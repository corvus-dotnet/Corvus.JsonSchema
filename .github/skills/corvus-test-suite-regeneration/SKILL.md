...
V4 schema validation tests are in `tests-v4/Corvus.Json.Specs.Tests/` as xUnit tests.
...
V4 tests are NOT regenerated by the master script — they are static xUnit test classes.
