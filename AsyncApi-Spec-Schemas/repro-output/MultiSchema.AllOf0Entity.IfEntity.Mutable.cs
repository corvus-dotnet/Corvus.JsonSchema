    ...
    public readonly partial struct AllOf0Entity
    {
        ...
        public readonly partial struct IfEntity
        {
            ...
            public ref struct Source
            {
                ...
                internal Source(Repro.MultiSchema.AllOf0Entity.IfEntity.ObjectBuilder.Build value) {_objectBuilder = value; _kind = Kind.ObjectBuilder; }

                internal Source(Repro.MultiSchema.AllOf0Entity.IfEntity.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Repro.MultiSchema.AllOf0Entity.IfEntity.ObjectBuilder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.ObjectBuilder; }

                internal Source(scoped in TContext context, Repro.MultiSchema.AllOf0Entity.IfEntity.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }
