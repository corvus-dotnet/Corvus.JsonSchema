        ...
        public readonly partial struct ThenEntity
        {
            ...
            public readonly partial struct SchemaEntity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Gets the (optional) <c>a</c> property.
                    /// </summary>
                    public Repro.JsonString.Mutable A
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AUtf8, out Repro.JsonString.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// <summary>
                    /// Set the <c>a</c> property.
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetA(in Repro.JsonString.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AUtf8);
                            _documentVersion = _parent.Version;
                            return;
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                        ...
                        else
                        {
                            ...
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.A, ref cvb);
                    ...
                    /// <summary>
                    /// Remove the <c>a</c> property, if present.
                    /// </summary>
                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                    public bool RemoveA()
                    {
                        CheckValidInstance();
                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AUtf8);
                        _documentVersion = _parent.Version;
                        return result;
                    }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Repro.MultiSchema.AllOf0Entity.ThenEntity.SchemaEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Repro.MultiSchema.AllOf0Entity.ThenEntity.SchemaEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Repro.JsonString.Source a = default)
                    {
                        a.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.A, ref builder);
                    }

                    /// <summary>
                    /// Creates an instance of a <see cref="SchemaEntity"/>.
                    /// </summary>
                    public void Create(in Repro.JsonString.Source a = default)
                    {
                        Create(ref _builder, a);
                    }
                ...
                /// </summary>
                /// <param name="workspace">The JSON workspace.</param>
                /// <param name="a">The value of the property.</param>
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Repro.JsonString.Source a = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
