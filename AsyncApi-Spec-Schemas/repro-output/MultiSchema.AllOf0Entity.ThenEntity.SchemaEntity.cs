    ...
    public readonly partial struct AllOf0Entity
    {
        ...
        public readonly partial struct ThenEntity
        {
...
#endif
            {
                ...
                /// </summary>
                public Repro.JsonString A
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AUtf8, out Repro.JsonString value))
                        {
                            return value;
                        }
                ...
                {
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="A"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> A => "a"u8;
                }
                ...
                {
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="A"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> A => [0x35, 0x00, 0x00, 0x00, 0x22, 0x61, 0x22];
                }
            }
        }
    }
