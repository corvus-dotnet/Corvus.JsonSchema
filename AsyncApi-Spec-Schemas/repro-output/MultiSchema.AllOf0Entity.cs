...
public readonly partial struct MultiSchema
{
...
#endif
    {
        ...
        /// </summary>
        public Repro.MultiSchema.AllOf0Entity.ThenEntity.SchemaEntity Schema
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchemaUtf8, out Repro.MultiSchema.AllOf0Entity.ThenEntity.SchemaEntity value))
                {
                    return value;
                }
        ...
        public bool TryGetAsIfEntity(out Repro.MultiSchema.AllOf0Entity.IfEntity result)
        {
            ...
            {
                result = Repro.MultiSchema.AllOf0Entity.IfEntity.From(this);
                return true;
            }
        ...
        public bool TryGetAsThenEntity(out Repro.MultiSchema.AllOf0Entity.ThenEntity result)
        {
            ...
            {
                result = Repro.MultiSchema.AllOf0Entity.ThenEntity.From(this);
                return true;
            }
