...
public readonly partial struct MultiSchema
{
    ...
    public readonly partial struct AllOf1Entity
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Repro.MultiSchema.AllOf1Entity.RequiredSchemaFormat.SchemaFormatEntity SchemaFormat
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchemaFormatUtf8, out Repro.MultiSchema.AllOf1Entity.RequiredSchemaFormat.SchemaFormatEntity value))
                    {
                        return value;
                    }
