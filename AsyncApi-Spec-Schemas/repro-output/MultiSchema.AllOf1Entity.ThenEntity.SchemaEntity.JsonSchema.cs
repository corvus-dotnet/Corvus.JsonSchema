    ...
    public readonly partial struct AllOf1Entity
    {
        ...
        public readonly partial struct ThenEntity
        {
                ...
                : IJsonElement<SchemaEntity>
            {
                ...
                {
                    private static readonly JsonSchemaPathProvider BSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/b"u8, buffer, out written);

                    private static void MatchB(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                        JsonSchemaContext childContext =
                            Repro.JsonNumber.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.BUtf8,
                                evaluationPath: BSchemaEvaluationPath);

                        Repro.JsonNumber.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    ...
                    {
                        if (span.SequenceEqual(JsonPropertyNames.BUtf8))
                        {
                            matcher = MatchB;
                            return true;
                        }
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/allOf/1/then/properties/schema"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/allOf/1/then/properties/schema";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/allOf/1/then/properties/schema"u8;
