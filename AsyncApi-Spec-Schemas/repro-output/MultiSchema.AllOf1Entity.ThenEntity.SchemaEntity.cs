    ...
    public readonly partial struct AllOf1Entity
    {
        ...
        public readonly partial struct ThenEntity
        {
...
#endif
            {
                ...
                /// </summary>
                public Repro.JsonNumber B
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BUtf8, out Repro.JsonNumber value))
                        {
                            return value;
                        }
                ...
                {
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="B"/>.
                    /// </summary>
                ...
                {
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="B"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> B => [0x35, 0x00, 0x00, 0x00, 0x22, 0x62, 0x22];
                }
            }
        }
    }
