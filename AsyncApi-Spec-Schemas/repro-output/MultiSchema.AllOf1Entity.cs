...
public readonly partial struct MultiSchema
{
...
#endif
    {
        ...
        /// </summary>
        public Repro.MultiSchema.AllOf1Entity.ThenEntity.SchemaEntity Schema
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchemaUtf8, out Repro.MultiSchema.AllOf1Entity.ThenEntity.SchemaEntity value))
                {
                    return value;
                }
        ...
        public bool TryGetAsRequiredSchemaFormat(out Repro.MultiSchema.AllOf1Entity.RequiredSchemaFormat result)
        {
            ...
            {
                result = Repro.MultiSchema.AllOf1Entity.RequiredSchemaFormat.From(this);
                return true;
            }
        ...
        public bool TryGetAsThenEntity(out Repro.MultiSchema.AllOf1Entity.ThenEntity result)
        {
            ...
            {
                result = Repro.MultiSchema.AllOf1Entity.ThenEntity.From(this);
                return true;
            }
