...
public readonly partial struct MultiSchema
{
    ...
    public readonly partial struct AllOf2Entity
    {
...
#endif
        {
            ...
            /// <param name="matchReproMultiSchemaAllOf2EntityThenEntity">Match a <see cref="Repro.MultiSchema.AllOf2Entity.ThenEntity"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Repro.MultiSchema.AllOf2Entity.ThenEntity, TContext, TResult> matchReproMultiSchemaAllOf2EntityThenEntity,
                Matcher<AllOf2Entity, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                if (Repro.MultiSchema.AllOf2Entity.RequiredSchemaFormat.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchReproMultiSchemaAllOf2EntityThenEntity(Repro.MultiSchema.AllOf2Entity.ThenEntity.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Repro.MultiSchema.AllOf2Entity.ThenEntity, TResult> matchReproMultiSchemaAllOf2EntityThenEntity,
                Matcher<AllOf2Entity, TResult> defaultMatch)
            {
                if (Repro.MultiSchema.AllOf2Entity.RequiredSchemaFormat.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchReproMultiSchemaAllOf2EntityThenEntity(Repro.MultiSchema.AllOf2Entity.ThenEntity.From(this));
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Repro.MultiSchema.AllOf2Entity.RequiredSchemaFormat" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsRequiredSchemaFormat(out Repro.MultiSchema.AllOf2Entity.RequiredSchemaFormat result)
            {
                if (Repro.MultiSchema.AllOf2Entity.RequiredSchemaFormat.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Repro.MultiSchema.AllOf2Entity.RequiredSchemaFormat.Mutable.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Repro.MultiSchema.AllOf2Entity.ThenEntity" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsThenEntity(out Repro.MultiSchema.AllOf2Entity.ThenEntity result)
            {
                if (Repro.MultiSchema.AllOf2Entity.ThenEntity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Repro.MultiSchema.AllOf2Entity.ThenEntity.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Repro.MultiSchema.AllOf2Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Repro.MultiSchema.AllOf2Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Repro.MultiSchema.AllOf2Entity.ThenEntity.SchemaEntity.Source schema = default)
            {
            ...
            /// Creates an instance of a <see cref="AllOf2Entity"/>.
            /// </summary>
            public void Create(in Repro.MultiSchema.AllOf2Entity.ThenEntity.SchemaEntity.Source schema = default)
            {
            ...
            /// Creates an instance of a <see cref="AllOf2Entity"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Repro.MultiSchema.AllOf2Entity.ThenEntity.SchemaEntity.Source<TContext> schema = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Repro.MultiSchema.AllOf2Entity.ThenEntity.SchemaEntity.Source schema = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Repro.MultiSchema.AllOf2Entity.ThenEntity.SchemaEntity.Source<TContext> schema = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
