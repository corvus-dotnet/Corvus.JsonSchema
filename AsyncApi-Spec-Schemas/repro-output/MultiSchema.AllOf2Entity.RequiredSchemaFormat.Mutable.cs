    ...
    public readonly partial struct AllOf2Entity
    {
        ...
        public readonly partial struct RequiredSchemaFormat
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Repro.MultiSchema.AllOf2Entity.RequiredSchemaFormat.SchemaFormatEntity.Mutable SchemaFormat
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchemaFormatUtf8, out Repro.MultiSchema.AllOf2Entity.RequiredSchemaFormat.SchemaFormatEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetSchemaFormat(in Repro.MultiSchema.AllOf2Entity.RequiredSchemaFormat.SchemaFormatEntity.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Repro.MultiSchema.AllOf2Entity.RequiredSchemaFormat.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Repro.MultiSchema.AllOf2Entity.RequiredSchemaFormat.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                {
                    builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.SchemaFormat, Repro.MultiSchema.AllOf2Entity.RequiredSchemaFormat.SchemaFormatEntity.ConstInstance);
                }
