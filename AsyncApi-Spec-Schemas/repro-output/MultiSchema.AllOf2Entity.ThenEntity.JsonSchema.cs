            ...
            public static partial class JsonSchema
            {
                ...
                private static void MatchSchema(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    JsonSchemaContext childContext =
                        Repro.MultiSchema.AllOf2Entity.ThenEntity.SchemaEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Repro.MultiSchema.AllOf2Entity.ThenEntity.SchemaEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                [NotNullWhen(true)]
#endif
                out Repro.PropertiesValidationHandler_NamedPropertyValidator? matcher)
                {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/allOf/2/then"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/allOf/2/then";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/allOf/2/then"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.StartObject)
                    {
                        ...
                        while (objectValidation_enumerator.MoveNext())
                        {
                            ...
                            if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out Repro.PropertiesValidationHandler_NamedPropertyValidator? validator))
                            {
