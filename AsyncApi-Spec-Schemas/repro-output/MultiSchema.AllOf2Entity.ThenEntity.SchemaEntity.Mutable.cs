        ...
        public readonly partial struct ThenEntity
        {
            ...
            public readonly partial struct SchemaEntity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Gets the (optional) <c>c</c> property.
                    /// </summary>
                    public Repro.JsonBoolean.Mutable C
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CUtf8, out Repro.JsonBoolean.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// <summary>
                    /// Set the <c>c</c> property.
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetC(in Repro.JsonBoolean.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CUtf8);
                            _documentVersion = _parent.Version;
                            return;
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                        ...
                        else
                        {
                            ...
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.C, ref cvb);
                    ...
                    /// <summary>
                    /// Remove the <c>c</c> property, if present.
                    /// </summary>
                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                    public bool RemoveC()
                    {
                        CheckValidInstance();
                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CUtf8);
                        _documentVersion = _parent.Version;
                        return result;
                    }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Repro.MultiSchema.AllOf2Entity.ThenEntity.SchemaEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Repro.MultiSchema.AllOf2Entity.ThenEntity.SchemaEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Repro.JsonBoolean.Source c = default)
                    {
                        c.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.C, ref builder);
                    }

                    /// <summary>
                    /// Creates an instance of a <see cref="SchemaEntity"/>.
                    /// </summary>
                    public void Create(in Repro.JsonBoolean.Source c = default)
                    {
                        Create(ref _builder, c);
                    }
                ...
                /// </summary>
                /// <param name="workspace">The JSON workspace.</param>
                /// <param name="c">The value of the property.</param>
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Repro.JsonBoolean.Source c = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
