    ...
    public readonly partial struct AllOf2Entity
    {
        ...
        public readonly partial struct ThenEntity
        {
...
#endif
            {
                ...
                /// </summary>
                public Repro.JsonBoolean C
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CUtf8, out Repro.JsonBoolean value))
                        {
                            return value;
                        }
                ...
                {
                    /// <summary>
                    /// Gets the JSON property name for <see cref="C"/>.
                    /// </summary>
                    ...
                    /// Gets the JSON property name for <see cref="C"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> CUtf8 => "c"u8;
                }
                ...
                {
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="C"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> C => "c"u8;
                }
                ...
                {
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="C"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> C => [0x35, 0x00, 0x00, 0x00, 0x22, 0x63, 0x22];
                }
            }
        }
    }
