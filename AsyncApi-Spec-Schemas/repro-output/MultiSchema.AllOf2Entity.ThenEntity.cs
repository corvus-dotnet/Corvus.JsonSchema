...
public readonly partial struct MultiSchema
{
    ...
    public readonly partial struct AllOf2Entity
    {
...
#endif
        {
            ...
            /// </summary>
            public Repro.MultiSchema.AllOf2Entity.ThenEntity.SchemaEntity Schema
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchemaUtf8, out Repro.MultiSchema.AllOf2Entity.ThenEntity.SchemaEntity value))
                    {
                        return value;
                    }
