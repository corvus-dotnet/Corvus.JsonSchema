...
public readonly partial struct MultiSchema
{
...
#endif
    {
        ...
        public static implicit operator Repro.MultiSchema.AllOf0Entity.Mutable(Mutable value)
        {
            return Repro.MultiSchema.AllOf0Entity.Mutable.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Mutable(Repro.MultiSchema.AllOf0Entity.Mutable value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Repro.MultiSchema.AllOf1Entity.Mutable(Mutable value)
        {
            return Repro.MultiSchema.AllOf1Entity.Mutable.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Mutable(Repro.MultiSchema.AllOf1Entity.Mutable value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Repro.MultiSchema.AllOf2Entity.Mutable(Mutable value)
        {
            return Repro.MultiSchema.AllOf2Entity.Mutable.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Mutable(Repro.MultiSchema.AllOf2Entity.Mutable value)
        {
            return From(value);
        }
        ...
        public static explicit operator Mutable(MultiSchema instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="MultiSchema"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator MultiSchema(Mutable instance)
        {
        ...
        /// </summary>
        public Repro.MultiSchema.AllOf2Entity.ThenEntity.SchemaEntity.Mutable Schema
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchemaUtf8, out Repro.MultiSchema.AllOf2Entity.ThenEntity.SchemaEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Repro.JsonString.Mutable SchemaFormat
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchemaFormatUtf8, out Repro.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetSchema(in Repro.MultiSchema.AllOf2Entity.ThenEntity.SchemaEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetSchema<TContext>(in Repro.MultiSchema.AllOf2Entity.ThenEntity.SchemaEntity.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetSchemaFormat(in Repro.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        public void Apply(in Repro.MultiSchema.AllOf0Entity value)
        {
            CheckValidInstance();
        ...
        /// This will add or update any property values provided by the <paramref name="value"/>.
        /// </remarks>
        public void Apply(in Repro.MultiSchema.AllOf1Entity value)
        {
            CheckValidInstance();
        ...
        /// This will add or update any property values provided by the <paramref name="value"/>.
        /// </remarks>
        public void Apply(in Repro.MultiSchema.AllOf2Entity value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"MultiSchema.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly MultiSchema Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly MultiSchema Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<MultiSchema>(_idx);
        }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Repro.MultiSchema.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
        where TContext : allows ref struct
#endif
        {
            ...
            {
                return matchAllOf0Entity(Repro.MultiSchema.AllOf0Entity.Mutable.From(this), context);
            }

            if (Repro.MultiSchema.AllOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAllOf1Entity(Repro.MultiSchema.AllOf1Entity.Mutable.From(this), context);
            }

            if (Repro.MultiSchema.AllOf2Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAllOf2Entity(Repro.MultiSchema.AllOf2Entity.Mutable.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Repro.MultiSchema.Mutable, TResult> defaultMatch)
        {
            if (Repro.MultiSchema.AllOf0Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAllOf0Entity(Repro.MultiSchema.AllOf0Entity.Mutable.From(this));
            }

            if (Repro.MultiSchema.AllOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAllOf1Entity(Repro.MultiSchema.AllOf1Entity.Mutable.From(this));
            }

            if (Repro.MultiSchema.AllOf2Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAllOf2Entity(Repro.MultiSchema.AllOf2Entity.Mutable.From(this));
            }
        ...
        public bool TryGetAsAllOf0Entity(out Repro.MultiSchema.AllOf0Entity result)
        {
            if (Repro.MultiSchema.AllOf0Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Repro.MultiSchema.AllOf0Entity.Mutable.From(this);
                return true;
            }
        ...
        public bool TryGetAsAllOf1Entity(out Repro.MultiSchema.AllOf1Entity result)
        {
            if (Repro.MultiSchema.AllOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Repro.MultiSchema.AllOf1Entity.Mutable.From(this);
                return true;
            }
        ...
        public bool TryGetAsAllOf2Entity(out Repro.MultiSchema.AllOf2Entity result)
        {
            if (Repro.MultiSchema.AllOf2Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Repro.MultiSchema.AllOf2Entity.Mutable.From(this);
                return true;
            }
    ...
    public ref struct Source
    {
        ...
        internal Source(Repro.MultiSchema.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(MultiSchema instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Repro.MultiSchema.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="MultiSchema"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Repro.MultiSchema.AllOf2Entity.ThenEntity.SchemaEntity.Source schema = default,
            in Repro.JsonString.Source schemaFormat = default)
        {
        ...
        /// Creates an instance of a <see cref="MultiSchema"/>.
        /// </summary>
        public void Create(in Repro.MultiSchema.AllOf2Entity.ThenEntity.SchemaEntity.Source schema = default, in Repro.JsonString.Source schemaFormat = default)
        {
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in Repro.MultiSchema.AllOf2Entity.ThenEntity.SchemaEntity.Source<TContext> schema = default,
            in Repro.JsonString.Source schemaFormat = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Repro.MultiSchema.AllOf2Entity.ThenEntity.SchemaEntity.Source schema = default, in Repro.JsonString.Source schemaFormat = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Repro.MultiSchema.AllOf2Entity.ThenEntity.SchemaEntity.Source<TContext> schema = default, in Repro.JsonString.Source schemaFormat = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    {
        return workspace.CreateBuilder<MultiSchema, Mutable>(this);
    }
}
