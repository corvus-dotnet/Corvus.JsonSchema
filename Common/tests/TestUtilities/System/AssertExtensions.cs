...
public static class AssertExtensions
{
    ...
    public static E AssertThrows<E, T>(ReadOnlySpan<T> span, AssertThrowsActionReadOnly<T> action) where E : Exception
    {
        ...
        {
            null => throw ThrowsException.ForNoException(typeof(E)),
            E ex when (ex.GetType() == typeof(E)) => ex,
            _ => throw ThrowsException.ForIncorrectExceptionType(typeof(E), exception),
        };
    }
