...
public readonly partial struct PersonArray : IJsonArray<PersonArray>, IReadOnlyCollection<Corvus.Json.Benchmarking.Models.V2.Person>
#else
public readonly partial struct PersonArray : IJsonArray<PersonArray>, IReadOnlyCollection<Corvus.Json.Benchmarking.Models.V2.Person>
#endif
{
    ...
    public Corvus.Json.Benchmarking.Models.V2.Person this[int index]
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new Corvus.Json.Benchmarking.Models.V2.Person(this.jsonElementBacking[index]);
            }
            ...
            if ((this.backing & Backing.Array) != 0)
            {
                try
                {
                    return this.arrayBacking[index].As<Corvus.Json.Benchmarking.Models.V2.Person>();
                }
                catch (ArgumentOutOfRangeException ex)
                {
                    throw new IndexOutOfRangeException(ex.Message, ex);
    ...
    public static PersonArray Create(ReadOnlySpan<Corvus.Json.Benchmarking.Models.V2.Person> items)
    {
        return new([..items]);
    }
    ...
    public static PersonArray FromItems(in Corvus.Json.Benchmarking.Models.V2.Person value1)
    {
    ...
    /// <returns>A PersonArray instantiated from the given items.</returns>
    public static PersonArray FromItems(in Corvus.Json.Benchmarking.Models.V2.Person value1, in Corvus.Json.Benchmarking.Models.V2.Person value2)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1.AsAny);
    ...
    /// <returns>A PersonArray instantiated from the given items.</returns>
    public static PersonArray FromItems(in Corvus.Json.Benchmarking.Models.V2.Person value1, in Corvus.Json.Benchmarking.Models.V2.Person value2, in Corvus.Json.Benchmarking.Models.V2.Person value3)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1.AsAny);
        builder.Add(value2.AsAny);
    ...
    public static PersonArray FromItems(params Corvus.Json.Benchmarking.Models.V2.Person[] value)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        foreach (Corvus.Json.Benchmarking.Models.V2.Person item in value)
        {
    ...
    /// <param name = "value">The value from which to construct the instance.</param>
    /// <returns>A JsonAny instantiated from the given items.</returns>
    public static PersonArray FromRange(IEnumerable<Corvus.Json.Benchmarking.Models.V2.Person> value)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        foreach (Corvus.Json.Benchmarking.Models.V2.Person item in value)
        {
    ...
    /// <inheritdoc/>
    IEnumerator<Corvus.Json.Benchmarking.Models.V2.Person> IEnumerable<Corvus.Json.Benchmarking.Models.V2.Person>.GetEnumerator()
    {
    ...
    /// <inheritdoc/>
    int IReadOnlyCollection<Corvus.Json.Benchmarking.Models.V2.Person>.Count => this.GetArrayLength();
    ...
    /// <inheritdoc/>
    public JsonArrayEnumerator<Corvus.Json.Benchmarking.Models.V2.Person> EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
            return new JsonArrayEnumerator<Corvus.Json.Benchmarking.Models.V2.Person>(this.jsonElementBacking);
        }

        if ((this.backing & Backing.Array) != 0)
        {
            return new JsonArrayEnumerator<Corvus.Json.Benchmarking.Models.V2.Person>(this.arrayBacking);
        }
