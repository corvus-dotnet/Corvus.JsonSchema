...
public readonly partial struct PersonName
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Json.Benchmarking.Models.V2.PersonNameElement FamilyName
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Corvus.Json.Benchmarking.Models.V2.PersonNameElement(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Corvus.Json.Benchmarking.Models.V2.PersonNameElement>();
                }
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Json.Benchmarking.Models.V2.PersonNameElement GivenName
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
    ...
    /// </para>
    /// </remarks>
    public Corvus.Json.Benchmarking.Models.V2.OtherNames OtherNames
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Corvus.Json.Benchmarking.Models.V2.OtherNames(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Corvus.Json.Benchmarking.Models.V2.OtherNames>();
                }
            }
    ...
    /// </summary>
    public static PersonName Create(Corvus.Json.Benchmarking.Models.V2.PersonNameElement familyName, Corvus.Json.Benchmarking.Models.V2.PersonNameElement? givenName = null, Corvus.Json.Benchmarking.Models.V2.OtherNames? otherNames = null)
    {
        var builder = ImmutableList.CreateBuilder<JsonObjectProperty>();
        builder.Add(JsonPropertyNames.FamilyName, familyName.AsAny);
        if (givenName is Corvus.Json.Benchmarking.Models.V2.PersonNameElement givenName__)
        {
            builder.Add(JsonPropertyNames.GivenName, givenName__.AsAny);
        }

        if (otherNames is Corvus.Json.Benchmarking.Models.V2.OtherNames otherNames__)
        {
    ...
    public PersonName WithFamilyName(in Corvus.Json.Benchmarking.Models.V2.PersonNameElement value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public PersonName WithGivenName(in Corvus.Json.Benchmarking.Models.V2.PersonNameElement value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public PersonName WithOtherNames(in Corvus.Json.Benchmarking.Models.V2.OtherNames value)
    {
    ...
    {
        return property.ValueAs<Corvus.Json.Benchmarking.Models.V2.PersonNameElement>().Validate(validationContext, level);
    }
    ...
    {
        return property.ValueAs<Corvus.Json.Benchmarking.Models.V2.OtherNames>().Validate(validationContext, level);
    }
