...
public readonly partial struct PersonNameElementArray
{
    ...
    public PersonNameElementArray Add(in Corvus.Json.Benchmarking.Models.V2.PersonNameElement item1)
    {
        ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
        builder.Add(item1);
        return new(builder.ToImmutable());
    ...
    /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
    public PersonNameElementArray Add(params Corvus.Json.Benchmarking.Models.V2.PersonNameElement[] items)
    {
        ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
        foreach (Corvus.Json.Benchmarking.Models.V2.PersonNameElement item in items)
        {
            builder.Add(item.AsAny);
        }
    ...
    /// <returns>An instance of the array with the items added.</returns>
    /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
    public PersonNameElementArray AddRange(IEnumerable<Corvus.Json.Benchmarking.Models.V2.PersonNameElement> items)
    {
        ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
        foreach (Corvus.Json.Benchmarking.Models.V2.PersonNameElement item in items)
        {
    ...
    /// <returns>An instance of the array with the item added.</returns>
    /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
    public PersonNameElementArray Insert(int index, in Corvus.Json.Benchmarking.Models.V2.PersonNameElement item1)
    {
        return new(this.GetImmutableListWith(index, item1));
    }
    ...
    public PersonNameElementArray InsertRange(int index, IEnumerable<Corvus.Json.Benchmarking.Models.V2.PersonNameElement> items)
    {
        return new(this.GetImmutableListWith(index, items.Select(item => item.AsAny)));
    }
    ...
    /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
    public PersonNameElementArray Replace(in Corvus.Json.Benchmarking.Models.V2.PersonNameElement oldValue, in Corvus.Json.Benchmarking.Models.V2.PersonNameElement newValue)
    {
        return new(this.GetImmutableListReplacing(oldValue.AsAny, newValue.AsAny));
    }
    ...
    public PersonNameElementArray SetItem(int index, in Corvus.Json.Benchmarking.Models.V2.PersonNameElement value)
    {
        return new(this.GetImmutableListSetting(index, value.AsAny));
    }
}