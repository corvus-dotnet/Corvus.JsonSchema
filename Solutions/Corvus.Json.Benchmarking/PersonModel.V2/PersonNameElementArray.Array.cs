...
public readonly partial struct PersonNameElementArray : IJsonArray<PersonNameElementArray>, IReadOnlyCollection<Corvus.Json.Benchmarking.Models.V2.PersonNameElement>
#else
public readonly partial struct PersonNameElementArray : IJsonArray<PersonNameElementArray>, IReadOnlyCollection<Corvus.Json.Benchmarking.Models.V2.PersonNameElement>
#endif
{
    ...
    public Corvus.Json.Benchmarking.Models.V2.PersonNameElement this[int index]
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new Corvus.Json.Benchmarking.Models.V2.PersonNameElement(this.jsonElementBacking[index]);
            }
            ...
            if ((this.backing & Backing.Array) != 0)
            {
                try
                {
                    return this.arrayBacking[index].As<Corvus.Json.Benchmarking.Models.V2.PersonNameElement>();
                }
                catch (ArgumentOutOfRangeException ex)
                {
                    throw new IndexOutOfRangeException(ex.Message, ex);
    ...
    public static PersonNameElementArray Create(ReadOnlySpan<Corvus.Json.Benchmarking.Models.V2.PersonNameElement> items)
    {
        return new([..items]);
    }
    ...
    public static PersonNameElementArray FromItems(in Corvus.Json.Benchmarking.Models.V2.PersonNameElement value1)
    {
    ...
    /// <returns>A PersonNameElementArray instantiated from the given items.</returns>
    public static PersonNameElementArray FromItems(in Corvus.Json.Benchmarking.Models.V2.PersonNameElement value1, in Corvus.Json.Benchmarking.Models.V2.PersonNameElement value2)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1.AsAny);
    ...
    /// <returns>A PersonNameElementArray instantiated from the given items.</returns>
    public static PersonNameElementArray FromItems(in Corvus.Json.Benchmarking.Models.V2.PersonNameElement value1, in Corvus.Json.Benchmarking.Models.V2.PersonNameElement value2, in Corvus.Json.Benchmarking.Models.V2.PersonNameElement value3)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1.AsAny);
        builder.Add(value2.AsAny);
    ...
    public static PersonNameElementArray FromItems(params Corvus.Json.Benchmarking.Models.V2.PersonNameElement[] value)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        foreach (Corvus.Json.Benchmarking.Models.V2.PersonNameElement item in value)
        {
    ...
    /// <param name = "value">The value from which to construct the instance.</param>
    /// <returns>A JsonAny instantiated from the given items.</returns>
    public static PersonNameElementArray FromRange(IEnumerable<Corvus.Json.Benchmarking.Models.V2.PersonNameElement> value)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        foreach (Corvus.Json.Benchmarking.Models.V2.PersonNameElement item in value)
        {
    ...
    /// <inheritdoc/>
    IEnumerator<Corvus.Json.Benchmarking.Models.V2.PersonNameElement> IEnumerable<Corvus.Json.Benchmarking.Models.V2.PersonNameElement>.GetEnumerator()
    {
    ...
    /// <inheritdoc/>
    int IReadOnlyCollection<Corvus.Json.Benchmarking.Models.V2.PersonNameElement>.Count => this.GetArrayLength();
    ...
    /// <inheritdoc/>
    public JsonArrayEnumerator<Corvus.Json.Benchmarking.Models.V2.PersonNameElement> EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
            return new JsonArrayEnumerator<Corvus.Json.Benchmarking.Models.V2.PersonNameElement>(this.jsonElementBacking);
        }

        if ((this.backing & Backing.Array) != 0)
        {
            return new JsonArrayEnumerator<Corvus.Json.Benchmarking.Models.V2.PersonNameElement>(this.arrayBacking);
        }
