...
public readonly partial struct Person
{
    ...
    {
        public static ValidationContext TypeValidationHandler(in Person value, JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ValidationContext result = validationContext;
            bool isValid = false;
            ...
            return result.MergeResults(isValid, level, localResultObject);
        }

        public static ValidationContext ObjectValidationHandler(in Person value, JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ValidationContext result = validationContext;
            ...
            {
                if ((property.NamePrefersUtf8 && property.NameEquals(JsonPropertyNames.DateOfBirthUtf8)) || (!property.NamePrefersUtf8 && property.NameEquals(JsonPropertyNames.DateOfBirth)))
                {
                ...
                else if ((property.NamePrefersUtf8 && property.NameEquals(JsonPropertyNames.EmailUtf8)) || (!property.NamePrefersUtf8 && property.NameEquals(JsonPropertyNames.Email)))
                {
                    result = result.WithLocalProperty(propertyCount);
                    if (level > ValidationLevel.Basic)
                    {
                ...
                else if ((property.NamePrefersUtf8 && property.NameEquals(JsonPropertyNames.HeightUtf8)) || (!property.NamePrefersUtf8 && property.NameEquals(JsonPropertyNames.Height)))
                {
                    result = result.WithLocalProperty(propertyCount);
                    if (level > ValidationLevel.Basic)
                    {
                ...
                else if ((property.NamePrefersUtf8 && property.NameEquals(JsonPropertyNames.NameUtf8)) || (!property.NamePrefersUtf8 && property.NameEquals(JsonPropertyNames.Name)))
                {
                    hasSeenName = true;
                    result = result.WithLocalProperty(propertyCount);
                    if (level > ValidationLevel.Basic)
                ...
                else if ((property.NamePrefersUtf8 && property.NameEquals(JsonPropertyNames.NetWorthUtf8)) || (!property.NamePrefersUtf8 && property.NameEquals(JsonPropertyNames.NetWorth)))
                {
                    result = result.WithLocalProperty(propertyCount);
                    if (level > ValidationLevel.Basic)
                    {
