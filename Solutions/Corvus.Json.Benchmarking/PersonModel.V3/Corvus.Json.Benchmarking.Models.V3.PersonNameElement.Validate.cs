...
public readonly partial struct PersonNameElement
{
    ...
    private static partial class CorvusValidation
    {
        ...
        public static ValidationContext TypeValidationHandler(in PersonNameElement value, JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ValidationContext result = validationContext;
            bool isValid = false;
            ...
            return result.MergeResults(isValid, level, localResultString);
        }

        public static ValidationContext StringValidationHandler(in PersonNameElement value, JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
