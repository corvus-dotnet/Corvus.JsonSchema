...
#endif
public readonly partial struct PersonNameElementArray : IJsonArray<Corvus.Json.Benchmarking.Models.V3.PersonNameElementArray>, IReadOnlyCollection<Corvus.Json.Benchmarking.Models.V3.PersonNameElement>
{
    /// <summary>
    /// Gets an empty array.
    /// </summary>
    ...
    public Corvus.Json.Benchmarking.Models.V3.PersonNameElement this[int index]
    {
        get
        {
            ...
            if ((this.backing & Backing.Array) != 0)
            {
                try
                {
                    return this.arrayBacking[index].As<Corvus.Json.Benchmarking.Models.V3.PersonNameElement>();
                }
                catch (ArgumentOutOfRangeException ex)
                {
                    throw new IndexOutOfRangeException(ex.Message, ex);
    ...
    /// <inheritdoc/>
    public JsonArrayEnumerator<Corvus.Json.Benchmarking.Models.V3.PersonNameElement> EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
            return new(this.jsonElementBacking);
