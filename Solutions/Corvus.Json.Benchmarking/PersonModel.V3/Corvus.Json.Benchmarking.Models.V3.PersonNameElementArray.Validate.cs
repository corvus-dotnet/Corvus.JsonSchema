...
public readonly partial struct PersonNameElementArray
{
    ...
    {
        public static ValidationContext TypeValidationHandler(in PersonNameElementArray value, JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ValidationContext result = validationContext;
            bool isValid = false;
        ...
        public static ValidationContext ArrayValidationHandler(in PersonNameElementArray value, JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ValidationContext result = validationContext;
