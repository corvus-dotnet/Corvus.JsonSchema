...
public readonly partial struct OtherNames
{
    private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
    {
        ...
        ValidationContext oneOfResult0 = this.As<Corvus.Json.Benchmarking.Models.V3.PersonNameElement>().Validate(childContext0.CreateChildContext(), level);
        ...
        ValidationContext oneOfResult1 = this.As<Corvus.Json.Benchmarking.Models.V3.PersonNameElementArray>().Validate(childContext1.CreateChildContext(), level);
