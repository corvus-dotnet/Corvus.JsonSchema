            ...
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            foreach (JsonObjectProperty property in value.EnumerateObject())
            {
                if (property.NameEquals(JsonPropertyNames.DateOfBirthUtf8, JsonPropertyNames.DateOfBirth))
                {
                    ...
                    ValidationContext propertyResult = property.Value.As<Corvus.Json.Benchmarking.Models.V3.Person.DateOfBirthEntity>().Validate(result.CreateChildContext(), level);
