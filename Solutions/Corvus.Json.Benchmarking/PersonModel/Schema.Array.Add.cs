...
{
    /// <inheritdoc/>
    public Schema Add(in JsonAny item1)
    {
    ...
    /// <inheritdoc/>
    public Schema Add(params JsonAny[] items)
    {
        ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
    ...
    /// <inheritdoc/>
    public Schema AddRange<TArray>(in TArray items)
    ...
    /// <inheritdoc/>
    public Schema AddRange(IEnumerable<JsonAny> items)
    {
        ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
        builder.AddRange(items);
        return new(builder.ToImmutable());
    ...
    /// <inheritdoc/>
    public Schema Insert(int index, in JsonAny item1)
    {
        return new(this.GetImmutableListWith(index, item1));
    }

    /// <inheritdoc/>
    public Schema InsertRange<TArray>(int index, in TArray items)
        where TArray : struct, IJsonArray<TArray>
    {
    ...
    /// <inheritdoc/>
    public Schema InsertRange<TItem>(int index, IEnumerable<TItem> items)
        where TItem : struct, IJsonValue<TItem>
    {
    ...
    /// <inheritdoc/>
    public Schema InsertRange(int index, IEnumerable<JsonAny> items)
    {
        return new(this.GetImmutableListWith(index, items));
    }

    /// <inheritdoc/>
    public Schema Replace(in JsonAny oldValue, in JsonAny newValue)
    {
        return this.GetImmutableListReplacing(oldValue.AsAny, newValue.AsAny);
    }

    /// <inheritdoc/>
    public Schema SetItem(int index, in JsonAny value)
    {
