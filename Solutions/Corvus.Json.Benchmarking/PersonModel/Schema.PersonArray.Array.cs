...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PersonArray : IJsonArray<PersonArray>
    {
        ...
        public static PersonArray FromItems(in Corvus.Json.Benchmarking.Models.Schema.Person value1)
        {
        ...
        /// <returns>A PersonArray instantiated from the given items.</returns>
        public static PersonArray FromItems(in Corvus.Json.Benchmarking.Models.Schema.Person value1, in Corvus.Json.Benchmarking.Models.Schema.Person value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A PersonArray instantiated from the given items.</returns>
        public static PersonArray FromItems(in Corvus.Json.Benchmarking.Models.Schema.Person value1, in Corvus.Json.Benchmarking.Models.Schema.Person value2, in Corvus.Json.Benchmarking.Models.Schema.Person value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static PersonArray FromItems(params Corvus.Json.Benchmarking.Models.Schema.Person[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Corvus.Json.Benchmarking.Models.Schema.Person item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static PersonArray FromRange(IEnumerable<Corvus.Json.Benchmarking.Models.Schema.Person> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Corvus.Json.Benchmarking.Models.Schema.Person item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Corvus.Json.Benchmarking.Models.Schema.Person> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Corvus.Json.Benchmarking.Models.Schema.Person>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Corvus.Json.Benchmarking.Models.Schema.Person>(this.arrayBacking);
            }
