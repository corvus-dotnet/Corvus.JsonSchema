...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PersonName
    {
        ...
        /// Gets FamilyName.
        /// </summary>
        public Corvus.Json.Benchmarking.Models.Schema.PersonNameElement FamilyName
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
                        return new Corvus.Json.Benchmarking.Models.Schema.PersonNameElement(result);
                    }
                }
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<Corvus.Json.Benchmarking.Models.Schema.PersonNameElement>();
                    }
                }
        ...
        /// Gets GivenName.
        /// </summary>
        public Corvus.Json.Benchmarking.Models.Schema.PersonNameElement GivenName
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
        ...
        /// Gets OtherNames.
        /// </summary>
        public Corvus.Json.Benchmarking.Models.Schema.OtherNames OtherNames
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
                        return new Corvus.Json.Benchmarking.Models.Schema.OtherNames(result);
                    }
                }
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<Corvus.Json.Benchmarking.Models.Schema.OtherNames>();
                    }
                }
        ...
        /// </summary>
        public static PersonName Create(Corvus.Json.Benchmarking.Models.Schema.PersonNameElement familyName, Corvus.Json.Benchmarking.Models.Schema.PersonNameElement? givenName = null, Corvus.Json.Benchmarking.Models.Schema.OtherNames? otherNames = null)
        {
            var builder = ImmutableDictionary.CreateBuilder<JsonPropertyName, JsonAny>();
            builder.Add(FamilyNameJsonPropertyName, familyName.AsAny);
            if (givenName is Corvus.Json.Benchmarking.Models.Schema.PersonNameElement givenName__)
            {
                builder.Add(GivenNameJsonPropertyName, givenName__.AsAny);
            }

            if (otherNames is Corvus.Json.Benchmarking.Models.Schema.OtherNames otherNames__)
            {
        ...
        public PersonName WithFamilyName(in Corvus.Json.Benchmarking.Models.Schema.PersonNameElement value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public PersonName WithGivenName(in Corvus.Json.Benchmarking.Models.Schema.PersonNameElement value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public PersonName WithOtherNames(in Corvus.Json.Benchmarking.Models.Schema.OtherNames value)
        {
        ...
        {
            return property.ValueAs<Corvus.Json.Benchmarking.Models.Schema.PersonNameElement>().Validate(validationContext, level);
        }
        ...
        {
            return property.ValueAs<Corvus.Json.Benchmarking.Models.Schema.OtherNames>().Validate(validationContext, level);
        }
    }
}