...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PersonNameElementArray : IJsonArray<PersonNameElementArray>
    {
        ...
        public static PersonNameElementArray FromItems(in Corvus.Json.Benchmarking.Models.Schema.PersonNameElement value1)
        {
        ...
        /// <returns>A PersonNameElementArray instantiated from the given items.</returns>
        public static PersonNameElementArray FromItems(in Corvus.Json.Benchmarking.Models.Schema.PersonNameElement value1, in Corvus.Json.Benchmarking.Models.Schema.PersonNameElement value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A PersonNameElementArray instantiated from the given items.</returns>
        public static PersonNameElementArray FromItems(in Corvus.Json.Benchmarking.Models.Schema.PersonNameElement value1, in Corvus.Json.Benchmarking.Models.Schema.PersonNameElement value2, in Corvus.Json.Benchmarking.Models.Schema.PersonNameElement value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static PersonNameElementArray FromItems(params Corvus.Json.Benchmarking.Models.Schema.PersonNameElement[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Corvus.Json.Benchmarking.Models.Schema.PersonNameElement item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static PersonNameElementArray FromRange(IEnumerable<Corvus.Json.Benchmarking.Models.Schema.PersonNameElement> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Corvus.Json.Benchmarking.Models.Schema.PersonNameElement item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Corvus.Json.Benchmarking.Models.Schema.PersonNameElement> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Corvus.Json.Benchmarking.Models.Schema.PersonNameElement>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Corvus.Json.Benchmarking.Models.Schema.PersonNameElement>(this.arrayBacking);
            }
