// <copyright file="CodeGenerator.DependentRequired.Partial.cs" company="Endjin Limited">
...
/// </summary>
public partial class CodeGeneratorDependentRequired
{
    private Dictionary<TypeDeclaration, Conversion>? conversions;

    /// <summary>
    /// Initializes a new instance of the <see cref="CodeGeneratorDependentRequired"/> class.
    /// </summary>
    ...
    public CodeGeneratorDependentRequired(JsonSchemaBuilder jsonSchemaBuilder, TypeDeclaration declarationToGenerate, bool validateFormat = true)
    {
