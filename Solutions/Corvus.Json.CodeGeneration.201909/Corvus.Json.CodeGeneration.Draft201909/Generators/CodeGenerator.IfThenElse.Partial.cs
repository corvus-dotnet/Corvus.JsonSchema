// <copyright file="CodeGenerator.IfThenElse.Partial.cs" company="Endjin Limited">
...
/// </summary>
public partial class CodeGeneratorIfThenElse
{
    private Dictionary<TypeDeclaration, Conversion>? conversions;

    /// <summary>
    /// Initializes a new instance of the <see cref="CodeGeneratorIfThenElse"/> class.
    /// </summary>
    ...
    public CodeGeneratorIfThenElse(JsonSchemaBuilder jsonSchemaBuilder, TypeDeclaration declarationToGenerate, bool validateFormat = true)
    {
