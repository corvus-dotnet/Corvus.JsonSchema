// <copyright file="CodeGenerator.Array.Partial.cs" company="Endjin Limited">
...
/// </summary>
public partial class CodeGeneratorArray
{
    private Dictionary<TypeDeclaration, Conversion>? conversions;

    /// <summary>
    /// Initializes a new instance of the <see cref="CodeGeneratorArray"/> class.
    /// </summary>
    ...
    public CodeGeneratorArray(JsonSchemaBuilder jsonSchemaBuilder, TypeDeclaration declarationToGenerate, bool validateFormat = true)
    {
