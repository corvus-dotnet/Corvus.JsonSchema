// <copyright file="CodeGenerator.DependentSchema.Partial.cs" company="Endjin Limited">
...
/// </summary>
public partial class CodeGeneratorDependentSchema
{
    private Dictionary<TypeDeclaration, Conversion>? conversions;

    /// <summary>
    /// Initializes a new instance of the <see cref="CodeGeneratorDependentSchema"/> class.
    /// </summary>
    ...
    public CodeGeneratorDependentSchema(JsonSchemaBuilder jsonSchemaBuilder, TypeDeclaration declarationToGenerate, bool validateFormat = true)
    {
