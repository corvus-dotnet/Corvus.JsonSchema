// <copyright file="CodeGenerator.Pattern.Partial.cs" company="Endjin Limited">
...
/// </summary>
public partial class CodeGeneratorPattern
{
    private Dictionary<TypeDeclaration, Conversion>? conversions;

    /// <summary>
    /// Initializes a new instance of the <see cref="CodeGeneratorPattern"/> class.
    /// </summary>
    ...
    public CodeGeneratorPattern(JsonSchemaBuilder jsonSchemaBuilder, TypeDeclaration declarationToGenerate, bool validateFormat = true)
    {
