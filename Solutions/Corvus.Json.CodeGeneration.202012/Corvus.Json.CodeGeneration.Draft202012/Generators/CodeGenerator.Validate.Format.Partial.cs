// <copyright file="CodeGenerator.Validate.Format.Partial.cs" company="Endjin Limited">
...
/// </summary>
public partial class CodeGeneratorValidateFormat
{
    private Dictionary<TypeDeclaration, Conversion>? conversions;

    /// <summary>
    /// Initializes a new instance of the <see cref="CodeGeneratorValidateFormat"/> class.
    /// </summary>
    ...
    public CodeGeneratorValidateFormat(JsonSchemaBuilder jsonSchemaBuilder, TypeDeclaration declarationToGenerate, bool validateFormat = true)
    {
