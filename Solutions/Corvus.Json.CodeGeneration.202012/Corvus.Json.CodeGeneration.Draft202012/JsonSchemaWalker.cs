...
internal class JsonSchemaWalker
{
    ...
    /// </summary>
    public const string SchemaContent = "application/vnd.Corvus.jsonschemawalker.draft202012schemacontent";
    ...
    private static Schema EnsureSchemaContent(LocatedElement referencedElement)
    {
        ...
        {
            var draft202012Schema = new Schema(referencedElement.Element);
