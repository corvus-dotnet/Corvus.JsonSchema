// <copyright file="CodeGenerator.AnyOf.Partial.cs" company="Endjin Limited">
...
/// </summary>
public partial class CodeGeneratorAnyOf
{
    private Dictionary<TypeDeclaration, Conversion>? conversions;

    /// <summary>
    /// Initializes a new instance of the <see cref="CodeGeneratorAnyOf"/> class.
    /// </summary>
    ...
    public CodeGeneratorAnyOf(JsonSchemaBuilder jsonSchemaBuilder, TypeDeclaration declarationToGenerate, bool validateFormat = true)
    {
