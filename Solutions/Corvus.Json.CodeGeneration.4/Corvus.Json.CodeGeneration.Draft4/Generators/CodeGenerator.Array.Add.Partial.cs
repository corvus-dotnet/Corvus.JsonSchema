// <copyright file="CodeGenerator.Array.Add.Partial.cs" company="Endjin Limited">
...
/// </summary>
public partial class CodeGeneratorArrayAdd
{
    private Dictionary<TypeDeclaration, Conversion>? conversions;

    /// <summary>
    /// Initializes a new instance of the <see cref="CodeGeneratorArrayAdd"/> class.
    /// </summary>
    ...
    public CodeGeneratorArrayAdd(JsonSchemaBuilder jsonSchemaBuilder, TypeDeclaration declarationToGenerate, bool validateFormat = true)
    {
