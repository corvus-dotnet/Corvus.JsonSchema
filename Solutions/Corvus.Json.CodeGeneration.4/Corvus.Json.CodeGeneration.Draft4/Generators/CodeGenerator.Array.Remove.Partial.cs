// <copyright file="CodeGenerator.Array.Remove.Partial.cs" company="Endjin Limited">
...
/// </summary>
public partial class CodeGeneratorArrayRemove
{
    private Dictionary<TypeDeclaration, Conversion>? conversions;

    /// <summary>
    /// Initializes a new instance of the <see cref="CodeGeneratorArrayRemove"/> class.
    /// </summary>
    ...
    public CodeGeneratorArrayRemove(JsonSchemaBuilder jsonSchemaBuilder, TypeDeclaration declarationToGenerate, bool validateFormat = true)
    {
