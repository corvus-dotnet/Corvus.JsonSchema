// <copyright file="CodeGenerator.Number.Partial.cs" company="Endjin Limited">
...
/// </summary>
public partial class CodeGeneratorNumber
{
    private Dictionary<TypeDeclaration, Conversion>? conversions;

    /// <summary>
    /// Initializes a new instance of the <see cref="CodeGeneratorNumber"/> class.
    /// </summary>
    ...
    public CodeGeneratorNumber(JsonSchemaBuilder jsonSchemaBuilder, TypeDeclaration declarationToGenerate, bool validateFormat = true)
    {
