// <copyright file="CodeGenerator.Validate.AnyOf.Partial.cs" company="Endjin Limited">
...
/// </summary>
public partial class CodeGeneratorValidateAnyOf
{
    private Dictionary<TypeDeclaration, Conversion>? conversions;

    /// <summary>
    /// Initializes a new instance of the <see cref="CodeGeneratorValidateAnyOf"/> class.
    /// </summary>
    ...
    public CodeGeneratorValidateAnyOf(JsonSchemaBuilder jsonSchemaBuilder, TypeDeclaration declarationToGenerate, bool validateFormat = true)
    {
