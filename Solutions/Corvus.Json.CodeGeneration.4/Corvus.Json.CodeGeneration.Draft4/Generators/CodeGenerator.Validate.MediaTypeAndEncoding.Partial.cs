// <copyright file="CodeGenerator.Validate.MediaTypeAndEncoding.Partial.cs" company="Endjin Limited">
...
using Corvus.Json.CodeGeneration.Draft4;
...
/// </summary>
public partial class CodeGeneratorValidateMediaTypeAndEncoding
{
    private Dictionary<TypeDeclaration, Conversion>? conversions;

    /// <summary>
    /// Initializes a new instance of the <see cref="CodeGeneratorValidateMediaTypeAndEncoding"/> class.
    /// </summary>
    ...
    public CodeGeneratorValidateMediaTypeAndEncoding(JsonSchemaBuilder jsonSchemaBuilder, TypeDeclaration declarationToGenerate, bool validateFormat = true)
    {
