...
public static class SchemaExtensionsDraft4
{
    ...
    {
        return
            draft6Schema.Type.IsSimpleTypes && draft6Schema.Type.Equals(JsonSchema.Draft4.Schema.SimpleTypes.EnumValues.Array);
    }
    ...
    {
        return
            draft6Schema.Type.IsSimpleTypes && draft6Schema.Type.Equals(JsonSchema.Draft4.Schema.SimpleTypes.EnumValues.Object);
    }
    ...
    {
        return
            draft6Schema.Type.IsSimpleTypes && (draft6Schema.Type.Equals(JsonSchema.Draft4.Schema.SimpleTypes.EnumValues.Number) || draft6Schema.Type.Equals(JsonSchema.Draft4.Schema.SimpleTypes.EnumValues.Integer));
    }
    ...
    {
        return
            draft6Schema.Type.IsSimpleTypes && draft6Schema.Type.Equals(JsonSchema.Draft4.Schema.SimpleTypes.EnumValues.Boolean);
    }
    ...
    {
        return
            draft6Schema.Type.IsSimpleTypes && draft6Schema.Type.Equals(JsonSchema.Draft4.Schema.SimpleTypes.EnumValues.Null);
    }
    ...
    {
        return
            draft6Schema.Type.IsSimpleTypes && draft6Schema.Type.Equals(JsonSchema.Draft4.Schema.SimpleTypes.EnumValues.String);
    }
    ...
    {
        return
            draft6Schema.IsExplicitBooleanType() || (draft6Schema.Type.IsSimpleTypesArray && draft6Schema.Type.AsSimpleTypesArray.EnumerateArray().Any(type => type.Equals(JsonSchema.Draft4.Schema.SimpleTypes.EnumValues.Boolean))) || draft6Schema.HasBooleanEnum() || draft6Schema.HasBooleanConst();
    }
    ...
    {
        return
            draft6Schema.IsExplicitNullType() || (draft6Schema.Type.IsSimpleTypesArray && draft6Schema.Type.AsSimpleTypesArray.EnumerateArray().Any(type => type.Equals(JsonSchema.Draft4.Schema.SimpleTypes.EnumValues.Null))) || draft6Schema.HasNullEnum() || draft6Schema.HasNullConst();
    }
    ...
    public static bool IsJsonInteger(this Schema draft6Schema)
    {
        return
            draft6Schema.Type.IsSimpleTypes && (
                draft6Schema.Type.Equals(JsonSchema.Draft4.Schema.SimpleTypes.EnumValues.Integer) ||
