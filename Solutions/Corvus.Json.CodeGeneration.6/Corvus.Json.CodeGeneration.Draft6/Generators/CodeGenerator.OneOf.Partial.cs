// <copyright file="CodeGenerator.OneOf.Partial.cs" company="Endjin Limited">
...
/// </summary>
public partial class CodeGeneratorOneOf
{
    private Dictionary<TypeDeclaration, Conversion>? conversions;

    /// <summary>
    /// Initializes a new instance of the <see cref="CodeGeneratorOneOf"/> class.
    /// </summary>
    ...
    public CodeGeneratorOneOf(JsonSchemaBuilder jsonSchemaBuilder, TypeDeclaration declarationToGenerate, bool validateFormat = true)
    {
