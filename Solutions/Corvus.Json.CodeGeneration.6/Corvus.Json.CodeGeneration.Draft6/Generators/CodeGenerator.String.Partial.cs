// <copyright file="CodeGenerator.String.Partial.cs" company="Endjin Limited">
...
/// </summary>
public partial class CodeGeneratorString
{
    private Dictionary<TypeDeclaration, Conversion>? conversions;

    /// <summary>
    /// Initializes a new instance of the <see cref="CodeGeneratorString"/> class.
    /// </summary>
    ...
    public CodeGeneratorString(JsonSchemaBuilder jsonSchemaBuilder, TypeDeclaration declarationToGenerate, bool validateFormat = true)
    {
