// <copyright file="CodeGenerator.Validate.Not.Partial.cs" company="Endjin Limited">
...
/// </summary>
public partial class CodeGeneratorValidateNot
{
    private Dictionary<TypeDeclaration, Conversion>? conversions;

    /// <summary>
    /// Initializes a new instance of the <see cref="CodeGeneratorValidateNot"/> class.
    /// </summary>
    ...
    public CodeGeneratorValidateNot(JsonSchemaBuilder jsonSchemaBuilder, TypeDeclaration declarationToGenerate, bool validateFormat = true)
    {
