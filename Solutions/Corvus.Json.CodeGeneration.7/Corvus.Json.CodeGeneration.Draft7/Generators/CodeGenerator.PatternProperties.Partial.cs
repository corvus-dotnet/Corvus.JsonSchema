// <copyright file="CodeGenerator.PatternProperties.Partial.cs" company="Endjin Limited">
...
/// </summary>
public partial class CodeGeneratorPatternProperties
{
    private Dictionary<TypeDeclaration, Conversion>? conversions;

    /// <summary>
    /// Initializes a new instance of the <see cref="CodeGeneratorPatternProperties"/> class.
    /// </summary>
    ...
    public CodeGeneratorPatternProperties(JsonSchemaBuilder jsonSchemaBuilder, TypeDeclaration declarationToGenerate, bool validateFormat = true)
    {
