// <copyright file="CodeGenerator.Validate.OneOf.Partial.cs" company="Endjin Limited">
...
/// </summary>
public partial class CodeGeneratorValidateOneOf
{
    private Dictionary<TypeDeclaration, Conversion>? conversions;

    /// <summary>
    /// Initializes a new instance of the <see cref="CodeGeneratorValidateOneOf"/> class.
    /// </summary>
    ...
    public CodeGeneratorValidateOneOf(JsonSchemaBuilder jsonSchemaBuilder, TypeDeclaration declarationToGenerate, bool validateFormat = true)
    {
