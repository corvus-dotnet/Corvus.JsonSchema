// <copyright file="CodeGenerator.Validate.Ref.Partial.cs" company="Endjin Limited">
...
/// </summary>
public partial class CodeGeneratorValidateRef
{
    private Dictionary<TypeDeclaration, Conversion>? conversions;

    /// <summary>
    /// Initializes a new instance of the <see cref="CodeGeneratorValidateRef"/> class.
    /// </summary>
    ...
    public CodeGeneratorValidateRef(JsonSchemaBuilder jsonSchemaBuilder, TypeDeclaration declarationToGenerate, bool validateFormat = true)
    {
