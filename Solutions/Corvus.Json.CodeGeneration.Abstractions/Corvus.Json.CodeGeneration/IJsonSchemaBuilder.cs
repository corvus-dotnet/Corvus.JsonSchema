...
public interface IJsonSchemaBuilder
{
    ...
    Task<(string RootType, ImmutableDictionary<string, TypeAndCode> GeneratedTypes)> BuildTypesFor(string reference, string rootNamespace, bool rebase = false, Dictionary<string, string>? baseUriToNamespaceMap = null, string? rootTypeName = null);
