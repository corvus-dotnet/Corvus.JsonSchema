// <copyright file="CodeGenerator.Conversions.Operators.Partial.cs" company="Endjin Limited">
...
using Corvus.Json.CodeGeneration.OpenApi30;
...
/// </summary>
public partial class CodeGeneratorConversionsOperators
{
    private Dictionary<TypeDeclaration, Conversion>? conversions;

    /// <summary>
    /// Initializes a new instance of the <see cref="CodeGeneratorConversionsOperators"/> class.
    /// </summary>
    ...
    public CodeGeneratorConversionsOperators(JsonSchemaBuilder jsonSchemaBuilder, TypeDeclaration declarationToGenerate, bool validateFormat = true)
    {
    ...
    /// <summary>
    /// Gets a value indicating whether this has a non-naked ref.
    /// </summary>
    ...
    public bool IsNotImplicitType
    {
        get
        {
            return !(this.IsImplicitObject || this.IsImplicitArray || this.IsImplicitNumber || this.IsImplicitString || this.IsImplicitBoolean);
        }
    }
    ...
    public bool IsImplicitObject
    {
        get
        {
            return this.TypeDeclaration.Schema().IsObjectType() || this.HasProperties || this.Conversions.Any(c => c.IsObject);
        }
    }
    ...
    public bool IsImplicitArray
    {
        get
        {
            return this.TypeDeclaration.Schema().IsArrayType() || this.Conversions.Any(c => c.IsArray);
        }
    }
    ...
    public bool IsImplicitNumber
    {
        get
        {
            return this.TypeDeclaration.Schema().IsNumberType() || this.Conversions.Any(c => c.IsNumber);
        }
    }
    ...
    public bool IsImplicitString
    {
        get
        {
            return this.TypeDeclaration.Schema().IsStringType() || this.Conversions.Any(c => c.IsString);
        }
    }
    ...
    public bool IsImplicitBoolean
    {
        get
        {
            return this.TypeDeclaration.Schema().IsBooleanType() || this.Conversions.Any(c => c.IsBoolean);
        }
    }
    ...
    public bool HasExclusiveMaximum
    {
        get
        {
            return this.TypeDeclaration.Schema().ExclusiveMaximum.ValueKind == JsonValueKind.True;
        }
    }
    ...
    public bool HasExclusiveMinimum
    {
        get
        {
            return this.TypeDeclaration.Schema().ExclusiveMinimum.ValueKind == JsonValueKind.True;
        }
    }
    ...
    public bool HasSingleItemsType
    {
        get
        {
            return this.TypeDeclaration.Schema().Items.IsNotNullOrUndefined();
        }
    }
    ...
    public bool IsTuple
    {
        get
        {
            // Cannot represent a tuple; no prefixItems equivalanet
            return false;
        }
    }
    ...
    private bool GetIsFixedSizeArray(TypeDeclaration typeDeclaration)
    {
        ...
        if (typeDeclaration.Schema().MinItems.IsUndefined() ||
            ...
            (long)typeDeclaration.Schema().MinItems != (long)typeDeclaration.Schema().MaxItems)
        {
            return false;
        }
    ...
    private bool MatchType(string typeToMatch)
    {
        ...
        {
            return this.TypeDeclaration.Schema().Type == typeToMatch;
        }
