...
public interface IIfThenValidationKeyword : ISingleSubschemaProviderKeyword
{
    ...
    /// </summary>
    /// <param name="typeDeclaration">The type declaration for which to get the then declaration.</param>
    /// <param name="thenDeclaration">The type declaration for the then clause.</param>
