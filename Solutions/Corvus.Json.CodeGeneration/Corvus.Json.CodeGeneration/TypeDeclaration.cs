...
public class TypeDeclaration
{
    ...
    public void SetBuiltInTypeNameAndNamespace()
    {
        if (this.Schema.IsBuiltInType())
        {
            ...
            {
                (ns, type) = BuiltInTypes.GetTypeNameFor(this.Schema.Type.AsSimpleTypesEntity, this.Schema.Format.AsOptionalString(), this.Schema.ContentEncoding.AsOptionalString(), this.Schema.ContentMediaType.AsOptionalString());
            }
