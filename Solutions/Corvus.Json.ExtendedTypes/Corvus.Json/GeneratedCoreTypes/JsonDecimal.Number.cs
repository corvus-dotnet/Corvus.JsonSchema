...
#if NET8_0_OR_GREATER
    : IJsonNumber<Corvus.Json.JsonDecimal>,
      IAdditionOperators<Corvus.Json.JsonDecimal, Corvus.Json.JsonDecimal, Corvus.Json.JsonDecimal>,
      ISubtractionOperators<Corvus.Json.JsonDecimal, Corvus.Json.JsonDecimal, Corvus.Json.JsonDecimal>,
      IMultiplyOperators<Corvus.Json.JsonDecimal, Corvus.Json.JsonDecimal, Corvus.Json.JsonDecimal>,
      IDivisionOperators<Corvus.Json.JsonDecimal, Corvus.Json.JsonDecimal, Corvus.Json.JsonDecimal>,
      IIncrementOperators<Corvus.Json.JsonDecimal>,
      IDecrementOperators<Corvus.Json.JsonDecimal>
#else
    : IJsonNumber<Corvus.Json.JsonDecimal>
#endif
{
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="JsonDecimal"/>.</returns>
    public static explicit operator JsonDecimal(byte value)
    {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="JsonDecimal"/>.</returns>
    public static explicit operator JsonDecimal(short value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="JsonDecimal"/>.</returns>
    public static explicit operator JsonDecimal(int value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="JsonDecimal"/>.</returns>
    public static explicit operator JsonDecimal(long value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="JsonDecimal"/>.</returns>
    public static explicit operator JsonDecimal(Int128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="JsonDecimal"/>.</returns>
    public static explicit operator JsonDecimal(sbyte value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="JsonDecimal"/>.</returns>
    public static explicit operator JsonDecimal(Half value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="JsonDecimal"/>.</returns>
    public static explicit operator JsonDecimal(ushort value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="JsonDecimal"/>.</returns>
    public static explicit operator JsonDecimal(uint value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="JsonDecimal"/>.</returns>
    public static explicit operator JsonDecimal(ulong value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="JsonDecimal"/>.</returns>
    public static explicit operator JsonDecimal(UInt128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
    ...
    public BinaryJsonNumber AsBinaryJsonNumber
    {
        get
        {
            ...
            {
                return BinaryJsonNumber.FromJson(this.jsonElementBacking, BinaryJsonNumber.Kind.Decimal);
            }
    ...
    /// Equality comparison.
    /// </summary>
    /// <param name="other">The <c>decimal</c> with which to compare.</param>
