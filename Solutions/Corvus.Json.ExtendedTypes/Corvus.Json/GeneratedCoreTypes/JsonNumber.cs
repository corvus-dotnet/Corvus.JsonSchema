...

{
    ...
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    public JsonNumber(BinaryJsonNumber value)
    {
    ...
    /// </summary>
    public static string SchemaLocation { get; } = "#/$defs/JsonNumber";
    ...
    public static JsonNumber Parse(string source, JsonDocumentOptions options = default)
    {
    ...
    /// <param name="source">The source of the JSON string to parse.</param>
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    public static JsonNumber Parse(Stream source, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(source, options);
        return new(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="source">The source of the JSON string to parse.</param>
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    public static JsonNumber Parse(ReadOnlyMemory<byte> source, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(source, options);
        return new(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="source">The source of the JSON string to parse.</param>
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    public static JsonNumber Parse(ReadOnlyMemory<char> source, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(source, options);
        return new(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="source">The source of the JSON string to parse.</param>
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    public static JsonNumber Parse(ReadOnlySequence<byte> source, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(source, options);
        return new(jsonDocument.RootElement.Clone());
    }
    ...
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    public static JsonNumber ParseValue(string source)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonNumber>.ParseValue(source);
#else
        return JsonValueHelpers.ParseValue<JsonNumber>(source.AsSpan());
#endif
    }
    ...
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    public static JsonNumber ParseValue(ReadOnlySpan<char> source)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonNumber>.ParseValue(source);
#else
        return JsonValueHelpers.ParseValue<JsonNumber>(source);
#endif
    }
    ...
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    public static JsonNumber ParseValue(ReadOnlySpan<byte> source)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonNumber>.ParseValue(source);
#else
    ...
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    public static JsonNumber ParseValue(ref Utf8JsonReader source)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonNumber>.ParseValue(ref source);
#else
        return JsonValueHelpers.ParseValue<JsonNumber>(ref source);
#endif
    }
    ...
    {
        return
            (obj is IJsonValue jv && this.Equals(jv.As<JsonNumber>())) ||
    ...
    {
        return this.Equals(other.As<JsonNumber>());
    }
