// <copyright file="JsonObjectProperty{T}.cs" company="Endjin Limited">
...
public readonly struct JsonObjectProperty<T>
    where T : struct, IJsonValue<T>
{
    ...
    public JsonObjectProperty(in JsonPropertyName name, in T value)
    {
    ...
    /// <summary>
    /// Convert to a <see cref="JsonObjectProperty"/>.
    /// </summary>
    /// <param name="jsonObjectProperty">The value to convert.</param>
    public static implicit operator JsonObjectProperty(JsonObjectProperty<T> jsonObjectProperty)
    {
        return new(jsonObjectProperty.Name, jsonObjectProperty.Value.AsAny);
    }

    /// <summary>
    /// Convert from a <see cref="JsonObjectProperty"/>.
    /// </summary>
    /// <param name="jsonObjectProperty">The value to convert.</param>
    public static explicit operator JsonObjectProperty<T>(JsonObjectProperty jsonObjectProperty)
    {
        return new(jsonObjectProperty.Name, jsonObjectProperty.Value.As<T>());
    }
    ...
    public static bool operator ==(in JsonObjectProperty<T> left, in JsonObjectProperty<T> right)
    {
    ...
    /// <param name="right">The RHS of the comparison.</param>
    /// <returns>True if they are equal.</returns>
    public static bool operator ==(in JsonObjectProperty<T> left, in JsonObjectProperty right)
    {
        return left.Equals(right);
    }
    ...
    public bool Equals(in JsonObjectProperty<T> other)
    {
