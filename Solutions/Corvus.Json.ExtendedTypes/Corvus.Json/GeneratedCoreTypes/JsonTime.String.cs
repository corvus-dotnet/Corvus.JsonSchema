...
public readonly partial struct JsonTime
    ...
    : IJsonString<Corvus.Json.JsonTime>,
      ISpanFormattable
#else
    : IJsonString<Corvus.Json.JsonTime>
#endif
{
    ...
    public JsonTime(in ReadOnlySpan<char> value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    public JsonTime(in ReadOnlySpan<byte> value)
    {
        this.backing = Backing.String;
        this.jsonElementBacking = default;
    ...
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    public JsonTime(NodaTime.OffsetTime value)
    {
        this.backing = Backing.String;
        this.jsonElementBacking = default;
        this.stringBacking = StandardDateFormat.FormatTime(value);
    }
    ...
    public JsonTime(TimeOnly value)
    {
        this.backing = Backing.String;
        this.jsonElementBacking = default;
        this.stringBacking = StandardDateFormat.FormatTime(new NodaTime.OffsetTime(NodaTime.LocalTime.FromTimeOnly(value), NodaTime.Offset.Zero));
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="JsonTime"/> struct.
    /// </summary>
    /// <param name="value1">The <see cref="TimeOnly"/> from which to construct the instance.</param>
    /// <param name="value2">The <see cref="NodaTime.Offset"/> from which to construct the instance.</param>
    public JsonTime(TimeOnly value1, NodaTime.Offset value2)
    {
        this.backing = Backing.String;
        this.jsonElementBacking = default;
        this.stringBacking = StandardDateFormat.FormatTime(new NodaTime.OffsetTime(NodaTime.LocalTime.FromTimeOnly(value1), value2));
    }
#endif

    /// <summary>
    /// Conversion to <see cref="NodaTime.OffsetTime"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator NodaTime.OffsetTime(JsonTime value)
    {
        return
            value.GetTime();
    }
    ...
    /// <summary>
    /// Conversion from <see cref="NodaTime.OffsetTime"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonTime(in NodaTime.OffsetTime value)
    {
        return new(value);
    }
...
#if NET8_0_OR_GREATER
    /// <summary>
    /// Conversion to <see cref="TimeOnly"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator TimeOnly(JsonTime value)
    {
        return
            new(value.GetTime().TickOfDay);
    }

    /// <summary>
    /// Conversion from <see cref="TimeOnly"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonTime(in TimeOnly value)
    {
        return new(value);
    }
#endif
    ...
    public static explicit operator string(JsonTime value)
    {
    ...
    /// <summary>
    /// Concatenate 2 JSON values, producing an instance of the string type JsonTime.
    /// </summary>
    ...
    public static JsonTime Concatenate<T1, T2>(Span<byte> buffer, in T1 value1, in T2 value2)
    ...
    /// <summary>
    /// Concatenate 3 JSON values, producing an instance of the string type JsonTime.
    /// </summary>
    /// <typeparam name="T1">The type of the 1st value.</typeparam>
    /// <typeparam name="T2">The type of the 2nd value.</typeparam>
    ...
    /// <returns>An instance of this string type.</returns>
    public static JsonTime Concatenate<T1, T2, T3>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3)
        where T1 : struct, IJsonValue<T1>
        where T2 : struct, IJsonValue<T2>
    ...
    /// <summary>
    /// Concatenate 4 JSON values, producing an instance of the string type JsonTime.
    /// </summary>
    /// <typeparam name="T1">The type of the 1st value.</typeparam>
    /// <typeparam name="T2">The type of the 2nd value.</typeparam>
    /// <typeparam name="T3">The type of the 3rd value.</typeparam>
    ...
    /// <returns>An instance of this string type.</returns>
    public static JsonTime Concatenate<T1, T2, T3, T4>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3, in T4 value4)
        where T1 : struct, IJsonValue<T1>
        where T2 : struct, IJsonValue<T2>
        where T3 : struct, IJsonValue<T3>
    ...
    /// <summary>
    /// Concatenate 5 JSON values, producing an instance of the string type JsonTime.
    /// </summary>
    /// <typeparam name="T1">The type of the 1st value.</typeparam>
    /// <typeparam name="T2">The type of the 2nd value.</typeparam>
    /// <typeparam name="T3">The type of the 3rd value.</typeparam>
    ...
    /// <returns>An instance of this string type.</returns>
    public static JsonTime Concatenate<T1, T2, T3, T4, T5>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3, in T4 value4, in T5 value5)
        where T1 : struct, IJsonValue<T1>
        where T2 : struct, IJsonValue<T2>
        where T3 : struct, IJsonValue<T3>
        where T4 : struct, IJsonValue<T4>
    ...
    /// <summary>
    /// Concatenate 6 JSON values, producing an instance of the string type JsonTime.
    /// </summary>
    /// <typeparam name="T1">The type of the 1st value.</typeparam>
    /// <typeparam name="T2">The type of the 2nd value.</typeparam>
    /// <typeparam name="T3">The type of the 3rd value.</typeparam>
    ...
    /// <returns>An instance of this string type.</returns>
    public static JsonTime Concatenate<T1, T2, T3, T4, T5, T6>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3, in T4 value4, in T5 value5, in T6 value6)
        where T1 : struct, IJsonValue<T1>
        where T2 : struct, IJsonValue<T2>
        where T3 : struct, IJsonValue<T3>
        where T4 : struct, IJsonValue<T4>
    ...
    /// <summary>
    /// Concatenate 7 JSON values, producing an instance of the string type JsonTime.
    /// </summary>
    /// <typeparam name="T1">The type of the 1st value.</typeparam>
    /// <typeparam name="T2">The type of the 2nd value.</typeparam>
    /// <typeparam name="T3">The type of the 3rd value.</typeparam>
    ...
    /// <returns>An instance of this string type.</returns>
    public static JsonTime Concatenate<T1, T2, T3, T4, T5, T6, T7>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3, in T4 value4, in T5 value5, in T6 value6, in T7 value7)
        where T1 : struct, IJsonValue<T1>
        where T2 : struct, IJsonValue<T2>
        where T3 : struct, IJsonValue<T3>
        where T4 : struct, IJsonValue<T4>
    ...
    /// <summary>
    /// Concatenate 8 JSON values, producing an instance of the string type JsonTime.
    /// </summary>
    /// <typeparam name="T1">The type of the 1st value.</typeparam>
    /// <typeparam name="T2">The type of the 2nd value.</typeparam>
    /// <typeparam name="T3">The type of the 3rd value.</typeparam>
    ...
    /// <returns>An instance of this string type.</returns>
    public static JsonTime Concatenate<T1, T2, T3, T4, T5, T6, T7, T8>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3, in T4 value4, in T5 value5, in T6 value6, in T7 value7, in T8 value8)
        where T1 : struct, IJsonValue<T1>
        where T2 : struct, IJsonValue<T2>
        where T3 : struct, IJsonValue<T3>
        where T4 : struct, IJsonValue<T4>
    ...
    public bool TryGetTime(out NodaTime.OffsetTime result)
    {
        if (this.jsonElementBacking.ValueKind == JsonValueKind.String)
        {
            return this.jsonElementBacking.TryGetValue(StandardDateFormat.TimeParser, default(object?), out result);
        }

        if ((this.backing & Backing.String) != 0)
        {
            return StandardDateFormat.TimeParser(this.stringBacking.AsSpan(), default, out result);
        }
