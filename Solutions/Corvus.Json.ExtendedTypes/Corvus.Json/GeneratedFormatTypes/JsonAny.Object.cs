// <copyright file="JsonAny.Object.cs" company="Endjin Limited">
...
/// </summary>
public readonly partial struct JsonAny : IJsonObject<JsonAny>
{
    /// <summary>
    ...
    public static implicit operator JsonAny(ImmutableDictionary<JsonPropertyName, JsonAny> value)
    {
        return new(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator ImmutableDictionary<JsonPropertyName, JsonAny>(JsonAny value)
    {
    ...
    public static JsonAny FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
    ...
    /// <param name="source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static JsonAny FromProperties(ImmutableDictionary<JsonPropertyName, JsonAny> source)
    {
        return new(source);
    }
    ...
    /// <param name="source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static JsonAny FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
    ...
    /// <inheritdoc/>
    public JsonAny SetProperty<TValue>(in JsonPropertyName name, TValue value)
    ...
    /// <inheritdoc/>
    public JsonAny RemoveProperty(in JsonPropertyName name)
    {
