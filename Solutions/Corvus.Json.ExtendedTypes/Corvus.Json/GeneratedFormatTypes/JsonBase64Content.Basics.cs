// <copyright file="JsonBase64Content.Basics.cs" company="Endjin Limited">
...
public readonly partial struct JsonBase64Content
{
    ...
    public JsonBase64Content(in ReadOnlySpan<byte> utf8Value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.String;
...
#else
        return JsonValueHelpers.ParseValue<JsonBase64Content>(buffer[..written]);
#endif
    }
