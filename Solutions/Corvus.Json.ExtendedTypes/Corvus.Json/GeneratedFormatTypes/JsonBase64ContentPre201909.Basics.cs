// <copyright file="JsonBase64ContentPre201909.Basics.cs" company="Endjin Limited">
...
public readonly partial struct JsonBase64ContentPre201909
{
    ...
    public JsonBase64ContentPre201909(in ReadOnlySpan<byte> utf8Value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.String;
    ...
    {
        return JsonBase64ContentPre201909.FromAny(value);
    }
    ...
    public static implicit operator string(JsonBase64ContentPre201909 value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonBase64ContentPre201909(ReadOnlySpan<char> value)
    {
        return new(value);
    }
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <exception cref="InvalidOperationException">The value was not a string.</exception>
    public static implicit operator ReadOnlySpan<char>(JsonBase64ContentPre201909 value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonBase64ContentPre201909(ReadOnlySpan<byte> value)
    {
        return new(value);
    }
