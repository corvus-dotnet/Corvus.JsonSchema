// <copyright file="JsonBase64ContentPre201909.Core.cs" company="Endjin Limited">
...
public readonly partial struct JsonBase64ContentPre201909
    ...
    : IJsonString<JsonBase64ContentPre201909>, ISpanFormattable
#else
    : IJsonString<JsonBase64ContentPre201909>
#endif
{
    ...
    /// </summary>
    public JsonBase64ContentPre201909()
    {
    ...
    public JsonBase64ContentPre201909(in JsonElement value)
    {
    ...
    /// </summary>
    public static JsonBase64ContentPre201909 Null { get; } = new(JsonValueHelpers.NullElement);
    ...
    public static bool operator ==(in JsonBase64ContentPre201909 left, in JsonBase64ContentPre201909 right)
    {
    ...
    public static JsonBase64ContentPre201909 FromAny(in JsonAny value)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonBase64ContentPre201909 FromJson(in JsonElement value)
    {
        return new(value);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonBase64ContentPre201909 FromString<TValue>(in TValue value)
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonBase64ContentPre201909 IJsonValue<JsonBase64ContentPre201909>.FromBoolean<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonBase64ContentPre201909 IJsonValue<JsonBase64ContentPre201909>.FromNumber<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonBase64ContentPre201909 IJsonValue<JsonBase64ContentPre201909>.FromArray<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonBase64ContentPre201909 IJsonValue<JsonBase64ContentPre201909>.FromObject<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <returns>A <see cref="JsonBase64ContentPre201909"/> instance built from the JSON string.</returns>
    public static JsonBase64ContentPre201909 Parse(string json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonBase64ContentPre201909(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonBase64ContentPre201909"/> instance built from the JSON string.</returns>
    public static JsonBase64ContentPre201909 Parse(Stream utf8Json, JsonDocumentOptions options = default)
    {
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonBase64ContentPre201909"/> instance built from the JSON string.</returns>
    public static JsonBase64ContentPre201909 Parse(ReadOnlyMemory<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonBase64ContentPre201909(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonBase64ContentPre201909"/> instance built from the JSON string.</returns>
    public static JsonBase64ContentPre201909 Parse(ReadOnlyMemory<char> json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonBase64ContentPre201909(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonBase64ContentPre201909"/> instance built from the JSON string.</returns>
    public static JsonBase64ContentPre201909 Parse(ReadOnlySequence<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonBase64ContentPre201909(jsonDocument.RootElement.Clone());
    }
    ...
    public bool Equals(in JsonBase64ContentPre201909 other)
    {
        return JsonValueHelpers.CompareValues(this, other);
    }
    ...
    {
        return Json.Validate.TypeBase64ContentPre201909(this, validationContext, level);
    }
