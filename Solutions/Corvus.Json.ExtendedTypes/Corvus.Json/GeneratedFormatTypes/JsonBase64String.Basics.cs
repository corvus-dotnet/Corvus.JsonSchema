// <copyright file="JsonBase64String.Basics.cs" company="Endjin Limited">
...
/// </summary>
[System.Text.Json.Serialization.JsonConverter(typeof(Corvus.Json.Internal.JsonValueConverter<JsonBase64String>))]
public readonly partial struct JsonBase64String
{
    ...
    public JsonBase64String(in ReadOnlySpan<byte> utf8Value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.String;
...
#else
        return JsonValueHelpers.ParseValue<JsonBase64String>(buffer[..written]);
#endif
    }
