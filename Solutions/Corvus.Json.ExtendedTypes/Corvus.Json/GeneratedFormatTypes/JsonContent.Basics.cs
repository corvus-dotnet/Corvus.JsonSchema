// <copyright file="JsonContent.Basics.cs" company="Endjin Limited">
...
/// </summary>
[System.Text.Json.Serialization.JsonConverter(typeof(Corvus.Json.Internal.JsonValueConverter<JsonContent>))]
public readonly partial struct JsonContent
{
    ...
    public JsonContent(in ReadOnlySpan<byte> utf8Value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.String;
    ...
    {
        return JsonContent.FromAny(value);
    }
    ...
    public static JsonContent ParseValue(ReadOnlySpan<char> buffer)
    {
        return IJsonValue<JsonContent>.ParseValue(buffer);
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonContent ParseValue(ReadOnlySpan<byte> buffer)
    {
        return IJsonValue<JsonContent>.ParseValue(buffer);
    }
    ...
    /// <returns>The parsed value.</returns>
    public static JsonContent ParseValue(ref Utf8JsonReader reader)
    {
        return IJsonValue<JsonContent>.ParseValue(ref reader);
    }
