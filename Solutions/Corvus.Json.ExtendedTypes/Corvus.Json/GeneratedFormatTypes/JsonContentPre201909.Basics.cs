// <copyright file="JsonContentPre201909.Basics.cs" company="Endjin Limited">
...
public readonly partial struct JsonContentPre201909
{
    ...
    public JsonContentPre201909(in ReadOnlySpan<byte> utf8Value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.String;
    ...
    {
        return JsonContentPre201909.FromAny(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonContentPre201909(ReadOnlySpan<char> value)
    {
        return new(value);
    }
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <exception cref="InvalidOperationException">The value was not a string.</exception>
    public static implicit operator ReadOnlySpan<char>(JsonContentPre201909 value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonContentPre201909(ReadOnlySpan<byte> value)
    {
        return new(value);
    }
