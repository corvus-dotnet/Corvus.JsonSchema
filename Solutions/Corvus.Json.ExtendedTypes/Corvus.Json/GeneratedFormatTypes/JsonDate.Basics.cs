// <copyright file="JsonDate.Basics.cs" company="Endjin Limited">
...
/// </summary>
[System.Text.Json.Serialization.JsonConverter(typeof(Corvus.Json.Internal.JsonValueConverter<JsonDate>))]
public readonly partial struct JsonDate
{
    ...
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    public JsonDate(in ReadOnlySpan<char> value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.String;
    ...
    public JsonDate(in ReadOnlySpan<byte> utf8Value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.String;
    ...
    public static explicit operator string(JsonDate value)
    {
    ...
    public static JsonDate ParseValue(ReadOnlySpan<char> buffer)
    {
        return IJsonValue<JsonDate>.ParseValue(buffer);
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonDate ParseValue(ReadOnlySpan<byte> buffer)
    {
        return IJsonValue<JsonDate>.ParseValue(buffer);
    }
    ...
    /// <returns>The parsed value.</returns>
    public static JsonDate ParseValue(ref Utf8JsonReader reader)
    {
        return IJsonValue<JsonDate>.ParseValue(ref reader);
    }
