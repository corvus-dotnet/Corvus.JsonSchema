// <copyright file="JsonDateTime.Basics.cs" company="Endjin Limited">
...
public readonly partial struct JsonDateTime
{
    ...
    public JsonDateTime(in ReadOnlySpan<byte> utf8Value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.String;
...
#else
        return JsonValueHelpers.ParseValue<JsonDateTime>(buffer[..written]);
#endif
    }
