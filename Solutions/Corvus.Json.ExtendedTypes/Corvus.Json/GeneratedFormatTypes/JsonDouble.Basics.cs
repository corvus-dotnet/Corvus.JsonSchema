// <copyright file="JsonDouble.Basics.cs" company="Endjin Limited">
...
public readonly partial struct JsonDouble
 : IAdditionOperators<JsonDouble, JsonDouble, JsonDouble>,
   ISubtractionOperators<JsonDouble, JsonDouble, JsonDouble>,
   IMultiplyOperators<JsonDouble, JsonDouble, JsonDouble>,
   IDivisionOperators<JsonDouble, JsonDouble, JsonDouble>,
   IIncrementOperators<JsonDouble>,
   IDecrementOperators<JsonDouble>
{
    /// <summary>
    ...
    public static implicit operator JsonDouble(JsonNumber value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonNumber(JsonDouble value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonAny(JsonDouble value)
    {
        return value.AsAny;
    }
    ...
    public static explicit operator byte(JsonDouble value)
    {
    ...
    public static explicit operator decimal(JsonDouble value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator short(JsonDouble value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator int(JsonDouble value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator long(JsonDouble value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an Int64.</exception>
    public static explicit operator Int128(JsonDouble value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator sbyte(JsonDouble value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator Half(JsonDouble value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as a Single.</exception>
    public static explicit operator float(JsonDouble value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator ushort(JsonDouble value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator uint(JsonDouble value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator ulong(JsonDouble value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an UInt64.</exception>
    public static explicit operator UInt128(JsonDouble value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static JsonDouble operator +(JsonDouble left, JsonDouble right)
    {
    ...
    /// <returns>The resulting value.</returns>
    public static JsonDouble operator ++(JsonDouble value)
    {
