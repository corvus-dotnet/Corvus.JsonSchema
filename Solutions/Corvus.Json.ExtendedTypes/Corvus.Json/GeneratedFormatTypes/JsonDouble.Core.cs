// <copyright file="JsonDouble.Core.cs" company="Endjin Limited">
...
/// Represents a double.
/// </summary>
[System.Text.Json.Serialization.JsonConverter(typeof(Corvus.Json.Internal.JsonValueConverter<JsonDouble>))]
public readonly partial struct JsonDouble : IJsonNumber<JsonDouble>
{
    ...
    public JsonDouble(in JsonElement value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    public JsonDouble(in BinaryJsonNumber value)
    {
        this.jsonElementBacking = default;
    ...
    /// </summary>
    public static JsonDouble Null { get; } = new(JsonValueHelpers.NullElement);

    /// <summary>
    /// Gets an Undefined instance.
    /// </summary>
    public static JsonDouble Undefined { get; }
    ...
    public static int Compare(in JsonDouble lhs, in JsonDouble rhs)
    {
    ...
    public static JsonDouble FromAny(in JsonAny value)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonDouble FromJson(in JsonElement value)
    {
        return new(value);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonDouble IJsonValue<JsonDouble>.FromString<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonDouble IJsonValue<JsonDouble>.FromBoolean<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonDouble FromNumber<TValue>(in TValue value)
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonDouble IJsonValue<JsonDouble>.FromArray<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonDouble IJsonValue<JsonDouble>.FromObject<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <returns>A <see cref="JsonDouble"/> instance built from the JSON string.</returns>
    public static JsonDouble Parse(string json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonDouble(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonDouble"/> instance built from the JSON string.</returns>
    public static JsonDouble Parse(Stream utf8Json, JsonDocumentOptions options = default)
    {
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonDouble"/> instance built from the JSON string.</returns>
    public static JsonDouble Parse(ReadOnlyMemory<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonDouble(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonDouble"/> instance built from the JSON string.</returns>
    public static JsonDouble Parse(ReadOnlyMemory<char> json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonDouble(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonDouble"/> instance built from the JSON string.</returns>
    public static JsonDouble Parse(ReadOnlySequence<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonDouble(jsonDocument.RootElement.Clone());
    }
    ...
    public static JsonDouble ParseValue(string buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonDouble>.ParseValue(buffer);
#else
        return JsonValueHelpers.ParseValue<JsonDouble>(buffer.AsSpan());
#endif
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonDouble ParseValue(ReadOnlySpan<char> buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonDouble>.ParseValue(buffer);
#else
        return JsonValueHelpers.ParseValue<JsonDouble>(buffer);
#endif
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonDouble ParseValue(ReadOnlySpan<byte> buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonDouble>.ParseValue(buffer);
#else
    ...
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonDouble>.ParseValue(ref reader);
#else
        return JsonValueHelpers.ParseValue<JsonDouble>(ref reader);
#endif
    }
...
#else
        return this.As<JsonDouble, TTarget>();
#endif
    }
    ...
    public bool Equals(in JsonDouble other)
    {
        return JsonValueHelpers.CompareValues(this, other);
    }
    ...
    {
        return Json.Validate.TypeDouble(this, validationContext, level);
    }
}