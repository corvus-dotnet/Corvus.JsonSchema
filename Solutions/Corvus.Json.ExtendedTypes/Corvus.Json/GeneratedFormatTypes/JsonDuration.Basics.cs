// <copyright file="JsonDuration.Basics.cs" company="Endjin Limited">
...
public readonly partial struct JsonDuration
{
    ...
    public JsonDuration(in ReadOnlySpan<byte> utf8Value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.String;
...
#else
        return JsonValueHelpers.ParseValue<JsonDuration>(buffer[..written]);
#endif
    }
