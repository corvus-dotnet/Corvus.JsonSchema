// <copyright file="JsonHalf.Core.cs" company="Endjin Limited">
...
public readonly partial struct JsonHalf : IJsonNumber<JsonHalf>
{
    ...
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    public JsonHalf(in BinaryJsonNumber value)
    {
        this.jsonElementBacking = default;
    ...
    /// <returns>A <see cref="JsonHalf"/> instance built from the JSON string.</returns>
    public static JsonHalf Parse(string json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonHalf(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonHalf"/> instance built from the JSON string.</returns>
    public static JsonHalf Parse(Stream utf8Json, JsonDocumentOptions options = default)
    {
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonHalf"/> instance built from the JSON string.</returns>
    public static JsonHalf Parse(ReadOnlyMemory<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonHalf(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonHalf"/> instance built from the JSON string.</returns>
    public static JsonHalf Parse(ReadOnlyMemory<char> json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonHalf(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonHalf"/> instance built from the JSON string.</returns>
    public static JsonHalf Parse(ReadOnlySequence<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonHalf(jsonDocument.RootElement.Clone());
    }
    ...
    public static JsonHalf ParseValue(ReadOnlySpan<char> buffer)
    {
        ...
        return IJsonValue<JsonHalf>.ParseValue(buffer);
#else
        return JsonValueHelpers.ParseValue<JsonHalf>(buffer);
#endif
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonHalf ParseValue(ReadOnlySpan<byte> buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonHalf>.ParseValue(buffer);
#else
    ...
    /// <returns>The parsed value.</returns>
    public static JsonHalf ParseValue(ref Utf8JsonReader reader)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonHalf>.ParseValue(ref reader);
#else
        return JsonValueHelpers.ParseValue<JsonHalf>(ref reader);
#endif
    }
    ...
    {
        return Json.Validate.TypeHalf(this, validationContext, level);
    }
}