// <copyright file="JsonHostname.Basics.cs" company="Endjin Limited">
...
public readonly partial struct JsonHostname
{
    ...
    public JsonHostname(in ReadOnlySpan<byte> utf8Value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.String;
...
#else
        return JsonValueHelpers.ParseValue<JsonHostname>(buffer[..written]);
#endif
    }
