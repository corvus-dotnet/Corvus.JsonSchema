// <copyright file="JsonIdnEmail.Basics.cs" company="Endjin Limited">
...
/// </summary>
[System.Text.Json.Serialization.JsonConverter(typeof(Corvus.Json.Internal.JsonValueConverter<JsonIdnEmail>))]
public readonly partial struct JsonIdnEmail
{
    /// <summary>
    ...
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    public JsonIdnEmail(in ReadOnlySpan<char> value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.String;
    ...
    public JsonIdnEmail(in ReadOnlySpan<byte> utf8Value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.String;
    ...
    {
        return JsonIdnEmail.FromAny(value);
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonIdnEmail ParseValue(ReadOnlySpan<byte> buffer)
    {
        return IJsonValue<JsonIdnEmail>.ParseValue(buffer);
    }
    ...
    /// <returns>The parsed value.</returns>
    public static JsonIdnEmail ParseValue(ref Utf8JsonReader reader)
    {
        return IJsonValue<JsonIdnEmail>.ParseValue(ref reader);
    }
