// <copyright file="JsonIdnHostname.Basics.cs" company="Endjin Limited">
...
public readonly partial struct JsonIdnHostname
{
    ...
    public JsonIdnHostname(in ReadOnlySpan<byte> utf8Value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.String;
...
#else
        return JsonValueHelpers.ParseValue<JsonIdnHostname>(buffer[..written]);
#endif
    }
