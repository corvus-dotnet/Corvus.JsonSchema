// <copyright file="JsonInt128.Core.cs" company="Endjin Limited">
...
/// Represents a int128.
/// </summary>
[System.Text.Json.Serialization.JsonConverter(typeof(Corvus.Json.Internal.JsonValueConverter<JsonInt128>))]
public readonly partial struct JsonInt128 : IJsonNumber<JsonInt128>
{
    ...
    public JsonInt128(in JsonElement value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    public JsonInt128(in BinaryJsonNumber value)
    {
        this.jsonElementBacking = default;
    ...
    /// </summary>
    public static JsonInt128 Null { get; } = new(JsonValueHelpers.NullElement);

    /// <summary>
    /// Gets an Undefined instance.
    /// </summary>
    public static JsonInt128 Undefined { get; }

    /// <summary>
    /// Gets a default instance.
    /// </summary>
    public static JsonInt128 DefaultInstance { get; }
    ...
    public static bool operator ==(in JsonInt128 left, in JsonInt128 right)
    {
    ...
    public static int Compare(in JsonInt128 lhs, in JsonInt128 rhs)
    {
    ...
    public static JsonInt128 FromAny(in JsonAny value)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonInt128 FromJson(in JsonElement value)
    {
        return new(value);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonInt128 IJsonValue<JsonInt128>.FromString<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonInt128 IJsonValue<JsonInt128>.FromBoolean<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonInt128 FromNumber<TValue>(in TValue value)
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonInt128 IJsonValue<JsonInt128>.FromArray<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonInt128 IJsonValue<JsonInt128>.FromObject<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <returns>A <see cref="JsonInt128"/> instance built from the JSON string.</returns>
    public static JsonInt128 Parse(string json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonInt128(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonInt128"/> instance built from the JSON string.</returns>
    public static JsonInt128 Parse(Stream utf8Json, JsonDocumentOptions options = default)
    {
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonInt128"/> instance built from the JSON string.</returns>
    public static JsonInt128 Parse(ReadOnlyMemory<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonInt128(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonInt128"/> instance built from the JSON string.</returns>
    public static JsonInt128 Parse(ReadOnlyMemory<char> json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonInt128(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonInt128"/> instance built from the JSON string.</returns>
    public static JsonInt128 Parse(ReadOnlySequence<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonInt128(jsonDocument.RootElement.Clone());
    }
    ...
    public static JsonInt128 ParseValue(ReadOnlySpan<char> buffer)
    {
        ...
        return IJsonValue<JsonInt128>.ParseValue(buffer);
#else
        return JsonValueHelpers.ParseValue<JsonInt128>(buffer);
#endif
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonInt128 ParseValue(ReadOnlySpan<byte> buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonInt128>.ParseValue(buffer);
#else
    ...
    /// <returns>The parsed value.</returns>
    public static JsonInt128 ParseValue(ref Utf8JsonReader reader)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonInt128>.ParseValue(ref reader);
#else
        return JsonValueHelpers.ParseValue<JsonInt128>(ref reader);
#endif
    }
...
#else
        return this.As<JsonInt128, TTarget>();
#endif
    }
    ...
    public bool Equals(in JsonInt128 other)
    {
        return JsonValueHelpers.CompareValues(this, other);
    }
    ...
    {
        return Json.Validate.TypeInt128(this, validationContext, level);
    }
}