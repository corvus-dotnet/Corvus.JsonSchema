// <copyright file="JsonInt16.Core.cs" company="Endjin Limited">
...
public readonly partial struct JsonInt16 : IJsonNumber<JsonInt16>
{
    ...
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    public JsonInt16(in BinaryJsonNumber value)
    {
        this.jsonElementBacking = default;
    ...
    public static int Compare(in JsonInt16 lhs, in JsonInt16 rhs)
    {
    ...
    /// <returns>A <see cref="JsonInt16"/> instance built from the JSON string.</returns>
    public static JsonInt16 Parse(string json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonInt16(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonInt16"/> instance built from the JSON string.</returns>
    public static JsonInt16 Parse(Stream utf8Json, JsonDocumentOptions options = default)
    {
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonInt16"/> instance built from the JSON string.</returns>
    public static JsonInt16 Parse(ReadOnlyMemory<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonInt16(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonInt16"/> instance built from the JSON string.</returns>
    public static JsonInt16 Parse(ReadOnlyMemory<char> json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonInt16(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonInt16"/> instance built from the JSON string.</returns>
    public static JsonInt16 Parse(ReadOnlySequence<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonInt16(jsonDocument.RootElement.Clone());
    }
    ...
    public static JsonInt16 ParseValue(string buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonInt16>.ParseValue(buffer);
#else
        return JsonValueHelpers.ParseValue<JsonInt16>(buffer.AsSpan());
#endif
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonInt16 ParseValue(ReadOnlySpan<char> buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonInt16>.ParseValue(buffer);
#else
        return JsonValueHelpers.ParseValue<JsonInt16>(buffer);
#endif
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonInt16 ParseValue(ReadOnlySpan<byte> buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonInt16>.ParseValue(buffer);
#else
    ...
    /// <returns>The parsed value.</returns>
    public static JsonInt16 ParseValue(ref Utf8JsonReader reader)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonInt16>.ParseValue(ref reader);
#else
        return JsonValueHelpers.ParseValue<JsonInt16>(ref reader);
#endif
    }
    ...
    {
        return Json.Validate.TypeInt16(this, validationContext, level);
    }
}