// <copyright file="JsonInt64.Core.cs" company="Endjin Limited">
...
/// Represents a int64.
/// </summary>
[System.Text.Json.Serialization.JsonConverter(typeof(Corvus.Json.Internal.JsonValueConverter<JsonInt64>))]
public readonly partial struct JsonInt64 : IJsonNumber<JsonInt64>
{
    ...
    public JsonInt64(in JsonElement value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    public JsonInt64(in BinaryJsonNumber value)
    {
        this.jsonElementBacking = default;
    ...
    /// </summary>
    public static JsonInt64 Null { get; } = new(JsonValueHelpers.NullElement);

    /// <summary>
    /// Gets an Undefined instance.
    /// </summary>
    public static JsonInt64 Undefined { get; }
    ...
    public static JsonInt64 FromAny(in JsonAny value)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonInt64 FromJson(in JsonElement value)
    {
        return new(value);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonInt64 IJsonValue<JsonInt64>.FromString<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonInt64 IJsonValue<JsonInt64>.FromBoolean<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonInt64 FromNumber<TValue>(in TValue value)
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonInt64 IJsonValue<JsonInt64>.FromArray<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonInt64 IJsonValue<JsonInt64>.FromObject<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <returns>A <see cref="JsonInt64"/> instance built from the JSON string.</returns>
    public static JsonInt64 Parse(string json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonInt64(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonInt64"/> instance built from the JSON string.</returns>
    public static JsonInt64 Parse(Stream utf8Json, JsonDocumentOptions options = default)
    {
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonInt64"/> instance built from the JSON string.</returns>
    public static JsonInt64 Parse(ReadOnlyMemory<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonInt64(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonInt64"/> instance built from the JSON string.</returns>
    public static JsonInt64 Parse(ReadOnlyMemory<char> json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonInt64(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonInt64"/> instance built from the JSON string.</returns>
    public static JsonInt64 Parse(ReadOnlySequence<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonInt64(jsonDocument.RootElement.Clone());
    }
    ...
    public static JsonInt64 ParseValue(string buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonInt64>.ParseValue(buffer);
#else
        return JsonValueHelpers.ParseValue<JsonInt64>(buffer.AsSpan());
#endif
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonInt64 ParseValue(ReadOnlySpan<char> buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonInt64>.ParseValue(buffer);
#else
        return JsonValueHelpers.ParseValue<JsonInt64>(buffer);
#endif
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonInt64 ParseValue(ReadOnlySpan<byte> buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonInt64>.ParseValue(buffer);
#else
    ...
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonInt64>.ParseValue(ref reader);
#else
        return JsonValueHelpers.ParseValue<JsonInt64>(ref reader);
#endif
    }
...
#else
        return this.As<JsonInt64, TTarget>();
#endif
    }
    ...
    public bool Equals(in JsonInt64 other)
    {
        return JsonValueHelpers.CompareValues(this, other);
    }
    ...
    {
        return Json.Validate.TypeInt64(this, validationContext, level);
    }
}