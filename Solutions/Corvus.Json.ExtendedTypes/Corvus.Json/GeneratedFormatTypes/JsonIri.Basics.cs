// <copyright file="JsonIri.Basics.cs" company="Endjin Limited">
...
public readonly partial struct JsonIri
{
    ...
    public JsonIri(in ReadOnlySpan<byte> utf8Value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.String;
...
#else
        return JsonValueHelpers.ParseValue<JsonIri>(buffer[..written]);
#endif
    }
