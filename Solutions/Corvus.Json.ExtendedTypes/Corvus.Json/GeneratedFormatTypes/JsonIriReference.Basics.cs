// <copyright file="JsonIriReference.Basics.cs" company="Endjin Limited">
...
/// </summary>
[System.Text.Json.Serialization.JsonConverter(typeof(Corvus.Json.Internal.JsonValueConverter<JsonIriReference>))]
public readonly partial struct JsonIriReference
{
    ...
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    public JsonIriReference(in ReadOnlySpan<char> value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.String;
    ...
    public JsonIriReference(in ReadOnlySpan<byte> utf8Value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.String;
    ...
    {
        return JsonIriReference.FromAny(value);
    }
