// <copyright file="JsonNotAny.String.cs" company="Endjin Limited">
...
/// </summary>
public readonly partial struct JsonNotAny : IJsonString<JsonNotAny>
{
    /// <summary>
    ...
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    public JsonNotAny(in ReadOnlySpan<char> value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.String;
    ...
    public JsonNotAny(in ReadOnlySpan<byte> utf8Value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.String;
