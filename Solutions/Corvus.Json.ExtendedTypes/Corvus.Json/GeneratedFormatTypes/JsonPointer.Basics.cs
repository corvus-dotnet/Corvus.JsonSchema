// <copyright file="JsonPointer.Basics.cs" company="Endjin Limited">
...
public readonly partial struct JsonPointer
{
    ...
    public JsonPointer(in ReadOnlySpan<byte> utf8Value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.String;
...
#else
        return JsonValueHelpers.ParseValue<JsonPointer>(buffer[..written]);
#endif
    }
