// <copyright file="JsonRegex.Basics.cs" company="Endjin Limited">
...
/// </summary>
[System.Text.Json.Serialization.JsonConverter(typeof(Corvus.Json.Internal.JsonValueConverter<JsonRegex>))]
public readonly partial struct JsonRegex
{
    ...
    public JsonRegex(in ReadOnlySpan<byte> utf8Value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.String;
...
#else
        return JsonValueHelpers.ParseValue<JsonRegex>(buffer[..written]);
#endif
    }
