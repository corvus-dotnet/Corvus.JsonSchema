...
public readonly partial struct JsonRegex
    ...
    : IJsonString<JsonRegex>, ISpanFormattable
#else
    : IJsonString<JsonRegex>
#endif
{
    ...
    public static JsonRegex ParseValue(ReadOnlySpan<char> buffer)
    {
        ...
        return IJsonValue<JsonRegex>.ParseValue(buffer);
#else
        return JsonValueHelpers.ParseValue<JsonRegex>(buffer);
#endif
    }
...
#else
        return JsonValueHelpers.ParseValue<JsonRegex>(ref reader);
#endif
    }
