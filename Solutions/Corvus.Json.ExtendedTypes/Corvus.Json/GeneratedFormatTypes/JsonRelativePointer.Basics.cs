// <copyright file="JsonRelativePointer.Basics.cs" company="Endjin Limited">
...
public readonly partial struct JsonRelativePointer
{
    ...
    public JsonRelativePointer(in ReadOnlySpan<byte> utf8Value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.String;
...
#else
        return JsonValueHelpers.ParseValue<JsonRelativePointer>(buffer[..written]);
#endif
    }
