// <copyright file="JsonSByte.Core.cs" company="Endjin Limited">
...
public readonly partial struct JsonSByte : IJsonNumber<JsonSByte>
{
    ...
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    public JsonSByte(in BinaryJsonNumber value)
    {
        this.jsonElementBacking = default;
    ...
    /// <returns>A <see cref="JsonSByte"/> instance built from the JSON string.</returns>
    public static JsonSByte Parse(string json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonSByte(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonSByte"/> instance built from the JSON string.</returns>
    public static JsonSByte Parse(Stream utf8Json, JsonDocumentOptions options = default)
    {
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonSByte"/> instance built from the JSON string.</returns>
    public static JsonSByte Parse(ReadOnlyMemory<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonSByte(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonSByte"/> instance built from the JSON string.</returns>
    public static JsonSByte Parse(ReadOnlyMemory<char> json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonSByte(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonSByte"/> instance built from the JSON string.</returns>
    public static JsonSByte Parse(ReadOnlySequence<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonSByte(jsonDocument.RootElement.Clone());
    }
    ...
    public static JsonSByte ParseValue(string buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonSByte>.ParseValue(buffer);
#else
        return JsonValueHelpers.ParseValue<JsonSByte>(buffer.AsSpan());
#endif
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonSByte ParseValue(ReadOnlySpan<char> buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonSByte>.ParseValue(buffer);
#else
        return JsonValueHelpers.ParseValue<JsonSByte>(buffer);
#endif
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonSByte ParseValue(ReadOnlySpan<byte> buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonSByte>.ParseValue(buffer);
#else
    ...
    /// <returns>The parsed value.</returns>
    public static JsonSByte ParseValue(ref Utf8JsonReader reader)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonSByte>.ParseValue(ref reader);
#else
        return JsonValueHelpers.ParseValue<JsonSByte>(ref reader);
#endif
    }
    ...
    {
        return Json.Validate.TypeSByte(this, validationContext, level);
    }
}