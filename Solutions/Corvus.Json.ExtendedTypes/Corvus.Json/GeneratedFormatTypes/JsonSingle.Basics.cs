// <copyright file="JsonSingle.Basics.cs" company="Endjin Limited">
...
#endif
{
    ...
    public static implicit operator JsonSingle(JsonNumber value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonNumber(JsonSingle value)
    {
    ...
    public static explicit operator byte(JsonSingle value)
    {
    ...
    public static explicit operator decimal(JsonSingle value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator double(JsonSingle value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator short(JsonSingle value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator int(JsonSingle value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator long(JsonSingle value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an Int64.</exception>
    public static explicit operator Int128(JsonSingle value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator sbyte(JsonSingle value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator Half(JsonSingle value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as a Single.</exception>
    public static implicit operator float(JsonSingle value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator ushort(JsonSingle value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator uint(JsonSingle value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator ulong(JsonSingle value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an UInt64.</exception>
    public static explicit operator UInt128(JsonSingle value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static implicit operator JsonSingle(float value)
    {
    ...
    public static JsonSingle operator +(JsonSingle left, JsonSingle right)
    {
    ...
    /// <returns>The resulting value.</returns>
    public static JsonSingle operator ++(JsonSingle value)
    {
