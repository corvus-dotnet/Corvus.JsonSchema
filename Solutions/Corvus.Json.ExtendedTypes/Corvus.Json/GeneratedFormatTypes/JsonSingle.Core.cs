// <copyright file="JsonSingle.Core.cs" company="Endjin Limited">
...
public readonly partial struct JsonSingle : IJsonNumber<JsonSingle>
{
    ...
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    public JsonSingle(in BinaryJsonNumber value)
    {
        this.jsonElementBacking = default;
    ...
    /// <returns>A <see cref="JsonSingle"/> instance built from the JSON string.</returns>
    public static JsonSingle Parse(string json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonSingle(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonSingle"/> instance built from the JSON string.</returns>
    public static JsonSingle Parse(Stream utf8Json, JsonDocumentOptions options = default)
    {
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonSingle"/> instance built from the JSON string.</returns>
    public static JsonSingle Parse(ReadOnlyMemory<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonSingle(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonSingle"/> instance built from the JSON string.</returns>
    public static JsonSingle Parse(ReadOnlyMemory<char> json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonSingle(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonSingle"/> instance built from the JSON string.</returns>
    public static JsonSingle Parse(ReadOnlySequence<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonSingle(jsonDocument.RootElement.Clone());
    }
    ...
    public static JsonSingle ParseValue(string buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonSingle>.ParseValue(buffer);
#else
        return JsonValueHelpers.ParseValue<JsonSingle>(buffer.AsSpan());
#endif
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonSingle ParseValue(ReadOnlySpan<char> buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonSingle>.ParseValue(buffer);
#else
        return JsonValueHelpers.ParseValue<JsonSingle>(buffer);
#endif
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonSingle ParseValue(ReadOnlySpan<byte> buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonSingle>.ParseValue(buffer);
#else
    ...
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonSingle>.ParseValue(ref reader);
#else
        return JsonValueHelpers.ParseValue<JsonSingle>(ref reader);
#endif
    }
    ...
    {
        return Json.Validate.TypeSingle(this, validationContext, level);
    }
}