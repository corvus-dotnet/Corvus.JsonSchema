// <copyright file="JsonUInt128.Core.cs" company="Endjin Limited">
...
public readonly partial struct JsonUInt128 : IJsonNumber<JsonUInt128>
{
    ...
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    public JsonUInt128(in BinaryJsonNumber value)
    {
        this.jsonElementBacking = default;
    ...
    /// <returns>A <see cref="JsonUInt128"/> instance built from the JSON string.</returns>
    public static JsonUInt128 Parse(string json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonUInt128(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonUInt128"/> instance built from the JSON string.</returns>
    public static JsonUInt128 Parse(Stream utf8Json, JsonDocumentOptions options = default)
    {
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonUInt128"/> instance built from the JSON string.</returns>
    public static JsonUInt128 Parse(ReadOnlyMemory<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonUInt128(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonUInt128"/> instance built from the JSON string.</returns>
    public static JsonUInt128 Parse(ReadOnlyMemory<char> json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonUInt128(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonUInt128"/> instance built from the JSON string.</returns>
    public static JsonUInt128 Parse(ReadOnlySequence<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonUInt128(jsonDocument.RootElement.Clone());
    }
    ...
    public static JsonUInt128 ParseValue(string buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonUInt128>.ParseValue(buffer);
#else
        return JsonValueHelpers.ParseValue<JsonUInt128>(buffer.AsSpan());
#endif
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonUInt128 ParseValue(ReadOnlySpan<char> buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonUInt128>.ParseValue(buffer);
#else
        return JsonValueHelpers.ParseValue<JsonUInt128>(buffer);
#endif
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonUInt128 ParseValue(ReadOnlySpan<byte> buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonUInt128>.ParseValue(buffer);
#else
    ...
    /// <returns>The parsed value.</returns>
    public static JsonUInt128 ParseValue(ref Utf8JsonReader reader)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonUInt128>.ParseValue(ref reader);
#else
        return JsonValueHelpers.ParseValue<JsonUInt128>(ref reader);
#endif
    }
    ...
    {
        return Json.Validate.TypeUInt128(this, validationContext, level);
    }
}