// <copyright file="JsonUInt16.Core.cs" company="Endjin Limited">
...
/// Represents a uint16.
/// </summary>
[System.Text.Json.Serialization.JsonConverter(typeof(Corvus.Json.Internal.JsonValueConverter<JsonUInt16>))]
public readonly partial struct JsonUInt16 : IJsonNumber<JsonUInt16>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="JsonUInt16"/> struct.
    /// </summary>
    public JsonUInt16()
    {
    ...
    public JsonUInt16(in JsonElement value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    public JsonUInt16(in BinaryJsonNumber value)
    {
        this.jsonElementBacking = default;
    ...
    /// </summary>
    public static JsonUInt16 Null { get; } = new(JsonValueHelpers.NullElement);

    /// <summary>
    /// Gets an Undefined instance.
    /// </summary>
    public static JsonUInt16 Undefined { get; }

    /// <summary>
    /// Gets a default instance.
    /// </summary>
    public static JsonUInt16 DefaultInstance { get; }
    ...
    public static bool operator ==(in JsonUInt16 left, in JsonUInt16 right)
    {
    ...
    public static int Compare(in JsonUInt16 lhs, in JsonUInt16 rhs)
    {
    ...
    public static JsonUInt16 FromAny(in JsonAny value)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonUInt16 FromJson(in JsonElement value)
    {
        return new(value);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonUInt16 IJsonValue<JsonUInt16>.FromString<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonUInt16 IJsonValue<JsonUInt16>.FromBoolean<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonUInt16 FromNumber<TValue>(in TValue value)
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonUInt16 IJsonValue<JsonUInt16>.FromArray<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonUInt16 IJsonValue<JsonUInt16>.FromObject<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <returns>A <see cref="JsonUInt16"/> instance built from the JSON string.</returns>
    public static JsonUInt16 Parse(string json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonUInt16(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonUInt16"/> instance built from the JSON string.</returns>
    public static JsonUInt16 Parse(Stream utf8Json, JsonDocumentOptions options = default)
    {
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonUInt16"/> instance built from the JSON string.</returns>
    public static JsonUInt16 Parse(ReadOnlyMemory<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonUInt16(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonUInt16"/> instance built from the JSON string.</returns>
    public static JsonUInt16 Parse(ReadOnlyMemory<char> json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonUInt16(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonUInt16"/> instance built from the JSON string.</returns>
    public static JsonUInt16 Parse(ReadOnlySequence<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonUInt16(jsonDocument.RootElement.Clone());
    }
    ...
    public static JsonUInt16 ParseValue(string buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonUInt16>.ParseValue(buffer);
#else
        return JsonValueHelpers.ParseValue<JsonUInt16>(buffer.AsSpan());
#endif
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonUInt16 ParseValue(ReadOnlySpan<char> buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonUInt16>.ParseValue(buffer);
#else
        return JsonValueHelpers.ParseValue<JsonUInt16>(buffer);
#endif
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonUInt16 ParseValue(ReadOnlySpan<byte> buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonUInt16>.ParseValue(buffer);
#else
    ...
    /// <returns>The parsed value.</returns>
    public static JsonUInt16 ParseValue(ref Utf8JsonReader reader)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonUInt16>.ParseValue(ref reader);
#else
        return JsonValueHelpers.ParseValue<JsonUInt16>(ref reader);
#endif
    }
...
#else
        return this.As<JsonUInt16, TTarget>();
#endif
    }
    ...
    public bool Equals(in JsonUInt16 other)
    {
        return JsonValueHelpers.CompareValues(this, other);
    }
    ...
    {
        return Json.Validate.TypeUInt16(this, validationContext, level);
    }
}