// <copyright file="JsonUInt32.Core.cs" company="Endjin Limited">
...
public readonly partial struct JsonUInt32 : IJsonNumber<JsonUInt32>
{
    ...
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    public JsonUInt32(in BinaryJsonNumber value)
    {
        this.jsonElementBacking = default;
    ...
    /// <returns>A <see cref="JsonUInt32"/> instance built from the JSON string.</returns>
    public static JsonUInt32 Parse(string json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonUInt32(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonUInt32"/> instance built from the JSON string.</returns>
    public static JsonUInt32 Parse(Stream utf8Json, JsonDocumentOptions options = default)
    {
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonUInt32"/> instance built from the JSON string.</returns>
    public static JsonUInt32 Parse(ReadOnlyMemory<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonUInt32(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonUInt32"/> instance built from the JSON string.</returns>
    public static JsonUInt32 Parse(ReadOnlyMemory<char> json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonUInt32(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonUInt32"/> instance built from the JSON string.</returns>
    public static JsonUInt32 Parse(ReadOnlySequence<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonUInt32(jsonDocument.RootElement.Clone());
    }
    ...
    public static JsonUInt32 ParseValue(string buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonUInt32>.ParseValue(buffer);
#else
        return JsonValueHelpers.ParseValue<JsonUInt32>(buffer.AsSpan());
#endif
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonUInt32 ParseValue(ReadOnlySpan<char> buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonUInt32>.ParseValue(buffer);
#else
        return JsonValueHelpers.ParseValue<JsonUInt32>(buffer);
#endif
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonUInt32 ParseValue(ReadOnlySpan<byte> buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonUInt32>.ParseValue(buffer);
#else
    ...
    /// <returns>The parsed value.</returns>
    public static JsonUInt32 ParseValue(ref Utf8JsonReader reader)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonUInt32>.ParseValue(ref reader);
#else
        return JsonValueHelpers.ParseValue<JsonUInt32>(ref reader);
#endif
    }
    ...
    {
        return Json.Validate.TypeUInt32(this, validationContext, level);
    }
}