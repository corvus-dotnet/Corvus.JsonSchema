// <copyright file="JsonUInt64.Core.cs" company="Endjin Limited">
...
/// Represents a uint64.
/// </summary>
[System.Text.Json.Serialization.JsonConverter(typeof(Corvus.Json.Internal.JsonValueConverter<JsonUInt64>))]
public readonly partial struct JsonUInt64 : IJsonNumber<JsonUInt64>
{
    ...
    public JsonUInt64(in JsonElement value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    public JsonUInt64(in BinaryJsonNumber value)
    {
        this.jsonElementBacking = default;
    ...
    /// </summary>
    public static JsonUInt64 Null { get; } = new(JsonValueHelpers.NullElement);

    /// <summary>
    /// Gets an Undefined instance.
    /// </summary>
    public static JsonUInt64 Undefined { get; }

    /// <summary>
    /// Gets a default instance.
    /// </summary>
    public static JsonUInt64 DefaultInstance { get; }
    ...
    public static bool operator ==(in JsonUInt64 left, in JsonUInt64 right)
    {
    ...
    public static JsonUInt64 FromAny(in JsonAny value)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonUInt64 FromJson(in JsonElement value)
    {
        return new(value);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonUInt64 IJsonValue<JsonUInt64>.FromString<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonUInt64 IJsonValue<JsonUInt64>.FromBoolean<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonUInt64 FromNumber<TValue>(in TValue value)
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonUInt64 IJsonValue<JsonUInt64>.FromArray<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonUInt64 IJsonValue<JsonUInt64>.FromObject<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <returns>A <see cref="JsonUInt64"/> instance built from the JSON string.</returns>
    public static JsonUInt64 Parse(string json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonUInt64(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonUInt64"/> instance built from the JSON string.</returns>
    public static JsonUInt64 Parse(Stream utf8Json, JsonDocumentOptions options = default)
    {
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonUInt64"/> instance built from the JSON string.</returns>
    public static JsonUInt64 Parse(ReadOnlyMemory<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonUInt64(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonUInt64"/> instance built from the JSON string.</returns>
    public static JsonUInt64 Parse(ReadOnlyMemory<char> json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonUInt64(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonUInt64"/> instance built from the JSON string.</returns>
    public static JsonUInt64 Parse(ReadOnlySequence<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonUInt64(jsonDocument.RootElement.Clone());
    }
    ...
    public static JsonUInt64 ParseValue(string buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonUInt64>.ParseValue(buffer);
#else
        return JsonValueHelpers.ParseValue<JsonUInt64>(buffer.AsSpan());
#endif
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonUInt64 ParseValue(ReadOnlySpan<char> buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonUInt64>.ParseValue(buffer);
#else
        return JsonValueHelpers.ParseValue<JsonUInt64>(buffer);
#endif
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonUInt64 ParseValue(ReadOnlySpan<byte> buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonUInt64>.ParseValue(buffer);
#else
    ...
    /// <returns>The parsed value.</returns>
    public static JsonUInt64 ParseValue(ref Utf8JsonReader reader)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonUInt64>.ParseValue(ref reader);
#else
        return JsonValueHelpers.ParseValue<JsonUInt64>(ref reader);
#endif
    }
...
#else
        return this.As<JsonUInt64, TTarget>();
#endif
    }
    ...
    public bool Equals(in JsonUInt64 other)
    {
        return JsonValueHelpers.CompareValues(this, other);
    }
    ...
    {
        return Json.Validate.TypeUInt64(this, validationContext, level);
    }
}