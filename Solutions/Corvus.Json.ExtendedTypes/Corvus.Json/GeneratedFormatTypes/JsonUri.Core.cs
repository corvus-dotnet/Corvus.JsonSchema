...
public readonly partial struct JsonUri
    ...
    : IJsonString<JsonUri>, ISpanFormattable
#else
    : IJsonString<JsonUri>
#endif
{
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonUri IJsonValue<JsonUri>.FromBoolean<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonUri IJsonValue<JsonUri>.FromNumber<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonUri IJsonValue<JsonUri>.FromArray<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>The value will be undefined if it cannot be initialized with the specified instance.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static JsonUri IJsonValue<JsonUri>.FromObject<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    public static JsonUri ParseValue(string buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonUri>.ParseValue(buffer);
#else
        return JsonValueHelpers.ParseValue<JsonUri>(buffer.AsSpan());
#endif
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonUri ParseValue(ReadOnlySpan<char> buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonUri>.ParseValue(buffer);
#else
        return JsonValueHelpers.ParseValue<JsonUri>(buffer);
#endif
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonUri ParseValue(ReadOnlySpan<byte> buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonUri>.ParseValue(buffer);
#else
    ...
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonUri>.ParseValue(ref reader);
#else
        return JsonValueHelpers.ParseValue<JsonUri>(ref reader);
#endif
    }
...
#else
        return this.As<JsonUri, TTarget>();
#endif
    }
    ...
    public bool Equals(in JsonUri other)
    {
        return JsonValueHelpers.CompareValues(this, other);
    }
