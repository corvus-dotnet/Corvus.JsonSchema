// <copyright file="JsonUriTemplate.Basics.cs" company="Endjin Limited">
...
public readonly partial struct JsonUriTemplate
{
    ...
    public JsonUriTemplate(in ReadOnlySpan<byte> utf8Value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.String;
...
#else
        return JsonValueHelpers.ParseValue<JsonUriTemplate>(buffer[..written]);
#endif
    }
