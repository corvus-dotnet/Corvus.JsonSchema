...
public readonly partial struct JsonUuid : IJsonString<JsonUuid>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static JsonUuid FromBoolean<TValue>(in TValue value)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static JsonUuid FromNumber<TValue>(in TValue value)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static JsonUuid FromArray<TValue>(in TValue value)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static JsonUuid FromObject<TValue>(in TValue value)
