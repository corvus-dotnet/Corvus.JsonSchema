// <copyright file="JsonUuid.Core.cs" company="Endjin Limited">
...
public readonly partial struct JsonUuid
    ...
    : IJsonString<JsonUuid>, ISpanFormattable
#else
    : IJsonString<JsonUuid>
#endif
{
    ...
    /// <returns>A <see cref="JsonUuid"/> instance built from the JSON string.</returns>
    public static JsonUuid Parse(string json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonUuid(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonUuid"/> instance built from the JSON string.</returns>
    public static JsonUuid Parse(Stream utf8Json, JsonDocumentOptions options = default)
    {
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonUuid"/> instance built from the JSON string.</returns>
    public static JsonUuid Parse(ReadOnlyMemory<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonUuid(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonUuid"/> instance built from the JSON string.</returns>
    public static JsonUuid Parse(ReadOnlyMemory<char> json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new JsonUuid(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref="JsonUuid"/> instance built from the JSON string.</returns>
    public static JsonUuid Parse(ReadOnlySequence<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new JsonUuid(jsonDocument.RootElement.Clone());
    }
    ...
    public static JsonUuid ParseValue(string buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonUuid>.ParseValue(buffer);
#else
        return JsonValueHelpers.ParseValue<JsonUuid>(buffer.AsSpan());
#endif
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonUuid ParseValue(ReadOnlySpan<char> buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonUuid>.ParseValue(buffer);
#else
        return JsonValueHelpers.ParseValue<JsonUuid>(buffer);
#endif
    }
    ...
    /// <param name="buffer">The buffer from which to parse the value.</param>
    /// <returns>The parsed value.</returns>
    public static JsonUuid ParseValue(ReadOnlySpan<byte> buffer)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonUuid>.ParseValue(buffer);
#else
    ...
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonUuid>.ParseValue(ref reader);
#else
        return JsonValueHelpers.ParseValue<JsonUuid>(ref reader);
#endif
    }
    ...
    {
        return Json.Validate.TypeUuid(this, validationContext, level);
    }
