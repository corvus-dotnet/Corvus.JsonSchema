...
/// </summary>
[System.Text.Json.Serialization.JsonConverter(typeof(Corvus.Json.Internal.JsonValueConverter<JsonObject>))]
public readonly partial struct JsonObject
{
    ...
    public JsonObject(ImmutableList<JsonObjectProperty> value)
    {
    ...
    /// <param name="source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static JsonObject FromProperties(ImmutableList<JsonObjectProperty> source)
    {
        return new(source);
    }
