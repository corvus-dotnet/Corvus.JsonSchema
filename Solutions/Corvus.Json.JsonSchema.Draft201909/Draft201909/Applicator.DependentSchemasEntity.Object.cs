...
public readonly partial struct Applicator
{
    ...
    /// </summary>
    public readonly partial struct DependentSchemasEntity : IJsonObject<DependentSchemasEntity>, IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.Draft201909.Schema>
    {
        /// <summary>
    ...
    static DependentSchemasEntity IJsonObject<DependentSchemasEntity>.FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
        ...
        public DependentSchemasEntity SetProperty(in JsonPropertyName name, in Corvus.Json.JsonSchema.Draft201909.Schema value)
        {
            return new(this.GetPropertyBackingWith(name, value.AsAny));
        }
