...
public readonly partial struct Applicator
{
    ...
    public readonly partial struct PatternPropertiesEntity
        : IJsonObject<Corvus.Json.JsonSchema.Draft201909.Applicator.PatternPropertiesEntity>,
...
PatternPropertiesEntity IJsonObject<PatternPropertiesEntity>.SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        public PatternPropertiesEntity SetProperty(in JsonPropertyName name, Corvus.Json.JsonSchema.Draft201909.Schema value)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWith(this, name, value.AsAny));
        }
