...
public readonly partial struct Applicator
{
    ...
    /// </summary>
    public readonly partial struct PropertiesEntity : IJsonObject<PropertiesEntity>, IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.Draft201909.Schema>
    {
        /// <summary>
    ...
    static PropertiesEntity IJsonObject<PropertiesEntity>.FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static PropertiesEntity FromProperties(IDictionary<JsonPropertyName, Corvus.Json.JsonSchema.Draft201909.Schema> source)
        {
            return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static PropertiesEntity FromProperties(params (JsonPropertyName Name, Corvus.Json.JsonSchema.Draft201909.Schema Value)[] source)
        {
        ...
        public PropertiesEntity SetProperty(in JsonPropertyName name, in Corvus.Json.JsonSchema.Draft201909.Schema value)
        {
            return new(this.GetPropertyBackingWith(name, value.AsAny));
        }
