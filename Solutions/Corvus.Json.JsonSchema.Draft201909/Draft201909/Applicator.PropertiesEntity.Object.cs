...
public readonly partial struct Applicator
{
    ...
    public readonly partial struct PropertiesEntity
        : IJsonObject<Corvus.Json.JsonSchema.Draft201909.Applicator.PropertiesEntity>,
...
PropertiesEntity IJsonObject<PropertiesEntity>.SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        public PropertiesEntity SetProperty(in JsonPropertyName name, Corvus.Json.JsonSchema.Draft201909.Schema value)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWith(this, name, value.AsAny));
        }
