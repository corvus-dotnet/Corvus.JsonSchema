...
public readonly partial struct Core
{
    ...
    /// </summary>
    public readonly partial struct DefsEntity : IJsonObject<DefsEntity>, IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.Draft201909.Schema>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "DefsEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public DefsEntity(ImmutableList<JsonObjectProperty> value)
        {
    ...
    static DefsEntity IJsonObject<DefsEntity>.FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
        ...
        /// <inheritdoc/>
        bool IJsonObject<DefsEntity>.TryGetProperty(ReadOnlySpan<byte> utf8Name, out JsonAny value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        bool IJsonObject<DefsEntity>.TryGetProperty<TValue>(ReadOnlySpan<byte> utf8Name, out TValue value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.TryGetProperty(utf8Name, out JsonElement result))
        ...
        public DefsEntity SetProperty(in JsonPropertyName name, in Corvus.Json.JsonSchema.Draft201909.Schema value)
        {
            return new(this.GetPropertyBackingWith(name, value.AsAny));
        }
        ...
        /// <inheritdoc/>
        public DefsEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
