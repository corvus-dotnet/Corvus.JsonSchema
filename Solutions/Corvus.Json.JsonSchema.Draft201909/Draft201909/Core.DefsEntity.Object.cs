...
public readonly partial struct Core
{
    ...
    public readonly partial struct DefsEntity : IJsonObject<DefsEntity>
    {
        ...
        public static DefsEntity FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static DefsEntity FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public DefsEntity SetProperty<TValue>(in JsonPropertyName name, TValue value)
