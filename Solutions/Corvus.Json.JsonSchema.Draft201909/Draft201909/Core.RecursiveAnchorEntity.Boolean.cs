...
public readonly partial struct Core
{
    ...
    public readonly partial struct RecursiveAnchorEntity
        : IJsonBoolean<Corvus.Json.JsonSchema.Draft201909.Core.RecursiveAnchorEntity>
    {
        /// <summary>
        /// Conversion from <see cref="bool"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RecursiveAnchorEntity(bool value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RecursiveAnchorEntity(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonBoolean(RecursiveAnchorEntity value)
        {
            return
                value.AsBoolean;
        }
