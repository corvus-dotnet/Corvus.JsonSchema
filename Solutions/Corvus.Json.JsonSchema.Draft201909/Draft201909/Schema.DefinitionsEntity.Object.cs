...
public readonly partial struct Schema
{
    ...
    /// </summary>
    public readonly partial struct DefinitionsEntity : IJsonObject<DefinitionsEntity>, IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.Draft201909.Schema>
    {
        /// <summary>
    ...
    static DefinitionsEntity IJsonObject<DefinitionsEntity>.FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static DefinitionsEntity FromProperties(IDictionary<JsonPropertyName, Corvus.Json.JsonSchema.Draft201909.Schema> source)
        {
            return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static DefinitionsEntity FromProperties(params (JsonPropertyName Name, Corvus.Json.JsonSchema.Draft201909.Schema Value)[] source)
        {
        ...
        public DefinitionsEntity SetProperty(in JsonPropertyName name, in Corvus.Json.JsonSchema.Draft201909.Schema value)
        {
            return new(this.GetPropertyBackingWith(name, value.AsAny));
        }
