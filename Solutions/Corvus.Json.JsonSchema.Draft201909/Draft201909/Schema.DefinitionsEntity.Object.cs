...
public readonly partial struct Schema
{
    ...
    public readonly partial struct DefinitionsEntity
        : IJsonObject<Corvus.Json.JsonSchema.Draft201909.Schema.DefinitionsEntity>,
...
DefinitionsEntity IJsonObject<DefinitionsEntity>.SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        public DefinitionsEntity SetProperty(in JsonPropertyName name, Corvus.Json.JsonSchema.Draft201909.Schema value)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWith(this, name, value.AsAny));
        }
