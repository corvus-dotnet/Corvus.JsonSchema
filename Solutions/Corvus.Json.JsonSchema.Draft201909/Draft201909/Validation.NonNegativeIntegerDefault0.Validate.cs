    ...
    public readonly partial struct NonNegativeIntegerDefault0
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("https://json-schema.org/draft/2019-09/meta/validation#/$defs/nonNegativeIntegerDefault0");
            }
        ...
        public static partial class CorvusValidation
        {
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                refResult = value.As<Corvus.Json.JsonSchema.Draft201909.Validation.NonNegativeInteger>().Validate(refResult, level);
