    ...
    public readonly partial struct PatternPropertiesEntity
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("https://json-schema.org/draft/2020-12/meta/applicator#/properties/patternProperties");
            }
        ...
        public static partial class CorvusValidation
        {
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                foreach (JsonObjectProperty<Corvus.Json.JsonSchema.Draft202012.Schema> property in value.EnumerateObject())
                {
                    ...
                    result = new Corvus.Json.JsonSchema.Draft202012.Applicator.PatternPropertiesEntity.PropertyNamesEntity(propertyNameAsString ??= property.Name.GetString()).Validate(result, level);
                    if (level == ValidationLevel.Flag && !result.IsValid)
                    {
                        return result;
                    }
