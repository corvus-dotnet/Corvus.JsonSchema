...
public readonly partial struct MetaData
{
...

    {
        ...
        /// </summary>
        public static string SchemaLocation { get; } = "https://json-schema.org/draft/2020-12/meta/meta-data#/properties/writeOnly";
        ...
        public static implicit operator WriteOnlyEntity(JsonAny value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonAny(WriteOnlyEntity value)
        {
            return value.AsAny;
        }
        ...
        /// <summary>
        /// Parses the WriteOnlyEntity.
        /// </summary>
        /// <param name="source">The source of the JSON string to parse.</param>
        /// <param name="options">The (optional) JsonDocumentOptions.</param>
        public static WriteOnlyEntity Parse(string source, JsonDocumentOptions options = default)
        {
        ...
        /// <param name="source">The source of the JSON string to parse.</param>
        /// <param name="options">The (optional) JsonDocumentOptions.</param>
        public static WriteOnlyEntity Parse(Stream source, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(source, options);
            return new(jsonDocument.RootElement.Clone());
        }
        ...
        /// <param name="source">The source of the JSON string to parse.</param>
        /// <param name="options">The (optional) JsonDocumentOptions.</param>
        public static WriteOnlyEntity Parse(ReadOnlyMemory<byte> source, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(source, options);
            return new(jsonDocument.RootElement.Clone());
        }
        ...
        /// <param name="source">The source of the JSON string to parse.</param>
        /// <param name="options">The (optional) JsonDocumentOptions.</param>
        public static WriteOnlyEntity Parse(ReadOnlyMemory<char> source, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(source, options);
            return new(jsonDocument.RootElement.Clone());
        }
        ...
        /// <param name="source">The source of the JSON string to parse.</param>
        /// <param name="options">The (optional) JsonDocumentOptions.</param>
        public static WriteOnlyEntity Parse(ReadOnlySequence<byte> source, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(source, options);
            return new(jsonDocument.RootElement.Clone());
        }
        ...
        /// </summary>
        /// <param name="source">The source of the JSON string to parse.</param>
        public static WriteOnlyEntity ParseValue(string source)
        {
#if NET8_0_OR_GREATER
            return IJsonValue<WriteOnlyEntity>.ParseValue(source);
#else
            return JsonValueHelpers.ParseValue<WriteOnlyEntity>(source.AsSpan());
#endif
        }
        ...
        /// </summary>
        /// <param name="source">The source of the JSON string to parse.</param>
        public static WriteOnlyEntity ParseValue(ReadOnlySpan<char> source)
        {
#if NET8_0_OR_GREATER
            return IJsonValue<WriteOnlyEntity>.ParseValue(source);
#else
            return JsonValueHelpers.ParseValue<WriteOnlyEntity>(source);
#endif
        }
        ...
        /// </summary>
        /// <param name="source">The source of the JSON string to parse.</param>
        public static WriteOnlyEntity ParseValue(ReadOnlySpan<byte> source)
        {
#if NET8_0_OR_GREATER
            return IJsonValue<WriteOnlyEntity>.ParseValue(source);
#else
        ...
        /// </summary>
        /// <param name="source">The source of the JSON string to parse.</param>
        public static WriteOnlyEntity ParseValue(ref Utf8JsonReader source)
        {
#if NET8_0_OR_GREATER
            return IJsonValue<WriteOnlyEntity>.ParseValue(ref source);
#else
            return JsonValueHelpers.ParseValue<WriteOnlyEntity>(ref source);
#endif
        }
...
#else
            return this.As<WriteOnlyEntity, TTarget>();
#endif
        }
        ...
        {
            return
                (obj is IJsonValue jv && this.Equals(jv.As<WriteOnlyEntity>())) ||
        ...
        {
            return this.Equals(other.As<WriteOnlyEntity>());
        }
