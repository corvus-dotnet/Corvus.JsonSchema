...
public readonly partial struct Schema
{
    ...
    public readonly partial struct DependenciesEntity
    {
            ...
            : IJsonValue<Corvus.Json.JsonSchema.Draft202012.Schema.DependenciesEntity.AdditionalPropertiesEntity>
        {
            ...
            /// <param name="matchSchema">Match a <see cref="Corvus.Json.JsonSchema.Draft202012.Schema"/>.</param>
            /// <param name="matchStringArray">Match a <see cref="Corvus.Json.JsonSchema.Draft202012.Validation.StringArray"/>.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TOut Match<TIn, TOut>(
                in TIn context,
                Matcher<Corvus.Json.JsonSchema.Draft202012.Schema, TIn, TOut> matchSchema,
                Matcher<Corvus.Json.JsonSchema.Draft202012.Validation.StringArray, TIn, TOut> matchStringArray,
                Matcher<Corvus.Json.JsonSchema.Draft202012.Schema.DependenciesEntity.AdditionalPropertiesEntity, TIn, TOut> defaultMatch)
            {
                Corvus.Json.JsonSchema.Draft202012.Schema matchSchemaValue = this.As<Corvus.Json.JsonSchema.Draft202012.Schema>();
                if (matchSchemaValue.IsValid())
                {
                    return matchSchema(matchSchemaValue, context);
                }

                Corvus.Json.JsonSchema.Draft202012.Validation.StringArray matchStringArrayValue = this.As<Corvus.Json.JsonSchema.Draft202012.Validation.StringArray>();
            ...
            public TOut Match<TOut>(
                Matcher<Corvus.Json.JsonSchema.Draft202012.Schema, TOut> matchSchema,
                Matcher<Corvus.Json.JsonSchema.Draft202012.Validation.StringArray, TOut> matchStringArray,
                Matcher<Corvus.Json.JsonSchema.Draft202012.Schema.DependenciesEntity.AdditionalPropertiesEntity, TOut> defaultMatch)
            {
                Corvus.Json.JsonSchema.Draft202012.Schema matchSchemaValue = this.As<Corvus.Json.JsonSchema.Draft202012.Schema>();
                if (matchSchemaValue.IsValid())
                {
