...
public readonly partial struct Schema
{
    ...
    public readonly partial struct DependenciesEntity
        : IJsonObject<Corvus.Json.JsonSchema.Draft202012.Schema.DependenciesEntity>,
          IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.Draft202012.Schema.DependenciesEntity.AdditionalPropertiesEntity>
    {
        /// <summary>
        ...
        /// <inheritdoc/>
        int IReadOnlyCollection<KeyValuePair<JsonPropertyName, Corvus.Json.JsonSchema.Draft202012.Schema.DependenciesEntity.AdditionalPropertiesEntity>>.Count => this.Count;
        ...
        bool IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.Draft202012.Schema.DependenciesEntity.AdditionalPropertiesEntity>.ContainsKey(JsonPropertyName key) => this.HasProperty(key);

        bool IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.Draft202012.Schema.DependenciesEntity.AdditionalPropertiesEntity>.TryGetValue(JsonPropertyName key, out Corvus.Json.JsonSchema.Draft202012.Schema.DependenciesEntity.AdditionalPropertiesEntity result) => this.TryGetProperty(key, out result);
        ...
        /// <returns><c>True</c> if the property was present.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public bool TryGetProperty(ReadOnlySpan<byte> name, out Corvus.Json.JsonSchema.Draft202012.Schema.DependenciesEntity.AdditionalPropertiesEntity value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.ValueKind != JsonValueKind.Object)
...
DependenciesEntity IJsonObject<DependenciesEntity>.SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        public DependenciesEntity SetProperty(in JsonPropertyName name, Corvus.Json.JsonSchema.Draft202012.Schema.DependenciesEntity.AdditionalPropertiesEntity value)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWith(this, name, value.AsAny));
        }
