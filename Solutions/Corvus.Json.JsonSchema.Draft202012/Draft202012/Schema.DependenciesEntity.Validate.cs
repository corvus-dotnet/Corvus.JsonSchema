    ...
    public readonly partial struct DependenciesEntity
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("https://json-schema.org/draft/2020-12/schema#/properties/dependencies");
            }
        ...
        public static partial class CorvusValidation
        {
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                int propertyCount = 0;
                foreach (JsonObjectProperty<Corvus.Json.JsonSchema.Draft202012.Schema.DependenciesEntity.AdditionalPropertiesEntity> property in value.EnumerateObject())
                {
