...
#if NET8_0_OR_GREATER
        : IJsonNumber<Corvus.Json.JsonSchema.Draft202012.Validation.MinContainsEntity>,
          IAdditionOperators<Corvus.Json.JsonSchema.Draft202012.Validation.MinContainsEntity, Corvus.Json.JsonSchema.Draft202012.Validation.MinContainsEntity, Corvus.Json.JsonSchema.Draft202012.Validation.MinContainsEntity>,
          ISubtractionOperators<Corvus.Json.JsonSchema.Draft202012.Validation.MinContainsEntity, Corvus.Json.JsonSchema.Draft202012.Validation.MinContainsEntity, Corvus.Json.JsonSchema.Draft202012.Validation.MinContainsEntity>,
          IMultiplyOperators<Corvus.Json.JsonSchema.Draft202012.Validation.MinContainsEntity, Corvus.Json.JsonSchema.Draft202012.Validation.MinContainsEntity, Corvus.Json.JsonSchema.Draft202012.Validation.MinContainsEntity>,
          IDivisionOperators<Corvus.Json.JsonSchema.Draft202012.Validation.MinContainsEntity, Corvus.Json.JsonSchema.Draft202012.Validation.MinContainsEntity, Corvus.Json.JsonSchema.Draft202012.Validation.MinContainsEntity>,
          IIncrementOperators<Corvus.Json.JsonSchema.Draft202012.Validation.MinContainsEntity>,
          IDecrementOperators<Corvus.Json.JsonSchema.Draft202012.Validation.MinContainsEntity>
#else
        : IJsonNumber<Corvus.Json.JsonSchema.Draft202012.Validation.MinContainsEntity>
#endif
    {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MinContainsEntity"/>.</returns>
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MinContainsEntity"/>.</returns>
        public static explicit operator MinContainsEntity(Int128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MinContainsEntity"/>.</returns>
        public static explicit operator MinContainsEntity(UInt128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        /// </returns>
        public static bool operator <(MinContainsEntity left, MinContainsEntity right)
        {
