...
public readonly partial struct Validation
{
...

    {
        ...
        /// <summary>
        /// Gets the instance as a <see cref="Corvus.Json.JsonSchema.Draft202012.Validation.NonNegativeInteger" />.
        /// </summary>
        public Corvus.Json.JsonSchema.Draft202012.Validation.NonNegativeInteger AsNonNegativeInteger
        {
            get
            {
                return this.As<Corvus.Json.JsonSchema.Draft202012.Validation.NonNegativeInteger>();
            }
        }

        /// <summary>
        /// Gets a value indicating whether the instance is a <see cref="Corvus.Json.JsonSchema.Draft202012.Validation.NonNegativeInteger" />.
        /// </summary>
        public bool IsNonNegativeInteger
        {
            get
            {
                return this.As<Corvus.Json.JsonSchema.Draft202012.Validation.NonNegativeInteger>().IsValid();
            }
        }
        ...
        {
            return value.As<Corvus.Json.JsonSchema.Draft202012.Validation.NonNegativeInteger>();
        }
        ...
        /// <summary>
        /// Parses the MinContainsEntity.
        /// </summary>
        /// <param name="source">The source of the JSON string to parse.</param>
        /// <param name="options">The (optional) JsonDocumentOptions.</param>
        public static MinContainsEntity Parse(string source, JsonDocumentOptions options = default)
        {
        ...
        /// <param name="source">The source of the JSON string to parse.</param>
        /// <param name="options">The (optional) JsonDocumentOptions.</param>
        public static MinContainsEntity Parse(Stream source, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(source, options);
            return new(jsonDocument.RootElement.Clone());
        }
        ...
        /// <param name="source">The source of the JSON string to parse.</param>
        /// <param name="options">The (optional) JsonDocumentOptions.</param>
        public static MinContainsEntity Parse(ReadOnlyMemory<byte> source, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(source, options);
            return new(jsonDocument.RootElement.Clone());
        }
        ...
        /// <param name="source">The source of the JSON string to parse.</param>
        /// <param name="options">The (optional) JsonDocumentOptions.</param>
        public static MinContainsEntity Parse(ReadOnlyMemory<char> source, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(source, options);
            return new(jsonDocument.RootElement.Clone());
        }
        ...
        /// <param name="source">The source of the JSON string to parse.</param>
        /// <param name="options">The (optional) JsonDocumentOptions.</param>
        public static MinContainsEntity Parse(ReadOnlySequence<byte> source, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(source, options);
            return new(jsonDocument.RootElement.Clone());
        }
        ...
        /// </summary>
        /// <param name="source">The source of the JSON string to parse.</param>
        public static MinContainsEntity ParseValue(string source)
        {
#if NET8_0_OR_GREATER
            return IJsonValue<MinContainsEntity>.ParseValue(source);
#else
            return JsonValueHelpers.ParseValue<MinContainsEntity>(source.AsSpan());
#endif
        }
        ...
        /// </summary>
        /// <param name="source">The source of the JSON string to parse.</param>
        public static MinContainsEntity ParseValue(ReadOnlySpan<char> source)
        {
#if NET8_0_OR_GREATER
            return IJsonValue<MinContainsEntity>.ParseValue(source);
#else
            return JsonValueHelpers.ParseValue<MinContainsEntity>(source);
#endif
        }
        ...
        /// </summary>
        /// <param name="source">The source of the JSON string to parse.</param>
        public static MinContainsEntity ParseValue(ReadOnlySpan<byte> source)
        {
#if NET8_0_OR_GREATER
            return IJsonValue<MinContainsEntity>.ParseValue(source);
#else
        ...
        /// </summary>
        /// <param name="source">The source of the JSON string to parse.</param>
        public static MinContainsEntity ParseValue(ref Utf8JsonReader source)
        {
#if NET8_0_OR_GREATER
            return IJsonValue<MinContainsEntity>.ParseValue(ref source);
#else
            return JsonValueHelpers.ParseValue<MinContainsEntity>(ref source);
#endif
        }
        ...
        {
            return
                (obj is IJsonValue jv && this.Equals(jv.As<MinContainsEntity>())) ||
        ...
        {
            return this.Equals(other.As<MinContainsEntity>());
        }
        ...
        {
            result = this.As<Corvus.Json.JsonSchema.Draft202012.Validation.NonNegativeInteger>();
