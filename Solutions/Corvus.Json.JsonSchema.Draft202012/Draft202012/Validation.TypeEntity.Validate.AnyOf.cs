...
public readonly partial struct Validation
{
    ...
    public readonly partial struct TypeEntity
    {
        private ValidationContext ValidateAnyOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext anyOfResult0 = this.As<Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes>().Validate(childContext0.CreateChildContext(), level);
            ...
            ValidationContext anyOfResult1 = this.As<Corvus.Json.JsonSchema.Draft202012.Validation.TypeEntity.SimpleTypesArray>().Validate(childContext1.CreateChildContext(), level);
