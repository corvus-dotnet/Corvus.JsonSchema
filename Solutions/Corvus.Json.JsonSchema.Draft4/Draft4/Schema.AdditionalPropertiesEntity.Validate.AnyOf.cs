...
public readonly partial struct Schema
{
    ...
    public readonly partial struct AdditionalPropertiesEntity
    {
        private ValidationContext ValidateAnyOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext anyOfResult0 = this.As<Corvus.Json.JsonBoolean>().Validate(childContext0.CreateChildContext(), level);
            ...
            ValidationContext anyOfResult1 = this.As<Corvus.Json.JsonSchema.Draft4.Schema>().Validate(childContext1.CreateChildContext(), level);
