...
public readonly partial struct Schema
{
    ...
    /// </summary>
    public readonly partial struct DependenciesEntity : IJsonObject<DependenciesEntity>, IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.Draft4.Schema.DependenciesEntity.AdditionalPropertiesEntity>
    {
        /// <summary>
        ...
        /// <inheritdoc/>
        int IReadOnlyCollection<KeyValuePair<JsonPropertyName, Corvus.Json.JsonSchema.Draft4.Schema.DependenciesEntity.AdditionalPropertiesEntity>>.Count
        {
            get
            {
    ...
    static DependenciesEntity IJsonObject<DependenciesEntity>.FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
        ...
        public bool TryGetProperty(in JsonPropertyName name, out Corvus.Json.JsonSchema.Draft4.Schema.DependenciesEntity.AdditionalPropertiesEntity value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
#if NET8_0_OR_GREATER
                value = Corvus.Json.JsonSchema.Draft4.Schema.DependenciesEntity.AdditionalPropertiesEntity.FromJson(result);
#else
                    value = JsonValueNetStandard20Extensions.FromJsonElement<Corvus.Json.JsonSchema.Draft4.Schema.DependenciesEntity.AdditionalPropertiesEntity>(result);
#endif
                    return true;
                }
...
#else
                    value = result.As<Corvus.Json.JsonSchema.Draft4.Schema.DependenciesEntity.AdditionalPropertiesEntity>();
#endif
                    return true;
                }
        ...
        /// <returns><c>True</c> if the property was present.</returns>
        /// <exception cref = "InvalidOperationException">The value is not an object.</exception>
        public bool TryGetProperty(ReadOnlySpan<byte> utf8Name, out Corvus.Json.JsonSchema.Draft4.Schema.DependenciesEntity.AdditionalPropertiesEntity value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.TryGetProperty(utf8Name, out JsonElement result))
        ...
        public DependenciesEntity SetProperty(in JsonPropertyName name, in Corvus.Json.JsonSchema.Draft4.Schema.DependenciesEntity.AdditionalPropertiesEntity value)
        {
            return new(this.GetPropertyBackingWith(name, value.AsAny));
        }
        ...
        /// <inheritdoc/>
        bool IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.Draft4.Schema.DependenciesEntity.AdditionalPropertiesEntity>.ContainsKey(JsonPropertyName key)
        {
            return this.HasProperty(key);
        }

        /// <inheritdoc/>
        bool IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.Draft4.Schema.DependenciesEntity.AdditionalPropertiesEntity>.TryGetValue(JsonPropertyName key, [MaybeNullWhen(false)] out Corvus.Json.JsonSchema.Draft4.Schema.DependenciesEntity.AdditionalPropertiesEntity value)
        {
