...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ItemsEntity
    {
        private ValidationContext ValidateAnyOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext anyOfResult0 = this.As<Corvus.Json.JsonSchema.Draft4.Schema>().Validate(childContext0.CreateChildContext(), level);
            ...
            ValidationContext anyOfResult1 = this.As<Corvus.Json.JsonSchema.Draft4.Schema.SchemaArray>().Validate(childContext1.CreateChildContext(), level);
