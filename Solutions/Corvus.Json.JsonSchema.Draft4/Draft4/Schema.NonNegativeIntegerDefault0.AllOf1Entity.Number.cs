...
: IJsonNumber<AllOf1Entity>,
  IAdditionOperators<AllOf1Entity, AllOf1Entity, AllOf1Entity>,
  ISubtractionOperators<AllOf1Entity, AllOf1Entity, AllOf1Entity>,
  IMultiplyOperators<AllOf1Entity, AllOf1Entity, AllOf1Entity>,
  IDivisionOperators<AllOf1Entity, AllOf1Entity, AllOf1Entity>,
  IIncrementOperators<AllOf1Entity>,
  IDecrementOperators<AllOf1Entity>
#else
        : IJsonNumber<AllOf1Entity>
#endif
        {
            ...
            public AllOf1Entity(in BinaryJsonNumber value)
            {
            ...
            public static explicit operator byte (AllOf1Entity value)
            {
            ...
            public static explicit operator decimal (AllOf1Entity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            public static explicit operator short (AllOf1Entity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            public static explicit operator int (AllOf1Entity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an Int64.</exception>
    public static explicit operator Int128(AllOf1Entity value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        throw new InvalidOperationException();
            ...
            public static explicit operator sbyte (AllOf1Entity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
    ...
    public static explicit operator Half(AllOf1Entity value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        throw new InvalidOperationException();
            ...
            /// <exception cref = "InvalidOperationException">The value was not a number.</exception>
            /// <exception cref = "FormatException">The value was not formatted as a Single.</exception>
            public static explicit operator float (AllOf1Entity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            public static explicit operator ushort (AllOf1Entity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            public static explicit operator uint (AllOf1Entity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            public static explicit operator ulong (AllOf1Entity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an UInt64.</exception>
    public static explicit operator UInt128(AllOf1Entity value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator AllOf1Entity(Int128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator AllOf1Entity(UInt128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
            ...
            public static AllOf1Entity operator +(AllOf1Entity left, AllOf1Entity right)
            {
            ...
            /// <returns>The resulting value.</returns>
            public static AllOf1Entity operator ++(AllOf1Entity value)
            {
            ...
            public static int Compare(in AllOf1Entity lhs, in AllOf1Entity rhs)
            {
