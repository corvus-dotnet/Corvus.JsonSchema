...
public readonly partial struct Schema
{
    ...
    public readonly partial struct NonNegativeIntegerDefault0
    {
        private ValidationContext ValidateAllOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext allOfResult0 = this.As<Corvus.Json.JsonSchema.Draft4.Schema.NonNegativeInteger>().Validate(childContext0.CreateChildContext(), level);
            ...
            ValidationContext allOfResult1 = this.As<Corvus.Json.JsonSchema.Draft4.Schema.NonNegativeIntegerDefault0.AllOf1Entity>().Validate(childContext1.CreateChildContext(), level);
