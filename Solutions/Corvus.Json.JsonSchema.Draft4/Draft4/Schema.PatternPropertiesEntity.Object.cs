...
public readonly partial struct Schema
{
    ...
    /// </summary>
    public readonly partial struct PatternPropertiesEntity : IJsonObject<PatternPropertiesEntity>, IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.Draft4.Schema>
    {
        /// <summary>
    ...
    static PatternPropertiesEntity IJsonObject<PatternPropertiesEntity>.FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
        ...
        public PatternPropertiesEntity SetProperty(in JsonPropertyName name, in Corvus.Json.JsonSchema.Draft4.Schema value)
        {
            return new(this.GetPropertyBackingWith(name, value.AsAny));
        }
