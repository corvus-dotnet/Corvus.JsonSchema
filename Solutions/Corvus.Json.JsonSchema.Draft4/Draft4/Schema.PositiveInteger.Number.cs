...
: IJsonNumber<PositiveInteger>,
  ...
  IIncrementOperators<PositiveInteger>,
  IDecrementOperators<PositiveInteger>
#else
    : IJsonNumber<PositiveInteger>
#endif
    {
        ...
        public PositiveInteger(in BinaryJsonNumber value)
        {
        ...
        public PositiveInteger(long value) : this(new BinaryJsonNumber(value))
        {
        }
        ...
        public static explicit operator long (PositiveInteger value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
    ...
    public static explicit operator PositiveInteger(Half value)
    {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator PositiveInteger(long value)
        {
            return new(new BinaryJsonNumber(value));
        }
