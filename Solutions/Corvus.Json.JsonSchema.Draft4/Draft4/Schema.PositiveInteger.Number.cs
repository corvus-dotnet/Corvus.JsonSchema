...
#if NET8_0_OR_GREATER
        : IJsonNumber<Corvus.Json.JsonSchema.Draft4.Schema.PositiveInteger>,
          IAdditionOperators<Corvus.Json.JsonSchema.Draft4.Schema.PositiveInteger, Corvus.Json.JsonSchema.Draft4.Schema.PositiveInteger, Corvus.Json.JsonSchema.Draft4.Schema.PositiveInteger>,
          ISubtractionOperators<Corvus.Json.JsonSchema.Draft4.Schema.PositiveInteger, Corvus.Json.JsonSchema.Draft4.Schema.PositiveInteger, Corvus.Json.JsonSchema.Draft4.Schema.PositiveInteger>,
          IMultiplyOperators<Corvus.Json.JsonSchema.Draft4.Schema.PositiveInteger, Corvus.Json.JsonSchema.Draft4.Schema.PositiveInteger, Corvus.Json.JsonSchema.Draft4.Schema.PositiveInteger>,
          IDivisionOperators<Corvus.Json.JsonSchema.Draft4.Schema.PositiveInteger, Corvus.Json.JsonSchema.Draft4.Schema.PositiveInteger, Corvus.Json.JsonSchema.Draft4.Schema.PositiveInteger>,
          IIncrementOperators<Corvus.Json.JsonSchema.Draft4.Schema.PositiveInteger>,
          IDecrementOperators<Corvus.Json.JsonSchema.Draft4.Schema.PositiveInteger>
#else
        : IJsonNumber<Corvus.Json.JsonSchema.Draft4.Schema.PositiveInteger>
#endif
    {
        ...
        public static implicit operator PositiveInteger(JsonNumber value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonNumber(PositiveInteger value)
        {
            return
                value.AsNumber;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonInteger(PositiveInteger value)
        {
            return
        ...
        public static explicit operator byte(PositiveInteger value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="PositiveInteger"/>.</returns>
        public static explicit operator PositiveInteger(byte value)
        {
        ...
        public static explicit operator decimal(PositiveInteger value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="PositiveInteger"/>.</returns>
        public static explicit operator PositiveInteger(decimal value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator double(PositiveInteger value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="PositiveInteger"/>.</returns>
        public static explicit operator PositiveInteger(double value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator short(PositiveInteger value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="PositiveInteger"/>.</returns>
        public static explicit operator PositiveInteger(short value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static implicit operator long(PositiveInteger value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator Int128(PositiveInteger value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="PositiveInteger"/>.</returns>
        public static explicit operator PositiveInteger(Int128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator sbyte(PositiveInteger value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="PositiveInteger"/>.</returns>
        public static explicit operator PositiveInteger(sbyte value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Half(PositiveInteger value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="PositiveInteger"/>.</returns>
        public static explicit operator PositiveInteger(Half value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator float(PositiveInteger value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="PositiveInteger"/>.</returns>
        public static explicit operator PositiveInteger(float value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ushort(PositiveInteger value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="PositiveInteger"/>.</returns>
        public static explicit operator PositiveInteger(ushort value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator uint(PositiveInteger value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="PositiveInteger"/>.</returns>
        public static explicit operator PositiveInteger(uint value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ulong(PositiveInteger value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="PositiveInteger"/>.</returns>
        public static explicit operator PositiveInteger(ulong value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator UInt128(PositiveInteger value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="PositiveInteger"/>.</returns>
        public static explicit operator PositiveInteger(UInt128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        /// <returns>The result of the operation.</returns>
        public static PositiveInteger operator ++(PositiveInteger value)
        {
        ...
        /// </returns>
        public static int Compare(in PositiveInteger lhs, in PositiveInteger rhs)
        {
