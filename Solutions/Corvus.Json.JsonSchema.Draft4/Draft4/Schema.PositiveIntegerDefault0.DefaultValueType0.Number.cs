...
#if NET8_0_OR_GREATER
            : IJsonNumber<Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0.DefaultValueType0>,
              IAdditionOperators<Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0.DefaultValueType0, Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0.DefaultValueType0, Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0.DefaultValueType0>,
              ISubtractionOperators<Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0.DefaultValueType0, Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0.DefaultValueType0, Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0.DefaultValueType0>,
              IMultiplyOperators<Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0.DefaultValueType0, Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0.DefaultValueType0, Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0.DefaultValueType0>,
              IDivisionOperators<Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0.DefaultValueType0, Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0.DefaultValueType0, Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0.DefaultValueType0>,
              IIncrementOperators<Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0.DefaultValueType0>,
              IDecrementOperators<Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0.DefaultValueType0>
#else
            : IJsonNumber<Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0.DefaultValueType0>
#endif
        {
