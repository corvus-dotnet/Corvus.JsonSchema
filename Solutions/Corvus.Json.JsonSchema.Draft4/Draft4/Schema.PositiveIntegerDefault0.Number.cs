...
#if NET8_0_OR_GREATER
        : IJsonNumber<Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0>,
          IAdditionOperators<Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0, Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0, Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0>,
          ISubtractionOperators<Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0, Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0, Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0>,
          IMultiplyOperators<Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0, Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0, Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0>,
          IDivisionOperators<Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0, Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0, Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0>,
          IIncrementOperators<Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0>,
          IDecrementOperators<Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0>
#else
        : IJsonNumber<Corvus.Json.JsonSchema.Draft4.Schema.PositiveIntegerDefault0>
#endif
    {
