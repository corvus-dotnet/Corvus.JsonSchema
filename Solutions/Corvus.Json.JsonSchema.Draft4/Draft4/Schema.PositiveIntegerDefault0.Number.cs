...
: IJsonNumber<PositiveIntegerDefault0>,
  IAdditionOperators<PositiveIntegerDefault0, PositiveIntegerDefault0, PositiveIntegerDefault0>,
  ISubtractionOperators<PositiveIntegerDefault0, PositiveIntegerDefault0, PositiveIntegerDefault0>,
  IMultiplyOperators<PositiveIntegerDefault0, PositiveIntegerDefault0, PositiveIntegerDefault0>,
  IDivisionOperators<PositiveIntegerDefault0, PositiveIntegerDefault0, PositiveIntegerDefault0>,
  IIncrementOperators<PositiveIntegerDefault0>,
  IDecrementOperators<PositiveIntegerDefault0>
#else
    : IJsonNumber<PositiveIntegerDefault0>
#endif
    {
        ...
        public PositiveIntegerDefault0(in BinaryJsonNumber value)
        {
        ...
        public PositiveIntegerDefault0(double value) : this(new BinaryJsonNumber(value))
        {
        }
        ...
        public static explicit operator long (PositiveIntegerDefault0 value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
    ...
    public static explicit operator PositiveIntegerDefault0(Half value)
    {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator PositiveIntegerDefault0(long value)
        {
            return new(new BinaryJsonNumber(value));
        }
