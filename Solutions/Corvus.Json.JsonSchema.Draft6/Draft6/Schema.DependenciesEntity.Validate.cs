    ...
    public readonly partial struct DependenciesEntity
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("http://json-schema.org/draft-06/schema#/properties/dependencies");
            }
        ...
        private static partial class CorvusValidation
        {
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                int propertyCount = 0;
                foreach (JsonObjectProperty<Corvus.Json.JsonSchema.Draft6.Schema.DependenciesEntity.AdditionalPropertiesEntity> property in value.EnumerateObject())
                {
