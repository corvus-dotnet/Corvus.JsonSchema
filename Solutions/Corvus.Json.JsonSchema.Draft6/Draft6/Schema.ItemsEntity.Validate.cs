        ...
        private static partial class CorvusValidation
        {
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                static ValidationContext ValidateAnyOf(in ItemsEntity value, in ValidationContext validationContext, ValidationLevel level)
                {
                    ...
                    ValidationContext anyOfResult0 = value.As<Corvus.Json.JsonSchema.Draft6.Schema>().Validate(anyOfChildContext0, level);
                    ...
                    ValidationContext anyOfResult1 = value.As<Corvus.Json.JsonSchema.Draft6.Schema.SchemaArray>().Validate(anyOfChildContext1, level);
