...
public readonly partial struct Schema
{
    ...
    public readonly partial struct NonNegativeIntegerDefault0
    {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0.AllOf1Entity(NonNegativeIntegerDefault0 value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
                return new(value.AsJsonElement);
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static explicit operator NonNegativeIntegerDefault0(Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0.AllOf1Entity value)
        {
            if (value.HasJsonElementBacking)
            {
                return new(value.AsJsonElement);
