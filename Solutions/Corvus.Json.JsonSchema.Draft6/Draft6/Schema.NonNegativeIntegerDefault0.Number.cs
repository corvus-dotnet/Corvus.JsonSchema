...
#if NET8_0_OR_GREATER
        : IJsonNumber<Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0>,
          IAdditionOperators<Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0, Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0, Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0>,
          ISubtractionOperators<Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0, Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0, Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0>,
          IMultiplyOperators<Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0, Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0, Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0>,
          IDivisionOperators<Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0, Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0, Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0>,
          IIncrementOperators<Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0>,
          IDecrementOperators<Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0>
#else
        : IJsonNumber<Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0>
#endif
    {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonInteger(NonNegativeIntegerDefault0 value)
        {
            return
