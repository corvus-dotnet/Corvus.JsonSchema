...
public readonly partial struct Schema
{
    public readonly partial struct NonNegativeIntegerDefault0
    {
        ...
        /// </summary>
        public readonly partial struct Type0 : IJsonBoolean<Type0>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "Type0"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public Type0(bool value)
            {
            ...
            public static implicit operator Type0(JsonBoolean value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator Type0(bool value)
            {
                return new(value);
            }
            ...
            public static implicit operator bool (Type0 value)
            {
