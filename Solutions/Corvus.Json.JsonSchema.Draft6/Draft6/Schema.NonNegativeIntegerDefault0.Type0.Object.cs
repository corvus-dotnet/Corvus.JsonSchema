...
public readonly partial struct Schema
{
    public readonly partial struct NonNegativeIntegerDefault0
    {
        ...
        /// </summary>
        public readonly partial struct Type0 : IJsonObject<Type0>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "Type0"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public Type0(ImmutableList<JsonObjectProperty> value)
            {
            ...
            public static implicit operator Type0(JsonObject value)
            {
            ...
            public static Type0 FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
            {
            ...
            /// <param name = "source">The dictionary of properties.</param>
            /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
            public static Type0 FromProperties(ImmutableList<JsonObjectProperty> source)
            {
                return new(source);
            }
            ...
            /// <param name = "source">The dictionary of properties.</param>
            /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
            public static Type0 FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
            {
            ...
            /// <inheritdoc/>
            public Type0 SetProperty<TValue>(in JsonPropertyName name, TValue value)
            ...
            /// <inheritdoc/>
            public Type0 RemoveProperty(in JsonPropertyName name)
            {
                return new(this.GetPropertyBackingWithout(name));
            }

            /// <inheritdoc/>
            public Type0 RemoveProperty(string name)
            {
                return new(this.GetPropertyBackingWithout(name));
            }

            /// <inheritdoc/>
            public Type0 RemoveProperty(ReadOnlySpan<char> name)
            {
                return new(this.GetPropertyBackingWithout(name));
            }

            /// <inheritdoc/>
            public Type0 RemoveProperty(ReadOnlySpan<byte> utf8Name)
            {
