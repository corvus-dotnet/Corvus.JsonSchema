...
public readonly partial struct Schema
{
    ...
    /// </summary>
    public readonly partial struct PatternPropertiesEntity : IJsonObject<PatternPropertiesEntity>, IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.Draft6.Schema>
    {
        /// <summary>
        ...
        JsonAny IJsonObject<PatternPropertiesEntity>.this[in JsonPropertyName name]
        {
            get
            {
                if (this.TryGetProperty(name, out Corvus.Json.JsonSchema.Draft6.Schema result))
                {
                    return result.AsAny;
                }
        ...
        /// </summary>
        public Corvus.Json.JsonSchema.Draft6.Schema this[in JsonPropertyName name]
        {
            get
            {
                if (this.TryGetProperty(name, out Corvus.Json.JsonSchema.Draft6.Schema result))
        ...
        /// <inheritdoc/>
        Corvus.Json.JsonSchema.Draft6.Schema IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.Draft6.Schema>.this[JsonPropertyName key] => this[key];
        /// <inheritdoc/>
        IEnumerable<JsonPropertyName> IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.Draft6.Schema>.Keys
        {
            get
            {
        ...
        /// <inheritdoc/>
        IEnumerable<Corvus.Json.JsonSchema.Draft6.Schema> IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.Draft6.Schema>.Values
        {
            get
            {
                foreach (var property in this.EnumerateObject())
        ...
        /// <inheritdoc/>
        int IReadOnlyCollection<KeyValuePair<JsonPropertyName, Corvus.Json.JsonSchema.Draft6.Schema>>.Count
        {
            get
            {
    ...
    static PatternPropertiesEntity IJsonObject<PatternPropertiesEntity>.FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static PatternPropertiesEntity FromProperties(IDictionary<JsonPropertyName, Corvus.Json.JsonSchema.Draft6.Schema> source)
        {
            return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static PatternPropertiesEntity FromProperties(params (JsonPropertyName Name, Corvus.Json.JsonSchema.Draft6.Schema Value)[] source)
        {
        ...
        public JsonObjectEnumerator<Corvus.Json.JsonSchema.Draft6.Schema> EnumerateObject()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new(this.jsonElementBacking);
        ...
        /// <exception cref = "InvalidOperationException">The value is not an object.</exception>
        public bool TryGetProperty(in JsonPropertyName name, out Corvus.Json.JsonSchema.Draft6.Schema value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (name.TryGetProperty(this.jsonElementBacking, out JsonElement result))
                {
#if NET8_0_OR_GREATER
                value = Corvus.Json.JsonSchema.Draft6.Schema.FromJson(result);
#else
                    value = JsonValueNetStandard20Extensions.FromJsonElement<Corvus.Json.JsonSchema.Draft6.Schema>(result);
#endif
                    return true;
                }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
#if NET8_0_OR_GREATER
                value = Corvus.Json.JsonSchema.Draft6.Schema.FromAny(result);
#else
                    value = result.As<Corvus.Json.JsonSchema.Draft6.Schema>();
#endif
                    return true;
                }
        ...
        /// <returns><c>True</c> if the property was present.</returns>
        /// <exception cref = "InvalidOperationException">The value is not an object.</exception>
        public bool TryGetProperty(string name, out Corvus.Json.JsonSchema.Draft6.Schema value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.TryGetProperty(name, out JsonElement result))
        ...
        /// <returns><c>True</c> if the property was present.</returns>
        /// <exception cref = "InvalidOperationException">The value is not an object.</exception>
        public bool TryGetProperty(ReadOnlySpan<char> name, out Corvus.Json.JsonSchema.Draft6.Schema value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.TryGetProperty(name, out JsonElement result))
        ...
        /// <returns><c>True</c> if the property was present.</returns>
        /// <exception cref = "InvalidOperationException">The value is not an object.</exception>
        public bool TryGetProperty(ReadOnlySpan<byte> utf8Name, out Corvus.Json.JsonSchema.Draft6.Schema value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.TryGetProperty(utf8Name, out JsonElement result))
        ...
        public PatternPropertiesEntity SetProperty(in JsonPropertyName name, in Corvus.Json.JsonSchema.Draft6.Schema value)
        {
            return new(this.GetPropertyBackingWith(name, value.AsAny));
        }
        ...
        /// <inheritdoc/>
        bool IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.Draft6.Schema>.ContainsKey(JsonPropertyName key)
        {
            return this.HasProperty(key);
        }

        /// <inheritdoc/>
        bool IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.Draft6.Schema>.TryGetValue(JsonPropertyName key, [MaybeNullWhen(false)] out Corvus.Json.JsonSchema.Draft6.Schema value)
        {
            return this.TryGetProperty(key, out value);
        }

        /// <inheritdoc/>
        IEnumerator<KeyValuePair<JsonPropertyName, Corvus.Json.JsonSchema.Draft6.Schema>> IEnumerable<KeyValuePair<JsonPropertyName, Corvus.Json.JsonSchema.Draft6.Schema>>.GetEnumerator()
        {
            if (this.HasJsonElementBacking)
            {
                return new ReadOnlyDictionaryJsonObjectEnumerator<Corvus.Json.JsonSchema.Draft6.Schema>(this.jsonElementBacking);
            }

            if (this.HasDotnetBacking)
            {
                return new ReadOnlyDictionaryJsonObjectEnumerator<Corvus.Json.JsonSchema.Draft6.Schema>(this.objectBacking);
            }
