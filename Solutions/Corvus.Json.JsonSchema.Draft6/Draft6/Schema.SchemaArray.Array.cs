...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SchemaArray
        : IJsonArray<Corvus.Json.JsonSchema.Draft6.Schema.SchemaArray>,
          IReadOnlyCollection<Corvus.Json.JsonSchema.Draft6.Schema>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        ...
        public Corvus.Json.JsonSchema.Draft6.Schema this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<Corvus.Json.JsonSchema.Draft6.Schema>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static SchemaArray FromItems(params Corvus.Json.JsonSchema.Draft6.Schema[] items)
        {
            return new([..items]);
        }
        ...
        public static SchemaArray FromItems(in Corvus.Json.JsonSchema.Draft6.Schema item1)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static SchemaArray FromItems(in Corvus.Json.JsonSchema.Draft6.Schema item1, in Corvus.Json.JsonSchema.Draft6.Schema item2)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static SchemaArray FromItems(in Corvus.Json.JsonSchema.Draft6.Schema item1, in Corvus.Json.JsonSchema.Draft6.Schema item2, in Corvus.Json.JsonSchema.Draft6.Schema item3)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static SchemaArray FromItems(in Corvus.Json.JsonSchema.Draft6.Schema item1, in Corvus.Json.JsonSchema.Draft6.Schema item2, in Corvus.Json.JsonSchema.Draft6.Schema item3, in Corvus.Json.JsonSchema.Draft6.Schema item4)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static SchemaArray FromItems(in Corvus.Json.JsonSchema.Draft6.Schema item1, in Corvus.Json.JsonSchema.Draft6.Schema item2, in Corvus.Json.JsonSchema.Draft6.Schema item3, in Corvus.Json.JsonSchema.Draft6.Schema item4, in Corvus.Json.JsonSchema.Draft6.Schema item5)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static SchemaArray FromItems(in Corvus.Json.JsonSchema.Draft6.Schema item1, in Corvus.Json.JsonSchema.Draft6.Schema item2, in Corvus.Json.JsonSchema.Draft6.Schema item3, in Corvus.Json.JsonSchema.Draft6.Schema item4, in Corvus.Json.JsonSchema.Draft6.Schema item5, in Corvus.Json.JsonSchema.Draft6.Schema item6)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static SchemaArray FromItems(in Corvus.Json.JsonSchema.Draft6.Schema item1, in Corvus.Json.JsonSchema.Draft6.Schema item2, in Corvus.Json.JsonSchema.Draft6.Schema item3, in Corvus.Json.JsonSchema.Draft6.Schema item4, in Corvus.Json.JsonSchema.Draft6.Schema item5, in Corvus.Json.JsonSchema.Draft6.Schema item6, in Corvus.Json.JsonSchema.Draft6.Schema item7)
        {
        ...
        public static SchemaArray FromRange(IEnumerable<Corvus.Json.JsonSchema.Draft6.Schema> items)
        {
            return new([..items]);
        }
        ...
        /// <inheritdoc/>
        IEnumerator<Corvus.Json.JsonSchema.Draft6.Schema> IEnumerable<Corvus.Json.JsonSchema.Draft6.Schema>.GetEnumerator() => this.EnumerateArray();

        /// <inheritdoc/>
        IEnumerator IEnumerable.GetEnumerator() => this.EnumerateArray();

        /// <inheritdoc/>
        int IReadOnlyCollection<Corvus.Json.JsonSchema.Draft6.Schema>.Count => this.GetArrayLength();
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Corvus.Json.JsonSchema.Draft6.Schema> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new(this.jsonElementBacking);
        ...
        /// <inheritdoc/>
        public SchemaArray Add(in Corvus.Json.JsonSchema.Draft6.Schema item1)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        public SchemaArray Add(params Corvus.Json.JsonSchema.Draft6.Schema[] items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            foreach (Corvus.Json.JsonSchema.Draft6.Schema item in items)
            {
                builder.Add(item.AsAny);
            }
        ...
        /// <inheritdoc/>
        public SchemaArray AddRange(IEnumerable<Corvus.Json.JsonSchema.Draft6.Schema> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            foreach (Corvus.Json.JsonSchema.Draft6.Schema item in items)
            {
        ...
        /// <inheritdoc/>
        public SchemaArray Insert(int index, in Corvus.Json.JsonSchema.Draft6.Schema item1)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
        }

        /// <inheritdoc/>
        public SchemaArray InsertRange(int index, IEnumerable<Corvus.Json.JsonSchema.Draft6.Schema> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
        }

        /// <inheritdoc/>
        public SchemaArray Replace(in Corvus.Json.JsonSchema.Draft6.Schema oldValue, in Corvus.Json.JsonSchema.Draft6.Schema newValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
        }

        /// <inheritdoc/>
        public SchemaArray SetItem(int index, in Corvus.Json.JsonSchema.Draft6.Schema value)
        {
            return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
        }
        ...
        /// <inheritdoc/>
        public SchemaArray Remove(in Corvus.Json.JsonSchema.Draft6.Schema oldValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
        }
