...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TypeEntity
        : IJsonArray<Corvus.Json.JsonSchema.Draft6.Schema.TypeEntity>,
          IReadOnlyCollection<Corvus.Json.JsonAny>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static TypeEntity EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
        ...
        public static TypeEntity From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }

        /// <summary>
        /// Create an new instance of the <see cref="TypeEntity"/>" struct from a span of items.
        /// </summary>
        ...
        public static TypeEntity Create(ReadOnlySpan<Corvus.Json.JsonAny> items)
        {
            return new([..items]);
        }
        ...
        public static TypeEntity FromItems(params Corvus.Json.JsonAny[] items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The value from which to construct the instance.</param>
        /// <returns>An instance of the array constructed from the value.</returns>
        public static TypeEntity FromItems<TItem>(params TItem[] items)
        ...
        public static TypeEntity FromItems<TItem1>(in TItem1 item1)
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static TypeEntity FromItems<TItem1, TItem2>(in TItem1 item1, in TItem2 item2)
            where TItem1 : struct, IJsonValue<TItem1>
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static TypeEntity FromItems<TItem1, TItem2, TItem3>(in TItem1 item1, in TItem2 item2, in TItem3 item3)
            where TItem1 : struct, IJsonValue<TItem1>
            where TItem2 : struct, IJsonValue<TItem2>
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static TypeEntity FromItems<TItem1, TItem2, TItem3, TItem4>(in TItem1 item1, in TItem2 item2, in TItem3 item3, in TItem4 item4)
            where TItem1 : struct, IJsonValue<TItem1>
            where TItem2 : struct, IJsonValue<TItem2>
            where TItem3 : struct, IJsonValue<TItem3>
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static TypeEntity FromItems<TItem1, TItem2, TItem3, TItem4, TItem5>(in TItem1 item1, in TItem2 item2, in TItem3 item3, in TItem4 item4, in TItem5 item5)
            where TItem1 : struct, IJsonValue<TItem1>
            where TItem2 : struct, IJsonValue<TItem2>
            where TItem3 : struct, IJsonValue<TItem3>
            where TItem4 : struct, IJsonValue<TItem4>
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static TypeEntity FromItems<TItem1, TItem2, TItem3, TItem4, TItem5, TItem6>(in TItem1 item1, in TItem2 item2, in TItem3 item3, in TItem4 item4, in TItem5 item5, in TItem6 item6)
            where TItem1 : struct, IJsonValue<TItem1>
            where TItem2 : struct, IJsonValue<TItem2>
            where TItem3 : struct, IJsonValue<TItem3>
            where TItem4 : struct, IJsonValue<TItem4>
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static TypeEntity FromItems<TItem1, TItem2, TItem3, TItem4, TItem5, TItem6, TItem7>(in TItem1 item1, in TItem2 item2, in TItem3 item3, in TItem4 item4, in TItem5 item5, in TItem6 item6, in TItem7 item7)
            where TItem1 : struct, IJsonValue<TItem1>
            where TItem2 : struct, IJsonValue<TItem2>
            where TItem3 : struct, IJsonValue<TItem3>
            where TItem4 : struct, IJsonValue<TItem4>
        ...
        public static TypeEntity FromRange(IEnumerable<Corvus.Json.JsonAny> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to construct the instance.</param>
        /// <returns>An instance of the array constructed from the items.</returns>
        public static TypeEntity FromRange<TItem>(IEnumerable<TItem> items)
            where TItem : struct, IJsonValue<TItem>
        {
            return new([..items.Select(item => item.AsAny)]);
        }
        ...
        /// </remarks>
        public static TypeEntity From<T>(IEnumerable<T> items)
        {
        ...
        /// <inheritdoc/>
        public TypeEntity Remove(in JsonAny oldValue)
        {
        ...
        private static class __CorvusArrayHelpers
        {
            ...
            public static ImmutableList<JsonAny> GetImmutableList(in TypeEntity arrayInstance)
            {
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in TypeEntity arrayInstance)
            {
            ...
            public static ImmutableList<JsonAny> GetImmutableListSetting(in TypeEntity arrayInstance, int index, in JsonAny value)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListReplacing(in TypeEntity arrayInstance, in JsonAny oldItem, in JsonAny newItem)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWithout(in TypeEntity arrayInstance, in JsonAny item)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in TypeEntity arrayInstance, int index, int count)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            // <exception cref = "InvalidOperationException">The value is not an array.</exception>
            // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWith(in TypeEntity arrayInstance, int index, in JsonAny value)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in TypeEntity arrayInstance, int index, TEnumerable values)
