...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TypeEntity : IJsonArray<TypeEntity>
    {
        ...
        /// Gets an empty array.
        /// </summary>
        public static readonly TypeEntity EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public TypeEntity(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
            this.stringBacking = string.Empty;
        ...
        public static TypeEntity Create(ReadOnlySpan<JsonAny> items)
        {
            return new([..items]);
        }
        ...
        public static TypeEntity FromItems(params JsonAny[] value)
        {
        ...
        public static TypeEntity FromItems<TItem>(params TItem[] value)
        ...
        /// <returns>A TypeEntity instantiated from the given items.</returns>
        public static TypeEntity FromItems<TItem1>(in TItem1 value1)
        ...
        /// <returns>A TypeEntity instantiated from the given items.</returns>
        public static TypeEntity FromItems<TItem1, TItem2>(in TItem1 value1, in TItem2 value2)
        ...
        /// <returns>A TypeEntity instantiated from the given items.</returns>
        public static TypeEntity FromItems<TItem1, TItem2, TItem3>(in TItem1 value1, in TItem2 value2, in TItem3 value3)
        ...
        public static TypeEntity From<T>(IEnumerable<T> items)
        {
            ...
            return new TypeEntity(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static TypeEntity FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static TypeEntity FromRange<T>(IEnumerable<T> items)
        ...
        /// <param name = "value1">The first value from which to construct the instance.</param>
        /// <returns>A TypeEntity instantiated from the given items.</returns>
        public static TypeEntity FromItems(in JsonAny value1)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1);
            return new(builder.ToImmutable());
        ...
        /// <param name = "value2">The second value from which to construct the instance.</param>
        /// <returns>A TypeEntity instantiated from the given items.</returns>
        public static TypeEntity FromItems(in JsonAny value1, in JsonAny value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1);
            builder.Add(value2);
        ...
        /// <param name = "value3">The thirdvalue from which to construct the instance.</param>
        /// <returns>A TypeEntity instantiated from the given items.</returns>
        public static TypeEntity FromItems(in JsonAny value1, in JsonAny value2, in JsonAny value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1);
            builder.Add(value2);
