...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TypeEntity
    {
        ...
        public static explicit operator Corvus.Json.JsonSchema.Draft6.Schema.SimpleTypes(TypeEntity value)
        {
            ...
            return Corvus.Json.JsonSchema.Draft6.Schema.SimpleTypes.Undefined;
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static explicit operator TypeEntity(Corvus.Json.JsonSchema.Draft6.Schema.SimpleTypes value)
        {
        ...
        public static explicit operator Corvus.Json.JsonSchema.Draft6.Schema.TypeEntity.SimpleTypesArray(TypeEntity value)
        {
            ...
            return Corvus.Json.JsonSchema.Draft6.Schema.TypeEntity.SimpleTypesArray.Undefined;
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static explicit operator TypeEntity(Corvus.Json.JsonSchema.Draft6.Schema.TypeEntity.SimpleTypesArray value)
        {
            if (value.HasJsonElementBacking)
            {
                return new(value.AsJsonElement);
