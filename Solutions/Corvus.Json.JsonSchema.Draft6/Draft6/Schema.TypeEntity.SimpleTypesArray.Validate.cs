        ...
        public readonly partial struct SimpleTypesArray
        {
            ...
            private static partial class CorvusValidation
            {
                    ...
                    ValidationLevel level)
                {
                    ...
                    int length = 0;
                    using JsonArrayEnumerator<Corvus.Json.JsonSchema.Draft6.Schema.SimpleTypes> arrayEnumerator = value.EnumerateArray();
                    while (arrayEnumerator.MoveNext())
                    {
                        ...
                        using JsonArrayEnumerator<Corvus.Json.JsonSchema.Draft6.Schema.SimpleTypes> innerEnumerator = value.EnumerateArray();
                        int innerIndex = -1;
