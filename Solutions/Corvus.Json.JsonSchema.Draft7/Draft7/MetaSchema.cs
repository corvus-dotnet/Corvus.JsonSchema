...
/// <summary>
/// MetaSchema for JsonSchema Draft 7.
/// </summary>
public sealed class MetaSchema : IMetaSchema
{
    /// <summary>
    /// Gets the default instance of the Draft 7 <see cref="MetaSchema"/>.
    /// </summary>
    public static MetaSchema Instance { get; } = new();

    /// <inheritdoc />
    public string Uri => "https://json-schema.org/draft-07/schema";

    /// <inheritdoc />
    public JsonDocument Document => JsonDocument.Parse(ReadResource("./metaschema/draft7/schema.json"));
