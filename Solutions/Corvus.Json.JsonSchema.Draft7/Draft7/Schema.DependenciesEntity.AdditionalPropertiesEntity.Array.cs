...
public readonly partial struct AdditionalPropertiesEntity : IJsonArray<AdditionalPropertiesEntity>, IEnumerable<JsonAny>
#else
...
#endif
        {
            ...
            /// Gets an empty array.
            /// </summary>
            public static readonly AdditionalPropertiesEntity EmptyArray = From(ImmutableList<JsonAny>.Empty);
            /// <summary>
            ...
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public AdditionalPropertiesEntity(IEnumerable<JsonAny> value)
            {
                this.jsonElementBacking = default;
                this.backing = Backing.Array;
                this.boolBacking = default;
            ...
            public static AdditionalPropertiesEntity FromItems(params JsonAny[] value)
            {
            ...
            public static AdditionalPropertiesEntity FromItems<TItem>(params TItem[] value)
            ...
            /// <returns>A AdditionalPropertiesEntity instantiated from the given items.</returns>
            public static AdditionalPropertiesEntity FromItems<TItem1>(in TItem1 value1)
            ...
            /// <returns>A AdditionalPropertiesEntity instantiated from the given items.</returns>
            public static AdditionalPropertiesEntity FromItems<TItem1, TItem2>(in TItem1 value1, in TItem2 value2)
            ...
            /// <returns>A AdditionalPropertiesEntity instantiated from the given items.</returns>
            public static AdditionalPropertiesEntity FromItems<TItem1, TItem2, TItem3>(in TItem1 value1, in TItem2 value2, in TItem3 value3)
            ...
            public static AdditionalPropertiesEntity From<T>(IEnumerable<T> items)
            {
                ...
                return new AdditionalPropertiesEntity(builder.ToImmutable());
            }
            ...
            /// other overloads which avoid this serialization step.
            /// </remarks>
            public static AdditionalPropertiesEntity FromRange(IEnumerable<JsonAny> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// other overloads which avoid this serialization step.
            /// </remarks>
            public static AdditionalPropertiesEntity FromRange<T>(IEnumerable<T> items)
            ...
            /// <param name = "value1">The first value from which to construct the instance.</param>
            /// <returns>A AdditionalPropertiesEntity instantiated from the given items.</returns>
            public static AdditionalPropertiesEntity FromItems(in JsonAny value1)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1);
                return new(builder.ToImmutable());
            ...
            /// <param name = "value2">The second value from which to construct the instance.</param>
            /// <returns>A AdditionalPropertiesEntity instantiated from the given items.</returns>
            public static AdditionalPropertiesEntity FromItems(in JsonAny value1, in JsonAny value2)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1);
                builder.Add(value2);
            ...
            /// <param name = "value3">The thirdvalue from which to construct the instance.</param>
            /// <returns>A AdditionalPropertiesEntity instantiated from the given items.</returns>
            public static AdditionalPropertiesEntity FromItems(in JsonAny value1, in JsonAny value2, in JsonAny value3)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1);
                builder.Add(value2);
