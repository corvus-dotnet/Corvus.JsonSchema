...
public readonly partial struct Schema
{
    public readonly partial struct NonNegativeIntegerDefault0
    {
        ...
        /// </summary>
        public readonly partial struct DefaultValue0 : IJsonObject<DefaultValue0>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "DefaultValue0"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public DefaultValue0(ImmutableList<JsonObjectProperty> value)
            {
            ...
            public static implicit operator DefaultValue0(JsonObject value)
            {
            ...
            public static DefaultValue0 FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
            {
            ...
            /// <param name = "source">The dictionary of properties.</param>
            /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
            public static DefaultValue0 FromProperties(ImmutableList<JsonObjectProperty> source)
            {
                return new(source);
            }
            ...
            /// <param name = "source">The dictionary of properties.</param>
            /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
            public static DefaultValue0 FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
            {
            ...
            /// <inheritdoc/>
            public DefaultValue0 SetProperty<TValue>(in JsonPropertyName name, TValue value)
            ...
            /// <inheritdoc/>
            public DefaultValue0 RemoveProperty(in JsonPropertyName name)
            {
                return new(this.GetPropertyBackingWithout(name));
            }

            /// <inheritdoc/>
            public DefaultValue0 RemoveProperty(string name)
            {
                return new(this.GetPropertyBackingWithout(name));
            }

            /// <inheritdoc/>
            public DefaultValue0 RemoveProperty(ReadOnlySpan<char> name)
            {
                return new(this.GetPropertyBackingWithout(name));
            }

            /// <inheritdoc/>
            public DefaultValue0 RemoveProperty(ReadOnlySpan<byte> utf8Name)
            {
