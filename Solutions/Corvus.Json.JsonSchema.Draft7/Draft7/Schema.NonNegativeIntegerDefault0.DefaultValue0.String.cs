...
public readonly partial struct Schema
{
    ...
    : IJsonString<DefaultValue0>, ISpanFormattable
#else
        : IJsonString<DefaultValue0>
#endif
        {
            /// <summary>
            ...
            public DefaultValue0(string value)
            {
            ...
            public static implicit operator DefaultValue0(string value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator DefaultValue0(JsonString value)
            {
            ...
            public static explicit operator string (DefaultValue0 value)
            {
            ...
            public static DefaultValue0 Concatenate<T1, T2>(Span<byte> buffer, in T1 firstValue, in T2 secondValue)
            ...
            /// <returns>An instance of this string type.</returns>
            public static DefaultValue0 Concatenate<T1, T2, T3>(Span<byte> buffer, in T1 firstValue, in T2 secondValue, in T3 thirdValue)
            ...
            /// <returns>An instance of this string type.</returns>
            public static DefaultValue0 Concatenate<T1, T2, T3, T4>(Span<byte> buffer, in T1 firstValue, in T2 secondValue, in T3 thirdValue, in T4 fourthValue)
            ...
            /// <returns>An instance of this string type.</returns>
            public static DefaultValue0 Concatenate<T1, T2, T3, T4, T5>(Span<byte> buffer, in T1 firstValue, in T2 secondValue, in T3 thirdValue, in T4 fourthValue, in T5 fifthValue)
            ...
            /// <returns>An instance of this string type.</returns>
            public static DefaultValue0 Concatenate<T1, T2, T3, T4, T5, T6>(Span<byte> buffer, in T1 firstValue, in T2 secondValue, in T3 thirdValue, in T4 fourthValue, in T5 fifthValue, in T6 sixthValue)
            ...
            /// <returns>An instance of this string type.</returns>
            public static DefaultValue0 Concatenate<T1, T2, T3, T4, T5, T6, T7>(Span<byte> buffer, in T1 firstValue, in T2 secondValue, in T3 thirdValue, in T4 fourthValue, in T5 fifthValue, in T6 sixthValue, in T7 seventhValue)
            ...
            /// <returns>An instance of this string type.</returns>
            public static DefaultValue0 Concatenate<T1, T2, T3, T4, T5, T6, T7, T8>(Span<byte> buffer, in T1 firstValue, in T2 secondValue, in T3 thirdValue, in T4 fourthValue, in T5 fifthValue, in T6 sixthValue, in T7 seventhValue, in T8 eighthValue)
