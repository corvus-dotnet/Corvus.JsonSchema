...
public readonly partial struct Schema
{
    ...
    public readonly partial struct NonNegativeIntegerDefault0
    {
        private ValidationContext ValidateAllOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext allOfResult1 = this.As<Corvus.Json.JsonSchema.Draft7.Schema.NonNegativeIntegerDefault0.DefaultValue0>().Validate(childContext1.CreateChildContext(), level);
