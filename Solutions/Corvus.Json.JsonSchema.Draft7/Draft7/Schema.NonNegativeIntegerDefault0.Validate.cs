    ...
    public readonly partial struct NonNegativeIntegerDefault0
    {
        ...
        public static partial class CorvusValidation
        {
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                allOfResult0 = value.As<Corvus.Json.JsonSchema.Draft7.Schema.NonNegativeInteger>().Validate(allOfResult0, level);
                ...
                allOfResult1 = value.As<Corvus.Json.JsonSchema.Draft7.Schema.NonNegativeIntegerDefault0.DefaultValueType0>().Validate(allOfResult1, level);
