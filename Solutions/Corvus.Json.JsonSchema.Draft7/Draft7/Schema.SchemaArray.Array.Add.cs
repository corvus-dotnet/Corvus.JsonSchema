...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SchemaArray
    {
        ...
        public SchemaArray Add(in Corvus.Json.JsonSchema.Draft7.Schema item1)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
            builder.Add(item1);
            return new(builder.ToImmutable());
        ...
        /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
        public SchemaArray Add(params Corvus.Json.JsonSchema.Draft7.Schema[] items)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
            foreach (Corvus.Json.JsonSchema.Draft7.Schema item in items)
            {
                builder.Add(item.AsAny);
            }
        ...
        /// <returns>An instance of the array with the items added.</returns>
        /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
        public SchemaArray AddRange(IEnumerable<Corvus.Json.JsonSchema.Draft7.Schema> items)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
            foreach (Corvus.Json.JsonSchema.Draft7.Schema item in items)
            {
        ...
        /// <returns>An instance of the array with the item added.</returns>
        /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
        public SchemaArray Insert(int index, in Corvus.Json.JsonSchema.Draft7.Schema item1)
        {
            return new(this.GetImmutableListWith(index, item1));
        }
        ...
        public SchemaArray InsertRange(int index, IEnumerable<Corvus.Json.JsonSchema.Draft7.Schema> items)
        {
            return new(this.GetImmutableListWith(index, items.Select(item => item.AsAny)));
        }
        ...
        /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
        public SchemaArray Replace(in Corvus.Json.JsonSchema.Draft7.Schema oldValue, in Corvus.Json.JsonSchema.Draft7.Schema newValue)
        {
            return new(this.GetImmutableListReplacing(oldValue.AsAny, newValue.AsAny));
        }
        ...
        public SchemaArray SetItem(int index, in Corvus.Json.JsonSchema.Draft7.Schema value)
        {
            return new(this.GetImmutableListSetting(index, value.AsAny));
        }
    }
