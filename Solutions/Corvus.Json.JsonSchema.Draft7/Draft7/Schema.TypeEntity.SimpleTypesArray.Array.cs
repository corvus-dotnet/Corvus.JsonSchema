...
public readonly partial struct SimpleTypesArray : IJsonArray<SimpleTypesArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypes>
#else
        public readonly partial struct SimpleTypesArray : IJsonArray<SimpleTypesArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypes>
#endif
        {
            ...
            public Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypes this[int index]
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        return new Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypes(this.jsonElementBacking[index]);
                    }
            ...
            public static SimpleTypesArray FromItems(in Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypes value1)
            {
            ...
            /// <returns>A SimpleTypesArray instantiated from the given items.</returns>
            public static SimpleTypesArray FromItems(in Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypes value1, in Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypes value2)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
            ...
            /// <returns>A SimpleTypesArray instantiated from the given items.</returns>
            public static SimpleTypesArray FromItems(in Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypes value1, in Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypes value2, in Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypes value3)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
                builder.Add(value2.AsAny);
            ...
            public static SimpleTypesArray FromItems(params Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypes[] value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypes item in value)
                {
            ...
            /// <param name = "value">The value from which to construct the instance.</param>
            /// <returns>A JsonAny instantiated from the given items.</returns>
            public static SimpleTypesArray FromRange(IEnumerable<Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypes> value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypes item in value)
                {
            ...
            /// <inheritdoc/>
            IEnumerator<Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypes> IEnumerable<Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypes>.GetEnumerator()
            {
            ...
            public JsonArrayEnumerator<Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypes> EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new JsonArrayEnumerator<Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypes>(this.jsonElementBacking);
                }

                if ((this.backing & Backing.Array) != 0)
                {
                    return new JsonArrayEnumerator<Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypes>(this.arrayBacking);
                }
