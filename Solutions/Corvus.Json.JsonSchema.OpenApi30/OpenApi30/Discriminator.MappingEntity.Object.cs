...
public readonly partial struct Discriminator
{
    ...
    /// </summary>
    public readonly partial struct MappingEntity : IJsonObject<MappingEntity>, IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonString>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "MappingEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public MappingEntity(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator MappingEntity(JsonObject value)
        {
        ...
        /// <inheritdoc/>
        JsonAny IJsonObject<MappingEntity>.this[in JsonPropertyName name]
        {
            get
            {
    ...
    static MappingEntity IJsonObject<MappingEntity>.FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static MappingEntity FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
    ...
    /// <param name="source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    static MappingEntity IJsonObject<MappingEntity>.FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static MappingEntity FromProperties(IDictionary<JsonPropertyName, Corvus.Json.JsonString> source)
        {
            return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static MappingEntity FromProperties(params (JsonPropertyName Name, Corvus.Json.JsonString Value)[] source)
        {
            return new(source.Select(s => new JsonObjectProperty(s.Name, s.Value.AsAny)).ToImmutableList());
        }

        /// <inheritdoc/>
        JsonObjectEnumerator IJsonObject<MappingEntity>.EnumerateObject()
        {
        ...
        /// <inheritdoc/>
        bool IJsonObject<MappingEntity>.TryGetProperty(in JsonPropertyName name, out JsonAny value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        bool IJsonObject<MappingEntity>.TryGetProperty(string name, out JsonAny value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        bool IJsonObject<MappingEntity>.TryGetProperty(ReadOnlySpan<char> name, out JsonAny value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.TryGetProperty(name, out JsonElement result))
        ...
        /// <inheritdoc/>
        bool IJsonObject<MappingEntity>.TryGetProperty(ReadOnlySpan<byte> utf8Name, out JsonAny value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        bool IJsonObject<MappingEntity>.TryGetProperty<TValue>(in JsonPropertyName name, out TValue value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (name.TryGetProperty(this.jsonElementBacking, out JsonElement result))
        ...
        /// <inheritdoc/>
        bool IJsonObject<MappingEntity>.TryGetProperty<TValue>(string name, out TValue value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.TryGetProperty(name, out JsonElement result))
        ...
        /// <inheritdoc/>
        bool IJsonObject<MappingEntity>.TryGetProperty<TValue>(ReadOnlySpan<char> name, out TValue value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.TryGetProperty(name, out JsonElement result))
        ...
        /// <inheritdoc/>
        bool IJsonObject<MappingEntity>.TryGetProperty<TValue>(ReadOnlySpan<byte> utf8Name, out TValue value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.TryGetProperty(utf8Name, out JsonElement result))
        ...
        /// <inheritdoc/>
        MappingEntity IJsonObject<MappingEntity>.SetProperty<TValue>(in JsonPropertyName name, TValue value)
        {
        ...
        public MappingEntity SetProperty(in JsonPropertyName name, in Corvus.Json.JsonString value)
        {
            return new(this.GetPropertyBackingWith(name, value.AsAny));
        }

        /// <inheritdoc/>
        public MappingEntity RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public MappingEntity RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public MappingEntity RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public MappingEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
