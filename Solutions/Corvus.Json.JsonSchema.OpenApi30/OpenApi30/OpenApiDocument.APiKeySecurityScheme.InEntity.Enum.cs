...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct APiKeySecurityScheme
    {
        ...
        public readonly partial struct InEntity
        {
            ...
            public TOut Match<TIn, TOut>(in TIn context, Func<TIn, TOut> matchHeader, Func<TIn, TOut> matchQuery, Func<TIn, TOut> matchCookie, Func<TIn, TOut> defaultMatch)
            {
            ...
            /// <param name = "matchCookie">The function to call if the value matches the JSON value "\"cookie\"".</param>
            /// <param name = "defaultMatch">The fallback match.</param>
            public TOut Match<TOut>(Func<TOut> matchHeader, Func<TOut> matchQuery, Func<TOut> matchCookie, Func<TOut> defaultMatch)
            {
                if (this.ValueKind == JsonValueKind.String)
                {
                    if (this.HasJsonElementBacking)
            ...
            public static class EnumValues
            {
                ...
                /// Gets "query" as a JSON value.
                /// </summary>
                internal static readonly InEntity Item1 = InEntity.Parse("\"query\"");
                /// <summary>
                /// Gets "cookie" as a JSON value.
                /// </summary>
