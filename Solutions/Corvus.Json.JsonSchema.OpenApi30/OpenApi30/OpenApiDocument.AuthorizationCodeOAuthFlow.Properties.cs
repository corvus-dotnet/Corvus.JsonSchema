...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct AuthorizationCodeOAuthFlow
    {
        ...
        public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.AuthorizationCodeOAuthFlow.ScopesEntity Scopes
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
                        return new Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.AuthorizationCodeOAuthFlow.ScopesEntity(result);
                    }
                }
        ...
        /// </summary>
        public static AuthorizationCodeOAuthFlow Create(Corvus.Json.JsonUriReference authorizationUrl, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.AuthorizationCodeOAuthFlow.ScopesEntity scopes, Corvus.Json.JsonUriReference tokenUrl, Corvus.Json.JsonUriReference? refreshUrl = null)
        {
        ...
        {
            return property.ValueAs<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.AuthorizationCodeOAuthFlow.ScopesEntity>().Validate(validationContext, level);
        }
