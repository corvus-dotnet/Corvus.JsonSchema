...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct ClientCredentialsFlow
    {
        ...
        public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ClientCredentialsFlow.ScopesEntity Scopes
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
                        return new Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ClientCredentialsFlow.ScopesEntity(result);
                    }
                }
        ...
        /// </summary>
        public static ClientCredentialsFlow Create(Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ClientCredentialsFlow.ScopesEntity scopes, Corvus.Json.JsonUriReference tokenUrl, Corvus.Json.JsonUriReference? refreshUrl = null)
        {
        ...
        {
            return property.ValueAs<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ClientCredentialsFlow.ScopesEntity>().Validate(validationContext, level);
        }
