        ...
        public readonly partial struct HeadersEntity
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("https://spec.openapis.org/oas/3.0/schema/2021-09-28#/definitions/Components/properties/headers");
                }
                    ...
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    foreach (JsonObjectProperty property in value.EnumerateObject())
                    {
                        ...
                        if (PatternProperties.IsMatch(propertyNameAsString))
                        {
                            ...
                            result = property.Value.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Components.HeadersEntity.AZaZ09Entity>().Validate(result, level);
                            if (level > ValidationLevel.Basic)
                            {
                                result = result.PopLocation();
                            }
