    ...
    public readonly partial struct Components
    {
        public readonly partial struct LinksEntity
        {
            ...
            public readonly partial struct AZaZ09Entity
            {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static explicit operator Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Link(AZaZ09Entity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                        return new(value.AsJsonElement);
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator AZaZ09Entity(Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Link value)
                {
                    if (value.HasJsonElementBacking)
                    {
                        return new(value.AsJsonElement);
