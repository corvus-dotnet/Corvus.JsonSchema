        ...
        public readonly partial struct RequestBodiesEntity
        {
            ...
            public readonly partial struct AZaZ09Entity
            {
                ...
                public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.RequestBody AsRequestBody
                {
                    get
                    {
                        return (Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.RequestBody)this;
                    }
                }

                /// <summary>
                /// Gets a value indicating whether this is a valid <see cref = "Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.RequestBody"/>.
                /// </summary>
                public bool IsRequestBody
                {
                    get
                    {
                        return ((Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.RequestBody)this).IsValid();
                    }
                }
                ...
                {
                    result = (Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.RequestBody)this;
                    return result.IsValid();
                }
            }
        }
