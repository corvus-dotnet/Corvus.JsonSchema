        ...
        public readonly partial struct SecuritySchemesEntity
        {
            ...
            public readonly partial struct AZaZ09Entity
            {
                private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
                {
                    ...
                    ValidationContext oneOfResult1 = this.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SecurityScheme>().Validate(childContext1.CreateChildContext(), level);
