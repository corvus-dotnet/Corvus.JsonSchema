...
[CollectionBuilder(typeof(ExampleXOrExamples), "Create")]
public readonly partial struct ExampleXOrExamples : IJsonArray<ExampleXOrExamples>, IReadOnlyCollection<JsonAny>
#else
    public readonly partial struct ExampleXOrExamples : IJsonArray<ExampleXOrExamples>, IReadOnlyCollection<JsonAny>
#endif
    {
        ...
        /// Gets an empty array.
        /// </summary>
        public static readonly ExampleXOrExamples EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExampleXOrExamples(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
            this.stringBacking = string.Empty;
        ...
        public static implicit operator ImmutableList<JsonAny>(ExampleXOrExamples value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExampleXOrExamples(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExampleXOrExamples(JsonArray value)
        {
        ...
        public static ExampleXOrExamples From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        public static ExampleXOrExamples Create(ReadOnlySpan<JsonAny> items)
        {
            return new([..items]);
        }
        ...
        public static ExampleXOrExamples FromItems(params JsonAny[] value)
        {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A ExampleXOrExamples instantiated from the given items.</returns>
        public static ExampleXOrExamples FromItems<TItem>(params TItem[] value)
        ...
        /// <returns>A ExampleXOrExamples instantiated from the given items.</returns>
        public static ExampleXOrExamples FromItems<TItem1>(in TItem1 value1)
        ...
        /// <returns>A ExampleXOrExamples instantiated from the given items.</returns>
        public static ExampleXOrExamples FromItems<TItem1, TItem2>(in TItem1 value1, in TItem2 value2)
        ...
        /// <returns>A ExampleXOrExamples instantiated from the given items.</returns>
        public static ExampleXOrExamples FromItems<TItem1, TItem2, TItem3>(in TItem1 value1, in TItem2 value2, in TItem3 value3)
        ...
        /// </remarks>
        public static ExampleXOrExamples From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new ExampleXOrExamples(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ExampleXOrExamples FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ExampleXOrExamples FromRange<T>(IEnumerable<T> items)
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ExampleXOrExamples FromRange(IEnumerable<string> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ExampleXOrExamples FromRange(IEnumerable<double> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ExampleXOrExamples FromRange(IEnumerable<float> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ExampleXOrExamples FromRange(IEnumerable<int> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ExampleXOrExamples FromRange(IEnumerable<long> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ExampleXOrExamples FromRange(IEnumerable<bool> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "value1">The first value from which to construct the instance.</param>
        /// <returns>A ExampleXOrExamples instantiated from the given items.</returns>
        public static ExampleXOrExamples FromItems(in JsonAny value1)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1);
            return new(builder.ToImmutable());
        ...
        /// <param name = "value2">The second value from which to construct the instance.</param>
        /// <returns>A ExampleXOrExamples instantiated from the given items.</returns>
        public static ExampleXOrExamples FromItems(in JsonAny value1, in JsonAny value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1);
            builder.Add(value2);
        ...
        /// <param name = "value3">The thirdvalue from which to construct the instance.</param>
        /// <returns>A ExampleXOrExamples instantiated from the given items.</returns>
        public static ExampleXOrExamples FromItems(in JsonAny value1, in JsonAny value2, in JsonAny value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1);
            builder.Add(value2);
