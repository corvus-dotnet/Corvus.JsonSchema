...
public readonly partial struct OpenApiDocument
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct ExampleXOrExamples : IJsonObject<ExampleXOrExamples>
    {
        /// <summary>
        ...
        public static implicit operator ExampleXOrExamples(JsonObject value)
        {
        ...
        public static ExampleXOrExamples FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static ExampleXOrExamples FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static ExampleXOrExamples FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public ExampleXOrExamples SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public ExampleXOrExamples RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ExampleXOrExamples RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ExampleXOrExamples RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ExampleXOrExamples RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
