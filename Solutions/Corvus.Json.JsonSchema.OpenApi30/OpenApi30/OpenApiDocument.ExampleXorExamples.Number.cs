...
: IJsonNumber<ExampleXorExamples>,
  IAdditionOperators<ExampleXorExamples, ExampleXorExamples, ExampleXorExamples>,
  ISubtractionOperators<ExampleXorExamples, ExampleXorExamples, ExampleXorExamples>,
  IMultiplyOperators<ExampleXorExamples, ExampleXorExamples, ExampleXorExamples>,
  IDivisionOperators<ExampleXorExamples, ExampleXorExamples, ExampleXorExamples>,
  IIncrementOperators<ExampleXorExamples>,
  IDecrementOperators<ExampleXorExamples>
#else
    : IJsonNumber<ExampleXorExamples>
#endif
    {
        ...
        public ExampleXorExamples(in BinaryJsonNumber value)
        {
        ...
        public ExampleXorExamples(double value) : this(new BinaryJsonNumber(value))
        {
        }
        ...
        public static implicit operator ExampleXorExamples(JsonNumber value)
        {
        ...
        public static explicit operator byte (ExampleXorExamples value)
        {
        ...
        public static explicit operator decimal (ExampleXorExamples value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator double (ExampleXorExamples value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator short (ExampleXorExamples value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator int (ExampleXorExamples value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator long (ExampleXorExamples value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an Int64.</exception>
    public static explicit operator Int128(ExampleXorExamples value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        public static explicit operator sbyte (ExampleXorExamples value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
    ...
    public static explicit operator Half(ExampleXorExamples value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        /// <exception cref = "InvalidOperationException">The value was not a number.</exception>
        /// <exception cref = "FormatException">The value was not formatted as a Single.</exception>
        public static explicit operator float (ExampleXorExamples value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator ushort (ExampleXorExamples value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator uint (ExampleXorExamples value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator ulong (ExampleXorExamples value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an UInt64.</exception>
    public static explicit operator UInt128(ExampleXorExamples value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ExampleXorExamples(decimal value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ExampleXorExamples(double value)
        {
            return new(new BinaryJsonNumber(value));
        }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator ExampleXorExamples(Half value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ExampleXorExamples(float value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ExampleXorExamples(byte value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ExampleXorExamples(short value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ExampleXorExamples(int value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ExampleXorExamples(long value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ExampleXorExamples(sbyte value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ExampleXorExamples(ushort value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ExampleXorExamples(uint value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ExampleXorExamples(ulong value)
        {
            return new(new BinaryJsonNumber(value));
        }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator ExampleXorExamples(Int128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator ExampleXorExamples(UInt128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
        ...
        public static ExampleXorExamples operator +(ExampleXorExamples left, ExampleXorExamples right)
        {
        ...
        /// <returns>The resulting value.</returns>
        public static ExampleXorExamples operator ++(ExampleXorExamples value)
        {
        ...
        public static int Compare(in ExampleXorExamples lhs, in ExampleXorExamples rhs)
        {
