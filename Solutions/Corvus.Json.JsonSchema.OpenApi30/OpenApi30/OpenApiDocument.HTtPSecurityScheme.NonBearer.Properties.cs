...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct HTtPSecurityScheme
    {
        ...
        public readonly partial struct NonBearer
        {
            ...
            public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.HTtPSecurityScheme.NonBearer.SchemeEntity Scheme
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        ...
                        {
                            return new Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.HTtPSecurityScheme.NonBearer.SchemeEntity(result);
                        }
                    }
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.HTtPSecurityScheme.NonBearer.SchemeEntity>();
                        }
                    }
            ...
            /// <summary>
            /// Creates an instance of a <see cref = "NonBearer"/>.
            /// </summary>
            public static NonBearer Create(Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.HTtPSecurityScheme.NonBearer.SchemeEntity? scheme = null)
            {
                var builder = ImmutableList.CreateBuilder<JsonObjectProperty>();
                if (scheme is Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.HTtPSecurityScheme.NonBearer.SchemeEntity scheme__)
                {
            ...
            public NonBearer WithScheme(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.HTtPSecurityScheme.NonBearer.SchemeEntity value)
            {
            ...
            {
                return property.ValueAs<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.HTtPSecurityScheme.NonBearer.SchemeEntity>().Validate(validationContext, level);
            }
