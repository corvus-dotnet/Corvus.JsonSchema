...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct HTtPSecurityScheme
    {
        public readonly partial struct OneOf1Entity
        {
            ...
            {
                /// <inheritdoc/>
                public SchemeEntity Add(in JsonAny item1)
                {
                ...
                /// <inheritdoc/>
                public SchemeEntity Add(params JsonAny[] items)
                {
                    ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
                ...
                /// <inheritdoc/>
                public SchemeEntity AddRange<TArray>(in TArray items)
                ...
                /// <inheritdoc/>
                public SchemeEntity AddRange<TItem>(IEnumerable<TItem> items)
                ...
                /// <inheritdoc/>
                public SchemeEntity AddRange(IEnumerable<JsonAny> items)
                {
                    ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
                    builder.AddRange(items);
                    return new(builder.ToImmutable());
                ...
                /// <inheritdoc/>
                public SchemeEntity Insert(int index, in JsonAny item1)
                {
                    return new(this.GetImmutableListWith(index, item1));
                }

                /// <inheritdoc/>
                public SchemeEntity InsertRange<TArray>(int index, in TArray items)
                    where TArray : struct, IJsonArray<TArray>
                {
                ...
                /// <inheritdoc/>
                public SchemeEntity InsertRange<TItem>(int index, IEnumerable<TItem> items)
                    where TItem : struct, IJsonValue<TItem>
                {
                ...
                /// <inheritdoc/>
                public SchemeEntity InsertRange(int index, IEnumerable<JsonAny> items)
                {
                    return new(this.GetImmutableListWith(index, items));
                }

                /// <inheritdoc/>
                public SchemeEntity Replace(in JsonAny oldValue, in JsonAny newValue)
                {
                    return new(this.GetImmutableListReplacing(oldValue.AsAny, newValue.AsAny));
                }

                /// <inheritdoc/>
                public SchemeEntity SetItem(int index, in JsonAny value)
                {
