...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct HTtPSecurityScheme
    {
        public readonly partial struct OneOf1Entity
        {
            ...
            /// </summary>
            public readonly partial struct SchemeEntity : IJsonBoolean<SchemeEntity>
            {
                /// <summary>
                ...
                public static implicit operator SchemeEntity(JsonBoolean value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator SchemeEntity(bool value)
                {
                    return new(value);
                }
                ...
                public static implicit operator bool (SchemeEntity value)
                {
