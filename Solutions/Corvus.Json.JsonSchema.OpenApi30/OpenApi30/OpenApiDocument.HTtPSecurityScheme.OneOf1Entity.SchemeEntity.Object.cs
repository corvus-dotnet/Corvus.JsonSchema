...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct HTtPSecurityScheme
    {
        public readonly partial struct OneOf1Entity
        {
            ...
            /// </summary>
            public readonly partial struct SchemeEntity : IJsonObject<SchemeEntity>
            {
                /// <summary>
                ...
                public static implicit operator SchemeEntity(JsonObject value)
                {
                ...
                public static SchemeEntity FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
                {
                ...
                /// <param name = "source">The dictionary of properties.</param>
                /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
                public static SchemeEntity FromProperties(ImmutableList<JsonObjectProperty> source)
                {
                    return new(source);
                }
                ...
                /// <param name = "source">The dictionary of properties.</param>
                /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
                public static SchemeEntity FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
                {
                ...
                /// <inheritdoc/>
                public SchemeEntity SetProperty<TValue>(in JsonPropertyName name, TValue value)
                ...
                /// <inheritdoc/>
                public SchemeEntity RemoveProperty(in JsonPropertyName name)
                {
                    return new(this.GetPropertyBackingWithout(name));
                }

                /// <inheritdoc/>
                public SchemeEntity RemoveProperty(string name)
                {
                    return new(this.GetPropertyBackingWithout(name));
                }

                /// <inheritdoc/>
                public SchemeEntity RemoveProperty(ReadOnlySpan<char> name)
                {
                    return new(this.GetPropertyBackingWithout(name));
                }

                /// <inheritdoc/>
                public SchemeEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
                {
