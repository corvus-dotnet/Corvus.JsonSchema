        ...
        public readonly partial struct OneOf1Entity
        {
            ...
            public readonly partial struct SchemeEntity
            {
                private ValidationContext ValidateNot(ValidationContext validationContext, ValidationLevel level)
                {
                    ...
                    ValidationContext notResult = this.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.HTtPSecurityScheme.OneOf1Entity.SchemeEntity.NotEntity>().Validate(validationContext.CreateChildContext(), level);
