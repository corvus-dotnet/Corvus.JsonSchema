    ...
    public readonly partial struct HTtPSecurityScheme
    {
        ...
        public readonly partial struct OneOf1Entity
        {
            private ValidationContext ValidateNot(ValidationContext validationContext, ValidationLevel level)
            {
                ...
                ValidationContext notResult = this.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.HTtPSecurityScheme.OneOf1Entity.NotEntity>().Validate(validationContext.CreateChildContext(), level);
