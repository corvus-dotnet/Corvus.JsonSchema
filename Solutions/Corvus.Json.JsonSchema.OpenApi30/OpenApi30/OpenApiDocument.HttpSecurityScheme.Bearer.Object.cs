...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct HttpSecurityScheme
    {
        ...
        /// </para>
        /// </remarks>
        public readonly partial struct Bearer : IJsonObject<Bearer>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "Bearer"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public Bearer(ImmutableList<JsonObjectProperty> value)
            {
            ...
            /// <inheritdoc/>
            public Bearer RemoveProperty(ReadOnlySpan<byte> utf8Name)
            {
