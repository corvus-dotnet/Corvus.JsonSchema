    ...
    public readonly partial struct ImplicitOAuthFlow
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("https://spec.openapis.org/oas/3.0/schema/2021-09-28#/definitions/ImplicitOAuthFlow");
            }
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                foreach (JsonObjectProperty property in value.EnumerateObject())
                {
                    ...
                    else if (property.NameEquals(JsonPropertyNames.ScopesUtf8, JsonPropertyNames.Scopes))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ImplicitOAuthFlow.ScopesEntity>().Validate(result.CreateChildContext(), level);
                        result = result.MergeResults(propertyResult.IsValid, level, propertyResult);
                        if (level > ValidationLevel.Basic)
                        {
                            result = result.PopLocation();
