...
public readonly partial struct OpenApiDocument
{
        ...
        : IJsonObject<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Link>
    {
        ...
        /// <param name="value">The new property value</param>
        /// <returns>The instance with the property set.</returns>
        public Link WithParameters(in Corvus.Json.JsonObject value)
        {
        ...
        /// <param name="value">The new property value</param>
        /// <returns>The instance with the property set.</returns>
        public Link WithServerValue(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Server value)
        {
            return this.SetProperty(JsonPropertyNames.ServerValue, value);
        }
