...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct Link
    {
        private ValidationContext ValidateNot(ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext notResult = this.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Link.OperationIdAndOperationRefAreMutuallyExclusive>().Validate(validationContext.CreateChildContext(), level);
