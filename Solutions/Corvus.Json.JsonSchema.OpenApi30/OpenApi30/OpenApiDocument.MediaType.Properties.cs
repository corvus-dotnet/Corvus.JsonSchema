...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct MediaType
    {
        ...
        /// </summary>
        public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.MediaType.EncodingEntity EncodingValue
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
                        return new Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.MediaType.EncodingEntity(result);
                    }
                }
        ...
        public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.MediaType.ExamplesEntity Examples
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
                        return new Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.MediaType.ExamplesEntity(result);
                    }
                }
        ...
        public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.MediaType.SchemaEntity Schema
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
                        return new Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.MediaType.SchemaEntity(result);
                    }
                }
        ...
        /// </summary>
        public static MediaType Create(Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.MediaType.EncodingEntity? encodingValue = null, Corvus.Json.JsonAny? example = null, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.MediaType.ExamplesEntity? examples = null, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.MediaType.SchemaEntity? schema = null)
        {
            var builder = ImmutableList.CreateBuilder<JsonObjectProperty>();
            if (encodingValue is Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.MediaType.EncodingEntity encodingValue__)
            {
            ...
            if (examples is Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.MediaType.ExamplesEntity examples__)
            {
                builder.Add(JsonPropertyNames.Examples, examples__.AsAny);
            }

            if (schema is Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.MediaType.SchemaEntity schema__)
            {
        ...
        public MediaType WithEncodingValue(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.MediaType.EncodingEntity value)
        {
        ...
        {
            return property.ValueAs<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.MediaType.SchemaEntity>().Validate(validationContext, level);
        }
        ...
        {
            return property.ValueAs<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.MediaType.ExamplesEntity>().Validate(validationContext, level);
        }
        ...
        {
            return property.ValueAs<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.MediaType.EncodingEntity>().Validate(validationContext, level);
        }
