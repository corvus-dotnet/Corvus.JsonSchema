...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct OAuthFlows
    {
        ...
        public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.AuthorizationCodeOAuthFlow AuthorizationCode
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
                        return new Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.AuthorizationCodeOAuthFlow(result);
                    }
                }
        ...
        public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ClientCredentialsFlow ClientCredentials
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
                        return new Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ClientCredentialsFlow(result);
                    }
                }
        ...
        public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ImplicitOAuthFlow Implicit
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
                        return new Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ImplicitOAuthFlow(result);
                    }
                }
        ...
        public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.PasswordOAuthFlow Password
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
                        return new Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.PasswordOAuthFlow(result);
                    }
                }
        ...
        /// </summary>
        public static OAuthFlows Create(Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.AuthorizationCodeOAuthFlow? authorizationCode = null, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ClientCredentialsFlow? clientCredentials = null, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ImplicitOAuthFlow? @implicit = null, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.PasswordOAuthFlow? password = null)
        {
            var builder = ImmutableList.CreateBuilder<JsonObjectProperty>();
            if (authorizationCode is Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.AuthorizationCodeOAuthFlow authorizationCode__)
            {
                builder.Add(JsonPropertyNames.AuthorizationCode, authorizationCode__.AsAny);
            }

            if (clientCredentials is Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ClientCredentialsFlow clientCredentials__)
            {
                builder.Add(JsonPropertyNames.ClientCredentials, clientCredentials__.AsAny);
            }

            if (@implicit is Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ImplicitOAuthFlow @implicit__)
            {
                builder.Add(JsonPropertyNames.Implicit, @implicit__.AsAny);
            }

            if (password is Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.PasswordOAuthFlow password__)
            {
        ...
        {
            return property.ValueAs<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ImplicitOAuthFlow>().Validate(validationContext, level);
        }
        ...
        {
            return property.ValueAs<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.PasswordOAuthFlow>().Validate(validationContext, level);
        }
        ...
        {
            return property.ValueAs<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ClientCredentialsFlow>().Validate(validationContext, level);
        }
        ...
        {
            return property.ValueAs<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.AuthorizationCodeOAuthFlow>().Validate(validationContext, level);
        }
