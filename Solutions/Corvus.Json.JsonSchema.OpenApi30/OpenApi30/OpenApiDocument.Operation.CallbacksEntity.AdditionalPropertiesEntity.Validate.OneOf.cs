        ...
        public readonly partial struct CallbacksEntity
        {
            ...
            public readonly partial struct AdditionalPropertiesEntity
            {
                private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
                {
                    ...
                    ValidationContext oneOfResult0 = this.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Callback>().Validate(childContext0.CreateChildContext(), level);
                    ...
                    ValidationContext oneOfResult1 = this.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Reference>().Validate(childContext1.CreateChildContext(), level);
