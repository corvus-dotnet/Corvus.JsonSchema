...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct Operation
    {
        ...
        /// </summary>
        public readonly partial struct CallbacksEntity : IJsonObject<CallbacksEntity>, IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity>
        {
            /// <summary>
            ...
            JsonAny IJsonObject<CallbacksEntity>.this[in JsonPropertyName name]
            {
                get
                {
                    if (this.TryGetProperty(name, out Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity result))
                    {
                        return result.AsAny;
                    }
            ...
            /// </summary>
            public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity this[in JsonPropertyName name]
            {
                get
                {
                    if (this.TryGetProperty(name, out Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity result))
            ...
            /// <inheritdoc/>
            Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity>.this[JsonPropertyName key] => this[key];
            /// <inheritdoc/>
            IEnumerable<JsonPropertyName> IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity>.Keys
            {
                get
                {
            ...
            /// <inheritdoc/>
            IEnumerable<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity> IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity>.Values
            {
                get
                {
                    foreach (var property in this.EnumerateObject())
            ...
            /// <inheritdoc/>
            int IReadOnlyCollection<KeyValuePair<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity>>.Count
            {
                get
                {
    ...
    static CallbacksEntity IJsonObject<CallbacksEntity>.FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
        return new(source.Select(s => new JsonObjectProperty(s.Name, s.Value)).ToImmutableList());
            ...
            /// <param name = "source">The dictionary of properties.</param>
            /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
            public static CallbacksEntity FromProperties(IDictionary<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity> source)
            {
                return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
            }
            ...
            /// <param name = "source">The dictionary of properties.</param>
            /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
            public static CallbacksEntity FromProperties(params (JsonPropertyName Name, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity Value)[] source)
            {
            ...
            public JsonObjectEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity> EnumerateObject()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new(this.jsonElementBacking);
            ...
            /// <exception cref = "InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(in JsonPropertyName name, out Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity value)
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    if (name.TryGetProperty(this.jsonElementBacking, out JsonElement result))
                    {
#if NET8_0_OR_GREATER
                value = Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity.FromJson(result);
#else
                        value = JsonValueNetStandard20Extensions.FromJsonElement<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity>(result);
#endif
                        return true;
                    }
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
#if NET8_0_OR_GREATER
                value = Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity.FromAny(result);
#else
                        value = result.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity>();
#endif
                        return true;
                    }
            ...
            /// <returns><c>True</c> if the property was present.</returns>
            /// <exception cref = "InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(string name, out Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity value)
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    if (this.jsonElementBacking.TryGetProperty(name, out JsonElement result))
            ...
            /// <returns><c>True</c> if the property was present.</returns>
            /// <exception cref = "InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(ReadOnlySpan<char> name, out Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity value)
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    if (this.jsonElementBacking.TryGetProperty(name, out JsonElement result))
            ...
            /// <returns><c>True</c> if the property was present.</returns>
            /// <exception cref = "InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(ReadOnlySpan<byte> utf8Name, out Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity value)
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    if (this.jsonElementBacking.TryGetProperty(utf8Name, out JsonElement result))
            ...
            public CallbacksEntity SetProperty(in JsonPropertyName name, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity value)
            {
                return new(this.GetPropertyBackingWith(name, value.AsAny));
            }
            ...
            /// <inheritdoc/>
            bool IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity>.ContainsKey(JsonPropertyName key)
            {
                return this.HasProperty(key);
            }

            /// <inheritdoc/>
            bool IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity>.TryGetValue(JsonPropertyName key, [MaybeNullWhen(false)] out Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity value)
            {
                return this.TryGetProperty(key, out value);
            }

            /// <inheritdoc/>
            IEnumerator<KeyValuePair<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity>> IEnumerable<KeyValuePair<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity>>.GetEnumerator()
            {
                if (this.HasJsonElementBacking)
                {
                    return new ReadOnlyDictionaryJsonObjectEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity>(this.jsonElementBacking);
                }

                if (this.HasDotnetBacking)
                {
                    return new ReadOnlyDictionaryJsonObjectEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.CallbacksEntity.AdditionalPropertiesEntity>(this.objectBacking);
                }
