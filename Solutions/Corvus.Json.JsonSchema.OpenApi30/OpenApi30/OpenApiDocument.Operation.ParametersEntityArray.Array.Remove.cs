...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct Operation
    {
        ...
        public readonly partial struct ParametersEntityArray
        {
            ...
            ParametersEntityArray IJsonArray<ParametersEntityArray>.Remove(in JsonAny item1)
            {
            ...
            public ParametersEntityArray Remove(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.ParametersEntityArray.ParametersEntity item)
            {
            ...
            /// <inheritdoc/>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public ParametersEntityArray RemoveAt(int index)
            {
            ...
            /// <inheritdoc/>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public ParametersEntityArray RemoveRange(int index, int count)
            {
