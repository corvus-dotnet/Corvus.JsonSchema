...
public readonly partial struct ParametersEntityArray : IJsonArray<ParametersEntityArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.ParametersEntityArray.ParametersEntity>
#else
        public readonly partial struct ParametersEntityArray : IJsonArray<ParametersEntityArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.ParametersEntityArray.ParametersEntity>
#endif
        {
            ...
            /// Gets an empty array.
            /// </summary>
            public static readonly ParametersEntityArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
            /// <summary>
            ...
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public ParametersEntityArray(IEnumerable<JsonAny> value)
            {
                this.jsonElementBacking = default;
                this.backing = Backing.Array;
            ...
            /// <inheritdoc/>
            JsonAny IJsonArray<ParametersEntityArray>.this[int index]
            {
                get
                {
            ...
            public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.ParametersEntityArray.ParametersEntity this[int index]
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        return new Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.ParametersEntityArray.ParametersEntity(this.jsonElementBacking[index]);
                    }
            ...
            /// <returns>A ParametersEntityArray instantiated from the given items.</returns>
            public static ParametersEntityArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.ParametersEntityArray.ParametersEntity value1)
            {
            ...
            /// <returns>A ParametersEntityArray instantiated from the given items.</returns>
            public static ParametersEntityArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.ParametersEntityArray.ParametersEntity value1, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.ParametersEntityArray.ParametersEntity value2)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
            ...
            /// <returns>A ParametersEntityArray instantiated from the given items.</returns>
            public static ParametersEntityArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.ParametersEntityArray.ParametersEntity value1, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.ParametersEntityArray.ParametersEntity value2, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.ParametersEntityArray.ParametersEntity value3)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
                builder.Add(value2.AsAny);
            ...
            public static ParametersEntityArray FromItems(params Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.ParametersEntityArray.ParametersEntity[] value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.ParametersEntityArray.ParametersEntity item in value)
                {
            ...
            /// <param name = "value">The value from which to construct the instance.</param>
            /// <returns>A JsonAny instantiated from the given items.</returns>
            public static ParametersEntityArray FromRange(IEnumerable<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.ParametersEntityArray.ParametersEntity> value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.ParametersEntityArray.ParametersEntity item in value)
                {
            ...
            /// </remarks>
            public static ParametersEntityArray From<T>(IEnumerable<T> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                ...
                return new ParametersEntityArray(builder.ToImmutable());
            }
            ...
            /// <param name = "items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static ParametersEntityArray FromRange(IEnumerable<JsonAny> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// <param name = "items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static ParametersEntityArray FromRange<T>(IEnumerable<T> items)
            ...
            /// <inheritdoc/>
            IEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.ParametersEntityArray.ParametersEntity> IEnumerable<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.ParametersEntityArray.ParametersEntity>.GetEnumerator()
            {
            ...
            public JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.ParametersEntityArray.ParametersEntity> EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.ParametersEntityArray.ParametersEntity>(this.jsonElementBacking);
                }

                if ((this.backing & Backing.Array) != 0)
                {
                    return new JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation.ParametersEntityArray.ParametersEntity>(this.arrayBacking);
                }
