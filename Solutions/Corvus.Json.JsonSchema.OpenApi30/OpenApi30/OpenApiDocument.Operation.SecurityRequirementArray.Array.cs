...
public readonly partial struct SecurityRequirementArray : IJsonArray<SecurityRequirementArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SecurityRequirement>
#else
        public readonly partial struct SecurityRequirementArray : IJsonArray<SecurityRequirementArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SecurityRequirement>
#endif
        {
            ...
            /// Gets an empty array.
            /// </summary>
            public static readonly SecurityRequirementArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
            /// <summary>
            ...
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public SecurityRequirementArray(IEnumerable<JsonAny> value)
            {
                this.jsonElementBacking = default;
                this.backing = Backing.Array;
            ...
            /// <inheritdoc/>
            JsonAny IJsonArray<SecurityRequirementArray>.this[int index]
            {
                get
                {
            ...
            public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SecurityRequirement this[int index]
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        return new Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SecurityRequirement(this.jsonElementBacking[index]);
                    }
            ...
            /// <returns>A SecurityRequirementArray instantiated from the given items.</returns>
            public static SecurityRequirementArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SecurityRequirement value1)
            {
            ...
            /// <returns>A SecurityRequirementArray instantiated from the given items.</returns>
            public static SecurityRequirementArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SecurityRequirement value1, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SecurityRequirement value2)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
            ...
            /// <returns>A SecurityRequirementArray instantiated from the given items.</returns>
            public static SecurityRequirementArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SecurityRequirement value1, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SecurityRequirement value2, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SecurityRequirement value3)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
                builder.Add(value2.AsAny);
            ...
            public static SecurityRequirementArray FromItems(params Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SecurityRequirement[] value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SecurityRequirement item in value)
                {
            ...
            /// <param name = "value">The value from which to construct the instance.</param>
            /// <returns>A JsonAny instantiated from the given items.</returns>
            public static SecurityRequirementArray FromRange(IEnumerable<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SecurityRequirement> value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SecurityRequirement item in value)
                {
            ...
            /// </remarks>
            public static SecurityRequirementArray From<T>(IEnumerable<T> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                ...
                return new SecurityRequirementArray(builder.ToImmutable());
            }
            ...
            /// <param name = "items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static SecurityRequirementArray FromRange(IEnumerable<JsonAny> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// <param name = "items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static SecurityRequirementArray FromRange<T>(IEnumerable<T> items)
            ...
            /// <inheritdoc/>
            IEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SecurityRequirement> IEnumerable<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SecurityRequirement>.GetEnumerator()
            {
            ...
            public JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SecurityRequirement> EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SecurityRequirement>(this.jsonElementBacking);
                }

                if ((this.backing & Backing.Array) != 0)
                {
                    return new JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SecurityRequirement>(this.arrayBacking);
                }
