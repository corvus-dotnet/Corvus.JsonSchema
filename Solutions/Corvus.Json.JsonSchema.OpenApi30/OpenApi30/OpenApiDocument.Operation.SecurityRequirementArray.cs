...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct Operation
    {
...

        {
            ...
            /// </summary>
            public static string SchemaLocation { get; } = "https://spec.openapis.org/oas/3.0/schema/2021-09-28#/definitions/Operation/properties/security";
            ...
            /// </summary>
            /// <param name="source">The source of the JSON string to parse.</param>
            public static SecurityRequirementArray ParseValue(string source)
            {
#if NET8_0_OR_GREATER
                return IJsonValue<SecurityRequirementArray>.ParseValue(source);
#else
                return JsonValueHelpers.ParseValue<SecurityRequirementArray>(source.AsSpan());
#endif
            }
            ...
            {
                return
                    (obj is IJsonValue jv && this.Equals(jv.As<SecurityRequirementArray>())) ||
            ...
            {
                return this.Equals(other.As<SecurityRequirementArray>());
            }
            ...
            public bool Equals(in SecurityRequirementArray other)
            {
                ...
                {
                    JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SecurityRequirement> lhs = this.EnumerateArray();
                    JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SecurityRequirement> rhs = other.EnumerateArray();
                    while (lhs.MoveNext())
                    {
                        if (!rhs.MoveNext())
                        {
