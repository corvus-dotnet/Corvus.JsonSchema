    ...
    public readonly partial struct ParameterLocation
    {
        public readonly partial struct OneOf3Entity
        {
            ...
            public readonly partial struct InEntity
            {
                ...
                public TOut Match<TIn, TOut>(in TIn context, Func<TIn, TOut> matchCookie, Func<TIn, TOut> defaultMatch)
                {
                ...
                /// <param name = "matchCookie">The function to call if the value matches the JSON value "\"cookie\"".</param>
                /// <param name = "defaultMatch">The fallback match.</param>
                public TOut Match<TOut>(Func<TOut> matchCookie, Func<TOut> defaultMatch)
                {
                    if (this.ValueKind == JsonValueKind.String)
                    {
                        if (this.HasJsonElementBacking)
                ...
                public static class EnumValues
                {
                    ...
                    /// Gets "cookie" as a JSON value.
                    /// </summary>
                    internal static readonly InEntity Item0 = InEntity.Parse("\"cookie\"");
                }
            }
        }
    }
