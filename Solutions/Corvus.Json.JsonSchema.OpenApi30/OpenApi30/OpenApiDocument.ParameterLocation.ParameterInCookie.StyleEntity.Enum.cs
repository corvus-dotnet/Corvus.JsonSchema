    ...
    public readonly partial struct ParameterLocation
    {
        public readonly partial struct ParameterInCookie
        {
            ...
            public readonly partial struct StyleEntity
            {
                ...
                public TOut Match<TIn, TOut>(in TIn context, Func<TIn, TOut> matchForm, Func<TIn, TOut> defaultMatch)
                {
                ...
                /// <param name = "matchForm">The function to call if the value matches the JSON value "\"form\"".</param>
                /// <param name = "defaultMatch">The fallback match.</param>
                public TOut Match<TOut>(Func<TOut> matchForm, Func<TOut> defaultMatch)
                {
                    if (this.ValueKind == JsonValueKind.String)
                    {
                        if (this.HasJsonElementBacking)
