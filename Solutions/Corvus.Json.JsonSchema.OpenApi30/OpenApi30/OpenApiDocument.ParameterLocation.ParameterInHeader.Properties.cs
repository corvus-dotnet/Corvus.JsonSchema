...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct ParameterLocation
    {
        ...
        public readonly partial struct ParameterInHeader
        {
            ...
            public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ParameterLocation.ParameterInHeader.InEntity In
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        ...
                        {
                            return new Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ParameterLocation.ParameterInHeader.InEntity(result);
                        }
                    }
            ...
            public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ParameterLocation.ParameterInHeader.StyleEntity Style
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        ...
                        {
                            return new Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ParameterLocation.ParameterInHeader.StyleEntity(result);
                        }
                    }
            ...
            /// </summary>
            public static ParameterInHeader Create(Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ParameterLocation.ParameterInHeader.InEntity? @in = null, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ParameterLocation.ParameterInHeader.StyleEntity? style = null)
            {
                var builder = ImmutableList.CreateBuilder<JsonObjectProperty>();
                if (@in is Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ParameterLocation.ParameterInHeader.InEntity @in__)
                {
                    builder.Add(JsonPropertyNames.In, @in__.AsAny);
                }

                if (style is Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ParameterLocation.ParameterInHeader.StyleEntity style__)
                {
            ...
            {
                return property.ValueAs<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ParameterLocation.ParameterInHeader.InEntity>().Validate(validationContext, level);
            }
            ...
            {
                return property.ValueAs<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ParameterLocation.ParameterInHeader.StyleEntity>().Validate(validationContext, level);
            }
