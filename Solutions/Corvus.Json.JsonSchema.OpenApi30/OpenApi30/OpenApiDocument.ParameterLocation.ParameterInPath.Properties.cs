...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct ParameterLocation
    {
        ...
        public readonly partial struct ParameterInPath
        {
            ...
            public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ParameterLocation.ParameterInPath.InEntity In
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        ...
                        {
                            return new Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ParameterLocation.ParameterInPath.InEntity(result);
                        }
                    }
            ...
            public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ParameterLocation.ParameterInPath.RequiredEntity Required
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        ...
                        {
                            return new Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ParameterLocation.ParameterInPath.RequiredEntity(result);
                        }
                    }
            ...
            public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ParameterLocation.ParameterInPath.StyleEntity Style
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        ...
                        {
                            return new Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ParameterLocation.ParameterInPath.StyleEntity(result);
                        }
                    }
            ...
            /// </summary>
            public static ParameterInPath Create(Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ParameterLocation.ParameterInPath.RequiredEntity required, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ParameterLocation.ParameterInPath.InEntity? @in = null, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ParameterLocation.ParameterInPath.StyleEntity? style = null)
            {
                var builder = ImmutableList.CreateBuilder<JsonObjectProperty>();
                builder.Add(JsonPropertyNames.Required, required.AsAny);
                if (@in is Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ParameterLocation.ParameterInPath.InEntity @in__)
                {
                    builder.Add(JsonPropertyNames.In, @in__.AsAny);
                }

                if (style is Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ParameterLocation.ParameterInPath.StyleEntity style__)
                {
            ...
            {
                return property.ValueAs<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ParameterLocation.ParameterInPath.RequiredEntity>().Validate(validationContext, level);
            }
            ...
            {
                return property.ValueAs<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ParameterLocation.ParameterInPath.InEntity>().Validate(validationContext, level);
            }
            ...
            {
                return property.ValueAs<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ParameterLocation.ParameterInPath.StyleEntity>().Validate(validationContext, level);
            }
