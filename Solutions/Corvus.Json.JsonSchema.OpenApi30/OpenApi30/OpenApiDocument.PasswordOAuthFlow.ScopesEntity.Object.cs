...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct PasswordOAuthFlow
    {
        ...
        /// </summary>
        public readonly partial struct ScopesEntity : IJsonObject<ScopesEntity>, IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonString>
        {
            /// <summary>
            ...
            /// <inheritdoc/>
            int IReadOnlyCollection<KeyValuePair<JsonPropertyName, Corvus.Json.JsonString>>.Count
            {
                get
                {
    ...
    static ScopesEntity IJsonObject<ScopesEntity>.FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
        return new(source.Select(s => new JsonObjectProperty(s.Name, s.Value)).ToImmutableList());
            ...
            /// <inheritdoc/>
            bool IJsonObject<ScopesEntity>.TryGetProperty(ReadOnlySpan<byte> utf8Name, out JsonAny value)
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <inheritdoc/>
            bool IJsonObject<ScopesEntity>.TryGetProperty<TValue>(ReadOnlySpan<byte> utf8Name, out TValue value)
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    if (this.jsonElementBacking.TryGetProperty(utf8Name, out JsonElement result))
            ...
            public bool TryGetProperty(in JsonPropertyName name, out Corvus.Json.JsonString value)
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
#if NET8_0_OR_GREATER
                value = Corvus.Json.JsonString.FromJson(result);
#else
                        value = JsonValueNetStandard20Extensions.FromJsonElement<Corvus.Json.JsonString>(result);
#endif
                        return true;
                    }
...
#else
                        value = result.As<Corvus.Json.JsonString>();
#endif
                        return true;
                    }
            ...
            /// <returns><c>True</c> if the property was present.</returns>
            /// <exception cref = "InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(ReadOnlySpan<byte> utf8Name, out Corvus.Json.JsonString value)
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    if (this.jsonElementBacking.TryGetProperty(utf8Name, out JsonElement result))
            ...
            public ScopesEntity SetProperty(in JsonPropertyName name, in Corvus.Json.JsonString value)
            {
                return new(this.GetPropertyBackingWith(name, value.AsAny));
            }
            ...
            /// <inheritdoc/>
            public ScopesEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
            {
                return new(this.GetPropertyBackingWithout(utf8Name));
            }

            /// <inheritdoc/>
            bool IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonString>.ContainsKey(JsonPropertyName key)
            {
                return this.HasProperty(key);
            }

            /// <inheritdoc/>
            bool IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonString>.TryGetValue(JsonPropertyName key, [MaybeNullWhen(false)] out Corvus.Json.JsonString value)
            {
