        ...
        public readonly partial struct ParametersEntityArray
        {
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
            {
                ...
                while (arrayEnumerator.MoveNext())
                {
                    ...
                    result = arrayEnumerator.Current.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.PathItem.ParametersEntityArray.ParametersEntity>().Validate(result, level);
