        ...
        public readonly partial struct ParametersEntityArray
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("https://spec.openapis.org/oas/3.0/schema/2021-09-28#/definitions/PathItem/properties/parameters");
                }
            ...
            public static partial class CorvusValidation
            {
                    ...
                    ValidationLevel level)
                {
                    ...
                    int length = 0;
                    using JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.PathItem.ParametersEntityArray.ParametersEntity> arrayEnumerator = value.EnumerateArray();
                    while (arrayEnumerator.MoveNext())
                    {
                        ...
                        using JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.PathItem.ParametersEntityArray.ParametersEntity> innerEnumerator = value.EnumerateArray();
                        int innerIndex = -1;
