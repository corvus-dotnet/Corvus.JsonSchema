    ...
    public readonly partial struct PathItem
    {
...

        {
            ...
            public bool Equals(in ParametersEntityArray other)
            {
                ...
                {
                    JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.PathItem.ParametersEntityArray.ParametersEntity> lhs = this.EnumerateArray();
                    JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.PathItem.ParametersEntityArray.ParametersEntity> rhs = other.EnumerateArray();
                    while (lhs.MoveNext())
                    {
                        if (!rhs.MoveNext())
                        {
