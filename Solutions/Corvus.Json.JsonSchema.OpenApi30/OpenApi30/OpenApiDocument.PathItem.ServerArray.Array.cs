...
public readonly partial struct ServerArray : IJsonArray<ServerArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Server>
#else
        public readonly partial struct ServerArray : IJsonArray<ServerArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Server>
#endif
        {
            ...
            /// Gets an empty array.
            /// </summary>
            public static readonly ServerArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
            /// <summary>
            /// Initializes a new instance of the <see cref = "ServerArray"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public ServerArray(ImmutableList<JsonAny> value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public ServerArray(IEnumerable<JsonAny> value)
            {
                this.jsonElementBacking = default;
                this.backing = Backing.Array;
            ...
            /// <inheritdoc/>
            JsonAny IJsonArray<ServerArray>.this[int index]
            {
                get
                {
            ...
            public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Server this[int index]
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        return new Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Server(this.jsonElementBacking[index]);
                    }
            ...
            /// <returns>A ServerArray instantiated from the given items.</returns>
            public static ServerArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Server value1)
            {
            ...
            /// <returns>A ServerArray instantiated from the given items.</returns>
            public static ServerArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Server value1, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Server value2)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
            ...
            /// <returns>A ServerArray instantiated from the given items.</returns>
            public static ServerArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Server value1, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Server value2, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Server value3)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
                builder.Add(value2.AsAny);
            ...
            public static ServerArray FromItems(params Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Server[] value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Server item in value)
                {
            ...
            /// <param name = "value">The value from which to construct the instance.</param>
            /// <returns>A JsonAny instantiated from the given items.</returns>
            public static ServerArray FromRange(IEnumerable<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Server> value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Server item in value)
                {
            ...
            /// </remarks>
            public static ServerArray From<T>(IEnumerable<T> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                ...
                return new ServerArray(builder.ToImmutable());
            }
            ...
            /// <param name = "items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static ServerArray FromRange(IEnumerable<JsonAny> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// <param name = "items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static ServerArray FromRange<T>(IEnumerable<T> items)
            ...
            /// <inheritdoc/>
            IEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Server> IEnumerable<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Server>.GetEnumerator()
            {
            ...
            public JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Server> EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Server>(this.jsonElementBacking);
                }

                if ((this.backing & Backing.Array) != 0)
                {
                    return new JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Server>(this.arrayBacking);
                }
