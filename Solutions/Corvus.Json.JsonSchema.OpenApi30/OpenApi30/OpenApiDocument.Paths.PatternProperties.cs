...
public readonly partial struct OpenApiDocument
{
    ...
    {
        /// <summary>
        /// A pattern property matching ^\\/ producing a <see cref = "Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.PathItem"/>.
        /// </summary>
        ...
        /// <summary>
        /// Determines if a property matches ^\\/ producing a <see cref = "Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.PathItem"/>.
        /// </summary>
        ...
        /// <summary>
        /// Get a property value as the type matching the given pattern property ^\\/ as a <see cref = "Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.PathItem"/>.
        /// </summary>
        public bool TryAsPatternPathItem(in JsonObjectProperty property, out Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.PathItem result)
        {
            if (property.Name.IsMatch(PatternPropertyPathItem))
            {
                result = property.ValueAs<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.PathItem>();
                return true;
            }
            else
            {
        ...
        /// <summary>
        /// Try to get a property value as the type matching the given pattern property ^\\/ as a <see cref = "Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.PathItem"/>.
        /// </summary>
        public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.PathItem AsPatternPathItem(in JsonObjectProperty property)
        {
            return property.ValueAs<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.PathItem>();
        }
        ...
        {
            return that.ValueAs<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.PathItem>().Validate(validationContext, level);
        }
