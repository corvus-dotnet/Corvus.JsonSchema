...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct Paths
    {
        ...
        public static implicit operator Paths(in JsonAny value)
        {
    ...
    static Paths IJsonValue<Paths>.FromArray<TValue>(in TValue value)
    {
        ...
        static Paths ParseValue(ReadOnlySpan<char> buffer)
        {
#if NET8_0_OR_GREATER
        return IJsonValue<Paths>.ParseValue(buffer);
#else
            return JsonValueHelpers.ParseValue<Paths>(buffer);
#endif
        }
        ...
        /// <param name = "buffer">The buffer from which to parse the value.</param>
        /// <returns>The parsed value.</returns>
        static Paths ParseValue(ReadOnlySpan<byte> buffer)
        {
#if NET8_0_OR_GREATER
        return IJsonValue<Paths>.ParseValue(buffer);
#else
        ...
        /// <returns>The parsed value.</returns>
        static Paths ParseValue(ref Utf8JsonReader reader)
        {
#if NET8_0_OR_GREATER
        return IJsonValue<Paths>.ParseValue(ref reader);
#else
            return JsonValueHelpers.ParseValue<Paths>(ref reader);
#endif
        }
