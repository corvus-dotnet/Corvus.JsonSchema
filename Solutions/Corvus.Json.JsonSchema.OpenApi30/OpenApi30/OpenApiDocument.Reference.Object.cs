...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct Reference
        : IJsonObject<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Reference>
    {
        /// <summary>
        /// The pattern matching '^\$ref$'
        /// for the pattern property producing the type
        /// <see cref="Corvus.Json.JsonUriReference"/>.
        /// </summary>
        public static Regex PatternPropertyJsonUriReference => CorvusValidation.PatternProperties;
        ...
        /// <see cref="Corvus.Json.JsonUriReference"/>.
        /// </summary>
        public static bool MatchesPatternJsonUriReference(in JsonObjectProperty property) => property.Name.IsMatch(CorvusValidation.PatternProperties);
        ...
        /// </summary>
        public static bool TryAsPatternJsonUriReference(in JsonObjectProperty property, out Corvus.Json.JsonUriReference result)
        {
            if (property.Name.IsMatch(CorvusValidation.PatternProperties))
            {
                result = property.Value.As<Corvus.Json.JsonUriReference>();
