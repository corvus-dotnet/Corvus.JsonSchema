...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct RequestBody
    {
        ...
        /// </summary>
        public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.RequestBody.ContentEntity Content
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
                        return new Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.RequestBody.ContentEntity(result);
                    }
                }
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.RequestBody.ContentEntity>();
                    }
                }
        ...
        /// </summary>
        public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.RequestBody.RequiredEntity Required
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
                        return new Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.RequestBody.RequiredEntity(result);
                    }
                }
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.RequestBody.RequiredEntity>();
                    }
                }
        ...
        /// </summary>
        public static RequestBody Create(Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.RequestBody.ContentEntity content, Corvus.Json.JsonString? description = null, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.RequestBody.RequiredEntity? required = null)
        {
            ...
            if (required is Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.RequestBody.RequiredEntity required__)
            {
        ...
        public RequestBody WithContent(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.RequestBody.ContentEntity value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public RequestBody WithRequired(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.RequestBody.RequiredEntity value)
        {
        ...
        {
            return property.ValueAs<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.RequestBody.ContentEntity>().Validate(validationContext, level);
        }
        ...
        {
            return property.ValueAs<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.RequestBody.RequiredEntity>().Validate(validationContext, level);
        }
