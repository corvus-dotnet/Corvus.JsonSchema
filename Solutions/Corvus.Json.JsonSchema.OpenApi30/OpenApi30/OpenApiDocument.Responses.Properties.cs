...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct Responses
    {
        ...
        public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Responses.DefaultEntity Default
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
                        return new Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Responses.DefaultEntity(result);
                    }
                }
        ...
        /// </summary>
        public static Responses Create(Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Responses.DefaultEntity? @default = null)
        {
            var builder = ImmutableList.CreateBuilder<JsonObjectProperty>();
            if (@default is Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Responses.DefaultEntity @default__)
            {
        ...
        public Responses WithDefault(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Responses.DefaultEntity value)
        {
        ...
        {
            return property.ValueAs<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Responses.DefaultEntity>().Validate(validationContext, level);
        }
