...
public readonly partial struct AllOfEntityArray : IJsonArray<AllOfEntityArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.AllOfEntityArray.AllOfEntity>
#else
        public readonly partial struct AllOfEntityArray : IJsonArray<AllOfEntityArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.AllOfEntityArray.AllOfEntity>
#endif
        {
            ...
            public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.AllOfEntityArray.AllOfEntity this[int index]
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        return new Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.AllOfEntityArray.AllOfEntity(this.jsonElementBacking[index]);
                    }
            ...
            public static AllOfEntityArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.AllOfEntityArray.AllOfEntity value1)
            {
            ...
            /// <returns>A AllOfEntityArray instantiated from the given items.</returns>
            public static AllOfEntityArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.AllOfEntityArray.AllOfEntity value1, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.AllOfEntityArray.AllOfEntity value2)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
            ...
            /// <returns>A AllOfEntityArray instantiated from the given items.</returns>
            public static AllOfEntityArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.AllOfEntityArray.AllOfEntity value1, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.AllOfEntityArray.AllOfEntity value2, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.AllOfEntityArray.AllOfEntity value3)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
                builder.Add(value2.AsAny);
            ...
            public static AllOfEntityArray FromItems(params Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.AllOfEntityArray.AllOfEntity[] value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.AllOfEntityArray.AllOfEntity item in value)
                {
            ...
            /// <param name = "value">The value from which to construct the instance.</param>
            /// <returns>A JsonAny instantiated from the given items.</returns>
            public static AllOfEntityArray FromRange(IEnumerable<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.AllOfEntityArray.AllOfEntity> value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.AllOfEntityArray.AllOfEntity item in value)
                {
            ...
            /// <inheritdoc/>
            IEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.AllOfEntityArray.AllOfEntity> IEnumerable<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.AllOfEntityArray.AllOfEntity>.GetEnumerator()
            {
            ...
            public JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.AllOfEntityArray.AllOfEntity> EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.AllOfEntityArray.AllOfEntity>(this.jsonElementBacking);
                }

                if ((this.backing & Backing.Array) != 0)
                {
                    return new JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.AllOfEntityArray.AllOfEntity>(this.arrayBacking);
                }
