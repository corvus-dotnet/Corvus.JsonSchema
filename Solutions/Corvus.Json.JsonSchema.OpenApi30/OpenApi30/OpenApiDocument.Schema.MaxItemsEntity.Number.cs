...
: IJsonNumber<MaxItemsEntity>,
  IAdditionOperators<MaxItemsEntity, MaxItemsEntity, MaxItemsEntity>,
  ISubtractionOperators<MaxItemsEntity, MaxItemsEntity, MaxItemsEntity>,
  IMultiplyOperators<MaxItemsEntity, MaxItemsEntity, MaxItemsEntity>,
  IDivisionOperators<MaxItemsEntity, MaxItemsEntity, MaxItemsEntity>,
  IIncrementOperators<MaxItemsEntity>,
  IDecrementOperators<MaxItemsEntity>
#else
        : IJsonNumber<MaxItemsEntity>
#endif
        {
            ...
            public MaxItemsEntity(in BinaryJsonNumber value)
            {
            ...
            public MaxItemsEntity(long value) : this(new BinaryJsonNumber(value))
            {
            }
            ...
            public static explicit operator long (MaxItemsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
    ...
    public static explicit operator MaxItemsEntity(Half value)
    {
        return new(new BinaryJsonNumber(value));
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator MaxItemsEntity(long value)
            {
                return new(new BinaryJsonNumber(value));
            }
