...
: IJsonNumber<MaxPropertiesEntity>,
  IAdditionOperators<MaxPropertiesEntity, MaxPropertiesEntity, MaxPropertiesEntity>,
  ISubtractionOperators<MaxPropertiesEntity, MaxPropertiesEntity, MaxPropertiesEntity>,
  IMultiplyOperators<MaxPropertiesEntity, MaxPropertiesEntity, MaxPropertiesEntity>,
  IDivisionOperators<MaxPropertiesEntity, MaxPropertiesEntity, MaxPropertiesEntity>,
  IIncrementOperators<MaxPropertiesEntity>,
  IDecrementOperators<MaxPropertiesEntity>
#else
        : IJsonNumber<MaxPropertiesEntity>
#endif
        {
            ...
            public MaxPropertiesEntity(in BinaryJsonNumber value)
            {
            ...
            public MaxPropertiesEntity(long value) : this(new BinaryJsonNumber(value))
            {
            }
            ...
            public static explicit operator long (MaxPropertiesEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
    ...
    public static explicit operator MaxPropertiesEntity(Half value)
    {
        return new(new BinaryJsonNumber(value));
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator MaxPropertiesEntity(long value)
            {
                return new(new BinaryJsonNumber(value));
            }
