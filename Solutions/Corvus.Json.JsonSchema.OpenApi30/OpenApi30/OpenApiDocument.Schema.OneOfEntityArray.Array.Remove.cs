...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct Schema
    {
        ...
        public readonly partial struct OneOfEntityArray
        {
            ...
            OneOfEntityArray IJsonArray<OneOfEntityArray>.Remove(in JsonAny item1)
            {
            ...
            public OneOfEntityArray Remove(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.OneOfEntityArray.OneOfEntity item)
            {
            ...
            /// <inheritdoc/>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public OneOfEntityArray RemoveAt(int index)
            {
            ...
            /// <inheritdoc/>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public OneOfEntityArray RemoveRange(int index, int count)
            {
