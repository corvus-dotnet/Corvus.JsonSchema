...
public readonly partial struct OneOfEntityArray : IJsonArray<OneOfEntityArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.OneOfEntityArray.OneOfEntity>
#else
        public readonly partial struct OneOfEntityArray : IJsonArray<OneOfEntityArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.OneOfEntityArray.OneOfEntity>
#endif
        {
            ...
            /// Gets an empty array.
            /// </summary>
            public static readonly OneOfEntityArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
            /// <summary>
            /// Initializes a new instance of the <see cref = "OneOfEntityArray"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public OneOfEntityArray(ImmutableList<JsonAny> value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public OneOfEntityArray(IEnumerable<JsonAny> value)
            {
                this.jsonElementBacking = default;
                this.backing = Backing.Array;
            ...
            /// <inheritdoc/>
            JsonAny IJsonArray<OneOfEntityArray>.this[int index]
            {
                get
                {
            ...
            public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.OneOfEntityArray.OneOfEntity this[int index]
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        return new Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.OneOfEntityArray.OneOfEntity(this.jsonElementBacking[index]);
                    }
            ...
            /// <returns>A OneOfEntityArray instantiated from the given items.</returns>
            public static OneOfEntityArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.OneOfEntityArray.OneOfEntity value1)
            {
            ...
            /// <returns>A OneOfEntityArray instantiated from the given items.</returns>
            public static OneOfEntityArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.OneOfEntityArray.OneOfEntity value1, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.OneOfEntityArray.OneOfEntity value2)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
            ...
            /// <returns>A OneOfEntityArray instantiated from the given items.</returns>
            public static OneOfEntityArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.OneOfEntityArray.OneOfEntity value1, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.OneOfEntityArray.OneOfEntity value2, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.OneOfEntityArray.OneOfEntity value3)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
                builder.Add(value2.AsAny);
            ...
            public static OneOfEntityArray FromItems(params Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.OneOfEntityArray.OneOfEntity[] value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.OneOfEntityArray.OneOfEntity item in value)
                {
            ...
            /// <param name = "value">The value from which to construct the instance.</param>
            /// <returns>A JsonAny instantiated from the given items.</returns>
            public static OneOfEntityArray FromRange(IEnumerable<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.OneOfEntityArray.OneOfEntity> value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.OneOfEntityArray.OneOfEntity item in value)
                {
            ...
            /// </remarks>
            public static OneOfEntityArray From<T>(IEnumerable<T> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                ...
                return new OneOfEntityArray(builder.ToImmutable());
            }
            ...
            /// <param name = "items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static OneOfEntityArray FromRange(IEnumerable<JsonAny> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// <param name = "items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static OneOfEntityArray FromRange<T>(IEnumerable<T> items)
            ...
            /// <inheritdoc/>
            IEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.OneOfEntityArray.OneOfEntity> IEnumerable<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.OneOfEntityArray.OneOfEntity>.GetEnumerator()
            {
            ...
            public JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.OneOfEntityArray.OneOfEntity> EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.OneOfEntityArray.OneOfEntity>(this.jsonElementBacking);
                }

                if ((this.backing & Backing.Array) != 0)
                {
                    return new JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.OneOfEntityArray.OneOfEntity>(this.arrayBacking);
                }
