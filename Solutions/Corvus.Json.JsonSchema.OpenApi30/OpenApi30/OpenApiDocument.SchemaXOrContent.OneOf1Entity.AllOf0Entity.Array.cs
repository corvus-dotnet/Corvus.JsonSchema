...
[CollectionBuilder(typeof(AllOf0Entity), "Create")]
public readonly partial struct AllOf0Entity : IJsonArray<AllOf0Entity>, IReadOnlyCollection<JsonAny>
#else
            public readonly partial struct AllOf0Entity : IJsonArray<AllOf0Entity>, IReadOnlyCollection<JsonAny>
#endif
            {
                ...
                /// Gets an empty array.
                /// </summary>
                public static readonly AllOf0Entity EmptyArray = From(ImmutableList<JsonAny>.Empty);
                /// <summary>
                ...
                /// </summary>
                /// <param name = "value">The value from which to construct the instance.</param>
                public AllOf0Entity(IEnumerable<JsonAny> value)
                {
                    this.jsonElementBacking = default;
                    this.backing = Backing.Array;
                    this.stringBacking = string.Empty;
                ...
                public static AllOf0Entity From(ImmutableList<JsonAny> items)
                {
                    return new(items);
                }
                ...
                public static AllOf0Entity Create(ReadOnlySpan<JsonAny> items)
                {
                    return new([..items]);
                }
                ...
                public static AllOf0Entity FromItems(params JsonAny[] value)
                {
                ...
                /// <param name = "value">The value from which to construct the instance.</param>
                /// <returns>A AllOf0Entity instantiated from the given items.</returns>
                public static AllOf0Entity FromItems<TItem>(params TItem[] value)
                ...
                /// <returns>A AllOf0Entity instantiated from the given items.</returns>
                public static AllOf0Entity FromItems<TItem1>(in TItem1 value1)
                ...
                /// <returns>A AllOf0Entity instantiated from the given items.</returns>
                public static AllOf0Entity FromItems<TItem1, TItem2>(in TItem1 value1, in TItem2 value2)
                ...
                /// <returns>A AllOf0Entity instantiated from the given items.</returns>
                public static AllOf0Entity FromItems<TItem1, TItem2, TItem3>(in TItem1 value1, in TItem2 value2, in TItem3 value3)
                ...
                /// </remarks>
                public static AllOf0Entity From<T>(IEnumerable<T> items)
                {
                    ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                    ...
                    return new AllOf0Entity(builder.ToImmutable());
                }
                ...
                /// other overloads which avoid this serialization step.
                /// </remarks>
                public static AllOf0Entity FromRange(IEnumerable<JsonAny> items)
                {
                    ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                ...
                /// other overloads which avoid this serialization step.
                /// </remarks>
                public static AllOf0Entity FromRange<T>(IEnumerable<T> items)
                ...
                /// <param name = "items">The items from which to create the array.</param>
                /// <returns>The new array created from the items.</returns>
                public static AllOf0Entity FromRange(IEnumerable<string> items)
                {
                    ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                ...
                /// <param name = "items">The items from which to create the array.</param>
                /// <returns>The new array created from the items.</returns>
                public static AllOf0Entity FromRange(IEnumerable<double> items)
                {
                    ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                ...
                /// <param name = "items">The items from which to create the array.</param>
                /// <returns>The new array created from the items.</returns>
                public static AllOf0Entity FromRange(IEnumerable<float> items)
                {
                    ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                ...
                /// <param name = "items">The items from which to create the array.</param>
                /// <returns>The new array created from the items.</returns>
                public static AllOf0Entity FromRange(IEnumerable<int> items)
                {
                    ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                ...
                /// <param name = "items">The items from which to create the array.</param>
                /// <returns>The new array created from the items.</returns>
                public static AllOf0Entity FromRange(IEnumerable<long> items)
                {
                    ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                ...
                /// <param name = "items">The items from which to create the array.</param>
                /// <returns>The new array created from the items.</returns>
                public static AllOf0Entity FromRange(IEnumerable<bool> items)
                {
                    ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                ...
                /// <param name = "value1">The first value from which to construct the instance.</param>
                /// <returns>A AllOf0Entity instantiated from the given items.</returns>
                public static AllOf0Entity FromItems(in JsonAny value1)
                {
                    ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                    builder.Add(value1);
                    return new(builder.ToImmutable());
                ...
                /// <param name = "value2">The second value from which to construct the instance.</param>
                /// <returns>A AllOf0Entity instantiated from the given items.</returns>
                public static AllOf0Entity FromItems(in JsonAny value1, in JsonAny value2)
                {
                    ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                    builder.Add(value1);
                    builder.Add(value2);
                ...
                /// <param name = "value3">The thirdvalue from which to construct the instance.</param>
                /// <returns>A AllOf0Entity instantiated from the given items.</returns>
                public static AllOf0Entity FromItems(in JsonAny value1, in JsonAny value2, in JsonAny value3)
                {
                    ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                    builder.Add(value1);
                    builder.Add(value2);
