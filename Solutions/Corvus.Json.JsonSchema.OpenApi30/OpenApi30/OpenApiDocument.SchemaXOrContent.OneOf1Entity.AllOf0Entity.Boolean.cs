...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct SchemaXOrContent
    {
        public readonly partial struct OneOf1Entity
        {
            ...
            /// </summary>
            public readonly partial struct AllOf0Entity : IJsonBoolean<AllOf0Entity>
            {
                /// <summary>
                /// Initializes a new instance of the <see cref = "AllOf0Entity"/> struct.
                /// </summary>
                /// <param name = "value">The value from which to construct the instance.</param>
                public AllOf0Entity(bool value)
                {
                ...
                public static implicit operator AllOf0Entity(JsonBoolean value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator AllOf0Entity(bool value)
                {
                    return new(value);
                }
                ...
                public static implicit operator bool (AllOf0Entity value)
                {
