...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct SchemaXOrContent
    {
        public readonly partial struct OneOf1Entity
        {
            ...
            /// </summary>
            public readonly partial struct AllOf3Entity : IJsonBoolean<AllOf3Entity>
            {
                /// <summary>
                ...
                public static implicit operator AllOf3Entity(JsonBoolean value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static implicit operator AllOf3Entity(bool value)
                {
                    return new(value);
                }
                ...
                public static implicit operator bool (AllOf3Entity value)
                {
