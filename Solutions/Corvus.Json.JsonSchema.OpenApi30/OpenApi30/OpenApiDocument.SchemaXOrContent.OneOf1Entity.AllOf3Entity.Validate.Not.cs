        ...
        public readonly partial struct OneOf1Entity
        {
            ...
            public readonly partial struct AllOf3Entity
            {
                private ValidationContext ValidateNot(ValidationContext validationContext, ValidationLevel level)
                {
                    ...
                    ValidationContext notResult = this.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SchemaXOrContent.OneOf1Entity.AllOf3Entity.NotEntity>().Validate(validationContext.CreateChildContext(), level);
