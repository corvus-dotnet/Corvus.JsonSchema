...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct SchemaXOrContent
    {
        public readonly partial struct OneOf1Entity
        {
            ...
            {
                /// <inheritdoc/>
                public AllOf4Entity Add(in JsonAny item1)
                {
                ...
                /// <inheritdoc/>
                public AllOf4Entity Add(params JsonAny[] items)
                {
                    ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
                ...
                /// <inheritdoc/>
                public AllOf4Entity AddRange<TArray>(in TArray items)
                ...
                /// <inheritdoc/>
                public AllOf4Entity AddRange<TItem>(IEnumerable<TItem> items)
                ...
                /// <inheritdoc/>
                public AllOf4Entity AddRange(IEnumerable<JsonAny> items)
                {
                    ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
                    builder.AddRange(items);
                    return new(builder.ToImmutable());
                ...
                /// <inheritdoc/>
                public AllOf4Entity Insert(int index, in JsonAny item1)
                {
                    return new(this.GetImmutableListWith(index, item1));
                }

                /// <inheritdoc/>
                public AllOf4Entity InsertRange<TArray>(int index, in TArray items)
                    where TArray : struct, IJsonArray<TArray>
                {
                ...
                /// <inheritdoc/>
                public AllOf4Entity InsertRange<TItem>(int index, IEnumerable<TItem> items)
                    where TItem : struct, IJsonValue<TItem>
                {
                ...
                /// <inheritdoc/>
                public AllOf4Entity InsertRange(int index, IEnumerable<JsonAny> items)
                {
                    return new(this.GetImmutableListWith(index, items));
                }

                /// <inheritdoc/>
                public AllOf4Entity Replace(in JsonAny oldValue, in JsonAny newValue)
                {
                    return new(this.GetImmutableListReplacing(oldValue.AsAny, newValue.AsAny));
                }

                /// <inheritdoc/>
                public AllOf4Entity SetItem(int index, in JsonAny value)
                {
