    ...
    public readonly partial struct SchemaXOrContent
    {
        ...
        public readonly partial struct OneOf1Entity
        {
            private ValidationContext ValidateAllOf(in ValidationContext validationContext, ValidationLevel level)
            {
                ...
                ValidationContext allOfResult0 = this.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SchemaXOrContent.OneOf1Entity.AllOf0Entity>().Validate(childContext0.CreateChildContext(), level);
                ...
                ValidationContext allOfResult1 = this.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SchemaXOrContent.OneOf1Entity.AllOf1Entity>().Validate(childContext1.CreateChildContext(), level);
                ...
                ValidationContext allOfResult2 = this.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SchemaXOrContent.OneOf1Entity.AllOf2Entity>().Validate(childContext2.CreateChildContext(), level);
                ...
                ValidationContext allOfResult3 = this.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SchemaXOrContent.OneOf1Entity.AllOf3Entity>().Validate(childContext3.CreateChildContext(), level);
                ...
                ValidationContext allOfResult4 = this.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SchemaXOrContent.OneOf1Entity.AllOf4Entity>().Validate(childContext4.CreateChildContext(), level);
