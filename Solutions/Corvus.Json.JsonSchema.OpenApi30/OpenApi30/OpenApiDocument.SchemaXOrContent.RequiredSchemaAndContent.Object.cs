...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct SchemaXOrContent
    {
        ...
        /// </summary>
        public readonly partial struct RequiredSchemaAndContent : IJsonObject<RequiredSchemaAndContent>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "RequiredSchemaAndContent"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public RequiredSchemaAndContent(ImmutableList<JsonObjectProperty> value)
            {
            ...
            public static implicit operator RequiredSchemaAndContent(JsonObject value)
            {
            ...
            public static RequiredSchemaAndContent FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
            {
            ...
            /// <param name = "source">The dictionary of properties.</param>
            /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
            public static RequiredSchemaAndContent FromProperties(ImmutableList<JsonObjectProperty> source)
            {
                return new(source);
            }
            ...
            /// <param name = "source">The dictionary of properties.</param>
            /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
            public static RequiredSchemaAndContent FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
            {
            ...
            /// <inheritdoc/>
            public RequiredSchemaAndContent SetProperty<TValue>(in JsonPropertyName name, TValue value)
            ...
            /// <inheritdoc/>
            public RequiredSchemaAndContent RemoveProperty(in JsonPropertyName name)
            {
                return new(this.GetPropertyBackingWithout(name));
            }

            /// <inheritdoc/>
            public RequiredSchemaAndContent RemoveProperty(string name)
            {
                return new(this.GetPropertyBackingWithout(name));
            }

            /// <inheritdoc/>
            public RequiredSchemaAndContent RemoveProperty(ReadOnlySpan<char> name)
            {
                return new(this.GetPropertyBackingWithout(name));
            }

            /// <inheritdoc/>
            public RequiredSchemaAndContent RemoveProperty(ReadOnlySpan<byte> utf8Name)
            {
