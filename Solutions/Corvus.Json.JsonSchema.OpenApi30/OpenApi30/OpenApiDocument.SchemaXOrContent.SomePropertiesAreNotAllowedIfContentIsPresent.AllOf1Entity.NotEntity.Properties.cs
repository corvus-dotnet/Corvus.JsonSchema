        ...
        public readonly partial struct SomePropertiesAreNotAllowedIfContentIsPresent
        {
            public readonly partial struct AllOf1Entity
            {
                ...
                public readonly partial struct NotEntity
                {
                    ...
                    /// <summary>
                    /// Gets the <c>explode</c> property. If the instance is valid, this property will be not be <c>undefined</c>.
                    /// </summary>
                    public Corvus.Json.JsonAny Explode
                    {
                        get
                        {
                    ...
                    /// </summary>
                    public static NotEntity Create(Corvus.Json.JsonAny explode)
                    {
                        var builder = ImmutableList.CreateBuilder<JsonObjectProperty>();
                        builder.Add(JsonPropertyNames.Explode, explode.AsAny);
                    ...
                    public NotEntity WithExplode(in Corvus.Json.JsonAny value)
                    {
