...
: IJsonNumber<AllOf3Entity>,
  IAdditionOperators<AllOf3Entity, AllOf3Entity, AllOf3Entity>,
  ISubtractionOperators<AllOf3Entity, AllOf3Entity, AllOf3Entity>,
  IMultiplyOperators<AllOf3Entity, AllOf3Entity, AllOf3Entity>,
  IDivisionOperators<AllOf3Entity, AllOf3Entity, AllOf3Entity>,
  IIncrementOperators<AllOf3Entity>,
  IDecrementOperators<AllOf3Entity>
#else
            : IJsonNumber<AllOf3Entity>
#endif
            {
                ...
                public AllOf3Entity(in BinaryJsonNumber value)
                {
                ...
                public AllOf3Entity(double value) : this(new BinaryJsonNumber(value))
                {
                }
                ...
                public static implicit operator AllOf3Entity(JsonNumber value)
                {
                ...
                public static explicit operator byte (AllOf3Entity value)
                {
                ...
                public static explicit operator decimal (AllOf3Entity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator double (AllOf3Entity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator short (AllOf3Entity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator int (AllOf3Entity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator long (AllOf3Entity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an Int64.</exception>
    public static explicit operator Int128(AllOf3Entity value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        throw new InvalidOperationException();
                ...
                public static explicit operator sbyte (AllOf3Entity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
    ...
    public static explicit operator Half(AllOf3Entity value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        throw new InvalidOperationException();
                ...
                /// <exception cref = "InvalidOperationException">The value was not a number.</exception>
                /// <exception cref = "FormatException">The value was not formatted as a Single.</exception>
                public static explicit operator float (AllOf3Entity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator ushort (AllOf3Entity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator uint (AllOf3Entity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator ulong (AllOf3Entity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an UInt64.</exception>
    public static explicit operator UInt128(AllOf3Entity value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        throw new InvalidOperationException();
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator AllOf3Entity(decimal value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator AllOf3Entity(double value)
                {
                    return new(new BinaryJsonNumber(value));
                }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator AllOf3Entity(Half value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator AllOf3Entity(float value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator AllOf3Entity(byte value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator AllOf3Entity(short value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator AllOf3Entity(int value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator AllOf3Entity(long value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator AllOf3Entity(sbyte value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator AllOf3Entity(ushort value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator AllOf3Entity(uint value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator AllOf3Entity(ulong value)
                {
                    return new(new BinaryJsonNumber(value));
                }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator AllOf3Entity(Int128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator AllOf3Entity(UInt128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
                ...
                public static AllOf3Entity operator +(AllOf3Entity left, AllOf3Entity right)
                {
                ...
                /// <returns>The resulting value.</returns>
                public static AllOf3Entity operator ++(AllOf3Entity value)
                {
                ...
                public static int Compare(in AllOf3Entity lhs, in AllOf3Entity rhs)
                {
