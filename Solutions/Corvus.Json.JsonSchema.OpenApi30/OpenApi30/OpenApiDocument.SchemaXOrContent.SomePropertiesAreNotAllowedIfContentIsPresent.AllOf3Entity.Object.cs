...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct SchemaXOrContent
    {
        public readonly partial struct SomePropertiesAreNotAllowedIfContentIsPresent
        {
            ...
            /// </summary>
            public readonly partial struct AllOf3Entity : IJsonObject<AllOf3Entity>
            {
                /// <summary>
                ...
                public static implicit operator AllOf3Entity(JsonObject value)
                {
                ...
                public static AllOf3Entity FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
                {
                ...
                /// <param name = "source">The dictionary of properties.</param>
                /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
                public static AllOf3Entity FromProperties(ImmutableList<JsonObjectProperty> source)
                {
                    return new(source);
                }
                ...
                /// <param name = "source">The dictionary of properties.</param>
                /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
                public static AllOf3Entity FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
                {
                ...
                /// <inheritdoc/>
                public AllOf3Entity SetProperty<TValue>(in JsonPropertyName name, TValue value)
                ...
                /// <inheritdoc/>
                public AllOf3Entity RemoveProperty(in JsonPropertyName name)
                {
                    return new(this.GetPropertyBackingWithout(name));
                }

                /// <inheritdoc/>
                public AllOf3Entity RemoveProperty(string name)
                {
                    return new(this.GetPropertyBackingWithout(name));
                }

                /// <inheritdoc/>
                public AllOf3Entity RemoveProperty(ReadOnlySpan<char> name)
                {
                    return new(this.GetPropertyBackingWithout(name));
                }

                /// <inheritdoc/>
                public AllOf3Entity RemoveProperty(ReadOnlySpan<byte> utf8Name)
                {
