        ...
        public readonly partial struct SomePropertiesAreNotAllowedIfContentIsPresent
        {
            public readonly partial struct AllOf4Entity
            {
                ...
                public readonly partial struct NotEntity
                {
                    ...
                    /// </summary>
                    public static NotEntity Create(Corvus.Json.JsonAny examples)
                    {
                    ...
                    public NotEntity WithExamples(in Corvus.Json.JsonAny value)
                    {
                    ...
                    private bool __TryGetCorvusLocalPropertiesValidator(in JsonObjectProperty property, bool hasJsonElementBacking, [NotNullWhen(true)] out ObjectPropertyValidator? propertyValidator)
                    {
                        ...
                        {
                            if (property.NameEquals(JsonPropertyNames.ExamplesUtf8))
                            {
                        ...
                        {
                            if (property.NameEquals(JsonPropertyNames.Examples))
                            {
                                propertyValidator = __CorvusValidateExamples;
                                return true;
                            }
