        ...
        public readonly partial struct SomePropertiesAreNotAllowedIfContentIsPresent
        {
            ...
            public readonly partial struct AllOf4Entity
            {
                private ValidationContext ValidateNot(ValidationContext validationContext, ValidationLevel level)
                {
                    ...
                    ValidationContext notResult = this.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SchemaXOrContent.SomePropertiesAreNotAllowedIfContentIsPresent.AllOf4Entity.RequiredExamples>().Validate(validationContext.CreateChildContext(), level);
