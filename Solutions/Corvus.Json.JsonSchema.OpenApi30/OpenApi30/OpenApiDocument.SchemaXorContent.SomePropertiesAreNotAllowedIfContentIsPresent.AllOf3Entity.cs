...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct SchemaXorContent
    {
        public readonly partial struct SomePropertiesAreNotAllowedIfContentIsPresent
        {
            ...
            public readonly partial struct AllOf3Entity
            {
                ...
                public static implicit operator AllOf3Entity(in JsonAny value)
                {
                ...
                /// <param name = "value">The value from which to convert.</param>
                /// <exception cref = "InvalidOperationException">The value was not compatible with this type.</exception>
                public static implicit operator JsonAny(in AllOf3Entity value)
                {
                    return value.AsAny;
                }
    ...
    /// <remarks>This will be AllOf3Entity.Undefined if the type is not compatible.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static AllOf3Entity IJsonValue<AllOf3Entity>.FromBoolean<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>This will be AllOf3Entity.Undefined if the type is not compatible.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static AllOf3Entity IJsonValue<AllOf3Entity>.FromString<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>This will be AllOf3Entity.Undefined if the type is not compatible.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static AllOf3Entity IJsonValue<AllOf3Entity>.FromNumber<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>This will be AllOf3Entity.Undefined if the type is not compatible.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static AllOf3Entity IJsonValue<AllOf3Entity>.FromArray<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>This will be AllOf3Entity.Undefined if the type is not compatible.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static AllOf3Entity IJsonValue<AllOf3Entity>.FromObject<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
        ...
        return Undefined;
...
#endif
                /// <summary>
                /// Parses a JSON string into a AllOf3Entity.
                /// </summary>
                /// <param name = "json">The json string to parse.</param>
                /// <param name = "options">The (optional) JsonDocumentOptions.</param>
                /// <returns>A <see cref = "AllOf3Entity"/> instance built from the JSON string.</returns>
                public static AllOf3Entity Parse(string json, JsonDocumentOptions options = default)
                {
                    using var jsonDocument = JsonDocument.Parse(json, options);
                    return new AllOf3Entity(jsonDocument.RootElement.Clone());
                }
                ...
                /// <param name = "options">The (optional) JsonDocumentOptions.</param>
                /// <returns>A <see cref = "AllOf3Entity"/> instance built from the JSON string.</returns>
                public static AllOf3Entity Parse(Stream utf8Json, JsonDocumentOptions options = default)
                {
                ...
                /// <param name = "options">The (optional) JsonDocumentOptions.</param>
                /// <returns>A <see cref = "AllOf3Entity"/> instance built from the JSON string.</returns>
                public static AllOf3Entity Parse(ReadOnlyMemory<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    using var jsonDocument = JsonDocument.Parse(utf8Json, options);
                    return new AllOf3Entity(jsonDocument.RootElement.Clone());
                }
                ...
                /// <param name = "options">The (optional) JsonDocumentOptions.</param>
                /// <returns>A <see cref = "AllOf3Entity"/> instance built from the JSON string.</returns>
                public static AllOf3Entity Parse(ReadOnlyMemory<char> json, JsonDocumentOptions options = default)
                {
                    using var jsonDocument = JsonDocument.Parse(json, options);
                    return new AllOf3Entity(jsonDocument.RootElement.Clone());
                }
                ...
                /// <param name = "options">The (optional) JsonDocumentOptions.</param>
                /// <returns>A <see cref = "AllOf3Entity"/> instance built from the JSON string.</returns>
                public static AllOf3Entity Parse(ReadOnlySequence<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    using var jsonDocument = JsonDocument.Parse(utf8Json, options);
                    return new AllOf3Entity(jsonDocument.RootElement.Clone());
                }
                ...
                static AllOf3Entity ParseValue(ReadOnlySpan<char> buffer)
                {
#if NET8_0_OR_GREATER
        return IJsonValue<AllOf3Entity>.ParseValue(buffer);
#else
                    return JsonValueHelpers.ParseValue<AllOf3Entity>(buffer);
#endif
                }
                ...
                /// <param name = "buffer">The buffer from which to parse the value.</param>
                /// <returns>The parsed value.</returns>
                static AllOf3Entity ParseValue(ReadOnlySpan<byte> buffer)
                {
#if NET8_0_OR_GREATER
        return IJsonValue<AllOf3Entity>.ParseValue(buffer);
#else
                ...
                /// <returns>The parsed value.</returns>
                static AllOf3Entity ParseValue(ref Utf8JsonReader reader)
                {
#if NET8_0_OR_GREATER
        return IJsonValue<AllOf3Entity>.ParseValue(ref reader);
#else
                    return JsonValueHelpers.ParseValue<AllOf3Entity>(ref reader);
#endif
                }
