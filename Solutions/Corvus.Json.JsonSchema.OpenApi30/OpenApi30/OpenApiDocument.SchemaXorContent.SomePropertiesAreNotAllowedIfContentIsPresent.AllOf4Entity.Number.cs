...
: IJsonNumber<AllOf4Entity>,
  IAdditionOperators<AllOf4Entity, AllOf4Entity, AllOf4Entity>,
  ISubtractionOperators<AllOf4Entity, AllOf4Entity, AllOf4Entity>,
  IMultiplyOperators<AllOf4Entity, AllOf4Entity, AllOf4Entity>,
  IDivisionOperators<AllOf4Entity, AllOf4Entity, AllOf4Entity>,
  IIncrementOperators<AllOf4Entity>,
  IDecrementOperators<AllOf4Entity>
#else
            : IJsonNumber<AllOf4Entity>
#endif
            {
                ...
                public AllOf4Entity(in BinaryJsonNumber value)
                {
                ...
                public AllOf4Entity(double value) : this(new BinaryJsonNumber(value))
                {
                }
                ...
                public static implicit operator AllOf4Entity(JsonNumber value)
                {
                ...
                public static explicit operator byte (AllOf4Entity value)
                {
                ...
                public static explicit operator decimal (AllOf4Entity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator double (AllOf4Entity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator short (AllOf4Entity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator int (AllOf4Entity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator long (AllOf4Entity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an Int64.</exception>
    public static explicit operator Int128(AllOf4Entity value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        throw new InvalidOperationException();
                ...
                public static explicit operator sbyte (AllOf4Entity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
    ...
    public static explicit operator Half(AllOf4Entity value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        throw new InvalidOperationException();
                ...
                /// <exception cref = "InvalidOperationException">The value was not a number.</exception>
                /// <exception cref = "FormatException">The value was not formatted as a Single.</exception>
                public static explicit operator float (AllOf4Entity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator ushort (AllOf4Entity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator uint (AllOf4Entity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator ulong (AllOf4Entity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an UInt64.</exception>
    public static explicit operator UInt128(AllOf4Entity value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        throw new InvalidOperationException();
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator AllOf4Entity(decimal value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator AllOf4Entity(double value)
                {
                    return new(new BinaryJsonNumber(value));
                }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator AllOf4Entity(Half value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator AllOf4Entity(float value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator AllOf4Entity(byte value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator AllOf4Entity(short value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator AllOf4Entity(int value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator AllOf4Entity(long value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator AllOf4Entity(sbyte value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator AllOf4Entity(ushort value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator AllOf4Entity(uint value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator AllOf4Entity(ulong value)
                {
                    return new(new BinaryJsonNumber(value));
                }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator AllOf4Entity(Int128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator AllOf4Entity(UInt128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
                ...
                public static AllOf4Entity operator +(AllOf4Entity left, AllOf4Entity right)
                {
                ...
                /// <returns>The resulting value.</returns>
                public static AllOf4Entity operator ++(AllOf4Entity value)
                {
                ...
                public static int Compare(in AllOf4Entity lhs, in AllOf4Entity rhs)
                {
