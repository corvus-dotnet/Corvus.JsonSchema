...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct SecurityRequirementArray
    {
        ...
        SecurityRequirementArray IJsonArray<SecurityRequirementArray>.Remove(in JsonAny item1)
        {
        ...
        public SecurityRequirementArray Remove(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.SecurityRequirement item)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public SecurityRequirementArray RemoveAt(int index)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public SecurityRequirementArray RemoveRange(int index, int count)
        {
