...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct SecurityScheme
    {
        private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext oneOfResult2 = this.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.OAuth2SecurityScheme>().Validate(childContext2.CreateChildContext(), level);
            ...
            ValidationContext oneOfResult3 = this.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.OpenIdConnectSecurityScheme>().Validate(childContext3.CreateChildContext(), level);
