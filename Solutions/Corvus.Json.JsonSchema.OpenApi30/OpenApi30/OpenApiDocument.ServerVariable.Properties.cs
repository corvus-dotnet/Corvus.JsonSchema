...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct ServerVariable
    {
        ...
        public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ServerVariable.JsonStringArray Enum
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
                        return new Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ServerVariable.JsonStringArray(result);
                    }
                }
        ...
        /// </summary>
        public static ServerVariable Create(Corvus.Json.JsonString @default, Corvus.Json.JsonString? description = null, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ServerVariable.JsonStringArray? @enum = null)
        {
            ...
            if (@enum is Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ServerVariable.JsonStringArray @enum__)
            {
        ...
        {
            return property.ValueAs<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ServerVariable.JsonStringArray>().Validate(validationContext, level);
        }
