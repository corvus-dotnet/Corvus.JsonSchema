...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct Tag
    {
        ...
        /// </summary>
        public static Tag Create(Corvus.Json.JsonString name, Corvus.Json.JsonString? description = null, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ExternalDocumentation? externalDocs = null)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Tag WithExternalDocs(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.ExternalDocumentation value)
        {
