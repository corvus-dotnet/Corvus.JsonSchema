...
public readonly partial struct TagArray : IJsonArray<TagArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag>
#else
    public readonly partial struct TagArray : IJsonArray<TagArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag>
#endif
    {
        ...
        public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag(this.jsonElementBacking[index]);
                }
        ...
        public static TagArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag value1)
        {
        ...
        /// <returns>A TagArray instantiated from the given items.</returns>
        public static TagArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag value1, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A TagArray instantiated from the given items.</returns>
        public static TagArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag value1, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag value2, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static TagArray FromItems(params Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static TagArray FromRange(IEnumerable<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item in value)
            {
        ...
        /// <inheritdoc/>
        IEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag> IEnumerable<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag>.GetEnumerator()
        {
        ...
        public JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag>(this.arrayBacking);
            }
