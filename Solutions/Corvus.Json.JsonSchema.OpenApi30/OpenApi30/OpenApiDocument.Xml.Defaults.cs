...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct Xml
    {
        ...
        private static ImmutableList<JsonObjectProperty> BuildDefaults()
        {
            ...
            builder.Add(JsonPropertyNames.Attribute, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Xml.AttributeEntity.DefaultInstance);
            builder.Add(JsonPropertyNames.Wrapped, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Xml.WrappedEntity.DefaultInstance);
