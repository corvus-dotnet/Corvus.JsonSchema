...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct Xml
    {
        ...
        public readonly partial struct WrappedEntity
            : IJsonBoolean<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Xml.WrappedEntity>
        {
            /// <summary>
            /// Conversion from <see cref="bool"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator WrappedEntity(bool value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator WrappedEntity(JsonBoolean value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonBoolean(WrappedEntity value)
            {
                return
                    value.AsBoolean;
            }
