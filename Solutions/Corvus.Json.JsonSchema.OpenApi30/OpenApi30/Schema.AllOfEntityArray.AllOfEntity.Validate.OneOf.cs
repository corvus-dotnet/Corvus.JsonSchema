    ...
    public readonly partial struct AllOfEntityArray
    {
        ...
        public readonly partial struct AllOfEntity
        {
            private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
            {
                ...
                ValidationContext oneOfResult0 = this.As<Corvus.Json.JsonSchema.OpenApi30.Schema>().Validate(childContext0.CreateChildContext(), level);
                ...
                ValidationContext oneOfResult1 = this.As<Corvus.Json.JsonSchema.OpenApi30.Reference>().Validate(childContext1.CreateChildContext(), level);
