...
public readonly partial struct Schema
{
    ...
    public readonly partial struct AllOfEntityArray
    {
        ...
        AllOfEntityArray IJsonArray<AllOfEntityArray>.Remove(in JsonAny item1)
        {
        ...
        public AllOfEntityArray Remove(in Corvus.Json.JsonSchema.OpenApi30.Schema.AllOfEntityArray.AllOfEntity item)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public AllOfEntityArray RemoveAt(int index)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public AllOfEntityArray RemoveRange(int index, int count)
        {
