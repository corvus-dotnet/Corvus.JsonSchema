...
public readonly partial struct AllOfEntityArray : IJsonArray<AllOfEntityArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi30.Schema.AllOfEntityArray.AllOfEntity>
#else
    public readonly partial struct AllOfEntityArray : IJsonArray<AllOfEntityArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi30.Schema.AllOfEntityArray.AllOfEntity>
#endif
    {
        ...
        /// Gets an empty array.
        /// </summary>
        public static readonly AllOfEntityArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "AllOfEntityArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public AllOfEntityArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public AllOfEntityArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        /// <inheritdoc/>
        JsonAny IJsonArray<AllOfEntityArray>.this[int index]
        {
            get
            {
        ...
        public Corvus.Json.JsonSchema.OpenApi30.Schema.AllOfEntityArray.AllOfEntity this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new Corvus.Json.JsonSchema.OpenApi30.Schema.AllOfEntityArray.AllOfEntity(this.jsonElementBacking[index]);
                }
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<Corvus.Json.JsonSchema.OpenApi30.Schema.AllOfEntityArray.AllOfEntity>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static AllOfEntityArray Create(ReadOnlySpan<Corvus.Json.JsonSchema.OpenApi30.Schema.AllOfEntityArray.AllOfEntity> items)
        {
            return new([..items]);
        }
        ...
        /// <returns>A AllOfEntityArray instantiated from the given items.</returns>
        public static AllOfEntityArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.Schema.AllOfEntityArray.AllOfEntity value1)
        {
        ...
        /// <returns>A AllOfEntityArray instantiated from the given items.</returns>
        public static AllOfEntityArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.Schema.AllOfEntityArray.AllOfEntity value1, in Corvus.Json.JsonSchema.OpenApi30.Schema.AllOfEntityArray.AllOfEntity value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A AllOfEntityArray instantiated from the given items.</returns>
        public static AllOfEntityArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.Schema.AllOfEntityArray.AllOfEntity value1, in Corvus.Json.JsonSchema.OpenApi30.Schema.AllOfEntityArray.AllOfEntity value2, in Corvus.Json.JsonSchema.OpenApi30.Schema.AllOfEntityArray.AllOfEntity value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static AllOfEntityArray FromItems(params Corvus.Json.JsonSchema.OpenApi30.Schema.AllOfEntityArray.AllOfEntity[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Corvus.Json.JsonSchema.OpenApi30.Schema.AllOfEntityArray.AllOfEntity item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static AllOfEntityArray FromRange(IEnumerable<Corvus.Json.JsonSchema.OpenApi30.Schema.AllOfEntityArray.AllOfEntity> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Corvus.Json.JsonSchema.OpenApi30.Schema.AllOfEntityArray.AllOfEntity item in value)
            {
        ...
        /// </remarks>
        public static AllOfEntityArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new AllOfEntityArray(builder.ToImmutable());
        }
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static AllOfEntityArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static AllOfEntityArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        IEnumerator<Corvus.Json.JsonSchema.OpenApi30.Schema.AllOfEntityArray.AllOfEntity> IEnumerable<Corvus.Json.JsonSchema.OpenApi30.Schema.AllOfEntityArray.AllOfEntity>.GetEnumerator()
        {
        ...
        /// <inheritdoc/>
        int IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi30.Schema.AllOfEntityArray.AllOfEntity>.Count => this.GetArrayLength();
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.Schema.AllOfEntityArray.AllOfEntity> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.Schema.AllOfEntityArray.AllOfEntity>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.Schema.AllOfEntityArray.AllOfEntity>(this.arrayBacking);
            }
