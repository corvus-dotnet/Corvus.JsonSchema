...
public readonly partial struct Schema
{
    ...
    public readonly partial struct AnyOfEntityArray
    {
        ...
        public AnyOfEntityArray Add(in Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity item1)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
            builder.Add(item1);
            return new(builder.ToImmutable());
        ...
        /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
        public AnyOfEntityArray Add(params Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity[] items)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
            foreach (Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity item in items)
            {
                builder.Add(item.AsAny);
            }
        ...
        /// <returns>An instance of the array with the items added.</returns>
        /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
        public AnyOfEntityArray AddRange(IEnumerable<Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity> items)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
            foreach (Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity item in items)
            {
        ...
        /// <returns>An instance of the array with the item added.</returns>
        /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
        public AnyOfEntityArray Insert(int index, in Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity item1)
        {
            return new(this.GetImmutableListWith(index, item1));
        }
        ...
        public AnyOfEntityArray InsertRange(int index, IEnumerable<Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity> items)
        {
            return new(this.GetImmutableListWith(index, items.Select(item => item.AsAny)));
        }
        ...
        /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
        public AnyOfEntityArray Replace(in Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity oldValue, in Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity newValue)
        {
            return new(this.GetImmutableListReplacing(oldValue.AsAny, newValue.AsAny));
        }
        ...
        public AnyOfEntityArray SetItem(int index, in Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity value)
        {
            return new(this.GetImmutableListSetting(index, value.AsAny));
        }
    }
