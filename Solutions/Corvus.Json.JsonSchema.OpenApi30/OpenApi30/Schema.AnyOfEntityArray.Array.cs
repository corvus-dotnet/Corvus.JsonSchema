...
public readonly partial struct AnyOfEntityArray : IJsonArray<AnyOfEntityArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity>
#else
    public readonly partial struct AnyOfEntityArray : IJsonArray<AnyOfEntityArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity>
#endif
    {
        ...
        public Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity(this.jsonElementBacking[index]);
                }
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static AnyOfEntityArray Create(ReadOnlySpan<Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity> items)
        {
            return new([..items]);
        }
        ...
        public static AnyOfEntityArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity value1)
        {
        ...
        /// <returns>A AnyOfEntityArray instantiated from the given items.</returns>
        public static AnyOfEntityArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity value1, in Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A AnyOfEntityArray instantiated from the given items.</returns>
        public static AnyOfEntityArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity value1, in Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity value2, in Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static AnyOfEntityArray FromItems(params Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static AnyOfEntityArray FromRange(IEnumerable<Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity item in value)
            {
        ...
        /// <inheritdoc/>
        IEnumerator<Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity> IEnumerable<Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity>.GetEnumerator()
        {
        ...
        /// <inheritdoc/>
        int IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity>.Count => this.GetArrayLength();
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.Schema.AnyOfEntityArray.AnyOfEntity>(this.arrayBacking);
            }
