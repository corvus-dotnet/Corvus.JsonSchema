...
: IJsonNumber<MaxLengthEntity>,
  IAdditionOperators<MaxLengthEntity, MaxLengthEntity, MaxLengthEntity>,
  ISubtractionOperators<MaxLengthEntity, MaxLengthEntity, MaxLengthEntity>,
  IMultiplyOperators<MaxLengthEntity, MaxLengthEntity, MaxLengthEntity>,
  IDivisionOperators<MaxLengthEntity, MaxLengthEntity, MaxLengthEntity>,
  IIncrementOperators<MaxLengthEntity>,
  IDecrementOperators<MaxLengthEntity>
#else
    : IJsonNumber<MaxLengthEntity>
#endif
    {
        ...
        public MaxLengthEntity(in BinaryJsonNumber value)
        {
        ...
        public MaxLengthEntity(long value) : this(new BinaryJsonNumber(value))
        {
        }
        ...
        public static explicit operator long (MaxLengthEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
    ...
    public static explicit operator MaxLengthEntity(Half value)
    {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator MaxLengthEntity(long value)
        {
            return new(new BinaryJsonNumber(value));
        }
