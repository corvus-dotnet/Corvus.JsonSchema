...
: IJsonNumber<MinItemsEntity>,
  IAdditionOperators<MinItemsEntity, MinItemsEntity, MinItemsEntity>,
  ISubtractionOperators<MinItemsEntity, MinItemsEntity, MinItemsEntity>,
  IMultiplyOperators<MinItemsEntity, MinItemsEntity, MinItemsEntity>,
  IDivisionOperators<MinItemsEntity, MinItemsEntity, MinItemsEntity>,
  IIncrementOperators<MinItemsEntity>,
  IDecrementOperators<MinItemsEntity>
#else
    : IJsonNumber<MinItemsEntity>
#endif
    {
        ...
        public MinItemsEntity(in BinaryJsonNumber value)
        {
        ...
        public MinItemsEntity(long value) : this(new BinaryJsonNumber(value))
        {
        }
        ...
        public static explicit operator long (MinItemsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
    ...
    public static explicit operator MinItemsEntity(Half value)
    {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator MinItemsEntity(long value)
        {
            return new(new BinaryJsonNumber(value));
        }
