...
: IJsonNumber<MinLengthEntity>,
  IAdditionOperators<MinLengthEntity, MinLengthEntity, MinLengthEntity>,
  ISubtractionOperators<MinLengthEntity, MinLengthEntity, MinLengthEntity>,
  IMultiplyOperators<MinLengthEntity, MinLengthEntity, MinLengthEntity>,
  IDivisionOperators<MinLengthEntity, MinLengthEntity, MinLengthEntity>,
  IIncrementOperators<MinLengthEntity>,
  IDecrementOperators<MinLengthEntity>
#else
    : IJsonNumber<MinLengthEntity>
#endif
    {
        ...
        public MinLengthEntity(in BinaryJsonNumber value)
        {
        ...
        public MinLengthEntity(long value) : this(new BinaryJsonNumber(value))
        {
        }
        ...
        public static explicit operator long (MinLengthEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
    ...
    public static explicit operator MinLengthEntity(Half value)
    {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator MinLengthEntity(long value)
        {
            return new(new BinaryJsonNumber(value));
        }
