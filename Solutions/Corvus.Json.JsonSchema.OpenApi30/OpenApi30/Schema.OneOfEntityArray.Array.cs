...
public readonly partial struct OneOfEntityArray : IJsonArray<OneOfEntityArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi30.Schema.OneOfEntityArray.OneOfEntity>
#else
    public readonly partial struct OneOfEntityArray : IJsonArray<OneOfEntityArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi30.Schema.OneOfEntityArray.OneOfEntity>
#endif
    {
        ...
        public Corvus.Json.JsonSchema.OpenApi30.Schema.OneOfEntityArray.OneOfEntity this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new Corvus.Json.JsonSchema.OpenApi30.Schema.OneOfEntityArray.OneOfEntity(this.jsonElementBacking[index]);
                }
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<Corvus.Json.JsonSchema.OpenApi30.Schema.OneOfEntityArray.OneOfEntity>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static OneOfEntityArray Create(ReadOnlySpan<Corvus.Json.JsonSchema.OpenApi30.Schema.OneOfEntityArray.OneOfEntity> items)
        {
            return new([..items]);
        }
        ...
        public static OneOfEntityArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.Schema.OneOfEntityArray.OneOfEntity value1)
        {
        ...
        /// <returns>A OneOfEntityArray instantiated from the given items.</returns>
        public static OneOfEntityArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.Schema.OneOfEntityArray.OneOfEntity value1, in Corvus.Json.JsonSchema.OpenApi30.Schema.OneOfEntityArray.OneOfEntity value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A OneOfEntityArray instantiated from the given items.</returns>
        public static OneOfEntityArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.Schema.OneOfEntityArray.OneOfEntity value1, in Corvus.Json.JsonSchema.OpenApi30.Schema.OneOfEntityArray.OneOfEntity value2, in Corvus.Json.JsonSchema.OpenApi30.Schema.OneOfEntityArray.OneOfEntity value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static OneOfEntityArray FromItems(params Corvus.Json.JsonSchema.OpenApi30.Schema.OneOfEntityArray.OneOfEntity[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Corvus.Json.JsonSchema.OpenApi30.Schema.OneOfEntityArray.OneOfEntity item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static OneOfEntityArray FromRange(IEnumerable<Corvus.Json.JsonSchema.OpenApi30.Schema.OneOfEntityArray.OneOfEntity> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Corvus.Json.JsonSchema.OpenApi30.Schema.OneOfEntityArray.OneOfEntity item in value)
            {
        ...
        /// <inheritdoc/>
        IEnumerator<Corvus.Json.JsonSchema.OpenApi30.Schema.OneOfEntityArray.OneOfEntity> IEnumerable<Corvus.Json.JsonSchema.OpenApi30.Schema.OneOfEntityArray.OneOfEntity>.GetEnumerator()
        {
        ...
        /// <inheritdoc/>
        int IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi30.Schema.OneOfEntityArray.OneOfEntity>.Count => this.GetArrayLength();
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.Schema.OneOfEntityArray.OneOfEntity> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.Schema.OneOfEntityArray.OneOfEntity>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.Schema.OneOfEntityArray.OneOfEntity>(this.arrayBacking);
            }
