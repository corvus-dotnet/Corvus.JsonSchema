...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct Components
    {
        ...
        public readonly partial struct CallbacksEntity
            : IJsonObject<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Components.CallbacksEntity>,
              IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.CallbacksOrReference>
        {
            /// <summary>
            /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator CallbacksEntity(ImmutableList<JsonObjectProperty> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ImmutableList<JsonObjectProperty>(CallbacksEntity value)
            {
                return
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonObject(CallbacksEntity value)
            {
                return
                    value.AsObject;
            }
            ...
            /// <inheritdoc/>
            int IReadOnlyCollection<KeyValuePair<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.CallbacksOrReference>>.Count => this.Count;
            ...
            bool IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.CallbacksOrReference>.ContainsKey(JsonPropertyName key) => this.HasProperty(key);

            bool IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.CallbacksOrReference>.TryGetValue(JsonPropertyName key, out Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.CallbacksOrReference result) => this.TryGetProperty(key, out result);
            ...
            /// <inheritdoc />
            bool IJsonObject<CallbacksEntity>.TryGetProperty(ReadOnlySpan<byte> name, out JsonAny value)
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    if (this.jsonElementBacking.ValueKind != JsonValueKind.Object)
            ...
            /// <returns><c>True</c> if the property was present.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(ReadOnlySpan<byte> name, out Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.CallbacksOrReference value)
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    if (this.jsonElementBacking.ValueKind != JsonValueKind.Object)
            ...
            /// <inheritdoc />
            bool IJsonObject<CallbacksEntity>.TryGetProperty<TValue>(ReadOnlySpan<byte> name, out TValue value)
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    if (this.jsonElementBacking.ValueKind != JsonValueKind.Object)
...
CallbacksEntity IJsonObject<CallbacksEntity>.SetProperty<TValue>(in JsonPropertyName name, TValue value)
            ...
            public CallbacksEntity SetProperty(in JsonPropertyName name, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.CallbacksOrReference value)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWith(this, name, value.AsAny));
            }
            ...
            /// <inheritdoc />
            public CallbacksEntity RemoveProperty(ReadOnlySpan<byte> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }
            ...
            private static class __CorvusObjectHelpers
            {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in CallbacksEntity that)
                {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in CallbacksEntity that, in JsonPropertyName name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in CallbacksEntity that, ReadOnlySpan<char> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in CallbacksEntity that, ReadOnlySpan<byte> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in CallbacksEntity that, string name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in CallbacksEntity that, in JsonPropertyName name, in JsonAny value)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
