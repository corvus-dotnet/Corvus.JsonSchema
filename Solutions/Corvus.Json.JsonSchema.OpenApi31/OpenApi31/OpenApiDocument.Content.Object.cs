...
public readonly partial struct OpenApiDocument
{
    ...
    /// </summary>
    public readonly partial struct Content : IJsonObject<Content>, IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.MediaType>
    {
        /// <summary>
        ...
        /// <inheritdoc/>
        int IReadOnlyCollection<KeyValuePair<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.MediaType>>.Count
        {
            get
            {
    ...
    static Content IJsonObject<Content>.FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
        ...
        /// <inheritdoc/>
        bool IJsonObject<Content>.TryGetProperty(ReadOnlySpan<byte> utf8Name, out JsonAny value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        bool IJsonObject<Content>.TryGetProperty<TValue>(ReadOnlySpan<byte> utf8Name, out TValue value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.TryGetProperty(utf8Name, out JsonElement result))
        ...
        public bool TryGetProperty(in JsonPropertyName name, out Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.MediaType value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
#if NET8_0_OR_GREATER
                value = Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.MediaType.FromJson(result);
#else
                    value = JsonValueNetStandard20Extensions.FromJsonElement<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.MediaType>(result);
#endif
                    return true;
                }
...
#else
                    value = result.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.MediaType>();
#endif
                    return true;
                }
        ...
        /// <returns><c>True</c> if the property was present.</returns>
        /// <exception cref = "InvalidOperationException">The value is not an object.</exception>
        public bool TryGetProperty(ReadOnlySpan<byte> utf8Name, out Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.MediaType value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.TryGetProperty(utf8Name, out JsonElement result))
        ...
        public Content SetProperty(in JsonPropertyName name, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.MediaType value)
        {
            return new(this.GetPropertyBackingWith(name, value.AsAny));
        }
        ...
        /// <inheritdoc/>
        bool IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.MediaType>.ContainsKey(JsonPropertyName key)
        {
            return this.HasProperty(key);
        }

        /// <inheritdoc/>
        bool IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.MediaType>.TryGetValue(JsonPropertyName key, [MaybeNullWhen(false)] out Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.MediaType value)
        {
