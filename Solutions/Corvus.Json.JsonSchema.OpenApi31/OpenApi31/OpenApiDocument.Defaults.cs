...
public readonly partial struct OpenApiDocument
{
    ...
    private static ImmutableList<JsonObjectProperty> BuildDefaults()
    {
        ...
        builder.Add(JsonPropertyNames.JsonSchemaDialect, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.JsonSchemaDialectEntity.DefaultInstance);
        builder.Add(JsonPropertyNames.Servers, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ServerArray.DefaultInstance);
