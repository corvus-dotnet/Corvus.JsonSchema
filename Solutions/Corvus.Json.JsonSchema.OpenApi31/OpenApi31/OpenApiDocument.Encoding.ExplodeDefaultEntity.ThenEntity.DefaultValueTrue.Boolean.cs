        ...
        public readonly partial struct ExplodeDefaultEntity
        {
            ...
            public readonly partial struct ThenEntity
            {
                ...
                public readonly partial struct DefaultValueTrue
                    : IJsonBoolean<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Encoding.ExplodeDefaultEntity.ThenEntity.DefaultValueTrue>
                {
                    /// <summary>
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator JsonBoolean(DefaultValueTrue value)
                    {
                        return
                            value.AsBoolean;
                    }
