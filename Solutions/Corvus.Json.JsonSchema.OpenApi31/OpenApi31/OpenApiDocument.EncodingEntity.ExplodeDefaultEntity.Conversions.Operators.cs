...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct EncodingEntity
    {
        ...
        public readonly partial struct ExplodeDefaultEntity
        {
            ...
            public static explicit operator Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.EncodingEntity.ExplodeDefaultEntity.ThenEntity(ExplodeDefaultEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static explicit operator ExplodeDefaultEntity(Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.EncodingEntity.ExplodeDefaultEntity.ThenEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static explicit operator Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.EncodingEntity.ExplodeDefaultEntity.ElseEntity(ExplodeDefaultEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
                    return new(value.AsJsonElement);
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static explicit operator ExplodeDefaultEntity(Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.EncodingEntity.ExplodeDefaultEntity.ElseEntity value)
            {
                if (value.HasJsonElementBacking)
                {
                    return new(value.AsJsonElement);
