...
: IJsonNumber<DefaultValuetrue>,
  IAdditionOperators<DefaultValuetrue, DefaultValuetrue, DefaultValuetrue>,
  ISubtractionOperators<DefaultValuetrue, DefaultValuetrue, DefaultValuetrue>,
  IMultiplyOperators<DefaultValuetrue, DefaultValuetrue, DefaultValuetrue>,
  IDivisionOperators<DefaultValuetrue, DefaultValuetrue, DefaultValuetrue>,
  IIncrementOperators<DefaultValuetrue>,
  IDecrementOperators<DefaultValuetrue>
#else
                : IJsonNumber<DefaultValuetrue>
#endif
                {
                    ...
                    public DefaultValuetrue(in BinaryJsonNumber value)
                    {
                    ...
                    public DefaultValuetrue(double value) : this(new BinaryJsonNumber(value))
                    {
                    }
                    ...
                    public static implicit operator DefaultValuetrue(JsonNumber value)
                    {
                    ...
                    public static explicit operator byte (DefaultValuetrue value)
                    {
                    ...
                    public static explicit operator decimal (DefaultValuetrue value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    public static explicit operator double (DefaultValuetrue value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    public static explicit operator short (DefaultValuetrue value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    public static explicit operator int (DefaultValuetrue value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    public static explicit operator long (DefaultValuetrue value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an Int64.</exception>
    public static explicit operator Int128(DefaultValuetrue value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        throw new InvalidOperationException();
                    ...
                    public static explicit operator sbyte (DefaultValuetrue value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
    ...
    public static explicit operator Half(DefaultValuetrue value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        throw new InvalidOperationException();
                    ...
                    /// <exception cref = "InvalidOperationException">The value was not a number.</exception>
                    /// <exception cref = "FormatException">The value was not formatted as a Single.</exception>
                    public static explicit operator float (DefaultValuetrue value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    public static explicit operator ushort (DefaultValuetrue value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    public static explicit operator uint (DefaultValuetrue value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    public static explicit operator ulong (DefaultValuetrue value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an UInt64.</exception>
    public static explicit operator UInt128(DefaultValuetrue value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        throw new InvalidOperationException();
                    ...
                    /// </summary>
                    /// <param name = "value">The value to convert.</param>
                    public static explicit operator DefaultValuetrue(decimal value)
                    {
                    ...
                    /// </summary>
                    /// <param name = "value">The value to convert.</param>
                    public static explicit operator DefaultValuetrue(double value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator DefaultValuetrue(Half value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
                    ...
                    /// </summary>
                    /// <param name = "value">The value to convert.</param>
                    public static explicit operator DefaultValuetrue(float value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    /// </summary>
                    /// <param name = "value">The value to convert.</param>
                    public static explicit operator DefaultValuetrue(byte value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    /// </summary>
                    /// <param name = "value">The value to convert.</param>
                    public static explicit operator DefaultValuetrue(short value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    /// </summary>
                    /// <param name = "value">The value to convert.</param>
                    public static explicit operator DefaultValuetrue(int value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    /// </summary>
                    /// <param name = "value">The value to convert.</param>
                    public static explicit operator DefaultValuetrue(long value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    /// </summary>
                    /// <param name = "value">The value to convert.</param>
                    public static explicit operator DefaultValuetrue(sbyte value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    /// </summary>
                    /// <param name = "value">The value to convert.</param>
                    public static explicit operator DefaultValuetrue(ushort value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    /// </summary>
                    /// <param name = "value">The value to convert.</param>
                    public static explicit operator DefaultValuetrue(uint value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    /// </summary>
                    /// <param name = "value">The value to convert.</param>
                    public static explicit operator DefaultValuetrue(ulong value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator DefaultValuetrue(Int128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator DefaultValuetrue(UInt128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
                    ...
                    public static DefaultValuetrue operator +(DefaultValuetrue left, DefaultValuetrue right)
                    {
                    ...
                    /// <returns>The resulting value.</returns>
                    public static DefaultValuetrue operator ++(DefaultValuetrue value)
                    {
                    ...
                    public static int Compare(in DefaultValuetrue lhs, in DefaultValuetrue rhs)
                    {
