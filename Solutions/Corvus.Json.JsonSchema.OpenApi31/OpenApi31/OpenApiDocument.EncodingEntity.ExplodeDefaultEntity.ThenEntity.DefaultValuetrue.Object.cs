    ...
    public readonly partial struct EncodingEntity
    {
        public readonly partial struct ExplodeDefaultEntity
        {
            public readonly partial struct ThenEntity
            {
                ...
                /// </summary>
                public readonly partial struct DefaultValuetrue : IJsonObject<DefaultValuetrue>
                {
                    /// <summary>
                    /// Initializes a new instance of the <see cref = "DefaultValuetrue"/> struct.
                    /// </summary>
                    /// <param name = "value">The value from which to construct the instance.</param>
                    public DefaultValuetrue(ImmutableList<JsonObjectProperty> value)
                    {
                    ...
                    public static implicit operator DefaultValuetrue(JsonObject value)
                    {
                    ...
                    public static DefaultValuetrue FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
                    {
                    ...
                    /// <param name = "source">The dictionary of properties.</param>
                    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
                    public static DefaultValuetrue FromProperties(ImmutableList<JsonObjectProperty> source)
                    {
                        return new(source);
                    }
                    ...
                    /// <param name = "source">The dictionary of properties.</param>
                    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
                    public static DefaultValuetrue FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
                    {
                ...
                value = TValue.FromAny(result);
                    ...
                    /// <inheritdoc/>
                    public DefaultValuetrue SetProperty<TValue>(in JsonPropertyName name, TValue value)
                    ...
                    /// <inheritdoc/>
                    public DefaultValuetrue RemoveProperty(in JsonPropertyName name)
                    {
                        return new(this.GetPropertyBackingWithout(name));
                    }

                    /// <inheritdoc/>
                    public DefaultValuetrue RemoveProperty(string name)
                    {
                        return new(this.GetPropertyBackingWithout(name));
                    }

                    /// <inheritdoc/>
                    public DefaultValuetrue RemoveProperty(ReadOnlySpan<char> name)
                    {
                        return new(this.GetPropertyBackingWithout(name));
                    }

                    /// <inheritdoc/>
                    public DefaultValuetrue RemoveProperty(ReadOnlySpan<byte> utf8Name)
                    {
