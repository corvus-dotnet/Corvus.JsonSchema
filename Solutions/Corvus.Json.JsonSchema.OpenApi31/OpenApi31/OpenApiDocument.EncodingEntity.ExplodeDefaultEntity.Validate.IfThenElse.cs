    ...
    public readonly partial struct EncodingEntity
    {
        ...
        public readonly partial struct ExplodeDefaultEntity
        {
            private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
            {
                ...
                ValidationContext ifResult = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.EncodingEntity.ExplodeDefaultEntity.RequiredStyle>().Validate(validationContext.CreateChildContext(), level);
                if (!ifResult.IsValid)
                {
                ...
                if (ifResult.IsValid)
                {
                    ...
                    ValidationContext thenResult = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.EncodingEntity.ExplodeDefaultEntity.ThenEntity>().Validate(validationContext.CreateChildContext(), level);
                ...
                if (!ifResult.IsValid)
                {
                    ...
                    ValidationContext elseResult = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.EncodingEntity.ExplodeDefaultEntity.ElseEntity>().Validate(validationContext.CreateChildContext(), level);
