...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct EncodingEntity
    {
        ...
        /// </summary>
        public Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.EncodingEntity.AllowReservedEntity AllowReserved
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
                        return new Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.EncodingEntity.AllowReservedEntity(result);
                    }
                }
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.EncodingEntity.AllowReservedEntity>();
                    }
                }
        ...
        /// </summary>
        public Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.EncodingEntity.StyleEntity Style
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
                        return new Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.EncodingEntity.StyleEntity(result);
                    }
                }
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.EncodingEntity.StyleEntity>();
                    }
                }
        ...
        public static EncodingEntity Create(Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.EncodingEntity.AllowReservedEntity? allowReserved = null, Corvus.Json.JsonString? contentType = null, Corvus.Json.JsonBoolean? explode = null, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.HeadersEntity? headers = null, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.EncodingEntity.StyleEntity? style = null)
        {
            ...
            if (style is Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.EncodingEntity.StyleEntity style__)
            {
        ...
        public EncodingEntity WithAllowReserved(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.EncodingEntity.AllowReservedEntity value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public EncodingEntity WithStyle(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.EncodingEntity.StyleEntity value)
        {
        ...
        {
            return property.ValueAs<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.EncodingEntity.StyleEntity>().Validate(validationContext, level);
        }
        ...
        {
            return property.ValueAs<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.EncodingEntity.AllowReservedEntity>().Validate(validationContext, level);
        }
        ...
        private bool __TryGetCorvusLocalPropertiesValidator(in JsonObjectProperty property, bool hasJsonElementBacking, [NotNullWhen(true)] out ObjectPropertyValidator? propertyValidator)
        {
            if (hasJsonElementBacking)
            {
                ...
                else if (property.NameEquals(JsonPropertyNames.ContentTypeUtf8))
                {
            ...
            else
            {
                ...
                else if (property.NameEquals(JsonPropertyNames.ContentType))
                {
                    propertyValidator = __CorvusValidateContentType;
                    return true;
                }
