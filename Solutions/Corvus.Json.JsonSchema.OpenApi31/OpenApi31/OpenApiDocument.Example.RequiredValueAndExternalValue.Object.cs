...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct Example
    {
        ...
        /// </summary>
        public readonly partial struct RequiredValueAndExternalValue : IJsonObject<RequiredValueAndExternalValue>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "RequiredValueAndExternalValue"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public RequiredValueAndExternalValue(ImmutableList<JsonObjectProperty> value)
            {
            ...
            public static implicit operator RequiredValueAndExternalValue(JsonObject value)
            {
            ...
            public static RequiredValueAndExternalValue FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
            {
            ...
            /// <param name = "source">The dictionary of properties.</param>
            /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
            public static RequiredValueAndExternalValue FromProperties(ImmutableList<JsonObjectProperty> source)
            {
                return new(source);
            }
            ...
            /// <param name = "source">The dictionary of properties.</param>
            /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
            public static RequiredValueAndExternalValue FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
            {
            ...
            /// <inheritdoc/>
            public RequiredValueAndExternalValue SetProperty<TValue>(in JsonPropertyName name, TValue value)
            ...
            /// <inheritdoc/>
            public RequiredValueAndExternalValue RemoveProperty(in JsonPropertyName name)
            {
                return new(this.GetPropertyBackingWithout(name));
            }

            /// <inheritdoc/>
            public RequiredValueAndExternalValue RemoveProperty(string name)
            {
                return new(this.GetPropertyBackingWithout(name));
            }

            /// <inheritdoc/>
            public RequiredValueAndExternalValue RemoveProperty(ReadOnlySpan<char> name)
            {
                return new(this.GetPropertyBackingWithout(name));
            }

            /// <inheritdoc/>
            public RequiredValueAndExternalValue RemoveProperty(ReadOnlySpan<byte> utf8Name)
            {
