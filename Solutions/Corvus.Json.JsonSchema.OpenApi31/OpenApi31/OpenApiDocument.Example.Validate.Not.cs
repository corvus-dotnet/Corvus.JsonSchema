...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct Example
    {
        private ValidationContext ValidateNot(ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext notResult = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Example.RequiredValueAndExternalValue>().Validate(validationContext.CreateChildContext(), level);
