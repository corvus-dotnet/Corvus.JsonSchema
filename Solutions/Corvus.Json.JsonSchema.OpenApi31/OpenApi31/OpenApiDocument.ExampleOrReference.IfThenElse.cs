...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct ExampleOrReference
    {
        ...
        public bool MatchIfRequiredRef(out Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Reference @then, out Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Example @else)
        {
            if (this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ExampleOrReference.RequiredRef>().IsValid())
            {
                @then = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Reference>();
                @else = Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Example.Undefined;
                return true;
            }

            @then = Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Reference.Undefined;
            @else = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Example>();
            return false;
        }
    }
}