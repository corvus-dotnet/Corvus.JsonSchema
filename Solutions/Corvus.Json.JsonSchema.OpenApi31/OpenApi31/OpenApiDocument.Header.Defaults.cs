...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct Header
    {
        ...
        private static ImmutableList<JsonObjectProperty> BuildDefaults()
        {
            ...
            builder.Add(JsonPropertyNames.Deprecated, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Header.DeprecatedEntity.DefaultInstance);
            builder.Add(JsonPropertyNames.Explode, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Header.WithStyleSimple.ExplodeEntity.DefaultInstance);
            builder.Add(JsonPropertyNames.Required, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Header.RequiredEntity.DefaultInstance);
            builder.Add(JsonPropertyNames.Style, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Header.WithStyleSimple.StyleEntity.DefaultInstance);
