...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct Header
    {
        private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext oneOfResult0 = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Header.RequiredSchema>().Validate(childContext0.CreateChildContext(), level);
            ...
            ValidationContext oneOfResult1 = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Header.RequiredContent>().Validate(childContext1.CreateChildContext(), level);
