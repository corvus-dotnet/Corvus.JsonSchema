...
public readonly partial struct OpenApiDocument
{
    ...
    /// </summary>
    public readonly partial struct HeaderContentEntity : IJsonObject<HeaderContentEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "HeaderContentEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public HeaderContentEntity(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator HeaderContentEntity(JsonObject value)
        {
        ...
        public static HeaderContentEntity FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static HeaderContentEntity FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static HeaderContentEntity FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public HeaderContentEntity SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public HeaderContentEntity RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public HeaderContentEntity RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public HeaderContentEntity RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public HeaderContentEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
