...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct HeaderOrReference
    {
        ...
        public bool MatchIfRequiredRef(out Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Reference @then, out Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Header @else)
        {
            if (this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.HeaderOrReference.RequiredRef>().IsValid())
            {
                @then = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Reference>();
                @else = Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Header.Undefined;
                return true;
            }

            @then = Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Reference.Undefined;
            @else = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Header>();
            return false;
        }
    }
}