...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct HeaderOrReference
    {
        private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext ifResult = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.HeaderOrReference.RequiredRef>().Validate(validationContext.CreateChildContext(), level);
            if (!ifResult.IsValid)
            {
            ...
            if (!ifResult.IsValid)
            {
                ...
                ValidationContext elseResult = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Header>().Validate(validationContext.CreateChildContext(), level);
