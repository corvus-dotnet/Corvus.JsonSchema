...
[CollectionBuilder(typeof(IdentifierEntity), "Create")]
public readonly partial struct IdentifierEntity : IJsonArray<IdentifierEntity>, IReadOnlyCollection<JsonAny>
#else
        public readonly partial struct IdentifierEntity : IJsonArray<IdentifierEntity>, IReadOnlyCollection<JsonAny>
#endif
        {
            ...
            /// Gets an empty array.
            /// </summary>
            public static readonly IdentifierEntity EmptyArray = From(ImmutableList<JsonAny>.Empty);
            /// <summary>
            /// Initializes a new instance of the <see cref = "IdentifierEntity"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public IdentifierEntity(ImmutableList<JsonAny> value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public IdentifierEntity(IEnumerable<JsonAny> value)
            {
                this.jsonElementBacking = default;
                this.backing = Backing.Array;
                this.stringBacking = string.Empty;
            ...
            public static implicit operator ImmutableList<JsonAny>(IdentifierEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator IdentifierEntity(ImmutableList<JsonAny> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator IdentifierEntity(JsonArray value)
            {
            ...
            public static IdentifierEntity From(ImmutableList<JsonAny> items)
            {
                return new(items);
            }
            ...
            public static IdentifierEntity Create(ReadOnlySpan<JsonAny> items)
            {
                return new([..items]);
            }
            ...
            public static IdentifierEntity FromItems(params JsonAny[] value)
            {
            ...
            /// <param name = "value">The value from which to construct the instance.</param>
            /// <returns>A IdentifierEntity instantiated from the given items.</returns>
            public static IdentifierEntity FromItems<TItem>(params TItem[] value)
            ...
            /// <returns>A IdentifierEntity instantiated from the given items.</returns>
            public static IdentifierEntity FromItems<TItem1>(in TItem1 value1)
            ...
            /// <returns>A IdentifierEntity instantiated from the given items.</returns>
            public static IdentifierEntity FromItems<TItem1, TItem2>(in TItem1 value1, in TItem2 value2)
            ...
            /// <returns>A IdentifierEntity instantiated from the given items.</returns>
            public static IdentifierEntity FromItems<TItem1, TItem2, TItem3>(in TItem1 value1, in TItem2 value2, in TItem3 value3)
            ...
            /// </remarks>
            public static IdentifierEntity From<T>(IEnumerable<T> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                ...
                return new IdentifierEntity(builder.ToImmutable());
            }
            ...
            /// other overloads which avoid this serialization step.
            /// </remarks>
            public static IdentifierEntity FromRange(IEnumerable<JsonAny> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// other overloads which avoid this serialization step.
            /// </remarks>
            public static IdentifierEntity FromRange<T>(IEnumerable<T> items)
            ...
            /// <param name = "items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static IdentifierEntity FromRange(IEnumerable<string> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// <param name = "items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static IdentifierEntity FromRange(IEnumerable<double> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// <param name = "items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static IdentifierEntity FromRange(IEnumerable<float> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// <param name = "items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static IdentifierEntity FromRange(IEnumerable<int> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// <param name = "items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static IdentifierEntity FromRange(IEnumerable<long> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// <param name = "items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static IdentifierEntity FromRange(IEnumerable<bool> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// <param name = "value1">The first value from which to construct the instance.</param>
            /// <returns>A IdentifierEntity instantiated from the given items.</returns>
            public static IdentifierEntity FromItems(in JsonAny value1)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1);
                return new(builder.ToImmutable());
            ...
            /// <param name = "value2">The second value from which to construct the instance.</param>
            /// <returns>A IdentifierEntity instantiated from the given items.</returns>
            public static IdentifierEntity FromItems(in JsonAny value1, in JsonAny value2)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1);
                builder.Add(value2);
            ...
            /// <param name = "value3">The thirdvalue from which to construct the instance.</param>
            /// <returns>A IdentifierEntity instantiated from the given items.</returns>
            public static IdentifierEntity FromItems(in JsonAny value1, in JsonAny value2, in JsonAny value3)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1);
                builder.Add(value2);
