...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct License
    {
        ...
        /// </summary>
        public readonly partial struct IdentifierEntity : IJsonBoolean<IdentifierEntity>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "IdentifierEntity"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public IdentifierEntity(bool value)
            {
            ...
            public static implicit operator IdentifierEntity(JsonBoolean value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator IdentifierEntity(bool value)
            {
                return new(value);
            }
            ...
            public static implicit operator bool (IdentifierEntity value)
            {
