...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct License
    {
        ...
        /// </summary>
        public readonly partial struct IdentifierEntity : IJsonObject<IdentifierEntity>
        {
            /// <summary>
            ...
            public static implicit operator IdentifierEntity(JsonObject value)
            {
            ...
            public static IdentifierEntity FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
            {
            ...
            /// <param name = "source">The dictionary of properties.</param>
            /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
            public static IdentifierEntity FromProperties(ImmutableList<JsonObjectProperty> source)
            {
                return new(source);
            }
            ...
            /// <param name = "source">The dictionary of properties.</param>
            /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
            public static IdentifierEntity FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
            {
            ...
            /// <inheritdoc/>
            public IdentifierEntity SetProperty<TValue>(in JsonPropertyName name, TValue value)
            ...
            /// <inheritdoc/>
            public IdentifierEntity RemoveProperty(in JsonPropertyName name)
            {
                return new(this.GetPropertyBackingWithout(name));
            }

            /// <inheritdoc/>
            public IdentifierEntity RemoveProperty(string name)
            {
                return new(this.GetPropertyBackingWithout(name));
            }

            /// <inheritdoc/>
            public IdentifierEntity RemoveProperty(ReadOnlySpan<char> name)
            {
                return new(this.GetPropertyBackingWithout(name));
            }

            /// <inheritdoc/>
            public IdentifierEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
            {
