...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct Link
    {
        private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext oneOfResult0 = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Link.RequiredOperationRef>().Validate(childContext0.CreateChildContext(), level);
            ...
            ValidationContext oneOfResult1 = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Link.RequiredOperationId>().Validate(childContext1.CreateChildContext(), level);
