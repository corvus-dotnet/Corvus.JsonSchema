...
public readonly partial struct OpenApiDocument
{
    ...
    /// Generated from JSON Schema.
    /// </summary>
    [System.Text.Json.Serialization.JsonConverter(typeof(Corvus.Json.Internal.JsonValueConverter<Link>))]
...

    {
        ...
        public Link(in JsonElement value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        public Link(ImmutableList<JsonObjectProperty> value)
        {
        ...
        /// </summary>
        public static string SchemaLocation { get; } = "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/link";

        /// <summary>
        /// Gets a Null instance.
        /// </summary>
        public static Link Null { get; } = new(JsonValueHelpers.NullElement);

        /// <summary>
        /// Gets an Undefined instance.
        /// </summary>
        public static Link Undefined { get; }
        ...
        /// <summary>
        /// Gets the instance as a <see cref="Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Link.RequiredOperationRef" />.
        /// </summary>
        public Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Link.RequiredOperationRef AsRequiredOperationRef
        {
            get
            {
                return this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Link.RequiredOperationRef>();
            }
        }

        /// <summary>
        /// Gets a value indicating whether the instance is a <see cref="Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Link.RequiredOperationRef" />.
        /// </summary>
        public bool IsRequiredOperationRef
        {
            get
            {
                return this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Link.RequiredOperationRef>().IsValid();
            }
        }

        /// <summary>
        /// Gets the instance as a <see cref="Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Link.RequiredOperationId" />.
        /// </summary>
        public Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Link.RequiredOperationId AsRequiredOperationId
        {
            get
            {
                return this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Link.RequiredOperationId>();
            }
        }

        /// <summary>
        /// Gets a value indicating whether the instance is a <see cref="Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Link.RequiredOperationId" />.
        /// </summary>
        public bool IsRequiredOperationId
        {
            get
            {
                return this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Link.RequiredOperationId>().IsValid();
            }
        }
        ...
        {
            return value.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Link.RequiredOperationRef>();
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Link(Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Link.RequiredOperationRef value)
        {
            return value.As<Link>();
        }
        ...
        {
            return value.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Link.RequiredOperationId>();
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Link(Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Link.RequiredOperationId value)
        {
            return value.As<Link>();
        }
        ...
        public static Link FromJson(in JsonElement value)
        {
            return new(value);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Link FromAny(in JsonAny value)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static Link IJsonValue<Link>.FromBoolean<TValue>(in TValue value)
        {
            if (value.HasJsonElementBacking)
            {
                return new(value.AsJsonElement);
        ...
        /// <returns>An instance of this type, initialized from the provided value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static Link IJsonValue<Link>.FromString<TValue>(in TValue value)
        {
            if (value.HasJsonElementBacking)
            {
                return new(value.AsJsonElement);
        ...
        /// <returns>An instance of this type, initialized from the provided value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static Link IJsonValue<Link>.FromNumber<TValue>(in TValue value)
        {
            if (value.HasJsonElementBacking)
            {
                return new(value.AsJsonElement);
        ...
        /// <returns>An instance of this type, initialized from the provided value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Link FromObject<TValue>(in TValue value)
        ...
        /// <returns>An instance of this type, initialized from the provided value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static Link IJsonValue<Link>.FromArray<TValue>(in TValue value)
        {
            if (value.HasJsonElementBacking)
            {
                return new(value.AsJsonElement);
        ...
        public static Link Parse(string source, JsonDocumentOptions options = default)
        {
        ...
        /// <param name="source">The source of the JSON string to parse.</param>
        /// <param name="options">The (optional) JsonDocumentOptions.</param>
        public static Link Parse(Stream source, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(source, options);
            return new(jsonDocument.RootElement.Clone());
        }
        ...
        /// <param name="source">The source of the JSON string to parse.</param>
        /// <param name="options">The (optional) JsonDocumentOptions.</param>
        public static Link Parse(ReadOnlyMemory<byte> source, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(source, options);
            return new(jsonDocument.RootElement.Clone());
        }
        ...
        /// <param name="source">The source of the JSON string to parse.</param>
        /// <param name="options">The (optional) JsonDocumentOptions.</param>
        public static Link Parse(ReadOnlyMemory<char> source, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(source, options);
            return new(jsonDocument.RootElement.Clone());
        }
        ...
        /// <param name="source">The source of the JSON string to parse.</param>
        /// <param name="options">The (optional) JsonDocumentOptions.</param>
        public static Link Parse(ReadOnlySequence<byte> source, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(source, options);
            return new(jsonDocument.RootElement.Clone());
        }
        ...
        /// </summary>
        /// <param name="source">The source of the JSON string to parse.</param>
        public static Link ParseValue(string source)
        {
#if NET8_0_OR_GREATER
            return IJsonValue<Link>.ParseValue(source);
#else
            return JsonValueHelpers.ParseValue<Link>(source.AsSpan());
#endif
        }
        ...
        /// </summary>
        /// <param name="source">The source of the JSON string to parse.</param>
        public static Link ParseValue(ReadOnlySpan<char> source)
        {
#if NET8_0_OR_GREATER
            return IJsonValue<Link>.ParseValue(source);
#else
            return JsonValueHelpers.ParseValue<Link>(source);
#endif
        }
        ...
        /// </summary>
        /// <param name="source">The source of the JSON string to parse.</param>
        public static Link ParseValue(ReadOnlySpan<byte> source)
        {
#if NET8_0_OR_GREATER
            return IJsonValue<Link>.ParseValue(source);
#else
        ...
        /// </summary>
        /// <param name="source">The source of the JSON string to parse.</param>
        public static Link ParseValue(ref Utf8JsonReader source)
        {
#if NET8_0_OR_GREATER
            return IJsonValue<Link>.ParseValue(ref source);
#else
            return JsonValueHelpers.ParseValue<Link>(ref source);
#endif
        }
        ...
        {
            return
                (obj is IJsonValue jv && this.Equals(jv.As<Link>())) ||
        ...
        {
            return this.Equals(other.As<Link>());
        }
        ...
        {
            result = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Link.RequiredOperationRef>();
        ...
        {
            result = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Link.RequiredOperationId>();
            return result.IsValid();
        }
