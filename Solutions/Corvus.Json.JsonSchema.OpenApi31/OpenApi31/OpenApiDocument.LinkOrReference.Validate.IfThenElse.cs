...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct LinkOrReference
    {
        private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext ifResult = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.LinkOrReference.RequiredRef>().Validate(validationContext.CreateChildContext(), level);
            if (!ifResult.IsValid)
            {
            ...
            if (!ifResult.IsValid)
            {
                ...
                ValidationContext elseResult = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Link>().Validate(validationContext.CreateChildContext(), level);
