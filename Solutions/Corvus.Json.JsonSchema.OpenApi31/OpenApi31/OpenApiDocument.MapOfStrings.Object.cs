...
public readonly partial struct OpenApiDocument
{
    ...
    /// </summary>
    public readonly partial struct MapOfStrings : IJsonObject<MapOfStrings>, IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonString>
    {
        /// <summary>
    ...
    static MapOfStrings IJsonObject<MapOfStrings>.FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
        ...
        /// <inheritdoc/>
        bool IJsonObject<MapOfStrings>.TryGetProperty(ReadOnlySpan<byte> utf8Name, out JsonAny value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        bool IJsonObject<MapOfStrings>.TryGetProperty<TValue>(ReadOnlySpan<byte> utf8Name, out TValue value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.TryGetProperty(utf8Name, out JsonElement result))
        ...
        public MapOfStrings SetProperty(in JsonPropertyName name, in Corvus.Json.JsonString value)
        {
            return new(this.GetPropertyBackingWith(name, value.AsAny));
        }
        ...
        /// <inheritdoc/>
        public MapOfStrings RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
