...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct OauthFlows
    {
        ...
        /// </summary>
        public readonly partial struct AuthorizationCodeEntity : IJsonObject<AuthorizationCodeEntity>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "AuthorizationCodeEntity"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public AuthorizationCodeEntity(ImmutableList<JsonObjectProperty> value)
            {
            ...
            public static implicit operator AuthorizationCodeEntity(JsonObject value)
            {
            ...
            public static AuthorizationCodeEntity FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
            {
            ...
            /// <param name = "source">The dictionary of properties.</param>
            /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
            public static AuthorizationCodeEntity FromProperties(ImmutableList<JsonObjectProperty> source)
            {
                return new(source);
            }
            ...
            /// <param name = "source">The dictionary of properties.</param>
            /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
            public static AuthorizationCodeEntity FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
            {
            ...
            /// <inheritdoc/>
            public AuthorizationCodeEntity SetProperty<TValue>(in JsonPropertyName name, TValue value)
            ...
            /// <inheritdoc/>
            public AuthorizationCodeEntity RemoveProperty(in JsonPropertyName name)
            {
                return new(this.GetPropertyBackingWithout(name));
            }

            /// <inheritdoc/>
            public AuthorizationCodeEntity RemoveProperty(string name)
            {
                return new(this.GetPropertyBackingWithout(name));
            }

            /// <inheritdoc/>
            public AuthorizationCodeEntity RemoveProperty(ReadOnlySpan<char> name)
            {
                return new(this.GetPropertyBackingWithout(name));
            }

            /// <inheritdoc/>
            public AuthorizationCodeEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
            {
