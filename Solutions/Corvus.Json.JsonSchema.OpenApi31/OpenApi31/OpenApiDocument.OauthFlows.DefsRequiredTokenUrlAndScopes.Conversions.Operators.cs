...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct OauthFlows
    {
        ...
        public readonly partial struct DefsRequiredTokenUrlAndScopes
        {
            ...
            public static implicit operator Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SpecificationExtensions(DefsRequiredTokenUrlAndScopes value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static explicit operator DefsRequiredTokenUrlAndScopes(Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SpecificationExtensions value)
            {
