...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct OauthFlows
    {
        ...
        /// </summary>
        public readonly partial struct DefsRequiredTokenUrlAndScopes : IJsonObject<DefsRequiredTokenUrlAndScopes>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "DefsRequiredTokenUrlAndScopes"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public DefsRequiredTokenUrlAndScopes(ImmutableList<JsonObjectProperty> value)
            {
            ...
            public static implicit operator DefsRequiredTokenUrlAndScopes(JsonObject value)
            {
            ...
            public static DefsRequiredTokenUrlAndScopes FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
            {
            ...
            /// <param name = "source">The dictionary of properties.</param>
            /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
            public static DefsRequiredTokenUrlAndScopes FromProperties(ImmutableList<JsonObjectProperty> source)
            {
                return new(source);
            }
            ...
            /// <param name = "source">The dictionary of properties.</param>
            /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
            public static DefsRequiredTokenUrlAndScopes FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
            {
            ...
            /// <inheritdoc/>
            public DefsRequiredTokenUrlAndScopes SetProperty<TValue>(in JsonPropertyName name, TValue value)
            ...
            /// <inheritdoc/>
            public DefsRequiredTokenUrlAndScopes RemoveProperty(in JsonPropertyName name)
            {
                return new(this.GetPropertyBackingWithout(name));
            }

            /// <inheritdoc/>
            public DefsRequiredTokenUrlAndScopes RemoveProperty(string name)
            {
                return new(this.GetPropertyBackingWithout(name));
            }

            /// <inheritdoc/>
            public DefsRequiredTokenUrlAndScopes RemoveProperty(ReadOnlySpan<char> name)
            {
                return new(this.GetPropertyBackingWithout(name));
            }

            /// <inheritdoc/>
            public DefsRequiredTokenUrlAndScopes RemoveProperty(ReadOnlySpan<byte> utf8Name)
            {
