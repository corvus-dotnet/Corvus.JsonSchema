...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct OauthFlows
    {
        ...
        public readonly partial struct OauthFlowsRequiredTokenUrlAndScopes
        {
            ...
            public static implicit operator Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SpecificationExtensions(OauthFlowsRequiredTokenUrlAndScopes value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static explicit operator OauthFlowsRequiredTokenUrlAndScopes(Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SpecificationExtensions value)
            {
