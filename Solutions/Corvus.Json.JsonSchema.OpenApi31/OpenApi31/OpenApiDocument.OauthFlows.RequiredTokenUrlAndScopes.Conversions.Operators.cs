...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct OauthFlows
    {
        ...
        public readonly partial struct RequiredTokenUrlAndScopes
        {
            ...
            public static implicit operator Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SpecificationExtensions(RequiredTokenUrlAndScopes value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static explicit operator RequiredTokenUrlAndScopes(Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SpecificationExtensions value)
            {
