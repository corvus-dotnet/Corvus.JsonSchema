...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct OauthFlows
    {
        ...
        /// </summary>
        public readonly partial struct RequiredTokenUrlAndScopes : IJsonObject<RequiredTokenUrlAndScopes>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "RequiredTokenUrlAndScopes"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public RequiredTokenUrlAndScopes(ImmutableList<JsonObjectProperty> value)
            {
            ...
            public static implicit operator RequiredTokenUrlAndScopes(JsonObject value)
            {
            ...
            public static RequiredTokenUrlAndScopes FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
            {
            ...
            /// <param name = "source">The dictionary of properties.</param>
            /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
            public static RequiredTokenUrlAndScopes FromProperties(ImmutableList<JsonObjectProperty> source)
            {
                return new(source);
            }
            ...
            /// <param name = "source">The dictionary of properties.</param>
            /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
            public static RequiredTokenUrlAndScopes FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
            {
            ...
            /// <inheritdoc/>
            public RequiredTokenUrlAndScopes SetProperty<TValue>(in JsonPropertyName name, TValue value)
            ...
            /// <inheritdoc/>
            public RequiredTokenUrlAndScopes RemoveProperty(in JsonPropertyName name)
            {
                return new(this.GetPropertyBackingWithout(name));
            }

            /// <inheritdoc/>
            public RequiredTokenUrlAndScopes RemoveProperty(string name)
            {
                return new(this.GetPropertyBackingWithout(name));
            }

            /// <inheritdoc/>
            public RequiredTokenUrlAndScopes RemoveProperty(ReadOnlySpan<char> name)
            {
                return new(this.GetPropertyBackingWithout(name));
            }

            /// <inheritdoc/>
            public RequiredTokenUrlAndScopes RemoveProperty(ReadOnlySpan<byte> utf8Name)
            {
