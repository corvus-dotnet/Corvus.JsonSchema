...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct OpenApiDocumentContentEntity
        : IJsonObject<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.OpenApiDocumentContentEntity>,
          IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.MediaType>
    {
        ...
        public static implicit operator OpenApiDocumentContentEntity(ImmutableList<JsonObjectProperty> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonObjectProperty>(OpenApiDocumentContentEntity value)
        {
            return
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator OpenApiDocumentContentEntity(JsonObject value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonObject(OpenApiDocumentContentEntity value)
        {
            return
                value.AsObject;
        }
        ...
        /// <inheritdoc/>
        JsonAny IJsonObject<OpenApiDocumentContentEntity>.this[in JsonPropertyName name]
        {
            get
            {
        ...
        /// <inheritdoc/>
        static OpenApiDocumentContentEntity IJsonObject<OpenApiDocumentContentEntity>.FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
            return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
        }

        /// <inheritdoc/>
        static OpenApiDocumentContentEntity IJsonObject<OpenApiDocumentContentEntity>.FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        public static OpenApiDocumentContentEntity FromProperties(IDictionary<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.MediaType> source)
        {
        ...
        public static OpenApiDocumentContentEntity FromProperties(params (JsonPropertyName Name, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.MediaType Value)[] source)
        {
        ...
        public static OpenApiDocumentContentEntity FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <inheritdoc/>
        JsonObjectEnumerator IJsonObject<OpenApiDocumentContentEntity>.EnumerateObject()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc />
        bool IJsonObject<OpenApiDocumentContentEntity>.TryGetProperty(in JsonPropertyName name, out JsonAny value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc />
        bool IJsonObject<OpenApiDocumentContentEntity>.TryGetProperty(string name, out JsonAny value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.ValueKind != JsonValueKind.Object)
        ...
        /// <inheritdoc />
        bool IJsonObject<OpenApiDocumentContentEntity>.TryGetProperty(ReadOnlySpan<char> name, out JsonAny value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.ValueKind != JsonValueKind.Object)
        ...
        /// <inheritdoc />
        bool IJsonObject<OpenApiDocumentContentEntity>.TryGetProperty(ReadOnlySpan<byte> name, out JsonAny value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.ValueKind != JsonValueKind.Object)
        ...
        /// <inheritdoc />
        bool IJsonObject<OpenApiDocumentContentEntity>.TryGetProperty<TValue>(in JsonPropertyName name, out TValue value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.ValueKind != JsonValueKind.Object)
        ...
        /// <inheritdoc />
        bool IJsonObject<OpenApiDocumentContentEntity>.TryGetProperty<TValue>(string name, out TValue value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.ValueKind != JsonValueKind.Object)
        ...
        /// <inheritdoc />
        bool IJsonObject<OpenApiDocumentContentEntity>.TryGetProperty<TValue>(ReadOnlySpan<char> name, out TValue value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.ValueKind != JsonValueKind.Object)
        ...
        /// <inheritdoc />
        bool IJsonObject<OpenApiDocumentContentEntity>.TryGetProperty<TValue>(ReadOnlySpan<byte> name, out TValue value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.ValueKind != JsonValueKind.Object)
        ...
        /// <inheritdoc />
OpenApiDocumentContentEntity IJsonObject<OpenApiDocumentContentEntity>.SetProperty<TValue>(in JsonPropertyName name, TValue value)
        {
        ...
        public OpenApiDocumentContentEntity SetProperty(in JsonPropertyName name, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.MediaType value)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWith(this, name, value.AsAny));
        }

        /// <inheritdoc />
        public OpenApiDocumentContentEntity RemoveProperty(in JsonPropertyName name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }

        /// <inheritdoc />
        public OpenApiDocumentContentEntity RemoveProperty(string name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }

        /// <inheritdoc />
        public OpenApiDocumentContentEntity RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }

        /// <inheritdoc />
        public OpenApiDocumentContentEntity RemoveProperty(ReadOnlySpan<byte> name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }
        ...
        private static class __CorvusObjectHelpers
        {
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in OpenApiDocumentContentEntity that)
            {
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in OpenApiDocumentContentEntity that, in JsonPropertyName name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
            ...
            /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in OpenApiDocumentContentEntity that, ReadOnlySpan<char> name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
                    return that.objectBacking.Remove(name);
            ...
            /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in OpenApiDocumentContentEntity that, ReadOnlySpan<byte> name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
                    return that.objectBacking.Remove(name);
            ...
            /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in OpenApiDocumentContentEntity that, string name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
                    return that.objectBacking.Remove(name);
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in OpenApiDocumentContentEntity that, in JsonPropertyName name, in JsonAny value)
            {
                if ((that.backing & Backing.Object) != 0)
                {
