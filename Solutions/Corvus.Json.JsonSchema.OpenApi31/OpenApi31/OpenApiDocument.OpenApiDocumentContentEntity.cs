...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct OpenApiDocumentContentEntity
    {
        ...
        public static implicit operator OpenApiDocumentContentEntity(in JsonAny value)
        {
        ...
        /// <param name = "value">The value from which to convert.</param>
        /// <exception cref = "InvalidOperationException">The value was not compatible with this type.</exception>
        public static implicit operator JsonAny(in OpenApiDocumentContentEntity value)
        {
            return value.AsAny;
        }
    ...
    /// <remarks>This will be OpenApiDocumentContentEntity.Undefined if the type is not compatible.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    static OpenApiDocumentContentEntity IJsonValue<OpenApiDocumentContentEntity>.FromArray<TValue>(in TValue value)
    {
        ...
        /// <summary>
        /// Parses a JSON string into a OpenApiDocumentContentEntity.
        /// </summary>
        /// <param name = "json">The json string to parse.</param>
        /// <param name = "options">The (optional) JsonDocumentOptions.</param>
        /// <returns>A <see cref = "OpenApiDocumentContentEntity"/> instance built from the JSON string.</returns>
        public static OpenApiDocumentContentEntity Parse(string json, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(json, options);
            return new OpenApiDocumentContentEntity(jsonDocument.RootElement.Clone());
        }
        ...
        /// <param name = "options">The (optional) JsonDocumentOptions.</param>
        /// <returns>A <see cref = "OpenApiDocumentContentEntity"/> instance built from the JSON string.</returns>
        public static OpenApiDocumentContentEntity Parse(Stream utf8Json, JsonDocumentOptions options = default)
        {
        ...
        /// <param name = "options">The (optional) JsonDocumentOptions.</param>
        /// <returns>A <see cref = "OpenApiDocumentContentEntity"/> instance built from the JSON string.</returns>
        public static OpenApiDocumentContentEntity Parse(ReadOnlyMemory<byte> utf8Json, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(utf8Json, options);
            return new OpenApiDocumentContentEntity(jsonDocument.RootElement.Clone());
        }
        ...
        /// <param name = "options">The (optional) JsonDocumentOptions.</param>
        /// <returns>A <see cref = "OpenApiDocumentContentEntity"/> instance built from the JSON string.</returns>
        public static OpenApiDocumentContentEntity Parse(ReadOnlyMemory<char> json, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(json, options);
            return new OpenApiDocumentContentEntity(jsonDocument.RootElement.Clone());
        }
        ...
        /// <param name = "options">The (optional) JsonDocumentOptions.</param>
        /// <returns>A <see cref = "OpenApiDocumentContentEntity"/> instance built from the JSON string.</returns>
        public static OpenApiDocumentContentEntity Parse(ReadOnlySequence<byte> utf8Json, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(utf8Json, options);
            return new OpenApiDocumentContentEntity(jsonDocument.RootElement.Clone());
        }
        ...
        static OpenApiDocumentContentEntity ParseValue(ReadOnlySpan<char> buffer)
        {
#if NET8_0_OR_GREATER
        return IJsonValue<OpenApiDocumentContentEntity>.ParseValue(buffer);
#else
            return JsonValueHelpers.ParseValue<OpenApiDocumentContentEntity>(buffer);
#endif
        }
        ...
        /// <param name = "buffer">The buffer from which to parse the value.</param>
        /// <returns>The parsed value.</returns>
        static OpenApiDocumentContentEntity ParseValue(ReadOnlySpan<byte> buffer)
        {
#if NET8_0_OR_GREATER
        return IJsonValue<OpenApiDocumentContentEntity>.ParseValue(buffer);
#else
        ...
        /// <returns>The parsed value.</returns>
        static OpenApiDocumentContentEntity ParseValue(ref Utf8JsonReader reader)
        {
#if NET8_0_OR_GREATER
        return IJsonValue<OpenApiDocumentContentEntity>.ParseValue(ref reader);
#else
            return JsonValueHelpers.ParseValue<OpenApiDocumentContentEntity>(ref reader);
#endif
        }
