...
public readonly partial struct OpenApiDocument
{
    ...
    /// </summary>
    public readonly partial struct OpenApiDocumentHeadersEntity : IJsonObject<OpenApiDocumentHeadersEntity>, IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.HeaderOrReference>
    {
        /// <summary>
    ...
    static OpenApiDocumentHeadersEntity IJsonObject<OpenApiDocumentHeadersEntity>.FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
        ...
        /// <inheritdoc/>
        bool IJsonObject<OpenApiDocumentHeadersEntity>.TryGetProperty(ReadOnlySpan<byte> utf8Name, out JsonAny value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        bool IJsonObject<OpenApiDocumentHeadersEntity>.TryGetProperty<TValue>(ReadOnlySpan<byte> utf8Name, out TValue value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.TryGetProperty(utf8Name, out JsonElement result))
        ...
        public OpenApiDocumentHeadersEntity SetProperty(in JsonPropertyName name, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.HeaderOrReference value)
        {
            return new(this.GetPropertyBackingWith(name, value.AsAny));
        }
        ...
        /// <inheritdoc/>
        public OpenApiDocumentHeadersEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
