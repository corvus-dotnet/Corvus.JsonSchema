...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct Operation
    {
        ...
        public readonly partial struct ParameterOrReferenceArray
        {
            ...
            ParameterOrReferenceArray IJsonArray<ParameterOrReferenceArray>.Remove(in JsonAny item1)
            {
            ...
            public ParameterOrReferenceArray Remove(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference item)
            {
            ...
            /// <inheritdoc/>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public ParameterOrReferenceArray RemoveAt(int index)
            {
            ...
            /// <inheritdoc/>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public ParameterOrReferenceArray RemoveRange(int index, int count)
            {
