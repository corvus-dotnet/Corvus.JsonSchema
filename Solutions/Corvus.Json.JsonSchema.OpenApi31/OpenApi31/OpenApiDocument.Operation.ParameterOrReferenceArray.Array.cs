...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct Operation
    {
        ...
        /// </summary>
#if NET8_0_OR_GREATER
        [CollectionBuilder(typeof(ParameterOrReferenceArray), "Create")]
#endif
        public readonly partial struct ParameterOrReferenceArray
            : IJsonArray<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Operation.ParameterOrReferenceArray>,
              IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference>
        {
            /// <summary>
            /// Gets an empty array.
            /// </summary>
            public static ParameterOrReferenceArray EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
            ...
            /// <inheritdoc/>
            Corvus.Json.JsonAny IJsonArray<ParameterOrReferenceArray>.this[int index]
            {
                get
                {
            ...
            public static implicit operator ParameterOrReferenceArray(ImmutableList<JsonAny> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ImmutableList<JsonAny>(ParameterOrReferenceArray value)
            {
                return
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ParameterOrReferenceArray(JsonArray value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonArray(ParameterOrReferenceArray value)
            {
                return
                    value.AsArray;
            }
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ParameterOrReferenceArray"/> struct.
            /// </summary>
            ...
            public static ParameterOrReferenceArray From(ImmutableList<JsonAny> items)
            {
                return new(items);
            }

            /// <summary>
            /// Create an new instance of the <see cref="ParameterOrReferenceArray"/>" struct from a span of items.
            /// </summary>
            ...
            public static ParameterOrReferenceArray Create(ReadOnlySpan<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference> items)            {
                return new([..items]);
            }
            ...
            public static ParameterOrReferenceArray FromItems(params Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference[] items)
            {
                return new([..items]);
            }
            ...
            public static ParameterOrReferenceArray FromItems(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference item1)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static ParameterOrReferenceArray FromItems(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference item1, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference item2)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static ParameterOrReferenceArray FromItems(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference item1, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference item2, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference item3)
            {
            ...
            public static ParameterOrReferenceArray FromRange(IEnumerable<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference> items)
            {
                return new([..items]);
            }
            ...
            /// <param name="items">The items from which to construct the instance.</param>
            /// <returns>An instance of the array constructed from the items .</returns>
            static ParameterOrReferenceArray IJsonArray<ParameterOrReferenceArray>.FromRange(IEnumerable<JsonAny> items)
            {
                return new([..items]);
            }
            ...
            /// <param name="items">The items from which to construct the instance.</param>
            /// <returns>An instance of the array constructed from the items.</returns>
            static ParameterOrReferenceArray IJsonArray<ParameterOrReferenceArray>.FromRange<T>(IEnumerable<T> items)
            {
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator IJsonArray<ParameterOrReferenceArray>.EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new(this.jsonElementBacking);
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator<TItem> IJsonArray<ParameterOrReferenceArray>.EnumerateArray<TItem>()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new(this.jsonElementBacking);
            ...
            /// <inheritdoc/>
            ParameterOrReferenceArray IJsonArray<ParameterOrReferenceArray>.Add(in JsonAny item1)
            {
            ...
            /// <inheritdoc/>
            ParameterOrReferenceArray IJsonArray<ParameterOrReferenceArray>.Add(params JsonAny[] items)
            {
                return new([..items]);
            }

            /// <inheritdoc/>
            ParameterOrReferenceArray IJsonArray<ParameterOrReferenceArray>.AddRange<TArray>(in TArray items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            ParameterOrReferenceArray IJsonArray<ParameterOrReferenceArray>.AddRange<TItem>(IEnumerable<TItem> items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            ParameterOrReferenceArray IJsonArray<ParameterOrReferenceArray>.AddRange(IEnumerable<JsonAny> items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            ParameterOrReferenceArray IJsonArray<ParameterOrReferenceArray>.Insert(int index, in JsonAny item1)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
            }

            /// <inheritdoc/>
            ParameterOrReferenceArray IJsonArray<ParameterOrReferenceArray>.InsertRange<TArray>(int index, in TArray items)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.EnumerateArray()));
            }

            /// <inheritdoc/>
            ParameterOrReferenceArray IJsonArray<ParameterOrReferenceArray>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
            }

            /// <inheritdoc/>
            ParameterOrReferenceArray IJsonArray<ParameterOrReferenceArray>.InsertRange(int index, IEnumerable<JsonAny> items)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
            }

            /// <inheritdoc/>
            ParameterOrReferenceArray IJsonArray<ParameterOrReferenceArray>.Replace(in JsonAny oldValue, in JsonAny newValue)
            {
                return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
            }

            /// <inheritdoc/>
            ParameterOrReferenceArray IJsonArray<ParameterOrReferenceArray>.SetItem(int index, in JsonAny value)
            {
                return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
            }

            /// <inheritdoc/>
            public ParameterOrReferenceArray Add(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference item1)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            public ParameterOrReferenceArray Add(params Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference[] items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            public ParameterOrReferenceArray AddRange(IEnumerable<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference> items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                foreach (Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference item in items)
                {
            ...
            /// <inheritdoc/>
            public ParameterOrReferenceArray Insert(int index, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference item1)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
            }

            /// <inheritdoc/>
            public ParameterOrReferenceArray InsertRange(int index, IEnumerable<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference> items)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
            }

            /// <inheritdoc/>
            public ParameterOrReferenceArray Replace(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference oldValue, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference newValue)
            {
                return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
            }

            /// <inheritdoc/>
            public ParameterOrReferenceArray SetItem(int index, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference value)
            {
                return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
            }

            /// <inheritdoc/>
            ParameterOrReferenceArray IJsonArray<ParameterOrReferenceArray>.Remove(in JsonAny oldValue)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
            }

            /// <inheritdoc/>
            ParameterOrReferenceArray IJsonArray<ParameterOrReferenceArray>.RemoveAt(int index)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
            }

            /// <inheritdoc/>
            ParameterOrReferenceArray IJsonArray<ParameterOrReferenceArray>.RemoveRange(int index, int count)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, count));
            }

            /// <inheritdoc/>
            public ParameterOrReferenceArray Remove(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference oldValue)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
            }
            ...
            private static class __CorvusArrayHelpers
            {
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny> GetImmutableList(in ParameterOrReferenceArray arrayInstance)
                {
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in ParameterOrReferenceArray arrayInstance)
                {
                ...
                public static ImmutableList<JsonAny> GetImmutableListSetting(in ParameterOrReferenceArray arrayInstance, int index, in JsonAny value)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListReplacing(in ParameterOrReferenceArray arrayInstance, in JsonAny oldItem, in JsonAny newItem)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWithout(in ParameterOrReferenceArray arrayInstance, in JsonAny item)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in ParameterOrReferenceArray arrayInstance, int index, int count)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                // <exception cref = "InvalidOperationException">The value is not an array.</exception>
                // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWith(in ParameterOrReferenceArray arrayInstance, int index, in JsonAny value)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in ParameterOrReferenceArray arrayInstance, int index, TEnumerable values)
