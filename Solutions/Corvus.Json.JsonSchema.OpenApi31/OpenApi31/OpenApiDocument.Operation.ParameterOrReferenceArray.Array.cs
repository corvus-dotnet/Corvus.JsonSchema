...
public readonly partial struct ParameterOrReferenceArray : IJsonArray<ParameterOrReferenceArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference>
#else
        public readonly partial struct ParameterOrReferenceArray : IJsonArray<ParameterOrReferenceArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference>
#endif
        {
            ...
            /// Gets an empty array.
            /// </summary>
            public static readonly ParameterOrReferenceArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
            /// <summary>
            ...
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public ParameterOrReferenceArray(IEnumerable<JsonAny> value)
            {
                this.jsonElementBacking = default;
                this.backing = Backing.Array;
            ...
            /// <inheritdoc/>
            JsonAny IJsonArray<ParameterOrReferenceArray>.this[int index]
            {
                get
                {
            ...
            public Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference this[int index]
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        return new Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference(this.jsonElementBacking[index]);
                    }
            ...
            /// <returns>A ParameterOrReferenceArray instantiated from the given items.</returns>
            public static ParameterOrReferenceArray FromItems(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference value1)
            {
            ...
            /// <returns>A ParameterOrReferenceArray instantiated from the given items.</returns>
            public static ParameterOrReferenceArray FromItems(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference value1, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference value2)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
            ...
            /// <returns>A ParameterOrReferenceArray instantiated from the given items.</returns>
            public static ParameterOrReferenceArray FromItems(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference value1, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference value2, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference value3)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
                builder.Add(value2.AsAny);
            ...
            public static ParameterOrReferenceArray FromItems(params Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference[] value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference item in value)
                {
            ...
            /// <param name = "value">The value from which to construct the instance.</param>
            /// <returns>A JsonAny instantiated from the given items.</returns>
            public static ParameterOrReferenceArray FromRange(IEnumerable<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference> value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference item in value)
                {
            ...
            /// </remarks>
            public static ParameterOrReferenceArray From<T>(IEnumerable<T> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                ...
                return new ParameterOrReferenceArray(builder.ToImmutable());
            }
            ...
            /// <param name = "items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static ParameterOrReferenceArray FromRange(IEnumerable<JsonAny> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// <param name = "items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static ParameterOrReferenceArray FromRange<T>(IEnumerable<T> items)
            ...
            /// <inheritdoc/>
            IEnumerator<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference> IEnumerable<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference>.GetEnumerator()
            {
            ...
            public JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference> EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference>(this.jsonElementBacking);
                }

                if ((this.backing & Backing.Array) != 0)
                {
                    return new JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference>(this.arrayBacking);
                }
