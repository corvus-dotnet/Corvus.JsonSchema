...
public readonly partial struct SecurityRequirementArray : IJsonArray<SecurityRequirementArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityRequirement>
#else
        public readonly partial struct SecurityRequirementArray : IJsonArray<SecurityRequirementArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityRequirement>
#endif
        {
            ...
            public Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityRequirement this[int index]
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        return new Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityRequirement(this.jsonElementBacking[index]);
                    }
            ...
            public static SecurityRequirementArray FromItems(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityRequirement value1)
            {
            ...
            /// <returns>A SecurityRequirementArray instantiated from the given items.</returns>
            public static SecurityRequirementArray FromItems(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityRequirement value1, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityRequirement value2)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
            ...
            /// <returns>A SecurityRequirementArray instantiated from the given items.</returns>
            public static SecurityRequirementArray FromItems(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityRequirement value1, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityRequirement value2, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityRequirement value3)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
                builder.Add(value2.AsAny);
            ...
            public static SecurityRequirementArray FromItems(params Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityRequirement[] value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityRequirement item in value)
                {
            ...
            /// <param name = "value">The value from which to construct the instance.</param>
            /// <returns>A JsonAny instantiated from the given items.</returns>
            public static SecurityRequirementArray FromRange(IEnumerable<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityRequirement> value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityRequirement item in value)
                {
            ...
            /// <inheritdoc/>
            IEnumerator<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityRequirement> IEnumerable<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityRequirement>.GetEnumerator()
            {
            ...
            public JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityRequirement> EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityRequirement>(this.jsonElementBacking);
                }

                if ((this.backing & Backing.Array) != 0)
                {
                    return new JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityRequirement>(this.arrayBacking);
                }
