    ...
    public readonly partial struct Parameter
    {
        ...
        public readonly partial struct RequiredIn
        {
            ...
            public Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.RequiredIn.InEntity In
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        ...
                        {
                            return new Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.RequiredIn.InEntity(result);
                        }
                    }
            ...
            public static RequiredIn Create()
            {
                ...
                builder.Add(JsonPropertyNames.In, new Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.RequiredIn.InEntity().AsAny);
            ...
            {
                return property.ValueAs<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.RequiredIn.InEntity>().Validate(validationContext, level);
            }
