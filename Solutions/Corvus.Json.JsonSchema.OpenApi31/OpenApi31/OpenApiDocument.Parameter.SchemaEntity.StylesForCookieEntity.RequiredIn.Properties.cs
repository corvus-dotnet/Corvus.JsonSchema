        ...
        public readonly partial struct SchemaEntity
        {
            public readonly partial struct StylesForCookieEntity
            {
                ...
                public readonly partial struct RequiredIn
                {
                    ...
                    /// </summary>
                    public Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.SchemaEntity.StylesForCookieEntity.RequiredIn.InEntity In
                    {
                        get
                        {
                            if ((this.backing & Backing.JsonElement) != 0)
                            {
                                ...
                                {
                                    return new Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.SchemaEntity.StylesForCookieEntity.RequiredIn.InEntity(result);
                                }
                            }
                            ...
                            if ((this.backing & Backing.Object) != 0)
                            {
                                ...
                                {
                                    return result.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.SchemaEntity.StylesForCookieEntity.RequiredIn.InEntity>();
                                }
                            }
                    ...
                    public static RequiredIn Create()
                    {
                        ...
                        builder.Add(JsonPropertyNames.In, new Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.SchemaEntity.StylesForCookieEntity.RequiredIn.InEntity().AsAny);
                    ...
                    {
                        return property.ValueAs<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.SchemaEntity.StylesForCookieEntity.RequiredIn.InEntity>().Validate(validationContext, level);
                    }
