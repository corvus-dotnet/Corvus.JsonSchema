    ...
    public readonly partial struct Parameter
    {
        public readonly partial struct SchemaEntity
        {
            ...
            public readonly partial struct StylesForFormEntity
            {
                ...
                public static explicit operator Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.SchemaEntity.StylesForFormEntity.ThenEntity(StylesForFormEntity value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static explicit operator StylesForFormEntity(Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.SchemaEntity.StylesForFormEntity.ThenEntity value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static explicit operator Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.SchemaEntity.StylesForFormEntity.ElseEntity(StylesForFormEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                        return new(value.AsJsonElement);
                ...
                /// </summary>
                /// <param name = "value">The value from which to convert.</param>
                public static explicit operator StylesForFormEntity(Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.SchemaEntity.StylesForFormEntity.ElseEntity value)
                {
                    if (value.HasJsonElementBacking)
                    {
                        return new(value.AsJsonElement);
