...
[CollectionBuilder(typeof(DefaultValuefalse), "Create")]
public readonly partial struct DefaultValuefalse : IJsonArray<DefaultValuefalse>, IReadOnlyCollection<JsonAny>
#else
                    public readonly partial struct DefaultValuefalse : IJsonArray<DefaultValuefalse>, IReadOnlyCollection<JsonAny>
#endif
                    {
                        ...
                        /// Gets an empty array.
                        /// </summary>
                        public static readonly DefaultValuefalse EmptyArray = From(ImmutableList<JsonAny>.Empty);
                        /// <summary>
                        /// Initializes a new instance of the <see cref = "DefaultValuefalse"/> struct.
                        /// </summary>
                        /// <param name = "value">The value from which to construct the instance.</param>
                        public DefaultValuefalse(ImmutableList<JsonAny> value)
                        {
                        ...
                        /// </summary>
                        /// <param name = "value">The value from which to construct the instance.</param>
                        public DefaultValuefalse(IEnumerable<JsonAny> value)
                        {
                            this.jsonElementBacking = default;
                            this.backing = Backing.Array;
                            this.stringBacking = string.Empty;
                        ...
                        public static implicit operator ImmutableList<JsonAny>(DefaultValuefalse value)
                        {
                        ...
                        /// </summary>
                        /// <param name = "value">The value from which to convert.</param>
                        public static implicit operator DefaultValuefalse(ImmutableList<JsonAny> value)
                        {
                            return new(value);
                        }
                        ...
                        /// </summary>
                        /// <param name = "value">The value from which to convert.</param>
                        public static implicit operator DefaultValuefalse(JsonArray value)
                        {
                        ...
                        public static DefaultValuefalse From(ImmutableList<JsonAny> items)
                        {
                            return new(items);
                        }
                        ...
                        public static DefaultValuefalse Create(ReadOnlySpan<JsonAny> items)
                        {
                            return new([..items]);
                        }
                        ...
                        public static DefaultValuefalse FromItems(params JsonAny[] value)
                        {
                        ...
                        /// <param name = "value">The value from which to construct the instance.</param>
                        /// <returns>A DefaultValuefalse instantiated from the given items.</returns>
                        public static DefaultValuefalse FromItems<TItem>(params TItem[] value)
                        ...
                        /// <returns>A DefaultValuefalse instantiated from the given items.</returns>
                        public static DefaultValuefalse FromItems<TItem1>(in TItem1 value1)
                        ...
                        /// <returns>A DefaultValuefalse instantiated from the given items.</returns>
                        public static DefaultValuefalse FromItems<TItem1, TItem2>(in TItem1 value1, in TItem2 value2)
                        ...
                        /// <returns>A DefaultValuefalse instantiated from the given items.</returns>
                        public static DefaultValuefalse FromItems<TItem1, TItem2, TItem3>(in TItem1 value1, in TItem2 value2, in TItem3 value3)
                        ...
                        /// </remarks>
                        public static DefaultValuefalse From<T>(IEnumerable<T> items)
                        {
                            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                            ...
                            return new DefaultValuefalse(builder.ToImmutable());
                        }
                        ...
                        /// other overloads which avoid this serialization step.
                        /// </remarks>
                        public static DefaultValuefalse FromRange(IEnumerable<JsonAny> items)
                        {
                            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                        ...
                        /// other overloads which avoid this serialization step.
                        /// </remarks>
                        public static DefaultValuefalse FromRange<T>(IEnumerable<T> items)
                        ...
                        /// <param name = "items">The items from which to create the array.</param>
                        /// <returns>The new array created from the items.</returns>
                        public static DefaultValuefalse FromRange(IEnumerable<string> items)
                        {
                            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                        ...
                        /// <param name = "items">The items from which to create the array.</param>
                        /// <returns>The new array created from the items.</returns>
                        public static DefaultValuefalse FromRange(IEnumerable<double> items)
                        {
                            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                        ...
                        /// <param name = "items">The items from which to create the array.</param>
                        /// <returns>The new array created from the items.</returns>
                        public static DefaultValuefalse FromRange(IEnumerable<float> items)
                        {
                            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                        ...
                        /// <param name = "items">The items from which to create the array.</param>
                        /// <returns>The new array created from the items.</returns>
                        public static DefaultValuefalse FromRange(IEnumerable<int> items)
                        {
                            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                        ...
                        /// <param name = "items">The items from which to create the array.</param>
                        /// <returns>The new array created from the items.</returns>
                        public static DefaultValuefalse FromRange(IEnumerable<long> items)
                        {
                            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                        ...
                        /// <param name = "items">The items from which to create the array.</param>
                        /// <returns>The new array created from the items.</returns>
                        public static DefaultValuefalse FromRange(IEnumerable<bool> items)
                        {
                            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                        ...
                        /// <param name = "value1">The first value from which to construct the instance.</param>
                        /// <returns>A DefaultValuefalse instantiated from the given items.</returns>
                        public static DefaultValuefalse FromItems(in JsonAny value1)
                        {
                            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                            builder.Add(value1);
                            return new(builder.ToImmutable());
                        ...
                        /// <param name = "value2">The second value from which to construct the instance.</param>
                        /// <returns>A DefaultValuefalse instantiated from the given items.</returns>
                        public static DefaultValuefalse FromItems(in JsonAny value1, in JsonAny value2)
                        {
                            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                            builder.Add(value1);
                            builder.Add(value2);
                        ...
                        /// <param name = "value3">The thirdvalue from which to construct the instance.</param>
                        /// <returns>A DefaultValuefalse instantiated from the given items.</returns>
                        public static DefaultValuefalse FromItems(in JsonAny value1, in JsonAny value2, in JsonAny value3)
                        {
                            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                            builder.Add(value1);
                            builder.Add(value2);
