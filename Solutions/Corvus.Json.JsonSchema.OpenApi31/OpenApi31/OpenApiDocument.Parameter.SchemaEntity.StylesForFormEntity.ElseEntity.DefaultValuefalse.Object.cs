        ...
        public readonly partial struct SchemaEntity
        {
            public readonly partial struct StylesForFormEntity
            {
                public readonly partial struct ElseEntity
                {
                    ...
                    /// </summary>
                    public readonly partial struct DefaultValuefalse : IJsonObject<DefaultValuefalse>
                    {
                        /// <summary>
                        /// Initializes a new instance of the <see cref = "DefaultValuefalse"/> struct.
                        /// </summary>
                        /// <param name = "value">The value from which to construct the instance.</param>
                        public DefaultValuefalse(ImmutableList<JsonObjectProperty> value)
                        {
                        ...
                        public static implicit operator DefaultValuefalse(JsonObject value)
                        {
                        ...
                        public static DefaultValuefalse FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
                        {
                        ...
                        /// <param name = "source">The dictionary of properties.</param>
                        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
                        public static DefaultValuefalse FromProperties(ImmutableList<JsonObjectProperty> source)
                        {
                            return new(source);
                        }
                        ...
                        /// <param name = "source">The dictionary of properties.</param>
                        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
                        public static DefaultValuefalse FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
                        {
                ...
                value = TValue.FromAny(result);
                        ...
                        /// <inheritdoc/>
                        public DefaultValuefalse SetProperty<TValue>(in JsonPropertyName name, TValue value)
                        ...
                        /// <inheritdoc/>
                        public DefaultValuefalse RemoveProperty(in JsonPropertyName name)
                        {
                            return new(this.GetPropertyBackingWithout(name));
                        }

                        /// <inheritdoc/>
                        public DefaultValuefalse RemoveProperty(string name)
                        {
                            return new(this.GetPropertyBackingWithout(name));
                        }

                        /// <inheritdoc/>
                        public DefaultValuefalse RemoveProperty(ReadOnlySpan<char> name)
                        {
                            return new(this.GetPropertyBackingWithout(name));
                        }

                        /// <inheritdoc/>
                        public DefaultValuefalse RemoveProperty(ReadOnlySpan<byte> utf8Name)
                        {
