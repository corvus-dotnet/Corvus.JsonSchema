        ...
        public readonly partial struct SchemaEntity
        {
            public readonly partial struct StylesForFormEntity
            {
                ...
                public readonly partial struct RequiredStyle
                {
                    ...
                    /// </summary>
                    public Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.SchemaEntity.StylesForFormEntity.RequiredStyle.StyleEntity Style
                    {
                        get
                        {
                            if ((this.backing & Backing.JsonElement) != 0)
                            {
                                ...
                                {
                                    return new Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.SchemaEntity.StylesForFormEntity.RequiredStyle.StyleEntity(result);
                                }
                            }
                            ...
                            if ((this.backing & Backing.Object) != 0)
                            {
                                ...
                                {
                                    return result.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.SchemaEntity.StylesForFormEntity.RequiredStyle.StyleEntity>();
                                }
                            }
                    ...
                    public static RequiredStyle Create()
                    {
                        ...
                        builder.Add(JsonPropertyNames.Style, new Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.SchemaEntity.StylesForFormEntity.RequiredStyle.StyleEntity().AsAny);
                    ...
                    {
                        return property.ValueAs<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.SchemaEntity.StylesForFormEntity.RequiredStyle.StyleEntity>().Validate(validationContext, level);
                    }
