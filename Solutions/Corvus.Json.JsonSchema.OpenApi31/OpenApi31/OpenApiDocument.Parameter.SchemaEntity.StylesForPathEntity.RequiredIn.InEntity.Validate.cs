                                ...
                                ValidationLevel level = ValidationLevel.Flag)
                            {
                                    ...
                                    ValidationLevel level = ValidationLevel.Flag)
                                {
                                    ...
                                    if (value.Equals(CorvusValidation.Const))
                                    {
                                        ...
                                        {
                                            result = result.WithResult(isValid: true, $"Validation const - the value '{value}' matched match '\"path\'.");
                                        }
                                    ...
                                    {
                                        result = result.WithResult(isValid: false, $"Validation const - the value '{value}' did not match '\"path\'.");
                                    }
                                    else if (level == ValidationLevel.Basic)
                                    {
                                        result = result.WithResult(isValid: false, "Validation const - the value did not match '\"path\'.");
                                    }
                                    else
                                    {
