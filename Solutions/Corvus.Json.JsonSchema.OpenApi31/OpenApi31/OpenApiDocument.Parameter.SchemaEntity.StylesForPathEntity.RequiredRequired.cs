        ...
        public readonly partial struct SchemaEntity
        {
            ...
            public readonly partial struct StylesForPathEntity
            {
...

                {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    public RequiredRequired(ImmutableList<JsonObjectProperty> value)
                    {
                    ...
                    public static implicit operator RequiredRequired(JsonAny value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator JsonAny(RequiredRequired value)
                    {
                        return value.AsAny;
                    }
                    ...
                    /// <summary>
                    /// Parses the RequiredRequired.
                    /// </summary>
                    /// <param name="source">The source of the JSON string to parse.</param>
                    /// <param name="options">The (optional) JsonDocumentOptions.</param>
                    public static RequiredRequired Parse(string source, JsonDocumentOptions options = default)
                    {
                    ...
                    /// <param name="source">The source of the JSON string to parse.</param>
                    /// <param name="options">The (optional) JsonDocumentOptions.</param>
                    public static RequiredRequired Parse(Stream source, JsonDocumentOptions options = default)
                    {
                        using var jsonDocument = JsonDocument.Parse(source, options);
                        return new(jsonDocument.RootElement.Clone());
                    }
                    ...
                    /// <param name="source">The source of the JSON string to parse.</param>
                    /// <param name="options">The (optional) JsonDocumentOptions.</param>
                    public static RequiredRequired Parse(ReadOnlyMemory<byte> source, JsonDocumentOptions options = default)
                    {
                        using var jsonDocument = JsonDocument.Parse(source, options);
                        return new(jsonDocument.RootElement.Clone());
                    }
                    ...
                    /// <param name="source">The source of the JSON string to parse.</param>
                    /// <param name="options">The (optional) JsonDocumentOptions.</param>
                    public static RequiredRequired Parse(ReadOnlyMemory<char> source, JsonDocumentOptions options = default)
                    {
                        using var jsonDocument = JsonDocument.Parse(source, options);
                        return new(jsonDocument.RootElement.Clone());
                    }
                    ...
                    /// <param name="source">The source of the JSON string to parse.</param>
                    /// <param name="options">The (optional) JsonDocumentOptions.</param>
                    public static RequiredRequired Parse(ReadOnlySequence<byte> source, JsonDocumentOptions options = default)
                    {
                        using var jsonDocument = JsonDocument.Parse(source, options);
                        return new(jsonDocument.RootElement.Clone());
                    }
                    ...
                    /// </summary>
                    /// <param name="source">The source of the JSON string to parse.</param>
                    public static RequiredRequired ParseValue(string source)
                    {
#if NET8_0_OR_GREATER
                        return IJsonValue<RequiredRequired>.ParseValue(source);
#else
                        return JsonValueHelpers.ParseValue<RequiredRequired>(source.AsSpan());
#endif
                    }
                    ...
                    /// </summary>
                    /// <param name="source">The source of the JSON string to parse.</param>
                    public static RequiredRequired ParseValue(ReadOnlySpan<char> source)
                    {
#if NET8_0_OR_GREATER
                        return IJsonValue<RequiredRequired>.ParseValue(source);
#else
                        return JsonValueHelpers.ParseValue<RequiredRequired>(source);
#endif
                    }
                    ...
                    /// </summary>
                    /// <param name="source">The source of the JSON string to parse.</param>
                    public static RequiredRequired ParseValue(ReadOnlySpan<byte> source)
                    {
#if NET8_0_OR_GREATER
                        return IJsonValue<RequiredRequired>.ParseValue(source);
#else
                    ...
                    /// </summary>
                    /// <param name="source">The source of the JSON string to parse.</param>
                    public static RequiredRequired ParseValue(ref Utf8JsonReader source)
                    {
#if NET8_0_OR_GREATER
                        return IJsonValue<RequiredRequired>.ParseValue(ref source);
#else
                        return JsonValueHelpers.ParseValue<RequiredRequired>(ref source);
#endif
                    }
                    ...
                    {
                        return
                            (obj is IJsonValue jv && this.Equals(jv.As<RequiredRequired>())) ||
                    ...
                    {
                        return this.Equals(other.As<RequiredRequired>());
                    }
