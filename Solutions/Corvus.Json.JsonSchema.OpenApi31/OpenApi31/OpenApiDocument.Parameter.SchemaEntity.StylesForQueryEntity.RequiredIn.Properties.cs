            ...
            public readonly partial struct StylesForQueryEntity
            {
                ...
                public readonly partial struct RequiredIn
                {
                    ...
                    public Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.SchemaEntity.StylesForQueryEntity.RequiredIn.InEntity In
                    {
                        get
                        {
                            if ((this.backing & Backing.JsonElement) != 0)
                            {
                                ...
                                {
                                    return new Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.SchemaEntity.StylesForQueryEntity.RequiredIn.InEntity(result);
                                }
                            }
                    ...
                    public static RequiredIn Create()
                    {
                        ...
                        builder.Add(JsonPropertyNames.In, new Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.SchemaEntity.StylesForQueryEntity.RequiredIn.InEntity().AsAny);
                    ...
                    {
                        return property.ValueAs<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.SchemaEntity.StylesForQueryEntity.RequiredIn.InEntity>().Validate(validationContext, level);
                    }
