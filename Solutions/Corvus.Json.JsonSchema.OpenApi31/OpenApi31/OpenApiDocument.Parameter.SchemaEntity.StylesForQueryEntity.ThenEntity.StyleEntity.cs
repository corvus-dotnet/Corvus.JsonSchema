            ...
            public readonly partial struct StylesForQueryEntity
            {
                ...
                public readonly partial struct ThenEntity
                {
...

                    {
                        ...
                        /// </summary>
                        public static string SchemaLocation { get; } = "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/parameter/dependentSchemas/schema/$defs/styles-for-query/then/properties/style";
                        ...
                        /// <summary>
                        /// Parses the StyleEntity.
                        /// </summary>
                        /// <param name="source">The source of the JSON string to parse.</param>
                        /// <param name="options">The (optional) JsonDocumentOptions.</param>
                        public static StyleEntity Parse(string source, JsonDocumentOptions options = default)
                        {
                        ...
                        /// <param name="source">The source of the JSON string to parse.</param>
                        /// <param name="options">The (optional) JsonDocumentOptions.</param>
                        public static StyleEntity Parse(Stream source, JsonDocumentOptions options = default)
                        {
                            using var jsonDocument = JsonDocument.Parse(source, options);
                            return new(jsonDocument.RootElement.Clone());
                        }
                        ...
                        /// <param name="source">The source of the JSON string to parse.</param>
                        /// <param name="options">The (optional) JsonDocumentOptions.</param>
                        public static StyleEntity Parse(ReadOnlyMemory<byte> source, JsonDocumentOptions options = default)
                        {
                            using var jsonDocument = JsonDocument.Parse(source, options);
                            return new(jsonDocument.RootElement.Clone());
                        }
                        ...
                        /// <param name="source">The source of the JSON string to parse.</param>
                        /// <param name="options">The (optional) JsonDocumentOptions.</param>
                        public static StyleEntity Parse(ReadOnlyMemory<char> source, JsonDocumentOptions options = default)
                        {
                            using var jsonDocument = JsonDocument.Parse(source, options);
                            return new(jsonDocument.RootElement.Clone());
                        }
                        ...
                        /// <param name="source">The source of the JSON string to parse.</param>
                        /// <param name="options">The (optional) JsonDocumentOptions.</param>
                        public static StyleEntity Parse(ReadOnlySequence<byte> source, JsonDocumentOptions options = default)
                        {
                            using var jsonDocument = JsonDocument.Parse(source, options);
                            return new(jsonDocument.RootElement.Clone());
                        }
                        ...
                        /// </summary>
                        /// <param name="source">The source of the JSON string to parse.</param>
                        public static StyleEntity ParseValue(string source)
                        {
#if NET8_0_OR_GREATER
                            return IJsonValue<StyleEntity>.ParseValue(source);
#else
                            return JsonValueHelpers.ParseValue<StyleEntity>(source.AsSpan());
#endif
                        }
                        ...
                        /// </summary>
                        /// <param name="source">The source of the JSON string to parse.</param>
                        public static StyleEntity ParseValue(ReadOnlySpan<char> source)
                        {
#if NET8_0_OR_GREATER
                            return IJsonValue<StyleEntity>.ParseValue(source);
#else
                            return JsonValueHelpers.ParseValue<StyleEntity>(source);
#endif
                        }
                        ...
                        /// </summary>
                        /// <param name="source">The source of the JSON string to parse.</param>
                        public static StyleEntity ParseValue(ReadOnlySpan<byte> source)
                        {
#if NET8_0_OR_GREATER
                            return IJsonValue<StyleEntity>.ParseValue(source);
#else
                        ...
                        /// </summary>
                        /// <param name="source">The source of the JSON string to parse.</param>
                        public static StyleEntity ParseValue(ref Utf8JsonReader source)
                        {
#if NET8_0_OR_GREATER
                            return IJsonValue<StyleEntity>.ParseValue(ref source);
#else
                            return JsonValueHelpers.ParseValue<StyleEntity>(ref source);
#endif
                        }
                        ...
                        {
                            return
                                (obj is IJsonValue jv && this.Equals(jv.As<StyleEntity>())) ||
                        ...
                        {
                            return this.Equals(other.As<StyleEntity>());
                        }
                        ...
                        public TOut Match<TIn, TOut>(
                            in TIn context,
                            Func<TIn, TOut> matchForm,
                            Func<TIn, TOut> matchSpaceDelimited,
                            Func<TIn, TOut> matchPipeDelimited,
                            Func<TIn, TOut> matchDeepObject,
                        ...
                        public TOut Match<TOut>(
                            Func<TOut> matchForm,
                            Func<TOut> matchSpaceDelimited,
                            Func<TOut> matchPipeDelimited,
                            Func<TOut> matchDeepObject,
