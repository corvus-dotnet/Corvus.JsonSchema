        ...
        public readonly partial struct SchemaEntity
        {
            ...
            public readonly partial struct StylesForQueryEntity
            {
                private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
                {
                    ...
                    ValidationContext ifResult = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.SchemaEntity.StylesForQueryEntity.RequiredIn>().Validate(validationContext.CreateChildContext(), level);
                    if (!ifResult.IsValid)
                    {
                    ...
                    if (ifResult.IsValid)
                    {
                        ...
                        ValidationContext thenResult = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.SchemaEntity.StylesForQueryEntity.ThenEntity>().Validate(validationContext.CreateChildContext(), level);
