            ...
            public readonly partial struct StylesForQueryEntity
            {
                ...
                public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    if (level > ValidationLevel.Basic)
                    {
                        ...
                        result = result.PushSchemaLocation("https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/parameter/dependentSchemas/schema/$defs/styles-for-query");
                    }
                ...
                public static partial class CorvusValidation
                {
                        ...
                        ValidationLevel level = ValidationLevel.Flag)
                    {
                        ...
                        ValidationContext ifResult = value.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.SchemaEntity.StylesForQueryEntity.RequiredIn>().Validate(validationContext.CreateChildContext(), level);
                        ...
                        if (ifResult.IsValid)
                        {
                            ...
                            ValidationContext thenResult = value.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.SchemaEntity.StylesForQueryEntity.ThenEntity>().Validate(validationContext.CreateChildContext(), level);
