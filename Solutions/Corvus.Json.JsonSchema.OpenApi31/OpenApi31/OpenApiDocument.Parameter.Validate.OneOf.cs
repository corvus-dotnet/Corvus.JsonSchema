...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct Parameter
    {
        private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext oneOfResult0 = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.RequiredSchema>().Validate(childContext0.CreateChildContext(), level);
            ...
            ValidationContext oneOfResult1 = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.RequiredContent>().Validate(childContext1.CreateChildContext(), level);
