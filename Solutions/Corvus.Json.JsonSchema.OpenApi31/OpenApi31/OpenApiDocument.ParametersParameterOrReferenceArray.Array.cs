...
[CollectionBuilder(typeof(ParametersParameterOrReferenceArray), "Create")]
public readonly partial struct ParametersParameterOrReferenceArray : IJsonArray<ParametersParameterOrReferenceArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference>
#else
    public readonly partial struct ParametersParameterOrReferenceArray : IJsonArray<ParametersParameterOrReferenceArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference>
#endif
    {
        ...
        /// Gets an empty array.
        /// </summary>
        public static readonly ParametersParameterOrReferenceArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "ParametersParameterOrReferenceArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ParametersParameterOrReferenceArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ParametersParameterOrReferenceArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        /// <inheritdoc/>
        JsonAny IJsonArray<ParametersParameterOrReferenceArray>.this[int index]
        {
            get
            {
        ...
        public static implicit operator ImmutableList<JsonAny>(ParametersParameterOrReferenceArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ParametersParameterOrReferenceArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ParametersParameterOrReferenceArray(JsonArray value)
        {
        ...
        public static ParametersParameterOrReferenceArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        public static ParametersParameterOrReferenceArray Create(ReadOnlySpan<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference> items)
        {
            return new([..items]);
        }
        ...
        /// <returns>A ParametersParameterOrReferenceArray instantiated from the given items.</returns>
        public static ParametersParameterOrReferenceArray FromItems(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference value1)
        {
        ...
        /// <returns>A ParametersParameterOrReferenceArray instantiated from the given items.</returns>
        public static ParametersParameterOrReferenceArray FromItems(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference value1, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ParametersParameterOrReferenceArray instantiated from the given items.</returns>
        public static ParametersParameterOrReferenceArray FromItems(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference value1, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference value2, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ParametersParameterOrReferenceArray FromItems(params Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ParametersParameterOrReferenceArray FromRange(IEnumerable<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference item in value)
            {
        ...
        /// </remarks>
        public static ParametersParameterOrReferenceArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new ParametersParameterOrReferenceArray(builder.ToImmutable());
        }
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ParametersParameterOrReferenceArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static ParametersParameterOrReferenceArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<ParametersParameterOrReferenceArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<ParametersParameterOrReferenceArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
