...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct PathItemOrReference
    {
        private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext ifResult = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.PathItemOrReference.RequiredRef>().Validate(validationContext.CreateChildContext(), level);
            if (!ifResult.IsValid)
            {
            ...
            if (!ifResult.IsValid)
            {
                ...
                ValidationContext elseResult = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.PathItem>().Validate(validationContext.CreateChildContext(), level);
