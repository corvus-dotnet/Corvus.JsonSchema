...
[CollectionBuilder(typeof(PathItemParametersParameterOrReferenceArray), "Create")]
public readonly partial struct PathItemParametersParameterOrReferenceArray : IJsonArray<PathItemParametersParameterOrReferenceArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference>
#else
    public readonly partial struct PathItemParametersParameterOrReferenceArray : IJsonArray<PathItemParametersParameterOrReferenceArray>, IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference>
#endif
    {
        ...
        /// Gets an empty array.
        /// </summary>
        public static readonly PathItemParametersParameterOrReferenceArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "PathItemParametersParameterOrReferenceArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public PathItemParametersParameterOrReferenceArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public PathItemParametersParameterOrReferenceArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        /// <inheritdoc/>
        JsonAny IJsonArray<PathItemParametersParameterOrReferenceArray>.this[int index]
        {
            get
            {
        ...
        public static implicit operator ImmutableList<JsonAny>(PathItemParametersParameterOrReferenceArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator PathItemParametersParameterOrReferenceArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator PathItemParametersParameterOrReferenceArray(JsonArray value)
        {
        ...
        public static PathItemParametersParameterOrReferenceArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        public static PathItemParametersParameterOrReferenceArray Create(ReadOnlySpan<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference> items)
        {
            return new([..items]);
        }
        ...
        /// <returns>A PathItemParametersParameterOrReferenceArray instantiated from the given items.</returns>
        public static PathItemParametersParameterOrReferenceArray FromItems(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference value1)
        {
        ...
        /// <returns>A PathItemParametersParameterOrReferenceArray instantiated from the given items.</returns>
        public static PathItemParametersParameterOrReferenceArray FromItems(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference value1, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A PathItemParametersParameterOrReferenceArray instantiated from the given items.</returns>
        public static PathItemParametersParameterOrReferenceArray FromItems(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference value1, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference value2, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static PathItemParametersParameterOrReferenceArray FromItems(params Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static PathItemParametersParameterOrReferenceArray FromRange(IEnumerable<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference item in value)
            {
        ...
        /// </remarks>
        public static PathItemParametersParameterOrReferenceArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new PathItemParametersParameterOrReferenceArray(builder.ToImmutable());
        }
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static PathItemParametersParameterOrReferenceArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static PathItemParametersParameterOrReferenceArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<PathItemParametersParameterOrReferenceArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<PathItemParametersParameterOrReferenceArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
