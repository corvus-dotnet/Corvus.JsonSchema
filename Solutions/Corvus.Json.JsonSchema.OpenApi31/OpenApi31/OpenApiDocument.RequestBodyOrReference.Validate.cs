    ...
    public readonly partial struct RequestBodyOrReference
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/request-body-or-reference");
            }
        ...
        public static partial class CorvusValidation
        {
            ...
            internal static ValidationContext TernaryIfValidationHandler(
                in RequestBodyOrReference value,
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                ValidationContext ifResult = value.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.RequestBodyOrReference.RequiredRef>().Validate(validationContext.CreateChildContext(), level);
                if (!ifResult.IsValid)
                {
                ...
                if (!ifResult.IsValid)
                {
                    ...
                    ValidationContext elseResult = value.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.RequestBody>().Validate(validationContext.CreateChildContext(), level);
