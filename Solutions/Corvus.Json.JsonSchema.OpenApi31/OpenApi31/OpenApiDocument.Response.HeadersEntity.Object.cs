...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct Response
    {
        ...
        /// </summary>
        public readonly partial struct HeadersEntity : IJsonObject<HeadersEntity>, IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.HeaderOrReference>
        {
            /// <summary>
            ...
            /// <inheritdoc/>
            int IReadOnlyCollection<KeyValuePair<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.HeaderOrReference>>.Count
            {
                get
                {
    ...
    static HeadersEntity IJsonObject<HeadersEntity>.FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
        return new(source.Select(s => new JsonObjectProperty(s.Name, s.Value)).ToImmutableList());
            ...
            /// <param name = "source">The dictionary of properties.</param>
            /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
            public static HeadersEntity FromProperties(IDictionary<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.HeaderOrReference> source)
            {
                return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
            }
            ...
            /// <param name = "source">The dictionary of properties.</param>
            /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
            public static HeadersEntity FromProperties(params (JsonPropertyName Name, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.HeaderOrReference Value)[] source)
            {
            ...
            /// <inheritdoc/>
            bool IJsonObject<HeadersEntity>.TryGetProperty(ReadOnlySpan<byte> utf8Name, out JsonAny value)
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <inheritdoc/>
            bool IJsonObject<HeadersEntity>.TryGetProperty<TValue>(ReadOnlySpan<byte> utf8Name, out TValue value)
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    if (this.jsonElementBacking.TryGetProperty(utf8Name, out JsonElement result))
            ...
            public bool TryGetProperty(in JsonPropertyName name, out Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.HeaderOrReference value)
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
#if NET8_0_OR_GREATER
                value = Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.HeaderOrReference.FromJson(result);
#else
                        value = JsonValueNetStandard20Extensions.FromJsonElement<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.HeaderOrReference>(result);
#endif
                        return true;
                    }
...
#else
                        value = result.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.HeaderOrReference>();
#endif
                        return true;
                    }
            ...
            /// <returns><c>True</c> if the property was present.</returns>
            /// <exception cref = "InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(ReadOnlySpan<byte> utf8Name, out Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.HeaderOrReference value)
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    if (this.jsonElementBacking.TryGetProperty(utf8Name, out JsonElement result))
            ...
            public HeadersEntity SetProperty(in JsonPropertyName name, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.HeaderOrReference value)
            {
                return new(this.GetPropertyBackingWith(name, value.AsAny));
            }
            ...
            /// <inheritdoc/>
            public HeadersEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
            {
                return new(this.GetPropertyBackingWithout(utf8Name));
            }

            /// <inheritdoc/>
            bool IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.HeaderOrReference>.ContainsKey(JsonPropertyName key)
            {
                return this.HasProperty(key);
            }

            /// <inheritdoc/>
            bool IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.HeaderOrReference>.TryGetValue(JsonPropertyName key, [MaybeNullWhen(false)] out Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.HeaderOrReference value)
            {
