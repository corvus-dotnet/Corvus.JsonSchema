...
public readonly partial struct OpenApiDocument
{
    ...
    /// </summary>
    public readonly partial struct ResponseHeadersEntity : IJsonObject<ResponseHeadersEntity>, IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.HeaderOrReference>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ResponseHeadersEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ResponseHeadersEntity(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator ResponseHeadersEntity(JsonObject value)
        {
        ...
        /// <inheritdoc/>
        JsonAny IJsonObject<ResponseHeadersEntity>.this[in JsonPropertyName name]
        {
            get
            {
    ...
    static ResponseHeadersEntity IJsonObject<ResponseHeadersEntity>.FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static ResponseHeadersEntity FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
    ...
    /// <param name="source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    static ResponseHeadersEntity IJsonObject<ResponseHeadersEntity>.FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static ResponseHeadersEntity FromProperties(IDictionary<JsonPropertyName, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.HeaderOrReference> source)
        {
            return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static ResponseHeadersEntity FromProperties(params (JsonPropertyName Name, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.HeaderOrReference Value)[] source)
        {
            return new(source.Select(s => new JsonObjectProperty(s.Name, s.Value.AsAny)).ToImmutableList());
        }

        /// <inheritdoc/>
        JsonObjectEnumerator IJsonObject<ResponseHeadersEntity>.EnumerateObject()
        {
        ...
        /// <inheritdoc/>
        bool IJsonObject<ResponseHeadersEntity>.TryGetProperty(in JsonPropertyName name, out JsonAny value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        bool IJsonObject<ResponseHeadersEntity>.TryGetProperty(string name, out JsonAny value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        bool IJsonObject<ResponseHeadersEntity>.TryGetProperty(ReadOnlySpan<char> name, out JsonAny value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.TryGetProperty(name, out JsonElement result))
        ...
        /// <inheritdoc/>
        bool IJsonObject<ResponseHeadersEntity>.TryGetProperty(ReadOnlySpan<byte> utf8Name, out JsonAny value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        bool IJsonObject<ResponseHeadersEntity>.TryGetProperty<TValue>(in JsonPropertyName name, out TValue value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (name.TryGetProperty(this.jsonElementBacking, out JsonElement result))
        ...
        /// <inheritdoc/>
        bool IJsonObject<ResponseHeadersEntity>.TryGetProperty<TValue>(string name, out TValue value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.TryGetProperty(name, out JsonElement result))
        ...
        /// <inheritdoc/>
        bool IJsonObject<ResponseHeadersEntity>.TryGetProperty<TValue>(ReadOnlySpan<char> name, out TValue value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.TryGetProperty(name, out JsonElement result))
        ...
        /// <inheritdoc/>
        bool IJsonObject<ResponseHeadersEntity>.TryGetProperty<TValue>(ReadOnlySpan<byte> utf8Name, out TValue value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.TryGetProperty(utf8Name, out JsonElement result))
        ...
        /// <inheritdoc/>
        ResponseHeadersEntity IJsonObject<ResponseHeadersEntity>.SetProperty<TValue>(in JsonPropertyName name, TValue value)
        {
        ...
        public ResponseHeadersEntity SetProperty(in JsonPropertyName name, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.HeaderOrReference value)
        {
            return new(this.GetPropertyBackingWith(name, value.AsAny));
        }

        /// <inheritdoc/>
        public ResponseHeadersEntity RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ResponseHeadersEntity RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ResponseHeadersEntity RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ResponseHeadersEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
