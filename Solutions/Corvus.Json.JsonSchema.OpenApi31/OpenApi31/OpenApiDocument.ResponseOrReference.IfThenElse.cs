...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct ResponseOrReference
    {
        ...
        public bool MatchIfRequiredRef(out Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Reference @then, out Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Response @else)
        {
            if (this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ResponseOrReference.RequiredRef>().IsValid())
            {
                @then = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Reference>();
                @else = Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Response.Undefined;
                return true;
            }

            @then = Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Reference.Undefined;
            @else = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Response>();
            return false;
        }
    }
}