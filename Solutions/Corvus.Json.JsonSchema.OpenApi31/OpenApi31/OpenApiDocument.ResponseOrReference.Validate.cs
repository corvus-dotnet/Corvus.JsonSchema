    ...
    public readonly partial struct ResponseOrReference
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/response-or-reference");
            }
        ...
        public static partial class CorvusValidation
        {
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                ValidationContext ifResult = value.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ResponseOrReference.RequiredRef>().Validate(validationContext.CreateChildContext(), level);
                ...
                if (!ifResult.IsValid)
                {
                    ...
                    ValidationContext elseResult = value.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Response>().Validate(validationContext.CreateChildContext(), level);
