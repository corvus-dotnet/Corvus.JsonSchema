...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct Responses
    {
        ...
        public readonly partial struct IfEntity
        {
            ...
            public static implicit operator IfEntity(in JsonAny value)
            {
    ...
    static IfEntity IJsonValue<IfEntity>.FromArray<TValue>(in TValue value)
    {
        ...
        return Undefined;
            ...
            static IfEntity ParseValue(ReadOnlySpan<char> buffer)
            {
#if NET8_0_OR_GREATER
        return IJsonValue<IfEntity>.ParseValue(buffer);
#else
                return JsonValueHelpers.ParseValue<IfEntity>(buffer);
#endif
            }
            ...
            /// <param name = "buffer">The buffer from which to parse the value.</param>
            /// <returns>The parsed value.</returns>
            static IfEntity ParseValue(ReadOnlySpan<byte> buffer)
            {
#if NET8_0_OR_GREATER
        return IJsonValue<IfEntity>.ParseValue(buffer);
#else
            ...
            /// <returns>The parsed value.</returns>
            static IfEntity ParseValue(ref Utf8JsonReader reader)
            {
#if NET8_0_OR_GREATER
        return IJsonValue<IfEntity>.ParseValue(ref reader);
#else
                return JsonValueHelpers.ParseValue<IfEntity>(ref reader);
#endif
            }
