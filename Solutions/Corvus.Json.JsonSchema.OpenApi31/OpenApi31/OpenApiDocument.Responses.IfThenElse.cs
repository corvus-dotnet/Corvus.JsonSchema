...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct Responses
    {
        ...
        public bool MatchIfIfEntity(out Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Responses.RequiredDefault result)
        {
            if (this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Responses.IfEntity>().IsValid())
            {
                result = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Responses.RequiredDefault>();
                return true;
            }

            result = Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Responses.RequiredDefault.Undefined;
            return false;
        }
    }
}