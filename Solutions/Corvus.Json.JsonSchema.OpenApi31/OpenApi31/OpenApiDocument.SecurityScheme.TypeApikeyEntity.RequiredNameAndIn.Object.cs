...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct SecurityScheme
    {
        public readonly partial struct TypeApikeyEntity
        {
            ...
            /// </summary>
            public readonly partial struct RequiredNameAndIn : IJsonObject<RequiredNameAndIn>
            {
                /// <summary>
                /// Initializes a new instance of the <see cref = "RequiredNameAndIn"/> struct.
                /// </summary>
                /// <param name = "value">The value from which to construct the instance.</param>
                public RequiredNameAndIn(ImmutableList<JsonObjectProperty> value)
                {
                ...
                public static implicit operator RequiredNameAndIn(JsonObject value)
                {
                ...
                public static RequiredNameAndIn FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
                {
                ...
                /// <param name = "source">The dictionary of properties.</param>
                /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
                public static RequiredNameAndIn FromProperties(ImmutableList<JsonObjectProperty> source)
                {
                    return new(source);
                }
                ...
                /// <param name = "source">The dictionary of properties.</param>
                /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
                public static RequiredNameAndIn FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
                {
                ...
                /// <inheritdoc/>
                public RequiredNameAndIn SetProperty<TValue>(in JsonPropertyName name, TValue value)
                ...
                /// <inheritdoc/>
                public RequiredNameAndIn RemoveProperty(in JsonPropertyName name)
                {
                    return new(this.GetPropertyBackingWithout(name));
                }

                /// <inheritdoc/>
                public RequiredNameAndIn RemoveProperty(string name)
                {
                    return new(this.GetPropertyBackingWithout(name));
                }

                /// <inheritdoc/>
                public RequiredNameAndIn RemoveProperty(ReadOnlySpan<char> name)
                {
                    return new(this.GetPropertyBackingWithout(name));
                }

                /// <inheritdoc/>
                public RequiredNameAndIn RemoveProperty(ReadOnlySpan<byte> utf8Name)
                {
