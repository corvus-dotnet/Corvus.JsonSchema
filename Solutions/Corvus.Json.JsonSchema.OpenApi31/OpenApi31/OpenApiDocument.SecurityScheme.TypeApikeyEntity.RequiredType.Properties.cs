    ...
    public readonly partial struct SecurityScheme
    {
        public readonly partial struct TypeApikeyEntity
        {
            ...
            public readonly partial struct RequiredType
            {
                ...
                /// </summary>
                public Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeApikeyEntity.RequiredType.TypeEntity Type
                {
                    get
                    {
                        if ((this.backing & Backing.JsonElement) != 0)
                        {
                            ...
                            {
                                return new Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeApikeyEntity.RequiredType.TypeEntity(result);
                            }
                        }
                        ...
                        if ((this.backing & Backing.Object) != 0)
                        {
                            ...
                            {
                                return result.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeApikeyEntity.RequiredType.TypeEntity>();
                            }
                        }
                ...
                public static RequiredType Create()
                {
                    ...
                    builder.Add(JsonPropertyNames.Type, new Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeApikeyEntity.RequiredType.TypeEntity().AsAny);
                ...
                {
                    return property.ValueAs<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeApikeyEntity.RequiredType.TypeEntity>().Validate(validationContext, level);
                }
