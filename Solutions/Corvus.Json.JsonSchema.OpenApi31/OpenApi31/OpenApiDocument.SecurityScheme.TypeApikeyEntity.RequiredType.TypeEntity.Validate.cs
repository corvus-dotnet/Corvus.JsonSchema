            ...
            public readonly partial struct RequiredType
            {
                ...
                public readonly partial struct TypeEntity
                {
                    ...
                    public static partial class CorvusValidation
                    {
                        ...
                        /// </summary>
                        public static readonly JsonString Const = JsonString.ParseValue("\"apiKey\"");

                        /// <summary>
                        /// A constant for the <c>const</c> keyword.
                        /// </summary>
                        public static ReadOnlySpan<byte> ConstUtf8 => "\"apiKey\""u8;
                            ...
                            ValidationLevel level = ValidationLevel.Flag)
                        {
                                ...
                                ValidationLevel level = ValidationLevel.Flag)
                            {
                                ...
                                if (value.Equals(CorvusValidation.Const))
                                {
                                    ...
                                    {
                                        result = result.WithResult(isValid: true, validationLocationReducedPathModifier: new JsonReference("const"), $"Validation const - the value '{value}' matched '\"apiKey\'.");
                                    }
                                ...
                                {
                                    result = result.WithResult(isValid: false, validationLocationReducedPathModifier: new JsonReference("const"), $"Validation const - the value '{value}' did not match '\"apiKey\'.");
                                }
                                else
                                {
                                    result = result.WithResult(isValid: false, validationLocationReducedPathModifier: new JsonReference("const"), "Validation const - the value did not match '\"apiKey\'.");
                                }
