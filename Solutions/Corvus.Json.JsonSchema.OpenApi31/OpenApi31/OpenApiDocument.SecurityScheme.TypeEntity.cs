    ...
    public readonly partial struct SecurityScheme
    {
...

        {
            ...
            public TOut Match<TIn, TOut>(
                in TIn context,
                Func<TIn, TOut> matchApiKey,
                Func<TIn, TOut> matchHttp,
                Func<TIn, TOut> matchMutualTls,
                Func<TIn, TOut> matchOauth2,
                Func<TIn, TOut> matchOpenIdConnect,
            ...
            public TOut Match<TOut>(
                Func<TOut> matchApiKey,
                Func<TOut> matchHttp,
                Func<TOut> matchMutualTls,
                Func<TOut> matchOauth2,
                Func<TOut> matchOpenIdConnect,
