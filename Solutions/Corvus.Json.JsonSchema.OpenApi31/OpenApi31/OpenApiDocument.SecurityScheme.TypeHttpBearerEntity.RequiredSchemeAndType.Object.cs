    ...
    public readonly partial struct SecurityScheme
    {
        ...
        public readonly partial struct TypeHttpBearerEntity
        {
            ...
            public readonly partial struct RequiredSchemeAndType
                : IJsonObject<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType>
            {
                /// <summary>
                /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator RequiredSchemeAndType(ImmutableList<JsonObjectProperty> value)
                {
                    return new(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator ImmutableList<JsonObjectProperty>(RequiredSchemeAndType value)
                {
                    return
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator RequiredSchemeAndType(JsonObject value)
                {
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator JsonObject(RequiredSchemeAndType value)
                {
                    return
                        value.AsObject;
                }
                ...
                public Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.SchemeEntity Scheme
                {
                    get
                    {
                        ...
                        if ((this.backing & Backing.Object) != 0)
                        {
                            ...
                            {
                                return result.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.SchemeEntity>();
                            }
                        }
                ...
                public Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.TypeEntity Type
                {
                    get
                    {
                        ...
                        if ((this.backing & Backing.Object) != 0)
                        {
                            ...
                            {
                                return result.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.TypeEntity>();
                            }
                        }
                ...
                /// <inheritdoc/>
                public static RequiredSchemeAndType FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
                {
                    return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
                }

                /// <inheritdoc/>
                public static RequiredSchemeAndType FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
                {
                ...
                public static RequiredSchemeAndType FromProperties(ImmutableList<JsonObjectProperty> source)
                {
                    return new(source);
                }
                ...
                /// </summary>
                public static RequiredSchemeAndType Create(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.SchemeEntity scheme)
                {
                    var builder = ImmutableList.CreateBuilder<JsonObjectProperty>();
                    builder.Add(JsonPropertyNames.Scheme, scheme.AsAny);
                    builder.Add(JsonPropertyNames.Type, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.TypeEntity.ConstInstance.AsAny);
                ...
                public RequiredSchemeAndType WithScheme(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.SchemeEntity value)
                {
                ...
                /// <param name="value">The new property value</param>
                /// <returns>The instance with the property set.</returns>
                public RequiredSchemeAndType WithType(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.TypeEntity value)
                {
                ...
                /// <inheritdoc />
                public RequiredSchemeAndType SetProperty<TValue>(in JsonPropertyName name, TValue value)
                ...
                /// <inheritdoc />
                public RequiredSchemeAndType RemoveProperty(in JsonPropertyName name)
                {
                    return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
                }

                /// <inheritdoc />
                public RequiredSchemeAndType RemoveProperty(string name)
                {
                    return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
                }

                /// <inheritdoc />
                public RequiredSchemeAndType RemoveProperty(ReadOnlySpan<char> name)
                {
                    return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
                }

                /// <inheritdoc />
                public RequiredSchemeAndType RemoveProperty(ReadOnlySpan<byte> name)
                {
                    return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
                }
                ...
                private static class __CorvusObjectHelpers
                {
                    ...
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in RequiredSchemeAndType that)
                    {
                    ...
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in RequiredSchemeAndType that, in JsonPropertyName name)
                    {
                        if ((that.backing & Backing.Object) != 0)
                        {
                    ...
                    /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in RequiredSchemeAndType that, ReadOnlySpan<char> name)
                    {
                        if ((that.backing & Backing.Object) != 0)
                        {
                            return that.objectBacking.Remove(name);
                    ...
                    /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in RequiredSchemeAndType that, ReadOnlySpan<byte> name)
                    {
                        if ((that.backing & Backing.Object) != 0)
                        {
                            return that.objectBacking.Remove(name);
                    ...
                    /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in RequiredSchemeAndType that, string name)
                    {
                        if ((that.backing & Backing.Object) != 0)
                        {
                            return that.objectBacking.Remove(name);
                    ...
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in RequiredSchemeAndType that, in JsonPropertyName name, in JsonAny value)
                    {
                        if ((that.backing & Backing.Object) != 0)
                        {
