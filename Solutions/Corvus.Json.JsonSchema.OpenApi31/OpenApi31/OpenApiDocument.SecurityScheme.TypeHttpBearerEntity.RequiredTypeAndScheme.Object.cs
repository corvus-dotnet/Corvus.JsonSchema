...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct SecurityScheme
    {
        public readonly partial struct TypeHttpBearerEntity
        {
            ...
            /// </summary>
            public readonly partial struct RequiredTypeAndScheme : IJsonObject<RequiredTypeAndScheme>
            {
                /// <summary>
                /// Initializes a new instance of the <see cref = "RequiredTypeAndScheme"/> struct.
                /// </summary>
                /// <param name = "value">The value from which to construct the instance.</param>
                public RequiredTypeAndScheme(ImmutableList<JsonObjectProperty> value)
                {
                ...
                public static implicit operator RequiredTypeAndScheme(JsonObject value)
                {
                ...
                public static RequiredTypeAndScheme FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
                {
                ...
                /// <param name = "source">The dictionary of properties.</param>
                /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
                public static RequiredTypeAndScheme FromProperties(ImmutableList<JsonObjectProperty> source)
                {
                    return new(source);
                }
                ...
                /// <param name = "source">The dictionary of properties.</param>
                /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
                public static RequiredTypeAndScheme FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
                {
                ...
                /// <inheritdoc/>
                public RequiredTypeAndScheme SetProperty<TValue>(in JsonPropertyName name, TValue value)
                ...
                /// <inheritdoc/>
                public RequiredTypeAndScheme RemoveProperty(in JsonPropertyName name)
                {
                    return new(this.GetPropertyBackingWithout(name));
                }

                /// <inheritdoc/>
                public RequiredTypeAndScheme RemoveProperty(string name)
                {
                    return new(this.GetPropertyBackingWithout(name));
                }

                /// <inheritdoc/>
                public RequiredTypeAndScheme RemoveProperty(ReadOnlySpan<char> name)
                {
                    return new(this.GetPropertyBackingWithout(name));
                }

                /// <inheritdoc/>
                public RequiredTypeAndScheme RemoveProperty(ReadOnlySpan<byte> utf8Name)
                {
