        ...
        public readonly partial struct TypeHttpBearerEntity
        {
            public readonly partial struct RequiredTypeAndScheme
            {
                ...
                public readonly partial struct TypeEntity
                {
                    ...
                    /// </summary>
                    public static string SchemaLocation { get; } = "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/security-scheme/$defs/type-http-bearer/if/properties/type";
                    /// <summary>
                    ...
                    public static implicit operator TypeEntity(in JsonAny value)
                    {
...
#else
                        return JsonValueHelpers.ParseValue<TypeEntity>(buffer);
#endif
                    }
...
#else
                        return JsonValueHelpers.ParseValue<TypeEntity>(ref reader);
#endif
                    }
