...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct SecurityScheme
    {
        ...
        public readonly partial struct TypeHttpEntity
        {
            ...
            public static explicit operator Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeHttpEntity.RequiredScheme(TypeHttpEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static explicit operator TypeHttpEntity(Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeHttpEntity.RequiredScheme value)
            {
