...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct SecurityScheme
    {
        ...
        public readonly partial struct TypeOauth2Entity
        {
            ...
            public static explicit operator Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeOauth2Entity.RequiredFlows(TypeOauth2Entity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static explicit operator TypeOauth2Entity(Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeOauth2Entity.RequiredFlows value)
            {
