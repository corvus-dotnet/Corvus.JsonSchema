        ...
        public readonly partial struct TypeOauth2Entity
        {
            ...
            public readonly partial struct RequiredType
            {
                ...
                public Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeOauth2Entity.RequiredType.TypeEntity Type
                {
                    get
                    {
                        if ((this.backing & Backing.JsonElement) != 0)
                        {
                            ...
                            {
                                return new Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeOauth2Entity.RequiredType.TypeEntity(result);
                            }
                        }
                ...
                public static RequiredType Create()
                {
                    ...
                    builder.Add(JsonPropertyNames.Type, new Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeOauth2Entity.RequiredType.TypeEntity().AsAny);
                ...
                {
                    return property.ValueAs<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeOauth2Entity.RequiredType.TypeEntity>().Validate(validationContext, level);
                }
