        ...
        public readonly partial struct TypeOidcEntity
        {
            ...
            public readonly partial struct RequiredType
            {
                ...
                public Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeOidcEntity.RequiredType.TypeEntity Type
                {
                    get
                    {
                        if ((this.backing & Backing.JsonElement) != 0)
                        {
                            ...
                            {
                                return new Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeOidcEntity.RequiredType.TypeEntity(result);
                            }
                        }
                ...
                public static RequiredType Create()
                {
                    ...
                    builder.Add(JsonPropertyNames.Type, new Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeOidcEntity.RequiredType.TypeEntity().AsAny);
                ...
                {
                    return property.ValueAs<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeOidcEntity.RequiredType.TypeEntity>().Validate(validationContext, level);
                }
