...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct SecuritySchemeOrReference
    {
        private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext ifResult = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecuritySchemeOrReference.RequiredRef>().Validate(validationContext.CreateChildContext(), level);
            if (!ifResult.IsValid)
            {
            ...
            if (!ifResult.IsValid)
            {
                ...
                ValidationContext elseResult = this.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme>().Validate(validationContext.CreateChildContext(), level);
