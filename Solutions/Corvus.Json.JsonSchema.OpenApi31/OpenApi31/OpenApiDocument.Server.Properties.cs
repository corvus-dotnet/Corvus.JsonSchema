...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct Server
    {
        ...
        public Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Server.VariablesEntity Variables
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
                        return new Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Server.VariablesEntity(result);
                    }
                }
        ...
        /// </summary>
        public static Server Create(Corvus.Json.JsonUriReference url, Corvus.Json.JsonString? description = null, Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Server.VariablesEntity? variables = null)
        {
            ...
            if (variables is Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Server.VariablesEntity variables__)
            {
        ...
        {
            return property.ValueAs<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Server.VariablesEntity>().Validate(validationContext, level);
        }
