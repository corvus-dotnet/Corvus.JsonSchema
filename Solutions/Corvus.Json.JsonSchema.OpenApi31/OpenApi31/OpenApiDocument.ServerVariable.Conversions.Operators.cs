...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct ServerVariable
    {
        ...
        public static implicit operator Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SpecificationExtensions(ServerVariable value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static explicit operator ServerVariable(Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SpecificationExtensions value)
        {
