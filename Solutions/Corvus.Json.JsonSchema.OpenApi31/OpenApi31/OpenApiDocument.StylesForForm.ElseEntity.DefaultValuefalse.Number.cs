...
: IJsonNumber<DefaultValuefalse>,
  IAdditionOperators<DefaultValuefalse, DefaultValuefalse, DefaultValuefalse>,
  ISubtractionOperators<DefaultValuefalse, DefaultValuefalse, DefaultValuefalse>,
  IMultiplyOperators<DefaultValuefalse, DefaultValuefalse, DefaultValuefalse>,
  IDivisionOperators<DefaultValuefalse, DefaultValuefalse, DefaultValuefalse>,
  IIncrementOperators<DefaultValuefalse>,
  IDecrementOperators<DefaultValuefalse>
#else
            : IJsonNumber<DefaultValuefalse>
#endif
            {
                ...
                public DefaultValuefalse(in BinaryJsonNumber value)
                {
                ...
                public DefaultValuefalse(double value) : this(new BinaryJsonNumber(value))
                {
                }
                ...
                public static implicit operator DefaultValuefalse(JsonNumber value)
                {
                ...
                public static explicit operator byte (DefaultValuefalse value)
                {
                ...
                public static explicit operator decimal (DefaultValuefalse value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator double (DefaultValuefalse value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator short (DefaultValuefalse value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator int (DefaultValuefalse value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator long (DefaultValuefalse value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an Int64.</exception>
    public static explicit operator Int128(DefaultValuefalse value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        throw new InvalidOperationException();
                ...
                public static explicit operator sbyte (DefaultValuefalse value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
    ...
    public static explicit operator Half(DefaultValuefalse value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        throw new InvalidOperationException();
                ...
                /// <exception cref = "InvalidOperationException">The value was not a number.</exception>
                /// <exception cref = "FormatException">The value was not formatted as a Single.</exception>
                public static explicit operator float (DefaultValuefalse value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator ushort (DefaultValuefalse value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator uint (DefaultValuefalse value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator ulong (DefaultValuefalse value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an UInt64.</exception>
    public static explicit operator UInt128(DefaultValuefalse value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        throw new InvalidOperationException();
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator DefaultValuefalse(decimal value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator DefaultValuefalse(double value)
                {
                    return new(new BinaryJsonNumber(value));
                }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator DefaultValuefalse(Half value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator DefaultValuefalse(float value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator DefaultValuefalse(byte value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator DefaultValuefalse(short value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator DefaultValuefalse(int value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator DefaultValuefalse(long value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator DefaultValuefalse(sbyte value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator DefaultValuefalse(ushort value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator DefaultValuefalse(uint value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator DefaultValuefalse(ulong value)
                {
                    return new(new BinaryJsonNumber(value));
                }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator DefaultValuefalse(Int128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator DefaultValuefalse(UInt128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
                ...
                public static DefaultValuefalse operator +(DefaultValuefalse left, DefaultValuefalse right)
                {
                ...
                /// <returns>The resulting value.</returns>
                public static DefaultValuefalse operator ++(DefaultValuefalse value)
                {
                ...
                public static int Compare(in DefaultValuefalse lhs, in DefaultValuefalse rhs)
                {
