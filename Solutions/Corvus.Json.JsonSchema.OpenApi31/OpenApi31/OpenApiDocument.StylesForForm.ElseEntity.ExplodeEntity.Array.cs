...
[CollectionBuilder(typeof(ExplodeEntity), "Create")]
public readonly partial struct ExplodeEntity : IJsonArray<ExplodeEntity>, IReadOnlyCollection<JsonAny>
#else
            public readonly partial struct ExplodeEntity : IJsonArray<ExplodeEntity>, IReadOnlyCollection<JsonAny>
#endif
            {
                ...
                public static ExplodeEntity Create(ReadOnlySpan<JsonAny> items)
                {
                    return new([..items]);
                }
