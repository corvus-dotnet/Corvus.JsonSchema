...
: IJsonNumber<ExplodeEntity>,
  IAdditionOperators<ExplodeEntity, ExplodeEntity, ExplodeEntity>,
  ISubtractionOperators<ExplodeEntity, ExplodeEntity, ExplodeEntity>,
  IMultiplyOperators<ExplodeEntity, ExplodeEntity, ExplodeEntity>,
  IDivisionOperators<ExplodeEntity, ExplodeEntity, ExplodeEntity>,
  IIncrementOperators<ExplodeEntity>,
  IDecrementOperators<ExplodeEntity>
#else
            : IJsonNumber<ExplodeEntity>
#endif
            {
                ...
                public ExplodeEntity(in BinaryJsonNumber value)
                {
                ...
                public ExplodeEntity(double value) : this(new BinaryJsonNumber(value))
                {
                }
                ...
                public static explicit operator byte (ExplodeEntity value)
                {
                ...
                public static explicit operator decimal (ExplodeEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator double (ExplodeEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator short (ExplodeEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator int (ExplodeEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator long (ExplodeEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an Int64.</exception>
    public static explicit operator Int128(ExplodeEntity value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        throw new InvalidOperationException();
                ...
                public static explicit operator sbyte (ExplodeEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
    ...
    public static explicit operator Half(ExplodeEntity value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        throw new InvalidOperationException();
                ...
                /// <exception cref = "InvalidOperationException">The value was not a number.</exception>
                /// <exception cref = "FormatException">The value was not formatted as a Single.</exception>
                public static explicit operator float (ExplodeEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator ushort (ExplodeEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator uint (ExplodeEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                public static explicit operator ulong (ExplodeEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an UInt64.</exception>
    public static explicit operator UInt128(ExplodeEntity value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        throw new InvalidOperationException();
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator ExplodeEntity(decimal value)
                {
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator ExplodeEntity(double value)
                {
                    return new(new BinaryJsonNumber(value));
                }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator ExplodeEntity(Half value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator ExplodeEntity(float value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator ExplodeEntity(byte value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator ExplodeEntity(short value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator ExplodeEntity(int value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator ExplodeEntity(long value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator ExplodeEntity(sbyte value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator ExplodeEntity(ushort value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                /// </summary>
                /// <param name = "value">The value to convert.</param>
                public static explicit operator ExplodeEntity(ulong value)
                {
                    return new(new BinaryJsonNumber(value));
                }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator ExplodeEntity(Int128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator ExplodeEntity(UInt128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
                ...
                public static bool operator <(in ExplodeEntity left, in ExplodeEntity right)
                {
                ...
                public static ExplodeEntity operator +(ExplodeEntity left, ExplodeEntity right)
                {
                ...
                /// <returns>The resulting value.</returns>
                public static ExplodeEntity operator ++(ExplodeEntity value)
                {
                ...
                public static int Compare(in ExplodeEntity lhs, in ExplodeEntity rhs)
                {
