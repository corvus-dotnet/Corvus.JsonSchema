...
public readonly partial struct OpenApiDocument
{
    public readonly partial struct StylesForForm
    {
        public readonly partial struct ElseEntity
        {
            ...
            /// </summary>
            public readonly partial struct ExplodeEntity : IJsonObject<ExplodeEntity>
            {
                /// <summary>
                /// Initializes a new instance of the <see cref = "ExplodeEntity"/> struct.
                /// </summary>
                /// <param name = "value">The value from which to construct the instance.</param>
                public ExplodeEntity(ImmutableList<JsonObjectProperty> value)
                {
                ...
                public static implicit operator ExplodeEntity(JsonObject value)
                {
                ...
                public static ExplodeEntity FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
                {
                ...
                /// <param name = "source">The dictionary of properties.</param>
                /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
                public static ExplodeEntity FromProperties(ImmutableList<JsonObjectProperty> source)
                {
                    return new(source);
                }
                ...
                /// <param name = "source">The dictionary of properties.</param>
                /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
                public static ExplodeEntity FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
                {
                ...
                /// <inheritdoc/>
                public ExplodeEntity SetProperty<TValue>(in JsonPropertyName name, TValue value)
                ...
                /// <inheritdoc/>
                public ExplodeEntity RemoveProperty(in JsonPropertyName name)
                {
                    return new(this.GetPropertyBackingWithout(name));
                }

                /// <inheritdoc/>
                public ExplodeEntity RemoveProperty(string name)
                {
                    return new(this.GetPropertyBackingWithout(name));
                }

                /// <inheritdoc/>
                public ExplodeEntity RemoveProperty(ReadOnlySpan<char> name)
                {
                    return new(this.GetPropertyBackingWithout(name));
                }

                /// <inheritdoc/>
                public ExplodeEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
                {
