    ...
    public readonly partial struct StylesForForm
    {
        ...
        public readonly partial struct RequiredStyle
        {
            ...
            public Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.StylesForForm.RequiredStyle.StyleEntity Style
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        ...
                        {
                            return new Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.StylesForForm.RequiredStyle.StyleEntity(result);
                        }
                    }
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        ...
                        {
                            return result.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.StylesForForm.RequiredStyle.StyleEntity>();
                        }
                    }
            ...
            public static RequiredStyle Create()
            {
                ...
                builder.Add(JsonPropertyNames.Style, new Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.StylesForForm.RequiredStyle.StyleEntity().AsAny);
            ...
            {
                return property.ValueAs<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.StylesForForm.RequiredStyle.StyleEntity>().Validate(validationContext, level);
            }
