        ...
        public readonly partial struct ThenEntity
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/styles-for-form/then");
                }
                    ...
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    foreach (JsonObjectProperty property in value.EnumerateObject())
                    {
                        if (property.NameEquals(JsonPropertyNames.ExplodeUtf8, JsonPropertyNames.Explode))
                        {
                            ...
                            ValidationContext propertyResult = property.Value.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.StylesForForm.ThenEntity.DefaultValueTrue>().Validate(result.CreateChildContext(), level);
