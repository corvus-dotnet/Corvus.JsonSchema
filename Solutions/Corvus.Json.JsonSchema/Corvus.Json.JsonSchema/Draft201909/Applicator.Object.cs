...
/// </summary>
public readonly partial struct Applicator : IJsonObject<Applicator>
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "Applicator"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public Applicator(ImmutableDictionary<JsonPropertyName, JsonAny> value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator Applicator(ImmutableDictionary<JsonPropertyName, JsonAny> value)
    {
        return new(value);
    }
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator ImmutableDictionary<JsonPropertyName, JsonAny>(Applicator value)
    {
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static Applicator FromProperties(ImmutableDictionary<JsonPropertyName, JsonAny> source)
    {
        return new(source);
    }
