...
public readonly partial struct Applicator
{
    public readonly partial struct PatternPropertiesValue
    {
        ...
        /// </summary>
        public readonly partial struct PropertyNamesEntity : IJsonArray<PropertyNamesEntity>
        {
            /// <summary>
            /// Gets an empty array.
            /// </summary>
            public static readonly PropertyNamesEntity EmptyArray = From(ImmutableList<JsonAny>.Empty);
            /// <summary>
            ...
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public PropertyNamesEntity(IEnumerable<JsonAny> value)
            {
                this.jsonElementBacking = default;
                this.backing = Backing.Array;
                this.stringBacking = string.Empty;
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator ImmutableList<JsonAny>(PropertyNamesEntity value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator PropertyNamesEntity(ImmutableList<JsonAny> value)
            {
                return new(value);
            }
            ...
            public static PropertyNamesEntity From(ImmutableList<JsonAny> items)
            {
                return new(items);
            }
            ...
            public static PropertyNamesEntity FromItems(params JsonAny[] value)
            {
            ...
            /// <param name = "value">The value from which to construct the instance.</param>
            /// <returns>A PropertyNamesEntity instantiated from the given items.</returns>
            public static PropertyNamesEntity FromItems<TItem>(params TItem[] value)
            ...
            /// <returns>A PropertyNamesEntity instantiated from the given items.</returns>
            public static PropertyNamesEntity FromItems<TItem1>(in TItem1 value1)
            ...
            /// <returns>A PropertyNamesEntity instantiated from the given items.</returns>
            public static PropertyNamesEntity FromItems<TItem1, TItem2>(in TItem1 value1, in TItem2 value2)
            ...
            /// <returns>A PropertyNamesEntity instantiated from the given items.</returns>
            public static PropertyNamesEntity FromItems<TItem1, TItem2, TItem3>(in TItem1 value1, in TItem2 value2, in TItem3 value3)
            ...
            /// </remarks>
            public static PropertyNamesEntity From<T>(IEnumerable<T> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// other overloads which avoid this serialization step.
            /// </remarks>
            public static PropertyNamesEntity FromRange(IEnumerable<JsonAny> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// other overloads which avoid this serialization step.
            /// </remarks>
            public static PropertyNamesEntity FromRange<T>(IEnumerable<T> items)
            ...
            /// <param name = "value1">The first value from which to construct the instance.</param>
            /// <returns>A PropertyNamesEntity instantiated from the given items.</returns>
            public static PropertyNamesEntity FromItems(in JsonAny value1)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1);
                return new(builder.ToImmutable());
            ...
            /// <param name = "value2">The second value from which to construct the instance.</param>
            /// <returns>A PropertyNamesEntity instantiated from the given items.</returns>
            public static PropertyNamesEntity FromItems(in JsonAny value1, in JsonAny value2)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1);
                builder.Add(value2);
            ...
            /// <param name = "value3">The thirdvalue from which to construct the instance.</param>
            /// <returns>A PropertyNamesEntity instantiated from the given items.</returns>
            public static PropertyNamesEntity FromItems(in JsonAny value1, in JsonAny value2, in JsonAny value3)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1);
                builder.Add(value2);
