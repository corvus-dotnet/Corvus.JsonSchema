...
public readonly partial struct Applicator
{
    ...
    public readonly partial struct PropertiesEntity
    {
        private ValidationContext ValidateAnyOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext anyOfResult0 = this.As<Corvus.Json.JsonSchema.Draft201909.Schema>().Validate(childContext0.CreateChildContext(), level);
            ...
            ValidationContext anyOfResult1 = this.As<Corvus.Json.JsonSchema.Draft201909.Applicator.SchemaArray>().Validate(childContext1.CreateChildContext(), level);
