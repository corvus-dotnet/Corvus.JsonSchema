...
public readonly partial struct Applicator
{
    ...
    public readonly partial struct SchemaArray : IJsonArray<SchemaArray>
    {
        ...
        public static SchemaArray FromItems(in Corvus.Json.JsonSchema.Draft201909.Schema value1)
        {
        ...
        /// <returns>A SchemaArray instantiated from the given items.</returns>
        public static SchemaArray FromItems(in Corvus.Json.JsonSchema.Draft201909.Schema value1, in Corvus.Json.JsonSchema.Draft201909.Schema value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A SchemaArray instantiated from the given items.</returns>
        public static SchemaArray FromItems(in Corvus.Json.JsonSchema.Draft201909.Schema value1, in Corvus.Json.JsonSchema.Draft201909.Schema value2, in Corvus.Json.JsonSchema.Draft201909.Schema value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static SchemaArray FromItems(params Corvus.Json.JsonSchema.Draft201909.Schema[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Corvus.Json.JsonSchema.Draft201909.Schema item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static SchemaArray FromItems(IEnumerable<Corvus.Json.JsonSchema.Draft201909.Schema> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Corvus.Json.JsonSchema.Draft201909.Schema item in value)
            {
        ...
        public JsonArrayEnumerator<Corvus.Json.JsonSchema.Draft201909.Schema> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Corvus.Json.JsonSchema.Draft201909.Schema>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Corvus.Json.JsonSchema.Draft201909.Schema>(this.arrayBacking);
            }
