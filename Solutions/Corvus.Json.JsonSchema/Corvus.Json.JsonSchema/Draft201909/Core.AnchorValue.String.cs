...
public readonly partial struct Core
{
    ...
    /// </summary>
    public readonly partial struct AnchorValue : IJsonString<AnchorValue>
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public AnchorValue(in ReadOnlySpan<char> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.String;
        ...
        public AnchorValue(in ReadOnlySpan<byte> utf8Value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.String;
