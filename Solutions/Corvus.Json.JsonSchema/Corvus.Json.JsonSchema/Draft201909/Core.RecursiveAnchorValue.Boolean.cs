...
public readonly partial struct Core
{
    ...
    /// </summary>
    public readonly partial struct RecursiveAnchorValue : IJsonBoolean<RecursiveAnchorValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "RecursiveAnchorValue"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public RecursiveAnchorValue(bool value)
        {
        ...
        public static implicit operator JsonBoolean(RecursiveAnchorValue value)
        {
