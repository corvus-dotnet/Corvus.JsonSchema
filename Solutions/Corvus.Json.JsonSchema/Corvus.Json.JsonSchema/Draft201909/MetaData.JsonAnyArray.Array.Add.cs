...
public readonly partial struct MetaData
{
    ...
    public readonly partial struct JsonAnyArray
    {
        ...
        public JsonAnyArray Add<TItem1>(in TItem1 item1)
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public JsonAnyArray Add<TItem1, TItem2>(in TItem1 item1, in TItem2 item2)
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public JsonAnyArray Insert<TItem1>(int index, in TItem1 item1)
            where TItem1 : struct, IJsonValue<TItem1>
        {
        ...
        /// <inheritdoc/>
        public JsonAnyArray Replace<TItem>(in TItem oldValue, in TItem newValue)
        ...
        /// <inheritdoc/>
        public JsonAnyArray SetItem<TItem>(int index, in TItem value)
            where TItem : struct, IJsonValue
        {
