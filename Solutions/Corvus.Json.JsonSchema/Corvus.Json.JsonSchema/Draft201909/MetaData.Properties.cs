...
public readonly partial struct MetaData
{
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public MetaData WithDeprecated(in Corvus.Json.JsonSchema.Draft201909.MetaData.DeprecatedValue value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public MetaData WithReadOnly(in Corvus.Json.JsonSchema.Draft201909.MetaData.ReadOnlyValue value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public MetaData WithWriteOnly(in Corvus.Json.JsonSchema.Draft201909.MetaData.WriteOnlyValue value)
    {
    ...
    {
        return property.ValueAs<Corvus.Json.JsonSchema.Draft201909.MetaData.DeprecatedValue>().Validate(validationContext, level);
    }
    ...
    {
        return property.ValueAs<Corvus.Json.JsonSchema.Draft201909.MetaData.ReadOnlyValue>().Validate(validationContext, level);
    }
    ...
    {
        return property.ValueAs<Corvus.Json.JsonSchema.Draft201909.MetaData.WriteOnlyValue>().Validate(validationContext, level);
    }
