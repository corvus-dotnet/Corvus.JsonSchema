...
public readonly partial struct MetaData
{
    ...
    /// </summary>
    public static MetaData Create(Corvus.Json.JsonString? title = null, Corvus.Json.JsonString? description = null, Corvus.Json.JsonAny? @default = null, Corvus.Json.JsonSchema.Draft201909.MetaData.DeprecatedEntity? deprecated = null, Corvus.Json.JsonSchema.Draft201909.MetaData.ReadOnlyEntity? readOnly = null, Corvus.Json.JsonSchema.Draft201909.MetaData.WriteOnlyEntity? writeOnly = null, Corvus.Json.JsonSchema.Draft201909.MetaData.JsonAnyArray? examples = null)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public MetaData WithDeprecated(in Corvus.Json.JsonSchema.Draft201909.MetaData.DeprecatedEntity value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public MetaData WithReadOnly(in Corvus.Json.JsonSchema.Draft201909.MetaData.ReadOnlyEntity value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public MetaData WithWriteOnly(in Corvus.Json.JsonSchema.Draft201909.MetaData.WriteOnlyEntity value)
    {
    ...
    {
        return property.ValueAs<Corvus.Json.JsonSchema.Draft201909.MetaData.DeprecatedEntity>().Validate(validationContext, level);
    }
    ...
    {
        return property.ValueAs<Corvus.Json.JsonSchema.Draft201909.MetaData.ReadOnlyEntity>().Validate(validationContext, level);
    }
    ...
    {
        return property.ValueAs<Corvus.Json.JsonSchema.Draft201909.MetaData.WriteOnlyEntity>().Validate(validationContext, level);
    }
    ...
    {
        return property.ValueAs<Corvus.Json.JsonSchema.Draft201909.MetaData.JsonAnyArray>().Validate(validationContext, level);
    }
}