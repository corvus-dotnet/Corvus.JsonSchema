...
public readonly partial struct Validation
{
    ...
    /// </summary>
    public readonly partial struct JsonStringArray : IJsonArray<JsonStringArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly JsonStringArray EmptyArray = FromItems(ImmutableList<JsonAny>.Empty);
        /// <summary>
        ...
        public static JsonStringArray FromItems(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static JsonStringArray FromItems(IEnumerable<Corvus.Json.JsonString> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Corvus.Json.JsonString item in value)
            {
