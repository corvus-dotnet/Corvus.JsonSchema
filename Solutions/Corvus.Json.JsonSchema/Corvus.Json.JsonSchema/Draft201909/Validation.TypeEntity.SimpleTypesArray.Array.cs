...
public readonly partial struct Validation
{
    public readonly partial struct TypeEntity
    {
        ...
        public readonly partial struct SimpleTypesArray : IJsonArray<SimpleTypesArray>
        {
            ...
            public static SimpleTypesArray FromItems(in Corvus.Json.JsonSchema.Draft201909.Validation.SimpleTypes value1)
            {
            ...
            /// <returns>A SimpleTypesArray instantiated from the given items.</returns>
            public static SimpleTypesArray FromItems(in Corvus.Json.JsonSchema.Draft201909.Validation.SimpleTypes value1, in Corvus.Json.JsonSchema.Draft201909.Validation.SimpleTypes value2)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
            ...
            /// <returns>A SimpleTypesArray instantiated from the given items.</returns>
            public static SimpleTypesArray FromItems(in Corvus.Json.JsonSchema.Draft201909.Validation.SimpleTypes value1, in Corvus.Json.JsonSchema.Draft201909.Validation.SimpleTypes value2, in Corvus.Json.JsonSchema.Draft201909.Validation.SimpleTypes value3)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
                builder.Add(value2.AsAny);
            ...
            public static SimpleTypesArray FromItems(params Corvus.Json.JsonSchema.Draft201909.Validation.SimpleTypes[] value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (Corvus.Json.JsonSchema.Draft201909.Validation.SimpleTypes item in value)
                {
            ...
            /// <param name = "value">The value from which to construct the instance.</param>
            /// <returns>A JsonAny instantiated from the given items.</returns>
            public static SimpleTypesArray FromRange(IEnumerable<Corvus.Json.JsonSchema.Draft201909.Validation.SimpleTypes> value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (Corvus.Json.JsonSchema.Draft201909.Validation.SimpleTypes item in value)
                {
            ...
            /// <inheritdoc/>
            public JsonArrayEnumerator<Corvus.Json.JsonSchema.Draft201909.Validation.SimpleTypes> EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new JsonArrayEnumerator<Corvus.Json.JsonSchema.Draft201909.Validation.SimpleTypes>(this.jsonElementBacking);
                }

                if ((this.backing & Backing.Array) != 0)
                {
                    return new JsonArrayEnumerator<Corvus.Json.JsonSchema.Draft201909.Validation.SimpleTypes>(this.arrayBacking);
                }
