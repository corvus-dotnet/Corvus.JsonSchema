...
public readonly partial struct Applicator
{
    ...
    public readonly partial struct SchemaArray
    {
        ...
        public SchemaArray Add<TItem1>(in TItem1 item1)
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public SchemaArray Add<TItem1, TItem2>(in TItem1 item1, in TItem2 item2)
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public SchemaArray Insert<TItem1>(int index, in TItem1 item1)
            where TItem1 : struct, IJsonValue<TItem1>
        {
        ...
        /// <inheritdoc/>
        public SchemaArray Replace<TItem>(in TItem oldValue, in TItem newValue)
        ...
        /// <inheritdoc/>
        public SchemaArray SetItem<TItem>(int index, in TItem value)
            where TItem : struct, IJsonValue
        {
