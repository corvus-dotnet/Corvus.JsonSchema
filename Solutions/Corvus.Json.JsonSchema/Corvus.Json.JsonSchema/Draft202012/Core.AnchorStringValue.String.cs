...
public readonly partial struct Core
{
    ...
    /// </summary>
    public readonly partial struct AnchorStringValue : IJsonString<AnchorStringValue>
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public AnchorStringValue(in ReadOnlySpan<char> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.String;
        ...
        public AnchorStringValue(in ReadOnlySpan<byte> utf8Value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.String;
