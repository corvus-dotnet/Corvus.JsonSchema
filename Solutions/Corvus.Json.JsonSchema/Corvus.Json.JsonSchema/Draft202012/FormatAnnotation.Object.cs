...
/// </summary>
public readonly partial struct FormatAnnotation : IJsonObject<FormatAnnotation>
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "FormatAnnotation"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public FormatAnnotation(ImmutableDictionary<JsonPropertyName, JsonAny> value)
    {
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static FormatAnnotation FromProperties(ImmutableDictionary<JsonPropertyName, JsonAny> source)
    {
        return new(source);
    }
