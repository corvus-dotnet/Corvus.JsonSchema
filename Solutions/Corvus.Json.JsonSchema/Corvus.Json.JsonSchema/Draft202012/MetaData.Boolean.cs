...
/// </summary>
public readonly partial struct MetaData : IJsonBoolean<MetaData>
{
    /// <summary>
    ...
    public static implicit operator JsonBoolean(MetaData value)
    {
    ...
    public static implicit operator bool (MetaData value)
    {
