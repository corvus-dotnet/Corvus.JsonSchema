...
public readonly partial struct Schema
{
    private ValidationContext ValidateAllOf(in ValidationContext validationContext, ValidationLevel level)
    {
        ...
        ValidationContext allOfResult0 = this.As<Corvus.Json.JsonSchema.Draft202012.Core>().Validate(validationContext.CreateChildContext(), level);
        ...
        ValidationContext allOfResult1 = this.As<Corvus.Json.JsonSchema.Draft202012.Applicator>().Validate(validationContext.CreateChildContext(), level);
        ...
        ValidationContext allOfResult2 = this.As<Corvus.Json.JsonSchema.Draft202012.Unevaluated>().Validate(validationContext.CreateChildContext(), level);
        ...
        ValidationContext allOfResult3 = this.As<Corvus.Json.JsonSchema.Draft202012.Validation>().Validate(validationContext.CreateChildContext(), level);
        ...
        ValidationContext allOfResult4 = this.As<Corvus.Json.JsonSchema.Draft202012.MetaData>().Validate(validationContext.CreateChildContext(), level);
        ...
        ValidationContext allOfResult5 = this.As<Corvus.Json.JsonSchema.Draft202012.FormatAnnotation>().Validate(validationContext.CreateChildContext(), level);
        ...
        if (level > ValidationLevel.Basic)
        {
            result = result.PushValidationLocationArrayIndex(6);
        }

        ValidationContext allOfResult6 = this.As<Corvus.Json.JsonSchema.Draft202012.Content>().Validate(validationContext.CreateChildContext(), level);
