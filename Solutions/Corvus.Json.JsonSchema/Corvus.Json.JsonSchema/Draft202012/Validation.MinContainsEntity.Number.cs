...
public readonly partial struct Validation
{
    ...
    public readonly partial struct MinContainsEntity : IJsonNumber<MinContainsEntity>
    {
        ...
        public MinContainsEntity(short value)
        ...
        /// </summary>
        /// <param name="value">The value from which to initialize the number.</param>
        public MinContainsEntity(sbyte value)
            : this(new BinaryJsonNumber(value))
        {
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to initialize the number.</param>
        public MinContainsEntity(ushort value)
            : this(new BinaryJsonNumber(value))
        {
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to initialize the number.</param>
        public MinContainsEntity(uint value)
            : this(new BinaryJsonNumber(value))
        {
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to initialize the number.</param>
        public MinContainsEntity(ulong value)
            : this(new BinaryJsonNumber(value))
        {
        }
