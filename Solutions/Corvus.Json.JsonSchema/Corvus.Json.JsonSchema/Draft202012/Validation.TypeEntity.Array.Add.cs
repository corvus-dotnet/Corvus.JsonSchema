...
public readonly partial struct Validation
{
    ...
    public readonly partial struct TypeEntity
    {
        ...
        public TypeEntity Add<TItem1>(in TItem1 item1)
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public TypeEntity Add<TItem1, TItem2>(in TItem1 item1, in TItem2 item2)
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public TypeEntity Insert<TItem1>(int index, in TItem1 item1)
            where TItem1 : struct, IJsonValue<TItem1>
        {
        ...
        /// <inheritdoc/>
        public TypeEntity Replace<TItem>(in TItem oldValue, in TItem newValue)
        ...
        /// <inheritdoc/>
        public TypeEntity SetItem<TItem>(int index, in TItem value)
            where TItem : struct, IJsonValue
        {
