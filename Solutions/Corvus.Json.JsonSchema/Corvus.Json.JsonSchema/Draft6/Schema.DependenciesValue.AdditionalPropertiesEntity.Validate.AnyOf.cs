    ...
    public readonly partial struct DependenciesValue
    {
        ...
        public readonly partial struct AdditionalPropertiesEntity
        {
            private ValidationContext ValidateAnyOf(in ValidationContext validationContext, ValidationLevel level)
            {
                ...
                ValidationContext anyOfResult0 = this.As<Corvus.Json.JsonSchema.Draft6.Schema>().Validate(validationContext.CreateChildContext(), level);
                ...
                ValidationContext anyOfResult1 = this.As<Corvus.Json.JsonSchema.Draft6.Schema.JsonStringArray>().Validate(validationContext.CreateChildContext(), level);
