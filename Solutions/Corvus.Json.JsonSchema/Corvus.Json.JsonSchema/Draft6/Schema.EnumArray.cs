...
public readonly partial struct Schema
{
    ...
    /// </summary>
    [System.Text.Json.Serialization.JsonConverter(typeof(Corvus.Json.Internal.JsonValueConverter<EnumArray>))]
    public readonly partial struct EnumArray
    {
        ...
        /// </summary>
        public static EnumArray Undefined { get; }
        /// <summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static EnumArray IJsonValue<EnumArray>.FromBoolean<TValue>(in TValue value)
        {
            if (value.HasJsonElementBacking)
            {
                return new(value.AsJsonElement);
        ...
        /// <remarks>This will be EnumArray.Undefined if the type is not compatible.</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static EnumArray IJsonValue<EnumArray>.FromString<TValue>(in TValue value)
        {
            if (value.HasJsonElementBacking)
            {
                return new(value.AsJsonElement);
        ...
        /// <remarks>This will be EnumArray.Undefined if the type is not compatible.</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static EnumArray IJsonValue<EnumArray>.FromNumber<TValue>(in TValue value)
        {
            if (value.HasJsonElementBacking)
            {
                return new(value.AsJsonElement);
        ...
        /// <remarks>This will be EnumArray.Undefined if the type is not compatible.</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static EnumArray IJsonValue<EnumArray>.FromObject<TValue>(in TValue value)
        {
            if (value.HasJsonElementBacking)
            {
                return new(value.AsJsonElement);
        ...
        static EnumArray ParseValue(ReadOnlySpan<char> buffer)
        {
            return IJsonValue<EnumArray>.ParseValue(buffer);
        }
        ...
        /// <param name = "buffer">The buffer from which to parse the value.</param>
        /// <returns>The parsed value.</returns>
        static EnumArray ParseValue(ReadOnlySpan<byte> buffer)
        {
            return IJsonValue<EnumArray>.ParseValue(buffer);
        }
        ...
        /// <returns>The parsed value.</returns>
        static EnumArray ParseValue(ref Utf8JsonReader reader)
        {
            return IJsonValue<EnumArray>.ParseValue(ref reader);
        }
        ...
        /// <inheritdoc/>
        public bool Equals(in EnumArray other)
        {
            return JsonValueHelpers.CompareValues(this, other);
        }
