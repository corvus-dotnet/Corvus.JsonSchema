...
public readonly partial struct Schema
{
    ...
    public readonly partial struct MultipleOfEntity : IJsonNumber<MultipleOfEntity>
    {
        ...
        public static implicit operator float (MultipleOfEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static implicit operator int (MultipleOfEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static implicit operator uint (MultipleOfEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static implicit operator ushort (MultipleOfEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static implicit operator ulong (MultipleOfEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static implicit operator byte (MultipleOfEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static implicit operator sbyte (MultipleOfEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
