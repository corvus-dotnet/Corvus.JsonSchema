...
public readonly partial struct Schema
{
    ...
    public readonly partial struct NonNegativeIntegerDefault0
    {
        ...
        public Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeInteger AsNonNegativeInteger
        {
            get
            {
                return (Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeInteger)this;
            }
        }

        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref = "Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeInteger"/>.
        /// </summary>
        public bool IsNonNegativeInteger
        {
            get
            {
                return ((Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeInteger)this).IsValid();
            }
        }
        ...
        {
            result = (Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeInteger)this;
