...
public readonly partial struct Schema
{
    ...
    public readonly partial struct NonNegativeIntegerDefault0Entity
    {
        private ValidationContext ValidateAllOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext allOfResult0 = this.As<Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerValue>().Validate(validationContext.CreateChildContext(), level);
            ...
            ValidationContext allOfResult1 = this.As<Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0Entity.AllOf1Entity>().Validate(validationContext.CreateChildContext(), level);
