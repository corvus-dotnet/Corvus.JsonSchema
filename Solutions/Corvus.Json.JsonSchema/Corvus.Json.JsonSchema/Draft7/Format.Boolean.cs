...
/// </summary>
public readonly partial struct Format : IJsonBoolean<Format>
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "Format"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public Format(bool value)
    {
    ...
    public static implicit operator JsonBoolean(Format value)
    {
    ...
    public static implicit operator bool (Format value)
    {
