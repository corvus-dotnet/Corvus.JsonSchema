    ...
    public readonly partial struct DependenciesEntity
    {
        ...
        public readonly partial struct AdditionalPropertiesEntity
        {
            private ValidationContext ValidateAnyOf(in ValidationContext validationContext, ValidationLevel level)
            {
                ...
                ValidationContext anyOfResult0 = this.As<Corvus.Json.JsonSchema.Draft7.Schema>().Validate(childContext0.CreateChildContext(), level);
                ...
                ValidationContext anyOfResult1 = this.As<Corvus.Json.JsonSchema.Draft7.Schema.StringArray>().Validate(childContext1.CreateChildContext(), level);
