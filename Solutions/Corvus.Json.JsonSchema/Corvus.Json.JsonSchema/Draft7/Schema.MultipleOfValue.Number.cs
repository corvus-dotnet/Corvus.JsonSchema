...
public readonly partial struct Schema
{
    ...
    /// </summary>
    public readonly partial struct MultipleOfValue : IJsonNumber<MultipleOfValue>
    {
        /// <summary>
        ...
        public static implicit operator JsonNumber(MultipleOfValue value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator MultipleOfValue(uint value)
        {
            return new(value);
        }
        ...
        public static implicit operator uint (MultipleOfValue value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator MultipleOfValue(ushort value)
        {
            return new(value);
        }
        ...
        public static implicit operator ushort (MultipleOfValue value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator MultipleOfValue(ulong value)
        {
            return new(value);
        }
        ...
        public static implicit operator ulong (MultipleOfValue value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator MultipleOfValue(byte value)
        {
            return new(value);
        }
        ...
        public static implicit operator byte (MultipleOfValue value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator MultipleOfValue(sbyte value)
        {
            return new(value);
        }
        ...
        public static implicit operator sbyte (MultipleOfValue value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
