...
public readonly partial struct Schema
{
    public readonly partial struct NonNegativeIntegerDefault0
    {
        ...
        /// </summary>
        public readonly partial struct AllOf1Entity : IJsonBoolean<AllOf1Entity>
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "AllOf1Entity"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public AllOf1Entity(bool value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator AllOf1Entity(JsonBoolean value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator AllOf1Entity(bool value)
            {
                return new(value);
            }
            ...
            public static implicit operator bool (AllOf1Entity value)
            {
