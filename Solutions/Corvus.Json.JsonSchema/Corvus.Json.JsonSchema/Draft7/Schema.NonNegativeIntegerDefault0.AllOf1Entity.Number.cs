...
public readonly partial struct Schema
{
    public readonly partial struct NonNegativeIntegerDefault0
    {
        ...
        public readonly partial struct AllOf1Entity : IJsonNumber<AllOf1Entity>
        {
            ...
            public AllOf1Entity(BinaryJsonNumber value)
            {
            ...
            public AllOf1Entity(short value)
            ...
            /// </summary>
            /// <param name="value">The value from which to initialize the number.</param>
            public AllOf1Entity(sbyte value)
                : this(new BinaryJsonNumber(value))
            {
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to initialize the number.</param>
            public AllOf1Entity(ushort value)
                : this(new BinaryJsonNumber(value))
            {
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to initialize the number.</param>
            public AllOf1Entity(uint value)
                : this(new BinaryJsonNumber(value))
            {
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to initialize the number.</param>
            public AllOf1Entity(ulong value)
                : this(new BinaryJsonNumber(value))
            {
            }
