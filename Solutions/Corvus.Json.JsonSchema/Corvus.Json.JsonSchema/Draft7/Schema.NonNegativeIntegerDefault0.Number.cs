...
public readonly partial struct Schema
{
    ...
    public readonly partial struct NonNegativeIntegerDefault0 : IJsonNumber<NonNegativeIntegerDefault0>
    {
        ...
        public static implicit operator float (NonNegativeIntegerDefault0 value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static implicit operator int (NonNegativeIntegerDefault0 value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static implicit operator long (NonNegativeIntegerDefault0 value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static implicit operator uint (NonNegativeIntegerDefault0 value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static implicit operator ushort (NonNegativeIntegerDefault0 value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static implicit operator ulong (NonNegativeIntegerDefault0 value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static implicit operator byte (NonNegativeIntegerDefault0 value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static implicit operator sbyte (NonNegativeIntegerDefault0 value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
