...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PropertiesEntity
    {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator PropertiesEntity(Corvus.Json.JsonSchema.Draft7.Schema.SchemaArray value)
        {
            if (value.HasJsonElementBacking)
            {
                return new(value.AsJsonElement);
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator Corvus.Json.JsonSchema.Draft7.Schema.SchemaArray(PropertiesEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
                return new(value.AsJsonElement);
