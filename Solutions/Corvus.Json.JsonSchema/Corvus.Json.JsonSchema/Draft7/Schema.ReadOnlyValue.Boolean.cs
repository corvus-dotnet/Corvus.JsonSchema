...
public readonly partial struct Schema
{
    ...
    /// </summary>
    public readonly partial struct ReadOnlyValue : IJsonBoolean<ReadOnlyValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ReadOnlyValue"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ReadOnlyValue(bool value)
        {
        ...
        public static implicit operator JsonBoolean(ReadOnlyValue value)
        {
