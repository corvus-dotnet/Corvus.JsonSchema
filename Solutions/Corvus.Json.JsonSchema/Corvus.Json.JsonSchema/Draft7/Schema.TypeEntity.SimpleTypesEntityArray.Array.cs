...
public readonly partial struct Schema
{
    public readonly partial struct TypeEntity
    {
        ...
        public readonly partial struct SimpleTypesEntityArray : IJsonArray<SimpleTypesEntityArray>
        {
            ...
            public static SimpleTypesEntityArray FromItems(in Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypesEntity value1)
            {
            ...
            /// <returns>A SimpleTypesEntityArray instantiated from the given items.</returns>
            public static SimpleTypesEntityArray FromItems(in Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypesEntity value1, in Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypesEntity value2)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
            ...
            /// <returns>A SimpleTypesEntityArray instantiated from the given items.</returns>
            public static SimpleTypesEntityArray FromItems(in Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypesEntity value1, in Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypesEntity value2, in Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypesEntity value3)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
                builder.Add(value2.AsAny);
            ...
            public static SimpleTypesEntityArray FromItems(params Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypesEntity[] value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// <inheritdoc/>
            public JsonArrayEnumerator<Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypesEntity> EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new JsonArrayEnumerator<Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypesEntity>(this.jsonElementBacking);
                }

                if ((this.backing & Backing.Array) != 0)
                {
                    return new JsonArrayEnumerator<Corvus.Json.JsonSchema.Draft7.Schema.SimpleTypesEntity>(this.arrayBacking);
                }
