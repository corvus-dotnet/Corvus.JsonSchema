...
public readonly partial struct Schema
{
    private ValidationContext ValidateAllOf(in ValidationContext validationContext, ValidationLevel level)
    {
        ...
        ValidationContext allOfResult0 = this.As<Corvus.Json.JsonSchema.Draft7.Core>().Validate(validationContext.CreateChildContext(), level);
        ...
        ValidationContext allOfResult1 = this.As<Corvus.Json.JsonSchema.Draft7.Applicator>().Validate(validationContext.CreateChildContext(), level);
        ...
        ValidationContext allOfResult2 = this.As<Corvus.Json.JsonSchema.Draft7.Validation>().Validate(validationContext.CreateChildContext(), level);
        ...
        ValidationContext allOfResult3 = this.As<Corvus.Json.JsonSchema.Draft7.MetaData>().Validate(validationContext.CreateChildContext(), level);
        ...
        ValidationContext allOfResult4 = this.As<Corvus.Json.JsonSchema.Draft7.Format>().Validate(validationContext.CreateChildContext(), level);
        ...
        ValidationContext allOfResult5 = this.As<Corvus.Json.JsonSchema.Draft7.Content>().Validate(validationContext.CreateChildContext(), level);
