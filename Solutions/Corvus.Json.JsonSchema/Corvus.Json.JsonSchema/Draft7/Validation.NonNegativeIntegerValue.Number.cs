...
public readonly partial struct Validation
{
    ...
    /// </summary>
    public readonly partial struct NonNegativeIntegerValue : IJsonNumber<NonNegativeIntegerValue>
    {
        /// <summary>
        ...
        public static implicit operator JsonNumber(NonNegativeIntegerValue value)
        {
        ...
        public static implicit operator double (NonNegativeIntegerValue value)
        {
        ...
        public static implicit operator float (NonNegativeIntegerValue value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator NonNegativeIntegerValue(uint value)
        {
            return new(value);
        }
        ...
        public static implicit operator uint (NonNegativeIntegerValue value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator NonNegativeIntegerValue(ushort value)
        {
            return new(value);
        }
        ...
        public static implicit operator ushort (NonNegativeIntegerValue value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator NonNegativeIntegerValue(ulong value)
        {
            return new(value);
        }
        ...
        public static implicit operator ulong (NonNegativeIntegerValue value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator NonNegativeIntegerValue(byte value)
        {
            return new(value);
        }
        ...
        public static implicit operator byte (NonNegativeIntegerValue value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator NonNegativeIntegerValue(sbyte value)
        {
            return new(value);
        }
        ...
        public static implicit operator sbyte (NonNegativeIntegerValue value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
