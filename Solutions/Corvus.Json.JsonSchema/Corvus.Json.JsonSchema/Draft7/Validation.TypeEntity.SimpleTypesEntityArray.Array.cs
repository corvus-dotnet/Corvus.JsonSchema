...
public readonly partial struct Validation
{
    public readonly partial struct TypeEntity
    {
        ...
        public readonly partial struct SimpleTypesEntityArray : IJsonArray<SimpleTypesEntityArray>
        {
            ...
            public static SimpleTypesEntityArray FromItems(in Corvus.Json.JsonSchema.Draft7.Validation.SimpleTypesEntity value1)
            {
            ...
            /// <returns>A SimpleTypesEntityArray instantiated from the given items.</returns>
            public static SimpleTypesEntityArray FromItems(in Corvus.Json.JsonSchema.Draft7.Validation.SimpleTypesEntity value1, in Corvus.Json.JsonSchema.Draft7.Validation.SimpleTypesEntity value2)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
            ...
            /// <returns>A SimpleTypesEntityArray instantiated from the given items.</returns>
            public static SimpleTypesEntityArray FromItems(in Corvus.Json.JsonSchema.Draft7.Validation.SimpleTypesEntity value1, in Corvus.Json.JsonSchema.Draft7.Validation.SimpleTypesEntity value2, in Corvus.Json.JsonSchema.Draft7.Validation.SimpleTypesEntity value3)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
                builder.Add(value2.AsAny);
            ...
            public static SimpleTypesEntityArray FromItems(params Corvus.Json.JsonSchema.Draft7.Validation.SimpleTypesEntity[] value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (Corvus.Json.JsonSchema.Draft7.Validation.SimpleTypesEntity item in value)
                {
            ...
            /// <inheritdoc/>
            public JsonArrayEnumerator<Corvus.Json.JsonSchema.Draft7.Validation.SimpleTypesEntity> EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new JsonArrayEnumerator<Corvus.Json.JsonSchema.Draft7.Validation.SimpleTypesEntity>(this.jsonElementBacking);
                }

                if ((this.backing & Backing.Array) != 0)
                {
                    return new JsonArrayEnumerator<Corvus.Json.JsonSchema.Draft7.Validation.SimpleTypesEntity>(this.arrayBacking);
                }
