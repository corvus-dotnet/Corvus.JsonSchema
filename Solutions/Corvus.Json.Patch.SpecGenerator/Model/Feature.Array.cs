...
public readonly partial struct Feature
    : IJsonArray<Corvus.Json.Patch.SpecGenerator.Feature>,
      IReadOnlyCollection<Corvus.Json.Patch.SpecGenerator.Scenario>
{
    /// <summary>
    /// Gets an empty array.
    /// </summary>
    public static Feature EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
    ...
    /// <inheritdoc/>
    Corvus.Json.JsonAny IJsonArray<Feature>.this[int index]
    {
        get
        {
    ...
    public Corvus.Json.Patch.SpecGenerator.Scenario this[int index]
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Array) != 0)
            {
                try
                {
                    return this.arrayBacking[index].As<Corvus.Json.Patch.SpecGenerator.Scenario>();
                }
                catch (ArgumentOutOfRangeException ex)
                {
                    throw new IndexOutOfRangeException(ex.Message, ex);
    ...
    public static implicit operator Feature(ImmutableList<JsonAny> value)
    {
        return new(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator ImmutableList<JsonAny>(Feature value)
    {
        return
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator Feature(JsonArray value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonArray(Feature value)
    {
        return
            value.AsArray;
    }
    ...
    /// <summary>
    /// Create an new instance of the <see cref="Feature"/>" struct from a span of items.
    /// </summary>
    ...
    public static Feature FromItems(params Corvus.Json.Patch.SpecGenerator.Scenario[] items)
    {
        return new([..items]);
    }
    ...
    public static Feature FromItems(in Corvus.Json.Patch.SpecGenerator.Scenario item1)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static Feature FromItems(in Corvus.Json.Patch.SpecGenerator.Scenario item1, in Corvus.Json.Patch.SpecGenerator.Scenario item2)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static Feature FromItems(in Corvus.Json.Patch.SpecGenerator.Scenario item1, in Corvus.Json.Patch.SpecGenerator.Scenario item2, in Corvus.Json.Patch.SpecGenerator.Scenario item3)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static Feature FromItems(in Corvus.Json.Patch.SpecGenerator.Scenario item1, in Corvus.Json.Patch.SpecGenerator.Scenario item2, in Corvus.Json.Patch.SpecGenerator.Scenario item3, in Corvus.Json.Patch.SpecGenerator.Scenario item4)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static Feature FromItems(in Corvus.Json.Patch.SpecGenerator.Scenario item1, in Corvus.Json.Patch.SpecGenerator.Scenario item2, in Corvus.Json.Patch.SpecGenerator.Scenario item3, in Corvus.Json.Patch.SpecGenerator.Scenario item4, in Corvus.Json.Patch.SpecGenerator.Scenario item5)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static Feature FromItems(in Corvus.Json.Patch.SpecGenerator.Scenario item1, in Corvus.Json.Patch.SpecGenerator.Scenario item2, in Corvus.Json.Patch.SpecGenerator.Scenario item3, in Corvus.Json.Patch.SpecGenerator.Scenario item4, in Corvus.Json.Patch.SpecGenerator.Scenario item5, in Corvus.Json.Patch.SpecGenerator.Scenario item6)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static Feature FromItems(in Corvus.Json.Patch.SpecGenerator.Scenario item1, in Corvus.Json.Patch.SpecGenerator.Scenario item2, in Corvus.Json.Patch.SpecGenerator.Scenario item3, in Corvus.Json.Patch.SpecGenerator.Scenario item4, in Corvus.Json.Patch.SpecGenerator.Scenario item5, in Corvus.Json.Patch.SpecGenerator.Scenario item6, in Corvus.Json.Patch.SpecGenerator.Scenario item7)
    {
    ...
    public static Feature FromRange(IEnumerable<Corvus.Json.Patch.SpecGenerator.Scenario> items)
    {
        return new([..items]);
    }
    ...
    /// <param name="items">The items from which to construct the instance.</param>
    /// <returns>An instance of the array constructed from the items .</returns>
    static Feature IJsonArray<Feature>.FromRange(IEnumerable<JsonAny> items)
    {
        return new([..items]);
    }
    ...
    /// <param name="items">The items from which to construct the instance.</param>
    /// <returns>An instance of the array constructed from the items.</returns>
    static Feature IJsonArray<Feature>.FromRange<T>(IEnumerable<T> items)
    {
    ...
    /// <inheritdoc/>
    IEnumerator<Corvus.Json.Patch.SpecGenerator.Scenario> IEnumerable<Corvus.Json.Patch.SpecGenerator.Scenario>.GetEnumerator() => this.EnumerateArray();
    ...
    /// <inheritdoc/>
    public JsonArrayEnumerator<Corvus.Json.Patch.SpecGenerator.Scenario> EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
            return new(this.jsonElementBacking);
    ...
    /// <inheritdoc/>
    JsonArrayEnumerator IJsonArray<Feature>.EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
            return new(this.jsonElementBacking);
    ...
    /// <inheritdoc/>
    JsonArrayEnumerator<TItem> IJsonArray<Feature>.EnumerateArray<TItem>()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
            return new(this.jsonElementBacking);
    ...
    /// <inheritdoc/>
    Feature IJsonArray<Feature>.AddRange<TArray>(in TArray items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    Feature IJsonArray<Feature>.InsertRange<TArray>(int index, in TArray items)
    {
    ...
    /// <inheritdoc/>
    Feature IJsonArray<Feature>.Remove(in JsonAny oldValue)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
    }

    /// <inheritdoc/>
    Feature IJsonArray<Feature>.RemoveAt(int index)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
    }

    /// <inheritdoc/>
    Feature IJsonArray<Feature>.RemoveRange(int index, int count)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, count));
    }

    /// <inheritdoc/>
    public Feature Remove(in Corvus.Json.Patch.SpecGenerator.Scenario oldValue)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
    }
    ...
    private static class __CorvusArrayHelpers
    {
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        public static ImmutableList<JsonAny> GetImmutableList(in Feature arrayInstance)
        {
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in Feature arrayInstance)
        {
        ...
        public static ImmutableList<JsonAny> GetImmutableListSetting(in Feature arrayInstance, int index, in JsonAny value)
        {
            if ((arrayInstance.backing & Backing.JsonElement) != 0)
            {
                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        public static ImmutableList<JsonAny> GetImmutableListReplacing(in Feature arrayInstance, in JsonAny oldItem, in JsonAny newItem)
        {
            if ((arrayInstance.backing & Backing.JsonElement) != 0)
            {
                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        public static ImmutableList<JsonAny> GetImmutableListWithout(in Feature arrayInstance, in JsonAny item)
        {
            if ((arrayInstance.backing & Backing.JsonElement) != 0)
            {
                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
        public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in Feature arrayInstance, int index, int count)
        {
            if ((arrayInstance.backing & Backing.JsonElement) != 0)
            {
                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
        ...
        // <exception cref = "InvalidOperationException">The value is not an array.</exception>
        // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
        public static ImmutableList<JsonAny> GetImmutableListWith(in Feature arrayInstance, int index, in JsonAny value)
        {
            if ((arrayInstance.backing & Backing.JsonElement) != 0)
            {
                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
        public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in Feature arrayInstance, int index, TEnumerable values)
