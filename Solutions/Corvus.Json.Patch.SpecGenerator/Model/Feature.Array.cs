...
public readonly partial struct Feature : IJsonArray<Feature>
{
    ...
    /// Gets an empty array.
    /// </summary>
    public static readonly Feature EmptyArray = From(ImmutableList<JsonAny>.Empty);
    /// <summary>
    ...
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public Feature(IEnumerable<JsonAny> value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.Array;
    ...
    /// <inheritdoc/>
    JsonAny IJsonArray<Feature>.this[int index]
    {
        get
        {
    ...
    public Corvus.Json.Patch.SpecGenerator.Scenario this[int index]
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new Corvus.Json.Patch.SpecGenerator.Scenario(this.jsonElementBacking[index]);
            }
    ...
    /// <returns>A Feature instantiated from the given items.</returns>
    public static Feature FromItems(in Corvus.Json.Patch.SpecGenerator.Scenario value1)
    {
    ...
    /// <returns>A Feature instantiated from the given items.</returns>
    public static Feature FromItems(in Corvus.Json.Patch.SpecGenerator.Scenario value1, in Corvus.Json.Patch.SpecGenerator.Scenario value2)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1.AsAny);
    ...
    /// <returns>A Feature instantiated from the given items.</returns>
    public static Feature FromItems(in Corvus.Json.Patch.SpecGenerator.Scenario value1, in Corvus.Json.Patch.SpecGenerator.Scenario value2, in Corvus.Json.Patch.SpecGenerator.Scenario value3)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1.AsAny);
        builder.Add(value2.AsAny);
    ...
    public static Feature FromItems(params Corvus.Json.Patch.SpecGenerator.Scenario[] value)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
    ...
    /// <param name = "value">The value from which to construct the instance.</param>
    /// <returns>A JsonAny instantiated from the given items.</returns>
    public static Feature FromRange(IEnumerable<Corvus.Json.Patch.SpecGenerator.Scenario> value)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        foreach (Corvus.Json.Patch.SpecGenerator.Scenario item in value)
        {
    ...
    /// </remarks>
    public static Feature From<T>(IEnumerable<T> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
    ...
    /// other overloads which avoid this serialization step.
    /// </remarks>
    public static Feature FromRange(IEnumerable<JsonAny> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
    ...
    /// other overloads which avoid this serialization step.
    /// </remarks>
    public static Feature FromRange<T>(IEnumerable<T> items)
    ...
    public JsonArrayEnumerator<Corvus.Json.Patch.SpecGenerator.Scenario> EnumerateArray()
    {
        ...
        if ((this.backing & Backing.Array) != 0)
        {
            return new JsonArrayEnumerator<Corvus.Json.Patch.SpecGenerator.Scenario>(this.arrayBacking);
        }
