...
/// </summary>
public readonly partial struct JsonPatchTestJson : IJsonString<JsonPatchTestJson>
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "JsonPatchTestJson"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public JsonPatchTestJson(string value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public JsonPatchTestJson(in ReadOnlySpan<char> value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.String;
    ...
    public JsonPatchTestJson(in ReadOnlySpan<byte> utf8Value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.String;
    ...
    public static implicit operator JsonString(JsonPatchTestJson value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator JsonPatchTestJson(JsonString value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator JsonPatchTestJson(string value)
    {
        return new(value);
    }
    ...
    public static implicit operator string (JsonPatchTestJson value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator JsonPatchTestJson(ReadOnlySpan<char> value)
    {
        return new(value);
    }
    ...
    /// <param name = "value">The value from which to convert.</param>
    /// <exception cref = "InvalidOperationException">The value was not a string.</exception>
    public static implicit operator ReadOnlySpan<char>(JsonPatchTestJson value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator JsonPatchTestJson(ReadOnlySpan<byte> value)
    {
        return new(value);
    }
