...
/// </summary>
public readonly partial struct ScenarioArray : IJsonArray<ScenarioArray>
{
    /// <summary>
    /// Gets an empty array.
    /// </summary>
    ...
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public ScenarioArray(IEnumerable<JsonAny> value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.Array;
    ...
    /// <returns>A ScenarioArray instantiated from the given items.</returns>
    public static ScenarioArray FromItems(in Corvus.Json.Patch.SpecGenerator.Scenario value1)
    {
    ...
    /// <returns>A ScenarioArray instantiated from the given items.</returns>
    public static ScenarioArray FromItems(in Corvus.Json.Patch.SpecGenerator.Scenario value1, in Corvus.Json.Patch.SpecGenerator.Scenario value2)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1.AsAny);
    ...
    /// <returns>A ScenarioArray instantiated from the given items.</returns>
    public static ScenarioArray FromItems(in Corvus.Json.Patch.SpecGenerator.Scenario value1, in Corvus.Json.Patch.SpecGenerator.Scenario value2, in Corvus.Json.Patch.SpecGenerator.Scenario value3)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1.AsAny);
        builder.Add(value2.AsAny);
    ...
    public static ScenarioArray FromItems(params Corvus.Json.Patch.SpecGenerator.Scenario[] value)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
    ...
    /// <param name = "value">The value from which to construct the instance.</param>
    /// <returns>A JsonAny instantiated from the given items.</returns>
    public static ScenarioArray FromRange(IEnumerable<Corvus.Json.Patch.SpecGenerator.Scenario> value)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        foreach (Corvus.Json.Patch.SpecGenerator.Scenario item in value)
        {
    ...
    /// <inheritdoc/>
    JsonArrayEnumerator IJsonArray<ScenarioArray>.EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <inheritdoc/>
    JsonArrayEnumerator<TItem> IJsonArray<ScenarioArray>.EnumerateArray<TItem>()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
