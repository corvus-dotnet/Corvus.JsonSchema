...

{
    ...
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    public static ScenarioWithError ParseValue(string source)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<ScenarioWithError>.ParseValue(source);
#else
        return JsonValueHelpers.ParseValue<ScenarioWithError>(source.AsSpan());
#endif
    }
    ...
    {
        return
            (obj is IJsonValue jv && this.Equals(jv.As<ScenarioWithError>())) ||
    ...
    {
        return this.Equals(other.As<ScenarioWithError>());
    }
