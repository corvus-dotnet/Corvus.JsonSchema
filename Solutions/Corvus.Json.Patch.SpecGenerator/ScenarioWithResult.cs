...
namespace Corvus.Json.Patch.SpecGenerator
{
    ...
    /// </summary>
    public readonly struct ScenarioWithResult : IJsonObject<ScenarioWithResult>, IEquatable<ScenarioWithResult>
    {
        /// <summary>
        ...
        /// JSON property name for <see cref = "Expected"/>.
        /// </summary>
        public static readonly string ExpectedJsonPropertyName = "expected";
        /// <summary>
        ...
        private static readonly ImmutableDictionary<string, PropertyValidator<ScenarioWithResult>> __CorvusLocalProperties = CreateLocalPropertyValidators();
        ...
        public ScenarioWithResult(JsonElement value)
        {
        ...
        public ScenarioWithResult(ImmutableDictionary<string, JsonAny> value)
        {
        ...
        public ScenarioWithResult(JsonObject jsonObject)
        {
        ...
        public ScenarioWithResult(Corvus.Json.Patch.SpecGenerator.ScenarioCommon conversion)
        {
        ...
        /// Initializes a new instance of the <see cref = "ScenarioWithResult"/> struct.
        /// </summary>
        /// <param name = "conversion">The <see cref = "Corvus.Json.Patch.SpecGenerator.NotDisabled"/> from which to construct the value.</param>
        public ScenarioWithResult(Corvus.Json.Patch.SpecGenerator.NotDisabled conversion)
        {
            if (conversion.HasJsonElement)
            {
                this.jsonElementBacking = conversion.AsJsonElement;
        ...
        public bool IsNotDisabled
        {
            get
            {
                return ((Corvus.Json.Patch.SpecGenerator.NotDisabled)this).Validate().IsValid;
            }
        }
        ...
        public Corvus.Json.JsonAny Expected
        {
            get
            {
                ...
                {
                    if (properties.TryGetValue(ExpectedJsonPropertyName, out JsonAny result))
                    {
                        return result;
                    }
                }
        ...
        {
            return new ScenarioWithResult(value);
        }
        ...
        public static implicit operator Corvus.Json.Patch.SpecGenerator.NotDisabled(ScenarioWithResult value)
        {
            if (value.ValueKind == JsonValueKind.Object)
            {
                return new Corvus.Json.Patch.SpecGenerator.NotDisabled(value.AsObject);
            }
        ...
        public static implicit operator ScenarioWithResult(JsonAny value)
        {
            ...
            {
                return new ScenarioWithResult(value.AsJsonElement);
            }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ScenarioWithResult(JsonObject value)
        {
            return new ScenarioWithResult(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator JsonObject(ScenarioWithResult value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableDictionary<string, JsonAny>(ScenarioWithResult value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ScenarioWithResult(ImmutableDictionary<string, JsonAny> value)
        {
            return new ScenarioWithResult(value);
        }
        ...
        public static bool operator ==(ScenarioWithResult lhs, ScenarioWithResult rhs)
        {
        ...
        public static ScenarioWithResult Create(Corvus.Json.JsonAny expected, Corvus.Json.JsonAny doc, Corvus.Json.JsonAny patch, Corvus.Json.JsonString? comment = null, Corvus.Json.JsonNotAny? disabled = null)
        {
            ...
            builder.Add(ExpectedJsonPropertyName, expected);
        ...
        public ScenarioWithResult WithExpected(Corvus.Json.JsonAny value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public ScenarioWithResult WithDoc(Corvus.Json.JsonAny value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public ScenarioWithResult WithPatch(Corvus.Json.JsonAny value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public ScenarioWithResult WithComment(Corvus.Json.JsonString value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public ScenarioWithResult WithDisabled(Corvus.Json.JsonNotAny value)
        {
        ...
        /// <inheritdoc/>
        public bool Equals(ScenarioWithResult other)
        {
            JsonValueKind valueKind = this.ValueKind;
            if (other.ValueKind != valueKind)
            {
        ...
        /// <inheritdoc/>
        public ScenarioWithResult SetProperty<TValue>(string name, TValue value)
        ...
        /// <inheritdoc/>
        public ScenarioWithResult SetProperty<TValue>(ReadOnlySpan<char> name, TValue value)
            where TValue : struct, IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Object || this.ValueKind == JsonValueKind.Undefined)
            {
        ...
        /// <inheritdoc/>
        public ScenarioWithResult SetProperty<TValue>(ReadOnlySpan<byte> utf8name, TValue value)
            where TValue : struct, IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Object || this.ValueKind == JsonValueKind.Undefined)
            {
        ...
        /// <inheritdoc/>
        public ScenarioWithResult RemoveProperty(string name)
        {
        ...
        /// <inheritdoc/>
        public ScenarioWithResult RemoveProperty(ReadOnlySpan<char> name)
        {
            if (this.ValueKind == JsonValueKind.Object)
            {
                return this.AsObject.RemoveProperty(name);
        ...
        /// <inheritdoc/>
        public ScenarioWithResult RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
            if (this.ValueKind == JsonValueKind.Object)
            {
        ...
        public T As<T>()
            where T : struct, IJsonValue
        {
            return this.As<ScenarioWithResult, T>();
        }
        ...
        private static ImmutableDictionary<string, PropertyValidator<ScenarioWithResult>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<string, PropertyValidator<ScenarioWithResult>>.Builder builder = ImmutableDictionary.CreateBuilder<string, PropertyValidator<ScenarioWithResult>>();
        ...
        private ValidationContext ValidateObject(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            foreach (Property property in this.EnumerateObject())
            {
                ...
                if (__CorvusLocalProperties.TryGetValue(propertyName, out PropertyValidator<ScenarioWithResult>? propertyValidator))
                {
                    ...
                    if (ExpectedJsonPropertyName.Equals(propertyName))
                    {
                        foundExpected = true;
                    }
                }
            ...
            if (!foundExpected)
            {
                ...
                {
                    result = result.WithResult(isValid: false, $"6.5.3. required - required property \"expected\" not present.");
                }
