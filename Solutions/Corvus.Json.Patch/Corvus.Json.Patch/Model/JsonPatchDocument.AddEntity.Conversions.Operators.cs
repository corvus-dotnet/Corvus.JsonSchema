...
public readonly partial struct JsonPatchDocument
{
    ...
    public readonly partial struct AddEntity
    {
        ...
        public static implicit operator AddEntity(Corvus.Json.Patch.Model.JsonPatchDocument.PatchOperationCommonEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator Corvus.Json.Patch.Model.JsonPatchDocument.PatchOperationCommonEntity(AddEntity value)
        {
