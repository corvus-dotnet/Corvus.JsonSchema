...
#endif
{
    ...
    /// Gets an empty array.
    /// </summary>
    public static readonly JsonPatchDocument EmptyArray = From(ImmutableList<JsonAny>.Empty);
    /// <summary>
    /// Initializes a new instance of the <see cref = "JsonPatchDocument"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public JsonPatchDocument(ImmutableList<JsonAny> value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public JsonPatchDocument(IEnumerable<JsonAny> value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.Array;
    ...
    /// <inheritdoc/>
    JsonAny IJsonArray<JsonPatchDocument>.this[int index]
    {
        get
        {
    ...
    public Corvus.Json.Patch.Model.JsonPatchDocument.PatchOperation this[int index]
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new Corvus.Json.Patch.Model.JsonPatchDocument.PatchOperation(this.jsonElementBacking[index]);
            }
    ...
    /// </remarks>
    public static JsonPatchDocument From<T>(IEnumerable<T> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
