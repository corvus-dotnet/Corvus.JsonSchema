...
public readonly partial struct JsonPatchDocument
{
    ...
    public readonly partial struct Copy
    {
        ...
        /// </summary>
        public static string SchemaLocation { get; } = "json-patch.json#/$defs/Copy";
        /// <summary>
        ...
        public static implicit operator Copy(in JsonAny value)
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static Copy IJsonValue<Copy>.FromBoolean<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>This will be Copy.Undefined if the type is not compatible.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static Copy IJsonValue<Copy>.FromString<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>This will be Copy.Undefined if the type is not compatible.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static Copy IJsonValue<Copy>.FromNumber<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <remarks>This will be Copy.Undefined if the type is not compatible.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static Copy IJsonValue<Copy>.FromArray<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
...
#else
            return JsonValueHelpers.ParseValue<Copy>(buffer);
#endif
        }
...
#else
            return JsonValueHelpers.ParseValue<Copy>(ref reader);
#endif
        }
        ...
        public bool Equals(in Copy other)
        {
            return JsonValueHelpers.CompareValues(this, other);
        }
