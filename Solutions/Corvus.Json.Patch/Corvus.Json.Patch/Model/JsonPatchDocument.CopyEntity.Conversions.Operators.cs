...
public readonly partial struct JsonPatchDocument
{
    ...
    public readonly partial struct CopyEntity
    {
        ...
        public static implicit operator CopyEntity(Corvus.Json.Patch.Model.JsonPatchDocument.PatchOperationCommonEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator Corvus.Json.Patch.Model.JsonPatchDocument.PatchOperationCommonEntity(CopyEntity value)
        {
