...
public readonly partial struct JsonPatchDocument
{
    ...
    public readonly partial struct CopyEntity
    {
        ...
        /// Gets Op.
        /// </summary>
        public Corvus.Json.Patch.Model.JsonPatchDocument.CopyEntity.OpEntity Op
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
                        return new Corvus.Json.Patch.Model.JsonPatchDocument.CopyEntity.OpEntity(result);
                    }
                }
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<Corvus.Json.Patch.Model.JsonPatchDocument.CopyEntity.OpEntity>();
                    }
                }
        ...
        /// <summary>
        /// Creates an instance of a <see cref = "CopyEntity"/>.
        /// </summary>
        public static CopyEntity Create(Corvus.Json.JsonPointer from, Corvus.Json.JsonPointer path)
        {
            var builder = ImmutableDictionary.CreateBuilder<JsonPropertyName, JsonAny>();
            builder.Add(FromJsonPropertyName, from.AsAny);
            builder.Add(PathJsonPropertyName, path.AsAny);
            builder.Add(OpJsonPropertyName, new Corvus.Json.Patch.Model.JsonPatchDocument.CopyEntity.OpEntity().AsAny);
        ...
        public CopyEntity WithFrom(in Corvus.Json.JsonPointer value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public CopyEntity WithPath(in Corvus.Json.JsonPointer value)
        {
        ...
        {
            return property.ValueAs<Corvus.Json.Patch.Model.JsonPatchDocument.CopyEntity.OpEntity>().Validate(validationContext, level);
        }
    }
}