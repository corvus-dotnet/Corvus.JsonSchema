...
public readonly partial struct JsonPatchDocument
{
    ...
    public readonly partial struct MoveEntity
    {
        ...
        public static implicit operator MoveEntity(Corvus.Json.Patch.Model.JsonPatchDocument.PatchOperationCommonEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator Corvus.Json.Patch.Model.JsonPatchDocument.PatchOperationCommonEntity(MoveEntity value)
        {
