...
public readonly partial struct JsonPatchDocument
{
    ...
    public readonly partial struct PatchOperationEntity
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref = "PatchOperationEntity"/>.
        /// </summary>
        public static PatchOperationEntity Create(Corvus.Json.JsonPointer path, Corvus.Json.JsonString op)
        {
        ...
        public PatchOperationEntity WithPath(in Corvus.Json.JsonPointer value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public PatchOperationEntity WithOp(in Corvus.Json.JsonString value)
        {
