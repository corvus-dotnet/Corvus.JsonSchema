...
public readonly partial struct JsonPatchDocument
{
    ...
    public readonly partial struct ReplaceEntity
    {
        ...
        public static implicit operator ReplaceEntity(Corvus.Json.Patch.Model.JsonPatchDocument.PatchOperationCommonEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator Corvus.Json.Patch.Model.JsonPatchDocument.PatchOperationCommonEntity(ReplaceEntity value)
        {
