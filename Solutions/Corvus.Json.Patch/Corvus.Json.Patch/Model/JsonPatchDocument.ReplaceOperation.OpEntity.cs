...
public readonly partial struct JsonPatchDocument
{
    ...
    public readonly partial struct ReplaceOperation
    {
...

        {
            ...
            public OpEntity(in JsonElement value)
            {
            ...
            /// </summary>
            public static string SchemaLocation { get; } = "#/$defs/ReplaceOperation/properties/op";

            /// <summary>
            /// Gets a Null instance.
            /// </summary>
            public static OpEntity Null { get; } = new(JsonValueHelpers.NullElement);
            ...
            public static OpEntity FromJson(in JsonElement value)
            {
                return new(value);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OpEntity FromAny(in JsonAny value)
            {
            ...
            /// <returns>An instance of this type, initialized from the provided value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OpEntity FromString<TValue>(in TValue value)
            ...
            public static OpEntity Parse(string source, JsonDocumentOptions options = default)
            {
            ...
            /// <param name="source">The source of the JSON string to parse.</param>
            /// <param name="options">The (optional) JsonDocumentOptions.</param>
            public static OpEntity Parse(Stream source, JsonDocumentOptions options = default)
            {
                using var jsonDocument = JsonDocument.Parse(source, options);
                return new(jsonDocument.RootElement.Clone());
            }
            ...
            /// <param name="source">The source of the JSON string to parse.</param>
            /// <param name="options">The (optional) JsonDocumentOptions.</param>
            public static OpEntity Parse(ReadOnlyMemory<byte> source, JsonDocumentOptions options = default)
            {
                using var jsonDocument = JsonDocument.Parse(source, options);
                return new(jsonDocument.RootElement.Clone());
            }
            ...
            /// <param name="source">The source of the JSON string to parse.</param>
            /// <param name="options">The (optional) JsonDocumentOptions.</param>
            public static OpEntity Parse(ReadOnlyMemory<char> source, JsonDocumentOptions options = default)
            {
                using var jsonDocument = JsonDocument.Parse(source, options);
                return new(jsonDocument.RootElement.Clone());
            }
            ...
            /// <param name="source">The source of the JSON string to parse.</param>
            /// <param name="options">The (optional) JsonDocumentOptions.</param>
            public static OpEntity Parse(ReadOnlySequence<byte> source, JsonDocumentOptions options = default)
            {
                using var jsonDocument = JsonDocument.Parse(source, options);
                return new(jsonDocument.RootElement.Clone());
            }
            ...
            /// </summary>
            /// <param name="source">The source of the JSON string to parse.</param>
            public static OpEntity ParseValue(string source)
            {
#if NET8_0_OR_GREATER
                return IJsonValue<OpEntity>.ParseValue(source);
#else
                return JsonValueHelpers.ParseValue<OpEntity>(source.AsSpan());
#endif
            }
            ...
            /// </summary>
            /// <param name="source">The source of the JSON string to parse.</param>
            public static OpEntity ParseValue(ReadOnlySpan<char> source)
            {
#if NET8_0_OR_GREATER
                return IJsonValue<OpEntity>.ParseValue(source);
#else
                return JsonValueHelpers.ParseValue<OpEntity>(source);
#endif
            }
            ...
            /// </summary>
            /// <param name="source">The source of the JSON string to parse.</param>
            public static OpEntity ParseValue(ReadOnlySpan<byte> source)
            {
#if NET8_0_OR_GREATER
                return IJsonValue<OpEntity>.ParseValue(source);
#else
            ...
            /// </summary>
            /// <param name="source">The source of the JSON string to parse.</param>
            public static OpEntity ParseValue(ref Utf8JsonReader source)
            {
#if NET8_0_OR_GREATER
                return IJsonValue<OpEntity>.ParseValue(ref source);
#else
                return JsonValueHelpers.ParseValue<OpEntity>(ref source);
#endif
            }
...
#else
                return this.As<OpEntity, TTarget>();
#endif
            }
            ...
            {
                return
                    (obj is IJsonValue jv && this.Equals(jv.As<OpEntity>())) ||
            ...
            {
                return this.Equals(other.As<OpEntity>());
            }
