...
public readonly partial struct JsonPatchDocument
{
    ...
    public readonly partial struct TestEntity
    {
        ...
        public static implicit operator TestEntity(Corvus.Json.Patch.Model.JsonPatchDocument.PatchOperationCommonEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator Corvus.Json.Patch.Model.JsonPatchDocument.PatchOperationCommonEntity(TestEntity value)
        {
