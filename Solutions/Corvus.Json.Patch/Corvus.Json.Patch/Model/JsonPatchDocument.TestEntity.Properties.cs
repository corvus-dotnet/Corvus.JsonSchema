...
public readonly partial struct JsonPatchDocument
{
    ...
    public readonly partial struct TestEntity
    {
        ...
        /// Gets Op.
        /// </summary>
        public Corvus.Json.Patch.Model.JsonPatchDocument.TestEntity.OpEntity Op
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
                        return new Corvus.Json.Patch.Model.JsonPatchDocument.TestEntity.OpEntity(result);
                    }
                }
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<Corvus.Json.Patch.Model.JsonPatchDocument.TestEntity.OpEntity>();
                    }
                }
        ...
        /// <summary>
        /// Creates an instance of a <see cref = "TestEntity"/>.
        /// </summary>
        public static TestEntity Create(Corvus.Json.JsonAny value, Corvus.Json.JsonPointer path)
        {
            var builder = ImmutableDictionary.CreateBuilder<JsonPropertyName, JsonAny>();
            builder.Add(ValueJsonPropertyName, value.AsAny);
            builder.Add(PathJsonPropertyName, path.AsAny);
            builder.Add(OpJsonPropertyName, new Corvus.Json.Patch.Model.JsonPatchDocument.TestEntity.OpEntity().AsAny);
        ...
        public TestEntity WithValue(in Corvus.Json.JsonAny value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public TestEntity WithPath(in Corvus.Json.JsonPointer value)
        {
        ...
        {
            return property.ValueAs<Corvus.Json.Patch.Model.JsonPatchDocument.TestEntity.OpEntity>().Validate(validationContext, level);
        }
    }
}