...
public readonly partial struct PatchOperationArray : IJsonArray<PatchOperationArray>
{
    ...
    /// Gets an empty array.
    /// </summary>
    public static readonly PatchOperationArray EmptyArray = FromItems(ImmutableList<JsonAny>.Empty);
    /// <summary>
    ...
    public static PatchOperationArray FromItems(ImmutableList<JsonAny> items)
    {
        return new(items);
    }
