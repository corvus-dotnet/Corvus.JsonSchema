...
/// </summary>
public readonly partial struct PatchOperationArray : IJsonArray<PatchOperationArray>
{
    /// <summary>
    /// Gets an empty array.
    /// </summary>
    public static readonly PatchOperationArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
    /// <summary>
    ...
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public PatchOperationArray(IEnumerable<JsonAny> value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.Array;
    ...
    public static PatchOperationArray From(ImmutableList<JsonAny> items)
    {
        return new(items);
    }
    ...
    /// <returns>A PatchOperationArray instantiated from the given items.</returns>
    public static PatchOperationArray FromItems(in Corvus.Json.Patch.Model.PatchOperation value1)
    {
    ...
    /// <returns>A PatchOperationArray instantiated from the given items.</returns>
    public static PatchOperationArray FromItems(in Corvus.Json.Patch.Model.PatchOperation value1, in Corvus.Json.Patch.Model.PatchOperation value2)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1.AsAny);
    ...
    /// <returns>A PatchOperationArray instantiated from the given items.</returns>
    public static PatchOperationArray FromItems(in Corvus.Json.Patch.Model.PatchOperation value1, in Corvus.Json.Patch.Model.PatchOperation value2, in Corvus.Json.Patch.Model.PatchOperation value3)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1.AsAny);
        builder.Add(value2.AsAny);
    ...
    public static PatchOperationArray FromItems(params Corvus.Json.Patch.Model.PatchOperation[] value)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
    ...
    /// </remarks>
    public static PatchOperationArray From<T>(IEnumerable<T> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
    ...
    /// other overloads which avoid this serialization step.
    /// </remarks>
    public static PatchOperationArray FromRange(IEnumerable<JsonAny> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
    ...
    /// other overloads which avoid this serialization step.
    /// </remarks>
    public static PatchOperationArray FromRange<T>(IEnumerable<T> items)
    ...
    /// <inheritdoc/>
    public JsonArrayEnumerator<Corvus.Json.Patch.Model.PatchOperation> EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
        ...
        if ((this.backing & Backing.Array) != 0)
        {
            return new JsonArrayEnumerator<Corvus.Json.Patch.Model.PatchOperation>(this.arrayBacking);
        }
    ...
    /// <inheritdoc/>
    JsonArrayEnumerator IJsonArray<PatchOperationArray>.EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <inheritdoc/>
    JsonArrayEnumerator<TItem> IJsonArray<PatchOperationArray>.EnumerateArray<TItem>()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
