...
{
    private static readonly ImmutableDictionary<JsonPropertyName, PropertyValidator<Test>> __CorvusLocalProperties = CreateLocalPropertyValidators();
    /// <summary>
    ...
    /// Gets Op.
    /// </summary>
    public Corvus.Json.Patch.Model.Test.OpEntity Op
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Corvus.Json.Patch.Model.Test.OpEntity(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Corvus.Json.Patch.Model.Test.OpEntity>();
                }
            }
    ...
    public static Test Create(Corvus.Json.JsonAny value, Corvus.Json.JsonPointer path)
    {
        ...
        builder.Add(OpJsonPropertyName, new Corvus.Json.Patch.Model.Test.OpEntity().AsAny);
    ...
    private static ImmutableDictionary<JsonPropertyName, PropertyValidator<Test>> CreateLocalPropertyValidators()
    {
        ImmutableDictionary<JsonPropertyName, PropertyValidator<Test>>.Builder builder = ImmutableDictionary.CreateBuilder<JsonPropertyName, PropertyValidator<Test>>();
    ...
    {
        Corvus.Json.Patch.Model.Test.OpEntity property = that.Op;
        return property.Validate(validationContext, level);
    }
}