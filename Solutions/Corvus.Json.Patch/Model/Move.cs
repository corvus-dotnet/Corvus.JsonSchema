...
namespace Corvus.Json.Patch.Model
{
    ...
    public readonly struct Move : IJsonObject<Move>, IEquatable<Move>
    {
        ...
        public Move(Corvus.Json.Patch.Model.PatchOperationCommon conversion)
        {
        ...
        /// {Property examples}.
        /// </example>
        public Corvus.Json.Patch.Model.Move.OpEntity Op
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<string, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new Corvus.Json.Patch.Model.Move.OpEntity(result);
                    }
                }
        ...
        public static implicit operator Move(Corvus.Json.Patch.Model.PatchOperationCommon value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator Corvus.Json.Patch.Model.PatchOperationCommon(Move value)
        {
        ...
        public static Move Create(Corvus.Json.JsonPointer from, Corvus.Json.JsonPointer path)
        {
            ...
            builder.Add(OpJsonPropertyName, new Corvus.Json.Patch.Model.Move.OpEntity());
