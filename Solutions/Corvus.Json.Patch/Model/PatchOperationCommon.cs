...
namespace Corvus.Json.Patch.Model
{
    ...
    /// </summary>
    public readonly struct PatchOperationCommon : IJsonObject<PatchOperationCommon>, IEquatable<PatchOperationCommon>
    {
        /// <summary>
        ...
        private static readonly ImmutableDictionary<string, PropertyValidator<PatchOperationCommon>> __CorvusLocalProperties = CreateLocalPropertyValidators();
        ...
        public PatchOperationCommon(JsonElement value)
        {
        ...
        public PatchOperationCommon(ImmutableDictionary<string, JsonAny> value)
        {
        ...
        public PatchOperationCommon(JsonObject jsonObject)
        {
        ...
        public static implicit operator PatchOperationCommon(JsonAny value)
        {
            ...
            {
                return new PatchOperationCommon(value.AsJsonElement);
            }
        ...
        {
            return new PatchOperationCommon(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableDictionary<string, JsonAny>(PatchOperationCommon value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator PatchOperationCommon(ImmutableDictionary<string, JsonAny> value)
        {
            return new PatchOperationCommon(value);
        }
        ...
        public static bool operator ==(PatchOperationCommon lhs, PatchOperationCommon rhs)
        {
        ...
        public PatchOperationCommon WithPath(Corvus.Json.JsonPointer value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public PatchOperationCommon WithOp(Corvus.Json.JsonString value)
        {
        ...
        /// <inheritdoc/>
        public bool Equals(PatchOperationCommon other)
        {
            JsonValueKind valueKind = this.ValueKind;
            if (other.ValueKind != valueKind)
            {
        ...
        /// <inheritdoc/>
        public PatchOperationCommon SetProperty<TValue>(string name, TValue value)
        ...
        /// <inheritdoc/>
        public PatchOperationCommon SetProperty<TValue>(ReadOnlySpan<char> name, TValue value)
            where TValue : struct, IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Object || this.ValueKind == JsonValueKind.Undefined)
            {
        ...
        /// <inheritdoc/>
        public PatchOperationCommon SetProperty<TValue>(ReadOnlySpan<byte> utf8name, TValue value)
            where TValue : struct, IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Object || this.ValueKind == JsonValueKind.Undefined)
            {
        ...
        /// <inheritdoc/>
        public PatchOperationCommon RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
            if (this.ValueKind == JsonValueKind.Object)
            {
        ...
        public T As<T>()
            where T : struct, IJsonValue
        {
            return this.As<PatchOperationCommon, T>();
        }
        ...
        private static ImmutableDictionary<string, PropertyValidator<PatchOperationCommon>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<string, PropertyValidator<PatchOperationCommon>>.Builder builder = ImmutableDictionary.CreateBuilder<string, PropertyValidator<PatchOperationCommon>>();
        ...
        private ValidationContext ValidateObject(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            foreach (Property property in this.EnumerateObject())
            {
                ...
                if (__CorvusLocalProperties.TryGetValue(propertyName, out PropertyValidator<PatchOperationCommon>? propertyValidator))
                {
                    ...
                    if (PathJsonPropertyName.Equals(propertyName))
                    {
                        foundPath = true;
                    }
