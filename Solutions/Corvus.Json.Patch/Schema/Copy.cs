...
namespace Corvus.Json.Patch
{
    ...
    public readonly struct Copy : IJsonObject<Copy>, IEquatable<Copy>
    {
        ...
        public Copy(Corvus.Json.Patch.PatchOperationCommon conversion)
        {
        ...
        /// {Property examples}.
        /// </example>
        public Corvus.Json.Patch.Copy.OpEntity Op
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<string, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new Corvus.Json.Patch.Copy.OpEntity(result);
                    }
                }
        ...
        public static implicit operator Copy(Corvus.Json.Patch.PatchOperationCommon value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator Corvus.Json.Patch.PatchOperationCommon(Copy value)
        {
        ...
        public static Copy Create(Corvus.Json.JsonPointer from, Corvus.Json.JsonPointer path)
        {
            ...
            builder.Add(OpJsonPropertyName, new Corvus.Json.Patch.Copy.OpEntity());
        ...
        {
            Corvus.Json.Patch.Copy.OpEntity property = that.Op;
            return property.Validate(validationContext, level);
        }
