...
namespace Corvus.Json.Patch
{
    ...
    /// </summary>
    public readonly struct PatchOperationArray : IJsonArray<PatchOperationArray>, IEquatable<PatchOperationArray>
    {
        ...
        public PatchOperationArray(JsonElement value)
        {
        ...
        public PatchOperationArray(ImmutableList<JsonAny> value)
        {
        ...
        public PatchOperationArray(JsonArray jsonArray)
        {
        ...
        public static implicit operator PatchOperationArray(JsonAny value)
        {
            if (value.HasJsonElement)
            {
                return new PatchOperationArray(value.AsJsonElement);
            }

            return value.As<PatchOperationArray>();
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator JsonAny(PatchOperationArray value)
        {
            return value.AsAny;
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator PatchOperationArray(JsonArray value)
        {
            return new PatchOperationArray(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator JsonArray(PatchOperationArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(PatchOperationArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator PatchOperationArray(ImmutableList<JsonAny> value)
        {
            return new PatchOperationArray(value);
        }
        ...
        public static bool operator ==(PatchOperationArray lhs, PatchOperationArray rhs)
        {
        ...
        public static PatchOperationArray From(params Corvus.Json.Patch.PatchOperation[] items)
        {
            ...
            return new PatchOperationArray(builder.ToImmutable());
        }
        ...
        /// <inheritdoc/>
        public bool Equals(PatchOperationArray other)
        {
            JsonValueKind valueKind = this.ValueKind;
            if (other.ValueKind != valueKind)
            {
        ...
        /// <inheritdoc/>
        public PatchOperationArray Add<TItem>(TItem item)
        ...
        /// <inheritdoc/>
        public PatchOperationArray Add<TItem1, TItem2>(TItem1 item1, TItem2 item2)
        ...
        /// <inheritdoc/>
        public PatchOperationArray Add<TItem1, TItem2, TItem3>(TItem1 item1, TItem2 item2, TItem3 item3)
        ...
        /// <inheritdoc/>
        public PatchOperationArray Add<TItem1, TItem2, TItem3, TItem4>(TItem1 item1, TItem2 item2, TItem3 item3, TItem4 item4)
        ...
        /// <inheritdoc/>
        public PatchOperationArray Add<TItem>(params TItem[] items)
            where TItem : struct, IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Array || this.ValueKind == JsonValueKind.Undefined)
            {
        ...
        /// <inheritdoc/>
        public PatchOperationArray AddRange<TItem>(IEnumerable<TItem> items)
            where TItem : struct, IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Array || this.ValueKind == JsonValueKind.Undefined)
            {
        ...
        /// <inheritdoc/>
        public PatchOperationArray Insert<TItem>(int index, TItem item)
            where TItem : struct, IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Array || this.ValueKind == JsonValueKind.Undefined)
            {
        ...
        /// <inheritdoc/>
        public PatchOperationArray Replace<TItem>(TItem oldValue, TItem newValue)
            where TItem : struct, IJsonValue
        {
        ...
        /// <inheritdoc/>
        public PatchOperationArray SetItem<TItem>(int index, TItem value)
            where TItem : struct, IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Array)
            {
        ...
        public T As<T>()
            where T : struct, IJsonValue
        {
            return this.As<PatchOperationArray, T>();
        }
