...
namespace Corvus.Json.Patch
{
    ...
    public readonly struct Remove : IJsonObject<Remove>, IEquatable<Remove>
    {
        ...
        public Remove(Corvus.Json.Patch.PatchOperationCommon conversion)
        {
        ...
        /// {Property examples}.
        /// </example>
        public Corvus.Json.Patch.Remove.OpEntity Op
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<string, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new Corvus.Json.Patch.Remove.OpEntity(result);
                    }
                }
        ...
        public static implicit operator Remove(Corvus.Json.Patch.PatchOperationCommon value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator Corvus.Json.Patch.PatchOperationCommon(Remove value)
        {
        ...
        public static Remove Create(Corvus.Json.JsonPointer path)
        {
            ...
            builder.Add(OpJsonPropertyName, new Corvus.Json.Patch.Remove.OpEntity());
        ...
        {
            Corvus.Json.Patch.Remove.OpEntity property = that.Op;
