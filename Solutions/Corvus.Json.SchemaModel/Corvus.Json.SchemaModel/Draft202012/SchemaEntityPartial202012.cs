// <copyright file="SchemaEntityPartial202012.cs" company="Endjin Limited">
...
/// </summary>
public partial class SchemaEntity202012
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SchemaEntity202012"/> class.
    /// </summary>
    ...
    public SchemaEntity202012(JsonSchemaBuilder jsonSchemaBuilder, TypeDeclaration declarationToGenerate)
    {
    ...
    /// <summary>
    /// Gets a value indicating whether this is a nested type.
    /// </summary>
    public bool IsNested => this.TypeDeclaration.Parent is not null;
    ...
    /// <returns>The formatted text generated from the child.</returns>
    public string WriteNestedType(TypeDeclaration child)
    {
        var sep = new SchemaEntity202012(this.Builder, child);
