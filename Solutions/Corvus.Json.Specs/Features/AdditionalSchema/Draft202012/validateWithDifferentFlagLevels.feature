...
Feature: Validate with different flag levels draft2020-12
...
Examples:
	...
	| "foo"            | false | Verbose  | 181   |
	| null             | false | Flag     | 0     |
	| null             | false | Basic    | 1     |
	| null             | false | Detailed | 1     |
	| null             | false | Verbose  | 169   |
	| -1               | false | Flag     | 0     |
	| 0                | false | Flag     | 0     |
	| 1                | false | Flag     | 0     |
	| 256              | false | Flag     | 0     |
	...
	| 0                | false | Verbose  | 183   |
	| 1                | false | Verbose  | 183   |
	| 256              | false | Verbose  | 181   |
	| -256             | false | Verbose  | 177   |
	| 256.1            | false | Verbose  | 173   |
	| -256.1           | false | Verbose  | 173   |
	| 32769            | false | Verbose  | 180   |
	| -32769           | false | Verbose  | 176   |
	| 32769.1          | false | Verbose  | 173   |
	| -32769.1         | false | Verbose  | 173   |
	| 65536            | false | Verbose  | 178   |
	| -65536           | false | Verbose  | 175   |
	| 65536.1          | false | Verbose  | 172   |
	| -65536.1         | false | Verbose  | 172   |
	| -2147483648      | false | Verbose  | 175   |
	| 2147483648       | false | Verbose  | 177   |
	| -2147483648.1    | false | Verbose  | 172   |
	| 2147483648.1     | false | Verbose  | 172   |
	| true             | false | Verbose  | 169   |
	| [1,2,3]          | false | Verbose  | 169   |
	| { "foo": "bar" } | false | Verbose  | 168   |

Scenario Outline: All of the format types non-asserting
	Given a schema file
		"""
		{
			"oneOf": [
...
Examples:
	...
	| "foo"            | false | Basic    | 1     |
	| "foo"            | false | Detailed | 1     |
	| "foo"            | false | Verbose  | 165   |
	| null             | false | Flag     | 0     |
	| null             | false | Basic    | 1     |
	| null             | false | Detailed | 1     |
	| null             | false | Verbose  | 201   |
	| -1               | false | Flag     | 0     |
	| 0                | false | Flag     | 0     |
	| 1                | false | Flag     | 0     |
	| 256              | false | Flag     | 0     |
	...
	| 0                | false | Verbose  | 173   |
	| 1                | false | Verbose  | 173   |
	| 256              | false | Verbose  | 173   |
	| -256             | false | Verbose  | 173   |
	| 256.1            | false | Verbose  | 173   |
	| -256.1           | false | Verbose  | 173   |
	| 32769            | false | Verbose  | 173   |
	| -32769           | false | Verbose  | 173   |
	| 32769.1          | false | Verbose  | 173   |
	| -32769.1         | false | Verbose  | 173   |
	| 65536            | false | Verbose  | 173   |
	| -65536           | false | Verbose  | 173   |
	| 65536.1          | false | Verbose  | 173   |
	| -65536.1         | false | Verbose  | 173   |
	| -2147483648      | false | Verbose  | 173   |
	| 2147483648       | false | Verbose  | 173   |
	| -2147483648.1    | false | Verbose  | 173   |
	| 2147483648.1     | false | Verbose  | 173   |
	| true             | false | Verbose  | 201   |
	| [1,2,3]          | false | Verbose  | 201   |
	| { "foo": "bar" } | false | Verbose  | 200   |