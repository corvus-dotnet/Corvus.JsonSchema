...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonDate : IJsonBoolean<ExtJsonDate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonDate"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonDate(bool value)
        {
        ...
        public static implicit operator ExtJsonDate(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonDate(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonDate value)
        {
