...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonDuration : IJsonBoolean<ExtJsonDuration>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonDuration"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonDuration(bool value)
        {
        ...
        public static implicit operator ExtJsonDuration(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonDuration(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonDuration value)
        {
