...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonEmail : IJsonBoolean<ExtJsonEmail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonEmail"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonEmail(bool value)
        {
        ...
        public static implicit operator ExtJsonEmail(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonEmail(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonEmail value)
        {
