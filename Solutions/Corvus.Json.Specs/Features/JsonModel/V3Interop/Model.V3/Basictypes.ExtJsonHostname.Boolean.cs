...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonHostname : IJsonBoolean<ExtJsonHostname>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonHostname"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonHostname(bool value)
        {
        ...
        public static implicit operator ExtJsonHostname(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonHostname(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonHostname value)
        {
