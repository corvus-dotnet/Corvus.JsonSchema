...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonInteger : IJsonBoolean<ExtJsonInteger>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonInteger"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonInteger(bool value)
        {
        ...
        public static implicit operator ExtJsonInteger(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonInteger(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonInteger value)
        {
