...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonIpV4 : IJsonBoolean<ExtJsonIpV4>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonIpV4"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonIpV4(bool value)
        {
        ...
        public static implicit operator ExtJsonIpV4(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonIpV4(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonIpV4 value)
        {
