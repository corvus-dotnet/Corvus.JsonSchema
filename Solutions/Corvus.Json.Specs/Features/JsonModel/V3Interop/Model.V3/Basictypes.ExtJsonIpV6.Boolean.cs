...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonIpV6 : IJsonBoolean<ExtJsonIpV6>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonIpV6"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonIpV6(bool value)
        {
        ...
        public static implicit operator ExtJsonIpV6(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonIpV6(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonIpV6 value)
        {
