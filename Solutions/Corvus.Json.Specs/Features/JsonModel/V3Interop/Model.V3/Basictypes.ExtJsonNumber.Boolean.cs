...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonNumber : IJsonBoolean<ExtJsonNumber>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonNumber"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonNumber(bool value)
        {
        ...
        public static implicit operator ExtJsonNumber(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonNumber(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonNumber value)
        {
