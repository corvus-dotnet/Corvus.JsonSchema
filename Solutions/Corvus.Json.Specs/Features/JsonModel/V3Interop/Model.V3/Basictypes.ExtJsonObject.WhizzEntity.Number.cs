...
: IJsonNumber<WhizzEntity>,
  IAdditionOperators<WhizzEntity, WhizzEntity, WhizzEntity>,
  ISubtractionOperators<WhizzEntity, WhizzEntity, WhizzEntity>,
  IMultiplyOperators<WhizzEntity, WhizzEntity, WhizzEntity>,
  IDivisionOperators<WhizzEntity, WhizzEntity, WhizzEntity>,
  IIncrementOperators<WhizzEntity>,
  IDecrementOperators<WhizzEntity>
#else
        : IJsonNumber<WhizzEntity>
#endif
        {
            ...
            public WhizzEntity(in BinaryJsonNumber value)
            {
            ...
            public WhizzEntity(double value) : this(new BinaryJsonNumber(value))
            {
            }
            ...
            public static implicit operator WhizzEntity(JsonNumber value)
            {
            ...
            public static explicit operator byte (WhizzEntity value)
            {
            ...
            public static explicit operator decimal (WhizzEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            public static explicit operator double (WhizzEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            public static explicit operator short (WhizzEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            public static explicit operator int (WhizzEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            public static explicit operator long (WhizzEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an Int64.</exception>
    public static explicit operator Int128(WhizzEntity value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        throw new InvalidOperationException();
            ...
            public static explicit operator sbyte (WhizzEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
    ...
    public static explicit operator Half(WhizzEntity value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        throw new InvalidOperationException();
            ...
            /// <exception cref = "InvalidOperationException">The value was not a number.</exception>
            /// <exception cref = "FormatException">The value was not formatted as a Single.</exception>
            public static explicit operator float (WhizzEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            public static explicit operator ushort (WhizzEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            public static explicit operator uint (WhizzEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            public static explicit operator ulong (WhizzEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an UInt64.</exception>
    public static explicit operator UInt128(WhizzEntity value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        throw new InvalidOperationException();
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator WhizzEntity(decimal value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator WhizzEntity(double value)
            {
                return new(new BinaryJsonNumber(value));
            }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator WhizzEntity(Half value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator WhizzEntity(float value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator WhizzEntity(byte value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator WhizzEntity(short value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator WhizzEntity(int value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator WhizzEntity(long value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator WhizzEntity(sbyte value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator WhizzEntity(ushort value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator WhizzEntity(uint value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            /// </summary>
            /// <param name = "value">The value to convert.</param>
            public static explicit operator WhizzEntity(ulong value)
            {
                return new(new BinaryJsonNumber(value));
            }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator WhizzEntity(Int128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator WhizzEntity(UInt128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
            ...
            public static WhizzEntity operator +(WhizzEntity left, WhizzEntity right)
            {
            ...
            /// <returns>The resulting value.</returns>
            public static WhizzEntity operator ++(WhizzEntity value)
            {
            ...
            public static int Compare(in WhizzEntity lhs, in WhizzEntity rhs)
            {
