...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonPointer : IJsonBoolean<ExtJsonPointer>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonPointer"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonPointer(bool value)
        {
        ...
        public static implicit operator ExtJsonPointer(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonPointer(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonPointer value)
        {
