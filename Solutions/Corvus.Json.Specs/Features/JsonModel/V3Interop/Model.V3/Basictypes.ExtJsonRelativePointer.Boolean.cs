...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonRelativePointer : IJsonBoolean<ExtJsonRelativePointer>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonRelativePointer"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonRelativePointer(bool value)
        {
        ...
        public static implicit operator ExtJsonRelativePointer(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonRelativePointer(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonRelativePointer value)
        {
