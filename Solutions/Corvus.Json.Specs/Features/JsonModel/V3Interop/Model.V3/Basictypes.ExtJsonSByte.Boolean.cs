...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonSByte : IJsonBoolean<ExtJsonSByte>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonSByte"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonSByte(bool value)
        {
        ...
        public static implicit operator ExtJsonSByte(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonSByte(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonSByte value)
        {
