...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonString1 : IJsonBoolean<ExtJsonString1>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonString1"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonString1(bool value)
        {
        ...
        public static implicit operator ExtJsonString1(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonString1(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonString1 value)
        {
