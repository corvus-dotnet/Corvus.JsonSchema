...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonString2 : IJsonBoolean<ExtJsonString2>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonString2"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonString2(bool value)
        {
        ...
        public static implicit operator ExtJsonString2(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonString2(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonString2 value)
        {
