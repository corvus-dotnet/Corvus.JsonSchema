...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonString3 : IJsonBoolean<ExtJsonString3>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonString3"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonString3(bool value)
        {
        ...
        public static implicit operator ExtJsonString3(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonString3(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonString3 value)
        {
