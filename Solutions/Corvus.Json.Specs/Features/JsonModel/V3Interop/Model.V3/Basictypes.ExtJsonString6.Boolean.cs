...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonString6 : IJsonBoolean<ExtJsonString6>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonString6"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonString6(bool value)
        {
        ...
        public static implicit operator ExtJsonString6(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonString6(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonString6 value)
        {
