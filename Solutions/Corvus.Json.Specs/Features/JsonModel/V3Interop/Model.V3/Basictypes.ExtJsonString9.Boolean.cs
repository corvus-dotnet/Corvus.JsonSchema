...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonString9 : IJsonBoolean<ExtJsonString9>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonString9"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonString9(bool value)
        {
        ...
        public static implicit operator ExtJsonString9(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonString9(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonString9 value)
        {
