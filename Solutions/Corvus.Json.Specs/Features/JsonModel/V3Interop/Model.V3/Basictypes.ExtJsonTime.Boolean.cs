...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonTime : IJsonBoolean<ExtJsonTime>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonTime"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonTime(bool value)
        {
        ...
        public static implicit operator ExtJsonTime(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonTime(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonTime value)
        {
