...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonUInt16ExMin : IJsonBoolean<ExtJsonUInt16ExMin>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonUInt16ExMin"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonUInt16ExMin(bool value)
        {
        ...
        public static implicit operator ExtJsonUInt16ExMin(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonUInt16ExMin(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonUInt16ExMin value)
        {
