...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonUriTemplate : IJsonBoolean<ExtJsonUriTemplate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonUriTemplate"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonUriTemplate(bool value)
        {
        ...
        public static implicit operator ExtJsonUriTemplate(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonUriTemplate(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonUriTemplate value)
        {
