...
namespace Features.JsonSchema.Draft201909
{
    ...
    [NUnit.Framework.DescriptionAttribute("if-then-else draft2019-09")]
    [NUnit.Framework.CategoryAttribute("draft2019-09")]
    public partial class If_Then_ElseDraft2019_09Feature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/JsonSchema/Draft201909", "if-then-else draft2019-09", "    In order to use json-schema\r\n    As a developer\r\n    I want to support if-the" +
                    "n-else in draft2019-09", ProgrammingLanguage.CSharp, new string[] {
                        "draft2019-09"});
