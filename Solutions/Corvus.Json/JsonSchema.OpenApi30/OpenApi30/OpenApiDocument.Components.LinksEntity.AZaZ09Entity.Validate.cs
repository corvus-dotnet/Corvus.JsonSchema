            ...
            public readonly partial struct AZaZ09Entity
            {
                ...
                public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    if (level > ValidationLevel.Basic)
                    {
                        ...
                        result = result.PushSchemaLocation("https://spec.openapis.org/oas/3.0/schema/2021-09-28#/definitions/Components/properties/links/patternProperties/^[a-zA-Z0-9\\.\\-_]+$");
                    }
                ...
                private static partial class CorvusValidation
                {
                        ...
                        ValidationLevel level = ValidationLevel.Flag)
                    {
                        ...
                        static ValidationContext ValidateOneOf(in AZaZ09Entity value, in ValidationContext validationContext, ValidationLevel level)
                        {
                            ...
                            ValidationContext oneOfResult1 = value.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Link>().Validate(oneOfChildContext1, level);
