...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct Components
    {
        ...
        public readonly partial struct LinksEntity
            : IJsonObject<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Components.LinksEntity>
        {
            /// <summary>
            /// The pattern matching '^[a-zA-Z0-9\.\-_]+$'
            /// for the pattern property producing the type
            /// <see cref="Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Components.LinksEntity.AZaZ09Entity"/>.
            /// </summary>
            public static Regex PatternPropertyAZaZ09Entity => CorvusValidation.PatternProperties;
            ...
            /// <summary>
            /// Determines if a property name matches '^[a-zA-Z0-9\.\-_]+$'
            /// for the pattern property producing the type
            /// <see cref="Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Components.LinksEntity.AZaZ09Entity"/>.
            /// </summary>
            public static bool MatchesPatternAZaZ09Entity(in JsonObjectProperty property) => property.Name.IsMatch(CorvusValidation.PatternProperties);

            /// <summary>
            /// Gets an instance of the type
            /// <see cref="Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Components.LinksEntity.AZaZ09Entity"/>
            /// if the property name matches '^[a-zA-Z0-9\.\-_]+$'.
            /// </summary>
            public static bool TryAsPatternAZaZ09Entity(in JsonObjectProperty property, out Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Components.LinksEntity.AZaZ09Entity result)
            {
                if (property.Name.IsMatch(CorvusValidation.PatternProperties))
                {
                    result = property.Value.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Components.LinksEntity.AZaZ09Entity>();
                    return result.IsValid();
                }

                result = Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Components.LinksEntity.AZaZ09Entity.Undefined;
                return false;
            }
