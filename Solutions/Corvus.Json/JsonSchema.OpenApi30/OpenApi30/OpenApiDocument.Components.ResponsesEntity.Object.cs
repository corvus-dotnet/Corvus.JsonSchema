...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct Components
    {
        ...
        public readonly partial struct ResponsesEntity
            : IJsonObject<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Components.ResponsesEntity>
        {
            /// <summary>
            /// The pattern matching '^[a-zA-Z0-9\.\-_]+$'
            /// for the pattern property producing the type
            /// <see cref="Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Components.ResponsesEntity.AZaZ09Entity"/>.
            /// </summary>
            ...
            /// </summary>
            public static bool TryAsPatternAZaZ09Entity(in JsonObjectProperty property, out Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Components.ResponsesEntity.AZaZ09Entity result)
            {
                if (property.Name.IsMatch(CorvusValidation.PatternProperties))
                {
                    result = property.Value.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Components.ResponsesEntity.AZaZ09Entity>();
