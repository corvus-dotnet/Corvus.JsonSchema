    ...
    public readonly partial struct ParameterLocation
    {
        ...
        public readonly partial struct ParameterInPath
        {
...

            {
                ...
                /// </summary>
                public static string SchemaLocation { get; } = "https://spec.openapis.org/oas/3.0/schema/2021-09-28#/definitions/ParameterLocation/oneOf/0/properties/style";
                ...
                public TOut Match<TIn, TOut>(
                    in TIn context,
                    Func<TIn, TOut> matchMatrix,
                    Func<TIn, TOut> matchLabel,
                    Func<TIn, TOut> matchSimple,
                ...
                public TOut Match<TOut>(
                    Func<TOut> matchMatrix,
                    Func<TOut> matchLabel,
                    Func<TOut> matchSimple,
