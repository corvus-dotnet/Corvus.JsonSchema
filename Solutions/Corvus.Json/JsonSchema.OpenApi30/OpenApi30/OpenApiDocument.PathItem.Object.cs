...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct PathItem
        : IJsonObject<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.PathItem>
    {
        /// <summary>
        /// The pattern matching '^(get|put|post|delete|options|head|patch|trace)$'
        /// for the pattern property producing the type
        /// <see cref="Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation"/>.
        /// </summary>
        public static Regex PatternPropertyOperation => CorvusValidation.PatternProperties1;
        ...
        /// <summary>
        /// Determines if a property name matches '^(get|put|post|delete|options|head|patch|trace)$'
        /// for the pattern property producing the type
        /// <see cref="Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation"/>.
        /// </summary>
        public static bool MatchesPatternOperation(in JsonObjectProperty property) => property.Name.IsMatch(CorvusValidation.PatternProperties1);

        /// <summary>
        /// Gets an instance of the type
        /// <see cref="Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation"/>
        /// if the property name matches '^(get|put|post|delete|options|head|patch|trace)$'.
        /// </summary>
        public static bool TryAsPatternOperation(in JsonObjectProperty property, out Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation result)
        {
            if (property.Name.IsMatch(CorvusValidation.PatternProperties1))
            {
                result = property.Value.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Operation>();
