            ...
            public readonly partial struct AdditionalPropertiesEntity
            {
                ...
                public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    if (level > ValidationLevel.Basic)
                    {
                        ...
                        result = result.PushSchemaLocation("https://spec.openapis.org/oas/3.0/schema/2021-09-28#/definitions/Response/properties/links/additionalProperties");
                    }
                ...
                private static partial class CorvusValidation
                {
                        ...
                        ValidationLevel level = ValidationLevel.Flag)
                    {
                        ...
                        static ValidationContext ValidateOneOf(in AdditionalPropertiesEntity value, in ValidationContext validationContext, ValidationLevel level)
                        {
                            ...
                            ValidationContext oneOfResult0 = value.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Link>().Validate(oneOfChildContext0, level);
