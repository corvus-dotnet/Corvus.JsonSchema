...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct Responses
        : IJsonObject<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Responses>
    {
        /// <summary>
        /// The pattern matching '^[1-5](?:\d{2}|XX)$'
        /// for the pattern property producing the type
        /// <see cref="Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Responses.Type15D2XxEntity"/>.
        /// </summary>
        public static Regex PatternPropertyType15D2XxEntity => CorvusValidation.PatternProperties1;
        ...
        public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Responses.DefaultEntity Default
        {
            get
            {
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Responses.DefaultEntity>();
                    }
                }
        ...
        /// </summary>
        public static Responses Create(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Responses.DefaultEntity? defaultEntity = null)
        {
        ...
        /// <summary>
        /// Determines if a property name matches '^[1-5](?:\d{2}|XX)$'
        /// for the pattern property producing the type
        /// <see cref="Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Responses.Type15D2XxEntity"/>.
        /// </summary>
        public static bool MatchesPatternType15D2XxEntity(in JsonObjectProperty property) => property.Name.IsMatch(CorvusValidation.PatternProperties1);

        /// <summary>
        /// Gets an instance of the type
        /// <see cref="Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Responses.Type15D2XxEntity"/>
        /// if the property name matches '^[1-5](?:\d{2}|XX)$'.
        /// </summary>
        public static bool TryAsPatternType15D2XxEntity(in JsonObjectProperty property, out Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Responses.Type15D2XxEntity result)
        {
            if (property.Name.IsMatch(CorvusValidation.PatternProperties1))
            {
                result = property.Value.As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Responses.Type15D2XxEntity>();
