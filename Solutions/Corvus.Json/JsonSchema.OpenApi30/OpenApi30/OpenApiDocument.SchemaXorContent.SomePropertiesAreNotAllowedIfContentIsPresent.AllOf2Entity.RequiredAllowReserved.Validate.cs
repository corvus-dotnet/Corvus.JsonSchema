                ...
                public readonly partial struct RequiredAllowReserved
                {
                    ...
                    private static partial class CorvusValidation
                    {
                        ...
                        public static ValidationContext ObjectValidationHandler(
                            in RequiredAllowReserved value,
                            ...
                            ValidationLevel level = ValidationLevel.Flag)
                        {
                            ...
                            bool hasSeenAllowReserved = false;
                            int propertyCount = 0;
                            foreach (JsonObjectProperty property in value.EnumerateObject())
                            {
                                if (property.NameEquals(JsonPropertyNames.AllowReservedUtf8, JsonPropertyNames.AllowReserved))
                                {
                                    hasSeenAllowReserved = true;
                                    result = result.WithLocalProperty(propertyCount);
                                    if (level > ValidationLevel.Basic)
                                    {
                                        result = result.PushValidationLocationReducedPathModifierAndProperty(new(""), JsonPropertyNames.AllowReserved);
                                    }
                            ...
                            if (!hasSeenAllowReserved)
                            {
                                if (level >= ValidationLevel.Basic)
                                {
                                    result = result.WithResult(isValid: false, "Validation required - the required property 'allowReserved' was not present.");
                                }
                                else
                                {
                            ...
                            {
                                result = result.WithResult(isValid: true, "Validation required - the required property 'allowReserved' was present.");
                            }
