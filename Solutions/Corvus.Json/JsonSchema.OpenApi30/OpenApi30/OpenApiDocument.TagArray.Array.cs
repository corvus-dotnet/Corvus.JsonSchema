...
public readonly partial struct OpenApiDocument
{
    ...
    /// </summary>
#if NET8_0_OR_GREATER
    [CollectionBuilder(typeof(TagArray), "Create")]
#endif
    public readonly partial struct TagArray
        : IJsonArray<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.TagArray>,
          IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static TagArray EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
        ...
        /// <inheritdoc/>
        Corvus.Json.JsonAny IJsonArray<TagArray>.this[int index]
        {
            get
            {
        ...
        public Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        /// <summary>
        /// Create an new instance of the <see cref="TagArray"/>" struct from a span of items.
        /// </summary>
        ...
        public static TagArray Create(ReadOnlySpan<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag> items)        {
            return new([..items]);
        }
        ...
        public static TagArray FromItems(params Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag[] items)
        {
            return new([..items]);
        }
        ...
        public static TagArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item1)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static TagArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item1, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item2)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static TagArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item1, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item2, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item3)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static TagArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item1, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item2, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item3, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item4)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static TagArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item1, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item2, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item3, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item4, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item5)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static TagArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item1, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item2, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item3, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item4, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item5, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item6)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static TagArray FromItems(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item1, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item2, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item3, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item4, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item5, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item6, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item7)
        {
        ...
        public static TagArray FromRange(IEnumerable<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to construct the instance.</param>
        /// <returns>An instance of the array constructed from the items .</returns>
        static TagArray IJsonArray<TagArray>.FromRange(IEnumerable<JsonAny> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to construct the instance.</param>
        /// <returns>An instance of the array constructed from the items.</returns>
        static TagArray IJsonArray<TagArray>.FromRange<T>(IEnumerable<T> items)
        {
        ...
        /// <inheritdoc/>
        IEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag> IEnumerable<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag>.GetEnumerator() => this.EnumerateArray();

        /// <inheritdoc/>
        IEnumerator IEnumerable.GetEnumerator() => this.EnumerateArray();

        /// <inheritdoc/>
        int IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag>.Count => this.GetArrayLength();
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new(this.jsonElementBacking);
        ...
        /// <inheritdoc/>
        TagArray IJsonArray<TagArray>.AddRange<TArray>(in TArray items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        TagArray IJsonArray<TagArray>.InsertRange<TArray>(int index, in TArray items)
        {
        ...
        /// <inheritdoc/>
        public TagArray Add(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item1)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        public TagArray Add(params Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag[] items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            foreach (Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item in items)
            {
                builder.Add(item.AsAny);
            }
        ...
        /// <inheritdoc/>
        public TagArray AddRange(IEnumerable<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            foreach (Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item in items)
            {
        ...
        /// <inheritdoc/>
        public TagArray Insert(int index, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag item1)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
        }

        /// <inheritdoc/>
        public TagArray InsertRange(int index, IEnumerable<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
        }

        /// <inheritdoc/>
        public TagArray Replace(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag oldValue, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag newValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
        }

        /// <inheritdoc/>
        public TagArray SetItem(int index, in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag value)
        {
            return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
        }

        /// <inheritdoc/>
        TagArray IJsonArray<TagArray>.Remove(in JsonAny oldValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
        }

        /// <inheritdoc/>
        TagArray IJsonArray<TagArray>.RemoveAt(int index)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
        }

        /// <inheritdoc/>
        TagArray IJsonArray<TagArray>.RemoveRange(int index, int count)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, count));
        }

        /// <inheritdoc/>
        public TagArray Remove(in Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag oldValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
        }
        ...
        private static class __CorvusArrayHelpers
        {
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableList(in TagArray arrayInstance)
            {
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in TagArray arrayInstance)
            {
            ...
            public static ImmutableList<JsonAny> GetImmutableListSetting(in TagArray arrayInstance, int index, in JsonAny value)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListReplacing(in TagArray arrayInstance, in JsonAny oldItem, in JsonAny newItem)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWithout(in TagArray arrayInstance, in JsonAny item)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in TagArray arrayInstance, int index, int count)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            // <exception cref = "InvalidOperationException">The value is not an array.</exception>
            // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWith(in TagArray arrayInstance, int index, in JsonAny value)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in TagArray arrayInstance, int index, TEnumerable values)
