// <copyright file="GeneratedBenchmark1.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// <summary>
    /// spec_tests - A.2.  Adding an Array Element.
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark1 : BenchmarkBase
    {
        ...
        {
            this.jePatch = BuildJEPatch("[{\"op\":\"add\",\"path\":\"/foo/1\",\"value\":\"qux\"}]");
                
            this.corvusPatch = Corvus.Json.JsonAny.Parse("[{\"op\":\"add\",\"path\":\"/foo/1\",\"value\":\"qux\"}]");
