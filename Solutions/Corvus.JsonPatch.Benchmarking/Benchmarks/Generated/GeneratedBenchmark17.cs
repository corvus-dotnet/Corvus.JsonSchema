// <copyright file="GeneratedBenchmark17.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// <summary>
    /// tests - add replaces any existing field.
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark17 : BenchmarkBase
    {
        ...
        public async Task GlobalSetup()
        {
            ...
            this.corvusPatch = Corvus.Json.JsonAny.Parse("[{\"op\":\"add\",\"path\":\"/foo\",\"value\":1}]");
