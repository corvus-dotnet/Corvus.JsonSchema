// <copyright file="GeneratedBenchmark24.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// <summary>
    /// tests - append to root array document?.
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark24 : BenchmarkBase
    {
        ...
        {
            this.jePatch = BuildJEPatch("[{\"op\":\"add\",\"path\":\"/-\",\"value\":\"hi\"}]");
                
            this.corvusPatch = Corvus.Json.JsonAny.Parse("[{\"op\":\"add\",\"path\":\"/-\",\"value\":\"hi\"}]");
