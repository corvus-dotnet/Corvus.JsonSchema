// <copyright file="GeneratedBenchmark27.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// <summary>
    /// tests - Add composite value at top level.
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark27 : BenchmarkBase
    {
        ...
        {
            this.jePatch = BuildJEPatch("[{\"op\":\"add\",\"path\":\"/bar\",\"value\":[1,2]}]");
                
            this.corvusPatch = Corvus.Json.JsonAny.Parse("[{\"op\":\"add\",\"path\":\"/bar\",\"value\":[1,2]}]");
