// <copyright file="GeneratedBenchmark3.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// <summary>
    /// spec_tests - A.4.  Removing an Array Element.
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark3 : BenchmarkBase
    {
        ...
        {
            this.jePatch = BuildJEPatch("[{\"op\":\"remove\",\"path\":\"/foo/1\"}]");
                
            this.corvusPatch = Corvus.Json.JsonAny.Parse("[{\"op\":\"remove\",\"path\":\"/foo/1\"}]");
