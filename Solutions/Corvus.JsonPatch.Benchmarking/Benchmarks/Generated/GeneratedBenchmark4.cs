// <copyright file="GeneratedBenchmark4.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// <summary>
    /// spec_tests - A.5.  Replacing a Value.
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark4 : BenchmarkBase
    {
        ...
        {
            this.jePatch = BuildJEPatch("[{\"op\":\"replace\",\"path\":\"/baz\",\"value\":\"boo\"}]");
                
            this.corvusPatch = Corvus.Json.JsonAny.Parse("[{\"op\":\"replace\",\"path\":\"/baz\",\"value\":\"boo\"}]");
