// <copyright file="GeneratedBenchmark41.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark41 : BenchmarkBase
    {
        ...
        {
            this.jePatch = BuildJEPatch("[{\"op\":\"replace\",\"path\":\"/foo\",\"value\":[1,2,3,4]}]");
                
            this.corvusPatch = Corvus.Json.JsonAny.Parse("[{\"op\":\"replace\",\"path\":\"/foo\",\"value\":[1,2,3,4]}]");
