// <copyright file="GeneratedBenchmark43.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark43 : BenchmarkBase
    {
        ...
        {
            this.jePatch = BuildJEPatch("[{\"op\":\"replace\",\"path\":\"/0\",\"value\":\"bar\"}]");
                
            this.corvusPatch = Corvus.Json.JsonAny.Parse("[{\"op\":\"replace\",\"path\":\"/0\",\"value\":\"bar\"}]");
