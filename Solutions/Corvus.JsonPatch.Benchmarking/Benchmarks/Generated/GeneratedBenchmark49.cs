// <copyright file="GeneratedBenchmark49.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// <summary>
    /// tests - replace whole document.
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark49 : BenchmarkBase
    {
        ...
        {
            this.jePatch = BuildJEPatch("[{\"op\":\"replace\",\"path\":\"\",\"value\":{\"baz\":\"qux\"}}]");
                
            this.corvusPatch = Corvus.Json.JsonAny.Parse("[{\"op\":\"replace\",\"path\":\"\",\"value\":{\"baz\":\"qux\"}}]");
