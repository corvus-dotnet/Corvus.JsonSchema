// <copyright file="GeneratedBenchmark50.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// <summary>
    /// tests - spurious patch properties.
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark50 : BenchmarkBase
    {
        ...
        {
            this.jePatch = BuildJEPatch("[{\"op\":\"test\",\"path\":\"/foo\",\"value\":1,\"spurious\":1}]");
                
            this.corvusPatch = Corvus.Json.JsonAny.Parse("[{\"op\":\"test\",\"path\":\"/foo\",\"value\":1,\"spurious\":1}]");
