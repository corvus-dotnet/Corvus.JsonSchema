// <copyright file="GeneratedBenchmark51.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// <summary>
    /// tests - null value should be valid obj property.
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark51 : BenchmarkBase
    {
        ...
        {
            this.jePatch = BuildJEPatch("[{\"op\":\"test\",\"path\":\"/foo\",\"value\":null}]");
                
            this.corvusPatch = Corvus.Json.JsonAny.Parse("[{\"op\":\"test\",\"path\":\"/foo\",\"value\":null}]");
