// <copyright file="GeneratedBenchmark52.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// <summary>
    /// tests - null value should be valid obj property to be replaced with something truthy.
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark52 : BenchmarkBase
    {
        ...
        {
            this.jePatch = BuildJEPatch("[{\"op\":\"replace\",\"path\":\"/foo\",\"value\":\"truthy\"}]");
                
            this.corvusPatch = Corvus.Json.JsonAny.Parse("[{\"op\":\"replace\",\"path\":\"/foo\",\"value\":\"truthy\"}]");
