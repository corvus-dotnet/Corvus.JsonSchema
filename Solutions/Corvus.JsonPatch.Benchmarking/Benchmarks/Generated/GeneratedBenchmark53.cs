// <copyright file="GeneratedBenchmark53.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// <summary>
    /// tests - null value should be valid obj property to be moved.
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark53 : BenchmarkBase
    {
        ...
        {
            this.jePatch = BuildJEPatch("[{\"op\":\"move\",\"from\":\"/foo\",\"path\":\"/bar\"}]");
                
            this.corvusPatch = Corvus.Json.JsonAny.Parse("[{\"op\":\"move\",\"from\":\"/foo\",\"path\":\"/bar\"}]");
