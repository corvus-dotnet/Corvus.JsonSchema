// <copyright file="GeneratedBenchmark54.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// <summary>
    /// tests - null value should be valid obj property to be copied.
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark54 : BenchmarkBase
    {
        ...
        {
            this.jePatch = BuildJEPatch("[{\"op\":\"copy\",\"from\":\"/foo\",\"path\":\"/bar\"}]");
                
            this.corvusPatch = Corvus.Json.JsonAny.Parse("[{\"op\":\"copy\",\"from\":\"/foo\",\"path\":\"/bar\"}]");
