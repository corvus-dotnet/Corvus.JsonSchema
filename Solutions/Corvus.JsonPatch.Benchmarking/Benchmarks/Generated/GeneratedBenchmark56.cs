// <copyright file="GeneratedBenchmark56.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// <summary>
    /// tests - null value should still be valid obj property replace other value.
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark56 : BenchmarkBase
    {
        ...
        {
            this.jePatch = BuildJEPatch("[{\"op\":\"replace\",\"path\":\"/foo\",\"value\":null}]");
                
            this.corvusPatch = Corvus.Json.JsonAny.Parse("[{\"op\":\"replace\",\"path\":\"/foo\",\"value\":null}]");
