// <copyright file="GeneratedBenchmark62.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// <summary>
    /// tests - Move to same location has no effect.
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark62 : BenchmarkBase
    {
        ...
        {
            this.jePatch = BuildJEPatch("[{\"op\":\"move\",\"from\":\"/foo\",\"path\":\"/foo\"}]");
                
            this.corvusPatch = Corvus.Json.JsonAny.Parse("[{\"op\":\"move\",\"from\":\"/foo\",\"path\":\"/foo\"}]");
