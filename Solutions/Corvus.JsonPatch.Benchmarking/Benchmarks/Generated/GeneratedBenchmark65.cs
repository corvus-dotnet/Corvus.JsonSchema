// <copyright file="GeneratedBenchmark65.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark65 : BenchmarkBase
    {
        ...
        {
            this.jePatch = BuildJEPatch("[{\"op\":\"copy\",\"from\":\"/baz/0\",\"path\":\"/boo\"}]");
                
            this.corvusPatch = Corvus.Json.JsonAny.Parse("[{\"op\":\"copy\",\"from\":\"/baz/0\",\"path\":\"/boo\"}]");
