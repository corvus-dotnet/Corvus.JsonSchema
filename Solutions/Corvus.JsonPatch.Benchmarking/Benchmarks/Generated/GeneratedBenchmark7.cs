// <copyright file="GeneratedBenchmark7.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// <summary>
    /// spec_tests - A.8.  Testing a Value: Success.
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark7 : BenchmarkBase
    {
        ...
        public async Task GlobalSetup()
        {
            ...
            this.corvusPatch = Corvus.Json.JsonAny.Parse("[{\"op\":\"test\",\"path\":\"/baz\",\"value\":\"qux\"},{\"op\":\"test\",\"path\":\"/foo/1\",\"value\":2}]");
