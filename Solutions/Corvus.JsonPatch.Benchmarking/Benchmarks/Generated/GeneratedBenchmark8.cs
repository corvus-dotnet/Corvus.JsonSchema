// <copyright file="GeneratedBenchmark8.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// <summary>
    /// spec_tests - A.10.  Adding a nested Member Object.
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark8 : BenchmarkBase
    {
        ...
        {
            this.jePatch = BuildJEPatch("[{\"op\":\"add\",\"path\":\"/child\",\"value\":{\"grandchild\":{}}}]");
                
            this.corvusPatch = Corvus.Json.JsonAny.Parse("[{\"op\":\"add\",\"path\":\"/child\",\"value\":{\"grandchild\":{}}}]");
