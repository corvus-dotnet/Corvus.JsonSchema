...
namespace AdditionalItemsDraft201909Feature.AdditionalItemsAsSchema
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\additionalItems.json", "#/0/schema", "#/000/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<AdditionalItemsDraft201909Feature.AdditionalItemsAsSchema.Schema>();
        }
        /// <summary>
