...
namespace AdditionalPropertiesDraft201909Feature.AdditionalPropertiesBeingFalseDoesNotAllowOtherProperties
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\additionalProperties.json", "#/0/schema", "#/000/tests/003/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<AdditionalPropertiesDraft201909Feature.AdditionalPropertiesBeingFalseDoesNotAllowOtherProperties.Schema>();
        }
        /// <summary>
