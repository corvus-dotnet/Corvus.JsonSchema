...
namespace AllOfDraft201909Feature.AllOf
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\allOf.json", "#/0/schema", "#/000/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<AllOfDraft201909Feature.AllOf.Schema>();
        }
        /// <summary>
