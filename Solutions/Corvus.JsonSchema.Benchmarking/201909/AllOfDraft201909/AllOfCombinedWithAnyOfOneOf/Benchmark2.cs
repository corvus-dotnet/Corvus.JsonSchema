...
namespace AllOfDraft201909Feature.AllOfCombinedWithAnyOfOneOf
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\allOf.json", "#/11/schema", "#/011/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<AllOfDraft201909Feature.AllOfCombinedWithAnyOfOneOf.Schema>();
        }
        /// <summary>
