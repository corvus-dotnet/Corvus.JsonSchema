...
namespace AllOfDraft201909Feature.AllOfSimpleTypes
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\allOf.json", "#/2/schema", "#/002/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<AllOfDraft201909Feature.AllOfSimpleTypes.Schema>();
        }
        /// <summary>
