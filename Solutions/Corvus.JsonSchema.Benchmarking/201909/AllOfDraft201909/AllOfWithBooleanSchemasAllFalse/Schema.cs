...
namespace AllOfDraft201909Feature.AllOfWithBooleanSchemasAllFalse
{
    using System;
            ...
            IEquatable<Schema>
    {
        ...
        private ValidationContext ValidateAllOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext allOfResult0 = this.As<Corvus.Json.JsonNotAny>().Validate(validationContext.CreateChildContext(), level);
            ...
            ValidationContext allOfResult1 = this.As<Corvus.Json.JsonNotAny>().Validate(validationContext.CreateChildContext(), level);
