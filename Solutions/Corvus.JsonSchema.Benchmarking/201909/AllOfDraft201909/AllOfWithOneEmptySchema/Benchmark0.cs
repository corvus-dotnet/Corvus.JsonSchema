...
namespace AllOfDraft201909Feature.AllOfWithOneEmptySchema
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\allOf.json", "#/6/schema", "#/006/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<AllOfDraft201909Feature.AllOfWithOneEmptySchema.Schema>();
        }
        /// <summary>
