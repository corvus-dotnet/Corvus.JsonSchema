...
namespace AllOfDraft201909Feature.NestedAllOfToCheckValidationSemantics
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\allOf.json", "#/10/schema", "#/010/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<AllOfDraft201909Feature.NestedAllOfToCheckValidationSemantics.Schema>();
        }
        /// <summary>
