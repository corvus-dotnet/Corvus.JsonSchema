...
namespace AnyOfDraft201909Feature.AnyOfComplexTypes
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\anyOf.json", "#/5/schema", "#/005/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<AnyOfDraft201909Feature.AnyOfComplexTypes.Schema>();
        }
        /// <summary>
