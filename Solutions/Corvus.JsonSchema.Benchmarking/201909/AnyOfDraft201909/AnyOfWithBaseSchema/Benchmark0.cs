...
namespace AnyOfDraft201909Feature.AnyOfWithBaseSchema
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\anyOf.json", "#/1/schema", "#/001/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<AnyOfDraft201909Feature.AnyOfWithBaseSchema.Schema>();
        }
        /// <summary>
