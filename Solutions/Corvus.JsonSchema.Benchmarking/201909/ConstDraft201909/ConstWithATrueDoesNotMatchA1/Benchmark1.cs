...
namespace ConstDraft201909Feature.ConstWithATrueDoesNotMatchA1
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\const.json", "#/9/schema", "#/009/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<ConstDraft201909Feature.ConstWithATrueDoesNotMatchA1.Schema>();
        }
        /// <summary>
