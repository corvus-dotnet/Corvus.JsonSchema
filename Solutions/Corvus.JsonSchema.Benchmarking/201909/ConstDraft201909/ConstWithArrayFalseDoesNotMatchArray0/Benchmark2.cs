...
namespace ConstDraft201909Feature.ConstWithArrayFalseDoesNotMatchArray0
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\const.json", "#/6/schema", "#/006/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<ConstDraft201909Feature.ConstWithArrayFalseDoesNotMatchArray0.Schema>();
        }
        /// <summary>
