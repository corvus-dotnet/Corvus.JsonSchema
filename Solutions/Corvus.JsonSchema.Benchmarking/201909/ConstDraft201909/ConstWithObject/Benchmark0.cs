...
namespace ConstDraft201909Feature.ConstWithObject
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\const.json", "#/1/schema", "#/001/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<ConstDraft201909Feature.ConstWithObject.Schema>();
        }
        /// <summary>
