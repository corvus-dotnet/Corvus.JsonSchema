...
namespace ConstDraft201909Feature.ConstWithTrueDoesNotMatch1
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\const.json", "#/5/schema", "#/005/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<ConstDraft201909Feature.ConstWithTrueDoesNotMatch1.Schema>();
        }
        /// <summary>
