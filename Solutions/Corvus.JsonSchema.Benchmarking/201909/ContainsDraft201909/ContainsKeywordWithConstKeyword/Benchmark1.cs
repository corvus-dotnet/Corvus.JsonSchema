...
namespace ContainsDraft201909Feature.ContainsKeywordWithConstKeyword
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\contains.json", "#/1/schema", "#/001/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<ContainsDraft201909Feature.ContainsKeywordWithConstKeyword.Schema>();
        }
        /// <summary>
