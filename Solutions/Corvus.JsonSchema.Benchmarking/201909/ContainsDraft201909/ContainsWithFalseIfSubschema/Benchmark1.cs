...
namespace ContainsDraft201909Feature.ContainsWithFalseIfSubschema
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\contains.json", "#/5/schema", "#/005/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<ContainsDraft201909Feature.ContainsWithFalseIfSubschema.Schema>();
        }
        /// <summary>
