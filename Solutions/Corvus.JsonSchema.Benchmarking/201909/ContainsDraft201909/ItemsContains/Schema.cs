...
namespace ContainsDraft201909Feature.ItemsContains
{
    using System;
                ...
                IEquatable<Schema>
    {
        ...
        public static Schema From(params ContainsDraft201909Feature.ItemsContains.Schema.ItemsEntity[] items)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Schema From(ContainsDraft201909Feature.ItemsContains.Schema.ItemsEntity item1)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Schema From(ContainsDraft201909Feature.ItemsContains.Schema.ItemsEntity item1, ContainsDraft201909Feature.ItemsContains.Schema.ItemsEntity item2)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Schema From(ContainsDraft201909Feature.ItemsContains.Schema.ItemsEntity item1, ContainsDraft201909Feature.ItemsContains.Schema.ItemsEntity item2, ContainsDraft201909Feature.ItemsContains.Schema.ItemsEntity item3)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Schema From(ContainsDraft201909Feature.ItemsContains.Schema.ItemsEntity item1, ContainsDraft201909Feature.ItemsContains.Schema.ItemsEntity item2, ContainsDraft201909Feature.ItemsContains.Schema.ItemsEntity item3, ContainsDraft201909Feature.ItemsContains.Schema.ItemsEntity item4)
        {
        ...
        public void WriteTo(Utf8JsonWriter writer)
        {
            ...
            writer.WriteNullValue();
                ...
                /// <summary>
        /// Enumerate the items in the array as a <see cref="ContainsDraft201909Feature.ItemsContains.Schema.ItemsEntity" />.
        /// </summary>
        public JsonArrayEnumerator<ContainsDraft201909Feature.ItemsContains.Schema.ItemsEntity> EnumerateItems()
        {
            if (this.arrayBacking is ImmutableList<JsonAny> items)
            {
                return new JsonArrayEnumerator<ContainsDraft201909Feature.ItemsContains.Schema.ItemsEntity>(items);
            }

            if (this.jsonElementBacking.ValueKind == JsonValueKind.Array)
            {
                return new JsonArrayEnumerator<ContainsDraft201909Feature.ItemsContains.Schema.ItemsEntity>(this.jsonElementBacking);
            }
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        ValidationContext containsResult = arrayEnumerator.Current.As<ContainsDraft201909Feature.ItemsContains.Schema.ContainsEntity>().Validate(result.CreateChildContext(), level);
                ...
                if (containsResult.IsValid)
                {
                    ...
                    containsCount++;
                        ...
                        result = arrayEnumerator.Current.As<ContainsDraft201909Feature.ItemsContains.Schema.ItemsEntity>().Validate(result, level);
                if (level == ValidationLevel.Flag && !result.IsValid)
                {
                    return result;
                }
            ...
            IEquatable<ItemsEntity>
    {
        ...
        /// </summary>
        /// <param name="jsonNumber">The <see cref="JsonNumber"/> from which to construct the value.</param>
        public ItemsEntity(JsonNumber jsonNumber)
        {
            if (jsonNumber.HasJsonElement)
            {
                this.jsonElementBacking = jsonNumber.AsJsonElement;
        ...
        /// </summary>
        /// <param name="value">A number value.</param>
        public ItemsEntity(double value)
        {
            this.jsonElementBacking = default;
                                            this.numberBacking = value;
        }
        ...
        /// </summary>
        /// <param name="value">A number value.</param>
        public ItemsEntity(float value)
        {
            this.jsonElementBacking = default;
                                            this.numberBacking = value;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ItemsEntity(double value)
        {
        ...
        /// </summary>
        /// <param name="number">The number from which to convert.</param>
        public static implicit operator double(ItemsEntity number)
        {
            return number.AsNumber.GetDouble();
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ItemsEntity(float value)
        {
            return new ItemsEntity(value);
        }
        ...
        /// </summary>
        /// <param name="number">The number from which to convert.</param>
        public static implicit operator float(ItemsEntity number)
        {
            return number.AsNumber.GetSingle();
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ItemsEntity(long value)
        {
            return new ItemsEntity(value);
        }
        ...
        /// </summary>
        /// <param name="number">The number from which to convert.</param>
        public static implicit operator long(ItemsEntity number)
        {
            return number.AsNumber.GetInt64();
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ItemsEntity(int value)
        {
            return new ItemsEntity(value);
        }
        ...
        /// </summary>
        /// <param name="number">The number from which to convert.</param>
        public static implicit operator int(ItemsEntity number)
        {
            return number.AsNumber.GetInt32();
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ItemsEntity(JsonNumber value)
        {
            return new ItemsEntity(value);
        }
        ...
        /// </summary>
        /// <param name="number">The value from which to convert.</param>
        public static implicit operator JsonNumber(ItemsEntity number)
        {
            return number.AsNumber;
        }
        ...
        /// <param name="rhs">The right hand side of the comparison.</param>
        /// <returns>True if they are equal.</returns>
        public static bool operator ==(ItemsEntity lhs, ItemsEntity rhs)
        {
            return lhs.Equals(rhs);
        }
