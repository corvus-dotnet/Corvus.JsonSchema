...
namespace ContentDraft201909Feature.ValidationOfBinaryStringEncoding
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\content.json", "#/1/schema", "#/001/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<ContentDraft201909Feature.ValidationOfBinaryStringEncoding.Schema>();
        }
        /// <summary>
