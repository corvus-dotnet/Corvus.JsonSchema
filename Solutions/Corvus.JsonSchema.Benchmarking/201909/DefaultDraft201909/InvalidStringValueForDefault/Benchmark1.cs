...
namespace DefaultDraft201909Feature.InvalidStringValueForDefault
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\default.json", "#/1/schema", "#/001/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<DefaultDraft201909Feature.InvalidStringValueForDefault.Schema>();
        }
        /// <summary>
