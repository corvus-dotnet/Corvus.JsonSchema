...
namespace DefaultDraft201909Feature.InvalidTypeForDefault
{
    using System;
                    ...
                    IEquatable<Schema>
    {
        ...
        /// {Property examples}.
        /// </example>
        public DefaultDraft201909Feature.InvalidTypeForDefault.Schema.FooValue Foo
        {
            get
            {
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  DefaultDraft201909Feature.InvalidTypeForDefault.Schema.FooValue(result);
                    }
                }
        ...
        public static Schema Create(
                            DefaultDraft201909Feature.InvalidTypeForDefault.Schema.FooValue? foo = null
        
        )
        {
            var builder = ImmutableDictionary.CreateBuilder<string, JsonAny>();
                            if (foo is DefaultDraft201909Feature.InvalidTypeForDefault.Schema.FooValue foo__)
            {
        ...
        public Schema WithFoo(DefaultDraft201909Feature.InvalidTypeForDefault.Schema.FooValue value)
        {
        ...
        {
            DefaultDraft201909Feature.InvalidTypeForDefault.Schema.FooValue property = that.Foo;
