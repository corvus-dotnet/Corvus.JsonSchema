...
namespace DefaultDraft201909Feature.TheDefaultKeywordDoesNotDoAnythingIfThePropertyIsMissing
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\default.json", "#/2/schema", "#/002/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<DefaultDraft201909Feature.TheDefaultKeywordDoesNotDoAnythingIfThePropertyIsMissing.Schema>();
        }
        /// <summary>
