...
namespace DependentRequiredDraft201909Feature.DependenciesWithEscapedCharacters
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            this.ValidateCorvusCore<DependentRequiredDraft201909Feature.DependenciesWithEscapedCharacters.Schema>();
        }
        /// <summary>
