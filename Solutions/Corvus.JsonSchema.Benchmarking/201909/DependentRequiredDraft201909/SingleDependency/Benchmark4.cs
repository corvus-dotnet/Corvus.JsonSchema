...
namespace DependentRequiredDraft201909Feature.SingleDependency
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\dependentRequired.json", "#/0/schema", "#/000/tests/004/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<DependentRequiredDraft201909Feature.SingleDependency.Schema>();
        }
        /// <summary>
