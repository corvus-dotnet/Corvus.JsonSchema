...
namespace DependentSchemasDraft201909Feature.BooleanSubschemas
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\dependentSchemas.json", "#/1/schema", "#/001/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<DependentSchemasDraft201909Feature.BooleanSubschemas.Schema>();
        }
        /// <summary>
