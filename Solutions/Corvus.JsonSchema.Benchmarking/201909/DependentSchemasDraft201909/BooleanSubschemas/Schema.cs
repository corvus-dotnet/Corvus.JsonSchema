...
namespace DependentSchemasDraft201909Feature.BooleanSubschemas
{
                    ...
                    IEquatable<Schema>
    {
        ...
        private static ImmutableDictionary<string, PropertyValidator<Schema>> CreateDependentSchemaValidators()
        {
            ImmutableDictionary<string, PropertyValidator<Schema>>.Builder builder =
                ...
                "foo", __CorvusValidateDependentSchema1);
                    ...
                    builder.Add(
                "bar", __CorvusValidateDependentSchema2);
        ...
        {
            return that.As<Corvus.Json.JsonAny>().Validate(validationContext, level);
        }
        ...
        {
            return that.As<Corvus.Json.JsonNotAny>().Validate(validationContext, level);
        }
