...
namespace DependentSchemasDraft201909Feature.SingleDependency
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\dependentSchemas.json", "#/0/schema", "#/000/tests/003/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<DependentSchemasDraft201909Feature.SingleDependency.Schema>();
        }
        /// <summary>
