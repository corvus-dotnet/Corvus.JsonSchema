...
namespace EnumDraft201909Feature.EnumWithEscapedCharacters
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\enum.json", "#/4/schema", "#/004/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<EnumDraft201909Feature.EnumWithEscapedCharacters.Schema>();
        }
        /// <summary>
