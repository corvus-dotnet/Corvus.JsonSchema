...
namespace EnumDraft201909Feature.EnumWithTrueDoesNotMatch1
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\enum.json", "#/6/schema", "#/006/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<EnumDraft201909Feature.EnumWithTrueDoesNotMatch1.Schema>();
        }
        /// <summary>
