...
namespace EnumDraft201909Feature.EnumsInProperties
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\enum.json", "#/3/schema", "#/003/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<EnumDraft201909Feature.EnumsInProperties.Schema>();
        }
        /// <summary>
