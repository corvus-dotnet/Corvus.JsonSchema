...
namespace EnumDraft201909Feature.HeterogeneousEnumWithNullValidation
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\enum.json", "#/2/schema", "#/002/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<EnumDraft201909Feature.HeterogeneousEnumWithNullValidation.Schema>();
        }
        /// <summary>
