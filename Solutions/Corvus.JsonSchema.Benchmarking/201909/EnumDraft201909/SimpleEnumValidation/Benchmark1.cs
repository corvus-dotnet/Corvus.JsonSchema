...
namespace EnumDraft201909Feature.SimpleEnumValidation
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\enum.json", "#/0/schema", "#/000/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<EnumDraft201909Feature.SimpleEnumValidation.Schema>();
        }
        /// <summary>
