...
namespace FormatDraft201909Feature.DateTimeFormat
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/8/schema", "#/008/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft201909Feature.DateTimeFormat.Schema>();
        }
        /// <summary>
