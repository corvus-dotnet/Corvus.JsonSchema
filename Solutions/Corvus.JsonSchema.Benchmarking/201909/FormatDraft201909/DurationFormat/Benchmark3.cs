...
namespace FormatDraft201909Feature.DurationFormat
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/18/schema", "#/018/tests/003/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft201909Feature.DurationFormat.Schema>();
        }
        /// <summary>
