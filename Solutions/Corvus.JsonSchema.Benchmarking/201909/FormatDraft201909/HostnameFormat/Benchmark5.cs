...
namespace FormatDraft201909Feature.HostnameFormat
{
    ...
    public class Benchmark5 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/6/schema", "#/006/tests/005/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft201909Feature.HostnameFormat.Schema>();
        }
        /// <summary>
