...
namespace FormatDraft201909Feature.IdnEmailFormat
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/1/schema", "#/001/tests/003/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft201909Feature.IdnEmailFormat.Schema>();
        }
        /// <summary>
