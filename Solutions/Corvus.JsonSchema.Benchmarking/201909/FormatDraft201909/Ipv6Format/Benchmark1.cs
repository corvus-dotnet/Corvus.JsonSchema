...
namespace FormatDraft201909Feature.Ipv6Format
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/4/schema", "#/004/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft201909Feature.Ipv6Format.Schema>();
        }
        /// <summary>
