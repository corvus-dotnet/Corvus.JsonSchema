...
namespace FormatDraft201909Feature.IriFormat
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/12/schema", "#/012/tests/003/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft201909Feature.IriFormat.Schema>();
        }
        /// <summary>
