...
namespace FormatDraft201909Feature.RelativeJsonPointerFormat
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/11/schema", "#/011/tests/002/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft201909Feature.RelativeJsonPointerFormat.Schema>();
        }
        /// <summary>
