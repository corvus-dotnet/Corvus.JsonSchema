...
namespace FormatDraft201909Feature.TimeFormat
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/9/schema", "#/009/tests/002/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft201909Feature.TimeFormat.Schema>();
        }
        /// <summary>
