...
namespace FormatDraft201909Feature.UriReferenceFormat
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/15/schema", "#/015/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft201909Feature.UriReferenceFormat.Schema>();
        }
        /// <summary>
