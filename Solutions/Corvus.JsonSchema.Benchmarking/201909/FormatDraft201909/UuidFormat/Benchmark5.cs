...
namespace FormatDraft201909Feature.UuidFormat
{
    ...
    public class Benchmark5 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/17/schema", "#/017/tests/005/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft201909Feature.UuidFormat.Schema>();
        }
        /// <summary>
