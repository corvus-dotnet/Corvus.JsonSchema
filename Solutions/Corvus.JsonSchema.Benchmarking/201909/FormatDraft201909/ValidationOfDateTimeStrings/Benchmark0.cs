...
namespace FormatDraft201909Feature.ValidationOfDateTimeStrings
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/8/schema", "#/008/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft201909Feature.ValidationOfDateTimeStrings.Schema>();
        }
        /// <summary>
