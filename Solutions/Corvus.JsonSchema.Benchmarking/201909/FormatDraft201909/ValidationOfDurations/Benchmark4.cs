...
namespace FormatDraft201909Feature.ValidationOfDurations
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/18/schema", "#/018/tests/004/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft201909Feature.ValidationOfDurations.Schema>();
        }
        /// <summary>
