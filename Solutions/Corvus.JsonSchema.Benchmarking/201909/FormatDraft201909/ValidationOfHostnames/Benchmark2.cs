...
namespace FormatDraft201909Feature.ValidationOfHostnames
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/6/schema", "#/006/tests/002/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft201909Feature.ValidationOfHostnames.Schema>();
        }
        /// <summary>
