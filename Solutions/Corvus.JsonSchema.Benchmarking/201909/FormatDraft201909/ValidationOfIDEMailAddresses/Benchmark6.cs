...
namespace FormatDraft201909Feature.ValidationOfIDEMailAddresses
{
    ...
    public class Benchmark6 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("format.json", "#/1/schema", "#/001/tests/006/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft201909Feature.ValidationOfIDEMailAddresses.Schema>();
        }
        /// <summary>
