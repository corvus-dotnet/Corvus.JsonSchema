...
namespace FormatDraft201909Feature.ValidationOfIDHostnames
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/5/schema", "#/005/tests/003/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft201909Feature.ValidationOfIDHostnames.Schema>();
        }
        /// <summary>
