...
namespace FormatDraft201909Feature.ValidationOfIPAddresses
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/3/schema", "#/003/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft201909Feature.ValidationOfIPAddresses.Schema>();
        }
        /// <summary>
