...
namespace FormatDraft201909Feature.ValidationOfIPv6Addresses
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/4/schema", "#/004/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft201909Feature.ValidationOfIPv6Addresses.Schema>();
        }
        /// <summary>
