...
namespace FormatDraft201909Feature.ValidationOfIRReferences
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/13/schema", "#/013/tests/003/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft201909Feature.ValidationOfIRReferences.Schema>();
        }
        /// <summary>
