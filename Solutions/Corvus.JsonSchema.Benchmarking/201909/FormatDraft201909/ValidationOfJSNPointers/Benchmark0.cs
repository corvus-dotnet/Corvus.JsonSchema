...
namespace FormatDraft201909Feature.ValidationOfJSNPointers
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/10/schema", "#/010/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft201909Feature.ValidationOfJSNPointers.Schema>();
        }
        /// <summary>
