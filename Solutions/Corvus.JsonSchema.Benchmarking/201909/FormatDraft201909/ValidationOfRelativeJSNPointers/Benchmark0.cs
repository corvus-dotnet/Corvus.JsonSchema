...
namespace FormatDraft201909Feature.ValidationOfRelativeJSNPointers
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/11/schema", "#/011/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft201909Feature.ValidationOfRelativeJSNPointers.Schema>();
        }
        /// <summary>
