...
namespace FormatDraft201909Feature.ValidationOfTimeStrings
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/9/schema", "#/009/tests/004/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft201909Feature.ValidationOfTimeStrings.Schema>();
        }
        /// <summary>
