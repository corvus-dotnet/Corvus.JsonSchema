...
namespace FormatDraft201909Feature.ValidationOfURReferences
{
    ...
    public class Benchmark5 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/15/schema", "#/015/tests/005/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft201909Feature.ValidationOfURReferences.Schema>();
        }
        /// <summary>
