...
namespace FormatDraft201909Feature.ValidationOfURTemplates
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/16/schema", "#/016/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft201909Feature.ValidationOfURTemplates.Schema>();
        }
        /// <summary>
