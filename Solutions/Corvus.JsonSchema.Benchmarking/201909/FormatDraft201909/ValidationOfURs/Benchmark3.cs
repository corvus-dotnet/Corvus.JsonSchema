...
namespace FormatDraft201909Feature.ValidationOfURs
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/14/schema", "#/014/tests/003/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft201909Feature.ValidationOfURs.Schema>();
        }
        /// <summary>
