...
namespace FormatDraft201909Feature.ValidationOfUUDs
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\format.json", "#/17/schema", "#/017/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft201909Feature.ValidationOfUUDs.Schema>();
        }
        /// <summary>
