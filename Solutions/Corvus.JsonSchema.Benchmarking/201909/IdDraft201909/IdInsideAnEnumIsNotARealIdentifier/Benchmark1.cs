...
namespace IdDraft201909Feature.IdInsideAnEnumIsNotARealIdentifier
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\id.json", "#/3/schema", "#/003/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<IdDraft201909Feature.IdInsideAnEnumIsNotARealIdentifier.Schema>();
        }
        /// <summary>
