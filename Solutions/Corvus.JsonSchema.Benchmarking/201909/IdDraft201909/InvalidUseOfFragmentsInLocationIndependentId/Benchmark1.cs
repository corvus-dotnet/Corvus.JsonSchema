...
namespace IdDraft201909Feature.InvalidUseOfFragmentsInLocationIndependentId
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\id.json", "#/0/schema", "#/000/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<IdDraft201909Feature.InvalidUseOfFragmentsInLocationIndependentId.Schema>();
        }
        /// <summary>
