...
namespace IdDraft201909Feature.UnnormalizedIdsAreAllowedButDiscouraged
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\id.json", "#/2/schema", "#/002/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<IdDraft201909Feature.UnnormalizedIdsAreAllowedButDiscouraged.Schema>();
        }
        /// <summary>
