...
namespace IdDraft201909Feature.UnnormalizedIdsAreAllowedButDiscouraged
{
                    ...
                    IEquatable<Content>
    {
        ...
        /// {Property examples}.
        /// </example>
        public IdDraft201909Feature.UnnormalizedIdsAreAllowedButDiscouraged.Schema ContentSchema
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<string, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  IdDraft201909Feature.UnnormalizedIdsAreAllowedButDiscouraged.Schema(result);
                    }
                }
        ...
        ,             IdDraft201909Feature.UnnormalizedIdsAreAllowedButDiscouraged.Schema? contentSchema = null
        ...
        )
        {
                    ...
                    if (contentEncoding is Corvus.Json.JsonString contentEncoding__)
            {
                builder.Add(ContentEncodingJsonPropertyName, contentEncoding__);
                    ...
                    if (contentSchema is IdDraft201909Feature.UnnormalizedIdsAreAllowedButDiscouraged.Schema contentSchema__)
            {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Content WithContentSchema(IdDraft201909Feature.UnnormalizedIdsAreAllowedButDiscouraged.Schema value)
        {
        ...
        private static ImmutableDictionary<string, PropertyValidator<Content>> CreateLocalPropertyValidators()
        {
            ImmutableDictionary<string, PropertyValidator<Content>>.Builder builder =
                ImmutableDictionary.CreateBuilder<string, PropertyValidator<Content>>();
                    ...
                    builder.Add(
                ContentMediaTypeJsonPropertyName, __CorvusValidateContentMediaType);
                    builder.Add(
                ContentEncodingJsonPropertyName, __CorvusValidateContentEncoding);
                    builder.Add(
                ContentSchemaJsonPropertyName, __CorvusValidateContentSchema);
        ...
        {
            IdDraft201909Feature.UnnormalizedIdsAreAllowedButDiscouraged.Schema property = that.ContentSchema;
            return property.Validate(validationContext, level);
        }
