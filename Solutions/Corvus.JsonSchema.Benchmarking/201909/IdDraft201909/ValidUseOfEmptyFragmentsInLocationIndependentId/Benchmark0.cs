...
namespace IdDraft201909Feature.ValidUseOfEmptyFragmentsInLocationIndependentId
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\id.json", "#/1/schema", "#/001/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<IdDraft201909Feature.ValidUseOfEmptyFragmentsInLocationIndependentId.Schema>();
        }
        /// <summary>
