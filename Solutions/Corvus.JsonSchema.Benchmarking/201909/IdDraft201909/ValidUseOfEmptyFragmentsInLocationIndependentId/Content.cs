...
namespace IdDraft201909Feature.ValidUseOfEmptyFragmentsInLocationIndependentId
{
                    ...
                    IEquatable<Content>
    {
        ...
        /// {Property examples}.
        /// </example>
        public IdDraft201909Feature.ValidUseOfEmptyFragmentsInLocationIndependentId.Schema ContentSchema
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<string, JsonAny> properties)
        ...
        ,             IdDraft201909Feature.ValidUseOfEmptyFragmentsInLocationIndependentId.Schema? contentSchema = null
        ...
        )
        {
                    ...
                    if (contentEncoding is Corvus.Json.JsonString contentEncoding__)
            {
                builder.Add(ContentEncodingJsonPropertyName, contentEncoding__);
                    ...
                    if (contentSchema is IdDraft201909Feature.ValidUseOfEmptyFragmentsInLocationIndependentId.Schema contentSchema__)
            {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Content WithContentSchema(IdDraft201909Feature.ValidUseOfEmptyFragmentsInLocationIndependentId.Schema value)
        {
        ...
        {
            IdDraft201909Feature.ValidUseOfEmptyFragmentsInLocationIndependentId.Schema property = that.ContentSchema;
            return property.Validate(validationContext, level);
        }
