...
namespace IfThenElseDraft201909Feature.IfAndElseWithoutThen
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\if-then-else.json", "#/4/schema", "#/004/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<IfThenElseDraft201909Feature.IfAndElseWithoutThen.Schema>();
        }
        /// <summary>
