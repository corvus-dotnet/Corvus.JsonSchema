...
namespace IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse
{
    using System;
            ...
            IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ThenEntity"/> from which to construct the value.</param>
        public Schema(IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ThenEntity conversion)
        {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ElseEntity"/> from which to construct the value.</param>
        public Schema(IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ElseEntity conversion)
        {
            if (conversion.HasJsonElement)
            {
                this.jsonElementBacking = conversion.AsJsonElement;
            ...
            /// <summary>
        /// Gets the value as a <see cref="IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ThenEntity" />.
        /// </summary>
        public IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ThenEntity AsThenEntity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ThenEntity" />.
        /// </summary>
        public bool IsThenEntity
        {
            get
            {
                return ((IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ThenEntity)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ElseEntity" />.
        /// </summary>
        public IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ElseEntity AsElseEntity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ElseEntity" />.
        /// </summary>
        public bool IsElseEntity
        {
            get
            {
                return ((IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ElseEntity)this).Validate().IsValid;
            }
        }
        ...
        /// </summary>
        public IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ThenEntity AsIfMatchThenEntity
        {
            get
            {
                return this.As<IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ThenEntity>(); 
            }
        }
        ...
        /// </summary>
        public IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ElseEntity AsElseMatchElseEntity
        {
            get
            {
                return this.As<IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ElseEntity>(); 
            }
        }
        ...
        public JsonAny AsAny
        {
            ...
            /// <summary>
        /// Conversion from <see cref="IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ThenEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ThenEntity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ThenEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ThenEntity(Schema value)
        {
                                    if (value.ValueKind == JsonValueKind.String)
            {
                return new IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ThenEntity(value.AsString);
            }
                                    return default;
        }
            /// <summary>
        /// Conversion from <see cref="IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ElseEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ElseEntity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ElseEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ElseEntity(Schema value)
        {
                                    if (value.ValueKind == JsonValueKind.String)
            {
                return new IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ElseEntity(value.AsString);
            }
                                    return default;
        }
        ...
        private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            if (ifResult.IsValid)
            {
                ValidationContext thenResult = this.As<IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ThenEntity>().Validate(validationContext.CreateChildContext(), level);
            ...
            if (!ifResult.IsValid)
            {
                ValidationContext elseResult = this.As<IfThenElseDraft201909Feature.IfWithBooleanSchemaFalse.Schema.ElseEntity>().Validate(validationContext.CreateChildContext(), level);
