...
namespace IfThenElseDraft201909Feature.IfWithBooleanSchemaTrue
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\if-then-else.json", "#/7/schema", "#/007/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<IfThenElseDraft201909Feature.IfWithBooleanSchemaTrue.Schema>();
        }
        /// <summary>
