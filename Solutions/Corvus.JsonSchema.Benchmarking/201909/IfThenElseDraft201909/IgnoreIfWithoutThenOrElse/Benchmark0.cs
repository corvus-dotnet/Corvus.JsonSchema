...
namespace IfThenElseDraft201909Feature.IgnoreIfWithoutThenOrElse
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\if-then-else.json", "#/0/schema", "#/000/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<IfThenElseDraft201909Feature.IgnoreIfWithoutThenOrElse.Schema>();
        }
        /// <summary>
