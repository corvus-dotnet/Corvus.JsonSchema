...
namespace ItemsDraft201909Feature.ItemsAndSubitems
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\items.json", "#/5/schema", "#/005/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<ItemsDraft201909Feature.ItemsAndSubitems.Schema>();
        }
        /// <summary>
