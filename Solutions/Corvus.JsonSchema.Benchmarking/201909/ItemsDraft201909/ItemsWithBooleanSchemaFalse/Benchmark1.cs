...
namespace ItemsDraft201909Feature.ItemsWithBooleanSchemaFalse
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\items.json", "#/3/schema", "#/003/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<ItemsDraft201909Feature.ItemsWithBooleanSchemaFalse.Schema>();
        }
        /// <summary>
