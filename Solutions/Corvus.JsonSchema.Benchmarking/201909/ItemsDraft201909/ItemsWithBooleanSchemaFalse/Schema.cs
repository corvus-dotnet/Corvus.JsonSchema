...
namespace ItemsDraft201909Feature.ItemsWithBooleanSchemaFalse
{
                ...
                IEquatable<Schema>
    {
        ...
        public static Schema From(params Corvus.Json.JsonNotAny[] items)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Schema From(Corvus.Json.JsonNotAny item1)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Schema From(Corvus.Json.JsonNotAny item1, Corvus.Json.JsonNotAny item2)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Schema From(Corvus.Json.JsonNotAny item1, Corvus.Json.JsonNotAny item2, Corvus.Json.JsonNotAny item3)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Schema From(Corvus.Json.JsonNotAny item1, Corvus.Json.JsonNotAny item2, Corvus.Json.JsonNotAny item3, Corvus.Json.JsonNotAny item4)
        {
