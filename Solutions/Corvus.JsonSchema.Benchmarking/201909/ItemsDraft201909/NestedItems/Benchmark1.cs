...
namespace ItemsDraft201909Feature.NestedItems
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\items.json", "#/6/schema", "#/006/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<ItemsDraft201909Feature.NestedItems.ItemsArrayArray>();
        }
        /// <summary>
