...
namespace MaxContainsDraft201909Feature.MaxContainsWithContains
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\maxContains.json", "#/1/schema", "#/001/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MaxContainsDraft201909Feature.MaxContainsWithContains.Schema>();
        }
        /// <summary>
