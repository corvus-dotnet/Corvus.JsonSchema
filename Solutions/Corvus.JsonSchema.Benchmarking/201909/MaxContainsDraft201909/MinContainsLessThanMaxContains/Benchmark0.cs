...
namespace MaxContainsDraft201909Feature.MinContainsLessThanMaxContains
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\maxContains.json", "#/2/schema", "#/002/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MaxContainsDraft201909Feature.MinContainsLessThanMaxContains.Schema>();
        }
        /// <summary>
