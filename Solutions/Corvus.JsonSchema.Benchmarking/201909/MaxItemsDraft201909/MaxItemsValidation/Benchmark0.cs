...
namespace MaxItemsDraft201909Feature.MaxItemsValidation
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\maxItems.json", "#/0/schema", "#/000/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MaxItemsDraft201909Feature.MaxItemsValidation.Schema>();
        }
        /// <summary>
