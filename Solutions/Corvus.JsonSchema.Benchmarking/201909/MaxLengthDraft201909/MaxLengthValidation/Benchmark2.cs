...
namespace MaxLengthDraft201909Feature.MaxLengthValidation
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\maxLength.json", "#/0/schema", "#/000/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MaxLengthDraft201909Feature.MaxLengthValidation.Schema>();
        }
        /// <summary>
