...
namespace MaxPropertiesDraft201909Feature.MaxPropertiesValidation
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\maxProperties.json", "#/0/schema", "#/000/tests/003/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MaxPropertiesDraft201909Feature.MaxPropertiesValidation.Schema>();
        }
        /// <summary>
