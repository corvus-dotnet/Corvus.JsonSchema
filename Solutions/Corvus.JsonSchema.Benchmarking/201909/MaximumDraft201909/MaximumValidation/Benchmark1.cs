...
namespace MaximumDraft201909Feature.MaximumValidation
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\maximum.json", "#/0/schema", "#/000/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MaximumDraft201909Feature.MaximumValidation.Schema>();
        }
        /// <summary>
