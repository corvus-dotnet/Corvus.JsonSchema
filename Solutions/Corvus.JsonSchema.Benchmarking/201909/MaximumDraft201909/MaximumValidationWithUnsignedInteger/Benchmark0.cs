...
namespace MaximumDraft201909Feature.MaximumValidationWithUnsignedInteger
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\maximum.json", "#/1/schema", "#/001/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MaximumDraft201909Feature.MaximumValidationWithUnsignedInteger.Schema>();
        }
        /// <summary>
