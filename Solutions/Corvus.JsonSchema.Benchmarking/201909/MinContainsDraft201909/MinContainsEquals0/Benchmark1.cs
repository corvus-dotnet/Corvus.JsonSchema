...
namespace MinContainsDraft201909Feature.MinContainsEquals0
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\minContains.json", "#/5/schema", "#/005/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MinContainsDraft201909Feature.MinContainsEquals0.Schema>();
        }
        /// <summary>
