...
namespace MinContainsDraft201909Feature.MinContainsEquals0WithMaxContains
{
    using System;
                ...
                IEquatable<Schema>
    {
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        ValidationContext containsResult = arrayEnumerator.Current.As<MinContainsDraft201909Feature.MinContainsEquals0WithMaxContains.Schema.ContainsEntity>().Validate(result.CreateChildContext(), level);
