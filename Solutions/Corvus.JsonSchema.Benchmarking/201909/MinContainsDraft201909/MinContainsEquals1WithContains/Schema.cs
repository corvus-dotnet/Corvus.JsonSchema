...
namespace MinContainsDraft201909Feature.MinContainsEquals1WithContains
{
    using System;
                ...
                IEquatable<Schema>
    {
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        ValidationContext containsResult = arrayEnumerator.Current.As<MinContainsDraft201909Feature.MinContainsEquals1WithContains.Schema.ContainsEntity>().Validate(result.CreateChildContext(), level);
                        ...
                        if (containsCount < 1)
            {
                ...
                {
                    result = result.WithResult(isValid: false, $"6.4.5. minContains - {containsCount} is less than minimum number of matching items 1.");
                }
                else if (level >= ValidationLevel.Basic)
                {
                    result = result.WithResult(isValid: false, "6.4.5. minContains - item count is less than minimum number of matching items 1.");
                }
                else
                {
