...
namespace MinContainsDraft201909Feature.MinContainsEquals2WithContains
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\minContains.json", "#/2/schema", "#/002/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MinContainsDraft201909Feature.MinContainsEquals2WithContains.Schema>();
        }
        /// <summary>
