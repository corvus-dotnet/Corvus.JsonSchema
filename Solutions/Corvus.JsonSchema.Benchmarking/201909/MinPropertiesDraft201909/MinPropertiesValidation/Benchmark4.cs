...
namespace MinPropertiesDraft201909Feature.MinPropertiesValidation
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\minProperties.json", "#/0/schema", "#/000/tests/004/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MinPropertiesDraft201909Feature.MinPropertiesValidation.Schema>();
        }
        /// <summary>
