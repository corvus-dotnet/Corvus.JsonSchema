...
namespace MinimumDraft201909Feature.MinimumValidation
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\minimum.json", "#/0/schema", "#/000/tests/003/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MinimumDraft201909Feature.MinimumValidation.Schema>();
        }
        /// <summary>
