...
namespace NotDraft201909Feature.ForbiddenProperty
{
    using System;
                    ...
                    IEquatable<Schema>
    {
        ...
        /// {Property examples}.
        /// </example>
        public NotDraft201909Feature.ForbiddenProperty.Schema.FooEntity Foo
        {
            get
            {
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  NotDraft201909Feature.ForbiddenProperty.Schema.FooEntity(result);
                    }
                }
        ...
        public static Schema Create(
                            NotDraft201909Feature.ForbiddenProperty.Schema.FooEntity? foo = null
        
        )
        {
            var builder = ImmutableDictionary.CreateBuilder<string, JsonAny>();
                            if (foo is NotDraft201909Feature.ForbiddenProperty.Schema.FooEntity foo__)
            {
        ...
        public Schema WithFoo(NotDraft201909Feature.ForbiddenProperty.Schema.FooEntity value)
        {
        ...
        {
            NotDraft201909Feature.ForbiddenProperty.Schema.FooEntity property = that.Foo;
            ...
            IEquatable<FooEntity>
    {
        ...
        private ValidationContext ValidateNot(ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext notResult = this.As<Corvus.Json.JsonAny>().Validate(validationContext.CreateChildContext(), level);
