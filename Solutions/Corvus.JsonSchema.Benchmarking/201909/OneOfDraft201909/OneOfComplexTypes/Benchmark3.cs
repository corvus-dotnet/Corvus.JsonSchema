...
namespace OneOfDraft201909Feature.OneOfComplexTypes
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\oneOf.json", "#/6/schema", "#/006/tests/003/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<OneOfDraft201909Feature.OneOfComplexTypes.Schema>();
        }
        /// <summary>
