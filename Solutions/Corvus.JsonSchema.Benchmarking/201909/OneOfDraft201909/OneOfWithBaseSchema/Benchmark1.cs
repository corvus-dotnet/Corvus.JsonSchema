...
namespace OneOfDraft201909Feature.OneOfWithBaseSchema
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\oneOf.json", "#/1/schema", "#/001/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<OneOfDraft201909Feature.OneOfWithBaseSchema.Schema>();
        }
        /// <summary>
