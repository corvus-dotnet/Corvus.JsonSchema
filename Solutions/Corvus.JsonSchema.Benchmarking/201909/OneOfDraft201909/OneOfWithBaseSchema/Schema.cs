...
namespace OneOfDraft201909Feature.OneOfWithBaseSchema
{
            ...
            IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="OneOfDraft201909Feature.OneOfWithBaseSchema.Schema.OneOf0Entity"/> from which to construct the value.</param>
        public Schema(OneOfDraft201909Feature.OneOfWithBaseSchema.Schema.OneOf0Entity conversion)
        {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="OneOfDraft201909Feature.OneOfWithBaseSchema.Schema.OneOf1Entity"/> from which to construct the value.</param>
        public Schema(OneOfDraft201909Feature.OneOfWithBaseSchema.Schema.OneOf1Entity conversion)
        {
            if (conversion.HasJsonElement)
            {
                this.jsonElementBacking = conversion.AsJsonElement;
            ...
            /// <summary>
        /// Gets the value as a <see cref="OneOfDraft201909Feature.OneOfWithBaseSchema.Schema.OneOf0Entity" />.
        /// </summary>
        public OneOfDraft201909Feature.OneOfWithBaseSchema.Schema.OneOf0Entity AsOneOf0Entity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="OneOfDraft201909Feature.OneOfWithBaseSchema.Schema.OneOf0Entity" />.
        /// </summary>
        public bool IsOneOf0Entity
        {
            get
            {
                return ((OneOfDraft201909Feature.OneOfWithBaseSchema.Schema.OneOf0Entity)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="OneOfDraft201909Feature.OneOfWithBaseSchema.Schema.OneOf1Entity" />.
        /// </summary>
        public OneOfDraft201909Feature.OneOfWithBaseSchema.Schema.OneOf1Entity AsOneOf1Entity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="OneOfDraft201909Feature.OneOfWithBaseSchema.Schema.OneOf1Entity" />.
        /// </summary>
        public bool IsOneOf1Entity
        {
            get
            {
                return ((OneOfDraft201909Feature.OneOfWithBaseSchema.Schema.OneOf1Entity)this).Validate().IsValid;
            }
        }
        ...
        public JsonAny AsAny
        {
            ...
            /// <summary>
        /// Conversion from <see cref="OneOfDraft201909Feature.OneOfWithBaseSchema.Schema.OneOf0Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(OneOfDraft201909Feature.OneOfWithBaseSchema.Schema.OneOf0Entity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="OneOfDraft201909Feature.OneOfWithBaseSchema.Schema.OneOf0Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator OneOfDraft201909Feature.OneOfWithBaseSchema.Schema.OneOf0Entity(Schema value)
        {
                                    if (value.ValueKind == JsonValueKind.String)
            {
                return new OneOfDraft201909Feature.OneOfWithBaseSchema.Schema.OneOf0Entity(value.AsString);
            }
                                    return default;
        }
            /// <summary>
        /// Conversion from <see cref="OneOfDraft201909Feature.OneOfWithBaseSchema.Schema.OneOf1Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(OneOfDraft201909Feature.OneOfWithBaseSchema.Schema.OneOf1Entity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="OneOfDraft201909Feature.OneOfWithBaseSchema.Schema.OneOf1Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator OneOfDraft201909Feature.OneOfWithBaseSchema.Schema.OneOf1Entity(Schema value)
        {
                                    if (value.ValueKind == JsonValueKind.String)
            {
                return new OneOfDraft201909Feature.OneOfWithBaseSchema.Schema.OneOf1Entity(value.AsString);
            }
                                    return default;
        }
        ...
        private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext oneOfResult0 = this.As<OneOfDraft201909Feature.OneOfWithBaseSchema.Schema.OneOf0Entity>().Validate(validationContext.CreateChildContext(), level);
            ...
            ValidationContext oneOfResult1 = this.As<OneOfDraft201909Feature.OneOfWithBaseSchema.Schema.OneOf1Entity>().Validate(validationContext.CreateChildContext(), level);
