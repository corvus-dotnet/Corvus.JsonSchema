...
namespace PatternPropertiesDraft201909Feature.PatternPropertiesValidatesPropertiesMatchingARegex
{
    ...
    public class Benchmark5 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\patternProperties.json", "#/0/schema", "#/000/tests/005/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<PatternPropertiesDraft201909Feature.PatternPropertiesValidatesPropertiesMatchingARegex.Schema>();
        }
        /// <summary>
