...
namespace PatternPropertiesDraft201909Feature.PatternPropertiesWithBooleanSchemas
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            this.ValidateCorvusCore<PatternPropertiesDraft201909Feature.PatternPropertiesWithBooleanSchemas.Schema>();
        }
        /// <summary>
