...
namespace PatternPropertiesDraft201909Feature.RegexesAreNotAnchoredByDefaultAndAreCaseSensitive
{
                    ...
                    IEquatable<Schema>
    {
                ...
                /// <summary>
        /// A pattern property matching [0-9]{2,} producing a <see cref="Corvus.Json.JsonBoolean" />.
        /// </summary>
        public static Regex PatternPropertyJsonBoolean = new Regex("[0-9]{2,}", RegexOptions.Compiled);

                /// <summary>
        /// A pattern property matching X_ producing a <see cref="Corvus.Json.JsonString" />.
        /// </summary>
        public static Regex PatternPropertyJsonString = new Regex("X_", RegexOptions.Compiled);
            ...
            private static ImmutableDictionary<Regex, PatternPropertyValidator> CreatePatternPropertiesValidators()
        {
            ImmutableDictionary<Regex, PatternPropertyValidator>.Builder builder =
                ImmutableDictionary.CreateBuilder<Regex, PatternPropertyValidator>();
                    ...
                    builder.Add(
                PatternPropertyJsonBoolean, __CorvusValidatePatternPropertyJsonBoolean);
                    builder.Add(
                PatternPropertyJsonString, __CorvusValidatePatternPropertyJsonString);
        
            return builder.ToImmutable();
        }

                private static ValidationContext __CorvusValidatePatternPropertyJsonBoolean(in Property that, in ValidationContext validationContext, ValidationLevel level)
        {
            return that.ValueAs<Corvus.Json.JsonBoolean>().Validate(validationContext, level);
        }
                private static ValidationContext __CorvusValidatePatternPropertyJsonString(in Property that, in ValidationContext validationContext, ValidationLevel level)
        {
            return that.ValueAs<Corvus.Json.JsonString>().Validate(validationContext, level);
        }
