...
namespace PropertiesDraft201909Feature.ObjectPropertiesValidation
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\properties.json", "#/0/schema", "#/000/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<PropertiesDraft201909Feature.ObjectPropertiesValidation.Schema>();
        }
        /// <summary>
