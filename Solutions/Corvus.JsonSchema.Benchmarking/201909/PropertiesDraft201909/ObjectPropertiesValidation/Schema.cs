...
namespace PropertiesDraft201909Feature.ObjectPropertiesValidation
{
                    ...
                    IEquatable<Schema>
    {
        ...
        /// {Property examples}.
        /// </example>
        public Corvus.Json.JsonInteger Foo
        {
            get
            {
        ...
        public Schema WithFoo(Corvus.Json.JsonInteger value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithBar(Corvus.Json.JsonString value)
        {
        ...
        {
            Corvus.Json.JsonInteger property = that.Foo;
