...
namespace PropertiesDraft201909Feature.PropertiesWithBooleanSchema
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\properties.json", "#/2/schema", "#/002/tests/003/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<PropertiesDraft201909Feature.PropertiesWithBooleanSchema.Schema>();
        }
        /// <summary>
