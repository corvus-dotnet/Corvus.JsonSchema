...
namespace PropertiesDraft201909Feature.PropertiesWithBooleanSchema
{
                    ...
                    IEquatable<Schema>
    {
        ...
        /// {Property examples}.
        /// </example>
        public Corvus.Json.JsonNotAny Bar
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<string, JsonAny> properties)
        ...
        ,             Corvus.Json.JsonNotAny? bar = null
        ...
        )
        {
                            ...
                            if (foo is Corvus.Json.JsonAny foo__)
            {
                builder.Add(FooJsonPropertyName, foo__);
                    ...
                    if (bar is Corvus.Json.JsonNotAny bar__)
            {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithBar(Corvus.Json.JsonNotAny value)
        {
        ...
        {
            Corvus.Json.JsonNotAny property = that.Bar;
            return property.Validate(validationContext, level);
        }
