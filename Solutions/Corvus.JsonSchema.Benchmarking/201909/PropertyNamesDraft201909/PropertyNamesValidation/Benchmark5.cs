...
namespace PropertyNamesDraft201909Feature.PropertyNamesValidation
{
    ...
    public class Benchmark5 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\propertyNames.json", "#/0/schema", "#/000/tests/005/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<PropertyNamesDraft201909Feature.PropertyNamesValidation.Schema>();
        }
        /// <summary>
