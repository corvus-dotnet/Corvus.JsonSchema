...
namespace RecursiveRefDraft201909Feature.DynamicRecursiveRefDestinationNotPredictableAtSchemaCompileTime
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\recursiveRef.json", "#/8/schema", "#/008/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<RecursiveRefDraft201909Feature.DynamicRecursiveRefDestinationNotPredictableAtSchemaCompileTime.MainJson>();
        }
        /// <summary>
