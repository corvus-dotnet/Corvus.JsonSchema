...
namespace RecursiveRefDraft201909Feature.RecursiveRefWithNesting
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\recursiveRef.json", "#/2/schema", "#/002/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<RecursiveRefDraft201909Feature.RecursiveRefWithNesting.SchemaJson>();
        }
        /// <summary>
