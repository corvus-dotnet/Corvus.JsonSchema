...
namespace RecursiveRefDraft201909Feature.RecursiveRefWithRecursiveAnchorFalseWorksLikeRef
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\recursiveRef.json", "#/3/schema", "#/003/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<RecursiveRefDraft201909Feature.RecursiveRefWithRecursiveAnchorFalseWorksLikeRef.SchemaJson>();
        }
        /// <summary>
