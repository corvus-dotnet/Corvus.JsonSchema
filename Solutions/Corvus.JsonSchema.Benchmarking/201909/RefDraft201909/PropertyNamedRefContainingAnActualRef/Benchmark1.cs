...
namespace RefDraft201909Feature.PropertyNamedRefContainingAnActualRef
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\ref.json", "#/8/schema", "#/008/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<RefDraft201909Feature.PropertyNamedRefContainingAnActualRef.Schema>();
        }
        /// <summary>
