...
namespace RefDraft201909Feature.PropertyNamedRefThatIsNotAReference
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\ref.json", "#/7/schema", "#/007/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<RefDraft201909Feature.PropertyNamedRefThatIsNotAReference.Schema>();
        }
        /// <summary>
