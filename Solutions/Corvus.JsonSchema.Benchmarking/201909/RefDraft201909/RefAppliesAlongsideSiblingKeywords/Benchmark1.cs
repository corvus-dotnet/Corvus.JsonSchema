...
namespace RefDraft201909Feature.RefAppliesAlongsideSiblingKeywords
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\ref.json", "#/5/schema", "#/005/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<RefDraft201909Feature.RefAppliesAlongsideSiblingKeywords.Schema>();
        }
        /// <summary>
