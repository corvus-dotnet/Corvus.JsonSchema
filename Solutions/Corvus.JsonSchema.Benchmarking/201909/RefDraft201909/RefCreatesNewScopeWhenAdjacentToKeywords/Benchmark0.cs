...
namespace RefDraft201909Feature.RefCreatesNewScopeWhenAdjacentToKeywords
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\ref.json", "#/13/schema", "#/013/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<RefDraft201909Feature.RefCreatesNewScopeWhenAdjacentToKeywords.Schema>();
        }
        /// <summary>
