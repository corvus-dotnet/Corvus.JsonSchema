...
namespace RefDraft201909Feature.RelativeRefsWithAbsoluteUrisAndDefs
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\ref.json", "#/16/schema", "#/016/tests/002/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<RefDraft201909Feature.RelativeRefsWithAbsoluteUrisAndDefs.SchemaRefsAbsoluteUrisDefs1Json>();
        }
        /// <summary>
