...
namespace RefDraft201909Feature.RemoteRefContainingRefsItself
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\ref.json", "#/6/schema", "#/006/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<RefDraft201909Feature.RemoteRefContainingRefsItself.Schema>();
        }
        /// <summary>
