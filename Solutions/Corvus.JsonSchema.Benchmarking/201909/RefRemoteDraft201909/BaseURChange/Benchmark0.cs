...
namespace RefRemoteDraft201909Feature.BaseURChange
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\refRemote.json", "#/3/schema", "#/003/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<RefRemoteDraft201909Feature.BaseURChange.Entity>();
        }
        /// <summary>
