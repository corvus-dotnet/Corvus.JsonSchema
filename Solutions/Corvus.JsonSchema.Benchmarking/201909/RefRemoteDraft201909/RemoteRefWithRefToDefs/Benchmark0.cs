...
namespace RefRemoteDraft201909Feature.RemoteRefWithRefToDefs
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\refRemote.json", "#/7/schema", "#/007/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<RefRemoteDraft201909Feature.RemoteRefWithRefToDefs.Inner>();
        }
        /// <summary>
