...
namespace RefRemoteDraft201909Feature.RootRefInRemoteRef
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\refRemote.json", "#/6/schema", "#/006/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<RefRemoteDraft201909Feature.RootRefInRemoteRef.Object>();
        }
        /// <summary>
