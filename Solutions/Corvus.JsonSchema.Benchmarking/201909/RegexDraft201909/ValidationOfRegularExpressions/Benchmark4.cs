...
namespace RegexDraft201909Feature.ValidationOfRegularExpressions
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\optional/format/regex.json", "#/0/schema", "#/000/tests/004/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<RegexDraft201909Feature.ValidationOfRegularExpressions.Schema>();
        }
        /// <summary>
