...
namespace RequiredDraft201909Feature.RequiredValidation
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\required.json", "#/0/schema", "#/000/tests/004/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<RequiredDraft201909Feature.RequiredValidation.Schema>();
        }
        /// <summary>
