...
namespace TypeDraft201909Feature.MultipleTypesCanBeSpecifiedInAnArray
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\type.json", "#/7/schema", "#/007/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<TypeDraft201909Feature.MultipleTypesCanBeSpecifiedInAnArray.Schema>();
        }
        /// <summary>
