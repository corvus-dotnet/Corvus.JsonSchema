...
namespace TypeDraft201909Feature.TypeArrayOrObject
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\type.json", "#/9/schema", "#/009/tests/003/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<TypeDraft201909Feature.TypeArrayOrObject.Schema>();
        }
        /// <summary>
