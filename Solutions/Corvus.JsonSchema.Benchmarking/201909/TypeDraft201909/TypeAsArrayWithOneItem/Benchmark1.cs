...
namespace TypeDraft201909Feature.TypeAsArrayWithOneItem
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\type.json", "#/8/schema", "#/008/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<TypeDraft201909Feature.TypeAsArrayWithOneItem.Schema>();
        }
        /// <summary>
