...
namespace UnevaluatedItemsDraft201909Feature.NonArrayInstancesAreValid
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\unevaluatedItems.json", "#/17/schema", "#/017/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<UnevaluatedItemsDraft201909Feature.NonArrayInstancesAreValid.Schema>();
        }
        /// <summary>
