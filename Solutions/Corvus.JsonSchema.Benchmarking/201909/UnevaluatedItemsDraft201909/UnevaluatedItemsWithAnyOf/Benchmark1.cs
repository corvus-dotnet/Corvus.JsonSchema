...
namespace UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithAnyOf
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            this.ValidateCorvusCore<UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithAnyOf.Schema>();
        }
        /// <summary>
