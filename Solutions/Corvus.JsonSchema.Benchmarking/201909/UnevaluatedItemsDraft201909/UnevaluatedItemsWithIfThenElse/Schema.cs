...
namespace UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse
{
                ...
                IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ElseEntity"/> from which to construct the value.</param>
        public Schema(UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ElseEntity conversion)
        {
            if (conversion.HasJsonElement)
            {
                this.jsonElementBacking = conversion.AsJsonElement;
        ...
        /// </summary>
        public UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ThenEntity AsThenEntity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ThenEntity" />.
        /// </summary>
        public bool IsThenEntity
        {
            get
            {
                return ((UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ThenEntity)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ElseEntity" />.
        /// </summary>
        public UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ElseEntity AsElseEntity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ElseEntity" />.
        /// </summary>
        public bool IsElseEntity
        {
            get
            {
                return ((UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ElseEntity)this).Validate().IsValid;
            }
        }
        ...
        public bool IsIfMatchThenEntity
        {
            get
            {
                return this.As<UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.IfEntity>().IsValid(); 
            }
        }
        ...
        /// </summary>
        public UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ThenEntity AsIfMatchThenEntity
        {
            get
            {
                return this.As<UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ThenEntity>(); 
            }
        }
        ...
        /// </summary>
        public UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ElseEntity AsElseMatchElseEntity
        {
            get
            {
                return this.As<UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ElseEntity>(); 
            }
        }
        ...
        public static implicit operator Schema(UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ThenEntity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ThenEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ThenEntity(Schema value)
        {
                            if (value.ValueKind == JsonValueKind.Array)
            {
                return new UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ThenEntity(value.AsArray);
            }
                                            return default;
        }
            /// <summary>
        /// Conversion from <see cref="UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ElseEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ElseEntity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ElseEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ElseEntity(Schema value)
        {
                            if (value.ValueKind == JsonValueKind.Array)
            {
                return new UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ElseEntity(value.AsArray);
            }
                                            return default;
        }
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                ...
                {
                                case 0:
                        result = arrayEnumerator.Current.As<UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.Items0Entity>().Validate(result, level);
                        if (level == ValidationLevel.Flag && !result.IsValid)
                        {
                            return result;
                        }
        ...
        private ValidationContext ValidateIfThenElse(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext ifResult = this.As<UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.IfEntity>().Validate(validationContext.CreateChildContext(), level);
            ...
            if (ifResult.IsValid)
            {
                ValidationContext thenResult = this.As<UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ThenEntity>().Validate(validationContext.CreateChildContext(), level);
            ...
            if (!ifResult.IsValid)
            {
                ValidationContext elseResult = this.As<UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ElseEntity>().Validate(validationContext.CreateChildContext(), level);
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        switch (arrayLength)
                {
                        ...
                        break;
                                case 3:
                        result = arrayEnumerator.Current.As<UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ElseEntity.Items3Entity>().Validate(result, level);
                        if (level == ValidationLevel.Flag && !result.IsValid)
                        {
                            return result;
                        }
    ...
    /// A type generated from a JsonSchema specification.
    /// </summary>
    public readonly struct Items3Entity :
                    IJsonValue,
            IEquatable<Items3Entity>
    {

        
    
            private static readonly Items3Entity __CorvusConstValue = JsonAny.Parse("\"else\"");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Items3Entity"/> struct.
        /// </summary>
        /// <param name="value">The backing <see cref="JsonElement"/>.</param>
        public Items3Entity(JsonElement value)
        {
            this.jsonElementBacking = value;
        ...
        public Items3Entity(string value)
        {
            this.jsonElementBacking = default;
        ...
        /// </summary>
        /// <param name="value">A string value.</param>
        public Items3Entity(ReadOnlySpan<char> value)
        {
            this.jsonElementBacking = default;
        ...
        /// </summary>
        /// <param name="value">A string value.</param>
        public Items3Entity(ReadOnlySpan<byte> value)
        {
            this.jsonElementBacking = default;
        ...
        public Items3Entity(JsonString jsonString)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Items3Entity(JsonAny value)
        {
            if (value.HasJsonElement)
            {
                return new Items3Entity(value.AsJsonElement);
            }

            return value.As<Items3Entity>();
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonAny(Items3Entity value)
        {
            return value.AsAny;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Items3Entity(ReadOnlySpan<char> value)
        {
            return new Items3Entity(value);
        }
        ...
        /// </summary>
        /// <param name="value">The number from which to convert.</param>
        public static implicit operator ReadOnlySpan<char>(Items3Entity value)
        {
            return value.AsString;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Items3Entity(ReadOnlySpan<byte> value)
        {
            return new Items3Entity(value);
        }
        ...
        /// </summary>
        /// <param name="value">The number from which to convert.</param>
        public static implicit operator ReadOnlySpan<byte>(Items3Entity value)
        {
            return value.AsString;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Items3Entity(JsonString value)
        {
            return new Items3Entity(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonString(Items3Entity value)
        {
            return value.AsString;
        }
        ...
        /// <param name="rhs">The right hand side of the comparison.</param>
        /// <returns>True if they are equal.</returns>
        public static bool operator ==(Items3Entity lhs, Items3Entity rhs)
        {
            return lhs.Equals(rhs);
        }
        ...
        /// <inheritdoc/>
        public bool Equals(Items3Entity other)
        {
            JsonValueKind valueKind = this.ValueKind;
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        switch (arrayLength)
                {
                        ...
                        break;
                                case 1:
                        result = arrayEnumerator.Current.As<UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.IfEntity.Items1Entity>().Validate(result, level);
                        if (level == ValidationLevel.Flag && !result.IsValid)
                        {
                            return result;
                        }
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        switch (arrayLength)
                {
                        ...
                        break;
                                case 2:
                        result = arrayEnumerator.Current.As<UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithIfThenElse.Schema.ThenEntity.Items2Entity>().Validate(result, level);
                        if (level == ValidationLevel.Flag && !result.IsValid)
                        {
                            return result;
                        }
    ...
    /// A type generated from a JsonSchema specification.
    /// </summary>
    public readonly struct Items2Entity :
                    IJsonValue,
            IEquatable<Items2Entity>
    {

        
    
            private static readonly Items2Entity __CorvusConstValue = JsonAny.Parse("\"then\"");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Items2Entity"/> struct.
        /// </summary>
        /// <param name="value">The backing <see cref="JsonElement"/>.</param>
        public Items2Entity(JsonElement value)
        {
            this.jsonElementBacking = value;
                            this.stringBacking = default;
                }
        ...
        /// </summary>
        /// <param name="value">A string value.</param>
        public Items2Entity(string value)
        {
            this.jsonElementBacking = default;
                                            this.stringBacking = value;
        }
        ...
        /// </summary>
        /// <param name="value">A string value.</param>
        public Items2Entity(ReadOnlySpan<char> value)
        {
            this.jsonElementBacking = default;
                                            this.stringBacking = value.ToString();
        }
        ...
        /// </summary>
        /// <param name="value">A string value.</param>
        public Items2Entity(ReadOnlySpan<byte> value)
        {
            this.jsonElementBacking = default;
                                            this.stringBacking = System.Text.Encoding.UTF8.GetString(value);
        }
        ...
        /// </summary>
        /// <param name="jsonString">The <see cref="JsonString"/> from which to construct the value.</param>
        public Items2Entity(JsonString jsonString)
        {
            if (jsonString.HasJsonElement)
            {
                this.jsonElementBacking = jsonString.AsJsonElement;
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Items2Entity(JsonAny value)
        {
            if (value.HasJsonElement)
            {
                return new Items2Entity(value.AsJsonElement);
            }

            return value.As<Items2Entity>();
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonAny(Items2Entity value)
        {
            return value.AsAny;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Items2Entity(ReadOnlySpan<char> value)
        {
            return new Items2Entity(value);
        }
        ...
        /// </summary>
        /// <param name="value">The number from which to convert.</param>
        public static implicit operator ReadOnlySpan<char>(Items2Entity value)
        {
            return value.AsString;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Items2Entity(ReadOnlySpan<byte> value)
        {
            return new Items2Entity(value);
        }
        ...
        /// </summary>
        /// <param name="value">The number from which to convert.</param>
        public static implicit operator ReadOnlySpan<byte>(Items2Entity value)
        {
            return value.AsString;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Items2Entity(JsonString value)
        {
            return new Items2Entity(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonString(Items2Entity value)
        {
            return value.AsString;
        }
        ...
        /// <param name="rhs">The right hand side of the comparison.</param>
        /// <returns>True if they are equal.</returns>
        public static bool operator ==(Items2Entity lhs, Items2Entity rhs)
        {
            return lhs.Equals(rhs);
        }
        ...
        /// <inheritdoc/>
        public bool Equals(Items2Entity other)
        {
            JsonValueKind valueKind = this.ValueKind;
