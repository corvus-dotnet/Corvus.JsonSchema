...
namespace UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithRef
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\unevaluatedItems.json", "#/14/schema", "#/014/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithRef.Schema>();
        }
        /// <summary>
