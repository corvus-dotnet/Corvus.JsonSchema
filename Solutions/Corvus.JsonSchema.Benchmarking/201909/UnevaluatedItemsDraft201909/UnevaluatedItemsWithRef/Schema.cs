...
namespace UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithRef
{
                ...
                IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithRef.Schema.BarEntity"/> from which to construct the value.</param>
        public Schema(UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithRef.Schema.BarEntity conversion)
        {
        ...
        public int Length
        {
            ...
            /// <summary>
        /// Gets the value as a <see cref="UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithRef.Schema.BarEntity" />.
        /// </summary>
        public UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithRef.Schema.BarEntity AsBarEntity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithRef.Schema.BarEntity" />.
        /// </summary>
        public bool IsBarEntity
        {
            get
            {
                return ((UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithRef.Schema.BarEntity)this).Validate().IsValid;
            }
        }
        ...
        public JsonAny AsAny
        {
            ...
            /// <summary>
        /// Conversion from <see cref="UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithRef.Schema.BarEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithRef.Schema.BarEntity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithRef.Schema.BarEntity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithRef.Schema.BarEntity(Schema value)
        {
                            if (value.ValueKind == JsonValueKind.Array)
            {
                return new UnevaluatedItemsDraft201909Feature.UnevaluatedItemsWithRef.Schema.BarEntity(value.AsArray);
            }
                                            return default;
        }
                ...
                IEquatable<BarEntity>
    {
        ...
        /// </summary>
        /// <param name="value">An array list.</param>
        public BarEntity(ImmutableList<JsonAny> value)
        {
            this.jsonElementBacking = default;
                                            this.arrayBacking = value;
        }
        ...
        /// </summary>
        /// <param name="jsonArray">The <see cref="JsonArray"/> from which to construct the value.</param>
        public BarEntity(JsonArray jsonArray)
        {
            if (jsonArray.HasJsonElement)
            {
                this.jsonElementBacking = jsonArray.AsJsonElement;
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator BarEntity(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonArray(BarEntity value)
        {
            return value.AsArray;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(BarEntity value)
        {
            return value.AsArray.AsItemsList;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator BarEntity(ImmutableList<JsonAny> value)
        {
            return new BarEntity(value);
        }
        ...
        /// <param name="items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static BarEntity From(params JsonAny[] items)
        {
            return new BarEntity(items.ToImmutableList());
        }
        ...
        /// <param name="item1">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static BarEntity From(JsonAny item1)
        {
            return new BarEntity(ImmutableList.Create(item1));
        }
        ...
        /// <param name="item2">The second item from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static BarEntity From(JsonAny item1, JsonAny item2)
        {
            return new BarEntity(ImmutableList.Create(item1, item2));
        }
        ...
        /// <param name="item3">The third item from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static BarEntity From(JsonAny item1, JsonAny item2, JsonAny item3)
        {
            return new BarEntity(ImmutableList.Create(item1, item2, item3));
        }
        ...
        /// <param name="item4">The fourth item from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static BarEntity From(JsonAny item1, JsonAny item2, JsonAny item3, JsonAny item4)
        {
            return new BarEntity(ImmutableList.Create(item1, item2, item3, item4));
        }
        ...
        /// <inheritdoc/>
        public BarEntity Add<TItem>(TItem item)
            where TItem : struct, IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Array || this.ValueKind == JsonValueKind.Undefined)
            {
        ...
        /// <inheritdoc/>
        public BarEntity Add<TItem1, TItem2>(TItem1 item1, TItem2 item2)
            where TItem1 : struct, IJsonValue
            where TItem2 : struct, IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Array || this.ValueKind == JsonValueKind.Undefined)
        ...
        /// <inheritdoc/>
        public BarEntity Add<TItem1, TItem2, TItem3>(TItem1 item1, TItem2 item2, TItem3 item3)
            where TItem1 : struct, IJsonValue
            where TItem2 : struct, IJsonValue
            where TItem3 : struct, IJsonValue
        {
        ...
        /// <inheritdoc/>
        public BarEntity Add<TItem1, TItem2, TItem3, TItem4>(TItem1 item1, TItem2 item2, TItem3 item3, TItem4 item4)
            where TItem1 : struct, IJsonValue
            where TItem2 : struct, IJsonValue
            where TItem3 : struct, IJsonValue
            where TItem4 : struct, IJsonValue
        ...
        /// <inheritdoc/>
        public BarEntity Add<TItem>(params TItem[] items)
            where TItem : struct, IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Array || this.ValueKind == JsonValueKind.Undefined)
            {
        ...
        /// <inheritdoc/>
        public BarEntity AddRange<TItem>(IEnumerable<TItem> items)
            where TItem : struct, IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Array || this.ValueKind == JsonValueKind.Undefined)
            {
        ...
        /// <inheritdoc/>
        public BarEntity Insert<TItem>(int index, TItem item)
            where TItem : struct, IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Array || this.ValueKind == JsonValueKind.Undefined)
            {
        ...
        /// <inheritdoc/>
        public BarEntity Replace<TItem>(TItem oldValue, TItem newValue)
            where TItem : struct, IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Array)
            {
        ...
        /// <inheritdoc/>
        public BarEntity RemoveAt(int index)
        {
            if (this.ValueKind == JsonValueKind.Array)
            {
                return this.AsArray.RemoveAt(index);
        ...
        /// <inheritdoc/>
        public BarEntity RemoveRange(int index, int count)
        {
            if (this.ValueKind == JsonValueKind.Array)
            {
                return this.AsArray.RemoveRange(index, count);
        ...
        /// <inheritdoc/>
        public BarEntity SetItem<TItem>(int index, TItem value)
            where TItem : struct, IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Array)
            {
