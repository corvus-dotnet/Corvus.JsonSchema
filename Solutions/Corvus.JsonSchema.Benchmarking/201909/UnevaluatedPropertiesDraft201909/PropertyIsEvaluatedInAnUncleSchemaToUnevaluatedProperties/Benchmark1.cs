...
namespace UnevaluatedPropertiesDraft201909Feature.PropertyIsEvaluatedInAnUncleSchemaToUnevaluatedProperties
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            this.ValidateCorvusCore<UnevaluatedPropertiesDraft201909Feature.PropertyIsEvaluatedInAnUncleSchemaToUnevaluatedProperties.Schema>();
        }
        /// <summary>
