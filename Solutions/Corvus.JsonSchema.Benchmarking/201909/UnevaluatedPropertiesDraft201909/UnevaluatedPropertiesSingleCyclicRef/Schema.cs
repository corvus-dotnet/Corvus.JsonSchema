...
namespace UnevaluatedPropertiesDraft201909Feature.UnevaluatedPropertiesSingleCyclicRef
{
                    ...
                    IEquatable<Schema>
    {
        ...
        /// {Property examples}.
        /// </example>
        public UnevaluatedPropertiesDraft201909Feature.UnevaluatedPropertiesSingleCyclicRef.Schema X
        {
            get
            {
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  UnevaluatedPropertiesDraft201909Feature.UnevaluatedPropertiesSingleCyclicRef.Schema(result);
                    }
                }
        ...
        public static Schema Create(
                            UnevaluatedPropertiesDraft201909Feature.UnevaluatedPropertiesSingleCyclicRef.Schema? x = null
        
        )
        {
            var builder = ImmutableDictionary.CreateBuilder<string, JsonAny>();
                            if (x is UnevaluatedPropertiesDraft201909Feature.UnevaluatedPropertiesSingleCyclicRef.Schema x__)
            {
                builder.Add(XJsonPropertyName, x__);
            }
        ...
        public Schema WithX(UnevaluatedPropertiesDraft201909Feature.UnevaluatedPropertiesSingleCyclicRef.Schema value)
        {
        ...
        private static ImmutableDictionary<string, PropertyValidator<Schema>> CreateLocalPropertyValidators()
        {
            ...
            return builder.ToImmutable();
                ...
                private static ValidationContext __CorvusValidateX(in Schema that, in ValidationContext validationContext, ValidationLevel level)
        {
            UnevaluatedPropertiesDraft201909Feature.UnevaluatedPropertiesSingleCyclicRef.Schema property = that.X;
