...
namespace UnevaluatedPropertiesDraft201909Feature.UnevaluatedPropertiesTrue
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2019-09\\unevaluatedProperties.json", "#/0/schema", "#/000/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<UnevaluatedPropertiesDraft201909Feature.UnevaluatedPropertiesTrue.Schema>();
        }
        /// <summary>
