...
namespace AdditionalPropertiesDraft202012Feature.AdditionalPropertiesBeingFalseDoesNotAllowOtherProperties
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\additionalProperties.json", "#/0/schema", "#/000/tests/002/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<AdditionalPropertiesDraft202012Feature.AdditionalPropertiesBeingFalseDoesNotAllowOtherProperties.Schema>();
        }
        /// <summary>
