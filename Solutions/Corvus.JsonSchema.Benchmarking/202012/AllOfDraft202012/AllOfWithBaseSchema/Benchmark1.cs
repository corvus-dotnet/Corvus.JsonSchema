...
namespace AllOfDraft202012Feature.AllOfWithBaseSchema
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\allOf.json", "#/1/schema", "#/001/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<AllOfDraft202012Feature.AllOfWithBaseSchema.Schema>();
        }
        /// <summary>
