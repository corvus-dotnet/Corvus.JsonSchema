...
namespace AllOfDraft202012Feature.AllOfWithBaseSchema
{
                    ...
                    IEquatable<Schema>
    {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="AllOfDraft202012Feature.AllOfWithBaseSchema.Schema.AllOf0Entity"/> from which to construct the value.</param>
        public Schema(AllOfDraft202012Feature.AllOfWithBaseSchema.Schema.AllOf0Entity conversion)
        {
        ...
        /// Initializes a new instance of the <see cref="Schema"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="AllOfDraft202012Feature.AllOfWithBaseSchema.Schema.AllOf1Entity"/> from which to construct the value.</param>
        public Schema(AllOfDraft202012Feature.AllOfWithBaseSchema.Schema.AllOf1Entity conversion)
        {
            if (conversion.HasJsonElement)
            {
                this.jsonElementBacking = conversion.AsJsonElement;
            ...
            /// <summary>
        /// Gets the value as a <see cref="AllOfDraft202012Feature.AllOfWithBaseSchema.Schema.AllOf0Entity" />.
        /// </summary>
        public AllOfDraft202012Feature.AllOfWithBaseSchema.Schema.AllOf0Entity AsAllOf0Entity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="AllOfDraft202012Feature.AllOfWithBaseSchema.Schema.AllOf0Entity" />.
        /// </summary>
        public bool IsAllOf0Entity
        {
            get
            {
                return ((AllOfDraft202012Feature.AllOfWithBaseSchema.Schema.AllOf0Entity)this).Validate().IsValid;
            }
        }

            /// <summary>
        /// Gets the value as a <see cref="AllOfDraft202012Feature.AllOfWithBaseSchema.Schema.AllOf1Entity" />.
        /// </summary>
        public AllOfDraft202012Feature.AllOfWithBaseSchema.Schema.AllOf1Entity AsAllOf1Entity
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="AllOfDraft202012Feature.AllOfWithBaseSchema.Schema.AllOf1Entity" />.
        /// </summary>
        public bool IsAllOf1Entity
        {
            get
            {
                return ((AllOfDraft202012Feature.AllOfWithBaseSchema.Schema.AllOf1Entity)this).Validate().IsValid;
            }
        }
        ...
        /// {Property examples}.
        /// </example>
        public Corvus.Json.JsonNull Baz
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<string, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  Corvus.Json.JsonNull(result);
                    }
                }
        ...
        public JsonAny AsAny
        {
            ...
            /// <summary>
        /// Conversion from <see cref="AllOfDraft202012Feature.AllOfWithBaseSchema.Schema.AllOf0Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(AllOfDraft202012Feature.AllOfWithBaseSchema.Schema.AllOf0Entity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="AllOfDraft202012Feature.AllOfWithBaseSchema.Schema.AllOf0Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AllOfDraft202012Feature.AllOfWithBaseSchema.Schema.AllOf0Entity(Schema value)
        {
                    if (value.ValueKind == JsonValueKind.Object)
            {
                return new AllOfDraft202012Feature.AllOfWithBaseSchema.Schema.AllOf0Entity(value.AsObject);
            }
                                                    return default;
        }
            /// <summary>
        /// Conversion from <see cref="AllOfDraft202012Feature.AllOfWithBaseSchema.Schema.AllOf1Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Schema(AllOfDraft202012Feature.AllOfWithBaseSchema.Schema.AllOf1Entity value)
        {
            return new Schema(value);
        }

        /// <summary>
        /// Conversion to <see cref="AllOfDraft202012Feature.AllOfWithBaseSchema.Schema.AllOf1Entity" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AllOfDraft202012Feature.AllOfWithBaseSchema.Schema.AllOf1Entity(Schema value)
        {
                    if (value.ValueKind == JsonValueKind.Object)
            {
                return new AllOfDraft202012Feature.AllOfWithBaseSchema.Schema.AllOf1Entity(value.AsObject);
            }
                                                    return default;
        }
        ...
        public Schema WithBar(Corvus.Json.JsonInteger value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Schema WithBaz(Corvus.Json.JsonNull value)
        {
        ...
        private ValidationContext ValidateAllOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext allOfResult0 = this.As<AllOfDraft202012Feature.AllOfWithBaseSchema.Schema.AllOf0Entity>().Validate(validationContext.CreateChildContext(), level);
            ...
            ValidationContext allOfResult1 = this.As<AllOfDraft202012Feature.AllOfWithBaseSchema.Schema.AllOf1Entity>().Validate(validationContext.CreateChildContext(), level);
                    ...
                    IEquatable<AllOf1Entity>
    {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public AllOf1Entity WithBaz(Corvus.Json.JsonNull value)
        {
            return this.SetProperty(BazJsonPropertyName, value);
        }
        ...
        private static ImmutableDictionary<string, PropertyValidator<AllOf1Entity>> CreateLocalPropertyValidators()
        {
            ...
            return builder.ToImmutable();
                ...
                private static ValidationContext __CorvusValidateBaz(in AllOf1Entity that, in ValidationContext validationContext, ValidationLevel level)
        {
            Corvus.Json.JsonNull property = that.Baz;
            return property.Validate(validationContext, level);
        }
