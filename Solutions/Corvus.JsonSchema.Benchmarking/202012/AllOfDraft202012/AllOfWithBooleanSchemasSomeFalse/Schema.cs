...
namespace AllOfDraft202012Feature.AllOfWithBooleanSchemasSomeFalse
{
    using System;
            ...
            IEquatable<Schema>
    {
        ...
        private ValidationContext ValidateAllOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext allOfResult0 = this.As<Corvus.Json.JsonAny>().Validate(validationContext.CreateChildContext(), level);
