...
namespace AllOfDraft202012Feature.AllOfWithTheLastEmptySchema
{
    using System;
            ...
            IEquatable<Schema>
    {
        ...
        private ValidationContext ValidateAllOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext allOfResult0 = this.As<Corvus.Json.JsonNumber>().Validate(validationContext.CreateChildContext(), level);
            ...
            ValidationContext allOfResult1 = this.As<Corvus.Json.JsonAny>().Validate(validationContext.CreateChildContext(), level);
