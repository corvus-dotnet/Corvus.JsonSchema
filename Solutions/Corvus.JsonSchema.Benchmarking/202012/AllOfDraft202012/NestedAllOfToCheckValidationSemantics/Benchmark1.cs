...
namespace AllOfDraft202012Feature.NestedAllOfToCheckValidationSemantics
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\allOf.json", "#/10/schema", "#/010/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<AllOfDraft202012Feature.NestedAllOfToCheckValidationSemantics.Schema>();
        }
        /// <summary>
