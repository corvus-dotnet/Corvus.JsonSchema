...
namespace AnchorDraft202012Feature.AnchorInsideAnEnumIsNotARealIdentifier
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\anchor.json", "#/3/schema", "#/003/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<AnchorDraft202012Feature.AnchorInsideAnEnumIsNotARealIdentifier.Schema>();
        }
        /// <summary>
