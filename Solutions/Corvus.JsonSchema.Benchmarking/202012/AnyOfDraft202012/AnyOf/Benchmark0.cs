...
namespace AnyOfDraft202012Feature.AnyOf
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\anyOf.json", "#/0/schema", "#/000/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<AnyOfDraft202012Feature.AnyOf.Schema>();
        }
        /// <summary>
