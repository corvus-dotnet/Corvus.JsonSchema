...
namespace AnyOfDraft202012Feature.AnyOfComplexTypes
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\anyOf.json", "#/5/schema", "#/005/tests/002/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<AnyOfDraft202012Feature.AnyOfComplexTypes.Schema>();
        }
        /// <summary>
