...
namespace AnyOfDraft202012Feature.AnyOfWithBooleanSchemasAllFalse
{
    using System;
            ...
            IEquatable<Schema>
    {
        ...
        private ValidationContext ValidateAnyOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext anyOfResult0 = this.As<Corvus.Json.JsonNotAny>().Validate(validationContext.CreateChildContext(), level);
            ...
            ValidationContext anyOfResult1 = this.As<Corvus.Json.JsonNotAny>().Validate(validationContext.CreateChildContext(), level);
