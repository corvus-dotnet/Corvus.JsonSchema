...
namespace AnyOfDraft202012Feature.AnyOfWithBooleanSchemasSomeTrue
{
    using System;
            ...
            IEquatable<Schema>
    {
        ...
        private ValidationContext ValidateAnyOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext anyOfResult0 = this.As<Corvus.Json.JsonAny>().Validate(validationContext.CreateChildContext(), level);
