...
namespace AnyOfDraft202012Feature.AnyOfWithOneEmptySchema
{
            ...
            IEquatable<Schema>
    {
        ...
        private ValidationContext ValidateAnyOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext anyOfResult0 = this.As<Corvus.Json.JsonNumber>().Validate(validationContext.CreateChildContext(), level);
            ...
            ValidationContext anyOfResult1 = this.As<Corvus.Json.JsonAny>().Validate(validationContext.CreateChildContext(), level);
