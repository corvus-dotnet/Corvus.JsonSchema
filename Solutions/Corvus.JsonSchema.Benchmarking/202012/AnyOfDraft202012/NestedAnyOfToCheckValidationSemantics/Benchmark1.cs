...
namespace AnyOfDraft202012Feature.NestedAnyOfToCheckValidationSemantics
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\anyOf.json", "#/7/schema", "#/007/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<AnyOfDraft202012Feature.NestedAnyOfToCheckValidationSemantics.Schema>();
        }
        /// <summary>
