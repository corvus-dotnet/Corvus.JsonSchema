...
namespace ConstDraft202012Feature.ConstWith1DoesNotMatchTrue
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\const.json", "#/11/schema", "#/011/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<ConstDraft202012Feature.ConstWith1DoesNotMatchTrue.Schema>();
        }
        /// <summary>
