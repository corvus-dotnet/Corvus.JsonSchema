...
namespace ConstDraft202012Feature.ConstWith20MatchesIntegerAndFloatTypes
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\const.json", "#/12/schema", "#/012/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<ConstDraft202012Feature.ConstWith20MatchesIntegerAndFloatTypes.Schema>();
        }
        /// <summary>
