...
namespace ConstDraft202012Feature.ConstWithAFalseDoesNotMatchA0
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\const.json", "#/8/schema", "#/008/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<ConstDraft202012Feature.ConstWithAFalseDoesNotMatchA0.Schema>();
        }
        /// <summary>
