...
namespace ConstDraft202012Feature.ConstWithArray
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\const.json", "#/2/schema", "#/002/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<ConstDraft202012Feature.ConstWithArray.Schema>();
        }
        /// <summary>
