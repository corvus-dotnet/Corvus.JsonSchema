...
namespace ConstDraft202012Feature.ConstWithArrayFalseDoesNotMatchArray0
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\const.json", "#/6/schema", "#/006/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<ConstDraft202012Feature.ConstWithArrayFalseDoesNotMatchArray0.Schema>();
        }
        /// <summary>
