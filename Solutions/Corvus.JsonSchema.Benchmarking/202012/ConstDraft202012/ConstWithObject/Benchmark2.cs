...
namespace ConstDraft202012Feature.ConstWithObject
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\const.json", "#/1/schema", "#/001/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<ConstDraft202012Feature.ConstWithObject.Schema>();
        }
        /// <summary>
