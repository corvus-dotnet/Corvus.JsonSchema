...
namespace ConstDraft202012Feature.FloatAndIntegersAreEqualUpTo64BitRepresentationLimits
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\const.json", "#/13/schema", "#/013/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<ConstDraft202012Feature.FloatAndIntegersAreEqualUpTo64BitRepresentationLimits.Schema>();
        }
        /// <summary>
