...
namespace ContainsDraft202012Feature.ContainsKeywordValidation
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\contains.json", "#/0/schema", "#/000/tests/003/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<ContainsDraft202012Feature.ContainsKeywordValidation.Schema>();
        }
        /// <summary>
