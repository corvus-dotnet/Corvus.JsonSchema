...
namespace ContainsDraft202012Feature.ContainsKeywordWithConstKeyword
{
    using System;
                ...
                IEquatable<Schema>
    {
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        ValidationContext containsResult = arrayEnumerator.Current.As<ContainsDraft202012Feature.ContainsKeywordWithConstKeyword.Schema.ContainsEntity>().Validate(result.CreateChildContext(), level);
            ...
            IEquatable<ContainsEntity>
    {
            ...
            private static readonly ContainsEntity __CorvusConstValue = JsonAny.Parse("5");
