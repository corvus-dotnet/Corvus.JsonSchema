...
namespace ContainsDraft202012Feature.ContainsWithFalseIfSubschema
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\contains.json", "#/5/schema", "#/005/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<ContainsDraft202012Feature.ContainsWithFalseIfSubschema.Schema>();
        }
        /// <summary>
