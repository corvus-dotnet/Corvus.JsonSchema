                ...
                IEquatable<Schema>
    {
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        ValidationContext containsResult = arrayEnumerator.Current.As<ContainsDraft202012Feature.ContainsWithFalseIfSubschema.Schema.ContainsEntity>().Validate(result.CreateChildContext(), level);
