...
namespace ContainsDraft202012Feature.ItemsContains
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\contains.json", "#/4/schema", "#/004/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<ContainsDraft202012Feature.ItemsContains.Schema>();
        }
        /// <summary>
