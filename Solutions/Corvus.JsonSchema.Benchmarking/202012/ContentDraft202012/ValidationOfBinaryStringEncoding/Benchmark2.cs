...
namespace ContentDraft202012Feature.ValidationOfBinaryStringEncoding
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\content.json", "#/1/schema", "#/001/tests/002/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<ContentDraft202012Feature.ValidationOfBinaryStringEncoding.Schema>();
        }
        /// <summary>
