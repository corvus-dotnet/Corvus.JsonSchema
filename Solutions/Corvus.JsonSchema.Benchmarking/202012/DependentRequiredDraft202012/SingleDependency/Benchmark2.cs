...
namespace DependentRequiredDraft202012Feature.SingleDependency
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\dependentRequired.json", "#/0/schema", "#/000/tests/002/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<DependentRequiredDraft202012Feature.SingleDependency.Schema>();
        }
        /// <summary>
