...
namespace DependentSchemasDraft202012Feature.BooleanSubschemas
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\dependentSchemas.json", "#/1/schema", "#/001/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<DependentSchemasDraft202012Feature.BooleanSubschemas.Schema>();
        }
        /// <summary>
