...
namespace DependentSchemasDraft202012Feature.DependenciesWithEscapedCharacters
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\dependentSchemas.json", "#/2/schema", "#/002/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<DependentSchemasDraft202012Feature.DependenciesWithEscapedCharacters.Schema>();
        }
        /// <summary>
