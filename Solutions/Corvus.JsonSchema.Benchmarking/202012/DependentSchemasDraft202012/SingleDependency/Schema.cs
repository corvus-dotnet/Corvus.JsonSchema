...
namespace DependentSchemasDraft202012Feature.SingleDependency
{
        ...
        private static ImmutableDictionary<string, PropertyValidator<Schema>> CreateDependentSchemaValidators()
        {
            ImmutableDictionary<string, PropertyValidator<Schema>>.Builder builder =
                ImmutableDictionary.CreateBuilder<string, PropertyValidator<Schema>>();
                    ...
                    builder.Add(
                "bar", __CorvusValidateDependentSchema1);
                    ...
                    IEquatable<BarEntity>
    {
        ...
        public static readonly string BarJsonPropertyName = "bar";
            ...
            private static readonly ImmutableDictionary<string, PropertyValidator<BarEntity>> __CorvusLocalProperties = CreateLocalPropertyValidators();
        ...
        public BarEntity WithFoo(Corvus.Json.JsonInteger value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public BarEntity WithBar(Corvus.Json.JsonInteger value)
        {
        ...
        private static ImmutableDictionary<string, PropertyValidator<BarEntity>> CreateLocalPropertyValidators()
        {
            ...
            return builder.ToImmutable();
                ...
                private static ValidationContext __CorvusValidateFoo(in BarEntity that, in ValidationContext validationContext, ValidationLevel level)
        {
            Corvus.Json.JsonInteger property = that.Foo;
            return property.Validate(validationContext, level);
        }
                private static ValidationContext __CorvusValidateBar(in BarEntity that, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            private ValidationContext ValidateObject(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            foreach (Property property in this.EnumerateObject())
            {
                string propertyName = property.Name;
                        ...
                        if (__CorvusLocalProperties.TryGetValue(propertyName, out PropertyValidator<BarEntity>? propertyValidator))
                {
                    result = result.WithLocalProperty(propertyCount);
