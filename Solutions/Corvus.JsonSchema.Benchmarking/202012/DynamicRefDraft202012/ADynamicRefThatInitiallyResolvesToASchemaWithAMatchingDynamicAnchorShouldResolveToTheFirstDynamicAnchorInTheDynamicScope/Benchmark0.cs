...
namespace DynamicRefDraft202012Feature.ADynamicRefThatInitiallyResolvesToASchemaWithAMatchingDynamicAnchorShouldResolveToTheFirstDynamicAnchorInTheDynamicScope
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            this.ValidateCorvusCore<DynamicRefDraft202012Feature.ADynamicRefThatInitiallyResolvesToASchemaWithAMatchingDynamicAnchorShouldResolveToTheFirstDynamicAnchorInTheDynamicScope.Root>();
        }
        /// <summary>
