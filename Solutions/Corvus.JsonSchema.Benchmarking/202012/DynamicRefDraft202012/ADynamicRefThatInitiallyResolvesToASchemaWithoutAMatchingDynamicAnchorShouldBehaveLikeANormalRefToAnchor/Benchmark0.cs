...
namespace DynamicRefDraft202012Feature.ADynamicRefThatInitiallyResolvesToASchemaWithoutAMatchingDynamicAnchorShouldBehaveLikeANormalRefToAnchor
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\dynamicRef.json", "#/9/schema", "#/009/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<DynamicRefDraft202012Feature.ADynamicRefThatInitiallyResolvesToASchemaWithoutAMatchingDynamicAnchorShouldBehaveLikeANormalRefToAnchor.Root>();
        }
        /// <summary>
