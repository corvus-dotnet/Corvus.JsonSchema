...
namespace DynamicRefDraft202012Feature.AfterLeavingADynamicScopeItShouldNotBeUsedByADynamicRef
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\dynamicRef.json", "#/11/schema", "#/011/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<DynamicRefDraft202012Feature.AfterLeavingADynamicScopeItShouldNotBeUsedByADynamicRef.Main>();
        }
        /// <summary>
