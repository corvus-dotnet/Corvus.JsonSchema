...
namespace DynamicRefDraft202012Feature.MultipleDynamicPathsToTheDynamicRefKeyword
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\dynamicRef.json", "#/10/schema", "#/010/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<DynamicRefDraft202012Feature.MultipleDynamicPathsToTheDynamicRefKeyword.Main>();
        }
        /// <summary>
