...
namespace DynamicRefDraft202012Feature.TestsForImplementationDynamicAnchorAndReferenceLinkReferenceShouldBeIndependentOfAnyPossibleOrdering
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\dynamicRef.json", "#/14/schema", "#/014/tests/002/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<DynamicRefDraft202012Feature.TestsForImplementationDynamicAnchorAndReferenceLinkReferenceShouldBeIndependentOfAnyPossibleOrdering.StrictExtendibleAllofDefsFirstJson>();
        }
        /// <summary>
