...
namespace EnumDraft202012Feature.EnumWithFalseDoesNotMatch0
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\enum.json", "#/5/schema", "#/005/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<EnumDraft202012Feature.EnumWithFalseDoesNotMatch0.Schema>();
        }
        /// <summary>
