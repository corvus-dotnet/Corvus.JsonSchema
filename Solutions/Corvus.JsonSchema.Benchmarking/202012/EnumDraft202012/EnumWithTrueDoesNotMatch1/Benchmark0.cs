...
namespace EnumDraft202012Feature.EnumWithTrueDoesNotMatch1
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\enum.json", "#/6/schema", "#/006/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<EnumDraft202012Feature.EnumWithTrueDoesNotMatch1.Schema>();
        }
        /// <summary>
