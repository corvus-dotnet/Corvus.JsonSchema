...
namespace EnumDraft202012Feature.HeterogeneousEnumValidation
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\enum.json", "#/1/schema", "#/001/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<EnumDraft202012Feature.HeterogeneousEnumValidation.Schema>();
        }
        /// <summary>
