...
namespace EnumDraft202012Feature.HeterogeneousEnumWithNullValidation
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\enum.json", "#/2/schema", "#/002/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<EnumDraft202012Feature.HeterogeneousEnumWithNullValidation.Schema>();
        }
        /// <summary>
