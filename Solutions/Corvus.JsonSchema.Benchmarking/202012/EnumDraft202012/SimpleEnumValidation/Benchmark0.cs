...
namespace EnumDraft202012Feature.SimpleEnumValidation
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\enum.json", "#/0/schema", "#/000/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<EnumDraft202012Feature.SimpleEnumValidation.Schema>();
        }
        /// <summary>
