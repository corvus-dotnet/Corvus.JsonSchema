...
namespace FormatDraft202012Feature.DateFormat
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/7/schema", "#/007/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft202012Feature.DateFormat.Schema>();
        }
        /// <summary>
