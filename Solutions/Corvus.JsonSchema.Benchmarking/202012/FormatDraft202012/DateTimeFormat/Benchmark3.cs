...
namespace FormatDraft202012Feature.DateTimeFormat
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/8/schema", "#/008/tests/003/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft202012Feature.DateTimeFormat.Schema>();
        }
        /// <summary>
