...
namespace FormatDraft202012Feature.IdnEmailFormat
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/1/schema", "#/001/tests/004/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft202012Feature.IdnEmailFormat.Schema>();
        }
        /// <summary>
