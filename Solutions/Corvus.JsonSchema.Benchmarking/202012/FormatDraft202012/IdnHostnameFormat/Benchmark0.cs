...
namespace FormatDraft202012Feature.IdnHostnameFormat
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/5/schema", "#/005/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft202012Feature.IdnHostnameFormat.Schema>();
        }
        /// <summary>
