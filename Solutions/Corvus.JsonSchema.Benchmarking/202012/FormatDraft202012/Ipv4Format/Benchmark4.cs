...
namespace FormatDraft202012Feature.Ipv4Format
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/3/schema", "#/003/tests/004/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft202012Feature.Ipv4Format.Schema>();
        }
        /// <summary>
