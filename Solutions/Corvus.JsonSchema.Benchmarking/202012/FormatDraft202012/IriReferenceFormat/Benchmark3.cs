...
namespace FormatDraft202012Feature.IriReferenceFormat
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/13/schema", "#/013/tests/003/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft202012Feature.IriReferenceFormat.Schema>();
        }
        /// <summary>
