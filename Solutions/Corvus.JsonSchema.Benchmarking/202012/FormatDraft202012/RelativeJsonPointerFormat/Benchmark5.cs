...
namespace FormatDraft202012Feature.RelativeJsonPointerFormat
{
    ...
    public class Benchmark5 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/11/schema", "#/011/tests/005/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft202012Feature.RelativeJsonPointerFormat.Schema>();
        }
        /// <summary>
