...
namespace FormatDraft202012Feature.TimeFormat
{
    ...
    public class Benchmark5 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/9/schema", "#/009/tests/005/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft202012Feature.TimeFormat.Schema>();
        }
        /// <summary>
