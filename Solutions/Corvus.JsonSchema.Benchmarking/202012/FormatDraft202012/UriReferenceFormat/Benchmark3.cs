...
namespace FormatDraft202012Feature.UriReferenceFormat
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/15/schema", "#/015/tests/003/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft202012Feature.UriReferenceFormat.Schema>();
        }
        /// <summary>
