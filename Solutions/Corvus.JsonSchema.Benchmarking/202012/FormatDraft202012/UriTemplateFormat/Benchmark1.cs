...
namespace FormatDraft202012Feature.UriTemplateFormat
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/16/schema", "#/016/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft202012Feature.UriTemplateFormat.Schema>();
        }
        /// <summary>
