...
namespace FormatDraft202012Feature.ValidationOfDateStrings
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/7/schema", "#/007/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft202012Feature.ValidationOfDateStrings.Schema>();
        }
        /// <summary>
