...
namespace FormatDraft202012Feature.ValidationOfDateTimeStrings
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/8/schema", "#/008/tests/004/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft202012Feature.ValidationOfDateTimeStrings.Schema>();
        }
        /// <summary>
