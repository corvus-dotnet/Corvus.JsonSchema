...
namespace FormatDraft202012Feature.ValidationOfDurations
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/18/schema", "#/018/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft202012Feature.ValidationOfDurations.Schema>();
        }
        /// <summary>
