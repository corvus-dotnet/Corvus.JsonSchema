...
namespace FormatDraft202012Feature.ValidationOfEMailAddresses
{
    ...
    public class Benchmark5 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/0/schema", "#/000/tests/005/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft202012Feature.ValidationOfEMailAddresses.Schema>();
        }
        /// <summary>
