...
namespace FormatDraft202012Feature.ValidationOfHostnames
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/6/schema", "#/006/tests/002/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft202012Feature.ValidationOfHostnames.Schema>();
        }
        /// <summary>
