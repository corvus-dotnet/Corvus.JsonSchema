...
namespace FormatDraft202012Feature.ValidationOfIPAddresses
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/3/schema", "#/003/tests/002/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft202012Feature.ValidationOfIPAddresses.Schema>();
        }
        /// <summary>
