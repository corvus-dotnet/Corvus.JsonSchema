...
namespace FormatDraft202012Feature.ValidationOfIPv6Addresses
{
    ...
    public class Benchmark5 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/4/schema", "#/004/tests/005/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft202012Feature.ValidationOfIPv6Addresses.Schema>();
        }
        /// <summary>
