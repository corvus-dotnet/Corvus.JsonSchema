...
namespace FormatDraft202012Feature.ValidationOfJSNPointers
{
    ...
    public class Benchmark6 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("format.json", "#/10/schema", "#/010/tests/006/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft202012Feature.ValidationOfJSNPointers.Schema>();
        }
        /// <summary>
