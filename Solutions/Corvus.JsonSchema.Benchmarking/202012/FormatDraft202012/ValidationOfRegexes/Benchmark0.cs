...
namespace FormatDraft202012Feature.ValidationOfRegexes
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/2/schema", "#/002/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft202012Feature.ValidationOfRegexes.Schema>();
        }
        /// <summary>
