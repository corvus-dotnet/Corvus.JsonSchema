...
namespace FormatDraft202012Feature.ValidationOfRelativeJSNPointers
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/11/schema", "#/011/tests/004/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft202012Feature.ValidationOfRelativeJSNPointers.Schema>();
        }
        /// <summary>
