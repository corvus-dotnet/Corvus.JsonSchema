...
namespace FormatDraft202012Feature.ValidationOfTimeStrings
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/9/schema", "#/009/tests/002/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft202012Feature.ValidationOfTimeStrings.Schema>();
        }
        /// <summary>
