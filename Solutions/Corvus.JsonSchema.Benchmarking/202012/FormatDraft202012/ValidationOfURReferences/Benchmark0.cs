...
namespace FormatDraft202012Feature.ValidationOfURReferences
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/15/schema", "#/015/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft202012Feature.ValidationOfURReferences.Schema>();
        }
        /// <summary>
