...
namespace FormatDraft202012Feature.ValidationOfURTemplates
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/16/schema", "#/016/tests/004/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft202012Feature.ValidationOfURTemplates.Schema>();
        }
        /// <summary>
