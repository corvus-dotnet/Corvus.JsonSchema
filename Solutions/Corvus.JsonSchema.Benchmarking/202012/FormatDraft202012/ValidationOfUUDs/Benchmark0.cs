...
namespace FormatDraft202012Feature.ValidationOfUUDs
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\format.json", "#/17/schema", "#/017/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<FormatDraft202012Feature.ValidationOfUUDs.Schema>();
        }
        /// <summary>
