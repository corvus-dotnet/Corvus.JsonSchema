...
namespace IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId
{
    ...
    public class Benchmark6 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\id.json", "#/0/schema", "#/000/tests/006/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<IdDraft202012Feature.InvalidUseOfFragmentsInLocationIndependentId.Schema>();
        }
        /// <summary>
