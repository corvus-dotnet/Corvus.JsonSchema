...
namespace IdDraft202012Feature.ValidUseOfEmptyFragmentsInLocationIndependentId
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\id.json", "#/1/schema", "#/001/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<IdDraft202012Feature.ValidUseOfEmptyFragmentsInLocationIndependentId.Schema>();
        }
        /// <summary>
