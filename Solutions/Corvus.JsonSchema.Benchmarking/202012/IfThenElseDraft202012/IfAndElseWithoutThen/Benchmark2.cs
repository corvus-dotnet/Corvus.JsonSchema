...
namespace IfThenElseDraft202012Feature.IfAndElseWithoutThen
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\if-then-else.json", "#/4/schema", "#/004/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<IfThenElseDraft202012Feature.IfAndElseWithoutThen.Schema>();
        }
        /// <summary>
