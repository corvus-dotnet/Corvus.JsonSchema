...
namespace IfThenElseDraft202012Feature.IfWithBooleanSchemaFalse
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\if-then-else.json", "#/8/schema", "#/008/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<IfThenElseDraft202012Feature.IfWithBooleanSchemaFalse.Schema>();
        }
        /// <summary>
