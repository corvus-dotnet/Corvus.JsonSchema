...
namespace IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\if-then-else.json", "#/7/schema", "#/007/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<IfThenElseDraft202012Feature.IfWithBooleanSchemaTrue.Schema>();
        }
        /// <summary>
