...
namespace IfThenElseDraft202012Feature.IgnoreThenWithoutIf
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\if-then-else.json", "#/1/schema", "#/001/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<IfThenElseDraft202012Feature.IgnoreThenWithoutIf.Schema>();
        }
        /// <summary>
