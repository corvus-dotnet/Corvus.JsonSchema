...
namespace IriDraft202012Feature.ValidationOfIRs
{
    ...
    public class Benchmark6 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\optional/format/iri.json", "#/0/schema", "#/000/tests/006/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<IriDraft202012Feature.ValidationOfIRs.Schema>();
        }
        /// <summary>
