...
namespace ItemsDraft202012Feature.ASchemaGivenForItems
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\items.json", "#/0/schema", "#/000/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<ItemsDraft202012Feature.ASchemaGivenForItems.Schema>();
        }
        /// <summary>
