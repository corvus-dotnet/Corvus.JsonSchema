...
namespace ItemsDraft202012Feature.ItemsAndSubitems
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\items.json", "#/3/schema", "#/003/tests/004/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<ItemsDraft202012Feature.ItemsAndSubitems.JsonNotAnyArray>();
        }
        /// <summary>
