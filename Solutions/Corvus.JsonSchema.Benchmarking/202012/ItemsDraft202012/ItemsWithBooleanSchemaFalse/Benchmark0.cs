...
namespace ItemsDraft202012Feature.ItemsWithBooleanSchemaFalse
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\items.json", "#/2/schema", "#/002/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<ItemsDraft202012Feature.ItemsWithBooleanSchemaFalse.Schema>();
        }
        /// <summary>
