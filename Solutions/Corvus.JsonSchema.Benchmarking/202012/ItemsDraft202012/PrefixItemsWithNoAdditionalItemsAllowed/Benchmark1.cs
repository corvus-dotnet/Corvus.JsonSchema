...
namespace ItemsDraft202012Feature.PrefixItemsWithNoAdditionalItemsAllowed
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\items.json", "#/5/schema", "#/005/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<ItemsDraft202012Feature.PrefixItemsWithNoAdditionalItemsAllowed.Schema>();
        }
        /// <summary>
