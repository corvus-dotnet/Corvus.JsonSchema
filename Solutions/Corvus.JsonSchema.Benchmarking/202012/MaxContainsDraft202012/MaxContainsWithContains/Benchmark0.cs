...
namespace MaxContainsDraft202012Feature.MaxContainsWithContains
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\maxContains.json", "#/1/schema", "#/001/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MaxContainsDraft202012Feature.MaxContainsWithContains.Schema>();
        }
        /// <summary>
