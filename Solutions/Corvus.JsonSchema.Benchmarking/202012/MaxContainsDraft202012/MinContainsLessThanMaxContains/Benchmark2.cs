...
namespace MaxContainsDraft202012Feature.MinContainsLessThanMaxContains
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\maxContains.json", "#/2/schema", "#/002/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MaxContainsDraft202012Feature.MinContainsLessThanMaxContains.Schema>();
        }
        /// <summary>
