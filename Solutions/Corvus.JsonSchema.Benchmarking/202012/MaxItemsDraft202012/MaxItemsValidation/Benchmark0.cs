...
namespace MaxItemsDraft202012Feature.MaxItemsValidation
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\maxItems.json", "#/0/schema", "#/000/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MaxItemsDraft202012Feature.MaxItemsValidation.Schema>();
        }
        /// <summary>
