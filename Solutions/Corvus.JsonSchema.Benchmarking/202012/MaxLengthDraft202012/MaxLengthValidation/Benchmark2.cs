...
namespace MaxLengthDraft202012Feature.MaxLengthValidation
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\maxLength.json", "#/0/schema", "#/000/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MaxLengthDraft202012Feature.MaxLengthValidation.Schema>();
        }
        /// <summary>
