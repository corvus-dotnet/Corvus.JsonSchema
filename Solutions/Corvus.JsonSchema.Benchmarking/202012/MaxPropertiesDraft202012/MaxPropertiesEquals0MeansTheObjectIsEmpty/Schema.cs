                    ...
                    IEquatable<Schema>
    {
            ...
            private ValidationContext ValidateObject(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            if (propertyCount > 0)
            {
                ...
                {
                    result = result.WithResult(isValid: false, $"6.5.1. maxProperties - property count of {propertyCount} is greater than 0.");
                }
                else if (level >= ValidationLevel.Basic)
                {
                    result = result.WithResult(isValid: false, "6.5.1. maxProperties - property count greater than 0.");
                }
                else
                {
