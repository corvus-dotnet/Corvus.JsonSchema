...
namespace MaxPropertiesDraft202012Feature.MaxPropertiesValidation
{
    ...
    public class Benchmark5 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\maxProperties.json", "#/0/schema", "#/000/tests/005/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MaxPropertiesDraft202012Feature.MaxPropertiesValidation.Schema>();
        }
        /// <summary>
