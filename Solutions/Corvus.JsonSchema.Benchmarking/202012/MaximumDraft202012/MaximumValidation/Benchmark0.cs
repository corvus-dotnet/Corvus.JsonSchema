...
namespace MaximumDraft202012Feature.MaximumValidation
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\maximum.json", "#/0/schema", "#/000/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MaximumDraft202012Feature.MaximumValidation.Schema>();
        }
        /// <summary>
