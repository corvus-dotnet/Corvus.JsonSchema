...
namespace MaximumDraft202012Feature.MaximumValidationWithUnsignedInteger
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\maximum.json", "#/1/schema", "#/001/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MaximumDraft202012Feature.MaximumValidationWithUnsignedInteger.Schema>();
        }
        /// <summary>
