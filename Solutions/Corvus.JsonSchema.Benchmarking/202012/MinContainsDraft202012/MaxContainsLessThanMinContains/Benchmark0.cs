...
namespace MinContainsDraft202012Feature.MaxContainsLessThanMinContains
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\minContains.json", "#/4/schema", "#/004/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MinContainsDraft202012Feature.MaxContainsLessThanMinContains.Schema>();
        }
        /// <summary>
