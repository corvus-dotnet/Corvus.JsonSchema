...
namespace MinContainsDraft202012Feature.MinContainsEquals0
{
    using System;
                ...
                IEquatable<Schema>
    {
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        ValidationContext containsResult = arrayEnumerator.Current.As<MinContainsDraft202012Feature.MinContainsEquals0.Schema.ContainsEntity>().Validate(result.CreateChildContext(), level);
