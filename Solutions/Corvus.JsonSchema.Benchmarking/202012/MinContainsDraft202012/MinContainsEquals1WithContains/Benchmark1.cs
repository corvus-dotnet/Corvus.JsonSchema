...
namespace MinContainsDraft202012Feature.MinContainsEquals1WithContains
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\minContains.json", "#/1/schema", "#/001/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MinContainsDraft202012Feature.MinContainsEquals1WithContains.Schema>();
        }
        /// <summary>
