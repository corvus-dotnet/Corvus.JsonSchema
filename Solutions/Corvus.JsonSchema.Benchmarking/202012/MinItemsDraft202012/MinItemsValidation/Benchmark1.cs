...
namespace MinItemsDraft202012Feature.MinItemsValidation
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\minItems.json", "#/0/schema", "#/000/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MinItemsDraft202012Feature.MinItemsValidation.Schema>();
        }
        /// <summary>
