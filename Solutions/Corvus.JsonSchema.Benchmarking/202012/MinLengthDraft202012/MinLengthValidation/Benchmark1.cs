...
namespace MinLengthDraft202012Feature.MinLengthValidation
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\minLength.json", "#/0/schema", "#/000/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MinLengthDraft202012Feature.MinLengthValidation.Schema>();
        }
        /// <summary>
