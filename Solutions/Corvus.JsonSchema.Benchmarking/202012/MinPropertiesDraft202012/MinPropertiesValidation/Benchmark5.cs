...
namespace MinPropertiesDraft202012Feature.MinPropertiesValidation
{
    ...
    public class Benchmark5 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\minProperties.json", "#/0/schema", "#/000/tests/005/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MinPropertiesDraft202012Feature.MinPropertiesValidation.Schema>();
        }
        /// <summary>
