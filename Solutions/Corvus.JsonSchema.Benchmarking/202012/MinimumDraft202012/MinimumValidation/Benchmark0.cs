...
namespace MinimumDraft202012Feature.MinimumValidation
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\minimum.json", "#/0/schema", "#/000/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MinimumDraft202012Feature.MinimumValidation.Schema>();
        }
        /// <summary>
