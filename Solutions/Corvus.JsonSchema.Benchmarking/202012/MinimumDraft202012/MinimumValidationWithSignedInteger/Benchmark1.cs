...
namespace MinimumDraft202012Feature.MinimumValidationWithSignedInteger
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\minimum.json", "#/1/schema", "#/001/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MinimumDraft202012Feature.MinimumValidationWithSignedInteger.Schema>();
        }
        /// <summary>
