...
namespace MultipleOfDraft202012Feature.ByInt
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\multipleOf.json", "#/0/schema", "#/000/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MultipleOfDraft202012Feature.ByInt.Schema>();
        }
        /// <summary>
