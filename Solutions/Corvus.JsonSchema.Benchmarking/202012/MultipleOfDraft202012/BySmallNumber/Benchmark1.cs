...
namespace MultipleOfDraft202012Feature.BySmallNumber
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\multipleOf.json", "#/2/schema", "#/002/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<MultipleOfDraft202012Feature.BySmallNumber.Schema>();
        }
        /// <summary>
