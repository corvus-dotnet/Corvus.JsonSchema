...
namespace NotDraft202012Feature.ForbiddenProperty
{
    using System;
                    ...
                    IEquatable<Schema>
    {
        ...
        /// {Property examples}.
        /// </example>
        public NotDraft202012Feature.ForbiddenProperty.Schema.FooEntity Foo
        {
            get
            {
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  NotDraft202012Feature.ForbiddenProperty.Schema.FooEntity(result);
                    }
                }
        ...
        public static Schema Create(
                            NotDraft202012Feature.ForbiddenProperty.Schema.FooEntity? foo = null
        
        )
        {
            var builder = ImmutableDictionary.CreateBuilder<string, JsonAny>();
                            if (foo is NotDraft202012Feature.ForbiddenProperty.Schema.FooEntity foo__)
            {
        ...
        public Schema WithFoo(NotDraft202012Feature.ForbiddenProperty.Schema.FooEntity value)
        {
        ...
        {
            NotDraft202012Feature.ForbiddenProperty.Schema.FooEntity property = that.Foo;
