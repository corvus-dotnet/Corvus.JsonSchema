...
namespace OneOfDraft202012Feature.OneOf
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\oneOf.json", "#/0/schema", "#/000/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<OneOfDraft202012Feature.OneOf.Schema>();
        }
        /// <summary>
