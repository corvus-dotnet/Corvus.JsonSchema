...
namespace OneOfDraft202012Feature.OneOfWithBooleanSchemasAllFalse
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\oneOf.json", "#/5/schema", "#/005/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<OneOfDraft202012Feature.OneOfWithBooleanSchemasAllFalse.Schema>();
        }
        /// <summary>
