...
namespace OneOfDraft202012Feature.OneOfWithBooleanSchemasAllTrue
{
    using System;
            ...
            IEquatable<Schema>
    {
        ...
        private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext oneOfResult1 = this.As<Corvus.Json.JsonAny>().Validate(validationContext.CreateChildContext(), level);
            ...
            ValidationContext oneOfResult2 = this.As<Corvus.Json.JsonAny>().Validate(validationContext.CreateChildContext(), level);
