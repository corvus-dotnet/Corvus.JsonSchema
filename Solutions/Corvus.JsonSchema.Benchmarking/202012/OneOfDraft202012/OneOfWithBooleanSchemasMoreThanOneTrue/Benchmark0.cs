...
namespace OneOfDraft202012Feature.OneOfWithBooleanSchemasMoreThanOneTrue
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\oneOf.json", "#/4/schema", "#/004/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<OneOfDraft202012Feature.OneOfWithBooleanSchemasMoreThanOneTrue.Schema>();
        }
        /// <summary>
