...
namespace OneOfDraft202012Feature.OneOfWithBooleanSchemasOneTrue
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\oneOf.json", "#/3/schema", "#/003/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<OneOfDraft202012Feature.OneOfWithBooleanSchemasOneTrue.Schema>();
        }
        /// <summary>
