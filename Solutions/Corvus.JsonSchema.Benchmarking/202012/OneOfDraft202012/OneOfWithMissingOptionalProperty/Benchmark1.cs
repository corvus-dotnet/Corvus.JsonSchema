...
namespace OneOfDraft202012Feature.OneOfWithMissingOptionalProperty
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\oneOf.json", "#/9/schema", "#/009/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<OneOfDraft202012Feature.OneOfWithMissingOptionalProperty.Schema>();
        }
        /// <summary>
