...
namespace OneOfDraft202012Feature.OneOfWithRequired
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\oneOf.json", "#/8/schema", "#/008/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<OneOfDraft202012Feature.OneOfWithRequired.Schema>();
        }
        /// <summary>
