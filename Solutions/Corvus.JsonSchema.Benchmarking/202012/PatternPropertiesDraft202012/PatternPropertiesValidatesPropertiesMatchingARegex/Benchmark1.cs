...
namespace PatternPropertiesDraft202012Feature.PatternPropertiesValidatesPropertiesMatchingARegex
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\patternProperties.json", "#/0/schema", "#/000/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<PatternPropertiesDraft202012Feature.PatternPropertiesValidatesPropertiesMatchingARegex.Schema>();
        }
        /// <summary>
