...
namespace PatternPropertiesDraft202012Feature.PatternPropertiesWithBooleanSchemas
{
    using System;
                    ...
                    IEquatable<Schema>
    {
                ...
                /// <summary>
        /// A pattern property matching f.* producing a <see cref="Corvus.Json.JsonAny" />.
        /// </summary>
        public static Regex PatternPropertyJsonAny = new Regex("f.*", RegexOptions.Compiled);

                /// <summary>
        /// A pattern property matching b.* producing a <see cref="Corvus.Json.JsonNotAny" />.
        /// </summary>
        public static Regex PatternPropertyJsonNotAny = new Regex("b.*", RegexOptions.Compiled);
            ...
            where T : struct, IJsonValue
        {
            return this.As<Schema, T>();
                ...
                /// <summary>
        /// Determines if a property matches f.* producing a <see cref="Corvus.Json.JsonAny" />.
        /// </summary>
        ...
        /// <summary>
        /// Get a property as the matching property type f.* as a <see cref="Corvus.Json.JsonAny" />.
        /// </summary>
        public Corvus.Json.JsonAny AsPatternJsonAny(in Property property)
        {
            return property.ValueAs<Corvus.Json.JsonAny>();
                ...
                /// <summary>
        /// Determines if a property matches b.* producing a <see cref="Corvus.Json.JsonNotAny" />.
        /// </summary>
        public bool MatchesPatternJsonNotAny(in Property property)
        {
            return PatternPropertyJsonNotAny.IsMatch(property.Name);
        }

        /// <summary>
        /// Get a property as the matching property type b.* as a <see cref="Corvus.Json.JsonNotAny" />.
        /// </summary>
        public Corvus.Json.JsonNotAny AsPatternJsonNotAny(in Property property)
        {
            ...
            private static ImmutableDictionary<Regex, PatternPropertyValidator> CreatePatternPropertiesValidators()
        {
            ImmutableDictionary<Regex, PatternPropertyValidator>.Builder builder =
                ...
                PatternPropertyJsonAny,__CorvusValidatePatternPropertyJsonAny);
                    builder.Add(
                PatternPropertyJsonNotAny,__CorvusValidatePatternPropertyJsonNotAny);
                ...
                private static ValidationContext __CorvusValidatePatternPropertyJsonAny(in Property that, in ValidationContext validationContext, ValidationLevel level)
        {
            return that.ValueAs<Corvus.Json.JsonAny>().Validate(validationContext, level);
                ...
                private static ValidationContext __CorvusValidatePatternPropertyJsonNotAny(in Property that, in ValidationContext validationContext, ValidationLevel level)
        {
