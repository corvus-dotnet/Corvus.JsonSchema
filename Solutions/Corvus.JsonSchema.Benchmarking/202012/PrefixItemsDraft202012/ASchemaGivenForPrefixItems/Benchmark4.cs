...
namespace PrefixItemsDraft202012Feature.ASchemaGivenForPrefixItems
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\prefixItems.json", "#/0/schema", "#/000/tests/004/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<PrefixItemsDraft202012Feature.ASchemaGivenForPrefixItems.Schema>();
        }
        /// <summary>
