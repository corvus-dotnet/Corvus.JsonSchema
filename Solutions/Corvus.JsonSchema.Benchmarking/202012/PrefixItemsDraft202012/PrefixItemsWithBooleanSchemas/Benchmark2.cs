...
namespace PrefixItemsDraft202012Feature.PrefixItemsWithBooleanSchemas
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\prefixItems.json", "#/1/schema", "#/001/tests/002/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<PrefixItemsDraft202012Feature.PrefixItemsWithBooleanSchemas.Schema>();
        }
        /// <summary>
