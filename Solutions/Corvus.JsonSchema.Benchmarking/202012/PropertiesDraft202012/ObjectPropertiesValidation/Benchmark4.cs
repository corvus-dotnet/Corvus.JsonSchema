...
namespace PropertiesDraft202012Feature.ObjectPropertiesValidation
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\properties.json", "#/0/schema", "#/000/tests/004/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<PropertiesDraft202012Feature.ObjectPropertiesValidation.Schema>();
        }
        /// <summary>
