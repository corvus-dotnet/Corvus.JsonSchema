...
namespace PropertyNamesDraft202012Feature.PropertyNamesValidation
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\propertyNames.json", "#/0/schema", "#/000/tests/004/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<PropertyNamesDraft202012Feature.PropertyNamesValidation.Schema>();
        }
        /// <summary>
