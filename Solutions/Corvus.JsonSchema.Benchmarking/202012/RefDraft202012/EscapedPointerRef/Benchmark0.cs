...
namespace RefDraft202012Feature.EscapedPointerRef
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\ref.json", "#/3/schema", "#/003/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<RefDraft202012Feature.EscapedPointerRef.Schema>();
        }
        /// <summary>
