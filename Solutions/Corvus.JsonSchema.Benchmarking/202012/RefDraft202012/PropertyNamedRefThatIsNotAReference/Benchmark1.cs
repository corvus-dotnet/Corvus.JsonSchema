...
namespace RefDraft202012Feature.PropertyNamedRefThatIsNotAReference
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\ref.json", "#/7/schema", "#/007/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<RefDraft202012Feature.PropertyNamedRefThatIsNotAReference.Schema>();
        }
        /// <summary>
