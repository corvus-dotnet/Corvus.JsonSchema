...
namespace RefDraft202012Feature.RefAppliesAlongsideSiblingKeywords
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\ref.json", "#/5/schema", "#/005/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<RefDraft202012Feature.RefAppliesAlongsideSiblingKeywords.Schema>();
        }
        /// <summary>
