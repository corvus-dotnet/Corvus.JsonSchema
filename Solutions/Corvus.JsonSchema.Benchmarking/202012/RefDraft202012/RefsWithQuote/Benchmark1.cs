...
namespace RefDraft202012Feature.RefsWithQuote
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\ref.json", "#/12/schema", "#/012/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<RefDraft202012Feature.RefsWithQuote.Schema>();
        }
        /// <summary>
