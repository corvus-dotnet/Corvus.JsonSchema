...
namespace RefDraft202012Feature.RefsWithRelativeUrisAndDefs
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\ref.json", "#/15/schema", "#/015/tests/002/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<RefDraft202012Feature.RefsWithRelativeUrisAndDefs.SchemaRelativeUriDefs1Json>();
        }
        /// <summary>
