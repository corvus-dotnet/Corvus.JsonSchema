...
namespace RefDraft202012Feature.RefsWithRelativeUrisAndDefs
{
                    ...
                    IEquatable<SchemaRelativeUriDefs1Json>
    {
        ...
        /// Initializes a new instance of the <see cref="SchemaRelativeUriDefs1Json"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="RefDraft202012Feature.RefsWithRelativeUrisAndDefs.Inner"/> from which to construct the value.</param>
        public SchemaRelativeUriDefs1Json(RefDraft202012Feature.RefsWithRelativeUrisAndDefs.Inner conversion)
        {
            ...
            /// <summary>
        /// Gets the value as a <see cref="RefDraft202012Feature.RefsWithRelativeUrisAndDefs.Inner" />.
        /// </summary>
        public RefDraft202012Feature.RefsWithRelativeUrisAndDefs.Inner AsInner
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="RefDraft202012Feature.RefsWithRelativeUrisAndDefs.Inner" />.
        /// </summary>
        public bool IsInner
        {
            get
            {
                return ((RefDraft202012Feature.RefsWithRelativeUrisAndDefs.Inner)this).Validate().IsValid;
            }
        }
        ...
        /// {Property examples}.
        /// </example>
        public RefDraft202012Feature.RefsWithRelativeUrisAndDefs.Inner Foo
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<string, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefDraft202012Feature.RefsWithRelativeUrisAndDefs.Inner(result);
                    }
                }
        ...
        public JsonAny AsAny
        {
            ...
            /// <summary>
        /// Conversion from <see cref="RefDraft202012Feature.RefsWithRelativeUrisAndDefs.Inner" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator SchemaRelativeUriDefs1Json(RefDraft202012Feature.RefsWithRelativeUrisAndDefs.Inner value)
        {
            return new SchemaRelativeUriDefs1Json(value);
        }

        /// <summary>
        /// Conversion to <see cref="RefDraft202012Feature.RefsWithRelativeUrisAndDefs.Inner" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RefDraft202012Feature.RefsWithRelativeUrisAndDefs.Inner(SchemaRelativeUriDefs1Json value)
        {
                    if (value.ValueKind == JsonValueKind.Object)
            {
                return new RefDraft202012Feature.RefsWithRelativeUrisAndDefs.Inner(value.AsObject);
            }
                                                    return default;
        }
        ...
        ,             RefDraft202012Feature.RefsWithRelativeUrisAndDefs.Inner? foo = null
        ...
        )
        {
                            ...
                            if (bar is Corvus.Json.JsonString bar__)
            {
                builder.Add(BarJsonPropertyName, bar__);
                    ...
                    if (foo is RefDraft202012Feature.RefsWithRelativeUrisAndDefs.Inner foo__)
            {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public SchemaRelativeUriDefs1Json WithFoo(RefDraft202012Feature.RefsWithRelativeUrisAndDefs.Inner value)
        {
        ...
        {
            RefDraft202012Feature.RefsWithRelativeUrisAndDefs.Inner property = that.Foo;
            ...
            private ValidationContext ValidateRef(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext refResult = this.As<RefDraft202012Feature.RefsWithRelativeUrisAndDefs.Inner>().Validate(validationContext.CreateChildContext(), level);
