...
namespace RefDraft202012Feature.RelativeRefsWithAbsoluteUrisAndDefs
{
                    ...
                    IEquatable<SchemaRefsAbsoluteUrisDefs1Json>
    {
        ...
        /// Initializes a new instance of the <see cref="SchemaRefsAbsoluteUrisDefs1Json"/> struct.
        /// </summary>
        /// <param name="conversion">The <see cref="RefDraft202012Feature.RelativeRefsWithAbsoluteUrisAndDefs.Inner"/> from which to construct the value.</param>
        public SchemaRefsAbsoluteUrisDefs1Json(RefDraft202012Feature.RelativeRefsWithAbsoluteUrisAndDefs.Inner conversion)
        {
            ...
            /// <summary>
        /// Gets the value as a <see cref="RefDraft202012Feature.RelativeRefsWithAbsoluteUrisAndDefs.Inner" />.
        /// </summary>
        public RefDraft202012Feature.RelativeRefsWithAbsoluteUrisAndDefs.Inner AsInner
        {
            get
            {
                return this;
        ...
        /// <summary>
        /// Gets a value indicating whether this is a valid <see cref="RefDraft202012Feature.RelativeRefsWithAbsoluteUrisAndDefs.Inner" />.
        /// </summary>
        public bool IsInner
        {
            get
            {
                return ((RefDraft202012Feature.RelativeRefsWithAbsoluteUrisAndDefs.Inner)this).Validate().IsValid;
            }
        }
        ...
        /// {Property examples}.
        /// </example>
        public RefDraft202012Feature.RelativeRefsWithAbsoluteUrisAndDefs.Inner Foo
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<string, JsonAny> properties)
                ...
                if (this.jsonElementBacking.ValueKind == JsonValueKind.Object)
                {
                    ...
                    {
                        return new  RefDraft202012Feature.RelativeRefsWithAbsoluteUrisAndDefs.Inner(result);
                    }
                }
        ...
        public JsonAny AsAny
        {
            ...
            /// <summary>
        /// Conversion from <see cref="RefDraft202012Feature.RelativeRefsWithAbsoluteUrisAndDefs.Inner" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator SchemaRefsAbsoluteUrisDefs1Json(RefDraft202012Feature.RelativeRefsWithAbsoluteUrisAndDefs.Inner value)
        {
            return new SchemaRefsAbsoluteUrisDefs1Json(value);
        }

        /// <summary>
        /// Conversion to <see cref="RefDraft202012Feature.RelativeRefsWithAbsoluteUrisAndDefs.Inner" />.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RefDraft202012Feature.RelativeRefsWithAbsoluteUrisAndDefs.Inner(SchemaRefsAbsoluteUrisDefs1Json value)
        {
                    if (value.ValueKind == JsonValueKind.Object)
            {
                return new RefDraft202012Feature.RelativeRefsWithAbsoluteUrisAndDefs.Inner(value.AsObject);
            }
                                                    return default;
        }
        ...
        ,             RefDraft202012Feature.RelativeRefsWithAbsoluteUrisAndDefs.Inner? foo = null
        ...
        )
        {
                            ...
                            if (bar is Corvus.Json.JsonString bar__)
            {
                builder.Add(BarJsonPropertyName, bar__);
                    ...
                    if (foo is RefDraft202012Feature.RelativeRefsWithAbsoluteUrisAndDefs.Inner foo__)
            {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public SchemaRefsAbsoluteUrisDefs1Json WithFoo(RefDraft202012Feature.RelativeRefsWithAbsoluteUrisAndDefs.Inner value)
        {
        ...
        {
            RefDraft202012Feature.RelativeRefsWithAbsoluteUrisAndDefs.Inner property = that.Foo;
            ...
            private ValidationContext ValidateRef(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext refResult = this.As<RefDraft202012Feature.RelativeRefsWithAbsoluteUrisAndDefs.Inner>().Validate(validationContext.CreateChildContext(), level);
