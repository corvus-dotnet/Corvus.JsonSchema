...
namespace RefDraft202012Feature.RemoteRefContainingRefsItself
{
                    ...
                    IEquatable<Unevaluated>
    {
        ...
        /// {Property examples}.
        /// </example>
        public RefDraft202012Feature.RemoteRefContainingRefsItself.Schema UnevaluatedItems
        {
            get
            {
        ...
        /// {Property examples}.
        /// </example>
        public RefDraft202012Feature.RemoteRefContainingRefsItself.Schema UnevaluatedProperties
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<string, JsonAny> properties)
        ...
        public static Unevaluated Create(
                            RefDraft202012Feature.RemoteRefContainingRefsItself.Schema? unevaluatedItems = null
        ,             RefDraft202012Feature.RemoteRefContainingRefsItself.Schema? unevaluatedProperties = null
        ...
        )
        {
                            ...
                            if (unevaluatedItems is RefDraft202012Feature.RemoteRefContainingRefsItself.Schema unevaluatedItems__)
            {
                builder.Add(UnevaluatedItemsJsonPropertyName, unevaluatedItems__);
                    ...
                    if (unevaluatedProperties is RefDraft202012Feature.RemoteRefContainingRefsItself.Schema unevaluatedProperties__)
            {
        ...
        public Unevaluated WithUnevaluatedItems(RefDraft202012Feature.RemoteRefContainingRefsItself.Schema value)
        {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Unevaluated WithUnevaluatedProperties(RefDraft202012Feature.RemoteRefContainingRefsItself.Schema value)
        {
        ...
        {
            RefDraft202012Feature.RemoteRefContainingRefsItself.Schema property = that.UnevaluatedItems;
        ...
        {
            RefDraft202012Feature.RemoteRefContainingRefsItself.Schema property = that.UnevaluatedProperties;
            return property.Validate(validationContext, level);
        }
