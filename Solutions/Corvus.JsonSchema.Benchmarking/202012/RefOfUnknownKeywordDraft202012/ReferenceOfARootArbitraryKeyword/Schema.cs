...
namespace RefOfUnknownKeywordDraft202012Feature.ReferenceOfARootArbitraryKeyword
{
    using System;
                    ...
                    IEquatable<Schema>
    {
        ...
        public static Schema Create(
                            Corvus.Json.JsonInteger? bar = null
        
        )
        {
            var builder = ImmutableDictionary.CreateBuilder<string, JsonAny>();
                            if (bar is Corvus.Json.JsonInteger bar__)
            {
