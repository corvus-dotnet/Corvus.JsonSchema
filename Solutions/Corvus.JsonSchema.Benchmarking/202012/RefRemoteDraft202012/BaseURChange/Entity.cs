...
namespace RefRemoteDraft202012Feature.BaseURChange
{
    using System;
                ...
                IEquatable<Entity>
    {
        ...
        public static Entity From(params RefRemoteDraft202012Feature.BaseURChange.BaseUriChange[] items)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Entity From(RefRemoteDraft202012Feature.BaseURChange.BaseUriChange item1)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Entity From(RefRemoteDraft202012Feature.BaseURChange.BaseUriChange item1, RefRemoteDraft202012Feature.BaseURChange.BaseUriChange item2)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Entity From(RefRemoteDraft202012Feature.BaseURChange.BaseUriChange item1, RefRemoteDraft202012Feature.BaseURChange.BaseUriChange item2, RefRemoteDraft202012Feature.BaseURChange.BaseUriChange item3)
        {
        ...
        /// <returns>The new array created from the items.</returns>
        public static Entity From(RefRemoteDraft202012Feature.BaseURChange.BaseUriChange item1, RefRemoteDraft202012Feature.BaseURChange.BaseUriChange item2, RefRemoteDraft202012Feature.BaseURChange.BaseUriChange item3, RefRemoteDraft202012Feature.BaseURChange.BaseUriChange item4)
        {
        ...
        public void WriteTo(Utf8JsonWriter writer)
        {
            ...
            writer.WriteNullValue();
                ...
                /// <summary>
        /// Enumerate the items in the array as a <see cref="RefRemoteDraft202012Feature.BaseURChange.BaseUriChange" />.
        /// </summary>
        public JsonArrayEnumerator<RefRemoteDraft202012Feature.BaseURChange.BaseUriChange> EnumerateItems()
        {
            if (this.arrayBacking is ImmutableList<JsonAny> items)
            {
                return new JsonArrayEnumerator<RefRemoteDraft202012Feature.BaseURChange.BaseUriChange>(items);
            }

            if (this.jsonElementBacking.ValueKind == JsonValueKind.Array)
            {
                return new JsonArrayEnumerator<RefRemoteDraft202012Feature.BaseURChange.BaseUriChange>(this.jsonElementBacking);
            }
        ...
        /// <inheritdoc/>
        public Entity Add<TItem1, TItem2>(TItem1 item1, TItem2 item2)
        ...
        /// <inheritdoc/>
        public Entity Add<TItem1, TItem2, TItem3>(TItem1 item1, TItem2 item2, TItem3 item3)
            where TItem1 : struct, IJsonValue
            where TItem2 : struct, IJsonValue
        ...
        /// <inheritdoc/>
        public Entity Add<TItem1, TItem2, TItem3, TItem4>(TItem1 item1, TItem2 item2, TItem3 item3, TItem4 item4)
            where TItem1 : struct, IJsonValue
            where TItem2 : struct, IJsonValue
            where TItem3 : struct, IJsonValue
        ...
        /// <inheritdoc/>
        public Entity Add<TItem>(params TItem[] items)
            where TItem : struct, IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Array || this.ValueKind == JsonValueKind.Undefined)
            {
        ...
        /// <inheritdoc/>
        public Entity AddRange<TItem>(IEnumerable<TItem> items)
            where TItem : struct, IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Array || this.ValueKind == JsonValueKind.Undefined)
            {
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        result = arrayEnumerator.Current.As<RefRemoteDraft202012Feature.BaseURChange.BaseUriChange>().Validate(result, level);
                if (level == ValidationLevel.Flag && !result.IsValid)
                {
                    return result;
                }
