...
namespace RefRemoteDraft202012Feature.RemoteRefWithRefToDefs
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\refRemote.json", "#/7/schema", "#/007/tests/000/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<RefRemoteDraft202012Feature.RemoteRefWithRefToDefs.Inner>();
        }
        /// <summary>
