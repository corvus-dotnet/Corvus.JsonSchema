...
namespace RegexDraft202012Feature.ValidationOfRegularExpressions
{
    ...
    public class Benchmark4 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\optional/format/regex.json", "#/0/schema", "#/000/tests/004/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<RegexDraft202012Feature.ValidationOfRegularExpressions.Schema>();
        }
        /// <summary>
