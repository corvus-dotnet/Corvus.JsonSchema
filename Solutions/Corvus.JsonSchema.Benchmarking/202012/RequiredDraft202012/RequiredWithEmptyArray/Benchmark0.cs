...
namespace RequiredDraft202012Feature.RequiredWithEmptyArray
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\required.json", "#/2/schema", "#/002/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<RequiredDraft202012Feature.RequiredWithEmptyArray.Schema>();
        }
        /// <summary>
