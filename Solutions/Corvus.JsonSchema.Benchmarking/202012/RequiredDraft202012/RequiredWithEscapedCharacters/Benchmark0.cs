...
namespace RequiredDraft202012Feature.RequiredWithEscapedCharacters
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\required.json", "#/3/schema", "#/003/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<RequiredDraft202012Feature.RequiredWithEscapedCharacters.Schema>();
        }
        /// <summary>
