...
namespace TypeDraft202012Feature.TypeArrayObjectOrNull
{
    ...
    public class Benchmark3 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\type.json", "#/10/schema", "#/010/tests/003/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<TypeDraft202012Feature.TypeArrayObjectOrNull.Schema>();
        }
        /// <summary>
