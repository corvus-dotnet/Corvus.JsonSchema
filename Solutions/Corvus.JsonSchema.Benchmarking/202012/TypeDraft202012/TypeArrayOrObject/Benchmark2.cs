...
namespace TypeDraft202012Feature.TypeArrayOrObject
{
    ...
    public class Benchmark2 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\type.json", "#/9/schema", "#/009/tests/002/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<TypeDraft202012Feature.TypeArrayOrObject.Schema>();
        }
        /// <summary>
