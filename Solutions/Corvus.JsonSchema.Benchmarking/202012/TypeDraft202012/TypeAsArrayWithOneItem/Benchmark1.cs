...
namespace TypeDraft202012Feature.TypeAsArrayWithOneItem
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\type.json", "#/8/schema", "#/008/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<TypeDraft202012Feature.TypeAsArrayWithOneItem.Schema>();
        }
        /// <summary>
