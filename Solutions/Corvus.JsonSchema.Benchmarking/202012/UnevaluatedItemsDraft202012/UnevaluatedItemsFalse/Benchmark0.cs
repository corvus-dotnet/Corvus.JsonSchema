...
namespace UnevaluatedItemsDraft202012Feature.UnevaluatedItemsFalse
{
    ...
    public class Benchmark0 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\unevaluatedItems.json", "#/1/schema", "#/001/tests/000/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<UnevaluatedItemsDraft202012Feature.UnevaluatedItemsFalse.Schema>();
        }
        /// <summary>
