...
namespace UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithNot
{
    using System;
                ...
                IEquatable<Schema>
    {
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        switch (arrayLength)
                {
                        ...
                        result = arrayEnumerator.Current.As<UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithNot.Schema.PrefixItems0Entity>().Validate(result, level);
                        if (level == ValidationLevel.Flag && !result.IsValid)
                        {
                            return result;
                        }
        ...
        private ValidationContext ValidateNot(ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext notResult = this.As<UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithNot.Schema.NotEntity>().Validate(validationContext.CreateChildContext(), level);
            ...
            IEquatable<NotEntity>
    {
        ...
        private ValidationContext ValidateNot(ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext notResult = this.As<UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithNot.Schema.NotEntity.NotEntity1>().Validate(validationContext.CreateChildContext(), level);
            if (notResult.IsValid)
            {
                if (level >= ValidationLevel.Detailed)
                {
                ...
                IEquatable<NotEntity1>
    {
        ...
        /// <inheritdoc/>
        public NotEntity1 Add<TItem1, TItem2>(TItem1 item1, TItem2 item2)
            where TItem1 : struct, IJsonValue
            where TItem2 : struct, IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Array || this.ValueKind == JsonValueKind.Undefined)
        ...
        /// <inheritdoc/>
        public NotEntity1 Add<TItem1, TItem2, TItem3>(TItem1 item1, TItem2 item2, TItem3 item3)
            where TItem1 : struct, IJsonValue
            where TItem2 : struct, IJsonValue
            where TItem3 : struct, IJsonValue
        {
        ...
        /// <inheritdoc/>
        public NotEntity1 Add<TItem1, TItem2, TItem3, TItem4>(TItem1 item1, TItem2 item2, TItem3 item3, TItem4 item4)
            where TItem1 : struct, IJsonValue
            where TItem2 : struct, IJsonValue
            where TItem3 : struct, IJsonValue
            where TItem4 : struct, IJsonValue
        ...
        /// <inheritdoc/>
        public NotEntity1 Add<TItem>(params TItem[] items)
            where TItem : struct, IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Array || this.ValueKind == JsonValueKind.Undefined)
            {
        ...
        /// <inheritdoc/>
        public NotEntity1 AddRange<TItem>(IEnumerable<TItem> items)
            where TItem : struct, IJsonValue
        {
            if (this.ValueKind == JsonValueKind.Array || this.ValueKind == JsonValueKind.Undefined)
            {
            ...
            private ValidationContext ValidateArray(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            while (arrayEnumerator.MoveNext())
            {
                        ...
                        switch (arrayLength)
                {
                        ...
                        result = arrayEnumerator.Current.As<UnevaluatedItemsDraft202012Feature.UnevaluatedItemsWithNot.Schema.NotEntity.NotEntity1.PrefixItems1Entity>().Validate(result, level);
                        if (level == ValidationLevel.Flag && !result.IsValid)
                        {
                            return result;
                        }
