...
namespace UnevaluatedPropertiesDraft202012Feature.InPlaceApplicatorSiblingsAllOfHasUnevaluated
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\unevaluatedProperties.json", "#/27/schema", "#/027/tests/001/data", true);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<UnevaluatedPropertiesDraft202012Feature.InPlaceApplicatorSiblingsAllOfHasUnevaluated.Schema>();
        }
        /// <summary>
