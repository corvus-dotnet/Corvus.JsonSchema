...
namespace UnevaluatedPropertiesDraft202012Feature.NestedUnevaluatedPropertiesOuterTrueInnerFalsePropertiesOutside
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\unevaluatedProperties.json", "#/20/schema", "#/020/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<UnevaluatedPropertiesDraft202012Feature.NestedUnevaluatedPropertiesOuterTrueInnerFalsePropertiesOutside.Schema>();
        }
        /// <summary>
