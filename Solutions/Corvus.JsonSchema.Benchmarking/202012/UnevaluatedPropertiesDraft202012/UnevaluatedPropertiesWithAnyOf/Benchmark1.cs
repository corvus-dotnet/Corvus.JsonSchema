...
namespace UnevaluatedPropertiesDraft202012Feature.UnevaluatedPropertiesWithAnyOf
{
    ...
    public class Benchmark1 : BenchmarkBase
    {
        ...
        {
            return this.GlobalSetup("draft2020-12\\unevaluatedProperties.json", "#/10/schema", "#/010/tests/001/data", false);
        }
        /// <summary>
        ...
        {
            this.ValidateCorvusCore<UnevaluatedPropertiesDraft202012Feature.UnevaluatedPropertiesWithAnyOf.Schema>();
        }
        /// <summary>
