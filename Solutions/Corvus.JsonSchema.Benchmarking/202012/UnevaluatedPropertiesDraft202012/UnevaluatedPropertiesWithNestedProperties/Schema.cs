...
namespace UnevaluatedPropertiesDraft202012Feature.UnevaluatedPropertiesWithNestedProperties
{
                    ...
                    IEquatable<AllOf0Entity>
    {
        ...
        /// <param name="value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public AllOf0Entity WithBar(Corvus.Json.JsonString value)
        {
            return this.SetProperty(BarJsonPropertyName, value);
        }
        ...
        private static ImmutableDictionary<string, PropertyValidator<AllOf0Entity>> CreateLocalPropertyValidators()
        {
            ...
            return builder.ToImmutable();
                ...
                private static ValidationContext __CorvusValidateBar(in AllOf0Entity that, in ValidationContext validationContext, ValidationLevel level)
        {
