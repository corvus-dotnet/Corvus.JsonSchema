...
namespace Corvus.Json.Draft202012
{
    ...
    public readonly struct Content : IJsonObject<Content>, IEquatable<Content>
    {
        ...
        /// {Property examples}.
        /// </example>
        public Corvus.Json.Draft202012.Schema ContentSchema
        {
            get
            {
                if (this.objectBacking is ImmutableDictionary<string, JsonAny> properties)
        ...
        /// </summary>
        public static Content Create(Corvus.Json.JsonString? contentEncoding = null, Corvus.Json.JsonString? contentMediaType = null, Corvus.Json.Draft202012.Schema? contentSchema = null)
        {
            ...
            if (contentSchema is Corvus.Json.Draft202012.Schema contentSchema__)
            {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Content WithContentSchema(Corvus.Json.Draft202012.Schema value)
        {
        ...
        {
            Corvus.Json.Draft202012.Schema property = that.ContentSchema;
            return property.Validate(validationContext, level);
        }
