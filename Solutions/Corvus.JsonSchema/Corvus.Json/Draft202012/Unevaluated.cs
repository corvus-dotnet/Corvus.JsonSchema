...
namespace Corvus.Json.Draft202012
{
    ...
    public readonly struct Unevaluated : IJsonObject<Unevaluated>, IEquatable<Unevaluated>
    {
        ...
        /// </summary>
        public static Unevaluated Create(Corvus.Json.Draft202012.Schema? unevaluatedItems = null, Corvus.Json.Draft202012.Schema? unevaluatedProperties = null)
        {
        ...
        public Unevaluated WithUnevaluatedItems(Corvus.Json.Draft202012.Schema value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public Unevaluated WithUnevaluatedProperties(Corvus.Json.Draft202012.Schema value)
        {
        ...
        {
            Corvus.Json.Draft202012.Schema property = that.UnevaluatedItems;
        ...
        {
            Corvus.Json.Draft202012.Schema property = that.UnevaluatedProperties;
            return property.Validate(validationContext, level);
        }
