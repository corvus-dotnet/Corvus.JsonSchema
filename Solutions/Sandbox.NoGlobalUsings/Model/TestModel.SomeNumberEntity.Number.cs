...
#if NET8_0_OR_GREATER
        : IJsonNumber<Sandbox.TestModel.SomeNumberEntity>,
          IAdditionOperators<Sandbox.TestModel.SomeNumberEntity, Sandbox.TestModel.SomeNumberEntity, Sandbox.TestModel.SomeNumberEntity>,
          ISubtractionOperators<Sandbox.TestModel.SomeNumberEntity, Sandbox.TestModel.SomeNumberEntity, Sandbox.TestModel.SomeNumberEntity>,
          IMultiplyOperators<Sandbox.TestModel.SomeNumberEntity, Sandbox.TestModel.SomeNumberEntity, Sandbox.TestModel.SomeNumberEntity>,
          IDivisionOperators<Sandbox.TestModel.SomeNumberEntity, Sandbox.TestModel.SomeNumberEntity, Sandbox.TestModel.SomeNumberEntity>,
          IIncrementOperators<Sandbox.TestModel.SomeNumberEntity>,
          IDecrementOperators<Sandbox.TestModel.SomeNumberEntity>
#else
        : IJsonNumber<Sandbox.TestModel.SomeNumberEntity>
#endif
    {
        ...
        public SomeNumberEntity(double value)
        ...
        public static implicit operator SomeNumberEntity(JsonNumber value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonNumber(SomeNumberEntity value)
        {
            return
                value.AsNumber;
        }
        ...
        public static explicit operator byte(SomeNumberEntity value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SomeNumberEntity"/>.</returns>
        public static explicit operator SomeNumberEntity(byte value)
        {
        ...
        public static explicit operator decimal(SomeNumberEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SomeNumberEntity"/>.</returns>
        public static explicit operator SomeNumberEntity(decimal value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static implicit operator double(SomeNumberEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SomeNumberEntity"/>.</returns>
        public static implicit operator SomeNumberEntity(double value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator short(SomeNumberEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SomeNumberEntity"/>.</returns>
        public static explicit operator SomeNumberEntity(short value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator int(SomeNumberEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SomeNumberEntity"/>.</returns>
        public static explicit operator SomeNumberEntity(int value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator long(SomeNumberEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SomeNumberEntity"/>.</returns>
        public static explicit operator SomeNumberEntity(long value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Int128(SomeNumberEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SomeNumberEntity"/>.</returns>
        public static explicit operator SomeNumberEntity(Int128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator sbyte(SomeNumberEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SomeNumberEntity"/>.</returns>
        public static explicit operator SomeNumberEntity(sbyte value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Half(SomeNumberEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SomeNumberEntity"/>.</returns>
        public static explicit operator SomeNumberEntity(Half value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator float(SomeNumberEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SomeNumberEntity"/>.</returns>
        public static explicit operator SomeNumberEntity(float value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ushort(SomeNumberEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SomeNumberEntity"/>.</returns>
        public static explicit operator SomeNumberEntity(ushort value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator uint(SomeNumberEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SomeNumberEntity"/>.</returns>
        public static explicit operator SomeNumberEntity(uint value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ulong(SomeNumberEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SomeNumberEntity"/>.</returns>
        public static explicit operator SomeNumberEntity(ulong value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator UInt128(SomeNumberEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SomeNumberEntity"/>.</returns>
        public static explicit operator SomeNumberEntity(UInt128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        /// </returns>
        public static bool operator <(SomeNumberEntity left, SomeNumberEntity right)
        {
        ...
        public static SomeNumberEntity operator +(SomeNumberEntity left, SomeNumberEntity right)
        {
        ...
        /// <returns>The result of the operation.</returns>
        public static SomeNumberEntity operator ++(SomeNumberEntity value)
        {
        ...
        /// </returns>
        public static int Compare(in SomeNumberEntity lhs, in SomeNumberEntity rhs)
        {
