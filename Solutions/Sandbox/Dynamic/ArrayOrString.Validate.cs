...
public readonly partial struct ArrayOrString
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("DocumentSchema.json?dynamicScope=D%3A%2Fsource%2Fcorvus-dotnet%2FCorvus.JsonSchema%2FSolutions%2FSandbox%2FDocumentSchema.json#/$defs/thingOrString");
        }
    ...
    public static partial class CorvusValidation
    {
            ...
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                oneOfChildContext0 = oneOfChildContext0.PushValidationLocationReducedPathModifier(new("#/oneOf/0/$dynamicRef"));
            }

            ValidationContext oneOfResult0 = value.As<TestingDynamic.ArrayOrString.MyThingArray>().Validate(oneOfChildContext0, level);
            ...
            ValidationContext oneOfResult1 = value.As<Corvus.Json.JsonString>().Validate(oneOfChildContext1, level);
