...
/// </summary>
#if NET8_0_OR_GREATER
[CollectionBuilder(typeof(FlimFlam), "Create")]
#endif
public readonly partial struct FlimFlam
    : IJsonArray<JsonSchemaSample.Api.FlimFlam>,
      IReadOnlyCollection<Corvus.Json.JsonNotAny>
{
    /// <summary>
    /// Gets an empty array.
    /// </summary>
    public static FlimFlam EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
    ...
    /// <inheritdoc/>
    Corvus.Json.JsonAny IJsonArray<FlimFlam>.this[int index]
    {
        get
        {
    ...
    public static implicit operator FlimFlam(ImmutableList<JsonAny> value)
    {
        return new(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator ImmutableList<JsonAny>(FlimFlam value)
    {
        return
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator FlimFlam(JsonArray value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonArray(FlimFlam value)
    {
        return
            value.AsArray;
    }
    ...
    public static FlimFlam From(ImmutableList<JsonAny> items)
    {
        return new(items);
    }

    /// <summary>
    /// Create an new instance of the <see cref="FlimFlam"/>" struct from a span of items.
    /// </summary>
    ...
    public static FlimFlam Create(ReadOnlySpan<Corvus.Json.JsonNotAny> items)
    {
        return new([..items]);
    }
    ...
    public static FlimFlam FromItems(params Corvus.Json.JsonNotAny[] items)
    {
        return new([..items]);
    }
    ...
    public static FlimFlam FromItems(in Corvus.Json.JsonNotAny item1)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static FlimFlam FromItems(in Corvus.Json.JsonNotAny item1, in Corvus.Json.JsonNotAny item2)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static FlimFlam FromItems(in Corvus.Json.JsonNotAny item1, in Corvus.Json.JsonNotAny item2, in Corvus.Json.JsonNotAny item3)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static FlimFlam FromItems(in Corvus.Json.JsonNotAny item1, in Corvus.Json.JsonNotAny item2, in Corvus.Json.JsonNotAny item3, in Corvus.Json.JsonNotAny item4)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static FlimFlam FromItems(in Corvus.Json.JsonNotAny item1, in Corvus.Json.JsonNotAny item2, in Corvus.Json.JsonNotAny item3, in Corvus.Json.JsonNotAny item4, in Corvus.Json.JsonNotAny item5)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static FlimFlam FromItems(in Corvus.Json.JsonNotAny item1, in Corvus.Json.JsonNotAny item2, in Corvus.Json.JsonNotAny item3, in Corvus.Json.JsonNotAny item4, in Corvus.Json.JsonNotAny item5, in Corvus.Json.JsonNotAny item6)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static FlimFlam FromItems(in Corvus.Json.JsonNotAny item1, in Corvus.Json.JsonNotAny item2, in Corvus.Json.JsonNotAny item3, in Corvus.Json.JsonNotAny item4, in Corvus.Json.JsonNotAny item5, in Corvus.Json.JsonNotAny item6, in Corvus.Json.JsonNotAny item7)
    {
    ...
    public static FlimFlam FromRange(IEnumerable<Corvus.Json.JsonNotAny> items)
    {
        return new([..items]);
    }
    ...
    /// <param name="items">The items from which to construct the instance.</param>
    /// <returns>An instance of the array constructed from the items .</returns>
    static FlimFlam IJsonArray<FlimFlam>.FromRange(IEnumerable<JsonAny> items)
    {
        return new([..items]);
    }
    ...
    /// <param name="items">The items from which to construct the instance.</param>
    /// <returns>An instance of the array constructed from the items.</returns>
    static FlimFlam IJsonArray<FlimFlam>.FromRange<T>(IEnumerable<T> items)
    {
    ...
    /// <inheritdoc/>
    IEnumerator<Corvus.Json.JsonNotAny> IEnumerable<Corvus.Json.JsonNotAny>.GetEnumerator() => this.EnumerateArray();

    /// <inheritdoc/>
    IEnumerator IEnumerable.GetEnumerator() => this.EnumerateArray();

    /// <inheritdoc/>
    int IReadOnlyCollection<Corvus.Json.JsonNotAny>.Count => this.GetArrayLength();
    ...
    /// <inheritdoc/>
    JsonArrayEnumerator IJsonArray<FlimFlam>.EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
            return new(this.jsonElementBacking);
    ...
    /// <inheritdoc/>
    JsonArrayEnumerator<TItem> IJsonArray<FlimFlam>.EnumerateArray<TItem>()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
            return new(this.jsonElementBacking);
    ...
    /// <inheritdoc/>
    FlimFlam IJsonArray<FlimFlam>.Add(in JsonAny item1)
    {
    ...
    /// <inheritdoc/>
    FlimFlam IJsonArray<FlimFlam>.Add(params JsonAny[] items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    FlimFlam IJsonArray<FlimFlam>.AddRange<TArray>(in TArray items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    FlimFlam IJsonArray<FlimFlam>.AddRange<TItem>(IEnumerable<TItem> items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    FlimFlam IJsonArray<FlimFlam>.AddRange(IEnumerable<JsonAny> items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    FlimFlam IJsonArray<FlimFlam>.Insert(int index, in JsonAny item1)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
    }

    /// <inheritdoc/>
    FlimFlam IJsonArray<FlimFlam>.InsertRange<TArray>(int index, in TArray items)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.EnumerateArray()));
    }

    /// <inheritdoc/>
    FlimFlam IJsonArray<FlimFlam>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
    }

    /// <inheritdoc/>
    FlimFlam IJsonArray<FlimFlam>.InsertRange(int index, IEnumerable<JsonAny> items)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
    }

    /// <inheritdoc/>
    FlimFlam IJsonArray<FlimFlam>.Replace(in JsonAny oldValue, in JsonAny newValue)
    {
        return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
    }

    /// <inheritdoc/>
    FlimFlam IJsonArray<FlimFlam>.SetItem(int index, in JsonAny value)
    {
        return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
    }

    /// <inheritdoc/>
    public FlimFlam Add(in Corvus.Json.JsonNotAny item1)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    public FlimFlam Add(params Corvus.Json.JsonNotAny[] items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        foreach (Corvus.Json.JsonNotAny item in items)
        {
            builder.Add(item.AsAny);
        }
    ...
    /// <inheritdoc/>
    public FlimFlam AddRange(IEnumerable<Corvus.Json.JsonNotAny> items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        foreach (Corvus.Json.JsonNotAny item in items)
        {
    ...
    /// <inheritdoc/>
    public FlimFlam Insert(int index, in Corvus.Json.JsonNotAny item1)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
    }

    /// <inheritdoc/>
    public FlimFlam InsertRange(int index, IEnumerable<Corvus.Json.JsonNotAny> items)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
    }

    /// <inheritdoc/>
    public FlimFlam Replace(in Corvus.Json.JsonNotAny oldValue, in Corvus.Json.JsonNotAny newValue)
    {
        return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
    }

    /// <inheritdoc/>
    public FlimFlam SetItem(int index, in Corvus.Json.JsonNotAny value)
    {
        return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
    }

    /// <inheritdoc/>
    FlimFlam IJsonArray<FlimFlam>.Remove(in JsonAny oldValue)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
    }

    /// <inheritdoc/>
    FlimFlam IJsonArray<FlimFlam>.RemoveAt(int index)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
    }

    /// <inheritdoc/>
    FlimFlam IJsonArray<FlimFlam>.RemoveRange(int index, int count)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, count));
    }

    /// <inheritdoc/>
    public FlimFlam Remove(in Corvus.Json.JsonNotAny oldValue)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
    }
    ...
    private static class __CorvusArrayHelpers
    {
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        public static ImmutableList<JsonAny> GetImmutableList(in FlimFlam arrayInstance)
        {
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in FlimFlam arrayInstance)
        {
        ...
        public static ImmutableList<JsonAny> GetImmutableListSetting(in FlimFlam arrayInstance, int index, in JsonAny value)
        {
            if ((arrayInstance.backing & Backing.JsonElement) != 0)
            {
                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        public static ImmutableList<JsonAny> GetImmutableListReplacing(in FlimFlam arrayInstance, in JsonAny oldItem, in JsonAny newItem)
        {
            if ((arrayInstance.backing & Backing.JsonElement) != 0)
            {
                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        public static ImmutableList<JsonAny> GetImmutableListWithout(in FlimFlam arrayInstance, in JsonAny item)
        {
            if ((arrayInstance.backing & Backing.JsonElement) != 0)
            {
                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
        public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in FlimFlam arrayInstance, int index, int count)
        {
            if ((arrayInstance.backing & Backing.JsonElement) != 0)
            {
                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
        ...
        // <exception cref = "InvalidOperationException">The value is not an array.</exception>
        // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
        public static ImmutableList<JsonAny> GetImmutableListWith(in FlimFlam arrayInstance, int index, in JsonAny value)
        {
            if ((arrayInstance.backing & Backing.JsonElement) != 0)
            {
                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
        public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in FlimFlam arrayInstance, int index, TEnumerable values)
