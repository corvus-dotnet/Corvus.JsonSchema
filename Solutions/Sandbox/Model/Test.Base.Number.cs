...
: IJsonNumber<Base>,
  IAdditionOperators<Base, Base, Base>,
  ISubtractionOperators<Base, Base, Base>,
  IMultiplyOperators<Base, Base, Base>,
  IDivisionOperators<Base, Base, Base>,
  IIncrementOperators<Base>,
  IDecrementOperators<Base>
#else
    : IJsonNumber<Base>
#endif
    {
        ...
        public Base(in BinaryJsonNumber value)
        {
        ...
        public Base(byte value) : this(new BinaryJsonNumber(value))
        {
        }
        ...
        public static implicit operator Base(JsonNumber value)
        {
        ...
        public static implicit operator byte (Base value)
        {
        ...
        public static explicit operator decimal (Base value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator double (Base value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator short (Base value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator int (Base value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator long (Base value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an Int64.</exception>
    public static explicit operator Int128(Base value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        public static explicit operator sbyte (Base value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
    ...
    public static explicit operator Half(Base value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        /// <exception cref = "InvalidOperationException">The value was not a number.</exception>
        /// <exception cref = "FormatException">The value was not formatted as a Single.</exception>
        public static explicit operator float (Base value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator ushort (Base value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator uint (Base value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator ulong (Base value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an UInt64.</exception>
    public static explicit operator UInt128(Base value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator Base(decimal value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator Base(double value)
        {
            return new(new BinaryJsonNumber(value));
        }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator Base(Half value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator Base(float value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator Base(byte value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator Base(short value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator Base(int value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator Base(long value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator Base(sbyte value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator Base(ushort value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator Base(uint value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator Base(ulong value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// <returns>The resulting value.</returns>
        public static Base operator ++(Base value)
        {
        ...
        public static int Compare(in Base lhs, in Base rhs)
        {
