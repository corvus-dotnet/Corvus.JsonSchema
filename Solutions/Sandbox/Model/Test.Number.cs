...
: IJsonNumber<Test>,
  IAdditionOperators<Test, Test, Test>,
  ISubtractionOperators<Test, Test, Test>,
  IMultiplyOperators<Test, Test, Test>,
  IDivisionOperators<Test, Test, Test>,
  IIncrementOperators<Test>,
  IDecrementOperators<Test>
#else
: IJsonNumber<Test>
#endif
{
    ...
    public Test(in BinaryJsonNumber value)
    {
    ...
    public Test(double value) : this(new BinaryJsonNumber(value))
    {
    }
    ...
    public static implicit operator Test(JsonNumber value)
    {
    ...
    public static implicit operator byte (Test value)
    {
    ...
    public static explicit operator decimal (Test value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator double (Test value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator short (Test value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator int (Test value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator long (Test value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an Int64.</exception>
    public static explicit operator Int128(Test value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator sbyte (Test value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator Half(Test value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <exception cref = "InvalidOperationException">The value was not a number.</exception>
    /// <exception cref = "FormatException">The value was not formatted as a Single.</exception>
    public static explicit operator float (Test value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator ushort (Test value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator uint (Test value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator ulong (Test value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an UInt64.</exception>
    public static explicit operator UInt128(Test value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// </summary>
    /// <param name = "value">The value to convert.</param>
    public static explicit operator Test(decimal value)
    {
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator Test(Half value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
    ...
    /// </summary>
    /// <param name = "value">The value to convert.</param>
    public static implicit operator Test(byte value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static int Compare(in Test lhs, in Test rhs)
    {
