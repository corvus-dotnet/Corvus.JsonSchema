...
public readonly partial struct Test
{
    ...
    public readonly partial struct PositiveInt32
    {
        ...
        /// </summary>
        public static string SchemaLocation { get; } = "test.json#/prefixItems/0";
        /// <summary>
        ...
        public static implicit operator PositiveInt32(in JsonAny value)
        {
        ...
        /// <param name = "value">The value from which to convert.</param>
        /// <exception cref = "InvalidOperationException">The value was not compatible with this type.</exception>
        public static implicit operator JsonAny(in PositiveInt32 value)
        {
            return value.AsAny;
        }
    ...
    /// <remarks>This will be PositiveInt32.Undefined if the type is not compatible.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    static PositiveInt32 IJsonValue<PositiveInt32>.FromObject<TValue>(in TValue value)
    {
...
#endif
        /// <summary>
        /// Parses a JSON string into a PositiveInt32.
        /// </summary>
        /// <param name = "json">The json string to parse.</param>
        /// <param name = "options">The (optional) JsonDocumentOptions.</param>
        /// <returns>A <see cref = "PositiveInt32"/> instance built from the JSON string.</returns>
        public static PositiveInt32 Parse(string json, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(json, options);
            return new PositiveInt32(jsonDocument.RootElement.Clone());
        }
        ...
        /// <param name = "options">The (optional) JsonDocumentOptions.</param>
        /// <returns>A <see cref = "PositiveInt32"/> instance built from the JSON string.</returns>
        public static PositiveInt32 Parse(Stream utf8Json, JsonDocumentOptions options = default)
        {
        ...
        /// <param name = "options">The (optional) JsonDocumentOptions.</param>
        /// <returns>A <see cref = "PositiveInt32"/> instance built from the JSON string.</returns>
        public static PositiveInt32 Parse(ReadOnlyMemory<byte> utf8Json, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(utf8Json, options);
            return new PositiveInt32(jsonDocument.RootElement.Clone());
        }
        ...
        /// <param name = "options">The (optional) JsonDocumentOptions.</param>
        /// <returns>A <see cref = "PositiveInt32"/> instance built from the JSON string.</returns>
        public static PositiveInt32 Parse(ReadOnlyMemory<char> json, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(json, options);
            return new PositiveInt32(jsonDocument.RootElement.Clone());
        }
        ...
        /// <param name = "options">The (optional) JsonDocumentOptions.</param>
        /// <returns>A <see cref = "PositiveInt32"/> instance built from the JSON string.</returns>
        public static PositiveInt32 Parse(ReadOnlySequence<byte> utf8Json, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(utf8Json, options);
            return new PositiveInt32(jsonDocument.RootElement.Clone());
        }
        ...
        static PositiveInt32 ParseValue(ReadOnlySpan<char> buffer)
        {
#if NET8_0_OR_GREATER
        return IJsonValue<PositiveInt32>.ParseValue(buffer);
#else
            return JsonValueHelpers.ParseValue<PositiveInt32>(buffer);
#endif
        }
        ...
        /// <param name = "buffer">The buffer from which to parse the value.</param>
        /// <returns>The parsed value.</returns>
        static PositiveInt32 ParseValue(ReadOnlySpan<byte> buffer)
        {
#if NET8_0_OR_GREATER
        return IJsonValue<PositiveInt32>.ParseValue(buffer);
#else
        ...
        /// <returns>The parsed value.</returns>
        static PositiveInt32 ParseValue(ref Utf8JsonReader reader)
        {
#if NET8_0_OR_GREATER
        return IJsonValue<PositiveInt32>.ParseValue(ref reader);
#else
            return JsonValueHelpers.ParseValue<PositiveInt32>(ref reader);
#endif
        }
