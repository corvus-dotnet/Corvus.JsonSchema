...
public readonly partial struct OtherNames : IJsonArray<OtherNames>
{
    ...
    /// Gets an empty array.
    /// </summary>
    public static readonly OtherNames EmptyArray = From(ImmutableList<JsonAny>.Empty);
    /// <summary>
    ...
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public OtherNames(IEnumerable<JsonAny> value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.Array;
        this.stringBacking = string.Empty;
    ...
    public static OtherNames FromItems(params JsonAny[] value)
    {
    ...
    /// <param name = "value">The value from which to construct the instance.</param>
    /// <returns>A OtherNames instantiated from the given items.</returns>
    public static OtherNames FromItems<TItem>(params TItem[] value)
    ...
    /// <returns>A OtherNames instantiated from the given items.</returns>
    public static OtherNames FromItems<TItem1>(in TItem1 value1)
    ...
    /// <returns>A OtherNames instantiated from the given items.</returns>
    public static OtherNames FromItems<TItem1, TItem2>(in TItem1 value1, in TItem2 value2)
    ...
    /// <returns>A OtherNames instantiated from the given items.</returns>
    public static OtherNames FromItems<TItem1, TItem2, TItem3>(in TItem1 value1, in TItem2 value2, in TItem3 value3)
    ...
    /// other overloads which avoid this serialization step.
    /// </remarks>
    public static OtherNames FromRange(IEnumerable<JsonAny> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
    ...
    /// other overloads which avoid this serialization step.
    /// </remarks>
    public static OtherNames FromRange<T>(IEnumerable<T> items)
    ...
    /// <param name = "value1">The first value from which to construct the instance.</param>
    /// <returns>A OtherNames instantiated from the given items.</returns>
    public static OtherNames FromItems(in JsonAny value1)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1);
        return new(builder.ToImmutable());
    ...
    /// <param name = "value2">The second value from which to construct the instance.</param>
    /// <returns>A OtherNames instantiated from the given items.</returns>
    public static OtherNames FromItems(in JsonAny value1, in JsonAny value2)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1);
        builder.Add(value2);
    ...
    /// <param name = "value3">The thirdvalue from which to construct the instance.</param>
    /// <returns>A OtherNames instantiated from the given items.</returns>
    public static OtherNames FromItems(in JsonAny value1, in JsonAny value2, in JsonAny value3)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1);
        builder.Add(value2);
