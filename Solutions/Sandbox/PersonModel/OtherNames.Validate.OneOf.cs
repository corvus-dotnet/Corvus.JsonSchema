...
public readonly partial struct OtherNames
{
    private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
    {
        ...
        int oneOfCount = 0;
        ValidationContext oneOfResult0 = this.As<Corvus.Json.Benchmarking.Models.PersonNameElement>().Validate(validationContext.CreateChildContext(), level);
        ...
        ValidationContext oneOfResult1 = this.As<Corvus.Json.Benchmarking.Models.PersonNameElementArray>().Validate(validationContext.CreateChildContext(), level);
