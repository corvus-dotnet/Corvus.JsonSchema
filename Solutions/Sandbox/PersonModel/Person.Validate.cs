            ...
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            foreach (JsonObjectProperty property in value.EnumerateObject())
            {
                ...
                else if (property.NameEquals(JsonPropertyNames.HeightUtf8, JsonPropertyNames.Height))
                {
                    ...
                    ValidationContext propertyResult = property.Value.As<Sandbox.Models.HeightRangeDouble>().Validate(result.CreateChildContext(), level);
                    if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                    {
                        return propertyResult;
                    }
                ...
                else if (property.NameEquals(JsonPropertyNames.NameUtf8, JsonPropertyNames.Name))
                {
                    ...
                    ValidationContext propertyResult = property.Value.As<Sandbox.Models.PersonName>().Validate(result.CreateChildContext(), level);
                    if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                    {
                        return propertyResult;
                    }
