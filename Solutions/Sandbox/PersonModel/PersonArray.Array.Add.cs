...
public readonly partial struct PersonArray
{
    ...
    public PersonArray Add(in Corvus.Json.Benchmarking.Models.Person item1)
    {
        ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
        builder.Add(item1);
        return new(builder.ToImmutable());
    ...
    /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
    public PersonArray Add(params Corvus.Json.Benchmarking.Models.Person[] items)
    {
        ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
        foreach (Corvus.Json.Benchmarking.Models.Person item in items)
        {
            builder.Add(item.AsAny);
        }
    ...
    /// <returns>An instance of the array with the items added.</returns>
    /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
    public PersonArray AddRange(IEnumerable<Corvus.Json.Benchmarking.Models.Person> items)
    {
        ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
        foreach (Corvus.Json.Benchmarking.Models.Person item in items)
        {
    ...
    /// <returns>An instance of the array with the item added.</returns>
    /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
    public PersonArray Insert(int index, in Corvus.Json.Benchmarking.Models.Person item1)
    {
        return new(this.GetImmutableListWith(index, item1));
    }
    ...
    public PersonArray InsertRange(int index, IEnumerable<Corvus.Json.Benchmarking.Models.Person> items)
    {
        return new(this.GetImmutableListWith(index, items.Select(item => item.AsAny)));
    }
    ...
    /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
    public PersonArray Replace(in Corvus.Json.Benchmarking.Models.Person oldValue, in Corvus.Json.Benchmarking.Models.Person newValue)
    {
        return new(this.GetImmutableListReplacing(oldValue.AsAny, newValue.AsAny));
    }
    ...
    public PersonArray SetItem(int index, in Corvus.Json.Benchmarking.Models.Person value)
    {
        return new(this.GetImmutableListSetting(index, value.AsAny));
    }
}