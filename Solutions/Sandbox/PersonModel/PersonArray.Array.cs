...
public readonly partial struct PersonArray
    : IJsonArray<Sandbox.Models.PersonArray>,
      IReadOnlyCollection<Sandbox.Models.Person>
{
    /// <summary>
    /// Gets an empty array.
    /// </summary>
    ...
    public Sandbox.Models.Person this[int index]
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Array) != 0)
            {
                try
                {
                    return this.arrayBacking[index].As<Sandbox.Models.Person>();
                }
                catch (ArgumentOutOfRangeException ex)
                {
                    throw new IndexOutOfRangeException(ex.Message, ex);
    ...
    public static PersonArray Create(ReadOnlySpan<Sandbox.Models.Person> items)
    {
        return new([..items]);
    }
    ...
    public static PersonArray FromItems(params Sandbox.Models.Person[] items)
    {
        return new([..items]);
    }
    ...
    public static PersonArray FromItems(in Sandbox.Models.Person item1)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static PersonArray FromItems(in Sandbox.Models.Person item1, in Sandbox.Models.Person item2)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static PersonArray FromItems(in Sandbox.Models.Person item1, in Sandbox.Models.Person item2, in Sandbox.Models.Person item3)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static PersonArray FromItems(in Sandbox.Models.Person item1, in Sandbox.Models.Person item2, in Sandbox.Models.Person item3, in Sandbox.Models.Person item4)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static PersonArray FromItems(in Sandbox.Models.Person item1, in Sandbox.Models.Person item2, in Sandbox.Models.Person item3, in Sandbox.Models.Person item4, in Sandbox.Models.Person item5)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static PersonArray FromItems(in Sandbox.Models.Person item1, in Sandbox.Models.Person item2, in Sandbox.Models.Person item3, in Sandbox.Models.Person item4, in Sandbox.Models.Person item5, in Sandbox.Models.Person item6)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static PersonArray FromItems(in Sandbox.Models.Person item1, in Sandbox.Models.Person item2, in Sandbox.Models.Person item3, in Sandbox.Models.Person item4, in Sandbox.Models.Person item5, in Sandbox.Models.Person item6, in Sandbox.Models.Person item7)
    {
    ...
    public static PersonArray FromRange(IEnumerable<Sandbox.Models.Person> items)
    {
        return new([..items]);
    }
    ...
    /// <inheritdoc/>
    IEnumerator<Sandbox.Models.Person> IEnumerable<Sandbox.Models.Person>.GetEnumerator() => this.EnumerateArray();

    /// <inheritdoc/>
    IEnumerator IEnumerable.GetEnumerator() => this.EnumerateArray();

    /// <inheritdoc/>
    int IReadOnlyCollection<Sandbox.Models.Person>.Count => this.GetArrayLength();
    ...
    /// <inheritdoc/>
    public JsonArrayEnumerator<Sandbox.Models.Person> EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <inheritdoc/>
    public PersonArray Add(in Sandbox.Models.Person item1)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    public PersonArray Add(params Sandbox.Models.Person[] items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        foreach (Sandbox.Models.Person item in items)
        {
            builder.Add(item.AsAny);
        }
    ...
    /// <inheritdoc/>
    public PersonArray AddRange(IEnumerable<Sandbox.Models.Person> items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        foreach (Sandbox.Models.Person item in items)
        {
    ...
    /// <inheritdoc/>
    public PersonArray Insert(int index, in Sandbox.Models.Person item1)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
    }

    /// <inheritdoc/>
    public PersonArray InsertRange(int index, IEnumerable<Sandbox.Models.Person> items)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
    }

    /// <inheritdoc/>
    public PersonArray Replace(in Sandbox.Models.Person oldValue, in Sandbox.Models.Person newValue)
    {
        return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
    }

    /// <inheritdoc/>
    public PersonArray SetItem(int index, in Sandbox.Models.Person value)
    {
        return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
    }
    ...
    /// <inheritdoc/>
    public PersonArray Remove(in Sandbox.Models.Person oldValue)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
    }
