...
public readonly partial struct PersonSchemaJson
{
    ...
    public readonly partial struct PersonName : IJsonObject<PersonName>
    {
        ...
        public PersonName(ImmutableDictionary<JsonPropertyName, JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator PersonName(ImmutableDictionary<JsonPropertyName, JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableDictionary<JsonPropertyName, JsonAny>(PersonName value)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static PersonName FromProperties(ImmutableDictionary<JsonPropertyName, JsonAny> source)
        {
            return new(source);
        }
