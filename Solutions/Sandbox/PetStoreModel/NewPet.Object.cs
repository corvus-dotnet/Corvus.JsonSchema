...
/// </summary>
public readonly partial struct NewPet : IJsonObject<NewPet>
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "NewPet"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public NewPet(ImmutableList<JsonObjectProperty> value)
    {
    ...
    public static implicit operator NewPet(JsonObject value)
    {
    ...
    public static NewPet FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static NewPet FromProperties(ImmutableList<JsonObjectProperty> source)
    {
        return new(source);
    }
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static NewPet FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
    ...
    /// <inheritdoc/>
    public NewPet SetProperty<TValue>(in JsonPropertyName name, TValue value)
    ...
    /// <inheritdoc/>
    public NewPet RemoveProperty(in JsonPropertyName name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public NewPet RemoveProperty(string name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public NewPet RemoveProperty(ReadOnlySpan<char> name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public NewPet RemoveProperty(ReadOnlySpan<byte> utf8Name)
    {
