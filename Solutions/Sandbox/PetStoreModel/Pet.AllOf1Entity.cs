...
public readonly partial struct Pet
{
    ...
    public readonly partial struct AllOf1Entity
    {
        ...
        public AllOf1Entity(in JsonElement value)
        {
        ...
        /// </summary>
        public static string SchemaLocation { get; } = "petstore.json#/components/schemas/Pet/allOf/1";
        /// <summary>
        ...
        public static implicit operator AllOf1Entity(in JsonAny value)
        {
        ...
        /// <param name = "value">The value from which to convert.</param>
        /// <exception cref = "InvalidOperationException">The value was not compatible with this type.</exception>
        public static implicit operator JsonAny(in AllOf1Entity value)
        {
            return value.AsAny;
        }
        ...
        public static AllOf1Entity FromAny(in JsonAny value)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllOf1Entity FromJson(in JsonElement value)
        {
            return new(value);
        }
    ...
    static AllOf1Entity IJsonValue<AllOf1Entity>.FromArray<TValue>(in TValue value)
    {
        ...
        /// <remarks>This will be AllOf1Entity.Undefined if the type is not compatible.</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllOf1Entity FromObject<TValue>(in TValue value)
        ...
        /// <returns>A <see cref = "AllOf1Entity"/> instance built from the JSON string.</returns>
        public static AllOf1Entity Parse(string json, JsonDocumentOptions options = default)
        {
        ...
        /// <param name = "options">The (optional) JsonDocumentOptions.</param>
        /// <returns>A <see cref = "AllOf1Entity"/> instance built from the JSON string.</returns>
        public static AllOf1Entity Parse(Stream utf8Json, JsonDocumentOptions options = default)
        {
        ...
        /// <param name = "options">The (optional) JsonDocumentOptions.</param>
        /// <returns>A <see cref = "AllOf1Entity"/> instance built from the JSON string.</returns>
        public static AllOf1Entity Parse(ReadOnlyMemory<byte> utf8Json, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(utf8Json, options);
            return new AllOf1Entity(jsonDocument.RootElement.Clone());
        }
        ...
        /// <param name = "options">The (optional) JsonDocumentOptions.</param>
        /// <returns>A <see cref = "AllOf1Entity"/> instance built from the JSON string.</returns>
        public static AllOf1Entity Parse(ReadOnlyMemory<char> json, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(json, options);
            return new AllOf1Entity(jsonDocument.RootElement.Clone());
        }
        ...
        /// <param name = "options">The (optional) JsonDocumentOptions.</param>
        /// <returns>A <see cref = "AllOf1Entity"/> instance built from the JSON string.</returns>
        public static AllOf1Entity Parse(ReadOnlySequence<byte> utf8Json, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(utf8Json, options);
            return new AllOf1Entity(jsonDocument.RootElement.Clone());
        }
