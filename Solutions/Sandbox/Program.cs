...
Console.WriteLine($"*0.3M == *0.3f is {lhs3["hello"].AsNumber == rhs3["hello"].AsNumber}");
Console.WriteLine($"*0.3f == *0.3M is {rhs3["hello"].AsNumber == lhs3["hello"].AsNumber}");
Console.WriteLine($"0.3M == 0.3f is {0.3M == (decimal)0.3f}");
Console.WriteLine($"0.3f == 0.3M is {(decimal)0.3f == 0.3M}");
