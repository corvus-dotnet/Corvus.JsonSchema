...
public readonly partial struct OtherNames
{
    ...
    public OtherNames Add<TItem1>(in TItem1 item1)
    ...
    /// <inheritdoc/>
    public OtherNames Add(in JsonAny item1, in JsonAny item2)
    {
        ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
        builder.Add(item1);
        builder.Add(item2);
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public OtherNames Add<TItem1, TItem2>(in TItem1 item1, in TItem2 item2)
    ...
    /// <inheritdoc/>
    public OtherNames Add<TItem>(params TItem[] items)
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public OtherNames Insert<TItem1>(int index, in TItem1 item1)
        where TItem1 : struct, IJsonValue<TItem1>
    {
    ...
    /// <inheritdoc/>
    public OtherNames Replace<TItem>(in TItem oldValue, in TItem newValue)
    ...
    /// <inheritdoc/>
    public OtherNames SetItem<TItem>(int index, in TItem value)
        where TItem : struct, IJsonValue
    {
