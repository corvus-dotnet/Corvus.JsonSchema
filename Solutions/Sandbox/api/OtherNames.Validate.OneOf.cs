...
public readonly partial struct OtherNames
{
    private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
    {
        ...
        int oneOfCount = 0;
        ValidationContext oneOfResult0 = this.As<JsonSchemaSample.Api.PersonNameElement>().Validate(validationContext.CreateChildContext(), level);
        ...
        ValidationContext oneOfResult1 = this.As<JsonSchemaSample.Api.PersonNameElementArray>().Validate(validationContext.CreateChildContext(), level);
