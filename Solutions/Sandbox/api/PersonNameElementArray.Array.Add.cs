...
public readonly partial struct PersonNameElementArray
{
    ...
    public PersonNameElementArray Add<TItem1>(in TItem1 item1)
    ...
    /// <inheritdoc/>
    public PersonNameElementArray Add(in JsonAny item1, in JsonAny item2)
    {
        ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
        builder.Add(item1);
        builder.Add(item2);
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public PersonNameElementArray Add<TItem1, TItem2>(in TItem1 item1, in TItem2 item2)
    ...
    /// <inheritdoc/>
    public PersonNameElementArray Add<TItem>(params TItem[] items)
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public PersonNameElementArray Insert<TItem1>(int index, in TItem1 item1)
        where TItem1 : struct, IJsonValue<TItem1>
    {
    ...
    /// <inheritdoc/>
    public PersonNameElementArray Replace<TItem>(in TItem oldValue, in TItem newValue)
    ...
    /// <inheritdoc/>
    public PersonNameElementArray SetItem<TItem>(int index, in TItem value)
        where TItem : struct, IJsonValue
    {
