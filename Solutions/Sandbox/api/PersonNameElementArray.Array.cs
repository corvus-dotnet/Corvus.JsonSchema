...
public readonly partial struct PersonNameElementArray
    : IJsonArray<JsonSchemaSample.Api.PersonNameElementArray>,
      IReadOnlyCollection<JsonSchemaSample.Api.PersonNameElement>
{
    /// <summary>
    /// Gets an empty array.
    /// </summary>
    ...
    public JsonSchemaSample.Api.PersonNameElement this[int index]
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Array) != 0)
            {
                try
                {
                    return this.arrayBacking[index].As<JsonSchemaSample.Api.PersonNameElement>();
                }
                catch (ArgumentOutOfRangeException ex)
                {
                    throw new IndexOutOfRangeException(ex.Message, ex);
    ...
    public static PersonNameElementArray Create(ReadOnlySpan<JsonSchemaSample.Api.PersonNameElement> items)    {
        return new([..items]);
    }
    ...
    public static PersonNameElementArray FromItems(params JsonSchemaSample.Api.PersonNameElement[] items)
    {
        return new([..items]);
    }
    ...
    public static PersonNameElementArray FromItems(in JsonSchemaSample.Api.PersonNameElement item1)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static PersonNameElementArray FromItems(in JsonSchemaSample.Api.PersonNameElement item1, in JsonSchemaSample.Api.PersonNameElement item2)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static PersonNameElementArray FromItems(in JsonSchemaSample.Api.PersonNameElement item1, in JsonSchemaSample.Api.PersonNameElement item2, in JsonSchemaSample.Api.PersonNameElement item3)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static PersonNameElementArray FromItems(in JsonSchemaSample.Api.PersonNameElement item1, in JsonSchemaSample.Api.PersonNameElement item2, in JsonSchemaSample.Api.PersonNameElement item3, in JsonSchemaSample.Api.PersonNameElement item4)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static PersonNameElementArray FromItems(in JsonSchemaSample.Api.PersonNameElement item1, in JsonSchemaSample.Api.PersonNameElement item2, in JsonSchemaSample.Api.PersonNameElement item3, in JsonSchemaSample.Api.PersonNameElement item4, in JsonSchemaSample.Api.PersonNameElement item5)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static PersonNameElementArray FromItems(in JsonSchemaSample.Api.PersonNameElement item1, in JsonSchemaSample.Api.PersonNameElement item2, in JsonSchemaSample.Api.PersonNameElement item3, in JsonSchemaSample.Api.PersonNameElement item4, in JsonSchemaSample.Api.PersonNameElement item5, in JsonSchemaSample.Api.PersonNameElement item6)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static PersonNameElementArray FromItems(in JsonSchemaSample.Api.PersonNameElement item1, in JsonSchemaSample.Api.PersonNameElement item2, in JsonSchemaSample.Api.PersonNameElement item3, in JsonSchemaSample.Api.PersonNameElement item4, in JsonSchemaSample.Api.PersonNameElement item5, in JsonSchemaSample.Api.PersonNameElement item6, in JsonSchemaSample.Api.PersonNameElement item7)
    {
    ...
    public static PersonNameElementArray FromRange(IEnumerable<JsonSchemaSample.Api.PersonNameElement> items)
    {
        return new([..items]);
    }
    ...
    /// <inheritdoc/>
    IEnumerator<JsonSchemaSample.Api.PersonNameElement> IEnumerable<JsonSchemaSample.Api.PersonNameElement>.GetEnumerator() => this.EnumerateArray();

    /// <inheritdoc/>
    IEnumerator IEnumerable.GetEnumerator() => this.EnumerateArray();

    /// <inheritdoc/>
    int IReadOnlyCollection<JsonSchemaSample.Api.PersonNameElement>.Count => this.GetArrayLength();
    ...
    /// <inheritdoc/>
    public JsonArrayEnumerator<JsonSchemaSample.Api.PersonNameElement> EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
            return new(this.jsonElementBacking);
    ...
    /// <inheritdoc/>
    public PersonNameElementArray Add(in JsonSchemaSample.Api.PersonNameElement item1)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    public PersonNameElementArray Add(params JsonSchemaSample.Api.PersonNameElement[] items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        foreach (JsonSchemaSample.Api.PersonNameElement item in items)
        {
            builder.Add(item.AsAny);
        }
    ...
    /// <inheritdoc/>
    public PersonNameElementArray AddRange(IEnumerable<JsonSchemaSample.Api.PersonNameElement> items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        foreach (JsonSchemaSample.Api.PersonNameElement item in items)
        {
    ...
    /// <inheritdoc/>
    public PersonNameElementArray Insert(int index, in JsonSchemaSample.Api.PersonNameElement item1)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
    }

    /// <inheritdoc/>
    public PersonNameElementArray InsertRange(int index, IEnumerable<JsonSchemaSample.Api.PersonNameElement> items)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
    }

    /// <inheritdoc/>
    public PersonNameElementArray Replace(in JsonSchemaSample.Api.PersonNameElement oldValue, in JsonSchemaSample.Api.PersonNameElement newValue)
    {
        return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
    }

    /// <inheritdoc/>
    public PersonNameElementArray SetItem(int index, in JsonSchemaSample.Api.PersonNameElement value)
    {
        return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
    }
    ...
    /// <inheritdoc/>
    public PersonNameElementArray Remove(in JsonSchemaSample.Api.PersonNameElement oldValue)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
    }
