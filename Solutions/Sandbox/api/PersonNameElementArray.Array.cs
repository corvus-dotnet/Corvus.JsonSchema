...
public readonly partial struct PersonNameElementArray : IJsonArray<PersonNameElementArray>
{
    ...
    /// Gets an empty array.
    /// </summary>
    public static readonly PersonNameElementArray EmptyArray = FromItems(ImmutableList<JsonAny>.Empty);
    /// <summary>
    ...
    public static PersonNameElementArray FromItems(ImmutableList<JsonAny> items)
    {
        return new(items);
    }
    ...
    public static PersonNameElementArray FromItems(in JsonSchemaSample.Api.PersonNameElement value1)
    {
    ...
    /// <returns>A PersonNameElementArray instantiated from the given items.</returns>
    public static PersonNameElementArray FromItems(in JsonSchemaSample.Api.PersonNameElement value1, in JsonSchemaSample.Api.PersonNameElement value2)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1.AsAny);
    ...
    /// <returns>A PersonNameElementArray instantiated from the given items.</returns>
    public static PersonNameElementArray FromItems(in JsonSchemaSample.Api.PersonNameElement value1, in JsonSchemaSample.Api.PersonNameElement value2, in JsonSchemaSample.Api.PersonNameElement value3)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1.AsAny);
        builder.Add(value2.AsAny);
    ...
    public static PersonNameElementArray FromItems(params JsonSchemaSample.Api.PersonNameElement[] value)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        foreach (JsonSchemaSample.Api.PersonNameElement item in value)
        {
    ...
    public JsonArrayEnumerator<JsonSchemaSample.Api.PersonNameElement> EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
            return new JsonArrayEnumerator<JsonSchemaSample.Api.PersonNameElement>(this.jsonElementBacking);
        }

        if ((this.backing & Backing.Array) != 0)
        {
            return new JsonArrayEnumerator<JsonSchemaSample.Api.PersonNameElement>(this.arrayBacking);
        }
