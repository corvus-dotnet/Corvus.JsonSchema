...
public readonly partial struct PersonNameElementArray
{
    ...
    public static implicit operator JsonAny(in PersonNameElementArray value)
    {
        return value.AsAny;
    }
    ...
    /// <returns>A <see cref = "PersonNameElementArray"/> instance built from the JSON string.</returns>
    public static PersonNameElementArray Parse(string json, JsonDocumentOptions options = default)
    {
    ...
    /// <param name = "options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref = "PersonNameElementArray"/> instance built from the JSON string.</returns>
    public static PersonNameElementArray Parse(Stream utf8Json, JsonDocumentOptions options = default)
    {
    ...
    /// <param name = "options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref = "PersonNameElementArray"/> instance built from the JSON string.</returns>
    public static PersonNameElementArray Parse(ReadOnlyMemory<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new PersonNameElementArray(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name = "options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref = "PersonNameElementArray"/> instance built from the JSON string.</returns>
    public static PersonNameElementArray Parse(ReadOnlyMemory<char> json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(json, options);
        return new PersonNameElementArray(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name = "options">The (optional) JsonDocumentOptions.</param>
    /// <returns>A <see cref = "PersonNameElementArray"/> instance built from the JSON string.</returns>
    public static PersonNameElementArray Parse(ReadOnlySequence<byte> utf8Json, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(utf8Json, options);
        return new PersonNameElementArray(jsonDocument.RootElement.Clone());
    }
