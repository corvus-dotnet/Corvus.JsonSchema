...

{
    ...
    /// </summary>
    public static string SchemaLocation { get; } = "https://endjin.com/58e06a5c-f38c-4336-8e58-0bee29418559/Schema";
        ...
        where T : struct, IJsonValue<T>
    {
        ...
        if (!other.As<Schema>().TryGetPeriod(out Period otherPeriod))
        {
            return false;
        }
