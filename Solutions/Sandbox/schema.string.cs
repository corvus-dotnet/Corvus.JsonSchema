...
public readonly partial struct Schema
    ...
    : IJsonString<FormatDraft201909Feature.DurationFormat.Schema>,
      ISpanFormattable
#else
    : IJsonString<FormatDraft201909Feature.DurationFormat.Schema>
#endif
{
    ...
    public Schema(Period value)
    {
        this.backing = Backing.String;
        this.jsonElementBacking = default;
        this.stringBacking = StandardDateFormat.FormatPeriod(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    public Schema(NodaTime.Period value)
    {
        this.backing = Backing.String;
        this.jsonElementBacking = default;
        this.stringBacking = StandardDateFormat.FormatPeriod(value);
    ...
    /// <summary>
    /// Conversion to <see cref="NodaTime.Period"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator NodaTime.Period(Schema value)
    {
        return
            (NodaTime.Period)value.GetPeriod();
    }

    /// <summary>
    /// Conversion from <see cref="NodaTime.Period"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator Schema(in NodaTime.Period value)
    {
        return new(value);
    }

    /// <summary>
    /// Conversion to <see cref="Period"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator Period(Schema value)
    {
        return
            value.GetPeriod();
    }
    ...
    /// <summary>
    /// Conversion from <see cref="Period"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator Schema(in Period value)
    {
        return new(value);
    }
    ...
    public static explicit operator string(Schema value)
    {
    ...
    /// <summary>
    /// Conversion from JsonDuration.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator Schema(JsonDuration value)
    {
        return value.As<Schema>();
    }

    /// <summary>
    /// Conversion to JsonDuration.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonDuration(Schema value)
    {
        return value.As<JsonDuration>();
    }

    /// <summary>
    /// Concatenate 2 JSON values, producing an instance of the string type Schema.
    /// </summary>
    ...
    public static Schema Concatenate<T1, T2>(Span<byte> buffer, in T1 value1, in T2 value2)
    ...
    /// <summary>
    /// Concatenate 3 JSON values, producing an instance of the string type Schema.
    /// </summary>
    /// <typeparam name="T1">The type of the 1st value.</typeparam>
    /// <typeparam name="T2">The type of the 2nd value.</typeparam>
    ...
    /// <returns>An instance of this string type.</returns>
    public static Schema Concatenate<T1, T2, T3>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3)
        where T1 : struct, IJsonValue<T1>
        where T2 : struct, IJsonValue<T2>
    ...
    /// <summary>
    /// Concatenate 4 JSON values, producing an instance of the string type Schema.
    /// </summary>
    /// <typeparam name="T1">The type of the 1st value.</typeparam>
    /// <typeparam name="T2">The type of the 2nd value.</typeparam>
    /// <typeparam name="T3">The type of the 3rd value.</typeparam>
    ...
    /// <returns>An instance of this string type.</returns>
    public static Schema Concatenate<T1, T2, T3, T4>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3, in T4 value4)
        where T1 : struct, IJsonValue<T1>
        where T2 : struct, IJsonValue<T2>
        where T3 : struct, IJsonValue<T3>
    ...
    /// <summary>
    /// Concatenate 5 JSON values, producing an instance of the string type Schema.
    /// </summary>
    /// <typeparam name="T1">The type of the 1st value.</typeparam>
    /// <typeparam name="T2">The type of the 2nd value.</typeparam>
    /// <typeparam name="T3">The type of the 3rd value.</typeparam>
    ...
    /// <returns>An instance of this string type.</returns>
    public static Schema Concatenate<T1, T2, T3, T4, T5>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3, in T4 value4, in T5 value5)
        where T1 : struct, IJsonValue<T1>
        where T2 : struct, IJsonValue<T2>
        where T3 : struct, IJsonValue<T3>
        where T4 : struct, IJsonValue<T4>
    ...
    /// <summary>
    /// Concatenate 6 JSON values, producing an instance of the string type Schema.
    /// </summary>
    /// <typeparam name="T1">The type of the 1st value.</typeparam>
    /// <typeparam name="T2">The type of the 2nd value.</typeparam>
    /// <typeparam name="T3">The type of the 3rd value.</typeparam>
    ...
    /// <returns>An instance of this string type.</returns>
    public static Schema Concatenate<T1, T2, T3, T4, T5, T6>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3, in T4 value4, in T5 value5, in T6 value6)
        where T1 : struct, IJsonValue<T1>
        where T2 : struct, IJsonValue<T2>
        where T3 : struct, IJsonValue<T3>
        where T4 : struct, IJsonValue<T4>
    ...
    /// <summary>
    /// Concatenate 7 JSON values, producing an instance of the string type Schema.
    /// </summary>
    /// <typeparam name="T1">The type of the 1st value.</typeparam>
    /// <typeparam name="T2">The type of the 2nd value.</typeparam>
    /// <typeparam name="T3">The type of the 3rd value.</typeparam>
    ...
    /// <returns>An instance of this string type.</returns>
    public static Schema Concatenate<T1, T2, T3, T4, T5, T6, T7>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3, in T4 value4, in T5 value5, in T6 value6, in T7 value7)
        where T1 : struct, IJsonValue<T1>
        where T2 : struct, IJsonValue<T2>
        where T3 : struct, IJsonValue<T3>
        where T4 : struct, IJsonValue<T4>
    ...
    /// <summary>
    /// Concatenate 8 JSON values, producing an instance of the string type Schema.
    /// </summary>
    /// <typeparam name="T1">The type of the 1st value.</typeparam>
    /// <typeparam name="T2">The type of the 2nd value.</typeparam>
    /// <typeparam name="T3">The type of the 3rd value.</typeparam>
    ...
    /// <returns>An instance of this string type.</returns>
    public static Schema Concatenate<T1, T2, T3, T4, T5, T6, T7, T8>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3, in T4 value4, in T5 value5, in T6 value6, in T7 value7, in T8 value8)
        where T1 : struct, IJsonValue<T1>
        where T2 : struct, IJsonValue<T2>
        where T3 : struct, IJsonValue<T3>
        where T4 : struct, IJsonValue<T4>
    ...
    public bool TryGetPeriod(out Period result)
    {
        ...
        if (this.jsonElementBacking.ValueKind == JsonValueKind.String)
        {
            if (this.jsonElementBacking.TryGetValue(static (ReadOnlySpan<char> text, in object? _, out PeriodBuilder builder) => Period.PeriodParser(text, out builder), default, out PeriodBuilder builder)) { result = builder.BuildPeriod(); return true; }
        }

        if ((this.backing & Backing.String) != 0)
        {
            if (Period.PeriodParser(this.stringBacking, out PeriodBuilder builder)) { result = builder.BuildPeriod(); return true; }
        }

#else
        if (this.jsonElementBacking.ValueKind == JsonValueKind.String)
        {
            if (this.jsonElementBacking.TryGetValue(static (ReadOnlySpan<char> text, in object? _, out Period period) => Period.TryParse(text, out period), default, out result)) { return true; }
        }

        if ((this.backing & Backing.String) != 0)
        {
            if (Period.TryParse(this.stringBacking.AsSpan(), out result)) { return true; }
        }
#endif
        result = Period.Zero;
        return false;
