...
V5.3.0 brings the OpenAPI and AsyncAPI generation work from the workflow-engine campaign back to the mainline. Generated clients gain a closure-free request-body overload, generated servers describe themselves from the specification, optional request bodies are finally optional, and the AsyncAPI transport surface gains a request/reply responder. Two changes are breaking, which is why this is a minor rather than a patch release.
