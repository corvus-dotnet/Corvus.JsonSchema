...
V5.2.1 fixes several validation defects — a runtime crash in evaluation tracking, a property-dispatch hash collision, detailed-results faults and corruption on complex schemas, and a struct-layout cycle in generated recursive discriminated unions — and lets you disable `format` assertion globally to produce annotation-only output.
