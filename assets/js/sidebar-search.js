...
(function () {
  ...
  async function ensureIndex() {
    ...
    try {
      ...
      var searchUrl = '/Corvus.JsonSchema/search-index.json';
      var loc = window.location.pathname;
      if (loc.indexOf('/Corvus.JsonSchema/api/v5/') === 0) searchUrl = '/Corvus.JsonSchema/api/v5/search-index.json';
      else if (loc.indexOf('/Corvus.JsonSchema/api/v4/') === 0) searchUrl = '/Corvus.JsonSchema/api/v4/search-index.json';
