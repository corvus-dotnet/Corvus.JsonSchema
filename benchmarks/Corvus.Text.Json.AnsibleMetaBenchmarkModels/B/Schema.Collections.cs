...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Collections
#if NET8_0_OR_GREATER
        : IJsonElement<Collections>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Collections"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Collections(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Collections DefaultInstance { get; }
        ...
        public Corvus.AnsibleMetaBenchmark.Baseline.Schema.Collections.CollectionsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.AnsibleMetaBenchmark.Baseline.Schema.Collections.CollectionsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.AnsibleMetaBenchmark.Baseline.Schema.Collections.CollectionsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.AnsibleMetaBenchmark.Baseline.Schema.Collections.CollectionsEntity>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in Collections left, in Collections right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Collections left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Collections instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Collections(JsonElement instance)
        {
            return Collections.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Collections From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Collections ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Collections>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Collections ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Collections>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Collections ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Collections>(json, options);
        }
        ...
        /// </exception>
        public static Collections ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Collections>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Collections? result)
        {
            return JsonElementHelpers.TryParseValue<Collections>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Collections(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Collections IJsonElement<Collections>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Collections: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Collections"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Collections"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Collections Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<Collections>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Collections"/> that lives for the lifetime of its
