    ...
    public readonly partial struct DebianPlatformModel
    {
        ...
        public readonly partial struct VersionsArray
        {
...
#endif
            {
                ...
                /// <param name="matchBookworm">Match 1st item.</param>
                /// <param name="matchBullseye">Match 2nd item.</param>
                /// <param name="matchBuster">Match 3rd item.</param>
                /// <param name="matchEtch">Match 4th item.</param>
                /// <param name="matchJessie">Match 5th item.</param>
                /// <param name="matchLenny">Match 6th item.</param>
                /// <param name="matchSid">Match 7th item.</param>
                /// <param name="matchSqueeze">Match 8th item.</param>
                /// <param name="matchStretch">Match 9th item.</param>
                /// <param name="matchWheezy">Match 10th item.</param>
                /// <param name="matchAll">Match 11th item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchBookworm,
                    Func<TContext, TResult> matchBullseye,
                    Func<TContext, TResult> matchBuster,
                    Func<TContext, TResult> matchEtch,
                    Func<TContext, TResult> matchJessie,
                    Func<TContext, TResult> matchLenny,
                    Func<TContext, TResult> matchSid,
                    Func<TContext, TResult> matchSqueeze,
                    Func<TContext, TResult> matchStretch,
                    Func<TContext, TResult> matchWheezy,
...
#endif
                {
                    ...
                    {
                        return matchBookworm(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchBullseye(context);
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchBuster(context);
                    }

                    if (this.ValueEquals(Constants.Enum4))
                    {
                        return matchEtch(context);
                    }
                    ...
                    {
                        return matchLenny(context);
                    }

                    if (this.ValueEquals(Constants.Enum7))
                    {
                        return matchSid(context);
                    }

                    if (this.ValueEquals(Constants.Enum8))
                    {
                        return matchSqueeze(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchBookworm,
                    Func<TResult> matchBullseye,
                    Func<TResult> matchBuster,
                    Func<TResult> matchEtch,
                    Func<TResult> matchJessie,
                    Func<TResult> matchLenny,
                    Func<TResult> matchSid,
                    Func<TResult> matchSqueeze,
                    Func<TResult> matchStretch,
                    Func<TResult> matchWheezy,
                    Func<TResult> matchAll,
                    Func<TResult> defaultMatch)
                {
                    if (this.ValueEquals(Constants.Enum1))
                    {
                        return matchBookworm();
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchBullseye();
                    }
