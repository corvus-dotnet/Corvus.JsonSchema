...
public readonly partial struct Schema
{
    ...
    public readonly partial struct DependencyModelArray
    {
...
#endif
        {
            ...
            public Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModel.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModel.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModel.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModel.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModel.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModel.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModel.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModel item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModel>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModel> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModel>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModel oldItem, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModel.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModel>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModel current = enumerator.Current;
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModelArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModelArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
