...
public readonly partial struct Schema
{
    ...
    public readonly partial struct DependencyModelArray
        ...
        : IJsonElement<DependencyModelArray>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DependencyModelArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal DependencyModelArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static DependencyModelArray DefaultInstance { get; }
        ...
        public Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModel this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModel>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModel> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModel>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in DependencyModelArray left, in DependencyModelArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in DependencyModelArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(DependencyModelArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DependencyModelArray(JsonElement instance)
        {
            return DependencyModelArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DependencyModelArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DependencyModelArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DependencyModelArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DependencyModelArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DependencyModelArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DependencyModelArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DependencyModelArray>(json, options);
        }
        ...
        /// </exception>
        public static DependencyModelArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<DependencyModelArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out DependencyModelArray? result)
        {
            return JsonElementHelpers.TryParseValue<DependencyModelArray>(ref reader, out result);
        }
...
#if NET
        static DependencyModelArray IJsonElement<DependencyModelArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DependencyModelArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public DependencyModelArray Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public DependencyModelArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<DependencyModelArray>(_idx);
            }
