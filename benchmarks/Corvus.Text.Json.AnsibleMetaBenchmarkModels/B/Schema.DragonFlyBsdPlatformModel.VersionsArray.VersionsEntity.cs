    ...
    public readonly partial struct DragonFlyBsdPlatformModel
    {
        ...
        public readonly partial struct VersionsArray
        {
...
#endif
            {
                ...
                /// <param name="match52">Match 1st item.</param>
                /// <param name="match54">Match 2nd item.</param>
                /// <param name="matchAll">Match 3rd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> match52,
                    Func<TContext, TResult> match54,
...
#endif
                {
                    ...
                    {
                        return match52(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return match54(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> match52,
                    Func<TResult> match54,
