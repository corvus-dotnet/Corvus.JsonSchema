    ...
    public readonly partial struct EosPlatformModel
    {
        ...
        public readonly partial struct VersionsArray
        {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.AnsibleMetaBenchmark.Baseline.Schema.EosPlatformModel.VersionsArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.AnsibleMetaBenchmark.Baseline.Schema.EosPlatformModel.VersionsArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
