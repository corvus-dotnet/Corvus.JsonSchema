        ...
        public readonly partial struct AllOf0Entity
        {
...
#endif
            {
                ...
                public bool TryGetAsWithStandaloneTrue(out Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.WithStandaloneTrue result)
                {
                    if (Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.WithStandaloneTrue.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.WithStandaloneTrue.Mutable.From(this);
                        return true;
                    }
                ...
                public bool TryGetAsRequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion(out Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion result)
                {
                    ...
                    {
                        result = Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
