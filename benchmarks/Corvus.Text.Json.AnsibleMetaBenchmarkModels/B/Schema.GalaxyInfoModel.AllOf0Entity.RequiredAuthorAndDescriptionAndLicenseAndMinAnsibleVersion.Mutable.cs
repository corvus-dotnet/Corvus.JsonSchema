...
public readonly partial struct Schema
{
    ...
    public readonly partial struct GalaxyInfoModel
    {
        ...
        public readonly partial struct AllOf0Entity
        {
            ...
            public readonly partial struct RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Text.Json.JsonElement.Mutable Author
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AuthorUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Text.Json.JsonElement.Mutable License
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LicenseUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                            {
                                return value;
                            }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    public void SetAuthor(in Corvus.Text.Json.JsonElement.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("author");
                        }
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetAuthor<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetLicense(in Corvus.Text.Json.JsonElement.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetLicense<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
#if NET9_0_OR_GREATER
                        where TContext : allows ref struct
#endif
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion"/>.
                    /// </summary>
                    internal static void Create(
                        ref ComplexValueBuilder builder,
                        in Corvus.Text.Json.JsonElement.Source author,
                        in Corvus.Text.Json.JsonElement.Source description,
                        in Corvus.Text.Json.JsonElement.Source license,
                    ...
                    public void Create(
                        ...
                        in Corvus.Text.Json.JsonElement.Source minAnsibleVersion)
                    {
                        Create(ref _builder, author, description, license, minAnsibleVersion);
                    }
                    ...
                    internal static void Create<TContext>(
                        in TContext context,
                        ref ComplexValueBuilder builder,
                        in Corvus.Text.Json.JsonElement.Source<TContext> author,
                        in Corvus.Text.Json.JsonElement.Source<TContext> description,
                        in Corvus.Text.Json.JsonElement.Source<TContext> license,
                    ...
                    #endif
                    {
                        Create(context, ref _builder, author, description, license, minAnsibleVersion);
                    }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source author, in Corvus.Text.Json.JsonElement.Source description, in Corvus.Text.Json.JsonElement.Source license, in Corvus.Text.Json.JsonElement.Source minAnsibleVersion, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(author, description, license, minAnsibleVersion);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> author, in Corvus.Text.Json.JsonElement.Source<TContext> description, in Corvus.Text.Json.JsonElement.Source<TContext> license, in Corvus.Text.Json.JsonElement.Source<TContext> minAnsibleVersion, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    ...
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(context, author, description, license, minAnsibleVersion);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion, Mutable>(this);
                }
            }
        }
    }
