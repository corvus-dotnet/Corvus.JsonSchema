...
public readonly partial struct Schema
{
    ...
    public readonly partial struct GalaxyInfoModel
    {
        ...
        public readonly partial struct AllOf0Entity
        {
            ...
            public readonly partial struct WithStandaloneTrue
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(WithStandaloneTrue instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="WithStandaloneTrue"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator WithStandaloneTrue(Mutable instance)
                    {
                    ...
                    /// </summary>
                    public Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.WithStandaloneTrue.StandaloneEntity.Mutable Standalone
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StandaloneUtf8, out Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.WithStandaloneTrue.StandaloneEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new WithStandaloneTrue(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    public void SetStandalone(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.WithStandaloneTrue.StandaloneEntity.Source value)
                    {
                        CheckValidInstance();
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"WithStandaloneTrue.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="WithStandaloneTrue"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="WithStandaloneTrue"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly WithStandaloneTrue Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<WithStandaloneTrue>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="WithStandaloneTrue"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly WithStandaloneTrue Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<WithStandaloneTrue>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.WithStandaloneTrue.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(WithStandaloneTrue instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.WithStandaloneTrue.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="WithStandaloneTrue"/>.
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.WithStandaloneTrue.StandaloneEntity.Source standalone = default)
                    {
                    ...
                    /// Creates an instance of a <see cref="WithStandaloneTrue"/>.
                    /// </summary>
                    public void Create(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.WithStandaloneTrue.StandaloneEntity.Source standalone = default)
                    {
                        Create(ref _builder, standalone);
                    }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.WithStandaloneTrue.StandaloneEntity.Source standalone = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(standalone);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<WithStandaloneTrue, Mutable>(this);
                }
            }
        }
    }
