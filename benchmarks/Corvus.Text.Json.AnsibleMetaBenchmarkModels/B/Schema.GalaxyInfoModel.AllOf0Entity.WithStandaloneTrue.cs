    ...
    public readonly partial struct GalaxyInfoModel
    {
        ...
        public readonly partial struct AllOf0Entity
        {
            ...
            public readonly partial struct WithStandaloneTrue
                ...
                : IJsonElement<WithStandaloneTrue>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="WithStandaloneTrue"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal WithStandaloneTrue(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static WithStandaloneTrue DefaultInstance { get; }
                ...
                /// </summary>
                public Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.WithStandaloneTrue.StandaloneEntity Standalone
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StandaloneUtf8, out Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.WithStandaloneTrue.StandaloneEntity value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in WithStandaloneTrue left, in WithStandaloneTrue right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in WithStandaloneTrue left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(WithStandaloneTrue instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WithStandaloneTrue(JsonElement instance)
                {
                    return WithStandaloneTrue.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WithStandaloneTrue From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WithStandaloneTrue ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<WithStandaloneTrue>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WithStandaloneTrue ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<WithStandaloneTrue>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WithStandaloneTrue ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<WithStandaloneTrue>(json, options);
                }
                ...
                /// </exception>
                public static WithStandaloneTrue ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<WithStandaloneTrue>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out WithStandaloneTrue? result)
                {
                    return JsonElementHelpers.TryParseValue<WithStandaloneTrue>(ref reader, out result);
                }
...
#if NET
                static WithStandaloneTrue IJsonElement<WithStandaloneTrue>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WithStandaloneTrue: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public WithStandaloneTrue Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public WithStandaloneTrue Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<WithStandaloneTrue>(_idx);
                    }
