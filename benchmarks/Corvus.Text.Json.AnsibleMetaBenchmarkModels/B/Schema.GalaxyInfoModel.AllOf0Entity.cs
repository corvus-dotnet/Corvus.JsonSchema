...
public readonly partial struct Schema
{
    ...
    public readonly partial struct GalaxyInfoModel
    {
...
#endif
        {
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.WithStandaloneTrue" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsWithStandaloneTrue(out Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.WithStandaloneTrue result)
            {
                if (Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.WithStandaloneTrue.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.WithStandaloneTrue.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsRequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion(out Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion result)
            {
                if (Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion.From(this);
                    return true;
                }
            ...
            /// <param name="matchCorvusAnsibleMetaBenchmarkBaselineSchemaGalaxyInfoModelAllOf0EntityRequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion">Match a <see cref="Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion, TContext, TResult> matchCorvusAnsibleMetaBenchmarkBaselineSchemaGalaxyInfoModelAllOf0EntityRequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion,
...
#endif
            {
                if (Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.WithStandaloneTrue.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchCorvusAnsibleMetaBenchmarkBaselineSchemaGalaxyInfoModelAllOf0EntityRequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion(Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion, TResult> matchCorvusAnsibleMetaBenchmarkBaselineSchemaGalaxyInfoModelAllOf0EntityRequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion,
                Matcher<AllOf0Entity, TResult> defaultMatch)
            {
                if (Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.WithStandaloneTrue.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchCorvusAnsibleMetaBenchmarkBaselineSchemaGalaxyInfoModelAllOf0EntityRequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion(Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf0Entity.RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion.From(this));
                }
