    ...
    public readonly partial struct GalaxyInfoModel
    {
        ...
        public readonly partial struct AllOf1Entity
        {
...
#endif
            {
                ...
                /// <param name="matchCorvusAnsibleMetaBenchmarkBaselineSchemaGalaxyInfoModelAllOf1EntityRequiredDescription">Match a <see cref="Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf1Entity.RequiredDescription"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf1Entity.RequiredDescription, TContext, TResult> matchCorvusAnsibleMetaBenchmarkBaselineSchemaGalaxyInfoModelAllOf1EntityRequiredDescription,
                    Matcher<AllOf1Entity, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    if (Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusAnsibleMetaBenchmarkBaselineSchemaGalaxyInfoModelAllOf1EntityRequiredDescription(Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf1Entity.RequiredDescription.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf1Entity.RequiredDescription, TResult> matchCorvusAnsibleMetaBenchmarkBaselineSchemaGalaxyInfoModelAllOf1EntityRequiredDescription,
                    Matcher<AllOf1Entity, TResult> defaultMatch)
                {
                    if (Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusAnsibleMetaBenchmarkBaselineSchemaGalaxyInfoModelAllOf1EntityRequiredDescription(Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf1Entity.RequiredDescription.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsWithStandaloneFalse(out Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse result)
                {
                    if (Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.Mutable.From(this);
                        return true;
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf1Entity.RequiredDescription" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsRequiredDescription(out Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf1Entity.RequiredDescription result)
                {
                    if (Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf1Entity.RequiredDescription.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf1Entity.RequiredDescription.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf1Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf1Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.JsonElement.Source description = default)
                {
                ...
                /// Creates an instance of a <see cref="AllOf1Entity"/>.
                /// </summary>
                public void Create(in Corvus.Text.Json.JsonElement.Source description = default)
                {
                    Create(ref _builder, description);
                }
                ...
                /// Creates an instance of a <see cref="AllOf1Entity"/>.
                /// </summary>
                public void Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> description = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                    Create(context, ref _builder, description);
                }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source description = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(description);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> description = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, description);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
