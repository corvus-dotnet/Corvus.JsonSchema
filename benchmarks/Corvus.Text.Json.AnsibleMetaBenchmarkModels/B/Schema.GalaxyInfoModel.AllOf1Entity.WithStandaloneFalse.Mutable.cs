        ...
        public readonly partial struct AllOf1Entity
        {
            ...
            public readonly partial struct WithStandaloneFalse
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(WithStandaloneFalse instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="WithStandaloneFalse"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator WithStandaloneFalse(Mutable instance)
                    {
                    ...
                    /// </summary>
                    public Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.StandaloneEntity.Mutable Standalone
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StandaloneUtf8, out Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.StandaloneEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetStandalone(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.StandaloneEntity.Source value)
                    {
                        CheckValidInstance();
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"WithStandaloneFalse.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly WithStandaloneFalse Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly WithStandaloneFalse Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<WithStandaloneFalse>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(WithStandaloneFalse instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="WithStandaloneFalse"/>.
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.StandaloneEntity.Source standalone = default)
                    {
                    ...
                    /// Creates an instance of a <see cref="WithStandaloneFalse"/>.
                    /// </summary>
                    public void Create(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.StandaloneEntity.Source standalone = default)
                    {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.StandaloneEntity.Source standalone = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                {
                    return workspace.CreateBuilder<WithStandaloneFalse, Mutable>(this);
                }
            }
        }
    }
