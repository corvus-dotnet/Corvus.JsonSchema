...
public readonly partial struct Schema
{
    ...
    public readonly partial struct GalaxyInfoModel
    {
        ...
        public readonly partial struct VideoLinksArray
#if NET8_0_OR_GREATER
            : IJsonElement<VideoLinksArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="VideoLinksArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal VideoLinksArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static VideoLinksArray DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in VideoLinksArray left, in VideoLinksArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in VideoLinksArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(VideoLinksArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator VideoLinksArray(JsonElement instance)
            {
                return VideoLinksArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static VideoLinksArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static VideoLinksArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<VideoLinksArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static VideoLinksArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<VideoLinksArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static VideoLinksArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<VideoLinksArray>(json, options);
            }
            ...
            /// </exception>
            public static VideoLinksArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<VideoLinksArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out VideoLinksArray? result)
            {
                return JsonElementHelpers.TryParseValue<VideoLinksArray>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new VideoLinksArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static VideoLinksArray IJsonElement<VideoLinksArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"VideoLinksArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="VideoLinksArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="VideoLinksArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public VideoLinksArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<VideoLinksArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="VideoLinksArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public VideoLinksArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<VideoLinksArray>(_idx);
                }
