...
public readonly partial struct Schema
{
    ...
    public readonly partial struct GenericBsdPlatformModel
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(GenericBsdPlatformModel instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="GenericBsdPlatformModel"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator GenericBsdPlatformModel(Mutable instance)
            {
            ...
            /// Name
            /// </summary>
            public Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericBsdPlatformModel.Name.Mutable NameValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameValueUtf8, out Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericBsdPlatformModel.Name.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericBsdPlatformModel.VersionsArray.Mutable Versions
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionsUtf8, out Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericBsdPlatformModel.VersionsArray.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new GenericBsdPlatformModel(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetNameValue(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericBsdPlatformModel.Name.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetVersions(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericBsdPlatformModel.VersionsArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetVersions<TContext>(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericBsdPlatformModel.VersionsArray.Source<TContext> value)
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"GenericBsdPlatformModel.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="GenericBsdPlatformModel"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="GenericBsdPlatformModel"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly GenericBsdPlatformModel Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<GenericBsdPlatformModel>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="GenericBsdPlatformModel"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly GenericBsdPlatformModel Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<GenericBsdPlatformModel>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericBsdPlatformModel.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(GenericBsdPlatformModel instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericBsdPlatformModel.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="GenericBsdPlatformModel"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericBsdPlatformModel.Name.Source name = default,
                in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericBsdPlatformModel.VersionsArray.Source versions = default)
            {
            ...
            /// Creates an instance of a <see cref="GenericBsdPlatformModel"/>.
            /// </summary>
            public void Create(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericBsdPlatformModel.Name.Source name = default, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericBsdPlatformModel.VersionsArray.Source versions = default)
            {
            ...
            internal static void Create<TContext>(
                ...
                ref ComplexValueBuilder builder,
                in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericBsdPlatformModel.Name.Source name = default,
                in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericBsdPlatformModel.VersionsArray.Source<TContext> versions = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericBsdPlatformModel.Name.Source name = default, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericBsdPlatformModel.VersionsArray.Source versions = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericBsdPlatformModel.Name.Source name = default, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericBsdPlatformModel.VersionsArray.Source<TContext> versions = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        {
            return workspace.CreateBuilder<GenericBsdPlatformModel, Mutable>(this);
        }
    }
}
