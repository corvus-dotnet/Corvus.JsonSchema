...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GenericBsdPlatformModel"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal GenericBsdPlatformModel(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static GenericBsdPlatformModel DefaultInstance { get; }
        ...
        /// Name
        /// </summary>
        public Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericBsdPlatformModel.Name NameValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameValueUtf8, out Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericBsdPlatformModel.Name value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericBsdPlatformModel.VersionsArray Versions
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionsUtf8, out Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericBsdPlatformModel.VersionsArray value))
                {
                    return value;
                }

                return Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericBsdPlatformModel.VersionsArray.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in GenericBsdPlatformModel left, in GenericBsdPlatformModel right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in GenericBsdPlatformModel left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(GenericBsdPlatformModel instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GenericBsdPlatformModel(JsonElement instance)
        {
            return GenericBsdPlatformModel.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GenericBsdPlatformModel From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GenericBsdPlatformModel ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GenericBsdPlatformModel>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GenericBsdPlatformModel ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GenericBsdPlatformModel>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GenericBsdPlatformModel ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GenericBsdPlatformModel>(json, options);
        }
        ...
        /// </exception>
        public static GenericBsdPlatformModel ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<GenericBsdPlatformModel>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out GenericBsdPlatformModel? result)
        {
            return JsonElementHelpers.TryParseValue<GenericBsdPlatformModel>(ref reader, out result);
        }
...
#if NET
        static GenericBsdPlatformModel IJsonElement<GenericBsdPlatformModel>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GenericBsdPlatformModel: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public GenericBsdPlatformModel Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public GenericBsdPlatformModel Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<GenericBsdPlatformModel>(_idx);
            }
