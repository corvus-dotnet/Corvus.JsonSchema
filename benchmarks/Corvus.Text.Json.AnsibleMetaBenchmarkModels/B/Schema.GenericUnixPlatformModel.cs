...
public readonly partial struct Schema
{
    ...
    public readonly partial struct GenericUnixPlatformModel
        ...
        : IJsonElement<GenericUnixPlatformModel>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GenericUnixPlatformModel"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal GenericUnixPlatformModel(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static GenericUnixPlatformModel DefaultInstance { get; }
        ...
        /// Name
        /// </summary>
        public Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericUnixPlatformModel.Name NameValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameValueUtf8, out Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericUnixPlatformModel.Name value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericUnixPlatformModel.VersionsArray Versions
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionsUtf8, out Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericUnixPlatformModel.VersionsArray value))
                {
                    return value;
                }

                return Corvus.AnsibleMetaBenchmark.Baseline.Schema.GenericUnixPlatformModel.VersionsArray.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in GenericUnixPlatformModel left, in GenericUnixPlatformModel right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in GenericUnixPlatformModel left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(GenericUnixPlatformModel instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GenericUnixPlatformModel(JsonElement instance)
        {
            return GenericUnixPlatformModel.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GenericUnixPlatformModel From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GenericUnixPlatformModel ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GenericUnixPlatformModel>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GenericUnixPlatformModel ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GenericUnixPlatformModel>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GenericUnixPlatformModel ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GenericUnixPlatformModel>(json, options);
        }
        ...
        /// </exception>
        public static GenericUnixPlatformModel ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<GenericUnixPlatformModel>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out GenericUnixPlatformModel? result)
        {
            return JsonElementHelpers.TryParseValue<GenericUnixPlatformModel>(ref reader, out result);
        }
...
#if NET
        static GenericUnixPlatformModel IJsonElement<GenericUnixPlatformModel>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GenericUnixPlatformModel: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public GenericUnixPlatformModel Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public GenericUnixPlatformModel Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<GenericUnixPlatformModel>(_idx);
            }
