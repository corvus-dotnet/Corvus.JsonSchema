...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// Name
        /// </summary>
        public Corvus.AnsibleMetaBenchmark.Baseline.Schema.JunosPlatformModel.Name NameValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameValueUtf8, out Corvus.AnsibleMetaBenchmark.Baseline.Schema.JunosPlatformModel.Name value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.AnsibleMetaBenchmark.Baseline.Schema.JunosPlatformModel.VersionsArray Versions
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionsUtf8, out Corvus.AnsibleMetaBenchmark.Baseline.Schema.JunosPlatformModel.VersionsArray value))
                {
                    return value;
                }

                return Corvus.AnsibleMetaBenchmark.Baseline.Schema.JunosPlatformModel.VersionsArray.DefaultInstance;
            }
        }
