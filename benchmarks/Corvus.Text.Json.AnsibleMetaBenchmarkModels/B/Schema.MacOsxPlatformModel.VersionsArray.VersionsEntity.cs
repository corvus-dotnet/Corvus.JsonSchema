    ...
    public readonly partial struct MacOsxPlatformModel
    {
        ...
        public readonly partial struct VersionsArray
        {
...
#endif
            {
                ...
                /// <param name="match1010">Match 1st item.</param>
                /// <param name="match1011">Match 2nd item.</param>
                /// <param name="match1012">Match 3rd item.</param>
                /// <param name="match1013">Match 4th item.</param>
                /// <param name="match1014">Match 5th item.</param>
                /// <param name="match1015">Match 6th item.</param>
                /// <param name="match107">Match 7th item.</param>
                /// <param name="match108">Match 8th item.</param>
                /// <param name="match109">Match 9th item.</param>
                /// <param name="matchAll">Match 10th item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> match1010,
                    Func<TContext, TResult> match1011,
                    Func<TContext, TResult> match1012,
                    Func<TContext, TResult> match1013,
                    Func<TContext, TResult> match1014,
                    Func<TContext, TResult> match1015,
                    Func<TContext, TResult> match107,
                    Func<TContext, TResult> match108,
                    Func<TContext, TResult> match109,
                ...
                public TResult Match<TResult>(
                    Func<TResult> match1010,
                    Func<TResult> match1011,
                    Func<TResult> match1012,
                    Func<TResult> match1013,
                    Func<TResult> match1014,
                    Func<TResult> match1015,
                    Func<TResult> match107,
                    Func<TResult> match108,
                    Func<TResult> match109,
