...
public readonly partial struct Schema
{
    ...
    public readonly partial struct MageiaPlatformModel
    {
...
#endif
        {
            ...
            /// Name
            /// </summary>
            public Corvus.AnsibleMetaBenchmark.Baseline.Schema.MageiaPlatformModel.Name.Mutable NameValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameValueUtf8, out Corvus.AnsibleMetaBenchmark.Baseline.Schema.MageiaPlatformModel.Name.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.AnsibleMetaBenchmark.Baseline.Schema.MageiaPlatformModel.VersionsArray.Mutable Versions
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionsUtf8, out Corvus.AnsibleMetaBenchmark.Baseline.Schema.MageiaPlatformModel.VersionsArray.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetNameValue(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.MageiaPlatformModel.Name.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetVersions(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.MageiaPlatformModel.VersionsArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetVersions<TContext>(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.MageiaPlatformModel.VersionsArray.Source<TContext> value)
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.AnsibleMetaBenchmark.Baseline.Schema.MageiaPlatformModel.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.AnsibleMetaBenchmark.Baseline.Schema.MageiaPlatformModel.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.AnsibleMetaBenchmark.Baseline.Schema.MageiaPlatformModel.Name.Source name = default,
                in Corvus.AnsibleMetaBenchmark.Baseline.Schema.MageiaPlatformModel.VersionsArray.Source versions = default)
            {
            ...
            /// Creates an instance of a <see cref="MageiaPlatformModel"/>.
            /// </summary>
            public void Create(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.MageiaPlatformModel.Name.Source name = default, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.MageiaPlatformModel.VersionsArray.Source versions = default)
            {
            ...
            internal static void Create<TContext>(
                ...
                ref ComplexValueBuilder builder,
                in Corvus.AnsibleMetaBenchmark.Baseline.Schema.MageiaPlatformModel.Name.Source name = default,
                in Corvus.AnsibleMetaBenchmark.Baseline.Schema.MageiaPlatformModel.VersionsArray.Source<TContext> versions = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.MageiaPlatformModel.Name.Source name = default, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.MageiaPlatformModel.VersionsArray.Source versions = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.MageiaPlatformModel.Name.Source name = default, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.MageiaPlatformModel.VersionsArray.Source<TContext> versions = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
