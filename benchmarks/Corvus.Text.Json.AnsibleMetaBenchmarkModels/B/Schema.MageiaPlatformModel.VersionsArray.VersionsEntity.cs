    ...
    public readonly partial struct MageiaPlatformModel
    {
        ...
        public readonly partial struct VersionsArray
        {
...
#endif
            {
                ...
                /// <param name="matchSeven">Match 1st item.</param>
                /// <param name="matchEight">Match 2nd item.</param>
                /// <param name="matchAll">Match 3rd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchSeven,
                    Func<TContext, TResult> matchEight,
...
#endif
                {
                    ...
                    {
                        return matchSeven(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchEight(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchSeven,
                    Func<TResult> matchEight,
