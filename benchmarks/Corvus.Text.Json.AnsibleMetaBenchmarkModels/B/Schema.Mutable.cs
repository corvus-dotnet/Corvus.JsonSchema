...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.Text.Json.JsonElementForBooleanFalseSchema.Mutable AdditionalProperties
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AdditionalPropertiesUtf8, out Corvus.Text.Json.JsonElementForBooleanFalseSchema.Mutable value))
                {
                    return value;
                }
        ...
        /// Allow Duplicates
        /// </summary>
        public Corvus.AnsibleMetaBenchmark.Baseline.JsonBoolean.Mutable AllowDuplicates
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AllowDuplicatesUtf8, out Corvus.AnsibleMetaBenchmark.Baseline.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.AnsibleMetaBenchmark.Baseline.Schema.Collections.Mutable CollectionsValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CollectionsValueUtf8, out Corvus.AnsibleMetaBenchmark.Baseline.Schema.Collections.Mutable value))
                {
                    return value;
                }
        ...
        /// Dependencies
        /// </summary>
        public Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModelArray.Mutable Dependencies
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DependenciesUtf8, out Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModelArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.Mutable GalaxyInfo
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GalaxyInfoUtf8, out Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.Mutable value))
                {
                    return value;
                }
        ...
        public void SetAllowDuplicates(in Corvus.AnsibleMetaBenchmark.Baseline.JsonBoolean.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AllowDuplicatesUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AllowDuplicatesUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
        ...
        /// <summary>
        /// Remove the <c>allow_duplicates</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveAllowDuplicates()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AllowDuplicatesUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetCollectionsValue(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.Collections.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CollectionsValueUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CollectionsValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetCollectionsValue<TContext>(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.Collections.Source<TContext> value)
        ...
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveCollectionsValue()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CollectionsValueUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetDependencies(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModelArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetDependencies<TContext>(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModelArray.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetGalaxyInfo(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.GalaxyInfoUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GalaxyInfoUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetGalaxyInfo<TContext>(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
        ...
        /// <summary>
        /// Remove the <c>galaxy_info</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveGalaxyInfo()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.GalaxyInfoUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.AnsibleMetaBenchmark.Baseline.Schema.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.AnsibleMetaBenchmark.Baseline.Schema.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.AnsibleMetaBenchmark.Baseline.JsonBoolean.Source allowDuplicates = default,
            in Corvus.AnsibleMetaBenchmark.Baseline.Schema.Collections.Source collections = default,
            in Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModelArray.Source dependencies = default,
            in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.Source galaxyInfo = default)
        {
        ...
        public void Create(
            ...
            in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.Source galaxyInfo = default)
        {
            Create(ref _builder, allowDuplicates, collections, dependencies, galaxyInfo);
        }
        ...
        internal static void Create<TContext>(
            ...
            ref ComplexValueBuilder builder,
            in Corvus.AnsibleMetaBenchmark.Baseline.JsonBoolean.Source allowDuplicates = default,
            in Corvus.AnsibleMetaBenchmark.Baseline.Schema.Collections.Source<TContext> collections = default,
            in Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModelArray.Source<TContext> dependencies = default,
            in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.Source<TContext> galaxyInfo = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        #endif
        {
            Create(context, ref _builder, allowDuplicates, collections, dependencies, galaxyInfo);
        }
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="allowDuplicates">The value of the property.</param>
    /// <param name="collections">The value of the property.</param>
    /// <param name="dependencies">The value of the property.</param>
    /// <param name="galaxyInfo">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.AnsibleMetaBenchmark.Baseline.JsonBoolean.Source allowDuplicates = default, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.Collections.Source collections = default, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModelArray.Source dependencies = default, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.Source galaxyInfo = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(allowDuplicates, collections, dependencies, galaxyInfo);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.AnsibleMetaBenchmark.Baseline.JsonBoolean.Source allowDuplicates = default, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.Collections.Source<TContext> collections = default, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModelArray.Source<TContext> dependencies = default, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.Source<TContext> galaxyInfo = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, allowDuplicates, collections, dependencies, galaxyInfo);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
