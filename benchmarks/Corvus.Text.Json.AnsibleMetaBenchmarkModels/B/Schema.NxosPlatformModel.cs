...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NxosPlatformModel"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal NxosPlatformModel(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static NxosPlatformModel DefaultInstance { get; }
        ...
        /// Name
        /// </summary>
        public Corvus.AnsibleMetaBenchmark.Baseline.Schema.NxosPlatformModel.Name NameValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameValueUtf8, out Corvus.AnsibleMetaBenchmark.Baseline.Schema.NxosPlatformModel.Name value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.AnsibleMetaBenchmark.Baseline.Schema.NxosPlatformModel.VersionsArray Versions
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionsUtf8, out Corvus.AnsibleMetaBenchmark.Baseline.Schema.NxosPlatformModel.VersionsArray value))
                {
                    return value;
                }

                return Corvus.AnsibleMetaBenchmark.Baseline.Schema.NxosPlatformModel.VersionsArray.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in NxosPlatformModel left, in NxosPlatformModel right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in NxosPlatformModel left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(NxosPlatformModel instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NxosPlatformModel(JsonElement instance)
        {
            return NxosPlatformModel.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NxosPlatformModel From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NxosPlatformModel ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<NxosPlatformModel>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NxosPlatformModel ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<NxosPlatformModel>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NxosPlatformModel ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<NxosPlatformModel>(json, options);
        }
        ...
        /// </exception>
        public static NxosPlatformModel ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<NxosPlatformModel>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out NxosPlatformModel? result)
        {
            return JsonElementHelpers.TryParseValue<NxosPlatformModel>(ref reader, out result);
        }
...
#if NET
        static NxosPlatformModel IJsonElement<NxosPlatformModel>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NxosPlatformModel: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public NxosPlatformModel Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public NxosPlatformModel Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<NxosPlatformModel>(_idx);
            }
