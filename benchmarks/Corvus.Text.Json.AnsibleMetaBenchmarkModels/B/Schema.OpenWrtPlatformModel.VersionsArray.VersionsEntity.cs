    ...
    public readonly partial struct OpenWrtPlatformModel
    {
        ...
        public readonly partial struct VersionsArray
        {
...
#endif
            {
                ...
                /// <param name="match1701">Match 1st item.</param>
                /// <param name="match1806">Match 2nd item.</param>
                /// <param name="match1907">Match 3rd item.</param>
                /// <param name="match2102">Match 4th item.</param>
                /// <param name="match2203">Match 5th item.</param>
                /// <param name="matchAll">Match 6th item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> match1701,
                    Func<TContext, TResult> match1806,
                    Func<TContext, TResult> match1907,
                    Func<TContext, TResult> match2102,
                    Func<TContext, TResult> match2203,
                ...
                public TResult Match<TResult>(
                    Func<TResult> match1701,
                    Func<TResult> match1806,
                    Func<TResult> match1907,
                    Func<TResult> match2102,
                    Func<TResult> match2203,
