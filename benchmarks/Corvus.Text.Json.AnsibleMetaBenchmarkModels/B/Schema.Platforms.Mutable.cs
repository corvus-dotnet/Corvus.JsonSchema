...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Platforms
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Platforms instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Platforms"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Platforms(Mutable instance)
            {
            ...
            public Corvus.AnsibleMetaBenchmark.Baseline.Schema.Platforms.PlatformsEntity.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.AnsibleMetaBenchmark.Baseline.Schema.Platforms.PlatformsEntity.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.AnsibleMetaBenchmark.Baseline.Schema.Platforms.PlatformsEntity.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.AnsibleMetaBenchmark.Baseline.Schema.Platforms.PlatformsEntity.Mutable>(_parent, _idx);
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Platforms.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.Platforms.PlatformsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.Platforms.PlatformsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.Platforms.PlatformsEntity.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.Platforms.PlatformsEntity item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.AnsibleMetaBenchmark.Baseline.Schema.Platforms.PlatformsEntity>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.AnsibleMetaBenchmark.Baseline.Schema.Platforms.PlatformsEntity> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.AnsibleMetaBenchmark.Baseline.Schema.Platforms.PlatformsEntity>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.Platforms.PlatformsEntity oldItem, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.Platforms.PlatformsEntity.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.AnsibleMetaBenchmark.Baseline.Schema.Platforms.PlatformsEntity>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.AnsibleMetaBenchmark.Baseline.Schema.Platforms.PlatformsEntity current = enumerator.Current;
            ...
            /// </para>
            /// </remarks>
            public readonly Platforms Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly Platforms Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Platforms>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.AnsibleMetaBenchmark.Baseline.Schema.Platforms.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(Platforms instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.AnsibleMetaBenchmark.Baseline.Schema.Platforms.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<Platforms, Mutable>(this);
        }
    }
}
