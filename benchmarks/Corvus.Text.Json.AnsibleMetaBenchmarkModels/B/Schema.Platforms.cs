...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public Corvus.AnsibleMetaBenchmark.Baseline.Schema.Platforms.PlatformsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.AnsibleMetaBenchmark.Baseline.Schema.Platforms.PlatformsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.AnsibleMetaBenchmark.Baseline.Schema.Platforms.PlatformsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.AnsibleMetaBenchmark.Baseline.Schema.Platforms.PlatformsEntity>(_parent, _idx);
        }
