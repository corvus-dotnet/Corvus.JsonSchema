        ...
        public readonly partial struct VersionsArray
        {
            ...
            public readonly partial struct VersionsEntity
            {
...
#endif
                {
                    ...
                    /// <param name="match10Sp3">Match 1st item.</param>
                    /// <param name="match10Sp4">Match 2nd item.</param>
                    /// <param name="match11">Match 3rd item.</param>
                    /// <param name="match11Sp1">Match 4th item.</param>
                    /// <param name="match11Sp2">Match 5th item.</param>
                    /// <param name="match11Sp3">Match 6th item.</param>
                    /// <param name="match11Sp4">Match 7th item.</param>
                    /// <param name="match12">Match 8th item.</param>
                    /// <param name="match12Sp1">Match 9th item.</param>
                    /// <param name="match12Sp2">Match 10th item.</param>
                    /// <param name="match12Sp3">Match 11th item.</param>
                    /// <param name="match12Sp4">Match 12th item.</param>
                    /// <param name="match12Sp5">Match 13th item.</param>
                    /// <param name="match15">Match 14th item.</param>
                    /// <param name="match15Sp1">Match 15th item.</param>
                    /// <param name="match15Sp2">Match 16th item.</param>
                    /// <param name="match15Sp3">Match 17th item.</param>
                    /// <param name="match15Sp4">Match 18th item.</param>
                    /// <param name="match15Sp5">Match 19th item.</param>
                    /// <param name="matchAll">Match 20th item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> match10Sp3,
                        Func<TContext, TResult> match10Sp4,
                        Func<TContext, TResult> match11,
                        Func<TContext, TResult> match11Sp1,
                        Func<TContext, TResult> match11Sp2,
                        Func<TContext, TResult> match11Sp3,
                        Func<TContext, TResult> match11Sp4,
                        Func<TContext, TResult> match12,
                        Func<TContext, TResult> match12Sp1,
                        Func<TContext, TResult> match12Sp2,
                        Func<TContext, TResult> match12Sp3,
                        Func<TContext, TResult> match12Sp4,
                        Func<TContext, TResult> match12Sp5,
                        Func<TContext, TResult> match15,
                        Func<TContext, TResult> match15Sp1,
                        Func<TContext, TResult> match15Sp2,
                        Func<TContext, TResult> match15Sp3,
                        Func<TContext, TResult> match15Sp4,
                        Func<TContext, TResult> match15Sp5,
...
#endif
                    {
                        ...
                        {
                            return match10Sp3(context);
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return match10Sp4(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> match10Sp3,
                        Func<TResult> match10Sp4,
                        Func<TResult> match11,
                        Func<TResult> match11Sp1,
                        Func<TResult> match11Sp2,
                        Func<TResult> match11Sp3,
                        Func<TResult> match11Sp4,
                        Func<TResult> match12,
                        Func<TResult> match12Sp1,
                        Func<TResult> match12Sp2,
                        Func<TResult> match12Sp3,
                        Func<TResult> match12Sp4,
                        Func<TResult> match12Sp5,
                        Func<TResult> match15,
                        Func<TResult> match15Sp1,
                        Func<TResult> match15Sp2,
                        Func<TResult> match15Sp3,
                        Func<TResult> match15Sp4,
                        Func<TResult> match15Sp5,
