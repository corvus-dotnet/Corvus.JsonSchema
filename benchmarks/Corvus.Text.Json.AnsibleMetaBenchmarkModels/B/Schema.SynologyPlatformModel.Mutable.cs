...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SynologyPlatformModel
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(SynologyPlatformModel instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SynologyPlatformModel"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SynologyPlatformModel(Mutable instance)
            {
            ...
            /// Name
            /// </summary>
            public Corvus.AnsibleMetaBenchmark.Baseline.Schema.SynologyPlatformModel.Name.Mutable NameValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameValueUtf8, out Corvus.AnsibleMetaBenchmark.Baseline.Schema.SynologyPlatformModel.Name.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.AnsibleMetaBenchmark.Baseline.Schema.SynologyPlatformModel.VersionsArray.Mutable Versions
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionsUtf8, out Corvus.AnsibleMetaBenchmark.Baseline.Schema.SynologyPlatformModel.VersionsArray.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetNameValue(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.SynologyPlatformModel.Name.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetVersions(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.SynologyPlatformModel.VersionsArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetVersions<TContext>(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.SynologyPlatformModel.VersionsArray.Source<TContext> value)
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SynologyPlatformModel.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly SynologyPlatformModel Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly SynologyPlatformModel Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SynologyPlatformModel>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.AnsibleMetaBenchmark.Baseline.Schema.SynologyPlatformModel.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(SynologyPlatformModel instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.AnsibleMetaBenchmark.Baseline.Schema.SynologyPlatformModel.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="SynologyPlatformModel"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.AnsibleMetaBenchmark.Baseline.Schema.SynologyPlatformModel.Name.Source name = default,
                in Corvus.AnsibleMetaBenchmark.Baseline.Schema.SynologyPlatformModel.VersionsArray.Source versions = default)
            {
            ...
            /// Creates an instance of a <see cref="SynologyPlatformModel"/>.
            /// </summary>
            public void Create(in Corvus.AnsibleMetaBenchmark.Baseline.Schema.SynologyPlatformModel.Name.Source name = default, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.SynologyPlatformModel.VersionsArray.Source versions = default)
            {
            ...
            internal static void Create<TContext>(
                ...
                ref ComplexValueBuilder builder,
                in Corvus.AnsibleMetaBenchmark.Baseline.Schema.SynologyPlatformModel.Name.Source name = default,
                in Corvus.AnsibleMetaBenchmark.Baseline.Schema.SynologyPlatformModel.VersionsArray.Source<TContext> versions = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.SynologyPlatformModel.Name.Source name = default, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.SynologyPlatformModel.VersionsArray.Source versions = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.SynologyPlatformModel.Name.Source name = default, in Corvus.AnsibleMetaBenchmark.Baseline.Schema.SynologyPlatformModel.VersionsArray.Source<TContext> versions = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        {
            return workspace.CreateBuilder<SynologyPlatformModel, Mutable>(this);
        }
    }
}
