    ...
    public readonly partial struct VCenterPlatformModel
    {
        ...
        public readonly partial struct VersionsArray
        {
...
#endif
            {
                ...
                /// <param name="match55">Match 1st item.</param>
                /// <param name="match60">Match 2nd item.</param>
                /// <param name="match65">Match 3rd item.</param>
                /// <param name="match67">Match 4th item.</param>
                /// <param name="match70">Match 5th item.</param>
                /// <param name="matchAll">Match 6th item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> match55,
