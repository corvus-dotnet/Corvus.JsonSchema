        ...
        public readonly partial struct VersionsArray
        {
            ...
            public readonly partial struct VersionsEntity
            {
...
#endif
                {
                    ...
                    /// <param name="match2008R2">Match 1st item.</param>
                    /// <param name="match2008x64">Match 2nd item.</param>
                    /// <param name="match2008x86">Match 3rd item.</param>
                    /// <param name="match2012">Match 4th item.</param>
                    /// <param name="match2012R2">Match 5th item.</param>
                    /// <param name="match2016">Match 6th item.</param>
                    /// <param name="match2019">Match 7th item.</param>
                    ...
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> match2008R2,
                        Func<TContext, TResult> match2008x64,
                        Func<TContext, TResult> match2008x86,
                        Func<TContext, TResult> match2012,
                        Func<TContext, TResult> match2012R2,
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> match2008R2,
                        Func<TResult> match2008x64,
                        Func<TResult> match2008x86,
                        Func<TResult> match2012,
                        Func<TResult> match2012R2,
