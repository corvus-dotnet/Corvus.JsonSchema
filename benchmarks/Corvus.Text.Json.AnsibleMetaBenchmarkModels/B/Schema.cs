...
#endif
{
    ...
    /// Allow Duplicates
    /// </summary>
    public Corvus.AnsibleMetaBenchmark.Baseline.JsonBoolean AllowDuplicates
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AllowDuplicatesUtf8, out Corvus.AnsibleMetaBenchmark.Baseline.JsonBoolean value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.AnsibleMetaBenchmark.Baseline.Schema.Collections CollectionsValue
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CollectionsValueUtf8, out Corvus.AnsibleMetaBenchmark.Baseline.Schema.Collections value))
            {
                return value;
            }
    ...
    /// Dependencies
    /// </summary>
    public Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModelArray Dependencies
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DependenciesUtf8, out Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModelArray value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel GalaxyInfo
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GalaxyInfoUtf8, out Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel value))
            {
                return value;
            }
