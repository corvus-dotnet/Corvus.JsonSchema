...
public readonly partial struct AnsibleMetaSchema
{
    ...
    public readonly partial struct AmazonPlatformModel
    {
...
#endif
        {
            ...
            public void SetNameValue(in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.AmazonPlatformModel.Name.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetVersions(in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.AmazonPlatformModel.VersionsArray.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.AmazonPlatformModel.Name.Source arg1, in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.AmazonPlatformModel.VersionsArray.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.AmazonPlatformModel.Name.Source arg1, in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.AmazonPlatformModel.VersionsArray.Source<TContext> arg2)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
        ...
        public ref struct Builder
        {
            ...
            internal static void BuildCreateValue(in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.AmazonPlatformModel.Name.Source arg1, in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.AmazonPlatformModel.VersionsArray.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.AmazonPlatformModel.Name.Source name = default, in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.AmazonPlatformModel.VersionsArray.Source versions = default)
        {
        ...
        /// <param name="versions">The value of the <c>"versions"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.AmazonPlatformModel.Name.Source name = default, in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.AmazonPlatformModel.VersionsArray.Source<TContext> versions = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
