        ...
        public readonly partial struct VersionsArray
        {
            ...
            public readonly partial struct VersionsEntity
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly VersionsEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly VersionsEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<VersionsEntity>(_idx);
                    }
                    ...
                    /// <param name="match201303">Match 1st item.</param>
                    /// <param name="match201309">Match 2nd item.</param>
                    /// <param name="match201403">Match 3rd item.</param>
                    /// <param name="match201409">Match 4th item.</param>
                    /// <param name="match201503">Match 5th item.</param>
                    /// <param name="match201509">Match 6th item.</param>
                    /// <param name="match201603">Match 7th item.</param>
                    /// <param name="match201609">Match 8th item.</param>
                    /// <param name="match201703">Match 9th item.</param>
                    /// <param name="match201709">Match 10th item.</param>
                    /// <param name="match201712">Match 11th item.</param>
                    /// <param name="match201803">Match 12th item.</param>
                    /// <param name="matchCandidate">Match 13th item.</param>
                    /// <param name="matchAll">Match 14th item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> match201303,
                        Func<TContext, TResult> match201309,
                        Func<TContext, TResult> match201403,
                        Func<TContext, TResult> match201409,
                        Func<TContext, TResult> match201503,
                        Func<TContext, TResult> match201509,
                        Func<TContext, TResult> match201603,
                        Func<TContext, TResult> match201609,
                        Func<TContext, TResult> match201703,
                        Func<TContext, TResult> match201709,
                        Func<TContext, TResult> match201712,
                        Func<TContext, TResult> match201803,
                        Func<TContext, TResult> matchCandidate,
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> match201303,
                        Func<TResult> match201309,
                        Func<TResult> match201403,
                        Func<TResult> match201409,
                        Func<TResult> match201503,
                        Func<TResult> match201509,
                        Func<TResult> match201603,
                        Func<TResult> match201609,
                        Func<TResult> match201703,
                        Func<TResult> match201709,
                        Func<TResult> match201712,
                        Func<TResult> match201803,
                        Func<TResult> matchCandidate,
                ...
                public static ParsedJsonDocument<VersionsEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<VersionsEntity>();
                    }
                    finally
                    {
