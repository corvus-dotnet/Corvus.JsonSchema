...
public readonly partial struct AnsibleMetaSchema
{
    ...
    public readonly partial struct Collections
    {
...
#endif
        {
            ...
            public Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.CollectionsEntity.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.CollectionsEntity.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.CollectionsEntity.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.CollectionsEntity.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.CollectionsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, scoped in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.CollectionsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(scoped in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.CollectionsEntity.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.CollectionsEntity item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.CollectionsEntity>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.CollectionsEntity> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.CollectionsEntity>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.CollectionsEntity oldItem, in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.CollectionsEntity.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.CollectionsEntity>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.CollectionsEntity current = enumerator.Current;
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            public void AddItem(in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.CollectionsEntity.Source value)
            {
        ...
        public static ParsedJsonDocument<Collections> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Collections>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Collections> Create<TContext>(
