...
public readonly partial struct AnsibleMetaSchema
{
...
#endif
    {
        ...
        public Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.CollectionsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.CollectionsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.CollectionsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.CollectionsEntity>(_parent, _idx);
        }
