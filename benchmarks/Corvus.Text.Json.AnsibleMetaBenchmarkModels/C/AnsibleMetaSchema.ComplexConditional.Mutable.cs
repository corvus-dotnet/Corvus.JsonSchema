...
public readonly partial struct AnsibleMetaSchema
{
    ...
    public readonly partial struct ComplexConditional
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.JsonStringArray.Mutable(Mutable value)
            {
                return Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.JsonStringArray.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.JsonStringArray.Mutable value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                ...
                {
                    return matchJsonBoolean(Corvus.AnsibleMetaBenchmark.Current.JsonBoolean.Mutable.From(this), context);
                }

                if (Corvus.AnsibleMetaBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonString(Corvus.AnsibleMetaBenchmark.Current.JsonString.Mutable.From(this), context);
                }
                ...
                {
                    return matchJsonStringArray(Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.JsonStringArray.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.Mutable, TResult> defaultMatch)
            {
                if (Corvus.AnsibleMetaBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonBoolean(Corvus.AnsibleMetaBenchmark.Current.JsonBoolean.Mutable.From(this));
                }

                if (Corvus.AnsibleMetaBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonString(Corvus.AnsibleMetaBenchmark.Current.JsonString.Mutable.From(this));
                }

                if (Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.JsonStringArray.Mutable.From(this));
                }
            ...
            public bool TryGetAsJsonBoolean(out Corvus.AnsibleMetaBenchmark.Current.JsonBoolean.Mutable result)
            {
                if (Corvus.AnsibleMetaBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.AnsibleMetaBenchmark.Current.JsonBoolean.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsJsonString(out Corvus.AnsibleMetaBenchmark.Current.JsonString.Mutable result)
            {
                if (Corvus.AnsibleMetaBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.AnsibleMetaBenchmark.Current.JsonString.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsJsonStringArray(out Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.JsonStringArray.Mutable result)
            {
                if (Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.JsonStringArray.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.AnsibleMetaBenchmark.Current.JsonBoolean instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.AnsibleMetaBenchmark.Current.JsonString instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public static ParsedJsonDocument<ComplexConditional> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ComplexConditional>();
            }
            finally
            {
