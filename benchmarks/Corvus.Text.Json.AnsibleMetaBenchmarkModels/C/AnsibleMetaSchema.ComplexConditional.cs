...
public readonly partial struct AnsibleMetaSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ComplexConditional"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ComplexConditional(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ComplexConditional DefaultInstance { get; }
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.JsonStringArray"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.JsonStringArray(ComplexConditional value)
        {
            return Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.JsonStringArray.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.JsonStringArray"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ComplexConditional(Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.JsonStringArray value)
        {
            return From(value);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator bool(ComplexConditional value)
        {
        ...
        /// </returns>
        public static bool operator ==(in ComplexConditional left, in ComplexConditional right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ComplexConditional left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ComplexConditional instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ComplexConditional(JsonElement instance)
        {
            return ComplexConditional.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ComplexConditional From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ComplexConditional ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ComplexConditional>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ComplexConditional ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ComplexConditional>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ComplexConditional ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ComplexConditional>(json, options);
        }
        ...
        /// </exception>
        public static ComplexConditional ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ComplexConditional>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ComplexConditional? result)
        {
            return JsonElementHelpers.TryParseValue<ComplexConditional>(ref reader, out result);
        }
...
#if NET
        static ComplexConditional IJsonElement<ComplexConditional>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ComplexConditional: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public ComplexConditional Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public ComplexConditional Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ComplexConditional>(_idx);
            }
        ...
        public bool TryGetAsJsonBoolean(out Corvus.AnsibleMetaBenchmark.Current.JsonBoolean result)
        {
            ...
            {
                result = Corvus.AnsibleMetaBenchmark.Current.JsonBoolean.From(this);
                return true;
            }
        ...
        public bool TryGetAsJsonString(out Corvus.AnsibleMetaBenchmark.Current.JsonString result)
        {
            ...
            {
                result = Corvus.AnsibleMetaBenchmark.Current.JsonString.From(this);
                return true;
            }
        ...
        public bool TryGetAsJsonStringArray(out Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.JsonStringArray result)
        {
            ...
            {
                result = Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.JsonStringArray.From(this);
                return true;
            }
        ...
        /// <param name="matchJsonBoolean">Match a <see cref="Corvus.AnsibleMetaBenchmark.Current.JsonBoolean"/>.</param>
        /// <param name="matchJsonString">Match a <see cref="Corvus.AnsibleMetaBenchmark.Current.JsonString"/>.</param>
        /// <param name="matchJsonStringArray">Match a <see cref="Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.JsonStringArray"/>.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Matcher<Corvus.AnsibleMetaBenchmark.Current.JsonBoolean, TContext, TResult> matchJsonBoolean,
            Matcher<Corvus.AnsibleMetaBenchmark.Current.JsonString, TContext, TResult> matchJsonString,
            Matcher<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.JsonStringArray, TContext, TResult> matchJsonStringArray,
            Matcher<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.AnsibleMetaBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonBoolean(Corvus.AnsibleMetaBenchmark.Current.JsonBoolean.From(this), context);
            }

            if (Corvus.AnsibleMetaBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonString(Corvus.AnsibleMetaBenchmark.Current.JsonString.From(this), context);
            }

            if (Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonStringArray(Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.JsonStringArray.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            Matcher<Corvus.AnsibleMetaBenchmark.Current.JsonBoolean, TResult> matchJsonBoolean,
            Matcher<Corvus.AnsibleMetaBenchmark.Current.JsonString, TResult> matchJsonString,
            Matcher<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.JsonStringArray, TResult> matchJsonStringArray,
            Matcher<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional, TResult> defaultMatch)
        {
            if (Corvus.AnsibleMetaBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonBoolean(Corvus.AnsibleMetaBenchmark.Current.JsonBoolean.From(this));
            }

            if (Corvus.AnsibleMetaBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonString(Corvus.AnsibleMetaBenchmark.Current.JsonString.From(this));
            }

            if (Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonStringArray(Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.ComplexConditional.JsonStringArray.From(this));
            }
