    ...
    public readonly partial struct DellOsPlatformModel
    {
        ...
        public readonly partial struct VersionsArray
        {
...
#endif
            {
                ...
                /// <param name="match10">Match 1st item.</param>
                /// <param name="matchSix">Match 2nd item.</param>
                /// <param name="matchNine">Match 3rd item.</param>
                /// <param name="matchAll">Match 4th item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> match10,
                    Func<TContext, TResult> matchSix,
                    Func<TContext, TResult> matchNine,
                ...
                public TResult Match<TResult>(
                    Func<TResult> match10,
                    Func<TResult> matchSix,
                    Func<TResult> matchNine,
