...
public readonly partial struct AnsibleMetaSchema
{
    ...
    public readonly partial struct DependencyModel
    {
        ...
        public readonly partial struct RequiredRole
            : IJsonElement<RequiredRole>
        {
            public static partial class JsonSchema
            {
                ...
                private const uint RequiredBitForRole = 0b00000000000000000000000000000001;
                ...
                [NotNullWhen(true)]
#endif
                out Corvus.AnsibleMetaBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1? matcher)
                {
                    if (span.SequenceEqual(JsonPropertyNames.RoleUtf8))
                    {
                        matcher = MatchRole;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://raw.githubusercontent.com/ansible/ansible-lint/main/src/ansiblelint/schemas/meta.json#/definitions/DependencyModel/anyOf/0"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "https://raw.githubusercontent.com/ansible/ansible-lint/main/src/ansiblelint/schemas/meta.json#/definitions/DependencyModel/anyOf/0";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://raw.githubusercontent.com/ansible/ansible-lint/main/src/ansiblelint/schemas/meta.json#/definitions/DependencyModel/anyOf/0"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.StartObject)
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyRolePresent, "role"u8, "required"u8);
                        }
                        ...
                        else
                        {
                            ...
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyRoleNotPresent, "role"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyRolePresent, "role"u8, "required"u8);
