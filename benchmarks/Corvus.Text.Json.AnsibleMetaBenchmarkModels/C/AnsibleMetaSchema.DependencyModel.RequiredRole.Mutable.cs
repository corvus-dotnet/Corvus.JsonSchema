    ...
    public readonly partial struct DependencyModel
    {
        ...
        public readonly partial struct RequiredRole
        {
...
#endif
            {
                ...
                public void SetRole(in Corvus.Text.Json.JsonElement.Source value)
                {
                    CheckValidInstance();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Text.Json.JsonElement.Source role)
            {
            ...
            /// <param name="role">The value of the <c>"role"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> role)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
