    ...
    public readonly partial struct DependencyModel
    {
            ...
            : IJsonElement<RequiredSrc>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchSrc(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/DependencyModel/anyOf/1"u8, buffer, out written);
