    ...
    public readonly partial struct DependencyModel
    {
        ...
        public readonly partial struct RequiredSrc
        {
...
#endif
            {
                ...
                public void SetSrc(in Corvus.Text.Json.JsonElement.Source value)
                {
                    CheckValidInstance();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Text.Json.JsonElement.Source src)
            {
            ...
            /// <param name="src">The value of the <c>"src"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> src)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
