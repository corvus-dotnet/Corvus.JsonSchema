...
public readonly partial struct AnsibleMetaSchema
{
    ...
    public readonly partial struct DependencyModel
    {
        ...
        public readonly partial struct Scm
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Scm instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Scm"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Scm(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Scm(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Scm.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Scm"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Scm"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly Scm Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Scm>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Scm"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly Scm Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Scm>(_idx);
                }
                ...
                /// <param name="matchHg">Match 1st item.</param>
                /// <param name="matchGit">Match 2nd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchHg,
                    Func<TContext, TResult> matchGit,
...
#endif
                {
                    ...
                    {
                        return matchHg(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchGit(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchHg,
                    Func<TResult> matchGit,
                ...
                public bool TryGetKnownValue(out KnownValues result)
                {
                    if (this.ValueEquals(Constants.Enum1))
                    {
                        result = KnownValues.Hg;
                        return true;
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        result = KnownValues.Git;
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Scm instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (Scm)value;
            ...
            {
                return workspace.CreateBuilder<Scm, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<Scm> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Scm>();
                }
                finally
                {
