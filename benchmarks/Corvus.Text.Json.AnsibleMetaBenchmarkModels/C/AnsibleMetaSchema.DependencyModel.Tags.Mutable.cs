    ...
    public readonly partial struct DependencyModel
    {
        ...
        public readonly partial struct Tags
        {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModel.Tags.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModel.Tags.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public static ParsedJsonDocument<Tags> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Tags>();
                }
                finally
                {
