...
public readonly partial struct AnsibleMetaSchema
{
    ...
    public readonly partial struct DependencyModel
    {
        ...
        public readonly partial struct Vars
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Vars instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Vars"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Vars(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Vars(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Vars.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Vars"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Vars"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly Vars Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Vars>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Vars"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly Vars Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Vars>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModel.Vars.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(Vars instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModel.Vars.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<Vars, Mutable>(this);
            }
        }
    }
}
