...
public readonly partial struct AnsibleMetaSchema
{
    ...
    public readonly partial struct DependencyModel
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="Vars"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal Vars(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Vars DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in Vars left, in Vars right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Vars left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(Vars instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Vars(JsonElement instance)
            {
                return Vars.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vars From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vars ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Vars>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vars ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Vars>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vars ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Vars>(json, options);
            }
            ...
            /// </exception>
            public static Vars ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Vars>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Vars? result)
            {
                return JsonElementHelpers.TryParseValue<Vars>(ref reader, out result);
            }
...
#if NET
            static Vars IJsonElement<Vars>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Vars: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public Vars Freeze()
            {
                ...
                {
                    return mutable.FreezeElement<Vars>(_idx);
                }
