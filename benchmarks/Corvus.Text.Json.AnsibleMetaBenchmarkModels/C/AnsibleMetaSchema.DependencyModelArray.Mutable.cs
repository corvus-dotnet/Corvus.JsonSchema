...
public readonly partial struct AnsibleMetaSchema
{
    ...
    public readonly partial struct DependencyModelArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DependencyModelArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DependencyModelArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DependencyModelArray(Mutable instance)
            {
            ...
            public Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModel.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModel.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModel.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModel.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DependencyModelArray(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DependencyModelArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModel.Source value)
            {
                CheckValidInstance();
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModel item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModel>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModel> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModel>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModel oldItem, in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModel.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModel>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModel current = enumerator.Current;
            ...
            /// <summary>
            /// Gets a <see cref="DependencyModelArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DependencyModelArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly DependencyModelArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DependencyModelArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DependencyModelArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly DependencyModelArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DependencyModelArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModelArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(DependencyModelArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModelArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// Add an item to the array.
            /// </summary>
            public void AddItem<TContext>(in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModel.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        {
            return workspace.CreateBuilder<DependencyModelArray, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<DependencyModelArray> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DependencyModelArray>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<DependencyModelArray> Create<TContext>(
