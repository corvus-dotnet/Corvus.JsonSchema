    ...
    public readonly partial struct DevuanPlatformModel
    {
        ...
        public readonly partial struct VersionsArray
        {
...
#endif
            {
                ...
                /// <param name="matchAscii">Match 1st item.</param>
                /// <param name="matchBeowulf">Match 2nd item.</param>
                /// <param name="matchCeres">Match 3rd item.</param>
                /// <param name="matchJessie">Match 4th item.</param>
                /// <param name="matchAll">Match 5th item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchAscii,
                    Func<TContext, TResult> matchBeowulf,
                    Func<TContext, TResult> matchCeres,
                    Func<TContext, TResult> matchJessie,
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchAscii,
                    Func<TResult> matchBeowulf,
                    Func<TResult> matchCeres,
                    Func<TResult> matchJessie,
