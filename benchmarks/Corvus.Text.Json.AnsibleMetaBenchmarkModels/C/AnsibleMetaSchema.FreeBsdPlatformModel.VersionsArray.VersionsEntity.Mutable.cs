        ...
        public readonly partial struct VersionsArray
        {
            ...
            public readonly partial struct VersionsEntity
            {
...
#endif
                {
                    ...
                    /// <param name="match101">Match 2nd item.</param>
                    /// <param name="match102">Match 3rd item.</param>
                    /// <param name="match103">Match 4th item.</param>
                    /// <param name="match104">Match 5th item.</param>
                    /// <param name="match110">Match 6th item.</param>
                    /// <param name="match111">Match 7th item.</param>
                    /// <param name="match112">Match 8th item.</param>
                    /// <param name="match113">Match 9th item.</param>
                    /// <param name="match114">Match 10th item.</param>
                    /// <param name="match120">Match 11th item.</param>
                    /// <param name="match121">Match 12th item.</param>
                    /// <param name="match122">Match 13th item.</param>
                    /// <param name="match130">Match 14th item.</param>
                    /// <param name="match131">Match 15th item.</param>
                    /// <param name="match132">Match 16th item.</param>
                    /// <param name="match140">Match 17th item.</param>
                    /// <param name="match80">Match 18th item.</param>
                    /// <param name="match81">Match 19th item.</param>
                    /// <param name="match82">Match 20th item.</param>
                    /// <param name="match83">Match 21st item.</param>
                    /// <param name="match84">Match 22nd item.</param>
                    /// <param name="match90">Match 23rd item.</param>
                    /// <param name="match91">Match 24th item.</param>
                    /// <param name="match92">Match 25th item.</param>
                    /// <param name="match93">Match 26th item.</param>
                    ...
                    public TResult Match<TContext, TResult>(
                        ...
                        Func<TContext, TResult> match101,
                        Func<TContext, TResult> match102,
                        Func<TContext, TResult> match103,
                        Func<TContext, TResult> match104,
                    ...
                    public TResult Match<TResult>(
                        ...
                        Func<TResult> match101,
                        Func<TResult> match102,
                        Func<TResult> match103,
                        Func<TResult> match104,
