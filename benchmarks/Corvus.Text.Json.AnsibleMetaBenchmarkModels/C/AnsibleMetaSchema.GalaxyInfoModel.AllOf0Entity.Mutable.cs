...
public readonly partial struct AnsibleMetaSchema
{
    ...
    public readonly partial struct GalaxyInfoModel
    {
        ...
        public readonly partial struct AllOf0Entity
        {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Text.Json.JsonElement.Source author = default, in Corvus.Text.Json.JsonElement.Source description = default, in Corvus.Text.Json.JsonElement.Source license = default, in Corvus.Text.Json.JsonElement.Source minAnsibleVersion = default)
            {
            ...
            /// <param name="minAnsibleVersion">The value of the <c>"min_ansible_version"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> author = default, in Corvus.Text.Json.JsonElement.Source<TContext> description = default, in Corvus.Text.Json.JsonElement.Source<TContext> license = default, in Corvus.Text.Json.JsonElement.Source<TContext> minAnsibleVersion = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
