    ...
    public readonly partial struct GalaxyInfoModel
    {
        ...
        public readonly partial struct AllOf0Entity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.AllOf0Entity.WithStandaloneTrue.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsWithStandaloneTrue(out Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.AllOf0Entity.WithStandaloneTrue.Mutable result)
                {
                    if (Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.AllOf0Entity.WithStandaloneTrue.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.AllOf0Entity.WithStandaloneTrue.Mutable.From(this);
                        return true;
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.AllOf0Entity.RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsRequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion(out Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.AllOf0Entity.RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion.Mutable result)
                {
                    ...
                    {
                        result = Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.AllOf0Entity.RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.AllOf0Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.AllOf0Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.Text.Json.JsonElement.Source author = default,
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.Text.Json.JsonElement.Source<TContext> author = default,
                    in Corvus.Text.Json.JsonElement.Source<TContext> description = default,
                    in Corvus.Text.Json.JsonElement.Source<TContext> license = default,
                    in Corvus.Text.Json.JsonElement.Source<TContext> minAnsibleVersion = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Text.Json.JsonElement.Source author = default, scoped in Corvus.Text.Json.JsonElement.Source description = default, scoped in Corvus.Text.Json.JsonElement.Source license = default, scoped in Corvus.Text.Json.JsonElement.Source minAnsibleVersion = default)
            {
            ...
            /// <param name="minAnsibleVersion">The value of the <c>"min_ansible_version"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> author = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> description = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> license = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> minAnsibleVersion = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source author = default, in Corvus.Text.Json.JsonElement.Source description = default, in Corvus.Text.Json.JsonElement.Source license = default, in Corvus.Text.Json.JsonElement.Source minAnsibleVersion = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> author = default, in Corvus.Text.Json.JsonElement.Source<TContext> description = default, in Corvus.Text.Json.JsonElement.Source<TContext> license = default, in Corvus.Text.Json.JsonElement.Source<TContext> minAnsibleVersion = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            public static ParsedJsonDocument<AllOf0Entity> Create(in Corvus.Text.Json.JsonElement.Source author = default, in Corvus.Text.Json.JsonElement.Source description = default, in Corvus.Text.Json.JsonElement.Source license = default, in Corvus.Text.Json.JsonElement.Source minAnsibleVersion = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<AllOf0Entity> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> author = default, in Corvus.Text.Json.JsonElement.Source<TContext> description = default, in Corvus.Text.Json.JsonElement.Source<TContext> license = default, in Corvus.Text.Json.JsonElement.Source<TContext> minAnsibleVersion = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
