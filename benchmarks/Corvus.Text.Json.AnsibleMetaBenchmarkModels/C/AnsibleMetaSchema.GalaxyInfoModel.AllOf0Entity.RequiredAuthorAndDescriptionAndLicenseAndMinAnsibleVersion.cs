    ...
    public readonly partial struct GalaxyInfoModel
    {
        ...
        public readonly partial struct AllOf0Entity
        {
            ...
            public readonly partial struct RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion
                ...
                : IJsonElement<RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion DefaultInstance { get; }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.JsonElement Author
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AuthorUtf8, out Corvus.Text.Json.JsonElement value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.JsonElement License
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LicenseUtf8, out Corvus.Text.Json.JsonElement value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion left, in RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion(JsonElement instance)
                {
                    return RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion>(json, options);
                }
                ...
                /// </exception>
                public static RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion? result)
                {
                    return JsonElementHelpers.TryParseValue<RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion>(ref reader, out result);
                }
...
#if NET
                static RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion IJsonElement<RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<RequiredAuthorAndDescriptionAndLicenseAndMinAnsibleVersion>(_idx);
                    }
                ...
                private static class JsonPropertyNamesPrebaked
                {
                    ...
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="MinAnsibleVersion"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> MinAnsibleVersion => [0x55, 0x01, 0x00, 0x00, 0x22, 0x6D, 0x69, 0x6E, 0x5F, 0x61, 0x6E, 0x73, 0x69, 0x62, 0x6C, 0x65, 0x5F, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6F, 0x6E, 0x22];
                }
            }
        }
    }
