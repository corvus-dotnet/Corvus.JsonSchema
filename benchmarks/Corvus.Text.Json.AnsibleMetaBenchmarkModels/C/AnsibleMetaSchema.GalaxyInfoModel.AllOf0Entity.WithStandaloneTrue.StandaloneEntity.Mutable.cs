            ...
            public readonly partial struct WithStandaloneTrue
            {
                ...
                public readonly partial struct StandaloneEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(StandaloneEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="StandaloneEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator StandaloneEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"StandaloneEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly StandaloneEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly StandaloneEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<StandaloneEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(StandaloneEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<StandaloneEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<StandaloneEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<StandaloneEntity>();
                        }
                        finally
                        {
