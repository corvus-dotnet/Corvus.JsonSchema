        ...
        public readonly partial struct AllOf1Entity
        {
            ...
            public readonly partial struct WithStandaloneFalse
            {
...
#endif
                {
                    ...
                    /// </summary>
                    public Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.StandaloneEntity.Mutable Standalone
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StandaloneUtf8, out Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.StandaloneEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetStandalone(scoped in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.StandaloneEntity.Source value)
                    {
                        CheckValidInstance();
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.StandaloneEntity.Source _createArg1;
                    ...
                    internal Source(Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.StandaloneEntity.Source arg1)
                    {
                        _createArg1 = arg1;
                        _kind = Kind.Create;
                    }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.StandaloneEntity.Source standalone = default)
                    {
                    ...
                    /// Creates an instance of a <see cref="WithStandaloneFalse"/>.
                    /// </summary>
                    public void Create(in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.StandaloneEntity.Source standalone = default)
                    {
                    ...
                    internal static void BuildCreateValue(scoped in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.StandaloneEntity.Source arg1, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                        Create(ref o, arg1);
                        o.EndObject();
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.StandaloneEntity.Source standalone = default)
                {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.StandaloneEntity.Source standalone = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                public static ParsedJsonDocument<WithStandaloneFalse> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<WithStandaloneFalse>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<WithStandaloneFalse> Create<TContext>(
                ...
                public static ParsedJsonDocument<WithStandaloneFalse> Create(in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.StandaloneEntity.Source standalone = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
