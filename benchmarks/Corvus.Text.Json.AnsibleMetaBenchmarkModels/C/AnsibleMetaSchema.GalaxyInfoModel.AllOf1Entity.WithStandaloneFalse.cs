...
public readonly partial struct AnsibleMetaSchema
{
    ...
    public readonly partial struct GalaxyInfoModel
    {
        ...
        public readonly partial struct AllOf1Entity
        {
            ...
            public readonly partial struct WithStandaloneFalse
#if NET8_0_OR_GREATER
                : IJsonElement<WithStandaloneFalse>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="WithStandaloneFalse"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal WithStandaloneFalse(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static WithStandaloneFalse DefaultInstance { get; }
                ...
                /// </summary>
                public Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.StandaloneEntity Standalone
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StandaloneUtf8, out Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.AllOf1Entity.WithStandaloneFalse.StandaloneEntity value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in WithStandaloneFalse left, in WithStandaloneFalse right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in WithStandaloneFalse left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(WithStandaloneFalse instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WithStandaloneFalse(JsonElement instance)
                {
                    return WithStandaloneFalse.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WithStandaloneFalse From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WithStandaloneFalse ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<WithStandaloneFalse>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WithStandaloneFalse ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<WithStandaloneFalse>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WithStandaloneFalse ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<WithStandaloneFalse>(json, options);
                }
                ...
                /// </exception>
                public static WithStandaloneFalse ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<WithStandaloneFalse>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out WithStandaloneFalse? result)
                {
                    return JsonElementHelpers.TryParseValue<WithStandaloneFalse>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new WithStandaloneFalse(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static WithStandaloneFalse IJsonElement<WithStandaloneFalse>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WithStandaloneFalse: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="WithStandaloneFalse"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="WithStandaloneFalse"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public WithStandaloneFalse Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<WithStandaloneFalse>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="WithStandaloneFalse"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public WithStandaloneFalse Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<WithStandaloneFalse>(_idx);
                    }
                ...
                {
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="Standalone"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Standalone => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x73, 0x74, 0x61, 0x6E, 0x64, 0x61, 0x6C, 0x6F, 0x6E, 0x65, 0x22];
                }
            }
        }
    }
