...
public readonly partial struct AnsibleMetaSchema
{
    ...
    public readonly partial struct GalaxyInfoModel
    {
        ...
        public readonly partial struct NamespaceName
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(NamespaceName instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="NamespaceName"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator NamespaceName(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new NamespaceName(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"NamespaceName.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="NamespaceName"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="NamespaceName"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly NamespaceName Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<NamespaceName>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="NamespaceName"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly NamespaceName Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<NamespaceName>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(NamespaceName instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<NamespaceName, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<NamespaceName> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<NamespaceName>();
                }
                finally
                {
