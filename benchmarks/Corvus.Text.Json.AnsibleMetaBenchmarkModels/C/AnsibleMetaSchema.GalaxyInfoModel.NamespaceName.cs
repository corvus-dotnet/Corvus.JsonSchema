...
public readonly partial struct AnsibleMetaSchema
{
    ...
    public readonly partial struct GalaxyInfoModel
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="NamespaceName"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal NamespaceName(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static NamespaceName DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(NamespaceName value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in NamespaceName left, in NamespaceName right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in NamespaceName left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(NamespaceName instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NamespaceName(JsonElement instance)
            {
                return NamespaceName.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NamespaceName From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NamespaceName ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NamespaceName>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NamespaceName ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NamespaceName>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NamespaceName ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NamespaceName>(json, options);
            }
            ...
            /// </exception>
            public static NamespaceName ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<NamespaceName>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out NamespaceName? result)
            {
                return JsonElementHelpers.TryParseValue<NamespaceName>(ref reader, out result);
            }
...
#if NET
            static NamespaceName IJsonElement<NamespaceName>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"NamespaceName: ValueKind = {ValueKind} : \"{ToString()}\"";
