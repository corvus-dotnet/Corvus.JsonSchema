    ...
    public readonly partial struct GalaxyInfoModel
    {
        ...
        public readonly partial struct RoleName
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RoleName instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RoleName"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RoleName(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RoleName(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RoleName.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RoleName"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RoleName"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RoleName Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RoleName>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RoleName"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RoleName Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RoleName>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RoleName instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RoleName, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RoleName> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RoleName>();
                }
                finally
                {
