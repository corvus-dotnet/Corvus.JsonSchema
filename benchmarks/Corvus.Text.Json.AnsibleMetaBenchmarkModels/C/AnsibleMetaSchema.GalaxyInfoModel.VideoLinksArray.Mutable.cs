    ...
    public readonly partial struct GalaxyInfoModel
    {
        ...
        public readonly partial struct VideoLinksArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(VideoLinksArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="VideoLinksArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator VideoLinksArray(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"VideoLinksArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public readonly VideoLinksArray Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly VideoLinksArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<VideoLinksArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.VideoLinksArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(VideoLinksArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.VideoLinksArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<VideoLinksArray, Mutable>(this);
            }
        }
    }
}
