...
public readonly partial struct AnsibleMetaSchema
{
...
#endif
    {
        ...
        /// Name
        /// </summary>
        public Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.IosPlatformModel.Name NameValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameValueUtf8, out Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.IosPlatformModel.Name value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.IosPlatformModel.VersionsArray Versions
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionsUtf8, out Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.IosPlatformModel.VersionsArray value))
                {
                    return value;
                }

                return Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.IosPlatformModel.VersionsArray.DefaultInstance;
            }
        }
