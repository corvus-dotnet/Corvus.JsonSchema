    ...
    public readonly partial struct KaliPlatformModel
    {
        ...
        public readonly partial struct VersionsArray
        {
...
#endif
            {
                ...
                /// <param name="match20">Match 1st item.</param>
                /// <param name="match2016">Match 2nd item.</param>
                /// <param name="match2017">Match 3rd item.</param>
                /// <param name="match2018">Match 4th item.</param>
                /// <param name="match2019">Match 5th item.</param>
                /// <param name="match2020">Match 6th item.</param>
                /// <param name="match2021">Match 7th item.</param>
                /// <param name="match2022">Match 8th item.</param>
                /// <param name="match2023">Match 9th item.</param>
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Func<TContext, TResult> match2016,
                    Func<TContext, TResult> match2017,
                    Func<TContext, TResult> match2018,
                    Func<TContext, TResult> match2019,
                    Func<TContext, TResult> match2020,
                    Func<TContext, TResult> match2021,
                    Func<TContext, TResult> match2022,
                    Func<TContext, TResult> match2023,
                ...
                public TResult Match<TResult>(
                    ...
                    Func<TResult> match2016,
                    Func<TResult> match2017,
                    Func<TResult> match2018,
                    Func<TResult> match2019,
                    Func<TResult> match2020,
                    Func<TResult> match2021,
                    Func<TResult> match2022,
                    Func<TResult> match2023,
