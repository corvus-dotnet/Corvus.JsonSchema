...
public readonly partial struct AnsibleMetaSchema
{
    ...
    public readonly partial struct KaliPlatformModel
        ...
        : IJsonElement<KaliPlatformModel>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KaliPlatformModel"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal KaliPlatformModel(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static KaliPlatformModel DefaultInstance { get; }
        ...
        /// Name
        /// </summary>
        public Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.KaliPlatformModel.Name NameValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameValueUtf8, out Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.KaliPlatformModel.Name value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.KaliPlatformModel.VersionsArray Versions
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionsUtf8, out Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.KaliPlatformModel.VersionsArray value))
                {
                    return value;
                }

                return Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.KaliPlatformModel.VersionsArray.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in KaliPlatformModel left, in KaliPlatformModel right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in KaliPlatformModel left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(KaliPlatformModel instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator KaliPlatformModel(JsonElement instance)
        {
            return KaliPlatformModel.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static KaliPlatformModel From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static KaliPlatformModel ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<KaliPlatformModel>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static KaliPlatformModel ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<KaliPlatformModel>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static KaliPlatformModel ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<KaliPlatformModel>(json, options);
        }
        ...
        /// </exception>
        public static KaliPlatformModel ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<KaliPlatformModel>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out KaliPlatformModel? result)
        {
            return JsonElementHelpers.TryParseValue<KaliPlatformModel>(ref reader, out result);
        }
...
#if NET
        static KaliPlatformModel IJsonElement<KaliPlatformModel>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"KaliPlatformModel: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public KaliPlatformModel Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public KaliPlatformModel Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<KaliPlatformModel>(_idx);
            }
