        ...
        public readonly partial struct VersionsArray
        {
            ...
            public readonly partial struct VersionsEntity
            {
...
#endif
                {
                    ...
                    /// <param name="matchBigSur">Match 1st item.</param>
                    /// <param name="matchCatalina">Match 2nd item.</param>
                    /// <param name="matchHighSierra">Match 3rd item.</param>
                    /// <param name="matchMojave">Match 4th item.</param>
                    /// <param name="matchMonterey">Match 5th item.</param>
                    /// <param name="matchSierra">Match 6th item.</param>
                    /// <param name="matchAll">Match 7th item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchBigSur,
                        Func<TContext, TResult> matchCatalina,
                        Func<TContext, TResult> matchHighSierra,
                        Func<TContext, TResult> matchMojave,
                        Func<TContext, TResult> matchMonterey,
                        Func<TContext, TResult> matchSierra,
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> matchBigSur,
                        Func<TResult> matchCatalina,
                        Func<TResult> matchHighSierra,
                        Func<TResult> matchMojave,
                        Func<TResult> matchMonterey,
                        Func<TResult> matchSierra,
                        ...
                        Func<TResult> defaultMatch)
                    {
                        ...
                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchCatalina();
                        }

                        if (this.ValueEquals(Constants.Enum3))
                        {
                            return matchHighSierra();
                        }
