...
public readonly partial struct AnsibleMetaSchema
{
...
#endif
    {
        ...
        public static explicit operator Mutable(AnsibleMetaSchema instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="AnsibleMetaSchema"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AnsibleMetaSchema(Mutable instance)
        {
        ...
        /// Allow Duplicates
        /// </summary>
        public Corvus.AnsibleMetaBenchmark.Current.JsonBoolean.Mutable AllowDuplicates
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AllowDuplicatesUtf8, out Corvus.AnsibleMetaBenchmark.Current.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.Mutable CollectionsValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CollectionsValueUtf8, out Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.Mutable value))
                {
                    return value;
                }
        ...
        /// Dependencies
        /// </summary>
        public Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModelArray.Mutable Dependencies
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DependenciesUtf8, out Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModelArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.Mutable GalaxyInfo
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GalaxyInfoUtf8, out Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetCollectionsValue<TContext>(in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetDependencies<TContext>(in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModelArray.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetGalaxyInfo<TContext>(in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AnsibleMetaSchema.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly AnsibleMetaSchema Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly AnsibleMetaSchema Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<AnsibleMetaSchema>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.Source _createArg2;
        private readonly Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModelArray.Source _createArg3;
        private readonly Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.Source _createArg4;
        ...
        public static implicit operator Source(AnsibleMetaSchema instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.AnsibleMetaBenchmark.Current.JsonBoolean.Source _createArg1;
        private readonly Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.Source<TContext> _createArg2;
        private readonly Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModelArray.Source<TContext> _createArg3;
        private readonly Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.Source<TContext> _createArg4;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="AnsibleMetaSchema"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.AnsibleMetaBenchmark.Current.JsonBoolean.Source allowDuplicates = default,
            in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.Source collections = default,
        ...
        internal static void Create<TContext>(
            ...
            ref ComplexValueBuilder builder,
            in Corvus.AnsibleMetaBenchmark.Current.JsonBoolean.Source allowDuplicates = default,
            in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.Source<TContext> collections = default,
            in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModelArray.Source<TContext> dependencies = default,
            in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.Source<TContext> galaxyInfo = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
    ...
    /// </summary>
    /// <param name="allowDuplicates">The value of the <c>"allow_duplicates"</c> property.</param>
    ...
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.AnsibleMetaBenchmark.Current.JsonBoolean.Source allowDuplicates = default, scoped in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.Source<TContext> collections = default, scoped in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModelArray.Source<TContext> dependencies = default, scoped in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.Source<TContext> galaxyInfo = default)
        ...
        #endif
    {
        return new Source<TContext>(context, allowDuplicates, collections, dependencies, galaxyInfo);
    }
    ...
    {
        return workspace.CreateBuilder<AnsibleMetaSchema, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<AnsibleMetaSchema> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<AnsibleMetaSchema>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<AnsibleMetaSchema> Create<TContext>(
    ...
    public static ParsedJsonDocument<AnsibleMetaSchema> Create(in Corvus.AnsibleMetaBenchmark.Current.JsonBoolean.Source allowDuplicates = default, in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.Source collections = default, in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModelArray.Source dependencies = default, in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.Source galaxyInfo = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<AnsibleMetaSchema> Create<TContext>(in TContext context, in Corvus.AnsibleMetaBenchmark.Current.JsonBoolean.Source allowDuplicates = default, in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections.Source<TContext> collections = default, in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModelArray.Source<TContext> dependencies = default, in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel.Source<TContext> galaxyInfo = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
