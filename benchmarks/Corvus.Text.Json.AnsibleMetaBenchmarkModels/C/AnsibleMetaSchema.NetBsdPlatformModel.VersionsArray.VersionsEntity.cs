    ...
    public readonly partial struct NetBsdPlatformModel
    {
        ...
        public readonly partial struct VersionsArray
        {
...
#endif
            {
                ...
                /// <param name="match80">Match 1st item.</param>
                /// <param name="match81">Match 2nd item.</param>
                /// <param name="match82">Match 3rd item.</param>
                /// <param name="match90">Match 4th item.</param>
                /// <param name="match91">Match 5th item.</param>
                /// <param name="match92">Match 6th item.</param>
                /// <param name="match93">Match 7th item.</param>
                /// <param name="match100">Match 8th item.</param>
                /// <param name="matchAll">Match 9th item.</param>
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Func<TContext, TResult> match92,
                    Func<TContext, TResult> match93,
                    Func<TContext, TResult> match100,
                ...
                public TResult Match<TResult>(
                    ...
                    Func<TResult> match92,
                    Func<TResult> match93,
                    Func<TResult> match100,
