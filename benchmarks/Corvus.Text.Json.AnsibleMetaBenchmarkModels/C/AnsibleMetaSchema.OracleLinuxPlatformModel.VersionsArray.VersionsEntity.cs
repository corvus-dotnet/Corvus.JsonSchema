    ...
    public readonly partial struct OracleLinuxPlatformModel
    {
        ...
        public readonly partial struct VersionsArray
        {
...
#endif
            {
                ...
                /// <param name="match70">Match 1st item.</param>
                /// <param name="match71">Match 2nd item.</param>
                /// <param name="match72">Match 3rd item.</param>
                /// <param name="match73">Match 4th item.</param>
                /// <param name="match74">Match 5th item.</param>
                /// <param name="match75">Match 6th item.</param>
                /// <param name="match76">Match 7th item.</param>
                /// <param name="match77">Match 8th item.</param>
                /// <param name="match78">Match 9th item.</param>
                /// <param name="match79">Match 10th item.</param>
                /// <param name="match80">Match 11th item.</param>
                /// <param name="match81">Match 12th item.</param>
                /// <param name="match82">Match 13th item.</param>
                /// <param name="match83">Match 14th item.</param>
                /// <param name="match84">Match 15th item.</param>
                /// <param name="match85">Match 16th item.</param>
                /// <param name="match86">Match 17th item.</param>
                /// <param name="match87">Match 18th item.</param>
                /// <param name="match88">Match 19th item.</param>
                /// <param name="match90">Match 20th item.</param>
                /// <param name="match91">Match 21st item.</param>
                /// <param name="matchAll">Match 22nd item.</param>
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Func<TContext, TResult> match74,
                    Func<TContext, TResult> match75,
                    Func<TContext, TResult> match76,
                    Func<TContext, TResult> match77,
                    Func<TContext, TResult> match78,
                    Func<TContext, TResult> match79,
                    Func<TContext, TResult> match80,
                    Func<TContext, TResult> match81,
                    Func<TContext, TResult> match82,
                    Func<TContext, TResult> match83,
                    Func<TContext, TResult> match84,
                    Func<TContext, TResult> match85,
                    Func<TContext, TResult> match86,
                    Func<TContext, TResult> match87,
                    Func<TContext, TResult> match88,
                    Func<TContext, TResult> match90,
                    Func<TContext, TResult> match91,
                ...
                public TResult Match<TResult>(
                    ...
                    Func<TResult> match74,
                    Func<TResult> match75,
                    Func<TResult> match76,
                    Func<TResult> match77,
                    Func<TResult> match78,
                    Func<TResult> match79,
                    Func<TResult> match80,
                    Func<TResult> match81,
                    Func<TResult> match82,
                    Func<TResult> match83,
                    Func<TResult> match84,
                    Func<TResult> match85,
                    Func<TResult> match86,
                    Func<TResult> match87,
                    Func<TResult> match88,
                    Func<TResult> match90,
                    Func<TResult> match91,
