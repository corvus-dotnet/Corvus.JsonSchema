...
public readonly partial struct AnsibleMetaSchema
{
    ...
    public readonly partial struct Platforms
    {
...
#endif
        {
            ...
            public Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Platforms.PlatformsEntity.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Platforms.PlatformsEntity.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Platforms.PlatformsEntity.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Platforms.PlatformsEntity.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Platforms.PlatformsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, scoped in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Platforms.PlatformsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(scoped in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Platforms.PlatformsEntity.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Platforms.PlatformsEntity item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Platforms.PlatformsEntity>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Platforms.PlatformsEntity> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Platforms.PlatformsEntity>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Platforms.PlatformsEntity oldItem, in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Platforms.PlatformsEntity.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Platforms.PlatformsEntity>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Platforms.PlatformsEntity current = enumerator.Current;
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Platforms.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Platforms.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            public void AddItem(in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Platforms.PlatformsEntity.Source value)
            {
            ...
            /// Add an item to the array.
            /// </summary>
            public void AddItem<TContext>(in Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Platforms.PlatformsEntity.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        public static ParsedJsonDocument<Platforms> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Platforms>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Platforms> Create<TContext>(
