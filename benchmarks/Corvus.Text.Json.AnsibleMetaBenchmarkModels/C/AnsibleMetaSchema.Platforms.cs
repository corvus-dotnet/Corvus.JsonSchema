...
public readonly partial struct AnsibleMetaSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Platforms"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Platforms(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Platforms DefaultInstance { get; }
        ...
        public Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Platforms.PlatformsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Platforms.PlatformsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Platforms.PlatformsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Platforms.PlatformsEntity>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in Platforms left, in Platforms right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Platforms left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Platforms instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Platforms(JsonElement instance)
        {
            return Platforms.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Platforms From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Platforms ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Platforms>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Platforms ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Platforms>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Platforms ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Platforms>(json, options);
        }
        ...
        /// </exception>
        public static Platforms ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Platforms>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Platforms? result)
        {
            return JsonElementHelpers.TryParseValue<Platforms>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Platforms(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Platforms IJsonElement<Platforms>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Platforms: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Platforms"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Platforms"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<Platforms>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Platforms"/> that lives for the lifetime of its
