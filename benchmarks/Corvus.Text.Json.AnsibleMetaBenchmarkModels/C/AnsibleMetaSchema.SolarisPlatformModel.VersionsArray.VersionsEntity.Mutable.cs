        ...
        public readonly partial struct VersionsArray
        {
            ...
            public readonly partial struct VersionsEntity
            {
...
#endif
                {
                    ...
                    /// <param name="match111">Match 3rd item.</param>
                    /// <param name="match112">Match 4th item.</param>
                    /// <param name="match113">Match 5th item.</param>
                    /// <param name="match114">Match 6th item.</param>
                    ...
                    public TResult Match<TContext, TResult>(
                        ...
                        Func<TContext, TResult> match111,
                        Func<TContext, TResult> match112,
                        Func<TContext, TResult> match113,
                        Func<TContext, TResult> match114,
                    ...
                    public TResult Match<TResult>(
                        ...
                        Func<TResult> match111,
                        Func<TResult> match112,
                        Func<TResult> match113,
                        Func<TResult> match114,
