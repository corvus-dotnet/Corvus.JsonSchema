...
public readonly partial struct AnsibleMetaSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VoidLinuxPlatformModel"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal VoidLinuxPlatformModel(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static VoidLinuxPlatformModel DefaultInstance { get; }
        ...
        /// Name
        /// </summary>
        public Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.VoidLinuxPlatformModel.Name NameValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameValueUtf8, out Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.VoidLinuxPlatformModel.Name value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.VoidLinuxPlatformModel.VersionsArray Versions
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionsUtf8, out Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.VoidLinuxPlatformModel.VersionsArray value))
                {
                    return value;
                }

                return Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.VoidLinuxPlatformModel.VersionsArray.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in VoidLinuxPlatformModel left, in VoidLinuxPlatformModel right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in VoidLinuxPlatformModel left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(VoidLinuxPlatformModel instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator VoidLinuxPlatformModel(JsonElement instance)
        {
            return VoidLinuxPlatformModel.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VoidLinuxPlatformModel From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VoidLinuxPlatformModel ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<VoidLinuxPlatformModel>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VoidLinuxPlatformModel ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<VoidLinuxPlatformModel>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VoidLinuxPlatformModel ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<VoidLinuxPlatformModel>(json, options);
        }
        ...
        /// </exception>
        public static VoidLinuxPlatformModel ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<VoidLinuxPlatformModel>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out VoidLinuxPlatformModel? result)
        {
            return JsonElementHelpers.TryParseValue<VoidLinuxPlatformModel>(ref reader, out result);
        }
...
#if NET
        static VoidLinuxPlatformModel IJsonElement<VoidLinuxPlatformModel>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"VoidLinuxPlatformModel: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public VoidLinuxPlatformModel Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public VoidLinuxPlatformModel Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<VoidLinuxPlatformModel>(_idx);
            }
