...
public readonly partial struct AnsibleMetaSchema
    ...
    : IJsonElement<AnsibleMetaSchema>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AnsibleMetaSchema"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal AnsibleMetaSchema(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static AnsibleMetaSchema DefaultInstance { get; }
    ...
    /// </summary>
    public Corvus.Text.Json.JsonElementForBooleanFalseSchema AdditionalProperties
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AdditionalPropertiesUtf8, out Corvus.Text.Json.JsonElementForBooleanFalseSchema value))
            {
                return value;
            }
    ...
    /// <summary>
    /// Gets the (optional) <c>allow_duplicates</c> property.
    /// Allow Duplicates
    /// </summary>
    public Corvus.AnsibleMetaBenchmark.Current.JsonBoolean AllowDuplicates
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AllowDuplicatesUtf8, out Corvus.AnsibleMetaBenchmark.Current.JsonBoolean value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections CollectionsValue
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CollectionsValueUtf8, out Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.Collections value))
            {
                return value;
            }
    ...
    /// Dependencies
    /// </summary>
    public Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModelArray Dependencies
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DependenciesUtf8, out Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.DependencyModelArray value))
            {
                return value;
            }
    ...
    /// <summary>
    /// Gets the (optional) <c>galaxy_info</c> property.
    /// </summary>
    public Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel GalaxyInfo
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GalaxyInfoUtf8, out Corvus.AnsibleMetaBenchmark.Current.AnsibleMetaSchema.GalaxyInfoModel value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in AnsibleMetaSchema left, in AnsibleMetaSchema right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in AnsibleMetaSchema left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(AnsibleMetaSchema instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator AnsibleMetaSchema(JsonElement instance)
    {
        return AnsibleMetaSchema.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AnsibleMetaSchema From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AnsibleMetaSchema ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<AnsibleMetaSchema>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AnsibleMetaSchema ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<AnsibleMetaSchema>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AnsibleMetaSchema ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<AnsibleMetaSchema>(json, options);
    }
    ...
    /// </exception>
    public static AnsibleMetaSchema ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<AnsibleMetaSchema>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out AnsibleMetaSchema? result)
    {
        return JsonElementHelpers.TryParseValue<AnsibleMetaSchema>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new AnsibleMetaSchema(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static AnsibleMetaSchema IJsonElement<AnsibleMetaSchema>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"AnsibleMetaSchema: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="AnsibleMetaSchema"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="AnsibleMetaSchema"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public AnsibleMetaSchema Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<AnsibleMetaSchema>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="AnsibleMetaSchema"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public AnsibleMetaSchema Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<AnsibleMetaSchema>(_idx);
        }
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="AllowDuplicates"/>.
        /// </summary>
        public const string AllowDuplicates = "allow_duplicates";

        /// <summary>
        /// Gets the JSON property name for <see cref="CollectionsValue"/>.
        /// </summary>
        public const string CollectionsValue = "collections";
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="GalaxyInfo"/>.
        /// </summary>
        public const string GalaxyInfo = "galaxy_info";
        ...
        /// Gets the JSON property name for <see cref="AllowDuplicates"/>.
        /// </summary>
        public static ReadOnlySpan<byte> AllowDuplicatesUtf8 => "allow_duplicates"u8;

        /// <summary>
        /// Gets the JSON property name for <see cref="CollectionsValue"/>.
        /// </summary>
        public static ReadOnlySpan<byte> CollectionsValueUtf8 => "collections"u8;
        ...
        /// Gets the JSON property name for <see cref="GalaxyInfo"/>.
        /// </summary>
        public static ReadOnlySpan<byte> GalaxyInfoUtf8 => "galaxy_info"u8;
    }
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="AllowDuplicates"/>.
        /// </summary>
        public static ReadOnlySpan<byte> AllowDuplicates => "allow_duplicates"u8;

        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="CollectionsValue"/>.
        /// </summary>
        public static ReadOnlySpan<byte> CollectionsValue => "collections"u8;
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="GalaxyInfo"/>.
        /// </summary>
