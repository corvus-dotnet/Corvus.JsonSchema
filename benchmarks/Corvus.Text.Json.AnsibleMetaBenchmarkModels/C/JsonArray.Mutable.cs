...
public readonly partial struct JsonArray
{
...
#endif
    {
        ...
        public static explicit operator Mutable(JsonArray instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="JsonArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonArray(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </para>
        /// </remarks>
        public readonly JsonArray Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly JsonArray Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonArray>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.AnsibleMetaBenchmark.Current.JsonArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(JsonArray instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.AnsibleMetaBenchmark.Current.JsonArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<JsonArray, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<JsonArray> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<JsonArray>();
        }
        finally
        {
