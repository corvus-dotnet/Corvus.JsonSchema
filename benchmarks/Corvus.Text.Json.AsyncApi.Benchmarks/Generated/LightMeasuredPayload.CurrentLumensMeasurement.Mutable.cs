...
public readonly partial struct LightMeasuredPayload
{
    ...
    public readonly partial struct CurrentLumensMeasurement
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(CurrentLumensMeasurement instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CurrentLumensMeasurement"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CurrentLumensMeasurement(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new CurrentLumensMeasurement(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CurrentLumensMeasurement.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="CurrentLumensMeasurement"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="CurrentLumensMeasurement"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly CurrentLumensMeasurement Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<CurrentLumensMeasurement>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="CurrentLumensMeasurement"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly CurrentLumensMeasurement Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CurrentLumensMeasurement>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(CurrentLumensMeasurement instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<CurrentLumensMeasurement, Mutable>(this);
        }
    }
}
