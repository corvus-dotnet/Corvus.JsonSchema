    ...
    : IJsonElement<LightMeasuredPayload>
{
    public static partial class JsonSchema
    {
        ...
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyLumensPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("lumens"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyLumensNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("lumens"u8, buffer, out written);

        private const int RequiredOffsetForLumens = 0;
        private const uint RequiredBitForLumens = 0b00000000000000000000000000000010;

        private static readonly JsonSchemaMessageProvider<int> RequiredPropertySentAtPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("sentAt"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertySentAtNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("sentAt"u8, buffer, out written);

        private const int RequiredOffsetForSentAt = 0;
        private const uint RequiredBitForSentAt = 0b00000000000000000000000000000100;

        private const uint RequiredBitMask0 =
            RequiredBitForId | RequiredBitForLumens | RequiredBitForSentAt;
        ...
        private static readonly JsonSchemaPathProvider LumensSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/lumens"u8, buffer, out written);
        ...
        private static void MatchLumens(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            ...
            requiredBitBuffer[RequiredOffsetForLumens] |= RequiredBitForLumens;
        }
            ...
            else
            {
                ...
                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                {
                    if (context.HasCollector)
                    {
                        ...
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyLumensPresent, "lumens"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertySentAtPresent, "sentAt"u8, "required"u8);
                    }
                }
                ...
                else
                {
                    ...
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForLumens] & RequiredBitForLumens) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyLumensNotPresent, "lumens"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyLumensPresent, "lumens"u8, "required"u8);
                    ...
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForSentAt] & RequiredBitForSentAt) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 2, RequiredPropertySentAtNotPresent, "sentAt"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertySentAtPresent, "sentAt"u8, "required"u8);
