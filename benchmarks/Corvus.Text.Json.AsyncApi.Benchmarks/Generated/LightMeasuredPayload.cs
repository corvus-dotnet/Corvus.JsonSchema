...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="LightMeasuredPayload"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal LightMeasuredPayload(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static LightMeasuredPayload DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in LightMeasuredPayload left, in LightMeasuredPayload right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in LightMeasuredPayload left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(LightMeasuredPayload instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator LightMeasuredPayload(JsonElement instance)
    {
        return LightMeasuredPayload.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static LightMeasuredPayload From<T>(in T instance)
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out LightMeasuredPayload? result)
    {
        return JsonElementHelpers.TryParseValue<LightMeasuredPayload>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new LightMeasuredPayload(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static LightMeasuredPayload IJsonElement<LightMeasuredPayload>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"LightMeasuredPayload: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="LightMeasuredPayload"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="LightMeasuredPayload"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public LightMeasuredPayload Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<LightMeasuredPayload>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="LightMeasuredPayload"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public LightMeasuredPayload Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<LightMeasuredPayload>(_idx);
        }
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="Lumens"/>.
        /// </summary>
        public const string Lumens = "lumens";

        /// <summary>
        /// Gets the JSON property name for <see cref="SentAt"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Lumens"/>.
        /// </summary>
        public static ReadOnlySpan<byte> LumensUtf8 => "lumens"u8;

        /// <summary>
        /// Gets the JSON property name for <see cref="SentAt"/>.
        /// </summary>
        public static ReadOnlySpan<byte> SentAtUtf8 => "sentAt"u8;
    }
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Lumens"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Lumens => "lumens"u8;

        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="SentAt"/>.
        /// </summary>
        public static ReadOnlySpan<byte> SentAt => "sentAt"u8;
    }
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Lumens"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Lumens => [0x85, 0x00, 0x00, 0x00, 0x22, 0x6C, 0x75, 0x6D, 0x65, 0x6E, 0x73, 0x22];

        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="SentAt"/>.
        /// </summary>
        public static ReadOnlySpan<byte> SentAt => [0x85, 0x00, 0x00, 0x00, 0x22, 0x73, 0x65, 0x6E, 0x74, 0x41, 0x74, 0x22];
    }
}
