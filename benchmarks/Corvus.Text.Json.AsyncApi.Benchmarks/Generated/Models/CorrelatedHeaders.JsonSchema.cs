...
public readonly partial struct CorrelatedHeaders
    : IJsonElement<CorrelatedHeaders>
{
    public static partial class JsonSchema
    {
        ...
        private const uint RequiredBitForCorrelationId = 0b00000000000000000000000000000001;
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/correlatedHeaders"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/correlatedHeaders";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/correlatedHeaders"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyCorrelationIdPresent, "correlationId"u8, "required"u8);
                }
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyCorrelationIdNotPresent, "correlationId"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyCorrelationIdPresent, "correlationId"u8, "required"u8);
