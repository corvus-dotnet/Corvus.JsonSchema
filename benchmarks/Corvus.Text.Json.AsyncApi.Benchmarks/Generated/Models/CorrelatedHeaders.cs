...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CorrelatedHeaders"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal CorrelatedHeaders(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static CorrelatedHeaders DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in CorrelatedHeaders left, in CorrelatedHeaders right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in CorrelatedHeaders left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(CorrelatedHeaders instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator CorrelatedHeaders(JsonElement instance)
    {
        return CorrelatedHeaders.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CorrelatedHeaders From<T>(in T instance)
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out CorrelatedHeaders? result)
    {
        return JsonElementHelpers.TryParseValue<CorrelatedHeaders>(ref reader, out result);
    }
...
#if NET
    static CorrelatedHeaders IJsonElement<CorrelatedHeaders>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"CorrelatedHeaders: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public CorrelatedHeaders Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public CorrelatedHeaders Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<CorrelatedHeaders>(_idx);
        }
