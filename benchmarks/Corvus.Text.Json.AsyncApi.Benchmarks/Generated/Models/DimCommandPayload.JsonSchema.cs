...
public readonly partial struct DimCommandPayload
    : IJsonElement<DimCommandPayload>
{
    public static partial class JsonSchema
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyPercentagePresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("percentage"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyPercentageNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("percentage"u8, buffer, out written);

        private const int RequiredOffsetForPercentage = 0;
        private const uint RequiredBitForPercentage = 0b00000000000000000000000000000001;

        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyStreetlightIdPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("streetlightId"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyStreetlightIdNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("streetlightId"u8, buffer, out written);

        private const int RequiredOffsetForStreetlightId = 0;
        private const uint RequiredBitForStreetlightId = 0b00000000000000000000000000000010;

        private const uint RequiredBitMask0 =
            RequiredBitForPercentage | RequiredBitForStreetlightId;
        private static readonly JsonSchemaPathProvider PercentageSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/percentage"u8, buffer, out written);
        private static readonly JsonSchemaPathProvider SentAtSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/sentAt"u8, buffer, out written);
        ...
        private static void MatchPercentage(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext =
                AsyncApiBenchmark.Generated.DimCommandPayload.TargetBrightnessPercentage.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.PercentageUtf8,
                    evaluationPath: PercentageSchemaEvaluationPath);

            AsyncApiBenchmark.Generated.DimCommandPayload.TargetBrightnessPercentage.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            requiredBitBuffer[RequiredOffsetForPercentage] |= RequiredBitForPercentage;
        }

        private static void MatchSentAt(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            ...
            AsyncApiBenchmark.Generated.JsonDateTime.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
        ...
        private static void MatchStreetlightId(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext2 =
                AsyncApiBenchmark.Generated.DimCommandPayload.TheStreetlightToDim.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            AsyncApiBenchmark.Generated.DimCommandPayload.TheStreetlightToDim.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
        ...
        private static PropertySchemaMatchers<AsyncApiBenchmark.Generated.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<AsyncApiBenchmark.Generated.PropertiesValidationHandler_NamedPropertyValidator>([
                (static () => JsonPropertyNames.PercentageUtf8, MatchPercentage),
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/dimCommandPayload"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/dimCommandPayload";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/dimCommandPayload"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyPercentagePresent, "percentage"u8, "required"u8);
                    context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyStreetlightIdPresent, "streetlightId"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForPercentage] & RequiredBitForPercentage) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyPercentageNotPresent, "percentage"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyPercentagePresent, "percentage"u8, "required"u8);
                    ...
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForStreetlightId] & RequiredBitForStreetlightId) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyStreetlightIdNotPresent, "streetlightId"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyStreetlightIdPresent, "streetlightId"u8, "required"u8);
