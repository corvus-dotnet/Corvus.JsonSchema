...
public readonly partial struct DimCommandPayload
{
...
#endif
    {
        ...
        /// <summary>
        /// Gets the <c>percentage</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// <summary>
        /// Gets the <c>streetlightId</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        /// If the instance is valid, this property will not be <see cref="JsonValueKind.Undefined"/>.
        ...
        {
            return
                (obj is IJsonElement value && Equals(new DimCommandPayload(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetPercentage(in AsyncApiBenchmark.Generated.DimCommandPayload.TargetBrightnessPercentage.Source value)
        {
            ...
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("percentage");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PercentageUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Percentage, ref cvb);
        ...
        public void SetStreetlightId(in AsyncApiBenchmark.Generated.DimCommandPayload.TheStreetlightToDim.Source value)
        {
            ...
            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("streetlightId");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StreetlightIdUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.StreetlightId, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DimCommandPayload.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="DimCommandPayload"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="DimCommandPayload"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly DimCommandPayload Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<DimCommandPayload>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="DimCommandPayload"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly DimCommandPayload Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<DimCommandPayload>(_idx);
        }
    }
