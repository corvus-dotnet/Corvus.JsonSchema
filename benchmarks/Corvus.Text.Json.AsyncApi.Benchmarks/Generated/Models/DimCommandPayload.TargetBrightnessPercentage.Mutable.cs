...
public readonly partial struct DimCommandPayload
{
    ...
    public readonly partial struct TargetBrightnessPercentage
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TargetBrightnessPercentage instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TargetBrightnessPercentage"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TargetBrightnessPercentage(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TargetBrightnessPercentage.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly TargetBrightnessPercentage Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TargetBrightnessPercentage Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TargetBrightnessPercentage>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TargetBrightnessPercentage instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TargetBrightnessPercentage, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TargetBrightnessPercentage> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TargetBrightnessPercentage>();
            }
            finally
            {
