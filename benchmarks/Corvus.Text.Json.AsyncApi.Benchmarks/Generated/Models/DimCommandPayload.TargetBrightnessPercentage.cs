...
public readonly partial struct DimCommandPayload
{
    ...
    public readonly partial struct TargetBrightnessPercentage
#if NET8_0_OR_GREATER
        : IJsonElement<TargetBrightnessPercentage>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetBrightnessPercentage"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TargetBrightnessPercentage(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TargetBrightnessPercentage DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator long(TargetBrightnessPercentage value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator double(TargetBrightnessPercentage value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Corvus.Numerics.BigNumber(TargetBrightnessPercentage value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator System.Numerics.BigInteger(TargetBrightnessPercentage value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator decimal(TargetBrightnessPercentage value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in TargetBrightnessPercentage left, in TargetBrightnessPercentage right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TargetBrightnessPercentage left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(TargetBrightnessPercentage instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TargetBrightnessPercentage(JsonElement instance)
        {
            return TargetBrightnessPercentage.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TargetBrightnessPercentage From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TargetBrightnessPercentage ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TargetBrightnessPercentage>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TargetBrightnessPercentage ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TargetBrightnessPercentage>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TargetBrightnessPercentage ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TargetBrightnessPercentage>(json, options);
        }
        ...
        /// </exception>
        public static TargetBrightnessPercentage ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<TargetBrightnessPercentage>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TargetBrightnessPercentage? result)
        {
            return JsonElementHelpers.TryParseValue<TargetBrightnessPercentage>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TargetBrightnessPercentage(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static TargetBrightnessPercentage IJsonElement<TargetBrightnessPercentage>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TargetBrightnessPercentage: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TargetBrightnessPercentage"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TargetBrightnessPercentage"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public TargetBrightnessPercentage Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TargetBrightnessPercentage>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TargetBrightnessPercentage"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public TargetBrightnessPercentage Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TargetBrightnessPercentage>(_idx);
            }
