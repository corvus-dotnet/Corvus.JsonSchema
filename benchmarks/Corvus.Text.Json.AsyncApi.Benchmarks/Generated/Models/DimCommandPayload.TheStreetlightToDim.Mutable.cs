...
public readonly partial struct DimCommandPayload
{
    ...
    public readonly partial struct TheStreetlightToDim
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TheStreetlightToDim instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheStreetlightToDim"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheStreetlightToDim(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheStreetlightToDim.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly TheStreetlightToDim Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TheStreetlightToDim Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheStreetlightToDim>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TheStreetlightToDim instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TheStreetlightToDim, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TheStreetlightToDim> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TheStreetlightToDim>();
            }
            finally
            {
