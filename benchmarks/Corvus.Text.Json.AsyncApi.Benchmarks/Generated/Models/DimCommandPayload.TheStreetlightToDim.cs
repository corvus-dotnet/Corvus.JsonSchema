...
public readonly partial struct DimCommandPayload
{
    ...
    public readonly partial struct TheStreetlightToDim
#if NET8_0_OR_GREATER
        : IJsonElement<TheStreetlightToDim>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// </summary>
        public static TheStreetlightToDim DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator System.Numerics.BigInteger(TheStreetlightToDim value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator decimal(TheStreetlightToDim value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in TheStreetlightToDim left, in TheStreetlightToDim right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TheStreetlightToDim left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        {
            return TheStreetlightToDim.From(instance);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TheStreetlightToDim? result)
        {
            return JsonElementHelpers.TryParseValue<TheStreetlightToDim>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TheStreetlightToDim(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static TheStreetlightToDim IJsonElement<TheStreetlightToDim>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TheStreetlightToDim: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TheStreetlightToDim"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TheStreetlightToDim"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public TheStreetlightToDim Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TheStreetlightToDim>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TheStreetlightToDim"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public TheStreetlightToDim Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TheStreetlightToDim>(_idx);
            }
