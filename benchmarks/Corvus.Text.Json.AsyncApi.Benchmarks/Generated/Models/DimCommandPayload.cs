...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DimCommandPayload"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal DimCommandPayload(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static DimCommandPayload DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in DimCommandPayload left, in DimCommandPayload right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in DimCommandPayload left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(DimCommandPayload instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator DimCommandPayload(JsonElement instance)
    {
        return DimCommandPayload.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DimCommandPayload From<T>(in T instance)
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out DimCommandPayload? result)
    {
        return JsonElementHelpers.TryParseValue<DimCommandPayload>(ref reader, out result);
    }
...
#if NET
    static DimCommandPayload IJsonElement<DimCommandPayload>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"DimCommandPayload: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public DimCommandPayload Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public DimCommandPayload Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<DimCommandPayload>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="Percentage"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="StreetlightId"/>.
        /// </summary>
        public const string StreetlightId = "streetlightId";

        /// <summary>
        /// Gets the JSON property name for <see cref="Percentage"/>.
        /// </summary>
        public static ReadOnlySpan<byte> PercentageUtf8 => "percentage"u8;
        ...
        /// Gets the JSON property name for <see cref="StreetlightId"/>.
        /// </summary>
        public static ReadOnlySpan<byte> StreetlightIdUtf8 => "streetlightId"u8;
    }
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Percentage"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Percentage => "percentage"u8;
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="StreetlightId"/>.
        /// </summary>
        public static ReadOnlySpan<byte> StreetlightId => "streetlightId"u8;
    }
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Percentage"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Percentage => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x70, 0x65, 0x72, 0x63, 0x65, 0x6E, 0x74, 0x61, 0x67, 0x65, 0x22];
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="StreetlightId"/>.
        /// </summary>
        public static ReadOnlySpan<byte> StreetlightId => [0xF5, 0x00, 0x00, 0x00, 0x22, 0x73, 0x74, 0x72, 0x65, 0x65, 0x74, 0x6C, 0x69, 0x67, 0x68, 0x74, 0x49, 0x64, 0x22];
    }
}
