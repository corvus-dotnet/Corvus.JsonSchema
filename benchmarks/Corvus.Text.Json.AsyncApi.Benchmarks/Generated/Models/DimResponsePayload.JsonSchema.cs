...
public readonly partial struct DimResponsePayload
    : IJsonElement<DimResponsePayload>
{
    public static partial class JsonSchema
    {
        ...
        private const uint RequiredBitForStatus = 0b00000000000000000000000000000001;
        ...
        private const uint RequiredBitMask0 =
            RequiredBitForStatus | RequiredBitForStreetlightId;
        private static readonly JsonSchemaPathProvider AppliedPercentageSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/appliedPercentage"u8, buffer, out written);
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/dimResponsePayload"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/dimResponsePayload";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/dimResponsePayload"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyStatusPresent, "status"u8, "required"u8);
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyStatusNotPresent, "status"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyStatusPresent, "status"u8, "required"u8);
