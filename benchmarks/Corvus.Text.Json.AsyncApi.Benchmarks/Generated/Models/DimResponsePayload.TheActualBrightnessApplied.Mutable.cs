...
public readonly partial struct DimResponsePayload
{
    ...
    public readonly partial struct TheActualBrightnessApplied
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TheActualBrightnessApplied instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheActualBrightnessApplied"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheActualBrightnessApplied(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new TheActualBrightnessApplied(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheActualBrightnessApplied.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="TheActualBrightnessApplied"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TheActualBrightnessApplied"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly TheActualBrightnessApplied Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TheActualBrightnessApplied>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TheActualBrightnessApplied"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly TheActualBrightnessApplied Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheActualBrightnessApplied>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TheActualBrightnessApplied instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TheActualBrightnessApplied, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TheActualBrightnessApplied> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TheActualBrightnessApplied>();
            }
            finally
            {
