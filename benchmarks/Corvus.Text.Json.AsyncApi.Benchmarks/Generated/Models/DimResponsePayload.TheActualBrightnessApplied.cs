...
public readonly partial struct DimResponsePayload
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TheActualBrightnessApplied"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TheActualBrightnessApplied(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TheActualBrightnessApplied DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator long(TheActualBrightnessApplied value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator double(TheActualBrightnessApplied value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Corvus.Numerics.BigNumber(TheActualBrightnessApplied value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator System.Numerics.BigInteger(TheActualBrightnessApplied value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator decimal(TheActualBrightnessApplied value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in TheActualBrightnessApplied left, in TheActualBrightnessApplied right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TheActualBrightnessApplied left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(TheActualBrightnessApplied instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TheActualBrightnessApplied(JsonElement instance)
        {
            return TheActualBrightnessApplied.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheActualBrightnessApplied From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheActualBrightnessApplied ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TheActualBrightnessApplied>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheActualBrightnessApplied ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TheActualBrightnessApplied>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheActualBrightnessApplied ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TheActualBrightnessApplied>(json, options);
        }
        ...
        /// </exception>
        public static TheActualBrightnessApplied ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<TheActualBrightnessApplied>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TheActualBrightnessApplied? result)
        {
            return JsonElementHelpers.TryParseValue<TheActualBrightnessApplied>(ref reader, out result);
        }
...
#if NET
        static TheActualBrightnessApplied IJsonElement<TheActualBrightnessApplied>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TheActualBrightnessApplied: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public TheActualBrightnessApplied Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public TheActualBrightnessApplied Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TheActualBrightnessApplied>(_idx);
            }
