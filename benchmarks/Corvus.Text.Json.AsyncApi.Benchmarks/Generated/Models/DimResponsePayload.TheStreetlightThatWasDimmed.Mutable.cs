...
public readonly partial struct DimResponsePayload
{
    ...
    public readonly partial struct TheStreetlightThatWasDimmed
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TheStreetlightThatWasDimmed instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheStreetlightThatWasDimmed"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheStreetlightThatWasDimmed(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheStreetlightThatWasDimmed.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly TheStreetlightThatWasDimmed Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TheStreetlightThatWasDimmed Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheStreetlightThatWasDimmed>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TheStreetlightThatWasDimmed instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TheStreetlightThatWasDimmed, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TheStreetlightThatWasDimmed> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TheStreetlightThatWasDimmed>();
            }
            finally
            {
