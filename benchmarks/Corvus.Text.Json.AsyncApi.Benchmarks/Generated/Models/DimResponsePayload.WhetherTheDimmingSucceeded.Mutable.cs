...
public readonly partial struct DimResponsePayload
{
    ...
    public readonly partial struct WhetherTheDimmingSucceeded
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(WhetherTheDimmingSucceeded instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="WhetherTheDimmingSucceeded"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator WhetherTheDimmingSucceeded(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new WhetherTheDimmingSucceeded(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"WhetherTheDimmingSucceeded.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="WhetherTheDimmingSucceeded"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="WhetherTheDimmingSucceeded"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly WhetherTheDimmingSucceeded Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<WhetherTheDimmingSucceeded>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="WhetherTheDimmingSucceeded"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly WhetherTheDimmingSucceeded Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<WhetherTheDimmingSucceeded>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(WhetherTheDimmingSucceeded instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<WhetherTheDimmingSucceeded, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<WhetherTheDimmingSucceeded> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<WhetherTheDimmingSucceeded>();
            }
            finally
            {
