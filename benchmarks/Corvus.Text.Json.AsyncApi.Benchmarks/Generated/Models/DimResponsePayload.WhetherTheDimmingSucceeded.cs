...
public readonly partial struct DimResponsePayload
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WhetherTheDimmingSucceeded"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal WhetherTheDimmingSucceeded(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static WhetherTheDimmingSucceeded DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(WhetherTheDimmingSucceeded value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in WhetherTheDimmingSucceeded left, in WhetherTheDimmingSucceeded right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in WhetherTheDimmingSucceeded left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(WhetherTheDimmingSucceeded instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator WhetherTheDimmingSucceeded(JsonElement instance)
        {
            return WhetherTheDimmingSucceeded.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WhetherTheDimmingSucceeded From<T>(in T instance)
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out WhetherTheDimmingSucceeded? result)
        {
            return JsonElementHelpers.TryParseValue<WhetherTheDimmingSucceeded>(ref reader, out result);
        }
...
#if NET
        static WhetherTheDimmingSucceeded IJsonElement<WhetherTheDimmingSucceeded>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"WhetherTheDimmingSucceeded: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public WhetherTheDimmingSucceeded Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public WhetherTheDimmingSucceeded Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<WhetherTheDimmingSucceeded>(_idx);
            }
