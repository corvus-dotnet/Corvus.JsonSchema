...
#endif
{
    ...
    /// </summary>
    public static DimResponsePayload DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in DimResponsePayload left, in DimResponsePayload right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in DimResponsePayload left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    {
        return DimResponsePayload.From(instance);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out DimResponsePayload? result)
    {
        return JsonElementHelpers.TryParseValue<DimResponsePayload>(ref reader, out result);
    }
...
#if NET
    static DimResponsePayload IJsonElement<DimResponsePayload>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"DimResponsePayload: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public DimResponsePayload Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public DimResponsePayload Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<DimResponsePayload>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="AppliedPercentage"/>.
        /// </summary>
        public const string AppliedPercentage = "appliedPercentage";
        ...
        /// Gets the JSON property name for <see cref="AppliedPercentage"/>.
        /// </summary>
        public static ReadOnlySpan<byte> AppliedPercentageUtf8 => "appliedPercentage"u8;
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="AppliedPercentage"/>.
        /// </summary>
        public static ReadOnlySpan<byte> AppliedPercentage => "appliedPercentage"u8;
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="AppliedPercentage"/>.
        /// </summary>
        public static ReadOnlySpan<byte> AppliedPercentage => [0x35, 0x01, 0x00, 0x00, 0x22, 0x61, 0x70, 0x70, 0x6C, 0x69, 0x65, 0x64, 0x50, 0x65, 0x72, 0x63, 0x65, 0x6E, 0x74, 0x61, 0x67, 0x65, 0x22];
