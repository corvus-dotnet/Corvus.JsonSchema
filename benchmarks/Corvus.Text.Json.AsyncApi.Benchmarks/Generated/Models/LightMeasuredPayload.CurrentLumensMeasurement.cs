...
public readonly partial struct LightMeasuredPayload
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CurrentLumensMeasurement"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal CurrentLumensMeasurement(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static CurrentLumensMeasurement DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator long(CurrentLumensMeasurement value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double(CurrentLumensMeasurement value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Corvus.Numerics.BigNumber(CurrentLumensMeasurement value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator System.Numerics.BigInteger(CurrentLumensMeasurement value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator decimal(CurrentLumensMeasurement value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in CurrentLumensMeasurement left, in CurrentLumensMeasurement right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in CurrentLumensMeasurement left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(CurrentLumensMeasurement instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator CurrentLumensMeasurement(JsonElement instance)
        {
            return CurrentLumensMeasurement.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CurrentLumensMeasurement From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CurrentLumensMeasurement ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CurrentLumensMeasurement>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CurrentLumensMeasurement ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CurrentLumensMeasurement>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CurrentLumensMeasurement ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CurrentLumensMeasurement>(json, options);
        }
        ...
        /// </exception>
        public static CurrentLumensMeasurement ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<CurrentLumensMeasurement>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out CurrentLumensMeasurement? result)
        {
            return JsonElementHelpers.TryParseValue<CurrentLumensMeasurement>(ref reader, out result);
        }
...
#if NET
        static CurrentLumensMeasurement IJsonElement<CurrentLumensMeasurement>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"CurrentLumensMeasurement: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public CurrentLumensMeasurement Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public CurrentLumensMeasurement Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<CurrentLumensMeasurement>(_idx);
            }
