...
public readonly partial struct LightMeasuredPayload
{
...
#endif
    {
        ...
        public void SetLumens(in AsyncApiBenchmark.LightMeasuredPayload.CurrentLumensMeasurement.Source value)
        {
            ...
            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("lumens");
            }
        ...
        public void SetSentAt(in AsyncApiBenchmark.JsonDateTime.Source value)
        {
            ...
            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("sentAt");
            }
