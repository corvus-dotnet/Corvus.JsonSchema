...
public readonly partial struct LightMeasuredPayload
{
    ...
    public readonly partial struct SensorId
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(SensorId instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SensorId"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SensorId(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SensorId.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly SensorId Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly SensorId Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SensorId>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(SensorId instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<SensorId, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<SensorId> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SensorId>();
            }
            finally
            {
