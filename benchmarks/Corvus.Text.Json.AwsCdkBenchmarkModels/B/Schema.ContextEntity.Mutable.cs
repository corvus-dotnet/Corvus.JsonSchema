...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ContextEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ContextEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ContextEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ContextEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ContextEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ContextEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ContextEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ContextEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ContextEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ContextEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ContextEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ContextEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ContextEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.AwsCdkBenchmark.Baseline.Schema.ContextEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(ContextEntity instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.AwsCdkBenchmark.Baseline.Schema.ContextEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<ContextEntity, Mutable>(this);
        }
    }
}
