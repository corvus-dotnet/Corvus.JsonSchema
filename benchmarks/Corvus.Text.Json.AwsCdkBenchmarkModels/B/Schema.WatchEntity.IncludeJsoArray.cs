...
public readonly partial struct Schema
{
    ...
    public readonly partial struct WatchEntity
    {
...
#endif
        {
            ...
            public Corvus.AwsCdkBenchmark.Baseline.JsonString this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.AwsCdkBenchmark.Baseline.JsonString>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.AwsCdkBenchmark.Baseline.JsonString> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.AwsCdkBenchmark.Baseline.JsonString>(_parent, _idx);
            }
