...
#endif
{
    ...
    /// </summary>
    public Corvus.AwsCdkBenchmark.Baseline.Schema.AppEntity App
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AppUtf8, out Corvus.AwsCdkBenchmark.Baseline.Schema.AppEntity value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.AwsCdkBenchmark.Baseline.JsonString BuildValue
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BuildValueUtf8, out Corvus.AwsCdkBenchmark.Baseline.JsonString value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.AwsCdkBenchmark.Baseline.Schema.ContextEntity Context
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContextUtf8, out Corvus.AwsCdkBenchmark.Baseline.Schema.ContextEntity value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.AwsCdkBenchmark.Baseline.JsonBoolean VersionReporting
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionReportingUtf8, out Corvus.AwsCdkBenchmark.Baseline.JsonBoolean value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.AwsCdkBenchmark.Baseline.Schema.WatchEntity Watch
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WatchUtf8, out Corvus.AwsCdkBenchmark.Baseline.Schema.WatchEntity value))
            {
                return value;
            }
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="VersionReporting"/>.
        /// </summary>
        public const string VersionReporting = "versionReporting";
        ...
        /// Gets the JSON property name for <see cref="VersionReporting"/>.
        /// </summary>
        public static ReadOnlySpan<byte> VersionReportingUtf8 => "versionReporting"u8;
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="VersionReporting"/>.
        /// </summary>
        public static ReadOnlySpan<byte> VersionReporting => "versionReporting"u8;
