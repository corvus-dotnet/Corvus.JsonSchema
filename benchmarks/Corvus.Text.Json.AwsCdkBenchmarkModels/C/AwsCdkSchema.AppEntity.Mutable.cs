...
public readonly partial struct AwsCdkSchema
{
    ...
    public readonly partial struct AppEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(AppEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="AppEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AppEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AppEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly AppEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly AppEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<AppEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(AppEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<AppEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<AppEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<AppEntity>();
            }
            finally
            {
