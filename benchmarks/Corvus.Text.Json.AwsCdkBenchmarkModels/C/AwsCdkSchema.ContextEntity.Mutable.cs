...
public readonly partial struct AwsCdkSchema
{
    ...
    public readonly partial struct ContextEntity
    {
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.ContextEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.ContextEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
