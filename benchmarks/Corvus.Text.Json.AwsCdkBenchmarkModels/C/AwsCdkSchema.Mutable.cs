...
public readonly partial struct AwsCdkSchema
{
...
#endif
    {
        ...
        public static explicit operator Mutable(AwsCdkSchema instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="AwsCdkSchema"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AwsCdkSchema(Mutable instance)
        {
        ...
        /// </summary>
        public Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.AppEntity.Mutable App
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AppUtf8, out Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.AppEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.AwsCdkBenchmark.Current.JsonString.Mutable BuildValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BuildValueUtf8, out Corvus.AwsCdkBenchmark.Current.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.AwsCdkBenchmark.Current.JsonBoolean.Mutable VersionReporting
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionReportingUtf8, out Corvus.AwsCdkBenchmark.Current.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.Mutable Watch
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WatchUtf8, out Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AwsCdkSchema(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetWatch<TContext>(in Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AwsCdkSchema.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AwsCdkSchema"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AwsCdkSchema"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly AwsCdkSchema Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AwsCdkSchema>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AwsCdkSchema"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly AwsCdkSchema Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<AwsCdkSchema>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.AppEntity.Source _createArg1;
        private readonly Corvus.AwsCdkBenchmark.Current.JsonString.Source _createArg2;
        private readonly Corvus.AwsCdkBenchmark.Current.JsonObject.Source _createArg3;
        private readonly Corvus.AwsCdkBenchmark.Current.JsonBoolean.Source _createArg4;
        private readonly Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.Source _createArg5;
        ...
        public static implicit operator Source(AwsCdkSchema instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.AppEntity.Source _createArg1;
        private readonly Corvus.AwsCdkBenchmark.Current.JsonString.Source _createArg2;
        private readonly Corvus.AwsCdkBenchmark.Current.JsonObject.Source<TContext> _createArg3;
        private readonly Corvus.AwsCdkBenchmark.Current.JsonBoolean.Source _createArg4;
        private readonly Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.Source<TContext> _createArg5;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="AwsCdkSchema"/>.
        /// </summary>
    ...
    /// </summary>
    /// <param name="app">The value of the <c>"app"</c> property.</param>
    /// <param name="build">The value of the <c>"build"</c> property.</param>
    ...
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.AppEntity.Source app = default, scoped in Corvus.AwsCdkBenchmark.Current.JsonString.Source build = default, scoped in Corvus.AwsCdkBenchmark.Current.JsonObject.Source<TContext> context1 = default, scoped in Corvus.AwsCdkBenchmark.Current.JsonBoolean.Source versionReporting = default, scoped in Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.Source<TContext> watch = default)
        ...
        #endif
    {
        return new Source<TContext>(context, app, build, context1, versionReporting, watch);
    }
    ...
    {
        return workspace.CreateBuilder<AwsCdkSchema, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<AwsCdkSchema> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<AwsCdkSchema>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<AwsCdkSchema> Create<TContext>(
    ...
    public static ParsedJsonDocument<AwsCdkSchema> Create(in Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.AppEntity.Source app = default, in Corvus.AwsCdkBenchmark.Current.JsonString.Source build = default, in Corvus.AwsCdkBenchmark.Current.JsonObject.Source context = default, in Corvus.AwsCdkBenchmark.Current.JsonBoolean.Source versionReporting = default, in Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.Source watch = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<AwsCdkSchema> Create<TContext>(in TContext context, in Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.AppEntity.Source app = default, in Corvus.AwsCdkBenchmark.Current.JsonString.Source build = default, in Corvus.AwsCdkBenchmark.Current.JsonObject.Source<TContext> context1 = default, in Corvus.AwsCdkBenchmark.Current.JsonBoolean.Source versionReporting = default, in Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.Source<TContext> watch = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
