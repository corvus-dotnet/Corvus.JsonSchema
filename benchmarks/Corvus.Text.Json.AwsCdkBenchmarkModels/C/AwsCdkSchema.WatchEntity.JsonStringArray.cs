...
public readonly partial struct AwsCdkSchema
{
    ...
    public readonly partial struct WatchEntity
    {
...
#endif
        {
            ...
            public Corvus.AwsCdkBenchmark.Current.JsonString this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.AwsCdkBenchmark.Current.JsonString>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.AwsCdkBenchmark.Current.JsonString> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.AwsCdkBenchmark.Current.JsonString>(_parent, _idx);
            }
