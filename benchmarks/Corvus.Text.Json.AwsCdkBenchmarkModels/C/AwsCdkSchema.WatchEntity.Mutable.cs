...
public readonly partial struct AwsCdkSchema
{
    ...
    public readonly partial struct WatchEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(WatchEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="WatchEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator WatchEntity(Mutable instance)
            {
            ...
            /// </summary>
            public Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.JsonStringArray.Mutable Exclude
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludeUtf8, out Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.JsonStringArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.IncludeJsoArray.Mutable Include
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeUtf8, out Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.IncludeJsoArray.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new WatchEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetExclude<TContext>(in Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.JsonStringArray.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetInclude<TContext>(in Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.IncludeJsoArray.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"WatchEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="WatchEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="WatchEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly WatchEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<WatchEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="WatchEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly WatchEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<WatchEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.JsonStringArray.Source _createArg1;
            private readonly Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.IncludeJsoArray.Source _createArg2;
            ...
            public static implicit operator Source(WatchEntity instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.JsonStringArray.Source<TContext> _createArg1;
            private readonly Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.IncludeJsoArray.Source<TContext> _createArg2;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="WatchEntity"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.JsonStringArray.Source exclude = default,
                in Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.IncludeJsoArray.Source include = default)
            {
            ...
            /// Creates an instance of a <see cref="WatchEntity"/>.
            /// </summary>
            public void Create(in Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.JsonStringArray.Source exclude = default, in Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.IncludeJsoArray.Source include = default)
            {
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.JsonStringArray.Source<TContext> exclude = default,
                in Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.IncludeJsoArray.Source<TContext> include = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.JsonStringArray.Source exclude = default, in Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.IncludeJsoArray.Source include = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.JsonStringArray.Source<TContext> exclude = default, in Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.IncludeJsoArray.Source<TContext> include = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        {
            return workspace.CreateBuilder<WatchEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<WatchEntity> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<WatchEntity>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<WatchEntity> Create<TContext>(
        ...
        public static ParsedJsonDocument<WatchEntity> Create(in Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.JsonStringArray.Source exclude = default, in Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.IncludeJsoArray.Source include = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<WatchEntity> Create<TContext>(in TContext context, in Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.JsonStringArray.Source<TContext> exclude = default, in Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.IncludeJsoArray.Source<TContext> include = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
