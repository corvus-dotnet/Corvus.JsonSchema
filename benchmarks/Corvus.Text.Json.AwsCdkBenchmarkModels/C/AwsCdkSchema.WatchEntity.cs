...
public readonly partial struct AwsCdkSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WatchEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal WatchEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static WatchEntity DefaultInstance { get; }
        ...
        /// </summary>
        public Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.JsonStringArray Exclude
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludeUtf8, out Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.JsonStringArray value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.IncludeJsoArray Include
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeUtf8, out Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity.IncludeJsoArray value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in WatchEntity left, in WatchEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in WatchEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(WatchEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator WatchEntity(JsonElement instance)
        {
            return WatchEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WatchEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WatchEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<WatchEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WatchEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<WatchEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WatchEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<WatchEntity>(json, options);
        }
        ...
        /// </exception>
        public static WatchEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<WatchEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out WatchEntity? result)
        {
            return JsonElementHelpers.TryParseValue<WatchEntity>(ref reader, out result);
        }
...
#if NET
        static WatchEntity IJsonElement<WatchEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"WatchEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
