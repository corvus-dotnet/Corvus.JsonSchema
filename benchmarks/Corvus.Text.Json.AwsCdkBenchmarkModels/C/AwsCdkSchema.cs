...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AwsCdkSchema"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal AwsCdkSchema(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static AwsCdkSchema DefaultInstance { get; }
    ...
    /// </summary>
    public Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.AppEntity App
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AppUtf8, out Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.AppEntity value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.AwsCdkBenchmark.Current.JsonString BuildValue
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BuildValueUtf8, out Corvus.AwsCdkBenchmark.Current.JsonString value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.AwsCdkBenchmark.Current.JsonBoolean VersionReporting
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionReportingUtf8, out Corvus.AwsCdkBenchmark.Current.JsonBoolean value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity Watch
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WatchUtf8, out Corvus.AwsCdkBenchmark.Current.AwsCdkSchema.WatchEntity value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in AwsCdkSchema left, in AwsCdkSchema right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in AwsCdkSchema left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(AwsCdkSchema instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator AwsCdkSchema(JsonElement instance)
    {
        return AwsCdkSchema.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AwsCdkSchema From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AwsCdkSchema ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<AwsCdkSchema>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AwsCdkSchema ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<AwsCdkSchema>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AwsCdkSchema ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<AwsCdkSchema>(json, options);
    }
    ...
    /// </exception>
    public static AwsCdkSchema ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<AwsCdkSchema>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out AwsCdkSchema? result)
    {
        return JsonElementHelpers.TryParseValue<AwsCdkSchema>(ref reader, out result);
    }
...
#if NET
    static AwsCdkSchema IJsonElement<AwsCdkSchema>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"AwsCdkSchema: ValueKind = {ValueKind} : \"{ToString()}\"";
