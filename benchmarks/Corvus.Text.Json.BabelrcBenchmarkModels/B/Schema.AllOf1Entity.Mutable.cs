...
public readonly partial struct Schema
{
    ...
    public readonly partial struct AllOf1Entity
    {
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.BabelrcBenchmark.Baseline.Schema.AllOf1Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.BabelrcBenchmark.Baseline.Schema.AllOf1Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.BabelrcBenchmark.Baseline.Schema.AllOf1Entity.EnvEntity.Source env = default)
            {
            ...
            /// Creates an instance of a <see cref="AllOf1Entity"/>.
            /// </summary>
            public void Create(in Corvus.BabelrcBenchmark.Baseline.Schema.AllOf1Entity.EnvEntity.Source env = default)
            {
            ...
            /// Creates an instance of a <see cref="AllOf1Entity"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.BabelrcBenchmark.Baseline.Schema.AllOf1Entity.EnvEntity.Source<TContext> env = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.BabelrcBenchmark.Baseline.Schema.AllOf1Entity.EnvEntity.Source env = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.BabelrcBenchmark.Baseline.Schema.AllOf1Entity.EnvEntity.Source<TContext> env = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
