...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Options
    {
        ...
        public readonly partial struct FilenameForUseInErrorsEtc
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(FilenameForUseInErrorsEtc instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="FilenameForUseInErrorsEtc"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FilenameForUseInErrorsEtc(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new FilenameForUseInErrorsEtc(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FilenameForUseInErrorsEtc.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="FilenameForUseInErrorsEtc"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="FilenameForUseInErrorsEtc"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly FilenameForUseInErrorsEtc Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<FilenameForUseInErrorsEtc>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="FilenameForUseInErrorsEtc"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly FilenameForUseInErrorsEtc Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<FilenameForUseInErrorsEtc>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(FilenameForUseInErrorsEtc instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<FilenameForUseInErrorsEtc, Mutable>(this);
            }
        }
    }
}
