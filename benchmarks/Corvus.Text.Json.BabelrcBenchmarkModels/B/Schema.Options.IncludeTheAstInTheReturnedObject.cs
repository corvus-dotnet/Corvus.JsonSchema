...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Options
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="IncludeTheAstInTheReturnedObject"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal IncludeTheAstInTheReturnedObject(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static IncludeTheAstInTheReturnedObject DefaultInstance { get; } = ParsedJsonDocument<IncludeTheAstInTheReturnedObject>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(IncludeTheAstInTheReturnedObject value)
            {
            ...
            /// </returns>
            public static bool operator ==(in IncludeTheAstInTheReturnedObject left, in IncludeTheAstInTheReturnedObject right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in IncludeTheAstInTheReturnedObject left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(IncludeTheAstInTheReturnedObject instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator IncludeTheAstInTheReturnedObject(JsonElement instance)
            {
                return IncludeTheAstInTheReturnedObject.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IncludeTheAstInTheReturnedObject From<T>(in T instance)
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out IncludeTheAstInTheReturnedObject? result)
            {
                return JsonElementHelpers.TryParseValue<IncludeTheAstInTheReturnedObject>(ref reader, out result);
            }
...
#if NET
            static IncludeTheAstInTheReturnedObject IJsonElement<IncludeTheAstInTheReturnedObject>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"IncludeTheAstInTheReturnedObject: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public IncludeTheAstInTheReturnedObject Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public IncludeTheAstInTheReturnedObject Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<IncludeTheAstInTheReturnedObject>(_idx);
                }
