...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Options
    {
        ...
        public readonly partial struct OppositeOfTheOnlyOption
#if NET8_0_OR_GREATER
            : IJsonElement<OppositeOfTheOnlyOption>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="OppositeOfTheOnlyOption"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal OppositeOfTheOnlyOption(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static OppositeOfTheOnlyOption DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(OppositeOfTheOnlyOption value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in OppositeOfTheOnlyOption left, in OppositeOfTheOnlyOption right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in OppositeOfTheOnlyOption left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(OppositeOfTheOnlyOption instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OppositeOfTheOnlyOption(JsonElement instance)
            {
                return OppositeOfTheOnlyOption.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OppositeOfTheOnlyOption From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OppositeOfTheOnlyOption ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OppositeOfTheOnlyOption>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OppositeOfTheOnlyOption ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OppositeOfTheOnlyOption>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OppositeOfTheOnlyOption ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OppositeOfTheOnlyOption>(json, options);
            }
            ...
            /// </exception>
            public static OppositeOfTheOnlyOption ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<OppositeOfTheOnlyOption>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out OppositeOfTheOnlyOption? result)
            {
                return JsonElementHelpers.TryParseValue<OppositeOfTheOnlyOption>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new OppositeOfTheOnlyOption(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static OppositeOfTheOnlyOption IJsonElement<OppositeOfTheOnlyOption>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OppositeOfTheOnlyOption: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="OppositeOfTheOnlyOption"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="OppositeOfTheOnlyOption"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public OppositeOfTheOnlyOption Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<OppositeOfTheOnlyOption>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="OppositeOfTheOnlyOption"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public OppositeOfTheOnlyOption Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<OppositeOfTheOnlyOption>(_idx);
                }
