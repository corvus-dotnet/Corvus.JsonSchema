...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Options
    {
        ...
        public readonly partial struct PluginsArrayArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PluginsArrayArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PluginsArrayArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PluginsArrayArray(Mutable instance)
                {
                ...
                public Corvus.BabelrcBenchmark.Baseline.Schema.Options.PluginsArrayArray.PluginsArray.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.BabelrcBenchmark.Baseline.Schema.Options.PluginsArrayArray.PluginsArray.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.BabelrcBenchmark.Baseline.Schema.Options.PluginsArrayArray.PluginsArray.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.BabelrcBenchmark.Baseline.Schema.Options.PluginsArrayArray.PluginsArray.Mutable>(_parent, _idx);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new PluginsArrayArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PluginsArrayArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.BabelrcBenchmark.Baseline.Schema.Options.PluginsArrayArray.PluginsArray.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, in Corvus.BabelrcBenchmark.Baseline.Schema.Options.PluginsArrayArray.PluginsArray.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(in Corvus.BabelrcBenchmark.Baseline.Schema.Options.PluginsArrayArray.PluginsArray.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.BabelrcBenchmark.Baseline.Schema.Options.PluginsArrayArray.PluginsArray item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.BabelrcBenchmark.Baseline.Schema.Options.PluginsArrayArray.PluginsArray>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.BabelrcBenchmark.Baseline.Schema.Options.PluginsArrayArray.PluginsArray> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.BabelrcBenchmark.Baseline.Schema.Options.PluginsArrayArray.PluginsArray>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.BabelrcBenchmark.Baseline.Schema.Options.PluginsArrayArray.PluginsArray oldItem, in Corvus.BabelrcBenchmark.Baseline.Schema.Options.PluginsArrayArray.PluginsArray.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.BabelrcBenchmark.Baseline.Schema.Options.PluginsArrayArray.PluginsArray>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.BabelrcBenchmark.Baseline.Schema.Options.PluginsArrayArray.PluginsArray current = enumerator.Current;
                ...
                /// <summary>
                /// Gets a <see cref="PluginsArrayArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="PluginsArrayArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly PluginsArrayArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<PluginsArrayArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="PluginsArrayArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly PluginsArrayArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PluginsArrayArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.BabelrcBenchmark.Baseline.Schema.Options.PluginsArrayArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(PluginsArrayArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.BabelrcBenchmark.Baseline.Schema.Options.PluginsArrayArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<PluginsArrayArray, Mutable>(this);
            }
        }
    }
}
