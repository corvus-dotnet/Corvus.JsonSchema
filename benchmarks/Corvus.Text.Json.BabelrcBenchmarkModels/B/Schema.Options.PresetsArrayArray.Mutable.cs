...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Options
    {
        ...
        public readonly partial struct PresetsArrayArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PresetsArrayArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PresetsArrayArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PresetsArrayArray(Mutable instance)
                {
                ...
                public Corvus.BabelrcBenchmark.Baseline.Schema.Options.PresetsArrayArray.PresetsArray.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.BabelrcBenchmark.Baseline.Schema.Options.PresetsArrayArray.PresetsArray.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.BabelrcBenchmark.Baseline.Schema.Options.PresetsArrayArray.PresetsArray.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.BabelrcBenchmark.Baseline.Schema.Options.PresetsArrayArray.PresetsArray.Mutable>(_parent, _idx);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new PresetsArrayArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PresetsArrayArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.BabelrcBenchmark.Baseline.Schema.Options.PresetsArrayArray.PresetsArray.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, in Corvus.BabelrcBenchmark.Baseline.Schema.Options.PresetsArrayArray.PresetsArray.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(in Corvus.BabelrcBenchmark.Baseline.Schema.Options.PresetsArrayArray.PresetsArray.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.BabelrcBenchmark.Baseline.Schema.Options.PresetsArrayArray.PresetsArray item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.BabelrcBenchmark.Baseline.Schema.Options.PresetsArrayArray.PresetsArray>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.BabelrcBenchmark.Baseline.Schema.Options.PresetsArrayArray.PresetsArray> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.BabelrcBenchmark.Baseline.Schema.Options.PresetsArrayArray.PresetsArray>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.BabelrcBenchmark.Baseline.Schema.Options.PresetsArrayArray.PresetsArray oldItem, in Corvus.BabelrcBenchmark.Baseline.Schema.Options.PresetsArrayArray.PresetsArray.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.BabelrcBenchmark.Baseline.Schema.Options.PresetsArrayArray.PresetsArray>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.BabelrcBenchmark.Baseline.Schema.Options.PresetsArrayArray.PresetsArray current = enumerator.Current;
                ...
                /// <summary>
                /// Gets a <see cref="PresetsArrayArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="PresetsArrayArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly PresetsArrayArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<PresetsArrayArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="PresetsArrayArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly PresetsArrayArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PresetsArrayArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.BabelrcBenchmark.Baseline.Schema.Options.PresetsArrayArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(PresetsArrayArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.BabelrcBenchmark.Baseline.Schema.Options.PresetsArrayArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<PresetsArrayArray, Mutable>(this);
            }
        }
    }
}
