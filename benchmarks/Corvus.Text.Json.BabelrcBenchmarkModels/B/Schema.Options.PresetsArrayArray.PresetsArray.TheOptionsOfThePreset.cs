    ...
    public readonly partial struct Options
    {
        ...
        public readonly partial struct PresetsArrayArray
        {
            ...
            public readonly partial struct PresetsArray
            {
                ...
                public readonly partial struct TheOptionsOfThePreset
#if NET8_0_OR_GREATER
                    : IJsonElement<TheOptionsOfThePreset>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="TheOptionsOfThePreset"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal TheOptionsOfThePreset(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static TheOptionsOfThePreset DefaultInstance { get; }
                    ...
                    /// </returns>
                    public static bool operator ==(in TheOptionsOfThePreset left, in TheOptionsOfThePreset right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in TheOptionsOfThePreset left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(TheOptionsOfThePreset instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TheOptionsOfThePreset(JsonElement instance)
                    {
                        return TheOptionsOfThePreset.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static TheOptionsOfThePreset From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static TheOptionsOfThePreset ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<TheOptionsOfThePreset>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static TheOptionsOfThePreset ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<TheOptionsOfThePreset>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static TheOptionsOfThePreset ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<TheOptionsOfThePreset>(json, options);
                    }
                    ...
                    /// </exception>
                    public static TheOptionsOfThePreset ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<TheOptionsOfThePreset>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out TheOptionsOfThePreset? result)
                    {
                        return JsonElementHelpers.TryParseValue<TheOptionsOfThePreset>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new TheOptionsOfThePreset(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static TheOptionsOfThePreset IJsonElement<TheOptionsOfThePreset>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TheOptionsOfThePreset: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="TheOptionsOfThePreset"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="TheOptionsOfThePreset"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public TheOptionsOfThePreset Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<TheOptionsOfThePreset>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="TheOptionsOfThePreset"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public TheOptionsOfThePreset Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<TheOptionsOfThePreset>(_idx);
                        }
