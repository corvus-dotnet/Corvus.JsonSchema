...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Options
    {
...
#endif
        {
            ...
            public Corvus.BabelrcBenchmark.Baseline.Schema.Options.PresetsArrayArray.PresetsArray this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.BabelrcBenchmark.Baseline.Schema.Options.PresetsArrayArray.PresetsArray>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.BabelrcBenchmark.Baseline.Schema.Options.PresetsArrayArray.PresetsArray> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.BabelrcBenchmark.Baseline.Schema.Options.PresetsArrayArray.PresetsArray>(_parent, _idx);
            }
