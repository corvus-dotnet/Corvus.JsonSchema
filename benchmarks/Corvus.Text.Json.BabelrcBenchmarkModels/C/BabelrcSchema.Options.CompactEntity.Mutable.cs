    ...
    public readonly partial struct Options
    {
        ...
        public readonly partial struct CompactEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<CompactEntity, Mutable>(CompactEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(CompactEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CompactEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CompactEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new CompactEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CompactEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="CompactEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="CompactEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly CompactEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<CompactEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="CompactEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly CompactEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CompactEntity>(_idx);
                }
                ...
                /// <param name="matchTrue">Match 2nd item.</param>
                /// <param name="matchFalse">Match 3rd item.</param>
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(CompactEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<CompactEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<CompactEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<CompactEntity>();
                }
                finally
                {
