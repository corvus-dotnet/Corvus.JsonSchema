...
public readonly partial struct BabelrcSchema
{
    ...
    public readonly partial struct Options
    {
        ...
        public readonly partial struct EnableCodeGeneration
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnableCodeGeneration, Mutable>(EnableCodeGeneration.DefaultInstance);
                ...
                public static explicit operator Mutable(EnableCodeGeneration instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EnableCodeGeneration"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EnableCodeGeneration(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new EnableCodeGeneration(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EnableCodeGeneration.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="EnableCodeGeneration"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="EnableCodeGeneration"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly EnableCodeGeneration Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<EnableCodeGeneration>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="EnableCodeGeneration"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly EnableCodeGeneration Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EnableCodeGeneration>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(EnableCodeGeneration instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<EnableCodeGeneration, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<EnableCodeGeneration> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EnableCodeGeneration>();
                }
                finally
                {
