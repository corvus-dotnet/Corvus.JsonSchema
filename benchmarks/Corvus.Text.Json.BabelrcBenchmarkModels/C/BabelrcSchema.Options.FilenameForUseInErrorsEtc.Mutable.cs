    ...
    public readonly partial struct Options
    {
        ...
        public readonly partial struct FilenameForUseInErrorsEtc
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<FilenameForUseInErrorsEtc, Mutable>(FilenameForUseInErrorsEtc.DefaultInstance);
            ...
            public static ParsedJsonDocument<FilenameForUseInErrorsEtc> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<FilenameForUseInErrorsEtc>();
                }
                finally
                {
