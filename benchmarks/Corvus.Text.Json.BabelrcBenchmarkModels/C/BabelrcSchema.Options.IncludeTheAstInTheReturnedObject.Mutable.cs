    ...
    public readonly partial struct Options
    {
        ...
        public readonly partial struct IncludeTheAstInTheReturnedObject
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<IncludeTheAstInTheReturnedObject, Mutable>(IncludeTheAstInTheReturnedObject.DefaultInstance);
                ...
                public static explicit operator Mutable(IncludeTheAstInTheReturnedObject instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="IncludeTheAstInTheReturnedObject"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IncludeTheAstInTheReturnedObject(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new IncludeTheAstInTheReturnedObject(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IncludeTheAstInTheReturnedObject.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="IncludeTheAstInTheReturnedObject"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="IncludeTheAstInTheReturnedObject"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly IncludeTheAstInTheReturnedObject Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<IncludeTheAstInTheReturnedObject>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="IncludeTheAstInTheReturnedObject"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly IncludeTheAstInTheReturnedObject Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<IncludeTheAstInTheReturnedObject>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(IncludeTheAstInTheReturnedObject instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<IncludeTheAstInTheReturnedObject, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<IncludeTheAstInTheReturnedObject> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<IncludeTheAstInTheReturnedObject>();
                }
                finally
                {
