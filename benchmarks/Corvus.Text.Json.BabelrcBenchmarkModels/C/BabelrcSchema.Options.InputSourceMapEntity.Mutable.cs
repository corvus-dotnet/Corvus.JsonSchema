    ...
    public readonly partial struct Options
    {
        ...
        public readonly partial struct InputSourceMapEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<InputSourceMapEntity, Mutable>(InputSourceMapEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(InputSourceMapEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="InputSourceMapEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator InputSourceMapEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"InputSourceMapEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly InputSourceMapEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly InputSourceMapEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<InputSourceMapEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.InputSourceMapEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(InputSourceMapEntity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.InputSourceMapEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<InputSourceMapEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<InputSourceMapEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<InputSourceMapEntity>();
                }
                finally
                {
