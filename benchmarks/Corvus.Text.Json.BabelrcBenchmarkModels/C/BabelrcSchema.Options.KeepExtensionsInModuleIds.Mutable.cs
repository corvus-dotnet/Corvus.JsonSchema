    ...
    public readonly partial struct Options
    {
        ...
        public readonly partial struct KeepExtensionsInModuleIds
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<KeepExtensionsInModuleIds, Mutable>(KeepExtensionsInModuleIds.DefaultInstance);
                ...
                public static explicit operator Mutable(KeepExtensionsInModuleIds instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="KeepExtensionsInModuleIds"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator KeepExtensionsInModuleIds(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"KeepExtensionsInModuleIds.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly KeepExtensionsInModuleIds Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly KeepExtensionsInModuleIds Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<KeepExtensionsInModuleIds>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(KeepExtensionsInModuleIds instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<KeepExtensionsInModuleIds, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<KeepExtensionsInModuleIds> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<KeepExtensionsInModuleIds>();
                }
                finally
                {
