...
public readonly partial struct BabelrcSchema
{
    ...
    public readonly partial struct Options
    {
        ...
        public readonly partial struct KeepExtensionsInModuleIds
#if NET8_0_OR_GREATER
            : IJsonElement<KeepExtensionsInModuleIds>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="KeepExtensionsInModuleIds"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal KeepExtensionsInModuleIds(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static KeepExtensionsInModuleIds DefaultInstance { get; } = ParsedJsonDocument<KeepExtensionsInModuleIds>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(KeepExtensionsInModuleIds value)
            {
            ...
            /// </returns>
            public static bool operator ==(in KeepExtensionsInModuleIds left, in KeepExtensionsInModuleIds right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in KeepExtensionsInModuleIds left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(KeepExtensionsInModuleIds instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator KeepExtensionsInModuleIds(JsonElement instance)
            {
                return KeepExtensionsInModuleIds.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static KeepExtensionsInModuleIds From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static KeepExtensionsInModuleIds ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<KeepExtensionsInModuleIds>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static KeepExtensionsInModuleIds ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<KeepExtensionsInModuleIds>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static KeepExtensionsInModuleIds ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<KeepExtensionsInModuleIds>(json, options);
            }
            ...
            /// </exception>
            public static KeepExtensionsInModuleIds ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<KeepExtensionsInModuleIds>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out KeepExtensionsInModuleIds? result)
            {
                return JsonElementHelpers.TryParseValue<KeepExtensionsInModuleIds>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new KeepExtensionsInModuleIds(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static KeepExtensionsInModuleIds IJsonElement<KeepExtensionsInModuleIds>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"KeepExtensionsInModuleIds: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="KeepExtensionsInModuleIds"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="KeepExtensionsInModuleIds"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public KeepExtensionsInModuleIds Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<KeepExtensionsInModuleIds>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="KeepExtensionsInModuleIds"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public KeepExtensionsInModuleIds Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<KeepExtensionsInModuleIds>(_idx);
                }
