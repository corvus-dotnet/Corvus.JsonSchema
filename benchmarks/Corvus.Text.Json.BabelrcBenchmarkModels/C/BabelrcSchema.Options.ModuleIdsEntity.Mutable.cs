    ...
    public readonly partial struct Options
    {
        ...
        public readonly partial struct ModuleIdsEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ModuleIdsEntity, Mutable>(ModuleIdsEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(ModuleIdsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ModuleIdsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ModuleIdsEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ModuleIdsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ModuleIdsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ModuleIdsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ModuleIdsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ModuleIdsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ModuleIdsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ModuleIdsEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ModuleIdsEntity>();
                }
                finally
                {
