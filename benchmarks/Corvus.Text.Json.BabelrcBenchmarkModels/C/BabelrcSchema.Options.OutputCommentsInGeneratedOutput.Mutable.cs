...
public readonly partial struct BabelrcSchema
{
    ...
    public readonly partial struct Options
    {
        ...
        public readonly partial struct OutputCommentsInGeneratedOutput
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<OutputCommentsInGeneratedOutput, Mutable>(OutputCommentsInGeneratedOutput.DefaultInstance);
                ...
                public static explicit operator Mutable(OutputCommentsInGeneratedOutput instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OutputCommentsInGeneratedOutput"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OutputCommentsInGeneratedOutput(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new OutputCommentsInGeneratedOutput(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OutputCommentsInGeneratedOutput.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="OutputCommentsInGeneratedOutput"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="OutputCommentsInGeneratedOutput"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly OutputCommentsInGeneratedOutput Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<OutputCommentsInGeneratedOutput>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="OutputCommentsInGeneratedOutput"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly OutputCommentsInGeneratedOutput Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OutputCommentsInGeneratedOutput>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(OutputCommentsInGeneratedOutput instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<OutputCommentsInGeneratedOutput, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<OutputCommentsInGeneratedOutput> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OutputCommentsInGeneratedOutput>();
                }
                finally
                {
