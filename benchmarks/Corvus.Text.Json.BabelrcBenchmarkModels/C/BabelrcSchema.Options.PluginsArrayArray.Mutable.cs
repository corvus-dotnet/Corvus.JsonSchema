    ...
    public readonly partial struct Options
    {
        ...
        public readonly partial struct PluginsArrayArray
        {
...
#endif
            {
                ...
                public Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.PluginsArray.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.PluginsArray.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.PluginsArray.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.PluginsArray.Mutable>(_parent, _idx);
                }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.PluginsArray.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, scoped in Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.PluginsArray.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(scoped in Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.PluginsArray.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.PluginsArray item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.PluginsArray>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.PluginsArray> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.PluginsArray>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.PluginsArray oldItem, in Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.PluginsArray.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.PluginsArray>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.PluginsArray current = enumerator.Current;
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                public void AddItem(in Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.PluginsArray.Source value)
                {
                ...
                /// Add an item to the array.
                /// </summary>
                public void AddItem<TContext>(in Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.PluginsArray.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            public static ParsedJsonDocument<PluginsArrayArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PluginsArrayArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<PluginsArrayArray> Create<TContext>(
