        ...
        public readonly partial struct PluginsArrayArray
        {
            ...
            public readonly partial struct PluginsArray
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(PluginsArray instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="PluginsArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator PluginsArray(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"PluginsArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly PluginsArray Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly PluginsArray Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<PluginsArray>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.PluginsArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(PluginsArray instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.PluginsArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<PluginsArray, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<PluginsArray> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<PluginsArray>();
                    }
                    finally
                    {
