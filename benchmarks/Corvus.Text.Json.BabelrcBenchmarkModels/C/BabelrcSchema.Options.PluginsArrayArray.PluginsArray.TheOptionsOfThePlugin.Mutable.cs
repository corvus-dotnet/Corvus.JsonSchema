            ...
            public readonly partial struct PluginsArray
            {
                ...
                public readonly partial struct TheOptionsOfThePlugin
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(TheOptionsOfThePlugin instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="TheOptionsOfThePlugin"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator TheOptionsOfThePlugin(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"TheOptionsOfThePlugin.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly TheOptionsOfThePlugin Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly TheOptionsOfThePlugin Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<TheOptionsOfThePlugin>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.PluginsArray.TheOptionsOfThePlugin.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                        public static implicit operator Source(TheOptionsOfThePlugin instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.PluginsArray.TheOptionsOfThePlugin.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    {
                        return workspace.CreateBuilder<TheOptionsOfThePlugin, Mutable>(this);
                    }
                }
            }
        }
