...
public readonly partial struct BabelrcSchema
{
    ...
    public readonly partial struct Options
    {
        ...
        public readonly partial struct PluginsArrayArray
        {
            ...
            /// Generated from JSON Schema.
            /// </summary>
            public readonly partial struct PluginsArray
            {
                /// <summary>
                /// Generated from JSON Schema.
                /// </summary>
                ...
                public readonly partial struct TheOptionsOfThePlugin
#if NET8_0_OR_GREATER
                    : IJsonElement<TheOptionsOfThePlugin>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="TheOptionsOfThePlugin"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal TheOptionsOfThePlugin(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static TheOptionsOfThePlugin DefaultInstance { get; }
                    ...
                    /// </returns>
                    public static bool operator ==(in TheOptionsOfThePlugin left, in TheOptionsOfThePlugin right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in TheOptionsOfThePlugin left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(TheOptionsOfThePlugin instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TheOptionsOfThePlugin(JsonElement instance)
                    {
                        return TheOptionsOfThePlugin.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static TheOptionsOfThePlugin From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static TheOptionsOfThePlugin ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<TheOptionsOfThePlugin>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static TheOptionsOfThePlugin ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<TheOptionsOfThePlugin>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static TheOptionsOfThePlugin ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<TheOptionsOfThePlugin>(json, options);
                    }
                    ...
                    /// </exception>
                    public static TheOptionsOfThePlugin ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<TheOptionsOfThePlugin>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out TheOptionsOfThePlugin? result)
                    {
                        return JsonElementHelpers.TryParseValue<TheOptionsOfThePlugin>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new TheOptionsOfThePlugin(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static TheOptionsOfThePlugin IJsonElement<TheOptionsOfThePlugin>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TheOptionsOfThePlugin: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="TheOptionsOfThePlugin"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="TheOptionsOfThePlugin"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public TheOptionsOfThePlugin Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<TheOptionsOfThePlugin>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="TheOptionsOfThePlugin"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public TheOptionsOfThePlugin Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<TheOptionsOfThePlugin>(_idx);
                        }
