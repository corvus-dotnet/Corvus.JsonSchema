...
public readonly partial struct BabelrcSchema
{
    ...
    public readonly partial struct Options
    {
...
#endif
        {
            ...
            public Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.PluginsArray this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.PluginsArray>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.PluginsArray> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PluginsArrayArray.PluginsArray>(_parent, _idx);
            }
