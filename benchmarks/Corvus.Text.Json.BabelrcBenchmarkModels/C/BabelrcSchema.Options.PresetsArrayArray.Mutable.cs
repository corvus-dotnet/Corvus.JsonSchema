    ...
    public readonly partial struct Options
    {
        ...
        public readonly partial struct PresetsArrayArray
        {
...
#endif
            {
                ...
                public Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PresetsArrayArray.PresetsArray.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PresetsArrayArray.PresetsArray.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PresetsArrayArray.PresetsArray.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PresetsArrayArray.PresetsArray.Mutable>(_parent, _idx);
                }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PresetsArrayArray.PresetsArray.Source value)
                {
                    CheckValidInstance();
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PresetsArrayArray.PresetsArray item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PresetsArrayArray.PresetsArray>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PresetsArrayArray.PresetsArray> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PresetsArrayArray.PresetsArray>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PresetsArrayArray.PresetsArray oldItem, in Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PresetsArrayArray.PresetsArray.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PresetsArrayArray.PresetsArray>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PresetsArrayArray.PresetsArray current = enumerator.Current;
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PresetsArrayArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PresetsArrayArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// Add an item to the array.
                /// </summary>
                public void AddItem<TContext>(in Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PresetsArrayArray.PresetsArray.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            public static ParsedJsonDocument<PresetsArrayArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PresetsArrayArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<PresetsArrayArray> Create<TContext>(
