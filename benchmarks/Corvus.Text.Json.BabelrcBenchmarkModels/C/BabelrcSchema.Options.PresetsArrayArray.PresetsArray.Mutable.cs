        ...
        public readonly partial struct PresetsArrayArray
        {
            ...
            public readonly partial struct PresetsArray
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(PresetsArray instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="PresetsArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator PresetsArray(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"PresetsArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly PresetsArray Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly PresetsArray Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<PresetsArray>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PresetsArrayArray.PresetsArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(PresetsArray instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PresetsArrayArray.PresetsArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<PresetsArray, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<PresetsArray> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<PresetsArray>();
                    }
                    finally
                    {
