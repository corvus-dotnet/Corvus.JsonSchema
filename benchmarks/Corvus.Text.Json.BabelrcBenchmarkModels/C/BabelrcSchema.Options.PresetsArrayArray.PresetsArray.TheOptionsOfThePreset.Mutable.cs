            ...
            public readonly partial struct PresetsArray
            {
                ...
                public readonly partial struct TheOptionsOfThePreset
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(TheOptionsOfThePreset instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="TheOptionsOfThePreset"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator TheOptionsOfThePreset(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"TheOptionsOfThePreset.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly TheOptionsOfThePreset Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly TheOptionsOfThePreset Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<TheOptionsOfThePreset>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PresetsArrayArray.PresetsArray.TheOptionsOfThePreset.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                        public static implicit operator Source(TheOptionsOfThePreset instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PresetsArrayArray.PresetsArray.TheOptionsOfThePreset.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    {
                        return workspace.CreateBuilder<TheOptionsOfThePreset, Mutable>(this);
                    }
                }
            }
        }
