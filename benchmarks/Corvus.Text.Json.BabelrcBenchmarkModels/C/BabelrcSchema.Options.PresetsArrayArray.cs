...
public readonly partial struct BabelrcSchema
{
    ...
    public readonly partial struct Options
    {
        ...
        public readonly partial struct PresetsArrayArray
            ...
            : IJsonElement<PresetsArrayArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="PresetsArrayArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal PresetsArrayArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static PresetsArrayArray DefaultInstance { get; }
            ...
            public Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PresetsArrayArray.PresetsArray this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PresetsArrayArray.PresetsArray>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PresetsArrayArray.PresetsArray> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.BabelrcBenchmark.Current.BabelrcSchema.Options.PresetsArrayArray.PresetsArray>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in PresetsArrayArray left, in PresetsArrayArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in PresetsArrayArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(PresetsArrayArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PresetsArrayArray(JsonElement instance)
            {
                return PresetsArrayArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PresetsArrayArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PresetsArrayArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PresetsArrayArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PresetsArrayArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PresetsArrayArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PresetsArrayArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PresetsArrayArray>(json, options);
            }
            ...
            /// </exception>
            public static PresetsArrayArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<PresetsArrayArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out PresetsArrayArray? result)
            {
                return JsonElementHelpers.TryParseValue<PresetsArrayArray>(ref reader, out result);
            }
...
#if NET
            static PresetsArrayArray IJsonElement<PresetsArrayArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PresetsArrayArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public PresetsArrayArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public PresetsArrayArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<PresetsArrayArray>(_idx);
                }
