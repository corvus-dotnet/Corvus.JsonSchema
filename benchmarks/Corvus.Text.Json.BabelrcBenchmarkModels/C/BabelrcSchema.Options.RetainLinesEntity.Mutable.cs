    ...
    public readonly partial struct Options
    {
        ...
        public readonly partial struct RetainLinesEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<RetainLinesEntity, Mutable>(RetainLinesEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(RetainLinesEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RetainLinesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RetainLinesEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RetainLinesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RetainLinesEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RetainLinesEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RetainLinesEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RetainLinesEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RetainLinesEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RetainLinesEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RetainLinesEntity>();
                }
                finally
                {
