    ...
    public readonly partial struct Options
    {
        ...
        public readonly partial struct SourceMapsEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SourceMapsEntity, Mutable>(SourceMapsEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<SourceMapsEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SourceMapsEntity>();
                }
                finally
                {
