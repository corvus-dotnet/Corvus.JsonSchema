...
public readonly partial struct BabelrcSchema
{
    ...
    public readonly partial struct Options
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SourceMapsEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SourceMapsEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SourceMapsEntity DefaultInstance { get; } = ParsedJsonDocument<SourceMapsEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(SourceMapsEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator bool(SourceMapsEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in SourceMapsEntity left, in SourceMapsEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SourceMapsEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SourceMapsEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SourceMapsEntity(JsonElement instance)
            {
                return SourceMapsEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SourceMapsEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SourceMapsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SourceMapsEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SourceMapsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SourceMapsEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SourceMapsEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SourceMapsEntity>(json, options);
            }
            ...
            /// </exception>
            public static SourceMapsEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SourceMapsEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SourceMapsEntity? result)
            {
                return JsonElementHelpers.TryParseValue<SourceMapsEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SourceMapsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static SourceMapsEntity IJsonElement<SourceMapsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SourceMapsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SourceMapsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SourceMapsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public SourceMapsEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SourceMapsEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SourceMapsEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public SourceMapsEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SourceMapsEntity>(_idx);
                }
            ...
            /// <param name="matchTrue">Match 3rd item.</param>
            /// <param name="matchFalse">Match 4th item.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Func<TContext, TResult> matchTrue,
                Func<TContext, TResult> matchFalse,
...
#endif
            {
                ...
                {
                    return matchTrue(context);
                }

                if (this.TokenType == JsonTokenType.False)
                {
                    return matchFalse(context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Func<TResult> matchTrue,
                Func<TResult> matchFalse,
