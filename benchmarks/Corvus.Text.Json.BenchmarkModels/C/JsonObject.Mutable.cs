...
public readonly partial struct JsonObject
{
...
#endif
    {
        ...
        public static implicit operator Corvus.PersonBenchmark.Current.Person.Mutable(Mutable value)
        {
            return Corvus.PersonBenchmark.Current.Person.Mutable.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Mutable(Corvus.PersonBenchmark.Current.Person.Mutable value)
        {
            return From(value);
        }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.PersonBenchmark.Current.Person.Mutable" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsPerson(out Corvus.PersonBenchmark.Current.Person.Mutable result)
        {
            if (Corvus.PersonBenchmark.Current.Person.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.PersonBenchmark.Current.Person.Mutable.From(this);
                return true;
            }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="JsonObject"/>.
        /// </summary>
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<JsonObject> Create<TContext>(
    ...
    public static ParsedJsonDocument<JsonObject> Create(in Corvus.PersonBenchmark.Current.PersonName.Source name, in Corvus.PersonBenchmark.Current.Age.Source age = default, in Corvus.PersonBenchmark.Current.CompetedInYears.Source competedInYears = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<JsonObject> Create<TContext>(in TContext context, in Corvus.PersonBenchmark.Current.PersonName.Source<TContext> name, in Corvus.PersonBenchmark.Current.Age.Source age = default, in Corvus.PersonBenchmark.Current.CompetedInYears.Source<TContext> competedInYears = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
