...
#endif
{
    ...
    /// </summary>
    public Corvus.PersonBenchmark.Current.Age Age
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AgeUtf8, out Corvus.PersonBenchmark.Current.Age value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.PersonBenchmark.Current.CompetedInYears CompetedInYears
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CompetedInYearsUtf8, out Corvus.PersonBenchmark.Current.CompetedInYears value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.PersonBenchmark.Current.PersonName Name
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.PersonBenchmark.Current.PersonName value))
            {
                return value;
            }
    ...
    /// <summary>
    /// Conversion to <see cref="Corvus.PersonBenchmark.Current.Person"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator Corvus.PersonBenchmark.Current.Person(JsonObject value)
    {
        return Corvus.PersonBenchmark.Current.Person.From(value);
    }

    /// <summary>
    /// Conversion from <see cref="Corvus.PersonBenchmark.Current.Person"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator JsonObject(Corvus.PersonBenchmark.Current.Person value)
    {
        return From(value);
    }
    ...
    /// <summary>
    /// Gets the value as a <see cref="Corvus.PersonBenchmark.Current.Person" />.
    /// </summary>
    /// <param name="result">The result of the conversions.</param>
    /// <returns><see langword="true" /> if the conversion was valid.</returns>
    public bool TryGetAsPerson(out Corvus.PersonBenchmark.Current.Person result)
    {
        if (Corvus.PersonBenchmark.Current.Person.JsonSchema.Evaluate(_parent, _idx))
        {
            result = Corvus.PersonBenchmark.Current.Person.From(this);
            return true;
        }
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="CompetedInYears"/>.
        /// </summary>
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="CompetedInYears"/>.
        /// </summary>
        public static ReadOnlySpan<byte> CompetedInYears => [0x15, 0x01, 0x00, 0x00, 0x22, 0x63, 0x6F, 0x6D, 0x70, 0x65, 0x74, 0x65, 0x64, 0x49, 0x6E, 0x59, 0x65, 0x61, 0x72, 0x73, 0x22];
