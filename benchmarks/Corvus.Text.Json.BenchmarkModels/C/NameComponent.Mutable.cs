...
public readonly partial struct NameComponent
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public readonly NameComponent Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly NameComponent Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<NameComponent>(_idx);
        }
    }
    ...
    public static ParsedJsonDocument<NameComponent> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<NameComponent>();
        }
        finally
        {
