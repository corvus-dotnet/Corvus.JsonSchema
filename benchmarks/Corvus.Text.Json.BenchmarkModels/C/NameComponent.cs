...
#endif
{
    ...
    /// </summary>
    public static NameComponent DefaultInstance { get; }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator string(NameComponent value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
    ...
    /// </returns>
    public static bool operator ==(in NameComponent left, in NameComponent right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in NameComponent left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator JsonElement(NameComponent instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator NameComponent(JsonElement instance)
    {
        return NameComponent.From(instance);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static NameComponent ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<NameComponent>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static NameComponent ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<NameComponent>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static NameComponent ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<NameComponent>(json, options);
    }
    ...
    /// </exception>
    public static NameComponent ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<NameComponent>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out NameComponent? result)
    {
        return JsonElementHelpers.TryParseValue<NameComponent>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new NameComponent(value.ParentDocument, value.ParentDocumentIndex))) ||
    ...
    /// <summary>
    /// Gets a <see cref="NameComponent"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="NameComponent"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    {
        CheckValidInstance();
        return _parent.CloneElement<NameComponent>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="NameComponent"/> that lives for the lifetime of its
