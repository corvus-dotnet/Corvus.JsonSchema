...
public readonly partial struct NameComponentArray
{
...
#endif
    {
        ...
        public Corvus.PersonBenchmark.Current.NameComponent.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.PersonBenchmark.Current.NameComponent.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.PersonBenchmark.Current.NameComponent.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.PersonBenchmark.Current.NameComponent.Mutable>(_parent, _idx);
        }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in Corvus.PersonBenchmark.Current.NameComponent.Source value)
        {
            CheckValidInstance();
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Remove(in Corvus.PersonBenchmark.Current.NameComponent item)
        {
            CheckValidInstance();
            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.PersonBenchmark.Current.NameComponent>(this, in item))
            {
                return false;
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<Corvus.PersonBenchmark.Current.NameComponent> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.PersonBenchmark.Current.NameComponent>(this, predicate);
            _documentVersion = _parent.Version;
        }
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Replace(in Corvus.PersonBenchmark.Current.NameComponent oldItem, in Corvus.PersonBenchmark.Current.NameComponent.Source newItem)
        {
            CheckValidInstance();
            ...
            var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.PersonBenchmark.Current.NameComponent>(_parent, _idx);

            while (enumerator.MoveNext())
            {
                Corvus.PersonBenchmark.Current.NameComponent current = enumerator.Current;
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.PersonBenchmark.Current.NameComponentArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.PersonBenchmark.Current.NameComponentArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    public static ParsedJsonDocument<NameComponentArray> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<NameComponentArray>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<NameComponentArray> Create<TContext>(
