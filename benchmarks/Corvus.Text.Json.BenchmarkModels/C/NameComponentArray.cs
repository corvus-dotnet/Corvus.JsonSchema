...
#endif
{
    ...
    public Corvus.PersonBenchmark.Current.NameComponent this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Corvus.PersonBenchmark.Current.NameComponent>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Corvus.PersonBenchmark.Current.NameComponent> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Corvus.PersonBenchmark.Current.NameComponent>(_parent, _idx);
    }
