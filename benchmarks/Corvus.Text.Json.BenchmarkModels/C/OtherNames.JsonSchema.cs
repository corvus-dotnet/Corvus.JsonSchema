    ...
    : IJsonElement<OtherNames>
{
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/$defs/OtherNames"u8, buffer, out written);
        ...
        /// </remarks>
        public const string SchemaDocument = "person-schema.json";

        /// <summary>
        /// Gets the schema document from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaDocumentUtf8 => "person-schema.json"u8;

        private static readonly global::Corvus.Text.Json.RuntimeEvaluator.JsonSchemaEvaluator Evaluator = global::Corvus.PersonBenchmark.Current.CorvusJsonSchemaProgram.Entry(6);
