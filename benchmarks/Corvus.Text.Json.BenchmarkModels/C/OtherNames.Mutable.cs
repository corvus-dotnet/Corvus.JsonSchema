...
public readonly partial struct OtherNames
{
...
#endif
    {
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.PersonBenchmark.Current.NameComponent"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.PersonBenchmark.Current.NameComponent.Mutable(Mutable value)
        {
            return Corvus.PersonBenchmark.Current.NameComponent.Mutable.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.PersonBenchmark.Current.NameComponent"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Mutable(Corvus.PersonBenchmark.Current.NameComponent.Mutable value)
        {
            return From(value);
        }

        /// <summary>
        /// Conversion to <see cref="Corvus.PersonBenchmark.Current.NameComponentArray"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.PersonBenchmark.Current.NameComponentArray.Mutable(Mutable value)
        {
            return Corvus.PersonBenchmark.Current.NameComponentArray.Mutable.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.PersonBenchmark.Current.NameComponentArray"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Mutable(Corvus.PersonBenchmark.Current.NameComponentArray.Mutable value)
        {
            return From(value);
        }
        ...
        /// <param name="matchNameComponent">Match a <see cref="Corvus.PersonBenchmark.Current.NameComponent"/>.</param>
        /// <param name="matchNameComponentArray">Match a <see cref="Corvus.PersonBenchmark.Current.NameComponentArray"/>.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Matcher<Corvus.PersonBenchmark.Current.NameComponent, TContext, TResult> matchNameComponent,
            Matcher<Corvus.PersonBenchmark.Current.NameComponentArray, TContext, TResult> matchNameComponentArray,
            Matcher<Corvus.PersonBenchmark.Current.OtherNames.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
        where TContext : allows ref struct
#endif
        {
            if (Corvus.PersonBenchmark.Current.NameComponent.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchNameComponent(Corvus.PersonBenchmark.Current.NameComponent.Mutable.From(this), context);
            }

            if (Corvus.PersonBenchmark.Current.NameComponentArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchNameComponentArray(Corvus.PersonBenchmark.Current.NameComponentArray.Mutable.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            Matcher<Corvus.PersonBenchmark.Current.NameComponent, TResult> matchNameComponent,
            Matcher<Corvus.PersonBenchmark.Current.NameComponentArray, TResult> matchNameComponentArray,
            Matcher<Corvus.PersonBenchmark.Current.OtherNames.Mutable, TResult> defaultMatch)
        {
            if (Corvus.PersonBenchmark.Current.NameComponent.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchNameComponent(Corvus.PersonBenchmark.Current.NameComponent.Mutable.From(this));
            }

            if (Corvus.PersonBenchmark.Current.NameComponentArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchNameComponentArray(Corvus.PersonBenchmark.Current.NameComponentArray.Mutable.From(this));
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.PersonBenchmark.Current.NameComponent.Mutable" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsNameComponent(out Corvus.PersonBenchmark.Current.NameComponent.Mutable result)
        {
            if (Corvus.PersonBenchmark.Current.NameComponent.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.PersonBenchmark.Current.NameComponent.Mutable.From(this);
                return true;
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.PersonBenchmark.Current.NameComponentArray.Mutable" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsNameComponentArray(out Corvus.PersonBenchmark.Current.NameComponentArray.Mutable result)
        {
            if (Corvus.PersonBenchmark.Current.NameComponentArray.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.PersonBenchmark.Current.NameComponentArray.Mutable.From(this);
                return true;
            }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.PersonBenchmark.Current.OtherNames.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(Corvus.PersonBenchmark.Current.NameComponent instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.PersonBenchmark.Current.OtherNames.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    public static ParsedJsonDocument<OtherNames> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<OtherNames>();
        }
        finally
        {
