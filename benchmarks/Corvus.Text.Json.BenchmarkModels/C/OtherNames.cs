...
#endif
{
    ...
    public static explicit operator Corvus.PersonBenchmark.Current.NameComponent(OtherNames value)
    {
        return Corvus.PersonBenchmark.Current.NameComponent.From(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator OtherNames(Corvus.PersonBenchmark.Current.NameComponent value)
    {
        return From(value);
    }

    /// <summary>
    /// Conversion from the <see cref="Corvus.PersonBenchmark.Current.NameComponent"/> mutable view.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator OtherNames(Corvus.PersonBenchmark.Current.NameComponent.Mutable value)
    {
        return From(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator Corvus.PersonBenchmark.Current.NameComponentArray(OtherNames value)
    {
        return Corvus.PersonBenchmark.Current.NameComponentArray.From(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator OtherNames(Corvus.PersonBenchmark.Current.NameComponentArray value)
    {
        return From(value);
    }

    /// <summary>
    /// Conversion from the <see cref="Corvus.PersonBenchmark.Current.NameComponentArray"/> mutable view.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator OtherNames(Corvus.PersonBenchmark.Current.NameComponentArray.Mutable value)
    {
        return From(value);
    }
    ...
    public bool TryGetAsNameComponent(out Corvus.PersonBenchmark.Current.NameComponent result)
    {
        ...
        {
            result = Corvus.PersonBenchmark.Current.NameComponent.From(this);
            return true;
        }
    ...
    public bool TryGetAsNameComponentArray(out Corvus.PersonBenchmark.Current.NameComponentArray result)
    {
        ...
        {
            result = Corvus.PersonBenchmark.Current.NameComponentArray.From(this);
            return true;
        }
    ...
    public TResult Match<TContext, TResult>(
        ...
        Matcher<Corvus.PersonBenchmark.Current.OtherNames, TContext, TResult> defaultMatch)
...
#endif
    {
        if (Corvus.PersonBenchmark.Current.NameComponent.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchNameComponent(Corvus.PersonBenchmark.Current.NameComponent.From(this), context);
        }

        if (Corvus.PersonBenchmark.Current.NameComponentArray.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchNameComponentArray(Corvus.PersonBenchmark.Current.NameComponentArray.From(this), context);
        }
    ...
    public TResult Match<TResult>(
        ...
        Matcher<Corvus.PersonBenchmark.Current.OtherNames, TResult> defaultMatch)
    {
        if (Corvus.PersonBenchmark.Current.NameComponent.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchNameComponent(Corvus.PersonBenchmark.Current.NameComponent.From(this));
        }

        if (Corvus.PersonBenchmark.Current.NameComponentArray.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchNameComponentArray(Corvus.PersonBenchmark.Current.NameComponentArray.From(this));
        }
