...
public readonly partial struct Person
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.PersonBenchmark.Current.Age.Mutable Age
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AgeUtf8, out Corvus.PersonBenchmark.Current.Age.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.PersonBenchmark.Current.CompetedInYears.Mutable CompetedInYears
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CompetedInYearsUtf8, out Corvus.PersonBenchmark.Current.CompetedInYears.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.PersonBenchmark.Current.PersonName.Mutable Name
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.PersonBenchmark.Current.PersonName.Mutable value))
                {
                    return value;
                }
        ...
        public void SetCompetedInYears(scoped in Corvus.PersonBenchmark.Current.CompetedInYears.Source value)
        {
            ...
            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CompetedInYearsUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CompetedInYearsUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.CompetedInYears, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetCompetedInYears<TContext>(in Corvus.PersonBenchmark.Current.CompetedInYears.Source<TContext> value)
        ...
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveCompetedInYears()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CompetedInYearsUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetName<TContext>(in Corvus.PersonBenchmark.Current.PersonName.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.PersonBenchmark.Current.PersonName.Source _createArg1;
        private readonly Corvus.PersonBenchmark.Current.Age.Source _createArg2;
        private readonly Corvus.PersonBenchmark.Current.CompetedInYears.Source _createArg3;
        ...
        #endif
    {
        ...
        private readonly Corvus.PersonBenchmark.Current.PersonName.Source<TContext> _createArg1;
        private readonly Corvus.PersonBenchmark.Current.Age.Source _createArg2;
        private readonly Corvus.PersonBenchmark.Current.CompetedInYears.Source<TContext> _createArg3;
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.PersonBenchmark.Current.PersonName.Source name,
            in Corvus.PersonBenchmark.Current.Age.Source age = default,
            in Corvus.PersonBenchmark.Current.CompetedInYears.Source competedInYears = default)
        {
            ...
            competedInYears.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.CompetedInYears, ref builder);
        }
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in Corvus.PersonBenchmark.Current.PersonName.Source<TContext> name,
            in Corvus.PersonBenchmark.Current.Age.Source age = default,
            in Corvus.PersonBenchmark.Current.CompetedInYears.Source<TContext> competedInYears = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
    ...
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.PersonBenchmark.Current.PersonName.Source<TContext> name, scoped in Corvus.PersonBenchmark.Current.Age.Source age = default, scoped in Corvus.PersonBenchmark.Current.CompetedInYears.Source<TContext> competedInYears = default)
        ...
        #endif
    {
        return new Source<TContext>(context, name, age, competedInYears);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.PersonBenchmark.Current.PersonName.Source name, in Corvus.PersonBenchmark.Current.Age.Source age = default, in Corvus.PersonBenchmark.Current.CompetedInYears.Source competedInYears = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.PersonBenchmark.Current.PersonName.Source<TContext> name, in Corvus.PersonBenchmark.Current.Age.Source age = default, in Corvus.PersonBenchmark.Current.CompetedInYears.Source<TContext> competedInYears = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    public static ParsedJsonDocument<Person> Create(in Corvus.PersonBenchmark.Current.PersonName.Source name, in Corvus.PersonBenchmark.Current.Age.Source age = default, in Corvus.PersonBenchmark.Current.CompetedInYears.Source competedInYears = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<Person> Create<TContext>(in TContext context, in Corvus.PersonBenchmark.Current.PersonName.Source<TContext> name, in Corvus.PersonBenchmark.Current.Age.Source age = default, in Corvus.PersonBenchmark.Current.CompetedInYears.Source<TContext> competedInYears = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
