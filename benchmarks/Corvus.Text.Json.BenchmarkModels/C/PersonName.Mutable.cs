...
public readonly partial struct PersonName
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.PersonBenchmark.Current.NameComponent.Mutable FirstName
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FirstNameUtf8, out Corvus.PersonBenchmark.Current.NameComponent.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.PersonBenchmark.Current.NameComponent.Mutable LastName
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LastNameUtf8, out Corvus.PersonBenchmark.Current.NameComponent.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.PersonBenchmark.Current.OtherNames.Mutable OtherNames
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OtherNamesUtf8, out Corvus.PersonBenchmark.Current.OtherNames.Mutable value))
                {
                    return value;
                }
        ...
        public void SetFirstName(scoped in Corvus.PersonBenchmark.Current.NameComponent.Source value)
        {
            CheckValidInstance();
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.FirstName, ref cvb);
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetLastName(scoped in Corvus.PersonBenchmark.Current.NameComponent.Source value)
        {
            CheckValidInstance();
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.LastName, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetOtherNames(scoped in Corvus.PersonBenchmark.Current.OtherNames.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetOtherNames<TContext>(in Corvus.PersonBenchmark.Current.OtherNames.Source<TContext> value)
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.PersonBenchmark.Current.NameComponent.Source _createArg1;
        private readonly Corvus.PersonBenchmark.Current.NameComponent.Source _createArg2;
        private readonly Corvus.PersonBenchmark.Current.OtherNames.Source _createArg3;
        ...
        internal Source(Corvus.PersonBenchmark.Current.PersonName.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.PersonBenchmark.Current.NameComponent.Source arg1, scoped in Corvus.PersonBenchmark.Current.NameComponent.Source arg2, scoped in Corvus.PersonBenchmark.Current.OtherNames.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        private readonly Corvus.PersonBenchmark.Current.NameComponent.Source _createArg1;
        private readonly Corvus.PersonBenchmark.Current.NameComponent.Source _createArg2;
        private readonly Corvus.PersonBenchmark.Current.OtherNames.Source<TContext> _createArg3;
        ...
        internal Source(scoped in TContext context, Corvus.PersonBenchmark.Current.PersonName.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, scoped in Corvus.PersonBenchmark.Current.NameComponent.Source arg1, scoped in Corvus.PersonBenchmark.Current.NameComponent.Source arg2, scoped in Corvus.PersonBenchmark.Current.OtherNames.Source<TContext> arg3)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.PersonBenchmark.Current.NameComponent.Source firstName,
            in Corvus.PersonBenchmark.Current.NameComponent.Source lastName = default,
            in Corvus.PersonBenchmark.Current.OtherNames.Source otherNames = default)
        {
            firstName.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.FirstName, ref builder);
            lastName.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.LastName, ref builder);
        ...
        internal static void Create<TContext>(
            ...
            in Corvus.PersonBenchmark.Current.NameComponent.Source firstName,
            in Corvus.PersonBenchmark.Current.NameComponent.Source lastName = default,
            in Corvus.PersonBenchmark.Current.OtherNames.Source<TContext> otherNames = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        internal static void BuildCreateValue(scoped in Corvus.PersonBenchmark.Current.NameComponent.Source arg1, scoped in Corvus.PersonBenchmark.Current.NameComponent.Source arg2, scoped in Corvus.PersonBenchmark.Current.OtherNames.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg3">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.PersonBenchmark.Current.NameComponent.Source arg1, scoped in Corvus.PersonBenchmark.Current.NameComponent.Source arg2, scoped in Corvus.PersonBenchmark.Current.OtherNames.Source<TContext> arg3, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// </summary>
    /// <param name="firstName">The value of the <c>"firstName"</c> property.</param>
    /// <param name="lastName">The value of the <c>"lastName"</c> property.</param>
    /// <param name="otherNames">The value of the <c>"otherNames"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.PersonBenchmark.Current.NameComponent.Source firstName, scoped in Corvus.PersonBenchmark.Current.NameComponent.Source lastName = default, scoped in Corvus.PersonBenchmark.Current.OtherNames.Source otherNames = default)
    {
        return new Source(firstName, lastName, otherNames);
    }
    ...
    /// <param name="otherNames">The value of the <c>"otherNames"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.PersonBenchmark.Current.NameComponent.Source firstName, scoped in Corvus.PersonBenchmark.Current.NameComponent.Source lastName = default, scoped in Corvus.PersonBenchmark.Current.OtherNames.Source<TContext> otherNames = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, firstName, lastName, otherNames);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.PersonBenchmark.Current.NameComponent.Source firstName, in Corvus.PersonBenchmark.Current.NameComponent.Source lastName = default, in Corvus.PersonBenchmark.Current.OtherNames.Source otherNames = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.PersonBenchmark.Current.NameComponent.Source firstName, in Corvus.PersonBenchmark.Current.NameComponent.Source lastName = default, in Corvus.PersonBenchmark.Current.OtherNames.Source<TContext> otherNames = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    public static ParsedJsonDocument<PersonName> Create(in Corvus.PersonBenchmark.Current.NameComponent.Source firstName, in Corvus.PersonBenchmark.Current.NameComponent.Source lastName = default, in Corvus.PersonBenchmark.Current.OtherNames.Source otherNames = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<PersonName> Create<TContext>(in TContext context, in Corvus.PersonBenchmark.Current.NameComponent.Source firstName, in Corvus.PersonBenchmark.Current.NameComponent.Source lastName = default, in Corvus.PersonBenchmark.Current.OtherNames.Source<TContext> otherNames = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
