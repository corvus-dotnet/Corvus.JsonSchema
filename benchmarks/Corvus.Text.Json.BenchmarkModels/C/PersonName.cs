...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.PersonBenchmark.Current.NameComponent FirstName
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FirstNameUtf8, out Corvus.PersonBenchmark.Current.NameComponent value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.PersonBenchmark.Current.NameComponent LastName
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LastNameUtf8, out Corvus.PersonBenchmark.Current.NameComponent value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.PersonBenchmark.Current.OtherNames OtherNames
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OtherNamesUtf8, out Corvus.PersonBenchmark.Current.OtherNames value))
            {
                return value;
            }
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="OtherNames"/>.
        /// </summary>
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="OtherNames"/>.
        /// </summary>
        public static ReadOnlySpan<byte> OtherNames => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x6F, 0x74, 0x68, 0x65, 0x72, 0x4E, 0x61, 0x6D, 0x65, 0x73, 0x22];
    }
}
