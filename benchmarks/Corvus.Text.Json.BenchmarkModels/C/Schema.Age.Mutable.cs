...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Age
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Age instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Age"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Age(Mutable instance)
            {
        ...
        {
            return workspace.CreateBuilder<Age, Mutable>(this);
        }
    }
}
