...
#if NET8_0_OR_GREATER
    : IJsonNumber<Benchmark.CorvusJsonSchema.Age>,
      IAdditionOperators<Benchmark.CorvusJsonSchema.Age, Benchmark.CorvusJsonSchema.Age, Benchmark.CorvusJsonSchema.Age>,
      ISubtractionOperators<Benchmark.CorvusJsonSchema.Age, Benchmark.CorvusJsonSchema.Age, Benchmark.CorvusJsonSchema.Age>,
      IMultiplyOperators<Benchmark.CorvusJsonSchema.Age, Benchmark.CorvusJsonSchema.Age, Benchmark.CorvusJsonSchema.Age>,
      IDivisionOperators<Benchmark.CorvusJsonSchema.Age, Benchmark.CorvusJsonSchema.Age, Benchmark.CorvusJsonSchema.Age>,
      IIncrementOperators<Benchmark.CorvusJsonSchema.Age>,
      IDecrementOperators<Benchmark.CorvusJsonSchema.Age>
#else
    : IJsonNumber<Benchmark.CorvusJsonSchema.Age>
#endif
{
    ...
    public static implicit operator Age(JsonNumber value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonNumber(Age value)
    {
        return
            value.AsNumber;
    }
    ...
    public static explicit operator byte(Age value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="Age"/>.</returns>
    public static explicit operator Age(byte value)
    {
    ...
    public static explicit operator decimal(Age value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="Age"/>.</returns>
    public static explicit operator Age(decimal value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static implicit operator double(Age value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="Age"/>.</returns>
    public static implicit operator Age(double value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator short(Age value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="Age"/>.</returns>
    public static explicit operator Age(short value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator int(Age value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    public static explicit operator long(Age value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="Age"/>.</returns>
    public static explicit operator Age(long value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator Int128(Age value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="Age"/>.</returns>
    public static explicit operator Age(Int128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
    ...
    public static explicit operator sbyte(Age value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="Age"/>.</returns>
    public static explicit operator Age(sbyte value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator Half(Age value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="Age"/>.</returns>
    public static explicit operator Age(Half value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
    ...
    public static explicit operator float(Age value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="Age"/>.</returns>
    public static explicit operator Age(float value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator ushort(Age value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="Age"/>.</returns>
    public static explicit operator Age(ushort value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator uint(Age value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="Age"/>.</returns>
    public static explicit operator Age(uint value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator ulong(Age value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="Age"/>.</returns>
    public static explicit operator Age(ulong value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator UInt128(Age value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="Age"/>.</returns>
    public static explicit operator Age(UInt128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
    ...
    /// <returns>The result of the operation.</returns>
    public static Age operator ++(Age value)
    {
    ...
    /// </returns>
    public static int Compare(in Age lhs, in Age rhs)
    {
