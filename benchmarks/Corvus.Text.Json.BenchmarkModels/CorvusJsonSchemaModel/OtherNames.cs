...
public readonly partial struct OtherNames
    : IJsonValue<Benchmark.CorvusJsonSchema.OtherNames>
{
    ...
    /// <summary>
    /// Gets the instance as a <see cref="Benchmark.CorvusJsonSchema.NameComponent" />.
    /// </summary>
    public Benchmark.CorvusJsonSchema.NameComponent AsNameComponent
    {
        get
        {
            return this.As<Benchmark.CorvusJsonSchema.NameComponent>();
        }
    }

    /// <summary>
    /// Gets a value indicating whether the instance is a <see cref="Benchmark.CorvusJsonSchema.NameComponent" />.
    /// </summary>
    public bool IsNameComponent
    {
        get
        {
            return this.As<Benchmark.CorvusJsonSchema.NameComponent>().IsValid();
        }
    }

    /// <summary>
    /// Gets the instance as a <see cref="Benchmark.CorvusJsonSchema.NameComponentArray" />.
    /// </summary>
    public Benchmark.CorvusJsonSchema.NameComponentArray AsNameComponentArray
    {
        get
        {
            return this.As<Benchmark.CorvusJsonSchema.NameComponentArray>();
        }
    }

    /// <summary>
    /// Gets a value indicating whether the instance is a <see cref="Benchmark.CorvusJsonSchema.NameComponentArray" />.
    /// </summary>
    public bool IsNameComponentArray
    {
        get
        {
            return this.As<Benchmark.CorvusJsonSchema.NameComponentArray>().IsValid();
        }
    }
    ...
    /// <summary>
    /// Conversion to <see cref="Benchmark.CorvusJsonSchema.NameComponent"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator Benchmark.CorvusJsonSchema.NameComponent(OtherNames value)
    {
        return value.As<Benchmark.CorvusJsonSchema.NameComponent>();
    }

    /// <summary>
    /// Conversion from <see cref="Benchmark.CorvusJsonSchema.NameComponent"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator OtherNames(Benchmark.CorvusJsonSchema.NameComponent value)
    {
        return value.As<OtherNames>();
    }

    /// <summary>
    /// Conversion to <see cref="Benchmark.CorvusJsonSchema.NameComponentArray"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator Benchmark.CorvusJsonSchema.NameComponentArray(OtherNames value)
    {
        return value.As<Benchmark.CorvusJsonSchema.NameComponentArray>();
    }

    /// <summary>
    /// Conversion from <see cref="Benchmark.CorvusJsonSchema.NameComponentArray"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator OtherNames(Benchmark.CorvusJsonSchema.NameComponentArray value)
    {
        return value.As<OtherNames>();
    }
    ...
    /// <param name="matchNameComponent">Match a <see cref="Benchmark.CorvusJsonSchema.NameComponent"/>.</param>
    /// <param name="matchNameComponentArray">Match a <see cref="Benchmark.CorvusJsonSchema.NameComponentArray"/>.</param>
    /// <param name="defaultMatch">Match any other value.</param>
    /// <returns>An instance of the value returned by the match function.</returns>
    public TOut Match<TIn, TOut>(
        in TIn context,
        Matcher<Benchmark.CorvusJsonSchema.NameComponent, TIn, TOut> matchNameComponent,
        Matcher<Benchmark.CorvusJsonSchema.NameComponentArray, TIn, TOut> matchNameComponentArray,
        Matcher<Benchmark.CorvusJsonSchema.OtherNames, TIn, TOut> defaultMatch)
    {
        Benchmark.CorvusJsonSchema.NameComponent matchNameComponentValue = this.As<Benchmark.CorvusJsonSchema.NameComponent>();
        if (matchNameComponentValue.IsValid())
        {
            return matchNameComponent(matchNameComponentValue, context);
        }

        Benchmark.CorvusJsonSchema.NameComponentArray matchNameComponentArrayValue = this.As<Benchmark.CorvusJsonSchema.NameComponentArray>();
        if (matchNameComponentArrayValue.IsValid())
        {
            return matchNameComponentArray(matchNameComponentArrayValue, context);
        }
    ...
    public TOut Match<TOut>(
        Matcher<Benchmark.CorvusJsonSchema.NameComponent, TOut> matchNameComponent,
        Matcher<Benchmark.CorvusJsonSchema.NameComponentArray, TOut> matchNameComponentArray,
        Matcher<Benchmark.CorvusJsonSchema.OtherNames, TOut> defaultMatch)
    {
        Benchmark.CorvusJsonSchema.NameComponent matchNameComponentValue = this.As<Benchmark.CorvusJsonSchema.NameComponent>();
        if (matchNameComponentValue.IsValid())
        {
            return matchNameComponent(matchNameComponentValue);
        }

        Benchmark.CorvusJsonSchema.NameComponentArray matchNameComponentArrayValue = this.As<Benchmark.CorvusJsonSchema.NameComponentArray>();
        if (matchNameComponentArrayValue.IsValid())
        {
            return matchNameComponentArray(matchNameComponentArrayValue);
        }
    ...
    /// <summary>
    /// Gets the value as a <see cref="Benchmark.CorvusJsonSchema.NameComponent" />.
    /// </summary>
    /// <param name="result">The result of the conversions.</param>
    /// <returns><see langword="true" /> if the conversion was valid.</returns>
    public bool TryGetAsNameComponent(out Benchmark.CorvusJsonSchema.NameComponent result)
    {
        result = this.As<Benchmark.CorvusJsonSchema.NameComponent>();
        return result.IsValid();
    }

    /// <summary>
    /// Gets the value as a <see cref="Benchmark.CorvusJsonSchema.NameComponentArray" />.
    /// </summary>
    /// <param name="result">The result of the conversions.</param>
    /// <returns><see langword="true" /> if the conversion was valid.</returns>
    public bool TryGetAsNameComponentArray(out Benchmark.CorvusJsonSchema.NameComponentArray result)
    {
        result = this.As<Benchmark.CorvusJsonSchema.NameComponentArray>();
        return result.IsValid();
    }
}