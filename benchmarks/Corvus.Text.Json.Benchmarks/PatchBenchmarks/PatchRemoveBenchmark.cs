// <copyright file="PatchRemoveBenchmark.cs" company="Endjin Limited">
...
/// <summary>
/// Benchmark for RFC 6902 A.3 — Removing an Object Member.
/// </summary>
[MemoryDiagnoser]
public class PatchRemoveBenchmark : PatchBenchmarkBase
{
    private const string PatchJson = """[{"op":"remove","path":"/baz"}]""";
