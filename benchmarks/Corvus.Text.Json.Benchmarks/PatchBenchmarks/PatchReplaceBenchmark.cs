// <copyright file="PatchReplaceBenchmark.cs" company="Endjin Limited">
...
/// <summary>
/// Benchmark for RFC 6902 A.5 — Replacing a Value.
/// </summary>
[MemoryDiagnoser]
public class PatchReplaceBenchmark : PatchBenchmarkBase
{
    private const string PatchJson = """[{"op":"replace","path":"/baz","value":"boo"}]""";
    private const string InputJson = """{"baz":"qux","foo":"bar"}""";
