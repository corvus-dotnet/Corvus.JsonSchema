...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AlignAfterOpenBracketEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal AlignAfterOpenBracketEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static AlignAfterOpenBracketEntity DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(AlignAfterOpenBracketEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in AlignAfterOpenBracketEntity left, in AlignAfterOpenBracketEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in AlignAfterOpenBracketEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(AlignAfterOpenBracketEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AlignAfterOpenBracketEntity(JsonElement instance)
        {
            return AlignAfterOpenBracketEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AlignAfterOpenBracketEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AlignAfterOpenBracketEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AlignAfterOpenBracketEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AlignAfterOpenBracketEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AlignAfterOpenBracketEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AlignAfterOpenBracketEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AlignAfterOpenBracketEntity>(json, options);
        }
        ...
        /// </exception>
        public static AlignAfterOpenBracketEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<AlignAfterOpenBracketEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out AlignAfterOpenBracketEntity? result)
        {
            return JsonElementHelpers.TryParseValue<AlignAfterOpenBracketEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AlignAfterOpenBracketEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static AlignAfterOpenBracketEntity IJsonElement<AlignAfterOpenBracketEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AlignAfterOpenBracketEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AlignAfterOpenBracketEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AlignAfterOpenBracketEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public AlignAfterOpenBracketEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AlignAfterOpenBracketEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AlignAfterOpenBracketEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public AlignAfterOpenBracketEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<AlignAfterOpenBracketEntity>(_idx);
            }
        ...
        /// <param name="matchAlwaysBreak">Match 3rd item.</param>
        /// <param name="matchBlockIndent">Match 4th item.</param>
        ...
        public TResult Match<TContext, TResult>(
            ...
            Func<TContext, TResult> matchAlwaysBreak,
            Func<TContext, TResult> matchBlockIndent,
...
#endif
        {
            ...
            {
                return matchAlwaysBreak(context);
            }

            if (this.ValueEquals(Constants.Enum4))
            {
                return matchBlockIndent(context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Func<TResult> matchAlwaysBreak,
            Func<TResult> matchBlockIndent,
            Func<TResult> defaultMatch)
        {
            ...
            if (this.ValueEquals(Constants.Enum3))
            {
                return matchAlwaysBreak();
            }

            if (this.ValueEquals(Constants.Enum4))
            {
                return matchBlockIndent();
            }
