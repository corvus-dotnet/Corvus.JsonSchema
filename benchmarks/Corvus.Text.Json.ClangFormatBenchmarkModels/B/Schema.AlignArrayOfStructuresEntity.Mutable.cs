...
public readonly partial struct Schema
{
    ...
    public readonly partial struct AlignArrayOfStructuresEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(AlignArrayOfStructuresEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="AlignArrayOfStructuresEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AlignArrayOfStructuresEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AlignArrayOfStructuresEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly AlignArrayOfStructuresEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly AlignArrayOfStructuresEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<AlignArrayOfStructuresEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(AlignArrayOfStructuresEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<AlignArrayOfStructuresEntity, Mutable>(this);
        }
    }
}
