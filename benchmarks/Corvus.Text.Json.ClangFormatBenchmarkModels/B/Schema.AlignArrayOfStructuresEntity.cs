...
public readonly partial struct Schema
{
    ...
    public readonly partial struct AlignArrayOfStructuresEntity
#if NET8_0_OR_GREATER
        : IJsonElement<AlignArrayOfStructuresEntity>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AlignArrayOfStructuresEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal AlignArrayOfStructuresEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static AlignArrayOfStructuresEntity DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(AlignArrayOfStructuresEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in AlignArrayOfStructuresEntity left, in AlignArrayOfStructuresEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in AlignArrayOfStructuresEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(AlignArrayOfStructuresEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AlignArrayOfStructuresEntity(JsonElement instance)
        {
            return AlignArrayOfStructuresEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AlignArrayOfStructuresEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AlignArrayOfStructuresEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AlignArrayOfStructuresEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AlignArrayOfStructuresEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AlignArrayOfStructuresEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AlignArrayOfStructuresEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AlignArrayOfStructuresEntity>(json, options);
        }
        ...
        /// </exception>
        public static AlignArrayOfStructuresEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<AlignArrayOfStructuresEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out AlignArrayOfStructuresEntity? result)
        {
            return JsonElementHelpers.TryParseValue<AlignArrayOfStructuresEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AlignArrayOfStructuresEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static AlignArrayOfStructuresEntity IJsonElement<AlignArrayOfStructuresEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AlignArrayOfStructuresEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AlignArrayOfStructuresEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AlignArrayOfStructuresEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public AlignArrayOfStructuresEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AlignArrayOfStructuresEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AlignArrayOfStructuresEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public AlignArrayOfStructuresEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<AlignArrayOfStructuresEntity>(_idx);
            }
