    ...
    public readonly partial struct AlignConsecutiveBitFieldsEntity
    {
        ...
        public readonly partial struct ClangFormat15AlignmentOptions
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.ClangFormatBenchmark.Baseline.JsonBoolean.Mutable AcrossComments
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AcrossCommentsUtf8, out Corvus.ClangFormatBenchmark.Baseline.JsonBoolean.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.ClangFormatBenchmark.Baseline.JsonBoolean.Mutable AcrossEmptyLines
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AcrossEmptyLinesUtf8, out Corvus.ClangFormatBenchmark.Baseline.JsonBoolean.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.ClangFormatBenchmark.Baseline.JsonBoolean.Mutable Enabled
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnabledUtf8, out Corvus.ClangFormatBenchmark.Baseline.JsonBoolean.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetAcrossComments(in Corvus.ClangFormatBenchmark.Baseline.JsonBoolean.Source value)
                {
                    CheckValidInstance();
                    ...
                    else
                    {
                        ...
                        value.AddAsProperty(JsonPropertyNamesEscaped.AcrossComments, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetAcrossEmptyLines(in Corvus.ClangFormatBenchmark.Baseline.JsonBoolean.Source value)
                {
                    CheckValidInstance();
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsProperty(JsonPropertyNamesEscaped.AcrossEmptyLines, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetEnabled(in Corvus.ClangFormatBenchmark.Baseline.JsonBoolean.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.ClangFormatBenchmark.Baseline.Schema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.ClangFormatBenchmark.Baseline.Schema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.ClangFormatBenchmark.Baseline.JsonBoolean.Source acrossComments = default,
                    in Corvus.ClangFormatBenchmark.Baseline.JsonBoolean.Source acrossEmptyLines = default,
                    in Corvus.ClangFormatBenchmark.Baseline.JsonBoolean.Source enabled = default)
                {
                    acrossComments.AddAsProperty(JsonPropertyNamesEscaped.AcrossComments, ref builder, escapeName: false);
                    acrossEmptyLines.AddAsProperty(JsonPropertyNamesEscaped.AcrossEmptyLines, ref builder, escapeName: false);
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.ClangFormatBenchmark.Baseline.JsonBoolean.Source acrossComments = default, in Corvus.ClangFormatBenchmark.Baseline.JsonBoolean.Source acrossEmptyLines = default, in Corvus.ClangFormatBenchmark.Baseline.JsonBoolean.Source enabled = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
