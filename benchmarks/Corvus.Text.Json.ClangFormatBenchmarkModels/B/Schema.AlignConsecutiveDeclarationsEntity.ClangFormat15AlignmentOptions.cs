...
public readonly partial struct Schema
{
    ...
    public readonly partial struct AlignConsecutiveDeclarationsEntity
    {
        ...
        public readonly partial struct ClangFormat15AlignmentOptions
            ...
            : IJsonElement<ClangFormat15AlignmentOptions>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ClangFormat15AlignmentOptions"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ClangFormat15AlignmentOptions(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ClangFormat15AlignmentOptions DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.ClangFormatBenchmark.Baseline.JsonBoolean AcrossComments
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AcrossCommentsUtf8, out Corvus.ClangFormatBenchmark.Baseline.JsonBoolean value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.ClangFormatBenchmark.Baseline.JsonBoolean AcrossEmptyLines
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AcrossEmptyLinesUtf8, out Corvus.ClangFormatBenchmark.Baseline.JsonBoolean value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.ClangFormatBenchmark.Baseline.JsonBoolean Enabled
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnabledUtf8, out Corvus.ClangFormatBenchmark.Baseline.JsonBoolean value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in ClangFormat15AlignmentOptions left, in ClangFormat15AlignmentOptions right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ClangFormat15AlignmentOptions left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(ClangFormat15AlignmentOptions instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ClangFormat15AlignmentOptions(JsonElement instance)
            {
                return ClangFormat15AlignmentOptions.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClangFormat15AlignmentOptions From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClangFormat15AlignmentOptions ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClangFormat15AlignmentOptions>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClangFormat15AlignmentOptions ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClangFormat15AlignmentOptions>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClangFormat15AlignmentOptions ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClangFormat15AlignmentOptions>(json, options);
            }
            ...
            /// </exception>
            public static ClangFormat15AlignmentOptions ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ClangFormat15AlignmentOptions>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ClangFormat15AlignmentOptions? result)
            {
                return JsonElementHelpers.TryParseValue<ClangFormat15AlignmentOptions>(ref reader, out result);
            }
...
#if NET
            static ClangFormat15AlignmentOptions IJsonElement<ClangFormat15AlignmentOptions>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ClangFormat15AlignmentOptions: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ClangFormat15AlignmentOptions Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ClangFormat15AlignmentOptions Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ClangFormat15AlignmentOptions>(_idx);
                }
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="AcrossComments"/>.
                /// </summary>
                public const string AcrossComments = "AcrossComments";

                /// <summary>
                /// Gets the JSON property name for <see cref="AcrossEmptyLines"/>.
                /// </summary>
                public const string AcrossEmptyLines = "AcrossEmptyLines";
                ...
                /// Gets the JSON property name for <see cref="AcrossComments"/>.
                /// </summary>
                public static ReadOnlySpan<byte> AcrossCommentsUtf8 => "AcrossComments"u8;

                /// <summary>
                /// Gets the JSON property name for <see cref="AcrossEmptyLines"/>.
                /// </summary>
                public static ReadOnlySpan<byte> AcrossEmptyLinesUtf8 => "AcrossEmptyLines"u8;
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="AcrossComments"/>.
                /// </summary>
                public static ReadOnlySpan<byte> AcrossComments => "AcrossComments"u8;

                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="AcrossEmptyLines"/>.
                /// </summary>
                public static ReadOnlySpan<byte> AcrossEmptyLines => "AcrossEmptyLines"u8;
