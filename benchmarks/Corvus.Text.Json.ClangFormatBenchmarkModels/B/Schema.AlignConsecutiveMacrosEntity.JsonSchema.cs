...
public readonly partial struct Schema
{
    ...
    public readonly partial struct AlignConsecutiveMacrosEntity
        : IJsonElement<AlignConsecutiveMacrosEntity>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/clang-format.json#/properties/AlignConsecutiveMacros"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://json.schemastore.org/clang-format.json#/properties/AlignConsecutiveMacros";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/clang-format.json#/properties/AlignConsecutiveMacros"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext oneOfContext0 =
                    Corvus.ClangFormatBenchmark.Baseline.Schema.AlignConsecutiveMacrosEntity.ClangFormat9StyleOfAligningConsecutiveMacros.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                Corvus.ClangFormatBenchmark.Baseline.Schema.AlignConsecutiveMacrosEntity.ClangFormat9StyleOfAligningConsecutiveMacros.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
                ...
                JsonSchemaContext oneOfContext1 =
                    Corvus.ClangFormatBenchmark.Baseline.Schema.AlignConsecutiveMacrosEntity.ClangFormat15AlignmentOptions.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                Corvus.ClangFormatBenchmark.Baseline.Schema.AlignConsecutiveMacrosEntity.ClangFormat15AlignmentOptions.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
