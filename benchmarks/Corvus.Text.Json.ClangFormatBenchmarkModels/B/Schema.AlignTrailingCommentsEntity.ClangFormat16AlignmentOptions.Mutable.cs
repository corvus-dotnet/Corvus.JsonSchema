    ...
    public readonly partial struct AlignTrailingCommentsEntity
    {
        ...
        public readonly partial struct ClangFormat16AlignmentOptions
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ClangFormat16AlignmentOptions instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ClangFormat16AlignmentOptions"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ClangFormat16AlignmentOptions(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.ClangFormatBenchmark.Baseline.Schema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.SpecifiesTheWayToAlignTrailingComments.Mutable Kind
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KindUtf8, out Corvus.ClangFormatBenchmark.Baseline.Schema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.SpecifiesTheWayToAlignTrailingComments.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.ClangFormatBenchmark.Baseline.Schema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.HowManyEmptyLinesToApplyAlignment.Mutable OverEmptyLines
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OverEmptyLinesUtf8, out Corvus.ClangFormatBenchmark.Baseline.Schema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.HowManyEmptyLinesToApplyAlignment.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetKind(in Corvus.ClangFormatBenchmark.Baseline.Schema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.SpecifiesTheWayToAlignTrailingComments.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetOverEmptyLines(in Corvus.ClangFormatBenchmark.Baseline.Schema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.HowManyEmptyLinesToApplyAlignment.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.OverEmptyLinesUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OverEmptyLinesUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                /// <summary>
                /// Remove the <c>OverEmptyLines</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveOverEmptyLines()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.OverEmptyLinesUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ClangFormat16AlignmentOptions.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ClangFormat16AlignmentOptions Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ClangFormat16AlignmentOptions Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ClangFormat16AlignmentOptions>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.ClangFormatBenchmark.Baseline.Schema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(ClangFormat16AlignmentOptions instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.ClangFormatBenchmark.Baseline.Schema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="ClangFormat16AlignmentOptions"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.ClangFormatBenchmark.Baseline.Schema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.SpecifiesTheWayToAlignTrailingComments.Source kind = default,
                    in Corvus.ClangFormatBenchmark.Baseline.Schema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.HowManyEmptyLinesToApplyAlignment.Source overEmptyLines = default)
                {
                ...
                /// Creates an instance of a <see cref="ClangFormat16AlignmentOptions"/>.
                /// </summary>
                public void Create(in Corvus.ClangFormatBenchmark.Baseline.Schema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.SpecifiesTheWayToAlignTrailingComments.Source kind = default, in Corvus.ClangFormatBenchmark.Baseline.Schema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.HowManyEmptyLinesToApplyAlignment.Source overEmptyLines = default)
                {
                    Create(ref _builder, kind, overEmptyLines);
                }
            ...
            /// <param name="overEmptyLines">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.ClangFormatBenchmark.Baseline.Schema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.SpecifiesTheWayToAlignTrailingComments.Source kind = default, in Corvus.ClangFormatBenchmark.Baseline.Schema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.HowManyEmptyLinesToApplyAlignment.Source overEmptyLines = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(kind, overEmptyLines);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<ClangFormat16AlignmentOptions, Mutable>(this);
            }
        }
    }
}
