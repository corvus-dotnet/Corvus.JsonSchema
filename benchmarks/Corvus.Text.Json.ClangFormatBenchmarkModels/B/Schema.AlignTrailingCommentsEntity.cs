...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public static explicit operator Corvus.ClangFormatBenchmark.Baseline.Schema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions(AlignTrailingCommentsEntity value)
        {
            return Corvus.ClangFormatBenchmark.Baseline.Schema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AlignTrailingCommentsEntity(Corvus.ClangFormatBenchmark.Baseline.Schema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions value)
        {
            return From(value);
        }
        ...
        public bool TryGetAsClangFormat16AlignmentOptions(out Corvus.ClangFormatBenchmark.Baseline.Schema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions result)
        {
            ...
            {
                result = Corvus.ClangFormatBenchmark.Baseline.Schema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.ClangFormatBenchmark.Baseline.Schema.AlignTrailingCommentsEntity, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            if (Corvus.ClangFormatBenchmark.Baseline.Schema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchClangFormat16AlignmentOptions(Corvus.ClangFormatBenchmark.Baseline.Schema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.ClangFormatBenchmark.Baseline.Schema.AlignTrailingCommentsEntity, TResult> defaultMatch)
        {
            if (Corvus.ClangFormatBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            if (Corvus.ClangFormatBenchmark.Baseline.Schema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchClangFormat16AlignmentOptions(Corvus.ClangFormatBenchmark.Baseline.Schema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.From(this));
            }
