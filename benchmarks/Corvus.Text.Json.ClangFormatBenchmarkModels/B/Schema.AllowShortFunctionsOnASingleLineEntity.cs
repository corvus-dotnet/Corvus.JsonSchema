...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AllowShortFunctionsOnASingleLineEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal AllowShortFunctionsOnASingleLineEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static AllowShortFunctionsOnASingleLineEntity DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(AllowShortFunctionsOnASingleLineEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in AllowShortFunctionsOnASingleLineEntity left, in AllowShortFunctionsOnASingleLineEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in AllowShortFunctionsOnASingleLineEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(AllowShortFunctionsOnASingleLineEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AllowShortFunctionsOnASingleLineEntity(JsonElement instance)
        {
            return AllowShortFunctionsOnASingleLineEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllowShortFunctionsOnASingleLineEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllowShortFunctionsOnASingleLineEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AllowShortFunctionsOnASingleLineEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllowShortFunctionsOnASingleLineEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AllowShortFunctionsOnASingleLineEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllowShortFunctionsOnASingleLineEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AllowShortFunctionsOnASingleLineEntity>(json, options);
        }
        ...
        /// </exception>
        public static AllowShortFunctionsOnASingleLineEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<AllowShortFunctionsOnASingleLineEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out AllowShortFunctionsOnASingleLineEntity? result)
        {
            return JsonElementHelpers.TryParseValue<AllowShortFunctionsOnASingleLineEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AllowShortFunctionsOnASingleLineEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static AllowShortFunctionsOnASingleLineEntity IJsonElement<AllowShortFunctionsOnASingleLineEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AllowShortFunctionsOnASingleLineEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AllowShortFunctionsOnASingleLineEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AllowShortFunctionsOnASingleLineEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public AllowShortFunctionsOnASingleLineEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AllowShortFunctionsOnASingleLineEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AllowShortFunctionsOnASingleLineEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public AllowShortFunctionsOnASingleLineEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<AllowShortFunctionsOnASingleLineEntity>(_idx);
            }
        ...
        /// <param name="matchEmpty">Match 4th item.</param>
        /// <param name="matchInlineOnly">Match 5th item.</param>
        ...
        public TResult Match<TContext, TResult>(
            ...
            Func<TContext, TResult> matchInlineOnly,
...
#endif
        {
            ...
            {
                return matchInlineOnly(context);
            }
