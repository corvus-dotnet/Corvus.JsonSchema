...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AllowShortIfStatementsOnASingleLineEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal AllowShortIfStatementsOnASingleLineEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static AllowShortIfStatementsOnASingleLineEntity DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(AllowShortIfStatementsOnASingleLineEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in AllowShortIfStatementsOnASingleLineEntity left, in AllowShortIfStatementsOnASingleLineEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in AllowShortIfStatementsOnASingleLineEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(AllowShortIfStatementsOnASingleLineEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AllowShortIfStatementsOnASingleLineEntity(JsonElement instance)
        {
            return AllowShortIfStatementsOnASingleLineEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllowShortIfStatementsOnASingleLineEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllowShortIfStatementsOnASingleLineEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AllowShortIfStatementsOnASingleLineEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllowShortIfStatementsOnASingleLineEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AllowShortIfStatementsOnASingleLineEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllowShortIfStatementsOnASingleLineEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AllowShortIfStatementsOnASingleLineEntity>(json, options);
        }
        ...
        /// </exception>
        public static AllowShortIfStatementsOnASingleLineEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<AllowShortIfStatementsOnASingleLineEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out AllowShortIfStatementsOnASingleLineEntity? result)
        {
            return JsonElementHelpers.TryParseValue<AllowShortIfStatementsOnASingleLineEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AllowShortIfStatementsOnASingleLineEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static AllowShortIfStatementsOnASingleLineEntity IJsonElement<AllowShortIfStatementsOnASingleLineEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AllowShortIfStatementsOnASingleLineEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AllowShortIfStatementsOnASingleLineEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AllowShortIfStatementsOnASingleLineEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public AllowShortIfStatementsOnASingleLineEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AllowShortIfStatementsOnASingleLineEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AllowShortIfStatementsOnASingleLineEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public AllowShortIfStatementsOnASingleLineEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<AllowShortIfStatementsOnASingleLineEntity>(_idx);
            }
        ...
        /// <param name="matchAllIfsAndElse">Match 1st item.</param>
        /// <param name="matchNever">Match 2nd item.</param>
        /// <param name="matchWithoutElse">Match 3rd item.</param>
        /// <param name="matchOnlyFirstIf">Match 4th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchAllIfsAndElse,
            Func<TContext, TResult> matchNever,
            Func<TContext, TResult> matchWithoutElse,
            Func<TContext, TResult> matchOnlyFirstIf,
...
#endif
        {
            ...
            {
                return matchAllIfsAndElse(context);
            }
            ...
            {
                return matchWithoutElse(context);
            }

            if (this.ValueEquals(Constants.Enum4))
            {
                return matchOnlyFirstIf(context);
            }
        ...
        public TResult Match<TResult>(
            Func<TResult> matchAllIfsAndElse,
            Func<TResult> matchNever,
            Func<TResult> matchWithoutElse,
            Func<TResult> matchOnlyFirstIf,
            Func<TResult> defaultMatch)
        {
            if (this.ValueEquals(Constants.Enum1))
            {
                return matchAllIfsAndElse();
            }
            ...
            if (this.ValueEquals(Constants.Enum3))
            {
                return matchWithoutElse();
            }

            if (this.ValueEquals(Constants.Enum4))
            {
                return matchOnlyFirstIf();
            }
