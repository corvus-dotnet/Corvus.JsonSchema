...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AllowShortLambdasOnASingleLineEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal AllowShortLambdasOnASingleLineEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static AllowShortLambdasOnASingleLineEntity DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(AllowShortLambdasOnASingleLineEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in AllowShortLambdasOnASingleLineEntity left, in AllowShortLambdasOnASingleLineEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in AllowShortLambdasOnASingleLineEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(AllowShortLambdasOnASingleLineEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AllowShortLambdasOnASingleLineEntity(JsonElement instance)
        {
            return AllowShortLambdasOnASingleLineEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllowShortLambdasOnASingleLineEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllowShortLambdasOnASingleLineEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AllowShortLambdasOnASingleLineEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllowShortLambdasOnASingleLineEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AllowShortLambdasOnASingleLineEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllowShortLambdasOnASingleLineEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AllowShortLambdasOnASingleLineEntity>(json, options);
        }
        ...
        /// </exception>
        public static AllowShortLambdasOnASingleLineEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<AllowShortLambdasOnASingleLineEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out AllowShortLambdasOnASingleLineEntity? result)
        {
            return JsonElementHelpers.TryParseValue<AllowShortLambdasOnASingleLineEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AllowShortLambdasOnASingleLineEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static AllowShortLambdasOnASingleLineEntity IJsonElement<AllowShortLambdasOnASingleLineEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AllowShortLambdasOnASingleLineEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AllowShortLambdasOnASingleLineEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AllowShortLambdasOnASingleLineEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public AllowShortLambdasOnASingleLineEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AllowShortLambdasOnASingleLineEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AllowShortLambdasOnASingleLineEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public AllowShortLambdasOnASingleLineEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<AllowShortLambdasOnASingleLineEntity>(_idx);
            }
        ...
        /// <param name="matchEmpty">Match 2nd item.</param>
        /// <param name="matchInline">Match 3rd item.</param>
        /// <param name="matchAll">Match 4th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchNone,
            Func<TContext, TResult> matchEmpty,
