...
public readonly partial struct Schema
{
    ...
    public readonly partial struct AlwaysBreakAfterDefinitionReturnTypeEntity
#if NET8_0_OR_GREATER
        : IJsonElement<AlwaysBreakAfterDefinitionReturnTypeEntity>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AlwaysBreakAfterDefinitionReturnTypeEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal AlwaysBreakAfterDefinitionReturnTypeEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static AlwaysBreakAfterDefinitionReturnTypeEntity DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(AlwaysBreakAfterDefinitionReturnTypeEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in AlwaysBreakAfterDefinitionReturnTypeEntity left, in AlwaysBreakAfterDefinitionReturnTypeEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in AlwaysBreakAfterDefinitionReturnTypeEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(AlwaysBreakAfterDefinitionReturnTypeEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AlwaysBreakAfterDefinitionReturnTypeEntity(JsonElement instance)
        {
            return AlwaysBreakAfterDefinitionReturnTypeEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AlwaysBreakAfterDefinitionReturnTypeEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AlwaysBreakAfterDefinitionReturnTypeEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AlwaysBreakAfterDefinitionReturnTypeEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AlwaysBreakAfterDefinitionReturnTypeEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AlwaysBreakAfterDefinitionReturnTypeEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AlwaysBreakAfterDefinitionReturnTypeEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AlwaysBreakAfterDefinitionReturnTypeEntity>(json, options);
        }
        ...
        /// </exception>
        public static AlwaysBreakAfterDefinitionReturnTypeEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<AlwaysBreakAfterDefinitionReturnTypeEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out AlwaysBreakAfterDefinitionReturnTypeEntity? result)
        {
            return JsonElementHelpers.TryParseValue<AlwaysBreakAfterDefinitionReturnTypeEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AlwaysBreakAfterDefinitionReturnTypeEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static AlwaysBreakAfterDefinitionReturnTypeEntity IJsonElement<AlwaysBreakAfterDefinitionReturnTypeEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AlwaysBreakAfterDefinitionReturnTypeEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AlwaysBreakAfterDefinitionReturnTypeEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AlwaysBreakAfterDefinitionReturnTypeEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public AlwaysBreakAfterDefinitionReturnTypeEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AlwaysBreakAfterDefinitionReturnTypeEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AlwaysBreakAfterDefinitionReturnTypeEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public AlwaysBreakAfterDefinitionReturnTypeEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<AlwaysBreakAfterDefinitionReturnTypeEntity>(_idx);
            }
        ...
        /// <param name="matchAll">Match 2nd item.</param>
        /// <param name="matchTopLevel">Match 3rd item.</param>
        ...
        public TResult Match<TContext, TResult>(
            ...
            Func<TContext, TResult> matchTopLevel,
