...
public readonly partial struct Schema
{
    ...
    public readonly partial struct AlwaysBreakAfterReturnTypeEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(AlwaysBreakAfterReturnTypeEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="AlwaysBreakAfterReturnTypeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AlwaysBreakAfterReturnTypeEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new AlwaysBreakAfterReturnTypeEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AlwaysBreakAfterReturnTypeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="AlwaysBreakAfterReturnTypeEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="AlwaysBreakAfterReturnTypeEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly AlwaysBreakAfterReturnTypeEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<AlwaysBreakAfterReturnTypeEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="AlwaysBreakAfterReturnTypeEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly AlwaysBreakAfterReturnTypeEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<AlwaysBreakAfterReturnTypeEntity>(_idx);
            }
            ...
            /// <param name="matchAllDefinitions">Match 4th item.</param>
            /// <param name="matchTopLevelDefinitions">Match 5th item.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Func<TContext, TResult> matchAllDefinitions,
                Func<TContext, TResult> matchTopLevelDefinitions,
...
#endif
            {
                ...
                {
                    return matchAllDefinitions(context);
                }

                if (this.ValueEquals(Constants.Enum5))
                {
                    return matchTopLevelDefinitions(context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Func<TResult> matchAllDefinitions,
                Func<TResult> matchTopLevelDefinitions,
                Func<TResult> defaultMatch)
            {
                ...
                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchAllDefinitions();
                }

                if (this.ValueEquals(Constants.Enum5))
                {
                    return matchTopLevelDefinitions();
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(AlwaysBreakAfterReturnTypeEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<AlwaysBreakAfterReturnTypeEntity, Mutable>(this);
        }
    }
}
