...
public readonly partial struct Schema
{
    ...
    public readonly partial struct BasedOnStyleEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(BasedOnStyleEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BasedOnStyleEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BasedOnStyleEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new BasedOnStyleEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BasedOnStyleEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="BasedOnStyleEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="BasedOnStyleEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly BasedOnStyleEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<BasedOnStyleEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="BasedOnStyleEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly BasedOnStyleEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<BasedOnStyleEntity>(_idx);
            }
            ...
            /// <param name="matchChromium">Match 1st item.</param>
            /// <param name="matchGoogle">Match 2nd item.</param>
            /// <param name="matchLlvm">Match 3rd item.</param>
            /// <param name="matchMozilla">Match 4th item.</param>
            /// <param name="matchWebKit">Match 5th item.</param>
            /// <param name="matchMicrosoft">Match 6th item.</param>
            /// <param name="matchGnu">Match 7th item.</param>
            /// <param name="matchInheritParentConfig">Match 8th item.</param>
            /// <param name="matchChromium1">Match 9th item.</param>
            /// <param name="matchGoogle1">Match 10th item.</param>
            /// <param name="matchLlvm1">Match 11th item.</param>
            /// <param name="matchMozilla1">Match 12th item.</param>
            /// <param name="matchWebkit">Match 13th item.</param>
            /// <param name="matchMicrosoft1">Match 14th item.</param>
            /// <param name="matchGnu1">Match 15th item.</param>
            /// <param name="matchInheritparentconfig">Match 16th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchChromium,
                Func<TContext, TResult> matchGoogle,
                Func<TContext, TResult> matchLlvm,
                Func<TContext, TResult> matchMozilla,
                Func<TContext, TResult> matchWebKit,
                Func<TContext, TResult> matchMicrosoft,
                Func<TContext, TResult> matchGnu,
                Func<TContext, TResult> matchInheritParentConfig,
                Func<TContext, TResult> matchChromium1,
                Func<TContext, TResult> matchGoogle1,
                Func<TContext, TResult> matchLlvm1,
                Func<TContext, TResult> matchMozilla1,
                Func<TContext, TResult> matchWebkit,
                Func<TContext, TResult> matchMicrosoft1,
                Func<TContext, TResult> matchGnu1,
                Func<TContext, TResult> matchInheritparentconfig,
...
#endif
            {
                ...
                {
                    return matchMicrosoft1(context);
                }

                if (this.ValueEquals(Constants.Enum15))
                {
                    return matchGnu1(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchChromium,
                Func<TResult> matchGoogle,
                Func<TResult> matchLlvm,
                Func<TResult> matchMozilla,
                Func<TResult> matchWebKit,
                Func<TResult> matchMicrosoft,
                Func<TResult> matchGnu,
                Func<TResult> matchInheritParentConfig,
                Func<TResult> matchChromium1,
                Func<TResult> matchGoogle1,
                Func<TResult> matchLlvm1,
                Func<TResult> matchMozilla1,
                Func<TResult> matchWebkit,
                Func<TResult> matchMicrosoft1,
                Func<TResult> matchGnu1,
                Func<TResult> matchInheritparentconfig,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchChromium();
                }
                ...
                if (this.ValueEquals(Constants.Enum8))
                {
                    return matchInheritParentConfig();
                }

                if (this.ValueEquals(Constants.Enum9))
                {
                    return matchChromium1();
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(BasedOnStyleEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<BasedOnStyleEntity, Mutable>(this);
        }
    }
}
