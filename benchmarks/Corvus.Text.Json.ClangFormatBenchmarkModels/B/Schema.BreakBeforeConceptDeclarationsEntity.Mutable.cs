...
public readonly partial struct Schema
{
    ...
    public readonly partial struct BreakBeforeConceptDeclarationsEntity
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.ClangFormatBenchmark.Baseline.Schema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse.Mutable(Mutable value)
            {
                return Corvus.ClangFormatBenchmark.Baseline.Schema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.ClangFormatBenchmark.Baseline.Schema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse.Mutable value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.ClangFormatBenchmark.Baseline.Schema.BreakBeforeConceptDeclarationsEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchClangFormat12TheConceptDeclarationStyleToUse(Corvus.ClangFormatBenchmark.Baseline.Schema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.ClangFormatBenchmark.Baseline.Schema.BreakBeforeConceptDeclarationsEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.ClangFormatBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.ClangFormatBenchmark.Baseline.Schema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchClangFormat12TheConceptDeclarationStyleToUse(Corvus.ClangFormatBenchmark.Baseline.Schema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse.Mutable.From(this));
                }
            ...
            public bool TryGetAsClangFormat12TheConceptDeclarationStyleToUse(out Corvus.ClangFormatBenchmark.Baseline.Schema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse result)
            {
                if (Corvus.ClangFormatBenchmark.Baseline.Schema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.ClangFormatBenchmark.Baseline.Schema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.ClangFormatBenchmark.Baseline.Schema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse instance) => new(JsonElement.From(instance));
