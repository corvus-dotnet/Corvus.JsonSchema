...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ClangFormat14ThePenaltyForBreakingAfter
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ClangFormat14ThePenaltyForBreakingAfter instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ClangFormat14ThePenaltyForBreakingAfter"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ClangFormat14ThePenaltyForBreakingAfter(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ClangFormat14ThePenaltyForBreakingAfter(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ClangFormat14ThePenaltyForBreakingAfter.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ClangFormat14ThePenaltyForBreakingAfter"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ClangFormat14ThePenaltyForBreakingAfter"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ClangFormat14ThePenaltyForBreakingAfter Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ClangFormat14ThePenaltyForBreakingAfter>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ClangFormat14ThePenaltyForBreakingAfter"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ClangFormat14ThePenaltyForBreakingAfter Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ClangFormat14ThePenaltyForBreakingAfter>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ClangFormat14ThePenaltyForBreakingAfter instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ClangFormat14ThePenaltyForBreakingAfter, Mutable>(this);
        }
    }
}
