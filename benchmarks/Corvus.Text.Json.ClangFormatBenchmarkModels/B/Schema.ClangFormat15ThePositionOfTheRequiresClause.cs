...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClangFormat15ThePositionOfTheRequiresClause"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ClangFormat15ThePositionOfTheRequiresClause(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ClangFormat15ThePositionOfTheRequiresClause DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(ClangFormat15ThePositionOfTheRequiresClause value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in ClangFormat15ThePositionOfTheRequiresClause left, in ClangFormat15ThePositionOfTheRequiresClause right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ClangFormat15ThePositionOfTheRequiresClause left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ClangFormat15ThePositionOfTheRequiresClause instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ClangFormat15ThePositionOfTheRequiresClause(JsonElement instance)
        {
            return ClangFormat15ThePositionOfTheRequiresClause.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat15ThePositionOfTheRequiresClause From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat15ThePositionOfTheRequiresClause ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClangFormat15ThePositionOfTheRequiresClause>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat15ThePositionOfTheRequiresClause ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClangFormat15ThePositionOfTheRequiresClause>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat15ThePositionOfTheRequiresClause ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClangFormat15ThePositionOfTheRequiresClause>(json, options);
        }
        ...
        /// </exception>
        public static ClangFormat15ThePositionOfTheRequiresClause ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ClangFormat15ThePositionOfTheRequiresClause>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ClangFormat15ThePositionOfTheRequiresClause? result)
        {
            return JsonElementHelpers.TryParseValue<ClangFormat15ThePositionOfTheRequiresClause>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ClangFormat15ThePositionOfTheRequiresClause(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ClangFormat15ThePositionOfTheRequiresClause IJsonElement<ClangFormat15ThePositionOfTheRequiresClause>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ClangFormat15ThePositionOfTheRequiresClause: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ClangFormat15ThePositionOfTheRequiresClause"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ClangFormat15ThePositionOfTheRequiresClause"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ClangFormat15ThePositionOfTheRequiresClause Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ClangFormat15ThePositionOfTheRequiresClause>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ClangFormat15ThePositionOfTheRequiresClause"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ClangFormat15ThePositionOfTheRequiresClause Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ClangFormat15ThePositionOfTheRequiresClause>(_idx);
            }
        ...
        /// <param name="matchOwnLine">Match 1st item.</param>
        /// <param name="matchWithPreceding">Match 2nd item.</param>
        /// <param name="matchWithFollowing">Match 3rd item.</param>
        /// <param name="matchSingleLine">Match 4th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchOwnLine,
            Func<TContext, TResult> matchWithPreceding,
            Func<TContext, TResult> matchWithFollowing,
            Func<TContext, TResult> matchSingleLine,
...
#endif
        {
            ...
            {
                return matchOwnLine(context);
            }

            if (this.ValueEquals(Constants.Enum2))
            {
                return matchWithPreceding(context);
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchWithFollowing(context);
            }

            if (this.ValueEquals(Constants.Enum4))
            {
                return matchSingleLine(context);
            }
        ...
        public TResult Match<TResult>(
            Func<TResult> matchOwnLine,
            Func<TResult> matchWithPreceding,
            Func<TResult> matchWithFollowing,
            Func<TResult> matchSingleLine,
            Func<TResult> defaultMatch)
        {
            ...
            if (this.ValueEquals(Constants.Enum2))
            {
                return matchWithPreceding();
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchWithFollowing();
            }

            if (this.ValueEquals(Constants.Enum4))
            {
                return matchSingleLine();
            }
