...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ClangFormat16LineEndingStyleNOrRNToUse
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ClangFormat16LineEndingStyleNOrRNToUse instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ClangFormat16LineEndingStyleNOrRNToUse"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ClangFormat16LineEndingStyleNOrRNToUse(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ClangFormat16LineEndingStyleNOrRNToUse.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ClangFormat16LineEndingStyleNOrRNToUse Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ClangFormat16LineEndingStyleNOrRNToUse Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ClangFormat16LineEndingStyleNOrRNToUse>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ClangFormat16LineEndingStyleNOrRNToUse instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ClangFormat16LineEndingStyleNOrRNToUse, Mutable>(this);
        }
    }
}
