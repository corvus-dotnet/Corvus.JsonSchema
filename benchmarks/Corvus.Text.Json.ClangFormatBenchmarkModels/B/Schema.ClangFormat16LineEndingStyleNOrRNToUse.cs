...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClangFormat16LineEndingStyleNOrRNToUse"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ClangFormat16LineEndingStyleNOrRNToUse(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ClangFormat16LineEndingStyleNOrRNToUse DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(ClangFormat16LineEndingStyleNOrRNToUse value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in ClangFormat16LineEndingStyleNOrRNToUse left, in ClangFormat16LineEndingStyleNOrRNToUse right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ClangFormat16LineEndingStyleNOrRNToUse left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ClangFormat16LineEndingStyleNOrRNToUse instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ClangFormat16LineEndingStyleNOrRNToUse(JsonElement instance)
        {
            return ClangFormat16LineEndingStyleNOrRNToUse.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat16LineEndingStyleNOrRNToUse From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat16LineEndingStyleNOrRNToUse ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClangFormat16LineEndingStyleNOrRNToUse>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat16LineEndingStyleNOrRNToUse ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClangFormat16LineEndingStyleNOrRNToUse>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat16LineEndingStyleNOrRNToUse ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClangFormat16LineEndingStyleNOrRNToUse>(json, options);
        }
        ...
        /// </exception>
        public static ClangFormat16LineEndingStyleNOrRNToUse ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ClangFormat16LineEndingStyleNOrRNToUse>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ClangFormat16LineEndingStyleNOrRNToUse? result)
        {
            return JsonElementHelpers.TryParseValue<ClangFormat16LineEndingStyleNOrRNToUse>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ClangFormat16LineEndingStyleNOrRNToUse(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ClangFormat16LineEndingStyleNOrRNToUse IJsonElement<ClangFormat16LineEndingStyleNOrRNToUse>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ClangFormat16LineEndingStyleNOrRNToUse: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ClangFormat16LineEndingStyleNOrRNToUse"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ClangFormat16LineEndingStyleNOrRNToUse"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ClangFormat16LineEndingStyleNOrRNToUse Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ClangFormat16LineEndingStyleNOrRNToUse>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ClangFormat16LineEndingStyleNOrRNToUse"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ClangFormat16LineEndingStyleNOrRNToUse Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ClangFormat16LineEndingStyleNOrRNToUse>(_idx);
            }
        ...
        /// <param name="matchLf">Match 1st item.</param>
        /// <param name="matchCrlf">Match 2nd item.</param>
        /// <param name="matchDeriveLf">Match 3rd item.</param>
        /// <param name="matchDeriveCrlf">Match 4th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchLf,
            Func<TContext, TResult> matchCrlf,
            Func<TContext, TResult> matchDeriveLf,
            Func<TContext, TResult> matchDeriveCrlf,
        ...
        public TResult Match<TResult>(
            Func<TResult> matchLf,
            Func<TResult> matchCrlf,
            Func<TResult> matchDeriveLf,
            Func<TResult> matchDeriveCrlf,
            Func<TResult> defaultMatch)
        {
            ...
            if (this.ValueEquals(Constants.Enum3))
            {
                return matchDeriveLf();
            }

            if (this.ValueEquals(Constants.Enum4))
            {
                return matchDeriveCrlf();
            }
