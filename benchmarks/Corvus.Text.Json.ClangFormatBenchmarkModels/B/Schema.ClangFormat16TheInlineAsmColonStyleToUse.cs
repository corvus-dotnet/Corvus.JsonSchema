...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ClangFormat16TheInlineAsmColonStyleToUse
#if NET8_0_OR_GREATER
        : IJsonElement<ClangFormat16TheInlineAsmColonStyleToUse>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClangFormat16TheInlineAsmColonStyleToUse"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ClangFormat16TheInlineAsmColonStyleToUse(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ClangFormat16TheInlineAsmColonStyleToUse DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(ClangFormat16TheInlineAsmColonStyleToUse value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in ClangFormat16TheInlineAsmColonStyleToUse left, in ClangFormat16TheInlineAsmColonStyleToUse right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ClangFormat16TheInlineAsmColonStyleToUse left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ClangFormat16TheInlineAsmColonStyleToUse instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ClangFormat16TheInlineAsmColonStyleToUse(JsonElement instance)
        {
            return ClangFormat16TheInlineAsmColonStyleToUse.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat16TheInlineAsmColonStyleToUse From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat16TheInlineAsmColonStyleToUse ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClangFormat16TheInlineAsmColonStyleToUse>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat16TheInlineAsmColonStyleToUse ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClangFormat16TheInlineAsmColonStyleToUse>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat16TheInlineAsmColonStyleToUse ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClangFormat16TheInlineAsmColonStyleToUse>(json, options);
        }
        ...
        /// </exception>
        public static ClangFormat16TheInlineAsmColonStyleToUse ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ClangFormat16TheInlineAsmColonStyleToUse>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ClangFormat16TheInlineAsmColonStyleToUse? result)
        {
            return JsonElementHelpers.TryParseValue<ClangFormat16TheInlineAsmColonStyleToUse>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ClangFormat16TheInlineAsmColonStyleToUse(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ClangFormat16TheInlineAsmColonStyleToUse IJsonElement<ClangFormat16TheInlineAsmColonStyleToUse>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ClangFormat16TheInlineAsmColonStyleToUse: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ClangFormat16TheInlineAsmColonStyleToUse"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ClangFormat16TheInlineAsmColonStyleToUse"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ClangFormat16TheInlineAsmColonStyleToUse Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ClangFormat16TheInlineAsmColonStyleToUse>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ClangFormat16TheInlineAsmColonStyleToUse"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ClangFormat16TheInlineAsmColonStyleToUse Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ClangFormat16TheInlineAsmColonStyleToUse>(_idx);
            }
        ...
        /// <param name="matchOnlyMultiline">Match 2nd item.</param>
        ...
        public TResult Match<TContext, TResult>(
            ...
            Func<TContext, TResult> matchOnlyMultiline,
...
#endif
        {
            ...
            {
                return matchOnlyMultiline(context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Func<TResult> matchOnlyMultiline,
