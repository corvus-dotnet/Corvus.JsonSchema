...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClangFormat36TheWayToWrapBinaryOperators"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ClangFormat36TheWayToWrapBinaryOperators(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ClangFormat36TheWayToWrapBinaryOperators DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(ClangFormat36TheWayToWrapBinaryOperators value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in ClangFormat36TheWayToWrapBinaryOperators left, in ClangFormat36TheWayToWrapBinaryOperators right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ClangFormat36TheWayToWrapBinaryOperators left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ClangFormat36TheWayToWrapBinaryOperators instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ClangFormat36TheWayToWrapBinaryOperators(JsonElement instance)
        {
            return ClangFormat36TheWayToWrapBinaryOperators.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat36TheWayToWrapBinaryOperators From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat36TheWayToWrapBinaryOperators ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClangFormat36TheWayToWrapBinaryOperators>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat36TheWayToWrapBinaryOperators ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClangFormat36TheWayToWrapBinaryOperators>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat36TheWayToWrapBinaryOperators ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClangFormat36TheWayToWrapBinaryOperators>(json, options);
        }
        ...
        /// </exception>
        public static ClangFormat36TheWayToWrapBinaryOperators ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ClangFormat36TheWayToWrapBinaryOperators>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ClangFormat36TheWayToWrapBinaryOperators? result)
        {
            return JsonElementHelpers.TryParseValue<ClangFormat36TheWayToWrapBinaryOperators>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ClangFormat36TheWayToWrapBinaryOperators(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ClangFormat36TheWayToWrapBinaryOperators IJsonElement<ClangFormat36TheWayToWrapBinaryOperators>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ClangFormat36TheWayToWrapBinaryOperators: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ClangFormat36TheWayToWrapBinaryOperators"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ClangFormat36TheWayToWrapBinaryOperators"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ClangFormat36TheWayToWrapBinaryOperators Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ClangFormat36TheWayToWrapBinaryOperators>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ClangFormat36TheWayToWrapBinaryOperators"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ClangFormat36TheWayToWrapBinaryOperators Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ClangFormat36TheWayToWrapBinaryOperators>(_idx);
            }
        ...
        /// <param name="matchNonAssignment">Match 2nd item.</param>
        ...
        public TResult Match<TContext, TResult>(
            ...
            Func<TContext, TResult> matchNonAssignment,
...
#endif
        {
            ...
            {
                return matchNonAssignment(context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Func<TResult> matchNonAssignment,
