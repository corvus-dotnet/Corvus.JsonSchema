...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ClangFormat37TheColumnLimit
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ClangFormat37TheColumnLimit instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ClangFormat37TheColumnLimit"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ClangFormat37TheColumnLimit(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ClangFormat37TheColumnLimit.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ClangFormat37TheColumnLimit Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ClangFormat37TheColumnLimit Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ClangFormat37TheColumnLimit>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ClangFormat37TheColumnLimit instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ClangFormat37TheColumnLimit, Mutable>(this);
        }
    }
}
