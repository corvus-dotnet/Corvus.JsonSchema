...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClangFormat5TheConstructorInitializersStyleToUse"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ClangFormat5TheConstructorInitializersStyleToUse(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ClangFormat5TheConstructorInitializersStyleToUse DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(ClangFormat5TheConstructorInitializersStyleToUse value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in ClangFormat5TheConstructorInitializersStyleToUse left, in ClangFormat5TheConstructorInitializersStyleToUse right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ClangFormat5TheConstructorInitializersStyleToUse left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ClangFormat5TheConstructorInitializersStyleToUse instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ClangFormat5TheConstructorInitializersStyleToUse(JsonElement instance)
        {
            return ClangFormat5TheConstructorInitializersStyleToUse.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat5TheConstructorInitializersStyleToUse From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat5TheConstructorInitializersStyleToUse ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClangFormat5TheConstructorInitializersStyleToUse>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat5TheConstructorInitializersStyleToUse ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClangFormat5TheConstructorInitializersStyleToUse>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat5TheConstructorInitializersStyleToUse ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClangFormat5TheConstructorInitializersStyleToUse>(json, options);
        }
        ...
        /// </exception>
        public static ClangFormat5TheConstructorInitializersStyleToUse ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ClangFormat5TheConstructorInitializersStyleToUse>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ClangFormat5TheConstructorInitializersStyleToUse? result)
        {
            return JsonElementHelpers.TryParseValue<ClangFormat5TheConstructorInitializersStyleToUse>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ClangFormat5TheConstructorInitializersStyleToUse(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ClangFormat5TheConstructorInitializersStyleToUse IJsonElement<ClangFormat5TheConstructorInitializersStyleToUse>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ClangFormat5TheConstructorInitializersStyleToUse: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ClangFormat5TheConstructorInitializersStyleToUse"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ClangFormat5TheConstructorInitializersStyleToUse"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ClangFormat5TheConstructorInitializersStyleToUse Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ClangFormat5TheConstructorInitializersStyleToUse>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ClangFormat5TheConstructorInitializersStyleToUse"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ClangFormat5TheConstructorInitializersStyleToUse Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ClangFormat5TheConstructorInitializersStyleToUse>(_idx);
            }
