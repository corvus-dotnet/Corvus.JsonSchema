...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ClangFormat7TheInheritanceListStyleToUse
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ClangFormat7TheInheritanceListStyleToUse instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ClangFormat7TheInheritanceListStyleToUse"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ClangFormat7TheInheritanceListStyleToUse(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ClangFormat7TheInheritanceListStyleToUse(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ClangFormat7TheInheritanceListStyleToUse.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ClangFormat7TheInheritanceListStyleToUse"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ClangFormat7TheInheritanceListStyleToUse"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ClangFormat7TheInheritanceListStyleToUse Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ClangFormat7TheInheritanceListStyleToUse>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ClangFormat7TheInheritanceListStyleToUse"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ClangFormat7TheInheritanceListStyleToUse Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ClangFormat7TheInheritanceListStyleToUse>(_idx);
            }
            ...
            /// <param name="matchBeforeColon">Match 1st item.</param>
            /// <param name="matchBeforeComma">Match 2nd item.</param>
            /// <param name="matchAfterColon">Match 3rd item.</param>
            /// <param name="matchAfterComma">Match 4th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchBeforeColon,
                Func<TContext, TResult> matchBeforeComma,
                Func<TContext, TResult> matchAfterColon,
                Func<TContext, TResult> matchAfterComma,
...
#endif
            {
                ...
                {
                    return matchBeforeColon(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchBeforeComma(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchAfterColon(context);
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchAfterComma(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchBeforeColon,
                Func<TResult> matchBeforeComma,
                Func<TResult> matchAfterColon,
                Func<TResult> matchAfterComma,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchBeforeColon();
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchBeforeComma();
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchAfterColon();
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchAfterComma();
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ClangFormat7TheInheritanceListStyleToUse instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ClangFormat7TheInheritanceListStyleToUse, Mutable>(this);
        }
    }
}
