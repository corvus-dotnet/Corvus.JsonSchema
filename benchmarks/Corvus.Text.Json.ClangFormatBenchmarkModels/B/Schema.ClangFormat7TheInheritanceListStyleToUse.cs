...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClangFormat7TheInheritanceListStyleToUse"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ClangFormat7TheInheritanceListStyleToUse(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ClangFormat7TheInheritanceListStyleToUse DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(ClangFormat7TheInheritanceListStyleToUse value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in ClangFormat7TheInheritanceListStyleToUse left, in ClangFormat7TheInheritanceListStyleToUse right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ClangFormat7TheInheritanceListStyleToUse left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ClangFormat7TheInheritanceListStyleToUse instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ClangFormat7TheInheritanceListStyleToUse(JsonElement instance)
        {
            return ClangFormat7TheInheritanceListStyleToUse.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat7TheInheritanceListStyleToUse From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat7TheInheritanceListStyleToUse ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClangFormat7TheInheritanceListStyleToUse>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat7TheInheritanceListStyleToUse ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClangFormat7TheInheritanceListStyleToUse>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat7TheInheritanceListStyleToUse ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClangFormat7TheInheritanceListStyleToUse>(json, options);
        }
        ...
        /// </exception>
        public static ClangFormat7TheInheritanceListStyleToUse ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ClangFormat7TheInheritanceListStyleToUse>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ClangFormat7TheInheritanceListStyleToUse? result)
        {
            return JsonElementHelpers.TryParseValue<ClangFormat7TheInheritanceListStyleToUse>(ref reader, out result);
        }
...
#if NET
        static ClangFormat7TheInheritanceListStyleToUse IJsonElement<ClangFormat7TheInheritanceListStyleToUse>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ClangFormat7TheInheritanceListStyleToUse: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public ClangFormat7TheInheritanceListStyleToUse Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public ClangFormat7TheInheritanceListStyleToUse Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ClangFormat7TheInheritanceListStyleToUse>(_idx);
            }
