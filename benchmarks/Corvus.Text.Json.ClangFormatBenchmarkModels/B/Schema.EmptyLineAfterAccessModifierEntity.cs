...
public readonly partial struct Schema
{
    ...
    public readonly partial struct EmptyLineAfterAccessModifierEntity
#if NET8_0_OR_GREATER
        : IJsonElement<EmptyLineAfterAccessModifierEntity>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EmptyLineAfterAccessModifierEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal EmptyLineAfterAccessModifierEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static EmptyLineAfterAccessModifierEntity DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(EmptyLineAfterAccessModifierEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in EmptyLineAfterAccessModifierEntity left, in EmptyLineAfterAccessModifierEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in EmptyLineAfterAccessModifierEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(EmptyLineAfterAccessModifierEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator EmptyLineAfterAccessModifierEntity(JsonElement instance)
        {
            return EmptyLineAfterAccessModifierEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EmptyLineAfterAccessModifierEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EmptyLineAfterAccessModifierEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EmptyLineAfterAccessModifierEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EmptyLineAfterAccessModifierEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EmptyLineAfterAccessModifierEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EmptyLineAfterAccessModifierEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EmptyLineAfterAccessModifierEntity>(json, options);
        }
        ...
        /// </exception>
        public static EmptyLineAfterAccessModifierEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<EmptyLineAfterAccessModifierEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out EmptyLineAfterAccessModifierEntity? result)
        {
            return JsonElementHelpers.TryParseValue<EmptyLineAfterAccessModifierEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new EmptyLineAfterAccessModifierEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static EmptyLineAfterAccessModifierEntity IJsonElement<EmptyLineAfterAccessModifierEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"EmptyLineAfterAccessModifierEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="EmptyLineAfterAccessModifierEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="EmptyLineAfterAccessModifierEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public EmptyLineAfterAccessModifierEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<EmptyLineAfterAccessModifierEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="EmptyLineAfterAccessModifierEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public EmptyLineAfterAccessModifierEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<EmptyLineAfterAccessModifierEntity>(_idx);
            }
        ...
        /// <param name="matchLeave">Match 2nd item.</param>
