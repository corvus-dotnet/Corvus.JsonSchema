...
public readonly partial struct Schema
{
    ...
    public readonly partial struct IndentPpDirectivesEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(IndentPpDirectivesEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="IndentPpDirectivesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator IndentPpDirectivesEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new IndentPpDirectivesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"IndentPpDirectivesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="IndentPpDirectivesEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="IndentPpDirectivesEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly IndentPpDirectivesEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<IndentPpDirectivesEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="IndentPpDirectivesEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly IndentPpDirectivesEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<IndentPpDirectivesEntity>(_idx);
            }
            ...
            /// <param name="matchAfterHash">Match 2nd item.</param>
            /// <param name="matchBeforeHash">Match 3rd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchNone,
                Func<TContext, TResult> matchAfterHash,
                Func<TContext, TResult> matchBeforeHash,
...
#endif
            {
                ...
                {
                    return matchAfterHash(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchBeforeHash(context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Func<TResult> matchAfterHash,
                Func<TResult> matchBeforeHash,
                Func<TResult> defaultMatch)
            {
                ...
                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchAfterHash();
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchBeforeHash();
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(IndentPpDirectivesEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<IndentPpDirectivesEntity, Mutable>(this);
        }
    }
}
