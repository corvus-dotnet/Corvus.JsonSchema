...
public readonly partial struct Schema
{
    ...
    public readonly partial struct IndentWidthEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(IndentWidthEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="IndentWidthEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator IndentWidthEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"IndentWidthEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly IndentWidthEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly IndentWidthEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<IndentWidthEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(IndentWidthEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<IndentWidthEntity, Mutable>(this);
        }
    }
}
