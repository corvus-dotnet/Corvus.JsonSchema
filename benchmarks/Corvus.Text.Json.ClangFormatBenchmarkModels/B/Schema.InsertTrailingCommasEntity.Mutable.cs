...
public readonly partial struct Schema
{
    ...
    public readonly partial struct InsertTrailingCommasEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(InsertTrailingCommasEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="InsertTrailingCommasEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator InsertTrailingCommasEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"InsertTrailingCommasEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly InsertTrailingCommasEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly InsertTrailingCommasEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<InsertTrailingCommasEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(InsertTrailingCommasEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<InsertTrailingCommasEntity, Mutable>(this);
        }
    }
}
