...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JavaImportGroupArray
        ...
        : IJsonElement<JavaImportGroupArray>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JavaImportGroupArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal JavaImportGroupArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static JavaImportGroupArray DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in JavaImportGroupArray left, in JavaImportGroupArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in JavaImportGroupArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(JavaImportGroupArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JavaImportGroupArray(JsonElement instance)
        {
            return JavaImportGroupArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JavaImportGroupArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JavaImportGroupArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<JavaImportGroupArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JavaImportGroupArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<JavaImportGroupArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JavaImportGroupArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<JavaImportGroupArray>(json, options);
        }
        ...
        /// </exception>
        public static JavaImportGroupArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<JavaImportGroupArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out JavaImportGroupArray? result)
        {
            return JsonElementHelpers.TryParseValue<JavaImportGroupArray>(ref reader, out result);
        }
...
#if NET
        static JavaImportGroupArray IJsonElement<JavaImportGroupArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JavaImportGroupArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public JavaImportGroupArray Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public JavaImportGroupArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<JavaImportGroupArray>(_idx);
            }
