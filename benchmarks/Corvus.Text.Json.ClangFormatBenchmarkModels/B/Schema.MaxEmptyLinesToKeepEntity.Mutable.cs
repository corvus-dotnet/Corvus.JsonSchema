...
public readonly partial struct Schema
{
    ...
    public readonly partial struct MaxEmptyLinesToKeepEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MaxEmptyLinesToKeepEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MaxEmptyLinesToKeepEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MaxEmptyLinesToKeepEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MaxEmptyLinesToKeepEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MaxEmptyLinesToKeepEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MaxEmptyLinesToKeepEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MaxEmptyLinesToKeepEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MaxEmptyLinesToKeepEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MaxEmptyLinesToKeepEntity, Mutable>(this);
        }
    }
}
