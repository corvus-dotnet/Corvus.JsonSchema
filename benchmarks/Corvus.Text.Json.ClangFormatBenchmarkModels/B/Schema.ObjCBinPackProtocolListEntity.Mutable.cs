...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ObjCBinPackProtocolListEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ObjCBinPackProtocolListEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ObjCBinPackProtocolListEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ObjCBinPackProtocolListEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ObjCBinPackProtocolListEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ObjCBinPackProtocolListEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ObjCBinPackProtocolListEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ObjCBinPackProtocolListEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ObjCBinPackProtocolListEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ObjCBinPackProtocolListEntity, Mutable>(this);
        }
    }
}
