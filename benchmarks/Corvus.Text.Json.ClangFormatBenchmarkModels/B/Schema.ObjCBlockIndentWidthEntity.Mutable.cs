...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ObjCBlockIndentWidthEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ObjCBlockIndentWidthEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ObjCBlockIndentWidthEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ObjCBlockIndentWidthEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ObjCBlockIndentWidthEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ObjCBlockIndentWidthEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ObjCBlockIndentWidthEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ObjCBlockIndentWidthEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ObjCBlockIndentWidthEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ObjCBlockIndentWidthEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ObjCBlockIndentWidthEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ObjCBlockIndentWidthEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ObjCBlockIndentWidthEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ObjCBlockIndentWidthEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ObjCBlockIndentWidthEntity, Mutable>(this);
        }
    }
}
