...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PenaltyBreakBeforeFirstCallParameterEntity
#if NET8_0_OR_GREATER
        : IJsonElement<PenaltyBreakBeforeFirstCallParameterEntity>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PenaltyBreakBeforeFirstCallParameterEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal PenaltyBreakBeforeFirstCallParameterEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static PenaltyBreakBeforeFirstCallParameterEntity DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator long(PenaltyBreakBeforeFirstCallParameterEntity value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator double(PenaltyBreakBeforeFirstCallParameterEntity value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Corvus.Numerics.BigNumber(PenaltyBreakBeforeFirstCallParameterEntity value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator System.Numerics.BigInteger(PenaltyBreakBeforeFirstCallParameterEntity value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator decimal(PenaltyBreakBeforeFirstCallParameterEntity value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in PenaltyBreakBeforeFirstCallParameterEntity left, in PenaltyBreakBeforeFirstCallParameterEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in PenaltyBreakBeforeFirstCallParameterEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(PenaltyBreakBeforeFirstCallParameterEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PenaltyBreakBeforeFirstCallParameterEntity(JsonElement instance)
        {
            return PenaltyBreakBeforeFirstCallParameterEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PenaltyBreakBeforeFirstCallParameterEntity From<T>(in T instance)
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out PenaltyBreakBeforeFirstCallParameterEntity? result)
        {
            return JsonElementHelpers.TryParseValue<PenaltyBreakBeforeFirstCallParameterEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PenaltyBreakBeforeFirstCallParameterEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static PenaltyBreakBeforeFirstCallParameterEntity IJsonElement<PenaltyBreakBeforeFirstCallParameterEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PenaltyBreakBeforeFirstCallParameterEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PenaltyBreakBeforeFirstCallParameterEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PenaltyBreakBeforeFirstCallParameterEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public PenaltyBreakBeforeFirstCallParameterEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PenaltyBreakBeforeFirstCallParameterEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PenaltyBreakBeforeFirstCallParameterEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public PenaltyBreakBeforeFirstCallParameterEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<PenaltyBreakBeforeFirstCallParameterEntity>(_idx);
            }
