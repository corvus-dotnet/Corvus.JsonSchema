...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PenaltyBreakStringEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PenaltyBreakStringEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PenaltyBreakStringEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PenaltyBreakStringEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PenaltyBreakStringEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PenaltyBreakStringEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="PenaltyBreakStringEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="PenaltyBreakStringEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly PenaltyBreakStringEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<PenaltyBreakStringEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="PenaltyBreakStringEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly PenaltyBreakStringEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PenaltyBreakStringEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(PenaltyBreakStringEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<PenaltyBreakStringEntity, Mutable>(this);
        }
    }
}
