...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PenaltyBreakTemplateDeclarationEntity
#if NET8_0_OR_GREATER
        : IJsonElement<PenaltyBreakTemplateDeclarationEntity>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PenaltyBreakTemplateDeclarationEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal PenaltyBreakTemplateDeclarationEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static PenaltyBreakTemplateDeclarationEntity DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator long(PenaltyBreakTemplateDeclarationEntity value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator double(PenaltyBreakTemplateDeclarationEntity value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Corvus.Numerics.BigNumber(PenaltyBreakTemplateDeclarationEntity value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator System.Numerics.BigInteger(PenaltyBreakTemplateDeclarationEntity value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator decimal(PenaltyBreakTemplateDeclarationEntity value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in PenaltyBreakTemplateDeclarationEntity left, in PenaltyBreakTemplateDeclarationEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in PenaltyBreakTemplateDeclarationEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(PenaltyBreakTemplateDeclarationEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PenaltyBreakTemplateDeclarationEntity(JsonElement instance)
        {
            return PenaltyBreakTemplateDeclarationEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PenaltyBreakTemplateDeclarationEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PenaltyBreakTemplateDeclarationEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PenaltyBreakTemplateDeclarationEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PenaltyBreakTemplateDeclarationEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PenaltyBreakTemplateDeclarationEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PenaltyBreakTemplateDeclarationEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PenaltyBreakTemplateDeclarationEntity>(json, options);
        }
        ...
        /// </exception>
        public static PenaltyBreakTemplateDeclarationEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<PenaltyBreakTemplateDeclarationEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out PenaltyBreakTemplateDeclarationEntity? result)
        {
            return JsonElementHelpers.TryParseValue<PenaltyBreakTemplateDeclarationEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PenaltyBreakTemplateDeclarationEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static PenaltyBreakTemplateDeclarationEntity IJsonElement<PenaltyBreakTemplateDeclarationEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PenaltyBreakTemplateDeclarationEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PenaltyBreakTemplateDeclarationEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PenaltyBreakTemplateDeclarationEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public PenaltyBreakTemplateDeclarationEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PenaltyBreakTemplateDeclarationEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PenaltyBreakTemplateDeclarationEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public PenaltyBreakTemplateDeclarationEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<PenaltyBreakTemplateDeclarationEntity>(_idx);
            }
