...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PenaltyExcessCharacterEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PenaltyExcessCharacterEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PenaltyExcessCharacterEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PenaltyExcessCharacterEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PenaltyExcessCharacterEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly PenaltyExcessCharacterEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly PenaltyExcessCharacterEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PenaltyExcessCharacterEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(PenaltyExcessCharacterEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<PenaltyExcessCharacterEntity, Mutable>(this);
        }
    }
}
