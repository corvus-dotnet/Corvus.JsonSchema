...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PenaltyReturnTypeOnItsOwnLineEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PenaltyReturnTypeOnItsOwnLineEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PenaltyReturnTypeOnItsOwnLineEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PenaltyReturnTypeOnItsOwnLineEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PenaltyReturnTypeOnItsOwnLineEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly PenaltyReturnTypeOnItsOwnLineEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly PenaltyReturnTypeOnItsOwnLineEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PenaltyReturnTypeOnItsOwnLineEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(PenaltyReturnTypeOnItsOwnLineEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<PenaltyReturnTypeOnItsOwnLineEntity, Mutable>(this);
        }
    }
}
