...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PenaltyReturnTypeOnItsOwnLineEntity
#if NET8_0_OR_GREATER
        : IJsonElement<PenaltyReturnTypeOnItsOwnLineEntity>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PenaltyReturnTypeOnItsOwnLineEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal PenaltyReturnTypeOnItsOwnLineEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static PenaltyReturnTypeOnItsOwnLineEntity DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator long(PenaltyReturnTypeOnItsOwnLineEntity value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator double(PenaltyReturnTypeOnItsOwnLineEntity value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Corvus.Numerics.BigNumber(PenaltyReturnTypeOnItsOwnLineEntity value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator System.Numerics.BigInteger(PenaltyReturnTypeOnItsOwnLineEntity value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator decimal(PenaltyReturnTypeOnItsOwnLineEntity value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in PenaltyReturnTypeOnItsOwnLineEntity left, in PenaltyReturnTypeOnItsOwnLineEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in PenaltyReturnTypeOnItsOwnLineEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(PenaltyReturnTypeOnItsOwnLineEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PenaltyReturnTypeOnItsOwnLineEntity(JsonElement instance)
        {
            return PenaltyReturnTypeOnItsOwnLineEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PenaltyReturnTypeOnItsOwnLineEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PenaltyReturnTypeOnItsOwnLineEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PenaltyReturnTypeOnItsOwnLineEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PenaltyReturnTypeOnItsOwnLineEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PenaltyReturnTypeOnItsOwnLineEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PenaltyReturnTypeOnItsOwnLineEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PenaltyReturnTypeOnItsOwnLineEntity>(json, options);
        }
        ...
        /// </exception>
        public static PenaltyReturnTypeOnItsOwnLineEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<PenaltyReturnTypeOnItsOwnLineEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out PenaltyReturnTypeOnItsOwnLineEntity? result)
        {
            return JsonElementHelpers.TryParseValue<PenaltyReturnTypeOnItsOwnLineEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PenaltyReturnTypeOnItsOwnLineEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static PenaltyReturnTypeOnItsOwnLineEntity IJsonElement<PenaltyReturnTypeOnItsOwnLineEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PenaltyReturnTypeOnItsOwnLineEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PenaltyReturnTypeOnItsOwnLineEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PenaltyReturnTypeOnItsOwnLineEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public PenaltyReturnTypeOnItsOwnLineEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PenaltyReturnTypeOnItsOwnLineEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PenaltyReturnTypeOnItsOwnLineEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public PenaltyReturnTypeOnItsOwnLineEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<PenaltyReturnTypeOnItsOwnLineEntity>(_idx);
            }
