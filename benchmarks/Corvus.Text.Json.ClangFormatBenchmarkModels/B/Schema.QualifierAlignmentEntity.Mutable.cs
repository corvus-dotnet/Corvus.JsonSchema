...
public readonly partial struct Schema
{
    ...
    public readonly partial struct QualifierAlignmentEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(QualifierAlignmentEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="QualifierAlignmentEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator QualifierAlignmentEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"QualifierAlignmentEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly QualifierAlignmentEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly QualifierAlignmentEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<QualifierAlignmentEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(QualifierAlignmentEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<QualifierAlignmentEntity, Mutable>(this);
        }
    }
}
