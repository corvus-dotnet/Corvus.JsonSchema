...
public readonly partial struct Schema
{
    ...
    public readonly partial struct QualifierOrderArrayQualifierOrderEntityArray
    {
...
#endif
        {
            ...
            public Corvus.ClangFormatBenchmark.Baseline.Schema.QualifierOrderArrayQualifierOrderEntityArray.QualifierOrderArrayQualifierOrderEntity.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.ClangFormatBenchmark.Baseline.Schema.QualifierOrderArrayQualifierOrderEntityArray.QualifierOrderArrayQualifierOrderEntity.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.ClangFormatBenchmark.Baseline.Schema.QualifierOrderArrayQualifierOrderEntityArray.QualifierOrderArrayQualifierOrderEntity.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.ClangFormatBenchmark.Baseline.Schema.QualifierOrderArrayQualifierOrderEntityArray.QualifierOrderArrayQualifierOrderEntity.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.ClangFormatBenchmark.Baseline.Schema.QualifierOrderArrayQualifierOrderEntityArray.QualifierOrderArrayQualifierOrderEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.ClangFormatBenchmark.Baseline.Schema.QualifierOrderArrayQualifierOrderEntityArray.QualifierOrderArrayQualifierOrderEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.ClangFormatBenchmark.Baseline.Schema.QualifierOrderArrayQualifierOrderEntityArray.QualifierOrderArrayQualifierOrderEntity.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.ClangFormatBenchmark.Baseline.Schema.QualifierOrderArrayQualifierOrderEntityArray.QualifierOrderArrayQualifierOrderEntity item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.ClangFormatBenchmark.Baseline.Schema.QualifierOrderArrayQualifierOrderEntityArray.QualifierOrderArrayQualifierOrderEntity>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.ClangFormatBenchmark.Baseline.Schema.QualifierOrderArrayQualifierOrderEntityArray.QualifierOrderArrayQualifierOrderEntity> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.ClangFormatBenchmark.Baseline.Schema.QualifierOrderArrayQualifierOrderEntityArray.QualifierOrderArrayQualifierOrderEntity>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.ClangFormatBenchmark.Baseline.Schema.QualifierOrderArrayQualifierOrderEntityArray.QualifierOrderArrayQualifierOrderEntity oldItem, in Corvus.ClangFormatBenchmark.Baseline.Schema.QualifierOrderArrayQualifierOrderEntityArray.QualifierOrderArrayQualifierOrderEntity.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.ClangFormatBenchmark.Baseline.Schema.QualifierOrderArrayQualifierOrderEntityArray.QualifierOrderArrayQualifierOrderEntity>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.ClangFormatBenchmark.Baseline.Schema.QualifierOrderArrayQualifierOrderEntityArray.QualifierOrderArrayQualifierOrderEntity current = enumerator.Current;
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.ClangFormatBenchmark.Baseline.Schema.QualifierOrderArrayQualifierOrderEntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.ClangFormatBenchmark.Baseline.Schema.QualifierOrderArrayQualifierOrderEntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
