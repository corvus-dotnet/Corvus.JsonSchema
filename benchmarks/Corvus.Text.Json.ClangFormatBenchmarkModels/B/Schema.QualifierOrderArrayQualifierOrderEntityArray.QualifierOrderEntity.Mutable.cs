    ...
    public readonly partial struct QualifierOrderArrayQualifierOrderEntityArray
    {
        ...
        public readonly partial struct QualifierOrderEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(QualifierOrderEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="QualifierOrderEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator QualifierOrderEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new QualifierOrderEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"QualifierOrderEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="QualifierOrderEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="QualifierOrderEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly QualifierOrderEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<QualifierOrderEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="QualifierOrderEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly QualifierOrderEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<QualifierOrderEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(QualifierOrderEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<QualifierOrderEntity, Mutable>(this);
            }
        }
    }
}
