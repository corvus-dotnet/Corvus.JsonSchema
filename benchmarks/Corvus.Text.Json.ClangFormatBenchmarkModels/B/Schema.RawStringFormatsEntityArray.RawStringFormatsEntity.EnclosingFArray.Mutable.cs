...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RawStringFormatsEntityArray
    {
        ...
        public readonly partial struct RawStringFormatsEntity
        {
            ...
            public readonly partial struct EnclosingFArray
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(EnclosingFArray instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="EnclosingFArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator EnclosingFArray(Mutable instance)
                    {
                    ...
                    public Corvus.ClangFormatBenchmark.Baseline.JsonString.Mutable this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.ClangFormatBenchmark.Baseline.JsonString.Mutable>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.ClangFormatBenchmark.Baseline.JsonString.Mutable> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.ClangFormatBenchmark.Baseline.JsonString.Mutable>(_parent, _idx);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new EnclosingFArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"EnclosingFArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void SetItem(int itemIndex, in Corvus.ClangFormatBenchmark.Baseline.JsonString.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void InsertItem(int itemIndex, in Corvus.ClangFormatBenchmark.Baseline.JsonString.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void AddItem(in Corvus.ClangFormatBenchmark.Baseline.JsonString.Source value)
                    {
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Remove(in Corvus.ClangFormatBenchmark.Baseline.JsonString item)
                    {
                        CheckValidInstance();
                        if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.ClangFormatBenchmark.Baseline.JsonString>(this, in item))
                        {
                            return false;
                        }
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void RemoveWhere(JsonPredicate<Corvus.ClangFormatBenchmark.Baseline.JsonString> predicate)
                    {
                        CheckValidInstance();
                        JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.ClangFormatBenchmark.Baseline.JsonString>(this, predicate);
                        _documentVersion = _parent.Version;
                    }
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Replace(in Corvus.ClangFormatBenchmark.Baseline.JsonString oldItem, in Corvus.ClangFormatBenchmark.Baseline.JsonString.Source newItem)
                    {
                        CheckValidInstance();
                        ...
                        var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.ClangFormatBenchmark.Baseline.JsonString>(_parent, _idx);

                        while (enumerator.MoveNext())
                        {
                            Corvus.ClangFormatBenchmark.Baseline.JsonString current = enumerator.Current;
                    ...
                    /// <summary>
                    /// Gets a <see cref="EnclosingFArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="EnclosingFArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EnclosingFArray Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<EnclosingFArray>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="EnclosingFArray"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EnclosingFArray Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<EnclosingFArray>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.ClangFormatBenchmark.Baseline.Schema.RawStringFormatsEntityArray.RawStringFormatsEntity.EnclosingFArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(EnclosingFArray instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.ClangFormatBenchmark.Baseline.Schema.RawStringFormatsEntityArray.RawStringFormatsEntity.EnclosingFArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<EnclosingFArray, Mutable>(this);
                }
            }
        }
    }
