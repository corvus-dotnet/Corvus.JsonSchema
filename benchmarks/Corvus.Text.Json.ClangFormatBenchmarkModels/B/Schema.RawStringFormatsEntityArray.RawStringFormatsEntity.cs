...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RawStringFormatsEntityArray
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RawStringFormatsEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RawStringFormatsEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RawStringFormatsEntity DefaultInstance { get; }
            ...
            /// <summary>
            /// Gets the (optional) <c>CanonicalDelimiter</c> property.
            /// </summary>
            public Corvus.ClangFormatBenchmark.Baseline.JsonString CanonicalDelimiter
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CanonicalDelimiterUtf8, out Corvus.ClangFormatBenchmark.Baseline.JsonString value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>Delimiters</c> property.
            /// </summary>
            public Corvus.ClangFormatBenchmark.Baseline.Schema.RawStringFormatsEntityArray.RawStringFormatsEntity.JsonStringArray Delimiters
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DelimitersUtf8, out Corvus.ClangFormatBenchmark.Baseline.Schema.RawStringFormatsEntityArray.RawStringFormatsEntity.JsonStringArray value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>EnclosingFunctions</c> property.
            /// </summary>
            public Corvus.ClangFormatBenchmark.Baseline.Schema.RawStringFormatsEntityArray.RawStringFormatsEntity.EnclosingFArray EnclosingFunctions
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnclosingFunctionsUtf8, out Corvus.ClangFormatBenchmark.Baseline.Schema.RawStringFormatsEntityArray.RawStringFormatsEntity.EnclosingFArray value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in RawStringFormatsEntity left, in RawStringFormatsEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RawStringFormatsEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RawStringFormatsEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RawStringFormatsEntity(JsonElement instance)
            {
                return RawStringFormatsEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RawStringFormatsEntity From<T>(in T instance)
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RawStringFormatsEntity? result)
            {
                return JsonElementHelpers.TryParseValue<RawStringFormatsEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RawStringFormatsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RawStringFormatsEntity IJsonElement<RawStringFormatsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RawStringFormatsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RawStringFormatsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RawStringFormatsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RawStringFormatsEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RawStringFormatsEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RawStringFormatsEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RawStringFormatsEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RawStringFormatsEntity>(_idx);
                }
            ...
            public static class JsonPropertyNames
            {
                ...
                /// <summary>
                /// Gets the JSON property name for <see cref="CanonicalDelimiter"/>.
                /// </summary>
                public const string CanonicalDelimiter = "CanonicalDelimiter";

                /// <summary>
                /// Gets the JSON property name for <see cref="Delimiters"/>.
                /// </summary>
                public const string Delimiters = "Delimiters";

                /// <summary>
                /// Gets the JSON property name for <see cref="EnclosingFunctions"/>.
                /// </summary>
                public const string EnclosingFunctions = "EnclosingFunctions";
                ...
                /// Gets the JSON property name for <see cref="CanonicalDelimiter"/>.
                /// </summary>
                public static ReadOnlySpan<byte> CanonicalDelimiterUtf8 => "CanonicalDelimiter"u8;

                /// <summary>
                /// Gets the JSON property name for <see cref="Delimiters"/>.
                /// </summary>
                public static ReadOnlySpan<byte> DelimitersUtf8 => "Delimiters"u8;

                /// <summary>
                /// Gets the JSON property name for <see cref="EnclosingFunctions"/>.
                /// </summary>
                public static ReadOnlySpan<byte> EnclosingFunctionsUtf8 => "EnclosingFunctions"u8;
            ...
            private static class JsonPropertyNamesEscaped
            {
                ...
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="CanonicalDelimiter"/>.
                /// </summary>
                public static ReadOnlySpan<byte> CanonicalDelimiter => "CanonicalDelimiter"u8;

                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Delimiters"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Delimiters => "Delimiters"u8;

                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="EnclosingFunctions"/>.
                /// </summary>
                public static ReadOnlySpan<byte> EnclosingFunctions => "EnclosingFunctions"u8;
