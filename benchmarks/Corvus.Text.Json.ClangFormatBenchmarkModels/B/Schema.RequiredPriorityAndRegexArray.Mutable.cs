...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RequiredPriorityAndRegexArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RequiredPriorityAndRegexArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RequiredPriorityAndRegexArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredPriorityAndRegexArray(Mutable instance)
            {
            ...
            public Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RequiredPriorityAndRegexArray(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredPriorityAndRegexArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex oldItem, in Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex current = enumerator.Current;
            ...
            /// <summary>
            /// Gets a <see cref="RequiredPriorityAndRegexArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RequiredPriorityAndRegexArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly RequiredPriorityAndRegexArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RequiredPriorityAndRegexArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RequiredPriorityAndRegexArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly RequiredPriorityAndRegexArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RequiredPriorityAndRegexArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(RequiredPriorityAndRegexArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<RequiredPriorityAndRegexArray, Mutable>(this);
        }
    }
}
