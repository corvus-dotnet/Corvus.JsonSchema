    ...
    public readonly partial struct RequiredPriorityAndRegexArray
    {
        ...
        public readonly partial struct RequiredPriorityAndRegex
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequiredPriorityAndRegex instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequiredPriorityAndRegex"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredPriorityAndRegex(Mutable instance)
                {
                ...
                /// </summary>
                public Corvus.ClangFormatBenchmark.Baseline.JsonBoolean.Mutable CaseSensitive
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CaseSensitiveUtf8, out Corvus.ClangFormatBenchmark.Baseline.JsonBoolean.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.PriorityEntity.Mutable Priority
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PriorityUtf8, out Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.PriorityEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.ClangFormatBenchmark.Baseline.JsonString.Mutable Regex
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RegexUtf8, out Corvus.ClangFormatBenchmark.Baseline.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                public Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.SortPriorityEntity.Mutable SortPriority
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SortPriorityUtf8, out Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.SortPriorityEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetCaseSensitive(in Corvus.ClangFormatBenchmark.Baseline.JsonBoolean.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetPriority(in Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.PriorityEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetRegex(in Corvus.ClangFormatBenchmark.Baseline.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetSortPriority(in Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.SortPriorityEntity.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SortPriorityUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SortPriorityUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                /// <summary>
                /// Remove the <c>SortPriority</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveSortPriority()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SortPriorityUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredPriorityAndRegex.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredPriorityAndRegex Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredPriorityAndRegex Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequiredPriorityAndRegex>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(RequiredPriorityAndRegex instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="RequiredPriorityAndRegex"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.PriorityEntity.Source priority,
                    in Corvus.ClangFormatBenchmark.Baseline.JsonString.Source regex,
                    in Corvus.ClangFormatBenchmark.Baseline.JsonBoolean.Source caseSensitive = default,
                    in Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.SortPriorityEntity.Source sortPriority = default)
                {
                ...
                public void Create(
                    ...
                    in Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.SortPriorityEntity.Source sortPriority = default)
                {
                    Create(ref _builder, priority, regex, caseSensitive, sortPriority);
                }
            ...
            /// <param name="sortPriority">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.PriorityEntity.Source priority, in Corvus.ClangFormatBenchmark.Baseline.JsonString.Source regex, in Corvus.ClangFormatBenchmark.Baseline.JsonBoolean.Source caseSensitive = default, in Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.SortPriorityEntity.Source sortPriority = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(priority, regex, caseSensitive, sortPriority);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<RequiredPriorityAndRegex, Mutable>(this);
            }
        }
    }
}
