...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RequiredPriorityAndRegexArray
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RequiredPriorityAndRegex"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RequiredPriorityAndRegex(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RequiredPriorityAndRegex DefaultInstance { get; }
            ...
            /// </summary>
            public Corvus.ClangFormatBenchmark.Baseline.JsonBoolean CaseSensitive
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CaseSensitiveUtf8, out Corvus.ClangFormatBenchmark.Baseline.JsonBoolean value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.PriorityEntity Priority
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PriorityUtf8, out Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.PriorityEntity value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.ClangFormatBenchmark.Baseline.JsonString Regex
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RegexUtf8, out Corvus.ClangFormatBenchmark.Baseline.JsonString value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>SortPriority</c> property.
            /// </summary>
            public Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.SortPriorityEntity SortPriority
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SortPriorityUtf8, out Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.SortPriorityEntity value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in RequiredPriorityAndRegex left, in RequiredPriorityAndRegex right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RequiredPriorityAndRegex left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RequiredPriorityAndRegex instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredPriorityAndRegex(JsonElement instance)
            {
                return RequiredPriorityAndRegex.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredPriorityAndRegex From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredPriorityAndRegex ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredPriorityAndRegex>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredPriorityAndRegex ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredPriorityAndRegex>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredPriorityAndRegex ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredPriorityAndRegex>(json, options);
            }
            ...
            /// </exception>
            public static RequiredPriorityAndRegex ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RequiredPriorityAndRegex>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredPriorityAndRegex? result)
            {
                return JsonElementHelpers.TryParseValue<RequiredPriorityAndRegex>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RequiredPriorityAndRegex(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RequiredPriorityAndRegex IJsonElement<RequiredPriorityAndRegex>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredPriorityAndRegex: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RequiredPriorityAndRegex"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RequiredPriorityAndRegex"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RequiredPriorityAndRegex Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RequiredPriorityAndRegex>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RequiredPriorityAndRegex"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RequiredPriorityAndRegex Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RequiredPriorityAndRegex>(_idx);
                }
            ...
            public static class JsonPropertyNames
            {
                ...
                /// <summary>
                /// Gets the JSON property name for <see cref="SortPriority"/>.
                /// </summary>
                ...
                /// Gets the JSON property name for <see cref="SortPriority"/>.
                /// </summary>
                public static ReadOnlySpan<byte> SortPriorityUtf8 => "SortPriority"u8;
            }
            ...
            private static class JsonPropertyNamesEscaped
            {
                ...
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Regex"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Regex => "Regex"u8;

                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="SortPriority"/>.
                /// </summary>
