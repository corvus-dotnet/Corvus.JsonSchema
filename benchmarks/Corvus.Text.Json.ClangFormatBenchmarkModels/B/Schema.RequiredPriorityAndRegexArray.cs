...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.ClangFormatBenchmark.Baseline.Schema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex>(_parent, _idx);
        }
