...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SeparateDefinitionBlocksEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal SeparateDefinitionBlocksEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static SeparateDefinitionBlocksEntity DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(SeparateDefinitionBlocksEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in SeparateDefinitionBlocksEntity left, in SeparateDefinitionBlocksEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SeparateDefinitionBlocksEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(SeparateDefinitionBlocksEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SeparateDefinitionBlocksEntity(JsonElement instance)
        {
            return SeparateDefinitionBlocksEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SeparateDefinitionBlocksEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SeparateDefinitionBlocksEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SeparateDefinitionBlocksEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SeparateDefinitionBlocksEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SeparateDefinitionBlocksEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SeparateDefinitionBlocksEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SeparateDefinitionBlocksEntity>(json, options);
        }
        ...
        /// </exception>
        public static SeparateDefinitionBlocksEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<SeparateDefinitionBlocksEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SeparateDefinitionBlocksEntity? result)
        {
            return JsonElementHelpers.TryParseValue<SeparateDefinitionBlocksEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new SeparateDefinitionBlocksEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static SeparateDefinitionBlocksEntity IJsonElement<SeparateDefinitionBlocksEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SeparateDefinitionBlocksEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="SeparateDefinitionBlocksEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="SeparateDefinitionBlocksEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public SeparateDefinitionBlocksEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<SeparateDefinitionBlocksEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="SeparateDefinitionBlocksEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public SeparateDefinitionBlocksEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<SeparateDefinitionBlocksEntity>(_idx);
            }
        ...
        /// <param name="matchLeave">Match 1st item.</param>
        /// <param name="matchAlways">Match 2nd item.</param>
        /// <param name="matchNever">Match 3rd item.</param>
