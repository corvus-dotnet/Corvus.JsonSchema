...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ShortNamespaceLinesEntity
#if NET8_0_OR_GREATER
        : IJsonElement<ShortNamespaceLinesEntity>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ShortNamespaceLinesEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ShortNamespaceLinesEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ShortNamespaceLinesEntity DefaultInstance { get; } = ParsedJsonDocument<ShortNamespaceLinesEntity>.NumberConstant([.."1"u8]);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator long(ShortNamespaceLinesEntity value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator double(ShortNamespaceLinesEntity value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Corvus.Numerics.BigNumber(ShortNamespaceLinesEntity value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator System.Numerics.BigInteger(ShortNamespaceLinesEntity value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in ShortNamespaceLinesEntity left, in ShortNamespaceLinesEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ShortNamespaceLinesEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ShortNamespaceLinesEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ShortNamespaceLinesEntity(JsonElement instance)
        {
            return ShortNamespaceLinesEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ShortNamespaceLinesEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ShortNamespaceLinesEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ShortNamespaceLinesEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ShortNamespaceLinesEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ShortNamespaceLinesEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ShortNamespaceLinesEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ShortNamespaceLinesEntity>(json, options);
        }
        ...
        /// </exception>
        public static ShortNamespaceLinesEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ShortNamespaceLinesEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ShortNamespaceLinesEntity? result)
        {
            return JsonElementHelpers.TryParseValue<ShortNamespaceLinesEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ShortNamespaceLinesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ShortNamespaceLinesEntity IJsonElement<ShortNamespaceLinesEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ShortNamespaceLinesEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ShortNamespaceLinesEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ShortNamespaceLinesEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ShortNamespaceLinesEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ShortNamespaceLinesEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ShortNamespaceLinesEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ShortNamespaceLinesEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ShortNamespaceLinesEntity>(_idx);
            }
