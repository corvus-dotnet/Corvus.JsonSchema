...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SortIncludesEntity
#if NET8_0_OR_GREATER
        : IJsonElement<SortIncludesEntity>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SortIncludesEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal SortIncludesEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static SortIncludesEntity DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(SortIncludesEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in SortIncludesEntity left, in SortIncludesEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SortIncludesEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(SortIncludesEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SortIncludesEntity(JsonElement instance)
        {
            return SortIncludesEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SortIncludesEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SortIncludesEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SortIncludesEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SortIncludesEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SortIncludesEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SortIncludesEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SortIncludesEntity>(json, options);
        }
        ...
        /// </exception>
        public static SortIncludesEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<SortIncludesEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SortIncludesEntity? result)
        {
            return JsonElementHelpers.TryParseValue<SortIncludesEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new SortIncludesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static SortIncludesEntity IJsonElement<SortIncludesEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SortIncludesEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="SortIncludesEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="SortIncludesEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public SortIncludesEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<SortIncludesEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="SortIncludesEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public SortIncludesEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<SortIncludesEntity>(_idx);
            }
        ...
        /// <param name="matchCaseSensitive">Match 1st item.</param>
        /// <param name="matchCaseInsensitive">Match 2nd item.</param>
        /// <param name="matchNever">Match 3rd item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchCaseSensitive,
            Func<TContext, TResult> matchCaseInsensitive,
...
#endif
        {
            ...
            {
                return matchCaseSensitive(context);
            }

            if (this.ValueEquals(Constants.Enum2))
            {
                return matchCaseInsensitive(context);
            }
        ...
        public TResult Match<TResult>(
            Func<TResult> matchCaseSensitive,
            Func<TResult> matchCaseInsensitive,
