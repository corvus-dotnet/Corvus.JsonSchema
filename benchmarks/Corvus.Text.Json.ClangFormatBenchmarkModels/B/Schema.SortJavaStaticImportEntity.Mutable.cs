...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SortJavaStaticImportEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(SortJavaStaticImportEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SortJavaStaticImportEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SortJavaStaticImportEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SortJavaStaticImportEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SortJavaStaticImportEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SortJavaStaticImportEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SortJavaStaticImportEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly SortJavaStaticImportEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SortJavaStaticImportEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SortJavaStaticImportEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly SortJavaStaticImportEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SortJavaStaticImportEntity>(_idx);
            }
            ...
            /// <param name="matchBefore">Match 1st item.</param>
            /// <param name="matchAfter">Match 2nd item.</param>
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(SortJavaStaticImportEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<SortJavaStaticImportEntity, Mutable>(this);
        }
    }
}
