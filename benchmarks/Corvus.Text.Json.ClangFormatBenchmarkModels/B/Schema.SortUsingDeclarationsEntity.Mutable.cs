...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SortUsingDeclarationsEntity
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.ClangFormatBenchmark.Baseline.Schema.SortUsingDeclarationsEntity.OneOf1Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.ClangFormatBenchmark.Baseline.Schema.SortUsingDeclarationsEntity.OneOf1Entity.Mutable(Mutable value)
            {
                return Corvus.ClangFormatBenchmark.Baseline.Schema.SortUsingDeclarationsEntity.OneOf1Entity.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.ClangFormatBenchmark.Baseline.Schema.SortUsingDeclarationsEntity.OneOf1Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.ClangFormatBenchmark.Baseline.Schema.SortUsingDeclarationsEntity.OneOf1Entity.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(SortUsingDeclarationsEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SortUsingDeclarationsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SortUsingDeclarationsEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SortUsingDeclarationsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly SortUsingDeclarationsEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly SortUsingDeclarationsEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SortUsingDeclarationsEntity>(_idx);
            }
            ...
            /// <param name="matchOneOf1Entity">Match a <see cref="Corvus.ClangFormatBenchmark.Baseline.Schema.SortUsingDeclarationsEntity.OneOf1Entity"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.ClangFormatBenchmark.Baseline.Schema.SortUsingDeclarationsEntity.OneOf1Entity, TContext, TResult> matchOneOf1Entity,
                Matcher<Corvus.ClangFormatBenchmark.Baseline.Schema.SortUsingDeclarationsEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                if (Corvus.ClangFormatBenchmark.Baseline.Schema.SortUsingDeclarationsEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.ClangFormatBenchmark.Baseline.Schema.SortUsingDeclarationsEntity.OneOf1Entity.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.ClangFormatBenchmark.Baseline.Schema.SortUsingDeclarationsEntity.OneOf1Entity, TResult> matchOneOf1Entity,
                Matcher<Corvus.ClangFormatBenchmark.Baseline.Schema.SortUsingDeclarationsEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.ClangFormatBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.ClangFormatBenchmark.Baseline.Schema.SortUsingDeclarationsEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.ClangFormatBenchmark.Baseline.Schema.SortUsingDeclarationsEntity.OneOf1Entity.Mutable.From(this));
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.ClangFormatBenchmark.Baseline.Schema.SortUsingDeclarationsEntity.OneOf1Entity" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsOneOf1Entity(out Corvus.ClangFormatBenchmark.Baseline.Schema.SortUsingDeclarationsEntity.OneOf1Entity result)
            {
                if (Corvus.ClangFormatBenchmark.Baseline.Schema.SortUsingDeclarationsEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.ClangFormatBenchmark.Baseline.Schema.SortUsingDeclarationsEntity.OneOf1Entity.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(SortUsingDeclarationsEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.ClangFormatBenchmark.Baseline.Schema.SortUsingDeclarationsEntity.OneOf1Entity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<SortUsingDeclarationsEntity, Mutable>(this);
        }
    }
}
