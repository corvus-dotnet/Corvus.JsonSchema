...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SpaceBeforeParensEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(SpaceBeforeParensEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SpaceBeforeParensEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SpaceBeforeParensEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SpaceBeforeParensEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SpaceBeforeParensEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SpaceBeforeParensEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SpaceBeforeParensEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly SpaceBeforeParensEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SpaceBeforeParensEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SpaceBeforeParensEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly SpaceBeforeParensEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SpaceBeforeParensEntity>(_idx);
            }
            ...
            /// <param name="matchControlStatements">Match 1st item.</param>
            /// <param name="matchNever">Match 2nd item.</param>
            /// <param name="matchControlStatementsExceptControlMacros">Match 3rd item.</param>
            /// <param name="matchNonEmptyParentheses">Match 4th item.</param>
            /// <param name="matchAlways">Match 5th item.</param>
            /// <param name="matchCustom">Match 6th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchControlStatements,
                Func<TContext, TResult> matchNever,
                Func<TContext, TResult> matchControlStatementsExceptControlMacros,
                Func<TContext, TResult> matchNonEmptyParentheses,
...
#endif
            {
                ...
                {
                    return matchControlStatements(context);
                }
                ...
                {
                    return matchControlStatementsExceptControlMacros(context);
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchNonEmptyParentheses(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchControlStatements,
                Func<TResult> matchNever,
                Func<TResult> matchControlStatementsExceptControlMacros,
                Func<TResult> matchNonEmptyParentheses,
                ...
                Func<TResult> defaultMatch)
            {
                ...
                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchControlStatementsExceptControlMacros();
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchNonEmptyParentheses();
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(SpaceBeforeParensEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<SpaceBeforeParensEntity, Mutable>(this);
        }
    }
}
