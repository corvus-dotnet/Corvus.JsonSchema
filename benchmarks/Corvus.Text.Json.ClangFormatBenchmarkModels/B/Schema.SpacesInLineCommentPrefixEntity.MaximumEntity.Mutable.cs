    ...
    public readonly partial struct SpacesInLineCommentPrefixEntity
    {
        ...
        public readonly partial struct MaximumEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(MaximumEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MaximumEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MaximumEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MaximumEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MaximumEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MaximumEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MaximumEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MaximumEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MaximumEntity, Mutable>(this);
            }
        }
    }
}
