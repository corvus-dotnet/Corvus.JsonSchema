...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SpacesInLineCommentPrefixEntity
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.ClangFormatBenchmark.Baseline.Schema.SpacesInLineCommentPrefixEntity.MaximumEntity.Mutable Maximum
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaximumUtf8, out Corvus.ClangFormatBenchmark.Baseline.Schema.SpacesInLineCommentPrefixEntity.MaximumEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.ClangFormatBenchmark.Baseline.Schema.SpacesInLineCommentPrefixEntity.MinimumEntity.Mutable Minimum
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinimumUtf8, out Corvus.ClangFormatBenchmark.Baseline.Schema.SpacesInLineCommentPrefixEntity.MinimumEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetMaximum(in Corvus.ClangFormatBenchmark.Baseline.Schema.SpacesInLineCommentPrefixEntity.MaximumEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetMinimum(in Corvus.ClangFormatBenchmark.Baseline.Schema.SpacesInLineCommentPrefixEntity.MinimumEntity.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.ClangFormatBenchmark.Baseline.Schema.SpacesInLineCommentPrefixEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.ClangFormatBenchmark.Baseline.Schema.SpacesInLineCommentPrefixEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.ClangFormatBenchmark.Baseline.Schema.SpacesInLineCommentPrefixEntity.MaximumEntity.Source maximum = default,
                in Corvus.ClangFormatBenchmark.Baseline.Schema.SpacesInLineCommentPrefixEntity.MinimumEntity.Source minimum = default)
            {
            ...
            /// Creates an instance of a <see cref="SpacesInLineCommentPrefixEntity"/>.
            /// </summary>
            public void Create(in Corvus.ClangFormatBenchmark.Baseline.Schema.SpacesInLineCommentPrefixEntity.MaximumEntity.Source maximum = default, in Corvus.ClangFormatBenchmark.Baseline.Schema.SpacesInLineCommentPrefixEntity.MinimumEntity.Source minimum = default)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.ClangFormatBenchmark.Baseline.Schema.SpacesInLineCommentPrefixEntity.MaximumEntity.Source maximum = default, in Corvus.ClangFormatBenchmark.Baseline.Schema.SpacesInLineCommentPrefixEntity.MinimumEntity.Source minimum = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
