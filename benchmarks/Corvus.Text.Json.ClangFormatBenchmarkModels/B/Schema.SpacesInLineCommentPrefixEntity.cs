...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.ClangFormatBenchmark.Baseline.Schema.SpacesInLineCommentPrefixEntity.MaximumEntity Maximum
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaximumUtf8, out Corvus.ClangFormatBenchmark.Baseline.Schema.SpacesInLineCommentPrefixEntity.MaximumEntity value))
                {
                    return value;
                }

                return Corvus.ClangFormatBenchmark.Baseline.Schema.SpacesInLineCommentPrefixEntity.MaximumEntity.DefaultInstance;
            }
        }
        ...
        /// </summary>
        public Corvus.ClangFormatBenchmark.Baseline.Schema.SpacesInLineCommentPrefixEntity.MinimumEntity Minimum
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinimumUtf8, out Corvus.ClangFormatBenchmark.Baseline.Schema.SpacesInLineCommentPrefixEntity.MinimumEntity value))
                {
                    return value;
                }

                return Corvus.ClangFormatBenchmark.Baseline.Schema.SpacesInLineCommentPrefixEntity.MinimumEntity.DefaultInstance;
            }
        }
