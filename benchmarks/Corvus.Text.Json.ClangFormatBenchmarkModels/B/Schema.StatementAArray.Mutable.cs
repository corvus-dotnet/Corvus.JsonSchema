...
public readonly partial struct Schema
{
    ...
    public readonly partial struct StatementAArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(StatementAArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="StatementAArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator StatementAArray(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new StatementAArray(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"StatementAArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// <summary>
            /// Gets a <see cref="StatementAArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="StatementAArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly StatementAArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<StatementAArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="StatementAArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly StatementAArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<StatementAArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.ClangFormatBenchmark.Baseline.Schema.StatementAArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(StatementAArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.ClangFormatBenchmark.Baseline.Schema.StatementAArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<StatementAArray, Mutable>(this);
        }
    }
}
