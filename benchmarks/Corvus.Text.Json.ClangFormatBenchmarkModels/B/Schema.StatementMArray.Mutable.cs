...
public readonly partial struct Schema
{
    ...
    public readonly partial struct StatementMArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(StatementMArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="StatementMArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator StatementMArray(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new StatementMArray(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"StatementMArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// <summary>
            /// Gets a <see cref="StatementMArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="StatementMArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly StatementMArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<StatementMArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="StatementMArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly StatementMArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<StatementMArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.ClangFormatBenchmark.Baseline.Schema.StatementMArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(StatementMArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.ClangFormatBenchmark.Baseline.Schema.StatementMArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<StatementMArray, Mutable>(this);
        }
    }
}
