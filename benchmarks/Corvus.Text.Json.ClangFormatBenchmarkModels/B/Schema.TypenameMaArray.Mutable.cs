...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TypenameMaArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TypenameMaArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TypenameMaArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TypenameMaArray(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TypenameMaArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </para>
            /// </remarks>
            public readonly TypenameMaArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TypenameMaArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TypenameMaArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.ClangFormatBenchmark.Baseline.Schema.TypenameMaArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(TypenameMaArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.ClangFormatBenchmark.Baseline.Schema.TypenameMaArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<TypenameMaArray, Mutable>(this);
        }
    }
}
