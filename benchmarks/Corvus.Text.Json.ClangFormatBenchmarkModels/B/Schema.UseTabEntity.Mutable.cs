...
public readonly partial struct Schema
{
    ...
    public readonly partial struct UseTabEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(UseTabEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="UseTabEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator UseTabEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"UseTabEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly UseTabEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly UseTabEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<UseTabEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(UseTabEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<UseTabEntity, Mutable>(this);
        }
    }
}
