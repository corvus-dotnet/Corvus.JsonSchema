...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UseTabEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal UseTabEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static UseTabEntity DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(UseTabEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in UseTabEntity left, in UseTabEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in UseTabEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(UseTabEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator UseTabEntity(JsonElement instance)
        {
            return UseTabEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UseTabEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UseTabEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<UseTabEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UseTabEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<UseTabEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UseTabEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<UseTabEntity>(json, options);
        }
        ...
        /// </exception>
        public static UseTabEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<UseTabEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out UseTabEntity? result)
        {
            return JsonElementHelpers.TryParseValue<UseTabEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new UseTabEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static UseTabEntity IJsonElement<UseTabEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"UseTabEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="UseTabEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="UseTabEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public UseTabEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<UseTabEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="UseTabEntity"/> that lives for the lifetime of its
        ...
        /// <param name="matchForIndentation">Match 2nd item.</param>
        /// <param name="matchForContinuationAndIndentation">Match 3rd item.</param>
        /// <param name="matchAlignWithSpaces">Match 4th item.</param>
        ...
        public TResult Match<TContext, TResult>(
            ...
            Func<TContext, TResult> matchForIndentation,
            Func<TContext, TResult> matchForContinuationAndIndentation,
            Func<TContext, TResult> matchAlignWithSpaces,
...
#endif
        {
            ...
            {
                return matchForIndentation(context);
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchForContinuationAndIndentation(context);
            }

            if (this.ValueEquals(Constants.Enum4))
            {
                return matchAlignWithSpaces(context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Func<TResult> matchForIndentation,
            Func<TResult> matchForContinuationAndIndentation,
            Func<TResult> matchAlignWithSpaces,
            ...
            Func<TResult> defaultMatch)
        {
            ...
            if (this.ValueEquals(Constants.Enum2))
            {
                return matchForIndentation();
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchForContinuationAndIndentation();
            }

            if (this.ValueEquals(Constants.Enum4))
            {
                return matchAlignWithSpaces();
            }
