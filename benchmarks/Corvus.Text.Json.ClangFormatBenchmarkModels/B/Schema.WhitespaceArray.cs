...
public readonly partial struct Schema
{
    ...
    public readonly partial struct WhitespaceArray
#if NET8_0_OR_GREATER
        : IJsonElement<WhitespaceArray>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WhitespaceArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal WhitespaceArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static WhitespaceArray DefaultInstance { get; }
        ...
        public Corvus.ClangFormatBenchmark.Baseline.JsonString this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.ClangFormatBenchmark.Baseline.JsonString>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.ClangFormatBenchmark.Baseline.JsonString> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.ClangFormatBenchmark.Baseline.JsonString>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in WhitespaceArray left, in WhitespaceArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in WhitespaceArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(WhitespaceArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator WhitespaceArray(JsonElement instance)
        {
            return WhitespaceArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WhitespaceArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WhitespaceArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<WhitespaceArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WhitespaceArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<WhitespaceArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WhitespaceArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<WhitespaceArray>(json, options);
        }
        ...
        /// </exception>
        public static WhitespaceArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<WhitespaceArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out WhitespaceArray? result)
        {
            return JsonElementHelpers.TryParseValue<WhitespaceArray>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new WhitespaceArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static WhitespaceArray IJsonElement<WhitespaceArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"WhitespaceArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="WhitespaceArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="WhitespaceArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public WhitespaceArray Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<WhitespaceArray>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="WhitespaceArray"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public WhitespaceArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<WhitespaceArray>(_idx);
            }
