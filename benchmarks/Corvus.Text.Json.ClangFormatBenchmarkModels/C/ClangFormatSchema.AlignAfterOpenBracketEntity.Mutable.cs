...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct AlignAfterOpenBracketEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(AlignAfterOpenBracketEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="AlignAfterOpenBracketEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AlignAfterOpenBracketEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AlignAfterOpenBracketEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly AlignAfterOpenBracketEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly AlignAfterOpenBracketEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<AlignAfterOpenBracketEntity>(_idx);
            }
            ...
            public bool TryGetKnownValue(out KnownValues result)
            {
                ...
                if (this.ValueEquals(Constants.Enum3))
                {
                    result = KnownValues.AlwaysBreak;
                    return true;
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    result = KnownValues.BlockIndent;
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(AlignAfterOpenBracketEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (AlignAfterOpenBracketEntity)value;
        ...
        {
            return workspace.CreateBuilder<AlignAfterOpenBracketEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<AlignAfterOpenBracketEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<AlignAfterOpenBracketEntity>();
            }
            finally
            {
