    ...
    public readonly partial struct AlignConsecutiveAssignmentsEntity
    {
        ...
        public readonly partial struct ClangFormat15AlignmentOptions
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.ClangFormatBenchmark.Current.JsonBoolean.Mutable AlignCompound
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AlignCompoundUtf8, out Corvus.ClangFormatBenchmark.Current.JsonBoolean.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.ClangFormatBenchmark.Current.JsonBoolean.Mutable PadOperators
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PadOperatorsUtf8, out Corvus.ClangFormatBenchmark.Current.JsonBoolean.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetAlignCompound(scoped in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AlignCompound, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                public void SetPadOperators(scoped in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.PadOperators, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Flags value) => ClangFormat15AlignmentOptions.Build((value & Flags.AcrossComments) != 0, (value & Flags.AcrossEmptyLines) != 0, (value & Flags.AlignCompound) != 0, (value & Flags.Enabled) != 0, (value & Flags.PadOperators) != 0);
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveAssignmentsEntity.ClangFormat15AlignmentOptions.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source alignCompound = default,
                    in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source enabled = default,
                    in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source padOperators = default)
                {
                    ...
                    alignCompound.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AlignCompound, ref builder);
                    enabled.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Enabled, ref builder);
                    padOperators.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.PadOperators, ref builder);
                }
            ...
            /// <param name="alignCompound">The value of the <c>"AlignCompound"</c> property.</param>
