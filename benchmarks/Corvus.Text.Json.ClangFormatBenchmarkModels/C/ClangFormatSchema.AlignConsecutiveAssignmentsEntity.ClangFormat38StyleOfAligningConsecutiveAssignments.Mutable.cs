    ...
    public readonly partial struct AlignConsecutiveAssignmentsEntity
    {
        ...
        public readonly partial struct ClangFormat38StyleOfAligningConsecutiveAssignments
        {
            ...
            public ref struct Source
            {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (ClangFormat38StyleOfAligningConsecutiveAssignments)value;
            ...
            public static ParsedJsonDocument<ClangFormat38StyleOfAligningConsecutiveAssignments> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ClangFormat38StyleOfAligningConsecutiveAssignments>();
                }
                finally
                {
