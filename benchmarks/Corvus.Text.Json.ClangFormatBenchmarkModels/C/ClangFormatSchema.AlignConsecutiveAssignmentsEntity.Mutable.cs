...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct AlignConsecutiveAssignmentsEntity
    {
...
#endif
        {
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveAssignmentsEntity.ClangFormat38StyleOfAligningConsecutiveAssignments" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsClangFormat38StyleOfAligningConsecutiveAssignments(out Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveAssignmentsEntity.ClangFormat38StyleOfAligningConsecutiveAssignments result)
            {
                if (Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveAssignmentsEntity.ClangFormat38StyleOfAligningConsecutiveAssignments.JsonSchema.Evaluate(_parent, _idx))
                {
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveAssignmentsEntity.ClangFormat15AlignmentOptions" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsClangFormat15AlignmentOptions(out Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveAssignmentsEntity.ClangFormat15AlignmentOptions result)
            {
                if (Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveAssignmentsEntity.ClangFormat15AlignmentOptions.JsonSchema.Evaluate(_parent, _idx))
                {
