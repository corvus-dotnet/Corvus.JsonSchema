    ...
    public readonly partial struct AlignConsecutiveBitFieldsEntity
    {
        ...
        public readonly partial struct ClangFormat11StyleOfAligningConsecutiveBitFields
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ClangFormat11StyleOfAligningConsecutiveBitFields instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ClangFormat11StyleOfAligningConsecutiveBitFields"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ClangFormat11StyleOfAligningConsecutiveBitFields(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ClangFormat11StyleOfAligningConsecutiveBitFields.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ClangFormat11StyleOfAligningConsecutiveBitFields Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ClangFormat11StyleOfAligningConsecutiveBitFields Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ClangFormat11StyleOfAligningConsecutiveBitFields>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ClangFormat11StyleOfAligningConsecutiveBitFields instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (ClangFormat11StyleOfAligningConsecutiveBitFields)value;
            ...
            {
                return workspace.CreateBuilder<ClangFormat11StyleOfAligningConsecutiveBitFields, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ClangFormat11StyleOfAligningConsecutiveBitFields> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ClangFormat11StyleOfAligningConsecutiveBitFields>();
                }
                finally
                {
