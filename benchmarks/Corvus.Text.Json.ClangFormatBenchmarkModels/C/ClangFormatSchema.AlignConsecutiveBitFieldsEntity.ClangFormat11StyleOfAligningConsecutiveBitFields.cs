...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct AlignConsecutiveBitFieldsEntity
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ClangFormat11StyleOfAligningConsecutiveBitFields"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ClangFormat11StyleOfAligningConsecutiveBitFields(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ClangFormat11StyleOfAligningConsecutiveBitFields DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ClangFormat11StyleOfAligningConsecutiveBitFields value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in ClangFormat11StyleOfAligningConsecutiveBitFields left, in ClangFormat11StyleOfAligningConsecutiveBitFields right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ClangFormat11StyleOfAligningConsecutiveBitFields left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ClangFormat11StyleOfAligningConsecutiveBitFields instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ClangFormat11StyleOfAligningConsecutiveBitFields(JsonElement instance)
            {
                return ClangFormat11StyleOfAligningConsecutiveBitFields.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClangFormat11StyleOfAligningConsecutiveBitFields From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClangFormat11StyleOfAligningConsecutiveBitFields ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClangFormat11StyleOfAligningConsecutiveBitFields>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClangFormat11StyleOfAligningConsecutiveBitFields ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClangFormat11StyleOfAligningConsecutiveBitFields>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClangFormat11StyleOfAligningConsecutiveBitFields ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClangFormat11StyleOfAligningConsecutiveBitFields>(json, options);
            }
            ...
            /// </exception>
            public static ClangFormat11StyleOfAligningConsecutiveBitFields ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ClangFormat11StyleOfAligningConsecutiveBitFields>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ClangFormat11StyleOfAligningConsecutiveBitFields? result)
            {
                return JsonElementHelpers.TryParseValue<ClangFormat11StyleOfAligningConsecutiveBitFields>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ClangFormat11StyleOfAligningConsecutiveBitFields(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ClangFormat11StyleOfAligningConsecutiveBitFields IJsonElement<ClangFormat11StyleOfAligningConsecutiveBitFields>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ClangFormat11StyleOfAligningConsecutiveBitFields: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ClangFormat11StyleOfAligningConsecutiveBitFields"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ClangFormat11StyleOfAligningConsecutiveBitFields"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ClangFormat11StyleOfAligningConsecutiveBitFields Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ClangFormat11StyleOfAligningConsecutiveBitFields>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ClangFormat11StyleOfAligningConsecutiveBitFields"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ClangFormat11StyleOfAligningConsecutiveBitFields Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ClangFormat11StyleOfAligningConsecutiveBitFields>(_idx);
                }
            ...
            /// <param name="matchConsecutive">Match 2nd item.</param>
            /// <param name="matchAcrossEmptyLines">Match 3rd item.</param>
            /// <param name="matchAcrossComments">Match 4th item.</param>
            /// <param name="matchAcrossEmptyLinesAndComments">Match 5th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchNone,
                Func<TContext, TResult> matchConsecutive,
                Func<TContext, TResult> matchAcrossEmptyLines,
                Func<TContext, TResult> matchAcrossComments,
                Func<TContext, TResult> matchAcrossEmptyLinesAndComments,
...
#endif
            {
                ...
                {
                    return matchConsecutive(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchAcrossEmptyLines(context);
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchAcrossComments(context);
                }

                if (this.ValueEquals(Constants.Enum5))
                {
                    return matchAcrossEmptyLinesAndComments(context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Func<TResult> matchConsecutive,
                Func<TResult> matchAcrossEmptyLines,
                Func<TResult> matchAcrossComments,
                Func<TResult> matchAcrossEmptyLinesAndComments,
                Func<TResult> defaultMatch)
            {
                ...
                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchAcrossEmptyLines();
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchAcrossComments();
                }

                if (this.ValueEquals(Constants.Enum5))
                {
                    return matchAcrossEmptyLinesAndComments();
                }
