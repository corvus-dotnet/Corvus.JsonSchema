...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct AlignConsecutiveBitFieldsEntity
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat11StyleOfAligningConsecutiveBitFields.Mutable(Mutable value)
            {
                return Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat11StyleOfAligningConsecutiveBitFields.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat11StyleOfAligningConsecutiveBitFields.Mutable value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Mutable(Mutable value)
            {
                return Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(AlignConsecutiveBitFieldsEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="AlignConsecutiveBitFieldsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AlignConsecutiveBitFieldsEntity(Mutable instance)
            {
            ...
            /// </remarks>
            public void Apply(in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AlignConsecutiveBitFieldsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly AlignConsecutiveBitFieldsEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly AlignConsecutiveBitFieldsEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<AlignConsecutiveBitFieldsEntity>(_idx);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchClangFormat11StyleOfAligningConsecutiveBitFields(Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat11StyleOfAligningConsecutiveBitFields.Mutable.From(this), context);
                }
                ...
                {
                    return matchClangFormat15AlignmentOptions(Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat11StyleOfAligningConsecutiveBitFields.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchClangFormat11StyleOfAligningConsecutiveBitFields(Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat11StyleOfAligningConsecutiveBitFields.Mutable.From(this));
                }

                if (Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchClangFormat15AlignmentOptions(Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Mutable.From(this));
                }
            ...
            public bool TryGetAsClangFormat11StyleOfAligningConsecutiveBitFields(out Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat11StyleOfAligningConsecutiveBitFields.Mutable result)
            {
                if (Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat11StyleOfAligningConsecutiveBitFields.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat11StyleOfAligningConsecutiveBitFields.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsClangFormat15AlignmentOptions(out Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Mutable result)
            {
                if (Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Builder.Build? _clangFormat15AlignmentOptionsBuilderInstance;
            private readonly Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Source _clangFormat15AlignmentOptionsSourceInstance;
            ...
            public Source(Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Builder.Build value) {_clangFormat15AlignmentOptionsBuilderInstance = value; _kind = Kind.ClangFormat15AlignmentOptionsBuilder; }

            public Source(Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Source value) { _clangFormat15AlignmentOptionsSourceInstance = value; _kind = Kind.ClangFormat15AlignmentOptionsSource; }

            public static implicit operator Source(AlignConsecutiveBitFieldsEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat11StyleOfAligningConsecutiveBitFields instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Source value) => new(value);
            ...
            internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
            {
                switch(_kind)
                {
                    ...
                    case Kind.ClangFormat15AlignmentOptionsBuilder:
                        valueBuilder.AddProperty(utf8Name, _clangFormat15AlignmentOptionsBuilderInstance!, static (in b, ref o) => Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Builder.BuildValue(b, ref o), escapeName, nameRequiresUnescaping);
                        break;
            ...
            internal void AddAsPrebakedProperty(ReadOnlySpan<byte> prebakedPropertyName, ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Utf16String:
                        ...
                        break;
                    case Kind.ClangFormat15AlignmentOptionsBuilder:
                        valueBuilder.AddPrebakedProperty(prebakedPropertyName, _clangFormat15AlignmentOptionsBuilderInstance!, static (in b, ref o) => Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Builder.BuildValue(b, ref o));
                        break;
                    case Kind.ClangFormat15AlignmentOptionsSource:
            ...
            internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Utf16String:
                        ...
                        break;
                    case Kind.ClangFormat15AlignmentOptionsBuilder:
                        valueBuilder.AddProperty(name, _clangFormat15AlignmentOptionsBuilderInstance!, static (in b, ref o) => Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Builder.BuildValue(b, ref o));
                        break;
                    case Kind.ClangFormat15AlignmentOptionsSource:
            ...
            internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Utf16String:
                        ...
                        break;
                    case Kind.ClangFormat15AlignmentOptionsBuilder:
                        valueBuilder.AddItem(_clangFormat15AlignmentOptionsBuilderInstance!, static (in b, ref o) => Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Builder.BuildValue(b, ref o));
                        break;
                    case Kind.ClangFormat15AlignmentOptionsSource:
            ...
            #endif
        {
            ...
            TContext _context;
            Source _source;
            private readonly Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Builder.Build<TContext>? _clangFormat15AlignmentOptionsBuilderInstance;
            ...
            public Source(scoped in TContext context, Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Builder.Build<TContext> value) {_context = context; _clangFormat15AlignmentOptionsBuilderInstance = value; _kind = Kind.ClangFormat15AlignmentOptionsBuilder; }
            ...
            internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.ClangFormat15AlignmentOptionsBuilder:
                        valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _clangFormat15AlignmentOptionsBuilderInstance!), static (in b, ref o) => Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Builder.BuildValue(b.Context, b.Build, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.ClangFormat15AlignmentOptionsBuilder:
                        valueBuilder.AddItem(BuildWithContext.Create(_context, _clangFormat15AlignmentOptionsBuilderInstance!), static (in b, ref o) => Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Builder.BuildValue(b.Context, b.Build, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
        ...
        public static Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Source Build(
            scoped in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Builder.Build buildValue, int initialCapacity = 1)
        {
            return new Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Source(buildValue);
        }
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Source<TContext> Build<TContext>(
            scoped in TContext context, scoped in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Builder.Build<TContext> buildValue, int initialCapacity = 1)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Source<TContext>(context, buildValue);
        }
        ...
        /// <returns>An instance of a mutable document initialized with the given value.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(
            JsonWorkspace workspace, scoped in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        {
            // Create the document builder without a MetadataDb
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            var source = new Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Source(value);
        ...
        /// <returns>An instance of a mutable document initialized with the given value.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
            JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            var source = new Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Source<TContext>(context, value);
            source.AddAsItem(ref cvb);
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<AlignConsecutiveBitFieldsEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<AlignConsecutiveBitFieldsEntity> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<AlignConsecutiveBitFieldsEntity>();
            }
            finally
            {
        ...
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<AlignConsecutiveBitFieldsEntity> Create(
            scoped in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
            try
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<AlignConsecutiveBitFieldsEntity> Create<TContext>(
            scoped in TContext context, scoped in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveBitFieldsEntity.ClangFormat15AlignmentOptions.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
