...
public readonly partial struct ClangFormatSchema
{
    ...
    /// </summary>
    public readonly partial struct AlignConsecutiveDeclarationsEntity
    {
        /// <summary>
        /// Generated from JSON Schema.
        /// </summary>
        /// <remarks>
        /// <para>
        /// clang-format 15\r\r Alignment options.
        /// </para>
        /// </remarks>
        [DebuggerDisplay("{DebuggerDisplay,nq}")]
        public readonly partial struct ClangFormat15AlignmentOptions
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ClangFormat15AlignmentOptions instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ClangFormat15AlignmentOptions"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ClangFormat15AlignmentOptions(Mutable instance)
                {
                ...
                /// <summary>
                /// Gets the (optional) <c>AcrossComments</c> property.
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Corvus.ClangFormatBenchmark.Current.JsonBoolean.Mutable AcrossComments
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AcrossCommentsUtf8, out Corvus.ClangFormatBenchmark.Current.JsonBoolean.Mutable value))
                        {
                            return value;
                        }
                ...
                /// <summary>
                /// Gets the (optional) <c>AcrossEmptyLines</c> property.
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Corvus.ClangFormatBenchmark.Current.JsonBoolean.Mutable AcrossEmptyLines
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AcrossEmptyLinesUtf8, out Corvus.ClangFormatBenchmark.Current.JsonBoolean.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.ClangFormatBenchmark.Current.JsonBoolean.Mutable Enabled
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnabledUtf8, out Corvus.ClangFormatBenchmark.Current.JsonBoolean.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ClangFormat15AlignmentOptions(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetAcrossComments(scoped in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source value)
                {
                    ...
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AcrossCommentsUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AcrossCommentsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AcrossComments, ref cvb);
                ...
                /// <summary>
                /// Remove the <c>AcrossComments</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveAcrossComments()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AcrossCommentsUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                public void SetAcrossEmptyLines(scoped in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AcrossEmptyLinesUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AcrossEmptyLinesUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AcrossEmptyLines, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>AcrossEmptyLines</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveAcrossEmptyLines()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AcrossEmptyLinesUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ClangFormat15AlignmentOptions.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ClangFormat15AlignmentOptions"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ClangFormat15AlignmentOptions"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ClangFormat15AlignmentOptions Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ClangFormat15AlignmentOptions>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ClangFormat15AlignmentOptions"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ClangFormat15AlignmentOptions Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ClangFormat15AlignmentOptions>(_idx);
                }
                ...
                public bool TryGetFlags(out Flags result)
                {
                    ...
                    if (element.TryGetProperty(JsonPropertyNames.AcrossCommentsUtf8, out propertyValue) && propertyValue.ValueKind == JsonValueKind.True)
                    {
                        flags |= Flags.AcrossComments;
                    }

                    if (element.TryGetProperty(JsonPropertyNames.AcrossEmptyLinesUtf8, out propertyValue) && propertyValue.ValueKind == JsonValueKind.True)
                    {
                        flags |= Flags.AcrossEmptyLines;
                    }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source _createArg3;
                ...
                internal Source(Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveDeclarationsEntity.ClangFormat15AlignmentOptions.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source arg1, scoped in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source arg2, scoped in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source arg3)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _createArg3 = arg3;
                ...
                public static implicit operator Source(ClangFormat15AlignmentOptions instance) => new(JsonElement.From(instance));

                public static implicit operator Source(Flags value) => ClangFormat15AlignmentOptions.Build((value & Flags.AcrossComments) != 0, (value & Flags.AcrossEmptyLines) != 0, (value & Flags.Enabled) != 0);
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignConsecutiveDeclarationsEntity.ClangFormat15AlignmentOptions.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="ClangFormat15AlignmentOptions"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source acrossComments = default,
                    in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source acrossEmptyLines = default,
                    in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source enabled = default)
                {
                    acrossComments.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AcrossComments, ref builder);
                    acrossEmptyLines.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AcrossEmptyLines, ref builder);
                ...
                public void Create(
                    ...
                    in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source enabled = default)
                {
                    Create(ref _builder, acrossComments, acrossEmptyLines, enabled);
                }
                ...
                internal static void BuildCreateValue(scoped in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source arg1, scoped in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source arg2, scoped in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source arg3, ref ComplexValueBuilder o)
                {
                    o.StartObject();
            ...
            /// </summary>
            /// <param name="acrossComments">The value of the <c>"AcrossComments"</c> property.</param>
            /// <param name="acrossEmptyLines">The value of the <c>"AcrossEmptyLines"</c> property.</param>
            /// <param name="enabled">The value of the <c>"Enabled"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source acrossComments = default, scoped in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source acrossEmptyLines = default, scoped in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source enabled = default)
            {
                return new Source(acrossComments, acrossEmptyLines, enabled);
            }
            ...
            /// </summary>
            /// <param name="workspace">The JSON workspace.</param>
            /// <param name="acrossComments">The value of the property.</param>
            /// <param name="acrossEmptyLines">The value of the property.</param>
            /// <param name="enabled">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source acrossComments = default, in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source acrossEmptyLines = default, in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source enabled = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(acrossComments, acrossEmptyLines, enabled);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<ClangFormat15AlignmentOptions, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ClangFormat15AlignmentOptions> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ClangFormat15AlignmentOptions>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ClangFormat15AlignmentOptions> Create<TContext>(
            ...
            public static ParsedJsonDocument<ClangFormat15AlignmentOptions> Create(in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source acrossComments = default, in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source acrossEmptyLines = default, in Corvus.ClangFormatBenchmark.Current.JsonBoolean.Source enabled = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
