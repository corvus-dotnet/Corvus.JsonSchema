    ...
    public readonly partial struct AlignConsecutiveDeclarationsEntity
    {
        ...
        public readonly partial struct ClangFormat38StyleOfAligningConsecutiveDeclarations
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ClangFormat38StyleOfAligningConsecutiveDeclarations instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ClangFormat38StyleOfAligningConsecutiveDeclarations"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ClangFormat38StyleOfAligningConsecutiveDeclarations(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ClangFormat38StyleOfAligningConsecutiveDeclarations.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ClangFormat38StyleOfAligningConsecutiveDeclarations Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ClangFormat38StyleOfAligningConsecutiveDeclarations Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ClangFormat38StyleOfAligningConsecutiveDeclarations>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ClangFormat38StyleOfAligningConsecutiveDeclarations instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (ClangFormat38StyleOfAligningConsecutiveDeclarations)value;
            ...
            {
                return workspace.CreateBuilder<ClangFormat38StyleOfAligningConsecutiveDeclarations, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ClangFormat38StyleOfAligningConsecutiveDeclarations> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ClangFormat38StyleOfAligningConsecutiveDeclarations>();
                }
                finally
                {
