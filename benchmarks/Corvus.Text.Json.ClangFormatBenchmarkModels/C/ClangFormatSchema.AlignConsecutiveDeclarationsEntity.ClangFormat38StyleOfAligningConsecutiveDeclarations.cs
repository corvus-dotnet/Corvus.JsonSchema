...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct AlignConsecutiveDeclarationsEntity
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ClangFormat38StyleOfAligningConsecutiveDeclarations"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ClangFormat38StyleOfAligningConsecutiveDeclarations(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ClangFormat38StyleOfAligningConsecutiveDeclarations DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ClangFormat38StyleOfAligningConsecutiveDeclarations value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in ClangFormat38StyleOfAligningConsecutiveDeclarations left, in ClangFormat38StyleOfAligningConsecutiveDeclarations right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ClangFormat38StyleOfAligningConsecutiveDeclarations left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ClangFormat38StyleOfAligningConsecutiveDeclarations instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ClangFormat38StyleOfAligningConsecutiveDeclarations(JsonElement instance)
            {
                return ClangFormat38StyleOfAligningConsecutiveDeclarations.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClangFormat38StyleOfAligningConsecutiveDeclarations From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClangFormat38StyleOfAligningConsecutiveDeclarations ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ClangFormat38StyleOfAligningConsecutiveDeclarations>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClangFormat38StyleOfAligningConsecutiveDeclarations ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ClangFormat38StyleOfAligningConsecutiveDeclarations>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClangFormat38StyleOfAligningConsecutiveDeclarations ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ClangFormat38StyleOfAligningConsecutiveDeclarations>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static ClangFormat38StyleOfAligningConsecutiveDeclarations ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ClangFormat38StyleOfAligningConsecutiveDeclarations>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ClangFormat38StyleOfAligningConsecutiveDeclarations? result)
            {
                return JsonElementHelpers.TryParseValue<ClangFormat38StyleOfAligningConsecutiveDeclarations>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ClangFormat38StyleOfAligningConsecutiveDeclarations(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ClangFormat38StyleOfAligningConsecutiveDeclarations IJsonElement<ClangFormat38StyleOfAligningConsecutiveDeclarations>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ClangFormat38StyleOfAligningConsecutiveDeclarations: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ClangFormat38StyleOfAligningConsecutiveDeclarations"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ClangFormat38StyleOfAligningConsecutiveDeclarations"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ClangFormat38StyleOfAligningConsecutiveDeclarations Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ClangFormat38StyleOfAligningConsecutiveDeclarations>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ClangFormat38StyleOfAligningConsecutiveDeclarations"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ClangFormat38StyleOfAligningConsecutiveDeclarations Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ClangFormat38StyleOfAligningConsecutiveDeclarations>(_idx);
                }
