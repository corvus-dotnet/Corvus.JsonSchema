    ...
    public readonly partial struct AlignConsecutiveMacrosEntity
    {
        ...
        public readonly partial struct ClangFormat9StyleOfAligningConsecutiveMacros
        {
            ...
            public ref struct Source
            {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (ClangFormat9StyleOfAligningConsecutiveMacros)value;
            ...
            public static ParsedJsonDocument<ClangFormat9StyleOfAligningConsecutiveMacros> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ClangFormat9StyleOfAligningConsecutiveMacros>();
                }
                finally
                {
