...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct AlignConsecutiveMacrosEntity
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ClangFormat9StyleOfAligningConsecutiveMacros"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ClangFormat9StyleOfAligningConsecutiveMacros(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ClangFormat9StyleOfAligningConsecutiveMacros DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ClangFormat9StyleOfAligningConsecutiveMacros value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in ClangFormat9StyleOfAligningConsecutiveMacros left, in ClangFormat9StyleOfAligningConsecutiveMacros right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ClangFormat9StyleOfAligningConsecutiveMacros left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ClangFormat9StyleOfAligningConsecutiveMacros instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ClangFormat9StyleOfAligningConsecutiveMacros(JsonElement instance)
            {
                return ClangFormat9StyleOfAligningConsecutiveMacros.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClangFormat9StyleOfAligningConsecutiveMacros From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClangFormat9StyleOfAligningConsecutiveMacros ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClangFormat9StyleOfAligningConsecutiveMacros>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClangFormat9StyleOfAligningConsecutiveMacros ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClangFormat9StyleOfAligningConsecutiveMacros>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClangFormat9StyleOfAligningConsecutiveMacros ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClangFormat9StyleOfAligningConsecutiveMacros>(json, options);
            }
            ...
            /// </exception>
            public static ClangFormat9StyleOfAligningConsecutiveMacros ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ClangFormat9StyleOfAligningConsecutiveMacros>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ClangFormat9StyleOfAligningConsecutiveMacros? result)
            {
                return JsonElementHelpers.TryParseValue<ClangFormat9StyleOfAligningConsecutiveMacros>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ClangFormat9StyleOfAligningConsecutiveMacros(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ClangFormat9StyleOfAligningConsecutiveMacros IJsonElement<ClangFormat9StyleOfAligningConsecutiveMacros>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ClangFormat9StyleOfAligningConsecutiveMacros: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ClangFormat9StyleOfAligningConsecutiveMacros"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ClangFormat9StyleOfAligningConsecutiveMacros"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ClangFormat9StyleOfAligningConsecutiveMacros Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ClangFormat9StyleOfAligningConsecutiveMacros>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ClangFormat9StyleOfAligningConsecutiveMacros"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ClangFormat9StyleOfAligningConsecutiveMacros Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ClangFormat9StyleOfAligningConsecutiveMacros>(_idx);
                }
