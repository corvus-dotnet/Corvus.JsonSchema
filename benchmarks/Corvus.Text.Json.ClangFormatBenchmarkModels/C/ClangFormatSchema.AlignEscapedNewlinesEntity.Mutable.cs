...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct AlignEscapedNewlinesEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(AlignEscapedNewlinesEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="AlignEscapedNewlinesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AlignEscapedNewlinesEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AlignEscapedNewlinesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly AlignEscapedNewlinesEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly AlignEscapedNewlinesEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<AlignEscapedNewlinesEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(AlignEscapedNewlinesEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (AlignEscapedNewlinesEntity)value;
        ...
        {
            return workspace.CreateBuilder<AlignEscapedNewlinesEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<AlignEscapedNewlinesEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<AlignEscapedNewlinesEntity>();
            }
            finally
            {
