...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct AlignOperandsEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(AlignOperandsEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="AlignOperandsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AlignOperandsEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new AlignOperandsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AlignOperandsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="AlignOperandsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="AlignOperandsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly AlignOperandsEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<AlignOperandsEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="AlignOperandsEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly AlignOperandsEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<AlignOperandsEntity>(_idx);
            }
            ...
            /// <param name="matchAlign">Match 1st item.</param>
            /// <param name="matchDontAlign">Match 2nd item.</param>
            /// <param name="matchAlignAfterOperator">Match 3rd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchAlign,
                Func<TContext, TResult> matchDontAlign,
                Func<TContext, TResult> matchAlignAfterOperator,
...
#endif
            {
                ...
                {
                    return matchAlign(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchDontAlign(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchAlignAfterOperator(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchAlign,
                Func<TResult> matchDontAlign,
                Func<TResult> matchAlignAfterOperator,
                Func<TResult> defaultMatch)
            {
                ...
                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchDontAlign();
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchAlignAfterOperator();
                }
            ...
            public bool TryGetKnownValue(out KnownValues result)
            {
                ...
                if (this.ValueEquals(Constants.Enum3))
                {
                    result = KnownValues.AlignAfterOperator;
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(AlignOperandsEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (AlignOperandsEntity)value;
        ...
        {
            return workspace.CreateBuilder<AlignOperandsEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<AlignOperandsEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<AlignOperandsEntity>();
            }
            finally
            {
