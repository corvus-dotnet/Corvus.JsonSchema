        ...
        public readonly partial struct ClangFormat16AlignmentOptions
        {
            ...
            public readonly partial struct HowManyEmptyLinesToApplyAlignment
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(HowManyEmptyLinesToApplyAlignment instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="HowManyEmptyLinesToApplyAlignment"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator HowManyEmptyLinesToApplyAlignment(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new HowManyEmptyLinesToApplyAlignment(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"HowManyEmptyLinesToApplyAlignment.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="HowManyEmptyLinesToApplyAlignment"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="HowManyEmptyLinesToApplyAlignment"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly HowManyEmptyLinesToApplyAlignment Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<HowManyEmptyLinesToApplyAlignment>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="HowManyEmptyLinesToApplyAlignment"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly HowManyEmptyLinesToApplyAlignment Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<HowManyEmptyLinesToApplyAlignment>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(HowManyEmptyLinesToApplyAlignment instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<HowManyEmptyLinesToApplyAlignment, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<HowManyEmptyLinesToApplyAlignment> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<HowManyEmptyLinesToApplyAlignment>();
                    }
                    finally
                    {
