    ...
    public readonly partial struct AlignTrailingCommentsEntity
    {
        ...
        public readonly partial struct ClangFormat16AlignmentOptions
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.SpecifiesTheWayToAlignTrailingComments.Mutable Kind
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KindUtf8, out Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.SpecifiesTheWayToAlignTrailingComments.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.HowManyEmptyLinesToApplyAlignment.Mutable OverEmptyLines
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OverEmptyLinesUtf8, out Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.HowManyEmptyLinesToApplyAlignment.Mutable value))
                        {
                            return value;
                        }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.SpecifiesTheWayToAlignTrailingComments.Source _createArg1;
                private readonly Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.HowManyEmptyLinesToApplyAlignment.Source _createArg2;
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.SpecifiesTheWayToAlignTrailingComments.Source kind = default, in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.HowManyEmptyLinesToApplyAlignment.Source overEmptyLines = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            public static ParsedJsonDocument<ClangFormat16AlignmentOptions> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ClangFormat16AlignmentOptions>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ClangFormat16AlignmentOptions> Create<TContext>(
            ...
            public static ParsedJsonDocument<ClangFormat16AlignmentOptions> Create(in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.SpecifiesTheWayToAlignTrailingComments.Source kind = default, in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.HowManyEmptyLinesToApplyAlignment.Source overEmptyLines = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
