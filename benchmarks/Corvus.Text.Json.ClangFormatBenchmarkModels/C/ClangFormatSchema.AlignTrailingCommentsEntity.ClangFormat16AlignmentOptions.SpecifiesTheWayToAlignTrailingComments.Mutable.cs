        ...
        public readonly partial struct ClangFormat16AlignmentOptions
        {
            ...
            public readonly partial struct SpecifiesTheWayToAlignTrailingComments
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(SpecifiesTheWayToAlignTrailingComments instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="SpecifiesTheWayToAlignTrailingComments"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator SpecifiesTheWayToAlignTrailingComments(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new SpecifiesTheWayToAlignTrailingComments(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"SpecifiesTheWayToAlignTrailingComments.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="SpecifiesTheWayToAlignTrailingComments"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="SpecifiesTheWayToAlignTrailingComments"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SpecifiesTheWayToAlignTrailingComments Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<SpecifiesTheWayToAlignTrailingComments>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="SpecifiesTheWayToAlignTrailingComments"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SpecifiesTheWayToAlignTrailingComments Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<SpecifiesTheWayToAlignTrailingComments>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(SpecifiesTheWayToAlignTrailingComments instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (SpecifiesTheWayToAlignTrailingComments)value;
                ...
                {
                    return workspace.CreateBuilder<SpecifiesTheWayToAlignTrailingComments, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<SpecifiesTheWayToAlignTrailingComments> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<SpecifiesTheWayToAlignTrailingComments>();
                    }
                    finally
                    {
