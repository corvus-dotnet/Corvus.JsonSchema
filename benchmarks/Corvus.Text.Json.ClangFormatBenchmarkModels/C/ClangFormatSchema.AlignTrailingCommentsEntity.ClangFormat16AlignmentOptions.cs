...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct AlignTrailingCommentsEntity
    {
        ...
        /// <remarks>
        /// <para>
        /// clang-format 16\r\r Alignment options.
        /// </para>
        /// </remarks>
        [DebuggerDisplay("{DebuggerDisplay,nq}")]
        public readonly partial struct ClangFormat16AlignmentOptions
#if NET8_0_OR_GREATER
            : IJsonElement<ClangFormat16AlignmentOptions>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ClangFormat16AlignmentOptions"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ClangFormat16AlignmentOptions(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ClangFormat16AlignmentOptions DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.SpecifiesTheWayToAlignTrailingComments Kind
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KindUtf8, out Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.SpecifiesTheWayToAlignTrailingComments value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>OverEmptyLines</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.HowManyEmptyLinesToApplyAlignment OverEmptyLines
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OverEmptyLinesUtf8, out Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.HowManyEmptyLinesToApplyAlignment value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in ClangFormat16AlignmentOptions left, in ClangFormat16AlignmentOptions right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ClangFormat16AlignmentOptions left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(ClangFormat16AlignmentOptions instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ClangFormat16AlignmentOptions(JsonElement instance)
            {
                return ClangFormat16AlignmentOptions.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClangFormat16AlignmentOptions From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClangFormat16AlignmentOptions ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClangFormat16AlignmentOptions>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClangFormat16AlignmentOptions ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClangFormat16AlignmentOptions>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClangFormat16AlignmentOptions ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClangFormat16AlignmentOptions>(json, options);
            }
            ...
            /// </exception>
            public static ClangFormat16AlignmentOptions ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ClangFormat16AlignmentOptions>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ClangFormat16AlignmentOptions? result)
            {
                return JsonElementHelpers.TryParseValue<ClangFormat16AlignmentOptions>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ClangFormat16AlignmentOptions(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ClangFormat16AlignmentOptions IJsonElement<ClangFormat16AlignmentOptions>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ClangFormat16AlignmentOptions: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ClangFormat16AlignmentOptions"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ClangFormat16AlignmentOptions"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ClangFormat16AlignmentOptions Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ClangFormat16AlignmentOptions>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ClangFormat16AlignmentOptions"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ClangFormat16AlignmentOptions Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ClangFormat16AlignmentOptions>(_idx);
                }
            ...
            public static class JsonPropertyNames
            {
                ...
                /// <summary>
                /// Gets the JSON property name for <see cref="OverEmptyLines"/>.
                /// </summary>
                public const string OverEmptyLines = "OverEmptyLines";
                ...
                /// Gets the JSON property name for <see cref="OverEmptyLines"/>.
                /// </summary>
                public static ReadOnlySpan<byte> OverEmptyLinesUtf8 => "OverEmptyLines"u8;
            }
            ...
            private static class JsonPropertyNamesEscaped
            {
                ...
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="OverEmptyLines"/>.
                /// </summary>
                public static ReadOnlySpan<byte> OverEmptyLines => "OverEmptyLines"u8;
            }
            ...
            private static class JsonPropertyNamesPrebaked
            {
                ...
                /// </summary>
                public static ReadOnlySpan<byte> Kind => [0x65, 0x00, 0x00, 0x00, 0x22, 0x4B, 0x69, 0x6E, 0x64, 0x22];

                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="OverEmptyLines"/>.
                /// </summary>
                public static ReadOnlySpan<byte> OverEmptyLines => [0x05, 0x01, 0x00, 0x00, 0x22, 0x4F, 0x76, 0x65, 0x72, 0x45, 0x6D, 0x70, 0x74, 0x79, 0x4C, 0x69, 0x6E, 0x65, 0x73, 0x22];
            }
        }
    }
}
