...
public readonly partial struct ClangFormatSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AlignTrailingCommentsEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal AlignTrailingCommentsEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static AlignTrailingCommentsEntity DefaultInstance { get; }
        ...
        public static explicit operator Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions(AlignTrailingCommentsEntity value)
        {
            return Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AlignTrailingCommentsEntity(Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions value)
        {
            return From(value);
        }
        ...
        /// </returns>
        public static bool operator ==(in AlignTrailingCommentsEntity left, in AlignTrailingCommentsEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in AlignTrailingCommentsEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(AlignTrailingCommentsEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AlignTrailingCommentsEntity(JsonElement instance)
        {
            return AlignTrailingCommentsEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AlignTrailingCommentsEntity From<T>(in T instance)
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out AlignTrailingCommentsEntity? result)
        {
            return JsonElementHelpers.TryParseValue<AlignTrailingCommentsEntity>(ref reader, out result);
        }
...
#if NET
        static AlignTrailingCommentsEntity IJsonElement<AlignTrailingCommentsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AlignTrailingCommentsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public AlignTrailingCommentsEntity Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public AlignTrailingCommentsEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<AlignTrailingCommentsEntity>(_idx);
            }
        ...
        public bool TryGetAsClangFormat16AlignmentOptions(out Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions result)
        {
            ...
            {
                result = Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            if (Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchClangFormat16AlignmentOptions(Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity, TResult> defaultMatch)
        {
            if (Corvus.ClangFormatBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            if (Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchClangFormat16AlignmentOptions(Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.AlignTrailingCommentsEntity.ClangFormat16AlignmentOptions.From(this));
            }
