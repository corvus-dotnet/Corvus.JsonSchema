...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct AllowShortBlocksOnASingleLineEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(AllowShortBlocksOnASingleLineEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="AllowShortBlocksOnASingleLineEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AllowShortBlocksOnASingleLineEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AllowShortBlocksOnASingleLineEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly AllowShortBlocksOnASingleLineEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly AllowShortBlocksOnASingleLineEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<AllowShortBlocksOnASingleLineEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(AllowShortBlocksOnASingleLineEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (AllowShortBlocksOnASingleLineEntity)value;
        ...
        {
            return workspace.CreateBuilder<AllowShortBlocksOnASingleLineEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<AllowShortBlocksOnASingleLineEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<AllowShortBlocksOnASingleLineEntity>();
            }
            finally
            {
