...
public readonly partial struct ClangFormatSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AllowShortBlocksOnASingleLineEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal AllowShortBlocksOnASingleLineEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static AllowShortBlocksOnASingleLineEntity DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(AllowShortBlocksOnASingleLineEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in AllowShortBlocksOnASingleLineEntity left, in AllowShortBlocksOnASingleLineEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in AllowShortBlocksOnASingleLineEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(AllowShortBlocksOnASingleLineEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AllowShortBlocksOnASingleLineEntity(JsonElement instance)
        {
            return AllowShortBlocksOnASingleLineEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllowShortBlocksOnASingleLineEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllowShortBlocksOnASingleLineEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AllowShortBlocksOnASingleLineEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllowShortBlocksOnASingleLineEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AllowShortBlocksOnASingleLineEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllowShortBlocksOnASingleLineEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AllowShortBlocksOnASingleLineEntity>(json, options);
        }
        ...
        /// </exception>
        public static AllowShortBlocksOnASingleLineEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<AllowShortBlocksOnASingleLineEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out AllowShortBlocksOnASingleLineEntity? result)
        {
            return JsonElementHelpers.TryParseValue<AllowShortBlocksOnASingleLineEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AllowShortBlocksOnASingleLineEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static AllowShortBlocksOnASingleLineEntity IJsonElement<AllowShortBlocksOnASingleLineEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AllowShortBlocksOnASingleLineEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AllowShortBlocksOnASingleLineEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AllowShortBlocksOnASingleLineEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public AllowShortBlocksOnASingleLineEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AllowShortBlocksOnASingleLineEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AllowShortBlocksOnASingleLineEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public AllowShortBlocksOnASingleLineEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<AllowShortBlocksOnASingleLineEntity>(_idx);
            }
