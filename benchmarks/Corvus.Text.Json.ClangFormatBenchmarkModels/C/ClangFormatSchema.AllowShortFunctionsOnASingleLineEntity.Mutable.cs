...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct AllowShortFunctionsOnASingleLineEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(AllowShortFunctionsOnASingleLineEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="AllowShortFunctionsOnASingleLineEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AllowShortFunctionsOnASingleLineEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AllowShortFunctionsOnASingleLineEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly AllowShortFunctionsOnASingleLineEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly AllowShortFunctionsOnASingleLineEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<AllowShortFunctionsOnASingleLineEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(AllowShortFunctionsOnASingleLineEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (AllowShortFunctionsOnASingleLineEntity)value;
        ...
        {
            return workspace.CreateBuilder<AllowShortFunctionsOnASingleLineEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<AllowShortFunctionsOnASingleLineEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<AllowShortFunctionsOnASingleLineEntity>();
            }
            finally
            {
