...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct AlwaysBreakAfterDefinitionReturnTypeEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(AlwaysBreakAfterDefinitionReturnTypeEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="AlwaysBreakAfterDefinitionReturnTypeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AlwaysBreakAfterDefinitionReturnTypeEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AlwaysBreakAfterDefinitionReturnTypeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly AlwaysBreakAfterDefinitionReturnTypeEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly AlwaysBreakAfterDefinitionReturnTypeEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<AlwaysBreakAfterDefinitionReturnTypeEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(AlwaysBreakAfterDefinitionReturnTypeEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (AlwaysBreakAfterDefinitionReturnTypeEntity)value;
        ...
        {
            return workspace.CreateBuilder<AlwaysBreakAfterDefinitionReturnTypeEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<AlwaysBreakAfterDefinitionReturnTypeEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<AlwaysBreakAfterDefinitionReturnTypeEntity>();
            }
            finally
            {
