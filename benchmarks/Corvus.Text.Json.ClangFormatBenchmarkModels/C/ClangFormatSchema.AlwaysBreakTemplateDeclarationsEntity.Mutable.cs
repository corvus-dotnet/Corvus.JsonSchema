...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct AlwaysBreakTemplateDeclarationsEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(AlwaysBreakTemplateDeclarationsEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="AlwaysBreakTemplateDeclarationsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AlwaysBreakTemplateDeclarationsEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new AlwaysBreakTemplateDeclarationsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AlwaysBreakTemplateDeclarationsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="AlwaysBreakTemplateDeclarationsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="AlwaysBreakTemplateDeclarationsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly AlwaysBreakTemplateDeclarationsEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<AlwaysBreakTemplateDeclarationsEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="AlwaysBreakTemplateDeclarationsEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly AlwaysBreakTemplateDeclarationsEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<AlwaysBreakTemplateDeclarationsEntity>(_idx);
            }
            ...
            /// <param name="matchYes">Match 1st item.</param>
            /// <param name="matchNo">Match 2nd item.</param>
            /// <param name="matchMultiLine">Match 3rd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchYes,
                Func<TContext, TResult> matchNo,
...
#endif
            {
                ...
                {
                    return matchYes(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchNo(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchYes,
                Func<TResult> matchNo,
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(AlwaysBreakTemplateDeclarationsEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (AlwaysBreakTemplateDeclarationsEntity)value;
        ...
        {
            return workspace.CreateBuilder<AlwaysBreakTemplateDeclarationsEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<AlwaysBreakTemplateDeclarationsEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<AlwaysBreakTemplateDeclarationsEntity>();
            }
            finally
            {
