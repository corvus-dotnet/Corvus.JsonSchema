...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct BitFieldColonSpacingEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(BitFieldColonSpacingEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BitFieldColonSpacingEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BitFieldColonSpacingEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BitFieldColonSpacingEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly BitFieldColonSpacingEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly BitFieldColonSpacingEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<BitFieldColonSpacingEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(BitFieldColonSpacingEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (BitFieldColonSpacingEntity)value;
        ...
        {
            return workspace.CreateBuilder<BitFieldColonSpacingEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<BitFieldColonSpacingEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<BitFieldColonSpacingEntity>();
            }
            finally
            {
