...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct BitFieldColonSpacingEntity
#if NET8_0_OR_GREATER
        : IJsonElement<BitFieldColonSpacingEntity>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BitFieldColonSpacingEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal BitFieldColonSpacingEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static BitFieldColonSpacingEntity DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(BitFieldColonSpacingEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in BitFieldColonSpacingEntity left, in BitFieldColonSpacingEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in BitFieldColonSpacingEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(BitFieldColonSpacingEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BitFieldColonSpacingEntity(JsonElement instance)
        {
            return BitFieldColonSpacingEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BitFieldColonSpacingEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BitFieldColonSpacingEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BitFieldColonSpacingEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BitFieldColonSpacingEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BitFieldColonSpacingEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BitFieldColonSpacingEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BitFieldColonSpacingEntity>(json, options);
        }
        ...
        /// </exception>
        public static BitFieldColonSpacingEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<BitFieldColonSpacingEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out BitFieldColonSpacingEntity? result)
        {
            return JsonElementHelpers.TryParseValue<BitFieldColonSpacingEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new BitFieldColonSpacingEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static BitFieldColonSpacingEntity IJsonElement<BitFieldColonSpacingEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BitFieldColonSpacingEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="BitFieldColonSpacingEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="BitFieldColonSpacingEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public BitFieldColonSpacingEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<BitFieldColonSpacingEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="BitFieldColonSpacingEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public BitFieldColonSpacingEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<BitFieldColonSpacingEntity>(_idx);
            }
        ...
        /// <param name="matchBoth">Match 1st item.</param>
        /// <param name="matchNone">Match 2nd item.</param>
        /// <param name="matchBefore">Match 3rd item.</param>
        /// <param name="matchAfter">Match 4th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchBoth,
            Func<TContext, TResult> matchNone,
            Func<TContext, TResult> matchBefore,
            Func<TContext, TResult> matchAfter,
...
#endif
        {
            ...
            {
                return matchBefore(context);
            }

            if (this.ValueEquals(Constants.Enum4))
            {
                return matchAfter(context);
            }
        ...
        public TResult Match<TResult>(
            Func<TResult> matchBoth,
            Func<TResult> matchNone,
            Func<TResult> matchBefore,
            Func<TResult> matchAfter,
