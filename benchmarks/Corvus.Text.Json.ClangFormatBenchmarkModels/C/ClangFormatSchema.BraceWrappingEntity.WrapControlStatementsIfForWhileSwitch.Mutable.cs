    ...
    public readonly partial struct BraceWrappingEntity
    {
        ...
        public readonly partial struct WrapControlStatementsIfForWhileSwitch
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(WrapControlStatementsIfForWhileSwitch instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="WrapControlStatementsIfForWhileSwitch"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WrapControlStatementsIfForWhileSwitch(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WrapControlStatementsIfForWhileSwitch.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly WrapControlStatementsIfForWhileSwitch Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly WrapControlStatementsIfForWhileSwitch Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<WrapControlStatementsIfForWhileSwitch>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(WrapControlStatementsIfForWhileSwitch instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (WrapControlStatementsIfForWhileSwitch)value;
            ...
            {
                return workspace.CreateBuilder<WrapControlStatementsIfForWhileSwitch, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<WrapControlStatementsIfForWhileSwitch> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<WrapControlStatementsIfForWhileSwitch>();
                }
                finally
                {
