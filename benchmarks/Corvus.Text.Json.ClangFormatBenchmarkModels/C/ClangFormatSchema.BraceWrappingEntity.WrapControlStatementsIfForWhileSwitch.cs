...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct BraceWrappingEntity
    {
        ...
        public readonly partial struct WrapControlStatementsIfForWhileSwitch
#if NET8_0_OR_GREATER
            : IJsonElement<WrapControlStatementsIfForWhileSwitch>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="WrapControlStatementsIfForWhileSwitch"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal WrapControlStatementsIfForWhileSwitch(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static WrapControlStatementsIfForWhileSwitch DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(WrapControlStatementsIfForWhileSwitch value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in WrapControlStatementsIfForWhileSwitch left, in WrapControlStatementsIfForWhileSwitch right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in WrapControlStatementsIfForWhileSwitch left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(WrapControlStatementsIfForWhileSwitch instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator WrapControlStatementsIfForWhileSwitch(JsonElement instance)
            {
                return WrapControlStatementsIfForWhileSwitch.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WrapControlStatementsIfForWhileSwitch From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WrapControlStatementsIfForWhileSwitch ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WrapControlStatementsIfForWhileSwitch>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WrapControlStatementsIfForWhileSwitch ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WrapControlStatementsIfForWhileSwitch>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WrapControlStatementsIfForWhileSwitch ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WrapControlStatementsIfForWhileSwitch>(json, options);
            }
            ...
            /// </exception>
            public static WrapControlStatementsIfForWhileSwitch ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<WrapControlStatementsIfForWhileSwitch>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out WrapControlStatementsIfForWhileSwitch? result)
            {
                return JsonElementHelpers.TryParseValue<WrapControlStatementsIfForWhileSwitch>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new WrapControlStatementsIfForWhileSwitch(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static WrapControlStatementsIfForWhileSwitch IJsonElement<WrapControlStatementsIfForWhileSwitch>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"WrapControlStatementsIfForWhileSwitch: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="WrapControlStatementsIfForWhileSwitch"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="WrapControlStatementsIfForWhileSwitch"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public WrapControlStatementsIfForWhileSwitch Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<WrapControlStatementsIfForWhileSwitch>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="WrapControlStatementsIfForWhileSwitch"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public WrapControlStatementsIfForWhileSwitch Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<WrapControlStatementsIfForWhileSwitch>(_idx);
                }
            ...
            /// <param name="matchMultiLine">Match 2nd item.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Func<TContext, TResult> matchMultiLine,
