...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct BreakAfterAttributesEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(BreakAfterAttributesEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BreakAfterAttributesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BreakAfterAttributesEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BreakAfterAttributesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly BreakAfterAttributesEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly BreakAfterAttributesEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<BreakAfterAttributesEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(BreakAfterAttributesEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (BreakAfterAttributesEntity)value;
        ...
        {
            return workspace.CreateBuilder<BreakAfterAttributesEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<BreakAfterAttributesEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<BreakAfterAttributesEntity>();
            }
            finally
            {
