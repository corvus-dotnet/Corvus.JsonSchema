    ...
    public readonly partial struct BreakBeforeConceptDeclarationsEntity
    {
        ...
        public readonly partial struct ClangFormat12TheConceptDeclarationStyleToUse
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ClangFormat12TheConceptDeclarationStyleToUse instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ClangFormat12TheConceptDeclarationStyleToUse"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ClangFormat12TheConceptDeclarationStyleToUse(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ClangFormat12TheConceptDeclarationStyleToUse.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ClangFormat12TheConceptDeclarationStyleToUse Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ClangFormat12TheConceptDeclarationStyleToUse Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ClangFormat12TheConceptDeclarationStyleToUse>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ClangFormat12TheConceptDeclarationStyleToUse instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (ClangFormat12TheConceptDeclarationStyleToUse)value;
            ...
            {
                return workspace.CreateBuilder<ClangFormat12TheConceptDeclarationStyleToUse, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ClangFormat12TheConceptDeclarationStyleToUse> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ClangFormat12TheConceptDeclarationStyleToUse>();
                }
                finally
                {
