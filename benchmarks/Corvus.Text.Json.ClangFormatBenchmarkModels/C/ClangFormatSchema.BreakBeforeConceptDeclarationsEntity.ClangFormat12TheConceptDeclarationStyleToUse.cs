...
public readonly partial struct ClangFormatSchema
{
    ...
    /// </summary>
    public readonly partial struct BreakBeforeConceptDeclarationsEntity
    {
        /// <summary>
        /// Generated from JSON Schema.
        /// </summary>
        /// <remarks>
        /// <para>
        /// clang-format 12\r\r The concept declaration style to use.
        /// </para>
        /// </remarks>
        [DebuggerDisplay("{DebuggerDisplay,nq}")]
        public readonly partial struct ClangFormat12TheConceptDeclarationStyleToUse
#if NET8_0_OR_GREATER
            : IJsonElement<ClangFormat12TheConceptDeclarationStyleToUse>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ClangFormat12TheConceptDeclarationStyleToUse"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ClangFormat12TheConceptDeclarationStyleToUse(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ClangFormat12TheConceptDeclarationStyleToUse DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ClangFormat12TheConceptDeclarationStyleToUse value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in ClangFormat12TheConceptDeclarationStyleToUse left, in ClangFormat12TheConceptDeclarationStyleToUse right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ClangFormat12TheConceptDeclarationStyleToUse left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ClangFormat12TheConceptDeclarationStyleToUse instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ClangFormat12TheConceptDeclarationStyleToUse(JsonElement instance)
            {
                return ClangFormat12TheConceptDeclarationStyleToUse.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClangFormat12TheConceptDeclarationStyleToUse From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClangFormat12TheConceptDeclarationStyleToUse ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClangFormat12TheConceptDeclarationStyleToUse>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClangFormat12TheConceptDeclarationStyleToUse ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClangFormat12TheConceptDeclarationStyleToUse>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClangFormat12TheConceptDeclarationStyleToUse ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClangFormat12TheConceptDeclarationStyleToUse>(json, options);
            }
            ...
            /// </exception>
            public static ClangFormat12TheConceptDeclarationStyleToUse ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ClangFormat12TheConceptDeclarationStyleToUse>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ClangFormat12TheConceptDeclarationStyleToUse? result)
            {
                return JsonElementHelpers.TryParseValue<ClangFormat12TheConceptDeclarationStyleToUse>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ClangFormat12TheConceptDeclarationStyleToUse(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ClangFormat12TheConceptDeclarationStyleToUse IJsonElement<ClangFormat12TheConceptDeclarationStyleToUse>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ClangFormat12TheConceptDeclarationStyleToUse: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ClangFormat12TheConceptDeclarationStyleToUse"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ClangFormat12TheConceptDeclarationStyleToUse"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ClangFormat12TheConceptDeclarationStyleToUse Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ClangFormat12TheConceptDeclarationStyleToUse>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ClangFormat12TheConceptDeclarationStyleToUse"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ClangFormat12TheConceptDeclarationStyleToUse Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ClangFormat12TheConceptDeclarationStyleToUse>(_idx);
                }
            ...
            /// <param name="matchNever">Match 1st item.</param>
            /// <param name="matchAllowed">Match 2nd item.</param>
            /// <param name="matchAlways">Match 3rd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchNever,
                Func<TContext, TResult> matchAllowed,
                Func<TContext, TResult> matchAlways,
            ...
            public TResult Match<TResult>(
                ...
                Func<TResult> matchAllowed,
                Func<TResult> matchAlways,
