...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct BreakBeforeConceptDeclarationsEntity
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse.Mutable(Mutable value)
            {
                return Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(BreakBeforeConceptDeclarationsEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BreakBeforeConceptDeclarationsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BreakBeforeConceptDeclarationsEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BreakBeforeConceptDeclarationsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly BreakBeforeConceptDeclarationsEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly BreakBeforeConceptDeclarationsEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<BreakBeforeConceptDeclarationsEntity>(_idx);
            }
            ...
            /// <param name="matchClangFormat12TheConceptDeclarationStyleToUse">Match a <see cref="Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse, TContext, TResult> matchClangFormat12TheConceptDeclarationStyleToUse,
                Matcher<Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BreakBeforeConceptDeclarationsEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                if (Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchClangFormat12TheConceptDeclarationStyleToUse(Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse, TResult> matchClangFormat12TheConceptDeclarationStyleToUse,
                Matcher<Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BreakBeforeConceptDeclarationsEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.ClangFormatBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchClangFormat12TheConceptDeclarationStyleToUse(Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse.Mutable.From(this));
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsClangFormat12TheConceptDeclarationStyleToUse(out Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse.Mutable result)
            {
                if (Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(BreakBeforeConceptDeclarationsEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BreakBeforeConceptDeclarationsEntity.ClangFormat12TheConceptDeclarationStyleToUse instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<BreakBeforeConceptDeclarationsEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<BreakBeforeConceptDeclarationsEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<BreakBeforeConceptDeclarationsEntity>();
            }
            finally
            {
