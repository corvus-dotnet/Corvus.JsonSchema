...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct ClangFormat15ThePositionOfTheRequiresClause
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ClangFormat15ThePositionOfTheRequiresClause instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ClangFormat15ThePositionOfTheRequiresClause"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ClangFormat15ThePositionOfTheRequiresClause(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ClangFormat15ThePositionOfTheRequiresClause.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ClangFormat15ThePositionOfTheRequiresClause Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ClangFormat15ThePositionOfTheRequiresClause Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ClangFormat15ThePositionOfTheRequiresClause>(_idx);
            }
            ...
            public bool TryGetKnownValue(out KnownValues result)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    result = KnownValues.OwnLine;
                    return true;
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    result = KnownValues.WithPreceding;
                    return true;
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    result = KnownValues.WithFollowing;
                    return true;
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    result = KnownValues.SingleLine;
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ClangFormat15ThePositionOfTheRequiresClause instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (ClangFormat15ThePositionOfTheRequiresClause)value;
        ...
        {
            return workspace.CreateBuilder<ClangFormat15ThePositionOfTheRequiresClause, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ClangFormat15ThePositionOfTheRequiresClause> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ClangFormat15ThePositionOfTheRequiresClause>();
            }
            finally
            {
