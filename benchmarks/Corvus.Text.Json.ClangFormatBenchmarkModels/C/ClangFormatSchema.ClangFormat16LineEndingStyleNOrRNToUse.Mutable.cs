...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct ClangFormat16LineEndingStyleNOrRNToUse
    {
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (ClangFormat16LineEndingStyleNOrRNToUse)value;
        ...
        public static ParsedJsonDocument<ClangFormat16LineEndingStyleNOrRNToUse> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ClangFormat16LineEndingStyleNOrRNToUse>();
            }
            finally
            {
