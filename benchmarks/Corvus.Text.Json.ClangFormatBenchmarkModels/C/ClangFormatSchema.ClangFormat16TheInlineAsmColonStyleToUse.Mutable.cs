...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct ClangFormat16TheInlineAsmColonStyleToUse
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ClangFormat16TheInlineAsmColonStyleToUse instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ClangFormat16TheInlineAsmColonStyleToUse"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ClangFormat16TheInlineAsmColonStyleToUse(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ClangFormat16TheInlineAsmColonStyleToUse.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ClangFormat16TheInlineAsmColonStyleToUse Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ClangFormat16TheInlineAsmColonStyleToUse Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ClangFormat16TheInlineAsmColonStyleToUse>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ClangFormat16TheInlineAsmColonStyleToUse instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (ClangFormat16TheInlineAsmColonStyleToUse)value;
        ...
        {
            return workspace.CreateBuilder<ClangFormat16TheInlineAsmColonStyleToUse, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ClangFormat16TheInlineAsmColonStyleToUse> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ClangFormat16TheInlineAsmColonStyleToUse>();
            }
            finally
            {
