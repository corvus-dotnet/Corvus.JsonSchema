...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct ClangFormat35LanguageThisFormatStyleIsTargetedAt
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ClangFormat35LanguageThisFormatStyleIsTargetedAt instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ClangFormat35LanguageThisFormatStyleIsTargetedAt"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ClangFormat35LanguageThisFormatStyleIsTargetedAt(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ClangFormat35LanguageThisFormatStyleIsTargetedAt.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ClangFormat35LanguageThisFormatStyleIsTargetedAt Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ClangFormat35LanguageThisFormatStyleIsTargetedAt Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ClangFormat35LanguageThisFormatStyleIsTargetedAt>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ClangFormat35LanguageThisFormatStyleIsTargetedAt instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (ClangFormat35LanguageThisFormatStyleIsTargetedAt)value;
        ...
        {
            return workspace.CreateBuilder<ClangFormat35LanguageThisFormatStyleIsTargetedAt, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ClangFormat35LanguageThisFormatStyleIsTargetedAt> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ClangFormat35LanguageThisFormatStyleIsTargetedAt>();
            }
            finally
            {
