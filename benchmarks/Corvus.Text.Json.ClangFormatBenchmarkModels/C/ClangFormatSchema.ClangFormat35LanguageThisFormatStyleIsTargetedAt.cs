...
public readonly partial struct ClangFormatSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClangFormat35LanguageThisFormatStyleIsTargetedAt"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ClangFormat35LanguageThisFormatStyleIsTargetedAt(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ClangFormat35LanguageThisFormatStyleIsTargetedAt DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(ClangFormat35LanguageThisFormatStyleIsTargetedAt value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in ClangFormat35LanguageThisFormatStyleIsTargetedAt left, in ClangFormat35LanguageThisFormatStyleIsTargetedAt right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ClangFormat35LanguageThisFormatStyleIsTargetedAt left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ClangFormat35LanguageThisFormatStyleIsTargetedAt instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ClangFormat35LanguageThisFormatStyleIsTargetedAt(JsonElement instance)
        {
            return ClangFormat35LanguageThisFormatStyleIsTargetedAt.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat35LanguageThisFormatStyleIsTargetedAt From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat35LanguageThisFormatStyleIsTargetedAt ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ClangFormat35LanguageThisFormatStyleIsTargetedAt>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat35LanguageThisFormatStyleIsTargetedAt ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ClangFormat35LanguageThisFormatStyleIsTargetedAt>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat35LanguageThisFormatStyleIsTargetedAt ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ClangFormat35LanguageThisFormatStyleIsTargetedAt>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static ClangFormat35LanguageThisFormatStyleIsTargetedAt ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ClangFormat35LanguageThisFormatStyleIsTargetedAt>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ClangFormat35LanguageThisFormatStyleIsTargetedAt? result)
        {
            return JsonElementHelpers.TryParseValue<ClangFormat35LanguageThisFormatStyleIsTargetedAt>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ClangFormat35LanguageThisFormatStyleIsTargetedAt(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ClangFormat35LanguageThisFormatStyleIsTargetedAt IJsonElement<ClangFormat35LanguageThisFormatStyleIsTargetedAt>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ClangFormat35LanguageThisFormatStyleIsTargetedAt: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ClangFormat35LanguageThisFormatStyleIsTargetedAt"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ClangFormat35LanguageThisFormatStyleIsTargetedAt"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ClangFormat35LanguageThisFormatStyleIsTargetedAt Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ClangFormat35LanguageThisFormatStyleIsTargetedAt>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ClangFormat35LanguageThisFormatStyleIsTargetedAt"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ClangFormat35LanguageThisFormatStyleIsTargetedAt Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ClangFormat35LanguageThisFormatStyleIsTargetedAt>(_idx);
            }
        ...
        /// <param name="matchCpp">Match 2nd item.</param>
        /// <param name="matchObjC">Match 3rd item.</param>
        /// <param name="matchCSharp">Match 4th item.</param>
        /// <param name="matchJava">Match 5th item.</param>
        /// <param name="matchJavaScript">Match 6th item.</param>
        /// <param name="matchJson">Match 7th item.</param>
        /// <param name="matchProto">Match 8th item.</param>
        /// <param name="matchTableGen">Match 9th item.</param>
        /// <param name="matchTextProto">Match 10th item.</param>
        /// <param name="matchVerilog">Match 11th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchNone,
            Func<TContext, TResult> matchCpp,
            Func<TContext, TResult> matchObjC,
            Func<TContext, TResult> matchCSharp,
            ...
            Func<TContext, TResult> matchTableGen,
            Func<TContext, TResult> matchTextProto,
...
#endif
        {
            ...
            {
                return matchCpp(context);
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchObjC(context);
            }

            if (this.ValueEquals(Constants.Enum4))
            {
                return matchCSharp(context);
            }
            ...
            {
                return matchTableGen(context);
            }

            if (this.ValueEquals(Constants.Enum10))
            {
                return matchTextProto(context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Func<TResult> matchCpp,
            Func<TResult> matchObjC,
            Func<TResult> matchCSharp,
            Func<TResult> matchJava,
            Func<TResult> matchJavaScript,
            Func<TResult> matchJson,
            Func<TResult> matchProto,
            Func<TResult> matchTableGen,
            Func<TResult> matchTextProto,
            ...
            Func<TResult> defaultMatch)
        {
            ...
            if (this.ValueEquals(Constants.Enum9))
            {
                return matchTableGen();
            }

            if (this.ValueEquals(Constants.Enum10))
            {
                return matchTextProto();
            }
