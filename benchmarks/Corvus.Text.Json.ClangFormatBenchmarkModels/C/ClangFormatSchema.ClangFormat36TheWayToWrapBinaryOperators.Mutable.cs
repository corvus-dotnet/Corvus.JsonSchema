...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct ClangFormat36TheWayToWrapBinaryOperators
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ClangFormat36TheWayToWrapBinaryOperators instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ClangFormat36TheWayToWrapBinaryOperators"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ClangFormat36TheWayToWrapBinaryOperators(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ClangFormat36TheWayToWrapBinaryOperators.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ClangFormat36TheWayToWrapBinaryOperators Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ClangFormat36TheWayToWrapBinaryOperators Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ClangFormat36TheWayToWrapBinaryOperators>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ClangFormat36TheWayToWrapBinaryOperators instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (ClangFormat36TheWayToWrapBinaryOperators)value;
        ...
        {
            return workspace.CreateBuilder<ClangFormat36TheWayToWrapBinaryOperators, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ClangFormat36TheWayToWrapBinaryOperators> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ClangFormat36TheWayToWrapBinaryOperators>();
            }
            finally
            {
