...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct ClangFormat37IndentWidthForLineContinuations
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ClangFormat37IndentWidthForLineContinuations instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ClangFormat37IndentWidthForLineContinuations"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ClangFormat37IndentWidthForLineContinuations(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ClangFormat37IndentWidthForLineContinuations(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ClangFormat37IndentWidthForLineContinuations.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ClangFormat37IndentWidthForLineContinuations"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ClangFormat37IndentWidthForLineContinuations"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ClangFormat37IndentWidthForLineContinuations Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ClangFormat37IndentWidthForLineContinuations>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ClangFormat37IndentWidthForLineContinuations"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ClangFormat37IndentWidthForLineContinuations Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ClangFormat37IndentWidthForLineContinuations>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ClangFormat37IndentWidthForLineContinuations instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ClangFormat37IndentWidthForLineContinuations, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ClangFormat37IndentWidthForLineContinuations> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ClangFormat37IndentWidthForLineContinuations>();
            }
            finally
            {
