...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct ClangFormat37PointerAndReferenceAlignmentStyle
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ClangFormat37PointerAndReferenceAlignmentStyle instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ClangFormat37PointerAndReferenceAlignmentStyle"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ClangFormat37PointerAndReferenceAlignmentStyle(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ClangFormat37PointerAndReferenceAlignmentStyle.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ClangFormat37PointerAndReferenceAlignmentStyle Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ClangFormat37PointerAndReferenceAlignmentStyle Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ClangFormat37PointerAndReferenceAlignmentStyle>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ClangFormat37PointerAndReferenceAlignmentStyle instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (ClangFormat37PointerAndReferenceAlignmentStyle)value;
        ...
        {
            return workspace.CreateBuilder<ClangFormat37PointerAndReferenceAlignmentStyle, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ClangFormat37PointerAndReferenceAlignmentStyle> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ClangFormat37PointerAndReferenceAlignmentStyle>();
            }
            finally
            {
