...
public readonly partial struct ClangFormatSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClangFormat37PointerAndReferenceAlignmentStyle"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ClangFormat37PointerAndReferenceAlignmentStyle(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ClangFormat37PointerAndReferenceAlignmentStyle DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(ClangFormat37PointerAndReferenceAlignmentStyle value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in ClangFormat37PointerAndReferenceAlignmentStyle left, in ClangFormat37PointerAndReferenceAlignmentStyle right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ClangFormat37PointerAndReferenceAlignmentStyle left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ClangFormat37PointerAndReferenceAlignmentStyle instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ClangFormat37PointerAndReferenceAlignmentStyle(JsonElement instance)
        {
            return ClangFormat37PointerAndReferenceAlignmentStyle.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat37PointerAndReferenceAlignmentStyle From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat37PointerAndReferenceAlignmentStyle ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClangFormat37PointerAndReferenceAlignmentStyle>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat37PointerAndReferenceAlignmentStyle ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClangFormat37PointerAndReferenceAlignmentStyle>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat37PointerAndReferenceAlignmentStyle ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClangFormat37PointerAndReferenceAlignmentStyle>(json, options);
        }
        ...
        /// </exception>
        public static ClangFormat37PointerAndReferenceAlignmentStyle ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ClangFormat37PointerAndReferenceAlignmentStyle>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ClangFormat37PointerAndReferenceAlignmentStyle? result)
        {
            return JsonElementHelpers.TryParseValue<ClangFormat37PointerAndReferenceAlignmentStyle>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ClangFormat37PointerAndReferenceAlignmentStyle(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ClangFormat37PointerAndReferenceAlignmentStyle IJsonElement<ClangFormat37PointerAndReferenceAlignmentStyle>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ClangFormat37PointerAndReferenceAlignmentStyle: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ClangFormat37PointerAndReferenceAlignmentStyle"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ClangFormat37PointerAndReferenceAlignmentStyle"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ClangFormat37PointerAndReferenceAlignmentStyle Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ClangFormat37PointerAndReferenceAlignmentStyle>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ClangFormat37PointerAndReferenceAlignmentStyle"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ClangFormat37PointerAndReferenceAlignmentStyle Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ClangFormat37PointerAndReferenceAlignmentStyle>(_idx);
            }
        ...
        /// <param name="matchRight">Match 2nd item.</param>
        /// <param name="matchMiddle">Match 3rd item.</param>
