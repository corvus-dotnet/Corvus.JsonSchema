...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct ClangFormat37TheBraceBreakingStyleToUse
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ClangFormat37TheBraceBreakingStyleToUse instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ClangFormat37TheBraceBreakingStyleToUse"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ClangFormat37TheBraceBreakingStyleToUse(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ClangFormat37TheBraceBreakingStyleToUse.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ClangFormat37TheBraceBreakingStyleToUse Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ClangFormat37TheBraceBreakingStyleToUse Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ClangFormat37TheBraceBreakingStyleToUse>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ClangFormat37TheBraceBreakingStyleToUse instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (ClangFormat37TheBraceBreakingStyleToUse)value;
        ...
        {
            return workspace.CreateBuilder<ClangFormat37TheBraceBreakingStyleToUse, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ClangFormat37TheBraceBreakingStyleToUse> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ClangFormat37TheBraceBreakingStyleToUse>();
            }
            finally
            {
