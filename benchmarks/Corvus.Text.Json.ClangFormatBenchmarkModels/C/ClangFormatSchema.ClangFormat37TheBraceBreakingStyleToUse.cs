...
public readonly partial struct ClangFormatSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClangFormat37TheBraceBreakingStyleToUse"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ClangFormat37TheBraceBreakingStyleToUse(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ClangFormat37TheBraceBreakingStyleToUse DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(ClangFormat37TheBraceBreakingStyleToUse value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in ClangFormat37TheBraceBreakingStyleToUse left, in ClangFormat37TheBraceBreakingStyleToUse right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ClangFormat37TheBraceBreakingStyleToUse left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ClangFormat37TheBraceBreakingStyleToUse instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ClangFormat37TheBraceBreakingStyleToUse(JsonElement instance)
        {
            return ClangFormat37TheBraceBreakingStyleToUse.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat37TheBraceBreakingStyleToUse From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat37TheBraceBreakingStyleToUse ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClangFormat37TheBraceBreakingStyleToUse>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat37TheBraceBreakingStyleToUse ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClangFormat37TheBraceBreakingStyleToUse>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClangFormat37TheBraceBreakingStyleToUse ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClangFormat37TheBraceBreakingStyleToUse>(json, options);
        }
        ...
        /// </exception>
        public static ClangFormat37TheBraceBreakingStyleToUse ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ClangFormat37TheBraceBreakingStyleToUse>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ClangFormat37TheBraceBreakingStyleToUse? result)
        {
            return JsonElementHelpers.TryParseValue<ClangFormat37TheBraceBreakingStyleToUse>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ClangFormat37TheBraceBreakingStyleToUse(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ClangFormat37TheBraceBreakingStyleToUse IJsonElement<ClangFormat37TheBraceBreakingStyleToUse>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ClangFormat37TheBraceBreakingStyleToUse: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ClangFormat37TheBraceBreakingStyleToUse"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ClangFormat37TheBraceBreakingStyleToUse"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ClangFormat37TheBraceBreakingStyleToUse Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ClangFormat37TheBraceBreakingStyleToUse>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ClangFormat37TheBraceBreakingStyleToUse"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ClangFormat37TheBraceBreakingStyleToUse Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ClangFormat37TheBraceBreakingStyleToUse>(_idx);
            }
        ...
        /// <param name="matchAttach">Match 1st item.</param>
        /// <param name="matchLinux">Match 2nd item.</param>
        /// <param name="matchMozilla">Match 3rd item.</param>
        /// <param name="matchStroustrup">Match 4th item.</param>
        /// <param name="matchAllman">Match 5th item.</param>
        /// <param name="matchWhitesmiths">Match 6th item.</param>
        /// <param name="matchGnu">Match 7th item.</param>
        /// <param name="matchWebKit">Match 8th item.</param>
        /// <param name="matchCustom">Match 9th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchAttach,
            Func<TContext, TResult> matchLinux,
            Func<TContext, TResult> matchMozilla,
            Func<TContext, TResult> matchStroustrup,
            Func<TContext, TResult> matchAllman,
            Func<TContext, TResult> matchWhitesmiths,
...
#endif
        {
            ...
            {
                return matchAttach(context);
            }

            if (this.ValueEquals(Constants.Enum2))
            {
                return matchLinux(context);
            }
            ...
            {
                return matchStroustrup(context);
            }

            if (this.ValueEquals(Constants.Enum5))
            {
                return matchAllman(context);
            }

            if (this.ValueEquals(Constants.Enum6))
            {
                return matchWhitesmiths(context);
            }
        ...
        public TResult Match<TResult>(
            Func<TResult> matchAttach,
            Func<TResult> matchLinux,
            Func<TResult> matchMozilla,
            Func<TResult> matchStroustrup,
            Func<TResult> matchAllman,
            Func<TResult> matchWhitesmiths,
