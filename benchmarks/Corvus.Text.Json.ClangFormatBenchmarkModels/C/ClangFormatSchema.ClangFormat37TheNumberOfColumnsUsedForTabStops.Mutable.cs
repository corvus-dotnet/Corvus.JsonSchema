...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct ClangFormat37TheNumberOfColumnsUsedForTabStops
    {
        ...
        public static ParsedJsonDocument<ClangFormat37TheNumberOfColumnsUsedForTabStops> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ClangFormat37TheNumberOfColumnsUsedForTabStops>();
            }
            finally
            {
