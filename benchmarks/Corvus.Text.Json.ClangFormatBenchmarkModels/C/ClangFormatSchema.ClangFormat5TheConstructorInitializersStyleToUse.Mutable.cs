...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct ClangFormat5TheConstructorInitializersStyleToUse
    {
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (ClangFormat5TheConstructorInitializersStyleToUse)value;
        ...
        public static ParsedJsonDocument<ClangFormat5TheConstructorInitializersStyleToUse> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ClangFormat5TheConstructorInitializersStyleToUse>();
            }
            finally
            {
