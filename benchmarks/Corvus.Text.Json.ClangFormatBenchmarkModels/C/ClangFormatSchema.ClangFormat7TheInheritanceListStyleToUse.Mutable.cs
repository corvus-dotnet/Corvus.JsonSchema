...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct ClangFormat7TheInheritanceListStyleToUse
    {
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (ClangFormat7TheInheritanceListStyleToUse)value;
        ...
        public static ParsedJsonDocument<ClangFormat7TheInheritanceListStyleToUse> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ClangFormat7TheInheritanceListStyleToUse>();
            }
            finally
            {
