...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct ClnagFormat37TheIndentationUsedForNamespaces
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ClnagFormat37TheIndentationUsedForNamespaces instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ClnagFormat37TheIndentationUsedForNamespaces"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ClnagFormat37TheIndentationUsedForNamespaces(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ClnagFormat37TheIndentationUsedForNamespaces.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ClnagFormat37TheIndentationUsedForNamespaces Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ClnagFormat37TheIndentationUsedForNamespaces Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ClnagFormat37TheIndentationUsedForNamespaces>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ClnagFormat37TheIndentationUsedForNamespaces instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (ClnagFormat37TheIndentationUsedForNamespaces)value;
        ...
        {
            return workspace.CreateBuilder<ClnagFormat37TheIndentationUsedForNamespaces, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ClnagFormat37TheIndentationUsedForNamespaces> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ClnagFormat37TheIndentationUsedForNamespaces>();
            }
            finally
            {
