...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct ClnagFormat37TheIndentationUsedForNamespaces
#if NET8_0_OR_GREATER
        : IJsonElement<ClnagFormat37TheIndentationUsedForNamespaces>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClnagFormat37TheIndentationUsedForNamespaces"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ClnagFormat37TheIndentationUsedForNamespaces(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ClnagFormat37TheIndentationUsedForNamespaces DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(ClnagFormat37TheIndentationUsedForNamespaces value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in ClnagFormat37TheIndentationUsedForNamespaces left, in ClnagFormat37TheIndentationUsedForNamespaces right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ClnagFormat37TheIndentationUsedForNamespaces left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ClnagFormat37TheIndentationUsedForNamespaces instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ClnagFormat37TheIndentationUsedForNamespaces(JsonElement instance)
        {
            return ClnagFormat37TheIndentationUsedForNamespaces.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClnagFormat37TheIndentationUsedForNamespaces From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClnagFormat37TheIndentationUsedForNamespaces ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClnagFormat37TheIndentationUsedForNamespaces>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClnagFormat37TheIndentationUsedForNamespaces ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClnagFormat37TheIndentationUsedForNamespaces>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClnagFormat37TheIndentationUsedForNamespaces ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ClnagFormat37TheIndentationUsedForNamespaces>(json, options);
        }
        ...
        /// </exception>
        public static ClnagFormat37TheIndentationUsedForNamespaces ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ClnagFormat37TheIndentationUsedForNamespaces>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ClnagFormat37TheIndentationUsedForNamespaces? result)
        {
            return JsonElementHelpers.TryParseValue<ClnagFormat37TheIndentationUsedForNamespaces>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ClnagFormat37TheIndentationUsedForNamespaces(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ClnagFormat37TheIndentationUsedForNamespaces IJsonElement<ClnagFormat37TheIndentationUsedForNamespaces>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ClnagFormat37TheIndentationUsedForNamespaces: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ClnagFormat37TheIndentationUsedForNamespaces"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ClnagFormat37TheIndentationUsedForNamespaces"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ClnagFormat37TheIndentationUsedForNamespaces Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ClnagFormat37TheIndentationUsedForNamespaces>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ClnagFormat37TheIndentationUsedForNamespaces"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ClnagFormat37TheIndentationUsedForNamespaces Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ClnagFormat37TheIndentationUsedForNamespaces>(_idx);
            }
        ...
        /// <param name="matchInner">Match 2nd item.</param>
        /// <param name="matchAll">Match 3rd item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchNone,
            Func<TContext, TResult> matchInner,
