...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct EmptyLineAfterAccessModifierEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(EmptyLineAfterAccessModifierEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EmptyLineAfterAccessModifierEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EmptyLineAfterAccessModifierEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EmptyLineAfterAccessModifierEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly EmptyLineAfterAccessModifierEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly EmptyLineAfterAccessModifierEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EmptyLineAfterAccessModifierEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EmptyLineAfterAccessModifierEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (EmptyLineAfterAccessModifierEntity)value;
        ...
        {
            return workspace.CreateBuilder<EmptyLineAfterAccessModifierEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<EmptyLineAfterAccessModifierEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EmptyLineAfterAccessModifierEntity>();
            }
            finally
            {
