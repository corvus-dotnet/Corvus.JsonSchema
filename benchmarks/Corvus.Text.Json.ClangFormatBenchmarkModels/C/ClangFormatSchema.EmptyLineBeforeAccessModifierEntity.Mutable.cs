...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct EmptyLineBeforeAccessModifierEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(EmptyLineBeforeAccessModifierEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EmptyLineBeforeAccessModifierEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EmptyLineBeforeAccessModifierEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EmptyLineBeforeAccessModifierEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly EmptyLineBeforeAccessModifierEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly EmptyLineBeforeAccessModifierEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EmptyLineBeforeAccessModifierEntity>(_idx);
            }
            ...
            public bool TryGetKnownValue(out KnownValues result)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    result = KnownValues.LogicalBlock;
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EmptyLineBeforeAccessModifierEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (EmptyLineBeforeAccessModifierEntity)value;
        ...
        {
            return workspace.CreateBuilder<EmptyLineBeforeAccessModifierEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<EmptyLineBeforeAccessModifierEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EmptyLineBeforeAccessModifierEntity>();
            }
            finally
            {
