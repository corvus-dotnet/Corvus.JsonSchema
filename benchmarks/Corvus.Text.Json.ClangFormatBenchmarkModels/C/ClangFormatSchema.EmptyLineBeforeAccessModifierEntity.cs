...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct EmptyLineBeforeAccessModifierEntity
#if NET8_0_OR_GREATER
        : IJsonElement<EmptyLineBeforeAccessModifierEntity>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EmptyLineBeforeAccessModifierEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal EmptyLineBeforeAccessModifierEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static EmptyLineBeforeAccessModifierEntity DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(EmptyLineBeforeAccessModifierEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in EmptyLineBeforeAccessModifierEntity left, in EmptyLineBeforeAccessModifierEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in EmptyLineBeforeAccessModifierEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(EmptyLineBeforeAccessModifierEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator EmptyLineBeforeAccessModifierEntity(JsonElement instance)
        {
            return EmptyLineBeforeAccessModifierEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EmptyLineBeforeAccessModifierEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EmptyLineBeforeAccessModifierEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EmptyLineBeforeAccessModifierEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EmptyLineBeforeAccessModifierEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EmptyLineBeforeAccessModifierEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EmptyLineBeforeAccessModifierEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EmptyLineBeforeAccessModifierEntity>(json, options);
        }
        ...
        /// </exception>
        public static EmptyLineBeforeAccessModifierEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<EmptyLineBeforeAccessModifierEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out EmptyLineBeforeAccessModifierEntity? result)
        {
            return JsonElementHelpers.TryParseValue<EmptyLineBeforeAccessModifierEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new EmptyLineBeforeAccessModifierEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static EmptyLineBeforeAccessModifierEntity IJsonElement<EmptyLineBeforeAccessModifierEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"EmptyLineBeforeAccessModifierEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="EmptyLineBeforeAccessModifierEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="EmptyLineBeforeAccessModifierEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public EmptyLineBeforeAccessModifierEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<EmptyLineBeforeAccessModifierEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="EmptyLineBeforeAccessModifierEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public EmptyLineBeforeAccessModifierEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<EmptyLineBeforeAccessModifierEntity>(_idx);
            }
        ...
        /// <param name="matchLogicalBlock">Match 1st item.</param>
        /// <param name="matchNever">Match 2nd item.</param>
        /// <param name="matchLeave">Match 3rd item.</param>
        /// <param name="matchAlways">Match 4th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchLogicalBlock,
            Func<TContext, TResult> matchNever,
            Func<TContext, TResult> matchLeave,
...
#endif
        {
            ...
            {
                return matchLogicalBlock(context);
            }
        ...
        public TResult Match<TResult>(
            Func<TResult> matchLogicalBlock,
            Func<TResult> matchNever,
            Func<TResult> matchLeave,
            Func<TResult> matchAlways,
            Func<TResult> defaultMatch)
        {
            if (this.ValueEquals(Constants.Enum1))
            {
                return matchLogicalBlock();
            }
