...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct IfMacrosJsArray
#if NET8_0_OR_GREATER
        : IJsonElement<IfMacrosJsArray>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IfMacrosJsArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal IfMacrosJsArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static IfMacrosJsArray DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in IfMacrosJsArray left, in IfMacrosJsArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in IfMacrosJsArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(IfMacrosJsArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator IfMacrosJsArray(JsonElement instance)
        {
            return IfMacrosJsArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IfMacrosJsArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IfMacrosJsArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IfMacrosJsArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IfMacrosJsArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IfMacrosJsArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IfMacrosJsArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IfMacrosJsArray>(json, options);
        }
        ...
        /// </exception>
        public static IfMacrosJsArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<IfMacrosJsArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out IfMacrosJsArray? result)
        {
            return JsonElementHelpers.TryParseValue<IfMacrosJsArray>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new IfMacrosJsArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static IfMacrosJsArray IJsonElement<IfMacrosJsArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"IfMacrosJsArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="IfMacrosJsArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="IfMacrosJsArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public IfMacrosJsArray Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<IfMacrosJsArray>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="IfMacrosJsArray"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public IfMacrosJsArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<IfMacrosJsArray>(_idx);
            }
