...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct IncludeBlocksEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(IncludeBlocksEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="IncludeBlocksEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator IncludeBlocksEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"IncludeBlocksEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly IncludeBlocksEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly IncludeBlocksEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<IncludeBlocksEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(IncludeBlocksEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (IncludeBlocksEntity)value;
        ...
        {
            return workspace.CreateBuilder<IncludeBlocksEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<IncludeBlocksEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<IncludeBlocksEntity>();
            }
            finally
            {
