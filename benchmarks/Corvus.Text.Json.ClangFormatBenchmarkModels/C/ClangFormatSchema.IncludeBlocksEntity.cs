...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct IncludeBlocksEntity
#if NET8_0_OR_GREATER
        : IJsonElement<IncludeBlocksEntity>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IncludeBlocksEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal IncludeBlocksEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static IncludeBlocksEntity DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(IncludeBlocksEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in IncludeBlocksEntity left, in IncludeBlocksEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in IncludeBlocksEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(IncludeBlocksEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator IncludeBlocksEntity(JsonElement instance)
        {
            return IncludeBlocksEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IncludeBlocksEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IncludeBlocksEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IncludeBlocksEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IncludeBlocksEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IncludeBlocksEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IncludeBlocksEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IncludeBlocksEntity>(json, options);
        }
        ...
        /// </exception>
        public static IncludeBlocksEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<IncludeBlocksEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out IncludeBlocksEntity? result)
        {
            return JsonElementHelpers.TryParseValue<IncludeBlocksEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new IncludeBlocksEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static IncludeBlocksEntity IJsonElement<IncludeBlocksEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"IncludeBlocksEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="IncludeBlocksEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="IncludeBlocksEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public IncludeBlocksEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<IncludeBlocksEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="IncludeBlocksEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public IncludeBlocksEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<IncludeBlocksEntity>(_idx);
            }
        ...
        /// <param name="matchRegroup">Match 1st item.</param>
        /// <param name="matchPreserve">Match 2nd item.</param>
        /// <param name="matchMerge">Match 3rd item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchRegroup,
            Func<TContext, TResult> matchPreserve,
            Func<TContext, TResult> matchMerge,
        ...
        public TResult Match<TResult>(
            Func<TResult> matchRegroup,
            Func<TResult> matchPreserve,
            Func<TResult> matchMerge,
