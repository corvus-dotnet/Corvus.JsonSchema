...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct IndentExternBlockEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(IndentExternBlockEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="IndentExternBlockEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator IndentExternBlockEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new IndentExternBlockEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"IndentExternBlockEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="IndentExternBlockEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="IndentExternBlockEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly IndentExternBlockEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<IndentExternBlockEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="IndentExternBlockEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly IndentExternBlockEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<IndentExternBlockEntity>(_idx);
            }
            ...
            /// <param name="matchAfterExternBlock">Match 1st item.</param>
            /// <param name="matchNoIndent">Match 2nd item.</param>
            /// <param name="matchIndent">Match 3rd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchAfterExternBlock,
                Func<TContext, TResult> matchNoIndent,
                Func<TContext, TResult> matchIndent,
...
#endif
            {
                ...
                {
                    return matchAfterExternBlock(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchNoIndent(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchIndent(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchAfterExternBlock,
                Func<TResult> matchNoIndent,
                Func<TResult> matchIndent,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchAfterExternBlock();
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchNoIndent();
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(IndentExternBlockEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (IndentExternBlockEntity)value;
        ...
        {
            return workspace.CreateBuilder<IndentExternBlockEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<IndentExternBlockEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<IndentExternBlockEntity>();
            }
            finally
            {
