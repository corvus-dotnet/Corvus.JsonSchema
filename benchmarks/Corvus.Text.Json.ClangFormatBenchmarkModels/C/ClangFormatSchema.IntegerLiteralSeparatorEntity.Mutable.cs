...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct IntegerLiteralSeparatorEntity
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public readonly IntegerLiteralSeparatorEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly IntegerLiteralSeparatorEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<IntegerLiteralSeparatorEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.ClangFormatBenchmark.Current.JsonInteger.Source _createArg1;
            private readonly Corvus.ClangFormatBenchmark.Current.JsonInteger.Source _createArg2;
            private readonly Corvus.ClangFormatBenchmark.Current.JsonInteger.Source _createArg3;
            private readonly Corvus.ClangFormatBenchmark.Current.JsonInteger.Source _createArg4;
            private readonly Corvus.ClangFormatBenchmark.Current.JsonInteger.Source _createArg5;
            private readonly Corvus.ClangFormatBenchmark.Current.JsonInteger.Source _createArg6;
        ...
        /// </summary>
        /// <param name="binary">The value of the <c>"Binary"</c> property.</param>
        /// <param name="binaryMinDigits">The value of the <c>"BinaryMinDigits"</c> property.</param>
        /// <param name="decimalValue">The value of the <c>"Decimal"</c> property.</param>
        /// <param name="decimalMinDigits">The value of the <c>"DecimalMinDigits"</c> property.</param>
        ...
        public static ParsedJsonDocument<IntegerLiteralSeparatorEntity> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<IntegerLiteralSeparatorEntity>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<IntegerLiteralSeparatorEntity> Create<TContext>(
        ...
        public static ParsedJsonDocument<IntegerLiteralSeparatorEntity> Create(in Corvus.ClangFormatBenchmark.Current.JsonInteger.Source binary = default, in Corvus.ClangFormatBenchmark.Current.JsonInteger.Source binaryMinDigits = default, in Corvus.ClangFormatBenchmark.Current.JsonInteger.Source decimalValue = default, in Corvus.ClangFormatBenchmark.Current.JsonInteger.Source decimalMinDigits = default, in Corvus.ClangFormatBenchmark.Current.JsonInteger.Source hex = default, in Corvus.ClangFormatBenchmark.Current.JsonInteger.Source hexMinDigits = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
