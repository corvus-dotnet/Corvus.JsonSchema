...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct JavaImportGroupArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(JavaImportGroupArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="JavaImportGroupArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JavaImportGroupArray(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new JavaImportGroupArray(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"JavaImportGroupArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// <summary>
            /// Gets a <see cref="JavaImportGroupArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="JavaImportGroupArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly JavaImportGroupArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<JavaImportGroupArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="JavaImportGroupArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly JavaImportGroupArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<JavaImportGroupArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.JavaImportGroupArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(JavaImportGroupArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.JavaImportGroupArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<JavaImportGroupArray, Mutable>(this);
        }
    }
}
