...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct JavaScriptQuotesEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(JavaScriptQuotesEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="JavaScriptQuotesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JavaScriptQuotesEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"JavaScriptQuotesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly JavaScriptQuotesEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly JavaScriptQuotesEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<JavaScriptQuotesEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(JavaScriptQuotesEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (JavaScriptQuotesEntity)value;
        ...
        {
            return workspace.CreateBuilder<JavaScriptQuotesEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<JavaScriptQuotesEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<JavaScriptQuotesEntity>();
            }
            finally
            {
