...
public readonly partial struct ClangFormatSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JavaScriptQuotesEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal JavaScriptQuotesEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static JavaScriptQuotesEntity DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(JavaScriptQuotesEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in JavaScriptQuotesEntity left, in JavaScriptQuotesEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in JavaScriptQuotesEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(JavaScriptQuotesEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JavaScriptQuotesEntity(JsonElement instance)
        {
            return JavaScriptQuotesEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JavaScriptQuotesEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JavaScriptQuotesEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<JavaScriptQuotesEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JavaScriptQuotesEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<JavaScriptQuotesEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JavaScriptQuotesEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<JavaScriptQuotesEntity>(json, options);
        }
        ...
        /// </exception>
        public static JavaScriptQuotesEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<JavaScriptQuotesEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out JavaScriptQuotesEntity? result)
        {
            return JsonElementHelpers.TryParseValue<JavaScriptQuotesEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new JavaScriptQuotesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static JavaScriptQuotesEntity IJsonElement<JavaScriptQuotesEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JavaScriptQuotesEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="JavaScriptQuotesEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="JavaScriptQuotesEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public JavaScriptQuotesEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<JavaScriptQuotesEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="JavaScriptQuotesEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public JavaScriptQuotesEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<JavaScriptQuotesEntity>(_idx);
            }
        ...
        /// <param name="matchSingle">Match 2nd item.</param>
        /// <param name="matchDouble">Match 3rd item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchLeave,
            Func<TContext, TResult> matchSingle,
            Func<TContext, TResult> matchDouble,
...
#endif
        {
            ...
            {
                return matchSingle(context);
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchDouble(context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Func<TResult> matchSingle,
            Func<TResult> matchDouble,
