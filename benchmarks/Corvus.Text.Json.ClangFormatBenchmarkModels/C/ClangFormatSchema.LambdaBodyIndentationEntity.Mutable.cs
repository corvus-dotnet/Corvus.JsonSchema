...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct LambdaBodyIndentationEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(LambdaBodyIndentationEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="LambdaBodyIndentationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LambdaBodyIndentationEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LambdaBodyIndentationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly LambdaBodyIndentationEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly LambdaBodyIndentationEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<LambdaBodyIndentationEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(LambdaBodyIndentationEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (LambdaBodyIndentationEntity)value;
        ...
        {
            return workspace.CreateBuilder<LambdaBodyIndentationEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<LambdaBodyIndentationEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<LambdaBodyIndentationEntity>();
            }
            finally
            {
