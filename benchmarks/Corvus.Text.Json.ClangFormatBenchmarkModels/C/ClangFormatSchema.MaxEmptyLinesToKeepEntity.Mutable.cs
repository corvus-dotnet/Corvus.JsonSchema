...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct MaxEmptyLinesToKeepEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MaxEmptyLinesToKeepEntity, Mutable>(MaxEmptyLinesToKeepEntity.DefaultInstance);
        ...
        public static ParsedJsonDocument<MaxEmptyLinesToKeepEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MaxEmptyLinesToKeepEntity>();
            }
            finally
            {
