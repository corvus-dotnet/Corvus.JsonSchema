...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct ObjCBinPackProtocolListEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ObjCBinPackProtocolListEntity, Mutable>(ObjCBinPackProtocolListEntity.DefaultInstance);
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (ObjCBinPackProtocolListEntity)value;
        ...
        public static ParsedJsonDocument<ObjCBinPackProtocolListEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ObjCBinPackProtocolListEntity>();
            }
            finally
            {
