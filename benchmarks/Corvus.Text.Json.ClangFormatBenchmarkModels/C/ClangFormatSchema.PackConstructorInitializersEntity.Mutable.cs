...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct PackConstructorInitializersEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PackConstructorInitializersEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PackConstructorInitializersEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PackConstructorInitializersEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PackConstructorInitializersEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly PackConstructorInitializersEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly PackConstructorInitializersEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PackConstructorInitializersEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(PackConstructorInitializersEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (PackConstructorInitializersEntity)value;
        ...
        {
            return workspace.CreateBuilder<PackConstructorInitializersEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<PackConstructorInitializersEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<PackConstructorInitializersEntity>();
            }
            finally
            {
