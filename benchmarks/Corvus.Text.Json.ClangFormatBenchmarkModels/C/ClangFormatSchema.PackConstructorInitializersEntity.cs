...
public readonly partial struct ClangFormatSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PackConstructorInitializersEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal PackConstructorInitializersEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static PackConstructorInitializersEntity DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(PackConstructorInitializersEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in PackConstructorInitializersEntity left, in PackConstructorInitializersEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in PackConstructorInitializersEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(PackConstructorInitializersEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PackConstructorInitializersEntity(JsonElement instance)
        {
            return PackConstructorInitializersEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PackConstructorInitializersEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PackConstructorInitializersEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PackConstructorInitializersEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PackConstructorInitializersEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PackConstructorInitializersEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PackConstructorInitializersEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PackConstructorInitializersEntity>(json, options);
        }
        ...
        /// </exception>
        public static PackConstructorInitializersEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<PackConstructorInitializersEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out PackConstructorInitializersEntity? result)
        {
            return JsonElementHelpers.TryParseValue<PackConstructorInitializersEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PackConstructorInitializersEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static PackConstructorInitializersEntity IJsonElement<PackConstructorInitializersEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PackConstructorInitializersEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PackConstructorInitializersEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PackConstructorInitializersEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public PackConstructorInitializersEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PackConstructorInitializersEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PackConstructorInitializersEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public PackConstructorInitializersEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<PackConstructorInitializersEntity>(_idx);
            }
        ...
        /// <param name="matchBinPack">Match 2nd item.</param>
        /// <param name="matchCurrentLine">Match 3rd item.</param>
        /// <param name="matchNextLine">Match 4th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchNever,
            Func<TContext, TResult> matchBinPack,
            Func<TContext, TResult> matchCurrentLine,
            Func<TContext, TResult> matchNextLine,
...
#endif
        {
            ...
            {
                return matchBinPack(context);
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchCurrentLine(context);
            }

            if (this.ValueEquals(Constants.Enum4))
            {
                return matchNextLine(context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Func<TResult> matchBinPack,
            Func<TResult> matchCurrentLine,
            Func<TResult> matchNextLine,
            Func<TResult> defaultMatch)
        {
            ...
            if (this.ValueEquals(Constants.Enum3))
            {
                return matchCurrentLine();
            }

            if (this.ValueEquals(Constants.Enum4))
            {
                return matchNextLine();
            }
