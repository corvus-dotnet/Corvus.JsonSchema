...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct PenaltyBreakAssignmentEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PenaltyBreakAssignmentEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PenaltyBreakAssignmentEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PenaltyBreakAssignmentEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PenaltyBreakAssignmentEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PenaltyBreakAssignmentEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="PenaltyBreakAssignmentEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="PenaltyBreakAssignmentEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly PenaltyBreakAssignmentEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<PenaltyBreakAssignmentEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="PenaltyBreakAssignmentEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly PenaltyBreakAssignmentEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PenaltyBreakAssignmentEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(PenaltyBreakAssignmentEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<PenaltyBreakAssignmentEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<PenaltyBreakAssignmentEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<PenaltyBreakAssignmentEntity>();
            }
            finally
            {
