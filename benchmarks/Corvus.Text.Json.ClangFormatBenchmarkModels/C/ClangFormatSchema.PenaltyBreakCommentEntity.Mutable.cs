...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct PenaltyBreakCommentEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PenaltyBreakCommentEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PenaltyBreakCommentEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PenaltyBreakCommentEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PenaltyBreakCommentEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly PenaltyBreakCommentEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly PenaltyBreakCommentEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PenaltyBreakCommentEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(PenaltyBreakCommentEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<PenaltyBreakCommentEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<PenaltyBreakCommentEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<PenaltyBreakCommentEntity>();
            }
            finally
            {
