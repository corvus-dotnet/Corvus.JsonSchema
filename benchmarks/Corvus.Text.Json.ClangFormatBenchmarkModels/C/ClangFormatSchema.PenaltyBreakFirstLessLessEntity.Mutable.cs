...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct PenaltyBreakFirstLessLessEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PenaltyBreakFirstLessLessEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PenaltyBreakFirstLessLessEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PenaltyBreakFirstLessLessEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PenaltyBreakFirstLessLessEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly PenaltyBreakFirstLessLessEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly PenaltyBreakFirstLessLessEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PenaltyBreakFirstLessLessEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(PenaltyBreakFirstLessLessEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<PenaltyBreakFirstLessLessEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<PenaltyBreakFirstLessLessEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<PenaltyBreakFirstLessLessEntity>();
            }
            finally
            {
