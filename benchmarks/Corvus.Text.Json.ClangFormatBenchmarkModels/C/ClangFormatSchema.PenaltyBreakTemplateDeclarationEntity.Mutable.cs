...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct PenaltyBreakTemplateDeclarationEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PenaltyBreakTemplateDeclarationEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PenaltyBreakTemplateDeclarationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PenaltyBreakTemplateDeclarationEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PenaltyBreakTemplateDeclarationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly PenaltyBreakTemplateDeclarationEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly PenaltyBreakTemplateDeclarationEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PenaltyBreakTemplateDeclarationEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(PenaltyBreakTemplateDeclarationEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<PenaltyBreakTemplateDeclarationEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<PenaltyBreakTemplateDeclarationEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<PenaltyBreakTemplateDeclarationEntity>();
            }
            finally
            {
