...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct PenaltyReturnTypeOnItsOwnLineEntity
    {
        ...
        public static ParsedJsonDocument<PenaltyReturnTypeOnItsOwnLineEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<PenaltyReturnTypeOnItsOwnLineEntity>();
            }
            finally
            {
