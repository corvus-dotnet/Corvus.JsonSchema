...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct PpIndentWidthEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PpIndentWidthEntity, Mutable>(PpIndentWidthEntity.DefaultInstance);
            ...
            public static explicit operator Mutable(PpIndentWidthEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PpIndentWidthEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PpIndentWidthEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PpIndentWidthEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PpIndentWidthEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="PpIndentWidthEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="PpIndentWidthEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly PpIndentWidthEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<PpIndentWidthEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="PpIndentWidthEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly PpIndentWidthEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PpIndentWidthEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(PpIndentWidthEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<PpIndentWidthEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<PpIndentWidthEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<PpIndentWidthEntity>();
            }
            finally
            {
