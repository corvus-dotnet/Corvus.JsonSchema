...
public readonly partial struct ClangFormatSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QualifierAlignmentEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal QualifierAlignmentEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static QualifierAlignmentEntity DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(QualifierAlignmentEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in QualifierAlignmentEntity left, in QualifierAlignmentEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in QualifierAlignmentEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(QualifierAlignmentEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator QualifierAlignmentEntity(JsonElement instance)
        {
            return QualifierAlignmentEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static QualifierAlignmentEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static QualifierAlignmentEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<QualifierAlignmentEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static QualifierAlignmentEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<QualifierAlignmentEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static QualifierAlignmentEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<QualifierAlignmentEntity>(json, options);
        }
        ...
        /// </exception>
        public static QualifierAlignmentEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<QualifierAlignmentEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out QualifierAlignmentEntity? result)
        {
            return JsonElementHelpers.TryParseValue<QualifierAlignmentEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new QualifierAlignmentEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static QualifierAlignmentEntity IJsonElement<QualifierAlignmentEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"QualifierAlignmentEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="QualifierAlignmentEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="QualifierAlignmentEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public QualifierAlignmentEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<QualifierAlignmentEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="QualifierAlignmentEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public QualifierAlignmentEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<QualifierAlignmentEntity>(_idx);
            }
        ...
        /// <param name="matchLeft">Match 2nd item.</param>
        /// <param name="matchRight">Match 3rd item.</param>
        /// <param name="matchCustom">Match 4th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchLeave,
            Func<TContext, TResult> matchLeft,
            Func<TContext, TResult> matchRight,
            Func<TContext, TResult> matchCustom,
...
#endif
        {
            ...
            {
                return matchLeft(context);
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchRight(context);
            }

            if (this.ValueEquals(Constants.Enum4))
            {
                return matchCustom(context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Func<TResult> matchLeft,
            Func<TResult> matchRight,
            Func<TResult> matchCustom,
