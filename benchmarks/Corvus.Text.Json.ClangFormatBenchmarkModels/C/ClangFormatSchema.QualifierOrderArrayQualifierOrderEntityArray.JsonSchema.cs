...
public readonly partial struct ClangFormatSchema
{
        ...
        : IJsonElement<QualifierOrderArrayQualifierOrderEntityArray>
    {
        ...
        {
            private static readonly JsonSchemaPathProvider<int> ContainsSchemaEvaluationPath = static (_, buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/contains"u8, buffer, out written);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/clang-format.json#/properties/QualifierOrder"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://json.schemastore.org/clang-format.json#/properties/QualifierOrder";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/clang-format.json#/properties/QualifierOrder"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (!JsonSchemaEvaluation.MatchTypeArray(tokenType,"type"u8, ref context))
                {
                    ...
                    context.IgnoredKeyword(JsonSchemaEvaluation.IgnoredNotTypeArray, "contains"u8);
                }
                else
                {
                    int containsHandlerContainsCount = 0;
                    ...
                    while (arrayValidation_enumerator.MoveNext())
                    {
                        ...
                        JsonSchemaContext childContext = Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.QualifierOrderArrayQualifierOrderEntityArray.QualifierOrderEntity.JsonSchema.PushChildContext(
                            parentDocument,
                            arrayValidation_currentIndex,
                            ref context,
                            providerContext: arrayValidation_itemCount,
                            schemaEvaluationPath: ContainsSchemaEvaluationPath,
                            documentEvaluationPath: JsonSchemaEvaluation.ItemIndex);

                        Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.QualifierOrderArrayQualifierOrderEntityArray.QualifierOrderEntity.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
                        ...
                        {
                            containsHandlerContainsCount++;
                            context.CommitChildContext(true, ref childContext);
                            context.AddLocalEvaluatedItem(arrayValidation_itemCount);
                        }

                        JsonSchemaContext childContext1 = Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.QualifierOrderArrayQualifierOrderEntityArray.QualifierOrderArrayQualifierOrderEntity.JsonSchema.PushChildContext(
                            parentDocument,
                            arrayValidation_currentIndex,
                            ref context,
                        ...
                        Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.QualifierOrderArrayQualifierOrderEntityArray.QualifierOrderArrayQualifierOrderEntity.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext1);
                    ...
                    JsonSchemaEvaluation.MatchContainsCountGreaterThan(0, containsHandlerContainsCount, "contains"u8, ref context);
                }
            }
