    ...
    public readonly partial struct QualifierOrderArrayQualifierOrderEntityArray
    {
        ...
        public readonly partial struct QualifierOrderArrayQualifierOrderEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(QualifierOrderArrayQualifierOrderEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="QualifierOrderArrayQualifierOrderEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator QualifierOrderArrayQualifierOrderEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"QualifierOrderArrayQualifierOrderEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly QualifierOrderArrayQualifierOrderEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly QualifierOrderArrayQualifierOrderEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<QualifierOrderArrayQualifierOrderEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(QualifierOrderArrayQualifierOrderEntity instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (QualifierOrderArrayQualifierOrderEntity)value;
            ...
            {
                return workspace.CreateBuilder<QualifierOrderArrayQualifierOrderEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<QualifierOrderArrayQualifierOrderEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<QualifierOrderArrayQualifierOrderEntity>();
                }
                finally
                {
