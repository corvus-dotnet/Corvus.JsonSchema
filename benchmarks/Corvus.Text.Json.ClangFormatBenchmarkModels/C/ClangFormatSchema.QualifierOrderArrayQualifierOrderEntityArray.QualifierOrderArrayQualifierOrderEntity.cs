...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct QualifierOrderArrayQualifierOrderEntityArray
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="QualifierOrderArrayQualifierOrderEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal QualifierOrderArrayQualifierOrderEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static QualifierOrderArrayQualifierOrderEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(QualifierOrderArrayQualifierOrderEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in QualifierOrderArrayQualifierOrderEntity left, in QualifierOrderArrayQualifierOrderEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in QualifierOrderArrayQualifierOrderEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(QualifierOrderArrayQualifierOrderEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator QualifierOrderArrayQualifierOrderEntity(JsonElement instance)
            {
                return QualifierOrderArrayQualifierOrderEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static QualifierOrderArrayQualifierOrderEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static QualifierOrderArrayQualifierOrderEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<QualifierOrderArrayQualifierOrderEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static QualifierOrderArrayQualifierOrderEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<QualifierOrderArrayQualifierOrderEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static QualifierOrderArrayQualifierOrderEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<QualifierOrderArrayQualifierOrderEntity>(json, options);
            }
            ...
            /// </exception>
            public static QualifierOrderArrayQualifierOrderEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<QualifierOrderArrayQualifierOrderEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out QualifierOrderArrayQualifierOrderEntity? result)
            {
                return JsonElementHelpers.TryParseValue<QualifierOrderArrayQualifierOrderEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new QualifierOrderArrayQualifierOrderEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static QualifierOrderArrayQualifierOrderEntity IJsonElement<QualifierOrderArrayQualifierOrderEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"QualifierOrderArrayQualifierOrderEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="QualifierOrderArrayQualifierOrderEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="QualifierOrderArrayQualifierOrderEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public QualifierOrderArrayQualifierOrderEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<QualifierOrderArrayQualifierOrderEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="QualifierOrderArrayQualifierOrderEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public QualifierOrderArrayQualifierOrderEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<QualifierOrderArrayQualifierOrderEntity>(_idx);
                }
            ...
            /// <param name="matchConst">Match 1st item.</param>
            /// <param name="matchInline">Match 2nd item.</param>
            /// <param name="matchStatic">Match 3rd item.</param>
            /// <param name="matchConstexpr">Match 4th item.</param>
            /// <param name="matchVolatile">Match 5th item.</param>
            /// <param name="matchRestrict">Match 6th item.</param>
            /// <param name="matchType">Match 7th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchConst,
                Func<TContext, TResult> matchInline,
                Func<TContext, TResult> matchStatic,
                Func<TContext, TResult> matchConstexpr,
                Func<TContext, TResult> matchVolatile,
                Func<TContext, TResult> matchRestrict,
                Func<TContext, TResult> matchType,
            ...
            public TResult Match<TResult>(
                Func<TResult> matchConst,
                Func<TResult> matchInline,
                Func<TResult> matchStatic,
                Func<TResult> matchConstexpr,
                Func<TResult> matchVolatile,
                Func<TResult> matchRestrict,
                Func<TResult> matchType,
                Func<TResult> defaultMatch)
            {
                ...
                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchConstexpr();
                }

                if (this.ValueEquals(Constants.Enum5))
                {
                    return matchVolatile();
                }

                if (this.ValueEquals(Constants.Enum6))
                {
                    return matchRestrict();
                }
