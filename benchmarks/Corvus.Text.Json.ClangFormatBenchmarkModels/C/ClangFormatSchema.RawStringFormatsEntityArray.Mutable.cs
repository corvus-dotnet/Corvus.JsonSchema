...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct RawStringFormatsEntityArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RawStringFormatsEntityArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RawStringFormatsEntityArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RawStringFormatsEntityArray(Mutable instance)
            {
            ...
            public Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.Mutable>(_parent, _idx);
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RawStringFormatsEntityArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, scoped in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(scoped in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity oldItem, in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity current = enumerator.Current;
            ...
            /// </para>
            /// </remarks>
            public readonly RawStringFormatsEntityArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly RawStringFormatsEntityArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RawStringFormatsEntityArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(RawStringFormatsEntityArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            public void AddItem(in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.Source value)
            {
            ...
            /// Add an item to the array.
            /// </summary>
            public void AddItem<TContext>(in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        {
            return workspace.CreateBuilder<RawStringFormatsEntityArray, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<RawStringFormatsEntityArray> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<RawStringFormatsEntityArray>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<RawStringFormatsEntityArray> Create<TContext>(
