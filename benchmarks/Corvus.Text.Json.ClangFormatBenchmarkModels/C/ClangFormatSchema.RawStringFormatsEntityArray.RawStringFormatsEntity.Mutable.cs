        ...
        public readonly partial struct RawStringFormatsEntity
        {
...
#endif
            {
                ...
                public void SetCanonicalDelimiter(in Corvus.ClangFormatBenchmark.Current.JsonString.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsProperty(JsonPropertyNamesEscaped.CanonicalDelimiter, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                public void SetDelimiters(in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.JsonStringArray.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsProperty(JsonPropertyNamesEscaped.Delimiters, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                public void SetEnclosingFunctions(in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.EnclosingFArray.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsProperty(JsonPropertyNamesEscaped.EnclosingFunctions, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
            ...
            public ref struct Builder
            {
                    ...
                    in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.LanguageEntity.Source language = default)
                {
                    ...
                    canonicalDelimiter.AddAsProperty(JsonPropertyNamesEscaped.CanonicalDelimiter, ref builder, escapeName: false);
                    delimiters.AddAsProperty(JsonPropertyNamesEscaped.Delimiters, ref builder, escapeName: false);
                    enclosingFunctions.AddAsProperty(JsonPropertyNamesEscaped.EnclosingFunctions, ref builder, escapeName: false);
