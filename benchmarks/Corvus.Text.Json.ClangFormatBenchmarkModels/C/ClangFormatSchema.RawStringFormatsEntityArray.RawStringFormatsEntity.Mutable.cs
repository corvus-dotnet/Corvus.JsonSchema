    ...
    public readonly partial struct RawStringFormatsEntityArray
    {
        ...
        public readonly partial struct RawStringFormatsEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RawStringFormatsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RawStringFormatsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RawStringFormatsEntity(Mutable instance)
                {
                ...
                /// </summary>
                public Corvus.ClangFormatBenchmark.Current.JsonString.Mutable CanonicalDelimiter
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CanonicalDelimiterUtf8, out Corvus.ClangFormatBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                public Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.JsonStringArray.Mutable Delimiters
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DelimitersUtf8, out Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.JsonStringArray.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                public Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.EnclosingFArray.Mutable EnclosingFunctions
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnclosingFunctionsUtf8, out Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.EnclosingFArray.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetCanonicalDelimiter(scoped in Corvus.ClangFormatBenchmark.Current.JsonString.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CanonicalDelimiterUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CanonicalDelimiterUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.CanonicalDelimiter, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>CanonicalDelimiter</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveCanonicalDelimiter()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CanonicalDelimiterUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                public void SetDelimiters(scoped in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.JsonStringArray.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DelimitersUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DelimitersUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Delimiters, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetDelimiters<TContext>(in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.JsonStringArray.Source<TContext> value)
                ...
                /// <summary>
                /// Remove the <c>Delimiters</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveDelimiters()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DelimitersUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                public void SetEnclosingFunctions(scoped in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.EnclosingFArray.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.EnclosingFunctionsUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnclosingFunctionsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.EnclosingFunctions, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetEnclosingFunctions<TContext>(in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.EnclosingFArray.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
                ...
                /// <summary>
                /// Remove the <c>EnclosingFunctions</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveEnclosingFunctions()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.EnclosingFunctionsUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RawStringFormatsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RawStringFormatsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RawStringFormatsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RawStringFormatsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BasedOnStyleEntity.Source _createArg1;
                private readonly Corvus.ClangFormatBenchmark.Current.JsonString.Source _createArg2;
                private readonly Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.JsonStringArray.Source _createArg3;
                private readonly Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.EnclosingFArray.Source _createArg4;
                private readonly Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.ClangFormat35LanguageThisFormatStyleIsTargetedAt.Source _createArg5;
                ...
                public static implicit operator Source(RawStringFormatsEntity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                private readonly Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BasedOnStyleEntity.Source _createArg1;
                private readonly Corvus.ClangFormatBenchmark.Current.JsonString.Source _createArg2;
                private readonly Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.JsonStringArray.Source<TContext> _createArg3;
                private readonly Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.EnclosingFArray.Source<TContext> _createArg4;
                private readonly Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.ClangFormat35LanguageThisFormatStyleIsTargetedAt.Source _createArg5;
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="RawStringFormatsEntity"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BasedOnStyleEntity.Source basedOnStyle = default,
                    in Corvus.ClangFormatBenchmark.Current.JsonString.Source canonicalDelimiter = default,
                    in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.JsonStringArray.Source delimiters = default,
                    in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.EnclosingFArray.Source enclosingFunctions = default,
                    in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.ClangFormat35LanguageThisFormatStyleIsTargetedAt.Source language = default)
                {
                    ...
                    canonicalDelimiter.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.CanonicalDelimiter, ref builder);
                    delimiters.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Delimiters, ref builder);
                    enclosingFunctions.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.EnclosingFunctions, ref builder);
                ...
                public void Create(
                    ...
                    in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.ClangFormat35LanguageThisFormatStyleIsTargetedAt.Source language = default)
                {
                    Create(ref _builder, basedOnStyle, canonicalDelimiter, delimiters, enclosingFunctions, language);
                }
                ...
                internal static void Create<TContext>(
                    ...
                    in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BasedOnStyleEntity.Source basedOnStyle = default,
                    in Corvus.ClangFormatBenchmark.Current.JsonString.Source canonicalDelimiter = default,
                    in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.JsonStringArray.Source<TContext> delimiters = default,
                    in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.EnclosingFArray.Source<TContext> enclosingFunctions = default,
                    in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.ClangFormat35LanguageThisFormatStyleIsTargetedAt.Source language = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                ...
                #endif
                {
                    Create(context, ref _builder, basedOnStyle, canonicalDelimiter, delimiters, enclosingFunctions, language);
                }
            ...
            /// </summary>
            /// <param name="basedOnStyle">The value of the <c>"BasedOnStyle"</c> property.</param>
            /// <param name="canonicalDelimiter">The value of the <c>"CanonicalDelimiter"</c> property.</param>
            /// <param name="delimiters">The value of the <c>"Delimiters"</c> property.</param>
            ...
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BasedOnStyleEntity.Source basedOnStyle = default, scoped in Corvus.ClangFormatBenchmark.Current.JsonString.Source canonicalDelimiter = default, scoped in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.JsonStringArray.Source<TContext> delimiters = default, scoped in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.EnclosingFArray.Source<TContext> enclosingFunctions = default, scoped in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.ClangFormat35LanguageThisFormatStyleIsTargetedAt.Source language = default)
                ...
                #endif
            {
                return new Source<TContext>(context, basedOnStyle, canonicalDelimiter, delimiters, enclosingFunctions, language);
            }
            ...
            /// <param name="canonicalDelimiter">The value of the property.</param>
            /// <param name="delimiters">The value of the property.</param>
            /// <param name="enclosingFunctions">The value of the property.</param>
            /// <param name="language">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BasedOnStyleEntity.Source basedOnStyle = default, in Corvus.ClangFormatBenchmark.Current.JsonString.Source canonicalDelimiter = default, in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.JsonStringArray.Source delimiters = default, in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.EnclosingFArray.Source enclosingFunctions = default, in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.ClangFormat35LanguageThisFormatStyleIsTargetedAt.Source language = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(basedOnStyle, canonicalDelimiter, delimiters, enclosingFunctions, language);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
                ...
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, basedOnStyle, canonicalDelimiter, delimiters, enclosingFunctions, language);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<RawStringFormatsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RawStringFormatsEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RawStringFormatsEntity>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RawStringFormatsEntity> Create<TContext>(
            ...
            public static ParsedJsonDocument<RawStringFormatsEntity> Create(in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BasedOnStyleEntity.Source basedOnStyle = default, in Corvus.ClangFormatBenchmark.Current.JsonString.Source canonicalDelimiter = default, in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.JsonStringArray.Source delimiters = default, in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.EnclosingFArray.Source enclosingFunctions = default, in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.ClangFormat35LanguageThisFormatStyleIsTargetedAt.Source language = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RawStringFormatsEntity> Create<TContext>(in TContext context, in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.BasedOnStyleEntity.Source basedOnStyle = default, in Corvus.ClangFormatBenchmark.Current.JsonString.Source canonicalDelimiter = default, in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.JsonStringArray.Source<TContext> delimiters = default, in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.EnclosingFArray.Source<TContext> enclosingFunctions = default, in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.ClangFormat35LanguageThisFormatStyleIsTargetedAt.Source language = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
