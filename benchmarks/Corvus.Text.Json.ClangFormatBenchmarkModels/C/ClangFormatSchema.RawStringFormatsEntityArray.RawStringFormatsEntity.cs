...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct RawStringFormatsEntityArray
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.ClangFormatBenchmark.Current.JsonString CanonicalDelimiter
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CanonicalDelimiterUtf8, out Corvus.ClangFormatBenchmark.Current.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.JsonStringArray Delimiters
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DelimitersUtf8, out Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.JsonStringArray value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.EnclosingFArray EnclosingFunctions
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnclosingFunctionsUtf8, out Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RawStringFormatsEntityArray.RawStringFormatsEntity.EnclosingFArray value))
                    {
                        return value;
                    }
