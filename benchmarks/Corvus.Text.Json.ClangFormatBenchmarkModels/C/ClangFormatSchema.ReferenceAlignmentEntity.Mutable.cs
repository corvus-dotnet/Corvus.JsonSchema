...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct ReferenceAlignmentEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ReferenceAlignmentEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ReferenceAlignmentEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ReferenceAlignmentEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ReferenceAlignmentEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ReferenceAlignmentEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ReferenceAlignmentEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ReferenceAlignmentEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ReferenceAlignmentEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (ReferenceAlignmentEntity)value;
        ...
        {
            return workspace.CreateBuilder<ReferenceAlignmentEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ReferenceAlignmentEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ReferenceAlignmentEntity>();
            }
            finally
            {
