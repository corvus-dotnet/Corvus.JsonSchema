...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct RequiredPriorityAndRegexArray
    {
...
#endif
        {
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.Source value)
            {
                CheckValidInstance();
