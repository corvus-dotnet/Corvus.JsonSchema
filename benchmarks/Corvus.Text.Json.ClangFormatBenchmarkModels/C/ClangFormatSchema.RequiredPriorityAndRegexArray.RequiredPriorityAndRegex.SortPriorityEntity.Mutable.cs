        ...
        public readonly partial struct RequiredPriorityAndRegex
        {
            ...
            public readonly partial struct SortPriorityEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(SortPriorityEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="SortPriorityEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator SortPriorityEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new SortPriorityEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"SortPriorityEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="SortPriorityEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="SortPriorityEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SortPriorityEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<SortPriorityEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="SortPriorityEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SortPriorityEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<SortPriorityEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(SortPriorityEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<SortPriorityEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<SortPriorityEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<SortPriorityEntity>();
                    }
                    finally
                    {
