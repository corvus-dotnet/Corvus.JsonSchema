...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct RequiredPriorityAndRegexArray
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.ClangFormatBenchmark.Current.JsonBoolean CaseSensitive
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CaseSensitiveUtf8, out Corvus.ClangFormatBenchmark.Current.JsonBoolean value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.PriorityEntity Priority
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PriorityUtf8, out Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.PriorityEntity value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.ClangFormatBenchmark.Current.JsonString Regex
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RegexUtf8, out Corvus.ClangFormatBenchmark.Current.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.SortPriorityEntity SortPriority
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SortPriorityUtf8, out Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.RequiredPriorityAndRegexArray.RequiredPriorityAndRegex.SortPriorityEntity value))
                    {
                        return value;
                    }
