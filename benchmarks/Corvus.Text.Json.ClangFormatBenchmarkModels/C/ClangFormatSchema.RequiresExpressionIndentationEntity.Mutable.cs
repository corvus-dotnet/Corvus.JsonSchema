...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct RequiresExpressionIndentationEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RequiresExpressionIndentationEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RequiresExpressionIndentationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiresExpressionIndentationEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RequiresExpressionIndentationEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiresExpressionIndentationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RequiresExpressionIndentationEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RequiresExpressionIndentationEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly RequiresExpressionIndentationEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RequiresExpressionIndentationEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RequiresExpressionIndentationEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly RequiresExpressionIndentationEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RequiresExpressionIndentationEntity>(_idx);
            }
            ...
            /// <param name="matchOuterScope">Match 1st item.</param>
            /// <param name="matchKeyword">Match 2nd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchOuterScope,
                Func<TContext, TResult> matchKeyword,
...
#endif
            {
                ...
                {
                    return matchOuterScope(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchKeyword(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchOuterScope,
                Func<TResult> matchKeyword,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchOuterScope();
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(RequiresExpressionIndentationEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (RequiresExpressionIndentationEntity)value;
        ...
        {
            return workspace.CreateBuilder<RequiresExpressionIndentationEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<RequiresExpressionIndentationEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<RequiresExpressionIndentationEntity>();
            }
            finally
            {
