...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct SeparateDefinitionBlocksEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(SeparateDefinitionBlocksEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SeparateDefinitionBlocksEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SeparateDefinitionBlocksEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SeparateDefinitionBlocksEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly SeparateDefinitionBlocksEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly SeparateDefinitionBlocksEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SeparateDefinitionBlocksEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(SeparateDefinitionBlocksEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (SeparateDefinitionBlocksEntity)value;
        ...
        {
            return workspace.CreateBuilder<SeparateDefinitionBlocksEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<SeparateDefinitionBlocksEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SeparateDefinitionBlocksEntity>();
            }
            finally
            {
