...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct ShortNamespaceLinesEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ShortNamespaceLinesEntity, Mutable>(ShortNamespaceLinesEntity.DefaultInstance);
            ...
            public static explicit operator Mutable(ShortNamespaceLinesEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ShortNamespaceLinesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ShortNamespaceLinesEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ShortNamespaceLinesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ShortNamespaceLinesEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ShortNamespaceLinesEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ShortNamespaceLinesEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ShortNamespaceLinesEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ShortNamespaceLinesEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ShortNamespaceLinesEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ShortNamespaceLinesEntity>();
            }
            finally
            {
