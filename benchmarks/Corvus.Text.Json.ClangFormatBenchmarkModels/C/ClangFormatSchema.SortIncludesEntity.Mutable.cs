...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct SortIncludesEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(SortIncludesEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SortIncludesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SortIncludesEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SortIncludesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly SortIncludesEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly SortIncludesEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SortIncludesEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(SortIncludesEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (SortIncludesEntity)value;
        ...
        {
            return workspace.CreateBuilder<SortIncludesEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<SortIncludesEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SortIncludesEntity>();
            }
            finally
            {
