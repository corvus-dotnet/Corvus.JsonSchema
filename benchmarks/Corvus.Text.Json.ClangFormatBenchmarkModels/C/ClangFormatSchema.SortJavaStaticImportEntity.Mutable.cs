...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct SortJavaStaticImportEntity
    {
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (SortJavaStaticImportEntity)value;
        ...
        public static ParsedJsonDocument<SortJavaStaticImportEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SortJavaStaticImportEntity>();
            }
            finally
            {
