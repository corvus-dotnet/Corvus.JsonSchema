...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct SortUsingDeclarationsEntity
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SortUsingDeclarationsEntity.OneOf1Entity.Mutable(Mutable value)
            {
                return Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SortUsingDeclarationsEntity.OneOf1Entity.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SortUsingDeclarationsEntity.OneOf1Entity.Mutable value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SortUsingDeclarationsEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchJsonBoolean(Corvus.ClangFormatBenchmark.Current.JsonBoolean.Mutable.From(this), context);
                }
                ...
                {
                    return matchOneOf1Entity(Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SortUsingDeclarationsEntity.OneOf1Entity.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SortUsingDeclarationsEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.ClangFormatBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonBoolean(Corvus.ClangFormatBenchmark.Current.JsonBoolean.Mutable.From(this));
                }

                if (Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SortUsingDeclarationsEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SortUsingDeclarationsEntity.OneOf1Entity.Mutable.From(this));
                }
            ...
            public bool TryGetAsJsonBoolean(out Corvus.ClangFormatBenchmark.Current.JsonBoolean.Mutable result)
            {
                if (Corvus.ClangFormatBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.ClangFormatBenchmark.Current.JsonBoolean.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsOneOf1Entity(out Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SortUsingDeclarationsEntity.OneOf1Entity.Mutable result)
            {
                if (Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SortUsingDeclarationsEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SortUsingDeclarationsEntity.OneOf1Entity.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SortUsingDeclarationsEntity.OneOf1Entity instance) => new(JsonElement.From(instance));
        ...
        public static ParsedJsonDocument<SortUsingDeclarationsEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SortUsingDeclarationsEntity>();
            }
            finally
            {
