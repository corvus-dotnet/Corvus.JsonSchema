    ...
    public readonly partial struct SortUsingDeclarationsEntity
    {
        ...
        public readonly partial struct OneOf1Entity
        {
...
#endif
            {
                ...
                /// <param name="matchLexicographic">Match 2nd item.</param>
                /// <param name="matchLexicographicNumeric">Match 3rd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchNever,
                    Func<TContext, TResult> matchLexicographic,
                    Func<TContext, TResult> matchLexicographicNumeric,
...
#endif
                {
                    ...
                    {
                        return matchLexicographic(context);
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchLexicographicNumeric(context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Func<TResult> matchLexicographic,
                    Func<TResult> matchLexicographicNumeric,
                    Func<TResult> defaultMatch)
                {
                    ...
                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchLexicographic();
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchLexicographicNumeric();
                    }
            ...
            public ref struct Source
            {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (OneOf1Entity)value;
