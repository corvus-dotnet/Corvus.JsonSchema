...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct SpaceAroundPointerQualifiersEntity
    {
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (SpaceAroundPointerQualifiersEntity)value;
        ...
        public static ParsedJsonDocument<SpaceAroundPointerQualifiersEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SpaceAroundPointerQualifiersEntity>();
            }
            finally
            {
