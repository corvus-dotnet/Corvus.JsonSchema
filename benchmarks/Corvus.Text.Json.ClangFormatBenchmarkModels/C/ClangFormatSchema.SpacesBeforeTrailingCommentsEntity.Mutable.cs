...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct SpacesBeforeTrailingCommentsEntity
    {
        ...
        public static ParsedJsonDocument<SpacesBeforeTrailingCommentsEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SpacesBeforeTrailingCommentsEntity>();
            }
            finally
            {
