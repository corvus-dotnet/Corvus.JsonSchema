...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct SpacesInAnglesEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(SpacesInAnglesEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SpacesInAnglesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SpacesInAnglesEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SpacesInAnglesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly SpacesInAnglesEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly SpacesInAnglesEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SpacesInAnglesEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(SpacesInAnglesEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (SpacesInAnglesEntity)value;
        ...
        {
            return workspace.CreateBuilder<SpacesInAnglesEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<SpacesInAnglesEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SpacesInAnglesEntity>();
            }
            finally
            {
