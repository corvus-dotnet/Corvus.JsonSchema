    ...
    public readonly partial struct SpacesInLineCommentPrefixEntity
    {
        ...
        public readonly partial struct MaximumEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MaximumEntity, Mutable>(MaximumEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<MaximumEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MaximumEntity>();
                }
                finally
                {
