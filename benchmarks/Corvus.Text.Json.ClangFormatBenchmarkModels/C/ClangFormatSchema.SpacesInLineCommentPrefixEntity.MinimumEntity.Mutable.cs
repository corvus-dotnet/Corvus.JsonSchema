...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct SpacesInLineCommentPrefixEntity
    {
        ...
        public readonly partial struct MinimumEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MinimumEntity, Mutable>(MinimumEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(MinimumEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MinimumEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MinimumEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new MinimumEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MinimumEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="MinimumEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="MinimumEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly MinimumEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<MinimumEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="MinimumEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly MinimumEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MinimumEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MinimumEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MinimumEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MinimumEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MinimumEntity>();
                }
                finally
                {
