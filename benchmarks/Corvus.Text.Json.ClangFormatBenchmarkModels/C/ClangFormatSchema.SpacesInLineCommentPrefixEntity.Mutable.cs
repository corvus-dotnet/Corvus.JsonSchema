...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct SpacesInLineCommentPrefixEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(SpacesInLineCommentPrefixEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SpacesInLineCommentPrefixEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SpacesInLineCommentPrefixEntity(Mutable instance)
            {
            ...
            /// </summary>
            public Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SpacesInLineCommentPrefixEntity.MaximumEntity.Mutable Maximum
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaximumUtf8, out Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SpacesInLineCommentPrefixEntity.MaximumEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SpacesInLineCommentPrefixEntity.MinimumEntity.Mutable Minimum
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinimumUtf8, out Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SpacesInLineCommentPrefixEntity.MinimumEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SpacesInLineCommentPrefixEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SpacesInLineCommentPrefixEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SpacesInLineCommentPrefixEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SpacesInLineCommentPrefixEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly SpacesInLineCommentPrefixEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SpacesInLineCommentPrefixEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SpacesInLineCommentPrefixEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly SpacesInLineCommentPrefixEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SpacesInLineCommentPrefixEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SpacesInLineCommentPrefixEntity.MaximumEntity.Source _createArg1;
            private readonly Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SpacesInLineCommentPrefixEntity.MinimumEntity.Source _createArg2;
            ...
            public static implicit operator Source(SpacesInLineCommentPrefixEntity instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SpacesInLineCommentPrefixEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="SpacesInLineCommentPrefixEntity"/>.
            /// </summary>
            ...
            /// Creates an instance of a <see cref="SpacesInLineCommentPrefixEntity"/>.
            /// </summary>
            public void Create(in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SpacesInLineCommentPrefixEntity.MaximumEntity.Source maximum = default, in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SpacesInLineCommentPrefixEntity.MinimumEntity.Source minimum = default)
            {
                Create(ref _builder, maximum, minimum);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SpacesInLineCommentPrefixEntity.MaximumEntity.Source maximum = default, in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SpacesInLineCommentPrefixEntity.MinimumEntity.Source minimum = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(maximum, minimum);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<SpacesInLineCommentPrefixEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<SpacesInLineCommentPrefixEntity> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SpacesInLineCommentPrefixEntity>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<SpacesInLineCommentPrefixEntity> Create<TContext>(
        ...
        public static ParsedJsonDocument<SpacesInLineCommentPrefixEntity> Create(in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SpacesInLineCommentPrefixEntity.MaximumEntity.Source maximum = default, in Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SpacesInLineCommentPrefixEntity.MinimumEntity.Source minimum = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
