...
public readonly partial struct ClangFormatSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SpacesInLineCommentPrefixEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal SpacesInLineCommentPrefixEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static SpacesInLineCommentPrefixEntity DefaultInstance { get; }
        ...
        /// </summary>
        public Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SpacesInLineCommentPrefixEntity.MaximumEntity Maximum
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaximumUtf8, out Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SpacesInLineCommentPrefixEntity.MaximumEntity value))
                {
                    return value;
                }

                return Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SpacesInLineCommentPrefixEntity.MaximumEntity.DefaultInstance;
            }
        }
        ...
        /// </summary>
        public Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SpacesInLineCommentPrefixEntity.MinimumEntity Minimum
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinimumUtf8, out Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SpacesInLineCommentPrefixEntity.MinimumEntity value))
                {
                    return value;
                }

                return Corvus.ClangFormatBenchmark.Current.ClangFormatSchema.SpacesInLineCommentPrefixEntity.MinimumEntity.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in SpacesInLineCommentPrefixEntity left, in SpacesInLineCommentPrefixEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SpacesInLineCommentPrefixEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(SpacesInLineCommentPrefixEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SpacesInLineCommentPrefixEntity(JsonElement instance)
        {
            return SpacesInLineCommentPrefixEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SpacesInLineCommentPrefixEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SpacesInLineCommentPrefixEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SpacesInLineCommentPrefixEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SpacesInLineCommentPrefixEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SpacesInLineCommentPrefixEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SpacesInLineCommentPrefixEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SpacesInLineCommentPrefixEntity>(json, options);
        }
        ...
        /// </exception>
        public static SpacesInLineCommentPrefixEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<SpacesInLineCommentPrefixEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SpacesInLineCommentPrefixEntity? result)
        {
            return JsonElementHelpers.TryParseValue<SpacesInLineCommentPrefixEntity>(ref reader, out result);
        }
...
#if NET
        static SpacesInLineCommentPrefixEntity IJsonElement<SpacesInLineCommentPrefixEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SpacesInLineCommentPrefixEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public SpacesInLineCommentPrefixEntity Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public SpacesInLineCommentPrefixEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<SpacesInLineCommentPrefixEntity>(_idx);
            }
        ...
        private static class JsonPropertyNamesPrebaked
        {
            ...
            /// </summary>
            public static ReadOnlySpan<byte> Maximum => [0x95, 0x00, 0x00, 0x00, 0x22, 0x4D, 0x61, 0x78, 0x69, 0x6D, 0x75, 0x6D, 0x22];

            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Minimum"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Minimum => [0x95, 0x00, 0x00, 0x00, 0x22, 0x4D, 0x69, 0x6E, 0x69, 0x6D, 0x75, 0x6D, 0x22];
        }
    }
}
