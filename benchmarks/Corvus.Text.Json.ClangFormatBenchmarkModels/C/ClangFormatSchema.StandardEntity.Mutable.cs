...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct StandardEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(StandardEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="StandardEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator StandardEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"StandardEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly StandardEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly StandardEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<StandardEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(StandardEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<StandardEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<StandardEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<StandardEntity>();
            }
            finally
            {
