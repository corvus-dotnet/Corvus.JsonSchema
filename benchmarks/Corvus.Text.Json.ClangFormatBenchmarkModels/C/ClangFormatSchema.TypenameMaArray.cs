...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct TypenameMaArray
#if NET8_0_OR_GREATER
        : IJsonElement<TypenameMaArray>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TypenameMaArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TypenameMaArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TypenameMaArray DefaultInstance { get; }
        ...
        public Corvus.ClangFormatBenchmark.Current.JsonString this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.ClangFormatBenchmark.Current.JsonString>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.ClangFormatBenchmark.Current.JsonString> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.ClangFormatBenchmark.Current.JsonString>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in TypenameMaArray left, in TypenameMaArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TypenameMaArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(TypenameMaArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TypenameMaArray(JsonElement instance)
        {
            return TypenameMaArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TypenameMaArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TypenameMaArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TypenameMaArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TypenameMaArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TypenameMaArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TypenameMaArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TypenameMaArray>(json, options);
        }
        ...
        /// </exception>
        public static TypenameMaArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<TypenameMaArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TypenameMaArray? result)
        {
            return JsonElementHelpers.TryParseValue<TypenameMaArray>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TypenameMaArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static TypenameMaArray IJsonElement<TypenameMaArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TypenameMaArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TypenameMaArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TypenameMaArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public TypenameMaArray Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TypenameMaArray>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TypenameMaArray"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public TypenameMaArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TypenameMaArray>(_idx);
            }
