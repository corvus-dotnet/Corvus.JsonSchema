...
public readonly partial struct ClangFormatSchema
{
    ...
    public readonly partial struct UseTabEntity
    {
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (UseTabEntity)value;
        ...
        public static ParsedJsonDocument<UseTabEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<UseTabEntity>();
            }
            finally
            {
