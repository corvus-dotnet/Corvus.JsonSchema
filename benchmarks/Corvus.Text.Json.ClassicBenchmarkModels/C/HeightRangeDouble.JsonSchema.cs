    ...
    : IJsonElement<HeightRangeDouble>
{
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/HeightRangeDouble"u8, buffer, out written);
