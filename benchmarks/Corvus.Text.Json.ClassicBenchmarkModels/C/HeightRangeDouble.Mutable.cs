...
public readonly partial struct HeightRangeDouble
{
...
#endif
    {
        ...
        public static explicit operator Mutable(HeightRangeDouble instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="HeightRangeDouble"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator HeightRangeDouble(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new HeightRangeDouble(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"HeightRangeDouble.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="HeightRangeDouble"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="HeightRangeDouble"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly HeightRangeDouble Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<HeightRangeDouble>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="HeightRangeDouble"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly HeightRangeDouble Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<HeightRangeDouble>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(HeightRangeDouble instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<HeightRangeDouble, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<HeightRangeDouble> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<HeightRangeDouble>();
        }
        finally
        {
