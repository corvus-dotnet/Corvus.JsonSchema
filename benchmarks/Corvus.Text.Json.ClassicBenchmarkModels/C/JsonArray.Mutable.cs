...
public readonly partial struct JsonArray
{
...
#endif
    {
        ...
        public static implicit operator Corvus.ClassicBenchmark.Current.PersonArray.Mutable(Mutable value)
        {
            return Corvus.ClassicBenchmark.Current.PersonArray.Mutable.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Mutable(Corvus.ClassicBenchmark.Current.PersonArray.Mutable value)
        {
            return From(value);
        }
        ...
        public bool TryGetAsPersonArray(out Corvus.ClassicBenchmark.Current.PersonArray.Mutable result)
        {
            ...
            {
                result = Corvus.ClassicBenchmark.Current.PersonArray.Mutable.From(this);
                return true;
            }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.ClassicBenchmark.Current.JsonArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.ClassicBenchmark.Current.JsonArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<JsonArray> Create<TContext>(
