...
public readonly partial struct JsonDecimal
{
...
#endif
    {
        ...
        public static implicit operator decimal(Mutable value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
        ...
        public static explicit operator Mutable(JsonDecimal instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="JsonDecimal"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonDecimal(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new JsonDecimal(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonDecimal.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="JsonDecimal"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="JsonDecimal"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly JsonDecimal Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<JsonDecimal>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="JsonDecimal"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly JsonDecimal Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonDecimal>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(JsonDecimal instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<JsonDecimal, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<JsonDecimal> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<JsonDecimal>();
        }
        finally
        {
