...
#endif
{
    ...
    /// <summary>
    /// Conversion to <see cref="Corvus.ClassicBenchmark.Current.PersonNameElement"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator Corvus.ClassicBenchmark.Current.PersonNameElement(OtherNames value)
    {
        return Corvus.ClassicBenchmark.Current.PersonNameElement.From(value);
    }

    /// <summary>
    /// Conversion from <see cref="Corvus.ClassicBenchmark.Current.PersonNameElement"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator OtherNames(Corvus.ClassicBenchmark.Current.PersonNameElement value)
    {
        return From(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator Corvus.ClassicBenchmark.Current.PersonNameElementArray(OtherNames value)
    {
        return Corvus.ClassicBenchmark.Current.PersonNameElementArray.From(value);
    }

    /// <summary>
    /// Conversion from <see cref="Corvus.ClassicBenchmark.Current.PersonNameElementArray"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    ...
    public bool TryGetAsPersonNameElement(out Corvus.ClassicBenchmark.Current.PersonNameElement result)
    {
        ...
        {
            result = Corvus.ClassicBenchmark.Current.PersonNameElement.From(this);
            return true;
        }
    ...
    public bool TryGetAsPersonNameElementArray(out Corvus.ClassicBenchmark.Current.PersonNameElementArray result)
    {
        ...
        {
            result = Corvus.ClassicBenchmark.Current.PersonNameElementArray.From(this);
            return true;
        }
    ...
    /// <param name="matchPersonNameElement">Match a <see cref="Corvus.ClassicBenchmark.Current.PersonNameElement"/>.</param>
    /// <param name="matchPersonNameElementArray">Match a <see cref="Corvus.ClassicBenchmark.Current.PersonNameElementArray"/>.</param>
    /// <param name="defaultMatch">Match any other value.</param>
    /// <returns>An instance of the value returned by the match function.</returns>
    public TResult Match<TContext, TResult>(
        in TContext context,
        Matcher<Corvus.ClassicBenchmark.Current.PersonNameElement, TContext, TResult> matchPersonNameElement,
        Matcher<Corvus.ClassicBenchmark.Current.PersonNameElementArray, TContext, TResult> matchPersonNameElementArray,
        Matcher<Corvus.ClassicBenchmark.Current.OtherNames, TContext, TResult> defaultMatch)
...
#endif
    {
        if (Corvus.ClassicBenchmark.Current.PersonNameElement.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchPersonNameElement(Corvus.ClassicBenchmark.Current.PersonNameElement.From(this), context);
        }

        if (Corvus.ClassicBenchmark.Current.PersonNameElementArray.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchPersonNameElementArray(Corvus.ClassicBenchmark.Current.PersonNameElementArray.From(this), context);
        }
    ...
    public TResult Match<TResult>(
        Matcher<Corvus.ClassicBenchmark.Current.PersonNameElement, TResult> matchPersonNameElement,
        Matcher<Corvus.ClassicBenchmark.Current.PersonNameElementArray, TResult> matchPersonNameElementArray,
        Matcher<Corvus.ClassicBenchmark.Current.OtherNames, TResult> defaultMatch)
    {
        if (Corvus.ClassicBenchmark.Current.PersonNameElement.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchPersonNameElement(Corvus.ClassicBenchmark.Current.PersonNameElement.From(this));
        }

        if (Corvus.ClassicBenchmark.Current.PersonNameElementArray.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchPersonNameElementArray(Corvus.ClassicBenchmark.Current.PersonNameElementArray.From(this));
        }
