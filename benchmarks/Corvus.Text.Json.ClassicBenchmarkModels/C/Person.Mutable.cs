...
public readonly partial struct Person
{
...
#endif
    {
        ...
        /// <returns>An immutable instance of a <see cref="Person"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// </summary>
        public Corvus.ClassicBenchmark.Current.JsonDate.Mutable DateOfBirth
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DateOfBirthUtf8, out Corvus.ClassicBenchmark.Current.JsonDate.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.ClassicBenchmark.Current.JsonEmail.Mutable Email
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EmailUtf8, out Corvus.ClassicBenchmark.Current.JsonEmail.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.ClassicBenchmark.Current.HeightRangeDouble.Mutable Height
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HeightUtf8, out Corvus.ClassicBenchmark.Current.HeightRangeDouble.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.ClassicBenchmark.Current.PersonName.Mutable Name
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.ClassicBenchmark.Current.PersonName.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.ClassicBenchmark.Current.JsonDecimal.Mutable NetWorth
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NetWorthUtf8, out Corvus.ClassicBenchmark.Current.JsonDecimal.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetName<TContext>(in Corvus.ClassicBenchmark.Current.PersonName.Source<TContext> value)
        ...
        public void SetNetWorth(scoped in Corvus.ClassicBenchmark.Current.JsonDecimal.Source value)
        {
            ...
            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.NetWorthUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NetWorthUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.NetWorth, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// <summary>
        /// Remove the <c>netWorth</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveNetWorth()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.NetWorthUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.ClassicBenchmark.Current.PersonName.Source name,
            in Corvus.ClassicBenchmark.Current.JsonDate.Source dateOfBirth = default,
            in Corvus.ClassicBenchmark.Current.JsonEmail.Source email = default,
            in Corvus.ClassicBenchmark.Current.HeightRangeDouble.Source height = default,
            in Corvus.ClassicBenchmark.Current.JsonDecimal.Source netWorth = default)
        {
            ...
            netWorth.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.NetWorth, ref builder);
        }
        ...
        public void Create(
            ...
            in Corvus.ClassicBenchmark.Current.JsonDecimal.Source netWorth = default)
        {
            Create(ref _builder, name, dateOfBirth, email, height, netWorth);
        }
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in Corvus.ClassicBenchmark.Current.PersonName.Source<TContext> name,
            in Corvus.ClassicBenchmark.Current.JsonDate.Source dateOfBirth = default,
            in Corvus.ClassicBenchmark.Current.JsonEmail.Source email = default,
            in Corvus.ClassicBenchmark.Current.HeightRangeDouble.Source height = default,
            in Corvus.ClassicBenchmark.Current.JsonDecimal.Source netWorth = default)
        ...
        #endif
        {
            Create(context, ref _builder, name, dateOfBirth, email, height, netWorth);
        }
        ...
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, name, dateOfBirth, email, height, netWorth);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<Person, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<Person> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<Person>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<Person> Create<TContext>(
    ...
    public static ParsedJsonDocument<Person> Create(in Corvus.ClassicBenchmark.Current.PersonName.Source name, in Corvus.ClassicBenchmark.Current.JsonDate.Source dateOfBirth = default, in Corvus.ClassicBenchmark.Current.JsonEmail.Source email = default, in Corvus.ClassicBenchmark.Current.HeightRangeDouble.Source height = default, in Corvus.ClassicBenchmark.Current.JsonDecimal.Source netWorth = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<Person> Create<TContext>(in TContext context, in Corvus.ClassicBenchmark.Current.PersonName.Source<TContext> name, in Corvus.ClassicBenchmark.Current.JsonDate.Source dateOfBirth = default, in Corvus.ClassicBenchmark.Current.JsonEmail.Source email = default, in Corvus.ClassicBenchmark.Current.HeightRangeDouble.Source height = default, in Corvus.ClassicBenchmark.Current.JsonDecimal.Source netWorth = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
