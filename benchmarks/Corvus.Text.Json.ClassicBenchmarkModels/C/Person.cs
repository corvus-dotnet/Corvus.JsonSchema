...
#endif
{
    ...
    /// </summary>
    public Corvus.ClassicBenchmark.Current.HeightRangeDouble Height
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HeightUtf8, out Corvus.ClassicBenchmark.Current.HeightRangeDouble value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.ClassicBenchmark.Current.PersonName Name
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.ClassicBenchmark.Current.PersonName value))
            {
                return value;
            }
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="NetWorth"/>.
        /// </summary>
        public static ReadOnlySpan<byte> NetWorth => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x6E, 0x65, 0x74, 0x57, 0x6F, 0x72, 0x74, 0x68, 0x22];
    }
}
