    ...
    : IJsonElement<PersonArray>
{
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/PersonArray"u8, buffer, out written);
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (arrayValidation_enumerator.MoveNext())
                {
                    ...
                    JsonSchemaContext childContext = Corvus.ClassicBenchmark.Current.Person.JsonSchema.PushChildContext(
                        parentDocument,
                    ...
                    Corvus.ClassicBenchmark.Current.Person.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
