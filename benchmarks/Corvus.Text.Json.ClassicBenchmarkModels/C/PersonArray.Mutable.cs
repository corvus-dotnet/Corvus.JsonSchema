...
public readonly partial struct PersonArray
{
...
#endif
    {
        ...
        public Corvus.ClassicBenchmark.Current.Person.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.ClassicBenchmark.Current.Person.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.ClassicBenchmark.Current.Person.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.ClassicBenchmark.Current.Person.Mutable>(_parent, _idx);
        }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in Corvus.ClassicBenchmark.Current.Person.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, scoped in Corvus.ClassicBenchmark.Current.Person.Source value)
        {
            CheckValidInstance();
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void AddItem(scoped in Corvus.ClassicBenchmark.Current.Person.Source value)
        {
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Remove(in Corvus.ClassicBenchmark.Current.Person item)
        {
            CheckValidInstance();
            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.ClassicBenchmark.Current.Person>(this, in item))
            {
                return false;
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<Corvus.ClassicBenchmark.Current.Person> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.ClassicBenchmark.Current.Person>(this, predicate);
            _documentVersion = _parent.Version;
        }
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Replace(in Corvus.ClassicBenchmark.Current.Person oldItem, in Corvus.ClassicBenchmark.Current.Person.Source newItem)
        {
            CheckValidInstance();
            ...
            var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.ClassicBenchmark.Current.Person>(_parent, _idx);

            while (enumerator.MoveNext())
            {
                Corvus.ClassicBenchmark.Current.Person current = enumerator.Current;
        ...
        /// </para>
        /// </remarks>
        public readonly PersonArray Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly PersonArray Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PersonArray>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.ClassicBenchmark.Current.PersonArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.ClassicBenchmark.Current.PersonArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        public void AddItem(in Corvus.ClassicBenchmark.Current.Person.Source value)
        {
    ...
    public static ParsedJsonDocument<PersonArray> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<PersonArray>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<PersonArray> Create<TContext>(
