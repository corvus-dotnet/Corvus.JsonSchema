...
#endif
{
    ...
    /// </summary>
    public static PersonArray DefaultInstance { get; }
    ...
    public Corvus.ClassicBenchmark.Current.Person this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Corvus.ClassicBenchmark.Current.Person>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Corvus.ClassicBenchmark.Current.Person> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Corvus.ClassicBenchmark.Current.Person>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in PersonArray left, in PersonArray right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PersonArray left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PersonArray instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PersonArray(JsonElement instance)
    {
        return PersonArray.From(instance);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PersonArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PersonArray>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PersonArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PersonArray>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PersonArray ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PersonArray>(json, options);
    }
    ...
    /// </exception>
    public static PersonArray ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<PersonArray>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PersonArray? result)
    {
        return JsonElementHelpers.TryParseValue<PersonArray>(ref reader, out result);
    }
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PersonArray: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="PersonArray"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="PersonArray"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public PersonArray Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<PersonArray>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="PersonArray"/> that lives for the lifetime of its
