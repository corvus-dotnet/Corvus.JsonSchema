...
public readonly partial struct PersonName
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PersonName instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.ClassicBenchmark.Current.PersonNameElement.Mutable FamilyName
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FamilyNameUtf8, out Corvus.ClassicBenchmark.Current.PersonNameElement.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.ClassicBenchmark.Current.PersonNameElement.Mutable GivenName
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GivenNameUtf8, out Corvus.ClassicBenchmark.Current.PersonNameElement.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.ClassicBenchmark.Current.OtherNames.Mutable OtherNames
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OtherNamesUtf8, out Corvus.ClassicBenchmark.Current.OtherNames.Mutable value))
                {
                    return value;
                }
        ...
        public void SetFamilyName(scoped in Corvus.ClassicBenchmark.Current.PersonNameElement.Source value)
        {
            ...
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("familyName");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FamilyNameUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.FamilyName, ref cvb);
        ...
        public void SetGivenName(scoped in Corvus.ClassicBenchmark.Current.PersonNameElement.Source value)
        {
            ...
            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.GivenNameUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GivenNameUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.GivenName, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// <summary>
        /// Remove the <c>givenName</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveGivenName()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.GivenNameUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        public void SetOtherNames(scoped in Corvus.ClassicBenchmark.Current.OtherNames.Source value)
        {
            ...
            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.OtherNamesUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OtherNamesUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.OtherNames, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetOtherNames<TContext>(in Corvus.ClassicBenchmark.Current.OtherNames.Source<TContext> value)
        ...
        /// <summary>
        /// Remove the <c>otherNames</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveOtherNames()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.OtherNamesUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// <summary>
        /// Gets a <see cref="PersonName"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PersonName"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PersonName Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PersonName>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PersonName"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PersonName Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PersonName>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.ClassicBenchmark.Current.PersonNameElement.Source _createArg1;
        private readonly Corvus.ClassicBenchmark.Current.PersonNameElement.Source _createArg2;
        private readonly Corvus.ClassicBenchmark.Current.OtherNames.Source _createArg3;
        ...
        #endif
    {
        ...
        private readonly Corvus.ClassicBenchmark.Current.PersonNameElement.Source _createArg1;
        private readonly Corvus.ClassicBenchmark.Current.PersonNameElement.Source _createArg2;
        private readonly Corvus.ClassicBenchmark.Current.OtherNames.Source<TContext> _createArg3;
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.ClassicBenchmark.Current.PersonNameElement.Source familyName,
            in Corvus.ClassicBenchmark.Current.PersonNameElement.Source givenName = default,
            in Corvus.ClassicBenchmark.Current.OtherNames.Source otherNames = default)
        {
            familyName.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.FamilyName, ref builder);
            givenName.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.GivenName, ref builder);
            otherNames.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.OtherNames, ref builder);
        }
        ...
        public void Create(
            ...
            in Corvus.ClassicBenchmark.Current.OtherNames.Source otherNames = default)
        {
            Create(ref _builder, familyName, givenName, otherNames);
        }
        ...
        internal static void Create<TContext>(
            ...
            in Corvus.ClassicBenchmark.Current.PersonNameElement.Source familyName,
            in Corvus.ClassicBenchmark.Current.PersonNameElement.Source givenName = default,
            in Corvus.ClassicBenchmark.Current.OtherNames.Source<TContext> otherNames = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        #endif
        {
            Create(context, ref _builder, familyName, givenName, otherNames);
        }
    ...
    /// </summary>
    /// <param name="familyName">The value of the <c>"familyName"</c> property.</param>
    ...
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.ClassicBenchmark.Current.PersonNameElement.Source familyName, scoped in Corvus.ClassicBenchmark.Current.PersonNameElement.Source givenName = default, scoped in Corvus.ClassicBenchmark.Current.OtherNames.Source<TContext> otherNames = default)
        ...
        #endif
    {
        return new Source<TContext>(context, familyName, givenName, otherNames);
    }
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="familyName">The value of the property.</param>
    /// <param name="givenName">The value of the property.</param>
    /// <param name="otherNames">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.ClassicBenchmark.Current.PersonNameElement.Source familyName, in Corvus.ClassicBenchmark.Current.PersonNameElement.Source givenName = default, in Corvus.ClassicBenchmark.Current.OtherNames.Source otherNames = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(familyName, givenName, otherNames);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.ClassicBenchmark.Current.PersonNameElement.Source familyName, in Corvus.ClassicBenchmark.Current.PersonNameElement.Source givenName = default, in Corvus.ClassicBenchmark.Current.OtherNames.Source<TContext> otherNames = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, familyName, givenName, otherNames);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<PersonName, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<PersonName> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<PersonName>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<PersonName> Create<TContext>(
    ...
    public static ParsedJsonDocument<PersonName> Create(in Corvus.ClassicBenchmark.Current.PersonNameElement.Source familyName, in Corvus.ClassicBenchmark.Current.PersonNameElement.Source givenName = default, in Corvus.ClassicBenchmark.Current.OtherNames.Source otherNames = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<PersonName> Create<TContext>(in TContext context, in Corvus.ClassicBenchmark.Current.PersonNameElement.Source familyName, in Corvus.ClassicBenchmark.Current.PersonNameElement.Source givenName = default, in Corvus.ClassicBenchmark.Current.OtherNames.Source<TContext> otherNames = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
