...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.ClassicBenchmark.Current.PersonNameElement FamilyName
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FamilyNameUtf8, out Corvus.ClassicBenchmark.Current.PersonNameElement value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.ClassicBenchmark.Current.PersonNameElement GivenName
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GivenNameUtf8, out Corvus.ClassicBenchmark.Current.PersonNameElement value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.ClassicBenchmark.Current.OtherNames OtherNames
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OtherNamesUtf8, out Corvus.ClassicBenchmark.Current.OtherNames value))
            {
                return value;
            }
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="FamilyName"/>.
        /// </summary>
        public static ReadOnlySpan<byte> FamilyName => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x66, 0x61, 0x6D, 0x69, 0x6C, 0x79, 0x4E, 0x61, 0x6D, 0x65, 0x22];

        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="GivenName"/>.
        /// </summary>
        public static ReadOnlySpan<byte> GivenName => [0xB5, 0x00, 0x00, 0x00, 0x22, 0x67, 0x69, 0x76, 0x65, 0x6E, 0x4E, 0x61, 0x6D, 0x65, 0x22];
