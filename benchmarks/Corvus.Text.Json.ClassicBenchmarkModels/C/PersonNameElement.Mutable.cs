...
public readonly partial struct PersonNameElement
{
...
#endif
    {
        ...
        /// <summary>
        /// Gets a <see cref="PersonNameElement"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PersonNameElement"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PersonNameElement Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PersonNameElement>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PersonNameElement"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PersonNameElement Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PersonNameElement>(_idx);
        }
    }
    ...
    public static ParsedJsonDocument<PersonNameElement> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<PersonNameElement>();
        }
        finally
        {
