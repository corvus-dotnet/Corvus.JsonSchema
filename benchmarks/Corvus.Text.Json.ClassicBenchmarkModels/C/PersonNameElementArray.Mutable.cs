...
public readonly partial struct PersonNameElementArray
{
...
#endif
    {
        ...
        public Corvus.ClassicBenchmark.Current.PersonNameElement.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.ClassicBenchmark.Current.PersonNameElement.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.ClassicBenchmark.Current.PersonNameElement.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.ClassicBenchmark.Current.PersonNameElement.Mutable>(_parent, _idx);
        }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in Corvus.ClassicBenchmark.Current.PersonNameElement.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, scoped in Corvus.ClassicBenchmark.Current.PersonNameElement.Source value)
        {
            CheckValidInstance();
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void AddItem(scoped in Corvus.ClassicBenchmark.Current.PersonNameElement.Source value)
        {
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Remove(in Corvus.ClassicBenchmark.Current.PersonNameElement item)
        {
            CheckValidInstance();
            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.ClassicBenchmark.Current.PersonNameElement>(this, in item))
            {
                return false;
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<Corvus.ClassicBenchmark.Current.PersonNameElement> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.ClassicBenchmark.Current.PersonNameElement>(this, predicate);
            _documentVersion = _parent.Version;
        }
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Replace(in Corvus.ClassicBenchmark.Current.PersonNameElement oldItem, in Corvus.ClassicBenchmark.Current.PersonNameElement.Source newItem)
        {
            CheckValidInstance();
            ...
            var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.ClassicBenchmark.Current.PersonNameElement>(_parent, _idx);

            while (enumerator.MoveNext())
            {
                Corvus.ClassicBenchmark.Current.PersonNameElement current = enumerator.Current;
        ...
        /// </para>
        /// </remarks>
        public readonly PersonNameElementArray Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly PersonNameElementArray Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PersonNameElementArray>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.ClassicBenchmark.Current.PersonNameElementArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.ClassicBenchmark.Current.PersonNameElementArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        public void AddItem(in Corvus.ClassicBenchmark.Current.PersonNameElement.Source value)
        {
    ...
    public static ParsedJsonDocument<PersonNameElementArray> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<PersonNameElementArray>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<PersonNameElementArray> Create<TContext>(
