...
#endif
{
    ...
    public Corvus.ClassicBenchmark.Current.PersonNameElement this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Corvus.ClassicBenchmark.Current.PersonNameElement>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Corvus.ClassicBenchmark.Current.PersonNameElement> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Corvus.ClassicBenchmark.Current.PersonNameElement>(_parent, _idx);
    }
    ...
    /// <summary>
    /// Gets a <see cref="PersonNameElementArray"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="PersonNameElementArray"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public PersonNameElementArray Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<PersonNameElementArray>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="PersonNameElementArray"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public PersonNameElementArray Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PersonNameElementArray>(_idx);
        }
