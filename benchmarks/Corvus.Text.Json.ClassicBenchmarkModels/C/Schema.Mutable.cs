...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public static implicit operator Corvus.ClassicBenchmark.Current.Schema.PersonArray.Mutable(Mutable value)
        {
            return Corvus.ClassicBenchmark.Current.Schema.PersonArray.Mutable.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Mutable(Corvus.ClassicBenchmark.Current.Schema.PersonArray.Mutable value)
        {
            return From(value);
        }
        ...
        public Corvus.ClassicBenchmark.Current.Schema.Person.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.ClassicBenchmark.Current.Schema.Person.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.ClassicBenchmark.Current.Schema.Person.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.ClassicBenchmark.Current.Schema.Person.Mutable>(_parent, _idx);
        }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in Corvus.ClassicBenchmark.Current.Schema.Person.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in Corvus.ClassicBenchmark.Current.Schema.Person.Source value)
        {
            CheckValidInstance();
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void AddItem(in Corvus.ClassicBenchmark.Current.Schema.Person.Source value)
        {
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Remove(in Corvus.ClassicBenchmark.Current.Schema.Person item)
        {
            CheckValidInstance();
            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.ClassicBenchmark.Current.Schema.Person>(this, in item))
            {
                return false;
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<Corvus.ClassicBenchmark.Current.Schema.Person> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.ClassicBenchmark.Current.Schema.Person>(this, predicate);
            _documentVersion = _parent.Version;
        }
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Replace(in Corvus.ClassicBenchmark.Current.Schema.Person oldItem, in Corvus.ClassicBenchmark.Current.Schema.Person.Source newItem)
        {
            CheckValidInstance();
            ...
            var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.ClassicBenchmark.Current.Schema.Person>(_parent, _idx);

            while (enumerator.MoveNext())
            {
                Corvus.ClassicBenchmark.Current.Schema.Person current = enumerator.Current;
        ...
        public bool TryGetAsPersonArray(out Corvus.ClassicBenchmark.Current.Schema.PersonArray result)
        {
            ...
            {
                result = Corvus.ClassicBenchmark.Current.Schema.PersonArray.Mutable.From(this);
                return true;
            }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.ClassicBenchmark.Current.Schema.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.ClassicBenchmark.Current.Schema.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
