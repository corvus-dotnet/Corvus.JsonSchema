...
public readonly partial struct Schema
{
        ...
        : IJsonElement<OtherNames>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("person-array-schema.json#/$defs/OtherNames"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "person-array-schema.json#/$defs/OtherNames";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "person-array-schema.json#/$defs/OtherNames"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext oneOfContext0 =
                    Corvus.ClassicBenchmark.Current.Schema.PersonNameElement.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                Corvus.ClassicBenchmark.Current.Schema.PersonNameElement.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
                ...
                JsonSchemaContext oneOfContext1 =
                    Corvus.ClassicBenchmark.Current.Schema.PersonNameElementArray.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                Corvus.ClassicBenchmark.Current.Schema.PersonNameElementArray.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
