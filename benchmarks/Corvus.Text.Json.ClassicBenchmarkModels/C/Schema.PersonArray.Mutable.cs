...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PersonArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PersonArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PersonArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PersonArray(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PersonArray(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PersonArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.ClassicBenchmark.Current.Schema.PersonArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.ClassicBenchmark.Current.Schema.PersonArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<PersonArray, Mutable>(this);
        }
    }
}
