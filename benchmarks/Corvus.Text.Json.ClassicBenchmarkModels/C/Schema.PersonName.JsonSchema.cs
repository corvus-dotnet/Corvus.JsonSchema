...
public readonly partial struct Schema
{
        ...
        : IJsonElement<PersonName>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyFamilyNamePresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("familyName"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyFamilyNameNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("familyName"u8, buffer, out written);

            private const int RequiredOffsetForFamilyName = 0;
            private const uint RequiredBitForFamilyName = 0b00000000000000000000000000000001;

            private const uint RequiredBitMask0 =
                RequiredBitForFamilyName;
            private static readonly JsonSchemaPathProvider FamilyNameSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/familyName/$ref"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider GivenNameSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/givenName/$ref"u8, buffer, out written);
            ...
            private static void MatchFamilyName(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.ClassicBenchmark.Current.Schema.PersonNameElement.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.FamilyNameUtf8,
                        evaluationPath: FamilyNameSchemaEvaluationPath);

                Corvus.ClassicBenchmark.Current.Schema.PersonNameElement.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                requiredBitBuffer[RequiredOffsetForFamilyName] |= RequiredBitForFamilyName;
            }

            private static void MatchGivenName(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext1 =
                    Corvus.ClassicBenchmark.Current.Schema.PersonNameElement.JsonSchema.PushChildContextUnescaped(
                        ...
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.GivenNameUtf8,
                        evaluationPath: GivenNameSchemaEvaluationPath);

                Corvus.ClassicBenchmark.Current.Schema.PersonNameElement.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            private static void MatchOtherNamesValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext2 =
                    Corvus.ClassicBenchmark.Current.Schema.OtherNames.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.ClassicBenchmark.Current.Schema.OtherNames.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                context.CommitChildContext(childContext2.IsMatch, ref childContext2);
            }

            private static PropertySchemaMatchers<Corvus.ClassicBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.ClassicBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                    (static () => JsonPropertyNames.FamilyNameUtf8, MatchFamilyName),
                    (static () => JsonPropertyNames.GivenNameUtf8, MatchGivenName),
                    (static () => JsonPropertyNames.OtherNamesValueUtf8, MatchOtherNamesValue),
                ]);
            }

            private static PropertySchemaMatchers<Corvus.ClassicBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> Matchers { get; } = MatchersBuilder();

            private static bool TryGetNamedMatcher(ReadOnlySpan<byte> span,
#if NET
            [NotNullWhen(true)]
#endif
            out Corvus.ClassicBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator? matcher)
            {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("person-array-schema.json#/$defs/PersonName"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "person-array-schema.json#/$defs/PersonName";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "person-array-schema.json#/$defs/PersonName"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (objectValidation_enumerator.MoveNext())
                    {
                        ...
                        if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out Corvus.ClassicBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator? validator))
                        {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyFamilyNamePresent, "familyName"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForFamilyName] & RequiredBitForFamilyName) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyFamilyNameNotPresent, "familyName"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyFamilyNamePresent, "familyName"u8, "required"u8);
