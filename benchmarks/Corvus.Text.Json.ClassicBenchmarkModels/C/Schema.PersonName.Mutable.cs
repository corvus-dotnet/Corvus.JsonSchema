...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PersonName
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.ClassicBenchmark.Current.Schema.PersonNameElement.Mutable FamilyName
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FamilyNameUtf8, out Corvus.ClassicBenchmark.Current.Schema.PersonNameElement.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.ClassicBenchmark.Current.Schema.PersonNameElement.Mutable GivenName
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GivenNameUtf8, out Corvus.ClassicBenchmark.Current.Schema.PersonNameElement.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.ClassicBenchmark.Current.Schema.OtherNames.Mutable OtherNamesValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OtherNamesValueUtf8, out Corvus.ClassicBenchmark.Current.Schema.OtherNames.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetFamilyName(in Corvus.ClassicBenchmark.Current.Schema.PersonNameElement.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetGivenName(in Corvus.ClassicBenchmark.Current.Schema.PersonNameElement.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetOtherNamesValue(in Corvus.ClassicBenchmark.Current.Schema.OtherNames.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetOtherNamesValue<TContext>(in Corvus.ClassicBenchmark.Current.Schema.OtherNames.Source<TContext> value)
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.ClassicBenchmark.Current.Schema.PersonName.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.ClassicBenchmark.Current.Schema.PersonName.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.ClassicBenchmark.Current.Schema.PersonNameElement.Source familyName,
                in Corvus.ClassicBenchmark.Current.Schema.PersonNameElement.Source givenName = default,
                in Corvus.ClassicBenchmark.Current.Schema.OtherNames.Source otherNames = default)
            {
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.ClassicBenchmark.Current.Schema.PersonNameElement.Source familyName,
                in Corvus.ClassicBenchmark.Current.Schema.PersonNameElement.Source givenName = default,
                in Corvus.ClassicBenchmark.Current.Schema.OtherNames.Source<TContext> otherNames = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
