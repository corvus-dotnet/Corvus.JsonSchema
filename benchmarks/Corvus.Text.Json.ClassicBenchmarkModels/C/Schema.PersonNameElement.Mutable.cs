...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PersonNameElement
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PersonNameElement instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PersonNameElement"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PersonNameElement(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PersonNameElement(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PersonNameElement.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(PersonNameElement instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<PersonNameElement, Mutable>(this);
        }
    }
}
