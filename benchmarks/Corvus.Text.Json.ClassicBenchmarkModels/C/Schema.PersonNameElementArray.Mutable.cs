...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PersonNameElementArray
    {
...
#endif
        {
            ...
            public Corvus.ClassicBenchmark.Current.Schema.PersonNameElement.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.ClassicBenchmark.Current.Schema.PersonNameElement.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.ClassicBenchmark.Current.Schema.PersonNameElement.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.ClassicBenchmark.Current.Schema.PersonNameElement.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.ClassicBenchmark.Current.Schema.PersonNameElement.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.ClassicBenchmark.Current.Schema.PersonNameElement.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.ClassicBenchmark.Current.Schema.PersonNameElement.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.ClassicBenchmark.Current.Schema.PersonNameElement item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.ClassicBenchmark.Current.Schema.PersonNameElement>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.ClassicBenchmark.Current.Schema.PersonNameElement> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.ClassicBenchmark.Current.Schema.PersonNameElement>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.ClassicBenchmark.Current.Schema.PersonNameElement oldItem, in Corvus.ClassicBenchmark.Current.Schema.PersonNameElement.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.ClassicBenchmark.Current.Schema.PersonNameElement>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.ClassicBenchmark.Current.Schema.PersonNameElement current = enumerator.Current;
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.ClassicBenchmark.Current.Schema.PersonNameElementArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.ClassicBenchmark.Current.Schema.PersonNameElementArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
