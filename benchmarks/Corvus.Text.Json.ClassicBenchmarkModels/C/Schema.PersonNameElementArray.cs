...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public Corvus.ClassicBenchmark.Current.Schema.PersonNameElement this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.ClassicBenchmark.Current.Schema.PersonNameElement>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.ClassicBenchmark.Current.Schema.PersonNameElement> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.ClassicBenchmark.Current.Schema.PersonNameElement>(_parent, _idx);
        }
