        ...
        public readonly partial struct RequiredName
        {
            ...
            public readonly partial struct InheritsEntity
            {
...
#endif
                {
                    ...
                    public Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Type1Entity this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Type1Entity>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Type1Entity> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Type1Entity>(_parent, _idx);
                    }
