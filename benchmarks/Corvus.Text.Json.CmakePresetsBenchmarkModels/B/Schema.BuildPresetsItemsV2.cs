...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BuildPresetsItemsV2"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal BuildPresetsItemsV2(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static BuildPresetsItemsV2 DefaultInstance { get; }
        ...
        public Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV2.RequiredName this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV2.RequiredName>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV2.RequiredName> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV2.RequiredName>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in BuildPresetsItemsV2 left, in BuildPresetsItemsV2 right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in BuildPresetsItemsV2 left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(BuildPresetsItemsV2 instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BuildPresetsItemsV2(JsonElement instance)
        {
            return BuildPresetsItemsV2.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuildPresetsItemsV2 From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuildPresetsItemsV2 ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BuildPresetsItemsV2>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuildPresetsItemsV2 ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BuildPresetsItemsV2>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuildPresetsItemsV2 ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BuildPresetsItemsV2>(json, options);
        }
        ...
        /// </exception>
        public static BuildPresetsItemsV2 ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<BuildPresetsItemsV2>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out BuildPresetsItemsV2? result)
        {
            return JsonElementHelpers.TryParseValue<BuildPresetsItemsV2>(ref reader, out result);
        }
...
#if NET
        static BuildPresetsItemsV2 IJsonElement<BuildPresetsItemsV2>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BuildPresetsItemsV2: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public BuildPresetsItemsV2 Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public BuildPresetsItemsV2 Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<BuildPresetsItemsV2>(_idx);
            }
