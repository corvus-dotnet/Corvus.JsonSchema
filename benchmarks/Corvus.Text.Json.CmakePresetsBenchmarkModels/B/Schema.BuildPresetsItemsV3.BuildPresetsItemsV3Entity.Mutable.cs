    ...
    public readonly partial struct BuildPresetsItemsV3
    {
        ...
        public readonly partial struct BuildPresetsItemsV3Entity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(BuildPresetsItemsV3Entity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="BuildPresetsItemsV3Entity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator BuildPresetsItemsV3Entity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"BuildPresetsItemsV3Entity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly BuildPresetsItemsV3Entity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly BuildPresetsItemsV3Entity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<BuildPresetsItemsV3Entity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV3.BuildPresetsItemsV3Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(BuildPresetsItemsV3Entity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV3.BuildPresetsItemsV3Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="BuildPresetsItemsV3Entity"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.CmakePresetsBenchmark.Baseline.Schema.TopCondition.Source condition = default)
                {
                ...
                /// Creates an instance of a <see cref="BuildPresetsItemsV3Entity"/>.
                /// </summary>
                public void Create(in Corvus.CmakePresetsBenchmark.Baseline.Schema.TopCondition.Source condition = default)
                {
                ...
                /// Creates an instance of a <see cref="BuildPresetsItemsV3Entity"/>.
                /// </summary>
                public void Create<TContext>(in TContext context, in Corvus.CmakePresetsBenchmark.Baseline.Schema.TopCondition.Source<TContext> condition = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Baseline.Schema.TopCondition.Source condition = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.CmakePresetsBenchmark.Baseline.Schema.TopCondition.Source<TContext> condition = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            {
                return workspace.CreateBuilder<BuildPresetsItemsV3Entity, Mutable>(this);
            }
        }
    }
}
