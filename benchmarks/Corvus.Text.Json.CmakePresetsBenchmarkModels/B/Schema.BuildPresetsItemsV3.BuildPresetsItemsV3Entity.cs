...
public readonly partial struct Schema
{
    ...
    public readonly partial struct BuildPresetsItemsV3
    {
        ...
        public readonly partial struct BuildPresetsItemsV3Entity
#if NET8_0_OR_GREATER
            : IJsonElement<BuildPresetsItemsV3Entity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="BuildPresetsItemsV3Entity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal BuildPresetsItemsV3Entity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static BuildPresetsItemsV3Entity DefaultInstance { get; }
            ...
            /// </summary>
            public Corvus.CmakePresetsBenchmark.Baseline.Schema.TopCondition Condition
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ConditionUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.TopCondition value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in BuildPresetsItemsV3Entity left, in BuildPresetsItemsV3Entity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in BuildPresetsItemsV3Entity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(BuildPresetsItemsV3Entity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BuildPresetsItemsV3Entity(JsonElement instance)
            {
                return BuildPresetsItemsV3Entity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BuildPresetsItemsV3Entity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BuildPresetsItemsV3Entity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BuildPresetsItemsV3Entity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BuildPresetsItemsV3Entity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BuildPresetsItemsV3Entity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BuildPresetsItemsV3Entity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BuildPresetsItemsV3Entity>(json, options);
            }
            ...
            /// </exception>
            public static BuildPresetsItemsV3Entity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<BuildPresetsItemsV3Entity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out BuildPresetsItemsV3Entity? result)
            {
                return JsonElementHelpers.TryParseValue<BuildPresetsItemsV3Entity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new BuildPresetsItemsV3Entity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static BuildPresetsItemsV3Entity IJsonElement<BuildPresetsItemsV3Entity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BuildPresetsItemsV3Entity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="BuildPresetsItemsV3Entity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="BuildPresetsItemsV3Entity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public BuildPresetsItemsV3Entity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<BuildPresetsItemsV3Entity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="BuildPresetsItemsV3Entity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public BuildPresetsItemsV3Entity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<BuildPresetsItemsV3Entity>(_idx);
                }
