...
public readonly partial struct Schema
{
        ...
        : IJsonElement<BuildPresetsItemsV3>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("cmake-presets-schema.json#/definitions/buildPresetsItemsV3"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "cmake-presets-schema.json#/definitions/buildPresetsItemsV3";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "cmake-presets-schema.json#/definitions/buildPresetsItemsV3"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (arrayValidation_enumerator.MoveNext())
                    {
                        ...
                        JsonSchemaContext childContext = Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV3.BuildPresetsItemsV3Entity.JsonSchema.PushChildContext(
                            parentDocument,
                        ...
                        Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV3.BuildPresetsItemsV3Entity.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
