...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV3.BuildPresetsItemsV3Entity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV3.BuildPresetsItemsV3Entity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV3.BuildPresetsItemsV3Entity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV3.BuildPresetsItemsV3Entity>(_parent, _idx);
        }
