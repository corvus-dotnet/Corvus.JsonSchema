...
public readonly partial struct Schema
{
    ...
    public readonly partial struct BuildPresetsItemsV4
    {
        ...
        public readonly partial struct BuildPresetsItemsV4Entity
            : IJsonElement<BuildPresetsItemsV4Entity>
        {
            public static partial class JsonSchema
            {
                private static readonly JsonSchemaPathProvider ResolvePackageReferencesSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/resolvePackageReferences"u8, buffer, out written);

                private static void MatchResolvePackageReferences(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.ResolvePackageReferencesEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.ResolvePackageReferencesUtf8,
                            evaluationPath: ResolvePackageReferencesSchemaEvaluationPath);

                    Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.ResolvePackageReferencesEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.ResolvePackageReferencesUtf8))
                    {
                        matcher = MatchResolvePackageReferences;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("cmake-presets-schema.json#/definitions/buildPresetsItemsV4/items"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "cmake-presets-schema.json#/definitions/buildPresetsItemsV4/items";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "cmake-presets-schema.json#/definitions/buildPresetsItemsV4/items"u8;
