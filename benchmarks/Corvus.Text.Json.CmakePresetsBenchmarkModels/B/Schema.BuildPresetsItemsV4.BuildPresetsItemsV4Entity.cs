...
public readonly partial struct Schema
{
    ...
    public readonly partial struct BuildPresetsItemsV4
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="BuildPresetsItemsV4Entity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal BuildPresetsItemsV4Entity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static BuildPresetsItemsV4Entity DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.ResolvePackageReferencesEntity ResolvePackageReferences
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ResolvePackageReferencesUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.ResolvePackageReferencesEntity value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in BuildPresetsItemsV4Entity left, in BuildPresetsItemsV4Entity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in BuildPresetsItemsV4Entity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(BuildPresetsItemsV4Entity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BuildPresetsItemsV4Entity(JsonElement instance)
            {
                return BuildPresetsItemsV4Entity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BuildPresetsItemsV4Entity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BuildPresetsItemsV4Entity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BuildPresetsItemsV4Entity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BuildPresetsItemsV4Entity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BuildPresetsItemsV4Entity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BuildPresetsItemsV4Entity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BuildPresetsItemsV4Entity>(json, options);
            }
            ...
            /// </exception>
            public static BuildPresetsItemsV4Entity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<BuildPresetsItemsV4Entity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out BuildPresetsItemsV4Entity? result)
            {
                return JsonElementHelpers.TryParseValue<BuildPresetsItemsV4Entity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new BuildPresetsItemsV4Entity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static BuildPresetsItemsV4Entity IJsonElement<BuildPresetsItemsV4Entity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BuildPresetsItemsV4Entity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="BuildPresetsItemsV4Entity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="BuildPresetsItemsV4Entity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public BuildPresetsItemsV4Entity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<BuildPresetsItemsV4Entity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="BuildPresetsItemsV4Entity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public BuildPresetsItemsV4Entity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<BuildPresetsItemsV4Entity>(_idx);
                }
