...
public readonly partial struct Schema
{
    ...
    public readonly partial struct BuildPresetsItemsV4
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(BuildPresetsItemsV4 instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BuildPresetsItemsV4"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BuildPresetsItemsV4(Mutable instance)
            {
            ...
            public Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new BuildPresetsItemsV4(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BuildPresetsItemsV4.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity oldItem, in Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity current = enumerator.Current;
            ...
            /// <summary>
            /// Gets a <see cref="BuildPresetsItemsV4"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="BuildPresetsItemsV4"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly BuildPresetsItemsV4 Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<BuildPresetsItemsV4>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="BuildPresetsItemsV4"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly BuildPresetsItemsV4 Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<BuildPresetsItemsV4>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(BuildPresetsItemsV4 instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<BuildPresetsItemsV4, Mutable>(this);
        }
    }
}
