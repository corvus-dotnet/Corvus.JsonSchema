...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BuildPresetsItemsV4"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal BuildPresetsItemsV4(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static BuildPresetsItemsV4 DefaultInstance { get; }
        ...
        public Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in BuildPresetsItemsV4 left, in BuildPresetsItemsV4 right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in BuildPresetsItemsV4 left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(BuildPresetsItemsV4 instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BuildPresetsItemsV4(JsonElement instance)
        {
            return BuildPresetsItemsV4.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuildPresetsItemsV4 From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuildPresetsItemsV4 ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BuildPresetsItemsV4>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuildPresetsItemsV4 ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BuildPresetsItemsV4>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuildPresetsItemsV4 ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BuildPresetsItemsV4>(json, options);
        }
        ...
        /// </exception>
        public static BuildPresetsItemsV4 ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<BuildPresetsItemsV4>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out BuildPresetsItemsV4? result)
        {
            return JsonElementHelpers.TryParseValue<BuildPresetsItemsV4>(ref reader, out result);
        }
...
#if NET
        static BuildPresetsItemsV4 IJsonElement<BuildPresetsItemsV4>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BuildPresetsItemsV4: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public BuildPresetsItemsV4 Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public BuildPresetsItemsV4 Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<BuildPresetsItemsV4>(_idx);
            }
