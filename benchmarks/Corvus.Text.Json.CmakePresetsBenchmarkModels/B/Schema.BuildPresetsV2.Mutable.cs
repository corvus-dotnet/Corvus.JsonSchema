...
public readonly partial struct Schema
{
    ...
    public readonly partial struct BuildPresetsV2
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV2"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV2.Mutable(Mutable value)
            {
                return Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV2.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV2"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Mutable(Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV2.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(BuildPresetsV2 instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BuildPresetsV2"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BuildPresetsV2(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new BuildPresetsV2(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BuildPresetsV2.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV2" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsBuildPresetsItemsV2(out Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV2 result)
            {
                if (Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV2.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV2.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsV2.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(BuildPresetsV2 instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsV2.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<BuildPresetsV2, Mutable>(this);
        }
    }
}
