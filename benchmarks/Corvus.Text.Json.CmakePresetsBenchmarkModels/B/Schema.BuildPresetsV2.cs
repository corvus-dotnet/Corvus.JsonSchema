...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BuildPresetsV2"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal BuildPresetsV2(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static BuildPresetsV2 DefaultInstance { get; }
        ...
        public static implicit operator Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV2(BuildPresetsV2 value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator BuildPresetsV2(Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV2 value)
        {
            return From(value);
        }
        ...
        /// </returns>
        public static bool operator ==(in BuildPresetsV2 left, in BuildPresetsV2 right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in BuildPresetsV2 left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(BuildPresetsV2 instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BuildPresetsV2(JsonElement instance)
        {
            return BuildPresetsV2.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuildPresetsV2 From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuildPresetsV2 ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BuildPresetsV2>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuildPresetsV2 ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BuildPresetsV2>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuildPresetsV2 ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BuildPresetsV2>(json, options);
        }
        ...
        /// </exception>
        public static BuildPresetsV2 ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<BuildPresetsV2>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out BuildPresetsV2? result)
        {
            return JsonElementHelpers.TryParseValue<BuildPresetsV2>(ref reader, out result);
        }
...
#if NET
        static BuildPresetsV2 IJsonElement<BuildPresetsV2>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BuildPresetsV2: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public BuildPresetsV2 Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<BuildPresetsV2>(_idx);
            }
