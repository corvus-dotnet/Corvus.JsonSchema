...
public readonly partial struct Schema
{
    ...
    public readonly partial struct BuildPresetsV3
    {
...
#endif
        {
            ...
            public static implicit operator Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV3.Mutable(Mutable value)
            {
                return Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV3.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Mutable(Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV3.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(BuildPresetsV3 instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BuildPresetsV3"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BuildPresetsV3(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BuildPresetsV3.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </para>
            /// </remarks>
            public readonly BuildPresetsV3 Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly BuildPresetsV3 Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<BuildPresetsV3>(_idx);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsV3.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                ...
                {
                    return matchBuildPresetsItemsV3(Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV3.Mutable.From(this), context);
                }

                if (Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV2.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchBuildPresetsItemsV2(Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV2.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsV3.Mutable, TResult> defaultMatch)
            {
                if (Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV3.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchBuildPresetsItemsV3(Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV3.Mutable.From(this));
                }

                if (Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV2.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchBuildPresetsItemsV2(Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV2.Mutable.From(this));
                }
            ...
            public bool TryGetAsBuildPresetsItemsV3(out Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV3 result)
            {
                if (Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV3.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV3.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsV3.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(BuildPresetsV3 instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsV3.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<BuildPresetsV3, Mutable>(this);
        }
    }
}
