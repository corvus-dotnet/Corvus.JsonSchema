...
public readonly partial struct Schema
{
    ...
    public readonly partial struct BuildPresetsV4
    {
...
#endif
        {
            ...
            public static implicit operator Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.Mutable(Mutable value)
            {
                return Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Mutable(Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.Mutable value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsV4.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                ...
                {
                    return matchBuildPresetsItemsV4(Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsV4.Mutable, TResult> defaultMatch)
            {
                if (Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchBuildPresetsItemsV4(Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.Mutable.From(this));
                }
            ...
            public bool TryGetAsBuildPresetsItemsV4(out Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4 result)
            {
                if (Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsItemsV4.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsV4.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.BuildPresetsV4.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
