...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CmakeMinimumRequired
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.CmakePresetsBenchmark.Baseline.JsonInteger.Mutable Major
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MajorUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonInteger.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CmakePresetsBenchmark.Baseline.JsonInteger.Mutable Minor
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinorUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonInteger.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CmakePresetsBenchmark.Baseline.JsonInteger.Mutable Patch
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PatchUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonInteger.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetMajor(in Corvus.CmakePresetsBenchmark.Baseline.JsonInteger.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetMinor(in Corvus.CmakePresetsBenchmark.Baseline.JsonInteger.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetPatch(in Corvus.CmakePresetsBenchmark.Baseline.JsonInteger.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.CmakeMinimumRequired.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.CmakeMinimumRequired.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.CmakePresetsBenchmark.Baseline.JsonInteger.Source major = default,
                in Corvus.CmakePresetsBenchmark.Baseline.JsonInteger.Source minor = default,
                in Corvus.CmakePresetsBenchmark.Baseline.JsonInteger.Source patch = default)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Baseline.JsonInteger.Source major = default, in Corvus.CmakePresetsBenchmark.Baseline.JsonInteger.Source minor = default, in Corvus.CmakePresetsBenchmark.Baseline.JsonInteger.Source patch = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
