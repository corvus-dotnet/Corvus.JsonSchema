...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CmakeMinimumRequired"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal CmakeMinimumRequired(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static CmakeMinimumRequired DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CmakePresetsBenchmark.Baseline.JsonInteger Major
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MajorUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonInteger value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CmakePresetsBenchmark.Baseline.JsonInteger Minor
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinorUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonInteger value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CmakePresetsBenchmark.Baseline.JsonInteger Patch
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PatchUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonInteger value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in CmakeMinimumRequired left, in CmakeMinimumRequired right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in CmakeMinimumRequired left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(CmakeMinimumRequired instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator CmakeMinimumRequired(JsonElement instance)
        {
            return CmakeMinimumRequired.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CmakeMinimumRequired From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CmakeMinimumRequired ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CmakeMinimumRequired>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CmakeMinimumRequired ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CmakeMinimumRequired>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CmakeMinimumRequired ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CmakeMinimumRequired>(json, options);
        }
        ...
        /// </exception>
        public static CmakeMinimumRequired ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<CmakeMinimumRequired>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out CmakeMinimumRequired? result)
        {
            return JsonElementHelpers.TryParseValue<CmakeMinimumRequired>(ref reader, out result);
        }
...
#if NET
        static CmakeMinimumRequired IJsonElement<CmakeMinimumRequired>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"CmakeMinimumRequired: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public CmakeMinimumRequired Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public CmakeMinimumRequired Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<CmakeMinimumRequired>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Major"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Major => "major"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Minor"/>.
            /// </summary>
