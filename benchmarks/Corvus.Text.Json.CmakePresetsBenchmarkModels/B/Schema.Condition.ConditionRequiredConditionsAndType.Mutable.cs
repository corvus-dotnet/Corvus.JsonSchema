    ...
    public readonly partial struct Condition
    {
        ...
        public readonly partial struct ConditionRequiredConditionsAndType
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredConditionsAndType.ConditionArray.Mutable Conditions
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ConditionsUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredConditionsAndType.ConditionArray.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredConditionsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.Mutable Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredConditionsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetConditions(in Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredConditionsAndType.ConditionArray.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetConditions<TContext>(in Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredConditionsAndType.ConditionArray.Source<TContext> value)
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetType(in Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredConditionsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredConditionsAndType.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredConditionsAndType.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredConditionsAndType.ConditionArray.Source conditions)
                {
                    conditions.AddAsProperty(JsonPropertyNamesEscaped.Conditions, ref builder, escapeName: false);
                    builder.AddProperty(JsonPropertyNamesEscaped.Type, Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredConditionsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.ConstInstance);
                }

                /// <summary>
                /// Creates an instance of a <see cref="ConditionRequiredConditionsAndType"/>.
                /// </summary>
                public void Create(in Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredConditionsAndType.ConditionArray.Source conditions)
                {
                ...
                internal static void Create<TContext>(
                    ...
                    in Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredConditionsAndType.ConditionArray.Source<TContext> conditions)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                /// Creates an instance of a <see cref="ConditionRequiredConditionsAndType"/>.
                /// </summary>
                public void Create<TContext>(in TContext context, in Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredConditionsAndType.ConditionArray.Source<TContext> conditions)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredConditionsAndType.ConditionArray.Source conditions, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredConditionsAndType.ConditionArray.Source<TContext> conditions, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
