...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Condition
    {
        ...
        public readonly partial struct ConditionRequiredLhsAndRhsAndType
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ConditionRequiredLhsAndRhsAndType instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ConditionRequiredLhsAndRhsAndType"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ConditionRequiredLhsAndRhsAndType(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Baseline.JsonString.Mutable Lhs
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LhsUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Baseline.JsonString.Mutable Rhs
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RhsUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredLhsAndRhsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.Mutable Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredLhsAndRhsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ConditionRequiredLhsAndRhsAndType(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetLhs(in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source value)
                {
                    CheckValidInstance();
                    ...
                    else
                    {
                        ...
                        value.AddAsProperty(JsonPropertyNamesEscaped.Lhs, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetRhs(in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source value)
                {
                    CheckValidInstance();
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsProperty(JsonPropertyNamesEscaped.Rhs, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetType(in Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredLhsAndRhsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.Source value)
                {
                    CheckValidInstance();
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ConditionRequiredLhsAndRhsAndType.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ConditionRequiredLhsAndRhsAndType"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ConditionRequiredLhsAndRhsAndType"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ConditionRequiredLhsAndRhsAndType Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ConditionRequiredLhsAndRhsAndType>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ConditionRequiredLhsAndRhsAndType"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ConditionRequiredLhsAndRhsAndType Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ConditionRequiredLhsAndRhsAndType>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredLhsAndRhsAndType.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(ConditionRequiredLhsAndRhsAndType instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredLhsAndRhsAndType.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="ConditionRequiredLhsAndRhsAndType"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source lhs,
                    in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source rhs)
                {
                    lhs.AddAsProperty(JsonPropertyNamesEscaped.Lhs, ref builder, escapeName: false);
                    rhs.AddAsProperty(JsonPropertyNamesEscaped.Rhs, ref builder, escapeName: false);
                    builder.AddProperty(JsonPropertyNamesEscaped.Type, Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredLhsAndRhsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.ConstInstance);
                }

                /// <summary>
                /// Creates an instance of a <see cref="ConditionRequiredLhsAndRhsAndType"/>.
                /// </summary>
                public void Create(in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source lhs, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source rhs)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source lhs, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source rhs, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            {
                return workspace.CreateBuilder<ConditionRequiredLhsAndRhsAndType, Mutable>(this);
            }
        }
    }
}
