...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Condition
    {
        ...
        public readonly partial struct ConditionRequiredLhsAndRhsAndType
            ...
            : IJsonElement<ConditionRequiredLhsAndRhsAndType>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ConditionRequiredLhsAndRhsAndType"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ConditionRequiredLhsAndRhsAndType(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ConditionRequiredLhsAndRhsAndType DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CmakePresetsBenchmark.Baseline.JsonString Lhs
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LhsUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CmakePresetsBenchmark.Baseline.JsonString Rhs
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RhsUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredLhsAndRhsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredLhsAndRhsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in ConditionRequiredLhsAndRhsAndType left, in ConditionRequiredLhsAndRhsAndType right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ConditionRequiredLhsAndRhsAndType left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(ConditionRequiredLhsAndRhsAndType instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ConditionRequiredLhsAndRhsAndType(JsonElement instance)
            {
                return ConditionRequiredLhsAndRhsAndType.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConditionRequiredLhsAndRhsAndType From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConditionRequiredLhsAndRhsAndType ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConditionRequiredLhsAndRhsAndType>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConditionRequiredLhsAndRhsAndType ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConditionRequiredLhsAndRhsAndType>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConditionRequiredLhsAndRhsAndType ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConditionRequiredLhsAndRhsAndType>(json, options);
            }
            ...
            /// </exception>
            public static ConditionRequiredLhsAndRhsAndType ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ConditionRequiredLhsAndRhsAndType>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ConditionRequiredLhsAndRhsAndType? result)
            {
                return JsonElementHelpers.TryParseValue<ConditionRequiredLhsAndRhsAndType>(ref reader, out result);
            }
...
#if NET
            static ConditionRequiredLhsAndRhsAndType IJsonElement<ConditionRequiredLhsAndRhsAndType>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ConditionRequiredLhsAndRhsAndType: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ConditionRequiredLhsAndRhsAndType Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ConditionRequiredLhsAndRhsAndType Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ConditionRequiredLhsAndRhsAndType>(_idx);
                }
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="Lhs"/>.
                /// </summary>
                public const string Lhs = "lhs";

                /// <summary>
                /// Gets the JSON property name for <see cref="Rhs"/>.
                /// </summary>
                ...
                /// Gets the JSON property name for <see cref="Lhs"/>.
                /// </summary>
                public static ReadOnlySpan<byte> LhsUtf8 => "lhs"u8;

                /// <summary>
                /// Gets the JSON property name for <see cref="Rhs"/>.
                /// </summary>
                public static ReadOnlySpan<byte> RhsUtf8 => "rhs"u8;
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Lhs"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Lhs => "lhs"u8;

                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Rhs"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Rhs => "rhs"u8;
