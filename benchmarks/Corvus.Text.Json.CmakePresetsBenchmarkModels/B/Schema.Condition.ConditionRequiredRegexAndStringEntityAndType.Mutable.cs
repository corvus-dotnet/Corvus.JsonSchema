    ...
    public readonly partial struct Condition
    {
        ...
        public readonly partial struct ConditionRequiredRegexAndStringEntityAndType
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Baseline.JsonString.Mutable Regex
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RegexUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredRegexAndStringEntityAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.Mutable Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredRegexAndStringEntityAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetRegex(in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetType(in Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredRegexAndStringEntityAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredRegexAndStringEntityAndType.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredRegexAndStringEntityAndType.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source regex,
                    in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source stringValue)
                {
                    ...
                    builder.AddProperty(JsonPropertyNamesEscaped.Type, Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.ConditionRequiredRegexAndStringEntityAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.ConstInstance);
                }

                /// <summary>
                /// Creates an instance of a <see cref="ConditionRequiredRegexAndStringEntityAndType"/>.
                /// </summary>
                public void Create(in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source regex, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source stringValue)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source regex, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source stringValue, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
