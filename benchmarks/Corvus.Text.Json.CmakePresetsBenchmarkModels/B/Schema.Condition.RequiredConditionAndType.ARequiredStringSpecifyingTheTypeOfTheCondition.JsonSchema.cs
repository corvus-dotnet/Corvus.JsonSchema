        ...
        public readonly partial struct RequiredConditionAndType
        {
                ...
                : IJsonElement<ARequiredStringSpecifyingTheTypeOfTheCondition>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Const = "not"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>const</c> keyword.
                    /// </summary>
                    public static readonly ARequiredStringSpecifyingTheTypeOfTheCondition ConstJson = ParsedJsonDocument<ARequiredStringSpecifyingTheTypeOfTheCondition>.StringConstant([.."\"not\""u8]);
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("cmake-presets-schema.json#/definitions/condition/anyOf/10/properties/type"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "cmake-presets-schema.json#/definitions/condition/anyOf/10/properties/type";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "cmake-presets-schema.json#/definitions/condition/anyOf/10/properties/type"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "not"u8, "not", "const"u8, ref context);
                        }
                        else
                        {
                            context.EvaluatedKeyword(false, "not", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                        }
                    }
