    ...
    public readonly partial struct Condition
    {
        ...
        public readonly partial struct RequiredLhsAndRhsAndType
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.RequiredLhsAndRhsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.Mutable Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.RequiredLhsAndRhsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetType(in Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.RequiredLhsAndRhsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.RequiredLhsAndRhsAndType.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.RequiredLhsAndRhsAndType.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                    ...
                    in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source rhs)
                {
                    ...
                    builder.AddProperty(JsonPropertyNamesEscaped.Type, Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.RequiredLhsAndRhsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.ConstInstance);
                }
