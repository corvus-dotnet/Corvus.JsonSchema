...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Condition
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.RequiredLhsAndRhsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.RequiredLhsAndRhsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition value))
                    {
                        return value;
                    }
