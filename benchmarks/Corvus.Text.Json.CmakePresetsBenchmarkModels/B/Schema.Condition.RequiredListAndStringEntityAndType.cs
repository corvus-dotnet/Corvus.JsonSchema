...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Condition
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.RequiredListAndStringEntityAndType.JsonStringArray List
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ListUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.RequiredListAndStringEntityAndType.JsonStringArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.RequiredListAndStringEntityAndType.ARequiredStringSpecifyingTheTypeOfTheCondition Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.RequiredListAndStringEntityAndType.ARequiredStringSpecifyingTheTypeOfTheCondition value))
                    {
                        return value;
                    }
