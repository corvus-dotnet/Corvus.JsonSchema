...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ConfigurePresetsItemsV1
    {
        ...
        public readonly partial struct AConfigurePresetObject
        {
            ...
            public readonly partial struct AnOptionalObjectSpecifyingDebugOptions
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(AnOptionalObjectSpecifyingDebugOptions instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="AnOptionalObjectSpecifyingDebugOptions"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AnOptionalObjectSpecifyingDebugOptions(Mutable instance)
                    {
                    ...
                    /// <summary>
                    /// Gets the (optional) <c>find</c> property.
                    /// </summary>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Mutable Find
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FindUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Mutable Output
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OutputUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// <summary>
                    /// Gets the (optional) <c>tryCompile</c> property.
                    /// </summary>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Mutable TryCompile
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TryCompileUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Mutable value))
                            {
                                return value;
                            }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new AnOptionalObjectSpecifyingDebugOptions(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    public void SetFind(in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FindUtf8);
                    ...
                    /// <summary>
                    /// Remove the <c>find</c> property, if present.
                    /// </summary>
                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                    public bool RemoveFind()
                    {
                        CheckValidInstance();
                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FindUtf8);
                        _documentVersion = _parent.Version;
                        return result;
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetOutput(in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// <summary>
                    /// Set the <c>tryCompile</c> property.
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetTryCompile(in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.TryCompileUtf8);
                            _documentVersion = _parent.Version;
                            return;
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TryCompileUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                            // We are going to replace just the value
                            value.AddAsItem(ref cvb);
                            _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    /// <summary>
                    /// Remove the <c>tryCompile</c> property, if present.
                    /// </summary>
                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                    public bool RemoveTryCompile()
                    {
                        CheckValidInstance();
                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.TryCompileUtf8);
                        _documentVersion = _parent.Version;
                        return result;
                    }
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AnOptionalObjectSpecifyingDebugOptions.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="AnOptionalObjectSpecifyingDebugOptions"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="AnOptionalObjectSpecifyingDebugOptions"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AnOptionalObjectSpecifyingDebugOptions Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<AnOptionalObjectSpecifyingDebugOptions>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="AnOptionalObjectSpecifyingDebugOptions"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AnOptionalObjectSpecifyingDebugOptions Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<AnOptionalObjectSpecifyingDebugOptions>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.AnOptionalObjectSpecifyingDebugOptions.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(AnOptionalObjectSpecifyingDebugOptions instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.AnOptionalObjectSpecifyingDebugOptions.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="AnOptionalObjectSpecifyingDebugOptions"/>.
                    /// </summary>
                    internal static void Create(
                        ref ComplexValueBuilder builder,
                        in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source find = default,
                        in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source output = default,
                        in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source tryCompile = default)
                    {
                    ...
                    public void Create(
                        ...
                        in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source tryCompile = default)
                    {
                        Create(ref _builder, find, output, tryCompile);
                    }
                ...
                /// <param name="tryCompile">The value of the property.</param>
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source find = default, in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source output = default, in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source tryCompile = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(find, output, tryCompile);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<AnOptionalObjectSpecifyingDebugOptions, Mutable>(this);
                }
            }
        }
    }
