    ...
    public readonly partial struct ConfigurePresetsItemsV1
    {
        ...
        public readonly partial struct AConfigurePresetObject
        {
            ...
            public readonly partial struct AnOptionalObjectSpecifyingDebugOptions
                ...
                : IJsonElement<AnOptionalObjectSpecifyingDebugOptions>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="AnOptionalObjectSpecifyingDebugOptions"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal AnOptionalObjectSpecifyingDebugOptions(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static AnOptionalObjectSpecifyingDebugOptions DefaultInstance { get; }
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean Find
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FindUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean Output
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OutputUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean TryCompile
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TryCompileUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in AnOptionalObjectSpecifyingDebugOptions left, in AnOptionalObjectSpecifyingDebugOptions right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in AnOptionalObjectSpecifyingDebugOptions left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(AnOptionalObjectSpecifyingDebugOptions instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AnOptionalObjectSpecifyingDebugOptions(JsonElement instance)
                {
                    return AnOptionalObjectSpecifyingDebugOptions.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AnOptionalObjectSpecifyingDebugOptions From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AnOptionalObjectSpecifyingDebugOptions ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AnOptionalObjectSpecifyingDebugOptions>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AnOptionalObjectSpecifyingDebugOptions ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AnOptionalObjectSpecifyingDebugOptions>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AnOptionalObjectSpecifyingDebugOptions ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AnOptionalObjectSpecifyingDebugOptions>(json, options);
                }
                ...
                /// </exception>
                public static AnOptionalObjectSpecifyingDebugOptions ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<AnOptionalObjectSpecifyingDebugOptions>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out AnOptionalObjectSpecifyingDebugOptions? result)
                {
                    return JsonElementHelpers.TryParseValue<AnOptionalObjectSpecifyingDebugOptions>(ref reader, out result);
                }
...
#if NET
                static AnOptionalObjectSpecifyingDebugOptions IJsonElement<AnOptionalObjectSpecifyingDebugOptions>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AnOptionalObjectSpecifyingDebugOptions: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public AnOptionalObjectSpecifyingDebugOptions Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public AnOptionalObjectSpecifyingDebugOptions Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<AnOptionalObjectSpecifyingDebugOptions>(_idx);
                    }
                ...
                public static class JsonPropertyNames
                {
                    ...
                    /// <summary>
                    /// Gets the JSON property name for <see cref="TryCompile"/>.
                    /// </summary>
                    public const string TryCompile = "tryCompile";
                    ...
                    /// Gets the JSON property name for <see cref="TryCompile"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> TryCompileUtf8 => "tryCompile"u8;
                }
                ...
                {
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="Find"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Find => "find"u8;
                    ...
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="TryCompile"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> TryCompile => "tryCompile"u8;
                }
            }
        }
    }
