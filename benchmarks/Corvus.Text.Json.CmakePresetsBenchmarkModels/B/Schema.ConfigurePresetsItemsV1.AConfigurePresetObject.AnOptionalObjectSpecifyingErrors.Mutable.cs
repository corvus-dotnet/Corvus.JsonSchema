        ...
        public readonly partial struct AConfigurePresetObject
        {
            ...
            public readonly partial struct AnOptionalObjectSpecifyingErrors
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Mutable Deprecated
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DeprecatedUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Mutable Dev
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DevUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetDeprecated(in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetDev(in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source value)
                    {
                        CheckValidInstance();
                        ...
                        {
                            // We are going to insert the new value
                            value.AddAsProperty(JsonPropertyNamesEscaped.Dev, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                            int endIndex = _idx + _parent.GetDbSize(_idx, false);
                            _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                        }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.AnOptionalObjectSpecifyingErrors.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.AnOptionalObjectSpecifyingErrors.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source deprecated = default,
                        in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source dev = default)
                    {
                        deprecated.AddAsProperty(JsonPropertyNamesEscaped.Deprecated, ref builder, escapeName: false);
                        dev.AddAsProperty(JsonPropertyNamesEscaped.Dev, ref builder, escapeName: false);
                    }

                    /// <summary>
                    /// Creates an instance of a <see cref="AnOptionalObjectSpecifyingErrors"/>.
                    /// </summary>
                    public void Create(in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source deprecated = default, in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source dev = default)
                    {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source deprecated = default, in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source dev = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
