    ...
    public readonly partial struct ConfigurePresetsItemsV1
    {
        ...
        public readonly partial struct AConfigurePresetObject
        {
            ...
            public readonly partial struct AnOptionalObjectSpecifyingErrors
                ...
                : IJsonElement<AnOptionalObjectSpecifyingErrors>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="AnOptionalObjectSpecifyingErrors"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal AnOptionalObjectSpecifyingErrors(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static AnOptionalObjectSpecifyingErrors DefaultInstance { get; }
                ...
                /// </returns>
                public static bool operator ==(in AnOptionalObjectSpecifyingErrors left, in AnOptionalObjectSpecifyingErrors right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in AnOptionalObjectSpecifyingErrors left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(AnOptionalObjectSpecifyingErrors instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AnOptionalObjectSpecifyingErrors(JsonElement instance)
                {
                    return AnOptionalObjectSpecifyingErrors.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AnOptionalObjectSpecifyingErrors From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AnOptionalObjectSpecifyingErrors ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AnOptionalObjectSpecifyingErrors>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AnOptionalObjectSpecifyingErrors ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AnOptionalObjectSpecifyingErrors>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AnOptionalObjectSpecifyingErrors ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AnOptionalObjectSpecifyingErrors>(json, options);
                }
                ...
                /// </exception>
                public static AnOptionalObjectSpecifyingErrors ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<AnOptionalObjectSpecifyingErrors>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out AnOptionalObjectSpecifyingErrors? result)
                {
                    return JsonElementHelpers.TryParseValue<AnOptionalObjectSpecifyingErrors>(ref reader, out result);
                }
...
#if NET
                static AnOptionalObjectSpecifyingErrors IJsonElement<AnOptionalObjectSpecifyingErrors>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AnOptionalObjectSpecifyingErrors: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public AnOptionalObjectSpecifyingErrors Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public AnOptionalObjectSpecifyingErrors Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<AnOptionalObjectSpecifyingErrors>(_idx);
                    }
