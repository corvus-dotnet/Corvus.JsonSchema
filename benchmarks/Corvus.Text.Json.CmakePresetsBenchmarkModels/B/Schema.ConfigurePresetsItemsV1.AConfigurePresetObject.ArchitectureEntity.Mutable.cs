    ...
    public readonly partial struct ConfigurePresetsItemsV1
    {
        ...
        public readonly partial struct AConfigurePresetObject
        {
            ...
            public readonly partial struct ArchitectureEntity
            {
                ...
                /// <returns>An instance of a mutable document initialized with the given value.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder(
                    JsonWorkspace workspace, scoped in Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity.AnyOf1Entity.Builder.Build value, int initialCapacity = 30)
                {
                    // Create the document builder without a MetadataDb
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
                    JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity.AnyOf1Entity.Builder.Build<TContext> value, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
