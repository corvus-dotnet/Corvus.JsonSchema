            ...
            public readonly partial struct CacheVariablesEntity
            {
                ...
                public readonly partial struct AdditionalPropertiesEntity
                {
                    ...
                    public readonly partial struct AnObjectRepresentingTheTypeAndValueOfTheVariable
                        ...
                        : IJsonElement<AnObjectRepresentingTheTypeAndValueOfTheVariable>,
                          IFormattable,
                          ISpanFormattable,
...
#endif
                    {
                        ...
                        /// <summary>
                        /// Initializes a new instance of the <see cref="AnObjectRepresentingTheTypeAndValueOfTheVariable"/> struct.
                        /// </summary>
                        /// <param name="value">The value from which to construct the instance.</param>
                        internal AnObjectRepresentingTheTypeAndValueOfTheVariable(IJsonDocument parent, int idx)
                        {
                            Debug.Assert(idx >= 0);
                            _parent = parent;
                            _idx = idx;
                        ...
                        /// </summary>
                        public static AnObjectRepresentingTheTypeAndValueOfTheVariable DefaultInstance { get; }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.CmakePresetsBenchmark.Baseline.JsonString Type
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonString value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.CacheVariablesEntity.AdditionalPropertiesEntity.AnObjectRepresentingTheTypeAndValueOfTheVariable.ValueEntity Value
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.CacheVariablesEntity.AdditionalPropertiesEntity.AnObjectRepresentingTheTypeAndValueOfTheVariable.ValueEntity value))
                                {
                                    return value;
                                }
                        ...
                        /// </returns>
                        public static bool operator ==(in AnObjectRepresentingTheTypeAndValueOfTheVariable left, in AnObjectRepresentingTheTypeAndValueOfTheVariable right)
                        {
                        ...
                        /// <c>True</c> if the values are equal.
                        /// </returns>
                        public static bool operator ==(in AnObjectRepresentingTheTypeAndValueOfTheVariable left, in JsonElement right)
                        {
                            return left.Equals(right);
                        }
                        ...
                        public static implicit operator JsonElement(AnObjectRepresentingTheTypeAndValueOfTheVariable instance)
                        {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator AnObjectRepresentingTheTypeAndValueOfTheVariable(JsonElement instance)
                        {
                            return AnObjectRepresentingTheTypeAndValueOfTheVariable.From(instance);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static AnObjectRepresentingTheTypeAndValueOfTheVariable From<T>(in T instance)
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static AnObjectRepresentingTheTypeAndValueOfTheVariable ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<AnObjectRepresentingTheTypeAndValueOfTheVariable>(utf8Json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static AnObjectRepresentingTheTypeAndValueOfTheVariable ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<AnObjectRepresentingTheTypeAndValueOfTheVariable>(json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static AnObjectRepresentingTheTypeAndValueOfTheVariable ParseValue(string json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<AnObjectRepresentingTheTypeAndValueOfTheVariable>(json, options);
                        }
                        ...
                        /// </exception>
                        public static AnObjectRepresentingTheTypeAndValueOfTheVariable ParseValue(ref Utf8JsonReader reader)
                        {
                            return JsonElementHelpers.ParseValue<AnObjectRepresentingTheTypeAndValueOfTheVariable>(ref reader);
                        }
                        ...
                        ///   A value could not be read from the reader.
                        /// </exception>
                        public static bool TryParseValue(ref Utf8JsonReader reader, out AnObjectRepresentingTheTypeAndValueOfTheVariable? result)
                        {
                            return JsonElementHelpers.TryParseValue<AnObjectRepresentingTheTypeAndValueOfTheVariable>(ref reader, out result);
                        }
...
#if NET
                        static AnObjectRepresentingTheTypeAndValueOfTheVariable IJsonElement<AnObjectRepresentingTheTypeAndValueOfTheVariable>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"AnObjectRepresentingTheTypeAndValueOfTheVariable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public AnObjectRepresentingTheTypeAndValueOfTheVariable Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public AnObjectRepresentingTheTypeAndValueOfTheVariable Freeze()
                        {
                            CheckValidInstance();
                            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                            {
                                return mutable.FreezeElement<AnObjectRepresentingTheTypeAndValueOfTheVariable>(_idx);
                            }
