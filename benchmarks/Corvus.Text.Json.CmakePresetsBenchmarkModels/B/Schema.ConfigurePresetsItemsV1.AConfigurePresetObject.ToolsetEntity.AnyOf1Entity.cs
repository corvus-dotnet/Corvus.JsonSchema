        ...
        public readonly partial struct AConfigurePresetObject
        {
            ...
            public readonly partial struct ToolsetEntity
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.StrategyEntity Strategy
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StrategyUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.StrategyEntity value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Baseline.JsonString Value
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonString value))
                            {
                                return value;
                            }
                    ...
                    {
                        /// <summary>
                        /// Gets the escaped UTF-8 JSON property name for <see cref="Strategy"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> Strategy => "strategy"u8;
