        ...
        public readonly partial struct AConfigurePresetObject
        {
            ...
            public readonly partial struct ToolsetEntity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Conversion to <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity"/>.
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static explicit operator Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Mutable(Mutable value)
                    {
                        return Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Mutable.From(value);
                    }

                    /// <summary>
                    /// Conversion from <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity"/>.
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator Mutable(Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Mutable value)
                    {
                        return From(value);
                    }
                    ...
                    public static explicit operator Mutable(ToolsetEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ToolsetEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ToolsetEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new ToolsetEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ToolsetEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="ToolsetEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="ToolsetEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ToolsetEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<ToolsetEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="ToolsetEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ToolsetEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ToolsetEntity>(_idx);
                    }
                    ...
                    /// <param name="matchAnyOf1Entity">Match a <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity"/>.</param>
                    ...
                    public TResult Match<TContext, TResult>(
                        ...
                        Matcher<Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity, TContext, TResult> matchAnyOf1Entity,
                        Matcher<Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
                    {
                        ...
                        if (Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchAnyOf1Entity(Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Mutable.From(this), context);
                        }
                    ...
                    public TResult Match<TResult>(
                        ...
                        Matcher<Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity, TResult> matchAnyOf1Entity,
                        Matcher<Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.Mutable, TResult> defaultMatch)
                    {
                        if (Corvus.CmakePresetsBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                        {
                        ...
                        if (Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchAnyOf1Entity(Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Mutable.From(this));
                        }
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsAnyOf1Entity(out Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity result)
                    {
                        if (Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Mutable.From(this);
                            return true;
                        }
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Builder.Build? _anyOf1EntityBuilderInstance;
                    ...
                    public Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Builder.Build value) {_anyOf1EntityBuilderInstance = value; _kind = Kind.AnyOf1EntityBuilder; }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity instance) => new(JsonElement.From(instance));
                    ...
                    internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
                    {
                        switch(_kind)
                        {
                            ...
                            case Kind.AnyOf1EntityBuilder:
                                valueBuilder.AddProperty(utf8Name, _anyOf1EntityBuilderInstance!, static (in b, ref o) => Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Builder.BuildValue(b, ref o), escapeName, nameRequiresUnescaping);
                                break;
                            default:
                    ...
                    internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
                    {
                        switch(_kind)
                        {
                            ...
                            case Kind.Utf16String:
                                ...
                                break;
                            case Kind.AnyOf1EntityBuilder:
                                valueBuilder.AddProperty(name, _anyOf1EntityBuilderInstance!, static (in b, ref o) => Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Builder.BuildValue(b, ref o));
                                break;
                            default:
                                Debug.Fail("Unexpected Kind");
                                break;
                    ...
                    internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
                    {
                        switch(_kind)
                        {
                            ...
                            case Kind.Utf16String:
                                ...
                                break;
                            case Kind.AnyOf1EntityBuilder:
                                valueBuilder.AddItem(_anyOf1EntityBuilderInstance!, static (in b, ref o) => Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Builder.BuildValue(b, ref o));
                                break;
                            default:
                                Debug.Fail("Unexpected Kind");
                                break;
                    ...
                    #endif
                {
                    ...
                    TContext _context;
                    Source _source;
                    private readonly Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Builder.Build<TContext>? _anyOf1EntityBuilderInstance;
                    ...
                    public Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Builder.Build<TContext> value) {_context = context; _anyOf1EntityBuilderInstance = value; _kind = Kind.AnyOf1EntityBuilder; }
                    ...
                    internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
                    {
                        switch(_kind)
                        {
                            ...
                            case Kind.Source:
                                ...
                                break;
                            case Kind.AnyOf1EntityBuilder:
                                valueBuilder.AddProperty(utf8Name, BuildWithContext.Create(_context, _anyOf1EntityBuilderInstance!), static (in b, ref o) => Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Builder.BuildValue(b.Context, b.Build, ref o), escapeName, nameRequiresUnescaping);
                                break;
                            default:
                                Debug.Fail("Unexpected Kind");
                                break;
                    ...
                    internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
                    {
                        switch(_kind)
                        {
                            ...
                            case Kind.Source:
                                ...
                                break;
                            case Kind.AnyOf1EntityBuilder:
                                valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _anyOf1EntityBuilderInstance!), static (in b, ref o) => Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Builder.BuildValue(b.Context, b.Build, ref o));
                                break;
                            default:
                                Debug.Fail("Unexpected Kind");
                                break;
                    ...
                    internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
                    {
                        switch(_kind)
                        {
                            ...
                            case Kind.Source:
                                ...
                                break;
                            case Kind.AnyOf1EntityBuilder:
                                valueBuilder.AddItem(BuildWithContext.Create(_context, _anyOf1EntityBuilderInstance!), static (in b, ref o) => Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Builder.BuildValue(b.Context, b.Build, ref o));
                                break;
                            default:
                                Debug.Fail("Unexpected Kind");
                                break;
                ...
                public static Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Source Build(
                    scoped in Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Builder.Build buildValue, int initialCapacity = 1)
                {
                    return new Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Source(buildValue);
                }
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Source<TContext> Build<TContext>(
                    scoped in TContext context, scoped in Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Builder.Build<TContext> buildValue, int initialCapacity = 1)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    return new Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Source<TContext>(context, buildValue);
                }
                ...
                /// <returns>An instance of a mutable document initialized with the given value.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder(
                    JsonWorkspace workspace, scoped in Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                {
                    // Create the document builder without a MetadataDb
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    var source = new Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Source(value);
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
                    JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    ...
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    var source = new Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Source<TContext>(context, value);
                    source.AddAsItem(ref cvb);
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<ToolsetEntity, Mutable>(this);
                }
            }
        }
    }
