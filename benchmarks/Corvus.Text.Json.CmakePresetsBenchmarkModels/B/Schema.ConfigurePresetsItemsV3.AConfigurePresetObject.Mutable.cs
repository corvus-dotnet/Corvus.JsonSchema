    ...
    public readonly partial struct ConfigurePresetsItemsV3
    {
        ...
        public readonly partial struct AConfigurePresetObject
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Baseline.JsonString.Mutable InstallDir
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InstallDirUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Baseline.JsonString.Mutable ToolchainFile
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ToolchainFileUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetInstallDir(in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetToolchainFile(in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV3.AConfigurePresetObject.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV3.AConfigurePresetObject.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source installDir = default,
                    in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source toolchainFile = default)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source binaryDir = default, in Corvus.CmakePresetsBenchmark.Baseline.Schema.TopCondition.Source condition = default, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source generator = default, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source installDir = default, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source toolchainFile = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source binaryDir = default, in Corvus.CmakePresetsBenchmark.Baseline.Schema.TopCondition.Source<TContext> condition = default, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source generator = default, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source installDir = default, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source toolchainFile = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
