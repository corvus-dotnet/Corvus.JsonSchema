...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ConfigurePresetsItemsV3
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.CmakePresetsBenchmark.Baseline.JsonString InstallDir
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InstallDirUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CmakePresetsBenchmark.Baseline.JsonString ToolchainFile
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ToolchainFileUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonString value))
                    {
                        return value;
                    }
