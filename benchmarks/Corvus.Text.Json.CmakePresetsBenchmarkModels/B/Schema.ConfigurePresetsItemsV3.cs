...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV3.AConfigurePresetObject this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV3.AConfigurePresetObject>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV3.AConfigurePresetObject> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV3.AConfigurePresetObject>(_parent, _idx);
        }
