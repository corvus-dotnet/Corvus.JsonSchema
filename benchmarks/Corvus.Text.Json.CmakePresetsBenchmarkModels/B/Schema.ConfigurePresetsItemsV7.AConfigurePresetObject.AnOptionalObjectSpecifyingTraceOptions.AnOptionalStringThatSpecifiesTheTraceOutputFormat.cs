    ...
    public readonly partial struct ConfigurePresetsItemsV7
    {
        ...
        public readonly partial struct AConfigurePresetObject
        {
            ...
            public readonly partial struct AnOptionalObjectSpecifyingTraceOptions
            {
                ...
                public readonly partial struct AnOptionalStringThatSpecifiesTheTraceOutputFormat
#if NET8_0_OR_GREATER
                    : IJsonElement<AnOptionalStringThatSpecifiesTheTraceOutputFormat>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="AnOptionalStringThatSpecifiesTheTraceOutputFormat"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal AnOptionalStringThatSpecifiesTheTraceOutputFormat(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static AnOptionalStringThatSpecifiesTheTraceOutputFormat DefaultInstance { get; }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator string(AnOptionalStringThatSpecifiesTheTraceOutputFormat value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                    ...
                    /// </returns>
                    public static bool operator ==(in AnOptionalStringThatSpecifiesTheTraceOutputFormat left, in AnOptionalStringThatSpecifiesTheTraceOutputFormat right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in AnOptionalStringThatSpecifiesTheTraceOutputFormat left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(AnOptionalStringThatSpecifiesTheTraceOutputFormat instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AnOptionalStringThatSpecifiesTheTraceOutputFormat(JsonElement instance)
                    {
                        return AnOptionalStringThatSpecifiesTheTraceOutputFormat.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AnOptionalStringThatSpecifiesTheTraceOutputFormat From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AnOptionalStringThatSpecifiesTheTraceOutputFormat ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<AnOptionalStringThatSpecifiesTheTraceOutputFormat>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AnOptionalStringThatSpecifiesTheTraceOutputFormat ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<AnOptionalStringThatSpecifiesTheTraceOutputFormat>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AnOptionalStringThatSpecifiesTheTraceOutputFormat ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<AnOptionalStringThatSpecifiesTheTraceOutputFormat>(json, options);
                    }
                    ...
                    /// </exception>
                    public static AnOptionalStringThatSpecifiesTheTraceOutputFormat ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<AnOptionalStringThatSpecifiesTheTraceOutputFormat>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out AnOptionalStringThatSpecifiesTheTraceOutputFormat? result)
                    {
                        return JsonElementHelpers.TryParseValue<AnOptionalStringThatSpecifiesTheTraceOutputFormat>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new AnOptionalStringThatSpecifiesTheTraceOutputFormat(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static AnOptionalStringThatSpecifiesTheTraceOutputFormat IJsonElement<AnOptionalStringThatSpecifiesTheTraceOutputFormat>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AnOptionalStringThatSpecifiesTheTraceOutputFormat: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="AnOptionalStringThatSpecifiesTheTraceOutputFormat"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="AnOptionalStringThatSpecifiesTheTraceOutputFormat"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public AnOptionalStringThatSpecifiesTheTraceOutputFormat Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<AnOptionalStringThatSpecifiesTheTraceOutputFormat>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="AnOptionalStringThatSpecifiesTheTraceOutputFormat"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public AnOptionalStringThatSpecifiesTheTraceOutputFormat Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<AnOptionalStringThatSpecifiesTheTraceOutputFormat>(_idx);
                        }
                    ...
                    /// <param name="matchHuman">Match 1st item.</param>
                    /// <param name="matchJsonV1">Match 2nd item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchHuman,
                        Func<TContext, TResult> matchJsonV1,
...
#endif
                    {
                        ...
                        {
                            return matchHuman(context);
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchJsonV1(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> matchHuman,
                        Func<TResult> matchJsonV1,
