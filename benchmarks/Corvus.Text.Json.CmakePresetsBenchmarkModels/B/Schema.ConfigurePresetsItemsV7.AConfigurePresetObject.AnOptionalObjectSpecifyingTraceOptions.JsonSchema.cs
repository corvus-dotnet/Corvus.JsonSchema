        ...
        public readonly partial struct AConfigurePresetObject
        {
                ...
                : IJsonElement<AnOptionalObjectSpecifyingTraceOptions>
            {
                public static partial class JsonSchema
                {
                    ...
                    private static readonly JsonSchemaPathProvider SourceValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/source"u8, buffer, out written);
                    ...
                    private static void MatchFormat(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        ...
                        JsonSchemaContext childContext =
                            Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV7.AConfigurePresetObject.AnOptionalObjectSpecifyingTraceOptions.AnOptionalStringThatSpecifiesTheTraceOutputFormat.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                        ...
                        Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV7.AConfigurePresetObject.AnOptionalObjectSpecifyingTraceOptions.AnOptionalStringThatSpecifiesTheTraceOutputFormat.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    ...
                    private static void MatchMode(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        ...
                        JsonSchemaContext childContext1 =
                            Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV7.AConfigurePresetObject.AnOptionalObjectSpecifyingTraceOptions.AnOptionalStringThatSpecifiesTheTraceMode.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                        ...
                        Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV7.AConfigurePresetObject.AnOptionalObjectSpecifyingTraceOptions.AnOptionalStringThatSpecifiesTheTraceMode.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                    ...
                    private static void MatchSourceValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                        JsonSchemaContext childContext3 =
                            Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV7.AConfigurePresetObject.AnOptionalObjectSpecifyingTraceOptions.SourceEntity.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.SourceValueUtf8,
                                evaluationPath: SourceValueSchemaEvaluationPath);

                        Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV7.AConfigurePresetObject.AnOptionalObjectSpecifyingTraceOptions.SourceEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
                    ...
                    private static PropertySchemaMatchers<Corvus.CmakePresetsBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                    {
                        return new PropertySchemaMatchers<Corvus.CmakePresetsBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator1>([
                            ...
                            (static () => JsonPropertyNames.SourceValueUtf8, MatchSourceValue),
                        ]);
                    }
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("cmake-presets-schema.json#/definitions/configurePresetsItemsV7/items/properties/trace"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "cmake-presets-schema.json#/definitions/configurePresetsItemsV7/items/properties/trace";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "cmake-presets-schema.json#/definitions/configurePresetsItemsV7/items/properties/trace"u8;
