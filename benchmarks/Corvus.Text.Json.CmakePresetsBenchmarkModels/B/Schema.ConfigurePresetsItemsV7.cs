...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigurePresetsItemsV7"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ConfigurePresetsItemsV7(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ConfigurePresetsItemsV7 DefaultInstance { get; }
        ...
        public Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV7.AConfigurePresetObject this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV7.AConfigurePresetObject>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV7.AConfigurePresetObject> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV7.AConfigurePresetObject>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in ConfigurePresetsItemsV7 left, in ConfigurePresetsItemsV7 right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ConfigurePresetsItemsV7 left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ConfigurePresetsItemsV7 instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ConfigurePresetsItemsV7(JsonElement instance)
        {
            return ConfigurePresetsItemsV7.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfigurePresetsItemsV7 From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfigurePresetsItemsV7 ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ConfigurePresetsItemsV7>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfigurePresetsItemsV7 ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ConfigurePresetsItemsV7>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfigurePresetsItemsV7 ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ConfigurePresetsItemsV7>(json, options);
        }
        ...
        /// </exception>
        public static ConfigurePresetsItemsV7 ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ConfigurePresetsItemsV7>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ConfigurePresetsItemsV7? result)
        {
            return JsonElementHelpers.TryParseValue<ConfigurePresetsItemsV7>(ref reader, out result);
        }
...
#if NET
        static ConfigurePresetsItemsV7 IJsonElement<ConfigurePresetsItemsV7>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ConfigurePresetsItemsV7: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public ConfigurePresetsItemsV7 Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public ConfigurePresetsItemsV7 Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ConfigurePresetsItemsV7>(_idx);
            }
