    ...
    public readonly partial struct ConfigurePresetsV3
    {
...
#endif
        {
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsV3.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsV3.Mutable, TResult> defaultMatch)
            {
                if (Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.JsonSchema.Evaluate(_parent, _idx))
                {
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsV3.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsV3.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
