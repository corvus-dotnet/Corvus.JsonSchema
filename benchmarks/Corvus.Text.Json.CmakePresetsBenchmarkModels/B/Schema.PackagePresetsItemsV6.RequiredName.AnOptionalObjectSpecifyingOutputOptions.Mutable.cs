        ...
        public readonly partial struct RequiredName
        {
            ...
            public readonly partial struct AnOptionalObjectSpecifyingOutputOptions
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Mutable DebugValue
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DebugValueUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Mutable Verbose
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VerboseUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetDebugValue(in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetVerbose(in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source value)
                    {
                        CheckValidInstance();
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.PackagePresetsItemsV6.RequiredName.AnOptionalObjectSpecifyingOutputOptions.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.PackagePresetsItemsV6.RequiredName.AnOptionalObjectSpecifyingOutputOptions.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source debug = default,
                        in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source verbose = default)
                    {
                    ...
                    /// Creates an instance of a <see cref="AnOptionalObjectSpecifyingOutputOptions"/>.
                    /// </summary>
                    public void Create(in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source debug = default, in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source verbose = default)
                    {
                        Create(ref _builder, debug, verbose);
                    }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source debug = default, in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source verbose = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(debug, verbose);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
