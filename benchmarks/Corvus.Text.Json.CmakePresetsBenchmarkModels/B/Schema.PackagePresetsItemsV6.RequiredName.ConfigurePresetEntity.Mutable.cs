        ...
        public readonly partial struct RequiredName
        {
            ...
            public readonly partial struct ConfigurePresetEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ConfigurePresetEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ConfigurePresetEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ConfigurePresetEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ConfigurePresetEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ConfigurePresetEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ConfigurePresetEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ConfigurePresetEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ConfigurePresetEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ConfigurePresetEntity, Mutable>(this);
                }
            }
        }
    }
