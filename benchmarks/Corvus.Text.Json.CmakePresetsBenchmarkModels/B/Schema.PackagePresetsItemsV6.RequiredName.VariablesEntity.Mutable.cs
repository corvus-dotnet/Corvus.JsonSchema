        ...
        public readonly partial struct RequiredName
        {
            ...
            public readonly partial struct VariablesEntity
            {
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.PackagePresetsItemsV6.RequiredName.VariablesEntity.ObjectBuilder.Build value) {_objectBuilder = value; _kind = Kind.ObjectBuilder; }

                    internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.PackagePresetsItemsV6.RequiredName.VariablesEntity.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.PackagePresetsItemsV6.RequiredName.VariablesEntity.ObjectBuilder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.ObjectBuilder; }

                    internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.PackagePresetsItemsV6.RequiredName.VariablesEntity.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }
