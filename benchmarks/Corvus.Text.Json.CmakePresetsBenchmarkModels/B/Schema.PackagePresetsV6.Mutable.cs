...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PackagePresetsV6
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.PackagePresetsItemsV6"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Corvus.CmakePresetsBenchmark.Baseline.Schema.PackagePresetsItemsV6.Mutable(Mutable value)
            {
                return Corvus.CmakePresetsBenchmark.Baseline.Schema.PackagePresetsItemsV6.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.PackagePresetsItemsV6"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Mutable(Corvus.CmakePresetsBenchmark.Baseline.Schema.PackagePresetsItemsV6.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(PackagePresetsV6 instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PackagePresetsV6"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PackagePresetsV6(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PackagePresetsV6(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PackagePresetsV6.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// <summary>
            /// Gets a <see cref="PackagePresetsV6"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="PackagePresetsV6"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly PackagePresetsV6 Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<PackagePresetsV6>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="PackagePresetsV6"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly PackagePresetsV6 Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PackagePresetsV6>(_idx);
            }

            /// <summary>
            /// Gets the value as a <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.PackagePresetsItemsV6" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsPackagePresetsItemsV6(out Corvus.CmakePresetsBenchmark.Baseline.Schema.PackagePresetsItemsV6 result)
            {
                if (Corvus.CmakePresetsBenchmark.Baseline.Schema.PackagePresetsItemsV6.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CmakePresetsBenchmark.Baseline.Schema.PackagePresetsItemsV6.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.PackagePresetsV6.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(PackagePresetsV6 instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.PackagePresetsV6.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<PackagePresetsV6, Mutable>(this);
        }
    }
}
