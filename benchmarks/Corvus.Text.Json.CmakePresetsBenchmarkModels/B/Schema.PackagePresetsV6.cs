...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public static implicit operator Corvus.CmakePresetsBenchmark.Baseline.Schema.PackagePresetsItemsV6(PackagePresetsV6 value)
        {
            return Corvus.CmakePresetsBenchmark.Baseline.Schema.PackagePresetsItemsV6.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator PackagePresetsV6(Corvus.CmakePresetsBenchmark.Baseline.Schema.PackagePresetsItemsV6 value)
        {
            return From(value);
        }
        ...
        public bool TryGetAsPackagePresetsItemsV6(out Corvus.CmakePresetsBenchmark.Baseline.Schema.PackagePresetsItemsV6 result)
        {
            ...
            {
                result = Corvus.CmakePresetsBenchmark.Baseline.Schema.PackagePresetsItemsV6.From(this);
                return true;
            }
