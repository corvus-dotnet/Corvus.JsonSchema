                ...
                public readonly partial struct AnOptionalObjectSpecifyingWhichTestsToExclude
                {
                    ...
                    public readonly partial struct FixturesEntity
                    {
...
#endif
                        {
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.CmakePresetsBenchmark.Baseline.JsonString.Mutable Any
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AnyUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonString.Mutable value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.CmakePresetsBenchmark.Baseline.JsonString.Mutable Cleanup
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CleanupUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonString.Mutable value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.CmakePresetsBenchmark.Baseline.JsonString.Mutable Setup
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SetupUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonString.Mutable value))
                                    {
                                        return value;
                                    }
                            ...
                            public void SetAny(in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source value)
                            {
                                CheckValidInstance();
                            ...
                            /// </summary>
                            /// <param name="value">The value of the property to add.</param>
                            public void SetCleanup(in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source value)
                            {
                                CheckValidInstance();
                            ...
                            /// </summary>
                            /// <param name="value">The value of the property to add.</param>
                            public void SetSetup(in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source value)
                            {
                                CheckValidInstance();
                        ...
                        public ref struct Source
                        {
                            ...
                            internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToExclude.FixturesEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        public ref struct Builder
                        {
                            ...
                            internal static void Create(
                                ...
                                in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source any = default,
                                in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source cleanup = default,
                                in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source setup = default)
                            {
                        ...
                        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source any = default, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source cleanup = default, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source setup = default, int initialCapacity = 30)
                        {
                            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                            cvb.StartObject();
