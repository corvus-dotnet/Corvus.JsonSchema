            ...
            public readonly partial struct AnOptionalObjectSpecifyingHowToFilterTheTestsToRun
            {
                ...
                public readonly partial struct AnOptionalObjectSpecifyingWhichTestsToExclude
                {
...
#endif
                    {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.CmakePresetsBenchmark.Baseline.JsonString Any
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AnyUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonString value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.CmakePresetsBenchmark.Baseline.JsonString Cleanup
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CleanupUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonString value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.CmakePresetsBenchmark.Baseline.JsonString Setup
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SetupUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonString value))
                                {
                                    return value;
                                }
