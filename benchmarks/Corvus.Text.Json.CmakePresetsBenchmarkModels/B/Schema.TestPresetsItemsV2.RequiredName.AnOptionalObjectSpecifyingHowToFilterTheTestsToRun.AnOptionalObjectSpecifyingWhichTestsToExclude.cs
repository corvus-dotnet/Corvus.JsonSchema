        ...
        public readonly partial struct RequiredName
        {
            ...
            public readonly partial struct AnOptionalObjectSpecifyingHowToFilterTheTestsToRun
            {
                ...
                public readonly partial struct AnOptionalObjectSpecifyingWhichTestsToExclude
                    ...
                    : IJsonElement<AnOptionalObjectSpecifyingWhichTestsToExclude>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="AnOptionalObjectSpecifyingWhichTestsToExclude"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal AnOptionalObjectSpecifyingWhichTestsToExclude(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static AnOptionalObjectSpecifyingWhichTestsToExclude DefaultInstance { get; }
                    ...
                    /// <summary>
                    /// Gets the (optional) <c>fixtures</c> property.
                    /// </summary>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToExclude.FixturesEntity Fixtures
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FixturesUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToExclude.FixturesEntity value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Baseline.JsonString Label
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LabelUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonString value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Baseline.JsonString Name
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonString value))
                            {
                                return value;
                            }
                    ...
                    /// </returns>
                    public static bool operator ==(in AnOptionalObjectSpecifyingWhichTestsToExclude left, in AnOptionalObjectSpecifyingWhichTestsToExclude right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in AnOptionalObjectSpecifyingWhichTestsToExclude left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(AnOptionalObjectSpecifyingWhichTestsToExclude instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AnOptionalObjectSpecifyingWhichTestsToExclude(JsonElement instance)
                    {
                        return AnOptionalObjectSpecifyingWhichTestsToExclude.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AnOptionalObjectSpecifyingWhichTestsToExclude From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AnOptionalObjectSpecifyingWhichTestsToExclude ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<AnOptionalObjectSpecifyingWhichTestsToExclude>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AnOptionalObjectSpecifyingWhichTestsToExclude ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<AnOptionalObjectSpecifyingWhichTestsToExclude>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AnOptionalObjectSpecifyingWhichTestsToExclude ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<AnOptionalObjectSpecifyingWhichTestsToExclude>(json, options);
                    }
                    ...
                    /// </exception>
                    public static AnOptionalObjectSpecifyingWhichTestsToExclude ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<AnOptionalObjectSpecifyingWhichTestsToExclude>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out AnOptionalObjectSpecifyingWhichTestsToExclude? result)
                    {
                        return JsonElementHelpers.TryParseValue<AnOptionalObjectSpecifyingWhichTestsToExclude>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new AnOptionalObjectSpecifyingWhichTestsToExclude(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static AnOptionalObjectSpecifyingWhichTestsToExclude IJsonElement<AnOptionalObjectSpecifyingWhichTestsToExclude>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AnOptionalObjectSpecifyingWhichTestsToExclude: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="AnOptionalObjectSpecifyingWhichTestsToExclude"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="AnOptionalObjectSpecifyingWhichTestsToExclude"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public AnOptionalObjectSpecifyingWhichTestsToExclude Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<AnOptionalObjectSpecifyingWhichTestsToExclude>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="AnOptionalObjectSpecifyingWhichTestsToExclude"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public AnOptionalObjectSpecifyingWhichTestsToExclude Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<AnOptionalObjectSpecifyingWhichTestsToExclude>(_idx);
                        }
                    ...
                    {
                        /// <summary>
                        /// Gets the JSON property name for <see cref="Fixtures"/>.
                        /// </summary>
                        ...
                        /// Gets the JSON property name for <see cref="Fixtures"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> FixturesUtf8 => "fixtures"u8;
                    ...
                    {
                        /// <summary>
                        /// Gets the escaped UTF-8 JSON property name for <see cref="Fixtures"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> Fixtures => "fixtures"u8;
