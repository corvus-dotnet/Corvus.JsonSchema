            ...
            public readonly partial struct AnOptionalObjectSpecifyingHowToFilterTheTestsToRun
            {
                ...
                public readonly partial struct AnOptionalObjectSpecifyingWhichTestsToInclude
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(AnOptionalObjectSpecifyingWhichTestsToInclude instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="AnOptionalObjectSpecifyingWhichTestsToInclude"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator AnOptionalObjectSpecifyingWhichTestsToInclude(Mutable instance)
                        {
                        ...
                        /// </summary>
                        public Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity.Mutable Index
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IndexUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.CmakePresetsBenchmark.Baseline.JsonString.Mutable Label
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LabelUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonString.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.CmakePresetsBenchmark.Baseline.JsonString.Mutable Name
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonString.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// <summary>
                        /// Gets the (optional) <c>useUnion</c> property.
                        /// </summary>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Mutable UseUnion
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UseUnionUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new AnOptionalObjectSpecifyingWhichTestsToInclude(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        public void SetIndex(in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity.Source value)
                        {
                            CheckValidInstance();
                            ...
                            else
                            {
                                ...
                                value.AddAsProperty(JsonPropertyNamesEscaped.Index, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetIndex<TContext>(in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity.Source<TContext> value)
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetLabel(in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source value)
                        {
                            CheckValidInstance();
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetName(in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source value)
                        {
                            CheckValidInstance();
                        ...
                        /// <summary>
                        /// Set the <c>useUnion</c> property.
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetUseUnion(in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source value)
                        {
                            CheckValidInstance();

                            if (value.IsUndefined)
                            {
                                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.UseUnionUtf8);
                                _documentVersion = _parent.Version;
                                return;
                            }

                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UseUnionUtf8, out IJsonDocument? elementParent, out int elementIdx))
                            {
                                // We are going to replace just the value
                                value.AddAsItem(ref cvb);
                                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                            ...
                            {
                                // We are going to insert the new value
                                value.AddAsProperty(JsonPropertyNamesEscaped.UseUnion, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                            }
                        ...
                        /// <summary>
                        /// Remove the <c>useUnion</c> property, if present.
                        /// </summary>
                        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                        public bool RemoveUseUnion()
                        {
                            CheckValidInstance();
                            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.UseUnionUtf8);
                            _documentVersion = _parent.Version;
                            return result;
                        }
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"AnOptionalObjectSpecifyingWhichTestsToInclude.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="AnOptionalObjectSpecifyingWhichTestsToInclude"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="AnOptionalObjectSpecifyingWhichTestsToInclude"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly AnOptionalObjectSpecifyingWhichTestsToInclude Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<AnOptionalObjectSpecifyingWhichTestsToInclude>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="AnOptionalObjectSpecifyingWhichTestsToInclude"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly AnOptionalObjectSpecifyingWhichTestsToInclude Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<AnOptionalObjectSpecifyingWhichTestsToInclude>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                        public static implicit operator Source(AnOptionalObjectSpecifyingWhichTestsToInclude instance) => new(JsonElement.From(instance));
                    ...
                    public ref struct Builder
                    {
                        ...
                        /// <summary>
                        /// Creates an instance of a <see cref="AnOptionalObjectSpecifyingWhichTestsToInclude"/>.
                        /// </summary>
                        internal static void Create(
                            ref ComplexValueBuilder builder,
                            in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity.Source index = default,
                            in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source label = default,
                            in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source name = default,
                            in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source useUnion = default)
                        {
                            index.AddAsProperty(JsonPropertyNamesEscaped.Index, ref builder, escapeName: false);
                            ...
                            useUnion.AddAsProperty(JsonPropertyNamesEscaped.UseUnion, ref builder, escapeName: false);
                        }
                        ...
                        public void Create(
                            ...
                            in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source useUnion = default)
                        {
                            Create(ref _builder, index, label, name, useUnion);
                        }
                        ...
                        internal static void Create<TContext>(
                            in TContext context,
                            ref ComplexValueBuilder builder,
                            in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity.Source<TContext> index = default,
                            in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source label = default,
                            in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source name = default,
                            in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source useUnion = default)
                        #if NET9_0_OR_GREATER
                        ...
                        #endif
                        {
                            Create(context, ref _builder, index, label, name, useUnion);
                        }
                    ...
                    /// <param name="useUnion">The value of the property.</param>
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity.Source index = default, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source label = default, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source name = default, in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source useUnion = default, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(index, label, name, useUnion);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity.Source<TContext> index = default, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source label = default, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source name = default, in Corvus.CmakePresetsBenchmark.Baseline.JsonBoolean.Source useUnion = default, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                        ...
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(context, index, label, name, useUnion);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    {
                        return workspace.CreateBuilder<AnOptionalObjectSpecifyingWhichTestsToInclude, Mutable>(this);
                    }
                }
            }
        }
