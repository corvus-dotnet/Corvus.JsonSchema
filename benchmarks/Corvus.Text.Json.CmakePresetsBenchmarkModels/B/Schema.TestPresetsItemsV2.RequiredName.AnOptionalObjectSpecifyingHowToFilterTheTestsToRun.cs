    ...
    public readonly partial struct TestPresetsItemsV2
    {
        ...
        public readonly partial struct RequiredName
        {
            ...
            public readonly partial struct AnOptionalObjectSpecifyingHowToFilterTheTestsToRun
                ...
                : IJsonElement<AnOptionalObjectSpecifyingHowToFilterTheTestsToRun>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="AnOptionalObjectSpecifyingHowToFilterTheTestsToRun"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal AnOptionalObjectSpecifyingHowToFilterTheTestsToRun(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static AnOptionalObjectSpecifyingHowToFilterTheTestsToRun DefaultInstance { get; }
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToExclude Exclude
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludeUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToExclude value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude Include
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in AnOptionalObjectSpecifyingHowToFilterTheTestsToRun left, in AnOptionalObjectSpecifyingHowToFilterTheTestsToRun right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in AnOptionalObjectSpecifyingHowToFilterTheTestsToRun left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(AnOptionalObjectSpecifyingHowToFilterTheTestsToRun instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AnOptionalObjectSpecifyingHowToFilterTheTestsToRun(JsonElement instance)
                {
                    return AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AnOptionalObjectSpecifyingHowToFilterTheTestsToRun From<T>(in T instance)
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out AnOptionalObjectSpecifyingHowToFilterTheTestsToRun? result)
                {
                    return JsonElementHelpers.TryParseValue<AnOptionalObjectSpecifyingHowToFilterTheTestsToRun>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new AnOptionalObjectSpecifyingHowToFilterTheTestsToRun(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static AnOptionalObjectSpecifyingHowToFilterTheTestsToRun IJsonElement<AnOptionalObjectSpecifyingHowToFilterTheTestsToRun>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AnOptionalObjectSpecifyingHowToFilterTheTestsToRun: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="AnOptionalObjectSpecifyingHowToFilterTheTestsToRun"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="AnOptionalObjectSpecifyingHowToFilterTheTestsToRun"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public AnOptionalObjectSpecifyingHowToFilterTheTestsToRun Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<AnOptionalObjectSpecifyingHowToFilterTheTestsToRun>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="AnOptionalObjectSpecifyingHowToFilterTheTestsToRun"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public AnOptionalObjectSpecifyingHowToFilterTheTestsToRun Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<AnOptionalObjectSpecifyingHowToFilterTheTestsToRun>(_idx);
                    }
