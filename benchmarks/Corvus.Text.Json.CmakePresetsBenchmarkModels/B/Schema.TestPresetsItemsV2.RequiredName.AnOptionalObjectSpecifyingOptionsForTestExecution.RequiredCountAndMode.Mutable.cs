            ...
            public readonly partial struct AnOptionalObjectSpecifyingOptionsForTestExecution
            {
                ...
                public readonly partial struct RequiredCountAndMode
                {
...
#endif
                    {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.CmakePresetsBenchmark.Baseline.JsonInteger.Mutable Count
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CountUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonInteger.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingOptionsForTestExecution.RequiredCountAndMode.ModeEntity.Mutable Mode
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ModeUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingOptionsForTestExecution.RequiredCountAndMode.ModeEntity.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        public void SetCount(in Corvus.CmakePresetsBenchmark.Baseline.JsonInteger.Source value)
                        {
                            CheckValidInstance();
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetMode(in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingOptionsForTestExecution.RequiredCountAndMode.ModeEntity.Source value)
                        {
                            CheckValidInstance();
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingOptionsForTestExecution.RequiredCountAndMode.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingOptionsForTestExecution.RequiredCountAndMode.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        internal static void Create(
                            ...
                            in Corvus.CmakePresetsBenchmark.Baseline.JsonInteger.Source count,
                            in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingOptionsForTestExecution.RequiredCountAndMode.ModeEntity.Source mode)
                        {
                        ...
                        /// Creates an instance of a <see cref="RequiredCountAndMode"/>.
                        /// </summary>
                        public void Create(in Corvus.CmakePresetsBenchmark.Baseline.JsonInteger.Source count, in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingOptionsForTestExecution.RequiredCountAndMode.ModeEntity.Source mode)
                        {
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Baseline.JsonInteger.Source count, in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingOptionsForTestExecution.RequiredCountAndMode.ModeEntity.Source mode, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
