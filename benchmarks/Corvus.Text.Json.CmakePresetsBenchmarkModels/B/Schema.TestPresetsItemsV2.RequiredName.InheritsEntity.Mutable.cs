        ...
        public readonly partial struct RequiredName
        {
            ...
            public readonly partial struct InheritsEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.AnyOf0Entity.Mutable(Mutable value)
                    {
                        return Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.AnyOf0Entity.Mutable.From(value);
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator Mutable(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.AnyOf0Entity.Mutable value)
                    {
                        return From(value);
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static explicit operator Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Mutable(Mutable value)
                    {
                        return Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Mutable.From(value);
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator Mutable(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Mutable value)
                    {
                        return From(value);
                    }
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly InheritsEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly InheritsEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<InheritsEntity>(_idx);
                    }
                    ...
                    public TResult Match<TContext, TResult>(
                        ...
                        Matcher<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                    {
                        ...
                        {
                            return matchAnyOf0Entity(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.AnyOf0Entity.Mutable.From(this), context);
                        }
                        ...
                        {
                            return matchType1EntityArray(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Mutable.From(this), context);
                        }
                    ...
                    public TResult Match<TResult>(
                        ...
                        Matcher<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Mutable, TResult> defaultMatch)
                    {
                        if (Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchAnyOf0Entity(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.AnyOf0Entity.Mutable.From(this));
                        }

                        if (Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchType1EntityArray(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Mutable.From(this));
                        }
                    ...
                    public bool TryGetAsAnyOf0Entity(out Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.AnyOf0Entity result)
                    {
                        if (Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.AnyOf0Entity.Mutable.From(this);
                            return true;
                        }
                    ...
                    public bool TryGetAsType1EntityArray(out Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray result)
                    {
                        if (Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Mutable.From(this);
                            return true;
                        }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.AnyOf0Entity instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
