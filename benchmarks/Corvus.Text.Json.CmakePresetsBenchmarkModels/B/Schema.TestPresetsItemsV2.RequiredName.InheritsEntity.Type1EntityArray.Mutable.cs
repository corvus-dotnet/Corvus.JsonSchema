    ...
    public readonly partial struct TestPresetsItemsV2
    {
        ...
        public readonly partial struct RequiredName
        {
            ...
            public readonly partial struct InheritsEntity
            {
                ...
                /// <remarks>
                /// <para>
                /// An optional array of strings representing the names of test presets to inherit from. The preset will inherit all of the fields from the inherits presets by default (except name, hidden, inherits, description, and displayName), but can override them as desired. If multiple inherits presets provide conflicting values for the same field, the earlier preset in the inherits list will be preferred. Presets in CMakePresets.json must not inherit from presets in CMakeUserPresets.json.
                /// </para>
                /// </remarks>
                ...
                public readonly partial struct Type1EntityArray
                {
...
#endif
                    {
                        ...
                        public Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Type1Entity.Mutable this[int index]
                        {
                            get
                            {
                                CheckValidInstance();
                                return _parent.GetArrayIndexElement<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Type1Entity.Mutable>(_idx, index);
                            }
                        }
                        ...
                        /// </summary>
                        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                        public ArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Type1Entity.Mutable> EnumerateArray()
                        {
                            CheckValidInstance();
                            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Type1Entity.Mutable>(_parent, _idx);
                        }
                        ...
                        /// </remarks>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public void SetItem(int itemIndex, in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Type1Entity.Source value)
                        {
                            CheckValidInstance();
                        ...
                        /// </remarks>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public void InsertItem(int itemIndex, in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Type1Entity.Source value)
                        {
                            CheckValidInstance();
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public void AddItem(in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Type1Entity.Source value)
                        {
                        ...
                        ///   The parent <see cref="JsonDocument"/> has been disposed.
                        /// </exception>
                        public bool Remove(in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Type1Entity item)
                        {
                            CheckValidInstance();
                            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Type1Entity>(this, in item))
                            {
                                return false;
                            }
                        ...
                        /// </remarks>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public void RemoveWhere(JsonPredicate<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Type1Entity> predicate)
                        {
                            CheckValidInstance();
                            JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Type1Entity>(this, predicate);
                            _documentVersion = _parent.Version;
                        }
                        ...
                        ///   The parent <see cref="JsonDocument"/> has been disposed.
                        /// </exception>
                        public bool Replace(in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Type1Entity oldItem, in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Type1Entity.Source newItem)
                        {
                            CheckValidInstance();
                            ...
                            var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Type1Entity>(_parent, _idx);

                            while (enumerator.MoveNext())
                            {
                                Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Type1Entity current = enumerator.Current;
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.InheritsEntity.Type1EntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
