                        ...
                        public readonly partial struct AnOptionalObjectSpecifyingTestsToIncludeByTestIndex
                        {
...
#endif
                            {
                                ...
                                public bool TryGetNumericValues(Span<long> items, out int written)
                                {
                                    CheckValidInstance();
                                    written = 0;
                                    foreach (Corvus.CmakePresetsBenchmark.Baseline.JsonInteger item in EnumerateArray())
                                    {
                                ...
                                public Corvus.CmakePresetsBenchmark.Baseline.JsonInteger this[int index]
                                {
                                    get
                                    {
                                        CheckValidInstance();
                                        return _parent.GetArrayIndexElement<Corvus.CmakePresetsBenchmark.Baseline.JsonInteger>(_idx, index);
                                    }
                                }
                                ...
                                /// </summary>
                                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                                public ArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.JsonInteger> EnumerateArray()
                                {
                                    CheckValidInstance();
                                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.JsonInteger>(_parent, _idx);
                                }
