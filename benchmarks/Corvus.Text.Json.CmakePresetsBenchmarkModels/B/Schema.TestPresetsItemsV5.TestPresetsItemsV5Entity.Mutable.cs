    ...
    public readonly partial struct TestPresetsItemsV5
    {
        ...
        public readonly partial struct TestPresetsItemsV5Entity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.TestPresetsItemsV5Entity.AnOptionalObjectSpecifyingOutputOptions.Mutable Output
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OutputUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.TestPresetsItemsV5Entity.AnOptionalObjectSpecifyingOutputOptions.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetOutput(in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.TestPresetsItemsV5Entity.AnOptionalObjectSpecifyingOutputOptions.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetOutput<TContext>(in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.TestPresetsItemsV5Entity.AnOptionalObjectSpecifyingOutputOptions.Source<TContext> value)
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.TestPresetsItemsV5Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.TestPresetsItemsV5Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.TestPresetsItemsV5Entity.AnOptionalObjectSpecifyingOutputOptions.Source output = default)
                {
                ...
                /// Creates an instance of a <see cref="TestPresetsItemsV5Entity"/>.
                /// </summary>
                public void Create(in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.TestPresetsItemsV5Entity.AnOptionalObjectSpecifyingOutputOptions.Source output = default)
                {
                ...
                internal static void Create<TContext>(
                    ...
                    in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.TestPresetsItemsV5Entity.AnOptionalObjectSpecifyingOutputOptions.Source<TContext> output = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                /// Creates an instance of a <see cref="TestPresetsItemsV5Entity"/>.
                /// </summary>
                public void Create<TContext>(in TContext context, in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.TestPresetsItemsV5Entity.AnOptionalObjectSpecifyingOutputOptions.Source<TContext> output = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.TestPresetsItemsV5Entity.AnOptionalObjectSpecifyingOutputOptions.Source output = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.TestPresetsItemsV5Entity.AnOptionalObjectSpecifyingOutputOptions.Source<TContext> output = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
