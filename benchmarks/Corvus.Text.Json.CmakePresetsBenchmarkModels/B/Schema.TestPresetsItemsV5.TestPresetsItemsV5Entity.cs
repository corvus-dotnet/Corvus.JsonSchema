...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TestPresetsItemsV5
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="TestPresetsItemsV5Entity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal TestPresetsItemsV5Entity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static TestPresetsItemsV5Entity DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.TestPresetsItemsV5Entity.AnOptionalObjectSpecifyingOutputOptions Output
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OutputUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.TestPresetsItemsV5Entity.AnOptionalObjectSpecifyingOutputOptions value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in TestPresetsItemsV5Entity left, in TestPresetsItemsV5Entity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in TestPresetsItemsV5Entity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(TestPresetsItemsV5Entity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TestPresetsItemsV5Entity(JsonElement instance)
            {
                return TestPresetsItemsV5Entity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TestPresetsItemsV5Entity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TestPresetsItemsV5Entity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TestPresetsItemsV5Entity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TestPresetsItemsV5Entity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TestPresetsItemsV5Entity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TestPresetsItemsV5Entity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TestPresetsItemsV5Entity>(json, options);
            }
            ...
            /// </exception>
            public static TestPresetsItemsV5Entity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<TestPresetsItemsV5Entity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out TestPresetsItemsV5Entity? result)
            {
                return JsonElementHelpers.TryParseValue<TestPresetsItemsV5Entity>(ref reader, out result);
            }
...
#if NET
            static TestPresetsItemsV5Entity IJsonElement<TestPresetsItemsV5Entity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TestPresetsItemsV5Entity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public TestPresetsItemsV5Entity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public TestPresetsItemsV5Entity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<TestPresetsItemsV5Entity>(_idx);
                }
