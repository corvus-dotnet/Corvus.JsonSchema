...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TestPresetsItemsV5
        ...
        : IJsonElement<TestPresetsItemsV5>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TestPresetsItemsV5"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TestPresetsItemsV5(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TestPresetsItemsV5 DefaultInstance { get; }
        ...
        public Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.TestPresetsItemsV5Entity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.TestPresetsItemsV5Entity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.TestPresetsItemsV5Entity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.TestPresetsItemsV5Entity>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in TestPresetsItemsV5 left, in TestPresetsItemsV5 right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TestPresetsItemsV5 left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(TestPresetsItemsV5 instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TestPresetsItemsV5(JsonElement instance)
        {
            return TestPresetsItemsV5.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TestPresetsItemsV5 From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TestPresetsItemsV5 ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TestPresetsItemsV5>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TestPresetsItemsV5 ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TestPresetsItemsV5>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TestPresetsItemsV5 ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TestPresetsItemsV5>(json, options);
        }
        ...
        /// </exception>
        public static TestPresetsItemsV5 ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<TestPresetsItemsV5>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TestPresetsItemsV5? result)
        {
            return JsonElementHelpers.TryParseValue<TestPresetsItemsV5>(ref reader, out result);
        }
...
#if NET
        static TestPresetsItemsV5 IJsonElement<TestPresetsItemsV5>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TestPresetsItemsV5: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public TestPresetsItemsV5 Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public TestPresetsItemsV5 Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TestPresetsItemsV5>(_idx);
            }
