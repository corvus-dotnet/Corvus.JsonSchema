        ...
        public readonly partial struct TestPresetsItemsV6Entity
        {
            ...
            public readonly partial struct AnOptionalObjectSpecifyingOutputOptions
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Baseline.JsonString.Mutable OutputJUnitFile
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OutputJUnitFileUtf8, out Corvus.CmakePresetsBenchmark.Baseline.JsonString.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetOutputJUnitFile(in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source value)
                    {
                        CheckValidInstance();
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.TestPresetsItemsV6Entity.AnOptionalObjectSpecifyingOutputOptions.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.TestPresetsItemsV6Entity.AnOptionalObjectSpecifyingOutputOptions.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source outputJUnitFile = default)
                    {
                    ...
                    /// Creates an instance of a <see cref="AnOptionalObjectSpecifyingOutputOptions"/>.
                    /// </summary>
                    public void Create(in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source outputJUnitFile = default)
                    {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source outputJUnitFile = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
