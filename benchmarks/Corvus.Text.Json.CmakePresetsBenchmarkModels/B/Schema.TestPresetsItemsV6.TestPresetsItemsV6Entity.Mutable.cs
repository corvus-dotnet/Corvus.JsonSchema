    ...
    public readonly partial struct TestPresetsItemsV6
    {
        ...
        public readonly partial struct TestPresetsItemsV6Entity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TestPresetsItemsV6Entity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TestPresetsItemsV6Entity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TestPresetsItemsV6Entity(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.TestPresetsItemsV6Entity.AnOptionalObjectSpecifyingOutputOptions.Mutable Output
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OutputUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.TestPresetsItemsV6Entity.AnOptionalObjectSpecifyingOutputOptions.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TestPresetsItemsV6Entity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetOutput(in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.TestPresetsItemsV6Entity.AnOptionalObjectSpecifyingOutputOptions.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetOutput<TContext>(in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.TestPresetsItemsV6Entity.AnOptionalObjectSpecifyingOutputOptions.Source<TContext> value)
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TestPresetsItemsV6Entity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TestPresetsItemsV6Entity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TestPresetsItemsV6Entity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly TestPresetsItemsV6Entity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TestPresetsItemsV6Entity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TestPresetsItemsV6Entity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly TestPresetsItemsV6Entity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TestPresetsItemsV6Entity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.TestPresetsItemsV6Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(TestPresetsItemsV6Entity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.TestPresetsItemsV6Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="TestPresetsItemsV6Entity"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.TestPresetsItemsV6Entity.AnOptionalObjectSpecifyingOutputOptions.Source output = default)
                {
                ...
                /// Creates an instance of a <see cref="TestPresetsItemsV6Entity"/>.
                /// </summary>
                public void Create(in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.TestPresetsItemsV6Entity.AnOptionalObjectSpecifyingOutputOptions.Source output = default)
                {
                ...
                internal static void Create<TContext>(
                    ...
                    in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.TestPresetsItemsV6Entity.AnOptionalObjectSpecifyingOutputOptions.Source<TContext> output = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                /// Creates an instance of a <see cref="TestPresetsItemsV6Entity"/>.
                /// </summary>
                public void Create<TContext>(in TContext context, in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.TestPresetsItemsV6Entity.AnOptionalObjectSpecifyingOutputOptions.Source<TContext> output = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.TestPresetsItemsV6Entity.AnOptionalObjectSpecifyingOutputOptions.Source output = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.TestPresetsItemsV6Entity.AnOptionalObjectSpecifyingOutputOptions.Source<TContext> output = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            {
                return workspace.CreateBuilder<TestPresetsItemsV6Entity, Mutable>(this);
            }
        }
    }
}
