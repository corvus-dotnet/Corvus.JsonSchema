...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TestPresetsItemsV6"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TestPresetsItemsV6(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TestPresetsItemsV6 DefaultInstance { get; }
        ...
        public Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.TestPresetsItemsV6Entity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.TestPresetsItemsV6Entity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.TestPresetsItemsV6Entity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.TestPresetsItemsV6Entity>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in TestPresetsItemsV6 left, in TestPresetsItemsV6 right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TestPresetsItemsV6 left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(TestPresetsItemsV6 instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TestPresetsItemsV6(JsonElement instance)
        {
            return TestPresetsItemsV6.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TestPresetsItemsV6 From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TestPresetsItemsV6 ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TestPresetsItemsV6>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TestPresetsItemsV6 ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TestPresetsItemsV6>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TestPresetsItemsV6 ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TestPresetsItemsV6>(json, options);
        }
        ...
        /// </exception>
        public static TestPresetsItemsV6 ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<TestPresetsItemsV6>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TestPresetsItemsV6? result)
        {
            return JsonElementHelpers.TryParseValue<TestPresetsItemsV6>(ref reader, out result);
        }
...
#if NET
        static TestPresetsItemsV6 IJsonElement<TestPresetsItemsV6>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TestPresetsItemsV6: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public TestPresetsItemsV6 Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public TestPresetsItemsV6 Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TestPresetsItemsV6>(_idx);
            }
