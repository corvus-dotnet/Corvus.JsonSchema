...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TestPresetsV2
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TestPresetsV2 instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TestPresetsV2"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TestPresetsV2(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TestPresetsV2.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </para>
            /// </remarks>
            public readonly TestPresetsV2 Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TestPresetsV2 Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TestPresetsV2>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsV2.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(TestPresetsV2 instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsV2.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<TestPresetsV2, Mutable>(this);
        }
    }
}
