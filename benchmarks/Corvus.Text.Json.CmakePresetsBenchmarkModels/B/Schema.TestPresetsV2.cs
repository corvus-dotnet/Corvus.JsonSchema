...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TestPresetsV2"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TestPresetsV2(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TestPresetsV2 DefaultInstance { get; }
        ...
        public static implicit operator Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2(TestPresetsV2 value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator TestPresetsV2(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2 value)
        {
            return From(value);
        }
        ...
        /// </returns>
        public static bool operator ==(in TestPresetsV2 left, in TestPresetsV2 right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TestPresetsV2 left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(TestPresetsV2 instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TestPresetsV2(JsonElement instance)
        {
            return TestPresetsV2.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TestPresetsV2 From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TestPresetsV2 ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TestPresetsV2>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TestPresetsV2 ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TestPresetsV2>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TestPresetsV2 ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TestPresetsV2>(json, options);
        }
        ...
        /// </exception>
        public static TestPresetsV2 ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<TestPresetsV2>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TestPresetsV2? result)
        {
            return JsonElementHelpers.TryParseValue<TestPresetsV2>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TestPresetsV2(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static TestPresetsV2 IJsonElement<TestPresetsV2>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TestPresetsV2: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TestPresetsV2"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TestPresetsV2"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public TestPresetsV2 Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TestPresetsV2>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TestPresetsV2"/> that lives for the lifetime of its
