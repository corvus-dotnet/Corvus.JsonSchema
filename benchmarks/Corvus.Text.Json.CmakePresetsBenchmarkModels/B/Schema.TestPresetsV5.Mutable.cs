    ...
    public readonly partial struct TestPresetsV5
    {
...
#endif
        {
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsV5.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsV5.Mutable, TResult> defaultMatch)
            {
                if (Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.JsonSchema.Evaluate(_parent, _idx))
                {
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsV5.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsV5.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
