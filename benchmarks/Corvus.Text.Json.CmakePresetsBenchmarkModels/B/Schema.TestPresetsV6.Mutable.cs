...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TestPresetsV6
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.Mutable(Mutable value)
            {
                return Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Mutable(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.Mutable value)
            {
                return From(value);
            }

            /// <summary>
            /// Conversion to <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV3"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV3.Mutable(Mutable value)
            {
                return Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV3.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV3"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Mutable(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV3.Mutable value)
            {
                return From(value);
            }

            /// <summary>
            /// Conversion to <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.Mutable(Mutable value)
            {
                return Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Mutable(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.Mutable value)
            {
                return From(value);
            }

            /// <summary>
            /// Conversion to <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.Mutable(Mutable value)
            {
                return Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Mutable(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(TestPresetsV6 instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TestPresetsV6"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TestPresetsV6(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new TestPresetsV6(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TestPresetsV6.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// <summary>
            /// Gets a <see cref="TestPresetsV6"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TestPresetsV6"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly TestPresetsV6 Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TestPresetsV6>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TestPresetsV6"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly TestPresetsV6 Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TestPresetsV6>(_idx);
            }
            ...
            /// <param name="matchTestPresetsItemsV2">Match a <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2"/>.</param>
            /// <param name="matchTestPresetsItemsV3">Match a <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV3"/>.</param>
            /// <param name="matchTestPresetsItemsV5">Match a <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5"/>.</param>
            /// <param name="matchTestPresetsItemsV6">Match a <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6"/>.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2, TContext, TResult> matchTestPresetsItemsV2,
                Matcher<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV3, TContext, TResult> matchTestPresetsItemsV3,
                Matcher<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5, TContext, TResult> matchTestPresetsItemsV5,
                Matcher<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6, TContext, TResult> matchTestPresetsItemsV6,
                Matcher<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsV6.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                if (Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchTestPresetsItemsV2(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.Mutable.From(this), context);
                }

                if (Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV3.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchTestPresetsItemsV3(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV3.Mutable.From(this), context);
                }

                if (Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchTestPresetsItemsV5(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.Mutable.From(this), context);
                }

                if (Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchTestPresetsItemsV6(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2, TResult> matchTestPresetsItemsV2,
                Matcher<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV3, TResult> matchTestPresetsItemsV3,
                Matcher<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5, TResult> matchTestPresetsItemsV5,
                Matcher<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6, TResult> matchTestPresetsItemsV6,
                Matcher<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsV6.Mutable, TResult> defaultMatch)
            {
                if (Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchTestPresetsItemsV2(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.Mutable.From(this));
                }

                if (Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV3.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchTestPresetsItemsV3(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV3.Mutable.From(this));
                }

                if (Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchTestPresetsItemsV5(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.Mutable.From(this));
                }

                if (Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchTestPresetsItemsV6(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.Mutable.From(this));
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsTestPresetsItemsV2(out Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2 result)
            {
                if (Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.Mutable.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV3" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsTestPresetsItemsV3(out Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV3 result)
            {
                if (Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV3.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV3.Mutable.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsTestPresetsItemsV5(out Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5 result)
            {
                if (Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.Mutable.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsTestPresetsItemsV6(out Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6 result)
            {
                if (Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsV6.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(TestPresetsV6 instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsV6.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<TestPresetsV6, Mutable>(this);
        }
    }
}
