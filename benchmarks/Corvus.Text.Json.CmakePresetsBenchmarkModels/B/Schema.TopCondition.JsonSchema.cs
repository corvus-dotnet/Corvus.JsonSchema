...
public readonly partial struct Schema
{
        ...
        : IJsonElement<TopCondition>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("cmake-presets-schema.json#/definitions/topCondition"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "cmake-presets-schema.json#/definitions/topCondition";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "cmake-presets-schema.json#/definitions/topCondition"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext anyOfContext0 =
                    Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AnyOf0SchemaEvaluationPath);
                Corvus.CmakePresetsBenchmark.Baseline.Schema.Condition.JsonSchema.Evaluate(parentDocument, parentIndex, ref anyOfContext0);
                ...
                JsonSchemaContext anyOfContext1 =
                    Corvus.CmakePresetsBenchmark.Baseline.JsonNull.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AnyOf1SchemaEvaluationPath);
                Corvus.CmakePresetsBenchmark.Baseline.JsonNull.JsonSchema.Evaluate(parentDocument, parentIndex, ref anyOfContext1);
