    ...
    public readonly partial struct WithVersionType2
    {
            ...
            : IJsonElement<VersionEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly NormalizedJsonNumber Const = new(false, [.."2"u8], [..""u8], 0);
                /// <summary>
                /// A constant for the <c>const</c> keyword.
                /// </summary>
                public static readonly VersionEntity ConstJson = ParsedJsonDocument<VersionEntity>.NumberConstant([.."2"u8]);
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("cmake-presets-schema.json#/oneOf/1/properties/version"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "cmake-presets-schema.json#/oneOf/1/properties/version";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "cmake-presets-schema.json#/oneOf/1/properties/version"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.Number)
                    {
                        ...
                        JsonSchemaEvaluation.MatchEquals(isNegative, integral, fractional, exponent, false, "2"u8, ""u8, 0, "2", "const"u8, ref context);
                    }
                    else
                    {
                        context.EvaluatedKeyword(false, "2", messageProvider: JsonSchemaEvaluation.ExpectedEquals, "const"u8);
                    }
                }
