    ...
    public readonly partial struct WorkflowPresetsItemsV6
    {
        ...
        public readonly partial struct RequiredNameAndSteps
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequiredNameAndSteps instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequiredNameAndSteps"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredNameAndSteps(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.NameEntity.Mutable Name
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.NameEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.Mutable Steps
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StepsUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.VendorEntity.Mutable Vendor
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VendorUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.VendorEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RequiredNameAndSteps(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetName(in Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.NameEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetSteps(in Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.Source value)
                {
                    CheckValidInstance();
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsProperty(JsonPropertyNamesEscaped.Steps, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetSteps<TContext>(in Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.Source<TContext> value)
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetVendor(in Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.VendorEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetVendor<TContext>(in Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.VendorEntity.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredNameAndSteps.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RequiredNameAndSteps"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RequiredNameAndSteps"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredNameAndSteps Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RequiredNameAndSteps>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RequiredNameAndSteps"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredNameAndSteps Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequiredNameAndSteps>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="RequiredNameAndSteps"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.NameEntity.Source name,
                    in Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.Source steps,
                    ...
                    in Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.VendorEntity.Source vendor = default)
                {
                    name.AddAsProperty(JsonPropertyNamesEscaped.Name, ref builder, escapeName: false);
                    steps.AddAsProperty(JsonPropertyNamesEscaped.Steps, ref builder, escapeName: false);
                ...
                public void Create(
                    ...
                    in Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.VendorEntity.Source vendor = default)
                {
                    Create(ref _builder, name, steps, description, displayName, vendor);
                }
                ...
                internal static void Create<TContext>(
                    ...
                    ref ComplexValueBuilder builder,
                    in Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.NameEntity.Source name,
                    in Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.Source<TContext> steps,
                    in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source description = default,
                    in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source displayName = default,
                    in Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.VendorEntity.Source<TContext> vendor = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                #endif
                {
                    Create(context, ref _builder, name, steps, description, displayName, vendor);
                }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.NameEntity.Source name, in Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.Source steps, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source description = default, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source displayName = default, in Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.VendorEntity.Source vendor = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(name, steps, description, displayName, vendor);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.NameEntity.Source name, in Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.Source<TContext> steps, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source description = default, in Corvus.CmakePresetsBenchmark.Baseline.JsonString.Source displayName = default, in Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.VendorEntity.Source<TContext> vendor = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, name, steps, description, displayName, vendor);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<RequiredNameAndSteps, Mutable>(this);
            }
        }
    }
}
