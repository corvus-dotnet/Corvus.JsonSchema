                ...
                public readonly partial struct RequiredNameAndType
                {
                    ...
                    public readonly partial struct TypeEntity
                    {
...
#endif
                        {
                            ...
                            /// <param name="matchConfigure">Match 1st item.</param>
                            /// <param name="matchBuild">Match 2nd item.</param>
                            /// <param name="matchTest">Match 3rd item.</param>
                            /// <param name="matchPackage">Match 4th item.</param>
                            /// <param name="defaultMatch">Match any other value.</param>
                            /// <returns>An instance of the value returned by the match function.</returns>
                            public TResult Match<TContext, TResult>(
                                in TContext context,
                                Func<TContext, TResult> matchConfigure,
                                Func<TContext, TResult> matchBuild,
                                Func<TContext, TResult> matchTest,
                                Func<TContext, TResult> matchPackage,
...
#endif
                            {
                                ...
                                {
                                    return matchConfigure(context);
                                }

                                if (this.ValueEquals(Constants.Enum2))
                                {
                                    return matchBuild(context);
                                }
                            ...
                            public TResult Match<TResult>(
                                Func<TResult> matchConfigure,
                                Func<TResult> matchBuild,
                                Func<TResult> matchTest,
                                Func<TResult> matchPackage,
                                Func<TResult> defaultMatch)
                            {
                                if (this.ValueEquals(Constants.Enum1))
                                {
                                    return matchConfigure();
                                }
