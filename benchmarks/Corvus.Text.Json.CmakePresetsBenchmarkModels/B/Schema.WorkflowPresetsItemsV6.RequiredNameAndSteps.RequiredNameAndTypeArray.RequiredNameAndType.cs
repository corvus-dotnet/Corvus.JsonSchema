        ...
        public readonly partial struct RequiredNameAndSteps
        {
            ...
            public readonly partial struct RequiredNameAndTypeArray
            {
                ...
                public readonly partial struct RequiredNameAndType
                    ...
                    : IJsonElement<RequiredNameAndType>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="RequiredNameAndType"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal RequiredNameAndType(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static RequiredNameAndType DefaultInstance { get; }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.NameEntity Name
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.NameEntity value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.TypeEntity Type
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.TypeEntity value))
                            {
                                return value;
                            }
                    ...
                    /// </returns>
                    public static bool operator ==(in RequiredNameAndType left, in RequiredNameAndType right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in RequiredNameAndType left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(RequiredNameAndType instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredNameAndType(JsonElement instance)
                    {
                        return RequiredNameAndType.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredNameAndType From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredNameAndType ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredNameAndType>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredNameAndType ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredNameAndType>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredNameAndType ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredNameAndType>(json, options);
                    }
                    ...
                    /// </exception>
                    public static RequiredNameAndType ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<RequiredNameAndType>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredNameAndType? result)
                    {
                        return JsonElementHelpers.TryParseValue<RequiredNameAndType>(ref reader, out result);
                    }
...
#if NET
                    static RequiredNameAndType IJsonElement<RequiredNameAndType>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredNameAndType: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public RequiredNameAndType Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public RequiredNameAndType Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<RequiredNameAndType>(_idx);
                        }
