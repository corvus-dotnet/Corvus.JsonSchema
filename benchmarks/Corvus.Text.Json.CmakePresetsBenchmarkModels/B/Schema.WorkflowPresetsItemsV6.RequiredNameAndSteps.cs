...
public readonly partial struct Schema
{
    ...
    public readonly partial struct WorkflowPresetsItemsV6
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RequiredNameAndSteps"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RequiredNameAndSteps(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RequiredNameAndSteps DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.NameEntity Name
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.NameEntity value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray Steps
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StepsUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.VendorEntity Vendor
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VendorUtf8, out Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.VendorEntity value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in RequiredNameAndSteps left, in RequiredNameAndSteps right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RequiredNameAndSteps left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RequiredNameAndSteps instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredNameAndSteps(JsonElement instance)
            {
                return RequiredNameAndSteps.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredNameAndSteps From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredNameAndSteps ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredNameAndSteps>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredNameAndSteps ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredNameAndSteps>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredNameAndSteps ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredNameAndSteps>(json, options);
            }
            ...
            /// </exception>
            public static RequiredNameAndSteps ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RequiredNameAndSteps>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredNameAndSteps? result)
            {
                return JsonElementHelpers.TryParseValue<RequiredNameAndSteps>(ref reader, out result);
            }
...
#if NET
            static RequiredNameAndSteps IJsonElement<RequiredNameAndSteps>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredNameAndSteps: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public RequiredNameAndSteps Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public RequiredNameAndSteps Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RequiredNameAndSteps>(_idx);
                }
