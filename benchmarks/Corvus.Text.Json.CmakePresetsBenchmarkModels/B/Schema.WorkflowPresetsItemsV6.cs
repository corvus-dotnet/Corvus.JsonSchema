...
public readonly partial struct Schema
{
    ...
    public readonly partial struct WorkflowPresetsItemsV6
        ...
        : IJsonElement<WorkflowPresetsItemsV6>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkflowPresetsItemsV6"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal WorkflowPresetsItemsV6(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static WorkflowPresetsItemsV6 DefaultInstance { get; }
        ...
        public Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in WorkflowPresetsItemsV6 left, in WorkflowPresetsItemsV6 right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in WorkflowPresetsItemsV6 left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(WorkflowPresetsItemsV6 instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator WorkflowPresetsItemsV6(JsonElement instance)
        {
            return WorkflowPresetsItemsV6.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WorkflowPresetsItemsV6 From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WorkflowPresetsItemsV6 ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<WorkflowPresetsItemsV6>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WorkflowPresetsItemsV6 ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<WorkflowPresetsItemsV6>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WorkflowPresetsItemsV6 ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<WorkflowPresetsItemsV6>(json, options);
        }
        ...
        /// </exception>
        public static WorkflowPresetsItemsV6 ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<WorkflowPresetsItemsV6>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out WorkflowPresetsItemsV6? result)
        {
            return JsonElementHelpers.TryParseValue<WorkflowPresetsItemsV6>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new WorkflowPresetsItemsV6(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static WorkflowPresetsItemsV6 IJsonElement<WorkflowPresetsItemsV6>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"WorkflowPresetsItemsV6: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="WorkflowPresetsItemsV6"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="WorkflowPresetsItemsV6"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public WorkflowPresetsItemsV6 Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<WorkflowPresetsItemsV6>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="WorkflowPresetsItemsV6"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public WorkflowPresetsItemsV6 Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<WorkflowPresetsItemsV6>(_idx);
            }
