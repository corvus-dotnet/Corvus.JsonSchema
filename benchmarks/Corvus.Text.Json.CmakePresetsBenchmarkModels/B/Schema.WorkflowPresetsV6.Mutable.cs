...
public readonly partial struct Schema
{
    ...
    public readonly partial struct WorkflowPresetsV6
    {
...
#endif
        {
            ...
            public static implicit operator Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.Mutable(Mutable value)
            {
                return Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Mutable(Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.Mutable value)
            {
                return From(value);
            }
            ...
            public bool TryGetAsWorkflowPresetsItemsV6(out Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6 result)
            {
                ...
                {
                    result = Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsV6.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsV6.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
