...
public readonly partial struct Schema
{
    ...
    public readonly partial struct WorkflowPresetsV6
#if NET8_0_OR_GREATER
        : IJsonElement<WorkflowPresetsV6>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkflowPresetsV6"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal WorkflowPresetsV6(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static WorkflowPresetsV6 DefaultInstance { get; }
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6(WorkflowPresetsV6 value)
        {
            return Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator WorkflowPresetsV6(Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6 value)
        {
            return From(value);
        }
        ...
        /// </returns>
        public static bool operator ==(in WorkflowPresetsV6 left, in WorkflowPresetsV6 right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in WorkflowPresetsV6 left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(WorkflowPresetsV6 instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator WorkflowPresetsV6(JsonElement instance)
        {
            return WorkflowPresetsV6.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WorkflowPresetsV6 From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WorkflowPresetsV6 ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<WorkflowPresetsV6>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WorkflowPresetsV6 ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<WorkflowPresetsV6>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WorkflowPresetsV6 ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<WorkflowPresetsV6>(json, options);
        }
        ...
        /// </exception>
        public static WorkflowPresetsV6 ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<WorkflowPresetsV6>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out WorkflowPresetsV6? result)
        {
            return JsonElementHelpers.TryParseValue<WorkflowPresetsV6>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new WorkflowPresetsV6(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static WorkflowPresetsV6 IJsonElement<WorkflowPresetsV6>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"WorkflowPresetsV6: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="WorkflowPresetsV6"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="WorkflowPresetsV6"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public WorkflowPresetsV6 Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<WorkflowPresetsV6>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="WorkflowPresetsV6"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public WorkflowPresetsV6 Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<WorkflowPresetsV6>(_idx);
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsWorkflowPresetsItemsV6(out Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6 result)
        {
            if (Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.From(this);
                return true;
            }
