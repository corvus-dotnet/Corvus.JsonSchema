        ...
        public readonly partial struct RequiredName
        {
            ...
            public readonly partial struct TargetsEntity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV2.RequiredName.TargetsEntity.JsonStringArray" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsJsonStringArray(out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV2.RequiredName.TargetsEntity.JsonStringArray result)
                    {
                        if (Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV2.RequiredName.TargetsEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                        {
