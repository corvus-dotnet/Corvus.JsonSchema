    ...
    public readonly partial struct BuildPresetsItemsV3
    {
        ...
        public readonly partial struct BuildPresetsItemsV3Entity
        {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV3.BuildPresetsItemsV3Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV3.BuildPresetsItemsV3Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public static ParsedJsonDocument<BuildPresetsItemsV3Entity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<BuildPresetsItemsV3Entity>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<BuildPresetsItemsV3Entity> Create<TContext>(
            ...
            public static ParsedJsonDocument<BuildPresetsItemsV3Entity> Create(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TopCondition.Source condition = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<BuildPresetsItemsV3Entity> Create<TContext>(in TContext context, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TopCondition.Source<TContext> condition = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
