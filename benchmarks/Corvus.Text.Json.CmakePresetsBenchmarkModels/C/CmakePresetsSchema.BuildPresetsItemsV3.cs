...
public readonly partial struct CmakePresetsSchema
{
    ...
    public readonly partial struct BuildPresetsItemsV3
        ...
        : IJsonElement<BuildPresetsItemsV3>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BuildPresetsItemsV3"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal BuildPresetsItemsV3(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static BuildPresetsItemsV3 DefaultInstance { get; }
        ...
        public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV3.BuildPresetsItemsV3Entity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV3.BuildPresetsItemsV3Entity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV3.BuildPresetsItemsV3Entity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV3.BuildPresetsItemsV3Entity>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in BuildPresetsItemsV3 left, in BuildPresetsItemsV3 right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in BuildPresetsItemsV3 left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(BuildPresetsItemsV3 instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BuildPresetsItemsV3(JsonElement instance)
        {
            return BuildPresetsItemsV3.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuildPresetsItemsV3 From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuildPresetsItemsV3 ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BuildPresetsItemsV3>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuildPresetsItemsV3 ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BuildPresetsItemsV3>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuildPresetsItemsV3 ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BuildPresetsItemsV3>(json, options);
        }
        ...
        /// </exception>
        public static BuildPresetsItemsV3 ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<BuildPresetsItemsV3>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out BuildPresetsItemsV3? result)
        {
            return JsonElementHelpers.TryParseValue<BuildPresetsItemsV3>(ref reader, out result);
        }
...
#if NET
        static BuildPresetsItemsV3 IJsonElement<BuildPresetsItemsV3>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BuildPresetsItemsV3: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public BuildPresetsItemsV3 Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public BuildPresetsItemsV3 Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<BuildPresetsItemsV3>(_idx);
            }
