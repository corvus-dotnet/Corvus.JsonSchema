    ...
    public readonly partial struct BuildPresetsItemsV4
    {
        ...
        public readonly partial struct BuildPresetsItemsV4Entity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(BuildPresetsItemsV4Entity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="BuildPresetsItemsV4Entity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator BuildPresetsItemsV4Entity(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.ResolvePackageReferencesEntity.Mutable ResolvePackageReferences
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ResolvePackageReferencesUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.ResolvePackageReferencesEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetResolvePackageReferences(scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.ResolvePackageReferencesEntity.Source value)
                {
                    CheckValidInstance();
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"BuildPresetsItemsV4Entity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly BuildPresetsItemsV4Entity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly BuildPresetsItemsV4Entity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<BuildPresetsItemsV4Entity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.ResolvePackageReferencesEntity.Source _createArg1;
                ...
                internal Source(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.ResolvePackageReferencesEntity.Source arg1)
                {
                    _createArg1 = arg1;
                    _kind = Kind.Create;
                }

                public static implicit operator Source(BuildPresetsItemsV4Entity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="BuildPresetsItemsV4Entity"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.ResolvePackageReferencesEntity.Source resolvePackageReferences = default)
                {
                ...
                /// Creates an instance of a <see cref="BuildPresetsItemsV4Entity"/>.
                /// </summary>
                public void Create(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.ResolvePackageReferencesEntity.Source resolvePackageReferences = default)
                {
                    Create(ref _builder, resolvePackageReferences);
                }
                ...
                internal static void BuildCreateValue(scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.ResolvePackageReferencesEntity.Source arg1, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                    Create(ref o, arg1);
                    o.EndObject();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.ResolvePackageReferencesEntity.Source resolvePackageReferences = default)
            {
                return new Source(resolvePackageReferences);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.ResolvePackageReferencesEntity.Source resolvePackageReferences = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(resolvePackageReferences);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<BuildPresetsItemsV4Entity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<BuildPresetsItemsV4Entity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<BuildPresetsItemsV4Entity>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<BuildPresetsItemsV4Entity> Create<TContext>(
            ...
            public static ParsedJsonDocument<BuildPresetsItemsV4Entity> Create(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.ResolvePackageReferencesEntity.Source resolvePackageReferences = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
