...
public readonly partial struct CmakePresetsSchema
{
    ...
    public readonly partial struct BuildPresetsItemsV4
    {
        ...
        /// Generated from JSON Schema.
        /// </summary>
        public readonly partial struct BuildPresetsItemsV4Entity
        {
            /// <summary>
            /// Generated from JSON Schema.
            /// </summary>
            ...
            public readonly partial struct ResolvePackageReferencesEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ResolvePackageReferencesEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ResolvePackageReferencesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ResolvePackageReferencesEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new ResolvePackageReferencesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ResolvePackageReferencesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="ResolvePackageReferencesEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="ResolvePackageReferencesEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ResolvePackageReferencesEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<ResolvePackageReferencesEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="ResolvePackageReferencesEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ResolvePackageReferencesEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ResolvePackageReferencesEntity>(_idx);
                    }
                    ...
                    /// <param name="matchOnly">Match 3rd item.</param>
                    ...
                    public TResult Match<TContext, TResult>(
                        ...
                        Func<TContext, TResult> matchOnly,
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ResolvePackageReferencesEntity instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (ResolvePackageReferencesEntity)value;
                ...
                {
                    return workspace.CreateBuilder<ResolvePackageReferencesEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ResolvePackageReferencesEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ResolvePackageReferencesEntity>();
                    }
                    finally
                    {
