...
public readonly partial struct CmakePresetsSchema
{
    ...
    public readonly partial struct BuildPresetsItemsV4
    {
...
#endif
        {
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity.Source value)
            {
                CheckValidInstance();
