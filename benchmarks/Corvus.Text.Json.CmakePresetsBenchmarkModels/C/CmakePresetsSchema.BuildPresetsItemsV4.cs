...
public readonly partial struct CmakePresetsSchema
{
...
#endif
    {
        ...
        public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.BuildPresetsItemsV4Entity>(_parent, _idx);
        }
