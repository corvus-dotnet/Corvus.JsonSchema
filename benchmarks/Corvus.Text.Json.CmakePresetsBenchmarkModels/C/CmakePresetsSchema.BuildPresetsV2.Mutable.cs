...
public readonly partial struct CmakePresetsSchema
{
    ...
    public readonly partial struct BuildPresetsV2
    {
...
#endif
        {
            ...
            public static implicit operator Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV2.Mutable(Mutable value)
            {
                return Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV2.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Mutable(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV2.Mutable value)
            {
                return From(value);
            }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV2.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsBuildPresetsItemsV2(out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV2.Mutable result)
            {
                if (Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV2.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV2.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsV2.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsV2.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public static ParsedJsonDocument<BuildPresetsV2> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<BuildPresetsV2>();
            }
            finally
            {
