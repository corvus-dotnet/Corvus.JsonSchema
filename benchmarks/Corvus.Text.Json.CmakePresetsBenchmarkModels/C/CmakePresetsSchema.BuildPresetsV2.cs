...
public readonly partial struct CmakePresetsSchema
{
...
#endif
    {
        ...
        public static implicit operator Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV2(BuildPresetsV2 value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator BuildPresetsV2(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV2 value)
        {
            return From(value);
        }
