...
public readonly partial struct CmakePresetsSchema
{
    ...
    public readonly partial struct BuildPresetsV4
    {
...
#endif
        {
            ...
            public static implicit operator Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.Mutable(Mutable value)
            {
                return Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Mutable(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.Mutable value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV3.Mutable(Mutable value)
            {
                return Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV3.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Mutable(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV3.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(BuildPresetsV4 instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BuildPresetsV4"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BuildPresetsV4(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BuildPresetsV4.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </para>
            /// </remarks>
            public readonly BuildPresetsV4 Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly BuildPresetsV4 Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<BuildPresetsV4>(_idx);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsV4.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                ...
                {
                    return matchBuildPresetsItemsV4(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.Mutable.From(this), context);
                }

                if (Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV3.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchBuildPresetsItemsV3(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV3.Mutable.From(this), context);
                }

                if (Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV2.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchBuildPresetsItemsV2(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV2.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsV4.Mutable, TResult> defaultMatch)
            {
                if (Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchBuildPresetsItemsV4(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.Mutable.From(this));
                }

                if (Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV3.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchBuildPresetsItemsV3(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV3.Mutable.From(this));
                }

                if (Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV2.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchBuildPresetsItemsV2(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV2.Mutable.From(this));
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV3.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsBuildPresetsItemsV3(out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV3.Mutable result)
            {
                if (Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV3.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV3.Mutable.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsBuildPresetsItemsV4(out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.Mutable result)
            {
                if (Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsItemsV4.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsV4.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(BuildPresetsV4 instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsV4.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<BuildPresetsV4, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<BuildPresetsV4> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<BuildPresetsV4>();
            }
            finally
            {
