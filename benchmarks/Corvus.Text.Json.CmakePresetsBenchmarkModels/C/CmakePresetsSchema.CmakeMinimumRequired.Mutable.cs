...
public readonly partial struct CmakePresetsSchema
{
    ...
    public readonly partial struct CmakeMinimumRequired
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(CmakeMinimumRequired instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CmakeMinimumRequired"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CmakeMinimumRequired(Mutable instance)
            {
            ...
            /// <summary>
            /// Gets the (optional) <c>major</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.CmakePresetsBenchmark.Current.JsonInteger.Mutable Major
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MajorUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonInteger.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>minor</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.CmakePresetsBenchmark.Current.JsonInteger.Mutable Minor
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinorUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonInteger.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CmakePresetsBenchmark.Current.JsonInteger.Mutable Patch
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PatchUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonInteger.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new CmakeMinimumRequired(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetMajor(scoped in Corvus.CmakePresetsBenchmark.Current.JsonInteger.Source value)
            {
                ...
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.MajorUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MajorUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Major, ref cvb);
            ...
            /// <summary>
            /// Remove the <c>major</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveMajor()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.MajorUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            public void SetMinor(scoped in Corvus.CmakePresetsBenchmark.Current.JsonInteger.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.MinorUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinorUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Minor, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>minor</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveMinor()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.MinorUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CmakeMinimumRequired.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="CmakeMinimumRequired"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="CmakeMinimumRequired"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly CmakeMinimumRequired Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<CmakeMinimumRequired>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="CmakeMinimumRequired"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly CmakeMinimumRequired Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CmakeMinimumRequired>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.CmakePresetsBenchmark.Current.JsonInteger.Source _createArg2;
            ...
            public static implicit operator Source(CmakeMinimumRequired instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.CmakeMinimumRequired.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="CmakeMinimumRequired"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.CmakePresetsBenchmark.Current.JsonInteger.Source major = default,
                in Corvus.CmakePresetsBenchmark.Current.JsonInteger.Source minor = default,
                in Corvus.CmakePresetsBenchmark.Current.JsonInteger.Source patch = default)
            {
                major.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Major, ref builder);
                minor.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Minor, ref builder);
            ...
            public void Create(
                ...
                in Corvus.CmakePresetsBenchmark.Current.JsonInteger.Source patch = default)
            {
                Create(ref _builder, major, minor, patch);
            }
        ...
        /// </summary>
        /// <param name="major">The value of the <c>"major"</c> property.</param>
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="major">The value of the property.</param>
        /// <param name="minor">The value of the property.</param>
        /// <param name="patch">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Current.JsonInteger.Source major = default, in Corvus.CmakePresetsBenchmark.Current.JsonInteger.Source minor = default, in Corvus.CmakePresetsBenchmark.Current.JsonInteger.Source patch = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(major, minor, patch);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<CmakeMinimumRequired, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<CmakeMinimumRequired> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<CmakeMinimumRequired>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<CmakeMinimumRequired> Create<TContext>(
        ...
        public static ParsedJsonDocument<CmakeMinimumRequired> Create(in Corvus.CmakePresetsBenchmark.Current.JsonInteger.Source major = default, in Corvus.CmakePresetsBenchmark.Current.JsonInteger.Source minor = default, in Corvus.CmakePresetsBenchmark.Current.JsonInteger.Source patch = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
