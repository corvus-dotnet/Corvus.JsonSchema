...
public readonly partial struct CmakePresetsSchema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.CmakePresetsBenchmark.Current.JsonInteger Major
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MajorUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonInteger value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CmakePresetsBenchmark.Current.JsonInteger Minor
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinorUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonInteger value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CmakePresetsBenchmark.Current.JsonInteger Patch
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PatchUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonInteger value))
                {
                    return value;
                }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Major"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Major => [0x75, 0x00, 0x00, 0x00, 0x22, 0x6D, 0x61, 0x6A, 0x6F, 0x72, 0x22];

            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Minor"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Minor => [0x75, 0x00, 0x00, 0x00, 0x22, 0x6D, 0x69, 0x6E, 0x6F, 0x72, 0x22];
