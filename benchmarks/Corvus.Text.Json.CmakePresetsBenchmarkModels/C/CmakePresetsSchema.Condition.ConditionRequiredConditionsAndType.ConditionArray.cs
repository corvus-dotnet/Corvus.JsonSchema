    ...
    public readonly partial struct Condition
    {
        ...
        public readonly partial struct ConditionRequiredConditionsAndType
        {
...
#endif
            {
                ...
                public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition>(_parent, _idx);
                }
