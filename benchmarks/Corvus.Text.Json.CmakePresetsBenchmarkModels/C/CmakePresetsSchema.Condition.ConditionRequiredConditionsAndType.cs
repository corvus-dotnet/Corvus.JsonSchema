...
public readonly partial struct CmakePresetsSchema
{
    ...
    public readonly partial struct Condition
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ConditionRequiredConditionsAndType"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ConditionRequiredConditionsAndType(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ConditionRequiredConditionsAndType DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.ConditionRequiredConditionsAndType.ConditionArray Conditions
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ConditionsUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.ConditionRequiredConditionsAndType.ConditionArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.ConditionRequiredConditionsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.ConditionRequiredConditionsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in ConditionRequiredConditionsAndType left, in ConditionRequiredConditionsAndType right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ConditionRequiredConditionsAndType left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(ConditionRequiredConditionsAndType instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ConditionRequiredConditionsAndType(JsonElement instance)
            {
                return ConditionRequiredConditionsAndType.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConditionRequiredConditionsAndType From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConditionRequiredConditionsAndType ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConditionRequiredConditionsAndType>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConditionRequiredConditionsAndType ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConditionRequiredConditionsAndType>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConditionRequiredConditionsAndType ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConditionRequiredConditionsAndType>(json, options);
            }
            ...
            /// </exception>
            public static ConditionRequiredConditionsAndType ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ConditionRequiredConditionsAndType>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ConditionRequiredConditionsAndType? result)
            {
                return JsonElementHelpers.TryParseValue<ConditionRequiredConditionsAndType>(ref reader, out result);
            }
...
#if NET
            static ConditionRequiredConditionsAndType IJsonElement<ConditionRequiredConditionsAndType>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ConditionRequiredConditionsAndType: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ConditionRequiredConditionsAndType Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ConditionRequiredConditionsAndType Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ConditionRequiredConditionsAndType>(_idx);
                }
