...
public readonly partial struct CmakePresetsSchema
{
    ...
    public readonly partial struct Condition
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.ConditionRequiredListAndStringEntityAndType.JsonStringArray List
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ListUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.ConditionRequiredListAndStringEntityAndType.JsonStringArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.ConditionRequiredListAndStringEntityAndType.ARequiredStringSpecifyingTheTypeOfTheCondition Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.ConditionRequiredListAndStringEntityAndType.ARequiredStringSpecifyingTheTypeOfTheCondition value))
                    {
                        return value;
                    }
