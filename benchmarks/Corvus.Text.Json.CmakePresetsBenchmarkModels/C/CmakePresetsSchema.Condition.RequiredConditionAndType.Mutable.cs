    ...
    public readonly partial struct Condition
    {
        ...
        public readonly partial struct RequiredConditionAndType
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequiredConditionAndType instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequiredConditionAndType"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredConditionAndType(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.Mutable ConditionValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ConditionValueUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredConditionAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.Mutable Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredConditionAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetConditionValue(scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.Source value)
                {
                    ...
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ConditionValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ConditionValue, ref cvb);
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetConditionValue<TContext>(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.Source<TContext> value)
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredConditionAndType.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredConditionAndType Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredConditionAndType Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequiredConditionAndType>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.Source _createArg1;
                ...
                public static implicit operator Source(RequiredConditionAndType instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                private readonly Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.Source<TContext> _createArg1;
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="RequiredConditionAndType"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.Source condition)
                {
                    condition.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ConditionValue, ref builder);
                    builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.Type, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredConditionAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.ConstInstance);
                }

                /// <summary>
                /// Creates an instance of a <see cref="RequiredConditionAndType"/>.
                /// </summary>
                public void Create(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.Source condition)
                {
                ...
                internal static void Create<TContext>(
                    ...
                    in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.Source<TContext> condition)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                /// Creates an instance of a <see cref="RequiredConditionAndType"/>.
                /// </summary>
                public void Create<TContext>(in TContext context, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.Source<TContext> condition)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.Source condition, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.Source<TContext> condition, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            {
                return workspace.CreateBuilder<RequiredConditionAndType, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RequiredConditionAndType> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RequiredConditionAndType>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredConditionAndType> Create<TContext>(
            ...
            public static ParsedJsonDocument<RequiredConditionAndType> Create(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.Source condition, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredConditionAndType> Create<TContext>(in TContext context, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.Source<TContext> condition, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
