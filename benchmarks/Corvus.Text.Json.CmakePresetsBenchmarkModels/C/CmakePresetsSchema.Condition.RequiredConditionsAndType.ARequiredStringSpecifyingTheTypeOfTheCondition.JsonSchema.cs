                ...
                public static partial class JsonSchema
                {
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "anyOf"u8, "anyOf", "const"u8, ref context);
                        }
                        else
                        {
                            context.EvaluatedKeyword(false, "anyOf", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                        }
                    }
