    ...
    public readonly partial struct Condition
    {
        ...
        public readonly partial struct RequiredConditionsAndType
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequiredConditionsAndType instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequiredConditionsAndType"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredConditionsAndType(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredConditionsAndType.ConditionArray.Mutable Conditions
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ConditionsUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredConditionsAndType.ConditionArray.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredConditionsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.Mutable Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredConditionsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetConditions<TContext>(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredConditionsAndType.ConditionArray.Source<TContext> value)
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredConditionsAndType.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredConditionsAndType Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredConditionsAndType Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequiredConditionsAndType>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredConditionsAndType.ConditionArray.Source _createArg1;
                ...
                public static implicit operator Source(RequiredConditionsAndType instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                private readonly Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredConditionsAndType.ConditionArray.Source<TContext> _createArg1;
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="RequiredConditionsAndType"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredConditionsAndType.ConditionArray.Source conditions)
                {
                    conditions.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Conditions, ref builder);
                    builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.Type, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredConditionsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.ConstInstance);
                }

                /// <summary>
                /// Creates an instance of a <see cref="RequiredConditionsAndType"/>.
                /// </summary>
                public void Create(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredConditionsAndType.ConditionArray.Source conditions)
                {
                ...
                internal static void Create<TContext>(
                    ...
                    in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredConditionsAndType.ConditionArray.Source<TContext> conditions)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                /// Creates an instance of a <see cref="RequiredConditionsAndType"/>.
                /// </summary>
                public void Create<TContext>(in TContext context, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredConditionsAndType.ConditionArray.Source<TContext> conditions)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredConditionsAndType.ConditionArray.Source conditions, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredConditionsAndType.ConditionArray.Source<TContext> conditions, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            {
                return workspace.CreateBuilder<RequiredConditionsAndType, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RequiredConditionsAndType> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RequiredConditionsAndType>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredConditionsAndType> Create<TContext>(
            ...
            public static ParsedJsonDocument<RequiredConditionsAndType> Create(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredConditionsAndType.ConditionArray.Source conditions, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredConditionsAndType> Create<TContext>(in TContext context, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredConditionsAndType.ConditionArray.Source<TContext> conditions, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
