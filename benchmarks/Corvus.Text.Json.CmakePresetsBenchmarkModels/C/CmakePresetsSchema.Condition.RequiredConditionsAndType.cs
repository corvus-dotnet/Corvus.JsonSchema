...
public readonly partial struct CmakePresetsSchema
{
    ...
    public readonly partial struct Condition
    {
        ...
        public readonly partial struct RequiredConditionsAndType
            ...
            : IJsonElement<RequiredConditionsAndType>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RequiredConditionsAndType"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RequiredConditionsAndType(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RequiredConditionsAndType DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredConditionsAndType.ConditionArray Conditions
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ConditionsUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredConditionsAndType.ConditionArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredConditionsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredConditionsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in RequiredConditionsAndType left, in RequiredConditionsAndType right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RequiredConditionsAndType left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RequiredConditionsAndType instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredConditionsAndType(JsonElement instance)
            {
                return RequiredConditionsAndType.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredConditionsAndType From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredConditionsAndType ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredConditionsAndType>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredConditionsAndType ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredConditionsAndType>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredConditionsAndType ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredConditionsAndType>(json, options);
            }
            ...
            /// </exception>
            public static RequiredConditionsAndType ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RequiredConditionsAndType>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredConditionsAndType? result)
            {
                return JsonElementHelpers.TryParseValue<RequiredConditionsAndType>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RequiredConditionsAndType(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RequiredConditionsAndType IJsonElement<RequiredConditionsAndType>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredConditionsAndType: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RequiredConditionsAndType"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RequiredConditionsAndType"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RequiredConditionsAndType Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RequiredConditionsAndType>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RequiredConditionsAndType"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RequiredConditionsAndType Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RequiredConditionsAndType>(_idx);
                }
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="Conditions"/>.
                /// </summary>
                ...
                /// Gets the JSON property name for <see cref="Conditions"/>.
                /// </summary>
                public static ReadOnlySpan<byte> ConditionsUtf8 => "conditions"u8;
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Conditions"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Conditions => "conditions"u8;
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="Conditions"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Conditions => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x63, 0x6F, 0x6E, 0x64, 0x69, 0x74, 0x69, 0x6F, 0x6E, 0x73, 0x22];
