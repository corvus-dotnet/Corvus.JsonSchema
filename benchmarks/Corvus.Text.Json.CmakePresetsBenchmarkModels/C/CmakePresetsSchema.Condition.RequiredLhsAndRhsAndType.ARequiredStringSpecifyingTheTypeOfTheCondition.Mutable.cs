        ...
        public readonly partial struct RequiredLhsAndRhsAndType
        {
            ...
            public readonly partial struct ARequiredStringSpecifyingTheTypeOfTheCondition
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ARequiredStringSpecifyingTheTypeOfTheCondition instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ARequiredStringSpecifyingTheTypeOfTheCondition"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ARequiredStringSpecifyingTheTypeOfTheCondition(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ARequiredStringSpecifyingTheTypeOfTheCondition.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ARequiredStringSpecifyingTheTypeOfTheCondition Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ARequiredStringSpecifyingTheTypeOfTheCondition Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ARequiredStringSpecifyingTheTypeOfTheCondition>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ARequiredStringSpecifyingTheTypeOfTheCondition instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ARequiredStringSpecifyingTheTypeOfTheCondition, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ARequiredStringSpecifyingTheTypeOfTheCondition> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ARequiredStringSpecifyingTheTypeOfTheCondition>();
                    }
                    finally
                    {
