    ...
    public readonly partial struct Condition
    {
            ...
            : IJsonElement<RequiredLhsAndRhsAndType>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchLhs(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
                ...
                private static void MatchRhs(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
