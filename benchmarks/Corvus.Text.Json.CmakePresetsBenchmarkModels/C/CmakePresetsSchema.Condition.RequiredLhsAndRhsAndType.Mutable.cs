    ...
    public readonly partial struct Condition
    {
        ...
        public readonly partial struct RequiredLhsAndRhsAndType
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequiredLhsAndRhsAndType instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequiredLhsAndRhsAndType"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredLhsAndRhsAndType(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Current.JsonString.Mutable Lhs
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LhsUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Current.JsonString.Mutable Rhs
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RhsUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredLhsAndRhsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.Mutable Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredLhsAndRhsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RequiredLhsAndRhsAndType(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                /// <summary>
                /// Set the <c>lhs</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetLhs(scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("lhs");
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LhsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Lhs, ref cvb);
                ...
                /// <summary>
                /// Set the <c>rhs</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetRhs(scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("rhs");
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RhsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Rhs, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetType(scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredLhsAndRhsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.Source value)
                {
                    CheckValidInstance();
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredLhsAndRhsAndType.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RequiredLhsAndRhsAndType"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RequiredLhsAndRhsAndType"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredLhsAndRhsAndType Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RequiredLhsAndRhsAndType>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RequiredLhsAndRhsAndType"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredLhsAndRhsAndType Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequiredLhsAndRhsAndType>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredLhsAndRhsAndType.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                public static implicit operator Source(RequiredLhsAndRhsAndType instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredLhsAndRhsAndType.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="RequiredLhsAndRhsAndType"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.CmakePresetsBenchmark.Current.JsonString.Source lhs,
                    in Corvus.CmakePresetsBenchmark.Current.JsonString.Source rhs)
                {
                    lhs.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Lhs, ref builder);
                    rhs.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Rhs, ref builder);
                    builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.Type, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredLhsAndRhsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.ConstInstance);
                }

                /// <summary>
                /// Creates an instance of a <see cref="RequiredLhsAndRhsAndType"/>.
                /// </summary>
                public void Create(in Corvus.CmakePresetsBenchmark.Current.JsonString.Source lhs, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source rhs)
                {
                    Create(ref _builder, lhs, rhs);
                }
            ...
            /// </summary>
            /// <param name="lhs">The value of the <c>"lhs"</c> property.</param>
            /// <param name="rhs">The value of the <c>"rhs"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source lhs, scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source rhs)
            {
                return new Source(lhs, rhs);
            }
            ...
            /// </summary>
            /// <param name="workspace">The JSON workspace.</param>
            /// <param name="lhs">The value of the property.</param>
            /// <param name="rhs">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source lhs, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source rhs, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            {
                return workspace.CreateBuilder<RequiredLhsAndRhsAndType, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RequiredLhsAndRhsAndType> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RequiredLhsAndRhsAndType>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredLhsAndRhsAndType> Create<TContext>(
            ...
            public static ParsedJsonDocument<RequiredLhsAndRhsAndType> Create(in Corvus.CmakePresetsBenchmark.Current.JsonString.Source lhs, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source rhs, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
