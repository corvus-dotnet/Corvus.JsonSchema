    ...
    public readonly partial struct Condition
    {
        ...
        public readonly partial struct RequiredLhsAndRhsAndType
        {
...
#endif
            {
                ...
                public void SetLhs(in Corvus.CmakePresetsBenchmark.Current.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetRhs(in Corvus.CmakePresetsBenchmark.Current.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetType(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredLhsAndRhsAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.Source value)
                {
                    CheckValidInstance();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.CmakePresetsBenchmark.Current.JsonString.Source lhs, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source rhs)
            {
