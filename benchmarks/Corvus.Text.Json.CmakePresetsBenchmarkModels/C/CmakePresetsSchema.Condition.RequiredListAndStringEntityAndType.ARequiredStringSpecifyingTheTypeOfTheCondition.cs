...
public readonly partial struct CmakePresetsSchema
{
    ...
    public readonly partial struct Condition
    {
        ...
        /// Generated from JSON Schema.
        /// </summary>
        public readonly partial struct RequiredListAndStringEntityAndType
        {
            /// <summary>
            /// Generated from JSON Schema.
            /// </summary>
            ...
            public readonly partial struct ARequiredStringSpecifyingTheTypeOfTheCondition
#if NET8_0_OR_GREATER
                : IJsonElement<ARequiredStringSpecifyingTheTypeOfTheCondition>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="ARequiredStringSpecifyingTheTypeOfTheCondition"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal ARequiredStringSpecifyingTheTypeOfTheCondition(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static ARequiredStringSpecifyingTheTypeOfTheCondition DefaultInstance { get; }

                /// <summary>
                /// Gets the const instance.
                /// </summary>
                public static ARequiredStringSpecifyingTheTypeOfTheCondition ConstInstance => Constants.ConstJson;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(ARequiredStringSpecifyingTheTypeOfTheCondition value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in ARequiredStringSpecifyingTheTypeOfTheCondition left, in ARequiredStringSpecifyingTheTypeOfTheCondition right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in ARequiredStringSpecifyingTheTypeOfTheCondition left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(ARequiredStringSpecifyingTheTypeOfTheCondition instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ARequiredStringSpecifyingTheTypeOfTheCondition(JsonElement instance)
                {
                    return ARequiredStringSpecifyingTheTypeOfTheCondition.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ARequiredStringSpecifyingTheTypeOfTheCondition From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ARequiredStringSpecifyingTheTypeOfTheCondition ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ARequiredStringSpecifyingTheTypeOfTheCondition>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ARequiredStringSpecifyingTheTypeOfTheCondition ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ARequiredStringSpecifyingTheTypeOfTheCondition>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ARequiredStringSpecifyingTheTypeOfTheCondition ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ARequiredStringSpecifyingTheTypeOfTheCondition>(json, options);
                }
                ...
                /// </exception>
                public static ARequiredStringSpecifyingTheTypeOfTheCondition ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<ARequiredStringSpecifyingTheTypeOfTheCondition>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out ARequiredStringSpecifyingTheTypeOfTheCondition? result)
                {
                    return JsonElementHelpers.TryParseValue<ARequiredStringSpecifyingTheTypeOfTheCondition>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ARequiredStringSpecifyingTheTypeOfTheCondition(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static ARequiredStringSpecifyingTheTypeOfTheCondition IJsonElement<ARequiredStringSpecifyingTheTypeOfTheCondition>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ARequiredStringSpecifyingTheTypeOfTheCondition: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ARequiredStringSpecifyingTheTypeOfTheCondition"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ARequiredStringSpecifyingTheTypeOfTheCondition"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public ARequiredStringSpecifyingTheTypeOfTheCondition Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ARequiredStringSpecifyingTheTypeOfTheCondition>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ARequiredStringSpecifyingTheTypeOfTheCondition"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public ARequiredStringSpecifyingTheTypeOfTheCondition Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<ARequiredStringSpecifyingTheTypeOfTheCondition>(_idx);
                    }
