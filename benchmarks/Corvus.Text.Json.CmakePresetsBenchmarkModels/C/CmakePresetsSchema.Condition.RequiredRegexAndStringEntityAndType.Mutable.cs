    ...
    public readonly partial struct Condition
    {
        ...
        public readonly partial struct RequiredRegexAndStringEntityAndType
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequiredRegexAndStringEntityAndType instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequiredRegexAndStringEntityAndType"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredRegexAndStringEntityAndType(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredRegexAndStringEntityAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.Mutable Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredRegexAndStringEntityAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetType(scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredRegexAndStringEntityAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.Source value)
                {
                    CheckValidInstance();
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredRegexAndStringEntityAndType.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredRegexAndStringEntityAndType Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredRegexAndStringEntityAndType Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequiredRegexAndStringEntityAndType>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredRegexAndStringEntityAndType.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                public static implicit operator Source(RequiredRegexAndStringEntityAndType instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredRegexAndStringEntityAndType.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="RequiredRegexAndStringEntityAndType"/>.
                /// </summary>
                    ...
                    in Corvus.CmakePresetsBenchmark.Current.JsonString.Source stringValue)
                {
                    ...
                    builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.Type, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredRegexAndStringEntityAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.ConstInstance);
                }
            ...
            {
                return workspace.CreateBuilder<RequiredRegexAndStringEntityAndType, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RequiredRegexAndStringEntityAndType> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RequiredRegexAndStringEntityAndType>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredRegexAndStringEntityAndType> Create<TContext>(
            ...
            public static ParsedJsonDocument<RequiredRegexAndStringEntityAndType> Create(in Corvus.CmakePresetsBenchmark.Current.JsonString.Source regex, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source stringValue, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
