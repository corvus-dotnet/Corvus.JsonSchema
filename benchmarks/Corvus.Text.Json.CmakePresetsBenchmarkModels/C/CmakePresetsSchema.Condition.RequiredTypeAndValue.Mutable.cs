    ...
    public readonly partial struct Condition
    {
        ...
        public readonly partial struct RequiredTypeAndValue
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredTypeAndValue.ARequiredStringSpecifyingTheTypeOfTheCondition.Mutable Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredTypeAndValue.ARequiredStringSpecifyingTheTypeOfTheCondition.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Mutable Value
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Mutable value))
                        {
                            return value;
                        }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredTypeAndValue.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source value)
                {
                    builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.Type, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredTypeAndValue.ARequiredStringSpecifyingTheTypeOfTheCondition.ConstInstance);
                ...
                /// Creates an instance of a <see cref="RequiredTypeAndValue"/>.
                /// </summary>
                public void Create(in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source value)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source value, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            public static ParsedJsonDocument<RequiredTypeAndValue> Create(in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source value, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
