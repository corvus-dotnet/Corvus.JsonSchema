            ...
            public readonly partial struct CacheVariablesEntity
            {
                ...
                public readonly partial struct AdditionalPropertiesEntity
                {
                    ...
                    public readonly partial struct AnObjectRepresentingTheTypeAndValueOfTheVariable
                    {
                        ...
                        public static ParsedJsonDocument<AnObjectRepresentingTheTypeAndValueOfTheVariable> Create(
                            scoped in Source value, int initialCapacity = 30)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<AnObjectRepresentingTheTypeAndValueOfTheVariable>();
                            }
                            finally
                            {
                        ...
                        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                        public static ParsedJsonDocument<AnObjectRepresentingTheTypeAndValueOfTheVariable> Create<TContext>(
                        ...
                        public static ParsedJsonDocument<AnObjectRepresentingTheTypeAndValueOfTheVariable> Create(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.CacheVariablesEntity.AdditionalPropertiesEntity.AnObjectRepresentingTheTypeAndValueOfTheVariable.ValueEntity.Source value, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source type = default, int initialCapacity = 30)
                        {
                            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                            try
                            {
