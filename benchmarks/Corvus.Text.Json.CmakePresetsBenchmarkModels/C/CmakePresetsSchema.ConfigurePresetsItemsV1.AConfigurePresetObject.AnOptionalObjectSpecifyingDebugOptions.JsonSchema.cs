        ...
        public readonly partial struct AConfigurePresetObject
        {
                ...
                : IJsonElement<AnOptionalObjectSpecifyingDebugOptions>
            {
                public static partial class JsonSchema
                {
                    ...
                    private static void MatchFind(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                    {
                    ...
                    private static void MatchTryCompile(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/configurePresetsItemsV1/items/properties/debug"u8, buffer, out written);
