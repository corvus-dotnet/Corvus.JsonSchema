        ...
        public readonly partial struct AConfigurePresetObject
        {
            ...
            public readonly partial struct AnOptionalObjectSpecifyingDebugOptions
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Mutable Find
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FindUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Mutable Output
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OutputUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Mutable TryCompile
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TryCompileUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetFind(scoped in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetOutput(scoped in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetTryCompile(scoped in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source value)
                    {
                        CheckValidInstance();
                    ...
                    public bool TryGetFlags(out Flags result)
                    {
                        ...
                        if (element.TryGetProperty(JsonPropertyNames.FindUtf8, out propertyValue) && propertyValue.ValueKind == JsonValueKind.True)
                        {
                            flags |= Flags.Find;
                        }

                        if (element.TryGetProperty(JsonPropertyNames.OutputUtf8, out propertyValue) && propertyValue.ValueKind == JsonValueKind.True)
                        {
                            flags |= Flags.Output;
                        }

                        if (element.TryGetProperty(JsonPropertyNames.TryCompileUtf8, out propertyValue) && propertyValue.ValueKind == JsonValueKind.True)
                        {
                            flags |= Flags.TryCompile;
                        }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.AnOptionalObjectSpecifyingDebugOptions.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source arg1, scoped in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source arg2, scoped in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source arg3)
                    {
                        _createArg1 = arg1;
                        _createArg2 = arg2;
                        _createArg3 = arg3;
                    ...
                    public static implicit operator Source(Flags value) => AnOptionalObjectSpecifyingDebugOptions.Build((value & Flags.Find) != 0, (value & Flags.Output) != 0, (value & Flags.TryCompile) != 0);
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.AnOptionalObjectSpecifyingDebugOptions.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source find = default,
                    ...
                    internal static void BuildCreateValue(scoped in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source arg1, scoped in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source arg2, scoped in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source arg3, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                ...
                /// <param name="tryCompile">The value of the <c>"tryCompile"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source find = default, scoped in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source output = default, scoped in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source tryCompile = default)
                {
                    return new Source(find, output, tryCompile);
                }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source find = default, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source output = default, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source tryCompile = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                public static ParsedJsonDocument<AnOptionalObjectSpecifyingDebugOptions> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<AnOptionalObjectSpecifyingDebugOptions>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<AnOptionalObjectSpecifyingDebugOptions> Create<TContext>(
                ...
                public static ParsedJsonDocument<AnOptionalObjectSpecifyingDebugOptions> Create(in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source find = default, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source output = default, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source tryCompile = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
