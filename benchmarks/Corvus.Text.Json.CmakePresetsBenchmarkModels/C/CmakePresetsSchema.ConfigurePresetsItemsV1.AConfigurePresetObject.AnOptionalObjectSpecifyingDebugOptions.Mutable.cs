        ...
        public readonly partial struct AConfigurePresetObject
        {
            ...
            public readonly partial struct AnOptionalObjectSpecifyingDebugOptions
            {
...
#endif
                {
                    ...
                    public void SetFind(in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetOutput(in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetTryCompile(in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source value)
                    {
                        CheckValidInstance();
                ...
                public ref struct Source
                {
                    ...
                    internal Source(in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source arg1, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source arg2, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source arg3)
                    {
                        _createArg1 = arg1;
                        _createArg2 = arg2;
                        _createArg3 = arg3;
                ...
                public ref struct Builder
                {
                    ...
                    internal static void BuildCreateValue(in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source arg1, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source arg2, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source arg3, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source find = default, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source output = default, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source tryCompile = default)
                {
