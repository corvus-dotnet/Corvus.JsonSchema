    ...
    public readonly partial struct ConfigurePresetsItemsV1
    {
        ...
        public readonly partial struct AConfigurePresetObject
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Current.JsonBoolean Find
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FindUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonBoolean value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Current.JsonBoolean Output
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OutputUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonBoolean value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Current.JsonBoolean TryCompile
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TryCompileUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonBoolean value))
                        {
                            return value;
                        }
                ...
                private static class JsonPropertyNamesPrebaked
                {
                    ...
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="TryCompile"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> TryCompile => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x74, 0x72, 0x79, 0x43, 0x6F, 0x6D, 0x70, 0x69, 0x6C, 0x65, 0x22];
                }
            }
        }
    }
