...
public readonly partial struct CmakePresetsSchema
{
    ...
    public readonly partial struct ConfigurePresetsItemsV1
    {
        ...
        public readonly partial struct AConfigurePresetObject
        {
            ...
            public readonly partial struct AnOptionalObjectSpecifyingErrors
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(AnOptionalObjectSpecifyingErrors instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="AnOptionalObjectSpecifyingErrors"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AnOptionalObjectSpecifyingErrors(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Mutable Deprecated
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DeprecatedUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Mutable Dev
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DevUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Mutable value))
                            {
                                return value;
                            }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new AnOptionalObjectSpecifyingErrors(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    public void SetDev(scoped in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source value)
                    {
                        ...
                        if (value.IsUndefined)
                        {
                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DevUtf8);
                            _documentVersion = _parent.Version;
                            return;
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DevUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                            // We are going to replace just the value
                            value.AddAsItem(ref cvb);
                            _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                        ...
                        {
                            // We are going to insert the new value
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Dev, ref cvb);
                            int endIndex = _idx + _parent.GetDbSize(_idx, false);
                            _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                        }
                    ...
                    /// <summary>
                    /// Remove the <c>dev</c> property, if present.
                    /// </summary>
                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                    public bool RemoveDev()
                    {
                        CheckValidInstance();
                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DevUtf8);
                        _documentVersion = _parent.Version;
                        return result;
                    }
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AnOptionalObjectSpecifyingErrors.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="AnOptionalObjectSpecifyingErrors"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="AnOptionalObjectSpecifyingErrors"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AnOptionalObjectSpecifyingErrors Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<AnOptionalObjectSpecifyingErrors>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="AnOptionalObjectSpecifyingErrors"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AnOptionalObjectSpecifyingErrors Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<AnOptionalObjectSpecifyingErrors>(_idx);
                    }
                    ...
                    public bool TryGetFlags(out Flags result)
                    {
                        ...
                        if (element.TryGetProperty(JsonPropertyNames.DeprecatedUtf8, out propertyValue) && propertyValue.ValueKind == JsonValueKind.True)
                        {
                            flags |= Flags.Deprecated;
                        }

                        if (element.TryGetProperty(JsonPropertyNames.DevUtf8, out propertyValue) && propertyValue.ValueKind == JsonValueKind.True)
                        {
                            flags |= Flags.Dev;
                        }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(AnOptionalObjectSpecifyingErrors instance) => new(JsonElement.From(instance));

                    public static implicit operator Source(Flags value) => AnOptionalObjectSpecifyingErrors.Build((value & Flags.Deprecated) != 0, (value & Flags.Dev) != 0);
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.AnOptionalObjectSpecifyingErrors.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="AnOptionalObjectSpecifyingErrors"/>.
                    /// </summary>
                    internal static void Create(
                        ref ComplexValueBuilder builder,
                        in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source deprecated = default,
                        in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source dev = default)
                    {
                        deprecated.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Deprecated, ref builder);
                        dev.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Dev, ref builder);
                    }

                    /// <summary>
                    /// Creates an instance of a <see cref="AnOptionalObjectSpecifyingErrors"/>.
                    /// </summary>
                    public void Create(in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source deprecated = default, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source dev = default)
                    {
                        Create(ref _builder, deprecated, dev);
                    }
                ...
                /// <param name="dev">The value of the property.</param>
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source deprecated = default, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source dev = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(deprecated, dev);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<AnOptionalObjectSpecifyingErrors, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<AnOptionalObjectSpecifyingErrors> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<AnOptionalObjectSpecifyingErrors>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<AnOptionalObjectSpecifyingErrors> Create<TContext>(
                ...
                public static ParsedJsonDocument<AnOptionalObjectSpecifyingErrors> Create(in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source deprecated = default, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source dev = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
