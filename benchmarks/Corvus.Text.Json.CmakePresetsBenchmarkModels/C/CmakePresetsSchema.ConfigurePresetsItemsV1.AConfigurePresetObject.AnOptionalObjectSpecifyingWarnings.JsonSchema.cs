        ...
        public readonly partial struct AConfigurePresetObject
        {
                ...
                : IJsonElement<AnOptionalObjectSpecifyingWarnings>
            {
                public static partial class JsonSchema
                {
                    ...
                    private static readonly JsonSchemaPathProvider DevSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/dev"u8, buffer, out written);
                    private static readonly JsonSchemaPathProvider SystemVarsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/systemVars"u8, buffer, out written);
                    ...
                    private static void MatchDev(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        ...
                        JsonSchemaContext childContext1 =
                            Corvus.CmakePresetsBenchmark.Current.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                                ...
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.DevUtf8,
                                evaluationPath: DevSchemaEvaluationPath);
                    ...
                    private static void MatchSystemVars(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        ...
                        JsonSchemaContext childContext2 =
                            Corvus.CmakePresetsBenchmark.Current.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                                ...
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.SystemVarsUtf8,
                                evaluationPath: SystemVarsSchemaEvaluationPath);

                        Corvus.CmakePresetsBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                    ...
                    private static void MatchUninitialized(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        ...
                        JsonSchemaContext childContext3 =
                            Corvus.CmakePresetsBenchmark.Current.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                                ...
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.UninitializedUtf8,
                                evaluationPath: UninitializedSchemaEvaluationPath);

                        Corvus.CmakePresetsBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
                    ...
                    private static void MatchUnusedCli(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        ...
                        JsonSchemaContext childContext4 =
                            Corvus.CmakePresetsBenchmark.Current.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                                ...
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.UnusedCliUtf8,
                                evaluationPath: UnusedCliSchemaEvaluationPath);

                        Corvus.CmakePresetsBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext4);
                    ...
                    private static PropertySchemaMatchers<Corvus.CmakePresetsBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                    {
                        return new PropertySchemaMatchers<Corvus.CmakePresetsBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1>([
                            ...
                            (static () => JsonPropertyNames.DevUtf8, MatchDev),
                            (static () => JsonPropertyNames.SystemVarsUtf8, MatchSystemVars),
                            (static () => JsonPropertyNames.UninitializedUtf8, MatchUninitialized),
                            (static () => JsonPropertyNames.UnusedCliUtf8, MatchUnusedCli),
                        ]);
                    }
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("cmake-presets-schema.json#/definitions/configurePresetsItemsV1/items/properties/warnings"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "cmake-presets-schema.json#/definitions/configurePresetsItemsV1/items/properties/warnings";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "cmake-presets-schema.json#/definitions/configurePresetsItemsV1/items/properties/warnings"u8;
