        ...
        public readonly partial struct AConfigurePresetObject
        {
            ...
            public readonly partial struct AnOptionalObjectSpecifyingWarnings
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(AnOptionalObjectSpecifyingWarnings instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="AnOptionalObjectSpecifyingWarnings"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AnOptionalObjectSpecifyingWarnings(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Mutable SystemVars
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SystemVarsUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Mutable Uninitialized
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UninitializedUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Mutable UnusedCli
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UnusedCliUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetSystemVars(scoped in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source value)
                    {
                        ...
                        if (value.IsUndefined)
                        {
                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SystemVarsUtf8);
                            _documentVersion = _parent.Version;
                            return;
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SystemVarsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                            // We are going to replace just the value
                            value.AddAsItem(ref cvb);
                            _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                        ...
                        {
                            // We are going to insert the new value
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.SystemVars, ref cvb);
                            int endIndex = _idx + _parent.GetDbSize(_idx, false);
                            _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                        }
                    ...
                    /// <summary>
                    /// Remove the <c>systemVars</c> property, if present.
                    /// </summary>
                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                    public bool RemoveSystemVars()
                    {
                        CheckValidInstance();
                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SystemVarsUtf8);
                        _documentVersion = _parent.Version;
                        return result;
                    }
                    ...
                    public void SetUninitialized(scoped in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source value)
                    {
                        ...
                        if (value.IsUndefined)
                        {
                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.UninitializedUtf8);
                            _documentVersion = _parent.Version;
                            return;
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UninitializedUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                            // We are going to replace just the value
                            value.AddAsItem(ref cvb);
                            _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                        ...
                        {
                            // We are going to insert the new value
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Uninitialized, ref cvb);
                            int endIndex = _idx + _parent.GetDbSize(_idx, false);
                            _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                        }
                    ...
                    /// <summary>
                    /// Remove the <c>uninitialized</c> property, if present.
                    /// </summary>
                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                    public bool RemoveUninitialized()
                    {
                        CheckValidInstance();
                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.UninitializedUtf8);
                        _documentVersion = _parent.Version;
                        return result;
                    }
                    ...
                    public void SetUnusedCli(scoped in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source value)
                    {
                        ...
                        if (value.IsUndefined)
                        {
                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.UnusedCliUtf8);
                            _documentVersion = _parent.Version;
                            return;
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UnusedCliUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                            // We are going to replace just the value
                            value.AddAsItem(ref cvb);
                            _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                        ...
                        {
                            // We are going to insert the new value
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.UnusedCli, ref cvb);
                            int endIndex = _idx + _parent.GetDbSize(_idx, false);
                            _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                        }
                    ...
                    /// <summary>
                    /// Remove the <c>unusedCli</c> property, if present.
                    /// </summary>
                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                    public bool RemoveUnusedCli()
                    {
                        CheckValidInstance();
                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.UnusedCliUtf8);
                        _documentVersion = _parent.Version;
                        return result;
                    }
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AnOptionalObjectSpecifyingWarnings.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AnOptionalObjectSpecifyingWarnings Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AnOptionalObjectSpecifyingWarnings Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<AnOptionalObjectSpecifyingWarnings>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(Flags value) => AnOptionalObjectSpecifyingWarnings.Build((value & Flags.Deprecated) != 0, (value & Flags.Dev) != 0, (value & Flags.SystemVars) != 0, (value & Flags.Uninitialized) != 0, (value & Flags.UnusedCli) != 0);
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.AnOptionalObjectSpecifyingWarnings.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="AnOptionalObjectSpecifyingWarnings"/>.
                    /// </summary>
                    internal static void Create(
                        ...
                        in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source systemVars = default,
                        in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source uninitialized = default,
                        in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source unusedCli = default)
                    {
                        ...
                        systemVars.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.SystemVars, ref builder);
                        uninitialized.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Uninitialized, ref builder);
                        unusedCli.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.UnusedCli, ref builder);
                    }
                    ...
                    public void Create(
                        ...
                        in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source unusedCli = default)
                    {
                        Create(ref _builder, deprecated, dev, systemVars, uninitialized, unusedCli);
                    }
                ...
                /// <param name="systemVars">The value of the property.</param>
                /// <param name="uninitialized">The value of the property.</param>
                /// <param name="unusedCli">The value of the property.</param>
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source deprecated = default, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source dev = default, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source systemVars = default, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source uninitialized = default, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source unusedCli = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(deprecated, dev, systemVars, uninitialized, unusedCli);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<AnOptionalObjectSpecifyingWarnings, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<AnOptionalObjectSpecifyingWarnings> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<AnOptionalObjectSpecifyingWarnings>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<AnOptionalObjectSpecifyingWarnings> Create<TContext>(
                ...
                public static ParsedJsonDocument<AnOptionalObjectSpecifyingWarnings> Create(in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source deprecated = default, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source dev = default, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source systemVars = default, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source uninitialized = default, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source unusedCli = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
