            ...
            public readonly partial struct ArchitectureEntity
            {
                ...
                public readonly partial struct AnyOf1Entity
                {
...
#endif
                    {
                        ...
                        public void SetStrategy(scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity.AnyOf1Entity.StrategyEntity.Source value)
                        {
                            CheckValidInstance();
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity.AnyOf1Entity.StrategyEntity.Source arg1, scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source arg2)
                        {
                            _createArg1 = arg1;
                            _createArg2 = arg2;
                            _kind = Kind.Create;
                    ...
                    /// <returns>The source from which to build the value.</returns>
                    public static Source Build(scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity.AnyOf1Entity.StrategyEntity.Source strategy = default, scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source value = default)
                    {
