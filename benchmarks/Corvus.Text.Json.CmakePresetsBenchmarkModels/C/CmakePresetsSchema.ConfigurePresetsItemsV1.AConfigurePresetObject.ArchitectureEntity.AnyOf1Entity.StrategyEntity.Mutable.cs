                ...
                public readonly partial struct AnyOf1Entity
                {
                    ...
                    public readonly partial struct StrategyEntity
                    {
                        ...
                        public ref struct Source
                        {
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator Source(KnownValues value) => (StrategyEntity)value;
                        ...
                        public static ParsedJsonDocument<StrategyEntity> Create(
                            scoped in Source value, int initialCapacity = 1)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<StrategyEntity>();
                            }
                            finally
                            {
