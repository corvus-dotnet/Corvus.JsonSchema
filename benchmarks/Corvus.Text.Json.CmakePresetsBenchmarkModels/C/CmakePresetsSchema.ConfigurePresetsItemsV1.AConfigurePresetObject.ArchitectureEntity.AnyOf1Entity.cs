        ...
        public readonly partial struct AConfigurePresetObject
        {
            ...
            public readonly partial struct ArchitectureEntity
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity.AnyOf1Entity.StrategyEntity Strategy
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StrategyUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity.AnyOf1Entity.StrategyEntity value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Current.JsonString Value
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonString value))
                            {
                                return value;
                            }
                    ...
                    {
                        /// <summary>
                        /// Gets the pre-baked property name blob for <see cref="Strategy"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> Strategy => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x73, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x22];
