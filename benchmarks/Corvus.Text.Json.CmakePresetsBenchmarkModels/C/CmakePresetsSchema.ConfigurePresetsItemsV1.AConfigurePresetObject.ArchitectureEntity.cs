    ...
    public readonly partial struct ConfigurePresetsItemsV1
    {
        ...
        public readonly partial struct AConfigurePresetObject
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="ArchitectureEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal ArchitectureEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static ArchitectureEntity DefaultInstance { get; }
                ...
                /// <summary>
                /// Conversion to <see cref="Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity.AnyOf1Entity"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity.AnyOf1Entity(ArchitectureEntity value)
                {
                    return Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity.AnyOf1Entity.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity.AnyOf1Entity"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator ArchitectureEntity(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity.AnyOf1Entity value)
                {
                    return From(value);
                }

                /// <summary>
                /// Conversion from the <see cref="Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity.AnyOf1Entity"/> mutable view.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator ArchitectureEntity(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity.AnyOf1Entity.Mutable value)
                {
                    return From(value);
                }

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(ArchitectureEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in ArchitectureEntity left, in ArchitectureEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in ArchitectureEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(ArchitectureEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ArchitectureEntity(JsonElement instance)
                {
                    return ArchitectureEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ArchitectureEntity From<T>(in T instance)
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ArchitectureEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<ArchitectureEntity>(utf8Json, options);
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ArchitectureEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<ArchitectureEntity>(json, options);
                    #pragma warning restore CS0618
                }
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ArchitectureEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<ArchitectureEntity>(json, options);
                    #pragma warning restore CS0618
                ...
                /// </exception>
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                public static ArchitectureEntity ParseValue(ref Utf8JsonReader reader)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<ArchitectureEntity>(ref reader);
                    #pragma warning restore CS0618
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out ArchitectureEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<ArchitectureEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ArchitectureEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static ArchitectureEntity IJsonElement<ArchitectureEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ArchitectureEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ArchitectureEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ArchitectureEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public ArchitectureEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ArchitectureEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ArchitectureEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public ArchitectureEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<ArchitectureEntity>(_idx);
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity.AnyOf1Entity" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsAnyOf1Entity(out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity.AnyOf1Entity result)
                {
                    ...
                    {
                        result = Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity.AnyOf1Entity.From(this);
                        return true;
                    }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity.AnyOf1Entity, TContext, TResult> matchAnyOf1Entity,
                    Matcher<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    if (Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchAnyOf1Entity(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity.AnyOf1Entity.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity.AnyOf1Entity, TResult> matchAnyOf1Entity,
                    Matcher<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity, TResult> defaultMatch)
                {
                    if (Corvus.CmakePresetsBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                    ...
                    if (Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchAnyOf1Entity(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity.AnyOf1Entity.From(this));
                    }
                ...
                public TAccumulator MatchEvery<TAccumulator>(
                    ...
                    Matcher<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity, TAccumulator, TAccumulator> defaultMatch)
                {
                    bool matched = false;
                    ...
                    {
                        matched = true;
                        accumulator = matchAnyOf1Entity(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ArchitectureEntity.AnyOf1Entity.From(this), accumulator);
                    }
