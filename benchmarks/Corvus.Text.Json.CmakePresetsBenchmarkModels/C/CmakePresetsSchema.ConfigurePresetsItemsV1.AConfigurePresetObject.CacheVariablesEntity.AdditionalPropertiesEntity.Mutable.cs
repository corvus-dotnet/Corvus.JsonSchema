        ...
        public readonly partial struct AConfigurePresetObject
        {
            ...
            public readonly partial struct CacheVariablesEntity
            {
                ...
                public readonly partial struct AdditionalPropertiesEntity
                {
                    ...
                    /// <returns>An instance of a mutable document initialized with the given value.</returns>
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(
                        JsonWorkspace workspace, scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.CacheVariablesEntity.AdditionalPropertiesEntity.AnObjectRepresentingTheTypeAndValueOfTheVariable.Builder.Build value, int initialCapacity = 30)
                    {
                        // Create the document builder without a MetadataDb
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
