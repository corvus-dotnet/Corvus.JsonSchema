            ...
            public readonly partial struct ToolsetEntity
            {
                ...
                public readonly partial struct AnyOf1Entity
                {
...
#endif
                    {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.StrategyEntity.Mutable Strategy
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StrategyUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.StrategyEntity.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.CmakePresetsBenchmark.Current.JsonString.Mutable Value
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonString.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        public void SetStrategy(scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.StrategyEntity.Source value)
                        {
                            CheckValidInstance();

                            if (value.IsUndefined)
                            {
                                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.StrategyUtf8);
                                _documentVersion = _parent.Version;
                                return;
                            }

                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StrategyUtf8, out IJsonDocument? elementParent, out int elementIdx))
                            {
                            ...
                            else
                            {
                                ...
                                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Strategy, ref cvb);
                        ...
                        public bool RemoveStrategy()
                        {
                            CheckValidInstance();
                            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.StrategyUtf8);
                            _documentVersion = _parent.Version;
                            return result;
                        }
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetValue(scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source value)
                        {
                            CheckValidInstance();
                    ...
                    public ref struct Source
                    {
                        ...
                        private readonly Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.StrategyEntity.Source _createArg1;
                        ...
                        internal Source(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                        internal Source(scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.StrategyEntity.Source arg1, scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source arg2)
                        {
                            _createArg1 = arg1;
                            _createArg2 = arg2;
                            _kind = Kind.Create;
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        internal static void Create(
                            ...
                            in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.StrategyEntity.Source strategy = default,
                            in Corvus.CmakePresetsBenchmark.Current.JsonString.Source value = default)
                        {
                            strategy.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Strategy, ref builder);
                        ...
                        /// Creates an instance of a <see cref="AnyOf1Entity"/>.
                        /// </summary>
                        public void Create(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.StrategyEntity.Source strategy = default, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source value = default)
                        {
                            Create(ref _builder, strategy, value);
                        }
                        ...
                        internal static void BuildCreateValue(scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.StrategyEntity.Source arg1, scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source arg2, ref ComplexValueBuilder o)
                        {
                            o.StartObject();
                    ...
                    /// <returns>The source from which to build the value.</returns>
                    public static Source Build(scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.StrategyEntity.Source strategy = default, scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source value = default)
                    {
                        return new Source(strategy, value);
                    }
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.StrategyEntity.Source strategy = default, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source value = default, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(strategy, value);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    public static ParsedJsonDocument<AnyOf1Entity> Create(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.ToolsetEntity.AnyOf1Entity.StrategyEntity.Source strategy = default, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source value = default, int initialCapacity = 30)
                    {
                        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                        try
                        {
