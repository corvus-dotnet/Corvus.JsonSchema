                        ...
                        public readonly partial struct ValueEntity
                        {
...
#endif
                            {
                                ...
                                public TResult Match<TContext, TResult>(
                                    ...
                                    Matcher<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.CacheVariablesEntity.AdditionalPropertiesEntity.AnObjectRepresentingTheTypeAndValueOfTheVariable.ValueEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
                                {
                                    ...
                                    {
                                        return matchJsonBoolean(Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Mutable.From(this), context);
                                    }
                                ...
                                public TResult Match<TResult>(
                                    ...
                                    Matcher<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.CacheVariablesEntity.AdditionalPropertiesEntity.AnObjectRepresentingTheTypeAndValueOfTheVariable.ValueEntity.Mutable, TResult> defaultMatch)
                                {
                                    if (Corvus.CmakePresetsBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                                    {
                                        return matchJsonBoolean(Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Mutable.From(this));
                                    }
                                ...
                                public bool TryGetAsJsonBoolean(out Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Mutable result)
                                {
                                    if (Corvus.CmakePresetsBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                                    {
                                        result = Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Mutable.From(this);
                                        return true;
                                    }
