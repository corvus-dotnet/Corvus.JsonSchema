...
public readonly partial struct CmakePresetsSchema
{
    ...
    public readonly partial struct ConfigurePresetsItemsV1
    {
...
#endif
        {
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1.AConfigurePresetObject.Source value)
            {
                CheckValidInstance();
