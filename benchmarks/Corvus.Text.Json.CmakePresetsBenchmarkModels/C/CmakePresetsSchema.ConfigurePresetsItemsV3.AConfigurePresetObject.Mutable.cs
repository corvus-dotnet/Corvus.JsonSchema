    ...
    public readonly partial struct ConfigurePresetsItemsV3
    {
        ...
        public readonly partial struct AConfigurePresetObject
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Current.JsonString.Mutable InstallDir
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InstallDirUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.CmakePresetsBenchmark.Current.JsonString.Mutable ToolchainFile
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ToolchainFileUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetBinaryDir(scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source value)
                {
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.BinaryDir, ref cvb);
                ...
                public void SetGenerator(scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Generator, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                public void SetInstallDir(scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.InstallDir, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                public void SetToolchainFile(scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ToolchainFile, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.CmakePresetsBenchmark.Current.JsonString.Source _createArg5;
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.CmakePresetsBenchmark.Current.JsonString.Source installDir = default,
                    in Corvus.CmakePresetsBenchmark.Current.JsonString.Source toolchainFile = default)
                {
                    binaryDir.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.BinaryDir, ref builder);
                    condition.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Condition, ref builder);
                    generator.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Generator, ref builder);
                    installDir.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.InstallDir, ref builder);
                    toolchainFile.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ToolchainFile, ref builder);
                }
                ...
                public void Create(
                    ...
                    in Corvus.CmakePresetsBenchmark.Current.JsonString.Source toolchainFile = default)
                {
                    Create(ref _builder, binaryDir, condition, generator, installDir, toolchainFile);
                }
                ...
                #endif
                {
                    Create(context, ref _builder, binaryDir, condition, generator, installDir, toolchainFile);
                }
            ...
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source binaryDir = default, scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TopCondition.Source<TContext> condition = default, scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source generator = default, scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source installDir = default, scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source toolchainFile = default)
                ...
                #endif
            {
                return new Source<TContext>(context, binaryDir, condition, generator, installDir, toolchainFile);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source binaryDir = default, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TopCondition.Source condition = default, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source generator = default, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source installDir = default, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source toolchainFile = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(binaryDir, condition, generator, installDir, toolchainFile);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source binaryDir = default, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TopCondition.Source<TContext> condition = default, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source generator = default, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source installDir = default, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source toolchainFile = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, binaryDir, condition, generator, installDir, toolchainFile);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            public static ParsedJsonDocument<AConfigurePresetObject> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AConfigurePresetObject>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<AConfigurePresetObject> Create<TContext>(
            ...
            public static ParsedJsonDocument<AConfigurePresetObject> Create(in Corvus.CmakePresetsBenchmark.Current.JsonString.Source binaryDir = default, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TopCondition.Source condition = default, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source generator = default, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source installDir = default, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source toolchainFile = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<AConfigurePresetObject> Create<TContext>(in TContext context, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source binaryDir = default, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TopCondition.Source<TContext> condition = default, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source generator = default, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source installDir = default, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source toolchainFile = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
