        ...
        public readonly partial struct AConfigurePresetObject
        {
                ...
                : IJsonElement<AnOptionalObjectSpecifyingTraceOptions>
            {
                public static partial class JsonSchema
                {
                    ...
                    private static void MatchSourceValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/configurePresetsItemsV7/items/properties/trace"u8, buffer, out written);
