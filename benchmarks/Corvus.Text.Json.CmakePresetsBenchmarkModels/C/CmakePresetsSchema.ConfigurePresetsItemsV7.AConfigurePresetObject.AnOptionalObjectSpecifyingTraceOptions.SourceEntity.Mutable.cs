                ...
                public readonly partial struct SourceEntity
                {
...
#endif
                    {
                        ...
                        public TAccumulator MatchEvery<TAccumulator>(
                            ...
                            Matcher<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV7.AConfigurePresetObject.AnOptionalObjectSpecifyingTraceOptions.SourceEntity.Mutable, TAccumulator, TAccumulator> defaultMatch)
                        {
                            bool matched = false;
                            ...
                            {
                                matched = true;
                                accumulator = matchAnyOf0Entity(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV7.AConfigurePresetObject.AnOptionalObjectSpecifyingTraceOptions.SourceEntity.AnyOf0Entity.Mutable.From(this), accumulator);
                            }

                            if (Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV7.AConfigurePresetObject.AnOptionalObjectSpecifyingTraceOptions.SourceEntity.AStringRepresentingThePathToOneSourceFileToBeTracedArray.JsonSchema.Evaluate(_parent, _idx))
                            {
                                matched = true;
                                accumulator = matchAStringRepresentingThePathToOneSourceFileToBeTracedArray(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV7.AConfigurePresetObject.AnOptionalObjectSpecifyingTraceOptions.SourceEntity.AStringRepresentingThePathToOneSourceFileToBeTracedArray.Mutable.From(this), accumulator);
                            }
