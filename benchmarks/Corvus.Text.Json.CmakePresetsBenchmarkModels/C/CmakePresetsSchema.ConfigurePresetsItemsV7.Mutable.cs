...
public readonly partial struct CmakePresetsSchema
{
    ...
    public readonly partial struct ConfigurePresetsItemsV7
    {
...
#endif
        {
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV7.AConfigurePresetObject.Source value)
            {
                CheckValidInstance();
