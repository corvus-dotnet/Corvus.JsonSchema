            ...
            public readonly partial struct AnOptionalObjectSpecifyingTraceOptions
            {
                ...
                public readonly partial struct AnOptionalStringThatSpecifiesTheTraceOutputFormat
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(AnOptionalStringThatSpecifiesTheTraceOutputFormat instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="AnOptionalStringThatSpecifiesTheTraceOutputFormat"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator AnOptionalStringThatSpecifiesTheTraceOutputFormat(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"AnOptionalStringThatSpecifiesTheTraceOutputFormat.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly AnOptionalStringThatSpecifiesTheTraceOutputFormat Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly AnOptionalStringThatSpecifiesTheTraceOutputFormat Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<AnOptionalStringThatSpecifiesTheTraceOutputFormat>(_idx);
                        }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(AnOptionalStringThatSpecifiesTheTraceOutputFormat instance) => new(JsonElement.From(instance));
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator Source(KnownValues value) => (AnOptionalStringThatSpecifiesTheTraceOutputFormat)value;
                    ...
                    {
                        return workspace.CreateBuilder<AnOptionalStringThatSpecifiesTheTraceOutputFormat, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<AnOptionalStringThatSpecifiesTheTraceOutputFormat> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<AnOptionalStringThatSpecifiesTheTraceOutputFormat>();
                        }
                        finally
                        {
