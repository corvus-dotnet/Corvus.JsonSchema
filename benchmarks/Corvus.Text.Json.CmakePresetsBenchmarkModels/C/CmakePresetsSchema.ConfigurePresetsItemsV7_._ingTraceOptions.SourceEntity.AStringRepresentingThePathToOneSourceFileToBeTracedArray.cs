            ...
            public readonly partial struct AnOptionalObjectSpecifyingTraceOptions
            {
                ...
                public readonly partial struct SourceEntity
                {
                    ...
                    public readonly partial struct AStringRepresentingThePathToOneSourceFileToBeTracedArray
                        ...
                        : IJsonElement<AStringRepresentingThePathToOneSourceFileToBeTracedArray>,
                          IFormattable,
                          ISpanFormattable,
...
#endif
                    {
                        ...
                        /// <summary>
                        /// Initializes a new instance of the <see cref="AStringRepresentingThePathToOneSourceFileToBeTracedArray"/> struct.
                        /// </summary>
                        ...
                        internal AStringRepresentingThePathToOneSourceFileToBeTracedArray(IJsonDocument parent, int idx)
                        {
                            Debug.Assert(idx >= 0);
                            _parent = parent;
                            _idx = idx;
                        ...
                        /// </summary>
                        public static AStringRepresentingThePathToOneSourceFileToBeTracedArray DefaultInstance { get; }
                        ...
                        public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV7.AConfigurePresetObject.AnOptionalObjectSpecifyingTraceOptions.SourceEntity.AStringRepresentingThePathToOneSourceFileToBeTracedArray.AStringRepresentingThePathToOneSourceFileToBeTraced this[int index]
                        {
                            get
                            {
                                CheckValidInstance();
                        ...
                        /// </returns>
                        public static bool operator ==(in AStringRepresentingThePathToOneSourceFileToBeTracedArray left, in AStringRepresentingThePathToOneSourceFileToBeTracedArray right)
                        {
                        ...
                        /// <c>True</c> if the values are equal.
                        /// </returns>
                        public static bool operator ==(in AStringRepresentingThePathToOneSourceFileToBeTracedArray left, in JsonElement right)
                        {
                            return left.Equals(right);
                        }
                        ...
                        public static implicit operator JsonElement(AStringRepresentingThePathToOneSourceFileToBeTracedArray instance)
                        {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator AStringRepresentingThePathToOneSourceFileToBeTracedArray(JsonElement instance)
                        {
                            return AStringRepresentingThePathToOneSourceFileToBeTracedArray.From(instance);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static AStringRepresentingThePathToOneSourceFileToBeTracedArray From<T>(in T instance)
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static AStringRepresentingThePathToOneSourceFileToBeTracedArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                        {
                            #pragma warning disable CS0618 // Type or member is obsolete
                            return JsonElementHelpers.ParseValue<AStringRepresentingThePathToOneSourceFileToBeTracedArray>(utf8Json, options);
                        ...
                        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static AStringRepresentingThePathToOneSourceFileToBeTracedArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                        {
                            #pragma warning disable CS0618 // Type or member is obsolete
                            return JsonElementHelpers.ParseValue<AStringRepresentingThePathToOneSourceFileToBeTracedArray>(json, options);
                            #pragma warning restore CS0618
                        }
                        ...
                        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static AStringRepresentingThePathToOneSourceFileToBeTracedArray ParseValue(string json, JsonDocumentOptions options = default)
                        {
                            #pragma warning disable CS0618 // Type or member is obsolete
                            return JsonElementHelpers.ParseValue<AStringRepresentingThePathToOneSourceFileToBeTracedArray>(json, options);
                            #pragma warning restore CS0618
                        ...
                        /// </exception>
                        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                        public static AStringRepresentingThePathToOneSourceFileToBeTracedArray ParseValue(ref Utf8JsonReader reader)
                        {
                            #pragma warning disable CS0618 // Type or member is obsolete
                            return JsonElementHelpers.ParseValue<AStringRepresentingThePathToOneSourceFileToBeTracedArray>(ref reader);
                            #pragma warning restore CS0618
                        }
                        ...
                        ///   A value could not be read from the reader.
                        /// </exception>
                        public static bool TryParseValue(ref Utf8JsonReader reader, out AStringRepresentingThePathToOneSourceFileToBeTracedArray? result)
                        {
                            return JsonElementHelpers.TryParseValue<AStringRepresentingThePathToOneSourceFileToBeTracedArray>(ref reader, out result);
                        }
...
#if NET
                        static AStringRepresentingThePathToOneSourceFileToBeTracedArray IJsonElement<AStringRepresentingThePathToOneSourceFileToBeTracedArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"AStringRepresentingThePathToOneSourceFileToBeTracedArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public AStringRepresentingThePathToOneSourceFileToBeTracedArray Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public AStringRepresentingThePathToOneSourceFileToBeTracedArray Freeze()
                        {
                            CheckValidInstance();
                            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                            {
                                return mutable.FreezeElement<AStringRepresentingThePathToOneSourceFileToBeTracedArray>(_idx);
                            }
