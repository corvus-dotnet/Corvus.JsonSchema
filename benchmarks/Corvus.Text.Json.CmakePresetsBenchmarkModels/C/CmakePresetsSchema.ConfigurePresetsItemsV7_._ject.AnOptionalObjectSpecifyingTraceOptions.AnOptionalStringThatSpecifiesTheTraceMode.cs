    ...
    public readonly partial struct ConfigurePresetsItemsV7
    {
        ...
        public readonly partial struct AConfigurePresetObject
        {
            ...
            public readonly partial struct AnOptionalObjectSpecifyingTraceOptions
            {
                ...
                public readonly partial struct AnOptionalStringThatSpecifiesTheTraceMode
#if NET8_0_OR_GREATER
                    : IJsonElement<AnOptionalStringThatSpecifiesTheTraceMode>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="AnOptionalStringThatSpecifiesTheTraceMode"/> struct.
                    /// </summary>
                    ...
                    internal AnOptionalStringThatSpecifiesTheTraceMode(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static AnOptionalStringThatSpecifiesTheTraceMode DefaultInstance { get; }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator string(AnOptionalStringThatSpecifiesTheTraceMode value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                    ...
                    /// </returns>
                    public static bool operator ==(in AnOptionalStringThatSpecifiesTheTraceMode left, in AnOptionalStringThatSpecifiesTheTraceMode right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in AnOptionalStringThatSpecifiesTheTraceMode left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(AnOptionalStringThatSpecifiesTheTraceMode instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AnOptionalStringThatSpecifiesTheTraceMode(JsonElement instance)
                    {
                        return AnOptionalStringThatSpecifiesTheTraceMode.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AnOptionalStringThatSpecifiesTheTraceMode From<T>(in T instance)
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AnOptionalStringThatSpecifiesTheTraceMode ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<AnOptionalStringThatSpecifiesTheTraceMode>(utf8Json, options);
                    ...
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AnOptionalStringThatSpecifiesTheTraceMode ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<AnOptionalStringThatSpecifiesTheTraceMode>(json, options);
                        #pragma warning restore CS0618
                    }
                    ...
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AnOptionalStringThatSpecifiesTheTraceMode ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<AnOptionalStringThatSpecifiesTheTraceMode>(json, options);
                        #pragma warning restore CS0618
                    ...
                    /// </exception>
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    public static AnOptionalStringThatSpecifiesTheTraceMode ParseValue(ref Utf8JsonReader reader)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<AnOptionalStringThatSpecifiesTheTraceMode>(ref reader);
                        #pragma warning restore CS0618
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out AnOptionalStringThatSpecifiesTheTraceMode? result)
                    {
                        return JsonElementHelpers.TryParseValue<AnOptionalStringThatSpecifiesTheTraceMode>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new AnOptionalStringThatSpecifiesTheTraceMode(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static AnOptionalStringThatSpecifiesTheTraceMode IJsonElement<AnOptionalStringThatSpecifiesTheTraceMode>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AnOptionalStringThatSpecifiesTheTraceMode: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="AnOptionalStringThatSpecifiesTheTraceMode"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="AnOptionalStringThatSpecifiesTheTraceMode"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public AnOptionalStringThatSpecifiesTheTraceMode Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<AnOptionalStringThatSpecifiesTheTraceMode>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="AnOptionalStringThatSpecifiesTheTraceMode"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public AnOptionalStringThatSpecifiesTheTraceMode Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<AnOptionalStringThatSpecifiesTheTraceMode>(_idx);
                        }
                    ...
                    /// <param name="matchOn">Match 1st item.</param>
                    /// <param name="matchOff">Match 2nd item.</param>
                    /// <param name="matchExpand">Match 3rd item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchOn,
                        Func<TContext, TResult> matchOff,
                        Func<TContext, TResult> matchExpand,
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> matchOn,
                        Func<TResult> matchOff,
                        Func<TResult> matchExpand,
