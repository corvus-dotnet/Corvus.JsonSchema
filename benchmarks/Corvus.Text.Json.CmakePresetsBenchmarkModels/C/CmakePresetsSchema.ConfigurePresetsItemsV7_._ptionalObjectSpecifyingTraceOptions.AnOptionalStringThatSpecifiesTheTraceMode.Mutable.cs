            ...
            public readonly partial struct AnOptionalObjectSpecifyingTraceOptions
            {
                ...
                public readonly partial struct AnOptionalStringThatSpecifiesTheTraceMode
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(AnOptionalStringThatSpecifiesTheTraceMode instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="AnOptionalStringThatSpecifiesTheTraceMode"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator AnOptionalStringThatSpecifiesTheTraceMode(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"AnOptionalStringThatSpecifiesTheTraceMode.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly AnOptionalStringThatSpecifiesTheTraceMode Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly AnOptionalStringThatSpecifiesTheTraceMode Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<AnOptionalStringThatSpecifiesTheTraceMode>(_idx);
                        }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(AnOptionalStringThatSpecifiesTheTraceMode instance) => new(JsonElement.From(instance));
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator Source(KnownValues value) => (AnOptionalStringThatSpecifiesTheTraceMode)value;
                    ...
                    {
                        return workspace.CreateBuilder<AnOptionalStringThatSpecifiesTheTraceMode, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<AnOptionalStringThatSpecifiesTheTraceMode> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<AnOptionalStringThatSpecifiesTheTraceMode>();
                        }
                        finally
                        {
