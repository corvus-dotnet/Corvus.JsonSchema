            ...
            public readonly partial struct AnOptionalObjectSpecifyingTraceOptions
            {
                ...
                public readonly partial struct SourceEntity
                {
                    ...
                    public readonly partial struct AStringRepresentingThePathToOneSourceFileToBeTracedArray
                    {
                        ...
                        public static ParsedJsonDocument<AStringRepresentingThePathToOneSourceFileToBeTracedArray> Create(
                            scoped in Source value, int initialCapacity = 30)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<AStringRepresentingThePathToOneSourceFileToBeTracedArray>();
                            }
                            finally
                            {
                        ...
                        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                        public static ParsedJsonDocument<AStringRepresentingThePathToOneSourceFileToBeTracedArray> Create<TContext>(
