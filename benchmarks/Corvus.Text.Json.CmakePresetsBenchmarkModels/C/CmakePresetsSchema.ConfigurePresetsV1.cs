...
public readonly partial struct CmakePresetsSchema
{
...
#endif
    {
        ...
        public static implicit operator Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1(ConfigurePresetsV1 value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator ConfigurePresetsV1(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsItemsV1 value)
        {
            return From(value);
        }
