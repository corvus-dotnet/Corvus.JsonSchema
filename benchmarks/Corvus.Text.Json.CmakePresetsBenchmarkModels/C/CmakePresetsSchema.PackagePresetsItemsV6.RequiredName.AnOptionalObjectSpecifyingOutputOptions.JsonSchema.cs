        ...
        public readonly partial struct RequiredName
        {
                ...
                : IJsonElement<AnOptionalObjectSpecifyingOutputOptions>
            {
                public static partial class JsonSchema
                {
                    ...
                    private static void MatchVerbose(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/packagePresetsItemsV6/items/properties/output"u8, buffer, out written);
