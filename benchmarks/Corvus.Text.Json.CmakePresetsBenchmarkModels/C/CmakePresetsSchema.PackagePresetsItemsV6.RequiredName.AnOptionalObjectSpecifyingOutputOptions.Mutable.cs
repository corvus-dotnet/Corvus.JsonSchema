        ...
        public readonly partial struct RequiredName
        {
            ...
            public readonly partial struct AnOptionalObjectSpecifyingOutputOptions
            {
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.PackagePresetsItemsV6.RequiredName.AnOptionalObjectSpecifyingOutputOptions.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.PackagePresetsItemsV6.RequiredName.AnOptionalObjectSpecifyingOutputOptions.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// Creates an instance of a <see cref="AnOptionalObjectSpecifyingOutputOptions"/>.
                    /// </summary>
                    public void Create(in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source debug = default, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source verbose = default)
                    {
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source debug = default, scoped in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source verbose = default)
                {
                    return new Source(debug, verbose);
                }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source debug = default, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source verbose = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                public static ParsedJsonDocument<AnOptionalObjectSpecifyingOutputOptions> Create(in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source debug = default, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source verbose = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
