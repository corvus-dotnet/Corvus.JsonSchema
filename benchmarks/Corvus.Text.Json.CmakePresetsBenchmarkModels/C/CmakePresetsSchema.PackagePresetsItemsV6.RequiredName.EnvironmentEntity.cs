    ...
    public readonly partial struct PackagePresetsItemsV6
    {
        ...
        public readonly partial struct RequiredName
        {
...
#endif
            {
                ...
                public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.PackagePresetsItemsV6.RequiredName.EnvironmentEntity.AdditionalPropertiesEntity this[ReadOnlySpan<byte> propertyName]
                {
                    get
                    {
                        CheckValidInstance();
                        if (!_parent.TryGetNamedPropertyValue(_idx, propertyName, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.PackagePresetsItemsV6.RequiredName.EnvironmentEntity.AdditionalPropertiesEntity value))
                        {
                            return default;
                        }
                ...
                /// <returns>The value of the property with the given name.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.PackagePresetsItemsV6.RequiredName.EnvironmentEntity.AdditionalPropertiesEntity this[ReadOnlySpan<char> propertyName]
                {
                    get
                    {
                        CheckValidInstance();
                ...
                /// <returns>The value of the property with the given name.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.PackagePresetsItemsV6.RequiredName.EnvironmentEntity.AdditionalPropertiesEntity this[string propertyName]
                {
                    get
                    {
                        CheckValidInstance();
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.PackagePresetsItemsV6.RequiredName.EnvironmentEntity.AdditionalPropertiesEntity value)
                {
                    CheckValidInstance();
                ...
                /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.PackagePresetsItemsV6.RequiredName.EnvironmentEntity.AdditionalPropertiesEntity value)
                {
                    CheckValidInstance();
                    return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                }
                ...
                /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public bool TryGetProperty(string propertyName, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.PackagePresetsItemsV6.RequiredName.EnvironmentEntity.AdditionalPropertiesEntity value)
                {
                    CheckValidInstance();
                    return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public ObjectEnumerator<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.PackagePresetsItemsV6.RequiredName.EnvironmentEntity.AdditionalPropertiesEntity> EnumerateObject()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateObjectEnumerator<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.PackagePresetsItemsV6.RequiredName.EnvironmentEntity.AdditionalPropertiesEntity>(_parent, _idx);
                }
