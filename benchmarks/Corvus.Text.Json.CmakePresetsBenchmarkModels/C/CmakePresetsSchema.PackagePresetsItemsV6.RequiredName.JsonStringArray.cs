    ...
    public readonly partial struct PackagePresetsItemsV6
    {
        ...
        public readonly partial struct RequiredName
        {
...
#endif
            {
                ...
                public Corvus.CmakePresetsBenchmark.Current.JsonString this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.CmakePresetsBenchmark.Current.JsonString>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.CmakePresetsBenchmark.Current.JsonString> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Current.JsonString>(_parent, _idx);
                }
