...
public readonly partial struct CmakePresetsSchema
{
    ...
    public readonly partial struct PackagePresetsItemsV6
        ...
        : IJsonElement<PackagePresetsItemsV6>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PackagePresetsItemsV6"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal PackagePresetsItemsV6(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static PackagePresetsItemsV6 DefaultInstance { get; }
        ...
        public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.PackagePresetsItemsV6.RequiredName this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.PackagePresetsItemsV6.RequiredName>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.PackagePresetsItemsV6.RequiredName> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.PackagePresetsItemsV6.RequiredName>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in PackagePresetsItemsV6 left, in PackagePresetsItemsV6 right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in PackagePresetsItemsV6 left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(PackagePresetsItemsV6 instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PackagePresetsItemsV6(JsonElement instance)
        {
            return PackagePresetsItemsV6.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PackagePresetsItemsV6 From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PackagePresetsItemsV6 ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PackagePresetsItemsV6>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PackagePresetsItemsV6 ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PackagePresetsItemsV6>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PackagePresetsItemsV6 ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PackagePresetsItemsV6>(json, options);
        }
        ...
        /// </exception>
        public static PackagePresetsItemsV6 ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<PackagePresetsItemsV6>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out PackagePresetsItemsV6? result)
        {
            return JsonElementHelpers.TryParseValue<PackagePresetsItemsV6>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PackagePresetsItemsV6(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static PackagePresetsItemsV6 IJsonElement<PackagePresetsItemsV6>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PackagePresetsItemsV6: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PackagePresetsItemsV6"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PackagePresetsItemsV6"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public PackagePresetsItemsV6 Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PackagePresetsItemsV6>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PackagePresetsItemsV6"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public PackagePresetsItemsV6 Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<PackagePresetsItemsV6>(_idx);
            }
