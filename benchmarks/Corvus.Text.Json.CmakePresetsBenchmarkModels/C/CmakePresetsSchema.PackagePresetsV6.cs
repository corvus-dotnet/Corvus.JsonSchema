...
public readonly partial struct CmakePresetsSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PackagePresetsV6"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal PackagePresetsV6(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static PackagePresetsV6 DefaultInstance { get; }
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.PackagePresetsItemsV6"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.PackagePresetsItemsV6(PackagePresetsV6 value)
        {
            return Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.PackagePresetsItemsV6.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.PackagePresetsItemsV6"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator PackagePresetsV6(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.PackagePresetsItemsV6 value)
        {
            return From(value);
        }
        ...
        /// </returns>
        public static bool operator ==(in PackagePresetsV6 left, in PackagePresetsV6 right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in PackagePresetsV6 left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(PackagePresetsV6 instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PackagePresetsV6(JsonElement instance)
        {
            return PackagePresetsV6.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PackagePresetsV6 From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PackagePresetsV6 ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PackagePresetsV6>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PackagePresetsV6 ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PackagePresetsV6>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PackagePresetsV6 ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PackagePresetsV6>(json, options);
        }
        ...
        /// </exception>
        public static PackagePresetsV6 ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<PackagePresetsV6>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out PackagePresetsV6? result)
        {
            return JsonElementHelpers.TryParseValue<PackagePresetsV6>(ref reader, out result);
        }
...
#if NET
        static PackagePresetsV6 IJsonElement<PackagePresetsV6>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PackagePresetsV6: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public PackagePresetsV6 Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<PackagePresetsV6>(_idx);
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.PackagePresetsItemsV6" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsPackagePresetsItemsV6(out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.PackagePresetsItemsV6 result)
        {
            if (Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.PackagePresetsItemsV6.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.PackagePresetsItemsV6.From(this);
                return true;
            }
