            ...
            public readonly partial struct AnOptionalObjectSpecifyingOptionsForTestExecution
            {
                ...
                public readonly partial struct RequiredCountAndMode
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RequiredCountAndMode instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RequiredCountAndMode"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RequiredCountAndMode(Mutable instance)
                        {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.CmakePresetsBenchmark.Current.JsonInteger.Mutable Count
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CountUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonInteger.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingOptionsForTestExecution.RequiredCountAndMode.ModeEntity.Mutable Mode
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ModeUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingOptionsForTestExecution.RequiredCountAndMode.ModeEntity.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new RequiredCountAndMode(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        public void SetCount(scoped in Corvus.CmakePresetsBenchmark.Current.JsonInteger.Source value)
                        {
                            ...
                            {
                                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("count");
                            }

                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CountUtf8, out IJsonDocument? elementParent, out int elementIdx))
                            {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RequiredCountAndMode.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="RequiredCountAndMode"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="RequiredCountAndMode"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredCountAndMode Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<RequiredCountAndMode>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="RequiredCountAndMode"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredCountAndMode Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RequiredCountAndMode>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        private readonly Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingOptionsForTestExecution.RequiredCountAndMode.ModeEntity.Source _createArg2;
                        ...
                        public static implicit operator Source(RequiredCountAndMode instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingOptionsForTestExecution.RequiredCountAndMode.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        /// <summary>
                        /// Creates an instance of a <see cref="RequiredCountAndMode"/>.
                        /// </summary>
                        ...
                        /// Creates an instance of a <see cref="RequiredCountAndMode"/>.
                        /// </summary>
                        public void Create(in Corvus.CmakePresetsBenchmark.Current.JsonInteger.Source count, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingOptionsForTestExecution.RequiredCountAndMode.ModeEntity.Source mode)
                        {
                            Create(ref _builder, count, mode);
                        }
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Current.JsonInteger.Source count, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingOptionsForTestExecution.RequiredCountAndMode.ModeEntity.Source mode, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(count, mode);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    {
                        return workspace.CreateBuilder<RequiredCountAndMode, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<RequiredCountAndMode> Create(
                        scoped in Source value, int initialCapacity = 30)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<RequiredCountAndMode>();
                        }
                        finally
                        {
                    ...
                    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<RequiredCountAndMode> Create<TContext>(
                    ...
                    public static ParsedJsonDocument<RequiredCountAndMode> Create(in Corvus.CmakePresetsBenchmark.Current.JsonInteger.Source count, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingOptionsForTestExecution.RequiredCountAndMode.ModeEntity.Source mode, int initialCapacity = 30)
                    {
                        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                        try
                        {
