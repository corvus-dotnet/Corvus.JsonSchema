            ...
            public readonly partial struct AnOptionalObjectSpecifyingHowToFilterTheTestsToRun
            {
                ...
                public readonly partial struct AnOptionalObjectSpecifyingWhichTestsToExclude
                {
...
#endif
                    {
                        ...
                        /// <summary>
                        /// Initializes a new instance of the <see cref="FixturesEntity"/> struct.
                        /// </summary>
                        /// <param name="value">The value from which to construct the instance.</param>
                        internal FixturesEntity(IJsonDocument parent, int idx)
                        {
                            Debug.Assert(idx >= 0);
                            _parent = parent;
                            _idx = idx;
                        ...
                        /// </summary>
                        public static FixturesEntity DefaultInstance { get; }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.CmakePresetsBenchmark.Current.JsonString Any
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AnyUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonString value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.CmakePresetsBenchmark.Current.JsonString Cleanup
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CleanupUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonString value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.CmakePresetsBenchmark.Current.JsonString Setup
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SetupUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonString value))
                                {
                                    return value;
                                }
                        ...
                        /// </returns>
                        public static bool operator ==(in FixturesEntity left, in FixturesEntity right)
                        {
                        ...
                        /// <c>True</c> if the values are equal.
                        /// </returns>
                        public static bool operator ==(in FixturesEntity left, in JsonElement right)
                        {
                            return left.Equals(right);
                        }
                        ...
                        public static implicit operator JsonElement(FixturesEntity instance)
                        {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator FixturesEntity(JsonElement instance)
                        {
                            return FixturesEntity.From(instance);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static FixturesEntity From<T>(in T instance)
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static FixturesEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<FixturesEntity>(utf8Json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static FixturesEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<FixturesEntity>(json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static FixturesEntity ParseValue(string json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<FixturesEntity>(json, options);
                        }
                        ...
                        /// </exception>
                        public static FixturesEntity ParseValue(ref Utf8JsonReader reader)
                        {
                            return JsonElementHelpers.ParseValue<FixturesEntity>(ref reader);
                        }
                        ...
                        ///   A value could not be read from the reader.
                        /// </exception>
                        public static bool TryParseValue(ref Utf8JsonReader reader, out FixturesEntity? result)
                        {
                            return JsonElementHelpers.TryParseValue<FixturesEntity>(ref reader, out result);
                        }
...
#if NET
                        static FixturesEntity IJsonElement<FixturesEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"FixturesEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public FixturesEntity Freeze()
                        {
                            CheckValidInstance();
                            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                            {
                                return mutable.FreezeElement<FixturesEntity>(_idx);
                            }
                        ...
                        {
                            /// <summary>
                            /// Gets the JSON property name for <see cref="Any"/>.
                            /// </summary>
                            public const string Any = "any";

                            /// <summary>
                            /// Gets the JSON property name for <see cref="Cleanup"/>.
                            /// </summary>
                            public const string Cleanup = "cleanup";

                            /// <summary>
                            /// Gets the JSON property name for <see cref="Setup"/>.
                            /// </summary>
                            ...
                            /// Gets the JSON property name for <see cref="Any"/>.
                            /// </summary>
                            public static ReadOnlySpan<byte> AnyUtf8 => "any"u8;

                            /// <summary>
                            /// Gets the JSON property name for <see cref="Cleanup"/>.
                            /// </summary>
                            public static ReadOnlySpan<byte> CleanupUtf8 => "cleanup"u8;

                            /// <summary>
                            /// Gets the JSON property name for <see cref="Setup"/>.
                            /// </summary>
                            public static ReadOnlySpan<byte> SetupUtf8 => "setup"u8;
                        }
                        ...
                        {
                            /// <summary>
                            /// Gets the escaped UTF-8 JSON property name for <see cref="Any"/>.
                            /// </summary>
                            public static ReadOnlySpan<byte> Any => "any"u8;

                            /// <summary>
                            /// Gets the escaped UTF-8 JSON property name for <see cref="Cleanup"/>.
                            /// </summary>
                            public static ReadOnlySpan<byte> Cleanup => "cleanup"u8;

                            /// <summary>
                            /// Gets the escaped UTF-8 JSON property name for <see cref="Setup"/>.
                            /// </summary>
                            public static ReadOnlySpan<byte> Setup => "setup"u8;
                        }
                        ...
                        {
                            /// <summary>
                            /// Gets the pre-baked property name blob for <see cref="Any"/>.
                            /// </summary>
                            public static ReadOnlySpan<byte> Any => [0x55, 0x00, 0x00, 0x00, 0x22, 0x61, 0x6E, 0x79, 0x22];

                            /// <summary>
                            /// Gets the pre-baked property name blob for <see cref="Cleanup"/>.
                            /// </summary>
                            public static ReadOnlySpan<byte> Cleanup => [0x95, 0x00, 0x00, 0x00, 0x22, 0x63, 0x6C, 0x65, 0x61, 0x6E, 0x75, 0x70, 0x22];

                            /// <summary>
                            /// Gets the pre-baked property name blob for <see cref="Setup"/>.
                            /// </summary>
                            public static ReadOnlySpan<byte> Setup => [0x75, 0x00, 0x00, 0x00, 0x22, 0x73, 0x65, 0x74, 0x75, 0x70, 0x22];
                        }
                    }
                }
            }
