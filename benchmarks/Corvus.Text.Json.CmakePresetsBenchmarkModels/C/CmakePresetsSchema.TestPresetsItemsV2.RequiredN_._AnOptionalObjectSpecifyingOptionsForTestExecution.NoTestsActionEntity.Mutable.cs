            ...
            public readonly partial struct AnOptionalObjectSpecifyingOptionsForTestExecution
            {
                ...
                public readonly partial struct NoTestsActionEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(NoTestsActionEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="NoTestsActionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator NoTestsActionEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"NoTestsActionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly NoTestsActionEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly NoTestsActionEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<NoTestsActionEntity>(_idx);
                        }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(NoTestsActionEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<NoTestsActionEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<NoTestsActionEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<NoTestsActionEntity>();
                        }
                        finally
                        {
