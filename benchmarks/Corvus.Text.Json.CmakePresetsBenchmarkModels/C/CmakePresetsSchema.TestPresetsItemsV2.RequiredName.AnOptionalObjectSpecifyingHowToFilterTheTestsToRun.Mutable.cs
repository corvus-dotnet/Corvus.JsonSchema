        ...
        public readonly partial struct RequiredName
        {
            ...
            public readonly partial struct AnOptionalObjectSpecifyingHowToFilterTheTestsToRun
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(AnOptionalObjectSpecifyingHowToFilterTheTestsToRun instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="AnOptionalObjectSpecifyingHowToFilterTheTestsToRun"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AnOptionalObjectSpecifyingHowToFilterTheTestsToRun(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToExclude.Mutable Exclude
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludeUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToExclude.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.Mutable Include
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetExclude<TContext>(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToExclude.Source<TContext> value)
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetInclude<TContext>(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.Source<TContext> value)
#if NET9_0_OR_GREATER
                        where TContext : allows ref struct
#endif
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AnOptionalObjectSpecifyingHowToFilterTheTestsToRun Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AnOptionalObjectSpecifyingHowToFilterTheTestsToRun Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<AnOptionalObjectSpecifyingHowToFilterTheTestsToRun>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToExclude.Source _createArg1;
                    private readonly Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.Source _createArg2;
                    ...
                    public static implicit operator Source(AnOptionalObjectSpecifyingHowToFilterTheTestsToRun instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    private readonly Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToExclude.Source<TContext> _createArg1;
                    private readonly Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.Source<TContext> _createArg2;
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="AnOptionalObjectSpecifyingHowToFilterTheTestsToRun"/>.
                    /// </summary>
                    internal static void Create(
                        ref ComplexValueBuilder builder,
                        in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToExclude.Source exclude = default,
                        in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.Source include = default)
                    {
                    ...
                    internal static void Create<TContext>(
                        in TContext context,
                        ref ComplexValueBuilder builder,
                        in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToExclude.Source<TContext> exclude = default,
                        in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.Source<TContext> include = default)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    {
                ...
                {
                    return workspace.CreateBuilder<AnOptionalObjectSpecifyingHowToFilterTheTestsToRun, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<AnOptionalObjectSpecifyingHowToFilterTheTestsToRun> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<AnOptionalObjectSpecifyingHowToFilterTheTestsToRun>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<AnOptionalObjectSpecifyingHowToFilterTheTestsToRun> Create<TContext>(
                ...
                public static ParsedJsonDocument<AnOptionalObjectSpecifyingHowToFilterTheTestsToRun> Create(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToExclude.Source exclude = default, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.Source include = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                public static ParsedJsonDocument<AnOptionalObjectSpecifyingHowToFilterTheTestsToRun> Create<TContext>(in TContext context, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToExclude.Source<TContext> exclude = default, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.Source<TContext> include = default, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
