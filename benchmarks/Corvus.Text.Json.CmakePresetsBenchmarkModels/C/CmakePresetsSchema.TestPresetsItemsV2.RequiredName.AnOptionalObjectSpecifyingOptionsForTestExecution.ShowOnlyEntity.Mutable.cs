            ...
            public readonly partial struct AnOptionalObjectSpecifyingOptionsForTestExecution
            {
                ...
                public readonly partial struct ShowOnlyEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(ShowOnlyEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="ShowOnlyEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator ShowOnlyEntity(Mutable instance)
                        {
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new ShowOnlyEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"ShowOnlyEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="ShowOnlyEntity"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="ShowOnlyEntity"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ShowOnlyEntity Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<ShowOnlyEntity>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="ShowOnlyEntity"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ShowOnlyEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<ShowOnlyEntity>(_idx);
                        }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(ShowOnlyEntity instance) => new(JsonElement.From(instance));
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator Source(KnownValues value) => (ShowOnlyEntity)value;
                    ...
                    {
                        return workspace.CreateBuilder<ShowOnlyEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<ShowOnlyEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<ShowOnlyEntity>();
                        }
                        finally
                        {
