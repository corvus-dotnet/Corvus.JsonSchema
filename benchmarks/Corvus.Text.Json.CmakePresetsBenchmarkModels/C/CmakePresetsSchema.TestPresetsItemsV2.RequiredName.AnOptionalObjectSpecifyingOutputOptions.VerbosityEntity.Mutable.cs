            ...
            public readonly partial struct AnOptionalObjectSpecifyingOutputOptions
            {
                ...
                public readonly partial struct VerbosityEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(VerbosityEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="VerbosityEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator VerbosityEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"VerbosityEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly VerbosityEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly VerbosityEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<VerbosityEntity>(_idx);
                        }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(VerbosityEntity instance) => new(JsonElement.From(instance));
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator Source(KnownValues value) => (VerbosityEntity)value;
                    ...
                    {
                        return workspace.CreateBuilder<VerbosityEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<VerbosityEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<VerbosityEntity>();
                        }
                        finally
                        {
