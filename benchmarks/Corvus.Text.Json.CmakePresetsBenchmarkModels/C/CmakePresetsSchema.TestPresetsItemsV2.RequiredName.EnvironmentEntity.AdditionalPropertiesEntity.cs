            ...
            public readonly partial struct EnvironmentEntity
            {
...
#endif
                {
                    ...
                    public TResult Match<TContext, TResult>(
                        ...
                        Matcher<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.EnvironmentEntity.AdditionalPropertiesEntity, TContext, TResult> defaultMatch)
                    ...
                    public TResult Match<TResult>(
                        ...
                        Matcher<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.EnvironmentEntity.AdditionalPropertiesEntity, TResult> defaultMatch)
                    {
                        if (Corvus.CmakePresetsBenchmark.Current.JsonNull.JsonSchema.Evaluate(_parent, _idx))
                        {
                    ...
                    public TAccumulator MatchEvery<TAccumulator>(
                        ...
                        Matcher<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.EnvironmentEntity.AdditionalPropertiesEntity, TAccumulator, TAccumulator> defaultMatch)
                    {
                        bool matched = false;
