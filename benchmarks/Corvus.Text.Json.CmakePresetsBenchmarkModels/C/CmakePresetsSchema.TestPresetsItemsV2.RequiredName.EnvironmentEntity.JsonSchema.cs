    ...
    public readonly partial struct TestPresetsItemsV2
    {
        ...
        public readonly partial struct RequiredName
        {
                ...
                : IJsonElement<EnvironmentEntity>
            {
                ...
                {
                    private static readonly JsonSchemaPathProvider PropertyNamesSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/propertyNames"u8, buffer, out written);
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("cmake-presets-schema.json#/definitions/testPresetsItemsV2/items/properties/environment"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "cmake-presets-schema.json#/definitions/testPresetsItemsV2/items/properties/environment";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "cmake-presets-schema.json#/definitions/testPresetsItemsV2/items/properties/environment"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (!JsonSchemaEvaluation.MatchTypeObject(tokenType,"type"u8, ref context))
                        {
                            ...
                            context.IgnoredKeyword(JsonSchemaEvaluation.IgnoredNotTypeObject, "propertyNames"u8);
                        }
                        else
                        {
                            ...
                            while (objectValidation_enumerator.MoveNext())
                            {
                                ...
                                using (var fixedJsonString = FixedStringJsonDocument<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.EnvironmentEntity.PropertyNamesEntity>.Parse(parentDocument.GetPropertyNameRaw(objectValidation_currentIndex, true), parentDocument.ValueIsEscaped(objectValidation_currentIndex, true)))
                                {
                                    JsonSchemaContext childContext =
                                        Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.EnvironmentEntity.PropertyNamesEntity.JsonSchema.PushChildContext(
                                            fixedJsonString,
                                            0,
                                            ref context,
                                            schemaEvaluationPath: PropertyNamesSchemaEvaluationPath);

                                    Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.EnvironmentEntity.PropertyNamesEntity.JsonSchema.Evaluate(fixedJsonString, 0, ref childContext);
                                    ...
                                    context.EvaluatedKeyword(context.IsMatch, messageProvider: JsonSchemaEvaluation.ExpectedPropertyNameMatchesSchema, "propertyNames"u8);
                                }

                                if (!context.HasLocalEvaluatedProperty(objectValidation_propertyCount))
                                {
                                    JsonSchemaContext childContext1 = Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.EnvironmentEntity.AdditionalPropertiesEntity.JsonSchema.PushChildContextUnescaped(
                                        parentDocument,
                                    ...
                                    Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.EnvironmentEntity.AdditionalPropertiesEntity.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext1);
