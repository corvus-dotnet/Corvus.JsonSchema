                ...
                public readonly partial struct Type1EntityArray
                {
                    ...
                    public readonly partial struct Type1Entity
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Mutable(Type1Entity instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="Type1Entity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator Type1Entity(Mutable instance)
                            {
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"Type1Entity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly Type1Entity Clone()
                            {
                                CheckValidInstance();
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly Type1Entity Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<Type1Entity>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            public static implicit operator Source(Type1Entity instance) => new(JsonElement.From(instance));
                        ...
                        {
                            return workspace.CreateBuilder<Type1Entity, Mutable>(this);
                        }
                        ...
                        public static ParsedJsonDocument<Type1Entity> Create(
                            scoped in Source value, int initialCapacity = 1)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<Type1Entity>();
                            }
                            finally
                            {
