    ...
    public readonly partial struct TestPresetsItemsV2
    {
        ...
        public readonly partial struct RequiredName
        {
            ...
            public readonly partial struct AnOptionalObjectSpecifyingHowToFilterTheTestsToRun
            {
                ...
                /// </para>
                /// </remarks>
                public readonly partial struct AnOptionalObjectSpecifyingWhichTestsToExclude
                {
                    /// <summary>
                    /// Generated from JSON Schema.
                    /// </summary>
                    ...
                    public readonly partial struct FixturesEntity
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Mutable(FixturesEntity instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="FixturesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator FixturesEntity(Mutable instance)
                            {
                            ...
                            /// <summary>
                            /// Gets the (optional) <c>any</c> property.
                            /// </summary>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.CmakePresetsBenchmark.Current.JsonString.Mutable Any
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AnyUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonString.Mutable value))
                                    {
                                        return value;
                                    }
                            ...
                            /// <summary>
                            /// Gets the (optional) <c>cleanup</c> property.
                            /// </summary>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.CmakePresetsBenchmark.Current.JsonString.Mutable Cleanup
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CleanupUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonString.Mutable value))
                                    {
                                        return value;
                                    }
                            ...
                            /// <summary>
                            /// Gets the (optional) <c>setup</c> property.
                            /// </summary>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.CmakePresetsBenchmark.Current.JsonString.Mutable Setup
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SetupUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonString.Mutable value))
                                    {
                                        return value;
                                    }
                            ...
                            {
                                return
                                    (obj is IJsonElement value && Equals(new FixturesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                            ...
                            /// <summary>
                            /// Set the <c>any</c> property.
                            /// </summary>
                            /// <param name="value">The value of the property to add.</param>
                            public void SetAny(in Corvus.CmakePresetsBenchmark.Current.JsonString.Source value)
                            {
                                CheckValidInstance();

                                if (value.IsUndefined)
                                {
                                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AnyUtf8);
                                    _documentVersion = _parent.Version;
                                    return;
                                }

                                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AnyUtf8, out IJsonDocument? elementParent, out int elementIdx))
                                {
                                ...
                                else
                                {
                                    ...
                                    value.AddAsProperty(JsonPropertyNamesEscaped.Any, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                            ...
                            /// <summary>
                            /// Remove the <c>any</c> property, if present.
                            /// </summary>
                            ...
                            {
                                CheckValidInstance();
                                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AnyUtf8);
                                _documentVersion = _parent.Version;
                                return result;
                            }

                            /// <summary>
                            /// Set the <c>cleanup</c> property.
                            /// </summary>
                            /// <param name="value">The value of the property to add.</param>
                            public void SetCleanup(in Corvus.CmakePresetsBenchmark.Current.JsonString.Source value)
                            {
                                CheckValidInstance();

                                if (value.IsUndefined)
                                {
                                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CleanupUtf8);
                                    _documentVersion = _parent.Version;
                                    return;
                                }

                                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CleanupUtf8, out IJsonDocument? elementParent, out int elementIdx))
                                {
                                    // We are going to replace just the value
                                    value.AddAsItem(ref cvb);
                                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                                ...
                                {
                                    // We are going to insert the new value
                                    value.AddAsProperty(JsonPropertyNamesEscaped.Cleanup, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                                }
                            ...
                            /// <summary>
                            /// Remove the <c>cleanup</c> property, if present.
                            /// </summary>
                            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                            public bool RemoveCleanup()
                            {
                                CheckValidInstance();
                                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CleanupUtf8);
                                _documentVersion = _parent.Version;
                                return result;
                            }

                            /// <summary>
                            /// Set the <c>setup</c> property.
                            /// </summary>
                            /// <param name="value">The value of the property to add.</param>
                            public void SetSetup(in Corvus.CmakePresetsBenchmark.Current.JsonString.Source value)
                            {
                                CheckValidInstance();

                                if (value.IsUndefined)
                                {
                                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SetupUtf8);
                                    _documentVersion = _parent.Version;
                                    return;
                                }

                                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SetupUtf8, out IJsonDocument? elementParent, out int elementIdx))
                                {
                                    // We are going to replace just the value
                                    value.AddAsItem(ref cvb);
                                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                                ...
                                {
                                    // We are going to insert the new value
                                    value.AddAsProperty(JsonPropertyNamesEscaped.Setup, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                                }
                            ...
                            /// <summary>
                            /// Remove the <c>setup</c> property, if present.
                            /// </summary>
                            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                            public bool RemoveSetup()
                            {
                                CheckValidInstance();
                                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SetupUtf8);
                                _documentVersion = _parent.Version;
                                return result;
                            }
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"FixturesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// <summary>
                            /// Gets a <see cref="FixturesEntity"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </summary>
                            /// <returns>
                            /// A <see cref="FixturesEntity"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </returns>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly FixturesEntity Clone()
                            {
                                CheckValidInstance();
                                return _parent.CloneElement<FixturesEntity>(_idx);
                            }
                            ...
                            /// </summary>
                            /// <returns>
                            /// An immutable <see cref="FixturesEntity"/> that lives for the lifetime of its
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly FixturesEntity Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<FixturesEntity>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            internal Source(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToExclude.FixturesEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                            public static implicit operator Source(FixturesEntity instance) => new(JsonElement.From(instance));
                        ...
                        public ref struct Builder
                        {
                            ...
                            /// <summary>
                            /// Creates an instance of a <see cref="FixturesEntity"/>.
                            /// </summary>
                            internal static void Create(
                                ref ComplexValueBuilder builder,
                                in Corvus.CmakePresetsBenchmark.Current.JsonString.Source any = default,
                                in Corvus.CmakePresetsBenchmark.Current.JsonString.Source cleanup = default,
                                in Corvus.CmakePresetsBenchmark.Current.JsonString.Source setup = default)
                            {
                                any.AddAsProperty(JsonPropertyNamesEscaped.Any, ref builder, escapeName: false);
                                cleanup.AddAsProperty(JsonPropertyNamesEscaped.Cleanup, ref builder, escapeName: false);
                                setup.AddAsProperty(JsonPropertyNamesEscaped.Setup, ref builder, escapeName: false);
                            }
                            ...
                            public void Create(
                                ...
                                in Corvus.CmakePresetsBenchmark.Current.JsonString.Source setup = default)
                            {
                                Create(ref _builder, any, cleanup, setup);
                            }
                        ...
                        /// </summary>
                        /// <param name="workspace">The JSON workspace.</param>
                        /// <param name="any">The value of the property.</param>
                        /// <param name="cleanup">The value of the property.</param>
                        /// <param name="setup">The value of the property.</param>
                        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source any = default, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source cleanup = default, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source setup = default, int initialCapacity = 30)
                        {
                            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                            cvb.StartObject();
                            Builder ovb = new(cvb);
                            ovb.Create(any, cleanup, setup);
                            cvb = ovb._builder;
                            cvb.EndObject();
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder;
                        ...
                        {
                            return workspace.CreateBuilder<FixturesEntity, Mutable>(this);
                        }
                    }
                }
            }
