                ...
                public readonly partial struct AnOptionalObjectSpecifyingWhichTestsToInclude
                {
                    ...
                    public readonly partial struct IndexEntity
                    {
                        ...
                        public readonly partial struct AnOptionalObjectSpecifyingTestsToIncludeByTestIndex
                        {
                            ...
                            public readonly partial struct JsonIntegerArray
                            {
...
#endif
                                {
                                    ...
                                    public static explicit operator Mutable(JsonIntegerArray instance)
                                    {
                                    ...
                                    /// <returns>An immutable instance of a <see cref="JsonIntegerArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static implicit operator JsonIntegerArray(Mutable instance)
                                    {
                                    ...
                                    public Corvus.CmakePresetsBenchmark.Current.JsonInteger.Mutable this[int index]
                                    {
                                        get
                                        {
                                            CheckValidInstance();
                                            return _parent.GetArrayIndexElement<Corvus.CmakePresetsBenchmark.Current.JsonInteger.Mutable>(_idx, index);
                                        }
                                    }
                                    ...
                                    /// </summary>
                                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                                    public ArrayEnumerator<Corvus.CmakePresetsBenchmark.Current.JsonInteger.Mutable> EnumerateArray()
                                    {
                                        CheckValidInstance();
                                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Current.JsonInteger.Mutable>(_parent, _idx);
                                    }
                                    ...
                                    public bool TryGetNumericValues(Span<long> items, out int written)
                                    {
                                        CheckValidInstance();
                                        written = 0;
                                        foreach (Corvus.CmakePresetsBenchmark.Current.JsonInteger.Mutable item in EnumerateArray())
                                        {
                                            ...
                                            if (!item.TryGetValue(out long value))
                                            {
                                                return false;
                                            }
                                    ...
                                    {
                                        return
                                            (obj is IJsonElement value && Equals(new JsonIntegerArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                                    ...
                                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                    private string DebuggerDisplay => $"JsonIntegerArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                    /// <summary>
                                    ...
                                    /// </remarks>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public void SetItem(int itemIndex, in Corvus.CmakePresetsBenchmark.Current.JsonInteger.Source value)
                                    {
                                        CheckValidInstance();
                                    ...
                                    /// </remarks>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public void InsertItem(int itemIndex, scoped in Corvus.CmakePresetsBenchmark.Current.JsonInteger.Source value)
                                    {
                                        CheckValidInstance();
                                    ...
                                    /// </exception>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public void AddItem(scoped in Corvus.CmakePresetsBenchmark.Current.JsonInteger.Source value)
                                    {
                                    ...
                                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                                    /// </exception>
                                    public bool Remove(in Corvus.CmakePresetsBenchmark.Current.JsonInteger item)
                                    {
                                        CheckValidInstance();
                                        if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.CmakePresetsBenchmark.Current.JsonInteger>(this, in item))
                                        {
                                            return false;
                                        }
                                    ...
                                    /// </remarks>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public void RemoveWhere(JsonPredicate<Corvus.CmakePresetsBenchmark.Current.JsonInteger> predicate)
                                    {
                                        CheckValidInstance();
                                        JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.CmakePresetsBenchmark.Current.JsonInteger>(this, predicate);
                                        _documentVersion = _parent.Version;
                                    }
                                    ...
                                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                                    /// </exception>
                                    public bool Replace(in Corvus.CmakePresetsBenchmark.Current.JsonInteger oldItem, in Corvus.CmakePresetsBenchmark.Current.JsonInteger.Source newItem)
                                    {
                                        CheckValidInstance();
                                        ...
                                        var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Current.JsonInteger>(_parent, _idx);

                                        while (enumerator.MoveNext())
                                        {
                                            Corvus.CmakePresetsBenchmark.Current.JsonInteger current = enumerator.Current;
                                    ...
                                    /// <summary>
                                    /// Gets a <see cref="JsonIntegerArray"/> which can be safely stored beyond the lifetime of the
                                    /// original document.
                                    /// </summary>
                                    /// <returns>
                                    /// A <see cref="JsonIntegerArray"/> which can be safely stored beyond the lifetime of the
                                    /// original document.
                                    /// </returns>
                                    /// <remarks>
                                    /// <para>
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public readonly JsonIntegerArray Clone()
                                    {
                                        CheckValidInstance();
                                        return _parent.CloneElement<JsonIntegerArray>(_idx);
                                    }
                                    ...
                                    /// </summary>
                                    /// <returns>
                                    /// An immutable <see cref="JsonIntegerArray"/> that lives for the lifetime of its
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public readonly JsonIntegerArray Freeze()
                                    {
                                        CheckValidInstance();
                                        return _parent.FreezeElement<JsonIntegerArray>(_idx);
                                    }
                                }
                                ...
                                public ref struct Source
                                {
                                    ...
                                    internal Source(ReadOnlySpan<long> value)
                                    {
                                        _longArray = value;
                                    ...
                                    public static implicit operator Source(JsonIntegerArray instance) => new(JsonElement.From(instance));

                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static implicit operator Source(ReadOnlySpan<long> value) => new(value);
                                ...
                                public ref struct Builder
                                {
                                    ...
                                    /// </summary>
                                    public void AddItem(in Corvus.CmakePresetsBenchmark.Current.JsonInteger.Source value)
                                    {
                                ...
                                /// <returns>The source from which to build the value.</returns>
                                public static Source Build(ReadOnlySpan<long> values)
                                {
                                ...
                                public static JsonDocumentBuilder<Mutable> CreateBuilder(
                                    JsonWorkspace workspace, ReadOnlySpan<long> values, int initialCapacity = 30)
                                {
                                ...
                                {
                                    return workspace.CreateBuilder<JsonIntegerArray, Mutable>(this);
                                }
                                ...
                                public static ParsedJsonDocument<JsonIntegerArray> Create(
                                    scoped in Source value, int initialCapacity = 30)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        Debug.Assert(cvb.MemberCount == 1);
                                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                        return documentBuilder.ToParsedJsonDocument<JsonIntegerArray>();
                                    }
                                    finally
                                    {
                                ...
                                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                                public static ParsedJsonDocument<JsonIntegerArray> Create<TContext>(
                                ...
                                public static ParsedJsonDocument<JsonIntegerArray> Create(
                                    ReadOnlySpan<long> values, int initialCapacity = 30)
                                {
