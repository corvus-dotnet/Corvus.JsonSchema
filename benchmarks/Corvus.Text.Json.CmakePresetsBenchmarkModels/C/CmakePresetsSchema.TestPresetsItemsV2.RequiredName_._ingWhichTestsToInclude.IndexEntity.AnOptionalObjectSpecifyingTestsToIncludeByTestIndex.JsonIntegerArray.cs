                    ...
                    public readonly partial struct IndexEntity
                    {
                        ...
                        public readonly partial struct AnOptionalObjectSpecifyingTestsToIncludeByTestIndex
                        {
...
#endif
                            {
                                ...
                                internal JsonIntegerArray(IJsonDocument parent, int idx)
                                {
                                    Debug.Assert(idx >= 0);
                                    _parent = parent;
                                    _idx = idx;
                                ...
                                /// </summary>
                                public static JsonIntegerArray DefaultInstance { get; }
                                ...
                                public bool TryGetNumericValues(Span<long> items, out int written)
                                {
                                    CheckValidInstance();
                                    written = 0;
                                    foreach (Corvus.CmakePresetsBenchmark.Current.JsonInteger item in EnumerateArray())
                                    {
                                ...
                                public Corvus.CmakePresetsBenchmark.Current.JsonInteger this[int index]
                                {
                                    get
                                    {
                                        CheckValidInstance();
                                        return _parent.GetArrayIndexElement<Corvus.CmakePresetsBenchmark.Current.JsonInteger>(_idx, index);
                                    }
                                }
                                ...
                                /// </summary>
                                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                                public ArrayEnumerator<Corvus.CmakePresetsBenchmark.Current.JsonInteger> EnumerateArray()
                                {
                                    CheckValidInstance();
                                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Current.JsonInteger>(_parent, _idx);
                                }
                                ...
                                /// </returns>
                                public static bool operator ==(in JsonIntegerArray left, in JsonIntegerArray right)
                                {
                                ...
                                /// <c>True</c> if the values are equal.
                                /// </returns>
                                public static bool operator ==(in JsonIntegerArray left, in JsonElement right)
                                {
                                    return left.Equals(right);
                                }
                                ...
                                public static implicit operator JsonElement(JsonIntegerArray instance)
                                {
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator JsonIntegerArray(JsonElement instance)
                                {
                                    return JsonIntegerArray.From(instance);
                                }
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static JsonIntegerArray From<T>(in T instance)
                                ...
                                /// </exception>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static JsonIntegerArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                                {
                                    return JsonElementHelpers.ParseValue<JsonIntegerArray>(utf8Json, options);
                                }
                                ...
                                /// </exception>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static JsonIntegerArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                                {
                                    return JsonElementHelpers.ParseValue<JsonIntegerArray>(json, options);
                                }
                                ...
                                /// </exception>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static JsonIntegerArray ParseValue(string json, JsonDocumentOptions options = default)
                                {
                                    return JsonElementHelpers.ParseValue<JsonIntegerArray>(json, options);
                                }
                                ...
                                /// </exception>
                                public static JsonIntegerArray ParseValue(ref Utf8JsonReader reader)
                                {
                                    return JsonElementHelpers.ParseValue<JsonIntegerArray>(ref reader);
                                }
                                ...
                                ///   A value could not be read from the reader.
                                /// </exception>
                                public static bool TryParseValue(ref Utf8JsonReader reader, out JsonIntegerArray? result)
                                {
                                    return JsonElementHelpers.TryParseValue<JsonIntegerArray>(ref reader, out result);
                                }
...
#if NET
                                static JsonIntegerArray IJsonElement<JsonIntegerArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"JsonIntegerArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// </para>
                                /// </remarks>
                                public JsonIntegerArray Freeze()
                                {
                                    CheckValidInstance();
                                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                    {
                                        return mutable.FreezeElement<JsonIntegerArray>(_idx);
                                    }
