            ...
            public readonly partial struct AnOptionalObjectSpecifyingHowToFilterTheTestsToRun
            {
                ...
                public readonly partial struct AnOptionalObjectSpecifyingWhichTestsToExclude
                {
                        ...
                        : IJsonElement<FixturesEntity>
                    {
                        ...
                        {
                            private static readonly JsonSchemaPathProvider AnySchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/any"u8, buffer, out written);
                            private static readonly JsonSchemaPathProvider CleanupSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/cleanup"u8, buffer, out written);
                            private static readonly JsonSchemaPathProvider SetupSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/setup"u8, buffer, out written);

                            private static void MatchAny(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                            {
                                ...
                                JsonSchemaContext childContext =
                                    Corvus.CmakePresetsBenchmark.Current.JsonString.JsonSchema.PushChildContextUnescaped(
                                        ...
                                        parentDocumentIndex,
                                        ref context,
                                        JsonPropertyNames.AnyUtf8,
                                        evaluationPath: AnySchemaEvaluationPath);
                            ...
                            private static void MatchCleanup(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                            {
                                context.AddLocalEvaluatedProperty(propertyCount);
                                JsonSchemaContext childContext1 =
                                    Corvus.CmakePresetsBenchmark.Current.JsonString.JsonSchema.PushChildContextUnescaped(
                                        ...
                                        parentDocumentIndex,
                                        ref context,
                                        JsonPropertyNames.CleanupUtf8,
                                        evaluationPath: CleanupSchemaEvaluationPath);
                            ...
                            private static void MatchSetup(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                            {
                                context.AddLocalEvaluatedProperty(propertyCount);
                                JsonSchemaContext childContext2 =
                                    Corvus.CmakePresetsBenchmark.Current.JsonString.JsonSchema.PushChildContextUnescaped(
                                        ...
                                        parentDocumentIndex,
                                        ref context,
                                        JsonPropertyNames.SetupUtf8,
                                        evaluationPath: SetupSchemaEvaluationPath);
                            ...
                            private static PropertySchemaMatchers<Corvus.CmakePresetsBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                            {
                                return new PropertySchemaMatchers<Corvus.CmakePresetsBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1>([
                                    (static () => JsonPropertyNames.AnyUtf8, MatchAny),
                                    (static () => JsonPropertyNames.CleanupUtf8, MatchCleanup),
                                    (static () => JsonPropertyNames.SetupUtf8, MatchSetup),
                                ]);
                            }
                            ...
                            /// </summary>
                            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("cmake-presets-schema.json#/definitions/testPresetsItemsV2/items/properties/filter/properties/exclude/properties/fixtures"u8, buffer, out written);

                            /// <summary>
                            /// Gets the schema location from which this type was generated.
                            /// </summary>
                            public const string SchemaLocation = "cmake-presets-schema.json#/definitions/testPresetsItemsV2/items/properties/filter/properties/exclude/properties/fixtures";

                            /// <summary>
                            /// Gets the schema location from which this type was generated as a UTF-8 string.
                            /// </summary>
                            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "cmake-presets-schema.json#/definitions/testPresetsItemsV2/items/properties/filter/properties/exclude/properties/fixtures"u8;
