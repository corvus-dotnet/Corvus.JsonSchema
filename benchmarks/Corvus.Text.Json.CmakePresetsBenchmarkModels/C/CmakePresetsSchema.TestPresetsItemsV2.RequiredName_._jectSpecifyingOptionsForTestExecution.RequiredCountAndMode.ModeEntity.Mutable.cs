                ...
                public readonly partial struct RequiredCountAndMode
                {
                    ...
                    public readonly partial struct ModeEntity
                    {
...
#endif
                        {
                            ...
                            /// <param name="matchUntilFail">Match 1st item.</param>
                            /// <param name="matchUntilPass">Match 2nd item.</param>
                            /// <param name="matchAfterTimeout">Match 3rd item.</param>
                            /// <param name="defaultMatch">Match any other value.</param>
                            /// <returns>An instance of the value returned by the match function.</returns>
                            public TResult Match<TContext, TResult>(
                                in TContext context,
                                Func<TContext, TResult> matchUntilFail,
                                Func<TContext, TResult> matchUntilPass,
                                Func<TContext, TResult> matchAfterTimeout,
...
#endif
                            {
                                ...
                                {
                                    return matchUntilFail(context);
                                }

                                if (this.ValueEquals(Constants.Enum2))
                                {
                                    return matchUntilPass(context);
                                }

                                if (this.ValueEquals(Constants.Enum3))
                                {
                                    return matchAfterTimeout(context);
                                }
                            ...
                            public TResult Match<TResult>(
                                Func<TResult> matchUntilFail,
                                Func<TResult> matchUntilPass,
                                Func<TResult> matchAfterTimeout,
                                Func<TResult> defaultMatch)
                            {
                                if (this.ValueEquals(Constants.Enum1))
                                {
                                    return matchUntilFail();
                                }

                                if (this.ValueEquals(Constants.Enum2))
                                {
                                    return matchUntilPass();
                                }

                                if (this.ValueEquals(Constants.Enum3))
                                {
                                    return matchAfterTimeout();
                                }
                        ...
                        public ref struct Source
                        {
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator Source(KnownValues value) => (ModeEntity)value;
