                ...
                public readonly partial struct AnOptionalObjectSpecifyingWhichTestsToInclude
                {
                    ...
                    public readonly partial struct IndexEntity
                    {
                            ...
                            : IJsonElement<AnOptionalObjectSpecifyingTestsToIncludeByTestIndex>
                        {
                            ...
                            {
                                private static readonly JsonSchemaPathProvider EndSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/end"u8, buffer, out written);
                                private static readonly JsonSchemaPathProvider SpecificTestsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/specificTests"u8, buffer, out written);
                                private static readonly JsonSchemaPathProvider StartSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/start"u8, buffer, out written);
                                private static readonly JsonSchemaPathProvider StrideSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/stride"u8, buffer, out written);

                                private static void MatchEnd(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                                {
                                    ...
                                    JsonSchemaContext childContext =
                                        Corvus.CmakePresetsBenchmark.Current.JsonInteger.JsonSchema.PushChildContextUnescaped(
                                            ...
                                            parentDocumentIndex,
                                            ref context,
                                            JsonPropertyNames.EndUtf8,
                                            evaluationPath: EndSchemaEvaluationPath);

                                    Corvus.CmakePresetsBenchmark.Current.JsonInteger.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                                    context.CommitChildContext(childContext.IsMatch, ref childContext);
                                }

                                private static void MatchSpecificTests(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                                {
                                    context.AddLocalEvaluatedProperty(propertyCount);
                                    JsonSchemaContext childContext1 =
                                        Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity.AnOptionalObjectSpecifyingTestsToIncludeByTestIndex.JsonIntegerArray.JsonSchema.PushChildContextUnescaped(
                                            parentDocument,
                                            parentDocumentIndex,
                                            ref context,
                                            JsonPropertyNames.SpecificTestsUtf8,
                                            evaluationPath: SpecificTestsSchemaEvaluationPath);

                                    Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity.AnOptionalObjectSpecifyingTestsToIncludeByTestIndex.JsonIntegerArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                                    context.CommitChildContext(childContext1.IsMatch, ref childContext1);
                                }

                                private static void MatchStart(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                                {
                                    context.AddLocalEvaluatedProperty(propertyCount);
                                    JsonSchemaContext childContext2 =
                                        Corvus.CmakePresetsBenchmark.Current.JsonInteger.JsonSchema.PushChildContextUnescaped(
                                            ...
                                            parentDocumentIndex,
                                            ref context,
                                            JsonPropertyNames.StartUtf8,
                                            evaluationPath: StartSchemaEvaluationPath);
                                ...
                                private static void MatchStride(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                                {
                                    context.AddLocalEvaluatedProperty(propertyCount);
                                    JsonSchemaContext childContext3 =
                                        Corvus.CmakePresetsBenchmark.Current.JsonInteger.JsonSchema.PushChildContextUnescaped(
                                            ...
                                            parentDocumentIndex,
                                            ref context,
                                            JsonPropertyNames.StrideUtf8,
                                            evaluationPath: StrideSchemaEvaluationPath);

                                    Corvus.CmakePresetsBenchmark.Current.JsonInteger.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
                                ...
                                private static PropertySchemaMatchers<Corvus.CmakePresetsBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                                {
                                    return new PropertySchemaMatchers<Corvus.CmakePresetsBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1>([
                                        (static () => JsonPropertyNames.EndUtf8, MatchEnd),
                                        (static () => JsonPropertyNames.SpecificTestsUtf8, MatchSpecificTests),
                                        (static () => JsonPropertyNames.StartUtf8, MatchStart),
                                        (static () => JsonPropertyNames.StrideUtf8, MatchStride),
                                    ]);
                                }
                                ...
                                /// </summary>
                                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/testPresetsItemsV2/items/properties/filter/properties/include/properties/index/anyOf/0"u8, buffer, out written);

                                /// <summary>
                                /// Gets the schema location from which this type was generated.
                                /// </summary>
                                public const string SchemaLocation = "/definitions/testPresetsItemsV2/items/properties/filter/properties/include/properties/index/anyOf/0";

                                /// <summary>
                                /// Gets the schema location from which this type was generated as a UTF-8 string.
                                /// </summary>
                                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/testPresetsItemsV2/items/properties/filter/properties/include/properties/index/anyOf/0"u8;
