                ...
                public readonly partial struct AnOptionalObjectSpecifyingWhichTestsToExclude
                {
                    ...
                    public readonly partial struct FixturesEntity
                    {
...
#endif
                        {
                            ...
                            public void SetAny(scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source value)
                            {
                                CheckValidInstance();
                            ...
                            /// </summary>
                            /// <param name="value">The value of the property to add.</param>
                            public void SetCleanup(scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source value)
                            {
                                CheckValidInstance();
                            ...
                            /// </summary>
                            /// <param name="value">The value of the property to add.</param>
                            public void SetSetup(scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source value)
                            {
                                CheckValidInstance();
                        ...
                        public ref struct Source
                        {
                            ...
                            internal Source(scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source arg1, scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source arg2, scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source arg3)
                            {
                                _createArg1 = arg1;
                                _createArg2 = arg2;
                                _createArg3 = arg3;
                        ...
                        public ref struct Builder
                        {
                            ...
                            internal static void BuildCreateValue(scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source arg1, scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source arg2, scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source arg3, ref ComplexValueBuilder o)
                            {
                                o.StartObject();
                        ...
                        /// </summary>
                        /// <param name="any">The value of the <c>"any"</c> property.</param>
                        /// <param name="cleanup">The value of the <c>"cleanup"</c> property.</param>
                        /// <param name="setup">The value of the <c>"setup"</c> property.</param>
                        /// <returns>The source from which to build the value.</returns>
                        public static Source Build(scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source any = default, scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source cleanup = default, scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source setup = default)
                        {
                            return new Source(any, cleanup, setup);
                        }
                        ...
                        public static ParsedJsonDocument<FixturesEntity> Create(
                            scoped in Source value, int initialCapacity = 30)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<FixturesEntity>();
                            }
                            finally
                            {
                        ...
                        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                        public static ParsedJsonDocument<FixturesEntity> Create<TContext>(
                        ...
                        public static ParsedJsonDocument<FixturesEntity> Create(in Corvus.CmakePresetsBenchmark.Current.JsonString.Source any = default, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source cleanup = default, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source setup = default, int initialCapacity = 30)
                        {
                            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                            try
                            {
