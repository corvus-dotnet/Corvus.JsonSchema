...
public readonly partial struct CmakePresetsSchema
{
    ...
    public readonly partial struct TestPresetsItemsV2
        ...
        : IJsonElement<TestPresetsItemsV2>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TestPresetsItemsV2"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TestPresetsItemsV2(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TestPresetsItemsV2 DefaultInstance { get; }
        ...
        public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in TestPresetsItemsV2 left, in TestPresetsItemsV2 right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TestPresetsItemsV2 left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(TestPresetsItemsV2 instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TestPresetsItemsV2(JsonElement instance)
        {
            return TestPresetsItemsV2.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TestPresetsItemsV2 From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TestPresetsItemsV2 ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TestPresetsItemsV2>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TestPresetsItemsV2 ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TestPresetsItemsV2>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TestPresetsItemsV2 ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TestPresetsItemsV2>(json, options);
        }
        ...
        /// </exception>
        public static TestPresetsItemsV2 ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<TestPresetsItemsV2>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TestPresetsItemsV2? result)
        {
            return JsonElementHelpers.TryParseValue<TestPresetsItemsV2>(ref reader, out result);
        }
...
#if NET
        static TestPresetsItemsV2 IJsonElement<TestPresetsItemsV2>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TestPresetsItemsV2: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public TestPresetsItemsV2 Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public TestPresetsItemsV2 Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TestPresetsItemsV2>(_idx);
            }
