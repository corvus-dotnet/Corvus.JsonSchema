        ...
        public readonly partial struct RequiredName
        {
            ...
            public readonly partial struct AnOptionalObjectSpecifyingHowToFilterTheTestsToRun
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="AnOptionalObjectSpecifyingWhichTestsToInclude"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal AnOptionalObjectSpecifyingWhichTestsToInclude(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static AnOptionalObjectSpecifyingWhichTestsToInclude DefaultInstance { get; }

                    /// <summary>
                    /// Gets the (optional) <c>index</c> property.
                    /// </summary>
                    public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity Index
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IndexUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Current.JsonString Label
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LabelUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonString value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Current.JsonString Name
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonString value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Current.JsonBoolean UseUnion
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UseUnionUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonBoolean value))
                            {
                                return value;
                            }
                    ...
                    /// </returns>
                    public static bool operator ==(in AnOptionalObjectSpecifyingWhichTestsToInclude left, in AnOptionalObjectSpecifyingWhichTestsToInclude right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in AnOptionalObjectSpecifyingWhichTestsToInclude left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(AnOptionalObjectSpecifyingWhichTestsToInclude instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AnOptionalObjectSpecifyingWhichTestsToInclude(JsonElement instance)
                    {
                        return AnOptionalObjectSpecifyingWhichTestsToInclude.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AnOptionalObjectSpecifyingWhichTestsToInclude From<T>(in T instance)
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AnOptionalObjectSpecifyingWhichTestsToInclude ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<AnOptionalObjectSpecifyingWhichTestsToInclude>(utf8Json, options);
                    ...
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AnOptionalObjectSpecifyingWhichTestsToInclude ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<AnOptionalObjectSpecifyingWhichTestsToInclude>(json, options);
                        #pragma warning restore CS0618
                    }
                    ...
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AnOptionalObjectSpecifyingWhichTestsToInclude ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<AnOptionalObjectSpecifyingWhichTestsToInclude>(json, options);
                        #pragma warning restore CS0618
                    ...
                    /// </exception>
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    public static AnOptionalObjectSpecifyingWhichTestsToInclude ParseValue(ref Utf8JsonReader reader)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<AnOptionalObjectSpecifyingWhichTestsToInclude>(ref reader);
                        #pragma warning restore CS0618
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out AnOptionalObjectSpecifyingWhichTestsToInclude? result)
                    {
                        return JsonElementHelpers.TryParseValue<AnOptionalObjectSpecifyingWhichTestsToInclude>(ref reader, out result);
                    }
...
#if NET
                    static AnOptionalObjectSpecifyingWhichTestsToInclude IJsonElement<AnOptionalObjectSpecifyingWhichTestsToInclude>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AnOptionalObjectSpecifyingWhichTestsToInclude: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public AnOptionalObjectSpecifyingWhichTestsToInclude Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public AnOptionalObjectSpecifyingWhichTestsToInclude Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<AnOptionalObjectSpecifyingWhichTestsToInclude>(_idx);
                        }
                    ...
                    public static class JsonPropertyNames
                    {
                        ...
                        /// <summary>
                        /// Gets the JSON property name for <see cref="UseUnion"/>.
                        /// </summary>
                        public const string UseUnion = "useUnion";
                        ...
                        /// Gets the JSON property name for <see cref="UseUnion"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> UseUnionUtf8 => "useUnion"u8;
                    }
                    ...
                    private static class JsonPropertyNamesEscaped
                    {
                        ...
                        /// <summary>
                        /// Gets the escaped UTF-8 JSON property name for <see cref="UseUnion"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> UseUnion => "useUnion"u8;
                    }
                    ...
                    private static class JsonPropertyNamesPrebaked
                    {
                        ...
                        /// <summary>
                        /// Gets the pre-baked property name blob for <see cref="UseUnion"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> UseUnion => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x75, 0x73, 0x65, 0x55, 0x6E, 0x69, 0x6F, 0x6E, 0x22];
                    }
                }
            }
        }
