            ...
            public readonly partial struct AnOptionalObjectSpecifyingHowToFilterTheTestsToRun
            {
                ...
                public readonly partial struct AnOptionalObjectSpecifyingWhichTestsToInclude
                {
...
#endif
                    {
                        ...
                        /// </summary>
                        public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity.Mutable Index
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IndexUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Mutable UseUnion
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UseUnionUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        public void SetIndex(scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity.Source value)
                        {
                            CheckValidInstance();
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetIndex<TContext>(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity.Source<TContext> value)
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetUseUnion(scoped in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source value)
                        {
                            CheckValidInstance();
                            ...
                            {
                                // We are going to insert the new value
                                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.UseUnion, ref cvb);
                                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                            }
                    ...
                    public ref struct Source
                    {
                        ...
                        private readonly Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity.Source _createArg1;
                        ...
                        internal Source(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                        internal Source(scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity.Source arg1, scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source arg2, scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source arg3, scoped in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source arg4)
                        {
                            _createArg1 = arg1;
                            _createArg2 = arg2;
                            _createArg3 = arg3;
                        ...
                        #endif
                    {
                        ...
                        private readonly Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity.Source<TContext> _createArg1;
                        private readonly Corvus.CmakePresetsBenchmark.Current.JsonString.Source _createArg2;
                        private readonly Corvus.CmakePresetsBenchmark.Current.JsonString.Source _createArg3;
                        private readonly Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source _createArg4;
                        ...
                        internal Source(scoped in TContext context, scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity.Source<TContext> arg1, scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source arg2, scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source arg3, scoped in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source arg4)
                        {
                            _context = context;
                            _createArg1 = arg1;
                            _createArg2 = arg2;
                    ...
                    public ref struct Builder
                    {
                        ...
                        internal static void Create(
                            ...
                            in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity.Source index = default,
                            ...
                            in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source useUnion = default)
                        {
                            ...
                            useUnion.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.UseUnion, ref builder);
                        }
                        ...
                        internal static void Create<TContext>(
                            in TContext context,
                            ref ComplexValueBuilder builder,
                            in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity.Source<TContext> index = default,
                            in Corvus.CmakePresetsBenchmark.Current.JsonString.Source label = default,
                            in Corvus.CmakePresetsBenchmark.Current.JsonString.Source name = default,
                            in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source useUnion = default)
                        #if NET9_0_OR_GREATER
                    ...
                    /// <param name="useUnion">The value of the <c>"useUnion"</c> property.</param>
                    /// <returns>The source from which to build the value.</returns>
                    public static Source Build(scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity.Source index = default, scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source label = default, scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source name = default, scoped in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source useUnion = default)
                    {
                        return new Source(index, label, name, useUnion);
                    }
                    ...
                    /// <param name="useUnion">The value of the <c>"useUnion"</c> property.</param>
                    /// <returns>The source from which to build the value.</returns>
                    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity.Source<TContext> index = default, scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source label = default, scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source name = default, scoped in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source useUnion = default)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                        return new Source<TContext>(context, index, label, name, useUnion);
                    }
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity.Source index = default, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source label = default, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source name = default, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source useUnion = default, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
