        ...
        public readonly partial struct RequiredName
        {
            ...
            public readonly partial struct AnOptionalObjectSpecifyingHowToFilterTheTestsToRun
            {
                ...
                public readonly partial struct AnOptionalObjectSpecifyingWhichTestsToInclude
                {
                    ...
                    public static ParsedJsonDocument<AnOptionalObjectSpecifyingWhichTestsToInclude> Create(
                        scoped in Source value, int initialCapacity = 30)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<AnOptionalObjectSpecifyingWhichTestsToInclude>();
                        }
                        finally
                        {
                    ...
                    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<AnOptionalObjectSpecifyingWhichTestsToInclude> Create<TContext>(
                    ...
                    public static ParsedJsonDocument<AnOptionalObjectSpecifyingWhichTestsToInclude> Create(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity.Source index = default, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source label = default, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source name = default, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source useUnion = default, int initialCapacity = 30)
                    {
                        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                        try
                        {
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<AnOptionalObjectSpecifyingWhichTestsToInclude> Create<TContext>(in TContext context, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2.RequiredName.AnOptionalObjectSpecifyingHowToFilterTheTestsToRun.AnOptionalObjectSpecifyingWhichTestsToInclude.IndexEntity.Source<TContext> index = default, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source label = default, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source name = default, in Corvus.CmakePresetsBenchmark.Current.JsonBoolean.Source useUnion = default, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
