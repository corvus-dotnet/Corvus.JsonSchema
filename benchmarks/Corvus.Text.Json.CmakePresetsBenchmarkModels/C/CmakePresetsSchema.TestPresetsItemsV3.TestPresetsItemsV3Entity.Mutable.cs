...
public readonly partial struct CmakePresetsSchema
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct TestPresetsItemsV3
    {
        /// <summary>
        /// Generated from JSON Schema.
        /// </summary>
        [DebuggerDisplay("{DebuggerDisplay,nq}")]
        public readonly partial struct TestPresetsItemsV3Entity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TestPresetsItemsV3Entity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TestPresetsItemsV3Entity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TestPresetsItemsV3Entity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TestPresetsItemsV3Entity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TestPresetsItemsV3Entity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TestPresetsItemsV3Entity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TestPresetsItemsV3Entity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly TestPresetsItemsV3Entity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TestPresetsItemsV3Entity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TestPresetsItemsV3Entity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly TestPresetsItemsV3Entity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TestPresetsItemsV3Entity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TopCondition.Source _createArg1;
                ...
                internal Source(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV3.TestPresetsItemsV3Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TopCondition.Source arg1)
                {
                    _createArg1 = arg1;
                    _kind = Kind.Create;
                }

                public static implicit operator Source(TestPresetsItemsV3Entity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                private readonly Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TopCondition.Source<TContext> _createArg1;
                ...
                internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV3.TestPresetsItemsV3Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in TContext context, scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TopCondition.Source<TContext> arg1)
                {
                    _context = context;
                    _createArg1 = arg1;
                    _kind = Kind.Create;
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="TestPresetsItemsV3Entity"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TopCondition.Source condition = default)
                {
                ...
                /// Creates an instance of a <see cref="TestPresetsItemsV3Entity"/>.
                /// </summary>
                public void Create(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TopCondition.Source condition = default)
                {
                    Create(ref _builder, condition);
                }
                ...
                /// Creates an instance of a <see cref="TestPresetsItemsV3Entity"/>.
                /// </summary>
                public void Create<TContext>(in TContext context, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TopCondition.Source<TContext> condition = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                    Create(context, ref _builder, condition);
                }
                ...
                internal static void BuildCreateValue(scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TopCondition.Source arg1, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                    Create(ref o, arg1);
                    o.EndObject();
                ...
                /// <param name="arg1">The value of the property.</param>
                /// <param name="o">The complex value builder into which to write the object.</param>
                internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TopCondition.Source<TContext> arg1, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TopCondition.Source condition = default)
            {
            ...
            /// <param name="condition">The value of the <c>"condition"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TopCondition.Source<TContext> condition = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Source<TContext>(context, condition);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TopCondition.Source condition = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(condition);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TopCondition.Source<TContext> condition = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            {
                return workspace.CreateBuilder<TestPresetsItemsV3Entity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TestPresetsItemsV3Entity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TestPresetsItemsV3Entity>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<TestPresetsItemsV3Entity> Create<TContext>(
            ...
            public static ParsedJsonDocument<TestPresetsItemsV3Entity> Create(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TopCondition.Source condition = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<TestPresetsItemsV3Entity> Create<TContext>(in TContext context, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TopCondition.Source<TContext> condition = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
