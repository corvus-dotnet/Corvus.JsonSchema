...
public readonly partial struct CmakePresetsSchema
{
    ...
    public readonly partial struct TestPresetsItemsV3
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="TestPresetsItemsV3Entity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal TestPresetsItemsV3Entity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static TestPresetsItemsV3Entity DefaultInstance { get; }
            ...
            /// </summary>
            public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TopCondition Condition
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ConditionUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TopCondition value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in TestPresetsItemsV3Entity left, in TestPresetsItemsV3Entity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in TestPresetsItemsV3Entity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(TestPresetsItemsV3Entity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TestPresetsItemsV3Entity(JsonElement instance)
            {
                return TestPresetsItemsV3Entity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TestPresetsItemsV3Entity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TestPresetsItemsV3Entity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TestPresetsItemsV3Entity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TestPresetsItemsV3Entity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TestPresetsItemsV3Entity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TestPresetsItemsV3Entity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TestPresetsItemsV3Entity>(json, options);
            }
            ...
            /// </exception>
            public static TestPresetsItemsV3Entity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<TestPresetsItemsV3Entity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out TestPresetsItemsV3Entity? result)
            {
                return JsonElementHelpers.TryParseValue<TestPresetsItemsV3Entity>(ref reader, out result);
            }
...
#if NET
            static TestPresetsItemsV3Entity IJsonElement<TestPresetsItemsV3Entity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TestPresetsItemsV3Entity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public TestPresetsItemsV3Entity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public TestPresetsItemsV3Entity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<TestPresetsItemsV3Entity>(_idx);
                }
