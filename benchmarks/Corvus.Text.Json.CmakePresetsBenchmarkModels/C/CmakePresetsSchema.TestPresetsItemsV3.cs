...
public readonly partial struct CmakePresetsSchema
{
    ...
    public readonly partial struct TestPresetsItemsV3
        ...
        : IJsonElement<TestPresetsItemsV3>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TestPresetsItemsV3"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TestPresetsItemsV3(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TestPresetsItemsV3 DefaultInstance { get; }
        ...
        public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV3.TestPresetsItemsV3Entity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV3.TestPresetsItemsV3Entity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV3.TestPresetsItemsV3Entity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV3.TestPresetsItemsV3Entity>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in TestPresetsItemsV3 left, in TestPresetsItemsV3 right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TestPresetsItemsV3 left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(TestPresetsItemsV3 instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TestPresetsItemsV3(JsonElement instance)
        {
            return TestPresetsItemsV3.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TestPresetsItemsV3 From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TestPresetsItemsV3 ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TestPresetsItemsV3>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TestPresetsItemsV3 ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TestPresetsItemsV3>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TestPresetsItemsV3 ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TestPresetsItemsV3>(json, options);
        }
        ...
        /// </exception>
        public static TestPresetsItemsV3 ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<TestPresetsItemsV3>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TestPresetsItemsV3? result)
        {
            return JsonElementHelpers.TryParseValue<TestPresetsItemsV3>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TestPresetsItemsV3(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static TestPresetsItemsV3 IJsonElement<TestPresetsItemsV3>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TestPresetsItemsV3: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TestPresetsItemsV3"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TestPresetsItemsV3"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public TestPresetsItemsV3 Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TestPresetsItemsV3>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TestPresetsItemsV3"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public TestPresetsItemsV3 Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TestPresetsItemsV3>(_idx);
            }
