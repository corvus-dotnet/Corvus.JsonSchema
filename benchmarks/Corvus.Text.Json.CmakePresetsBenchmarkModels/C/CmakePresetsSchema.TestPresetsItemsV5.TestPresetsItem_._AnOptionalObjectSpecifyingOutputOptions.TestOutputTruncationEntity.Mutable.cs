            ...
            public readonly partial struct AnOptionalObjectSpecifyingOutputOptions
            {
                ...
                public readonly partial struct TestOutputTruncationEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(TestOutputTruncationEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="TestOutputTruncationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator TestOutputTruncationEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"TestOutputTruncationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly TestOutputTruncationEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly TestOutputTruncationEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<TestOutputTruncationEntity>(_idx);
                        }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(TestOutputTruncationEntity instance) => new(JsonElement.From(instance));
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator Source(KnownValues value) => (TestOutputTruncationEntity)value;
                    ...
                    {
                        return workspace.CreateBuilder<TestOutputTruncationEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<TestOutputTruncationEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<TestOutputTruncationEntity>();
                        }
                        finally
                        {
