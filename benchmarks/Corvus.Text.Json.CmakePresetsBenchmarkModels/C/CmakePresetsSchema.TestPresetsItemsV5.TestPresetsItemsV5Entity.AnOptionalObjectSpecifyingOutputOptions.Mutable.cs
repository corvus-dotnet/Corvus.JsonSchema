        ...
        public readonly partial struct TestPresetsItemsV5Entity
        {
            ...
            public readonly partial struct AnOptionalObjectSpecifyingOutputOptions
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(AnOptionalObjectSpecifyingOutputOptions instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="AnOptionalObjectSpecifyingOutputOptions"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AnOptionalObjectSpecifyingOutputOptions(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV5.TestPresetsItemsV5Entity.AnOptionalObjectSpecifyingOutputOptions.TestOutputTruncationEntity.Mutable TestOutputTruncation
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TestOutputTruncationUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV5.TestPresetsItemsV5Entity.AnOptionalObjectSpecifyingOutputOptions.TestOutputTruncationEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetTestOutputTruncation(scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV5.TestPresetsItemsV5Entity.AnOptionalObjectSpecifyingOutputOptions.TestOutputTruncationEntity.Source value)
                    {
                        CheckValidInstance();
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AnOptionalObjectSpecifyingOutputOptions.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AnOptionalObjectSpecifyingOutputOptions Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AnOptionalObjectSpecifyingOutputOptions Freeze()
                    {
                        CheckValidInstance();
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV5.TestPresetsItemsV5Entity.AnOptionalObjectSpecifyingOutputOptions.TestOutputTruncationEntity.Source _createArg1;
                    ...
                    internal Source(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV5.TestPresetsItemsV5Entity.AnOptionalObjectSpecifyingOutputOptions.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV5.TestPresetsItemsV5Entity.AnOptionalObjectSpecifyingOutputOptions.TestOutputTruncationEntity.Source arg1)
                    {
                        _createArg1 = arg1;
                        _kind = Kind.Create;
                    }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV5.TestPresetsItemsV5Entity.AnOptionalObjectSpecifyingOutputOptions.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="AnOptionalObjectSpecifyingOutputOptions"/>.
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV5.TestPresetsItemsV5Entity.AnOptionalObjectSpecifyingOutputOptions.TestOutputTruncationEntity.Source testOutputTruncation = default)
                    {
                    ...
                    /// Creates an instance of a <see cref="AnOptionalObjectSpecifyingOutputOptions"/>.
                    /// </summary>
                    public void Create(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV5.TestPresetsItemsV5Entity.AnOptionalObjectSpecifyingOutputOptions.TestOutputTruncationEntity.Source testOutputTruncation = default)
                    {
                        Create(ref _builder, testOutputTruncation);
                    }
                    ...
                    internal static void BuildCreateValue(scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV5.TestPresetsItemsV5Entity.AnOptionalObjectSpecifyingOutputOptions.TestOutputTruncationEntity.Source arg1, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                        Create(ref o, arg1);
                        o.EndObject();
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV5.TestPresetsItemsV5Entity.AnOptionalObjectSpecifyingOutputOptions.TestOutputTruncationEntity.Source testOutputTruncation = default)
                {
                    return new Source(testOutputTruncation);
                }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV5.TestPresetsItemsV5Entity.AnOptionalObjectSpecifyingOutputOptions.TestOutputTruncationEntity.Source testOutputTruncation = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(testOutputTruncation);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<AnOptionalObjectSpecifyingOutputOptions, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<AnOptionalObjectSpecifyingOutputOptions> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<AnOptionalObjectSpecifyingOutputOptions>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<AnOptionalObjectSpecifyingOutputOptions> Create<TContext>(
                ...
                public static ParsedJsonDocument<AnOptionalObjectSpecifyingOutputOptions> Create(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV5.TestPresetsItemsV5Entity.AnOptionalObjectSpecifyingOutputOptions.TestOutputTruncationEntity.Source testOutputTruncation = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
