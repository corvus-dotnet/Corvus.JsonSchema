...
public readonly partial struct CmakePresetsSchema
{
...
#endif
    {
        ...
        public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV5.TestPresetsItemsV5Entity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV5.TestPresetsItemsV5Entity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV5.TestPresetsItemsV5Entity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV5.TestPresetsItemsV5Entity>(_parent, _idx);
        }
