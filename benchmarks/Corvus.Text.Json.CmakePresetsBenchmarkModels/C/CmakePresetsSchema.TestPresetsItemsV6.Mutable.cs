...
public readonly partial struct CmakePresetsSchema
{
    ...
    public readonly partial struct TestPresetsItemsV6
    {
...
#endif
        {
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV6.TestPresetsItemsV6Entity.Source value)
            {
                CheckValidInstance();
