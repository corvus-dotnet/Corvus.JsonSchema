        ...
        public readonly partial struct TestPresetsItemsV6Entity
        {
            ...
            public readonly partial struct AnOptionalObjectSpecifyingOutputOptions
            {
...
#endif
                {
                    ...
                    public void SetOutputJUnitFile(in Corvus.CmakePresetsBenchmark.Current.JsonString.Source value)
                    {
                        CheckValidInstance();
                ...
                public ref struct Source
                {
                    ...
                    internal Source(in Corvus.CmakePresetsBenchmark.Current.JsonString.Source arg1)
                    {
                        _createArg1 = arg1;
                        _kind = Kind.Create;
                    }
                ...
                public ref struct Builder
                {
                    ...
                    internal static void BuildCreateValue(in Corvus.CmakePresetsBenchmark.Current.JsonString.Source arg1, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                        Create(ref o, arg1);
                        o.EndObject();
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(in Corvus.CmakePresetsBenchmark.Current.JsonString.Source outputJUnitFile = default)
                {
