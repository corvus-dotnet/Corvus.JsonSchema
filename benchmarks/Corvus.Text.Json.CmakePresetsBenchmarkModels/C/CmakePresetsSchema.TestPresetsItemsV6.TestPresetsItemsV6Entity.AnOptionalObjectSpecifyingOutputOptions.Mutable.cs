        ...
        public readonly partial struct TestPresetsItemsV6Entity
        {
            ...
            public readonly partial struct AnOptionalObjectSpecifyingOutputOptions
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.CmakePresetsBenchmark.Current.JsonString.Mutable OutputJUnitFile
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OutputJUnitFileUtf8, out Corvus.CmakePresetsBenchmark.Current.JsonString.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetOutputJUnitFile(scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source value)
                    {
                        CheckValidInstance();
                        ...
                        else
                        {
                            ...
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.OutputJUnitFile, ref cvb);
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV6.TestPresetsItemsV6Entity.AnOptionalObjectSpecifyingOutputOptions.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source arg1)
                    {
                        _createArg1 = arg1;
                        _kind = Kind.Create;
                    }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV6.TestPresetsItemsV6Entity.AnOptionalObjectSpecifyingOutputOptions.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source outputJUnitFile = default)
                    {
                        outputJUnitFile.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.OutputJUnitFile, ref builder);
                    }

                    /// <summary>
                    /// Creates an instance of a <see cref="AnOptionalObjectSpecifyingOutputOptions"/>.
                    /// </summary>
                    public void Create(in Corvus.CmakePresetsBenchmark.Current.JsonString.Source outputJUnitFile = default)
                    {
                        Create(ref _builder, outputJUnitFile);
                    }
                    ...
                    internal static void BuildCreateValue(scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source arg1, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                        Create(ref o, arg1);
                        o.EndObject();
                ...
                /// </summary>
                /// <param name="outputJUnitFile">The value of the <c>"outputJUnitFile"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.CmakePresetsBenchmark.Current.JsonString.Source outputJUnitFile = default)
                {
                    return new Source(outputJUnitFile);
                }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Current.JsonString.Source outputJUnitFile = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(outputJUnitFile);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                public static ParsedJsonDocument<AnOptionalObjectSpecifyingOutputOptions> Create(in Corvus.CmakePresetsBenchmark.Current.JsonString.Source outputJUnitFile = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
