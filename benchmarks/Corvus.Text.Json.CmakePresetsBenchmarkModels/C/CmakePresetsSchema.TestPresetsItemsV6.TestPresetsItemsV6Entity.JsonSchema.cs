...
public readonly partial struct CmakePresetsSchema
{
    ...
    public readonly partial struct TestPresetsItemsV6
    {
        ...
        public readonly partial struct TestPresetsItemsV6Entity
            : IJsonElement<TestPresetsItemsV6Entity>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchOutput(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV6.TestPresetsItemsV6Entity.AnOptionalObjectSpecifyingOutputOptions.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV6.TestPresetsItemsV6Entity.AnOptionalObjectSpecifyingOutputOptions.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.OutputUtf8))
                    {
                        matcher = MatchOutput;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("cmake-presets-schema.json#/definitions/testPresetsItemsV6/items"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "cmake-presets-schema.json#/definitions/testPresetsItemsV6/items";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "cmake-presets-schema.json#/definitions/testPresetsItemsV6/items"u8;
