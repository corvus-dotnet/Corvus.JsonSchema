...
public readonly partial struct CmakePresetsSchema
{
...
#endif
    {
        ...
        public static implicit operator Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2(TestPresetsV2 value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator TestPresetsV2(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsItemsV2 value)
        {
            return From(value);
        }
