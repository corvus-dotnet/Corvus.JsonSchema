...
public readonly partial struct CmakePresetsSchema
{
    ...
    public readonly partial struct TestPresetsV3
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsV3.RequiredName.OutputEntity Output
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OutputUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsV3.RequiredName.OutputEntity value))
                    {
                        return value;
                    }
