...
public readonly partial struct CmakePresetsSchema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsV2 BuildPresets
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BuildPresetsUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsV2 value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsV1 ConfigurePresets
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ConfigurePresetsUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsV1 value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsV2 TestPresets
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TestPresetsUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsV2 value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WithVersionType2.ARequiredIntegerRepresentingTheVersionOfTheJsonSchema Version
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WithVersionType2.ARequiredIntegerRepresentingTheVersionOfTheJsonSchema value))
                {
                    return value;
                }
