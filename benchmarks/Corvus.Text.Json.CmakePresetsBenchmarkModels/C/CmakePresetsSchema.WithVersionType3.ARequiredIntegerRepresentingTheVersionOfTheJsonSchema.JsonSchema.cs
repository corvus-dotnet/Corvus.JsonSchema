    ...
    public readonly partial struct WithVersionType3
    {
            ...
            : IJsonElement<ARequiredIntegerRepresentingTheVersionOfTheJsonSchema>
        {
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/oneOf/2/properties/version"u8, buffer, out written);
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.Number)
                    {
                        ...
                        JsonSchemaEvaluation.MatchEquals(isNegative, integral, fractional, exponent, false, "3"u8, ""u8, 0, "3", "const"u8, ref context);
                    }
                    else
                    {
                        context.EvaluatedKeyword(false, "3", messageProvider: JsonSchemaEvaluation.ExpectedEquals, "const"u8);
                    }
                }
