...
public readonly partial struct CmakePresetsSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WithVersionType3"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal WithVersionType3(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static WithVersionType3 DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsV3 BuildPresets
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BuildPresetsUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsV3 value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsV3 TestPresets
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TestPresetsUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsV3 value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WithVersionType3.ARequiredIntegerRepresentingTheVersionOfTheJsonSchema Version
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WithVersionType3.ARequiredIntegerRepresentingTheVersionOfTheJsonSchema value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in WithVersionType3 left, in WithVersionType3 right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in WithVersionType3 left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(WithVersionType3 instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator WithVersionType3(JsonElement instance)
        {
            return WithVersionType3.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WithVersionType3 From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WithVersionType3 ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<WithVersionType3>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WithVersionType3 ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<WithVersionType3>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WithVersionType3 ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<WithVersionType3>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static WithVersionType3 ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<WithVersionType3>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out WithVersionType3? result)
        {
            return JsonElementHelpers.TryParseValue<WithVersionType3>(ref reader, out result);
        }
...
#if NET
        static WithVersionType3 IJsonElement<WithVersionType3>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"WithVersionType3: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="WithVersionType3"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="WithVersionType3"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public WithVersionType3 Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<WithVersionType3>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="WithVersionType3"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public WithVersionType3 Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<WithVersionType3>(_idx);
            }
