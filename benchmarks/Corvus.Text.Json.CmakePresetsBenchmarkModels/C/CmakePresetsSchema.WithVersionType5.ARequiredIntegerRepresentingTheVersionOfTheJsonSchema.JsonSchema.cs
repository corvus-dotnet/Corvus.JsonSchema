    ...
    public readonly partial struct WithVersionType5
    {
            ...
            : IJsonElement<ARequiredIntegerRepresentingTheVersionOfTheJsonSchema>
        {
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/oneOf/4/properties/version"u8, buffer, out written);
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.Number)
                    {
                        ...
                        JsonSchemaEvaluation.MatchEquals(isNegative, integral, fractional, exponent, false, "5"u8, ""u8, 0, "5", "const"u8, ref context);
                    }
                    else
                    {
                        context.EvaluatedKeyword(false, "5", messageProvider: JsonSchemaEvaluation.ExpectedEquals, "const"u8);
                    }
                }
