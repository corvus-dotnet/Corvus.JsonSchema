    ...
    public readonly partial struct WithVersionType8
    {
            ...
            : IJsonElement<ARequiredIntegerRepresentingTheVersionOfTheJsonSchema>
        {
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/oneOf/7/properties/version"u8, buffer, out written);
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.Number)
                    {
                        ...
                        JsonSchemaEvaluation.MatchEquals(isNegative, integral, fractional, exponent, false, "8"u8, ""u8, 0, "8", "const"u8, ref context);
                    }
                    else
                    {
                        context.EvaluatedKeyword(false, "8", messageProvider: JsonSchemaEvaluation.ExpectedEquals, "const"u8);
                    }
                }
