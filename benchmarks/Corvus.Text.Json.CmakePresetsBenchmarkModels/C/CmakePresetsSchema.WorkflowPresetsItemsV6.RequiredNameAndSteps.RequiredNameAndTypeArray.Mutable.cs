        ...
        public readonly partial struct RequiredNameAndSteps
        {
            ...
            public readonly partial struct RequiredNameAndTypeArray
            {
...
#endif
                {
                    ...
                    public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.Mutable this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.Mutable>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.Mutable> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.Mutable>(_parent, _idx);
                    }
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void SetItem(int itemIndex, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void InsertItem(int itemIndex, scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void AddItem(scoped in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.Source value)
                    {
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Remove(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType item)
                    {
                        CheckValidInstance();
                        if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType>(this, in item))
                        {
                            return false;
                        }
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void RemoveWhere(JsonPredicate<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType> predicate)
                    {
                        CheckValidInstance();
                        JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType>(this, predicate);
                        _documentVersion = _parent.Version;
                    }
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Replace(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType oldItem, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.Source newItem)
                    {
                        CheckValidInstance();
                        ...
                        var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType>(_parent, _idx);

                        while (enumerator.MoveNext())
                        {
                            Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType current = enumerator.Current;
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// </summary>
                    public void AddItem(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.Source value)
                    {
                    ...
                    /// Add an item to the array.
                    /// </summary>
                    public void AddItem<TContext>(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.Source<TContext> value)
#if NET9_0_OR_GREATER
                        where TContext : allows ref struct
#endif
                    {
                ...
                public static ParsedJsonDocument<RequiredNameAndTypeArray> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RequiredNameAndTypeArray>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredNameAndTypeArray> Create<TContext>(
