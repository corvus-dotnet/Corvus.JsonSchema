            ...
            public readonly partial struct RequiredNameAndTypeArray
            {
                ...
                public readonly partial struct RequiredNameAndType
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RequiredNameAndType instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RequiredNameAndType"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RequiredNameAndType(Mutable instance)
                        {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.NameEntity.Mutable Name
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.NameEntity.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.TypeEntity.Mutable Type
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.TypeEntity.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new RequiredNameAndType(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RequiredNameAndType.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="RequiredNameAndType"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="RequiredNameAndType"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredNameAndType Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<RequiredNameAndType>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="RequiredNameAndType"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredNameAndType Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RequiredNameAndType>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        private readonly Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.NameEntity.Source _createArg1;
                        private readonly Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.TypeEntity.Source _createArg2;
                        ...
                        public static implicit operator Source(RequiredNameAndType instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        /// <summary>
                        /// Creates an instance of a <see cref="RequiredNameAndType"/>.
                        /// </summary>
                        internal static void Create(
                            ref ComplexValueBuilder builder,
                            in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.NameEntity.Source name,
                            in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.TypeEntity.Source type)
                        {
                        ...
                        /// Creates an instance of a <see cref="RequiredNameAndType"/>.
                        /// </summary>
                        public void Create(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.NameEntity.Source name, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.TypeEntity.Source type)
                        {
                            Create(ref _builder, name, type);
                        }
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.NameEntity.Source name, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.TypeEntity.Source type, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(name, type);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    {
                        return workspace.CreateBuilder<RequiredNameAndType, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<RequiredNameAndType> Create(
                        scoped in Source value, int initialCapacity = 30)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<RequiredNameAndType>();
                        }
                        finally
                        {
                    ...
                    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<RequiredNameAndType> Create<TContext>(
                    ...
                    public static ParsedJsonDocument<RequiredNameAndType> Create(in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.NameEntity.Source name, in Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.RequiredNameAndType.TypeEntity.Source type, int initialCapacity = 30)
                    {
                        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                        try
                        {
