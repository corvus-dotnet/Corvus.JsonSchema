...
public readonly partial struct CmakePresetsSchema
{
    ...
    public readonly partial struct WorkflowPresetsV6
    {
...
#endif
        {
            ...
            public static implicit operator Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.Mutable(Mutable value)
            {
                return Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Mutable(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(WorkflowPresetsV6 instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="WorkflowPresetsV6"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator WorkflowPresetsV6(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"WorkflowPresetsV6.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </para>
            /// </remarks>
            public readonly WorkflowPresetsV6 Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly WorkflowPresetsV6 Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<WorkflowPresetsV6>(_idx);
            }

            /// <summary>
            /// Gets the value as a <see cref="Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsWorkflowPresetsItemsV6(out Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.Mutable result)
            {
                if (Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsV6.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(WorkflowPresetsV6 instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsV6.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<WorkflowPresetsV6, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<WorkflowPresetsV6> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<WorkflowPresetsV6>();
            }
            finally
            {
