                ...
                public readonly partial struct SourceEntity
                {
                    ...
                    public readonly partial struct AStringRepresentingThePathToOneSourceFileToBeTracedArray
                    {
...
#endif
                        {
                            ...
                            /// <summary>
                            /// Initializes a new instance of the <see cref="AStringRepresentingThePathToOneSourceFileToBeTraced"/> struct.
                            /// </summary>
                            ...
                            internal AStringRepresentingThePathToOneSourceFileToBeTraced(IJsonDocument parent, int idx)
                            {
                                Debug.Assert(idx >= 0);
                                _parent = parent;
                                _idx = idx;
                            ...
                            /// </summary>
                            public static AStringRepresentingThePathToOneSourceFileToBeTraced DefaultInstance { get; }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static explicit operator string(AStringRepresentingThePathToOneSourceFileToBeTraced value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                            ...
                            /// </returns>
                            public static bool operator ==(in AStringRepresentingThePathToOneSourceFileToBeTraced left, in AStringRepresentingThePathToOneSourceFileToBeTraced right)
                            {
                            ...
                            /// <c>True</c> if the values are equal.
                            /// </returns>
                            public static bool operator ==(in AStringRepresentingThePathToOneSourceFileToBeTraced left, in JsonElement right)
                            {
                                return left.Equals(right);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator JsonElement(AStringRepresentingThePathToOneSourceFileToBeTraced instance)
                            {
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator AStringRepresentingThePathToOneSourceFileToBeTraced(JsonElement instance)
                            {
                                return AStringRepresentingThePathToOneSourceFileToBeTraced.From(instance);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static AStringRepresentingThePathToOneSourceFileToBeTraced From<T>(in T instance)
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static AStringRepresentingThePathToOneSourceFileToBeTraced ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                            {
                                #pragma warning disable CS0618 // Type or member is obsolete
                                return JsonElementHelpers.ParseValue<AStringRepresentingThePathToOneSourceFileToBeTraced>(utf8Json, options);
                            ...
                            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static AStringRepresentingThePathToOneSourceFileToBeTraced ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                            {
                                #pragma warning disable CS0618 // Type or member is obsolete
                                return JsonElementHelpers.ParseValue<AStringRepresentingThePathToOneSourceFileToBeTraced>(json, options);
                                #pragma warning restore CS0618
                            }
                            ...
                            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static AStringRepresentingThePathToOneSourceFileToBeTraced ParseValue(string json, JsonDocumentOptions options = default)
                            {
                                #pragma warning disable CS0618 // Type or member is obsolete
                                return JsonElementHelpers.ParseValue<AStringRepresentingThePathToOneSourceFileToBeTraced>(json, options);
                                #pragma warning restore CS0618
                            ...
                            /// </exception>
                            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                            public static AStringRepresentingThePathToOneSourceFileToBeTraced ParseValue(ref Utf8JsonReader reader)
                            {
                                #pragma warning disable CS0618 // Type or member is obsolete
                                return JsonElementHelpers.ParseValue<AStringRepresentingThePathToOneSourceFileToBeTraced>(ref reader);
                                #pragma warning restore CS0618
                            }
                            ...
                            ///   A value could not be read from the reader.
                            /// </exception>
                            public static bool TryParseValue(ref Utf8JsonReader reader, out AStringRepresentingThePathToOneSourceFileToBeTraced? result)
                            {
                                return JsonElementHelpers.TryParseValue<AStringRepresentingThePathToOneSourceFileToBeTraced>(ref reader, out result);
                            }
...
#if NET
                            static AStringRepresentingThePathToOneSourceFileToBeTraced IJsonElement<AStringRepresentingThePathToOneSourceFileToBeTraced>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"AStringRepresentingThePathToOneSourceFileToBeTraced: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// </para>
                            /// </remarks>
                            public AStringRepresentingThePathToOneSourceFileToBeTraced Clone()
                            {
                                CheckValidInstance();
                            ...
                            /// </para>
                            /// </remarks>
                            public AStringRepresentingThePathToOneSourceFileToBeTraced Freeze()
                            {
                                CheckValidInstance();
                                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                {
                                    return mutable.FreezeElement<AStringRepresentingThePathToOneSourceFileToBeTraced>(_idx);
                                }
