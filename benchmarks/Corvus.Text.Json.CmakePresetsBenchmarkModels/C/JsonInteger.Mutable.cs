...
public readonly partial struct JsonInteger
{
...
#endif
    {
        ...
        public static explicit operator Mutable(JsonInteger instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="JsonInteger"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonInteger(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonInteger.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="JsonInteger"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="JsonInteger"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly JsonInteger Clone()
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="JsonInteger"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly JsonInteger Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonInteger>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(JsonInteger instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<JsonInteger, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<JsonInteger> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<JsonInteger>();
        }
        finally
        {
