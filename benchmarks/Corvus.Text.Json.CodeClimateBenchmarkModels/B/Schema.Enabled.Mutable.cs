...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Enabled
    {
...
#endif
        {
            ...
            /// Enabled
            /// </summary>
            public Corvus.CodeClimateBenchmark.Baseline.Schema.Enabled.EnabledEntity.Mutable EnabledValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnabledValueUtf8, out Corvus.CodeClimateBenchmark.Baseline.Schema.Enabled.EnabledEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetEnabledValue(in Corvus.CodeClimateBenchmark.Baseline.Schema.Enabled.EnabledEntity.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CodeClimateBenchmark.Baseline.Schema.Enabled.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CodeClimateBenchmark.Baseline.Schema.Enabled.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.CodeClimateBenchmark.Baseline.Schema.Enabled.EnabledEntity.Source enabled = default)
            {
            ...
            /// Creates an instance of a <see cref="Enabled"/>.
            /// </summary>
            public void Create(in Corvus.CodeClimateBenchmark.Baseline.Schema.Enabled.EnabledEntity.Source enabled = default)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CodeClimateBenchmark.Baseline.Schema.Enabled.EnabledEntity.Source enabled = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
