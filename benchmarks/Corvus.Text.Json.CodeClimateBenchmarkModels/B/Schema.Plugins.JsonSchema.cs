                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (objectValidation_enumerator.MoveNext())
                    {
                        ...
                        {
                            JsonSchemaContext childContext = Corvus.CodeClimateBenchmark.Baseline.Schema.Enabled.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                            ...
                            Corvus.CodeClimateBenchmark.Baseline.Schema.Enabled.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
