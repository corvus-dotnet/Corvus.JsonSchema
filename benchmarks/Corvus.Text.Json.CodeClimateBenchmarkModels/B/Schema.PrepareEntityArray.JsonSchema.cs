                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (arrayValidation_enumerator.MoveNext())
                    {
                        ...
                        JsonSchemaContext childContext = Corvus.CodeClimateBenchmark.Baseline.Schema.PrepareEntityArray.PrepareEntity.JsonSchema.PushChildContext(
                            parentDocument,
                        ...
                        Corvus.CodeClimateBenchmark.Baseline.Schema.PrepareEntityArray.PrepareEntity.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
