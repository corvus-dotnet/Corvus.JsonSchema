    ...
    public readonly partial struct PrepareEntityArray
    {
        ...
        public readonly partial struct PrepareEntity
        {
...
#endif
            {
                ...
                /// Path
                /// </summary>
                public Corvus.CodeClimateBenchmark.Baseline.JsonString.Mutable Path
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathUtf8, out Corvus.CodeClimateBenchmark.Baseline.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// URL
                /// </summary>
                public Corvus.CodeClimateBenchmark.Baseline.JsonUri.Mutable Url
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UrlUtf8, out Corvus.CodeClimateBenchmark.Baseline.JsonUri.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetPath(in Corvus.CodeClimateBenchmark.Baseline.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetUrl(in Corvus.CodeClimateBenchmark.Baseline.JsonUri.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CodeClimateBenchmark.Baseline.Schema.PrepareEntityArray.PrepareEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CodeClimateBenchmark.Baseline.Schema.PrepareEntityArray.PrepareEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.CodeClimateBenchmark.Baseline.JsonString.Source path = default,
                    in Corvus.CodeClimateBenchmark.Baseline.JsonUri.Source url = default)
                {
                ...
                /// Creates an instance of a <see cref="PrepareEntity"/>.
                /// </summary>
                public void Create(in Corvus.CodeClimateBenchmark.Baseline.JsonString.Source path = default, in Corvus.CodeClimateBenchmark.Baseline.JsonUri.Source url = default)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CodeClimateBenchmark.Baseline.JsonString.Source path = default, in Corvus.CodeClimateBenchmark.Baseline.JsonUri.Source url = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
