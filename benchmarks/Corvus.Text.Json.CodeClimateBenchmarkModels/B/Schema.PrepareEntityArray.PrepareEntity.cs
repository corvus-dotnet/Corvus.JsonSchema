...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PrepareEntityArray
    {
...
#endif
        {
            ...
            /// Path
            /// </summary>
            public Corvus.CodeClimateBenchmark.Baseline.JsonString Path
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathUtf8, out Corvus.CodeClimateBenchmark.Baseline.JsonString value))
                    {
                        return value;
                    }
            ...
            /// URL
            /// </summary>
            public Corvus.CodeClimateBenchmark.Baseline.JsonUri Url
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UrlUtf8, out Corvus.CodeClimateBenchmark.Baseline.JsonUri value))
                    {
                        return value;
                    }
