...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public Corvus.CodeClimateBenchmark.Baseline.Schema.PrepareEntityArray.PrepareEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.CodeClimateBenchmark.Baseline.Schema.PrepareEntityArray.PrepareEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.CodeClimateBenchmark.Baseline.Schema.PrepareEntityArray.PrepareEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CodeClimateBenchmark.Baseline.Schema.PrepareEntityArray.PrepareEntity>(_parent, _idx);
        }
