...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Version
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Version instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Version"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Version(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Version.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Version Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Version>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(Version instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<Version, Mutable>(this);
        }
    }
}
