...
#endif
{
    ...
    /// Checks
    /// </summary>
    public Corvus.CodeClimateBenchmark.Baseline.Schema.Checks ChecksValue
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ChecksValueUtf8, out Corvus.CodeClimateBenchmark.Baseline.Schema.Checks value))
            {
                return value;
            }
    ...
    /// Exclude Patterns
    /// </summary>
    public Corvus.CodeClimateBenchmark.Baseline.Schema.JsonStringArray ExcludePatterns
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludePatternsUtf8, out Corvus.CodeClimateBenchmark.Baseline.Schema.JsonStringArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.CodeClimateBenchmark.Baseline.Schema.Plugins PluginsValue
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PluginsValueUtf8, out Corvus.CodeClimateBenchmark.Baseline.Schema.Plugins value))
            {
                return value;
            }
    ...
    /// Prepare
    /// </summary>
    public Corvus.CodeClimateBenchmark.Baseline.Schema.PrepareEntityArray Prepare
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrepareUtf8, out Corvus.CodeClimateBenchmark.Baseline.Schema.PrepareEntityArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.CodeClimateBenchmark.Baseline.Schema.Version VersionValue
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionValueUtf8, out Corvus.CodeClimateBenchmark.Baseline.Schema.Version value))
            {
                return value;
            }

            return Corvus.CodeClimateBenchmark.Baseline.Schema.Version.DefaultInstance;
        }
    }
