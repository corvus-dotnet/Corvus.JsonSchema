...
public readonly partial struct CodeClimateSchema
{
        ...
        : IJsonElement<Checks>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/properties/checks"u8, buffer, out written);
            ...
            /// </remarks>
            public const string SchemaDocument = "code-climate-schema.json";

            /// <summary>
            /// Gets the schema document from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaDocumentUtf8 => "code-climate-schema.json"u8;

            private static readonly global::Corvus.Text.Json.RuntimeEvaluator.JsonSchemaEvaluator Evaluator = global::Corvus.CodeClimateBenchmark.Current.CorvusJsonSchemaProgram.Entry(5);
