...
public readonly partial struct CodeClimateSchema
{
    ...
    public readonly partial struct Enabled
    {
...
#endif
        {
            ...
            public void SetEnabledValue(in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.EnabledEntity.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.EnabledEntity.Source arg1)
            {
                _createArg1 = arg1;
                _kind = Kind.Create;
            }
        ...
        public ref struct Builder
        {
            ...
            internal static void BuildCreateValue(in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.EnabledEntity.Source arg1, ref ComplexValueBuilder o)
            {
                o.StartObject();
                Create(ref o, arg1);
                o.EndObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.EnabledEntity.Source enabled = default)
        {
