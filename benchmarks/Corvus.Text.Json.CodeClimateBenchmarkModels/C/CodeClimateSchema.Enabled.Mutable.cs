...
public readonly partial struct CodeClimateSchema
{
    ...
    public readonly partial struct Enabled
    {
...
#endif
        {
            ...
            /// Enabled
            /// </summary>
            public Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.EnabledEntity.Mutable EnabledValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnabledValueUtf8, out Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.EnabledEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetEnabledValue(scoped in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.EnabledEntity.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.EnabledValueUtf8);
            ...
            public bool RemoveEnabledValue()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.EnabledValueUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.EnabledEntity.Source _createArg1;
            ...
            internal Source(Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.EnabledEntity.Source arg1)
            {
                _createArg1 = arg1;
                _kind = Kind.Create;
            }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Enabled"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.EnabledEntity.Source enabled = default)
            {
            ...
            /// Creates an instance of a <see cref="Enabled"/>.
            /// </summary>
            public void Create(in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.EnabledEntity.Source enabled = default)
            {
            ...
            internal static void BuildCreateValue(scoped in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.EnabledEntity.Source arg1, ref ComplexValueBuilder o)
            {
                o.StartObject();
                Create(ref o, arg1);
                o.EndObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.EnabledEntity.Source enabled = default)
        {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.EnabledEntity.Source enabled = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        public static ParsedJsonDocument<Enabled> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Enabled>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Enabled> Create<TContext>(
        ...
        public static ParsedJsonDocument<Enabled> Create(in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.EnabledEntity.Source enabled = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
