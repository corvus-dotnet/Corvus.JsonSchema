...
public readonly partial struct CodeClimateSchema
{
...
#endif
    {
        ...
        /// Enabled
        /// </summary>
        public Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.EnabledEntity EnabledValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnabledValueUtf8, out Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.EnabledEntity value))
                {
                    return value;
                }

                return Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.EnabledEntity.DefaultInstance;
            }
        }
