...
public readonly partial struct CodeClimateSchema
{
...
#endif
    {
        ...
        public static explicit operator Mutable(CodeClimateSchema instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="CodeClimateSchema"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator CodeClimateSchema(Mutable instance)
        {
        ...
        /// <summary>
        /// Gets the (optional) <c>checks</c> property.
        /// Checks
        /// </summary>
        public Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Checks.Mutable ChecksValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ChecksValueUtf8, out Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Checks.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the (optional) <c>exclude_patterns</c> property.
        /// Exclude Patterns
        /// </summary>
        public Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.JsonStringArray.Mutable ExcludePatterns
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludePatternsUtf8, out Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.JsonStringArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Plugins.Mutable PluginsValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PluginsValueUtf8, out Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Plugins.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the (optional) <c>prepare</c> property.
        /// Prepare
        /// </summary>
        public Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.Mutable Prepare
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrepareUtf8, out Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Version.Mutable VersionValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionValueUtf8, out Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Version.Mutable value))
                {
                    return value;
                }

                return Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Version.Mutable.DefaultInstance;
            }
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new CodeClimateSchema(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetChecksValue(scoped in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Checks.Source value)
        {
            ...
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ChecksValueUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ChecksValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ChecksValue, ref cvb);
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetChecksValue<TContext>(in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Checks.Source<TContext> value)
        ...
        /// <summary>
        /// Remove the <c>checks</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveChecksValue()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ChecksValueUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        public void SetExcludePatterns(scoped in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.JsonStringArray.Source value)
        {
            ...
            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ExcludePatternsUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludePatternsUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ExcludePatterns, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetExcludePatterns<TContext>(in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.JsonStringArray.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
        ...
        /// <summary>
        /// Remove the <c>exclude_patterns</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveExcludePatterns()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ExcludePatternsUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        public void SetPluginsValue(scoped in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Plugins.Source value)
        {
            ...
            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PluginsValueUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PluginsValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.PluginsValue, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPluginsValue<TContext>(in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Plugins.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
        ...
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemovePluginsValue()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PluginsValueUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        public void SetPrepare(scoped in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.Source value)
        {
            ...
            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PrepareUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrepareUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Prepare, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPrepare<TContext>(in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
        ...
        /// <summary>
        /// Remove the <c>prepare</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemovePrepare()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PrepareUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"CodeClimateSchema.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="CodeClimateSchema"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="CodeClimateSchema"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly CodeClimateSchema Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<CodeClimateSchema>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="CodeClimateSchema"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly CodeClimateSchema Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<CodeClimateSchema>(_idx);
        }
    }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="CodeClimateSchema"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Checks.Source checks = default,
            in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.JsonStringArray.Source excludePatterns = default,
            in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Plugins.Source plugins = default,
            in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.Source prepare = default,
            in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Version.Source version = default)
        {
            checks.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ChecksValue, ref builder);
            excludePatterns.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ExcludePatterns, ref builder);
            plugins.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.PluginsValue, ref builder);
            prepare.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Prepare, ref builder);
        ...
        public void Create(
            ...
            in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Version.Source version = default)
        {
            Create(ref _builder, checks, excludePatterns, plugins, prepare, version);
        }
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Checks.Source<TContext> checks = default,
            in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.JsonStringArray.Source<TContext> excludePatterns = default,
            in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Plugins.Source<TContext> plugins = default,
            in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.Source<TContext> prepare = default,
            in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Version.Source version = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        ...
        #endif
        {
            Create(context, ref _builder, checks, excludePatterns, plugins, prepare, version);
        }
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="checks">The value of the property.</param>
    /// <param name="excludePatterns">The value of the property.</param>
    /// <param name="plugins">The value of the property.</param>
    /// <param name="prepare">The value of the property.</param>
    /// <param name="version">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Checks.Source checks = default, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.JsonStringArray.Source excludePatterns = default, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Plugins.Source plugins = default, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.Source prepare = default, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Version.Source version = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(checks, excludePatterns, plugins, prepare, version);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Checks.Source<TContext> checks = default, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.JsonStringArray.Source<TContext> excludePatterns = default, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Plugins.Source<TContext> plugins = default, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.Source<TContext> prepare = default, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Version.Source version = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, checks, excludePatterns, plugins, prepare, version);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<CodeClimateSchema, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<CodeClimateSchema> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<CodeClimateSchema>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<CodeClimateSchema> Create<TContext>(
    ...
    public static ParsedJsonDocument<CodeClimateSchema> Create(in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Checks.Source checks = default, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.JsonStringArray.Source excludePatterns = default, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Plugins.Source plugins = default, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.Source prepare = default, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Version.Source version = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<CodeClimateSchema> Create<TContext>(in TContext context, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Checks.Source<TContext> checks = default, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.JsonStringArray.Source<TContext> excludePatterns = default, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Plugins.Source<TContext> plugins = default, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.Source<TContext> prepare = default, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Version.Source version = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
