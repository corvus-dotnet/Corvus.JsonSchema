...
public readonly partial struct CodeClimateSchema
{
...
#endif
    {
        ...
        public void SetChecksValue(in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Checks.Source value)
        {
            ...
            else
            {
                ...
                value.AddAsProperty(JsonPropertyNamesEscaped.ChecksValue, ref cvb, escapeName: false, nameRequiresUnescaping: false);
        ...
        public void SetExcludePatterns(in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.JsonStringArray.Source value)
        {
            ...
            {
                // We are going to insert the new value
                value.AddAsProperty(JsonPropertyNamesEscaped.ExcludePatterns, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        public void SetPluginsValue(in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Plugins.Source value)
        {
            ...
            {
                // We are going to insert the new value
                value.AddAsProperty(JsonPropertyNamesEscaped.PluginsValue, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        public void SetPrepare(in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.Source value)
        {
            ...
            {
                // We are going to insert the new value
                value.AddAsProperty(JsonPropertyNamesEscaped.Prepare, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
    ...
    public ref struct Builder
    {
        ...
        {
            checks.AddAsProperty(JsonPropertyNamesEscaped.ChecksValue, ref builder, escapeName: false);
            excludePatterns.AddAsProperty(JsonPropertyNamesEscaped.ExcludePatterns, ref builder, escapeName: false);
            plugins.AddAsProperty(JsonPropertyNamesEscaped.PluginsValue, ref builder, escapeName: false);
            prepare.AddAsProperty(JsonPropertyNamesEscaped.Prepare, ref builder, escapeName: false);
