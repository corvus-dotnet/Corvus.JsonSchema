...
public readonly partial struct CodeClimateSchema
{
    ...
    public readonly partial struct Plugins
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Plugins instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Plugins"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Plugins(Mutable instance)
            {
            ...
            public Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.Mutable this[ReadOnlySpan<byte> propertyName]
            {
                get
                {
                    CheckValidInstance();
                    if (!_parent.TryGetNamedPropertyValue(_idx, propertyName, out Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.Mutable value))
                    {
                        return default;
                    }
            ...
            /// <returns>The value of the property with the given name.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.Mutable this[ReadOnlySpan<char> propertyName]
            {
                get
                {
                    CheckValidInstance();
            ...
            /// <returns>The value of the property with the given name.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.Mutable this[string propertyName]
            {
                get
                {
                    CheckValidInstance();
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.Mutable value)
            {
                CheckValidInstance();
            ...
            /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.Mutable value)
            {
                CheckValidInstance();
                return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
            }
            ...
            /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(string propertyName, out Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.Mutable value)
            {
                CheckValidInstance();
                return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public ObjectEnumerator<Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.Mutable> EnumerateObject()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateObjectEnumerator<Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Plugins(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Plugins.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Plugins"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Plugins"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Plugins Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Plugins>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Plugins"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Plugins Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Plugins>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Plugins.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(Plugins instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Plugins.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            public void AddProperty(ReadOnlySpan<byte> propertyName, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.Source value)
            {
            ...
            /// <param name="propertyName">The name of the property to add.</param>
            /// <param name="value">The value of the property to add.</param>
            public void AddProperty<TContext>(ReadOnlySpan<byte> propertyName, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            /// <param name="propertyName">The name of the property to add.</param>
            /// <param name="value">The value of the property to add.</param>
            public void AddProperty(ReadOnlySpan<char> propertyName, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.Source value)
            {
                value.AddAsProperty(propertyName, ref _builder);
            }
            ...
            /// <param name="propertyName">The name of the property to add.</param>
            /// <param name="value">The value of the property to add.</param>
            public void AddProperty<TContext>(ReadOnlySpan<char> propertyName, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            /// <param name="propertyName">The name of the property to add.</param>
            /// <param name="value">The value of the property to add.</param>
            public void AddProperty(string propertyName, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.Source value)
            {
                value.AddAsProperty(propertyName, ref _builder);
            }
            ...
            /// <param name="propertyName">The name of the property to add.</param>
            /// <param name="value">The value of the property to add.</param>
            public void AddProperty<TContext>(string propertyName, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Enabled.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        {
            return workspace.CreateBuilder<Plugins, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Plugins> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Plugins>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Plugins> Create<TContext>(
