...
public readonly partial struct CodeClimateSchema
{
    ...
    public readonly partial struct PrepareEntityArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PrepareEntityArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PrepareEntityArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PrepareEntityArray(Mutable instance)
            {
            ...
            public Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.PrepareEntity.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.PrepareEntity.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.PrepareEntity.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.PrepareEntity.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PrepareEntityArray(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PrepareEntityArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.PrepareEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, scoped in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.PrepareEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(scoped in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.PrepareEntity.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.PrepareEntity item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.PrepareEntity>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.PrepareEntity> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.PrepareEntity>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.PrepareEntity oldItem, in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.PrepareEntity.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.PrepareEntity>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.PrepareEntity current = enumerator.Current;
            ...
            /// <summary>
            /// Gets a <see cref="PrepareEntityArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="PrepareEntityArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly PrepareEntityArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<PrepareEntityArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="PrepareEntityArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly PrepareEntityArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PrepareEntityArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(PrepareEntityArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            public void AddItem(in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.PrepareEntity.Source value)
            {
            ...
            /// Add an item to the array.
            /// </summary>
            public void AddItem<TContext>(in Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.PrepareEntity.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        {
            return workspace.CreateBuilder<PrepareEntityArray, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<PrepareEntityArray> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<PrepareEntityArray>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<PrepareEntityArray> Create<TContext>(
