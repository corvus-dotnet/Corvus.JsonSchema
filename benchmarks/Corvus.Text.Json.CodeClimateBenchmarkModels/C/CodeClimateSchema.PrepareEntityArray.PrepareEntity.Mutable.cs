...
public readonly partial struct CodeClimateSchema
{
    ...
    public readonly partial struct PrepareEntityArray
    {
        ...
        public readonly partial struct PrepareEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PrepareEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PrepareEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PrepareEntity(Mutable instance)
                {
                ...
                /// Path
                /// </summary>
                public Corvus.CodeClimateBenchmark.Current.JsonString.Mutable Path
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathUtf8, out Corvus.CodeClimateBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// URL
                /// </summary>
                public Corvus.CodeClimateBenchmark.Current.JsonUri.Mutable Url
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UrlUtf8, out Corvus.CodeClimateBenchmark.Current.JsonUri.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new PrepareEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetPath(scoped in Corvus.CodeClimateBenchmark.Current.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetUrl(scoped in Corvus.CodeClimateBenchmark.Current.JsonUri.Source value)
                {
                    CheckValidInstance();
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PrepareEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="PrepareEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="PrepareEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly PrepareEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<PrepareEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="PrepareEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly PrepareEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PrepareEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.CodeClimateBenchmark.Current.JsonString.Source _createArg1;
                private readonly Corvus.CodeClimateBenchmark.Current.JsonUri.Source _createArg2;
                ...
                internal Source(Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.PrepareEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.CodeClimateBenchmark.Current.JsonString.Source arg1, scoped in Corvus.CodeClimateBenchmark.Current.JsonUri.Source arg2)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _kind = Kind.Create;
                ...
                public static implicit operator Source(PrepareEntity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.PrepareEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="PrepareEntity"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.CodeClimateBenchmark.Current.JsonString.Source path = default,
                    in Corvus.CodeClimateBenchmark.Current.JsonUri.Source url = default)
                {
                ...
                /// Creates an instance of a <see cref="PrepareEntity"/>.
                /// </summary>
                public void Create(in Corvus.CodeClimateBenchmark.Current.JsonString.Source path = default, in Corvus.CodeClimateBenchmark.Current.JsonUri.Source url = default)
                {
                    Create(ref _builder, path, url);
                }
                ...
                internal static void BuildCreateValue(scoped in Corvus.CodeClimateBenchmark.Current.JsonString.Source arg1, scoped in Corvus.CodeClimateBenchmark.Current.JsonUri.Source arg2, ref ComplexValueBuilder o)
                {
                    o.StartObject();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.CodeClimateBenchmark.Current.JsonString.Source path = default, scoped in Corvus.CodeClimateBenchmark.Current.JsonUri.Source url = default)
            {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CodeClimateBenchmark.Current.JsonString.Source path = default, in Corvus.CodeClimateBenchmark.Current.JsonUri.Source url = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            {
                return workspace.CreateBuilder<PrepareEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PrepareEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PrepareEntity>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<PrepareEntity> Create<TContext>(
            ...
            public static ParsedJsonDocument<PrepareEntity> Create(in Corvus.CodeClimateBenchmark.Current.JsonString.Source path = default, in Corvus.CodeClimateBenchmark.Current.JsonUri.Source url = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
