...
public readonly partial struct CodeClimateSchema
{
    ...
    public readonly partial struct PrepareEntityArray
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="PrepareEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal PrepareEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static PrepareEntity DefaultInstance { get; }
            ...
            /// Path
            /// </summary>
            public Corvus.CodeClimateBenchmark.Current.JsonString Path
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathUtf8, out Corvus.CodeClimateBenchmark.Current.JsonString value))
                    {
                        return value;
                    }
            ...
            /// URL
            /// </summary>
            public Corvus.CodeClimateBenchmark.Current.JsonUri Url
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UrlUtf8, out Corvus.CodeClimateBenchmark.Current.JsonUri value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in PrepareEntity left, in PrepareEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in PrepareEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(PrepareEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PrepareEntity(JsonElement instance)
            {
                return PrepareEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PrepareEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PrepareEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PrepareEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PrepareEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PrepareEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PrepareEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PrepareEntity>(json, options);
            }
            ...
            /// </exception>
            public static PrepareEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<PrepareEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out PrepareEntity? result)
            {
                return JsonElementHelpers.TryParseValue<PrepareEntity>(ref reader, out result);
            }
...
#if NET
            static PrepareEntity IJsonElement<PrepareEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PrepareEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
