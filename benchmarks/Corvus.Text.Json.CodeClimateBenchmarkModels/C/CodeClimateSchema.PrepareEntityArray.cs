...
public readonly partial struct CodeClimateSchema
{
    ...
    public readonly partial struct PrepareEntityArray
        ...
        : IJsonElement<PrepareEntityArray>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PrepareEntityArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal PrepareEntityArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static PrepareEntityArray DefaultInstance { get; }
        ...
        public Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.PrepareEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.PrepareEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.PrepareEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray.PrepareEntity>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in PrepareEntityArray left, in PrepareEntityArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in PrepareEntityArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(PrepareEntityArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PrepareEntityArray(JsonElement instance)
        {
            return PrepareEntityArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PrepareEntityArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PrepareEntityArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PrepareEntityArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PrepareEntityArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PrepareEntityArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PrepareEntityArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PrepareEntityArray>(json, options);
        }
        ...
        /// </exception>
        public static PrepareEntityArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<PrepareEntityArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out PrepareEntityArray? result)
        {
            return JsonElementHelpers.TryParseValue<PrepareEntityArray>(ref reader, out result);
        }
...
#if NET
        static PrepareEntityArray IJsonElement<PrepareEntityArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PrepareEntityArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public PrepareEntityArray Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public PrepareEntityArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<PrepareEntityArray>(_idx);
            }
