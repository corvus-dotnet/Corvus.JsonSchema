...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CodeClimateSchema"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal CodeClimateSchema(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static CodeClimateSchema DefaultInstance { get; }
    ...
    /// Checks
    /// </summary>
    public Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Checks ChecksValue
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ChecksValueUtf8, out Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Checks value))
            {
                return value;
            }
    ...
    /// Exclude Patterns
    /// </summary>
    public Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.JsonStringArray ExcludePatterns
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludePatternsUtf8, out Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.JsonStringArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Plugins PluginsValue
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PluginsValueUtf8, out Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Plugins value))
            {
                return value;
            }
    ...
    /// Prepare
    /// </summary>
    public Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray Prepare
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrepareUtf8, out Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.PrepareEntityArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Version VersionValue
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionValueUtf8, out Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Version value))
            {
                return value;
            }

            return Corvus.CodeClimateBenchmark.Current.CodeClimateSchema.Version.DefaultInstance;
        }
    }
    ...
    /// </returns>
    public static bool operator ==(in CodeClimateSchema left, in CodeClimateSchema right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in CodeClimateSchema left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(CodeClimateSchema instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator CodeClimateSchema(JsonElement instance)
    {
        return CodeClimateSchema.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CodeClimateSchema From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CodeClimateSchema ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<CodeClimateSchema>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CodeClimateSchema ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<CodeClimateSchema>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CodeClimateSchema ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<CodeClimateSchema>(json, options);
    }
    ...
    /// </exception>
    public static CodeClimateSchema ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<CodeClimateSchema>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out CodeClimateSchema? result)
    {
        return JsonElementHelpers.TryParseValue<CodeClimateSchema>(ref reader, out result);
    }
...
#if NET
    static CodeClimateSchema IJsonElement<CodeClimateSchema>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"CodeClimateSchema: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public CodeClimateSchema Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public CodeClimateSchema Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<CodeClimateSchema>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="ChecksValue"/>.
        /// </summary>
        public const string ChecksValue = "checks";

        /// <summary>
        /// Gets the JSON property name for <see cref="ExcludePatterns"/>.
        /// </summary>
        public const string ExcludePatterns = "exclude_patterns";

        /// <summary>
        /// Gets the JSON property name for <see cref="PluginsValue"/>.
        /// </summary>
        public const string PluginsValue = "plugins";

        /// <summary>
        /// Gets the JSON property name for <see cref="Prepare"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="ChecksValue"/>.
        /// </summary>
        public static ReadOnlySpan<byte> ChecksValueUtf8 => "checks"u8;

        /// <summary>
        /// Gets the JSON property name for <see cref="ExcludePatterns"/>.
        /// </summary>
        public static ReadOnlySpan<byte> ExcludePatternsUtf8 => "exclude_patterns"u8;

        /// <summary>
        /// Gets the JSON property name for <see cref="PluginsValue"/>.
        /// </summary>
        public static ReadOnlySpan<byte> PluginsValueUtf8 => "plugins"u8;

        /// <summary>
        /// Gets the JSON property name for <see cref="Prepare"/>.
        /// </summary>
        public static ReadOnlySpan<byte> PrepareUtf8 => "prepare"u8;
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="ChecksValue"/>.
        /// </summary>
        public static ReadOnlySpan<byte> ChecksValue => "checks"u8;

        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="ExcludePatterns"/>.
        /// </summary>
        public static ReadOnlySpan<byte> ExcludePatterns => "exclude_patterns"u8;

        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="PluginsValue"/>.
        /// </summary>
        public static ReadOnlySpan<byte> PluginsValue => "plugins"u8;

        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Prepare"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Prepare => "prepare"u8;
