...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ArithmeticExpression
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.Mutable Args
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ArgsUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticExpression.OpEntity.Mutable Op
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OpUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticExpression.OpEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetArgs(in Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetArgs<TContext>(in Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetOp(in Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticExpression.OpEntity.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticExpression.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticExpression.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.Source args,
                in Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticExpression.OpEntity.Source op)
            {
            ...
            /// Creates an instance of a <see cref="ArithmeticExpression"/>.
            /// </summary>
            public void Create(in Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.Source args, in Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticExpression.OpEntity.Source op)
            {
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.Source<TContext> args,
                in Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticExpression.OpEntity.Source op)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.Source args, in Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticExpression.OpEntity.Source op, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.Source<TContext> args, in Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticExpression.OpEntity.Source op, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
