...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ArithmeticOperands
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ArithmeticOperands instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ArithmeticOperands"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ArithmeticOperands(Mutable instance)
            {
            ...
            public Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.ArithmeticOperandsEntity.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.ArithmeticOperandsEntity.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.ArithmeticOperandsEntity.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.ArithmeticOperandsEntity.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ArithmeticOperands(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ArithmeticOperands.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.ArithmeticOperandsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.ArithmeticOperandsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.ArithmeticOperandsEntity.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.ArithmeticOperandsEntity item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.ArithmeticOperandsEntity>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.ArithmeticOperandsEntity> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.ArithmeticOperandsEntity>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.ArithmeticOperandsEntity oldItem, in Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.ArithmeticOperandsEntity.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.ArithmeticOperandsEntity>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.ArithmeticOperandsEntity current = enumerator.Current;
            ...
            /// <summary>
            /// Gets a <see cref="ArithmeticOperands"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ArithmeticOperands"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ArithmeticOperands Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ArithmeticOperands>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ArithmeticOperands"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ArithmeticOperands Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ArithmeticOperands>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(ArithmeticOperands instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticOperands.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<ArithmeticOperands, Mutable>(this);
        }
    }
}
