        ...
        public readonly partial struct ArrayOperandsEntity
        {
...
#endif
            {
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Cql2Benchmark.Baseline.Schema.ArrayOperands.ArrayOperandsEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Cql2Benchmark.Baseline.Schema.ArrayOperands.ArrayOperandsEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Cql2Benchmark.Baseline.Schema.ArrayExpression.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Cql2Benchmark.Baseline.Schema.ArrayOperands.ArrayOperandsEntity.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Baseline.Schema.ArrayOperands.ArrayOperandsEntity.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }
