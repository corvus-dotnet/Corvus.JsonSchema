...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ArrayOperands
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ArrayOperands instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ArrayOperands"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ArrayOperands(Mutable instance)
            {
            ...
            public Corvus.Cql2Benchmark.Baseline.Schema.ArrayOperands.ArrayOperandsEntity.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Baseline.Schema.ArrayOperands.ArrayOperandsEntity.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Cql2Benchmark.Baseline.Schema.ArrayOperands.ArrayOperandsEntity.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Baseline.Schema.ArrayOperands.ArrayOperandsEntity.Mutable>(_parent, _idx);
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ArrayOperands.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.Cql2Benchmark.Baseline.Schema.ArrayOperands.ArrayOperandsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.Cql2Benchmark.Baseline.Schema.ArrayOperands.ArrayOperandsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.Cql2Benchmark.Baseline.Schema.ArrayOperands.ArrayOperandsEntity.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.Cql2Benchmark.Baseline.Schema.ArrayOperands.ArrayOperandsEntity item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Cql2Benchmark.Baseline.Schema.ArrayOperands.ArrayOperandsEntity>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.Cql2Benchmark.Baseline.Schema.ArrayOperands.ArrayOperandsEntity> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Cql2Benchmark.Baseline.Schema.ArrayOperands.ArrayOperandsEntity>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.Cql2Benchmark.Baseline.Schema.ArrayOperands.ArrayOperandsEntity oldItem, in Corvus.Cql2Benchmark.Baseline.Schema.ArrayOperands.ArrayOperandsEntity.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Baseline.Schema.ArrayOperands.ArrayOperandsEntity>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.Cql2Benchmark.Baseline.Schema.ArrayOperands.ArrayOperandsEntity current = enumerator.Current;
            ...
            /// </para>
            /// </remarks>
            public readonly ArrayOperands Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ArrayOperands Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ArrayOperands>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Cql2Benchmark.Baseline.Schema.ArrayOperands.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(ArrayOperands instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Baseline.Schema.ArrayOperands.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<ArrayOperands, Mutable>(this);
        }
    }
}
