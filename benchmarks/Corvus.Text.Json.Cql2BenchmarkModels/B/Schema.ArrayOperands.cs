...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public Corvus.Cql2Benchmark.Baseline.Schema.ArrayOperands.ArrayOperandsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Baseline.Schema.ArrayOperands.ArrayOperandsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Cql2Benchmark.Baseline.Schema.ArrayOperands.ArrayOperandsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Baseline.Schema.ArrayOperands.ArrayOperandsEntity>(_parent, _idx);
        }
