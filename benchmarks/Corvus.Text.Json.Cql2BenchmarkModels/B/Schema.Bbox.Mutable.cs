...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Bbox
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.Cql2Benchmark.Baseline.Schema.Bbox.OneOf0Entity.Mutable(Mutable value)
            {
                return Corvus.Cql2Benchmark.Baseline.Schema.Bbox.OneOf0Entity.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Cql2Benchmark.Baseline.Schema.Bbox.OneOf0Entity.Mutable value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Cql2Benchmark.Baseline.Schema.Bbox.OneOf1Entity.Mutable(Mutable value)
            {
                return Corvus.Cql2Benchmark.Baseline.Schema.Bbox.OneOf1Entity.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Cql2Benchmark.Baseline.Schema.Bbox.OneOf1Entity.Mutable value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Cql2Benchmark.Baseline.Schema.Bbox.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                ...
                {
                    return matchOneOf0Entity(Corvus.Cql2Benchmark.Baseline.Schema.Bbox.OneOf0Entity.Mutable.From(this), context);
                }

                if (Corvus.Cql2Benchmark.Baseline.Schema.Bbox.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.Cql2Benchmark.Baseline.Schema.Bbox.OneOf1Entity.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Cql2Benchmark.Baseline.Schema.Bbox.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Cql2Benchmark.Baseline.Schema.Bbox.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf0Entity(Corvus.Cql2Benchmark.Baseline.Schema.Bbox.OneOf0Entity.Mutable.From(this));
                }

                if (Corvus.Cql2Benchmark.Baseline.Schema.Bbox.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.Cql2Benchmark.Baseline.Schema.Bbox.OneOf1Entity.Mutable.From(this));
                }
            ...
            public bool TryGetAsOneOf0Entity(out Corvus.Cql2Benchmark.Baseline.Schema.Bbox.OneOf0Entity result)
            {
                if (Corvus.Cql2Benchmark.Baseline.Schema.Bbox.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Cql2Benchmark.Baseline.Schema.Bbox.OneOf0Entity.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsOneOf1Entity(out Corvus.Cql2Benchmark.Baseline.Schema.Bbox.OneOf1Entity result)
            {
                if (Corvus.Cql2Benchmark.Baseline.Schema.Bbox.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Cql2Benchmark.Baseline.Schema.Bbox.OneOf1Entity.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Cql2Benchmark.Baseline.Schema.Bbox.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Baseline.Schema.Bbox.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
