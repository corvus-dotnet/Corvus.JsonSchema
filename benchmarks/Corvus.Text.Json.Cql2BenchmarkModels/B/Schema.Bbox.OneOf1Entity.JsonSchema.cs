    ...
    public readonly partial struct Bbox
    {
            ...
            : IJsonElement<OneOf1Entity>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("cql2-schema.json#/$defs/bbox/oneOf/1"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "cql2-schema.json#/$defs/bbox/oneOf/1";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "cql2-schema.json#/$defs/bbox/oneOf/1"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.StartArray)
                    {
                        ...
                        JsonSchemaEvaluation.MatchItemCountLessThanOrEquals(6, arrayValidation_itemCount, "maxItems"u8, ref context);
                        ...
                        JsonSchemaEvaluation.MatchItemCountGreaterThanOrEquals(6, arrayValidation_itemCount, "minItems"u8, ref context);
                    }
                    else
                    {
