...
public readonly partial struct Schema
{
    ...
    public readonly partial struct BboxLiteral
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Baseline.Schema.Bbox.Mutable BboxValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BboxValueUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.Bbox.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetBboxValue(in Corvus.Cql2Benchmark.Baseline.Schema.Bbox.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetBboxValue<TContext>(in Corvus.Cql2Benchmark.Baseline.Schema.Bbox.Source<TContext> value)
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Cql2Benchmark.Baseline.Schema.BboxLiteral.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Baseline.Schema.BboxLiteral.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.Cql2Benchmark.Baseline.Schema.Bbox.Source bbox)
            {
            ...
            /// Creates an instance of a <see cref="BboxLiteral"/>.
            /// </summary>
            public void Create(in Corvus.Cql2Benchmark.Baseline.Schema.Bbox.Source bbox)
            {
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.Cql2Benchmark.Baseline.Schema.Bbox.Source<TContext> bbox)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="BboxLiteral"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.Cql2Benchmark.Baseline.Schema.Bbox.Source<TContext> bbox)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Cql2Benchmark.Baseline.Schema.Bbox.Source bbox, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Cql2Benchmark.Baseline.Schema.Bbox.Source<TContext> bbox, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
