...
public readonly partial struct Schema
{
    ...
    public readonly partial struct DateInstant
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Baseline.Schema.DateString.Mutable Date
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DateUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.DateString.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetDate(in Corvus.Cql2Benchmark.Baseline.Schema.DateString.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Cql2Benchmark.Baseline.Schema.DateInstant.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Baseline.Schema.DateInstant.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.Cql2Benchmark.Baseline.Schema.DateString.Source date)
            {
            ...
            /// Creates an instance of a <see cref="DateInstant"/>.
            /// </summary>
            public void Create(in Corvus.Cql2Benchmark.Baseline.Schema.DateString.Source date)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Cql2Benchmark.Baseline.Schema.DateString.Source date, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
