...
public readonly partial struct Schema
{
    ...
    public readonly partial struct DateString
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DateString instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DateString"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DateString(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DateString.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly DateString Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly DateString Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DateString>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(DateString instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<DateString, Mutable>(this);
        }
    }
}
