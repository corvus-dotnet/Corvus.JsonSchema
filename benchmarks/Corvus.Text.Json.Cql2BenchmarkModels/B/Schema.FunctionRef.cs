...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Baseline.Schema.FunctionRef.ArgsEntityArray Args
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ArgsUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.FunctionRef.ArgsEntityArray value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Baseline.Schema.FunctionRef.OpEntity Op
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OpUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.FunctionRef.OpEntity value))
                {
                    return value;
                }
