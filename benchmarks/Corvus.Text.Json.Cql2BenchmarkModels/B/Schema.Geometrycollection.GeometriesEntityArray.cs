...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Geometrycollection
    {
...
#endif
        {
            ...
            public Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.GeometriesEntityArray.GeometriesEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.GeometriesEntityArray.GeometriesEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.GeometriesEntityArray.GeometriesEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.GeometriesEntityArray.GeometriesEntity>(_parent, _idx);
            }
