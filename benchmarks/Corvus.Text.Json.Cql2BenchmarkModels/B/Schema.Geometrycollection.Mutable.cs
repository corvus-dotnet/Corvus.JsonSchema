...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Geometrycollection
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Geometrycollection instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Geometrycollection"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Geometrycollection(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.GeometriesEntityArray.Mutable Geometries
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GeometriesUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.GeometriesEntityArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.TypeEntity.Mutable Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.TypeEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Geometrycollection(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetGeometries(in Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.GeometriesEntityArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetGeometries<TContext>(in Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.GeometriesEntityArray.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(in Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.TypeEntity.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Geometrycollection.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Geometrycollection"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Geometrycollection"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Geometrycollection Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Geometrycollection>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Geometrycollection"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Geometrycollection Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Geometrycollection>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(Geometrycollection instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Geometrycollection"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.GeometriesEntityArray.Source geometries,
                in Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.TypeEntity.Source type)
            {
            ...
            /// Creates an instance of a <see cref="Geometrycollection"/>.
            /// </summary>
            public void Create(in Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.GeometriesEntityArray.Source geometries, in Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.TypeEntity.Source type)
            {
                Create(ref _builder, geometries, type);
            }
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.GeometriesEntityArray.Source<TContext> geometries,
                in Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.TypeEntity.Source type)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            ...
            #endif
            {
                Create(context, ref _builder, geometries, type);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.GeometriesEntityArray.Source geometries, in Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.TypeEntity.Source type, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(geometries, type);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.GeometriesEntityArray.Source<TContext> geometries, in Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.TypeEntity.Source type, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, geometries, type);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<Geometrycollection, Mutable>(this);
        }
    }
}
