...
public readonly partial struct Schema
{
    ...
    public readonly partial struct InListOperands
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(InListOperands instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="InListOperands"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator InListOperands(Mutable instance)
            {
            ...
            /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public Corvus.Cql2Benchmark.Baseline.Schema.ScalarExpression.Mutable Item1
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Baseline.Schema.ScalarExpression.Mutable>(_idx, 0);
                }
            }
            ...
            /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public Corvus.Cql2Benchmark.Baseline.Schema.InListOperands.ScalarExpressionArray.Mutable Item2
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Baseline.Schema.InListOperands.ScalarExpressionArray.Mutable>(_idx, 1);
                }
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"InListOperands.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </para>
            /// </remarks>
            public readonly InListOperands Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly InListOperands Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<InListOperands>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Cql2Benchmark.Baseline.Schema.InListOperands.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(InListOperands instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Baseline.Schema.InListOperands.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            public void CreateTuple(in Corvus.Cql2Benchmark.Baseline.Schema.ScalarExpression.Source item1, in Corvus.Cql2Benchmark.Baseline.Schema.InListOperands.ScalarExpressionArray.Source item2)
            {
        ...
        {
            return workspace.CreateBuilder<InListOperands, Mutable>(this);
        }
    }
}
