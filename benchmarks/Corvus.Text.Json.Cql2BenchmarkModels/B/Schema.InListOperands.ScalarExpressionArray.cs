...
public readonly partial struct Schema
{
    ...
    public readonly partial struct InListOperands
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ScalarExpressionArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ScalarExpressionArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ScalarExpressionArray DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in ScalarExpressionArray left, in ScalarExpressionArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ScalarExpressionArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(ScalarExpressionArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ScalarExpressionArray(JsonElement instance)
            {
                return ScalarExpressionArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ScalarExpressionArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ScalarExpressionArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ScalarExpressionArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ScalarExpressionArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ScalarExpressionArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ScalarExpressionArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ScalarExpressionArray>(json, options);
            }
            ...
            /// </exception>
            public static ScalarExpressionArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ScalarExpressionArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ScalarExpressionArray? result)
            {
                return JsonElementHelpers.TryParseValue<ScalarExpressionArray>(ref reader, out result);
            }
...
#if NET
            static ScalarExpressionArray IJsonElement<ScalarExpressionArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ScalarExpressionArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ScalarExpressionArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ScalarExpressionArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ScalarExpressionArray>(_idx);
                }
