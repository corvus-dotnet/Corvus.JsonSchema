...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InListOperands"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal InListOperands(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static InListOperands DefaultInstance { get; }
        ...
        /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public Corvus.Cql2Benchmark.Baseline.Schema.ScalarExpression Item1
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Baseline.Schema.ScalarExpression>(_idx, 0);
            }
        }
        ...
        /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public Corvus.Cql2Benchmark.Baseline.Schema.InListOperands.ScalarExpressionArray Item2
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Baseline.Schema.InListOperands.ScalarExpressionArray>(_idx, 1);
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in InListOperands left, in InListOperands right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in InListOperands left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(InListOperands instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator InListOperands(JsonElement instance)
        {
            return InListOperands.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static InListOperands From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static InListOperands ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<InListOperands>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static InListOperands ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<InListOperands>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static InListOperands ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<InListOperands>(json, options);
        }
        ...
        /// </exception>
        public static InListOperands ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<InListOperands>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out InListOperands? result)
        {
            return JsonElementHelpers.TryParseValue<InListOperands>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new InListOperands(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static InListOperands IJsonElement<InListOperands>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"InListOperands: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="InListOperands"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="InListOperands"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public InListOperands Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<InListOperands>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="InListOperands"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public InListOperands Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<InListOperands>(_idx);
            }
