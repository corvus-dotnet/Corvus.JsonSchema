...
public readonly partial struct Schema
{
    ...
    public readonly partial struct InstantString
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.Cql2Benchmark.Baseline.Schema.DateString"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Cql2Benchmark.Baseline.Schema.DateString.Mutable(Mutable value)
            {
                return Corvus.Cql2Benchmark.Baseline.Schema.DateString.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Cql2Benchmark.Baseline.Schema.DateString"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Cql2Benchmark.Baseline.Schema.DateString.Mutable value)
            {
                return From(value);
            }

            /// <summary>
            /// Conversion to <see cref="Corvus.Cql2Benchmark.Baseline.Schema.TimestampString"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Cql2Benchmark.Baseline.Schema.TimestampString.Mutable(Mutable value)
            {
                return Corvus.Cql2Benchmark.Baseline.Schema.TimestampString.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Cql2Benchmark.Baseline.Schema.TimestampString"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Cql2Benchmark.Baseline.Schema.TimestampString.Mutable value)
            {
                return From(value);
            }
            ...
            /// <param name="matchDateString">Match a <see cref="Corvus.Cql2Benchmark.Baseline.Schema.DateString"/>.</param>
            /// <param name="matchTimestampString">Match a <see cref="Corvus.Cql2Benchmark.Baseline.Schema.TimestampString"/>.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.Cql2Benchmark.Baseline.Schema.DateString, TContext, TResult> matchDateString,
                Matcher<Corvus.Cql2Benchmark.Baseline.Schema.TimestampString, TContext, TResult> matchTimestampString,
                Matcher<Corvus.Cql2Benchmark.Baseline.Schema.InstantString.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                if (Corvus.Cql2Benchmark.Baseline.Schema.DateString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchDateString(Corvus.Cql2Benchmark.Baseline.Schema.DateString.Mutable.From(this), context);
                }

                if (Corvus.Cql2Benchmark.Baseline.Schema.TimestampString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchTimestampString(Corvus.Cql2Benchmark.Baseline.Schema.TimestampString.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.Cql2Benchmark.Baseline.Schema.DateString, TResult> matchDateString,
                Matcher<Corvus.Cql2Benchmark.Baseline.Schema.TimestampString, TResult> matchTimestampString,
                Matcher<Corvus.Cql2Benchmark.Baseline.Schema.InstantString.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Cql2Benchmark.Baseline.Schema.DateString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchDateString(Corvus.Cql2Benchmark.Baseline.Schema.DateString.Mutable.From(this));
                }

                if (Corvus.Cql2Benchmark.Baseline.Schema.TimestampString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchTimestampString(Corvus.Cql2Benchmark.Baseline.Schema.TimestampString.Mutable.From(this));
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Cql2Benchmark.Baseline.Schema.DateString" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsDateString(out Corvus.Cql2Benchmark.Baseline.Schema.DateString result)
            {
                if (Corvus.Cql2Benchmark.Baseline.Schema.DateString.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Cql2Benchmark.Baseline.Schema.DateString.Mutable.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Cql2Benchmark.Baseline.Schema.TimestampString" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsTimestampString(out Corvus.Cql2Benchmark.Baseline.Schema.TimestampString result)
            {
                if (Corvus.Cql2Benchmark.Baseline.Schema.TimestampString.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Cql2Benchmark.Baseline.Schema.TimestampString.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Cql2Benchmark.Baseline.Schema.DateString instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Cql2Benchmark.Baseline.Schema.TimestampString instance) => new(JsonElement.From(instance));
