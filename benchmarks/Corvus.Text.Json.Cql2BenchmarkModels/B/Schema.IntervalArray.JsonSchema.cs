...
public readonly partial struct Schema
{
        ...
        : IJsonElement<IntervalArray>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("cql2-schema.json#/$defs/intervalArray"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "cql2-schema.json#/$defs/intervalArray";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "cql2-schema.json#/$defs/intervalArray"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (arrayValidation_enumerator.MoveNext())
                    {
                        ...
                        JsonSchemaContext childContext = Corvus.Cql2Benchmark.Baseline.Schema.IntervalArray.IntervalArrayEntity.JsonSchema.PushChildContext(
                            parentDocument,
                        ...
                        Corvus.Cql2Benchmark.Baseline.Schema.IntervalArray.IntervalArrayEntity.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
