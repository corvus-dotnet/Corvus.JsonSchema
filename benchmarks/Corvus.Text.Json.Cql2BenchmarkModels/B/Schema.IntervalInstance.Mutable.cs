...
public readonly partial struct Schema
{
    ...
    public readonly partial struct IntervalInstance
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(IntervalInstance instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="IntervalInstance"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator IntervalInstance(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Baseline.Schema.IntervalArray.Mutable Interval
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IntervalUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.IntervalArray.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new IntervalInstance(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetInterval(in Corvus.Cql2Benchmark.Baseline.Schema.IntervalArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetInterval<TContext>(in Corvus.Cql2Benchmark.Baseline.Schema.IntervalArray.Source<TContext> value)
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"IntervalInstance.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="IntervalInstance"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="IntervalInstance"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly IntervalInstance Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<IntervalInstance>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="IntervalInstance"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly IntervalInstance Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<IntervalInstance>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Cql2Benchmark.Baseline.Schema.IntervalInstance.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(IntervalInstance instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Baseline.Schema.IntervalInstance.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="IntervalInstance"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.Cql2Benchmark.Baseline.Schema.IntervalArray.Source interval)
            {
            ...
            /// Creates an instance of a <see cref="IntervalInstance"/>.
            /// </summary>
            public void Create(in Corvus.Cql2Benchmark.Baseline.Schema.IntervalArray.Source interval)
            {
                Create(ref _builder, interval);
            }
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.Cql2Benchmark.Baseline.Schema.IntervalArray.Source<TContext> interval)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="IntervalInstance"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.Cql2Benchmark.Baseline.Schema.IntervalArray.Source<TContext> interval)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
                Create(context, ref _builder, interval);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Cql2Benchmark.Baseline.Schema.IntervalArray.Source interval, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Cql2Benchmark.Baseline.Schema.IntervalArray.Source<TContext> interval, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        {
            return workspace.CreateBuilder<IntervalInstance, Mutable>(this);
        }
    }
}
