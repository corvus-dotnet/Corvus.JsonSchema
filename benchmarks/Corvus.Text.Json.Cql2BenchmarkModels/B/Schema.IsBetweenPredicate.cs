...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IsBetweenPredicate"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal IsBetweenPredicate(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static IsBetweenPredicate DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Baseline.Schema.IsBetweenOperands Args
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ArgsUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.IsBetweenOperands value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Baseline.Schema.IsBetweenPredicate.OpEntity Op
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OpUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.IsBetweenPredicate.OpEntity value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in IsBetweenPredicate left, in IsBetweenPredicate right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in IsBetweenPredicate left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(IsBetweenPredicate instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator IsBetweenPredicate(JsonElement instance)
        {
            return IsBetweenPredicate.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IsBetweenPredicate From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IsBetweenPredicate ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IsBetweenPredicate>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IsBetweenPredicate ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IsBetweenPredicate>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IsBetweenPredicate ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IsBetweenPredicate>(json, options);
        }
        ...
        /// </exception>
        public static IsBetweenPredicate ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<IsBetweenPredicate>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out IsBetweenPredicate? result)
        {
            return JsonElementHelpers.TryParseValue<IsBetweenPredicate>(ref reader, out result);
        }
...
#if NET
        static IsBetweenPredicate IJsonElement<IsBetweenPredicate>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"IsBetweenPredicate: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public IsBetweenPredicate Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public IsBetweenPredicate Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<IsBetweenPredicate>(_idx);
            }
