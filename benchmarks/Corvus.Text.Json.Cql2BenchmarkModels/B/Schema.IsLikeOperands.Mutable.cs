...
public readonly partial struct Schema
{
    ...
    public readonly partial struct IsLikeOperands
    {
...
#endif
        {
            ...
            /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public Corvus.Cql2Benchmark.Baseline.Schema.IsLikeOperands.PrefixItems0Entity.Mutable Item1
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Baseline.Schema.IsLikeOperands.PrefixItems0Entity.Mutable>(_idx, 0);
                }
            }
            ...
            /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.Mutable Item2
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.Mutable>(_idx, 1);
                }
            }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Cql2Benchmark.Baseline.Schema.IsLikeOperands.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Baseline.Schema.IsLikeOperands.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            public void CreateTuple(in Corvus.Cql2Benchmark.Baseline.Schema.IsLikeOperands.PrefixItems0Entity.Source item1, in Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.Source item2)
            {
