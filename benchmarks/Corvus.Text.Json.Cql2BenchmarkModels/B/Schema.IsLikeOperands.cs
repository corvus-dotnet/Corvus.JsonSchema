...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IsLikeOperands"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal IsLikeOperands(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static IsLikeOperands DefaultInstance { get; }
        ...
        /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public Corvus.Cql2Benchmark.Baseline.Schema.IsLikeOperands.PrefixItems0Entity Item1
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Baseline.Schema.IsLikeOperands.PrefixItems0Entity>(_idx, 0);
            }
        }
        ...
        /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression Item2
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression>(_idx, 1);
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in IsLikeOperands left, in IsLikeOperands right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in IsLikeOperands left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(IsLikeOperands instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator IsLikeOperands(JsonElement instance)
        {
            return IsLikeOperands.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IsLikeOperands From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IsLikeOperands ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IsLikeOperands>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IsLikeOperands ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IsLikeOperands>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IsLikeOperands ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IsLikeOperands>(json, options);
        }
        ...
        /// </exception>
        public static IsLikeOperands ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<IsLikeOperands>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out IsLikeOperands? result)
        {
            return JsonElementHelpers.TryParseValue<IsLikeOperands>(ref reader, out result);
        }
...
#if NET
        static IsLikeOperands IJsonElement<IsLikeOperands>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"IsLikeOperands: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public IsLikeOperands Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<IsLikeOperands>(_idx);
            }
