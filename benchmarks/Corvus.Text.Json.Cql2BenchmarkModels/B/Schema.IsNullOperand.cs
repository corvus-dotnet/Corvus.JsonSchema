...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public Corvus.Cql2Benchmark.Baseline.Schema.IsNullOperand.IsNullOperandEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Baseline.Schema.IsNullOperand.IsNullOperandEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Cql2Benchmark.Baseline.Schema.IsNullOperand.IsNullOperandEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Baseline.Schema.IsNullOperand.IsNullOperandEntity>(_parent, _idx);
        }
