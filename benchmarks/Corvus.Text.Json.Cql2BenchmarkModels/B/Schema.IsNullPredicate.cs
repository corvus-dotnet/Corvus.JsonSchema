...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IsNullPredicate"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal IsNullPredicate(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static IsNullPredicate DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Baseline.Schema.IsNullOperand Args
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ArgsUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.IsNullOperand value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Baseline.Schema.IsNullPredicate.OpEntity Op
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OpUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.IsNullPredicate.OpEntity value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in IsNullPredicate left, in IsNullPredicate right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in IsNullPredicate left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(IsNullPredicate instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator IsNullPredicate(JsonElement instance)
        {
            return IsNullPredicate.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IsNullPredicate From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IsNullPredicate ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IsNullPredicate>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IsNullPredicate ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IsNullPredicate>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IsNullPredicate ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IsNullPredicate>(json, options);
        }
        ...
        /// </exception>
        public static IsNullPredicate ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<IsNullPredicate>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out IsNullPredicate? result)
        {
            return JsonElementHelpers.TryParseValue<IsNullPredicate>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new IsNullPredicate(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static IsNullPredicate IJsonElement<IsNullPredicate>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"IsNullPredicate: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="IsNullPredicate"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="IsNullPredicate"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<IsNullPredicate>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="IsNullPredicate"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public IsNullPredicate Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<IsNullPredicate>(_idx);
            }
