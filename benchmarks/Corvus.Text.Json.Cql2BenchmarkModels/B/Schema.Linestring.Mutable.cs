...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Linestring
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.Cql2Benchmark.Baseline.Schema.Linestring.JsonNumberArray.Mutable Bbox
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BboxUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.Linestring.JsonNumberArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Baseline.Schema.Linestring.CoordinatesArray2Array.Mutable Coordinates
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CoordinatesUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.Linestring.CoordinatesArray2Array.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Baseline.Schema.Linestring.TypeEntity.Mutable Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.Linestring.TypeEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetBbox(in Corvus.Cql2Benchmark.Baseline.Schema.Linestring.JsonNumberArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetBbox<TContext>(in Corvus.Cql2Benchmark.Baseline.Schema.Linestring.JsonNumberArray.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCoordinates(in Corvus.Cql2Benchmark.Baseline.Schema.Linestring.CoordinatesArray2Array.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCoordinates<TContext>(in Corvus.Cql2Benchmark.Baseline.Schema.Linestring.CoordinatesArray2Array.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(in Corvus.Cql2Benchmark.Baseline.Schema.Linestring.TypeEntity.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Cql2Benchmark.Baseline.Schema.Linestring.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Baseline.Schema.Linestring.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.Cql2Benchmark.Baseline.Schema.Linestring.CoordinatesArray2Array.Source coordinates,
                in Corvus.Cql2Benchmark.Baseline.Schema.Linestring.TypeEntity.Source type,
                in Corvus.Cql2Benchmark.Baseline.Schema.Linestring.JsonNumberArray.Source bbox = default)
            {
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.Cql2Benchmark.Baseline.Schema.Linestring.CoordinatesArray2Array.Source<TContext> coordinates,
                in Corvus.Cql2Benchmark.Baseline.Schema.Linestring.TypeEntity.Source type,
                in Corvus.Cql2Benchmark.Baseline.Schema.Linestring.JsonNumberArray.Source<TContext> bbox = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Cql2Benchmark.Baseline.Schema.Linestring.CoordinatesArray2Array.Source coordinates, in Corvus.Cql2Benchmark.Baseline.Schema.Linestring.TypeEntity.Source type, in Corvus.Cql2Benchmark.Baseline.Schema.Linestring.JsonNumberArray.Source bbox = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Cql2Benchmark.Baseline.Schema.Linestring.CoordinatesArray2Array.Source<TContext> coordinates, in Corvus.Cql2Benchmark.Baseline.Schema.Linestring.TypeEntity.Source type, in Corvus.Cql2Benchmark.Baseline.Schema.Linestring.JsonNumberArray.Source<TContext> bbox = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
