        ...
        public readonly partial struct CoordinatesArray2Array
        {
...
#endif
            {
                ...
                public bool TryGetNumericValues(Span<double> items, out int written)
                {
                    CheckValidInstance();
                    written = 0;
                    foreach (Corvus.Cql2Benchmark.Baseline.Schema.Multilinestring.CoordinatesArray2Array.ItemsArrayArray.JsonNumberArray item in EnumerateArray())
                    {
                ...
                public Corvus.Cql2Benchmark.Baseline.Schema.Multilinestring.CoordinatesArray2Array.ItemsArrayArray.JsonNumberArray this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Baseline.Schema.Multilinestring.CoordinatesArray2Array.ItemsArrayArray.JsonNumberArray>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.Cql2Benchmark.Baseline.Schema.Multilinestring.CoordinatesArray2Array.ItemsArrayArray.JsonNumberArray> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Baseline.Schema.Multilinestring.CoordinatesArray2Array.ItemsArrayArray.JsonNumberArray>(_parent, _idx);
                }
