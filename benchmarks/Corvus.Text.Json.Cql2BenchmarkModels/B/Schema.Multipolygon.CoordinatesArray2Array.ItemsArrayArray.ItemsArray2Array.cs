            ...
            public readonly partial struct ItemsArrayArray
            {
...
#endif
                {
                    ...
                    public bool TryGetNumericValues(Span<double> items, out int written)
                    {
                        CheckValidInstance();
                        written = 0;
                        foreach (Corvus.Cql2Benchmark.Baseline.Schema.Multipolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray item in EnumerateArray())
                        {
                    ...
                    public Corvus.Cql2Benchmark.Baseline.Schema.Multipolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Baseline.Schema.Multipolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.Cql2Benchmark.Baseline.Schema.Multipolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Baseline.Schema.Multipolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray>(_parent, _idx);
                    }
