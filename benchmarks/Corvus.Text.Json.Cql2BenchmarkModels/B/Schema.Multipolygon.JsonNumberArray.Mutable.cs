    ...
    public readonly partial struct Multipolygon
    {
        ...
        public readonly partial struct JsonNumberArray
        {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Cql2Benchmark.Baseline.Schema.Multipolygon.JsonNumberArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Baseline.Schema.Multipolygon.JsonNumberArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
