...
public readonly partial struct Schema
{
    ...
    public readonly partial struct NotExpression
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(NotExpression instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="NotExpression"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NotExpression(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Baseline.Schema.NotExpression.SchemaArray.Mutable Args
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ArgsUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.NotExpression.SchemaArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Baseline.Schema.NotExpression.OpEntity.Mutable Op
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OpUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.NotExpression.OpEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new NotExpression(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetArgs(in Corvus.Cql2Benchmark.Baseline.Schema.NotExpression.SchemaArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetArgs<TContext>(in Corvus.Cql2Benchmark.Baseline.Schema.NotExpression.SchemaArray.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetOp(in Corvus.Cql2Benchmark.Baseline.Schema.NotExpression.OpEntity.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"NotExpression.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="NotExpression"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="NotExpression"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly NotExpression Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<NotExpression>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="NotExpression"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly NotExpression Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<NotExpression>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Cql2Benchmark.Baseline.Schema.NotExpression.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(NotExpression instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Baseline.Schema.NotExpression.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="NotExpression"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Cql2Benchmark.Baseline.Schema.NotExpression.SchemaArray.Source args,
                in Corvus.Cql2Benchmark.Baseline.Schema.NotExpression.OpEntity.Source op)
            {
            ...
            /// Creates an instance of a <see cref="NotExpression"/>.
            /// </summary>
            public void Create(in Corvus.Cql2Benchmark.Baseline.Schema.NotExpression.SchemaArray.Source args, in Corvus.Cql2Benchmark.Baseline.Schema.NotExpression.OpEntity.Source op)
            {
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.Cql2Benchmark.Baseline.Schema.NotExpression.SchemaArray.Source<TContext> args,
                in Corvus.Cql2Benchmark.Baseline.Schema.NotExpression.OpEntity.Source op)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Cql2Benchmark.Baseline.Schema.NotExpression.SchemaArray.Source args, in Corvus.Cql2Benchmark.Baseline.Schema.NotExpression.OpEntity.Source op, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Cql2Benchmark.Baseline.Schema.NotExpression.SchemaArray.Source<TContext> args, in Corvus.Cql2Benchmark.Baseline.Schema.NotExpression.OpEntity.Source op, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        {
            return workspace.CreateBuilder<NotExpression, Mutable>(this);
        }
    }
}
