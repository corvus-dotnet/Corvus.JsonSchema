...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NotExpression"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal NotExpression(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static NotExpression DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Baseline.Schema.NotExpression.SchemaArray Args
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ArgsUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.NotExpression.SchemaArray value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Baseline.Schema.NotExpression.OpEntity Op
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OpUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.NotExpression.OpEntity value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in NotExpression left, in NotExpression right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in NotExpression left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(NotExpression instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NotExpression(JsonElement instance)
        {
            return NotExpression.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NotExpression From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NotExpression ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<NotExpression>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NotExpression ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<NotExpression>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NotExpression ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<NotExpression>(json, options);
        }
        ...
        /// </exception>
        public static NotExpression ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<NotExpression>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out NotExpression? result)
        {
            return JsonElementHelpers.TryParseValue<NotExpression>(ref reader, out result);
        }
...
#if NET
        static NotExpression IJsonElement<NotExpression>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NotExpression: ValueKind = {ValueKind} : \"{ToString()}\"";
