...
public readonly partial struct Schema
{
    ...
    public readonly partial struct NumericExpression
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(NumericExpression instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="NumericExpression"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NumericExpression(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"NumericExpression.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Cql2Benchmark.Baseline.Schema.NumericExpression.Mutable, TContext, TResult> defaultMatch)
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Cql2Benchmark.Baseline.Schema.NumericExpression.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticExpression.JsonSchema.Evaluate(_parent, _idx))
                {
        ...
        {
            return workspace.CreateBuilder<NumericExpression, Mutable>(this);
        }
    }
}
