...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public static explicit operator Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticExpression(NumericExpression value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator NumericExpression(Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticExpression value)
        {
            return From(value);
        }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Cql2Benchmark.Baseline.Schema.NumericExpression, TContext, TResult> defaultMatch)
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Cql2Benchmark.Baseline.Schema.NumericExpression, TResult> defaultMatch)
        {
            if (Corvus.Cql2Benchmark.Baseline.Schema.ArithmeticExpression.JsonSchema.Evaluate(_parent, _idx))
            {
