    ...
    public readonly partial struct PatternExpression
    {
        ...
        public readonly partial struct PatternExpressionRequiredArgsAndOp
        {
            ...
            public readonly partial struct PatternExpressionArray
                ...
                : IJsonElement<PatternExpressionArray>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="PatternExpressionArray"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal PatternExpressionArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static PatternExpressionArray DefaultInstance { get; }
                ...
                /// </remarks>
                public static int ValueBufferSize => 1;
                ...
                public Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression>(_parent, _idx);
                }
                ...
                /// </returns>
                public static bool operator ==(in PatternExpressionArray left, in PatternExpressionArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in PatternExpressionArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(PatternExpressionArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PatternExpressionArray(JsonElement instance)
                {
                    return PatternExpressionArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static PatternExpressionArray From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static PatternExpressionArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<PatternExpressionArray>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static PatternExpressionArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<PatternExpressionArray>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static PatternExpressionArray ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<PatternExpressionArray>(json, options);
                }
                ...
                /// </exception>
                public static PatternExpressionArray ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<PatternExpressionArray>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out PatternExpressionArray? result)
                {
                    return JsonElementHelpers.TryParseValue<PatternExpressionArray>(ref reader, out result);
                }
...
#if NET
                static PatternExpressionArray IJsonElement<PatternExpressionArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PatternExpressionArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public PatternExpressionArray Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public PatternExpressionArray Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<PatternExpressionArray>(_idx);
                    }
