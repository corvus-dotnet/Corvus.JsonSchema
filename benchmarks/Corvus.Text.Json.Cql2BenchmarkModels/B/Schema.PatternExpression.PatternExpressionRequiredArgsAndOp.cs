...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PatternExpression
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.PatternExpressionArray Args
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ArgsUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.PatternExpressionArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.OpEntity Op
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OpUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.OpEntity value))
                    {
                        return value;
                    }
