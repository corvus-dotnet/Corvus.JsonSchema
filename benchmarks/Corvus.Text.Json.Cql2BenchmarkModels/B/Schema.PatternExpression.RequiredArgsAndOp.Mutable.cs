    ...
    public readonly partial struct PatternExpression
    {
        ...
        public readonly partial struct RequiredArgsAndOp
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequiredArgsAndOp instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequiredArgsAndOp"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredArgsAndOp(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.RequiredArgsAndOp.PatternExpressionArray.Mutable Args
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ArgsUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.RequiredArgsAndOp.PatternExpressionArray.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.RequiredArgsAndOp.OpEntity.Mutable Op
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OpUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.RequiredArgsAndOp.OpEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetArgs(in Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.RequiredArgsAndOp.PatternExpressionArray.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetArgs<TContext>(in Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.RequiredArgsAndOp.PatternExpressionArray.Source<TContext> value)
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetOp(in Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.RequiredArgsAndOp.OpEntity.Source value)
                {
                    CheckValidInstance();
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredArgsAndOp.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredArgsAndOp Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredArgsAndOp Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequiredArgsAndOp>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.RequiredArgsAndOp.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(RequiredArgsAndOp instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.RequiredArgsAndOp.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="RequiredArgsAndOp"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.RequiredArgsAndOp.PatternExpressionArray.Source args,
                    in Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.RequiredArgsAndOp.OpEntity.Source op)
                {
                ...
                /// Creates an instance of a <see cref="RequiredArgsAndOp"/>.
                /// </summary>
                public void Create(in Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.RequiredArgsAndOp.PatternExpressionArray.Source args, in Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.RequiredArgsAndOp.OpEntity.Source op)
                {
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.RequiredArgsAndOp.PatternExpressionArray.Source<TContext> args,
                    in Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.RequiredArgsAndOp.OpEntity.Source op)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.RequiredArgsAndOp.PatternExpressionArray.Source args, in Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.RequiredArgsAndOp.OpEntity.Source op, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            {
                return workspace.CreateBuilder<RequiredArgsAndOp, Mutable>(this);
            }
        }
    }
}
