...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        internal Point(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Point DefaultInstance { get; }
        ...
        /// </summary>
        public Corvus.Cql2Benchmark.Baseline.Schema.Point.JsonNumberArray Bbox
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BboxUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.Point.JsonNumberArray value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Baseline.Schema.Point.CoordinateArray Coordinates
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CoordinatesUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.Point.CoordinateArray value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Baseline.Schema.Point.TypeEntity Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.Point.TypeEntity value))
                {
                    return value;
                }
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Point left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Point instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Point(JsonElement instance)
        {
            return Point.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Point From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Point ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Point>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Point ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Point>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Point ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Point>(json, options);
        }
        ...
        /// </exception>
        public static Point ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Point>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Point? result)
        {
            return JsonElementHelpers.TryParseValue<Point>(ref reader, out result);
        }
...
#if NET
        static Point IJsonElement<Point>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Point: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public Point Freeze()
        {
            ...
            {
                return mutable.FreezeElement<Point>(_idx);
            }
