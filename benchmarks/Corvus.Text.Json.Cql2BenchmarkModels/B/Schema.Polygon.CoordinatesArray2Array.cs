    ...
    public readonly partial struct Polygon
    {
...
#endif
        {
            ...
            public bool TryGetNumericValues(Span<double> items, out int written)
            {
                CheckValidInstance();
                written = 0;
                foreach (Corvus.Cql2Benchmark.Baseline.Schema.Polygon.CoordinatesArray2Array.ItemsArrayArray item in EnumerateArray())
                {
            ...
            public Corvus.Cql2Benchmark.Baseline.Schema.Polygon.CoordinatesArray2Array.ItemsArrayArray this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Baseline.Schema.Polygon.CoordinatesArray2Array.ItemsArrayArray>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Cql2Benchmark.Baseline.Schema.Polygon.CoordinatesArray2Array.ItemsArrayArray> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Baseline.Schema.Polygon.CoordinatesArray2Array.ItemsArrayArray>(_parent, _idx);
            }
