...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PropertyRef
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PropertyRef instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PropertyRef"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PropertyRef(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Baseline.JsonString.Mutable Property
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PropertyUtf8, out Corvus.Cql2Benchmark.Baseline.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Set the <c>property</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetProperty(in Corvus.Cql2Benchmark.Baseline.JsonString.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("property");
                }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PropertyRef.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly PropertyRef Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly PropertyRef Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PropertyRef>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Cql2Benchmark.Baseline.Schema.PropertyRef.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(PropertyRef instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Baseline.Schema.PropertyRef.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="PropertyRef"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.Cql2Benchmark.Baseline.JsonString.Source property)
            {
                property.AddAsProperty(JsonPropertyNamesEscaped.Property, ref builder, escapeName: false);
            }

            /// <summary>
            /// Creates an instance of a <see cref="PropertyRef"/>.
            /// </summary>
            public void Create(in Corvus.Cql2Benchmark.Baseline.JsonString.Source property)
            {
                Create(ref _builder, property);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Cql2Benchmark.Baseline.JsonString.Source property, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        {
            return workspace.CreateBuilder<PropertyRef, Mutable>(this);
        }
    }
}
