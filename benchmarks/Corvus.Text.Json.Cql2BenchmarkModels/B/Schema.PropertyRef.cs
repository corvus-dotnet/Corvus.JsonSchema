...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PropertyRef
#if NET8_0_OR_GREATER
        : IJsonElement<PropertyRef>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertyRef"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal PropertyRef(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static PropertyRef DefaultInstance { get; }
        ...
        /// <summary>
        /// Gets the <c>property</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Baseline.JsonString Property
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PropertyUtf8, out Corvus.Cql2Benchmark.Baseline.JsonString value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in PropertyRef left, in PropertyRef right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in PropertyRef left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(PropertyRef instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PropertyRef(JsonElement instance)
        {
            return PropertyRef.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PropertyRef From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PropertyRef ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PropertyRef>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PropertyRef ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PropertyRef>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PropertyRef ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PropertyRef>(json, options);
        }
        ...
        /// </exception>
        public static PropertyRef ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<PropertyRef>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out PropertyRef? result)
        {
            return JsonElementHelpers.TryParseValue<PropertyRef>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PropertyRef(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static PropertyRef IJsonElement<PropertyRef>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PropertyRef: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PropertyRef"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PropertyRef"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public PropertyRef Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PropertyRef>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PropertyRef"/> that lives for the lifetime of its
        ...
        public static class JsonPropertyNames
        {
            ...
            /// Gets the JSON property name for <see cref="Property"/>.
            /// </summary>
            public static ReadOnlySpan<byte> PropertyUtf8 => "property"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Property"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Property => "property"u8;
        }
    }
}
