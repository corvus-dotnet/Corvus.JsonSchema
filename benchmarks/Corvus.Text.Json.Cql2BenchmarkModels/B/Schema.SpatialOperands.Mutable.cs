...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SpatialOperands
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(SpatialOperands instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SpatialOperands"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SpatialOperands(Mutable instance)
            {
            ...
            public Corvus.Cql2Benchmark.Baseline.Schema.SpatialOperands.SpatialOperandsEntity.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Baseline.Schema.SpatialOperands.SpatialOperandsEntity.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Cql2Benchmark.Baseline.Schema.SpatialOperands.SpatialOperandsEntity.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Baseline.Schema.SpatialOperands.SpatialOperandsEntity.Mutable>(_parent, _idx);
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SpatialOperands.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.Cql2Benchmark.Baseline.Schema.SpatialOperands.SpatialOperandsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.Cql2Benchmark.Baseline.Schema.SpatialOperands.SpatialOperandsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.Cql2Benchmark.Baseline.Schema.SpatialOperands.SpatialOperandsEntity.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.Cql2Benchmark.Baseline.Schema.SpatialOperands.SpatialOperandsEntity item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Cql2Benchmark.Baseline.Schema.SpatialOperands.SpatialOperandsEntity>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.Cql2Benchmark.Baseline.Schema.SpatialOperands.SpatialOperandsEntity> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Cql2Benchmark.Baseline.Schema.SpatialOperands.SpatialOperandsEntity>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.Cql2Benchmark.Baseline.Schema.SpatialOperands.SpatialOperandsEntity oldItem, in Corvus.Cql2Benchmark.Baseline.Schema.SpatialOperands.SpatialOperandsEntity.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Baseline.Schema.SpatialOperands.SpatialOperandsEntity>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.Cql2Benchmark.Baseline.Schema.SpatialOperands.SpatialOperandsEntity current = enumerator.Current;
            ...
            /// </para>
            /// </remarks>
            public readonly SpatialOperands Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly SpatialOperands Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SpatialOperands>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Cql2Benchmark.Baseline.Schema.SpatialOperands.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(SpatialOperands instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Baseline.Schema.SpatialOperands.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<SpatialOperands, Mutable>(this);
        }
    }
}
