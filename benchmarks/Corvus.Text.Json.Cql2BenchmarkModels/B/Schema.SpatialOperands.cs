...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SpatialOperands"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal SpatialOperands(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static SpatialOperands DefaultInstance { get; }
        ...
        public Corvus.Cql2Benchmark.Baseline.Schema.SpatialOperands.SpatialOperandsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Baseline.Schema.SpatialOperands.SpatialOperandsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Cql2Benchmark.Baseline.Schema.SpatialOperands.SpatialOperandsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Baseline.Schema.SpatialOperands.SpatialOperandsEntity>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in SpatialOperands left, in SpatialOperands right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SpatialOperands left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(SpatialOperands instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SpatialOperands(JsonElement instance)
        {
            return SpatialOperands.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SpatialOperands From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SpatialOperands ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SpatialOperands>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SpatialOperands ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SpatialOperands>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SpatialOperands ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SpatialOperands>(json, options);
        }
        ...
        /// </exception>
        public static SpatialOperands ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<SpatialOperands>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SpatialOperands? result)
        {
            return JsonElementHelpers.TryParseValue<SpatialOperands>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new SpatialOperands(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static SpatialOperands IJsonElement<SpatialOperands>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SpatialOperands: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="SpatialOperands"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="SpatialOperands"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public SpatialOperands Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<SpatialOperands>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="SpatialOperands"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public SpatialOperands Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<SpatialOperands>(_idx);
            }
