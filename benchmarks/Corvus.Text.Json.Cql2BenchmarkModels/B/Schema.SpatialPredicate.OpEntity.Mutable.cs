    ...
    public readonly partial struct SpatialPredicate
    {
        ...
        public readonly partial struct OpEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(OpEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OpEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OpEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OpEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="OpEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="OpEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly OpEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<OpEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="OpEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly OpEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OpEntity>(_idx);
                }
                ...
                /// <param name="matchSContains">Match 1st item.</param>
                /// <param name="matchSCrosses">Match 2nd item.</param>
                /// <param name="matchSDisjoint">Match 3rd item.</param>
                /// <param name="matchSEquals">Match 4th item.</param>
                /// <param name="matchSIntersects">Match 5th item.</param>
                /// <param name="matchSOverlaps">Match 6th item.</param>
                /// <param name="matchSTouches">Match 7th item.</param>
                /// <param name="matchSWithin">Match 8th item.</param>
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(OpEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<OpEntity, Mutable>(this);
            }
        }
    }
}
