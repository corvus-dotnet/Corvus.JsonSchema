...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TimestampInstant
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Baseline.Schema.TimestampString.Mutable Timestamp
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TimestampUtf8, out Corvus.Cql2Benchmark.Baseline.Schema.TimestampString.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetTimestamp(in Corvus.Cql2Benchmark.Baseline.Schema.TimestampString.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Cql2Benchmark.Baseline.Schema.TimestampInstant.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Baseline.Schema.TimestampInstant.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.Cql2Benchmark.Baseline.Schema.TimestampString.Source timestamp)
            {
            ...
            /// Creates an instance of a <see cref="TimestampInstant"/>.
            /// </summary>
            public void Create(in Corvus.Cql2Benchmark.Baseline.Schema.TimestampString.Source timestamp)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Cql2Benchmark.Baseline.Schema.TimestampString.Source timestamp, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
