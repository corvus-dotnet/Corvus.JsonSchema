...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct AndOrExpression
    {
        ...
        public readonly partial struct Cql2SchemaArray
#if NET8_0_OR_GREATER
            : IJsonElement<Cql2SchemaArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="Cql2SchemaArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal Cql2SchemaArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Cql2SchemaArray DefaultInstance { get; }
            ...
            public Corvus.Cql2Benchmark.Current.Cql2Schema this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Current.Cql2Schema>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in Cql2SchemaArray left, in Cql2SchemaArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Cql2SchemaArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(Cql2SchemaArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Cql2SchemaArray(JsonElement instance)
            {
                return Cql2SchemaArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Cql2SchemaArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Cql2SchemaArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Cql2SchemaArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Cql2SchemaArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Cql2SchemaArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Cql2SchemaArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Cql2SchemaArray>(json, options);
            }
            ...
            /// </exception>
            public static Cql2SchemaArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Cql2SchemaArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Cql2SchemaArray? result)
            {
                return JsonElementHelpers.TryParseValue<Cql2SchemaArray>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Cql2SchemaArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static Cql2SchemaArray IJsonElement<Cql2SchemaArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Cql2SchemaArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Cql2SchemaArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Cql2SchemaArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Cql2SchemaArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Cql2SchemaArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Cql2SchemaArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public Cql2SchemaArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<Cql2SchemaArray>(_idx);
                }
