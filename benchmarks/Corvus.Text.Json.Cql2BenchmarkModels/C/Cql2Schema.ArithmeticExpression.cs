...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct ArithmeticExpression
#if NET8_0_OR_GREATER
        : IJsonElement<ArithmeticExpression>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ArithmeticExpression"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ArithmeticExpression(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ArithmeticExpression DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Current.Cql2Schema.ArithmeticOperands Args
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ArgsUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.ArithmeticOperands value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Current.Cql2Schema.ArithmeticExpression.OpEntity Op
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OpUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.ArithmeticExpression.OpEntity value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in ArithmeticExpression left, in ArithmeticExpression right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ArithmeticExpression left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ArithmeticExpression instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ArithmeticExpression(JsonElement instance)
        {
            return ArithmeticExpression.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ArithmeticExpression From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ArithmeticExpression ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ArithmeticExpression>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ArithmeticExpression ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ArithmeticExpression>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ArithmeticExpression ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ArithmeticExpression>(json, options);
        }
        ...
        /// </exception>
        public static ArithmeticExpression ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ArithmeticExpression>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ArithmeticExpression? result)
        {
            return JsonElementHelpers.TryParseValue<ArithmeticExpression>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ArithmeticExpression(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ArithmeticExpression IJsonElement<ArithmeticExpression>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ArithmeticExpression: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ArithmeticExpression"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ArithmeticExpression"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<ArithmeticExpression>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ArithmeticExpression"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ArithmeticExpression Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ArithmeticExpression>(_idx);
            }
        ...
        private static class JsonPropertyNamesEscaped
        {
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Op"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Op => "op"u8;
        }
        ...
        private static class JsonPropertyNamesPrebaked
        {
            ...
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Op"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Op => [0x45, 0x00, 0x00, 0x00, 0x22, 0x6F, 0x70, 0x22];
        }
    }
}
