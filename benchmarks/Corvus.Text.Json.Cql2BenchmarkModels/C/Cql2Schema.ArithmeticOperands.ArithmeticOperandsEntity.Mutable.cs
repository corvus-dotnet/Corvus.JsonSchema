    ...
    public readonly partial struct ArithmeticOperands
    {
        ...
        public readonly partial struct ArithmeticOperandsEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public void Apply(in Corvus.Cql2Benchmark.Current.Cql2Schema.ArithmeticExpression value)
                {
                    CheckValidInstance();
                ...
                /// <summary>
                /// Gets a <see cref="ArithmeticOperandsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ArithmeticOperandsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ArithmeticOperandsEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ArithmeticOperandsEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ArithmeticOperandsEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ArithmeticOperandsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ArithmeticOperandsEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.ArithmeticOperands.ArithmeticOperandsEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    {
                        return matchArithmeticExpression(Corvus.Cql2Benchmark.Current.Cql2Schema.ArithmeticExpression.Mutable.From(this), context);
                    }
                    ...
                    {
                        return matchJsonNumber(Corvus.Cql2Benchmark.Current.JsonNumber.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.ArithmeticOperands.ArithmeticOperandsEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Cql2Benchmark.Current.Cql2Schema.ArithmeticExpression.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchArithmeticExpression(Corvus.Cql2Benchmark.Current.Cql2Schema.ArithmeticExpression.Mutable.From(this));
                    }
                    ...
                    if (Corvus.Cql2Benchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonNumber(Corvus.Cql2Benchmark.Current.JsonNumber.Mutable.From(this));
                    }
                ...
                public bool TryGetAsArithmeticExpression(out Corvus.Cql2Benchmark.Current.Cql2Schema.ArithmeticExpression.Mutable result)
                {
                    if (Corvus.Cql2Benchmark.Current.Cql2Schema.ArithmeticExpression.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Cql2Benchmark.Current.Cql2Schema.ArithmeticExpression.Mutable.From(this);
                        return true;
                    }
                ...
                public bool TryGetAsJsonNumber(out Corvus.Cql2Benchmark.Current.JsonNumber.Mutable result)
                {
                    if (Corvus.Cql2Benchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Cql2Benchmark.Current.JsonNumber.Mutable.From(this);
                        return true;
                    }
            ...
            public static ParsedJsonDocument<ArithmeticOperandsEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ArithmeticOperandsEntity>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ArithmeticOperandsEntity> Create<TContext>(
