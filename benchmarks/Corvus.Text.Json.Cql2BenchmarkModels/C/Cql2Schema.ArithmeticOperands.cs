...
public readonly partial struct Cql2Schema
{
...
#endif
    {
        ...
        public Corvus.Cql2Benchmark.Current.Cql2Schema.ArithmeticOperands.ArithmeticOperandsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Current.Cql2Schema.ArithmeticOperands.ArithmeticOperandsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema.ArithmeticOperands.ArithmeticOperandsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema.ArithmeticOperands.ArithmeticOperandsEntity>(_parent, _idx);
        }
