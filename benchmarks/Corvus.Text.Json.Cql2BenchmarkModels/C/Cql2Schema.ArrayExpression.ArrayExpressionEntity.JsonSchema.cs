    ...
    public readonly partial struct ArrayExpression
    {
            ...
            : IJsonElement<ArrayExpressionEntity>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("cql2-schema.json#/$defs/arrayExpression/items"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "cql2-schema.json#/$defs/arrayExpression/items";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "cql2-schema.json#/$defs/arrayExpression/items"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    JsonSchemaContext oneOfContext2 =
                        Corvus.Cql2Benchmark.Current.Cql2Schema.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf2SchemaEvaluationPath);
                    Corvus.Cql2Benchmark.Current.Cql2Schema.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext2);
                    ...
                    JsonSchemaContext oneOfContext3 =
                        Corvus.Cql2Benchmark.Current.Cql2Schema.SpatialInstance.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf3SchemaEvaluationPath);
                    Corvus.Cql2Benchmark.Current.Cql2Schema.SpatialInstance.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext3);
                    ...
                    JsonSchemaContext oneOfContext4 =
                        Corvus.Cql2Benchmark.Current.Cql2Schema.TemporalInstance.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf4SchemaEvaluationPath);
                    Corvus.Cql2Benchmark.Current.Cql2Schema.TemporalInstance.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext4);
                    ...
                    JsonSchemaContext oneOfContext5 =
                        Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf5SchemaEvaluationPath);
                    Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext5);
                    ...
                    JsonSchemaContext oneOfContext6 =
                        Corvus.Cql2Benchmark.Current.Cql2Schema.PropertyRef.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf6SchemaEvaluationPath);
                    Corvus.Cql2Benchmark.Current.Cql2Schema.PropertyRef.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext6);
