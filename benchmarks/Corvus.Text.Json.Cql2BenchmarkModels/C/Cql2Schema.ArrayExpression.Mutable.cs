...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct ArrayExpression
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ArrayExpression instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ArrayExpression"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ArrayExpression(Mutable instance)
            {
            ...
            public Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.ArrayExpressionEntity.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.ArrayExpressionEntity.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.ArrayExpressionEntity.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.ArrayExpressionEntity.Mutable>(_parent, _idx);
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ArrayExpression.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.ArrayExpressionEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.ArrayExpressionEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.ArrayExpressionEntity.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.ArrayExpressionEntity item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.ArrayExpressionEntity>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.ArrayExpressionEntity> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.ArrayExpressionEntity>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.ArrayExpressionEntity oldItem, in Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.ArrayExpressionEntity.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.ArrayExpressionEntity>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.ArrayExpressionEntity current = enumerator.Current;
            ...
            /// </para>
            /// </remarks>
            public readonly ArrayExpression Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ArrayExpression Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ArrayExpression>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(ArrayExpression instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            public void AddItem(in Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.ArrayExpressionEntity.Source value)
            {
            ...
            /// Add an item to the array.
            /// </summary>
            public void AddItem<TContext>(in Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.ArrayExpressionEntity.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        {
            return workspace.CreateBuilder<ArrayExpression, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ArrayExpression> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ArrayExpression>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ArrayExpression> Create<TContext>(
