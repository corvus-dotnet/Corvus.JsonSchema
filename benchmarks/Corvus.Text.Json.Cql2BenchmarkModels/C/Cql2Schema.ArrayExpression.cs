...
public readonly partial struct Cql2Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ArrayExpression"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ArrayExpression(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ArrayExpression DefaultInstance { get; }
        ...
        public Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.ArrayExpressionEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.ArrayExpressionEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.ArrayExpressionEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.ArrayExpressionEntity>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in ArrayExpression left, in ArrayExpression right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ArrayExpression left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ArrayExpression instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ArrayExpression(JsonElement instance)
        {
            return ArrayExpression.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ArrayExpression From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ArrayExpression ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ArrayExpression>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ArrayExpression ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ArrayExpression>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ArrayExpression ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ArrayExpression>(json, options);
        }
        ...
        /// </exception>
        public static ArrayExpression ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ArrayExpression>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ArrayExpression? result)
        {
            return JsonElementHelpers.TryParseValue<ArrayExpression>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ArrayExpression(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ArrayExpression IJsonElement<ArrayExpression>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ArrayExpression: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ArrayExpression"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ArrayExpression"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<ArrayExpression>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ArrayExpression"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ArrayExpression Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ArrayExpression>(_idx);
            }
