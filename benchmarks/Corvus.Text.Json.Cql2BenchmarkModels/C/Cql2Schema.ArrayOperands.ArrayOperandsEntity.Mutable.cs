    ...
    public readonly partial struct ArrayOperands
    {
        ...
        public readonly partial struct ArrayOperandsEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ArrayOperandsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ArrayOperandsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ArrayOperandsEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ArrayOperandsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ArrayOperandsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// <summary>
                /// Gets a <see cref="ArrayOperandsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ArrayOperandsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ArrayOperandsEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ArrayOperandsEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ArrayOperandsEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ArrayOperandsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ArrayOperandsEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayOperands.ArrayOperandsEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayOperands.ArrayOperandsEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayExpression.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayOperands.ArrayOperandsEntity.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }
                ...
                public static implicit operator Source(ArrayOperandsEntity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Current.Cql2Schema.ArrayOperands.ArrayOperandsEntity.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }
            ...
            {
                return workspace.CreateBuilder<ArrayOperandsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ArrayOperandsEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ArrayOperandsEntity>();
                }
                finally
                {
            ...
            public static ParsedJsonDocument<ArrayOperandsEntity> CreateArray(
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>An empty <see cref="ParsedJsonDocument{T}"/>. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ArrayOperandsEntity> CreateObject(
                int initialCapacity = 30, int initialValueBufferSize = 8192)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
                try
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ArrayOperandsEntity> Create<TContext>(
