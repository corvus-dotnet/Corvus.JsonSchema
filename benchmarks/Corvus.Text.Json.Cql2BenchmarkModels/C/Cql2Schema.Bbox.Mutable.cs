...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct Bbox
    {
...
#endif
        {
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf0Entity" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsOneOf0Entity(out Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf0Entity result)
            {
                if (Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                {
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf1Entity" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsOneOf1Entity(out Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf1Entity result)
            {
                if (Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
