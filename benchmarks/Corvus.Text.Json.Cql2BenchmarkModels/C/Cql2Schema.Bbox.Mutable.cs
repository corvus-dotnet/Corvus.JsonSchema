...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct Bbox
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf0Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf0Entity.Mutable(Mutable value)
            {
                return Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf0Entity.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf0Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf0Entity.Mutable value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf1Entity.Mutable(Mutable value)
            {
                return Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf1Entity.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf1Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf1Entity.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(Bbox instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Bbox"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Bbox(Mutable instance)
            {
            ...
            public Corvus.Cql2Benchmark.Current.JsonNumber.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Current.JsonNumber.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Cql2Benchmark.Current.JsonNumber.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Current.JsonNumber.Mutable>(_parent, _idx);
            }
            ...
            public bool TryGetNumericValues(Span<double> items, out int written)
            {
                CheckValidInstance();
                written = 0;
                foreach (Corvus.Cql2Benchmark.Current.JsonNumber.Mutable item in EnumerateArray())
                {
                    ...
                    if (!item.TryGetValue(out double value))
                    {
                        return false;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Bbox(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Bbox.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.Cql2Benchmark.Current.JsonNumber.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, scoped in Corvus.Cql2Benchmark.Current.JsonNumber.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(scoped in Corvus.Cql2Benchmark.Current.JsonNumber.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.Cql2Benchmark.Current.JsonNumber item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Cql2Benchmark.Current.JsonNumber>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.Cql2Benchmark.Current.JsonNumber> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Cql2Benchmark.Current.JsonNumber>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.Cql2Benchmark.Current.JsonNumber oldItem, in Corvus.Cql2Benchmark.Current.JsonNumber.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Current.JsonNumber>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.Cql2Benchmark.Current.JsonNumber current = enumerator.Current;
            ...
            /// <summary>
            /// Gets a <see cref="Bbox"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Bbox"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Bbox Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Bbox>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Bbox"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Bbox Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Bbox>(_idx);
            }
            ...
            /// <param name="matchOneOf0Entity">Match a <see cref="Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf0Entity"/>.</param>
            /// <param name="matchOneOf1Entity">Match a <see cref="Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf1Entity"/>.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf0Entity, TContext, TResult> matchOneOf0Entity,
                Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf1Entity, TContext, TResult> matchOneOf1Entity,
                Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                if (Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf0Entity(Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf0Entity.Mutable.From(this), context);
                }

                if (Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf1Entity.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf0Entity, TResult> matchOneOf0Entity,
                Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf1Entity, TResult> matchOneOf1Entity,
                Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf0Entity(Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf0Entity.Mutable.From(this));
                }

                if (Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf1Entity.Mutable.From(this));
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf0Entity.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsOneOf0Entity(out Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf0Entity.Mutable result)
            {
                if (Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf0Entity.Mutable.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf1Entity.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsOneOf1Entity(out Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf1Entity.Mutable result)
            {
                if (Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.OneOf1Entity.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(Bbox instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            public void AddItem(in Corvus.Cql2Benchmark.Current.JsonNumber.Source value)
            {
        ...
        {
            return workspace.CreateBuilder<Bbox, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Bbox> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Bbox>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Bbox> Create<TContext>(
