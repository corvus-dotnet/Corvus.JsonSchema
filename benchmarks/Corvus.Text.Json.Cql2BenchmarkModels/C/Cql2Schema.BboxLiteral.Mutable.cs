...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct BboxLiteral
    {
...
#endif
        {
            ...
            public void SetBboxValue(in Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox.Source value)
            {
                ...
                else
                {
                    ...
                    value.AddAsProperty(JsonPropertyNamesEscaped.BboxValue, ref cvb, escapeName: false, nameRequiresUnescaping: false);
        ...
        public ref struct Builder
        {
            ...
            {
                bbox.AddAsProperty(JsonPropertyNamesEscaped.BboxValue, ref builder, escapeName: false);
            }
