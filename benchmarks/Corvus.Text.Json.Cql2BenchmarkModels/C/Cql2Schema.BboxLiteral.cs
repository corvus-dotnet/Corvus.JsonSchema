...
public readonly partial struct Cql2Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BboxLiteral"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal BboxLiteral(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static BboxLiteral DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox BboxValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BboxValueUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.Bbox value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in BboxLiteral left, in BboxLiteral right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in BboxLiteral left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(BboxLiteral instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BboxLiteral(JsonElement instance)
        {
            return BboxLiteral.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BboxLiteral From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BboxLiteral ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BboxLiteral>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BboxLiteral ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BboxLiteral>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BboxLiteral ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BboxLiteral>(json, options);
        }
        ...
        /// </exception>
        public static BboxLiteral ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<BboxLiteral>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out BboxLiteral? result)
        {
            return JsonElementHelpers.TryParseValue<BboxLiteral>(ref reader, out result);
        }
...
#if NET
        static BboxLiteral IJsonElement<BboxLiteral>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BboxLiteral: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="BboxValue"/>.
            /// </summary>
            public const string BboxValue = "bbox";

            /// <summary>
            /// Gets the JSON property name for <see cref="BboxValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> BboxValueUtf8 => "bbox"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="BboxValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> BboxValue => "bbox"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="BboxValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> BboxValue => [0x65, 0x00, 0x00, 0x00, 0x22, 0x62, 0x62, 0x6F, 0x78, 0x22];
        }
    }
}
