    ...
    public readonly partial struct BinaryComparisonPredicate
    {
        ...
        public readonly partial struct OpEntity
        {
...
#endif
            {
                ...
                /// <param name="matchEquals">Match 1st item.</param>
                /// <param name="match">Match 2nd item.</param>
                /// <param name="matchLt">Match 3rd item.</param>
                /// <param name="matchGt">Match 4th item.</param>
            ...
            public ref struct Source
            {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (OpEntity)value;
            ...
            public static ParsedJsonDocument<OpEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OpEntity>();
                }
                finally
                {
