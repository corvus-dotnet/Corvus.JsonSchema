...
public readonly partial struct Cql2Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BinaryComparisonPredicate"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal BinaryComparisonPredicate(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static BinaryComparisonPredicate DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Current.Cql2Schema.ScalarOperands Args
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ArgsUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.ScalarOperands value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Current.Cql2Schema.BinaryComparisonPredicate.OpEntity Op
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OpUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.BinaryComparisonPredicate.OpEntity value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in BinaryComparisonPredicate left, in BinaryComparisonPredicate right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in BinaryComparisonPredicate left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(BinaryComparisonPredicate instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BinaryComparisonPredicate(JsonElement instance)
        {
            return BinaryComparisonPredicate.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BinaryComparisonPredicate From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BinaryComparisonPredicate ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BinaryComparisonPredicate>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BinaryComparisonPredicate ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BinaryComparisonPredicate>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BinaryComparisonPredicate ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BinaryComparisonPredicate>(json, options);
        }
        ...
        /// </exception>
        public static BinaryComparisonPredicate ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<BinaryComparisonPredicate>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out BinaryComparisonPredicate? result)
        {
            return JsonElementHelpers.TryParseValue<BinaryComparisonPredicate>(ref reader, out result);
        }
...
#if NET
        static BinaryComparisonPredicate IJsonElement<BinaryComparisonPredicate>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BinaryComparisonPredicate: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public BinaryComparisonPredicate Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public BinaryComparisonPredicate Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<BinaryComparisonPredicate>(_idx);
            }
