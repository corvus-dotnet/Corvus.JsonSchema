...
public readonly partial struct Cql2Schema
{
    ...
    /// Generated from JSON Schema.
    /// </summary>
    public readonly partial struct Casei
    {
        /// <summary>
        /// Generated from JSON Schema.
        /// </summary>
        ...
        public readonly partial struct ArgsEntityArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ArgsEntityArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ArgsEntityArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ArgsEntityArray(Mutable instance)
                {
                ...
                public Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.ArgsEntityArray.ArgsEntity.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.ArgsEntityArray.ArgsEntity.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.ArgsEntityArray.ArgsEntity.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.ArgsEntityArray.ArgsEntity.Mutable>(_parent, _idx);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ArgsEntityArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ArgsEntityArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.ArgsEntityArray.ArgsEntity.Source value)
                {
                    CheckValidInstance();
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.ArgsEntityArray.ArgsEntity item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.ArgsEntityArray.ArgsEntity>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.ArgsEntityArray.ArgsEntity> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.ArgsEntityArray.ArgsEntity>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.ArgsEntityArray.ArgsEntity oldItem, in Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.ArgsEntityArray.ArgsEntity.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.ArgsEntityArray.ArgsEntity>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.ArgsEntityArray.ArgsEntity current = enumerator.Current;
                ...
                /// <summary>
                /// Gets a <see cref="ArgsEntityArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ArgsEntityArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ArgsEntityArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ArgsEntityArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ArgsEntityArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ArgsEntityArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ArgsEntityArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.ArgsEntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(ArgsEntityArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.ArgsEntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// Add an item to the array.
                /// </summary>
                public void AddItem<TContext>(in Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.ArgsEntityArray.ArgsEntity.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            {
                return workspace.CreateBuilder<ArgsEntityArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ArgsEntityArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ArgsEntityArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ArgsEntityArray> Create<TContext>(
