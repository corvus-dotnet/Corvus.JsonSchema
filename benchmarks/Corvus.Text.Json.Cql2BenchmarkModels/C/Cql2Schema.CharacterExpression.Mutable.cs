...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct CharacterExpression
    {
...
#endif
        {
            ...
            /// </remarks>
            public void Apply(in Corvus.Cql2Benchmark.Current.Cql2Schema.Casei value)
            {
                CheckValidInstance();
            ...
            /// This will add or update any property values provided by the <paramref name="value"/>.
            /// </remarks>
            public void Apply(in Corvus.Cql2Benchmark.Current.Cql2Schema.Accenti value)
            {
                CheckValidInstance();
            ...
            /// <summary>
            /// Gets a <see cref="CharacterExpression"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="CharacterExpression"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly CharacterExpression Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<CharacterExpression>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="CharacterExpression"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly CharacterExpression Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CharacterExpression>(_idx);
            }
            ...
            /// <param name="matchCasei">Match a <see cref="Corvus.Cql2Benchmark.Current.Cql2Schema.Casei"/>.</param>
            /// <param name="matchAccenti">Match a <see cref="Corvus.Cql2Benchmark.Current.Cql2Schema.Accenti"/>.</param>
            /// <param name="matchJsonString">Match a <see cref="Corvus.Cql2Benchmark.Current.JsonString"/>.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.Casei, TContext, TResult> matchCasei,
                Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.Accenti, TContext, TResult> matchAccenti,
                Matcher<Corvus.Cql2Benchmark.Current.JsonString, TContext, TResult> matchJsonString,
                Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.CharacterExpression.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchCasei(Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.Mutable.From(this), context);
                }

                if (Corvus.Cql2Benchmark.Current.Cql2Schema.Accenti.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchAccenti(Corvus.Cql2Benchmark.Current.Cql2Schema.Accenti.Mutable.From(this), context);
                }

                if (Corvus.Cql2Benchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonString(Corvus.Cql2Benchmark.Current.JsonString.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.Casei, TResult> matchCasei,
                Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.Accenti, TResult> matchAccenti,
                Matcher<Corvus.Cql2Benchmark.Current.JsonString, TResult> matchJsonString,
                Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.CharacterExpression.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchCasei(Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.Mutable.From(this));
                }

                if (Corvus.Cql2Benchmark.Current.Cql2Schema.Accenti.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchAccenti(Corvus.Cql2Benchmark.Current.Cql2Schema.Accenti.Mutable.From(this));
                }

                if (Corvus.Cql2Benchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonString(Corvus.Cql2Benchmark.Current.JsonString.Mutable.From(this));
                }
            ...
            public bool TryGetAsAccenti(out Corvus.Cql2Benchmark.Current.Cql2Schema.Accenti.Mutable result)
            {
                if (Corvus.Cql2Benchmark.Current.Cql2Schema.Accenti.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Cql2Benchmark.Current.Cql2Schema.Accenti.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsCasei(out Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.Mutable result)
            {
                if (Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsJsonString(out Corvus.Cql2Benchmark.Current.JsonString.Mutable result)
            {
                if (Corvus.Cql2Benchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Cql2Benchmark.Current.JsonString.Mutable.From(this);
                    return true;
                }
        ...
        public static ParsedJsonDocument<CharacterExpression> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<CharacterExpression>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<CharacterExpression> Create<TContext>(
