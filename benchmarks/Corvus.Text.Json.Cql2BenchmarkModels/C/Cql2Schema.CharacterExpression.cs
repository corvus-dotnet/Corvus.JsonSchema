...
public readonly partial struct Cql2Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CharacterExpression"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal CharacterExpression(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static CharacterExpression DefaultInstance { get; }
        ...
        public static explicit operator Corvus.Cql2Benchmark.Current.Cql2Schema.Casei(CharacterExpression value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator CharacterExpression(Corvus.Cql2Benchmark.Current.Cql2Schema.Casei value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator CharacterExpression(Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.Mutable value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Cql2Benchmark.Current.Cql2Schema.Accenti(CharacterExpression value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator CharacterExpression(Corvus.Cql2Benchmark.Current.Cql2Schema.Accenti value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator CharacterExpression(Corvus.Cql2Benchmark.Current.Cql2Schema.Accenti.Mutable value)
        {
            return From(value);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(CharacterExpression value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in CharacterExpression left, in CharacterExpression right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in CharacterExpression left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(CharacterExpression instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator CharacterExpression(JsonElement instance)
        {
            return CharacterExpression.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CharacterExpression From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CharacterExpression ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<CharacterExpression>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CharacterExpression ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<CharacterExpression>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CharacterExpression ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<CharacterExpression>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static CharacterExpression ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<CharacterExpression>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out CharacterExpression? result)
        {
            return JsonElementHelpers.TryParseValue<CharacterExpression>(ref reader, out result);
        }
...
#if NET
        static CharacterExpression IJsonElement<CharacterExpression>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"CharacterExpression: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public CharacterExpression Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public CharacterExpression Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<CharacterExpression>(_idx);
            }
        ...
        public bool TryGetAsAccenti(out Corvus.Cql2Benchmark.Current.Cql2Schema.Accenti result)
        {
            ...
            {
                result = Corvus.Cql2Benchmark.Current.Cql2Schema.Accenti.From(this);
                return true;
            }
        ...
        public bool TryGetAsCasei(out Corvus.Cql2Benchmark.Current.Cql2Schema.Casei result)
        {
            ...
            {
                result = Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.From(this);
                return true;
            }
        ...
        public bool TryGetAsJsonString(out Corvus.Cql2Benchmark.Current.JsonString result)
        {
            ...
            {
                result = Corvus.Cql2Benchmark.Current.JsonString.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.CharacterExpression, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchCasei(Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.From(this), context);
            }

            if (Corvus.Cql2Benchmark.Current.Cql2Schema.Accenti.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAccenti(Corvus.Cql2Benchmark.Current.Cql2Schema.Accenti.From(this), context);
            }

            if (Corvus.Cql2Benchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonString(Corvus.Cql2Benchmark.Current.JsonString.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.CharacterExpression, TResult> defaultMatch)
        {
            if (Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchCasei(Corvus.Cql2Benchmark.Current.Cql2Schema.Casei.From(this));
            }

            if (Corvus.Cql2Benchmark.Current.Cql2Schema.Accenti.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAccenti(Corvus.Cql2Benchmark.Current.Cql2Schema.Accenti.From(this));
            }

            if (Corvus.Cql2Benchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonString(Corvus.Cql2Benchmark.Current.JsonString.From(this));
            }
