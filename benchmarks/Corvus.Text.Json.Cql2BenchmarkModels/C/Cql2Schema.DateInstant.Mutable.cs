...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct DateInstant
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DateInstant instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DateInstant"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DateInstant(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Current.Cql2Schema.DateString.Mutable Date
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DateUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.DateString.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DateInstant(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetDate(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.DateString.Source value)
            {
                ...
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("date");
                }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DateInstant.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DateInstant"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DateInstant"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly DateInstant Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DateInstant>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DateInstant"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly DateInstant Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DateInstant>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.DateString.Source _createArg1;
            ...
            public static implicit operator Source(DateInstant instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Current.Cql2Schema.DateInstant.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="DateInstant"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.Cql2Benchmark.Current.Cql2Schema.DateString.Source date)
            {
            ...
            /// Creates an instance of a <see cref="DateInstant"/>.
            /// </summary>
            public void Create(in Corvus.Cql2Benchmark.Current.Cql2Schema.DateString.Source date)
            {
                Create(ref _builder, date);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Cql2Benchmark.Current.Cql2Schema.DateString.Source date, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        {
            return workspace.CreateBuilder<DateInstant, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<DateInstant> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DateInstant>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<DateInstant> Create<TContext>(
        ...
        public static ParsedJsonDocument<DateInstant> Create(in Corvus.Cql2Benchmark.Current.Cql2Schema.DateString.Source date, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
