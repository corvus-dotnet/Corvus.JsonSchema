...
public readonly partial struct Cql2Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Current.Cql2Schema.DateString Date
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DateUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.DateString value))
                {
                    return value;
                }
