...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct FunctionRef
    {
...
#endif
        {
            ...
            public Corvus.Cql2Benchmark.Current.Cql2Schema.FunctionRef.ArgsEntityArray.ArgsEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Current.Cql2Schema.FunctionRef.ArgsEntityArray.ArgsEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema.FunctionRef.ArgsEntityArray.ArgsEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema.FunctionRef.ArgsEntityArray.ArgsEntity>(_parent, _idx);
            }
