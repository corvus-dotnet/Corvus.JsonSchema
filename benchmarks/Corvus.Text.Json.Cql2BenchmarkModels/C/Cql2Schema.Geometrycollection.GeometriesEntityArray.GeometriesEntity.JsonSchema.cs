        ...
        public readonly partial struct GeometriesEntityArray
        {
                ...
                : IJsonElement<GeometriesEntity>
            {
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("cql2-schema.json#/$defs/geometrycollection/properties/geometries/items"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "cql2-schema.json#/$defs/geometrycollection/properties/geometries/items";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "cql2-schema.json#/$defs/geometrycollection/properties/geometries/items"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                            ...
                            switch (oneOfDiscriminatorBranch)
                            {
                                case 0:
                                {
                                    JsonSchemaContext discriminatorContext0 =
                                        Corvus.Cql2Benchmark.Current.Cql2Schema.Point.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                                    Corvus.Cql2Benchmark.Current.Cql2Schema.Point.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext0);
                                ...
                                case 1:
                                {
                                    JsonSchemaContext discriminatorContext1 =
                                        Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                                    Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext1);
                                ...
                                case 2:
                                {
                                    JsonSchemaContext discriminatorContext2 =
                                        Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf2SchemaEvaluationPath);
                                    Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext2);
                                ...
                                case 3:
                                {
                                    JsonSchemaContext discriminatorContext3 =
                                        Corvus.Cql2Benchmark.Current.Cql2Schema.Multipoint.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf3SchemaEvaluationPath);
                                    Corvus.Cql2Benchmark.Current.Cql2Schema.Multipoint.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext3);
                                ...
                                case 4:
                                {
                                    JsonSchemaContext discriminatorContext4 =
                                        Corvus.Cql2Benchmark.Current.Cql2Schema.Multilinestring.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf4SchemaEvaluationPath);
                                    Corvus.Cql2Benchmark.Current.Cql2Schema.Multilinestring.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext4);
                                ...
                                case 5:
                                {
                                    JsonSchemaContext discriminatorContext5 =
                                        Corvus.Cql2Benchmark.Current.Cql2Schema.Multipolygon.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf5SchemaEvaluationPath);
                                    Corvus.Cql2Benchmark.Current.Cql2Schema.Multipolygon.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext5);
                        ...
                        JsonSchemaContext oneOfContext0 =
                            Corvus.Cql2Benchmark.Current.Cql2Schema.Point.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                        Corvus.Cql2Benchmark.Current.Cql2Schema.Point.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
                        ...
                        JsonSchemaContext oneOfContext1 =
                            Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                        Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
                        ...
                        JsonSchemaContext oneOfContext2 =
                            Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf2SchemaEvaluationPath);
                        Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext2);
                        ...
                        JsonSchemaContext oneOfContext3 =
                            Corvus.Cql2Benchmark.Current.Cql2Schema.Multipoint.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf3SchemaEvaluationPath);
                        Corvus.Cql2Benchmark.Current.Cql2Schema.Multipoint.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext3);
                        ...
                        JsonSchemaContext oneOfContext4 =
                            Corvus.Cql2Benchmark.Current.Cql2Schema.Multilinestring.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf4SchemaEvaluationPath);
                        Corvus.Cql2Benchmark.Current.Cql2Schema.Multilinestring.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext4);
                        ...
                        JsonSchemaContext oneOfContext5 =
                            Corvus.Cql2Benchmark.Current.Cql2Schema.Multipolygon.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf5SchemaEvaluationPath);
                        Corvus.Cql2Benchmark.Current.Cql2Schema.Multipolygon.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext5);
