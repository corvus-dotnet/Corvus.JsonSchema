    ...
    public readonly partial struct Geometrycollection
    {
        ...
        public readonly partial struct GeometriesEntityArray
        {
...
#endif
            {
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.GeometriesEntityArray.GeometriesEntity.Source value)
                {
                    CheckValidInstance();
