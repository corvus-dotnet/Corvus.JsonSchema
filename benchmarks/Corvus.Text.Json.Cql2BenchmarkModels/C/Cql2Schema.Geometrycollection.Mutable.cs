...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct Geometrycollection
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.GeometriesEntityArray.Mutable Geometries
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GeometriesUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.GeometriesEntityArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.TypeEntity.Mutable Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.TypeEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetGeometries(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.GeometriesEntityArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetGeometries<TContext>(in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.GeometriesEntityArray.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.TypeEntity.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.GeometriesEntityArray.Source _createArg1;
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.TypeEntity.Source _createArg2;
            ...
            internal Source(Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.GeometriesEntityArray.Source arg1, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.TypeEntity.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            #endif
        {
            ...
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.GeometriesEntityArray.Source<TContext> _createArg1;
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.TypeEntity.Source _createArg2;
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in TContext context, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.GeometriesEntityArray.Source<TContext> arg1, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.TypeEntity.Source arg2)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.GeometriesEntityArray.Source geometries,
                in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.TypeEntity.Source type)
            {
            ...
            /// Creates an instance of a <see cref="Geometrycollection"/>.
            /// </summary>
            public void Create(in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.GeometriesEntityArray.Source geometries, in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.TypeEntity.Source type)
            {
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.GeometriesEntityArray.Source<TContext> geometries,
                in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.TypeEntity.Source type)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            ...
            internal static void BuildCreateValue(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.GeometriesEntityArray.Source arg1, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.TypeEntity.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
            ...
            /// <param name="arg2">The value of the property.</param>
            /// <param name="o">The complex value builder into which to write the object.</param>
            internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.GeometriesEntityArray.Source<TContext> arg1, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.TypeEntity.Source arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.GeometriesEntityArray.Source geometries, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.TypeEntity.Source type)
        {
            return new Source(geometries, type);
        }
        ...
        /// <param name="type">The value of the <c>"type"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.GeometriesEntityArray.Source<TContext> geometries, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.TypeEntity.Source type)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Source<TContext>(context, geometries, type);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.GeometriesEntityArray.Source geometries, in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.TypeEntity.Source type, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        public static ParsedJsonDocument<Geometrycollection> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Geometrycollection>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Geometrycollection> Create<TContext>(
        ...
        public static ParsedJsonDocument<Geometrycollection> Create(in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.GeometriesEntityArray.Source geometries, in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.TypeEntity.Source type, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Geometrycollection> Create<TContext>(in TContext context, in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.GeometriesEntityArray.Source<TContext> geometries, in Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.TypeEntity.Source type, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
