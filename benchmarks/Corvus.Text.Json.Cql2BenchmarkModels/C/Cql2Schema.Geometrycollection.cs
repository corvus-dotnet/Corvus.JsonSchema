...
public readonly partial struct Cql2Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.GeometriesEntityArray Geometries
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GeometriesUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.GeometriesEntityArray value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.TypeEntity Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.TypeEntity value))
                {
                    return value;
                }
