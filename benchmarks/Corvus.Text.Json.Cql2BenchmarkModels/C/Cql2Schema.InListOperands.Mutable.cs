...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct InListOperands
    {
...
#endif
        {
            ...
            /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public Corvus.Cql2Benchmark.Current.Cql2Schema.ScalarExpression.Mutable Item1
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Current.Cql2Schema.ScalarExpression.Mutable>(_idx, 0);
                }
            }
            ...
            /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public Corvus.Cql2Benchmark.Current.Cql2Schema.InListOperands.ScalarExpressionArray.Mutable Item2
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Current.Cql2Schema.InListOperands.ScalarExpressionArray.Mutable>(_idx, 1);
                }
            }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Cql2Benchmark.Current.Cql2Schema.InListOperands.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Current.Cql2Schema.InListOperands.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            public void CreateTuple(in Corvus.Cql2Benchmark.Current.Cql2Schema.ScalarExpression.Source item1, in Corvus.Cql2Benchmark.Current.Cql2Schema.InListOperands.ScalarExpressionArray.Source item2)
            {
        ...
        public static ParsedJsonDocument<InListOperands> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<InListOperands>();
            }
            finally
            {
