...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct InListOperands
    {
...
#endif
        {
            ...
            public Corvus.Cql2Benchmark.Current.Cql2Schema.ScalarExpression this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Current.Cql2Schema.ScalarExpression>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema.ScalarExpression> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema.ScalarExpression>(_parent, _idx);
            }
