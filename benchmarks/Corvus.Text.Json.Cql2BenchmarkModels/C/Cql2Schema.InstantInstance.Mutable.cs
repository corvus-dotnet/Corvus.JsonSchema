...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct InstantInstance
    {
...
#endif
        {
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Cql2Benchmark.Current.Cql2Schema.DateInstant.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsDateInstant(out Corvus.Cql2Benchmark.Current.Cql2Schema.DateInstant.Mutable result)
            {
                if (Corvus.Cql2Benchmark.Current.Cql2Schema.DateInstant.JsonSchema.Evaluate(_parent, _idx))
                {
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampInstant.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsTimestampInstant(out Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampInstant.Mutable result)
            {
                if (Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampInstant.JsonSchema.Evaluate(_parent, _idx))
                {
        ...
        public static ParsedJsonDocument<InstantInstance> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<InstantInstance>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<InstantInstance> Create<TContext>(
