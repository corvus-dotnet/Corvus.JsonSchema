...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct InstantInstance
    {
...
#endif
        {
            ...
            /// </remarks>
            public void Apply(in Corvus.Cql2Benchmark.Current.Cql2Schema.DateInstant value)
            {
                CheckValidInstance();
            ...
            /// This will add or update any property values provided by the <paramref name="value"/>.
            /// </remarks>
            public void Apply(in Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampInstant value)
            {
                CheckValidInstance();
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.InstantInstance.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchDateInstant(Corvus.Cql2Benchmark.Current.Cql2Schema.DateInstant.Mutable.From(this), context);
                }

                if (Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampInstant.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchTimestampInstant(Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampInstant.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.InstantInstance.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Cql2Benchmark.Current.Cql2Schema.DateInstant.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchDateInstant(Corvus.Cql2Benchmark.Current.Cql2Schema.DateInstant.Mutable.From(this));
                }

                if (Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampInstant.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchTimestampInstant(Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampInstant.Mutable.From(this));
                }
            ...
            public bool TryGetAsDateInstant(out Corvus.Cql2Benchmark.Current.Cql2Schema.DateInstant result)
            {
                if (Corvus.Cql2Benchmark.Current.Cql2Schema.DateInstant.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Cql2Benchmark.Current.Cql2Schema.DateInstant.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsTimestampInstant(out Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampInstant result)
            {
                if (Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampInstant.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampInstant.Mutable.From(this);
                    return true;
                }
