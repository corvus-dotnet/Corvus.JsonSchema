...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct InstantString
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(InstantString instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="InstantString"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator InstantString(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"InstantString.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly InstantString Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly InstantString Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<InstantString>(_idx);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.InstantString.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchDateString(Corvus.Cql2Benchmark.Current.Cql2Schema.DateString.Mutable.From(this), context);
                }

                if (Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchTimestampString(Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.InstantString.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Cql2Benchmark.Current.Cql2Schema.DateString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchDateString(Corvus.Cql2Benchmark.Current.Cql2Schema.DateString.Mutable.From(this));
                }

                if (Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchTimestampString(Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.Mutable.From(this));
                }
            ...
            public bool TryGetAsDateString(out Corvus.Cql2Benchmark.Current.Cql2Schema.DateString.Mutable result)
            {
                if (Corvus.Cql2Benchmark.Current.Cql2Schema.DateString.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Cql2Benchmark.Current.Cql2Schema.DateString.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsTimestampString(out Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.Mutable result)
            {
                if (Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(InstantString instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<InstantString, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<InstantString> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<InstantString>();
            }
            finally
            {
