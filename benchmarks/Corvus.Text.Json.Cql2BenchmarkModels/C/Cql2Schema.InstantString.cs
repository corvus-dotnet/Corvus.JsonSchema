...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct InstantString
#if NET8_0_OR_GREATER
        : IJsonElement<InstantString>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InstantString"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal InstantString(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static InstantString DefaultInstance { get; }
        ...
        public static explicit operator Corvus.Cql2Benchmark.Current.Cql2Schema.DateString(InstantString value)
        {
            return Corvus.Cql2Benchmark.Current.Cql2Schema.DateString.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator InstantString(Corvus.Cql2Benchmark.Current.Cql2Schema.DateString value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString(InstantString value)
        {
            return Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.From(value);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(InstantString value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in InstantString left, in InstantString right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in InstantString left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(InstantString instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator InstantString(JsonElement instance)
        {
            return InstantString.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static InstantString From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static InstantString ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<InstantString>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static InstantString ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<InstantString>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static InstantString ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<InstantString>(json, options);
        }
        ...
        /// </exception>
        public static InstantString ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<InstantString>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out InstantString? result)
        {
            return JsonElementHelpers.TryParseValue<InstantString>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new InstantString(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static InstantString IJsonElement<InstantString>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"InstantString: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="InstantString"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="InstantString"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public InstantString Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<InstantString>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="InstantString"/> that lives for the lifetime of its
        ...
        public bool TryGetAsDateString(out Corvus.Cql2Benchmark.Current.Cql2Schema.DateString result)
        {
            ...
            {
                result = Corvus.Cql2Benchmark.Current.Cql2Schema.DateString.From(this);
                return true;
            }
        ...
        public bool TryGetAsTimestampString(out Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString result)
        {
            ...
            {
                result = Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.From(this);
                return true;
            }
        ...
        /// <param name="matchDateString">Match a <see cref="Corvus.Cql2Benchmark.Current.Cql2Schema.DateString"/>.</param>
        /// <param name="matchTimestampString">Match a <see cref="Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString"/>.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.DateString, TContext, TResult> matchDateString,
            Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString, TContext, TResult> matchTimestampString,
            Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.InstantString, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.Cql2Benchmark.Current.Cql2Schema.DateString.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchDateString(Corvus.Cql2Benchmark.Current.Cql2Schema.DateString.From(this), context);
            }

            if (Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchTimestampString(Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.DateString, TResult> matchDateString,
            Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString, TResult> matchTimestampString,
            Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.InstantString, TResult> defaultMatch)
        {
            if (Corvus.Cql2Benchmark.Current.Cql2Schema.DateString.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchDateString(Corvus.Cql2Benchmark.Current.Cql2Schema.DateString.From(this));
            }

            if (Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchTimestampString(Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.From(this));
            }
