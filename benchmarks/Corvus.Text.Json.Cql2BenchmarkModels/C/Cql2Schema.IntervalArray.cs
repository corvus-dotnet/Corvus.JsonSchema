...
public readonly partial struct Cql2Schema
{
...
#endif
    {
        ...
        public Corvus.Cql2Benchmark.Current.Cql2Schema.IntervalArray.IntervalArrayEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Current.Cql2Schema.IntervalArray.IntervalArrayEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema.IntervalArray.IntervalArrayEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema.IntervalArray.IntervalArrayEntity>(_parent, _idx);
        }
