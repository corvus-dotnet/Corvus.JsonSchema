...
public readonly partial struct Cql2Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Current.Cql2Schema.IntervalArray Interval
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IntervalUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.IntervalArray value))
                {
                    return value;
                }
