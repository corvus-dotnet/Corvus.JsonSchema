...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct IsBetweenOperands
        ...
        : IJsonElement<IsBetweenOperands>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IsBetweenOperands"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal IsBetweenOperands(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static IsBetweenOperands DefaultInstance { get; }
        ...
        public Corvus.Cql2Benchmark.Current.Cql2Schema.IsBetweenOperands.IsBetweenOperandsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Current.Cql2Schema.IsBetweenOperands.IsBetweenOperandsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema.IsBetweenOperands.IsBetweenOperandsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema.IsBetweenOperands.IsBetweenOperandsEntity>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in IsBetweenOperands left, in IsBetweenOperands right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in IsBetweenOperands left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(IsBetweenOperands instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator IsBetweenOperands(JsonElement instance)
        {
            return IsBetweenOperands.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IsBetweenOperands From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IsBetweenOperands ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IsBetweenOperands>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IsBetweenOperands ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IsBetweenOperands>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IsBetweenOperands ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IsBetweenOperands>(json, options);
        }
        ...
        /// </exception>
        public static IsBetweenOperands ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<IsBetweenOperands>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out IsBetweenOperands? result)
        {
            return JsonElementHelpers.TryParseValue<IsBetweenOperands>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new IsBetweenOperands(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static IsBetweenOperands IJsonElement<IsBetweenOperands>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"IsBetweenOperands: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="IsBetweenOperands"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="IsBetweenOperands"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public IsBetweenOperands Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<IsBetweenOperands>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="IsBetweenOperands"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public IsBetweenOperands Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<IsBetweenOperands>(_idx);
            }
