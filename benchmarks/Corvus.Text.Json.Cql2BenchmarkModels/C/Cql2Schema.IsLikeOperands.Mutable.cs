...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct IsLikeOperands
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(IsLikeOperands instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="IsLikeOperands"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator IsLikeOperands(Mutable instance)
            {
            ...
            /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public Corvus.Cql2Benchmark.Current.Cql2Schema.IsLikeOperands.PrefixItems0Entity.Mutable Item1
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Current.Cql2Schema.IsLikeOperands.PrefixItems0Entity.Mutable>(_idx, 0);
                }
            }
            ...
            /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.Mutable Item2
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.Mutable>(_idx, 1);
                }
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new IsLikeOperands(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"IsLikeOperands.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// <summary>
            /// Gets a <see cref="IsLikeOperands"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="IsLikeOperands"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly IsLikeOperands Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<IsLikeOperands>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="IsLikeOperands"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly IsLikeOperands Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<IsLikeOperands>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Cql2Benchmark.Current.Cql2Schema.IsLikeOperands.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(IsLikeOperands instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Current.Cql2Schema.IsLikeOperands.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            public void CreateTuple(in Corvus.Cql2Benchmark.Current.Cql2Schema.IsLikeOperands.PrefixItems0Entity.Source item1, in Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.Source item2)
            {
        ...
        {
            return workspace.CreateBuilder<IsLikeOperands, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<IsLikeOperands> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<IsLikeOperands>();
            }
            finally
            {
