    ...
    public readonly partial struct IsLikeOperands
    {
        ...
        public readonly partial struct PrefixItems0Entity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public readonly PrefixItems0Entity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PrefixItems0Entity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PrefixItems0Entity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.IsLikeOperands.PrefixItems0Entity.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.IsLikeOperands.PrefixItems0Entity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Cql2Benchmark.Current.Cql2Schema.CharacterExpression.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public static ParsedJsonDocument<PrefixItems0Entity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PrefixItems0Entity>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<PrefixItems0Entity> Create<TContext>(
