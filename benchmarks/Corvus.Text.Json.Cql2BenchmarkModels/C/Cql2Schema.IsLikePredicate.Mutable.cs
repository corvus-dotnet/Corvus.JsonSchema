...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct IsLikePredicate
    {
...
#endif
        {
            ...
            public void SetArgs(in Corvus.Cql2Benchmark.Current.Cql2Schema.IsLikeOperands.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetOp(in Corvus.Cql2Benchmark.Current.Cql2Schema.IsLikePredicate.OpEntity.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(in Corvus.Cql2Benchmark.Current.Cql2Schema.IsLikeOperands.Source arg1, in Corvus.Cql2Benchmark.Current.Cql2Schema.IsLikePredicate.OpEntity.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, in Corvus.Cql2Benchmark.Current.Cql2Schema.IsLikeOperands.Source<TContext> arg1, in Corvus.Cql2Benchmark.Current.Cql2Schema.IsLikePredicate.OpEntity.Source arg2)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
        ...
        public ref struct Builder
        {
            ...
            internal static void BuildCreateValue(in Corvus.Cql2Benchmark.Current.Cql2Schema.IsLikeOperands.Source arg1, in Corvus.Cql2Benchmark.Current.Cql2Schema.IsLikePredicate.OpEntity.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
            ...
            /// <param name="arg2">The value of the property.</param>
            /// <param name="o">The complex value builder into which to write the object.</param>
            internal static void BuildCreateValue<TContext>(scoped in TContext context, in Corvus.Cql2Benchmark.Current.Cql2Schema.IsLikeOperands.Source<TContext> arg1, in Corvus.Cql2Benchmark.Current.Cql2Schema.IsLikePredicate.OpEntity.Source arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in Corvus.Cql2Benchmark.Current.Cql2Schema.IsLikeOperands.Source args, in Corvus.Cql2Benchmark.Current.Cql2Schema.IsLikePredicate.OpEntity.Source op)
        {
        ...
        /// <param name="op">The value of the <c>"op"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Cql2Benchmark.Current.Cql2Schema.IsLikeOperands.Source<TContext> args, in Corvus.Cql2Benchmark.Current.Cql2Schema.IsLikePredicate.OpEntity.Source op)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
