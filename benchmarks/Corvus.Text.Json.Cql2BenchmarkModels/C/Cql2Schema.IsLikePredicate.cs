...
public readonly partial struct Cql2Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Current.Cql2Schema.IsLikeOperands Args
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ArgsUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.IsLikeOperands value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Current.Cql2Schema.IsLikePredicate.OpEntity Op
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OpUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.IsLikePredicate.OpEntity value))
                {
                    return value;
                }
