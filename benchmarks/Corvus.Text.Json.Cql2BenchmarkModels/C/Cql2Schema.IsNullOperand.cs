...
public readonly partial struct Cql2Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IsNullOperand"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal IsNullOperand(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static IsNullOperand DefaultInstance { get; }
        ...
        public Corvus.Cql2Benchmark.Current.Cql2Schema.IsNullOperand.IsNullOperandEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Current.Cql2Schema.IsNullOperand.IsNullOperandEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema.IsNullOperand.IsNullOperandEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema.IsNullOperand.IsNullOperandEntity>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in IsNullOperand left, in IsNullOperand right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in IsNullOperand left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(IsNullOperand instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator IsNullOperand(JsonElement instance)
        {
            return IsNullOperand.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IsNullOperand From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IsNullOperand ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IsNullOperand>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IsNullOperand ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IsNullOperand>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IsNullOperand ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IsNullOperand>(json, options);
        }
        ...
        /// </exception>
        public static IsNullOperand ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<IsNullOperand>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out IsNullOperand? result)
        {
            return JsonElementHelpers.TryParseValue<IsNullOperand>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new IsNullOperand(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static IsNullOperand IJsonElement<IsNullOperand>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"IsNullOperand: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="IsNullOperand"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="IsNullOperand"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public IsNullOperand Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<IsNullOperand>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="IsNullOperand"/> that lives for the lifetime of its
