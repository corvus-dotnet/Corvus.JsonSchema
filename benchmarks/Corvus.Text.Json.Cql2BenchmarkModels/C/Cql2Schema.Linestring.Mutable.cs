...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct Linestring
    {
...
#endif
        {
            ...
            public void SetBbox(in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.JsonNumberArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCoordinates(in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.CoordinatesArray2Array.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.TypeEntity.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.CoordinatesArray2Array.Source arg1, in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.TypeEntity.Source arg2, in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.JsonNumberArray.Source arg3)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.CoordinatesArray2Array.Source coordinates, in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.TypeEntity.Source type, in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.JsonNumberArray.Source bbox = default)
        {
