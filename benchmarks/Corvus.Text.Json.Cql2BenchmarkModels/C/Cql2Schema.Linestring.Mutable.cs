...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct Linestring
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Linestring instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Linestring"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Linestring(Mutable instance)
            {
            ...
            /// </summary>
            public Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.JsonNumberArray.Mutable Bbox
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BboxUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.JsonNumberArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.CoordinatesArray2Array.Mutable Coordinates
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CoordinatesUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.CoordinatesArray2Array.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.TypeEntity.Mutable Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.TypeEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetBbox(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.JsonNumberArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetBbox<TContext>(in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.JsonNumberArray.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCoordinates(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.CoordinatesArray2Array.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCoordinates<TContext>(in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.CoordinatesArray2Array.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.TypeEntity.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Linestring.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Linestring Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly Linestring Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Linestring>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.CoordinatesArray2Array.Source _createArg1;
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.TypeEntity.Source _createArg2;
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.JsonNumberArray.Source _createArg3;
            ...
            internal Source(Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.CoordinatesArray2Array.Source arg1, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.TypeEntity.Source arg2, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.JsonNumberArray.Source arg3)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            public static implicit operator Source(Linestring instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.CoordinatesArray2Array.Source<TContext> _createArg1;
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.TypeEntity.Source _createArg2;
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.JsonNumberArray.Source<TContext> _createArg3;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Linestring"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.CoordinatesArray2Array.Source coordinates,
                in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.TypeEntity.Source type,
                in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.JsonNumberArray.Source bbox = default)
            {
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.CoordinatesArray2Array.Source<TContext> coordinates,
                in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.TypeEntity.Source type,
                in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.JsonNumberArray.Source<TContext> bbox = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        {
            return workspace.CreateBuilder<Linestring, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Linestring> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Linestring>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Linestring> Create<TContext>(
        ...
        public static ParsedJsonDocument<Linestring> Create(in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.CoordinatesArray2Array.Source coordinates, in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.TypeEntity.Source type, in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.JsonNumberArray.Source bbox = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Linestring> Create<TContext>(in TContext context, in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.CoordinatesArray2Array.Source<TContext> coordinates, in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.TypeEntity.Source type, in Corvus.Cql2Benchmark.Current.Cql2Schema.Linestring.JsonNumberArray.Source<TContext> bbox = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
