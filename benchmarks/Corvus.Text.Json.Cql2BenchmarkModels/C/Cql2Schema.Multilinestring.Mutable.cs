...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct Multilinestring
    {
...
#endif
        {
            ...
            public void SetBbox(in Corvus.Cql2Benchmark.Current.Cql2Schema.Multilinestring.JsonNumberArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCoordinates(in Corvus.Cql2Benchmark.Current.Cql2Schema.Multilinestring.CoordinatesArray2Array.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(in Corvus.Cql2Benchmark.Current.Cql2Schema.Multilinestring.TypeEntity.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(in Corvus.Cql2Benchmark.Current.Cql2Schema.Multilinestring.CoordinatesArray2Array.Source arg1, in Corvus.Cql2Benchmark.Current.Cql2Schema.Multilinestring.TypeEntity.Source arg2, in Corvus.Cql2Benchmark.Current.Cql2Schema.Multilinestring.JsonNumberArray.Source arg3)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
