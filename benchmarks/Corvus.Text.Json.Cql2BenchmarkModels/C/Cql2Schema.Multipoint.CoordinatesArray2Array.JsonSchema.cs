    ...
    public readonly partial struct Multipoint
    {
            ...
            : IJsonElement<CoordinatesArray2Array>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/multipoint/properties/coordinates"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/multipoint/properties/coordinates";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/multipoint/properties/coordinates"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        while (arrayValidation_enumerator.MoveNext())
                        {
                            ...
                            JsonSchemaContext childContext = Corvus.Cql2Benchmark.Current.Cql2Schema.Multipoint.CoordinatesArray2Array.JsonNumberArray.JsonSchema.PushChildContext(
                                parentDocument,
                            ...
                            Corvus.Cql2Benchmark.Current.Cql2Schema.Multipoint.CoordinatesArray2Array.JsonNumberArray.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
