...
public readonly partial struct Cql2Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Multipoint"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Multipoint(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Multipoint DefaultInstance { get; }
        ...
        /// </summary>
        public Corvus.Cql2Benchmark.Current.Cql2Schema.Multipoint.JsonNumberArray Bbox
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BboxUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.Multipoint.JsonNumberArray value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Current.Cql2Schema.Multipoint.CoordinatesArray2Array Coordinates
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CoordinatesUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.Multipoint.CoordinatesArray2Array value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Current.Cql2Schema.Multipoint.TypeEntity Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.Multipoint.TypeEntity value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in Multipoint left, in Multipoint right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Multipoint left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Multipoint instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Multipoint(JsonElement instance)
        {
            return Multipoint.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Multipoint From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Multipoint ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Multipoint>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Multipoint ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Multipoint>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Multipoint ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Multipoint>(json, options);
        }
        ...
        /// </exception>
        public static Multipoint ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Multipoint>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Multipoint? result)
        {
            return JsonElementHelpers.TryParseValue<Multipoint>(ref reader, out result);
        }
...
#if NET
        static Multipoint IJsonElement<Multipoint>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Multipoint: ValueKind = {ValueKind} : \"{ToString()}\"";
