...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct Multipolygon
    {
...
#endif
        {
            ...
            public void SetBbox(in Corvus.Cql2Benchmark.Current.Cql2Schema.Multipolygon.JsonNumberArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCoordinates(in Corvus.Cql2Benchmark.Current.Cql2Schema.Multipolygon.CoordinatesArray2Array.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(in Corvus.Cql2Benchmark.Current.Cql2Schema.Multipolygon.TypeEntity.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(in Corvus.Cql2Benchmark.Current.Cql2Schema.Multipolygon.CoordinatesArray2Array.Source arg1, in Corvus.Cql2Benchmark.Current.Cql2Schema.Multipolygon.TypeEntity.Source arg2, in Corvus.Cql2Benchmark.Current.Cql2Schema.Multipolygon.JsonNumberArray.Source arg3)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, in Corvus.Cql2Benchmark.Current.Cql2Schema.Multipolygon.CoordinatesArray2Array.Source<TContext> arg1, in Corvus.Cql2Benchmark.Current.Cql2Schema.Multipolygon.TypeEntity.Source arg2, in Corvus.Cql2Benchmark.Current.Cql2Schema.Multipolygon.JsonNumberArray.Source<TContext> arg3)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in Corvus.Cql2Benchmark.Current.Cql2Schema.Multipolygon.CoordinatesArray2Array.Source coordinates, in Corvus.Cql2Benchmark.Current.Cql2Schema.Multipolygon.TypeEntity.Source type, in Corvus.Cql2Benchmark.Current.Cql2Schema.Multipolygon.JsonNumberArray.Source bbox = default)
        {
