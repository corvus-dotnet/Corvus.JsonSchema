...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct NotExpression
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.Cql2SchemaArray.Mutable Args
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ArgsUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.Cql2SchemaArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.OpEntity.Mutable Op
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OpUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.OpEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetArgs(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.Cql2SchemaArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetArgs<TContext>(in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.Cql2SchemaArray.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetOp(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.OpEntity.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.Cql2SchemaArray.Source _createArg1;
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.OpEntity.Source _createArg2;
            ...
            internal Source(Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.Cql2SchemaArray.Source arg1, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.OpEntity.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            #endif
        {
            ...
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.Cql2SchemaArray.Source<TContext> _createArg1;
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.OpEntity.Source _createArg2;
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in TContext context, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.Cql2SchemaArray.Source<TContext> arg1, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.OpEntity.Source arg2)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
        ...
        public ref struct Builder
        {
            ...
            /// Creates an instance of a <see cref="NotExpression"/>.
            /// </summary>
            public void Create(in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.Cql2SchemaArray.Source args, in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.OpEntity.Source op)
            {
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.Cql2SchemaArray.Source<TContext> args,
                in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.OpEntity.Source op)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            ...
            internal static void BuildCreateValue(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.Cql2SchemaArray.Source arg1, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.OpEntity.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
            ...
            /// <param name="arg2">The value of the property.</param>
            /// <param name="o">The complex value builder into which to write the object.</param>
            internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.Cql2SchemaArray.Source<TContext> arg1, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.OpEntity.Source arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.Cql2SchemaArray.Source args, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.OpEntity.Source op)
        {
        ...
        /// <param name="op">The value of the <c>"op"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.Cql2SchemaArray.Source<TContext> args, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.OpEntity.Source op)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.Cql2SchemaArray.Source args, in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.OpEntity.Source op, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.Cql2SchemaArray.Source<TContext> args, in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.OpEntity.Source op, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        public static ParsedJsonDocument<NotExpression> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<NotExpression>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<NotExpression> Create<TContext>(
        ...
        public static ParsedJsonDocument<NotExpression> Create(in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.Cql2SchemaArray.Source args, in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.OpEntity.Source op, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<NotExpression> Create<TContext>(in TContext context, in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.Cql2SchemaArray.Source<TContext> args, in Corvus.Cql2Benchmark.Current.Cql2Schema.NotExpression.OpEntity.Source op, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
