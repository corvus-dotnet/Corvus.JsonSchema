    ...
    public readonly partial struct PatternExpression
    {
        ...
        public readonly partial struct PatternExpressionRequiredArgsAndOp
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PatternExpressionRequiredArgsAndOp instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PatternExpressionRequiredArgsAndOp"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PatternExpressionRequiredArgsAndOp(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.PatternExpressionArray.Mutable Args
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ArgsUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.PatternExpressionArray.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.OpEntity.Mutable Op
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OpUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.OpEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new PatternExpressionRequiredArgsAndOp(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetArgs<TContext>(in Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.PatternExpressionArray.Source<TContext> value)
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PatternExpressionRequiredArgsAndOp.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="PatternExpressionRequiredArgsAndOp"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="PatternExpressionRequiredArgsAndOp"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly PatternExpressionRequiredArgsAndOp Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<PatternExpressionRequiredArgsAndOp>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="PatternExpressionRequiredArgsAndOp"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly PatternExpressionRequiredArgsAndOp Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PatternExpressionRequiredArgsAndOp>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.PatternExpressionArray.Source _createArg1;
                private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.OpEntity.Source _createArg2;
                ...
                public static implicit operator Source(PatternExpressionRequiredArgsAndOp instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.PatternExpressionArray.Source<TContext> _createArg1;
                private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.OpEntity.Source _createArg2;
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="PatternExpressionRequiredArgsAndOp"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.PatternExpressionArray.Source args,
                    in Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.OpEntity.Source op)
                {
                ...
                /// Creates an instance of a <see cref="PatternExpressionRequiredArgsAndOp"/>.
                /// </summary>
                public void Create(in Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.PatternExpressionArray.Source args, in Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.OpEntity.Source op)
                {
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.PatternExpressionArray.Source<TContext> args,
                    in Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.OpEntity.Source op)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.PatternExpressionArray.Source args, in Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.OpEntity.Source op, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            {
                return workspace.CreateBuilder<PatternExpressionRequiredArgsAndOp, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PatternExpressionRequiredArgsAndOp> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PatternExpressionRequiredArgsAndOp>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<PatternExpressionRequiredArgsAndOp> Create<TContext>(
            ...
            public static ParsedJsonDocument<PatternExpressionRequiredArgsAndOp> Create(in Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.PatternExpressionArray.Source args, in Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.OpEntity.Source op, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<PatternExpressionRequiredArgsAndOp> Create<TContext>(in TContext context, in Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.PatternExpressionArray.Source<TContext> args, in Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.OpEntity.Source op, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
