...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct PatternExpression
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="PatternExpressionRequiredArgsAndOp"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal PatternExpressionRequiredArgsAndOp(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static PatternExpressionRequiredArgsAndOp DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.PatternExpressionArray Args
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ArgsUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.PatternExpressionArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.OpEntity Op
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OpUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.OpEntity value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in PatternExpressionRequiredArgsAndOp left, in PatternExpressionRequiredArgsAndOp right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in PatternExpressionRequiredArgsAndOp left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(PatternExpressionRequiredArgsAndOp instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PatternExpressionRequiredArgsAndOp(JsonElement instance)
            {
                return PatternExpressionRequiredArgsAndOp.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PatternExpressionRequiredArgsAndOp From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PatternExpressionRequiredArgsAndOp ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PatternExpressionRequiredArgsAndOp>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PatternExpressionRequiredArgsAndOp ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PatternExpressionRequiredArgsAndOp>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PatternExpressionRequiredArgsAndOp ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PatternExpressionRequiredArgsAndOp>(json, options);
            }
            ...
            /// </exception>
            public static PatternExpressionRequiredArgsAndOp ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<PatternExpressionRequiredArgsAndOp>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out PatternExpressionRequiredArgsAndOp? result)
            {
                return JsonElementHelpers.TryParseValue<PatternExpressionRequiredArgsAndOp>(ref reader, out result);
            }
...
#if NET
            static PatternExpressionRequiredArgsAndOp IJsonElement<PatternExpressionRequiredArgsAndOp>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PatternExpressionRequiredArgsAndOp: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public PatternExpressionRequiredArgsAndOp Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public PatternExpressionRequiredArgsAndOp Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<PatternExpressionRequiredArgsAndOp>(_idx);
                }
