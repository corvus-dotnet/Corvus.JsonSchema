...
public readonly partial struct Cql2Schema
{
    ...
    /// Generated from JSON Schema.
    /// </summary>
    public readonly partial struct PatternExpression
    {
        /// <summary>
        /// Generated from JSON Schema.
        /// </summary>
        public readonly partial struct RequiredArgsAndOp
        {
            /// <summary>
            /// Generated from JSON Schema.
            /// </summary>
            [DebuggerDisplay("{DebuggerDisplay,nq}")]
            public readonly partial struct PatternExpressionArray
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(PatternExpressionArray instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="PatternExpressionArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator PatternExpressionArray(Mutable instance)
                    {
                    ...
                    public Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.Mutable this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.Mutable>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.Mutable> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.Mutable>(_parent, _idx);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new PatternExpressionArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"PatternExpressionArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void SetItem(int itemIndex, in Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void InsertItem(int itemIndex, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void AddItem(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.Source value)
                    {
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Remove(in Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression item)
                    {
                        CheckValidInstance();
                        if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression>(this, in item))
                        {
                            return false;
                        }
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void RemoveWhere(JsonPredicate<Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression> predicate)
                    {
                        CheckValidInstance();
                        JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression>(this, predicate);
                        _documentVersion = _parent.Version;
                    }
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Replace(in Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression oldItem, in Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.Source newItem)
                    {
                        CheckValidInstance();
                        ...
                        var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression>(_parent, _idx);

                        while (enumerator.MoveNext())
                        {
                            Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression current = enumerator.Current;
                    ...
                    /// <summary>
                    /// Gets a <see cref="PatternExpressionArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="PatternExpressionArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly PatternExpressionArray Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<PatternExpressionArray>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="PatternExpressionArray"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly PatternExpressionArray Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<PatternExpressionArray>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.RequiredArgsAndOp.PatternExpressionArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(PatternExpressionArray instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.RequiredArgsAndOp.PatternExpressionArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// </summary>
                    public void AddItem(in Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.Source value)
                    {
                    ...
                    /// Add an item to the array.
                    /// </summary>
                    public void AddItem<TContext>(in Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.Source<TContext> value)
#if NET9_0_OR_GREATER
                        where TContext : allows ref struct
#endif
                    {
                ...
                {
                    return workspace.CreateBuilder<PatternExpressionArray, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<PatternExpressionArray> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<PatternExpressionArray>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<PatternExpressionArray> Create<TContext>(
