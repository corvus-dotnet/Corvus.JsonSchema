...
public readonly partial struct Cql2Schema
{
...
#endif
    {
        ...
        public static explicit operator Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.RequiredArgsAndOp(PatternExpression value)
        {
            return Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.RequiredArgsAndOp.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator PatternExpression(Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.RequiredArgsAndOp value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp(PatternExpression value)
        {
            return Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.From(value);
        }
        ...
        public bool TryGetAsRequiredArgsAndOp(out Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.RequiredArgsAndOp result)
        {
            ...
            {
                result = Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.RequiredArgsAndOp.From(this);
                return true;
            }
        ...
        public bool TryGetAsPatternExpressionRequiredArgsAndOp(out Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp result)
        {
            ...
            {
                result = Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.RequiredArgsAndOp.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredArgsAndOp(Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.RequiredArgsAndOp.From(this), context);
            }

            if (Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchPatternExpressionRequiredArgsAndOp(Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression, TResult> defaultMatch)
        {
            if (Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.RequiredArgsAndOp.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredArgsAndOp(Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.RequiredArgsAndOp.From(this));
            }

            if (Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchPatternExpressionRequiredArgsAndOp(Corvus.Cql2Benchmark.Current.Cql2Schema.PatternExpression.PatternExpressionRequiredArgsAndOp.From(this));
            }
