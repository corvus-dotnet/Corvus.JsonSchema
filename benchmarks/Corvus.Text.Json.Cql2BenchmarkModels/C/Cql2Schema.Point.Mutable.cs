...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct Point
    {
...
#endif
        {
            ...
            public void SetBbox(in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.JsonNumberArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCoordinates(in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.CoordinateArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.TypeEntity.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.CoordinateArray.Source arg1, in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.TypeEntity.Source arg2, in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.JsonNumberArray.Source arg3)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.CoordinateArray.Source<TContext> arg1, in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.TypeEntity.Source arg2, in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.JsonNumberArray.Source<TContext> arg3)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
        ...
        public ref struct Builder
        {
            ...
            internal static void BuildCreateValue(in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.CoordinateArray.Source arg1, in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.TypeEntity.Source arg2, in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.JsonNumberArray.Source arg3, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.CoordinateArray.Source coordinates, in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.TypeEntity.Source type, in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.JsonNumberArray.Source bbox = default)
        {
