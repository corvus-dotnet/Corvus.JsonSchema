...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct Point
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Point instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Point"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Point(Mutable instance)
            {
            ...
            /// </summary>
            public Corvus.Cql2Benchmark.Current.Cql2Schema.Point.JsonNumberArray.Mutable Bbox
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BboxUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.Point.JsonNumberArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Current.Cql2Schema.Point.CoordinateArray.Mutable Coordinates
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CoordinatesUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.Point.CoordinateArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Current.Cql2Schema.Point.TypeEntity.Mutable Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.Point.TypeEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Point(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetBbox(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.JsonNumberArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetBbox<TContext>(in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.JsonNumberArray.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCoordinates(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.CoordinateArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCoordinates<TContext>(in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.CoordinateArray.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.TypeEntity.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Point.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Point"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Point"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<Point>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Point"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Point Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Point>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.Point.CoordinateArray.Source _createArg1;
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.Point.TypeEntity.Source _createArg2;
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.Point.JsonNumberArray.Source _createArg3;
            ...
            internal Source(Corvus.Cql2Benchmark.Current.Cql2Schema.Point.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.CoordinateArray.Source arg1, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.TypeEntity.Source arg2, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.JsonNumberArray.Source arg3)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            public static implicit operator Source(Point instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.Point.CoordinateArray.Source<TContext> _createArg1;
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.Point.TypeEntity.Source _createArg2;
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.Point.JsonNumberArray.Source<TContext> _createArg3;
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Current.Cql2Schema.Point.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in TContext context, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.CoordinateArray.Source<TContext> arg1, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.TypeEntity.Source arg2, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.JsonNumberArray.Source<TContext> arg3)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.CoordinateArray.Source coordinates,
                in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.TypeEntity.Source type,
                in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.JsonNumberArray.Source bbox = default)
            {
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.CoordinateArray.Source<TContext> coordinates,
                in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.TypeEntity.Source type,
                in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.JsonNumberArray.Source<TContext> bbox = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            internal static void BuildCreateValue(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.CoordinateArray.Source arg1, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.TypeEntity.Source arg2, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.JsonNumberArray.Source arg3, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.CoordinateArray.Source coordinates, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.TypeEntity.Source type, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.JsonNumberArray.Source bbox = default)
        {
        ...
        /// <param name="bbox">The value of the <c>"bbox"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.CoordinateArray.Source<TContext> coordinates, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.TypeEntity.Source type, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.JsonNumberArray.Source<TContext> bbox = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.CoordinateArray.Source coordinates, in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.TypeEntity.Source type, in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.JsonNumberArray.Source bbox = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        {
            return workspace.CreateBuilder<Point, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Point> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Point>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Point> Create<TContext>(
        ...
        public static ParsedJsonDocument<Point> Create(in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.CoordinateArray.Source coordinates, in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.TypeEntity.Source type, in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.JsonNumberArray.Source bbox = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Point> Create<TContext>(in TContext context, in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.CoordinateArray.Source<TContext> coordinates, in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.TypeEntity.Source type, in Corvus.Cql2Benchmark.Current.Cql2Schema.Point.JsonNumberArray.Source<TContext> bbox = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
