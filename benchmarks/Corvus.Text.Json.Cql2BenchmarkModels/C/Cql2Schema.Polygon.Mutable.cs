...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct Polygon
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Polygon instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Polygon"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Polygon(Mutable instance)
            {
            ...
            /// </summary>
            public Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.JsonNumberArray.Mutable Bbox
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BboxUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.JsonNumberArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.CoordinatesArray2Array.Mutable Coordinates
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CoordinatesUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.CoordinatesArray2Array.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.TypeEntity.Mutable Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.TypeEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Polygon(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetBbox(in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.JsonNumberArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetBbox<TContext>(in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.JsonNumberArray.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCoordinates(in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.CoordinatesArray2Array.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCoordinates<TContext>(in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.CoordinatesArray2Array.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.TypeEntity.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Polygon.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Polygon"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Polygon"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Polygon Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Polygon>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Polygon"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Polygon Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Polygon>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.CoordinatesArray2Array.Source _createArg1;
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.TypeEntity.Source _createArg2;
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.JsonNumberArray.Source _createArg3;
            ...
            internal Source(Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.CoordinatesArray2Array.Source arg1, in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.TypeEntity.Source arg2, in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.JsonNumberArray.Source arg3)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            public static implicit operator Source(Polygon instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.CoordinatesArray2Array.Source<TContext> _createArg1;
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.TypeEntity.Source _createArg2;
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.JsonNumberArray.Source<TContext> _createArg3;
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in TContext context, in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.CoordinatesArray2Array.Source<TContext> arg1, in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.TypeEntity.Source arg2, in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.JsonNumberArray.Source<TContext> arg3)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Polygon"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.CoordinatesArray2Array.Source coordinates,
                in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.TypeEntity.Source type,
                in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.JsonNumberArray.Source bbox = default)
            {
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.CoordinatesArray2Array.Source<TContext> coordinates,
                in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.TypeEntity.Source type,
                in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.JsonNumberArray.Source<TContext> bbox = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            internal static void BuildCreateValue(in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.CoordinatesArray2Array.Source arg1, in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.TypeEntity.Source arg2, in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.JsonNumberArray.Source arg3, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.CoordinatesArray2Array.Source coordinates, in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.TypeEntity.Source type, in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.JsonNumberArray.Source bbox = default)
        {
        ...
        {
            return workspace.CreateBuilder<Polygon, Mutable>(this);
        }
    }
}
