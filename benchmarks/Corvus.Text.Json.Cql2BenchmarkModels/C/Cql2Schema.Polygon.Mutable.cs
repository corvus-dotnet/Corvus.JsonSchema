...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct Polygon
    {
...
#endif
        {
            ...
            public void SetBbox(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.JsonNumberArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCoordinates(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.CoordinatesArray2Array.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.TypeEntity.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.CoordinatesArray2Array.Source arg1, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.TypeEntity.Source arg2, scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.JsonNumberArray.Source arg3)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
        ...
        public static ParsedJsonDocument<Polygon> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Polygon>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Polygon> Create<TContext>(
        ...
        public static ParsedJsonDocument<Polygon> Create(in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.CoordinatesArray2Array.Source coordinates, in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.TypeEntity.Source type, in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.JsonNumberArray.Source bbox = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Polygon> Create<TContext>(in TContext context, in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.CoordinatesArray2Array.Source<TContext> coordinates, in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.TypeEntity.Source type, in Corvus.Cql2Benchmark.Current.Cql2Schema.Polygon.JsonNumberArray.Source<TContext> bbox = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
