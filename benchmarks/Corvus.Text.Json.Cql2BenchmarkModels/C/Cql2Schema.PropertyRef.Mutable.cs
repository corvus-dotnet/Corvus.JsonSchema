...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct PropertyRef
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Current.JsonString.Mutable Property
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PropertyUtf8, out Corvus.Cql2Benchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetProperty(scoped in Corvus.Cql2Benchmark.Current.JsonString.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Cql2Benchmark.Current.JsonString.Source _createArg1;
            ...
            internal Source(Corvus.Cql2Benchmark.Current.Cql2Schema.PropertyRef.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Cql2Benchmark.Current.JsonString.Source arg1)
            {
                _createArg1 = arg1;
                _kind = Kind.Create;
            }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Current.Cql2Schema.PropertyRef.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.Cql2Benchmark.Current.JsonString.Source property)
            {
                property.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Property, ref builder);
            }

            /// <summary>
            /// Creates an instance of a <see cref="PropertyRef"/>.
            /// </summary>
            public void Create(in Corvus.Cql2Benchmark.Current.JsonString.Source property)
            {
            ...
            internal static void BuildCreateValue(scoped in Corvus.Cql2Benchmark.Current.JsonString.Source arg1, ref ComplexValueBuilder o)
            {
                o.StartObject();
                Create(ref o, arg1);
                o.EndObject();
        ...
        /// </summary>
        /// <param name="property">The value of the <c>"property"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Cql2Benchmark.Current.JsonString.Source property)
        {
            return new Source(property);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Cql2Benchmark.Current.JsonString.Source property, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        public static ParsedJsonDocument<PropertyRef> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<PropertyRef>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<PropertyRef> Create<TContext>(
        ...
        public static ParsedJsonDocument<PropertyRef> Create(in Corvus.Cql2Benchmark.Current.JsonString.Source property, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
