...
public readonly partial struct Cql2Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Current.JsonString Property
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PropertyUtf8, out Corvus.Cql2Benchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        private static class JsonPropertyNamesPrebaked
        {
            ...
            /// </summary>
            public static ReadOnlySpan<byte> Property => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x70, 0x72, 0x6F, 0x70, 0x65, 0x72, 0x74, 0x79, 0x22];
        }
    }
}
