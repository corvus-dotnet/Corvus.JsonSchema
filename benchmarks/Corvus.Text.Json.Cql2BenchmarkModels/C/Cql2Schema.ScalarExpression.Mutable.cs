...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct ScalarExpression
    {
...
#endif
        {
            ...
            /// This will add or update any property values provided by the <paramref name="value"/>.
            /// </remarks>
            public void Apply(in Corvus.Cql2Benchmark.Current.Cql2Schema.InstantInstance value)
            {
                CheckValidInstance();
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.ScalarExpression.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchInstantInstance(Corvus.Cql2Benchmark.Current.Cql2Schema.InstantInstance.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.ScalarExpression.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Cql2Benchmark.Current.Cql2Schema.CharacterExpression.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.Cql2Benchmark.Current.Cql2Schema.InstantInstance.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchInstantInstance(Corvus.Cql2Benchmark.Current.Cql2Schema.InstantInstance.Mutable.From(this));
                }
            ...
            public bool TryGetAsInstantInstance(out Corvus.Cql2Benchmark.Current.Cql2Schema.InstantInstance.Mutable result)
            {
                if (Corvus.Cql2Benchmark.Current.Cql2Schema.InstantInstance.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Cql2Benchmark.Current.Cql2Schema.InstantInstance.Mutable.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Cql2Benchmark.Current.JsonBoolean.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsJsonBoolean(out Corvus.Cql2Benchmark.Current.JsonBoolean.Mutable result)
            {
                if (Corvus.Cql2Benchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
        ...
        public static ParsedJsonDocument<ScalarExpression> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ScalarExpression>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ScalarExpression> Create<TContext>(
