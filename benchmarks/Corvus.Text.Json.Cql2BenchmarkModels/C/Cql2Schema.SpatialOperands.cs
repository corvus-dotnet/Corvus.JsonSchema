...
public readonly partial struct Cql2Schema
{
...
#endif
    {
        ...
        public Corvus.Cql2Benchmark.Current.Cql2Schema.SpatialOperands.SpatialOperandsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Cql2Benchmark.Current.Cql2Schema.SpatialOperands.SpatialOperandsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema.SpatialOperands.SpatialOperandsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Cql2Benchmark.Current.Cql2Schema.SpatialOperands.SpatialOperandsEntity>(_parent, _idx);
        }
