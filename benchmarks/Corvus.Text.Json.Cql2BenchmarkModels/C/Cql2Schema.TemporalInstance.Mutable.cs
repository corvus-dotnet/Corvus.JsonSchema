...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct TemporalInstance
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public readonly TemporalInstance Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TemporalInstance Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TemporalInstance>(_idx);
            }
        ...
        public static ParsedJsonDocument<TemporalInstance> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TemporalInstance>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<TemporalInstance> Create<TContext>(
