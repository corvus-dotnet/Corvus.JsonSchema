...
public readonly partial struct Cql2Schema
{
    ...
    /// Generated from JSON Schema.
    /// </summary>
    public readonly partial struct TemporalOperands
    {
        /// <summary>
        /// Generated from JSON Schema.
        /// </summary>
        [DebuggerDisplay("{DebuggerDisplay,nq}")]
        public readonly partial struct TemporalOperandsEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TemporalOperandsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TemporalOperandsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TemporalOperandsEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TemporalOperandsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TemporalOperandsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TemporalOperandsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TemporalOperandsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly TemporalOperandsEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TemporalOperandsEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TemporalOperandsEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly TemporalOperandsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TemporalOperandsEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.TemporalOperands.TemporalOperandsEntity.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Cql2Benchmark.Current.Cql2Schema.TemporalOperands.TemporalOperandsEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Cql2Benchmark.Current.Cql2Schema.TemporalInstance.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TemporalOperandsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TemporalOperandsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TemporalOperandsEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TemporalOperandsEntity>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<TemporalOperandsEntity> Create<TContext>(
