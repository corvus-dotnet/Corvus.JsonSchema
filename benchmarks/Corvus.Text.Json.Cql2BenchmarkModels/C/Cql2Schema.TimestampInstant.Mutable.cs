...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct TimestampInstant
    {
...
#endif
        {
            ...
            public void SetTimestamp(in Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(in Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.Source arg1)
            {
                _createArg1 = arg1;
                _kind = Kind.Create;
            }
        ...
        public ref struct Builder
        {
            ...
            internal static void BuildCreateValue(in Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.Source arg1, ref ComplexValueBuilder o)
            {
                o.StartObject();
                Create(ref o, arg1);
                o.EndObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.Source timestamp)
        {
