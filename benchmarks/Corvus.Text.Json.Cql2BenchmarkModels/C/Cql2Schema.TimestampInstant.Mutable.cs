...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct TimestampInstant
    {
...
#endif
        {
            ...
            public void SetTimestamp(in Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.Source value)
            {
                ...
                else
                {
                    ...
                    value.AddAsProperty(JsonPropertyNamesEscaped.Timestamp, ref cvb, escapeName: false, nameRequiresUnescaping: false);
        ...
        public ref struct Builder
        {
            ...
            {
                timestamp.AddAsProperty(JsonPropertyNamesEscaped.Timestamp, ref builder, escapeName: false);
            }
