...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct TimestampInstant
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TimestampInstant instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TimestampInstant"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TimestampInstant(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.Mutable Timestamp
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TimestampUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetTimestamp(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TimestampInstant.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly TimestampInstant Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TimestampInstant Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TimestampInstant>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.Source _createArg1;
            ...
            internal Source(Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampInstant.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.Source arg1)
            {
                _createArg1 = arg1;
                _kind = Kind.Create;
            }

            public static implicit operator Source(TimestampInstant instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampInstant.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="TimestampInstant"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.Source timestamp)
            {
            ...
            /// Creates an instance of a <see cref="TimestampInstant"/>.
            /// </summary>
            public void Create(in Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.Source timestamp)
            {
                Create(ref _builder, timestamp);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.Source arg1, ref ComplexValueBuilder o)
            {
                o.StartObject();
                Create(ref o, arg1);
                o.EndObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.Source timestamp)
        {
            return new Source(timestamp);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.Source timestamp, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(timestamp);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<TimestampInstant, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TimestampInstant> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TimestampInstant>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<TimestampInstant> Create<TContext>(
        ...
        public static ParsedJsonDocument<TimestampInstant> Create(in Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString.Source timestamp, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
