...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct TimestampInstant
#if NET8_0_OR_GREATER
        : IJsonElement<TimestampInstant>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TimestampInstant"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TimestampInstant(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TimestampInstant DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString Timestamp
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TimestampUtf8, out Corvus.Cql2Benchmark.Current.Cql2Schema.TimestampString value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in TimestampInstant left, in TimestampInstant right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TimestampInstant left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(TimestampInstant instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TimestampInstant(JsonElement instance)
        {
            return TimestampInstant.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TimestampInstant From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TimestampInstant ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TimestampInstant>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TimestampInstant ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TimestampInstant>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TimestampInstant ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TimestampInstant>(json, options);
        }
        ...
        /// </exception>
        public static TimestampInstant ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<TimestampInstant>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TimestampInstant? result)
        {
            return JsonElementHelpers.TryParseValue<TimestampInstant>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TimestampInstant(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static TimestampInstant IJsonElement<TimestampInstant>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TimestampInstant: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TimestampInstant"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TimestampInstant"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public TimestampInstant Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TimestampInstant>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TimestampInstant"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public TimestampInstant Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TimestampInstant>(_idx);
            }
