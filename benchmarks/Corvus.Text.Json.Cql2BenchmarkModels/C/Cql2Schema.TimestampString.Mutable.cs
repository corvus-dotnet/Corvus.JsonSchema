...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct TimestampString
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TimestampString instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TimestampString"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TimestampString(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TimestampString.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly TimestampString Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TimestampString Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TimestampString>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TimestampString instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TimestampString, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TimestampString> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TimestampString>();
            }
            finally
            {
