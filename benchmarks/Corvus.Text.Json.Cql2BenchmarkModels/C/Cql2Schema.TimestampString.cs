...
public readonly partial struct Cql2Schema
{
    ...
    public readonly partial struct TimestampString
#if NET8_0_OR_GREATER
        : IJsonElement<TimestampString>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TimestampString"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TimestampString(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TimestampString DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(TimestampString value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in TimestampString left, in TimestampString right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TimestampString left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(TimestampString instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TimestampString(JsonElement instance)
        {
            return TimestampString.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TimestampString From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TimestampString ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TimestampString>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TimestampString ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TimestampString>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TimestampString ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TimestampString>(json, options);
        }
        ...
        /// </exception>
        public static TimestampString ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<TimestampString>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TimestampString? result)
        {
            return JsonElementHelpers.TryParseValue<TimestampString>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TimestampString(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static TimestampString IJsonElement<TimestampString>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TimestampString: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TimestampString"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TimestampString"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public TimestampString Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TimestampString>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TimestampString"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public TimestampString Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TimestampString>(_idx);
            }
