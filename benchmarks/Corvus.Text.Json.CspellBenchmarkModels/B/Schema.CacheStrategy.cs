...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CacheStrategy
#if NET8_0_OR_GREATER
        : IJsonElement<CacheStrategy>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CacheStrategy"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal CacheStrategy(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static CacheStrategy DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(CacheStrategy value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in CacheStrategy left, in CacheStrategy right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in CacheStrategy left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(CacheStrategy instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator CacheStrategy(JsonElement instance)
        {
            return CacheStrategy.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CacheStrategy From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CacheStrategy ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CacheStrategy>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CacheStrategy ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CacheStrategy>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CacheStrategy ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CacheStrategy>(json, options);
        }
        ...
        /// </exception>
        public static CacheStrategy ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<CacheStrategy>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out CacheStrategy? result)
        {
            return JsonElementHelpers.TryParseValue<CacheStrategy>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new CacheStrategy(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static CacheStrategy IJsonElement<CacheStrategy>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"CacheStrategy: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="CacheStrategy"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="CacheStrategy"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public CacheStrategy Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<CacheStrategy>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="CacheStrategy"/> that lives for the lifetime of its
        ...
        /// <param name="matchMetadata">Match 1st item.</param>
        /// <param name="matchContent">Match 2nd item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchMetadata,
            Func<TContext, TResult> matchContent,
