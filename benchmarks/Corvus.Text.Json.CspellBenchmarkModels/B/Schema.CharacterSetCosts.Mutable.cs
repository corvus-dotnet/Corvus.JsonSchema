...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CharacterSetCosts
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Baseline.JsonString.Mutable Characters
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CharactersUtf8, out Corvus.CspellBenchmark.Baseline.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Baseline.JsonNumber.Mutable Cost
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CostUtf8, out Corvus.CspellBenchmark.Baseline.JsonNumber.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetCharacters(in Corvus.CspellBenchmark.Baseline.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCost(in Corvus.CspellBenchmark.Baseline.JsonNumber.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CspellBenchmark.Baseline.Schema.CharacterSetCosts.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Baseline.Schema.CharacterSetCosts.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.CspellBenchmark.Baseline.JsonString.Source characters,
                in Corvus.CspellBenchmark.Baseline.JsonNumber.Source cost,
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CspellBenchmark.Baseline.JsonString.Source characters, in Corvus.CspellBenchmark.Baseline.JsonNumber.Source cost, in Corvus.CspellBenchmark.Baseline.JsonNumber.Source penalty = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
