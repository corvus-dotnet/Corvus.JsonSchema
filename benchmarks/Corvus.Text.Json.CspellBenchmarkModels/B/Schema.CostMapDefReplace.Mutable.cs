...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CostMapDefReplace
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(CostMapDefReplace instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CostMapDefReplace"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CostMapDefReplace(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Baseline.JsonNumber.Mutable InsDel
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InsDelUtf8, out Corvus.CspellBenchmark.Baseline.JsonNumber.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Baseline.JsonString.Mutable Map
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MapUtf8, out Corvus.CspellBenchmark.Baseline.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Baseline.JsonNumber.Mutable Penalty
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PenaltyUtf8, out Corvus.CspellBenchmark.Baseline.JsonNumber.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Baseline.JsonNumber.Mutable Replace
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReplaceUtf8, out Corvus.CspellBenchmark.Baseline.JsonNumber.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Baseline.JsonNumber.Mutable Swap
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SwapUtf8, out Corvus.CspellBenchmark.Baseline.JsonNumber.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new CostMapDefReplace(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetInsDel(in Corvus.CspellBenchmark.Baseline.JsonNumber.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.InsDelUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.InsDel, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>insDel</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveInsDel()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.InsDelUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetMap(in Corvus.CspellBenchmark.Baseline.JsonString.Source value)
            {
                CheckValidInstance();
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.Map, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetPenalty(in Corvus.CspellBenchmark.Baseline.JsonNumber.Source value)
            {
                CheckValidInstance();
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.Penalty, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetReplace(in Corvus.CspellBenchmark.Baseline.JsonNumber.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("replace");
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetSwap(in Corvus.CspellBenchmark.Baseline.JsonNumber.Source value)
            {
                CheckValidInstance();
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.Swap, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CostMapDefReplace.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="CostMapDefReplace"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="CostMapDefReplace"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly CostMapDefReplace Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<CostMapDefReplace>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="CostMapDefReplace"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly CostMapDefReplace Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CostMapDefReplace>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CspellBenchmark.Baseline.Schema.CostMapDefReplace.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Baseline.Schema.CostMapDefReplace.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="CostMapDefReplace"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.CspellBenchmark.Baseline.JsonString.Source map,
                in Corvus.CspellBenchmark.Baseline.JsonNumber.Source replace,
                in Corvus.CspellBenchmark.Baseline.JsonString.Source description = default,
                in Corvus.CspellBenchmark.Baseline.JsonNumber.Source insDel = default,
                in Corvus.CspellBenchmark.Baseline.JsonNumber.Source penalty = default,
                in Corvus.CspellBenchmark.Baseline.JsonNumber.Source swap = default)
            {
                map.AddAsProperty(JsonPropertyNamesEscaped.Map, ref builder, escapeName: false);
                ...
                insDel.AddAsProperty(JsonPropertyNamesEscaped.InsDel, ref builder, escapeName: false);
                penalty.AddAsProperty(JsonPropertyNamesEscaped.Penalty, ref builder, escapeName: false);
                swap.AddAsProperty(JsonPropertyNamesEscaped.Swap, ref builder, escapeName: false);
            }
            ...
            public void Create(
                ...
                in Corvus.CspellBenchmark.Baseline.JsonNumber.Source swap = default)
            {
                Create(ref _builder, map, replace, description, insDel, penalty, swap);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CspellBenchmark.Baseline.JsonString.Source map, in Corvus.CspellBenchmark.Baseline.JsonNumber.Source replace, in Corvus.CspellBenchmark.Baseline.JsonString.Source description = default, in Corvus.CspellBenchmark.Baseline.JsonNumber.Source insDel = default, in Corvus.CspellBenchmark.Baseline.JsonNumber.Source penalty = default, in Corvus.CspellBenchmark.Baseline.JsonNumber.Source swap = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(map, replace, description, insDel, penalty, swap);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<CostMapDefReplace, Mutable>(this);
        }
    }
}
