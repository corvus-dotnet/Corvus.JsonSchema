    ...
    public readonly partial struct DictionaryDefinitionCustom
    {
        ...
        public readonly partial struct ScopeEntity
        {
...
#endif
            {
                ...
                public Corvus.CspellBenchmark.Baseline.Schema.CustomDictionaryScope this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Baseline.Schema.CustomDictionaryScope>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.CustomDictionaryScope> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.CustomDictionaryScope>(_parent, _idx);
                }
