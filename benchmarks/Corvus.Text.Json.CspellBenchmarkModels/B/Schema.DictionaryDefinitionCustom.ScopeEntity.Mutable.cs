...
public readonly partial struct Schema
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct DictionaryDefinitionCustom
    {
        /// <summary>
        /// Generated from JSON Schema.
        /// </summary>
        ...
        public readonly partial struct ScopeEntity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Conversion to <see cref="Corvus.CspellBenchmark.Baseline.Schema.CustomDictionaryScope"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.CspellBenchmark.Baseline.Schema.CustomDictionaryScope.Mutable(Mutable value)
                {
                    return Corvus.CspellBenchmark.Baseline.Schema.CustomDictionaryScope.Mutable.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.CspellBenchmark.Baseline.Schema.CustomDictionaryScope"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.CspellBenchmark.Baseline.Schema.CustomDictionaryScope.Mutable value)
                {
                    return From(value);
                }

                /// <summary>
                /// Conversion to <see cref="Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray.Mutable(Mutable value)
                {
                    return Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray.Mutable.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray.Mutable value)
                {
                    return From(value);
                }
                ...
                public static explicit operator Mutable(ScopeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ScopeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ScopeEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ScopeEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ScopeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// <summary>
                /// Gets a <see cref="ScopeEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ScopeEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ScopeEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ScopeEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ScopeEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ScopeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ScopeEntity>(_idx);
                }
                ...
                /// <param name="matchCustomDictionaryScope">Match a <see cref="Corvus.CspellBenchmark.Baseline.Schema.CustomDictionaryScope"/>.</param>
                /// <param name="matchCustomDictionaryScopeArray">Match a <see cref="Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray"/>.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.CspellBenchmark.Baseline.Schema.CustomDictionaryScope, TContext, TResult> matchCustomDictionaryScope,
                    Matcher<Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray, TContext, TResult> matchCustomDictionaryScopeArray,
                    Matcher<Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionCustom.ScopeEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    if (Corvus.CspellBenchmark.Baseline.Schema.CustomDictionaryScope.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCustomDictionaryScope(Corvus.CspellBenchmark.Baseline.Schema.CustomDictionaryScope.Mutable.From(this), context);
                    }

                    if (Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCustomDictionaryScopeArray(Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.CspellBenchmark.Baseline.Schema.CustomDictionaryScope, TResult> matchCustomDictionaryScope,
                    Matcher<Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray, TResult> matchCustomDictionaryScopeArray,
                    Matcher<Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionCustom.ScopeEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.CspellBenchmark.Baseline.Schema.CustomDictionaryScope.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCustomDictionaryScope(Corvus.CspellBenchmark.Baseline.Schema.CustomDictionaryScope.Mutable.From(this));
                    }

                    if (Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCustomDictionaryScopeArray(Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray.Mutable.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.CspellBenchmark.Baseline.Schema.CustomDictionaryScope" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsCustomDictionaryScope(out Corvus.CspellBenchmark.Baseline.Schema.CustomDictionaryScope result)
                {
                    if (Corvus.CspellBenchmark.Baseline.Schema.CustomDictionaryScope.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.CspellBenchmark.Baseline.Schema.CustomDictionaryScope.Mutable.From(this);
                        return true;
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsCustomDictionaryScopeArray(out Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray result)
                {
                    if (Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionCustom.ScopeEntity.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(ScopeEntity instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.CspellBenchmark.Baseline.Schema.CustomDictionaryScope instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionCustom.ScopeEntity.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<ScopeEntity, Mutable>(this);
            }
        }
    }
}
