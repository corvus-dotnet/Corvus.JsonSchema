...
public readonly partial struct Schema
{
    ...
    public readonly partial struct DictionaryInformation
    {
...
#endif
        {
            ...
            public Corvus.CspellBenchmark.Baseline.Schema.PatternAdjustment this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Baseline.Schema.PatternAdjustment>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.PatternAdjustment> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.PatternAdjustment>(_parent, _idx);
            }
