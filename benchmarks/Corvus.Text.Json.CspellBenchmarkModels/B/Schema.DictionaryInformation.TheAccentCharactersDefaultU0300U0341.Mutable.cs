    ...
    public readonly partial struct DictionaryInformation
    {
        ...
        public readonly partial struct TheAccentCharactersDefaultU0300U0341
        {
...
#endif
            {
                ...
                /// <summary>
                /// Conversion to <see cref="Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAccentCharactersDefaultU0300U0341.CharacterSetCostsArray"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAccentCharactersDefaultU0300U0341.CharacterSetCostsArray.Mutable(Mutable value)
                {
                    return Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAccentCharactersDefaultU0300U0341.CharacterSetCostsArray.Mutable.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAccentCharactersDefaultU0300U0341.CharacterSetCostsArray"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAccentCharactersDefaultU0300U0341.CharacterSetCostsArray.Mutable value)
                {
                    return From(value);
                }
                ...
                /// <param name="matchCharacterSetCostsArray">Match a <see cref="Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAccentCharactersDefaultU0300U0341.CharacterSetCostsArray"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAccentCharactersDefaultU0300U0341.CharacterSetCostsArray, TContext, TResult> matchCharacterSetCostsArray,
                    Matcher<Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAccentCharactersDefaultU0300U0341.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    ...
                    {
                        return matchJsonString(Corvus.CspellBenchmark.Baseline.JsonString.Mutable.From(this), context);
                    }

                    if (Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAccentCharactersDefaultU0300U0341.CharacterSetCostsArray.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCharacterSetCostsArray(Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAccentCharactersDefaultU0300U0341.CharacterSetCostsArray.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAccentCharactersDefaultU0300U0341.CharacterSetCostsArray, TResult> matchCharacterSetCostsArray,
                    Matcher<Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAccentCharactersDefaultU0300U0341.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.CspellBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonString(Corvus.CspellBenchmark.Baseline.JsonString.Mutable.From(this));
                    }

                    if (Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAccentCharactersDefaultU0300U0341.CharacterSetCostsArray.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCharacterSetCostsArray(Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAccentCharactersDefaultU0300U0341.CharacterSetCostsArray.Mutable.From(this));
                    }
                ...
                public bool TryGetAsJsonString(out Corvus.CspellBenchmark.Baseline.JsonString result)
                {
                    if (Corvus.CspellBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.CspellBenchmark.Baseline.JsonString.Mutable.From(this);
                        return true;
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAccentCharactersDefaultU0300U0341.CharacterSetCostsArray" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsCharacterSetCostsArray(out Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAccentCharactersDefaultU0300U0341.CharacterSetCostsArray result)
                {
                    if (Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAccentCharactersDefaultU0300U0341.CharacterSetCostsArray.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAccentCharactersDefaultU0300U0341.CharacterSetCostsArray.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAccentCharactersDefaultU0300U0341.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.CspellBenchmark.Baseline.JsonString instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAccentCharactersDefaultU0300U0341.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
