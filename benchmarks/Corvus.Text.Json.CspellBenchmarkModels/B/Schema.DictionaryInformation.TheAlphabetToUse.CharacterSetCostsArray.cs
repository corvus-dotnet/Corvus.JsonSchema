    ...
    public readonly partial struct DictionaryInformation
    {
        ...
        public readonly partial struct TheAlphabetToUse
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="CharacterSetCostsArray"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal CharacterSetCostsArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static CharacterSetCostsArray DefaultInstance { get; }
                ...
                public Corvus.CspellBenchmark.Baseline.Schema.CharacterSetCosts this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Baseline.Schema.CharacterSetCosts>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.CharacterSetCosts> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.CharacterSetCosts>(_parent, _idx);
                }
                ...
                /// </returns>
                public static bool operator ==(in CharacterSetCostsArray left, in CharacterSetCostsArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in CharacterSetCostsArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(CharacterSetCostsArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CharacterSetCostsArray(JsonElement instance)
                {
                    return CharacterSetCostsArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CharacterSetCostsArray From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CharacterSetCostsArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<CharacterSetCostsArray>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CharacterSetCostsArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<CharacterSetCostsArray>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CharacterSetCostsArray ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<CharacterSetCostsArray>(json, options);
                }
                ...
                /// </exception>
                public static CharacterSetCostsArray ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<CharacterSetCostsArray>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out CharacterSetCostsArray? result)
                {
                    return JsonElementHelpers.TryParseValue<CharacterSetCostsArray>(ref reader, out result);
                }
...
#if NET
                static CharacterSetCostsArray IJsonElement<CharacterSetCostsArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CharacterSetCostsArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public CharacterSetCostsArray Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public CharacterSetCostsArray Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<CharacterSetCostsArray>(_idx);
                    }
