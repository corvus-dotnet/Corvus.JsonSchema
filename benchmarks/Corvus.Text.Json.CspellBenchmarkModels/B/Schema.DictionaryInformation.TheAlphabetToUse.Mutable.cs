    ...
    public readonly partial struct DictionaryInformation
    {
        ...
        public readonly partial struct TheAlphabetToUse
        {
...
#endif
            {
                ...
                public static explicit operator Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.Mutable(Mutable value)
                {
                    return Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.Mutable value)
                {
                    return From(value);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAlphabetToUse.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    ...
                    {
                        return matchCharacterSetCostsArray(Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAlphabetToUse.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.CspellBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                    ...
                    if (Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCharacterSetCostsArray(Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.Mutable.From(this));
                    }
                ...
                public bool TryGetAsCharacterSetCostsArray(out Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray result)
                {
                    if (Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAlphabetToUse.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CspellBenchmark.Baseline.Schema.DictionaryInformation.TheAlphabetToUse.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
