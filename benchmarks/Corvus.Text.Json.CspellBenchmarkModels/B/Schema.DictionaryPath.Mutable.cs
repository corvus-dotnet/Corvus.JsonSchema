...
public readonly partial struct Schema
{
    ...
    public readonly partial struct DictionaryPath
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DictionaryPath instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DictionaryPath"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DictionaryPath(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DictionaryPath.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly DictionaryPath Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly DictionaryPath Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DictionaryPath>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(DictionaryPath instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<DictionaryPath, Mutable>(this);
        }
    }
}
