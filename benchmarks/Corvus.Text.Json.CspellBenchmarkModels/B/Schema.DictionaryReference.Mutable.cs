...
public readonly partial struct Schema
{
    ...
    public readonly partial struct DictionaryReference
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.CspellBenchmark.Baseline.Schema.DictionaryId.Mutable(Mutable value)
            {
                return Corvus.CspellBenchmark.Baseline.Schema.DictionaryId.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.CspellBenchmark.Baseline.Schema.DictionaryId.Mutable value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.CspellBenchmark.Baseline.Schema.DictionaryNegRef.Mutable(Mutable value)
            {
                return Corvus.CspellBenchmark.Baseline.Schema.DictionaryNegRef.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.CspellBenchmark.Baseline.Schema.DictionaryNegRef.Mutable value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.DictionaryReference.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchDictionaryId(Corvus.CspellBenchmark.Baseline.Schema.DictionaryId.Mutable.From(this), context);
                }

                if (Corvus.CspellBenchmark.Baseline.Schema.DictionaryNegRef.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchDictionaryNegRef(Corvus.CspellBenchmark.Baseline.Schema.DictionaryNegRef.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.DictionaryReference.Mutable, TResult> defaultMatch)
            {
                if (Corvus.CspellBenchmark.Baseline.Schema.DictionaryId.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchDictionaryId(Corvus.CspellBenchmark.Baseline.Schema.DictionaryId.Mutable.From(this));
                }

                if (Corvus.CspellBenchmark.Baseline.Schema.DictionaryNegRef.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchDictionaryNegRef(Corvus.CspellBenchmark.Baseline.Schema.DictionaryNegRef.Mutable.From(this));
                }
            ...
            public bool TryGetAsDictionaryId(out Corvus.CspellBenchmark.Baseline.Schema.DictionaryId result)
            {
                if (Corvus.CspellBenchmark.Baseline.Schema.DictionaryId.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Baseline.Schema.DictionaryId.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsDictionaryNegRef(out Corvus.CspellBenchmark.Baseline.Schema.DictionaryNegRef result)
            {
                if (Corvus.CspellBenchmark.Baseline.Schema.DictionaryNegRef.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Baseline.Schema.DictionaryNegRef.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.CspellBenchmark.Baseline.Schema.DictionaryId instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.CspellBenchmark.Baseline.Schema.DictionaryNegRef instance) => new(JsonElement.From(instance));
