    ...
    public readonly partial struct EditCosts
    {
        ...
        public readonly partial struct CapsCostsEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(CapsCostsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CapsCostsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CapsCostsEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CapsCostsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly CapsCostsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly CapsCostsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CapsCostsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(CapsCostsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<CapsCostsEntity, Mutable>(this);
            }
        }
    }
}
