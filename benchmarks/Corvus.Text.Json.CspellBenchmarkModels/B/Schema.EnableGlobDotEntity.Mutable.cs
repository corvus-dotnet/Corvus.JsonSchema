...
public readonly partial struct Schema
{
    ...
    public readonly partial struct EnableGlobDotEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(EnableGlobDotEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EnableGlobDotEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnableGlobDotEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new EnableGlobDotEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnableGlobDotEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="EnableGlobDotEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="EnableGlobDotEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly EnableGlobDotEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<EnableGlobDotEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="EnableGlobDotEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly EnableGlobDotEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EnableGlobDotEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EnableGlobDotEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<EnableGlobDotEntity, Mutable>(this);
        }
    }
}
