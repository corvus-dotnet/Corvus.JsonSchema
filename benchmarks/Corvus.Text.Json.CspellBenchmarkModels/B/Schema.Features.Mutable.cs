...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Features
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Features instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Features"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Features(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Baseline.JsonBoolean.Mutable WeightedSuggestions
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WeightedSuggestionsUtf8, out Corvus.CspellBenchmark.Baseline.JsonBoolean.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetWeightedSuggestions(in Corvus.CspellBenchmark.Baseline.JsonBoolean.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.WeightedSuggestionsUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WeightedSuggestionsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsProperty(JsonPropertyNamesEscaped.WeightedSuggestions, ref cvb, escapeName: false, nameRequiresUnescaping: false);
            ...
            /// <summary>
            /// Remove the <c>weighted-suggestions</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveWeightedSuggestions()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.WeightedSuggestionsUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Features.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Features Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly Features Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Features>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CspellBenchmark.Baseline.Schema.Features.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(Features instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Baseline.Schema.Features.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Features"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.CspellBenchmark.Baseline.JsonBoolean.Source weightedSuggestions = default)
            {
                weightedSuggestions.AddAsProperty(JsonPropertyNamesEscaped.WeightedSuggestions, ref builder, escapeName: false);
            }

            /// <summary>
            /// Creates an instance of a <see cref="Features"/>.
            /// </summary>
            public void Create(in Corvus.CspellBenchmark.Baseline.JsonBoolean.Source weightedSuggestions = default)
            {
                Create(ref _builder, weightedSuggestions);
            }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="weightedSuggestions">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CspellBenchmark.Baseline.JsonBoolean.Source weightedSuggestions = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(weightedSuggestions);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<Features, Mutable>(this);
        }
    }
}
