...
public readonly partial struct Schema
{
    ...
    public readonly partial struct GitignoreRootEntity
#if NET8_0_OR_GREATER
        : IJsonElement<GitignoreRootEntity>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GitignoreRootEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal GitignoreRootEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static GitignoreRootEntity DefaultInstance { get; }
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.CspellBenchmark.Baseline.Schema.GitignoreRootEntity.JsonStringArray"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.CspellBenchmark.Baseline.Schema.GitignoreRootEntity.JsonStringArray(GitignoreRootEntity value)
        {
            return Corvus.CspellBenchmark.Baseline.Schema.GitignoreRootEntity.JsonStringArray.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.CspellBenchmark.Baseline.Schema.GitignoreRootEntity.JsonStringArray"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator GitignoreRootEntity(Corvus.CspellBenchmark.Baseline.Schema.GitignoreRootEntity.JsonStringArray value)
        {
            return From(value);
        }
        ...
        /// </returns>
        public static bool operator ==(in GitignoreRootEntity left, in GitignoreRootEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in GitignoreRootEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(GitignoreRootEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GitignoreRootEntity(JsonElement instance)
        {
            return GitignoreRootEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GitignoreRootEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GitignoreRootEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GitignoreRootEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GitignoreRootEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GitignoreRootEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GitignoreRootEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GitignoreRootEntity>(json, options);
        }
        ...
        /// </exception>
        public static GitignoreRootEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<GitignoreRootEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out GitignoreRootEntity? result)
        {
            return JsonElementHelpers.TryParseValue<GitignoreRootEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GitignoreRootEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static GitignoreRootEntity IJsonElement<GitignoreRootEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GitignoreRootEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GitignoreRootEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GitignoreRootEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public GitignoreRootEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GitignoreRootEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GitignoreRootEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public GitignoreRootEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<GitignoreRootEntity>(_idx);
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.CspellBenchmark.Baseline.Schema.GitignoreRootEntity.JsonStringArray" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsJsonStringArray(out Corvus.CspellBenchmark.Baseline.Schema.GitignoreRootEntity.JsonStringArray result)
        {
            if (Corvus.CspellBenchmark.Baseline.Schema.GitignoreRootEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.CspellBenchmark.Baseline.Schema.GitignoreRootEntity.JsonStringArray.From(this);
                return true;
            }
        ...
        /// <param name="matchJsonStringArray">Match a <see cref="Corvus.CspellBenchmark.Baseline.Schema.GitignoreRootEntity.JsonStringArray"/>.</param>
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.CspellBenchmark.Baseline.Schema.GitignoreRootEntity.JsonStringArray, TContext, TResult> matchJsonStringArray,
            Matcher<Corvus.CspellBenchmark.Baseline.Schema.GitignoreRootEntity, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            if (Corvus.CspellBenchmark.Baseline.Schema.GitignoreRootEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonStringArray(Corvus.CspellBenchmark.Baseline.Schema.GitignoreRootEntity.JsonStringArray.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.CspellBenchmark.Baseline.Schema.GitignoreRootEntity.JsonStringArray, TResult> matchJsonStringArray,
            Matcher<Corvus.CspellBenchmark.Baseline.Schema.GitignoreRootEntity, TResult> defaultMatch)
        {
            if (Corvus.CspellBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            if (Corvus.CspellBenchmark.Baseline.Schema.GitignoreRootEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonStringArray(Corvus.CspellBenchmark.Baseline.Schema.GitignoreRootEntity.JsonStringArray.From(this));
            }
