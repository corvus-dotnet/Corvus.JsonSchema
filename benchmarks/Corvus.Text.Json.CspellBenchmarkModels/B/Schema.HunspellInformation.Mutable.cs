...
public readonly partial struct Schema
{
    ...
    public readonly partial struct HunspellInformation
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(HunspellInformation instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="HunspellInformation"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator HunspellInformation(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Baseline.JsonString.Mutable Aff
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AffUtf8, out Corvus.CspellBenchmark.Baseline.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Baseline.Schema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings.Mutable Costs
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CostsUtf8, out Corvus.CspellBenchmark.Baseline.Schema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new HunspellInformation(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetAff(in Corvus.CspellBenchmark.Baseline.JsonString.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("aff");
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AffUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsProperty(JsonPropertyNamesEscaped.Aff, ref cvb, escapeName: false, nameRequiresUnescaping: false);
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCosts(in Corvus.CspellBenchmark.Baseline.Schema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCosts<TContext>(in Corvus.CspellBenchmark.Baseline.Schema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings.Source<TContext> value)
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"HunspellInformation.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="HunspellInformation"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="HunspellInformation"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly HunspellInformation Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<HunspellInformation>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="HunspellInformation"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly HunspellInformation Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<HunspellInformation>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CspellBenchmark.Baseline.Schema.HunspellInformation.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(HunspellInformation instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Baseline.Schema.HunspellInformation.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="HunspellInformation"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.CspellBenchmark.Baseline.JsonString.Source aff,
                in Corvus.CspellBenchmark.Baseline.Schema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings.Source costs = default)
            {
                aff.AddAsProperty(JsonPropertyNamesEscaped.Aff, ref builder, escapeName: false);
            ...
            /// Creates an instance of a <see cref="HunspellInformation"/>.
            /// </summary>
            public void Create(in Corvus.CspellBenchmark.Baseline.JsonString.Source aff, in Corvus.CspellBenchmark.Baseline.Schema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings.Source costs = default)
            {
                Create(ref _builder, aff, costs);
            }
            ...
            internal static void Create<TContext>(
                ...
                ref ComplexValueBuilder builder,
                in Corvus.CspellBenchmark.Baseline.JsonString.Source aff,
                in Corvus.CspellBenchmark.Baseline.Schema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings.Source<TContext> costs = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            #endif
            {
                Create(context, ref _builder, aff, costs);
            }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="aff">The value of the property.</param>
        /// <param name="costs">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CspellBenchmark.Baseline.JsonString.Source aff, in Corvus.CspellBenchmark.Baseline.Schema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings.Source costs = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(aff, costs);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.CspellBenchmark.Baseline.JsonString.Source aff, in Corvus.CspellBenchmark.Baseline.Schema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings.Source<TContext> costs = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        {
            return workspace.CreateBuilder<HunspellInformation, Mutable>(this);
        }
    }
}
