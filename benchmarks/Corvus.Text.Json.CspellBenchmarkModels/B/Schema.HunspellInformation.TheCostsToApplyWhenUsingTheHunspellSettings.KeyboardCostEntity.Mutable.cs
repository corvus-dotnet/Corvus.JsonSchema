        ...
        public readonly partial struct TheCostsToApplyWhenUsingTheHunspellSettings
        {
            ...
            public readonly partial struct KeyboardCostEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(KeyboardCostEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="KeyboardCostEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator KeyboardCostEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"KeyboardCostEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly KeyboardCostEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly KeyboardCostEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<KeyboardCostEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(KeyboardCostEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<KeyboardCostEntity, Mutable>(this);
                }
            }
        }
    }
