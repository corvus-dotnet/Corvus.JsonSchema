...
public readonly partial struct Schema
{
    ...
    public readonly partial struct HunspellInformation
        ...
        : IJsonElement<HunspellInformation>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HunspellInformation"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal HunspellInformation(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static HunspellInformation DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CspellBenchmark.Baseline.JsonString Aff
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AffUtf8, out Corvus.CspellBenchmark.Baseline.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CspellBenchmark.Baseline.Schema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings Costs
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CostsUtf8, out Corvus.CspellBenchmark.Baseline.Schema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in HunspellInformation left, in HunspellInformation right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in HunspellInformation left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(HunspellInformation instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator HunspellInformation(JsonElement instance)
        {
            return HunspellInformation.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static HunspellInformation From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static HunspellInformation ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<HunspellInformation>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static HunspellInformation ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<HunspellInformation>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static HunspellInformation ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<HunspellInformation>(json, options);
        }
        ...
        /// </exception>
        public static HunspellInformation ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<HunspellInformation>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out HunspellInformation? result)
        {
            return JsonElementHelpers.TryParseValue<HunspellInformation>(ref reader, out result);
        }
...
#if NET
        static HunspellInformation IJsonElement<HunspellInformation>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"HunspellInformation: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public HunspellInformation Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public HunspellInformation Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<HunspellInformation>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="Aff"/>.
            /// </summary>
            public const string Aff = "aff";
            ...
            /// Gets the JSON property name for <see cref="Aff"/>.
            /// </summary>
            public static ReadOnlySpan<byte> AffUtf8 => "aff"u8;
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Aff"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Aff => "aff"u8;
