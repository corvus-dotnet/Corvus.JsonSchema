...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ImportEntity
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.CspellBenchmark.Baseline.Schema.ImportEntity.JsonStringArray.Mutable(Mutable value)
            {
                return Corvus.CspellBenchmark.Baseline.Schema.ImportEntity.JsonStringArray.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.CspellBenchmark.Baseline.Schema.ImportEntity.JsonStringArray.Mutable value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.ImportEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                ...
                {
                    return matchJsonStringArray(Corvus.CspellBenchmark.Baseline.Schema.ImportEntity.JsonStringArray.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.ImportEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.CspellBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.CspellBenchmark.Baseline.Schema.ImportEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.CspellBenchmark.Baseline.Schema.ImportEntity.JsonStringArray.Mutable.From(this));
                }
            ...
            public bool TryGetAsJsonStringArray(out Corvus.CspellBenchmark.Baseline.Schema.ImportEntity.JsonStringArray result)
            {
                if (Corvus.CspellBenchmark.Baseline.Schema.ImportEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Baseline.Schema.ImportEntity.JsonStringArray.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CspellBenchmark.Baseline.Schema.ImportEntity.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Baseline.Schema.ImportEntity.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
