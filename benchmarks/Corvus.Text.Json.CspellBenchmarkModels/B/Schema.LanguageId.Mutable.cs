...
public readonly partial struct Schema
{
    ...
    public readonly partial struct LanguageId
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.CspellBenchmark.Baseline.Schema.LanguageIdSingle.Mutable(Mutable value)
            {
                return Corvus.CspellBenchmark.Baseline.Schema.LanguageIdSingle.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.CspellBenchmark.Baseline.Schema.LanguageIdSingle.Mutable value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultiple.Mutable(Mutable value)
            {
                return Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultiple.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultiple.Mutable value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultipleNeg.Mutable(Mutable value)
            {
                return Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultipleNeg.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultipleNeg.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(LanguageId instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="LanguageId"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LanguageId(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LanguageId.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly LanguageId Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly LanguageId Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<LanguageId>(_idx);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.LanguageId.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchLanguageIdSingle(Corvus.CspellBenchmark.Baseline.Schema.LanguageIdSingle.Mutable.From(this), context);
                }

                if (Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultiple.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchLanguageIdMultiple(Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultiple.Mutable.From(this), context);
                }

                if (Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultipleNeg.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchLanguageIdMultipleNeg(Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultipleNeg.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.LanguageId.Mutable, TResult> defaultMatch)
            {
                if (Corvus.CspellBenchmark.Baseline.Schema.LanguageIdSingle.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchLanguageIdSingle(Corvus.CspellBenchmark.Baseline.Schema.LanguageIdSingle.Mutable.From(this));
                }

                if (Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultiple.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchLanguageIdMultiple(Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultiple.Mutable.From(this));
                }

                if (Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultipleNeg.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchLanguageIdMultipleNeg(Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultipleNeg.Mutable.From(this));
                }
            ...
            public bool TryGetAsLanguageIdMultiple(out Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultiple result)
            {
                if (Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultiple.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultiple.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsLanguageIdMultipleNeg(out Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultipleNeg result)
            {
                if (Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultipleNeg.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultipleNeg.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsLanguageIdSingle(out Corvus.CspellBenchmark.Baseline.Schema.LanguageIdSingle result)
            {
                if (Corvus.CspellBenchmark.Baseline.Schema.LanguageIdSingle.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Baseline.Schema.LanguageIdSingle.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(LanguageId instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultiple instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultipleNeg instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.CspellBenchmark.Baseline.Schema.LanguageIdSingle instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<LanguageId, Mutable>(this);
        }
    }
}
