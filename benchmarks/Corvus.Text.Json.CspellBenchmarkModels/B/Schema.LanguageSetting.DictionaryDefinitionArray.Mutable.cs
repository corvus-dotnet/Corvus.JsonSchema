    ...
    public readonly partial struct LanguageSetting
    {
        ...
        public readonly partial struct DictionaryDefinitionArray
        {
...
#endif
            {
                ...
                public Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinition.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinition.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinition.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinition.Mutable>(_parent, _idx);
                }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinition.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, in Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinition.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(in Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinition.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinition item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinition>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinition> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinition>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinition oldItem, in Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinition.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinition>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinition current = enumerator.Current;
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CspellBenchmark.Baseline.Schema.LanguageSetting.DictionaryDefinitionArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CspellBenchmark.Baseline.Schema.LanguageSetting.DictionaryDefinitionArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
