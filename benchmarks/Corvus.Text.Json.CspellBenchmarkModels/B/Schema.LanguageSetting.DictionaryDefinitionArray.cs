...
public readonly partial struct Schema
{
    ...
    public readonly partial struct LanguageSetting
    {
...
#endif
        {
            ...
            public Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinition this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinition>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinition> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinition>(_parent, _idx);
            }
