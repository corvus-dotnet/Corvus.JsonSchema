...
public readonly partial struct Schema
{
    ...
    public readonly partial struct LanguageSetting
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.CspellBenchmark.Baseline.Schema.LanguageSetting.LocaleEntity.JsonStringArray(LocaleEntity value)
            {
                return Corvus.CspellBenchmark.Baseline.Schema.LanguageSetting.LocaleEntity.JsonStringArray.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator LocaleEntity(Corvus.CspellBenchmark.Baseline.Schema.LanguageSetting.LocaleEntity.JsonStringArray value)
            {
                return From(value);
            }
            ...
            public bool TryGetAsJsonStringArray(out Corvus.CspellBenchmark.Baseline.Schema.LanguageSetting.LocaleEntity.JsonStringArray result)
            {
                ...
                {
                    result = Corvus.CspellBenchmark.Baseline.Schema.LanguageSetting.LocaleEntity.JsonStringArray.From(this);
                    return true;
                }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.LanguageSetting.LocaleEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                if (Corvus.CspellBenchmark.Baseline.Schema.LanguageSetting.LocaleEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.CspellBenchmark.Baseline.Schema.LanguageSetting.LocaleEntity.JsonStringArray.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.LanguageSetting.LocaleEntity, TResult> defaultMatch)
            {
                if (Corvus.CspellBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.CspellBenchmark.Baseline.Schema.LanguageSetting.LocaleEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.CspellBenchmark.Baseline.Schema.LanguageSetting.LocaleEntity.JsonStringArray.From(this));
                }
