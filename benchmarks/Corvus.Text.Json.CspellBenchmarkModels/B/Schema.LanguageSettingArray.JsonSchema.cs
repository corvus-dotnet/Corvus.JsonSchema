...
public readonly partial struct Schema
{
        ...
        : IJsonElement<LanguageSettingArray>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("cspell-schema.json#/properties/languageSettings"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "cspell-schema.json#/properties/languageSettings";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "cspell-schema.json#/properties/languageSettings"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (arrayValidation_enumerator.MoveNext())
                    {
                        ...
                        JsonSchemaContext childContext = Corvus.CspellBenchmark.Baseline.Schema.LanguageSetting.JsonSchema.PushChildContext(
                            parentDocument,
                        ...
                        Corvus.CspellBenchmark.Baseline.Schema.LanguageSetting.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
