...
public readonly partial struct Schema
{
    ...
    public readonly partial struct LoadDefaultConfigurationEntity
#if NET8_0_OR_GREATER
        : IJsonElement<LoadDefaultConfigurationEntity>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoadDefaultConfigurationEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal LoadDefaultConfigurationEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static LoadDefaultConfigurationEntity DefaultInstance { get; } = ParsedJsonDocument<LoadDefaultConfigurationEntity>.True;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(LoadDefaultConfigurationEntity value)
        {
        ...
        /// </returns>
        public static bool operator ==(in LoadDefaultConfigurationEntity left, in LoadDefaultConfigurationEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in LoadDefaultConfigurationEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(LoadDefaultConfigurationEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator LoadDefaultConfigurationEntity(JsonElement instance)
        {
            return LoadDefaultConfigurationEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LoadDefaultConfigurationEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LoadDefaultConfigurationEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<LoadDefaultConfigurationEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LoadDefaultConfigurationEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<LoadDefaultConfigurationEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LoadDefaultConfigurationEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<LoadDefaultConfigurationEntity>(json, options);
        }
        ...
        /// </exception>
        public static LoadDefaultConfigurationEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<LoadDefaultConfigurationEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out LoadDefaultConfigurationEntity? result)
        {
            return JsonElementHelpers.TryParseValue<LoadDefaultConfigurationEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new LoadDefaultConfigurationEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static LoadDefaultConfigurationEntity IJsonElement<LoadDefaultConfigurationEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"LoadDefaultConfigurationEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="LoadDefaultConfigurationEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="LoadDefaultConfigurationEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public LoadDefaultConfigurationEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<LoadDefaultConfigurationEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="LoadDefaultConfigurationEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public LoadDefaultConfigurationEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<LoadDefaultConfigurationEntity>(_idx);
            }
