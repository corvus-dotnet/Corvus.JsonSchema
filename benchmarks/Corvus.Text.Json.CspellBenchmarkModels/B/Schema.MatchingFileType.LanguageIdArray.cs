...
public readonly partial struct Schema
{
    ...
    public readonly partial struct MatchingFileType
    {
...
#endif
        {
            ...
            public Corvus.CspellBenchmark.Baseline.Schema.LanguageId this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Baseline.Schema.LanguageId>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.LanguageId> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.LanguageId>(_parent, _idx);
            }
