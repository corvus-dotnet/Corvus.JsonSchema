...
public readonly partial struct Schema
{
    ...
    public readonly partial struct MatchingFileType
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.CspellBenchmark.Baseline.Schema.LanguageId.Mutable(Mutable value)
            {
                return Corvus.CspellBenchmark.Baseline.Schema.LanguageId.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.CspellBenchmark.Baseline.Schema.LanguageId.Mutable value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.CspellBenchmark.Baseline.Schema.MatchingFileType.LanguageIdArray.Mutable(Mutable value)
            {
                return Corvus.CspellBenchmark.Baseline.Schema.MatchingFileType.LanguageIdArray.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.CspellBenchmark.Baseline.Schema.MatchingFileType.LanguageIdArray.Mutable value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.MatchingFileType.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                ...
                {
                    return matchLanguageId(Corvus.CspellBenchmark.Baseline.Schema.LanguageId.Mutable.From(this), context);
                }

                if (Corvus.CspellBenchmark.Baseline.Schema.MatchingFileType.LanguageIdArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchLanguageIdArray(Corvus.CspellBenchmark.Baseline.Schema.MatchingFileType.LanguageIdArray.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.MatchingFileType.Mutable, TResult> defaultMatch)
            {
                if (Corvus.CspellBenchmark.Baseline.Schema.LanguageId.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchLanguageId(Corvus.CspellBenchmark.Baseline.Schema.LanguageId.Mutable.From(this));
                }

                if (Corvus.CspellBenchmark.Baseline.Schema.MatchingFileType.LanguageIdArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchLanguageIdArray(Corvus.CspellBenchmark.Baseline.Schema.MatchingFileType.LanguageIdArray.Mutable.From(this));
                }
            ...
            public bool TryGetAsLanguageId(out Corvus.CspellBenchmark.Baseline.Schema.LanguageId result)
            {
                if (Corvus.CspellBenchmark.Baseline.Schema.LanguageId.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Baseline.Schema.LanguageId.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsLanguageIdArray(out Corvus.CspellBenchmark.Baseline.Schema.MatchingFileType.LanguageIdArray result)
            {
                if (Corvus.CspellBenchmark.Baseline.Schema.MatchingFileType.LanguageIdArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Baseline.Schema.MatchingFileType.LanguageIdArray.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CspellBenchmark.Baseline.Schema.MatchingFileType.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.CspellBenchmark.Baseline.Schema.LanguageId instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Baseline.Schema.MatchingFileType.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
