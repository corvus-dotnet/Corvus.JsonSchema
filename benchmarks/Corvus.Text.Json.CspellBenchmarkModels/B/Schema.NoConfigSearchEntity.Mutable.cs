...
public readonly partial struct Schema
{
    ...
    public readonly partial struct NoConfigSearchEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(NoConfigSearchEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="NoConfigSearchEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NoConfigSearchEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"NoConfigSearchEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly NoConfigSearchEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly NoConfigSearchEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<NoConfigSearchEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(NoConfigSearchEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<NoConfigSearchEntity, Mutable>(this);
        }
    }
}
