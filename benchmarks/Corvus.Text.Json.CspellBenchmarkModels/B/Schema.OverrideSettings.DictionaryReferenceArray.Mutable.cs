...
public readonly partial struct Schema
{
    ...
    public readonly partial struct OverrideSettings
    {
        ...
        public readonly partial struct DictionaryReferenceArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DictionaryReferenceArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DictionaryReferenceArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DictionaryReferenceArray(Mutable instance)
                {
                ...
                public Corvus.CspellBenchmark.Baseline.Schema.DictionaryReference.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Baseline.Schema.DictionaryReference.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.DictionaryReference.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.DictionaryReference.Mutable>(_parent, _idx);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new DictionaryReferenceArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DictionaryReferenceArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.CspellBenchmark.Baseline.Schema.DictionaryReference.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, in Corvus.CspellBenchmark.Baseline.Schema.DictionaryReference.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(in Corvus.CspellBenchmark.Baseline.Schema.DictionaryReference.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.CspellBenchmark.Baseline.Schema.DictionaryReference item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.CspellBenchmark.Baseline.Schema.DictionaryReference>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.CspellBenchmark.Baseline.Schema.DictionaryReference> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.CspellBenchmark.Baseline.Schema.DictionaryReference>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.CspellBenchmark.Baseline.Schema.DictionaryReference oldItem, in Corvus.CspellBenchmark.Baseline.Schema.DictionaryReference.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.DictionaryReference>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.CspellBenchmark.Baseline.Schema.DictionaryReference current = enumerator.Current;
                ...
                /// <summary>
                /// Gets a <see cref="DictionaryReferenceArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="DictionaryReferenceArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly DictionaryReferenceArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<DictionaryReferenceArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="DictionaryReferenceArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly DictionaryReferenceArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DictionaryReferenceArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings.DictionaryReferenceArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(DictionaryReferenceArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings.DictionaryReferenceArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<DictionaryReferenceArray, Mutable>(this);
            }
        }
    }
}
