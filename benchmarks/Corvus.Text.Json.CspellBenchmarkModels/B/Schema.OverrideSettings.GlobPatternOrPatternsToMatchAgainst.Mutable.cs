...
public readonly partial struct Schema
{
    ...
    public readonly partial struct OverrideSettings
    {
        ...
        public readonly partial struct GlobPatternOrPatternsToMatchAgainst
        {
...
#endif
            {
                ...
                /// <summary>
                /// Conversion to <see cref="Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings.GlobPatternOrPatternsToMatchAgainst.JsonStringArray"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings.GlobPatternOrPatternsToMatchAgainst.JsonStringArray.Mutable(Mutable value)
                {
                    return Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings.GlobPatternOrPatternsToMatchAgainst.JsonStringArray.Mutable.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings.GlobPatternOrPatternsToMatchAgainst.JsonStringArray"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings.GlobPatternOrPatternsToMatchAgainst.JsonStringArray.Mutable value)
                {
                    return From(value);
                }
                ...
                public static explicit operator Mutable(GlobPatternOrPatternsToMatchAgainst instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="GlobPatternOrPatternsToMatchAgainst"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator GlobPatternOrPatternsToMatchAgainst(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new GlobPatternOrPatternsToMatchAgainst(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"GlobPatternOrPatternsToMatchAgainst.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// <summary>
                /// Gets a <see cref="GlobPatternOrPatternsToMatchAgainst"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="GlobPatternOrPatternsToMatchAgainst"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly GlobPatternOrPatternsToMatchAgainst Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<GlobPatternOrPatternsToMatchAgainst>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="GlobPatternOrPatternsToMatchAgainst"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly GlobPatternOrPatternsToMatchAgainst Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<GlobPatternOrPatternsToMatchAgainst>(_idx);
                }
                ...
                /// <param name="matchJsonStringArray">Match a <see cref="Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings.GlobPatternOrPatternsToMatchAgainst.JsonStringArray"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings.GlobPatternOrPatternsToMatchAgainst.JsonStringArray, TContext, TResult> matchJsonStringArray,
                    Matcher<Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings.GlobPatternOrPatternsToMatchAgainst.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    ...
                    if (Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings.GlobPatternOrPatternsToMatchAgainst.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonStringArray(Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings.GlobPatternOrPatternsToMatchAgainst.JsonStringArray.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings.GlobPatternOrPatternsToMatchAgainst.JsonStringArray, TResult> matchJsonStringArray,
                    Matcher<Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings.GlobPatternOrPatternsToMatchAgainst.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.CspellBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                    ...
                    if (Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings.GlobPatternOrPatternsToMatchAgainst.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonStringArray(Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings.GlobPatternOrPatternsToMatchAgainst.JsonStringArray.Mutable.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings.GlobPatternOrPatternsToMatchAgainst.JsonStringArray" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsJsonStringArray(out Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings.GlobPatternOrPatternsToMatchAgainst.JsonStringArray result)
                {
                    if (Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings.GlobPatternOrPatternsToMatchAgainst.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings.GlobPatternOrPatternsToMatchAgainst.JsonStringArray.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings.GlobPatternOrPatternsToMatchAgainst.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(GlobPatternOrPatternsToMatchAgainst instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings.GlobPatternOrPatternsToMatchAgainst.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<GlobPatternOrPatternsToMatchAgainst, Mutable>(this);
            }
        }
    }
}
