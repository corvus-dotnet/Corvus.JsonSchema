...
public readonly partial struct Schema
{
    ...
    public readonly partial struct OverrideSettings
    {
...
#endif
        {
            ...
            public Corvus.CspellBenchmark.Baseline.Schema.LanguageSetting this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Baseline.Schema.LanguageSetting>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.LanguageSetting> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.LanguageSetting>(_parent, _idx);
            }
