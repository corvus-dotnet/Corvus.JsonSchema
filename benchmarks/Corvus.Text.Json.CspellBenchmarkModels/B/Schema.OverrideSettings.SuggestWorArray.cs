...
public readonly partial struct Schema
{
    ...
    public readonly partial struct OverrideSettings
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SuggestWorArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SuggestWorArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SuggestWorArray DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in SuggestWorArray left, in SuggestWorArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SuggestWorArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(SuggestWorArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SuggestWorArray(JsonElement instance)
            {
                return SuggestWorArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SuggestWorArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SuggestWorArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SuggestWorArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SuggestWorArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SuggestWorArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SuggestWorArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SuggestWorArray>(json, options);
            }
            ...
            /// </exception>
            public static SuggestWorArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SuggestWorArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SuggestWorArray? result)
            {
                return JsonElementHelpers.TryParseValue<SuggestWorArray>(ref reader, out result);
            }
...
#if NET
            static SuggestWorArray IJsonElement<SuggestWorArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SuggestWorArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public SuggestWorArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SuggestWorArray>(_idx);
                }
