...
public readonly partial struct Schema
{
    ...
    public readonly partial struct OverrideSettings
    {
        ...
        public readonly partial struct TheMaximumNumberOfProblemsToReportInAFile
#if NET8_0_OR_GREATER
            : IJsonElement<TheMaximumNumberOfProblemsToReportInAFile>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="TheMaximumNumberOfProblemsToReportInAFile"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal TheMaximumNumberOfProblemsToReportInAFile(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static TheMaximumNumberOfProblemsToReportInAFile DefaultInstance { get; } = ParsedJsonDocument<TheMaximumNumberOfProblemsToReportInAFile>.NumberConstant([.."10000"u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator long(TheMaximumNumberOfProblemsToReportInAFile value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator double(TheMaximumNumberOfProblemsToReportInAFile value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator Corvus.Numerics.BigNumber(TheMaximumNumberOfProblemsToReportInAFile value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator System.Numerics.BigInteger(TheMaximumNumberOfProblemsToReportInAFile value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator decimal(TheMaximumNumberOfProblemsToReportInAFile value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in TheMaximumNumberOfProblemsToReportInAFile left, in TheMaximumNumberOfProblemsToReportInAFile right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in TheMaximumNumberOfProblemsToReportInAFile left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(TheMaximumNumberOfProblemsToReportInAFile instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheMaximumNumberOfProblemsToReportInAFile(JsonElement instance)
            {
                return TheMaximumNumberOfProblemsToReportInAFile.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheMaximumNumberOfProblemsToReportInAFile From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheMaximumNumberOfProblemsToReportInAFile ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TheMaximumNumberOfProblemsToReportInAFile>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheMaximumNumberOfProblemsToReportInAFile ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TheMaximumNumberOfProblemsToReportInAFile>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheMaximumNumberOfProblemsToReportInAFile ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TheMaximumNumberOfProblemsToReportInAFile>(json, options);
            }
            ...
            /// </exception>
            public static TheMaximumNumberOfProblemsToReportInAFile ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<TheMaximumNumberOfProblemsToReportInAFile>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out TheMaximumNumberOfProblemsToReportInAFile? result)
            {
                return JsonElementHelpers.TryParseValue<TheMaximumNumberOfProblemsToReportInAFile>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new TheMaximumNumberOfProblemsToReportInAFile(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static TheMaximumNumberOfProblemsToReportInAFile IJsonElement<TheMaximumNumberOfProblemsToReportInAFile>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheMaximumNumberOfProblemsToReportInAFile: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="TheMaximumNumberOfProblemsToReportInAFile"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TheMaximumNumberOfProblemsToReportInAFile"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public TheMaximumNumberOfProblemsToReportInAFile Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TheMaximumNumberOfProblemsToReportInAFile>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TheMaximumNumberOfProblemsToReportInAFile"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public TheMaximumNumberOfProblemsToReportInAFile Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<TheMaximumNumberOfProblemsToReportInAFile>(_idx);
                }
