...
public readonly partial struct Schema
{
    ...
    public readonly partial struct OverrideSettingsArray
#if NET8_0_OR_GREATER
        : IJsonElement<OverrideSettingsArray>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OverrideSettingsArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal OverrideSettingsArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static OverrideSettingsArray DefaultInstance { get; }
        ...
        public Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.OverrideSettings>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in OverrideSettingsArray left, in OverrideSettingsArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in OverrideSettingsArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(OverrideSettingsArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator OverrideSettingsArray(JsonElement instance)
        {
            return OverrideSettingsArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OverrideSettingsArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OverrideSettingsArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<OverrideSettingsArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OverrideSettingsArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<OverrideSettingsArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OverrideSettingsArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<OverrideSettingsArray>(json, options);
        }
        ...
        /// </exception>
        public static OverrideSettingsArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<OverrideSettingsArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out OverrideSettingsArray? result)
        {
            return JsonElementHelpers.TryParseValue<OverrideSettingsArray>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new OverrideSettingsArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static OverrideSettingsArray IJsonElement<OverrideSettingsArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"OverrideSettingsArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="OverrideSettingsArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="OverrideSettingsArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public OverrideSettingsArray Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<OverrideSettingsArray>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="OverrideSettingsArray"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public OverrideSettingsArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<OverrideSettingsArray>(_idx);
            }
