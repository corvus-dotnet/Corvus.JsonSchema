...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PatternAdjustment
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Baseline.JsonString.Mutable Regexp
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RegexpUtf8, out Corvus.CspellBenchmark.Baseline.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetRegexp(in Corvus.CspellBenchmark.Baseline.JsonString.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CspellBenchmark.Baseline.Schema.PatternAdjustment.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Baseline.Schema.PatternAdjustment.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.CspellBenchmark.Baseline.JsonString.Source id,
                in Corvus.CspellBenchmark.Baseline.JsonNumber.Source penalty,
                in Corvus.CspellBenchmark.Baseline.JsonString.Source regexp)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CspellBenchmark.Baseline.JsonString.Source id, in Corvus.CspellBenchmark.Baseline.JsonNumber.Source penalty, in Corvus.CspellBenchmark.Baseline.JsonString.Source regexp, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
