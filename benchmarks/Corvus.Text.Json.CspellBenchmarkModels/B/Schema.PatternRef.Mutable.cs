...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PatternRef
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.CspellBenchmark.Baseline.Schema.PredefinedPatterns.Mutable(Mutable value)
            {
                return Corvus.CspellBenchmark.Baseline.Schema.PredefinedPatterns.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.CspellBenchmark.Baseline.Schema.PredefinedPatterns.Mutable value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.PatternRef.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                if (Corvus.CspellBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonString1(Corvus.CspellBenchmark.Baseline.JsonString.Mutable.From(this), context);
                }

                if (Corvus.CspellBenchmark.Baseline.Schema.PredefinedPatterns.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchPredefinedPatterns(Corvus.CspellBenchmark.Baseline.Schema.PredefinedPatterns.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.PatternRef.Mutable, TResult> defaultMatch)
            {
                if (Corvus.CspellBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.CspellBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonString1(Corvus.CspellBenchmark.Baseline.JsonString.Mutable.From(this));
                }

                if (Corvus.CspellBenchmark.Baseline.Schema.PredefinedPatterns.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchPredefinedPatterns(Corvus.CspellBenchmark.Baseline.Schema.PredefinedPatterns.Mutable.From(this));
                }
            ...
            public bool TryGetAsPredefinedPatterns(out Corvus.CspellBenchmark.Baseline.Schema.PredefinedPatterns result)
            {
                if (Corvus.CspellBenchmark.Baseline.Schema.PredefinedPatterns.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Baseline.Schema.PredefinedPatterns.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.CspellBenchmark.Baseline.Schema.PredefinedPatterns instance) => new(JsonElement.From(instance));
