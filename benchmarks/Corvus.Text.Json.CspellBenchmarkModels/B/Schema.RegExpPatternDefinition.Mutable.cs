...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RegExpPatternDefinition
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Baseline.Schema.RegExpPatternDefinition.RegExpPatternOrArrayOfRegExpPatterns.Mutable Pattern
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PatternUtf8, out Corvus.CspellBenchmark.Baseline.Schema.RegExpPatternDefinition.RegExpPatternOrArrayOfRegExpPatterns.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetPattern(in Corvus.CspellBenchmark.Baseline.Schema.RegExpPatternDefinition.RegExpPatternOrArrayOfRegExpPatterns.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetPattern<TContext>(in Corvus.CspellBenchmark.Baseline.Schema.RegExpPatternDefinition.RegExpPatternOrArrayOfRegExpPatterns.Source<TContext> value)
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CspellBenchmark.Baseline.Schema.RegExpPatternDefinition.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Baseline.Schema.RegExpPatternDefinition.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.CspellBenchmark.Baseline.JsonString.Source name,
                in Corvus.CspellBenchmark.Baseline.Schema.RegExpPatternDefinition.RegExpPatternOrArrayOfRegExpPatterns.Source pattern,
            ...
            internal static void Create<TContext>(
                ...
                ref ComplexValueBuilder builder,
                in Corvus.CspellBenchmark.Baseline.JsonString.Source name,
                in Corvus.CspellBenchmark.Baseline.Schema.RegExpPatternDefinition.RegExpPatternOrArrayOfRegExpPatterns.Source<TContext> pattern,
                in Corvus.CspellBenchmark.Baseline.JsonString.Source description = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CspellBenchmark.Baseline.JsonString.Source name, in Corvus.CspellBenchmark.Baseline.Schema.RegExpPatternDefinition.RegExpPatternOrArrayOfRegExpPatterns.Source pattern, in Corvus.CspellBenchmark.Baseline.JsonString.Source description = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.CspellBenchmark.Baseline.JsonString.Source name, in Corvus.CspellBenchmark.Baseline.Schema.RegExpPatternDefinition.RegExpPatternOrArrayOfRegExpPatterns.Source<TContext> pattern, in Corvus.CspellBenchmark.Baseline.JsonString.Source description = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
