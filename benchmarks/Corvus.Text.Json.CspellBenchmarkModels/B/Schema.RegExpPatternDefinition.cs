...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RegExpPatternDefinition"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal RegExpPatternDefinition(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RegExpPatternDefinition DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CspellBenchmark.Baseline.Schema.RegExpPatternDefinition.RegExpPatternOrArrayOfRegExpPatterns Pattern
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PatternUtf8, out Corvus.CspellBenchmark.Baseline.Schema.RegExpPatternDefinition.RegExpPatternOrArrayOfRegExpPatterns value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in RegExpPatternDefinition left, in RegExpPatternDefinition right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RegExpPatternDefinition left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(RegExpPatternDefinition instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RegExpPatternDefinition(JsonElement instance)
        {
            return RegExpPatternDefinition.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RegExpPatternDefinition From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RegExpPatternDefinition ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RegExpPatternDefinition>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RegExpPatternDefinition ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RegExpPatternDefinition>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RegExpPatternDefinition ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RegExpPatternDefinition>(json, options);
        }
        ...
        /// </exception>
        public static RegExpPatternDefinition ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<RegExpPatternDefinition>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RegExpPatternDefinition? result)
        {
            return JsonElementHelpers.TryParseValue<RegExpPatternDefinition>(ref reader, out result);
        }
...
#if NET
        static RegExpPatternDefinition IJsonElement<RegExpPatternDefinition>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RegExpPatternDefinition: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public RegExpPatternDefinition Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public RegExpPatternDefinition Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<RegExpPatternDefinition>(_idx);
            }
