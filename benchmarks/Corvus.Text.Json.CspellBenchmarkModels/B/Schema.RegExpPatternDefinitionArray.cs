...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RegExpPatternDefinitionArray
        ...
        : IJsonElement<RegExpPatternDefinitionArray>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RegExpPatternDefinitionArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal RegExpPatternDefinitionArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RegExpPatternDefinitionArray DefaultInstance { get; }
        ...
        public Corvus.CspellBenchmark.Baseline.Schema.RegExpPatternDefinition this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Baseline.Schema.RegExpPatternDefinition>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.RegExpPatternDefinition> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.RegExpPatternDefinition>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in RegExpPatternDefinitionArray left, in RegExpPatternDefinitionArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RegExpPatternDefinitionArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(RegExpPatternDefinitionArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RegExpPatternDefinitionArray(JsonElement instance)
        {
            return RegExpPatternDefinitionArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RegExpPatternDefinitionArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RegExpPatternDefinitionArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RegExpPatternDefinitionArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RegExpPatternDefinitionArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RegExpPatternDefinitionArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RegExpPatternDefinitionArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RegExpPatternDefinitionArray>(json, options);
        }
        ...
        /// </exception>
        public static RegExpPatternDefinitionArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<RegExpPatternDefinitionArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RegExpPatternDefinitionArray? result)
        {
            return JsonElementHelpers.TryParseValue<RegExpPatternDefinitionArray>(ref reader, out result);
        }
...
#if NET
        static RegExpPatternDefinitionArray IJsonElement<RegExpPatternDefinitionArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RegExpPatternDefinitionArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public RegExpPatternDefinitionArray Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public RegExpPatternDefinitionArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<RegExpPatternDefinitionArray>(_idx);
            }
