...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RegExpPatternList
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RegExpPatternList instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RegExpPatternList"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RegExpPatternList(Mutable instance)
            {
            ...
            public Corvus.CspellBenchmark.Baseline.Schema.PatternRef.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Baseline.Schema.PatternRef.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.PatternRef.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.PatternRef.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RegExpPatternList(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RegExpPatternList.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.CspellBenchmark.Baseline.Schema.PatternRef.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.CspellBenchmark.Baseline.Schema.PatternRef.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.CspellBenchmark.Baseline.Schema.PatternRef.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.CspellBenchmark.Baseline.Schema.PatternRef item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.CspellBenchmark.Baseline.Schema.PatternRef>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.CspellBenchmark.Baseline.Schema.PatternRef> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.CspellBenchmark.Baseline.Schema.PatternRef>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.CspellBenchmark.Baseline.Schema.PatternRef oldItem, in Corvus.CspellBenchmark.Baseline.Schema.PatternRef.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.PatternRef>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.CspellBenchmark.Baseline.Schema.PatternRef current = enumerator.Current;
            ...
            /// <summary>
            /// Gets a <see cref="RegExpPatternList"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RegExpPatternList"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly RegExpPatternList Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RegExpPatternList>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RegExpPatternList"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly RegExpPatternList Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RegExpPatternList>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CspellBenchmark.Baseline.Schema.RegExpPatternList.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(RegExpPatternList instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Baseline.Schema.RegExpPatternList.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<RegExpPatternList, Mutable>(this);
        }
    }
}
