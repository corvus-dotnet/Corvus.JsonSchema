...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ReplaceEntry
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ReplaceEntry instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ReplaceEntry"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ReplaceEntry(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ReplaceEntry(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ReplaceEntry.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// <summary>
            /// Gets a <see cref="ReplaceEntry"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ReplaceEntry"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ReplaceEntry Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ReplaceEntry>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ReplaceEntry"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ReplaceEntry Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ReplaceEntry>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CspellBenchmark.Baseline.Schema.ReplaceEntry.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(ReplaceEntry instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Baseline.Schema.ReplaceEntry.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<ReplaceEntry, Mutable>(this);
        }
    }
}
