...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReplaceMap"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ReplaceMap(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ReplaceMap DefaultInstance { get; }
        ...
        public Corvus.CspellBenchmark.Baseline.Schema.ReplaceEntry this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Baseline.Schema.ReplaceEntry>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.ReplaceEntry> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.ReplaceEntry>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in ReplaceMap left, in ReplaceMap right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ReplaceMap left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ReplaceMap instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ReplaceMap(JsonElement instance)
        {
            return ReplaceMap.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ReplaceMap From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ReplaceMap ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ReplaceMap>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ReplaceMap ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ReplaceMap>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ReplaceMap ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ReplaceMap>(json, options);
        }
        ...
        /// </exception>
        public static ReplaceMap ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ReplaceMap>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ReplaceMap? result)
        {
            return JsonElementHelpers.TryParseValue<ReplaceMap>(ref reader, out result);
        }
...
#if NET
        static ReplaceMap IJsonElement<ReplaceMap>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ReplaceMap: ValueKind = {ValueKind} : \"{ToString()}\"";
