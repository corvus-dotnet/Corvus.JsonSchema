...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ReporterSettings
    {
        ...
        public readonly partial struct AnyOf2Array
            : IJsonElement<AnyOf2Array>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("cspell-schema.json#/definitions/ReporterSettings/anyOf/2"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "cspell-schema.json#/definitions/ReporterSettings/anyOf/2";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "cspell-schema.json#/definitions/ReporterSettings/anyOf/2"u8;
                    ...
                    else
                    {
                        ...
                        while (arrayValidation_enumerator.MoveNext())
                        {
                            ...
                            switch (arrayValidation_itemCount)
                            {
                                case 0:
                                {
                                    JsonSchemaContext childContext = Corvus.CspellBenchmark.Baseline.JsonString.JsonSchema.PushChildContext(
                                        parentDocument,
                                    ...
                                    Corvus.CspellBenchmark.Baseline.JsonString.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
                                ...
                                case 1:
                                {
                                    JsonSchemaContext childContext1 = Corvus.CspellBenchmark.Baseline.Schema.Serializable.JsonSchema.PushChildContext(
                                        parentDocument,
                                        arrayValidation_currentIndex,
                                        ref context,
                                        itemIndex: arrayValidation_itemCount,
                                    ...
                                    Corvus.CspellBenchmark.Baseline.Schema.Serializable.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext1);
                        ...
                        JsonSchemaEvaluation.MatchItemCountLessThanOrEquals(2, arrayValidation_itemCount, "maxItems"u8, ref context);
