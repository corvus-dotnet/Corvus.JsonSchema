    ...
    public readonly partial struct ReporterSettings
    {
        ...
        public readonly partial struct AnyOf2Array
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AnyOf2Array instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AnyOf2Array"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AnyOf2Array(Mutable instance)
                {
                ...
                /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public Corvus.CspellBenchmark.Baseline.JsonString.Mutable Item1
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Baseline.JsonString.Mutable>(_idx, 0);
                    }
                }
                ...
                /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public Corvus.CspellBenchmark.Baseline.Schema.Serializable.Mutable Item2
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Baseline.Schema.Serializable.Mutable>(_idx, 1);
                    }
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AnyOf2Array.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public readonly AnyOf2Array Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AnyOf2Array Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AnyOf2Array>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.AnyOf2Array.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(AnyOf2Array instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.AnyOf2Array.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                public void CreateTuple(in Corvus.CspellBenchmark.Baseline.JsonString.Source item1, in Corvus.CspellBenchmark.Baseline.Schema.Serializable.Source item2)
                {
            ...
            {
                return workspace.CreateBuilder<AnyOf2Array, Mutable>(this);
            }
        }
    }
}
