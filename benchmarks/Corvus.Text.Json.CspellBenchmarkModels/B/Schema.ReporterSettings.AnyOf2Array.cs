...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ReporterSettings
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AnyOf2Array"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal AnyOf2Array(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AnyOf2Array DefaultInstance { get; }
            ...
            /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public Corvus.CspellBenchmark.Baseline.JsonString Item1
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Baseline.JsonString>(_idx, 0);
                }
            }
            ...
            /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public Corvus.CspellBenchmark.Baseline.Schema.Serializable Item2
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Baseline.Schema.Serializable>(_idx, 1);
                }
            }
            ...
            /// </returns>
            public static bool operator ==(in AnyOf2Array left, in AnyOf2Array right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AnyOf2Array left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(AnyOf2Array instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AnyOf2Array(JsonElement instance)
            {
                return AnyOf2Array.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnyOf2Array From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnyOf2Array ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AnyOf2Array>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnyOf2Array ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AnyOf2Array>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnyOf2Array ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AnyOf2Array>(json, options);
            }
            ...
            /// </exception>
            public static AnyOf2Array ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<AnyOf2Array>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AnyOf2Array? result)
            {
                return JsonElementHelpers.TryParseValue<AnyOf2Array>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new AnyOf2Array(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static AnyOf2Array IJsonElement<AnyOf2Array>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AnyOf2Array: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="AnyOf2Array"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="AnyOf2Array"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public AnyOf2Array Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<AnyOf2Array>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="AnyOf2Array"/> that lives for the lifetime of its
