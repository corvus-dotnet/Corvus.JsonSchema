...
public readonly partial struct Schema
{
        ...
        : IJsonElement<ReporterSettings>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("cspell-schema.json#/definitions/ReporterSettings"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "cspell-schema.json#/definitions/ReporterSettings";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "cspell-schema.json#/definitions/ReporterSettings"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext anyOfContext1 =
                    Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.JsonStringArray.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AnyOf1SchemaEvaluationPath);
                Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.JsonStringArray.JsonSchema.Evaluate(parentDocument, parentIndex, ref anyOfContext1);
                ...
                JsonSchemaContext anyOfContext2 =
                    Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.AnyOf2Array.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AnyOf2SchemaEvaluationPath);
                Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.AnyOf2Array.JsonSchema.Evaluate(parentDocument, parentIndex, ref anyOfContext2);
