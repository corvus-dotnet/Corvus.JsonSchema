...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ReporterSettings
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.JsonStringArray"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.JsonStringArray.Mutable(Mutable value)
            {
                return Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.JsonStringArray.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.JsonStringArray"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.JsonStringArray.Mutable value)
            {
                return From(value);
            }

            /// <summary>
            /// Conversion to <see cref="Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.AnyOf2Array"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.AnyOf2Array.Mutable(Mutable value)
            {
                return Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.AnyOf2Array.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.AnyOf2Array"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.AnyOf2Array.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(ReporterSettings instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ReporterSettings"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ReporterSettings(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ReporterSettings.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </para>
            /// </remarks>
            public readonly ReporterSettings Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ReporterSettings Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ReporterSettings>(_idx);
            }
            ...
            /// <param name="matchJsonStringArray">Match a <see cref="Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.JsonStringArray"/>.</param>
            /// <param name="matchAnyOf2Array">Match a <see cref="Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.AnyOf2Array"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.JsonStringArray, TContext, TResult> matchJsonStringArray,
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.AnyOf2Array, TContext, TResult> matchAnyOf2Array,
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                ...
                if (Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.JsonStringArray.Mutable.From(this), context);
                }

                if (Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.AnyOf2Array.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchAnyOf2Array(Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.AnyOf2Array.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.JsonStringArray, TResult> matchJsonStringArray,
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.AnyOf2Array, TResult> matchAnyOf2Array,
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.Mutable, TResult> defaultMatch)
            {
                if (Corvus.CspellBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.JsonStringArray.Mutable.From(this));
                }

                if (Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.AnyOf2Array.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchAnyOf2Array(Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.AnyOf2Array.Mutable.From(this));
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.JsonStringArray" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsJsonStringArray(out Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.JsonStringArray result)
            {
                if (Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.JsonStringArray.Mutable.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.AnyOf2Array" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsAnyOf2Array(out Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.AnyOf2Array result)
            {
                if (Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.AnyOf2Array.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.AnyOf2Array.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(ReporterSettings instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Baseline.Schema.ReporterSettings.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<ReporterSettings, Mutable>(this);
        }
    }
}
