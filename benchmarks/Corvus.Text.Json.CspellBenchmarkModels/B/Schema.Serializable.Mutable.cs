...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Serializable
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.CspellBenchmark.Baseline.Schema.Serializable.AnyOf4Entity.Mutable(Mutable value)
            {
                return Corvus.CspellBenchmark.Baseline.Schema.Serializable.AnyOf4Entity.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.CspellBenchmark.Baseline.Schema.Serializable.AnyOf4Entity.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(Serializable instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Serializable"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Serializable(Mutable instance)
            {
            ...
            /// </remarks>
            public void Apply(in Corvus.CspellBenchmark.Baseline.Schema.Serializable.AnyOf4Entity value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Serializable.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Serializable Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly Serializable Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Serializable>(_idx);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.Serializable.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchJsonNumber(Corvus.CspellBenchmark.Baseline.JsonNumber.Mutable.From(this), context);
                }
                ...
                {
                    return matchJsonBoolean(Corvus.CspellBenchmark.Baseline.JsonBoolean.Mutable.From(this), context);
                }

                if (Corvus.CspellBenchmark.Baseline.JsonNull.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonNull(Corvus.CspellBenchmark.Baseline.JsonNull.Mutable.From(this), context);
                }

                if (Corvus.CspellBenchmark.Baseline.Schema.Serializable.AnyOf4Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchAnyOf4Entity(Corvus.CspellBenchmark.Baseline.Schema.Serializable.AnyOf4Entity.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.Serializable.Mutable, TResult> defaultMatch)
            {
                if (Corvus.CspellBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonNumber(Corvus.CspellBenchmark.Baseline.JsonNumber.Mutable.From(this));
                }
                ...
                if (Corvus.CspellBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonBoolean(Corvus.CspellBenchmark.Baseline.JsonBoolean.Mutable.From(this));
                }

                if (Corvus.CspellBenchmark.Baseline.JsonNull.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonNull(Corvus.CspellBenchmark.Baseline.JsonNull.Mutable.From(this));
                }

                if (Corvus.CspellBenchmark.Baseline.Schema.Serializable.AnyOf4Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchAnyOf4Entity(Corvus.CspellBenchmark.Baseline.Schema.Serializable.AnyOf4Entity.Mutable.From(this));
                }
            ...
            public bool TryGetAsJsonNumber(out Corvus.CspellBenchmark.Baseline.JsonNumber result)
            {
                if (Corvus.CspellBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Baseline.JsonNumber.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsJsonBoolean(out Corvus.CspellBenchmark.Baseline.JsonBoolean result)
            {
                if (Corvus.CspellBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Baseline.JsonBoolean.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsJsonNull(out Corvus.CspellBenchmark.Baseline.JsonNull result)
            {
                if (Corvus.CspellBenchmark.Baseline.JsonNull.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Baseline.JsonNull.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsAnyOf4Entity(out Corvus.CspellBenchmark.Baseline.Schema.Serializable.AnyOf4Entity result)
            {
                if (Corvus.CspellBenchmark.Baseline.Schema.Serializable.AnyOf4Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Baseline.Schema.Serializable.AnyOf4Entity.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CspellBenchmark.Baseline.Schema.Serializable.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(Serializable instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.CspellBenchmark.Baseline.JsonBoolean instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.CspellBenchmark.Baseline.JsonNull instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.CspellBenchmark.Baseline.JsonNumber instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Baseline.Schema.Serializable.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<Serializable, Mutable>(this);
        }
    }
}
