...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SuggestionCostsDefs
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(SuggestionCostsDefs instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SuggestionCostsDefs"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SuggestionCostsDefs(Mutable instance)
            {
            ...
            public Corvus.CspellBenchmark.Baseline.Schema.SuggestionCostMapDef.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Baseline.Schema.SuggestionCostMapDef.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.SuggestionCostMapDef.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.SuggestionCostMapDef.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SuggestionCostsDefs(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SuggestionCostsDefs.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.CspellBenchmark.Baseline.Schema.SuggestionCostMapDef.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.CspellBenchmark.Baseline.Schema.SuggestionCostMapDef.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.CspellBenchmark.Baseline.Schema.SuggestionCostMapDef.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.CspellBenchmark.Baseline.Schema.SuggestionCostMapDef item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.CspellBenchmark.Baseline.Schema.SuggestionCostMapDef>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.CspellBenchmark.Baseline.Schema.SuggestionCostMapDef> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.CspellBenchmark.Baseline.Schema.SuggestionCostMapDef>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.CspellBenchmark.Baseline.Schema.SuggestionCostMapDef oldItem, in Corvus.CspellBenchmark.Baseline.Schema.SuggestionCostMapDef.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.SuggestionCostMapDef>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.CspellBenchmark.Baseline.Schema.SuggestionCostMapDef current = enumerator.Current;
            ...
            /// <summary>
            /// Gets a <see cref="SuggestionCostsDefs"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SuggestionCostsDefs"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly SuggestionCostsDefs Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SuggestionCostsDefs>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SuggestionCostsDefs"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly SuggestionCostsDefs Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SuggestionCostsDefs>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CspellBenchmark.Baseline.Schema.SuggestionCostsDefs.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(SuggestionCostsDefs instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Baseline.Schema.SuggestionCostsDefs.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<SuggestionCostsDefs, Mutable>(this);
        }
    }
}
