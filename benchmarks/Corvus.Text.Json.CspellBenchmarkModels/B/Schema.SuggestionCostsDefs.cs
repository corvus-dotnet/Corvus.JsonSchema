...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public Corvus.CspellBenchmark.Baseline.Schema.SuggestionCostMapDef this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Baseline.Schema.SuggestionCostMapDef>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.SuggestionCostMapDef> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Baseline.Schema.SuggestionCostMapDef>(_parent, _idx);
        }
