...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TheMaximumNumberOfProblemsToReportInAFile
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TheMaximumNumberOfProblemsToReportInAFile instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheMaximumNumberOfProblemsToReportInAFile"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheMaximumNumberOfProblemsToReportInAFile(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheMaximumNumberOfProblemsToReportInAFile.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly TheMaximumNumberOfProblemsToReportInAFile Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TheMaximumNumberOfProblemsToReportInAFile Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheMaximumNumberOfProblemsToReportInAFile>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TheMaximumNumberOfProblemsToReportInAFile instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TheMaximumNumberOfProblemsToReportInAFile, Mutable>(this);
        }
    }
}
