...
public readonly partial struct Schema
{
    ...
    public readonly partial struct UrlToJsonSchema
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(UrlToJsonSchema instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="UrlToJsonSchema"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator UrlToJsonSchema(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"UrlToJsonSchema.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly UrlToJsonSchema Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly UrlToJsonSchema Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<UrlToJsonSchema>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(UrlToJsonSchema instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<UrlToJsonSchema, Mutable>(this);
        }
    }
}
