...
public readonly partial struct Schema
{
    ...
    public readonly partial struct UseGitignoreEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(UseGitignoreEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="UseGitignoreEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator UseGitignoreEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"UseGitignoreEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly UseGitignoreEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly UseGitignoreEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<UseGitignoreEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(UseGitignoreEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<UseGitignoreEntity, Mutable>(this);
        }
    }
}
