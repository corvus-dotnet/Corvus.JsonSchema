...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Version
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.CspellBenchmark.Baseline.Schema.VersionLatest"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.CspellBenchmark.Baseline.Schema.VersionLatest.Mutable(Mutable value)
            {
                return Corvus.CspellBenchmark.Baseline.Schema.VersionLatest.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.CspellBenchmark.Baseline.Schema.VersionLatest"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.CspellBenchmark.Baseline.Schema.VersionLatest.Mutable value)
            {
                return From(value);
            }

            /// <summary>
            /// Conversion to <see cref="Corvus.CspellBenchmark.Baseline.Schema.VersionLegacy"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.CspellBenchmark.Baseline.Schema.VersionLegacy.Mutable(Mutable value)
            {
                return Corvus.CspellBenchmark.Baseline.Schema.VersionLegacy.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.CspellBenchmark.Baseline.Schema.VersionLegacy"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.CspellBenchmark.Baseline.Schema.VersionLegacy.Mutable value)
            {
                return From(value);
            }
            ...
            /// <param name="matchVersionLatest">Match a <see cref="Corvus.CspellBenchmark.Baseline.Schema.VersionLatest"/>.</param>
            /// <param name="matchVersionLegacy">Match a <see cref="Corvus.CspellBenchmark.Baseline.Schema.VersionLegacy"/>.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.VersionLatest, TContext, TResult> matchVersionLatest,
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.VersionLegacy, TContext, TResult> matchVersionLegacy,
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.Version.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                if (Corvus.CspellBenchmark.Baseline.Schema.VersionLatest.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchVersionLatest(Corvus.CspellBenchmark.Baseline.Schema.VersionLatest.Mutable.From(this), context);
                }

                if (Corvus.CspellBenchmark.Baseline.Schema.VersionLegacy.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchVersionLegacy(Corvus.CspellBenchmark.Baseline.Schema.VersionLegacy.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.VersionLatest, TResult> matchVersionLatest,
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.VersionLegacy, TResult> matchVersionLegacy,
                Matcher<Corvus.CspellBenchmark.Baseline.Schema.Version.Mutable, TResult> defaultMatch)
            {
                if (Corvus.CspellBenchmark.Baseline.Schema.VersionLatest.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchVersionLatest(Corvus.CspellBenchmark.Baseline.Schema.VersionLatest.Mutable.From(this));
                }

                if (Corvus.CspellBenchmark.Baseline.Schema.VersionLegacy.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchVersionLegacy(Corvus.CspellBenchmark.Baseline.Schema.VersionLegacy.Mutable.From(this));
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.CspellBenchmark.Baseline.Schema.VersionLatest" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsVersionLatest(out Corvus.CspellBenchmark.Baseline.Schema.VersionLatest result)
            {
                if (Corvus.CspellBenchmark.Baseline.Schema.VersionLatest.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Baseline.Schema.VersionLatest.Mutable.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.CspellBenchmark.Baseline.Schema.VersionLegacy" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsVersionLegacy(out Corvus.CspellBenchmark.Baseline.Schema.VersionLegacy result)
            {
                if (Corvus.CspellBenchmark.Baseline.Schema.VersionLegacy.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Baseline.Schema.VersionLegacy.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.CspellBenchmark.Baseline.Schema.VersionLatest instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.CspellBenchmark.Baseline.Schema.VersionLegacy instance) => new(JsonElement.From(instance));
