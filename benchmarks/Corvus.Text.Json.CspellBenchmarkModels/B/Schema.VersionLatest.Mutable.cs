...
public readonly partial struct Schema
{
    ...
    public readonly partial struct VersionLatest
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(VersionLatest instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="VersionLatest"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator VersionLatest(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"VersionLatest.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly VersionLatest Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly VersionLatest Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<VersionLatest>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(VersionLatest instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<VersionLatest, Mutable>(this);
        }
    }
}
