...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct AllowCompoundWordsEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AllowCompoundWordsEntity, Mutable>(AllowCompoundWordsEntity.DefaultInstance);
            ...
            public static explicit operator Mutable(AllowCompoundWordsEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="AllowCompoundWordsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AllowCompoundWordsEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AllowCompoundWordsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly AllowCompoundWordsEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly AllowCompoundWordsEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<AllowCompoundWordsEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(AllowCompoundWordsEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<AllowCompoundWordsEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<AllowCompoundWordsEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<AllowCompoundWordsEntity>();
            }
            finally
            {
