...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct AllowCompoundWordsEntity
#if NET8_0_OR_GREATER
        : IJsonElement<AllowCompoundWordsEntity>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AllowCompoundWordsEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal AllowCompoundWordsEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static AllowCompoundWordsEntity DefaultInstance { get; } = ParsedJsonDocument<AllowCompoundWordsEntity>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(AllowCompoundWordsEntity value)
        {
        ...
        /// </returns>
        public static bool operator ==(in AllowCompoundWordsEntity left, in AllowCompoundWordsEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in AllowCompoundWordsEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(AllowCompoundWordsEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AllowCompoundWordsEntity(JsonElement instance)
        {
            return AllowCompoundWordsEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllowCompoundWordsEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllowCompoundWordsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AllowCompoundWordsEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllowCompoundWordsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AllowCompoundWordsEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllowCompoundWordsEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AllowCompoundWordsEntity>(json, options);
        }
        ...
        /// </exception>
        public static AllowCompoundWordsEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<AllowCompoundWordsEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out AllowCompoundWordsEntity? result)
        {
            return JsonElementHelpers.TryParseValue<AllowCompoundWordsEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AllowCompoundWordsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static AllowCompoundWordsEntity IJsonElement<AllowCompoundWordsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AllowCompoundWordsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AllowCompoundWordsEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AllowCompoundWordsEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public AllowCompoundWordsEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AllowCompoundWordsEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AllowCompoundWordsEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public AllowCompoundWordsEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<AllowCompoundWordsEntity>(_idx);
            }
