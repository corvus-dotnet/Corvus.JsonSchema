...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct CacheFormat
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(CacheFormat instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CacheFormat"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CacheFormat(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new CacheFormat(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CacheFormat.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="CacheFormat"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="CacheFormat"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly CacheFormat Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<CacheFormat>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="CacheFormat"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly CacheFormat Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CacheFormat>(_idx);
            }
            ...
            /// <param name="matchLegacy">Match 1st item.</param>
            /// <param name="matchUniversal">Match 2nd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchLegacy,
                Func<TContext, TResult> matchUniversal,
...
#endif
            {
                ...
                {
                    return matchLegacy(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchUniversal(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchLegacy,
                Func<TResult> matchUniversal,
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(CacheFormat instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (CacheFormat)value;
        ...
        {
            return workspace.CreateBuilder<CacheFormat, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<CacheFormat> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<CacheFormat>();
            }
            finally
            {
