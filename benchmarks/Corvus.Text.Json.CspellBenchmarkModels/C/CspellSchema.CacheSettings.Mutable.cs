...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct CacheSettings
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(CacheSettings instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CacheSettings"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CacheSettings(Mutable instance)
            {
            ...
            /// <summary>
            /// Gets the (optional) <c>cacheFormat</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Current.CspellSchema.CacheFormat.Mutable CacheFormatValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CacheFormatValueUtf8, out Corvus.CspellBenchmark.Current.CspellSchema.CacheFormat.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>cacheLocation</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Current.JsonString.Mutable CacheLocation
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CacheLocationUtf8, out Corvus.CspellBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>cacheStrategy</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Current.CspellSchema.CacheStrategy.Mutable CacheStrategyValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CacheStrategyValueUtf8, out Corvus.CspellBenchmark.Current.CspellSchema.CacheStrategy.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>useCache</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Current.CspellSchema.CacheSettings.UseCacheEntity.Mutable UseCache
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UseCacheUtf8, out Corvus.CspellBenchmark.Current.CspellSchema.CacheSettings.UseCacheEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new CacheSettings(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetCacheFormatValue(scoped in Corvus.CspellBenchmark.Current.CspellSchema.CacheFormat.Source value)
            {
                ...
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CacheFormatValueUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CacheFormatValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.CacheFormatValue, ref cvb);
            ...
            /// <summary>
            /// Remove the <c>cacheFormat</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveCacheFormatValue()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CacheFormatValueUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            public void SetCacheLocation(scoped in Corvus.CspellBenchmark.Current.JsonString.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CacheLocationUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CacheLocationUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.CacheLocation, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>cacheLocation</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveCacheLocation()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CacheLocationUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            public void SetCacheStrategyValue(scoped in Corvus.CspellBenchmark.Current.CspellSchema.CacheStrategy.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CacheStrategyValueUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CacheStrategyValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.CacheStrategyValue, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>cacheStrategy</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveCacheStrategyValue()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CacheStrategyValueUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            public void SetUseCache(scoped in Corvus.CspellBenchmark.Current.CspellSchema.CacheSettings.UseCacheEntity.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.UseCacheUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UseCacheUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.UseCache, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>useCache</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveUseCache()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.UseCacheUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CacheSettings.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="CacheSettings"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="CacheSettings"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly CacheSettings Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<CacheSettings>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="CacheSettings"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly CacheSettings Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CacheSettings>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.CspellBenchmark.Current.CspellSchema.CacheFormat.Source _createArg1;
            private readonly Corvus.CspellBenchmark.Current.JsonString.Source _createArg2;
            private readonly Corvus.CspellBenchmark.Current.CspellSchema.CacheStrategy.Source _createArg3;
            private readonly Corvus.CspellBenchmark.Current.CspellSchema.CacheSettings.UseCacheEntity.Source _createArg4;
            ...
            public static implicit operator Source(CacheSettings instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Current.CspellSchema.CacheSettings.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="CacheSettings"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.CspellBenchmark.Current.CspellSchema.CacheFormat.Source cacheFormat = default,
                in Corvus.CspellBenchmark.Current.JsonString.Source cacheLocation = default,
                in Corvus.CspellBenchmark.Current.CspellSchema.CacheStrategy.Source cacheStrategy = default,
                in Corvus.CspellBenchmark.Current.CspellSchema.CacheSettings.UseCacheEntity.Source useCache = default)
            {
                cacheFormat.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.CacheFormatValue, ref builder);
                cacheLocation.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.CacheLocation, ref builder);
                cacheStrategy.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.CacheStrategyValue, ref builder);
                useCache.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.UseCache, ref builder);
            }
            ...
            public void Create(
                ...
                in Corvus.CspellBenchmark.Current.CspellSchema.CacheSettings.UseCacheEntity.Source useCache = default)
            {
                Create(ref _builder, cacheFormat, cacheLocation, cacheStrategy, useCache);
            }
        ...
        /// </summary>
        /// <param name="cacheFormat">The value of the <c>"cacheFormat"</c> property.</param>
        /// <param name="cacheLocation">The value of the <c>"cacheLocation"</c> property.</param>
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="cacheFormat">The value of the property.</param>
        /// <param name="cacheLocation">The value of the property.</param>
        /// <param name="cacheStrategy">The value of the property.</param>
        /// <param name="useCache">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CspellBenchmark.Current.CspellSchema.CacheFormat.Source cacheFormat = default, in Corvus.CspellBenchmark.Current.JsonString.Source cacheLocation = default, in Corvus.CspellBenchmark.Current.CspellSchema.CacheStrategy.Source cacheStrategy = default, in Corvus.CspellBenchmark.Current.CspellSchema.CacheSettings.UseCacheEntity.Source useCache = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(cacheFormat, cacheLocation, cacheStrategy, useCache);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<CacheSettings, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<CacheSettings> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<CacheSettings>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<CacheSettings> Create<TContext>(
        ...
        public static ParsedJsonDocument<CacheSettings> Create(in Corvus.CspellBenchmark.Current.CspellSchema.CacheFormat.Source cacheFormat = default, in Corvus.CspellBenchmark.Current.JsonString.Source cacheLocation = default, in Corvus.CspellBenchmark.Current.CspellSchema.CacheStrategy.Source cacheStrategy = default, in Corvus.CspellBenchmark.Current.CspellSchema.CacheSettings.UseCacheEntity.Source useCache = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
