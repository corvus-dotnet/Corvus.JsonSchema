    ...
    public readonly partial struct CacheSettings
    {
        ...
        public readonly partial struct UseCacheEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<UseCacheEntity, Mutable>(UseCacheEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(UseCacheEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="UseCacheEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator UseCacheEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"UseCacheEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly UseCacheEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly UseCacheEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<UseCacheEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(UseCacheEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<UseCacheEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<UseCacheEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<UseCacheEntity>();
                }
                finally
                {
