...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct CacheStrategy
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(CacheStrategy instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CacheStrategy"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CacheStrategy(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CacheStrategy.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly CacheStrategy Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly CacheStrategy Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CacheStrategy>(_idx);
            }
            ...
            public bool TryGetKnownValue(out KnownValues result)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    result = KnownValues.Metadata;
                    return true;
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    result = KnownValues.Content;
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(CacheStrategy instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (CacheStrategy)value;
        ...
        {
            return workspace.CreateBuilder<CacheStrategy, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<CacheStrategy> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<CacheStrategy>();
            }
            finally
            {
