...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct CharacterSetCosts
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(CharacterSetCosts instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CharacterSetCosts"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CharacterSetCosts(Mutable instance)
            {
            ...
            /// <summary>
            /// Gets the <c>characters</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Current.JsonString.Mutable Characters
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CharactersUtf8, out Corvus.CspellBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Current.JsonNumber.Mutable Cost
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CostUtf8, out Corvus.CspellBenchmark.Current.JsonNumber.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new CharacterSetCosts(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetCharacters(scoped in Corvus.CspellBenchmark.Current.JsonString.Source value)
            {
                ...
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("characters");
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CharactersUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Characters, ref cvb);
            ...
            public void SetCost(scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("cost");
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CostUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Cost, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CharacterSetCosts.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="CharacterSetCosts"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="CharacterSetCosts"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly CharacterSetCosts Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<CharacterSetCosts>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="CharacterSetCosts"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly CharacterSetCosts Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CharacterSetCosts>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.CspellBenchmark.Current.JsonNumber.Source _createArg3;
            ...
            public static implicit operator Source(CharacterSetCosts instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Current.CspellSchema.CharacterSetCosts.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="CharacterSetCosts"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.CspellBenchmark.Current.JsonString.Source characters,
                in Corvus.CspellBenchmark.Current.JsonNumber.Source cost,
                in Corvus.CspellBenchmark.Current.JsonNumber.Source penalty = default)
            {
                characters.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Characters, ref builder);
                cost.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Cost, ref builder);
            ...
            public void Create(
                ...
                in Corvus.CspellBenchmark.Current.JsonNumber.Source penalty = default)
            {
                Create(ref _builder, characters, cost, penalty);
            }
        ...
        /// </summary>
        /// <param name="characters">The value of the <c>"characters"</c> property.</param>
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="characters">The value of the property.</param>
        /// <param name="cost">The value of the property.</param>
        /// <param name="penalty">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CspellBenchmark.Current.JsonString.Source characters, in Corvus.CspellBenchmark.Current.JsonNumber.Source cost, in Corvus.CspellBenchmark.Current.JsonNumber.Source penalty = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(characters, cost, penalty);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<CharacterSetCosts, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<CharacterSetCosts> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<CharacterSetCosts>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<CharacterSetCosts> Create<TContext>(
        ...
        public static ParsedJsonDocument<CharacterSetCosts> Create(in Corvus.CspellBenchmark.Current.JsonString.Source characters, in Corvus.CspellBenchmark.Current.JsonNumber.Source cost, in Corvus.CspellBenchmark.Current.JsonNumber.Source penalty = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
