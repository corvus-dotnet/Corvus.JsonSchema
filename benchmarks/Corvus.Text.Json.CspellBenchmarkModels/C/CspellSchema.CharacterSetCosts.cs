...
public readonly partial struct CspellSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CharacterSetCosts"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal CharacterSetCosts(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static CharacterSetCosts DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CspellBenchmark.Current.JsonString Characters
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CharactersUtf8, out Corvus.CspellBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CspellBenchmark.Current.JsonNumber Cost
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CostUtf8, out Corvus.CspellBenchmark.Current.JsonNumber value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in CharacterSetCosts left, in CharacterSetCosts right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in CharacterSetCosts left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(CharacterSetCosts instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator CharacterSetCosts(JsonElement instance)
        {
            return CharacterSetCosts.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CharacterSetCosts From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CharacterSetCosts ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CharacterSetCosts>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CharacterSetCosts ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CharacterSetCosts>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CharacterSetCosts ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CharacterSetCosts>(json, options);
        }
        ...
        /// </exception>
        public static CharacterSetCosts ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<CharacterSetCosts>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out CharacterSetCosts? result)
        {
            return JsonElementHelpers.TryParseValue<CharacterSetCosts>(ref reader, out result);
        }
...
#if NET
        static CharacterSetCosts IJsonElement<CharacterSetCosts>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"CharacterSetCosts: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public CharacterSetCosts Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public CharacterSetCosts Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<CharacterSetCosts>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="Characters"/>.
            /// </summary>
            ...
            /// Gets the JSON property name for <see cref="Characters"/>.
            /// </summary>
            public static ReadOnlySpan<byte> CharactersUtf8 => "characters"u8;
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Characters"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Characters => "characters"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Cost"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Cost => "cost"u8;
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Characters"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Characters => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x63, 0x68, 0x61, 0x72, 0x61, 0x63, 0x74, 0x65, 0x72, 0x73, 0x22];

            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Cost"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Cost => [0x65, 0x00, 0x00, 0x00, 0x22, 0x63, 0x6F, 0x73, 0x74, 0x22];
