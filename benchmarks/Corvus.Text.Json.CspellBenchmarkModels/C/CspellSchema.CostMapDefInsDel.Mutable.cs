...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct CostMapDefInsDel
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(CostMapDefInsDel instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CostMapDefInsDel"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CostMapDefInsDel(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Current.JsonNumber.Mutable InsDel
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InsDelUtf8, out Corvus.CspellBenchmark.Current.JsonNumber.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Current.JsonString.Mutable Map
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MapUtf8, out Corvus.CspellBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Current.JsonNumber.Mutable Penalty
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PenaltyUtf8, out Corvus.CspellBenchmark.Current.JsonNumber.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Current.JsonNumber.Mutable Replace
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReplaceUtf8, out Corvus.CspellBenchmark.Current.JsonNumber.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>swap</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Current.JsonNumber.Mutable Swap
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SwapUtf8, out Corvus.CspellBenchmark.Current.JsonNumber.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new CostMapDefInsDel(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetInsDel(scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("insDel");
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InsDelUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.InsDel, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            public void SetMap(scoped in Corvus.CspellBenchmark.Current.JsonString.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("map");
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MapUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Map, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            public void SetPenalty(scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PenaltyUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PenaltyUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Penalty, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>penalty</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemovePenalty()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PenaltyUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            public void SetReplace(scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ReplaceUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReplaceUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Replace, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>replace</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveReplace()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ReplaceUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            public void SetSwap(scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SwapUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SwapUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Swap, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>swap</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveSwap()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SwapUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CostMapDefInsDel.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="CostMapDefInsDel"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="CostMapDefInsDel"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly CostMapDefInsDel Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<CostMapDefInsDel>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="CostMapDefInsDel"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly CostMapDefInsDel Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CostMapDefInsDel>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.CspellBenchmark.Current.JsonNumber.Source _createArg1;
            private readonly Corvus.CspellBenchmark.Current.JsonString.Source _createArg2;
            ...
            internal Source(Corvus.CspellBenchmark.Current.CspellSchema.CostMapDefInsDel.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source arg1, scoped in Corvus.CspellBenchmark.Current.JsonString.Source arg2, scoped in Corvus.CspellBenchmark.Current.JsonString.Source arg3, scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source arg4, scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source arg5, scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source arg6)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            public static implicit operator Source(CostMapDefInsDel instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Current.CspellSchema.CostMapDefInsDel.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="CostMapDefInsDel"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.CspellBenchmark.Current.JsonNumber.Source insDel,
                in Corvus.CspellBenchmark.Current.JsonString.Source map,
                in Corvus.CspellBenchmark.Current.JsonString.Source description = default,
                in Corvus.CspellBenchmark.Current.JsonNumber.Source penalty = default,
                in Corvus.CspellBenchmark.Current.JsonNumber.Source replace = default,
                in Corvus.CspellBenchmark.Current.JsonNumber.Source swap = default)
            {
                insDel.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.InsDel, ref builder);
                map.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Map, ref builder);
                description.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Description, ref builder);
                penalty.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Penalty, ref builder);
                replace.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Replace, ref builder);
                swap.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Swap, ref builder);
            }
            ...
            public void Create(
                ...
                in Corvus.CspellBenchmark.Current.JsonNumber.Source swap = default)
            {
                Create(ref _builder, insDel, map, description, penalty, replace, swap);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source arg1, scoped in Corvus.CspellBenchmark.Current.JsonString.Source arg2, scoped in Corvus.CspellBenchmark.Current.JsonString.Source arg3, scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source arg4, scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source arg5, scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source arg6, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source insDel, scoped in Corvus.CspellBenchmark.Current.JsonString.Source map, scoped in Corvus.CspellBenchmark.Current.JsonString.Source description = default, scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source penalty = default, scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source replace = default, scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source swap = default)
        {
            return new Source(insDel, map, description, penalty, replace, swap);
        }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="insDel">The value of the property.</param>
        /// <param name="map">The value of the property.</param>
        /// <param name="description">The value of the property.</param>
        /// <param name="penalty">The value of the property.</param>
        /// <param name="replace">The value of the property.</param>
        /// <param name="swap">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CspellBenchmark.Current.JsonNumber.Source insDel, in Corvus.CspellBenchmark.Current.JsonString.Source map, in Corvus.CspellBenchmark.Current.JsonString.Source description = default, in Corvus.CspellBenchmark.Current.JsonNumber.Source penalty = default, in Corvus.CspellBenchmark.Current.JsonNumber.Source replace = default, in Corvus.CspellBenchmark.Current.JsonNumber.Source swap = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(insDel, map, description, penalty, replace, swap);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<CostMapDefInsDel, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<CostMapDefInsDel> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<CostMapDefInsDel>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<CostMapDefInsDel> Create<TContext>(
        ...
        public static ParsedJsonDocument<CostMapDefInsDel> Create(in Corvus.CspellBenchmark.Current.JsonNumber.Source insDel, in Corvus.CspellBenchmark.Current.JsonString.Source map, in Corvus.CspellBenchmark.Current.JsonString.Source description = default, in Corvus.CspellBenchmark.Current.JsonNumber.Source penalty = default, in Corvus.CspellBenchmark.Current.JsonNumber.Source replace = default, in Corvus.CspellBenchmark.Current.JsonNumber.Source swap = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
