...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct CostMapDefReplace
    {
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Current.CspellSchema.CostMapDefReplace.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.CspellBenchmark.Current.JsonNumber.Source replace,
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CspellBenchmark.Current.JsonString.Source map, in Corvus.CspellBenchmark.Current.JsonNumber.Source replace, in Corvus.CspellBenchmark.Current.JsonString.Source description = default, in Corvus.CspellBenchmark.Current.JsonNumber.Source insDel = default, in Corvus.CspellBenchmark.Current.JsonNumber.Source penalty = default, in Corvus.CspellBenchmark.Current.JsonNumber.Source swap = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        public static ParsedJsonDocument<CostMapDefReplace> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<CostMapDefReplace>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<CostMapDefReplace> Create<TContext>(
        ...
        public static ParsedJsonDocument<CostMapDefReplace> Create(in Corvus.CspellBenchmark.Current.JsonString.Source map, in Corvus.CspellBenchmark.Current.JsonNumber.Source replace, in Corvus.CspellBenchmark.Current.JsonString.Source description = default, in Corvus.CspellBenchmark.Current.JsonNumber.Source insDel = default, in Corvus.CspellBenchmark.Current.JsonNumber.Source penalty = default, in Corvus.CspellBenchmark.Current.JsonNumber.Source swap = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
