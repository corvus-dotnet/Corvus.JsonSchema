...
public readonly partial struct CspellSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CostMapDefReplace"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal CostMapDefReplace(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static CostMapDefReplace DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in CostMapDefReplace left, in CostMapDefReplace right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in CostMapDefReplace left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(CostMapDefReplace instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator CostMapDefReplace(JsonElement instance)
        {
            return CostMapDefReplace.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CostMapDefReplace From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CostMapDefReplace ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CostMapDefReplace>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CostMapDefReplace ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CostMapDefReplace>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CostMapDefReplace ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CostMapDefReplace>(json, options);
        }
        ...
        /// </exception>
        public static CostMapDefReplace ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<CostMapDefReplace>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out CostMapDefReplace? result)
        {
            return JsonElementHelpers.TryParseValue<CostMapDefReplace>(ref reader, out result);
        }
...
#if NET
        static CostMapDefReplace IJsonElement<CostMapDefReplace>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"CostMapDefReplace: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public CostMapDefReplace Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public CostMapDefReplace Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<CostMapDefReplace>(_idx);
            }
