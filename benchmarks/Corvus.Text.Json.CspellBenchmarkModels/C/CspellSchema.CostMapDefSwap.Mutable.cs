...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct CostMapDefSwap
    {
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in Corvus.CspellBenchmark.Current.JsonString.Source map, in Corvus.CspellBenchmark.Current.JsonNumber.Source swap, in Corvus.CspellBenchmark.Current.JsonString.Source description = default, in Corvus.CspellBenchmark.Current.JsonNumber.Source insDel = default, in Corvus.CspellBenchmark.Current.JsonNumber.Source penalty = default, in Corvus.CspellBenchmark.Current.JsonNumber.Source replace = default)
        {
