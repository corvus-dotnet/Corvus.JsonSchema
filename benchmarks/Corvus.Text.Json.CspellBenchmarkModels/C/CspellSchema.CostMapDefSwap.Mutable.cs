...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct CostMapDefSwap
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(CostMapDefSwap instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CostMapDefSwap"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CostMapDefSwap(Mutable instance)
            {
            ...
            public void SetSwap(scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("swap");
                }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CostMapDefSwap.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly CostMapDefSwap Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly CostMapDefSwap Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CostMapDefSwap>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CspellBenchmark.Current.CspellSchema.CostMapDefSwap.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            public static implicit operator Source(CostMapDefSwap instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Current.CspellSchema.CostMapDefSwap.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="CostMapDefSwap"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.CspellBenchmark.Current.JsonString.Source map,
                in Corvus.CspellBenchmark.Current.JsonNumber.Source swap,
                in Corvus.CspellBenchmark.Current.JsonString.Source description = default,
                in Corvus.CspellBenchmark.Current.JsonNumber.Source insDel = default,
            ...
            public void Create(
                ...
                in Corvus.CspellBenchmark.Current.JsonNumber.Source replace = default)
            {
                Create(ref _builder, map, swap, description, insDel, penalty, replace);
            }
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.CspellBenchmark.Current.JsonString.Source map, scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source swap, scoped in Corvus.CspellBenchmark.Current.JsonString.Source description = default, scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source insDel = default, scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source penalty = default, scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source replace = default)
        {
            return new Source(map, swap, description, insDel, penalty, replace);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CspellBenchmark.Current.JsonString.Source map, in Corvus.CspellBenchmark.Current.JsonNumber.Source swap, in Corvus.CspellBenchmark.Current.JsonString.Source description = default, in Corvus.CspellBenchmark.Current.JsonNumber.Source insDel = default, in Corvus.CspellBenchmark.Current.JsonNumber.Source penalty = default, in Corvus.CspellBenchmark.Current.JsonNumber.Source replace = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(map, swap, description, insDel, penalty, replace);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<CostMapDefSwap, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<CostMapDefSwap> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<CostMapDefSwap>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<CostMapDefSwap> Create<TContext>(
        ...
        public static ParsedJsonDocument<CostMapDefSwap> Create(in Corvus.CspellBenchmark.Current.JsonString.Source map, in Corvus.CspellBenchmark.Current.JsonNumber.Source swap, in Corvus.CspellBenchmark.Current.JsonString.Source description = default, in Corvus.CspellBenchmark.Current.JsonNumber.Source insDel = default, in Corvus.CspellBenchmark.Current.JsonNumber.Source penalty = default, in Corvus.CspellBenchmark.Current.JsonNumber.Source replace = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
