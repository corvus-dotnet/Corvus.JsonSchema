...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct CustomDictionaryScope
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(CustomDictionaryScope instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CustomDictionaryScope"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CustomDictionaryScope(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CustomDictionaryScope.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly CustomDictionaryScope Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly CustomDictionaryScope Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CustomDictionaryScope>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(CustomDictionaryScope instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (CustomDictionaryScope)value;
        ...
        {
            return workspace.CreateBuilder<CustomDictionaryScope, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<CustomDictionaryScope> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<CustomDictionaryScope>();
            }
            finally
            {
