...
public readonly partial struct CspellSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomDictionaryScope"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal CustomDictionaryScope(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static CustomDictionaryScope DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(CustomDictionaryScope value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in CustomDictionaryScope left, in CustomDictionaryScope right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in CustomDictionaryScope left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(CustomDictionaryScope instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator CustomDictionaryScope(JsonElement instance)
        {
            return CustomDictionaryScope.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CustomDictionaryScope From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CustomDictionaryScope ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CustomDictionaryScope>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CustomDictionaryScope ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CustomDictionaryScope>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CustomDictionaryScope ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CustomDictionaryScope>(json, options);
        }
        ...
        /// </exception>
        public static CustomDictionaryScope ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<CustomDictionaryScope>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out CustomDictionaryScope? result)
        {
            return JsonElementHelpers.TryParseValue<CustomDictionaryScope>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new CustomDictionaryScope(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static CustomDictionaryScope IJsonElement<CustomDictionaryScope>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"CustomDictionaryScope: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="CustomDictionaryScope"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="CustomDictionaryScope"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public CustomDictionaryScope Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<CustomDictionaryScope>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="CustomDictionaryScope"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public CustomDictionaryScope Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<CustomDictionaryScope>(_idx);
            }
        ...
        /// <param name="matchUser">Match 1st item.</param>
        /// <param name="matchWorkspace">Match 2nd item.</param>
        /// <param name="matchFolder">Match 3rd item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchUser,
            Func<TContext, TResult> matchWorkspace,
            Func<TContext, TResult> matchFolder,
...
#endif
        {
            ...
            {
                return matchUser(context);
            }

            if (this.ValueEquals(Constants.Enum2))
            {
                return matchWorkspace(context);
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchFolder(context);
            }
        ...
        public TResult Match<TResult>(
            Func<TResult> matchUser,
            Func<TResult> matchWorkspace,
            Func<TResult> matchFolder,
