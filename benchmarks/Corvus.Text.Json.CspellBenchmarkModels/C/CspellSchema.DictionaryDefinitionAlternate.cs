...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct DictionaryDefinitionAlternate
#if NET8_0_OR_GREATER
        : IJsonElement<DictionaryDefinitionAlternate>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DictionaryDefinitionAlternate"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal DictionaryDefinitionAlternate(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static DictionaryDefinitionAlternate DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CspellBenchmark.Current.CspellSchema.DictionaryPath File
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FileUtf8, out Corvus.CspellBenchmark.Current.CspellSchema.DictionaryPath value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId Name
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CspellBenchmark.Current.JsonBoolean NoSuggest
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NoSuggestUtf8, out Corvus.CspellBenchmark.Current.JsonBoolean value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CspellBenchmark.Current.CspellSchema.ReplaceMap RepMap
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RepMapUtf8, out Corvus.CspellBenchmark.Current.CspellSchema.ReplaceMap value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CspellBenchmark.Current.CspellSchema.DictionaryFileTypes Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.CspellBenchmark.Current.CspellSchema.DictionaryFileTypes value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CspellBenchmark.Current.JsonBoolean UseCompounds
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UseCompoundsUtf8, out Corvus.CspellBenchmark.Current.JsonBoolean value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in DictionaryDefinitionAlternate left, in DictionaryDefinitionAlternate right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in DictionaryDefinitionAlternate left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(DictionaryDefinitionAlternate instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DictionaryDefinitionAlternate(JsonElement instance)
        {
            return DictionaryDefinitionAlternate.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DictionaryDefinitionAlternate From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DictionaryDefinitionAlternate ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DictionaryDefinitionAlternate>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DictionaryDefinitionAlternate ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DictionaryDefinitionAlternate>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DictionaryDefinitionAlternate ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DictionaryDefinitionAlternate>(json, options);
        }
        ...
        /// </exception>
        public static DictionaryDefinitionAlternate ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<DictionaryDefinitionAlternate>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out DictionaryDefinitionAlternate? result)
        {
            return JsonElementHelpers.TryParseValue<DictionaryDefinitionAlternate>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new DictionaryDefinitionAlternate(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static DictionaryDefinitionAlternate IJsonElement<DictionaryDefinitionAlternate>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DictionaryDefinitionAlternate: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="DictionaryDefinitionAlternate"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="DictionaryDefinitionAlternate"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public DictionaryDefinitionAlternate Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<DictionaryDefinitionAlternate>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="DictionaryDefinitionAlternate"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public DictionaryDefinitionAlternate Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<DictionaryDefinitionAlternate>(_idx);
            }
        ...
        public static class JsonPropertyNames
        {
            ...
            /// <summary>
            /// Gets the JSON property name for <see cref="File"/>.
            /// </summary>
            ...
            /// <summary>
            /// Gets the JSON property name for <see cref="NoSuggest"/>.
            /// </summary>
            public const string NoSuggest = "noSuggest";

            /// <summary>
            /// Gets the JSON property name for <see cref="RepMap"/>.
            /// </summary>
            public const string RepMap = "repMap";
            ...
            /// <summary>
            /// Gets the JSON property name for <see cref="UseCompounds"/>.
            /// </summary>
            public const string UseCompounds = "useCompounds";
            ...
            /// Gets the JSON property name for <see cref="NoSuggest"/>.
            /// </summary>
            public static ReadOnlySpan<byte> NoSuggestUtf8 => "noSuggest"u8;

            /// <summary>
            /// Gets the JSON property name for <see cref="RepMap"/>.
            /// </summary>
            public static ReadOnlySpan<byte> RepMapUtf8 => "repMap"u8;
            ...
            /// Gets the JSON property name for <see cref="UseCompounds"/>.
            /// </summary>
            public static ReadOnlySpan<byte> UseCompoundsUtf8 => "useCompounds"u8;
        }
        ...
        private static class JsonPropertyNamesEscaped
        {
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="File"/>.
            /// </summary>
            public static ReadOnlySpan<byte> File => "file"u8;
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="NoSuggest"/>.
            /// </summary>
            public static ReadOnlySpan<byte> NoSuggest => "noSuggest"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="RepMap"/>.
            /// </summary>
            public static ReadOnlySpan<byte> RepMap => "repMap"u8;
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="UseCompounds"/>.
            /// </summary>
            public static ReadOnlySpan<byte> UseCompounds => "useCompounds"u8;
        }
        ...
        private static class JsonPropertyNamesPrebaked
        {
            ...
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="File"/>.
            /// </summary>
            public static ReadOnlySpan<byte> File => [0x65, 0x00, 0x00, 0x00, 0x22, 0x66, 0x69, 0x6C, 0x65, 0x22];
