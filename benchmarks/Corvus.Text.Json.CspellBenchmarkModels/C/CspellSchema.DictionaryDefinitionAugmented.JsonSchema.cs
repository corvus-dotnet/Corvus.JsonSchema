...
public readonly partial struct CspellSchema
{
        ...
        : IJsonElement<DictionaryDefinitionAugmented>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchDictionaryInformationValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
