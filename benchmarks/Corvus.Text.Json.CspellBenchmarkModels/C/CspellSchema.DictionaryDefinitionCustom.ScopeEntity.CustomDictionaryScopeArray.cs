...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct DictionaryDefinitionCustom
    {
        ...
        public readonly partial struct ScopeEntity
        {
            ...
            public readonly partial struct CustomDictionaryScopeArray
#if NET8_0_OR_GREATER
                : IJsonElement<CustomDictionaryScopeArray>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="CustomDictionaryScopeArray"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal CustomDictionaryScopeArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static CustomDictionaryScopeArray DefaultInstance { get; }
                ...
                public Corvus.CspellBenchmark.Current.CspellSchema.CustomDictionaryScope this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Current.CspellSchema.CustomDictionaryScope>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.CustomDictionaryScope> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.CustomDictionaryScope>(_parent, _idx);
                }
                ...
                /// </returns>
                public static bool operator ==(in CustomDictionaryScopeArray left, in CustomDictionaryScopeArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in CustomDictionaryScopeArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(CustomDictionaryScopeArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CustomDictionaryScopeArray(JsonElement instance)
                {
                    return CustomDictionaryScopeArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CustomDictionaryScopeArray From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CustomDictionaryScopeArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<CustomDictionaryScopeArray>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CustomDictionaryScopeArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<CustomDictionaryScopeArray>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CustomDictionaryScopeArray ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<CustomDictionaryScopeArray>(json, options);
                }
                ...
                /// </exception>
                public static CustomDictionaryScopeArray ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<CustomDictionaryScopeArray>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out CustomDictionaryScopeArray? result)
                {
                    return JsonElementHelpers.TryParseValue<CustomDictionaryScopeArray>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new CustomDictionaryScopeArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static CustomDictionaryScopeArray IJsonElement<CustomDictionaryScopeArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CustomDictionaryScopeArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="CustomDictionaryScopeArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="CustomDictionaryScopeArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public CustomDictionaryScopeArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<CustomDictionaryScopeArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="CustomDictionaryScopeArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public CustomDictionaryScopeArray Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<CustomDictionaryScopeArray>(_idx);
                    }
