...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct DictionaryDefinitionCustom
    {
...
#endif
        {
            ...
            internal ScopeEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.CspellBenchmark.Current.CspellSchema.CustomDictionaryScope"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.CustomDictionaryScope(ScopeEntity value)
            {
                return Corvus.CspellBenchmark.Current.CspellSchema.CustomDictionaryScope.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.CspellBenchmark.Current.CspellSchema.CustomDictionaryScope"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ScopeEntity(Corvus.CspellBenchmark.Current.CspellSchema.CustomDictionaryScope value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray(ScopeEntity value)
            {
                return Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ScopeEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ScopeEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ScopeEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ScopeEntity(JsonElement instance)
            {
                return ScopeEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ScopeEntity From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ScopeEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ScopeEntity>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ScopeEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ScopeEntity>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ScopeEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ScopeEntity>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static ScopeEntity ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ScopeEntity>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ScopeEntity? result)
            {
                return JsonElementHelpers.TryParseValue<ScopeEntity>(ref reader, out result);
            }
...
#if NET
            static ScopeEntity IJsonElement<ScopeEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ScopeEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public bool TryGetAsCustomDictionaryScope(out Corvus.CspellBenchmark.Current.CspellSchema.CustomDictionaryScope result)
            {
                ...
                {
                    result = Corvus.CspellBenchmark.Current.CspellSchema.CustomDictionaryScope.From(this);
                    return true;
                }
            ...
            public bool TryGetAsCustomDictionaryScopeArray(out Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray result)
            {
                ...
                {
                    result = Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray.From(this);
                    return true;
                }
            ...
            /// <param name="matchCustomDictionaryScope">Match a <see cref="Corvus.CspellBenchmark.Current.CspellSchema.CustomDictionaryScope"/>.</param>
            /// <param name="matchCustomDictionaryScopeArray">Match a <see cref="Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray"/>.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.CustomDictionaryScope, TContext, TResult> matchCustomDictionaryScope,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray, TContext, TResult> matchCustomDictionaryScopeArray,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionCustom.ScopeEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                if (Corvus.CspellBenchmark.Current.CspellSchema.CustomDictionaryScope.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchCustomDictionaryScope(Corvus.CspellBenchmark.Current.CspellSchema.CustomDictionaryScope.From(this), context);
                }

                if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchCustomDictionaryScopeArray(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.CustomDictionaryScope, TResult> matchCustomDictionaryScope,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray, TResult> matchCustomDictionaryScopeArray,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionCustom.ScopeEntity, TResult> defaultMatch)
            {
                if (Corvus.CspellBenchmark.Current.CspellSchema.CustomDictionaryScope.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchCustomDictionaryScope(Corvus.CspellBenchmark.Current.CspellSchema.CustomDictionaryScope.From(this));
                }

                if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchCustomDictionaryScopeArray(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray.From(this));
                }
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.CustomDictionaryScope, TAccumulator, TAccumulator> matchCustomDictionaryScope,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray, TAccumulator, TAccumulator> matchCustomDictionaryScopeArray,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionCustom.ScopeEntity, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
                ...
                {
                    matched = true;
                    accumulator = matchCustomDictionaryScope(Corvus.CspellBenchmark.Current.CspellSchema.CustomDictionaryScope.From(this), accumulator);
                }

                if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    matched = true;
                    accumulator = matchCustomDictionaryScopeArray(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionCustom.ScopeEntity.CustomDictionaryScopeArray.From(this), accumulator);
                }
