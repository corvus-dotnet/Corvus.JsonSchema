...
public readonly partial struct CspellSchema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.CspellBenchmark.Current.JsonBoolean AddWords
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AddWordsUtf8, out Corvus.CspellBenchmark.Current.JsonBoolean value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CspellBenchmark.Current.JsonString Path
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathUtf8, out Corvus.CspellBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionCustom.ScopeEntity Scope
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopeUtf8, out Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionCustom.ScopeEntity value))
                {
                    return value;
                }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="AddWords"/>.
            /// </summary>
            public static ReadOnlySpan<byte> AddWords => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x61, 0x64, 0x64, 0x57, 0x6F, 0x72, 0x64, 0x73, 0x22];
