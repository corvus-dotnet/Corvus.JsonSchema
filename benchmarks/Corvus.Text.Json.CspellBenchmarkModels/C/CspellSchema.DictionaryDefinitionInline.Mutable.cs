...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct DictionaryDefinitionInline
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DictionaryDefinitionInline instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DictionaryDefinitionInline"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DictionaryDefinitionInline(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DictionaryDefinitionInline.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly DictionaryDefinitionInline Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly DictionaryDefinitionInline Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DictionaryDefinitionInline>(_idx);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionInline.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchDictionaryDefinitionInlineWords(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionInlineWords.Mutable.From(this), context);
                }

                if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionInlineIgnoreWords.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchDictionaryDefinitionInlineIgnoreWords(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionInlineIgnoreWords.Mutable.From(this), context);
                }

                if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionInlineFlagWords.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchDictionaryDefinitionInlineFlagWords(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionInlineFlagWords.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionInline.Mutable, TResult> defaultMatch)
            {
                if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionInlineWords.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchDictionaryDefinitionInlineWords(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionInlineWords.Mutable.From(this));
                }

                if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionInlineIgnoreWords.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchDictionaryDefinitionInlineIgnoreWords(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionInlineIgnoreWords.Mutable.From(this));
                }

                if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionInlineFlagWords.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchDictionaryDefinitionInlineFlagWords(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionInlineFlagWords.Mutable.From(this));
                }
            ...
            public bool TryGetAsDictionaryDefinitionInlineFlagWords(out Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionInlineFlagWords.Mutable result)
            {
                if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionInlineFlagWords.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionInlineFlagWords.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsDictionaryDefinitionInlineIgnoreWords(out Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionInlineIgnoreWords.Mutable result)
            {
                if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionInlineIgnoreWords.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionInlineIgnoreWords.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsDictionaryDefinitionInlineWords(out Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionInlineWords.Mutable result)
            {
                if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionInlineWords.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinitionInlineWords.Mutable.From(this);
                    return true;
                }
        ...
        {
            return workspace.CreateBuilder<DictionaryDefinitionInline, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<DictionaryDefinitionInline> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DictionaryDefinitionInline>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<DictionaryDefinitionInline> Create<TContext>(
