...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct DictionaryDefinitionPreferred
    {
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.CspellBenchmark.Current.CspellSchema.DictionaryPath.Source _createArg2;
            private readonly Corvus.CspellBenchmark.Current.JsonString.Source _createArg3;
            private readonly Corvus.CspellBenchmark.Current.JsonBoolean.Source _createArg4;
            private readonly Corvus.CspellBenchmark.Current.CspellSchema.ReplaceMap.Source _createArg5;
            private readonly Corvus.CspellBenchmark.Current.CspellSchema.DictionaryFileTypes.Source _createArg6;
            private readonly Corvus.CspellBenchmark.Current.JsonBoolean.Source _createArg7;
            ...
            #endif
        {
            ...
            private readonly Corvus.CspellBenchmark.Current.JsonString.Source _createArg3;
            private readonly Corvus.CspellBenchmark.Current.JsonBoolean.Source _createArg4;
            private readonly Corvus.CspellBenchmark.Current.CspellSchema.ReplaceMap.Source<TContext> _createArg5;
            private readonly Corvus.CspellBenchmark.Current.CspellSchema.DictionaryFileTypes.Source _createArg6;
            private readonly Corvus.CspellBenchmark.Current.JsonBoolean.Source _createArg7;
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId.Source name, scoped in Corvus.CspellBenchmark.Current.CspellSchema.DictionaryPath.Source path, scoped in Corvus.CspellBenchmark.Current.JsonString.Source description = default, scoped in Corvus.CspellBenchmark.Current.JsonBoolean.Source noSuggest = default, scoped in Corvus.CspellBenchmark.Current.CspellSchema.ReplaceMap.Source<TContext> repMap = default, scoped in Corvus.CspellBenchmark.Current.CspellSchema.DictionaryFileTypes.Source type = default, scoped in Corvus.CspellBenchmark.Current.JsonBoolean.Source useCompounds = default)
            ...
            #endif
        {
            return new Source<TContext>(context, name, path, description, noSuggest, repMap, type, useCompounds);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId.Source name, in Corvus.CspellBenchmark.Current.CspellSchema.DictionaryPath.Source path, in Corvus.CspellBenchmark.Current.JsonString.Source description = default, in Corvus.CspellBenchmark.Current.JsonBoolean.Source noSuggest = default, in Corvus.CspellBenchmark.Current.CspellSchema.ReplaceMap.Source repMap = default, in Corvus.CspellBenchmark.Current.CspellSchema.DictionaryFileTypes.Source type = default, in Corvus.CspellBenchmark.Current.JsonBoolean.Source useCompounds = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId.Source name, in Corvus.CspellBenchmark.Current.CspellSchema.DictionaryPath.Source path, in Corvus.CspellBenchmark.Current.JsonString.Source description = default, in Corvus.CspellBenchmark.Current.JsonBoolean.Source noSuggest = default, in Corvus.CspellBenchmark.Current.CspellSchema.ReplaceMap.Source<TContext> repMap = default, in Corvus.CspellBenchmark.Current.CspellSchema.DictionaryFileTypes.Source type = default, in Corvus.CspellBenchmark.Current.JsonBoolean.Source useCompounds = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        public static ParsedJsonDocument<DictionaryDefinitionPreferred> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DictionaryDefinitionPreferred>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<DictionaryDefinitionPreferred> Create<TContext>(
        ...
        public static ParsedJsonDocument<DictionaryDefinitionPreferred> Create(in Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId.Source name, in Corvus.CspellBenchmark.Current.CspellSchema.DictionaryPath.Source path, in Corvus.CspellBenchmark.Current.JsonString.Source description = default, in Corvus.CspellBenchmark.Current.JsonBoolean.Source noSuggest = default, in Corvus.CspellBenchmark.Current.CspellSchema.ReplaceMap.Source repMap = default, in Corvus.CspellBenchmark.Current.CspellSchema.DictionaryFileTypes.Source type = default, in Corvus.CspellBenchmark.Current.JsonBoolean.Source useCompounds = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<DictionaryDefinitionPreferred> Create<TContext>(in TContext context, in Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId.Source name, in Corvus.CspellBenchmark.Current.CspellSchema.DictionaryPath.Source path, in Corvus.CspellBenchmark.Current.JsonString.Source description = default, in Corvus.CspellBenchmark.Current.JsonBoolean.Source noSuggest = default, in Corvus.CspellBenchmark.Current.CspellSchema.ReplaceMap.Source<TContext> repMap = default, in Corvus.CspellBenchmark.Current.CspellSchema.DictionaryFileTypes.Source type = default, in Corvus.CspellBenchmark.Current.JsonBoolean.Source useCompounds = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
