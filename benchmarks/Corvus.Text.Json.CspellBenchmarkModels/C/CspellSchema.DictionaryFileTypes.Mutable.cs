...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct DictionaryFileTypes
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DictionaryFileTypes instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DictionaryFileTypes"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DictionaryFileTypes(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DictionaryFileTypes(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DictionaryFileTypes.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DictionaryFileTypes"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DictionaryFileTypes"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly DictionaryFileTypes Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DictionaryFileTypes>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DictionaryFileTypes"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly DictionaryFileTypes Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DictionaryFileTypes>(_idx);
            }
            ...
            /// <param name="matchS">Match 1st item.</param>
            /// <param name="matchW">Match 2nd item.</param>
            /// <param name="matchC">Match 3rd item.</param>
            /// <param name="matchT">Match 4th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchS,
                Func<TContext, TResult> matchW,
                Func<TContext, TResult> matchC,
                Func<TContext, TResult> matchT,
...
#endif
            {
                ...
                {
                    return matchS(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchW(context);
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(DictionaryFileTypes instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (DictionaryFileTypes)value;
        ...
        {
            return workspace.CreateBuilder<DictionaryFileTypes, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<DictionaryFileTypes> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DictionaryFileTypes>();
            }
            finally
            {
