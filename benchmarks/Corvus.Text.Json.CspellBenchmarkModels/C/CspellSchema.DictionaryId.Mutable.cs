...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct DictionaryId
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DictionaryId instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DictionaryId"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DictionaryId(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DictionaryId(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DictionaryId.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DictionaryId"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DictionaryId"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly DictionaryId Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DictionaryId>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DictionaryId"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly DictionaryId Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DictionaryId>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(DictionaryId instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<DictionaryId, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<DictionaryId> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DictionaryId>();
            }
            finally
            {
