...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct DictionaryInformation
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="PatternAdjustmentArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal PatternAdjustmentArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static PatternAdjustmentArray DefaultInstance { get; }
            ...
            public Corvus.CspellBenchmark.Current.CspellSchema.PatternAdjustment this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Current.CspellSchema.PatternAdjustment>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.PatternAdjustment> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.PatternAdjustment>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in PatternAdjustmentArray left, in PatternAdjustmentArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in PatternAdjustmentArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(PatternAdjustmentArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PatternAdjustmentArray(JsonElement instance)
            {
                return PatternAdjustmentArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PatternAdjustmentArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PatternAdjustmentArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PatternAdjustmentArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PatternAdjustmentArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PatternAdjustmentArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PatternAdjustmentArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PatternAdjustmentArray>(json, options);
            }
            ...
            /// </exception>
            public static PatternAdjustmentArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<PatternAdjustmentArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out PatternAdjustmentArray? result)
            {
                return JsonElementHelpers.TryParseValue<PatternAdjustmentArray>(ref reader, out result);
            }
...
#if NET
            static PatternAdjustmentArray IJsonElement<PatternAdjustmentArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PatternAdjustmentArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public PatternAdjustmentArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public PatternAdjustmentArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<PatternAdjustmentArray>(_idx);
                }
