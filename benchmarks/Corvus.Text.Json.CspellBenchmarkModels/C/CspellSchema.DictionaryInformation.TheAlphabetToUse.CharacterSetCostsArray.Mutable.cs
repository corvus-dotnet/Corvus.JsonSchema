...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct DictionaryInformation
    {
        ...
        public readonly partial struct TheAlphabetToUse
        {
            ...
            public readonly partial struct CharacterSetCostsArray
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(CharacterSetCostsArray instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="CharacterSetCostsArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator CharacterSetCostsArray(Mutable instance)
                    {
                    ...
                    public Corvus.CspellBenchmark.Current.CspellSchema.CharacterSetCosts.Mutable this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Current.CspellSchema.CharacterSetCosts.Mutable>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.CharacterSetCosts.Mutable> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.CharacterSetCosts.Mutable>(_parent, _idx);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new CharacterSetCostsArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"CharacterSetCostsArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void SetItem(int itemIndex, in Corvus.CspellBenchmark.Current.CspellSchema.CharacterSetCosts.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void InsertItem(int itemIndex, scoped in Corvus.CspellBenchmark.Current.CspellSchema.CharacterSetCosts.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void AddItem(scoped in Corvus.CspellBenchmark.Current.CspellSchema.CharacterSetCosts.Source value)
                    {
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Remove(in Corvus.CspellBenchmark.Current.CspellSchema.CharacterSetCosts item)
                    {
                        CheckValidInstance();
                        if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.CspellBenchmark.Current.CspellSchema.CharacterSetCosts>(this, in item))
                        {
                            return false;
                        }
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void RemoveWhere(JsonPredicate<Corvus.CspellBenchmark.Current.CspellSchema.CharacterSetCosts> predicate)
                    {
                        CheckValidInstance();
                        JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.CspellBenchmark.Current.CspellSchema.CharacterSetCosts>(this, predicate);
                        _documentVersion = _parent.Version;
                    }
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Replace(in Corvus.CspellBenchmark.Current.CspellSchema.CharacterSetCosts oldItem, in Corvus.CspellBenchmark.Current.CspellSchema.CharacterSetCosts.Source newItem)
                    {
                        CheckValidInstance();
                        ...
                        var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.CharacterSetCosts>(_parent, _idx);

                        while (enumerator.MoveNext())
                        {
                            Corvus.CspellBenchmark.Current.CspellSchema.CharacterSetCosts current = enumerator.Current;
                    ...
                    /// <summary>
                    /// Gets a <see cref="CharacterSetCostsArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="CharacterSetCostsArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly CharacterSetCostsArray Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<CharacterSetCostsArray>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="CharacterSetCostsArray"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly CharacterSetCostsArray Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<CharacterSetCostsArray>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(CharacterSetCostsArray instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// </summary>
                    public void AddItem(in Corvus.CspellBenchmark.Current.CspellSchema.CharacterSetCosts.Source value)
                    {
                    ...
                    /// Add an item to the array.
                    /// </summary>
                    public void AddItem<TContext>(in Corvus.CspellBenchmark.Current.CspellSchema.CharacterSetCosts.Source<TContext> value)
#if NET9_0_OR_GREATER
                        where TContext : allows ref struct
#endif
                    {
                ...
                {
                    return workspace.CreateBuilder<CharacterSetCostsArray, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<CharacterSetCostsArray> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<CharacterSetCostsArray>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<CharacterSetCostsArray> Create<TContext>(
