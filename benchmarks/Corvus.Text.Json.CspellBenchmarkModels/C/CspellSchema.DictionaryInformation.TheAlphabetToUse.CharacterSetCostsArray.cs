    ...
    public readonly partial struct DictionaryInformation
    {
        ...
        public readonly partial struct TheAlphabetToUse
        {
...
#endif
            {
                ...
                public Corvus.CspellBenchmark.Current.CspellSchema.CharacterSetCosts this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Current.CspellSchema.CharacterSetCosts>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.CharacterSetCosts> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.CharacterSetCosts>(_parent, _idx);
                }
