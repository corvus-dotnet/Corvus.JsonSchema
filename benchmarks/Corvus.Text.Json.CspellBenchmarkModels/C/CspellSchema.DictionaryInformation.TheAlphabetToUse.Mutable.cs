...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct DictionaryInformation
    {
        ...
        public readonly partial struct TheAlphabetToUse
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TheAlphabetToUse, Mutable>(TheAlphabetToUse.DefaultInstance);
                ...
                /// <summary>
                /// Conversion to <see cref="Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.Mutable(Mutable value)
                {
                    return Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.Mutable.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.Mutable value)
                {
                    return From(value);
                }
                ...
                public static explicit operator Mutable(TheAlphabetToUse instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheAlphabetToUse"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheAlphabetToUse(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TheAlphabetToUse(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheAlphabetToUse.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// <summary>
                /// Gets a <see cref="TheAlphabetToUse"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TheAlphabetToUse"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly TheAlphabetToUse Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TheAlphabetToUse>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TheAlphabetToUse"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly TheAlphabetToUse Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheAlphabetToUse>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray, TContext, TResult> matchCharacterSetCostsArray,
                    Matcher<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    ...
                    {
                        return matchCharacterSetCostsArray(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray, TResult> matchCharacterSetCostsArray,
                    Matcher<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.CspellBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                    ...
                    if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCharacterSetCostsArray(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.Mutable.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsCharacterSetCostsArray(out Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.Mutable result)
                {
                    if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(TheAlphabetToUse instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<TheAlphabetToUse, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TheAlphabetToUse> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TheAlphabetToUse>();
                }
                finally
                {
