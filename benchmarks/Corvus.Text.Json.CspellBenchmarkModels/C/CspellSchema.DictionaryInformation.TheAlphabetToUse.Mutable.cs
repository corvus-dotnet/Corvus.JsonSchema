    ...
    public readonly partial struct DictionaryInformation
    {
        ...
        public readonly partial struct TheAlphabetToUse
        {
...
#endif
            {
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsCharacterSetCostsArray(out Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray result)
                {
                    if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.JsonSchema.Evaluate(_parent, _idx))
                    {
