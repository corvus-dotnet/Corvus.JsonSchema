...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct DictionaryInformation
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray(TheAlphabetToUse value)
            {
                return Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator TheAlphabetToUse(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray value)
            {
                return From(value);
            }
            ...
            public bool TryGetAsCharacterSetCostsArray(out Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray result)
            {
                ...
                {
                    result = Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.From(this);
                    return true;
                }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchCharacterSetCostsArray(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse, TResult> defaultMatch)
            {
                if (Corvus.CspellBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchCharacterSetCostsArray(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.From(this));
                }
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
                ...
                {
                    matched = true;
                    accumulator = matchCharacterSetCostsArray(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryInformation.TheAlphabetToUse.CharacterSetCostsArray.From(this), accumulator);
                }
