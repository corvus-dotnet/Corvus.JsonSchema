...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct DictionaryNegRef
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DictionaryNegRef instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DictionaryNegRef"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DictionaryNegRef(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DictionaryNegRef(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DictionaryNegRef.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DictionaryNegRef"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DictionaryNegRef"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly DictionaryNegRef Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DictionaryNegRef>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DictionaryNegRef"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly DictionaryNegRef Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DictionaryNegRef>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(DictionaryNegRef instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<DictionaryNegRef, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<DictionaryNegRef> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DictionaryNegRef>();
            }
            finally
            {
