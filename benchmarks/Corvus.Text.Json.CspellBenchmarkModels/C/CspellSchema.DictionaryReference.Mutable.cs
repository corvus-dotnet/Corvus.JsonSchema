...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct DictionaryReference
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId.Mutable(Mutable value)
            {
                return Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId.Mutable value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.DictionaryNegRef.Mutable(Mutable value)
            {
                return Corvus.CspellBenchmark.Current.CspellSchema.DictionaryNegRef.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.CspellBenchmark.Current.CspellSchema.DictionaryNegRef"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryNegRef.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(DictionaryReference instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DictionaryReference"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DictionaryReference(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DictionaryReference.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly DictionaryReference Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly DictionaryReference Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DictionaryReference>(_idx);
            }
            ...
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId, TContext, TResult> matchDictionaryId,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryNegRef, TContext, TResult> matchDictionaryNegRef,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryReference.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchDictionaryId(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId.Mutable.From(this), context);
                }

                if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryNegRef.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchDictionaryNegRef(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryNegRef.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId, TResult> matchDictionaryId,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryNegRef, TResult> matchDictionaryNegRef,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryReference.Mutable, TResult> defaultMatch)
            {
                if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchDictionaryId(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId.Mutable.From(this));
                }

                if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryNegRef.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchDictionaryNegRef(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryNegRef.Mutable.From(this));
                }
            ...
            public bool TryGetAsDictionaryId(out Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId.Mutable result)
            {
                if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsDictionaryNegRef(out Corvus.CspellBenchmark.Current.CspellSchema.DictionaryNegRef.Mutable result)
            {
                if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryNegRef.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Current.CspellSchema.DictionaryNegRef.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(DictionaryReference instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryNegRef instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<DictionaryReference, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<DictionaryReference> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DictionaryReference>();
            }
            finally
            {
