...
public readonly partial struct CspellSchema
{
...
#endif
    {
        ...
        public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId(DictionaryReference value)
        {
            return Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator DictionaryReference(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.DictionaryNegRef(DictionaryReference value)
        {
            return Corvus.CspellBenchmark.Current.CspellSchema.DictionaryNegRef.From(value);
        }
        ...
        public bool TryGetAsDictionaryId(out Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId result)
        {
            ...
            {
                result = Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId.From(this);
                return true;
            }
        ...
        public bool TryGetAsDictionaryNegRef(out Corvus.CspellBenchmark.Current.CspellSchema.DictionaryNegRef result)
        {
            ...
            {
                result = Corvus.CspellBenchmark.Current.CspellSchema.DictionaryNegRef.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryReference, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchDictionaryId(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId.From(this), context);
            }

            if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryNegRef.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchDictionaryNegRef(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryNegRef.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryReference, TResult> defaultMatch)
        {
            if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchDictionaryId(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId.From(this));
            }

            if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryNegRef.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchDictionaryNegRef(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryNegRef.From(this));
            }
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryReference, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
            ...
            {
                matched = true;
                accumulator = matchDictionaryId(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryId.From(this), accumulator);
            }

            if (Corvus.CspellBenchmark.Current.CspellSchema.DictionaryNegRef.JsonSchema.Evaluate(_parent, _idx))
            {
                matched = true;
                accumulator = matchDictionaryNegRef(Corvus.CspellBenchmark.Current.CspellSchema.DictionaryNegRef.From(this), accumulator);
            }
