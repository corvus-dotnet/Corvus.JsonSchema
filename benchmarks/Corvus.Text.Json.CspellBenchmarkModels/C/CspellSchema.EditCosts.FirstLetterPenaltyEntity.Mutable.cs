...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct EditCosts
    {
        ...
        public readonly partial struct FirstLetterPenaltyEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<FirstLetterPenaltyEntity, Mutable>(FirstLetterPenaltyEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(FirstLetterPenaltyEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="FirstLetterPenaltyEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FirstLetterPenaltyEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new FirstLetterPenaltyEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FirstLetterPenaltyEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="FirstLetterPenaltyEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="FirstLetterPenaltyEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly FirstLetterPenaltyEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<FirstLetterPenaltyEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="FirstLetterPenaltyEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly FirstLetterPenaltyEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<FirstLetterPenaltyEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(FirstLetterPenaltyEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<FirstLetterPenaltyEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<FirstLetterPenaltyEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<FirstLetterPenaltyEntity>();
                }
                finally
                {
