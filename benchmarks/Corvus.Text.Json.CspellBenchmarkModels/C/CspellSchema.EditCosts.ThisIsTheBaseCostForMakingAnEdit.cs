...
public readonly partial struct CspellSchema
{
    ...
    /// Generated from JSON Schema.
    /// </summary>
    public readonly partial struct EditCosts
    {
        /// <summary>
        /// Generated from JSON Schema.
        /// </summary>
        ...
        public readonly partial struct ThisIsTheBaseCostForMakingAnEdit
#if NET8_0_OR_GREATER
            : IJsonElement<ThisIsTheBaseCostForMakingAnEdit>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ThisIsTheBaseCostForMakingAnEdit"/> struct.
            /// </summary>
            ...
            internal ThisIsTheBaseCostForMakingAnEdit(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ThisIsTheBaseCostForMakingAnEdit DefaultInstance { get; } = ParsedJsonDocument<ThisIsTheBaseCostForMakingAnEdit>.NumberConstant([.."100"u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator long(ThisIsTheBaseCostForMakingAnEdit value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator double(ThisIsTheBaseCostForMakingAnEdit value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator Corvus.Numerics.BigNumber(ThisIsTheBaseCostForMakingAnEdit value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator System.Numerics.BigInteger(ThisIsTheBaseCostForMakingAnEdit value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator decimal(ThisIsTheBaseCostForMakingAnEdit value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator sbyte(ThisIsTheBaseCostForMakingAnEdit value) => value._parent.TryGetValue(value._idx, out sbyte result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator byte(ThisIsTheBaseCostForMakingAnEdit value) => value._parent.TryGetValue(value._idx, out byte result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator short(ThisIsTheBaseCostForMakingAnEdit value) => value._parent.TryGetValue(value._idx, out short result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator ushort(ThisIsTheBaseCostForMakingAnEdit value) => value._parent.TryGetValue(value._idx, out ushort result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator int(ThisIsTheBaseCostForMakingAnEdit value) => value._parent.TryGetValue(value._idx, out int result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator uint(ThisIsTheBaseCostForMakingAnEdit value) => value._parent.TryGetValue(value._idx, out uint result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator ulong(ThisIsTheBaseCostForMakingAnEdit value) => value._parent.TryGetValue(value._idx, out ulong result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator float(ThisIsTheBaseCostForMakingAnEdit value) => value._parent.TryGetValue(value._idx, out float result) ? result : throw new FormatException();

#if NET
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator Int128(ThisIsTheBaseCostForMakingAnEdit value) => value._parent.TryGetValue(value._idx, out Int128 result) ? result : throw new FormatException();
#endif

#if NET
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator UInt128(ThisIsTheBaseCostForMakingAnEdit value) => value._parent.TryGetValue(value._idx, out UInt128 result) ? result : throw new FormatException();
#endif

#if NET
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator Half(ThisIsTheBaseCostForMakingAnEdit value) => value._parent.TryGetValue(value._idx, out Half result) ? result : throw new FormatException();
#endif
            ...
            /// </returns>
            public static bool operator ==(in ThisIsTheBaseCostForMakingAnEdit left, in ThisIsTheBaseCostForMakingAnEdit right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ThisIsTheBaseCostForMakingAnEdit left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ThisIsTheBaseCostForMakingAnEdit instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ThisIsTheBaseCostForMakingAnEdit(JsonElement instance)
            {
                return ThisIsTheBaseCostForMakingAnEdit.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ThisIsTheBaseCostForMakingAnEdit From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ThisIsTheBaseCostForMakingAnEdit ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ThisIsTheBaseCostForMakingAnEdit>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ThisIsTheBaseCostForMakingAnEdit ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ThisIsTheBaseCostForMakingAnEdit>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ThisIsTheBaseCostForMakingAnEdit ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ThisIsTheBaseCostForMakingAnEdit>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static ThisIsTheBaseCostForMakingAnEdit ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ThisIsTheBaseCostForMakingAnEdit>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ThisIsTheBaseCostForMakingAnEdit? result)
            {
                return JsonElementHelpers.TryParseValue<ThisIsTheBaseCostForMakingAnEdit>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ThisIsTheBaseCostForMakingAnEdit(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ThisIsTheBaseCostForMakingAnEdit IJsonElement<ThisIsTheBaseCostForMakingAnEdit>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ThisIsTheBaseCostForMakingAnEdit: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ThisIsTheBaseCostForMakingAnEdit"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ThisIsTheBaseCostForMakingAnEdit"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ThisIsTheBaseCostForMakingAnEdit Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ThisIsTheBaseCostForMakingAnEdit>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ThisIsTheBaseCostForMakingAnEdit"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ThisIsTheBaseCostForMakingAnEdit Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ThisIsTheBaseCostForMakingAnEdit>(_idx);
                }
