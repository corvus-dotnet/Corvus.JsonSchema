...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct EnableGlobDotEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnableGlobDotEntity, Mutable>(EnableGlobDotEntity.DefaultInstance);
        ...
        public static ParsedJsonDocument<EnableGlobDotEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EnableGlobDotEntity>();
            }
            finally
            {
