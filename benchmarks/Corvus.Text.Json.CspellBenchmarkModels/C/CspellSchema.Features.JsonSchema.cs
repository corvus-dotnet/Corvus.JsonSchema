...
public readonly partial struct CspellSchema
{
        ...
        : IJsonElement<Features>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchWeightedSuggestions(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/Features"u8, buffer, out written);
