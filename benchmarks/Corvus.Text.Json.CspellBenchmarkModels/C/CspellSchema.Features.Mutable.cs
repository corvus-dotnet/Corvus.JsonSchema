...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct Features
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Current.JsonBoolean.Mutable WeightedSuggestions
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WeightedSuggestionsUtf8, out Corvus.CspellBenchmark.Current.JsonBoolean.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetWeightedSuggestions(scoped in Corvus.CspellBenchmark.Current.JsonBoolean.Source value)
            {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.WeightedSuggestions, ref cvb);
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Current.CspellSchema.Features.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.CspellBenchmark.Current.JsonBoolean.Source weightedSuggestions = default)
            {
                weightedSuggestions.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.WeightedSuggestions, ref builder);
            }

            /// <summary>
            /// Creates an instance of a <see cref="Features"/>.
            /// </summary>
            public void Create(in Corvus.CspellBenchmark.Current.JsonBoolean.Source weightedSuggestions = default)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CspellBenchmark.Current.JsonBoolean.Source weightedSuggestions = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        public static ParsedJsonDocument<Features> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Features>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Features> Create<TContext>(
        ...
        public static ParsedJsonDocument<Features> Create(in Corvus.CspellBenchmark.Current.JsonBoolean.Source weightedSuggestions = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
