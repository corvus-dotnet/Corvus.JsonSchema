...
public readonly partial struct CspellSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Features"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Features(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Features DefaultInstance { get; }

        /// <summary>
        /// Gets the (optional) <c>weighted-suggestions</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.CspellBenchmark.Current.JsonBoolean WeightedSuggestions
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WeightedSuggestionsUtf8, out Corvus.CspellBenchmark.Current.JsonBoolean value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in Features left, in Features right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Features left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Features instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Features(JsonElement instance)
        {
            return Features.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Features From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Features ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Features>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Features ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Features>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Features ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Features>(json, options);
        }
        ...
        /// </exception>
        public static Features ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Features>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Features? result)
        {
            return JsonElementHelpers.TryParseValue<Features>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Features(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Features IJsonElement<Features>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Features: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Features"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Features"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<Features>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Features"/> that lives for the lifetime of its
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="WeightedSuggestions"/>.
            /// </summary>
            public const string WeightedSuggestions = "weighted-suggestions";

            /// <summary>
            /// Gets the JSON property name for <see cref="WeightedSuggestions"/>.
            /// </summary>
            public static ReadOnlySpan<byte> WeightedSuggestionsUtf8 => "weighted-suggestions"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="WeightedSuggestions"/>.
            /// </summary>
            public static ReadOnlySpan<byte> WeightedSuggestions => "weighted-suggestions"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="WeightedSuggestions"/>.
            /// </summary>
            public static ReadOnlySpan<byte> WeightedSuggestions => [0x65, 0x01, 0x00, 0x00, 0x22, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x65, 0x64, 0x2D, 0x73, 0x75, 0x67, 0x67, 0x65, 0x73, 0x74, 0x69, 0x6F, 0x6E, 0x73, 0x22];
        }
    }
}
