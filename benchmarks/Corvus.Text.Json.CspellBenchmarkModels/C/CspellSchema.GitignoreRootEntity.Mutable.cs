...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct GitignoreRootEntity
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray.Mutable(Mutable value)
            {
                return Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(GitignoreRootEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="GitignoreRootEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator GitignoreRootEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"GitignoreRootEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </para>
            /// </remarks>
            public readonly GitignoreRootEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly GitignoreRootEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<GitignoreRootEntity>(_idx);
            }
            ...
            /// <param name="matchJsonStringArray">Match a <see cref="Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray, TContext, TResult> matchJsonStringArray,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                ...
                if (Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray, TResult> matchJsonStringArray,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.CspellBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray.Mutable.From(this));
                }
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray, TAccumulator, TAccumulator> matchJsonStringArray,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.Mutable, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
                ...
                {
                    matched = true;
                    accumulator = matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray.Mutable.From(this), accumulator);
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsJsonStringArray(out Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray.Mutable result)
            {
                if (Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(GitignoreRootEntity instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<GitignoreRootEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<GitignoreRootEntity> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<GitignoreRootEntity>();
            }
            finally
            {
