...
public readonly partial struct CspellSchema
{
...
#endif
    {
        ...
        public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray(GitignoreRootEntity value)
        {
            return Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator GitignoreRootEntity(Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray value)
        {
            return From(value);
        }
        ...
        public bool TryGetAsJsonStringArray(out Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray result)
        {
            ...
            {
                result = Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            if (Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity, TResult> defaultMatch)
        {
            if (Corvus.CspellBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            if (Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray.From(this));
            }
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
            ...
            {
                matched = true;
                accumulator = matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.GitignoreRootEntity.JsonStringArray.From(this), accumulator);
            }
