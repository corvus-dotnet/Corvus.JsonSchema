...
public readonly partial struct CspellSchema
{
        ...
        : IJsonElement<HunspellInformation>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAffPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("aff"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAffNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("aff"u8, buffer, out written);

            private const int RequiredOffsetForAff = 0;
            private const uint RequiredBitForAff = 0b00000000000000000000000000000001;

            private const uint RequiredBitMask0 =
                RequiredBitForAff;
            private static readonly JsonSchemaPathProvider AffSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/aff"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider CostsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/costs"u8, buffer, out written);

            private static void MatchAff(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.CspellBenchmark.Current.JsonString.JsonSchema.PushChildContextUnescaped(
                        ...
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.AffUtf8,
                        evaluationPath: AffSchemaEvaluationPath);
                ...
                requiredBitBuffer[RequiredOffsetForAff] |= RequiredBitForAff;
            }

            private static void MatchCosts(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext1 =
                    Corvus.CspellBenchmark.Current.CspellSchema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.CostsUtf8,
                        evaluationPath: CostsSchemaEvaluationPath);

                Corvus.CspellBenchmark.Current.CspellSchema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            private static PropertySchemaMatchers<Corvus.CspellBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.CspellBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1>([
                    (static () => JsonPropertyNames.AffUtf8, MatchAff),
                    (static () => JsonPropertyNames.CostsUtf8, MatchCosts),
                ]);
            }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("cspell-schema.json#/definitions/HunspellInformation"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "cspell-schema.json#/definitions/HunspellInformation";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "cspell-schema.json#/definitions/HunspellInformation"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAffPresent, "aff"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForAff] & RequiredBitForAff) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyAffNotPresent, "aff"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAffPresent, "aff"u8, "required"u8);
