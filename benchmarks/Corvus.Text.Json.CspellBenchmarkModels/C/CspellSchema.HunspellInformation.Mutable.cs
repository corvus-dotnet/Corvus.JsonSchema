...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct HunspellInformation
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Current.JsonString.Mutable Aff
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AffUtf8, out Corvus.CspellBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Current.CspellSchema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings.Mutable Costs
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CostsUtf8, out Corvus.CspellBenchmark.Current.CspellSchema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetAff(scoped in Corvus.CspellBenchmark.Current.JsonString.Source value)
            {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Aff, ref cvb);
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCosts<TContext>(in Corvus.CspellBenchmark.Current.CspellSchema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings.Source<TContext> value)
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.CspellBenchmark.Current.CspellSchema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings.Source _createArg2;
            ...
            #endif
        {
            ...
            private readonly Corvus.CspellBenchmark.Current.JsonString.Source _createArg1;
            private readonly Corvus.CspellBenchmark.Current.CspellSchema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings.Source<TContext> _createArg2;
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.CspellBenchmark.Current.JsonString.Source aff,
                in Corvus.CspellBenchmark.Current.CspellSchema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings.Source costs = default)
            {
                aff.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Aff, ref builder);
            ...
            /// Creates an instance of a <see cref="HunspellInformation"/>.
            /// </summary>
            public void Create(in Corvus.CspellBenchmark.Current.JsonString.Source aff, in Corvus.CspellBenchmark.Current.CspellSchema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings.Source costs = default)
            {
            ...
            internal static void Create<TContext>(
                ...
                ref ComplexValueBuilder builder,
                in Corvus.CspellBenchmark.Current.JsonString.Source aff,
                in Corvus.CspellBenchmark.Current.CspellSchema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings.Source<TContext> costs = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.CspellBenchmark.Current.JsonString.Source aff, scoped in Corvus.CspellBenchmark.Current.CspellSchema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings.Source<TContext> costs = default)
            ...
            #endif
        {
            return new Source<TContext>(context, aff, costs);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CspellBenchmark.Current.JsonString.Source aff, in Corvus.CspellBenchmark.Current.CspellSchema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings.Source costs = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.CspellBenchmark.Current.JsonString.Source aff, in Corvus.CspellBenchmark.Current.CspellSchema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings.Source<TContext> costs = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        public static ParsedJsonDocument<HunspellInformation> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<HunspellInformation>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<HunspellInformation> Create<TContext>(
        ...
        public static ParsedJsonDocument<HunspellInformation> Create(in Corvus.CspellBenchmark.Current.JsonString.Source aff, in Corvus.CspellBenchmark.Current.CspellSchema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings.Source costs = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<HunspellInformation> Create<TContext>(in TContext context, in Corvus.CspellBenchmark.Current.JsonString.Source aff, in Corvus.CspellBenchmark.Current.CspellSchema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings.Source<TContext> costs = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
