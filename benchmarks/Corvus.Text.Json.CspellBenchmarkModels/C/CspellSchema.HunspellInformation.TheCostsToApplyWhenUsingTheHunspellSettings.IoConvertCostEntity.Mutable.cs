...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct HunspellInformation
    {
        ...
        public readonly partial struct TheCostsToApplyWhenUsingTheHunspellSettings
        {
            ...
            public readonly partial struct IoConvertCostEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<IoConvertCostEntity, Mutable>(IoConvertCostEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(IoConvertCostEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="IoConvertCostEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator IoConvertCostEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new IoConvertCostEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"IoConvertCostEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="IoConvertCostEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="IoConvertCostEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IoConvertCostEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<IoConvertCostEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="IoConvertCostEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IoConvertCostEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<IoConvertCostEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(IoConvertCostEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<IoConvertCostEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<IoConvertCostEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<IoConvertCostEntity>();
                    }
                    finally
                    {
