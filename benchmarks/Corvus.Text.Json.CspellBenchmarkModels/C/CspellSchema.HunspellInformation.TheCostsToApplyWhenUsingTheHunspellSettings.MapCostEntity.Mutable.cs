        ...
        public readonly partial struct TheCostsToApplyWhenUsingTheHunspellSettings
        {
            ...
            public readonly partial struct MapCostEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MapCostEntity, Mutable>(MapCostEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(MapCostEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="MapCostEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator MapCostEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new MapCostEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"MapCostEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="MapCostEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="MapCostEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MapCostEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<MapCostEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="MapCostEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MapCostEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<MapCostEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(MapCostEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<MapCostEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<MapCostEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<MapCostEntity>();
                    }
                    finally
                    {
