        ...
        public readonly partial struct TheCostsToApplyWhenUsingTheHunspellSettings
        {
            ...
            public readonly partial struct ThisIsTheBaseCostForMakingAnEdit
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ThisIsTheBaseCostForMakingAnEdit, Mutable>(ThisIsTheBaseCostForMakingAnEdit.DefaultInstance);
                    ...
                    public static explicit operator Mutable(ThisIsTheBaseCostForMakingAnEdit instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ThisIsTheBaseCostForMakingAnEdit"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ThisIsTheBaseCostForMakingAnEdit(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ThisIsTheBaseCostForMakingAnEdit.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ThisIsTheBaseCostForMakingAnEdit Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ThisIsTheBaseCostForMakingAnEdit Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ThisIsTheBaseCostForMakingAnEdit>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ThisIsTheBaseCostForMakingAnEdit instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ThisIsTheBaseCostForMakingAnEdit, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ThisIsTheBaseCostForMakingAnEdit> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ThisIsTheBaseCostForMakingAnEdit>();
                    }
                    finally
                    {
