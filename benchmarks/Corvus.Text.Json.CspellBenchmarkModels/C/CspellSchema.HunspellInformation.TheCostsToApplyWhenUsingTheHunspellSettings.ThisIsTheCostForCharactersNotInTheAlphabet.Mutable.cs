        ...
        public readonly partial struct TheCostsToApplyWhenUsingTheHunspellSettings
        {
            ...
            public readonly partial struct ThisIsTheCostForCharactersNotInTheAlphabet
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ThisIsTheCostForCharactersNotInTheAlphabet, Mutable>(ThisIsTheCostForCharactersNotInTheAlphabet.DefaultInstance);
                    ...
                    public static explicit operator Mutable(ThisIsTheCostForCharactersNotInTheAlphabet instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ThisIsTheCostForCharactersNotInTheAlphabet"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ThisIsTheCostForCharactersNotInTheAlphabet(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ThisIsTheCostForCharactersNotInTheAlphabet.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ThisIsTheCostForCharactersNotInTheAlphabet Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ThisIsTheCostForCharactersNotInTheAlphabet Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ThisIsTheCostForCharactersNotInTheAlphabet>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ThisIsTheCostForCharactersNotInTheAlphabet instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ThisIsTheCostForCharactersNotInTheAlphabet, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ThisIsTheCostForCharactersNotInTheAlphabet> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ThisIsTheCostForCharactersNotInTheAlphabet>();
                    }
                    finally
                    {
