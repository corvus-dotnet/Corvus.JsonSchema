...
public readonly partial struct CspellSchema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.CspellBenchmark.Current.JsonString Aff
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AffUtf8, out Corvus.CspellBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CspellBenchmark.Current.CspellSchema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings Costs
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CostsUtf8, out Corvus.CspellBenchmark.Current.CspellSchema.HunspellInformation.TheCostsToApplyWhenUsingTheHunspellSettings value))
                {
                    return value;
                }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Aff"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Aff => [0x55, 0x00, 0x00, 0x00, 0x22, 0x61, 0x66, 0x66, 0x22];

            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Costs"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Costs => [0x75, 0x00, 0x00, 0x00, 0x22, 0x63, 0x6F, 0x73, 0x74, 0x73, 0x22];
        }
    }
}
