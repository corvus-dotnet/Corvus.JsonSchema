        ...
        public readonly partial struct TheCostsToApplyWhenUsingTheHunspellSettings
        {
            ...
            public readonly partial struct TheCostToSubstitutePairsFoundInTheReplaceSettings
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TheCostToSubstitutePairsFoundInTheReplaceSettings, Mutable>(TheCostToSubstitutePairsFoundInTheReplaceSettings.DefaultInstance);
                    ...
                    public static explicit operator Mutable(TheCostToSubstitutePairsFoundInTheReplaceSettings instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="TheCostToSubstitutePairsFoundInTheReplaceSettings"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TheCostToSubstitutePairsFoundInTheReplaceSettings(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TheCostToSubstitutePairsFoundInTheReplaceSettings.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheCostToSubstitutePairsFoundInTheReplaceSettings Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheCostToSubstitutePairsFoundInTheReplaceSettings Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<TheCostToSubstitutePairsFoundInTheReplaceSettings>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(TheCostToSubstitutePairsFoundInTheReplaceSettings instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<TheCostToSubstitutePairsFoundInTheReplaceSettings, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<TheCostToSubstitutePairsFoundInTheReplaceSettings> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<TheCostToSubstitutePairsFoundInTheReplaceSettings>();
                    }
                    finally
                    {
