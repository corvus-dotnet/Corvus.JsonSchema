...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct ImportEntity
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray.Mutable(Mutable value)
            {
                return Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(ImportEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ImportEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ImportEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ImportEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </para>
            /// </remarks>
            public readonly ImportEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ImportEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ImportEntity>(_idx);
            }
            ...
            /// <param name="matchJsonStringArray">Match a <see cref="Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray, TContext, TResult> matchJsonStringArray,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                ...
                {
                    return matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray, TResult> matchJsonStringArray,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.CspellBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray.Mutable.From(this));
                }
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray, TAccumulator, TAccumulator> matchJsonStringArray,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.Mutable, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
                ...
                {
                    matched = true;
                    accumulator = matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray.Mutable.From(this), accumulator);
                }
            ...
            public bool TryGetAsJsonStringArray(out Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray.Mutable result)
            {
                if (Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(ImportEntity instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<ImportEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ImportEntity> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ImportEntity>();
            }
            finally
            {
