...
public readonly partial struct CspellSchema
{
...
#endif
    {
        ...
        public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray(ImportEntity value)
        {
            return Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImportEntity(Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray value)
        {
            return From(value);
        }
        ...
        public bool TryGetAsJsonStringArray(out Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray result)
        {
            ...
            {
                result = Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            if (Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity, TResult> defaultMatch)
        {
            if (Corvus.CspellBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            if (Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray.From(this));
            }
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
            ...
            {
                matched = true;
                accumulator = matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.ImportEntity.JsonStringArray.From(this), accumulator);
            }
