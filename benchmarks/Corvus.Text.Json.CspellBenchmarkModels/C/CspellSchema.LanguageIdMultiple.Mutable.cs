...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct LanguageIdMultiple
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(LanguageIdMultiple instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="LanguageIdMultiple"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LanguageIdMultiple(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LanguageIdMultiple.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly LanguageIdMultiple Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly LanguageIdMultiple Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<LanguageIdMultiple>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(LanguageIdMultiple instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<LanguageIdMultiple, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<LanguageIdMultiple> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<LanguageIdMultiple>();
            }
            finally
            {
