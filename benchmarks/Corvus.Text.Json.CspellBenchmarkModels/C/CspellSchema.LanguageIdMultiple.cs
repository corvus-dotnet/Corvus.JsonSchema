...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct LanguageIdMultiple
#if NET8_0_OR_GREATER
        : IJsonElement<LanguageIdMultiple>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LanguageIdMultiple"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal LanguageIdMultiple(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static LanguageIdMultiple DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(LanguageIdMultiple value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in LanguageIdMultiple left, in LanguageIdMultiple right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in LanguageIdMultiple left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(LanguageIdMultiple instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator LanguageIdMultiple(JsonElement instance)
        {
            return LanguageIdMultiple.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LanguageIdMultiple From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LanguageIdMultiple ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<LanguageIdMultiple>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LanguageIdMultiple ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<LanguageIdMultiple>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LanguageIdMultiple ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<LanguageIdMultiple>(json, options);
        }
        ...
        /// </exception>
        public static LanguageIdMultiple ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<LanguageIdMultiple>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out LanguageIdMultiple? result)
        {
            return JsonElementHelpers.TryParseValue<LanguageIdMultiple>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new LanguageIdMultiple(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static LanguageIdMultiple IJsonElement<LanguageIdMultiple>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"LanguageIdMultiple: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="LanguageIdMultiple"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="LanguageIdMultiple"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public LanguageIdMultiple Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<LanguageIdMultiple>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="LanguageIdMultiple"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public LanguageIdMultiple Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<LanguageIdMultiple>(_idx);
            }
