...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct LanguageIdMultipleNeg
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(LanguageIdMultipleNeg instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="LanguageIdMultipleNeg"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LanguageIdMultipleNeg(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LanguageIdMultipleNeg.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly LanguageIdMultipleNeg Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly LanguageIdMultipleNeg Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<LanguageIdMultipleNeg>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(LanguageIdMultipleNeg instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<LanguageIdMultipleNeg, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<LanguageIdMultipleNeg> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<LanguageIdMultipleNeg>();
            }
            finally
            {
