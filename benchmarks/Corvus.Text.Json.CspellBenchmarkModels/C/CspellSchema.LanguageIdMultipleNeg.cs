...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct LanguageIdMultipleNeg
#if NET8_0_OR_GREATER
        : IJsonElement<LanguageIdMultipleNeg>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LanguageIdMultipleNeg"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal LanguageIdMultipleNeg(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static LanguageIdMultipleNeg DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(LanguageIdMultipleNeg value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in LanguageIdMultipleNeg left, in LanguageIdMultipleNeg right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in LanguageIdMultipleNeg left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(LanguageIdMultipleNeg instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator LanguageIdMultipleNeg(JsonElement instance)
        {
            return LanguageIdMultipleNeg.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LanguageIdMultipleNeg From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LanguageIdMultipleNeg ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<LanguageIdMultipleNeg>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LanguageIdMultipleNeg ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<LanguageIdMultipleNeg>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LanguageIdMultipleNeg ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<LanguageIdMultipleNeg>(json, options);
        }
        ...
        /// </exception>
        public static LanguageIdMultipleNeg ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<LanguageIdMultipleNeg>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out LanguageIdMultipleNeg? result)
        {
            return JsonElementHelpers.TryParseValue<LanguageIdMultipleNeg>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new LanguageIdMultipleNeg(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static LanguageIdMultipleNeg IJsonElement<LanguageIdMultipleNeg>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"LanguageIdMultipleNeg: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="LanguageIdMultipleNeg"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="LanguageIdMultipleNeg"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public LanguageIdMultipleNeg Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<LanguageIdMultipleNeg>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="LanguageIdMultipleNeg"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public LanguageIdMultipleNeg Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<LanguageIdMultipleNeg>(_idx);
            }
