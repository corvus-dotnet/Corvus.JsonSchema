...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct LanguageIdSingleArray
    {
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CspellBenchmark.Current.CspellSchema.LanguageIdSingleArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Current.CspellSchema.LanguageIdSingleArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
