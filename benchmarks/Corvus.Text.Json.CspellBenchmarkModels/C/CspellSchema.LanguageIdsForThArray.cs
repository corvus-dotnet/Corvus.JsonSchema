...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct LanguageIdsForThArray
        ...
        : IJsonElement<LanguageIdsForThArray>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LanguageIdsForThArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal LanguageIdsForThArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static LanguageIdsForThArray DefaultInstance { get; }
        ...
        public Corvus.CspellBenchmark.Current.CspellSchema.LanguageIdSingle this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Current.CspellSchema.LanguageIdSingle>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.LanguageIdSingle> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.LanguageIdSingle>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in LanguageIdsForThArray left, in LanguageIdsForThArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in LanguageIdsForThArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(LanguageIdsForThArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator LanguageIdsForThArray(JsonElement instance)
        {
            return LanguageIdsForThArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LanguageIdsForThArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LanguageIdsForThArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<LanguageIdsForThArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LanguageIdsForThArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<LanguageIdsForThArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LanguageIdsForThArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<LanguageIdsForThArray>(json, options);
        }
        ...
        /// </exception>
        public static LanguageIdsForThArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<LanguageIdsForThArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out LanguageIdsForThArray? result)
        {
            return JsonElementHelpers.TryParseValue<LanguageIdsForThArray>(ref reader, out result);
        }
...
#if NET
        static LanguageIdsForThArray IJsonElement<LanguageIdsForThArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"LanguageIdsForThArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public LanguageIdsForThArray Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public LanguageIdsForThArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<LanguageIdsForThArray>(_idx);
            }
