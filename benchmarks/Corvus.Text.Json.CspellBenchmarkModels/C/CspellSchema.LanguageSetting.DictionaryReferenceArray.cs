...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct LanguageSetting
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DictionaryReferenceArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal DictionaryReferenceArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static DictionaryReferenceArray DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in DictionaryReferenceArray left, in DictionaryReferenceArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in DictionaryReferenceArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(DictionaryReferenceArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DictionaryReferenceArray(JsonElement instance)
            {
                return DictionaryReferenceArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DictionaryReferenceArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DictionaryReferenceArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DictionaryReferenceArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DictionaryReferenceArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DictionaryReferenceArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DictionaryReferenceArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DictionaryReferenceArray>(json, options);
            }
            ...
            /// </exception>
            public static DictionaryReferenceArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<DictionaryReferenceArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out DictionaryReferenceArray? result)
            {
                return JsonElementHelpers.TryParseValue<DictionaryReferenceArray>(ref reader, out result);
            }
...
#if NET
            static DictionaryReferenceArray IJsonElement<DictionaryReferenceArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DictionaryReferenceArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public DictionaryReferenceArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public DictionaryReferenceArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<DictionaryReferenceArray>(_idx);
                }
