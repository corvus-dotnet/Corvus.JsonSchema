        ...
        public readonly partial struct LocalEntity
        {
            ...
            public readonly partial struct JsonStringArray
            {
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
