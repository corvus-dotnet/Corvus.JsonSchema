    ...
    public readonly partial struct LanguageSetting
    {
        ...
        public readonly partial struct LocalEntity
        {
...
#endif
            {
                ...
                public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray.Mutable(Mutable value)
                {
                    return Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray.Mutable value)
                {
                    return From(value);
                }
                ...
                public static explicit operator Mutable(LocalEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="LocalEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LocalEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LocalEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public readonly LocalEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly LocalEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<LocalEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    ...
                    {
                        return matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.CspellBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                    ...
                    if (Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray.Mutable.From(this));
                    }
                ...
                public TAccumulator MatchEvery<TAccumulator>(
                    ...
                    Matcher<Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.Mutable, TAccumulator, TAccumulator> defaultMatch)
                {
                    bool matched = false;
                    ...
                    {
                        matched = true;
                        accumulator = matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray.Mutable.From(this), accumulator);
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsJsonStringArray(out Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray.Mutable result)
                {
                    if (Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(LocalEntity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<LocalEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<LocalEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<LocalEntity>();
                }
                finally
                {
