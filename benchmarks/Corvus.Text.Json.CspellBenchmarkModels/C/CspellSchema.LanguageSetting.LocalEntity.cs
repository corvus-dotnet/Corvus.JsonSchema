...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct LanguageSetting
    {
        ...
        public readonly partial struct LocalEntity
#if NET8_0_OR_GREATER
            : IJsonElement<LocalEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="LocalEntity"/> struct.
            /// </summary>
            ...
            internal LocalEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static LocalEntity DefaultInstance { get; }
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray(LocalEntity value)
            {
                return Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator LocalEntity(Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray value)
            {
                return From(value);
            }

            /// <summary>
            /// Conversion from the <see cref="Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray"/> mutable view.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator LocalEntity(Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray.Mutable value)
            {
                return From(value);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(LocalEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in LocalEntity left, in LocalEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in LocalEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(LocalEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LocalEntity(JsonElement instance)
            {
                return LocalEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LocalEntity From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LocalEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<LocalEntity>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LocalEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<LocalEntity>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LocalEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<LocalEntity>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static LocalEntity ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<LocalEntity>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out LocalEntity? result)
            {
                return JsonElementHelpers.TryParseValue<LocalEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new LocalEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static LocalEntity IJsonElement<LocalEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LocalEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="LocalEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="LocalEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public LocalEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<LocalEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="LocalEntity"/> that lives for the lifetime of its
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsJsonStringArray(out Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray result)
            {
                if (Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray.From(this);
                    return true;
                }
            ...
            /// <param name="matchJsonStringArray">Match a <see cref="Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray, TContext, TResult> matchJsonStringArray,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                if (Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray, TResult> matchJsonStringArray,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity, TResult> defaultMatch)
            {
                if (Corvus.CspellBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray.From(this));
                }
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray, TAccumulator, TAccumulator> matchJsonStringArray,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
                ...
                {
                    matched = true;
                    accumulator = matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocalEntity.JsonStringArray.From(this), accumulator);
                }
