    ...
    public readonly partial struct LanguageSetting
    {
        ...
        public readonly partial struct LocaleEntity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Conversion to <see cref="Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray.Mutable(Mutable value)
                {
                    return Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray.Mutable.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray.Mutable value)
                {
                    return From(value);
                }
                ...
                /// <param name="matchJsonStringArray">Match a <see cref="Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray, TContext, TResult> matchJsonStringArray,
                    Matcher<Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    ...
                    if (Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray, TResult> matchJsonStringArray,
                    Matcher<Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.CspellBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                    ...
                    if (Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray.Mutable.From(this));
                    }
                ...
                public TAccumulator MatchEvery<TAccumulator>(
                    ...
                    Matcher<Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray, TAccumulator, TAccumulator> matchJsonStringArray,
                    Matcher<Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.Mutable, TAccumulator, TAccumulator> defaultMatch)
                {
                    bool matched = false;
                    ...
                    {
                        matched = true;
                        accumulator = matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray.Mutable.From(this), accumulator);
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsJsonStringArray(out Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray.Mutable result)
                {
                    if (Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public static ParsedJsonDocument<LocaleEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<LocaleEntity>();
                }
                finally
                {
