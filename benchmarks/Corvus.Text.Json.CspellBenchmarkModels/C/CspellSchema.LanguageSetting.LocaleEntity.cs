...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct LanguageSetting
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray(LocaleEntity value)
            {
                return Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator LocaleEntity(Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray value)
            {
                return From(value);
            }
            ...
            public bool TryGetAsJsonStringArray(out Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray result)
            {
                ...
                {
                    result = Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray.From(this);
                    return true;
                }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                if (Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity, TResult> defaultMatch)
            {
                if (Corvus.CspellBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray.From(this));
                }
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
                ...
                {
                    matched = true;
                    accumulator = matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.LocaleEntity.JsonStringArray.From(this), accumulator);
                }
