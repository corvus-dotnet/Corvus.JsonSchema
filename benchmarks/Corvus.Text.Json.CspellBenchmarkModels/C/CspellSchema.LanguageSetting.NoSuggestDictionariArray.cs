...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct LanguageSetting
    {
        ...
        public readonly partial struct NoSuggestDictionariArray
            ...
            : IJsonElement<NoSuggestDictionariArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="NoSuggestDictionariArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal NoSuggestDictionariArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static NoSuggestDictionariArray DefaultInstance { get; }
            ...
            public Corvus.CspellBenchmark.Current.CspellSchema.DictionaryReference this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryReference>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryReference> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryReference>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in NoSuggestDictionariArray left, in NoSuggestDictionariArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in NoSuggestDictionariArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(NoSuggestDictionariArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NoSuggestDictionariArray(JsonElement instance)
            {
                return NoSuggestDictionariArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NoSuggestDictionariArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NoSuggestDictionariArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NoSuggestDictionariArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NoSuggestDictionariArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NoSuggestDictionariArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NoSuggestDictionariArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NoSuggestDictionariArray>(json, options);
            }
            ...
            /// </exception>
            public static NoSuggestDictionariArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<NoSuggestDictionariArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out NoSuggestDictionariArray? result)
            {
                return JsonElementHelpers.TryParseValue<NoSuggestDictionariArray>(ref reader, out result);
            }
...
#if NET
            static NoSuggestDictionariArray IJsonElement<NoSuggestDictionariArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"NoSuggestDictionariArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public NoSuggestDictionariArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public NoSuggestDictionariArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<NoSuggestDictionariArray>(_idx);
                }
