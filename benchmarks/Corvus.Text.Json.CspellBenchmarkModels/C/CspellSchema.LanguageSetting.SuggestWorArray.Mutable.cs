...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct LanguageSetting
    {
        ...
        public readonly partial struct SuggestWorArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SuggestWorArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SuggestWorArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SuggestWorArray(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new SuggestWorArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SuggestWorArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// <summary>
                /// Gets a <see cref="SuggestWorArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="SuggestWorArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly SuggestWorArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<SuggestWorArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="SuggestWorArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly SuggestWorArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SuggestWorArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.SuggestWorArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(SuggestWorArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.SuggestWorArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<SuggestWorArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SuggestWorArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SuggestWorArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<SuggestWorArray> Create<TContext>(
