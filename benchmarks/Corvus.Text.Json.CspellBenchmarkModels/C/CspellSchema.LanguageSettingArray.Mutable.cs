...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct LanguageSettingArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(LanguageSettingArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="LanguageSettingArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LanguageSettingArray(Mutable instance)
            {
            ...
            public Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new LanguageSettingArray(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LanguageSettingArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, scoped in Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(scoped in Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting oldItem, in Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting current = enumerator.Current;
            ...
            /// <summary>
            /// Gets a <see cref="LanguageSettingArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="LanguageSettingArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly LanguageSettingArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<LanguageSettingArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="LanguageSettingArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly LanguageSettingArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<LanguageSettingArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CspellBenchmark.Current.CspellSchema.LanguageSettingArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(LanguageSettingArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Current.CspellSchema.LanguageSettingArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            public void AddItem(in Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.Source value)
            {
            ...
            /// Add an item to the array.
            /// </summary>
            public void AddItem<TContext>(in Corvus.CspellBenchmark.Current.CspellSchema.LanguageSetting.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        {
            return workspace.CreateBuilder<LanguageSettingArray, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<LanguageSettingArray> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<LanguageSettingArray>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<LanguageSettingArray> Create<TContext>(
