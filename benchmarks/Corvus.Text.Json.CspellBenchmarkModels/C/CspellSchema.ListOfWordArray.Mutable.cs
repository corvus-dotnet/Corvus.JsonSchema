...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct ListOfWordArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ListOfWordArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ListOfWordArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ListOfWordArray(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ListOfWordArray(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ListOfWordArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// <summary>
            /// Gets a <see cref="ListOfWordArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ListOfWordArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ListOfWordArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ListOfWordArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ListOfWordArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ListOfWordArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ListOfWordArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CspellBenchmark.Current.CspellSchema.ListOfWordArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(ListOfWordArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Current.CspellSchema.ListOfWordArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<ListOfWordArray, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ListOfWordArray> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ListOfWordArray>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ListOfWordArray> Create<TContext>(
