...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct LoadDefaultConfigurationEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<LoadDefaultConfigurationEntity, Mutable>(LoadDefaultConfigurationEntity.DefaultInstance);
            ...
            public static explicit operator Mutable(LoadDefaultConfigurationEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="LoadDefaultConfigurationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LoadDefaultConfigurationEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LoadDefaultConfigurationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly LoadDefaultConfigurationEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly LoadDefaultConfigurationEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<LoadDefaultConfigurationEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(LoadDefaultConfigurationEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<LoadDefaultConfigurationEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<LoadDefaultConfigurationEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<LoadDefaultConfigurationEntity>();
            }
            finally
            {
