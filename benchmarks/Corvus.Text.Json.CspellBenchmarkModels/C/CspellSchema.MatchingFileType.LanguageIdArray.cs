...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct MatchingFileType
    {
        ...
        public readonly partial struct LanguageIdArray
#if NET8_0_OR_GREATER
            : IJsonElement<LanguageIdArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="LanguageIdArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal LanguageIdArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static LanguageIdArray DefaultInstance { get; }
            ...
            public Corvus.CspellBenchmark.Current.CspellSchema.LanguageId this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Current.CspellSchema.LanguageId>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.LanguageId> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.LanguageId>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in LanguageIdArray left, in LanguageIdArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in LanguageIdArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(LanguageIdArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LanguageIdArray(JsonElement instance)
            {
                return LanguageIdArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LanguageIdArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LanguageIdArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LanguageIdArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LanguageIdArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LanguageIdArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LanguageIdArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LanguageIdArray>(json, options);
            }
            ...
            /// </exception>
            public static LanguageIdArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<LanguageIdArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out LanguageIdArray? result)
            {
                return JsonElementHelpers.TryParseValue<LanguageIdArray>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new LanguageIdArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static LanguageIdArray IJsonElement<LanguageIdArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LanguageIdArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="LanguageIdArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="LanguageIdArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public LanguageIdArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<LanguageIdArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="LanguageIdArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public LanguageIdArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<LanguageIdArray>(_idx);
                }
