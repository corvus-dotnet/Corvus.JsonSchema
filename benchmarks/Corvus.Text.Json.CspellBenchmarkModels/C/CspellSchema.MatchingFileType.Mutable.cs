...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct MatchingFileType
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.LanguageId.Mutable(Mutable value)
            {
                return Corvus.CspellBenchmark.Current.CspellSchema.LanguageId.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.CspellBenchmark.Current.CspellSchema.LanguageId.Mutable value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.MatchingFileType.LanguageIdArray.Mutable(Mutable value)
            {
                return Corvus.CspellBenchmark.Current.CspellSchema.MatchingFileType.LanguageIdArray.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.CspellBenchmark.Current.CspellSchema.MatchingFileType.LanguageIdArray.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(MatchingFileType instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MatchingFileType"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MatchingFileType(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MatchingFileType.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </para>
            /// </remarks>
            public readonly MatchingFileType Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MatchingFileType Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MatchingFileType>(_idx);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.MatchingFileType.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                ...
                {
                    return matchLanguageId(Corvus.CspellBenchmark.Current.CspellSchema.LanguageId.Mutable.From(this), context);
                }

                if (Corvus.CspellBenchmark.Current.CspellSchema.MatchingFileType.LanguageIdArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchLanguageIdArray(Corvus.CspellBenchmark.Current.CspellSchema.MatchingFileType.LanguageIdArray.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.MatchingFileType.Mutable, TResult> defaultMatch)
            {
                if (Corvus.CspellBenchmark.Current.CspellSchema.LanguageId.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchLanguageId(Corvus.CspellBenchmark.Current.CspellSchema.LanguageId.Mutable.From(this));
                }

                if (Corvus.CspellBenchmark.Current.CspellSchema.MatchingFileType.LanguageIdArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchLanguageIdArray(Corvus.CspellBenchmark.Current.CspellSchema.MatchingFileType.LanguageIdArray.Mutable.From(this));
                }
            ...
            public bool TryGetAsLanguageId(out Corvus.CspellBenchmark.Current.CspellSchema.LanguageId.Mutable result)
            {
                if (Corvus.CspellBenchmark.Current.CspellSchema.LanguageId.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Current.CspellSchema.LanguageId.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsLanguageIdArray(out Corvus.CspellBenchmark.Current.CspellSchema.MatchingFileType.LanguageIdArray.Mutable result)
            {
                if (Corvus.CspellBenchmark.Current.CspellSchema.MatchingFileType.LanguageIdArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Current.CspellSchema.MatchingFileType.LanguageIdArray.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CspellBenchmark.Current.CspellSchema.MatchingFileType.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(MatchingFileType instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.CspellBenchmark.Current.CspellSchema.LanguageId instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Current.CspellSchema.MatchingFileType.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<MatchingFileType, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MatchingFileType> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MatchingFileType>();
            }
            finally
            {
