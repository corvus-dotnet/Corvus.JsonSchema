...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct NoConfigSearchEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NoConfigSearchEntity, Mutable>(NoConfigSearchEntity.DefaultInstance);
        ...
        public static ParsedJsonDocument<NoConfigSearchEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<NoConfigSearchEntity>();
            }
            finally
            {
