...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct NoConfigSearchEntity
#if NET8_0_OR_GREATER
        : IJsonElement<NoConfigSearchEntity>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NoConfigSearchEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal NoConfigSearchEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static NoConfigSearchEntity DefaultInstance { get; } = ParsedJsonDocument<NoConfigSearchEntity>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(NoConfigSearchEntity value)
        {
        ...
        /// </returns>
        public static bool operator ==(in NoConfigSearchEntity left, in NoConfigSearchEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in NoConfigSearchEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(NoConfigSearchEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NoConfigSearchEntity(JsonElement instance)
        {
            return NoConfigSearchEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NoConfigSearchEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NoConfigSearchEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<NoConfigSearchEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NoConfigSearchEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<NoConfigSearchEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NoConfigSearchEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<NoConfigSearchEntity>(json, options);
        }
        ...
        /// </exception>
        public static NoConfigSearchEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<NoConfigSearchEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out NoConfigSearchEntity? result)
        {
            return JsonElementHelpers.TryParseValue<NoConfigSearchEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new NoConfigSearchEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static NoConfigSearchEntity IJsonElement<NoConfigSearchEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NoConfigSearchEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="NoConfigSearchEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="NoConfigSearchEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public NoConfigSearchEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<NoConfigSearchEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="NoConfigSearchEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public NoConfigSearchEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<NoConfigSearchEntity>(_idx);
            }
