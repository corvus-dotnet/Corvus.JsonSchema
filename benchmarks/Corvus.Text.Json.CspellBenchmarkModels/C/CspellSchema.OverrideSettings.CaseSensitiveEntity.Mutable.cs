    ...
    public readonly partial struct OverrideSettings
    {
        ...
        public readonly partial struct CaseSensitiveEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<CaseSensitiveEntity, Mutable>(CaseSensitiveEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(CaseSensitiveEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CaseSensitiveEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CaseSensitiveEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CaseSensitiveEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly CaseSensitiveEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly CaseSensitiveEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CaseSensitiveEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(CaseSensitiveEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<CaseSensitiveEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<CaseSensitiveEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<CaseSensitiveEntity>();
                }
                finally
                {
