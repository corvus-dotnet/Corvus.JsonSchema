...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct OverrideSettings
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DictionaryDefinitionArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal DictionaryDefinitionArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static DictionaryDefinitionArray DefaultInstance { get; }
            ...
            public Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinition this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinition>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinition> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.DictionaryDefinition>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in DictionaryDefinitionArray left, in DictionaryDefinitionArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in DictionaryDefinitionArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(DictionaryDefinitionArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DictionaryDefinitionArray(JsonElement instance)
            {
                return DictionaryDefinitionArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DictionaryDefinitionArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DictionaryDefinitionArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DictionaryDefinitionArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DictionaryDefinitionArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DictionaryDefinitionArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DictionaryDefinitionArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DictionaryDefinitionArray>(json, options);
            }
            ...
            /// </exception>
            public static DictionaryDefinitionArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<DictionaryDefinitionArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out DictionaryDefinitionArray? result)
            {
                return JsonElementHelpers.TryParseValue<DictionaryDefinitionArray>(ref reader, out result);
            }
...
#if NET
            static DictionaryDefinitionArray IJsonElement<DictionaryDefinitionArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DictionaryDefinitionArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public DictionaryDefinitionArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public DictionaryDefinitionArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<DictionaryDefinitionArray>(_idx);
                }
