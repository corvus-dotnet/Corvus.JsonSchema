    ...
    public readonly partial struct OverrideSettings
    {
        ...
        public readonly partial struct IsTheSpellCheckerEnabled
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<IsTheSpellCheckerEnabled, Mutable>(IsTheSpellCheckerEnabled.DefaultInstance);
                ...
                public static explicit operator Mutable(IsTheSpellCheckerEnabled instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="IsTheSpellCheckerEnabled"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IsTheSpellCheckerEnabled(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IsTheSpellCheckerEnabled.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly IsTheSpellCheckerEnabled Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly IsTheSpellCheckerEnabled Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<IsTheSpellCheckerEnabled>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(IsTheSpellCheckerEnabled instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<IsTheSpellCheckerEnabled, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<IsTheSpellCheckerEnabled> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<IsTheSpellCheckerEnabled>();
                }
                finally
                {
