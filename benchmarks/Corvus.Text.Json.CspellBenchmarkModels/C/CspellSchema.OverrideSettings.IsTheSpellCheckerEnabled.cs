...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct OverrideSettings
    {
        ...
        public readonly partial struct IsTheSpellCheckerEnabled
#if NET8_0_OR_GREATER
            : IJsonElement<IsTheSpellCheckerEnabled>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="IsTheSpellCheckerEnabled"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal IsTheSpellCheckerEnabled(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static IsTheSpellCheckerEnabled DefaultInstance { get; } = ParsedJsonDocument<IsTheSpellCheckerEnabled>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(IsTheSpellCheckerEnabled value)
            {
            ...
            /// </returns>
            public static bool operator ==(in IsTheSpellCheckerEnabled left, in IsTheSpellCheckerEnabled right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in IsTheSpellCheckerEnabled left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(IsTheSpellCheckerEnabled instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator IsTheSpellCheckerEnabled(JsonElement instance)
            {
                return IsTheSpellCheckerEnabled.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IsTheSpellCheckerEnabled From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IsTheSpellCheckerEnabled ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IsTheSpellCheckerEnabled>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IsTheSpellCheckerEnabled ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IsTheSpellCheckerEnabled>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IsTheSpellCheckerEnabled ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IsTheSpellCheckerEnabled>(json, options);
            }
            ...
            /// </exception>
            public static IsTheSpellCheckerEnabled ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<IsTheSpellCheckerEnabled>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out IsTheSpellCheckerEnabled? result)
            {
                return JsonElementHelpers.TryParseValue<IsTheSpellCheckerEnabled>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new IsTheSpellCheckerEnabled(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static IsTheSpellCheckerEnabled IJsonElement<IsTheSpellCheckerEnabled>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"IsTheSpellCheckerEnabled: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="IsTheSpellCheckerEnabled"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="IsTheSpellCheckerEnabled"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public IsTheSpellCheckerEnabled Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<IsTheSpellCheckerEnabled>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="IsTheSpellCheckerEnabled"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public IsTheSpellCheckerEnabled Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<IsTheSpellCheckerEnabled>(_idx);
                }
