    ...
    public readonly partial struct OverrideSettings
    {
        ...
        public readonly partial struct LanguageIdSingleArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(LanguageIdSingleArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="LanguageIdSingleArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LanguageIdSingleArray(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LanguageIdSingleArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public readonly LanguageIdSingleArray Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly LanguageIdSingleArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<LanguageIdSingleArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CspellBenchmark.Current.CspellSchema.OverrideSettings.LanguageIdSingleArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(LanguageIdSingleArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CspellBenchmark.Current.CspellSchema.OverrideSettings.LanguageIdSingleArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<LanguageIdSingleArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<LanguageIdSingleArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<LanguageIdSingleArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<LanguageIdSingleArray> Create<TContext>(
