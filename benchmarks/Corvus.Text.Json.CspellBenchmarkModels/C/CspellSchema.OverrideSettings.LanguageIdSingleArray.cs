...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct OverrideSettings
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="LanguageIdSingleArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal LanguageIdSingleArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static LanguageIdSingleArray DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in LanguageIdSingleArray left, in LanguageIdSingleArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in LanguageIdSingleArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(LanguageIdSingleArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LanguageIdSingleArray(JsonElement instance)
            {
                return LanguageIdSingleArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LanguageIdSingleArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LanguageIdSingleArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LanguageIdSingleArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LanguageIdSingleArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LanguageIdSingleArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LanguageIdSingleArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LanguageIdSingleArray>(json, options);
            }
            ...
            /// </exception>
            public static LanguageIdSingleArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<LanguageIdSingleArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out LanguageIdSingleArray? result)
            {
                return JsonElementHelpers.TryParseValue<LanguageIdSingleArray>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new LanguageIdSingleArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static LanguageIdSingleArray IJsonElement<LanguageIdSingleArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LanguageIdSingleArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="LanguageIdSingleArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="LanguageIdSingleArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public LanguageIdSingleArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<LanguageIdSingleArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="LanguageIdSingleArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public LanguageIdSingleArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<LanguageIdSingleArray>(_idx);
                }
