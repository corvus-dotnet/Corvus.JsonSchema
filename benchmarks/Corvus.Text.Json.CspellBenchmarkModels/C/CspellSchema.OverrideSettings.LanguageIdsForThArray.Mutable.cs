...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct OverrideSettings
    {
        ...
        public readonly partial struct LanguageIdsForThArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(LanguageIdsForThArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="LanguageIdsForThArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LanguageIdsForThArray(Mutable instance)
                {
                ...
                public Corvus.CspellBenchmark.Current.CspellSchema.LanguageIdSingle.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Current.CspellSchema.LanguageIdSingle.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.LanguageIdSingle.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.LanguageIdSingle.Mutable>(_parent, _idx);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new LanguageIdsForThArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LanguageIdsForThArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.CspellBenchmark.Current.CspellSchema.LanguageIdSingle.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, scoped in Corvus.CspellBenchmark.Current.CspellSchema.LanguageIdSingle.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(scoped in Corvus.CspellBenchmark.Current.CspellSchema.LanguageIdSingle.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.CspellBenchmark.Current.CspellSchema.LanguageIdSingle item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.CspellBenchmark.Current.CspellSchema.LanguageIdSingle>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.CspellBenchmark.Current.CspellSchema.LanguageIdSingle> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.CspellBenchmark.Current.CspellSchema.LanguageIdSingle>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.CspellBenchmark.Current.CspellSchema.LanguageIdSingle oldItem, in Corvus.CspellBenchmark.Current.CspellSchema.LanguageIdSingle.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.LanguageIdSingle>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.CspellBenchmark.Current.CspellSchema.LanguageIdSingle current = enumerator.Current;
                ...
                /// <summary>
                /// Gets a <see cref="LanguageIdsForThArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="LanguageIdsForThArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly LanguageIdsForThArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<LanguageIdsForThArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="LanguageIdsForThArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly LanguageIdsForThArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<LanguageIdsForThArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CspellBenchmark.Current.CspellSchema.OverrideSettings.LanguageIdsForThArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(LanguageIdsForThArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CspellBenchmark.Current.CspellSchema.OverrideSettings.LanguageIdsForThArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                public void AddItem(in Corvus.CspellBenchmark.Current.CspellSchema.LanguageIdSingle.Source value)
                {
            ...
            {
                return workspace.CreateBuilder<LanguageIdsForThArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<LanguageIdsForThArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<LanguageIdsForThArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<LanguageIdsForThArray> Create<TContext>(
