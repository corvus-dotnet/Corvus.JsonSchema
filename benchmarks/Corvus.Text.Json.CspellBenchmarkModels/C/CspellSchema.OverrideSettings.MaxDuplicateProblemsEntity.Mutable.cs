...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct OverrideSettings
    {
        ...
        public readonly partial struct MaxDuplicateProblemsEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MaxDuplicateProblemsEntity, Mutable>(MaxDuplicateProblemsEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(MaxDuplicateProblemsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MaxDuplicateProblemsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MaxDuplicateProblemsEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new MaxDuplicateProblemsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MaxDuplicateProblemsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="MaxDuplicateProblemsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="MaxDuplicateProblemsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly MaxDuplicateProblemsEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<MaxDuplicateProblemsEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="MaxDuplicateProblemsEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly MaxDuplicateProblemsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MaxDuplicateProblemsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MaxDuplicateProblemsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MaxDuplicateProblemsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MaxDuplicateProblemsEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MaxDuplicateProblemsEntity>();
                }
                finally
                {
