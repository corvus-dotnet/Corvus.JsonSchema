...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct OverrideSettings
    {
        ...
        public readonly partial struct MinWordLengthEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MinWordLengthEntity, Mutable>(MinWordLengthEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(MinWordLengthEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MinWordLengthEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MinWordLengthEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new MinWordLengthEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MinWordLengthEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="MinWordLengthEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="MinWordLengthEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly MinWordLengthEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<MinWordLengthEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="MinWordLengthEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly MinWordLengthEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MinWordLengthEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MinWordLengthEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MinWordLengthEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MinWordLengthEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MinWordLengthEntity>();
                }
                finally
                {
