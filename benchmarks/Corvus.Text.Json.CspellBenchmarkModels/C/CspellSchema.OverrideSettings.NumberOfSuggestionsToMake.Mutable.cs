    ...
    public readonly partial struct OverrideSettings
    {
        ...
        public readonly partial struct NumberOfSuggestionsToMake
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NumberOfSuggestionsToMake, Mutable>(NumberOfSuggestionsToMake.DefaultInstance);
                ...
                public static explicit operator Mutable(NumberOfSuggestionsToMake instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="NumberOfSuggestionsToMake"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator NumberOfSuggestionsToMake(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new NumberOfSuggestionsToMake(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"NumberOfSuggestionsToMake.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="NumberOfSuggestionsToMake"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="NumberOfSuggestionsToMake"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly NumberOfSuggestionsToMake Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<NumberOfSuggestionsToMake>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="NumberOfSuggestionsToMake"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly NumberOfSuggestionsToMake Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<NumberOfSuggestionsToMake>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(NumberOfSuggestionsToMake instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<NumberOfSuggestionsToMake, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<NumberOfSuggestionsToMake> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<NumberOfSuggestionsToMake>();
                }
                finally
                {
