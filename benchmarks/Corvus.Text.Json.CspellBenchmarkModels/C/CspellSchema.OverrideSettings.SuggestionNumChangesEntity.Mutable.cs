    ...
    public readonly partial struct OverrideSettings
    {
        ...
        public readonly partial struct SuggestionNumChangesEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SuggestionNumChangesEntity, Mutable>(SuggestionNumChangesEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(SuggestionNumChangesEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SuggestionNumChangesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SuggestionNumChangesEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new SuggestionNumChangesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SuggestionNumChangesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="SuggestionNumChangesEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="SuggestionNumChangesEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly SuggestionNumChangesEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<SuggestionNumChangesEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="SuggestionNumChangesEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly SuggestionNumChangesEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SuggestionNumChangesEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SuggestionNumChangesEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SuggestionNumChangesEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SuggestionNumChangesEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SuggestionNumChangesEntity>();
                }
                finally
                {
