...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct OverrideSettings
    {
        ...
        public readonly partial struct SuggestionsTimeoutEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SuggestionsTimeoutEntity, Mutable>(SuggestionsTimeoutEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(SuggestionsTimeoutEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SuggestionsTimeoutEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SuggestionsTimeoutEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new SuggestionsTimeoutEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SuggestionsTimeoutEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="SuggestionsTimeoutEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="SuggestionsTimeoutEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly SuggestionsTimeoutEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<SuggestionsTimeoutEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="SuggestionsTimeoutEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly SuggestionsTimeoutEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SuggestionsTimeoutEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SuggestionsTimeoutEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SuggestionsTimeoutEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SuggestionsTimeoutEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SuggestionsTimeoutEntity>();
                }
                finally
                {
