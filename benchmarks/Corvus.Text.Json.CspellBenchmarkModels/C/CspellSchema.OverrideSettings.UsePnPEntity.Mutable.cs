    ...
    public readonly partial struct OverrideSettings
    {
        ...
        public readonly partial struct UsePnPEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<UsePnPEntity, Mutable>(UsePnPEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(UsePnPEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="UsePnPEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator UsePnPEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"UsePnPEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly UsePnPEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly UsePnPEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<UsePnPEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(UsePnPEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<UsePnPEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<UsePnPEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<UsePnPEntity>();
                }
                finally
                {
