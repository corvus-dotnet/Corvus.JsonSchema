...
public readonly partial struct CspellSchema
{
...
#endif
    {
        ...
        public Corvus.CspellBenchmark.Current.CspellSchema.OverrideSettings this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Current.CspellSchema.OverrideSettings>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.OverrideSettings> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.OverrideSettings>(_parent, _idx);
        }
