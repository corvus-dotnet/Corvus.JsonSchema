...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct PatternAdjustment
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PatternAdjustment instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PatternAdjustment"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PatternAdjustment(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.CspellBenchmark.Current.JsonString.Mutable Regexp
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RegexpUtf8, out Corvus.CspellBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PatternAdjustment(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetPenalty(scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("penalty");
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetRegexp(scoped in Corvus.CspellBenchmark.Current.JsonString.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("regexp");
                }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PatternAdjustment.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="PatternAdjustment"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="PatternAdjustment"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly PatternAdjustment Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<PatternAdjustment>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="PatternAdjustment"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly PatternAdjustment Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PatternAdjustment>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CspellBenchmark.Current.CspellSchema.PatternAdjustment.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.CspellBenchmark.Current.JsonString.Source arg1, scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source arg2, scoped in Corvus.CspellBenchmark.Current.JsonString.Source arg3)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            public static implicit operator Source(PatternAdjustment instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Current.CspellSchema.PatternAdjustment.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="PatternAdjustment"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.CspellBenchmark.Current.JsonString.Source id,
                in Corvus.CspellBenchmark.Current.JsonNumber.Source penalty,
                in Corvus.CspellBenchmark.Current.JsonString.Source regexp)
            {
            ...
            public void Create(
                ...
                in Corvus.CspellBenchmark.Current.JsonString.Source regexp)
            {
                Create(ref _builder, id, penalty, regexp);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.CspellBenchmark.Current.JsonString.Source arg1, scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source arg2, scoped in Corvus.CspellBenchmark.Current.JsonString.Source arg3, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.CspellBenchmark.Current.JsonString.Source id, scoped in Corvus.CspellBenchmark.Current.JsonNumber.Source penalty, scoped in Corvus.CspellBenchmark.Current.JsonString.Source regexp)
        {
            return new Source(id, penalty, regexp);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CspellBenchmark.Current.JsonString.Source id, in Corvus.CspellBenchmark.Current.JsonNumber.Source penalty, in Corvus.CspellBenchmark.Current.JsonString.Source regexp, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(id, penalty, regexp);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<PatternAdjustment, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<PatternAdjustment> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<PatternAdjustment>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<PatternAdjustment> Create<TContext>(
        ...
        public static ParsedJsonDocument<PatternAdjustment> Create(in Corvus.CspellBenchmark.Current.JsonString.Source id, in Corvus.CspellBenchmark.Current.JsonNumber.Source penalty, in Corvus.CspellBenchmark.Current.JsonString.Source regexp, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
