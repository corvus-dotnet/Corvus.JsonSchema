...
public readonly partial struct CspellSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PatternAdjustment"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal PatternAdjustment(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static PatternAdjustment DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.CspellBenchmark.Current.JsonString Regexp
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RegexpUtf8, out Corvus.CspellBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in PatternAdjustment left, in PatternAdjustment right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in PatternAdjustment left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(PatternAdjustment instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PatternAdjustment(JsonElement instance)
        {
            return PatternAdjustment.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PatternAdjustment From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PatternAdjustment ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PatternAdjustment>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PatternAdjustment ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PatternAdjustment>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PatternAdjustment ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PatternAdjustment>(json, options);
        }
        ...
        /// </exception>
        public static PatternAdjustment ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<PatternAdjustment>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out PatternAdjustment? result)
        {
            return JsonElementHelpers.TryParseValue<PatternAdjustment>(ref reader, out result);
        }
...
#if NET
        static PatternAdjustment IJsonElement<PatternAdjustment>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PatternAdjustment: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public PatternAdjustment Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public PatternAdjustment Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<PatternAdjustment>(_idx);
            }
