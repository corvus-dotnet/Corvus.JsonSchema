...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct PatternRef
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns.Mutable(Mutable value)
            {
                return Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(PatternRef instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PatternRef"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PatternRef(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PatternRef.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly PatternRef Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly PatternRef Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PatternRef>(_idx);
            }
            ...
            /// <param name="matchJsonString1">Match a <see cref="Corvus.CspellBenchmark.Current.JsonString"/>.</param>
            /// <param name="matchPredefinedPatterns">Match a <see cref="Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.JsonString, TContext, TResult> matchJsonString1,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns, TContext, TResult> matchPredefinedPatterns,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.PatternRef.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                if (Corvus.CspellBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonString1(Corvus.CspellBenchmark.Current.JsonString.Mutable.From(this), context);
                }

                if (Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchPredefinedPatterns(Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.JsonString, TResult> matchJsonString1,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns, TResult> matchPredefinedPatterns,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.PatternRef.Mutable, TResult> defaultMatch)
            {
                if (Corvus.CspellBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.CspellBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonString1(Corvus.CspellBenchmark.Current.JsonString.Mutable.From(this));
                }

                if (Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchPredefinedPatterns(Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns.Mutable.From(this));
                }
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.JsonString, TAccumulator, TAccumulator> matchJsonString1,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns, TAccumulator, TAccumulator> matchPredefinedPatterns,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.PatternRef.Mutable, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
                ...
                {
                    matched = true;
                    accumulator = matchJsonString1(Corvus.CspellBenchmark.Current.JsonString.Mutable.From(this), accumulator);
                }

                if (Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns.JsonSchema.Evaluate(_parent, _idx))
                {
                    matched = true;
                    accumulator = matchPredefinedPatterns(Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns.Mutable.From(this), accumulator);
                }
            ...
            public bool TryGetAsPredefinedPatterns(out Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns.Mutable result)
            {
                if (Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(PatternRef instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<PatternRef, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<PatternRef> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<PatternRef>();
            }
            finally
            {
