...
public readonly partial struct CspellSchema
{
...
#endif
    {
        ...
        public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns(PatternRef value)
        {
            return Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator PatternRef(Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns value)
        {
            return From(value);
        }

        /// <summary>
        /// Conversion from the <see cref="Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns"/> mutable view.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator PatternRef(Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns.Mutable value)
        {
            return From(value);
        }
        ...
        public bool TryGetAsPredefinedPatterns(out Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns result)
        {
            ...
            {
                result = Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.CspellBenchmark.Current.CspellSchema.PatternRef, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            if (Corvus.CspellBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonString1(Corvus.CspellBenchmark.Current.JsonString.From(this), context);
            }

            if (Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchPredefinedPatterns(Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.CspellBenchmark.Current.CspellSchema.PatternRef, TResult> defaultMatch)
        {
            if (Corvus.CspellBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            if (Corvus.CspellBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonString1(Corvus.CspellBenchmark.Current.JsonString.From(this));
            }

            if (Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchPredefinedPatterns(Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns.From(this));
            }
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.CspellBenchmark.Current.CspellSchema.PatternRef, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
            ...
            {
                matched = true;
                accumulator = matchJsonString1(Corvus.CspellBenchmark.Current.JsonString.From(this), accumulator);
            }

            if (Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns.JsonSchema.Evaluate(_parent, _idx))
            {
                matched = true;
                accumulator = matchPredefinedPatterns(Corvus.CspellBenchmark.Current.CspellSchema.PredefinedPatterns.From(this), accumulator);
            }
