...
public readonly partial struct CspellSchema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.CspellBenchmark.Current.CspellSchema.RegExpPatternDefinition.RegExpPatternOrArrayOfRegExpPatterns Pattern
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PatternUtf8, out Corvus.CspellBenchmark.Current.CspellSchema.RegExpPatternDefinition.RegExpPatternOrArrayOfRegExpPatterns value))
                {
                    return value;
                }
