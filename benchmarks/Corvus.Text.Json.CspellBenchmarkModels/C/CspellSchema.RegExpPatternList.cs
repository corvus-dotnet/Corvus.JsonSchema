...
public readonly partial struct CspellSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RegExpPatternList"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal RegExpPatternList(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RegExpPatternList DefaultInstance { get; }
        ...
        public Corvus.CspellBenchmark.Current.CspellSchema.PatternRef this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Current.CspellSchema.PatternRef>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.PatternRef> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.PatternRef>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in RegExpPatternList left, in RegExpPatternList right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RegExpPatternList left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(RegExpPatternList instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RegExpPatternList(JsonElement instance)
        {
            return RegExpPatternList.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RegExpPatternList From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RegExpPatternList ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RegExpPatternList>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RegExpPatternList ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RegExpPatternList>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RegExpPatternList ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RegExpPatternList>(json, options);
        }
        ...
        /// </exception>
        public static RegExpPatternList ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<RegExpPatternList>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RegExpPatternList? result)
        {
            return JsonElementHelpers.TryParseValue<RegExpPatternList>(ref reader, out result);
        }
...
#if NET
        static RegExpPatternList IJsonElement<RegExpPatternList>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RegExpPatternList: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public RegExpPatternList Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public RegExpPatternList Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<RegExpPatternList>(_idx);
            }
