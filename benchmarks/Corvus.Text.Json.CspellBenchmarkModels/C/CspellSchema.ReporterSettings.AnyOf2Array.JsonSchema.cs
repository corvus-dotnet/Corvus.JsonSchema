    ...
    public readonly partial struct ReporterSettings
    {
            ...
            : IJsonElement<AnyOf2Array>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/ReporterSettings/anyOf/2"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/definitions/ReporterSettings/anyOf/2";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/ReporterSettings/anyOf/2"u8;
                    ...
                    else
                    {
                        ...
                        while (arrayValidation_enumerator.MoveNext())
                        {
                            ...
                            switch (arrayValidation_itemCount)
                            {
                                ...
                                case 1:
                                {
                                    JsonSchemaContext childContext1 = Corvus.CspellBenchmark.Current.CspellSchema.Serializable.JsonSchema.PushChildContext(
                                        parentDocument,
                                        arrayValidation_currentIndex,
                                        ref context,
                                        itemIndex: arrayValidation_itemCount,
                                    ...
                                    Corvus.CspellBenchmark.Current.CspellSchema.Serializable.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext1);
