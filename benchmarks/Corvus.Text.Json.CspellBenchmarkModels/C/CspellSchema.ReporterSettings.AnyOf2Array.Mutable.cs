    ...
    public readonly partial struct ReporterSettings
    {
        ...
        public readonly partial struct AnyOf2Array
        {
...
#endif
            {
                ...
                /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public Corvus.CspellBenchmark.Current.JsonString.Mutable Item1
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Current.JsonString.Mutable>(_idx, 0);
                    }
                }
                ...
                /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public Corvus.CspellBenchmark.Current.CspellSchema.Serializable.Mutable Item2
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Current.CspellSchema.Serializable.Mutable>(_idx, 1);
                    }
                }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                public void CreateTuple(in Corvus.CspellBenchmark.Current.JsonString.Source item1, in Corvus.CspellBenchmark.Current.CspellSchema.Serializable.Source item2)
                {
            ...
            public static ParsedJsonDocument<AnyOf2Array> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AnyOf2Array>();
                }
                finally
                {
