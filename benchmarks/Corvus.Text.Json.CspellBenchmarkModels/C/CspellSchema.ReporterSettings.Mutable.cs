...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct ReporterSettings
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray.Mutable(Mutable value)
            {
                return Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray.Mutable value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array.Mutable(Mutable value)
            {
                return Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array.Mutable value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                ...
                {
                    return matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray.Mutable.From(this), context);
                }

                if (Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchAnyOf2Array(Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.Mutable, TResult> defaultMatch)
            {
                if (Corvus.CspellBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray.Mutable.From(this));
                }

                if (Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchAnyOf2Array(Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array.Mutable.From(this));
                }
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.Mutable, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
                ...
                {
                    matched = true;
                    accumulator = matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray.Mutable.From(this), accumulator);
                }

                if (Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array.JsonSchema.Evaluate(_parent, _idx))
                {
                    matched = true;
                    accumulator = matchAnyOf2Array(Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array.Mutable.From(this), accumulator);
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsJsonStringArray(out Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray.Mutable result)
            {
                if (Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray.Mutable.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsAnyOf2Array(out Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array.Mutable result)
            {
                if (Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public static ParsedJsonDocument<ReporterSettings> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ReporterSettings>();
            }
            finally
            {
