...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct ReporterSettings
#if NET8_0_OR_GREATER
        : IJsonElement<ReporterSettings>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReporterSettings"/> struct.
        /// </summary>
        ...
        internal ReporterSettings(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ReporterSettings DefaultInstance { get; }
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray(ReporterSettings value)
        {
            return Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ReporterSettings(Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array(ReporterSettings value)
        {
            return Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(ReporterSettings value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in ReporterSettings left, in ReporterSettings right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ReporterSettings left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ReporterSettings instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ReporterSettings(JsonElement instance)
        {
            return ReporterSettings.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ReporterSettings From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ReporterSettings ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ReporterSettings>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ReporterSettings ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ReporterSettings>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ReporterSettings ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ReporterSettings>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static ReporterSettings ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ReporterSettings>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ReporterSettings? result)
        {
            return JsonElementHelpers.TryParseValue<ReporterSettings>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ReporterSettings(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ReporterSettings IJsonElement<ReporterSettings>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ReporterSettings: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ReporterSettings"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ReporterSettings"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ReporterSettings Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ReporterSettings>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ReporterSettings"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ReporterSettings Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ReporterSettings>(_idx);
            }
        ...
        public bool TryGetAsJsonString(out Corvus.CspellBenchmark.Current.JsonString result)
        {
            ...
            {
                result = Corvus.CspellBenchmark.Current.JsonString.From(this);
                return true;
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsJsonStringArray(out Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray result)
        {
            if (Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray.From(this);
                return true;
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsAnyOf2Array(out Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array result)
        {
            if (Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array.From(this);
                return true;
            }
        ...
        /// <param name="matchJsonStringArray">Match a <see cref="Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray"/>.</param>
        /// <param name="matchAnyOf2Array">Match a <see cref="Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array"/>.</param>
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray, TContext, TResult> matchJsonStringArray,
            Matcher<Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array, TContext, TResult> matchAnyOf2Array,
            Matcher<Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.CspellBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonString(Corvus.CspellBenchmark.Current.JsonString.From(this), context);
            }

            if (Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray.From(this), context);
            }

            if (Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf2Array(Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray, TResult> matchJsonStringArray,
            Matcher<Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array, TResult> matchAnyOf2Array,
            Matcher<Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings, TResult> defaultMatch)
        {
            if (Corvus.CspellBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonString(Corvus.CspellBenchmark.Current.JsonString.From(this));
            }

            if (Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray.From(this));
            }

            if (Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf2Array(Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array.From(this));
            }
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray, TAccumulator, TAccumulator> matchJsonStringArray,
            Matcher<Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array, TAccumulator, TAccumulator> matchAnyOf2Array,
            Matcher<Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
            ...
            {
                matched = true;
                accumulator = matchJsonStringArray(Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.JsonStringArray.From(this), accumulator);
            }

            if (Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array.JsonSchema.Evaluate(_parent, _idx))
            {
                matched = true;
                accumulator = matchAnyOf2Array(Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings.AnyOf2Array.From(this), accumulator);
            }
