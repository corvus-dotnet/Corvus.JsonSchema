...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct ReporterSettingsArray
        ...
        : IJsonElement<ReporterSettingsArray>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReporterSettingsArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ReporterSettingsArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        public Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.ReporterSettings>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in ReporterSettingsArray left, in ReporterSettingsArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ReporterSettingsArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ReporterSettingsArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ReporterSettingsArray(JsonElement instance)
        {
            return ReporterSettingsArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ReporterSettingsArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ReporterSettingsArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ReporterSettingsArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ReporterSettingsArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ReporterSettingsArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ReporterSettingsArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ReporterSettingsArray>(json, options);
        }
        ...
        /// </exception>
        public static ReporterSettingsArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ReporterSettingsArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ReporterSettingsArray? result)
        {
            return JsonElementHelpers.TryParseValue<ReporterSettingsArray>(ref reader, out result);
        }
...
#if NET
        static ReporterSettingsArray IJsonElement<ReporterSettingsArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ReporterSettingsArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public ReporterSettingsArray Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public ReporterSettingsArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ReporterSettingsArray>(_idx);
            }
