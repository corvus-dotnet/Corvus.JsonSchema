    ...
    public readonly partial struct Serializable
    {
        ...
        public readonly partial struct AnyOf4Entity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AnyOf4Entity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AnyOf4Entity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AnyOf4Entity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AnyOf4Entity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AnyOf4Entity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AnyOf4Entity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AnyOf4Entity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CspellBenchmark.Current.CspellSchema.Serializable.AnyOf4Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(AnyOf4Entity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CspellBenchmark.Current.CspellSchema.Serializable.AnyOf4Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<AnyOf4Entity, Mutable>(this);
            }
        }
    }
}
