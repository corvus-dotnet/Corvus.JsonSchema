    ...
    public readonly partial struct Serializable
    {
...
#endif
        {
...
#endif
            {
                ...
                {
                    return matchJsonNumber(Corvus.CspellBenchmark.Current.JsonNumber.Mutable.From(this), context);
                }
                ...
                {
                    return matchJsonBoolean(Corvus.CspellBenchmark.Current.JsonBoolean.Mutable.From(this), context);
                }
                ...
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.Serializable.Mutable, TResult> defaultMatch)
            {
                if (Corvus.CspellBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonNumber(Corvus.CspellBenchmark.Current.JsonNumber.Mutable.From(this));
                }
                ...
                if (Corvus.CspellBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonBoolean(Corvus.CspellBenchmark.Current.JsonBoolean.Mutable.From(this));
                }
            ...
            public bool TryGetAsJsonNumber(out Corvus.CspellBenchmark.Current.JsonNumber.Mutable result)
            {
                if (Corvus.CspellBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Current.JsonNumber.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsJsonBoolean(out Corvus.CspellBenchmark.Current.JsonBoolean.Mutable result)
            {
                if (Corvus.CspellBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Current.JsonBoolean.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsJsonNull(out Corvus.CspellBenchmark.Current.JsonNull.Mutable result)
            {
                if (Corvus.CspellBenchmark.Current.JsonNull.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Current.JsonNull.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CspellBenchmark.Current.CspellSchema.Serializable.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.CspellBenchmark.Current.JsonBoolean instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.CspellBenchmark.Current.JsonNull instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.CspellBenchmark.Current.JsonNumber instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CspellBenchmark.Current.CspellSchema.Serializable.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static ParsedJsonDocument<Serializable> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Serializable>();
            }
            finally
            {
