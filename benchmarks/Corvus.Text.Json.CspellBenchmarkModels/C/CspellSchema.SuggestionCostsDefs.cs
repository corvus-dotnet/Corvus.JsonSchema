...
public readonly partial struct CspellSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SuggestionCostsDefs"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal SuggestionCostsDefs(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static SuggestionCostsDefs DefaultInstance { get; }
        ...
        public Corvus.CspellBenchmark.Current.CspellSchema.SuggestionCostMapDef this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.CspellBenchmark.Current.CspellSchema.SuggestionCostMapDef>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.SuggestionCostMapDef> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.CspellBenchmark.Current.CspellSchema.SuggestionCostMapDef>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in SuggestionCostsDefs left, in SuggestionCostsDefs right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SuggestionCostsDefs left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(SuggestionCostsDefs instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SuggestionCostsDefs(JsonElement instance)
        {
            return SuggestionCostsDefs.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuggestionCostsDefs From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuggestionCostsDefs ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SuggestionCostsDefs>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuggestionCostsDefs ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SuggestionCostsDefs>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuggestionCostsDefs ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SuggestionCostsDefs>(json, options);
        }
        ...
        /// </exception>
        public static SuggestionCostsDefs ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<SuggestionCostsDefs>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SuggestionCostsDefs? result)
        {
            return JsonElementHelpers.TryParseValue<SuggestionCostsDefs>(ref reader, out result);
        }
...
#if NET
        static SuggestionCostsDefs IJsonElement<SuggestionCostsDefs>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SuggestionCostsDefs: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public SuggestionCostsDefs Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public SuggestionCostsDefs Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<SuggestionCostsDefs>(_idx);
            }
