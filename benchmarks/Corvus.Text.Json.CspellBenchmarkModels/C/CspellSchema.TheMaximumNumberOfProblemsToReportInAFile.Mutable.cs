...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct TheMaximumNumberOfProblemsToReportInAFile
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TheMaximumNumberOfProblemsToReportInAFile, Mutable>(TheMaximumNumberOfProblemsToReportInAFile.DefaultInstance);
        ...
        public static ParsedJsonDocument<TheMaximumNumberOfProblemsToReportInAFile> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TheMaximumNumberOfProblemsToReportInAFile>();
            }
            finally
            {
