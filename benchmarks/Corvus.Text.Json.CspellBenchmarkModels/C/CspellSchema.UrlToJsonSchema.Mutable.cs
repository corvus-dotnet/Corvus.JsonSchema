...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct UrlToJsonSchema
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<UrlToJsonSchema, Mutable>(UrlToJsonSchema.DefaultInstance);
        ...
        public static ParsedJsonDocument<UrlToJsonSchema> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<UrlToJsonSchema>();
            }
            finally
            {
