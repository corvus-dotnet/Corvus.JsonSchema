...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct UrlToJsonSchema
#if NET8_0_OR_GREATER
        : IJsonElement<UrlToJsonSchema>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UrlToJsonSchema"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal UrlToJsonSchema(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static UrlToJsonSchema DefaultInstance { get; } = ParsedJsonDocument<UrlToJsonSchema>.StringConstant([.."\"https://raw.githubusercontent.com/streetsidesoftware/cspell/main/cspell.schema.json\""u8]);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(UrlToJsonSchema value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in UrlToJsonSchema left, in UrlToJsonSchema right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in UrlToJsonSchema left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(UrlToJsonSchema instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator UrlToJsonSchema(JsonElement instance)
        {
            return UrlToJsonSchema.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UrlToJsonSchema From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UrlToJsonSchema ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<UrlToJsonSchema>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UrlToJsonSchema ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<UrlToJsonSchema>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UrlToJsonSchema ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<UrlToJsonSchema>(json, options);
        }
        ...
        /// </exception>
        public static UrlToJsonSchema ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<UrlToJsonSchema>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out UrlToJsonSchema? result)
        {
            return JsonElementHelpers.TryParseValue<UrlToJsonSchema>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new UrlToJsonSchema(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static UrlToJsonSchema IJsonElement<UrlToJsonSchema>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"UrlToJsonSchema: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="UrlToJsonSchema"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="UrlToJsonSchema"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public UrlToJsonSchema Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<UrlToJsonSchema>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="UrlToJsonSchema"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public UrlToJsonSchema Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<UrlToJsonSchema>(_idx);
            }
