...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct UseGitignoreEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<UseGitignoreEntity, Mutable>(UseGitignoreEntity.DefaultInstance);
        ...
        public static ParsedJsonDocument<UseGitignoreEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<UseGitignoreEntity>();
            }
            finally
            {
