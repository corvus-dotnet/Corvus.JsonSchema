...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct Version
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest.Mutable(Mutable value)
            {
                return Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest.Mutable value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy.Mutable(Mutable value)
            {
                return Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy.Mutable value)
            {
                return From(value);
            }
            ...
            /// <param name="matchVersionLatest">Match a <see cref="Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest"/>.</param>
            /// <param name="matchVersionLegacy">Match a <see cref="Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy"/>.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest, TContext, TResult> matchVersionLatest,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy, TContext, TResult> matchVersionLegacy,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.Version.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchVersionLatest(Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest.Mutable.From(this), context);
                }

                if (Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchVersionLegacy(Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest, TResult> matchVersionLatest,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy, TResult> matchVersionLegacy,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.Version.Mutable, TResult> defaultMatch)
            {
                if (Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchVersionLatest(Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest.Mutable.From(this));
                }

                if (Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchVersionLegacy(Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy.Mutable.From(this));
                }
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest, TAccumulator, TAccumulator> matchVersionLatest,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy, TAccumulator, TAccumulator> matchVersionLegacy,
                Matcher<Corvus.CspellBenchmark.Current.CspellSchema.Version.Mutable, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
                ...
                {
                    matched = true;
                    accumulator = matchVersionLatest(Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest.Mutable.From(this), accumulator);
                }

                if (Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy.JsonSchema.Evaluate(_parent, _idx))
                {
                    matched = true;
                    accumulator = matchVersionLegacy(Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy.Mutable.From(this), accumulator);
                }
            ...
            public bool TryGetAsVersionLatest(out Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest.Mutable result)
            {
                if (Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsVersionLegacy(out Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy.Mutable result)
            {
                if (Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy instance) => new(JsonElement.From(instance));
        ...
        public static ParsedJsonDocument<Version> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Version>();
            }
            finally
            {
