...
public readonly partial struct CspellSchema
{
...
#endif
    {
        ...
        public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest(Version value)
        {
            return Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Version(Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy(Version value)
        {
            return Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy.From(value);
        }
        ...
        public bool TryGetAsVersionLatest(out Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest result)
        {
            ...
            {
                result = Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest.From(this);
                return true;
            }
        ...
        public bool TryGetAsVersionLegacy(out Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy result)
        {
            ...
            {
                result = Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.CspellBenchmark.Current.CspellSchema.Version, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchVersionLatest(Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest.From(this), context);
            }

            if (Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchVersionLegacy(Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.CspellBenchmark.Current.CspellSchema.Version, TResult> defaultMatch)
        {
            if (Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchVersionLatest(Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest.From(this));
            }

            if (Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchVersionLegacy(Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy.From(this));
            }
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.CspellBenchmark.Current.CspellSchema.Version, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
            ...
            {
                matched = true;
                accumulator = matchVersionLatest(Corvus.CspellBenchmark.Current.CspellSchema.VersionLatest.From(this), accumulator);
            }

            if (Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy.JsonSchema.Evaluate(_parent, _idx))
            {
                matched = true;
                accumulator = matchVersionLegacy(Corvus.CspellBenchmark.Current.CspellSchema.VersionLegacy.From(this), accumulator);
            }
