...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct VersionLatest
#if NET8_0_OR_GREATER
        : IJsonElement<VersionLatest>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VersionLatest"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal VersionLatest(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static VersionLatest DefaultInstance { get; }

        /// <summary>
        /// Gets the const instance.
        /// </summary>
        public static VersionLatest ConstInstance => Constants.ConstJson;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(VersionLatest value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in VersionLatest left, in VersionLatest right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in VersionLatest left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(VersionLatest instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator VersionLatest(JsonElement instance)
        {
            return VersionLatest.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VersionLatest From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VersionLatest ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<VersionLatest>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VersionLatest ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<VersionLatest>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VersionLatest ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<VersionLatest>(json, options);
        }
        ...
        /// </exception>
        public static VersionLatest ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<VersionLatest>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out VersionLatest? result)
        {
            return JsonElementHelpers.TryParseValue<VersionLatest>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new VersionLatest(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static VersionLatest IJsonElement<VersionLatest>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"VersionLatest: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="VersionLatest"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="VersionLatest"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public VersionLatest Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<VersionLatest>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="VersionLatest"/> that lives for the lifetime of its
