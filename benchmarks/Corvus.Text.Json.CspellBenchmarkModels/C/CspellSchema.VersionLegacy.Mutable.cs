...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct VersionLegacy
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(VersionLegacy instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="VersionLegacy"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator VersionLegacy(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"VersionLegacy.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly VersionLegacy Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly VersionLegacy Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<VersionLegacy>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(VersionLegacy instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<VersionLegacy, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<VersionLegacy> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<VersionLegacy>();
            }
            finally
            {
