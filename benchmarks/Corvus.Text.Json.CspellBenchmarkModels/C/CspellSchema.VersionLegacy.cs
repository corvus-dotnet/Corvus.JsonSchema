...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct VersionLegacy
#if NET8_0_OR_GREATER
        : IJsonElement<VersionLegacy>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VersionLegacy"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal VersionLegacy(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static VersionLegacy DefaultInstance { get; }

        /// <summary>
        /// Gets the const instance.
        /// </summary>
        public static VersionLegacy ConstInstance => Constants.ConstJson;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(VersionLegacy value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in VersionLegacy left, in VersionLegacy right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in VersionLegacy left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(VersionLegacy instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator VersionLegacy(JsonElement instance)
        {
            return VersionLegacy.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VersionLegacy From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VersionLegacy ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<VersionLegacy>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VersionLegacy ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<VersionLegacy>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VersionLegacy ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<VersionLegacy>(json, options);
        }
        ...
        /// </exception>
        public static VersionLegacy ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<VersionLegacy>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out VersionLegacy? result)
        {
            return JsonElementHelpers.TryParseValue<VersionLegacy>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new VersionLegacy(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static VersionLegacy IJsonElement<VersionLegacy>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"VersionLegacy: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="VersionLegacy"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="VersionLegacy"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public VersionLegacy Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<VersionLegacy>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="VersionLegacy"/> that lives for the lifetime of its
