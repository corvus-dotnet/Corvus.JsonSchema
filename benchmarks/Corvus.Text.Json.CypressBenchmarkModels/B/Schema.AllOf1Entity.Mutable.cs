...
public readonly partial struct Schema
{
    ...
    public readonly partial struct AllOf1Entity
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.Mutable Component
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ComponentUtf8, out Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.Mutable E2e
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.E2eUtf8, out Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetComponent(in Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetComponent<TContext>(in Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetE2e(in Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetE2e<TContext>(in Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.CypressBenchmark.Baseline.Schema.AllOf1Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.CypressBenchmark.Baseline.Schema.AllOf1Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.Source component = default,
                in Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.Source e2e = default)
            {
            ...
            /// Creates an instance of a <see cref="AllOf1Entity"/>.
            /// </summary>
            public void Create(in Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.Source component = default, in Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.Source e2e = default)
            {
                Create(ref _builder, component, e2e);
            }
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.Source<TContext> component = default,
                in Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.Source<TContext> e2e = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            #endif
            {
                Create(context, ref _builder, component, e2e);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.Source component = default, in Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.Source e2e = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(component, e2e);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.Source<TContext> component = default, in Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.Source<TContext> e2e = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, component, e2e);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
