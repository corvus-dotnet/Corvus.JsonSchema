    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct AnimationDistanceThresholdEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AnimationDistanceThresholdEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AnimationDistanceThresholdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AnimationDistanceThresholdEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AnimationDistanceThresholdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AnimationDistanceThresholdEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AnimationDistanceThresholdEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AnimationDistanceThresholdEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AnimationDistanceThresholdEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AnimationDistanceThresholdEntity, Mutable>(this);
            }
        }
    }
}
