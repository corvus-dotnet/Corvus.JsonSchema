    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct BlockHostsArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(BlockHostsArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="BlockHostsArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator BlockHostsArray(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"BlockHostsArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public readonly BlockHostsArray Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly BlockHostsArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<BlockHostsArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.BlockHostsArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(BlockHostsArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.BlockHostsArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<BlockHostsArray, Mutable>(this);
            }
        }
    }
}
