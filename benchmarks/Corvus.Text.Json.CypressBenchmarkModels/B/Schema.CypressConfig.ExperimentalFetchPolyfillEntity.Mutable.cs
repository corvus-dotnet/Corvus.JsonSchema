    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct ExperimentalFetchPolyfillEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ExperimentalFetchPolyfillEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ExperimentalFetchPolyfillEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExperimentalFetchPolyfillEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExperimentalFetchPolyfillEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ExperimentalFetchPolyfillEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ExperimentalFetchPolyfillEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ExperimentalFetchPolyfillEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ExperimentalFetchPolyfillEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ExperimentalFetchPolyfillEntity, Mutable>(this);
            }
        }
    }
}
