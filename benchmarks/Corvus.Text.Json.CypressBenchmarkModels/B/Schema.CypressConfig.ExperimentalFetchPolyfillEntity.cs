...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CypressConfig
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ExperimentalFetchPolyfillEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ExperimentalFetchPolyfillEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ExperimentalFetchPolyfillEntity DefaultInstance { get; } = ParsedJsonDocument<ExperimentalFetchPolyfillEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(ExperimentalFetchPolyfillEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in ExperimentalFetchPolyfillEntity left, in ExperimentalFetchPolyfillEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ExperimentalFetchPolyfillEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ExperimentalFetchPolyfillEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ExperimentalFetchPolyfillEntity(JsonElement instance)
            {
                return ExperimentalFetchPolyfillEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExperimentalFetchPolyfillEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExperimentalFetchPolyfillEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ExperimentalFetchPolyfillEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExperimentalFetchPolyfillEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ExperimentalFetchPolyfillEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExperimentalFetchPolyfillEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ExperimentalFetchPolyfillEntity>(json, options);
            }
            ...
            /// </exception>
            public static ExperimentalFetchPolyfillEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ExperimentalFetchPolyfillEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ExperimentalFetchPolyfillEntity? result)
            {
                return JsonElementHelpers.TryParseValue<ExperimentalFetchPolyfillEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ExperimentalFetchPolyfillEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ExperimentalFetchPolyfillEntity IJsonElement<ExperimentalFetchPolyfillEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ExperimentalFetchPolyfillEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ExperimentalFetchPolyfillEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ExperimentalFetchPolyfillEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ExperimentalFetchPolyfillEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ExperimentalFetchPolyfillEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ExperimentalFetchPolyfillEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ExperimentalFetchPolyfillEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ExperimentalFetchPolyfillEntity>(_idx);
                }
