...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct ExperimentalSessionSupportEntity
#if NET8_0_OR_GREATER
            : IJsonElement<ExperimentalSessionSupportEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ExperimentalSessionSupportEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ExperimentalSessionSupportEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ExperimentalSessionSupportEntity DefaultInstance { get; } = ParsedJsonDocument<ExperimentalSessionSupportEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(ExperimentalSessionSupportEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in ExperimentalSessionSupportEntity left, in ExperimentalSessionSupportEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ExperimentalSessionSupportEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ExperimentalSessionSupportEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ExperimentalSessionSupportEntity(JsonElement instance)
            {
                return ExperimentalSessionSupportEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExperimentalSessionSupportEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExperimentalSessionSupportEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ExperimentalSessionSupportEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExperimentalSessionSupportEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ExperimentalSessionSupportEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExperimentalSessionSupportEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ExperimentalSessionSupportEntity>(json, options);
            }
            ...
            /// </exception>
            public static ExperimentalSessionSupportEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ExperimentalSessionSupportEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ExperimentalSessionSupportEntity? result)
            {
                return JsonElementHelpers.TryParseValue<ExperimentalSessionSupportEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ExperimentalSessionSupportEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ExperimentalSessionSupportEntity IJsonElement<ExperimentalSessionSupportEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ExperimentalSessionSupportEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ExperimentalSessionSupportEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ExperimentalSessionSupportEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ExperimentalSessionSupportEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ExperimentalSessionSupportEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ExperimentalSessionSupportEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ExperimentalSessionSupportEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ExperimentalSessionSupportEntity>(_idx);
                }
