...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct ExperimentalStudioEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ExperimentalStudioEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ExperimentalStudioEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExperimentalStudioEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ExperimentalStudioEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExperimentalStudioEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ExperimentalStudioEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ExperimentalStudioEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ExperimentalStudioEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ExperimentalStudioEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ExperimentalStudioEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ExperimentalStudioEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ExperimentalStudioEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ExperimentalStudioEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ExperimentalStudioEntity, Mutable>(this);
            }
        }
    }
}
