    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct IgnoreTestFilesArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(IgnoreTestFilesArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="IgnoreTestFilesArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IgnoreTestFilesArray(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IgnoreTestFilesArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public readonly IgnoreTestFilesArray Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly IgnoreTestFilesArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<IgnoreTestFilesArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.IgnoreTestFilesArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(IgnoreTestFilesArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.IgnoreTestFilesArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<IgnoreTestFilesArray, Mutable>(this);
            }
        }
    }
}
