    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct IncludeShadowDomEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(IncludeShadowDomEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="IncludeShadowDomEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IncludeShadowDomEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IncludeShadowDomEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly IncludeShadowDomEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly IncludeShadowDomEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<IncludeShadowDomEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(IncludeShadowDomEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<IncludeShadowDomEntity, Mutable>(this);
            }
        }
    }
}
