    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct NodeVersionEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(NodeVersionEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="NodeVersionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator NodeVersionEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"NodeVersionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly NodeVersionEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly NodeVersionEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<NodeVersionEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(NodeVersionEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<NodeVersionEntity, Mutable>(this);
            }
        }
    }
}
