    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct NumTestsKeptInMemoryEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(NumTestsKeptInMemoryEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="NumTestsKeptInMemoryEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator NumTestsKeptInMemoryEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"NumTestsKeptInMemoryEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly NumTestsKeptInMemoryEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly NumTestsKeptInMemoryEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<NumTestsKeptInMemoryEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(NumTestsKeptInMemoryEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<NumTestsKeptInMemoryEntity, Mutable>(this);
            }
        }
    }
}
