...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CypressConfig
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="PageLoadTimeoutEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal PageLoadTimeoutEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static PageLoadTimeoutEntity DefaultInstance { get; } = ParsedJsonDocument<PageLoadTimeoutEntity>.NumberConstant([.."60000"u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator long(PageLoadTimeoutEntity value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator double(PageLoadTimeoutEntity value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator Corvus.Numerics.BigNumber(PageLoadTimeoutEntity value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator System.Numerics.BigInteger(PageLoadTimeoutEntity value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator decimal(PageLoadTimeoutEntity value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in PageLoadTimeoutEntity left, in PageLoadTimeoutEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in PageLoadTimeoutEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(PageLoadTimeoutEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PageLoadTimeoutEntity(JsonElement instance)
            {
                return PageLoadTimeoutEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PageLoadTimeoutEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PageLoadTimeoutEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PageLoadTimeoutEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PageLoadTimeoutEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PageLoadTimeoutEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PageLoadTimeoutEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PageLoadTimeoutEntity>(json, options);
            }
            ...
            /// </exception>
            public static PageLoadTimeoutEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<PageLoadTimeoutEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out PageLoadTimeoutEntity? result)
            {
                return JsonElementHelpers.TryParseValue<PageLoadTimeoutEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PageLoadTimeoutEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static PageLoadTimeoutEntity IJsonElement<PageLoadTimeoutEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PageLoadTimeoutEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="PageLoadTimeoutEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="PageLoadTimeoutEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public PageLoadTimeoutEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<PageLoadTimeoutEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="PageLoadTimeoutEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public PageLoadTimeoutEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<PageLoadTimeoutEntity>(_idx);
                }
