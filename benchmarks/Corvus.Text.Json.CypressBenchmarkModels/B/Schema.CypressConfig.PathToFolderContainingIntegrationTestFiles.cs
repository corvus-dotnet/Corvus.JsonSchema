...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct PathToFolderContainingIntegrationTestFiles
#if NET8_0_OR_GREATER
            : IJsonElement<PathToFolderContainingIntegrationTestFiles>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="PathToFolderContainingIntegrationTestFiles"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal PathToFolderContainingIntegrationTestFiles(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static PathToFolderContainingIntegrationTestFiles DefaultInstance { get; } = ParsedJsonDocument<PathToFolderContainingIntegrationTestFiles>.StringConstant([.."\"cypress/integration\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(PathToFolderContainingIntegrationTestFiles value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in PathToFolderContainingIntegrationTestFiles left, in PathToFolderContainingIntegrationTestFiles right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in PathToFolderContainingIntegrationTestFiles left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(PathToFolderContainingIntegrationTestFiles instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PathToFolderContainingIntegrationTestFiles(JsonElement instance)
            {
                return PathToFolderContainingIntegrationTestFiles.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PathToFolderContainingIntegrationTestFiles From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PathToFolderContainingIntegrationTestFiles ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PathToFolderContainingIntegrationTestFiles>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PathToFolderContainingIntegrationTestFiles ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PathToFolderContainingIntegrationTestFiles>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PathToFolderContainingIntegrationTestFiles ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PathToFolderContainingIntegrationTestFiles>(json, options);
            }
            ...
            /// </exception>
            public static PathToFolderContainingIntegrationTestFiles ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<PathToFolderContainingIntegrationTestFiles>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out PathToFolderContainingIntegrationTestFiles? result)
            {
                return JsonElementHelpers.TryParseValue<PathToFolderContainingIntegrationTestFiles>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PathToFolderContainingIntegrationTestFiles(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static PathToFolderContainingIntegrationTestFiles IJsonElement<PathToFolderContainingIntegrationTestFiles>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PathToFolderContainingIntegrationTestFiles: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="PathToFolderContainingIntegrationTestFiles"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="PathToFolderContainingIntegrationTestFiles"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public PathToFolderContainingIntegrationTestFiles Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<PathToFolderContainingIntegrationTestFiles>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="PathToFolderContainingIntegrationTestFiles"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public PathToFolderContainingIntegrationTestFiles Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<PathToFolderContainingIntegrationTestFiles>(_idx);
                }
