...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct PathToFolderWhereFilesDownloadedDuringATestAreSaved
#if NET8_0_OR_GREATER
            : IJsonElement<PathToFolderWhereFilesDownloadedDuringATestAreSaved>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="PathToFolderWhereFilesDownloadedDuringATestAreSaved"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal PathToFolderWhereFilesDownloadedDuringATestAreSaved(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static PathToFolderWhereFilesDownloadedDuringATestAreSaved DefaultInstance { get; } = ParsedJsonDocument<PathToFolderWhereFilesDownloadedDuringATestAreSaved>.StringConstant([.."\"cypress/downloads\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(PathToFolderWhereFilesDownloadedDuringATestAreSaved value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in PathToFolderWhereFilesDownloadedDuringATestAreSaved left, in PathToFolderWhereFilesDownloadedDuringATestAreSaved right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in PathToFolderWhereFilesDownloadedDuringATestAreSaved left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(PathToFolderWhereFilesDownloadedDuringATestAreSaved instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PathToFolderWhereFilesDownloadedDuringATestAreSaved(JsonElement instance)
            {
                return PathToFolderWhereFilesDownloadedDuringATestAreSaved.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PathToFolderWhereFilesDownloadedDuringATestAreSaved From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PathToFolderWhereFilesDownloadedDuringATestAreSaved ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PathToFolderWhereFilesDownloadedDuringATestAreSaved>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PathToFolderWhereFilesDownloadedDuringATestAreSaved ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PathToFolderWhereFilesDownloadedDuringATestAreSaved>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PathToFolderWhereFilesDownloadedDuringATestAreSaved ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PathToFolderWhereFilesDownloadedDuringATestAreSaved>(json, options);
            }
            ...
            /// </exception>
            public static PathToFolderWhereFilesDownloadedDuringATestAreSaved ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<PathToFolderWhereFilesDownloadedDuringATestAreSaved>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out PathToFolderWhereFilesDownloadedDuringATestAreSaved? result)
            {
                return JsonElementHelpers.TryParseValue<PathToFolderWhereFilesDownloadedDuringATestAreSaved>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PathToFolderWhereFilesDownloadedDuringATestAreSaved(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static PathToFolderWhereFilesDownloadedDuringATestAreSaved IJsonElement<PathToFolderWhereFilesDownloadedDuringATestAreSaved>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PathToFolderWhereFilesDownloadedDuringATestAreSaved: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="PathToFolderWhereFilesDownloadedDuringATestAreSaved"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="PathToFolderWhereFilesDownloadedDuringATestAreSaved"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public PathToFolderWhereFilesDownloadedDuringATestAreSaved Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<PathToFolderWhereFilesDownloadedDuringATestAreSaved>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="PathToFolderWhereFilesDownloadedDuringATestAreSaved"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public PathToFolderWhereFilesDownloadedDuringATestAreSaved Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<PathToFolderWhereFilesDownloadedDuringATestAreSaved>(_idx);
                }
