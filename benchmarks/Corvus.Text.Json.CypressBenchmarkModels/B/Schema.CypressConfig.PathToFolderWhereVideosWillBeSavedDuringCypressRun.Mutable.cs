    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct PathToFolderWhereVideosWillBeSavedDuringCypressRun
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PathToFolderWhereVideosWillBeSavedDuringCypressRun instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PathToFolderWhereVideosWillBeSavedDuringCypressRun"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PathToFolderWhereVideosWillBeSavedDuringCypressRun(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PathToFolderWhereVideosWillBeSavedDuringCypressRun.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PathToFolderWhereVideosWillBeSavedDuringCypressRun Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PathToFolderWhereVideosWillBeSavedDuringCypressRun Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PathToFolderWhereVideosWillBeSavedDuringCypressRun>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PathToFolderWhereVideosWillBeSavedDuringCypressRun instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PathToFolderWhereVideosWillBeSavedDuringCypressRun, Mutable>(this);
            }
        }
    }
}
