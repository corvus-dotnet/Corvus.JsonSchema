...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct PathToPluginsFilePassFalseToDisable
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PathToPluginsFilePassFalseToDisable instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PathToPluginsFilePassFalseToDisable"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PathToPluginsFilePassFalseToDisable(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new PathToPluginsFilePassFalseToDisable(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PathToPluginsFilePassFalseToDisable.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="PathToPluginsFilePassFalseToDisable"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="PathToPluginsFilePassFalseToDisable"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly PathToPluginsFilePassFalseToDisable Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<PathToPluginsFilePassFalseToDisable>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="PathToPluginsFilePassFalseToDisable"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly PathToPluginsFilePassFalseToDisable Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PathToPluginsFilePassFalseToDisable>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PathToPluginsFilePassFalseToDisable instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PathToPluginsFilePassFalseToDisable, Mutable>(this);
            }
        }
    }
}
