    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct ProjectIdEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ProjectIdEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ProjectIdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ProjectIdEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ProjectIdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ProjectIdEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ProjectIdEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ProjectIdEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ProjectIdEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ProjectIdEntity, Mutable>(this);
            }
        }
    }
}
