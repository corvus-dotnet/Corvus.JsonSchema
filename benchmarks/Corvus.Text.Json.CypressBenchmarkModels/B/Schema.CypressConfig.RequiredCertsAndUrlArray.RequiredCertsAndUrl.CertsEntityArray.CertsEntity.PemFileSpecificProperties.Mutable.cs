                    ...
                    public readonly partial struct CertsEntity
                    {
                        ...
                        public readonly partial struct PemFileSpecificProperties
                        {
...
#endif
                            {
                                ...
                                /// </para>
                                /// </remarks>
                                public Corvus.CypressBenchmark.Baseline.JsonString.Mutable Cert
                                {
                                    get
                                    {
                                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CertUtf8, out Corvus.CypressBenchmark.Baseline.JsonString.Mutable value))
                                        {
                                            return value;
                                        }
                                ...
                                /// </para>
                                /// </remarks>
                                public Corvus.CypressBenchmark.Baseline.JsonString.Mutable Key
                                {
                                    get
                                    {
                                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KeyUtf8, out Corvus.CypressBenchmark.Baseline.JsonString.Mutable value))
                                        {
                                            return value;
                                        }
                                ...
                                public void SetCert(in Corvus.CypressBenchmark.Baseline.JsonString.Source value)
                                {
                                    CheckValidInstance();
                                ...
                                /// </summary>
                                /// <param name="value">The value of the property to add.</param>
                                public void SetKey(in Corvus.CypressBenchmark.Baseline.JsonString.Source value)
                                {
                                    CheckValidInstance();
                            ...
                            public ref struct Source
                            {
                                ...
                                internal Source(Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.RequiredCertsAndUrlArray.RequiredCertsAndUrl.CertsEntityArray.CertsEntity.PemFileSpecificProperties.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                                ...
                                #endif
                            {
                                ...
                                internal Source(scoped in TContext context, Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.RequiredCertsAndUrlArray.RequiredCertsAndUrl.CertsEntityArray.CertsEntity.PemFileSpecificProperties.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                            ...
                            public ref struct Builder
                            {
                                ...
                                internal static void Create(
                                    ...
                                    in Corvus.CypressBenchmark.Baseline.JsonString.Source cert,
                                    in Corvus.CypressBenchmark.Baseline.JsonString.Source key,
                            ...
                            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CypressBenchmark.Baseline.JsonString.Source cert, in Corvus.CypressBenchmark.Baseline.JsonString.Source key, in Corvus.CypressBenchmark.Baseline.JsonString.Source passphrase = default, int initialCapacity = 30)
                            {
                                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                                cvb.StartObject();
