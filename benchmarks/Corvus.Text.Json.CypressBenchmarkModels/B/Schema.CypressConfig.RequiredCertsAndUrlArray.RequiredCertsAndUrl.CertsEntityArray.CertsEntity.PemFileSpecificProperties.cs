                ...
                public readonly partial struct CertsEntityArray
                {
                    ...
                    public readonly partial struct CertsEntity
                    {
...
#endif
                        {
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.CypressBenchmark.Baseline.JsonString Cert
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CertUtf8, out Corvus.CypressBenchmark.Baseline.JsonString value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.CypressBenchmark.Baseline.JsonString Key
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KeyUtf8, out Corvus.CypressBenchmark.Baseline.JsonString value))
                                    {
                                        return value;
                                    }
