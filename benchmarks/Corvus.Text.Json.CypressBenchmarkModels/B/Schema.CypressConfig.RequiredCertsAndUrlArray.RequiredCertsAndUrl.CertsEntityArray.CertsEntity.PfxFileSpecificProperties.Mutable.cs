            ...
            public readonly partial struct RequiredCertsAndUrl
            {
                ...
                public readonly partial struct CertsEntityArray
                {
                    ...
                    public readonly partial struct CertsEntity
                    {
                        ...
                        public readonly partial struct PfxFileSpecificProperties
                        {
...
#endif
                            {
                                ...
                                public static explicit operator Mutable(PfxFileSpecificProperties instance)
                                {
                                ...
                                /// <returns>An immutable instance of a <see cref="PfxFileSpecificProperties"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator PfxFileSpecificProperties(Mutable instance)
                                {
                                ...
                                /// <summary>
                                /// Gets the (optional) <c>passphrase</c> property.
                                /// </summary>
                                /// <remarks>
                                /// <para>
                                ...
                                /// </para>
                                /// </remarks>
                                public Corvus.CypressBenchmark.Baseline.JsonString.Mutable Passphrase
                                {
                                    get
                                    {
                                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PassphraseUtf8, out Corvus.CypressBenchmark.Baseline.JsonString.Mutable value))
                                        {
                                            return value;
                                        }
                                ...
                                /// </para>
                                /// </remarks>
                                public Corvus.CypressBenchmark.Baseline.JsonString.Mutable Pfx
                                {
                                    get
                                    {
                                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PfxUtf8, out Corvus.CypressBenchmark.Baseline.JsonString.Mutable value))
                                        {
                                            return value;
                                        }
                                ...
                                {
                                    return
                                        (obj is IJsonElement value && Equals(new PfxFileSpecificProperties(value.ParentDocument, value.ParentDocumentIndex))) ||
                                ...
                                public void SetPassphrase(in Corvus.CypressBenchmark.Baseline.JsonString.Source value)
                                {
                                    CheckValidInstance();

                                    if (value.IsUndefined)
                                    {
                                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PassphraseUtf8);
                                        _documentVersion = _parent.Version;
                                        return;
                                    }

                                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PassphraseUtf8, out IJsonDocument? elementParent, out int elementIdx))
                                    {
                                    ...
                                    else
                                    {
                                        ...
                                        value.AddAsProperty(JsonPropertyNamesEscaped.Passphrase, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                                ...
                                /// <summary>
                                /// Remove the <c>passphrase</c> property, if present.
                                /// </summary>
                                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                                public bool RemovePassphrase()
                                {
                                    CheckValidInstance();
                                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PassphraseUtf8);
                                    _documentVersion = _parent.Version;
                                    return result;
                                }

                                /// <summary>
                                /// Set the <c>pfx</c> property.
                                /// </summary>
                                /// <param name="value">The value of the property to add.</param>
                                public void SetPfx(in Corvus.CypressBenchmark.Baseline.JsonString.Source value)
                                {
                                    CheckValidInstance();

                                    if (value.IsUndefined)
                                    {
                                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("pfx");
                                    }

                                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PfxUtf8, out IJsonDocument? elementParent, out int elementIdx))
                                    {
                                        // We are going to replace just the value
                                        value.AddAsItem(ref cvb);
                                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                                    ...
                                    {
                                        // We are going to insert the new value
                                        value.AddAsProperty(JsonPropertyNamesEscaped.Pfx, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                                    }
                                ...
                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"PfxFileSpecificProperties.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// <summary>
                                /// Gets a <see cref="PfxFileSpecificProperties"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </summary>
                                /// <returns>
                                /// A <see cref="PfxFileSpecificProperties"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </returns>
                                /// <remarks>
                                /// <para>
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly PfxFileSpecificProperties Clone()
                                {
                                    CheckValidInstance();
                                    return _parent.CloneElement<PfxFileSpecificProperties>(_idx);
                                }
                                ...
                                /// </summary>
                                /// <returns>
                                /// An immutable <see cref="PfxFileSpecificProperties"/> that lives for the lifetime of its
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly PfxFileSpecificProperties Freeze()
                                {
                                    CheckValidInstance();
                                    return _parent.FreezeElement<PfxFileSpecificProperties>(_idx);
                                }
                            }
                            ...
                            public ref struct Source
                            {
                                ...
                                internal Source(Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.RequiredCertsAndUrlArray.RequiredCertsAndUrl.CertsEntityArray.CertsEntity.PfxFileSpecificProperties.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                                public static implicit operator Source(PfxFileSpecificProperties instance) => new(JsonElement.From(instance));
                                ...
                                #endif
                            {
                                ...
                                internal Source(scoped in TContext context, Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.RequiredCertsAndUrlArray.RequiredCertsAndUrl.CertsEntityArray.CertsEntity.PfxFileSpecificProperties.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                            ...
                            public ref struct Builder
                            {
                                ...
                                /// <summary>
                                /// Creates an instance of a <see cref="PfxFileSpecificProperties"/>.
                                /// </summary>
                                internal static void Create(
                                    ref ComplexValueBuilder builder,
                                    in Corvus.CypressBenchmark.Baseline.JsonString.Source pfx,
                                    in Corvus.CypressBenchmark.Baseline.JsonString.Source passphrase = default)
                                {
                                    pfx.AddAsProperty(JsonPropertyNamesEscaped.Pfx, ref builder, escapeName: false);
                                    passphrase.AddAsProperty(JsonPropertyNamesEscaped.Passphrase, ref builder, escapeName: false);
                                }

                                /// <summary>
                                /// Creates an instance of a <see cref="PfxFileSpecificProperties"/>.
                                /// </summary>
                                public void Create(in Corvus.CypressBenchmark.Baseline.JsonString.Source pfx, in Corvus.CypressBenchmark.Baseline.JsonString.Source passphrase = default)
                                {
                                    Create(ref _builder, pfx, passphrase);
                                }
                            ...
                            /// </summary>
                            /// <param name="workspace">The JSON workspace.</param>
                            /// <param name="pfx">The value of the property.</param>
                            /// <param name="passphrase">The value of the property.</param>
                            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CypressBenchmark.Baseline.JsonString.Source pfx, in Corvus.CypressBenchmark.Baseline.JsonString.Source passphrase = default, int initialCapacity = 30)
                            {
                                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                                cvb.StartObject();
                                Builder ovb = new(cvb);
                                ovb.Create(pfx, passphrase);
                                cvb = ovb._builder;
                                cvb.EndObject();
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder;
                            ...
                            {
                                return workspace.CreateBuilder<PfxFileSpecificProperties, Mutable>(this);
                            }
                        }
                    }
                }
