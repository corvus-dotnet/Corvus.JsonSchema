                ...
                public readonly partial struct CertsEntityArray
                {
                    ...
                    public readonly partial struct CertsEntity
                    {
...
#endif
                        {
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.CypressBenchmark.Baseline.JsonString Passphrase
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PassphraseUtf8, out Corvus.CypressBenchmark.Baseline.JsonString value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.CypressBenchmark.Baseline.JsonString Pfx
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PfxUtf8, out Corvus.CypressBenchmark.Baseline.JsonString value))
                                    {
                                        return value;
                                    }
