        ...
        public readonly partial struct RequiredCertsAndUrlArray
        {
            ...
            public readonly partial struct RequiredCertsAndUrl
            {
...
#endif
                {
                    ...
                    public Corvus.CypressBenchmark.Baseline.JsonString this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.CypressBenchmark.Baseline.JsonString>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.CypressBenchmark.Baseline.JsonString> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.CypressBenchmark.Baseline.JsonString>(_parent, _idx);
                    }
