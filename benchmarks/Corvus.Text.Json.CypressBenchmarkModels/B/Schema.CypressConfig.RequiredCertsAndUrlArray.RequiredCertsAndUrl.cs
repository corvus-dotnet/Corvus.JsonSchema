    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct RequiredCertsAndUrlArray
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.RequiredCertsAndUrlArray.RequiredCertsAndUrl.JsonStringArray Ca
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CaUtf8, out Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.RequiredCertsAndUrlArray.RequiredCertsAndUrl.JsonStringArray value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.RequiredCertsAndUrlArray.RequiredCertsAndUrl.CertsEntityArray Certs
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CertsUtf8, out Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.RequiredCertsAndUrlArray.RequiredCertsAndUrl.CertsEntityArray value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.CypressBenchmark.Baseline.JsonString Url
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UrlUtf8, out Corvus.CypressBenchmark.Baseline.JsonString value))
                        {
                            return value;
                        }
