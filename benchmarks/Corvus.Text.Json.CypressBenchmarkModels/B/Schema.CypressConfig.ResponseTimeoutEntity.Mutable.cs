    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct ResponseTimeoutEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ResponseTimeoutEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ResponseTimeoutEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ResponseTimeoutEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ResponseTimeoutEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ResponseTimeoutEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ResponseTimeoutEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ResponseTimeoutEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ResponseTimeoutEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ResponseTimeoutEntity, Mutable>(this);
            }
        }
    }
}
