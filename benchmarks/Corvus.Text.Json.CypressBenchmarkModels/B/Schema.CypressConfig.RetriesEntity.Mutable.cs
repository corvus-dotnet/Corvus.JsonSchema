    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct RetriesEntity
        {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.RetriesEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CypressBenchmark.Baseline.Schema.CypressConfig.RetriesEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
