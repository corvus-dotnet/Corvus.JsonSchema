...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct ScreenshotOnRunFailureEntity
#if NET8_0_OR_GREATER
            : IJsonElement<ScreenshotOnRunFailureEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ScreenshotOnRunFailureEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ScreenshotOnRunFailureEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ScreenshotOnRunFailureEntity DefaultInstance { get; } = ParsedJsonDocument<ScreenshotOnRunFailureEntity>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(ScreenshotOnRunFailureEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in ScreenshotOnRunFailureEntity left, in ScreenshotOnRunFailureEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ScreenshotOnRunFailureEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ScreenshotOnRunFailureEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ScreenshotOnRunFailureEntity(JsonElement instance)
            {
                return ScreenshotOnRunFailureEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ScreenshotOnRunFailureEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ScreenshotOnRunFailureEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ScreenshotOnRunFailureEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ScreenshotOnRunFailureEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ScreenshotOnRunFailureEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ScreenshotOnRunFailureEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ScreenshotOnRunFailureEntity>(json, options);
            }
            ...
            /// </exception>
            public static ScreenshotOnRunFailureEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ScreenshotOnRunFailureEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ScreenshotOnRunFailureEntity? result)
            {
                return JsonElementHelpers.TryParseValue<ScreenshotOnRunFailureEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ScreenshotOnRunFailureEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ScreenshotOnRunFailureEntity IJsonElement<ScreenshotOnRunFailureEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ScreenshotOnRunFailureEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ScreenshotOnRunFailureEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ScreenshotOnRunFailureEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ScreenshotOnRunFailureEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ScreenshotOnRunFailureEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ScreenshotOnRunFailureEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ScreenshotOnRunFailureEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ScreenshotOnRunFailureEntity>(_idx);
                }
