    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct ScreenshotsFolderEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ScreenshotsFolderEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ScreenshotsFolderEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ScreenshotsFolderEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ScreenshotsFolderEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ScreenshotsFolderEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ScreenshotsFolderEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ScreenshotsFolderEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ScreenshotsFolderEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ScreenshotsFolderEntity, Mutable>(this);
            }
        }
    }
}
