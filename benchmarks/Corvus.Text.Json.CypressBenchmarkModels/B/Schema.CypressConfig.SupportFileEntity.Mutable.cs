...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct SupportFileEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SupportFileEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SupportFileEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SupportFileEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new SupportFileEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SupportFileEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="SupportFileEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="SupportFileEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly SupportFileEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<SupportFileEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="SupportFileEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly SupportFileEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SupportFileEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SupportFileEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SupportFileEntity, Mutable>(this);
            }
        }
    }
}
