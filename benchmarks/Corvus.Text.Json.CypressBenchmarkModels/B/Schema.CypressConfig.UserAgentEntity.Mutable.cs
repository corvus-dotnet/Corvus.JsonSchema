    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct UserAgentEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(UserAgentEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="UserAgentEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator UserAgentEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"UserAgentEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly UserAgentEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly UserAgentEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<UserAgentEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(UserAgentEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<UserAgentEntity, Mutable>(this);
            }
        }
    }
}
