    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct VideoEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(VideoEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="VideoEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator VideoEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"VideoEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly VideoEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly VideoEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<VideoEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(VideoEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<VideoEntity, Mutable>(this);
            }
        }
    }
}
