...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct WatchForFileChangesEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(WatchForFileChangesEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="WatchForFileChangesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WatchForFileChangesEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new WatchForFileChangesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WatchForFileChangesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="WatchForFileChangesEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="WatchForFileChangesEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly WatchForFileChangesEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<WatchForFileChangesEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="WatchForFileChangesEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly WatchForFileChangesEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<WatchForFileChangesEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(WatchForFileChangesEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<WatchForFileChangesEntity, Mutable>(this);
            }
        }
    }
}
