...
public readonly partial struct CypressSchema
{
    ...
    public readonly partial struct AllOf1Entity
    {
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.Source _createArg1;
            private readonly Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.Source _createArg2;
            ...
            #endif
        {
            ...
            private readonly Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.Source<TContext> _createArg1;
            private readonly Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.Source<TContext> _createArg2;
        ...
        public ref struct Builder
        {
            ...
            /// Creates an instance of a <see cref="AllOf1Entity"/>.
            /// </summary>
            public void Create(in Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.Source component = default, in Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.Source e2e = default)
            {
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.Source<TContext> component = default, scoped in Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.Source<TContext> e2e = default)
            ...
            #endif
        {
            return new Source<TContext>(context, component, e2e);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.Source component = default, in Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.Source e2e = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        public static ParsedJsonDocument<AllOf1Entity> Create(in Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.Source component = default, in Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.Source e2e = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<AllOf1Entity> Create<TContext>(in TContext context, in Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.Source<TContext> component = default, in Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.Source<TContext> e2e = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
