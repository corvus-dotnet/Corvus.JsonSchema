    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct AnimationDistanceThresholdEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AnimationDistanceThresholdEntity, Mutable>(AnimationDistanceThresholdEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<AnimationDistanceThresholdEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AnimationDistanceThresholdEntity>();
                }
                finally
                {
