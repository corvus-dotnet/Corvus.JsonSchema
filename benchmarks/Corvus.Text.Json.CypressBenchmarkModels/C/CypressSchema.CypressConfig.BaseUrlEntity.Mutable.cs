    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct BaseUrlEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<BaseUrlEntity, Mutable>(BaseUrlEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(BaseUrlEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="BaseUrlEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator BaseUrlEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"BaseUrlEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly BaseUrlEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly BaseUrlEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<BaseUrlEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(BaseUrlEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<BaseUrlEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<BaseUrlEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<BaseUrlEntity>();
                }
                finally
                {
