    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct BlockHostsArray
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<BlockHostsArray, Mutable>(BlockHostsArray.DefaultInstance);
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.BlockHostsArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.BlockHostsArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public static ParsedJsonDocument<BlockHostsArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<BlockHostsArray>();
                }
                finally
                {
