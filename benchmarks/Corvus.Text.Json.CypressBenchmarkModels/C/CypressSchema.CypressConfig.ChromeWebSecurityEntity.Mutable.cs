    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct ChromeWebSecurityEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ChromeWebSecurityEntity, Mutable>(ChromeWebSecurityEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(ChromeWebSecurityEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ChromeWebSecurityEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ChromeWebSecurityEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ChromeWebSecurityEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ChromeWebSecurityEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ChromeWebSecurityEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ChromeWebSecurityEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ChromeWebSecurityEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ChromeWebSecurityEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ChromeWebSecurityEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ChromeWebSecurityEntity>();
                }
                finally
                {
