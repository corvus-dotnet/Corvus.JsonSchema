    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct ComponentFolderEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ComponentFolderEntity, Mutable>(ComponentFolderEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(ComponentFolderEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ComponentFolderEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ComponentFolderEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ComponentFolderEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ComponentFolderEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ComponentFolderEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ComponentFolderEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ComponentFolderEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ComponentFolderEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ComponentFolderEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ComponentFolderEntity>();
                }
                finally
                {
