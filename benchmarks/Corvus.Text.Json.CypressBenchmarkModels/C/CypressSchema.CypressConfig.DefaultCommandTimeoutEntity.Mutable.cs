    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct DefaultCommandTimeoutEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DefaultCommandTimeoutEntity, Mutable>(DefaultCommandTimeoutEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(DefaultCommandTimeoutEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DefaultCommandTimeoutEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DefaultCommandTimeoutEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DefaultCommandTimeoutEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DefaultCommandTimeoutEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DefaultCommandTimeoutEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DefaultCommandTimeoutEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DefaultCommandTimeoutEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DefaultCommandTimeoutEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DefaultCommandTimeoutEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DefaultCommandTimeoutEntity>();
                }
                finally
                {
