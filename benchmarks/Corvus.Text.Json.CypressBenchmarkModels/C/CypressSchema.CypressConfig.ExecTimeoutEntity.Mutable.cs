    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct ExecTimeoutEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ExecTimeoutEntity, Mutable>(ExecTimeoutEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(ExecTimeoutEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ExecTimeoutEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExecTimeoutEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExecTimeoutEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ExecTimeoutEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ExecTimeoutEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ExecTimeoutEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ExecTimeoutEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ExecTimeoutEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ExecTimeoutEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ExecTimeoutEntity>();
                }
                finally
                {
