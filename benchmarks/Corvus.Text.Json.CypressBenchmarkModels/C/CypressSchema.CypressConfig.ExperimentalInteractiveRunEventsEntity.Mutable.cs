    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct ExperimentalInteractiveRunEventsEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ExperimentalInteractiveRunEventsEntity, Mutable>(ExperimentalInteractiveRunEventsEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(ExperimentalInteractiveRunEventsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ExperimentalInteractiveRunEventsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExperimentalInteractiveRunEventsEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExperimentalInteractiveRunEventsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ExperimentalInteractiveRunEventsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ExperimentalInteractiveRunEventsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ExperimentalInteractiveRunEventsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ExperimentalInteractiveRunEventsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ExperimentalInteractiveRunEventsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ExperimentalInteractiveRunEventsEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ExperimentalInteractiveRunEventsEntity>();
                }
                finally
                {
