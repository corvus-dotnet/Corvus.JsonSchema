    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct ExperimentalSessionSupportEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ExperimentalSessionSupportEntity, Mutable>(ExperimentalSessionSupportEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<ExperimentalSessionSupportEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ExperimentalSessionSupportEntity>();
                }
                finally
                {
