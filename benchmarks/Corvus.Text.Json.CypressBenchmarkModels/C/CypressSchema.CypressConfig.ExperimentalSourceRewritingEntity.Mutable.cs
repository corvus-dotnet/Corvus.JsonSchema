...
public readonly partial struct CypressSchema
{
    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct ExperimentalSourceRewritingEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ExperimentalSourceRewritingEntity, Mutable>(ExperimentalSourceRewritingEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(ExperimentalSourceRewritingEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ExperimentalSourceRewritingEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExperimentalSourceRewritingEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ExperimentalSourceRewritingEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExperimentalSourceRewritingEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ExperimentalSourceRewritingEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ExperimentalSourceRewritingEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ExperimentalSourceRewritingEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ExperimentalSourceRewritingEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ExperimentalSourceRewritingEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ExperimentalSourceRewritingEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ExperimentalSourceRewritingEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ExperimentalSourceRewritingEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ExperimentalSourceRewritingEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ExperimentalSourceRewritingEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ExperimentalSourceRewritingEntity>();
                }
                finally
                {
