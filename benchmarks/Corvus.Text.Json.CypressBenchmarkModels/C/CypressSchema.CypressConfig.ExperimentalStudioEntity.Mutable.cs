    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct ExperimentalStudioEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ExperimentalStudioEntity, Mutable>(ExperimentalStudioEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<ExperimentalStudioEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ExperimentalStudioEntity>();
                }
                finally
                {
