    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct FileServerFolderEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<FileServerFolderEntity, Mutable>(FileServerFolderEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(FileServerFolderEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="FileServerFolderEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FileServerFolderEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new FileServerFolderEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FileServerFolderEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="FileServerFolderEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="FileServerFolderEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly FileServerFolderEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<FileServerFolderEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="FileServerFolderEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly FileServerFolderEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<FileServerFolderEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(FileServerFolderEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<FileServerFolderEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<FileServerFolderEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<FileServerFolderEntity>();
                }
                finally
                {
