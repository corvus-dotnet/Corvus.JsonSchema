...
public readonly partial struct CypressSchema
{
    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct IgnoreTestFilesArray
#if NET8_0_OR_GREATER
            : IJsonElement<IgnoreTestFilesArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="IgnoreTestFilesArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal IgnoreTestFilesArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static IgnoreTestFilesArray DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(IgnoreTestFilesArray value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in IgnoreTestFilesArray left, in IgnoreTestFilesArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in IgnoreTestFilesArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(IgnoreTestFilesArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator IgnoreTestFilesArray(JsonElement instance)
            {
                return IgnoreTestFilesArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IgnoreTestFilesArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IgnoreTestFilesArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IgnoreTestFilesArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IgnoreTestFilesArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IgnoreTestFilesArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IgnoreTestFilesArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IgnoreTestFilesArray>(json, options);
            }
            ...
            /// </exception>
            public static IgnoreTestFilesArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<IgnoreTestFilesArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out IgnoreTestFilesArray? result)
            {
                return JsonElementHelpers.TryParseValue<IgnoreTestFilesArray>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new IgnoreTestFilesArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static IgnoreTestFilesArray IJsonElement<IgnoreTestFilesArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"IgnoreTestFilesArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="IgnoreTestFilesArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="IgnoreTestFilesArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public IgnoreTestFilesArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<IgnoreTestFilesArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="IgnoreTestFilesArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public IgnoreTestFilesArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<IgnoreTestFilesArray>(_idx);
                }
