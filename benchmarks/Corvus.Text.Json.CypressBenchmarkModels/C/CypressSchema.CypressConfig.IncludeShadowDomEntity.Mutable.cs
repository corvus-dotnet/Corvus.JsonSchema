    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct IncludeShadowDomEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<IncludeShadowDomEntity, Mutable>(IncludeShadowDomEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<IncludeShadowDomEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<IncludeShadowDomEntity>();
                }
                finally
                {
