...
public readonly partial struct CypressSchema
{
    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct ModifyObstructiveCodeEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ModifyObstructiveCodeEntity, Mutable>(ModifyObstructiveCodeEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(ModifyObstructiveCodeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ModifyObstructiveCodeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ModifyObstructiveCodeEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ModifyObstructiveCodeEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ModifyObstructiveCodeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ModifyObstructiveCodeEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ModifyObstructiveCodeEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ModifyObstructiveCodeEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ModifyObstructiveCodeEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ModifyObstructiveCodeEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ModifyObstructiveCodeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ModifyObstructiveCodeEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ModifyObstructiveCodeEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ModifyObstructiveCodeEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ModifyObstructiveCodeEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ModifyObstructiveCodeEntity>();
                }
                finally
                {
