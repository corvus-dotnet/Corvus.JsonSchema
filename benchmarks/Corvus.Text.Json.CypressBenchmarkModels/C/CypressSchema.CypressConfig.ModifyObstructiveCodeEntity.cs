...
public readonly partial struct CypressSchema
{
    ...
    public readonly partial struct CypressConfig
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ModifyObstructiveCodeEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ModifyObstructiveCodeEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ModifyObstructiveCodeEntity DefaultInstance { get; } = ParsedJsonDocument<ModifyObstructiveCodeEntity>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(ModifyObstructiveCodeEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in ModifyObstructiveCodeEntity left, in ModifyObstructiveCodeEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ModifyObstructiveCodeEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ModifyObstructiveCodeEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ModifyObstructiveCodeEntity(JsonElement instance)
            {
                return ModifyObstructiveCodeEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ModifyObstructiveCodeEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ModifyObstructiveCodeEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ModifyObstructiveCodeEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ModifyObstructiveCodeEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ModifyObstructiveCodeEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ModifyObstructiveCodeEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ModifyObstructiveCodeEntity>(json, options);
            }
            ...
            /// </exception>
            public static ModifyObstructiveCodeEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ModifyObstructiveCodeEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ModifyObstructiveCodeEntity? result)
            {
                return JsonElementHelpers.TryParseValue<ModifyObstructiveCodeEntity>(ref reader, out result);
            }
...
#if NET
            static ModifyObstructiveCodeEntity IJsonElement<ModifyObstructiveCodeEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ModifyObstructiveCodeEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ModifyObstructiveCodeEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ModifyObstructiveCodeEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ModifyObstructiveCodeEntity>(_idx);
                }
