    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct NodeVersionEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NodeVersionEntity, Mutable>(NodeVersionEntity.DefaultInstance);
            ...
            public ref struct Source
            {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (NodeVersionEntity)value;
            ...
            public static ParsedJsonDocument<NodeVersionEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<NodeVersionEntity>();
                }
                finally
                {
