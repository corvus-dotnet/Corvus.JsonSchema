    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct NumTestsKeptInMemoryEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NumTestsKeptInMemoryEntity, Mutable>(NumTestsKeptInMemoryEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<NumTestsKeptInMemoryEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<NumTestsKeptInMemoryEntity>();
                }
                finally
                {
