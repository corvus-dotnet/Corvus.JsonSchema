    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct PageLoadTimeoutEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PageLoadTimeoutEntity, Mutable>(PageLoadTimeoutEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(PageLoadTimeoutEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PageLoadTimeoutEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PageLoadTimeoutEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PageLoadTimeoutEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PageLoadTimeoutEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PageLoadTimeoutEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PageLoadTimeoutEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PageLoadTimeoutEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PageLoadTimeoutEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PageLoadTimeoutEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PageLoadTimeoutEntity>();
                }
                finally
                {
