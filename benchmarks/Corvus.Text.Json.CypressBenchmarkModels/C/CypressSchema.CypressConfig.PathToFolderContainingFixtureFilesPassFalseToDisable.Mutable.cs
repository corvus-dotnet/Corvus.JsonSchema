...
public readonly partial struct CypressSchema
{
    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct PathToFolderContainingFixtureFilesPassFalseToDisable
        {
            ...
            public static ParsedJsonDocument<PathToFolderContainingFixtureFilesPassFalseToDisable> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PathToFolderContainingFixtureFilesPassFalseToDisable>();
                }
                finally
                {
