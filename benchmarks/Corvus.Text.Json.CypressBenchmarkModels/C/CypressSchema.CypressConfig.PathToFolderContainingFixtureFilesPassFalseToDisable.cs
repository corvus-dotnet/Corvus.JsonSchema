...
public readonly partial struct CypressSchema
{
    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct PathToFolderContainingFixtureFilesPassFalseToDisable
            ...
            : IJsonElement<PathToFolderContainingFixtureFilesPassFalseToDisable>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="PathToFolderContainingFixtureFilesPassFalseToDisable"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal PathToFolderContainingFixtureFilesPassFalseToDisable(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static PathToFolderContainingFixtureFilesPassFalseToDisable DefaultInstance { get; } = ParsedJsonDocument<PathToFolderContainingFixtureFilesPassFalseToDisable>.StringConstant([.."\"cypress/fixtures\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(PathToFolderContainingFixtureFilesPassFalseToDisable value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator bool(PathToFolderContainingFixtureFilesPassFalseToDisable value)
            {
            ...
            /// </returns>
            public static bool operator ==(in PathToFolderContainingFixtureFilesPassFalseToDisable left, in PathToFolderContainingFixtureFilesPassFalseToDisable right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in PathToFolderContainingFixtureFilesPassFalseToDisable left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(PathToFolderContainingFixtureFilesPassFalseToDisable instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PathToFolderContainingFixtureFilesPassFalseToDisable(JsonElement instance)
            {
                return PathToFolderContainingFixtureFilesPassFalseToDisable.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PathToFolderContainingFixtureFilesPassFalseToDisable From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PathToFolderContainingFixtureFilesPassFalseToDisable ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<PathToFolderContainingFixtureFilesPassFalseToDisable>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PathToFolderContainingFixtureFilesPassFalseToDisable ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<PathToFolderContainingFixtureFilesPassFalseToDisable>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PathToFolderContainingFixtureFilesPassFalseToDisable ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<PathToFolderContainingFixtureFilesPassFalseToDisable>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static PathToFolderContainingFixtureFilesPassFalseToDisable ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<PathToFolderContainingFixtureFilesPassFalseToDisable>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out PathToFolderContainingFixtureFilesPassFalseToDisable? result)
            {
                return JsonElementHelpers.TryParseValue<PathToFolderContainingFixtureFilesPassFalseToDisable>(ref reader, out result);
            }
...
#if NET
            static PathToFolderContainingFixtureFilesPassFalseToDisable IJsonElement<PathToFolderContainingFixtureFilesPassFalseToDisable>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PathToFolderContainingFixtureFilesPassFalseToDisable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public PathToFolderContainingFixtureFilesPassFalseToDisable Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public PathToFolderContainingFixtureFilesPassFalseToDisable Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<PathToFolderContainingFixtureFilesPassFalseToDisable>(_idx);
                }
