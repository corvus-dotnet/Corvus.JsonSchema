    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct PathToFolderContainingIntegrationTestFiles
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PathToFolderContainingIntegrationTestFiles, Mutable>(PathToFolderContainingIntegrationTestFiles.DefaultInstance);
                ...
                public static explicit operator Mutable(PathToFolderContainingIntegrationTestFiles instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PathToFolderContainingIntegrationTestFiles"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PathToFolderContainingIntegrationTestFiles(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PathToFolderContainingIntegrationTestFiles.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PathToFolderContainingIntegrationTestFiles Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PathToFolderContainingIntegrationTestFiles Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PathToFolderContainingIntegrationTestFiles>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PathToFolderContainingIntegrationTestFiles instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PathToFolderContainingIntegrationTestFiles, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PathToFolderContainingIntegrationTestFiles> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PathToFolderContainingIntegrationTestFiles>();
                }
                finally
                {
