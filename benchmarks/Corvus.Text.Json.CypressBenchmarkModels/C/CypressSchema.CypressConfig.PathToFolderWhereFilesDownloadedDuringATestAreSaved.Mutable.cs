    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct PathToFolderWhereFilesDownloadedDuringATestAreSaved
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PathToFolderWhereFilesDownloadedDuringATestAreSaved, Mutable>(PathToFolderWhereFilesDownloadedDuringATestAreSaved.DefaultInstance);
            ...
            public static ParsedJsonDocument<PathToFolderWhereFilesDownloadedDuringATestAreSaved> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PathToFolderWhereFilesDownloadedDuringATestAreSaved>();
                }
                finally
                {
