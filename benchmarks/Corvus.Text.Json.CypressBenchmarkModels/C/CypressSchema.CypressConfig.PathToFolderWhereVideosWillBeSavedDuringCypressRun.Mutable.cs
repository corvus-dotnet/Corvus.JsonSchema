    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct PathToFolderWhereVideosWillBeSavedDuringCypressRun
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PathToFolderWhereVideosWillBeSavedDuringCypressRun, Mutable>(PathToFolderWhereVideosWillBeSavedDuringCypressRun.DefaultInstance);
            ...
            public static ParsedJsonDocument<PathToFolderWhereVideosWillBeSavedDuringCypressRun> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PathToFolderWhereVideosWillBeSavedDuringCypressRun>();
                }
                finally
                {
