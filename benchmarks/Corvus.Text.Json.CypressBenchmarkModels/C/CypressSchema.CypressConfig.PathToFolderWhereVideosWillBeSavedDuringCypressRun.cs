...
public readonly partial struct CypressSchema
{
    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct PathToFolderWhereVideosWillBeSavedDuringCypressRun
#if NET8_0_OR_GREATER
            : IJsonElement<PathToFolderWhereVideosWillBeSavedDuringCypressRun>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="PathToFolderWhereVideosWillBeSavedDuringCypressRun"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal PathToFolderWhereVideosWillBeSavedDuringCypressRun(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static PathToFolderWhereVideosWillBeSavedDuringCypressRun DefaultInstance { get; } = ParsedJsonDocument<PathToFolderWhereVideosWillBeSavedDuringCypressRun>.StringConstant([.."\"cypress/videos\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(PathToFolderWhereVideosWillBeSavedDuringCypressRun value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in PathToFolderWhereVideosWillBeSavedDuringCypressRun left, in PathToFolderWhereVideosWillBeSavedDuringCypressRun right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in PathToFolderWhereVideosWillBeSavedDuringCypressRun left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(PathToFolderWhereVideosWillBeSavedDuringCypressRun instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PathToFolderWhereVideosWillBeSavedDuringCypressRun(JsonElement instance)
            {
                return PathToFolderWhereVideosWillBeSavedDuringCypressRun.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PathToFolderWhereVideosWillBeSavedDuringCypressRun From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PathToFolderWhereVideosWillBeSavedDuringCypressRun ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PathToFolderWhereVideosWillBeSavedDuringCypressRun>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PathToFolderWhereVideosWillBeSavedDuringCypressRun ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PathToFolderWhereVideosWillBeSavedDuringCypressRun>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PathToFolderWhereVideosWillBeSavedDuringCypressRun ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PathToFolderWhereVideosWillBeSavedDuringCypressRun>(json, options);
            }
            ...
            /// </exception>
            public static PathToFolderWhereVideosWillBeSavedDuringCypressRun ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<PathToFolderWhereVideosWillBeSavedDuringCypressRun>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out PathToFolderWhereVideosWillBeSavedDuringCypressRun? result)
            {
                return JsonElementHelpers.TryParseValue<PathToFolderWhereVideosWillBeSavedDuringCypressRun>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PathToFolderWhereVideosWillBeSavedDuringCypressRun(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static PathToFolderWhereVideosWillBeSavedDuringCypressRun IJsonElement<PathToFolderWhereVideosWillBeSavedDuringCypressRun>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PathToFolderWhereVideosWillBeSavedDuringCypressRun: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="PathToFolderWhereVideosWillBeSavedDuringCypressRun"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="PathToFolderWhereVideosWillBeSavedDuringCypressRun"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public PathToFolderWhereVideosWillBeSavedDuringCypressRun Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<PathToFolderWhereVideosWillBeSavedDuringCypressRun>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="PathToFolderWhereVideosWillBeSavedDuringCypressRun"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public PathToFolderWhereVideosWillBeSavedDuringCypressRun Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<PathToFolderWhereVideosWillBeSavedDuringCypressRun>(_idx);
                }
