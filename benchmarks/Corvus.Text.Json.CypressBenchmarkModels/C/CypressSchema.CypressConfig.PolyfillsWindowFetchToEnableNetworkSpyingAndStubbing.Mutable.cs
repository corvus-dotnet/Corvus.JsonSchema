    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing, Mutable>(PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing.DefaultInstance);
                ...
                public static explicit operator Mutable(PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing>();
                }
                finally
                {
