...
public readonly partial struct CypressSchema
{
    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing
#if NET8_0_OR_GREATER
            : IJsonElement<PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing DefaultInstance { get; } = ParsedJsonDocument<PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing value)
            {
            ...
            /// </returns>
            public static bool operator ==(in PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing left, in PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing(JsonElement instance)
            {
                return PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing? result)
            {
                return JsonElementHelpers.TryParseValue<PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing IJsonElement<PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<PolyfillsWindowFetchToEnableNetworkSpyingAndStubbing>(_idx);
                }
