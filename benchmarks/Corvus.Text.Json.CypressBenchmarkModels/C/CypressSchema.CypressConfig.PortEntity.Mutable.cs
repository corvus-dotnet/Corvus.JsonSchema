    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct PortEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PortEntity, Mutable>(PortEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(PortEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PortEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PortEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PortEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PortEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PortEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PortEntity>(_idx);
                }
            }
            ...
            {
                return workspace.CreateBuilder<PortEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PortEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PortEntity>();
                }
                finally
                {
