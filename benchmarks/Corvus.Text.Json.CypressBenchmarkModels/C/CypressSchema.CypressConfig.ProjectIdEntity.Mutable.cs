    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct ProjectIdEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ProjectIdEntity, Mutable>(ProjectIdEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<ProjectIdEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ProjectIdEntity>();
                }
                finally
                {
