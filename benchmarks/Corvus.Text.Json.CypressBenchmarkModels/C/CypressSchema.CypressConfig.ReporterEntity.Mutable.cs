    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct ReporterEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ReporterEntity, Mutable>(ReporterEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(ReporterEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ReporterEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ReporterEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ReporterEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ReporterEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ReporterEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ReporterEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ReporterEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ReporterEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ReporterEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ReporterEntity>();
                }
                finally
                {
