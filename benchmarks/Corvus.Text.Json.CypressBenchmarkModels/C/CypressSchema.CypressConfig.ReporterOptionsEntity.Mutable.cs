    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct ReporterOptionsEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ReporterOptionsEntity, Mutable>(ReporterOptionsEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(ReporterOptionsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ReporterOptionsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ReporterOptionsEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ReporterOptionsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ReporterOptionsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ReporterOptionsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ReporterOptionsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.ReporterOptionsEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(ReporterOptionsEntity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.ReporterOptionsEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<ReporterOptionsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ReporterOptionsEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ReporterOptionsEntity>();
                }
                finally
                {
