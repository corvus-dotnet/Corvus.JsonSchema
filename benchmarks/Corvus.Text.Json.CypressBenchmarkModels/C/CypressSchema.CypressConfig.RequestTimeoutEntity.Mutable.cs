    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct RequestTimeoutEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<RequestTimeoutEntity, Mutable>(RequestTimeoutEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(RequestTimeoutEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequestTimeoutEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequestTimeoutEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequestTimeoutEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RequestTimeoutEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RequestTimeoutEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequestTimeoutEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RequestTimeoutEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RequestTimeoutEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RequestTimeoutEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RequestTimeoutEntity>();
                }
                finally
                {
