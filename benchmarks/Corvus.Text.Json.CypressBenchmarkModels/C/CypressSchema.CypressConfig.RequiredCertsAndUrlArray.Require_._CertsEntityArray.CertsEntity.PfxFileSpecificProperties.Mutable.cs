                    ...
                    public readonly partial struct CertsEntity
                    {
                        ...
                        public readonly partial struct PfxFileSpecificProperties
                        {
...
#endif
                            {
                                ...
                                /// </para>
                                /// </remarks>
                                public Corvus.CypressBenchmark.Current.JsonString.Mutable Passphrase
                                {
                                    get
                                    {
                                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PassphraseUtf8, out Corvus.CypressBenchmark.Current.JsonString.Mutable value))
                                        {
                                            return value;
                                        }
                                ...
                                /// </para>
                                /// </remarks>
                                public Corvus.CypressBenchmark.Current.JsonString.Mutable Pfx
                                {
                                    get
                                    {
                                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PfxUtf8, out Corvus.CypressBenchmark.Current.JsonString.Mutable value))
                                        {
                                            return value;
                                        }
                                ...
                                public void SetPassphrase(scoped in Corvus.CypressBenchmark.Current.JsonString.Source value)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Passphrase, ref cvb);
                                ...
                                /// </summary>
                                /// <param name="value">The value of the property to add.</param>
                                public void SetPfx(scoped in Corvus.CypressBenchmark.Current.JsonString.Source value)
                                {
                                    CheckValidInstance();
                                    ...
                                    {
                                        // We are going to insert the new value
                                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Pfx, ref cvb);
                                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                                    }
                            ...
                            public ref struct Source
                            {
                                ...
                                private readonly Corvus.CypressBenchmark.Current.JsonString.Source _createArg1;
                                ...
                                internal Source(Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.RequiredCertsAndUrlArray.RequiredCertsAndUrl.CertsEntityArray.CertsEntity.PfxFileSpecificProperties.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                                internal Source(scoped in Corvus.CypressBenchmark.Current.JsonString.Source arg1, scoped in Corvus.CypressBenchmark.Current.JsonString.Source arg2)
                                {
                                    _createArg1 = arg1;
                                    _createArg2 = arg2;
                                    _kind = Kind.Create;
                                ...
                                #endif
                            {
                                ...
                                internal Source(scoped in TContext context, Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.RequiredCertsAndUrlArray.RequiredCertsAndUrl.CertsEntityArray.CertsEntity.PfxFileSpecificProperties.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                            ...
                            public ref struct Builder
                            {
                                ...
                                internal static void Create(
                                    ...
                                    in Corvus.CypressBenchmark.Current.JsonString.Source pfx,
                                    in Corvus.CypressBenchmark.Current.JsonString.Source passphrase = default)
                                {
                                    pfx.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Pfx, ref builder);
                                    passphrase.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Passphrase, ref builder);
                                }

                                /// <summary>
                                /// Creates an instance of a <see cref="PfxFileSpecificProperties"/>.
                                /// </summary>
                                public void Create(in Corvus.CypressBenchmark.Current.JsonString.Source pfx, in Corvus.CypressBenchmark.Current.JsonString.Source passphrase = default)
                                {
                                ...
                                internal static void BuildCreateValue(scoped in Corvus.CypressBenchmark.Current.JsonString.Source arg1, scoped in Corvus.CypressBenchmark.Current.JsonString.Source arg2, ref ComplexValueBuilder o)
                                {
                                    o.StartObject();
                            ...
                            /// </summary>
                            /// <param name="pfx">The value of the <c>"pfx"</c> property.</param>
                            /// <param name="passphrase">The value of the <c>"passphrase"</c> property.</param>
                            /// <returns>The source from which to build the value.</returns>
                            public static Source Build(scoped in Corvus.CypressBenchmark.Current.JsonString.Source pfx, scoped in Corvus.CypressBenchmark.Current.JsonString.Source passphrase = default)
                            {
                                return new Source(pfx, passphrase);
                            }
                            ...
                            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CypressBenchmark.Current.JsonString.Source pfx, in Corvus.CypressBenchmark.Current.JsonString.Source passphrase = default, int initialCapacity = 30)
                            {
                                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                                cvb.StartObject();
                            ...
                            public static ParsedJsonDocument<PfxFileSpecificProperties> Create(
                                scoped in Source value, int initialCapacity = 30)
                            {
                                ...
                                try
                                {
                                    ...
                                    Debug.Assert(cvb.MemberCount == 1);
                                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                    return documentBuilder.ToParsedJsonDocument<PfxFileSpecificProperties>();
                                }
                                finally
                                {
                            ...
                            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                            public static ParsedJsonDocument<PfxFileSpecificProperties> Create<TContext>(
                            ...
                            public static ParsedJsonDocument<PfxFileSpecificProperties> Create(in Corvus.CypressBenchmark.Current.JsonString.Source pfx, in Corvus.CypressBenchmark.Current.JsonString.Source passphrase = default, int initialCapacity = 30)
                            {
                                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                                try
                                {
