                    ...
                    public readonly partial struct CertsEntity
                    {
                        ...
                        public readonly partial struct PemFileSpecificProperties
                        {
...
#endif
                            {
                                ...
                                public static explicit operator Mutable(PemFileSpecificProperties instance)
                                {
                                ...
                                /// <returns>An immutable instance of a <see cref="PemFileSpecificProperties"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator PemFileSpecificProperties(Mutable instance)
                                {
                                ...
                                /// </para>
                                /// </remarks>
                                public Corvus.CypressBenchmark.Current.JsonString.Mutable Cert
                                {
                                    get
                                    {
                                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CertUtf8, out Corvus.CypressBenchmark.Current.JsonString.Mutable value))
                                        {
                                            return value;
                                        }
                                ...
                                /// </para>
                                /// </remarks>
                                public Corvus.CypressBenchmark.Current.JsonString.Mutable Key
                                {
                                    get
                                    {
                                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KeyUtf8, out Corvus.CypressBenchmark.Current.JsonString.Mutable value))
                                        {
                                            return value;
                                        }
                                ...
                                {
                                    return
                                        (obj is IJsonElement value && Equals(new PemFileSpecificProperties(value.ParentDocument, value.ParentDocumentIndex))) ||
                                ...
                                public void SetCert(scoped in Corvus.CypressBenchmark.Current.JsonString.Source value)
                                {
                                    ...
                                    {
                                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("cert");
                                    }

                                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CertUtf8, out IJsonDocument? elementParent, out int elementIdx))
                                    {
                                    ...
                                    else
                                    {
                                        ...
                                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Cert, ref cvb);
                                ...
                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"PemFileSpecificProperties.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// <summary>
                                /// Gets a <see cref="PemFileSpecificProperties"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </summary>
                                /// <returns>
                                /// A <see cref="PemFileSpecificProperties"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </returns>
                                /// <remarks>
                                /// <para>
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly PemFileSpecificProperties Clone()
                                {
                                    CheckValidInstance();
                                    return _parent.CloneElement<PemFileSpecificProperties>(_idx);
                                }
                                ...
                                /// </summary>
                                /// <returns>
                                /// An immutable <see cref="PemFileSpecificProperties"/> that lives for the lifetime of its
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly PemFileSpecificProperties Freeze()
                                {
                                    CheckValidInstance();
                                    return _parent.FreezeElement<PemFileSpecificProperties>(_idx);
                                }
                            }
                            ...
                            public ref struct Source
                            {
                                ...
                                private readonly Corvus.CypressBenchmark.Current.JsonString.Source _createArg3;
                                ...
                                public static implicit operator Source(PemFileSpecificProperties instance) => new(JsonElement.From(instance));
                                ...
                                #endif
                            {
                                ...
                                internal Source(scoped in TContext context, Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.RequiredCertsAndUrlArray.RequiredCertsAndUrl.CertsEntityArray.CertsEntity.PemFileSpecificProperties.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                            ...
                            public ref struct Builder
                            {
                                ...
                                /// <summary>
                                /// Creates an instance of a <see cref="PemFileSpecificProperties"/>.
                                /// </summary>
                                internal static void Create(
                                    ref ComplexValueBuilder builder,
                                    in Corvus.CypressBenchmark.Current.JsonString.Source cert,
                                    in Corvus.CypressBenchmark.Current.JsonString.Source key,
                                    in Corvus.CypressBenchmark.Current.JsonString.Source passphrase = default)
                                {
                                    cert.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Cert, ref builder);
                                ...
                                public void Create(
                                    ...
                                    in Corvus.CypressBenchmark.Current.JsonString.Source passphrase = default)
                                {
                                    Create(ref _builder, cert, key, passphrase);
                                }
                            ...
                            /// </summary>
                            /// <param name="cert">The value of the <c>"cert"</c> property.</param>
                            ...
                            /// </summary>
                            /// <param name="workspace">The JSON workspace.</param>
                            /// <param name="cert">The value of the property.</param>
                            /// <param name="key">The value of the property.</param>
                            /// <param name="passphrase">The value of the property.</param>
                            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.CypressBenchmark.Current.JsonString.Source cert, in Corvus.CypressBenchmark.Current.JsonString.Source key, in Corvus.CypressBenchmark.Current.JsonString.Source passphrase = default, int initialCapacity = 30)
                            {
                                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                                cvb.StartObject();
                                Builder ovb = new(cvb);
                                ovb.Create(cert, key, passphrase);
                                cvb = ovb._builder;
                                cvb.EndObject();
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder;
                            ...
                            {
                                return workspace.CreateBuilder<PemFileSpecificProperties, Mutable>(this);
                            }
                            ...
                            public static ParsedJsonDocument<PemFileSpecificProperties> Create(
                                scoped in Source value, int initialCapacity = 30)
                            {
                                ...
                                try
                                {
                                    ...
                                    Debug.Assert(cvb.MemberCount == 1);
                                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                    return documentBuilder.ToParsedJsonDocument<PemFileSpecificProperties>();
                                }
                                finally
                                {
                            ...
                            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                            public static ParsedJsonDocument<PemFileSpecificProperties> Create<TContext>(
                            ...
                            public static ParsedJsonDocument<PemFileSpecificProperties> Create(in Corvus.CypressBenchmark.Current.JsonString.Source cert, in Corvus.CypressBenchmark.Current.JsonString.Source key, in Corvus.CypressBenchmark.Current.JsonString.Source passphrase = default, int initialCapacity = 30)
                            {
                                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                                try
                                {
