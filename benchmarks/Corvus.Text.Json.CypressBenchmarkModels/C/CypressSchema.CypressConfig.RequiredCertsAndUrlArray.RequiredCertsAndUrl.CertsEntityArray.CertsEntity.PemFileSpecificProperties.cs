                ...
                public readonly partial struct CertsEntityArray
                {
                    ...
                    public readonly partial struct CertsEntity
                    {
...
#endif
                        {
                            ...
                            /// <summary>
                            /// Initializes a new instance of the <see cref="PemFileSpecificProperties"/> struct.
                            /// </summary>
                            /// <param name="value">The value from which to construct the instance.</param>
                            internal PemFileSpecificProperties(IJsonDocument parent, int idx)
                            {
                                Debug.Assert(idx >= 0);
                                _parent = parent;
                                _idx = idx;
                            ...
                            /// </summary>
                            public static PemFileSpecificProperties DefaultInstance { get; }
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.CypressBenchmark.Current.JsonString Cert
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CertUtf8, out Corvus.CypressBenchmark.Current.JsonString value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.CypressBenchmark.Current.JsonString Key
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KeyUtf8, out Corvus.CypressBenchmark.Current.JsonString value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </returns>
                            public static bool operator ==(in PemFileSpecificProperties left, in PemFileSpecificProperties right)
                            {
                            ...
                            /// <c>True</c> if the values are equal.
                            /// </returns>
                            public static bool operator ==(in PemFileSpecificProperties left, in JsonElement right)
                            {
                                return left.Equals(right);
                            }
                            ...
                            public static implicit operator JsonElement(PemFileSpecificProperties instance)
                            {
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator PemFileSpecificProperties(JsonElement instance)
                            {
                                return PemFileSpecificProperties.From(instance);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static PemFileSpecificProperties From<T>(in T instance)
                            ...
                            ///   A value could not be read from the reader.
                            /// </exception>
                            public static bool TryParseValue(ref Utf8JsonReader reader, out PemFileSpecificProperties? result)
                            {
                                return JsonElementHelpers.TryParseValue<PemFileSpecificProperties>(ref reader, out result);
                            }
...
#if NET
                            static PemFileSpecificProperties IJsonElement<PemFileSpecificProperties>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"PemFileSpecificProperties: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// </para>
                            /// </remarks>
                            public PemFileSpecificProperties Clone()
                            {
                                CheckValidInstance();
                            ...
                            /// </para>
                            /// </remarks>
                            public PemFileSpecificProperties Freeze()
                            {
                                CheckValidInstance();
                                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                {
                                    return mutable.FreezeElement<PemFileSpecificProperties>(_idx);
                                }
                            ...
                            {
                                /// <summary>
                                /// Gets the JSON property name for <see cref="Cert"/>.
                                /// </summary>
                                ...
                                /// Gets the JSON property name for <see cref="Cert"/>.
                                /// </summary>
                                public static ReadOnlySpan<byte> CertUtf8 => "cert"u8;
                            ...
                            {
                                /// <summary>
                                /// Gets the escaped UTF-8 JSON property name for <see cref="Cert"/>.
                                /// </summary>
                                public static ReadOnlySpan<byte> Cert => "cert"u8;
                            ...
                            {
                                /// <summary>
                                /// Gets the pre-baked property name blob for <see cref="Cert"/>.
                                /// </summary>
                                public static ReadOnlySpan<byte> Cert => [0x65, 0x00, 0x00, 0x00, 0x22, 0x63, 0x65, 0x72, 0x74, 0x22];
