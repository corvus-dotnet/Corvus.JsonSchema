        ...
        public readonly partial struct RequiredCertsAndUrlArray
        {
                ...
                : IJsonElement<RequiredCertsAndUrl>
            {
                public static partial class JsonSchema
                {
                    ...
                    private static void MatchCa(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                    {
                    ...
                    private static void MatchCerts(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
