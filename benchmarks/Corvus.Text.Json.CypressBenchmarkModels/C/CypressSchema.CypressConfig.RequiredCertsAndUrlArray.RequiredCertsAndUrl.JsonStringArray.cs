        ...
        public readonly partial struct RequiredCertsAndUrlArray
        {
            ...
            public readonly partial struct RequiredCertsAndUrl
            {
...
#endif
                {
                    ...
                    public Corvus.CypressBenchmark.Current.JsonString this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.CypressBenchmark.Current.JsonString>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.CypressBenchmark.Current.JsonString> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.CypressBenchmark.Current.JsonString>(_parent, _idx);
                    }
