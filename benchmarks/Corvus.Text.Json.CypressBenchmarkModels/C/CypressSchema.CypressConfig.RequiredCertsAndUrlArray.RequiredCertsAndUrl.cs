    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct RequiredCertsAndUrlArray
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="RequiredCertsAndUrl"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal RequiredCertsAndUrl(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static RequiredCertsAndUrl DefaultInstance { get; }
                ...
                /// </para>
                /// </remarks>
                public Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.RequiredCertsAndUrlArray.RequiredCertsAndUrl.JsonStringArray Ca
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CaUtf8, out Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.RequiredCertsAndUrlArray.RequiredCertsAndUrl.JsonStringArray value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.RequiredCertsAndUrlArray.RequiredCertsAndUrl.CertsEntityArray Certs
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CertsUtf8, out Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.RequiredCertsAndUrlArray.RequiredCertsAndUrl.CertsEntityArray value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.CypressBenchmark.Current.JsonString Url
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UrlUtf8, out Corvus.CypressBenchmark.Current.JsonString value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in RequiredCertsAndUrl left, in RequiredCertsAndUrl right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in RequiredCertsAndUrl left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(RequiredCertsAndUrl instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredCertsAndUrl(JsonElement instance)
                {
                    return RequiredCertsAndUrl.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredCertsAndUrl From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredCertsAndUrl ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredCertsAndUrl>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredCertsAndUrl ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredCertsAndUrl>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredCertsAndUrl ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredCertsAndUrl>(json, options);
                }
                ...
                /// </exception>
                public static RequiredCertsAndUrl ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<RequiredCertsAndUrl>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredCertsAndUrl? result)
                {
                    return JsonElementHelpers.TryParseValue<RequiredCertsAndUrl>(ref reader, out result);
                }
...
#if NET
                static RequiredCertsAndUrl IJsonElement<RequiredCertsAndUrl>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredCertsAndUrl: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public RequiredCertsAndUrl Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public RequiredCertsAndUrl Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<RequiredCertsAndUrl>(_idx);
                    }
                ...
                {
                    /// <summary>
                    /// Gets the JSON property name for <see cref="Ca"/>.
                    /// </summary>
                    public const string Ca = "ca";

                    /// <summary>
                    /// Gets the JSON property name for <see cref="Certs"/>.
                    /// </summary>
                    ...
                    /// Gets the JSON property name for <see cref="Ca"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> CaUtf8 => "ca"u8;

                    /// <summary>
                    /// Gets the JSON property name for <see cref="Certs"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> CertsUtf8 => "certs"u8;
                ...
                {
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="Ca"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Ca => "ca"u8;

                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="Certs"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Certs => "certs"u8;
                ...
                {
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="Ca"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Ca => [0x45, 0x00, 0x00, 0x00, 0x22, 0x63, 0x61, 0x22];

                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="Certs"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Certs => [0x75, 0x00, 0x00, 0x00, 0x22, 0x63, 0x65, 0x72, 0x74, 0x73, 0x22];
