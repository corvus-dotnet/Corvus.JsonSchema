                ...
                public readonly partial struct CertsEntityArray
                {
                    ...
                    public readonly partial struct CertsEntity
                    {
                        ...
                        public readonly partial struct PfxFileSpecificProperties
                            ...
                            : IJsonElement<PfxFileSpecificProperties>,
                              IFormattable,
                              ISpanFormattable,
...
#endif
                        {
                            ...
                            /// <summary>
                            /// Initializes a new instance of the <see cref="PfxFileSpecificProperties"/> struct.
                            /// </summary>
                            /// <param name="value">The value from which to construct the instance.</param>
                            internal PfxFileSpecificProperties(IJsonDocument parent, int idx)
                            {
                                Debug.Assert(idx >= 0);
                                _parent = parent;
                                _idx = idx;
                            ...
                            /// </summary>
                            public static PfxFileSpecificProperties DefaultInstance { get; }
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.CypressBenchmark.Current.JsonString Passphrase
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PassphraseUtf8, out Corvus.CypressBenchmark.Current.JsonString value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.CypressBenchmark.Current.JsonString Pfx
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PfxUtf8, out Corvus.CypressBenchmark.Current.JsonString value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </returns>
                            public static bool operator ==(in PfxFileSpecificProperties left, in PfxFileSpecificProperties right)
                            {
                            ...
                            /// <c>True</c> if the values are equal.
                            /// </returns>
                            public static bool operator ==(in PfxFileSpecificProperties left, in JsonElement right)
                            {
                                return left.Equals(right);
                            }
                            ...
                            public static implicit operator JsonElement(PfxFileSpecificProperties instance)
                            {
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator PfxFileSpecificProperties(JsonElement instance)
                            {
                                return PfxFileSpecificProperties.From(instance);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static PfxFileSpecificProperties From<T>(in T instance)
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static PfxFileSpecificProperties ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                            {
                                #pragma warning disable CS0618 // Type or member is obsolete
                                return JsonElementHelpers.ParseValue<PfxFileSpecificProperties>(utf8Json, options);
                            ...
                            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static PfxFileSpecificProperties ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                            {
                                #pragma warning disable CS0618 // Type or member is obsolete
                                return JsonElementHelpers.ParseValue<PfxFileSpecificProperties>(json, options);
                                #pragma warning restore CS0618
                            }
                            ...
                            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static PfxFileSpecificProperties ParseValue(string json, JsonDocumentOptions options = default)
                            {
                                #pragma warning disable CS0618 // Type or member is obsolete
                                return JsonElementHelpers.ParseValue<PfxFileSpecificProperties>(json, options);
                                #pragma warning restore CS0618
                            ...
                            /// </exception>
                            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                            public static PfxFileSpecificProperties ParseValue(ref Utf8JsonReader reader)
                            {
                                #pragma warning disable CS0618 // Type or member is obsolete
                                return JsonElementHelpers.ParseValue<PfxFileSpecificProperties>(ref reader);
                                #pragma warning restore CS0618
                            }
                            ...
                            ///   A value could not be read from the reader.
                            /// </exception>
                            public static bool TryParseValue(ref Utf8JsonReader reader, out PfxFileSpecificProperties? result)
                            {
                                return JsonElementHelpers.TryParseValue<PfxFileSpecificProperties>(ref reader, out result);
                            }
...
#if NET
                            static PfxFileSpecificProperties IJsonElement<PfxFileSpecificProperties>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"PfxFileSpecificProperties: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// </para>
                            /// </remarks>
                            public PfxFileSpecificProperties Clone()
                            {
                                CheckValidInstance();
                            ...
                            /// </para>
                            /// </remarks>
                            public PfxFileSpecificProperties Freeze()
                            {
                                CheckValidInstance();
                                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                {
                                    return mutable.FreezeElement<PfxFileSpecificProperties>(_idx);
                                }
                            ...
                            {
                                /// <summary>
                                /// Gets the JSON property name for <see cref="Passphrase"/>.
                                /// </summary>
                                public const string Passphrase = "passphrase";

                                /// <summary>
                                /// Gets the JSON property name for <see cref="Pfx"/>.
                                /// </summary>
                                ...
                                /// Gets the JSON property name for <see cref="Passphrase"/>.
                                /// </summary>
                                public static ReadOnlySpan<byte> PassphraseUtf8 => "passphrase"u8;

                                /// <summary>
                                /// Gets the JSON property name for <see cref="Pfx"/>.
                                /// </summary>
                                public static ReadOnlySpan<byte> PfxUtf8 => "pfx"u8;
                            }
                            ...
                            {
                                /// <summary>
                                /// Gets the escaped UTF-8 JSON property name for <see cref="Passphrase"/>.
                                /// </summary>
                                public static ReadOnlySpan<byte> Passphrase => "passphrase"u8;

                                /// <summary>
                                /// Gets the escaped UTF-8 JSON property name for <see cref="Pfx"/>.
                                /// </summary>
                                public static ReadOnlySpan<byte> Pfx => "pfx"u8;
                            }
                            ...
                            {
                                /// <summary>
                                /// Gets the pre-baked property name blob for <see cref="Passphrase"/>.
                                /// </summary>
                                public static ReadOnlySpan<byte> Passphrase => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x70, 0x61, 0x73, 0x73, 0x70, 0x68, 0x72, 0x61, 0x73, 0x65, 0x22];

                                /// <summary>
                                /// Gets the pre-baked property name blob for <see cref="Pfx"/>.
                                /// </summary>
                                public static ReadOnlySpan<byte> Pfx => [0x55, 0x00, 0x00, 0x00, 0x22, 0x70, 0x66, 0x78, 0x22];
                            }
                        }
                    }
                }
