    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct ResponseTimeoutEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ResponseTimeoutEntity, Mutable>(ResponseTimeoutEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<ResponseTimeoutEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ResponseTimeoutEntity>();
                }
                finally
                {
