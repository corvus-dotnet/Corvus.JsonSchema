    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct ScreenshotOnRunFailureEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ScreenshotOnRunFailureEntity, Mutable>(ScreenshotOnRunFailureEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<ScreenshotOnRunFailureEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ScreenshotOnRunFailureEntity>();
                }
                finally
                {
