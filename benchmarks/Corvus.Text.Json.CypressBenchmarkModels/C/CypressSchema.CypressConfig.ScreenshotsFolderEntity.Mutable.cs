    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct ScreenshotsFolderEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ScreenshotsFolderEntity, Mutable>(ScreenshotsFolderEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<ScreenshotsFolderEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ScreenshotsFolderEntity>();
                }
                finally
                {
