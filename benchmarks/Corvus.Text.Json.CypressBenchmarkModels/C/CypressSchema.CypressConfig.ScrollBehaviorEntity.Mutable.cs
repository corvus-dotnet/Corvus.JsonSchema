    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct ScrollBehaviorEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ScrollBehaviorEntity, Mutable>(ScrollBehaviorEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(ScrollBehaviorEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ScrollBehaviorEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ScrollBehaviorEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ScrollBehaviorEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ScrollBehaviorEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ScrollBehaviorEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ScrollBehaviorEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ScrollBehaviorEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ScrollBehaviorEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ScrollBehaviorEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ScrollBehaviorEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ScrollBehaviorEntity>(_idx);
                }
                ...
                /// <param name="matchTop">Match 3rd item.</param>
                /// <param name="matchBottom">Match 4th item.</param>
                /// <param name="matchNearest">Match 5th item.</param>
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Func<TContext, TResult> matchNearest,
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ScrollBehaviorEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ScrollBehaviorEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ScrollBehaviorEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ScrollBehaviorEntity>();
                }
                finally
                {
