    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct SlowTestThresholdEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SlowTestThresholdEntity, Mutable>(SlowTestThresholdEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(SlowTestThresholdEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SlowTestThresholdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SlowTestThresholdEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SlowTestThresholdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SlowTestThresholdEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SlowTestThresholdEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SlowTestThresholdEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SlowTestThresholdEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SlowTestThresholdEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SlowTestThresholdEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SlowTestThresholdEntity>();
                }
                finally
                {
