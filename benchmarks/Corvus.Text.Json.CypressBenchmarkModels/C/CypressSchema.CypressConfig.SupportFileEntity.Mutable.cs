    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct SupportFileEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SupportFileEntity, Mutable>(SupportFileEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<SupportFileEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SupportFileEntity>();
                }
                finally
                {
