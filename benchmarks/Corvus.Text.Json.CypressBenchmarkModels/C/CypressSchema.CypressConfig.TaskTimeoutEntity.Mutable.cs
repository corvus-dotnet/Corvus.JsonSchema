    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct TaskTimeoutEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TaskTimeoutEntity, Mutable>(TaskTimeoutEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(TaskTimeoutEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TaskTimeoutEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TaskTimeoutEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TaskTimeoutEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TaskTimeoutEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TaskTimeoutEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TaskTimeoutEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly TaskTimeoutEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TaskTimeoutEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TaskTimeoutEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly TaskTimeoutEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TaskTimeoutEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TaskTimeoutEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TaskTimeoutEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TaskTimeoutEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TaskTimeoutEntity>();
                }
                finally
                {
