    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct TestFilesArray
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TestFilesArray, Mutable>(TestFilesArray.DefaultInstance);
                ...
                public static explicit operator Mutable(TestFilesArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TestFilesArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TestFilesArray(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TestFilesArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public readonly TestFilesArray Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TestFilesArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TestFilesArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.TestFilesArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(TestFilesArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.CypressBenchmark.Current.CypressSchema.CypressConfig.TestFilesArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<TestFilesArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TestFilesArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TestFilesArray>();
                }
                finally
                {
