    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct TrashAssetsBeforeRunsEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TrashAssetsBeforeRunsEntity, Mutable>(TrashAssetsBeforeRunsEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(TrashAssetsBeforeRunsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TrashAssetsBeforeRunsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TrashAssetsBeforeRunsEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TrashAssetsBeforeRunsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TrashAssetsBeforeRunsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TrashAssetsBeforeRunsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TrashAssetsBeforeRunsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TrashAssetsBeforeRunsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TrashAssetsBeforeRunsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TrashAssetsBeforeRunsEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TrashAssetsBeforeRunsEntity>();
                }
                finally
                {
