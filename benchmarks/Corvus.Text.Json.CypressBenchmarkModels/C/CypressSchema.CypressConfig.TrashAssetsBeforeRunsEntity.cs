...
public readonly partial struct CypressSchema
{
    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct TrashAssetsBeforeRunsEntity
#if NET8_0_OR_GREATER
            : IJsonElement<TrashAssetsBeforeRunsEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="TrashAssetsBeforeRunsEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal TrashAssetsBeforeRunsEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static TrashAssetsBeforeRunsEntity DefaultInstance { get; } = ParsedJsonDocument<TrashAssetsBeforeRunsEntity>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(TrashAssetsBeforeRunsEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in TrashAssetsBeforeRunsEntity left, in TrashAssetsBeforeRunsEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in TrashAssetsBeforeRunsEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(TrashAssetsBeforeRunsEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TrashAssetsBeforeRunsEntity(JsonElement instance)
            {
                return TrashAssetsBeforeRunsEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TrashAssetsBeforeRunsEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TrashAssetsBeforeRunsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TrashAssetsBeforeRunsEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TrashAssetsBeforeRunsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TrashAssetsBeforeRunsEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TrashAssetsBeforeRunsEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TrashAssetsBeforeRunsEntity>(json, options);
            }
            ...
            /// </exception>
            public static TrashAssetsBeforeRunsEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<TrashAssetsBeforeRunsEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out TrashAssetsBeforeRunsEntity? result)
            {
                return JsonElementHelpers.TryParseValue<TrashAssetsBeforeRunsEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new TrashAssetsBeforeRunsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static TrashAssetsBeforeRunsEntity IJsonElement<TrashAssetsBeforeRunsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TrashAssetsBeforeRunsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="TrashAssetsBeforeRunsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TrashAssetsBeforeRunsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public TrashAssetsBeforeRunsEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TrashAssetsBeforeRunsEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TrashAssetsBeforeRunsEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public TrashAssetsBeforeRunsEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<TrashAssetsBeforeRunsEntity>(_idx);
                }
