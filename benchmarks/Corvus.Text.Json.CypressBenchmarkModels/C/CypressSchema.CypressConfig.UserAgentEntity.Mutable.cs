    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct UserAgentEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<UserAgentEntity, Mutable>(UserAgentEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<UserAgentEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<UserAgentEntity>();
                }
                finally
                {
