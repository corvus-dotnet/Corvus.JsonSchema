    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct VideoCompressionEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<VideoCompressionEntity, Mutable>(VideoCompressionEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(VideoCompressionEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="VideoCompressionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator VideoCompressionEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"VideoCompressionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly VideoCompressionEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly VideoCompressionEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<VideoCompressionEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(VideoCompressionEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<VideoCompressionEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<VideoCompressionEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<VideoCompressionEntity>();
                }
                finally
                {
