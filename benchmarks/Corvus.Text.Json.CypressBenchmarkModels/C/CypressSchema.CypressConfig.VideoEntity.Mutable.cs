    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct VideoEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<VideoEntity, Mutable>(VideoEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<VideoEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<VideoEntity>();
                }
                finally
                {
