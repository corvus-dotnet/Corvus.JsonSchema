    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct VideoUploadOnPassesEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<VideoUploadOnPassesEntity, Mutable>(VideoUploadOnPassesEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(VideoUploadOnPassesEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="VideoUploadOnPassesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator VideoUploadOnPassesEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"VideoUploadOnPassesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly VideoUploadOnPassesEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly VideoUploadOnPassesEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<VideoUploadOnPassesEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(VideoUploadOnPassesEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<VideoUploadOnPassesEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<VideoUploadOnPassesEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<VideoUploadOnPassesEntity>();
                }
                finally
                {
