...
public readonly partial struct CypressSchema
{
    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct VideoUploadOnPassesEntity
#if NET8_0_OR_GREATER
            : IJsonElement<VideoUploadOnPassesEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="VideoUploadOnPassesEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal VideoUploadOnPassesEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static VideoUploadOnPassesEntity DefaultInstance { get; } = ParsedJsonDocument<VideoUploadOnPassesEntity>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(VideoUploadOnPassesEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in VideoUploadOnPassesEntity left, in VideoUploadOnPassesEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in VideoUploadOnPassesEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(VideoUploadOnPassesEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator VideoUploadOnPassesEntity(JsonElement instance)
            {
                return VideoUploadOnPassesEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static VideoUploadOnPassesEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static VideoUploadOnPassesEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<VideoUploadOnPassesEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static VideoUploadOnPassesEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<VideoUploadOnPassesEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static VideoUploadOnPassesEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<VideoUploadOnPassesEntity>(json, options);
            }
            ...
            /// </exception>
            public static VideoUploadOnPassesEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<VideoUploadOnPassesEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out VideoUploadOnPassesEntity? result)
            {
                return JsonElementHelpers.TryParseValue<VideoUploadOnPassesEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new VideoUploadOnPassesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static VideoUploadOnPassesEntity IJsonElement<VideoUploadOnPassesEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"VideoUploadOnPassesEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="VideoUploadOnPassesEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="VideoUploadOnPassesEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public VideoUploadOnPassesEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<VideoUploadOnPassesEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="VideoUploadOnPassesEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public VideoUploadOnPassesEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<VideoUploadOnPassesEntity>(_idx);
                }
