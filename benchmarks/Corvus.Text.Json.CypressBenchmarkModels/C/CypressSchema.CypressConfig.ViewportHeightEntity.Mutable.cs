    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct ViewportHeightEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ViewportHeightEntity, Mutable>(ViewportHeightEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(ViewportHeightEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ViewportHeightEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ViewportHeightEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ViewportHeightEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ViewportHeightEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ViewportHeightEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ViewportHeightEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ViewportHeightEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ViewportHeightEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ViewportHeightEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ViewportHeightEntity>();
                }
                finally
                {
