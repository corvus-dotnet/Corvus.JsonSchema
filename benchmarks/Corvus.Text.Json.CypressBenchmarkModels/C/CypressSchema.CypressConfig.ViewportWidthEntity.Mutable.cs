    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct ViewportWidthEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ViewportWidthEntity, Mutable>(ViewportWidthEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(ViewportWidthEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ViewportWidthEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ViewportWidthEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ViewportWidthEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ViewportWidthEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ViewportWidthEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ViewportWidthEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ViewportWidthEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ViewportWidthEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ViewportWidthEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ViewportWidthEntity>();
                }
                finally
                {
