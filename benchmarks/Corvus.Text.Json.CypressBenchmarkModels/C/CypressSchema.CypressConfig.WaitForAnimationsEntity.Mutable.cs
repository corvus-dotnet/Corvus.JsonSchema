    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct WaitForAnimationsEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<WaitForAnimationsEntity, Mutable>(WaitForAnimationsEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(WaitForAnimationsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="WaitForAnimationsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WaitForAnimationsEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WaitForAnimationsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly WaitForAnimationsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly WaitForAnimationsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<WaitForAnimationsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(WaitForAnimationsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<WaitForAnimationsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<WaitForAnimationsEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<WaitForAnimationsEntity>();
                }
                finally
                {
