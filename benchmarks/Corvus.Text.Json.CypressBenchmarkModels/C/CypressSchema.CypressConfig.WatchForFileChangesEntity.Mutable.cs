    ...
    public readonly partial struct CypressConfig
    {
        ...
        public readonly partial struct WatchForFileChangesEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<WatchForFileChangesEntity, Mutable>(WatchForFileChangesEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<WatchForFileChangesEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<WatchForFileChangesEntity>();
                }
                finally
                {
