    ...
    public readonly partial struct ConfigurationForDenoTest
    {
        ...
        public readonly partial struct FilesEntity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForDenoTest.FilesEntity.JsonStringArray.Mutable Exclude
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludeUtf8, out Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForDenoTest.FilesEntity.JsonStringArray.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForDenoTest.FilesEntity.IncludeJsoArray.Mutable Include
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeUtf8, out Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForDenoTest.FilesEntity.IncludeJsoArray.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetExclude(in Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForDenoTest.FilesEntity.JsonStringArray.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetExclude<TContext>(in Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForDenoTest.FilesEntity.JsonStringArray.Source<TContext> value)
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetInclude(in Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForDenoTest.FilesEntity.IncludeJsoArray.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetInclude<TContext>(in Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForDenoTest.FilesEntity.IncludeJsoArray.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForDenoTest.FilesEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForDenoTest.FilesEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForDenoTest.FilesEntity.JsonStringArray.Source exclude = default,
                    in Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForDenoTest.FilesEntity.IncludeJsoArray.Source include = default)
                {
                ...
                /// Creates an instance of a <see cref="FilesEntity"/>.
                /// </summary>
                public void Create(in Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForDenoTest.FilesEntity.JsonStringArray.Source exclude = default, in Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForDenoTest.FilesEntity.IncludeJsoArray.Source include = default)
                {
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForDenoTest.FilesEntity.JsonStringArray.Source<TContext> exclude = default,
                    in Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForDenoTest.FilesEntity.IncludeJsoArray.Source<TContext> include = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForDenoTest.FilesEntity.JsonStringArray.Source exclude = default, in Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForDenoTest.FilesEntity.IncludeJsoArray.Source include = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForDenoTest.FilesEntity.JsonStringArray.Source<TContext> exclude = default, in Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForDenoTest.FilesEntity.IncludeJsoArray.Source<TContext> include = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
