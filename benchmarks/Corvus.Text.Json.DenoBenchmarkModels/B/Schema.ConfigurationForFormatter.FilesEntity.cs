...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ConfigurationForFormatter
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForFormatter.FilesEntity.JsonStringArray Exclude
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludeUtf8, out Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForFormatter.FilesEntity.JsonStringArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForFormatter.FilesEntity.ListOfFileArray Include
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeUtf8, out Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForFormatter.FilesEntity.ListOfFileArray value))
                    {
                        return value;
                    }
