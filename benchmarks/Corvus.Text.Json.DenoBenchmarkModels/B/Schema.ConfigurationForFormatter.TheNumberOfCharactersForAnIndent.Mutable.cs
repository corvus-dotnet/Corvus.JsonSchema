    ...
    public readonly partial struct ConfigurationForFormatter
    {
        ...
        public readonly partial struct TheNumberOfCharactersForAnIndent
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TheNumberOfCharactersForAnIndent instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheNumberOfCharactersForAnIndent"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheNumberOfCharactersForAnIndent(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheNumberOfCharactersForAnIndent.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TheNumberOfCharactersForAnIndent Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TheNumberOfCharactersForAnIndent Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheNumberOfCharactersForAnIndent>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TheNumberOfCharactersForAnIndent instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TheNumberOfCharactersForAnIndent, Mutable>(this);
            }
        }
    }
}
