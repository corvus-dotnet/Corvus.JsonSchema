...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ConfigurationForLinter
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForLinter.FilesEntity.JsonStringArray Exclude
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludeUtf8, out Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForLinter.FilesEntity.JsonStringArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForLinter.FilesEntity.ListOfFileArray Include
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeUtf8, out Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForLinter.FilesEntity.ListOfFileArray value))
                    {
                        return value;
                    }
