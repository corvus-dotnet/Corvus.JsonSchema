...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ConfigurationForLinter
    {
        ...
        /// Generated from JSON Schema.
        /// </summary>
        public readonly partial struct RulesEntity
        {
            /// <summary>
            /// Generated from JSON Schema.
            /// </summary>
            ...
            public readonly partial struct TagsJsonStArray
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(TagsJsonStArray instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="TagsJsonStArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TagsJsonStArray(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new TagsJsonStArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TagsJsonStArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<TagsJsonStArray>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForLinter.RulesEntity.TagsJsonStArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(TagsJsonStArray instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.DenoBenchmark.Baseline.Schema.ConfigurationForLinter.RulesEntity.TagsJsonStArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
