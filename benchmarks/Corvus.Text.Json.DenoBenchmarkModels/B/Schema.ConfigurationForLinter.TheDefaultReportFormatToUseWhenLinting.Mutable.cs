    ...
    public readonly partial struct ConfigurationForLinter
    {
        ...
        public readonly partial struct TheDefaultReportFormatToUseWhenLinting
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TheDefaultReportFormatToUseWhenLinting instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheDefaultReportFormatToUseWhenLinting"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheDefaultReportFormatToUseWhenLinting(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TheDefaultReportFormatToUseWhenLinting(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheDefaultReportFormatToUseWhenLinting.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TheDefaultReportFormatToUseWhenLinting"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TheDefaultReportFormatToUseWhenLinting"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly TheDefaultReportFormatToUseWhenLinting Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TheDefaultReportFormatToUseWhenLinting>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TheDefaultReportFormatToUseWhenLinting"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly TheDefaultReportFormatToUseWhenLinting Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheDefaultReportFormatToUseWhenLinting>(_idx);
                }
                ...
                /// <param name="matchPretty">Match 1st item.</param>
                /// <param name="matchJson">Match 2nd item.</param>
                /// <param name="matchCompact">Match 3rd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchPretty,
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TheDefaultReportFormatToUseWhenLinting instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TheDefaultReportFormatToUseWhenLinting, Mutable>(this);
            }
        }
    }
}
