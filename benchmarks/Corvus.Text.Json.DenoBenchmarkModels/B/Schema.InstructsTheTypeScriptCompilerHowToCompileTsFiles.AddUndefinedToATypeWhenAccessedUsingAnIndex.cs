...
public readonly partial struct Schema
{
    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AddUndefinedToATypeWhenAccessedUsingAnIndex"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal AddUndefinedToATypeWhenAccessedUsingAnIndex(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AddUndefinedToATypeWhenAccessedUsingAnIndex DefaultInstance { get; } = ParsedJsonDocument<AddUndefinedToATypeWhenAccessedUsingAnIndex>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(AddUndefinedToATypeWhenAccessedUsingAnIndex value)
            {
            ...
            /// </returns>
            public static bool operator ==(in AddUndefinedToATypeWhenAccessedUsingAnIndex left, in AddUndefinedToATypeWhenAccessedUsingAnIndex right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AddUndefinedToATypeWhenAccessedUsingAnIndex left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(AddUndefinedToATypeWhenAccessedUsingAnIndex instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AddUndefinedToATypeWhenAccessedUsingAnIndex(JsonElement instance)
            {
                return AddUndefinedToATypeWhenAccessedUsingAnIndex.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AddUndefinedToATypeWhenAccessedUsingAnIndex From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AddUndefinedToATypeWhenAccessedUsingAnIndex ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AddUndefinedToATypeWhenAccessedUsingAnIndex>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AddUndefinedToATypeWhenAccessedUsingAnIndex ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AddUndefinedToATypeWhenAccessedUsingAnIndex>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AddUndefinedToATypeWhenAccessedUsingAnIndex ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AddUndefinedToATypeWhenAccessedUsingAnIndex>(json, options);
            }
            ...
            /// </exception>
            public static AddUndefinedToATypeWhenAccessedUsingAnIndex ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<AddUndefinedToATypeWhenAccessedUsingAnIndex>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AddUndefinedToATypeWhenAccessedUsingAnIndex? result)
            {
                return JsonElementHelpers.TryParseValue<AddUndefinedToATypeWhenAccessedUsingAnIndex>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new AddUndefinedToATypeWhenAccessedUsingAnIndex(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static AddUndefinedToATypeWhenAccessedUsingAnIndex IJsonElement<AddUndefinedToATypeWhenAccessedUsingAnIndex>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AddUndefinedToATypeWhenAccessedUsingAnIndex: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="AddUndefinedToATypeWhenAccessedUsingAnIndex"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="AddUndefinedToATypeWhenAccessedUsingAnIndex"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public AddUndefinedToATypeWhenAccessedUsingAnIndex Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<AddUndefinedToATypeWhenAccessedUsingAnIndex>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="AddUndefinedToATypeWhenAccessedUsingAnIndex"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public AddUndefinedToATypeWhenAccessedUsingAnIndex Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<AddUndefinedToATypeWhenAccessedUsingAnIndex>(_idx);
                }
