...
public readonly partial struct Schema
{
    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DisableErrorReportingForUnreachableCode"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal DisableErrorReportingForUnreachableCode(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static DisableErrorReportingForUnreachableCode DefaultInstance { get; } = ParsedJsonDocument<DisableErrorReportingForUnreachableCode>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(DisableErrorReportingForUnreachableCode value)
            {
            ...
            /// </returns>
            public static bool operator ==(in DisableErrorReportingForUnreachableCode left, in DisableErrorReportingForUnreachableCode right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in DisableErrorReportingForUnreachableCode left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(DisableErrorReportingForUnreachableCode instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DisableErrorReportingForUnreachableCode(JsonElement instance)
            {
                return DisableErrorReportingForUnreachableCode.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DisableErrorReportingForUnreachableCode From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DisableErrorReportingForUnreachableCode ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DisableErrorReportingForUnreachableCode>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DisableErrorReportingForUnreachableCode ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DisableErrorReportingForUnreachableCode>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DisableErrorReportingForUnreachableCode ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DisableErrorReportingForUnreachableCode>(json, options);
            }
            ...
            /// </exception>
            public static DisableErrorReportingForUnreachableCode ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<DisableErrorReportingForUnreachableCode>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out DisableErrorReportingForUnreachableCode? result)
            {
                return JsonElementHelpers.TryParseValue<DisableErrorReportingForUnreachableCode>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DisableErrorReportingForUnreachableCode(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static DisableErrorReportingForUnreachableCode IJsonElement<DisableErrorReportingForUnreachableCode>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DisableErrorReportingForUnreachableCode: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DisableErrorReportingForUnreachableCode"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DisableErrorReportingForUnreachableCode"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public DisableErrorReportingForUnreachableCode Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DisableErrorReportingForUnreachableCode>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DisableErrorReportingForUnreachableCode"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public DisableErrorReportingForUnreachableCode Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<DisableErrorReportingForUnreachableCode>(_idx);
                }
