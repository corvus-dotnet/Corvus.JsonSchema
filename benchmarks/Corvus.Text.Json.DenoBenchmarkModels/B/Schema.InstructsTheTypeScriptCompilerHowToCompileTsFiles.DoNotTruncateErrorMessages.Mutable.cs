...
public readonly partial struct Schema
{
    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
        ...
        public readonly partial struct DoNotTruncateErrorMessages
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DoNotTruncateErrorMessages instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DoNotTruncateErrorMessages"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DoNotTruncateErrorMessages(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new DoNotTruncateErrorMessages(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DoNotTruncateErrorMessages.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="DoNotTruncateErrorMessages"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="DoNotTruncateErrorMessages"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly DoNotTruncateErrorMessages Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<DoNotTruncateErrorMessages>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="DoNotTruncateErrorMessages"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly DoNotTruncateErrorMessages Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DoNotTruncateErrorMessages>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DoNotTruncateErrorMessages instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DoNotTruncateErrorMessages, Mutable>(this);
            }
        }
    }
}
