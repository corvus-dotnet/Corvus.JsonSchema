...
public readonly partial struct Schema
{
    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="EnableErrorReportingWhenThisIsGivenTheTypeAny"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal EnableErrorReportingWhenThisIsGivenTheTypeAny(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static EnableErrorReportingWhenThisIsGivenTheTypeAny DefaultInstance { get; } = ParsedJsonDocument<EnableErrorReportingWhenThisIsGivenTheTypeAny>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(EnableErrorReportingWhenThisIsGivenTheTypeAny value)
            {
            ...
            /// </returns>
            public static bool operator ==(in EnableErrorReportingWhenThisIsGivenTheTypeAny left, in EnableErrorReportingWhenThisIsGivenTheTypeAny right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in EnableErrorReportingWhenThisIsGivenTheTypeAny left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(EnableErrorReportingWhenThisIsGivenTheTypeAny instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnableErrorReportingWhenThisIsGivenTheTypeAny(JsonElement instance)
            {
                return EnableErrorReportingWhenThisIsGivenTheTypeAny.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableErrorReportingWhenThisIsGivenTheTypeAny From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableErrorReportingWhenThisIsGivenTheTypeAny ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableErrorReportingWhenThisIsGivenTheTypeAny>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableErrorReportingWhenThisIsGivenTheTypeAny ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableErrorReportingWhenThisIsGivenTheTypeAny>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableErrorReportingWhenThisIsGivenTheTypeAny ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableErrorReportingWhenThisIsGivenTheTypeAny>(json, options);
            }
            ...
            /// </exception>
            public static EnableErrorReportingWhenThisIsGivenTheTypeAny ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<EnableErrorReportingWhenThisIsGivenTheTypeAny>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out EnableErrorReportingWhenThisIsGivenTheTypeAny? result)
            {
                return JsonElementHelpers.TryParseValue<EnableErrorReportingWhenThisIsGivenTheTypeAny>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new EnableErrorReportingWhenThisIsGivenTheTypeAny(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static EnableErrorReportingWhenThisIsGivenTheTypeAny IJsonElement<EnableErrorReportingWhenThisIsGivenTheTypeAny>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnableErrorReportingWhenThisIsGivenTheTypeAny: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="EnableErrorReportingWhenThisIsGivenTheTypeAny"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="EnableErrorReportingWhenThisIsGivenTheTypeAny"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public EnableErrorReportingWhenThisIsGivenTheTypeAny Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<EnableErrorReportingWhenThisIsGivenTheTypeAny>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="EnableErrorReportingWhenThisIsGivenTheTypeAny"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public EnableErrorReportingWhenThisIsGivenTheTypeAny Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<EnableErrorReportingWhenThisIsGivenTheTypeAny>(_idx);
                }
