...
public readonly partial struct Schema
{
    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
        ...
        public readonly partial struct ExactOptionalPropertyTypesEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ExactOptionalPropertyTypesEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ExactOptionalPropertyTypesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExactOptionalPropertyTypesEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ExactOptionalPropertyTypesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExactOptionalPropertyTypesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ExactOptionalPropertyTypesEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ExactOptionalPropertyTypesEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ExactOptionalPropertyTypesEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ExactOptionalPropertyTypesEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ExactOptionalPropertyTypesEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ExactOptionalPropertyTypesEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ExactOptionalPropertyTypesEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ExactOptionalPropertyTypesEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ExactOptionalPropertyTypesEntity, Mutable>(this);
            }
        }
    }
}
