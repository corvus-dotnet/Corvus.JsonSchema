    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
        ...
        public readonly partial struct JsxFactoryEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(JsxFactoryEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="JsxFactoryEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsxFactoryEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"JsxFactoryEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly JsxFactoryEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly JsxFactoryEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<JsxFactoryEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(JsxFactoryEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<JsxFactoryEntity, Mutable>(this);
            }
        }
    }
}
