...
public readonly partial struct Schema
{
    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
        ...
        public readonly partial struct JsxFactoryEntity
#if NET8_0_OR_GREATER
            : IJsonElement<JsxFactoryEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="JsxFactoryEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal JsxFactoryEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static JsxFactoryEntity DefaultInstance { get; } = ParsedJsonDocument<JsxFactoryEntity>.StringConstant([.."\"React.createElement\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(JsxFactoryEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in JsxFactoryEntity left, in JsxFactoryEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in JsxFactoryEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(JsxFactoryEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsxFactoryEntity(JsonElement instance)
            {
                return JsxFactoryEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static JsxFactoryEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static JsxFactoryEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<JsxFactoryEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static JsxFactoryEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<JsxFactoryEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static JsxFactoryEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<JsxFactoryEntity>(json, options);
            }
            ...
            /// </exception>
            public static JsxFactoryEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<JsxFactoryEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out JsxFactoryEntity? result)
            {
                return JsonElementHelpers.TryParseValue<JsxFactoryEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new JsxFactoryEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static JsxFactoryEntity IJsonElement<JsxFactoryEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"JsxFactoryEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="JsxFactoryEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="JsxFactoryEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public JsxFactoryEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<JsxFactoryEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="JsxFactoryEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public JsxFactoryEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<JsxFactoryEntity>(_idx);
                }
