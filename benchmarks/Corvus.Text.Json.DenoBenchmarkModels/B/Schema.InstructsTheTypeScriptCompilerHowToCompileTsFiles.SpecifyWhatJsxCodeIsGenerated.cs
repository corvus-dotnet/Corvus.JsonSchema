...
public readonly partial struct Schema
{
    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SpecifyWhatJsxCodeIsGenerated"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SpecifyWhatJsxCodeIsGenerated(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SpecifyWhatJsxCodeIsGenerated DefaultInstance { get; } = ParsedJsonDocument<SpecifyWhatJsxCodeIsGenerated>.StringConstant([.."\"react\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(SpecifyWhatJsxCodeIsGenerated value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in SpecifyWhatJsxCodeIsGenerated left, in SpecifyWhatJsxCodeIsGenerated right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SpecifyWhatJsxCodeIsGenerated left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SpecifyWhatJsxCodeIsGenerated instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SpecifyWhatJsxCodeIsGenerated(JsonElement instance)
            {
                return SpecifyWhatJsxCodeIsGenerated.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpecifyWhatJsxCodeIsGenerated From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpecifyWhatJsxCodeIsGenerated ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpecifyWhatJsxCodeIsGenerated>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpecifyWhatJsxCodeIsGenerated ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpecifyWhatJsxCodeIsGenerated>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpecifyWhatJsxCodeIsGenerated ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpecifyWhatJsxCodeIsGenerated>(json, options);
            }
            ...
            /// </exception>
            public static SpecifyWhatJsxCodeIsGenerated ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SpecifyWhatJsxCodeIsGenerated>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SpecifyWhatJsxCodeIsGenerated? result)
            {
                return JsonElementHelpers.TryParseValue<SpecifyWhatJsxCodeIsGenerated>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SpecifyWhatJsxCodeIsGenerated(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static SpecifyWhatJsxCodeIsGenerated IJsonElement<SpecifyWhatJsxCodeIsGenerated>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SpecifyWhatJsxCodeIsGenerated: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SpecifyWhatJsxCodeIsGenerated"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SpecifyWhatJsxCodeIsGenerated"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public SpecifyWhatJsxCodeIsGenerated Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SpecifyWhatJsxCodeIsGenerated>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SpecifyWhatJsxCodeIsGenerated"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public SpecifyWhatJsxCodeIsGenerated Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SpecifyWhatJsxCodeIsGenerated>(_idx);
                }
            ...
            /// <param name="matchPreserve">Match 1st item.</param>
            /// <param name="matchReact">Match 2nd item.</param>
            /// <param name="matchReactJsx">Match 3rd item.</param>
            /// <param name="matchReactJsxdev">Match 4th item.</param>
            /// <param name="matchReactNative">Match 5th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchPreserve,
                Func<TContext, TResult> matchReact,
                Func<TContext, TResult> matchReactJsx,
                Func<TContext, TResult> matchReactJsxdev,
                Func<TContext, TResult> matchReactNative,
...
#endif
            {
                ...
                {
                    return matchPreserve(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchReact(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchReactJsx(context);
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchReactJsxdev(context);
                }

                if (this.ValueEquals(Constants.Enum5))
                {
                    return matchReactNative(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchPreserve,
                Func<TResult> matchReact,
                Func<TResult> matchReactJsx,
                Func<TResult> matchReactJsxdev,
                Func<TResult> matchReactNative,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchPreserve();
                }
                ...
                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchReactJsx();
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchReactJsxdev();
                }

                if (this.ValueEquals(Constants.Enum5))
                {
                    return matchReactNative();
                }
