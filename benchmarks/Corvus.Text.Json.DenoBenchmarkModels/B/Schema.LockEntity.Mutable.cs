...
public readonly partial struct Schema
{
    ...
    public readonly partial struct LockEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(LockEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="LockEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LockEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LockEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly LockEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly LockEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<LockEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(LockEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<LockEntity, Mutable>(this);
        }
    }
}
