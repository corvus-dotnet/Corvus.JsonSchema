                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (objectValidation_enumerator.MoveNext())
                    {
                        ...
                        {
                            JsonSchemaContext childContext = Corvus.DenoBenchmark.Baseline.Schema.ScopesEntity.ADefinitionOfAScopedRemapping.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                            ...
                            Corvus.DenoBenchmark.Baseline.Schema.ScopesEntity.ADefinitionOfAScopedRemapping.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
