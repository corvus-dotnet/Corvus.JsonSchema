...
public readonly partial struct DenoSchema
{
    ...
    public readonly partial struct AMapOfSpecifiersToTheirRemappedSpecifiers
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(AMapOfSpecifiersToTheirRemappedSpecifiers instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="AMapOfSpecifiersToTheirRemappedSpecifiers"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AMapOfSpecifiersToTheirRemappedSpecifiers(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AMapOfSpecifiersToTheirRemappedSpecifiers.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly AMapOfSpecifiersToTheirRemappedSpecifiers Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly AMapOfSpecifiersToTheirRemappedSpecifiers Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<AMapOfSpecifiersToTheirRemappedSpecifiers>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.DenoBenchmark.Current.DenoSchema.AMapOfSpecifiersToTheirRemappedSpecifiers.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(AMapOfSpecifiersToTheirRemappedSpecifiers instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.DenoBenchmark.Current.DenoSchema.AMapOfSpecifiersToTheirRemappedSpecifiers.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<AMapOfSpecifiersToTheirRemappedSpecifiers, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<AMapOfSpecifiersToTheirRemappedSpecifiers> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<AMapOfSpecifiersToTheirRemappedSpecifiers>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<AMapOfSpecifiersToTheirRemappedSpecifiers> Create<TContext>(
