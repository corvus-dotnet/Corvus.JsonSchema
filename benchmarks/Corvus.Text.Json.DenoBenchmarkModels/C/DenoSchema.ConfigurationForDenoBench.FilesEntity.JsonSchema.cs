    ...
    public readonly partial struct ConfigurationForDenoBench
    {
            ...
            : IJsonElement<FilesEntity>
        {
            public static partial class JsonSchema
            {
                ...
                private static readonly JsonSchemaPathProvider IncludeSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/include"u8, buffer, out written);
                ...
                private static void MatchExclude(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    JsonSchemaContext childContext =
                        Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.JsonStringArray.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.JsonStringArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    context.CommitChildContext(childContext.IsMatch, ref childContext);
                }

                private static void MatchInclude(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext1 =
                        Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.IncludeJsoArray.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.IncludeUtf8,
                            evaluationPath: IncludeSchemaEvaluationPath);

                    Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.IncludeJsoArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                ...
                private static PropertySchemaMatchers<Corvus.DenoBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Corvus.DenoBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                        ...
                        (static () => JsonPropertyNames.IncludeUtf8, MatchInclude),
                    ]);
                }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://deno.land/x/deno/cli/schemas/config-file.v1.json#/properties/bench/properties/files"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "https://deno.land/x/deno/cli/schemas/config-file.v1.json#/properties/bench/properties/files";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://deno.land/x/deno/cli/schemas/config-file.v1.json#/properties/bench/properties/files"u8;
