    ...
    public readonly partial struct ConfigurationForDenoBench
    {
        ...
        public readonly partial struct FilesEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(FilesEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="FilesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FilesEntity(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.JsonStringArray.Mutable Exclude
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludeUtf8, out Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.JsonStringArray.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.IncludeJsoArray.Mutable Include
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeUtf8, out Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.IncludeJsoArray.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetExclude(scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.JsonStringArray.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetExclude<TContext>(in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.JsonStringArray.Source<TContext> value)
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetInclude(scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.IncludeJsoArray.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.IncludeUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetInclude<TContext>(in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.IncludeJsoArray.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
                ...
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveInclude()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.IncludeUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FilesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="FilesEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="FilesEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly FilesEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<FilesEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="FilesEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly FilesEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<FilesEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.JsonStringArray.Source _createArg1;
                private readonly Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.IncludeJsoArray.Source _createArg2;
                ...
                internal Source(Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.JsonStringArray.Source arg1, scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.IncludeJsoArray.Source arg2)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _kind = Kind.Create;
                ...
                public static implicit operator Source(FilesEntity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                private readonly Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.JsonStringArray.Source<TContext> _createArg1;
                private readonly Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.IncludeJsoArray.Source<TContext> _createArg2;
                ...
                internal Source(scoped in TContext context, Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in TContext context, scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.JsonStringArray.Source<TContext> arg1, scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.IncludeJsoArray.Source<TContext> arg2)
                {
                    _context = context;
                    _createArg1 = arg1;
                    _createArg2 = arg2;
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="FilesEntity"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.JsonStringArray.Source exclude = default,
                    in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.IncludeJsoArray.Source include = default)
                {
                ...
                /// Creates an instance of a <see cref="FilesEntity"/>.
                /// </summary>
                public void Create(in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.JsonStringArray.Source exclude = default, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.IncludeJsoArray.Source include = default)
                {
                    Create(ref _builder, exclude, include);
                }
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.JsonStringArray.Source<TContext> exclude = default,
                    in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.IncludeJsoArray.Source<TContext> include = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                #endif
                {
                    Create(context, ref _builder, exclude, include);
                }
                ...
                internal static void BuildCreateValue(scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.JsonStringArray.Source arg1, scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.IncludeJsoArray.Source arg2, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                ...
                /// <param name="arg2">The value of the property.</param>
                /// <param name="o">The complex value builder into which to write the object.</param>
                internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.JsonStringArray.Source<TContext> arg1, scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.IncludeJsoArray.Source<TContext> arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.JsonStringArray.Source exclude = default, scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.IncludeJsoArray.Source include = default)
            {
            ...
            /// <param name="include">The value of the <c>"include"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.JsonStringArray.Source<TContext> exclude = default, scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.IncludeJsoArray.Source<TContext> include = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Source<TContext>(context, exclude, include);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.JsonStringArray.Source exclude = default, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.IncludeJsoArray.Source include = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(exclude, include);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.JsonStringArray.Source<TContext> exclude = default, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.IncludeJsoArray.Source<TContext> include = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, exclude, include);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<FilesEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<FilesEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<FilesEntity>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<FilesEntity> Create<TContext>(
            ...
            public static ParsedJsonDocument<FilesEntity> Create(in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.JsonStringArray.Source exclude = default, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.IncludeJsoArray.Source include = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<FilesEntity> Create<TContext>(in TContext context, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.JsonStringArray.Source<TContext> exclude = default, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity.IncludeJsoArray.Source<TContext> include = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
