...
public readonly partial struct DenoSchema
{
    ...
    public readonly partial struct ConfigurationForDenoBench
        ...
        : IJsonElement<ConfigurationForDenoBench>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigurationForDenoBench"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ConfigurationForDenoBench(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ConfigurationForDenoBench DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.JsonStringArray Exclude
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludeUtf8, out Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.JsonStringArray value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity Files
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FilesUtf8, out Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.FilesEntity value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.IncludeJsoArray Include
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeUtf8, out Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoBench.IncludeJsoArray value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in ConfigurationForDenoBench left, in ConfigurationForDenoBench right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ConfigurationForDenoBench left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ConfigurationForDenoBench instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ConfigurationForDenoBench(JsonElement instance)
        {
            return ConfigurationForDenoBench.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfigurationForDenoBench From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfigurationForDenoBench ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ConfigurationForDenoBench>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfigurationForDenoBench ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ConfigurationForDenoBench>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfigurationForDenoBench ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ConfigurationForDenoBench>(json, options);
        }
        ...
        /// </exception>
        public static ConfigurationForDenoBench ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ConfigurationForDenoBench>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ConfigurationForDenoBench? result)
        {
            return JsonElementHelpers.TryParseValue<ConfigurationForDenoBench>(ref reader, out result);
        }
...
#if NET
        static ConfigurationForDenoBench IJsonElement<ConfigurationForDenoBench>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ConfigurationForDenoBench: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public ConfigurationForDenoBench Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public ConfigurationForDenoBench Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ConfigurationForDenoBench>(_idx);
            }
