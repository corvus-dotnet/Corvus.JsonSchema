...
public readonly partial struct DenoSchema
{
    ...
    public readonly partial struct ConfigurationForDenoTask
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ConfigurationForDenoTask instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ConfigurationForDenoTask"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ConfigurationForDenoTask(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ConfigurationForDenoTask(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ConfigurationForDenoTask.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ConfigurationForDenoTask"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ConfigurationForDenoTask"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ConfigurationForDenoTask Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ConfigurationForDenoTask>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ConfigurationForDenoTask"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ConfigurationForDenoTask Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ConfigurationForDenoTask>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoTask.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(ConfigurationForDenoTask instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoTask.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<ConfigurationForDenoTask, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ConfigurationForDenoTask> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ConfigurationForDenoTask>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ConfigurationForDenoTask> Create<TContext>(
