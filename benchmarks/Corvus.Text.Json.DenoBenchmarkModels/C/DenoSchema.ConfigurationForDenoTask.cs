...
public readonly partial struct DenoSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Determines if a property name matches '^[A-Za-z][A-Za-z0-9_\-:]*$'
        /// for the pattern property producing the type
        /// <see cref="Corvus.DenoBenchmark.Current.JsonString"/>.
        /// </summary>
        ...
        /// <see cref="Corvus.DenoBenchmark.Current.JsonString"/>
        /// if the property name matches '^[A-Za-z][A-Za-z0-9_\-:]*$'.
        /// </summary>
        /// <param name="propertyName">The unescaped UTF-8 property name.</param>
        /// <param name="value">The property value.</param>
        /// <param name="result">The typed property value, if the name matches.</param>
        /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
        public static bool TryAsPatternJsonString(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.DenoBenchmark.Current.JsonString result)
        {
            if (MatchesPatternJsonString(propertyName))
            {
                result = Corvus.DenoBenchmark.Current.JsonString.From(value);
                return true;
            }
        ...
        {
            /// <summary>
            /// Visits a property matching '^[A-Za-z][A-Za-z0-9_\-:]*$'.
            /// </summary>
            bool VisitPatternJsonString(ReadOnlySpan<byte> name, in Corvus.DenoBenchmark.Current.JsonString value, ref TState state);
            ...
            where TVisitor : IPatternPropertyVisitor<TState>
        {
            ...
            foreach (var property in EnumerateObject())
            {
                ...
                {
                    matched = true;
                    Corvus.DenoBenchmark.Current.JsonString typedValue = Corvus.DenoBenchmark.Current.JsonString.From(property.Value);
