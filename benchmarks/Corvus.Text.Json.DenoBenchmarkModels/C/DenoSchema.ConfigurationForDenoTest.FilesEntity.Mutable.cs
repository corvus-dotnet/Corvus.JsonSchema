    ...
    public readonly partial struct ConfigurationForDenoTest
    {
        ...
        public readonly partial struct FilesEntity
        {
...
#endif
            {
                ...
                public void SetExclude(in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoTest.FilesEntity.JsonStringArray.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetInclude(in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoTest.FilesEntity.IncludeJsoArray.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoTest.FilesEntity.JsonStringArray.Source arg1, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoTest.FilesEntity.IncludeJsoArray.Source arg2)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _kind = Kind.Create;
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoTest.FilesEntity.JsonStringArray.Source<TContext> arg1, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoTest.FilesEntity.IncludeJsoArray.Source<TContext> arg2)
                {
                    _context = context;
                    _createArg1 = arg1;
                    _createArg2 = arg2;
            ...
            public ref struct Builder
            {
                ...
                internal static void BuildCreateValue(in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoTest.FilesEntity.JsonStringArray.Source arg1, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoTest.FilesEntity.IncludeJsoArray.Source arg2, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                ...
                /// <param name="arg2">The value of the property.</param>
                /// <param name="o">The complex value builder into which to write the object.</param>
                internal static void BuildCreateValue<TContext>(scoped in TContext context, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoTest.FilesEntity.JsonStringArray.Source<TContext> arg1, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoTest.FilesEntity.IncludeJsoArray.Source<TContext> arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoTest.FilesEntity.JsonStringArray.Source exclude = default, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoTest.FilesEntity.IncludeJsoArray.Source include = default)
            {
            ...
            /// <param name="include">The value of the <c>"include"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoTest.FilesEntity.JsonStringArray.Source<TContext> exclude = default, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoTest.FilesEntity.IncludeJsoArray.Source<TContext> include = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
