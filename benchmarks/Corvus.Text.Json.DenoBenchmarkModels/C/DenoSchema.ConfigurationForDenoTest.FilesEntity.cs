...
public readonly partial struct DenoSchema
{
    ...
    public readonly partial struct ConfigurationForDenoTest
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoTest.FilesEntity.JsonStringArray Exclude
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludeUtf8, out Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoTest.FilesEntity.JsonStringArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoTest.FilesEntity.IncludeJsoArray Include
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeUtf8, out Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForDenoTest.FilesEntity.IncludeJsoArray value))
                    {
                        return value;
                    }
