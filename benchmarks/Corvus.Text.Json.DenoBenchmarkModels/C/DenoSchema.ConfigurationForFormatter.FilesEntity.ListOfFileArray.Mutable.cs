...
public readonly partial struct DenoSchema
{
    ...
    public readonly partial struct ConfigurationForFormatter
    {
        ...
        public readonly partial struct FilesEntity
        {
            ...
            public readonly partial struct ListOfFileArray
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ListOfFileArray instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ListOfFileArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ListOfFileArray(Mutable instance)
                    {
                    ...
                    public Corvus.DenoBenchmark.Current.JsonString.Mutable this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.DenoBenchmark.Current.JsonString.Mutable>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.DenoBenchmark.Current.JsonString.Mutable> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.DenoBenchmark.Current.JsonString.Mutable>(_parent, _idx);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new ListOfFileArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ListOfFileArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void SetItem(int itemIndex, in Corvus.DenoBenchmark.Current.JsonString.Source value)
                    {
                        CheckValidInstance();
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Remove(in Corvus.DenoBenchmark.Current.JsonString item)
                    {
                        CheckValidInstance();
                        if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.DenoBenchmark.Current.JsonString>(this, in item))
                        {
                            return false;
                        }
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void RemoveWhere(JsonPredicate<Corvus.DenoBenchmark.Current.JsonString> predicate)
                    {
                        CheckValidInstance();
                        JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.DenoBenchmark.Current.JsonString>(this, predicate);
                        _documentVersion = _parent.Version;
                    }
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Replace(in Corvus.DenoBenchmark.Current.JsonString oldItem, in Corvus.DenoBenchmark.Current.JsonString.Source newItem)
                    {
                        CheckValidInstance();
                        ...
                        var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.DenoBenchmark.Current.JsonString>(_parent, _idx);

                        while (enumerator.MoveNext())
                        {
                            Corvus.DenoBenchmark.Current.JsonString current = enumerator.Current;
                    ...
                    /// <summary>
                    /// Gets a <see cref="ListOfFileArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="ListOfFileArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ListOfFileArray Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<ListOfFileArray>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="ListOfFileArray"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ListOfFileArray Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ListOfFileArray>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForFormatter.FilesEntity.ListOfFileArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(ListOfFileArray instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForFormatter.FilesEntity.ListOfFileArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<ListOfFileArray, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ListOfFileArray> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ListOfFileArray>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<ListOfFileArray> Create<TContext>(
