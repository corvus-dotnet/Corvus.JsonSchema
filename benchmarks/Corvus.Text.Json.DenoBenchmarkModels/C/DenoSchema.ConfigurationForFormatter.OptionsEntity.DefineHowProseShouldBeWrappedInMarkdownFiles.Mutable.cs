        ...
        public readonly partial struct OptionsEntity
        {
            ...
            public readonly partial struct DefineHowProseShouldBeWrappedInMarkdownFiles
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DefineHowProseShouldBeWrappedInMarkdownFiles, Mutable>(DefineHowProseShouldBeWrappedInMarkdownFiles.DefaultInstance);
                    ...
                    public static explicit operator Mutable(DefineHowProseShouldBeWrappedInMarkdownFiles instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DefineHowProseShouldBeWrappedInMarkdownFiles"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DefineHowProseShouldBeWrappedInMarkdownFiles(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new DefineHowProseShouldBeWrappedInMarkdownFiles(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DefineHowProseShouldBeWrappedInMarkdownFiles.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="DefineHowProseShouldBeWrappedInMarkdownFiles"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="DefineHowProseShouldBeWrappedInMarkdownFiles"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DefineHowProseShouldBeWrappedInMarkdownFiles Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<DefineHowProseShouldBeWrappedInMarkdownFiles>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="DefineHowProseShouldBeWrappedInMarkdownFiles"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DefineHowProseShouldBeWrappedInMarkdownFiles Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DefineHowProseShouldBeWrappedInMarkdownFiles>(_idx);
                    }
                    ...
                    /// <param name="matchPreserve">Match 3rd item.</param>
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DefineHowProseShouldBeWrappedInMarkdownFiles instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (DefineHowProseShouldBeWrappedInMarkdownFiles)value;
                ...
                {
                    return workspace.CreateBuilder<DefineHowProseShouldBeWrappedInMarkdownFiles, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<DefineHowProseShouldBeWrappedInMarkdownFiles> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DefineHowProseShouldBeWrappedInMarkdownFiles>();
                    }
                    finally
                    {
