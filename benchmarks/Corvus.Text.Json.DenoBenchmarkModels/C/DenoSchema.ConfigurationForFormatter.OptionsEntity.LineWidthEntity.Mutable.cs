        ...
        public readonly partial struct OptionsEntity
        {
            ...
            public readonly partial struct LineWidthEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<LineWidthEntity, Mutable>(LineWidthEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(LineWidthEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="LineWidthEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator LineWidthEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"LineWidthEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly LineWidthEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly LineWidthEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<LineWidthEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(LineWidthEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<LineWidthEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<LineWidthEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<LineWidthEntity>();
                    }
                    finally
                    {
