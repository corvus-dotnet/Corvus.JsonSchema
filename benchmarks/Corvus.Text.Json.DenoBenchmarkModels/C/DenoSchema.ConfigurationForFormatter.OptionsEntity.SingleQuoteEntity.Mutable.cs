        ...
        public readonly partial struct OptionsEntity
        {
            ...
            public readonly partial struct SingleQuoteEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SingleQuoteEntity, Mutable>(SingleQuoteEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(SingleQuoteEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="SingleQuoteEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator SingleQuoteEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"SingleQuoteEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SingleQuoteEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SingleQuoteEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<SingleQuoteEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(SingleQuoteEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<SingleQuoteEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<SingleQuoteEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<SingleQuoteEntity>();
                    }
                    finally
                    {
