...
public readonly partial struct DenoSchema
{
    ...
    public readonly partial struct ConfigurationForFormatter
    {
        ...
        public readonly partial struct OptionsEntity
        {
            ...
            public readonly partial struct SingleQuoteEntity
#if NET8_0_OR_GREATER
                : IJsonElement<SingleQuoteEntity>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="SingleQuoteEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal SingleQuoteEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static SingleQuoteEntity DefaultInstance { get; } = ParsedJsonDocument<SingleQuoteEntity>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(SingleQuoteEntity value)
                {
                ...
                /// </returns>
                public static bool operator ==(in SingleQuoteEntity left, in SingleQuoteEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in SingleQuoteEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(SingleQuoteEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SingleQuoteEntity(JsonElement instance)
                {
                    return SingleQuoteEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SingleQuoteEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SingleQuoteEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SingleQuoteEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SingleQuoteEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SingleQuoteEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SingleQuoteEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SingleQuoteEntity>(json, options);
                }
                ...
                /// </exception>
                public static SingleQuoteEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<SingleQuoteEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out SingleQuoteEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<SingleQuoteEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new SingleQuoteEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static SingleQuoteEntity IJsonElement<SingleQuoteEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SingleQuoteEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="SingleQuoteEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="SingleQuoteEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public SingleQuoteEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<SingleQuoteEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="SingleQuoteEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public SingleQuoteEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<SingleQuoteEntity>(_idx);
                    }
