        ...
        public readonly partial struct OptionsEntity
        {
            ...
            public readonly partial struct TheNumberOfCharactersForAnIndent
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TheNumberOfCharactersForAnIndent, Mutable>(TheNumberOfCharactersForAnIndent.DefaultInstance);
                ...
                public static ParsedJsonDocument<TheNumberOfCharactersForAnIndent> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<TheNumberOfCharactersForAnIndent>();
                    }
                    finally
                    {
