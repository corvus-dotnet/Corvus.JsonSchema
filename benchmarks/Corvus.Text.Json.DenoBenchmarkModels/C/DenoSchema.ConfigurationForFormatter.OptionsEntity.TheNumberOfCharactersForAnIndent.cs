...
public readonly partial struct DenoSchema
{
    ...
    public readonly partial struct ConfigurationForFormatter
    {
        ...
        public readonly partial struct OptionsEntity
        {
            ...
            public readonly partial struct TheNumberOfCharactersForAnIndent
#if NET8_0_OR_GREATER
                : IJsonElement<TheNumberOfCharactersForAnIndent>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="TheNumberOfCharactersForAnIndent"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal TheNumberOfCharactersForAnIndent(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static TheNumberOfCharactersForAnIndent DefaultInstance { get; } = ParsedJsonDocument<TheNumberOfCharactersForAnIndent>.NumberConstant([.."2"u8]);
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator long(TheNumberOfCharactersForAnIndent value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator double(TheNumberOfCharactersForAnIndent value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator Corvus.Numerics.BigNumber(TheNumberOfCharactersForAnIndent value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator System.Numerics.BigInteger(TheNumberOfCharactersForAnIndent value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in TheNumberOfCharactersForAnIndent left, in TheNumberOfCharactersForAnIndent right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in TheNumberOfCharactersForAnIndent left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(TheNumberOfCharactersForAnIndent instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheNumberOfCharactersForAnIndent(JsonElement instance)
                {
                    return TheNumberOfCharactersForAnIndent.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheNumberOfCharactersForAnIndent From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheNumberOfCharactersForAnIndent ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheNumberOfCharactersForAnIndent>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheNumberOfCharactersForAnIndent ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheNumberOfCharactersForAnIndent>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheNumberOfCharactersForAnIndent ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheNumberOfCharactersForAnIndent>(json, options);
                }
                ...
                /// </exception>
                public static TheNumberOfCharactersForAnIndent ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<TheNumberOfCharactersForAnIndent>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out TheNumberOfCharactersForAnIndent? result)
                {
                    return JsonElementHelpers.TryParseValue<TheNumberOfCharactersForAnIndent>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TheNumberOfCharactersForAnIndent(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static TheNumberOfCharactersForAnIndent IJsonElement<TheNumberOfCharactersForAnIndent>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheNumberOfCharactersForAnIndent: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TheNumberOfCharactersForAnIndent"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TheNumberOfCharactersForAnIndent"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public TheNumberOfCharactersForAnIndent Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TheNumberOfCharactersForAnIndent>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TheNumberOfCharactersForAnIndent"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public TheNumberOfCharactersForAnIndent Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<TheNumberOfCharactersForAnIndent>(_idx);
                    }
