...
public readonly partial struct DenoSchema
{
    ...
    public readonly partial struct ConfigurationForFormatter
    {
        ...
        public readonly partial struct OptionsEntity
        {
            ...
            public readonly partial struct WhetherToPreferUsingSemicolons
#if NET8_0_OR_GREATER
                : IJsonElement<WhetherToPreferUsingSemicolons>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="WhetherToPreferUsingSemicolons"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal WhetherToPreferUsingSemicolons(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static WhetherToPreferUsingSemicolons DefaultInstance { get; } = ParsedJsonDocument<WhetherToPreferUsingSemicolons>.True;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(WhetherToPreferUsingSemicolons value)
                {
                ...
                /// </returns>
                public static bool operator ==(in WhetherToPreferUsingSemicolons left, in WhetherToPreferUsingSemicolons right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in WhetherToPreferUsingSemicolons left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(WhetherToPreferUsingSemicolons instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WhetherToPreferUsingSemicolons(JsonElement instance)
                {
                    return WhetherToPreferUsingSemicolons.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WhetherToPreferUsingSemicolons From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WhetherToPreferUsingSemicolons ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<WhetherToPreferUsingSemicolons>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WhetherToPreferUsingSemicolons ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<WhetherToPreferUsingSemicolons>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WhetherToPreferUsingSemicolons ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<WhetherToPreferUsingSemicolons>(json, options);
                }
                ...
                /// </exception>
                public static WhetherToPreferUsingSemicolons ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<WhetherToPreferUsingSemicolons>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out WhetherToPreferUsingSemicolons? result)
                {
                    return JsonElementHelpers.TryParseValue<WhetherToPreferUsingSemicolons>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new WhetherToPreferUsingSemicolons(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static WhetherToPreferUsingSemicolons IJsonElement<WhetherToPreferUsingSemicolons>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WhetherToPreferUsingSemicolons: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="WhetherToPreferUsingSemicolons"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="WhetherToPreferUsingSemicolons"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public WhetherToPreferUsingSemicolons Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<WhetherToPreferUsingSemicolons>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="WhetherToPreferUsingSemicolons"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public WhetherToPreferUsingSemicolons Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<WhetherToPreferUsingSemicolons>(_idx);
                    }
