        ...
        public readonly partial struct OptionsEntity
        {
            ...
            public readonly partial struct WhetherToUseTabsTrueOrSpacesFalseForIndentation
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<WhetherToUseTabsTrueOrSpacesFalseForIndentation, Mutable>(WhetherToUseTabsTrueOrSpacesFalseForIndentation.DefaultInstance);
                    ...
                    public static explicit operator Mutable(WhetherToUseTabsTrueOrSpacesFalseForIndentation instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="WhetherToUseTabsTrueOrSpacesFalseForIndentation"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator WhetherToUseTabsTrueOrSpacesFalseForIndentation(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"WhetherToUseTabsTrueOrSpacesFalseForIndentation.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly WhetherToUseTabsTrueOrSpacesFalseForIndentation Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly WhetherToUseTabsTrueOrSpacesFalseForIndentation Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<WhetherToUseTabsTrueOrSpacesFalseForIndentation>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(WhetherToUseTabsTrueOrSpacesFalseForIndentation instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<WhetherToUseTabsTrueOrSpacesFalseForIndentation, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<WhetherToUseTabsTrueOrSpacesFalseForIndentation> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<WhetherToUseTabsTrueOrSpacesFalseForIndentation>();
                    }
                    finally
                    {
