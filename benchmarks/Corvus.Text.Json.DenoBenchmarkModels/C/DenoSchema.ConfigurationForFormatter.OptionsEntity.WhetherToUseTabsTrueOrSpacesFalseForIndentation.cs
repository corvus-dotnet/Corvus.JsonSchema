    ...
    public readonly partial struct ConfigurationForFormatter
    {
        ...
        public readonly partial struct OptionsEntity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="WhetherToUseTabsTrueOrSpacesFalseForIndentation"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal WhetherToUseTabsTrueOrSpacesFalseForIndentation(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static WhetherToUseTabsTrueOrSpacesFalseForIndentation DefaultInstance { get; } = ParsedJsonDocument<WhetherToUseTabsTrueOrSpacesFalseForIndentation>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(WhetherToUseTabsTrueOrSpacesFalseForIndentation value)
                {
                ...
                /// </returns>
                public static bool operator ==(in WhetherToUseTabsTrueOrSpacesFalseForIndentation left, in WhetherToUseTabsTrueOrSpacesFalseForIndentation right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in WhetherToUseTabsTrueOrSpacesFalseForIndentation left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(WhetherToUseTabsTrueOrSpacesFalseForIndentation instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WhetherToUseTabsTrueOrSpacesFalseForIndentation(JsonElement instance)
                {
                    return WhetherToUseTabsTrueOrSpacesFalseForIndentation.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WhetherToUseTabsTrueOrSpacesFalseForIndentation From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WhetherToUseTabsTrueOrSpacesFalseForIndentation ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<WhetherToUseTabsTrueOrSpacesFalseForIndentation>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WhetherToUseTabsTrueOrSpacesFalseForIndentation ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<WhetherToUseTabsTrueOrSpacesFalseForIndentation>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WhetherToUseTabsTrueOrSpacesFalseForIndentation ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<WhetherToUseTabsTrueOrSpacesFalseForIndentation>(json, options);
                }
                ...
                /// </exception>
                public static WhetherToUseTabsTrueOrSpacesFalseForIndentation ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<WhetherToUseTabsTrueOrSpacesFalseForIndentation>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out WhetherToUseTabsTrueOrSpacesFalseForIndentation? result)
                {
                    return JsonElementHelpers.TryParseValue<WhetherToUseTabsTrueOrSpacesFalseForIndentation>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new WhetherToUseTabsTrueOrSpacesFalseForIndentation(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static WhetherToUseTabsTrueOrSpacesFalseForIndentation IJsonElement<WhetherToUseTabsTrueOrSpacesFalseForIndentation>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WhetherToUseTabsTrueOrSpacesFalseForIndentation: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="WhetherToUseTabsTrueOrSpacesFalseForIndentation"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="WhetherToUseTabsTrueOrSpacesFalseForIndentation"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public WhetherToUseTabsTrueOrSpacesFalseForIndentation Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<WhetherToUseTabsTrueOrSpacesFalseForIndentation>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="WhetherToUseTabsTrueOrSpacesFalseForIndentation"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public WhetherToUseTabsTrueOrSpacesFalseForIndentation Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<WhetherToUseTabsTrueOrSpacesFalseForIndentation>(_idx);
                    }
