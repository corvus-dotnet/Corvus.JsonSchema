    ...
    public readonly partial struct ConfigurationForFormatter
    {
        ...
        public readonly partial struct WhetherToPreferUsingSemicolons
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<WhetherToPreferUsingSemicolons, Mutable>(WhetherToPreferUsingSemicolons.DefaultInstance);
                ...
                public static explicit operator Mutable(WhetherToPreferUsingSemicolons instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="WhetherToPreferUsingSemicolons"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WhetherToPreferUsingSemicolons(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WhetherToPreferUsingSemicolons.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly WhetherToPreferUsingSemicolons Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly WhetherToPreferUsingSemicolons Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<WhetherToPreferUsingSemicolons>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(WhetherToPreferUsingSemicolons instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<WhetherToPreferUsingSemicolons, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<WhetherToPreferUsingSemicolons> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<WhetherToPreferUsingSemicolons>();
                }
                finally
                {
