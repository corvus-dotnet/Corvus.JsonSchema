    ...
    public readonly partial struct ConfigurationForLinter
    {
        ...
        public readonly partial struct FilesEntity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.JsonStringArray.Mutable Exclude
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludeUtf8, out Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.JsonStringArray.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.ListOfFileArray.Mutable Include
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeUtf8, out Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.ListOfFileArray.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetExclude(scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.JsonStringArray.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetExclude<TContext>(in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.JsonStringArray.Source<TContext> value)
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetInclude(scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.ListOfFileArray.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetInclude<TContext>(in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.ListOfFileArray.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.JsonStringArray.Source _createArg1;
                private readonly Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.ListOfFileArray.Source _createArg2;
                ...
                internal Source(Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.JsonStringArray.Source arg1, scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.ListOfFileArray.Source arg2)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _kind = Kind.Create;
                ...
                #endif
            {
                ...
                private readonly Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.JsonStringArray.Source<TContext> _createArg1;
                private readonly Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.ListOfFileArray.Source<TContext> _createArg2;
                ...
                internal Source(scoped in TContext context, Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in TContext context, scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.JsonStringArray.Source<TContext> arg1, scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.ListOfFileArray.Source<TContext> arg2)
                {
                    _context = context;
                    _createArg1 = arg1;
                    _createArg2 = arg2;
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.JsonStringArray.Source exclude = default,
                    in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.ListOfFileArray.Source include = default)
                {
                ...
                /// Creates an instance of a <see cref="FilesEntity"/>.
                /// </summary>
                public void Create(in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.JsonStringArray.Source exclude = default, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.ListOfFileArray.Source include = default)
                {
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.JsonStringArray.Source<TContext> exclude = default,
                    in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.ListOfFileArray.Source<TContext> include = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                internal static void BuildCreateValue(scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.JsonStringArray.Source arg1, scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.ListOfFileArray.Source arg2, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                ...
                /// <param name="arg2">The value of the property.</param>
                /// <param name="o">The complex value builder into which to write the object.</param>
                internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.JsonStringArray.Source<TContext> arg1, scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.ListOfFileArray.Source<TContext> arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.JsonStringArray.Source exclude = default, scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.ListOfFileArray.Source include = default)
            {
            ...
            /// <param name="include">The value of the <c>"include"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.JsonStringArray.Source<TContext> exclude = default, scoped in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.ListOfFileArray.Source<TContext> include = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.JsonStringArray.Source exclude = default, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.ListOfFileArray.Source include = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.JsonStringArray.Source<TContext> exclude = default, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.ListOfFileArray.Source<TContext> include = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            public static ParsedJsonDocument<FilesEntity> Create(in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.JsonStringArray.Source exclude = default, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.ListOfFileArray.Source include = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<FilesEntity> Create<TContext>(in TContext context, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.JsonStringArray.Source<TContext> exclude = default, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.ListOfFileArray.Source<TContext> include = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
