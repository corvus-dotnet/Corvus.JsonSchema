    ...
    public readonly partial struct ConfigurationForLinter
    {
        ...
        public readonly partial struct FilesEntity
        {
...
#endif
            {
                ...
                public void SetExclude(in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.JsonStringArray.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetInclude(in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.ListOfFileArray.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.JsonStringArray.Source arg1, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.ListOfFileArray.Source arg2)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _kind = Kind.Create;
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.JsonStringArray.Source<TContext> arg1, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.ListOfFileArray.Source<TContext> arg2)
                {
                    _context = context;
                    _createArg1 = arg1;
                    _createArg2 = arg2;
            ...
            public ref struct Builder
            {
                ...
                internal static void BuildCreateValue(in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.JsonStringArray.Source arg1, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.ListOfFileArray.Source arg2, ref ComplexValueBuilder o)
                {
                    o.StartObject();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.JsonStringArray.Source exclude = default, in Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity.ListOfFileArray.Source include = default)
            {
