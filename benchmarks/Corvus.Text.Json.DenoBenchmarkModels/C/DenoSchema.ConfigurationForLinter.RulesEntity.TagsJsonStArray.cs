    ...
    public readonly partial struct ConfigurationForLinter
    {
        ...
        public readonly partial struct RulesEntity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="TagsJsonStArray"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal TagsJsonStArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static TagsJsonStArray DefaultInstance { get; }
                ...
                /// </remarks>
                public static int ValueBufferSize => 0;
                ...
                /// </returns>
                public static bool operator ==(in TagsJsonStArray left, in TagsJsonStArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in TagsJsonStArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(TagsJsonStArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TagsJsonStArray(JsonElement instance)
                {
                    return TagsJsonStArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TagsJsonStArray From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TagsJsonStArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TagsJsonStArray>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TagsJsonStArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TagsJsonStArray>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TagsJsonStArray ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TagsJsonStArray>(json, options);
                }
                ...
                /// </exception>
                public static TagsJsonStArray ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<TagsJsonStArray>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out TagsJsonStArray? result)
                {
                    return JsonElementHelpers.TryParseValue<TagsJsonStArray>(ref reader, out result);
                }
...
#if NET
                static TagsJsonStArray IJsonElement<TagsJsonStArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TagsJsonStArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public TagsJsonStArray Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<TagsJsonStArray>(_idx);
                    }
