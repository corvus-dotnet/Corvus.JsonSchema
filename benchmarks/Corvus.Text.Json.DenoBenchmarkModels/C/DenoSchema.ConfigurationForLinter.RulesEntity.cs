...
public readonly partial struct DenoSchema
{
    ...
    public readonly partial struct ConfigurationForLinter
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RulesEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RulesEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RulesEntity DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.RulesEntity.JsonStringArray Exclude
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludeUtf8, out Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.RulesEntity.JsonStringArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.RulesEntity.IncludeJsoArray Include
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeUtf8, out Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.RulesEntity.IncludeJsoArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.RulesEntity.TagsJsonStArray Tags
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.RulesEntity.TagsJsonStArray value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in RulesEntity left, in RulesEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RulesEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RulesEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RulesEntity(JsonElement instance)
            {
                return RulesEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RulesEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RulesEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RulesEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RulesEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RulesEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RulesEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RulesEntity>(json, options);
            }
            ...
            /// </exception>
            public static RulesEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RulesEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RulesEntity? result)
            {
                return JsonElementHelpers.TryParseValue<RulesEntity>(ref reader, out result);
            }
...
#if NET
            static RulesEntity IJsonElement<RulesEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RulesEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
