    ...
    public readonly partial struct ConfigurationForLinter
    {
        ...
        public readonly partial struct TheDefaultReportFormatToUseWhenLinting
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TheDefaultReportFormatToUseWhenLinting, Mutable>(TheDefaultReportFormatToUseWhenLinting.DefaultInstance);
            ...
            public ref struct Source
            {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (TheDefaultReportFormatToUseWhenLinting)value;
            ...
            public static ParsedJsonDocument<TheDefaultReportFormatToUseWhenLinting> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TheDefaultReportFormatToUseWhenLinting>();
                }
                finally
                {
