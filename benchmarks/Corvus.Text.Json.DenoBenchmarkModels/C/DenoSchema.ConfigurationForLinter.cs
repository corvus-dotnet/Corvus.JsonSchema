...
public readonly partial struct DenoSchema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.JsonStringArray Exclude
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludeUtf8, out Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.JsonStringArray value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity Files
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FilesUtf8, out Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.FilesEntity value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.ListOfFileArray Include
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeUtf8, out Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.ListOfFileArray value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.TheDefaultReportFormatToUseWhenLinting Report
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReportUtf8, out Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.TheDefaultReportFormatToUseWhenLinting value))
                {
                    return value;
                }

                return Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.TheDefaultReportFormatToUseWhenLinting.DefaultInstance;
            }
        }
        ...
        /// </summary>
        public Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.RulesEntity Rules
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RulesUtf8, out Corvus.DenoBenchmark.Current.DenoSchema.ConfigurationForLinter.RulesEntity value))
                {
                    return value;
                }
        ...
        private static class JsonPropertyNamesPrebaked
        {
            ...
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Report"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Report => [0x85, 0x00, 0x00, 0x00, 0x22, 0x72, 0x65, 0x70, 0x6F, 0x72, 0x74, 0x22];
