    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
        ...
        public readonly partial struct AddUndefinedToATypeWhenAccessedUsingAnIndex
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AddUndefinedToATypeWhenAccessedUsingAnIndex, Mutable>(AddUndefinedToATypeWhenAccessedUsingAnIndex.DefaultInstance);
                ...
                public static explicit operator Mutable(AddUndefinedToATypeWhenAccessedUsingAnIndex instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AddUndefinedToATypeWhenAccessedUsingAnIndex"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AddUndefinedToATypeWhenAccessedUsingAnIndex(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AddUndefinedToATypeWhenAccessedUsingAnIndex.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AddUndefinedToATypeWhenAccessedUsingAnIndex Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AddUndefinedToATypeWhenAccessedUsingAnIndex Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AddUndefinedToATypeWhenAccessedUsingAnIndex>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AddUndefinedToATypeWhenAccessedUsingAnIndex instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AddUndefinedToATypeWhenAccessedUsingAnIndex, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AddUndefinedToATypeWhenAccessedUsingAnIndex> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AddUndefinedToATypeWhenAccessedUsingAnIndex>();
                }
                finally
                {
