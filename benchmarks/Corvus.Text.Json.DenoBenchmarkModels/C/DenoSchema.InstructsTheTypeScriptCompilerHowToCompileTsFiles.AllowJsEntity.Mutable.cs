    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
        ...
        public readonly partial struct AllowJsEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AllowJsEntity, Mutable>(AllowJsEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(AllowJsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AllowJsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AllowJsEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AllowJsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AllowJsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AllowJsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AllowJsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AllowJsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AllowJsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AllowJsEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AllowJsEntity>();
                }
                finally
                {
