    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
        ...
        public readonly partial struct DisableErrorReportingForUnreachableCode
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableErrorReportingForUnreachableCode, Mutable>(DisableErrorReportingForUnreachableCode.DefaultInstance);
                ...
                public static explicit operator Mutable(DisableErrorReportingForUnreachableCode instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DisableErrorReportingForUnreachableCode"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DisableErrorReportingForUnreachableCode(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DisableErrorReportingForUnreachableCode.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DisableErrorReportingForUnreachableCode Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DisableErrorReportingForUnreachableCode Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DisableErrorReportingForUnreachableCode>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DisableErrorReportingForUnreachableCode instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DisableErrorReportingForUnreachableCode, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DisableErrorReportingForUnreachableCode> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DisableErrorReportingForUnreachableCode>();
                }
                finally
                {
