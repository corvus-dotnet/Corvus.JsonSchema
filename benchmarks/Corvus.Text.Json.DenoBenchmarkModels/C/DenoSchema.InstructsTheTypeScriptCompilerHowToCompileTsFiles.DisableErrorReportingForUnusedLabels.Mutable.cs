    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
        ...
        public readonly partial struct DisableErrorReportingForUnusedLabels
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableErrorReportingForUnusedLabels, Mutable>(DisableErrorReportingForUnusedLabels.DefaultInstance);
                ...
                public static explicit operator Mutable(DisableErrorReportingForUnusedLabels instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DisableErrorReportingForUnusedLabels"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DisableErrorReportingForUnusedLabels(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DisableErrorReportingForUnusedLabels.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DisableErrorReportingForUnusedLabels Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DisableErrorReportingForUnusedLabels Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DisableErrorReportingForUnusedLabels>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DisableErrorReportingForUnusedLabels instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DisableErrorReportingForUnusedLabels, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DisableErrorReportingForUnusedLabels> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DisableErrorReportingForUnusedLabels>();
                }
                finally
                {
