...
public readonly partial struct DenoSchema
{
    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
        ...
        public readonly partial struct DisableErrorReportingForUnusedLabels
#if NET8_0_OR_GREATER
            : IJsonElement<DisableErrorReportingForUnusedLabels>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DisableErrorReportingForUnusedLabels"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal DisableErrorReportingForUnusedLabels(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static DisableErrorReportingForUnusedLabels DefaultInstance { get; } = ParsedJsonDocument<DisableErrorReportingForUnusedLabels>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(DisableErrorReportingForUnusedLabels value)
            {
            ...
            /// </returns>
            public static bool operator ==(in DisableErrorReportingForUnusedLabels left, in DisableErrorReportingForUnusedLabels right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in DisableErrorReportingForUnusedLabels left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(DisableErrorReportingForUnusedLabels instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DisableErrorReportingForUnusedLabels(JsonElement instance)
            {
                return DisableErrorReportingForUnusedLabels.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DisableErrorReportingForUnusedLabels From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DisableErrorReportingForUnusedLabels ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DisableErrorReportingForUnusedLabels>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DisableErrorReportingForUnusedLabels ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DisableErrorReportingForUnusedLabels>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DisableErrorReportingForUnusedLabels ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DisableErrorReportingForUnusedLabels>(json, options);
            }
            ...
            /// </exception>
            public static DisableErrorReportingForUnusedLabels ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<DisableErrorReportingForUnusedLabels>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out DisableErrorReportingForUnusedLabels? result)
            {
                return JsonElementHelpers.TryParseValue<DisableErrorReportingForUnusedLabels>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DisableErrorReportingForUnusedLabels(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static DisableErrorReportingForUnusedLabels IJsonElement<DisableErrorReportingForUnusedLabels>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DisableErrorReportingForUnusedLabels: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DisableErrorReportingForUnusedLabels"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DisableErrorReportingForUnusedLabels"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public DisableErrorReportingForUnusedLabels Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DisableErrorReportingForUnusedLabels>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DisableErrorReportingForUnusedLabels"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public DisableErrorReportingForUnusedLabels Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<DisableErrorReportingForUnusedLabels>(_idx);
                }
