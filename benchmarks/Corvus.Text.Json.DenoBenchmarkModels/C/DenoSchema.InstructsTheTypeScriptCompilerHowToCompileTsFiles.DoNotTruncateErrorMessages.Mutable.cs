    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
        ...
        public readonly partial struct DoNotTruncateErrorMessages
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DoNotTruncateErrorMessages, Mutable>(DoNotTruncateErrorMessages.DefaultInstance);
            ...
            public static ParsedJsonDocument<DoNotTruncateErrorMessages> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DoNotTruncateErrorMessages>();
                }
                finally
                {
