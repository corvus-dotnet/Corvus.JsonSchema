...
public readonly partial struct DenoSchema
{
    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DoNotTruncateErrorMessages"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal DoNotTruncateErrorMessages(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static DoNotTruncateErrorMessages DefaultInstance { get; } = ParsedJsonDocument<DoNotTruncateErrorMessages>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(DoNotTruncateErrorMessages value)
            {
            ...
            /// </returns>
            public static bool operator ==(in DoNotTruncateErrorMessages left, in DoNotTruncateErrorMessages right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in DoNotTruncateErrorMessages left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(DoNotTruncateErrorMessages instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DoNotTruncateErrorMessages(JsonElement instance)
            {
                return DoNotTruncateErrorMessages.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DoNotTruncateErrorMessages From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DoNotTruncateErrorMessages ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DoNotTruncateErrorMessages>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DoNotTruncateErrorMessages ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DoNotTruncateErrorMessages>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DoNotTruncateErrorMessages ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DoNotTruncateErrorMessages>(json, options);
            }
            ...
            /// </exception>
            public static DoNotTruncateErrorMessages ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<DoNotTruncateErrorMessages>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out DoNotTruncateErrorMessages? result)
            {
                return JsonElementHelpers.TryParseValue<DoNotTruncateErrorMessages>(ref reader, out result);
            }
...
#if NET
            static DoNotTruncateErrorMessages IJsonElement<DoNotTruncateErrorMessages>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DoNotTruncateErrorMessages: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public DoNotTruncateErrorMessages Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public DoNotTruncateErrorMessages Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<DoNotTruncateErrorMessages>(_idx);
                }
