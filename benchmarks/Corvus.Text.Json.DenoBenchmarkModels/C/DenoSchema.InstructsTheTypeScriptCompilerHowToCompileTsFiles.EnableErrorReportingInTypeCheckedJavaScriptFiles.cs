...
public readonly partial struct DenoSchema
{
    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
        ...
        public readonly partial struct EnableErrorReportingInTypeCheckedJavaScriptFiles
#if NET8_0_OR_GREATER
            : IJsonElement<EnableErrorReportingInTypeCheckedJavaScriptFiles>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="EnableErrorReportingInTypeCheckedJavaScriptFiles"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal EnableErrorReportingInTypeCheckedJavaScriptFiles(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static EnableErrorReportingInTypeCheckedJavaScriptFiles DefaultInstance { get; } = ParsedJsonDocument<EnableErrorReportingInTypeCheckedJavaScriptFiles>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(EnableErrorReportingInTypeCheckedJavaScriptFiles value)
            {
            ...
            /// </returns>
            public static bool operator ==(in EnableErrorReportingInTypeCheckedJavaScriptFiles left, in EnableErrorReportingInTypeCheckedJavaScriptFiles right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in EnableErrorReportingInTypeCheckedJavaScriptFiles left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(EnableErrorReportingInTypeCheckedJavaScriptFiles instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnableErrorReportingInTypeCheckedJavaScriptFiles(JsonElement instance)
            {
                return EnableErrorReportingInTypeCheckedJavaScriptFiles.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableErrorReportingInTypeCheckedJavaScriptFiles From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableErrorReportingInTypeCheckedJavaScriptFiles ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableErrorReportingInTypeCheckedJavaScriptFiles>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableErrorReportingInTypeCheckedJavaScriptFiles ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableErrorReportingInTypeCheckedJavaScriptFiles>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableErrorReportingInTypeCheckedJavaScriptFiles ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableErrorReportingInTypeCheckedJavaScriptFiles>(json, options);
            }
            ...
            /// </exception>
            public static EnableErrorReportingInTypeCheckedJavaScriptFiles ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<EnableErrorReportingInTypeCheckedJavaScriptFiles>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out EnableErrorReportingInTypeCheckedJavaScriptFiles? result)
            {
                return JsonElementHelpers.TryParseValue<EnableErrorReportingInTypeCheckedJavaScriptFiles>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new EnableErrorReportingInTypeCheckedJavaScriptFiles(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static EnableErrorReportingInTypeCheckedJavaScriptFiles IJsonElement<EnableErrorReportingInTypeCheckedJavaScriptFiles>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnableErrorReportingInTypeCheckedJavaScriptFiles: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="EnableErrorReportingInTypeCheckedJavaScriptFiles"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="EnableErrorReportingInTypeCheckedJavaScriptFiles"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public EnableErrorReportingInTypeCheckedJavaScriptFiles Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<EnableErrorReportingInTypeCheckedJavaScriptFiles>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="EnableErrorReportingInTypeCheckedJavaScriptFiles"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public EnableErrorReportingInTypeCheckedJavaScriptFiles Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<EnableErrorReportingInTypeCheckedJavaScriptFiles>(_idx);
                }
