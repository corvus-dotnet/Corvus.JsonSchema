    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
        ...
        public readonly partial struct EnableErrorReportingWhenThisIsGivenTheTypeAny
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnableErrorReportingWhenThisIsGivenTheTypeAny, Mutable>(EnableErrorReportingWhenThisIsGivenTheTypeAny.DefaultInstance);
                ...
                public static explicit operator Mutable(EnableErrorReportingWhenThisIsGivenTheTypeAny instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EnableErrorReportingWhenThisIsGivenTheTypeAny"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EnableErrorReportingWhenThisIsGivenTheTypeAny(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EnableErrorReportingWhenThisIsGivenTheTypeAny.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly EnableErrorReportingWhenThisIsGivenTheTypeAny Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly EnableErrorReportingWhenThisIsGivenTheTypeAny Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EnableErrorReportingWhenThisIsGivenTheTypeAny>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(EnableErrorReportingWhenThisIsGivenTheTypeAny instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<EnableErrorReportingWhenThisIsGivenTheTypeAny, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<EnableErrorReportingWhenThisIsGivenTheTypeAny> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EnableErrorReportingWhenThisIsGivenTheTypeAny>();
                }
                finally
                {
