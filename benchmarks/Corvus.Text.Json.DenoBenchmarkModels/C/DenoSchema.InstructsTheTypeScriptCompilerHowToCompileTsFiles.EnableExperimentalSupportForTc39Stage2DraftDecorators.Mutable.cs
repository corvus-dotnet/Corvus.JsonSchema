    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
        ...
        public readonly partial struct EnableExperimentalSupportForTc39Stage2DraftDecorators
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnableExperimentalSupportForTc39Stage2DraftDecorators, Mutable>(EnableExperimentalSupportForTc39Stage2DraftDecorators.DefaultInstance);
                ...
                public static explicit operator Mutable(EnableExperimentalSupportForTc39Stage2DraftDecorators instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EnableExperimentalSupportForTc39Stage2DraftDecorators"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EnableExperimentalSupportForTc39Stage2DraftDecorators(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EnableExperimentalSupportForTc39Stage2DraftDecorators.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly EnableExperimentalSupportForTc39Stage2DraftDecorators Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly EnableExperimentalSupportForTc39Stage2DraftDecorators Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EnableExperimentalSupportForTc39Stage2DraftDecorators>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(EnableExperimentalSupportForTc39Stage2DraftDecorators instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<EnableExperimentalSupportForTc39Stage2DraftDecorators, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<EnableExperimentalSupportForTc39Stage2DraftDecorators> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EnableExperimentalSupportForTc39Stage2DraftDecorators>();
                }
                finally
                {
