...
public readonly partial struct DenoSchema
{
    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
        ...
        public readonly partial struct EnableExperimentalSupportForTc39Stage2DraftDecorators
#if NET8_0_OR_GREATER
            : IJsonElement<EnableExperimentalSupportForTc39Stage2DraftDecorators>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="EnableExperimentalSupportForTc39Stage2DraftDecorators"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal EnableExperimentalSupportForTc39Stage2DraftDecorators(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static EnableExperimentalSupportForTc39Stage2DraftDecorators DefaultInstance { get; } = ParsedJsonDocument<EnableExperimentalSupportForTc39Stage2DraftDecorators>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(EnableExperimentalSupportForTc39Stage2DraftDecorators value)
            {
            ...
            /// </returns>
            public static bool operator ==(in EnableExperimentalSupportForTc39Stage2DraftDecorators left, in EnableExperimentalSupportForTc39Stage2DraftDecorators right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in EnableExperimentalSupportForTc39Stage2DraftDecorators left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(EnableExperimentalSupportForTc39Stage2DraftDecorators instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnableExperimentalSupportForTc39Stage2DraftDecorators(JsonElement instance)
            {
                return EnableExperimentalSupportForTc39Stage2DraftDecorators.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableExperimentalSupportForTc39Stage2DraftDecorators From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableExperimentalSupportForTc39Stage2DraftDecorators ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<EnableExperimentalSupportForTc39Stage2DraftDecorators>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableExperimentalSupportForTc39Stage2DraftDecorators ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<EnableExperimentalSupportForTc39Stage2DraftDecorators>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableExperimentalSupportForTc39Stage2DraftDecorators ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<EnableExperimentalSupportForTc39Stage2DraftDecorators>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static EnableExperimentalSupportForTc39Stage2DraftDecorators ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<EnableExperimentalSupportForTc39Stage2DraftDecorators>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out EnableExperimentalSupportForTc39Stage2DraftDecorators? result)
            {
                return JsonElementHelpers.TryParseValue<EnableExperimentalSupportForTc39Stage2DraftDecorators>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new EnableExperimentalSupportForTc39Stage2DraftDecorators(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static EnableExperimentalSupportForTc39Stage2DraftDecorators IJsonElement<EnableExperimentalSupportForTc39Stage2DraftDecorators>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnableExperimentalSupportForTc39Stage2DraftDecorators: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="EnableExperimentalSupportForTc39Stage2DraftDecorators"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="EnableExperimentalSupportForTc39Stage2DraftDecorators"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public EnableExperimentalSupportForTc39Stage2DraftDecorators Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<EnableExperimentalSupportForTc39Stage2DraftDecorators>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="EnableExperimentalSupportForTc39Stage2DraftDecorators"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public EnableExperimentalSupportForTc39Stage2DraftDecorators Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<EnableExperimentalSupportForTc39Stage2DraftDecorators>(_idx);
                }
