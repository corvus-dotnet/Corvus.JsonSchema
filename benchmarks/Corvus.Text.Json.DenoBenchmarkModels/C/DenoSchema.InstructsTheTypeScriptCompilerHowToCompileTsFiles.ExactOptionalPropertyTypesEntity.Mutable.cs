    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
        ...
        public readonly partial struct ExactOptionalPropertyTypesEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ExactOptionalPropertyTypesEntity, Mutable>(ExactOptionalPropertyTypesEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<ExactOptionalPropertyTypesEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ExactOptionalPropertyTypesEntity>();
                }
                finally
                {
