...
public readonly partial struct DenoSchema
{
    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
        ...
        public readonly partial struct KeyofStringsOnlyEntity
#if NET8_0_OR_GREATER
            : IJsonElement<KeyofStringsOnlyEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="KeyofStringsOnlyEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal KeyofStringsOnlyEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static KeyofStringsOnlyEntity DefaultInstance { get; } = ParsedJsonDocument<KeyofStringsOnlyEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(KeyofStringsOnlyEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in KeyofStringsOnlyEntity left, in KeyofStringsOnlyEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in KeyofStringsOnlyEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(KeyofStringsOnlyEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator KeyofStringsOnlyEntity(JsonElement instance)
            {
                return KeyofStringsOnlyEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static KeyofStringsOnlyEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static KeyofStringsOnlyEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<KeyofStringsOnlyEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static KeyofStringsOnlyEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<KeyofStringsOnlyEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static KeyofStringsOnlyEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<KeyofStringsOnlyEntity>(json, options);
            }
            ...
            /// </exception>
            public static KeyofStringsOnlyEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<KeyofStringsOnlyEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out KeyofStringsOnlyEntity? result)
            {
                return JsonElementHelpers.TryParseValue<KeyofStringsOnlyEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new KeyofStringsOnlyEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static KeyofStringsOnlyEntity IJsonElement<KeyofStringsOnlyEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"KeyofStringsOnlyEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="KeyofStringsOnlyEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="KeyofStringsOnlyEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public KeyofStringsOnlyEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<KeyofStringsOnlyEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="KeyofStringsOnlyEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public KeyofStringsOnlyEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<KeyofStringsOnlyEntity>(_idx);
                }
