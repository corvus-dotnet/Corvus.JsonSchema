...
public readonly partial struct DenoSchema
{
    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
        ...
        public readonly partial struct NoImplicitAnyEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NoImplicitAnyEntity, Mutable>(NoImplicitAnyEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(NoImplicitAnyEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="NoImplicitAnyEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator NoImplicitAnyEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new NoImplicitAnyEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"NoImplicitAnyEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="NoImplicitAnyEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="NoImplicitAnyEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly NoImplicitAnyEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<NoImplicitAnyEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="NoImplicitAnyEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly NoImplicitAnyEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<NoImplicitAnyEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(NoImplicitAnyEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<NoImplicitAnyEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<NoImplicitAnyEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<NoImplicitAnyEntity>();
                }
                finally
                {
