    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
        ...
        public readonly partial struct NoImplicitReturnsEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NoImplicitReturnsEntity, Mutable>(NoImplicitReturnsEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(NoImplicitReturnsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="NoImplicitReturnsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator NoImplicitReturnsEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"NoImplicitReturnsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly NoImplicitReturnsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly NoImplicitReturnsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<NoImplicitReturnsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(NoImplicitReturnsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<NoImplicitReturnsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<NoImplicitReturnsEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<NoImplicitReturnsEntity>();
                }
                finally
                {
