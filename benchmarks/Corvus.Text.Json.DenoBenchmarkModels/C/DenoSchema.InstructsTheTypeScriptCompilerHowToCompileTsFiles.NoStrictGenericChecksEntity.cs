...
public readonly partial struct DenoSchema
{
    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
        ...
        public readonly partial struct NoStrictGenericChecksEntity
#if NET8_0_OR_GREATER
            : IJsonElement<NoStrictGenericChecksEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="NoStrictGenericChecksEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal NoStrictGenericChecksEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static NoStrictGenericChecksEntity DefaultInstance { get; } = ParsedJsonDocument<NoStrictGenericChecksEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(NoStrictGenericChecksEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in NoStrictGenericChecksEntity left, in NoStrictGenericChecksEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in NoStrictGenericChecksEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(NoStrictGenericChecksEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NoStrictGenericChecksEntity(JsonElement instance)
            {
                return NoStrictGenericChecksEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NoStrictGenericChecksEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NoStrictGenericChecksEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NoStrictGenericChecksEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NoStrictGenericChecksEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NoStrictGenericChecksEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NoStrictGenericChecksEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NoStrictGenericChecksEntity>(json, options);
            }
            ...
            /// </exception>
            public static NoStrictGenericChecksEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<NoStrictGenericChecksEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out NoStrictGenericChecksEntity? result)
            {
                return JsonElementHelpers.TryParseValue<NoStrictGenericChecksEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new NoStrictGenericChecksEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static NoStrictGenericChecksEntity IJsonElement<NoStrictGenericChecksEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"NoStrictGenericChecksEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="NoStrictGenericChecksEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="NoStrictGenericChecksEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public NoStrictGenericChecksEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<NoStrictGenericChecksEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="NoStrictGenericChecksEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public NoStrictGenericChecksEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<NoStrictGenericChecksEntity>(_idx);
                }
