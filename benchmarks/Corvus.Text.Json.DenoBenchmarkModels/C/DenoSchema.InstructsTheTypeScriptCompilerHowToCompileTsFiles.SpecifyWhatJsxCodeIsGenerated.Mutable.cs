    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
        ...
        public readonly partial struct SpecifyWhatJsxCodeIsGenerated
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SpecifyWhatJsxCodeIsGenerated, Mutable>(SpecifyWhatJsxCodeIsGenerated.DefaultInstance);
                ...
                public static explicit operator Mutable(SpecifyWhatJsxCodeIsGenerated instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SpecifyWhatJsxCodeIsGenerated"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SpecifyWhatJsxCodeIsGenerated(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SpecifyWhatJsxCodeIsGenerated.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SpecifyWhatJsxCodeIsGenerated Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SpecifyWhatJsxCodeIsGenerated Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SpecifyWhatJsxCodeIsGenerated>(_idx);
                }
                ...
                public bool TryGetKnownValue(out KnownValues result)
                {
                    ...
                    if (this.ValueEquals(Constants.Enum2))
                    {
                        result = KnownValues.React;
                        return true;
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        result = KnownValues.ReactJsx;
                        return true;
                    }

                    if (this.ValueEquals(Constants.Enum4))
                    {
                        result = KnownValues.ReactJsxdev;
                        return true;
                    }

                    if (this.ValueEquals(Constants.Enum5))
                    {
                        result = KnownValues.ReactNative;
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SpecifyWhatJsxCodeIsGenerated instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (SpecifyWhatJsxCodeIsGenerated)value;
            ...
            {
                return workspace.CreateBuilder<SpecifyWhatJsxCodeIsGenerated, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SpecifyWhatJsxCodeIsGenerated> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SpecifyWhatJsxCodeIsGenerated>();
                }
                finally
                {
