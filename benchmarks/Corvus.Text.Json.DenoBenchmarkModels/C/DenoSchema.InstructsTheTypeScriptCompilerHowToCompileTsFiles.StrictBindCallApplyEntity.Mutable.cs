    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
        ...
        public readonly partial struct StrictBindCallApplyEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<StrictBindCallApplyEntity, Mutable>(StrictBindCallApplyEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(StrictBindCallApplyEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="StrictBindCallApplyEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator StrictBindCallApplyEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"StrictBindCallApplyEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly StrictBindCallApplyEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly StrictBindCallApplyEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<StrictBindCallApplyEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(StrictBindCallApplyEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<StrictBindCallApplyEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<StrictBindCallApplyEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<StrictBindCallApplyEntity>();
                }
                finally
                {
