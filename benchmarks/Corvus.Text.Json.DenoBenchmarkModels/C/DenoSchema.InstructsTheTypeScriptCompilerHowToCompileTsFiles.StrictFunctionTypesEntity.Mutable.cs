...
public readonly partial struct DenoSchema
{
    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
        ...
        public readonly partial struct StrictFunctionTypesEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<StrictFunctionTypesEntity, Mutable>(StrictFunctionTypesEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(StrictFunctionTypesEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="StrictFunctionTypesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator StrictFunctionTypesEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new StrictFunctionTypesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"StrictFunctionTypesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="StrictFunctionTypesEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="StrictFunctionTypesEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly StrictFunctionTypesEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<StrictFunctionTypesEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="StrictFunctionTypesEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly StrictFunctionTypesEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<StrictFunctionTypesEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(StrictFunctionTypesEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<StrictFunctionTypesEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<StrictFunctionTypesEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<StrictFunctionTypesEntity>();
                }
                finally
                {
