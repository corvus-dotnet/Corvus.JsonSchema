...
public readonly partial struct DenoSchema
{
    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
        ...
        public readonly partial struct StrictPropertyInitializationEntity
#if NET8_0_OR_GREATER
            : IJsonElement<StrictPropertyInitializationEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="StrictPropertyInitializationEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal StrictPropertyInitializationEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static StrictPropertyInitializationEntity DefaultInstance { get; } = ParsedJsonDocument<StrictPropertyInitializationEntity>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(StrictPropertyInitializationEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in StrictPropertyInitializationEntity left, in StrictPropertyInitializationEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in StrictPropertyInitializationEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(StrictPropertyInitializationEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator StrictPropertyInitializationEntity(JsonElement instance)
            {
                return StrictPropertyInitializationEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StrictPropertyInitializationEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StrictPropertyInitializationEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<StrictPropertyInitializationEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StrictPropertyInitializationEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<StrictPropertyInitializationEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StrictPropertyInitializationEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<StrictPropertyInitializationEntity>(json, options);
            }
            ...
            /// </exception>
            public static StrictPropertyInitializationEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<StrictPropertyInitializationEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out StrictPropertyInitializationEntity? result)
            {
                return JsonElementHelpers.TryParseValue<StrictPropertyInitializationEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new StrictPropertyInitializationEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static StrictPropertyInitializationEntity IJsonElement<StrictPropertyInitializationEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"StrictPropertyInitializationEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="StrictPropertyInitializationEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="StrictPropertyInitializationEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public StrictPropertyInitializationEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<StrictPropertyInitializationEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="StrictPropertyInitializationEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public StrictPropertyInitializationEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<StrictPropertyInitializationEntity>(_idx);
                }
