    ...
    public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
    {
        ...
        public readonly partial struct WhenTypeCheckingTakeIntoAccountNullAndUndefined
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<WhenTypeCheckingTakeIntoAccountNullAndUndefined, Mutable>(WhenTypeCheckingTakeIntoAccountNullAndUndefined.DefaultInstance);
            ...
            public static ParsedJsonDocument<WhenTypeCheckingTakeIntoAccountNullAndUndefined> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<WhenTypeCheckingTakeIntoAccountNullAndUndefined>();
                }
                finally
                {
