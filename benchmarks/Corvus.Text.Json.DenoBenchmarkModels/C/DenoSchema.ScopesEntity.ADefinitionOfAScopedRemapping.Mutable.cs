...
public readonly partial struct DenoSchema
{
    ...
    public readonly partial struct ScopesEntity
    {
        ...
        public readonly partial struct ADefinitionOfAScopedRemapping
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ADefinitionOfAScopedRemapping instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ADefinitionOfAScopedRemapping"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ADefinitionOfAScopedRemapping(Mutable instance)
                {
                ...
                public Corvus.DenoBenchmark.Current.JsonString.Mutable this[ReadOnlySpan<byte> propertyName]
                {
                    get
                    {
                        CheckValidInstance();
                        if (!_parent.TryGetNamedPropertyValue(_idx, propertyName, out Corvus.DenoBenchmark.Current.JsonString.Mutable value))
                        {
                            return default;
                        }
                ...
                /// <returns>The value of the property with the given name.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public Corvus.DenoBenchmark.Current.JsonString.Mutable this[ReadOnlySpan<char> propertyName]
                {
                    get
                    {
                        CheckValidInstance();
                ...
                /// <returns>The value of the property with the given name.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public Corvus.DenoBenchmark.Current.JsonString.Mutable this[string propertyName]
                {
                    get
                    {
                        CheckValidInstance();
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.DenoBenchmark.Current.JsonString.Mutable value)
                {
                    CheckValidInstance();
                ...
                /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.DenoBenchmark.Current.JsonString.Mutable value)
                {
                    CheckValidInstance();
                    return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                }
                ...
                /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public bool TryGetProperty(string propertyName, out Corvus.DenoBenchmark.Current.JsonString.Mutable value)
                {
                    CheckValidInstance();
                    return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public ObjectEnumerator<Corvus.DenoBenchmark.Current.JsonString.Mutable> EnumerateObject()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateObjectEnumerator<Corvus.DenoBenchmark.Current.JsonString.Mutable>(_parent, _idx);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ADefinitionOfAScopedRemapping(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ADefinitionOfAScopedRemapping.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetProperty(string propertyName, scoped in Corvus.DenoBenchmark.Current.JsonString.Source value)
                {
                ...
                ///   </para>
                /// </remarks>
                public void SetProperty(ReadOnlySpan<char> propertyName, scoped in Corvus.DenoBenchmark.Current.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                ///   </para>
                /// </remarks>
                public void SetProperty(ReadOnlySpan<byte> propertyName, scoped in Corvus.DenoBenchmark.Current.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                /// <summary>
                /// Gets a <see cref="ADefinitionOfAScopedRemapping"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ADefinitionOfAScopedRemapping"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ADefinitionOfAScopedRemapping Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ADefinitionOfAScopedRemapping>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ADefinitionOfAScopedRemapping"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ADefinitionOfAScopedRemapping Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ADefinitionOfAScopedRemapping>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.DenoBenchmark.Current.DenoSchema.ScopesEntity.ADefinitionOfAScopedRemapping.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(ADefinitionOfAScopedRemapping instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.DenoBenchmark.Current.DenoSchema.ScopesEntity.ADefinitionOfAScopedRemapping.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                public void AddProperty(ReadOnlySpan<byte> propertyName, in Corvus.DenoBenchmark.Current.JsonString.Source value)
                {
                ...
                /// <param name="propertyName">The name of the property to add.</param>
                /// <param name="value">The value of the property to add.</param>
                public void AddProperty(ReadOnlySpan<char> propertyName, in Corvus.DenoBenchmark.Current.JsonString.Source value)
                {
                    value.AddAsProperty(propertyName, ref _builder);
                }
                ...
                /// <param name="propertyName">The name of the property to add.</param>
                /// <param name="value">The value of the property to add.</param>
                public void AddProperty(string propertyName, in Corvus.DenoBenchmark.Current.JsonString.Source value)
                {
                    value.AddAsProperty(propertyName, ref _builder);
                }
            ...
            {
                return workspace.CreateBuilder<ADefinitionOfAScopedRemapping, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ADefinitionOfAScopedRemapping> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ADefinitionOfAScopedRemapping>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ADefinitionOfAScopedRemapping> Create<TContext>(
