...
public readonly partial struct DenoSchema
{
    ...
    public readonly partial struct ScopesEntity
    {
        ...
        public readonly partial struct ADefinitionOfAScopedRemapping
            ...
            : IJsonElement<ADefinitionOfAScopedRemapping>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ADefinitionOfAScopedRemapping"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ADefinitionOfAScopedRemapping(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ADefinitionOfAScopedRemapping DefaultInstance { get; }
            ...
            public Corvus.DenoBenchmark.Current.JsonString this[ReadOnlySpan<byte> propertyName]
            {
                get
                {
                    CheckValidInstance();
                    if (!_parent.TryGetNamedPropertyValue(_idx, propertyName, out Corvus.DenoBenchmark.Current.JsonString value))
                    {
                        return default;
                    }
            ...
            /// <returns>The value of the property with the given name.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public Corvus.DenoBenchmark.Current.JsonString this[ReadOnlySpan<char> propertyName]
            {
                get
                {
                    CheckValidInstance();
            ...
            /// <returns>The value of the property with the given name.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public Corvus.DenoBenchmark.Current.JsonString this[string propertyName]
            {
                get
                {
                    CheckValidInstance();
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.DenoBenchmark.Current.JsonString value)
            {
                CheckValidInstance();
            ...
            /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.DenoBenchmark.Current.JsonString value)
            {
                CheckValidInstance();
                return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
            }
            ...
            /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(string propertyName, out Corvus.DenoBenchmark.Current.JsonString value)
            {
                CheckValidInstance();
                return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public ObjectEnumerator<Corvus.DenoBenchmark.Current.JsonString> EnumerateObject()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateObjectEnumerator<Corvus.DenoBenchmark.Current.JsonString>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in ADefinitionOfAScopedRemapping left, in ADefinitionOfAScopedRemapping right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ADefinitionOfAScopedRemapping left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(ADefinitionOfAScopedRemapping instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ADefinitionOfAScopedRemapping(JsonElement instance)
            {
                return ADefinitionOfAScopedRemapping.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ADefinitionOfAScopedRemapping From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ADefinitionOfAScopedRemapping ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ADefinitionOfAScopedRemapping>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ADefinitionOfAScopedRemapping ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ADefinitionOfAScopedRemapping>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ADefinitionOfAScopedRemapping ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ADefinitionOfAScopedRemapping>(json, options);
            }
            ...
            /// </exception>
            public static ADefinitionOfAScopedRemapping ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ADefinitionOfAScopedRemapping>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ADefinitionOfAScopedRemapping? result)
            {
                return JsonElementHelpers.TryParseValue<ADefinitionOfAScopedRemapping>(ref reader, out result);
            }
...
#if NET
            static ADefinitionOfAScopedRemapping IJsonElement<ADefinitionOfAScopedRemapping>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ADefinitionOfAScopedRemapping: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ADefinitionOfAScopedRemapping Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ADefinitionOfAScopedRemapping Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ADefinitionOfAScopedRemapping>(_idx);
                }
