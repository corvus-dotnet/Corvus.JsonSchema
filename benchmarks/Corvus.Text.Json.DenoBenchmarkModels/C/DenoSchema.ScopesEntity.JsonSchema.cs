...
public readonly partial struct DenoSchema
{
        ...
        : IJsonElement<ScopesEntity>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://deno.land/x/deno/cli/schemas/config-file.v1.json#/properties/scopes"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://deno.land/x/deno/cli/schemas/config-file.v1.json#/properties/scopes";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://deno.land/x/deno/cli/schemas/config-file.v1.json#/properties/scopes"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (objectValidation_enumerator.MoveNext())
                    {
                        ...
                        {
                            JsonSchemaContext childContext = Corvus.DenoBenchmark.Current.DenoSchema.ScopesEntity.ADefinitionOfAScopedRemapping.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                            ...
                            Corvus.DenoBenchmark.Current.DenoSchema.ScopesEntity.ADefinitionOfAScopedRemapping.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
