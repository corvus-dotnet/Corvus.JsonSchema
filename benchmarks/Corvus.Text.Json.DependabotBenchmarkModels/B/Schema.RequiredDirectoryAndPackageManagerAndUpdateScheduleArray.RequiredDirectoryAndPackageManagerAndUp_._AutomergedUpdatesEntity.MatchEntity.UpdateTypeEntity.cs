                ...
                public readonly partial struct AutomergedUpdatesEntity
                {
                    ...
                    public readonly partial struct MatchEntity
                    {
...
#endif
                        {
                            ...
                            /// <summary>
                            /// Initializes a new instance of the <see cref="UpdateTypeEntity"/> struct.
                            /// </summary>
                            /// <param name="value">The value from which to construct the instance.</param>
                            internal UpdateTypeEntity(IJsonDocument parent, int idx)
                            {
                                Debug.Assert(idx >= 0);
                                _parent = parent;
                                _idx = idx;
                            ...
                            /// </summary>
                            public static UpdateTypeEntity DefaultInstance { get; }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static explicit operator string(UpdateTypeEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                            ...
                            /// </returns>
                            public static bool operator ==(in UpdateTypeEntity left, in UpdateTypeEntity right)
                            {
                            ...
                            /// <c>True</c> if the values are equal.
                            /// </returns>
                            public static bool operator ==(in UpdateTypeEntity left, in JsonElement right)
                            {
                                return left.Equals(right);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator JsonElement(UpdateTypeEntity instance)
                            {
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator UpdateTypeEntity(JsonElement instance)
                            {
                                return UpdateTypeEntity.From(instance);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static UpdateTypeEntity From<T>(in T instance)
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static UpdateTypeEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<UpdateTypeEntity>(utf8Json, options);
                            }
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static UpdateTypeEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<UpdateTypeEntity>(json, options);
                            }
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static UpdateTypeEntity ParseValue(string json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<UpdateTypeEntity>(json, options);
                            }
                            ...
                            /// </exception>
                            public static UpdateTypeEntity ParseValue(ref Utf8JsonReader reader)
                            {
                                return JsonElementHelpers.ParseValue<UpdateTypeEntity>(ref reader);
                            }
                            ...
                            ///   A value could not be read from the reader.
                            /// </exception>
                            public static bool TryParseValue(ref Utf8JsonReader reader, out UpdateTypeEntity? result)
                            {
                                return JsonElementHelpers.TryParseValue<UpdateTypeEntity>(ref reader, out result);
                            }
                            ...
                            {
                                return
                                    (obj is IJsonElement value && Equals(new UpdateTypeEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                            static UpdateTypeEntity IJsonElement<UpdateTypeEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"UpdateTypeEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// <summary>
                            /// Gets a <see cref="UpdateTypeEntity"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </summary>
                            /// <returns>
                            /// A <see cref="UpdateTypeEntity"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </returns>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public UpdateTypeEntity Clone()
                            {
                                CheckValidInstance();
                                return _parent.CloneElement<UpdateTypeEntity>(_idx);
                            }
                            ...
                            /// </summary>
                            /// <returns>
                            /// An immutable <see cref="UpdateTypeEntity"/> that lives for the lifetime of its
                            ...
                            /// </para>
                            /// </remarks>
                            public UpdateTypeEntity Freeze()
                            {
                                CheckValidInstance();
                                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                {
                                    return mutable.FreezeElement<UpdateTypeEntity>(_idx);
                                }
                            ...
                            /// <param name="matchSecurityPatch">Match 1st item.</param>
                            /// <param name="matchSemverPatch">Match 2nd item.</param>
                            /// <param name="matchSemverMinor">Match 3rd item.</param>
                            /// <param name="matchInRange">Match 4th item.</param>
                            /// <param name="matchAll">Match 5th item.</param>
                            /// <param name="defaultMatch">Match any other value.</param>
                            /// <returns>An instance of the value returned by the match function.</returns>
                            public TResult Match<TContext, TResult>(
                                in TContext context,
                                Func<TContext, TResult> matchSecurityPatch,
                                Func<TContext, TResult> matchSemverPatch,
                                Func<TContext, TResult> matchSemverMinor,
                                Func<TContext, TResult> matchInRange,
...
#endif
                            {
                                ...
                                {
                                    return matchSecurityPatch(context);
                                }

                                if (this.ValueEquals(Constants.Enum2))
                                {
                                    return matchSemverPatch(context);
                                }

                                if (this.ValueEquals(Constants.Enum3))
                                {
                                    return matchSemverMinor(context);
                                }

                                if (this.ValueEquals(Constants.Enum4))
                                {
                                    return matchInRange(context);
                                }
                            ...
                            public TResult Match<TResult>(
                                Func<TResult> matchSecurityPatch,
                                Func<TResult> matchSemverPatch,
                                Func<TResult> matchSemverMinor,
                                Func<TResult> matchInRange,
                                Func<TResult> matchAll,
                                Func<TResult> defaultMatch)
                            {
                                if (this.ValueEquals(Constants.Enum1))
                                {
                                    return matchSecurityPatch();
                                }

                                if (this.ValueEquals(Constants.Enum2))
                                {
                                    return matchSemverPatch();
                                }

                                if (this.ValueEquals(Constants.Enum3))
                                {
                                    return matchSemverMinor();
                                }
