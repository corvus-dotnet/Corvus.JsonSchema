            ...
            public readonly partial struct AllowedUpdatesEntityArray
            {
                ...
                public readonly partial struct AllowedUpdatesEntity
                {
...
#endif
                    {
                        ...
                        /// <summary>
                        /// Initializes a new instance of the <see cref="MatchEntity"/> struct.
                        /// </summary>
                        /// <param name="value">The value from which to construct the instance.</param>
                        internal MatchEntity(IJsonDocument parent, int idx)
                        {
                            Debug.Assert(idx >= 0);
                            _parent = parent;
                            _idx = idx;
                        ...
                        /// </summary>
                        public static MatchEntity DefaultInstance { get; }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.DependabotBenchmark.Baseline.JsonString DependencyName
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DependencyNameUtf8, out Corvus.DependabotBenchmark.Baseline.JsonString value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.DependabotBenchmark.Baseline.JsonString DependencyType
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DependencyTypeUtf8, out Corvus.DependabotBenchmark.Baseline.JsonString value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.DependabotBenchmark.Baseline.Schema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.RequiredDirectoryAndPackageManagerAndUpdateSchedule.AllowedUpdatesEntityArray.AllowedUpdatesEntity.MatchEntity.WhichUpdatesToDo UpdateType
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UpdateTypeUtf8, out Corvus.DependabotBenchmark.Baseline.Schema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.RequiredDirectoryAndPackageManagerAndUpdateSchedule.AllowedUpdatesEntityArray.AllowedUpdatesEntity.MatchEntity.WhichUpdatesToDo value))
                                {
                                    return value;
                                }

                                return Corvus.DependabotBenchmark.Baseline.Schema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.RequiredDirectoryAndPackageManagerAndUpdateSchedule.AllowedUpdatesEntityArray.AllowedUpdatesEntity.MatchEntity.WhichUpdatesToDo.DefaultInstance;
                            }
                        }
                        ...
                        /// </returns>
                        public static bool operator ==(in MatchEntity left, in MatchEntity right)
                        {
                        ...
                        /// <c>True</c> if the values are equal.
                        /// </returns>
                        public static bool operator ==(in MatchEntity left, in JsonElement right)
                        {
                            return left.Equals(right);
                        }
                        ...
                        public static implicit operator JsonElement(MatchEntity instance)
                        {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator MatchEntity(JsonElement instance)
                        {
                            return MatchEntity.From(instance);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static MatchEntity From<T>(in T instance)
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static MatchEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<MatchEntity>(utf8Json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static MatchEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<MatchEntity>(json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static MatchEntity ParseValue(string json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<MatchEntity>(json, options);
                        }
                        ...
                        /// </exception>
                        public static MatchEntity ParseValue(ref Utf8JsonReader reader)
                        {
                            return JsonElementHelpers.ParseValue<MatchEntity>(ref reader);
                        }
                        ...
                        ///   A value could not be read from the reader.
                        /// </exception>
                        public static bool TryParseValue(ref Utf8JsonReader reader, out MatchEntity? result)
                        {
                            return JsonElementHelpers.TryParseValue<MatchEntity>(ref reader, out result);
                        }
...
#if NET
                        static MatchEntity IJsonElement<MatchEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"MatchEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        {
                            /// <summary>
                            /// Gets the JSON property name for <see cref="DependencyName"/>.
                            /// </summary>
                            public const string DependencyName = "dependency_name";

                            /// <summary>
                            /// Gets the JSON property name for <see cref="DependencyType"/>.
                            /// </summary>
                            public const string DependencyType = "dependency_type";

                            /// <summary>
                            /// Gets the JSON property name for <see cref="UpdateType"/>.
                            /// </summary>
                            ...
                            /// Gets the JSON property name for <see cref="DependencyName"/>.
                            /// </summary>
                            public static ReadOnlySpan<byte> DependencyNameUtf8 => "dependency_name"u8;

                            /// <summary>
                            /// Gets the JSON property name for <see cref="DependencyType"/>.
                            /// </summary>
                            public static ReadOnlySpan<byte> DependencyTypeUtf8 => "dependency_type"u8;

                            /// <summary>
                            /// Gets the JSON property name for <see cref="UpdateType"/>.
                            /// </summary>
                            public static ReadOnlySpan<byte> UpdateTypeUtf8 => "update_type"u8;
                        }
                        ...
                        {
                            /// <summary>
                            /// Gets the escaped UTF-8 JSON property name for <see cref="DependencyName"/>.
                            /// </summary>
                            public static ReadOnlySpan<byte> DependencyName => "dependency_name"u8;

                            /// <summary>
                            /// Gets the escaped UTF-8 JSON property name for <see cref="DependencyType"/>.
                            /// </summary>
                            public static ReadOnlySpan<byte> DependencyType => "dependency_type"u8;

                            /// <summary>
                            /// Gets the escaped UTF-8 JSON property name for <see cref="UpdateType"/>.
                            /// </summary>
