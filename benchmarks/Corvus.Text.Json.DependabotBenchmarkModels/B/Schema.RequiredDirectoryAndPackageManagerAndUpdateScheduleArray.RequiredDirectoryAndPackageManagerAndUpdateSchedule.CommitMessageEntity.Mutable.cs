        ...
        public readonly partial struct RequiredDirectoryAndPackageManagerAndUpdateSchedule
        {
            ...
            public readonly partial struct CommitMessageEntity
            {
...
#endif
                {
                    ...
                    /// </summary>
                    public Corvus.DependabotBenchmark.Baseline.JsonBoolean.Mutable IncludeScope
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeScopeUtf8, out Corvus.DependabotBenchmark.Baseline.JsonBoolean.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </summary>
                    public Corvus.DependabotBenchmark.Baseline.JsonString.Mutable Prefix
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrefixUtf8, out Corvus.DependabotBenchmark.Baseline.JsonString.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </summary>
                    public Corvus.DependabotBenchmark.Baseline.JsonString.Mutable PrefixDevelopment
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrefixDevelopmentUtf8, out Corvus.DependabotBenchmark.Baseline.JsonString.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetIncludeScope(in Corvus.DependabotBenchmark.Baseline.JsonBoolean.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetPrefix(in Corvus.DependabotBenchmark.Baseline.JsonString.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetPrefixDevelopment(in Corvus.DependabotBenchmark.Baseline.JsonString.Source value)
                    {
                        CheckValidInstance();
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.DependabotBenchmark.Baseline.Schema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.RequiredDirectoryAndPackageManagerAndUpdateSchedule.CommitMessageEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.DependabotBenchmark.Baseline.Schema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.RequiredDirectoryAndPackageManagerAndUpdateSchedule.CommitMessageEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.DependabotBenchmark.Baseline.JsonBoolean.Source includeScope = default,
                        in Corvus.DependabotBenchmark.Baseline.JsonString.Source prefix = default,
                        in Corvus.DependabotBenchmark.Baseline.JsonString.Source prefixDevelopment = default)
                    {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.DependabotBenchmark.Baseline.JsonBoolean.Source includeScope = default, in Corvus.DependabotBenchmark.Baseline.JsonString.Source prefix = default, in Corvus.DependabotBenchmark.Baseline.JsonString.Source prefixDevelopment = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
