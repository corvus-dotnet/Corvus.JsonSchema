    ...
    public readonly partial struct RequiredDirectoryAndPackageManagerAndUpdateScheduleArray
    {
        ...
        public readonly partial struct RequiredDirectoryAndPackageManagerAndUpdateSchedule
        {
...
#endif
            {
                ...
                /// </summary>
                public Corvus.DependabotBenchmark.Baseline.JsonBoolean IncludeScope
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeScopeUtf8, out Corvus.DependabotBenchmark.Baseline.JsonBoolean value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                public Corvus.DependabotBenchmark.Baseline.JsonString Prefix
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrefixUtf8, out Corvus.DependabotBenchmark.Baseline.JsonString value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                public Corvus.DependabotBenchmark.Baseline.JsonString PrefixDevelopment
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrefixDevelopmentUtf8, out Corvus.DependabotBenchmark.Baseline.JsonString value))
                        {
                            return value;
                        }
