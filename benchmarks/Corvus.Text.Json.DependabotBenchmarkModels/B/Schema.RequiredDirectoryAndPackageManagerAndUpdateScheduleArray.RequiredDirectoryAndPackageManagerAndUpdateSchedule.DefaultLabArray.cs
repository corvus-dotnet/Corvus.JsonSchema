    ...
    public readonly partial struct RequiredDirectoryAndPackageManagerAndUpdateScheduleArray
    {
        ...
        public readonly partial struct RequiredDirectoryAndPackageManagerAndUpdateSchedule
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="DefaultLabArray"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal DefaultLabArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static DefaultLabArray DefaultInstance { get; }
                ...
                /// </returns>
                public static bool operator ==(in DefaultLabArray left, in DefaultLabArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in DefaultLabArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(DefaultLabArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DefaultLabArray(JsonElement instance)
                {
                    return DefaultLabArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DefaultLabArray From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DefaultLabArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DefaultLabArray>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DefaultLabArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DefaultLabArray>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DefaultLabArray ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DefaultLabArray>(json, options);
                }
                ...
                /// </exception>
                public static DefaultLabArray ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<DefaultLabArray>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out DefaultLabArray? result)
                {
                    return JsonElementHelpers.TryParseValue<DefaultLabArray>(ref reader, out result);
                }
...
#if NET
                static DefaultLabArray IJsonElement<DefaultLabArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DefaultLabArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public DefaultLabArray Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<DefaultLabArray>(_idx);
                    }
