                ...
                public readonly partial struct IgnoredUpdatesEntity
                {
                    ...
                    public readonly partial struct MatchEntity
                    {
...
#endif
                        {
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.DependabotBenchmark.Baseline.JsonString.Mutable DependencyName
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DependencyNameUtf8, out Corvus.DependabotBenchmark.Baseline.JsonString.Mutable value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.DependabotBenchmark.Baseline.JsonString.Mutable VersionRequirement
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionRequirementUtf8, out Corvus.DependabotBenchmark.Baseline.JsonString.Mutable value))
                                    {
                                        return value;
                                    }
                            ...
                            public void SetDependencyName(in Corvus.DependabotBenchmark.Baseline.JsonString.Source value)
                            {
                                CheckValidInstance();
                                ...
                                else
                                {
                                    ...
                                    value.AddAsProperty(JsonPropertyNamesEscaped.DependencyName, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                            ...
                            /// </summary>
                            /// <param name="value">The value of the property to add.</param>
                            public void SetVersionRequirement(in Corvus.DependabotBenchmark.Baseline.JsonString.Source value)
                            {
                                CheckValidInstance();
                                ...
                                {
                                    // We are going to insert the new value
                                    value.AddAsProperty(JsonPropertyNamesEscaped.VersionRequirement, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                                }
                        ...
                        public ref struct Source
                        {
                            ...
                            internal Source(Corvus.DependabotBenchmark.Baseline.Schema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.RequiredDirectoryAndPackageManagerAndUpdateSchedule.IgnoredUpdatesEntityArray.IgnoredUpdatesEntity.MatchEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        public ref struct Builder
                        {
                            ...
                            internal static void Create(
                                ...
                                in Corvus.DependabotBenchmark.Baseline.JsonString.Source dependencyName = default,
                                in Corvus.DependabotBenchmark.Baseline.JsonString.Source versionRequirement = default)
                            {
                                dependencyName.AddAsProperty(JsonPropertyNamesEscaped.DependencyName, ref builder, escapeName: false);
                                versionRequirement.AddAsProperty(JsonPropertyNamesEscaped.VersionRequirement, ref builder, escapeName: false);
                            }

                            /// <summary>
                            /// Creates an instance of a <see cref="MatchEntity"/>.
                            /// </summary>
                            public void Create(in Corvus.DependabotBenchmark.Baseline.JsonString.Source dependencyName = default, in Corvus.DependabotBenchmark.Baseline.JsonString.Source versionRequirement = default)
                            {
                        ...
                        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.DependabotBenchmark.Baseline.JsonString.Source dependencyName = default, in Corvus.DependabotBenchmark.Baseline.JsonString.Source versionRequirement = default, int initialCapacity = 30)
                        {
                            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                            cvb.StartObject();
