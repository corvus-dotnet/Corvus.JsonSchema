            ...
            public readonly partial struct AutomergedUpdatesEntityArray
            {
                ...
                public readonly partial struct AutomergedUpdatesEntity
                {
...
#endif
                    {
                        ...
                        /// </summary>
                        public Corvus.DependabotBenchmark.Baseline.Schema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.RequiredDirectoryAndPackageManagerAndUpdateSchedule.AutomergedUpdatesEntityArray.AutomergedUpdatesEntity.MatchEntity.DependencyTypeEntity DependencyType
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DependencyTypeUtf8, out Corvus.DependabotBenchmark.Baseline.Schema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.RequiredDirectoryAndPackageManagerAndUpdateSchedule.AutomergedUpdatesEntityArray.AutomergedUpdatesEntity.MatchEntity.DependencyTypeEntity value))
                                {
                                    return value;
                                }
                        ...
                        /// </summary>
                        public Corvus.DependabotBenchmark.Baseline.Schema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.RequiredDirectoryAndPackageManagerAndUpdateSchedule.AutomergedUpdatesEntityArray.AutomergedUpdatesEntity.MatchEntity.UpdateTypeEntity UpdateType
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UpdateTypeUtf8, out Corvus.DependabotBenchmark.Baseline.Schema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.RequiredDirectoryAndPackageManagerAndUpdateSchedule.AutomergedUpdatesEntityArray.AutomergedUpdatesEntity.MatchEntity.UpdateTypeEntity value))
                                {
                                    return value;
                                }
