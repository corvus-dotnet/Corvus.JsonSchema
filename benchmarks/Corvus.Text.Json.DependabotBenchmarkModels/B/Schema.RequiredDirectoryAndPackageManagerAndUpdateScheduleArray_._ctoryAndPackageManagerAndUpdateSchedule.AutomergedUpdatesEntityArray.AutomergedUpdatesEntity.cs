        ...
        public readonly partial struct RequiredDirectoryAndPackageManagerAndUpdateSchedule
        {
            ...
            public readonly partial struct AutomergedUpdatesEntityArray
            {
                ...
                public readonly partial struct AutomergedUpdatesEntity
                    ...
                    : IJsonElement<AutomergedUpdatesEntity>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="AutomergedUpdatesEntity"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal AutomergedUpdatesEntity(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static AutomergedUpdatesEntity DefaultInstance { get; }
                    ...
                    /// </summary>
                    public Corvus.DependabotBenchmark.Baseline.Schema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.RequiredDirectoryAndPackageManagerAndUpdateSchedule.AutomergedUpdatesEntityArray.AutomergedUpdatesEntity.MatchEntity MatchValue
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MatchValueUtf8, out Corvus.DependabotBenchmark.Baseline.Schema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.RequiredDirectoryAndPackageManagerAndUpdateSchedule.AutomergedUpdatesEntityArray.AutomergedUpdatesEntity.MatchEntity value))
                            {
                                return value;
                            }
                    ...
                    /// </returns>
                    public static bool operator ==(in AutomergedUpdatesEntity left, in AutomergedUpdatesEntity right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in AutomergedUpdatesEntity left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(AutomergedUpdatesEntity instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AutomergedUpdatesEntity(JsonElement instance)
                    {
                        return AutomergedUpdatesEntity.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AutomergedUpdatesEntity From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AutomergedUpdatesEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<AutomergedUpdatesEntity>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AutomergedUpdatesEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<AutomergedUpdatesEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AutomergedUpdatesEntity ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<AutomergedUpdatesEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    public static AutomergedUpdatesEntity ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<AutomergedUpdatesEntity>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out AutomergedUpdatesEntity? result)
                    {
                        return JsonElementHelpers.TryParseValue<AutomergedUpdatesEntity>(ref reader, out result);
                    }
...
#if NET
                    static AutomergedUpdatesEntity IJsonElement<AutomergedUpdatesEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AutomergedUpdatesEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="AutomergedUpdatesEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="AutomergedUpdatesEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public AutomergedUpdatesEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<AutomergedUpdatesEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="AutomergedUpdatesEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public AutomergedUpdatesEntity Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<AutomergedUpdatesEntity>(_idx);
                        }
                    ...
                    {
                        /// <summary>
                        /// Gets the JSON property name for <see cref="MatchValue"/>.
                        /// </summary>
                        public const string MatchValue = "match";

                        /// <summary>
                        /// Gets the JSON property name for <see cref="MatchValue"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> MatchValueUtf8 => "match"u8;
                    }
                    ...
                    {
                        /// <summary>
                        /// Gets the escaped UTF-8 JSON property name for <see cref="MatchValue"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> MatchValue => "match"u8;
                    }
                }
            }
        }
