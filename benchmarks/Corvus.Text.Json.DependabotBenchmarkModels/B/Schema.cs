...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.DependabotBenchmark.Baseline.Schema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray UpdateConfigs
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UpdateConfigsUtf8, out Corvus.DependabotBenchmark.Baseline.Schema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.DependabotBenchmark.Baseline.Schema.VersionEntity Version
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.DependabotBenchmark.Baseline.Schema.VersionEntity value))
            {
                return value;
            }

            return Corvus.DependabotBenchmark.Baseline.Schema.VersionEntity.DefaultInstance;
        }
    }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="UpdateConfigs"/>.
        /// </summary>
        public const string UpdateConfigs = "update_configs";
        ...
        /// Gets the JSON property name for <see cref="UpdateConfigs"/>.
        /// </summary>
        public static ReadOnlySpan<byte> UpdateConfigsUtf8 => "update_configs"u8;
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="UpdateConfigs"/>.
        /// </summary>
        public static ReadOnlySpan<byte> UpdateConfigs => "update_configs"u8;
