    ...
    : IJsonElement<DependabotSchema>
{
    public static partial class JsonSchema
    {
        ...
        private static void MatchUpdateConfigs(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
