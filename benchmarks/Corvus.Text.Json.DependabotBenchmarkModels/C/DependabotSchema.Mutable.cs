...
public readonly partial struct DependabotSchema
{
...
#endif
    {
        ...
        public static explicit operator Mutable(DependabotSchema instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="DependabotSchema"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DependabotSchema(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.DependabotBenchmark.Current.DependabotSchema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.Mutable UpdateConfigs
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UpdateConfigsUtf8, out Corvus.DependabotBenchmark.Current.DependabotSchema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.DependabotBenchmark.Current.DependabotSchema.VersionEntity.Mutable Version
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.DependabotBenchmark.Current.DependabotSchema.VersionEntity.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new DependabotSchema(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetUpdateConfigs<TContext>(in Corvus.DependabotBenchmark.Current.DependabotSchema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.Source<TContext> value)
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DependabotSchema.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="DependabotSchema"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="DependabotSchema"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly DependabotSchema Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<DependabotSchema>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="DependabotSchema"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly DependabotSchema Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<DependabotSchema>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.DependabotBenchmark.Current.DependabotSchema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.Source _createArg1;
        private readonly Corvus.DependabotBenchmark.Current.DependabotSchema.VersionEntity.Source _createArg2;
        ...
        public static implicit operator Source(DependabotSchema instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.DependabotBenchmark.Current.DependabotSchema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.Source<TContext> _createArg1;
        private readonly Corvus.DependabotBenchmark.Current.DependabotSchema.VersionEntity.Source _createArg2;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="DependabotSchema"/>.
        /// </summary>
        ...
        /// Creates an instance of a <see cref="DependabotSchema"/>.
        /// </summary>
        public void Create(in Corvus.DependabotBenchmark.Current.DependabotSchema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.Source updateConfigs, in Corvus.DependabotBenchmark.Current.DependabotSchema.VersionEntity.Source version)
        {
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in Corvus.DependabotBenchmark.Current.DependabotSchema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.Source<TContext> updateConfigs,
            in Corvus.DependabotBenchmark.Current.DependabotSchema.VersionEntity.Source version)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    ...
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.DependabotBenchmark.Current.DependabotSchema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.Source<TContext> updateConfigs, scoped in Corvus.DependabotBenchmark.Current.DependabotSchema.VersionEntity.Source version)
        ...
        #endif
    {
        return new Source<TContext>(context, updateConfigs, version);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.DependabotBenchmark.Current.DependabotSchema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.Source updateConfigs, in Corvus.DependabotBenchmark.Current.DependabotSchema.VersionEntity.Source version, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.DependabotBenchmark.Current.DependabotSchema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.Source<TContext> updateConfigs, in Corvus.DependabotBenchmark.Current.DependabotSchema.VersionEntity.Source version, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    {
        return workspace.CreateBuilder<DependabotSchema, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<DependabotSchema> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<DependabotSchema>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<DependabotSchema> Create<TContext>(
    ...
    public static ParsedJsonDocument<DependabotSchema> Create(in Corvus.DependabotBenchmark.Current.DependabotSchema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.Source updateConfigs, in Corvus.DependabotBenchmark.Current.DependabotSchema.VersionEntity.Source version, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<DependabotSchema> Create<TContext>(in TContext context, in Corvus.DependabotBenchmark.Current.DependabotSchema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.Source<TContext> updateConfigs, in Corvus.DependabotBenchmark.Current.DependabotSchema.VersionEntity.Source version, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
