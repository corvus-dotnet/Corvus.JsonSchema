...
public readonly partial struct DependabotSchema
{
    ...
    public readonly partial struct RequiredDirectoryAndPackageManagerAndUpdateScheduleArray
    {
        ...
        public readonly partial struct RequiredDirectoryAndPackageManagerAndUpdateSchedule
        {
            ...
            public readonly partial struct HowOftenToCheckForUpdates
#if NET8_0_OR_GREATER
                : IJsonElement<HowOftenToCheckForUpdates>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="HowOftenToCheckForUpdates"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal HowOftenToCheckForUpdates(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static HowOftenToCheckForUpdates DefaultInstance { get; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(HowOftenToCheckForUpdates value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in HowOftenToCheckForUpdates left, in HowOftenToCheckForUpdates right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in HowOftenToCheckForUpdates left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(HowOftenToCheckForUpdates instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator HowOftenToCheckForUpdates(JsonElement instance)
                {
                    return HowOftenToCheckForUpdates.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static HowOftenToCheckForUpdates From<T>(in T instance)
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static HowOftenToCheckForUpdates ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<HowOftenToCheckForUpdates>(utf8Json, options);
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static HowOftenToCheckForUpdates ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<HowOftenToCheckForUpdates>(json, options);
                    #pragma warning restore CS0618
                }
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static HowOftenToCheckForUpdates ParseValue(string json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<HowOftenToCheckForUpdates>(json, options);
                    #pragma warning restore CS0618
                ...
                /// </exception>
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                public static HowOftenToCheckForUpdates ParseValue(ref Utf8JsonReader reader)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<HowOftenToCheckForUpdates>(ref reader);
                    #pragma warning restore CS0618
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out HowOftenToCheckForUpdates? result)
                {
                    return JsonElementHelpers.TryParseValue<HowOftenToCheckForUpdates>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new HowOftenToCheckForUpdates(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static HowOftenToCheckForUpdates IJsonElement<HowOftenToCheckForUpdates>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"HowOftenToCheckForUpdates: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="HowOftenToCheckForUpdates"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="HowOftenToCheckForUpdates"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public HowOftenToCheckForUpdates Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<HowOftenToCheckForUpdates>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="HowOftenToCheckForUpdates"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public HowOftenToCheckForUpdates Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<HowOftenToCheckForUpdates>(_idx);
                    }
                ...
                /// <param name="matchLive">Match 1st item.</param>
                /// <param name="matchDaily">Match 2nd item.</param>
                /// <param name="matchWeekly">Match 3rd item.</param>
                /// <param name="matchMonthly">Match 4th item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchLive,
                    Func<TContext, TResult> matchDaily,
                    Func<TContext, TResult> matchWeekly,
                    Func<TContext, TResult> matchMonthly,
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchLive,
                    Func<TResult> matchDaily,
                    Func<TResult> matchWeekly,
                    Func<TResult> matchMonthly,
