    ...
    public readonly partial struct RequiredDirectoryAndPackageManagerAndUpdateScheduleArray
    {
        ...
        public readonly partial struct RequiredDirectoryAndPackageManagerAndUpdateSchedule
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="VersionRequirementUpdatesEntity"/> struct.
                /// </summary>
                ...
                internal VersionRequirementUpdatesEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static VersionRequirementUpdatesEntity DefaultInstance { get; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(VersionRequirementUpdatesEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in VersionRequirementUpdatesEntity left, in VersionRequirementUpdatesEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in VersionRequirementUpdatesEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(VersionRequirementUpdatesEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator VersionRequirementUpdatesEntity(JsonElement instance)
                {
                    return VersionRequirementUpdatesEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static VersionRequirementUpdatesEntity From<T>(in T instance)
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static VersionRequirementUpdatesEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<VersionRequirementUpdatesEntity>(utf8Json, options);
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static VersionRequirementUpdatesEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<VersionRequirementUpdatesEntity>(json, options);
                    #pragma warning restore CS0618
                }
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static VersionRequirementUpdatesEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<VersionRequirementUpdatesEntity>(json, options);
                    #pragma warning restore CS0618
                ...
                /// </exception>
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                public static VersionRequirementUpdatesEntity ParseValue(ref Utf8JsonReader reader)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<VersionRequirementUpdatesEntity>(ref reader);
                    #pragma warning restore CS0618
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out VersionRequirementUpdatesEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<VersionRequirementUpdatesEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new VersionRequirementUpdatesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static VersionRequirementUpdatesEntity IJsonElement<VersionRequirementUpdatesEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"VersionRequirementUpdatesEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="VersionRequirementUpdatesEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="VersionRequirementUpdatesEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public VersionRequirementUpdatesEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<VersionRequirementUpdatesEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="VersionRequirementUpdatesEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public VersionRequirementUpdatesEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<VersionRequirementUpdatesEntity>(_idx);
                    }
                ...
                /// <param name="matchOff">Match 1st item.</param>
                /// <param name="matchAuto">Match 2nd item.</param>
                /// <param name="matchWidenRanges">Match 3rd item.</param>
                /// <param name="matchIncreaseVersions">Match 4th item.</param>
                /// <param name="matchIncreaseVersionsIfNecessary">Match 5th item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchOff,
                    Func<TContext, TResult> matchAuto,
                    Func<TContext, TResult> matchWidenRanges,
                    Func<TContext, TResult> matchIncreaseVersions,
                    Func<TContext, TResult> matchIncreaseVersionsIfNecessary,
...
#endif
                {
                    ...
                    {
                        return matchOff(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchAuto(context);
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchWidenRanges(context);
                    }

                    if (this.ValueEquals(Constants.Enum4))
                    {
                        return matchIncreaseVersions(context);
                    }

                    if (this.ValueEquals(Constants.Enum5))
                    {
                        return matchIncreaseVersionsIfNecessary(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchOff,
                    Func<TResult> matchAuto,
                    Func<TResult> matchWidenRanges,
                    Func<TResult> matchIncreaseVersions,
                    Func<TResult> matchIncreaseVersionsIfNecessary,
                    Func<TResult> defaultMatch)
                {
                    ...
                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchWidenRanges();
                    }

                    if (this.ValueEquals(Constants.Enum4))
                    {
                        return matchIncreaseVersions();
                    }

                    if (this.ValueEquals(Constants.Enum5))
                    {
                        return matchIncreaseVersionsIfNecessary();
                    }
