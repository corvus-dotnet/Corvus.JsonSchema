                    ...
                    public readonly partial struct MatchEntity
                    {
                        ...
                        public readonly partial struct DependencyTypeEntity
                        {
                            ...
                            public ref struct Source
                            {
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator Source(KnownValues value) => (DependencyTypeEntity)value;
                            ...
                            public static ParsedJsonDocument<DependencyTypeEntity> Create(
                                scoped in Source value, int initialCapacity = 1)
                            {
                                ...
                                try
                                {
                                    ...
                                    Debug.Assert(cvb.MemberCount == 1);
                                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                    return documentBuilder.ToParsedJsonDocument<DependencyTypeEntity>();
                                }
                                finally
                                {
