                    ...
                    public readonly partial struct MatchEntity
                    {
                        ...
                        public readonly partial struct UpdateTypeEntity
                        {
...
#endif
                            {
                                ...
                                public static explicit operator Mutable(UpdateTypeEntity instance)
                                {
                                ...
                                /// <returns>An immutable instance of a <see cref="UpdateTypeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator UpdateTypeEntity(Mutable instance)
                                {
                                ...
                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"UpdateTypeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly UpdateTypeEntity Clone()
                                {
                                    CheckValidInstance();
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly UpdateTypeEntity Freeze()
                                {
                                    CheckValidInstance();
                                    return _parent.FreezeElement<UpdateTypeEntity>(_idx);
                                }
                            ...
                            public ref struct Source
                            {
                                ...
                                public static implicit operator Source(UpdateTypeEntity instance) => new(JsonElement.From(instance));
                            ...
                            {
                                return workspace.CreateBuilder<UpdateTypeEntity, Mutable>(this);
                            }
                            ...
                            public static ParsedJsonDocument<UpdateTypeEntity> Create(
                                scoped in Source value, int initialCapacity = 1)
                            {
                                ...
                                try
                                {
                                    ...
                                    Debug.Assert(cvb.MemberCount == 1);
                                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                    return documentBuilder.ToParsedJsonDocument<UpdateTypeEntity>();
                                }
                                finally
                                {
