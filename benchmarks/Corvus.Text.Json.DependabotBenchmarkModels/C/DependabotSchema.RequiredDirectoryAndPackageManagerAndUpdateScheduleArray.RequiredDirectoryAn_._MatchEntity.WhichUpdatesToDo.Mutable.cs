                    ...
                    public readonly partial struct MatchEntity
                    {
                        ...
                        public readonly partial struct WhichUpdatesToDo
                        {
...
#endif
                            {
                                ...
                                /// </remarks>
                                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<WhichUpdatesToDo, Mutable>(WhichUpdatesToDo.DefaultInstance);
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly WhichUpdatesToDo Clone()
                                {
                                    CheckValidInstance();
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly WhichUpdatesToDo Freeze()
                                {
                                    CheckValidInstance();
                                    return _parent.FreezeElement<WhichUpdatesToDo>(_idx);
                                }
                            ...
                            public ref struct Source
                            {
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator Source(KnownValues value) => (WhichUpdatesToDo)value;
                            ...
                            public static ParsedJsonDocument<WhichUpdatesToDo> Create(
                                scoped in Source value, int initialCapacity = 1)
                            {
                                ...
                                try
                                {
                                    ...
                                    Debug.Assert(cvb.MemberCount == 1);
                                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                    return documentBuilder.ToParsedJsonDocument<WhichUpdatesToDo>();
                                }
                                finally
                                {
