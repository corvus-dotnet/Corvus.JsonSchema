                ...
                public readonly partial struct IgnoredUpdatesEntity
                {
                    ...
                    public readonly partial struct MatchEntity
                    {
...
#endif
                        {
                            ...
                            /// <summary>
                            /// Gets the (optional) <c>version_requirement</c> property.
                            /// </summary>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.DependabotBenchmark.Current.JsonString.Mutable VersionRequirement
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionRequirementUtf8, out Corvus.DependabotBenchmark.Current.JsonString.Mutable value))
                                    {
                                        return value;
                                    }
                            ...
                            public void SetDependencyName(scoped in Corvus.DependabotBenchmark.Current.JsonString.Source value)
                            {
                                CheckValidInstance();
                            ...
                            /// <summary>
                            /// Set the <c>version_requirement</c> property.
                            /// </summary>
                            /// <param name="value">The value of the property to add.</param>
                            public void SetVersionRequirement(scoped in Corvus.DependabotBenchmark.Current.JsonString.Source value)
                            {
                                CheckValidInstance();

                                if (value.IsUndefined)
                                {
                                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.VersionRequirementUtf8);
                                    _documentVersion = _parent.Version;
                                    return;
                                }

                                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionRequirementUtf8, out IJsonDocument? elementParent, out int elementIdx))
                                {
                                    // We are going to replace just the value
                                    value.AddAsItem(ref cvb);
                                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                                ...
                                {
                                    // We are going to insert the new value
                                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.VersionRequirement, ref cvb);
                                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                                }
                            ...
                            /// <summary>
                            /// Remove the <c>version_requirement</c> property, if present.
                            /// </summary>
                            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                            public bool RemoveVersionRequirement()
                            {
                                CheckValidInstance();
                                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.VersionRequirementUtf8);
                                _documentVersion = _parent.Version;
                                return result;
                            }
                        ...
                        public ref struct Source
                        {
                            ...
                            internal Source(Corvus.DependabotBenchmark.Current.DependabotSchema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.RequiredDirectoryAndPackageManagerAndUpdateSchedule.IgnoredUpdatesEntityArray.IgnoredUpdatesEntity.MatchEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                            internal Source(scoped in Corvus.DependabotBenchmark.Current.JsonString.Source arg1, scoped in Corvus.DependabotBenchmark.Current.JsonString.Source arg2)
                            {
                                _createArg1 = arg1;
                                _createArg2 = arg2;
                                _kind = Kind.Create;
                        ...
                        public ref struct Builder
                        {
                            ...
                            internal static void Create(
                                ...
                                in Corvus.DependabotBenchmark.Current.JsonString.Source versionRequirement = default)
                            {
                                dependencyName.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DependencyName, ref builder);
                                versionRequirement.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.VersionRequirement, ref builder);
                            }

                            /// <summary>
                            /// Creates an instance of a <see cref="MatchEntity"/>.
                            /// </summary>
                            public void Create(in Corvus.DependabotBenchmark.Current.JsonString.Source dependencyName = default, in Corvus.DependabotBenchmark.Current.JsonString.Source versionRequirement = default)
                            {
                                Create(ref _builder, dependencyName, versionRequirement);
                            }
                            ...
                            internal static void BuildCreateValue(scoped in Corvus.DependabotBenchmark.Current.JsonString.Source arg1, scoped in Corvus.DependabotBenchmark.Current.JsonString.Source arg2, ref ComplexValueBuilder o)
                            {
                                o.StartObject();
                        ...
                        /// <param name="versionRequirement">The value of the <c>"version_requirement"</c> property.</param>
                        /// <returns>The source from which to build the value.</returns>
                        public static Source Build(scoped in Corvus.DependabotBenchmark.Current.JsonString.Source dependencyName = default, scoped in Corvus.DependabotBenchmark.Current.JsonString.Source versionRequirement = default)
                        {
                            return new Source(dependencyName, versionRequirement);
                        }
                        ...
                        /// <param name="versionRequirement">The value of the property.</param>
                        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.DependabotBenchmark.Current.JsonString.Source dependencyName = default, in Corvus.DependabotBenchmark.Current.JsonString.Source versionRequirement = default, int initialCapacity = 30)
                        {
                            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                            cvb.StartObject();
                            Builder ovb = new(cvb);
                            ovb.Create(dependencyName, versionRequirement);
                            cvb = ovb._builder;
                            cvb.EndObject();
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder;
                        ...
                        public static ParsedJsonDocument<MatchEntity> Create(
                            scoped in Source value, int initialCapacity = 30)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<MatchEntity>();
                            }
                            finally
                            {
                        ...
                        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                        public static ParsedJsonDocument<MatchEntity> Create<TContext>(
                        ...
                        public static ParsedJsonDocument<MatchEntity> Create(in Corvus.DependabotBenchmark.Current.JsonString.Source dependencyName = default, in Corvus.DependabotBenchmark.Current.JsonString.Source versionRequirement = default, int initialCapacity = 30)
                        {
                            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                            try
                            {
