                ...
                public readonly partial struct AllowedUpdatesEntity
                {
                    ...
                    public readonly partial struct MatchEntity
                    {
...
#endif
                        {
                            ...
                            /// <summary>
                            /// Initializes a new instance of the <see cref="WhichUpdatesToDo"/> struct.
                            /// </summary>
                            /// <param name="value">The value from which to construct the instance.</param>
                            internal WhichUpdatesToDo(IJsonDocument parent, int idx)
                            {
                                Debug.Assert(idx >= 0);
                                _parent = parent;
                                _idx = idx;
                            ...
                            /// </summary>
                            public static WhichUpdatesToDo DefaultInstance { get; } = ParsedJsonDocument<WhichUpdatesToDo>.StringConstant([.."\"security\""u8]);
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static explicit operator string(WhichUpdatesToDo value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                            ...
                            /// </returns>
                            public static bool operator ==(in WhichUpdatesToDo left, in WhichUpdatesToDo right)
                            {
                            ...
                            /// <c>True</c> if the values are equal.
                            /// </returns>
                            public static bool operator ==(in WhichUpdatesToDo left, in JsonElement right)
                            {
                                return left.Equals(right);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator JsonElement(WhichUpdatesToDo instance)
                            {
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator WhichUpdatesToDo(JsonElement instance)
                            {
                                return WhichUpdatesToDo.From(instance);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static WhichUpdatesToDo From<T>(in T instance)
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static WhichUpdatesToDo ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<WhichUpdatesToDo>(utf8Json, options);
                            }
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static WhichUpdatesToDo ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<WhichUpdatesToDo>(json, options);
                            }
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static WhichUpdatesToDo ParseValue(string json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<WhichUpdatesToDo>(json, options);
                            }
                            ...
                            /// </exception>
                            public static WhichUpdatesToDo ParseValue(ref Utf8JsonReader reader)
                            {
                                return JsonElementHelpers.ParseValue<WhichUpdatesToDo>(ref reader);
                            }
                            ...
                            ///   A value could not be read from the reader.
                            /// </exception>
                            public static bool TryParseValue(ref Utf8JsonReader reader, out WhichUpdatesToDo? result)
                            {
                                return JsonElementHelpers.TryParseValue<WhichUpdatesToDo>(ref reader, out result);
                            }
...
#if NET
                            static WhichUpdatesToDo IJsonElement<WhichUpdatesToDo>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"WhichUpdatesToDo: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// <summary>
                            /// Gets a <see cref="WhichUpdatesToDo"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </summary>
                            /// <returns>
                            /// A <see cref="WhichUpdatesToDo"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </returns>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public WhichUpdatesToDo Clone()
                            {
                                CheckValidInstance();
                                return _parent.CloneElement<WhichUpdatesToDo>(_idx);
                            }
                            ...
                            /// </summary>
                            /// <returns>
                            /// An immutable <see cref="WhichUpdatesToDo"/> that lives for the lifetime of its
                            ...
                            /// </para>
                            /// </remarks>
                            public WhichUpdatesToDo Freeze()
                            {
                                CheckValidInstance();
                                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                {
                                    return mutable.FreezeElement<WhichUpdatesToDo>(_idx);
                                }
