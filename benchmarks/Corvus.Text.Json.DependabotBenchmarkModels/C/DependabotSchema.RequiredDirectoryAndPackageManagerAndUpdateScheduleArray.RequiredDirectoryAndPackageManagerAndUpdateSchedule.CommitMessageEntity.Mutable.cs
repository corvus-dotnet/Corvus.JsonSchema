        ...
        public readonly partial struct RequiredDirectoryAndPackageManagerAndUpdateSchedule
        {
            ...
            public readonly partial struct CommitMessageEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(CommitMessageEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="CommitMessageEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator CommitMessageEntity(Mutable instance)
                    {
                    ...
                    /// <summary>
                    /// Gets the (optional) <c>include_scope</c> property.
                    /// </summary>
                    public Corvus.DependabotBenchmark.Current.JsonBoolean.Mutable IncludeScope
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeScopeUtf8, out Corvus.DependabotBenchmark.Current.JsonBoolean.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </summary>
                    public Corvus.DependabotBenchmark.Current.JsonString.Mutable Prefix
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrefixUtf8, out Corvus.DependabotBenchmark.Current.JsonString.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// <summary>
                    /// Gets the (optional) <c>prefix_development</c> property.
                    /// </summary>
                    public Corvus.DependabotBenchmark.Current.JsonString.Mutable PrefixDevelopment
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrefixDevelopmentUtf8, out Corvus.DependabotBenchmark.Current.JsonString.Mutable value))
                            {
                                return value;
                            }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new CommitMessageEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    /// <summary>
                    /// Set the <c>include_scope</c> property.
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetIncludeScope(in Corvus.DependabotBenchmark.Current.JsonBoolean.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.IncludeScopeUtf8);
                            _documentVersion = _parent.Version;
                            return;
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeScopeUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                        ...
                        else
                        {
                            ...
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.IncludeScope, ref cvb);
                    ...
                    /// <summary>
                    /// Remove the <c>include_scope</c> property, if present.
                    /// </summary>
                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                    public bool RemoveIncludeScope()
                    {
                        CheckValidInstance();
                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.IncludeScopeUtf8);
                        _documentVersion = _parent.Version;
                        return result;
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetPrefix(in Corvus.DependabotBenchmark.Current.JsonString.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// <summary>
                    /// Set the <c>prefix_development</c> property.
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetPrefixDevelopment(in Corvus.DependabotBenchmark.Current.JsonString.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PrefixDevelopmentUtf8);
                            _documentVersion = _parent.Version;
                            return;
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrefixDevelopmentUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                            // We are going to replace just the value
                            value.AddAsItem(ref cvb);
                            _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                        ...
                        {
                            // We are going to insert the new value
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.PrefixDevelopment, ref cvb);
                            int endIndex = _idx + _parent.GetDbSize(_idx, false);
                            _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                        }
                    ...
                    /// <summary>
                    /// Remove the <c>prefix_development</c> property, if present.
                    /// </summary>
                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                    public bool RemovePrefixDevelopment()
                    {
                        CheckValidInstance();
                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PrefixDevelopmentUtf8);
                        _documentVersion = _parent.Version;
                        return result;
                    }
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"CommitMessageEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="CommitMessageEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="CommitMessageEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly CommitMessageEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<CommitMessageEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="CommitMessageEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly CommitMessageEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<CommitMessageEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.DependabotBenchmark.Current.JsonBoolean.Source _createArg1;
                    private readonly Corvus.DependabotBenchmark.Current.JsonString.Source _createArg2;
                    private readonly Corvus.DependabotBenchmark.Current.JsonString.Source _createArg3;
                    ...
                    internal Source(Corvus.DependabotBenchmark.Current.DependabotSchema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.RequiredDirectoryAndPackageManagerAndUpdateSchedule.CommitMessageEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(in Corvus.DependabotBenchmark.Current.JsonBoolean.Source arg1, in Corvus.DependabotBenchmark.Current.JsonString.Source arg2, in Corvus.DependabotBenchmark.Current.JsonString.Source arg3)
                    {
                        _createArg1 = arg1;
                        _createArg2 = arg2;
                        _createArg3 = arg3;
                    ...
                    public static implicit operator Source(CommitMessageEntity instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.DependabotBenchmark.Current.DependabotSchema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.RequiredDirectoryAndPackageManagerAndUpdateSchedule.CommitMessageEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="CommitMessageEntity"/>.
                    /// </summary>
                    internal static void Create(
                        ref ComplexValueBuilder builder,
                        in Corvus.DependabotBenchmark.Current.JsonBoolean.Source includeScope = default,
                        in Corvus.DependabotBenchmark.Current.JsonString.Source prefix = default,
                        in Corvus.DependabotBenchmark.Current.JsonString.Source prefixDevelopment = default)
                    {
                        includeScope.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.IncludeScope, ref builder);
                        prefix.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Prefix, ref builder);
                        prefixDevelopment.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.PrefixDevelopment, ref builder);
                    }
                    ...
                    public void Create(
                        ...
                        in Corvus.DependabotBenchmark.Current.JsonString.Source prefixDevelopment = default)
                    {
                        Create(ref _builder, includeScope, prefix, prefixDevelopment);
                    }
                    ...
                    internal static void BuildCreateValue(in Corvus.DependabotBenchmark.Current.JsonBoolean.Source arg1, in Corvus.DependabotBenchmark.Current.JsonString.Source arg2, in Corvus.DependabotBenchmark.Current.JsonString.Source arg3, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                ...
                /// </summary>
                /// <param name="includeScope">The value of the <c>"include_scope"</c> property.</param>
                /// <param name="prefix">The value of the <c>"prefix"</c> property.</param>
                /// <param name="prefixDevelopment">The value of the <c>"prefix_development"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(in Corvus.DependabotBenchmark.Current.JsonBoolean.Source includeScope = default, in Corvus.DependabotBenchmark.Current.JsonString.Source prefix = default, in Corvus.DependabotBenchmark.Current.JsonString.Source prefixDevelopment = default)
                {
                    return new Source(includeScope, prefix, prefixDevelopment);
                }
                ...
                /// </summary>
                /// <param name="workspace">The JSON workspace.</param>
                /// <param name="includeScope">The value of the property.</param>
                /// <param name="prefix">The value of the property.</param>
                /// <param name="prefixDevelopment">The value of the property.</param>
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.DependabotBenchmark.Current.JsonBoolean.Source includeScope = default, in Corvus.DependabotBenchmark.Current.JsonString.Source prefix = default, in Corvus.DependabotBenchmark.Current.JsonString.Source prefixDevelopment = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(includeScope, prefix, prefixDevelopment);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<CommitMessageEntity, Mutable>(this);
                }
            }
        }
    }
