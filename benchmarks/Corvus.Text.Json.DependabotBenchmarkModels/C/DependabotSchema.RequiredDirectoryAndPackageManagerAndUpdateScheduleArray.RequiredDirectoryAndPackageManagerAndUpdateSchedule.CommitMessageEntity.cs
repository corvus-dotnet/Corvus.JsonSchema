    ...
    public readonly partial struct RequiredDirectoryAndPackageManagerAndUpdateScheduleArray
    {
        ...
        public readonly partial struct RequiredDirectoryAndPackageManagerAndUpdateSchedule
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="CommitMessageEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal CommitMessageEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static CommitMessageEntity DefaultInstance { get; }
                ...
                /// </summary>
                public Corvus.DependabotBenchmark.Current.JsonBoolean IncludeScope
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeScopeUtf8, out Corvus.DependabotBenchmark.Current.JsonBoolean value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                public Corvus.DependabotBenchmark.Current.JsonString Prefix
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrefixUtf8, out Corvus.DependabotBenchmark.Current.JsonString value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                public Corvus.DependabotBenchmark.Current.JsonString PrefixDevelopment
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrefixDevelopmentUtf8, out Corvus.DependabotBenchmark.Current.JsonString value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in CommitMessageEntity left, in CommitMessageEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in CommitMessageEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(CommitMessageEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CommitMessageEntity(JsonElement instance)
                {
                    return CommitMessageEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CommitMessageEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CommitMessageEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<CommitMessageEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CommitMessageEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<CommitMessageEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CommitMessageEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<CommitMessageEntity>(json, options);
                }
                ...
                /// </exception>
                public static CommitMessageEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<CommitMessageEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out CommitMessageEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<CommitMessageEntity>(ref reader, out result);
                }
...
#if NET
                static CommitMessageEntity IJsonElement<CommitMessageEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CommitMessageEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public CommitMessageEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public CommitMessageEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<CommitMessageEntity>(_idx);
                    }
                ...
                {
                    /// <summary>
                    /// Gets the JSON property name for <see cref="IncludeScope"/>.
                    /// </summary>
                    public const string IncludeScope = "include_scope";
                    ...
                    /// <summary>
                    /// Gets the JSON property name for <see cref="PrefixDevelopment"/>.
                    /// </summary>
                    public const string PrefixDevelopment = "prefix_development";

                    /// <summary>
                    /// Gets the JSON property name for <see cref="IncludeScope"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> IncludeScopeUtf8 => "include_scope"u8;
                    ...
                    /// Gets the JSON property name for <see cref="PrefixDevelopment"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> PrefixDevelopmentUtf8 => "prefix_development"u8;
                }
                ...
                {
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="IncludeScope"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> IncludeScope => "include_scope"u8;
                    ...
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="PrefixDevelopment"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> PrefixDevelopment => "prefix_development"u8;
                }
                ...
                {
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="IncludeScope"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> IncludeScope => [0xF5, 0x00, 0x00, 0x00, 0x22, 0x69, 0x6E, 0x63, 0x6C, 0x75, 0x64, 0x65, 0x5F, 0x73, 0x63, 0x6F, 0x70, 0x65, 0x22];
                    ...
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="PrefixDevelopment"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> PrefixDevelopment => [0x45, 0x01, 0x00, 0x00, 0x22, 0x70, 0x72, 0x65, 0x66, 0x69, 0x78, 0x5F, 0x64, 0x65, 0x76, 0x65, 0x6C, 0x6F, 0x70, 0x6D, 0x65, 0x6E, 0x74, 0x22];
                }
            }
        }
    }
