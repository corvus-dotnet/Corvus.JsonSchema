                    ...
                    public readonly partial struct MatchEntity
                    {
                        ...
                        public readonly partial struct WhichUpdatesToDo
                        {
...
#endif
                            {
                                ...
                                public static explicit operator Mutable(WhichUpdatesToDo instance)
                                {
                                ...
                                /// <returns>An immutable instance of a <see cref="WhichUpdatesToDo"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator WhichUpdatesToDo(Mutable instance)
                                {
                                ...
                                {
                                    return
                                        (obj is IJsonElement value && Equals(new WhichUpdatesToDo(value.ParentDocument, value.ParentDocumentIndex))) ||
                                ...
                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"WhichUpdatesToDo.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            public ref struct Source
                            {
                                ...
                                public static implicit operator Source(WhichUpdatesToDo instance) => new(JsonElement.From(instance));
                            ...
                            {
                                return workspace.CreateBuilder<WhichUpdatesToDo, Mutable>(this);
                            }
                        }
                    }
                }
