        ...
        public readonly partial struct RequiredDirectoryAndPackageManagerAndUpdateSchedule
        {
            ...
            public readonly partial struct VersionRequirementUpdatesEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(VersionRequirementUpdatesEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="VersionRequirementUpdatesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator VersionRequirementUpdatesEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"VersionRequirementUpdatesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly VersionRequirementUpdatesEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly VersionRequirementUpdatesEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<VersionRequirementUpdatesEntity>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(VersionRequirementUpdatesEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<VersionRequirementUpdatesEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<VersionRequirementUpdatesEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<VersionRequirementUpdatesEntity>();
                    }
                    finally
                    {
