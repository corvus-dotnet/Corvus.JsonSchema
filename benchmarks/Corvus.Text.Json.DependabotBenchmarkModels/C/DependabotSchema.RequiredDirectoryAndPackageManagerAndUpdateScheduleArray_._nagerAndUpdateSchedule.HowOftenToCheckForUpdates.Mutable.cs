        ...
        public readonly partial struct RequiredDirectoryAndPackageManagerAndUpdateSchedule
        {
            ...
            public readonly partial struct HowOftenToCheckForUpdates
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(HowOftenToCheckForUpdates instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="HowOftenToCheckForUpdates"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator HowOftenToCheckForUpdates(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"HowOftenToCheckForUpdates.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly HowOftenToCheckForUpdates Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly HowOftenToCheckForUpdates Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<HowOftenToCheckForUpdates>(_idx);
                    }
                    ...
                    public bool TryGetKnownValue(out KnownValues result)
                    {
                        if (this.ValueEquals(Constants.Enum1))
                        {
                            result = KnownValues.Live;
                            return true;
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            result = KnownValues.Daily;
                            return true;
                        }

                        if (this.ValueEquals(Constants.Enum3))
                        {
                            result = KnownValues.Weekly;
                            return true;
                        }

                        if (this.ValueEquals(Constants.Enum4))
                        {
                            result = KnownValues.Monthly;
                            return true;
                        }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(HowOftenToCheckForUpdates instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (HowOftenToCheckForUpdates)value;
                ...
                {
                    return workspace.CreateBuilder<HowOftenToCheckForUpdates, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<HowOftenToCheckForUpdates> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<HowOftenToCheckForUpdates>();
                    }
                    finally
                    {
