        ...
        public readonly partial struct RequiredDirectoryAndPackageManagerAndUpdateSchedule
        {
            ...
            public readonly partial struct CommitMessageEntity
            {
...
#endif
                {
                    ...
                    public void SetIncludeScope(scoped in Corvus.DependabotBenchmark.Current.JsonBoolean.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetPrefix(scoped in Corvus.DependabotBenchmark.Current.JsonString.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetPrefixDevelopment(scoped in Corvus.DependabotBenchmark.Current.JsonString.Source value)
                    {
                        CheckValidInstance();
                ...
                public ref struct Source
                {
                    ...
                    internal Source(scoped in Corvus.DependabotBenchmark.Current.JsonBoolean.Source arg1, scoped in Corvus.DependabotBenchmark.Current.JsonString.Source arg2, scoped in Corvus.DependabotBenchmark.Current.JsonString.Source arg3)
                    {
                        _createArg1 = arg1;
                        _createArg2 = arg2;
                        _createArg3 = arg3;
                ...
                public ref struct Builder
                {
                    ...
                    internal static void BuildCreateValue(scoped in Corvus.DependabotBenchmark.Current.JsonBoolean.Source arg1, scoped in Corvus.DependabotBenchmark.Current.JsonString.Source arg2, scoped in Corvus.DependabotBenchmark.Current.JsonString.Source arg3, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.DependabotBenchmark.Current.JsonBoolean.Source includeScope = default, scoped in Corvus.DependabotBenchmark.Current.JsonString.Source prefix = default, scoped in Corvus.DependabotBenchmark.Current.JsonString.Source prefixDevelopment = default)
                {
                ...
                public static ParsedJsonDocument<CommitMessageEntity> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<CommitMessageEntity>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<CommitMessageEntity> Create<TContext>(
                ...
                public static ParsedJsonDocument<CommitMessageEntity> Create(in Corvus.DependabotBenchmark.Current.JsonBoolean.Source includeScope = default, in Corvus.DependabotBenchmark.Current.JsonString.Source prefix = default, in Corvus.DependabotBenchmark.Current.JsonString.Source prefixDevelopment = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
