...
public readonly partial struct Schema
{
    ...
    public readonly partial struct AdditionalItemsEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(AdditionalItemsEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="AdditionalItemsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AdditionalItemsEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AdditionalItemsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly AdditionalItemsEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly AdditionalItemsEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<AdditionalItemsEntity>(_idx);
            }
            ...
            /// <param name="matchJsonBoolean">Match a <see cref="Corvus.Draft04Benchmark.Baseline.JsonBoolean"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.Draft04Benchmark.Baseline.JsonBoolean, TContext, TResult> matchJsonBoolean,
                Matcher<Corvus.Draft04Benchmark.Baseline.Schema, TContext, TResult> matchSchema,
                Matcher<Corvus.Draft04Benchmark.Baseline.Schema.AdditionalItemsEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                if (Corvus.Draft04Benchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonBoolean(Corvus.Draft04Benchmark.Baseline.JsonBoolean.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.Draft04Benchmark.Baseline.JsonBoolean, TResult> matchJsonBoolean,
                Matcher<Corvus.Draft04Benchmark.Baseline.Schema, TResult> matchSchema,
                Matcher<Corvus.Draft04Benchmark.Baseline.Schema.AdditionalItemsEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Draft04Benchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonBoolean(Corvus.Draft04Benchmark.Baseline.JsonBoolean.Mutable.From(this));
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Draft04Benchmark.Baseline.JsonBoolean" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsJsonBoolean(out Corvus.Draft04Benchmark.Baseline.JsonBoolean result)
            {
                if (Corvus.Draft04Benchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Draft04Benchmark.Baseline.JsonBoolean.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(AdditionalItemsEntity instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(bool value) => new (value);

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Draft04Benchmark.Baseline.JsonBoolean instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<AdditionalItemsEntity, Mutable>(this);
        }
    }
}
