...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public static explicit operator Corvus.Draft04Benchmark.Baseline.Schema(AdditionalPropertiesEntity value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AdditionalPropertiesEntity(Corvus.Draft04Benchmark.Baseline.Schema value)
        {
            return From(value);
        }
        ...
        public bool TryGetAsJsonBoolean(out Corvus.Draft04Benchmark.Baseline.JsonBoolean result)
        {
            ...
            {
                result = Corvus.Draft04Benchmark.Baseline.JsonBoolean.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Draft04Benchmark.Baseline.Schema.AdditionalPropertiesEntity, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.Draft04Benchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonBoolean(Corvus.Draft04Benchmark.Baseline.JsonBoolean.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Draft04Benchmark.Baseline.Schema.AdditionalPropertiesEntity, TResult> defaultMatch)
        {
            if (Corvus.Draft04Benchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonBoolean(Corvus.Draft04Benchmark.Baseline.JsonBoolean.From(this));
            }
