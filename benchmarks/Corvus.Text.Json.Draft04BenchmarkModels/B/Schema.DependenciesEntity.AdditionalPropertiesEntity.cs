...
public readonly partial struct Schema
{
    ...
    public readonly partial struct DependenciesEntity
    {
...
#endif
        {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Draft04Benchmark.Baseline.Schema.StringArray(AdditionalPropertiesEntity value)
            {
                return Corvus.Draft04Benchmark.Baseline.Schema.StringArray.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator AdditionalPropertiesEntity(Corvus.Draft04Benchmark.Baseline.Schema.StringArray value)
            {
                return From(value);
            }
            ...
            public bool TryGetAsStringArray(out Corvus.Draft04Benchmark.Baseline.Schema.StringArray result)
            {
                ...
                {
                    result = Corvus.Draft04Benchmark.Baseline.Schema.StringArray.From(this);
                    return true;
                }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Draft04Benchmark.Baseline.Schema.DependenciesEntity.AdditionalPropertiesEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                if (Corvus.Draft04Benchmark.Baseline.Schema.StringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchStringArray(Corvus.Draft04Benchmark.Baseline.Schema.StringArray.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Draft04Benchmark.Baseline.Schema.DependenciesEntity.AdditionalPropertiesEntity, TResult> defaultMatch)
            {
                if (Corvus.Draft04Benchmark.Baseline.Schema.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.Draft04Benchmark.Baseline.Schema.StringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchStringArray(Corvus.Draft04Benchmark.Baseline.Schema.StringArray.From(this));
                }
