...
public readonly partial struct Schema
{
    ...
    public readonly partial struct EnumArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(EnumArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EnumArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnumArray(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnumArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </para>
            /// </remarks>
            public readonly EnumArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly EnumArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EnumArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Draft04Benchmark.Baseline.Schema.EnumArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(EnumArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Draft04Benchmark.Baseline.Schema.EnumArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<EnumArray, Mutable>(this);
        }
    }
}
