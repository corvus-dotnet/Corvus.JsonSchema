...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        internal EnumArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static EnumArray DefaultInstance { get; }
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in EnumArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(EnumArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator EnumArray(JsonElement instance)
        {
            return EnumArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnumArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnumArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnumArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnumArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnumArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnumArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnumArray>(json, options);
        }
        ...
        /// </exception>
        public static EnumArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<EnumArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out EnumArray? result)
        {
            return JsonElementHelpers.TryParseValue<EnumArray>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new EnumArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static EnumArray IJsonElement<EnumArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"EnumArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="EnumArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="EnumArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public EnumArray Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<EnumArray>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="EnumArray"/> that lives for the lifetime of its
