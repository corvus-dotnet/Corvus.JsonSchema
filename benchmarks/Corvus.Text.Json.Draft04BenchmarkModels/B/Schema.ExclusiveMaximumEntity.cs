...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ExclusiveMaximumEntity
        ...
        : IJsonElement<ExclusiveMaximumEntity>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        internal ExclusiveMaximumEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ExclusiveMaximumEntity DefaultInstance { get; } = ParsedJsonDocument<ExclusiveMaximumEntity>.False;
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ExclusiveMaximumEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ExclusiveMaximumEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ExclusiveMaximumEntity(JsonElement instance)
        {
            return ExclusiveMaximumEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ExclusiveMaximumEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ExclusiveMaximumEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ExclusiveMaximumEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ExclusiveMaximumEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ExclusiveMaximumEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ExclusiveMaximumEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ExclusiveMaximumEntity>(json, options);
        }
        ...
        /// </exception>
        public static ExclusiveMaximumEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ExclusiveMaximumEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ExclusiveMaximumEntity? result)
        {
            return JsonElementHelpers.TryParseValue<ExclusiveMaximumEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ExclusiveMaximumEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ExclusiveMaximumEntity IJsonElement<ExclusiveMaximumEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ExclusiveMaximumEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ExclusiveMaximumEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ExclusiveMaximumEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ExclusiveMaximumEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ExclusiveMaximumEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ExclusiveMaximumEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ExclusiveMaximumEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ExclusiveMaximumEntity>(_idx);
            }
