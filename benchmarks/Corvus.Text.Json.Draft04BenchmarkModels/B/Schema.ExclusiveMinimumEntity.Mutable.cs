...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ExclusiveMinimumEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ExclusiveMinimumEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ExclusiveMinimumEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ExclusiveMinimumEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ExclusiveMinimumEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ExclusiveMinimumEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ExclusiveMinimumEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ExclusiveMinimumEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ExclusiveMinimumEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ExclusiveMinimumEntity, Mutable>(this);
        }
    }
}
