...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ItemsEntity
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray.Mutable(Mutable value)
            {
                return Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray.Mutable value)
            {
                return From(value);
            }
            ...
            /// <param name="matchSchemaArray">Match a <see cref="Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray, TContext, TResult> matchSchemaArray,
                Matcher<Corvus.Draft04Benchmark.Baseline.Schema.ItemsEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                ...
                if (Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchSchemaArray(Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray, TResult> matchSchemaArray,
                Matcher<Corvus.Draft04Benchmark.Baseline.Schema.ItemsEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Draft04Benchmark.Baseline.Schema.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchSchemaArray(Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray.Mutable.From(this));
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsSchemaArray(out Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray result)
            {
                if (Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Draft04Benchmark.Baseline.Schema.ItemsEntity.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Draft04Benchmark.Baseline.Schema.ItemsEntity.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }
