...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public static explicit operator Corvus.Draft04Benchmark.Baseline.Schema(ItemsEntity value)
        {
            return Corvus.Draft04Benchmark.Baseline.Schema.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ItemsEntity(Corvus.Draft04Benchmark.Baseline.Schema value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray(ItemsEntity value)
        {
            return Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ItemsEntity(Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray value)
        {
            return From(value);
        }
        ...
        public bool TryGetAsSchema(out Corvus.Draft04Benchmark.Baseline.Schema result)
        {
            ...
            {
                result = Corvus.Draft04Benchmark.Baseline.Schema.From(this);
                return true;
            }
        ...
        public bool TryGetAsSchemaArray(out Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray result)
        {
            ...
            {
                result = Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Draft04Benchmark.Baseline.Schema.ItemsEntity, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.Draft04Benchmark.Baseline.Schema.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchSchema(Corvus.Draft04Benchmark.Baseline.Schema.From(this), context);
            }

            if (Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchSchemaArray(Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Draft04Benchmark.Baseline.Schema.ItemsEntity, TResult> defaultMatch)
        {
            if (Corvus.Draft04Benchmark.Baseline.Schema.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchSchema(Corvus.Draft04Benchmark.Baseline.Schema.From(this));
            }

            if (Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchSchemaArray(Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray.From(this));
            }
