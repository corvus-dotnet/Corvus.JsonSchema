...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PositiveIntegerDefault0
    {
...
#endif
        {
            ...
            public static implicit operator Corvus.Draft04Benchmark.Baseline.Schema.PositiveInteger.Mutable(Mutable value)
            {
                return Corvus.Draft04Benchmark.Baseline.Schema.PositiveInteger.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Mutable(Corvus.Draft04Benchmark.Baseline.Schema.PositiveInteger.Mutable value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0.Mutable(Mutable value)
            {
                return Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Mutable(Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(PositiveIntegerDefault0 instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PositiveIntegerDefault0"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PositiveIntegerDefault0(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PositiveIntegerDefault0.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly PositiveIntegerDefault0 Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly PositiveIntegerDefault0 Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PositiveIntegerDefault0>(_idx);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchPositiveInteger(Corvus.Draft04Benchmark.Baseline.Schema.PositiveInteger.Mutable.From(this), context);
                }

                if (Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchDefaultValueType0(Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Draft04Benchmark.Baseline.Schema.PositiveInteger.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchPositiveInteger(Corvus.Draft04Benchmark.Baseline.Schema.PositiveInteger.Mutable.From(this));
                }

                if (Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchDefaultValueType0(Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0.Mutable.From(this));
                }
            ...
            public bool TryGetAsPositiveInteger(out Corvus.Draft04Benchmark.Baseline.Schema.PositiveInteger result)
            {
                if (Corvus.Draft04Benchmark.Baseline.Schema.PositiveInteger.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Draft04Benchmark.Baseline.Schema.PositiveInteger.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsDefaultValueType0(out Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0 result)
            {
                if (Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(PositiveIntegerDefault0 instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<PositiveIntegerDefault0, Mutable>(this);
        }
    }
}
