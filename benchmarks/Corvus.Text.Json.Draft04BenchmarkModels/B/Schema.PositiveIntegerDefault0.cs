...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.Draft04Benchmark.Baseline.Schema.PositiveInteger"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Corvus.Draft04Benchmark.Baseline.Schema.PositiveInteger(PositiveIntegerDefault0 value)
        {
            return Corvus.Draft04Benchmark.Baseline.Schema.PositiveInteger.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.Draft04Benchmark.Baseline.Schema.PositiveInteger"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator PositiveIntegerDefault0(Corvus.Draft04Benchmark.Baseline.Schema.PositiveInteger value)
        {
            return From(value);
        }

        /// <summary>
        /// Conversion to <see cref="Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0(PositiveIntegerDefault0 value)
        {
            return Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator PositiveIntegerDefault0(Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0 value)
        {
            return From(value);
        }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Draft04Benchmark.Baseline.Schema.PositiveInteger" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsPositiveInteger(out Corvus.Draft04Benchmark.Baseline.Schema.PositiveInteger result)
        {
            if (Corvus.Draft04Benchmark.Baseline.Schema.PositiveInteger.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Draft04Benchmark.Baseline.Schema.PositiveInteger.From(this);
                return true;
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsDefaultValueType0(out Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0 result)
        {
            if (Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0.From(this);
                return true;
            }
        ...
        /// <param name="matchPositiveInteger">Match a <see cref="Corvus.Draft04Benchmark.Baseline.Schema.PositiveInteger"/>.</param>
        /// <param name="matchDefaultValueType0">Match a <see cref="Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0"/>.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Matcher<Corvus.Draft04Benchmark.Baseline.Schema.PositiveInteger, TContext, TResult> matchPositiveInteger,
            Matcher<Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0, TContext, TResult> matchDefaultValueType0,
            Matcher<Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.Draft04Benchmark.Baseline.Schema.PositiveInteger.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchPositiveInteger(Corvus.Draft04Benchmark.Baseline.Schema.PositiveInteger.From(this), context);
            }

            if (Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchDefaultValueType0(Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            Matcher<Corvus.Draft04Benchmark.Baseline.Schema.PositiveInteger, TResult> matchPositiveInteger,
            Matcher<Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0, TResult> matchDefaultValueType0,
            Matcher<Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0, TResult> defaultMatch)
        {
            if (Corvus.Draft04Benchmark.Baseline.Schema.PositiveInteger.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchPositiveInteger(Corvus.Draft04Benchmark.Baseline.Schema.PositiveInteger.From(this));
            }

            if (Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchDefaultValueType0(Corvus.Draft04Benchmark.Baseline.Schema.PositiveIntegerDefault0.DefaultValueType0.From(this));
            }
