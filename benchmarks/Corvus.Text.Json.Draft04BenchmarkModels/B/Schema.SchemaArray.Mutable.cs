...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SchemaArray
    {
...
#endif
        {
            ...
            public Corvus.Draft04Benchmark.Baseline.Schema.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Draft04Benchmark.Baseline.Schema.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Draft04Benchmark.Baseline.Schema.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Draft04Benchmark.Baseline.Schema.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.Draft04Benchmark.Baseline.Schema.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.Draft04Benchmark.Baseline.Schema.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.Draft04Benchmark.Baseline.Schema.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.Draft04Benchmark.Baseline.Schema item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Draft04Benchmark.Baseline.Schema>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.Draft04Benchmark.Baseline.Schema> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Draft04Benchmark.Baseline.Schema>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.Draft04Benchmark.Baseline.Schema oldItem, in Corvus.Draft04Benchmark.Baseline.Schema.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Draft04Benchmark.Baseline.Schema>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.Draft04Benchmark.Baseline.Schema current = enumerator.Current;
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Draft04Benchmark.Baseline.Schema.SchemaArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
