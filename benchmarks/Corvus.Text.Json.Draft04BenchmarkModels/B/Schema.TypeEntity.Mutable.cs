...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TypeEntity
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes.Mutable(Mutable value)
            {
                return Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes.Mutable value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray.Mutable(Mutable value)
            {
                return Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray.Mutable value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                ...
                {
                    return matchSimpleTypes(Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes.Mutable.From(this), context);
                }

                if (Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchSimpleTypesArray(Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchSimpleTypes(Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes.Mutable.From(this));
                }

                if (Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchSimpleTypesArray(Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray.Mutable.From(this));
                }
            ...
            public bool TryGetAsSimpleTypes(out Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes result)
            {
                if (Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsSimpleTypesArray(out Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray result)
            {
                if (Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
