...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TypeEntity
    {
...
#endif
        {
            ...
            public Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes>(_parent, _idx);
            }
