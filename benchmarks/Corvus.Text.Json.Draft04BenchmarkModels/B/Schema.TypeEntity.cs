...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes(TypeEntity value)
        {
            return Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator TypeEntity(Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes value)
        {
            return From(value);
        }

        /// <summary>
        /// Conversion to <see cref="Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray(TypeEntity value)
        {
            return Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator TypeEntity(Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray value)
        {
            return From(value);
        }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsSimpleTypes(out Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes result)
        {
            if (Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes.From(this);
                return true;
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsSimpleTypesArray(out Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray result)
        {
            if (Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray.From(this);
                return true;
            }
        ...
        /// <param name="matchSimpleTypes">Match a <see cref="Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes"/>.</param>
        /// <param name="matchSimpleTypesArray">Match a <see cref="Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray"/>.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Matcher<Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes, TContext, TResult> matchSimpleTypes,
            Matcher<Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray, TContext, TResult> matchSimpleTypesArray,
            Matcher<Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchSimpleTypes(Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes.From(this), context);
            }

            if (Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchSimpleTypesArray(Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            Matcher<Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes, TResult> matchSimpleTypes,
            Matcher<Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray, TResult> matchSimpleTypesArray,
            Matcher<Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity, TResult> defaultMatch)
        {
            if (Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchSimpleTypes(Corvus.Draft04Benchmark.Baseline.Schema.SimpleTypes.From(this));
            }

            if (Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchSimpleTypesArray(Corvus.Draft04Benchmark.Baseline.Schema.TypeEntity.SimpleTypesArray.From(this));
            }
