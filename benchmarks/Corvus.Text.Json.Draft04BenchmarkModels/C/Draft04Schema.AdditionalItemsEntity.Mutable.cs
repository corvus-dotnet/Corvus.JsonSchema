...
public readonly partial struct Draft04Schema
{
    ...
    public readonly partial struct AdditionalItemsEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AdditionalItemsEntity, Mutable>(AdditionalItemsEntity.DefaultInstance);
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.AdditionalItemsEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchJsonBoolean(Corvus.Draft04Benchmark.Current.JsonBoolean.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.AdditionalItemsEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Draft04Benchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonBoolean(Corvus.Draft04Benchmark.Current.JsonBoolean.Mutable.From(this));
                }
            ...
            public bool TryGetAsJsonBoolean(out Corvus.Draft04Benchmark.Current.JsonBoolean.Mutable result)
            {
                if (Corvus.Draft04Benchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Draft04Benchmark.Current.JsonBoolean.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Draft04Benchmark.Current.JsonBoolean instance) => new(JsonElement.From(instance));
        ...
        public static ParsedJsonDocument<AdditionalItemsEntity> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<AdditionalItemsEntity>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<AdditionalItemsEntity> Create<TContext>(
