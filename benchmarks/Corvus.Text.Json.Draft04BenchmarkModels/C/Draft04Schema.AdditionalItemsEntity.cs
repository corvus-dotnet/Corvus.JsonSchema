...
public readonly partial struct Draft04Schema
{
...
#endif
    {
        ...
        internal AdditionalItemsEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        public static explicit operator Corvus.Draft04Benchmark.Current.Draft04Schema(AdditionalItemsEntity value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AdditionalItemsEntity(Corvus.Draft04Benchmark.Current.Draft04Schema value)
        {
            return From(value);
        }
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in AdditionalItemsEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(AdditionalItemsEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AdditionalItemsEntity(JsonElement instance)
        {
            return AdditionalItemsEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AdditionalItemsEntity From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AdditionalItemsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<AdditionalItemsEntity>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AdditionalItemsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<AdditionalItemsEntity>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AdditionalItemsEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<AdditionalItemsEntity>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static AdditionalItemsEntity ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<AdditionalItemsEntity>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out AdditionalItemsEntity? result)
        {
            return JsonElementHelpers.TryParseValue<AdditionalItemsEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AdditionalItemsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static AdditionalItemsEntity IJsonElement<AdditionalItemsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AdditionalItemsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AdditionalItemsEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AdditionalItemsEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public AdditionalItemsEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AdditionalItemsEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AdditionalItemsEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public AdditionalItemsEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<AdditionalItemsEntity>(_idx);
            }
        ...
        public bool TryGetAsJsonBoolean(out Corvus.Draft04Benchmark.Current.JsonBoolean result)
        {
            ...
            {
                result = Corvus.Draft04Benchmark.Current.JsonBoolean.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            in TContext context,
            Matcher<Corvus.Draft04Benchmark.Current.JsonBoolean, TContext, TResult> matchJsonBoolean,
            Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema, TContext, TResult> matchDraft04Schema,
            Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.AdditionalItemsEntity, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.Draft04Benchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonBoolean(Corvus.Draft04Benchmark.Current.JsonBoolean.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            Matcher<Corvus.Draft04Benchmark.Current.JsonBoolean, TResult> matchJsonBoolean,
            Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema, TResult> matchDraft04Schema,
            Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.AdditionalItemsEntity, TResult> defaultMatch)
        {
            if (Corvus.Draft04Benchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonBoolean(Corvus.Draft04Benchmark.Current.JsonBoolean.From(this));
            }
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.AdditionalItemsEntity, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
            ...
            {
                matched = true;
                accumulator = matchJsonBoolean(Corvus.Draft04Benchmark.Current.JsonBoolean.From(this), accumulator);
            }
