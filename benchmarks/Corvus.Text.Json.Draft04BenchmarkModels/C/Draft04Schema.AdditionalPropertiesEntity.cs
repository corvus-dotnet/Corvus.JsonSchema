...
public readonly partial struct Draft04Schema
{
...
#endif
    {
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.AdditionalPropertiesEntity, TContext, TResult> defaultMatch)
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.AdditionalPropertiesEntity, TResult> defaultMatch)
        {
            if (Corvus.Draft04Benchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
            {
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.AdditionalPropertiesEntity, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
