    ...
    public readonly partial struct DependenciesEntity
    {
        ...
        public readonly partial struct AdditionalPropertiesEntity
        {
...
#endif
            {
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray.Mutable(Mutable value)
                {
                    return Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray.Mutable value)
                {
                    return From(value);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.DependenciesEntity.AdditionalPropertiesEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    ...
                    {
                        return matchStringArray(Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.DependenciesEntity.AdditionalPropertiesEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Draft04Benchmark.Current.Draft04Schema.JsonSchema.Evaluate(_parent, _idx))
                    {
                    ...
                    if (Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchStringArray(Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray.Mutable.From(this));
                    }
                ...
                public TAccumulator MatchEvery<TAccumulator>(
                    ...
                    Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.DependenciesEntity.AdditionalPropertiesEntity.Mutable, TAccumulator, TAccumulator> defaultMatch)
                {
                    bool matched = false;
                    ...
                    {
                        matched = true;
                        accumulator = matchStringArray(Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray.Mutable.From(this), accumulator);
                    }
                ...
                public bool TryGetAsStringArray(out Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray.Mutable result)
                {
                    if (Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Draft04Benchmark.Current.Draft04Schema.DependenciesEntity.AdditionalPropertiesEntity.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Draft04Benchmark.Current.Draft04Schema.DependenciesEntity.AdditionalPropertiesEntity.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }
