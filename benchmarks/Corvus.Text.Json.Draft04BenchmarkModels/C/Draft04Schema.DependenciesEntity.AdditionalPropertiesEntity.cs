...
public readonly partial struct Draft04Schema
{
    ...
    public readonly partial struct DependenciesEntity
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.Draft04Benchmark.Current.Draft04Schema(AdditionalPropertiesEntity value)
            {
                return Corvus.Draft04Benchmark.Current.Draft04Schema.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator AdditionalPropertiesEntity(Corvus.Draft04Benchmark.Current.Draft04Schema value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator AdditionalPropertiesEntity(Corvus.Draft04Benchmark.Current.Draft04Schema.Mutable value)
            {
                return From(value);
            }

            /// <summary>
            /// Conversion to <see cref="Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray(AdditionalPropertiesEntity value)
            {
                return Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator AdditionalPropertiesEntity(Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray value)
            {
                return From(value);
            }

            /// <summary>
            /// Conversion from the <see cref="Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray"/> mutable view.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator AdditionalPropertiesEntity(Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray.Mutable value)
            {
                return From(value);
            }
            ...
            public bool TryGetAsDraft04Schema(out Corvus.Draft04Benchmark.Current.Draft04Schema result)
            {
                ...
                {
                    result = Corvus.Draft04Benchmark.Current.Draft04Schema.From(this);
                    return true;
                }
            ...
            public bool TryGetAsStringArray(out Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray result)
            {
                ...
                {
                    result = Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray.From(this);
                    return true;
                }
            ...
            /// <param name="matchStringArray">Match a <see cref="Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray, TContext, TResult> matchStringArray,
                Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.DependenciesEntity.AdditionalPropertiesEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                if (Corvus.Draft04Benchmark.Current.Draft04Schema.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchDraft04Schema(Corvus.Draft04Benchmark.Current.Draft04Schema.From(this), context);
                }

                if (Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchStringArray(Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray, TResult> matchStringArray,
                Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.DependenciesEntity.AdditionalPropertiesEntity, TResult> defaultMatch)
            {
                if (Corvus.Draft04Benchmark.Current.Draft04Schema.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchDraft04Schema(Corvus.Draft04Benchmark.Current.Draft04Schema.From(this));
                }

                if (Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchStringArray(Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray.From(this));
                }
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray, TAccumulator, TAccumulator> matchStringArray,
                Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.DependenciesEntity.AdditionalPropertiesEntity, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
                ...
                {
                    matched = true;
                    accumulator = matchDraft04Schema(Corvus.Draft04Benchmark.Current.Draft04Schema.From(this), accumulator);
                }

                if (Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    matched = true;
                    accumulator = matchStringArray(Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray.From(this), accumulator);
                }
