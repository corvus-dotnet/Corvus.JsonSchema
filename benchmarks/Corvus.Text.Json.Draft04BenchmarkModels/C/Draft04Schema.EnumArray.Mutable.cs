...
public readonly partial struct Draft04Schema
{
    ...
    public readonly partial struct EnumArray
    {
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Draft04Benchmark.Current.Draft04Schema.EnumArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Draft04Benchmark.Current.Draft04Schema.EnumArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public static ParsedJsonDocument<EnumArray> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EnumArray>();
            }
            finally
            {
