...
public readonly partial struct Draft04Schema
{
    ...
    public readonly partial struct ExclusiveMaximumEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ExclusiveMaximumEntity, Mutable>(ExclusiveMaximumEntity.DefaultInstance);
            ...
            public static explicit operator Mutable(ExclusiveMaximumEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ExclusiveMaximumEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ExclusiveMaximumEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ExclusiveMaximumEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ExclusiveMaximumEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ExclusiveMaximumEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ExclusiveMaximumEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ExclusiveMaximumEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ExclusiveMaximumEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ExclusiveMaximumEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ExclusiveMaximumEntity>();
            }
            finally
            {
