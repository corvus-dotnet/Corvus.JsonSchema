...
public readonly partial struct Draft04Schema
{
    ...
    public readonly partial struct ItemsEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ItemsEntity, Mutable>(ItemsEntity.DefaultInstance);
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.Draft04Benchmark.Current.Draft04Schema"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Draft04Benchmark.Current.Draft04Schema.Mutable(Mutable value)
            {
                return Corvus.Draft04Benchmark.Current.Draft04Schema.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Draft04Benchmark.Current.Draft04Schema"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Draft04Benchmark.Current.Draft04Schema.Mutable value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray.Mutable(Mutable value)
            {
                return Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray.Mutable value)
            {
                return From(value);
            }
            ...
            /// </remarks>
            public void Apply(in Corvus.Draft04Benchmark.Current.Draft04Schema value)
            {
                CheckValidInstance();
            ...
            /// <param name="matchSchemaArray">Match a <see cref="Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray"/>.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema, TContext, TResult> matchDraft04Schema,
                Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray, TContext, TResult> matchSchemaArray,
                Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.ItemsEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                ...
                {
                    return matchDraft04Schema(Corvus.Draft04Benchmark.Current.Draft04Schema.Mutable.From(this), context);
                }

                if (Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchSchemaArray(Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema, TResult> matchDraft04Schema,
                Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray, TResult> matchSchemaArray,
                Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.ItemsEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Draft04Benchmark.Current.Draft04Schema.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchDraft04Schema(Corvus.Draft04Benchmark.Current.Draft04Schema.Mutable.From(this));
                }

                if (Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchSchemaArray(Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray.Mutable.From(this));
                }
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray, TAccumulator, TAccumulator> matchSchemaArray,
                Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.ItemsEntity.Mutable, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
                ...
                {
                    matched = true;
                    accumulator = matchSchemaArray(Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray.Mutable.From(this), accumulator);
                }
            ...
            public bool TryGetAsDraft04Schema(out Corvus.Draft04Benchmark.Current.Draft04Schema.Mutable result)
            {
                if (Corvus.Draft04Benchmark.Current.Draft04Schema.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Draft04Benchmark.Current.Draft04Schema.Mutable.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsSchemaArray(out Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray.Mutable result)
            {
                if (Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Draft04Benchmark.Current.Draft04Schema.ItemsEntity.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }
            ...
            #endif
        {
            ...
            private readonly Corvus.Draft04Benchmark.Current.Draft04Schema.Builder.Build<TContext>? _draft04SchemaBuilderInstance;
            ...
            internal Source(scoped in TContext context, Corvus.Draft04Benchmark.Current.Draft04Schema.ItemsEntity.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }

            public Source(scoped in TContext context, Corvus.Draft04Benchmark.Current.Draft04Schema.Builder.Build<TContext> value) {_context = context; _draft04SchemaBuilderInstance = value; _kind = Kind.Draft04SchemaBuilder; }
            ...
            internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.ArrayBuilder:
                        ...
                        break;
                    case Kind.Draft04SchemaBuilder:
                        valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _draft04SchemaBuilderInstance!), static (in b, ref o) => Corvus.Draft04Benchmark.Current.Draft04Schema.Builder.BuildValue(b.Context, b.Build, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.ArrayBuilder:
                        ...
                        break;
                    case Kind.Draft04SchemaBuilder:
                        valueBuilder.AddItem(BuildWithContext.Create(_context, _draft04SchemaBuilderInstance!), static (in b, ref o) => Corvus.Draft04Benchmark.Current.Draft04Schema.Builder.BuildValue(b.Context, b.Build, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Corvus.Draft04Benchmark.Current.Draft04Schema.Source Build(
            scoped in Corvus.Draft04Benchmark.Current.Draft04Schema.Builder.Build buildValue, int initialCapacity = 1)
        {
            return new Corvus.Draft04Benchmark.Current.Draft04Schema.Source(buildValue);
        }
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Corvus.Draft04Benchmark.Current.Draft04Schema.Source<TContext> Build<TContext>(
            scoped in TContext context, scoped in Corvus.Draft04Benchmark.Current.Draft04Schema.Builder.Build<TContext> buildValue, int initialCapacity = 1)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Corvus.Draft04Benchmark.Current.Draft04Schema.Source<TContext>(context, buildValue);
        }
        ...
        /// <returns>An instance of a mutable document initialized with the given value.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(
            JsonWorkspace workspace, scoped in Corvus.Draft04Benchmark.Current.Draft04Schema.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        {
            // Create the document builder without a MetadataDb
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            var source = new Corvus.Draft04Benchmark.Current.Draft04Schema.Source(value);
        ...
        /// <returns>An instance of a mutable document initialized with the given value.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
            JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.Draft04Benchmark.Current.Draft04Schema.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            var source = new Corvus.Draft04Benchmark.Current.Draft04Schema.Source<TContext>(context, value);
            source.AddAsItem(ref cvb);
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        public static ParsedJsonDocument<ItemsEntity> CreateArray(
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>An empty <see cref="ParsedJsonDocument{T}"/>. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ItemsEntity> CreateObject(
            int initialCapacity = 30, int initialValueBufferSize = 8192)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
            try
        ...
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ItemsEntity> Create(
            scoped in Corvus.Draft04Benchmark.Current.Draft04Schema.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
            try
            {
        ...
        public static ParsedJsonDocument<ItemsEntity> Create<TContext>(
            scoped in TContext context, scoped in Corvus.Draft04Benchmark.Current.Draft04Schema.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
