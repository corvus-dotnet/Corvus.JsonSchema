...
public readonly partial struct Draft04Schema
{
...
#endif
    {
        ...
        public static explicit operator Corvus.Draft04Benchmark.Current.Draft04Schema(ItemsEntity value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ItemsEntity(Corvus.Draft04Benchmark.Current.Draft04Schema value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray(ItemsEntity value)
        {
            return Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray.From(value);
        }
        ...
        public bool TryGetAsSchemaArray(out Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray result)
        {
            ...
            {
                result = Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.ItemsEntity, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            if (Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchSchemaArray(Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.ItemsEntity, TResult> defaultMatch)
        {
            if (Corvus.Draft04Benchmark.Current.Draft04Schema.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            if (Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchSchemaArray(Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray.From(this));
            }
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.ItemsEntity, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
            ...
            {
                matched = true;
                accumulator = matchSchemaArray(Corvus.Draft04Benchmark.Current.Draft04Schema.SchemaArray.From(this), accumulator);
            }
