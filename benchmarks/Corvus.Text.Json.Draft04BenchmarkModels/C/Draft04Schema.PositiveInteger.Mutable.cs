...
public readonly partial struct Draft04Schema
{
    ...
    public readonly partial struct PositiveInteger
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PositiveInteger instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PositiveInteger"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PositiveInteger(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PositiveInteger(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PositiveInteger.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="PositiveInteger"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="PositiveInteger"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly PositiveInteger Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<PositiveInteger>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="PositiveInteger"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly PositiveInteger Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PositiveInteger>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(PositiveInteger instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<PositiveInteger, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<PositiveInteger> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<PositiveInteger>();
            }
            finally
            {
