...
public readonly partial struct Draft04Schema
{
    ...
    public readonly partial struct PositiveIntegerDefault0
    {
...
#endif
        {
            ...
            public static implicit operator Corvus.Draft04Benchmark.Current.Draft04Schema.PositiveInteger.Mutable(Mutable value)
            {
                return Corvus.Draft04Benchmark.Current.Draft04Schema.PositiveInteger.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Mutable(Corvus.Draft04Benchmark.Current.Draft04Schema.PositiveInteger.Mutable value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Corvus.Draft04Benchmark.Current.Draft04Schema.PositiveIntegerDefault0.DefaultValueType0.Mutable(Mutable value)
            {
                return Corvus.Draft04Benchmark.Current.Draft04Schema.PositiveIntegerDefault0.DefaultValueType0.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Mutable(Corvus.Draft04Benchmark.Current.Draft04Schema.PositiveIntegerDefault0.DefaultValueType0.Mutable value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.PositiveIntegerDefault0.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchPositiveInteger(Corvus.Draft04Benchmark.Current.Draft04Schema.PositiveInteger.Mutable.From(this), context);
                }
                ...
                {
                    return matchDefaultValueType0(Corvus.Draft04Benchmark.Current.Draft04Schema.PositiveIntegerDefault0.DefaultValueType0.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.PositiveIntegerDefault0.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Draft04Benchmark.Current.Draft04Schema.PositiveInteger.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchPositiveInteger(Corvus.Draft04Benchmark.Current.Draft04Schema.PositiveInteger.Mutable.From(this));
                }

                if (Corvus.Draft04Benchmark.Current.Draft04Schema.PositiveIntegerDefault0.DefaultValueType0.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchDefaultValueType0(Corvus.Draft04Benchmark.Current.Draft04Schema.PositiveIntegerDefault0.DefaultValueType0.Mutable.From(this));
                }
            ...
            public bool TryGetAsPositiveInteger(out Corvus.Draft04Benchmark.Current.Draft04Schema.PositiveInteger.Mutable result)
            {
                if (Corvus.Draft04Benchmark.Current.Draft04Schema.PositiveInteger.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Draft04Benchmark.Current.Draft04Schema.PositiveInteger.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsDefaultValueType0(out Corvus.Draft04Benchmark.Current.Draft04Schema.PositiveIntegerDefault0.DefaultValueType0.Mutable result)
            {
                if (Corvus.Draft04Benchmark.Current.Draft04Schema.PositiveIntegerDefault0.DefaultValueType0.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Draft04Benchmark.Current.Draft04Schema.PositiveIntegerDefault0.DefaultValueType0.Mutable.From(this);
                    return true;
                }
        ...
        public static ParsedJsonDocument<PositiveIntegerDefault0> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<PositiveIntegerDefault0>();
            }
            finally
            {
