...
public readonly partial struct Draft04Schema
{
...
#endif
    {
        ...
        public Corvus.Draft04Benchmark.Current.Draft04Schema this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Draft04Benchmark.Current.Draft04Schema>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Draft04Benchmark.Current.Draft04Schema> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Draft04Benchmark.Current.Draft04Schema>(_parent, _idx);
        }
