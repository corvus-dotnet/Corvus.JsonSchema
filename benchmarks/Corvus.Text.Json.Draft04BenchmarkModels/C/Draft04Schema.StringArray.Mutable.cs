...
public readonly partial struct Draft04Schema
{
    ...
    public readonly partial struct StringArray
    {
...
#endif
        {
            ...
            public Corvus.Draft04Benchmark.Current.JsonString.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Draft04Benchmark.Current.JsonString.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Draft04Benchmark.Current.JsonString.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Draft04Benchmark.Current.JsonString.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.Draft04Benchmark.Current.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, scoped in Corvus.Draft04Benchmark.Current.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(scoped in Corvus.Draft04Benchmark.Current.JsonString.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.Draft04Benchmark.Current.JsonString item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Draft04Benchmark.Current.JsonString>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.Draft04Benchmark.Current.JsonString> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Draft04Benchmark.Current.JsonString>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.Draft04Benchmark.Current.JsonString oldItem, in Corvus.Draft04Benchmark.Current.JsonString.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Draft04Benchmark.Current.JsonString>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.Draft04Benchmark.Current.JsonString current = enumerator.Current;
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Draft04Benchmark.Current.Draft04Schema.StringArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            public void AddItem(in Corvus.Draft04Benchmark.Current.JsonString.Source value)
            {
