...
public readonly partial struct Draft04Schema
{
    ...
    public readonly partial struct TypeEntity
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes.Mutable(Mutable value)
            {
                return Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes.Mutable value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.SimpleTypesArray.Mutable(Mutable value)
            {
                return Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.SimpleTypesArray.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.SimpleTypesArray"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.SimpleTypesArray.Mutable value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes, TContext, TResult> matchSimpleTypes,
                Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.SimpleTypesArray, TContext, TResult> matchSimpleTypesArray,
                Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                ...
                {
                    return matchSimpleTypes(Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes.Mutable.From(this), context);
                }

                if (Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.SimpleTypesArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchSimpleTypesArray(Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.SimpleTypesArray.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes, TResult> matchSimpleTypes,
                Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.SimpleTypesArray, TResult> matchSimpleTypesArray,
                Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchSimpleTypes(Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes.Mutable.From(this));
                }

                if (Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.SimpleTypesArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchSimpleTypesArray(Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.SimpleTypesArray.Mutable.From(this));
                }
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.Mutable, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
                ...
                {
                    matched = true;
                    accumulator = matchSimpleTypes(Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes.Mutable.From(this), accumulator);
                }

                if (Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.SimpleTypesArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    matched = true;
                    accumulator = matchSimpleTypesArray(Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.SimpleTypesArray.Mutable.From(this), accumulator);
                }
            ...
            public bool TryGetAsSimpleTypes(out Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes.Mutable result)
            {
                if (Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsSimpleTypesArray(out Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.SimpleTypesArray.Mutable result)
            {
                if (Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.SimpleTypesArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.SimpleTypesArray.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
