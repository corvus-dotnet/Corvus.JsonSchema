    ...
    public readonly partial struct TypeEntity
    {
        ...
        public readonly partial struct SimpleTypesArray
        {
...
#endif
            {
                ...
                public Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes.Mutable>(_parent, _idx);
                }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, scoped in Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(scoped in Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes oldItem, in Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes current = enumerator.Current;
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.SimpleTypesArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.SimpleTypesArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                public void AddItem(in Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes.Source value)
                {
