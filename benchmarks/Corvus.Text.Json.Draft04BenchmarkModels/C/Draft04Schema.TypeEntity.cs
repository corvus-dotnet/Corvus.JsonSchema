...
public readonly partial struct Draft04Schema
{
...
#endif
    {
        ...
        public static explicit operator Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes(TypeEntity value)
        {
            return Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator TypeEntity(Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.SimpleTypesArray(TypeEntity value)
        {
            return Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.SimpleTypesArray.From(value);
        }
        ...
        public bool TryGetAsSimpleTypes(out Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes result)
        {
            ...
            {
                result = Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes.From(this);
                return true;
            }
        ...
        public bool TryGetAsSimpleTypesArray(out Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.SimpleTypesArray result)
        {
            ...
            {
                result = Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.SimpleTypesArray.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchSimpleTypes(Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes.From(this), context);
            }

            if (Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.SimpleTypesArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchSimpleTypesArray(Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.SimpleTypesArray.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity, TResult> defaultMatch)
        {
            if (Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchSimpleTypes(Corvus.Draft04Benchmark.Current.Draft04Schema.SimpleTypes.From(this));
            }

            if (Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.SimpleTypesArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchSimpleTypesArray(Corvus.Draft04Benchmark.Current.Draft04Schema.TypeEntity.SimpleTypesArray.From(this));
            }
