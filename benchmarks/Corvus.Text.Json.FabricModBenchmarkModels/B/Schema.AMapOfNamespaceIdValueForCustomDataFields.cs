...
public readonly partial struct Schema
{
    ...
    public readonly partial struct AMapOfNamespaceIdValueForCustomDataFields
#if NET8_0_OR_GREATER
        : IJsonElement<AMapOfNamespaceIdValueForCustomDataFields>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AMapOfNamespaceIdValueForCustomDataFields"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal AMapOfNamespaceIdValueForCustomDataFields(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static AMapOfNamespaceIdValueForCustomDataFields DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in AMapOfNamespaceIdValueForCustomDataFields left, in AMapOfNamespaceIdValueForCustomDataFields right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in AMapOfNamespaceIdValueForCustomDataFields left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(AMapOfNamespaceIdValueForCustomDataFields instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AMapOfNamespaceIdValueForCustomDataFields(JsonElement instance)
        {
            return AMapOfNamespaceIdValueForCustomDataFields.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AMapOfNamespaceIdValueForCustomDataFields From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AMapOfNamespaceIdValueForCustomDataFields ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AMapOfNamespaceIdValueForCustomDataFields>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AMapOfNamespaceIdValueForCustomDataFields ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AMapOfNamespaceIdValueForCustomDataFields>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AMapOfNamespaceIdValueForCustomDataFields ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AMapOfNamespaceIdValueForCustomDataFields>(json, options);
        }
        ...
        /// </exception>
        public static AMapOfNamespaceIdValueForCustomDataFields ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<AMapOfNamespaceIdValueForCustomDataFields>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out AMapOfNamespaceIdValueForCustomDataFields? result)
        {
            return JsonElementHelpers.TryParseValue<AMapOfNamespaceIdValueForCustomDataFields>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AMapOfNamespaceIdValueForCustomDataFields(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static AMapOfNamespaceIdValueForCustomDataFields IJsonElement<AMapOfNamespaceIdValueForCustomDataFields>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AMapOfNamespaceIdValueForCustomDataFields: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AMapOfNamespaceIdValueForCustomDataFields"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AMapOfNamespaceIdValueForCustomDataFields"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public AMapOfNamespaceIdValueForCustomDataFields Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AMapOfNamespaceIdValueForCustomDataFields>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AMapOfNamespaceIdValueForCustomDataFields"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public AMapOfNamespaceIdValueForCustomDataFields Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<AMapOfNamespaceIdValueForCustomDataFields>(_idx);
            }
