...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ContriArray
    {
...
#endif
        {
            ...
            public Corvus.FabricModBenchmark.Baseline.Schema.Person.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.FabricModBenchmark.Baseline.Schema.Person.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.FabricModBenchmark.Baseline.Schema.Person.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.FabricModBenchmark.Baseline.Schema.Person.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.FabricModBenchmark.Baseline.Schema.Person.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.FabricModBenchmark.Baseline.Schema.Person.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.FabricModBenchmark.Baseline.Schema.Person.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.FabricModBenchmark.Baseline.Schema.Person item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.FabricModBenchmark.Baseline.Schema.Person>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.FabricModBenchmark.Baseline.Schema.Person> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.FabricModBenchmark.Baseline.Schema.Person>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.FabricModBenchmark.Baseline.Schema.Person oldItem, in Corvus.FabricModBenchmark.Baseline.Schema.Person.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.FabricModBenchmark.Baseline.Schema.Person>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.FabricModBenchmark.Baseline.Schema.Person current = enumerator.Current;
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.FabricModBenchmark.Baseline.Schema.ContriArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.FabricModBenchmark.Baseline.Schema.ContriArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
