...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Entrypoint
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Mutable(Mutable value)
            {
                return Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Mutable value)
            {
                return From(value);
            }
            ...
            /// </remarks>
            public void Apply(in Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue value)
            {
                CheckValidInstance();
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchRequiredValue(Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.Mutable, TResult> defaultMatch)
            {
                if (Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchRequiredValue(Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Mutable.From(this));
                }
            ...
            public bool TryGetAsRequiredValue(out Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue result)
            {
                if (Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Builder.Build? _requiredValueBuilderInstance;
            ...
            public Source(Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Builder.Build value) {_requiredValueBuilderInstance = value; _kind = Kind.RequiredValueBuilder; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue instance) => new(JsonElement.From(instance));
            ...
            internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
            {
                switch(_kind)
                {
                    ...
                    case Kind.RequiredValueBuilder:
                        valueBuilder.AddProperty(utf8Name, _requiredValueBuilderInstance!, static (in b, ref o) => Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Builder.BuildValue(b, ref o), escapeName, nameRequiresUnescaping);
                        break;
                    default:
            ...
            internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Utf16String:
                        ...
                        break;
                    case Kind.RequiredValueBuilder:
                        valueBuilder.AddProperty(name, _requiredValueBuilderInstance!, static (in b, ref o) => Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Builder.BuildValue(b, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Utf16String:
                        ...
                        break;
                    case Kind.RequiredValueBuilder:
                        valueBuilder.AddItem(_requiredValueBuilderInstance!, static (in b, ref o) => Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Builder.BuildValue(b, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            #endif
        {
            ...
            TContext _context;
            Source _source;
            private readonly Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Builder.Build<TContext>? _requiredValueBuilderInstance;
            ...
            public Source(scoped in TContext context, Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Builder.Build<TContext> value) {_context = context; _requiredValueBuilderInstance = value; _kind = Kind.RequiredValueBuilder; }
            ...
            internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.RequiredValueBuilder:
                        valueBuilder.AddProperty(utf8Name, BuildWithContext.Create(_context, _requiredValueBuilderInstance!), static (in b, ref o) => Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Builder.BuildValue(b.Context, b.Build, ref o), escapeName, nameRequiresUnescaping);
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.RequiredValueBuilder:
                        valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _requiredValueBuilderInstance!), static (in b, ref o) => Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Builder.BuildValue(b.Context, b.Build, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.RequiredValueBuilder:
                        valueBuilder.AddItem(BuildWithContext.Create(_context, _requiredValueBuilderInstance!), static (in b, ref o) => Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Builder.BuildValue(b.Context, b.Build, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
        ...
        public static Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Source Build(
            scoped in Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Builder.Build buildValue, int initialCapacity = 1)
        {
            return new Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Source(buildValue);
        }
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Source<TContext> Build<TContext>(
            scoped in TContext context, scoped in Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Builder.Build<TContext> buildValue, int initialCapacity = 1)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Source<TContext>(context, buildValue);
        }
        ...
        /// <returns>An instance of a mutable document initialized with the given value.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(
            JsonWorkspace workspace, scoped in Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        {
            // Create the document builder without a MetadataDb
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            var source = new Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Source(value);
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
            JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            var source = new Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Source<TContext>(context, value);
            source.AddAsItem(ref cvb);
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
