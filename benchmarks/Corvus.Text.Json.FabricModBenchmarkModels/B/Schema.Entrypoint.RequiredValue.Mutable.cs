    ...
    public readonly partial struct Entrypoint
    {
        ...
        public readonly partial struct RequiredValue
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.TheLanguageAdapterToUse.Mutable Adapter
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AdapterUtf8, out Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.TheLanguageAdapterToUse.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.FabricModBenchmark.Baseline.JsonString.Mutable Value
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.FabricModBenchmark.Baseline.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetAdapter(in Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.TheLanguageAdapterToUse.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetValue(in Corvus.FabricModBenchmark.Baseline.JsonString.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.FabricModBenchmark.Baseline.JsonString.Source value,
                    in Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.TheLanguageAdapterToUse.Source adapter = default)
                {
                ...
                /// Creates an instance of a <see cref="RequiredValue"/>.
                /// </summary>
                public void Create(in Corvus.FabricModBenchmark.Baseline.JsonString.Source value, in Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.TheLanguageAdapterToUse.Source adapter = default)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.FabricModBenchmark.Baseline.JsonString.Source value, in Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.TheLanguageAdapterToUse.Source adapter = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
