...
public readonly partial struct Schema
{
    ...
    /// Generated from JSON Schema.
    /// </summary>
    public readonly partial struct Entrypoint
    {
        /// <summary>
        /// Generated from JSON Schema.
        /// </summary>
        public readonly partial struct RequiredValue
        {
            /// <summary>
            /// Generated from JSON Schema.
            /// </summary>
            ...
            public readonly partial struct TheLanguageAdapterToUse
#if NET8_0_OR_GREATER
                : IJsonElement<TheLanguageAdapterToUse>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="TheLanguageAdapterToUse"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal TheLanguageAdapterToUse(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static TheLanguageAdapterToUse DefaultInstance { get; } = ParsedJsonDocument<TheLanguageAdapterToUse>.StringConstant([.."\"default\""u8]);
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(TheLanguageAdapterToUse value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in TheLanguageAdapterToUse left, in TheLanguageAdapterToUse right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in TheLanguageAdapterToUse left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(TheLanguageAdapterToUse instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheLanguageAdapterToUse(JsonElement instance)
                {
                    return TheLanguageAdapterToUse.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheLanguageAdapterToUse From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheLanguageAdapterToUse ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheLanguageAdapterToUse>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheLanguageAdapterToUse ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheLanguageAdapterToUse>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheLanguageAdapterToUse ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheLanguageAdapterToUse>(json, options);
                }
                ...
                /// </exception>
                public static TheLanguageAdapterToUse ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<TheLanguageAdapterToUse>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out TheLanguageAdapterToUse? result)
                {
                    return JsonElementHelpers.TryParseValue<TheLanguageAdapterToUse>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TheLanguageAdapterToUse(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static TheLanguageAdapterToUse IJsonElement<TheLanguageAdapterToUse>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheLanguageAdapterToUse: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TheLanguageAdapterToUse"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TheLanguageAdapterToUse"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public TheLanguageAdapterToUse Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TheLanguageAdapterToUse>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TheLanguageAdapterToUse"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public TheLanguageAdapterToUse Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<TheLanguageAdapterToUse>(_idx);
                    }
