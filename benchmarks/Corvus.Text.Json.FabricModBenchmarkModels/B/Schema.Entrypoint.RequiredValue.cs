...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Entrypoint
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.TheLanguageAdapterToUse Adapter
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AdapterUtf8, out Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.TheLanguageAdapterToUse value))
                    {
                        return value;
                    }

                    return Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.TheLanguageAdapterToUse.DefaultInstance;
                }
            }
            ...
            /// </para>
            /// </remarks>
            public Corvus.FabricModBenchmark.Baseline.JsonString Value
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.FabricModBenchmark.Baseline.JsonString value))
                    {
                        return value;
                    }
