...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        internal Entrypoint(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Entrypoint DefaultInstance { get; }
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue(Entrypoint value)
        {
            return Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Entrypoint(Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue value)
        {
            return From(value);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(Entrypoint value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in Entrypoint left, in Entrypoint right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Entrypoint left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(Entrypoint instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Entrypoint(JsonElement instance)
        {
            return Entrypoint.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Entrypoint From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Entrypoint ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Entrypoint>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Entrypoint ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Entrypoint>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Entrypoint ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Entrypoint>(json, options);
        }
        ...
        /// </exception>
        public static Entrypoint ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Entrypoint>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Entrypoint? result)
        {
            return JsonElementHelpers.TryParseValue<Entrypoint>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Entrypoint(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Entrypoint IJsonElement<Entrypoint>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Entrypoint: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Entrypoint"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Entrypoint"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<Entrypoint>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Entrypoint"/> that lives for the lifetime of its
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsRequiredValue(out Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue result)
        {
            if (Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.From(this);
                return true;
            }
        ...
        /// <param name="matchRequiredValue">Match a <see cref="Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue"/>.</param>
        ...
        public TResult Match<TContext, TResult>(
            in TContext context,
            Matcher<Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue, TContext, TResult> matchRequiredValue,
            Matcher<Corvus.FabricModBenchmark.Baseline.JsonString, TContext, TResult> matchJsonString,
            Matcher<Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredValue(Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            Matcher<Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue, TResult> matchRequiredValue,
            Matcher<Corvus.FabricModBenchmark.Baseline.JsonString, TResult> matchJsonString,
            Matcher<Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint, TResult> defaultMatch)
        {
            if (Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredValue(Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.RequiredValue.From(this));
            }
