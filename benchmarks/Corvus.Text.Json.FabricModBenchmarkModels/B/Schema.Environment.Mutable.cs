...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Environment
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Environment instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Environment"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Environment(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Environment.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Environment Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly Environment Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Environment>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(Environment instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<Environment, Mutable>(this);
        }
    }
}
