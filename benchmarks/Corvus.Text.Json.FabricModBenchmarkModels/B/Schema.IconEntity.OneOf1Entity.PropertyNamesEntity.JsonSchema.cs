        ...
        public readonly partial struct OneOf1Entity
        {
                ...
                : IJsonElement<PropertyNamesEntity>
            {
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/fabric.mod.json#/properties/icon/oneOf/1/propertyNames"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "https://json.schemastore.org/fabric.mod.json#/properties/icon/oneOf/1/propertyNames";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/fabric.mod.json#/properties/icon/oneOf/1/propertyNames"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            JsonSchemaEvaluation.MatchRegularExpression(unescapedUtf8JsonString.Span, Pattern,"^[1-9][0-9]*$", "pattern"u8, ref context);
                        }
                        else
                        {
...
#else
                    private static Regex CreatePattern() => new("^[1-9][0-9]*$", RegexOptions.Compiled);
#endif
