...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public static explicit operator Corvus.FabricModBenchmark.Baseline.Schema.IconEntity.OneOf1Entity(IconEntity value)
        {
            return Corvus.FabricModBenchmark.Baseline.Schema.IconEntity.OneOf1Entity.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator IconEntity(Corvus.FabricModBenchmark.Baseline.Schema.IconEntity.OneOf1Entity value)
        {
            return From(value);
        }
        ...
        public bool TryGetAsOneOf1Entity(out Corvus.FabricModBenchmark.Baseline.Schema.IconEntity.OneOf1Entity result)
        {
            ...
            {
                result = Corvus.FabricModBenchmark.Baseline.Schema.IconEntity.OneOf1Entity.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.FabricModBenchmark.Baseline.Schema.IconEntity, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            if (Corvus.FabricModBenchmark.Baseline.Schema.IconEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchOneOf1Entity(Corvus.FabricModBenchmark.Baseline.Schema.IconEntity.OneOf1Entity.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.FabricModBenchmark.Baseline.Schema.IconEntity, TResult> defaultMatch)
        {
            if (Corvus.FabricModBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            if (Corvus.FabricModBenchmark.Baseline.Schema.IconEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchOneOf1Entity(Corvus.FabricModBenchmark.Baseline.Schema.IconEntity.OneOf1Entity.From(this));
            }
