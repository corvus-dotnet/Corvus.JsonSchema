        ...
        public readonly partial struct MixinsEntity
        {
            ...
            public readonly partial struct OneOf1Entity
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.FabricModBenchmark.Baseline.JsonString.Mutable Config
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ConfigUtf8, out Corvus.FabricModBenchmark.Baseline.JsonString.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetConfig(in Corvus.FabricModBenchmark.Baseline.JsonString.Source value)
                    {
                        CheckValidInstance();
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.FabricModBenchmark.Baseline.Schema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.FabricModBenchmark.Baseline.Schema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.FabricModBenchmark.Baseline.JsonString.Source config = default,
                    ...
                    /// Creates an instance of a <see cref="OneOf1Entity"/>.
                    /// </summary>
                    public void Create(in Corvus.FabricModBenchmark.Baseline.JsonString.Source config = default, in Corvus.FabricModBenchmark.Baseline.Schema.Environment.Source environment = default)
                    {
                        Create(ref _builder, config, environment);
                    }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.FabricModBenchmark.Baseline.JsonString.Source config = default, in Corvus.FabricModBenchmark.Baseline.Schema.Environment.Source environment = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(config, environment);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
