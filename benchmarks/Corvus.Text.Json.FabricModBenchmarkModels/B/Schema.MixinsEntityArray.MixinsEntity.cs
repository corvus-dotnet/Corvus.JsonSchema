...
public readonly partial struct Schema
{
    ...
    /// Generated from JSON Schema.
    /// </summary>
    public readonly partial struct MixinsEntityArray
    {
        /// <summary>
        /// Generated from JSON Schema.
        /// </summary>
        [DebuggerDisplay("{DebuggerDisplay,nq}")]
        public readonly partial struct MixinsEntity
#if NET8_0_OR_GREATER
            : IJsonElement<MixinsEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="MixinsEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal MixinsEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static MixinsEntity DefaultInstance { get; }
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.FabricModBenchmark.Baseline.Schema.MixinsEntityArray.MixinsEntity.OneOf1Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.FabricModBenchmark.Baseline.Schema.MixinsEntityArray.MixinsEntity.OneOf1Entity(MixinsEntity value)
            {
                return Corvus.FabricModBenchmark.Baseline.Schema.MixinsEntityArray.MixinsEntity.OneOf1Entity.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.FabricModBenchmark.Baseline.Schema.MixinsEntityArray.MixinsEntity.OneOf1Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator MixinsEntity(Corvus.FabricModBenchmark.Baseline.Schema.MixinsEntityArray.MixinsEntity.OneOf1Entity value)
            {
                return From(value);
            }
            ...
            /// </returns>
            public static bool operator ==(in MixinsEntity left, in MixinsEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in MixinsEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(MixinsEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MixinsEntity(JsonElement instance)
            {
                return MixinsEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MixinsEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MixinsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MixinsEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MixinsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MixinsEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MixinsEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MixinsEntity>(json, options);
            }
            ...
            /// </exception>
            public static MixinsEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<MixinsEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out MixinsEntity? result)
            {
                return JsonElementHelpers.TryParseValue<MixinsEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MixinsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static MixinsEntity IJsonElement<MixinsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MixinsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MixinsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MixinsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public MixinsEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MixinsEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MixinsEntity"/> that lives for the lifetime of its
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.FabricModBenchmark.Baseline.JsonString" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsJsonString(out Corvus.FabricModBenchmark.Baseline.JsonString result)
            {
                if (Corvus.FabricModBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.FabricModBenchmark.Baseline.JsonString.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.FabricModBenchmark.Baseline.Schema.MixinsEntityArray.MixinsEntity.OneOf1Entity" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsOneOf1Entity(out Corvus.FabricModBenchmark.Baseline.Schema.MixinsEntityArray.MixinsEntity.OneOf1Entity result)
            {
                if (Corvus.FabricModBenchmark.Baseline.Schema.MixinsEntityArray.MixinsEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.FabricModBenchmark.Baseline.Schema.MixinsEntityArray.MixinsEntity.OneOf1Entity.From(this);
                    return true;
                }
            ...
            /// <param name="matchJsonString">Match a <see cref="Corvus.FabricModBenchmark.Baseline.JsonString"/>.</param>
            /// <param name="matchOneOf1Entity">Match a <see cref="Corvus.FabricModBenchmark.Baseline.Schema.MixinsEntityArray.MixinsEntity.OneOf1Entity"/>.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.FabricModBenchmark.Baseline.JsonString, TContext, TResult> matchJsonString,
                Matcher<Corvus.FabricModBenchmark.Baseline.Schema.MixinsEntityArray.MixinsEntity.OneOf1Entity, TContext, TResult> matchOneOf1Entity,
                Matcher<Corvus.FabricModBenchmark.Baseline.Schema.MixinsEntityArray.MixinsEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                if (Corvus.FabricModBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonString(Corvus.FabricModBenchmark.Baseline.JsonString.From(this), context);
                }

                if (Corvus.FabricModBenchmark.Baseline.Schema.MixinsEntityArray.MixinsEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.FabricModBenchmark.Baseline.Schema.MixinsEntityArray.MixinsEntity.OneOf1Entity.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.FabricModBenchmark.Baseline.JsonString, TResult> matchJsonString,
                Matcher<Corvus.FabricModBenchmark.Baseline.Schema.MixinsEntityArray.MixinsEntity.OneOf1Entity, TResult> matchOneOf1Entity,
                Matcher<Corvus.FabricModBenchmark.Baseline.Schema.MixinsEntityArray.MixinsEntity, TResult> defaultMatch)
            {
                if (Corvus.FabricModBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonString(Corvus.FabricModBenchmark.Baseline.JsonString.From(this));
                }

                if (Corvus.FabricModBenchmark.Baseline.Schema.MixinsEntityArray.MixinsEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.FabricModBenchmark.Baseline.Schema.MixinsEntityArray.MixinsEntity.OneOf1Entity.From(this));
                }
