...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public Corvus.FabricModBenchmark.Baseline.Schema.MixinsEntityArray.MixinsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.FabricModBenchmark.Baseline.Schema.MixinsEntityArray.MixinsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.FabricModBenchmark.Baseline.Schema.MixinsEntityArray.MixinsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.FabricModBenchmark.Baseline.Schema.MixinsEntityArray.MixinsEntity>(_parent, _idx);
        }
