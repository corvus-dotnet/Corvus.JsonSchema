...
public readonly partial struct Schema
{
    ...
    public readonly partial struct NestedJar
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.FabricModBenchmark.Baseline.JsonString.Mutable File
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FileUtf8, out Corvus.FabricModBenchmark.Baseline.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetFile(in Corvus.FabricModBenchmark.Baseline.JsonString.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.FabricModBenchmark.Baseline.Schema.NestedJar.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.FabricModBenchmark.Baseline.Schema.NestedJar.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.FabricModBenchmark.Baseline.JsonString.Source file)
            {
            ...
            /// Creates an instance of a <see cref="NestedJar"/>.
            /// </summary>
            public void Create(in Corvus.FabricModBenchmark.Baseline.JsonString.Source file)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.FabricModBenchmark.Baseline.JsonString.Source file, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
