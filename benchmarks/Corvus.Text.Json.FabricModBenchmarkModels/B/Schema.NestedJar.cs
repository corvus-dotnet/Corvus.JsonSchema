...
public readonly partial struct Schema
{
    ...
    public readonly partial struct NestedJar
#if NET8_0_OR_GREATER
        : IJsonElement<NestedJar>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NestedJar"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal NestedJar(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static NestedJar DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.FabricModBenchmark.Baseline.JsonString File
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FileUtf8, out Corvus.FabricModBenchmark.Baseline.JsonString value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in NestedJar left, in NestedJar right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in NestedJar left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(NestedJar instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NestedJar(JsonElement instance)
        {
            return NestedJar.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NestedJar From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NestedJar ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<NestedJar>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NestedJar ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<NestedJar>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NestedJar ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<NestedJar>(json, options);
        }
        ...
        /// </exception>
        public static NestedJar ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<NestedJar>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out NestedJar? result)
        {
            return JsonElementHelpers.TryParseValue<NestedJar>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new NestedJar(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static NestedJar IJsonElement<NestedJar>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NestedJar: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="NestedJar"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="NestedJar"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public NestedJar Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<NestedJar>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="NestedJar"/> that lives for the lifetime of its
