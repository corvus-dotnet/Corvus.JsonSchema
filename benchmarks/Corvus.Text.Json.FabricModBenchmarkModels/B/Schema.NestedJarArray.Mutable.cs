...
public readonly partial struct Schema
{
    ...
    public readonly partial struct NestedJarArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(NestedJarArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="NestedJarArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NestedJarArray(Mutable instance)
            {
            ...
            public Corvus.FabricModBenchmark.Baseline.Schema.NestedJar.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.FabricModBenchmark.Baseline.Schema.NestedJar.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.FabricModBenchmark.Baseline.Schema.NestedJar.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.FabricModBenchmark.Baseline.Schema.NestedJar.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new NestedJarArray(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"NestedJarArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.FabricModBenchmark.Baseline.Schema.NestedJar.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.FabricModBenchmark.Baseline.Schema.NestedJar.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.FabricModBenchmark.Baseline.Schema.NestedJar.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.FabricModBenchmark.Baseline.Schema.NestedJar item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.FabricModBenchmark.Baseline.Schema.NestedJar>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.FabricModBenchmark.Baseline.Schema.NestedJar> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.FabricModBenchmark.Baseline.Schema.NestedJar>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.FabricModBenchmark.Baseline.Schema.NestedJar oldItem, in Corvus.FabricModBenchmark.Baseline.Schema.NestedJar.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.FabricModBenchmark.Baseline.Schema.NestedJar>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.FabricModBenchmark.Baseline.Schema.NestedJar current = enumerator.Current;
            ...
            /// <summary>
            /// Gets a <see cref="NestedJarArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="NestedJarArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly NestedJarArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<NestedJarArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="NestedJarArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly NestedJarArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<NestedJarArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.FabricModBenchmark.Baseline.Schema.NestedJarArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(NestedJarArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.FabricModBenchmark.Baseline.Schema.NestedJarArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<NestedJarArray, Mutable>(this);
        }
    }
}
