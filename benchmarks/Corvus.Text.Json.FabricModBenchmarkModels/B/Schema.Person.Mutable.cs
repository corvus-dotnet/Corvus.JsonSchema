...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Person
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Mutable(Mutable value)
            {
                return Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Mutable value)
            {
                return From(value);
            }
            ...
            /// </remarks>
            public void Apply(in Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName value)
            {
                CheckValidInstance();
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.FabricModBenchmark.Baseline.Schema.Person.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchRequiredName(Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.FabricModBenchmark.Baseline.Schema.Person.Mutable, TResult> defaultMatch)
            {
                if (Corvus.FabricModBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchRequiredName(Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Mutable.From(this));
                }
            ...
            public bool TryGetAsRequiredName(out Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName result)
            {
                if (Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Builder.Build? _requiredNameBuilderInstance;
            ...
            public Source(Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Builder.Build value) {_requiredNameBuilderInstance = value; _kind = Kind.RequiredNameBuilder; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName instance) => new(JsonElement.From(instance));
            ...
            internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
            {
                switch(_kind)
                {
                    ...
                    case Kind.RequiredNameBuilder:
                        valueBuilder.AddProperty(utf8Name, _requiredNameBuilderInstance!, static (in b, ref o) => Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Builder.BuildValue(b, ref o), escapeName, nameRequiresUnescaping);
                        break;
                    default:
            ...
            internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Utf16String:
                        ...
                        break;
                    case Kind.RequiredNameBuilder:
                        valueBuilder.AddProperty(name, _requiredNameBuilderInstance!, static (in b, ref o) => Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Builder.BuildValue(b, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Utf16String:
                        ...
                        break;
                    case Kind.RequiredNameBuilder:
                        valueBuilder.AddItem(_requiredNameBuilderInstance!, static (in b, ref o) => Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Builder.BuildValue(b, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            #endif
        {
            ...
            TContext _context;
            Source _source;
            private readonly Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Builder.Build<TContext>? _requiredNameBuilderInstance;
            ...
            public Source(scoped in TContext context, Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Builder.Build<TContext> value) {_context = context; _requiredNameBuilderInstance = value; _kind = Kind.RequiredNameBuilder; }
            ...
            internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.RequiredNameBuilder:
                        valueBuilder.AddProperty(utf8Name, BuildWithContext.Create(_context, _requiredNameBuilderInstance!), static (in b, ref o) => Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Builder.BuildValue(b.Context, b.Build, ref o), escapeName, nameRequiresUnescaping);
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.RequiredNameBuilder:
                        valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _requiredNameBuilderInstance!), static (in b, ref o) => Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Builder.BuildValue(b.Context, b.Build, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.RequiredNameBuilder:
                        valueBuilder.AddItem(BuildWithContext.Create(_context, _requiredNameBuilderInstance!), static (in b, ref o) => Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Builder.BuildValue(b.Context, b.Build, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
        ...
        public static Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Source Build(
            scoped in Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Builder.Build buildValue, int initialCapacity = 1)
        {
            return new Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Source(buildValue);
        }
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Source<TContext> Build<TContext>(
            scoped in TContext context, scoped in Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Builder.Build<TContext> buildValue, int initialCapacity = 1)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Source<TContext>(context, buildValue);
        }
        ...
        /// <returns>An instance of a mutable document initialized with the given value.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(
            JsonWorkspace workspace, scoped in Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        {
            // Create the document builder without a MetadataDb
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            var source = new Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Source(value);
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
            JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            var source = new Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Source<TContext>(context, value);
            source.AddAsItem(ref cvb);
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
