    ...
    public readonly partial struct Person
    {
        ...
        public readonly partial struct RequiredName
        {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.FabricModBenchmark.Baseline.JsonString.Source name,
                ...
                /// Creates an instance of a <see cref="RequiredName"/>.
                /// </summary>
                public void Create(in Corvus.FabricModBenchmark.Baseline.JsonString.Source name, in Corvus.FabricModBenchmark.Baseline.Schema.ContactInfo.Source contact = default)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.FabricModBenchmark.Baseline.JsonString.Source name, in Corvus.FabricModBenchmark.Baseline.Schema.ContactInfo.Source contact = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.FabricModBenchmark.Baseline.JsonString.Source name, in Corvus.FabricModBenchmark.Baseline.Schema.ContactInfo.Source<TContext> contact = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
