...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName(Person value)
        {
            return Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Person(Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName value)
        {
            return From(value);
        }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsRequiredName(out Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName result)
        {
            if (Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.From(this);
                return true;
            }
        ...
        /// <param name="matchRequiredName">Match a <see cref="Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName"/>.</param>
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName, TContext, TResult> matchRequiredName,
            Matcher<Corvus.FabricModBenchmark.Baseline.Schema.Person, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            if (Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredName(Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName, TResult> matchRequiredName,
            Matcher<Corvus.FabricModBenchmark.Baseline.Schema.Person, TResult> defaultMatch)
        {
            if (Corvus.FabricModBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            if (Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredName(Corvus.FabricModBenchmark.Baseline.Schema.Person.RequiredName.From(this));
            }
