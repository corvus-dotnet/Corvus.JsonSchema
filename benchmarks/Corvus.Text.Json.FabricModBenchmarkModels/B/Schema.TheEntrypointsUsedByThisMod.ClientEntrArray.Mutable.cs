...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TheEntrypointsUsedByThisMod
    {
        ...
        public readonly partial struct ClientEntrArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ClientEntrArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ClientEntrArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ClientEntrArray(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ClientEntrArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ClientEntrArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// <summary>
                /// Gets a <see cref="ClientEntrArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ClientEntrArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ClientEntrArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ClientEntrArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ClientEntrArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ClientEntrArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ClientEntrArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.FabricModBenchmark.Baseline.Schema.TheEntrypointsUsedByThisMod.ClientEntrArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(ClientEntrArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.FabricModBenchmark.Baseline.Schema.TheEntrypointsUsedByThisMod.ClientEntrArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<ClientEntrArray, Mutable>(this);
            }
        }
    }
}
