    ...
    public readonly partial struct TheEntrypointsUsedByThisMod
    {
        ...
        public readonly partial struct FabricDataArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(FabricDataArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="FabricDataArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FabricDataArray(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FabricDataArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public readonly FabricDataArray Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly FabricDataArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<FabricDataArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.FabricModBenchmark.Baseline.Schema.TheEntrypointsUsedByThisMod.FabricDataArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(FabricDataArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.FabricModBenchmark.Baseline.Schema.TheEntrypointsUsedByThisMod.FabricDataArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<FabricDataArray, Mutable>(this);
            }
        }
    }
}
