...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TheEntrypointsUsedByThisMod
    {
...
#endif
        {
            ...
            public Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint>(_parent, _idx);
            }
