...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TheEntrypointsUsedByThisMod
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="MainEntrypArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal MainEntrypArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static MainEntrypArray DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in MainEntrypArray left, in MainEntrypArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in MainEntrypArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(MainEntrypArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MainEntrypArray(JsonElement instance)
            {
                return MainEntrypArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MainEntrypArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MainEntrypArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MainEntrypArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MainEntrypArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MainEntrypArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MainEntrypArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MainEntrypArray>(json, options);
            }
            ...
            /// </exception>
            public static MainEntrypArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<MainEntrypArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out MainEntrypArray? result)
            {
                return JsonElementHelpers.TryParseValue<MainEntrypArray>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MainEntrypArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static MainEntrypArray IJsonElement<MainEntrypArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MainEntrypArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MainEntrypArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MainEntrypArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public MainEntrypArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MainEntrypArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MainEntrypArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public MainEntrypArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<MainEntrypArray>(_idx);
                }
