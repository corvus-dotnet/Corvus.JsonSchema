...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TheEntrypointsUsedByThisMod
    {
        ...
        public readonly partial struct PreLaunchEArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PreLaunchEArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PreLaunchEArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PreLaunchEArray(Mutable instance)
                {
                ...
                public Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.Mutable>(_parent, _idx);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new PreLaunchEArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PreLaunchEArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, in Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(in Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint oldItem, in Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.FabricModBenchmark.Baseline.Schema.Entrypoint current = enumerator.Current;
                ...
                /// <summary>
                /// Gets a <see cref="PreLaunchEArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="PreLaunchEArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly PreLaunchEArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<PreLaunchEArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="PreLaunchEArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly PreLaunchEArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PreLaunchEArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.FabricModBenchmark.Baseline.Schema.TheEntrypointsUsedByThisMod.PreLaunchEArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(PreLaunchEArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.FabricModBenchmark.Baseline.Schema.TheEntrypointsUsedByThisMod.PreLaunchEArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<PreLaunchEArray, Mutable>(this);
            }
        }
    }
}
