...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TheLicenseTheModUses
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.FabricModBenchmark.Baseline.Schema.TheLicenseTheModUses.JsonStringArray.Mutable(Mutable value)
            {
                return Corvus.FabricModBenchmark.Baseline.Schema.TheLicenseTheModUses.JsonStringArray.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.FabricModBenchmark.Baseline.Schema.TheLicenseTheModUses.JsonStringArray.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(TheLicenseTheModUses instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheLicenseTheModUses"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheLicenseTheModUses(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheLicenseTheModUses.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </para>
            /// </remarks>
            public readonly TheLicenseTheModUses Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TheLicenseTheModUses Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheLicenseTheModUses>(_idx);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.FabricModBenchmark.Baseline.Schema.TheLicenseTheModUses.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                ...
                {
                    return matchJsonString(Corvus.FabricModBenchmark.Baseline.JsonString.Mutable.From(this), context);
                }

                if (Corvus.FabricModBenchmark.Baseline.Schema.TheLicenseTheModUses.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.FabricModBenchmark.Baseline.Schema.TheLicenseTheModUses.JsonStringArray.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.FabricModBenchmark.Baseline.Schema.TheLicenseTheModUses.Mutable, TResult> defaultMatch)
            {
                if (Corvus.FabricModBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonString(Corvus.FabricModBenchmark.Baseline.JsonString.Mutable.From(this));
                }

                if (Corvus.FabricModBenchmark.Baseline.Schema.TheLicenseTheModUses.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.FabricModBenchmark.Baseline.Schema.TheLicenseTheModUses.JsonStringArray.Mutable.From(this));
                }
            ...
            public bool TryGetAsJsonString(out Corvus.FabricModBenchmark.Baseline.JsonString result)
            {
                if (Corvus.FabricModBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.FabricModBenchmark.Baseline.JsonString.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsJsonStringArray(out Corvus.FabricModBenchmark.Baseline.Schema.TheLicenseTheModUses.JsonStringArray result)
            {
                if (Corvus.FabricModBenchmark.Baseline.Schema.TheLicenseTheModUses.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.FabricModBenchmark.Baseline.Schema.TheLicenseTheModUses.JsonStringArray.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.FabricModBenchmark.Baseline.Schema.TheLicenseTheModUses.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(TheLicenseTheModUses instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.FabricModBenchmark.Baseline.JsonString instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.FabricModBenchmark.Baseline.Schema.TheLicenseTheModUses.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<TheLicenseTheModUses, Mutable>(this);
        }
    }
}
