...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TheModIdentifier
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TheModIdentifier instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheModIdentifier"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheModIdentifier(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheModIdentifier.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly TheModIdentifier Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TheModIdentifier Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheModIdentifier>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TheModIdentifier instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TheModIdentifier, Mutable>(this);
        }
    }
}
