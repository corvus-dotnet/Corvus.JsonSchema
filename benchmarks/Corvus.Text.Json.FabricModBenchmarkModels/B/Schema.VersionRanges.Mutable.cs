...
public readonly partial struct Schema
{
    ...
    public readonly partial struct VersionRanges
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.FabricModBenchmark.Baseline.Schema.VersionRanges.JsonStringArray"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.FabricModBenchmark.Baseline.Schema.VersionRanges.JsonStringArray.Mutable(Mutable value)
            {
                return Corvus.FabricModBenchmark.Baseline.Schema.VersionRanges.JsonStringArray.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.FabricModBenchmark.Baseline.Schema.VersionRanges.JsonStringArray"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.FabricModBenchmark.Baseline.Schema.VersionRanges.JsonStringArray.Mutable value)
            {
                return From(value);
            }
            ...
            /// <param name="matchJsonStringArray">Match a <see cref="Corvus.FabricModBenchmark.Baseline.Schema.VersionRanges.JsonStringArray"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.FabricModBenchmark.Baseline.Schema.VersionRanges.JsonStringArray, TContext, TResult> matchJsonStringArray,
                Matcher<Corvus.FabricModBenchmark.Baseline.Schema.VersionRanges.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                ...
                if (Corvus.FabricModBenchmark.Baseline.Schema.VersionRanges.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.FabricModBenchmark.Baseline.Schema.VersionRanges.JsonStringArray.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.FabricModBenchmark.Baseline.Schema.VersionRanges.JsonStringArray, TResult> matchJsonStringArray,
                Matcher<Corvus.FabricModBenchmark.Baseline.Schema.VersionRanges.Mutable, TResult> defaultMatch)
            {
                if (Corvus.FabricModBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.FabricModBenchmark.Baseline.Schema.VersionRanges.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.FabricModBenchmark.Baseline.Schema.VersionRanges.JsonStringArray.Mutable.From(this));
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.FabricModBenchmark.Baseline.Schema.VersionRanges.JsonStringArray" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsJsonStringArray(out Corvus.FabricModBenchmark.Baseline.Schema.VersionRanges.JsonStringArray result)
            {
                if (Corvus.FabricModBenchmark.Baseline.Schema.VersionRanges.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.FabricModBenchmark.Baseline.Schema.VersionRanges.JsonStringArray.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.FabricModBenchmark.Baseline.Schema.VersionRanges.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.FabricModBenchmark.Baseline.Schema.VersionRanges.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
