...
public readonly partial struct FabricModSchema
{
    ...
    public readonly partial struct Entrypoint
    {
...
#endif
        {
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsRequiredValue(out Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue result)
            {
                if (Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.JsonSchema.Evaluate(_parent, _idx))
                {
