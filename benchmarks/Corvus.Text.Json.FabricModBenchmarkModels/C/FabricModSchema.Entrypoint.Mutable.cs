...
public readonly partial struct FabricModSchema
{
    ...
    public readonly partial struct Entrypoint
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Mutable(Mutable value)
            {
                return Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(Entrypoint instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Entrypoint"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Entrypoint(Mutable instance)
            {
            ...
            /// </remarks>
            public void Apply(in Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Entrypoint.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Entrypoint Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly Entrypoint Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Entrypoint>(_idx);
            }
            ...
            /// <param name="matchRequiredValue">Match a <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue, TContext, TResult> matchRequiredValue,
                Matcher<Corvus.FabricModBenchmark.Current.JsonString, TContext, TResult> matchJsonString,
                Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                if (Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchRequiredValue(Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue, TResult> matchRequiredValue,
                Matcher<Corvus.FabricModBenchmark.Current.JsonString, TResult> matchJsonString,
                Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.Mutable, TResult> defaultMatch)
            {
                if (Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchRequiredValue(Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Mutable.From(this));
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsRequiredValue(out Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Mutable result)
            {
                if (Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Builder.Build? _requiredValueBuilderInstance;
            private readonly Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Source _requiredValueSourceInstance;
            ...
            public Source(Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Builder.Build value) {_requiredValueBuilderInstance = value; _kind = Kind.RequiredValueBuilder; }

            public Source(Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Source value) { _requiredValueSourceInstance = value; _kind = Kind.RequiredValueSource; }

            public static implicit operator Source(Entrypoint instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Source value) => new(value);
            ...
            internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Utf16String:
                        ...
                        break;
                    case Kind.RequiredValueBuilder:
                        valueBuilder.AddProperty(utf8Name, _requiredValueBuilderInstance!, static (in b, ref o) => Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Builder.BuildValue(b, ref o), escapeName, nameRequiresUnescaping);
                        break;
                    case Kind.RequiredValueSource:
                        _requiredValueSourceInstance.AddAsProperty(utf8Name, ref valueBuilder, escapeName, nameRequiresUnescaping);
                        break;
                    default:
            ...
            internal void AddAsPrebakedProperty(ReadOnlySpan<byte> prebakedPropertyName, ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Utf16String:
                        ...
                        break;
                    case Kind.RequiredValueBuilder:
                        valueBuilder.AddPrebakedProperty(prebakedPropertyName, _requiredValueBuilderInstance!, static (in b, ref o) => Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Builder.BuildValue(b, ref o));
                        break;
                    case Kind.RequiredValueSource:
                        _requiredValueSourceInstance.AddAsPrebakedProperty(prebakedPropertyName, ref valueBuilder);
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Utf16String:
                        ...
                        break;
                    case Kind.RequiredValueBuilder:
                        valueBuilder.AddProperty(name, _requiredValueBuilderInstance!, static (in b, ref o) => Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Builder.BuildValue(b, ref o));
                        break;
                    case Kind.RequiredValueSource:
                        _requiredValueSourceInstance.AddAsProperty(name, ref valueBuilder);
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Utf16String:
                        ...
                        break;
                    case Kind.RequiredValueBuilder:
                        valueBuilder.AddItem(_requiredValueBuilderInstance!, static (in b, ref o) => Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Builder.BuildValue(b, ref o));
                        break;
                    case Kind.RequiredValueSource:
                        _requiredValueSourceInstance.AddAsItem(ref valueBuilder);
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            #endif
        {
            ...
            TContext _context;
            Source _source;
            private readonly Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Builder.Build<TContext>? _requiredValueBuilderInstance;
            ...
            public Source(scoped in TContext context, Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Builder.Build<TContext> value) {_context = context; _requiredValueBuilderInstance = value; _kind = Kind.RequiredValueBuilder; }
            ...
            internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.RequiredValueBuilder:
                        valueBuilder.AddProperty(utf8Name, BuildWithContext.Create(_context, _requiredValueBuilderInstance!), static (in b, ref o) => Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Builder.BuildValue(b.Context, b.Build, ref o), escapeName, nameRequiresUnescaping);
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsPrebakedProperty(ReadOnlySpan<byte> prebakedPropertyName, ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.RequiredValueBuilder:
                        valueBuilder.AddPrebakedProperty(prebakedPropertyName, BuildWithContext.Create(_context, _requiredValueBuilderInstance!), static (in b, ref o) => Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Builder.BuildValue(b.Context, b.Build, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.RequiredValueBuilder:
                        valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _requiredValueBuilderInstance!), static (in b, ref o) => Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Builder.BuildValue(b.Context, b.Build, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.RequiredValueBuilder:
                        valueBuilder.AddItem(BuildWithContext.Create(_context, _requiredValueBuilderInstance!), static (in b, ref o) => Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Builder.BuildValue(b.Context, b.Build, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
        ...
        public static Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Source Build(
            scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Builder.Build buildValue, int initialCapacity = 1)
        {
            return new Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Source(buildValue);
        }
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Source<TContext> Build<TContext>(
            scoped in TContext context, scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Builder.Build<TContext> buildValue, int initialCapacity = 1)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Source<TContext>(context, buildValue);
        }
        ...
        /// <returns>An instance of a mutable document initialized with the given value.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(
            JsonWorkspace workspace, scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        {
            // Create the document builder without a MetadataDb
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            var source = new Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Source(value);
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
            JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            var source = new Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Source<TContext>(context, value);
            source.AddAsItem(ref cvb);
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<Entrypoint, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Entrypoint> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Entrypoint>();
            }
            finally
            {
        ...
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Entrypoint> Create(
            scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
            try
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Entrypoint> Create<TContext>(
            scoped in TContext context, scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
