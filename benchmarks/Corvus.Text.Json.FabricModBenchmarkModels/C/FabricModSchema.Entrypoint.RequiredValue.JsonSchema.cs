    ...
    public readonly partial struct Entrypoint
    {
            ...
            : IJsonElement<RequiredValue>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchAdapter(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
