    ...
    public readonly partial struct Entrypoint
    {
        ...
        public readonly partial struct RequiredValue
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequiredValue instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequiredValue"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredValue(Mutable instance)
                {
                ...
                /// <summary>
                /// Gets the (optional) <c>adapter</c> property.
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.TheLanguageAdapterToUse.Mutable Adapter
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AdapterUtf8, out Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.TheLanguageAdapterToUse.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.FabricModBenchmark.Current.JsonString.Mutable Value
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.FabricModBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RequiredValue(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                /// <summary>
                /// Set the <c>adapter</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetAdapter(scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.TheLanguageAdapterToUse.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AdapterUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AdapterUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Adapter, ref cvb);
                ...
                /// <summary>
                /// Remove the <c>adapter</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveAdapter()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AdapterUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetValue(scoped in Corvus.FabricModBenchmark.Current.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredValue.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RequiredValue"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RequiredValue"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredValue Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RequiredValue>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RequiredValue"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredValue Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequiredValue>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.TheLanguageAdapterToUse.Source _createArg2;
                ...
                internal Source(Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.FabricModBenchmark.Current.JsonString.Source arg1, scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.TheLanguageAdapterToUse.Source arg2)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _kind = Kind.Create;
                ...
                public static implicit operator Source(RequiredValue instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="RequiredValue"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.FabricModBenchmark.Current.JsonString.Source value,
                    in Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.TheLanguageAdapterToUse.Source adapter = default)
                {
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Value, ref builder);
                    adapter.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Adapter, ref builder);
                }

                /// <summary>
                /// Creates an instance of a <see cref="RequiredValue"/>.
                /// </summary>
                public void Create(in Corvus.FabricModBenchmark.Current.JsonString.Source value, in Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.TheLanguageAdapterToUse.Source adapter = default)
                {
                    Create(ref _builder, value, adapter);
                }
                ...
                internal static void BuildCreateValue(scoped in Corvus.FabricModBenchmark.Current.JsonString.Source arg1, scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.TheLanguageAdapterToUse.Source arg2, ref ComplexValueBuilder o)
                {
                    o.StartObject();
            ...
            /// <param name="adapter">The value of the <c>"adapter"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.FabricModBenchmark.Current.JsonString.Source value, scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.TheLanguageAdapterToUse.Source adapter = default)
            {
                return new Source(value, adapter);
            }
            ...
            /// <param name="adapter">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.FabricModBenchmark.Current.JsonString.Source value, in Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.TheLanguageAdapterToUse.Source adapter = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(value, adapter);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<RequiredValue, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RequiredValue> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RequiredValue>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredValue> Create<TContext>(
            ...
            public static ParsedJsonDocument<RequiredValue> Create(in Corvus.FabricModBenchmark.Current.JsonString.Source value, in Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.TheLanguageAdapterToUse.Source adapter = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
