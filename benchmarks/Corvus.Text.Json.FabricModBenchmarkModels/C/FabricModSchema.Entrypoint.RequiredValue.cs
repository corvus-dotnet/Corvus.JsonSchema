...
public readonly partial struct FabricModSchema
{
    ...
    public readonly partial struct Entrypoint
    {
...
#endif
        {
            ...
            internal RequiredValue(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RequiredValue DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.TheLanguageAdapterToUse Adapter
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AdapterUtf8, out Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.TheLanguageAdapterToUse value))
                    {
                        return value;
                    }

                    return Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.TheLanguageAdapterToUse.DefaultInstance;
                }
            }
            ...
            /// </para>
            /// </remarks>
            public Corvus.FabricModBenchmark.Current.JsonString Value
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.FabricModBenchmark.Current.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in RequiredValue left, in RequiredValue right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RequiredValue left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RequiredValue instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredValue(JsonElement instance)
            {
                return RequiredValue.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredValue From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredValue ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredValue>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredValue ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredValue>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredValue ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredValue>(json, options);
            }
            ...
            /// </exception>
            public static RequiredValue ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RequiredValue>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredValue? result)
            {
                return JsonElementHelpers.TryParseValue<RequiredValue>(ref reader, out result);
            }
...
#if NET
            static RequiredValue IJsonElement<RequiredValue>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredValue: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="Adapter"/>.
                /// </summary>
                ...
                /// Gets the JSON property name for <see cref="Adapter"/>.
                /// </summary>
                public static ReadOnlySpan<byte> AdapterUtf8 => "adapter"u8;
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Adapter"/>.
                /// </summary>
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="Adapter"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Adapter => [0x95, 0x00, 0x00, 0x00, 0x22, 0x61, 0x64, 0x61, 0x70, 0x74, 0x65, 0x72, 0x22];
