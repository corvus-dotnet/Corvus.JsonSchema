...
public readonly partial struct FabricModSchema
{
...
#endif
    {
        ...
        public static explicit operator Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue(Entrypoint value)
        {
            return Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Entrypoint(Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue value)
        {
            return From(value);
        }

        /// <summary>
        /// Conversion from the <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue"/> mutable view.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Entrypoint(Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.Mutable value)
        {
            return From(value);
        }
        ...
        public bool TryGetAsRequiredValue(out Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue result)
        {
            ...
            {
                result = Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredValue(Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint, TResult> defaultMatch)
        {
            if (Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredValue(Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.RequiredValue.From(this));
            }
