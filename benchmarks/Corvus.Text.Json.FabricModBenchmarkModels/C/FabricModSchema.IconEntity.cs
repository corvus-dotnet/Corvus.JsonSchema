...
public readonly partial struct FabricModSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IconEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal IconEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static IconEntity DefaultInstance { get; }
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.IconEntity.OneOf1Entity"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.FabricModBenchmark.Current.FabricModSchema.IconEntity.OneOf1Entity(IconEntity value)
        {
            return Corvus.FabricModBenchmark.Current.FabricModSchema.IconEntity.OneOf1Entity.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.IconEntity.OneOf1Entity"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator IconEntity(Corvus.FabricModBenchmark.Current.FabricModSchema.IconEntity.OneOf1Entity value)
        {
            return From(value);
        }
        ...
        /// </returns>
        public static bool operator ==(in IconEntity left, in IconEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in IconEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(IconEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator IconEntity(JsonElement instance)
        {
            return IconEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IconEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IconEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IconEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IconEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IconEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IconEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IconEntity>(json, options);
        }
        ...
        /// </exception>
        public static IconEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<IconEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out IconEntity? result)
        {
            return JsonElementHelpers.TryParseValue<IconEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new IconEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static IconEntity IJsonElement<IconEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"IconEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="IconEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="IconEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<IconEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="IconEntity"/> that lives for the lifetime of its
        ...
        public bool TryGetAsOneOf1Entity(out Corvus.FabricModBenchmark.Current.FabricModSchema.IconEntity.OneOf1Entity result)
        {
            ...
            {
                result = Corvus.FabricModBenchmark.Current.FabricModSchema.IconEntity.OneOf1Entity.From(this);
                return true;
            }
        ...
        /// <param name="matchOneOf1Entity">Match a <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.IconEntity.OneOf1Entity"/>.</param>
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.IconEntity.OneOf1Entity, TContext, TResult> matchOneOf1Entity,
            Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.IconEntity, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            if (Corvus.FabricModBenchmark.Current.FabricModSchema.IconEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchOneOf1Entity(Corvus.FabricModBenchmark.Current.FabricModSchema.IconEntity.OneOf1Entity.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.IconEntity.OneOf1Entity, TResult> matchOneOf1Entity,
            Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.IconEntity, TResult> defaultMatch)
        {
            if (Corvus.FabricModBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            if (Corvus.FabricModBenchmark.Current.FabricModSchema.IconEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchOneOf1Entity(Corvus.FabricModBenchmark.Current.FabricModSchema.IconEntity.OneOf1Entity.From(this));
            }
