...
public readonly partial struct FabricModSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LanguageAdaptersEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal LanguageAdaptersEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static LanguageAdaptersEntity DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in LanguageAdaptersEntity left, in LanguageAdaptersEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in LanguageAdaptersEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(LanguageAdaptersEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator LanguageAdaptersEntity(JsonElement instance)
        {
            return LanguageAdaptersEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LanguageAdaptersEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LanguageAdaptersEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<LanguageAdaptersEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LanguageAdaptersEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<LanguageAdaptersEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LanguageAdaptersEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<LanguageAdaptersEntity>(json, options);
        }
        ...
        /// </exception>
        public static LanguageAdaptersEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<LanguageAdaptersEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out LanguageAdaptersEntity? result)
        {
            return JsonElementHelpers.TryParseValue<LanguageAdaptersEntity>(ref reader, out result);
        }
...
#if NET
        static LanguageAdaptersEntity IJsonElement<LanguageAdaptersEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"LanguageAdaptersEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public LanguageAdaptersEntity Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public LanguageAdaptersEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<LanguageAdaptersEntity>(_idx);
            }
