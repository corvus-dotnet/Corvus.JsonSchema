    ...
    public readonly partial struct MixinsEntityArray
    {
        ...
        public readonly partial struct MixinsEntity
        {
...
#endif
            {
                ...
                public static explicit operator Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Mutable(Mutable value)
                {
                    return Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Mutable value)
                {
                    return From(value);
                }
                ...
                /// </remarks>
                public void Apply(in Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity value)
                {
                    CheckValidInstance();
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    {
                        return matchOneOf1Entity(Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.FabricModBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                    ...
                    if (Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf1Entity(Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Mutable.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsOneOf1Entity(out Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Mutable result)
                {
                    if (Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Mutable.From(this);
                        return true;
                    }
                ...
                #endif
            {
                ...
                TContext _context;
                Source _source;
                private readonly Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Builder.Build<TContext>? _oneOf1EntityBuilderInstance;
                ...
                public Source(scoped in TContext context, Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Builder.Build<TContext> value) {_context = context; _oneOf1EntityBuilderInstance = value; _kind = Kind.OneOf1EntityBuilder; }
                ...
                internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Source:
                            ...
                            break;
                        case Kind.OneOf1EntityBuilder:
                            valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _oneOf1EntityBuilderInstance!), static (in b, ref o) => Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Source:
                            ...
                            break;
                        case Kind.OneOf1EntityBuilder:
                            valueBuilder.AddItem(BuildWithContext.Create(_context, _oneOf1EntityBuilderInstance!), static (in b, ref o) => Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
            ...
            public static Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Source Build(
                scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Builder.Build buildValue, int initialCapacity = 1)
            {
                return new Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Source(buildValue);
            }
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Source<TContext> Build<TContext>(
                scoped in TContext context, scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Builder.Build<TContext> buildValue, int initialCapacity = 1)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Source<TContext>(context, buildValue);
            }
            ...
            /// <returns>An instance of a mutable document initialized with the given value.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(
                JsonWorkspace workspace, scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            {
                // Create the document builder without a MetadataDb
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                var source = new Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Source(value);
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
                JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                var source = new Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Source<TContext>(context, value);
                source.AddAsItem(ref cvb);
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            public static ParsedJsonDocument<MixinsEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MixinsEntity>();
                }
                finally
                {
            ...
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<MixinsEntity> Create(
                scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
                try
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<MixinsEntity> Create<TContext>(
                scoped in TContext context, scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
