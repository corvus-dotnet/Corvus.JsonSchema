        ...
        public readonly partial struct MixinsEntity
        {
            ...
            public readonly partial struct OneOf1Entity
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.FabricModBenchmark.Current.JsonString.Mutable Config
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ConfigUtf8, out Corvus.FabricModBenchmark.Current.JsonString.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetConfig(scoped in Corvus.FabricModBenchmark.Current.JsonString.Source value)
                    {
                        CheckValidInstance();
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.FabricModBenchmark.Current.FabricModSchema.Environment.Source _createArg2;
                    ...
                    internal Source(Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in Corvus.FabricModBenchmark.Current.JsonString.Source arg1, scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.Environment.Source arg2)
                    {
                        _createArg1 = arg1;
                        _createArg2 = arg2;
                        _kind = Kind.Create;
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.FabricModBenchmark.Current.JsonString.Source config = default,
                    ...
                    /// Creates an instance of a <see cref="OneOf1Entity"/>.
                    /// </summary>
                    public void Create(in Corvus.FabricModBenchmark.Current.JsonString.Source config = default, in Corvus.FabricModBenchmark.Current.FabricModSchema.Environment.Source environment = default)
                    {
                    ...
                    internal static void BuildCreateValue(scoped in Corvus.FabricModBenchmark.Current.JsonString.Source arg1, scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.Environment.Source arg2, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.FabricModBenchmark.Current.JsonString.Source config = default, scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.Environment.Source environment = default)
                {
                    return new Source(config, environment);
                }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.FabricModBenchmark.Current.JsonString.Source config = default, in Corvus.FabricModBenchmark.Current.FabricModSchema.Environment.Source environment = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                public static ParsedJsonDocument<OneOf1Entity> Create(in Corvus.FabricModBenchmark.Current.JsonString.Source config = default, in Corvus.FabricModBenchmark.Current.FabricModSchema.Environment.Source environment = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
