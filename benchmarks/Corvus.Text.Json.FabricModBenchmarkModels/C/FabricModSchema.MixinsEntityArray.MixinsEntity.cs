...
public readonly partial struct FabricModSchema
{
    ...
    public readonly partial struct MixinsEntityArray
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity(MixinsEntity value)
            {
                return Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator MixinsEntity(Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity value)
            {
                return From(value);
            }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsOneOf1Entity(out Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity result)
            {
                if (Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.From(this);
                    return true;
                }
            ...
            /// <param name="matchOneOf1Entity">Match a <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity, TContext, TResult> matchOneOf1Entity,
                Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                if (Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity, TResult> matchOneOf1Entity,
                Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity, TResult> defaultMatch)
            {
                if (Corvus.FabricModBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.OneOf1Entity.From(this));
                }
