...
public readonly partial struct FabricModSchema
{
    ...
    public readonly partial struct MixinsEntityArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MixinsEntityArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MixinsEntityArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MixinsEntityArray(Mutable instance)
            {
            ...
            public Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MixinsEntityArray(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MixinsEntityArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity oldItem, in Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity current = enumerator.Current;
            ...
            /// <summary>
            /// Gets a <see cref="MixinsEntityArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MixinsEntityArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly MixinsEntityArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MixinsEntityArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MixinsEntityArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly MixinsEntityArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MixinsEntityArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(MixinsEntityArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            public void AddItem(in Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.Source value)
            {
            ...
            /// Add an item to the array.
            /// </summary>
            public void AddItem<TContext>(in Corvus.FabricModBenchmark.Current.FabricModSchema.MixinsEntityArray.MixinsEntity.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        {
            return workspace.CreateBuilder<MixinsEntityArray, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MixinsEntityArray> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MixinsEntityArray>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<MixinsEntityArray> Create<TContext>(
