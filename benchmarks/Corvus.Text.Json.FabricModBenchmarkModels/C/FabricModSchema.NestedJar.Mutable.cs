...
public readonly partial struct FabricModSchema
{
    ...
    public readonly partial struct NestedJar
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(NestedJar instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="NestedJar"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NestedJar(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.FabricModBenchmark.Current.JsonString.Mutable File
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FileUtf8, out Corvus.FabricModBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetFile(scoped in Corvus.FabricModBenchmark.Current.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"NestedJar.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly NestedJar Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly NestedJar Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<NestedJar>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.FabricModBenchmark.Current.FabricModSchema.NestedJar.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.FabricModBenchmark.Current.JsonString.Source arg1)
            {
                _createArg1 = arg1;
                _kind = Kind.Create;
            }

            public static implicit operator Source(NestedJar instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.FabricModBenchmark.Current.FabricModSchema.NestedJar.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="NestedJar"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.FabricModBenchmark.Current.JsonString.Source file)
            {
            ...
            /// Creates an instance of a <see cref="NestedJar"/>.
            /// </summary>
            public void Create(in Corvus.FabricModBenchmark.Current.JsonString.Source file)
            {
                Create(ref _builder, file);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.FabricModBenchmark.Current.JsonString.Source arg1, ref ComplexValueBuilder o)
            {
                o.StartObject();
                Create(ref o, arg1);
                o.EndObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.FabricModBenchmark.Current.JsonString.Source file)
        {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.FabricModBenchmark.Current.JsonString.Source file, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        {
            return workspace.CreateBuilder<NestedJar, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<NestedJar> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<NestedJar>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<NestedJar> Create<TContext>(
        ...
        public static ParsedJsonDocument<NestedJar> Create(in Corvus.FabricModBenchmark.Current.JsonString.Source file, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
