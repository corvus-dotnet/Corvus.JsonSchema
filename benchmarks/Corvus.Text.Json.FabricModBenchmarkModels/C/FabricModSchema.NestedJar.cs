...
public readonly partial struct FabricModSchema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.FabricModBenchmark.Current.JsonString File
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FileUtf8, out Corvus.FabricModBenchmark.Current.JsonString value))
                {
                    return value;
                }
