...
public readonly partial struct FabricModSchema
{
    ...
    public readonly partial struct NestedJarArray
    {
...
#endif
        {
            ...
            public Corvus.FabricModBenchmark.Current.FabricModSchema.NestedJar.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.FabricModBenchmark.Current.FabricModSchema.NestedJar.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.FabricModBenchmark.Current.FabricModSchema.NestedJar.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.FabricModBenchmark.Current.FabricModSchema.NestedJar.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.FabricModBenchmark.Current.FabricModSchema.NestedJar.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.NestedJar.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.NestedJar.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.FabricModBenchmark.Current.FabricModSchema.NestedJar item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.FabricModBenchmark.Current.FabricModSchema.NestedJar>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.FabricModBenchmark.Current.FabricModSchema.NestedJar> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.FabricModBenchmark.Current.FabricModSchema.NestedJar>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.FabricModBenchmark.Current.FabricModSchema.NestedJar oldItem, in Corvus.FabricModBenchmark.Current.FabricModSchema.NestedJar.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.FabricModBenchmark.Current.FabricModSchema.NestedJar>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.FabricModBenchmark.Current.FabricModSchema.NestedJar current = enumerator.Current;
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.FabricModBenchmark.Current.FabricModSchema.NestedJarArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.FabricModBenchmark.Current.FabricModSchema.NestedJarArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            public void AddItem(in Corvus.FabricModBenchmark.Current.FabricModSchema.NestedJar.Source value)
            {
            ...
            /// Add an item to the array.
            /// </summary>
            public void AddItem<TContext>(in Corvus.FabricModBenchmark.Current.FabricModSchema.NestedJar.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        public static ParsedJsonDocument<NestedJarArray> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<NestedJarArray>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<NestedJarArray> Create<TContext>(
