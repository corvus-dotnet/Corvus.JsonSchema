...
public readonly partial struct FabricModSchema
{
    ...
    public readonly partial struct Person
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Mutable(Mutable value)
            {
                return Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Mutable value)
            {
                return From(value);
            }
            ...
            /// </remarks>
            public void Apply(in Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName value)
            {
                CheckValidInstance();
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.Person.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchRequiredName(Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.Person.Mutable, TResult> defaultMatch)
            {
                if (Corvus.FabricModBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchRequiredName(Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Mutable.From(this));
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsRequiredName(out Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Mutable result)
            {
                if (Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Mutable.From(this);
                    return true;
                }
            ...
            #endif
        {
            ...
            TContext _context;
            Source _source;
            private readonly Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Builder.Build<TContext>? _requiredNameBuilderInstance;
            ...
            public Source(scoped in TContext context, Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Builder.Build<TContext> value) {_context = context; _requiredNameBuilderInstance = value; _kind = Kind.RequiredNameBuilder; }
            ...
            internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.RequiredNameBuilder:
                        valueBuilder.AddProperty(utf8Name, BuildWithContext.Create(_context, _requiredNameBuilderInstance!), static (in b, ref o) => Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Builder.BuildValue(b.Context, b.Build, ref o), escapeName, nameRequiresUnescaping);
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsPrebakedProperty(ReadOnlySpan<byte> prebakedPropertyName, ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.RequiredNameBuilder:
                        valueBuilder.AddPrebakedProperty(prebakedPropertyName, BuildWithContext.Create(_context, _requiredNameBuilderInstance!), static (in b, ref o) => Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Builder.BuildValue(b.Context, b.Build, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.RequiredNameBuilder:
                        valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _requiredNameBuilderInstance!), static (in b, ref o) => Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Builder.BuildValue(b.Context, b.Build, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.RequiredNameBuilder:
                        valueBuilder.AddItem(BuildWithContext.Create(_context, _requiredNameBuilderInstance!), static (in b, ref o) => Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Builder.BuildValue(b.Context, b.Build, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
        ...
        public static Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Source Build(
            scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Builder.Build buildValue, int initialCapacity = 1)
        {
            return new Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Source(buildValue);
        }
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Source<TContext> Build<TContext>(
            scoped in TContext context, scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Builder.Build<TContext> buildValue, int initialCapacity = 1)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Source<TContext>(context, buildValue);
        }
        ...
        /// <returns>An instance of a mutable document initialized with the given value.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(
            JsonWorkspace workspace, scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        {
            // Create the document builder without a MetadataDb
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            var source = new Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Source(value);
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
            JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            var source = new Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Source<TContext>(context, value);
            source.AddAsItem(ref cvb);
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Person> Create(
            scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
            try
            {
        ...
        public static ParsedJsonDocument<Person> Create<TContext>(
            scoped in TContext context, scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
