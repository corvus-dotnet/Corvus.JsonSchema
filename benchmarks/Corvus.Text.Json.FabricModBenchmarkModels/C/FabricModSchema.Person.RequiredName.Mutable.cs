    ...
    public readonly partial struct Person
    {
        ...
        public readonly partial struct RequiredName
        {
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.FabricModBenchmark.Current.FabricModSchema.ContactInfo.Source _createArg2;
                ...
                #endif
            {
                ...
                private readonly Corvus.FabricModBenchmark.Current.JsonString.Source _createArg1;
                private readonly Corvus.FabricModBenchmark.Current.FabricModSchema.ContactInfo.Source<TContext> _createArg2;
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.FabricModBenchmark.Current.JsonString.Source name,
                ...
                /// Creates an instance of a <see cref="RequiredName"/>.
                /// </summary>
                public void Create(in Corvus.FabricModBenchmark.Current.JsonString.Source name, in Corvus.FabricModBenchmark.Current.FabricModSchema.ContactInfo.Source contact = default)
                {
                    Create(ref _builder, name, contact);
                }
                ...
                #endif
                {
                    Create(context, ref _builder, name, contact);
                }
            ...
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.FabricModBenchmark.Current.JsonString.Source name, scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.ContactInfo.Source<TContext> contact = default)
                ...
                #endif
            {
                return new Source<TContext>(context, name, contact);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.FabricModBenchmark.Current.JsonString.Source name, in Corvus.FabricModBenchmark.Current.FabricModSchema.ContactInfo.Source contact = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(name, contact);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.FabricModBenchmark.Current.JsonString.Source name, in Corvus.FabricModBenchmark.Current.FabricModSchema.ContactInfo.Source<TContext> contact = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, name, contact);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            public static ParsedJsonDocument<RequiredName> Create(in Corvus.FabricModBenchmark.Current.JsonString.Source name, in Corvus.FabricModBenchmark.Current.FabricModSchema.ContactInfo.Source contact = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredName> Create<TContext>(in TContext context, in Corvus.FabricModBenchmark.Current.JsonString.Source name, in Corvus.FabricModBenchmark.Current.FabricModSchema.ContactInfo.Source<TContext> contact = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
