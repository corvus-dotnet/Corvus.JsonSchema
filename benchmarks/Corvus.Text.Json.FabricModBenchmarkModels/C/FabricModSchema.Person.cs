...
public readonly partial struct FabricModSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName(Person value)
        {
            return Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Person(Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName value)
        {
            return From(value);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Person(JsonElement instance)
        {
            return Person.From(instance);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Person ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Person>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Person ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Person>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Person ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Person>(json, options);
        }
        ...
        /// </exception>
        public static Person ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Person>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Person? result)
        {
            return JsonElementHelpers.TryParseValue<Person>(ref reader, out result);
        }
        ...
        public Person Freeze()
        {
            ...
            {
                return mutable.FreezeElement<Person>(_idx);
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsRequiredName(out Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName result)
        {
            if (Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.From(this);
                return true;
            }
        ...
        /// <param name="matchRequiredName">Match a <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName"/>.</param>
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName, TContext, TResult> matchRequiredName,
            Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.Person, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            if (Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredName(Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName, TResult> matchRequiredName,
            Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.Person, TResult> defaultMatch)
        {
            if (Corvus.FabricModBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            if (Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredName(Corvus.FabricModBenchmark.Current.FabricModSchema.Person.RequiredName.From(this));
            }
