...
public readonly partial struct FabricModSchema
{
...
#endif
    {
        ...
        public Corvus.FabricModBenchmark.Current.FabricModSchema.Person this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.FabricModBenchmark.Current.FabricModSchema.Person>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.FabricModBenchmark.Current.FabricModSchema.Person> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.FabricModBenchmark.Current.FabricModSchema.Person>(_parent, _idx);
        }
