...
public readonly partial struct FabricModSchema
{
    ...
    public readonly partial struct TheEntrypointsUsedByThisMod
    {
        ...
        public readonly partial struct EntrypointArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(EntrypointArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EntrypointArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EntrypointArray(Mutable instance)
                {
                ...
                public Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.Mutable>(_parent, _idx);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new EntrypointArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EntrypointArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(scoped in Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint oldItem, in Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint current = enumerator.Current;
                ...
                /// <summary>
                /// Gets a <see cref="EntrypointArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="EntrypointArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly EntrypointArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<EntrypointArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="EntrypointArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly EntrypointArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EntrypointArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.FabricModBenchmark.Current.FabricModSchema.TheEntrypointsUsedByThisMod.EntrypointArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(EntrypointArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.FabricModBenchmark.Current.FabricModSchema.TheEntrypointsUsedByThisMod.EntrypointArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                public void AddItem(in Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.Source value)
                {
                ...
                /// Add an item to the array.
                /// </summary>
                public void AddItem<TContext>(in Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            {
                return workspace.CreateBuilder<EntrypointArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<EntrypointArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EntrypointArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<EntrypointArray> Create<TContext>(
