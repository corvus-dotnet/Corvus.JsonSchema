...
public readonly partial struct FabricModSchema
{
    ...
    public readonly partial struct TheEntrypointsUsedByThisMod
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="EntrypointArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal EntrypointArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static EntrypointArray DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in EntrypointArray left, in EntrypointArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in EntrypointArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(EntrypointArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EntrypointArray(JsonElement instance)
            {
                return EntrypointArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EntrypointArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EntrypointArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EntrypointArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EntrypointArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EntrypointArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EntrypointArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EntrypointArray>(json, options);
            }
            ...
            /// </exception>
            public static EntrypointArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<EntrypointArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out EntrypointArray? result)
            {
                return JsonElementHelpers.TryParseValue<EntrypointArray>(ref reader, out result);
            }
...
#if NET
            static EntrypointArray IJsonElement<EntrypointArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EntrypointArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public EntrypointArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<EntrypointArray>(_idx);
                }
