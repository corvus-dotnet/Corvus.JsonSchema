...
public readonly partial struct FabricModSchema
{
    ...
    public readonly partial struct TheEntrypointsUsedByThisMod
    {
        ...
        public readonly partial struct FabricDataArray
#if NET8_0_OR_GREATER
            : IJsonElement<FabricDataArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="FabricDataArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal FabricDataArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static FabricDataArray DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in FabricDataArray left, in FabricDataArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in FabricDataArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(FabricDataArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator FabricDataArray(JsonElement instance)
            {
                return FabricDataArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FabricDataArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FabricDataArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FabricDataArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FabricDataArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FabricDataArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FabricDataArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FabricDataArray>(json, options);
            }
            ...
            /// </exception>
            public static FabricDataArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<FabricDataArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out FabricDataArray? result)
            {
                return JsonElementHelpers.TryParseValue<FabricDataArray>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new FabricDataArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static FabricDataArray IJsonElement<FabricDataArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"FabricDataArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="FabricDataArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="FabricDataArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public FabricDataArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<FabricDataArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="FabricDataArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public FabricDataArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<FabricDataArray>(_idx);
                }
