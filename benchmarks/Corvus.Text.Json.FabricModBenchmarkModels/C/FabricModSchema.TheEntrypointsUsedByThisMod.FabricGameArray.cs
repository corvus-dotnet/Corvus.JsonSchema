...
public readonly partial struct FabricModSchema
{
    ...
    public readonly partial struct TheEntrypointsUsedByThisMod
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="FabricGameArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal FabricGameArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static FabricGameArray DefaultInstance { get; }
            ...
            public Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.FabricModBenchmark.Current.FabricModSchema.Entrypoint>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in FabricGameArray left, in FabricGameArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in FabricGameArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(FabricGameArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator FabricGameArray(JsonElement instance)
            {
                return FabricGameArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FabricGameArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FabricGameArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FabricGameArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FabricGameArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FabricGameArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FabricGameArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FabricGameArray>(json, options);
            }
            ...
            /// </exception>
            public static FabricGameArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<FabricGameArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out FabricGameArray? result)
            {
                return JsonElementHelpers.TryParseValue<FabricGameArray>(ref reader, out result);
            }
...
#if NET
            static FabricGameArray IJsonElement<FabricGameArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"FabricGameArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public FabricGameArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<FabricGameArray>(_idx);
                }
