...
public readonly partial struct FabricModSchema
{
    ...
    public readonly partial struct TheLicenseTheModUses
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray.Mutable(Mutable value)
            {
                return Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray.Mutable value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                ...
                {
                    return matchJsonStringArray(Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.Mutable, TResult> defaultMatch)
            {
                if (Corvus.FabricModBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray.Mutable.From(this));
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsJsonStringArray(out Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray.Mutable result)
            {
                if (Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public static ParsedJsonDocument<TheLicenseTheModUses> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TheLicenseTheModUses>();
            }
            finally
            {
