...
public readonly partial struct FabricModSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TheLicenseTheModUses"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TheLicenseTheModUses(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TheLicenseTheModUses DefaultInstance { get; }
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray(TheLicenseTheModUses value)
        {
            return Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator TheLicenseTheModUses(Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray value)
        {
            return From(value);
        }
        ...
        /// </returns>
        public static bool operator ==(in TheLicenseTheModUses left, in TheLicenseTheModUses right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TheLicenseTheModUses left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(TheLicenseTheModUses instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TheLicenseTheModUses(JsonElement instance)
        {
            return TheLicenseTheModUses.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheLicenseTheModUses From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheLicenseTheModUses ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TheLicenseTheModUses>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheLicenseTheModUses ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TheLicenseTheModUses>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheLicenseTheModUses ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TheLicenseTheModUses>(json, options);
        }
        ...
        /// </exception>
        public static TheLicenseTheModUses ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<TheLicenseTheModUses>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TheLicenseTheModUses? result)
        {
            return JsonElementHelpers.TryParseValue<TheLicenseTheModUses>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TheLicenseTheModUses(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static TheLicenseTheModUses IJsonElement<TheLicenseTheModUses>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TheLicenseTheModUses: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TheLicenseTheModUses"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TheLicenseTheModUses"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public TheLicenseTheModUses Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TheLicenseTheModUses>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TheLicenseTheModUses"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public TheLicenseTheModUses Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TheLicenseTheModUses>(_idx);
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsJsonStringArray(out Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray result)
        {
            if (Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray.From(this);
                return true;
            }
        ...
        /// <param name="matchJsonStringArray">Match a <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray"/>.</param>
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray, TContext, TResult> matchJsonStringArray,
            Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            if (Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonStringArray(Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray, TResult> matchJsonStringArray,
            Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses, TResult> defaultMatch)
        {
            if (Corvus.FabricModBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            if (Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonStringArray(Corvus.FabricModBenchmark.Current.FabricModSchema.TheLicenseTheModUses.JsonStringArray.From(this));
            }
