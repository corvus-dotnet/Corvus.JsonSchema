...
public readonly partial struct FabricModSchema
{
    ...
    public readonly partial struct TheModIdentifier
#if NET8_0_OR_GREATER
        : IJsonElement<TheModIdentifier>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TheModIdentifier"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TheModIdentifier(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TheModIdentifier DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(TheModIdentifier value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in TheModIdentifier left, in TheModIdentifier right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TheModIdentifier left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(TheModIdentifier instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TheModIdentifier(JsonElement instance)
        {
            return TheModIdentifier.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheModIdentifier From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheModIdentifier ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TheModIdentifier>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheModIdentifier ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TheModIdentifier>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheModIdentifier ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TheModIdentifier>(json, options);
        }
        ...
        /// </exception>
        public static TheModIdentifier ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<TheModIdentifier>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TheModIdentifier? result)
        {
            return JsonElementHelpers.TryParseValue<TheModIdentifier>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TheModIdentifier(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static TheModIdentifier IJsonElement<TheModIdentifier>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TheModIdentifier: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TheModIdentifier"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TheModIdentifier"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public TheModIdentifier Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TheModIdentifier>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TheModIdentifier"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public TheModIdentifier Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TheModIdentifier>(_idx);
            }
