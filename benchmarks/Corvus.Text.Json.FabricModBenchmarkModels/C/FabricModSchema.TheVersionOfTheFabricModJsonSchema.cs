...
public readonly partial struct FabricModSchema
{
    ...
    public readonly partial struct TheVersionOfTheFabricModJsonSchema
        ...
        : IJsonElement<TheVersionOfTheFabricModJsonSchema>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TheVersionOfTheFabricModJsonSchema"/> struct.
        /// </summary>
        ...
        internal TheVersionOfTheFabricModJsonSchema(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TheVersionOfTheFabricModJsonSchema DefaultInstance { get; }

        /// <summary>
        /// Gets the const instance.
        /// </summary>
        public static TheVersionOfTheFabricModJsonSchema ConstInstance => Constants.ConstJson;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator System.Numerics.BigInteger(TheVersionOfTheFabricModJsonSchema value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator decimal(TheVersionOfTheFabricModJsonSchema value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator sbyte(TheVersionOfTheFabricModJsonSchema value) => value._parent.TryGetValue(value._idx, out sbyte result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator byte(TheVersionOfTheFabricModJsonSchema value) => value._parent.TryGetValue(value._idx, out byte result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator short(TheVersionOfTheFabricModJsonSchema value) => value._parent.TryGetValue(value._idx, out short result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator ushort(TheVersionOfTheFabricModJsonSchema value) => value._parent.TryGetValue(value._idx, out ushort result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator int(TheVersionOfTheFabricModJsonSchema value) => value._parent.TryGetValue(value._idx, out int result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator uint(TheVersionOfTheFabricModJsonSchema value) => value._parent.TryGetValue(value._idx, out uint result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator ulong(TheVersionOfTheFabricModJsonSchema value) => value._parent.TryGetValue(value._idx, out ulong result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator float(TheVersionOfTheFabricModJsonSchema value) => value._parent.TryGetValue(value._idx, out float result) ? result : throw new FormatException();

#if NET
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Int128(TheVersionOfTheFabricModJsonSchema value) => value._parent.TryGetValue(value._idx, out Int128 result) ? result : throw new FormatException();
#endif

#if NET
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator UInt128(TheVersionOfTheFabricModJsonSchema value) => value._parent.TryGetValue(value._idx, out UInt128 result) ? result : throw new FormatException();
#endif

#if NET
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Half(TheVersionOfTheFabricModJsonSchema value) => value._parent.TryGetValue(value._idx, out Half result) ? result : throw new FormatException();
#endif
        ...
        /// </returns>
        public static bool operator ==(in TheVersionOfTheFabricModJsonSchema left, in TheVersionOfTheFabricModJsonSchema right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TheVersionOfTheFabricModJsonSchema left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(TheVersionOfTheFabricModJsonSchema instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TheVersionOfTheFabricModJsonSchema(JsonElement instance)
        {
            return TheVersionOfTheFabricModJsonSchema.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheVersionOfTheFabricModJsonSchema From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheVersionOfTheFabricModJsonSchema ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheVersionOfTheFabricModJsonSchema>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheVersionOfTheFabricModJsonSchema ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheVersionOfTheFabricModJsonSchema>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheVersionOfTheFabricModJsonSchema ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheVersionOfTheFabricModJsonSchema>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static TheVersionOfTheFabricModJsonSchema ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheVersionOfTheFabricModJsonSchema>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TheVersionOfTheFabricModJsonSchema? result)
        {
            return JsonElementHelpers.TryParseValue<TheVersionOfTheFabricModJsonSchema>(ref reader, out result);
        }
...
#if NET
        static TheVersionOfTheFabricModJsonSchema IJsonElement<TheVersionOfTheFabricModJsonSchema>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TheVersionOfTheFabricModJsonSchema: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public TheVersionOfTheFabricModJsonSchema Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public TheVersionOfTheFabricModJsonSchema Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TheVersionOfTheFabricModJsonSchema>(_idx);
            }
