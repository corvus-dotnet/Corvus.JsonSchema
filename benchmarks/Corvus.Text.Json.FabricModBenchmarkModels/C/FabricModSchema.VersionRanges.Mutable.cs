...
public readonly partial struct FabricModSchema
{
    ...
    public readonly partial struct VersionRanges
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray.Mutable(Mutable value)
            {
                return Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(VersionRanges instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="VersionRanges"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator VersionRanges(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"VersionRanges.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </para>
            /// </remarks>
            public readonly VersionRanges Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly VersionRanges Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<VersionRanges>(_idx);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                ...
                {
                    return matchJsonString(Corvus.FabricModBenchmark.Current.JsonString.Mutable.From(this), context);
                }

                if (Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.Mutable, TResult> defaultMatch)
            {
                if (Corvus.FabricModBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonString(Corvus.FabricModBenchmark.Current.JsonString.Mutable.From(this));
                }

                if (Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray.Mutable.From(this));
                }
            ...
            public bool TryGetAsJsonString(out Corvus.FabricModBenchmark.Current.JsonString.Mutable result)
            {
                if (Corvus.FabricModBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.FabricModBenchmark.Current.JsonString.Mutable.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsJsonStringArray(out Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray.Mutable result)
            {
                if (Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(VersionRanges instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<VersionRanges, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<VersionRanges> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<VersionRanges>();
            }
            finally
            {
