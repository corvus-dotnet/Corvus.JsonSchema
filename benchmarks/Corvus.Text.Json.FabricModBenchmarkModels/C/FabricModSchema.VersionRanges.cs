...
public readonly partial struct FabricModSchema
{
    ...
    public readonly partial struct VersionRanges
#if NET8_0_OR_GREATER
        : IJsonElement<VersionRanges>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VersionRanges"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal VersionRanges(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static VersionRanges DefaultInstance { get; }
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray(VersionRanges value)
        {
            return Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator VersionRanges(Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray value)
        {
            return From(value);
        }

        /// <summary>
        /// Conversion from the <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray"/> mutable view.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator VersionRanges(Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray.Mutable value)
        {
            return From(value);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(VersionRanges value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in VersionRanges left, in VersionRanges right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in VersionRanges left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(VersionRanges instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator VersionRanges(JsonElement instance)
        {
            return VersionRanges.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VersionRanges From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VersionRanges ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<VersionRanges>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VersionRanges ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<VersionRanges>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VersionRanges ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<VersionRanges>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static VersionRanges ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<VersionRanges>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out VersionRanges? result)
        {
            return JsonElementHelpers.TryParseValue<VersionRanges>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new VersionRanges(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static VersionRanges IJsonElement<VersionRanges>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"VersionRanges: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="VersionRanges"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="VersionRanges"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<VersionRanges>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="VersionRanges"/> that lives for the lifetime of its
        ...
        public bool TryGetAsJsonString(out Corvus.FabricModBenchmark.Current.JsonString result)
        {
            ...
            {
                result = Corvus.FabricModBenchmark.Current.JsonString.From(this);
                return true;
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsJsonStringArray(out Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray result)
        {
            if (Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray.From(this);
                return true;
            }
        ...
        /// <param name="matchJsonString">Match a <see cref="Corvus.FabricModBenchmark.Current.JsonString"/>.</param>
        /// <param name="matchJsonStringArray">Match a <see cref="Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray"/>.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Matcher<Corvus.FabricModBenchmark.Current.JsonString, TContext, TResult> matchJsonString,
            Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray, TContext, TResult> matchJsonStringArray,
            Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.FabricModBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonString(Corvus.FabricModBenchmark.Current.JsonString.From(this), context);
            }

            if (Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonStringArray(Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            Matcher<Corvus.FabricModBenchmark.Current.JsonString, TResult> matchJsonString,
            Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray, TResult> matchJsonStringArray,
            Matcher<Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges, TResult> defaultMatch)
        {
            if (Corvus.FabricModBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonString(Corvus.FabricModBenchmark.Current.JsonString.From(this));
            }

            if (Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonStringArray(Corvus.FabricModBenchmark.Current.FabricModSchema.VersionRanges.JsonStringArray.From(this));
            }
