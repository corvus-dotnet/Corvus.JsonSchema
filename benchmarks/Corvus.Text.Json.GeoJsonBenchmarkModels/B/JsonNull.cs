...
public readonly partial struct JsonNull
#if NET8_0_OR_GREATER
    : IJsonElement<JsonNull>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    internal JsonNull(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in JsonNull left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(JsonNull instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator JsonNull(JsonElement instance)
    {
        return JsonNull.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonNull From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonNull ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<JsonNull>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonNull ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<JsonNull>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonNull ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<JsonNull>(json, options);
    }
    ...
    {
        return JsonElementHelpers.ParseValue<JsonNull>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out JsonNull? result)
    {
        return JsonElementHelpers.TryParseValue<JsonNull>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new JsonNull(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static JsonNull IJsonElement<JsonNull>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"JsonNull: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="JsonNull"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="JsonNull"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    {
        CheckValidInstance();
        return _parent.CloneElement<JsonNull>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="JsonNull"/> that lives for the lifetime of its
