                            ...
                            ref JsonSchemaContext context)
                        {
                            ...
                            else
                            {
                                ...
                                while (arrayValidation_enumerator.MoveNext())
                                {
                                    ...
                                    JsonSchemaContext childContext = Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonFeature.GeometryEntity.GeoJsonMultiPoint.CoordinatesArray2Array.JsonNumberArray.JsonSchema.PushChildContext(
                                        parentDocument,
                                    ...
                                    Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonFeature.GeometryEntity.GeoJsonMultiPoint.CoordinatesArray2Array.JsonNumberArray.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
