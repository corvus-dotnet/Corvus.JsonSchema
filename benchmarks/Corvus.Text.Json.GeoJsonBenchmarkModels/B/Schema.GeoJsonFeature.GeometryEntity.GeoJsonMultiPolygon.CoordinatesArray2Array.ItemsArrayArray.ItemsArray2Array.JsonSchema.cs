                    ...
                    public readonly partial struct ItemsArrayArray
                    {
                            ...
                            : IJsonElement<ItemsArray2Array>
                        {
                            public static partial class JsonSchema
                            {
                                ...
                                /// </summary>
                                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://geojson.org/schema/GeoJSON.json#/oneOf/7/properties/geometry/oneOf/6/properties/coordinates/items/items"u8, buffer, out written);

                                /// <summary>
                                /// Gets the schema location from which this type was generated.
                                /// </summary>
                                public const string SchemaLocation = "https://geojson.org/schema/GeoJSON.json#/oneOf/7/properties/geometry/oneOf/6/properties/coordinates/items/items";

                                /// <summary>
                                /// Gets the schema location from which this type was generated as a UTF-8 string.
                                /// </summary>
                                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://geojson.org/schema/GeoJSON.json#/oneOf/7/properties/geometry/oneOf/6/properties/coordinates/items/items"u8;
                                    ...
                                    ref JsonSchemaContext context)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        while (arrayValidation_enumerator.MoveNext())
                                        {
                                            ...
                                            JsonSchemaContext childContext = Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonFeature.GeometryEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray.JsonSchema.PushChildContext(
                                                parentDocument,
                                            ...
                                            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonFeature.GeometryEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
