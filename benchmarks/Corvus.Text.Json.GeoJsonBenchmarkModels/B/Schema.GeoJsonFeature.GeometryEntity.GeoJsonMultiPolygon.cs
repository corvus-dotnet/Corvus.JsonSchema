    ...
    public readonly partial struct GeoJsonFeature
    {
        ...
        public readonly partial struct GeometryEntity
        {
...
#endif
            {
                ...
                /// </summary>
                public Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonFeature.GeometryEntity.GeoJsonMultiPolygon.JsonNumberArray Bbox
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BboxUtf8, out Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonFeature.GeometryEntity.GeoJsonMultiPolygon.JsonNumberArray value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonFeature.GeometryEntity.GeoJsonMultiPolygon.CoordinatesArray2Array Coordinates
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CoordinatesUtf8, out Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonFeature.GeometryEntity.GeoJsonMultiPolygon.CoordinatesArray2Array value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonFeature.GeometryEntity.GeoJsonMultiPolygon.TypeEntity Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonFeature.GeometryEntity.GeoJsonMultiPolygon.TypeEntity value))
                        {
                            return value;
                        }
