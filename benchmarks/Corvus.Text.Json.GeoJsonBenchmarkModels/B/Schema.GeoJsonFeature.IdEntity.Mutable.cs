    ...
    public readonly partial struct GeoJsonFeature
    {
        ...
        public readonly partial struct IdEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(IdEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="IdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IdEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly IdEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly IdEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<IdEntity>(_idx);
                }
                ...
                /// <param name="matchJsonNumber">Match a <see cref="Corvus.GeoJsonBenchmark.Baseline.JsonNumber"/>.</param>
                /// <param name="matchJsonString">Match a <see cref="Corvus.GeoJsonBenchmark.Baseline.JsonString"/>.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.GeoJsonBenchmark.Baseline.JsonNumber, TContext, TResult> matchJsonNumber,
                    Matcher<Corvus.GeoJsonBenchmark.Baseline.JsonString, TContext, TResult> matchJsonString,
                    Matcher<Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonFeature.IdEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    if (Corvus.GeoJsonBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonNumber(Corvus.GeoJsonBenchmark.Baseline.JsonNumber.Mutable.From(this), context);
                    }

                    if (Corvus.GeoJsonBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonString(Corvus.GeoJsonBenchmark.Baseline.JsonString.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.GeoJsonBenchmark.Baseline.JsonNumber, TResult> matchJsonNumber,
                    Matcher<Corvus.GeoJsonBenchmark.Baseline.JsonString, TResult> matchJsonString,
                    Matcher<Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonFeature.IdEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.GeoJsonBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonNumber(Corvus.GeoJsonBenchmark.Baseline.JsonNumber.Mutable.From(this));
                    }

                    if (Corvus.GeoJsonBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonString(Corvus.GeoJsonBenchmark.Baseline.JsonString.Mutable.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.GeoJsonBenchmark.Baseline.JsonNumber" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsJsonNumber(out Corvus.GeoJsonBenchmark.Baseline.JsonNumber result)
                {
                    if (Corvus.GeoJsonBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.GeoJsonBenchmark.Baseline.JsonNumber.Mutable.From(this);
                        return true;
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.GeoJsonBenchmark.Baseline.JsonString" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsJsonString(out Corvus.GeoJsonBenchmark.Baseline.JsonString result)
                {
                    if (Corvus.GeoJsonBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.GeoJsonBenchmark.Baseline.JsonString.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(IdEntity instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.GeoJsonBenchmark.Baseline.JsonNumber instance) => new(JsonElement.From(instance));

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.GeoJsonBenchmark.Baseline.JsonString instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<IdEntity, Mutable>(this);
            }
        }
    }
}
