                                                    ...
                                                    ref JsonSchemaContext context)
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        while (arrayValidation_enumerator.MoveNext())
                                                        {
                                                            ...
                                                            JsonSchemaContext childContext = Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiLineString.CoordinatesArray2Array.ItemsArrayArray.JsonNumberArray.JsonSchema.PushChildContext(
                                                                parentDocument,
                                                            ...
                                                            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiLineString.CoordinatesArray2Array.ItemsArrayArray.JsonNumberArray.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
