                                            ...
                                            public readonly partial struct ItemsArray2Array
                                            {
                                                ...
                                                public readonly partial struct JsonNumberArray
                                                {
...
#endif
                                                    {
                                                        ...
                                                        public static explicit operator Mutable(JsonNumberArray instance)
                                                        {
                                                        ...
                                                        /// <returns>An immutable instance of a <see cref="JsonNumberArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                                        public static implicit operator JsonNumberArray(Mutable instance)
                                                        {
                                                        ...
                                                        public Corvus.GeoJsonBenchmark.Baseline.JsonNumber.Mutable this[int index]
                                                        {
                                                            get
                                                            {
                                                                CheckValidInstance();
                                                                return _parent.GetArrayIndexElement<Corvus.GeoJsonBenchmark.Baseline.JsonNumber.Mutable>(_idx, index);
                                                            }
                                                        }
                                                        ...
                                                        /// </summary>
                                                        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                                                        public ArrayEnumerator<Corvus.GeoJsonBenchmark.Baseline.JsonNumber.Mutable> EnumerateArray()
                                                        {
                                                            CheckValidInstance();
                                                            return EnumeratorCreator.CreateArrayEnumerator<Corvus.GeoJsonBenchmark.Baseline.JsonNumber.Mutable>(_parent, _idx);
                                                        }
                                                        ...
                                                        public bool TryGetNumericValues(Span<double> items, out int written)
                                                        {
                                                            CheckValidInstance();
                                                            written = 0;
                                                            foreach (Corvus.GeoJsonBenchmark.Baseline.JsonNumber.Mutable item in EnumerateArray())
                                                            {
                                                        ...
                                                        {
                                                            return
                                                                (obj is IJsonElement value && Equals(new JsonNumberArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                                                        ...
                                                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                                        private string DebuggerDisplay => $"JsonNumberArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                                        /// <summary>
                                                        ...
                                                        /// </remarks>
                                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                                        public void SetItem(int itemIndex, in Corvus.GeoJsonBenchmark.Baseline.JsonNumber.Source value)
                                                        {
                                                            CheckValidInstance();
                                                        ...
                                                        /// </remarks>
                                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                                        public void InsertItem(int itemIndex, in Corvus.GeoJsonBenchmark.Baseline.JsonNumber.Source value)
                                                        {
                                                            CheckValidInstance();
                                                        ...
                                                        /// </exception>
                                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                                        public void AddItem(in Corvus.GeoJsonBenchmark.Baseline.JsonNumber.Source value)
                                                        {
                                                        ...
                                                        ///   The parent <see cref="JsonDocument"/> has been disposed.
                                                        /// </exception>
                                                        public bool Remove(in Corvus.GeoJsonBenchmark.Baseline.JsonNumber item)
                                                        {
                                                            CheckValidInstance();
                                                            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.GeoJsonBenchmark.Baseline.JsonNumber>(this, in item))
                                                            {
                                                                return false;
                                                            }
                                                        ...
                                                        /// </remarks>
                                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                                        public void RemoveWhere(JsonPredicate<Corvus.GeoJsonBenchmark.Baseline.JsonNumber> predicate)
                                                        {
                                                            CheckValidInstance();
                                                            JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.GeoJsonBenchmark.Baseline.JsonNumber>(this, predicate);
                                                            _documentVersion = _parent.Version;
                                                        }
                                                        ...
                                                        ///   The parent <see cref="JsonDocument"/> has been disposed.
                                                        /// </exception>
                                                        public bool Replace(in Corvus.GeoJsonBenchmark.Baseline.JsonNumber oldItem, in Corvus.GeoJsonBenchmark.Baseline.JsonNumber.Source newItem)
                                                        {
                                                            CheckValidInstance();
                                                            ...
                                                            var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.GeoJsonBenchmark.Baseline.JsonNumber>(_parent, _idx);

                                                            while (enumerator.MoveNext())
                                                            {
                                                                Corvus.GeoJsonBenchmark.Baseline.JsonNumber current = enumerator.Current;
                                                        ...
                                                        /// <summary>
                                                        /// Gets a <see cref="JsonNumberArray"/> which can be safely stored beyond the lifetime of the
                                                        /// original document.
                                                        /// </summary>
                                                        /// <returns>
                                                        /// A <see cref="JsonNumberArray"/> which can be safely stored beyond the lifetime of the
                                                        /// original document.
                                                        /// </returns>
                                                        /// <remarks>
                                                        /// <para>
                                                        ...
                                                        /// </para>
                                                        /// </remarks>
                                                        public readonly JsonNumberArray Clone()
                                                        {
                                                            CheckValidInstance();
                                                            return _parent.CloneElement<JsonNumberArray>(_idx);
                                                        }
                                                        ...
                                                        /// </summary>
                                                        /// <returns>
                                                        /// An immutable <see cref="JsonNumberArray"/> that lives for the lifetime of its
                                                        ...
                                                        /// </para>
                                                        /// </remarks>
                                                        public readonly JsonNumberArray Freeze()
                                                        {
                                                            CheckValidInstance();
                                                            return _parent.FreezeElement<JsonNumberArray>(_idx);
                                                        }
                                                    }
                                                    ...
                                                    {
                                                        return workspace.CreateBuilder<JsonNumberArray, Mutable>(this);
                                                    }
                                                }
                                            }
                                        }
