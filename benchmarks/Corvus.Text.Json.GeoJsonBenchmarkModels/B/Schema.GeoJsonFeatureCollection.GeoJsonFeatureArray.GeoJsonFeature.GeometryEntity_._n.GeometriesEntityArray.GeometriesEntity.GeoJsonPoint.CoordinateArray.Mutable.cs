                        ...
                        public readonly partial struct GeometriesEntityArray
                        {
                            ...
                            public readonly partial struct GeometriesEntity
                            {
                                ...
                                public readonly partial struct GeoJsonPoint
                                {
                                    ...
                                    public readonly partial struct CoordinateArray
                                    {
...
#endif
                                        {
                                            ...
                                            public static explicit operator Mutable(CoordinateArray instance)
                                            {
                                            ...
                                            /// <returns>An immutable instance of a <see cref="CoordinateArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                            public static implicit operator CoordinateArray(Mutable instance)
                                            {
                                            ...
                                            {
                                                return
                                                    (obj is IJsonElement value && Equals(new CoordinateArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                                            ...
                                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                            private string DebuggerDisplay => $"CoordinateArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                            /// <summary>
                                            ...
                                            /// <summary>
                                            /// Gets a <see cref="CoordinateArray"/> which can be safely stored beyond the lifetime of the
                                            /// original document.
                                            /// </summary>
                                            /// <returns>
                                            /// A <see cref="CoordinateArray"/> which can be safely stored beyond the lifetime of the
                                            /// original document.
                                            /// </returns>
                                            /// <remarks>
                                            /// <para>
                                            ...
                                            /// </para>
                                            /// </remarks>
                                            public readonly CoordinateArray Clone()
                                            {
                                                CheckValidInstance();
                                                return _parent.CloneElement<CoordinateArray>(_idx);
                                            }
                                            ...
                                            /// </summary>
                                            /// <returns>
                                            /// An immutable <see cref="CoordinateArray"/> that lives for the lifetime of its
                                            ...
                                            /// </para>
                                            /// </remarks>
                                            public readonly CoordinateArray Freeze()
                                            {
                                                CheckValidInstance();
                                                return _parent.FreezeElement<CoordinateArray>(_idx);
                                            }
                                        }
                                        ...
                                        public ref struct Source
                                        {
                                            ...
                                            internal Source(Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonPoint.CoordinateArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                                            public static implicit operator Source(CoordinateArray instance) => new(JsonElement.From(instance));
                                            ...
                                            #endif
                                        {
                                            ...
                                            internal Source(scoped in TContext context, Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonPoint.CoordinateArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                                        ...
                                        {
                                            return workspace.CreateBuilder<CoordinateArray, Mutable>(this);
                                        }
                                    }
                                }
                            }
