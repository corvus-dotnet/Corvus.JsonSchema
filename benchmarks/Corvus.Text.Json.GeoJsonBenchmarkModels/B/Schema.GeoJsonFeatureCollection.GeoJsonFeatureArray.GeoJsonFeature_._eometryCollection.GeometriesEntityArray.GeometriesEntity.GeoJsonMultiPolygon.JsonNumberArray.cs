                            ...
                            public readonly partial struct GeometriesEntity
                            {
                                ...
                                public readonly partial struct GeoJsonMultiPolygon
                                {
...
#endif
                                    {
                                        ...
                                        internal JsonNumberArray(IJsonDocument parent, int idx)
                                        {
                                            Debug.Assert(idx >= 0);
                                            _parent = parent;
                                            _idx = idx;
                                        ...
                                        /// </summary>
                                        public static JsonNumberArray DefaultInstance { get; }
                                        ...
                                        /// </returns>
                                        public static bool operator ==(in JsonNumberArray left, in JsonNumberArray right)
                                        {
                                        ...
                                        /// <c>True</c> if the values are equal.
                                        /// </returns>
                                        public static bool operator ==(in JsonNumberArray left, in JsonElement right)
                                        {
                                            return left.Equals(right);
                                        }
                                        ...
                                        public static implicit operator JsonElement(JsonNumberArray instance)
                                        {
                                        ...
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static implicit operator JsonNumberArray(JsonElement instance)
                                        {
                                            return JsonNumberArray.From(instance);
                                        }
                                        ...
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static JsonNumberArray From<T>(in T instance)
                                        ...
                                        /// </exception>
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static JsonNumberArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                                        {
                                            return JsonElementHelpers.ParseValue<JsonNumberArray>(utf8Json, options);
                                        }
                                        ...
                                        /// </exception>
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static JsonNumberArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                                        {
                                            return JsonElementHelpers.ParseValue<JsonNumberArray>(json, options);
                                        }
                                        ...
                                        /// </exception>
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static JsonNumberArray ParseValue(string json, JsonDocumentOptions options = default)
                                        {
                                            return JsonElementHelpers.ParseValue<JsonNumberArray>(json, options);
                                        }
                                        ...
                                        /// </exception>
                                        public static JsonNumberArray ParseValue(ref Utf8JsonReader reader)
                                        {
                                            return JsonElementHelpers.ParseValue<JsonNumberArray>(ref reader);
                                        }
                                        ...
                                        ///   A value could not be read from the reader.
                                        /// </exception>
                                        public static bool TryParseValue(ref Utf8JsonReader reader, out JsonNumberArray? result)
                                        {
                                            return JsonElementHelpers.TryParseValue<JsonNumberArray>(ref reader, out result);
                                        }
...
#if NET
                                        static JsonNumberArray IJsonElement<JsonNumberArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                        private string DebuggerDisplay => $"JsonNumberArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                                        ...
                                        /// </para>
                                        /// </remarks>
                                        public JsonNumberArray Freeze()
                                        {
                                            CheckValidInstance();
                                            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                            {
                                                return mutable.FreezeElement<JsonNumberArray>(_idx);
                                            }
