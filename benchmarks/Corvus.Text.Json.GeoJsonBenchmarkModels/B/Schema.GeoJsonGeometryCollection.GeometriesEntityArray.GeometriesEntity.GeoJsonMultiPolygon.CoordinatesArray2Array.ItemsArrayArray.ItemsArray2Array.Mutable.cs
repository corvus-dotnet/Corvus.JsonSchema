                        ...
                        public readonly partial struct ItemsArrayArray
                        {
                            ...
                            public readonly partial struct ItemsArray2Array
                            {
...
#endif
                                {
                                    ...
                                    public Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray.Mutable this[int index]
                                    {
                                        get
                                        {
                                            CheckValidInstance();
                                            return _parent.GetArrayIndexElement<Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray.Mutable>(_idx, index);
                                        }
                                    }
                                    ...
                                    /// </summary>
                                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                                    public ArrayEnumerator<Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray.Mutable> EnumerateArray()
                                    {
                                        CheckValidInstance();
                                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray.Mutable>(_parent, _idx);
                                    }
                                    ...
                                    public bool TryGetNumericValues(Span<double> items, out int written)
                                    {
                                        CheckValidInstance();
                                        written = 0;
                                        foreach (Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray.Mutable item in EnumerateArray())
                                        {
                                    ...
                                    /// </remarks>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public void SetItem(int itemIndex, in Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray.Source value)
                                    {
                                        CheckValidInstance();
                                    ...
                                    /// </remarks>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public void InsertItem(int itemIndex, in Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray.Source value)
                                    {
                                        CheckValidInstance();
                                    ...
                                    /// </exception>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public void AddItem(in Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray.Source value)
                                    {
                                    ...
                                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                                    /// </exception>
                                    public bool Remove(in Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray item)
                                    {
                                        CheckValidInstance();
                                        if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray>(this, in item))
                                        {
                                            return false;
                                        }
                                    ...
                                    /// </remarks>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public void RemoveWhere(JsonPredicate<Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray> predicate)
                                    {
                                        CheckValidInstance();
                                        JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray>(this, predicate);
                                        _documentVersion = _parent.Version;
                                    }
                                    ...
                                    public bool Replace(in Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray oldItem, in Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray.Source newItem)
                                    {
                                        ...
                                        var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray>(_parent, _idx);

                                        while (enumerator.MoveNext())
                                        {
                                            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray current = enumerator.Current;
                                ...
                                public ref struct Source
                                {
                                    ...
                                    internal Source(Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
