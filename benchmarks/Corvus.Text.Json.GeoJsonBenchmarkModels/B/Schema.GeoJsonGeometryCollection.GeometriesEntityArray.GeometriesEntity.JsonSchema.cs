                ...
                public static partial class JsonSchema
                {
                        ...
                        ref JsonSchemaContext context)
                    {
                            ...
                            switch (oneOfDiscriminatorBranch)
                            {
                                case 0:
                                {
                                    JsonSchemaContext discriminatorContext0 =
                                        Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonPoint.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                                    Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonPoint.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext0);
                                ...
                                case 1:
                                {
                                    JsonSchemaContext discriminatorContext1 =
                                        Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonLineString.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                                    Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonLineString.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext1);
                                ...
                                case 2:
                                {
                                    JsonSchemaContext discriminatorContext2 =
                                        Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonPolygon.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf2SchemaEvaluationPath);
                                    Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonPolygon.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext2);
                                ...
                                case 3:
                                {
                                    JsonSchemaContext discriminatorContext3 =
                                        Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPoint.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf3SchemaEvaluationPath);
                                    Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPoint.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext3);
                                ...
                                case 4:
                                {
                                    JsonSchemaContext discriminatorContext4 =
                                        Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiLineString.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf4SchemaEvaluationPath);
                                    Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiLineString.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext4);
                                ...
                                case 5:
                                {
                                    JsonSchemaContext discriminatorContext5 =
                                        Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf5SchemaEvaluationPath);
                                    Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext5);
                        ...
                        JsonSchemaContext oneOfContext0 =
                            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonPoint.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                        Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonPoint.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
                        ...
                        JsonSchemaContext oneOfContext1 =
                            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonLineString.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                        Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonLineString.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
                        ...
                        JsonSchemaContext oneOfContext2 =
                            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonPolygon.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf2SchemaEvaluationPath);
                        Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonPolygon.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext2);
                        ...
                        JsonSchemaContext oneOfContext3 =
                            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPoint.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf3SchemaEvaluationPath);
                        Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPoint.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext3);
                        ...
                        JsonSchemaContext oneOfContext4 =
                            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiLineString.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf4SchemaEvaluationPath);
                        Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiLineString.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext4);
                        ...
                        JsonSchemaContext oneOfContext5 =
                            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf5SchemaEvaluationPath);
                        Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext5);
