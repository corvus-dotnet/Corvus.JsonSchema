    ...
    public readonly partial struct GeoJsonFeature
    {
        ...
        public readonly partial struct GeometryEntity
        {
...
#endif
            {
                ...
                /// </summary>
                public Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonMultiLineString.JsonNumberArray Bbox
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BboxUtf8, out Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonMultiLineString.JsonNumberArray value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonMultiLineString.CoordinatesArray2Array Coordinates
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CoordinatesUtf8, out Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonMultiLineString.CoordinatesArray2Array value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonMultiLineString.TypeEntity Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonMultiLineString.TypeEntity value))
                        {
                            return value;
                        }
