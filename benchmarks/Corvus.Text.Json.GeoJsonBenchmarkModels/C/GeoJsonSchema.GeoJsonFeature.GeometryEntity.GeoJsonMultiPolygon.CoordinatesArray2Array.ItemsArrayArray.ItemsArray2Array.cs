                    ...
                    public readonly partial struct ItemsArrayArray
                    {
...
#endif
                        {
                            ...
                            public bool TryGetNumericValues(Span<double> items, out int written)
                            {
                                CheckValidInstance();
                                written = 0;
                                foreach (Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray item in EnumerateArray())
                                {
                            ...
                            public Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray this[int index]
                            {
                                get
                                {
                                    CheckValidInstance();
                                    return _parent.GetArrayIndexElement<Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray>(_idx, index);
                                }
                            }
                            ...
                            /// </summary>
                            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                            public ArrayEnumerator<Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray> EnumerateArray()
                            {
                                CheckValidInstance();
                                return EnumeratorCreator.CreateArrayEnumerator<Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonNumberArray>(_parent, _idx);
                            }
