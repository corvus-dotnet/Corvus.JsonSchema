        ...
        public readonly partial struct IdEntity
        {
...
#endif
            {
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.IdEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    {
                        return matchJsonNumber(Corvus.GeoJsonBenchmark.Current.JsonNumber.Mutable.From(this), context);
                    }

                    if (Corvus.GeoJsonBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonString(Corvus.GeoJsonBenchmark.Current.JsonString.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.IdEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.GeoJsonBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonNumber(Corvus.GeoJsonBenchmark.Current.JsonNumber.Mutable.From(this));
                    }

                    if (Corvus.GeoJsonBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonString(Corvus.GeoJsonBenchmark.Current.JsonString.Mutable.From(this));
                    }
                ...
                public bool TryGetAsJsonNumber(out Corvus.GeoJsonBenchmark.Current.JsonNumber.Mutable result)
                {
                    if (Corvus.GeoJsonBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.GeoJsonBenchmark.Current.JsonNumber.Mutable.From(this);
                        return true;
                    }
                ...
                public bool TryGetAsJsonString(out Corvus.GeoJsonBenchmark.Current.JsonString.Mutable result)
                {
                    if (Corvus.GeoJsonBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.GeoJsonBenchmark.Current.JsonString.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.GeoJsonBenchmark.Current.JsonNumber instance) => new(JsonElement.From(instance));

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.GeoJsonBenchmark.Current.JsonString instance) => new(JsonElement.From(instance));
            ...
            public static ParsedJsonDocument<IdEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<IdEntity>();
                }
                finally
                {
