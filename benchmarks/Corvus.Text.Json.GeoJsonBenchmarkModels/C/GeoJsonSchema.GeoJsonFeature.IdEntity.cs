...
public readonly partial struct GeoJsonSchema
{
    ...
    public readonly partial struct GeoJsonFeature
    {
...
#endif
        {
            ...
            internal IdEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(IdEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator long(IdEntity value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator double(IdEntity value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator Corvus.Numerics.BigNumber(IdEntity value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator System.Numerics.BigInteger(IdEntity value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator decimal(IdEntity value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator sbyte(IdEntity value) => value._parent.TryGetValue(value._idx, out sbyte result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator byte(IdEntity value) => value._parent.TryGetValue(value._idx, out byte result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator short(IdEntity value) => value._parent.TryGetValue(value._idx, out short result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator ushort(IdEntity value) => value._parent.TryGetValue(value._idx, out ushort result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator int(IdEntity value) => value._parent.TryGetValue(value._idx, out int result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator uint(IdEntity value) => value._parent.TryGetValue(value._idx, out uint result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator ulong(IdEntity value) => value._parent.TryGetValue(value._idx, out ulong result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator float(IdEntity value) => value._parent.TryGetValue(value._idx, out float result) ? result : throw new FormatException();

#if NET
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator Int128(IdEntity value) => value._parent.TryGetValue(value._idx, out Int128 result) ? result : throw new FormatException();
#endif

#if NET
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator UInt128(IdEntity value) => value._parent.TryGetValue(value._idx, out UInt128 result) ? result : throw new FormatException();
#endif

#if NET
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator Half(IdEntity value) => value._parent.TryGetValue(value._idx, out Half result) ? result : throw new FormatException();
#endif
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in IdEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(IdEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator IdEntity(JsonElement instance)
            {
                return IdEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IdEntity From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IdEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<IdEntity>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IdEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<IdEntity>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IdEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<IdEntity>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static IdEntity ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<IdEntity>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out IdEntity? result)
            {
                return JsonElementHelpers.TryParseValue<IdEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new IdEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static IdEntity IJsonElement<IdEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"IdEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="IdEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="IdEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<IdEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="IdEntity"/> that lives for the lifetime of its
            ...
            public bool TryGetAsJsonNumber(out Corvus.GeoJsonBenchmark.Current.JsonNumber result)
            {
                ...
                {
                    result = Corvus.GeoJsonBenchmark.Current.JsonNumber.From(this);
                    return true;
                }
            ...
            public bool TryGetAsJsonString(out Corvus.GeoJsonBenchmark.Current.JsonString result)
            {
                ...
                {
                    result = Corvus.GeoJsonBenchmark.Current.JsonString.From(this);
                    return true;
                }
            ...
            /// <param name="matchJsonNumber">Match a <see cref="Corvus.GeoJsonBenchmark.Current.JsonNumber"/>.</param>
            /// <param name="matchJsonString">Match a <see cref="Corvus.GeoJsonBenchmark.Current.JsonString"/>.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.GeoJsonBenchmark.Current.JsonNumber, TContext, TResult> matchJsonNumber,
                Matcher<Corvus.GeoJsonBenchmark.Current.JsonString, TContext, TResult> matchJsonString,
                Matcher<Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.IdEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                if (Corvus.GeoJsonBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonNumber(Corvus.GeoJsonBenchmark.Current.JsonNumber.From(this), context);
                }

                if (Corvus.GeoJsonBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonString(Corvus.GeoJsonBenchmark.Current.JsonString.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.GeoJsonBenchmark.Current.JsonNumber, TResult> matchJsonNumber,
                Matcher<Corvus.GeoJsonBenchmark.Current.JsonString, TResult> matchJsonString,
                Matcher<Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.IdEntity, TResult> defaultMatch)
            {
                if (Corvus.GeoJsonBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonNumber(Corvus.GeoJsonBenchmark.Current.JsonNumber.From(this));
                }

                if (Corvus.GeoJsonBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonString(Corvus.GeoJsonBenchmark.Current.JsonString.From(this));
                }
