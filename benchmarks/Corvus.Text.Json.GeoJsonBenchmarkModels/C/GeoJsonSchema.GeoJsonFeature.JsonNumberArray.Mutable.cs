    ...
    public readonly partial struct GeoJsonFeature
    {
        ...
        public readonly partial struct JsonNumberArray
        {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.JsonNumberArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.JsonNumberArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
