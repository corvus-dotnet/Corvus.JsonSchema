...
public readonly partial struct GeoJsonSchema
{
    ...
    public readonly partial struct GeoJsonFeature
    {
...
#endif
        {
            ...
            public void SetBbox(in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.JsonNumberArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetGeometry(in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.GeometryEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetId(in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.IdEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetProperties(in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.PropertiesEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.TypeEntity.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.GeometryEntity.Source arg1, in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.PropertiesEntity.Source arg2, in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.TypeEntity.Source arg3, in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.JsonNumberArray.Source arg4, in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.IdEntity.Source arg5)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.GeometryEntity.Source<TContext> arg1, in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.PropertiesEntity.Source<TContext> arg2, in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.TypeEntity.Source arg3, in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.JsonNumberArray.Source<TContext> arg4, in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.IdEntity.Source arg5)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
