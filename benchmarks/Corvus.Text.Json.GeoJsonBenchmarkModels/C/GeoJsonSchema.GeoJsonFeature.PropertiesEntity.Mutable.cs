    ...
    public readonly partial struct GeoJsonFeature
    {
        ...
        public readonly partial struct PropertiesEntity
        {
...
#endif
            {
                ...
                public static explicit operator Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity.Mutable(Mutable value)
                {
                    return Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity.Mutable value)
                {
                    return From(value);
                }
                ...
                /// </remarks>
                public void Apply(in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity value)
                {
                    CheckValidInstance();
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.PropertiesEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    {
                        return matchOneOf1Entity(Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.PropertiesEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.GeoJsonBenchmark.Current.JsonNull.JsonSchema.Evaluate(_parent, _idx))
                    {
                    ...
                    if (Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf1Entity(Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity.Mutable.From(this));
                    }
                ...
                public bool TryGetAsOneOf1Entity(out Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity result)
                {
                    if (Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.PropertiesEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeature.PropertiesEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
