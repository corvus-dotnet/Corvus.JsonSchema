            ...
            public readonly partial struct GeoJsonFeature
            {
                ...
                public readonly partial struct PropertiesEntity
                {
...
#endif
                    {
                        ...
                        /// <summary>
                        /// Gets the value as a <see cref="Corvus.GeoJsonBenchmark.Current.JsonObject.Mutable" />.
                        /// </summary>
                        /// <param name="result">The result of the conversions.</param>
                        /// <returns><see langword="true" /> if the conversion was valid.</returns>
                        public bool TryGetAsJsonObject(out Corvus.GeoJsonBenchmark.Current.JsonObject.Mutable result)
                        {
                            if (Corvus.GeoJsonBenchmark.Current.JsonObject.JsonSchema.Evaluate(_parent, _idx))
                            {
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature.PropertiesEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature.PropertiesEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
