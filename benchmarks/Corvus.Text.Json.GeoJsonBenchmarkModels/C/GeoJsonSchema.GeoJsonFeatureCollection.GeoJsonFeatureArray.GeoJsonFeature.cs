    ...
    public readonly partial struct GeoJsonFeatureCollection
    {
        ...
        public readonly partial struct GeoJsonFeatureArray
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="GeoJsonFeature"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal GeoJsonFeature(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static GeoJsonFeature DefaultInstance { get; }
                ...
                /// </summary>
                public Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature.JsonNumberArray Bbox
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BboxUtf8, out Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature.JsonNumberArray value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature.GeometryEntity Geometry
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GeometryUtf8, out Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature.GeometryEntity value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                public Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature.IdEntity Id
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature.IdEntity value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature.PropertiesEntity Properties
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PropertiesUtf8, out Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature.PropertiesEntity value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature.TypeEntity Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature.TypeEntity value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in GeoJsonFeature left, in GeoJsonFeature right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in GeoJsonFeature left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(GeoJsonFeature instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator GeoJsonFeature(JsonElement instance)
                {
                    return GeoJsonFeature.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static GeoJsonFeature From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static GeoJsonFeature ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<GeoJsonFeature>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static GeoJsonFeature ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<GeoJsonFeature>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static GeoJsonFeature ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<GeoJsonFeature>(json, options);
                }
                ...
                /// </exception>
                public static GeoJsonFeature ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<GeoJsonFeature>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out GeoJsonFeature? result)
                {
                    return JsonElementHelpers.TryParseValue<GeoJsonFeature>(ref reader, out result);
                }
...
#if NET
                static GeoJsonFeature IJsonElement<GeoJsonFeature>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"GeoJsonFeature: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public GeoJsonFeature Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<GeoJsonFeature>(_idx);
                    }
                ...
                public static class JsonPropertyNames
                {
                    ...
                    /// <summary>
                    /// Gets the JSON property name for <see cref="Geometry"/>.
                    /// </summary>
                    ...
                    /// Gets the JSON property name for <see cref="Geometry"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> GeometryUtf8 => "geometry"u8;
                ...
                private static class JsonPropertyNamesEscaped
                {
                    ...
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="Geometry"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Geometry => "geometry"u8;
                ...
                private static class JsonPropertyNamesPrebaked
                {
                    ...
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="Geometry"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Geometry => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x67, 0x65, 0x6F, 0x6D, 0x65, 0x74, 0x72, 0x79, 0x22];
