                        ...
                        public readonly partial struct GeometriesEntityArray
                        {
                            ...
                            public readonly partial struct GeometriesEntity
                            {
                                ...
                                public readonly partial struct GeoJsonMultiPoint
                                    ...
                                    : IJsonElement<GeoJsonMultiPoint>,
                                      IFormattable,
                                      ISpanFormattable,
...
#endif
                                {
                                    ...
                                    /// <summary>
                                    /// Initializes a new instance of the <see cref="GeoJsonMultiPoint"/> struct.
                                    /// </summary>
                                    /// <param name="value">The value from which to construct the instance.</param>
                                    internal GeoJsonMultiPoint(IJsonDocument parent, int idx)
                                    {
                                        Debug.Assert(idx >= 0);
                                        _parent = parent;
                                        _idx = idx;
                                    ...
                                    /// </summary>
                                    public static GeoJsonMultiPoint DefaultInstance { get; }
                                    ...
                                    /// </summary>
                                    public Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPoint.JsonNumberArray Bbox
                                    {
                                        get
                                        {
                                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BboxUtf8, out Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPoint.JsonNumberArray value))
                                            {
                                                return value;
                                            }
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPoint.CoordinatesArray2Array Coordinates
                                    {
                                        get
                                        {
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPoint.TypeEntity Type
                                    {
                                        get
                                        {
                                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPoint.TypeEntity value))
                                            {
                                                return value;
                                            }
                                    ...
                                    /// </returns>
                                    public static bool operator ==(in GeoJsonMultiPoint left, in GeoJsonMultiPoint right)
                                    {
                                    ...
                                    /// <c>True</c> if the values are equal.
                                    /// </returns>
                                    public static bool operator ==(in GeoJsonMultiPoint left, in JsonElement right)
                                    {
                                        return left.Equals(right);
                                    }
                                    ...
                                    public static implicit operator JsonElement(GeoJsonMultiPoint instance)
                                    {
                                    ...
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static implicit operator GeoJsonMultiPoint(JsonElement instance)
                                    {
                                        return GeoJsonMultiPoint.From(instance);
                                    }
                                    ...
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static GeoJsonMultiPoint From<T>(in T instance)
                                    ...
                                    ///   A value could not be read from the reader.
                                    /// </exception>
                                    public static bool TryParseValue(ref Utf8JsonReader reader, out GeoJsonMultiPoint? result)
                                    {
                                        return JsonElementHelpers.TryParseValue<GeoJsonMultiPoint>(ref reader, out result);
                                    }
...
#if NET
                                    static GeoJsonMultiPoint IJsonElement<GeoJsonMultiPoint>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                    private string DebuggerDisplay => $"GeoJsonMultiPoint: ValueKind = {ValueKind} : \"{ToString()}\"";
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public GeoJsonMultiPoint Clone()
                                    {
                                        CheckValidInstance();
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public GeoJsonMultiPoint Freeze()
                                    {
                                        CheckValidInstance();
                                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                        {
                                            return mutable.FreezeElement<GeoJsonMultiPoint>(_idx);
                                        }
