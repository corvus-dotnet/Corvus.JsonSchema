...
public readonly partial struct GeoJsonSchema
{
    ...
    public readonly partial struct GeoJsonFeatureCollection
    {
        ...
        public readonly partial struct GeoJsonFeatureArray
            ...
            : IJsonElement<GeoJsonFeatureArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="GeoJsonFeatureArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal GeoJsonFeatureArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static GeoJsonFeatureArray DefaultInstance { get; }
            ...
            public Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in GeoJsonFeatureArray left, in GeoJsonFeatureArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in GeoJsonFeatureArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(GeoJsonFeatureArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator GeoJsonFeatureArray(JsonElement instance)
            {
                return GeoJsonFeatureArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static GeoJsonFeatureArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static GeoJsonFeatureArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<GeoJsonFeatureArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static GeoJsonFeatureArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<GeoJsonFeatureArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static GeoJsonFeatureArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<GeoJsonFeatureArray>(json, options);
            }
            ...
            /// </exception>
            public static GeoJsonFeatureArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<GeoJsonFeatureArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out GeoJsonFeatureArray? result)
            {
                return JsonElementHelpers.TryParseValue<GeoJsonFeatureArray>(ref reader, out result);
            }
...
#if NET
            static GeoJsonFeatureArray IJsonElement<GeoJsonFeatureArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"GeoJsonFeatureArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public GeoJsonFeatureArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public GeoJsonFeatureArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<GeoJsonFeatureArray>(_idx);
                }
