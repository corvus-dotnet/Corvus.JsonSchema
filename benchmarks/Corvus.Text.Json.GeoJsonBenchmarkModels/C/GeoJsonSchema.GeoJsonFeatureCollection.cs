...
public readonly partial struct GeoJsonSchema
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.JsonNumberArray Bbox
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BboxUtf8, out Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.JsonNumberArray value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray Features
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FeaturesUtf8, out Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.TypeEntity Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonFeatureCollection.TypeEntity value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets a <see cref="GeoJsonFeatureCollection"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GeoJsonFeatureCollection"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public GeoJsonFeatureCollection Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GeoJsonFeatureCollection>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GeoJsonFeatureCollection"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public GeoJsonFeatureCollection Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<GeoJsonFeatureCollection>(_idx);
            }
        ...
        private static class JsonPropertyNamesPrebaked
        {
            ...
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Features"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Features => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x66, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x73, 0x22];
