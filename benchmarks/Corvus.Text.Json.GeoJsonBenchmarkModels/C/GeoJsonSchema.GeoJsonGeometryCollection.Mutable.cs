    ...
    public readonly partial struct GeoJsonGeometryCollection
    {
...
#endif
        {
            ...
            public void SetGeometries(in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.Geometries, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
        ...
        public ref struct Builder
        {
            ...
            {
                geometries.AddAsProperty(JsonPropertyNamesEscaped.Geometries, ref builder, escapeName: false);
