...
public readonly partial struct GeoJsonSchema
{
    ...
    public readonly partial struct GeoJsonPoint
    {
...
#endif
        {
            ...
            public void SetBbox(in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.JsonNumberArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCoordinates(in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.CoordinateArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.TypeEntity.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.CoordinateArray.Source arg1, in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.TypeEntity.Source arg2, in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.JsonNumberArray.Source arg3)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.CoordinateArray.Source<TContext> arg1, in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.TypeEntity.Source arg2, in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.JsonNumberArray.Source<TContext> arg3)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
        ...
        public ref struct Builder
        {
            ...
            internal static void BuildCreateValue(in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.CoordinateArray.Source arg1, in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.TypeEntity.Source arg2, in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.JsonNumberArray.Source arg3, ref ComplexValueBuilder o)
            {
                o.StartObject();
            ...
            /// <param name="arg3">The value of the property.</param>
            /// <param name="o">The complex value builder into which to write the object.</param>
            internal static void BuildCreateValue<TContext>(scoped in TContext context, in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.CoordinateArray.Source<TContext> arg1, in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.TypeEntity.Source arg2, in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.JsonNumberArray.Source<TContext> arg3, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.CoordinateArray.Source coordinates, in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.TypeEntity.Source type, in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.JsonNumberArray.Source bbox = default)
        {
        ...
        /// <param name="bbox">The value of the <c>"bbox"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.CoordinateArray.Source<TContext> coordinates, in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.TypeEntity.Source type, in Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.JsonNumberArray.Source<TContext> bbox = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
