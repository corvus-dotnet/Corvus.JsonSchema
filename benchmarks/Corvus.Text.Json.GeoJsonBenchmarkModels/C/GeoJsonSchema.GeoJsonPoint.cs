...
public readonly partial struct GeoJsonSchema
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.JsonNumberArray Bbox
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BboxUtf8, out Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.JsonNumberArray value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.CoordinateArray Coordinates
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CoordinatesUtf8, out Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.CoordinateArray value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.TypeEntity Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonPoint.TypeEntity value))
                {
                    return value;
                }
