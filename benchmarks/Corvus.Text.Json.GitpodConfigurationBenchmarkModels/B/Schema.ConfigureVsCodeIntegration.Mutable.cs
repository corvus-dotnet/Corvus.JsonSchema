...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ConfigureVsCodeIntegration
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfigureVsCodeIntegration.JsonStringArray.Mutable Extensions
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExtensionsUtf8, out Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfigureVsCodeIntegration.JsonStringArray.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetExtensions(in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfigureVsCodeIntegration.JsonStringArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetExtensions<TContext>(in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfigureVsCodeIntegration.JsonStringArray.Source<TContext> value)
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfigureVsCodeIntegration.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfigureVsCodeIntegration.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfigureVsCodeIntegration.JsonStringArray.Source extensions = default)
            {
            ...
            /// Creates an instance of a <see cref="ConfigureVsCodeIntegration"/>.
            /// </summary>
            public void Create(in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfigureVsCodeIntegration.JsonStringArray.Source extensions = default)
            {
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfigureVsCodeIntegration.JsonStringArray.Source<TContext> extensions = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="ConfigureVsCodeIntegration"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfigureVsCodeIntegration.JsonStringArray.Source<TContext> extensions = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfigureVsCodeIntegration.JsonStringArray.Source extensions = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfigureVsCodeIntegration.JsonStringArray.Source<TContext> extensions = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
