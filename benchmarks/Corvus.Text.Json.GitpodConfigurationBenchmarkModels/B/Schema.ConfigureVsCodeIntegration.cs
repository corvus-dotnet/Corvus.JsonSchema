...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfigureVsCodeIntegration.JsonStringArray Extensions
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExtensionsUtf8, out Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfigureVsCodeIntegration.JsonStringArray value))
                {
                    return value;
                }
