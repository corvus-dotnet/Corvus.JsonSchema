...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ConfiguresGitpodSGitHubApp
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ConfiguresGitpodSGitHubApp instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ConfiguresGitpodSGitHubApp"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ConfiguresGitpodSGitHubApp(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfiguresGitpodSGitHubApp.PrebuildsEntity.Mutable Prebuilds
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrebuildsUtf8, out Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfiguresGitpodSGitHubApp.PrebuildsEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ConfiguresGitpodSGitHubApp(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetPrebuilds(in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfiguresGitpodSGitHubApp.PrebuildsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetPrebuilds<TContext>(in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfiguresGitpodSGitHubApp.PrebuildsEntity.Source<TContext> value)
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ConfiguresGitpodSGitHubApp.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ConfiguresGitpodSGitHubApp"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ConfiguresGitpodSGitHubApp"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ConfiguresGitpodSGitHubApp Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ConfiguresGitpodSGitHubApp>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ConfiguresGitpodSGitHubApp"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ConfiguresGitpodSGitHubApp Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ConfiguresGitpodSGitHubApp>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfiguresGitpodSGitHubApp.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(ConfiguresGitpodSGitHubApp instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfiguresGitpodSGitHubApp.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ConfiguresGitpodSGitHubApp"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfiguresGitpodSGitHubApp.PrebuildsEntity.Source prebuilds = default)
            {
            ...
            /// Creates an instance of a <see cref="ConfiguresGitpodSGitHubApp"/>.
            /// </summary>
            public void Create(in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfiguresGitpodSGitHubApp.PrebuildsEntity.Source prebuilds = default)
            {
                Create(ref _builder, prebuilds);
            }
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfiguresGitpodSGitHubApp.PrebuildsEntity.Source<TContext> prebuilds = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="ConfiguresGitpodSGitHubApp"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfiguresGitpodSGitHubApp.PrebuildsEntity.Source<TContext> prebuilds = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
                Create(context, ref _builder, prebuilds);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfiguresGitpodSGitHubApp.PrebuildsEntity.Source prebuilds = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(prebuilds);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfiguresGitpodSGitHubApp.PrebuildsEntity.Source<TContext> prebuilds = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        {
            return workspace.CreateBuilder<ConfiguresGitpodSGitHubApp, Mutable>(this);
        }
    }
}
