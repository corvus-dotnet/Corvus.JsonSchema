...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfiguresGitpodSGitHubApp.PrebuildsEntity Prebuilds
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrebuildsUtf8, out Corvus.GitpodConfigurationBenchmark.Baseline.Schema.ConfiguresGitpodSGitHubApp.PrebuildsEntity value))
                {
                    return value;
                }
