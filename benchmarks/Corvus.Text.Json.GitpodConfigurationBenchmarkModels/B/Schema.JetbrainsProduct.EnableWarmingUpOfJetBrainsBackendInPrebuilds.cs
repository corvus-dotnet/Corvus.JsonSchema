...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JetbrainsProduct
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.GitpodConfigurationBenchmark.Baseline.Schema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.VersionEntity Version
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.GitpodConfigurationBenchmark.Baseline.Schema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.VersionEntity value))
                    {
                        return value;
                    }
