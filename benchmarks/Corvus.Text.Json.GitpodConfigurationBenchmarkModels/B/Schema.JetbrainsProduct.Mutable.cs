...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JetbrainsProduct
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(JetbrainsProduct instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="JetbrainsProduct"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JetbrainsProduct(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.GitpodConfigurationBenchmark.Baseline.Schema.JetbrainsProduct.JsonStringArray.Mutable Plugins
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PluginsUtf8, out Corvus.GitpodConfigurationBenchmark.Baseline.Schema.JetbrainsProduct.JsonStringArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>prebuilds</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.GitpodConfigurationBenchmark.Baseline.Schema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.Mutable Prebuilds
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrebuildsUtf8, out Corvus.GitpodConfigurationBenchmark.Baseline.Schema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>vmoptions</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.GitpodConfigurationBenchmark.Baseline.JsonString.Mutable Vmoptions
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VmoptionsUtf8, out Corvus.GitpodConfigurationBenchmark.Baseline.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new JetbrainsProduct(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetPlugins(in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.JetbrainsProduct.JsonStringArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetPlugins<TContext>(in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.JetbrainsProduct.JsonStringArray.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetPrebuilds(in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PrebuildsUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrebuildsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetPrebuilds<TContext>(in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            /// <summary>
            /// Remove the <c>prebuilds</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemovePrebuilds()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PrebuildsUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetVmoptions(in Corvus.GitpodConfigurationBenchmark.Baseline.JsonString.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.VmoptionsUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VmoptionsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            /// <summary>
            /// Remove the <c>vmoptions</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveVmoptions()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.VmoptionsUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"JetbrainsProduct.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="JetbrainsProduct"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="JetbrainsProduct"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly JetbrainsProduct Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<JetbrainsProduct>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="JetbrainsProduct"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly JetbrainsProduct Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<JetbrainsProduct>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.GitpodConfigurationBenchmark.Baseline.Schema.JetbrainsProduct.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(JetbrainsProduct instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.GitpodConfigurationBenchmark.Baseline.Schema.JetbrainsProduct.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="JetbrainsProduct"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.JetbrainsProduct.JsonStringArray.Source plugins = default,
                in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.Source prebuilds = default,
                in Corvus.GitpodConfigurationBenchmark.Baseline.JsonString.Source vmoptions = default)
            {
            ...
            public void Create(
                ...
                in Corvus.GitpodConfigurationBenchmark.Baseline.JsonString.Source vmoptions = default)
            {
                Create(ref _builder, plugins, prebuilds, vmoptions);
            }
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.JetbrainsProduct.JsonStringArray.Source<TContext> plugins = default,
                in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.Source<TContext> prebuilds = default,
                in Corvus.GitpodConfigurationBenchmark.Baseline.JsonString.Source vmoptions = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            ...
            #endif
            {
                Create(context, ref _builder, plugins, prebuilds, vmoptions);
            }
        ...
        /// <param name="prebuilds">The value of the property.</param>
        /// <param name="vmoptions">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.JetbrainsProduct.JsonStringArray.Source plugins = default, in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.Source prebuilds = default, in Corvus.GitpodConfigurationBenchmark.Baseline.JsonString.Source vmoptions = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(plugins, prebuilds, vmoptions);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
            ...
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, plugins, prebuilds, vmoptions);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<JetbrainsProduct, Mutable>(this);
        }
    }
}
