...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JetbrainsProduct"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal JetbrainsProduct(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static JetbrainsProduct DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.GitpodConfigurationBenchmark.Baseline.Schema.JetbrainsProduct.JsonStringArray Plugins
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PluginsUtf8, out Corvus.GitpodConfigurationBenchmark.Baseline.Schema.JetbrainsProduct.JsonStringArray value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.GitpodConfigurationBenchmark.Baseline.Schema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds Prebuilds
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrebuildsUtf8, out Corvus.GitpodConfigurationBenchmark.Baseline.Schema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.GitpodConfigurationBenchmark.Baseline.JsonString Vmoptions
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VmoptionsUtf8, out Corvus.GitpodConfigurationBenchmark.Baseline.JsonString value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in JetbrainsProduct left, in JetbrainsProduct right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in JetbrainsProduct left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(JetbrainsProduct instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JetbrainsProduct(JsonElement instance)
        {
            return JetbrainsProduct.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JetbrainsProduct From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JetbrainsProduct ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<JetbrainsProduct>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JetbrainsProduct ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<JetbrainsProduct>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JetbrainsProduct ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<JetbrainsProduct>(json, options);
        }
        ...
        /// </exception>
        public static JetbrainsProduct ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<JetbrainsProduct>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out JetbrainsProduct? result)
        {
            return JsonElementHelpers.TryParseValue<JetbrainsProduct>(ref reader, out result);
        }
...
#if NET
        static JetbrainsProduct IJsonElement<JetbrainsProduct>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JetbrainsProduct: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public JetbrainsProduct Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<JetbrainsProduct>(_idx);
            }
        ...
        public static class JsonPropertyNames
        {
            ...
            /// <summary>
            /// Gets the JSON property name for <see cref="Prebuilds"/>.
            /// </summary>
            public const string Prebuilds = "prebuilds";

            /// <summary>
            /// Gets the JSON property name for <see cref="Vmoptions"/>.
            /// </summary>
            public const string Vmoptions = "vmoptions";
            ...
            /// Gets the JSON property name for <see cref="Prebuilds"/>.
            /// </summary>
            public static ReadOnlySpan<byte> PrebuildsUtf8 => "prebuilds"u8;

            /// <summary>
            /// Gets the JSON property name for <see cref="Vmoptions"/>.
            /// </summary>
            public static ReadOnlySpan<byte> VmoptionsUtf8 => "vmoptions"u8;
        }
        ...
        private static class JsonPropertyNamesEscaped
        {
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Prebuilds"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Prebuilds => "prebuilds"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Vmoptions"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Vmoptions => "vmoptions"u8;
        }
    }
}
