...
public readonly partial struct Schema
{
        ...
        : IJsonElement<RequiredPortArray>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://gitpod.io/schemas/gitpod-schema.json#/properties/ports"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://gitpod.io/schemas/gitpod-schema.json#/properties/ports";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://gitpod.io/schemas/gitpod-schema.json#/properties/ports"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (arrayValidation_enumerator.MoveNext())
                    {
                        ...
                        JsonSchemaContext childContext = Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.JsonSchema.PushChildContext(
                            parentDocument,
                        ...
                        Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
