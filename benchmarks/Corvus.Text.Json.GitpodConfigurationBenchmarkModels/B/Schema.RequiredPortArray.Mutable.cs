...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RequiredPortArray
    {
...
#endif
        {
            ...
            public Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort oldItem, in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort current = enumerator.Current;
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
