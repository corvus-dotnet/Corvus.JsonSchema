        ...
        public readonly partial struct RequiredPort
        {
            ...
            public readonly partial struct TheProtocolOfWorkspacePort
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(TheProtocolOfWorkspacePort instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="TheProtocolOfWorkspacePort"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TheProtocolOfWorkspacePort(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new TheProtocolOfWorkspacePort(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TheProtocolOfWorkspacePort.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="TheProtocolOfWorkspacePort"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="TheProtocolOfWorkspacePort"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheProtocolOfWorkspacePort Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<TheProtocolOfWorkspacePort>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="TheProtocolOfWorkspacePort"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheProtocolOfWorkspacePort Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<TheProtocolOfWorkspacePort>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(TheProtocolOfWorkspacePort instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<TheProtocolOfWorkspacePort, Mutable>(this);
                }
            }
        }
    }
