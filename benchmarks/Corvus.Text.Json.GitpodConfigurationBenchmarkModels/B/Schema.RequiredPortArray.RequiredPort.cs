...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RequiredPortArray
    {
...
#endif
        {
            ...
            internal RequiredPort(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </para>
            /// </remarks>
            public Corvus.GitpodConfigurationBenchmark.Baseline.JsonString Description
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out Corvus.GitpodConfigurationBenchmark.Baseline.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.OnOpenEntity OnOpen
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OnOpenUtf8, out Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.OnOpenEntity value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.PortEntity Port
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PortUtf8, out Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.PortEntity value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.TheProtocolOfWorkspacePort Protocol
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProtocolUtf8, out Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.TheProtocolOfWorkspacePort value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.VisibilityEntity Visibility
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VisibilityUtf8, out Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.VisibilityEntity value))
                    {
                        return value;
                    }

                    return Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.VisibilityEntity.DefaultInstance;
                }
            }
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RequiredPort left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RequiredPort instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredPort(JsonElement instance)
            {
                return RequiredPort.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredPort From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredPort ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredPort>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredPort ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredPort>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredPort ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredPort>(json, options);
            }
            ...
            /// </exception>
            public static RequiredPort ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RequiredPort>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredPort? result)
            {
                return JsonElementHelpers.TryParseValue<RequiredPort>(ref reader, out result);
            }
...
#if NET
            static RequiredPort IJsonElement<RequiredPort>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredPort: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public static class JsonPropertyNames
            {
                ...
                /// <summary>
                /// Gets the JSON property name for <see cref="OnOpen"/>.
                /// </summary>
                ...
                /// <summary>
                /// Gets the JSON property name for <see cref="Visibility"/>.
                /// </summary>
                ...
                /// Gets the JSON property name for <see cref="OnOpen"/>.
                /// </summary>
                public static ReadOnlySpan<byte> OnOpenUtf8 => "onOpen"u8;
                ...
                /// Gets the JSON property name for <see cref="Visibility"/>.
                /// </summary>
                public static ReadOnlySpan<byte> VisibilityUtf8 => "visibility"u8;
            }
            ...
            private static class JsonPropertyNamesEscaped
            {
                ...
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="OnOpen"/>.
                /// </summary>
                public static ReadOnlySpan<byte> OnOpen => "onOpen"u8;
                ...
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Visibility"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Visibility => "visibility"u8;
            }
        }
    }
}
