...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RequiredPortArray
        ...
        : IJsonElement<RequiredPortArray>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequiredPortArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal RequiredPortArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RequiredPortArray DefaultInstance { get; }
        ...
        public Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in RequiredPortArray left, in RequiredPortArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RequiredPortArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(RequiredPortArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RequiredPortArray(JsonElement instance)
        {
            return RequiredPortArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredPortArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredPortArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredPortArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredPortArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredPortArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredPortArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredPortArray>(json, options);
        }
        ...
        /// </exception>
        public static RequiredPortArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<RequiredPortArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredPortArray? result)
        {
            return JsonElementHelpers.TryParseValue<RequiredPortArray>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new RequiredPortArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static RequiredPortArray IJsonElement<RequiredPortArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RequiredPortArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="RequiredPortArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="RequiredPortArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public RequiredPortArray Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<RequiredPortArray>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="RequiredPortArray"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public RequiredPortArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<RequiredPortArray>(_idx);
            }
