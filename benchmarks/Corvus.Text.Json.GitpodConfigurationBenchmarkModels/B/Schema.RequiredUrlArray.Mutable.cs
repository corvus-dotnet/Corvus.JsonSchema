...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RequiredUrlArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RequiredUrlArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RequiredUrlArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredUrlArray(Mutable instance)
            {
            ...
            public Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredUrlArray.RequiredUrl.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredUrlArray.RequiredUrl.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredUrlArray.RequiredUrl.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredUrlArray.RequiredUrl.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RequiredUrlArray(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredUrlArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredUrlArray.RequiredUrl.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredUrlArray.RequiredUrl.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredUrlArray.RequiredUrl.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredUrlArray.RequiredUrl item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredUrlArray.RequiredUrl>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredUrlArray.RequiredUrl> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredUrlArray.RequiredUrl>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredUrlArray.RequiredUrl oldItem, in Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredUrlArray.RequiredUrl.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredUrlArray.RequiredUrl>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredUrlArray.RequiredUrl current = enumerator.Current;
            ...
            /// <summary>
            /// Gets a <see cref="RequiredUrlArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RequiredUrlArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly RequiredUrlArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RequiredUrlArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RequiredUrlArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly RequiredUrlArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RequiredUrlArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredUrlArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(RequiredUrlArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredUrlArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<RequiredUrlArray, Mutable>(this);
        }
    }
}
