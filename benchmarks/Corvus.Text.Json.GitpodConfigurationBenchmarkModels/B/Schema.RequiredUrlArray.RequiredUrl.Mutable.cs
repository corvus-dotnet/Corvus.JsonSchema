    ...
    public readonly partial struct RequiredUrlArray
    {
        ...
        public readonly partial struct RequiredUrl
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.GitpodConfigurationBenchmark.Baseline.JsonString.Mutable Url
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UrlUtf8, out Corvus.GitpodConfigurationBenchmark.Baseline.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetUrl(in Corvus.GitpodConfigurationBenchmark.Baseline.JsonString.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredUrlArray.RequiredUrl.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredUrlArray.RequiredUrl.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.GitpodConfigurationBenchmark.Baseline.JsonString.Source url,
                ...
                /// Creates an instance of a <see cref="RequiredUrl"/>.
                /// </summary>
                public void Create(in Corvus.GitpodConfigurationBenchmark.Baseline.JsonString.Source url, in Corvus.GitpodConfigurationBenchmark.Baseline.JsonString.Source checkoutLocation = default)
                {
                    Create(ref _builder, url, checkoutLocation);
                }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.GitpodConfigurationBenchmark.Baseline.JsonString.Source url, in Corvus.GitpodConfigurationBenchmark.Baseline.JsonString.Source checkoutLocation = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(url, checkoutLocation);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
