...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TasksEntityArray
    {
            ...
            : IJsonElement<TasksEntity>
        {
            ...
            {
                private static readonly JsonSchemaPathProvider BeforeSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/before"u8, buffer, out written);
                ...
                private static readonly JsonSchemaPathProvider InitSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/init"u8, buffer, out written);
                ...
                private static readonly JsonSchemaPathProvider OpenInSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/openIn"u8, buffer, out written);
                ...
                private static void MatchBefore(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    JsonSchemaContext childContext =
                        Corvus.GitpodConfigurationBenchmark.Baseline.JsonString.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.BeforeUtf8,
                            evaluationPath: BeforeSchemaEvaluationPath);

                    Corvus.GitpodConfigurationBenchmark.Baseline.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                private static void MatchCommand(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    Corvus.GitpodConfigurationBenchmark.Baseline.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                ...
                private static void MatchEnv(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    JsonSchemaContext childContext2 =
                        Corvus.GitpodConfigurationBenchmark.Baseline.Schema.TasksEntityArray.TasksEntity.EnvironmentVariablesToSet.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.GitpodConfigurationBenchmark.Baseline.Schema.TasksEntityArray.TasksEntity.EnvironmentVariablesToSet.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                ...
                private static void MatchInit(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    JsonSchemaContext childContext3 =
                        Corvus.GitpodConfigurationBenchmark.Baseline.JsonString.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.InitUtf8,
                            evaluationPath: InitSchemaEvaluationPath);

                    Corvus.GitpodConfigurationBenchmark.Baseline.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
                ...
                private static void MatchName(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    Corvus.GitpodConfigurationBenchmark.Baseline.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext4);
                ...
                private static void MatchOpenIn(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    JsonSchemaContext childContext5 =
                        Corvus.GitpodConfigurationBenchmark.Baseline.Schema.TasksEntityArray.TasksEntity.OpenInEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.OpenInUtf8,
                            evaluationPath: OpenInSchemaEvaluationPath);

                    Corvus.GitpodConfigurationBenchmark.Baseline.Schema.TasksEntityArray.TasksEntity.OpenInEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext5);
                ...
                private static void MatchOpenMode(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    JsonSchemaContext childContext6 =
                        Corvus.GitpodConfigurationBenchmark.Baseline.Schema.TasksEntityArray.TasksEntity.TheOpeningModeDefaultIsTabAfter.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.OpenModeUtf8,
                            evaluationPath: OpenModeSchemaEvaluationPath);

                    Corvus.GitpodConfigurationBenchmark.Baseline.Schema.TasksEntityArray.TasksEntity.TheOpeningModeDefaultIsTabAfter.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext6);
                ...
                private static void MatchPrebuild(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    JsonSchemaContext childContext7 =
                        Corvus.GitpodConfigurationBenchmark.Baseline.JsonString.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.PrebuildUtf8,
                            evaluationPath: PrebuildSchemaEvaluationPath);

                    Corvus.GitpodConfigurationBenchmark.Baseline.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext7);
                ...
                private static PropertySchemaMatchers<Corvus.GitpodConfigurationBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Corvus.GitpodConfigurationBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator>([
                        (static () => JsonPropertyNames.BeforeUtf8, MatchBefore),
                        (static () => JsonPropertyNames.CommandUtf8, MatchCommand),
                        (static () => JsonPropertyNames.EnvUtf8, MatchEnv),
                        (static () => JsonPropertyNames.InitUtf8, MatchInit),
                        (static () => JsonPropertyNames.NameUtf8, MatchName),
                        (static () => JsonPropertyNames.OpenInUtf8, MatchOpenIn),
                        (static () => JsonPropertyNames.OpenModeUtf8, MatchOpenMode),
                        (static () => JsonPropertyNames.PrebuildUtf8, MatchPrebuild),
                    ]);
                }
