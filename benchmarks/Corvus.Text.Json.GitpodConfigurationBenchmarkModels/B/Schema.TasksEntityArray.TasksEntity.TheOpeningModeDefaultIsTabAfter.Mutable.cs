        ...
        public readonly partial struct TasksEntity
        {
            ...
            public readonly partial struct TheOpeningModeDefaultIsTabAfter
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(TheOpeningModeDefaultIsTabAfter instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="TheOpeningModeDefaultIsTabAfter"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TheOpeningModeDefaultIsTabAfter(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TheOpeningModeDefaultIsTabAfter.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheOpeningModeDefaultIsTabAfter Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheOpeningModeDefaultIsTabAfter Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<TheOpeningModeDefaultIsTabAfter>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(TheOpeningModeDefaultIsTabAfter instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<TheOpeningModeDefaultIsTabAfter, Mutable>(this);
                }
            }
        }
    }
