...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public Corvus.GitpodConfigurationBenchmark.Baseline.Schema.TasksEntityArray.TasksEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.GitpodConfigurationBenchmark.Baseline.Schema.TasksEntityArray.TasksEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.GitpodConfigurationBenchmark.Baseline.Schema.TasksEntityArray.TasksEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.GitpodConfigurationBenchmark.Baseline.Schema.TasksEntityArray.TasksEntity>(_parent, _idx);
        }
