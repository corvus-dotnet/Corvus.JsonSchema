...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TheDockerImageToRunYourWorkspaceIn
#if NET8_0_OR_GREATER
        : IJsonElement<TheDockerImageToRunYourWorkspaceIn>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TheDockerImageToRunYourWorkspaceIn"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TheDockerImageToRunYourWorkspaceIn(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TheDockerImageToRunYourWorkspaceIn DefaultInstance { get; } = ParsedJsonDocument<TheDockerImageToRunYourWorkspaceIn>.StringConstant([.."\"gitpod/workspace-full\""u8]);
        ...
        /// </para>
        /// </remarks>
        public Corvus.GitpodConfigurationBenchmark.Baseline.JsonString Context
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContextUtf8, out Corvus.GitpodConfigurationBenchmark.Baseline.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.GitpodConfigurationBenchmark.Baseline.JsonString File
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FileUtf8, out Corvus.GitpodConfigurationBenchmark.Baseline.JsonString value))
                {
                    return value;
                }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(TheDockerImageToRunYourWorkspaceIn value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in TheDockerImageToRunYourWorkspaceIn left, in TheDockerImageToRunYourWorkspaceIn right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TheDockerImageToRunYourWorkspaceIn left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(TheDockerImageToRunYourWorkspaceIn instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TheDockerImageToRunYourWorkspaceIn(JsonElement instance)
        {
            return TheDockerImageToRunYourWorkspaceIn.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheDockerImageToRunYourWorkspaceIn From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheDockerImageToRunYourWorkspaceIn ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TheDockerImageToRunYourWorkspaceIn>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheDockerImageToRunYourWorkspaceIn ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TheDockerImageToRunYourWorkspaceIn>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheDockerImageToRunYourWorkspaceIn ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TheDockerImageToRunYourWorkspaceIn>(json, options);
        }
        ...
        /// </exception>
        public static TheDockerImageToRunYourWorkspaceIn ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<TheDockerImageToRunYourWorkspaceIn>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TheDockerImageToRunYourWorkspaceIn? result)
        {
            return JsonElementHelpers.TryParseValue<TheDockerImageToRunYourWorkspaceIn>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TheDockerImageToRunYourWorkspaceIn(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static TheDockerImageToRunYourWorkspaceIn IJsonElement<TheDockerImageToRunYourWorkspaceIn>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TheDockerImageToRunYourWorkspaceIn: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TheDockerImageToRunYourWorkspaceIn"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TheDockerImageToRunYourWorkspaceIn"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public TheDockerImageToRunYourWorkspaceIn Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TheDockerImageToRunYourWorkspaceIn>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TheDockerImageToRunYourWorkspaceIn"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public TheDockerImageToRunYourWorkspaceIn Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TheDockerImageToRunYourWorkspaceIn>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="Context"/>.
            /// </summary>
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Context"/>.
            /// </summary>
