...
public readonly partial struct GitpodConfigurationSchema
{
    ...
    public readonly partial struct ConfigureJetBrainsIntegration
    {
...
#endif
        {
            ...
            public Corvus.GitpodConfigurationBenchmark.Current.JsonString this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.GitpodConfigurationBenchmark.Current.JsonString>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.GitpodConfigurationBenchmark.Current.JsonString> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.GitpodConfigurationBenchmark.Current.JsonString>(_parent, _idx);
            }
