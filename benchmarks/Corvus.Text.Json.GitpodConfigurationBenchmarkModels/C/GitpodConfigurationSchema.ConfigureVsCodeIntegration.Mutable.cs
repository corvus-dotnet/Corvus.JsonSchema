...
public readonly partial struct GitpodConfigurationSchema
{
    ...
    public readonly partial struct ConfigureVsCodeIntegration
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ConfigureVsCodeIntegration instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ConfigureVsCodeIntegration"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ConfigureVsCodeIntegration(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.ConfigureVsCodeIntegration.JsonStringArray.Mutable Extensions
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExtensionsUtf8, out Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.ConfigureVsCodeIntegration.JsonStringArray.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ConfigureVsCodeIntegration(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetExtensions<TContext>(in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.ConfigureVsCodeIntegration.JsonStringArray.Source<TContext> value)
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ConfigureVsCodeIntegration.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ConfigureVsCodeIntegration"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ConfigureVsCodeIntegration"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ConfigureVsCodeIntegration Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ConfigureVsCodeIntegration>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ConfigureVsCodeIntegration"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ConfigureVsCodeIntegration Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ConfigureVsCodeIntegration>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.ConfigureVsCodeIntegration.JsonStringArray.Source _createArg1;
            ...
            public static implicit operator Source(ConfigureVsCodeIntegration instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.ConfigureVsCodeIntegration.JsonStringArray.Source<TContext> _createArg1;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ConfigureVsCodeIntegration"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.ConfigureVsCodeIntegration.JsonStringArray.Source extensions = default)
            {
            ...
            /// Creates an instance of a <see cref="ConfigureVsCodeIntegration"/>.
            /// </summary>
            public void Create(in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.ConfigureVsCodeIntegration.JsonStringArray.Source extensions = default)
            {
                Create(ref _builder, extensions);
            }
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.ConfigureVsCodeIntegration.JsonStringArray.Source<TContext> extensions = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="ConfigureVsCodeIntegration"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.ConfigureVsCodeIntegration.JsonStringArray.Source<TContext> extensions = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
                Create(context, ref _builder, extensions);
            }
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.ConfigureVsCodeIntegration.JsonStringArray.Source<TContext> extensions = default)
            ...
            #endif
        {
            return new Source<TContext>(context, extensions);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.ConfigureVsCodeIntegration.JsonStringArray.Source extensions = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(extensions);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.ConfigureVsCodeIntegration.JsonStringArray.Source<TContext> extensions = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        {
            return workspace.CreateBuilder<ConfigureVsCodeIntegration, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ConfigureVsCodeIntegration> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ConfigureVsCodeIntegration>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ConfigureVsCodeIntegration> Create<TContext>(
        ...
        public static ParsedJsonDocument<ConfigureVsCodeIntegration> Create(in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.ConfigureVsCodeIntegration.JsonStringArray.Source extensions = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ConfigureVsCodeIntegration> Create<TContext>(in TContext context, in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.ConfigureVsCodeIntegration.JsonStringArray.Source<TContext> extensions = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
