...
public readonly partial struct GitpodConfigurationSchema
{
    ...
    public readonly partial struct ConfiguresGitpodSGitHubApp
        : IJsonElement<ConfiguresGitpodSGitHubApp>
    {
        public static partial class JsonSchema
        {
            private static readonly JsonSchemaPathProvider PrebuildsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/prebuilds"u8, buffer, out written);

            private static void MatchPrebuilds(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.ConfiguresGitpodSGitHubApp.PrebuildsEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.PrebuildsUtf8,
                        evaluationPath: PrebuildsSchemaEvaluationPath);

                Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.ConfiguresGitpodSGitHubApp.PrebuildsEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.PrebuildsUtf8))
                {
                    matcher = MatchPrebuilds;
                    return true;
                }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://gitpod.io/schemas/gitpod-schema.json#/properties/github"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://gitpod.io/schemas/gitpod-schema.json#/properties/github";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://gitpod.io/schemas/gitpod-schema.json#/properties/github"u8;
