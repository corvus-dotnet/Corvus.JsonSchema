    ...
    public readonly partial struct ConfiguresGitpodSGitHubApp
    {
        ...
        public readonly partial struct PrebuildsEntity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="AddCheckEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal AddCheckEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static AddCheckEntity DefaultInstance { get; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(AddCheckEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator bool(AddCheckEntity value)
                {
                ...
                /// </returns>
                public static bool operator ==(in AddCheckEntity left, in AddCheckEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in AddCheckEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(AddCheckEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AddCheckEntity(JsonElement instance)
                {
                    return AddCheckEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AddCheckEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AddCheckEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AddCheckEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AddCheckEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AddCheckEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AddCheckEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AddCheckEntity>(json, options);
                }
                ...
                /// </exception>
                public static AddCheckEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<AddCheckEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out AddCheckEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<AddCheckEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new AddCheckEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static AddCheckEntity IJsonElement<AddCheckEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AddCheckEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="AddCheckEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="AddCheckEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public AddCheckEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<AddCheckEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="AddCheckEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public AddCheckEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<AddCheckEntity>(_idx);
                    }
                ...
                /// <param name="matchPreventMergeOnError">Match 3rd item.</param>
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Func<TContext, TResult> matchPreventMergeOnError,
...
#endif
                {
                    ...
                    {
                        return matchPreventMergeOnError(context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Func<TResult> matchPreventMergeOnError,
                    Func<TResult> defaultMatch)
                {
                    ...
                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchPreventMergeOnError();
                    }
