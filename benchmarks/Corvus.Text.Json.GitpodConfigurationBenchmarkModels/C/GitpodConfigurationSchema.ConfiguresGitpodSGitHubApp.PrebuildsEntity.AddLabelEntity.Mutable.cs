        ...
        public readonly partial struct PrebuildsEntity
        {
            ...
            public readonly partial struct AddLabelEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(AddLabelEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="AddLabelEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AddLabelEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AddLabelEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AddLabelEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AddLabelEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<AddLabelEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(AddLabelEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<AddLabelEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<AddLabelEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<AddLabelEntity>();
                    }
                    finally
                    {
