...
public readonly partial struct GitpodConfigurationSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfiguresGitpodSGitHubApp"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ConfiguresGitpodSGitHubApp(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ConfiguresGitpodSGitHubApp DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.ConfiguresGitpodSGitHubApp.PrebuildsEntity Prebuilds
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrebuildsUtf8, out Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.ConfiguresGitpodSGitHubApp.PrebuildsEntity value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in ConfiguresGitpodSGitHubApp left, in ConfiguresGitpodSGitHubApp right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ConfiguresGitpodSGitHubApp left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ConfiguresGitpodSGitHubApp instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ConfiguresGitpodSGitHubApp(JsonElement instance)
        {
            return ConfiguresGitpodSGitHubApp.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfiguresGitpodSGitHubApp From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfiguresGitpodSGitHubApp ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ConfiguresGitpodSGitHubApp>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfiguresGitpodSGitHubApp ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ConfiguresGitpodSGitHubApp>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfiguresGitpodSGitHubApp ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ConfiguresGitpodSGitHubApp>(json, options);
        }
        ...
        /// </exception>
        public static ConfiguresGitpodSGitHubApp ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ConfiguresGitpodSGitHubApp>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ConfiguresGitpodSGitHubApp? result)
        {
            return JsonElementHelpers.TryParseValue<ConfiguresGitpodSGitHubApp>(ref reader, out result);
        }
...
#if NET
        static ConfiguresGitpodSGitHubApp IJsonElement<ConfiguresGitpodSGitHubApp>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ConfiguresGitpodSGitHubApp: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public ConfiguresGitpodSGitHubApp Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public ConfiguresGitpodSGitHubApp Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ConfiguresGitpodSGitHubApp>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Prebuilds"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Prebuilds => [0xB5, 0x00, 0x00, 0x00, 0x22, 0x70, 0x72, 0x65, 0x62, 0x75, 0x69, 0x6C, 0x64, 0x73, 0x22];
        }
    }
}
