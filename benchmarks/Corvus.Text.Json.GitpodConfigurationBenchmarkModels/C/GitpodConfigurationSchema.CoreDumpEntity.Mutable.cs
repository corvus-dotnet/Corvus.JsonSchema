...
public readonly partial struct GitpodConfigurationSchema
{
    ...
    public readonly partial struct CoreDumpEntity
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.GitpodConfigurationBenchmark.Current.JsonBoolean.Mutable Enabled
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnabledUtf8, out Corvus.GitpodConfigurationBenchmark.Current.JsonBoolean.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.GitpodConfigurationBenchmark.Current.JsonNumber.Mutable HardLimit
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HardLimitUtf8, out Corvus.GitpodConfigurationBenchmark.Current.JsonNumber.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.GitpodConfigurationBenchmark.Current.JsonNumber.Mutable SoftLimit
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SoftLimitUtf8, out Corvus.GitpodConfigurationBenchmark.Current.JsonNumber.Mutable value))
                    {
                        return value;
                    }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.CoreDumpEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.GitpodConfigurationBenchmark.Current.JsonBoolean.Source enabled = default,
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.GitpodConfigurationBenchmark.Current.JsonBoolean.Source enabled = default, in Corvus.GitpodConfigurationBenchmark.Current.JsonNumber.Source hardLimit = default, in Corvus.GitpodConfigurationBenchmark.Current.JsonNumber.Source softLimit = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        public static ParsedJsonDocument<CoreDumpEntity> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<CoreDumpEntity>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<CoreDumpEntity> Create<TContext>(
        ...
        public static ParsedJsonDocument<CoreDumpEntity> Create(in Corvus.GitpodConfigurationBenchmark.Current.JsonBoolean.Source enabled = default, in Corvus.GitpodConfigurationBenchmark.Current.JsonNumber.Source hardLimit = default, in Corvus.GitpodConfigurationBenchmark.Current.JsonNumber.Source softLimit = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
