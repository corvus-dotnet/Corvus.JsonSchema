...
public readonly partial struct GitpodConfigurationSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CoreDumpEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal CoreDumpEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static CoreDumpEntity DefaultInstance { get; }

        /// <summary>
        /// Gets the (optional) <c>enabled</c> property.
        /// </summary>
        public Corvus.GitpodConfigurationBenchmark.Current.JsonBoolean Enabled
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnabledUtf8, out Corvus.GitpodConfigurationBenchmark.Current.JsonBoolean value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the (optional) <c>hardLimit</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.GitpodConfigurationBenchmark.Current.JsonNumber HardLimit
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HardLimitUtf8, out Corvus.GitpodConfigurationBenchmark.Current.JsonNumber value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the (optional) <c>softLimit</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.GitpodConfigurationBenchmark.Current.JsonNumber SoftLimit
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SoftLimitUtf8, out Corvus.GitpodConfigurationBenchmark.Current.JsonNumber value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in CoreDumpEntity left, in CoreDumpEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in CoreDumpEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(CoreDumpEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator CoreDumpEntity(JsonElement instance)
        {
            return CoreDumpEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CoreDumpEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CoreDumpEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CoreDumpEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CoreDumpEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CoreDumpEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CoreDumpEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CoreDumpEntity>(json, options);
        }
        ...
        /// </exception>
        public static CoreDumpEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<CoreDumpEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out CoreDumpEntity? result)
        {
            return JsonElementHelpers.TryParseValue<CoreDumpEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new CoreDumpEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static CoreDumpEntity IJsonElement<CoreDumpEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"CoreDumpEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="CoreDumpEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="CoreDumpEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public CoreDumpEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<CoreDumpEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="CoreDumpEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public CoreDumpEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<CoreDumpEntity>(_idx);
            }
        ...
        public static class JsonPropertyNames
        {
            ...
            /// <summary>
            /// Gets the JSON property name for <see cref="HardLimit"/>.
            /// </summary>
            public const string HardLimit = "hardLimit";

            /// <summary>
            /// Gets the JSON property name for <see cref="SoftLimit"/>.
            /// </summary>
            ...
            /// Gets the JSON property name for <see cref="HardLimit"/>.
            /// </summary>
            public static ReadOnlySpan<byte> HardLimitUtf8 => "hardLimit"u8;

            /// <summary>
            /// Gets the JSON property name for <see cref="SoftLimit"/>.
            /// </summary>
            public static ReadOnlySpan<byte> SoftLimitUtf8 => "softLimit"u8;
        }
        ...
        private static class JsonPropertyNamesEscaped
        {
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="HardLimit"/>.
            /// </summary>
            public static ReadOnlySpan<byte> HardLimit => "hardLimit"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="SoftLimit"/>.
            /// </summary>
            public static ReadOnlySpan<byte> SoftLimit => "softLimit"u8;
        }
        ...
        private static class JsonPropertyNamesPrebaked
        {
            ...
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="HardLimit"/>.
            /// </summary>
            public static ReadOnlySpan<byte> HardLimit => [0xB5, 0x00, 0x00, 0x00, 0x22, 0x68, 0x61, 0x72, 0x64, 0x4C, 0x69, 0x6D, 0x69, 0x74, 0x22];

            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="SoftLimit"/>.
            /// </summary>
            public static ReadOnlySpan<byte> SoftLimit => [0xB5, 0x00, 0x00, 0x00, 0x22, 0x73, 0x6F, 0x66, 0x74, 0x4C, 0x69, 0x6D, 0x69, 0x74, 0x22];
        }
    }
}
