    ...
    public readonly partial struct JetbrainsProduct
    {
        ...
        public readonly partial struct EnableWarmingUpOfJetBrainsBackendInPrebuilds
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(EnableWarmingUpOfJetBrainsBackendInPrebuilds instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EnableWarmingUpOfJetBrainsBackendInPrebuilds"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EnableWarmingUpOfJetBrainsBackendInPrebuilds(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.VersionEntity.Mutable Version
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.VersionEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EnableWarmingUpOfJetBrainsBackendInPrebuilds.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly EnableWarmingUpOfJetBrainsBackendInPrebuilds Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly EnableWarmingUpOfJetBrainsBackendInPrebuilds Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EnableWarmingUpOfJetBrainsBackendInPrebuilds>(_idx);
                }
            }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="EnableWarmingUpOfJetBrainsBackendInPrebuilds"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.VersionEntity.Source version = default)
                {
                ...
                /// Creates an instance of a <see cref="EnableWarmingUpOfJetBrainsBackendInPrebuilds"/>.
                /// </summary>
                public void Create(in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.VersionEntity.Source version = default)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.VersionEntity.Source version = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            {
                return workspace.CreateBuilder<EnableWarmingUpOfJetBrainsBackendInPrebuilds, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<EnableWarmingUpOfJetBrainsBackendInPrebuilds> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EnableWarmingUpOfJetBrainsBackendInPrebuilds>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<EnableWarmingUpOfJetBrainsBackendInPrebuilds> Create<TContext>(
            ...
            public static ParsedJsonDocument<EnableWarmingUpOfJetBrainsBackendInPrebuilds> Create(in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.VersionEntity.Source version = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
