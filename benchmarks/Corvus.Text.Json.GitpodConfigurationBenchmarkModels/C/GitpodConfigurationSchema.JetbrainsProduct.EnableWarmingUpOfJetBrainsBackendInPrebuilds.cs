...
public readonly partial struct GitpodConfigurationSchema
{
    ...
    public readonly partial struct JetbrainsProduct
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="EnableWarmingUpOfJetBrainsBackendInPrebuilds"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal EnableWarmingUpOfJetBrainsBackendInPrebuilds(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static EnableWarmingUpOfJetBrainsBackendInPrebuilds DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.VersionEntity Version
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.VersionEntity value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in EnableWarmingUpOfJetBrainsBackendInPrebuilds left, in EnableWarmingUpOfJetBrainsBackendInPrebuilds right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in EnableWarmingUpOfJetBrainsBackendInPrebuilds left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(EnableWarmingUpOfJetBrainsBackendInPrebuilds instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnableWarmingUpOfJetBrainsBackendInPrebuilds(JsonElement instance)
            {
                return EnableWarmingUpOfJetBrainsBackendInPrebuilds.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableWarmingUpOfJetBrainsBackendInPrebuilds From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableWarmingUpOfJetBrainsBackendInPrebuilds ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableWarmingUpOfJetBrainsBackendInPrebuilds>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableWarmingUpOfJetBrainsBackendInPrebuilds ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableWarmingUpOfJetBrainsBackendInPrebuilds>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableWarmingUpOfJetBrainsBackendInPrebuilds ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableWarmingUpOfJetBrainsBackendInPrebuilds>(json, options);
            }
            ...
            /// </exception>
            public static EnableWarmingUpOfJetBrainsBackendInPrebuilds ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<EnableWarmingUpOfJetBrainsBackendInPrebuilds>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out EnableWarmingUpOfJetBrainsBackendInPrebuilds? result)
            {
                return JsonElementHelpers.TryParseValue<EnableWarmingUpOfJetBrainsBackendInPrebuilds>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new EnableWarmingUpOfJetBrainsBackendInPrebuilds(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static EnableWarmingUpOfJetBrainsBackendInPrebuilds IJsonElement<EnableWarmingUpOfJetBrainsBackendInPrebuilds>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnableWarmingUpOfJetBrainsBackendInPrebuilds: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="EnableWarmingUpOfJetBrainsBackendInPrebuilds"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="EnableWarmingUpOfJetBrainsBackendInPrebuilds"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public EnableWarmingUpOfJetBrainsBackendInPrebuilds Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<EnableWarmingUpOfJetBrainsBackendInPrebuilds>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="EnableWarmingUpOfJetBrainsBackendInPrebuilds"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public EnableWarmingUpOfJetBrainsBackendInPrebuilds Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<EnableWarmingUpOfJetBrainsBackendInPrebuilds>(_idx);
                }
