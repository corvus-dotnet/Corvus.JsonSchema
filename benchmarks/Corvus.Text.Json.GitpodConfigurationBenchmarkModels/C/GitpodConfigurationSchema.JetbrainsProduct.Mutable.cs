...
public readonly partial struct GitpodConfigurationSchema
{
    ...
    public readonly partial struct JetbrainsProduct
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.JsonStringArray.Mutable Plugins
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PluginsUtf8, out Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.JsonStringArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.Mutable Prebuilds
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrebuildsUtf8, out Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.GitpodConfigurationBenchmark.Current.JsonString.Mutable Vmoptions
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VmoptionsUtf8, out Corvus.GitpodConfigurationBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetPlugins<TContext>(in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.JsonStringArray.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetPrebuilds<TContext>(in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.JsonStringArray.Source _createArg1;
            private readonly Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.Source _createArg2;
            ...
            #endif
        {
            ...
            private readonly Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.JsonStringArray.Source<TContext> _createArg1;
            private readonly Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.Source<TContext> _createArg2;
            private readonly Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source _createArg3;
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.JsonStringArray.Source plugins = default,
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.JsonStringArray.Source<TContext> plugins = default,
                in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.Source<TContext> prebuilds = default,
                in Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source vmoptions = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.JsonStringArray.Source<TContext> plugins = default, scoped in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.Source<TContext> prebuilds = default, scoped in Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source vmoptions = default)
            ...
            #endif
        {
            return new Source<TContext>(context, plugins, prebuilds, vmoptions);
        }
        ...
        public static ParsedJsonDocument<JetbrainsProduct> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<JetbrainsProduct>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<JetbrainsProduct> Create<TContext>(
        ...
        public static ParsedJsonDocument<JetbrainsProduct> Create(in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.JsonStringArray.Source plugins = default, in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.Source prebuilds = default, in Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source vmoptions = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<JetbrainsProduct> Create<TContext>(in TContext context, in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.JsonStringArray.Source<TContext> plugins = default, in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.JetbrainsProduct.EnableWarmingUpOfJetBrainsBackendInPrebuilds.Source<TContext> prebuilds = default, in Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source vmoptions = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
