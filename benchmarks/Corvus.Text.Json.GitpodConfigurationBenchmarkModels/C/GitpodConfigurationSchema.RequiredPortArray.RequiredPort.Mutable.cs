    ...
    public readonly partial struct RequiredPortArray
    {
        ...
        public readonly partial struct RequiredPort
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequiredPort instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequiredPort"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredPort(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.GitpodConfigurationBenchmark.Current.JsonString.Mutable Description
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out Corvus.GitpodConfigurationBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.GitpodConfigurationBenchmark.Current.JsonString.Mutable Name
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.GitpodConfigurationBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// <summary>
                /// Gets the (optional) <c>onOpen</c> property.
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.OnOpenEntity.Mutable OnOpen
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OnOpenUtf8, out Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.OnOpenEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.PortEntity.Mutable Port
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PortUtf8, out Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.PortEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.TheProtocolOfWorkspacePort.Mutable Protocol
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProtocolUtf8, out Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.TheProtocolOfWorkspacePort.Mutable value))
                        {
                            return value;
                        }
                ...
                /// <summary>
                /// Gets the (optional) <c>visibility</c> property.
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.VisibilityEntity.Mutable Visibility
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VisibilityUtf8, out Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.VisibilityEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RequiredPort(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetOnOpen(scoped in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.OnOpenEntity.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.OnOpenUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OnOpenUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.OnOpen, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>onOpen</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveOnOpen()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.OnOpenUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                public void SetProtocol(scoped in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.TheProtocolOfWorkspacePort.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ProtocolUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }
                ...
                /// <summary>
                /// Remove the <c>protocol</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveProtocol()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ProtocolUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                public void SetVisibility(scoped in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.VisibilityEntity.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.VisibilityUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VisibilityUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Visibility, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>visibility</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveVisibility()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.VisibilityUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredPort.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RequiredPort"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RequiredPort"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredPort Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RequiredPort>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RequiredPort"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredPort Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequiredPort>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.PortEntity.Source _createArg1;
                private readonly Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source _createArg2;
                private readonly Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source _createArg3;
                private readonly Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.OnOpenEntity.Source _createArg4;
                private readonly Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.TheProtocolOfWorkspacePort.Source _createArg5;
                private readonly Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.VisibilityEntity.Source _createArg6;
                ...
                public static implicit operator Source(RequiredPort instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.PortEntity.Source port,
                    in Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source description = default,
                    in Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source name = default,
                    in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.OnOpenEntity.Source onOpen = default,
                    in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.TheProtocolOfWorkspacePort.Source protocol = default,
                    in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.VisibilityEntity.Source visibility = default)
                {
                    ...
                    onOpen.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.OnOpen, ref builder);
                    protocol.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Protocol, ref builder);
                    visibility.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Visibility, ref builder);
                }
                ...
                public void Create(
                    ...
                    in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.VisibilityEntity.Source visibility = default)
                {
                    Create(ref _builder, port, description, name, onOpen, protocol, visibility);
                }
            ...
            /// <param name="onOpen">The value of the <c>"onOpen"</c> property.</param>
            ...
            {
                return workspace.CreateBuilder<RequiredPort, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RequiredPort> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RequiredPort>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredPort> Create<TContext>(
            ...
            public static ParsedJsonDocument<RequiredPort> Create(in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.PortEntity.Source port, in Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source description = default, in Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source name = default, in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.OnOpenEntity.Source onOpen = default, in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.TheProtocolOfWorkspacePort.Source protocol = default, in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.VisibilityEntity.Source visibility = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
