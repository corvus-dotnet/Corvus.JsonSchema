        ...
        public readonly partial struct RequiredPort
        {
...
#endif
            {
                ...
                public void SetOnOpen(in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.OnOpenEntity.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsProperty(JsonPropertyNamesEscaped.OnOpen, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                public void SetProtocol(in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.TheProtocolOfWorkspacePort.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsProperty(JsonPropertyNamesEscaped.Protocol, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                public void SetVisibility(in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.VisibilityEntity.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsProperty(JsonPropertyNamesEscaped.Visibility, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
            ...
            public ref struct Builder
            {
                    ...
                    in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredPortArray.RequiredPort.VisibilityEntity.Source visibility = default)
                {
                    ...
                    onOpen.AddAsProperty(JsonPropertyNamesEscaped.OnOpen, ref builder, escapeName: false);
                    protocol.AddAsProperty(JsonPropertyNamesEscaped.Protocol, ref builder, escapeName: false);
                    visibility.AddAsProperty(JsonPropertyNamesEscaped.Visibility, ref builder, escapeName: false);
                }
