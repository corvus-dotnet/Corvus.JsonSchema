        ...
        public readonly partial struct RequiredPort
        {
            ...
            public readonly partial struct OnOpenEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(OnOpenEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="OnOpenEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator OnOpenEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new OnOpenEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"OnOpenEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="OnOpenEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="OnOpenEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OnOpenEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<OnOpenEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="OnOpenEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OnOpenEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<OnOpenEntity>(_idx);
                    }
                    ...
                    /// <param name="matchOpenBrowser">Match 1st item.</param>
                    /// <param name="matchOpenPreview">Match 2nd item.</param>
                    /// <param name="matchNotify">Match 3rd item.</param>
                    /// <param name="matchIgnore">Match 4th item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchOpenBrowser,
                        Func<TContext, TResult> matchOpenPreview,
                        Func<TContext, TResult> matchNotify,
...
#endif
                    {
                        ...
                        {
                            return matchOpenBrowser(context);
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchOpenPreview(context);
                        }

                        if (this.ValueEquals(Constants.Enum3))
                        {
                            return matchNotify(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> matchOpenBrowser,
                        Func<TResult> matchOpenPreview,
                        Func<TResult> matchNotify,
                        Func<TResult> matchIgnore,
                        Func<TResult> defaultMatch)
                    {
                        if (this.ValueEquals(Constants.Enum1))
                        {
                            return matchOpenBrowser();
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchOpenPreview();
                        }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(OnOpenEntity instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (OnOpenEntity)value;
                ...
                {
                    return workspace.CreateBuilder<OnOpenEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<OnOpenEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<OnOpenEntity>();
                    }
                    finally
                    {
