        ...
        public readonly partial struct RequiredPort
        {
            ...
            public readonly partial struct TheProtocolOfWorkspacePort
            {
                ...
                public ref struct Source
                {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (TheProtocolOfWorkspacePort)value;
                ...
                public static ParsedJsonDocument<TheProtocolOfWorkspacePort> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<TheProtocolOfWorkspacePort>();
                    }
                    finally
                    {
