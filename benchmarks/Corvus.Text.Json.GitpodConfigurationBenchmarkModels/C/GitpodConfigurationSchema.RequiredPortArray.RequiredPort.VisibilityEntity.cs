    ...
    public readonly partial struct RequiredPortArray
    {
        ...
        public readonly partial struct RequiredPort
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="VisibilityEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal VisibilityEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static VisibilityEntity DefaultInstance { get; } = ParsedJsonDocument<VisibilityEntity>.StringConstant([.."\"private\""u8]);
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(VisibilityEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in VisibilityEntity left, in VisibilityEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in VisibilityEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(VisibilityEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator VisibilityEntity(JsonElement instance)
                {
                    return VisibilityEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static VisibilityEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static VisibilityEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<VisibilityEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static VisibilityEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<VisibilityEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static VisibilityEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<VisibilityEntity>(json, options);
                }
                ...
                /// </exception>
                public static VisibilityEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<VisibilityEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out VisibilityEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<VisibilityEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new VisibilityEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static VisibilityEntity IJsonElement<VisibilityEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"VisibilityEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="VisibilityEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="VisibilityEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public VisibilityEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<VisibilityEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="VisibilityEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public VisibilityEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<VisibilityEntity>(_idx);
                    }
                ...
                /// <param name="matchPrivate">Match 1st item.</param>
                /// <param name="matchPublic">Match 2nd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchPrivate,
                    Func<TContext, TResult> matchPublic,
...
#endif
                {
                    ...
                    {
                        return matchPrivate(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchPublic(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchPrivate,
                    Func<TResult> matchPublic,
