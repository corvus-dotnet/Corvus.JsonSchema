...
public readonly partial struct GitpodConfigurationSchema
{
    ...
    public readonly partial struct RequiredUrlArray
    {
...
#endif
        {
            ...
            public Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredUrlArray.RequiredUrl.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredUrlArray.RequiredUrl.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredUrlArray.RequiredUrl.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredUrlArray.RequiredUrl.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredUrlArray.RequiredUrl.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, scoped in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredUrlArray.RequiredUrl.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(scoped in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredUrlArray.RequiredUrl.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredUrlArray.RequiredUrl item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredUrlArray.RequiredUrl>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredUrlArray.RequiredUrl> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredUrlArray.RequiredUrl>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredUrlArray.RequiredUrl oldItem, in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredUrlArray.RequiredUrl.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredUrlArray.RequiredUrl>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredUrlArray.RequiredUrl current = enumerator.Current;
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredUrlArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredUrlArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            public void AddItem(in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredUrlArray.RequiredUrl.Source value)
            {
            ...
            /// Add an item to the array.
            /// </summary>
            public void AddItem<TContext>(in Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredUrlArray.RequiredUrl.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        public static ParsedJsonDocument<RequiredUrlArray> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<RequiredUrlArray>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<RequiredUrlArray> Create<TContext>(
