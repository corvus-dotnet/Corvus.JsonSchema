    ...
    public readonly partial struct RequiredUrlArray
    {
            ...
            : IJsonElement<RequiredUrl>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchCheckoutLocation(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/properties/additionalRepositories/items"u8, buffer, out written);
