    ...
    public readonly partial struct RequiredUrlArray
    {
        ...
        public readonly partial struct RequiredUrl
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.GitpodConfigurationBenchmark.Current.JsonString.Mutable Url
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UrlUtf8, out Corvus.GitpodConfigurationBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.RequiredUrlArray.RequiredUrl.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source url,
                ...
                /// Creates an instance of a <see cref="RequiredUrl"/>.
                /// </summary>
                public void Create(in Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source url, in Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source checkoutLocation = default)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source url, in Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source checkoutLocation = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            public static ParsedJsonDocument<RequiredUrl> Create(in Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source url, in Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source checkoutLocation = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
