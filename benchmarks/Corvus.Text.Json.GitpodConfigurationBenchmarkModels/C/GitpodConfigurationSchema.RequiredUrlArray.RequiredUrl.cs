...
public readonly partial struct GitpodConfigurationSchema
{
    ...
    public readonly partial struct RequiredUrlArray
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.GitpodConfigurationBenchmark.Current.JsonString Url
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UrlUtf8, out Corvus.GitpodConfigurationBenchmark.Current.JsonString value))
                    {
                        return value;
                    }
