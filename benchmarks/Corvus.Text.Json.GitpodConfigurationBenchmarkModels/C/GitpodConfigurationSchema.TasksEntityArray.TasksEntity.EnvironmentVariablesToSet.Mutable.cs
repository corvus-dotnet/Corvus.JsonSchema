        ...
        public readonly partial struct TasksEntity
        {
            ...
            public readonly partial struct EnvironmentVariablesToSet
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(EnvironmentVariablesToSet instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="EnvironmentVariablesToSet"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator EnvironmentVariablesToSet(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"EnvironmentVariablesToSet.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EnvironmentVariablesToSet Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EnvironmentVariablesToSet Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<EnvironmentVariablesToSet>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.TasksEntityArray.TasksEntity.EnvironmentVariablesToSet.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(EnvironmentVariablesToSet instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.TasksEntityArray.TasksEntity.EnvironmentVariablesToSet.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<EnvironmentVariablesToSet, Mutable>(this);
                }
            }
        }
    }
