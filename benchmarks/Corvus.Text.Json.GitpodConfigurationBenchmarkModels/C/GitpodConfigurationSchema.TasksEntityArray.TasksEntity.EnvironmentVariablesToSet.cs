...
public readonly partial struct GitpodConfigurationSchema
{
    ...
    public readonly partial struct TasksEntityArray
    {
        ...
        public readonly partial struct TasksEntity
        {
            ...
            public readonly partial struct EnvironmentVariablesToSet
#if NET8_0_OR_GREATER
                : IJsonElement<EnvironmentVariablesToSet>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="EnvironmentVariablesToSet"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal EnvironmentVariablesToSet(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static EnvironmentVariablesToSet DefaultInstance { get; }
                ...
                /// </returns>
                public static bool operator ==(in EnvironmentVariablesToSet left, in EnvironmentVariablesToSet right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in EnvironmentVariablesToSet left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(EnvironmentVariablesToSet instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EnvironmentVariablesToSet(JsonElement instance)
                {
                    return EnvironmentVariablesToSet.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EnvironmentVariablesToSet From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EnvironmentVariablesToSet ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<EnvironmentVariablesToSet>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EnvironmentVariablesToSet ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<EnvironmentVariablesToSet>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EnvironmentVariablesToSet ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<EnvironmentVariablesToSet>(json, options);
                }
                ...
                /// </exception>
                public static EnvironmentVariablesToSet ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<EnvironmentVariablesToSet>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out EnvironmentVariablesToSet? result)
                {
                    return JsonElementHelpers.TryParseValue<EnvironmentVariablesToSet>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new EnvironmentVariablesToSet(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static EnvironmentVariablesToSet IJsonElement<EnvironmentVariablesToSet>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EnvironmentVariablesToSet: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="EnvironmentVariablesToSet"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="EnvironmentVariablesToSet"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public EnvironmentVariablesToSet Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<EnvironmentVariablesToSet>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="EnvironmentVariablesToSet"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public EnvironmentVariablesToSet Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<EnvironmentVariablesToSet>(_idx);
                    }
