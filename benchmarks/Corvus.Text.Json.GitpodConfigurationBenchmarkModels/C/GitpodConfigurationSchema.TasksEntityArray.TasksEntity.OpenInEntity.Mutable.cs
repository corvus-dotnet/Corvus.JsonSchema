        ...
        public readonly partial struct TasksEntity
        {
            ...
            public readonly partial struct OpenInEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(OpenInEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="OpenInEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator OpenInEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new OpenInEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"OpenInEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="OpenInEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="OpenInEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OpenInEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<OpenInEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="OpenInEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OpenInEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<OpenInEntity>(_idx);
                    }
                    ...
                    /// <param name="matchBottom">Match 1st item.</param>
                    /// <param name="matchMain">Match 2nd item.</param>
                    ...
                    public TResult Match<TContext, TResult>(
                        ...
                        Func<TContext, TResult> matchMain,
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(OpenInEntity instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (OpenInEntity)value;
                ...
                {
                    return workspace.CreateBuilder<OpenInEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<OpenInEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<OpenInEntity>();
                    }
                    finally
                    {
