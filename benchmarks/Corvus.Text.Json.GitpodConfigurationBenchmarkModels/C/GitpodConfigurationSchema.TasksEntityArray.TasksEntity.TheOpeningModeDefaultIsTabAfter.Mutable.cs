        ...
        public readonly partial struct TasksEntity
        {
            ...
            public readonly partial struct TheOpeningModeDefaultIsTabAfter
            {
                ...
                public ref struct Source
                {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (TheOpeningModeDefaultIsTabAfter)value;
                ...
                public static ParsedJsonDocument<TheOpeningModeDefaultIsTabAfter> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<TheOpeningModeDefaultIsTabAfter>();
                    }
                    finally
                    {
