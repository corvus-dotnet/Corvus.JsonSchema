    ...
    public readonly partial struct TasksEntityArray
    {
        ...
        public readonly partial struct TasksEntity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="TheOpeningModeDefaultIsTabAfter"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal TheOpeningModeDefaultIsTabAfter(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static TheOpeningModeDefaultIsTabAfter DefaultInstance { get; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(TheOpeningModeDefaultIsTabAfter value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in TheOpeningModeDefaultIsTabAfter left, in TheOpeningModeDefaultIsTabAfter right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in TheOpeningModeDefaultIsTabAfter left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(TheOpeningModeDefaultIsTabAfter instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheOpeningModeDefaultIsTabAfter(JsonElement instance)
                {
                    return TheOpeningModeDefaultIsTabAfter.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheOpeningModeDefaultIsTabAfter From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheOpeningModeDefaultIsTabAfter ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheOpeningModeDefaultIsTabAfter>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheOpeningModeDefaultIsTabAfter ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheOpeningModeDefaultIsTabAfter>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheOpeningModeDefaultIsTabAfter ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheOpeningModeDefaultIsTabAfter>(json, options);
                }
                ...
                /// </exception>
                public static TheOpeningModeDefaultIsTabAfter ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<TheOpeningModeDefaultIsTabAfter>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out TheOpeningModeDefaultIsTabAfter? result)
                {
                    return JsonElementHelpers.TryParseValue<TheOpeningModeDefaultIsTabAfter>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TheOpeningModeDefaultIsTabAfter(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static TheOpeningModeDefaultIsTabAfter IJsonElement<TheOpeningModeDefaultIsTabAfter>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheOpeningModeDefaultIsTabAfter: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TheOpeningModeDefaultIsTabAfter"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TheOpeningModeDefaultIsTabAfter"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public TheOpeningModeDefaultIsTabAfter Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TheOpeningModeDefaultIsTabAfter>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TheOpeningModeDefaultIsTabAfter"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public TheOpeningModeDefaultIsTabAfter Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<TheOpeningModeDefaultIsTabAfter>(_idx);
                    }
                ...
                /// <param name="matchSplitLeft">Match 1st item.</param>
                /// <param name="matchSplitRight">Match 2nd item.</param>
                /// <param name="matchTabBefore">Match 3rd item.</param>
                /// <param name="matchTabAfter">Match 4th item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchSplitLeft,
                    Func<TContext, TResult> matchSplitRight,
                    Func<TContext, TResult> matchTabBefore,
                    Func<TContext, TResult> matchTabAfter,
...
#endif
                {
                    ...
                    {
                        return matchSplitLeft(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchSplitRight(context);
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchTabBefore(context);
                    }

                    if (this.ValueEquals(Constants.Enum4))
                    {
                        return matchTabAfter(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchSplitLeft,
                    Func<TResult> matchSplitRight,
                    Func<TResult> matchTabBefore,
                    Func<TResult> matchTabAfter,
                    Func<TResult> defaultMatch)
                {
                    if (this.ValueEquals(Constants.Enum1))
                    {
                        return matchSplitLeft();
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchSplitRight();
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchTabBefore();
                    }

                    if (this.ValueEquals(Constants.Enum4))
                    {
                        return matchTabAfter();
                    }
