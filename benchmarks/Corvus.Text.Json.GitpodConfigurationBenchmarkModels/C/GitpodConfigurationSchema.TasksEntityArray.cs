...
public readonly partial struct GitpodConfigurationSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TasksEntityArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TasksEntityArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TasksEntityArray DefaultInstance { get; }
        ...
        public Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.TasksEntityArray.TasksEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.TasksEntityArray.TasksEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.TasksEntityArray.TasksEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.TasksEntityArray.TasksEntity>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in TasksEntityArray left, in TasksEntityArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TasksEntityArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(TasksEntityArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TasksEntityArray(JsonElement instance)
        {
            return TasksEntityArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TasksEntityArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TasksEntityArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TasksEntityArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TasksEntityArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TasksEntityArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TasksEntityArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TasksEntityArray>(json, options);
        }
        ...
        /// </exception>
        public static TasksEntityArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<TasksEntityArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TasksEntityArray? result)
        {
            return JsonElementHelpers.TryParseValue<TasksEntityArray>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TasksEntityArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static TasksEntityArray IJsonElement<TasksEntityArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TasksEntityArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TasksEntityArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TasksEntityArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public TasksEntityArray Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TasksEntityArray>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TasksEntityArray"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public TasksEntityArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TasksEntityArray>(_idx);
            }
