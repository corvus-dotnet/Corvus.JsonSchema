...
public readonly partial struct GitpodConfigurationSchema
{
    ...
    public readonly partial struct TheDockerImageToRunYourWorkspaceIn
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TheDockerImageToRunYourWorkspaceIn, Mutable>(TheDockerImageToRunYourWorkspaceIn.DefaultInstance);
            ...
            public static explicit operator Mutable(TheDockerImageToRunYourWorkspaceIn instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheDockerImageToRunYourWorkspaceIn"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheDockerImageToRunYourWorkspaceIn(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.GitpodConfigurationBenchmark.Current.JsonString.Mutable Context
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContextUtf8, out Corvus.GitpodConfigurationBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.GitpodConfigurationBenchmark.Current.JsonString.Mutable File
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FileUtf8, out Corvus.GitpodConfigurationBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetContext(scoped in Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source value)
            {
                ...
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ContextUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContextUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
            ...
            /// <summary>
            /// Remove the <c>context</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveContext()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ContextUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheDockerImageToRunYourWorkspaceIn.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly TheDockerImageToRunYourWorkspaceIn Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TheDockerImageToRunYourWorkspaceIn Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheDockerImageToRunYourWorkspaceIn>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source _createArg1;
            ...
            public static implicit operator Source(TheDockerImageToRunYourWorkspaceIn instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.GitpodConfigurationBenchmark.Current.GitpodConfigurationSchema.TheDockerImageToRunYourWorkspaceIn.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="TheDockerImageToRunYourWorkspaceIn"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source file,
                in Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source context = default)
            {
            ...
            /// Creates an instance of a <see cref="TheDockerImageToRunYourWorkspaceIn"/>.
            /// </summary>
            public void Create(in Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source file, in Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source context = default)
            {
                Create(ref _builder, file, context);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source file, in Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source context = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(file, context);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<TheDockerImageToRunYourWorkspaceIn, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TheDockerImageToRunYourWorkspaceIn> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TheDockerImageToRunYourWorkspaceIn>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<TheDockerImageToRunYourWorkspaceIn> Create<TContext>(
        ...
        public static ParsedJsonDocument<TheDockerImageToRunYourWorkspaceIn> Create(in Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source file, in Corvus.GitpodConfigurationBenchmark.Current.JsonString.Source context = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
