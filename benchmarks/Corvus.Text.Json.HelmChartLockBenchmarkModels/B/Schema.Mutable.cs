...
namespace Corvus.HelmChartLockBenchmark.Baseline;
/// <summary>
/// Helm Chart.lock
/// </summary>
...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.Mutable Dependencies
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DependenciesUtf8, out Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.HelmChartLockBenchmark.Baseline.JsonString.Mutable Digest
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DigestUtf8, out Corvus.HelmChartLockBenchmark.Baseline.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the <c>generated</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        /// If the instance is valid, this property will not be <see cref="JsonValueKind.Undefined"/>.
        ...
        /// </para>
        /// </remarks>
        public Corvus.HelmChartLockBenchmark.Baseline.JsonDateTime.Mutable Generated
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GeneratedUtf8, out Corvus.HelmChartLockBenchmark.Baseline.JsonDateTime.Mutable value))
                {
                    return value;
                }
        ...
        public void SetDependencies(in Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetDependencies<TContext>(in Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetDigest(in Corvus.HelmChartLockBenchmark.Baseline.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetGenerated(in Corvus.HelmChartLockBenchmark.Baseline.JsonDateTime.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("generated");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GeneratedUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.HelmChartLockBenchmark.Baseline.Schema.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.HelmChartLockBenchmark.Baseline.Schema.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.Source dependencies,
            in Corvus.HelmChartLockBenchmark.Baseline.JsonString.Source digest,
            in Corvus.HelmChartLockBenchmark.Baseline.JsonDateTime.Source generated)
        {
        ...
        public void Create(
            ...
            in Corvus.HelmChartLockBenchmark.Baseline.JsonDateTime.Source generated)
        {
            Create(ref _builder, dependencies, digest, generated);
        }
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.Source<TContext> dependencies,
            in Corvus.HelmChartLockBenchmark.Baseline.JsonString.Source digest,
            in Corvus.HelmChartLockBenchmark.Baseline.JsonDateTime.Source generated)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        ...
        #endif
        {
            Create(context, ref _builder, dependencies, digest, generated);
        }
    ...
    /// <param name="generated">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.Source dependencies, in Corvus.HelmChartLockBenchmark.Baseline.JsonString.Source digest, in Corvus.HelmChartLockBenchmark.Baseline.JsonDateTime.Source generated, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(dependencies, digest, generated);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.Source<TContext> dependencies, in Corvus.HelmChartLockBenchmark.Baseline.JsonString.Source digest, in Corvus.HelmChartLockBenchmark.Baseline.JsonDateTime.Source generated, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, dependencies, digest, generated);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
