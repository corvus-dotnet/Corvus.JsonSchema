...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RequiredNameAndRepositoryAndVersionArray
    {
...
#endif
        {
            ...
            public Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.RequiredNameAndRepositoryAndVersion.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.RequiredNameAndRepositoryAndVersion.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.RequiredNameAndRepositoryAndVersion.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.RequiredNameAndRepositoryAndVersion.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.RequiredNameAndRepositoryAndVersion.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.RequiredNameAndRepositoryAndVersion.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.RequiredNameAndRepositoryAndVersion.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.RequiredNameAndRepositoryAndVersion item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.RequiredNameAndRepositoryAndVersion>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.RequiredNameAndRepositoryAndVersion> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.RequiredNameAndRepositoryAndVersion>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.RequiredNameAndRepositoryAndVersion oldItem, in Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.RequiredNameAndRepositoryAndVersion.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.RequiredNameAndRepositoryAndVersion>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.RequiredNameAndRepositoryAndVersion current = enumerator.Current;
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
