    ...
    public readonly partial struct RequiredNameAndRepositoryAndVersionArray
    {
        ...
        public readonly partial struct RequiredNameAndRepositoryAndVersion
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.HelmChartLockBenchmark.Baseline.JsonString.Mutable Name
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.HelmChartLockBenchmark.Baseline.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.HelmChartLockBenchmark.Baseline.JsonUri.Mutable Repository
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RepositoryUtf8, out Corvus.HelmChartLockBenchmark.Baseline.JsonUri.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.HelmChartLockBenchmark.Baseline.JsonString.Mutable Version
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.HelmChartLockBenchmark.Baseline.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetName(in Corvus.HelmChartLockBenchmark.Baseline.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetRepository(in Corvus.HelmChartLockBenchmark.Baseline.JsonUri.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetVersion(in Corvus.HelmChartLockBenchmark.Baseline.JsonString.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.RequiredNameAndRepositoryAndVersion.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.RequiredNameAndRepositoryAndVersion.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.HelmChartLockBenchmark.Baseline.JsonString.Source name,
                    in Corvus.HelmChartLockBenchmark.Baseline.JsonUri.Source repository,
                    in Corvus.HelmChartLockBenchmark.Baseline.JsonString.Source version)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.HelmChartLockBenchmark.Baseline.JsonString.Source name, in Corvus.HelmChartLockBenchmark.Baseline.JsonUri.Source repository, in Corvus.HelmChartLockBenchmark.Baseline.JsonString.Source version, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
