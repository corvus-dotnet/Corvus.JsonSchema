...
public readonly partial struct HelmChartLockSchema
{
...
#endif
    {
        ...
        public static explicit operator Mutable(HelmChartLockSchema instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="HelmChartLockSchema"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator HelmChartLockSchema(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.HelmChartLockBenchmark.Current.HelmChartLockSchema.RequiredNameAndRepositoryAndVersionArray.Mutable Dependencies
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DependenciesUtf8, out Corvus.HelmChartLockBenchmark.Current.HelmChartLockSchema.RequiredNameAndRepositoryAndVersionArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.HelmChartLockBenchmark.Current.JsonString.Mutable Digest
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DigestUtf8, out Corvus.HelmChartLockBenchmark.Current.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.HelmChartLockBenchmark.Current.JsonDateTime.Mutable Generated
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GeneratedUtf8, out Corvus.HelmChartLockBenchmark.Current.JsonDateTime.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new HelmChartLockSchema(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetDependencies<TContext>(in Corvus.HelmChartLockBenchmark.Current.HelmChartLockSchema.RequiredNameAndRepositoryAndVersionArray.Source<TContext> value)
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"HelmChartLockSchema.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="HelmChartLockSchema"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="HelmChartLockSchema"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly HelmChartLockSchema Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<HelmChartLockSchema>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="HelmChartLockSchema"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly HelmChartLockSchema Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<HelmChartLockSchema>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.HelmChartLockBenchmark.Current.HelmChartLockSchema.RequiredNameAndRepositoryAndVersionArray.Source _createArg1;
        private readonly Corvus.HelmChartLockBenchmark.Current.JsonString.Source _createArg2;
        private readonly Corvus.HelmChartLockBenchmark.Current.JsonDateTime.Source _createArg3;
        ...
        public static implicit operator Source(HelmChartLockSchema instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.HelmChartLockBenchmark.Current.HelmChartLockSchema.RequiredNameAndRepositoryAndVersionArray.Source<TContext> _createArg1;
        private readonly Corvus.HelmChartLockBenchmark.Current.JsonString.Source _createArg2;
        private readonly Corvus.HelmChartLockBenchmark.Current.JsonDateTime.Source _createArg3;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="HelmChartLockSchema"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.HelmChartLockBenchmark.Current.HelmChartLockSchema.RequiredNameAndRepositoryAndVersionArray.Source dependencies,
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in Corvus.HelmChartLockBenchmark.Current.HelmChartLockSchema.RequiredNameAndRepositoryAndVersionArray.Source<TContext> dependencies,
            in Corvus.HelmChartLockBenchmark.Current.JsonString.Source digest,
            in Corvus.HelmChartLockBenchmark.Current.JsonDateTime.Source generated)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    ...
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.HelmChartLockBenchmark.Current.HelmChartLockSchema.RequiredNameAndRepositoryAndVersionArray.Source<TContext> dependencies, scoped in Corvus.HelmChartLockBenchmark.Current.JsonString.Source digest, scoped in Corvus.HelmChartLockBenchmark.Current.JsonDateTime.Source generated)
        ...
        #endif
    {
        return new Source<TContext>(context, dependencies, digest, generated);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.HelmChartLockBenchmark.Current.HelmChartLockSchema.RequiredNameAndRepositoryAndVersionArray.Source dependencies, in Corvus.HelmChartLockBenchmark.Current.JsonString.Source digest, in Corvus.HelmChartLockBenchmark.Current.JsonDateTime.Source generated, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.HelmChartLockBenchmark.Current.HelmChartLockSchema.RequiredNameAndRepositoryAndVersionArray.Source<TContext> dependencies, in Corvus.HelmChartLockBenchmark.Current.JsonString.Source digest, in Corvus.HelmChartLockBenchmark.Current.JsonDateTime.Source generated, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    {
        return workspace.CreateBuilder<HelmChartLockSchema, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<HelmChartLockSchema> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<HelmChartLockSchema>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<HelmChartLockSchema> Create<TContext>(
    ...
    public static ParsedJsonDocument<HelmChartLockSchema> Create(in Corvus.HelmChartLockBenchmark.Current.HelmChartLockSchema.RequiredNameAndRepositoryAndVersionArray.Source dependencies, in Corvus.HelmChartLockBenchmark.Current.JsonString.Source digest, in Corvus.HelmChartLockBenchmark.Current.JsonDateTime.Source generated, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<HelmChartLockSchema> Create<TContext>(in TContext context, in Corvus.HelmChartLockBenchmark.Current.HelmChartLockSchema.RequiredNameAndRepositoryAndVersionArray.Source<TContext> dependencies, in Corvus.HelmChartLockBenchmark.Current.JsonString.Source digest, in Corvus.HelmChartLockBenchmark.Current.JsonDateTime.Source generated, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
