    ...
    public readonly partial struct RequiredNameAndRepositoryAndVersionArray
    {
            ...
            : IJsonElement<RequiredNameAndRepositoryAndVersion>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/properties/dependencies/items"u8, buffer, out written);
                ...
                /// </remarks>
                public const string SchemaDocument = "helm-chart-lock-schema.json";

                /// <summary>
                /// Gets the schema document from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaDocumentUtf8 => "helm-chart-lock-schema.json"u8;

                private static readonly global::Corvus.Text.Json.RuntimeEvaluator.JsonSchemaEvaluator Evaluator = global::Corvus.HelmChartLockBenchmark.Current.CorvusJsonSchemaProgram.Entry(5);
