...
public readonly partial struct HelmChartLockSchema
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct RequiredNameAndRepositoryAndVersionArray
    {
        /// <summary>
        /// Generated from JSON Schema.
        /// </summary>
        [DebuggerDisplay("{DebuggerDisplay,nq}")]
        public readonly partial struct RequiredNameAndRepositoryAndVersion
            : IJsonElement<RequiredNameAndRepositoryAndVersion>
        {
            public static partial class JsonSchema
            {
                ...
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyRepositoryPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("repository"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyRepositoryNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("repository"u8, buffer, out written);

                private const int RequiredOffsetForRepository = 0;
                private const uint RequiredBitForRepository = 0b00000000000000000000000000000010;
                ...
                private const uint RequiredBitMask0 =
                    RequiredBitForName | RequiredBitForRepository | RequiredBitForVersion;
                ...
                private static readonly JsonSchemaPathProvider RepositorySchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/repository"u8, buffer, out written);
                ...
                private static void MatchName(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext =
                        Corvus.HelmChartLockBenchmark.Current.JsonString.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.HelmChartLockBenchmark.Current.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                private static void MatchRepository(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext1 =
                        Corvus.HelmChartLockBenchmark.Current.JsonUri.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.RepositoryUtf8,
                            evaluationPath: RepositorySchemaEvaluationPath);

                    Corvus.HelmChartLockBenchmark.Current.JsonUri.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                    ...
                    requiredBitBuffer[RequiredOffsetForRepository] |= RequiredBitForRepository;
                }
                ...
                private static void MatchVersion(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    Corvus.HelmChartLockBenchmark.Current.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                ...
                private static PropertySchemaMatchers<Corvus.HelmChartLockBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Corvus.HelmChartLockBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                        (static () => JsonPropertyNames.NameUtf8, MatchName),
                        (static () => JsonPropertyNames.RepositoryUtf8, MatchRepository),
                        (static () => JsonPropertyNames.VersionUtf8, MatchVersion),
                    ]);
                }

                private static PropertySchemaMatchers<Corvus.HelmChartLockBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> Matchers { get; } = MatchersBuilder();

                private static bool TryGetNamedMatcher(ReadOnlySpan<byte> span,
#if NET
                [NotNullWhen(true)]
#endif
                out Corvus.HelmChartLockBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator? matcher)
                {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/chart-lock.json#/properties/dependencies/items"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "https://json.schemastore.org/chart-lock.json#/properties/dependencies/items";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/chart-lock.json#/properties/dependencies/items"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        while (objectValidation_enumerator.MoveNext())
                        {
                            ...
                            if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out Corvus.HelmChartLockBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator? validator))
                            {
                        ...
                        if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                        {
                            if (context.HasCollector)
                            {
                                ...
                                context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyRepositoryPresent, "repository"u8, "required"u8);
                        ...
                        else
                        {
                            ...
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForRepository] & RequiredBitForRepository) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyRepositoryNotPresent, "repository"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyRepositoryPresent, "repository"u8, "required"u8);
