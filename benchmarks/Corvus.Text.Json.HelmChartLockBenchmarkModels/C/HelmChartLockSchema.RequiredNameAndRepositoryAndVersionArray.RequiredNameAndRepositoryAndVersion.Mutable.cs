    ...
    public readonly partial struct RequiredNameAndRepositoryAndVersionArray
    {
        ...
        public readonly partial struct RequiredNameAndRepositoryAndVersion
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequiredNameAndRepositoryAndVersion instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequiredNameAndRepositoryAndVersion"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredNameAndRepositoryAndVersion(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.HelmChartLockBenchmark.Current.JsonString.Mutable Name
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.HelmChartLockBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.HelmChartLockBenchmark.Current.JsonUri.Mutable Repository
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RepositoryUtf8, out Corvus.HelmChartLockBenchmark.Current.JsonUri.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.HelmChartLockBenchmark.Current.JsonString.Mutable Version
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.HelmChartLockBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetRepository(scoped in Corvus.HelmChartLockBenchmark.Current.JsonUri.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("repository");
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RepositoryUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Repository, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredNameAndRepositoryAndVersion.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredNameAndRepositoryAndVersion Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredNameAndRepositoryAndVersion Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequiredNameAndRepositoryAndVersion>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.HelmChartLockBenchmark.Current.JsonString.Source _createArg1;
                private readonly Corvus.HelmChartLockBenchmark.Current.JsonUri.Source _createArg2;
                private readonly Corvus.HelmChartLockBenchmark.Current.JsonString.Source _createArg3;
                ...
                public static implicit operator Source(RequiredNameAndRepositoryAndVersion instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.HelmChartLockBenchmark.Current.HelmChartLockSchema.RequiredNameAndRepositoryAndVersionArray.RequiredNameAndRepositoryAndVersion.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="RequiredNameAndRepositoryAndVersion"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.HelmChartLockBenchmark.Current.JsonString.Source name,
                    in Corvus.HelmChartLockBenchmark.Current.JsonUri.Source repository,
                    in Corvus.HelmChartLockBenchmark.Current.JsonString.Source version)
                {
                    name.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Name, ref builder);
                    repository.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Repository, ref builder);
                ...
                public void Create(
                    ...
                    in Corvus.HelmChartLockBenchmark.Current.JsonString.Source version)
                {
                    Create(ref _builder, name, repository, version);
                }
            ...
            /// <param name="repository">The value of the property.</param>
            /// <param name="version">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.HelmChartLockBenchmark.Current.JsonString.Source name, in Corvus.HelmChartLockBenchmark.Current.JsonUri.Source repository, in Corvus.HelmChartLockBenchmark.Current.JsonString.Source version, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(name, repository, version);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<RequiredNameAndRepositoryAndVersion, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RequiredNameAndRepositoryAndVersion> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RequiredNameAndRepositoryAndVersion>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredNameAndRepositoryAndVersion> Create<TContext>(
            ...
            public static ParsedJsonDocument<RequiredNameAndRepositoryAndVersion> Create(in Corvus.HelmChartLockBenchmark.Current.JsonString.Source name, in Corvus.HelmChartLockBenchmark.Current.JsonUri.Source repository, in Corvus.HelmChartLockBenchmark.Current.JsonString.Source version, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
