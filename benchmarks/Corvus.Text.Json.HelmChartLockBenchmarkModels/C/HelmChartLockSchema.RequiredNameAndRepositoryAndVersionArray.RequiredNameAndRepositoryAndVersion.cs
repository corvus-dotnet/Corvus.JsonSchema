...
public readonly partial struct HelmChartLockSchema
{
    ...
    public readonly partial struct RequiredNameAndRepositoryAndVersionArray
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RequiredNameAndRepositoryAndVersion"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RequiredNameAndRepositoryAndVersion(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RequiredNameAndRepositoryAndVersion DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.HelmChartLockBenchmark.Current.JsonString Name
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.HelmChartLockBenchmark.Current.JsonString value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the <c>repository</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            /// If the instance is valid, this property will not be <see cref="JsonValueKind.Undefined"/>.
            ...
            /// </para>
            /// </remarks>
            public Corvus.HelmChartLockBenchmark.Current.JsonUri Repository
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RepositoryUtf8, out Corvus.HelmChartLockBenchmark.Current.JsonUri value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.HelmChartLockBenchmark.Current.JsonString Version
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.HelmChartLockBenchmark.Current.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in RequiredNameAndRepositoryAndVersion left, in RequiredNameAndRepositoryAndVersion right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RequiredNameAndRepositoryAndVersion left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RequiredNameAndRepositoryAndVersion instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredNameAndRepositoryAndVersion(JsonElement instance)
            {
                return RequiredNameAndRepositoryAndVersion.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredNameAndRepositoryAndVersion From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredNameAndRepositoryAndVersion ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredNameAndRepositoryAndVersion>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredNameAndRepositoryAndVersion ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredNameAndRepositoryAndVersion>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredNameAndRepositoryAndVersion ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredNameAndRepositoryAndVersion>(json, options);
            }
            ...
            /// </exception>
            public static RequiredNameAndRepositoryAndVersion ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RequiredNameAndRepositoryAndVersion>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredNameAndRepositoryAndVersion? result)
            {
                return JsonElementHelpers.TryParseValue<RequiredNameAndRepositoryAndVersion>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RequiredNameAndRepositoryAndVersion(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RequiredNameAndRepositoryAndVersion IJsonElement<RequiredNameAndRepositoryAndVersion>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredNameAndRepositoryAndVersion: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RequiredNameAndRepositoryAndVersion"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RequiredNameAndRepositoryAndVersion"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RequiredNameAndRepositoryAndVersion Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RequiredNameAndRepositoryAndVersion>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RequiredNameAndRepositoryAndVersion"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RequiredNameAndRepositoryAndVersion Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RequiredNameAndRepositoryAndVersion>(_idx);
                }
            ...
            public static class JsonPropertyNames
            {
                ...
                /// <summary>
                /// Gets the JSON property name for <see cref="Repository"/>.
                /// </summary>
                ...
                /// Gets the JSON property name for <see cref="Repository"/>.
                /// </summary>
                public static ReadOnlySpan<byte> RepositoryUtf8 => "repository"u8;
            ...
            private static class JsonPropertyNamesEscaped
            {
                ...
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Repository"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Repository => "repository"u8;
