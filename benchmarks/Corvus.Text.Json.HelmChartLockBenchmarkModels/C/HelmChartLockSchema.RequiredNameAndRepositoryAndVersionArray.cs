...
public readonly partial struct HelmChartLockSchema
{
    ...
    public readonly partial struct RequiredNameAndRepositoryAndVersionArray
        ...
        : IJsonElement<RequiredNameAndRepositoryAndVersionArray>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequiredNameAndRepositoryAndVersionArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal RequiredNameAndRepositoryAndVersionArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RequiredNameAndRepositoryAndVersionArray DefaultInstance { get; }
        ...
        public Corvus.HelmChartLockBenchmark.Current.HelmChartLockSchema.RequiredNameAndRepositoryAndVersionArray.RequiredNameAndRepositoryAndVersion this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.HelmChartLockBenchmark.Current.HelmChartLockSchema.RequiredNameAndRepositoryAndVersionArray.RequiredNameAndRepositoryAndVersion>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.HelmChartLockBenchmark.Current.HelmChartLockSchema.RequiredNameAndRepositoryAndVersionArray.RequiredNameAndRepositoryAndVersion> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.HelmChartLockBenchmark.Current.HelmChartLockSchema.RequiredNameAndRepositoryAndVersionArray.RequiredNameAndRepositoryAndVersion>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in RequiredNameAndRepositoryAndVersionArray left, in RequiredNameAndRepositoryAndVersionArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RequiredNameAndRepositoryAndVersionArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(RequiredNameAndRepositoryAndVersionArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RequiredNameAndRepositoryAndVersionArray(JsonElement instance)
        {
            return RequiredNameAndRepositoryAndVersionArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredNameAndRepositoryAndVersionArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredNameAndRepositoryAndVersionArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredNameAndRepositoryAndVersionArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredNameAndRepositoryAndVersionArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredNameAndRepositoryAndVersionArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredNameAndRepositoryAndVersionArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredNameAndRepositoryAndVersionArray>(json, options);
        }
        ...
        /// </exception>
        public static RequiredNameAndRepositoryAndVersionArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<RequiredNameAndRepositoryAndVersionArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredNameAndRepositoryAndVersionArray? result)
        {
            return JsonElementHelpers.TryParseValue<RequiredNameAndRepositoryAndVersionArray>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new RequiredNameAndRepositoryAndVersionArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static RequiredNameAndRepositoryAndVersionArray IJsonElement<RequiredNameAndRepositoryAndVersionArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RequiredNameAndRepositoryAndVersionArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="RequiredNameAndRepositoryAndVersionArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="RequiredNameAndRepositoryAndVersionArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public RequiredNameAndRepositoryAndVersionArray Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<RequiredNameAndRepositoryAndVersionArray>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="RequiredNameAndRepositoryAndVersionArray"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public RequiredNameAndRepositoryAndVersionArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<RequiredNameAndRepositoryAndVersionArray>(_idx);
            }
