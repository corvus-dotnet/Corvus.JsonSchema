...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="HelmChartLockSchema"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal HelmChartLockSchema(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static HelmChartLockSchema DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.HelmChartLockBenchmark.Current.HelmChartLockSchema.RequiredNameAndRepositoryAndVersionArray Dependencies
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DependenciesUtf8, out Corvus.HelmChartLockBenchmark.Current.HelmChartLockSchema.RequiredNameAndRepositoryAndVersionArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.HelmChartLockBenchmark.Current.JsonString Digest
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DigestUtf8, out Corvus.HelmChartLockBenchmark.Current.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.HelmChartLockBenchmark.Current.JsonDateTime Generated
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GeneratedUtf8, out Corvus.HelmChartLockBenchmark.Current.JsonDateTime value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in HelmChartLockSchema left, in HelmChartLockSchema right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in HelmChartLockSchema left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(HelmChartLockSchema instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator HelmChartLockSchema(JsonElement instance)
    {
        return HelmChartLockSchema.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static HelmChartLockSchema From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static HelmChartLockSchema ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<HelmChartLockSchema>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static HelmChartLockSchema ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<HelmChartLockSchema>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static HelmChartLockSchema ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<HelmChartLockSchema>(json, options);
    }
    ...
    /// </exception>
    public static HelmChartLockSchema ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<HelmChartLockSchema>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out HelmChartLockSchema? result)
    {
        return JsonElementHelpers.TryParseValue<HelmChartLockSchema>(ref reader, out result);
    }
...
#if NET
    static HelmChartLockSchema IJsonElement<HelmChartLockSchema>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"HelmChartLockSchema: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public HelmChartLockSchema Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public HelmChartLockSchema Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<HelmChartLockSchema>(_idx);
        }
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Generated"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Generated => [0xB5, 0x00, 0x00, 0x00, 0x22, 0x67, 0x65, 0x6E, 0x65, 0x72, 0x61, 0x74, 0x65, 0x64, 0x22];
    }
}
