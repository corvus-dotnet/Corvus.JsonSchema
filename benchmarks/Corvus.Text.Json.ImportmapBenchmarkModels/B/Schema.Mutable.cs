...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.ImportmapBenchmark.Baseline.Schema.TheImportsField.Mutable Imports
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ImportsUtf8, out Corvus.ImportmapBenchmark.Baseline.Schema.TheImportsField.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.ImportmapBenchmark.Baseline.Schema.TheScopesField.Mutable Scopes
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopesUtf8, out Corvus.ImportmapBenchmark.Baseline.Schema.TheScopesField.Mutable value))
                {
                    return value;
                }
        ...
        public void SetImports(in Corvus.ImportmapBenchmark.Baseline.Schema.TheImportsField.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetImports<TContext>(in Corvus.ImportmapBenchmark.Baseline.Schema.TheImportsField.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetScopes(in Corvus.ImportmapBenchmark.Baseline.Schema.TheScopesField.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetScopes<TContext>(in Corvus.ImportmapBenchmark.Baseline.Schema.TheScopesField.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.ImportmapBenchmark.Baseline.Schema.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.ImportmapBenchmark.Baseline.Schema.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.ImportmapBenchmark.Baseline.Schema.TheImportsField.Source imports = default,
            in Corvus.ImportmapBenchmark.Baseline.Schema.TheScopesField.Source scopes = default)
        {
        ...
        /// Creates an instance of a <see cref="Schema"/>.
        /// </summary>
        public void Create(in Corvus.ImportmapBenchmark.Baseline.Schema.TheImportsField.Source imports = default, in Corvus.ImportmapBenchmark.Baseline.Schema.TheScopesField.Source scopes = default)
        {
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in Corvus.ImportmapBenchmark.Baseline.Schema.TheImportsField.Source<TContext> imports = default,
            in Corvus.ImportmapBenchmark.Baseline.Schema.TheScopesField.Source<TContext> scopes = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.ImportmapBenchmark.Baseline.Schema.TheImportsField.Source imports = default, in Corvus.ImportmapBenchmark.Baseline.Schema.TheScopesField.Source scopes = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.ImportmapBenchmark.Baseline.Schema.TheImportsField.Source<TContext> imports = default, in Corvus.ImportmapBenchmark.Baseline.Schema.TheScopesField.Source<TContext> scopes = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
