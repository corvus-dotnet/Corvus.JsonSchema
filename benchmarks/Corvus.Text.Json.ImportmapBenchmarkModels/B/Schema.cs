...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.ImportmapBenchmark.Baseline.Schema.TheImportsField Imports
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ImportsUtf8, out Corvus.ImportmapBenchmark.Baseline.Schema.TheImportsField value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.ImportmapBenchmark.Baseline.Schema.TheScopesField Scopes
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopesUtf8, out Corvus.ImportmapBenchmark.Baseline.Schema.TheScopesField value))
            {
                return value;
            }
