...
public readonly partial struct ImportmapSchema
{
...
#endif
    {
        ...
        public static explicit operator Mutable(ImportmapSchema instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ImportmapSchema"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ImportmapSchema(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheImportsField.Mutable Imports
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ImportsUtf8, out Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheImportsField.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheScopesField.Mutable Scopes
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopesUtf8, out Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheScopesField.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ImportmapSchema(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetImports<TContext>(in Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheImportsField.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetScopes<TContext>(in Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheScopesField.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ImportmapSchema.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ImportmapSchema"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ImportmapSchema"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly ImportmapSchema Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ImportmapSchema>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ImportmapSchema"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly ImportmapSchema Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<ImportmapSchema>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheImportsField.Source _createArg1;
        private readonly Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheScopesField.Source _createArg2;
        ...
        public static implicit operator Source(ImportmapSchema instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheImportsField.Source<TContext> _createArg1;
        private readonly Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheScopesField.Source<TContext> _createArg2;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="ImportmapSchema"/>.
        /// </summary>
        ...
        /// Creates an instance of a <see cref="ImportmapSchema"/>.
        /// </summary>
        public void Create(in Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheImportsField.Source imports = default, in Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheScopesField.Source scopes = default)
        {
            Create(ref _builder, imports, scopes);
        }
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheImportsField.Source<TContext> imports = default,
            in Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheScopesField.Source<TContext> scopes = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        #endif
        {
            Create(context, ref _builder, imports, scopes);
        }
    ...
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheImportsField.Source<TContext> imports = default, scoped in Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheScopesField.Source<TContext> scopes = default)
        ...
        #endif
    {
        return new Source<TContext>(context, imports, scopes);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheImportsField.Source imports = default, in Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheScopesField.Source scopes = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(imports, scopes);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheImportsField.Source<TContext> imports = default, in Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheScopesField.Source<TContext> scopes = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, imports, scopes);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<ImportmapSchema, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<ImportmapSchema> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<ImportmapSchema>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<ImportmapSchema> Create<TContext>(
    ...
    public static ParsedJsonDocument<ImportmapSchema> Create(in Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheImportsField.Source imports = default, in Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheScopesField.Source scopes = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<ImportmapSchema> Create<TContext>(in TContext context, in Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheImportsField.Source<TContext> imports = default, in Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheScopesField.Source<TContext> scopes = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
