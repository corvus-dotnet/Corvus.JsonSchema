...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ImportmapSchema"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal ImportmapSchema(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static ImportmapSchema DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheImportsField Imports
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ImportsUtf8, out Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheImportsField value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheScopesField Scopes
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopesUtf8, out Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheScopesField value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in ImportmapSchema left, in ImportmapSchema right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in ImportmapSchema left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(ImportmapSchema instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator ImportmapSchema(JsonElement instance)
    {
        return ImportmapSchema.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ImportmapSchema From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ImportmapSchema ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<ImportmapSchema>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ImportmapSchema ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<ImportmapSchema>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ImportmapSchema ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<ImportmapSchema>(json, options);
    }
    ...
    /// </exception>
    public static ImportmapSchema ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<ImportmapSchema>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out ImportmapSchema? result)
    {
        return JsonElementHelpers.TryParseValue<ImportmapSchema>(ref reader, out result);
    }
...
#if NET
    static ImportmapSchema IJsonElement<ImportmapSchema>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"ImportmapSchema: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public ImportmapSchema Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<ImportmapSchema>(_idx);
        }
