// <copyright file="BenchmarkArrayIndex.cs" company="Endjin Limited">
...
/// <summary>
/// Benchmark for array indexing: locations[1].name.
/// </summary>
[MemoryDiagnoser]
public class BenchmarkArrayIndex : JMESPathBenchmarkBase
{
    private const string ExpressionText = "locations[1].name";
    private const string DataJson = """{"locations":[{"name":"Seattle"},{"name":"London"},{"name":"Tokyo"}]}""";
    ...
    {
        using JsonWorkspace workspace = JsonWorkspace.Create();
        ArrayIndexCodeGen.Evaluate(this.CorvusData, workspace);
    }
}
