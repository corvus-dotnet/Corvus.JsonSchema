// <copyright file="BenchmarkConformanceAvgArray.cs" company="Endjin Limited">
...
/// <summary>
/// Conformance benchmark: avg of 26 values.
/// </summary>
[MemoryDiagnoser]
public class BenchmarkConformanceAvgArray : JMESPathBenchmarkBase
{
    private const string ExpressionText = "avg(values(@))";
    ...
    {
        using JsonWorkspace workspace = JsonWorkspace.Create();
        ConformanceAvgArrayCodeGen.Evaluate(this.CorvusData, workspace);
    }
}
