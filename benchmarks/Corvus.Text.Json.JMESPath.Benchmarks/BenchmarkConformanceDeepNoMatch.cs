// <copyright file="BenchmarkConformanceDeepNoMatch.cs" company="Endjin Limited">
...
/// <summary>
/// Conformance benchmark: deep field selection no match.
/// </summary>
[MemoryDiagnoser]
public class BenchmarkConformanceDeepNoMatch : JMESPathBenchmarkBase
{
    private const string ExpressionText = "a.b.c.d.e.f.g.h.i.j.k.l.m.n.o.p.q.r.s";
    ...
    {
        using JsonWorkspace workspace = JsonWorkspace.Create();
        ConformanceDeepNoMatchCodeGen.Evaluate(this.CorvusData, workspace);
    }
}
