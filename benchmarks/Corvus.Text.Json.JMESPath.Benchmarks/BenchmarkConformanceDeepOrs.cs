// <copyright file="BenchmarkConformanceDeepOrs.cs" company="Endjin Limited">
...
/// <summary>
/// Conformance benchmark: deep ors (26 variables).
/// </summary>
[MemoryDiagnoser]
public class BenchmarkConformanceDeepOrs : JMESPathBenchmarkBase
{
    ...
    {
        using JsonWorkspace workspace = JsonWorkspace.Create();
        ConformanceDeepOrsCodeGen.Evaluate(this.CorvusData, workspace);
    }
}
