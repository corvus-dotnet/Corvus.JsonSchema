// <copyright file="BenchmarkConformanceLongString.cs" company="Endjin Limited">
...
/// <summary>
/// Conformance benchmark: long raw string literal (208 chars).
/// </summary>
[MemoryDiagnoser]
public class BenchmarkConformanceLongString : JMESPathBenchmarkBase
{
    private static readonly string ExpressionText = File.ReadAllText(
        Path.Combine(AppContext.BaseDirectory, "Expressions", "conformance-long-string.jmespath")).Trim();
    ...
    {
        using JsonWorkspace workspace = JsonWorkspace.Create();
        ConformanceLongStringCodeGen.Evaluate(this.CorvusData, workspace);
    }
}
