// <copyright file="BenchmarkConformanceMaxArray.cs" company="Endjin Limited">
...
/// <summary>
/// Conformance benchmark: max of 26 values.
/// </summary>
[MemoryDiagnoser]
public class BenchmarkConformanceMaxArray : JMESPathBenchmarkBase
{
    private const string ExpressionText = "max(values(@))";
    ...
    {
        using JsonWorkspace workspace = JsonWorkspace.Create();
        ConformanceMaxArrayCodeGen.Evaluate(this.CorvusData, workspace);
    }
}
