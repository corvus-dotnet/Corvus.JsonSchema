// <copyright file="BenchmarkConformanceMinArray.cs" company="Endjin Limited">
...
/// <summary>
/// Conformance benchmark: min of 26 values.
/// </summary>
[MemoryDiagnoser]
public class BenchmarkConformanceMinArray : JMESPathBenchmarkBase
{
    private const string ExpressionText = "min(values(@))";
    ...
    {
        using JsonWorkspace workspace = JsonWorkspace.Create();
        ConformanceMinArrayCodeGen.Evaluate(this.CorvusData, workspace);
    }
}
