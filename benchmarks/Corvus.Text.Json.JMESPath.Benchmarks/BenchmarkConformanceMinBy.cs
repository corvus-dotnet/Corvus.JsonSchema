// <copyright file="BenchmarkConformanceMinBy.cs" company="Endjin Limited">
...
/// <summary>
/// Conformance benchmark: min_by over array of objects.
/// </summary>
[MemoryDiagnoser]
public class BenchmarkConformanceMinBy : JMESPathBenchmarkBase
{
    private const string ExpressionText = "min_by(items, &val)";
    ...
    {
        using JsonWorkspace workspace = JsonWorkspace.Create();
        ConformanceMinByCodeGen.Evaluate(this.CorvusData, workspace);
    }
}
