// <copyright file="BenchmarkConformanceMultiList.cs" company="Endjin Limited">
...
/// <summary>
/// Conformance benchmark: multi-select list (26 elements).
/// </summary>
[MemoryDiagnoser]
public class BenchmarkConformanceMultiList : JMESPathBenchmarkBase
{
    private const string ExpressionText = "[z, y, x, w, v, u, t, s, r, q, p, o, n, m, l, k, j, i, h, g, f, e, d, c, b, a]";
    ...
    {
        using JsonWorkspace workspace = JsonWorkspace.Create();
        ConformanceMultiListCodeGen.Evaluate(this.CorvusData, workspace);
    }
}
