// <copyright file="BenchmarkConformanceNestedSum.cs" company="Endjin Limited">
...
/// <summary>
/// Conformance benchmark: nested sum (26 levels deep).
/// </summary>
[MemoryDiagnoser]
public class BenchmarkConformanceNestedSum : JMESPathBenchmarkBase
{
    private static readonly string ExpressionText = File.ReadAllText(
        Path.Combine(AppContext.BaseDirectory, "Expressions", "conformance-nested-sum.jmespath")).Trim();
    ...
    {
        using JsonWorkspace workspace = JsonWorkspace.Create();
        ConformanceNestedSumCodeGen.Evaluate(this.CorvusData, workspace);
    }
}
