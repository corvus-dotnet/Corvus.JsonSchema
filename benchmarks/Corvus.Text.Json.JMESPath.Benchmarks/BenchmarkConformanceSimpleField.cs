// <copyright file="BenchmarkConformanceSimpleField.cs" company="Endjin Limited">
...
/// <summary>
/// Conformance benchmark: simple field.
/// </summary>
[MemoryDiagnoser]
public class BenchmarkConformanceSimpleField : JMESPathBenchmarkBase
{
    private const string ExpressionText = "b";
    ...
    {
        using JsonWorkspace workspace = JsonWorkspace.Create();
        ConformanceSimpleFieldCodeGen.Evaluate(this.CorvusData, workspace);
    }
}
