// <copyright file="BenchmarkConformanceSimpleOr.cs" company="Endjin Limited">
...
/// <summary>
/// Conformance benchmark: simple or.
/// </summary>
[MemoryDiagnoser]
public class BenchmarkConformanceSimpleOr : JMESPathBenchmarkBase
{
    private const string ExpressionText = "not_there || b";
    ...
    {
        using JsonWorkspace workspace = JsonWorkspace.Create();
        ConformanceSimpleOrCodeGen.Evaluate(this.CorvusData, workspace);
    }
}
