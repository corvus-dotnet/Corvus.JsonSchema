// <copyright file="BenchmarkConformanceSumArray.cs" company="Endjin Limited">
...
/// <summary>
/// Conformance benchmark: sum over 26-element array literal.
/// </summary>
[MemoryDiagnoser]
public class BenchmarkConformanceSumArray : JMESPathBenchmarkBase
{
    private const string ExpressionText = "sum([z, y, x, w, v, u, t, s, r, q, p, o, n, m, l, k, j, i, h, g, f, e, d, c, b, a])";
    ...
    {
        using JsonWorkspace workspace = JsonWorkspace.Create();
        ConformanceSumArrayCodeGen.Evaluate(this.CorvusData, workspace);
    }
}
