// <copyright file="BenchmarkFilterProjection.cs" company="Endjin Limited">
...
/// <summary>
/// Benchmark for filter projection: people[?age > `30`].name.
/// </summary>
[MemoryDiagnoser]
public class BenchmarkFilterProjection : JMESPathBenchmarkBase
{
    private const string ExpressionText = "people[?age > `30`].name";
    private const string DataJson = """{"people":[{"name":"Alice","age":30},{"name":"Bob","age":25},{"name":"Charlie","age":35},{"name":"Diana","age":28},{"name":"Eve","age":42}]}""";
    ...
    {
        using JsonWorkspace workspace = JsonWorkspace.Create();
        FilterProjectionCodeGen.Evaluate(this.CorvusData, workspace);
    }
}
