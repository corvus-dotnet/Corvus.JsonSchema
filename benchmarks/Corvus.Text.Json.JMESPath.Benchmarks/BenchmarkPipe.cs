// <copyright file="BenchmarkPipe.cs" company="Endjin Limited">
...
/// <summary>
/// Benchmark for pipe expression: people[*].age | sort(@) | [-1].
/// </summary>
[MemoryDiagnoser]
public class BenchmarkPipe : JMESPathBenchmarkBase
{
    private const string ExpressionText = "people[*].age | sort(@) | [-1]";
    ...
    {
        using JsonWorkspace workspace = JsonWorkspace.Create();
        PipeCodeGen.Evaluate(this.CorvusData, workspace);
    }
}
