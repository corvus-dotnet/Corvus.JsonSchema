...
/// <summary>
/// Benchmark for simple property access: foo.bar.
/// </summary>
[MemoryDiagnoser]
public class BenchmarkSimpleProperty : JMESPathBenchmarkBase
{
    private const string ExpressionText = "foo.bar";
    private const string DataJson = """{"foo":{"bar":"baz"}}""";
