// <copyright file="BenchmarkSortBy.cs" company="Endjin Limited">
...
/// <summary>
/// Benchmark for sort_by function with expression reference: sort_by(people, &amp;age).
/// </summary>
[MemoryDiagnoser]
public class BenchmarkSortBy : JMESPathBenchmarkBase
{
    private const string ExpressionText = "sort_by(people, &age)";
    ...
    {
        using JsonWorkspace workspace = JsonWorkspace.Create();
        SortByCodeGen.Evaluate(this.CorvusData, workspace);
    }
}
