    ...
    public readonly partial struct EnvItems
    {
        ...
        public readonly partial struct AutoCleanClosureEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AutoCleanClosureEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AutoCleanClosureEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AutoCleanClosureEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AutoCleanClosureEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AutoCleanClosureEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AutoCleanClosureEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AutoCleanClosureEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AutoCleanClosureEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AutoCleanClosureEntity, Mutable>(this);
            }
        }
    }
}
