...
public readonly partial struct Schema
{
    ...
    public readonly partial struct EnvItems
    {
        ...
        public readonly partial struct FailSpecWithNoExpectationsEntity
#if NET8_0_OR_GREATER
            : IJsonElement<FailSpecWithNoExpectationsEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="FailSpecWithNoExpectationsEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal FailSpecWithNoExpectationsEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static FailSpecWithNoExpectationsEntity DefaultInstance { get; } = ParsedJsonDocument<FailSpecWithNoExpectationsEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(FailSpecWithNoExpectationsEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in FailSpecWithNoExpectationsEntity left, in FailSpecWithNoExpectationsEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in FailSpecWithNoExpectationsEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(FailSpecWithNoExpectationsEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator FailSpecWithNoExpectationsEntity(JsonElement instance)
            {
                return FailSpecWithNoExpectationsEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FailSpecWithNoExpectationsEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FailSpecWithNoExpectationsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FailSpecWithNoExpectationsEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FailSpecWithNoExpectationsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FailSpecWithNoExpectationsEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FailSpecWithNoExpectationsEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FailSpecWithNoExpectationsEntity>(json, options);
            }
            ...
            /// </exception>
            public static FailSpecWithNoExpectationsEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<FailSpecWithNoExpectationsEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out FailSpecWithNoExpectationsEntity? result)
            {
                return JsonElementHelpers.TryParseValue<FailSpecWithNoExpectationsEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new FailSpecWithNoExpectationsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static FailSpecWithNoExpectationsEntity IJsonElement<FailSpecWithNoExpectationsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"FailSpecWithNoExpectationsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="FailSpecWithNoExpectationsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="FailSpecWithNoExpectationsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public FailSpecWithNoExpectationsEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<FailSpecWithNoExpectationsEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="FailSpecWithNoExpectationsEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public FailSpecWithNoExpectationsEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<FailSpecWithNoExpectationsEntity>(_idx);
                }
