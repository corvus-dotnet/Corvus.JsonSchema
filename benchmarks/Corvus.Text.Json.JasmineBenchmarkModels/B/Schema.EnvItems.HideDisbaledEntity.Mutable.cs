...
public readonly partial struct Schema
{
    ...
    public readonly partial struct EnvItems
    {
        ...
        public readonly partial struct HideDisbaledEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(HideDisbaledEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="HideDisbaledEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator HideDisbaledEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new HideDisbaledEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"HideDisbaledEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="HideDisbaledEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="HideDisbaledEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly HideDisbaledEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<HideDisbaledEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="HideDisbaledEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly HideDisbaledEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<HideDisbaledEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(HideDisbaledEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<HideDisbaledEntity, Mutable>(this);
            }
        }
    }
}
