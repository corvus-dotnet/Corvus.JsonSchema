...
public readonly partial struct Schema
{
    ...
    public readonly partial struct EnvItems
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="HideDisbaledEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal HideDisbaledEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static HideDisbaledEntity DefaultInstance { get; } = ParsedJsonDocument<HideDisbaledEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(HideDisbaledEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in HideDisbaledEntity left, in HideDisbaledEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in HideDisbaledEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(HideDisbaledEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator HideDisbaledEntity(JsonElement instance)
            {
                return HideDisbaledEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HideDisbaledEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HideDisbaledEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HideDisbaledEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HideDisbaledEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HideDisbaledEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HideDisbaledEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HideDisbaledEntity>(json, options);
            }
            ...
            /// </exception>
            public static HideDisbaledEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<HideDisbaledEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out HideDisbaledEntity? result)
            {
                return JsonElementHelpers.TryParseValue<HideDisbaledEntity>(ref reader, out result);
            }
...
#if NET
            static HideDisbaledEntity IJsonElement<HideDisbaledEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"HideDisbaledEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public HideDisbaledEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public HideDisbaledEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<HideDisbaledEntity>(_idx);
                }
