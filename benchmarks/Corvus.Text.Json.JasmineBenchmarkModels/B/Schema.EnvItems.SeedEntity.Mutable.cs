    ...
    public readonly partial struct EnvItems
    {
        ...
        public readonly partial struct SeedEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SeedEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SeedEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SeedEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SeedEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SeedEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SeedEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SeedEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.JasmineBenchmark.Baseline.Schema.EnvItems.SeedEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    {
                        return matchJsonString(Corvus.JasmineBenchmark.Baseline.JsonString.Mutable.From(this), context);
                    }

                    if (Corvus.JasmineBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonNumber(Corvus.JasmineBenchmark.Baseline.JsonNumber.Mutable.From(this), context);
                    }

                    if (Corvus.JasmineBenchmark.Baseline.JsonNull.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonNull(Corvus.JasmineBenchmark.Baseline.JsonNull.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.JasmineBenchmark.Baseline.Schema.EnvItems.SeedEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.JasmineBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonString(Corvus.JasmineBenchmark.Baseline.JsonString.Mutable.From(this));
                    }

                    if (Corvus.JasmineBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonNumber(Corvus.JasmineBenchmark.Baseline.JsonNumber.Mutable.From(this));
                    }

                    if (Corvus.JasmineBenchmark.Baseline.JsonNull.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonNull(Corvus.JasmineBenchmark.Baseline.JsonNull.Mutable.From(this));
                    }
                ...
                public bool TryGetAsJsonString(out Corvus.JasmineBenchmark.Baseline.JsonString result)
                {
                    if (Corvus.JasmineBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.JasmineBenchmark.Baseline.JsonString.Mutable.From(this);
                        return true;
                    }
                ...
                public bool TryGetAsJsonNumber(out Corvus.JasmineBenchmark.Baseline.JsonNumber result)
                {
                    if (Corvus.JasmineBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.JasmineBenchmark.Baseline.JsonNumber.Mutable.From(this);
                        return true;
                    }
                ...
                public bool TryGetAsJsonNull(out Corvus.JasmineBenchmark.Baseline.JsonNull result)
                {
                    if (Corvus.JasmineBenchmark.Baseline.JsonNull.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.JasmineBenchmark.Baseline.JsonNull.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SeedEntity instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.JasmineBenchmark.Baseline.JsonNull instance) => new(JsonElement.From(instance));

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.JasmineBenchmark.Baseline.JsonNumber instance) => new(JsonElement.From(instance));

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.JasmineBenchmark.Baseline.JsonString instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SeedEntity, Mutable>(this);
            }
        }
    }
}
