    ...
    public readonly partial struct EnvItems
    {
        ...
        public readonly partial struct StopOnSpecFailureEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(StopOnSpecFailureEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="StopOnSpecFailureEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator StopOnSpecFailureEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"StopOnSpecFailureEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly StopOnSpecFailureEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly StopOnSpecFailureEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<StopOnSpecFailureEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(StopOnSpecFailureEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<StopOnSpecFailureEntity, Mutable>(this);
            }
        }
    }
}
