...
public readonly partial struct Schema
{
    ...
    public readonly partial struct EnvItems
    {
        ...
        public readonly partial struct StopOnSpecFailureEntity
#if NET8_0_OR_GREATER
            : IJsonElement<StopOnSpecFailureEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="StopOnSpecFailureEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal StopOnSpecFailureEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static StopOnSpecFailureEntity DefaultInstance { get; } = ParsedJsonDocument<StopOnSpecFailureEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(StopOnSpecFailureEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in StopOnSpecFailureEntity left, in StopOnSpecFailureEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in StopOnSpecFailureEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(StopOnSpecFailureEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator StopOnSpecFailureEntity(JsonElement instance)
            {
                return StopOnSpecFailureEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StopOnSpecFailureEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StopOnSpecFailureEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<StopOnSpecFailureEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StopOnSpecFailureEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<StopOnSpecFailureEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StopOnSpecFailureEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<StopOnSpecFailureEntity>(json, options);
            }
            ...
            /// </exception>
            public static StopOnSpecFailureEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<StopOnSpecFailureEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out StopOnSpecFailureEntity? result)
            {
                return JsonElementHelpers.TryParseValue<StopOnSpecFailureEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new StopOnSpecFailureEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static StopOnSpecFailureEntity IJsonElement<StopOnSpecFailureEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"StopOnSpecFailureEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="StopOnSpecFailureEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="StopOnSpecFailureEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public StopOnSpecFailureEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<StopOnSpecFailureEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="StopOnSpecFailureEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public StopOnSpecFailureEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<StopOnSpecFailureEntity>(_idx);
                }
