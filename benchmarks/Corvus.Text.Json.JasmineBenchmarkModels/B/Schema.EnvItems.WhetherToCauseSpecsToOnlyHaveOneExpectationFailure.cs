...
public readonly partial struct Schema
{
    ...
    public readonly partial struct EnvItems
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="WhetherToCauseSpecsToOnlyHaveOneExpectationFailure"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal WhetherToCauseSpecsToOnlyHaveOneExpectationFailure(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static WhetherToCauseSpecsToOnlyHaveOneExpectationFailure DefaultInstance { get; } = ParsedJsonDocument<WhetherToCauseSpecsToOnlyHaveOneExpectationFailure>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(WhetherToCauseSpecsToOnlyHaveOneExpectationFailure value)
            {
            ...
            /// </returns>
            public static bool operator ==(in WhetherToCauseSpecsToOnlyHaveOneExpectationFailure left, in WhetherToCauseSpecsToOnlyHaveOneExpectationFailure right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in WhetherToCauseSpecsToOnlyHaveOneExpectationFailure left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(WhetherToCauseSpecsToOnlyHaveOneExpectationFailure instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator WhetherToCauseSpecsToOnlyHaveOneExpectationFailure(JsonElement instance)
            {
                return WhetherToCauseSpecsToOnlyHaveOneExpectationFailure.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WhetherToCauseSpecsToOnlyHaveOneExpectationFailure From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WhetherToCauseSpecsToOnlyHaveOneExpectationFailure ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WhetherToCauseSpecsToOnlyHaveOneExpectationFailure>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WhetherToCauseSpecsToOnlyHaveOneExpectationFailure ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WhetherToCauseSpecsToOnlyHaveOneExpectationFailure>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WhetherToCauseSpecsToOnlyHaveOneExpectationFailure ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WhetherToCauseSpecsToOnlyHaveOneExpectationFailure>(json, options);
            }
            ...
            /// </exception>
            public static WhetherToCauseSpecsToOnlyHaveOneExpectationFailure ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<WhetherToCauseSpecsToOnlyHaveOneExpectationFailure>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out WhetherToCauseSpecsToOnlyHaveOneExpectationFailure? result)
            {
                return JsonElementHelpers.TryParseValue<WhetherToCauseSpecsToOnlyHaveOneExpectationFailure>(ref reader, out result);
            }
...
#if NET
            static WhetherToCauseSpecsToOnlyHaveOneExpectationFailure IJsonElement<WhetherToCauseSpecsToOnlyHaveOneExpectationFailure>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"WhetherToCauseSpecsToOnlyHaveOneExpectationFailure: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public WhetherToCauseSpecsToOnlyHaveOneExpectationFailure Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public WhetherToCauseSpecsToOnlyHaveOneExpectationFailure Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<WhetherToCauseSpecsToOnlyHaveOneExpectationFailure>(_idx);
                }
