...
public readonly partial struct Schema
{
    ...
    public readonly partial struct EnvItems
    {
        ...
        public readonly partial struct WhetherToRandomizeSpecExecutionOrder
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(WhetherToRandomizeSpecExecutionOrder instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="WhetherToRandomizeSpecExecutionOrder"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WhetherToRandomizeSpecExecutionOrder(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new WhetherToRandomizeSpecExecutionOrder(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WhetherToRandomizeSpecExecutionOrder.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="WhetherToRandomizeSpecExecutionOrder"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="WhetherToRandomizeSpecExecutionOrder"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly WhetherToRandomizeSpecExecutionOrder Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<WhetherToRandomizeSpecExecutionOrder>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="WhetherToRandomizeSpecExecutionOrder"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly WhetherToRandomizeSpecExecutionOrder Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<WhetherToRandomizeSpecExecutionOrder>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(WhetherToRandomizeSpecExecutionOrder instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<WhetherToRandomizeSpecExecutionOrder, Mutable>(this);
            }
        }
    }
}
