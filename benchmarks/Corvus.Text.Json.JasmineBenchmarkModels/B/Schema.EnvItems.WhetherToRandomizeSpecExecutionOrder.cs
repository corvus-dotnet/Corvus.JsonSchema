...
public readonly partial struct Schema
{
    ...
    public readonly partial struct EnvItems
    {
        ...
        public readonly partial struct WhetherToRandomizeSpecExecutionOrder
            ...
            : IJsonElement<WhetherToRandomizeSpecExecutionOrder>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="WhetherToRandomizeSpecExecutionOrder"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal WhetherToRandomizeSpecExecutionOrder(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static WhetherToRandomizeSpecExecutionOrder DefaultInstance { get; } = ParsedJsonDocument<WhetherToRandomizeSpecExecutionOrder>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(WhetherToRandomizeSpecExecutionOrder value)
            {
            ...
            /// </returns>
            public static bool operator ==(in WhetherToRandomizeSpecExecutionOrder left, in WhetherToRandomizeSpecExecutionOrder right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in WhetherToRandomizeSpecExecutionOrder left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(WhetherToRandomizeSpecExecutionOrder instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator WhetherToRandomizeSpecExecutionOrder(JsonElement instance)
            {
                return WhetherToRandomizeSpecExecutionOrder.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WhetherToRandomizeSpecExecutionOrder From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WhetherToRandomizeSpecExecutionOrder ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WhetherToRandomizeSpecExecutionOrder>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WhetherToRandomizeSpecExecutionOrder ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WhetherToRandomizeSpecExecutionOrder>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WhetherToRandomizeSpecExecutionOrder ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WhetherToRandomizeSpecExecutionOrder>(json, options);
            }
            ...
            /// </exception>
            public static WhetherToRandomizeSpecExecutionOrder ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<WhetherToRandomizeSpecExecutionOrder>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out WhetherToRandomizeSpecExecutionOrder? result)
            {
                return JsonElementHelpers.TryParseValue<WhetherToRandomizeSpecExecutionOrder>(ref reader, out result);
            }
...
#if NET
            static WhetherToRandomizeSpecExecutionOrder IJsonElement<WhetherToRandomizeSpecExecutionOrder>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"WhetherToRandomizeSpecExecutionOrder: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public WhetherToRandomizeSpecExecutionOrder Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public WhetherToRandomizeSpecExecutionOrder Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<WhetherToRandomizeSpecExecutionOrder>(_idx);
                }
