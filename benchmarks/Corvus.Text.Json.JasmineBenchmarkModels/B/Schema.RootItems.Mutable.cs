...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RootItems
    {
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.JasmineBenchmark.Baseline.Schema.RootItems.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.JasmineBenchmark.Baseline.Schema.RootItems.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.JasmineBenchmark.Baseline.Schema.RootItems.SpecDirEntity.Source specDir, in Corvus.JasmineBenchmark.Baseline.Schema.RootItems.SpecFilesJArray.Source specFiles, in Corvus.JasmineBenchmark.Baseline.Schema.RootItems.JsonStringArray.Source helpers = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.JasmineBenchmark.Baseline.Schema.RootItems.SpecDirEntity.Source specDir, in Corvus.JasmineBenchmark.Baseline.Schema.RootItems.SpecFilesJArray.Source<TContext> specFiles, in Corvus.JasmineBenchmark.Baseline.Schema.RootItems.JsonStringArray.Source<TContext> helpers = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
