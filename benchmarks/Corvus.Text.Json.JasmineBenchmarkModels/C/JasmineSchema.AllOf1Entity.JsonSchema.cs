        ...
        : IJsonElement<AllOf1Entity>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchEnv(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            [NotNullWhen(true)]
#endif
            out Corvus.JasmineBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator? matcher)
            {
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (objectValidation_enumerator.MoveNext())
                    {
                        ...
                        if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out Corvus.JasmineBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator? validator))
                        {
