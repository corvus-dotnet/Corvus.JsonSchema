...
public readonly partial struct JasmineSchema
{
    ...
    public readonly partial struct AllOf1Entity
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.Mutable Env
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnvUtf8, out Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetEnv(scoped in Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetEnv<TContext>(in Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.Source<TContext> value)
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.Source _createArg1;
            ...
            internal Source(Corvus.JasmineBenchmark.Current.JasmineSchema.AllOf1Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.Source arg1)
            {
                _createArg1 = arg1;
                _kind = Kind.Create;
            }
            ...
            #endif
        {
            ...
            private readonly Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.Source<TContext> _createArg1;
            ...
            internal Source(scoped in TContext context, Corvus.JasmineBenchmark.Current.JasmineSchema.AllOf1Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in TContext context, scoped in Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.Source<TContext> arg1)
            {
                _context = context;
                _createArg1 = arg1;
                _kind = Kind.Create;
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.Source env = default)
            {
            ...
            /// Creates an instance of a <see cref="AllOf1Entity"/>.
            /// </summary>
            public void Create(in Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.Source env = default)
            {
                Create(ref _builder, env);
            }
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.Source<TContext> env = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="AllOf1Entity"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.Source<TContext> env = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
                Create(context, ref _builder, env);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.Source arg1, ref ComplexValueBuilder o)
            {
                o.StartObject();
                Create(ref o, arg1);
                o.EndObject();
            ...
            /// <param name="arg1">The value of the property.</param>
            /// <param name="o">The complex value builder into which to write the object.</param>
            internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.Source<TContext> arg1, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.Source env = default)
        {
        ...
        /// <param name="env">The value of the <c>"env"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.Source<TContext> env = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Source<TContext>(context, env);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.Source env = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.Source<TContext> env = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        public static ParsedJsonDocument<AllOf1Entity> Create(in Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.Source env = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<AllOf1Entity> Create<TContext>(in TContext context, in Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.Source<TContext> env = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
