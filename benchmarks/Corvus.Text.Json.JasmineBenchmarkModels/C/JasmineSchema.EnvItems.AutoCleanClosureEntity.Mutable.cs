    ...
    public readonly partial struct EnvItems
    {
        ...
        public readonly partial struct AutoCleanClosureEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AutoCleanClosureEntity, Mutable>(AutoCleanClosureEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<AutoCleanClosureEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AutoCleanClosureEntity>();
                }
                finally
                {
