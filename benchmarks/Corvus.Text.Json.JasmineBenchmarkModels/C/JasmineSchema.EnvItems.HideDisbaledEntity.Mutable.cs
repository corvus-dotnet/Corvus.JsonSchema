    ...
    public readonly partial struct EnvItems
    {
        ...
        public readonly partial struct HideDisbaledEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<HideDisbaledEntity, Mutable>(HideDisbaledEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<HideDisbaledEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<HideDisbaledEntity>();
                }
                finally
                {
