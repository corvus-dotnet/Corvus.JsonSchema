...
public readonly partial struct JasmineSchema
{
    ...
    public readonly partial struct EnvItems
    {
...
#endif
        {
            ...
            /// <summary>
            /// Gets a <see cref="EnvItems"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="EnvItems"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly EnvItems Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<EnvItems>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="EnvItems"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly EnvItems Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EnvItems>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.AutoCleanClosureEntity.Source _createArg1;
            private readonly Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.FailSpecWithNoExpectationsEntity.Source _createArg2;
            private readonly Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.HideDisbaledEntity.Source _createArg3;
            private readonly Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.WhetherToRandomizeSpecExecutionOrder.Source _createArg4;
            private readonly Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.SeedEntity.Source _createArg5;
            private readonly Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.StopOnSpecFailureEntity.Source _createArg6;
            private readonly Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.WhetherToCauseSpecsToOnlyHaveOneExpectationFailure.Source _createArg7;
            private readonly Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.VerboseDepricationEntity.Source _createArg8;
        ...
        /// </summary>
        /// <param name="autoCleanClosure">The value of the <c>"autoCleanClosure"</c> property.</param>
        /// <param name="failSpecWithNoExpectations">The value of the <c>"failSpecWithNoExpectations"</c> property.</param>
        /// <param name="hideDisbaled">The value of the <c>"hideDisbaled"</c> property.</param>
        /// <param name="random">The value of the <c>"random"</c> property.</param>
        /// <param name="seed">The value of the <c>"seed"</c> property.</param>
        /// <param name="stopOnSpecFailure">The value of the <c>"stopOnSpecFailure"</c> property.</param>
        ...
        public static ParsedJsonDocument<EnvItems> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EnvItems>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<EnvItems> Create<TContext>(
