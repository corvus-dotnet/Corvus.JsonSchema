    ...
    public readonly partial struct EnvItems
    {
        ...
        public readonly partial struct SeedEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SeedEntity, Mutable>(SeedEntity.DefaultInstance);
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.JasmineBenchmark.Current.JsonString, TContext, TResult> matchJsonString,
                    Matcher<Corvus.JasmineBenchmark.Current.JsonNumber, TContext, TResult> matchJsonNumber,
                    Matcher<Corvus.JasmineBenchmark.Current.JsonNull, TContext, TResult> matchJsonNull,
                    Matcher<Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.SeedEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    {
                        return matchJsonString(Corvus.JasmineBenchmark.Current.JsonString.Mutable.From(this), context);
                    }

                    if (Corvus.JasmineBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonNumber(Corvus.JasmineBenchmark.Current.JsonNumber.Mutable.From(this), context);
                    }

                    if (Corvus.JasmineBenchmark.Current.JsonNull.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonNull(Corvus.JasmineBenchmark.Current.JsonNull.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.JasmineBenchmark.Current.JsonString, TResult> matchJsonString,
                    Matcher<Corvus.JasmineBenchmark.Current.JsonNumber, TResult> matchJsonNumber,
                    Matcher<Corvus.JasmineBenchmark.Current.JsonNull, TResult> matchJsonNull,
                    Matcher<Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.SeedEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.JasmineBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonString(Corvus.JasmineBenchmark.Current.JsonString.Mutable.From(this));
                    }

                    if (Corvus.JasmineBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonNumber(Corvus.JasmineBenchmark.Current.JsonNumber.Mutable.From(this));
                    }

                    if (Corvus.JasmineBenchmark.Current.JsonNull.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonNull(Corvus.JasmineBenchmark.Current.JsonNull.Mutable.From(this));
                    }
                ...
                public TAccumulator MatchEvery<TAccumulator>(
                    ...
                    Matcher<Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.SeedEntity.Mutable, TAccumulator, TAccumulator> defaultMatch)
                {
                    bool matched = false;
                    ...
                    {
                        matched = true;
                        accumulator = matchJsonString(Corvus.JasmineBenchmark.Current.JsonString.Mutable.From(this), accumulator);
                    }

                    if (Corvus.JasmineBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
                        matched = true;
                        accumulator = matchJsonNumber(Corvus.JasmineBenchmark.Current.JsonNumber.Mutable.From(this), accumulator);
                    }

                    if (Corvus.JasmineBenchmark.Current.JsonNull.JsonSchema.Evaluate(_parent, _idx))
                    {
                        matched = true;
                        accumulator = matchJsonNull(Corvus.JasmineBenchmark.Current.JsonNull.Mutable.From(this), accumulator);
                    }
                ...
                public bool TryGetAsJsonString(out Corvus.JasmineBenchmark.Current.JsonString.Mutable result)
                {
                    if (Corvus.JasmineBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.JasmineBenchmark.Current.JsonString.Mutable.From(this);
                        return true;
                    }
                ...
                public bool TryGetAsJsonNumber(out Corvus.JasmineBenchmark.Current.JsonNumber.Mutable result)
                {
                    if (Corvus.JasmineBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.JasmineBenchmark.Current.JsonNumber.Mutable.From(this);
                        return true;
                    }
                ...
                public bool TryGetAsJsonNull(out Corvus.JasmineBenchmark.Current.JsonNull.Mutable result)
                {
                    if (Corvus.JasmineBenchmark.Current.JsonNull.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.JasmineBenchmark.Current.JsonNull.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.JasmineBenchmark.Current.JsonNull instance) => new(JsonElement.From(instance));

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.JasmineBenchmark.Current.JsonNumber instance) => new(JsonElement.From(instance));

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.JasmineBenchmark.Current.JsonString instance) => new(JsonElement.From(instance));
            ...
            public static ParsedJsonDocument<SeedEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SeedEntity>();
                }
                finally
                {
