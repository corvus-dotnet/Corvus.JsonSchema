...
public readonly partial struct JasmineSchema
{
    ...
    public readonly partial struct EnvItems
    {
...
#endif
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator sbyte(SeedEntity value) => value._parent.TryGetValue(value._idx, out sbyte result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator byte(SeedEntity value) => value._parent.TryGetValue(value._idx, out byte result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator short(SeedEntity value) => value._parent.TryGetValue(value._idx, out short result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator ushort(SeedEntity value) => value._parent.TryGetValue(value._idx, out ushort result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator int(SeedEntity value) => value._parent.TryGetValue(value._idx, out int result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator uint(SeedEntity value) => value._parent.TryGetValue(value._idx, out uint result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator ulong(SeedEntity value) => value._parent.TryGetValue(value._idx, out ulong result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator float(SeedEntity value) => value._parent.TryGetValue(value._idx, out float result) ? result : throw new FormatException();

#if NET
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator Int128(SeedEntity value) => value._parent.TryGetValue(value._idx, out Int128 result) ? result : throw new FormatException();
#endif

#if NET
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator UInt128(SeedEntity value) => value._parent.TryGetValue(value._idx, out UInt128 result) ? result : throw new FormatException();
#endif

#if NET
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator Half(SeedEntity value) => value._parent.TryGetValue(value._idx, out Half result) ? result : throw new FormatException();
#endif
            ...
            public bool TryGetAsJsonString(out Corvus.JasmineBenchmark.Current.JsonString result)
            {
                ...
                {
                    result = Corvus.JasmineBenchmark.Current.JsonString.From(this);
                    return true;
                }
            ...
            public bool TryGetAsJsonNumber(out Corvus.JasmineBenchmark.Current.JsonNumber result)
            {
                ...
                {
                    result = Corvus.JasmineBenchmark.Current.JsonNumber.From(this);
                    return true;
                }
            ...
            public bool TryGetAsJsonNull(out Corvus.JasmineBenchmark.Current.JsonNull result)
            {
                ...
                {
                    result = Corvus.JasmineBenchmark.Current.JsonNull.From(this);
                    return true;
                }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.SeedEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                if (Corvus.JasmineBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonString(Corvus.JasmineBenchmark.Current.JsonString.From(this), context);
                }

                if (Corvus.JasmineBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonNumber(Corvus.JasmineBenchmark.Current.JsonNumber.From(this), context);
                }

                if (Corvus.JasmineBenchmark.Current.JsonNull.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonNull(Corvus.JasmineBenchmark.Current.JsonNull.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.JasmineBenchmark.Current.JasmineSchema.EnvItems.SeedEntity, TResult> defaultMatch)
            {
                if (Corvus.JasmineBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonString(Corvus.JasmineBenchmark.Current.JsonString.From(this));
                }

                if (Corvus.JasmineBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonNumber(Corvus.JasmineBenchmark.Current.JsonNumber.From(this));
                }

                if (Corvus.JasmineBenchmark.Current.JsonNull.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonNull(Corvus.JasmineBenchmark.Current.JsonNull.From(this));
                }
