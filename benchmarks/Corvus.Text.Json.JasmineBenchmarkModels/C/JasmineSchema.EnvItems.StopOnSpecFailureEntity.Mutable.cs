    ...
    public readonly partial struct EnvItems
    {
        ...
        public readonly partial struct StopOnSpecFailureEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<StopOnSpecFailureEntity, Mutable>(StopOnSpecFailureEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<StopOnSpecFailureEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<StopOnSpecFailureEntity>();
                }
                finally
                {
