    ...
    public readonly partial struct EnvItems
    {
        ...
        public readonly partial struct VerboseDepricationEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<VerboseDepricationEntity, Mutable>(VerboseDepricationEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(VerboseDepricationEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="VerboseDepricationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator VerboseDepricationEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"VerboseDepricationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly VerboseDepricationEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly VerboseDepricationEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<VerboseDepricationEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(VerboseDepricationEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<VerboseDepricationEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<VerboseDepricationEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<VerboseDepricationEntity>();
                }
                finally
                {
