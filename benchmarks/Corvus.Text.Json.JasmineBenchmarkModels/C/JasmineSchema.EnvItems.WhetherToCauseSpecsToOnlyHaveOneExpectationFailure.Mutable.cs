...
public readonly partial struct JasmineSchema
{
    ...
    public readonly partial struct EnvItems
    {
        ...
        public readonly partial struct WhetherToCauseSpecsToOnlyHaveOneExpectationFailure
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<WhetherToCauseSpecsToOnlyHaveOneExpectationFailure, Mutable>(WhetherToCauseSpecsToOnlyHaveOneExpectationFailure.DefaultInstance);
                ...
                public static explicit operator Mutable(WhetherToCauseSpecsToOnlyHaveOneExpectationFailure instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="WhetherToCauseSpecsToOnlyHaveOneExpectationFailure"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WhetherToCauseSpecsToOnlyHaveOneExpectationFailure(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new WhetherToCauseSpecsToOnlyHaveOneExpectationFailure(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WhetherToCauseSpecsToOnlyHaveOneExpectationFailure.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="WhetherToCauseSpecsToOnlyHaveOneExpectationFailure"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="WhetherToCauseSpecsToOnlyHaveOneExpectationFailure"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly WhetherToCauseSpecsToOnlyHaveOneExpectationFailure Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<WhetherToCauseSpecsToOnlyHaveOneExpectationFailure>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="WhetherToCauseSpecsToOnlyHaveOneExpectationFailure"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly WhetherToCauseSpecsToOnlyHaveOneExpectationFailure Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<WhetherToCauseSpecsToOnlyHaveOneExpectationFailure>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(WhetherToCauseSpecsToOnlyHaveOneExpectationFailure instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<WhetherToCauseSpecsToOnlyHaveOneExpectationFailure, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<WhetherToCauseSpecsToOnlyHaveOneExpectationFailure> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<WhetherToCauseSpecsToOnlyHaveOneExpectationFailure>();
                }
                finally
                {
