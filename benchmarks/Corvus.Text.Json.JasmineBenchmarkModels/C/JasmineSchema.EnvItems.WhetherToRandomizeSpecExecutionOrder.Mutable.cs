    ...
    public readonly partial struct EnvItems
    {
        ...
        public readonly partial struct WhetherToRandomizeSpecExecutionOrder
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<WhetherToRandomizeSpecExecutionOrder, Mutable>(WhetherToRandomizeSpecExecutionOrder.DefaultInstance);
            ...
            public static ParsedJsonDocument<WhetherToRandomizeSpecExecutionOrder> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<WhetherToRandomizeSpecExecutionOrder>();
                }
                finally
                {
