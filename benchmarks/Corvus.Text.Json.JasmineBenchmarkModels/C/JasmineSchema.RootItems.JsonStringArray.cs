...
public readonly partial struct JasmineSchema
{
    ...
    public readonly partial struct RootItems
    {
...
#endif
        {
            ...
            public Corvus.JasmineBenchmark.Current.JsonString this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.JasmineBenchmark.Current.JsonString>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.JasmineBenchmark.Current.JsonString> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.JasmineBenchmark.Current.JsonString>(_parent, _idx);
            }
