...
public readonly partial struct JasmineSchema
{
    ...
    public readonly partial struct RootItems
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RootItems instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RootItems"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RootItems(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.JsonStringArray.Mutable Helpers
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HelpersUtf8, out Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.JsonStringArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.SpecDirEntity.Mutable SpecDir
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SpecDirUtf8, out Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.SpecDirEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.SpecFilesJArray.Mutable SpecFiles
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SpecFilesUtf8, out Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.SpecFilesJArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetHelpers<TContext>(in Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.JsonStringArray.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetSpecFiles<TContext>(in Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.SpecFilesJArray.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RootItems.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly RootItems Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly RootItems Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RootItems>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.SpecDirEntity.Source _createArg1;
            private readonly Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.SpecFilesJArray.Source _createArg2;
            private readonly Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.JsonStringArray.Source _createArg3;
            ...
            public static implicit operator Source(RootItems instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.SpecDirEntity.Source _createArg1;
            private readonly Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.SpecFilesJArray.Source<TContext> _createArg2;
            private readonly Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.JsonStringArray.Source<TContext> _createArg3;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="RootItems"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.SpecDirEntity.Source specDir,
                in Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.SpecFilesJArray.Source specFiles,
                in Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.JsonStringArray.Source helpers = default)
            {
            ...
            public void Create(
                ...
                in Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.JsonStringArray.Source helpers = default)
            {
                Create(ref _builder, specDir, specFiles, helpers);
            }
            ...
            internal static void Create<TContext>(
                ...
                ref ComplexValueBuilder builder,
                in Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.SpecDirEntity.Source specDir,
                in Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.SpecFilesJArray.Source<TContext> specFiles,
                in Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.JsonStringArray.Source<TContext> helpers = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            #endif
            {
                Create(context, ref _builder, specDir, specFiles, helpers);
            }
        ...
        /// </summary>
        /// <param name="specDir">The value of the <c>"spec_dir"</c> property.</param>
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.SpecDirEntity.Source specDir, scoped in Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.SpecFilesJArray.Source<TContext> specFiles, scoped in Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.JsonStringArray.Source<TContext> helpers = default)
            ...
            #endif
        {
            return new Source<TContext>(context, specDir, specFiles, helpers);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.SpecDirEntity.Source specDir, in Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.SpecFilesJArray.Source specFiles, in Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.JsonStringArray.Source helpers = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(specDir, specFiles, helpers);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.SpecDirEntity.Source specDir, in Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.SpecFilesJArray.Source<TContext> specFiles, in Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.JsonStringArray.Source<TContext> helpers = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, specDir, specFiles, helpers);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<RootItems, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<RootItems> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<RootItems>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<RootItems> Create<TContext>(
        ...
        public static ParsedJsonDocument<RootItems> Create(in Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.SpecDirEntity.Source specDir, in Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.SpecFilesJArray.Source specFiles, in Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.JsonStringArray.Source helpers = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<RootItems> Create<TContext>(in TContext context, in Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.SpecDirEntity.Source specDir, in Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.SpecFilesJArray.Source<TContext> specFiles, in Corvus.JasmineBenchmark.Current.JasmineSchema.RootItems.JsonStringArray.Source<TContext> helpers = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
