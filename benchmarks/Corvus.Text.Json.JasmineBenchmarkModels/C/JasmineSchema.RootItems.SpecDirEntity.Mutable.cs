...
public readonly partial struct JasmineSchema
{
    ...
    public readonly partial struct RootItems
    {
        ...
        public readonly partial struct SpecDirEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SpecDirEntity, Mutable>(SpecDirEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(SpecDirEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SpecDirEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SpecDirEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new SpecDirEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SpecDirEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="SpecDirEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="SpecDirEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly SpecDirEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<SpecDirEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="SpecDirEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly SpecDirEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SpecDirEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SpecDirEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SpecDirEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SpecDirEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SpecDirEntity>();
                }
                finally
                {
