...
public readonly partial struct JsonNull
{
...
#endif
    {
        ...
        public static explicit operator Mutable(JsonNull instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="JsonNull"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonNull(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonNull.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly JsonNull Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly JsonNull Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonNull>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(JsonNull instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<JsonNull, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<JsonNull> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<JsonNull>();
        }
        finally
        {
