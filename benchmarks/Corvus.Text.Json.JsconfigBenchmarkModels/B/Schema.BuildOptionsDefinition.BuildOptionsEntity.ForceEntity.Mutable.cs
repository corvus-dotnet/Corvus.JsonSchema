        ...
        public readonly partial struct BuildOptionsEntity
        {
            ...
            public readonly partial struct ForceEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ForceEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ForceEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ForceEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ForceEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ForceEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ForceEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ForceEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ForceEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ForceEntity, Mutable>(this);
                }
            }
        }
    }
