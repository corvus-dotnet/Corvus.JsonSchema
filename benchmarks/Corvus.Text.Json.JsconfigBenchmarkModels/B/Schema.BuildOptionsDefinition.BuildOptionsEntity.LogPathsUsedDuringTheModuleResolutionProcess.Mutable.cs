        ...
        public readonly partial struct BuildOptionsEntity
        {
            ...
            public readonly partial struct LogPathsUsedDuringTheModuleResolutionProcess
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(LogPathsUsedDuringTheModuleResolutionProcess instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="LogPathsUsedDuringTheModuleResolutionProcess"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator LogPathsUsedDuringTheModuleResolutionProcess(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"LogPathsUsedDuringTheModuleResolutionProcess.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly LogPathsUsedDuringTheModuleResolutionProcess Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly LogPathsUsedDuringTheModuleResolutionProcess Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<LogPathsUsedDuringTheModuleResolutionProcess>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(LogPathsUsedDuringTheModuleResolutionProcess instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<LogPathsUsedDuringTheModuleResolutionProcess, Mutable>(this);
                }
            }
        }
    }
