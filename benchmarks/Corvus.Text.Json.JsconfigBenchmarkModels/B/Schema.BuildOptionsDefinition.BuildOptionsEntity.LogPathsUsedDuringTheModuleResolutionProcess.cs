...
public readonly partial struct Schema
{
    ...
    public readonly partial struct BuildOptionsDefinition
    {
        ...
        public readonly partial struct BuildOptionsEntity
        {
            ...
            public readonly partial struct LogPathsUsedDuringTheModuleResolutionProcess
#if NET8_0_OR_GREATER
                : IJsonElement<LogPathsUsedDuringTheModuleResolutionProcess>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="LogPathsUsedDuringTheModuleResolutionProcess"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal LogPathsUsedDuringTheModuleResolutionProcess(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static LogPathsUsedDuringTheModuleResolutionProcess DefaultInstance { get; } = ParsedJsonDocument<LogPathsUsedDuringTheModuleResolutionProcess>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(LogPathsUsedDuringTheModuleResolutionProcess value)
                {
                ...
                /// </returns>
                public static bool operator ==(in LogPathsUsedDuringTheModuleResolutionProcess left, in LogPathsUsedDuringTheModuleResolutionProcess right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in LogPathsUsedDuringTheModuleResolutionProcess left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(LogPathsUsedDuringTheModuleResolutionProcess instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LogPathsUsedDuringTheModuleResolutionProcess(JsonElement instance)
                {
                    return LogPathsUsedDuringTheModuleResolutionProcess.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static LogPathsUsedDuringTheModuleResolutionProcess From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static LogPathsUsedDuringTheModuleResolutionProcess ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<LogPathsUsedDuringTheModuleResolutionProcess>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static LogPathsUsedDuringTheModuleResolutionProcess ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<LogPathsUsedDuringTheModuleResolutionProcess>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static LogPathsUsedDuringTheModuleResolutionProcess ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<LogPathsUsedDuringTheModuleResolutionProcess>(json, options);
                }
                ...
                /// </exception>
                public static LogPathsUsedDuringTheModuleResolutionProcess ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<LogPathsUsedDuringTheModuleResolutionProcess>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out LogPathsUsedDuringTheModuleResolutionProcess? result)
                {
                    return JsonElementHelpers.TryParseValue<LogPathsUsedDuringTheModuleResolutionProcess>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new LogPathsUsedDuringTheModuleResolutionProcess(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static LogPathsUsedDuringTheModuleResolutionProcess IJsonElement<LogPathsUsedDuringTheModuleResolutionProcess>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LogPathsUsedDuringTheModuleResolutionProcess: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="LogPathsUsedDuringTheModuleResolutionProcess"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="LogPathsUsedDuringTheModuleResolutionProcess"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public LogPathsUsedDuringTheModuleResolutionProcess Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<LogPathsUsedDuringTheModuleResolutionProcess>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="LogPathsUsedDuringTheModuleResolutionProcess"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public LogPathsUsedDuringTheModuleResolutionProcess Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<LogPathsUsedDuringTheModuleResolutionProcess>(_idx);
                    }
