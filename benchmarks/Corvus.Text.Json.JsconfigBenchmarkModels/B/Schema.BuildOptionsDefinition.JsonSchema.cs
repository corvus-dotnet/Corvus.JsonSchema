...
public readonly partial struct Schema
{
    ...
    public readonly partial struct BuildOptionsDefinition
        : IJsonElement<BuildOptionsDefinition>
    {
        public static partial class JsonSchema
        {
            private static readonly JsonSchemaPathProvider BuildOptionsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/buildOptions"u8, buffer, out written);

            private static void MatchBuildOptions(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.JsconfigBenchmark.Baseline.Schema.BuildOptionsDefinition.BuildOptionsEntity.JsonSchema.PushChildContextUnescaped(
                        ...
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.BuildOptionsUtf8,
                        evaluationPath: BuildOptionsSchemaEvaluationPath);

                Corvus.JsconfigBenchmark.Baseline.Schema.BuildOptionsDefinition.BuildOptionsEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.BuildOptionsUtf8))
                {
                    matcher = MatchBuildOptions;
                    return true;
                }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/jsconfig.json#/definitions/buildOptionsDefinition"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://json.schemastore.org/jsconfig.json#/definitions/buildOptionsDefinition";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/jsconfig.json#/definitions/buildOptionsDefinition"u8;
