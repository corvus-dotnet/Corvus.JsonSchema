...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct CreateSourcemapsForDTsFiles
#if NET8_0_OR_GREATER
                : IJsonElement<CreateSourcemapsForDTsFiles>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="CreateSourcemapsForDTsFiles"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal CreateSourcemapsForDTsFiles(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static CreateSourcemapsForDTsFiles DefaultInstance { get; } = ParsedJsonDocument<CreateSourcemapsForDTsFiles>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(CreateSourcemapsForDTsFiles value)
                {
                ...
                /// </returns>
                public static bool operator ==(in CreateSourcemapsForDTsFiles left, in CreateSourcemapsForDTsFiles right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in CreateSourcemapsForDTsFiles left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(CreateSourcemapsForDTsFiles instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CreateSourcemapsForDTsFiles(JsonElement instance)
                {
                    return CreateSourcemapsForDTsFiles.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CreateSourcemapsForDTsFiles From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CreateSourcemapsForDTsFiles ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<CreateSourcemapsForDTsFiles>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CreateSourcemapsForDTsFiles ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<CreateSourcemapsForDTsFiles>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CreateSourcemapsForDTsFiles ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<CreateSourcemapsForDTsFiles>(json, options);
                }
                ...
                /// </exception>
                public static CreateSourcemapsForDTsFiles ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<CreateSourcemapsForDTsFiles>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out CreateSourcemapsForDTsFiles? result)
                {
                    return JsonElementHelpers.TryParseValue<CreateSourcemapsForDTsFiles>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new CreateSourcemapsForDTsFiles(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static CreateSourcemapsForDTsFiles IJsonElement<CreateSourcemapsForDTsFiles>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CreateSourcemapsForDTsFiles: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="CreateSourcemapsForDTsFiles"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="CreateSourcemapsForDTsFiles"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public CreateSourcemapsForDTsFiles Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<CreateSourcemapsForDTsFiles>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="CreateSourcemapsForDTsFiles"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public CreateSourcemapsForDTsFiles Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<CreateSourcemapsForDTsFiles>(_idx);
                    }
