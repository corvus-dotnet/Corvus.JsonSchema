        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct EnableImportingJsonFiles
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(EnableImportingJsonFiles instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="EnableImportingJsonFiles"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator EnableImportingJsonFiles(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new EnableImportingJsonFiles(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"EnableImportingJsonFiles.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="EnableImportingJsonFiles"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="EnableImportingJsonFiles"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EnableImportingJsonFiles Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<EnableImportingJsonFiles>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="EnableImportingJsonFiles"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EnableImportingJsonFiles Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<EnableImportingJsonFiles>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(EnableImportingJsonFiles instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<EnableImportingJsonFiles, Mutable>(this);
                }
            }
        }
    }
