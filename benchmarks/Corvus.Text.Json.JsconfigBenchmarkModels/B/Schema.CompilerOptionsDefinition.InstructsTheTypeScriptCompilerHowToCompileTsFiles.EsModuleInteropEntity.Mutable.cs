        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct EsModuleInteropEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(EsModuleInteropEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="EsModuleInteropEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator EsModuleInteropEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"EsModuleInteropEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EsModuleInteropEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EsModuleInteropEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<EsModuleInteropEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(EsModuleInteropEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<EsModuleInteropEntity, Mutable>(this);
                }
            }
        }
    }
