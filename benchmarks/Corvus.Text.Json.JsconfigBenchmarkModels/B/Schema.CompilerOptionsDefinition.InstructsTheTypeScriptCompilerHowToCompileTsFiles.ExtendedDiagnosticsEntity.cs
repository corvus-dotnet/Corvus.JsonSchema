...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct ExtendedDiagnosticsEntity
#if NET8_0_OR_GREATER
                : IJsonElement<ExtendedDiagnosticsEntity>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="ExtendedDiagnosticsEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal ExtendedDiagnosticsEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static ExtendedDiagnosticsEntity DefaultInstance { get; } = ParsedJsonDocument<ExtendedDiagnosticsEntity>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(ExtendedDiagnosticsEntity value)
                {
                ...
                /// </returns>
                public static bool operator ==(in ExtendedDiagnosticsEntity left, in ExtendedDiagnosticsEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in ExtendedDiagnosticsEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(ExtendedDiagnosticsEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExtendedDiagnosticsEntity(JsonElement instance)
                {
                    return ExtendedDiagnosticsEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ExtendedDiagnosticsEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ExtendedDiagnosticsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ExtendedDiagnosticsEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ExtendedDiagnosticsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ExtendedDiagnosticsEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ExtendedDiagnosticsEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ExtendedDiagnosticsEntity>(json, options);
                }
                ...
                /// </exception>
                public static ExtendedDiagnosticsEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<ExtendedDiagnosticsEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out ExtendedDiagnosticsEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<ExtendedDiagnosticsEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ExtendedDiagnosticsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static ExtendedDiagnosticsEntity IJsonElement<ExtendedDiagnosticsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExtendedDiagnosticsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ExtendedDiagnosticsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ExtendedDiagnosticsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public ExtendedDiagnosticsEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ExtendedDiagnosticsEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ExtendedDiagnosticsEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public ExtendedDiagnosticsEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<ExtendedDiagnosticsEntity>(_idx);
                    }
