...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct ImportHelpersEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ImportHelpersEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ImportHelpersEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ImportHelpersEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new ImportHelpersEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ImportHelpersEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="ImportHelpersEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="ImportHelpersEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ImportHelpersEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<ImportHelpersEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="ImportHelpersEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ImportHelpersEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ImportHelpersEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ImportHelpersEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ImportHelpersEntity, Mutable>(this);
                }
            }
        }
    }
