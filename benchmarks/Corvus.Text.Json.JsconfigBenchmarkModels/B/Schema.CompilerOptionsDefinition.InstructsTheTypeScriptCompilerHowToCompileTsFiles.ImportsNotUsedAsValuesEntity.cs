    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="ImportsNotUsedAsValuesEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal ImportsNotUsedAsValuesEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static ImportsNotUsedAsValuesEntity DefaultInstance { get; } = ParsedJsonDocument<ImportsNotUsedAsValuesEntity>.StringConstant([.."\"remove\""u8]);
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(ImportsNotUsedAsValuesEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in ImportsNotUsedAsValuesEntity left, in ImportsNotUsedAsValuesEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in ImportsNotUsedAsValuesEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(ImportsNotUsedAsValuesEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ImportsNotUsedAsValuesEntity(JsonElement instance)
                {
                    return ImportsNotUsedAsValuesEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ImportsNotUsedAsValuesEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ImportsNotUsedAsValuesEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ImportsNotUsedAsValuesEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ImportsNotUsedAsValuesEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ImportsNotUsedAsValuesEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ImportsNotUsedAsValuesEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ImportsNotUsedAsValuesEntity>(json, options);
                }
                ...
                /// </exception>
                public static ImportsNotUsedAsValuesEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<ImportsNotUsedAsValuesEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out ImportsNotUsedAsValuesEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<ImportsNotUsedAsValuesEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ImportsNotUsedAsValuesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static ImportsNotUsedAsValuesEntity IJsonElement<ImportsNotUsedAsValuesEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ImportsNotUsedAsValuesEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ImportsNotUsedAsValuesEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ImportsNotUsedAsValuesEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public ImportsNotUsedAsValuesEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ImportsNotUsedAsValuesEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ImportsNotUsedAsValuesEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public ImportsNotUsedAsValuesEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<ImportsNotUsedAsValuesEntity>(_idx);
                    }
                ...
                /// <param name="matchRemove">Match 1st item.</param>
                /// <param name="matchPreserve">Match 2nd item.</param>
                /// <param name="matchError">Match 3rd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchRemove,
                    Func<TContext, TResult> matchPreserve,
                    Func<TContext, TResult> matchError,
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchRemove,
                    Func<TResult> matchPreserve,
                    Func<TResult> matchError,
