...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct InlineSourcesEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(InlineSourcesEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="InlineSourcesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator InlineSourcesEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new InlineSourcesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"InlineSourcesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="InlineSourcesEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="InlineSourcesEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly InlineSourcesEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<InlineSourcesEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="InlineSourcesEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly InlineSourcesEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<InlineSourcesEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(InlineSourcesEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<InlineSourcesEntity, Mutable>(this);
                }
            }
        }
    }
