...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct IsolatedModulesEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(IsolatedModulesEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="IsolatedModulesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator IsolatedModulesEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new IsolatedModulesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"IsolatedModulesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="IsolatedModulesEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="IsolatedModulesEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IsolatedModulesEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<IsolatedModulesEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="IsolatedModulesEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IsolatedModulesEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<IsolatedModulesEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(IsolatedModulesEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<IsolatedModulesEntity, Mutable>(this);
                }
            }
        }
    }
