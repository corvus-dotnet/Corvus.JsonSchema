        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct LibEntityArray
            {
                ...
                public readonly partial struct LibEntity
                {
                    ...
                    public readonly partial struct AnyOf11Entity
#if NET8_0_OR_GREATER
                        : IJsonElement<AnyOf11Entity>,
                          IFormattable,
                          ISpanFormattable,
...
#endif
                    {
                        ...
                        /// <summary>
                        /// Initializes a new instance of the <see cref="AnyOf11Entity"/> struct.
                        /// </summary>
                        /// <param name="value">The value from which to construct the instance.</param>
                        internal AnyOf11Entity(IJsonDocument parent, int idx)
                        {
                            Debug.Assert(idx >= 0);
                            _parent = parent;
                            _idx = idx;
                        ...
                        /// </summary>
                        public static AnyOf11Entity DefaultInstance { get; }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static explicit operator string(AnyOf11Entity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                        ...
                        /// </returns>
                        public static bool operator ==(in AnyOf11Entity left, in AnyOf11Entity right)
                        {
                        ...
                        /// <c>True</c> if the values are equal.
                        /// </returns>
                        public static bool operator ==(in AnyOf11Entity left, in JsonElement right)
                        {
                            return left.Equals(right);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator JsonElement(AnyOf11Entity instance)
                        {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator AnyOf11Entity(JsonElement instance)
                        {
                            return AnyOf11Entity.From(instance);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static AnyOf11Entity From<T>(in T instance)
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static AnyOf11Entity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<AnyOf11Entity>(utf8Json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static AnyOf11Entity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<AnyOf11Entity>(json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static AnyOf11Entity ParseValue(string json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<AnyOf11Entity>(json, options);
                        }
                        ...
                        /// </exception>
                        public static AnyOf11Entity ParseValue(ref Utf8JsonReader reader)
                        {
                            return JsonElementHelpers.ParseValue<AnyOf11Entity>(ref reader);
                        }
                        ...
                        ///   A value could not be read from the reader.
                        /// </exception>
                        public static bool TryParseValue(ref Utf8JsonReader reader, out AnyOf11Entity? result)
                        {
                            return JsonElementHelpers.TryParseValue<AnyOf11Entity>(ref reader, out result);
                        }
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new AnyOf11Entity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                        static AnyOf11Entity IJsonElement<AnyOf11Entity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"AnyOf11Entity: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="AnyOf11Entity"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="AnyOf11Entity"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public AnyOf11Entity Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<AnyOf11Entity>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="AnyOf11Entity"/> that lives for the lifetime of its
