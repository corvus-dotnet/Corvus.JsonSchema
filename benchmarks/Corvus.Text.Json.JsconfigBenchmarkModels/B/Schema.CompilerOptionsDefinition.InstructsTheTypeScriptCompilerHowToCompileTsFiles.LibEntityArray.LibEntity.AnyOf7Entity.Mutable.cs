                ...
                public readonly partial struct LibEntity
                {
                    ...
                    public readonly partial struct AnyOf7Entity
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Mutable(AnyOf7Entity instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="AnyOf7Entity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator AnyOf7Entity(Mutable instance)
                            {
                            ...
                            {
                                return
                                    (obj is IJsonElement value && Equals(new AnyOf7Entity(value.ParentDocument, value.ParentDocumentIndex))) ||
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"AnyOf7Entity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// <summary>
                            /// Gets a <see cref="AnyOf7Entity"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </summary>
                            /// <returns>
                            /// A <see cref="AnyOf7Entity"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </returns>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly AnyOf7Entity Clone()
                            {
                                CheckValidInstance();
                                return _parent.CloneElement<AnyOf7Entity>(_idx);
                            }
                            ...
                            /// </summary>
                            /// <returns>
                            /// An immutable <see cref="AnyOf7Entity"/> that lives for the lifetime of its
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly AnyOf7Entity Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<AnyOf7Entity>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            public static implicit operator Source(AnyOf7Entity instance) => new(JsonElement.From(instance));
                        ...
                        {
                            return workspace.CreateBuilder<AnyOf7Entity, Mutable>(this);
                        }
                    }
                }
            }
