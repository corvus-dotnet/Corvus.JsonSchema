        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct MaxNodeModuleJsDepthEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(MaxNodeModuleJsDepthEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="MaxNodeModuleJsDepthEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator MaxNodeModuleJsDepthEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"MaxNodeModuleJsDepthEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MaxNodeModuleJsDepthEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MaxNodeModuleJsDepthEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<MaxNodeModuleJsDepthEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(MaxNodeModuleJsDepthEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<MaxNodeModuleJsDepthEntity, Mutable>(this);
                }
            }
        }
    }
