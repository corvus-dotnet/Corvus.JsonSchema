            ...
            public readonly partial struct ModuleResolutionEntity
            {
                    ...
                    : IJsonElement<AnyOf1Entity>
                {
                    public static partial class JsonSchema
                    {
                        ...
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/jsconfig.json#/definitions/compilerOptionsDefinition/properties/compilerOptions/properties/moduleResolution/anyOf/1"u8, buffer, out written);

                        /// <summary>
                        /// Gets the schema location from which this type was generated.
                        /// </summary>
                        public const string SchemaLocation = "https://json.schemastore.org/jsconfig.json#/definitions/compilerOptionsDefinition/properties/compilerOptions/properties/moduleResolution/anyOf/1";

                        /// <summary>
                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                        /// </summary>
                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/jsconfig.json#/definitions/compilerOptionsDefinition/properties/compilerOptions/properties/moduleResolution/anyOf/1"u8;
                            ...
                            ref JsonSchemaContext context)
                        {
                            ...
                            if (tokenType == JsonTokenType.String)
                            {
                                ...
                                JsonSchemaEvaluation.MatchRegularExpression(unescapedUtf8JsonString.Span, Pattern,"^(([Nn]ode)|([Nn]ode16)|([Nn]ode[Nn]ext)|([Cc]lassic)|([Bb]undler))$", "pattern"u8, ref context);
                            }
                            else
                            {
                        ...
                        [GeneratedRegex("^(([Nn]ode)|([Nn]ode16)|([Nn]ode[Nn]ext)|([Cc]lassic)|([Bb]undler))$")]
                        private static partial Regex CreatePattern();
#else
                        private static Regex CreatePattern() => new("^(([Nn]ode)|([Nn]ode16)|([Nn]ode[Nn]ext)|([Cc]lassic)|([Bb]undler))$", RegexOptions.Compiled);
#endif
