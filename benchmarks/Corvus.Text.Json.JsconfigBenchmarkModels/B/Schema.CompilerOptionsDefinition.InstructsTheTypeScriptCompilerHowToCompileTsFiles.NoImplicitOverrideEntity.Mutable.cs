        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct NoImplicitOverrideEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(NoImplicitOverrideEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="NoImplicitOverrideEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator NoImplicitOverrideEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"NoImplicitOverrideEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly NoImplicitOverrideEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly NoImplicitOverrideEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<NoImplicitOverrideEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(NoImplicitOverrideEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<NoImplicitOverrideEntity, Mutable>(this);
                }
            }
        }
    }
