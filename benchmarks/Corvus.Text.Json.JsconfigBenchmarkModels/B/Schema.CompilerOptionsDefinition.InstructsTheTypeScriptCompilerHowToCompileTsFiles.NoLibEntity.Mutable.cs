        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct NoLibEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(NoLibEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="NoLibEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator NoLibEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"NoLibEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly NoLibEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly NoLibEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<NoLibEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(NoLibEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<NoLibEntity, Mutable>(this);
                }
            }
        }
    }
