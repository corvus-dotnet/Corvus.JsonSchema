            ...
            public readonly partial struct PluginsEntityArray
            {
                ...
                public readonly partial struct PluginsEntity
                {
...
#endif
                    {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.JsconfigBenchmark.Baseline.JsonString.Mutable Name
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.JsconfigBenchmark.Baseline.JsonString.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        public void SetName(in Corvus.JsconfigBenchmark.Baseline.JsonString.Source value)
                        {
                            CheckValidInstance();
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.JsconfigBenchmark.Baseline.Schema.CompilerOptionsDefinition.InstructsTheTypeScriptCompilerHowToCompileTsFiles.PluginsEntityArray.PluginsEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.JsconfigBenchmark.Baseline.Schema.CompilerOptionsDefinition.InstructsTheTypeScriptCompilerHowToCompileTsFiles.PluginsEntityArray.PluginsEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        /// </summary>
                        internal static void Create(ref ComplexValueBuilder builder, in Corvus.JsconfigBenchmark.Baseline.JsonString.Source name = default)
                        {
                        ...
                        /// Creates an instance of a <see cref="PluginsEntity"/>.
                        /// </summary>
                        public void Create(in Corvus.JsconfigBenchmark.Baseline.JsonString.Source name = default)
                        {
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.JsconfigBenchmark.Baseline.JsonString.Source name = default, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
