        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct PrettyEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(PrettyEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="PrettyEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator PrettyEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"PrettyEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly PrettyEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly PrettyEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<PrettyEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(PrettyEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<PrettyEntity, Mutable>(this);
                }
            }
        }
    }
