        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct RaiseAnErrorWhenAFunctionParameterIsnTRead
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RaiseAnErrorWhenAFunctionParameterIsnTRead instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RaiseAnErrorWhenAFunctionParameterIsnTRead"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RaiseAnErrorWhenAFunctionParameterIsnTRead(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RaiseAnErrorWhenAFunctionParameterIsnTRead.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RaiseAnErrorWhenAFunctionParameterIsnTRead Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RaiseAnErrorWhenAFunctionParameterIsnTRead Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RaiseAnErrorWhenAFunctionParameterIsnTRead>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(RaiseAnErrorWhenAFunctionParameterIsnTRead instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<RaiseAnErrorWhenAFunctionParameterIsnTRead, Mutable>(this);
                }
            }
        }
    }
