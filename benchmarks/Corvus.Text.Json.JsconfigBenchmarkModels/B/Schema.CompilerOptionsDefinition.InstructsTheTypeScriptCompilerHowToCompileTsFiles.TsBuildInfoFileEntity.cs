    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="TsBuildInfoFileEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal TsBuildInfoFileEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static TsBuildInfoFileEntity DefaultInstance { get; } = ParsedJsonDocument<TsBuildInfoFileEntity>.StringConstant([.."\".tsbuildinfo\""u8]);
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(TsBuildInfoFileEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in TsBuildInfoFileEntity left, in TsBuildInfoFileEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in TsBuildInfoFileEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(TsBuildInfoFileEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TsBuildInfoFileEntity(JsonElement instance)
                {
                    return TsBuildInfoFileEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TsBuildInfoFileEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TsBuildInfoFileEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TsBuildInfoFileEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TsBuildInfoFileEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TsBuildInfoFileEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TsBuildInfoFileEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TsBuildInfoFileEntity>(json, options);
                }
                ...
                /// </exception>
                public static TsBuildInfoFileEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<TsBuildInfoFileEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out TsBuildInfoFileEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<TsBuildInfoFileEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TsBuildInfoFileEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static TsBuildInfoFileEntity IJsonElement<TsBuildInfoFileEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TsBuildInfoFileEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TsBuildInfoFileEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TsBuildInfoFileEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public TsBuildInfoFileEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TsBuildInfoFileEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TsBuildInfoFileEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public TsBuildInfoFileEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<TsBuildInfoFileEntity>(_idx);
                    }
