        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct WhenTypeCheckingTakeIntoAccountNullAndUndefined
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(WhenTypeCheckingTakeIntoAccountNullAndUndefined instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="WhenTypeCheckingTakeIntoAccountNullAndUndefined"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator WhenTypeCheckingTakeIntoAccountNullAndUndefined(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"WhenTypeCheckingTakeIntoAccountNullAndUndefined.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly WhenTypeCheckingTakeIntoAccountNullAndUndefined Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly WhenTypeCheckingTakeIntoAccountNullAndUndefined Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<WhenTypeCheckingTakeIntoAccountNullAndUndefined>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(WhenTypeCheckingTakeIntoAccountNullAndUndefined instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<WhenTypeCheckingTakeIntoAccountNullAndUndefined, Mutable>(this);
                }
            }
        }
    }
