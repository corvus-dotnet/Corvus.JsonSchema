...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.JsconfigBenchmark.Baseline.Schema.CompilerOptionsDefinition.InstructsTheTypeScriptCompilerHowToCompileTsFiles.Mutable CompilerOptions
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CompilerOptionsUtf8, out Corvus.JsconfigBenchmark.Baseline.Schema.CompilerOptionsDefinition.InstructsTheTypeScriptCompilerHowToCompileTsFiles.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetCompilerOptions(in Corvus.JsconfigBenchmark.Baseline.Schema.CompilerOptionsDefinition.InstructsTheTypeScriptCompilerHowToCompileTsFiles.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCompilerOptions<TContext>(in Corvus.JsconfigBenchmark.Baseline.Schema.CompilerOptionsDefinition.InstructsTheTypeScriptCompilerHowToCompileTsFiles.Source<TContext> value)
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.JsconfigBenchmark.Baseline.Schema.CompilerOptionsDefinition.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.JsconfigBenchmark.Baseline.Schema.CompilerOptionsDefinition.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.JsconfigBenchmark.Baseline.Schema.CompilerOptionsDefinition.InstructsTheTypeScriptCompilerHowToCompileTsFiles.Source compilerOptions = default)
            {
            ...
            /// Creates an instance of a <see cref="CompilerOptionsDefinition"/>.
            /// </summary>
            public void Create(in Corvus.JsconfigBenchmark.Baseline.Schema.CompilerOptionsDefinition.InstructsTheTypeScriptCompilerHowToCompileTsFiles.Source compilerOptions = default)
            {
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.JsconfigBenchmark.Baseline.Schema.CompilerOptionsDefinition.InstructsTheTypeScriptCompilerHowToCompileTsFiles.Source<TContext> compilerOptions = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="CompilerOptionsDefinition"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.JsconfigBenchmark.Baseline.Schema.CompilerOptionsDefinition.InstructsTheTypeScriptCompilerHowToCompileTsFiles.Source<TContext> compilerOptions = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.JsconfigBenchmark.Baseline.Schema.CompilerOptionsDefinition.InstructsTheTypeScriptCompilerHowToCompileTsFiles.Source compilerOptions = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.JsconfigBenchmark.Baseline.Schema.CompilerOptionsDefinition.InstructsTheTypeScriptCompilerHowToCompileTsFiles.Source<TContext> compilerOptions = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
