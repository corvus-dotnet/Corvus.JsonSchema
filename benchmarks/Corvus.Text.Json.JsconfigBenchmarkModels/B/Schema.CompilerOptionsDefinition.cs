...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CompilerOptionsDefinition"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal CompilerOptionsDefinition(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static CompilerOptionsDefinition DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in CompilerOptionsDefinition left, in CompilerOptionsDefinition right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in CompilerOptionsDefinition left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(CompilerOptionsDefinition instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator CompilerOptionsDefinition(JsonElement instance)
        {
            return CompilerOptionsDefinition.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CompilerOptionsDefinition From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CompilerOptionsDefinition ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CompilerOptionsDefinition>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CompilerOptionsDefinition ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CompilerOptionsDefinition>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CompilerOptionsDefinition ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CompilerOptionsDefinition>(json, options);
        }
        ...
        /// </exception>
        public static CompilerOptionsDefinition ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<CompilerOptionsDefinition>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out CompilerOptionsDefinition? result)
        {
            return JsonElementHelpers.TryParseValue<CompilerOptionsDefinition>(ref reader, out result);
        }
...
#if NET
        static CompilerOptionsDefinition IJsonElement<CompilerOptionsDefinition>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"CompilerOptionsDefinition: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public CompilerOptionsDefinition Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public CompilerOptionsDefinition Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<CompilerOptionsDefinition>(_idx);
            }
