...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ExcludeDefinition
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ExcludeDefinition instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ExcludeDefinition"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ExcludeDefinition(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.JsconfigBenchmark.Baseline.Schema.ExcludeDefinition.JsonStringArray.Mutable Exclude
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludeUtf8, out Corvus.JsconfigBenchmark.Baseline.Schema.ExcludeDefinition.JsonStringArray.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ExcludeDefinition(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetExclude(in Corvus.JsconfigBenchmark.Baseline.Schema.ExcludeDefinition.JsonStringArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetExclude<TContext>(in Corvus.JsconfigBenchmark.Baseline.Schema.ExcludeDefinition.JsonStringArray.Source<TContext> value)
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ExcludeDefinition.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ExcludeDefinition"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ExcludeDefinition"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ExcludeDefinition Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ExcludeDefinition>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ExcludeDefinition"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ExcludeDefinition Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ExcludeDefinition>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.JsconfigBenchmark.Baseline.Schema.ExcludeDefinition.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(ExcludeDefinition instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.JsconfigBenchmark.Baseline.Schema.ExcludeDefinition.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ExcludeDefinition"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.JsconfigBenchmark.Baseline.Schema.ExcludeDefinition.JsonStringArray.Source exclude = default)
            {
            ...
            /// Creates an instance of a <see cref="ExcludeDefinition"/>.
            /// </summary>
            public void Create(in Corvus.JsconfigBenchmark.Baseline.Schema.ExcludeDefinition.JsonStringArray.Source exclude = default)
            {
                Create(ref _builder, exclude);
            }
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.JsconfigBenchmark.Baseline.Schema.ExcludeDefinition.JsonStringArray.Source<TContext> exclude = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="ExcludeDefinition"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.JsconfigBenchmark.Baseline.Schema.ExcludeDefinition.JsonStringArray.Source<TContext> exclude = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
                Create(context, ref _builder, exclude);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.JsconfigBenchmark.Baseline.Schema.ExcludeDefinition.JsonStringArray.Source exclude = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.JsconfigBenchmark.Baseline.Schema.ExcludeDefinition.JsonStringArray.Source<TContext> exclude = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        {
            return workspace.CreateBuilder<ExcludeDefinition, Mutable>(this);
        }
    }
}
