...
public readonly partial struct Schema
{
    ...
    public readonly partial struct FilesDefinition
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(FilesDefinition instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="FilesDefinition"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator FilesDefinition(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.JsconfigBenchmark.Baseline.Schema.FilesDefinition.JsonStringArray.Mutable Files
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FilesUtf8, out Corvus.JsconfigBenchmark.Baseline.Schema.FilesDefinition.JsonStringArray.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetFiles(in Corvus.JsconfigBenchmark.Baseline.Schema.FilesDefinition.JsonStringArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetFiles<TContext>(in Corvus.JsconfigBenchmark.Baseline.Schema.FilesDefinition.JsonStringArray.Source<TContext> value)
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"FilesDefinition.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly FilesDefinition Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly FilesDefinition Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<FilesDefinition>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.JsconfigBenchmark.Baseline.Schema.FilesDefinition.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(FilesDefinition instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.JsconfigBenchmark.Baseline.Schema.FilesDefinition.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="FilesDefinition"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.JsconfigBenchmark.Baseline.Schema.FilesDefinition.JsonStringArray.Source files = default)
            {
            ...
            /// Creates an instance of a <see cref="FilesDefinition"/>.
            /// </summary>
            public void Create(in Corvus.JsconfigBenchmark.Baseline.Schema.FilesDefinition.JsonStringArray.Source files = default)
            {
                Create(ref _builder, files);
            }
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.JsconfigBenchmark.Baseline.Schema.FilesDefinition.JsonStringArray.Source<TContext> files = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="FilesDefinition"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.JsconfigBenchmark.Baseline.Schema.FilesDefinition.JsonStringArray.Source<TContext> files = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
                Create(context, ref _builder, files);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.JsconfigBenchmark.Baseline.Schema.FilesDefinition.JsonStringArray.Source files = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.JsconfigBenchmark.Baseline.Schema.FilesDefinition.JsonStringArray.Source<TContext> files = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        {
            return workspace.CreateBuilder<FilesDefinition, Mutable>(this);
        }
    }
}
