...
public readonly partial struct Schema
{
    ...
    public readonly partial struct IncludeDefinition
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.JsconfigBenchmark.Baseline.Schema.IncludeDefinition.JsonStringArray.Mutable Include
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeUtf8, out Corvus.JsconfigBenchmark.Baseline.Schema.IncludeDefinition.JsonStringArray.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetInclude(in Corvus.JsconfigBenchmark.Baseline.Schema.IncludeDefinition.JsonStringArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetInclude<TContext>(in Corvus.JsconfigBenchmark.Baseline.Schema.IncludeDefinition.JsonStringArray.Source<TContext> value)
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.JsconfigBenchmark.Baseline.Schema.IncludeDefinition.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.JsconfigBenchmark.Baseline.Schema.IncludeDefinition.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.JsconfigBenchmark.Baseline.Schema.IncludeDefinition.JsonStringArray.Source include = default)
            {
            ...
            /// Creates an instance of a <see cref="IncludeDefinition"/>.
            /// </summary>
            public void Create(in Corvus.JsconfigBenchmark.Baseline.Schema.IncludeDefinition.JsonStringArray.Source include = default)
            {
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.JsconfigBenchmark.Baseline.Schema.IncludeDefinition.JsonStringArray.Source<TContext> include = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="IncludeDefinition"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.JsconfigBenchmark.Baseline.Schema.IncludeDefinition.JsonStringArray.Source<TContext> include = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.JsconfigBenchmark.Baseline.Schema.IncludeDefinition.JsonStringArray.Source include = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.JsconfigBenchmark.Baseline.Schema.IncludeDefinition.JsonStringArray.Source<TContext> include = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
