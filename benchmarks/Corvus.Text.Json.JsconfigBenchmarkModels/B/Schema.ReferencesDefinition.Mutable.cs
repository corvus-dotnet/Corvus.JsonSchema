...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ReferencesDefinition
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ReferencesDefinition instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ReferencesDefinition"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ReferencesDefinition(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.Mutable References
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReferencesUtf8, out Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ReferencesDefinition(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            /// <summary>
            /// Set the <c>references</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetReferences(in Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ReferencesUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReferencesUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsProperty(JsonPropertyNamesEscaped.References, ref cvb, escapeName: false, nameRequiresUnescaping: false);
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetReferences<TContext>(in Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.Source<TContext> value)
            ...
            /// <summary>
            /// Remove the <c>references</c> property, if present.
            /// </summary>
            ...
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ReferencesUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ReferencesDefinition.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ReferencesDefinition"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ReferencesDefinition"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ReferencesDefinition Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ReferencesDefinition>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ReferencesDefinition"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ReferencesDefinition Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ReferencesDefinition>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(ReferencesDefinition instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ReferencesDefinition"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.Source references = default)
            {
                references.AddAsProperty(JsonPropertyNamesEscaped.References, ref builder, escapeName: false);
            }

            /// <summary>
            /// Creates an instance of a <see cref="ReferencesDefinition"/>.
            /// </summary>
            public void Create(in Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.Source references = default)
            {
                Create(ref _builder, references);
            }
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.Source<TContext> references = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="ReferencesDefinition"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.Source<TContext> references = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
                Create(context, ref _builder, references);
            }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="references">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.Source references = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(references);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.Source<TContext> references = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        {
            return workspace.CreateBuilder<ReferencesDefinition, Mutable>(this);
        }
    }
}
