    ...
    public readonly partial struct ReferencesDefinition
    {
        ...
        public readonly partial struct ProjectReferenceArray
        {
...
#endif
            {
                ...
                public Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.ProjectReference.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.ProjectReference.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.ProjectReference.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.ProjectReference.Mutable>(_parent, _idx);
                }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.ProjectReference.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, in Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.ProjectReference.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(in Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.ProjectReference.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.ProjectReference item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.ProjectReference>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.ProjectReference> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.ProjectReference>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.ProjectReference oldItem, in Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.ProjectReference.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.ProjectReference>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.ProjectReference current = enumerator.Current;
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
