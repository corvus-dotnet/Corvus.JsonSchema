        ...
        public readonly partial struct ProjectReferenceArray
        {
            ...
            public readonly partial struct ProjectReference
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.JsconfigBenchmark.Baseline.JsonString.Mutable Path
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathUtf8, out Corvus.JsconfigBenchmark.Baseline.JsonString.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetPath(in Corvus.JsconfigBenchmark.Baseline.JsonString.Source value)
                    {
                        CheckValidInstance();
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.ProjectReference.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.ProjectReference.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.JsconfigBenchmark.Baseline.JsonString.Source path = default)
                    {
                    ...
                    /// Creates an instance of a <see cref="ProjectReference"/>.
                    /// </summary>
                    public void Create(in Corvus.JsconfigBenchmark.Baseline.JsonString.Source path = default)
                    {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.JsconfigBenchmark.Baseline.JsonString.Source path = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
