    ...
    public readonly partial struct ReferencesDefinition
    {
        ...
        public readonly partial struct ProjectReferenceArray
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="ProjectReference"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal ProjectReference(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static ProjectReference DefaultInstance { get; }
                ...
                /// </para>
                /// </remarks>
                public Corvus.JsconfigBenchmark.Baseline.JsonString Path
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathUtf8, out Corvus.JsconfigBenchmark.Baseline.JsonString value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in ProjectReference left, in ProjectReference right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in ProjectReference left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(ProjectReference instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ProjectReference(JsonElement instance)
                {
                    return ProjectReference.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ProjectReference From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ProjectReference ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ProjectReference>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ProjectReference ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ProjectReference>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ProjectReference ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ProjectReference>(json, options);
                }
                ...
                /// </exception>
                public static ProjectReference ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<ProjectReference>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out ProjectReference? result)
                {
                    return JsonElementHelpers.TryParseValue<ProjectReference>(ref reader, out result);
                }
...
#if NET
                static ProjectReference IJsonElement<ProjectReference>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ProjectReference: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public ProjectReference Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<ProjectReference>(_idx);
                    }
