...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ReferencesDefinition
    {
...
#endif
        {
            ...
            public Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.ProjectReference this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.ProjectReference>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.ProjectReference> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray.ProjectReference>(_parent, _idx);
            }
