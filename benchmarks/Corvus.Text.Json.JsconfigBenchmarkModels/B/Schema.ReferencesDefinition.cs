...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray References
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReferencesUtf8, out Corvus.JsconfigBenchmark.Baseline.Schema.ReferencesDefinition.ProjectReferenceArray value))
                {
                    return value;
                }
