...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TypeAcquisitionDefinition
    {
        ...
        public readonly partial struct TypeAcquisitionEntity
        {
            ...
            public readonly partial struct EnableAutoTypeAcquisition
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(EnableAutoTypeAcquisition instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="EnableAutoTypeAcquisition"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator EnableAutoTypeAcquisition(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new EnableAutoTypeAcquisition(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"EnableAutoTypeAcquisition.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="EnableAutoTypeAcquisition"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="EnableAutoTypeAcquisition"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EnableAutoTypeAcquisition Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<EnableAutoTypeAcquisition>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="EnableAutoTypeAcquisition"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EnableAutoTypeAcquisition Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<EnableAutoTypeAcquisition>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(EnableAutoTypeAcquisition instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<EnableAutoTypeAcquisition, Mutable>(this);
                }
            }
        }
    }
