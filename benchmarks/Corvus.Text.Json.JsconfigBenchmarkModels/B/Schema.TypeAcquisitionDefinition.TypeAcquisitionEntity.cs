...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TypeAcquisitionDefinition
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.JsconfigBenchmark.Baseline.Schema.TypeAcquisitionDefinition.TypeAcquisitionEntity.EnableAutoTypeAcquisition Enable
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnableUtf8, out Corvus.JsconfigBenchmark.Baseline.Schema.TypeAcquisitionDefinition.TypeAcquisitionEntity.EnableAutoTypeAcquisition value))
                    {
                        return value;
                    }

                    return Corvus.JsconfigBenchmark.Baseline.Schema.TypeAcquisitionDefinition.TypeAcquisitionEntity.EnableAutoTypeAcquisition.DefaultInstance;
                }
            }
            ...
            /// </para>
            /// </remarks>
            public Corvus.JsconfigBenchmark.Baseline.Schema.TypeAcquisitionDefinition.TypeAcquisitionEntity.JsonStringArray Exclude
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludeUtf8, out Corvus.JsconfigBenchmark.Baseline.Schema.TypeAcquisitionDefinition.TypeAcquisitionEntity.JsonStringArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.JsconfigBenchmark.Baseline.Schema.TypeAcquisitionDefinition.TypeAcquisitionEntity.IncludeJsoArray Include
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeUtf8, out Corvus.JsconfigBenchmark.Baseline.Schema.TypeAcquisitionDefinition.TypeAcquisitionEntity.IncludeJsoArray value))
                    {
                        return value;
                    }
