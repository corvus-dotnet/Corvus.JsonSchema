        ...
        public readonly partial struct SettingsForTheWatchModeInTypeScript
        {
            ...
            public readonly partial struct RemoveALisArray
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RemoveALisArray instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RemoveALisArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RemoveALisArray(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RemoveALisArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RemoveALisArray Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RemoveALisArray Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RemoveALisArray>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.JsconfigBenchmark.Baseline.Schema.WatchOptionsDefinition.SettingsForTheWatchModeInTypeScript.RemoveALisArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(RemoveALisArray instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.JsconfigBenchmark.Baseline.Schema.WatchOptionsDefinition.SettingsForTheWatchModeInTypeScript.RemoveALisArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<RemoveALisArray, Mutable>(this);
                }
            }
        }
    }
