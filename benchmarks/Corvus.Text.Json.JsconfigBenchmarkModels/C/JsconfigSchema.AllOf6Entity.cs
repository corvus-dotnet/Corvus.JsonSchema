...
public readonly partial struct JsconfigSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOf6Entity"/> struct.
        /// </summary>
        ...
        internal AllOf6Entity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static AllOf6Entity DefaultInstance { get; }
        ...
        public static explicit operator Corvus.JsconfigBenchmark.Current.JsconfigSchema.FilesDefinition(AllOf6Entity value)
        {
            return Corvus.JsconfigBenchmark.Current.JsconfigSchema.FilesDefinition.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AllOf6Entity(Corvus.JsconfigBenchmark.Current.JsconfigSchema.FilesDefinition value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition(AllOf6Entity value)
        {
            return Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition(AllOf6Entity value)
        {
            return Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AllOf6Entity(Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.JsconfigBenchmark.Current.JsconfigSchema.ReferencesDefinition(AllOf6Entity value)
        {
            return Corvus.JsconfigBenchmark.Current.JsconfigSchema.ReferencesDefinition.From(value);
        }
        ...
        /// </returns>
        public static bool operator ==(in AllOf6Entity left, in AllOf6Entity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in AllOf6Entity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(AllOf6Entity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AllOf6Entity(JsonElement instance)
        {
            return AllOf6Entity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllOf6Entity From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllOf6Entity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<AllOf6Entity>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllOf6Entity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<AllOf6Entity>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllOf6Entity ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<AllOf6Entity>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static AllOf6Entity ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<AllOf6Entity>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out AllOf6Entity? result)
        {
            return JsonElementHelpers.TryParseValue<AllOf6Entity>(ref reader, out result);
        }
...
#if NET
        static AllOf6Entity IJsonElement<AllOf6Entity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AllOf6Entity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AllOf6Entity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AllOf6Entity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public AllOf6Entity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AllOf6Entity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AllOf6Entity"/> that lives for the lifetime of its
        ...
        public bool TryGetAsExcludeDefinition(out Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition result)
        {
            ...
            {
                result = Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.From(this);
                return true;
            }
        ...
        public bool TryGetAsFilesDefinition(out Corvus.JsconfigBenchmark.Current.JsconfigSchema.FilesDefinition result)
        {
            ...
            {
                result = Corvus.JsconfigBenchmark.Current.JsconfigSchema.FilesDefinition.From(this);
                return true;
            }
        ...
        public bool TryGetAsIncludeDefinition(out Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition result)
        {
            ...
            {
                result = Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.From(this);
                return true;
            }
        ...
        public bool TryGetAsReferencesDefinition(out Corvus.JsconfigBenchmark.Current.JsconfigSchema.ReferencesDefinition result)
        {
            ...
            {
                result = Corvus.JsconfigBenchmark.Current.JsconfigSchema.ReferencesDefinition.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.JsconfigBenchmark.Current.JsconfigSchema.AllOf6Entity, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.JsconfigBenchmark.Current.JsconfigSchema.FilesDefinition.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchFilesDefinition(Corvus.JsconfigBenchmark.Current.JsconfigSchema.FilesDefinition.From(this), context);
            }

            if (Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchExcludeDefinition(Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.From(this), context);
            }

            if (Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchIncludeDefinition(Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.From(this), context);
            }

            if (Corvus.JsconfigBenchmark.Current.JsconfigSchema.ReferencesDefinition.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchReferencesDefinition(Corvus.JsconfigBenchmark.Current.JsconfigSchema.ReferencesDefinition.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.JsconfigBenchmark.Current.JsconfigSchema.AllOf6Entity, TResult> defaultMatch)
        {
            if (Corvus.JsconfigBenchmark.Current.JsconfigSchema.FilesDefinition.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchFilesDefinition(Corvus.JsconfigBenchmark.Current.JsconfigSchema.FilesDefinition.From(this));
            }

            if (Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchExcludeDefinition(Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.From(this));
            }

            if (Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchIncludeDefinition(Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.From(this));
            }

            if (Corvus.JsconfigBenchmark.Current.JsconfigSchema.ReferencesDefinition.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchReferencesDefinition(Corvus.JsconfigBenchmark.Current.JsconfigSchema.ReferencesDefinition.From(this));
            }
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.JsconfigBenchmark.Current.JsconfigSchema.AllOf6Entity, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
            ...
            {
                matched = true;
                accumulator = matchFilesDefinition(Corvus.JsconfigBenchmark.Current.JsconfigSchema.FilesDefinition.From(this), accumulator);
            }

            if (Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.JsonSchema.Evaluate(_parent, _idx))
            {
                matched = true;
                accumulator = matchExcludeDefinition(Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.From(this), accumulator);
            }

            if (Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.JsonSchema.Evaluate(_parent, _idx))
            {
                matched = true;
                accumulator = matchIncludeDefinition(Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.From(this), accumulator);
            }

            if (Corvus.JsconfigBenchmark.Current.JsconfigSchema.ReferencesDefinition.JsonSchema.Evaluate(_parent, _idx))
            {
                matched = true;
                accumulator = matchReferencesDefinition(Corvus.JsconfigBenchmark.Current.JsconfigSchema.ReferencesDefinition.From(this), accumulator);
            }
