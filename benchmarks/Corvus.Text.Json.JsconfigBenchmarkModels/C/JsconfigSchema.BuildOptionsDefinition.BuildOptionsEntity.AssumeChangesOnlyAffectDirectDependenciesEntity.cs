...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct BuildOptionsDefinition
    {
        ...
        public readonly partial struct BuildOptionsEntity
        {
            ...
            public readonly partial struct AssumeChangesOnlyAffectDirectDependenciesEntity
#if NET8_0_OR_GREATER
                : IJsonElement<AssumeChangesOnlyAffectDirectDependenciesEntity>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="AssumeChangesOnlyAffectDirectDependenciesEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal AssumeChangesOnlyAffectDirectDependenciesEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static AssumeChangesOnlyAffectDirectDependenciesEntity DefaultInstance { get; } = ParsedJsonDocument<AssumeChangesOnlyAffectDirectDependenciesEntity>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(AssumeChangesOnlyAffectDirectDependenciesEntity value)
                {
                ...
                /// </returns>
                public static bool operator ==(in AssumeChangesOnlyAffectDirectDependenciesEntity left, in AssumeChangesOnlyAffectDirectDependenciesEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in AssumeChangesOnlyAffectDirectDependenciesEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(AssumeChangesOnlyAffectDirectDependenciesEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AssumeChangesOnlyAffectDirectDependenciesEntity(JsonElement instance)
                {
                    return AssumeChangesOnlyAffectDirectDependenciesEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AssumeChangesOnlyAffectDirectDependenciesEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AssumeChangesOnlyAffectDirectDependenciesEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AssumeChangesOnlyAffectDirectDependenciesEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AssumeChangesOnlyAffectDirectDependenciesEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AssumeChangesOnlyAffectDirectDependenciesEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AssumeChangesOnlyAffectDirectDependenciesEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AssumeChangesOnlyAffectDirectDependenciesEntity>(json, options);
                }
                ...
                /// </exception>
                public static AssumeChangesOnlyAffectDirectDependenciesEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<AssumeChangesOnlyAffectDirectDependenciesEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out AssumeChangesOnlyAffectDirectDependenciesEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<AssumeChangesOnlyAffectDirectDependenciesEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new AssumeChangesOnlyAffectDirectDependenciesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static AssumeChangesOnlyAffectDirectDependenciesEntity IJsonElement<AssumeChangesOnlyAffectDirectDependenciesEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AssumeChangesOnlyAffectDirectDependenciesEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="AssumeChangesOnlyAffectDirectDependenciesEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="AssumeChangesOnlyAffectDirectDependenciesEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public AssumeChangesOnlyAffectDirectDependenciesEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<AssumeChangesOnlyAffectDirectDependenciesEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="AssumeChangesOnlyAffectDirectDependenciesEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public AssumeChangesOnlyAffectDirectDependenciesEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<AssumeChangesOnlyAffectDirectDependenciesEntity>(_idx);
                    }
