        ...
        public readonly partial struct BuildOptionsEntity
        {
            ...
            public readonly partial struct EnableVerboseLogging
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnableVerboseLogging, Mutable>(EnableVerboseLogging.DefaultInstance);
                    ...
                    public static explicit operator Mutable(EnableVerboseLogging instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="EnableVerboseLogging"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator EnableVerboseLogging(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"EnableVerboseLogging.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EnableVerboseLogging Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EnableVerboseLogging Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<EnableVerboseLogging>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(EnableVerboseLogging instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<EnableVerboseLogging, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<EnableVerboseLogging> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<EnableVerboseLogging>();
                    }
                    finally
                    {
