...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct BuildOptionsDefinition
    {
        ...
        public readonly partial struct BuildOptionsEntity
        {
            ...
            public readonly partial struct EnableVerboseLogging
#if NET8_0_OR_GREATER
                : IJsonElement<EnableVerboseLogging>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="EnableVerboseLogging"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal EnableVerboseLogging(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static EnableVerboseLogging DefaultInstance { get; } = ParsedJsonDocument<EnableVerboseLogging>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(EnableVerboseLogging value)
                {
                ...
                /// </returns>
                public static bool operator ==(in EnableVerboseLogging left, in EnableVerboseLogging right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in EnableVerboseLogging left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(EnableVerboseLogging instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EnableVerboseLogging(JsonElement instance)
                {
                    return EnableVerboseLogging.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EnableVerboseLogging From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EnableVerboseLogging ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<EnableVerboseLogging>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EnableVerboseLogging ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<EnableVerboseLogging>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EnableVerboseLogging ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<EnableVerboseLogging>(json, options);
                }
                ...
                /// </exception>
                public static EnableVerboseLogging ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<EnableVerboseLogging>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out EnableVerboseLogging? result)
                {
                    return JsonElementHelpers.TryParseValue<EnableVerboseLogging>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new EnableVerboseLogging(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static EnableVerboseLogging IJsonElement<EnableVerboseLogging>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EnableVerboseLogging: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="EnableVerboseLogging"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="EnableVerboseLogging"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public EnableVerboseLogging Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<EnableVerboseLogging>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="EnableVerboseLogging"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public EnableVerboseLogging Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<EnableVerboseLogging>(_idx);
                    }
