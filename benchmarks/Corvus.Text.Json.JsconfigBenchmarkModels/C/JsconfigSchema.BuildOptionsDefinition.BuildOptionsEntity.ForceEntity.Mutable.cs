        ...
        public readonly partial struct BuildOptionsEntity
        {
            ...
            public readonly partial struct ForceEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ForceEntity, Mutable>(ForceEntity.DefaultInstance);
                ...
                public static ParsedJsonDocument<ForceEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ForceEntity>();
                    }
                    finally
                    {
