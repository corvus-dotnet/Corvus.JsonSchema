        ...
        public readonly partial struct BuildOptionsEntity
        {
            ...
            public readonly partial struct IncrementalEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<IncrementalEntity, Mutable>(IncrementalEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(IncrementalEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="IncrementalEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator IncrementalEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"IncrementalEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IncrementalEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IncrementalEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<IncrementalEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(IncrementalEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<IncrementalEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<IncrementalEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<IncrementalEntity>();
                    }
                    finally
                    {
