        ...
        public readonly partial struct BuildOptionsEntity
        {
            ...
            public readonly partial struct LogPathsUsedDuringTheModuleResolutionProcess
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<LogPathsUsedDuringTheModuleResolutionProcess, Mutable>(LogPathsUsedDuringTheModuleResolutionProcess.DefaultInstance);
                ...
                public static ParsedJsonDocument<LogPathsUsedDuringTheModuleResolutionProcess> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<LogPathsUsedDuringTheModuleResolutionProcess>();
                    }
                    finally
                    {
