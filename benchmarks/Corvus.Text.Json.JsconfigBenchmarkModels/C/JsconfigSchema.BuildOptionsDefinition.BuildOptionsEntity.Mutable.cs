    ...
    public readonly partial struct BuildOptionsDefinition
    {
        ...
        public readonly partial struct BuildOptionsEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(BuildOptionsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="BuildOptionsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator BuildOptionsEntity(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.AssumeChangesOnlyAffectDirectDependenciesEntity.Mutable AssumeChangesOnlyAffectDirectDependencies
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AssumeChangesOnlyAffectDirectDependenciesUtf8, out Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.AssumeChangesOnlyAffectDirectDependenciesEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.Entity.Mutable Dry
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DryUtf8, out Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.Entity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.ForceEntity.Mutable Force
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ForceUtf8, out Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.ForceEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.IncrementalEntity.Mutable Incremental
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncrementalUtf8, out Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.IncrementalEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.LogPathsUsedDuringTheModuleResolutionProcess.Mutable TraceResolution
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TraceResolutionUtf8, out Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.LogPathsUsedDuringTheModuleResolutionProcess.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.EnableVerboseLogging.Mutable Verbose
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VerboseUtf8, out Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.EnableVerboseLogging.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetDry(scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.Entity.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DryUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DryUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Dry, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>dry</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveDry()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DryUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"BuildOptionsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly BuildOptionsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly BuildOptionsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<BuildOptionsEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.AssumeChangesOnlyAffectDirectDependenciesEntity.Source _createArg1;
                private readonly Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.Entity.Source _createArg2;
                private readonly Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.ForceEntity.Source _createArg3;
                private readonly Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.IncrementalEntity.Source _createArg4;
                private readonly Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.LogPathsUsedDuringTheModuleResolutionProcess.Source _createArg5;
                private readonly Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.EnableVerboseLogging.Source _createArg6;
                ...
                public static implicit operator Source(BuildOptionsEntity instance) => new(JsonElement.From(instance));

                public static implicit operator Source(Flags value) => BuildOptionsEntity.Build((value & Flags.AssumeChangesOnlyAffectDirectDependencies) != 0, (value & Flags.Dry) != 0, (value & Flags.Force) != 0, (value & Flags.Incremental) != 0, (value & Flags.TraceResolution) != 0, (value & Flags.Verbose) != 0);
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="BuildOptionsEntity"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.AssumeChangesOnlyAffectDirectDependenciesEntity.Source assumeChangesOnlyAffectDirectDependencies = default,
                    in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.Entity.Source dry = default,
                    in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.ForceEntity.Source force = default,
                    in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.IncrementalEntity.Source incremental = default,
                    in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.LogPathsUsedDuringTheModuleResolutionProcess.Source traceResolution = default,
                    in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.EnableVerboseLogging.Source verbose = default)
                {
                    ...
                    dry.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Dry, ref builder);
                ...
                public void Create(
                    ...
                    in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.EnableVerboseLogging.Source verbose = default)
                {
                    Create(ref _builder, assumeChangesOnlyAffectDirectDependencies, dry, force, incremental, traceResolution, verbose);
                }
            ...
            /// </summary>
            /// <param name="assumeChangesOnlyAffectDirectDependencies">The value of the <c>"assumeChangesOnlyAffectDirectDependencies"</c> property.</param>
            /// <param name="dry">The value of the <c>"dry"</c> property.</param>
            /// <param name="force">The value of the <c>"force"</c> property.</param>
            /// <param name="incremental">The value of the <c>"incremental"</c> property.</param>
            ...
            /// <param name="dry">The value of the property.</param>
            ...
            {
                return workspace.CreateBuilder<BuildOptionsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<BuildOptionsEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<BuildOptionsEntity>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<BuildOptionsEntity> Create<TContext>(
            ...
            public static ParsedJsonDocument<BuildOptionsEntity> Create(in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.AssumeChangesOnlyAffectDirectDependenciesEntity.Source assumeChangesOnlyAffectDirectDependencies = default, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.Entity.Source dry = default, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.ForceEntity.Source force = default, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.IncrementalEntity.Source incremental = default, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.LogPathsUsedDuringTheModuleResolutionProcess.Source traceResolution = default, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.EnableVerboseLogging.Source verbose = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
