...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct BuildOptionsDefinition
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(BuildOptionsDefinition instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BuildOptionsDefinition"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BuildOptionsDefinition(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new BuildOptionsDefinition(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BuildOptionsDefinition.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="BuildOptionsDefinition"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="BuildOptionsDefinition"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly BuildOptionsDefinition Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<BuildOptionsDefinition>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="BuildOptionsDefinition"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly BuildOptionsDefinition Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<BuildOptionsDefinition>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.Source arg1)
            {
                _createArg1 = arg1;
                _kind = Kind.Create;
            }

            public static implicit operator Source(BuildOptionsDefinition instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in TContext context, scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.Source<TContext> arg1)
            {
                _context = context;
                _createArg1 = arg1;
                _kind = Kind.Create;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="BuildOptionsDefinition"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.Source buildOptions = default)
            {
            ...
            /// Creates an instance of a <see cref="BuildOptionsDefinition"/>.
            /// </summary>
            public void Create(in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.Source buildOptions = default)
            {
                Create(ref _builder, buildOptions);
            }
            ...
            /// Creates an instance of a <see cref="BuildOptionsDefinition"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.Source<TContext> buildOptions = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
                Create(context, ref _builder, buildOptions);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.Source arg1, ref ComplexValueBuilder o)
            {
                o.StartObject();
                Create(ref o, arg1);
                o.EndObject();
            ...
            /// <param name="arg1">The value of the property.</param>
            /// <param name="o">The complex value builder into which to write the object.</param>
            internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.Source<TContext> arg1, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.Source buildOptions = default)
        {
            return new Source(buildOptions);
        }
        ...
        /// <param name="buildOptions">The value of the <c>"buildOptions"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.Source<TContext> buildOptions = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Source<TContext>(context, buildOptions);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.Source buildOptions = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(buildOptions);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.Source<TContext> buildOptions = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, buildOptions);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<BuildOptionsDefinition, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<BuildOptionsDefinition> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<BuildOptionsDefinition>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<BuildOptionsDefinition> Create<TContext>(
        ...
        public static ParsedJsonDocument<BuildOptionsDefinition> Create(in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.Source buildOptions = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<BuildOptionsDefinition> Create<TContext>(in TContext context, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.BuildOptionsDefinition.BuildOptionsEntity.Source<TContext> buildOptions = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
