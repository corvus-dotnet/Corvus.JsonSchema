...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompileOnSaveDefinition
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(CompileOnSaveDefinition instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CompileOnSaveDefinition"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CompileOnSaveDefinition(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new CompileOnSaveDefinition(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CompileOnSaveDefinition.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="CompileOnSaveDefinition"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="CompileOnSaveDefinition"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly CompileOnSaveDefinition Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<CompileOnSaveDefinition>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="CompileOnSaveDefinition"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly CompileOnSaveDefinition Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CompileOnSaveDefinition>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.JsconfigBenchmark.Current.JsonBoolean.Source _createArg1;
            ...
            internal Source(Corvus.JsconfigBenchmark.Current.JsconfigSchema.CompileOnSaveDefinition.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.JsconfigBenchmark.Current.JsonBoolean.Source arg1)
            {
                _createArg1 = arg1;
                _kind = Kind.Create;
            }

            public static implicit operator Source(CompileOnSaveDefinition instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.JsconfigBenchmark.Current.JsconfigSchema.CompileOnSaveDefinition.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="CompileOnSaveDefinition"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.JsconfigBenchmark.Current.JsonBoolean.Source compileOnSave = default)
            {
            ...
            /// Creates an instance of a <see cref="CompileOnSaveDefinition"/>.
            /// </summary>
            public void Create(in Corvus.JsconfigBenchmark.Current.JsonBoolean.Source compileOnSave = default)
            {
                Create(ref _builder, compileOnSave);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.JsconfigBenchmark.Current.JsonBoolean.Source arg1, ref ComplexValueBuilder o)
            {
                o.StartObject();
                Create(ref o, arg1);
                o.EndObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.JsconfigBenchmark.Current.JsonBoolean.Source compileOnSave = default)
        {
            return new Source(compileOnSave);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.JsconfigBenchmark.Current.JsonBoolean.Source compileOnSave = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(compileOnSave);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<CompileOnSaveDefinition, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<CompileOnSaveDefinition> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<CompileOnSaveDefinition>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<CompileOnSaveDefinition> Create<TContext>(
        ...
        public static ParsedJsonDocument<CompileOnSaveDefinition> Create(in Corvus.JsconfigBenchmark.Current.JsonBoolean.Source compileOnSave = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
