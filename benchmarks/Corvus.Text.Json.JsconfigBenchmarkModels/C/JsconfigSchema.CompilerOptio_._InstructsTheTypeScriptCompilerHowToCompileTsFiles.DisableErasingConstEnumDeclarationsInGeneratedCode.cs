...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct DisableErasingConstEnumDeclarationsInGeneratedCode
#if NET8_0_OR_GREATER
                : IJsonElement<DisableErasingConstEnumDeclarationsInGeneratedCode>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="DisableErasingConstEnumDeclarationsInGeneratedCode"/> struct.
                /// </summary>
                ...
                internal DisableErasingConstEnumDeclarationsInGeneratedCode(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static DisableErasingConstEnumDeclarationsInGeneratedCode DefaultInstance { get; } = ParsedJsonDocument<DisableErasingConstEnumDeclarationsInGeneratedCode>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(DisableErasingConstEnumDeclarationsInGeneratedCode value)
                {
                ...
                /// </returns>
                public static bool operator ==(in DisableErasingConstEnumDeclarationsInGeneratedCode left, in DisableErasingConstEnumDeclarationsInGeneratedCode right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in DisableErasingConstEnumDeclarationsInGeneratedCode left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(DisableErasingConstEnumDeclarationsInGeneratedCode instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DisableErasingConstEnumDeclarationsInGeneratedCode(JsonElement instance)
                {
                    return DisableErasingConstEnumDeclarationsInGeneratedCode.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DisableErasingConstEnumDeclarationsInGeneratedCode From<T>(in T instance)
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DisableErasingConstEnumDeclarationsInGeneratedCode ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<DisableErasingConstEnumDeclarationsInGeneratedCode>(utf8Json, options);
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DisableErasingConstEnumDeclarationsInGeneratedCode ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<DisableErasingConstEnumDeclarationsInGeneratedCode>(json, options);
                    #pragma warning restore CS0618
                }
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DisableErasingConstEnumDeclarationsInGeneratedCode ParseValue(string json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<DisableErasingConstEnumDeclarationsInGeneratedCode>(json, options);
                    #pragma warning restore CS0618
                ...
                /// </exception>
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                public static DisableErasingConstEnumDeclarationsInGeneratedCode ParseValue(ref Utf8JsonReader reader)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<DisableErasingConstEnumDeclarationsInGeneratedCode>(ref reader);
                    #pragma warning restore CS0618
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out DisableErasingConstEnumDeclarationsInGeneratedCode? result)
                {
                    return JsonElementHelpers.TryParseValue<DisableErasingConstEnumDeclarationsInGeneratedCode>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new DisableErasingConstEnumDeclarationsInGeneratedCode(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static DisableErasingConstEnumDeclarationsInGeneratedCode IJsonElement<DisableErasingConstEnumDeclarationsInGeneratedCode>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DisableErasingConstEnumDeclarationsInGeneratedCode: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="DisableErasingConstEnumDeclarationsInGeneratedCode"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="DisableErasingConstEnumDeclarationsInGeneratedCode"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public DisableErasingConstEnumDeclarationsInGeneratedCode Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<DisableErasingConstEnumDeclarationsInGeneratedCode>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="DisableErasingConstEnumDeclarationsInGeneratedCode"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public DisableErasingConstEnumDeclarationsInGeneratedCode Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<DisableErasingConstEnumDeclarationsInGeneratedCode>(_idx);
                    }
