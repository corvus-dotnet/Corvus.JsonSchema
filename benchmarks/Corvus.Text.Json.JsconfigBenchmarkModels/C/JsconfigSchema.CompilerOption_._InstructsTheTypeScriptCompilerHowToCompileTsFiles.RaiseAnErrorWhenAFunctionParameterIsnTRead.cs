...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct RaiseAnErrorWhenAFunctionParameterIsnTRead
#if NET8_0_OR_GREATER
                : IJsonElement<RaiseAnErrorWhenAFunctionParameterIsnTRead>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="RaiseAnErrorWhenAFunctionParameterIsnTRead"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal RaiseAnErrorWhenAFunctionParameterIsnTRead(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static RaiseAnErrorWhenAFunctionParameterIsnTRead DefaultInstance { get; } = ParsedJsonDocument<RaiseAnErrorWhenAFunctionParameterIsnTRead>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(RaiseAnErrorWhenAFunctionParameterIsnTRead value)
                {
                ...
                /// </returns>
                public static bool operator ==(in RaiseAnErrorWhenAFunctionParameterIsnTRead left, in RaiseAnErrorWhenAFunctionParameterIsnTRead right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in RaiseAnErrorWhenAFunctionParameterIsnTRead left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(RaiseAnErrorWhenAFunctionParameterIsnTRead instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RaiseAnErrorWhenAFunctionParameterIsnTRead(JsonElement instance)
                {
                    return RaiseAnErrorWhenAFunctionParameterIsnTRead.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RaiseAnErrorWhenAFunctionParameterIsnTRead From<T>(in T instance)
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RaiseAnErrorWhenAFunctionParameterIsnTRead ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<RaiseAnErrorWhenAFunctionParameterIsnTRead>(utf8Json, options);
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RaiseAnErrorWhenAFunctionParameterIsnTRead ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<RaiseAnErrorWhenAFunctionParameterIsnTRead>(json, options);
                    #pragma warning restore CS0618
                }
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RaiseAnErrorWhenAFunctionParameterIsnTRead ParseValue(string json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<RaiseAnErrorWhenAFunctionParameterIsnTRead>(json, options);
                    #pragma warning restore CS0618
                ...
                /// </exception>
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                public static RaiseAnErrorWhenAFunctionParameterIsnTRead ParseValue(ref Utf8JsonReader reader)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<RaiseAnErrorWhenAFunctionParameterIsnTRead>(ref reader);
                    #pragma warning restore CS0618
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out RaiseAnErrorWhenAFunctionParameterIsnTRead? result)
                {
                    return JsonElementHelpers.TryParseValue<RaiseAnErrorWhenAFunctionParameterIsnTRead>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RaiseAnErrorWhenAFunctionParameterIsnTRead(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static RaiseAnErrorWhenAFunctionParameterIsnTRead IJsonElement<RaiseAnErrorWhenAFunctionParameterIsnTRead>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RaiseAnErrorWhenAFunctionParameterIsnTRead: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RaiseAnErrorWhenAFunctionParameterIsnTRead"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RaiseAnErrorWhenAFunctionParameterIsnTRead"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public RaiseAnErrorWhenAFunctionParameterIsnTRead Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RaiseAnErrorWhenAFunctionParameterIsnTRead>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RaiseAnErrorWhenAFunctionParameterIsnTRead"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public RaiseAnErrorWhenAFunctionParameterIsnTRead Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<RaiseAnErrorWhenAFunctionParameterIsnTRead>(_idx);
                    }
