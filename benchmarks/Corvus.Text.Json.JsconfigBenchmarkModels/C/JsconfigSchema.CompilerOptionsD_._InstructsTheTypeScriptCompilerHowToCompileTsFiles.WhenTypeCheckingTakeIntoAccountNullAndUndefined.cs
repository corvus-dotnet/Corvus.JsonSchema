...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct WhenTypeCheckingTakeIntoAccountNullAndUndefined
#if NET8_0_OR_GREATER
                : IJsonElement<WhenTypeCheckingTakeIntoAccountNullAndUndefined>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="WhenTypeCheckingTakeIntoAccountNullAndUndefined"/> struct.
                /// </summary>
                ...
                internal WhenTypeCheckingTakeIntoAccountNullAndUndefined(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static WhenTypeCheckingTakeIntoAccountNullAndUndefined DefaultInstance { get; } = ParsedJsonDocument<WhenTypeCheckingTakeIntoAccountNullAndUndefined>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(WhenTypeCheckingTakeIntoAccountNullAndUndefined value)
                {
                ...
                /// </returns>
                public static bool operator ==(in WhenTypeCheckingTakeIntoAccountNullAndUndefined left, in WhenTypeCheckingTakeIntoAccountNullAndUndefined right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in WhenTypeCheckingTakeIntoAccountNullAndUndefined left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(WhenTypeCheckingTakeIntoAccountNullAndUndefined instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WhenTypeCheckingTakeIntoAccountNullAndUndefined(JsonElement instance)
                {
                    return WhenTypeCheckingTakeIntoAccountNullAndUndefined.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WhenTypeCheckingTakeIntoAccountNullAndUndefined From<T>(in T instance)
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WhenTypeCheckingTakeIntoAccountNullAndUndefined ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<WhenTypeCheckingTakeIntoAccountNullAndUndefined>(utf8Json, options);
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WhenTypeCheckingTakeIntoAccountNullAndUndefined ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<WhenTypeCheckingTakeIntoAccountNullAndUndefined>(json, options);
                    #pragma warning restore CS0618
                }
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WhenTypeCheckingTakeIntoAccountNullAndUndefined ParseValue(string json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<WhenTypeCheckingTakeIntoAccountNullAndUndefined>(json, options);
                    #pragma warning restore CS0618
                ...
                /// </exception>
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                public static WhenTypeCheckingTakeIntoAccountNullAndUndefined ParseValue(ref Utf8JsonReader reader)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<WhenTypeCheckingTakeIntoAccountNullAndUndefined>(ref reader);
                    #pragma warning restore CS0618
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out WhenTypeCheckingTakeIntoAccountNullAndUndefined? result)
                {
                    return JsonElementHelpers.TryParseValue<WhenTypeCheckingTakeIntoAccountNullAndUndefined>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new WhenTypeCheckingTakeIntoAccountNullAndUndefined(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static WhenTypeCheckingTakeIntoAccountNullAndUndefined IJsonElement<WhenTypeCheckingTakeIntoAccountNullAndUndefined>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WhenTypeCheckingTakeIntoAccountNullAndUndefined: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="WhenTypeCheckingTakeIntoAccountNullAndUndefined"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="WhenTypeCheckingTakeIntoAccountNullAndUndefined"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public WhenTypeCheckingTakeIntoAccountNullAndUndefined Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<WhenTypeCheckingTakeIntoAccountNullAndUndefined>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="WhenTypeCheckingTakeIntoAccountNullAndUndefined"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public WhenTypeCheckingTakeIntoAccountNullAndUndefined Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<WhenTypeCheckingTakeIntoAccountNullAndUndefined>(_idx);
                    }
