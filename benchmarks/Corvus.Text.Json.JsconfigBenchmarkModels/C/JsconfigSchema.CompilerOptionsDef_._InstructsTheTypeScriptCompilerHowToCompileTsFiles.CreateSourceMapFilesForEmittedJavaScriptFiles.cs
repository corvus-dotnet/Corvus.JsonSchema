...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct CreateSourceMapFilesForEmittedJavaScriptFiles
#if NET8_0_OR_GREATER
                : IJsonElement<CreateSourceMapFilesForEmittedJavaScriptFiles>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="CreateSourceMapFilesForEmittedJavaScriptFiles"/> struct.
                /// </summary>
                ...
                internal CreateSourceMapFilesForEmittedJavaScriptFiles(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static CreateSourceMapFilesForEmittedJavaScriptFiles DefaultInstance { get; } = ParsedJsonDocument<CreateSourceMapFilesForEmittedJavaScriptFiles>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(CreateSourceMapFilesForEmittedJavaScriptFiles value)
                {
                ...
                /// </returns>
                public static bool operator ==(in CreateSourceMapFilesForEmittedJavaScriptFiles left, in CreateSourceMapFilesForEmittedJavaScriptFiles right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in CreateSourceMapFilesForEmittedJavaScriptFiles left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(CreateSourceMapFilesForEmittedJavaScriptFiles instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CreateSourceMapFilesForEmittedJavaScriptFiles(JsonElement instance)
                {
                    return CreateSourceMapFilesForEmittedJavaScriptFiles.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CreateSourceMapFilesForEmittedJavaScriptFiles From<T>(in T instance)
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CreateSourceMapFilesForEmittedJavaScriptFiles ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<CreateSourceMapFilesForEmittedJavaScriptFiles>(utf8Json, options);
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CreateSourceMapFilesForEmittedJavaScriptFiles ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<CreateSourceMapFilesForEmittedJavaScriptFiles>(json, options);
                    #pragma warning restore CS0618
                }
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CreateSourceMapFilesForEmittedJavaScriptFiles ParseValue(string json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<CreateSourceMapFilesForEmittedJavaScriptFiles>(json, options);
                    #pragma warning restore CS0618
                ...
                /// </exception>
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                public static CreateSourceMapFilesForEmittedJavaScriptFiles ParseValue(ref Utf8JsonReader reader)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<CreateSourceMapFilesForEmittedJavaScriptFiles>(ref reader);
                    #pragma warning restore CS0618
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out CreateSourceMapFilesForEmittedJavaScriptFiles? result)
                {
                    return JsonElementHelpers.TryParseValue<CreateSourceMapFilesForEmittedJavaScriptFiles>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new CreateSourceMapFilesForEmittedJavaScriptFiles(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static CreateSourceMapFilesForEmittedJavaScriptFiles IJsonElement<CreateSourceMapFilesForEmittedJavaScriptFiles>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CreateSourceMapFilesForEmittedJavaScriptFiles: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="CreateSourceMapFilesForEmittedJavaScriptFiles"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="CreateSourceMapFilesForEmittedJavaScriptFiles"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public CreateSourceMapFilesForEmittedJavaScriptFiles Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<CreateSourceMapFilesForEmittedJavaScriptFiles>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="CreateSourceMapFilesForEmittedJavaScriptFiles"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public CreateSourceMapFilesForEmittedJavaScriptFiles Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<CreateSourceMapFilesForEmittedJavaScriptFiles>(_idx);
                    }
