...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct DisableTruncatingTypesInErrorMessages
#if NET8_0_OR_GREATER
                : IJsonElement<DisableTruncatingTypesInErrorMessages>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="DisableTruncatingTypesInErrorMessages"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal DisableTruncatingTypesInErrorMessages(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static DisableTruncatingTypesInErrorMessages DefaultInstance { get; } = ParsedJsonDocument<DisableTruncatingTypesInErrorMessages>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(DisableTruncatingTypesInErrorMessages value)
                {
                ...
                /// </returns>
                public static bool operator ==(in DisableTruncatingTypesInErrorMessages left, in DisableTruncatingTypesInErrorMessages right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in DisableTruncatingTypesInErrorMessages left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(DisableTruncatingTypesInErrorMessages instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DisableTruncatingTypesInErrorMessages(JsonElement instance)
                {
                    return DisableTruncatingTypesInErrorMessages.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DisableTruncatingTypesInErrorMessages From<T>(in T instance)
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DisableTruncatingTypesInErrorMessages ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<DisableTruncatingTypesInErrorMessages>(utf8Json, options);
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DisableTruncatingTypesInErrorMessages ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<DisableTruncatingTypesInErrorMessages>(json, options);
                    #pragma warning restore CS0618
                }
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DisableTruncatingTypesInErrorMessages ParseValue(string json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<DisableTruncatingTypesInErrorMessages>(json, options);
                    #pragma warning restore CS0618
                ...
                /// </exception>
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                public static DisableTruncatingTypesInErrorMessages ParseValue(ref Utf8JsonReader reader)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<DisableTruncatingTypesInErrorMessages>(ref reader);
                    #pragma warning restore CS0618
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out DisableTruncatingTypesInErrorMessages? result)
                {
                    return JsonElementHelpers.TryParseValue<DisableTruncatingTypesInErrorMessages>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new DisableTruncatingTypesInErrorMessages(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static DisableTruncatingTypesInErrorMessages IJsonElement<DisableTruncatingTypesInErrorMessages>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DisableTruncatingTypesInErrorMessages: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="DisableTruncatingTypesInErrorMessages"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="DisableTruncatingTypesInErrorMessages"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public DisableTruncatingTypesInErrorMessages Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<DisableTruncatingTypesInErrorMessages>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="DisableTruncatingTypesInErrorMessages"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public DisableTruncatingTypesInErrorMessages Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<DisableTruncatingTypesInErrorMessages>(_idx);
                    }
