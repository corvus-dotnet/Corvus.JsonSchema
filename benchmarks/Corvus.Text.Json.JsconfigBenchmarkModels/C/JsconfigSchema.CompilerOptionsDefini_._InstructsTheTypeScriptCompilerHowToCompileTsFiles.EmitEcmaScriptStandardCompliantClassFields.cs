...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct EmitEcmaScriptStandardCompliantClassFields
#if NET8_0_OR_GREATER
                : IJsonElement<EmitEcmaScriptStandardCompliantClassFields>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="EmitEcmaScriptStandardCompliantClassFields"/> struct.
                /// </summary>
                ...
                internal EmitEcmaScriptStandardCompliantClassFields(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static EmitEcmaScriptStandardCompliantClassFields DefaultInstance { get; } = ParsedJsonDocument<EmitEcmaScriptStandardCompliantClassFields>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(EmitEcmaScriptStandardCompliantClassFields value)
                {
                ...
                /// </returns>
                public static bool operator ==(in EmitEcmaScriptStandardCompliantClassFields left, in EmitEcmaScriptStandardCompliantClassFields right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in EmitEcmaScriptStandardCompliantClassFields left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(EmitEcmaScriptStandardCompliantClassFields instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EmitEcmaScriptStandardCompliantClassFields(JsonElement instance)
                {
                    return EmitEcmaScriptStandardCompliantClassFields.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EmitEcmaScriptStandardCompliantClassFields From<T>(in T instance)
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EmitEcmaScriptStandardCompliantClassFields ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<EmitEcmaScriptStandardCompliantClassFields>(utf8Json, options);
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EmitEcmaScriptStandardCompliantClassFields ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<EmitEcmaScriptStandardCompliantClassFields>(json, options);
                    #pragma warning restore CS0618
                }
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EmitEcmaScriptStandardCompliantClassFields ParseValue(string json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<EmitEcmaScriptStandardCompliantClassFields>(json, options);
                    #pragma warning restore CS0618
                ...
                /// </exception>
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                public static EmitEcmaScriptStandardCompliantClassFields ParseValue(ref Utf8JsonReader reader)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<EmitEcmaScriptStandardCompliantClassFields>(ref reader);
                    #pragma warning restore CS0618
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out EmitEcmaScriptStandardCompliantClassFields? result)
                {
                    return JsonElementHelpers.TryParseValue<EmitEcmaScriptStandardCompliantClassFields>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new EmitEcmaScriptStandardCompliantClassFields(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static EmitEcmaScriptStandardCompliantClassFields IJsonElement<EmitEcmaScriptStandardCompliantClassFields>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EmitEcmaScriptStandardCompliantClassFields: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="EmitEcmaScriptStandardCompliantClassFields"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="EmitEcmaScriptStandardCompliantClassFields"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public EmitEcmaScriptStandardCompliantClassFields Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<EmitEcmaScriptStandardCompliantClassFields>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="EmitEcmaScriptStandardCompliantClassFields"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public EmitEcmaScriptStandardCompliantClassFields Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<EmitEcmaScriptStandardCompliantClassFields>(_idx);
                    }
