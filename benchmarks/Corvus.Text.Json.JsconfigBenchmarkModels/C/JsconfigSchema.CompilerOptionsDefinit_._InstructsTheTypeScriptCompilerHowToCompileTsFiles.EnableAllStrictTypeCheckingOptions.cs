...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct EnableAllStrictTypeCheckingOptions
#if NET8_0_OR_GREATER
                : IJsonElement<EnableAllStrictTypeCheckingOptions>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="EnableAllStrictTypeCheckingOptions"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal EnableAllStrictTypeCheckingOptions(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static EnableAllStrictTypeCheckingOptions DefaultInstance { get; } = ParsedJsonDocument<EnableAllStrictTypeCheckingOptions>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(EnableAllStrictTypeCheckingOptions value)
                {
                ...
                /// </returns>
                public static bool operator ==(in EnableAllStrictTypeCheckingOptions left, in EnableAllStrictTypeCheckingOptions right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in EnableAllStrictTypeCheckingOptions left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(EnableAllStrictTypeCheckingOptions instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EnableAllStrictTypeCheckingOptions(JsonElement instance)
                {
                    return EnableAllStrictTypeCheckingOptions.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EnableAllStrictTypeCheckingOptions From<T>(in T instance)
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EnableAllStrictTypeCheckingOptions ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<EnableAllStrictTypeCheckingOptions>(utf8Json, options);
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EnableAllStrictTypeCheckingOptions ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<EnableAllStrictTypeCheckingOptions>(json, options);
                    #pragma warning restore CS0618
                }
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EnableAllStrictTypeCheckingOptions ParseValue(string json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<EnableAllStrictTypeCheckingOptions>(json, options);
                    #pragma warning restore CS0618
                ...
                /// </exception>
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                public static EnableAllStrictTypeCheckingOptions ParseValue(ref Utf8JsonReader reader)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<EnableAllStrictTypeCheckingOptions>(ref reader);
                    #pragma warning restore CS0618
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out EnableAllStrictTypeCheckingOptions? result)
                {
                    return JsonElementHelpers.TryParseValue<EnableAllStrictTypeCheckingOptions>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new EnableAllStrictTypeCheckingOptions(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static EnableAllStrictTypeCheckingOptions IJsonElement<EnableAllStrictTypeCheckingOptions>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EnableAllStrictTypeCheckingOptions: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="EnableAllStrictTypeCheckingOptions"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="EnableAllStrictTypeCheckingOptions"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public EnableAllStrictTypeCheckingOptions Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<EnableAllStrictTypeCheckingOptions>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="EnableAllStrictTypeCheckingOptions"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public EnableAllStrictTypeCheckingOptions Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<EnableAllStrictTypeCheckingOptions>(_idx);
                    }
