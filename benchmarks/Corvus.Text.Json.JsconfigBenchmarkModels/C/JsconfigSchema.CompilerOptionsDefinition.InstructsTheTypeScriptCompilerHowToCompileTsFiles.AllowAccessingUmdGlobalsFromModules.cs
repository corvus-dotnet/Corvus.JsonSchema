    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="AllowAccessingUmdGlobalsFromModules"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal AllowAccessingUmdGlobalsFromModules(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static AllowAccessingUmdGlobalsFromModules DefaultInstance { get; } = ParsedJsonDocument<AllowAccessingUmdGlobalsFromModules>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(AllowAccessingUmdGlobalsFromModules value)
                {
                ...
                /// </returns>
                public static bool operator ==(in AllowAccessingUmdGlobalsFromModules left, in AllowAccessingUmdGlobalsFromModules right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in AllowAccessingUmdGlobalsFromModules left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(AllowAccessingUmdGlobalsFromModules instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AllowAccessingUmdGlobalsFromModules(JsonElement instance)
                {
                    return AllowAccessingUmdGlobalsFromModules.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AllowAccessingUmdGlobalsFromModules From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AllowAccessingUmdGlobalsFromModules ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AllowAccessingUmdGlobalsFromModules>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AllowAccessingUmdGlobalsFromModules ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AllowAccessingUmdGlobalsFromModules>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AllowAccessingUmdGlobalsFromModules ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AllowAccessingUmdGlobalsFromModules>(json, options);
                }
                ...
                /// </exception>
                public static AllowAccessingUmdGlobalsFromModules ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<AllowAccessingUmdGlobalsFromModules>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out AllowAccessingUmdGlobalsFromModules? result)
                {
                    return JsonElementHelpers.TryParseValue<AllowAccessingUmdGlobalsFromModules>(ref reader, out result);
                }
...
#if NET
                static AllowAccessingUmdGlobalsFromModules IJsonElement<AllowAccessingUmdGlobalsFromModules>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AllowAccessingUmdGlobalsFromModules: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public AllowAccessingUmdGlobalsFromModules Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public AllowAccessingUmdGlobalsFromModules Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<AllowAccessingUmdGlobalsFromModules>(_idx);
                    }
