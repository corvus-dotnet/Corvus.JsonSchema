        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct CompositeEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<CompositeEntity, Mutable>(CompositeEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(CompositeEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="CompositeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator CompositeEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"CompositeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly CompositeEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly CompositeEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<CompositeEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(CompositeEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<CompositeEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<CompositeEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<CompositeEntity>();
                    }
                    finally
                    {
