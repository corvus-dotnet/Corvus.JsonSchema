        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct CreateSourcemapsForDTsFiles
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<CreateSourcemapsForDTsFiles, Mutable>(CreateSourcemapsForDTsFiles.DefaultInstance);
                    ...
                    public static explicit operator Mutable(CreateSourcemapsForDTsFiles instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="CreateSourcemapsForDTsFiles"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator CreateSourcemapsForDTsFiles(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"CreateSourcemapsForDTsFiles.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly CreateSourcemapsForDTsFiles Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly CreateSourcemapsForDTsFiles Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<CreateSourcemapsForDTsFiles>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(CreateSourcemapsForDTsFiles instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<CreateSourcemapsForDTsFiles, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<CreateSourcemapsForDTsFiles> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<CreateSourcemapsForDTsFiles>();
                    }
                    finally
                    {
