        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct DisableEmittingComments
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableEmittingComments, Mutable>(DisableEmittingComments.DefaultInstance);
                    ...
                    public static explicit operator Mutable(DisableEmittingComments instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DisableEmittingComments"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DisableEmittingComments(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DisableEmittingComments.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DisableEmittingComments Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DisableEmittingComments Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DisableEmittingComments>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DisableEmittingComments instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<DisableEmittingComments, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<DisableEmittingComments> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DisableEmittingComments>();
                    }
                    finally
                    {
