...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct DisableEmittingComments
#if NET8_0_OR_GREATER
                : IJsonElement<DisableEmittingComments>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="DisableEmittingComments"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal DisableEmittingComments(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static DisableEmittingComments DefaultInstance { get; } = ParsedJsonDocument<DisableEmittingComments>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(DisableEmittingComments value)
                {
                ...
                /// </returns>
                public static bool operator ==(in DisableEmittingComments left, in DisableEmittingComments right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in DisableEmittingComments left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(DisableEmittingComments instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DisableEmittingComments(JsonElement instance)
                {
                    return DisableEmittingComments.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DisableEmittingComments From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DisableEmittingComments ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DisableEmittingComments>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DisableEmittingComments ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DisableEmittingComments>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DisableEmittingComments ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DisableEmittingComments>(json, options);
                }
                ...
                /// </exception>
                public static DisableEmittingComments ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<DisableEmittingComments>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out DisableEmittingComments? result)
                {
                    return JsonElementHelpers.TryParseValue<DisableEmittingComments>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new DisableEmittingComments(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static DisableEmittingComments IJsonElement<DisableEmittingComments>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DisableEmittingComments: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="DisableEmittingComments"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="DisableEmittingComments"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public DisableEmittingComments Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<DisableEmittingComments>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="DisableEmittingComments"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public DisableEmittingComments Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<DisableEmittingComments>(_idx);
                    }
