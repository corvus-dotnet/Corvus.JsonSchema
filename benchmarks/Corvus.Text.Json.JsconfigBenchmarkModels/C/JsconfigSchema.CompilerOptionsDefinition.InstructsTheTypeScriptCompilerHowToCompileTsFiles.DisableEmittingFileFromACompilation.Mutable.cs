        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct DisableEmittingFileFromACompilation
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableEmittingFileFromACompilation, Mutable>(DisableEmittingFileFromACompilation.DefaultInstance);
                    ...
                    public static explicit operator Mutable(DisableEmittingFileFromACompilation instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DisableEmittingFileFromACompilation"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DisableEmittingFileFromACompilation(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DisableEmittingFileFromACompilation.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DisableEmittingFileFromACompilation Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DisableEmittingFileFromACompilation Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DisableEmittingFileFromACompilation>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DisableEmittingFileFromACompilation instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<DisableEmittingFileFromACompilation, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<DisableEmittingFileFromACompilation> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DisableEmittingFileFromACompilation>();
                    }
                    finally
                    {
