    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="DisableEmittingFileFromACompilation"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal DisableEmittingFileFromACompilation(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static DisableEmittingFileFromACompilation DefaultInstance { get; } = ParsedJsonDocument<DisableEmittingFileFromACompilation>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(DisableEmittingFileFromACompilation value)
                {
                ...
                /// </returns>
                public static bool operator ==(in DisableEmittingFileFromACompilation left, in DisableEmittingFileFromACompilation right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in DisableEmittingFileFromACompilation left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(DisableEmittingFileFromACompilation instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DisableEmittingFileFromACompilation(JsonElement instance)
                {
                    return DisableEmittingFileFromACompilation.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DisableEmittingFileFromACompilation From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DisableEmittingFileFromACompilation ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DisableEmittingFileFromACompilation>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DisableEmittingFileFromACompilation ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DisableEmittingFileFromACompilation>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DisableEmittingFileFromACompilation ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DisableEmittingFileFromACompilation>(json, options);
                }
                ...
                /// </exception>
                public static DisableEmittingFileFromACompilation ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<DisableEmittingFileFromACompilation>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out DisableEmittingFileFromACompilation? result)
                {
                    return JsonElementHelpers.TryParseValue<DisableEmittingFileFromACompilation>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new DisableEmittingFileFromACompilation(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static DisableEmittingFileFromACompilation IJsonElement<DisableEmittingFileFromACompilation>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DisableEmittingFileFromACompilation: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="DisableEmittingFileFromACompilation"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="DisableEmittingFileFromACompilation"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public DisableEmittingFileFromACompilation Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<DisableEmittingFileFromACompilation>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="DisableEmittingFileFromACompilation"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public DisableEmittingFileFromACompilation Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<DisableEmittingFileFromACompilation>(_idx);
                    }
