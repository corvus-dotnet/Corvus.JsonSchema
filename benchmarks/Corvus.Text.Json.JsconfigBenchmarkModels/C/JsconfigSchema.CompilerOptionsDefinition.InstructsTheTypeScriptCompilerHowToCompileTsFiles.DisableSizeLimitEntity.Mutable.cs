...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct DisableSizeLimitEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableSizeLimitEntity, Mutable>(DisableSizeLimitEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(DisableSizeLimitEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DisableSizeLimitEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DisableSizeLimitEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new DisableSizeLimitEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DisableSizeLimitEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="DisableSizeLimitEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="DisableSizeLimitEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DisableSizeLimitEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<DisableSizeLimitEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="DisableSizeLimitEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DisableSizeLimitEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DisableSizeLimitEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DisableSizeLimitEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<DisableSizeLimitEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<DisableSizeLimitEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DisableSizeLimitEntity>();
                    }
                    finally
                    {
