        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct DownlevelIterationEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DownlevelIterationEntity, Mutable>(DownlevelIterationEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(DownlevelIterationEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DownlevelIterationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DownlevelIterationEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DownlevelIterationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DownlevelIterationEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DownlevelIterationEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DownlevelIterationEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DownlevelIterationEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<DownlevelIterationEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<DownlevelIterationEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DownlevelIterationEntity>();
                    }
                    finally
                    {
