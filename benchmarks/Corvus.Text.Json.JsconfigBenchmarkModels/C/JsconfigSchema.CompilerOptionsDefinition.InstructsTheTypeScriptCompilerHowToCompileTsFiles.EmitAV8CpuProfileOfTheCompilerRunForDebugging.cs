...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct EmitAV8CpuProfileOfTheCompilerRunForDebugging
#if NET8_0_OR_GREATER
                : IJsonElement<EmitAV8CpuProfileOfTheCompilerRunForDebugging>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="EmitAV8CpuProfileOfTheCompilerRunForDebugging"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal EmitAV8CpuProfileOfTheCompilerRunForDebugging(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static EmitAV8CpuProfileOfTheCompilerRunForDebugging DefaultInstance { get; } = ParsedJsonDocument<EmitAV8CpuProfileOfTheCompilerRunForDebugging>.StringConstant([.."\"profile.cpuprofile\""u8]);
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(EmitAV8CpuProfileOfTheCompilerRunForDebugging value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in EmitAV8CpuProfileOfTheCompilerRunForDebugging left, in EmitAV8CpuProfileOfTheCompilerRunForDebugging right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in EmitAV8CpuProfileOfTheCompilerRunForDebugging left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(EmitAV8CpuProfileOfTheCompilerRunForDebugging instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EmitAV8CpuProfileOfTheCompilerRunForDebugging(JsonElement instance)
                {
                    return EmitAV8CpuProfileOfTheCompilerRunForDebugging.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EmitAV8CpuProfileOfTheCompilerRunForDebugging From<T>(in T instance)
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out EmitAV8CpuProfileOfTheCompilerRunForDebugging? result)
                {
                    return JsonElementHelpers.TryParseValue<EmitAV8CpuProfileOfTheCompilerRunForDebugging>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new EmitAV8CpuProfileOfTheCompilerRunForDebugging(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static EmitAV8CpuProfileOfTheCompilerRunForDebugging IJsonElement<EmitAV8CpuProfileOfTheCompilerRunForDebugging>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EmitAV8CpuProfileOfTheCompilerRunForDebugging: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="EmitAV8CpuProfileOfTheCompilerRunForDebugging"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="EmitAV8CpuProfileOfTheCompilerRunForDebugging"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public EmitAV8CpuProfileOfTheCompilerRunForDebugging Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<EmitAV8CpuProfileOfTheCompilerRunForDebugging>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="EmitAV8CpuProfileOfTheCompilerRunForDebugging"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public EmitAV8CpuProfileOfTheCompilerRunForDebugging Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<EmitAV8CpuProfileOfTheCompilerRunForDebugging>(_idx);
                    }
