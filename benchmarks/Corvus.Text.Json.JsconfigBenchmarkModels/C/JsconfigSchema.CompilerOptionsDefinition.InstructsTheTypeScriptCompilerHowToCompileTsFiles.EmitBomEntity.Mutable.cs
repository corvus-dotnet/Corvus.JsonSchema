        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct EmitBomEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EmitBomEntity, Mutable>(EmitBomEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(EmitBomEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="EmitBomEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator EmitBomEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"EmitBomEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EmitBomEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EmitBomEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<EmitBomEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(EmitBomEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<EmitBomEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<EmitBomEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<EmitBomEntity>();
                    }
                    finally
                    {
