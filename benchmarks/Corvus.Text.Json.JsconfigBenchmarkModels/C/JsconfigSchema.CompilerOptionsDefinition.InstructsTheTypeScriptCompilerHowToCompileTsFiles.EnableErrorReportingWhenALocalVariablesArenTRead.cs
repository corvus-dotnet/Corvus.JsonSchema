...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct EnableErrorReportingWhenALocalVariablesArenTRead
#if NET8_0_OR_GREATER
                : IJsonElement<EnableErrorReportingWhenALocalVariablesArenTRead>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="EnableErrorReportingWhenALocalVariablesArenTRead"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal EnableErrorReportingWhenALocalVariablesArenTRead(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static EnableErrorReportingWhenALocalVariablesArenTRead DefaultInstance { get; } = ParsedJsonDocument<EnableErrorReportingWhenALocalVariablesArenTRead>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(EnableErrorReportingWhenALocalVariablesArenTRead value)
                {
                ...
                /// </returns>
                public static bool operator ==(in EnableErrorReportingWhenALocalVariablesArenTRead left, in EnableErrorReportingWhenALocalVariablesArenTRead right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in EnableErrorReportingWhenALocalVariablesArenTRead left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(EnableErrorReportingWhenALocalVariablesArenTRead instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EnableErrorReportingWhenALocalVariablesArenTRead(JsonElement instance)
                {
                    return EnableErrorReportingWhenALocalVariablesArenTRead.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EnableErrorReportingWhenALocalVariablesArenTRead From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EnableErrorReportingWhenALocalVariablesArenTRead ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<EnableErrorReportingWhenALocalVariablesArenTRead>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EnableErrorReportingWhenALocalVariablesArenTRead ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<EnableErrorReportingWhenALocalVariablesArenTRead>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EnableErrorReportingWhenALocalVariablesArenTRead ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<EnableErrorReportingWhenALocalVariablesArenTRead>(json, options);
                }
                ...
                /// </exception>
                public static EnableErrorReportingWhenALocalVariablesArenTRead ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<EnableErrorReportingWhenALocalVariablesArenTRead>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out EnableErrorReportingWhenALocalVariablesArenTRead? result)
                {
                    return JsonElementHelpers.TryParseValue<EnableErrorReportingWhenALocalVariablesArenTRead>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new EnableErrorReportingWhenALocalVariablesArenTRead(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static EnableErrorReportingWhenALocalVariablesArenTRead IJsonElement<EnableErrorReportingWhenALocalVariablesArenTRead>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EnableErrorReportingWhenALocalVariablesArenTRead: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="EnableErrorReportingWhenALocalVariablesArenTRead"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="EnableErrorReportingWhenALocalVariablesArenTRead"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public EnableErrorReportingWhenALocalVariablesArenTRead Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<EnableErrorReportingWhenALocalVariablesArenTRead>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="EnableErrorReportingWhenALocalVariablesArenTRead"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public EnableErrorReportingWhenALocalVariablesArenTRead Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<EnableErrorReportingWhenALocalVariablesArenTRead>(_idx);
                    }
