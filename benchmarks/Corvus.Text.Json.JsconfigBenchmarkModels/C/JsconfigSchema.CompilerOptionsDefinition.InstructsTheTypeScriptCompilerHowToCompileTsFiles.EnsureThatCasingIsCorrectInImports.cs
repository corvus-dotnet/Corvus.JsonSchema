...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct EnsureThatCasingIsCorrectInImports
#if NET8_0_OR_GREATER
                : IJsonElement<EnsureThatCasingIsCorrectInImports>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="EnsureThatCasingIsCorrectInImports"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal EnsureThatCasingIsCorrectInImports(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static EnsureThatCasingIsCorrectInImports DefaultInstance { get; } = ParsedJsonDocument<EnsureThatCasingIsCorrectInImports>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(EnsureThatCasingIsCorrectInImports value)
                {
                ...
                /// </returns>
                public static bool operator ==(in EnsureThatCasingIsCorrectInImports left, in EnsureThatCasingIsCorrectInImports right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in EnsureThatCasingIsCorrectInImports left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(EnsureThatCasingIsCorrectInImports instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EnsureThatCasingIsCorrectInImports(JsonElement instance)
                {
                    return EnsureThatCasingIsCorrectInImports.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EnsureThatCasingIsCorrectInImports From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EnsureThatCasingIsCorrectInImports ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<EnsureThatCasingIsCorrectInImports>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EnsureThatCasingIsCorrectInImports ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<EnsureThatCasingIsCorrectInImports>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EnsureThatCasingIsCorrectInImports ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<EnsureThatCasingIsCorrectInImports>(json, options);
                }
                ...
                /// </exception>
                public static EnsureThatCasingIsCorrectInImports ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<EnsureThatCasingIsCorrectInImports>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out EnsureThatCasingIsCorrectInImports? result)
                {
                    return JsonElementHelpers.TryParseValue<EnsureThatCasingIsCorrectInImports>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new EnsureThatCasingIsCorrectInImports(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static EnsureThatCasingIsCorrectInImports IJsonElement<EnsureThatCasingIsCorrectInImports>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EnsureThatCasingIsCorrectInImports: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="EnsureThatCasingIsCorrectInImports"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="EnsureThatCasingIsCorrectInImports"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public EnsureThatCasingIsCorrectInImports Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<EnsureThatCasingIsCorrectInImports>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="EnsureThatCasingIsCorrectInImports"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public EnsureThatCasingIsCorrectInImports Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<EnsureThatCasingIsCorrectInImports>(_idx);
                    }
