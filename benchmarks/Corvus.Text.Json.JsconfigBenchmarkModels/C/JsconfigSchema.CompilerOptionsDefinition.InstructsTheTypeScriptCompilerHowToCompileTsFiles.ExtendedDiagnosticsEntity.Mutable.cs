        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct ExtendedDiagnosticsEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ExtendedDiagnosticsEntity, Mutable>(ExtendedDiagnosticsEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(ExtendedDiagnosticsEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ExtendedDiagnosticsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ExtendedDiagnosticsEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ExtendedDiagnosticsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ExtendedDiagnosticsEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ExtendedDiagnosticsEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ExtendedDiagnosticsEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ExtendedDiagnosticsEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ExtendedDiagnosticsEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ExtendedDiagnosticsEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ExtendedDiagnosticsEntity>();
                    }
                    finally
                    {
