        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct FallbackPollingEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(FallbackPollingEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="FallbackPollingEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator FallbackPollingEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"FallbackPollingEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly FallbackPollingEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly FallbackPollingEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<FallbackPollingEntity>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(FallbackPollingEntity instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (FallbackPollingEntity)value;
                ...
                {
                    return workspace.CreateBuilder<FallbackPollingEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<FallbackPollingEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<FallbackPollingEntity>();
                    }
                    finally
                    {
