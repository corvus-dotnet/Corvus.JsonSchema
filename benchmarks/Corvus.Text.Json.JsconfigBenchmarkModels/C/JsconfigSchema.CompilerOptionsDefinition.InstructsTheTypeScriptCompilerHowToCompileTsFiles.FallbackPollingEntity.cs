    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="FallbackPollingEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal FallbackPollingEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static FallbackPollingEntity DefaultInstance { get; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(FallbackPollingEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in FallbackPollingEntity left, in FallbackPollingEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in FallbackPollingEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(FallbackPollingEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FallbackPollingEntity(JsonElement instance)
                {
                    return FallbackPollingEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static FallbackPollingEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static FallbackPollingEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<FallbackPollingEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static FallbackPollingEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<FallbackPollingEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static FallbackPollingEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<FallbackPollingEntity>(json, options);
                }
                ...
                /// </exception>
                public static FallbackPollingEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<FallbackPollingEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out FallbackPollingEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<FallbackPollingEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new FallbackPollingEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static FallbackPollingEntity IJsonElement<FallbackPollingEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FallbackPollingEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="FallbackPollingEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="FallbackPollingEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public FallbackPollingEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<FallbackPollingEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="FallbackPollingEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public FallbackPollingEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<FallbackPollingEntity>(_idx);
                    }
                ...
                /// <param name="matchFixedPollingInterval">Match 1st item.</param>
                /// <param name="matchPriorityPollingInterval">Match 2nd item.</param>
                /// <param name="matchDynamicPriorityPolling">Match 3rd item.</param>
                /// <param name="matchFixedInterval">Match 4th item.</param>
                /// <param name="matchPriorityInterval">Match 5th item.</param>
                /// <param name="matchDynamicPriority">Match 6th item.</param>
                /// <param name="matchFixedChunkSize">Match 7th item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchFixedPollingInterval,
                    Func<TContext, TResult> matchPriorityPollingInterval,
                    Func<TContext, TResult> matchDynamicPriorityPolling,
                    Func<TContext, TResult> matchFixedInterval,
                    Func<TContext, TResult> matchPriorityInterval,
                    Func<TContext, TResult> matchDynamicPriority,
                    Func<TContext, TResult> matchFixedChunkSize,
...
#endif
                {
                    ...
                    {
                        return matchFixedPollingInterval(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchPriorityPollingInterval(context);
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchDynamicPriorityPolling(context);
                    }

                    if (this.ValueEquals(Constants.Enum4))
                    {
                        return matchFixedInterval(context);
                    }

                    if (this.ValueEquals(Constants.Enum5))
                    {
                        return matchPriorityInterval(context);
                    }

                    if (this.ValueEquals(Constants.Enum6))
                    {
                        return matchDynamicPriority(context);
                    }

                    if (this.ValueEquals(Constants.Enum7))
                    {
                        return matchFixedChunkSize(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchFixedPollingInterval,
                    Func<TResult> matchPriorityPollingInterval,
                    Func<TResult> matchDynamicPriorityPolling,
                    Func<TResult> matchFixedInterval,
                    Func<TResult> matchPriorityInterval,
                    Func<TResult> matchDynamicPriority,
                    Func<TResult> matchFixedChunkSize,
                    Func<TResult> defaultMatch)
                {
                    if (this.ValueEquals(Constants.Enum1))
                    {
                        return matchFixedPollingInterval();
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchPriorityPollingInterval();
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchDynamicPriorityPolling();
                    }

                    if (this.ValueEquals(Constants.Enum4))
                    {
                        return matchFixedInterval();
                    }

                    if (this.ValueEquals(Constants.Enum5))
                    {
                        return matchPriorityInterval();
                    }

                    if (this.ValueEquals(Constants.Enum6))
                    {
                        return matchDynamicPriority();
                    }

                    if (this.ValueEquals(Constants.Enum7))
                    {
                        return matchFixedChunkSize();
                    }
