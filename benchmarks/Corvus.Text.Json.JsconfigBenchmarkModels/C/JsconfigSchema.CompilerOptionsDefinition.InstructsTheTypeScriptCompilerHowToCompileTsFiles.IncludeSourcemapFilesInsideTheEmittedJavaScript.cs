...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct IncludeSourcemapFilesInsideTheEmittedJavaScript
#if NET8_0_OR_GREATER
                : IJsonElement<IncludeSourcemapFilesInsideTheEmittedJavaScript>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="IncludeSourcemapFilesInsideTheEmittedJavaScript"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal IncludeSourcemapFilesInsideTheEmittedJavaScript(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static IncludeSourcemapFilesInsideTheEmittedJavaScript DefaultInstance { get; } = ParsedJsonDocument<IncludeSourcemapFilesInsideTheEmittedJavaScript>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(IncludeSourcemapFilesInsideTheEmittedJavaScript value)
                {
                ...
                /// </returns>
                public static bool operator ==(in IncludeSourcemapFilesInsideTheEmittedJavaScript left, in IncludeSourcemapFilesInsideTheEmittedJavaScript right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in IncludeSourcemapFilesInsideTheEmittedJavaScript left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(IncludeSourcemapFilesInsideTheEmittedJavaScript instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IncludeSourcemapFilesInsideTheEmittedJavaScript(JsonElement instance)
                {
                    return IncludeSourcemapFilesInsideTheEmittedJavaScript.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static IncludeSourcemapFilesInsideTheEmittedJavaScript From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static IncludeSourcemapFilesInsideTheEmittedJavaScript ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<IncludeSourcemapFilesInsideTheEmittedJavaScript>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static IncludeSourcemapFilesInsideTheEmittedJavaScript ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<IncludeSourcemapFilesInsideTheEmittedJavaScript>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static IncludeSourcemapFilesInsideTheEmittedJavaScript ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<IncludeSourcemapFilesInsideTheEmittedJavaScript>(json, options);
                }
                ...
                /// </exception>
                public static IncludeSourcemapFilesInsideTheEmittedJavaScript ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<IncludeSourcemapFilesInsideTheEmittedJavaScript>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out IncludeSourcemapFilesInsideTheEmittedJavaScript? result)
                {
                    return JsonElementHelpers.TryParseValue<IncludeSourcemapFilesInsideTheEmittedJavaScript>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new IncludeSourcemapFilesInsideTheEmittedJavaScript(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static IncludeSourcemapFilesInsideTheEmittedJavaScript IJsonElement<IncludeSourcemapFilesInsideTheEmittedJavaScript>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IncludeSourcemapFilesInsideTheEmittedJavaScript: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="IncludeSourcemapFilesInsideTheEmittedJavaScript"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="IncludeSourcemapFilesInsideTheEmittedJavaScript"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public IncludeSourcemapFilesInsideTheEmittedJavaScript Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<IncludeSourcemapFilesInsideTheEmittedJavaScript>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="IncludeSourcemapFilesInsideTheEmittedJavaScript"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public IncludeSourcemapFilesInsideTheEmittedJavaScript Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<IncludeSourcemapFilesInsideTheEmittedJavaScript>(_idx);
                    }
