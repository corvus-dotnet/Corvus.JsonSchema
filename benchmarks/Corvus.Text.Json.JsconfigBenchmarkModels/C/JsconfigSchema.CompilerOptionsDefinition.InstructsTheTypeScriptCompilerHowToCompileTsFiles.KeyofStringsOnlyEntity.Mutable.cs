        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct KeyofStringsOnlyEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<KeyofStringsOnlyEntity, Mutable>(KeyofStringsOnlyEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(KeyofStringsOnlyEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="KeyofStringsOnlyEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator KeyofStringsOnlyEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"KeyofStringsOnlyEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly KeyofStringsOnlyEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly KeyofStringsOnlyEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<KeyofStringsOnlyEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(KeyofStringsOnlyEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<KeyofStringsOnlyEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<KeyofStringsOnlyEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<KeyofStringsOnlyEntity>();
                    }
                    finally
                    {
