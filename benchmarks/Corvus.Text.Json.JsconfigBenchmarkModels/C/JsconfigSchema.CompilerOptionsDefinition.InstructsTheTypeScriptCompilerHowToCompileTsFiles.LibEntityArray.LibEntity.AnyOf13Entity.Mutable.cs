                ...
                public readonly partial struct LibEntity
                {
                    ...
                    public readonly partial struct AnyOf13Entity
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Mutable(AnyOf13Entity instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="AnyOf13Entity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator AnyOf13Entity(Mutable instance)
                            {
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"AnyOf13Entity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly AnyOf13Entity Clone()
                            {
                                CheckValidInstance();
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly AnyOf13Entity Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<AnyOf13Entity>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            public static implicit operator Source(AnyOf13Entity instance) => new(JsonElement.From(instance));
                        ...
                        {
                            return workspace.CreateBuilder<AnyOf13Entity, Mutable>(this);
                        }
                        ...
                        public static ParsedJsonDocument<AnyOf13Entity> Create(
                            scoped in Source value, int initialCapacity = 1)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<AnyOf13Entity>();
                            }
                            finally
                            {
