                ...
                public readonly partial struct LibEntity
                {
                        ...
                        : IJsonElement<AnyOf6Entity>
                    {
                        public static partial class JsonSchema
                        {
                            ...
                            /// </summary>
                            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/jsconfig.json#/definitions/compilerOptionsDefinition/properties/compilerOptions/properties/lib/items/anyOf/6"u8, buffer, out written);

                            /// <summary>
                            /// Gets the schema location from which this type was generated.
                            /// </summary>
                            public const string SchemaLocation = "https://json.schemastore.org/jsconfig.json#/definitions/compilerOptionsDefinition/properties/compilerOptions/properties/lib/items/anyOf/6";

                            /// <summary>
                            /// Gets the schema location from which this type was generated as a UTF-8 string.
                            /// </summary>
                            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/jsconfig.json#/definitions/compilerOptionsDefinition/properties/compilerOptions/properties/lib/items/anyOf/6"u8;
                                ...
                                ref JsonSchemaContext context)
                            {
                                ...
                                if (tokenType == JsonTokenType.String)
                                {
                                    ...
                                    JsonSchemaEvaluation.MatchRegularExpression(unescapedUtf8JsonString.Span, Pattern,"^[Ee][Ss]2019(\\.([Aa][Rr][Rr][Aa][Yy]|[Oo][Bb][Jj][Ee][Cc][Tt]|[Ss][Tt][Rr][Ii][Nn][Gg]|[Ss][Yy][Mm][Bb][Oo][Ll]))?$", "pattern"u8, ref context);
                                }
                                else
                                {
                            ...
                            [GeneratedRegex("^[Ee][Ss]2019(\\.([Aa][Rr][Rr][Aa][Yy]|[Oo][Bb][Jj][Ee][Cc][Tt]|[Ss][Tt][Rr][Ii][Nn][Gg]|[Ss][Yy][Mm][Bb][Oo][Ll]))?$")]
                            private static partial Regex CreatePattern();
#else
                            private static Regex CreatePattern() => new("^[Ee][Ss]2019(\\.([Aa][Rr][Rr][Aa][Yy]|[Oo][Bb][Jj][Ee][Cc][Tt]|[Ss][Tt][Rr][Ii][Nn][Gg]|[Ss][Yy][Mm][Bb][Oo][Ll]))?$", RegexOptions.Compiled);
#endif
