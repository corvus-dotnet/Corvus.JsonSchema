        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct MaxNodeModuleJsDepthEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MaxNodeModuleJsDepthEntity, Mutable>(MaxNodeModuleJsDepthEntity.DefaultInstance);
                ...
                public static ParsedJsonDocument<MaxNodeModuleJsDepthEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<MaxNodeModuleJsDepthEntity>();
                    }
                    finally
                    {
