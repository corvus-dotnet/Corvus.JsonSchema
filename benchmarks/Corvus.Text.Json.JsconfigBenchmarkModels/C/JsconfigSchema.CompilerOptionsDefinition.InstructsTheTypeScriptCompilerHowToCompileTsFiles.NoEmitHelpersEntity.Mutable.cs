        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct NoEmitHelpersEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NoEmitHelpersEntity, Mutable>(NoEmitHelpersEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(NoEmitHelpersEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="NoEmitHelpersEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator NoEmitHelpersEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"NoEmitHelpersEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly NoEmitHelpersEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly NoEmitHelpersEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<NoEmitHelpersEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(NoEmitHelpersEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<NoEmitHelpersEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<NoEmitHelpersEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<NoEmitHelpersEntity>();
                    }
                    finally
                    {
