        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct NoEmitOnErrorEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NoEmitOnErrorEntity, Mutable>(NoEmitOnErrorEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(NoEmitOnErrorEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="NoEmitOnErrorEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator NoEmitOnErrorEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"NoEmitOnErrorEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly NoEmitOnErrorEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly NoEmitOnErrorEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<NoEmitOnErrorEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(NoEmitOnErrorEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<NoEmitOnErrorEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<NoEmitOnErrorEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<NoEmitOnErrorEntity>();
                    }
                    finally
                    {
