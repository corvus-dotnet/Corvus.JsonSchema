...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct NoEmitOnErrorEntity
#if NET8_0_OR_GREATER
                : IJsonElement<NoEmitOnErrorEntity>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="NoEmitOnErrorEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal NoEmitOnErrorEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static NoEmitOnErrorEntity DefaultInstance { get; } = ParsedJsonDocument<NoEmitOnErrorEntity>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(NoEmitOnErrorEntity value)
                {
                ...
                /// </returns>
                public static bool operator ==(in NoEmitOnErrorEntity left, in NoEmitOnErrorEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in NoEmitOnErrorEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(NoEmitOnErrorEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator NoEmitOnErrorEntity(JsonElement instance)
                {
                    return NoEmitOnErrorEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static NoEmitOnErrorEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static NoEmitOnErrorEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<NoEmitOnErrorEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static NoEmitOnErrorEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<NoEmitOnErrorEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static NoEmitOnErrorEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<NoEmitOnErrorEntity>(json, options);
                }
                ...
                /// </exception>
                public static NoEmitOnErrorEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<NoEmitOnErrorEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out NoEmitOnErrorEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<NoEmitOnErrorEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new NoEmitOnErrorEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static NoEmitOnErrorEntity IJsonElement<NoEmitOnErrorEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"NoEmitOnErrorEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="NoEmitOnErrorEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="NoEmitOnErrorEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public NoEmitOnErrorEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<NoEmitOnErrorEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="NoEmitOnErrorEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public NoEmitOnErrorEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<NoEmitOnErrorEntity>(_idx);
                    }
