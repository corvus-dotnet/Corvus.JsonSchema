        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct NoFallthroughCasesInSwitchEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NoFallthroughCasesInSwitchEntity, Mutable>(NoFallthroughCasesInSwitchEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(NoFallthroughCasesInSwitchEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="NoFallthroughCasesInSwitchEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator NoFallthroughCasesInSwitchEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"NoFallthroughCasesInSwitchEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly NoFallthroughCasesInSwitchEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly NoFallthroughCasesInSwitchEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<NoFallthroughCasesInSwitchEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(NoFallthroughCasesInSwitchEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<NoFallthroughCasesInSwitchEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<NoFallthroughCasesInSwitchEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<NoFallthroughCasesInSwitchEntity>();
                    }
                    finally
                    {
