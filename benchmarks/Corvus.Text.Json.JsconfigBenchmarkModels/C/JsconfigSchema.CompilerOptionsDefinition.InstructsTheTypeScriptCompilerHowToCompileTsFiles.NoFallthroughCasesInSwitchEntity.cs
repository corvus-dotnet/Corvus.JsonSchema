...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct NoFallthroughCasesInSwitchEntity
#if NET8_0_OR_GREATER
                : IJsonElement<NoFallthroughCasesInSwitchEntity>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="NoFallthroughCasesInSwitchEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal NoFallthroughCasesInSwitchEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static NoFallthroughCasesInSwitchEntity DefaultInstance { get; } = ParsedJsonDocument<NoFallthroughCasesInSwitchEntity>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(NoFallthroughCasesInSwitchEntity value)
                {
                ...
                /// </returns>
                public static bool operator ==(in NoFallthroughCasesInSwitchEntity left, in NoFallthroughCasesInSwitchEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in NoFallthroughCasesInSwitchEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(NoFallthroughCasesInSwitchEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator NoFallthroughCasesInSwitchEntity(JsonElement instance)
                {
                    return NoFallthroughCasesInSwitchEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static NoFallthroughCasesInSwitchEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static NoFallthroughCasesInSwitchEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<NoFallthroughCasesInSwitchEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static NoFallthroughCasesInSwitchEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<NoFallthroughCasesInSwitchEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static NoFallthroughCasesInSwitchEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<NoFallthroughCasesInSwitchEntity>(json, options);
                }
                ...
                /// </exception>
                public static NoFallthroughCasesInSwitchEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<NoFallthroughCasesInSwitchEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out NoFallthroughCasesInSwitchEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<NoFallthroughCasesInSwitchEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new NoFallthroughCasesInSwitchEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static NoFallthroughCasesInSwitchEntity IJsonElement<NoFallthroughCasesInSwitchEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"NoFallthroughCasesInSwitchEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="NoFallthroughCasesInSwitchEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="NoFallthroughCasesInSwitchEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public NoFallthroughCasesInSwitchEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<NoFallthroughCasesInSwitchEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="NoFallthroughCasesInSwitchEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public NoFallthroughCasesInSwitchEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<NoFallthroughCasesInSwitchEntity>(_idx);
                    }
