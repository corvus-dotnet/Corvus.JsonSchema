...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct NoImplicitUseStrictEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NoImplicitUseStrictEntity, Mutable>(NoImplicitUseStrictEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(NoImplicitUseStrictEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="NoImplicitUseStrictEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator NoImplicitUseStrictEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new NoImplicitUseStrictEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"NoImplicitUseStrictEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="NoImplicitUseStrictEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="NoImplicitUseStrictEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly NoImplicitUseStrictEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<NoImplicitUseStrictEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="NoImplicitUseStrictEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly NoImplicitUseStrictEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<NoImplicitUseStrictEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(NoImplicitUseStrictEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<NoImplicitUseStrictEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<NoImplicitUseStrictEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<NoImplicitUseStrictEntity>();
                    }
                    finally
                    {
