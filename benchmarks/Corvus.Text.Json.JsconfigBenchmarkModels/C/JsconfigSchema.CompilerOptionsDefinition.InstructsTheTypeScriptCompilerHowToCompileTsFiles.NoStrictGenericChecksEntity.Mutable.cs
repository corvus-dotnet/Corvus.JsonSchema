        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct NoStrictGenericChecksEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NoStrictGenericChecksEntity, Mutable>(NoStrictGenericChecksEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(NoStrictGenericChecksEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="NoStrictGenericChecksEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator NoStrictGenericChecksEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"NoStrictGenericChecksEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly NoStrictGenericChecksEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly NoStrictGenericChecksEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<NoStrictGenericChecksEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(NoStrictGenericChecksEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<NoStrictGenericChecksEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<NoStrictGenericChecksEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<NoStrictGenericChecksEntity>();
                    }
                    finally
                    {
