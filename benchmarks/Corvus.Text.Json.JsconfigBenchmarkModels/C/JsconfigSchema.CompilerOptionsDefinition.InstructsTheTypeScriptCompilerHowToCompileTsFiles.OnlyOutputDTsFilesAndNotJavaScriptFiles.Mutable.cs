...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct OnlyOutputDTsFilesAndNotJavaScriptFiles
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<OnlyOutputDTsFilesAndNotJavaScriptFiles, Mutable>(OnlyOutputDTsFilesAndNotJavaScriptFiles.DefaultInstance);
                    ...
                    public static explicit operator Mutable(OnlyOutputDTsFilesAndNotJavaScriptFiles instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="OnlyOutputDTsFilesAndNotJavaScriptFiles"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator OnlyOutputDTsFilesAndNotJavaScriptFiles(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new OnlyOutputDTsFilesAndNotJavaScriptFiles(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"OnlyOutputDTsFilesAndNotJavaScriptFiles.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="OnlyOutputDTsFilesAndNotJavaScriptFiles"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="OnlyOutputDTsFilesAndNotJavaScriptFiles"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OnlyOutputDTsFilesAndNotJavaScriptFiles Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<OnlyOutputDTsFilesAndNotJavaScriptFiles>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="OnlyOutputDTsFilesAndNotJavaScriptFiles"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OnlyOutputDTsFilesAndNotJavaScriptFiles Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<OnlyOutputDTsFilesAndNotJavaScriptFiles>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(OnlyOutputDTsFilesAndNotJavaScriptFiles instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<OnlyOutputDTsFilesAndNotJavaScriptFiles, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<OnlyOutputDTsFilesAndNotJavaScriptFiles> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<OnlyOutputDTsFilesAndNotJavaScriptFiles>();
                    }
                    finally
                    {
