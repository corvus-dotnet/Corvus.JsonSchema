    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct OnlyOutputDTsFilesAndNotJavaScriptFiles
                ...
                : IJsonElement<OnlyOutputDTsFilesAndNotJavaScriptFiles>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="OnlyOutputDTsFilesAndNotJavaScriptFiles"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal OnlyOutputDTsFilesAndNotJavaScriptFiles(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static OnlyOutputDTsFilesAndNotJavaScriptFiles DefaultInstance { get; } = ParsedJsonDocument<OnlyOutputDTsFilesAndNotJavaScriptFiles>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(OnlyOutputDTsFilesAndNotJavaScriptFiles value)
                {
                ...
                /// </returns>
                public static bool operator ==(in OnlyOutputDTsFilesAndNotJavaScriptFiles left, in OnlyOutputDTsFilesAndNotJavaScriptFiles right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in OnlyOutputDTsFilesAndNotJavaScriptFiles left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(OnlyOutputDTsFilesAndNotJavaScriptFiles instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OnlyOutputDTsFilesAndNotJavaScriptFiles(JsonElement instance)
                {
                    return OnlyOutputDTsFilesAndNotJavaScriptFiles.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static OnlyOutputDTsFilesAndNotJavaScriptFiles From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static OnlyOutputDTsFilesAndNotJavaScriptFiles ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<OnlyOutputDTsFilesAndNotJavaScriptFiles>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static OnlyOutputDTsFilesAndNotJavaScriptFiles ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<OnlyOutputDTsFilesAndNotJavaScriptFiles>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static OnlyOutputDTsFilesAndNotJavaScriptFiles ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<OnlyOutputDTsFilesAndNotJavaScriptFiles>(json, options);
                }
                ...
                /// </exception>
                public static OnlyOutputDTsFilesAndNotJavaScriptFiles ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<OnlyOutputDTsFilesAndNotJavaScriptFiles>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out OnlyOutputDTsFilesAndNotJavaScriptFiles? result)
                {
                    return JsonElementHelpers.TryParseValue<OnlyOutputDTsFilesAndNotJavaScriptFiles>(ref reader, out result);
                }
...
#if NET
                static OnlyOutputDTsFilesAndNotJavaScriptFiles IJsonElement<OnlyOutputDTsFilesAndNotJavaScriptFiles>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OnlyOutputDTsFilesAndNotJavaScriptFiles: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public OnlyOutputDTsFilesAndNotJavaScriptFiles Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public OnlyOutputDTsFilesAndNotJavaScriptFiles Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<OnlyOutputDTsFilesAndNotJavaScriptFiles>(_idx);
                    }
