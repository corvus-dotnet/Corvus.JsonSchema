...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct PreserveSymlinksEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PreserveSymlinksEntity, Mutable>(PreserveSymlinksEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(PreserveSymlinksEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="PreserveSymlinksEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator PreserveSymlinksEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new PreserveSymlinksEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"PreserveSymlinksEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="PreserveSymlinksEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="PreserveSymlinksEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly PreserveSymlinksEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<PreserveSymlinksEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="PreserveSymlinksEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly PreserveSymlinksEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<PreserveSymlinksEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(PreserveSymlinksEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<PreserveSymlinksEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<PreserveSymlinksEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<PreserveSymlinksEntity>();
                    }
                    finally
                    {
