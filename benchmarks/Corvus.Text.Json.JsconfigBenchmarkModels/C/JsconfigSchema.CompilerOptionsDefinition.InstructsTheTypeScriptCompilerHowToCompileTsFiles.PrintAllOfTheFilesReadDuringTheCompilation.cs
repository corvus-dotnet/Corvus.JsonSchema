...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct PrintAllOfTheFilesReadDuringTheCompilation
#if NET8_0_OR_GREATER
                : IJsonElement<PrintAllOfTheFilesReadDuringTheCompilation>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="PrintAllOfTheFilesReadDuringTheCompilation"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal PrintAllOfTheFilesReadDuringTheCompilation(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static PrintAllOfTheFilesReadDuringTheCompilation DefaultInstance { get; } = ParsedJsonDocument<PrintAllOfTheFilesReadDuringTheCompilation>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(PrintAllOfTheFilesReadDuringTheCompilation value)
                {
                ...
                /// </returns>
                public static bool operator ==(in PrintAllOfTheFilesReadDuringTheCompilation left, in PrintAllOfTheFilesReadDuringTheCompilation right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in PrintAllOfTheFilesReadDuringTheCompilation left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(PrintAllOfTheFilesReadDuringTheCompilation instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PrintAllOfTheFilesReadDuringTheCompilation(JsonElement instance)
                {
                    return PrintAllOfTheFilesReadDuringTheCompilation.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static PrintAllOfTheFilesReadDuringTheCompilation From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static PrintAllOfTheFilesReadDuringTheCompilation ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<PrintAllOfTheFilesReadDuringTheCompilation>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static PrintAllOfTheFilesReadDuringTheCompilation ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<PrintAllOfTheFilesReadDuringTheCompilation>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static PrintAllOfTheFilesReadDuringTheCompilation ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<PrintAllOfTheFilesReadDuringTheCompilation>(json, options);
                }
                ...
                /// </exception>
                public static PrintAllOfTheFilesReadDuringTheCompilation ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<PrintAllOfTheFilesReadDuringTheCompilation>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out PrintAllOfTheFilesReadDuringTheCompilation? result)
                {
                    return JsonElementHelpers.TryParseValue<PrintAllOfTheFilesReadDuringTheCompilation>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new PrintAllOfTheFilesReadDuringTheCompilation(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static PrintAllOfTheFilesReadDuringTheCompilation IJsonElement<PrintAllOfTheFilesReadDuringTheCompilation>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PrintAllOfTheFilesReadDuringTheCompilation: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="PrintAllOfTheFilesReadDuringTheCompilation"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="PrintAllOfTheFilesReadDuringTheCompilation"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public PrintAllOfTheFilesReadDuringTheCompilation Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<PrintAllOfTheFilesReadDuringTheCompilation>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="PrintAllOfTheFilesReadDuringTheCompilation"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public PrintAllOfTheFilesReadDuringTheCompilation Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<PrintAllOfTheFilesReadDuringTheCompilation>(_idx);
                    }
