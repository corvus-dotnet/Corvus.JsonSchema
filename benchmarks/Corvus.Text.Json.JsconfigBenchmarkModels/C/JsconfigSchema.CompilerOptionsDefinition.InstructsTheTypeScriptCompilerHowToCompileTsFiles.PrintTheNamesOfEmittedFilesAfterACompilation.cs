...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct PrintTheNamesOfEmittedFilesAfterACompilation
#if NET8_0_OR_GREATER
                : IJsonElement<PrintTheNamesOfEmittedFilesAfterACompilation>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="PrintTheNamesOfEmittedFilesAfterACompilation"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal PrintTheNamesOfEmittedFilesAfterACompilation(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static PrintTheNamesOfEmittedFilesAfterACompilation DefaultInstance { get; } = ParsedJsonDocument<PrintTheNamesOfEmittedFilesAfterACompilation>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(PrintTheNamesOfEmittedFilesAfterACompilation value)
                {
                ...
                /// </returns>
                public static bool operator ==(in PrintTheNamesOfEmittedFilesAfterACompilation left, in PrintTheNamesOfEmittedFilesAfterACompilation right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in PrintTheNamesOfEmittedFilesAfterACompilation left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(PrintTheNamesOfEmittedFilesAfterACompilation instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PrintTheNamesOfEmittedFilesAfterACompilation(JsonElement instance)
                {
                    return PrintTheNamesOfEmittedFilesAfterACompilation.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static PrintTheNamesOfEmittedFilesAfterACompilation From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static PrintTheNamesOfEmittedFilesAfterACompilation ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<PrintTheNamesOfEmittedFilesAfterACompilation>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static PrintTheNamesOfEmittedFilesAfterACompilation ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<PrintTheNamesOfEmittedFilesAfterACompilation>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static PrintTheNamesOfEmittedFilesAfterACompilation ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<PrintTheNamesOfEmittedFilesAfterACompilation>(json, options);
                }
                ...
                /// </exception>
                public static PrintTheNamesOfEmittedFilesAfterACompilation ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<PrintTheNamesOfEmittedFilesAfterACompilation>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out PrintTheNamesOfEmittedFilesAfterACompilation? result)
                {
                    return JsonElementHelpers.TryParseValue<PrintTheNamesOfEmittedFilesAfterACompilation>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new PrintTheNamesOfEmittedFilesAfterACompilation(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static PrintTheNamesOfEmittedFilesAfterACompilation IJsonElement<PrintTheNamesOfEmittedFilesAfterACompilation>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PrintTheNamesOfEmittedFilesAfterACompilation: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="PrintTheNamesOfEmittedFilesAfterACompilation"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="PrintTheNamesOfEmittedFilesAfterACompilation"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public PrintTheNamesOfEmittedFilesAfterACompilation Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<PrintTheNamesOfEmittedFilesAfterACompilation>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="PrintTheNamesOfEmittedFilesAfterACompilation"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public PrintTheNamesOfEmittedFilesAfterACompilation Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<PrintTheNamesOfEmittedFilesAfterACompilation>(_idx);
                    }
