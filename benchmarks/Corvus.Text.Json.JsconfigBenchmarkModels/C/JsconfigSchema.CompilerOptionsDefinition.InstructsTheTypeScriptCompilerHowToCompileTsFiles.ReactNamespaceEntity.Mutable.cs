...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct ReactNamespaceEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ReactNamespaceEntity, Mutable>(ReactNamespaceEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(ReactNamespaceEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ReactNamespaceEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ReactNamespaceEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new ReactNamespaceEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ReactNamespaceEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="ReactNamespaceEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="ReactNamespaceEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ReactNamespaceEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<ReactNamespaceEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="ReactNamespaceEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ReactNamespaceEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ReactNamespaceEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ReactNamespaceEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ReactNamespaceEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ReactNamespaceEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ReactNamespaceEntity>();
                    }
                    finally
                    {
