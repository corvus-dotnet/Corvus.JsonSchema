        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct ResolvePackageJsonExportsEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ResolvePackageJsonExportsEntity, Mutable>(ResolvePackageJsonExportsEntity.DefaultInstance);
                ...
                public static ParsedJsonDocument<ResolvePackageJsonExportsEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ResolvePackageJsonExportsEntity>();
                    }
                    finally
                    {
