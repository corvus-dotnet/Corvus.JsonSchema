        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct SkipDefaultLibCheckEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SkipDefaultLibCheckEntity, Mutable>(SkipDefaultLibCheckEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(SkipDefaultLibCheckEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="SkipDefaultLibCheckEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator SkipDefaultLibCheckEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"SkipDefaultLibCheckEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SkipDefaultLibCheckEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SkipDefaultLibCheckEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<SkipDefaultLibCheckEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(SkipDefaultLibCheckEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<SkipDefaultLibCheckEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<SkipDefaultLibCheckEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<SkipDefaultLibCheckEntity>();
                    }
                    finally
                    {
