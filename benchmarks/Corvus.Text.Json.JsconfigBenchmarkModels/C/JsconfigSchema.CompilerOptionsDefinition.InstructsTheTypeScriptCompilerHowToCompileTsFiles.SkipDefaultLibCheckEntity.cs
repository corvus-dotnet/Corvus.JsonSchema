...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct SkipDefaultLibCheckEntity
#if NET8_0_OR_GREATER
                : IJsonElement<SkipDefaultLibCheckEntity>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="SkipDefaultLibCheckEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal SkipDefaultLibCheckEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static SkipDefaultLibCheckEntity DefaultInstance { get; } = ParsedJsonDocument<SkipDefaultLibCheckEntity>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(SkipDefaultLibCheckEntity value)
                {
                ...
                /// </returns>
                public static bool operator ==(in SkipDefaultLibCheckEntity left, in SkipDefaultLibCheckEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in SkipDefaultLibCheckEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(SkipDefaultLibCheckEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SkipDefaultLibCheckEntity(JsonElement instance)
                {
                    return SkipDefaultLibCheckEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SkipDefaultLibCheckEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SkipDefaultLibCheckEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SkipDefaultLibCheckEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SkipDefaultLibCheckEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SkipDefaultLibCheckEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SkipDefaultLibCheckEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SkipDefaultLibCheckEntity>(json, options);
                }
                ...
                /// </exception>
                public static SkipDefaultLibCheckEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<SkipDefaultLibCheckEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out SkipDefaultLibCheckEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<SkipDefaultLibCheckEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new SkipDefaultLibCheckEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static SkipDefaultLibCheckEntity IJsonElement<SkipDefaultLibCheckEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SkipDefaultLibCheckEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="SkipDefaultLibCheckEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="SkipDefaultLibCheckEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public SkipDefaultLibCheckEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<SkipDefaultLibCheckEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="SkipDefaultLibCheckEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public SkipDefaultLibCheckEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<SkipDefaultLibCheckEntity>(_idx);
                    }
