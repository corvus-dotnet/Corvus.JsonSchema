        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct SkipTypeCheckingAllDTsFiles
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SkipTypeCheckingAllDTsFiles, Mutable>(SkipTypeCheckingAllDTsFiles.DefaultInstance);
                ...
                public static ParsedJsonDocument<SkipTypeCheckingAllDTsFiles> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<SkipTypeCheckingAllDTsFiles>();
                    }
                    finally
                    {
