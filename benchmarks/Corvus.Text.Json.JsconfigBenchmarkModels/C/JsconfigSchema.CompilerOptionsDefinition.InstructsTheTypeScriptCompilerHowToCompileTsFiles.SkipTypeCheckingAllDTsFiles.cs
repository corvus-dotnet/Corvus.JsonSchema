...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct SkipTypeCheckingAllDTsFiles
#if NET8_0_OR_GREATER
                : IJsonElement<SkipTypeCheckingAllDTsFiles>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="SkipTypeCheckingAllDTsFiles"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal SkipTypeCheckingAllDTsFiles(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static SkipTypeCheckingAllDTsFiles DefaultInstance { get; } = ParsedJsonDocument<SkipTypeCheckingAllDTsFiles>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(SkipTypeCheckingAllDTsFiles value)
                {
                ...
                /// </returns>
                public static bool operator ==(in SkipTypeCheckingAllDTsFiles left, in SkipTypeCheckingAllDTsFiles right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in SkipTypeCheckingAllDTsFiles left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(SkipTypeCheckingAllDTsFiles instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SkipTypeCheckingAllDTsFiles(JsonElement instance)
                {
                    return SkipTypeCheckingAllDTsFiles.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SkipTypeCheckingAllDTsFiles From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SkipTypeCheckingAllDTsFiles ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SkipTypeCheckingAllDTsFiles>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SkipTypeCheckingAllDTsFiles ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SkipTypeCheckingAllDTsFiles>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SkipTypeCheckingAllDTsFiles ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SkipTypeCheckingAllDTsFiles>(json, options);
                }
                ...
                /// </exception>
                public static SkipTypeCheckingAllDTsFiles ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<SkipTypeCheckingAllDTsFiles>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out SkipTypeCheckingAllDTsFiles? result)
                {
                    return JsonElementHelpers.TryParseValue<SkipTypeCheckingAllDTsFiles>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new SkipTypeCheckingAllDTsFiles(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static SkipTypeCheckingAllDTsFiles IJsonElement<SkipTypeCheckingAllDTsFiles>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SkipTypeCheckingAllDTsFiles: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="SkipTypeCheckingAllDTsFiles"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="SkipTypeCheckingAllDTsFiles"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public SkipTypeCheckingAllDTsFiles Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<SkipTypeCheckingAllDTsFiles>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="SkipTypeCheckingAllDTsFiles"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public SkipTypeCheckingAllDTsFiles Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<SkipTypeCheckingAllDTsFiles>(_idx);
                    }
