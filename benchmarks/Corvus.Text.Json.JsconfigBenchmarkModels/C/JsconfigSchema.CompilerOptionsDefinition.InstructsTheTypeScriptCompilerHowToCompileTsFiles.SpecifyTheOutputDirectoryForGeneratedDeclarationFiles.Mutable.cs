...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct SpecifyTheOutputDirectoryForGeneratedDeclarationFiles
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(SpecifyTheOutputDirectoryForGeneratedDeclarationFiles instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="SpecifyTheOutputDirectoryForGeneratedDeclarationFiles"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator SpecifyTheOutputDirectoryForGeneratedDeclarationFiles(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new SpecifyTheOutputDirectoryForGeneratedDeclarationFiles(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"SpecifyTheOutputDirectoryForGeneratedDeclarationFiles.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="SpecifyTheOutputDirectoryForGeneratedDeclarationFiles"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="SpecifyTheOutputDirectoryForGeneratedDeclarationFiles"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SpecifyTheOutputDirectoryForGeneratedDeclarationFiles Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<SpecifyTheOutputDirectoryForGeneratedDeclarationFiles>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="SpecifyTheOutputDirectoryForGeneratedDeclarationFiles"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SpecifyTheOutputDirectoryForGeneratedDeclarationFiles Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<SpecifyTheOutputDirectoryForGeneratedDeclarationFiles>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(SpecifyTheOutputDirectoryForGeneratedDeclarationFiles instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<SpecifyTheOutputDirectoryForGeneratedDeclarationFiles, Mutable>(this);
                }
            }
        }
    }
