    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct SpecifyTheOutputDirectoryForGeneratedDeclarationFiles
                ...
                : IJsonElement<SpecifyTheOutputDirectoryForGeneratedDeclarationFiles>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="SpecifyTheOutputDirectoryForGeneratedDeclarationFiles"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal SpecifyTheOutputDirectoryForGeneratedDeclarationFiles(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static SpecifyTheOutputDirectoryForGeneratedDeclarationFiles DefaultInstance { get; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(SpecifyTheOutputDirectoryForGeneratedDeclarationFiles value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in SpecifyTheOutputDirectoryForGeneratedDeclarationFiles left, in SpecifyTheOutputDirectoryForGeneratedDeclarationFiles right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in SpecifyTheOutputDirectoryForGeneratedDeclarationFiles left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(SpecifyTheOutputDirectoryForGeneratedDeclarationFiles instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SpecifyTheOutputDirectoryForGeneratedDeclarationFiles(JsonElement instance)
                {
                    return SpecifyTheOutputDirectoryForGeneratedDeclarationFiles.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SpecifyTheOutputDirectoryForGeneratedDeclarationFiles From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SpecifyTheOutputDirectoryForGeneratedDeclarationFiles ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SpecifyTheOutputDirectoryForGeneratedDeclarationFiles>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SpecifyTheOutputDirectoryForGeneratedDeclarationFiles ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SpecifyTheOutputDirectoryForGeneratedDeclarationFiles>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SpecifyTheOutputDirectoryForGeneratedDeclarationFiles ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SpecifyTheOutputDirectoryForGeneratedDeclarationFiles>(json, options);
                }
                ...
                /// </exception>
                public static SpecifyTheOutputDirectoryForGeneratedDeclarationFiles ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<SpecifyTheOutputDirectoryForGeneratedDeclarationFiles>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out SpecifyTheOutputDirectoryForGeneratedDeclarationFiles? result)
                {
                    return JsonElementHelpers.TryParseValue<SpecifyTheOutputDirectoryForGeneratedDeclarationFiles>(ref reader, out result);
                }
...
#if NET
                static SpecifyTheOutputDirectoryForGeneratedDeclarationFiles IJsonElement<SpecifyTheOutputDirectoryForGeneratedDeclarationFiles>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SpecifyTheOutputDirectoryForGeneratedDeclarationFiles: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public SpecifyTheOutputDirectoryForGeneratedDeclarationFiles Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public SpecifyTheOutputDirectoryForGeneratedDeclarationFiles Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<SpecifyTheOutputDirectoryForGeneratedDeclarationFiles>(_idx);
                    }
