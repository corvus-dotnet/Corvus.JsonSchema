        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct SpecifyWhatModuleCodeIsGenerated
            {
...
#endif
                {
                    ...
                    /// <param name="matchCommonJs">Match 1st item.</param>
                    /// <param name="matchAmd">Match 2nd item.</param>
                    /// <param name="matchSystem">Match 3rd item.</param>
                    /// <param name="matchUmd">Match 4th item.</param>
                    /// <param name="matchEs6">Match 5th item.</param>
                    /// <param name="matchEs2015">Match 6th item.</param>
                    /// <param name="matchEs2020">Match 7th item.</param>
                    /// <param name="matchEsNext">Match 8th item.</param>
                    /// <param name="matchNone">Match 9th item.</param>
                    /// <param name="matchEs2022">Match 10th item.</param>
                    /// <param name="matchNode16">Match 11th item.</param>
                    /// <param name="matchNodeNext">Match 12th item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchCommonJs,
                        Func<TContext, TResult> matchAmd,
                        Func<TContext, TResult> matchSystem,
                        Func<TContext, TResult> matchUmd,
                        ...
                        Func<TContext, TResult> matchNode16,
                        Func<TContext, TResult> matchNodeNext,
...
#endif
                    {
                        ...
                        {
                            return matchCommonJs(context);
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchAmd(context);
                        }
                        ...
                        {
                            return matchNode16(context);
                        }

                        if (this.ValueEquals(Constants.Enum12))
                        {
                            return matchNodeNext(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> matchCommonJs,
                        Func<TResult> matchAmd,
                        Func<TResult> matchSystem,
                        Func<TResult> matchUmd,
                        ...
                        Func<TResult> matchNode16,
                        Func<TResult> matchNodeNext,
                        Func<TResult> defaultMatch)
                    {
                        if (this.ValueEquals(Constants.Enum1))
                        {
                            return matchCommonJs();
                        }
