...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct SuppressExcessPropertyErrorsEntity
#if NET8_0_OR_GREATER
                : IJsonElement<SuppressExcessPropertyErrorsEntity>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="SuppressExcessPropertyErrorsEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal SuppressExcessPropertyErrorsEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static SuppressExcessPropertyErrorsEntity DefaultInstance { get; } = ParsedJsonDocument<SuppressExcessPropertyErrorsEntity>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(SuppressExcessPropertyErrorsEntity value)
                {
                ...
                /// </returns>
                public static bool operator ==(in SuppressExcessPropertyErrorsEntity left, in SuppressExcessPropertyErrorsEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in SuppressExcessPropertyErrorsEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(SuppressExcessPropertyErrorsEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SuppressExcessPropertyErrorsEntity(JsonElement instance)
                {
                    return SuppressExcessPropertyErrorsEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SuppressExcessPropertyErrorsEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SuppressExcessPropertyErrorsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SuppressExcessPropertyErrorsEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SuppressExcessPropertyErrorsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SuppressExcessPropertyErrorsEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SuppressExcessPropertyErrorsEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SuppressExcessPropertyErrorsEntity>(json, options);
                }
                ...
                /// </exception>
                public static SuppressExcessPropertyErrorsEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<SuppressExcessPropertyErrorsEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out SuppressExcessPropertyErrorsEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<SuppressExcessPropertyErrorsEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new SuppressExcessPropertyErrorsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static SuppressExcessPropertyErrorsEntity IJsonElement<SuppressExcessPropertyErrorsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SuppressExcessPropertyErrorsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="SuppressExcessPropertyErrorsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="SuppressExcessPropertyErrorsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public SuppressExcessPropertyErrorsEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<SuppressExcessPropertyErrorsEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="SuppressExcessPropertyErrorsEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public SuppressExcessPropertyErrorsEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<SuppressExcessPropertyErrorsEntity>(_idx);
                    }
