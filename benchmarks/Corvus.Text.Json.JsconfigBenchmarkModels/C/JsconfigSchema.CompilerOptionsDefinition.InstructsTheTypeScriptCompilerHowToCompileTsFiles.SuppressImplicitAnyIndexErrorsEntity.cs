    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="SuppressImplicitAnyIndexErrorsEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal SuppressImplicitAnyIndexErrorsEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static SuppressImplicitAnyIndexErrorsEntity DefaultInstance { get; } = ParsedJsonDocument<SuppressImplicitAnyIndexErrorsEntity>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(SuppressImplicitAnyIndexErrorsEntity value)
                {
                ...
                /// </returns>
                public static bool operator ==(in SuppressImplicitAnyIndexErrorsEntity left, in SuppressImplicitAnyIndexErrorsEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in SuppressImplicitAnyIndexErrorsEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(SuppressImplicitAnyIndexErrorsEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SuppressImplicitAnyIndexErrorsEntity(JsonElement instance)
                {
                    return SuppressImplicitAnyIndexErrorsEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SuppressImplicitAnyIndexErrorsEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SuppressImplicitAnyIndexErrorsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SuppressImplicitAnyIndexErrorsEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SuppressImplicitAnyIndexErrorsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SuppressImplicitAnyIndexErrorsEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SuppressImplicitAnyIndexErrorsEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SuppressImplicitAnyIndexErrorsEntity>(json, options);
                }
                ...
                /// </exception>
                public static SuppressImplicitAnyIndexErrorsEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<SuppressImplicitAnyIndexErrorsEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out SuppressImplicitAnyIndexErrorsEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<SuppressImplicitAnyIndexErrorsEntity>(ref reader, out result);
                }
...
#if NET
                static SuppressImplicitAnyIndexErrorsEntity IJsonElement<SuppressImplicitAnyIndexErrorsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SuppressImplicitAnyIndexErrorsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public SuppressImplicitAnyIndexErrorsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public SuppressImplicitAnyIndexErrorsEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<SuppressImplicitAnyIndexErrorsEntity>(_idx);
                    }
