        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct TraceResolutionEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TraceResolutionEntity, Mutable>(TraceResolutionEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(TraceResolutionEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="TraceResolutionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TraceResolutionEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TraceResolutionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TraceResolutionEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TraceResolutionEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<TraceResolutionEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(TraceResolutionEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<TraceResolutionEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<TraceResolutionEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<TraceResolutionEntity>();
                    }
                    finally
                    {
