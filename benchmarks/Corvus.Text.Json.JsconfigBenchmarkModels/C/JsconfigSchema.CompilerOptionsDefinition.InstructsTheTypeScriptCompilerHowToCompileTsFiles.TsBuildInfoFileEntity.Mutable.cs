        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct TsBuildInfoFileEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TsBuildInfoFileEntity, Mutable>(TsBuildInfoFileEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(TsBuildInfoFileEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="TsBuildInfoFileEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TsBuildInfoFileEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TsBuildInfoFileEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TsBuildInfoFileEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TsBuildInfoFileEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<TsBuildInfoFileEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(TsBuildInfoFileEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<TsBuildInfoFileEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<TsBuildInfoFileEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<TsBuildInfoFileEntity>();
                    }
                    finally
                    {
