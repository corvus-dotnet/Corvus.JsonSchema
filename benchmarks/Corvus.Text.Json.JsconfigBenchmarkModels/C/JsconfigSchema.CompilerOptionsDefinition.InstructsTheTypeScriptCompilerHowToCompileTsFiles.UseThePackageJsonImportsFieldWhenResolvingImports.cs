...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct UseThePackageJsonImportsFieldWhenResolvingImports
#if NET8_0_OR_GREATER
                : IJsonElement<UseThePackageJsonImportsFieldWhenResolvingImports>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="UseThePackageJsonImportsFieldWhenResolvingImports"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal UseThePackageJsonImportsFieldWhenResolvingImports(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static UseThePackageJsonImportsFieldWhenResolvingImports DefaultInstance { get; } = ParsedJsonDocument<UseThePackageJsonImportsFieldWhenResolvingImports>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(UseThePackageJsonImportsFieldWhenResolvingImports value)
                {
                ...
                /// </returns>
                public static bool operator ==(in UseThePackageJsonImportsFieldWhenResolvingImports left, in UseThePackageJsonImportsFieldWhenResolvingImports right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in UseThePackageJsonImportsFieldWhenResolvingImports left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(UseThePackageJsonImportsFieldWhenResolvingImports instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator UseThePackageJsonImportsFieldWhenResolvingImports(JsonElement instance)
                {
                    return UseThePackageJsonImportsFieldWhenResolvingImports.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static UseThePackageJsonImportsFieldWhenResolvingImports From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static UseThePackageJsonImportsFieldWhenResolvingImports ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<UseThePackageJsonImportsFieldWhenResolvingImports>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static UseThePackageJsonImportsFieldWhenResolvingImports ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<UseThePackageJsonImportsFieldWhenResolvingImports>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static UseThePackageJsonImportsFieldWhenResolvingImports ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<UseThePackageJsonImportsFieldWhenResolvingImports>(json, options);
                }
                ...
                /// </exception>
                public static UseThePackageJsonImportsFieldWhenResolvingImports ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<UseThePackageJsonImportsFieldWhenResolvingImports>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out UseThePackageJsonImportsFieldWhenResolvingImports? result)
                {
                    return JsonElementHelpers.TryParseValue<UseThePackageJsonImportsFieldWhenResolvingImports>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new UseThePackageJsonImportsFieldWhenResolvingImports(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static UseThePackageJsonImportsFieldWhenResolvingImports IJsonElement<UseThePackageJsonImportsFieldWhenResolvingImports>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"UseThePackageJsonImportsFieldWhenResolvingImports: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="UseThePackageJsonImportsFieldWhenResolvingImports"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="UseThePackageJsonImportsFieldWhenResolvingImports"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public UseThePackageJsonImportsFieldWhenResolvingImports Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<UseThePackageJsonImportsFieldWhenResolvingImports>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="UseThePackageJsonImportsFieldWhenResolvingImports"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public UseThePackageJsonImportsFieldWhenResolvingImports Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<UseThePackageJsonImportsFieldWhenResolvingImports>(_idx);
                    }
