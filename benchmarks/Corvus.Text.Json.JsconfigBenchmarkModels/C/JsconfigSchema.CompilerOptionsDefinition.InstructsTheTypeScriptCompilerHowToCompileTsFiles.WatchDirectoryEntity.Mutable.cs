        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct WatchDirectoryEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<WatchDirectoryEntity, Mutable>(WatchDirectoryEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(WatchDirectoryEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="WatchDirectoryEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator WatchDirectoryEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new WatchDirectoryEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"WatchDirectoryEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="WatchDirectoryEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="WatchDirectoryEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly WatchDirectoryEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<WatchDirectoryEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="WatchDirectoryEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly WatchDirectoryEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<WatchDirectoryEntity>(_idx);
                    }
                    ...
                    /// <param name="matchUseFsEvents">Match 1st item.</param>
                    /// <param name="matchFixedPollingInterval">Match 2nd item.</param>
                    /// <param name="matchDynamicPriorityPolling">Match 3rd item.</param>
                    /// <param name="matchFixedChunkSizePolling">Match 4th item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchUseFsEvents,
                        Func<TContext, TResult> matchFixedPollingInterval,
                        Func<TContext, TResult> matchDynamicPriorityPolling,
                        Func<TContext, TResult> matchFixedChunkSizePolling,
...
#endif
                    {
                        ...
                        {
                            return matchUseFsEvents(context);
                        }
                        ...
                        {
                            return matchFixedChunkSizePolling(context);
                        }
                        ...
                        Func<TResult> defaultMatch)
                    {
                        ...
                        if (this.ValueEquals(Constants.Enum4))
                        {
                            return matchFixedChunkSizePolling();
                        }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(WatchDirectoryEntity instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (WatchDirectoryEntity)value;
                ...
                {
                    return workspace.CreateBuilder<WatchDirectoryEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<WatchDirectoryEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<WatchDirectoryEntity>();
                    }
                    finally
                    {
