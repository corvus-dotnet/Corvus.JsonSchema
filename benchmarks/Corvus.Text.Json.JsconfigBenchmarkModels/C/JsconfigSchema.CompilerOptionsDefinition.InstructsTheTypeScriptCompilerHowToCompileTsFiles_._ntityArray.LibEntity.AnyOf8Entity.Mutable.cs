                ...
                public readonly partial struct LibEntity
                {
                    ...
                    public readonly partial struct AnyOf8Entity
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Mutable(AnyOf8Entity instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="AnyOf8Entity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator AnyOf8Entity(Mutable instance)
                            {
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"AnyOf8Entity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly AnyOf8Entity Clone()
                            {
                                CheckValidInstance();
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly AnyOf8Entity Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<AnyOf8Entity>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            public static implicit operator Source(AnyOf8Entity instance) => new(JsonElement.From(instance));
                        ...
                        {
                            return workspace.CreateBuilder<AnyOf8Entity, Mutable>(this);
                        }
                        ...
                        public static ParsedJsonDocument<AnyOf8Entity> Create(
                            scoped in Source value, int initialCapacity = 1)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<AnyOf8Entity>();
                            }
                            finally
                            {
