        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct LibEntityArray
            {
                ...
                public readonly partial struct LibEntity
                {
                    ...
                    public readonly partial struct AnyOf5Entity
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Mutable(AnyOf5Entity instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="AnyOf5Entity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator AnyOf5Entity(Mutable instance)
                            {
                            ...
                            {
                                return
                                    (obj is IJsonElement value && Equals(new AnyOf5Entity(value.ParentDocument, value.ParentDocumentIndex))) ||
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"AnyOf5Entity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// <summary>
                            /// Gets a <see cref="AnyOf5Entity"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </summary>
                            /// <returns>
                            /// A <see cref="AnyOf5Entity"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </returns>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly AnyOf5Entity Clone()
                            {
                                CheckValidInstance();
                                return _parent.CloneElement<AnyOf5Entity>(_idx);
                            }
                            ...
                            /// </summary>
                            /// <returns>
                            /// An immutable <see cref="AnyOf5Entity"/> that lives for the lifetime of its
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly AnyOf5Entity Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<AnyOf5Entity>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            public static implicit operator Source(AnyOf5Entity instance) => new(JsonElement.From(instance));
                        ...
                        {
                            return workspace.CreateBuilder<AnyOf5Entity, Mutable>(this);
                        }
                        ...
                        public static ParsedJsonDocument<AnyOf5Entity> Create(
                            scoped in Source value, int initialCapacity = 1)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<AnyOf5Entity>();
                            }
                            finally
                            {
