        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct LibEntityArray
            {
                ...
                public readonly partial struct LibEntity
                {
                    ...
                    public readonly partial struct AnyOf6Entity
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Mutable(AnyOf6Entity instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="AnyOf6Entity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator AnyOf6Entity(Mutable instance)
                            {
                            ...
                            {
                                return
                                    (obj is IJsonElement value && Equals(new AnyOf6Entity(value.ParentDocument, value.ParentDocumentIndex))) ||
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"AnyOf6Entity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// <summary>
                            /// Gets a <see cref="AnyOf6Entity"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </summary>
                            /// <returns>
                            /// A <see cref="AnyOf6Entity"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </returns>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly AnyOf6Entity Clone()
                            {
                                CheckValidInstance();
                                return _parent.CloneElement<AnyOf6Entity>(_idx);
                            }
                            ...
                            /// </summary>
                            /// <returns>
                            /// An immutable <see cref="AnyOf6Entity"/> that lives for the lifetime of its
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly AnyOf6Entity Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<AnyOf6Entity>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            public static implicit operator Source(AnyOf6Entity instance) => new(JsonElement.From(instance));
                        ...
                        {
                            return workspace.CreateBuilder<AnyOf6Entity, Mutable>(this);
                        }
                        ...
                        public static ParsedJsonDocument<AnyOf6Entity> Create(
                            scoped in Source value, int initialCapacity = 1)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<AnyOf6Entity>();
                            }
                            finally
                            {
