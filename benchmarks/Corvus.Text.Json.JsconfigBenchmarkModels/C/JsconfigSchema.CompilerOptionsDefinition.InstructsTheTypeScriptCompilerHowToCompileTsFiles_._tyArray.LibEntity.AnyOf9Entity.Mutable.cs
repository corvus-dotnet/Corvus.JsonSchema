                ...
                public readonly partial struct LibEntity
                {
                    ...
                    public readonly partial struct AnyOf9Entity
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Mutable(AnyOf9Entity instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="AnyOf9Entity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator AnyOf9Entity(Mutable instance)
                            {
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"AnyOf9Entity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly AnyOf9Entity Clone()
                            {
                                CheckValidInstance();
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly AnyOf9Entity Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<AnyOf9Entity>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            public static implicit operator Source(AnyOf9Entity instance) => new(JsonElement.From(instance));
                        ...
                        {
                            return workspace.CreateBuilder<AnyOf9Entity, Mutable>(this);
                        }
                        ...
                        public static ParsedJsonDocument<AnyOf9Entity> Create(
                            scoped in Source value, int initialCapacity = 1)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<AnyOf9Entity>();
                            }
                            finally
                            {
