            ...
            public readonly partial struct ModuleResolutionEntity
            {
                ...
                public readonly partial struct AnyOf0Entity
                {
...
#endif
                    {
                        ...
                        /// <param name="matchClassic">Match 1st item.</param>
                        /// <param name="matchNode">Match 2nd item.</param>
                        /// <param name="matchNode16">Match 3rd item.</param>
                        /// <param name="matchNodenext">Match 4th item.</param>
                        /// <param name="matchBundler">Match 5th item.</param>
                        /// <param name="defaultMatch">Match any other value.</param>
                        /// <returns>An instance of the value returned by the match function.</returns>
                        public TResult Match<TContext, TResult>(
                            in TContext context,
                            Func<TContext, TResult> matchClassic,
                            Func<TContext, TResult> matchNode,
                            Func<TContext, TResult> matchNode16,
                            Func<TContext, TResult> matchNodenext,
                            Func<TContext, TResult> matchBundler,
