    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct EnableErrorReportingInTypeCheckedJavaScriptFiles
            {
                ...
                public static ParsedJsonDocument<EnableErrorReportingInTypeCheckedJavaScriptFiles> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<EnableErrorReportingInTypeCheckedJavaScriptFiles>();
                    }
                    finally
                    {
