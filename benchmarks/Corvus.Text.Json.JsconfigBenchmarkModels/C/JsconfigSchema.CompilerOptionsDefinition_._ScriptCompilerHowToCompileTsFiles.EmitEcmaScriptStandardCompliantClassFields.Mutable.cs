        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct EmitEcmaScriptStandardCompliantClassFields
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EmitEcmaScriptStandardCompliantClassFields, Mutable>(EmitEcmaScriptStandardCompliantClassFields.DefaultInstance);
                    ...
                    public static explicit operator Mutable(EmitEcmaScriptStandardCompliantClassFields instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="EmitEcmaScriptStandardCompliantClassFields"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator EmitEcmaScriptStandardCompliantClassFields(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"EmitEcmaScriptStandardCompliantClassFields.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EmitEcmaScriptStandardCompliantClassFields Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EmitEcmaScriptStandardCompliantClassFields Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<EmitEcmaScriptStandardCompliantClassFields>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(EmitEcmaScriptStandardCompliantClassFields instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<EmitEcmaScriptStandardCompliantClassFields, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<EmitEcmaScriptStandardCompliantClassFields> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<EmitEcmaScriptStandardCompliantClassFields>();
                    }
                    finally
                    {
