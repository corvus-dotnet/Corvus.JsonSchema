        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct PrintAllOfTheFilesReadDuringTheCompilation
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PrintAllOfTheFilesReadDuringTheCompilation, Mutable>(PrintAllOfTheFilesReadDuringTheCompilation.DefaultInstance);
                    ...
                    public static explicit operator Mutable(PrintAllOfTheFilesReadDuringTheCompilation instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="PrintAllOfTheFilesReadDuringTheCompilation"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator PrintAllOfTheFilesReadDuringTheCompilation(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"PrintAllOfTheFilesReadDuringTheCompilation.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly PrintAllOfTheFilesReadDuringTheCompilation Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly PrintAllOfTheFilesReadDuringTheCompilation Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<PrintAllOfTheFilesReadDuringTheCompilation>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(PrintAllOfTheFilesReadDuringTheCompilation instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<PrintAllOfTheFilesReadDuringTheCompilation, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<PrintAllOfTheFilesReadDuringTheCompilation> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<PrintAllOfTheFilesReadDuringTheCompilation>();
                    }
                    finally
                    {
