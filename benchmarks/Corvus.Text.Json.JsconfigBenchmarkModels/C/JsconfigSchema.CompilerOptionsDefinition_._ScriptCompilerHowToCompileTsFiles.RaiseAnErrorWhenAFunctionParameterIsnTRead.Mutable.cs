        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct RaiseAnErrorWhenAFunctionParameterIsnTRead
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<RaiseAnErrorWhenAFunctionParameterIsnTRead, Mutable>(RaiseAnErrorWhenAFunctionParameterIsnTRead.DefaultInstance);
                ...
                public static ParsedJsonDocument<RaiseAnErrorWhenAFunctionParameterIsnTRead> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RaiseAnErrorWhenAFunctionParameterIsnTRead>();
                    }
                    finally
                    {
