        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct UseThePackageJsonImportsFieldWhenResolvingImports
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<UseThePackageJsonImportsFieldWhenResolvingImports, Mutable>(UseThePackageJsonImportsFieldWhenResolvingImports.DefaultInstance);
                    ...
                    public static explicit operator Mutable(UseThePackageJsonImportsFieldWhenResolvingImports instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="UseThePackageJsonImportsFieldWhenResolvingImports"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator UseThePackageJsonImportsFieldWhenResolvingImports(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"UseThePackageJsonImportsFieldWhenResolvingImports.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly UseThePackageJsonImportsFieldWhenResolvingImports Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly UseThePackageJsonImportsFieldWhenResolvingImports Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<UseThePackageJsonImportsFieldWhenResolvingImports>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(UseThePackageJsonImportsFieldWhenResolvingImports instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<UseThePackageJsonImportsFieldWhenResolvingImports, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<UseThePackageJsonImportsFieldWhenResolvingImports> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<UseThePackageJsonImportsFieldWhenResolvingImports>();
                    }
                    finally
                    {
