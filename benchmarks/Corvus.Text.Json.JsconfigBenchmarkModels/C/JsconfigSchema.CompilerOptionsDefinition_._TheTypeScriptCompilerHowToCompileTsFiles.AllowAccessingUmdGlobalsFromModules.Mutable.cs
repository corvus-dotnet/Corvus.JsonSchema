...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct AllowAccessingUmdGlobalsFromModules
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AllowAccessingUmdGlobalsFromModules, Mutable>(AllowAccessingUmdGlobalsFromModules.DefaultInstance);
                    ...
                    public static explicit operator Mutable(AllowAccessingUmdGlobalsFromModules instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="AllowAccessingUmdGlobalsFromModules"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AllowAccessingUmdGlobalsFromModules(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new AllowAccessingUmdGlobalsFromModules(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AllowAccessingUmdGlobalsFromModules.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="AllowAccessingUmdGlobalsFromModules"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="AllowAccessingUmdGlobalsFromModules"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AllowAccessingUmdGlobalsFromModules Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<AllowAccessingUmdGlobalsFromModules>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="AllowAccessingUmdGlobalsFromModules"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AllowAccessingUmdGlobalsFromModules Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<AllowAccessingUmdGlobalsFromModules>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(AllowAccessingUmdGlobalsFromModules instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<AllowAccessingUmdGlobalsFromModules, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<AllowAccessingUmdGlobalsFromModules> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<AllowAccessingUmdGlobalsFromModules>();
                    }
                    finally
                    {
