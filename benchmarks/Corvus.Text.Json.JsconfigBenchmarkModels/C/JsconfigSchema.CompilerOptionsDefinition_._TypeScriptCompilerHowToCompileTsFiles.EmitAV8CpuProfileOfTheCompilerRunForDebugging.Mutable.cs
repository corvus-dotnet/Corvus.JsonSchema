        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct EmitAV8CpuProfileOfTheCompilerRunForDebugging
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EmitAV8CpuProfileOfTheCompilerRunForDebugging, Mutable>(EmitAV8CpuProfileOfTheCompilerRunForDebugging.DefaultInstance);
                    ...
                    public static explicit operator Mutable(EmitAV8CpuProfileOfTheCompilerRunForDebugging instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="EmitAV8CpuProfileOfTheCompilerRunForDebugging"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator EmitAV8CpuProfileOfTheCompilerRunForDebugging(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"EmitAV8CpuProfileOfTheCompilerRunForDebugging.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EmitAV8CpuProfileOfTheCompilerRunForDebugging Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EmitAV8CpuProfileOfTheCompilerRunForDebugging Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<EmitAV8CpuProfileOfTheCompilerRunForDebugging>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(EmitAV8CpuProfileOfTheCompilerRunForDebugging instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<EmitAV8CpuProfileOfTheCompilerRunForDebugging, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<EmitAV8CpuProfileOfTheCompilerRunForDebugging> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<EmitAV8CpuProfileOfTheCompilerRunForDebugging>();
                    }
                    finally
                    {
