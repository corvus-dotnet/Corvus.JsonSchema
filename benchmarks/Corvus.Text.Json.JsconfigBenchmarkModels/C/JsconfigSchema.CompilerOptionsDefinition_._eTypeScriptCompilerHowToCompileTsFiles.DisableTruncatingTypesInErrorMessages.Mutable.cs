        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct DisableTruncatingTypesInErrorMessages
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableTruncatingTypesInErrorMessages, Mutable>(DisableTruncatingTypesInErrorMessages.DefaultInstance);
                    ...
                    public static explicit operator Mutable(DisableTruncatingTypesInErrorMessages instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DisableTruncatingTypesInErrorMessages"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DisableTruncatingTypesInErrorMessages(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DisableTruncatingTypesInErrorMessages.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DisableTruncatingTypesInErrorMessages Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DisableTruncatingTypesInErrorMessages Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DisableTruncatingTypesInErrorMessages>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DisableTruncatingTypesInErrorMessages instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<DisableTruncatingTypesInErrorMessages, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<DisableTruncatingTypesInErrorMessages> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DisableTruncatingTypesInErrorMessages>();
                    }
                    finally
                    {
