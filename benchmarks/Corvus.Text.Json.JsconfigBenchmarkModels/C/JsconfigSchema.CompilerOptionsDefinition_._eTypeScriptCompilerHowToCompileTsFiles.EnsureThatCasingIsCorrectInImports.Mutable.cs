        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct EnsureThatCasingIsCorrectInImports
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnsureThatCasingIsCorrectInImports, Mutable>(EnsureThatCasingIsCorrectInImports.DefaultInstance);
                    ...
                    public static explicit operator Mutable(EnsureThatCasingIsCorrectInImports instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="EnsureThatCasingIsCorrectInImports"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator EnsureThatCasingIsCorrectInImports(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"EnsureThatCasingIsCorrectInImports.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EnsureThatCasingIsCorrectInImports Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EnsureThatCasingIsCorrectInImports Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<EnsureThatCasingIsCorrectInImports>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(EnsureThatCasingIsCorrectInImports instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<EnsureThatCasingIsCorrectInImports, Mutable>(this);
                }
            }
        }
    }
