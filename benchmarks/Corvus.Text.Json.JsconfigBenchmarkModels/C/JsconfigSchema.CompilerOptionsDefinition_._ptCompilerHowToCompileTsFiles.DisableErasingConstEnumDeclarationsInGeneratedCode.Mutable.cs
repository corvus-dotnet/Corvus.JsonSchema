        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct DisableErasingConstEnumDeclarationsInGeneratedCode
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableErasingConstEnumDeclarationsInGeneratedCode, Mutable>(DisableErasingConstEnumDeclarationsInGeneratedCode.DefaultInstance);
                    ...
                    public static explicit operator Mutable(DisableErasingConstEnumDeclarationsInGeneratedCode instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DisableErasingConstEnumDeclarationsInGeneratedCode"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DisableErasingConstEnumDeclarationsInGeneratedCode(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DisableErasingConstEnumDeclarationsInGeneratedCode.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DisableErasingConstEnumDeclarationsInGeneratedCode Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DisableErasingConstEnumDeclarationsInGeneratedCode Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DisableErasingConstEnumDeclarationsInGeneratedCode>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DisableErasingConstEnumDeclarationsInGeneratedCode instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<DisableErasingConstEnumDeclarationsInGeneratedCode, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<DisableErasingConstEnumDeclarationsInGeneratedCode> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DisableErasingConstEnumDeclarationsInGeneratedCode>();
                    }
                    finally
                    {
