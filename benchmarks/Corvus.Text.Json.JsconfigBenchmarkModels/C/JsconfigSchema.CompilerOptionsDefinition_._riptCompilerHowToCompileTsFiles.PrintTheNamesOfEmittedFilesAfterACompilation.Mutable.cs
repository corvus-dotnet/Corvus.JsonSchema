        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct PrintTheNamesOfEmittedFilesAfterACompilation
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PrintTheNamesOfEmittedFilesAfterACompilation, Mutable>(PrintTheNamesOfEmittedFilesAfterACompilation.DefaultInstance);
                    ...
                    public static explicit operator Mutable(PrintTheNamesOfEmittedFilesAfterACompilation instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="PrintTheNamesOfEmittedFilesAfterACompilation"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator PrintTheNamesOfEmittedFilesAfterACompilation(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"PrintTheNamesOfEmittedFilesAfterACompilation.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly PrintTheNamesOfEmittedFilesAfterACompilation Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly PrintTheNamesOfEmittedFilesAfterACompilation Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<PrintTheNamesOfEmittedFilesAfterACompilation>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(PrintTheNamesOfEmittedFilesAfterACompilation instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<PrintTheNamesOfEmittedFilesAfterACompilation, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<PrintTheNamesOfEmittedFilesAfterACompilation> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<PrintTheNamesOfEmittedFilesAfterACompilation>();
                    }
                    finally
                    {
