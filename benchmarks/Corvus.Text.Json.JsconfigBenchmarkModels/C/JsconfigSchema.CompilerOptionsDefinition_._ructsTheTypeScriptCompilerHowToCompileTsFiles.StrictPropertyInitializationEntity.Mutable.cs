        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct StrictPropertyInitializationEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<StrictPropertyInitializationEntity, Mutable>(StrictPropertyInitializationEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(StrictPropertyInitializationEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="StrictPropertyInitializationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator StrictPropertyInitializationEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"StrictPropertyInitializationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly StrictPropertyInitializationEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly StrictPropertyInitializationEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<StrictPropertyInitializationEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(StrictPropertyInitializationEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<StrictPropertyInitializationEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<StrictPropertyInitializationEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<StrictPropertyInitializationEntity>();
                    }
                    finally
                    {
