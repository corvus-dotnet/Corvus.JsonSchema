        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct EnableAllStrictTypeCheckingOptions
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnableAllStrictTypeCheckingOptions, Mutable>(EnableAllStrictTypeCheckingOptions.DefaultInstance);
                    ...
                    public static explicit operator Mutable(EnableAllStrictTypeCheckingOptions instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="EnableAllStrictTypeCheckingOptions"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator EnableAllStrictTypeCheckingOptions(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"EnableAllStrictTypeCheckingOptions.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EnableAllStrictTypeCheckingOptions Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EnableAllStrictTypeCheckingOptions Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<EnableAllStrictTypeCheckingOptions>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(EnableAllStrictTypeCheckingOptions instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<EnableAllStrictTypeCheckingOptions, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<EnableAllStrictTypeCheckingOptions> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<EnableAllStrictTypeCheckingOptions>();
                    }
                    finally
                    {
