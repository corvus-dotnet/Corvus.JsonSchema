        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct IncludeSourcemapFilesInsideTheEmittedJavaScript
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<IncludeSourcemapFilesInsideTheEmittedJavaScript, Mutable>(IncludeSourcemapFilesInsideTheEmittedJavaScript.DefaultInstance);
                    ...
                    public static explicit operator Mutable(IncludeSourcemapFilesInsideTheEmittedJavaScript instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="IncludeSourcemapFilesInsideTheEmittedJavaScript"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator IncludeSourcemapFilesInsideTheEmittedJavaScript(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"IncludeSourcemapFilesInsideTheEmittedJavaScript.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IncludeSourcemapFilesInsideTheEmittedJavaScript Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IncludeSourcemapFilesInsideTheEmittedJavaScript Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<IncludeSourcemapFilesInsideTheEmittedJavaScript>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(IncludeSourcemapFilesInsideTheEmittedJavaScript instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<IncludeSourcemapFilesInsideTheEmittedJavaScript, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<IncludeSourcemapFilesInsideTheEmittedJavaScript> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<IncludeSourcemapFilesInsideTheEmittedJavaScript>();
                    }
                    finally
                    {
