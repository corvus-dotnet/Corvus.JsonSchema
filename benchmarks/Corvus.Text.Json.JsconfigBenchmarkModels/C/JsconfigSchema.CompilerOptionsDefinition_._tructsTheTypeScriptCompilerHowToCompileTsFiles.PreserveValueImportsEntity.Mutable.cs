...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct PreserveValueImportsEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PreserveValueImportsEntity, Mutable>(PreserveValueImportsEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(PreserveValueImportsEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="PreserveValueImportsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator PreserveValueImportsEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new PreserveValueImportsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"PreserveValueImportsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="PreserveValueImportsEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="PreserveValueImportsEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly PreserveValueImportsEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<PreserveValueImportsEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="PreserveValueImportsEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly PreserveValueImportsEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<PreserveValueImportsEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(PreserveValueImportsEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<PreserveValueImportsEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<PreserveValueImportsEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<PreserveValueImportsEntity>();
                    }
                    finally
                    {
