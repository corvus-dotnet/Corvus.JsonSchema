...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct CompilerOptionsDefinition
    {
        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct SuppressImplicitAnyIndexErrorsEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SuppressImplicitAnyIndexErrorsEntity, Mutable>(SuppressImplicitAnyIndexErrorsEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(SuppressImplicitAnyIndexErrorsEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="SuppressImplicitAnyIndexErrorsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator SuppressImplicitAnyIndexErrorsEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new SuppressImplicitAnyIndexErrorsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"SuppressImplicitAnyIndexErrorsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="SuppressImplicitAnyIndexErrorsEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="SuppressImplicitAnyIndexErrorsEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SuppressImplicitAnyIndexErrorsEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<SuppressImplicitAnyIndexErrorsEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="SuppressImplicitAnyIndexErrorsEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SuppressImplicitAnyIndexErrorsEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<SuppressImplicitAnyIndexErrorsEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(SuppressImplicitAnyIndexErrorsEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<SuppressImplicitAnyIndexErrorsEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<SuppressImplicitAnyIndexErrorsEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<SuppressImplicitAnyIndexErrorsEntity>();
                    }
                    finally
                    {
