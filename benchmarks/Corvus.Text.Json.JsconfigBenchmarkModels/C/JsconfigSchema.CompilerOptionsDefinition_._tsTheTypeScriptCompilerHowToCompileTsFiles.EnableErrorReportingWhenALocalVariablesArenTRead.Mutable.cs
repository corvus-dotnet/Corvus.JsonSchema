        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct EnableErrorReportingWhenALocalVariablesArenTRead
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnableErrorReportingWhenALocalVariablesArenTRead, Mutable>(EnableErrorReportingWhenALocalVariablesArenTRead.DefaultInstance);
                    ...
                    public static explicit operator Mutable(EnableErrorReportingWhenALocalVariablesArenTRead instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="EnableErrorReportingWhenALocalVariablesArenTRead"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator EnableErrorReportingWhenALocalVariablesArenTRead(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"EnableErrorReportingWhenALocalVariablesArenTRead.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EnableErrorReportingWhenALocalVariablesArenTRead Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EnableErrorReportingWhenALocalVariablesArenTRead Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<EnableErrorReportingWhenALocalVariablesArenTRead>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(EnableErrorReportingWhenALocalVariablesArenTRead instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<EnableErrorReportingWhenALocalVariablesArenTRead, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<EnableErrorReportingWhenALocalVariablesArenTRead> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<EnableErrorReportingWhenALocalVariablesArenTRead>();
                    }
                    finally
                    {
