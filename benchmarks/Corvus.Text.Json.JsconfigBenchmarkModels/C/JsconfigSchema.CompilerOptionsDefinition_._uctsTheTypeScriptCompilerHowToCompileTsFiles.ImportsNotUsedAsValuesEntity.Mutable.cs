        ...
        public readonly partial struct InstructsTheTypeScriptCompilerHowToCompileTsFiles
        {
            ...
            public readonly partial struct ImportsNotUsedAsValuesEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ImportsNotUsedAsValuesEntity, Mutable>(ImportsNotUsedAsValuesEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(ImportsNotUsedAsValuesEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ImportsNotUsedAsValuesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ImportsNotUsedAsValuesEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ImportsNotUsedAsValuesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ImportsNotUsedAsValuesEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ImportsNotUsedAsValuesEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ImportsNotUsedAsValuesEntity>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ImportsNotUsedAsValuesEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ImportsNotUsedAsValuesEntity, Mutable>(this);
                }
            }
        }
    }
