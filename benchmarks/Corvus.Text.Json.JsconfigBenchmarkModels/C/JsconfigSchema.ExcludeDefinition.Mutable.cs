...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct ExcludeDefinition
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.JsonStringArray.Mutable Exclude
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludeUtf8, out Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.JsonStringArray.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetExclude(scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.JsonStringArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetExclude<TContext>(in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.JsonStringArray.Source<TContext> value)
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.JsonStringArray.Source _createArg1;
            ...
            internal Source(Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.JsonStringArray.Source arg1)
            {
                _createArg1 = arg1;
                _kind = Kind.Create;
            }
            ...
            #endif
        {
            ...
            private readonly Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.JsonStringArray.Source<TContext> _createArg1;
            ...
            internal Source(scoped in TContext context, Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in TContext context, scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.JsonStringArray.Source<TContext> arg1)
            {
                _context = context;
                _createArg1 = arg1;
                _kind = Kind.Create;
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.JsonStringArray.Source exclude = default)
            {
            ...
            /// Creates an instance of a <see cref="ExcludeDefinition"/>.
            /// </summary>
            public void Create(in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.JsonStringArray.Source exclude = default)
            {
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.JsonStringArray.Source<TContext> exclude = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="ExcludeDefinition"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.JsonStringArray.Source<TContext> exclude = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            internal static void BuildCreateValue(scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.JsonStringArray.Source arg1, ref ComplexValueBuilder o)
            {
                o.StartObject();
                Create(ref o, arg1);
                o.EndObject();
            ...
            /// <param name="arg1">The value of the property.</param>
            /// <param name="o">The complex value builder into which to write the object.</param>
            internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.JsonStringArray.Source<TContext> arg1, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.JsonStringArray.Source exclude = default)
        {
        ...
        /// <param name="exclude">The value of the <c>"exclude"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.JsonStringArray.Source<TContext> exclude = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Source<TContext>(context, exclude);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.JsonStringArray.Source exclude = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.JsonStringArray.Source<TContext> exclude = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        public static ParsedJsonDocument<ExcludeDefinition> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ExcludeDefinition>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ExcludeDefinition> Create<TContext>(
        ...
        public static ParsedJsonDocument<ExcludeDefinition> Create(in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.JsonStringArray.Source exclude = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ExcludeDefinition> Create<TContext>(in TContext context, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExcludeDefinition.JsonStringArray.Source<TContext> exclude = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
