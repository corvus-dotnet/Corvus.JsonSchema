...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct ExtendsDefinition
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ExtendsEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ExtendsEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ExtendsEntity DefaultInstance { get; }
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.OneOf0Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.OneOf0Entity(ExtendsEntity value)
            {
                return Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.OneOf0Entity.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.OneOf0Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ExtendsEntity(Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.OneOf0Entity value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.JsonStringArray(ExtendsEntity value)
            {
                return Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.JsonStringArray.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.JsonStringArray"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ExtendsEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in ExtendsEntity left, in ExtendsEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ExtendsEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ExtendsEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ExtendsEntity(JsonElement instance)
            {
                return ExtendsEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExtendsEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExtendsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ExtendsEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExtendsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ExtendsEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExtendsEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ExtendsEntity>(json, options);
            }
            ...
            /// </exception>
            public static ExtendsEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ExtendsEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ExtendsEntity? result)
            {
                return JsonElementHelpers.TryParseValue<ExtendsEntity>(ref reader, out result);
            }
...
#if NET
            static ExtendsEntity IJsonElement<ExtendsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ExtendsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public bool TryGetAsOneOf0Entity(out Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.OneOf0Entity result)
            {
                ...
                {
                    result = Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.OneOf0Entity.From(this);
                    return true;
                }
            ...
            public bool TryGetAsJsonStringArray(out Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.JsonStringArray result)
            {
                ...
                {
                    result = Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.JsonStringArray.From(this);
                    return true;
                }
            ...
            /// <param name="matchOneOf0Entity">Match a <see cref="Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.OneOf0Entity"/>.</param>
            /// <param name="matchJsonStringArray">Match a <see cref="Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.JsonStringArray"/>.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.OneOf0Entity, TContext, TResult> matchOneOf0Entity,
                Matcher<Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.JsonStringArray, TContext, TResult> matchJsonStringArray,
                Matcher<Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                if (Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf0Entity(Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.OneOf0Entity.From(this), context);
                }

                if (Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.JsonStringArray.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.OneOf0Entity, TResult> matchOneOf0Entity,
                Matcher<Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.JsonStringArray, TResult> matchJsonStringArray,
                Matcher<Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity, TResult> defaultMatch)
            {
                if (Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf0Entity(Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.OneOf0Entity.From(this));
                }

                if (Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.JsonStringArray.From(this));
                }
