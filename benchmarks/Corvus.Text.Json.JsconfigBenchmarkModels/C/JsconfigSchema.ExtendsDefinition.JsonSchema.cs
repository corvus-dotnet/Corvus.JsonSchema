        ...
        : IJsonElement<ExtendsDefinition>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchExtends(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/extendsDefinition"u8, buffer, out written);
