...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct ExtendsDefinition
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ExtendsDefinition instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ExtendsDefinition"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ExtendsDefinition(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ExtendsDefinition.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ExtendsDefinition Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ExtendsDefinition Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ExtendsDefinition>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.Source _createArg1;
            ...
            internal Source(Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.Source arg1)
            {
                _createArg1 = arg1;
                _kind = Kind.Create;
            }

            public static implicit operator Source(ExtendsDefinition instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.Source<TContext> _createArg1;
            ...
            internal Source(scoped in TContext context, Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in TContext context, scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.Source<TContext> arg1)
            {
                _context = context;
                _createArg1 = arg1;
                _kind = Kind.Create;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ExtendsDefinition"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.Source extends = default)
            {
            ...
            /// Creates an instance of a <see cref="ExtendsDefinition"/>.
            /// </summary>
            public void Create(in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.Source extends = default)
            {
                Create(ref _builder, extends);
            }
            ...
            /// Creates an instance of a <see cref="ExtendsDefinition"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.Source<TContext> extends = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
                Create(context, ref _builder, extends);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.Source arg1, ref ComplexValueBuilder o)
            {
                o.StartObject();
                Create(ref o, arg1);
                o.EndObject();
            ...
            /// <param name="arg1">The value of the property.</param>
            /// <param name="o">The complex value builder into which to write the object.</param>
            internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.Source<TContext> arg1, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.Source extends = default)
        {
        ...
        /// <param name="extends">The value of the <c>"extends"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.Source<TContext> extends = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Source<TContext>(context, extends);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.Source extends = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.Source<TContext> extends = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        {
            return workspace.CreateBuilder<ExtendsDefinition, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ExtendsDefinition> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ExtendsDefinition>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ExtendsDefinition> Create<TContext>(
        ...
        public static ParsedJsonDocument<ExtendsDefinition> Create(in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.Source extends = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ExtendsDefinition> Create<TContext>(in TContext context, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity.Source<TContext> extends = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
