...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct ExtendsDefinition
#if NET8_0_OR_GREATER
        : IJsonElement<ExtendsDefinition>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtendsDefinition"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ExtendsDefinition(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ExtendsDefinition DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity Extends
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExtendsUtf8, out Corvus.JsconfigBenchmark.Current.JsconfigSchema.ExtendsDefinition.ExtendsEntity value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in ExtendsDefinition left, in ExtendsDefinition right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ExtendsDefinition left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ExtendsDefinition instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ExtendsDefinition(JsonElement instance)
        {
            return ExtendsDefinition.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ExtendsDefinition From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ExtendsDefinition ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ExtendsDefinition>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ExtendsDefinition ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ExtendsDefinition>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ExtendsDefinition ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ExtendsDefinition>(json, options);
        }
        ...
        /// </exception>
        public static ExtendsDefinition ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ExtendsDefinition>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ExtendsDefinition? result)
        {
            return JsonElementHelpers.TryParseValue<ExtendsDefinition>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ExtendsDefinition(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ExtendsDefinition IJsonElement<ExtendsDefinition>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ExtendsDefinition: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ExtendsDefinition"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ExtendsDefinition"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ExtendsDefinition Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ExtendsDefinition>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ExtendsDefinition"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ExtendsDefinition Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ExtendsDefinition>(_idx);
            }
