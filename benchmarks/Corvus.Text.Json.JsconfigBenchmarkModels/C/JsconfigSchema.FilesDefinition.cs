...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct FilesDefinition
#if NET8_0_OR_GREATER
        : IJsonElement<FilesDefinition>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FilesDefinition"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal FilesDefinition(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static FilesDefinition DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.JsconfigBenchmark.Current.JsconfigSchema.FilesDefinition.JsonStringArray Files
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FilesUtf8, out Corvus.JsconfigBenchmark.Current.JsconfigSchema.FilesDefinition.JsonStringArray value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in FilesDefinition left, in FilesDefinition right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in FilesDefinition left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(FilesDefinition instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator FilesDefinition(JsonElement instance)
        {
            return FilesDefinition.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FilesDefinition From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FilesDefinition ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<FilesDefinition>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FilesDefinition ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<FilesDefinition>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FilesDefinition ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<FilesDefinition>(json, options);
        }
        ...
        /// </exception>
        public static FilesDefinition ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<FilesDefinition>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out FilesDefinition? result)
        {
            return JsonElementHelpers.TryParseValue<FilesDefinition>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new FilesDefinition(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static FilesDefinition IJsonElement<FilesDefinition>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"FilesDefinition: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="FilesDefinition"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="FilesDefinition"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public FilesDefinition Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<FilesDefinition>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="FilesDefinition"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public FilesDefinition Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<FilesDefinition>(_idx);
            }
