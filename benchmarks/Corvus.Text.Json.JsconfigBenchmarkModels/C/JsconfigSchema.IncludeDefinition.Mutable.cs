...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct IncludeDefinition
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(IncludeDefinition instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="IncludeDefinition"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator IncludeDefinition(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.JsonStringArray.Mutable Include
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeUtf8, out Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.JsonStringArray.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new IncludeDefinition(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetInclude(scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.JsonStringArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetInclude<TContext>(in Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.JsonStringArray.Source<TContext> value)
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"IncludeDefinition.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="IncludeDefinition"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="IncludeDefinition"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly IncludeDefinition Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<IncludeDefinition>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="IncludeDefinition"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly IncludeDefinition Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<IncludeDefinition>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.JsonStringArray.Source _createArg1;
            ...
            internal Source(Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.JsonStringArray.Source arg1)
            {
                _createArg1 = arg1;
                _kind = Kind.Create;
            }

            public static implicit operator Source(IncludeDefinition instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.JsonStringArray.Source<TContext> _createArg1;
            ...
            internal Source(scoped in TContext context, Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in TContext context, scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.JsonStringArray.Source<TContext> arg1)
            {
                _context = context;
                _createArg1 = arg1;
                _kind = Kind.Create;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="IncludeDefinition"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.JsonStringArray.Source include = default)
            {
            ...
            /// Creates an instance of a <see cref="IncludeDefinition"/>.
            /// </summary>
            public void Create(in Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.JsonStringArray.Source include = default)
            {
                Create(ref _builder, include);
            }
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.JsonStringArray.Source<TContext> include = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="IncludeDefinition"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.JsonStringArray.Source<TContext> include = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
                Create(context, ref _builder, include);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.JsonStringArray.Source arg1, ref ComplexValueBuilder o)
            {
                o.StartObject();
                Create(ref o, arg1);
                o.EndObject();
            ...
            /// <param name="arg1">The value of the property.</param>
            /// <param name="o">The complex value builder into which to write the object.</param>
            internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.JsonStringArray.Source<TContext> arg1, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.JsonStringArray.Source include = default)
        {
        ...
        /// <param name="include">The value of the <c>"include"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.JsonStringArray.Source<TContext> include = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Source<TContext>(context, include);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.JsonStringArray.Source include = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.JsonStringArray.Source<TContext> include = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        {
            return workspace.CreateBuilder<IncludeDefinition, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<IncludeDefinition> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<IncludeDefinition>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<IncludeDefinition> Create<TContext>(
        ...
        public static ParsedJsonDocument<IncludeDefinition> Create(in Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.JsonStringArray.Source include = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<IncludeDefinition> Create<TContext>(in TContext context, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.IncludeDefinition.JsonStringArray.Source<TContext> include = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
