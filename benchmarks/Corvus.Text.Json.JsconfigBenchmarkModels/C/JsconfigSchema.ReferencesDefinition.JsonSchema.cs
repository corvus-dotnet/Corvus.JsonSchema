...
public readonly partial struct JsconfigSchema
{
        ...
        : IJsonElement<ReferencesDefinition>
    {
        ...
        {
            private static readonly JsonSchemaPathProvider ReferencesSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/references"u8, buffer, out written);

            private static void MatchReferences(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.JsconfigBenchmark.Current.JsconfigSchema.ReferencesDefinition.ProjectReferenceArray.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.ReferencesUtf8,
                        evaluationPath: ReferencesSchemaEvaluationPath);

                Corvus.JsconfigBenchmark.Current.JsconfigSchema.ReferencesDefinition.ProjectReferenceArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.ReferencesUtf8))
                {
                    matcher = MatchReferences;
                    return true;
                }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/jsconfig.json#/definitions/referencesDefinition"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://json.schemastore.org/jsconfig.json#/definitions/referencesDefinition";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/jsconfig.json#/definitions/referencesDefinition"u8;
