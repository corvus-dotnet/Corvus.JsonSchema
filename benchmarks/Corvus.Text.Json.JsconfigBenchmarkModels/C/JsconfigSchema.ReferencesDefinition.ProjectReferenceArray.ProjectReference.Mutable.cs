...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct ReferencesDefinition
    {
        ...
        public readonly partial struct ProjectReferenceArray
        {
            ...
            public readonly partial struct ProjectReference
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ProjectReference instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ProjectReference"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ProjectReference(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.JsconfigBenchmark.Current.JsonString.Mutable Path
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathUtf8, out Corvus.JsconfigBenchmark.Current.JsonString.Mutable value))
                            {
                                return value;
                            }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new ProjectReference(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ProjectReference.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="ProjectReference"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="ProjectReference"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ProjectReference Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<ProjectReference>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="ProjectReference"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ProjectReference Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ProjectReference>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.JsconfigBenchmark.Current.JsonString.Source _createArg1;
                    ...
                    public static implicit operator Source(ProjectReference instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.JsconfigBenchmark.Current.JsconfigSchema.ReferencesDefinition.ProjectReferenceArray.ProjectReference.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="ProjectReference"/>.
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.JsconfigBenchmark.Current.JsonString.Source path = default)
                    {
                    ...
                    /// Creates an instance of a <see cref="ProjectReference"/>.
                    /// </summary>
                    public void Create(in Corvus.JsconfigBenchmark.Current.JsonString.Source path = default)
                    {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.JsconfigBenchmark.Current.JsonString.Source path = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                {
                    return workspace.CreateBuilder<ProjectReference, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ProjectReference> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ProjectReference>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<ProjectReference> Create<TContext>(
                ...
                public static ParsedJsonDocument<ProjectReference> Create(in Corvus.JsconfigBenchmark.Current.JsonString.Source path = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
