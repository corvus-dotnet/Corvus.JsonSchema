...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct ReferencesDefinition
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ProjectReferenceArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ProjectReferenceArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ProjectReferenceArray DefaultInstance { get; }
            ...
            public Corvus.JsconfigBenchmark.Current.JsconfigSchema.ReferencesDefinition.ProjectReferenceArray.ProjectReference this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.JsconfigBenchmark.Current.JsconfigSchema.ReferencesDefinition.ProjectReferenceArray.ProjectReference>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.JsconfigBenchmark.Current.JsconfigSchema.ReferencesDefinition.ProjectReferenceArray.ProjectReference> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.JsconfigBenchmark.Current.JsconfigSchema.ReferencesDefinition.ProjectReferenceArray.ProjectReference>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in ProjectReferenceArray left, in ProjectReferenceArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ProjectReferenceArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(ProjectReferenceArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ProjectReferenceArray(JsonElement instance)
            {
                return ProjectReferenceArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ProjectReferenceArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ProjectReferenceArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ProjectReferenceArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ProjectReferenceArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ProjectReferenceArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ProjectReferenceArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ProjectReferenceArray>(json, options);
            }
            ...
            /// </exception>
            public static ProjectReferenceArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ProjectReferenceArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ProjectReferenceArray? result)
            {
                return JsonElementHelpers.TryParseValue<ProjectReferenceArray>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ProjectReferenceArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ProjectReferenceArray IJsonElement<ProjectReferenceArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ProjectReferenceArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ProjectReferenceArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ProjectReferenceArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ProjectReferenceArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ProjectReferenceArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ProjectReferenceArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ProjectReferenceArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ProjectReferenceArray>(_idx);
                }
