...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct ReferencesDefinition
        ...
        : IJsonElement<ReferencesDefinition>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReferencesDefinition"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ReferencesDefinition(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ReferencesDefinition DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.JsconfigBenchmark.Current.JsconfigSchema.ReferencesDefinition.ProjectReferenceArray References
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReferencesUtf8, out Corvus.JsconfigBenchmark.Current.JsconfigSchema.ReferencesDefinition.ProjectReferenceArray value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in ReferencesDefinition left, in ReferencesDefinition right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ReferencesDefinition left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ReferencesDefinition instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ReferencesDefinition(JsonElement instance)
        {
            return ReferencesDefinition.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ReferencesDefinition From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ReferencesDefinition ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ReferencesDefinition>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ReferencesDefinition ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ReferencesDefinition>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ReferencesDefinition ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ReferencesDefinition>(json, options);
        }
        ...
        /// </exception>
        public static ReferencesDefinition ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ReferencesDefinition>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ReferencesDefinition? result)
        {
            return JsonElementHelpers.TryParseValue<ReferencesDefinition>(ref reader, out result);
        }
...
#if NET
        static ReferencesDefinition IJsonElement<ReferencesDefinition>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ReferencesDefinition: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public ReferencesDefinition Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public ReferencesDefinition Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ReferencesDefinition>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="References"/>.
            /// </summary>
            public static ReadOnlySpan<byte> References => "references"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="References"/>.
            /// </summary>
            public static ReadOnlySpan<byte> References => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6E, 0x63, 0x65, 0x73, 0x22];
        }
    }
}
