...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct TypeAcquisitionDefinition
        : IJsonElement<TypeAcquisitionDefinition>
    {
        public static partial class JsonSchema
        {
            private static readonly JsonSchemaPathProvider TypeAcquisitionSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/typeAcquisition"u8, buffer, out written);

            private static void MatchTypeAcquisition(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.JsconfigBenchmark.Current.JsconfigSchema.TypeAcquisitionDefinition.TypeAcquisitionEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.TypeAcquisitionUtf8,
                        evaluationPath: TypeAcquisitionSchemaEvaluationPath);

                Corvus.JsconfigBenchmark.Current.JsconfigSchema.TypeAcquisitionDefinition.TypeAcquisitionEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.TypeAcquisitionUtf8))
                {
                    matcher = MatchTypeAcquisition;
                    return true;
                }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/jsconfig.json#/definitions/typeAcquisitionDefinition"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://json.schemastore.org/jsconfig.json#/definitions/typeAcquisitionDefinition";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/jsconfig.json#/definitions/typeAcquisitionDefinition"u8;
