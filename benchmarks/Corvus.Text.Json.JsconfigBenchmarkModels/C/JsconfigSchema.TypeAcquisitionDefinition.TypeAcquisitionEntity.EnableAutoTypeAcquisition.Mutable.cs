        ...
        public readonly partial struct TypeAcquisitionEntity
        {
            ...
            public readonly partial struct EnableAutoTypeAcquisition
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnableAutoTypeAcquisition, Mutable>(EnableAutoTypeAcquisition.DefaultInstance);
                ...
                public static ParsedJsonDocument<EnableAutoTypeAcquisition> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<EnableAutoTypeAcquisition>();
                    }
                    finally
                    {
