...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct TypeAcquisitionDefinition
    {
        ...
        public readonly partial struct TypeAcquisitionEntity
#if NET8_0_OR_GREATER
            : IJsonElement<TypeAcquisitionEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="TypeAcquisitionEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal TypeAcquisitionEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static TypeAcquisitionEntity DefaultInstance { get; }
            ...
            /// <summary>
            /// Gets the (optional) <c>enable</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.JsconfigBenchmark.Current.JsconfigSchema.TypeAcquisitionDefinition.TypeAcquisitionEntity.EnableAutoTypeAcquisition Enable
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnableUtf8, out Corvus.JsconfigBenchmark.Current.JsconfigSchema.TypeAcquisitionDefinition.TypeAcquisitionEntity.EnableAutoTypeAcquisition value))
                    {
                        return value;
                    }

                    return Corvus.JsconfigBenchmark.Current.JsconfigSchema.TypeAcquisitionDefinition.TypeAcquisitionEntity.EnableAutoTypeAcquisition.DefaultInstance;
                }
            }
            ...
            /// </para>
            /// </remarks>
            public Corvus.JsconfigBenchmark.Current.JsconfigSchema.TypeAcquisitionDefinition.TypeAcquisitionEntity.JsonStringArray Exclude
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludeUtf8, out Corvus.JsconfigBenchmark.Current.JsconfigSchema.TypeAcquisitionDefinition.TypeAcquisitionEntity.JsonStringArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.JsconfigBenchmark.Current.JsconfigSchema.TypeAcquisitionDefinition.TypeAcquisitionEntity.IncludeJsoArray Include
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeUtf8, out Corvus.JsconfigBenchmark.Current.JsconfigSchema.TypeAcquisitionDefinition.TypeAcquisitionEntity.IncludeJsoArray value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in TypeAcquisitionEntity left, in TypeAcquisitionEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in TypeAcquisitionEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(TypeAcquisitionEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TypeAcquisitionEntity(JsonElement instance)
            {
                return TypeAcquisitionEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TypeAcquisitionEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TypeAcquisitionEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TypeAcquisitionEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TypeAcquisitionEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TypeAcquisitionEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TypeAcquisitionEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TypeAcquisitionEntity>(json, options);
            }
            ...
            /// </exception>
            public static TypeAcquisitionEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<TypeAcquisitionEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out TypeAcquisitionEntity? result)
            {
                return JsonElementHelpers.TryParseValue<TypeAcquisitionEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new TypeAcquisitionEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static TypeAcquisitionEntity IJsonElement<TypeAcquisitionEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TypeAcquisitionEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="TypeAcquisitionEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TypeAcquisitionEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public TypeAcquisitionEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TypeAcquisitionEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TypeAcquisitionEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public TypeAcquisitionEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<TypeAcquisitionEntity>(_idx);
                }
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="Enable"/>.
                /// </summary>
                ...
                /// Gets the JSON property name for <see cref="Enable"/>.
                /// </summary>
                public static ReadOnlySpan<byte> EnableUtf8 => "enable"u8;
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Enable"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Enable => "enable"u8;
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="Enable"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Enable => [0x85, 0x00, 0x00, 0x00, 0x22, 0x65, 0x6E, 0x61, 0x62, 0x6C, 0x65, 0x22];
