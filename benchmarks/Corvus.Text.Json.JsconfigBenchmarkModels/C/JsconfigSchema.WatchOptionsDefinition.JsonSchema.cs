...
public readonly partial struct JsconfigSchema
{
        ...
        : IJsonElement<WatchOptionsDefinition>
    {
        ...
        {
            private static readonly JsonSchemaPathProvider WatchOptionsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/watchOptions"u8, buffer, out written);

            private static void MatchWatchOptions(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.JsconfigBenchmark.Current.JsconfigSchema.WatchOptionsDefinition.SettingsForTheWatchModeInTypeScript.JsonSchema.PushChildContextUnescaped(
                        ...
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.WatchOptionsUtf8,
                        evaluationPath: WatchOptionsSchemaEvaluationPath);

                Corvus.JsconfigBenchmark.Current.JsconfigSchema.WatchOptionsDefinition.SettingsForTheWatchModeInTypeScript.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.WatchOptionsUtf8))
                {
                    matcher = MatchWatchOptions;
                    return true;
                }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/jsconfig.json#/definitions/watchOptionsDefinition"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://json.schemastore.org/jsconfig.json#/definitions/watchOptionsDefinition";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/jsconfig.json#/definitions/watchOptionsDefinition"u8;
