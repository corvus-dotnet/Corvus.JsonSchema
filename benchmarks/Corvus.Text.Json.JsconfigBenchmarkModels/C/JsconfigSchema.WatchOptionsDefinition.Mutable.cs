...
public readonly partial struct JsconfigSchema
{
    ...
    public readonly partial struct WatchOptionsDefinition
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(WatchOptionsDefinition instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="WatchOptionsDefinition"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator WatchOptionsDefinition(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.JsconfigBenchmark.Current.JsconfigSchema.WatchOptionsDefinition.SettingsForTheWatchModeInTypeScript.Mutable WatchOptions
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WatchOptionsUtf8, out Corvus.JsconfigBenchmark.Current.JsconfigSchema.WatchOptionsDefinition.SettingsForTheWatchModeInTypeScript.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new WatchOptionsDefinition(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetWatchOptions(scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.WatchOptionsDefinition.SettingsForTheWatchModeInTypeScript.Source value)
            {
                ...
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.WatchOptionsUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WatchOptionsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.WatchOptions, ref cvb);
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetWatchOptions<TContext>(in Corvus.JsconfigBenchmark.Current.JsconfigSchema.WatchOptionsDefinition.SettingsForTheWatchModeInTypeScript.Source<TContext> value)
            ...
            /// <summary>
            /// Remove the <c>watchOptions</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveWatchOptions()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.WatchOptionsUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"WatchOptionsDefinition.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="WatchOptionsDefinition"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="WatchOptionsDefinition"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly WatchOptionsDefinition Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<WatchOptionsDefinition>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="WatchOptionsDefinition"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly WatchOptionsDefinition Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<WatchOptionsDefinition>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.JsconfigBenchmark.Current.JsconfigSchema.WatchOptionsDefinition.SettingsForTheWatchModeInTypeScript.Source _createArg1;
            ...
            public static implicit operator Source(WatchOptionsDefinition instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.JsconfigBenchmark.Current.JsconfigSchema.WatchOptionsDefinition.SettingsForTheWatchModeInTypeScript.Source<TContext> _createArg1;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="WatchOptionsDefinition"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.WatchOptionsDefinition.SettingsForTheWatchModeInTypeScript.Source watchOptions = default)
            {
                watchOptions.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.WatchOptions, ref builder);
            }

            /// <summary>
            /// Creates an instance of a <see cref="WatchOptionsDefinition"/>.
            /// </summary>
            public void Create(in Corvus.JsconfigBenchmark.Current.JsconfigSchema.WatchOptionsDefinition.SettingsForTheWatchModeInTypeScript.Source watchOptions = default)
            {
                Create(ref _builder, watchOptions);
            }
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.JsconfigBenchmark.Current.JsconfigSchema.WatchOptionsDefinition.SettingsForTheWatchModeInTypeScript.Source<TContext> watchOptions = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="WatchOptionsDefinition"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.WatchOptionsDefinition.SettingsForTheWatchModeInTypeScript.Source<TContext> watchOptions = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
                Create(context, ref _builder, watchOptions);
            }
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.JsconfigBenchmark.Current.JsconfigSchema.WatchOptionsDefinition.SettingsForTheWatchModeInTypeScript.Source<TContext> watchOptions = default)
            ...
            #endif
        {
            return new Source<TContext>(context, watchOptions);
        }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="watchOptions">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.WatchOptionsDefinition.SettingsForTheWatchModeInTypeScript.Source watchOptions = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(watchOptions);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.WatchOptionsDefinition.SettingsForTheWatchModeInTypeScript.Source<TContext> watchOptions = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, watchOptions);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<WatchOptionsDefinition, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<WatchOptionsDefinition> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<WatchOptionsDefinition>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<WatchOptionsDefinition> Create<TContext>(
        ...
        public static ParsedJsonDocument<WatchOptionsDefinition> Create(in Corvus.JsconfigBenchmark.Current.JsconfigSchema.WatchOptionsDefinition.SettingsForTheWatchModeInTypeScript.Source watchOptions = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<WatchOptionsDefinition> Create<TContext>(in TContext context, in Corvus.JsconfigBenchmark.Current.JsconfigSchema.WatchOptionsDefinition.SettingsForTheWatchModeInTypeScript.Source<TContext> watchOptions = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
