...
public readonly partial struct Schema
{
    ...
    public readonly partial struct BossEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(BossEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BossEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BossEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BossEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly BossEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly BossEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<BossEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(BossEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<BossEntity, Mutable>(this);
        }
    }
}
