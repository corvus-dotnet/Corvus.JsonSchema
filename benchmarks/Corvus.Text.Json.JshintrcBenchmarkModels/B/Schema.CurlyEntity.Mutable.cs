...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CurlyEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(CurlyEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CurlyEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CurlyEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CurlyEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly CurlyEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly CurlyEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CurlyEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(CurlyEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<CurlyEntity, Mutable>(this);
        }
    }
}
