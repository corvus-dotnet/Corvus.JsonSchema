...
public readonly partial struct Schema
{
    ...
    public readonly partial struct EnvironmentCouchDb
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(EnvironmentCouchDb instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EnvironmentCouchDb"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnvironmentCouchDb(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new EnvironmentCouchDb(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnvironmentCouchDb.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="EnvironmentCouchDb"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="EnvironmentCouchDb"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentCouchDb Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<EnvironmentCouchDb>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="EnvironmentCouchDb"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentCouchDb Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EnvironmentCouchDb>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EnvironmentCouchDb instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<EnvironmentCouchDb, Mutable>(this);
        }
    }
}
