...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnvironmentDefinesGlobalsExposedByTheShellJsLibrary"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal EnvironmentDefinesGlobalsExposedByTheShellJsLibrary(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static EnvironmentDefinesGlobalsExposedByTheShellJsLibrary DefaultInstance { get; } = ParsedJsonDocument<EnvironmentDefinesGlobalsExposedByTheShellJsLibrary>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(EnvironmentDefinesGlobalsExposedByTheShellJsLibrary value)
        {
        ...
        /// </returns>
        public static bool operator ==(in EnvironmentDefinesGlobalsExposedByTheShellJsLibrary left, in EnvironmentDefinesGlobalsExposedByTheShellJsLibrary right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in EnvironmentDefinesGlobalsExposedByTheShellJsLibrary left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(EnvironmentDefinesGlobalsExposedByTheShellJsLibrary instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator EnvironmentDefinesGlobalsExposedByTheShellJsLibrary(JsonElement instance)
        {
            return EnvironmentDefinesGlobalsExposedByTheShellJsLibrary.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentDefinesGlobalsExposedByTheShellJsLibrary From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentDefinesGlobalsExposedByTheShellJsLibrary ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentDefinesGlobalsExposedByTheShellJsLibrary>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentDefinesGlobalsExposedByTheShellJsLibrary ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentDefinesGlobalsExposedByTheShellJsLibrary>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentDefinesGlobalsExposedByTheShellJsLibrary ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentDefinesGlobalsExposedByTheShellJsLibrary>(json, options);
        }
        ...
        /// </exception>
        public static EnvironmentDefinesGlobalsExposedByTheShellJsLibrary ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<EnvironmentDefinesGlobalsExposedByTheShellJsLibrary>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out EnvironmentDefinesGlobalsExposedByTheShellJsLibrary? result)
        {
            return JsonElementHelpers.TryParseValue<EnvironmentDefinesGlobalsExposedByTheShellJsLibrary>(ref reader, out result);
        }
...
#if NET
        static EnvironmentDefinesGlobalsExposedByTheShellJsLibrary IJsonElement<EnvironmentDefinesGlobalsExposedByTheShellJsLibrary>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"EnvironmentDefinesGlobalsExposedByTheShellJsLibrary: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public EnvironmentDefinesGlobalsExposedByTheShellJsLibrary Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public EnvironmentDefinesGlobalsExposedByTheShellJsLibrary Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<EnvironmentDefinesGlobalsExposedByTheShellJsLibrary>(_idx);
            }
