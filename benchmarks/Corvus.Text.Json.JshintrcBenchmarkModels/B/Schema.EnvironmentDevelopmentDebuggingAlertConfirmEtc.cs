...
public readonly partial struct Schema
{
    ...
    public readonly partial struct EnvironmentDevelopmentDebuggingAlertConfirmEtc
#if NET8_0_OR_GREATER
        : IJsonElement<EnvironmentDevelopmentDebuggingAlertConfirmEtc>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnvironmentDevelopmentDebuggingAlertConfirmEtc"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal EnvironmentDevelopmentDebuggingAlertConfirmEtc(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static EnvironmentDevelopmentDebuggingAlertConfirmEtc DefaultInstance { get; } = ParsedJsonDocument<EnvironmentDevelopmentDebuggingAlertConfirmEtc>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(EnvironmentDevelopmentDebuggingAlertConfirmEtc value)
        {
        ...
        /// </returns>
        public static bool operator ==(in EnvironmentDevelopmentDebuggingAlertConfirmEtc left, in EnvironmentDevelopmentDebuggingAlertConfirmEtc right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in EnvironmentDevelopmentDebuggingAlertConfirmEtc left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(EnvironmentDevelopmentDebuggingAlertConfirmEtc instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator EnvironmentDevelopmentDebuggingAlertConfirmEtc(JsonElement instance)
        {
            return EnvironmentDevelopmentDebuggingAlertConfirmEtc.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentDevelopmentDebuggingAlertConfirmEtc From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentDevelopmentDebuggingAlertConfirmEtc ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentDevelopmentDebuggingAlertConfirmEtc>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentDevelopmentDebuggingAlertConfirmEtc ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentDevelopmentDebuggingAlertConfirmEtc>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentDevelopmentDebuggingAlertConfirmEtc ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentDevelopmentDebuggingAlertConfirmEtc>(json, options);
        }
        ...
        /// </exception>
        public static EnvironmentDevelopmentDebuggingAlertConfirmEtc ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<EnvironmentDevelopmentDebuggingAlertConfirmEtc>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out EnvironmentDevelopmentDebuggingAlertConfirmEtc? result)
        {
            return JsonElementHelpers.TryParseValue<EnvironmentDevelopmentDebuggingAlertConfirmEtc>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new EnvironmentDevelopmentDebuggingAlertConfirmEtc(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static EnvironmentDevelopmentDebuggingAlertConfirmEtc IJsonElement<EnvironmentDevelopmentDebuggingAlertConfirmEtc>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"EnvironmentDevelopmentDebuggingAlertConfirmEtc: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="EnvironmentDevelopmentDebuggingAlertConfirmEtc"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="EnvironmentDevelopmentDebuggingAlertConfirmEtc"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public EnvironmentDevelopmentDebuggingAlertConfirmEtc Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<EnvironmentDevelopmentDebuggingAlertConfirmEtc>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="EnvironmentDevelopmentDebuggingAlertConfirmEtc"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public EnvironmentDevelopmentDebuggingAlertConfirmEtc Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<EnvironmentDevelopmentDebuggingAlertConfirmEtc>(_idx);
            }
