...
public readonly partial struct Schema
{
    ...
    public readonly partial struct EnvironmentDojoToolkit
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(EnvironmentDojoToolkit instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EnvironmentDojoToolkit"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnvironmentDojoToolkit(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnvironmentDojoToolkit.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentDojoToolkit Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentDojoToolkit Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EnvironmentDojoToolkit>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EnvironmentDojoToolkit instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<EnvironmentDojoToolkit, Mutable>(this);
        }
    }
}
