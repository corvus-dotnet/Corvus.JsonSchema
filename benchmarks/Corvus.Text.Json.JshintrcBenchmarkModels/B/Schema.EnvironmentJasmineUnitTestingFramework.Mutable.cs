...
public readonly partial struct Schema
{
    ...
    public readonly partial struct EnvironmentJasmineUnitTestingFramework
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(EnvironmentJasmineUnitTestingFramework instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EnvironmentJasmineUnitTestingFramework"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnvironmentJasmineUnitTestingFramework(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new EnvironmentJasmineUnitTestingFramework(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnvironmentJasmineUnitTestingFramework.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="EnvironmentJasmineUnitTestingFramework"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="EnvironmentJasmineUnitTestingFramework"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentJasmineUnitTestingFramework Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<EnvironmentJasmineUnitTestingFramework>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="EnvironmentJasmineUnitTestingFramework"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentJasmineUnitTestingFramework Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EnvironmentJasmineUnitTestingFramework>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EnvironmentJasmineUnitTestingFramework instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<EnvironmentJasmineUnitTestingFramework, Mutable>(this);
        }
    }
}
