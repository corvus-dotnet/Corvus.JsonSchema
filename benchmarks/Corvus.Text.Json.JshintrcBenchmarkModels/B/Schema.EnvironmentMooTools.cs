...
public readonly partial struct Schema
{
    ...
    public readonly partial struct EnvironmentMooTools
        ...
        : IJsonElement<EnvironmentMooTools>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnvironmentMooTools"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal EnvironmentMooTools(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static EnvironmentMooTools DefaultInstance { get; } = ParsedJsonDocument<EnvironmentMooTools>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(EnvironmentMooTools value)
        {
        ...
        /// </returns>
        public static bool operator ==(in EnvironmentMooTools left, in EnvironmentMooTools right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in EnvironmentMooTools left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(EnvironmentMooTools instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator EnvironmentMooTools(JsonElement instance)
        {
            return EnvironmentMooTools.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentMooTools From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentMooTools ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentMooTools>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentMooTools ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentMooTools>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentMooTools ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentMooTools>(json, options);
        }
        ...
        /// </exception>
        public static EnvironmentMooTools ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<EnvironmentMooTools>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out EnvironmentMooTools? result)
        {
            return JsonElementHelpers.TryParseValue<EnvironmentMooTools>(ref reader, out result);
        }
...
#if NET
        static EnvironmentMooTools IJsonElement<EnvironmentMooTools>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"EnvironmentMooTools: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public EnvironmentMooTools Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public EnvironmentMooTools Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<EnvironmentMooTools>(_idx);
            }
