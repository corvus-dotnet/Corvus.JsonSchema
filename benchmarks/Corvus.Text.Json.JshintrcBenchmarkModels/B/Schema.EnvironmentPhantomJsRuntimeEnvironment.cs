...
public readonly partial struct Schema
{
    ...
    public readonly partial struct EnvironmentPhantomJsRuntimeEnvironment
#if NET8_0_OR_GREATER
        : IJsonElement<EnvironmentPhantomJsRuntimeEnvironment>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnvironmentPhantomJsRuntimeEnvironment"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal EnvironmentPhantomJsRuntimeEnvironment(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static EnvironmentPhantomJsRuntimeEnvironment DefaultInstance { get; } = ParsedJsonDocument<EnvironmentPhantomJsRuntimeEnvironment>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(EnvironmentPhantomJsRuntimeEnvironment value)
        {
        ...
        /// </returns>
        public static bool operator ==(in EnvironmentPhantomJsRuntimeEnvironment left, in EnvironmentPhantomJsRuntimeEnvironment right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in EnvironmentPhantomJsRuntimeEnvironment left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(EnvironmentPhantomJsRuntimeEnvironment instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator EnvironmentPhantomJsRuntimeEnvironment(JsonElement instance)
        {
            return EnvironmentPhantomJsRuntimeEnvironment.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentPhantomJsRuntimeEnvironment From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentPhantomJsRuntimeEnvironment ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentPhantomJsRuntimeEnvironment>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentPhantomJsRuntimeEnvironment ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentPhantomJsRuntimeEnvironment>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentPhantomJsRuntimeEnvironment ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentPhantomJsRuntimeEnvironment>(json, options);
        }
        ...
        /// </exception>
        public static EnvironmentPhantomJsRuntimeEnvironment ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<EnvironmentPhantomJsRuntimeEnvironment>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out EnvironmentPhantomJsRuntimeEnvironment? result)
        {
            return JsonElementHelpers.TryParseValue<EnvironmentPhantomJsRuntimeEnvironment>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new EnvironmentPhantomJsRuntimeEnvironment(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static EnvironmentPhantomJsRuntimeEnvironment IJsonElement<EnvironmentPhantomJsRuntimeEnvironment>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"EnvironmentPhantomJsRuntimeEnvironment: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="EnvironmentPhantomJsRuntimeEnvironment"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="EnvironmentPhantomJsRuntimeEnvironment"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public EnvironmentPhantomJsRuntimeEnvironment Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<EnvironmentPhantomJsRuntimeEnvironment>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="EnvironmentPhantomJsRuntimeEnvironment"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public EnvironmentPhantomJsRuntimeEnvironment Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<EnvironmentPhantomJsRuntimeEnvironment>(_idx);
            }
