...
public readonly partial struct Schema
{
    ...
    public readonly partial struct EnvironmentRhino
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(EnvironmentRhino instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EnvironmentRhino"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnvironmentRhino(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnvironmentRhino.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentRhino Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentRhino Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EnvironmentRhino>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EnvironmentRhino instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<EnvironmentRhino, Mutable>(this);
        }
    }
}
