...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ExprEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ExprEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ExprEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ExprEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ExprEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ExprEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ExprEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ExprEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ExprEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ExprEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ExprEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ExprEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ExprEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ExprEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ExprEntity, Mutable>(this);
        }
    }
}
