...
public readonly partial struct Schema
{
    ...
    public readonly partial struct MaxCyclomaticComplexityPerFunction
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MaxCyclomaticComplexityPerFunction instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MaxCyclomaticComplexityPerFunction"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MaxCyclomaticComplexityPerFunction(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MaxCyclomaticComplexityPerFunction(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MaxCyclomaticComplexityPerFunction.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MaxCyclomaticComplexityPerFunction"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MaxCyclomaticComplexityPerFunction"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly MaxCyclomaticComplexityPerFunction Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MaxCyclomaticComplexityPerFunction>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MaxCyclomaticComplexityPerFunction"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly MaxCyclomaticComplexityPerFunction Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MaxCyclomaticComplexityPerFunction>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MaxCyclomaticComplexityPerFunction instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MaxCyclomaticComplexityPerFunction, Mutable>(this);
        }
    }
}
