...
public readonly partial struct Schema
{
    ...
    public readonly partial struct MaxNumberOfFormalParametersAllowedPerFunction
#if NET8_0_OR_GREATER
        : IJsonElement<MaxNumberOfFormalParametersAllowedPerFunction>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MaxNumberOfFormalParametersAllowedPerFunction"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal MaxNumberOfFormalParametersAllowedPerFunction(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static MaxNumberOfFormalParametersAllowedPerFunction DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator long(MaxNumberOfFormalParametersAllowedPerFunction value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator double(MaxNumberOfFormalParametersAllowedPerFunction value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Corvus.Numerics.BigNumber(MaxNumberOfFormalParametersAllowedPerFunction value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator System.Numerics.BigInteger(MaxNumberOfFormalParametersAllowedPerFunction value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator decimal(MaxNumberOfFormalParametersAllowedPerFunction value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator bool(MaxNumberOfFormalParametersAllowedPerFunction value)
        {
        ...
        /// </returns>
        public static bool operator ==(in MaxNumberOfFormalParametersAllowedPerFunction left, in MaxNumberOfFormalParametersAllowedPerFunction right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in MaxNumberOfFormalParametersAllowedPerFunction left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(MaxNumberOfFormalParametersAllowedPerFunction instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator MaxNumberOfFormalParametersAllowedPerFunction(JsonElement instance)
        {
            return MaxNumberOfFormalParametersAllowedPerFunction.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MaxNumberOfFormalParametersAllowedPerFunction From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MaxNumberOfFormalParametersAllowedPerFunction ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MaxNumberOfFormalParametersAllowedPerFunction>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MaxNumberOfFormalParametersAllowedPerFunction ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MaxNumberOfFormalParametersAllowedPerFunction>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MaxNumberOfFormalParametersAllowedPerFunction ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MaxNumberOfFormalParametersAllowedPerFunction>(json, options);
        }
        ...
        /// </exception>
        public static MaxNumberOfFormalParametersAllowedPerFunction ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<MaxNumberOfFormalParametersAllowedPerFunction>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out MaxNumberOfFormalParametersAllowedPerFunction? result)
        {
            return JsonElementHelpers.TryParseValue<MaxNumberOfFormalParametersAllowedPerFunction>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new MaxNumberOfFormalParametersAllowedPerFunction(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static MaxNumberOfFormalParametersAllowedPerFunction IJsonElement<MaxNumberOfFormalParametersAllowedPerFunction>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"MaxNumberOfFormalParametersAllowedPerFunction: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="MaxNumberOfFormalParametersAllowedPerFunction"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="MaxNumberOfFormalParametersAllowedPerFunction"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public MaxNumberOfFormalParametersAllowedPerFunction Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<MaxNumberOfFormalParametersAllowedPerFunction>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="MaxNumberOfFormalParametersAllowedPerFunction"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public MaxNumberOfFormalParametersAllowedPerFunction Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<MaxNumberOfFormalParametersAllowedPerFunction>(_idx);
            }
