...
public readonly partial struct Schema
{
    ...
    public readonly partial struct MaxNumberStatementsPerFunction
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MaxNumberStatementsPerFunction instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MaxNumberStatementsPerFunction"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MaxNumberStatementsPerFunction(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MaxNumberStatementsPerFunction.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MaxNumberStatementsPerFunction Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MaxNumberStatementsPerFunction Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MaxNumberStatementsPerFunction>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MaxNumberStatementsPerFunction instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MaxNumberStatementsPerFunction, Mutable>(this);
        }
    }
}
