...
public readonly partial struct Schema
{
    ...
    public readonly partial struct MozEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MozEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MozEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MozEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MozEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MozEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MozEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MozEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MozEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MozEntity, Mutable>(this);
        }
    }
}
