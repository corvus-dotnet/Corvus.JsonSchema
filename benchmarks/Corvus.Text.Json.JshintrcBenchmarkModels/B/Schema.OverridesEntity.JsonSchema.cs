                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (objectValidation_enumerator.MoveNext())
                    {
                        ...
                        {
                            JsonSchemaContext childContext = Corvus.JshintrcBenchmark.Baseline.Schema.OverridesEntity.ThePathPatternToApplyTheGivenOptionsTo.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                            ...
                            Corvus.JshintrcBenchmark.Baseline.Schema.OverridesEntity.ThePathPatternToApplyTheGivenOptionsTo.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
