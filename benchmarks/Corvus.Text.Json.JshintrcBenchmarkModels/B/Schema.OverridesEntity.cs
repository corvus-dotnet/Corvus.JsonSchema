...
public readonly partial struct Schema
{
    ...
    public readonly partial struct OverridesEntity
#if NET8_0_OR_GREATER
        : IJsonElement<OverridesEntity>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OverridesEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal OverridesEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static OverridesEntity DefaultInstance { get; }
        ...
        public Corvus.JshintrcBenchmark.Baseline.Schema.OverridesEntity.ThePathPatternToApplyTheGivenOptionsTo this[ReadOnlySpan<byte> propertyName]
        {
            get
            {
                CheckValidInstance();
                if (!_parent.TryGetNamedPropertyValue(_idx, propertyName, out Corvus.JshintrcBenchmark.Baseline.Schema.OverridesEntity.ThePathPatternToApplyTheGivenOptionsTo value))
                {
                    return default;
                }
        ...
        /// <returns>The value of the property with the given name.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public Corvus.JshintrcBenchmark.Baseline.Schema.OverridesEntity.ThePathPatternToApplyTheGivenOptionsTo this[ReadOnlySpan<char> propertyName]
        {
            get
            {
                CheckValidInstance();
        ...
        /// <returns>The value of the property with the given name.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public Corvus.JshintrcBenchmark.Baseline.Schema.OverridesEntity.ThePathPatternToApplyTheGivenOptionsTo this[string propertyName]
        {
            get
            {
                CheckValidInstance();
        ...
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.JshintrcBenchmark.Baseline.Schema.OverridesEntity.ThePathPatternToApplyTheGivenOptionsTo value)
        {
            CheckValidInstance();
        ...
        /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.JshintrcBenchmark.Baseline.Schema.OverridesEntity.ThePathPatternToApplyTheGivenOptionsTo value)
        {
            CheckValidInstance();
            return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
        }
        ...
        /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public bool TryGetProperty(string propertyName, out Corvus.JshintrcBenchmark.Baseline.Schema.OverridesEntity.ThePathPatternToApplyTheGivenOptionsTo value)
        {
            CheckValidInstance();
            return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public ObjectEnumerator<Corvus.JshintrcBenchmark.Baseline.Schema.OverridesEntity.ThePathPatternToApplyTheGivenOptionsTo> EnumerateObject()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateObjectEnumerator<Corvus.JshintrcBenchmark.Baseline.Schema.OverridesEntity.ThePathPatternToApplyTheGivenOptionsTo>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in OverridesEntity left, in OverridesEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in OverridesEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(OverridesEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator OverridesEntity(JsonElement instance)
        {
            return OverridesEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OverridesEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OverridesEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<OverridesEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OverridesEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<OverridesEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OverridesEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<OverridesEntity>(json, options);
        }
        ...
        /// </exception>
        public static OverridesEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<OverridesEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out OverridesEntity? result)
        {
            return JsonElementHelpers.TryParseValue<OverridesEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new OverridesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static OverridesEntity IJsonElement<OverridesEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"OverridesEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="OverridesEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="OverridesEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public OverridesEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<OverridesEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="OverridesEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public OverridesEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<OverridesEntity>(_idx);
            }
