...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ProhibitTheUseOfBitwiseOperatorsEtc
#if NET8_0_OR_GREATER
        : IJsonElement<ProhibitTheUseOfBitwiseOperatorsEtc>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProhibitTheUseOfBitwiseOperatorsEtc"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ProhibitTheUseOfBitwiseOperatorsEtc(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ProhibitTheUseOfBitwiseOperatorsEtc DefaultInstance { get; } = ParsedJsonDocument<ProhibitTheUseOfBitwiseOperatorsEtc>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(ProhibitTheUseOfBitwiseOperatorsEtc value)
        {
        ...
        /// </returns>
        public static bool operator ==(in ProhibitTheUseOfBitwiseOperatorsEtc left, in ProhibitTheUseOfBitwiseOperatorsEtc right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ProhibitTheUseOfBitwiseOperatorsEtc left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ProhibitTheUseOfBitwiseOperatorsEtc instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ProhibitTheUseOfBitwiseOperatorsEtc(JsonElement instance)
        {
            return ProhibitTheUseOfBitwiseOperatorsEtc.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProhibitTheUseOfBitwiseOperatorsEtc From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProhibitTheUseOfBitwiseOperatorsEtc ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ProhibitTheUseOfBitwiseOperatorsEtc>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProhibitTheUseOfBitwiseOperatorsEtc ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ProhibitTheUseOfBitwiseOperatorsEtc>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProhibitTheUseOfBitwiseOperatorsEtc ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ProhibitTheUseOfBitwiseOperatorsEtc>(json, options);
        }
        ...
        /// </exception>
        public static ProhibitTheUseOfBitwiseOperatorsEtc ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ProhibitTheUseOfBitwiseOperatorsEtc>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ProhibitTheUseOfBitwiseOperatorsEtc? result)
        {
            return JsonElementHelpers.TryParseValue<ProhibitTheUseOfBitwiseOperatorsEtc>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ProhibitTheUseOfBitwiseOperatorsEtc(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ProhibitTheUseOfBitwiseOperatorsEtc IJsonElement<ProhibitTheUseOfBitwiseOperatorsEtc>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ProhibitTheUseOfBitwiseOperatorsEtc: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ProhibitTheUseOfBitwiseOperatorsEtc"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ProhibitTheUseOfBitwiseOperatorsEtc"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ProhibitTheUseOfBitwiseOperatorsEtc Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ProhibitTheUseOfBitwiseOperatorsEtc>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ProhibitTheUseOfBitwiseOperatorsEtc"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ProhibitTheUseOfBitwiseOperatorsEtc Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ProhibitTheUseOfBitwiseOperatorsEtc>(_idx);
            }
