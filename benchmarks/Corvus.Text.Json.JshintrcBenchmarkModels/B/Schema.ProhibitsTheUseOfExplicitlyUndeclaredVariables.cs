...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ProhibitsTheUseOfExplicitlyUndeclaredVariables
#if NET8_0_OR_GREATER
        : IJsonElement<ProhibitsTheUseOfExplicitlyUndeclaredVariables>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProhibitsTheUseOfExplicitlyUndeclaredVariables"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ProhibitsTheUseOfExplicitlyUndeclaredVariables(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ProhibitsTheUseOfExplicitlyUndeclaredVariables DefaultInstance { get; } = ParsedJsonDocument<ProhibitsTheUseOfExplicitlyUndeclaredVariables>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(ProhibitsTheUseOfExplicitlyUndeclaredVariables value)
        {
        ...
        /// </returns>
        public static bool operator ==(in ProhibitsTheUseOfExplicitlyUndeclaredVariables left, in ProhibitsTheUseOfExplicitlyUndeclaredVariables right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ProhibitsTheUseOfExplicitlyUndeclaredVariables left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ProhibitsTheUseOfExplicitlyUndeclaredVariables instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ProhibitsTheUseOfExplicitlyUndeclaredVariables(JsonElement instance)
        {
            return ProhibitsTheUseOfExplicitlyUndeclaredVariables.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProhibitsTheUseOfExplicitlyUndeclaredVariables From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProhibitsTheUseOfExplicitlyUndeclaredVariables ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ProhibitsTheUseOfExplicitlyUndeclaredVariables>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProhibitsTheUseOfExplicitlyUndeclaredVariables ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ProhibitsTheUseOfExplicitlyUndeclaredVariables>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProhibitsTheUseOfExplicitlyUndeclaredVariables ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ProhibitsTheUseOfExplicitlyUndeclaredVariables>(json, options);
        }
        ...
        /// </exception>
        public static ProhibitsTheUseOfExplicitlyUndeclaredVariables ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ProhibitsTheUseOfExplicitlyUndeclaredVariables>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ProhibitsTheUseOfExplicitlyUndeclaredVariables? result)
        {
            return JsonElementHelpers.TryParseValue<ProhibitsTheUseOfExplicitlyUndeclaredVariables>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ProhibitsTheUseOfExplicitlyUndeclaredVariables(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ProhibitsTheUseOfExplicitlyUndeclaredVariables IJsonElement<ProhibitsTheUseOfExplicitlyUndeclaredVariables>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ProhibitsTheUseOfExplicitlyUndeclaredVariables: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ProhibitsTheUseOfExplicitlyUndeclaredVariables"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ProhibitsTheUseOfExplicitlyUndeclaredVariables"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ProhibitsTheUseOfExplicitlyUndeclaredVariables Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ProhibitsTheUseOfExplicitlyUndeclaredVariables>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ProhibitsTheUseOfExplicitlyUndeclaredVariables"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ProhibitsTheUseOfExplicitlyUndeclaredVariables Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ProhibitsTheUseOfExplicitlyUndeclaredVariables>(_idx);
            }
