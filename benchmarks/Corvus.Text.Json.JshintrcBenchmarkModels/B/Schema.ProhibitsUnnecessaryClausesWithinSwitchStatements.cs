...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProhibitsUnnecessaryClausesWithinSwitchStatements"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ProhibitsUnnecessaryClausesWithinSwitchStatements(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ProhibitsUnnecessaryClausesWithinSwitchStatements DefaultInstance { get; } = ParsedJsonDocument<ProhibitsUnnecessaryClausesWithinSwitchStatements>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(ProhibitsUnnecessaryClausesWithinSwitchStatements value)
        {
        ...
        /// </returns>
        public static bool operator ==(in ProhibitsUnnecessaryClausesWithinSwitchStatements left, in ProhibitsUnnecessaryClausesWithinSwitchStatements right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ProhibitsUnnecessaryClausesWithinSwitchStatements left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ProhibitsUnnecessaryClausesWithinSwitchStatements instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ProhibitsUnnecessaryClausesWithinSwitchStatements(JsonElement instance)
        {
            return ProhibitsUnnecessaryClausesWithinSwitchStatements.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProhibitsUnnecessaryClausesWithinSwitchStatements From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProhibitsUnnecessaryClausesWithinSwitchStatements ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ProhibitsUnnecessaryClausesWithinSwitchStatements>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProhibitsUnnecessaryClausesWithinSwitchStatements ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ProhibitsUnnecessaryClausesWithinSwitchStatements>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProhibitsUnnecessaryClausesWithinSwitchStatements ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ProhibitsUnnecessaryClausesWithinSwitchStatements>(json, options);
        }
        ...
        /// </exception>
        public static ProhibitsUnnecessaryClausesWithinSwitchStatements ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ProhibitsUnnecessaryClausesWithinSwitchStatements>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ProhibitsUnnecessaryClausesWithinSwitchStatements? result)
        {
            return JsonElementHelpers.TryParseValue<ProhibitsUnnecessaryClausesWithinSwitchStatements>(ref reader, out result);
        }
...
#if NET
        static ProhibitsUnnecessaryClausesWithinSwitchStatements IJsonElement<ProhibitsUnnecessaryClausesWithinSwitchStatements>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ProhibitsUnnecessaryClausesWithinSwitchStatements: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public ProhibitsUnnecessaryClausesWithinSwitchStatements Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public ProhibitsUnnecessaryClausesWithinSwitchStatements Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ProhibitsUnnecessaryClausesWithinSwitchStatements>(_idx);
            }
