...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RegexpuEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RegexpuEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RegexpuEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RegexpuEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RegexpuEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly RegexpuEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly RegexpuEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RegexpuEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(RegexpuEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<RegexpuEntity, Mutable>(this);
        }
    }
}
