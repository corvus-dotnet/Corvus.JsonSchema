...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ShadowEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ShadowEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ShadowEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ShadowEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ShadowEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ShadowEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ShadowEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ShadowEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ShadowEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ShadowEntity, Mutable>(this);
        }
    }
}
