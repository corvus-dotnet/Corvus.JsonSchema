...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SingleGroupsEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(SingleGroupsEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SingleGroupsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SingleGroupsEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SingleGroupsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SingleGroupsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SingleGroupsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SingleGroupsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly SingleGroupsEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SingleGroupsEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SingleGroupsEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly SingleGroupsEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SingleGroupsEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(SingleGroupsEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<SingleGroupsEntity, Mutable>(this);
        }
    }
}
