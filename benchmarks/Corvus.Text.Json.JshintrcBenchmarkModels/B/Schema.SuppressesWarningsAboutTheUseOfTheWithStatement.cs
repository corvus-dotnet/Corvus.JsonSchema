...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SuppressesWarningsAboutTheUseOfTheWithStatement
#if NET8_0_OR_GREATER
        : IJsonElement<SuppressesWarningsAboutTheUseOfTheWithStatement>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SuppressesWarningsAboutTheUseOfTheWithStatement"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal SuppressesWarningsAboutTheUseOfTheWithStatement(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static SuppressesWarningsAboutTheUseOfTheWithStatement DefaultInstance { get; } = ParsedJsonDocument<SuppressesWarningsAboutTheUseOfTheWithStatement>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(SuppressesWarningsAboutTheUseOfTheWithStatement value)
        {
        ...
        /// </returns>
        public static bool operator ==(in SuppressesWarningsAboutTheUseOfTheWithStatement left, in SuppressesWarningsAboutTheUseOfTheWithStatement right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SuppressesWarningsAboutTheUseOfTheWithStatement left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(SuppressesWarningsAboutTheUseOfTheWithStatement instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SuppressesWarningsAboutTheUseOfTheWithStatement(JsonElement instance)
        {
            return SuppressesWarningsAboutTheUseOfTheWithStatement.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutTheUseOfTheWithStatement From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutTheUseOfTheWithStatement ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutTheUseOfTheWithStatement>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutTheUseOfTheWithStatement ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutTheUseOfTheWithStatement>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutTheUseOfTheWithStatement ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutTheUseOfTheWithStatement>(json, options);
        }
        ...
        /// </exception>
        public static SuppressesWarningsAboutTheUseOfTheWithStatement ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutTheUseOfTheWithStatement>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SuppressesWarningsAboutTheUseOfTheWithStatement? result)
        {
            return JsonElementHelpers.TryParseValue<SuppressesWarningsAboutTheUseOfTheWithStatement>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new SuppressesWarningsAboutTheUseOfTheWithStatement(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static SuppressesWarningsAboutTheUseOfTheWithStatement IJsonElement<SuppressesWarningsAboutTheUseOfTheWithStatement>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SuppressesWarningsAboutTheUseOfTheWithStatement: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="SuppressesWarningsAboutTheUseOfTheWithStatement"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="SuppressesWarningsAboutTheUseOfTheWithStatement"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public SuppressesWarningsAboutTheUseOfTheWithStatement Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<SuppressesWarningsAboutTheUseOfTheWithStatement>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="SuppressesWarningsAboutTheUseOfTheWithStatement"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public SuppressesWarningsAboutTheUseOfTheWithStatement Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<SuppressesWarningsAboutTheUseOfTheWithStatement>(_idx);
            }
