...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ValidthisEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ValidthisEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ValidthisEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ValidthisEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ValidthisEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ValidthisEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ValidthisEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ValidthisEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ValidthisEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ValidthisEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ValidthisEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ValidthisEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ValidthisEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ValidthisEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ValidthisEntity, Mutable>(this);
        }
    }
}
