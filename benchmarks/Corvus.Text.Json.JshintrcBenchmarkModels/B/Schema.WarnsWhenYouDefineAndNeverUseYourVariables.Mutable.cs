...
public readonly partial struct Schema
{
    ...
    public readonly partial struct WarnsWhenYouDefineAndNeverUseYourVariables
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(WarnsWhenYouDefineAndNeverUseYourVariables instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="WarnsWhenYouDefineAndNeverUseYourVariables"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator WarnsWhenYouDefineAndNeverUseYourVariables(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new WarnsWhenYouDefineAndNeverUseYourVariables(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"WarnsWhenYouDefineAndNeverUseYourVariables.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="WarnsWhenYouDefineAndNeverUseYourVariables"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="WarnsWhenYouDefineAndNeverUseYourVariables"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly WarnsWhenYouDefineAndNeverUseYourVariables Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<WarnsWhenYouDefineAndNeverUseYourVariables>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="WarnsWhenYouDefineAndNeverUseYourVariables"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly WarnsWhenYouDefineAndNeverUseYourVariables Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<WarnsWhenYouDefineAndNeverUseYourVariables>(_idx);
            }
            ...
            /// <param name="matchVars">Match 3rd item.</param>
            /// <param name="matchStrict">Match 4th item.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Func<TContext, TResult> matchVars,
                Func<TContext, TResult> matchStrict,
...
#endif
            {
                ...
                {
                    return matchVars(context);
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchStrict(context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Func<TResult> matchVars,
                Func<TResult> matchStrict,
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(WarnsWhenYouDefineAndNeverUseYourVariables instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<WarnsWhenYouDefineAndNeverUseYourVariables, Mutable>(this);
        }
    }
}
