...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct BossEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<BossEntity, Mutable>(BossEntity.DefaultInstance);
        ...
        public static ParsedJsonDocument<BossEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<BossEntity>();
            }
            finally
            {
