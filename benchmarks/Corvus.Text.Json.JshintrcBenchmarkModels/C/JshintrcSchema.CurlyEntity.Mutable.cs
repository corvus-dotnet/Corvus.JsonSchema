...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct CurlyEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<CurlyEntity, Mutable>(CurlyEntity.DefaultInstance);
        ...
        public static ParsedJsonDocument<CurlyEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<CurlyEntity>();
            }
            finally
            {
