...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct ElisionEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ElisionEntity, Mutable>(ElisionEntity.DefaultInstance);
        ...
        public static ParsedJsonDocument<ElisionEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ElisionEntity>();
            }
            finally
            {
