...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct EnvironmentBrowserify
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnvironmentBrowserify, Mutable>(EnvironmentBrowserify.DefaultInstance);
            ...
            public static explicit operator Mutable(EnvironmentBrowserify instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EnvironmentBrowserify"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnvironmentBrowserify(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new EnvironmentBrowserify(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnvironmentBrowserify.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="EnvironmentBrowserify"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="EnvironmentBrowserify"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentBrowserify Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<EnvironmentBrowserify>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="EnvironmentBrowserify"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentBrowserify Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EnvironmentBrowserify>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EnvironmentBrowserify instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<EnvironmentBrowserify, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<EnvironmentBrowserify> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EnvironmentBrowserify>();
            }
            finally
            {
