...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct EnvironmentCouchDb
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnvironmentCouchDb, Mutable>(EnvironmentCouchDb.DefaultInstance);
        ...
        public static ParsedJsonDocument<EnvironmentCouchDb> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EnvironmentCouchDb>();
            }
            finally
            {
