...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct EnvironmentDefinesGlobalsExposedByTheShellJsLibrary
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnvironmentDefinesGlobalsExposedByTheShellJsLibrary, Mutable>(EnvironmentDefinesGlobalsExposedByTheShellJsLibrary.DefaultInstance);
            ...
            public static explicit operator Mutable(EnvironmentDefinesGlobalsExposedByTheShellJsLibrary instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EnvironmentDefinesGlobalsExposedByTheShellJsLibrary"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnvironmentDefinesGlobalsExposedByTheShellJsLibrary(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new EnvironmentDefinesGlobalsExposedByTheShellJsLibrary(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnvironmentDefinesGlobalsExposedByTheShellJsLibrary.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="EnvironmentDefinesGlobalsExposedByTheShellJsLibrary"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="EnvironmentDefinesGlobalsExposedByTheShellJsLibrary"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentDefinesGlobalsExposedByTheShellJsLibrary Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<EnvironmentDefinesGlobalsExposedByTheShellJsLibrary>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="EnvironmentDefinesGlobalsExposedByTheShellJsLibrary"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentDefinesGlobalsExposedByTheShellJsLibrary Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EnvironmentDefinesGlobalsExposedByTheShellJsLibrary>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EnvironmentDefinesGlobalsExposedByTheShellJsLibrary instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<EnvironmentDefinesGlobalsExposedByTheShellJsLibrary, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<EnvironmentDefinesGlobalsExposedByTheShellJsLibrary> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EnvironmentDefinesGlobalsExposedByTheShellJsLibrary>();
            }
            finally
            {
