...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct EnvironmentDefinesGlobalsForTypedArrayConstructors
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnvironmentDefinesGlobalsForTypedArrayConstructors, Mutable>(EnvironmentDefinesGlobalsForTypedArrayConstructors.DefaultInstance);
            ...
            public static explicit operator Mutable(EnvironmentDefinesGlobalsForTypedArrayConstructors instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EnvironmentDefinesGlobalsForTypedArrayConstructors"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnvironmentDefinesGlobalsForTypedArrayConstructors(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnvironmentDefinesGlobalsForTypedArrayConstructors.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentDefinesGlobalsForTypedArrayConstructors Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentDefinesGlobalsForTypedArrayConstructors Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EnvironmentDefinesGlobalsForTypedArrayConstructors>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EnvironmentDefinesGlobalsForTypedArrayConstructors instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<EnvironmentDefinesGlobalsForTypedArrayConstructors, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<EnvironmentDefinesGlobalsForTypedArrayConstructors> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EnvironmentDefinesGlobalsForTypedArrayConstructors>();
            }
            finally
            {
