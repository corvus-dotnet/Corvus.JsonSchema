...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct EnvironmentDefinesGlobalsForTypedArrayConstructors
#if NET8_0_OR_GREATER
        : IJsonElement<EnvironmentDefinesGlobalsForTypedArrayConstructors>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnvironmentDefinesGlobalsForTypedArrayConstructors"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal EnvironmentDefinesGlobalsForTypedArrayConstructors(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static EnvironmentDefinesGlobalsForTypedArrayConstructors DefaultInstance { get; } = ParsedJsonDocument<EnvironmentDefinesGlobalsForTypedArrayConstructors>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(EnvironmentDefinesGlobalsForTypedArrayConstructors value)
        {
        ...
        /// </returns>
        public static bool operator ==(in EnvironmentDefinesGlobalsForTypedArrayConstructors left, in EnvironmentDefinesGlobalsForTypedArrayConstructors right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in EnvironmentDefinesGlobalsForTypedArrayConstructors left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(EnvironmentDefinesGlobalsForTypedArrayConstructors instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator EnvironmentDefinesGlobalsForTypedArrayConstructors(JsonElement instance)
        {
            return EnvironmentDefinesGlobalsForTypedArrayConstructors.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentDefinesGlobalsForTypedArrayConstructors From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentDefinesGlobalsForTypedArrayConstructors ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentDefinesGlobalsForTypedArrayConstructors>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentDefinesGlobalsForTypedArrayConstructors ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentDefinesGlobalsForTypedArrayConstructors>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentDefinesGlobalsForTypedArrayConstructors ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentDefinesGlobalsForTypedArrayConstructors>(json, options);
        }
        ...
        /// </exception>
        public static EnvironmentDefinesGlobalsForTypedArrayConstructors ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<EnvironmentDefinesGlobalsForTypedArrayConstructors>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out EnvironmentDefinesGlobalsForTypedArrayConstructors? result)
        {
            return JsonElementHelpers.TryParseValue<EnvironmentDefinesGlobalsForTypedArrayConstructors>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new EnvironmentDefinesGlobalsForTypedArrayConstructors(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static EnvironmentDefinesGlobalsForTypedArrayConstructors IJsonElement<EnvironmentDefinesGlobalsForTypedArrayConstructors>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"EnvironmentDefinesGlobalsForTypedArrayConstructors: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="EnvironmentDefinesGlobalsForTypedArrayConstructors"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="EnvironmentDefinesGlobalsForTypedArrayConstructors"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public EnvironmentDefinesGlobalsForTypedArrayConstructors Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<EnvironmentDefinesGlobalsForTypedArrayConstructors>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="EnvironmentDefinesGlobalsForTypedArrayConstructors"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public EnvironmentDefinesGlobalsForTypedArrayConstructors Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<EnvironmentDefinesGlobalsForTypedArrayConstructors>(_idx);
            }
