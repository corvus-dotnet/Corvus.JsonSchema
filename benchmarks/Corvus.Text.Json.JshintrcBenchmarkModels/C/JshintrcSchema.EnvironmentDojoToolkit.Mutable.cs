...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct EnvironmentDojoToolkit
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnvironmentDojoToolkit, Mutable>(EnvironmentDojoToolkit.DefaultInstance);
        ...
        public static ParsedJsonDocument<EnvironmentDojoToolkit> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EnvironmentDojoToolkit>();
            }
            finally
            {
