...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct EnvironmentEs6Module
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnvironmentEs6Module, Mutable>(EnvironmentEs6Module.DefaultInstance);
            ...
            public static explicit operator Mutable(EnvironmentEs6Module instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EnvironmentEs6Module"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnvironmentEs6Module(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnvironmentEs6Module.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentEs6Module Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentEs6Module Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EnvironmentEs6Module>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EnvironmentEs6Module instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<EnvironmentEs6Module, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<EnvironmentEs6Module> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EnvironmentEs6Module>();
            }
            finally
            {
