...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct EnvironmentJQuery
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnvironmentJQuery, Mutable>(EnvironmentJQuery.DefaultInstance);
            ...
            public static explicit operator Mutable(EnvironmentJQuery instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EnvironmentJQuery"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnvironmentJQuery(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnvironmentJQuery.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentJQuery Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentJQuery Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EnvironmentJQuery>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EnvironmentJQuery instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<EnvironmentJQuery, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<EnvironmentJQuery> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EnvironmentJQuery>();
            }
            finally
            {
