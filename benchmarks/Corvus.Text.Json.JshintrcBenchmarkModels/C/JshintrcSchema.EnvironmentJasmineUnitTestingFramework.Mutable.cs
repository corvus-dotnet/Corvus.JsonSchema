...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct EnvironmentJasmineUnitTestingFramework
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnvironmentJasmineUnitTestingFramework, Mutable>(EnvironmentJasmineUnitTestingFramework.DefaultInstance);
        ...
        public static ParsedJsonDocument<EnvironmentJasmineUnitTestingFramework> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EnvironmentJasmineUnitTestingFramework>();
            }
            finally
            {
