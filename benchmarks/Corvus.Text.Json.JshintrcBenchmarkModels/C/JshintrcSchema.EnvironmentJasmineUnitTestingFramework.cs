...
public readonly partial struct JshintrcSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnvironmentJasmineUnitTestingFramework"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal EnvironmentJasmineUnitTestingFramework(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static EnvironmentJasmineUnitTestingFramework DefaultInstance { get; } = ParsedJsonDocument<EnvironmentJasmineUnitTestingFramework>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(EnvironmentJasmineUnitTestingFramework value)
        {
        ...
        /// </returns>
        public static bool operator ==(in EnvironmentJasmineUnitTestingFramework left, in EnvironmentJasmineUnitTestingFramework right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in EnvironmentJasmineUnitTestingFramework left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(EnvironmentJasmineUnitTestingFramework instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator EnvironmentJasmineUnitTestingFramework(JsonElement instance)
        {
            return EnvironmentJasmineUnitTestingFramework.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentJasmineUnitTestingFramework From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentJasmineUnitTestingFramework ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentJasmineUnitTestingFramework>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentJasmineUnitTestingFramework ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentJasmineUnitTestingFramework>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentJasmineUnitTestingFramework ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentJasmineUnitTestingFramework>(json, options);
        }
        ...
        /// </exception>
        public static EnvironmentJasmineUnitTestingFramework ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<EnvironmentJasmineUnitTestingFramework>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out EnvironmentJasmineUnitTestingFramework? result)
        {
            return JsonElementHelpers.TryParseValue<EnvironmentJasmineUnitTestingFramework>(ref reader, out result);
        }
...
#if NET
        static EnvironmentJasmineUnitTestingFramework IJsonElement<EnvironmentJasmineUnitTestingFramework>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"EnvironmentJasmineUnitTestingFramework: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public EnvironmentJasmineUnitTestingFramework Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public EnvironmentJasmineUnitTestingFramework Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<EnvironmentJasmineUnitTestingFramework>(_idx);
            }
