...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct EnvironmentMochaUnitTestingFramework
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnvironmentMochaUnitTestingFramework, Mutable>(EnvironmentMochaUnitTestingFramework.DefaultInstance);
            ...
            public static explicit operator Mutable(EnvironmentMochaUnitTestingFramework instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EnvironmentMochaUnitTestingFramework"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnvironmentMochaUnitTestingFramework(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new EnvironmentMochaUnitTestingFramework(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnvironmentMochaUnitTestingFramework.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="EnvironmentMochaUnitTestingFramework"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="EnvironmentMochaUnitTestingFramework"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentMochaUnitTestingFramework Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<EnvironmentMochaUnitTestingFramework>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="EnvironmentMochaUnitTestingFramework"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentMochaUnitTestingFramework Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EnvironmentMochaUnitTestingFramework>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EnvironmentMochaUnitTestingFramework instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<EnvironmentMochaUnitTestingFramework, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<EnvironmentMochaUnitTestingFramework> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EnvironmentMochaUnitTestingFramework>();
            }
            finally
            {
