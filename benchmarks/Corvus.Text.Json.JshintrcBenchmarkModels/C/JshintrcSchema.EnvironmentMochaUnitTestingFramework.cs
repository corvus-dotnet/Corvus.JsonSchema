...
public readonly partial struct JshintrcSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnvironmentMochaUnitTestingFramework"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal EnvironmentMochaUnitTestingFramework(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static EnvironmentMochaUnitTestingFramework DefaultInstance { get; } = ParsedJsonDocument<EnvironmentMochaUnitTestingFramework>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(EnvironmentMochaUnitTestingFramework value)
        {
        ...
        /// </returns>
        public static bool operator ==(in EnvironmentMochaUnitTestingFramework left, in EnvironmentMochaUnitTestingFramework right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in EnvironmentMochaUnitTestingFramework left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(EnvironmentMochaUnitTestingFramework instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator EnvironmentMochaUnitTestingFramework(JsonElement instance)
        {
            return EnvironmentMochaUnitTestingFramework.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentMochaUnitTestingFramework From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentMochaUnitTestingFramework ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentMochaUnitTestingFramework>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentMochaUnitTestingFramework ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentMochaUnitTestingFramework>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentMochaUnitTestingFramework ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentMochaUnitTestingFramework>(json, options);
        }
        ...
        /// </exception>
        public static EnvironmentMochaUnitTestingFramework ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<EnvironmentMochaUnitTestingFramework>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out EnvironmentMochaUnitTestingFramework? result)
        {
            return JsonElementHelpers.TryParseValue<EnvironmentMochaUnitTestingFramework>(ref reader, out result);
        }
...
#if NET
        static EnvironmentMochaUnitTestingFramework IJsonElement<EnvironmentMochaUnitTestingFramework>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"EnvironmentMochaUnitTestingFramework: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public EnvironmentMochaUnitTestingFramework Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public EnvironmentMochaUnitTestingFramework Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<EnvironmentMochaUnitTestingFramework>(_idx);
            }
