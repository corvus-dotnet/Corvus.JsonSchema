...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct EnvironmentNodeJs
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnvironmentNodeJs, Mutable>(EnvironmentNodeJs.DefaultInstance);
            ...
            public static explicit operator Mutable(EnvironmentNodeJs instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EnvironmentNodeJs"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnvironmentNodeJs(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnvironmentNodeJs.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentNodeJs Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentNodeJs Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EnvironmentNodeJs>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EnvironmentNodeJs instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<EnvironmentNodeJs, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<EnvironmentNodeJs> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EnvironmentNodeJs>();
            }
            finally
            {
