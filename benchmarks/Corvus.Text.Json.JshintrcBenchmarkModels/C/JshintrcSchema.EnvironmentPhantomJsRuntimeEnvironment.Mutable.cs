...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct EnvironmentPhantomJsRuntimeEnvironment
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnvironmentPhantomJsRuntimeEnvironment, Mutable>(EnvironmentPhantomJsRuntimeEnvironment.DefaultInstance);
            ...
            public static explicit operator Mutable(EnvironmentPhantomJsRuntimeEnvironment instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EnvironmentPhantomJsRuntimeEnvironment"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnvironmentPhantomJsRuntimeEnvironment(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnvironmentPhantomJsRuntimeEnvironment.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentPhantomJsRuntimeEnvironment Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentPhantomJsRuntimeEnvironment Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EnvironmentPhantomJsRuntimeEnvironment>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EnvironmentPhantomJsRuntimeEnvironment instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<EnvironmentPhantomJsRuntimeEnvironment, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<EnvironmentPhantomJsRuntimeEnvironment> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EnvironmentPhantomJsRuntimeEnvironment>();
            }
            finally
            {
