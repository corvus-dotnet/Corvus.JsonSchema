...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct EnvironmentPrototypeJavaScriptFramework
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnvironmentPrototypeJavaScriptFramework, Mutable>(EnvironmentPrototypeJavaScriptFramework.DefaultInstance);
            ...
            public static explicit operator Mutable(EnvironmentPrototypeJavaScriptFramework instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EnvironmentPrototypeJavaScriptFramework"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnvironmentPrototypeJavaScriptFramework(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new EnvironmentPrototypeJavaScriptFramework(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnvironmentPrototypeJavaScriptFramework.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="EnvironmentPrototypeJavaScriptFramework"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="EnvironmentPrototypeJavaScriptFramework"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentPrototypeJavaScriptFramework Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<EnvironmentPrototypeJavaScriptFramework>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="EnvironmentPrototypeJavaScriptFramework"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentPrototypeJavaScriptFramework Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EnvironmentPrototypeJavaScriptFramework>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EnvironmentPrototypeJavaScriptFramework instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<EnvironmentPrototypeJavaScriptFramework, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<EnvironmentPrototypeJavaScriptFramework> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EnvironmentPrototypeJavaScriptFramework>();
            }
            finally
            {
