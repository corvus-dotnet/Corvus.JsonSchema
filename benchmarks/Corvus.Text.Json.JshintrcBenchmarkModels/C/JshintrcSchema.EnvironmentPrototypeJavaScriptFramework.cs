...
public readonly partial struct JshintrcSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnvironmentPrototypeJavaScriptFramework"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal EnvironmentPrototypeJavaScriptFramework(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static EnvironmentPrototypeJavaScriptFramework DefaultInstance { get; } = ParsedJsonDocument<EnvironmentPrototypeJavaScriptFramework>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(EnvironmentPrototypeJavaScriptFramework value)
        {
        ...
        /// </returns>
        public static bool operator ==(in EnvironmentPrototypeJavaScriptFramework left, in EnvironmentPrototypeJavaScriptFramework right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in EnvironmentPrototypeJavaScriptFramework left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(EnvironmentPrototypeJavaScriptFramework instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator EnvironmentPrototypeJavaScriptFramework(JsonElement instance)
        {
            return EnvironmentPrototypeJavaScriptFramework.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentPrototypeJavaScriptFramework From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentPrototypeJavaScriptFramework ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentPrototypeJavaScriptFramework>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentPrototypeJavaScriptFramework ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentPrototypeJavaScriptFramework>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentPrototypeJavaScriptFramework ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentPrototypeJavaScriptFramework>(json, options);
        }
        ...
        /// </exception>
        public static EnvironmentPrototypeJavaScriptFramework ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<EnvironmentPrototypeJavaScriptFramework>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out EnvironmentPrototypeJavaScriptFramework? result)
        {
            return JsonElementHelpers.TryParseValue<EnvironmentPrototypeJavaScriptFramework>(ref reader, out result);
        }
...
#if NET
        static EnvironmentPrototypeJavaScriptFramework IJsonElement<EnvironmentPrototypeJavaScriptFramework>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"EnvironmentPrototypeJavaScriptFramework: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public EnvironmentPrototypeJavaScriptFramework Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public EnvironmentPrototypeJavaScriptFramework Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<EnvironmentPrototypeJavaScriptFramework>(_idx);
            }
