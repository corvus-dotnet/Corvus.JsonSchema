...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct EnvironmentWebBrowserWindowDocumentEtc
        ...
        : IJsonElement<EnvironmentWebBrowserWindowDocumentEtc>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnvironmentWebBrowserWindowDocumentEtc"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal EnvironmentWebBrowserWindowDocumentEtc(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static EnvironmentWebBrowserWindowDocumentEtc DefaultInstance { get; } = ParsedJsonDocument<EnvironmentWebBrowserWindowDocumentEtc>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(EnvironmentWebBrowserWindowDocumentEtc value)
        {
        ...
        /// </returns>
        public static bool operator ==(in EnvironmentWebBrowserWindowDocumentEtc left, in EnvironmentWebBrowserWindowDocumentEtc right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in EnvironmentWebBrowserWindowDocumentEtc left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(EnvironmentWebBrowserWindowDocumentEtc instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator EnvironmentWebBrowserWindowDocumentEtc(JsonElement instance)
        {
            return EnvironmentWebBrowserWindowDocumentEtc.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentWebBrowserWindowDocumentEtc From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentWebBrowserWindowDocumentEtc ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentWebBrowserWindowDocumentEtc>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentWebBrowserWindowDocumentEtc ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentWebBrowserWindowDocumentEtc>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentWebBrowserWindowDocumentEtc ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentWebBrowserWindowDocumentEtc>(json, options);
        }
        ...
        /// </exception>
        public static EnvironmentWebBrowserWindowDocumentEtc ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<EnvironmentWebBrowserWindowDocumentEtc>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out EnvironmentWebBrowserWindowDocumentEtc? result)
        {
            return JsonElementHelpers.TryParseValue<EnvironmentWebBrowserWindowDocumentEtc>(ref reader, out result);
        }
...
#if NET
        static EnvironmentWebBrowserWindowDocumentEtc IJsonElement<EnvironmentWebBrowserWindowDocumentEtc>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"EnvironmentWebBrowserWindowDocumentEtc: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public EnvironmentWebBrowserWindowDocumentEtc Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public EnvironmentWebBrowserWindowDocumentEtc Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<EnvironmentWebBrowserWindowDocumentEtc>(_idx);
            }
