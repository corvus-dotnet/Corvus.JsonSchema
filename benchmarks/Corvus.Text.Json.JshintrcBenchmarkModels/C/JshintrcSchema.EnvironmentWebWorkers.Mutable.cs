...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct EnvironmentWebWorkers
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnvironmentWebWorkers, Mutable>(EnvironmentWebWorkers.DefaultInstance);
            ...
            public static explicit operator Mutable(EnvironmentWebWorkers instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EnvironmentWebWorkers"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnvironmentWebWorkers(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnvironmentWebWorkers.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentWebWorkers Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentWebWorkers Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EnvironmentWebWorkers>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EnvironmentWebWorkers instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<EnvironmentWebWorkers, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<EnvironmentWebWorkers> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EnvironmentWebWorkers>();
            }
            finally
            {
