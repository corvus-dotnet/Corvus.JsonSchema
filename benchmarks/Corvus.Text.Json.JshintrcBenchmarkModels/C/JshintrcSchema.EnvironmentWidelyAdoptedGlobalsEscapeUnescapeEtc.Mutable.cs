...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc, Mutable>(EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc.DefaultInstance);
            ...
            public static explicit operator Mutable(EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc>();
            }
            finally
            {
