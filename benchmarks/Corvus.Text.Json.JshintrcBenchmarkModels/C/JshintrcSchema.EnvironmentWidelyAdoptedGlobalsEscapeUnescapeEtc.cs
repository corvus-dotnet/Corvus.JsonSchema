...
public readonly partial struct JshintrcSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc DefaultInstance { get; } = ParsedJsonDocument<EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc value)
        {
        ...
        /// </returns>
        public static bool operator ==(in EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc left, in EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc(JsonElement instance)
        {
            return EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc>(json, options);
        }
        ...
        /// </exception>
        public static EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc? result)
        {
            return JsonElementHelpers.TryParseValue<EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc IJsonElement<EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<EnvironmentWidelyAdoptedGlobalsEscapeUnescapeEtc>(_idx);
            }
