...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct EnvironmentWindowsScriptingHost
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnvironmentWindowsScriptingHost, Mutable>(EnvironmentWindowsScriptingHost.DefaultInstance);
            ...
            public static explicit operator Mutable(EnvironmentWindowsScriptingHost instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EnvironmentWindowsScriptingHost"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnvironmentWindowsScriptingHost(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnvironmentWindowsScriptingHost.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentWindowsScriptingHost Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentWindowsScriptingHost Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EnvironmentWindowsScriptingHost>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EnvironmentWindowsScriptingHost instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<EnvironmentWindowsScriptingHost, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<EnvironmentWindowsScriptingHost> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EnvironmentWindowsScriptingHost>();
            }
            finally
            {
