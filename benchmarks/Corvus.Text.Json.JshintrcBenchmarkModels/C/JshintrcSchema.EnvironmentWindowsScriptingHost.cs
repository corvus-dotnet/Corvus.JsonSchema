...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct EnvironmentWindowsScriptingHost
#if NET8_0_OR_GREATER
        : IJsonElement<EnvironmentWindowsScriptingHost>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnvironmentWindowsScriptingHost"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal EnvironmentWindowsScriptingHost(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static EnvironmentWindowsScriptingHost DefaultInstance { get; } = ParsedJsonDocument<EnvironmentWindowsScriptingHost>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(EnvironmentWindowsScriptingHost value)
        {
        ...
        /// </returns>
        public static bool operator ==(in EnvironmentWindowsScriptingHost left, in EnvironmentWindowsScriptingHost right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in EnvironmentWindowsScriptingHost left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(EnvironmentWindowsScriptingHost instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator EnvironmentWindowsScriptingHost(JsonElement instance)
        {
            return EnvironmentWindowsScriptingHost.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentWindowsScriptingHost From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentWindowsScriptingHost ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentWindowsScriptingHost>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentWindowsScriptingHost ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentWindowsScriptingHost>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnvironmentWindowsScriptingHost ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnvironmentWindowsScriptingHost>(json, options);
        }
        ...
        /// </exception>
        public static EnvironmentWindowsScriptingHost ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<EnvironmentWindowsScriptingHost>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out EnvironmentWindowsScriptingHost? result)
        {
            return JsonElementHelpers.TryParseValue<EnvironmentWindowsScriptingHost>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new EnvironmentWindowsScriptingHost(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static EnvironmentWindowsScriptingHost IJsonElement<EnvironmentWindowsScriptingHost>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"EnvironmentWindowsScriptingHost: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="EnvironmentWindowsScriptingHost"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="EnvironmentWindowsScriptingHost"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public EnvironmentWindowsScriptingHost Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<EnvironmentWindowsScriptingHost>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="EnvironmentWindowsScriptingHost"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public EnvironmentWindowsScriptingHost Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<EnvironmentWindowsScriptingHost>(_idx);
            }
