...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct EnvironmentYahooUserInterface
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnvironmentYahooUserInterface, Mutable>(EnvironmentYahooUserInterface.DefaultInstance);
            ...
            public static explicit operator Mutable(EnvironmentYahooUserInterface instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EnvironmentYahooUserInterface"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnvironmentYahooUserInterface(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnvironmentYahooUserInterface.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentYahooUserInterface Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly EnvironmentYahooUserInterface Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EnvironmentYahooUserInterface>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EnvironmentYahooUserInterface instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<EnvironmentYahooUserInterface, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<EnvironmentYahooUserInterface> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EnvironmentYahooUserInterface>();
            }
            finally
            {
