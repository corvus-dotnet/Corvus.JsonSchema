...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct ExprEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ExprEntity, Mutable>(ExprEntity.DefaultInstance);
        ...
        public static ParsedJsonDocument<ExprEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ExprEntity>();
            }
            finally
            {
