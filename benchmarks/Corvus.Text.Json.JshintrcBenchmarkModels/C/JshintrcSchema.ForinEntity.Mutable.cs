...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct ForinEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ForinEntity, Mutable>(ForinEntity.DefaultInstance);
            ...
            public static explicit operator Mutable(ForinEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ForinEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ForinEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ForinEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ForinEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ForinEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ForinEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ForinEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ForinEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ForinEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ForinEntity>();
            }
            finally
            {
