...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct FreezeEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<FreezeEntity, Mutable>(FreezeEntity.DefaultInstance);
            ...
            public static explicit operator Mutable(FreezeEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="FreezeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator FreezeEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"FreezeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly FreezeEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly FreezeEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<FreezeEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(FreezeEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<FreezeEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<FreezeEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<FreezeEntity>();
            }
            finally
            {
