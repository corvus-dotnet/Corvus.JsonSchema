...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct FuncscopeEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<FuncscopeEntity, Mutable>(FuncscopeEntity.DefaultInstance);
            ...
            public static explicit operator Mutable(FuncscopeEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="FuncscopeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator FuncscopeEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"FuncscopeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly FuncscopeEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly FuncscopeEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<FuncscopeEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(FuncscopeEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<FuncscopeEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<FuncscopeEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<FuncscopeEntity>();
            }
            finally
            {
