...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct FuturehostileEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<FuturehostileEntity, Mutable>(FuturehostileEntity.DefaultInstance);
        ...
        public static ParsedJsonDocument<FuturehostileEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<FuturehostileEntity>();
            }
            finally
            {
