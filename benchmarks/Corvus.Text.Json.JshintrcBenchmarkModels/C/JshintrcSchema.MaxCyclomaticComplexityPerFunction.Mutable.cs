...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct MaxCyclomaticComplexityPerFunction
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MaxCyclomaticComplexityPerFunction, Mutable>(MaxCyclomaticComplexityPerFunction.DefaultInstance);
        ...
        public static ParsedJsonDocument<MaxCyclomaticComplexityPerFunction> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MaxCyclomaticComplexityPerFunction>();
            }
            finally
            {
