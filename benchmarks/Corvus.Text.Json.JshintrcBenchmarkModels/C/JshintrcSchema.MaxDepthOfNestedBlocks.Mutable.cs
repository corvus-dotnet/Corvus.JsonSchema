...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct MaxDepthOfNestedBlocks
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MaxDepthOfNestedBlocks, Mutable>(MaxDepthOfNestedBlocks.DefaultInstance);
        ...
        public static ParsedJsonDocument<MaxDepthOfNestedBlocks> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MaxDepthOfNestedBlocks>();
            }
            finally
            {
