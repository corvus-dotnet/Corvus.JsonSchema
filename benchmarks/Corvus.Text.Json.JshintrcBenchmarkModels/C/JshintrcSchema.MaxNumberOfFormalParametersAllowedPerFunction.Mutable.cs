...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct MaxNumberOfFormalParametersAllowedPerFunction
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MaxNumberOfFormalParametersAllowedPerFunction instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MaxNumberOfFormalParametersAllowedPerFunction"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MaxNumberOfFormalParametersAllowedPerFunction(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MaxNumberOfFormalParametersAllowedPerFunction.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MaxNumberOfFormalParametersAllowedPerFunction Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MaxNumberOfFormalParametersAllowedPerFunction Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MaxNumberOfFormalParametersAllowedPerFunction>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MaxNumberOfFormalParametersAllowedPerFunction instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MaxNumberOfFormalParametersAllowedPerFunction, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MaxNumberOfFormalParametersAllowedPerFunction> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MaxNumberOfFormalParametersAllowedPerFunction>();
            }
            finally
            {
