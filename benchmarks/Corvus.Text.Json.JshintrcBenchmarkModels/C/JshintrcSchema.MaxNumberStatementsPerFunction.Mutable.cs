...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct MaxNumberStatementsPerFunction
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MaxNumberStatementsPerFunction, Mutable>(MaxNumberStatementsPerFunction.DefaultInstance);
        ...
        public static ParsedJsonDocument<MaxNumberStatementsPerFunction> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MaxNumberStatementsPerFunction>();
            }
            finally
            {
