...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp
    {
        ...
        public static ParsedJsonDocument<MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp>();
            }
            finally
            {
