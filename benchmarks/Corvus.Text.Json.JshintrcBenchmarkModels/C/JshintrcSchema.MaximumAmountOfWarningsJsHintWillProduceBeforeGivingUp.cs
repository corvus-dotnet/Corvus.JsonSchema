...
public readonly partial struct JshintrcSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp"/> struct.
        /// </summary>
        ...
        internal MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp DefaultInstance { get; } = ParsedJsonDocument<MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp>.NumberConstant([.."50"u8]);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator System.Numerics.BigInteger(MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator decimal(MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator sbyte(MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp value) => value._parent.TryGetValue(value._idx, out sbyte result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator byte(MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp value) => value._parent.TryGetValue(value._idx, out byte result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator short(MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp value) => value._parent.TryGetValue(value._idx, out short result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator ushort(MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp value) => value._parent.TryGetValue(value._idx, out ushort result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator int(MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp value) => value._parent.TryGetValue(value._idx, out int result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator uint(MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp value) => value._parent.TryGetValue(value._idx, out uint result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator ulong(MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp value) => value._parent.TryGetValue(value._idx, out ulong result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator float(MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp value) => value._parent.TryGetValue(value._idx, out float result) ? result : throw new FormatException();

#if NET
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Int128(MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp value) => value._parent.TryGetValue(value._idx, out Int128 result) ? result : throw new FormatException();
#endif

#if NET
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator UInt128(MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp value) => value._parent.TryGetValue(value._idx, out UInt128 result) ? result : throw new FormatException();
#endif

#if NET
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Half(MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp value) => value._parent.TryGetValue(value._idx, out Half result) ? result : throw new FormatException();
#endif
        ...
        /// </returns>
        public static bool operator ==(in MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp left, in MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp(JsonElement instance)
        {
            return MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp? result)
        {
            return JsonElementHelpers.TryParseValue<MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp>(ref reader, out result);
        }
...
#if NET
        static MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp IJsonElement<MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<MaximumAmountOfWarningsJsHintWillProduceBeforeGivingUp>(_idx);
            }
