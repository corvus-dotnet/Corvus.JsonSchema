...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct NoargEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(NoargEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="NoargEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NoargEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new NoargEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"NoargEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="NoargEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="NoargEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly NoargEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<NoargEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="NoargEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly NoargEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<NoargEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(NoargEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<NoargEntity, Mutable>(this);
        }
    }
}
