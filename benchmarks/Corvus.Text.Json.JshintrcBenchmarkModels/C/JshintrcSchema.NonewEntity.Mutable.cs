...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct NonewEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NonewEntity, Mutable>(NonewEntity.DefaultInstance);
            ...
            public static explicit operator Mutable(NonewEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="NonewEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NonewEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new NonewEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"NonewEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="NonewEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="NonewEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly NonewEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<NonewEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="NonewEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly NonewEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<NonewEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(NonewEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<NonewEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<NonewEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<NonewEntity>();
            }
            finally
            {
