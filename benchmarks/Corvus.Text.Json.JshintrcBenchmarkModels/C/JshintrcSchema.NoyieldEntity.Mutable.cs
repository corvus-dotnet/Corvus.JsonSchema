...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct NoyieldEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NoyieldEntity, Mutable>(NoyieldEntity.DefaultInstance);
            ...
            public static explicit operator Mutable(NoyieldEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="NoyieldEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NoyieldEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new NoyieldEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"NoyieldEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="NoyieldEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="NoyieldEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly NoyieldEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<NoyieldEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="NoyieldEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly NoyieldEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<NoyieldEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(NoyieldEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<NoyieldEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<NoyieldEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<NoyieldEntity>();
            }
            finally
            {
