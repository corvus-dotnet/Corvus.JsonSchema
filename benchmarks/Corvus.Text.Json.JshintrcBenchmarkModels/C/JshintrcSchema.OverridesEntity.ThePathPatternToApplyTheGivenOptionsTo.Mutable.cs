...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct OverridesEntity
    {
        ...
        public readonly partial struct ThePathPatternToApplyTheGivenOptionsTo
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ThePathPatternToApplyTheGivenOptionsTo instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ThePathPatternToApplyTheGivenOptionsTo"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ThePathPatternToApplyTheGivenOptionsTo(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ThePathPatternToApplyTheGivenOptionsTo(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ThePathPatternToApplyTheGivenOptionsTo.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ThePathPatternToApplyTheGivenOptionsTo"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ThePathPatternToApplyTheGivenOptionsTo"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ThePathPatternToApplyTheGivenOptionsTo Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ThePathPatternToApplyTheGivenOptionsTo>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ThePathPatternToApplyTheGivenOptionsTo"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ThePathPatternToApplyTheGivenOptionsTo Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ThePathPatternToApplyTheGivenOptionsTo>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.JshintrcBenchmark.Current.JshintrcSchema.OverridesEntity.ThePathPatternToApplyTheGivenOptionsTo.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(ThePathPatternToApplyTheGivenOptionsTo instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.JshintrcBenchmark.Current.JshintrcSchema.OverridesEntity.ThePathPatternToApplyTheGivenOptionsTo.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<ThePathPatternToApplyTheGivenOptionsTo, Mutable>(this);
            }
        }
    }
}
