...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct ProhibitTheUseOfBitwiseOperatorsEtc
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ProhibitTheUseOfBitwiseOperatorsEtc, Mutable>(ProhibitTheUseOfBitwiseOperatorsEtc.DefaultInstance);
            ...
            public static explicit operator Mutable(ProhibitTheUseOfBitwiseOperatorsEtc instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ProhibitTheUseOfBitwiseOperatorsEtc"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ProhibitTheUseOfBitwiseOperatorsEtc(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ProhibitTheUseOfBitwiseOperatorsEtc.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ProhibitTheUseOfBitwiseOperatorsEtc Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ProhibitTheUseOfBitwiseOperatorsEtc Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ProhibitTheUseOfBitwiseOperatorsEtc>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ProhibitTheUseOfBitwiseOperatorsEtc instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ProhibitTheUseOfBitwiseOperatorsEtc, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ProhibitTheUseOfBitwiseOperatorsEtc> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ProhibitTheUseOfBitwiseOperatorsEtc>();
            }
            finally
            {
