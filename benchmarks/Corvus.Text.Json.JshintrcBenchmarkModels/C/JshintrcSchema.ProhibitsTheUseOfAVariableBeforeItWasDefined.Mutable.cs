...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct ProhibitsTheUseOfAVariableBeforeItWasDefined
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ProhibitsTheUseOfAVariableBeforeItWasDefined, Mutable>(ProhibitsTheUseOfAVariableBeforeItWasDefined.DefaultInstance);
        ...
        public static ParsedJsonDocument<ProhibitsTheUseOfAVariableBeforeItWasDefined> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ProhibitsTheUseOfAVariableBeforeItWasDefined>();
            }
            finally
            {
