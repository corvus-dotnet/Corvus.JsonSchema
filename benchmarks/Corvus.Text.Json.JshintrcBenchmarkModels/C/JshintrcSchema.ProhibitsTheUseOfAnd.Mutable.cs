...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct ProhibitsTheUseOfAnd
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ProhibitsTheUseOfAnd, Mutable>(ProhibitsTheUseOfAnd.DefaultInstance);
            ...
            public static explicit operator Mutable(ProhibitsTheUseOfAnd instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ProhibitsTheUseOfAnd"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ProhibitsTheUseOfAnd(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ProhibitsTheUseOfAnd.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ProhibitsTheUseOfAnd Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ProhibitsTheUseOfAnd Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ProhibitsTheUseOfAnd>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ProhibitsTheUseOfAnd instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ProhibitsTheUseOfAnd, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ProhibitsTheUseOfAnd> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ProhibitsTheUseOfAnd>();
            }
            finally
            {
