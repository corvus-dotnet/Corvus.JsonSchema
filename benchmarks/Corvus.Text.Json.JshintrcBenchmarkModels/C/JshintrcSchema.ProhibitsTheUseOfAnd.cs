...
public readonly partial struct JshintrcSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProhibitsTheUseOfAnd"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ProhibitsTheUseOfAnd(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ProhibitsTheUseOfAnd DefaultInstance { get; } = ParsedJsonDocument<ProhibitsTheUseOfAnd>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(ProhibitsTheUseOfAnd value)
        {
        ...
        /// </returns>
        public static bool operator ==(in ProhibitsTheUseOfAnd left, in ProhibitsTheUseOfAnd right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ProhibitsTheUseOfAnd left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ProhibitsTheUseOfAnd instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ProhibitsTheUseOfAnd(JsonElement instance)
        {
            return ProhibitsTheUseOfAnd.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProhibitsTheUseOfAnd From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProhibitsTheUseOfAnd ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ProhibitsTheUseOfAnd>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProhibitsTheUseOfAnd ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ProhibitsTheUseOfAnd>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProhibitsTheUseOfAnd ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ProhibitsTheUseOfAnd>(json, options);
        }
        ...
        /// </exception>
        public static ProhibitsTheUseOfAnd ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ProhibitsTheUseOfAnd>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ProhibitsTheUseOfAnd? result)
        {
            return JsonElementHelpers.TryParseValue<ProhibitsTheUseOfAnd>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ProhibitsTheUseOfAnd(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ProhibitsTheUseOfAnd IJsonElement<ProhibitsTheUseOfAnd>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ProhibitsTheUseOfAnd: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ProhibitsTheUseOfAnd"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ProhibitsTheUseOfAnd"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ProhibitsTheUseOfAnd Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ProhibitsTheUseOfAnd>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ProhibitsTheUseOfAnd"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ProhibitsTheUseOfAnd Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ProhibitsTheUseOfAnd>(_idx);
            }
