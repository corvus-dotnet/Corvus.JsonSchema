...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct ProhibitsTheUseOfAndInFavorOfAnd
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ProhibitsTheUseOfAndInFavorOfAnd, Mutable>(ProhibitsTheUseOfAndInFavorOfAnd.DefaultInstance);
            ...
            public static explicit operator Mutable(ProhibitsTheUseOfAndInFavorOfAnd instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ProhibitsTheUseOfAndInFavorOfAnd"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ProhibitsTheUseOfAndInFavorOfAnd(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ProhibitsTheUseOfAndInFavorOfAnd.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ProhibitsTheUseOfAndInFavorOfAnd Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ProhibitsTheUseOfAndInFavorOfAnd Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ProhibitsTheUseOfAndInFavorOfAnd>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ProhibitsTheUseOfAndInFavorOfAnd instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ProhibitsTheUseOfAndInFavorOfAnd, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ProhibitsTheUseOfAndInFavorOfAnd> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ProhibitsTheUseOfAndInFavorOfAnd>();
            }
            finally
            {
