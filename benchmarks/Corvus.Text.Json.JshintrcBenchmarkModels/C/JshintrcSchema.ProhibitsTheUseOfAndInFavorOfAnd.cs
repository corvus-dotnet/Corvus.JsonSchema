...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct ProhibitsTheUseOfAndInFavorOfAnd
#if NET8_0_OR_GREATER
        : IJsonElement<ProhibitsTheUseOfAndInFavorOfAnd>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProhibitsTheUseOfAndInFavorOfAnd"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ProhibitsTheUseOfAndInFavorOfAnd(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ProhibitsTheUseOfAndInFavorOfAnd DefaultInstance { get; } = ParsedJsonDocument<ProhibitsTheUseOfAndInFavorOfAnd>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(ProhibitsTheUseOfAndInFavorOfAnd value)
        {
        ...
        /// </returns>
        public static bool operator ==(in ProhibitsTheUseOfAndInFavorOfAnd left, in ProhibitsTheUseOfAndInFavorOfAnd right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ProhibitsTheUseOfAndInFavorOfAnd left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ProhibitsTheUseOfAndInFavorOfAnd instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ProhibitsTheUseOfAndInFavorOfAnd(JsonElement instance)
        {
            return ProhibitsTheUseOfAndInFavorOfAnd.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProhibitsTheUseOfAndInFavorOfAnd From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProhibitsTheUseOfAndInFavorOfAnd ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ProhibitsTheUseOfAndInFavorOfAnd>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProhibitsTheUseOfAndInFavorOfAnd ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ProhibitsTheUseOfAndInFavorOfAnd>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProhibitsTheUseOfAndInFavorOfAnd ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ProhibitsTheUseOfAndInFavorOfAnd>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static ProhibitsTheUseOfAndInFavorOfAnd ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ProhibitsTheUseOfAndInFavorOfAnd>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ProhibitsTheUseOfAndInFavorOfAnd? result)
        {
            return JsonElementHelpers.TryParseValue<ProhibitsTheUseOfAndInFavorOfAnd>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ProhibitsTheUseOfAndInFavorOfAnd(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ProhibitsTheUseOfAndInFavorOfAnd IJsonElement<ProhibitsTheUseOfAndInFavorOfAnd>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ProhibitsTheUseOfAndInFavorOfAnd: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ProhibitsTheUseOfAndInFavorOfAnd"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ProhibitsTheUseOfAndInFavorOfAnd"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ProhibitsTheUseOfAndInFavorOfAnd Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ProhibitsTheUseOfAndInFavorOfAnd>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ProhibitsTheUseOfAndInFavorOfAnd"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ProhibitsTheUseOfAndInFavorOfAnd Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ProhibitsTheUseOfAndInFavorOfAnd>(_idx);
            }
