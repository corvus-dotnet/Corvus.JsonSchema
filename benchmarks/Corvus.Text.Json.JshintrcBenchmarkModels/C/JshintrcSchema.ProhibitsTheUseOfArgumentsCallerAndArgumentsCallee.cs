...
public readonly partial struct JshintrcSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee DefaultInstance { get; } = ParsedJsonDocument<ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee value)
        {
        ...
        /// </returns>
        public static bool operator ==(in ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee left, in ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee(JsonElement instance)
        {
            return ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee? result)
        {
            return JsonElementHelpers.TryParseValue<ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee IJsonElement<ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ProhibitsTheUseOfArgumentsCallerAndArgumentsCallee>(_idx);
            }
