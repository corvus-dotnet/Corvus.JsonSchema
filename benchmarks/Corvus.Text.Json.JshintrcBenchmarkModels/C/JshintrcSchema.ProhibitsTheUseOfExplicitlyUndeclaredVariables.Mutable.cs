...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct ProhibitsTheUseOfExplicitlyUndeclaredVariables
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ProhibitsTheUseOfExplicitlyUndeclaredVariables, Mutable>(ProhibitsTheUseOfExplicitlyUndeclaredVariables.DefaultInstance);
        ...
        public static ParsedJsonDocument<ProhibitsTheUseOfExplicitlyUndeclaredVariables> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ProhibitsTheUseOfExplicitlyUndeclaredVariables>();
            }
            finally
            {
