...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct ProhibitsUnnecessaryClausesWithinSwitchStatements
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ProhibitsUnnecessaryClausesWithinSwitchStatements, Mutable>(ProhibitsUnnecessaryClausesWithinSwitchStatements.DefaultInstance);
        ...
        public static ParsedJsonDocument<ProhibitsUnnecessaryClausesWithinSwitchStatements> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ProhibitsUnnecessaryClausesWithinSwitchStatements>();
            }
            finally
            {
