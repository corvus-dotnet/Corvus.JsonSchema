...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct RequiresAllCodeToRunInEs5StrictMode
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<RequiresAllCodeToRunInEs5StrictMode, Mutable>(RequiresAllCodeToRunInEs5StrictMode.DefaultInstance);
            ...
            public static explicit operator Mutable(RequiresAllCodeToRunInEs5StrictMode instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RequiresAllCodeToRunInEs5StrictMode"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiresAllCodeToRunInEs5StrictMode(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiresAllCodeToRunInEs5StrictMode.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly RequiresAllCodeToRunInEs5StrictMode Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly RequiresAllCodeToRunInEs5StrictMode Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RequiresAllCodeToRunInEs5StrictMode>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(RequiresAllCodeToRunInEs5StrictMode instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<RequiresAllCodeToRunInEs5StrictMode, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<RequiresAllCodeToRunInEs5StrictMode> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<RequiresAllCodeToRunInEs5StrictMode>();
            }
            finally
            {
