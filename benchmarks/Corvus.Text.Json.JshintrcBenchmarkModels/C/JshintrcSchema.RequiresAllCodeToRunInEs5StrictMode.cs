...
public readonly partial struct JshintrcSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequiresAllCodeToRunInEs5StrictMode"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal RequiresAllCodeToRunInEs5StrictMode(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RequiresAllCodeToRunInEs5StrictMode DefaultInstance { get; } = ParsedJsonDocument<RequiresAllCodeToRunInEs5StrictMode>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(RequiresAllCodeToRunInEs5StrictMode value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator bool(RequiresAllCodeToRunInEs5StrictMode value)
        {
        ...
        /// </returns>
        public static bool operator ==(in RequiresAllCodeToRunInEs5StrictMode left, in RequiresAllCodeToRunInEs5StrictMode right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RequiresAllCodeToRunInEs5StrictMode left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(RequiresAllCodeToRunInEs5StrictMode instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RequiresAllCodeToRunInEs5StrictMode(JsonElement instance)
        {
            return RequiresAllCodeToRunInEs5StrictMode.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiresAllCodeToRunInEs5StrictMode From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiresAllCodeToRunInEs5StrictMode ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiresAllCodeToRunInEs5StrictMode>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiresAllCodeToRunInEs5StrictMode ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiresAllCodeToRunInEs5StrictMode>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiresAllCodeToRunInEs5StrictMode ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiresAllCodeToRunInEs5StrictMode>(json, options);
        }
        ...
        /// </exception>
        public static RequiresAllCodeToRunInEs5StrictMode ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<RequiresAllCodeToRunInEs5StrictMode>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RequiresAllCodeToRunInEs5StrictMode? result)
        {
            return JsonElementHelpers.TryParseValue<RequiresAllCodeToRunInEs5StrictMode>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new RequiresAllCodeToRunInEs5StrictMode(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static RequiresAllCodeToRunInEs5StrictMode IJsonElement<RequiresAllCodeToRunInEs5StrictMode>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RequiresAllCodeToRunInEs5StrictMode: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="RequiresAllCodeToRunInEs5StrictMode"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="RequiresAllCodeToRunInEs5StrictMode"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public RequiresAllCodeToRunInEs5StrictMode Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<RequiresAllCodeToRunInEs5StrictMode>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="RequiresAllCodeToRunInEs5StrictMode"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public RequiresAllCodeToRunInEs5StrictMode Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<RequiresAllCodeToRunInEs5StrictMode>(_idx);
            }
        ...
        /// <param name="matchImplied">Match 3rd item.</param>
        /// <param name="matchGlobal">Match 4th item.</param>
        /// <param name="matchFunc">Match 5th item.</param>
        ...
        public TResult Match<TContext, TResult>(
            ...
            Func<TContext, TResult> matchImplied,
            Func<TContext, TResult> matchGlobal,
            Func<TContext, TResult> matchFunc,
        ...
        public TResult Match<TResult>(
            ...
            Func<TResult> matchImplied,
            Func<TResult> matchGlobal,
            Func<TResult> matchFunc,
