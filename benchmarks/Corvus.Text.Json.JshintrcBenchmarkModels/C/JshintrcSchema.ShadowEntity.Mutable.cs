...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct ShadowEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ShadowEntity, Mutable>(ShadowEntity.DefaultInstance);
        ...
        public static ParsedJsonDocument<ShadowEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ShadowEntity>();
            }
            finally
            {
