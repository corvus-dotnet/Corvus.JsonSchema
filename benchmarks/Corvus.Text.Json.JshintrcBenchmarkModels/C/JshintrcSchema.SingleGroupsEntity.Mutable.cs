...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct SingleGroupsEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SingleGroupsEntity, Mutable>(SingleGroupsEntity.DefaultInstance);
        ...
        public static ParsedJsonDocument<SingleGroupsEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SingleGroupsEntity>();
            }
            finally
            {
