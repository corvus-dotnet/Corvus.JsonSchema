...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct SupernewEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SupernewEntity, Mutable>(SupernewEntity.DefaultInstance);
        ...
        public static ParsedJsonDocument<SupernewEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SupernewEntity>();
            }
            finally
            {
