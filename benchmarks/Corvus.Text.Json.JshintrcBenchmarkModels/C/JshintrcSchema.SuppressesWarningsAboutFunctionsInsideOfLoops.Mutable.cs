...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct SuppressesWarningsAboutFunctionsInsideOfLoops
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SuppressesWarningsAboutFunctionsInsideOfLoops, Mutable>(SuppressesWarningsAboutFunctionsInsideOfLoops.DefaultInstance);
        ...
        public static ParsedJsonDocument<SuppressesWarningsAboutFunctionsInsideOfLoops> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SuppressesWarningsAboutFunctionsInsideOfLoops>();
            }
            finally
            {
