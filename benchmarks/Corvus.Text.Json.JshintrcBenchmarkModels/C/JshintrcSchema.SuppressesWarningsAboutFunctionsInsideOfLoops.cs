...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct SuppressesWarningsAboutFunctionsInsideOfLoops
#if NET8_0_OR_GREATER
        : IJsonElement<SuppressesWarningsAboutFunctionsInsideOfLoops>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SuppressesWarningsAboutFunctionsInsideOfLoops"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal SuppressesWarningsAboutFunctionsInsideOfLoops(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static SuppressesWarningsAboutFunctionsInsideOfLoops DefaultInstance { get; } = ParsedJsonDocument<SuppressesWarningsAboutFunctionsInsideOfLoops>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(SuppressesWarningsAboutFunctionsInsideOfLoops value)
        {
        ...
        /// </returns>
        public static bool operator ==(in SuppressesWarningsAboutFunctionsInsideOfLoops left, in SuppressesWarningsAboutFunctionsInsideOfLoops right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SuppressesWarningsAboutFunctionsInsideOfLoops left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(SuppressesWarningsAboutFunctionsInsideOfLoops instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SuppressesWarningsAboutFunctionsInsideOfLoops(JsonElement instance)
        {
            return SuppressesWarningsAboutFunctionsInsideOfLoops.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutFunctionsInsideOfLoops From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutFunctionsInsideOfLoops ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutFunctionsInsideOfLoops>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutFunctionsInsideOfLoops ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutFunctionsInsideOfLoops>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutFunctionsInsideOfLoops ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutFunctionsInsideOfLoops>(json, options);
        }
        ...
        /// </exception>
        public static SuppressesWarningsAboutFunctionsInsideOfLoops ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutFunctionsInsideOfLoops>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SuppressesWarningsAboutFunctionsInsideOfLoops? result)
        {
            return JsonElementHelpers.TryParseValue<SuppressesWarningsAboutFunctionsInsideOfLoops>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new SuppressesWarningsAboutFunctionsInsideOfLoops(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static SuppressesWarningsAboutFunctionsInsideOfLoops IJsonElement<SuppressesWarningsAboutFunctionsInsideOfLoops>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SuppressesWarningsAboutFunctionsInsideOfLoops: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="SuppressesWarningsAboutFunctionsInsideOfLoops"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="SuppressesWarningsAboutFunctionsInsideOfLoops"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public SuppressesWarningsAboutFunctionsInsideOfLoops Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<SuppressesWarningsAboutFunctionsInsideOfLoops>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="SuppressesWarningsAboutFunctionsInsideOfLoops"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public SuppressesWarningsAboutFunctionsInsideOfLoops Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<SuppressesWarningsAboutFunctionsInsideOfLoops>(_idx);
            }
