...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct SuppressesWarningsAboutInvalidTypeofOperatorValues
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SuppressesWarningsAboutInvalidTypeofOperatorValues, Mutable>(SuppressesWarningsAboutInvalidTypeofOperatorValues.DefaultInstance);
        ...
        public static ParsedJsonDocument<SuppressesWarningsAboutInvalidTypeofOperatorValues> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SuppressesWarningsAboutInvalidTypeofOperatorValues>();
            }
            finally
            {
