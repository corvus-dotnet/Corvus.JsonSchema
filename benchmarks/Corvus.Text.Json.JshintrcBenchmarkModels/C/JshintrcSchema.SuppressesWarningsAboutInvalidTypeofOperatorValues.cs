...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct SuppressesWarningsAboutInvalidTypeofOperatorValues
#if NET8_0_OR_GREATER
        : IJsonElement<SuppressesWarningsAboutInvalidTypeofOperatorValues>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SuppressesWarningsAboutInvalidTypeofOperatorValues"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal SuppressesWarningsAboutInvalidTypeofOperatorValues(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static SuppressesWarningsAboutInvalidTypeofOperatorValues DefaultInstance { get; } = ParsedJsonDocument<SuppressesWarningsAboutInvalidTypeofOperatorValues>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(SuppressesWarningsAboutInvalidTypeofOperatorValues value)
        {
        ...
        /// </returns>
        public static bool operator ==(in SuppressesWarningsAboutInvalidTypeofOperatorValues left, in SuppressesWarningsAboutInvalidTypeofOperatorValues right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SuppressesWarningsAboutInvalidTypeofOperatorValues left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(SuppressesWarningsAboutInvalidTypeofOperatorValues instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SuppressesWarningsAboutInvalidTypeofOperatorValues(JsonElement instance)
        {
            return SuppressesWarningsAboutInvalidTypeofOperatorValues.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutInvalidTypeofOperatorValues From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutInvalidTypeofOperatorValues ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutInvalidTypeofOperatorValues>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutInvalidTypeofOperatorValues ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutInvalidTypeofOperatorValues>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutInvalidTypeofOperatorValues ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutInvalidTypeofOperatorValues>(json, options);
        }
        ...
        /// </exception>
        public static SuppressesWarningsAboutInvalidTypeofOperatorValues ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutInvalidTypeofOperatorValues>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SuppressesWarningsAboutInvalidTypeofOperatorValues? result)
        {
            return JsonElementHelpers.TryParseValue<SuppressesWarningsAboutInvalidTypeofOperatorValues>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new SuppressesWarningsAboutInvalidTypeofOperatorValues(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static SuppressesWarningsAboutInvalidTypeofOperatorValues IJsonElement<SuppressesWarningsAboutInvalidTypeofOperatorValues>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SuppressesWarningsAboutInvalidTypeofOperatorValues: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="SuppressesWarningsAboutInvalidTypeofOperatorValues"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="SuppressesWarningsAboutInvalidTypeofOperatorValues"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public SuppressesWarningsAboutInvalidTypeofOperatorValues Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<SuppressesWarningsAboutInvalidTypeofOperatorValues>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="SuppressesWarningsAboutInvalidTypeofOperatorValues"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public SuppressesWarningsAboutInvalidTypeofOperatorValues Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<SuppressesWarningsAboutInvalidTypeofOperatorValues>(_idx);
            }
