...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct SuppressesWarningsAboutMissingSemicolons
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SuppressesWarningsAboutMissingSemicolons, Mutable>(SuppressesWarningsAboutMissingSemicolons.DefaultInstance);
            ...
            public static explicit operator Mutable(SuppressesWarningsAboutMissingSemicolons instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SuppressesWarningsAboutMissingSemicolons"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SuppressesWarningsAboutMissingSemicolons(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SuppressesWarningsAboutMissingSemicolons(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SuppressesWarningsAboutMissingSemicolons.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SuppressesWarningsAboutMissingSemicolons"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SuppressesWarningsAboutMissingSemicolons"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly SuppressesWarningsAboutMissingSemicolons Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SuppressesWarningsAboutMissingSemicolons>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SuppressesWarningsAboutMissingSemicolons"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly SuppressesWarningsAboutMissingSemicolons Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SuppressesWarningsAboutMissingSemicolons>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(SuppressesWarningsAboutMissingSemicolons instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<SuppressesWarningsAboutMissingSemicolons, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<SuppressesWarningsAboutMissingSemicolons> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SuppressesWarningsAboutMissingSemicolons>();
            }
            finally
            {
