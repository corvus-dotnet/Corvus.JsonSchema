...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct SuppressesWarningsAboutMissingSemicolons
        ...
        : IJsonElement<SuppressesWarningsAboutMissingSemicolons>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SuppressesWarningsAboutMissingSemicolons"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal SuppressesWarningsAboutMissingSemicolons(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static SuppressesWarningsAboutMissingSemicolons DefaultInstance { get; } = ParsedJsonDocument<SuppressesWarningsAboutMissingSemicolons>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(SuppressesWarningsAboutMissingSemicolons value)
        {
        ...
        /// </returns>
        public static bool operator ==(in SuppressesWarningsAboutMissingSemicolons left, in SuppressesWarningsAboutMissingSemicolons right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SuppressesWarningsAboutMissingSemicolons left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(SuppressesWarningsAboutMissingSemicolons instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SuppressesWarningsAboutMissingSemicolons(JsonElement instance)
        {
            return SuppressesWarningsAboutMissingSemicolons.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutMissingSemicolons From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutMissingSemicolons ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutMissingSemicolons>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutMissingSemicolons ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutMissingSemicolons>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutMissingSemicolons ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutMissingSemicolons>(json, options);
        }
        ...
        /// </exception>
        public static SuppressesWarningsAboutMissingSemicolons ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutMissingSemicolons>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SuppressesWarningsAboutMissingSemicolons? result)
        {
            return JsonElementHelpers.TryParseValue<SuppressesWarningsAboutMissingSemicolons>(ref reader, out result);
        }
...
#if NET
        static SuppressesWarningsAboutMissingSemicolons IJsonElement<SuppressesWarningsAboutMissingSemicolons>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SuppressesWarningsAboutMissingSemicolons: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public SuppressesWarningsAboutMissingSemicolons Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public SuppressesWarningsAboutMissingSemicolons Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<SuppressesWarningsAboutMissingSemicolons>(_idx);
            }
