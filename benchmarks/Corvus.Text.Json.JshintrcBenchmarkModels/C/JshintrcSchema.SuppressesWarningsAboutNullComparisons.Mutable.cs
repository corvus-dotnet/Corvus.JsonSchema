...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct SuppressesWarningsAboutNullComparisons
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SuppressesWarningsAboutNullComparisons, Mutable>(SuppressesWarningsAboutNullComparisons.DefaultInstance);
            ...
            public static explicit operator Mutable(SuppressesWarningsAboutNullComparisons instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SuppressesWarningsAboutNullComparisons"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SuppressesWarningsAboutNullComparisons(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SuppressesWarningsAboutNullComparisons(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SuppressesWarningsAboutNullComparisons.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SuppressesWarningsAboutNullComparisons"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SuppressesWarningsAboutNullComparisons"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly SuppressesWarningsAboutNullComparisons Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SuppressesWarningsAboutNullComparisons>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SuppressesWarningsAboutNullComparisons"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly SuppressesWarningsAboutNullComparisons Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SuppressesWarningsAboutNullComparisons>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(SuppressesWarningsAboutNullComparisons instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<SuppressesWarningsAboutNullComparisons, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<SuppressesWarningsAboutNullComparisons> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SuppressesWarningsAboutNullComparisons>();
            }
            finally
            {
