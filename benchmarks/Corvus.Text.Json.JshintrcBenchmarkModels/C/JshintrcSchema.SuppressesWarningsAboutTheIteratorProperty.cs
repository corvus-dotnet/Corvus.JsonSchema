...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct SuppressesWarningsAboutTheIteratorProperty
        ...
        : IJsonElement<SuppressesWarningsAboutTheIteratorProperty>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SuppressesWarningsAboutTheIteratorProperty"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal SuppressesWarningsAboutTheIteratorProperty(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static SuppressesWarningsAboutTheIteratorProperty DefaultInstance { get; } = ParsedJsonDocument<SuppressesWarningsAboutTheIteratorProperty>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(SuppressesWarningsAboutTheIteratorProperty value)
        {
        ...
        /// </returns>
        public static bool operator ==(in SuppressesWarningsAboutTheIteratorProperty left, in SuppressesWarningsAboutTheIteratorProperty right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SuppressesWarningsAboutTheIteratorProperty left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(SuppressesWarningsAboutTheIteratorProperty instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SuppressesWarningsAboutTheIteratorProperty(JsonElement instance)
        {
            return SuppressesWarningsAboutTheIteratorProperty.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutTheIteratorProperty From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutTheIteratorProperty ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutTheIteratorProperty>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutTheIteratorProperty ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutTheIteratorProperty>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutTheIteratorProperty ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutTheIteratorProperty>(json, options);
        }
        ...
        /// </exception>
        public static SuppressesWarningsAboutTheIteratorProperty ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutTheIteratorProperty>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SuppressesWarningsAboutTheIteratorProperty? result)
        {
            return JsonElementHelpers.TryParseValue<SuppressesWarningsAboutTheIteratorProperty>(ref reader, out result);
        }
...
#if NET
        static SuppressesWarningsAboutTheIteratorProperty IJsonElement<SuppressesWarningsAboutTheIteratorProperty>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SuppressesWarningsAboutTheIteratorProperty: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public SuppressesWarningsAboutTheIteratorProperty Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public SuppressesWarningsAboutTheIteratorProperty Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<SuppressesWarningsAboutTheIteratorProperty>(_idx);
            }
