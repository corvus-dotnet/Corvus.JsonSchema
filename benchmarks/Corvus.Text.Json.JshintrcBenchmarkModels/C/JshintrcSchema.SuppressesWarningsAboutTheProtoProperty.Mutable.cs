...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct SuppressesWarningsAboutTheProtoProperty
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SuppressesWarningsAboutTheProtoProperty, Mutable>(SuppressesWarningsAboutTheProtoProperty.DefaultInstance);
        ...
        public static ParsedJsonDocument<SuppressesWarningsAboutTheProtoProperty> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SuppressesWarningsAboutTheProtoProperty>();
            }
            finally
            {
