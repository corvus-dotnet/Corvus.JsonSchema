...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct SuppressesWarningsAboutTheUseOfEval
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SuppressesWarningsAboutTheUseOfEval, Mutable>(SuppressesWarningsAboutTheUseOfEval.DefaultInstance);
        ...
        public static ParsedJsonDocument<SuppressesWarningsAboutTheUseOfEval> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SuppressesWarningsAboutTheUseOfEval>();
            }
            finally
            {
