...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct SuppressesWarningsAboutTheUseOfEval
#if NET8_0_OR_GREATER
        : IJsonElement<SuppressesWarningsAboutTheUseOfEval>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SuppressesWarningsAboutTheUseOfEval"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal SuppressesWarningsAboutTheUseOfEval(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static SuppressesWarningsAboutTheUseOfEval DefaultInstance { get; } = ParsedJsonDocument<SuppressesWarningsAboutTheUseOfEval>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(SuppressesWarningsAboutTheUseOfEval value)
        {
        ...
        /// </returns>
        public static bool operator ==(in SuppressesWarningsAboutTheUseOfEval left, in SuppressesWarningsAboutTheUseOfEval right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SuppressesWarningsAboutTheUseOfEval left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(SuppressesWarningsAboutTheUseOfEval instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SuppressesWarningsAboutTheUseOfEval(JsonElement instance)
        {
            return SuppressesWarningsAboutTheUseOfEval.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutTheUseOfEval From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutTheUseOfEval ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutTheUseOfEval>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutTheUseOfEval ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutTheUseOfEval>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutTheUseOfEval ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutTheUseOfEval>(json, options);
        }
        ...
        /// </exception>
        public static SuppressesWarningsAboutTheUseOfEval ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutTheUseOfEval>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SuppressesWarningsAboutTheUseOfEval? result)
        {
            return JsonElementHelpers.TryParseValue<SuppressesWarningsAboutTheUseOfEval>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new SuppressesWarningsAboutTheUseOfEval(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static SuppressesWarningsAboutTheUseOfEval IJsonElement<SuppressesWarningsAboutTheUseOfEval>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SuppressesWarningsAboutTheUseOfEval: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="SuppressesWarningsAboutTheUseOfEval"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="SuppressesWarningsAboutTheUseOfEval"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public SuppressesWarningsAboutTheUseOfEval Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<SuppressesWarningsAboutTheUseOfEval>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="SuppressesWarningsAboutTheUseOfEval"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public SuppressesWarningsAboutTheUseOfEval Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<SuppressesWarningsAboutTheUseOfEval>(_idx);
            }
