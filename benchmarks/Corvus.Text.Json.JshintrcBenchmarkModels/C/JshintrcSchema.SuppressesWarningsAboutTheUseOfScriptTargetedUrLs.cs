...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct SuppressesWarningsAboutTheUseOfScriptTargetedUrLs
#if NET8_0_OR_GREATER
        : IJsonElement<SuppressesWarningsAboutTheUseOfScriptTargetedUrLs>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SuppressesWarningsAboutTheUseOfScriptTargetedUrLs"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal SuppressesWarningsAboutTheUseOfScriptTargetedUrLs(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static SuppressesWarningsAboutTheUseOfScriptTargetedUrLs DefaultInstance { get; } = ParsedJsonDocument<SuppressesWarningsAboutTheUseOfScriptTargetedUrLs>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(SuppressesWarningsAboutTheUseOfScriptTargetedUrLs value)
        {
        ...
        /// </returns>
        public static bool operator ==(in SuppressesWarningsAboutTheUseOfScriptTargetedUrLs left, in SuppressesWarningsAboutTheUseOfScriptTargetedUrLs right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SuppressesWarningsAboutTheUseOfScriptTargetedUrLs left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(SuppressesWarningsAboutTheUseOfScriptTargetedUrLs instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SuppressesWarningsAboutTheUseOfScriptTargetedUrLs(JsonElement instance)
        {
            return SuppressesWarningsAboutTheUseOfScriptTargetedUrLs.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutTheUseOfScriptTargetedUrLs From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutTheUseOfScriptTargetedUrLs ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutTheUseOfScriptTargetedUrLs>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutTheUseOfScriptTargetedUrLs ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutTheUseOfScriptTargetedUrLs>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SuppressesWarningsAboutTheUseOfScriptTargetedUrLs ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutTheUseOfScriptTargetedUrLs>(json, options);
        }
        ...
        /// </exception>
        public static SuppressesWarningsAboutTheUseOfScriptTargetedUrLs ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<SuppressesWarningsAboutTheUseOfScriptTargetedUrLs>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SuppressesWarningsAboutTheUseOfScriptTargetedUrLs? result)
        {
            return JsonElementHelpers.TryParseValue<SuppressesWarningsAboutTheUseOfScriptTargetedUrLs>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new SuppressesWarningsAboutTheUseOfScriptTargetedUrLs(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static SuppressesWarningsAboutTheUseOfScriptTargetedUrLs IJsonElement<SuppressesWarningsAboutTheUseOfScriptTargetedUrLs>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SuppressesWarningsAboutTheUseOfScriptTargetedUrLs: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="SuppressesWarningsAboutTheUseOfScriptTargetedUrLs"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="SuppressesWarningsAboutTheUseOfScriptTargetedUrLs"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public SuppressesWarningsAboutTheUseOfScriptTargetedUrLs Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<SuppressesWarningsAboutTheUseOfScriptTargetedUrLs>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="SuppressesWarningsAboutTheUseOfScriptTargetedUrLs"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public SuppressesWarningsAboutTheUseOfScriptTargetedUrLs Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<SuppressesWarningsAboutTheUseOfScriptTargetedUrLs>(_idx);
            }
