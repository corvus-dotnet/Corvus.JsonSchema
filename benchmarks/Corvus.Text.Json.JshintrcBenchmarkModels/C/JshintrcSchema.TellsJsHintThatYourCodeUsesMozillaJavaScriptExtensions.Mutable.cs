...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions, Mutable>(TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions.DefaultInstance);
            ...
            public static explicit operator Mutable(TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions>();
            }
            finally
            {
