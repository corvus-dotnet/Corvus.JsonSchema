...
public readonly partial struct JshintrcSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions DefaultInstance { get; } = ParsedJsonDocument<TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions value)
        {
        ...
        /// </returns>
        public static bool operator ==(in TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions left, in TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions(JsonElement instance)
        {
            return TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions? result)
        {
            return JsonElementHelpers.TryParseValue<TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions>(ref reader, out result);
        }
...
#if NET
        static TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions IJsonElement<TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TellsJsHintThatYourCodeUsesMozillaJavaScriptExtensions>(_idx);
            }
