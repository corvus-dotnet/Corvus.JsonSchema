...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct TheEcmaScriptVersionToWhichTheCodeMustAdhere
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TheEcmaScriptVersionToWhichTheCodeMustAdhere, Mutable>(TheEcmaScriptVersionToWhichTheCodeMustAdhere.DefaultInstance);
            ...
            public static explicit operator Mutable(TheEcmaScriptVersionToWhichTheCodeMustAdhere instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheEcmaScriptVersionToWhichTheCodeMustAdhere"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheEcmaScriptVersionToWhichTheCodeMustAdhere(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new TheEcmaScriptVersionToWhichTheCodeMustAdhere(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheEcmaScriptVersionToWhichTheCodeMustAdhere.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="TheEcmaScriptVersionToWhichTheCodeMustAdhere"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TheEcmaScriptVersionToWhichTheCodeMustAdhere"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly TheEcmaScriptVersionToWhichTheCodeMustAdhere Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TheEcmaScriptVersionToWhichTheCodeMustAdhere>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TheEcmaScriptVersionToWhichTheCodeMustAdhere"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly TheEcmaScriptVersionToWhichTheCodeMustAdhere Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheEcmaScriptVersionToWhichTheCodeMustAdhere>(_idx);
            }
            ...
            /// <param name="matchNumberThree">Match 1st item.</param>
            /// <param name="matchNumberFive">Match 2nd item.</param>
            /// <param name="matchNumberSix">Match 3rd item.</param>
            /// <param name="matchNumberSeven">Match 4th item.</param>
            /// <param name="matchNumberEight">Match 5th item.</param>
            /// <param name="matchNumberNine">Match 6th item.</param>
            /// <param name="matchNumber10">Match 7th item.</param>
            /// <param name="matchNumber11">Match 8th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchNumberThree,
                Func<TContext, TResult> matchNumberFive,
                Func<TContext, TResult> matchNumberSix,
                Func<TContext, TResult> matchNumberSeven,
                Func<TContext, TResult> matchNumberEight,
                Func<TContext, TResult> matchNumberNine,
                Func<TContext, TResult> matchNumber10,
                Func<TContext, TResult> matchNumber11,
...
#endif
            {
                ...
                {
                    return matchNumberThree(context);
                }
                ...
                {
                    return matchNumberSix(context);
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchNumberSeven(context);
                }

                if (this.ValueEquals(Constants.Enum5))
                {
                    return matchNumberEight(context);
                }

                if (this.ValueEquals(Constants.Enum6))
                {
                    return matchNumberNine(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchNumberThree,
                Func<TResult> matchNumberFive,
                Func<TResult> matchNumberSix,
                Func<TResult> matchNumberSeven,
                Func<TResult> matchNumberEight,
                Func<TResult> matchNumberNine,
                Func<TResult> matchNumber10,
                Func<TResult> matchNumber11,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchNumberThree();
                }
                ...
                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchNumberSix();
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchNumberSeven();
                }

                if (this.ValueEquals(Constants.Enum5))
                {
                    return matchNumberEight();
                }

                if (this.ValueEquals(Constants.Enum6))
                {
                    return matchNumberNine();
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TheEcmaScriptVersionToWhichTheCodeMustAdhere instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TheEcmaScriptVersionToWhichTheCodeMustAdhere, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TheEcmaScriptVersionToWhichTheCodeMustAdhere> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TheEcmaScriptVersionToWhichTheCodeMustAdhere>();
            }
            finally
            {
