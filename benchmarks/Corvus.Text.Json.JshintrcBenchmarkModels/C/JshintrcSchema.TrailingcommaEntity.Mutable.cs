...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct TrailingcommaEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TrailingcommaEntity, Mutable>(TrailingcommaEntity.DefaultInstance);
            ...
            public static explicit operator Mutable(TrailingcommaEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TrailingcommaEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TrailingcommaEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TrailingcommaEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly TrailingcommaEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TrailingcommaEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TrailingcommaEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TrailingcommaEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TrailingcommaEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TrailingcommaEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TrailingcommaEntity>();
            }
            finally
            {
