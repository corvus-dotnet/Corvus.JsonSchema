...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct ValidthisEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ValidthisEntity, Mutable>(ValidthisEntity.DefaultInstance);
        ...
        public static ParsedJsonDocument<ValidthisEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ValidthisEntity>();
            }
            finally
            {
