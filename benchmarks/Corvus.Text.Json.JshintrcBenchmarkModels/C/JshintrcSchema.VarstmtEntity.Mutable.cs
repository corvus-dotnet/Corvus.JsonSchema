...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct VarstmtEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<VarstmtEntity, Mutable>(VarstmtEntity.DefaultInstance);
            ...
            public static explicit operator Mutable(VarstmtEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="VarstmtEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator VarstmtEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"VarstmtEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly VarstmtEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly VarstmtEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<VarstmtEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(VarstmtEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<VarstmtEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<VarstmtEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<VarstmtEntity>();
            }
            finally
            {
