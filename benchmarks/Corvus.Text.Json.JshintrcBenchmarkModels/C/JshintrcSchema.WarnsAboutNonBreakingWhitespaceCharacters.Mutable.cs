...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct WarnsAboutNonBreakingWhitespaceCharacters
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<WarnsAboutNonBreakingWhitespaceCharacters, Mutable>(WarnsAboutNonBreakingWhitespaceCharacters.DefaultInstance);
        ...
        public static ParsedJsonDocument<WarnsAboutNonBreakingWhitespaceCharacters> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<WarnsAboutNonBreakingWhitespaceCharacters>();
            }
            finally
            {
