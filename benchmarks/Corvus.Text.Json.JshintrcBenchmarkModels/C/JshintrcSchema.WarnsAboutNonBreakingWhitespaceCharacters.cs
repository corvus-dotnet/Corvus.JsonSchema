...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct WarnsAboutNonBreakingWhitespaceCharacters
        ...
        : IJsonElement<WarnsAboutNonBreakingWhitespaceCharacters>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WarnsAboutNonBreakingWhitespaceCharacters"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal WarnsAboutNonBreakingWhitespaceCharacters(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static WarnsAboutNonBreakingWhitespaceCharacters DefaultInstance { get; } = ParsedJsonDocument<WarnsAboutNonBreakingWhitespaceCharacters>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(WarnsAboutNonBreakingWhitespaceCharacters value)
        {
        ...
        /// </returns>
        public static bool operator ==(in WarnsAboutNonBreakingWhitespaceCharacters left, in WarnsAboutNonBreakingWhitespaceCharacters right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in WarnsAboutNonBreakingWhitespaceCharacters left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(WarnsAboutNonBreakingWhitespaceCharacters instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator WarnsAboutNonBreakingWhitespaceCharacters(JsonElement instance)
        {
            return WarnsAboutNonBreakingWhitespaceCharacters.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WarnsAboutNonBreakingWhitespaceCharacters From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WarnsAboutNonBreakingWhitespaceCharacters ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<WarnsAboutNonBreakingWhitespaceCharacters>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WarnsAboutNonBreakingWhitespaceCharacters ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<WarnsAboutNonBreakingWhitespaceCharacters>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WarnsAboutNonBreakingWhitespaceCharacters ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<WarnsAboutNonBreakingWhitespaceCharacters>(json, options);
        }
        ...
        /// </exception>
        public static WarnsAboutNonBreakingWhitespaceCharacters ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<WarnsAboutNonBreakingWhitespaceCharacters>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out WarnsAboutNonBreakingWhitespaceCharacters? result)
        {
            return JsonElementHelpers.TryParseValue<WarnsAboutNonBreakingWhitespaceCharacters>(ref reader, out result);
        }
...
#if NET
        static WarnsAboutNonBreakingWhitespaceCharacters IJsonElement<WarnsAboutNonBreakingWhitespaceCharacters>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"WarnsAboutNonBreakingWhitespaceCharacters: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public WarnsAboutNonBreakingWhitespaceCharacters Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public WarnsAboutNonBreakingWhitespaceCharacters Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<WarnsAboutNonBreakingWhitespaceCharacters>(_idx);
            }
