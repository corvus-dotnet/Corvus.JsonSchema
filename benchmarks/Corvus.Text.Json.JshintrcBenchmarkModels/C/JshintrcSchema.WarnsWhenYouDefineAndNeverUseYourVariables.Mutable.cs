...
public readonly partial struct JshintrcSchema
{
    ...
    public readonly partial struct WarnsWhenYouDefineAndNeverUseYourVariables
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<WarnsWhenYouDefineAndNeverUseYourVariables, Mutable>(WarnsWhenYouDefineAndNeverUseYourVariables.DefaultInstance);
        ...
        public static ParsedJsonDocument<WarnsWhenYouDefineAndNeverUseYourVariables> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<WarnsWhenYouDefineAndNeverUseYourVariables>();
            }
            finally
            {
