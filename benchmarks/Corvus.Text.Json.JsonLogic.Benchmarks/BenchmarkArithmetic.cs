...
/// <summary>
/// Benchmark for nested arithmetic: {"+":[1,{"*":[2,{"var":"x"}]},3]} with {"x": 4}.
/// </summary>
[MemoryDiagnoser]
public class BenchmarkArithmetic : JsonLogicBenchmarkBase
{
    private const string RuleJson = """{"+":[1,{"*":[2,{"var":"x"}]},3]}""";
    private const string DataJson = """{"x":4}""";
    ...
    {
        using JsonWorkspace workspace = JsonWorkspace.Create();
        ArithmeticCodeGen.Evaluate(this.CorvusData, workspace);
    }
}