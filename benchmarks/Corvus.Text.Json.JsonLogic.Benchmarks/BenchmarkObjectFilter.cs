// <copyright file="BenchmarkObjectFilter.cs" company="Endjin Limited">
...
/// <summary>
/// Benchmark for filtering an array of objects by a property:
/// {"filter":[{"var":"people"},{">":[{"var":"age"},30]}]}.
/// </summary>
[MemoryDiagnoser]
public class BenchmarkObjectFilter : JsonLogicBenchmarkBase
{
    private const string RuleJson = """{"filter":[{"var":"people"},{">":[{"var":"age"},30]}]}""";
    ...
    {
        using JsonWorkspace workspace = JsonWorkspace.Create();
        ObjectFilterCodeGen.Evaluate(this.CorvusData, workspace);
    }
}