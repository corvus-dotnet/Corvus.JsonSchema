// <copyright file="BenchmarkSubstr.cs" company="Endjin Limited">
...
/// <summary>
/// Benchmark for extracting a substring from a dynamic value.
/// </summary>
[MemoryDiagnoser]
public class BenchmarkSubstr : JsonLogicBenchmarkBase
{
    private const string RuleJson = """{"substr":[{"var":"text"},3,5]}""";
    private const string DataJson = """{"text":"Hello, World!"}""";
    ...
    {
        using JsonWorkspace workspace = JsonWorkspace.Create();
        SubstrCodeGen.Evaluate(this.CorvusData, workspace);
    }
}