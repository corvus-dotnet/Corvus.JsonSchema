...
public readonly partial struct Schema
{
    ...
    public readonly partial struct EchoEndpoint
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(EchoEndpoint instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EchoEndpoint"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EchoEndpoint(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EchoEndpoint.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly EchoEndpoint Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly EchoEndpoint Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EchoEndpoint>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EchoEndpoint instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<EchoEndpoint, Mutable>(this);
        }
    }
}
