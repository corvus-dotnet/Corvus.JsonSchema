...
public readonly partial struct Schema
{
    ...
    public readonly partial struct EchoEndpoint
#if NET8_0_OR_GREATER
        : IJsonElement<EchoEndpoint>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EchoEndpoint"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal EchoEndpoint(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static EchoEndpoint DefaultInstance { get; } = ParsedJsonDocument<EchoEndpoint>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(EchoEndpoint value)
        {
        ...
        /// </returns>
        public static bool operator ==(in EchoEndpoint left, in EchoEndpoint right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in EchoEndpoint left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(EchoEndpoint instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator EchoEndpoint(JsonElement instance)
        {
            return EchoEndpoint.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EchoEndpoint From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EchoEndpoint ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EchoEndpoint>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EchoEndpoint ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EchoEndpoint>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EchoEndpoint ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EchoEndpoint>(json, options);
        }
        ...
        /// </exception>
        public static EchoEndpoint ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<EchoEndpoint>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out EchoEndpoint? result)
        {
            return JsonElementHelpers.TryParseValue<EchoEndpoint>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new EchoEndpoint(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static EchoEndpoint IJsonElement<EchoEndpoint>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"EchoEndpoint: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="EchoEndpoint"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="EchoEndpoint"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<EchoEndpoint>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="EchoEndpoint"/> that lives for the lifetime of its
