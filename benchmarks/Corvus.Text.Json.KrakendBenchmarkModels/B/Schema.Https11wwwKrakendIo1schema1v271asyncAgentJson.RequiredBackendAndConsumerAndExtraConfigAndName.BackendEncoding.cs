    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271asyncAgentJson
    {
        ...
        public readonly partial struct RequiredBackendAndConsumerAndExtraConfigAndName
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="BackendEncoding"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal BackendEncoding(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static BackendEncoding DefaultInstance { get; } = ParsedJsonDocument<BackendEncoding>.StringConstant([.."\"json\""u8]);
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(BackendEncoding value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in BackendEncoding left, in BackendEncoding right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in BackendEncoding left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(BackendEncoding instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator BackendEncoding(JsonElement instance)
                {
                    return BackendEncoding.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static BackendEncoding From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static BackendEncoding ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<BackendEncoding>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static BackendEncoding ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<BackendEncoding>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static BackendEncoding ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<BackendEncoding>(json, options);
                }
                ...
                /// </exception>
                public static BackendEncoding ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<BackendEncoding>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out BackendEncoding? result)
                {
                    return JsonElementHelpers.TryParseValue<BackendEncoding>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new BackendEncoding(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static BackendEncoding IJsonElement<BackendEncoding>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"BackendEncoding: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="BackendEncoding"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="BackendEncoding"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public BackendEncoding Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<BackendEncoding>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="BackendEncoding"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public BackendEncoding Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<BackendEncoding>(_idx);
                    }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Func<TContext, TResult> matchSafejson,
                    Func<TContext, TResult> matchXml,
                    Func<TContext, TResult> matchRss,
                ...
                public TResult Match<TResult>(
                    ...
                    Func<TResult> matchSafejson,
                    Func<TResult> matchXml,
                    Func<TResult> matchRss,
