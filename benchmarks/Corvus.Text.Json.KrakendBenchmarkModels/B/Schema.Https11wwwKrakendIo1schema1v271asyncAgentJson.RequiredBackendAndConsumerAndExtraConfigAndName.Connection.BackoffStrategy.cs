        ...
        public readonly partial struct RequiredBackendAndConsumerAndExtraConfigAndName
        {
            ...
            public readonly partial struct Connection
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="BackoffStrategy"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal BackoffStrategy(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static BackoffStrategy DefaultInstance { get; } = ParsedJsonDocument<BackoffStrategy>.StringConstant([.."\"fallback\""u8]);
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator string(BackoffStrategy value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                    ...
                    /// </returns>
                    public static bool operator ==(in BackoffStrategy left, in BackoffStrategy right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in BackoffStrategy left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(BackoffStrategy instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator BackoffStrategy(JsonElement instance)
                    {
                        return BackoffStrategy.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static BackoffStrategy From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static BackoffStrategy ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<BackoffStrategy>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static BackoffStrategy ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<BackoffStrategy>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static BackoffStrategy ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<BackoffStrategy>(json, options);
                    }
                    ...
                    /// </exception>
                    public static BackoffStrategy ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<BackoffStrategy>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out BackoffStrategy? result)
                    {
                        return JsonElementHelpers.TryParseValue<BackoffStrategy>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new BackoffStrategy(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static BackoffStrategy IJsonElement<BackoffStrategy>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"BackoffStrategy: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="BackoffStrategy"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="BackoffStrategy"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<BackoffStrategy>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="BackoffStrategy"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public BackoffStrategy Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<BackoffStrategy>(_idx);
                        }
                    ...
                    /// <param name="matchLinear">Match 1st item.</param>
                    /// <param name="matchLinearJitter">Match 2nd item.</param>
                    /// <param name="matchExponential">Match 3rd item.</param>
                    /// <param name="matchExponentialJitter">Match 4th item.</param>
                    /// <param name="matchFallback">Match 5th item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchLinear,
                        Func<TContext, TResult> matchLinearJitter,
                        Func<TContext, TResult> matchExponential,
                        Func<TContext, TResult> matchExponentialJitter,
                        Func<TContext, TResult> matchFallback,
...
#endif
                    {
                        ...
                        {
                            return matchLinear(context);
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchLinearJitter(context);
                        }

                        if (this.ValueEquals(Constants.Enum3))
                        {
                            return matchExponential(context);
                        }

                        if (this.ValueEquals(Constants.Enum4))
                        {
                            return matchExponentialJitter(context);
                        }

                        if (this.ValueEquals(Constants.Enum5))
                        {
                            return matchFallback(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> matchLinear,
                        Func<TResult> matchLinearJitter,
                        Func<TResult> matchExponential,
                        Func<TResult> matchExponentialJitter,
                        Func<TResult> matchFallback,
                        Func<TResult> defaultMatch)
                    {
                        ...
                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchLinearJitter();
                        }

                        if (this.ValueEquals(Constants.Enum3))
                        {
                            return matchExponential();
                        }

                        if (this.ValueEquals(Constants.Enum4))
                        {
                            return matchExponentialJitter();
                        }
