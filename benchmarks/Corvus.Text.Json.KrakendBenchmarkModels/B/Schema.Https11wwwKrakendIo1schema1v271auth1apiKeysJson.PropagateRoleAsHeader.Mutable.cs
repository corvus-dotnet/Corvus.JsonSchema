    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1apiKeysJson
    {
        ...
        public readonly partial struct PropagateRoleAsHeader
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PropagateRoleAsHeader instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PropagateRoleAsHeader"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PropagateRoleAsHeader(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PropagateRoleAsHeader.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PropagateRoleAsHeader Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PropagateRoleAsHeader Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PropagateRoleAsHeader>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PropagateRoleAsHeader instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PropagateRoleAsHeader, Mutable>(this);
            }
        }
    }
}
