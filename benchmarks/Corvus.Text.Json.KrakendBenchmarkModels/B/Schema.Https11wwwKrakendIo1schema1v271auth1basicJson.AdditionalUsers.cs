...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1basicJson
    {
        ...
        public readonly partial struct AdditionalUsers
#if NET8_0_OR_GREATER
            : IJsonElement<AdditionalUsers>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AdditionalUsers"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal AdditionalUsers(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AdditionalUsers DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in AdditionalUsers left, in AdditionalUsers right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AdditionalUsers left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(AdditionalUsers instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AdditionalUsers(JsonElement instance)
            {
                return AdditionalUsers.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AdditionalUsers From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AdditionalUsers ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AdditionalUsers>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AdditionalUsers ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AdditionalUsers>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AdditionalUsers ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AdditionalUsers>(json, options);
            }
            ...
            /// </exception>
            public static AdditionalUsers ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<AdditionalUsers>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AdditionalUsers? result)
            {
                return JsonElementHelpers.TryParseValue<AdditionalUsers>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new AdditionalUsers(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static AdditionalUsers IJsonElement<AdditionalUsers>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AdditionalUsers: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="AdditionalUsers"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="AdditionalUsers"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public AdditionalUsers Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<AdditionalUsers>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="AdditionalUsers"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public AdditionalUsers Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<AdditionalUsers>(_idx);
                }
