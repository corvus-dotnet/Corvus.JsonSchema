...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson
    {
        ...
        public readonly partial struct EndpointParameters
#if NET8_0_OR_GREATER
            : IJsonElement<EndpointParameters>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="EndpointParameters"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal EndpointParameters(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static EndpointParameters DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in EndpointParameters left, in EndpointParameters right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in EndpointParameters left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(EndpointParameters instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EndpointParameters(JsonElement instance)
            {
                return EndpointParameters.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EndpointParameters From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EndpointParameters ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EndpointParameters>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EndpointParameters ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EndpointParameters>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EndpointParameters ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EndpointParameters>(json, options);
            }
            ...
            /// </exception>
            public static EndpointParameters ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<EndpointParameters>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out EndpointParameters? result)
            {
                return JsonElementHelpers.TryParseValue<EndpointParameters>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new EndpointParameters(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static EndpointParameters IJsonElement<EndpointParameters>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EndpointParameters: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="EndpointParameters"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="EndpointParameters"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public EndpointParameters Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<EndpointParameters>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="EndpointParameters"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public EndpointParameters Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<EndpointParameters>(_idx);
                }
