    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1gcpJson
    {
        ...
        public readonly partial struct CustomClaims
        {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271auth1gcpJson.CustomClaims.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271auth1gcpJson.CustomClaims.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
