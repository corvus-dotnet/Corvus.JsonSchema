...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1gcpJson
    {
        ...
        public readonly partial struct CustomClaims
#if NET8_0_OR_GREATER
            : IJsonElement<CustomClaims>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="CustomClaims"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal CustomClaims(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static CustomClaims DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in CustomClaims left, in CustomClaims right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in CustomClaims left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(CustomClaims instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CustomClaims(JsonElement instance)
            {
                return CustomClaims.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CustomClaims From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CustomClaims ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CustomClaims>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CustomClaims ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CustomClaims>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CustomClaims ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CustomClaims>(json, options);
            }
            ...
            /// </exception>
            public static CustomClaims ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<CustomClaims>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out CustomClaims? result)
            {
                return JsonElementHelpers.TryParseValue<CustomClaims>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new CustomClaims(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static CustomClaims IJsonElement<CustomClaims>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CustomClaims: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="CustomClaims"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="CustomClaims"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public CustomClaims Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<CustomClaims>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="CustomClaims"/> that lives for the lifetime of its
