...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1joseJson
        : IJsonElement<Https11wwwKrakendIo1schema1v271auth1joseJson>
    {
        public static partial class JsonSchema
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertySharedCacheDurationPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("shared_cache_duration"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertySharedCacheDurationNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("shared_cache_duration"u8, buffer, out written);

            private const int RequiredOffsetForSharedCacheDuration = 0;
            private const uint RequiredBitForSharedCacheDuration = 0b00000000000000000000000000000001;

            private const uint RequiredBitMask0 =
                RequiredBitForSharedCacheDuration;
            private static readonly JsonSchemaPathProvider SharedCacheDurationSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/shared_cache_duration"u8, buffer, out written);

            private static void MatchSharedCacheDuration(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.KrakendBenchmark.Baseline.JsonInteger.JsonSchema.PushChildContextUnescaped(
                        ...
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.SharedCacheDurationUtf8,
                        evaluationPath: SharedCacheDurationSchemaEvaluationPath);
                ...
                requiredBitBuffer[RequiredOffsetForSharedCacheDuration] |= RequiredBitForSharedCacheDuration;
            }
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.SharedCacheDurationUtf8))
                {
                    matcher = MatchSharedCacheDuration;
                    return true;
                }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1auth~1jose.json"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1auth~1jose.json";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1auth~1jose.json"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertySharedCacheDurationPresent, "shared_cache_duration"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForSharedCacheDuration] & RequiredBitForSharedCacheDuration) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertySharedCacheDurationNotPresent, "shared_cache_duration"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertySharedCacheDurationPresent, "shared_cache_duration"u8, "required"u8);
