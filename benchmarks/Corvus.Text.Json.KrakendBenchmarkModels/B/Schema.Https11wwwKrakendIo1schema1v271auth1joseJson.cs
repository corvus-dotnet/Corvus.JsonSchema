...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        internal Https11wwwKrakendIo1schema1v271auth1joseJson(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Baseline.JsonInteger SharedCacheDuration
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SharedCacheDurationUtf8, out Corvus.KrakendBenchmark.Baseline.JsonInteger value))
                {
                    return value;
                }
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Https11wwwKrakendIo1schema1v271auth1joseJson left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Https11wwwKrakendIo1schema1v271auth1joseJson instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Https11wwwKrakendIo1schema1v271auth1joseJson(JsonElement instance)
        {
            return Https11wwwKrakendIo1schema1v271auth1joseJson.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271auth1joseJson From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271auth1joseJson ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271auth1joseJson>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271auth1joseJson ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271auth1joseJson>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271auth1joseJson ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271auth1joseJson>(json, options);
        }
        ...
        /// </exception>
        public static Https11wwwKrakendIo1schema1v271auth1joseJson ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271auth1joseJson>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Https11wwwKrakendIo1schema1v271auth1joseJson? result)
        {
            return JsonElementHelpers.TryParseValue<Https11wwwKrakendIo1schema1v271auth1joseJson>(ref reader, out result);
        }
...
#if NET
        static Https11wwwKrakendIo1schema1v271auth1joseJson IJsonElement<Https11wwwKrakendIo1schema1v271auth1joseJson>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Https11wwwKrakendIo1schema1v271auth1joseJson: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public Https11wwwKrakendIo1schema1v271auth1joseJson Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public Https11wwwKrakendIo1schema1v271auth1joseJson Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<Https11wwwKrakendIo1schema1v271auth1joseJson>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="SharedCacheDuration"/>.
            /// </summary>
            public static ReadOnlySpan<byte> SharedCacheDuration => "shared_cache_duration"u8;
        }
    }
}
