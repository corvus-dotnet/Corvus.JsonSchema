    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1revokerJson
    {
        ...
        public readonly partial struct RevokeServerMaxRetries
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RevokeServerMaxRetries instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RevokeServerMaxRetries"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RevokeServerMaxRetries(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RevokeServerMaxRetries.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RevokeServerMaxRetries Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RevokeServerMaxRetries Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RevokeServerMaxRetries>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RevokeServerMaxRetries instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RevokeServerMaxRetries, Mutable>(this);
            }
        }
    }
}
