...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1revokerJson
    {
        ...
        public readonly partial struct RevokeServerMaxRetries
#if NET8_0_OR_GREATER
            : IJsonElement<RevokeServerMaxRetries>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RevokeServerMaxRetries"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RevokeServerMaxRetries(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RevokeServerMaxRetries DefaultInstance { get; } = ParsedJsonDocument<RevokeServerMaxRetries>.NumberConstant([.."0"u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator long(RevokeServerMaxRetries value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator double(RevokeServerMaxRetries value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator Corvus.Numerics.BigNumber(RevokeServerMaxRetries value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator System.Numerics.BigInteger(RevokeServerMaxRetries value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator decimal(RevokeServerMaxRetries value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in RevokeServerMaxRetries left, in RevokeServerMaxRetries right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RevokeServerMaxRetries left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RevokeServerMaxRetries instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RevokeServerMaxRetries(JsonElement instance)
            {
                return RevokeServerMaxRetries.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RevokeServerMaxRetries From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RevokeServerMaxRetries ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RevokeServerMaxRetries>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RevokeServerMaxRetries ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RevokeServerMaxRetries>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RevokeServerMaxRetries ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RevokeServerMaxRetries>(json, options);
            }
            ...
            /// </exception>
            public static RevokeServerMaxRetries ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RevokeServerMaxRetries>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RevokeServerMaxRetries? result)
            {
                return JsonElementHelpers.TryParseValue<RevokeServerMaxRetries>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RevokeServerMaxRetries(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RevokeServerMaxRetries IJsonElement<RevokeServerMaxRetries>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RevokeServerMaxRetries: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RevokeServerMaxRetries"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RevokeServerMaxRetries"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RevokeServerMaxRetries Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RevokeServerMaxRetries>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RevokeServerMaxRetries"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RevokeServerMaxRetries Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RevokeServerMaxRetries>(_idx);
                }
