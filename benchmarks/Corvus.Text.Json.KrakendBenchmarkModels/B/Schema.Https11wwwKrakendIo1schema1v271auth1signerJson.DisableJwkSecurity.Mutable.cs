    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1signerJson
    {
        ...
        public readonly partial struct DisableJwkSecurity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DisableJwkSecurity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DisableJwkSecurity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DisableJwkSecurity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DisableJwkSecurity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DisableJwkSecurity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DisableJwkSecurity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DisableJwkSecurity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DisableJwkSecurity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DisableJwkSecurity, Mutable>(this);
            }
        }
    }
}
