...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1signerJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="FullFormat"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal FullFormat(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static FullFormat DefaultInstance { get; } = ParsedJsonDocument<FullFormat>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(FullFormat value)
            {
            ...
            /// </returns>
            public static bool operator ==(in FullFormat left, in FullFormat right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in FullFormat left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(FullFormat instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator FullFormat(JsonElement instance)
            {
                return FullFormat.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FullFormat From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FullFormat ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FullFormat>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FullFormat ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FullFormat>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FullFormat ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FullFormat>(json, options);
            }
            ...
            /// </exception>
            public static FullFormat ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<FullFormat>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out FullFormat? result)
            {
                return JsonElementHelpers.TryParseValue<FullFormat>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new FullFormat(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static FullFormat IJsonElement<FullFormat>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"FullFormat: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="FullFormat"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="FullFormat"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public FullFormat Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<FullFormat>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="FullFormat"/> that lives for the lifetime of its
