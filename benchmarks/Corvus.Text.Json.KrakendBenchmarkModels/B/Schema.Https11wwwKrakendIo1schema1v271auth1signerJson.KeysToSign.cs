...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1signerJson
    {
        ...
        public readonly partial struct KeysToSign
#if NET8_0_OR_GREATER
            : IJsonElement<KeysToSign>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="KeysToSign"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal KeysToSign(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static KeysToSign DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in KeysToSign left, in KeysToSign right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in KeysToSign left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(KeysToSign instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator KeysToSign(JsonElement instance)
            {
                return KeysToSign.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static KeysToSign From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static KeysToSign ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<KeysToSign>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static KeysToSign ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<KeysToSign>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static KeysToSign ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<KeysToSign>(json, options);
            }
            ...
            /// </exception>
            public static KeysToSign ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<KeysToSign>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out KeysToSign? result)
            {
                return JsonElementHelpers.TryParseValue<KeysToSign>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new KeysToSign(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static KeysToSign IJsonElement<KeysToSign>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"KeysToSign: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="KeysToSign"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="KeysToSign"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public KeysToSign Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<KeysToSign>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="KeysToSign"/> that lives for the lifetime of its
