    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1signerJson
    {
        ...
        public readonly partial struct RequiredAlgAndDisableJwkSecurityAndJwkLocalPath
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequiredAlgAndDisableJwkSecurityAndJwkLocalPath instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequiredAlgAndDisableJwkSecurityAndJwkLocalPath"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredAlgAndDisableJwkSecurityAndJwkLocalPath(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.JsonElement.Mutable DisableJwkSecurity
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisableJwkSecurityUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.JsonElement.Mutable JwkLocalPath
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.JwkLocalPathUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RequiredAlgAndDisableJwkSecurityAndJwkLocalPath(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetDisableJwkSecurity(in Corvus.Text.Json.JsonElement.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("disable_jwk_security");
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisableJwkSecurityUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsProperty(JsonPropertyNamesEscaped.DisableJwkSecurity, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetDisableJwkSecurity<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
                ...
                public void SetJwkLocalPath(in Corvus.Text.Json.JsonElement.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("jwk_local_path");
                    }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetJwkLocalPath<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredAlgAndDisableJwkSecurityAndJwkLocalPath.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RequiredAlgAndDisableJwkSecurityAndJwkLocalPath"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RequiredAlgAndDisableJwkSecurityAndJwkLocalPath"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredAlgAndDisableJwkSecurityAndJwkLocalPath Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RequiredAlgAndDisableJwkSecurityAndJwkLocalPath>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RequiredAlgAndDisableJwkSecurityAndJwkLocalPath"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredAlgAndDisableJwkSecurityAndJwkLocalPath Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequiredAlgAndDisableJwkSecurityAndJwkLocalPath>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271auth1signerJson.RequiredAlgAndDisableJwkSecurityAndJwkLocalPath.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(RequiredAlgAndDisableJwkSecurityAndJwkLocalPath instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271auth1signerJson.RequiredAlgAndDisableJwkSecurityAndJwkLocalPath.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.Text.Json.JsonElement.Source disableJwkSecurity,
                    in Corvus.Text.Json.JsonElement.Source jwkLocalPath)
                {
                    alg.AddAsProperty(JsonPropertyNamesEscaped.Alg, ref builder, escapeName: false);
                    disableJwkSecurity.AddAsProperty(JsonPropertyNamesEscaped.DisableJwkSecurity, ref builder, escapeName: false);
                ...
                public void Create(
                    ...
                    in Corvus.Text.Json.JsonElement.Source jwkLocalPath)
                {
                    Create(ref _builder, alg, disableJwkSecurity, jwkLocalPath);
                }
                ...
                internal static void Create<TContext>(
                    ...
                    in Corvus.Text.Json.JsonElement.Source<TContext> disableJwkSecurity,
                    in Corvus.Text.Json.JsonElement.Source<TContext> jwkLocalPath)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                #endif
                {
                    Create(context, ref _builder, alg, disableJwkSecurity, jwkLocalPath);
                }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source alg, in Corvus.Text.Json.JsonElement.Source disableJwkSecurity, in Corvus.Text.Json.JsonElement.Source jwkLocalPath, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(alg, disableJwkSecurity, jwkLocalPath);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> alg, in Corvus.Text.Json.JsonElement.Source<TContext> disableJwkSecurity, in Corvus.Text.Json.JsonElement.Source<TContext> jwkLocalPath, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, alg, disableJwkSecurity, jwkLocalPath);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<RequiredAlgAndDisableJwkSecurityAndJwkLocalPath, Mutable>(this);
            }
        }
    }
}
