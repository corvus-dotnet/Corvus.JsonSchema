    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1validatorJson
    {
        ...
        public readonly partial struct Cache
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Cache instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Cache"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Cache(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Cache.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly Cache Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Cache>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Cache instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<Cache, Mutable>(this);
            }
        }
    }
}
