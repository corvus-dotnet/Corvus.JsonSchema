    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1validatorJson
    {
            ...
            : IJsonElement<KeyIdentifyStrategy>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "kid"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly KeyIdentifyStrategy EnumJson1 = ParsedJsonDocument<KeyIdentifyStrategy>.StringConstant([.."\"kid\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "x5t"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly KeyIdentifyStrategy EnumJson2 = ParsedJsonDocument<KeyIdentifyStrategy>.StringConstant([.."\"x5t\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum3 = "kid_x5t"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly KeyIdentifyStrategy EnumJson3 = ParsedJsonDocument<KeyIdentifyStrategy>.StringConstant([.."\"kid_x5t\""u8]);
            }
            ...
            public static class EnumValues
            {
                /// <summary>
                /// Gets the string "kid"
                /// as a <see cref="KeyIdentifyStrategy"/>.
                /// </summary>
                public static KeyIdentifyStrategy Kid { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "kid"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> KidUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "x5t"
                /// as a <see cref="KeyIdentifyStrategy"/>.
                /// </summary>
                public static KeyIdentifyStrategy X5t { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "x5t"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> X5tUtf8 => Constants.Enum2;

                /// <summary>
                /// Gets the string "kid_x5t"
                /// as a <see cref="KeyIdentifyStrategy"/>.
                /// </summary>
                public static KeyIdentifyStrategy KidX5t { get; } = Constants.EnumJson3;
                /// <summary>
                /// Gets the string "kid_x5t"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> KidX5tUtf8 => Constants.Enum3;
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1auth~1validator.json/properties/key_identify_strategy"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1auth~1validator.json/properties/key_identify_strategy";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1auth~1validator.json/properties/key_identify_strategy"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("kid"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("x5t"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("kid_x5t"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }
                    }
