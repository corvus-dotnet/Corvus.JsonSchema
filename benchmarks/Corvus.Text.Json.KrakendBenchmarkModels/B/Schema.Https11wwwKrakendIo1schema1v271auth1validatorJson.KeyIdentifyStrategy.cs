...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1validatorJson
    {
        ...
        public readonly partial struct KeyIdentifyStrategy
#if NET8_0_OR_GREATER
            : IJsonElement<KeyIdentifyStrategy>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="KeyIdentifyStrategy"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal KeyIdentifyStrategy(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static KeyIdentifyStrategy DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(KeyIdentifyStrategy value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in KeyIdentifyStrategy left, in KeyIdentifyStrategy right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in KeyIdentifyStrategy left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(KeyIdentifyStrategy instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator KeyIdentifyStrategy(JsonElement instance)
            {
                return KeyIdentifyStrategy.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static KeyIdentifyStrategy From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static KeyIdentifyStrategy ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<KeyIdentifyStrategy>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static KeyIdentifyStrategy ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<KeyIdentifyStrategy>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static KeyIdentifyStrategy ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<KeyIdentifyStrategy>(json, options);
            }
            ...
            /// </exception>
            public static KeyIdentifyStrategy ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<KeyIdentifyStrategy>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out KeyIdentifyStrategy? result)
            {
                return JsonElementHelpers.TryParseValue<KeyIdentifyStrategy>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new KeyIdentifyStrategy(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static KeyIdentifyStrategy IJsonElement<KeyIdentifyStrategy>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"KeyIdentifyStrategy: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="KeyIdentifyStrategy"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="KeyIdentifyStrategy"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public KeyIdentifyStrategy Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<KeyIdentifyStrategy>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="KeyIdentifyStrategy"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public KeyIdentifyStrategy Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<KeyIdentifyStrategy>(_idx);
                }
            ...
            /// <param name="matchKid">Match 1st item.</param>
            /// <param name="matchX5t">Match 2nd item.</param>
            /// <param name="matchKidX5t">Match 3rd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchKid,
                Func<TContext, TResult> matchX5t,
                Func<TContext, TResult> matchKidX5t,
...
#endif
            {
                ...
                {
                    return matchKid(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchX5t(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchKidX5t(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchKid,
                Func<TResult> matchX5t,
                Func<TResult> matchKidX5t,
