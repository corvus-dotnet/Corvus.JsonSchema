...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1validatorJson
    {
...
#endif
        {
            ...
            internal RequiredAlgAndJwkUrl(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.JsonElement JwkUrl
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.JwkUrlUtf8, out Corvus.Text.Json.JsonElement value))
                    {
                        return value;
                    }
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RequiredAlgAndJwkUrl left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RequiredAlgAndJwkUrl instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredAlgAndJwkUrl(JsonElement instance)
            {
                return RequiredAlgAndJwkUrl.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredAlgAndJwkUrl From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredAlgAndJwkUrl ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredAlgAndJwkUrl>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredAlgAndJwkUrl ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredAlgAndJwkUrl>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredAlgAndJwkUrl ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredAlgAndJwkUrl>(json, options);
            }
            ...
            /// </exception>
            public static RequiredAlgAndJwkUrl ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RequiredAlgAndJwkUrl>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredAlgAndJwkUrl? result)
            {
                return JsonElementHelpers.TryParseValue<RequiredAlgAndJwkUrl>(ref reader, out result);
            }
...
#if NET
            static RequiredAlgAndJwkUrl IJsonElement<RequiredAlgAndJwkUrl>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredAlgAndJwkUrl: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public RequiredAlgAndJwkUrl Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public RequiredAlgAndJwkUrl Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RequiredAlgAndJwkUrl>(_idx);
                }
