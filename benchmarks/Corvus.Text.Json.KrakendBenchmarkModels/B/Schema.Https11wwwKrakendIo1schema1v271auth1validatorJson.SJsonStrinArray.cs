...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1validatorJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Gets a <see cref="SJsonStrinArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SJsonStrinArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public SJsonStrinArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SJsonStrinArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SJsonStrinArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public SJsonStrinArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SJsonStrinArray>(_idx);
                }
