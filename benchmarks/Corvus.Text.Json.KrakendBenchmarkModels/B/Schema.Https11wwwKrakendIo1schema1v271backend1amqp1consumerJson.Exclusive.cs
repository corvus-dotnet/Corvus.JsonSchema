...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1amqp1consumerJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="Exclusive"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal Exclusive(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Exclusive DefaultInstance { get; } = ParsedJsonDocument<Exclusive>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(Exclusive value)
            {
            ...
            /// </returns>
            public static bool operator ==(in Exclusive left, in Exclusive right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Exclusive left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(Exclusive instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Exclusive(JsonElement instance)
            {
                return Exclusive.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Exclusive From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Exclusive ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Exclusive>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Exclusive ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Exclusive>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Exclusive ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Exclusive>(json, options);
            }
            ...
            /// </exception>
            public static Exclusive ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Exclusive>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Exclusive? result)
            {
                return JsonElementHelpers.TryParseValue<Exclusive>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Exclusive(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static Exclusive IJsonElement<Exclusive>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Exclusive: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Exclusive"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Exclusive"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Exclusive Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Exclusive>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Exclusive"/> that lives for the lifetime of its
