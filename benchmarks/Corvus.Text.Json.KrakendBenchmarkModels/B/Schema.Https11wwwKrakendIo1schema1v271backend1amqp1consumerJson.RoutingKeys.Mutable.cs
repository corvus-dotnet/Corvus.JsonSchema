    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1amqp1consumerJson
    {
        ...
        public readonly partial struct RoutingKeys
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RoutingKeys instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RoutingKeys"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RoutingKeys(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RoutingKeys.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public readonly RoutingKeys Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RoutingKeys Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RoutingKeys>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271backend1amqp1consumerJson.RoutingKeys.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(RoutingKeys instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271backend1amqp1consumerJson.RoutingKeys.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<RoutingKeys, Mutable>(this);
            }
        }
    }
}
