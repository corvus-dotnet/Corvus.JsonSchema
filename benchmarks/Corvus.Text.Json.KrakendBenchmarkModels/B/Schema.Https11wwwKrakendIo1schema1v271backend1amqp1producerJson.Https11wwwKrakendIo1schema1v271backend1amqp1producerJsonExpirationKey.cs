...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1amqp1producerJson
    {
        ...
        public readonly partial struct Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey
#if NET8_0_OR_GREATER
            : IJsonElement<Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey DefaultInstance { get; } = ParsedJsonDocument<Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey>.StringConstant([.."\"\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey left, in Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey(JsonElement instance)
            {
                return Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey>(json, options);
            }
            ...
            /// </exception>
            public static Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey? result)
            {
                return JsonElementHelpers.TryParseValue<Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey IJsonElement<Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey>(_idx);
                }
