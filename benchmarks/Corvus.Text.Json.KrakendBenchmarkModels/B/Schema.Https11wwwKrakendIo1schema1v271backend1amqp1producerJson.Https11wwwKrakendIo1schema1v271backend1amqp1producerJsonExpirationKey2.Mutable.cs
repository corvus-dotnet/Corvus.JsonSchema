...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1amqp1producerJson
    {
        ...
        public readonly partial struct Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2 instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2 Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2 Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2 instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2, Mutable>(this);
            }
        }
    }
}
