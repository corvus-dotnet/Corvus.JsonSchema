...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1amqp1producerJson
    {
        ...
        public readonly partial struct Immediate
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Immediate instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Immediate"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Immediate(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Immediate(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Immediate.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Immediate"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Immediate"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly Immediate Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Immediate>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Immediate"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly Immediate Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Immediate>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Immediate instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<Immediate, Mutable>(this);
            }
        }
    }
}
