    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1graphqlJson
    {
        ...
        public readonly partial struct Variables
        {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271backend1graphqlJson.Variables.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271backend1graphqlJson.Variables.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
