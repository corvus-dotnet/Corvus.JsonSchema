...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1grpcJson
    {
        ...
        public readonly partial struct MappingOfParameters
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(MappingOfParameters instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MappingOfParameters"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MappingOfParameters(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new MappingOfParameters(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MappingOfParameters.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="MappingOfParameters"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="MappingOfParameters"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly MappingOfParameters Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<MappingOfParameters>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="MappingOfParameters"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly MappingOfParameters Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MappingOfParameters>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271backend1grpcJson.MappingOfParameters.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(MappingOfParameters instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271backend1grpcJson.MappingOfParameters.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<MappingOfParameters, Mutable>(this);
            }
        }
    }
}
