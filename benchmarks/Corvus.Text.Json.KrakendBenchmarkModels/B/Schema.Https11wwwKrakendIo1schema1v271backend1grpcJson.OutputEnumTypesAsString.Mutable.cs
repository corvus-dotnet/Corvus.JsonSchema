    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1grpcJson
    {
        ...
        public readonly partial struct OutputEnumTypesAsString
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(OutputEnumTypesAsString instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OutputEnumTypesAsString"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OutputEnumTypesAsString(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OutputEnumTypesAsString.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly OutputEnumTypesAsString Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly OutputEnumTypesAsString Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OutputEnumTypesAsString>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(OutputEnumTypesAsString instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<OutputEnumTypesAsString, Mutable>(this);
            }
        }
    }
}
