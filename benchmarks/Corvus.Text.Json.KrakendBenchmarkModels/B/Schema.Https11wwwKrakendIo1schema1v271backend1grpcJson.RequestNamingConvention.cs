...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1grpcJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RequestNamingConvention"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RequestNamingConvention(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RequestNamingConvention DefaultInstance { get; } = ParsedJsonDocument<RequestNamingConvention>.StringConstant([.."\"snake_case\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(RequestNamingConvention value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in RequestNamingConvention left, in RequestNamingConvention right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RequestNamingConvention left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RequestNamingConvention instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequestNamingConvention(JsonElement instance)
            {
                return RequestNamingConvention.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequestNamingConvention From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequestNamingConvention ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequestNamingConvention>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequestNamingConvention ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequestNamingConvention>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequestNamingConvention ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequestNamingConvention>(json, options);
            }
            ...
            /// </exception>
            public static RequestNamingConvention ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RequestNamingConvention>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RequestNamingConvention? result)
            {
                return JsonElementHelpers.TryParseValue<RequestNamingConvention>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RequestNamingConvention(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RequestNamingConvention IJsonElement<RequestNamingConvention>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequestNamingConvention: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RequestNamingConvention"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RequestNamingConvention"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RequestNamingConvention Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RequestNamingConvention>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RequestNamingConvention"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RequestNamingConvention Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RequestNamingConvention>(_idx);
                }
