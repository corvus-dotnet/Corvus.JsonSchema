...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1pubsub1publisherJson
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Https11wwwKrakendIo1schema1v271backend1pubsub1publisherJson instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Https11wwwKrakendIo1schema1v271backend1pubsub1publisherJson"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Https11wwwKrakendIo1schema1v271backend1pubsub1publisherJson(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Baseline.JsonString.Mutable TopicUrl
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TopicUrlUtf8, out Corvus.KrakendBenchmark.Baseline.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Https11wwwKrakendIo1schema1v271backend1pubsub1publisherJson(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetTopicUrl(in Corvus.KrakendBenchmark.Baseline.JsonString.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("topic_url");
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TopicUrlUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsProperty(JsonPropertyNamesEscaped.TopicUrl, ref cvb, escapeName: false, nameRequiresUnescaping: false);
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Https11wwwKrakendIo1schema1v271backend1pubsub1publisherJson.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Https11wwwKrakendIo1schema1v271backend1pubsub1publisherJson"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Https11wwwKrakendIo1schema1v271backend1pubsub1publisherJson"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Https11wwwKrakendIo1schema1v271backend1pubsub1publisherJson Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Https11wwwKrakendIo1schema1v271backend1pubsub1publisherJson>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Https11wwwKrakendIo1schema1v271backend1pubsub1publisherJson"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Https11wwwKrakendIo1schema1v271backend1pubsub1publisherJson Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Https11wwwKrakendIo1schema1v271backend1pubsub1publisherJson>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271backend1pubsub1publisherJson.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(Https11wwwKrakendIo1schema1v271backend1pubsub1publisherJson instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271backend1pubsub1publisherJson.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.KrakendBenchmark.Baseline.JsonString.Source topicUrl)
            {
                topicUrl.AddAsProperty(JsonPropertyNamesEscaped.TopicUrl, ref builder, escapeName: false);
            }

            /// <summary>
            /// Creates an instance of a <see cref="Https11wwwKrakendIo1schema1v271backend1pubsub1publisherJson"/>.
            /// </summary>
            public void Create(in Corvus.KrakendBenchmark.Baseline.JsonString.Source topicUrl)
            {
                Create(ref _builder, topicUrl);
            }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="topicUrl">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Baseline.JsonString.Source topicUrl, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        {
            return workspace.CreateBuilder<Https11wwwKrakendIo1schema1v271backend1pubsub1publisherJson, Mutable>(this);
        }
    }
}
