...
public readonly partial struct Schema
{
        ...
        : IJsonElement<Https11wwwKrakendIo1schema1v271backend1pubsub1subscriberJson>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertySubscriptionUrlPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("subscription_url"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertySubscriptionUrlNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("subscription_url"u8, buffer, out written);

            private const int RequiredOffsetForSubscriptionUrl = 0;
            private const uint RequiredBitForSubscriptionUrl = 0b00000000000000000000000000000001;

            private const uint RequiredBitMask0 =
                RequiredBitForSubscriptionUrl;
            private static readonly JsonSchemaPathProvider SubscriptionUrlSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/subscription_url"u8, buffer, out written);

            private static void MatchSubscriptionUrl(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.KrakendBenchmark.Baseline.JsonString.JsonSchema.PushChildContextUnescaped(
                        ...
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.SubscriptionUrlUtf8,
                        evaluationPath: SubscriptionUrlSchemaEvaluationPath);
                ...
                requiredBitBuffer[RequiredOffsetForSubscriptionUrl] |= RequiredBitForSubscriptionUrl;
            }
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.SubscriptionUrlUtf8))
                {
                    matcher = MatchSubscriptionUrl;
                    return true;
                }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend~1pubsub~1subscriber.json"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend~1pubsub~1subscriber.json";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend~1pubsub~1subscriber.json"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertySubscriptionUrlPresent, "subscription_url"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForSubscriptionUrl] & RequiredBitForSubscriptionUrl) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertySubscriptionUrlNotPresent, "subscription_url"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertySubscriptionUrlPresent, "subscription_url"u8, "required"u8);
