...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1pubsub1subscriberJson
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Https11wwwKrakendIo1schema1v271backend1pubsub1subscriberJson instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Https11wwwKrakendIo1schema1v271backend1pubsub1subscriberJson"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Https11wwwKrakendIo1schema1v271backend1pubsub1subscriberJson(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Baseline.JsonString.Mutable SubscriptionUrl
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SubscriptionUrlUtf8, out Corvus.KrakendBenchmark.Baseline.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Set the <c>subscription_url</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetSubscriptionUrl(in Corvus.KrakendBenchmark.Baseline.JsonString.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("subscription_url");
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SubscriptionUrlUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsProperty(JsonPropertyNamesEscaped.SubscriptionUrl, ref cvb, escapeName: false, nameRequiresUnescaping: false);
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Https11wwwKrakendIo1schema1v271backend1pubsub1subscriberJson.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Https11wwwKrakendIo1schema1v271backend1pubsub1subscriberJson Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly Https11wwwKrakendIo1schema1v271backend1pubsub1subscriberJson Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Https11wwwKrakendIo1schema1v271backend1pubsub1subscriberJson>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271backend1pubsub1subscriberJson.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(Https11wwwKrakendIo1schema1v271backend1pubsub1subscriberJson instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271backend1pubsub1subscriberJson.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Https11wwwKrakendIo1schema1v271backend1pubsub1subscriberJson"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.KrakendBenchmark.Baseline.JsonString.Source subscriptionUrl)
            {
                subscriptionUrl.AddAsProperty(JsonPropertyNamesEscaped.SubscriptionUrl, ref builder, escapeName: false);
            }

            /// <summary>
            /// Creates an instance of a <see cref="Https11wwwKrakendIo1schema1v271backend1pubsub1subscriberJson"/>.
            /// </summary>
            public void Create(in Corvus.KrakendBenchmark.Baseline.JsonString.Source subscriptionUrl)
            {
                Create(ref _builder, subscriptionUrl);
            }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="subscriptionUrl">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Baseline.JsonString.Source subscriptionUrl, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(subscriptionUrl);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<Https11wwwKrakendIo1schema1v271backend1pubsub1subscriberJson, Mutable>(this);
        }
    }
}
