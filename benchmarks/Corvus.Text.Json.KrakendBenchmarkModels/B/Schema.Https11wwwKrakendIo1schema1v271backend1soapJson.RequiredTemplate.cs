...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1soapJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RequiredTemplate"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RequiredTemplate(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RequiredTemplate DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.JsonElement Template
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TemplateUtf8, out Corvus.Text.Json.JsonElement value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in RequiredTemplate left, in RequiredTemplate right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RequiredTemplate left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RequiredTemplate instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredTemplate(JsonElement instance)
            {
                return RequiredTemplate.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredTemplate From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredTemplate ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredTemplate>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredTemplate ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredTemplate>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredTemplate ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredTemplate>(json, options);
            }
            ...
            /// </exception>
            public static RequiredTemplate ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RequiredTemplate>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredTemplate? result)
            {
                return JsonElementHelpers.TryParseValue<RequiredTemplate>(ref reader, out result);
            }
...
#if NET
            static RequiredTemplate IJsonElement<RequiredTemplate>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredTemplate: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public RequiredTemplate Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RequiredTemplate>(_idx);
                }
