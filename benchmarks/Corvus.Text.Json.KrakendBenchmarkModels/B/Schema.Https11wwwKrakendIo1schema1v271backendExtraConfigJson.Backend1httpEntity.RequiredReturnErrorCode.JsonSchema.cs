...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backendExtraConfigJson
    {
        ...
        public readonly partial struct Backend1httpEntity
        {
            ...
            public readonly partial struct RequiredReturnErrorCode
                : IJsonElement<RequiredReturnErrorCode>
            {
                public static partial class JsonSchema
                {
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyReturnErrorCodePresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("return_error_code"u8, buffer, out written);
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyReturnErrorCodeNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("return_error_code"u8, buffer, out written);

                    private const int RequiredOffsetForReturnErrorCode = 0;
                    private const uint RequiredBitForReturnErrorCode = 0b00000000000000000000000000000001;

                    private const uint RequiredBitMask0 =
                        RequiredBitForReturnErrorCode;

                    private static void MatchReturnErrorCode(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        requiredBitBuffer[RequiredOffsetForReturnErrorCode] |= RequiredBitForReturnErrorCode;
                    }
                    ...
                    {
                        if (span.SequenceEqual(JsonPropertyNames.ReturnErrorCodeUtf8))
                        {
                            matcher = MatchReturnErrorCode;
                            return true;
                        }
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend_extra_config.json/properties/backend~1http/oneOf/1"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend_extra_config.json/properties/backend~1http/oneOf/1";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend_extra_config.json/properties/backend~1http/oneOf/1"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.StartObject)
                        {
                            ...
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyReturnErrorCodePresent, "return_error_code"u8, "required"u8);
                            }
                            ...
                            {
                                if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForReturnErrorCode] & RequiredBitForReturnErrorCode) == 0)
                                {
                                    context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyReturnErrorCodeNotPresent, "return_error_code"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyReturnErrorCodePresent, "return_error_code"u8, "required"u8);
