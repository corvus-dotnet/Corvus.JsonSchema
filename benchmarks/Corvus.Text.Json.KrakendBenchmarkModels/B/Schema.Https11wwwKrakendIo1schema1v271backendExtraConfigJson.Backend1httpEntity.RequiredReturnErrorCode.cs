    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backendExtraConfigJson
    {
        ...
        public readonly partial struct Backend1httpEntity
        {
...
#endif
            {
                ...
                internal RequiredReturnErrorCode(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.JsonElement ReturnErrorCode
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReturnErrorCodeUtf8, out Corvus.Text.Json.JsonElement value))
                        {
                            return value;
                        }
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in RequiredReturnErrorCode left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(RequiredReturnErrorCode instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredReturnErrorCode(JsonElement instance)
                {
                    return RequiredReturnErrorCode.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredReturnErrorCode From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredReturnErrorCode ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredReturnErrorCode>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredReturnErrorCode ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredReturnErrorCode>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredReturnErrorCode ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredReturnErrorCode>(json, options);
                }
                ...
                /// </exception>
                public static RequiredReturnErrorCode ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<RequiredReturnErrorCode>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredReturnErrorCode? result)
                {
                    return JsonElementHelpers.TryParseValue<RequiredReturnErrorCode>(ref reader, out result);
                }
...
#if NET
                static RequiredReturnErrorCode IJsonElement<RequiredReturnErrorCode>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredReturnErrorCode: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public RequiredReturnErrorCode Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public RequiredReturnErrorCode Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<RequiredReturnErrorCode>(_idx);
                    }
