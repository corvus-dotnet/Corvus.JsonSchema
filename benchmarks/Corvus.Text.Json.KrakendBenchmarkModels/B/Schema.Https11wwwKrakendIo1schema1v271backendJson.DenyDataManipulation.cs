...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backendJson
    {
        ...
        public readonly partial struct DenyDataManipulation
#if NET8_0_OR_GREATER
            : IJsonElement<DenyDataManipulation>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DenyDataManipulation"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal DenyDataManipulation(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static DenyDataManipulation DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in DenyDataManipulation left, in DenyDataManipulation right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in DenyDataManipulation left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(DenyDataManipulation instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DenyDataManipulation(JsonElement instance)
            {
                return DenyDataManipulation.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DenyDataManipulation From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DenyDataManipulation ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DenyDataManipulation>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DenyDataManipulation ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DenyDataManipulation>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DenyDataManipulation ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DenyDataManipulation>(json, options);
            }
            ...
            /// </exception>
            public static DenyDataManipulation ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<DenyDataManipulation>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out DenyDataManipulation? result)
            {
                return JsonElementHelpers.TryParseValue<DenyDataManipulation>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DenyDataManipulation(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static DenyDataManipulation IJsonElement<DenyDataManipulation>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DenyDataManipulation: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DenyDataManipulation"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DenyDataManipulation"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public DenyDataManipulation Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DenyDataManipulation>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DenyDataManipulation"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public DenyDataManipulation Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<DenyDataManipulation>(_idx);
                }
