    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backendJson
    {
        ...
        public readonly partial struct IsACollectionArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(IsACollectionArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="IsACollectionArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IsACollectionArray(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IsACollectionArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly IsACollectionArray Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly IsACollectionArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<IsACollectionArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(IsACollectionArray instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<IsACollectionArray, Mutable>(this);
            }
        }
    }
}
