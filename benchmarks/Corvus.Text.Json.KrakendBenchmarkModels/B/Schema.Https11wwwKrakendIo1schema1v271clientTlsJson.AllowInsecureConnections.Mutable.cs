    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271clientTlsJson
    {
        ...
        public readonly partial struct AllowInsecureConnections
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AllowInsecureConnections instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AllowInsecureConnections"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AllowInsecureConnections(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AllowInsecureConnections.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AllowInsecureConnections Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AllowInsecureConnections Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AllowInsecureConnections>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AllowInsecureConnections instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AllowInsecureConnections, Mutable>(this);
            }
        }
    }
}
