...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271clientTlsJson
    {
        ...
        public readonly partial struct CipherSuites
#if NET8_0_OR_GREATER
            : IJsonElement<CipherSuites>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="CipherSuites"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal CipherSuites(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static CipherSuites DefaultInstance { get; } = CipherSuites.ParseValue("[ 4865, 4866, 4867 ]"u8);
            ...
            /// </returns>
            public static bool operator ==(in CipherSuites left, in CipherSuites right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in CipherSuites left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(CipherSuites instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CipherSuites(JsonElement instance)
            {
                return CipherSuites.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CipherSuites From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CipherSuites ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CipherSuites>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CipherSuites ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CipherSuites>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CipherSuites ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CipherSuites>(json, options);
            }
            ...
            /// </exception>
            public static CipherSuites ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<CipherSuites>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out CipherSuites? result)
            {
                return JsonElementHelpers.TryParseValue<CipherSuites>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new CipherSuites(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static CipherSuites IJsonElement<CipherSuites>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CipherSuites: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="CipherSuites"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="CipherSuites"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public CipherSuites Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<CipherSuites>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="CipherSuites"/> that lives for the lifetime of its
