    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271clientTlsJson
    {
...
#endif
        {
            ...
            public bool TryGetNumericValues(Span<double> items, out int written)
            {
                CheckValidInstance();
                written = 0;
                foreach (Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271clientTlsJson.CurvePreferencesEntityArray.CurvePreferencesEntity item in EnumerateArray())
                {
            ...
            public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271clientTlsJson.CurvePreferencesEntityArray.CurvePreferencesEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271clientTlsJson.CurvePreferencesEntityArray.CurvePreferencesEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271clientTlsJson.CurvePreferencesEntityArray.CurvePreferencesEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271clientTlsJson.CurvePreferencesEntityArray.CurvePreferencesEntity>(_parent, _idx);
            }
