...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271clientTlsJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="MinimumTlsVersion"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal MinimumTlsVersion(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static MinimumTlsVersion DefaultInstance { get; } = ParsedJsonDocument<MinimumTlsVersion>.StringConstant([.."\"TLS13\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(MinimumTlsVersion value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in MinimumTlsVersion left, in MinimumTlsVersion right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in MinimumTlsVersion left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(MinimumTlsVersion instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MinimumTlsVersion(JsonElement instance)
            {
                return MinimumTlsVersion.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MinimumTlsVersion From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MinimumTlsVersion ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MinimumTlsVersion>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MinimumTlsVersion ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MinimumTlsVersion>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MinimumTlsVersion ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MinimumTlsVersion>(json, options);
            }
            ...
            /// </exception>
            public static MinimumTlsVersion ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<MinimumTlsVersion>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out MinimumTlsVersion? result)
            {
                return JsonElementHelpers.TryParseValue<MinimumTlsVersion>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MinimumTlsVersion(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static MinimumTlsVersion IJsonElement<MinimumTlsVersion>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MinimumTlsVersion: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MinimumTlsVersion"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MinimumTlsVersion"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public MinimumTlsVersion Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MinimumTlsVersion>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MinimumTlsVersion"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public MinimumTlsVersion Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<MinimumTlsVersion>(_idx);
                }
            ...
            /// <param name="matchSsl30">Match 1st item.</param>
            /// <param name="matchTls10">Match 2nd item.</param>
            /// <param name="matchTls11">Match 3rd item.</param>
            /// <param name="matchTls12">Match 4th item.</param>
            /// <param name="matchTls13">Match 5th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchSsl30,
                Func<TContext, TResult> matchTls10,
                Func<TContext, TResult> matchTls11,
                Func<TContext, TResult> matchTls12,
                Func<TContext, TResult> matchTls13,
            ...
            public TResult Match<TResult>(
                Func<TResult> matchSsl30,
                Func<TResult> matchTls10,
                Func<TResult> matchTls11,
                Func<TResult> matchTls12,
                Func<TResult> matchTls13,
