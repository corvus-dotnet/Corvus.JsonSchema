...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271clientTlsJson
    {
        ...
        public readonly partial struct RequiredCertificateAndPrivateKeyArray
        {
            ...
            public readonly partial struct RequiredCertificateAndPrivateKey
                : IJsonElement<RequiredCertificateAndPrivateKey>
            {
                public static partial class JsonSchema
                {
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyCertificatePresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("certificate"u8, buffer, out written);
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyCertificateNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("certificate"u8, buffer, out written);

                    private const int RequiredOffsetForCertificate = 0;
                    private const uint RequiredBitForCertificate = 0b00000000000000000000000000000001;

                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyPrivateKeyPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("private_key"u8, buffer, out written);
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyPrivateKeyNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("private_key"u8, buffer, out written);

                    private const int RequiredOffsetForPrivateKey = 0;
                    private const uint RequiredBitForPrivateKey = 0b00000000000000000000000000000010;

                    private const uint RequiredBitMask0 =
                        RequiredBitForCertificate | RequiredBitForPrivateKey;
                    private static readonly JsonSchemaPathProvider CertificateSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/certificate"u8, buffer, out written);
                    ...
                    private static void MatchCertificate(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        ...
                        JsonSchemaContext childContext =
                            Corvus.KrakendBenchmark.Baseline.JsonString.JsonSchema.PushChildContextUnescaped(
                                ...
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.CertificateUtf8,
                                evaluationPath: CertificateSchemaEvaluationPath);
                        ...
                        requiredBitBuffer[RequiredOffsetForCertificate] |= RequiredBitForCertificate;
                    }

                    private static void MatchPrivateKey(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                        ...
                        requiredBitBuffer[RequiredOffsetForPrivateKey] |= RequiredBitForPrivateKey;
                    }
                    ...
                    private static PropertySchemaMatchers<Corvus.KrakendBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                    {
                        return new PropertySchemaMatchers<Corvus.KrakendBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator>([
                            (static () => JsonPropertyNames.CertificateUtf8, MatchCertificate),
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1client_tls.json/properties/client_certs/items"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1client_tls.json/properties/client_certs/items";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1client_tls.json/properties/client_certs/items"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyCertificatePresent, "certificate"u8, "required"u8);
                                context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyPrivateKeyPresent, "private_key"u8, "required"u8);
                            }
                            ...
                            {
                                if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForCertificate] & RequiredBitForCertificate) == 0)
                                {
                                    context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyCertificateNotPresent, "certificate"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyCertificatePresent, "certificate"u8, "required"u8);
                                ...
                                if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForPrivateKey] & RequiredBitForPrivateKey) == 0)
                                {
                                    context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyPrivateKeyNotPresent, "private_key"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyPrivateKeyPresent, "private_key"u8, "required"u8);
