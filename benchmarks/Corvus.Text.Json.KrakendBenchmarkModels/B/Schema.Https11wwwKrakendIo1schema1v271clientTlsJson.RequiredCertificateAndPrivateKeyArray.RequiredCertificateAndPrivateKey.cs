    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271clientTlsJson
    {
        ...
        public readonly partial struct RequiredCertificateAndPrivateKeyArray
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="RequiredCertificateAndPrivateKey"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal RequiredCertificateAndPrivateKey(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static RequiredCertificateAndPrivateKey DefaultInstance { get; }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Baseline.JsonString Certificate
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CertificateUtf8, out Corvus.KrakendBenchmark.Baseline.JsonString value))
                        {
                            return value;
                        }
                ...
                /// <summary>
                /// Gets the <c>private_key</c> property.
                /// Private key
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </returns>
                public static bool operator ==(in RequiredCertificateAndPrivateKey left, in RequiredCertificateAndPrivateKey right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in RequiredCertificateAndPrivateKey left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(RequiredCertificateAndPrivateKey instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredCertificateAndPrivateKey(JsonElement instance)
                {
                    return RequiredCertificateAndPrivateKey.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredCertificateAndPrivateKey From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredCertificateAndPrivateKey ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredCertificateAndPrivateKey>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredCertificateAndPrivateKey ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredCertificateAndPrivateKey>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredCertificateAndPrivateKey ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredCertificateAndPrivateKey>(json, options);
                }
                ...
                /// </exception>
                public static RequiredCertificateAndPrivateKey ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<RequiredCertificateAndPrivateKey>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredCertificateAndPrivateKey? result)
                {
                    return JsonElementHelpers.TryParseValue<RequiredCertificateAndPrivateKey>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RequiredCertificateAndPrivateKey(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static RequiredCertificateAndPrivateKey IJsonElement<RequiredCertificateAndPrivateKey>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredCertificateAndPrivateKey: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RequiredCertificateAndPrivateKey"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RequiredCertificateAndPrivateKey"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public RequiredCertificateAndPrivateKey Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RequiredCertificateAndPrivateKey>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RequiredCertificateAndPrivateKey"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public RequiredCertificateAndPrivateKey Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<RequiredCertificateAndPrivateKey>(_idx);
                    }
                ...
                {
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="Certificate"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Certificate => "certificate"u8;
