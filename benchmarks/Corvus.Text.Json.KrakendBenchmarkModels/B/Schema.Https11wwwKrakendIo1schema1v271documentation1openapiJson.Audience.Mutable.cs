    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271documentation1openapiJson
    {
        ...
        public readonly partial struct Audience
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Audience instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Audience"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Audience(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Audience(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Audience.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// <summary>
                /// Gets a <see cref="Audience"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Audience"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly Audience Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Audience>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Audience"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly Audience Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Audience>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.Audience.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(Audience instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.Audience.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<Audience, Mutable>(this);
            }
        }
    }
}
