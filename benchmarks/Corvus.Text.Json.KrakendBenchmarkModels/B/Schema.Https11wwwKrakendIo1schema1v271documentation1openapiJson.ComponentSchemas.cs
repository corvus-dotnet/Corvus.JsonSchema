...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271documentation1openapiJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ComponentSchemas"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ComponentSchemas(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ComponentSchemas DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in ComponentSchemas left, in ComponentSchemas right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ComponentSchemas left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(ComponentSchemas instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ComponentSchemas(JsonElement instance)
            {
                return ComponentSchemas.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ComponentSchemas From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ComponentSchemas ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ComponentSchemas>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ComponentSchemas ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ComponentSchemas>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ComponentSchemas ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ComponentSchemas>(json, options);
            }
            ...
            /// </exception>
            public static ComponentSchemas ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ComponentSchemas>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ComponentSchemas? result)
            {
                return JsonElementHelpers.TryParseValue<ComponentSchemas>(ref reader, out result);
            }
...
#if NET
            static ComponentSchemas IJsonElement<ComponentSchemas>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ComponentSchemas: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ComponentSchemas Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ComponentSchemas>(_idx);
                }
