            ...
            public readonly partial struct RequiredContentType
            {
                ...
                public readonly partial struct ContentType
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(ContentType instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="ContentType"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator ContentType(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"ContentType.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        /// <summary>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ContentType Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ContentType Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<ContentType>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.DefinitionOfErrorsOas3Only.RequiredContentType.ContentType.ObjectBuilder.Build value) {_objectBuilder = value; _kind = Kind.ObjectBuilder; }

                        internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.DefinitionOfErrorsOas3Only.RequiredContentType.ContentType.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }

                        public static implicit operator Source(ContentType instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.DefinitionOfErrorsOas3Only.RequiredContentType.ContentType.ObjectBuilder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.ObjectBuilder; }

                        internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.DefinitionOfErrorsOas3Only.RequiredContentType.ContentType.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }
                    ...
                    {
                        return workspace.CreateBuilder<ContentType, Mutable>(this);
                    }
                }
            }
        }
