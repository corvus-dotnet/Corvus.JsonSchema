...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271documentation1openapiJson
    {
        ...
        public readonly partial struct DefinitionOfErrorsOas3Only
            ...
            : IJsonElement<DefinitionOfErrorsOas3Only>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DefinitionOfErrorsOas3Only"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal DefinitionOfErrorsOas3Only(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static DefinitionOfErrorsOas3Only DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in DefinitionOfErrorsOas3Only left, in DefinitionOfErrorsOas3Only right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in DefinitionOfErrorsOas3Only left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(DefinitionOfErrorsOas3Only instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DefinitionOfErrorsOas3Only(JsonElement instance)
            {
                return DefinitionOfErrorsOas3Only.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DefinitionOfErrorsOas3Only From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DefinitionOfErrorsOas3Only ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DefinitionOfErrorsOas3Only>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DefinitionOfErrorsOas3Only ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DefinitionOfErrorsOas3Only>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DefinitionOfErrorsOas3Only ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DefinitionOfErrorsOas3Only>(json, options);
            }
            ...
            /// </exception>
            public static DefinitionOfErrorsOas3Only ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<DefinitionOfErrorsOas3Only>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out DefinitionOfErrorsOas3Only? result)
            {
                return JsonElementHelpers.TryParseValue<DefinitionOfErrorsOas3Only>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DefinitionOfErrorsOas3Only(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static DefinitionOfErrorsOas3Only IJsonElement<DefinitionOfErrorsOas3Only>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DefinitionOfErrorsOas3Only: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DefinitionOfErrorsOas3Only"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DefinitionOfErrorsOas3Only"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public DefinitionOfErrorsOas3Only Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DefinitionOfErrorsOas3Only>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DefinitionOfErrorsOas3Only"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public DefinitionOfErrorsOas3Only Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<DefinitionOfErrorsOas3Only>(_idx);
                }
