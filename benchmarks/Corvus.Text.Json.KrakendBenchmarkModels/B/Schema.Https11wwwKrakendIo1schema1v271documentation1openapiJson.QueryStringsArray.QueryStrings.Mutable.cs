        ...
        public readonly partial struct QueryStringsArray
        {
            ...
            public readonly partial struct QueryStrings
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(QueryStrings instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="QueryStrings"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator QueryStrings(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Baseline.JsonBoolean.Mutable Required
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RequiredUtf8, out Corvus.KrakendBenchmark.Baseline.JsonBoolean.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetRequired(in Corvus.KrakendBenchmark.Baseline.JsonBoolean.Source value)
                    {
                        CheckValidInstance();
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"QueryStrings.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly QueryStrings Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly QueryStrings Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<QueryStrings>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.QueryStringsArray.QueryStrings.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(QueryStrings instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.QueryStringsArray.QueryStrings.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="QueryStrings"/>.
                    /// </summary>
                    internal static void Create(
                        ...
                        in Corvus.KrakendBenchmark.Baseline.JsonBoolean.Source required = default)
                    {
                    ...
                    public void Create(
                        ...
                        in Corvus.KrakendBenchmark.Baseline.JsonBoolean.Source required = default)
                    {
                        Create(ref _builder, name, description, required);
                    }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Baseline.JsonString.Source name, in Corvus.KrakendBenchmark.Baseline.JsonString.Source description = default, in Corvus.KrakendBenchmark.Baseline.JsonBoolean.Source required = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(name, description, required);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<QueryStrings, Mutable>(this);
                }
            }
        }
    }
