...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271documentation1openapiJson
    {
        ...
        /// </para>
        /// </remarks>
        public readonly partial struct QueryStringsArray
        {
            /// <summary>
            /// Query strings
            /// </summary>
            [DebuggerDisplay("{DebuggerDisplay,nq}")]
            public readonly partial struct QueryStrings
#if NET8_0_OR_GREATER
                : IJsonElement<QueryStrings>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="QueryStrings"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal QueryStrings(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static QueryStrings DefaultInstance { get; }
                ...
                /// <remarks>
                /// <para>
                /// The description of the querystring
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Baseline.JsonString Description
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out Corvus.KrakendBenchmark.Baseline.JsonString value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// <para>
                /// The name of the querystring, as declared in `input_query_strings`
                /// </para>
                /// </remarks>
                ...
                /// <remarks>
                /// <para>
                /// Set to `true` when this query string is required
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Baseline.JsonBoolean Required
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RequiredUtf8, out Corvus.KrakendBenchmark.Baseline.JsonBoolean value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in QueryStrings left, in QueryStrings right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in QueryStrings left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(QueryStrings instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator QueryStrings(JsonElement instance)
                {
                    return QueryStrings.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static QueryStrings From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static QueryStrings ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<QueryStrings>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static QueryStrings ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<QueryStrings>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static QueryStrings ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<QueryStrings>(json, options);
                }
                ...
                /// </exception>
                public static QueryStrings ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<QueryStrings>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out QueryStrings? result)
                {
                    return JsonElementHelpers.TryParseValue<QueryStrings>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new QueryStrings(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static QueryStrings IJsonElement<QueryStrings>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"QueryStrings: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="QueryStrings"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="QueryStrings"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public QueryStrings Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<QueryStrings>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="QueryStrings"/> that lives for the lifetime of its
