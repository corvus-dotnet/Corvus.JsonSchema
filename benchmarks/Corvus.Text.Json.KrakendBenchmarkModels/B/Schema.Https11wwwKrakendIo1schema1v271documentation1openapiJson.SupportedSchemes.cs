...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271documentation1openapiJson
    {
        ...
        public readonly partial struct SupportedSchemes
#if NET8_0_OR_GREATER
            : IJsonElement<SupportedSchemes>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SupportedSchemes"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SupportedSchemes(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SupportedSchemes DefaultInstance { get; } = SupportedSchemes.ParseValue("[ \"http\" ]"u8);
            ...
            /// </returns>
            public static bool operator ==(in SupportedSchemes left, in SupportedSchemes right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SupportedSchemes left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(SupportedSchemes instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SupportedSchemes(JsonElement instance)
            {
                return SupportedSchemes.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SupportedSchemes From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SupportedSchemes ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SupportedSchemes>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SupportedSchemes ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SupportedSchemes>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SupportedSchemes ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SupportedSchemes>(json, options);
            }
            ...
            /// </exception>
            public static SupportedSchemes ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SupportedSchemes>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SupportedSchemes? result)
            {
                return JsonElementHelpers.TryParseValue<SupportedSchemes>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SupportedSchemes(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static SupportedSchemes IJsonElement<SupportedSchemes>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SupportedSchemes: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SupportedSchemes"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SupportedSchemes"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public SupportedSchemes Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SupportedSchemes>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SupportedSchemes"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public SupportedSchemes Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SupportedSchemes>(_idx);
                }
