...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271endpointExtraConfigJson
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Baseline.JsonString Identifier
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdentifierUtf8, out Corvus.KrakendBenchmark.Baseline.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271endpointExtraConfigJson.ApiKeyValidation.JsonStringArray Roles
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RolesUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271endpointExtraConfigJson.ApiKeyValidation.JsonStringArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271endpointExtraConfigJson.ApiKeyValidation.Strategy StrategyValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StrategyValueUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271endpointExtraConfigJson.ApiKeyValidation.Strategy value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets a <see cref="ApiKeyValidation"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ApiKeyValidation"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ApiKeyValidation Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ApiKeyValidation>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ApiKeyValidation"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ApiKeyValidation Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ApiKeyValidation>(_idx);
                }
