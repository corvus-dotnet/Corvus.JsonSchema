    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271endpointExtraConfigJson
    {
        ...
        public readonly partial struct Proxy
        {
            ...
            public readonly partial struct StaticResponse
                : IJsonElement<StaticResponse>
            {
                public static partial class JsonSchema
                {
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDataPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("data"u8, buffer, out written);
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDataNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("data"u8, buffer, out written);

                    private const int RequiredOffsetForData = 0;
                    private const uint RequiredBitForData = 0b00000000000000000000000000000001;

                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyStrategyPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("strategy"u8, buffer, out written);
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyStrategyNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("strategy"u8, buffer, out written);

                    private const int RequiredOffsetForStrategy = 0;
                    private const uint RequiredBitForStrategy = 0b00000000000000000000000000000010;

                    private const uint RequiredBitMask0 =
                        RequiredBitForData | RequiredBitForStrategy;
                    private static readonly JsonSchemaPathProvider DataValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/data"u8, buffer, out written);
                    ...
                    private static void MatchDataValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        ...
                        JsonSchemaContext childContext =
                            Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271endpointExtraConfigJson.Proxy.StaticResponse.Data.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                        ...
                        Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271endpointExtraConfigJson.Proxy.StaticResponse.Data.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                        ...
                        requiredBitBuffer[RequiredOffsetForData] |= RequiredBitForData;
                    }
                    ...
                    private static void MatchStrategyValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        ...
                        JsonSchemaContext childContext1 =
                            Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271endpointExtraConfigJson.Proxy.StaticResponse.Strategy.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                        ...
                        Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271endpointExtraConfigJson.Proxy.StaticResponse.Strategy.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                        ...
                        requiredBitBuffer[RequiredOffsetForStrategy] |= RequiredBitForStrategy;
                    }
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1endpoint_extra_config.json/properties/proxy/properties/static"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1endpoint_extra_config.json/properties/proxy/properties/static";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1endpoint_extra_config.json/properties/proxy/properties/static"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDataPresent, "data"u8, "required"u8);
                                context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyStrategyPresent, "strategy"u8, "required"u8);
                            }
                            ...
                            {
                                if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForData] & RequiredBitForData) == 0)
                                {
                                    context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyDataNotPresent, "data"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDataPresent, "data"u8, "required"u8);
                                ...
                                if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForStrategy] & RequiredBitForStrategy) == 0)
                                {
                                    context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyStrategyNotPresent, "strategy"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyStrategyPresent, "strategy"u8, "required"u8);
