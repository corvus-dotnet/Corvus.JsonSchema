    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271grpcJson
    {
        ...
        public readonly partial struct GrpcServer
        {
            ...
            public readonly partial struct OpenTelemetrySettings
            {
                ...
                public readonly partial struct DisableTrace
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(DisableTrace instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="DisableTrace"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator DisableTrace(Mutable instance)
                        {
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new DisableTrace(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"DisableTrace.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="DisableTrace"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="DisableTrace"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly DisableTrace Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<DisableTrace>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="DisableTrace"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly DisableTrace Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<DisableTrace>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(DisableTrace instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<DisableTrace, Mutable>(this);
                    }
                }
            }
        }
