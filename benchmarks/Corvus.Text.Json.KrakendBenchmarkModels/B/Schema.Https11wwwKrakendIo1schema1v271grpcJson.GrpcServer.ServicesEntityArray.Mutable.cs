        ...
        public readonly partial struct GrpcServer
        {
            ...
            public readonly partial struct ServicesEntityArray
            {
...
#endif
                {
                    ...
                    public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity.Mutable this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity.Mutable>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity.Mutable> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity.Mutable>(_parent, _idx);
                    }
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void SetItem(int itemIndex, in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void InsertItem(int itemIndex, in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void AddItem(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity.Source value)
                    {
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Remove(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity item)
                    {
                        CheckValidInstance();
                        if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity>(this, in item))
                        {
                            return false;
                        }
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void RemoveWhere(JsonPredicate<Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity> predicate)
                    {
                        CheckValidInstance();
                        JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity>(this, predicate);
                        _documentVersion = _parent.Version;
                    }
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Replace(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity oldItem, in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity.Source newItem)
                    {
                        CheckValidInstance();
                        ...
                        var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity>(_parent, _idx);

                        while (enumerator.MoveNext())
                        {
                            Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity current = enumerator.Current;
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
