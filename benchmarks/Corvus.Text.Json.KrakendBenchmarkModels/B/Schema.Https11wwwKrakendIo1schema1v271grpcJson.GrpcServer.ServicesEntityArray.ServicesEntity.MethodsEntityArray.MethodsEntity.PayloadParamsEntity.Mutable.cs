                        ...
                        public readonly partial struct MethodsEntity
                        {
                            ...
                            public readonly partial struct PayloadParamsEntity
                            {
...
#endif
                                {
                                    ...
                                    public static explicit operator Mutable(PayloadParamsEntity instance)
                                    {
                                    ...
                                    /// <returns>An immutable instance of a <see cref="PayloadParamsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static implicit operator PayloadParamsEntity(Mutable instance)
                                    {
                                    ...
                                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                    private string DebuggerDisplay => $"PayloadParamsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public readonly PayloadParamsEntity Clone()
                                    {
                                        CheckValidInstance();
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public readonly PayloadParamsEntity Freeze()
                                    {
                                        CheckValidInstance();
                                        return _parent.FreezeElement<PayloadParamsEntity>(_idx);
                                    }
                                }
                                ...
                                public ref struct Source
                                {
                                    ...
                                    internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.MethodsEntity.PayloadParamsEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                                    public static implicit operator Source(PayloadParamsEntity instance) => new(JsonElement.From(instance));
                                ...
                                {
                                    return workspace.CreateBuilder<PayloadParamsEntity, Mutable>(this);
                                }
                            }
                        }
                    }
