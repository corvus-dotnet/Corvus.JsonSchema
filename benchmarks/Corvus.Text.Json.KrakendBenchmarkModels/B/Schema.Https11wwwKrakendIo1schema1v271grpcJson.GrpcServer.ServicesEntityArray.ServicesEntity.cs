        ...
        public readonly partial struct GrpcServer
        {
            ...
            public readonly partial struct ServicesEntityArray
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray Methods
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MethodsUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray value))
                            {
                                return value;
                            }
