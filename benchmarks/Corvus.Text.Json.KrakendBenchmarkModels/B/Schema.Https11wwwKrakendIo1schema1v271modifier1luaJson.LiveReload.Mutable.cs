    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271modifier1luaJson
    {
        ...
        public readonly partial struct LiveReload
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(LiveReload instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="LiveReload"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LiveReload(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LiveReload.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly LiveReload Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly LiveReload Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<LiveReload>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(LiveReload instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<LiveReload, Mutable>(this);
            }
        }
    }
}
