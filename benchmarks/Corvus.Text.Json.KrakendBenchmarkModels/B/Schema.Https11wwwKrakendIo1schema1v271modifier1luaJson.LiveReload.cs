...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271modifier1luaJson
    {
        ...
        public readonly partial struct LiveReload
#if NET8_0_OR_GREATER
            : IJsonElement<LiveReload>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="LiveReload"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal LiveReload(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static LiveReload DefaultInstance { get; } = ParsedJsonDocument<LiveReload>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(LiveReload value)
            {
            ...
            /// </returns>
            public static bool operator ==(in LiveReload left, in LiveReload right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in LiveReload left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(LiveReload instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LiveReload(JsonElement instance)
            {
                return LiveReload.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LiveReload From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LiveReload ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LiveReload>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LiveReload ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LiveReload>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LiveReload ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LiveReload>(json, options);
            }
            ...
            /// </exception>
            public static LiveReload ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<LiveReload>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out LiveReload? result)
            {
                return JsonElementHelpers.TryParseValue<LiveReload>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new LiveReload(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static LiveReload IJsonElement<LiveReload>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LiveReload: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="LiveReload"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="LiveReload"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public LiveReload Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<LiveReload>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="LiveReload"/> that lives for the lifetime of its
