    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271modifier1luaJson
    {
        ...
        public readonly partial struct Md5Checksum
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Md5Checksum instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Md5Checksum"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Md5Checksum(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Md5Checksum.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly Md5Checksum Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly Md5Checksum Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Md5Checksum>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271modifier1luaJson.Md5Checksum.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(Md5Checksum instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271modifier1luaJson.Md5Checksum.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<Md5Checksum, Mutable>(this);
            }
        }
    }
}
