...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271modifier1luaJson
    {
        ...
        public readonly partial struct Md5Checksum
#if NET8_0_OR_GREATER
            : IJsonElement<Md5Checksum>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="Md5Checksum"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal Md5Checksum(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Md5Checksum DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in Md5Checksum left, in Md5Checksum right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Md5Checksum left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(Md5Checksum instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Md5Checksum(JsonElement instance)
            {
                return Md5Checksum.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Md5Checksum From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Md5Checksum ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Md5Checksum>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Md5Checksum ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Md5Checksum>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Md5Checksum ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Md5Checksum>(json, options);
            }
            ...
            /// </exception>
            public static Md5Checksum ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Md5Checksum>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Md5Checksum? result)
            {
                return JsonElementHelpers.TryParseValue<Md5Checksum>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Md5Checksum(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static Md5Checksum IJsonElement<Md5Checksum>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Md5Checksum: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Md5Checksum"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Md5Checksum"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<Md5Checksum>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Md5Checksum"/> that lives for the lifetime of its
