    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271modifier1luaJson
    {
        ...
        public readonly partial struct OpenExternalLibs
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(OpenExternalLibs instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OpenExternalLibs"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OpenExternalLibs(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OpenExternalLibs.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly OpenExternalLibs Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly OpenExternalLibs Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OpenExternalLibs>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(OpenExternalLibs instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<OpenExternalLibs, Mutable>(this);
            }
        }
    }
}
