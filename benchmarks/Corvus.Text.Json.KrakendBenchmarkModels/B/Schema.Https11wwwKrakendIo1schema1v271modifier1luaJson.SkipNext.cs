...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271modifier1luaJson
    {
        ...
        public readonly partial struct SkipNext
#if NET8_0_OR_GREATER
            : IJsonElement<SkipNext>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SkipNext"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SkipNext(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SkipNext DefaultInstance { get; } = ParsedJsonDocument<SkipNext>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(SkipNext value)
            {
            ...
            /// </returns>
            public static bool operator ==(in SkipNext left, in SkipNext right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SkipNext left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SkipNext instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SkipNext(JsonElement instance)
            {
                return SkipNext.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SkipNext From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SkipNext ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SkipNext>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SkipNext ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SkipNext>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SkipNext ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SkipNext>(json, options);
            }
            ...
            /// </exception>
            public static SkipNext ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SkipNext>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SkipNext? result)
            {
                return JsonElementHelpers.TryParseValue<SkipNext>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SkipNext(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static SkipNext IJsonElement<SkipNext>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SkipNext: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SkipNext"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SkipNext"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public SkipNext Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SkipNext>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SkipNext"/> that lives for the lifetime of its
