...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271modifier1luaJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="Sources"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal Sources(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Sources DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in Sources left, in Sources right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Sources left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(Sources instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Sources(JsonElement instance)
            {
                return Sources.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Sources From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Sources ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Sources>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Sources ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Sources>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Sources ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Sources>(json, options);
            }
            ...
            /// </exception>
            public static Sources ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Sources>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Sources? result)
            {
                return JsonElementHelpers.TryParseValue<Sources>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Sources(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static Sources IJsonElement<Sources>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Sources: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Sources"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Sources"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<Sources>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Sources"/> that lives for the lifetime of its
