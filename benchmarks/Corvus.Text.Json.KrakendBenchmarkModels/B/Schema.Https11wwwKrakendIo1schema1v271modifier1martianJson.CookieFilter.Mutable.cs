    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271modifier1martianJson
    {
        ...
        public readonly partial struct CookieFilter
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(CookieFilter instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CookieFilter"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CookieFilter(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271modifier1martianJson.CookieFilter.Scope.Mutable ScopeValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopeValueUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271modifier1martianJson.CookieFilter.Scope.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new CookieFilter(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetScopeValue(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271modifier1martianJson.CookieFilter.Scope.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetScopeValue<TContext>(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271modifier1martianJson.CookieFilter.Scope.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CookieFilter.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="CookieFilter"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="CookieFilter"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly CookieFilter Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<CookieFilter>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="CookieFilter"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly CookieFilter Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CookieFilter>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271modifier1martianJson.CookieFilter.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(CookieFilter instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271modifier1martianJson.CookieFilter.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="CookieFilter"/>.
                /// </summary>
                    ...
                    in Corvus.Text.Json.JsonElement.Source value = default)
                {
                    ...
                    builder.AddProperty(JsonPropertyNamesEscaped.ScopeValue, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271modifier1martianJson.CookieFilter.Scope.ConstInstance);
                ...
                public void Create(
                    ...
                    in Corvus.Text.Json.JsonElement.Source value = default)
                {
                    Create(ref _builder, modifier, name, elseValue, value);
                }
                ...
                #endif
                {
                    Create(context, ref _builder, modifier, name, elseValue, value);
                }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271modifier1martianJson.Source modifier, in Corvus.KrakendBenchmark.Baseline.JsonString.Source name, in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271modifier1martianJson.Source elseValue = default, in Corvus.Text.Json.JsonElement.Source value = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(modifier, name, elseValue, value);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271modifier1martianJson.Source<TContext> modifier, in Corvus.KrakendBenchmark.Baseline.JsonString.Source name, in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271modifier1martianJson.Source<TContext> elseValue = default, in Corvus.Text.Json.JsonElement.Source<TContext> value = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, modifier, name, elseValue, value);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<CookieFilter, Mutable>(this);
            }
        }
    }
}
