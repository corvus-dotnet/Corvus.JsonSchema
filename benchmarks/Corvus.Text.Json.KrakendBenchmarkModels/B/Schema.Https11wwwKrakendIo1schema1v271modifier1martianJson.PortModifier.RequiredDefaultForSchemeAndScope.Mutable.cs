        ...
        public readonly partial struct PortModifier
        {
            ...
            public readonly partial struct RequiredDefaultForSchemeAndScope
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RequiredDefaultForSchemeAndScope instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RequiredDefaultForSchemeAndScope"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredDefaultForSchemeAndScope(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Text.Json.JsonElement.Mutable DefaultForScheme
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DefaultForSchemeUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                            {
                                return value;
                            }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RequiredDefaultForSchemeAndScope(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    public void SetDefaultForScheme(in Corvus.Text.Json.JsonElement.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("defaultForScheme");
                        }
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetDefaultForScheme<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredDefaultForSchemeAndScope.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RequiredDefaultForSchemeAndScope"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RequiredDefaultForSchemeAndScope"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredDefaultForSchemeAndScope Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RequiredDefaultForSchemeAndScope>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RequiredDefaultForSchemeAndScope"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredDefaultForSchemeAndScope Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RequiredDefaultForSchemeAndScope>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271modifier1martianJson.PortModifier.RequiredDefaultForSchemeAndScope.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(RequiredDefaultForSchemeAndScope instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271modifier1martianJson.PortModifier.RequiredDefaultForSchemeAndScope.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.Text.Json.JsonElement.Source defaultForScheme,
                    ...
                    /// Creates an instance of a <see cref="RequiredDefaultForSchemeAndScope"/>.
                    /// </summary>
                    public void Create(in Corvus.Text.Json.JsonElement.Source defaultForScheme, in Corvus.Text.Json.JsonElement.Source scope)
                    {
                        Create(ref _builder, defaultForScheme, scope);
                    }
                    ...
                    internal static void Create<TContext>(
                        in TContext context,
                        ref ComplexValueBuilder builder,
                        in Corvus.Text.Json.JsonElement.Source<TContext> defaultForScheme,
                    ...
                    #endif
                    {
                        Create(context, ref _builder, defaultForScheme, scope);
                    }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source defaultForScheme, in Corvus.Text.Json.JsonElement.Source scope, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(defaultForScheme, scope);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> defaultForScheme, in Corvus.Text.Json.JsonElement.Source<TContext> scope, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    ...
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(context, defaultForScheme, scope);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<RequiredDefaultForSchemeAndScope, Mutable>(this);
                }
            }
        }
    }
