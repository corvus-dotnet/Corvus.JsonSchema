    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271modifier1martianJson
    {
        ...
        public readonly partial struct PortModifier
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="RequiredRemoveEntityAndScope"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal RequiredRemoveEntityAndScope(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static RequiredRemoveEntityAndScope DefaultInstance { get; }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.JsonElement RemoveValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RemoveValueUtf8, out Corvus.Text.Json.JsonElement value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.JsonElement Scope
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopeUtf8, out Corvus.Text.Json.JsonElement value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in RequiredRemoveEntityAndScope left, in RequiredRemoveEntityAndScope right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in RequiredRemoveEntityAndScope left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(RequiredRemoveEntityAndScope instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredRemoveEntityAndScope(JsonElement instance)
                {
                    return RequiredRemoveEntityAndScope.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredRemoveEntityAndScope From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredRemoveEntityAndScope ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredRemoveEntityAndScope>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredRemoveEntityAndScope ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredRemoveEntityAndScope>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredRemoveEntityAndScope ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredRemoveEntityAndScope>(json, options);
                }
                ...
                /// </exception>
                public static RequiredRemoveEntityAndScope ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<RequiredRemoveEntityAndScope>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredRemoveEntityAndScope? result)
                {
                    return JsonElementHelpers.TryParseValue<RequiredRemoveEntityAndScope>(ref reader, out result);
                }
...
#if NET
                static RequiredRemoveEntityAndScope IJsonElement<RequiredRemoveEntityAndScope>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredRemoveEntityAndScope: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public RequiredRemoveEntityAndScope Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public RequiredRemoveEntityAndScope Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<RequiredRemoveEntityAndScope>(_idx);
                    }
