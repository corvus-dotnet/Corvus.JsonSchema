            ...
            public readonly partial struct RequiredModifierAndPriorityArray
            {
                ...
                public readonly partial struct RequiredModifierAndPriority
                {
...
#endif
                    {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.KrakendBenchmark.Baseline.JsonInteger.Mutable Priority
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PriorityUtf8, out Corvus.KrakendBenchmark.Baseline.JsonInteger.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetPriority(in Corvus.KrakendBenchmark.Baseline.JsonInteger.Source value)
                        {
                            CheckValidInstance();
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271modifier1martianJson.PriorityGroup.RequiredModifierAndPriorityArray.RequiredModifierAndPriority.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271modifier1martianJson.PriorityGroup.RequiredModifierAndPriorityArray.RequiredModifierAndPriority.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        internal static void Create(
                            ...
                            in Corvus.KrakendBenchmark.Baseline.JsonInteger.Source priority)
                        {
                        ...
                        /// Creates an instance of a <see cref="RequiredModifierAndPriority"/>.
                        /// </summary>
                        public void Create(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271modifier1martianJson.Source modifier, in Corvus.KrakendBenchmark.Baseline.JsonInteger.Source priority)
                        {
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271modifier1martianJson.Source modifier, in Corvus.KrakendBenchmark.Baseline.JsonInteger.Source priority, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271modifier1martianJson.Source<TContext> modifier, in Corvus.KrakendBenchmark.Baseline.JsonInteger.Source priority, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
