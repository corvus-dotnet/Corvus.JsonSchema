    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271modifier1responseHeadersJson
    {
        ...
        public readonly partial struct HeadersToAdd
        {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271modifier1responseHeadersJson.HeadersToAdd.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271modifier1responseHeadersJson.HeadersToAdd.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
