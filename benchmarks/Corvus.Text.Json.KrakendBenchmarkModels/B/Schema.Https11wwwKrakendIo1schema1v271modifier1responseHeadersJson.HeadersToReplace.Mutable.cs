    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271modifier1responseHeadersJson
    {
        ...
        public readonly partial struct HeadersToReplace
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(HeadersToReplace instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="HeadersToReplace"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator HeadersToReplace(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new HeadersToReplace(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"HeadersToReplace.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="HeadersToReplace"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="HeadersToReplace"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly HeadersToReplace Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<HeadersToReplace>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="HeadersToReplace"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly HeadersToReplace Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<HeadersToReplace>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271modifier1responseHeadersJson.HeadersToReplace.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(HeadersToReplace instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271modifier1responseHeadersJson.HeadersToReplace.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<HeadersToReplace, Mutable>(this);
            }
        }
    }
}
