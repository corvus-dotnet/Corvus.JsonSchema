        ...
        public readonly partial struct RequiredFindAndReplace
        {
            ...
            public readonly partial struct IsARegexp
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(IsARegexp instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="IsARegexp"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator IsARegexp(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"IsARegexp.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IsARegexp Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IsARegexp Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<IsARegexp>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(IsARegexp instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<IsARegexp, Mutable>(this);
                }
            }
        }
    }
