...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1httpServerJson
    {
        ...
        public readonly partial struct PluginName
#if NET8_0_OR_GREATER
            : IJsonElement<PluginName>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="PluginName"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal PluginName(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static PluginName DefaultInstance { get; } = PluginName.ParseValue("[]"u8);
            ...
            /// </returns>
            public static bool operator ==(in PluginName left, in PluginName right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in PluginName left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(PluginName instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PluginName(JsonElement instance)
            {
                return PluginName.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PluginName From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PluginName ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PluginName>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PluginName ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PluginName>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PluginName ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PluginName>(json, options);
            }
            ...
            /// </exception>
            public static PluginName ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<PluginName>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out PluginName? result)
            {
                return JsonElementHelpers.TryParseValue<PluginName>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PluginName(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static PluginName IJsonElement<PluginName>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PluginName: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="PluginName"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="PluginName"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public PluginName Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<PluginName>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="PluginName"/> that lives for the lifetime of its
