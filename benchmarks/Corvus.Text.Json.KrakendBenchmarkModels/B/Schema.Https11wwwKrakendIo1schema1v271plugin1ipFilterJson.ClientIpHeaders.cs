...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1ipFilterJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ClientIpHeaders"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ClientIpHeaders(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ClientIpHeaders DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in ClientIpHeaders left, in ClientIpHeaders right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ClientIpHeaders left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(ClientIpHeaders instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ClientIpHeaders(JsonElement instance)
            {
                return ClientIpHeaders.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClientIpHeaders From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClientIpHeaders ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClientIpHeaders>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClientIpHeaders ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClientIpHeaders>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClientIpHeaders ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClientIpHeaders>(json, options);
            }
            ...
            /// </exception>
            public static ClientIpHeaders ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ClientIpHeaders>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ClientIpHeaders? result)
            {
                return JsonElementHelpers.TryParseValue<ClientIpHeaders>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ClientIpHeaders(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ClientIpHeaders IJsonElement<ClientIpHeaders>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ClientIpHeaders: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ClientIpHeaders"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ClientIpHeaders"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ClientIpHeaders Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ClientIpHeaders>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ClientIpHeaders"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ClientIpHeaders Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ClientIpHeaders>(_idx);
                }
