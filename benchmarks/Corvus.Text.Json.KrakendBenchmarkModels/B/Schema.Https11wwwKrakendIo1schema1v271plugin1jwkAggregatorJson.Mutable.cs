...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Baseline.JsonBoolean.Mutable Cache
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CacheUtf8, out Corvus.KrakendBenchmark.Baseline.JsonBoolean.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson.Origins.Mutable OriginsValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OriginsValueUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson.Origins.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetCache(in Corvus.KrakendBenchmark.Baseline.JsonBoolean.Source value)
            {
                CheckValidInstance();
            ...
            /// <summary>
            /// Set the <c>origins</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetOriginsValue(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson.Origins.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("origins");
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OriginsValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.OriginsValue, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetOriginsValue<TContext>(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson.Origins.Source<TContext> value)
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson.Origins.Source origins,
                in Corvus.KrakendBenchmark.Baseline.JsonInteger.Source port,
                in Corvus.KrakendBenchmark.Baseline.JsonBoolean.Source cache = default)
            {
                origins.AddAsProperty(JsonPropertyNamesEscaped.OriginsValue, ref builder, escapeName: false);
            ...
            public void Create(
                ...
                in Corvus.KrakendBenchmark.Baseline.JsonBoolean.Source cache = default)
            {
                Create(ref _builder, origins, port, cache);
            }
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson.Origins.Source<TContext> origins,
                in Corvus.KrakendBenchmark.Baseline.JsonInteger.Source port,
                in Corvus.KrakendBenchmark.Baseline.JsonBoolean.Source cache = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            ...
            #endif
            {
                Create(context, ref _builder, origins, port, cache);
            }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="origins">The value of the property.</param>
        /// <param name="port">The value of the property.</param>
        /// <param name="cache">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson.Origins.Source origins, in Corvus.KrakendBenchmark.Baseline.JsonInteger.Source port, in Corvus.KrakendBenchmark.Baseline.JsonBoolean.Source cache = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(origins, port, cache);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson.Origins.Source<TContext> origins, in Corvus.KrakendBenchmark.Baseline.JsonInteger.Source port, in Corvus.KrakendBenchmark.Baseline.JsonBoolean.Source cache = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, origins, port, cache);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson, Mutable>(this);
        }
    }
}
