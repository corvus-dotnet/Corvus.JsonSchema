    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson
    {
        ...
        public readonly partial struct ErrorDefinition
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson.ErrorDefinition.ErrorBody.Mutable Body
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BodyUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson.ErrorDefinition.ErrorBody.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson.ErrorDefinition.ErrorCode.Mutable Status
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson.ErrorDefinition.ErrorCode.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetBody(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson.ErrorDefinition.ErrorBody.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetStatus(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson.ErrorDefinition.ErrorCode.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson.ErrorDefinition.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson.ErrorDefinition.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson.ErrorDefinition.ErrorBody.Source body = default,
                    in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson.ErrorDefinition.ErrorCode.Source status = default)
                {
