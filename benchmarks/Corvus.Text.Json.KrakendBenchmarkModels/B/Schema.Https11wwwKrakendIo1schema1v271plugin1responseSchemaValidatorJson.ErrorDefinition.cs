...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson
    {
        ...
        public readonly partial struct ErrorDefinition
#if NET8_0_OR_GREATER
            : IJsonElement<ErrorDefinition>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ErrorDefinition"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ErrorDefinition(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ErrorDefinition DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson.ErrorDefinition.ErrorBody Body
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BodyUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson.ErrorDefinition.ErrorBody value))
                    {
                        return value;
                    }

                    return Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson.ErrorDefinition.ErrorBody.DefaultInstance;
                }
            }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson.ErrorDefinition.ErrorCode Status
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson.ErrorDefinition.ErrorCode value))
                    {
                        return value;
                    }

                    return Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson.ErrorDefinition.ErrorCode.DefaultInstance;
                }
            }
            ...
            /// </returns>
            public static bool operator ==(in ErrorDefinition left, in ErrorDefinition right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ErrorDefinition left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(ErrorDefinition instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ErrorDefinition(JsonElement instance)
            {
                return ErrorDefinition.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ErrorDefinition From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ErrorDefinition ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ErrorDefinition>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ErrorDefinition ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ErrorDefinition>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ErrorDefinition ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ErrorDefinition>(json, options);
            }
            ...
            /// </exception>
            public static ErrorDefinition ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ErrorDefinition>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ErrorDefinition? result)
            {
                return JsonElementHelpers.TryParseValue<ErrorDefinition>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ErrorDefinition(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ErrorDefinition IJsonElement<ErrorDefinition>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ErrorDefinition: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ErrorDefinition"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ErrorDefinition"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<ErrorDefinition>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ErrorDefinition"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ErrorDefinition Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ErrorDefinition>(_idx);
                }
