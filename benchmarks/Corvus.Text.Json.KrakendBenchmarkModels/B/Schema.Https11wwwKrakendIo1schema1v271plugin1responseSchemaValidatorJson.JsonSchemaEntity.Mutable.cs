    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson
    {
        ...
        public readonly partial struct JsonSchemaEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(JsonSchemaEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="JsonSchemaEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonSchemaEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"JsonSchemaEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly JsonSchemaEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly JsonSchemaEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<JsonSchemaEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson.JsonSchemaEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(JsonSchemaEntity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson.JsonSchemaEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<JsonSchemaEntity, Mutable>(this);
            }
        }
    }
}
