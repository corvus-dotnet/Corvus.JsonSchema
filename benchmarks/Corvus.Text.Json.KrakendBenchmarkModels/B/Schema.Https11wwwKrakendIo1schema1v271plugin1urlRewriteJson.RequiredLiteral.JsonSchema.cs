...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1urlRewriteJson
    {
        ...
        public readonly partial struct RequiredLiteral
            : IJsonElement<RequiredLiteral>
        {
            public static partial class JsonSchema
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyLiteralPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("literal"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyLiteralNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("literal"u8, buffer, out written);

                private const int RequiredOffsetForLiteral = 0;
                private const uint RequiredBitForLiteral = 0b00000000000000000000000000000001;

                private const uint RequiredBitMask0 =
                    RequiredBitForLiteral;

                private static void MatchLiteral(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    requiredBitBuffer[RequiredOffsetForLiteral] |= RequiredBitForLiteral;
                }
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.LiteralUtf8))
                    {
                        matcher = MatchLiteral;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1plugin~1url-rewrite.json/anyOf/0"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1plugin~1url-rewrite.json/anyOf/0";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1plugin~1url-rewrite.json/anyOf/0"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.StartObject)
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyLiteralPresent, "literal"u8, "required"u8);
                        }
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForLiteral] & RequiredBitForLiteral) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyLiteralNotPresent, "literal"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyLiteralPresent, "literal"u8, "required"u8);
