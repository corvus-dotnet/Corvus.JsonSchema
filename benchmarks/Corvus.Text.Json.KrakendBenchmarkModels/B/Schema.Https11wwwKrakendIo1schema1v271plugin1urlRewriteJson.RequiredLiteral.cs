...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1urlRewriteJson
    {
...
#endif
        {
            ...
            internal RequiredLiteral(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.JsonElement Literal
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LiteralUtf8, out Corvus.Text.Json.JsonElement value))
                    {
                        return value;
                    }
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RequiredLiteral left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RequiredLiteral instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredLiteral(JsonElement instance)
            {
                return RequiredLiteral.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredLiteral From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredLiteral ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredLiteral>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredLiteral ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredLiteral>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredLiteral ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredLiteral>(json, options);
            }
            ...
            /// </exception>
            public static RequiredLiteral ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RequiredLiteral>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredLiteral? result)
            {
                return JsonElementHelpers.TryParseValue<RequiredLiteral>(ref reader, out result);
            }
...
#if NET
            static RequiredLiteral IJsonElement<RequiredLiteral>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredLiteral: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public RequiredLiteral Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RequiredLiteral>(_idx);
                }
