...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1urlRewriteJson
    {
            ...
            : IJsonElement<RequiredRegexp>
        {
            ...
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyRegexpPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("regexp"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyRegexpNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("regexp"u8, buffer, out written);

                private const int RequiredOffsetForRegexp = 0;
                private const uint RequiredBitForRegexp = 0b00000000000000000000000000000001;

                private const uint RequiredBitMask0 =
                    RequiredBitForRegexp;

                private static void MatchRegexp(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    requiredBitBuffer[RequiredOffsetForRegexp] |= RequiredBitForRegexp;
                }
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.RegexpUtf8))
                    {
                        matcher = MatchRegexp;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1plugin~1url-rewrite.json/anyOf/1"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1plugin~1url-rewrite.json/anyOf/1";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1plugin~1url-rewrite.json/anyOf/1"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.StartObject)
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyRegexpPresent, "regexp"u8, "required"u8);
                        }
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForRegexp] & RequiredBitForRegexp) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyRegexpNotPresent, "regexp"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyRegexpPresent, "regexp"u8, "required"u8);
