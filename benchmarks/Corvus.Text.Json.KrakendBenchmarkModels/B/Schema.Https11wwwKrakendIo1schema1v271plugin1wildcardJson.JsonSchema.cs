...
public readonly partial struct Schema
{
        ...
        : IJsonElement<Https11wwwKrakendIo1schema1v271plugin1wildcardJson>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyEndpointsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("endpoints"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyEndpointsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("endpoints"u8, buffer, out written);

            private const int RequiredOffsetForEndpoints = 0;
            private const uint RequiredBitForEndpoints = 0b00000000000000000000000000000001;

            private const uint RequiredBitMask0 =
                RequiredBitForEndpoints;
            private static readonly JsonSchemaPathProvider EndpointsValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/endpoints"u8, buffer, out written);

            private static void MatchEndpointsValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1wildcardJson.Endpoints.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.EndpointsValueUtf8,
                        evaluationPath: EndpointsValueSchemaEvaluationPath);

                Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1wildcardJson.Endpoints.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                requiredBitBuffer[RequiredOffsetForEndpoints] |= RequiredBitForEndpoints;
            }
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.EndpointsValueUtf8))
                {
                    matcher = MatchEndpointsValue;
                    return true;
                }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1plugin~1wildcard.json"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1plugin~1wildcard.json";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1plugin~1wildcard.json"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyEndpointsPresent, "endpoints"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForEndpoints] & RequiredBitForEndpoints) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyEndpointsNotPresent, "endpoints"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyEndpointsPresent, "endpoints"u8, "required"u8);
