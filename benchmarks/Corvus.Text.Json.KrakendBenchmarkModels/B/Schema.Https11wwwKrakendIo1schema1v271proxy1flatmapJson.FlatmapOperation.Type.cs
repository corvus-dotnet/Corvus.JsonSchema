    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271proxy1flatmapJson
    {
        ...
        public readonly partial struct FlatmapOperation
        {
...
#endif
            {
                ...
                internal Type(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(Type value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in Type left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(Type instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Type(JsonElement instance)
                {
                    return Type.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Type From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Type ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Type>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Type ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Type>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Type ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Type>(json, options);
                }
                ...
                /// </exception>
                public static Type ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<Type>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out Type? result)
                {
                    return JsonElementHelpers.TryParseValue<Type>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Type(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static Type IJsonElement<Type>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Type: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Type"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Type"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Type>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Type"/> that lives for the lifetime of its
                ...
                public Type Freeze()
                {
                    ...
                    {
                        return mutable.FreezeElement<Type>(_idx);
                    }
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchMove,
                    Func<TContext, TResult> matchDel,
                    Func<TContext, TResult> matchAppend,
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchMove,
                    Func<TResult> matchDel,
                    Func<TResult> matchAppend,
