...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271proxy1flatmapJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="FlatmapOperation"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal FlatmapOperation(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static FlatmapOperation DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271proxy1flatmapJson.FlatmapOperation.Args ArgsValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ArgsValueUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271proxy1flatmapJson.FlatmapOperation.Args value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271proxy1flatmapJson.FlatmapOperation.Type TypeValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeValueUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271proxy1flatmapJson.FlatmapOperation.Type value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in FlatmapOperation left, in FlatmapOperation right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in FlatmapOperation left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(FlatmapOperation instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator FlatmapOperation(JsonElement instance)
            {
                return FlatmapOperation.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FlatmapOperation From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FlatmapOperation ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FlatmapOperation>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FlatmapOperation ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FlatmapOperation>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FlatmapOperation ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FlatmapOperation>(json, options);
            }
            ...
            /// </exception>
            public static FlatmapOperation ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<FlatmapOperation>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out FlatmapOperation? result)
            {
                return JsonElementHelpers.TryParseValue<FlatmapOperation>(ref reader, out result);
            }
...
#if NET
            static FlatmapOperation IJsonElement<FlatmapOperation>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"FlatmapOperation: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public FlatmapOperation Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<FlatmapOperation>(_idx);
                }
            ...
            public static class JsonPropertyNames
            {
                ...
                /// Gets the JSON property name for <see cref="TypeValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> TypeValueUtf8 => "type"u8;
            }
