...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271proxyJson
    {
        ...
        public readonly partial struct DecompressGzip
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DecompressGzip instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DecompressGzip"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DecompressGzip(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new DecompressGzip(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DecompressGzip.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="DecompressGzip"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="DecompressGzip"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly DecompressGzip Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<DecompressGzip>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="DecompressGzip"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly DecompressGzip Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DecompressGzip>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DecompressGzip instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DecompressGzip, Mutable>(this);
            }
        }
    }
}
