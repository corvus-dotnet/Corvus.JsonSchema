...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271proxyJson
    {
        ...
        public readonly partial struct TrafficShadowingOrMirroring
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TrafficShadowingOrMirroring instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TrafficShadowingOrMirroring"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TrafficShadowingOrMirroring(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TrafficShadowingOrMirroring(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TrafficShadowingOrMirroring.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TrafficShadowingOrMirroring"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TrafficShadowingOrMirroring"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly TrafficShadowingOrMirroring Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TrafficShadowingOrMirroring>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TrafficShadowingOrMirroring"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly TrafficShadowingOrMirroring Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TrafficShadowingOrMirroring>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TrafficShadowingOrMirroring instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TrafficShadowingOrMirroring, Mutable>(this);
            }
        }
    }
}
