...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Baseline.JsonInteger.Mutable Interval
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IntervalUtf8, out Corvus.KrakendBenchmark.Baseline.JsonInteger.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson.LogStatusChange.Mutable LogStatusChangeValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LogStatusChangeValueUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson.LogStatusChange.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Baseline.JsonInteger.Mutable MaxErrors
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxErrorsUtf8, out Corvus.KrakendBenchmark.Baseline.JsonInteger.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Baseline.JsonInteger.Mutable Timeout
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TimeoutUtf8, out Corvus.KrakendBenchmark.Baseline.JsonInteger.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            /// <summary>
            /// Set the <c>interval</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetInterval(in Corvus.KrakendBenchmark.Baseline.JsonInteger.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("interval");
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IntervalUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsProperty(JsonPropertyNamesEscaped.Interval, ref cvb, escapeName: false, nameRequiresUnescaping: false);
            ...
            /// <summary>
            /// Set the <c>log_status_change</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetLogStatusChangeValue(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson.LogStatusChange.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.LogStatusChangeValueUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LogStatusChangeValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.LogStatusChangeValue, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>log_status_change</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveLogStatusChangeValue()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.LogStatusChangeValueUtf8);
                _documentVersion = _parent.Version;
                return result;
            }

            /// <summary>
            /// Set the <c>max_errors</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetMaxErrors(in Corvus.KrakendBenchmark.Baseline.JsonInteger.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("max_errors");
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxErrorsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.MaxErrors, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetTimeout(in Corvus.KrakendBenchmark.Baseline.JsonInteger.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("timeout");
                }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.KrakendBenchmark.Baseline.JsonInteger.Source interval,
                in Corvus.KrakendBenchmark.Baseline.JsonInteger.Source maxErrors,
                in Corvus.KrakendBenchmark.Baseline.JsonInteger.Source timeout,
                in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson.LogStatusChange.Source logStatusChange = default,
                in Corvus.KrakendBenchmark.Baseline.JsonString.Source name = default)
            {
                interval.AddAsProperty(JsonPropertyNamesEscaped.Interval, ref builder, escapeName: false);
                maxErrors.AddAsProperty(JsonPropertyNamesEscaped.MaxErrors, ref builder, escapeName: false);
                timeout.AddAsProperty(JsonPropertyNamesEscaped.Timeout, ref builder, escapeName: false);
                logStatusChange.AddAsProperty(JsonPropertyNamesEscaped.LogStatusChangeValue, ref builder, escapeName: false);
            ...
            public void Create(
                ...
                in Corvus.KrakendBenchmark.Baseline.JsonString.Source name = default)
            {
                Create(ref _builder, interval, maxErrors, timeout, logStatusChange, name);
            }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="interval">The value of the property.</param>
        /// <param name="maxErrors">The value of the property.</param>
        /// <param name="timeout">The value of the property.</param>
        /// <param name="logStatusChange">The value of the property.</param>
        /// <param name="name">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Baseline.JsonInteger.Source interval, in Corvus.KrakendBenchmark.Baseline.JsonInteger.Source maxErrors, in Corvus.KrakendBenchmark.Baseline.JsonInteger.Source timeout, in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson.LogStatusChange.Source logStatusChange = default, in Corvus.KrakendBenchmark.Baseline.JsonString.Source name = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(interval, maxErrors, timeout, logStatusChange, name);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson, Mutable>(this);
        }
    }
}
