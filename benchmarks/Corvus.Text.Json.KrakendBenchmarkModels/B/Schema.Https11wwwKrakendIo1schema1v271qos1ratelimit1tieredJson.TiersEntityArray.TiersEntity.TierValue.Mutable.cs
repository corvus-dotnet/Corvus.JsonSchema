    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson
    {
        ...
        public readonly partial struct TiersEntityArray
        {
            ...
            public readonly partial struct TiersEntity
            {
                ...
                public readonly partial struct TierValue
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(TierValue instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="TierValue"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator TierValue(Mutable instance)
                        {
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new TierValue(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"TierValue.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="TierValue"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="TierValue"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly TierValue Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<TierValue>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="TierValue"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly TierValue Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<TierValue>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(TierValue instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<TierValue, Mutable>(this);
                    }
                }
            }
        }
