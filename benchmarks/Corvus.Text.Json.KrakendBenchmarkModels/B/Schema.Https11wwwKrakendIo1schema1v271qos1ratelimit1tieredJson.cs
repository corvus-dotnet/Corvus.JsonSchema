...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson
        ...
        : IJsonElement<Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Baseline.JsonString TierKey
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TierKeyUtf8, out Corvus.KrakendBenchmark.Baseline.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson.TiersEntityArray Tiers
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TiersUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson.TiersEntityArray value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson left, in Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson(JsonElement instance)
        {
            return Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson>(json, options);
        }
        ...
        /// </exception>
        public static Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson? result)
        {
            return JsonElementHelpers.TryParseValue<Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson IJsonElement<Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="TierKey"/>.
            /// </summary>
            public const string TierKey = "tier_key";

            /// <summary>
            /// Gets the JSON property name for <see cref="Tiers"/>.
            /// </summary>
            ...
            /// Gets the JSON property name for <see cref="TierKey"/>.
            /// </summary>
            public static ReadOnlySpan<byte> TierKeyUtf8 => "tier_key"u8;

            /// <summary>
            /// Gets the JSON property name for <see cref="Tiers"/>.
            /// </summary>
            public static ReadOnlySpan<byte> TiersUtf8 => "tiers"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="TierKey"/>.
            /// </summary>
            public static ReadOnlySpan<byte> TierKey => "tier_key"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Tiers"/>.
            /// </summary>
