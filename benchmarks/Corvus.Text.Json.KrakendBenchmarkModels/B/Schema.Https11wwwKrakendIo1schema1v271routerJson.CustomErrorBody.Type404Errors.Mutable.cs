        ...
        public readonly partial struct CustomErrorBody
        {
            ...
            public readonly partial struct Type404Errors
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(Type404Errors instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="Type404Errors"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Type404Errors(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"Type404Errors.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly Type404Errors Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly Type404Errors Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<Type404Errors>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271routerJson.CustomErrorBody.Type404Errors.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(Type404Errors instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271routerJson.CustomErrorBody.Type404Errors.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<Type404Errors, Mutable>(this);
                }
            }
        }
    }
