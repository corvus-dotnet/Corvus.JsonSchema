...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271routerJson
    {
        ...
        public readonly partial struct CustomErrorBody
        {
            ...
            public readonly partial struct Type404Errors
#if NET8_0_OR_GREATER
                : IJsonElement<Type404Errors>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="Type404Errors"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal Type404Errors(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static Type404Errors DefaultInstance { get; }
                ...
                /// </returns>
                public static bool operator ==(in Type404Errors left, in Type404Errors right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in Type404Errors left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(Type404Errors instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Type404Errors(JsonElement instance)
                {
                    return Type404Errors.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Type404Errors From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Type404Errors ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Type404Errors>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Type404Errors ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Type404Errors>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Type404Errors ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Type404Errors>(json, options);
                }
                ...
                /// </exception>
                public static Type404Errors ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<Type404Errors>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out Type404Errors? result)
                {
                    return JsonElementHelpers.TryParseValue<Type404Errors>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Type404Errors(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static Type404Errors IJsonElement<Type404Errors>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Type404Errors: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Type404Errors"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Type404Errors"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Type404Errors Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Type404Errors>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Type404Errors"/> that lives for the lifetime of its
