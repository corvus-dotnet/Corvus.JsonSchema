...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271routerJson
    {
        ...
        public readonly partial struct EnableH2c
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(EnableH2c instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EnableH2c"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EnableH2c(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new EnableH2c(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EnableH2c.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="EnableH2c"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="EnableH2c"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly EnableH2c Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<EnableH2c>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="EnableH2c"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly EnableH2c Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EnableH2c>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(EnableH2c instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<EnableH2c, Mutable>(this);
            }
        }
    }
}
