...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271routerJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ForwardedByClientIp"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ForwardedByClientIp(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ForwardedByClientIp DefaultInstance { get; } = ParsedJsonDocument<ForwardedByClientIp>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(ForwardedByClientIp value)
            {
            ...
            /// </returns>
            public static bool operator ==(in ForwardedByClientIp left, in ForwardedByClientIp right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ForwardedByClientIp left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ForwardedByClientIp instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ForwardedByClientIp(JsonElement instance)
            {
                return ForwardedByClientIp.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ForwardedByClientIp From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ForwardedByClientIp ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ForwardedByClientIp>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ForwardedByClientIp ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ForwardedByClientIp>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ForwardedByClientIp ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ForwardedByClientIp>(json, options);
            }
            ...
            /// </exception>
            public static ForwardedByClientIp ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ForwardedByClientIp>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ForwardedByClientIp? result)
            {
                return JsonElementHelpers.TryParseValue<ForwardedByClientIp>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ForwardedByClientIp(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ForwardedByClientIp IJsonElement<ForwardedByClientIp>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ForwardedByClientIp: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ForwardedByClientIp"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ForwardedByClientIp"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ForwardedByClientIp Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ForwardedByClientIp>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ForwardedByClientIp"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ForwardedByClientIp Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ForwardedByClientIp>(_idx);
                }
