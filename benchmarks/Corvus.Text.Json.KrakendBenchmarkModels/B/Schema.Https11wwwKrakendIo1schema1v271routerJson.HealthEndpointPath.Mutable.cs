    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271routerJson
    {
        ...
        public readonly partial struct HealthEndpointPath
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(HealthEndpointPath instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="HealthEndpointPath"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator HealthEndpointPath(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"HealthEndpointPath.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly HealthEndpointPath Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly HealthEndpointPath Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<HealthEndpointPath>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(HealthEndpointPath instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<HealthEndpointPath, Mutable>(this);
            }
        }
    }
}
