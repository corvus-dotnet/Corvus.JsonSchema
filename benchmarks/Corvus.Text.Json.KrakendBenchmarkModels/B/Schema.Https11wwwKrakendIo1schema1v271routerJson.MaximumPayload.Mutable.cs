    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271routerJson
    {
        ...
        public readonly partial struct MaximumPayload
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(MaximumPayload instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MaximumPayload"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MaximumPayload(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MaximumPayload.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MaximumPayload Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MaximumPayload Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MaximumPayload>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MaximumPayload instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MaximumPayload, Mutable>(this);
            }
        }
    }
}
