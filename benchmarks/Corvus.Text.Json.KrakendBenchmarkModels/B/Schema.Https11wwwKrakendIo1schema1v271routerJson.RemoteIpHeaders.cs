...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271routerJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RemoteIpHeaders"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RemoteIpHeaders(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RemoteIpHeaders DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in RemoteIpHeaders left, in RemoteIpHeaders right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RemoteIpHeaders left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RemoteIpHeaders instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RemoteIpHeaders(JsonElement instance)
            {
                return RemoteIpHeaders.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RemoteIpHeaders From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RemoteIpHeaders ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RemoteIpHeaders>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RemoteIpHeaders ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RemoteIpHeaders>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RemoteIpHeaders ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RemoteIpHeaders>(json, options);
            }
            ...
            /// </exception>
            public static RemoteIpHeaders ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RemoteIpHeaders>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RemoteIpHeaders? result)
            {
                return JsonElementHelpers.TryParseValue<RemoteIpHeaders>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RemoteIpHeaders(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RemoteIpHeaders IJsonElement<RemoteIpHeaders>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RemoteIpHeaders: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RemoteIpHeaders"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RemoteIpHeaders"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RemoteIpHeaders Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RemoteIpHeaders>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RemoteIpHeaders"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RemoteIpHeaders Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RemoteIpHeaders>(_idx);
                }
