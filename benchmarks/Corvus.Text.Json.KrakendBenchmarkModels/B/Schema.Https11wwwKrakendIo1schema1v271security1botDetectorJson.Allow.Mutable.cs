...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1botDetectorJson
    {
        ...
        public readonly partial struct Allow
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Allow instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Allow"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Allow(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Allow(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Allow.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// <summary>
                /// Gets a <see cref="Allow"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Allow"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly Allow Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Allow>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Allow"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly Allow Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Allow>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271security1botDetectorJson.Allow.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(Allow instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271security1botDetectorJson.Allow.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<Allow, Mutable>(this);
            }
        }
    }
}
