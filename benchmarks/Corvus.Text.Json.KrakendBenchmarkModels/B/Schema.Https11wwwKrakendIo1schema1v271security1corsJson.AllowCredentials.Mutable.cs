    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1corsJson
    {
        ...
        public readonly partial struct AllowCredentials
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AllowCredentials instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AllowCredentials"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AllowCredentials(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AllowCredentials.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AllowCredentials Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AllowCredentials Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AllowCredentials>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AllowCredentials instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AllowCredentials, Mutable>(this);
            }
        }
    }
}
