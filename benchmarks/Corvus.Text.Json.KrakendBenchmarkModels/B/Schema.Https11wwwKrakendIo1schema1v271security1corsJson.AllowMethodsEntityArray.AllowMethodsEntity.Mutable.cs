        ...
        public readonly partial struct AllowMethodsEntityArray
        {
            ...
            public readonly partial struct AllowMethodsEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(AllowMethodsEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="AllowMethodsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AllowMethodsEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new AllowMethodsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AllowMethodsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="AllowMethodsEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="AllowMethodsEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AllowMethodsEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<AllowMethodsEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="AllowMethodsEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AllowMethodsEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<AllowMethodsEntity>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(AllowMethodsEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<AllowMethodsEntity, Mutable>(this);
                }
            }
        }
    }
