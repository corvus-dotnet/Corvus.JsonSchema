...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1corsJson
    {
        ...
        public readonly partial struct AllowPrivateNetwork
#if NET8_0_OR_GREATER
            : IJsonElement<AllowPrivateNetwork>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AllowPrivateNetwork"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal AllowPrivateNetwork(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AllowPrivateNetwork DefaultInstance { get; } = ParsedJsonDocument<AllowPrivateNetwork>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(AllowPrivateNetwork value)
            {
            ...
            /// </returns>
            public static bool operator ==(in AllowPrivateNetwork left, in AllowPrivateNetwork right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AllowPrivateNetwork left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(AllowPrivateNetwork instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AllowPrivateNetwork(JsonElement instance)
            {
                return AllowPrivateNetwork.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllowPrivateNetwork From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllowPrivateNetwork ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllowPrivateNetwork>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllowPrivateNetwork ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllowPrivateNetwork>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllowPrivateNetwork ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllowPrivateNetwork>(json, options);
            }
            ...
            /// </exception>
            public static AllowPrivateNetwork ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<AllowPrivateNetwork>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AllowPrivateNetwork? result)
            {
                return JsonElementHelpers.TryParseValue<AllowPrivateNetwork>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new AllowPrivateNetwork(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static AllowPrivateNetwork IJsonElement<AllowPrivateNetwork>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AllowPrivateNetwork: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="AllowPrivateNetwork"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="AllowPrivateNetwork"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public AllowPrivateNetwork Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<AllowPrivateNetwork>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="AllowPrivateNetwork"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public AllowPrivateNetwork Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<AllowPrivateNetwork>(_idx);
                }
