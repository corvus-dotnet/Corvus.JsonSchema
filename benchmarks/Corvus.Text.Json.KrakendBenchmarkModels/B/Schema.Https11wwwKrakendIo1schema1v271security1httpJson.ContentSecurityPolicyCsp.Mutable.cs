    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1httpJson
    {
        ...
        public readonly partial struct ContentSecurityPolicyCsp
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ContentSecurityPolicyCsp instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ContentSecurityPolicyCsp"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ContentSecurityPolicyCsp(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ContentSecurityPolicyCsp(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ContentSecurityPolicyCsp.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ContentSecurityPolicyCsp"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ContentSecurityPolicyCsp"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ContentSecurityPolicyCsp Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ContentSecurityPolicyCsp>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ContentSecurityPolicyCsp"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ContentSecurityPolicyCsp Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ContentSecurityPolicyCsp>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ContentSecurityPolicyCsp instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ContentSecurityPolicyCsp, Mutable>(this);
            }
        }
    }
}
