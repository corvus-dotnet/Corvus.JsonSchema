...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1httpJson
    {
        ...
        public readonly partial struct ForceStsHeader
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ForceStsHeader instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ForceStsHeader"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ForceStsHeader(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ForceStsHeader(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ForceStsHeader.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ForceStsHeader"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ForceStsHeader"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ForceStsHeader Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ForceStsHeader>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ForceStsHeader"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ForceStsHeader Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ForceStsHeader>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ForceStsHeader instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ForceStsHeader, Mutable>(this);
            }
        }
    }
}
