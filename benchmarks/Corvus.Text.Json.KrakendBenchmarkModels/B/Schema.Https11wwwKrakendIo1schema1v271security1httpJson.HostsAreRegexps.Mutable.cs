    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1httpJson
    {
        ...
        public readonly partial struct HostsAreRegexps
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(HostsAreRegexps instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="HostsAreRegexps"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator HostsAreRegexps(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"HostsAreRegexps.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly HostsAreRegexps Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly HostsAreRegexps Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<HostsAreRegexps>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(HostsAreRegexps instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<HostsAreRegexps, Mutable>(this);
            }
        }
    }
}
