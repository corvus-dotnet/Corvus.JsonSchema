...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1httpJson
    {
        ...
        public readonly partial struct HostsAreRegexps
#if NET8_0_OR_GREATER
            : IJsonElement<HostsAreRegexps>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="HostsAreRegexps"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal HostsAreRegexps(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static HostsAreRegexps DefaultInstance { get; } = ParsedJsonDocument<HostsAreRegexps>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(HostsAreRegexps value)
            {
            ...
            /// </returns>
            public static bool operator ==(in HostsAreRegexps left, in HostsAreRegexps right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in HostsAreRegexps left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(HostsAreRegexps instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator HostsAreRegexps(JsonElement instance)
            {
                return HostsAreRegexps.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HostsAreRegexps From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HostsAreRegexps ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HostsAreRegexps>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HostsAreRegexps ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HostsAreRegexps>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HostsAreRegexps ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HostsAreRegexps>(json, options);
            }
            ...
            /// </exception>
            public static HostsAreRegexps ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<HostsAreRegexps>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out HostsAreRegexps? result)
            {
                return JsonElementHelpers.TryParseValue<HostsAreRegexps>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new HostsAreRegexps(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static HostsAreRegexps IJsonElement<HostsAreRegexps>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"HostsAreRegexps: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="HostsAreRegexps"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="HostsAreRegexps"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public HostsAreRegexps Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<HostsAreRegexps>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="HostsAreRegexps"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public HostsAreRegexps Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<HostsAreRegexps>(_idx);
                }
