...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1httpJson
    {
        ...
        public readonly partial struct SslRedirect
#if NET8_0_OR_GREATER
            : IJsonElement<SslRedirect>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SslRedirect"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SslRedirect(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SslRedirect DefaultInstance { get; } = ParsedJsonDocument<SslRedirect>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(SslRedirect value)
            {
            ...
            /// </returns>
            public static bool operator ==(in SslRedirect left, in SslRedirect right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SslRedirect left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SslRedirect instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SslRedirect(JsonElement instance)
            {
                return SslRedirect.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SslRedirect From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SslRedirect ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SslRedirect>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SslRedirect ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SslRedirect>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SslRedirect ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SslRedirect>(json, options);
            }
            ...
            /// </exception>
            public static SslRedirect ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SslRedirect>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SslRedirect? result)
            {
                return JsonElementHelpers.TryParseValue<SslRedirect>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SslRedirect(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static SslRedirect IJsonElement<SslRedirect>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SslRedirect: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SslRedirect"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SslRedirect"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public SslRedirect Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SslRedirect>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SslRedirect"/> that lives for the lifetime of its
