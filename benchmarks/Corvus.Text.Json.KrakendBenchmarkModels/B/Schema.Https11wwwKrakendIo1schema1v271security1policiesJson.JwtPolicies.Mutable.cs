    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1policiesJson
    {
        ...
        public readonly partial struct JwtPolicies
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271security1policiesJson.JwtPolicies.JsonStringArray.Mutable Policies
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PoliciesUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271security1policiesJson.JwtPolicies.JsonStringArray.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetPolicies(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271security1policiesJson.JwtPolicies.JsonStringArray.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetPolicies<TContext>(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271security1policiesJson.JwtPolicies.JsonStringArray.Source<TContext> value)
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271security1policiesJson.JwtPolicies.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271security1policiesJson.JwtPolicies.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271security1policiesJson.JwtPolicies.JsonStringArray.Source policies)
                {
                ...
                /// Creates an instance of a <see cref="JwtPolicies"/>.
                /// </summary>
                public void Create(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271security1policiesJson.JwtPolicies.JsonStringArray.Source policies)
                {
                ...
                internal static void Create<TContext>(
                    ...
                    in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271security1policiesJson.JwtPolicies.JsonStringArray.Source<TContext> policies)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                /// Creates an instance of a <see cref="JwtPolicies"/>.
                /// </summary>
                public void Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271security1policiesJson.JwtPolicies.JsonStringArray.Source<TContext> policies)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271security1policiesJson.JwtPolicies.JsonStringArray.Source policies, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271security1policiesJson.JwtPolicies.JsonStringArray.Source<TContext> policies, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
