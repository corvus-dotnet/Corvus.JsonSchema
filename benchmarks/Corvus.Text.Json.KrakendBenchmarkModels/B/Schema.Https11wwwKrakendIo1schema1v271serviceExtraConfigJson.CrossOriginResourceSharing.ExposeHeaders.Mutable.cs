        ...
        public readonly partial struct CrossOriginResourceSharing
        {
            ...
            public readonly partial struct ExposeHeaders
            {
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271serviceExtraConfigJson.CrossOriginResourceSharing.ExposeHeaders.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271serviceExtraConfigJson.CrossOriginResourceSharing.ExposeHeaders.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
