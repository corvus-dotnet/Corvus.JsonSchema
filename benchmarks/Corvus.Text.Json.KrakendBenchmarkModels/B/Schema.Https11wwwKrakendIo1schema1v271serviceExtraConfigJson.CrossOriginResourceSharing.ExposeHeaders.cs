...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271serviceExtraConfigJson
    {
        ...
        public readonly partial struct CrossOriginResourceSharing
        {
            ...
            public readonly partial struct ExposeHeaders
#if NET8_0_OR_GREATER
                : IJsonElement<ExposeHeaders>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="ExposeHeaders"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal ExposeHeaders(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static ExposeHeaders DefaultInstance { get; } = ExposeHeaders.ParseValue("[]"u8);
                ...
                /// </returns>
                public static bool operator ==(in ExposeHeaders left, in ExposeHeaders right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in ExposeHeaders left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(ExposeHeaders instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExposeHeaders(JsonElement instance)
                {
                    return ExposeHeaders.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ExposeHeaders From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ExposeHeaders ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ExposeHeaders>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ExposeHeaders ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ExposeHeaders>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ExposeHeaders ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ExposeHeaders>(json, options);
                }
                ...
                /// </exception>
                public static ExposeHeaders ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<ExposeHeaders>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out ExposeHeaders? result)
                {
                    return JsonElementHelpers.TryParseValue<ExposeHeaders>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ExposeHeaders(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static ExposeHeaders IJsonElement<ExposeHeaders>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExposeHeaders: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ExposeHeaders"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ExposeHeaders"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public ExposeHeaders Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ExposeHeaders>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ExposeHeaders"/> that lives for the lifetime of its
