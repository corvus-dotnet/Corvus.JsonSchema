    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1influxJson
    {
        ...
        public readonly partial struct PointsInBuffer
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PointsInBuffer instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PointsInBuffer"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PointsInBuffer(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PointsInBuffer.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PointsInBuffer Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PointsInBuffer Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PointsInBuffer>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PointsInBuffer instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PointsInBuffer, Mutable>(this);
            }
        }
    }
}
