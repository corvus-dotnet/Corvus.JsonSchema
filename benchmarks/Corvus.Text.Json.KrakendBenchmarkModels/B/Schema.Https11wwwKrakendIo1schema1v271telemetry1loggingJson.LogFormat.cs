...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1loggingJson
    {
        ...
        public readonly partial struct LogFormat
#if NET8_0_OR_GREATER
            : IJsonElement<LogFormat>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="LogFormat"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal LogFormat(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static LogFormat DefaultInstance { get; } = ParsedJsonDocument<LogFormat>.StringConstant([.."\"default\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(LogFormat value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in LogFormat left, in LogFormat right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in LogFormat left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(LogFormat instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LogFormat(JsonElement instance)
            {
                return LogFormat.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LogFormat From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LogFormat ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LogFormat>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LogFormat ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LogFormat>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LogFormat ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LogFormat>(json, options);
            }
            ...
            /// </exception>
            public static LogFormat ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<LogFormat>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out LogFormat? result)
            {
                return JsonElementHelpers.TryParseValue<LogFormat>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new LogFormat(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static LogFormat IJsonElement<LogFormat>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LogFormat: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="LogFormat"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="LogFormat"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public LogFormat Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<LogFormat>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="LogFormat"/> that lives for the lifetime of its
