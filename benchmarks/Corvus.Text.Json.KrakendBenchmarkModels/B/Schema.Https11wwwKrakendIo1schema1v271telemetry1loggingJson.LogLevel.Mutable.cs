    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1loggingJson
    {
        ...
        public readonly partial struct LogLevel
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(LogLevel instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="LogLevel"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LogLevel(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LogLevel.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly LogLevel Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly LogLevel Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<LogLevel>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(LogLevel instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<LogLevel, Mutable>(this);
            }
        }
    }
}
