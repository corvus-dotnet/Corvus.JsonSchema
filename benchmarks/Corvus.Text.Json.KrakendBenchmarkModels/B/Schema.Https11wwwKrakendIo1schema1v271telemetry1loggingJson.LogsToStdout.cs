...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1loggingJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="LogsToStdout"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal LogsToStdout(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static LogsToStdout DefaultInstance { get; } = ParsedJsonDocument<LogsToStdout>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(LogsToStdout value)
            {
            ...
            /// </returns>
            public static bool operator ==(in LogsToStdout left, in LogsToStdout right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in LogsToStdout left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(LogsToStdout instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LogsToStdout(JsonElement instance)
            {
                return LogsToStdout.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LogsToStdout From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LogsToStdout ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LogsToStdout>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LogsToStdout ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LogsToStdout>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LogsToStdout ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LogsToStdout>(json, options);
            }
            ...
            /// </exception>
            public static LogsToStdout ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<LogsToStdout>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out LogsToStdout? result)
            {
                return JsonElementHelpers.TryParseValue<LogsToStdout>(ref reader, out result);
            }
...
#if NET
            static LogsToStdout IJsonElement<LogsToStdout>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LogsToStdout: ValueKind = {ValueKind} : \"{ToString()}\"";
