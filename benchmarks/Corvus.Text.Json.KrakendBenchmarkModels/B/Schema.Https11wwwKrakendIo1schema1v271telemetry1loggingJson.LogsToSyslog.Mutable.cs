...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1loggingJson
    {
        ...
        public readonly partial struct LogsToSyslog
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(LogsToSyslog instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="LogsToSyslog"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LogsToSyslog(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new LogsToSyslog(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LogsToSyslog.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="LogsToSyslog"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="LogsToSyslog"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly LogsToSyslog Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<LogsToSyslog>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="LogsToSyslog"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly LogsToSyslog Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<LogsToSyslog>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(LogsToSyslog instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<LogsToSyslog, Mutable>(this);
            }
        }
    }
}
