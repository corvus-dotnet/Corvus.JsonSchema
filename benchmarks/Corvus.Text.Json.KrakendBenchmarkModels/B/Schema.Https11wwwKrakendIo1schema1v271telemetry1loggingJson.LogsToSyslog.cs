...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1loggingJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="LogsToSyslog"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal LogsToSyslog(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static LogsToSyslog DefaultInstance { get; } = ParsedJsonDocument<LogsToSyslog>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(LogsToSyslog value)
            {
            ...
            /// </returns>
            public static bool operator ==(in LogsToSyslog left, in LogsToSyslog right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in LogsToSyslog left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(LogsToSyslog instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LogsToSyslog(JsonElement instance)
            {
                return LogsToSyslog.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LogsToSyslog From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LogsToSyslog ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LogsToSyslog>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LogsToSyslog ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LogsToSyslog>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LogsToSyslog ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LogsToSyslog>(json, options);
            }
            ...
            /// </exception>
            public static LogsToSyslog ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<LogsToSyslog>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out LogsToSyslog? result)
            {
                return JsonElementHelpers.TryParseValue<LogsToSyslog>(ref reader, out result);
            }
...
#if NET
            static LogsToSyslog IJsonElement<LogsToSyslog>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LogsToSyslog: ValueKind = {ValueKind} : \"{ToString()}\"";
