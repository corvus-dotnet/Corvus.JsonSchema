...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1metricsJson
    {
        ...
        public readonly partial struct EndpointDisabled
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(EndpointDisabled instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EndpointDisabled"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EndpointDisabled(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new EndpointDisabled(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EndpointDisabled.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="EndpointDisabled"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="EndpointDisabled"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly EndpointDisabled Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<EndpointDisabled>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="EndpointDisabled"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly EndpointDisabled Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EndpointDisabled>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(EndpointDisabled instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<EndpointDisabled, Mutable>(this);
            }
        }
    }
}
