    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1moesifJson
    {
        ...
        public readonly partial struct BatchSize
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(BatchSize instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="BatchSize"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator BatchSize(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"BatchSize.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly BatchSize Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly BatchSize Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<BatchSize>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(BatchSize instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<BatchSize, Mutable>(this);
            }
        }
    }
}
