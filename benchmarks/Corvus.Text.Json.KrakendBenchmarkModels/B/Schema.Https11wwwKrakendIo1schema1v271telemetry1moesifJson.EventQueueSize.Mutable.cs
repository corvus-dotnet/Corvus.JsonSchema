    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1moesifJson
    {
        ...
        public readonly partial struct EventQueueSize
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(EventQueueSize instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EventQueueSize"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EventQueueSize(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EventQueueSize.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly EventQueueSize Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly EventQueueSize Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EventQueueSize>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(EventQueueSize instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<EventQueueSize, Mutable>(this);
            }
        }
    }
}
