...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1moesifJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ShouldSkip"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ShouldSkip(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ShouldSkip value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in ShouldSkip left, in ShouldSkip right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ShouldSkip left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ShouldSkip instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ShouldSkip(JsonElement instance)
            {
                return ShouldSkip.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShouldSkip From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShouldSkip ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ShouldSkip>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShouldSkip ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ShouldSkip>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShouldSkip ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ShouldSkip>(json, options);
            }
            ...
            /// </exception>
            public static ShouldSkip ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ShouldSkip>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ShouldSkip? result)
            {
                return JsonElementHelpers.TryParseValue<ShouldSkip>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ShouldSkip(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ShouldSkip IJsonElement<ShouldSkip>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ShouldSkip: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ShouldSkip"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ShouldSkip"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ShouldSkip Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ShouldSkip>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ShouldSkip"/> that lives for the lifetime of its
