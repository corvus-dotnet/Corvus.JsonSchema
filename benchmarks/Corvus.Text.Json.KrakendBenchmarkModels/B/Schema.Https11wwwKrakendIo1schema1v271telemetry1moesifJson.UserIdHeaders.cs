...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1moesifJson
    {
        ...
        public readonly partial struct UserIdHeaders
#if NET8_0_OR_GREATER
            : IJsonElement<UserIdHeaders>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="UserIdHeaders"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal UserIdHeaders(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static UserIdHeaders DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in UserIdHeaders left, in UserIdHeaders right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in UserIdHeaders left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(UserIdHeaders instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator UserIdHeaders(JsonElement instance)
            {
                return UserIdHeaders.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UserIdHeaders From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UserIdHeaders ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<UserIdHeaders>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UserIdHeaders ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<UserIdHeaders>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UserIdHeaders ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<UserIdHeaders>(json, options);
            }
            ...
            /// </exception>
            public static UserIdHeaders ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<UserIdHeaders>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out UserIdHeaders? result)
            {
                return JsonElementHelpers.TryParseValue<UserIdHeaders>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new UserIdHeaders(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static UserIdHeaders IJsonElement<UserIdHeaders>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"UserIdHeaders: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="UserIdHeaders"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="UserIdHeaders"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public UserIdHeaders Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<UserIdHeaders>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="UserIdHeaders"/> that lives for the lifetime of its
