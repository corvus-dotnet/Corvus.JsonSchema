...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1opencensusJson
    {
        ...
        public readonly partial struct EnabledLayers
        {
            ...
            public readonly partial struct ReportRouter
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ReportRouter instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ReportRouter"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ReportRouter(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new ReportRouter(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ReportRouter.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="ReportRouter"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="ReportRouter"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ReportRouter Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<ReportRouter>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="ReportRouter"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ReportRouter Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ReportRouter>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ReportRouter instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ReportRouter, Mutable>(this);
                }
            }
        }
    }
