            ...
            public readonly partial struct AwsXRay
            {
                ...
                public readonly partial struct RequiredAccessKeyIdAndRegionAndSecretAccessKeyAndVersion
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RequiredAccessKeyIdAndRegionAndSecretAccessKeyAndVersion instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RequiredAccessKeyIdAndRegionAndSecretAccessKeyAndVersion"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RequiredAccessKeyIdAndRegionAndSecretAccessKeyAndVersion(Mutable instance)
                        {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.Text.Json.JsonElement.Mutable AccessKeyId
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AccessKeyIdUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.Text.Json.JsonElement.Mutable SecretAccessKey
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SecretAccessKeyUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new RequiredAccessKeyIdAndRegionAndSecretAccessKeyAndVersion(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        public void SetAccessKeyId(in Corvus.Text.Json.JsonElement.Source value)
                        {
                            CheckValidInstance();

                            if (value.IsUndefined)
                            {
                                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("access_key_id");
                            }
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetAccessKeyId<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetSecretAccessKey(in Corvus.Text.Json.JsonElement.Source value)
                        {
                            CheckValidInstance();

                            if (value.IsUndefined)
                            {
                                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("secret_access_key");
                            }
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetSecretAccessKey<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
#if NET9_0_OR_GREATER
                            where TContext : allows ref struct
#endif
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RequiredAccessKeyIdAndRegionAndSecretAccessKeyAndVersion.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="RequiredAccessKeyIdAndRegionAndSecretAccessKeyAndVersion"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="RequiredAccessKeyIdAndRegionAndSecretAccessKeyAndVersion"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredAccessKeyIdAndRegionAndSecretAccessKeyAndVersion Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<RequiredAccessKeyIdAndRegionAndSecretAccessKeyAndVersion>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="RequiredAccessKeyIdAndRegionAndSecretAccessKeyAndVersion"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredAccessKeyIdAndRegionAndSecretAccessKeyAndVersion Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RequiredAccessKeyIdAndRegionAndSecretAccessKeyAndVersion>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.Exporters.AwsXRay.RequiredAccessKeyIdAndRegionAndSecretAccessKeyAndVersion.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                        public static implicit operator Source(RequiredAccessKeyIdAndRegionAndSecretAccessKeyAndVersion instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.Exporters.AwsXRay.RequiredAccessKeyIdAndRegionAndSecretAccessKeyAndVersion.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        internal static void Create(
                            ...
                            in Corvus.Text.Json.JsonElement.Source accessKeyId,
                            in Corvus.Text.Json.JsonElement.Source region,
                            in Corvus.Text.Json.JsonElement.Source secretAccessKey,
                        ...
                        public void Create(
                            ...
                            in Corvus.Text.Json.JsonElement.Source version)
                        {
                            Create(ref _builder, accessKeyId, region, secretAccessKey, version);
                        }
                        ...
                        internal static void Create<TContext>(
                            in TContext context,
                            ref ComplexValueBuilder builder,
                            in Corvus.Text.Json.JsonElement.Source<TContext> accessKeyId,
                            in Corvus.Text.Json.JsonElement.Source<TContext> region,
                            in Corvus.Text.Json.JsonElement.Source<TContext> secretAccessKey,
                        ...
                        #endif
                        {
                            Create(context, ref _builder, accessKeyId, region, secretAccessKey, version);
                        }
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source accessKeyId, in Corvus.Text.Json.JsonElement.Source region, in Corvus.Text.Json.JsonElement.Source secretAccessKey, in Corvus.Text.Json.JsonElement.Source version, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(accessKeyId, region, secretAccessKey, version);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> accessKeyId, in Corvus.Text.Json.JsonElement.Source<TContext> region, in Corvus.Text.Json.JsonElement.Source<TContext> secretAccessKey, in Corvus.Text.Json.JsonElement.Source<TContext> version, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                        ...
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(context, accessKeyId, region, secretAccessKey, version);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    {
                        return workspace.CreateBuilder<RequiredAccessKeyIdAndRegionAndSecretAccessKeyAndVersion, Mutable>(this);
                    }
                }
            }
        }
