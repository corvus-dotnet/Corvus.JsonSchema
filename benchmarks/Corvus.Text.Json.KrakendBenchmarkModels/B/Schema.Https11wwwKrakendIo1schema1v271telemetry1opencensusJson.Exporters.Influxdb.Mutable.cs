        ...
        public readonly partial struct Exporters
        {
            ...
            public readonly partial struct Influxdb
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(Influxdb instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="Influxdb"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Influxdb(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Baseline.JsonString.Mutable Db
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DbUtf8, out Corvus.KrakendBenchmark.Baseline.JsonString.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Baseline.JsonString.Mutable Password
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PasswordUtf8, out Corvus.KrakendBenchmark.Baseline.JsonString.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Baseline.JsonString.Mutable Username
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UsernameUtf8, out Corvus.KrakendBenchmark.Baseline.JsonString.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetDb(in Corvus.KrakendBenchmark.Baseline.JsonString.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("db");
                        }
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetPassword(in Corvus.KrakendBenchmark.Baseline.JsonString.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetUsername(in Corvus.KrakendBenchmark.Baseline.JsonString.Source value)
                    {
                        CheckValidInstance();
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"Influxdb.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly Influxdb Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly Influxdb Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<Influxdb>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.Exporters.Influxdb.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(Influxdb instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.Exporters.Influxdb.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="Influxdb"/>.
                    /// </summary>
                    internal static void Create(
                        ref ComplexValueBuilder builder,
                        in Corvus.KrakendBenchmark.Baseline.JsonString.Source address,
                        in Corvus.KrakendBenchmark.Baseline.JsonString.Source db,
                        in Corvus.KrakendBenchmark.Baseline.JsonString.Source password = default,
                        in Corvus.KrakendBenchmark.Baseline.Schema.Duration.Source timeout = default,
                        in Corvus.KrakendBenchmark.Baseline.JsonString.Source username = default)
                    {
                    ...
                    public void Create(
                        ...
                        in Corvus.KrakendBenchmark.Baseline.JsonString.Source username = default)
                    {
                        Create(ref _builder, address, db, password, timeout, username);
                    }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Baseline.JsonString.Source address, in Corvus.KrakendBenchmark.Baseline.JsonString.Source db, in Corvus.KrakendBenchmark.Baseline.JsonString.Source password = default, in Corvus.KrakendBenchmark.Baseline.Schema.Duration.Source timeout = default, in Corvus.KrakendBenchmark.Baseline.JsonString.Source username = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(address, db, password, timeout, username);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<Influxdb, Mutable>(this);
                }
            }
        }
    }
