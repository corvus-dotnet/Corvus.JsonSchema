        ...
        public readonly partial struct Exporters
        {
            ...
            public readonly partial struct Jaeger
            {
                ...
                public readonly partial struct RequiredEndpointAndServiceName
                    ...
                    : IJsonElement<RequiredEndpointAndServiceName>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="RequiredEndpointAndServiceName"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal RequiredEndpointAndServiceName(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static RequiredEndpointAndServiceName DefaultInstance { get; }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Text.Json.JsonElement Endpoint
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EndpointUtf8, out Corvus.Text.Json.JsonElement value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Text.Json.JsonElement ServiceName
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ServiceNameUtf8, out Corvus.Text.Json.JsonElement value))
                            {
                                return value;
                            }
                    ...
                    /// </returns>
                    public static bool operator ==(in RequiredEndpointAndServiceName left, in RequiredEndpointAndServiceName right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in RequiredEndpointAndServiceName left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(RequiredEndpointAndServiceName instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredEndpointAndServiceName(JsonElement instance)
                    {
                        return RequiredEndpointAndServiceName.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredEndpointAndServiceName From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredEndpointAndServiceName ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredEndpointAndServiceName>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredEndpointAndServiceName ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredEndpointAndServiceName>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredEndpointAndServiceName ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredEndpointAndServiceName>(json, options);
                    }
                    ...
                    /// </exception>
                    public static RequiredEndpointAndServiceName ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<RequiredEndpointAndServiceName>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredEndpointAndServiceName? result)
                    {
                        return JsonElementHelpers.TryParseValue<RequiredEndpointAndServiceName>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RequiredEndpointAndServiceName(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static RequiredEndpointAndServiceName IJsonElement<RequiredEndpointAndServiceName>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredEndpointAndServiceName: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RequiredEndpointAndServiceName"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RequiredEndpointAndServiceName"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public RequiredEndpointAndServiceName Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RequiredEndpointAndServiceName>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RequiredEndpointAndServiceName"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public RequiredEndpointAndServiceName Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<RequiredEndpointAndServiceName>(_idx);
                        }
