    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1opencensusJson
    {
        ...
        public readonly partial struct Exporters
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="Ocagent"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal Ocagent(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static Ocagent DefaultInstance { get; }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Baseline.JsonString Address
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AddressUtf8, out Corvus.KrakendBenchmark.Baseline.JsonString value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.Exporters.Ocagent.EnableCompression EnableCompressionValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnableCompressionValueUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.Exporters.Ocagent.EnableCompression value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.Exporters.Ocagent.EnableCompression.DefaultInstance;
                    }
                }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.Exporters.Ocagent.Headers HeadersValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HeadersValueUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.Exporters.Ocagent.Headers value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.Exporters.Ocagent.Insecure InsecureValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InsecureValueUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.Exporters.Ocagent.Insecure value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.Exporters.Ocagent.Insecure.DefaultInstance;
                    }
                }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Baseline.Schema.Duration Reconnection
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReconnectionUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Duration value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in Ocagent left, in Ocagent right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in Ocagent left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(Ocagent instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Ocagent(JsonElement instance)
                {
                    return Ocagent.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Ocagent From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Ocagent ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Ocagent>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Ocagent ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Ocagent>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Ocagent ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Ocagent>(json, options);
                }
                ...
                /// </exception>
                public static Ocagent ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<Ocagent>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out Ocagent? result)
                {
                    return JsonElementHelpers.TryParseValue<Ocagent>(ref reader, out result);
                }
...
#if NET
                static Ocagent IJsonElement<Ocagent>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Ocagent: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                public static class JsonPropertyNames
                {
                    ...
                    /// <summary>
                    /// Gets the JSON property name for <see cref="EnableCompressionValue"/>.
                    /// </summary>
                    ...
                    /// </summary>
                    public const string InsecureValue = "insecure";
                    ...
                    /// Gets the JSON property name for <see cref="InsecureValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> InsecureValueUtf8 => "insecure"u8;
                ...
                private static class JsonPropertyNamesEscaped
                {
                    ...
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="EnableCompressionValue"/>.
                    /// </summary>
                    ...
                    /// </summary>
                    public static ReadOnlySpan<byte> InsecureValue => "insecure"u8;

                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="Reconnection"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Reconnection => "reconnection"u8;
