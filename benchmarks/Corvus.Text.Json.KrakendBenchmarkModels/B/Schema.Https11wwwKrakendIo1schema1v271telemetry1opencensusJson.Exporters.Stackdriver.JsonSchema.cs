    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1opencensusJson
    {
        ...
        public readonly partial struct Exporters
        {
            ...
            public readonly partial struct Stackdriver
                : IJsonElement<Stackdriver>
            {
                public static partial class JsonSchema
                {
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDefaultLabelsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("default_labels"u8, buffer, out written);
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDefaultLabelsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("default_labels"u8, buffer, out written);

                    private const int RequiredOffsetForDefaultLabels = 0;
                    private const uint RequiredBitForDefaultLabels = 0b00000000000000000000000000000001;

                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyProjectIdPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("project_id"u8, buffer, out written);
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyProjectIdNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("project_id"u8, buffer, out written);

                    private const int RequiredOffsetForProjectId = 0;
                    private const uint RequiredBitForProjectId = 0b00000000000000000000000000000010;
                    ...
                    private static void MatchDefaultLabelsValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        ...
                        JsonSchemaContext childContext =
                            Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.Exporters.Stackdriver.DefaultLabels.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                        ...
                        Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.Exporters.Stackdriver.DefaultLabels.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                        ...
                        requiredBitBuffer[RequiredOffsetForDefaultLabels] |= RequiredBitForDefaultLabels;
                    }

                    private static void MatchMetricPrefix(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                        JsonSchemaContext childContext1 =
                            Corvus.KrakendBenchmark.Baseline.JsonString.JsonSchema.PushChildContextUnescaped(
                                ...
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.MetricPrefixUtf8,
                                evaluationPath: MetricPrefixSchemaEvaluationPath);
                    ...
                    private static void MatchProjectIdValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                        JsonSchemaContext childContext2 =
                            Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.Exporters.Stackdriver.ProjectId.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.ProjectIdValueUtf8,
                                evaluationPath: ProjectIdValueSchemaEvaluationPath);

                        Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.Exporters.Stackdriver.ProjectId.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDefaultLabelsPresent, "default_labels"u8, "required"u8);
                                context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyProjectIdPresent, "project_id"u8, "required"u8);
                            }
                            ...
                            {
                                if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForDefaultLabels] & RequiredBitForDefaultLabels) == 0)
                                {
                                    context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyDefaultLabelsNotPresent, "default_labels"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDefaultLabelsPresent, "default_labels"u8, "required"u8);
                                ...
                                {
                                    context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyProjectIdNotPresent, "project_id"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyProjectIdPresent, "project_id"u8, "required"u8);
