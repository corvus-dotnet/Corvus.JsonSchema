            ...
            public readonly partial struct Stackdriver
            {
                ...
                public readonly partial struct ProjectId
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(ProjectId instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="ProjectId"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator ProjectId(Mutable instance)
                        {
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new ProjectId(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"ProjectId.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="ProjectId"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="ProjectId"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ProjectId Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<ProjectId>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="ProjectId"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ProjectId Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<ProjectId>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(ProjectId instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<ProjectId, Mutable>(this);
                    }
                }
            }
        }
