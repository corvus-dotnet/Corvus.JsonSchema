    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1opencensusJson
    {
        ...
        public readonly partial struct Exporters
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="Stackdriver"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal Stackdriver(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static Stackdriver DefaultInstance { get; }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.Exporters.Stackdriver.DefaultLabels DefaultLabelsValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DefaultLabelsValueUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.Exporters.Stackdriver.DefaultLabels value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Baseline.JsonString MetricPrefix
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MetricPrefixUtf8, out Corvus.KrakendBenchmark.Baseline.JsonString value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.Exporters.Stackdriver.ProjectId ProjectIdValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProjectIdValueUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.Exporters.Stackdriver.ProjectId value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.Exporters.Stackdriver.ProjectId.DefaultInstance;
                    }
                }
                ...
                /// </returns>
                public static bool operator ==(in Stackdriver left, in Stackdriver right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in Stackdriver left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(Stackdriver instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Stackdriver(JsonElement instance)
                {
                    return Stackdriver.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Stackdriver From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Stackdriver ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Stackdriver>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Stackdriver ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Stackdriver>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Stackdriver ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Stackdriver>(json, options);
                }
                ...
                /// </exception>
                public static Stackdriver ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<Stackdriver>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out Stackdriver? result)
                {
                    return JsonElementHelpers.TryParseValue<Stackdriver>(ref reader, out result);
                }
...
#if NET
                static Stackdriver IJsonElement<Stackdriver>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Stackdriver: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                public static class JsonPropertyNames
                {
                    ...
                    /// <summary>
                    /// Gets the JSON property name for <see cref="ProjectIdValue"/>.
                    /// </summary>
                    ...
                    /// Gets the JSON property name for <see cref="ProjectIdValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> ProjectIdValueUtf8 => "project_id"u8;
                }
                ...
                private static class JsonPropertyNamesEscaped
                {
                    ...
                    /// </summary>
                    public static ReadOnlySpan<byte> MetricPrefix => "metric_prefix"u8;
