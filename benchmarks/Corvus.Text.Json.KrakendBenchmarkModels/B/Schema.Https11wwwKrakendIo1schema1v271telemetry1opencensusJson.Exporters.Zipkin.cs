    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1opencensusJson
    {
        ...
        public readonly partial struct Exporters
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Baseline.JsonString CollectorUrl
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CollectorUrlUtf8, out Corvus.KrakendBenchmark.Baseline.JsonString value))
                        {
                            return value;
                        }
