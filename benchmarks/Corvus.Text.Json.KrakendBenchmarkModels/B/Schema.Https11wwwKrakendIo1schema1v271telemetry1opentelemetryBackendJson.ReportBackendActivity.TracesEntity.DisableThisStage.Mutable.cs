            ...
            public readonly partial struct TracesEntity
            {
                ...
                public readonly partial struct DisableThisStage
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(DisableThisStage instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="DisableThisStage"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator DisableThisStage(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"DisableThisStage.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly DisableThisStage Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly DisableThisStage Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<DisableThisStage>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(DisableThisStage instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<DisableThisStage, Mutable>(this);
                    }
                }
            }
        }
