    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1opentelemetryBackendJson
    {
        ...
        public readonly partial struct ReportBackendActivity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryBackendJson.ReportBackendActivity.TracesEntity.DisableThisStage DisableStage
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisableStageUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryBackendJson.ReportBackendActivity.TracesEntity.DisableThisStage value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryBackendJson.ReportBackendActivity.TracesEntity.DisableThisStage.DefaultInstance;
                    }
                }
