        ...
        public readonly partial struct ExportersOverride
        {
            ...
            public readonly partial struct TraceExporters
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(TraceExporters instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="TraceExporters"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TraceExporters(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TraceExporters.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TraceExporters Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TraceExporters Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<TraceExporters>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryEndpointJson.ExportersOverride.TraceExporters.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(TraceExporters instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryEndpointJson.ExportersOverride.TraceExporters.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<TraceExporters, Mutable>(this);
                }
            }
        }
    }
