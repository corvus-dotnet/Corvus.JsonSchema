...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1opentelemetryEndpointJson
    {
        ...
        public readonly partial struct ExportersOverride
        {
            ...
            public readonly partial struct TraceExporters
#if NET8_0_OR_GREATER
                : IJsonElement<TraceExporters>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="TraceExporters"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal TraceExporters(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static TraceExporters DefaultInstance { get; }
                ...
                /// </returns>
                public static bool operator ==(in TraceExporters left, in TraceExporters right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in TraceExporters left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(TraceExporters instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TraceExporters(JsonElement instance)
                {
                    return TraceExporters.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TraceExporters From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TraceExporters ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TraceExporters>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TraceExporters ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TraceExporters>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TraceExporters ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TraceExporters>(json, options);
                }
                ...
                /// </exception>
                public static TraceExporters ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<TraceExporters>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out TraceExporters? result)
                {
                    return JsonElementHelpers.TryParseValue<TraceExporters>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TraceExporters(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static TraceExporters IJsonElement<TraceExporters>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TraceExporters: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TraceExporters"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TraceExporters"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public TraceExporters Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TraceExporters>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TraceExporters"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public TraceExporters Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<TraceExporters>(_idx);
                    }
