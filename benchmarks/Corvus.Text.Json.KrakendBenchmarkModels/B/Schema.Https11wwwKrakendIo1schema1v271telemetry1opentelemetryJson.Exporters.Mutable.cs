    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson
    {
        ...
        public readonly partial struct Exporters
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.RequiredHostAndNameArray.Mutable Otlp
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OtlpUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.RequiredHostAndNameArray.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.RequiredNameArray.Mutable Prometheus
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrometheusUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.RequiredNameArray.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetOtlp(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.RequiredHostAndNameArray.Source value)
                {
                    CheckValidInstance();
                    ...
                    else
                    {
                        ...
                        value.AddAsProperty(JsonPropertyNamesEscaped.Otlp, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetOtlp<TContext>(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.RequiredHostAndNameArray.Source<TContext> value)
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetPrometheus(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.RequiredNameArray.Source value)
                {
                    CheckValidInstance();
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsProperty(JsonPropertyNamesEscaped.Prometheus, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetPrometheus<TContext>(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.RequiredNameArray.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.RequiredHostAndNameArray.Source otlp = default,
                    in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.RequiredNameArray.Source prometheus = default)
                {
                    otlp.AddAsProperty(JsonPropertyNamesEscaped.Otlp, ref builder, escapeName: false);
                    prometheus.AddAsProperty(JsonPropertyNamesEscaped.Prometheus, ref builder, escapeName: false);
                }

                /// <summary>
                /// Creates an instance of a <see cref="Exporters"/>.
                /// </summary>
                public void Create(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.RequiredHostAndNameArray.Source otlp = default, in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.RequiredNameArray.Source prometheus = default)
                {
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.RequiredHostAndNameArray.Source<TContext> otlp = default,
                    in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.RequiredNameArray.Source<TContext> prometheus = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
