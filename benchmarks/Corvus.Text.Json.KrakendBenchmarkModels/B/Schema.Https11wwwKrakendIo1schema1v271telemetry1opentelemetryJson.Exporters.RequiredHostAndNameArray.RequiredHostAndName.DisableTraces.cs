            ...
            public readonly partial struct RequiredHostAndNameArray
            {
                ...
                public readonly partial struct RequiredHostAndName
                {
...
#endif
                    {
                        ...
                        /// <summary>
                        /// Initializes a new instance of the <see cref="DisableTraces"/> struct.
                        /// </summary>
                        /// <param name="value">The value from which to construct the instance.</param>
                        internal DisableTraces(IJsonDocument parent, int idx)
                        {
                            Debug.Assert(idx >= 0);
                            _parent = parent;
                            _idx = idx;
                        ...
                        /// </summary>
                        public static DisableTraces DefaultInstance { get; } = ParsedJsonDocument<DisableTraces>.False;
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator bool(DisableTraces value)
                        {
                        ...
                        /// </returns>
                        public static bool operator ==(in DisableTraces left, in DisableTraces right)
                        {
                        ...
                        /// <c>True</c> if the values are equal.
                        /// </returns>
                        public static bool operator ==(in DisableTraces left, in JsonElement right)
                        {
                            return left.Equals(right);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator JsonElement(DisableTraces instance)
                        {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator DisableTraces(JsonElement instance)
                        {
                            return DisableTraces.From(instance);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static DisableTraces From<T>(in T instance)
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static DisableTraces ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<DisableTraces>(utf8Json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static DisableTraces ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<DisableTraces>(json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static DisableTraces ParseValue(string json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<DisableTraces>(json, options);
                        }
                        ...
                        /// </exception>
                        public static DisableTraces ParseValue(ref Utf8JsonReader reader)
                        {
                            return JsonElementHelpers.ParseValue<DisableTraces>(ref reader);
                        }
                        ...
                        ///   A value could not be read from the reader.
                        /// </exception>
                        public static bool TryParseValue(ref Utf8JsonReader reader, out DisableTraces? result)
                        {
                            return JsonElementHelpers.TryParseValue<DisableTraces>(ref reader, out result);
                        }
...
#if NET
                        static DisableTraces IJsonElement<DisableTraces>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"DisableTraces: ValueKind = {ValueKind} : \"{ToString()}\"";
