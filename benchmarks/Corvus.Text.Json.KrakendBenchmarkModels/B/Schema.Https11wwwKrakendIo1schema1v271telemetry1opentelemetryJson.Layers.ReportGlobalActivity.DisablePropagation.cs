    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson
    {
        ...
        public readonly partial struct Layers
        {
            ...
            public readonly partial struct ReportGlobalActivity
            {
                ...
                public readonly partial struct DisablePropagation
#if NET8_0_OR_GREATER
                    : IJsonElement<DisablePropagation>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="DisablePropagation"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal DisablePropagation(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static DisablePropagation DefaultInstance { get; } = ParsedJsonDocument<DisablePropagation>.False;
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator bool(DisablePropagation value)
                    {
                    ...
                    /// </returns>
                    public static bool operator ==(in DisablePropagation left, in DisablePropagation right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in DisablePropagation left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(DisablePropagation instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DisablePropagation(JsonElement instance)
                    {
                        return DisablePropagation.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static DisablePropagation From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static DisablePropagation ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<DisablePropagation>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static DisablePropagation ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<DisablePropagation>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static DisablePropagation ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<DisablePropagation>(json, options);
                    }
                    ...
                    /// </exception>
                    public static DisablePropagation ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<DisablePropagation>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out DisablePropagation? result)
                    {
                        return JsonElementHelpers.TryParseValue<DisablePropagation>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new DisablePropagation(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static DisablePropagation IJsonElement<DisablePropagation>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DisablePropagation: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="DisablePropagation"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="DisablePropagation"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public DisablePropagation Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<DisablePropagation>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="DisablePropagation"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public DisablePropagation Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<DisablePropagation>(_idx);
                        }
