            ...
            public readonly partial struct ReportGlobalActivity
            {
                ...
                public readonly partial struct MetricsStaticAttributesEntityArray
                {
                    ...
                    public readonly partial struct MetricsStaticAttributesEntity
                        ...
                        : IJsonElement<MetricsStaticAttributesEntity>,
                          IFormattable,
                          ISpanFormattable,
...
#endif
                    {
                        ...
                        /// <summary>
                        /// Initializes a new instance of the <see cref="MetricsStaticAttributesEntity"/> struct.
                        /// </summary>
                        /// <param name="value">The value from which to construct the instance.</param>
                        internal MetricsStaticAttributesEntity(IJsonDocument parent, int idx)
                        {
                            Debug.Assert(idx >= 0);
                            _parent = parent;
                            _idx = idx;
                        ...
                        /// </summary>
                        public static MetricsStaticAttributesEntity DefaultInstance { get; }
                        ...
                        /// </returns>
                        public static bool operator ==(in MetricsStaticAttributesEntity left, in MetricsStaticAttributesEntity right)
                        {
                        ...
                        /// <c>True</c> if the values are equal.
                        /// </returns>
                        public static bool operator ==(in MetricsStaticAttributesEntity left, in JsonElement right)
                        {
                            return left.Equals(right);
                        }
                        ...
                        public static implicit operator JsonElement(MetricsStaticAttributesEntity instance)
                        {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator MetricsStaticAttributesEntity(JsonElement instance)
                        {
                            return MetricsStaticAttributesEntity.From(instance);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static MetricsStaticAttributesEntity From<T>(in T instance)
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static MetricsStaticAttributesEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<MetricsStaticAttributesEntity>(utf8Json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static MetricsStaticAttributesEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<MetricsStaticAttributesEntity>(json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static MetricsStaticAttributesEntity ParseValue(string json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<MetricsStaticAttributesEntity>(json, options);
                        }
                        ...
                        /// </exception>
                        public static MetricsStaticAttributesEntity ParseValue(ref Utf8JsonReader reader)
                        {
                            return JsonElementHelpers.ParseValue<MetricsStaticAttributesEntity>(ref reader);
                        }
                        ...
                        ///   A value could not be read from the reader.
                        /// </exception>
                        public static bool TryParseValue(ref Utf8JsonReader reader, out MetricsStaticAttributesEntity? result)
                        {
                            return JsonElementHelpers.TryParseValue<MetricsStaticAttributesEntity>(ref reader, out result);
                        }
...
#if NET
                        static MetricsStaticAttributesEntity IJsonElement<MetricsStaticAttributesEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"MetricsStaticAttributesEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public MetricsStaticAttributesEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public MetricsStaticAttributesEntity Freeze()
                        {
                            CheckValidInstance();
                            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                            {
                                return mutable.FreezeElement<MetricsStaticAttributesEntity>(_idx);
                            }
