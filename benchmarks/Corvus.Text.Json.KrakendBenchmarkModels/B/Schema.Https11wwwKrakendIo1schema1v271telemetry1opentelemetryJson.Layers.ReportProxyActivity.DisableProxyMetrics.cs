    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson
    {
        ...
        public readonly partial struct Layers
        {
            ...
            public readonly partial struct ReportProxyActivity
            {
                ...
                public readonly partial struct DisableProxyMetrics
#if NET8_0_OR_GREATER
                    : IJsonElement<DisableProxyMetrics>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="DisableProxyMetrics"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal DisableProxyMetrics(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static DisableProxyMetrics DefaultInstance { get; } = ParsedJsonDocument<DisableProxyMetrics>.False;
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator bool(DisableProxyMetrics value)
                    {
                    ...
                    /// </returns>
                    public static bool operator ==(in DisableProxyMetrics left, in DisableProxyMetrics right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in DisableProxyMetrics left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(DisableProxyMetrics instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DisableProxyMetrics(JsonElement instance)
                    {
                        return DisableProxyMetrics.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static DisableProxyMetrics From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static DisableProxyMetrics ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<DisableProxyMetrics>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static DisableProxyMetrics ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<DisableProxyMetrics>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static DisableProxyMetrics ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<DisableProxyMetrics>(json, options);
                    }
                    ...
                    /// </exception>
                    public static DisableProxyMetrics ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<DisableProxyMetrics>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out DisableProxyMetrics? result)
                    {
                        return JsonElementHelpers.TryParseValue<DisableProxyMetrics>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new DisableProxyMetrics(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static DisableProxyMetrics IJsonElement<DisableProxyMetrics>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DisableProxyMetrics: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="DisableProxyMetrics"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="DisableProxyMetrics"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public DisableProxyMetrics Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<DisableProxyMetrics>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="DisableProxyMetrics"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public DisableProxyMetrics Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<DisableProxyMetrics>(_idx);
                        }
