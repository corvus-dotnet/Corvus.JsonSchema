        ...
        public readonly partial struct Layers
        {
            ...
            public readonly partial struct ReportProxyActivity
            {
...
#endif
                {
                    ...
                    public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Layers.ReportProxyActivity.MetricsStaticAttributesEntityArray.MetricsStaticAttributesEntity this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Layers.ReportProxyActivity.MetricsStaticAttributesEntityArray.MetricsStaticAttributesEntity>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Layers.ReportProxyActivity.MetricsStaticAttributesEntityArray.MetricsStaticAttributesEntity> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Layers.ReportProxyActivity.MetricsStaticAttributesEntityArray.MetricsStaticAttributesEntity>(_parent, _idx);
                    }
