        ...
        public readonly partial struct RequiredHeadersAndNameArray
        {
            ...
            public readonly partial struct RequiredHeadersAndName
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="Headers"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal Headers(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static Headers DefaultInstance { get; }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Baseline.JsonString Property
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PropertyUtf8, out Corvus.KrakendBenchmark.Baseline.JsonString value))
                            {
                                return value;
                            }
                    ...
                    /// </returns>
                    public static bool operator ==(in Headers left, in Headers right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in Headers left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(Headers instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Headers(JsonElement instance)
                    {
                        return Headers.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static Headers From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static Headers ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<Headers>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static Headers ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<Headers>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static Headers ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<Headers>(json, options);
                    }
                    ...
                    /// </exception>
                    public static Headers ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<Headers>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out Headers? result)
                    {
                        return JsonElementHelpers.TryParseValue<Headers>(ref reader, out result);
                    }
...
#if NET
                    static Headers IJsonElement<Headers>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"Headers: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    private static class JsonPropertyNamesEscaped
                    {
                        ...
                        /// </summary>
                        public static ReadOnlySpan<byte> Property => ".*"u8;
                    }
                }
            }
        }
