    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271tlsJson
    {
        ...
        public readonly partial struct CaCertificatesForMtls
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(CaCertificatesForMtls instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CaCertificatesForMtls"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CaCertificatesForMtls(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CaCertificatesForMtls.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public readonly CaCertificatesForMtls Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly CaCertificatesForMtls Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CaCertificatesForMtls>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271tlsJson.CaCertificatesForMtls.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(CaCertificatesForMtls instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271tlsJson.CaCertificatesForMtls.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<CaCertificatesForMtls, Mutable>(this);
            }
        }
    }
}
