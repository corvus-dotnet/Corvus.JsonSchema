        ...
        public readonly partial struct KeysEntityArray
        {
            ...
            public readonly partial struct KeysEntity
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.PrivateKey.Mutable PrivateKeyValue
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrivateKeyValueUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.PrivateKey.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.PublicKey.Mutable PublicKeyValue
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PublicKeyValueUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.PublicKey.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetPrivateKeyValue(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.PrivateKey.Source value)
                    {
                        CheckValidInstance();
                        ...
                        else
                        {
                            ...
                            value.AddAsProperty(JsonPropertyNamesEscaped.PrivateKeyValue, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetPublicKeyValue(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.PublicKey.Source value)
                    {
                        CheckValidInstance();
                        ...
                        {
                            // We are going to insert the new value
                            value.AddAsProperty(JsonPropertyNamesEscaped.PublicKeyValue, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                            int endIndex = _idx + _parent.GetDbSize(_idx, false);
                            _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                        }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.PrivateKey.Source privateKey = default,
                        in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.PublicKey.Source publicKey = default)
                    {
                        privateKey.AddAsProperty(JsonPropertyNamesEscaped.PrivateKeyValue, ref builder, escapeName: false);
                        publicKey.AddAsProperty(JsonPropertyNamesEscaped.PublicKeyValue, ref builder, escapeName: false);
                    }

                    /// <summary>
                    /// Creates an instance of a <see cref="KeysEntity"/>.
                    /// </summary>
                    public void Create(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.PrivateKey.Source privateKey = default, in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.PublicKey.Source publicKey = default)
                    {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.PrivateKey.Source privateKey = default, in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.PublicKey.Source publicKey = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
