    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271tlsJson
    {
        ...
        public readonly partial struct KeysEntityArray
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.PrivateKey PrivateKeyValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrivateKeyValueUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.PrivateKey value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.PrivateKey.DefaultInstance;
                    }
                }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.PublicKey PublicKeyValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PublicKeyValueUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.PublicKey value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.PublicKey.DefaultInstance;
                    }
                }
