...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271websocketJson
    {
        ...
        public readonly partial struct MaximumMessageSize
#if NET8_0_OR_GREATER
            : IJsonElement<MaximumMessageSize>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="MaximumMessageSize"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal MaximumMessageSize(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static MaximumMessageSize DefaultInstance { get; } = ParsedJsonDocument<MaximumMessageSize>.NumberConstant([.."512"u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator long(MaximumMessageSize value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator double(MaximumMessageSize value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator Corvus.Numerics.BigNumber(MaximumMessageSize value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator System.Numerics.BigInteger(MaximumMessageSize value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator decimal(MaximumMessageSize value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in MaximumMessageSize left, in MaximumMessageSize right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in MaximumMessageSize left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(MaximumMessageSize instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MaximumMessageSize(JsonElement instance)
            {
                return MaximumMessageSize.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MaximumMessageSize From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MaximumMessageSize ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MaximumMessageSize>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MaximumMessageSize ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MaximumMessageSize>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MaximumMessageSize ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MaximumMessageSize>(json, options);
            }
            ...
            /// </exception>
            public static MaximumMessageSize ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<MaximumMessageSize>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out MaximumMessageSize? result)
            {
                return JsonElementHelpers.TryParseValue<MaximumMessageSize>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MaximumMessageSize(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static MaximumMessageSize IJsonElement<MaximumMessageSize>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MaximumMessageSize: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MaximumMessageSize"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MaximumMessageSize"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public MaximumMessageSize Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MaximumMessageSize>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MaximumMessageSize"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public MaximumMessageSize Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<MaximumMessageSize>(_idx);
                }
