...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271websocketJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="MessageBufferSize"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal MessageBufferSize(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static MessageBufferSize DefaultInstance { get; } = ParsedJsonDocument<MessageBufferSize>.NumberConstant([.."256"u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator long(MessageBufferSize value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator double(MessageBufferSize value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator Corvus.Numerics.BigNumber(MessageBufferSize value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator System.Numerics.BigInteger(MessageBufferSize value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator decimal(MessageBufferSize value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in MessageBufferSize left, in MessageBufferSize right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in MessageBufferSize left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(MessageBufferSize instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MessageBufferSize(JsonElement instance)
            {
                return MessageBufferSize.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MessageBufferSize From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MessageBufferSize ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MessageBufferSize>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MessageBufferSize ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MessageBufferSize>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MessageBufferSize ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MessageBufferSize>(json, options);
            }
            ...
            /// </exception>
            public static MessageBufferSize ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<MessageBufferSize>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out MessageBufferSize? result)
            {
                return JsonElementHelpers.TryParseValue<MessageBufferSize>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MessageBufferSize(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static MessageBufferSize IJsonElement<MessageBufferSize>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MessageBufferSize: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MessageBufferSize"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MessageBufferSize"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public MessageBufferSize Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MessageBufferSize>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MessageBufferSize"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public MessageBufferSize Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<MessageBufferSize>(_idx);
                }
