...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271websocketJson
    {
        ...
        public readonly partial struct NotifyConnections
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(NotifyConnections instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="NotifyConnections"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator NotifyConnections(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new NotifyConnections(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"NotifyConnections.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="NotifyConnections"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="NotifyConnections"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly NotifyConnections Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<NotifyConnections>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="NotifyConnections"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly NotifyConnections Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<NotifyConnections>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(NotifyConnections instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<NotifyConnections, Mutable>(this);
            }
        }
    }
}
