    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271websocketJson
    {
        ...
        public readonly partial struct NotifyDisconnections
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(NotifyDisconnections instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="NotifyDisconnections"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator NotifyDisconnections(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"NotifyDisconnections.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly NotifyDisconnections Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly NotifyDisconnections Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<NotifyDisconnections>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(NotifyDisconnections instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<NotifyDisconnections, Mutable>(this);
            }
        }
    }
}
