    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271websocketJson
    {
        ...
        public readonly partial struct ReadBufferSize
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ReadBufferSize instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ReadBufferSize"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ReadBufferSize(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ReadBufferSize.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ReadBufferSize Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ReadBufferSize Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ReadBufferSize>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ReadBufferSize instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ReadBufferSize, Mutable>(this);
            }
        }
    }
}
