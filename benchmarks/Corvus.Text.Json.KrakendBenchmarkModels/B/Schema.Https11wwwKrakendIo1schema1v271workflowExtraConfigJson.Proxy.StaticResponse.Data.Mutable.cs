            ...
            public readonly partial struct StaticResponse
            {
                ...
                public readonly partial struct Data
                {
...
#endif
                    {
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly Data Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<Data>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.Proxy.StaticResponse.Data.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.Proxy.StaticResponse.Data.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
