        ...
        public readonly partial struct Proxy
        {
            ...
            public readonly partial struct StaticResponse
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(StaticResponse instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="StaticResponse"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator StaticResponse(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.Proxy.StaticResponse.Data.Mutable DataValue
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DataValueUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.Proxy.StaticResponse.Data.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.Proxy.StaticResponse.Strategy.Mutable StrategyValue
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StrategyValueUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.Proxy.StaticResponse.Strategy.Mutable value))
                            {
                                return value;
                            }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new StaticResponse(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    public void SetDataValue(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.Proxy.StaticResponse.Data.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("data");
                        }
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetDataValue<TContext>(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.Proxy.StaticResponse.Data.Source<TContext> value)
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetStrategyValue(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.Proxy.StaticResponse.Strategy.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("strategy");
                        }
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"StaticResponse.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="StaticResponse"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="StaticResponse"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly StaticResponse Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<StaticResponse>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="StaticResponse"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly StaticResponse Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<StaticResponse>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.Proxy.StaticResponse.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(StaticResponse instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.Proxy.StaticResponse.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="StaticResponse"/>.
                    /// </summary>
                    internal static void Create(
                        ref ComplexValueBuilder builder,
                        in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.Proxy.StaticResponse.Data.Source data,
                        in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.Proxy.StaticResponse.Strategy.Source strategy)
                    {
                    ...
                    /// Creates an instance of a <see cref="StaticResponse"/>.
                    /// </summary>
                    public void Create(in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.Proxy.StaticResponse.Data.Source data, in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.Proxy.StaticResponse.Strategy.Source strategy)
                    {
                        Create(ref _builder, data, strategy);
                    }
                    ...
                    internal static void Create<TContext>(
                        in TContext context,
                        ref ComplexValueBuilder builder,
                        in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.Proxy.StaticResponse.Data.Source<TContext> data,
                        in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.Proxy.StaticResponse.Strategy.Source strategy)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    ...
                    #endif
                    {
                        Create(context, ref _builder, data, strategy);
                    }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.Proxy.StaticResponse.Data.Source data, in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.Proxy.StaticResponse.Strategy.Source strategy, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(data, strategy);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.Proxy.StaticResponse.Data.Source<TContext> data, in Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.Proxy.StaticResponse.Strategy.Source strategy, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    ...
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(context, data, strategy);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<StaticResponse, Mutable>(this);
                }
            }
        }
    }
