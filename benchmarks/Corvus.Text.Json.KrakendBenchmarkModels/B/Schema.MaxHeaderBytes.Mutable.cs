...
public readonly partial struct Schema
{
    ...
    public readonly partial struct MaxHeaderBytes
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MaxHeaderBytes instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MaxHeaderBytes"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MaxHeaderBytes(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MaxHeaderBytes.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MaxHeaderBytes Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MaxHeaderBytes Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MaxHeaderBytes>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MaxHeaderBytes instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MaxHeaderBytes, Mutable>(this);
        }
    }
}
