...
public readonly partial struct Schema
{
    ...
    public readonly partial struct MaxHeaderBytes
#if NET8_0_OR_GREATER
        : IJsonElement<MaxHeaderBytes>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MaxHeaderBytes"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal MaxHeaderBytes(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static MaxHeaderBytes DefaultInstance { get; } = ParsedJsonDocument<MaxHeaderBytes>.NumberConstant([.."1000000"u8]);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator long(MaxHeaderBytes value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator double(MaxHeaderBytes value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Corvus.Numerics.BigNumber(MaxHeaderBytes value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator System.Numerics.BigInteger(MaxHeaderBytes value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator decimal(MaxHeaderBytes value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in MaxHeaderBytes left, in MaxHeaderBytes right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in MaxHeaderBytes left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(MaxHeaderBytes instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator MaxHeaderBytes(JsonElement instance)
        {
            return MaxHeaderBytes.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MaxHeaderBytes From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MaxHeaderBytes ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MaxHeaderBytes>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MaxHeaderBytes ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MaxHeaderBytes>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MaxHeaderBytes ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MaxHeaderBytes>(json, options);
        }
        ...
        /// </exception>
        public static MaxHeaderBytes ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<MaxHeaderBytes>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out MaxHeaderBytes? result)
        {
            return JsonElementHelpers.TryParseValue<MaxHeaderBytes>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new MaxHeaderBytes(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static MaxHeaderBytes IJsonElement<MaxHeaderBytes>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"MaxHeaderBytes: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="MaxHeaderBytes"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="MaxHeaderBytes"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public MaxHeaderBytes Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<MaxHeaderBytes>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="MaxHeaderBytes"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public MaxHeaderBytes Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<MaxHeaderBytes>(_idx);
            }
