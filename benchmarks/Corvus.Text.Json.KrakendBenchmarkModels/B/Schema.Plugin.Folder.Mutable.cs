    ...
    public readonly partial struct Plugin
    {
        ...
        public readonly partial struct Folder
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Folder instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Folder"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Folder(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Folder.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly Folder Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Folder>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Folder instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<Folder, Mutable>(this);
            }
        }
    }
}
