...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Plugin
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="Folder"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal Folder(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Folder DefaultInstance { get; } = ParsedJsonDocument<Folder>.StringConstant([.."\"/opt/krakend/plugins/\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(Folder value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in Folder left, in Folder right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Folder left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(Folder instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Folder(JsonElement instance)
            {
                return Folder.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Folder From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Folder ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Folder>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Folder ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Folder>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Folder ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Folder>(json, options);
            }
            ...
            /// </exception>
            public static Folder ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Folder>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Folder? result)
            {
                return JsonElementHelpers.TryParseValue<Folder>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Folder(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static Folder IJsonElement<Folder>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Folder: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Folder"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Folder"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<Folder>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Folder"/> that lives for the lifetime of its
