...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Plugin
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Baseline.Schema.Plugin.Folder.Mutable FolderValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FolderValueUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Plugin.Folder.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Baseline.Schema.Plugin.Pattern.Mutable PatternValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PatternValueUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Plugin.Pattern.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetFolderValue(in Corvus.KrakendBenchmark.Baseline.Schema.Plugin.Folder.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetPatternValue(in Corvus.KrakendBenchmark.Baseline.Schema.Plugin.Pattern.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.KrakendBenchmark.Baseline.Schema.Plugin.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Baseline.Schema.Plugin.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.KrakendBenchmark.Baseline.Schema.Plugin.Folder.Source folder,
                in Corvus.KrakendBenchmark.Baseline.Schema.Plugin.Pattern.Source pattern)
            {
            ...
            /// Creates an instance of a <see cref="Plugin"/>.
            /// </summary>
            public void Create(in Corvus.KrakendBenchmark.Baseline.Schema.Plugin.Folder.Source folder, in Corvus.KrakendBenchmark.Baseline.Schema.Plugin.Pattern.Source pattern)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Baseline.Schema.Plugin.Folder.Source folder, in Corvus.KrakendBenchmark.Baseline.Schema.Plugin.Pattern.Source pattern, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
