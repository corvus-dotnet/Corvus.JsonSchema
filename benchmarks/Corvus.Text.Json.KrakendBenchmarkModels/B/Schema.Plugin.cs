...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        internal Plugin(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Plugin DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Baseline.Schema.Plugin.Folder FolderValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FolderValueUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Plugin.Folder value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Baseline.Schema.Plugin.Folder.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Baseline.Schema.Plugin.Pattern PatternValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PatternValueUtf8, out Corvus.KrakendBenchmark.Baseline.Schema.Plugin.Pattern value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Baseline.Schema.Plugin.Pattern.DefaultInstance;
            }
        }
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Plugin left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Plugin instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Plugin(JsonElement instance)
        {
            return Plugin.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Plugin From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Plugin ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Plugin>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Plugin ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Plugin>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Plugin ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Plugin>(json, options);
        }
        ...
        /// </exception>
        public static Plugin ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Plugin>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Plugin? result)
        {
            return JsonElementHelpers.TryParseValue<Plugin>(ref reader, out result);
        }
...
#if NET
        static Plugin IJsonElement<Plugin>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Plugin: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public Plugin Freeze()
        {
            ...
            {
                return mutable.FreezeElement<Plugin>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="FolderValue"/>.
            /// </summary>
            public const string FolderValue = "folder";
            ...
            /// Gets the JSON property name for <see cref="FolderValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> FolderValueUtf8 => "folder"u8;
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="FolderValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> FolderValue => "folder"u8;
