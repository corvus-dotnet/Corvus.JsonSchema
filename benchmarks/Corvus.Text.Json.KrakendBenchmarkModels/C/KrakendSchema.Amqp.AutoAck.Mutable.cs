    ...
    public readonly partial struct Amqp
    {
        ...
        public readonly partial struct AutoAck
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AutoAck, Mutable>(AutoAck.DefaultInstance);
            ...
            public static ParsedJsonDocument<AutoAck> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AutoAck>();
                }
                finally
                {
