...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Amqp
    {
        ...
        public readonly partial struct Durable
#if NET8_0_OR_GREATER
            : IJsonElement<Durable>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="Durable"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal Durable(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Durable DefaultInstance { get; } = ParsedJsonDocument<Durable>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(Durable value)
            {
            ...
            /// </returns>
            public static bool operator ==(in Durable left, in Durable right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Durable left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(Durable instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Durable(JsonElement instance)
            {
                return Durable.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Durable From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Durable ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Durable>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Durable ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Durable>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Durable ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Durable>(json, options);
            }
            ...
            /// </exception>
            public static Durable ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Durable>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Durable? result)
            {
                return JsonElementHelpers.TryParseValue<Durable>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Durable(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static Durable IJsonElement<Durable>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Durable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Durable"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Durable"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<Durable>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Durable"/> that lives for the lifetime of its
