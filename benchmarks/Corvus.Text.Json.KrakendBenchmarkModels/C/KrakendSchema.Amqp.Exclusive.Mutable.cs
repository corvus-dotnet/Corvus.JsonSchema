    ...
    public readonly partial struct Amqp
    {
        ...
        public readonly partial struct Exclusive
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<Exclusive, Mutable>(Exclusive.DefaultInstance);
                ...
                public static explicit operator Mutable(Exclusive instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Exclusive"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Exclusive(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Exclusive.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly Exclusive Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly Exclusive Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Exclusive>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Exclusive instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<Exclusive, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<Exclusive> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Exclusive>();
                }
                finally
                {
