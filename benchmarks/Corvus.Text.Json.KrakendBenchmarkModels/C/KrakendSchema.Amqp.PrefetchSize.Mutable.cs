    ...
    public readonly partial struct Amqp
    {
        ...
        public readonly partial struct PrefetchSize
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PrefetchSize, Mutable>(PrefetchSize.DefaultInstance);
                ...
                public static explicit operator Mutable(PrefetchSize instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PrefetchSize"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PrefetchSize(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PrefetchSize.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PrefetchSize Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PrefetchSize Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PrefetchSize>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PrefetchSize instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PrefetchSize, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PrefetchSize> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PrefetchSize>();
                }
                finally
                {
