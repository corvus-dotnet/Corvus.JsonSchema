...
public readonly partial struct KrakendSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Amqp"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Amqp(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Amqp DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.AutoAck AutoAckValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AutoAckValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.AutoAck value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.AutoAck.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Delete DeleteValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DeleteValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Delete value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Delete.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Durable DurableValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DurableValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Durable value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Durable.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Exclusive ExclusiveValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExclusiveValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Exclusive value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Exclusive.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.PrefetchCount PrefetchCountValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrefetchCountValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.PrefetchCount value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.PrefetchCount.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.PrefetchSize PrefetchSizeValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrefetchSizeValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.PrefetchSize value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.PrefetchSize.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in Amqp left, in Amqp right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Amqp left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Amqp instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Amqp(JsonElement instance)
        {
            return Amqp.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Amqp From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Amqp ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Amqp>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Amqp ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Amqp>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Amqp ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Amqp>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static Amqp ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Amqp>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Amqp? result)
        {
            return JsonElementHelpers.TryParseValue<Amqp>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Amqp(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Amqp IJsonElement<Amqp>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Amqp: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Amqp"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Amqp"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<Amqp>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Amqp"/> that lives for the lifetime of its
        ...
        public Amqp Freeze()
        {
            ...
            {
                return mutable.FreezeElement<Amqp>(_idx);
            }
        ...
        public static class JsonPropertyNames
        {
            ...
            /// <summary>
            /// Gets the JSON property name for <see cref="PrefetchSizeValue"/>.
            /// </summary>
            public const string PrefetchSizeValue = "prefetch_size";
            ...
            /// Gets the JSON property name for <see cref="PrefetchSizeValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> PrefetchSizeValueUtf8 => "prefetch_size"u8;
        }
        ...
        private static class JsonPropertyNamesEscaped
        {
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="PrefetchSizeValue"/>.
            /// </summary>
