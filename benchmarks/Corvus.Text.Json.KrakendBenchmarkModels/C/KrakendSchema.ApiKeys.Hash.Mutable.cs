    ...
    public readonly partial struct ApiKeys
    {
        ...
        public readonly partial struct Hash
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<Hash, Mutable>(Hash.DefaultInstance);
                ...
                public static explicit operator Mutable(Hash instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Hash"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Hash(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Hash.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly Hash Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Hash>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Hash instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (Hash)value;
            ...
            {
                return workspace.CreateBuilder<Hash, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<Hash> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Hash>();
                }
                finally
                {
