...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct ApiKeys
    {
...
#endif
        {
            ...
            internal Hash(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Hash DefaultInstance { get; } = ParsedJsonDocument<Hash>.StringConstant([.."\"plain\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(Hash value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in Hash left, in Hash right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Hash left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(Hash instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Hash(JsonElement instance)
            {
                return Hash.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Hash From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Hash ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Hash>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Hash ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Hash>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Hash ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Hash>(json, options);
            }
            ...
            /// </exception>
            public static Hash ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Hash>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Hash? result)
            {
                return JsonElementHelpers.TryParseValue<Hash>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Hash(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static Hash IJsonElement<Hash>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Hash: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Hash"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Hash"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<Hash>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Hash"/> that lives for the lifetime of its
            ...
            public Hash Freeze()
            {
                ...
                {
                    return mutable.FreezeElement<Hash>(_idx);
                }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Func<TContext, TResult> matchFnv128,
                Func<TContext, TResult> matchSha256,
                Func<TContext, TResult> matchSha1,
            ...
            public TResult Match<TResult>(
                ...
                Func<TResult> matchFnv128,
                Func<TResult> matchSha256,
                Func<TResult> matchSha1,
