        ...
        public readonly partial struct KeysEntityArray
        {
            ...
            public readonly partial struct KeysEntity
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity.JsonStringArray.Mutable Roles
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RolesUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity.JsonStringArray.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetRoles(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity.JsonStringArray.Source value)
                    {
                        ...
                        {
                            // We are going to insert the new value
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Roles, ref cvb);
                            int endIndex = _idx + _parent.GetDbSize(_idx, false);
                            _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                        }
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetRoles<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity.JsonStringArray.Source<TContext> value)
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity.JsonStringArray.Source _createArg2;
                    ...
                    #endif
                {
                    ...
                    private readonly Corvus.KrakendBenchmark.Current.JsonString.Source _createArg1;
                    private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity.JsonStringArray.Source<TContext> _createArg2;
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity.JsonStringArray.Source roles = default)
                    {
                        key.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Key, ref builder);
                        roles.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Roles, ref builder);
                    }

                    /// <summary>
                    /// Creates an instance of a <see cref="KeysEntity"/>.
                    /// </summary>
                    public void Create(in Corvus.KrakendBenchmark.Current.JsonString.Source key = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity.JsonStringArray.Source roles = default)
                    {
                    ...
                    internal static void Create<TContext>(
                        ...
                        ref ComplexValueBuilder builder,
                        in Corvus.KrakendBenchmark.Current.JsonString.Source key = default,
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity.JsonStringArray.Source<TContext> roles = default)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    {
                ...
                public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source key = default, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity.JsonStringArray.Source<TContext> roles = default)
                    ...
                    #endif
                {
                    return new Source<TContext>(context, key, roles);
                }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonString.Source key = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity.JsonStringArray.Source roles = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.JsonString.Source key = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity.JsonStringArray.Source<TContext> roles = default, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                ...
                public static ParsedJsonDocument<KeysEntity> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source key = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity.JsonStringArray.Source roles = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                public static ParsedJsonDocument<KeysEntity> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.JsonString.Source key = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity.JsonStringArray.Source<TContext> roles = default, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
