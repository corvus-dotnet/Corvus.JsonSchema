    ...
    public readonly partial struct ApiKeys
    {
        ...
        public readonly partial struct KeysEntityArray
        {
...
#endif
            {
                ...
                public Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity.Mutable>(_parent, _idx);
                }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity oldItem, in Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity current = enumerator.Current;
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                public void AddItem(in Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity.Source value)
                {
                ...
                /// Add an item to the array.
                /// </summary>
                public void AddItem<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            public static ParsedJsonDocument<KeysEntityArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<KeysEntityArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<KeysEntityArray> Create<TContext>(
