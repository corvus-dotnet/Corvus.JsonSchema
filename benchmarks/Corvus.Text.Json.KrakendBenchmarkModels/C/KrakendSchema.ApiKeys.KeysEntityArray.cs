...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct ApiKeys
    {
...
#endif
        {
            ...
            public Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray.KeysEntity>(_parent, _idx);
            }
