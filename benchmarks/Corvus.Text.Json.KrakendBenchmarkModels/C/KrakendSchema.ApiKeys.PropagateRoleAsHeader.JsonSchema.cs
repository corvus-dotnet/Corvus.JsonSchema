    ...
    public readonly partial struct ApiKeys
    {
            ...
            : IJsonElement<PropagateRoleAsHeader>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1auth~1api-keys.json/properties/propagate_role"u8, buffer, out written);
