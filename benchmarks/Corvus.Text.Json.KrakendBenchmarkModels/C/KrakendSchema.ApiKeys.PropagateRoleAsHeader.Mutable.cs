    ...
    public readonly partial struct ApiKeys
    {
        ...
        public readonly partial struct PropagateRoleAsHeader
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PropagateRoleAsHeader, Mutable>(PropagateRoleAsHeader.DefaultInstance);
            ...
            public static ParsedJsonDocument<PropagateRoleAsHeader> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PropagateRoleAsHeader>();
                }
                finally
                {
