    ...
    public readonly partial struct ApiKeys
    {
        ...
        public readonly partial struct Salt
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<Salt, Mutable>(Salt.DefaultInstance);
                ...
                public static explicit operator Mutable(Salt instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Salt"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Salt(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Salt.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly Salt Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Salt>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Salt instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<Salt, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<Salt> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Salt>();
                }
                finally
                {
