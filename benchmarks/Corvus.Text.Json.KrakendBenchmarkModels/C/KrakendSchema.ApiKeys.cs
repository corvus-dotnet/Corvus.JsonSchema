...
public readonly partial struct KrakendSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiKeys"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ApiKeys(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ApiKeys DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.Hash HashValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HashValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.Hash value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.Hash.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.Identifier IdentifierValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdentifierValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.Identifier value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.Identifier.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray Keys
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KeysUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.KeysEntityArray value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.PropagateRoleAsHeader PropagateRole
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PropagateRoleUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.PropagateRoleAsHeader value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.PropagateRoleAsHeader.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.Salt SaltValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SaltValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.Salt value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.Salt.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.Strategy StrategyValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StrategyValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.Strategy value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.ApiKeys.Strategy.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in ApiKeys left, in ApiKeys right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ApiKeys left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ApiKeys instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ApiKeys(JsonElement instance)
        {
            return ApiKeys.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ApiKeys From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ApiKeys ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ApiKeys>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ApiKeys ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ApiKeys>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ApiKeys ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ApiKeys>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static ApiKeys ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ApiKeys>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ApiKeys? result)
        {
            return JsonElementHelpers.TryParseValue<ApiKeys>(ref reader, out result);
        }
...
#if NET
        static ApiKeys IJsonElement<ApiKeys>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ApiKeys: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="HashValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> HashValue => [0x65, 0x00, 0x00, 0x00, 0x22, 0x68, 0x61, 0x73, 0x68, 0x22];

            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="IdentifierValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> IdentifierValue => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x69, 0x64, 0x65, 0x6E, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x22];
            ...
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="PropagateRole"/>.
            /// </summary>
            public static ReadOnlySpan<byte> PropagateRole => [0x05, 0x01, 0x00, 0x00, 0x22, 0x70, 0x72, 0x6F, 0x70, 0x61, 0x67, 0x61, 0x74, 0x65, 0x5F, 0x72, 0x6F, 0x6C, 0x65, 0x22];

            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="SaltValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> SaltValue => [0x65, 0x00, 0x00, 0x00, 0x22, 0x73, 0x61, 0x6C, 0x74, 0x22];
