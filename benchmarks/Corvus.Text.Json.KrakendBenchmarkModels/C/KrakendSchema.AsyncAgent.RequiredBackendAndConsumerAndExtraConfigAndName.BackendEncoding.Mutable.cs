        ...
        public readonly partial struct RequiredBackendAndConsumerAndExtraConfigAndName
        {
            ...
            public readonly partial struct BackendEncoding
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<BackendEncoding, Mutable>(BackendEncoding.DefaultInstance);
                    ...
                    public static explicit operator Mutable(BackendEncoding instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="BackendEncoding"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator BackendEncoding(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"BackendEncoding.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly BackendEncoding Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly BackendEncoding Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<BackendEncoding>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(BackendEncoding instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (BackendEncoding)value;
                ...
                {
                    return workspace.CreateBuilder<BackendEncoding, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<BackendEncoding> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<BackendEncoding>();
                    }
                    finally
                    {
