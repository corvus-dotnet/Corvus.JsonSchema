                ...
                public static partial class JsonSchema
                {
                    ...
                    private static void MatchBackoffStrategyValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                    {
                        ...
                        JsonSchemaContext childContext =
                            Corvus.KrakendBenchmark.Current.KrakendSchema.AsyncAgent.RequiredBackendAndConsumerAndExtraConfigAndName.Connection.BackoffStrategy.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                        ...
                        Corvus.KrakendBenchmark.Current.KrakendSchema.AsyncAgent.RequiredBackendAndConsumerAndExtraConfigAndName.Connection.BackoffStrategy.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                        context.CommitChildContext(childContext.IsMatch, ref childContext);
                    }

                    private static void MatchHealthInterval(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                    ...
                    private static void MatchMaxRetriesValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                    {
                        ...
                        JsonSchemaContext childContext2 =
                            Corvus.KrakendBenchmark.Current.KrakendSchema.AsyncAgent.RequiredBackendAndConsumerAndExtraConfigAndName.Connection.MaxRetries.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                        ...
                        Corvus.KrakendBenchmark.Current.KrakendSchema.AsyncAgent.RequiredBackendAndConsumerAndExtraConfigAndName.Connection.MaxRetries.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
