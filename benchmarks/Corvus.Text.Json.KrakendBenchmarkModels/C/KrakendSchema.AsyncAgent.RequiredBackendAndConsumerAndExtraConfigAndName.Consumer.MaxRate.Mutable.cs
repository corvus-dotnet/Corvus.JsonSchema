    ...
    public readonly partial struct AsyncAgent
    {
        ...
        public readonly partial struct RequiredBackendAndConsumerAndExtraConfigAndName
        {
            ...
            public readonly partial struct Consumer
            {
                ...
                public readonly partial struct MaxRate
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MaxRate, Mutable>(MaxRate.DefaultInstance);
                        ...
                        public static explicit operator Mutable(MaxRate instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="MaxRate"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator MaxRate(Mutable instance)
                        {
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new MaxRate(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"MaxRate.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="MaxRate"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="MaxRate"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly MaxRate Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<MaxRate>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="MaxRate"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly MaxRate Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<MaxRate>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(MaxRate instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<MaxRate, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<MaxRate> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<MaxRate>();
                        }
                        finally
                        {
