        ...
        public readonly partial struct RequiredBackendAndConsumerAndExtraConfigAndName
        {
            ...
            public readonly partial struct RequiredAsyncAmqp
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RequiredAsyncAmqp instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RequiredAsyncAmqp"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredAsyncAmqp(Mutable instance)
                    {
                    ...
                    /// <summary>
                    /// Gets the <c>async/amqp</c> property.
                    /// Async Agent extra configuration
                    /// </summary>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Mutable AsyncAmqp
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AsyncAmqpUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Mutable value))
                            {
                                return value;
                            }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RequiredAsyncAmqp(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    /// <summary>
                    /// Set the <c>async/amqp</c> property.
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetAsyncAmqp(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("async/amqp");
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AsyncAmqpUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                        ...
                        else
                        {
                            ...
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AsyncAmqp, ref cvb);
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetAsyncAmqp<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Source<TContext> value)
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredAsyncAmqp.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RequiredAsyncAmqp"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RequiredAsyncAmqp"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredAsyncAmqp Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RequiredAsyncAmqp>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RequiredAsyncAmqp"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredAsyncAmqp Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RequiredAsyncAmqp>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Source _createArg1;
                    ...
                    internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.AsyncAgent.RequiredBackendAndConsumerAndExtraConfigAndName.RequiredAsyncAmqp.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Source arg1)
                    {
                        _createArg1 = arg1;
                        _kind = Kind.Create;
                    }

                    public static implicit operator Source(RequiredAsyncAmqp instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Source<TContext> _createArg1;
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.AsyncAgent.RequiredBackendAndConsumerAndExtraConfigAndName.RequiredAsyncAmqp.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Source<TContext> arg1)
                    {
                        _context = context;
                        _createArg1 = arg1;
                        _kind = Kind.Create;
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="RequiredAsyncAmqp"/>.
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Source asyncAmqp)
                    {
                        asyncAmqp.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AsyncAmqp, ref builder);
                    }

                    /// <summary>
                    /// Creates an instance of a <see cref="RequiredAsyncAmqp"/>.
                    /// </summary>
                    public void Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Source asyncAmqp)
                    {
                        Create(ref _builder, asyncAmqp);
                    }
                    ...
                    internal static void Create<TContext>(
                        ...
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Source<TContext> asyncAmqp)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    {
                    ...
                    /// Creates an instance of a <see cref="RequiredAsyncAmqp"/>.
                    /// </summary>
                    public void Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Source<TContext> asyncAmqp)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    {
                        Create(context, ref _builder, asyncAmqp);
                    }
                    ...
                    internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Source arg1, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                        Create(ref o, arg1);
                        o.EndObject();
                    ...
                    /// <param name="arg1">The value of the property.</param>
                    /// <param name="o">The complex value builder into which to write the object.</param>
                    internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Source<TContext> arg1, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                        where TContext : allows ref struct
#endif
                    {
                ...
                /// </summary>
                /// <param name="asyncAmqp">The value of the <c>"async/amqp"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Source asyncAmqp)
                {
                    return new Source(asyncAmqp);
                }
                ...
                /// <param name="asyncAmqp">The value of the <c>"async/amqp"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Source<TContext> asyncAmqp)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    return new Source<TContext>(context, asyncAmqp);
                }
                ...
                /// </summary>
                /// <param name="workspace">The JSON workspace.</param>
                /// <param name="asyncAmqp">The value of the property.</param>
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Source asyncAmqp, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(asyncAmqp);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Source<TContext> asyncAmqp, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                ...
                {
                    return workspace.CreateBuilder<RequiredAsyncAmqp, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<RequiredAsyncAmqp> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RequiredAsyncAmqp>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredAsyncAmqp> Create<TContext>(
                ...
                public static ParsedJsonDocument<RequiredAsyncAmqp> Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Source asyncAmqp, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredAsyncAmqp> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp.Source<TContext> asyncAmqp, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
