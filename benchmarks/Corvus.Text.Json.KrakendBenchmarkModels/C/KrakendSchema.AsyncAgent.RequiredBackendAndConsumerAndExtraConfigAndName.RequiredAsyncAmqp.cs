    ...
    public readonly partial struct AsyncAgent
    {
        ...
        public readonly partial struct RequiredBackendAndConsumerAndExtraConfigAndName
        {
...
#endif
            {
                ...
                internal RequiredAsyncAmqp(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp AsyncAmqp
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AsyncAmqpUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Amqp value))
                        {
                            return value;
                        }
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in RequiredAsyncAmqp left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(RequiredAsyncAmqp instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredAsyncAmqp(JsonElement instance)
                {
                    return RequiredAsyncAmqp.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredAsyncAmqp From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredAsyncAmqp ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredAsyncAmqp>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredAsyncAmqp ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredAsyncAmqp>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredAsyncAmqp ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredAsyncAmqp>(json, options);
                }
                ...
                /// </exception>
                public static RequiredAsyncAmqp ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<RequiredAsyncAmqp>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredAsyncAmqp? result)
                {
                    return JsonElementHelpers.TryParseValue<RequiredAsyncAmqp>(ref reader, out result);
                }
...
#if NET
                static RequiredAsyncAmqp IJsonElement<RequiredAsyncAmqp>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredAsyncAmqp: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public RequiredAsyncAmqp Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public RequiredAsyncAmqp Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<RequiredAsyncAmqp>(_idx);
                    }
                ...
                {
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="AsyncAmqp"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> AsyncAmqp => "async/amqp"u8;
                }
                ...
                {
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="AsyncAmqp"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> AsyncAmqp => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x61, 0x73, 0x79, 0x6E, 0x63, 0x2F, 0x61, 0x6D, 0x71, 0x70, 0x22];
                }
            }
        }
    }
