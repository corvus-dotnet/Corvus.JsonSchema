...
public readonly partial struct KrakendSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AsyncAgent"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal AsyncAgent(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static AsyncAgent DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in AsyncAgent left, in AsyncAgent right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in AsyncAgent left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(AsyncAgent instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AsyncAgent(JsonElement instance)
        {
            return AsyncAgent.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AsyncAgent From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AsyncAgent ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AsyncAgent>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AsyncAgent ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AsyncAgent>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AsyncAgent ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AsyncAgent>(json, options);
        }
        ...
        /// </exception>
        public static AsyncAgent ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<AsyncAgent>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out AsyncAgent? result)
        {
            return JsonElementHelpers.TryParseValue<AsyncAgent>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AsyncAgent(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static AsyncAgent IJsonElement<AsyncAgent>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AsyncAgent: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AsyncAgent"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AsyncAgent"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public AsyncAgent Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AsyncAgent>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AsyncAgent"/> that lives for the lifetime of its
