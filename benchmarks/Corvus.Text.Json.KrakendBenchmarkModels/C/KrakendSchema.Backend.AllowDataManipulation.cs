...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Backend
    {
        ...
        public readonly partial struct AllowDataManipulation
#if NET8_0_OR_GREATER
            : IJsonElement<AllowDataManipulation>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AllowDataManipulation"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal AllowDataManipulation(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AllowDataManipulation DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in AllowDataManipulation left, in AllowDataManipulation right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AllowDataManipulation left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(AllowDataManipulation instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AllowDataManipulation(JsonElement instance)
            {
                return AllowDataManipulation.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllowDataManipulation From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllowDataManipulation ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllowDataManipulation>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllowDataManipulation ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllowDataManipulation>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllowDataManipulation ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllowDataManipulation>(json, options);
            }
            ...
            /// </exception>
            public static AllowDataManipulation ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<AllowDataManipulation>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AllowDataManipulation? result)
            {
                return JsonElementHelpers.TryParseValue<AllowDataManipulation>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new AllowDataManipulation(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static AllowDataManipulation IJsonElement<AllowDataManipulation>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AllowDataManipulation: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="AllowDataManipulation"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="AllowDataManipulation"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public AllowDataManipulation Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<AllowDataManipulation>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="AllowDataManipulation"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public AllowDataManipulation Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<AllowDataManipulation>(_idx);
                }
