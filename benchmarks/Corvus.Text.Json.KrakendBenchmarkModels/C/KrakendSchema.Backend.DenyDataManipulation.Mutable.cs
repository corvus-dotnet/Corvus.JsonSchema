    ...
    public readonly partial struct Backend
    {
        ...
        public readonly partial struct DenyDataManipulation
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DenyDataManipulation instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DenyDataManipulation"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DenyDataManipulation(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DenyDataManipulation.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public readonly DenyDataManipulation Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DenyDataManipulation Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DenyDataManipulation>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Backend.DenyDataManipulation.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(DenyDataManipulation instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Backend.DenyDataManipulation.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<DenyDataManipulation, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DenyDataManipulation> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DenyDataManipulation>();
                }
                finally
                {
