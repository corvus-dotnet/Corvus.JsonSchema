    ...
    public readonly partial struct Backend
    {
        ...
        public readonly partial struct DisableHostSanitize
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableHostSanitize, Mutable>(DisableHostSanitize.DefaultInstance);
            ...
            public static ParsedJsonDocument<DisableHostSanitize> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DisableHostSanitize>();
                }
                finally
                {
