    ...
    public readonly partial struct Backend
    {
        ...
        public readonly partial struct GroupDataManipulation
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<GroupDataManipulation, Mutable>(GroupDataManipulation.DefaultInstance);
                ...
                public static explicit operator Mutable(GroupDataManipulation instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="GroupDataManipulation"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator GroupDataManipulation(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"GroupDataManipulation.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly GroupDataManipulation Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly GroupDataManipulation Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<GroupDataManipulation>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(GroupDataManipulation instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<GroupDataManipulation, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<GroupDataManipulation> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<GroupDataManipulation>();
                }
                finally
                {
