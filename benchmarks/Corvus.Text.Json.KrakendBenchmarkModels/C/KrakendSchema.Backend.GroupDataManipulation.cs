...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Backend
    {
        ...
        public readonly partial struct GroupDataManipulation
#if NET8_0_OR_GREATER
            : IJsonElement<GroupDataManipulation>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="GroupDataManipulation"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal GroupDataManipulation(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static GroupDataManipulation DefaultInstance { get; } = ParsedJsonDocument<GroupDataManipulation>.StringConstant([.."\"backend1\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(GroupDataManipulation value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in GroupDataManipulation left, in GroupDataManipulation right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in GroupDataManipulation left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(GroupDataManipulation instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator GroupDataManipulation(JsonElement instance)
            {
                return GroupDataManipulation.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static GroupDataManipulation From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static GroupDataManipulation ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<GroupDataManipulation>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static GroupDataManipulation ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<GroupDataManipulation>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static GroupDataManipulation ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<GroupDataManipulation>(json, options);
            }
            ...
            /// </exception>
            public static GroupDataManipulation ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<GroupDataManipulation>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out GroupDataManipulation? result)
            {
                return JsonElementHelpers.TryParseValue<GroupDataManipulation>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new GroupDataManipulation(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static GroupDataManipulation IJsonElement<GroupDataManipulation>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"GroupDataManipulation: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="GroupDataManipulation"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="GroupDataManipulation"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public GroupDataManipulation Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<GroupDataManipulation>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="GroupDataManipulation"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public GroupDataManipulation Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<GroupDataManipulation>(_idx);
                }
