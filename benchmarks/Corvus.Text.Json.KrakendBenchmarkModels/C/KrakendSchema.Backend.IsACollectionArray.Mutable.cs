    ...
    public readonly partial struct Backend
    {
        ...
        public readonly partial struct IsACollectionArray
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<IsACollectionArray, Mutable>(IsACollectionArray.DefaultInstance);
            ...
            public static ParsedJsonDocument<IsACollectionArray> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<IsACollectionArray>();
                }
                finally
                {
