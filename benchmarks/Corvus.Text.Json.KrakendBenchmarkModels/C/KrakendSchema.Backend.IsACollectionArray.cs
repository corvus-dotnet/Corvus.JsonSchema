...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Backend
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="IsACollectionArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal IsACollectionArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static IsACollectionArray DefaultInstance { get; } = ParsedJsonDocument<IsACollectionArray>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(IsACollectionArray value)
            {
            ...
            /// </returns>
            public static bool operator ==(in IsACollectionArray left, in IsACollectionArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in IsACollectionArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(IsACollectionArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator IsACollectionArray(JsonElement instance)
            {
                return IsACollectionArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IsACollectionArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IsACollectionArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IsACollectionArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IsACollectionArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IsACollectionArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IsACollectionArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IsACollectionArray>(json, options);
            }
            ...
            /// </exception>
            public static IsACollectionArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<IsACollectionArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out IsACollectionArray? result)
            {
                return JsonElementHelpers.TryParseValue<IsACollectionArray>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new IsACollectionArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static IsACollectionArray IJsonElement<IsACollectionArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"IsACollectionArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="IsACollectionArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="IsACollectionArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public IsACollectionArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<IsACollectionArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="IsACollectionArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public IsACollectionArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<IsACollectionArray>(_idx);
                }
