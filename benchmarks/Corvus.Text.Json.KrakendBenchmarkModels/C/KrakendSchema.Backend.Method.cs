...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Backend
    {
...
#endif
        {
            ...
            internal Method(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Method DefaultInstance { get; } = ParsedJsonDocument<Method>.StringConstant([.."\"GET\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(Method value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in Method left, in Method right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Method left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(Method instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Method(JsonElement instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Method From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Method ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Method>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Method ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Method>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Method ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Method>(json, options);
            }
            ...
            /// </exception>
            public static Method ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Method>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Method? result)
            {
                return JsonElementHelpers.TryParseValue<Method>(ref reader, out result);
            }
...
#if NET
            static Method IJsonElement<Method>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Method: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public Method Freeze()
            {
                ...
                {
                    return mutable.FreezeElement<Method>(_idx);
                }
