    ...
    public readonly partial struct Backend
    {
        ...
        public readonly partial struct ServiceDiscovery
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ServiceDiscovery, Mutable>(ServiceDiscovery.DefaultInstance);
                ...
                public static explicit operator Mutable(ServiceDiscovery instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ServiceDiscovery"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ServiceDiscovery(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ServiceDiscovery.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ServiceDiscovery Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ServiceDiscovery Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ServiceDiscovery>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ServiceDiscovery instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (ServiceDiscovery)value;
            ...
            {
                return workspace.CreateBuilder<ServiceDiscovery, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ServiceDiscovery> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ServiceDiscovery>();
                }
                finally
                {
