...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Backend
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ServiceDiscovery"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ServiceDiscovery(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ServiceDiscovery DefaultInstance { get; } = ParsedJsonDocument<ServiceDiscovery>.StringConstant([.."\"static\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ServiceDiscovery value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in ServiceDiscovery left, in ServiceDiscovery right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ServiceDiscovery left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ServiceDiscovery instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ServiceDiscovery(JsonElement instance)
            {
                return ServiceDiscovery.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ServiceDiscovery From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ServiceDiscovery ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ServiceDiscovery>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ServiceDiscovery ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ServiceDiscovery>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ServiceDiscovery ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ServiceDiscovery>(json, options);
            }
            ...
            /// </exception>
            public static ServiceDiscovery ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ServiceDiscovery>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ServiceDiscovery? result)
            {
                return JsonElementHelpers.TryParseValue<ServiceDiscovery>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ServiceDiscovery(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ServiceDiscovery IJsonElement<ServiceDiscovery>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ServiceDiscovery: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ServiceDiscovery"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ServiceDiscovery"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<ServiceDiscovery>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ServiceDiscovery"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ServiceDiscovery Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ServiceDiscovery>(_idx);
                }
            ...
            /// <param name="matchStatic">Match 1st item.</param>
            /// <param name="matchDns">Match 2nd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchStatic,
                Func<TContext, TResult> matchDns,
