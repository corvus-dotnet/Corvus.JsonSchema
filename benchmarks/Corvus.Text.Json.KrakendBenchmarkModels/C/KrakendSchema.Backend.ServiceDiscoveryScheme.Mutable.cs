    ...
    public readonly partial struct Backend
    {
        ...
        public readonly partial struct ServiceDiscoveryScheme
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ServiceDiscoveryScheme, Mutable>(ServiceDiscoveryScheme.DefaultInstance);
            ...
            public static ParsedJsonDocument<ServiceDiscoveryScheme> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ServiceDiscoveryScheme>();
                }
                finally
                {
