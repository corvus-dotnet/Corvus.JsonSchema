...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Backend
    {
        ...
        public readonly partial struct ServiceDiscoveryScheme
#if NET8_0_OR_GREATER
            : IJsonElement<ServiceDiscoveryScheme>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ServiceDiscoveryScheme"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ServiceDiscoveryScheme(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ServiceDiscoveryScheme DefaultInstance { get; } = ParsedJsonDocument<ServiceDiscoveryScheme>.StringConstant([.."\"http\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ServiceDiscoveryScheme value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in ServiceDiscoveryScheme left, in ServiceDiscoveryScheme right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ServiceDiscoveryScheme left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ServiceDiscoveryScheme instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ServiceDiscoveryScheme(JsonElement instance)
            {
                return ServiceDiscoveryScheme.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ServiceDiscoveryScheme From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ServiceDiscoveryScheme ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ServiceDiscoveryScheme>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ServiceDiscoveryScheme ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ServiceDiscoveryScheme>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ServiceDiscoveryScheme ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ServiceDiscoveryScheme>(json, options);
            }
            ...
            /// </exception>
            public static ServiceDiscoveryScheme ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ServiceDiscoveryScheme>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ServiceDiscoveryScheme? result)
            {
                return JsonElementHelpers.TryParseValue<ServiceDiscoveryScheme>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ServiceDiscoveryScheme(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ServiceDiscoveryScheme IJsonElement<ServiceDiscoveryScheme>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ServiceDiscoveryScheme: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ServiceDiscoveryScheme"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ServiceDiscoveryScheme"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ServiceDiscoveryScheme Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ServiceDiscoveryScheme>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ServiceDiscoveryScheme"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ServiceDiscoveryScheme Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ServiceDiscoveryScheme>(_idx);
                }
