        ...
        public readonly partial struct Backend1httpEntity
        {
            ...
            public readonly partial struct RequiredReturnErrorCode
            {
...
#endif
                {
                    ...
                    public void SetReturnErrorCode(in Corvus.Text.Json.JsonElement.Source value)
                    {
                        CheckValidInstance();
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(in Corvus.Text.Json.JsonElement.Source returnErrorCode)
                {
                ...
                /// <param name="returnErrorCode">The value of the <c>"return_error_code"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> returnErrorCode)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
