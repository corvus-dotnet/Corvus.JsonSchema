        ...
        public readonly partial struct Backend1httpEntity
        {
                ...
                : IJsonElement<RequiredReturnErrorDetails>
            {
                public static partial class JsonSchema
                {
                    ...
                    private static void MatchReturnErrorDetails(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                    {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend_extra_config.json/properties/backend~1http/oneOf/0"u8, buffer, out written);
