        ...
        public readonly partial struct Backend1httpEntity
        {
            ...
            public readonly partial struct RequiredReturnErrorDetails
            {
...
#endif
                {
                    ...
                    public void SetReturnErrorDetails(in Corvus.Text.Json.JsonElement.Source value)
                    {
                        CheckValidInstance();
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(in Corvus.Text.Json.JsonElement.Source returnErrorDetails)
                {
                ...
                /// <param name="returnErrorDetails">The value of the <c>"return_error_details"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> returnErrorDetails)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
