        ...
        public readonly partial struct Backend1httpEntity
        {
            ...
            public readonly partial struct RequiredReturnErrorDetails
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RequiredReturnErrorDetails instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RequiredReturnErrorDetails"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredReturnErrorDetails(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Text.Json.JsonElement.Mutable ReturnErrorDetails
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReturnErrorDetailsUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                            {
                                return value;
                            }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RequiredReturnErrorDetails(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    public void SetReturnErrorDetails(scoped in Corvus.Text.Json.JsonElement.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("return_error_details");
                        }
                        ...
                        else
                        {
                            ...
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ReturnErrorDetails, ref cvb);
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetReturnErrorDetails<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredReturnErrorDetails.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RequiredReturnErrorDetails"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RequiredReturnErrorDetails"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredReturnErrorDetails Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RequiredReturnErrorDetails>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RequiredReturnErrorDetails"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredReturnErrorDetails Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RequiredReturnErrorDetails>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.BackendExtraConfig.Backend1httpEntity.RequiredReturnErrorDetails.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public static implicit operator Source(RequiredReturnErrorDetails instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.BackendExtraConfig.Backend1httpEntity.RequiredReturnErrorDetails.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.JsonElement.Source returnErrorDetails)
                    {
                        returnErrorDetails.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ReturnErrorDetails, ref builder);
                    }

                    /// <summary>
                    /// Creates an instance of a <see cref="RequiredReturnErrorDetails"/>.
                    /// </summary>
                    public void Create(in Corvus.Text.Json.JsonElement.Source returnErrorDetails)
                    {
                        Create(ref _builder, returnErrorDetails);
                    }
                    ...
                    internal static void Create<TContext>(
                        ...
                        in Corvus.Text.Json.JsonElement.Source<TContext> returnErrorDetails)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    {
                    ...
                    /// Creates an instance of a <see cref="RequiredReturnErrorDetails"/>.
                    /// </summary>
                    public void Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> returnErrorDetails)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    {
                        Create(context, ref _builder, returnErrorDetails);
                    }
                ...
                /// </summary>
                /// <param name="returnErrorDetails">The value of the <c>"return_error_details"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.Text.Json.JsonElement.Source returnErrorDetails)
                {
                    return new Source(returnErrorDetails);
                }
                ...
                /// <param name="returnErrorDetails">The value of the <c>"return_error_details"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> returnErrorDetails)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    return new Source<TContext>(context, returnErrorDetails);
                }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source returnErrorDetails, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(returnErrorDetails);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> returnErrorDetails, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    ...
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(context, returnErrorDetails);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<RequiredReturnErrorDetails, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<RequiredReturnErrorDetails> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RequiredReturnErrorDetails>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredReturnErrorDetails> Create<TContext>(
                ...
                public static ParsedJsonDocument<RequiredReturnErrorDetails> Create(in Corvus.Text.Json.JsonElement.Source returnErrorDetails, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredReturnErrorDetails> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> returnErrorDetails, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
