...
public readonly partial struct KrakendSchema
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct Basic
    {
        /// <summary>
        /// Additional users
        /// </summary>
        ...
        public readonly partial struct AdditionalUsers
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AdditionalUsers instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AdditionalUsers"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AdditionalUsers(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AdditionalUsers.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AdditionalUsers Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AdditionalUsers Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AdditionalUsers>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(AdditionalUsers instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<AdditionalUsers, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AdditionalUsers> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AdditionalUsers>();
                }
                finally
                {
