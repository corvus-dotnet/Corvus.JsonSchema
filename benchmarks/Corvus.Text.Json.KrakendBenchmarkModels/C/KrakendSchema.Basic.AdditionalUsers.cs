...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Basic
    {
...
#endif
        {
            ...
            /// <see cref="Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Entity"/>.
            /// </summary>
            ...
            /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
            public static bool TryAsPatternEntity(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Entity result)
            {
                if (MatchesPatternEntity(propertyName))
                {
                    result = Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Entity.From(value);
                    return true;
                }
            ...
            public interface IPatternPropertyVisitor<TState>
            {
                ...
                /// </summary>
                bool VisitPatternEntity(ReadOnlySpan<byte> name, in Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Entity value, ref TState state);
                ...
                where TVisitor : IPatternPropertyVisitor<TState>
            {
                ...
                foreach (var property in EnumerateObject())
                {
                    ...
                    {
                        matched = true;
                        Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Entity typedValue = Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Entity.From(property.Value);
