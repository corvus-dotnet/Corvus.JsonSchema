...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Basic
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Basic instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Basic"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Basic(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Mutable Users
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UsersUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetHtpasswdPath(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetUsers(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetUsers<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Source<TContext> value)
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Basic.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Basic Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Basic>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Source _createArg2;
            ...
            internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            public static implicit operator Source(Basic instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.KrakendBenchmark.Current.JsonString.Source _createArg1;
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Source<TContext> _createArg2;
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Source<TContext> arg2)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Basic"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.KrakendBenchmark.Current.JsonString.Source htpasswdPath = default,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Source users = default)
            {
            ...
            /// Creates an instance of a <see cref="Basic"/>.
            /// </summary>
            public void Create(in Corvus.KrakendBenchmark.Current.JsonString.Source htpasswdPath = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Source users = default)
            {
            ...
            internal static void Create<TContext>(
                ...
                ref ComplexValueBuilder builder,
                in Corvus.KrakendBenchmark.Current.JsonString.Source htpasswdPath = default,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Source<TContext> users = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
            ...
            /// <param name="arg2">The value of the property.</param>
            /// <param name="o">The complex value builder into which to write the object.</param>
            internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Source<TContext> arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        /// </summary>
        /// <param name="htpasswdPath">The value of the <c>"htpasswd_path"</c> property.</param>
        /// <param name="users">The value of the <c>"users"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source htpasswdPath = default, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Source users = default)
        {
            return new Source(htpasswdPath, users);
        }
        ...
        /// <param name="users">The value of the <c>"users"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source htpasswdPath = default, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Source<TContext> users = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Source<TContext>(context, htpasswdPath, users);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonString.Source htpasswdPath = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Source users = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.JsonString.Source htpasswdPath = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Source<TContext> users = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        {
            return workspace.CreateBuilder<Basic, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Basic> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Basic>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Basic> Create<TContext>(
        ...
        public static ParsedJsonDocument<Basic> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source htpasswdPath = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Source users = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Basic> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.JsonString.Source htpasswdPath = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers.Source<TContext> users = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
