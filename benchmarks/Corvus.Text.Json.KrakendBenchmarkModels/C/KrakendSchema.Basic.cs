...
public readonly partial struct KrakendSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Basic"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Basic(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Basic DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.JsonString HtpasswdPath
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HtpasswdPathUtf8, out Corvus.KrakendBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers Users
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UsersUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Basic.AdditionalUsers value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in Basic left, in Basic right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Basic left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Basic instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Basic(JsonElement instance)
        {
            return Basic.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Basic From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Basic ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Basic>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Basic ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Basic>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Basic ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Basic>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static Basic ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Basic>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Basic? result)
        {
            return JsonElementHelpers.TryParseValue<Basic>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Basic(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Basic IJsonElement<Basic>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Basic: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Basic"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Basic"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<Basic>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Basic"/> that lives for the lifetime of its
        ...
        public Basic Freeze()
        {
            ...
            {
                return mutable.FreezeElement<Basic>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="HtpasswdPath"/>.
            /// </summary>
            public static ReadOnlySpan<byte> HtpasswdPath => [0xF5, 0x00, 0x00, 0x00, 0x22, 0x68, 0x74, 0x70, 0x61, 0x73, 0x73, 0x77, 0x64, 0x5F, 0x70, 0x61, 0x74, 0x68, 0x22];

            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Users"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Users => [0x75, 0x00, 0x00, 0x00, 0x22, 0x75, 0x73, 0x65, 0x72, 0x73, 0x22];
        }
    }
}
