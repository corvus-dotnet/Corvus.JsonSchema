    ...
    public readonly partial struct BodyGenerator
    {
        ...
        public readonly partial struct EnableDebug
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnableDebug, Mutable>(EnableDebug.DefaultInstance);
                ...
                public static explicit operator Mutable(EnableDebug instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EnableDebug"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EnableDebug(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EnableDebug.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly EnableDebug Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly EnableDebug Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EnableDebug>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(EnableDebug instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<EnableDebug, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<EnableDebug> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EnableDebug>();
                }
                finally
                {
