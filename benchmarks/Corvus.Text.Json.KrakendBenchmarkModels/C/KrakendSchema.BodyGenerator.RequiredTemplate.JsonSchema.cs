    ...
    public readonly partial struct BodyGenerator
    {
            ...
            : IJsonElement<RequiredTemplate>
        {
            public static partial class JsonSchema
            {
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.TemplateUtf8))
                    {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1modifier~1body-generator.json/oneOf/1"u8, buffer, out written);
