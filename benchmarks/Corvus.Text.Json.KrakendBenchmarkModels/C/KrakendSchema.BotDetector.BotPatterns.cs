...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct BotDetector
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="BotPatterns"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal BotPatterns(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static BotPatterns DefaultInstance { get; } = BotPatterns.ParseValue("[]"u8);
            ...
            /// </returns>
            public static bool operator ==(in BotPatterns left, in BotPatterns right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in BotPatterns left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(BotPatterns instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BotPatterns(JsonElement instance)
            {
                return BotPatterns.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BotPatterns From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BotPatterns ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BotPatterns>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BotPatterns ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BotPatterns>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BotPatterns ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BotPatterns>(json, options);
            }
            ...
            /// </exception>
            public static BotPatterns ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<BotPatterns>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out BotPatterns? result)
            {
                return JsonElementHelpers.TryParseValue<BotPatterns>(ref reader, out result);
            }
...
#if NET
            static BotPatterns IJsonElement<BotPatterns>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BotPatterns: ValueKind = {ValueKind} : \"{ToString()}\"";
