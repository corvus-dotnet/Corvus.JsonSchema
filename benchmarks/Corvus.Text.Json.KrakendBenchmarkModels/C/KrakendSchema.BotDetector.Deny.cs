...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct BotDetector
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="Deny"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal Deny(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Deny DefaultInstance { get; } = Deny.ParseValue("[]"u8);
            ...
            /// </returns>
            public static bool operator ==(in Deny left, in Deny right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Deny left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(Deny instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Deny(JsonElement instance)
            {
                return Deny.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Deny From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Deny ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Deny>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Deny ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Deny>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Deny ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Deny>(json, options);
            }
            ...
            /// </exception>
            public static Deny ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Deny>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Deny? result)
            {
                return JsonElementHelpers.TryParseValue<Deny>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Deny(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static Deny IJsonElement<Deny>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Deny: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Deny"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Deny"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<Deny>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Deny"/> that lives for the lifetime of its
            ...
            public Deny Freeze()
            {
                ...
                {
                    return mutable.FreezeElement<Deny>(_idx);
                }
