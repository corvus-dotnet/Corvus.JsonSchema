    ...
    public readonly partial struct BotDetector
    {
        ...
        public readonly partial struct EmptyUserAgentIsABot
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EmptyUserAgentIsABot, Mutable>(EmptyUserAgentIsABot.DefaultInstance);
                ...
                public static explicit operator Mutable(EmptyUserAgentIsABot instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EmptyUserAgentIsABot"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EmptyUserAgentIsABot(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EmptyUserAgentIsABot.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly EmptyUserAgentIsABot Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly EmptyUserAgentIsABot Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EmptyUserAgentIsABot>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(EmptyUserAgentIsABot instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<EmptyUserAgentIsABot, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<EmptyUserAgentIsABot> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EmptyUserAgentIsABot>();
                }
                finally
                {
