...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct BotDetector
    {
        ...
        public readonly partial struct EmptyUserAgentIsABot
#if NET8_0_OR_GREATER
            : IJsonElement<EmptyUserAgentIsABot>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="EmptyUserAgentIsABot"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal EmptyUserAgentIsABot(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static EmptyUserAgentIsABot DefaultInstance { get; } = ParsedJsonDocument<EmptyUserAgentIsABot>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(EmptyUserAgentIsABot value)
            {
            ...
            /// </returns>
            public static bool operator ==(in EmptyUserAgentIsABot left, in EmptyUserAgentIsABot right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in EmptyUserAgentIsABot left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(EmptyUserAgentIsABot instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EmptyUserAgentIsABot(JsonElement instance)
            {
                return EmptyUserAgentIsABot.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EmptyUserAgentIsABot From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EmptyUserAgentIsABot ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EmptyUserAgentIsABot>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EmptyUserAgentIsABot ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EmptyUserAgentIsABot>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EmptyUserAgentIsABot ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EmptyUserAgentIsABot>(json, options);
            }
            ...
            /// </exception>
            public static EmptyUserAgentIsABot ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<EmptyUserAgentIsABot>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out EmptyUserAgentIsABot? result)
            {
                return JsonElementHelpers.TryParseValue<EmptyUserAgentIsABot>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new EmptyUserAgentIsABot(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static EmptyUserAgentIsABot IJsonElement<EmptyUserAgentIsABot>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EmptyUserAgentIsABot: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="EmptyUserAgentIsABot"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="EmptyUserAgentIsABot"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public EmptyUserAgentIsABot Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<EmptyUserAgentIsABot>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="EmptyUserAgentIsABot"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public EmptyUserAgentIsABot Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<EmptyUserAgentIsABot>(_idx);
                }
