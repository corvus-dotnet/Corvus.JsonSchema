...
public readonly partial struct KrakendSchema
{
        ...
        : IJsonElement<BotDetector>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchAllowValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.KrakendBenchmark.Current.KrakendSchema.BotDetector.Allow.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.KrakendBenchmark.Current.KrakendSchema.BotDetector.Allow.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                context.CommitChildContext(childContext.IsMatch, ref childContext);
            }

            private static void MatchCacheSize(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
            ...
            private static void MatchDenyValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext2 =
                    Corvus.KrakendBenchmark.Current.KrakendSchema.BotDetector.Deny.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.KrakendBenchmark.Current.KrakendSchema.BotDetector.Deny.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                context.CommitChildContext(childContext2.IsMatch, ref childContext2);
            }

            private static void MatchEmptyUserAgentIsBot(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext3 =
                    Corvus.KrakendBenchmark.Current.KrakendSchema.BotDetector.EmptyUserAgentIsABot.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.KrakendBenchmark.Current.KrakendSchema.BotDetector.EmptyUserAgentIsABot.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
                context.CommitChildContext(childContext3.IsMatch, ref childContext3);
            }

            private static void MatchPatterns(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext4 =
                    Corvus.KrakendBenchmark.Current.KrakendSchema.BotDetector.BotPatterns.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.KrakendBenchmark.Current.KrakendSchema.BotDetector.BotPatterns.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext4);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1security~1bot-detector.json"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1security~1bot-detector.json";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1security~1bot-detector.json"u8;
