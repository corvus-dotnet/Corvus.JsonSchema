    ...
    public readonly partial struct Cel
    {
        ...
        public readonly partial struct ObjectInArray
        {
...
#endif
            {
                ...
                public void SetCheckExpr(in Corvus.KrakendBenchmark.Current.JsonString.Source value)
                {
                    CheckValidInstance();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.KrakendBenchmark.Current.JsonString.Source checkExpr)
            {
