...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Cel
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.JsonString CheckExpr
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CheckExprUtf8, out Corvus.KrakendBenchmark.Current.JsonString value))
                    {
                        return value;
                    }
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="CheckExpr"/>.
                /// </summary>
                public const string CheckExpr = "check_expr";

                /// <summary>
                /// Gets the JSON property name for <see cref="CheckExpr"/>.
                /// </summary>
                public static ReadOnlySpan<byte> CheckExprUtf8 => "check_expr"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="CheckExpr"/>.
                /// </summary>
                public static ReadOnlySpan<byte> CheckExpr => "check_expr"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="CheckExpr"/>.
                /// </summary>
                public static ReadOnlySpan<byte> CheckExpr => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x63, 0x68, 0x65, 0x63, 0x6B, 0x5F, 0x65, 0x78, 0x70, 0x72, 0x22];
            }
        }
    }
}
