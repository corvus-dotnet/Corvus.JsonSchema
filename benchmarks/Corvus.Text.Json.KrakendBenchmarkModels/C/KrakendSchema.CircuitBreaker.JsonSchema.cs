...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct CircuitBreaker
        : IJsonElement<CircuitBreaker>
    {
        public static partial class JsonSchema
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyIntervalPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("interval"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyIntervalNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("interval"u8, buffer, out written);

            private const int RequiredOffsetForInterval = 0;
            private const uint RequiredBitForInterval = 0b00000000000000000000000000000001;

            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyMaxErrorsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("max_errors"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyMaxErrorsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("max_errors"u8, buffer, out written);

            private const int RequiredOffsetForMaxErrors = 0;
            private const uint RequiredBitForMaxErrors = 0b00000000000000000000000000000010;

            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyTimeoutPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("timeout"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyTimeoutNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("timeout"u8, buffer, out written);

            private const int RequiredOffsetForTimeout = 0;
            private const uint RequiredBitForTimeout = 0b00000000000000000000000000000100;

            private const uint RequiredBitMask0 =
                RequiredBitForInterval | RequiredBitForMaxErrors | RequiredBitForTimeout;
            private static readonly JsonSchemaPathProvider IntervalSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/interval"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider LogStatusChangeValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/log_status_change"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider MaxErrorsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/max_errors"u8, buffer, out written);
            ...
            private static void MatchInterval(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.KrakendBenchmark.Current.JsonInteger.JsonSchema.PushChildContextUnescaped(
                        ...
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.IntervalUtf8,
                        evaluationPath: IntervalSchemaEvaluationPath);

                Corvus.KrakendBenchmark.Current.JsonInteger.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                requiredBitBuffer[RequiredOffsetForInterval] |= RequiredBitForInterval;
            }

            private static void MatchLogStatusChangeValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext1 =
                    Corvus.KrakendBenchmark.Current.KrakendSchema.CircuitBreaker.LogStatusChange.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.LogStatusChangeValueUtf8,
                        evaluationPath: LogStatusChangeValueSchemaEvaluationPath);

                Corvus.KrakendBenchmark.Current.KrakendSchema.CircuitBreaker.LogStatusChange.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                context.CommitChildContext(childContext1.IsMatch, ref childContext1);
            }

            private static void MatchMaxErrors(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext2 =
                    Corvus.KrakendBenchmark.Current.JsonInteger.JsonSchema.PushChildContextUnescaped(
                        ...
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.MaxErrorsUtf8,
                        evaluationPath: MaxErrorsSchemaEvaluationPath);

                Corvus.KrakendBenchmark.Current.JsonInteger.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                ...
                requiredBitBuffer[RequiredOffsetForMaxErrors] |= RequiredBitForMaxErrors;
            }
            ...
            private static void MatchTimeout(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                Corvus.KrakendBenchmark.Current.JsonInteger.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext4);
                ...
                requiredBitBuffer[RequiredOffsetForTimeout] |= RequiredBitForTimeout;
            }
            ...
            private static PropertySchemaMatchers<Corvus.KrakendBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.KrakendBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                    (static () => JsonPropertyNames.IntervalUtf8, MatchInterval),
                    (static () => JsonPropertyNames.LogStatusChangeValueUtf8, MatchLogStatusChangeValue),
                    (static () => JsonPropertyNames.MaxErrorsUtf8, MatchMaxErrors),
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1qos~1circuit-breaker.json"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1qos~1circuit-breaker.json";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1qos~1circuit-breaker.json"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                    {
                        if (context.HasCollector)
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyIntervalPresent, "interval"u8, "required"u8);
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyMaxErrorsPresent, "max_errors"u8, "required"u8);
                            context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyTimeoutPresent, "timeout"u8, "required"u8);
                        }
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForInterval] & RequiredBitForInterval) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyIntervalNotPresent, "interval"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyIntervalPresent, "interval"u8, "required"u8);
                        ...
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForMaxErrors] & RequiredBitForMaxErrors) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyMaxErrorsNotPresent, "max_errors"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyMaxErrorsPresent, "max_errors"u8, "required"u8);
                        ...
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForTimeout] & RequiredBitForTimeout) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 2, RequiredPropertyTimeoutNotPresent, "timeout"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyTimeoutPresent, "timeout"u8, "required"u8);
