    ...
    public readonly partial struct CircuitBreaker
    {
        ...
        public readonly partial struct LogStatusChange
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<LogStatusChange, Mutable>(LogStatusChange.DefaultInstance);
                ...
                public static explicit operator Mutable(LogStatusChange instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="LogStatusChange"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LogStatusChange(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LogStatusChange.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly LogStatusChange Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly LogStatusChange Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<LogStatusChange>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(LogStatusChange instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<LogStatusChange, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<LogStatusChange> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<LogStatusChange>();
                }
                finally
                {
