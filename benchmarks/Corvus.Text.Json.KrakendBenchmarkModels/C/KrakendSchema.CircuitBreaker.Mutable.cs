...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct CircuitBreaker
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(CircuitBreaker instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CircuitBreaker"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CircuitBreaker(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.CircuitBreaker.LogStatusChange.Mutable LogStatusChangeValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LogStatusChangeValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.CircuitBreaker.LogStatusChange.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.KrakendBenchmark.Current.KrakendSchema.CircuitBreaker.LogStatusChange.Mutable.DefaultInstance;
                }
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new CircuitBreaker(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetInterval(scoped in Corvus.KrakendBenchmark.Current.JsonInteger.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetLogStatusChangeValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.CircuitBreaker.LogStatusChange.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetMaxErrors(scoped in Corvus.KrakendBenchmark.Current.JsonInteger.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetTimeout(scoped in Corvus.KrakendBenchmark.Current.JsonInteger.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CircuitBreaker.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="CircuitBreaker"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="CircuitBreaker"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly CircuitBreaker Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<CircuitBreaker>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="CircuitBreaker"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly CircuitBreaker Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CircuitBreaker>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.KrakendBenchmark.Current.JsonInteger.Source _createArg3;
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.CircuitBreaker.LogStatusChange.Source _createArg4;
            ...
            internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.CircuitBreaker.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.KrakendBenchmark.Current.JsonInteger.Source arg1, scoped in Corvus.KrakendBenchmark.Current.JsonInteger.Source arg2, scoped in Corvus.KrakendBenchmark.Current.JsonInteger.Source arg3, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.CircuitBreaker.LogStatusChange.Source arg4, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg5)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            public static implicit operator Source(CircuitBreaker instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.CircuitBreaker.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="CircuitBreaker"/>.
            /// </summary>
            internal static void Create(
                ...
                in Corvus.KrakendBenchmark.Current.KrakendSchema.CircuitBreaker.LogStatusChange.Source logStatusChange = default,
            ...
            internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.JsonInteger.Source arg1, scoped in Corvus.KrakendBenchmark.Current.JsonInteger.Source arg2, scoped in Corvus.KrakendBenchmark.Current.JsonInteger.Source arg3, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.CircuitBreaker.LogStatusChange.Source arg4, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg5, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// </summary>
        /// <param name="interval">The value of the <c>"interval"</c> property.</param>
        /// <param name="maxErrors">The value of the <c>"max_errors"</c> property.</param>
        /// <param name="timeout">The value of the <c>"timeout"</c> property.</param>
        /// <param name="logStatusChange">The value of the <c>"log_status_change"</c> property.</param>
        /// <param name="name">The value of the <c>"name"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.KrakendBenchmark.Current.JsonInteger.Source interval, scoped in Corvus.KrakendBenchmark.Current.JsonInteger.Source maxErrors, scoped in Corvus.KrakendBenchmark.Current.JsonInteger.Source timeout, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.CircuitBreaker.LogStatusChange.Source logStatusChange = default, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source name = default)
        {
            return new Source(interval, maxErrors, timeout, logStatusChange, name);
        }
        ...
        {
            return workspace.CreateBuilder<CircuitBreaker, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<CircuitBreaker> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<CircuitBreaker>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<CircuitBreaker> Create<TContext>(
        ...
        public static ParsedJsonDocument<CircuitBreaker> Create(in Corvus.KrakendBenchmark.Current.JsonInteger.Source interval, in Corvus.KrakendBenchmark.Current.JsonInteger.Source maxErrors, in Corvus.KrakendBenchmark.Current.JsonInteger.Source timeout, in Corvus.KrakendBenchmark.Current.KrakendSchema.CircuitBreaker.LogStatusChange.Source logStatusChange = default, in Corvus.KrakendBenchmark.Current.JsonString.Source name = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
