    ...
    public readonly partial struct ClientTls
    {
        ...
        public readonly partial struct AllowInsecureConnections
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AllowInsecureConnections, Mutable>(AllowInsecureConnections.DefaultInstance);
            ...
            public static ParsedJsonDocument<AllowInsecureConnections> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AllowInsecureConnections>();
                }
                finally
                {
