...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct ClientTls
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="CaCertificates"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal CaCertificates(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static CaCertificates DefaultInstance { get; } = CaCertificates.ParseValue("[]"u8);
            ...
            /// </returns>
            public static bool operator ==(in CaCertificates left, in CaCertificates right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in CaCertificates left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(CaCertificates instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CaCertificates(JsonElement instance)
            {
                return CaCertificates.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CaCertificates From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CaCertificates ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CaCertificates>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CaCertificates ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CaCertificates>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CaCertificates ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CaCertificates>(json, options);
            }
            ...
            /// </exception>
            public static CaCertificates ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<CaCertificates>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out CaCertificates? result)
            {
                return JsonElementHelpers.TryParseValue<CaCertificates>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new CaCertificates(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static CaCertificates IJsonElement<CaCertificates>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CaCertificates: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="CaCertificates"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="CaCertificates"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public CaCertificates Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<CaCertificates>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="CaCertificates"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public CaCertificates Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<CaCertificates>(_idx);
                }
