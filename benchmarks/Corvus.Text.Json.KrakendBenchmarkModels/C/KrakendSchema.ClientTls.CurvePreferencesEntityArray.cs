    ...
    public readonly partial struct ClientTls
    {
...
#endif
        {
            ...
            public bool TryGetNumericValues(Span<double> items, out int written)
            {
                CheckValidInstance();
                written = 0;
                foreach (Corvus.KrakendBenchmark.Current.KrakendSchema.ClientTls.CurvePreferencesEntityArray.CurvePreferencesEntity item in EnumerateArray())
                {
            ...
            public Corvus.KrakendBenchmark.Current.KrakendSchema.ClientTls.CurvePreferencesEntityArray.CurvePreferencesEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.KrakendBenchmark.Current.KrakendSchema.ClientTls.CurvePreferencesEntityArray.CurvePreferencesEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.ClientTls.CurvePreferencesEntityArray.CurvePreferencesEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.ClientTls.CurvePreferencesEntityArray.CurvePreferencesEntity>(_parent, _idx);
            }
