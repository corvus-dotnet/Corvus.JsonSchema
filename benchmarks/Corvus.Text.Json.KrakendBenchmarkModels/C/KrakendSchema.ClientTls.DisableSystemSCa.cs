...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct ClientTls
    {
        ...
        public readonly partial struct DisableSystemSCa
#if NET8_0_OR_GREATER
            : IJsonElement<DisableSystemSCa>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DisableSystemSCa"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal DisableSystemSCa(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static DisableSystemSCa DefaultInstance { get; } = ParsedJsonDocument<DisableSystemSCa>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(DisableSystemSCa value)
            {
            ...
            /// </returns>
            public static bool operator ==(in DisableSystemSCa left, in DisableSystemSCa right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in DisableSystemSCa left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(DisableSystemSCa instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DisableSystemSCa(JsonElement instance)
            {
                return DisableSystemSCa.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DisableSystemSCa From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DisableSystemSCa ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DisableSystemSCa>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DisableSystemSCa ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DisableSystemSCa>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DisableSystemSCa ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DisableSystemSCa>(json, options);
            }
            ...
            /// </exception>
            public static DisableSystemSCa ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<DisableSystemSCa>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out DisableSystemSCa? result)
            {
                return JsonElementHelpers.TryParseValue<DisableSystemSCa>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DisableSystemSCa(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static DisableSystemSCa IJsonElement<DisableSystemSCa>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DisableSystemSCa: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DisableSystemSCa"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DisableSystemSCa"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public DisableSystemSCa Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DisableSystemSCa>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DisableSystemSCa"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public DisableSystemSCa Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<DisableSystemSCa>(_idx);
                }
