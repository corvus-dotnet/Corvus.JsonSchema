        ...
        public readonly partial struct RequiredCertificateAndPrivateKeyArray
        {
                ...
                : IJsonElement<RequiredCertificateAndPrivateKey>
            {
                public static partial class JsonSchema
                {
                    ...
                    private static void MatchCertificate(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                    {
                    ...
                    private static void MatchPrivateKey(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
