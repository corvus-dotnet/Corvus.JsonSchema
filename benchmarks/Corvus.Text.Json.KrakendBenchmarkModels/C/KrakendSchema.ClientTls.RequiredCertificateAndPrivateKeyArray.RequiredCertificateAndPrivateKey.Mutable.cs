        ...
        public readonly partial struct RequiredCertificateAndPrivateKeyArray
        {
            ...
            public readonly partial struct RequiredCertificateAndPrivateKey
            {
...
#endif
                {
                    ...
                    public void SetCertificate(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source value)
                    {
                        CheckValidInstance();
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.ClientTls.RequiredCertificateAndPrivateKeyArray.RequiredCertificateAndPrivateKey.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.ClientTls.RequiredCertificateAndPrivateKeyArray.RequiredCertificateAndPrivateKey.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                /// </summary>
                /// <param name="certificate">The value of the <c>"certificate"</c> property.</param>
                /// <param name="privateKey">The value of the <c>"private_key"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source certificate, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source privateKey)
                {
                    return new Source(certificate, privateKey);
                }
                ...
                public static ParsedJsonDocument<RequiredCertificateAndPrivateKey> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RequiredCertificateAndPrivateKey>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredCertificateAndPrivateKey> Create<TContext>(
                ...
                public static ParsedJsonDocument<RequiredCertificateAndPrivateKey> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source certificate, in Corvus.KrakendBenchmark.Current.JsonString.Source privateKey, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
