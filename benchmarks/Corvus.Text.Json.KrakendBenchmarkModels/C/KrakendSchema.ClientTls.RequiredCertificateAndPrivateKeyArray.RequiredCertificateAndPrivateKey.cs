    ...
    public readonly partial struct ClientTls
    {
        ...
        public readonly partial struct RequiredCertificateAndPrivateKeyArray
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.JsonString Certificate
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CertificateUtf8, out Corvus.KrakendBenchmark.Current.JsonString value))
                        {
                            return value;
                        }
                ...
                {
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="Certificate"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Certificate => [0xD5, 0x00, 0x00, 0x00, 0x22, 0x63, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x22];
