    ...
    public readonly partial struct Consumer
    {
            ...
            : IJsonElement<AutoAck>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend~1amqp~1consumer.json/properties/auto_ack"u8, buffer, out written);
