...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Consumer
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AutoAck"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal AutoAck(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AutoAck DefaultInstance { get; } = ParsedJsonDocument<AutoAck>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(AutoAck value)
            {
            ...
            /// </returns>
            public static bool operator ==(in AutoAck left, in AutoAck right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AutoAck left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(AutoAck instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AutoAck(JsonElement instance)
            {
                return AutoAck.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AutoAck From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AutoAck ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AutoAck>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AutoAck ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AutoAck>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AutoAck ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AutoAck>(json, options);
            }
            ...
            /// </exception>
            public static AutoAck ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<AutoAck>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AutoAck? result)
            {
                return JsonElementHelpers.TryParseValue<AutoAck>(ref reader, out result);
            }
...
#if NET
            static AutoAck IJsonElement<AutoAck>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AutoAck: ValueKind = {ValueKind} : \"{ToString()}\"";
