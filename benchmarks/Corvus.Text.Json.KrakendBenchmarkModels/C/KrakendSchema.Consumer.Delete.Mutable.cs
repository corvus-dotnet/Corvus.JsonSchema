    ...
    public readonly partial struct Consumer
    {
        ...
        public readonly partial struct Delete
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<Delete, Mutable>(Delete.DefaultInstance);
            ...
            public static ParsedJsonDocument<Delete> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Delete>();
                }
                finally
                {
