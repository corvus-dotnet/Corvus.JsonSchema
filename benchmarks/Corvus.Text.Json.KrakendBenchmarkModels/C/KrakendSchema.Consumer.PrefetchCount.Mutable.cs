    ...
    public readonly partial struct Consumer
    {
        ...
        public readonly partial struct PrefetchCount
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PrefetchCount, Mutable>(PrefetchCount.DefaultInstance);
                ...
                public static explicit operator Mutable(PrefetchCount instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PrefetchCount"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PrefetchCount(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PrefetchCount.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PrefetchCount Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PrefetchCount Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PrefetchCount>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PrefetchCount instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PrefetchCount, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PrefetchCount> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PrefetchCount>();
                }
                finally
                {
