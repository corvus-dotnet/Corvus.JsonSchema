        ...
        public readonly partial struct RequiredFindAndReplace
        {
            ...
            public readonly partial struct IsARegexp
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<IsARegexp, Mutable>(IsARegexp.DefaultInstance);
                ...
                public static ParsedJsonDocument<IsARegexp> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<IsARegexp>();
                    }
                    finally
                    {
