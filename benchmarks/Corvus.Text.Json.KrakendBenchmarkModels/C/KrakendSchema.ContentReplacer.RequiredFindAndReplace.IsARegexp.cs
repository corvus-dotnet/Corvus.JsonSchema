    ...
    public readonly partial struct ContentReplacer
    {
        ...
        public readonly partial struct RequiredFindAndReplace
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="IsARegexp"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal IsARegexp(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static IsARegexp DefaultInstance { get; } = ParsedJsonDocument<IsARegexp>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(IsARegexp value)
                {
                ...
                /// </returns>
                public static bool operator ==(in IsARegexp left, in IsARegexp right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in IsARegexp left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(IsARegexp instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IsARegexp(JsonElement instance)
                {
                    return IsARegexp.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static IsARegexp From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static IsARegexp ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<IsARegexp>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static IsARegexp ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<IsARegexp>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static IsARegexp ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<IsARegexp>(json, options);
                }
                ...
                /// </exception>
                public static IsARegexp ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<IsARegexp>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out IsARegexp? result)
                {
                    return JsonElementHelpers.TryParseValue<IsARegexp>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new IsARegexp(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static IsARegexp IJsonElement<IsARegexp>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IsARegexp: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="IsARegexp"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="IsARegexp"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public IsARegexp Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<IsARegexp>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="IsARegexp"/> that lives for the lifetime of its
