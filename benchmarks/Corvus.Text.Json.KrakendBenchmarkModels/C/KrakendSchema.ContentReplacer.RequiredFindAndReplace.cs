...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct ContentReplacer
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.ContentReplacer.RequiredFindAndReplace.IsARegexp Regexp
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RegexpUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.ContentReplacer.RequiredFindAndReplace.IsARegexp value))
                    {
                        return value;
                    }

                    return Corvus.KrakendBenchmark.Current.KrakendSchema.ContentReplacer.RequiredFindAndReplace.IsARegexp.DefaultInstance;
                }
            }
