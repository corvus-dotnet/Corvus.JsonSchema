        ...
        public readonly partial struct AllowMethodsEntityArray
        {
            ...
            public readonly partial struct AllowMethodsEntity
            {
                ...
                public ref struct Source
                {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (AllowMethodsEntity)value;
                ...
                public static ParsedJsonDocument<AllowMethodsEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<AllowMethodsEntity>();
                    }
                    finally
                    {
