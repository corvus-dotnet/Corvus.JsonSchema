...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Cors
    {
...
#endif
        {
            ...
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Cors.AllowMethodsEntityArray.AllowMethodsEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.KrakendBenchmark.Current.KrakendSchema.Cors.AllowMethodsEntityArray.AllowMethodsEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Cors.AllowMethodsEntityArray.AllowMethodsEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Cors.AllowMethodsEntityArray.AllowMethodsEntity>(_parent, _idx);
            }
