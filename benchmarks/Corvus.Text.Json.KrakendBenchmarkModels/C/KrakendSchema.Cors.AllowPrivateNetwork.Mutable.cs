    ...
    public readonly partial struct Cors
    {
        ...
        public readonly partial struct AllowPrivateNetwork
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AllowPrivateNetwork, Mutable>(AllowPrivateNetwork.DefaultInstance);
            ...
            public static ParsedJsonDocument<AllowPrivateNetwork> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AllowPrivateNetwork>();
                }
                finally
                {
