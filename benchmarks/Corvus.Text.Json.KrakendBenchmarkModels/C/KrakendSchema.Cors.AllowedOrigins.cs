...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Cors
    {
        ...
        public readonly partial struct AllowedOrigins
#if NET8_0_OR_GREATER
            : IJsonElement<AllowedOrigins>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AllowedOrigins"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal AllowedOrigins(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AllowedOrigins DefaultInstance { get; } = AllowedOrigins.ParseValue("[ \"*\" ]"u8);
            ...
            /// </returns>
            public static bool operator ==(in AllowedOrigins left, in AllowedOrigins right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AllowedOrigins left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(AllowedOrigins instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AllowedOrigins(JsonElement instance)
            {
                return AllowedOrigins.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllowedOrigins From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllowedOrigins ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllowedOrigins>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllowedOrigins ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllowedOrigins>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllowedOrigins ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllowedOrigins>(json, options);
            }
            ...
            /// </exception>
            public static AllowedOrigins ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<AllowedOrigins>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AllowedOrigins? result)
            {
                return JsonElementHelpers.TryParseValue<AllowedOrigins>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new AllowedOrigins(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static AllowedOrigins IJsonElement<AllowedOrigins>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AllowedOrigins: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="AllowedOrigins"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="AllowedOrigins"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public AllowedOrigins Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<AllowedOrigins>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="AllowedOrigins"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public AllowedOrigins Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<AllowedOrigins>(_idx);
                }
