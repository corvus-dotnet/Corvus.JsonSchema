    ...
    public readonly partial struct Cors
    {
        ...
        public readonly partial struct ExposeHeaders
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ExposeHeaders, Mutable>(ExposeHeaders.DefaultInstance);
                ...
                public static explicit operator Mutable(ExposeHeaders instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ExposeHeaders"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExposeHeaders(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExposeHeaders.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public readonly ExposeHeaders Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ExposeHeaders Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ExposeHeaders>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Cors.ExposeHeaders.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(ExposeHeaders instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Cors.ExposeHeaders.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<ExposeHeaders, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ExposeHeaders> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ExposeHeaders>();
                }
                finally
                {
