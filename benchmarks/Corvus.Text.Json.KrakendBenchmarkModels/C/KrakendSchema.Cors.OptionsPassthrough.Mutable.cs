    ...
    public readonly partial struct Cors
    {
        ...
        public readonly partial struct OptionsPassthrough
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<OptionsPassthrough, Mutable>(OptionsPassthrough.DefaultInstance);
                ...
                public static explicit operator Mutable(OptionsPassthrough instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OptionsPassthrough"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OptionsPassthrough(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OptionsPassthrough.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly OptionsPassthrough Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly OptionsPassthrough Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OptionsPassthrough>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(OptionsPassthrough instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<OptionsPassthrough, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<OptionsPassthrough> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OptionsPassthrough>();
                }
                finally
                {
