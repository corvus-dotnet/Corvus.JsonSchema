    ...
    public readonly partial struct Cors
    {
        ...
        public readonly partial struct SuccessStatusCodes
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SuccessStatusCodes, Mutable>(SuccessStatusCodes.DefaultInstance);
            ...
            public static ParsedJsonDocument<SuccessStatusCodes> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SuccessStatusCodes>();
                }
                finally
                {
