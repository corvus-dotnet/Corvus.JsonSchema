...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct DebugEndpoint
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DebugEndpoint, Mutable>(DebugEndpoint.DefaultInstance);
            ...
            public static explicit operator Mutable(DebugEndpoint instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DebugEndpoint"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DebugEndpoint(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DebugEndpoint(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DebugEndpoint.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DebugEndpoint"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DebugEndpoint"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly DebugEndpoint Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DebugEndpoint>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DebugEndpoint"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly DebugEndpoint Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DebugEndpoint>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(DebugEndpoint instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<DebugEndpoint, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<DebugEndpoint> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DebugEndpoint>();
            }
            finally
            {
