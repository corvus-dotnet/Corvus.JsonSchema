...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct DisableCompression
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableCompression, Mutable>(DisableCompression.DefaultInstance);
            ...
            public static explicit operator Mutable(DisableCompression instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DisableCompression"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DisableCompression(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DisableCompression.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly DisableCompression Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly DisableCompression Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DisableCompression>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(DisableCompression instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<DisableCompression, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<DisableCompression> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DisableCompression>();
            }
            finally
            {
