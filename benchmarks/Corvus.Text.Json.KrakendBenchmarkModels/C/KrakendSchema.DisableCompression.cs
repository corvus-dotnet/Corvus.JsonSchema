...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct DisableCompression
#if NET8_0_OR_GREATER
        : IJsonElement<DisableCompression>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DisableCompression"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal DisableCompression(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static DisableCompression DefaultInstance { get; } = ParsedJsonDocument<DisableCompression>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(DisableCompression value)
        {
        ...
        /// </returns>
        public static bool operator ==(in DisableCompression left, in DisableCompression right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in DisableCompression left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(DisableCompression instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DisableCompression(JsonElement instance)
        {
            return DisableCompression.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DisableCompression From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DisableCompression ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DisableCompression>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DisableCompression ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DisableCompression>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DisableCompression ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DisableCompression>(json, options);
        }
        ...
        /// </exception>
        public static DisableCompression ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<DisableCompression>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out DisableCompression? result)
        {
            return JsonElementHelpers.TryParseValue<DisableCompression>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new DisableCompression(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static DisableCompression IJsonElement<DisableCompression>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DisableCompression: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="DisableCompression"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="DisableCompression"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public DisableCompression Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<DisableCompression>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="DisableCompression"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public DisableCompression Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<DisableCompression>(_idx);
            }
