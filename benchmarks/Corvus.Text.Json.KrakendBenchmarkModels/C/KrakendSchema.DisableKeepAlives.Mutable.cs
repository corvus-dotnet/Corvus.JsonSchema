...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct DisableKeepAlives
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableKeepAlives, Mutable>(DisableKeepAlives.DefaultInstance);
            ...
            public static explicit operator Mutable(DisableKeepAlives instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DisableKeepAlives"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DisableKeepAlives(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DisableKeepAlives(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DisableKeepAlives.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DisableKeepAlives"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DisableKeepAlives"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly DisableKeepAlives Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DisableKeepAlives>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DisableKeepAlives"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly DisableKeepAlives Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DisableKeepAlives>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(DisableKeepAlives instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<DisableKeepAlives, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<DisableKeepAlives> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DisableKeepAlives>();
            }
            finally
            {
