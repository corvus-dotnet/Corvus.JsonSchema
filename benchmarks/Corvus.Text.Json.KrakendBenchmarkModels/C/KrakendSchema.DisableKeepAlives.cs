...
public readonly partial struct KrakendSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DisableKeepAlives"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal DisableKeepAlives(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static DisableKeepAlives DefaultInstance { get; } = ParsedJsonDocument<DisableKeepAlives>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(DisableKeepAlives value)
        {
        ...
        /// </returns>
        public static bool operator ==(in DisableKeepAlives left, in DisableKeepAlives right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in DisableKeepAlives left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(DisableKeepAlives instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DisableKeepAlives(JsonElement instance)
        {
            return DisableKeepAlives.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DisableKeepAlives From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DisableKeepAlives ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DisableKeepAlives>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DisableKeepAlives ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DisableKeepAlives>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DisableKeepAlives ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DisableKeepAlives>(json, options);
        }
        ...
        /// </exception>
        public static DisableKeepAlives ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<DisableKeepAlives>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out DisableKeepAlives? result)
        {
            return JsonElementHelpers.TryParseValue<DisableKeepAlives>(ref reader, out result);
        }
...
#if NET
        static DisableKeepAlives IJsonElement<DisableKeepAlives>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DisableKeepAlives: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public DisableKeepAlives Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public DisableKeepAlives Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<DisableKeepAlives>(_idx);
            }
