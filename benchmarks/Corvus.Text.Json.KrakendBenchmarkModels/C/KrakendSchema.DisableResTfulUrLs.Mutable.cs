...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct DisableResTfulUrLs
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableResTfulUrLs, Mutable>(DisableResTfulUrLs.DefaultInstance);
            ...
            public static explicit operator Mutable(DisableResTfulUrLs instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DisableResTfulUrLs"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DisableResTfulUrLs(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DisableResTfulUrLs(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DisableResTfulUrLs.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DisableResTfulUrLs"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DisableResTfulUrLs"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly DisableResTfulUrLs Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DisableResTfulUrLs>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DisableResTfulUrLs"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly DisableResTfulUrLs Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DisableResTfulUrLs>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(DisableResTfulUrLs instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<DisableResTfulUrLs, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<DisableResTfulUrLs> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DisableResTfulUrLs>();
            }
            finally
            {
