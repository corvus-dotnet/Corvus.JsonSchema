...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Duration
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Duration instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Duration"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Duration(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Duration(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Duration.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Duration"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Duration"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Duration Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Duration>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Duration"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Duration Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Duration>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(Duration instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<Duration, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Duration> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Duration>();
            }
            finally
            {
