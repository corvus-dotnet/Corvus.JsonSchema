    ...
    public readonly partial struct Endpoint
    {
            ...
            : IJsonElement<BackendArray>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1endpoint.json/properties/backend"u8, buffer, out written);
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        while (arrayValidation_enumerator.MoveNext())
                        {
                            ...
                            JsonSchemaContext childContext = Corvus.KrakendBenchmark.Current.KrakendSchema.Backend.JsonSchema.PushChildContext(
                                parentDocument,
                            ...
                            Corvus.KrakendBenchmark.Current.KrakendSchema.Backend.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
