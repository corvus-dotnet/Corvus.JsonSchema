    ...
    public readonly partial struct Endpoint
    {
        ...
        public readonly partial struct EndpointEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(EndpointEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EndpointEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EndpointEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new EndpointEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EndpointEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="EndpointEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="EndpointEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly EndpointEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<EndpointEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="EndpointEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly EndpointEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EndpointEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(EndpointEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<EndpointEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<EndpointEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EndpointEntity>();
                }
                finally
                {
