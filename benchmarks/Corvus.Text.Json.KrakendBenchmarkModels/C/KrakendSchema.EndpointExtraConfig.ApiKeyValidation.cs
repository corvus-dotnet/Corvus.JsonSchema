...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct EndpointExtraConfig
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.EndpointExtraConfig.ApiKeyValidation.JsonStringArray Roles
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RolesUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.EndpointExtraConfig.ApiKeyValidation.JsonStringArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.EndpointExtraConfig.ApiKeyValidation.Strategy StrategyValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StrategyValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.EndpointExtraConfig.ApiKeyValidation.Strategy value))
                    {
                        return value;
                    }
