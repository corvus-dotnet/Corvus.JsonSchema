    ...
    public readonly partial struct EndpointExtraConfig
    {
        ...
        public readonly partial struct Proxy
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.EndpointExtraConfig.Proxy.SequentialProxy.Mutable Sequential
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SequentialUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.EndpointExtraConfig.Proxy.SequentialProxy.Mutable value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Current.KrakendSchema.EndpointExtraConfig.Proxy.SequentialProxy.Mutable.DefaultInstance;
                    }
                }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.EndpointExtraConfig.Proxy.StaticResponse.Mutable Static
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StaticUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.EndpointExtraConfig.Proxy.StaticResponse.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetStatic<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.EndpointExtraConfig.Proxy.StaticResponse.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.EndpointExtraConfig.Proxy.SequentialProxy.Source _createArg3;
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.EndpointExtraConfig.Proxy.StaticResponse.Source _createArg4;
                ...
                #endif
            {
                ...
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.EndpointExtraConfig.Proxy.SequentialProxy.Source _createArg3;
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.EndpointExtraConfig.Proxy.StaticResponse.Source<TContext> _createArg4;
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.EndpointExtraConfig.Proxy.SequentialProxy.Source sequential = default,
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.EndpointExtraConfig.Proxy.StaticResponse.Source staticValue = default)
                {
                ...
                internal static void Create<TContext>(
                    ...
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.EndpointExtraConfig.Proxy.SequentialProxy.Source sequential = default,
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.EndpointExtraConfig.Proxy.StaticResponse.Source<TContext> staticValue = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonString.Source combiner = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Flatmap.Source flatmapFilter = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.EndpointExtraConfig.Proxy.SequentialProxy.Source sequential = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.EndpointExtraConfig.Proxy.StaticResponse.Source staticValue = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.JsonString.Source combiner = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Flatmap.Source<TContext> flatmapFilter = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.EndpointExtraConfig.Proxy.SequentialProxy.Source sequential = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.EndpointExtraConfig.Proxy.StaticResponse.Source<TContext> staticValue = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            public static ParsedJsonDocument<Proxy> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source combiner = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Flatmap.Source flatmapFilter = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.EndpointExtraConfig.Proxy.SequentialProxy.Source sequential = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.EndpointExtraConfig.Proxy.StaticResponse.Source staticValue = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
