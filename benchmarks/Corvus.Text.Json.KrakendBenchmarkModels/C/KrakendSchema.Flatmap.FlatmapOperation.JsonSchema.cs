    ...
    public readonly partial struct Flatmap
    {
            ...
            : IJsonElement<FlatmapOperation>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchTypeValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
