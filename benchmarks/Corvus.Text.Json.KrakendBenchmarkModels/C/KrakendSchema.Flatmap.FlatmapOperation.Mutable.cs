    ...
    public readonly partial struct Flatmap
    {
        ...
        public readonly partial struct FlatmapOperation
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Flatmap.FlatmapOperation.Type.Mutable TypeValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Flatmap.FlatmapOperation.Type.Mutable value))
                        {
                            return value;
                        }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Flatmap.FlatmapOperation.Type.Source _createArg2;
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.Flatmap.FlatmapOperation.Type.Source type)
                {
                ...
                /// Creates an instance of a <see cref="FlatmapOperation"/>.
                /// </summary>
                public void Create(in Corvus.KrakendBenchmark.Current.JsonArray.Source args, in Corvus.KrakendBenchmark.Current.KrakendSchema.Flatmap.FlatmapOperation.Type.Source type)
                {
            ...
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonArray.Source<TContext> args, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Flatmap.FlatmapOperation.Type.Source type)
                ...
                #endif
            {
                return new Source<TContext>(context, args, type);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonArray.Source args, in Corvus.KrakendBenchmark.Current.KrakendSchema.Flatmap.FlatmapOperation.Type.Source type, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.JsonArray.Source<TContext> args, in Corvus.KrakendBenchmark.Current.KrakendSchema.Flatmap.FlatmapOperation.Type.Source type, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            public static ParsedJsonDocument<FlatmapOperation> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<FlatmapOperation>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<FlatmapOperation> Create<TContext>(
            ...
            public static ParsedJsonDocument<FlatmapOperation> Create(in Corvus.KrakendBenchmark.Current.JsonArray.Source args, in Corvus.KrakendBenchmark.Current.KrakendSchema.Flatmap.FlatmapOperation.Type.Source type, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<FlatmapOperation> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.JsonArray.Source<TContext> args, in Corvus.KrakendBenchmark.Current.KrakendSchema.Flatmap.FlatmapOperation.Type.Source type, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
