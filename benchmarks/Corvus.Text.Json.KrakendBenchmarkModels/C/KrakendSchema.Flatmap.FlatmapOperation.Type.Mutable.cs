        ...
        public readonly partial struct FlatmapOperation
        {
            ...
            public readonly partial struct Type
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(Type instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="Type"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Type(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"Type.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<Type>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(Type instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (Type)value;
                ...
                {
                    return workspace.CreateBuilder<Type, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<Type> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<Type>();
                    }
                    finally
                    {
