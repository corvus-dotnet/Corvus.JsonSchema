...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Flatmap
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Flatmap.FlatmapOperation.Type TypeValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Flatmap.FlatmapOperation.Type value))
                    {
                        return value;
                    }
