...
public readonly partial struct KrakendSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Flatmap"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Flatmap(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Flatmap DefaultInstance { get; }
        ...
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Flatmap.FlatmapOperation this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.KrakendBenchmark.Current.KrakendSchema.Flatmap.FlatmapOperation>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Flatmap.FlatmapOperation> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Flatmap.FlatmapOperation>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in Flatmap left, in Flatmap right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Flatmap left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Flatmap instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Flatmap(JsonElement instance)
        {
            return Flatmap.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Flatmap From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Flatmap ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Flatmap>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Flatmap ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Flatmap>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Flatmap ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Flatmap>(json, options);
        }
        ...
        /// </exception>
        public static Flatmap ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Flatmap>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Flatmap? result)
        {
            return JsonElementHelpers.TryParseValue<Flatmap>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Flatmap(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Flatmap IJsonElement<Flatmap>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Flatmap: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Flatmap"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Flatmap"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Flatmap Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<Flatmap>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Flatmap"/> that lives for the lifetime of its
