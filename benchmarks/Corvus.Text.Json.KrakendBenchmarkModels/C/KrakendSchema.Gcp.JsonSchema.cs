...
public readonly partial struct KrakendSchema
{
        ...
        : IJsonElement<Gcp>
    {
        public static partial class JsonSchema
        {
            ...
            private static readonly JsonSchemaPathProvider CustomClaimsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/custom_claims"u8, buffer, out written);
            ...
            private static void MatchCredentialsFile(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
            ...
            private static void MatchCredentialsJson(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
            ...
            private static void MatchCustomClaims(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext3 =
                    Corvus.KrakendBenchmark.Current.JsonObject.JsonSchema.PushChildContextUnescaped(
                        ...
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.CustomClaimsUtf8,
                        evaluationPath: CustomClaimsSchemaEvaluationPath);

                Corvus.KrakendBenchmark.Current.JsonObject.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
            ...
            private static PropertySchemaMatchers<Corvus.KrakendBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.KrakendBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1>([
                    ...
                    (static () => JsonPropertyNames.CustomClaimsUtf8, MatchCustomClaims),
                ]);
            }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1auth~1gcp.json"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1auth~1gcp.json";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1auth~1gcp.json"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext anyOfContext0 =
                    Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudience.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AnyOf0SchemaEvaluationPath);
                Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudience.JsonSchema.Evaluate(parentDocument, parentIndex, ref anyOfContext0);
                ...
                JsonSchemaContext anyOfContext1 =
                    Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudienceAndCredentialsFile.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AnyOf1SchemaEvaluationPath);
                Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudienceAndCredentialsFile.JsonSchema.Evaluate(parentDocument, parentIndex, ref anyOfContext1);
                ...
                JsonSchemaContext anyOfContext2 =
                    Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudienceAndCredentialsJson.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AnyOf2SchemaEvaluationPath);
                Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudienceAndCredentialsJson.JsonSchema.Evaluate(parentDocument, parentIndex, ref anyOfContext2);
