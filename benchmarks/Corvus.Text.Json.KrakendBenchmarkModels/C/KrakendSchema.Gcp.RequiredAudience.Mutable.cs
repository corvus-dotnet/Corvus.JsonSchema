...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Gcp
    {
        ...
        public readonly partial struct RequiredAudience
        {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Text.Json.JsonElement.Source audience)
            {
            ...
            /// <param name="audience">The value of the <c>"audience"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> audience)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
