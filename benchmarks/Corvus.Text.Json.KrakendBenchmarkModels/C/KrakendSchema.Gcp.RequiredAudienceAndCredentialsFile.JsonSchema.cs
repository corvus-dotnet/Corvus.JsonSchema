    ...
    public readonly partial struct Gcp
    {
            ...
            : IJsonElement<RequiredAudienceAndCredentialsFile>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchCredentialsFile(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
