    ...
    public readonly partial struct Gcp
    {
        ...
        public readonly partial struct RequiredAudienceAndCredentialsFile
        {
...
#endif
            {
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetCredentialsFile(in Corvus.Text.Json.JsonElement.Source value)
                {
                    CheckValidInstance();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Text.Json.JsonElement.Source audience, in Corvus.Text.Json.JsonElement.Source credentialsFile)
            {
            ...
            /// <param name="credentialsFile">The value of the <c>"credentials_file"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> audience, in Corvus.Text.Json.JsonElement.Source<TContext> credentialsFile)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
