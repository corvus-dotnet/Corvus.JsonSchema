    ...
    public readonly partial struct Gcp
    {
        ...
        public readonly partial struct RequiredAudienceAndCredentialsFile
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequiredAudienceAndCredentialsFile instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequiredAudienceAndCredentialsFile"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredAudienceAndCredentialsFile(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.JsonElement.Mutable CredentialsFile
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CredentialsFileUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetCredentialsFile(scoped in Corvus.Text.Json.JsonElement.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("credentials_file");
                    }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetCredentialsFile<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredAudienceAndCredentialsFile.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredAudienceAndCredentialsFile Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredAudienceAndCredentialsFile Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequiredAudienceAndCredentialsFile>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudienceAndCredentialsFile.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                public static implicit operator Source(RequiredAudienceAndCredentialsFile instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudienceAndCredentialsFile.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.Text.Json.JsonElement.Source credentialsFile)
                {
                ...
                /// Creates an instance of a <see cref="RequiredAudienceAndCredentialsFile"/>.
                /// </summary>
                public void Create(in Corvus.Text.Json.JsonElement.Source audience, in Corvus.Text.Json.JsonElement.Source credentialsFile)
                {
                    Create(ref _builder, audience, credentialsFile);
                }
                ...
                internal static void Create<TContext>(
                    ...
                    in Corvus.Text.Json.JsonElement.Source<TContext> credentialsFile)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                #endif
                {
                    Create(context, ref _builder, audience, credentialsFile);
                }
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Text.Json.JsonElement.Source audience, scoped in Corvus.Text.Json.JsonElement.Source credentialsFile)
            {
                return new Source(audience, credentialsFile);
            }
            ...
            /// <param name="credentialsFile">The value of the <c>"credentials_file"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> audience, scoped in Corvus.Text.Json.JsonElement.Source<TContext> credentialsFile)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Source<TContext>(context, audience, credentialsFile);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source audience, in Corvus.Text.Json.JsonElement.Source credentialsFile, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(audience, credentialsFile);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> audience, in Corvus.Text.Json.JsonElement.Source<TContext> credentialsFile, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, audience, credentialsFile);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<RequiredAudienceAndCredentialsFile, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RequiredAudienceAndCredentialsFile> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RequiredAudienceAndCredentialsFile>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredAudienceAndCredentialsFile> Create<TContext>(
            ...
            public static ParsedJsonDocument<RequiredAudienceAndCredentialsFile> Create(in Corvus.Text.Json.JsonElement.Source audience, in Corvus.Text.Json.JsonElement.Source credentialsFile, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredAudienceAndCredentialsFile> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> audience, in Corvus.Text.Json.JsonElement.Source<TContext> credentialsFile, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
