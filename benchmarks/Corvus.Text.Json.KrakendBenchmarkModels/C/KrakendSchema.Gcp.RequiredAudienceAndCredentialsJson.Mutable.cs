    ...
    public readonly partial struct Gcp
    {
        ...
        public readonly partial struct RequiredAudienceAndCredentialsJson
        {
...
#endif
            {
                ...
                public void SetAudience(in Corvus.Text.Json.JsonElement.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetCredentialsJson(in Corvus.Text.Json.JsonElement.Source value)
                {
                    CheckValidInstance();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Text.Json.JsonElement.Source audience, in Corvus.Text.Json.JsonElement.Source credentialsJson)
            {
            ...
            /// <param name="credentialsJson">The value of the <c>"credentials_json"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> audience, in Corvus.Text.Json.JsonElement.Source<TContext> credentialsJson)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
