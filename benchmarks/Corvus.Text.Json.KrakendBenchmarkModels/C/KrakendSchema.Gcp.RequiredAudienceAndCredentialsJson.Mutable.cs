...
public readonly partial struct KrakendSchema
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct Gcp
    {
        /// <summary>
        /// Generated from JSON Schema.
        /// </summary>
        [DebuggerDisplay("{DebuggerDisplay,nq}")]
        public readonly partial struct RequiredAudienceAndCredentialsJson
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequiredAudienceAndCredentialsJson instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequiredAudienceAndCredentialsJson"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredAudienceAndCredentialsJson(Mutable instance)
                {
                ...
                /// <summary>
                /// Gets the <c>audience</c> property.
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.JsonElement.Mutable Audience
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AudienceUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                        {
                            return value;
                        }
                ...
                /// <summary>
                /// Gets the <c>credentials_json</c> property.
                /// </summary>
                /// <remarks>
                /// <para>
                /// If the instance is valid, this property will not be <see cref="JsonValueKind.Undefined"/>, but may be <see cref="JsonValueKind.Null"/>.
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.JsonElement.Mutable CredentialsJson
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CredentialsJsonUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RequiredAudienceAndCredentialsJson(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetAudience(scoped in Corvus.Text.Json.JsonElement.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("audience");
                    }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetAudience<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetCredentialsJson(scoped in Corvus.Text.Json.JsonElement.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("credentials_json");
                    }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetCredentialsJson<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredAudienceAndCredentialsJson.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RequiredAudienceAndCredentialsJson"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RequiredAudienceAndCredentialsJson"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredAudienceAndCredentialsJson Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RequiredAudienceAndCredentialsJson>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RequiredAudienceAndCredentialsJson"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredAudienceAndCredentialsJson Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequiredAudienceAndCredentialsJson>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudienceAndCredentialsJson.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                public static implicit operator Source(RequiredAudienceAndCredentialsJson instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudienceAndCredentialsJson.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="RequiredAudienceAndCredentialsJson"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.Text.Json.JsonElement.Source audience,
                    in Corvus.Text.Json.JsonElement.Source credentialsJson)
                {
                ...
                /// Creates an instance of a <see cref="RequiredAudienceAndCredentialsJson"/>.
                /// </summary>
                public void Create(in Corvus.Text.Json.JsonElement.Source audience, in Corvus.Text.Json.JsonElement.Source credentialsJson)
                {
                    Create(ref _builder, audience, credentialsJson);
                }
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.Text.Json.JsonElement.Source<TContext> audience,
                    in Corvus.Text.Json.JsonElement.Source<TContext> credentialsJson)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                #endif
                {
                    Create(context, ref _builder, audience, credentialsJson);
                }
            ...
            /// <param name="credentialsJson">The value of the <c>"credentials_json"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Text.Json.JsonElement.Source audience, scoped in Corvus.Text.Json.JsonElement.Source credentialsJson)
            {
                return new Source(audience, credentialsJson);
            }
            ...
            /// <param name="credentialsJson">The value of the <c>"credentials_json"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> audience, scoped in Corvus.Text.Json.JsonElement.Source<TContext> credentialsJson)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Source<TContext>(context, audience, credentialsJson);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source audience, in Corvus.Text.Json.JsonElement.Source credentialsJson, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(audience, credentialsJson);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> audience, in Corvus.Text.Json.JsonElement.Source<TContext> credentialsJson, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, audience, credentialsJson);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<RequiredAudienceAndCredentialsJson, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RequiredAudienceAndCredentialsJson> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RequiredAudienceAndCredentialsJson>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredAudienceAndCredentialsJson> Create<TContext>(
            ...
            public static ParsedJsonDocument<RequiredAudienceAndCredentialsJson> Create(in Corvus.Text.Json.JsonElement.Source audience, in Corvus.Text.Json.JsonElement.Source credentialsJson, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredAudienceAndCredentialsJson> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> audience, in Corvus.Text.Json.JsonElement.Source<TContext> credentialsJson, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
