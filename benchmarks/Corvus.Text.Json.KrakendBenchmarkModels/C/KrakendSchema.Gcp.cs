...
public readonly partial struct KrakendSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Gcp"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Gcp(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Gcp DefaultInstance { get; }
        ...
        public static explicit operator Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudience(Gcp value)
        {
            return Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudience.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Gcp(Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudience value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudienceAndCredentialsFile(Gcp value)
        {
            return Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudienceAndCredentialsFile.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Gcp(Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudienceAndCredentialsFile value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudienceAndCredentialsJson(Gcp value)
        {
            return Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudienceAndCredentialsJson.From(value);
        }
        ...
        /// </returns>
        public static bool operator ==(in Gcp left, in Gcp right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Gcp left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Gcp instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Gcp(JsonElement instance)
        {
            return Gcp.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Gcp From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Gcp ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Gcp>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Gcp ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Gcp>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Gcp ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Gcp>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static Gcp ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Gcp>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Gcp? result)
        {
            return JsonElementHelpers.TryParseValue<Gcp>(ref reader, out result);
        }
...
#if NET
        static Gcp IJsonElement<Gcp>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Gcp: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public Gcp Freeze()
        {
            ...
            {
                return mutable.FreezeElement<Gcp>(_idx);
            }
        ...
        public bool TryGetAsRequiredAudience(out Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudience result)
        {
            ...
            {
                result = Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudience.From(this);
                return true;
            }
        ...
        public bool TryGetAsRequiredAudienceAndCredentialsFile(out Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudienceAndCredentialsFile result)
        {
            ...
            {
                result = Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudienceAndCredentialsFile.From(this);
                return true;
            }
        ...
        public bool TryGetAsRequiredAudienceAndCredentialsJson(out Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudienceAndCredentialsJson result)
        {
            ...
            {
                result = Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudienceAndCredentialsJson.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudience.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredAudience(Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudience.From(this), context);
            }

            if (Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudienceAndCredentialsFile.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredAudienceAndCredentialsFile(Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudienceAndCredentialsFile.From(this), context);
            }

            if (Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudienceAndCredentialsJson.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredAudienceAndCredentialsJson(Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudienceAndCredentialsJson.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp, TResult> defaultMatch)
        {
            if (Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudience.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredAudience(Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudience.From(this));
            }

            if (Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudienceAndCredentialsFile.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredAudienceAndCredentialsFile(Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudienceAndCredentialsFile.From(this));
            }

            if (Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudienceAndCredentialsJson.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredAudienceAndCredentialsJson(Corvus.KrakendBenchmark.Current.KrakendSchema.Gcp.RequiredAudienceAndCredentialsJson.From(this));
            }
