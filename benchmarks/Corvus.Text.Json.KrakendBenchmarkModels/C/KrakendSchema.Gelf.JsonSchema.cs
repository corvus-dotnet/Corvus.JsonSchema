...
public readonly partial struct KrakendSchema
{
        ...
        : IJsonElement<Gelf>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchEnableTcp(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
