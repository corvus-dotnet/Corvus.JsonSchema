...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Gelf
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Gelf instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Gelf"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Gelf(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Gelf.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Gelf Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Gelf>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(Gelf instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Gelf.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Gelf"/>.
            /// </summary>
        ...
        {
            return workspace.CreateBuilder<Gelf, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Gelf> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Gelf>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Gelf> Create<TContext>(
        ...
        public static ParsedJsonDocument<Gelf> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source address, in Corvus.KrakendBenchmark.Current.JsonBoolean.Source enableTcp, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
