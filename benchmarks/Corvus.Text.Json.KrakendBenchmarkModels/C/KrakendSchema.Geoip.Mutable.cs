...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Geoip
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Geoip instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Geoip"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Geoip(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Geoip(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetCitydbPath(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Geoip.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Geoip"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Geoip"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Geoip Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Geoip>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Geoip"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Geoip Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Geoip>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Geoip.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            public static implicit operator Source(Geoip instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Geoip.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Geoip"/>.
            /// </summary>
        ...
        /// </summary>
        /// <param name="citydbPath">The value of the <c>"citydb_path"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source citydbPath)
        {
            return new Source(citydbPath);
        }
        ...
        {
            return workspace.CreateBuilder<Geoip, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Geoip> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Geoip>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Geoip> Create<TContext>(
        ...
        public static ParsedJsonDocument<Geoip> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source citydbPath, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
