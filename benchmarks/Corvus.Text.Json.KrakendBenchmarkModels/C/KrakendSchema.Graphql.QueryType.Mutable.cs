...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Graphql
    {
        ...
        public readonly partial struct QueryType
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(QueryType instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="QueryType"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator QueryType(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new QueryType(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"QueryType.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="QueryType"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="QueryType"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly QueryType Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<QueryType>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="QueryType"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly QueryType Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<QueryType>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(QueryType instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (QueryType)value;
            ...
            {
                return workspace.CreateBuilder<QueryType, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<QueryType> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<QueryType>();
                }
                finally
                {
