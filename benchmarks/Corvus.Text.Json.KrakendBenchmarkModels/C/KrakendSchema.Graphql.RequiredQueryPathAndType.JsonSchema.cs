    ...
    public readonly partial struct Graphql
    {
            ...
            : IJsonElement<RequiredQueryPathAndType>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchQueryPath(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
