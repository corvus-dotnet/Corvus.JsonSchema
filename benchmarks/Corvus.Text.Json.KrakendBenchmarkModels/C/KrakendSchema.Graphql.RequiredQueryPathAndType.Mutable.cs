    ...
    public readonly partial struct Graphql
    {
        ...
        public readonly partial struct RequiredQueryPathAndType
        {
...
#endif
            {
                ...
                public void SetQueryPath(in Corvus.Text.Json.JsonElement.Source value)
                {
                    CheckValidInstance();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Text.Json.JsonElement.Source queryPath, in Corvus.Text.Json.JsonElement.Source type)
            {
            ...
            /// <param name="type">The value of the <c>"type"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> queryPath, in Corvus.Text.Json.JsonElement.Source<TContext> type)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
