...
public readonly partial struct KrakendSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Graphql"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Graphql(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Graphql DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Graphql.QueryType Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Graphql.QueryType value))
                {
                    return value;
                }
        ...
        public static explicit operator Corvus.KrakendBenchmark.Current.KrakendSchema.Graphql.RequiredQueryAndType(Graphql value)
        {
            return Corvus.KrakendBenchmark.Current.KrakendSchema.Graphql.RequiredQueryAndType.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Graphql(Corvus.KrakendBenchmark.Current.KrakendSchema.Graphql.RequiredQueryAndType value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.KrakendBenchmark.Current.KrakendSchema.Graphql.RequiredQueryPathAndType(Graphql value)
        {
            return Corvus.KrakendBenchmark.Current.KrakendSchema.Graphql.RequiredQueryPathAndType.From(value);
        }
        ...
        /// </returns>
        public static bool operator ==(in Graphql left, in Graphql right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Graphql left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Graphql instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Graphql(JsonElement instance)
        {
            return Graphql.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Graphql From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Graphql ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Graphql>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Graphql ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Graphql>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Graphql ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Graphql>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static Graphql ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Graphql>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Graphql? result)
        {
            return JsonElementHelpers.TryParseValue<Graphql>(ref reader, out result);
        }
...
#if NET
        static Graphql IJsonElement<Graphql>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Graphql: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public bool TryGetAsRequiredQueryAndType(out Corvus.KrakendBenchmark.Current.KrakendSchema.Graphql.RequiredQueryAndType result)
        {
            ...
            {
                result = Corvus.KrakendBenchmark.Current.KrakendSchema.Graphql.RequiredQueryAndType.From(this);
                return true;
            }
        ...
        public bool TryGetAsRequiredQueryPathAndType(out Corvus.KrakendBenchmark.Current.KrakendSchema.Graphql.RequiredQueryPathAndType result)
        {
            ...
            {
                result = Corvus.KrakendBenchmark.Current.KrakendSchema.Graphql.RequiredQueryPathAndType.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.KrakendBenchmark.Current.KrakendSchema.Graphql, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.KrakendBenchmark.Current.KrakendSchema.Graphql.RequiredQueryAndType.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredQueryAndType(Corvus.KrakendBenchmark.Current.KrakendSchema.Graphql.RequiredQueryAndType.From(this), context);
            }

            if (Corvus.KrakendBenchmark.Current.KrakendSchema.Graphql.RequiredQueryPathAndType.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredQueryPathAndType(Corvus.KrakendBenchmark.Current.KrakendSchema.Graphql.RequiredQueryPathAndType.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.KrakendBenchmark.Current.KrakendSchema.Graphql, TResult> defaultMatch)
        {
            if (Corvus.KrakendBenchmark.Current.KrakendSchema.Graphql.RequiredQueryAndType.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredQueryAndType(Corvus.KrakendBenchmark.Current.KrakendSchema.Graphql.RequiredQueryAndType.From(this));
            }

            if (Corvus.KrakendBenchmark.Current.KrakendSchema.Graphql.RequiredQueryPathAndType.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredQueryPathAndType(Corvus.KrakendBenchmark.Current.KrakendSchema.Graphql.RequiredQueryPathAndType.From(this));
            }
