    ...
    public readonly partial struct Grpc
    {
        ...
        public readonly partial struct DisableQueryParameters
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableQueryParameters, Mutable>(DisableQueryParameters.DefaultInstance);
                ...
                public static explicit operator Mutable(DisableQueryParameters instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DisableQueryParameters"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DisableQueryParameters(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DisableQueryParameters.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DisableQueryParameters Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DisableQueryParameters Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DisableQueryParameters>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DisableQueryParameters instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DisableQueryParameters, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DisableQueryParameters> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DisableQueryParameters>();
                }
                finally
                {
