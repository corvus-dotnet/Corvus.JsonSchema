    ...
    public readonly partial struct Grpc
    {
            ...
            : IJsonElement<MappingOfHeaders>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend~1grpc.json/properties/header_mapping"u8, buffer, out written);
