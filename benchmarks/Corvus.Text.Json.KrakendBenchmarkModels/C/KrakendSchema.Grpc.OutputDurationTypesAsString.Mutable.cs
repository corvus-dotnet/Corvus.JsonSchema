    ...
    public readonly partial struct Grpc
    {
        ...
        public readonly partial struct OutputDurationTypesAsString
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<OutputDurationTypesAsString, Mutable>(OutputDurationTypesAsString.DefaultInstance);
            ...
            public static ParsedJsonDocument<OutputDurationTypesAsString> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OutputDurationTypesAsString>();
                }
                finally
                {
