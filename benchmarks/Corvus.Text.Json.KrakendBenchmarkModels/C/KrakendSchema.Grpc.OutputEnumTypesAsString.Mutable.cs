    ...
    public readonly partial struct Grpc
    {
        ...
        public readonly partial struct OutputEnumTypesAsString
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<OutputEnumTypesAsString, Mutable>(OutputEnumTypesAsString.DefaultInstance);
            ...
            public static ParsedJsonDocument<OutputEnumTypesAsString> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OutputEnumTypesAsString>();
                }
                finally
                {
