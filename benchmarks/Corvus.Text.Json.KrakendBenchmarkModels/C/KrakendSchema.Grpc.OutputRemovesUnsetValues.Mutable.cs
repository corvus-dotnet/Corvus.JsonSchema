...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Grpc
    {
        ...
        public readonly partial struct OutputRemovesUnsetValues
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<OutputRemovesUnsetValues, Mutable>(OutputRemovesUnsetValues.DefaultInstance);
                ...
                public static explicit operator Mutable(OutputRemovesUnsetValues instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OutputRemovesUnsetValues"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OutputRemovesUnsetValues(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new OutputRemovesUnsetValues(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OutputRemovesUnsetValues.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="OutputRemovesUnsetValues"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="OutputRemovesUnsetValues"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly OutputRemovesUnsetValues Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<OutputRemovesUnsetValues>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="OutputRemovesUnsetValues"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly OutputRemovesUnsetValues Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OutputRemovesUnsetValues>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(OutputRemovesUnsetValues instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<OutputRemovesUnsetValues, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<OutputRemovesUnsetValues> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OutputRemovesUnsetValues>();
                }
                finally
                {
