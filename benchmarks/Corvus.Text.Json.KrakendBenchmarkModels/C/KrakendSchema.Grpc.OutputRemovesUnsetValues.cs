...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Grpc
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="OutputRemovesUnsetValues"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal OutputRemovesUnsetValues(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static OutputRemovesUnsetValues DefaultInstance { get; } = ParsedJsonDocument<OutputRemovesUnsetValues>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(OutputRemovesUnsetValues value)
            {
            ...
            /// </returns>
            public static bool operator ==(in OutputRemovesUnsetValues left, in OutputRemovesUnsetValues right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in OutputRemovesUnsetValues left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(OutputRemovesUnsetValues instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OutputRemovesUnsetValues(JsonElement instance)
            {
                return OutputRemovesUnsetValues.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OutputRemovesUnsetValues From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OutputRemovesUnsetValues ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OutputRemovesUnsetValues>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OutputRemovesUnsetValues ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OutputRemovesUnsetValues>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OutputRemovesUnsetValues ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OutputRemovesUnsetValues>(json, options);
            }
            ...
            /// </exception>
            public static OutputRemovesUnsetValues ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<OutputRemovesUnsetValues>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out OutputRemovesUnsetValues? result)
            {
                return JsonElementHelpers.TryParseValue<OutputRemovesUnsetValues>(ref reader, out result);
            }
...
#if NET
            static OutputRemovesUnsetValues IJsonElement<OutputRemovesUnsetValues>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OutputRemovesUnsetValues: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public OutputRemovesUnsetValues Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public OutputRemovesUnsetValues Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<OutputRemovesUnsetValues>(_idx);
                }
