    ...
    public readonly partial struct Grpc
    {
        ...
        public readonly partial struct OutputTimestampsTypesAsString
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<OutputTimestampsTypesAsString, Mutable>(OutputTimestampsTypesAsString.DefaultInstance);
                ...
                public static explicit operator Mutable(OutputTimestampsTypesAsString instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OutputTimestampsTypesAsString"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OutputTimestampsTypesAsString(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OutputTimestampsTypesAsString.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly OutputTimestampsTypesAsString Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly OutputTimestampsTypesAsString Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OutputTimestampsTypesAsString>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(OutputTimestampsTypesAsString instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<OutputTimestampsTypesAsString, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<OutputTimestampsTypesAsString> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OutputTimestampsTypesAsString>();
                }
                finally
                {
