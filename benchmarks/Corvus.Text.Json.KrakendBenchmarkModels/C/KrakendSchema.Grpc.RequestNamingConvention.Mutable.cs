    ...
    public readonly partial struct Grpc
    {
        ...
        public readonly partial struct RequestNamingConvention
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<RequestNamingConvention, Mutable>(RequestNamingConvention.DefaultInstance);
            ...
            public ref struct Source
            {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (RequestNamingConvention)value;
            ...
            public static ParsedJsonDocument<RequestNamingConvention> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RequestNamingConvention>();
                }
                finally
                {
