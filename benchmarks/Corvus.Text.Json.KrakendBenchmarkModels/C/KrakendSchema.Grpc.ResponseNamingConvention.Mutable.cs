    ...
    public readonly partial struct Grpc
    {
        ...
        public readonly partial struct ResponseNamingConvention
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ResponseNamingConvention, Mutable>(ResponseNamingConvention.DefaultInstance);
                ...
                public static explicit operator Mutable(ResponseNamingConvention instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ResponseNamingConvention"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ResponseNamingConvention(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ResponseNamingConvention.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ResponseNamingConvention Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ResponseNamingConvention Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ResponseNamingConvention>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ResponseNamingConvention instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (ResponseNamingConvention)value;
            ...
            {
                return workspace.CreateBuilder<ResponseNamingConvention, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ResponseNamingConvention> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ResponseNamingConvention>();
                }
                finally
                {
