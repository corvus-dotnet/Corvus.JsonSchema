...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Http
    {
        ...
        public readonly partial struct AllowedHosts
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AllowedHosts, Mutable>(AllowedHosts.DefaultInstance);
                ...
                public static explicit operator Mutable(AllowedHosts instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AllowedHosts"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AllowedHosts(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new AllowedHosts(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AllowedHosts.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// <summary>
                /// Gets a <see cref="AllowedHosts"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="AllowedHosts"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly AllowedHosts Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<AllowedHosts>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="AllowedHosts"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly AllowedHosts Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AllowedHosts>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Http.AllowedHosts.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(AllowedHosts instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Http.AllowedHosts.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<AllowedHosts, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AllowedHosts> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AllowedHosts>();
                }
                finally
                {
