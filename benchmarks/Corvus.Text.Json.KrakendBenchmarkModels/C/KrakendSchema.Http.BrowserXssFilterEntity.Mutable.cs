...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Http
    {
        ...
        public readonly partial struct BrowserXssFilterEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<BrowserXssFilterEntity, Mutable>(BrowserXssFilterEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(BrowserXssFilterEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="BrowserXssFilterEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator BrowserXssFilterEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new BrowserXssFilterEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"BrowserXssFilterEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="BrowserXssFilterEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="BrowserXssFilterEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly BrowserXssFilterEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<BrowserXssFilterEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="BrowserXssFilterEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly BrowserXssFilterEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<BrowserXssFilterEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(BrowserXssFilterEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<BrowserXssFilterEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<BrowserXssFilterEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<BrowserXssFilterEntity>();
                }
                finally
                {
