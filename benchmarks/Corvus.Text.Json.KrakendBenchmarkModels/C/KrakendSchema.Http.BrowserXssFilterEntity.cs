...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Http
    {
...
#endif
        {
            ...
            internal BrowserXssFilterEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static BrowserXssFilterEntity DefaultInstance { get; } = ParsedJsonDocument<BrowserXssFilterEntity>.False;
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in BrowserXssFilterEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(BrowserXssFilterEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BrowserXssFilterEntity(JsonElement instance)
            {
                return BrowserXssFilterEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BrowserXssFilterEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BrowserXssFilterEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BrowserXssFilterEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BrowserXssFilterEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BrowserXssFilterEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BrowserXssFilterEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BrowserXssFilterEntity>(json, options);
            }
            ...
            /// </exception>
            public static BrowserXssFilterEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<BrowserXssFilterEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out BrowserXssFilterEntity? result)
            {
                return JsonElementHelpers.TryParseValue<BrowserXssFilterEntity>(ref reader, out result);
            }
...
#if NET
            static BrowserXssFilterEntity IJsonElement<BrowserXssFilterEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BrowserXssFilterEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public BrowserXssFilterEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public BrowserXssFilterEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<BrowserXssFilterEntity>(_idx);
                }
