    ...
    public readonly partial struct Http
    {
        ...
        public readonly partial struct ClickjackingProtection
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ClickjackingProtection, Mutable>(ClickjackingProtection.DefaultInstance);
            ...
            public static ParsedJsonDocument<ClickjackingProtection> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ClickjackingProtection>();
                }
                finally
                {
