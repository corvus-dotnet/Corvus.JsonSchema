    ...
    public readonly partial struct Http
    {
        ...
        public readonly partial struct ClickjackingProtectionFrameOptionsValue
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ClickjackingProtectionFrameOptionsValue, Mutable>(ClickjackingProtectionFrameOptionsValue.DefaultInstance);
            ...
            public static ParsedJsonDocument<ClickjackingProtectionFrameOptionsValue> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ClickjackingProtectionFrameOptionsValue>();
                }
                finally
                {
