    ...
    public readonly partial struct Http
    {
        ...
        public readonly partial struct ContentSecurityPolicyCsp
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ContentSecurityPolicyCsp, Mutable>(ContentSecurityPolicyCsp.DefaultInstance);
            ...
            public static ParsedJsonDocument<ContentSecurityPolicyCsp> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ContentSecurityPolicyCsp>();
                }
                finally
                {
