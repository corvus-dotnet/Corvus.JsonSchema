    ...
    public readonly partial struct Http
    {
        ...
        public readonly partial struct DevelopmentFlag
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DevelopmentFlag, Mutable>(DevelopmentFlag.DefaultInstance);
                ...
                public static explicit operator Mutable(DevelopmentFlag instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DevelopmentFlag"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DevelopmentFlag(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DevelopmentFlag.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DevelopmentFlag Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DevelopmentFlag Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DevelopmentFlag>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DevelopmentFlag instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DevelopmentFlag, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DevelopmentFlag> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DevelopmentFlag>();
                }
                finally
                {
