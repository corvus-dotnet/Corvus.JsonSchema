    ...
    public readonly partial struct Http
    {
        ...
        public readonly partial struct ForceStsHeader
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ForceStsHeader, Mutable>(ForceStsHeader.DefaultInstance);
            ...
            public static ParsedJsonDocument<ForceStsHeader> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ForceStsHeader>();
                }
                finally
                {
