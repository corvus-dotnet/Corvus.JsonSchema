...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Http
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ForceStsHeader"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ForceStsHeader(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ForceStsHeader DefaultInstance { get; } = ParsedJsonDocument<ForceStsHeader>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(ForceStsHeader value)
            {
            ...
            /// </returns>
            public static bool operator ==(in ForceStsHeader left, in ForceStsHeader right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ForceStsHeader left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ForceStsHeader instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ForceStsHeader(JsonElement instance)
            {
                return ForceStsHeader.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ForceStsHeader From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ForceStsHeader ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ForceStsHeader>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ForceStsHeader ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ForceStsHeader>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ForceStsHeader ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ForceStsHeader>(json, options);
            }
            ...
            /// </exception>
            public static ForceStsHeader ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ForceStsHeader>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ForceStsHeader? result)
            {
                return JsonElementHelpers.TryParseValue<ForceStsHeader>(ref reader, out result);
            }
...
#if NET
            static ForceStsHeader IJsonElement<ForceStsHeader>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ForceStsHeader: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ForceStsHeader Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ForceStsHeader>(_idx);
                }
