    ...
    public readonly partial struct Http
    {
        ...
        public readonly partial struct HostsAreRegexps
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<HostsAreRegexps, Mutable>(HostsAreRegexps.DefaultInstance);
            ...
            public static ParsedJsonDocument<HostsAreRegexps> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<HostsAreRegexps>();
                }
                finally
                {
