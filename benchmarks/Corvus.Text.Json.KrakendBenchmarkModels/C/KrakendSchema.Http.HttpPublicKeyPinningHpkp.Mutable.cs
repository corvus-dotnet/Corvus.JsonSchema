    ...
    public readonly partial struct Http
    {
        ...
        public readonly partial struct HttpPublicKeyPinningHpkp
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<HttpPublicKeyPinningHpkp, Mutable>(HttpPublicKeyPinningHpkp.DefaultInstance);
                ...
                public static explicit operator Mutable(HttpPublicKeyPinningHpkp instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="HttpPublicKeyPinningHpkp"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator HttpPublicKeyPinningHpkp(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"HttpPublicKeyPinningHpkp.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly HttpPublicKeyPinningHpkp Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly HttpPublicKeyPinningHpkp Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<HttpPublicKeyPinningHpkp>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(HttpPublicKeyPinningHpkp instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<HttpPublicKeyPinningHpkp, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<HttpPublicKeyPinningHpkp> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<HttpPublicKeyPinningHpkp>();
                }
                finally
                {
