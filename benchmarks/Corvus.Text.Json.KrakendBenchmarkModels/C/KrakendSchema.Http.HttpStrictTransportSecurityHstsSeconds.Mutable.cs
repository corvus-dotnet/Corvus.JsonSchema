    ...
    public readonly partial struct Http
    {
        ...
        public readonly partial struct HttpStrictTransportSecurityHstsSeconds
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<HttpStrictTransportSecurityHstsSeconds, Mutable>(HttpStrictTransportSecurityHstsSeconds.DefaultInstance);
                ...
                public static explicit operator Mutable(HttpStrictTransportSecurityHstsSeconds instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="HttpStrictTransportSecurityHstsSeconds"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator HttpStrictTransportSecurityHstsSeconds(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"HttpStrictTransportSecurityHstsSeconds.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly HttpStrictTransportSecurityHstsSeconds Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly HttpStrictTransportSecurityHstsSeconds Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<HttpStrictTransportSecurityHstsSeconds>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(HttpStrictTransportSecurityHstsSeconds instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<HttpStrictTransportSecurityHstsSeconds, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<HttpStrictTransportSecurityHstsSeconds> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<HttpStrictTransportSecurityHstsSeconds>();
                }
                finally
                {
