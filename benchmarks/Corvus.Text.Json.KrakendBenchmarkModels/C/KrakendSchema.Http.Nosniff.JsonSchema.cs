    ...
    public readonly partial struct Http
    {
            ...
            : IJsonElement<Nosniff>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1security~1http.json/properties/content_type_nosniff"u8, buffer, out written);
