    ...
    public readonly partial struct Http
    {
        ...
        public readonly partial struct Nosniff
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<Nosniff, Mutable>(Nosniff.DefaultInstance);
            ...
            public static ParsedJsonDocument<Nosniff> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Nosniff>();
                }
                finally
                {
