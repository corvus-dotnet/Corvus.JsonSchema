    ...
    public readonly partial struct Http
    {
        ...
        public readonly partial struct ReferrerPolicy
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ReferrerPolicy, Mutable>(ReferrerPolicy.DefaultInstance);
            ...
            public static ParsedJsonDocument<ReferrerPolicy> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ReferrerPolicy>();
                }
                finally
                {
