...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Http
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ReferrerPolicy"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ReferrerPolicy(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ReferrerPolicy DefaultInstance { get; } = ParsedJsonDocument<ReferrerPolicy>.StringConstant([.."\"same-origin\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ReferrerPolicy value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in ReferrerPolicy left, in ReferrerPolicy right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ReferrerPolicy left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ReferrerPolicy instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ReferrerPolicy(JsonElement instance)
            {
                return ReferrerPolicy.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ReferrerPolicy From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ReferrerPolicy ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ReferrerPolicy>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ReferrerPolicy ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ReferrerPolicy>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ReferrerPolicy ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ReferrerPolicy>(json, options);
            }
            ...
            /// </exception>
            public static ReferrerPolicy ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ReferrerPolicy>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ReferrerPolicy? result)
            {
                return JsonElementHelpers.TryParseValue<ReferrerPolicy>(ref reader, out result);
            }
...
#if NET
            static ReferrerPolicy IJsonElement<ReferrerPolicy>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ReferrerPolicy: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ReferrerPolicy Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ReferrerPolicy>(_idx);
                }
