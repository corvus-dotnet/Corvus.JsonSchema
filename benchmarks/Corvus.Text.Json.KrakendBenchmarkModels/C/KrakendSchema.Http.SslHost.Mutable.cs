...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Http
    {
        ...
        public readonly partial struct SslHost
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SslHost, Mutable>(SslHost.DefaultInstance);
                ...
                public static explicit operator Mutable(SslHost instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SslHost"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SslHost(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new SslHost(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SslHost.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="SslHost"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="SslHost"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly SslHost Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<SslHost>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="SslHost"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly SslHost Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SslHost>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SslHost instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SslHost, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SslHost> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SslHost>();
                }
                finally
                {
