    ...
    public readonly partial struct Http
    {
        ...
        public readonly partial struct StrictTransportSecurityIncludeSubdomains
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<StrictTransportSecurityIncludeSubdomains, Mutable>(StrictTransportSecurityIncludeSubdomains.DefaultInstance);
            ...
            public static ParsedJsonDocument<StrictTransportSecurityIncludeSubdomains> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<StrictTransportSecurityIncludeSubdomains>();
                }
                finally
                {
