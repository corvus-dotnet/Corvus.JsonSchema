...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Http
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="StrictTransportSecurityIncludeSubdomains"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal StrictTransportSecurityIncludeSubdomains(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static StrictTransportSecurityIncludeSubdomains DefaultInstance { get; } = ParsedJsonDocument<StrictTransportSecurityIncludeSubdomains>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(StrictTransportSecurityIncludeSubdomains value)
            {
            ...
            /// </returns>
            public static bool operator ==(in StrictTransportSecurityIncludeSubdomains left, in StrictTransportSecurityIncludeSubdomains right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in StrictTransportSecurityIncludeSubdomains left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(StrictTransportSecurityIncludeSubdomains instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator StrictTransportSecurityIncludeSubdomains(JsonElement instance)
            {
                return StrictTransportSecurityIncludeSubdomains.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StrictTransportSecurityIncludeSubdomains From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StrictTransportSecurityIncludeSubdomains ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<StrictTransportSecurityIncludeSubdomains>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StrictTransportSecurityIncludeSubdomains ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<StrictTransportSecurityIncludeSubdomains>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StrictTransportSecurityIncludeSubdomains ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<StrictTransportSecurityIncludeSubdomains>(json, options);
            }
            ...
            /// </exception>
            public static StrictTransportSecurityIncludeSubdomains ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<StrictTransportSecurityIncludeSubdomains>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out StrictTransportSecurityIncludeSubdomains? result)
            {
                return JsonElementHelpers.TryParseValue<StrictTransportSecurityIncludeSubdomains>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new StrictTransportSecurityIncludeSubdomains(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static StrictTransportSecurityIncludeSubdomains IJsonElement<StrictTransportSecurityIncludeSubdomains>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"StrictTransportSecurityIncludeSubdomains: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="StrictTransportSecurityIncludeSubdomains"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="StrictTransportSecurityIncludeSubdomains"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public StrictTransportSecurityIncludeSubdomains Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<StrictTransportSecurityIncludeSubdomains>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="StrictTransportSecurityIncludeSubdomains"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public StrictTransportSecurityIncludeSubdomains Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<StrictTransportSecurityIncludeSubdomains>(_idx);
                }
