...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct HttpClient
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(HttpClient instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="HttpClient"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator HttpClient(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.HttpClient.NoRedirect.Mutable NoRedirectValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NoRedirectValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.HttpClient.NoRedirect.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.KrakendBenchmark.Current.KrakendSchema.HttpClient.NoRedirect.Mutable.DefaultInstance;
                }
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"HttpClient.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly HttpClient Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly HttpClient Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<HttpClient>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.HttpClient.NoRedirect.Source _createArg2;
            ...
            public static implicit operator Source(HttpClient instance) => new(JsonElement.From(instance));
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="HttpClient"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.ClientTls.Source clientTls = default,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.HttpClient.NoRedirect.Source noRedirect = default,
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.ClientTls.Source<TContext> clientTls = default, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.HttpClient.NoRedirect.Source noRedirect = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> proxyAddress = default)
            ...
            #endif
        {
            return new Source<TContext>(context, clientTls, noRedirect, proxyAddress);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.ClientTls.Source clientTls = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.HttpClient.NoRedirect.Source noRedirect = default, in Corvus.Text.Json.JsonElement.Source proxyAddress = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.ClientTls.Source<TContext> clientTls = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.HttpClient.NoRedirect.Source noRedirect = default, in Corvus.Text.Json.JsonElement.Source<TContext> proxyAddress = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        {
            return workspace.CreateBuilder<HttpClient, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<HttpClient> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<HttpClient>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<HttpClient> Create<TContext>(
        ...
        public static ParsedJsonDocument<HttpClient> Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.ClientTls.Source clientTls = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.HttpClient.NoRedirect.Source noRedirect = default, in Corvus.Text.Json.JsonElement.Source proxyAddress = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<HttpClient> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.ClientTls.Source<TContext> clientTls = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.HttpClient.NoRedirect.Source noRedirect = default, in Corvus.Text.Json.JsonElement.Source<TContext> proxyAddress = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
