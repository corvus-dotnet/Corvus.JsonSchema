    ...
    public readonly partial struct HttpClient
    {
        ...
        public readonly partial struct NoRedirect
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NoRedirect, Mutable>(NoRedirect.DefaultInstance);
                ...
                public static explicit operator Mutable(NoRedirect instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="NoRedirect"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator NoRedirect(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"NoRedirect.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly NoRedirect Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly NoRedirect Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<NoRedirect>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(NoRedirect instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<NoRedirect, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<NoRedirect> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<NoRedirect>();
                }
                finally
                {
