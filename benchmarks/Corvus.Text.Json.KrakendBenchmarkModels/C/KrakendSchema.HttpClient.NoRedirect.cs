...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct HttpClient
    {
        ...
        public readonly partial struct NoRedirect
#if NET8_0_OR_GREATER
            : IJsonElement<NoRedirect>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="NoRedirect"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal NoRedirect(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static NoRedirect DefaultInstance { get; } = ParsedJsonDocument<NoRedirect>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(NoRedirect value)
            {
            ...
            /// </returns>
            public static bool operator ==(in NoRedirect left, in NoRedirect right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in NoRedirect left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(NoRedirect instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NoRedirect(JsonElement instance)
            {
                return NoRedirect.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NoRedirect From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NoRedirect ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NoRedirect>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NoRedirect ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NoRedirect>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NoRedirect ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NoRedirect>(json, options);
            }
            ...
            /// </exception>
            public static NoRedirect ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<NoRedirect>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out NoRedirect? result)
            {
                return JsonElementHelpers.TryParseValue<NoRedirect>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new NoRedirect(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static NoRedirect IJsonElement<NoRedirect>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"NoRedirect: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="NoRedirect"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="NoRedirect"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public NoRedirect Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<NoRedirect>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="NoRedirect"/> that lives for the lifetime of its
