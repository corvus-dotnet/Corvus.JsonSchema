    ...
    public readonly partial struct HttpServer
    {
            ...
            : IJsonElement<PluginName>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1plugin~1http-server.json/properties/name"u8, buffer, out written);
