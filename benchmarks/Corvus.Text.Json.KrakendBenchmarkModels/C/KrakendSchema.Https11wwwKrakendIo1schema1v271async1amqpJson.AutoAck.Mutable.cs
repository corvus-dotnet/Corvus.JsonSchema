    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271async1amqpJson
    {
        ...
        public readonly partial struct AutoAck
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AutoAck instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AutoAck"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AutoAck(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new AutoAck(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AutoAck.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="AutoAck"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="AutoAck"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly AutoAck Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<AutoAck>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="AutoAck"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly AutoAck Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AutoAck>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AutoAck instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AutoAck, Mutable>(this);
            }
        }
    }
}
