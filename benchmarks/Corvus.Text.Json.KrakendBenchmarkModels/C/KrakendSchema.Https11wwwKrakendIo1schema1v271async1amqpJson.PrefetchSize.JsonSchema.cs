    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271async1amqpJson
    {
            ...
            : IJsonElement<PrefetchSize>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1async~1amqp.json/properties/prefetch_size"u8, buffer, out written);
