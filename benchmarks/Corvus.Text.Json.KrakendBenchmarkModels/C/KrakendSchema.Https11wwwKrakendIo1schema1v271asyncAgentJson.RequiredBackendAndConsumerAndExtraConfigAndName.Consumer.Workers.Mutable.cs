            ...
            public readonly partial struct Consumer
            {
                ...
                public readonly partial struct Workers
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(Workers instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="Workers"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator Workers(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"Workers.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly Workers Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<Workers>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(Workers instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<Workers, Mutable>(this);
                    }
                }
            }
        }
