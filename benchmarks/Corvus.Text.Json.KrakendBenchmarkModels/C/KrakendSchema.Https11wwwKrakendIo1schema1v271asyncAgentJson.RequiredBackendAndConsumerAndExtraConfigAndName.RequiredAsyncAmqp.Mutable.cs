        ...
        public readonly partial struct RequiredBackendAndConsumerAndExtraConfigAndName
        {
            ...
            public readonly partial struct RequiredAsyncAmqp
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271async1amqpJson.Mutable AsyncAmqp
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AsyncAmqpUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271async1amqpJson.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetAsyncAmqp(in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271async1amqpJson.Source value)
                    {
                        CheckValidInstance();
                        ...
                        else
                        {
                            ...
                            value.AddAsProperty(JsonPropertyNamesEscaped.AsyncAmqp, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetAsyncAmqp<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271async1amqpJson.Source<TContext> value)
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271asyncAgentJson.RequiredBackendAndConsumerAndExtraConfigAndName.RequiredAsyncAmqp.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271asyncAgentJson.RequiredBackendAndConsumerAndExtraConfigAndName.RequiredAsyncAmqp.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271async1amqpJson.Source asyncAmqp)
                    {
                        asyncAmqp.AddAsProperty(JsonPropertyNamesEscaped.AsyncAmqp, ref builder, escapeName: false);
                    }

                    /// <summary>
                    /// Creates an instance of a <see cref="RequiredAsyncAmqp"/>.
                    /// </summary>
                    public void Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271async1amqpJson.Source asyncAmqp)
                    {
                    ...
                    internal static void Create<TContext>(
                        ...
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271async1amqpJson.Source<TContext> asyncAmqp)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    {
                    ...
                    /// Creates an instance of a <see cref="RequiredAsyncAmqp"/>.
                    /// </summary>
                    public void Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271async1amqpJson.Source<TContext> asyncAmqp)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271async1amqpJson.Source asyncAmqp, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271async1amqpJson.Source<TContext> asyncAmqp, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
