...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1apiKeysJson
    {
...
#endif
        {
            ...
            /// </summary>
            public static Identifier DefaultInstance { get; } = ParsedJsonDocument<Identifier>.StringConstant([.."\"Authorization\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(Identifier value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
