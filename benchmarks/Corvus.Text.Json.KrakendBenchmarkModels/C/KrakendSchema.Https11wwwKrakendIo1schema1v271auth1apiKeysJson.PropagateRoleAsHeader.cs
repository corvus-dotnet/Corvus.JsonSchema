...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1apiKeysJson
    {
        ...
        public readonly partial struct PropagateRoleAsHeader
#if NET8_0_OR_GREATER
            : IJsonElement<PropagateRoleAsHeader>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="PropagateRoleAsHeader"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal PropagateRoleAsHeader(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static PropagateRoleAsHeader DefaultInstance { get; } = ParsedJsonDocument<PropagateRoleAsHeader>.StringConstant([.."\"\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(PropagateRoleAsHeader value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in PropagateRoleAsHeader left, in PropagateRoleAsHeader right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in PropagateRoleAsHeader left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(PropagateRoleAsHeader instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PropagateRoleAsHeader(JsonElement instance)
            {
                return PropagateRoleAsHeader.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PropagateRoleAsHeader From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PropagateRoleAsHeader ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PropagateRoleAsHeader>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PropagateRoleAsHeader ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PropagateRoleAsHeader>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PropagateRoleAsHeader ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PropagateRoleAsHeader>(json, options);
            }
            ...
            /// </exception>
            public static PropagateRoleAsHeader ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<PropagateRoleAsHeader>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out PropagateRoleAsHeader? result)
            {
                return JsonElementHelpers.TryParseValue<PropagateRoleAsHeader>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PropagateRoleAsHeader(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static PropagateRoleAsHeader IJsonElement<PropagateRoleAsHeader>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PropagateRoleAsHeader: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="PropagateRoleAsHeader"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="PropagateRoleAsHeader"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public PropagateRoleAsHeader Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<PropagateRoleAsHeader>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="PropagateRoleAsHeader"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public PropagateRoleAsHeader Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<PropagateRoleAsHeader>(_idx);
                }
