    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson
    {
        ...
        public readonly partial struct EndpointParameters
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(EndpointParameters instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EndpointParameters"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EndpointParameters(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EndpointParameters.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly EndpointParameters Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly EndpointParameters Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EndpointParameters>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson.EndpointParameters.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(EndpointParameters instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson.EndpointParameters.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<EndpointParameters, Mutable>(this);
            }
        }
    }
}
