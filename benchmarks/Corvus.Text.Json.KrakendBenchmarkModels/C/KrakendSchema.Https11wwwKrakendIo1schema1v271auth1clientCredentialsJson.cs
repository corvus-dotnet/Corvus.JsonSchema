...
public readonly partial struct KrakendSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.JsonString ClientId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ClientIdUtf8, out Corvus.KrakendBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.JsonString ClientSecret
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ClientSecretUtf8, out Corvus.KrakendBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.JsonString Scopes
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopesUtf8, out Corvus.KrakendBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.JsonString TokenUrl
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TokenUrlUtf8, out Corvus.KrakendBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson left, in Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson(JsonElement instance)
        {
            return Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson>(json, options);
        }
        ...
        /// </exception>
        public static Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson? result)
        {
            return JsonElementHelpers.TryParseValue<Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson IJsonElement<Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<Https11wwwKrakendIo1schema1v271auth1clientCredentialsJson>(_idx);
            }
        ...
        private static class JsonPropertyNamesEscaped
        {
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="ClientSecret"/>.
            /// </summary>
            public static ReadOnlySpan<byte> ClientSecret => "client_secret"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="EndpointParams"/>.
            /// </summary>
            public static ReadOnlySpan<byte> EndpointParams => "endpoint_params"u8;
