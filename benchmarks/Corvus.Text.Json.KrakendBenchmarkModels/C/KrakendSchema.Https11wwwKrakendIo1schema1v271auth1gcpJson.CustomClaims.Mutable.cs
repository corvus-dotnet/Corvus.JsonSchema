    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1gcpJson
    {
        ...
        public readonly partial struct CustomClaims
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(CustomClaims instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CustomClaims"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CustomClaims(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CustomClaims.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly CustomClaims Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly CustomClaims Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CustomClaims>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271auth1gcpJson.CustomClaims.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(CustomClaims instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271auth1gcpJson.CustomClaims.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<CustomClaims, Mutable>(this);
            }
        }
    }
}
