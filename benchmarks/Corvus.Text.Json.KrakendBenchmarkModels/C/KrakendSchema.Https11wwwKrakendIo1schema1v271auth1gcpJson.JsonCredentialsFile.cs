...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1gcpJson
    {
        ...
        public readonly partial struct JsonCredentialsFile
#if NET8_0_OR_GREATER
            : IJsonElement<JsonCredentialsFile>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="JsonCredentialsFile"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal JsonCredentialsFile(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static JsonCredentialsFile DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in JsonCredentialsFile left, in JsonCredentialsFile right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in JsonCredentialsFile left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(JsonCredentialsFile instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonCredentialsFile(JsonElement instance)
            {
                return JsonCredentialsFile.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static JsonCredentialsFile From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static JsonCredentialsFile ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<JsonCredentialsFile>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static JsonCredentialsFile ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<JsonCredentialsFile>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static JsonCredentialsFile ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<JsonCredentialsFile>(json, options);
            }
            ...
            /// </exception>
            public static JsonCredentialsFile ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<JsonCredentialsFile>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out JsonCredentialsFile? result)
            {
                return JsonElementHelpers.TryParseValue<JsonCredentialsFile>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new JsonCredentialsFile(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static JsonCredentialsFile IJsonElement<JsonCredentialsFile>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"JsonCredentialsFile: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="JsonCredentialsFile"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="JsonCredentialsFile"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public JsonCredentialsFile Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<JsonCredentialsFile>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="JsonCredentialsFile"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public JsonCredentialsFile Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<JsonCredentialsFile>(_idx);
                }
