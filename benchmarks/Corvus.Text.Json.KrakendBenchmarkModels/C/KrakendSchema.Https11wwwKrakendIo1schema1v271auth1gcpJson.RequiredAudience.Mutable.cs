    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1gcpJson
    {
        ...
        public readonly partial struct RequiredAudience
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequiredAudience instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequiredAudience"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredAudience(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredAudience.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredAudience Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredAudience Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequiredAudience>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271auth1gcpJson.RequiredAudience.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(RequiredAudience instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271auth1gcpJson.RequiredAudience.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.JsonElement.Source audience)
                {
                ...
                /// Creates an instance of a <see cref="RequiredAudience"/>.
                /// </summary>
                public void Create(in Corvus.Text.Json.JsonElement.Source audience)
                {
                    Create(ref _builder, audience);
                }
                ...
                /// Creates an instance of a <see cref="RequiredAudience"/>.
                /// </summary>
                public void Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> audience)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                    Create(context, ref _builder, audience);
                }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source audience, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> audience, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            {
                return workspace.CreateBuilder<RequiredAudience, Mutable>(this);
            }
        }
    }
}
