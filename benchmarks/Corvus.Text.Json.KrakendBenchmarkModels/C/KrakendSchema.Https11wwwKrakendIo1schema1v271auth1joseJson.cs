...
public readonly partial struct KrakendSchema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.JsonInteger SharedCacheDuration
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SharedCacheDurationUtf8, out Corvus.KrakendBenchmark.Current.JsonInteger value))
                {
                    return value;
                }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="SharedCacheDuration"/>.
            /// </summary>
            public static ReadOnlySpan<byte> SharedCacheDuration => [0x75, 0x01, 0x00, 0x00, 0x22, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x5F, 0x63, 0x61, 0x63, 0x68, 0x65, 0x5F, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6F, 0x6E, 0x22];
        }
    }
}
