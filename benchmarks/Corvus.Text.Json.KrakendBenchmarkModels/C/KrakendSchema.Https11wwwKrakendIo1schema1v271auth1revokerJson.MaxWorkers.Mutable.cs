    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1revokerJson
    {
        ...
        public readonly partial struct MaxWorkers
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(MaxWorkers instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MaxWorkers"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MaxWorkers(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MaxWorkers.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MaxWorkers Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MaxWorkers Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MaxWorkers>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MaxWorkers instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MaxWorkers, Mutable>(this);
            }
        }
    }
}
