...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1revokerJson
    {
        ...
        public readonly partial struct TokenKeys
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TokenKeys instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TokenKeys"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TokenKeys(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TokenKeys(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TokenKeys.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// <summary>
                /// Gets a <see cref="TokenKeys"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TokenKeys"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly TokenKeys Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TokenKeys>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TokenKeys"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly TokenKeys Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TokenKeys>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271auth1revokerJson.TokenKeys.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(TokenKeys instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271auth1revokerJson.TokenKeys.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<TokenKeys, Mutable>(this);
            }
        }
    }
}
