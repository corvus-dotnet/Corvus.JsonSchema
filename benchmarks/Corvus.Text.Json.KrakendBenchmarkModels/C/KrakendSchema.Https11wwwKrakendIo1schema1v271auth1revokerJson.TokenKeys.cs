...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1revokerJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="TokenKeys"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal TokenKeys(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static TokenKeys DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in TokenKeys left, in TokenKeys right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in TokenKeys left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(TokenKeys instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TokenKeys(JsonElement instance)
            {
                return TokenKeys.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TokenKeys From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TokenKeys ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TokenKeys>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TokenKeys ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TokenKeys>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TokenKeys ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TokenKeys>(json, options);
            }
            ...
            /// </exception>
            public static TokenKeys ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<TokenKeys>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out TokenKeys? result)
            {
                return JsonElementHelpers.TryParseValue<TokenKeys>(ref reader, out result);
            }
...
#if NET
            static TokenKeys IJsonElement<TokenKeys>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TokenKeys: ValueKind = {ValueKind} : \"{ToString()}\"";
