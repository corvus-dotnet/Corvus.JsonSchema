    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1signerJson
    {
        ...
        public readonly partial struct Algorithm
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Algorithm instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Algorithm"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Algorithm(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Algorithm.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly Algorithm Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly Algorithm Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Algorithm>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Algorithm instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<Algorithm, Mutable>(this);
            }
        }
    }
}
