    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1signerJson
    {
        ...
        public readonly partial struct FullFormat
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(FullFormat instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="FullFormat"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FullFormat(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FullFormat.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly FullFormat Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly FullFormat Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<FullFormat>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(FullFormat instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<FullFormat, Mutable>(this);
            }
        }
    }
}
