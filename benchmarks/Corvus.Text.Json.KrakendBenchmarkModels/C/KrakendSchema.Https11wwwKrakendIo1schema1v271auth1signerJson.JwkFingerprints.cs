...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1signerJson
    {
        ...
        public readonly partial struct JwkFingerprints
#if NET8_0_OR_GREATER
            : IJsonElement<JwkFingerprints>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="JwkFingerprints"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal JwkFingerprints(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static JwkFingerprints DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in JwkFingerprints left, in JwkFingerprints right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in JwkFingerprints left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(JwkFingerprints instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JwkFingerprints(JsonElement instance)
            {
                return JwkFingerprints.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static JwkFingerprints From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static JwkFingerprints ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<JwkFingerprints>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static JwkFingerprints ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<JwkFingerprints>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static JwkFingerprints ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<JwkFingerprints>(json, options);
            }
            ...
            /// </exception>
            public static JwkFingerprints ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<JwkFingerprints>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out JwkFingerprints? result)
            {
                return JsonElementHelpers.TryParseValue<JwkFingerprints>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new JwkFingerprints(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static JwkFingerprints IJsonElement<JwkFingerprints>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"JwkFingerprints: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="JwkFingerprints"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="JwkFingerprints"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public JwkFingerprints Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<JwkFingerprints>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="JwkFingerprints"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public JwkFingerprints Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<JwkFingerprints>(_idx);
                }
