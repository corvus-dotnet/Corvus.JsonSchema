        ...
        public readonly partial struct RequiredAlgAndDisableJwkSecurityAndJwkLocalPath
        {
...
#endif
            {
                ...
                public void SetDisableJwkSecurity(in Corvus.Text.Json.JsonElement.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DisableJwkSecurity, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271auth1signerJson.RequiredAlgAndDisableJwkSecurityAndJwkLocalPath.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271auth1signerJson.RequiredAlgAndDisableJwkSecurityAndJwkLocalPath.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                    ...
                    in Corvus.Text.Json.JsonElement.Source jwkLocalPath)
                {
                    ...
                    disableJwkSecurity.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DisableJwkSecurity, ref builder);
