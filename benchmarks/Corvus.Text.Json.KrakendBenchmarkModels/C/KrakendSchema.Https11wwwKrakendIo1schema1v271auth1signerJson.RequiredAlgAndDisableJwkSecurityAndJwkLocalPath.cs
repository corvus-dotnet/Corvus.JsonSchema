...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1signerJson
    {
...
#endif
        {
            ...
            internal RequiredAlgAndDisableJwkSecurityAndJwkLocalPath(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.JsonElement DisableJwkSecurity
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisableJwkSecurityUtf8, out Corvus.Text.Json.JsonElement value))
                    {
                        return value;
                    }
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RequiredAlgAndDisableJwkSecurityAndJwkLocalPath left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RequiredAlgAndDisableJwkSecurityAndJwkLocalPath instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredAlgAndDisableJwkSecurityAndJwkLocalPath(JsonElement instance)
            {
                return RequiredAlgAndDisableJwkSecurityAndJwkLocalPath.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredAlgAndDisableJwkSecurityAndJwkLocalPath From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredAlgAndDisableJwkSecurityAndJwkLocalPath ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredAlgAndDisableJwkSecurityAndJwkLocalPath>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredAlgAndDisableJwkSecurityAndJwkLocalPath ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredAlgAndDisableJwkSecurityAndJwkLocalPath>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredAlgAndDisableJwkSecurityAndJwkLocalPath ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredAlgAndDisableJwkSecurityAndJwkLocalPath>(json, options);
            }
            ...
            /// </exception>
            public static RequiredAlgAndDisableJwkSecurityAndJwkLocalPath ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RequiredAlgAndDisableJwkSecurityAndJwkLocalPath>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredAlgAndDisableJwkSecurityAndJwkLocalPath? result)
            {
                return JsonElementHelpers.TryParseValue<RequiredAlgAndDisableJwkSecurityAndJwkLocalPath>(ref reader, out result);
            }
...
#if NET
            static RequiredAlgAndDisableJwkSecurityAndJwkLocalPath IJsonElement<RequiredAlgAndDisableJwkSecurityAndJwkLocalPath>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredAlgAndDisableJwkSecurityAndJwkLocalPath: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public RequiredAlgAndDisableJwkSecurityAndJwkLocalPath Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public RequiredAlgAndDisableJwkSecurityAndJwkLocalPath Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RequiredAlgAndDisableJwkSecurityAndJwkLocalPath>(_idx);
                }
            ...
            private static class JsonPropertyNamesEscaped
            {
                ...
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="DisableJwkSecurity"/>.
                /// </summary>
                public static ReadOnlySpan<byte> DisableJwkSecurity => "disable_jwk_security"u8;
            ...
            private static class JsonPropertyNamesPrebaked
            {
                ...
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="DisableJwkSecurity"/>.
                /// </summary>
                public static ReadOnlySpan<byte> DisableJwkSecurity => [0x65, 0x01, 0x00, 0x00, 0x22, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6C, 0x65, 0x5F, 0x6A, 0x77, 0x6B, 0x5F, 0x73, 0x65, 0x63, 0x75, 0x72, 0x69, 0x74, 0x79, 0x22];
