    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1signerJson
    {
        ...
        public readonly partial struct SecretSUrl
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SecretSUrl instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SecretSUrl"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SecretSUrl(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SecretSUrl.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SecretSUrl Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SecretSUrl Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SecretSUrl>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SecretSUrl instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SecretSUrl, Mutable>(this);
            }
        }
    }
}
