...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1signerJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SecretSUrl"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SecretSUrl(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SecretSUrl DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(SecretSUrl value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in SecretSUrl left, in SecretSUrl right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SecretSUrl left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SecretSUrl instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SecretSUrl(JsonElement instance)
            {
                return SecretSUrl.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SecretSUrl From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SecretSUrl ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SecretSUrl>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SecretSUrl ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SecretSUrl>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SecretSUrl ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SecretSUrl>(json, options);
            }
            ...
            /// </exception>
            public static SecretSUrl ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SecretSUrl>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SecretSUrl? result)
            {
                return JsonElementHelpers.TryParseValue<SecretSUrl>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SecretSUrl(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static SecretSUrl IJsonElement<SecretSUrl>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SecretSUrl: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SecretSUrl"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SecretSUrl"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public SecretSUrl Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SecretSUrl>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SecretSUrl"/> that lives for the lifetime of its
