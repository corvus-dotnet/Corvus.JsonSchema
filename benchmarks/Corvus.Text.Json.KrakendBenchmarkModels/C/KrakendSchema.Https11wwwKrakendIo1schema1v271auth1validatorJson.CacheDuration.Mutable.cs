    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1validatorJson
    {
        ...
        public readonly partial struct CacheDuration
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(CacheDuration instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CacheDuration"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CacheDuration(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CacheDuration.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly CacheDuration Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly CacheDuration Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CacheDuration>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(CacheDuration instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<CacheDuration, Mutable>(this);
            }
        }
    }
}
