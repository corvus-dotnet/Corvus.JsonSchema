    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1validatorJson
    {
        ...
        public readonly partial struct KeyIdentifyStrategy
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(KeyIdentifyStrategy instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="KeyIdentifyStrategy"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator KeyIdentifyStrategy(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"KeyIdentifyStrategy.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly KeyIdentifyStrategy Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly KeyIdentifyStrategy Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<KeyIdentifyStrategy>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(KeyIdentifyStrategy instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<KeyIdentifyStrategy, Mutable>(this);
            }
        }
    }
}
