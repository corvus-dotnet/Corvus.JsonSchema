...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1validatorJson
    {
        ...
        public readonly partial struct RequiredAlgAndJwkLocalPath
#if NET8_0_OR_GREATER
            : IJsonElement<RequiredAlgAndJwkLocalPath>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RequiredAlgAndJwkLocalPath"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RequiredAlgAndJwkLocalPath(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RequiredAlgAndJwkLocalPath DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.JsonElement Alg
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AlgUtf8, out Corvus.Text.Json.JsonElement value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the <c>jwk_local_path</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            /// If the instance is valid, this property will not be <see cref="JsonValueKind.Undefined"/>, but may be <see cref="JsonValueKind.Null"/>.
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.JsonElement JwkLocalPath
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.JwkLocalPathUtf8, out Corvus.Text.Json.JsonElement value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in RequiredAlgAndJwkLocalPath left, in RequiredAlgAndJwkLocalPath right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RequiredAlgAndJwkLocalPath left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RequiredAlgAndJwkLocalPath instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredAlgAndJwkLocalPath(JsonElement instance)
            {
                return RequiredAlgAndJwkLocalPath.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredAlgAndJwkLocalPath From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredAlgAndJwkLocalPath ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredAlgAndJwkLocalPath>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredAlgAndJwkLocalPath ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredAlgAndJwkLocalPath>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredAlgAndJwkLocalPath ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredAlgAndJwkLocalPath>(json, options);
            }
            ...
            /// </exception>
            public static RequiredAlgAndJwkLocalPath ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RequiredAlgAndJwkLocalPath>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredAlgAndJwkLocalPath? result)
            {
                return JsonElementHelpers.TryParseValue<RequiredAlgAndJwkLocalPath>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RequiredAlgAndJwkLocalPath(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RequiredAlgAndJwkLocalPath IJsonElement<RequiredAlgAndJwkLocalPath>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredAlgAndJwkLocalPath: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RequiredAlgAndJwkLocalPath"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RequiredAlgAndJwkLocalPath"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RequiredAlgAndJwkLocalPath Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RequiredAlgAndJwkLocalPath>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RequiredAlgAndJwkLocalPath"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RequiredAlgAndJwkLocalPath Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RequiredAlgAndJwkLocalPath>(_idx);
                }
