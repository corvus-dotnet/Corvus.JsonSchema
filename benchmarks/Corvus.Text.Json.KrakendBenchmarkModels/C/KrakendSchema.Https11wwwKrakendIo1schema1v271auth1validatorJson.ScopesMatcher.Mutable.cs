    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1validatorJson
    {
        ...
        public readonly partial struct ScopesMatcher
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ScopesMatcher instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ScopesMatcher"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ScopesMatcher(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ScopesMatcher.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ScopesMatcher Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ScopesMatcher Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ScopesMatcher>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ScopesMatcher instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ScopesMatcher, Mutable>(this);
            }
        }
    }
}
