    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1amqp1consumerJson
    {
        ...
        public readonly partial struct Delete
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Delete instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Delete"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Delete(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Delete.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly Delete Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Delete>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Delete instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<Delete, Mutable>(this);
            }
        }
    }
}
