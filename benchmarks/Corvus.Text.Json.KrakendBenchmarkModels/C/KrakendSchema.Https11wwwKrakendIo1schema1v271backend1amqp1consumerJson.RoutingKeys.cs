...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1amqp1consumerJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RoutingKeys"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RoutingKeys(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RoutingKeys DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in RoutingKeys left, in RoutingKeys right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RoutingKeys left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RoutingKeys instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RoutingKeys(JsonElement instance)
            {
                return RoutingKeys.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RoutingKeys From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RoutingKeys ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RoutingKeys>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RoutingKeys ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RoutingKeys>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RoutingKeys ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RoutingKeys>(json, options);
            }
            ...
            /// </exception>
            public static RoutingKeys ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RoutingKeys>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RoutingKeys? result)
            {
                return JsonElementHelpers.TryParseValue<RoutingKeys>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RoutingKeys(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RoutingKeys IJsonElement<RoutingKeys>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RoutingKeys: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RoutingKeys"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RoutingKeys"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RoutingKeys Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RoutingKeys>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RoutingKeys"/> that lives for the lifetime of its
