    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1amqp1producerJson
    {
        ...
        public readonly partial struct Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey1
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey1 instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey1"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey1(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey1.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey1 Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey1 Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey1>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey1 instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey1, Mutable>(this);
            }
        }
    }
}
