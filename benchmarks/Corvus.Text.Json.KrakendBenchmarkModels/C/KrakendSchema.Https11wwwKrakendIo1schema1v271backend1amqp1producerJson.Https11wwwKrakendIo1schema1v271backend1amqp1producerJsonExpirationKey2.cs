...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1amqp1producerJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2 DefaultInstance { get; } = ParsedJsonDocument<Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2>.StringConstant([.."\"\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2 value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2 left, in Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2 right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2 left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2 instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2(JsonElement instance)
            {
                return Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2 From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2 ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2 ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2 ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2>(json, options);
            }
            ...
            /// </exception>
            public static Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2 ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2? result)
            {
                return JsonElementHelpers.TryParseValue<Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2>(ref reader, out result);
            }
...
#if NET
            static Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2 IJsonElement<Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2 Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2 Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<Https11wwwKrakendIo1schema1v271backend1amqp1producerJsonExpirationKey2>(_idx);
                }
