    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1amqp1producerJson
    {
        ...
        public readonly partial struct Mandatory
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Mandatory instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Mandatory"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Mandatory(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Mandatory.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly Mandatory Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly Mandatory Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Mandatory>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Mandatory instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<Mandatory, Mutable>(this);
            }
        }
    }
}
