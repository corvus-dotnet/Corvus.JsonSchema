...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1amqp1producerJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="Mandatory"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal Mandatory(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Mandatory DefaultInstance { get; } = ParsedJsonDocument<Mandatory>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(Mandatory value)
            {
            ...
            /// </returns>
            public static bool operator ==(in Mandatory left, in Mandatory right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Mandatory left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(Mandatory instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Mandatory(JsonElement instance)
            {
                return Mandatory.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Mandatory From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Mandatory ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Mandatory>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Mandatory ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Mandatory>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Mandatory ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Mandatory>(json, options);
            }
            ...
            /// </exception>
            public static Mandatory ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Mandatory>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Mandatory? result)
            {
                return JsonElementHelpers.TryParseValue<Mandatory>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Mandatory(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static Mandatory IJsonElement<Mandatory>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Mandatory: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Mandatory"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Mandatory"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Mandatory Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Mandatory>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Mandatory"/> that lives for the lifetime of its
