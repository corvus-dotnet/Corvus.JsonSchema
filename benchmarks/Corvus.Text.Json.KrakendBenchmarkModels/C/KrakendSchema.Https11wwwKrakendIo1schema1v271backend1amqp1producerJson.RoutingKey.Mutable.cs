    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1amqp1producerJson
    {
        ...
        public readonly partial struct RoutingKey
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RoutingKey instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RoutingKey"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RoutingKey(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RoutingKey.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RoutingKey Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RoutingKey Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RoutingKey>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RoutingKey instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RoutingKey, Mutable>(this);
            }
        }
    }
}
