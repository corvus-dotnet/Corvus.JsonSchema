...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1amqp1producerJson
    {
        ...
        public readonly partial struct StaticRoutingKey
#if NET8_0_OR_GREATER
            : IJsonElement<StaticRoutingKey>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="StaticRoutingKey"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal StaticRoutingKey(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static StaticRoutingKey DefaultInstance { get; } = ParsedJsonDocument<StaticRoutingKey>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(StaticRoutingKey value)
            {
            ...
            /// </returns>
            public static bool operator ==(in StaticRoutingKey left, in StaticRoutingKey right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in StaticRoutingKey left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(StaticRoutingKey instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator StaticRoutingKey(JsonElement instance)
            {
                return StaticRoutingKey.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StaticRoutingKey From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StaticRoutingKey ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<StaticRoutingKey>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StaticRoutingKey ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<StaticRoutingKey>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StaticRoutingKey ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<StaticRoutingKey>(json, options);
            }
            ...
            /// </exception>
            public static StaticRoutingKey ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<StaticRoutingKey>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out StaticRoutingKey? result)
            {
                return JsonElementHelpers.TryParseValue<StaticRoutingKey>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new StaticRoutingKey(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static StaticRoutingKey IJsonElement<StaticRoutingKey>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"StaticRoutingKey: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="StaticRoutingKey"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="StaticRoutingKey"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public StaticRoutingKey Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<StaticRoutingKey>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="StaticRoutingKey"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public StaticRoutingKey Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<StaticRoutingKey>(_idx);
                }
