    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1graphqlJson
    {
        ...
        public readonly partial struct Variables
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Variables instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Variables"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Variables(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Variables(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Variables.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Variables"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Variables"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly Variables Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Variables>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Variables"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly Variables Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Variables>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271backend1graphqlJson.Variables.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(Variables instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271backend1graphqlJson.Variables.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<Variables, Mutable>(this);
            }
        }
    }
}
