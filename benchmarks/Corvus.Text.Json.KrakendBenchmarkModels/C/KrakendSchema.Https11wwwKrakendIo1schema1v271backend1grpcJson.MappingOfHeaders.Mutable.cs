    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1grpcJson
    {
        ...
        public readonly partial struct MappingOfHeaders
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(MappingOfHeaders instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MappingOfHeaders"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MappingOfHeaders(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MappingOfHeaders.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MappingOfHeaders Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MappingOfHeaders Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MappingOfHeaders>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271backend1grpcJson.MappingOfHeaders.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(MappingOfHeaders instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271backend1grpcJson.MappingOfHeaders.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<MappingOfHeaders, Mutable>(this);
            }
        }
    }
}
