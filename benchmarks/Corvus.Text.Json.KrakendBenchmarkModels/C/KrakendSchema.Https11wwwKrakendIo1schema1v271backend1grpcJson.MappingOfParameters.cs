...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1grpcJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="MappingOfParameters"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal MappingOfParameters(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static MappingOfParameters DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in MappingOfParameters left, in MappingOfParameters right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in MappingOfParameters left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(MappingOfParameters instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MappingOfParameters(JsonElement instance)
            {
                return MappingOfParameters.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MappingOfParameters From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MappingOfParameters ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MappingOfParameters>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MappingOfParameters ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MappingOfParameters>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MappingOfParameters ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MappingOfParameters>(json, options);
            }
            ...
            /// </exception>
            public static MappingOfParameters ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<MappingOfParameters>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out MappingOfParameters? result)
            {
                return JsonElementHelpers.TryParseValue<MappingOfParameters>(ref reader, out result);
            }
...
#if NET
            static MappingOfParameters IJsonElement<MappingOfParameters>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MappingOfParameters: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public MappingOfParameters Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public MappingOfParameters Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<MappingOfParameters>(_idx);
                }
