...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1grpcJson
    {
        ...
        public readonly partial struct OutputDurationTypesAsString
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(OutputDurationTypesAsString instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OutputDurationTypesAsString"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OutputDurationTypesAsString(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new OutputDurationTypesAsString(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OutputDurationTypesAsString.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="OutputDurationTypesAsString"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="OutputDurationTypesAsString"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly OutputDurationTypesAsString Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<OutputDurationTypesAsString>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="OutputDurationTypesAsString"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly OutputDurationTypesAsString Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OutputDurationTypesAsString>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(OutputDurationTypesAsString instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<OutputDurationTypesAsString, Mutable>(this);
            }
        }
    }
}
