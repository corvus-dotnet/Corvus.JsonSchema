...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1grpcJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="OutputDurationTypesAsString"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal OutputDurationTypesAsString(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static OutputDurationTypesAsString DefaultInstance { get; } = ParsedJsonDocument<OutputDurationTypesAsString>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(OutputDurationTypesAsString value)
            {
            ...
            /// </returns>
            public static bool operator ==(in OutputDurationTypesAsString left, in OutputDurationTypesAsString right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in OutputDurationTypesAsString left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(OutputDurationTypesAsString instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OutputDurationTypesAsString(JsonElement instance)
            {
                return OutputDurationTypesAsString.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OutputDurationTypesAsString From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OutputDurationTypesAsString ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OutputDurationTypesAsString>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OutputDurationTypesAsString ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OutputDurationTypesAsString>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OutputDurationTypesAsString ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OutputDurationTypesAsString>(json, options);
            }
            ...
            /// </exception>
            public static OutputDurationTypesAsString ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<OutputDurationTypesAsString>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out OutputDurationTypesAsString? result)
            {
                return JsonElementHelpers.TryParseValue<OutputDurationTypesAsString>(ref reader, out result);
            }
...
#if NET
            static OutputDurationTypesAsString IJsonElement<OutputDurationTypesAsString>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OutputDurationTypesAsString: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public OutputDurationTypesAsString Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public OutputDurationTypesAsString Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<OutputDurationTypesAsString>(_idx);
                }
