...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1grpcJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="OutputEnumTypesAsString"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal OutputEnumTypesAsString(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static OutputEnumTypesAsString DefaultInstance { get; } = ParsedJsonDocument<OutputEnumTypesAsString>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(OutputEnumTypesAsString value)
            {
            ...
            /// </returns>
            public static bool operator ==(in OutputEnumTypesAsString left, in OutputEnumTypesAsString right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in OutputEnumTypesAsString left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(OutputEnumTypesAsString instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OutputEnumTypesAsString(JsonElement instance)
            {
                return OutputEnumTypesAsString.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OutputEnumTypesAsString From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OutputEnumTypesAsString ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OutputEnumTypesAsString>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OutputEnumTypesAsString ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OutputEnumTypesAsString>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OutputEnumTypesAsString ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OutputEnumTypesAsString>(json, options);
            }
            ...
            /// </exception>
            public static OutputEnumTypesAsString ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<OutputEnumTypesAsString>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out OutputEnumTypesAsString? result)
            {
                return JsonElementHelpers.TryParseValue<OutputEnumTypesAsString>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new OutputEnumTypesAsString(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static OutputEnumTypesAsString IJsonElement<OutputEnumTypesAsString>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OutputEnumTypesAsString: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="OutputEnumTypesAsString"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="OutputEnumTypesAsString"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public OutputEnumTypesAsString Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<OutputEnumTypesAsString>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="OutputEnumTypesAsString"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public OutputEnumTypesAsString Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<OutputEnumTypesAsString>(_idx);
                }
