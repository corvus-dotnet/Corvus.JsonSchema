...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1grpcJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="OutputTimestampsTypesAsString"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal OutputTimestampsTypesAsString(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static OutputTimestampsTypesAsString DefaultInstance { get; } = ParsedJsonDocument<OutputTimestampsTypesAsString>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(OutputTimestampsTypesAsString value)
            {
            ...
            /// </returns>
            public static bool operator ==(in OutputTimestampsTypesAsString left, in OutputTimestampsTypesAsString right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in OutputTimestampsTypesAsString left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(OutputTimestampsTypesAsString instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OutputTimestampsTypesAsString(JsonElement instance)
            {
                return OutputTimestampsTypesAsString.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OutputTimestampsTypesAsString From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OutputTimestampsTypesAsString ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OutputTimestampsTypesAsString>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OutputTimestampsTypesAsString ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OutputTimestampsTypesAsString>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OutputTimestampsTypesAsString ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OutputTimestampsTypesAsString>(json, options);
            }
            ...
            /// </exception>
            public static OutputTimestampsTypesAsString ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<OutputTimestampsTypesAsString>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out OutputTimestampsTypesAsString? result)
            {
                return JsonElementHelpers.TryParseValue<OutputTimestampsTypesAsString>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new OutputTimestampsTypesAsString(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static OutputTimestampsTypesAsString IJsonElement<OutputTimestampsTypesAsString>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OutputTimestampsTypesAsString: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="OutputTimestampsTypesAsString"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="OutputTimestampsTypesAsString"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public OutputTimestampsTypesAsString Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<OutputTimestampsTypesAsString>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="OutputTimestampsTypesAsString"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public OutputTimestampsTypesAsString Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<OutputTimestampsTypesAsString>(_idx);
                }
