    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1grpcJson
    {
        ...
        public readonly partial struct RequestNamingConvention
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequestNamingConvention instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequestNamingConvention"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequestNamingConvention(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequestNamingConvention.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RequestNamingConvention Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RequestNamingConvention Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequestNamingConvention>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RequestNamingConvention instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RequestNamingConvention, Mutable>(this);
            }
        }
    }
}
