...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1grpcJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ResponseNamingConvention"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ResponseNamingConvention(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ResponseNamingConvention DefaultInstance { get; } = ParsedJsonDocument<ResponseNamingConvention>.StringConstant([.."\"snake_case\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ResponseNamingConvention value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in ResponseNamingConvention left, in ResponseNamingConvention right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ResponseNamingConvention left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ResponseNamingConvention instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ResponseNamingConvention(JsonElement instance)
            {
                return ResponseNamingConvention.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ResponseNamingConvention From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ResponseNamingConvention ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ResponseNamingConvention>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ResponseNamingConvention ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ResponseNamingConvention>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ResponseNamingConvention ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ResponseNamingConvention>(json, options);
            }
            ...
            /// </exception>
            public static ResponseNamingConvention ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ResponseNamingConvention>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ResponseNamingConvention? result)
            {
                return JsonElementHelpers.TryParseValue<ResponseNamingConvention>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ResponseNamingConvention(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ResponseNamingConvention IJsonElement<ResponseNamingConvention>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ResponseNamingConvention: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ResponseNamingConvention"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ResponseNamingConvention"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ResponseNamingConvention Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ResponseNamingConvention>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ResponseNamingConvention"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ResponseNamingConvention Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ResponseNamingConvention>(_idx);
                }
            ...
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchCamelCase,
                Func<TContext, TResult> matchSnakeCase,
            ...
            public TResult Match<TResult>(
                Func<TResult> matchCamelCase,
                Func<TResult> matchSnakeCase,
