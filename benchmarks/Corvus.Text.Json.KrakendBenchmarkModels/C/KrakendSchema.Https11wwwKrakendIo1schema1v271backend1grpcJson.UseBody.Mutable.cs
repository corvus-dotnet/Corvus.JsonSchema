    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1grpcJson
    {
        ...
        public readonly partial struct UseBody
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(UseBody instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="UseBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator UseBody(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"UseBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly UseBody Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<UseBody>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(UseBody instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<UseBody, Mutable>(this);
            }
        }
    }
}
