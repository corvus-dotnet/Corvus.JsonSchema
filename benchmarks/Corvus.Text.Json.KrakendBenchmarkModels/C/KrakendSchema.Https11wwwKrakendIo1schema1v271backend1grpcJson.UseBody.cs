...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1grpcJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="UseBody"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal UseBody(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static UseBody DefaultInstance { get; } = ParsedJsonDocument<UseBody>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(UseBody value)
            {
            ...
            /// </returns>
            public static bool operator ==(in UseBody left, in UseBody right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in UseBody left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(UseBody instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator UseBody(JsonElement instance)
            {
                return UseBody.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UseBody From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UseBody ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<UseBody>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UseBody ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<UseBody>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UseBody ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<UseBody>(json, options);
            }
            ...
            /// </exception>
            public static UseBody ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<UseBody>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out UseBody? result)
            {
                return JsonElementHelpers.TryParseValue<UseBody>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new UseBody(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static UseBody IJsonElement<UseBody>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"UseBody: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="UseBody"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="UseBody"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public UseBody Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<UseBody>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="UseBody"/> that lives for the lifetime of its
