...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1httpClientJson
        ...
        : IJsonElement<Https11wwwKrakendIo1schema1v271backend1httpClientJson>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Https11wwwKrakendIo1schema1v271backend1httpClientJson"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Https11wwwKrakendIo1schema1v271backend1httpClientJson(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Https11wwwKrakendIo1schema1v271backend1httpClientJson DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271backend1httpClientJson.NoRedirect NoRedirectValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NoRedirectValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271backend1httpClientJson.NoRedirect value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271backend1httpClientJson.NoRedirect.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.JsonElement ProxyAddress
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProxyAddressUtf8, out Corvus.Text.Json.JsonElement value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in Https11wwwKrakendIo1schema1v271backend1httpClientJson left, in Https11wwwKrakendIo1schema1v271backend1httpClientJson right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Https11wwwKrakendIo1schema1v271backend1httpClientJson left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Https11wwwKrakendIo1schema1v271backend1httpClientJson instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Https11wwwKrakendIo1schema1v271backend1httpClientJson(JsonElement instance)
        {
            return Https11wwwKrakendIo1schema1v271backend1httpClientJson.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271backend1httpClientJson From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271backend1httpClientJson ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271backend1httpClientJson>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271backend1httpClientJson ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271backend1httpClientJson>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271backend1httpClientJson ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271backend1httpClientJson>(json, options);
        }
        ...
        /// </exception>
        public static Https11wwwKrakendIo1schema1v271backend1httpClientJson ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271backend1httpClientJson>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Https11wwwKrakendIo1schema1v271backend1httpClientJson? result)
        {
            return JsonElementHelpers.TryParseValue<Https11wwwKrakendIo1schema1v271backend1httpClientJson>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Https11wwwKrakendIo1schema1v271backend1httpClientJson(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Https11wwwKrakendIo1schema1v271backend1httpClientJson IJsonElement<Https11wwwKrakendIo1schema1v271backend1httpClientJson>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Https11wwwKrakendIo1schema1v271backend1httpClientJson: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Https11wwwKrakendIo1schema1v271backend1httpClientJson"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Https11wwwKrakendIo1schema1v271backend1httpClientJson"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Https11wwwKrakendIo1schema1v271backend1httpClientJson Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<Https11wwwKrakendIo1schema1v271backend1httpClientJson>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Https11wwwKrakendIo1schema1v271backend1httpClientJson"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public Https11wwwKrakendIo1schema1v271backend1httpClientJson Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<Https11wwwKrakendIo1schema1v271backend1httpClientJson>(_idx);
            }
        ...
        public static class JsonPropertyNames
        {
            ...
            /// <summary>
            /// Gets the JSON property name for <see cref="NoRedirectValue"/>.
            /// </summary>
            public const string NoRedirectValue = "no_redirect";
            ...
            /// Gets the JSON property name for <see cref="NoRedirectValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> NoRedirectValueUtf8 => "no_redirect"u8;
        ...
        private static class JsonPropertyNamesEscaped
        {
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="NoRedirectValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> NoRedirectValue => "no_redirect"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="ProxyAddress"/>.
            /// </summary>
