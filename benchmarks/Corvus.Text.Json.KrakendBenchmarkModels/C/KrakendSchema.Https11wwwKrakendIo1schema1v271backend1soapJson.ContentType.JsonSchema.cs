    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1soapJson
    {
            ...
            : IJsonElement<ContentType>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend~1soap.json/properties/content_type"u8, buffer, out written);
