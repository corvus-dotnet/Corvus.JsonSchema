    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1staticFilesystemJson
    {
        ...
        public readonly partial struct WhetherToAllowDirectoryListingsOrNot
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(WhetherToAllowDirectoryListingsOrNot instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="WhetherToAllowDirectoryListingsOrNot"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WhetherToAllowDirectoryListingsOrNot(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WhetherToAllowDirectoryListingsOrNot.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly WhetherToAllowDirectoryListingsOrNot Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly WhetherToAllowDirectoryListingsOrNot Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<WhetherToAllowDirectoryListingsOrNot>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(WhetherToAllowDirectoryListingsOrNot instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<WhetherToAllowDirectoryListingsOrNot, Mutable>(this);
            }
        }
    }
}
