    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backendExtraConfigJson
    {
        ...
        public readonly partial struct Backend1httpEntity
        {
...
#endif
            {
                ...
                internal RequiredReturnErrorDetails(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.JsonElement ReturnErrorDetails
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReturnErrorDetailsUtf8, out Corvus.Text.Json.JsonElement value))
                        {
                            return value;
                        }
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in RequiredReturnErrorDetails left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(RequiredReturnErrorDetails instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredReturnErrorDetails(JsonElement instance)
                {
                    return RequiredReturnErrorDetails.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredReturnErrorDetails From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredReturnErrorDetails ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredReturnErrorDetails>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredReturnErrorDetails ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredReturnErrorDetails>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredReturnErrorDetails ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredReturnErrorDetails>(json, options);
                }
                ...
                /// </exception>
                public static RequiredReturnErrorDetails ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<RequiredReturnErrorDetails>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredReturnErrorDetails? result)
                {
                    return JsonElementHelpers.TryParseValue<RequiredReturnErrorDetails>(ref reader, out result);
                }
...
#if NET
                static RequiredReturnErrorDetails IJsonElement<RequiredReturnErrorDetails>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredReturnErrorDetails: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public RequiredReturnErrorDetails Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public RequiredReturnErrorDetails Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<RequiredReturnErrorDetails>(_idx);
                    }
                ...
                {
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="ReturnErrorDetails"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> ReturnErrorDetails => [0x65, 0x01, 0x00, 0x00, 0x22, 0x72, 0x65, 0x74, 0x75, 0x72, 0x6E, 0x5F, 0x65, 0x72, 0x72, 0x6F, 0x72, 0x5F, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6C, 0x73, 0x22];
                }
            }
        }
    }
