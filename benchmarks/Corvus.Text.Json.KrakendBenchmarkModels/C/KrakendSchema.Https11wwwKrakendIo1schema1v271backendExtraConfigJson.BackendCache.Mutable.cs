...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backendExtraConfigJson
    {
        ...
        public readonly partial struct BackendCache
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(BackendCache instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="BackendCache"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator BackendCache(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.JsonBoolean.Mutable Shared
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SharedUtf8, out Corvus.KrakendBenchmark.Current.JsonBoolean.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new BackendCache(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetShared(in Corvus.KrakendBenchmark.Current.JsonBoolean.Source value)
                {
                    ...
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SharedUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SharedUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsProperty(JsonPropertyNamesEscaped.Shared, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                ...
                /// <summary>
                /// Remove the <c>shared</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveShared()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SharedUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"BackendCache.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="BackendCache"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="BackendCache"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly BackendCache Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<BackendCache>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="BackendCache"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly BackendCache Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<BackendCache>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271backendExtraConfigJson.BackendCache.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(BackendCache instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271backendExtraConfigJson.BackendCache.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="BackendCache"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.KrakendBenchmark.Current.JsonBoolean.Source shared = default)
                {
                    shared.AddAsProperty(JsonPropertyNamesEscaped.Shared, ref builder, escapeName: false);
                }

                /// <summary>
                /// Creates an instance of a <see cref="BackendCache"/>.
                /// </summary>
                public void Create(in Corvus.KrakendBenchmark.Current.JsonBoolean.Source shared = default)
                {
                    Create(ref _builder, shared);
                }
            ...
            /// </summary>
            /// <param name="workspace">The JSON workspace.</param>
            /// <param name="shared">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonBoolean.Source shared = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            {
                return workspace.CreateBuilder<BackendCache, Mutable>(this);
            }
        }
    }
}
