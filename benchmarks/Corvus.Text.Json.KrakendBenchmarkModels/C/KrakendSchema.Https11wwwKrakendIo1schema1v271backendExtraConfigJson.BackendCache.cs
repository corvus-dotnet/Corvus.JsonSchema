...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backendExtraConfigJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="BackendCache"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal BackendCache(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static BackendCache DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.JsonBoolean Shared
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SharedUtf8, out Corvus.KrakendBenchmark.Current.JsonBoolean value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in BackendCache left, in BackendCache right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in BackendCache left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(BackendCache instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BackendCache(JsonElement instance)
            {
                return BackendCache.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BackendCache From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BackendCache ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BackendCache>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BackendCache ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BackendCache>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BackendCache ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BackendCache>(json, options);
            }
            ...
            /// </exception>
            public static BackendCache ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<BackendCache>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out BackendCache? result)
            {
                return JsonElementHelpers.TryParseValue<BackendCache>(ref reader, out result);
            }
...
#if NET
            static BackendCache IJsonElement<BackendCache>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BackendCache: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Shared"/>.
                /// </summary>
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="Shared"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Shared => [0x85, 0x00, 0x00, 0x00, 0x22, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x22];
            }
        }
    }
}
