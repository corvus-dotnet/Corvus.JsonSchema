    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backendJson
    {
        ...
        public readonly partial struct DisableHostSanitize
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DisableHostSanitize instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DisableHostSanitize"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DisableHostSanitize(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DisableHostSanitize.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DisableHostSanitize Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DisableHostSanitize Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DisableHostSanitize>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DisableHostSanitize instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DisableHostSanitize, Mutable>(this);
            }
        }
    }
}
