...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backendJson
    {
        ...
        public readonly partial struct Mapping
#if NET8_0_OR_GREATER
            : IJsonElement<Mapping>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            internal Mapping(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Mapping DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in Mapping left, in Mapping right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Mapping left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(Mapping instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Mapping(JsonElement instance)
            {
                return Mapping.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Mapping From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Mapping ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Mapping>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Mapping ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Mapping>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Mapping ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Mapping>(json, options);
            }
            ...
            /// </exception>
            public static Mapping ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Mapping>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Mapping? result)
            {
                return JsonElementHelpers.TryParseValue<Mapping>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Mapping(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static Mapping IJsonElement<Mapping>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Mapping: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Mapping"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Mapping"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<Mapping>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Mapping"/> that lives for the lifetime of its
