    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backendJson
    {
        ...
        public readonly partial struct Method
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Method instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Method"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Method(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Method(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Method.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Method"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Method"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly Method Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Method>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Method"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly Method Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Method>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Method instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<Method, Mutable>(this);
            }
        }
    }
}
