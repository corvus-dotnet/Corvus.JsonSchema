    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backendJson
    {
        ...
        public readonly partial struct ServiceDiscoveryScheme
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ServiceDiscoveryScheme instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ServiceDiscoveryScheme"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ServiceDiscoveryScheme(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ServiceDiscoveryScheme.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ServiceDiscoveryScheme Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ServiceDiscoveryScheme Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ServiceDiscoveryScheme>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ServiceDiscoveryScheme instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ServiceDiscoveryScheme, Mutable>(this);
            }
        }
    }
}
