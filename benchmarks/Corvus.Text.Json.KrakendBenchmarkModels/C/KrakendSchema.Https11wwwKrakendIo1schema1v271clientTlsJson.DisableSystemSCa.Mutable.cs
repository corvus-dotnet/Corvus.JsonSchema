    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271clientTlsJson
    {
        ...
        public readonly partial struct DisableSystemSCa
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DisableSystemSCa instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DisableSystemSCa"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DisableSystemSCa(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DisableSystemSCa.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DisableSystemSCa Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DisableSystemSCa Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DisableSystemSCa>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DisableSystemSCa instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DisableSystemSCa, Mutable>(this);
            }
        }
    }
}
