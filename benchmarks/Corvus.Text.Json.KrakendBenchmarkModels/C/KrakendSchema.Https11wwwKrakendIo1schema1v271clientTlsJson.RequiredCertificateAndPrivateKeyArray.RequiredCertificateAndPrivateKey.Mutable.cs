        ...
        public readonly partial struct RequiredCertificateAndPrivateKeyArray
        {
            ...
            public readonly partial struct RequiredCertificateAndPrivateKey
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RequiredCertificateAndPrivateKey instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RequiredCertificateAndPrivateKey"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredCertificateAndPrivateKey(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.JsonString.Mutable Certificate
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CertificateUtf8, out Corvus.KrakendBenchmark.Current.JsonString.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// <summary>
                    /// Set the <c>certificate</c> property.
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetCertificate(in Corvus.KrakendBenchmark.Current.JsonString.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("certificate");
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CertificateUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                        ...
                        else
                        {
                            ...
                            value.AddAsProperty(JsonPropertyNamesEscaped.Certificate, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    ...
                    public void SetPrivateKey(in Corvus.KrakendBenchmark.Current.JsonString.Source value)
                    {
                        ...
                        if (value.IsUndefined)
                        {
                            CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("private_key");
                        }
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredCertificateAndPrivateKey.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredCertificateAndPrivateKey Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredCertificateAndPrivateKey Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RequiredCertificateAndPrivateKey>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271clientTlsJson.RequiredCertificateAndPrivateKeyArray.RequiredCertificateAndPrivateKey.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(RequiredCertificateAndPrivateKey instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271clientTlsJson.RequiredCertificateAndPrivateKeyArray.RequiredCertificateAndPrivateKey.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.KrakendBenchmark.Current.JsonString.Source certificate,
                        in Corvus.KrakendBenchmark.Current.JsonString.Source privateKey)
                    {
                        certificate.AddAsProperty(JsonPropertyNamesEscaped.Certificate, ref builder, escapeName: false);
                    ...
                    /// Creates an instance of a <see cref="RequiredCertificateAndPrivateKey"/>.
                    /// </summary>
                    public void Create(in Corvus.KrakendBenchmark.Current.JsonString.Source certificate, in Corvus.KrakendBenchmark.Current.JsonString.Source privateKey)
                    {
                        Create(ref _builder, certificate, privateKey);
                    }
                ...
                /// </summary>
                /// <param name="workspace">The JSON workspace.</param>
                /// <param name="certificate">The value of the property.</param>
                /// <param name="privateKey">The value of the property.</param>
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonString.Source certificate, in Corvus.KrakendBenchmark.Current.JsonString.Source privateKey, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(certificate, privateKey);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<RequiredCertificateAndPrivateKey, Mutable>(this);
                }
            }
        }
    }
