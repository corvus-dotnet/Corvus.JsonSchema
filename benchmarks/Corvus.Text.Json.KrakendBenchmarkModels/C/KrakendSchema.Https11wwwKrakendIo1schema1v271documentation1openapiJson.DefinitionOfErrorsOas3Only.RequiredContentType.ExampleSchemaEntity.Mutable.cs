            ...
            public readonly partial struct RequiredContentType
            {
                ...
                public readonly partial struct ExampleSchemaEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(ExampleSchemaEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="ExampleSchemaEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator ExampleSchemaEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"ExampleSchemaEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ExampleSchemaEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ExampleSchemaEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<ExampleSchemaEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.DefinitionOfErrorsOas3Only.RequiredContentType.ExampleSchemaEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                        public static implicit operator Source(ExampleSchemaEntity instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.DefinitionOfErrorsOas3Only.RequiredContentType.ExampleSchemaEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    {
                        return workspace.CreateBuilder<ExampleSchemaEntity, Mutable>(this);
                    }
                }
            }
        }
