    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271documentation1openapiJson
    {
        ...
        public readonly partial struct JwtKey
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(JwtKey instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="JwtKey"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JwtKey(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"JwtKey.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly JwtKey Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<JwtKey>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(JwtKey instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<JwtKey, Mutable>(this);
            }
        }
    }
}
