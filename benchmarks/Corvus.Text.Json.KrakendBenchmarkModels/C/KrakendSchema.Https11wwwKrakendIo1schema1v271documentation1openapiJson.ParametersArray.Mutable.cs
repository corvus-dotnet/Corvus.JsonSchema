    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271documentation1openapiJson
    {
        ...
        public readonly partial struct ParametersArray
        {
...
#endif
            {
                ...
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ParametersArray.Parameters.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ParametersArray.Parameters.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ParametersArray.Parameters.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ParametersArray.Parameters.Mutable>(_parent, _idx);
                }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ParametersArray.Parameters.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ParametersArray.Parameters.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ParametersArray.Parameters.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ParametersArray.Parameters item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ParametersArray.Parameters>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ParametersArray.Parameters> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ParametersArray.Parameters>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ParametersArray.Parameters oldItem, in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ParametersArray.Parameters.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ParametersArray.Parameters>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ParametersArray.Parameters current = enumerator.Current;
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ParametersArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ParametersArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
