        ...
        public readonly partial struct ParametersArray
        {
            ...
            public readonly partial struct Parameters
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(Parameters instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="Parameters"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Parameters(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// <para>
                    /// The name of the parameter, as declared in `endpoint` without the curly braces `{}`
                    /// </para>
                    /// </remarks>
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"Parameters.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly Parameters Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly Parameters Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<Parameters>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ParametersArray.Parameters.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(Parameters instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ParametersArray.Parameters.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="Parameters"/>.
                    /// </summary>
                    ...
                    /// Creates an instance of a <see cref="Parameters"/>.
                    /// </summary>
                    public void Create(in Corvus.KrakendBenchmark.Current.JsonString.Source name, in Corvus.KrakendBenchmark.Current.JsonString.Source description = default)
                    {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonString.Source name, in Corvus.KrakendBenchmark.Current.JsonString.Source description = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                {
                    return workspace.CreateBuilder<Parameters, Mutable>(this);
                }
            }
        }
    }
