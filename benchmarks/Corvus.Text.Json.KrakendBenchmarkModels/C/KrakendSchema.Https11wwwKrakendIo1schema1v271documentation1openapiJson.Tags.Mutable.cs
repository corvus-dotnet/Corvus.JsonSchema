    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271documentation1openapiJson
    {
        ...
        public readonly partial struct Tags
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Tags instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Tags"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Tags(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Tags(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Tags.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// <summary>
                /// Gets a <see cref="Tags"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Tags"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly Tags Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Tags>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Tags"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly Tags Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Tags>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.Tags.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(Tags instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.Tags.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<Tags, Mutable>(this);
            }
        }
    }
}
