...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271endpointJson
    {
        ...
        public readonly partial struct ConcurrentCalls
#if NET8_0_OR_GREATER
            : IJsonElement<ConcurrentCalls>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ConcurrentCalls"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ConcurrentCalls(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ConcurrentCalls DefaultInstance { get; } = ParsedJsonDocument<ConcurrentCalls>.NumberConstant([.."1"u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator long(ConcurrentCalls value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator double(ConcurrentCalls value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator Corvus.Numerics.BigNumber(ConcurrentCalls value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator System.Numerics.BigInteger(ConcurrentCalls value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator decimal(ConcurrentCalls value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in ConcurrentCalls left, in ConcurrentCalls right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ConcurrentCalls left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ConcurrentCalls instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ConcurrentCalls(JsonElement instance)
            {
                return ConcurrentCalls.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConcurrentCalls From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConcurrentCalls ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConcurrentCalls>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConcurrentCalls ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConcurrentCalls>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConcurrentCalls ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConcurrentCalls>(json, options);
            }
            ...
            /// </exception>
            public static ConcurrentCalls ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ConcurrentCalls>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ConcurrentCalls? result)
            {
                return JsonElementHelpers.TryParseValue<ConcurrentCalls>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ConcurrentCalls(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ConcurrentCalls IJsonElement<ConcurrentCalls>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ConcurrentCalls: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ConcurrentCalls"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ConcurrentCalls"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ConcurrentCalls Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ConcurrentCalls>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ConcurrentCalls"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ConcurrentCalls Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ConcurrentCalls>(_idx);
                }
