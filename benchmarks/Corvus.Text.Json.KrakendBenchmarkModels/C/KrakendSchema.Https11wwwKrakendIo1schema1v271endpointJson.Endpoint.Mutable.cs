    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271endpointJson
    {
        ...
        public readonly partial struct Endpoint
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Endpoint instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Endpoint"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Endpoint(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Endpoint.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly Endpoint Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly Endpoint Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Endpoint>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Endpoint instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<Endpoint, Mutable>(this);
            }
        }
    }
}
