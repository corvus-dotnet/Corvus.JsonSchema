                ...
                public readonly partial struct ServicesEntity
                {
                    ...
                    public readonly partial struct MethodsEntityArray
                    {
                        ...
                        public readonly partial struct MethodsEntity
                        {
                            ...
                            public readonly partial struct PayloadParamsEntity
#if NET8_0_OR_GREATER
                                : IJsonElement<PayloadParamsEntity>,
                                  IFormattable,
                                  ISpanFormattable,
...
#endif
                            {
                                ...
                                /// <summary>
                                /// Initializes a new instance of the <see cref="PayloadParamsEntity"/> struct.
                                /// </summary>
                                /// <param name="value">The value from which to construct the instance.</param>
                                internal PayloadParamsEntity(IJsonDocument parent, int idx)
                                {
                                    Debug.Assert(idx >= 0);
                                    _parent = parent;
                                    _idx = idx;
                                ...
                                /// </summary>
                                public static PayloadParamsEntity DefaultInstance { get; }
                                ...
                                /// </returns>
                                public static bool operator ==(in PayloadParamsEntity left, in PayloadParamsEntity right)
                                {
                                ...
                                /// <c>True</c> if the values are equal.
                                /// </returns>
                                public static bool operator ==(in PayloadParamsEntity left, in JsonElement right)
                                {
                                    return left.Equals(right);
                                }
                                ...
                                public static implicit operator JsonElement(PayloadParamsEntity instance)
                                {
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator PayloadParamsEntity(JsonElement instance)
                                {
                                    return PayloadParamsEntity.From(instance);
                                }
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static PayloadParamsEntity From<T>(in T instance)
                                ...
                                /// </exception>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static PayloadParamsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                                {
                                    return JsonElementHelpers.ParseValue<PayloadParamsEntity>(utf8Json, options);
                                }
                                ...
                                /// </exception>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static PayloadParamsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                                {
                                    return JsonElementHelpers.ParseValue<PayloadParamsEntity>(json, options);
                                }
                                ...
                                /// </exception>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static PayloadParamsEntity ParseValue(string json, JsonDocumentOptions options = default)
                                {
                                    return JsonElementHelpers.ParseValue<PayloadParamsEntity>(json, options);
                                }
                                ...
                                /// </exception>
                                public static PayloadParamsEntity ParseValue(ref Utf8JsonReader reader)
                                {
                                    return JsonElementHelpers.ParseValue<PayloadParamsEntity>(ref reader);
                                }
                                ...
                                ///   A value could not be read from the reader.
                                /// </exception>
                                public static bool TryParseValue(ref Utf8JsonReader reader, out PayloadParamsEntity? result)
                                {
                                    return JsonElementHelpers.TryParseValue<PayloadParamsEntity>(ref reader, out result);
                                }
                                ...
                                {
                                    return
                                        (obj is IJsonElement value && Equals(new PayloadParamsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                                static PayloadParamsEntity IJsonElement<PayloadParamsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"PayloadParamsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// <summary>
                                /// Gets a <see cref="PayloadParamsEntity"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </summary>
                                /// <returns>
                                /// A <see cref="PayloadParamsEntity"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </returns>
                                /// <remarks>
                                /// <para>
                                ...
                                /// </para>
                                /// </remarks>
                                public PayloadParamsEntity Clone()
                                {
                                    CheckValidInstance();
                                    return _parent.CloneElement<PayloadParamsEntity>(_idx);
                                }
                                ...
                                /// </summary>
                                /// <returns>
                                /// An immutable <see cref="PayloadParamsEntity"/> that lives for the lifetime of its
                                ...
                                /// </para>
                                /// </remarks>
                                public PayloadParamsEntity Freeze()
                                {
                                    CheckValidInstance();
                                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                    {
                                        return mutable.FreezeElement<PayloadParamsEntity>(_idx);
                                    }
