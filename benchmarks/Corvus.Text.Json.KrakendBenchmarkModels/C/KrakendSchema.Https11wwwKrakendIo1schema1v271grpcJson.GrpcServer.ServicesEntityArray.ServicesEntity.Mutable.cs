            ...
            public readonly partial struct ServicesEntityArray
            {
                ...
                public readonly partial struct ServicesEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(ServicesEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="ServicesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator ServicesEntity(Mutable instance)
                        {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Mutable Methods
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MethodsUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// <remarks>
                        /// <para>
                        /// The name of the published gRPC service.
                        /// </para>
                        /// <para>
                        /// See: https://www.krakend.io/docs/enterprise/grpc/server/
                        /// </para>
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new ServicesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        public void SetMethods(in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Source value)
                        {
                            CheckValidInstance();
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetMethods<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Source<TContext> value)
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"ServicesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="ServicesEntity"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="ServicesEntity"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ServicesEntity Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<ServicesEntity>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="ServicesEntity"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ServicesEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<ServicesEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                        public static implicit operator Source(ServicesEntity instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        /// <summary>
                        /// Creates an instance of a <see cref="ServicesEntity"/>.
                        /// </summary>
                        internal static void Create(
                            ref ComplexValueBuilder builder,
                            in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Source methods = default,
                            in Corvus.KrakendBenchmark.Current.JsonString.Source name = default)
                        {
                        ...
                        /// Creates an instance of a <see cref="ServicesEntity"/>.
                        /// </summary>
                        public void Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Source methods = default, in Corvus.KrakendBenchmark.Current.JsonString.Source name = default)
                        {
                            Create(ref _builder, methods, name);
                        }
                        ...
                        internal static void Create<TContext>(
                            in TContext context,
                            ref ComplexValueBuilder builder,
                            in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Source<TContext> methods = default,
                            in Corvus.KrakendBenchmark.Current.JsonString.Source name = default)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                        ...
                        #endif
                        {
                            Create(context, ref _builder, methods, name);
                        }
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Source methods = default, in Corvus.KrakendBenchmark.Current.JsonString.Source name = default, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(methods, name);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271grpcJson.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Source<TContext> methods = default, in Corvus.KrakendBenchmark.Current.JsonString.Source name = default, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                        ...
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(context, methods, name);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    {
                        return workspace.CreateBuilder<ServicesEntity, Mutable>(this);
                    }
                }
            }
        }
