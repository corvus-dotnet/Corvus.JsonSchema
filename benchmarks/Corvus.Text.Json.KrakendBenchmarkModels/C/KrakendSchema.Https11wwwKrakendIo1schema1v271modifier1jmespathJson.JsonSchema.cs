...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271modifier1jmespathJson
        : IJsonElement<Https11wwwKrakendIo1schema1v271modifier1jmespathJson>
    {
        public static partial class JsonSchema
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyExprPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("expr"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyExprNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("expr"u8, buffer, out written);

            private const int RequiredOffsetForExpr = 0;
            private const uint RequiredBitForExpr = 0b00000000000000000000000000000001;
            ...
            private static void MatchExpr(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                requiredBitBuffer[RequiredOffsetForExpr] |= RequiredBitForExpr;
            }
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.ExprUtf8))
                {
                    matcher = MatchExpr;
                    return true;
                }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1modifier~1jmespath.json"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1modifier~1jmespath.json";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1modifier~1jmespath.json"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyExprPresent, "expr"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForExpr] & RequiredBitForExpr) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyExprNotPresent, "expr"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyExprPresent, "expr"u8, "required"u8);
