...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271modifier1luaJson
    {
        ...
        public readonly partial struct OpenExternalLibs
#if NET8_0_OR_GREATER
            : IJsonElement<OpenExternalLibs>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="OpenExternalLibs"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal OpenExternalLibs(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static OpenExternalLibs DefaultInstance { get; } = ParsedJsonDocument<OpenExternalLibs>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(OpenExternalLibs value)
            {
            ...
            /// </returns>
            public static bool operator ==(in OpenExternalLibs left, in OpenExternalLibs right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in OpenExternalLibs left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(OpenExternalLibs instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OpenExternalLibs(JsonElement instance)
            {
                return OpenExternalLibs.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OpenExternalLibs From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OpenExternalLibs ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OpenExternalLibs>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OpenExternalLibs ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OpenExternalLibs>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OpenExternalLibs ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OpenExternalLibs>(json, options);
            }
            ...
            /// </exception>
            public static OpenExternalLibs ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<OpenExternalLibs>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out OpenExternalLibs? result)
            {
                return JsonElementHelpers.TryParseValue<OpenExternalLibs>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new OpenExternalLibs(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static OpenExternalLibs IJsonElement<OpenExternalLibs>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OpenExternalLibs: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="OpenExternalLibs"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="OpenExternalLibs"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public OpenExternalLibs Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<OpenExternalLibs>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="OpenExternalLibs"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public OpenExternalLibs Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<OpenExternalLibs>(_idx);
                }
