        ...
        public readonly partial struct CookieModifier
        {
            ...
            public readonly partial struct HttpOnlyEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(HttpOnlyEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="HttpOnlyEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator HttpOnlyEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"HttpOnlyEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly HttpOnlyEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly HttpOnlyEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<HttpOnlyEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(HttpOnlyEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<HttpOnlyEntity, Mutable>(this);
                }
            }
        }
    }
