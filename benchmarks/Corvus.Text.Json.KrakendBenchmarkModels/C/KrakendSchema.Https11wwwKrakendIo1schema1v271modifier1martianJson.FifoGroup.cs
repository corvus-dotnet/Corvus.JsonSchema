...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271modifier1martianJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="FifoGroup"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal FifoGroup(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static FifoGroup DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271modifier1martianJson.FifoGroup.AggregateErrorsEntity AggregateErrors
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AggregateErrorsUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271modifier1martianJson.FifoGroup.AggregateErrorsEntity value))
                    {
                        return value;
                    }

                    return Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271modifier1martianJson.FifoGroup.AggregateErrorsEntity.DefaultInstance;
                }
            }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271modifier1martianJson.FifoGroup.Https11wwwKrakendIo1schema1v271modifier1martianJsonArray Modifiers
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ModifiersUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271modifier1martianJson.FifoGroup.Https11wwwKrakendIo1schema1v271modifier1martianJsonArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271modifier1martianJson.FifoGroup.Scope ScopeValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopeValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271modifier1martianJson.FifoGroup.Scope value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in FifoGroup left, in FifoGroup right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in FifoGroup left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(FifoGroup instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator FifoGroup(JsonElement instance)
            {
                return FifoGroup.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FifoGroup From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FifoGroup ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FifoGroup>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FifoGroup ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FifoGroup>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FifoGroup ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FifoGroup>(json, options);
            }
            ...
            /// </exception>
            public static FifoGroup ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<FifoGroup>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out FifoGroup? result)
            {
                return JsonElementHelpers.TryParseValue<FifoGroup>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new FifoGroup(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static FifoGroup IJsonElement<FifoGroup>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"FifoGroup: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="FifoGroup"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="FifoGroup"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public FifoGroup Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<FifoGroup>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="FifoGroup"/> that lives for the lifetime of its
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="AggregateErrors"/>.
                /// </summary>
                public static ReadOnlySpan<byte> AggregateErrors => "aggregateErrors"u8;

                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Modifiers"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Modifiers => "modifiers"u8;
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="AggregateErrors"/>.
                /// </summary>
                public static ReadOnlySpan<byte> AggregateErrors => [0x15, 0x01, 0x00, 0x00, 0x22, 0x61, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x45, 0x72, 0x72, 0x6F, 0x72, 0x73, 0x22];

                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="Modifiers"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Modifiers => [0xB5, 0x00, 0x00, 0x00, 0x22, 0x6D, 0x6F, 0x64, 0x69, 0x66, 0x69, 0x65, 0x72, 0x73, 0x22];
