    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271modifier1martianJson
    {
        ...
        public readonly partial struct HeaderCopy
        {
...
#endif
            {
                ...
                public void SetFromValue(in Corvus.KrakendBenchmark.Current.JsonString.Source value)
                {
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.FromValue, ref cvb);
                ...
                public void SetTo(in Corvus.KrakendBenchmark.Current.JsonString.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.To, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
            ...
            public ref struct Builder
            {
                ...
                {
                    from.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.FromValue, ref builder);
                    scope.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ScopeValue, ref builder);
                    to.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.To, ref builder);
                }
