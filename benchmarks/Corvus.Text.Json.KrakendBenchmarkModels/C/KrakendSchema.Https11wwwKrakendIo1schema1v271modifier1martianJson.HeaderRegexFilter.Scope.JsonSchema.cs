        ...
        public readonly partial struct HeaderRegexFilter
        {
                ...
                : IJsonElement<Scope>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly Scope Enum1 = Scope.ParseValue("[ \"request\", \"response\" ]");
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly Scope Enum2 = Scope.ParseValue("[ \"request\" ]");
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly Scope Enum3 = Scope.ParseValue("[ \"response\" ]");
                }
                ...
                public static class EnumValues
                {
                    ...
                    /// as a <see cref="Scope"/>.
                    /// </summary>
                    public static Scope ArrayValue1 { get; } = Constants.Enum1;

                    /// <summary>
                    /// Gets the array value
                    /// as a <see cref="Scope"/>.
                    /// </summary>
                    public static Scope ArrayValue2 { get; } = Constants.Enum2;

                    /// <summary>
                    /// Gets the array value
                    /// as a <see cref="Scope"/>.
                    /// </summary>
                    public static Scope ArrayValue3 { get; } = Constants.Enum3;
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1modifier~1martian.json/properties/header.RegexFilter/properties/scope"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1modifier~1martian.json/properties/header.RegexFilter/properties/scope";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1modifier~1martian.json/properties/header.RegexFilter/properties/scope"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        {
                            if (JsonElementHelpers.DeepEqualsNoParentDocumentCheck(Constants.Enum1, tokenType, parentDocument, parentIndex))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (JsonElementHelpers.DeepEqualsNoParentDocumentCheck(Constants.Enum2, tokenType, parentDocument, parentIndex))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (JsonElementHelpers.DeepEqualsNoParentDocumentCheck(Constants.Enum3, tokenType, parentDocument, parentIndex))
                            {
                                goto enumShortCircuitSuccess;
                            }
                        }
