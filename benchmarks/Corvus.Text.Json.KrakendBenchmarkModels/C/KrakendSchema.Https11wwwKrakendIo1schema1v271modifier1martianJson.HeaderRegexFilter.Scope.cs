    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271modifier1martianJson
    {
        ...
        public readonly partial struct HeaderRegexFilter
        {
...
#endif
            {
                ...
                internal Scope(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static Scope DefaultInstance { get; }
                ...
                /// </returns>
                public static bool operator ==(in Scope left, in Scope right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in Scope left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(Scope instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Scope(JsonElement instance)
                {
                    return Scope.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Scope From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Scope ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Scope>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Scope ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Scope>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Scope ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Scope>(json, options);
                }
                ...
                /// </exception>
                public static Scope ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<Scope>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out Scope? result)
                {
                    return JsonElementHelpers.TryParseValue<Scope>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Scope(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static Scope IJsonElement<Scope>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Scope: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Scope"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Scope"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Scope>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Scope"/> that lives for the lifetime of its
                ...
                public Scope Freeze()
                {
                    ...
                    {
                        return mutable.FreezeElement<Scope>(_idx);
                    }
                ...
                /// <param name="matchArrayValue1">Match 1st item.</param>
                /// <param name="matchArrayValue2">Match 2nd item.</param>
                /// <param name="matchArrayValue3">Match 3rd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchArrayValue1,
                    Func<TContext, TResult> matchArrayValue2,
                    Func<TContext, TResult> matchArrayValue3,
                    Func<TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    if (this.Equals(Constants.Enum1))
                    {
                        return matchArrayValue1(context);
                    }

                    if (this.Equals(Constants.Enum2))
                    {
                        return matchArrayValue2(context);
                    }

                    if (this.Equals(Constants.Enum3))
                    {
                        return matchArrayValue3(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchArrayValue1,
                    Func<TResult> matchArrayValue2,
                    Func<TResult> matchArrayValue3,
                    Func<TResult> defaultMatch)
                {
                    if (this.Equals(Constants.Enum1))
                    {
                        return matchArrayValue1();
                    }

                    if (this.Equals(Constants.Enum2))
                    {
                        return matchArrayValue2();
                    }

                    if (this.Equals(Constants.Enum3))
                    {
                        return matchArrayValue3();
                    }
