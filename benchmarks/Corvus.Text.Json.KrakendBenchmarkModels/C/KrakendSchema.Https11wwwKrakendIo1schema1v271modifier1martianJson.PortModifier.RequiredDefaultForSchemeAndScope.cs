    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271modifier1martianJson
    {
        ...
        public readonly partial struct PortModifier
        {
...
#endif
            {
                ...
                internal RequiredDefaultForSchemeAndScope(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.JsonElement DefaultForScheme
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DefaultForSchemeUtf8, out Corvus.Text.Json.JsonElement value))
                        {
                            return value;
                        }
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in RequiredDefaultForSchemeAndScope left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(RequiredDefaultForSchemeAndScope instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredDefaultForSchemeAndScope(JsonElement instance)
                {
                    return RequiredDefaultForSchemeAndScope.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredDefaultForSchemeAndScope From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredDefaultForSchemeAndScope ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredDefaultForSchemeAndScope>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredDefaultForSchemeAndScope ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredDefaultForSchemeAndScope>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredDefaultForSchemeAndScope ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredDefaultForSchemeAndScope>(json, options);
                }
                ...
                /// </exception>
                public static RequiredDefaultForSchemeAndScope ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<RequiredDefaultForSchemeAndScope>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredDefaultForSchemeAndScope? result)
                {
                    return JsonElementHelpers.TryParseValue<RequiredDefaultForSchemeAndScope>(ref reader, out result);
                }
...
#if NET
                static RequiredDefaultForSchemeAndScope IJsonElement<RequiredDefaultForSchemeAndScope>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredDefaultForSchemeAndScope: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public RequiredDefaultForSchemeAndScope Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public RequiredDefaultForSchemeAndScope Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<RequiredDefaultForSchemeAndScope>(_idx);
                    }
