        ...
        public readonly partial struct PriorityGroup
        {
            ...
            public readonly partial struct RequiredModifierAndPriorityArray
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="RequiredModifierAndPriority"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal RequiredModifierAndPriority(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static RequiredModifierAndPriority DefaultInstance { get; }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.JsonInteger Priority
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PriorityUtf8, out Corvus.KrakendBenchmark.Current.JsonInteger value))
                            {
                                return value;
                            }
                    ...
                    /// </returns>
                    public static bool operator ==(in RequiredModifierAndPriority left, in RequiredModifierAndPriority right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in RequiredModifierAndPriority left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(RequiredModifierAndPriority instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredModifierAndPriority(JsonElement instance)
                    {
                        return RequiredModifierAndPriority.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredModifierAndPriority From<T>(in T instance)
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredModifierAndPriority? result)
                    {
                        return JsonElementHelpers.TryParseValue<RequiredModifierAndPriority>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RequiredModifierAndPriority(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static RequiredModifierAndPriority IJsonElement<RequiredModifierAndPriority>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredModifierAndPriority: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RequiredModifierAndPriority"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RequiredModifierAndPriority"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public RequiredModifierAndPriority Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RequiredModifierAndPriority>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RequiredModifierAndPriority"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public RequiredModifierAndPriority Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<RequiredModifierAndPriority>(_idx);
                        }
