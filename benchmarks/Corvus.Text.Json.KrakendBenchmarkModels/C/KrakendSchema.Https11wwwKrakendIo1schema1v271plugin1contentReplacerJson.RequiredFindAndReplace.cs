...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1contentReplacerJson
    {
        ...
        public readonly partial struct RequiredFindAndReplace
            ...
            : IJsonElement<RequiredFindAndReplace>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RequiredFindAndReplace"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RequiredFindAndReplace(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RequiredFindAndReplace DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.JsonString Find
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FindUtf8, out Corvus.KrakendBenchmark.Current.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271plugin1contentReplacerJson.RequiredFindAndReplace.IsARegexp Regexp
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RegexpUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271plugin1contentReplacerJson.RequiredFindAndReplace.IsARegexp value))
                    {
                        return value;
                    }

                    return Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271plugin1contentReplacerJson.RequiredFindAndReplace.IsARegexp.DefaultInstance;
                }
            }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.JsonString Replace
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReplaceUtf8, out Corvus.KrakendBenchmark.Current.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in RequiredFindAndReplace left, in RequiredFindAndReplace right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RequiredFindAndReplace left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RequiredFindAndReplace instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredFindAndReplace(JsonElement instance)
            {
                return RequiredFindAndReplace.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredFindAndReplace From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredFindAndReplace ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredFindAndReplace>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredFindAndReplace ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredFindAndReplace>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredFindAndReplace ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredFindAndReplace>(json, options);
            }
            ...
            /// </exception>
            public static RequiredFindAndReplace ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RequiredFindAndReplace>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredFindAndReplace? result)
            {
                return JsonElementHelpers.TryParseValue<RequiredFindAndReplace>(ref reader, out result);
            }
...
#if NET
            static RequiredFindAndReplace IJsonElement<RequiredFindAndReplace>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredFindAndReplace: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public RequiredFindAndReplace Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public RequiredFindAndReplace Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RequiredFindAndReplace>(_idx);
                }
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="Find"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Find => [0x65, 0x00, 0x00, 0x00, 0x22, 0x66, 0x69, 0x6E, 0x64, 0x22];
