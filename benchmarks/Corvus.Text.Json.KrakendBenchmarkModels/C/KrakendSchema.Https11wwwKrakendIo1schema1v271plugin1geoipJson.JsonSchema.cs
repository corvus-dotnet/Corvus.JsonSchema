...
public readonly partial struct KrakendSchema
{
        ...
        : IJsonElement<Https11wwwKrakendIo1schema1v271plugin1geoipJson>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyCitydbPathPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("citydb_path"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyCitydbPathNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("citydb_path"u8, buffer, out written);

            private const int RequiredOffsetForCitydbPath = 0;
            private const uint RequiredBitForCitydbPath = 0b00000000000000000000000000000001;

            private const uint RequiredBitMask0 =
                RequiredBitForCitydbPath;
            private static readonly JsonSchemaPathProvider CitydbPathSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/citydb_path"u8, buffer, out written);

            private static void MatchCitydbPath(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.KrakendBenchmark.Current.JsonString.JsonSchema.PushChildContextUnescaped(
                        ...
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.CitydbPathUtf8,
                        evaluationPath: CitydbPathSchemaEvaluationPath);
                ...
                requiredBitBuffer[RequiredOffsetForCitydbPath] |= RequiredBitForCitydbPath;
            }
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.CitydbPathUtf8))
                {
                    matcher = MatchCitydbPath;
                    return true;
                }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1plugin~1geoip.json"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1plugin~1geoip.json";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1plugin~1geoip.json"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyCitydbPathPresent, "citydb_path"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForCitydbPath] & RequiredBitForCitydbPath) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyCitydbPathNotPresent, "citydb_path"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyCitydbPathPresent, "citydb_path"u8, "required"u8);
