...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1httpClientJson
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Https11wwwKrakendIo1schema1v271plugin1httpClientJson instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Https11wwwKrakendIo1schema1v271plugin1httpClientJson"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Https11wwwKrakendIo1schema1v271plugin1httpClientJson(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Https11wwwKrakendIo1schema1v271plugin1httpClientJson.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Https11wwwKrakendIo1schema1v271plugin1httpClientJson Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly Https11wwwKrakendIo1schema1v271plugin1httpClientJson Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Https11wwwKrakendIo1schema1v271plugin1httpClientJson>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271plugin1httpClientJson.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(Https11wwwKrakendIo1schema1v271plugin1httpClientJson instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271plugin1httpClientJson.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Https11wwwKrakendIo1schema1v271plugin1httpClientJson"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.KrakendBenchmark.Current.JsonString.Source name = default)
            {
            ...
            /// Creates an instance of a <see cref="Https11wwwKrakendIo1schema1v271plugin1httpClientJson"/>.
            /// </summary>
            public void Create(in Corvus.KrakendBenchmark.Current.JsonString.Source name = default)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonString.Source name = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        {
            return workspace.CreateBuilder<Https11wwwKrakendIo1schema1v271plugin1httpClientJson, Mutable>(this);
        }
    }
}
