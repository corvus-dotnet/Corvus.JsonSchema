    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1ipFilterJson
    {
        ...
        public readonly partial struct Cidr
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Cidr instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Cidr"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Cidr(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Cidr.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public readonly Cidr Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Cidr>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271plugin1ipFilterJson.Cidr.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(Cidr instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271plugin1ipFilterJson.Cidr.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<Cidr, Mutable>(this);
            }
        }
    }
}
