...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1ipFilterJson
    {
        ...
        public readonly partial struct Cidr
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="Cidr"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal Cidr(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Cidr DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in Cidr left, in Cidr right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Cidr left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(Cidr instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Cidr(JsonElement instance)
            {
                return Cidr.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Cidr From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Cidr ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Cidr>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Cidr ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Cidr>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Cidr ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Cidr>(json, options);
            }
            ...
            /// </exception>
            public static Cidr ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Cidr>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Cidr? result)
            {
                return JsonElementHelpers.TryParseValue<Cidr>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Cidr(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static Cidr IJsonElement<Cidr>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Cidr: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Cidr"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Cidr"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<Cidr>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Cidr"/> that lives for the lifetime of its
            ...
            public Cidr Freeze()
            {
                ...
                {
                    return mutable.FreezeElement<Cidr>(_idx);
                }
