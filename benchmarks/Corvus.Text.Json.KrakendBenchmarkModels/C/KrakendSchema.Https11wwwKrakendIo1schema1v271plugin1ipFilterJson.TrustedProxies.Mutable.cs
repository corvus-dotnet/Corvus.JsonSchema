    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1ipFilterJson
    {
        ...
        public readonly partial struct TrustedProxies
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TrustedProxies instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TrustedProxies"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TrustedProxies(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TrustedProxies.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public readonly TrustedProxies Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TrustedProxies Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TrustedProxies>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271plugin1ipFilterJson.TrustedProxies.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(TrustedProxies instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271plugin1ipFilterJson.TrustedProxies.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<TrustedProxies, Mutable>(this);
            }
        }
    }
}
