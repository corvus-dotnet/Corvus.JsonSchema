...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1ipFilterJson
    {
        ...
        public readonly partial struct TrustedProxies
#if NET8_0_OR_GREATER
            : IJsonElement<TrustedProxies>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="TrustedProxies"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal TrustedProxies(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static TrustedProxies DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in TrustedProxies left, in TrustedProxies right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in TrustedProxies left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(TrustedProxies instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TrustedProxies(JsonElement instance)
            {
                return TrustedProxies.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TrustedProxies From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TrustedProxies ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TrustedProxies>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TrustedProxies ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TrustedProxies>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TrustedProxies ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TrustedProxies>(json, options);
            }
            ...
            /// </exception>
            public static TrustedProxies ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<TrustedProxies>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out TrustedProxies? result)
            {
                return JsonElementHelpers.TryParseValue<TrustedProxies>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new TrustedProxies(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static TrustedProxies IJsonElement<TrustedProxies>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TrustedProxies: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="TrustedProxies"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TrustedProxies"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public TrustedProxies Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TrustedProxies>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TrustedProxies"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public TrustedProxies Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<TrustedProxies>(_idx);
                }
