...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1ipFilterJson
        ...
        : IJsonElement<Https11wwwKrakendIo1schema1v271plugin1ipFilterJson>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Https11wwwKrakendIo1schema1v271plugin1ipFilterJson"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Https11wwwKrakendIo1schema1v271plugin1ipFilterJson(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Https11wwwKrakendIo1schema1v271plugin1ipFilterJson DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271plugin1ipFilterJson.AllowOrDenyMode Allow
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AllowUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271plugin1ipFilterJson.AllowOrDenyMode value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271plugin1ipFilterJson.AllowOrDenyMode.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in Https11wwwKrakendIo1schema1v271plugin1ipFilterJson left, in Https11wwwKrakendIo1schema1v271plugin1ipFilterJson right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Https11wwwKrakendIo1schema1v271plugin1ipFilterJson left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Https11wwwKrakendIo1schema1v271plugin1ipFilterJson instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Https11wwwKrakendIo1schema1v271plugin1ipFilterJson(JsonElement instance)
        {
            return Https11wwwKrakendIo1schema1v271plugin1ipFilterJson.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271plugin1ipFilterJson From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271plugin1ipFilterJson ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271plugin1ipFilterJson>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271plugin1ipFilterJson ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271plugin1ipFilterJson>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271plugin1ipFilterJson ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271plugin1ipFilterJson>(json, options);
        }
        ...
        /// </exception>
        public static Https11wwwKrakendIo1schema1v271plugin1ipFilterJson ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271plugin1ipFilterJson>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Https11wwwKrakendIo1schema1v271plugin1ipFilterJson? result)
        {
            return JsonElementHelpers.TryParseValue<Https11wwwKrakendIo1schema1v271plugin1ipFilterJson>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Https11wwwKrakendIo1schema1v271plugin1ipFilterJson(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Https11wwwKrakendIo1schema1v271plugin1ipFilterJson IJsonElement<Https11wwwKrakendIo1schema1v271plugin1ipFilterJson>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Https11wwwKrakendIo1schema1v271plugin1ipFilterJson: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Https11wwwKrakendIo1schema1v271plugin1ipFilterJson"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Https11wwwKrakendIo1schema1v271plugin1ipFilterJson"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Https11wwwKrakendIo1schema1v271plugin1ipFilterJson Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<Https11wwwKrakendIo1schema1v271plugin1ipFilterJson>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Https11wwwKrakendIo1schema1v271plugin1ipFilterJson"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public Https11wwwKrakendIo1schema1v271plugin1ipFilterJson Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<Https11wwwKrakendIo1schema1v271plugin1ipFilterJson>(_idx);
            }
