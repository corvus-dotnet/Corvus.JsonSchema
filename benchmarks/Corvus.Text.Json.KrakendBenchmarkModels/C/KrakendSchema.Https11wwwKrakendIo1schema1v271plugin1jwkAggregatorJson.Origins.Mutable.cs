    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson
    {
        ...
        public readonly partial struct Origins
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Origins instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Origins"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Origins(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Origins.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public readonly Origins Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Origins>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson.Origins.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(Origins instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271plugin1jwkAggregatorJson.Origins.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<Origins, Mutable>(this);
            }
        }
    }
}
