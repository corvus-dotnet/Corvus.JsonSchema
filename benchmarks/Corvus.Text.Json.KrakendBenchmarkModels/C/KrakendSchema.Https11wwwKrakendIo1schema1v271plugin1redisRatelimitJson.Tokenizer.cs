...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1redisRatelimitJson
    {
...
#endif
        {
            ...
            internal Tokenizer(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Tokenizer DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(Tokenizer value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in Tokenizer left, in Tokenizer right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Tokenizer left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(Tokenizer instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Tokenizer(JsonElement instance)
            {
                return Tokenizer.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Tokenizer From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Tokenizer ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Tokenizer>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Tokenizer ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Tokenizer>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Tokenizer ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Tokenizer>(json, options);
            }
            ...
            /// </exception>
            public static Tokenizer ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Tokenizer>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Tokenizer? result)
            {
                return JsonElementHelpers.TryParseValue<Tokenizer>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Tokenizer(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static Tokenizer IJsonElement<Tokenizer>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Tokenizer: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Tokenizer"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Tokenizer"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<Tokenizer>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Tokenizer"/> that lives for the lifetime of its
            ...
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchJwt,
                Func<TContext, TResult> matchIp,
                Func<TContext, TResult> matchUrl,
                Func<TContext, TResult> matchPath,
                Func<TContext, TResult> matchHeader,
                Func<TContext, TResult> matchParam,
            ...
            public TResult Match<TResult>(
                Func<TResult> matchJwt,
                Func<TResult> matchIp,
                Func<TResult> matchUrl,
                Func<TResult> matchPath,
                Func<TResult> matchHeader,
                Func<TResult> matchParam,
