    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson
    {
        ...
        public readonly partial struct ErrorDefinition
        {
...
#endif
            {
                ...
                internal ErrorCode(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static ErrorCode DefaultInstance { get; } = ParsedJsonDocument<ErrorCode>.NumberConstant([.."500"u8]);
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator long(ErrorCode value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator double(ErrorCode value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator Corvus.Numerics.BigNumber(ErrorCode value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator System.Numerics.BigInteger(ErrorCode value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in ErrorCode left, in ErrorCode right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in ErrorCode left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(ErrorCode instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ErrorCode(JsonElement instance)
                {
                    return ErrorCode.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ErrorCode From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ErrorCode ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ErrorCode>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ErrorCode ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ErrorCode>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ErrorCode ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ErrorCode>(json, options);
                }
                ...
                /// </exception>
                public static ErrorCode ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<ErrorCode>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out ErrorCode? result)
                {
                    return JsonElementHelpers.TryParseValue<ErrorCode>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ErrorCode(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static ErrorCode IJsonElement<ErrorCode>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ErrorCode: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ErrorCode"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ErrorCode"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ErrorCode>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ErrorCode"/> that lives for the lifetime of its
