...
public readonly partial struct KrakendSchema
{
...
#endif
    {
        ...
        internal Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson.ErrorDefinition Error
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ErrorUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson.ErrorDefinition value))
                {
                    return value;
                }
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson(JsonElement instance)
        {
            return Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson>(json, options);
        }
        ...
        /// </exception>
        public static Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson? result)
        {
            return JsonElementHelpers.TryParseValue<Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson>(ref reader, out result);
        }
...
#if NET
        static Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson IJsonElement<Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<Https11wwwKrakendIo1schema1v271plugin1responseSchemaValidatorJson>(_idx);
            }
