    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1urlRewriteJson
    {
            ...
            : IJsonElement<JsonArrayArray>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1plugin~1url-rewrite.json/properties/regexp"u8, buffer, out written);
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        while (arrayValidation_enumerator.MoveNext())
                        {
                            ...
                            JsonSchemaContext childContext = Corvus.KrakendBenchmark.Current.JsonArray.JsonSchema.PushChildContext(
                                parentDocument,
                            ...
                            Corvus.KrakendBenchmark.Current.JsonArray.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
