    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1urlRewriteJson
    {
        ...
        public readonly partial struct LiteralMatch
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(LiteralMatch instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="LiteralMatch"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LiteralMatch(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new LiteralMatch(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LiteralMatch.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="LiteralMatch"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="LiteralMatch"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly LiteralMatch Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<LiteralMatch>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="LiteralMatch"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly LiteralMatch Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<LiteralMatch>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271plugin1urlRewriteJson.LiteralMatch.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(LiteralMatch instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271plugin1urlRewriteJson.LiteralMatch.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<LiteralMatch, Mutable>(this);
            }
        }
    }
}
