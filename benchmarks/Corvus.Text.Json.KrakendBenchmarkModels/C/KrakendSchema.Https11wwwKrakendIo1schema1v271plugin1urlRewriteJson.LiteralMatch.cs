...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1urlRewriteJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="LiteralMatch"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal LiteralMatch(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static LiteralMatch DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in LiteralMatch left, in LiteralMatch right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in LiteralMatch left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(LiteralMatch instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LiteralMatch(JsonElement instance)
            {
                return LiteralMatch.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LiteralMatch From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LiteralMatch ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LiteralMatch>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LiteralMatch ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LiteralMatch>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LiteralMatch ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LiteralMatch>(json, options);
            }
            ...
            /// </exception>
            public static LiteralMatch ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<LiteralMatch>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out LiteralMatch? result)
            {
                return JsonElementHelpers.TryParseValue<LiteralMatch>(ref reader, out result);
            }
...
#if NET
            static LiteralMatch IJsonElement<LiteralMatch>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LiteralMatch: ValueKind = {ValueKind} : \"{ToString()}\"";
