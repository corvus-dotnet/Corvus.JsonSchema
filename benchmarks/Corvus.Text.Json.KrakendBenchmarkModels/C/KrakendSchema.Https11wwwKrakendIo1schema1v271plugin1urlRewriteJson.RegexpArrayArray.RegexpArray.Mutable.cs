        ...
        public readonly partial struct RegexpArrayArray
        {
            ...
            public readonly partial struct RegexpArray
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RegexpArray instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RegexpArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RegexpArray(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RegexpArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RegexpArray Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RegexpArray Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RegexpArray>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271plugin1urlRewriteJson.RegexpArrayArray.RegexpArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(RegexpArray instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271plugin1urlRewriteJson.RegexpArrayArray.RegexpArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<RegexpArray, Mutable>(this);
                }
            }
        }
    }
