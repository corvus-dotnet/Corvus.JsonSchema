    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1wildcardJson
    {
        ...
        public readonly partial struct Endpoints
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Endpoints instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Endpoints"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Endpoints(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Endpoints.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly Endpoints Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly Endpoints Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Endpoints>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271plugin1wildcardJson.Endpoints.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(Endpoints instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271plugin1wildcardJson.Endpoints.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<Endpoints, Mutable>(this);
            }
        }
    }
}
