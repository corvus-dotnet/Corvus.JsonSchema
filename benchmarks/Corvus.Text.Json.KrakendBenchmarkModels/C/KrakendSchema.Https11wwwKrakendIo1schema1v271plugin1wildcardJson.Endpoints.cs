...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1wildcardJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="Endpoints"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal Endpoints(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Endpoints DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in Endpoints left, in Endpoints right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Endpoints left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(Endpoints instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Endpoints(JsonElement instance)
            {
                return Endpoints.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Endpoints From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Endpoints ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Endpoints>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Endpoints ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Endpoints>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Endpoints ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Endpoints>(json, options);
            }
            ...
            /// </exception>
            public static Endpoints ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Endpoints>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Endpoints? result)
            {
                return JsonElementHelpers.TryParseValue<Endpoints>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Endpoints(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static Endpoints IJsonElement<Endpoints>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Endpoints: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Endpoints"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Endpoints"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<Endpoints>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Endpoints"/> that lives for the lifetime of its
