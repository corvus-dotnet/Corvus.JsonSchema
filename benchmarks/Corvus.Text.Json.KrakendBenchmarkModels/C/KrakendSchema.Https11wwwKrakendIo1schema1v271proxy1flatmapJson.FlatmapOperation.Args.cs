    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271proxy1flatmapJson
    {
        ...
        public readonly partial struct FlatmapOperation
        {
...
#endif
            {
                ...
                internal Args(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static Args DefaultInstance { get; }
                ...
                /// </returns>
                public static bool operator ==(in Args left, in Args right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in Args left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(Args instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Args(JsonElement instance)
                {
                    return Args.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Args From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Args ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Args>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Args ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Args>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Args ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Args>(json, options);
                }
                ...
                /// </exception>
                public static Args ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<Args>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out Args? result)
                {
                    return JsonElementHelpers.TryParseValue<Args>(ref reader, out result);
                }
...
#if NET
                static Args IJsonElement<Args>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Args: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                public Args Freeze()
                {
                    ...
                    {
                        return mutable.FreezeElement<Args>(_idx);
                    }
