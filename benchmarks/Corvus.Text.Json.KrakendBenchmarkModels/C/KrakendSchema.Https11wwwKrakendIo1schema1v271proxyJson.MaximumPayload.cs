...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271proxyJson
    {
        ...
        public readonly partial struct MaximumPayload
#if NET8_0_OR_GREATER
            : IJsonElement<MaximumPayload>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="MaximumPayload"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal MaximumPayload(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static MaximumPayload DefaultInstance { get; } = ParsedJsonDocument<MaximumPayload>.NumberConstant([.."0"u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator System.Numerics.BigInteger(MaximumPayload value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator decimal(MaximumPayload value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in MaximumPayload left, in MaximumPayload right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in MaximumPayload left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(MaximumPayload instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MaximumPayload(JsonElement instance)
            {
                return MaximumPayload.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MaximumPayload From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MaximumPayload ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MaximumPayload>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MaximumPayload ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MaximumPayload>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MaximumPayload ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MaximumPayload>(json, options);
            }
            ...
            /// </exception>
            public static MaximumPayload ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<MaximumPayload>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out MaximumPayload? result)
            {
                return JsonElementHelpers.TryParseValue<MaximumPayload>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MaximumPayload(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static MaximumPayload IJsonElement<MaximumPayload>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MaximumPayload: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MaximumPayload"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MaximumPayload"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public MaximumPayload Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MaximumPayload>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MaximumPayload"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public MaximumPayload Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<MaximumPayload>(_idx);
                }
