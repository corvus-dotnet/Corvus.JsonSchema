...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271proxyJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="TrafficShadowingOrMirroring"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal TrafficShadowingOrMirroring(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static TrafficShadowingOrMirroring DefaultInstance { get; } = ParsedJsonDocument<TrafficShadowingOrMirroring>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(TrafficShadowingOrMirroring value)
            {
            ...
            /// </returns>
            public static bool operator ==(in TrafficShadowingOrMirroring left, in TrafficShadowingOrMirroring right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in TrafficShadowingOrMirroring left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(TrafficShadowingOrMirroring instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TrafficShadowingOrMirroring(JsonElement instance)
            {
                return TrafficShadowingOrMirroring.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TrafficShadowingOrMirroring From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TrafficShadowingOrMirroring ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TrafficShadowingOrMirroring>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TrafficShadowingOrMirroring ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TrafficShadowingOrMirroring>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TrafficShadowingOrMirroring ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TrafficShadowingOrMirroring>(json, options);
            }
            ...
            /// </exception>
            public static TrafficShadowingOrMirroring ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<TrafficShadowingOrMirroring>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out TrafficShadowingOrMirroring? result)
            {
                return JsonElementHelpers.TryParseValue<TrafficShadowingOrMirroring>(ref reader, out result);
            }
...
#if NET
            static TrafficShadowingOrMirroring IJsonElement<TrafficShadowingOrMirroring>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TrafficShadowingOrMirroring: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public TrafficShadowingOrMirroring Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public TrafficShadowingOrMirroring Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<TrafficShadowingOrMirroring>(_idx);
                }
