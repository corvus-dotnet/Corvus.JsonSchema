...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson
    {
        ...
        public readonly partial struct LogStatusChange
#if NET8_0_OR_GREATER
            : IJsonElement<LogStatusChange>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="LogStatusChange"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal LogStatusChange(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static LogStatusChange DefaultInstance { get; } = ParsedJsonDocument<LogStatusChange>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(LogStatusChange value)
            {
            ...
            /// </returns>
            public static bool operator ==(in LogStatusChange left, in LogStatusChange right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in LogStatusChange left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(LogStatusChange instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LogStatusChange(JsonElement instance)
            {
                return LogStatusChange.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LogStatusChange From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LogStatusChange ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LogStatusChange>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LogStatusChange ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LogStatusChange>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LogStatusChange ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LogStatusChange>(json, options);
            }
            ...
            /// </exception>
            public static LogStatusChange ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<LogStatusChange>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out LogStatusChange? result)
            {
                return JsonElementHelpers.TryParseValue<LogStatusChange>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new LogStatusChange(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static LogStatusChange IJsonElement<LogStatusChange>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LogStatusChange: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="LogStatusChange"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="LogStatusChange"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public LogStatusChange Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<LogStatusChange>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="LogStatusChange"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public LogStatusChange Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<LogStatusChange>(_idx);
                }
