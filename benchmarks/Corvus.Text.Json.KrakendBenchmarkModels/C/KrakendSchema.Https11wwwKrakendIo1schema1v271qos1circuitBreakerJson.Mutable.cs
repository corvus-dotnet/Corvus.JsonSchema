...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.JsonInteger.Mutable Interval
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IntervalUtf8, out Corvus.KrakendBenchmark.Current.JsonInteger.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson.LogStatusChange.Mutable LogStatusChangeValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LogStatusChangeValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson.LogStatusChange.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.JsonInteger.Mutable MaxErrors
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxErrorsUtf8, out Corvus.KrakendBenchmark.Current.JsonInteger.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.JsonInteger.Mutable Timeout
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TimeoutUtf8, out Corvus.KrakendBenchmark.Current.JsonInteger.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetInterval(in Corvus.KrakendBenchmark.Current.JsonInteger.Source value)
            {
                CheckValidInstance();
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Interval, ref cvb);
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetLogStatusChangeValue(in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson.LogStatusChange.Source value)
            {
                CheckValidInstance();
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.LogStatusChangeValue, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetMaxErrors(in Corvus.KrakendBenchmark.Current.JsonInteger.Source value)
            {
                CheckValidInstance();
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.MaxErrors, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetTimeout(in Corvus.KrakendBenchmark.Current.JsonInteger.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.KrakendBenchmark.Current.JsonInteger.Source interval,
                in Corvus.KrakendBenchmark.Current.JsonInteger.Source maxErrors,
                in Corvus.KrakendBenchmark.Current.JsonInteger.Source timeout,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson.LogStatusChange.Source logStatusChange = default,
                in Corvus.KrakendBenchmark.Current.JsonString.Source name = default)
            {
                interval.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Interval, ref builder);
                maxErrors.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.MaxErrors, ref builder);
                timeout.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Timeout, ref builder);
                logStatusChange.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.LogStatusChangeValue, ref builder);
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonInteger.Source interval, in Corvus.KrakendBenchmark.Current.JsonInteger.Source maxErrors, in Corvus.KrakendBenchmark.Current.JsonInteger.Source timeout, in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson.LogStatusChange.Source logStatusChange = default, in Corvus.KrakendBenchmark.Current.JsonString.Source name = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
