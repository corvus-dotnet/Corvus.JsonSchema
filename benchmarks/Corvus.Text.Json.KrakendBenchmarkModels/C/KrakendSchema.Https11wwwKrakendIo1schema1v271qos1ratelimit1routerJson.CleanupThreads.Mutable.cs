    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271qos1ratelimit1routerJson
    {
        ...
        public readonly partial struct CleanupThreads
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(CleanupThreads instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CleanupThreads"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CleanupThreads(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CleanupThreads.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly CleanupThreads Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly CleanupThreads Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CleanupThreads>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(CleanupThreads instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<CleanupThreads, Mutable>(this);
            }
        }
    }
}
