    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271qos1ratelimit1routerJson
    {
        ...
        public readonly partial struct ClientCapacity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ClientCapacity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ClientCapacity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ClientCapacity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ClientCapacity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ClientCapacity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ClientCapacity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ClientCapacity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ClientCapacity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ClientCapacity, Mutable>(this);
            }
        }
    }
}
