...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271qos1ratelimit1routerJson
    {
        ...
        public readonly partial struct RequiredClientMaxRate
            : IJsonElement<RequiredClientMaxRate>
        {
            public static partial class JsonSchema
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyClientMaxRatePresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("client_max_rate"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyClientMaxRateNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("client_max_rate"u8, buffer, out written);

                private const int RequiredOffsetForClientMaxRate = 0;
                private const uint RequiredBitForClientMaxRate = 0b00000000000000000000000000000001;

                private const uint RequiredBitMask0 =
                    RequiredBitForClientMaxRate;
                ...
                {
                    requiredBitBuffer[RequiredOffsetForClientMaxRate] |= RequiredBitForClientMaxRate;
                }
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.ClientMaxRateUtf8))
                    {
                        matcher = MatchClientMaxRate;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1qos~1ratelimit~1router.json/anyOf/1"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1qos~1ratelimit~1router.json/anyOf/1";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1qos~1ratelimit~1router.json/anyOf/1"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.StartObject)
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyClientMaxRatePresent, "client_max_rate"u8, "required"u8);
                        }
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForClientMaxRate] & RequiredBitForClientMaxRate) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyClientMaxRateNotPresent, "client_max_rate"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyClientMaxRatePresent, "client_max_rate"u8, "required"u8);
