...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271qos1ratelimit1routerJson
    {
        ...
        public readonly partial struct RequiredMaxRate
#if NET8_0_OR_GREATER
            : IJsonElement<RequiredMaxRate>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RequiredMaxRate"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RequiredMaxRate(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RequiredMaxRate DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.JsonElement MaxRate
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxRateUtf8, out Corvus.Text.Json.JsonElement value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in RequiredMaxRate left, in RequiredMaxRate right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RequiredMaxRate left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RequiredMaxRate instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredMaxRate(JsonElement instance)
            {
                return RequiredMaxRate.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredMaxRate From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredMaxRate ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredMaxRate>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredMaxRate ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredMaxRate>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredMaxRate ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredMaxRate>(json, options);
            }
            ...
            /// </exception>
            public static RequiredMaxRate ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RequiredMaxRate>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredMaxRate? result)
            {
                return JsonElementHelpers.TryParseValue<RequiredMaxRate>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RequiredMaxRate(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RequiredMaxRate IJsonElement<RequiredMaxRate>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredMaxRate: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RequiredMaxRate"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RequiredMaxRate"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RequiredMaxRate Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RequiredMaxRate>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RequiredMaxRate"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RequiredMaxRate Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RequiredMaxRate>(_idx);
                }
