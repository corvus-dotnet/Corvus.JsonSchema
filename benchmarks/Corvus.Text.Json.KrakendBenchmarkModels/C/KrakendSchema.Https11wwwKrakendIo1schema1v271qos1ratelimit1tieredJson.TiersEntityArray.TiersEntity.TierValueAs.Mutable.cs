            ...
            public readonly partial struct TiersEntity
            {
                ...
                public readonly partial struct TierValueAs
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(TierValueAs instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="TierValueAs"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator TierValueAs(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"TierValueAs.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly TierValueAs Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly TierValueAs Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<TierValueAs>(_idx);
                        }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(TierValueAs instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<TierValueAs, Mutable>(this);
                    }
                }
            }
        }
