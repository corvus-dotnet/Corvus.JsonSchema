        ...
        public readonly partial struct TiersEntityArray
        {
            ...
            public readonly partial struct TiersEntity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="TierValueAs"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal TierValueAs(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static TierValueAs DefaultInstance { get; } = ParsedJsonDocument<TierValueAs>.StringConstant([.."\"literal\""u8]);
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator string(TierValueAs value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                    ...
                    /// </returns>
                    public static bool operator ==(in TierValueAs left, in TierValueAs right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in TierValueAs left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(TierValueAs instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TierValueAs(JsonElement instance)
                    {
                        return TierValueAs.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static TierValueAs From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static TierValueAs ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<TierValueAs>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static TierValueAs ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<TierValueAs>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static TierValueAs ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<TierValueAs>(json, options);
                    }
                    ...
                    /// </exception>
                    public static TierValueAs ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<TierValueAs>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out TierValueAs? result)
                    {
                        return JsonElementHelpers.TryParseValue<TierValueAs>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new TierValueAs(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static TierValueAs IJsonElement<TierValueAs>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TierValueAs: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="TierValueAs"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="TierValueAs"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public TierValueAs Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<TierValueAs>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="TierValueAs"/> that lives for the lifetime of its
                    ...
                    /// <param name="matchLiteral">Match 1st item.</param>
                    /// <param name="matchPolicy">Match 2nd item.</param>
                    /// <param name="matchAst">Match 3rd item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchLiteral,
                        Func<TContext, TResult> matchPolicy,
...
#endif
                    {
                        ...
                        {
                            return matchLiteral(context);
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchPolicy(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> matchLiteral,
                        Func<TResult> matchPolicy,
