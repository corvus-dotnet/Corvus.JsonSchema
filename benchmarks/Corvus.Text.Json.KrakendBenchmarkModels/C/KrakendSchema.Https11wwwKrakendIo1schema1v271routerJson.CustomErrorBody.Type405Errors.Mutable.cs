        ...
        public readonly partial struct CustomErrorBody
        {
            ...
            public readonly partial struct Type405Errors
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly Type405Errors Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly Type405Errors Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<Type405Errors>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271routerJson.CustomErrorBody.Type405Errors.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271routerJson.CustomErrorBody.Type405Errors.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
