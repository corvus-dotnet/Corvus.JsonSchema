    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271routerJson
    {
        ...
        public readonly partial struct CustomErrorBody
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="Type405Errors"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal Type405Errors(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static Type405Errors DefaultInstance { get; }
                ...
                /// </returns>
                public static bool operator ==(in Type405Errors left, in Type405Errors right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in Type405Errors left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(Type405Errors instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Type405Errors(JsonElement instance)
                {
                    return Type405Errors.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Type405Errors From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Type405Errors ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Type405Errors>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Type405Errors ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Type405Errors>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Type405Errors ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Type405Errors>(json, options);
                }
                ...
                /// </exception>
                public static Type405Errors ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<Type405Errors>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out Type405Errors? result)
                {
                    return JsonElementHelpers.TryParseValue<Type405Errors>(ref reader, out result);
                }
...
#if NET
                static Type405Errors IJsonElement<Type405Errors>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Type405Errors: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Type405Errors"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Type405Errors"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Type405Errors Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Type405Errors>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Type405Errors"/> that lives for the lifetime of its
