    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271routerJson
    {
            ...
            : IJsonElement<DisableAccessLog>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1router.json/properties/disable_access_log"u8, buffer, out written);
