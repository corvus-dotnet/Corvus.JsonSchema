...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271routerJson
    {
        ...
        public readonly partial struct DisableAccessLog
#if NET8_0_OR_GREATER
            : IJsonElement<DisableAccessLog>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DisableAccessLog"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal DisableAccessLog(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static DisableAccessLog DefaultInstance { get; } = ParsedJsonDocument<DisableAccessLog>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(DisableAccessLog value)
            {
            ...
            /// </returns>
            public static bool operator ==(in DisableAccessLog left, in DisableAccessLog right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in DisableAccessLog left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(DisableAccessLog instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DisableAccessLog(JsonElement instance)
            {
                return DisableAccessLog.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DisableAccessLog From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DisableAccessLog ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DisableAccessLog>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DisableAccessLog ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DisableAccessLog>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DisableAccessLog ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DisableAccessLog>(json, options);
            }
            ...
            /// </exception>
            public static DisableAccessLog ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<DisableAccessLog>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out DisableAccessLog? result)
            {
                return JsonElementHelpers.TryParseValue<DisableAccessLog>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DisableAccessLog(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static DisableAccessLog IJsonElement<DisableAccessLog>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DisableAccessLog: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DisableAccessLog"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DisableAccessLog"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public DisableAccessLog Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DisableAccessLog>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DisableAccessLog"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public DisableAccessLog Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<DisableAccessLog>(_idx);
                }
