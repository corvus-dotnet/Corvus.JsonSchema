    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271routerJson
    {
        ...
        public readonly partial struct ForwardedByClientIp
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ForwardedByClientIp instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ForwardedByClientIp"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ForwardedByClientIp(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ForwardedByClientIp.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ForwardedByClientIp Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ForwardedByClientIp Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ForwardedByClientIp>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ForwardedByClientIp instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ForwardedByClientIp, Mutable>(this);
            }
        }
    }
}
