    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271routerJson
    {
        ...
        public readonly partial struct HideVersionHeader
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(HideVersionHeader instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="HideVersionHeader"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator HideVersionHeader(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"HideVersionHeader.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly HideVersionHeader Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly HideVersionHeader Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<HideVersionHeader>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(HideVersionHeader instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<HideVersionHeader, Mutable>(this);
            }
        }
    }
}
