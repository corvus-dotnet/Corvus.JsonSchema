...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271routerJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="HideVersionHeader"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal HideVersionHeader(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static HideVersionHeader DefaultInstance { get; } = ParsedJsonDocument<HideVersionHeader>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(HideVersionHeader value)
            {
            ...
            /// </returns>
            public static bool operator ==(in HideVersionHeader left, in HideVersionHeader right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in HideVersionHeader left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(HideVersionHeader instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator HideVersionHeader(JsonElement instance)
            {
                return HideVersionHeader.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HideVersionHeader From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HideVersionHeader ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HideVersionHeader>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HideVersionHeader ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HideVersionHeader>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HideVersionHeader ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HideVersionHeader>(json, options);
            }
            ...
            /// </exception>
            public static HideVersionHeader ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<HideVersionHeader>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out HideVersionHeader? result)
            {
                return JsonElementHelpers.TryParseValue<HideVersionHeader>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new HideVersionHeader(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static HideVersionHeader IJsonElement<HideVersionHeader>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"HideVersionHeader: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="HideVersionHeader"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="HideVersionHeader"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public HideVersionHeader Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<HideVersionHeader>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="HideVersionHeader"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public HideVersionHeader Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<HideVersionHeader>(_idx);
                }
