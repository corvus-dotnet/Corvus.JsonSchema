    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271routerJson
    {
        ...
        public readonly partial struct RemoveExtraSlash
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RemoveExtraSlash instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RemoveExtraSlash"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RemoveExtraSlash(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RemoveExtraSlash.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RemoveExtraSlash Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RemoveExtraSlash Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RemoveExtraSlash>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RemoveExtraSlash instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RemoveExtraSlash, Mutable>(this);
            }
        }
    }
}
