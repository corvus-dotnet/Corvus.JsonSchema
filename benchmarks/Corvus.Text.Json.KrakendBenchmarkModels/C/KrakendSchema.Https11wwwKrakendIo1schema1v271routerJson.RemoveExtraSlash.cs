...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271routerJson
    {
        ...
        public readonly partial struct RemoveExtraSlash
#if NET8_0_OR_GREATER
            : IJsonElement<RemoveExtraSlash>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RemoveExtraSlash"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RemoveExtraSlash(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RemoveExtraSlash DefaultInstance { get; } = ParsedJsonDocument<RemoveExtraSlash>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(RemoveExtraSlash value)
            {
            ...
            /// </returns>
            public static bool operator ==(in RemoveExtraSlash left, in RemoveExtraSlash right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RemoveExtraSlash left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RemoveExtraSlash instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RemoveExtraSlash(JsonElement instance)
            {
                return RemoveExtraSlash.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RemoveExtraSlash From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RemoveExtraSlash ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RemoveExtraSlash>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RemoveExtraSlash ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RemoveExtraSlash>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RemoveExtraSlash ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RemoveExtraSlash>(json, options);
            }
            ...
            /// </exception>
            public static RemoveExtraSlash ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RemoveExtraSlash>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RemoveExtraSlash? result)
            {
                return JsonElementHelpers.TryParseValue<RemoveExtraSlash>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RemoveExtraSlash(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RemoveExtraSlash IJsonElement<RemoveExtraSlash>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RemoveExtraSlash: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RemoveExtraSlash"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RemoveExtraSlash"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RemoveExtraSlash Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RemoveExtraSlash>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RemoveExtraSlash"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RemoveExtraSlash Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RemoveExtraSlash>(_idx);
                }
