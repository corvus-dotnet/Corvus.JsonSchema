...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271routerJson
    {
        ...
        public readonly partial struct ReturningTheGatewayErrorMessage
#if NET8_0_OR_GREATER
            : IJsonElement<ReturningTheGatewayErrorMessage>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ReturningTheGatewayErrorMessage"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ReturningTheGatewayErrorMessage(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ReturningTheGatewayErrorMessage DefaultInstance { get; } = ParsedJsonDocument<ReturningTheGatewayErrorMessage>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(ReturningTheGatewayErrorMessage value)
            {
            ...
            /// </returns>
            public static bool operator ==(in ReturningTheGatewayErrorMessage left, in ReturningTheGatewayErrorMessage right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ReturningTheGatewayErrorMessage left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ReturningTheGatewayErrorMessage instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ReturningTheGatewayErrorMessage(JsonElement instance)
            {
                return ReturningTheGatewayErrorMessage.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ReturningTheGatewayErrorMessage From<T>(in T instance)
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ReturningTheGatewayErrorMessage? result)
            {
                return JsonElementHelpers.TryParseValue<ReturningTheGatewayErrorMessage>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ReturningTheGatewayErrorMessage(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ReturningTheGatewayErrorMessage IJsonElement<ReturningTheGatewayErrorMessage>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ReturningTheGatewayErrorMessage: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ReturningTheGatewayErrorMessage"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ReturningTheGatewayErrorMessage"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ReturningTheGatewayErrorMessage Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ReturningTheGatewayErrorMessage>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ReturningTheGatewayErrorMessage"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ReturningTheGatewayErrorMessage Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ReturningTheGatewayErrorMessage>(_idx);
                }
