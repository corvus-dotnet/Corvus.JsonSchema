...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1botDetectorJson
    {
        ...
        public readonly partial struct BotPatterns
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(BotPatterns instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="BotPatterns"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator BotPatterns(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new BotPatterns(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"BotPatterns.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// <summary>
                /// Gets a <see cref="BotPatterns"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="BotPatterns"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly BotPatterns Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<BotPatterns>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="BotPatterns"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly BotPatterns Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<BotPatterns>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271security1botDetectorJson.BotPatterns.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(BotPatterns instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271security1botDetectorJson.BotPatterns.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<BotPatterns, Mutable>(this);
            }
        }
    }
}
