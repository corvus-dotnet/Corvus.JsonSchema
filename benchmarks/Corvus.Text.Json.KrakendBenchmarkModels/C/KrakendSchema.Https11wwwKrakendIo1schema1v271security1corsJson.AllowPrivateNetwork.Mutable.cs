    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1corsJson
    {
        ...
        public readonly partial struct AllowPrivateNetwork
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AllowPrivateNetwork instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AllowPrivateNetwork"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AllowPrivateNetwork(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AllowPrivateNetwork.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AllowPrivateNetwork Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AllowPrivateNetwork Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AllowPrivateNetwork>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AllowPrivateNetwork instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AllowPrivateNetwork, Mutable>(this);
            }
        }
    }
}
