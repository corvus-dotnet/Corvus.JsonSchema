...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1corsJson
    {
        ...
        public readonly partial struct AllowedHeaders
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AllowedHeaders instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AllowedHeaders"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AllowedHeaders(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new AllowedHeaders(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AllowedHeaders.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// <summary>
                /// Gets a <see cref="AllowedHeaders"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="AllowedHeaders"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly AllowedHeaders Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<AllowedHeaders>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="AllowedHeaders"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly AllowedHeaders Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AllowedHeaders>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271security1corsJson.AllowedHeaders.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(AllowedHeaders instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271security1corsJson.AllowedHeaders.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<AllowedHeaders, Mutable>(this);
            }
        }
    }
}
