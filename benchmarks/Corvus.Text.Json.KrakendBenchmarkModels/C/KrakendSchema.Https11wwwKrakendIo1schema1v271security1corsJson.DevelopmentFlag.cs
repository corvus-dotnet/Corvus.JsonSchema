...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1corsJson
    {
        ...
        public readonly partial struct DevelopmentFlag
#if NET8_0_OR_GREATER
            : IJsonElement<DevelopmentFlag>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DevelopmentFlag"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal DevelopmentFlag(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static DevelopmentFlag DefaultInstance { get; } = ParsedJsonDocument<DevelopmentFlag>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(DevelopmentFlag value)
            {
            ...
            /// </returns>
            public static bool operator ==(in DevelopmentFlag left, in DevelopmentFlag right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in DevelopmentFlag left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(DevelopmentFlag instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DevelopmentFlag(JsonElement instance)
            {
                return DevelopmentFlag.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DevelopmentFlag From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DevelopmentFlag ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DevelopmentFlag>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DevelopmentFlag ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DevelopmentFlag>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DevelopmentFlag ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DevelopmentFlag>(json, options);
            }
            ...
            /// </exception>
            public static DevelopmentFlag ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<DevelopmentFlag>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out DevelopmentFlag? result)
            {
                return JsonElementHelpers.TryParseValue<DevelopmentFlag>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DevelopmentFlag(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static DevelopmentFlag IJsonElement<DevelopmentFlag>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DevelopmentFlag: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DevelopmentFlag"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DevelopmentFlag"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public DevelopmentFlag Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DevelopmentFlag>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DevelopmentFlag"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public DevelopmentFlag Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<DevelopmentFlag>(_idx);
                }
