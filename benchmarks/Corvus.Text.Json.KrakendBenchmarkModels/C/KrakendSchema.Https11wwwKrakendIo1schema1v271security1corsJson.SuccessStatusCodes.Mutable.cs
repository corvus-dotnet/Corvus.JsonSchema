    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1corsJson
    {
        ...
        public readonly partial struct SuccessStatusCodes
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SuccessStatusCodes instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SuccessStatusCodes"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SuccessStatusCodes(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SuccessStatusCodes.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SuccessStatusCodes Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SuccessStatusCodes Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SuccessStatusCodes>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SuccessStatusCodes instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SuccessStatusCodes, Mutable>(this);
            }
        }
    }
}
