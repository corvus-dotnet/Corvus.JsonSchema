...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1corsJson
    {
        ...
        public readonly partial struct SuccessStatusCodes
#if NET8_0_OR_GREATER
            : IJsonElement<SuccessStatusCodes>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SuccessStatusCodes"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SuccessStatusCodes(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SuccessStatusCodes DefaultInstance { get; } = ParsedJsonDocument<SuccessStatusCodes>.NumberConstant([.."204"u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator long(SuccessStatusCodes value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator double(SuccessStatusCodes value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator Corvus.Numerics.BigNumber(SuccessStatusCodes value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator System.Numerics.BigInteger(SuccessStatusCodes value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator decimal(SuccessStatusCodes value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in SuccessStatusCodes left, in SuccessStatusCodes right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SuccessStatusCodes left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SuccessStatusCodes instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SuccessStatusCodes(JsonElement instance)
            {
                return SuccessStatusCodes.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SuccessStatusCodes From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SuccessStatusCodes ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SuccessStatusCodes>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SuccessStatusCodes ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SuccessStatusCodes>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SuccessStatusCodes ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SuccessStatusCodes>(json, options);
            }
            ...
            /// </exception>
            public static SuccessStatusCodes ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SuccessStatusCodes>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SuccessStatusCodes? result)
            {
                return JsonElementHelpers.TryParseValue<SuccessStatusCodes>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SuccessStatusCodes(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static SuccessStatusCodes IJsonElement<SuccessStatusCodes>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SuccessStatusCodes: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SuccessStatusCodes"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SuccessStatusCodes"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public SuccessStatusCodes Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SuccessStatusCodes>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SuccessStatusCodes"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public SuccessStatusCodes Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SuccessStatusCodes>(_idx);
                }
