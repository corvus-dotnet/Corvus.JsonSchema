...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1httpJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AllowedHosts"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal AllowedHosts(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AllowedHosts DefaultInstance { get; } = AllowedHosts.ParseValue("[]"u8);
            ...
            /// </returns>
            public static bool operator ==(in AllowedHosts left, in AllowedHosts right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AllowedHosts left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(AllowedHosts instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AllowedHosts(JsonElement instance)
            {
                return AllowedHosts.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllowedHosts From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllowedHosts ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllowedHosts>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllowedHosts ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllowedHosts>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllowedHosts ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllowedHosts>(json, options);
            }
            ...
            /// </exception>
            public static AllowedHosts ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<AllowedHosts>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AllowedHosts? result)
            {
                return JsonElementHelpers.TryParseValue<AllowedHosts>(ref reader, out result);
            }
...
#if NET
            static AllowedHosts IJsonElement<AllowedHosts>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AllowedHosts: ValueKind = {ValueKind} : \"{ToString()}\"";
