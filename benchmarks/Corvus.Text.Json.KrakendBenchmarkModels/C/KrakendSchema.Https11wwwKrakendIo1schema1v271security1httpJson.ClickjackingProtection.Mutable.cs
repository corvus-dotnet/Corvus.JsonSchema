...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1httpJson
    {
        ...
        public readonly partial struct ClickjackingProtection
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ClickjackingProtection instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ClickjackingProtection"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ClickjackingProtection(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ClickjackingProtection(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ClickjackingProtection.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ClickjackingProtection"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ClickjackingProtection"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ClickjackingProtection Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ClickjackingProtection>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ClickjackingProtection"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ClickjackingProtection Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ClickjackingProtection>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ClickjackingProtection instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ClickjackingProtection, Mutable>(this);
            }
        }
    }
}
