...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1httpJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ClickjackingProtection"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ClickjackingProtection(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ClickjackingProtection DefaultInstance { get; } = ParsedJsonDocument<ClickjackingProtection>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(ClickjackingProtection value)
            {
            ...
            /// </returns>
            public static bool operator ==(in ClickjackingProtection left, in ClickjackingProtection right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ClickjackingProtection left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ClickjackingProtection instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ClickjackingProtection(JsonElement instance)
            {
                return ClickjackingProtection.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClickjackingProtection From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClickjackingProtection ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClickjackingProtection>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClickjackingProtection ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClickjackingProtection>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClickjackingProtection ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClickjackingProtection>(json, options);
            }
            ...
            /// </exception>
            public static ClickjackingProtection ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ClickjackingProtection>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ClickjackingProtection? result)
            {
                return JsonElementHelpers.TryParseValue<ClickjackingProtection>(ref reader, out result);
            }
...
#if NET
            static ClickjackingProtection IJsonElement<ClickjackingProtection>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ClickjackingProtection: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ClickjackingProtection Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ClickjackingProtection Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ClickjackingProtection>(_idx);
                }
