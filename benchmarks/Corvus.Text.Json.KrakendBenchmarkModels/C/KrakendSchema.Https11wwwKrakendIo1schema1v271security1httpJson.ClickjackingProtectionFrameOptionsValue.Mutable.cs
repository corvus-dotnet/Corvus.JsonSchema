    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1httpJson
    {
        ...
        public readonly partial struct ClickjackingProtectionFrameOptionsValue
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ClickjackingProtectionFrameOptionsValue instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ClickjackingProtectionFrameOptionsValue"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ClickjackingProtectionFrameOptionsValue(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ClickjackingProtectionFrameOptionsValue.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ClickjackingProtectionFrameOptionsValue Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ClickjackingProtectionFrameOptionsValue Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ClickjackingProtectionFrameOptionsValue>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ClickjackingProtectionFrameOptionsValue instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ClickjackingProtectionFrameOptionsValue, Mutable>(this);
            }
        }
    }
}
