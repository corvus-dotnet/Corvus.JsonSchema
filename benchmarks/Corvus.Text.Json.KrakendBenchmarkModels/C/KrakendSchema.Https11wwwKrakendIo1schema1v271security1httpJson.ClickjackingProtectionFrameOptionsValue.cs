...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1httpJson
    {
        ...
        public readonly partial struct ClickjackingProtectionFrameOptionsValue
#if NET8_0_OR_GREATER
            : IJsonElement<ClickjackingProtectionFrameOptionsValue>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ClickjackingProtectionFrameOptionsValue"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ClickjackingProtectionFrameOptionsValue(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ClickjackingProtectionFrameOptionsValue DefaultInstance { get; } = ParsedJsonDocument<ClickjackingProtectionFrameOptionsValue>.StringConstant([.."\"\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ClickjackingProtectionFrameOptionsValue value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in ClickjackingProtectionFrameOptionsValue left, in ClickjackingProtectionFrameOptionsValue right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ClickjackingProtectionFrameOptionsValue left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ClickjackingProtectionFrameOptionsValue instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ClickjackingProtectionFrameOptionsValue(JsonElement instance)
            {
                return ClickjackingProtectionFrameOptionsValue.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClickjackingProtectionFrameOptionsValue From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClickjackingProtectionFrameOptionsValue ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClickjackingProtectionFrameOptionsValue>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClickjackingProtectionFrameOptionsValue ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClickjackingProtectionFrameOptionsValue>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClickjackingProtectionFrameOptionsValue ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClickjackingProtectionFrameOptionsValue>(json, options);
            }
            ...
            /// </exception>
            public static ClickjackingProtectionFrameOptionsValue ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ClickjackingProtectionFrameOptionsValue>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ClickjackingProtectionFrameOptionsValue? result)
            {
                return JsonElementHelpers.TryParseValue<ClickjackingProtectionFrameOptionsValue>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ClickjackingProtectionFrameOptionsValue(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ClickjackingProtectionFrameOptionsValue IJsonElement<ClickjackingProtectionFrameOptionsValue>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ClickjackingProtectionFrameOptionsValue: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ClickjackingProtectionFrameOptionsValue"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ClickjackingProtectionFrameOptionsValue"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ClickjackingProtectionFrameOptionsValue Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ClickjackingProtectionFrameOptionsValue>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ClickjackingProtectionFrameOptionsValue"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ClickjackingProtectionFrameOptionsValue Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ClickjackingProtectionFrameOptionsValue>(_idx);
                }
