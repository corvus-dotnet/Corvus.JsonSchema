...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1httpJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ContentSecurityPolicyCsp"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ContentSecurityPolicyCsp(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ContentSecurityPolicyCsp DefaultInstance { get; } = ParsedJsonDocument<ContentSecurityPolicyCsp>.StringConstant([.."\"\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ContentSecurityPolicyCsp value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in ContentSecurityPolicyCsp left, in ContentSecurityPolicyCsp right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ContentSecurityPolicyCsp left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ContentSecurityPolicyCsp instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ContentSecurityPolicyCsp(JsonElement instance)
            {
                return ContentSecurityPolicyCsp.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ContentSecurityPolicyCsp From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ContentSecurityPolicyCsp ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ContentSecurityPolicyCsp>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ContentSecurityPolicyCsp ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ContentSecurityPolicyCsp>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ContentSecurityPolicyCsp ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ContentSecurityPolicyCsp>(json, options);
            }
            ...
            /// </exception>
            public static ContentSecurityPolicyCsp ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ContentSecurityPolicyCsp>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ContentSecurityPolicyCsp? result)
            {
                return JsonElementHelpers.TryParseValue<ContentSecurityPolicyCsp>(ref reader, out result);
            }
...
#if NET
            static ContentSecurityPolicyCsp IJsonElement<ContentSecurityPolicyCsp>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ContentSecurityPolicyCsp: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ContentSecurityPolicyCsp Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ContentSecurityPolicyCsp Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ContentSecurityPolicyCsp>(_idx);
                }
