...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1httpJson
    {
        ...
        public readonly partial struct HttpPublicKeyPinningHpkp
#if NET8_0_OR_GREATER
            : IJsonElement<HttpPublicKeyPinningHpkp>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="HttpPublicKeyPinningHpkp"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal HttpPublicKeyPinningHpkp(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static HttpPublicKeyPinningHpkp DefaultInstance { get; } = ParsedJsonDocument<HttpPublicKeyPinningHpkp>.StringConstant([.."\"\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(HttpPublicKeyPinningHpkp value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in HttpPublicKeyPinningHpkp left, in HttpPublicKeyPinningHpkp right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in HttpPublicKeyPinningHpkp left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(HttpPublicKeyPinningHpkp instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator HttpPublicKeyPinningHpkp(JsonElement instance)
            {
                return HttpPublicKeyPinningHpkp.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HttpPublicKeyPinningHpkp From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HttpPublicKeyPinningHpkp ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HttpPublicKeyPinningHpkp>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HttpPublicKeyPinningHpkp ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HttpPublicKeyPinningHpkp>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HttpPublicKeyPinningHpkp ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HttpPublicKeyPinningHpkp>(json, options);
            }
            ...
            /// </exception>
            public static HttpPublicKeyPinningHpkp ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<HttpPublicKeyPinningHpkp>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out HttpPublicKeyPinningHpkp? result)
            {
                return JsonElementHelpers.TryParseValue<HttpPublicKeyPinningHpkp>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new HttpPublicKeyPinningHpkp(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static HttpPublicKeyPinningHpkp IJsonElement<HttpPublicKeyPinningHpkp>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"HttpPublicKeyPinningHpkp: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="HttpPublicKeyPinningHpkp"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="HttpPublicKeyPinningHpkp"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public HttpPublicKeyPinningHpkp Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<HttpPublicKeyPinningHpkp>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="HttpPublicKeyPinningHpkp"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public HttpPublicKeyPinningHpkp Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<HttpPublicKeyPinningHpkp>(_idx);
                }
