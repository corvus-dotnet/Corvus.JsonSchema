...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1httpJson
    {
        ...
        public readonly partial struct HttpStrictTransportSecurityHstsSeconds
#if NET8_0_OR_GREATER
            : IJsonElement<HttpStrictTransportSecurityHstsSeconds>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="HttpStrictTransportSecurityHstsSeconds"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal HttpStrictTransportSecurityHstsSeconds(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static HttpStrictTransportSecurityHstsSeconds DefaultInstance { get; } = ParsedJsonDocument<HttpStrictTransportSecurityHstsSeconds>.NumberConstant([.."0"u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator long(HttpStrictTransportSecurityHstsSeconds value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator double(HttpStrictTransportSecurityHstsSeconds value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator Corvus.Numerics.BigNumber(HttpStrictTransportSecurityHstsSeconds value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator System.Numerics.BigInteger(HttpStrictTransportSecurityHstsSeconds value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator decimal(HttpStrictTransportSecurityHstsSeconds value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in HttpStrictTransportSecurityHstsSeconds left, in HttpStrictTransportSecurityHstsSeconds right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in HttpStrictTransportSecurityHstsSeconds left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(HttpStrictTransportSecurityHstsSeconds instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator HttpStrictTransportSecurityHstsSeconds(JsonElement instance)
            {
                return HttpStrictTransportSecurityHstsSeconds.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HttpStrictTransportSecurityHstsSeconds From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HttpStrictTransportSecurityHstsSeconds ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HttpStrictTransportSecurityHstsSeconds>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HttpStrictTransportSecurityHstsSeconds ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HttpStrictTransportSecurityHstsSeconds>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HttpStrictTransportSecurityHstsSeconds ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HttpStrictTransportSecurityHstsSeconds>(json, options);
            }
            ...
            /// </exception>
            public static HttpStrictTransportSecurityHstsSeconds ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<HttpStrictTransportSecurityHstsSeconds>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out HttpStrictTransportSecurityHstsSeconds? result)
            {
                return JsonElementHelpers.TryParseValue<HttpStrictTransportSecurityHstsSeconds>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new HttpStrictTransportSecurityHstsSeconds(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static HttpStrictTransportSecurityHstsSeconds IJsonElement<HttpStrictTransportSecurityHstsSeconds>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"HttpStrictTransportSecurityHstsSeconds: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="HttpStrictTransportSecurityHstsSeconds"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="HttpStrictTransportSecurityHstsSeconds"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public HttpStrictTransportSecurityHstsSeconds Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<HttpStrictTransportSecurityHstsSeconds>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="HttpStrictTransportSecurityHstsSeconds"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public HttpStrictTransportSecurityHstsSeconds Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<HttpStrictTransportSecurityHstsSeconds>(_idx);
                }
