    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1httpJson
    {
        ...
        public readonly partial struct Https11wwwKrakendIo1schema1v271security1httpJsonSslHost
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Https11wwwKrakendIo1schema1v271security1httpJsonSslHost instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Https11wwwKrakendIo1schema1v271security1httpJsonSslHost"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Https11wwwKrakendIo1schema1v271security1httpJsonSslHost(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Https11wwwKrakendIo1schema1v271security1httpJsonSslHost.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly Https11wwwKrakendIo1schema1v271security1httpJsonSslHost Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly Https11wwwKrakendIo1schema1v271security1httpJsonSslHost Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Https11wwwKrakendIo1schema1v271security1httpJsonSslHost>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Https11wwwKrakendIo1schema1v271security1httpJsonSslHost instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<Https11wwwKrakendIo1schema1v271security1httpJsonSslHost, Mutable>(this);
            }
        }
    }
}
