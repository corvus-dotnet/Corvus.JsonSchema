    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1httpJson
    {
        ...
        public readonly partial struct Nosniff
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Nosniff instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Nosniff"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Nosniff(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Nosniff.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly Nosniff Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Nosniff>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Nosniff instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<Nosniff, Mutable>(this);
            }
        }
    }
}
