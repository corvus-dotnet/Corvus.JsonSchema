...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1httpJson
    {
        ...
        public readonly partial struct Nosniff
#if NET8_0_OR_GREATER
            : IJsonElement<Nosniff>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="Nosniff"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal Nosniff(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Nosniff DefaultInstance { get; } = ParsedJsonDocument<Nosniff>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(Nosniff value)
            {
            ...
            /// </returns>
            public static bool operator ==(in Nosniff left, in Nosniff right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Nosniff left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(Nosniff instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Nosniff(JsonElement instance)
            {
                return Nosniff.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Nosniff From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Nosniff ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Nosniff>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Nosniff ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Nosniff>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Nosniff ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Nosniff>(json, options);
            }
            ...
            /// </exception>
            public static Nosniff ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Nosniff>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Nosniff? result)
            {
                return JsonElementHelpers.TryParseValue<Nosniff>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Nosniff(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static Nosniff IJsonElement<Nosniff>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Nosniff: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Nosniff"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Nosniff"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Nosniff Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Nosniff>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Nosniff"/> that lives for the lifetime of its
