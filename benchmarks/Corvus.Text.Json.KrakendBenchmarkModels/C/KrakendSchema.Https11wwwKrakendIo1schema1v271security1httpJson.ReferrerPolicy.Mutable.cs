...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1httpJson
    {
        ...
        public readonly partial struct ReferrerPolicy
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ReferrerPolicy instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ReferrerPolicy"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ReferrerPolicy(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ReferrerPolicy(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ReferrerPolicy.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ReferrerPolicy"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ReferrerPolicy"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ReferrerPolicy Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ReferrerPolicy>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ReferrerPolicy"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ReferrerPolicy Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ReferrerPolicy>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ReferrerPolicy instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ReferrerPolicy, Mutable>(this);
            }
        }
    }
}
