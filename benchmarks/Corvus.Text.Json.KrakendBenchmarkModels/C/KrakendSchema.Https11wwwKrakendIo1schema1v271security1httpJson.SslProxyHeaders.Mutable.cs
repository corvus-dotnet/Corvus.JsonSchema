...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1httpJson
    {
        ...
        public readonly partial struct SslProxyHeaders
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SslProxyHeaders instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SslProxyHeaders"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SslProxyHeaders(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new SslProxyHeaders(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SslProxyHeaders.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="SslProxyHeaders"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="SslProxyHeaders"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly SslProxyHeaders Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<SslProxyHeaders>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="SslProxyHeaders"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly SslProxyHeaders Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SslProxyHeaders>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271security1httpJson.SslProxyHeaders.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(SslProxyHeaders instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271security1httpJson.SslProxyHeaders.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<SslProxyHeaders, Mutable>(this);
            }
        }
    }
}
