    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1httpJson
    {
        ...
        public readonly partial struct SslRedirect
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SslRedirect instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SslRedirect"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SslRedirect(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SslRedirect.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SslRedirect Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SslRedirect Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SslRedirect>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SslRedirect instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SslRedirect, Mutable>(this);
            }
        }
    }
}
