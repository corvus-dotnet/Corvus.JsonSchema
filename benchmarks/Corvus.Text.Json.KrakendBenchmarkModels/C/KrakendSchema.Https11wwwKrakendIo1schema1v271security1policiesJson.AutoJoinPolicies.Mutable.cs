...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1policiesJson
    {
        ...
        public readonly partial struct AutoJoinPolicies
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AutoJoinPolicies instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AutoJoinPolicies"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AutoJoinPolicies(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new AutoJoinPolicies(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AutoJoinPolicies.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="AutoJoinPolicies"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="AutoJoinPolicies"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly AutoJoinPolicies Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<AutoJoinPolicies>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="AutoJoinPolicies"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly AutoJoinPolicies Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AutoJoinPolicies>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AutoJoinPolicies instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AutoJoinPolicies, Mutable>(this);
            }
        }
    }
}
