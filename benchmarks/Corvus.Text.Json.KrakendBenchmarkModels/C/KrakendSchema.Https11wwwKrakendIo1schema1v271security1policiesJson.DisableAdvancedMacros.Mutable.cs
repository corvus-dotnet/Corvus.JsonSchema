    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1policiesJson
    {
        ...
        public readonly partial struct DisableAdvancedMacros
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DisableAdvancedMacros instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DisableAdvancedMacros"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DisableAdvancedMacros(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DisableAdvancedMacros.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DisableAdvancedMacros Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DisableAdvancedMacros Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DisableAdvancedMacros>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DisableAdvancedMacros instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DisableAdvancedMacros, Mutable>(this);
            }
        }
    }
}
