...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1policiesJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="JwtPolicies"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal JwtPolicies(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static JwtPolicies DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271security1policiesJson.JwtPolicies.JsonStringArray Policies
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PoliciesUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271security1policiesJson.JwtPolicies.JsonStringArray value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in JwtPolicies left, in JwtPolicies right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in JwtPolicies left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(JwtPolicies instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JwtPolicies(JsonElement instance)
            {
                return JwtPolicies.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static JwtPolicies From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static JwtPolicies ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<JwtPolicies>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static JwtPolicies ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<JwtPolicies>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static JwtPolicies ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<JwtPolicies>(json, options);
            }
            ...
            /// </exception>
            public static JwtPolicies ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<JwtPolicies>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out JwtPolicies? result)
            {
                return JsonElementHelpers.TryParseValue<JwtPolicies>(ref reader, out result);
            }
...
#if NET
            static JwtPolicies IJsonElement<JwtPolicies>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"JwtPolicies: ValueKind = {ValueKind} : \"{ToString()}\"";
