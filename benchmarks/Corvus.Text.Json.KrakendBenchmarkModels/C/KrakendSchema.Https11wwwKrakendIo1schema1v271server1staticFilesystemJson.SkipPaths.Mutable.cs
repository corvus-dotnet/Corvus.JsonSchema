...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271server1staticFilesystemJson
    {
        ...
        public readonly partial struct SkipPaths
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SkipPaths instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SkipPaths"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SkipPaths(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new SkipPaths(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SkipPaths.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// <summary>
                /// Gets a <see cref="SkipPaths"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="SkipPaths"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly SkipPaths Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<SkipPaths>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="SkipPaths"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly SkipPaths Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SkipPaths>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271server1staticFilesystemJson.SkipPaths.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(SkipPaths instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271server1staticFilesystemJson.SkipPaths.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<SkipPaths, Mutable>(this);
            }
        }
    }
}
