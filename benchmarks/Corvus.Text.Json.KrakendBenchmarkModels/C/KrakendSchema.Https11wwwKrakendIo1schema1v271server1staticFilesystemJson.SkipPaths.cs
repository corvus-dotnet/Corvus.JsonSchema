...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271server1staticFilesystemJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SkipPaths"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SkipPaths(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SkipPaths DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in SkipPaths left, in SkipPaths right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SkipPaths left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(SkipPaths instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SkipPaths(JsonElement instance)
            {
                return SkipPaths.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SkipPaths From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SkipPaths ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SkipPaths>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SkipPaths ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SkipPaths>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SkipPaths ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SkipPaths>(json, options);
            }
            ...
            /// </exception>
            public static SkipPaths ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SkipPaths>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SkipPaths? result)
            {
                return JsonElementHelpers.TryParseValue<SkipPaths>(ref reader, out result);
            }
...
#if NET
            static SkipPaths IJsonElement<SkipPaths>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SkipPaths: ValueKind = {ValueKind} : \"{ToString()}\"";
