    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271serviceExtraConfigJson
    {
        ...
        public readonly partial struct CrossOriginResourceSharing
        {
...
#endif
            {
                ...
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271serviceExtraConfigJson.CrossOriginResourceSharing.ObjectInArrayArray.ObjectInArray this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271serviceExtraConfigJson.CrossOriginResourceSharing.ObjectInArrayArray.ObjectInArray>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271serviceExtraConfigJson.CrossOriginResourceSharing.ObjectInArrayArray.ObjectInArray> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271serviceExtraConfigJson.CrossOriginResourceSharing.ObjectInArrayArray.ObjectInArray>(_parent, _idx);
                }
