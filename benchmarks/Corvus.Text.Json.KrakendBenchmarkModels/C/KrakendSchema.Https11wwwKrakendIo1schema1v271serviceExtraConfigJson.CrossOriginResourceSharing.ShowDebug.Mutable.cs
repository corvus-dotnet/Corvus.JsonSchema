        ...
        public readonly partial struct CrossOriginResourceSharing
        {
            ...
            public readonly partial struct ShowDebug
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ShowDebug instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ShowDebug"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ShowDebug(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ShowDebug.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ShowDebug Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ShowDebug Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ShowDebug>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ShowDebug instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ShowDebug, Mutable>(this);
                }
            }
        }
    }
