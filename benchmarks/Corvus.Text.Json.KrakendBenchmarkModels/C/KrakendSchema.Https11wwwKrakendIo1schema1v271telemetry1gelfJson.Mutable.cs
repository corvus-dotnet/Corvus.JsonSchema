...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1gelfJson
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.JsonBoolean.Mutable EnableTcp
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnableTcpUtf8, out Corvus.KrakendBenchmark.Current.JsonBoolean.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetEnableTcp(in Corvus.KrakendBenchmark.Current.JsonBoolean.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.EnableTcp, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1gelfJson.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1gelfJson.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.KrakendBenchmark.Current.JsonBoolean.Source enableTcp)
            {
                address.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Address, ref builder);
                enableTcp.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.EnableTcp, ref builder);
            }

            /// <summary>
            /// Creates an instance of a <see cref="Https11wwwKrakendIo1schema1v271telemetry1gelfJson"/>.
            /// </summary>
            public void Create(in Corvus.KrakendBenchmark.Current.JsonString.Source address, in Corvus.KrakendBenchmark.Current.JsonBoolean.Source enableTcp)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonString.Source address, in Corvus.KrakendBenchmark.Current.JsonBoolean.Source enableTcp, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
