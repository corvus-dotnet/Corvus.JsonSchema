...
public readonly partial struct KrakendSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Https11wwwKrakendIo1schema1v271telemetry1gelfJson"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Https11wwwKrakendIo1schema1v271telemetry1gelfJson(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Https11wwwKrakendIo1schema1v271telemetry1gelfJson DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.JsonString Address
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AddressUtf8, out Corvus.KrakendBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the <c>enable_tcp</c> property.
        /// Enable TCP
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.JsonBoolean EnableTcp
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnableTcpUtf8, out Corvus.KrakendBenchmark.Current.JsonBoolean value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in Https11wwwKrakendIo1schema1v271telemetry1gelfJson left, in Https11wwwKrakendIo1schema1v271telemetry1gelfJson right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Https11wwwKrakendIo1schema1v271telemetry1gelfJson left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Https11wwwKrakendIo1schema1v271telemetry1gelfJson instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Https11wwwKrakendIo1schema1v271telemetry1gelfJson(JsonElement instance)
        {
            return Https11wwwKrakendIo1schema1v271telemetry1gelfJson.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271telemetry1gelfJson From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271telemetry1gelfJson ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271telemetry1gelfJson>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271telemetry1gelfJson ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271telemetry1gelfJson>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Https11wwwKrakendIo1schema1v271telemetry1gelfJson ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271telemetry1gelfJson>(json, options);
        }
        ...
        /// </exception>
        public static Https11wwwKrakendIo1schema1v271telemetry1gelfJson ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Https11wwwKrakendIo1schema1v271telemetry1gelfJson>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Https11wwwKrakendIo1schema1v271telemetry1gelfJson? result)
        {
            return JsonElementHelpers.TryParseValue<Https11wwwKrakendIo1schema1v271telemetry1gelfJson>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Https11wwwKrakendIo1schema1v271telemetry1gelfJson(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Https11wwwKrakendIo1schema1v271telemetry1gelfJson IJsonElement<Https11wwwKrakendIo1schema1v271telemetry1gelfJson>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Https11wwwKrakendIo1schema1v271telemetry1gelfJson: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Https11wwwKrakendIo1schema1v271telemetry1gelfJson"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Https11wwwKrakendIo1schema1v271telemetry1gelfJson"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Https11wwwKrakendIo1schema1v271telemetry1gelfJson Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<Https11wwwKrakendIo1schema1v271telemetry1gelfJson>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Https11wwwKrakendIo1schema1v271telemetry1gelfJson"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public Https11wwwKrakendIo1schema1v271telemetry1gelfJson Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<Https11wwwKrakendIo1schema1v271telemetry1gelfJson>(_idx);
            }
        ...
        public static class JsonPropertyNames
        {
            ...
            /// <summary>
            /// Gets the JSON property name for <see cref="EnableTcp"/>.
            /// </summary>
            public const string EnableTcp = "enable_tcp";
            ...
            /// Gets the JSON property name for <see cref="EnableTcp"/>.
            /// </summary>
            public static ReadOnlySpan<byte> EnableTcpUtf8 => "enable_tcp"u8;
        }
        ...
        private static class JsonPropertyNamesEscaped
        {
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="EnableTcp"/>.
            /// </summary>
            public static ReadOnlySpan<byte> EnableTcp => "enable_tcp"u8;
        }
        ...
        private static class JsonPropertyNamesPrebaked
        {
            ...
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="EnableTcp"/>.
            /// </summary>
            public static ReadOnlySpan<byte> EnableTcp => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x65, 0x6E, 0x61, 0x62, 0x6C, 0x65, 0x5F, 0x74, 0x63, 0x70, 0x22];
        }
    }
}
