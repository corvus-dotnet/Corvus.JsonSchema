    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1loggingJson
    {
        ...
        public readonly partial struct SyslogFacility
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SyslogFacility instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SyslogFacility"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SyslogFacility(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new SyslogFacility(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SyslogFacility.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="SyslogFacility"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="SyslogFacility"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly SyslogFacility Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<SyslogFacility>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="SyslogFacility"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly SyslogFacility Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SyslogFacility>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchLocal0,
                    Func<TContext, TResult> matchLocal1,
                    Func<TContext, TResult> matchLocal2,
                    Func<TContext, TResult> matchLocal3,
                    Func<TContext, TResult> matchLocal4,
                    Func<TContext, TResult> matchLocal5,
                    Func<TContext, TResult> matchLocal6,
                    Func<TContext, TResult> matchLocal7,
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchLocal0,
                    Func<TResult> matchLocal1,
                    Func<TResult> matchLocal2,
                    Func<TResult> matchLocal3,
                    Func<TResult> matchLocal4,
                    Func<TResult> matchLocal5,
                    Func<TResult> matchLocal6,
                    Func<TResult> matchLocal7,
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SyslogFacility instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SyslogFacility, Mutable>(this);
            }
        }
    }
}
