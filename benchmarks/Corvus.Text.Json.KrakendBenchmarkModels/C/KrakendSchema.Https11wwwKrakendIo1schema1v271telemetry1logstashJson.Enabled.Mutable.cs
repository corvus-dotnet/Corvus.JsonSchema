    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1logstashJson
    {
        ...
        public readonly partial struct Enabled
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Enabled instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Enabled"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Enabled(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Enabled(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Enabled.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Enabled"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Enabled"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly Enabled Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Enabled>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Enabled"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly Enabled Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Enabled>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Enabled instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<Enabled, Mutable>(this);
            }
        }
    }
}
