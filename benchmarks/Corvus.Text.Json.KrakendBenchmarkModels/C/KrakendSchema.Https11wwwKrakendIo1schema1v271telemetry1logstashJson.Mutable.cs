...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1logstashJson
    {
...
#endif
        {
            ...
            public void SetEnabledValue(in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1logstashJson.Enabled.Source value)
            {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.EnabledValue, ref cvb);
        ...
        public ref struct Builder
        {
            ...
            {
                enabled.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.EnabledValue, ref builder);
            }
