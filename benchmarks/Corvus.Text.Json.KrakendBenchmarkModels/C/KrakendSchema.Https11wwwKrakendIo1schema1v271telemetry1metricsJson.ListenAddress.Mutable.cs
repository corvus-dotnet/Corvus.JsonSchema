...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1metricsJson
    {
        ...
        public readonly partial struct ListenAddress
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ListenAddress instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ListenAddress"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ListenAddress(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ListenAddress(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ListenAddress.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ListenAddress"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ListenAddress"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ListenAddress Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ListenAddress>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ListenAddress"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ListenAddress Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ListenAddress>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ListenAddress instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ListenAddress, Mutable>(this);
            }
        }
    }
}
