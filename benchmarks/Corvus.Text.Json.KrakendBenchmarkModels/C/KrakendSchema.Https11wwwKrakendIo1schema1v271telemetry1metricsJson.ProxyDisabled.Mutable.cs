    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1metricsJson
    {
        ...
        public readonly partial struct ProxyDisabled
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ProxyDisabled instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ProxyDisabled"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ProxyDisabled(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ProxyDisabled.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ProxyDisabled Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ProxyDisabled Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ProxyDisabled>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ProxyDisabled instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ProxyDisabled, Mutable>(this);
            }
        }
    }
}
