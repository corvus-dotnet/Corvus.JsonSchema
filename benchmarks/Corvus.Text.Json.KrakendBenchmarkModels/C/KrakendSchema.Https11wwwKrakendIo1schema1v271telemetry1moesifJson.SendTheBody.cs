...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1moesifJson
    {
        ...
        public readonly partial struct SendTheBody
#if NET8_0_OR_GREATER
            : IJsonElement<SendTheBody>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SendTheBody"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SendTheBody(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SendTheBody DefaultInstance { get; } = ParsedJsonDocument<SendTheBody>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(SendTheBody value)
            {
            ...
            /// </returns>
            public static bool operator ==(in SendTheBody left, in SendTheBody right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SendTheBody left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SendTheBody instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SendTheBody(JsonElement instance)
            {
                return SendTheBody.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SendTheBody From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SendTheBody ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SendTheBody>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SendTheBody ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SendTheBody>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SendTheBody ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SendTheBody>(json, options);
            }
            ...
            /// </exception>
            public static SendTheBody ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SendTheBody>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SendTheBody? result)
            {
                return JsonElementHelpers.TryParseValue<SendTheBody>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SendTheBody(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static SendTheBody IJsonElement<SendTheBody>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SendTheBody: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SendTheBody"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SendTheBody"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public SendTheBody Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SendTheBody>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SendTheBody"/> that lives for the lifetime of its
