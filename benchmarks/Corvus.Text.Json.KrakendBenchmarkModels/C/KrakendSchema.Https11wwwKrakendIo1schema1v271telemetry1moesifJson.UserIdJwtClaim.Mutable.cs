    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1moesifJson
    {
        ...
        public readonly partial struct UserIdJwtClaim
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(UserIdJwtClaim instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="UserIdJwtClaim"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator UserIdJwtClaim(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"UserIdJwtClaim.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly UserIdJwtClaim Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly UserIdJwtClaim Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<UserIdJwtClaim>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(UserIdJwtClaim instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<UserIdJwtClaim, Mutable>(this);
            }
        }
    }
}
