...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1moesifJson
    {
        ...
        public readonly partial struct UserIdJwtClaim
#if NET8_0_OR_GREATER
            : IJsonElement<UserIdJwtClaim>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="UserIdJwtClaim"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal UserIdJwtClaim(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static UserIdJwtClaim DefaultInstance { get; } = ParsedJsonDocument<UserIdJwtClaim>.StringConstant([.."\"sub\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(UserIdJwtClaim value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in UserIdJwtClaim left, in UserIdJwtClaim right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in UserIdJwtClaim left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(UserIdJwtClaim instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator UserIdJwtClaim(JsonElement instance)
            {
                return UserIdJwtClaim.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UserIdJwtClaim From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UserIdJwtClaim ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<UserIdJwtClaim>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UserIdJwtClaim ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<UserIdJwtClaim>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UserIdJwtClaim ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<UserIdJwtClaim>(json, options);
            }
            ...
            /// </exception>
            public static UserIdJwtClaim ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<UserIdJwtClaim>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out UserIdJwtClaim? result)
            {
                return JsonElementHelpers.TryParseValue<UserIdJwtClaim>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new UserIdJwtClaim(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static UserIdJwtClaim IJsonElement<UserIdJwtClaim>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"UserIdJwtClaim: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="UserIdJwtClaim"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="UserIdJwtClaim"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public UserIdJwtClaim Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<UserIdJwtClaim>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="UserIdJwtClaim"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public UserIdJwtClaim Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<UserIdJwtClaim>(_idx);
                }
