    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1newrelicJson
    {
        ...
        public readonly partial struct HeadersToPass
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(HeadersToPass instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="HeadersToPass"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator HeadersToPass(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"HeadersToPass.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public readonly HeadersToPass Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly HeadersToPass Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<HeadersToPass>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1newrelicJson.HeadersToPass.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(HeadersToPass instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1newrelicJson.HeadersToPass.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<HeadersToPass, Mutable>(this);
            }
        }
    }
}
