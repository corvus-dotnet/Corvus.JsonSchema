...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1newrelicJson
    {
        ...
        public readonly partial struct HeadersToPass
#if NET8_0_OR_GREATER
            : IJsonElement<HeadersToPass>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="HeadersToPass"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal HeadersToPass(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static HeadersToPass DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in HeadersToPass left, in HeadersToPass right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in HeadersToPass left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(HeadersToPass instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator HeadersToPass(JsonElement instance)
            {
                return HeadersToPass.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HeadersToPass From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HeadersToPass ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HeadersToPass>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HeadersToPass ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HeadersToPass>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HeadersToPass ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HeadersToPass>(json, options);
            }
            ...
            /// </exception>
            public static HeadersToPass ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<HeadersToPass>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out HeadersToPass? result)
            {
                return JsonElementHelpers.TryParseValue<HeadersToPass>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new HeadersToPass(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static HeadersToPass IJsonElement<HeadersToPass>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"HeadersToPass: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="HeadersToPass"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="HeadersToPass"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public HeadersToPass Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<HeadersToPass>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="HeadersToPass"/> that lives for the lifetime of its
