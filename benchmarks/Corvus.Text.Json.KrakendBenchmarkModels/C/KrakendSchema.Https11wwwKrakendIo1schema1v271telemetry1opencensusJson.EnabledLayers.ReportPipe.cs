    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1opencensusJson
    {
        ...
        public readonly partial struct EnabledLayers
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="ReportPipe"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal ReportPipe(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static ReportPipe DefaultInstance { get; } = ParsedJsonDocument<ReportPipe>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(ReportPipe value)
                {
                ...
                /// </returns>
                public static bool operator ==(in ReportPipe left, in ReportPipe right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in ReportPipe left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(ReportPipe instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ReportPipe(JsonElement instance)
                {
                    return ReportPipe.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ReportPipe From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ReportPipe ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ReportPipe>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ReportPipe ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ReportPipe>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ReportPipe ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ReportPipe>(json, options);
                }
                ...
                /// </exception>
                public static ReportPipe ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<ReportPipe>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out ReportPipe? result)
                {
                    return JsonElementHelpers.TryParseValue<ReportPipe>(ref reader, out result);
                }
...
#if NET
                static ReportPipe IJsonElement<ReportPipe>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ReportPipe: ValueKind = {ValueKind} : \"{ToString()}\"";
