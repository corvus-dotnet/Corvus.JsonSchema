        ...
        public readonly partial struct Exporters
        {
            ...
            public readonly partial struct AwsXRay
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="RequiredRegionAndUseEnvAndVersion"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal RequiredRegionAndUseEnvAndVersion(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static RequiredRegionAndUseEnvAndVersion DefaultInstance { get; }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Text.Json.JsonElement Region
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RegionUtf8, out Corvus.Text.Json.JsonElement value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Text.Json.JsonElement UseEnv
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UseEnvUtf8, out Corvus.Text.Json.JsonElement value))
                            {
                                return value;
                            }
                    ...
                    /// </returns>
                    public static bool operator ==(in RequiredRegionAndUseEnvAndVersion left, in RequiredRegionAndUseEnvAndVersion right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in RequiredRegionAndUseEnvAndVersion left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(RequiredRegionAndUseEnvAndVersion instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredRegionAndUseEnvAndVersion(JsonElement instance)
                    {
                        return RequiredRegionAndUseEnvAndVersion.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredRegionAndUseEnvAndVersion From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredRegionAndUseEnvAndVersion ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredRegionAndUseEnvAndVersion>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredRegionAndUseEnvAndVersion ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredRegionAndUseEnvAndVersion>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredRegionAndUseEnvAndVersion ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredRegionAndUseEnvAndVersion>(json, options);
                    }
                    ...
                    /// </exception>
                    public static RequiredRegionAndUseEnvAndVersion ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<RequiredRegionAndUseEnvAndVersion>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredRegionAndUseEnvAndVersion? result)
                    {
                        return JsonElementHelpers.TryParseValue<RequiredRegionAndUseEnvAndVersion>(ref reader, out result);
                    }
...
#if NET
                    static RequiredRegionAndUseEnvAndVersion IJsonElement<RequiredRegionAndUseEnvAndVersion>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredRegionAndUseEnvAndVersion: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public RequiredRegionAndUseEnvAndVersion Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public RequiredRegionAndUseEnvAndVersion Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<RequiredRegionAndUseEnvAndVersion>(_idx);
                        }
                    ...
                    private static class JsonPropertyNamesEscaped
                    {
                        ...
                        /// <summary>
                        /// Gets the escaped UTF-8 JSON property name for <see cref="UseEnv"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> UseEnv => "use_env"u8;
                    ...
                    private static class JsonPropertyNamesPrebaked
                    {
                        ...
                        /// <summary>
                        /// Gets the pre-baked property name blob for <see cref="UseEnv"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> UseEnv => [0x95, 0x00, 0x00, 0x00, 0x22, 0x75, 0x73, 0x65, 0x5F, 0x65, 0x6E, 0x76, 0x22];
