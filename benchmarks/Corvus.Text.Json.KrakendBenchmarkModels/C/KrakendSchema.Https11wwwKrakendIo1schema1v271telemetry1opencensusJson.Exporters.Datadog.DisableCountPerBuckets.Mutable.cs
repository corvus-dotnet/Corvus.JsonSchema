            ...
            public readonly partial struct Datadog
            {
                ...
                public readonly partial struct DisableCountPerBuckets
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(DisableCountPerBuckets instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="DisableCountPerBuckets"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator DisableCountPerBuckets(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"DisableCountPerBuckets.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly DisableCountPerBuckets Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly DisableCountPerBuckets Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<DisableCountPerBuckets>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(DisableCountPerBuckets instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<DisableCountPerBuckets, Mutable>(this);
                    }
                }
            }
        }
