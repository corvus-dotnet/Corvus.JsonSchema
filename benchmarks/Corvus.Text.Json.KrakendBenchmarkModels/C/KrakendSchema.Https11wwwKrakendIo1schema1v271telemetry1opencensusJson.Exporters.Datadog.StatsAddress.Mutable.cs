            ...
            public readonly partial struct Datadog
            {
                ...
                public readonly partial struct StatsAddress
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(StatsAddress instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="StatsAddress"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator StatsAddress(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"StatsAddress.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly StatsAddress Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly StatsAddress Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<StatsAddress>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(StatsAddress instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<StatsAddress, Mutable>(this);
                    }
                }
            }
        }
