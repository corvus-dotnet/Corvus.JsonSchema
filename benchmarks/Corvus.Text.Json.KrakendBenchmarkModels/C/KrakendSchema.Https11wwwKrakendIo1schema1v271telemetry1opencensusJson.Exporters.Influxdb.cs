    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1opencensusJson
    {
        ...
        public readonly partial struct Exporters
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="Influxdb"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal Influxdb(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static Influxdb DefaultInstance { get; }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.JsonString Db
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DbUtf8, out Corvus.KrakendBenchmark.Current.JsonString value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.JsonString Password
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PasswordUtf8, out Corvus.KrakendBenchmark.Current.JsonString value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.JsonString Username
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UsernameUtf8, out Corvus.KrakendBenchmark.Current.JsonString value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in Influxdb left, in Influxdb right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in Influxdb left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(Influxdb instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Influxdb(JsonElement instance)
                {
                    return Influxdb.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Influxdb From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Influxdb ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Influxdb>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Influxdb ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Influxdb>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Influxdb ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Influxdb>(json, options);
                }
                ...
                /// </exception>
                public static Influxdb ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<Influxdb>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out Influxdb? result)
                {
                    return JsonElementHelpers.TryParseValue<Influxdb>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Influxdb(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static Influxdb IJsonElement<Influxdb>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Influxdb: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Influxdb"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Influxdb"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Influxdb Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Influxdb>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Influxdb"/> that lives for the lifetime of its
                ...
                private static class JsonPropertyNamesEscaped
                {
                    ...
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="Db"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Db => "db"u8;
                ...
                private static class JsonPropertyNamesPrebaked
                {
                    ...
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="Db"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Db => [0x45, 0x00, 0x00, 0x00, 0x22, 0x64, 0x62, 0x22];
