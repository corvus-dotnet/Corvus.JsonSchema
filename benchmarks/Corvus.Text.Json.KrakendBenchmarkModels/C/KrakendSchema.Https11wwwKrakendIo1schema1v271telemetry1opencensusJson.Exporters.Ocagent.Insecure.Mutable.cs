            ...
            public readonly partial struct Ocagent
            {
                ...
                public readonly partial struct Insecure
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(Insecure instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="Insecure"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator Insecure(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"Insecure.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly Insecure Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly Insecure Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<Insecure>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(Insecure instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<Insecure, Mutable>(this);
                    }
                }
            }
        }
