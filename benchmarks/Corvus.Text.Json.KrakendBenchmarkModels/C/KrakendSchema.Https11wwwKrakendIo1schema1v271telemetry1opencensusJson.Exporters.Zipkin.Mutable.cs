        ...
        public readonly partial struct Exporters
        {
            ...
            public readonly partial struct Zipkin
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(Zipkin instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="Zipkin"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Zipkin(Mutable instance)
                    {
                    ...
                    /// <summary>
                    /// Gets the <c>collector_url</c> property.
                    /// Collector URL
                    /// </summary>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.JsonString.Mutable CollectorUrl
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CollectorUrlUtf8, out Corvus.KrakendBenchmark.Current.JsonString.Mutable value))
                            {
                                return value;
                            }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new Zipkin(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    /// <summary>
                    /// Set the <c>collector_url</c> property.
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetCollectorUrl(in Corvus.KrakendBenchmark.Current.JsonString.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("collector_url");
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CollectorUrlUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                        ...
                        else
                        {
                            ...
                            value.AddAsProperty(JsonPropertyNamesEscaped.CollectorUrl, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"Zipkin.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="Zipkin"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="Zipkin"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly Zipkin Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<Zipkin>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="Zipkin"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly Zipkin Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<Zipkin>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.Exporters.Zipkin.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(Zipkin instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.Exporters.Zipkin.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="Zipkin"/>.
                    /// </summary>
                    internal static void Create(
                        ref ComplexValueBuilder builder,
                        in Corvus.KrakendBenchmark.Current.JsonString.Source collectorUrl,
                        in Corvus.KrakendBenchmark.Current.JsonString.Source serviceName)
                    {
                        collectorUrl.AddAsProperty(JsonPropertyNamesEscaped.CollectorUrl, ref builder, escapeName: false);
                    ...
                    /// Creates an instance of a <see cref="Zipkin"/>.
                    /// </summary>
                    public void Create(in Corvus.KrakendBenchmark.Current.JsonString.Source collectorUrl, in Corvus.KrakendBenchmark.Current.JsonString.Source serviceName)
                    {
                        Create(ref _builder, collectorUrl, serviceName);
                    }
                ...
                /// </summary>
                /// <param name="workspace">The JSON workspace.</param>
                /// <param name="collectorUrl">The value of the property.</param>
                /// <param name="serviceName">The value of the property.</param>
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonString.Source collectorUrl, in Corvus.KrakendBenchmark.Current.JsonString.Source serviceName, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(collectorUrl, serviceName);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<Zipkin, Mutable>(this);
                }
            }
        }
    }
