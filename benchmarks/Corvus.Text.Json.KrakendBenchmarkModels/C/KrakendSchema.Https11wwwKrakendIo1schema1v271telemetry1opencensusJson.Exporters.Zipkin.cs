    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1opencensusJson
    {
        ...
        public readonly partial struct Exporters
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="Zipkin"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal Zipkin(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static Zipkin DefaultInstance { get; }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.JsonString CollectorUrl
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CollectorUrlUtf8, out Corvus.KrakendBenchmark.Current.JsonString value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in Zipkin left, in Zipkin right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in Zipkin left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(Zipkin instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Zipkin(JsonElement instance)
                {
                    return Zipkin.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Zipkin From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Zipkin ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Zipkin>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Zipkin ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Zipkin>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Zipkin ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Zipkin>(json, options);
                }
                ...
                /// </exception>
                public static Zipkin ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<Zipkin>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out Zipkin? result)
                {
                    return JsonElementHelpers.TryParseValue<Zipkin>(ref reader, out result);
                }
...
#if NET
                static Zipkin IJsonElement<Zipkin>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Zipkin: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                {
                    /// <summary>
                    /// Gets the JSON property name for <see cref="CollectorUrl"/>.
                    /// </summary>
                    public const string CollectorUrl = "collector_url";
                    ...
                    /// Gets the JSON property name for <see cref="CollectorUrl"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> CollectorUrlUtf8 => "collector_url"u8;
                ...
                {
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="CollectorUrl"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> CollectorUrl => "collector_url"u8;
                ...
                {
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="CollectorUrl"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> CollectorUrl => [0xF5, 0x00, 0x00, 0x00, 0x22, 0x63, 0x6F, 0x6C, 0x6C, 0x65, 0x63, 0x74, 0x6F, 0x72, 0x5F, 0x75, 0x72, 0x6C, 0x22];
