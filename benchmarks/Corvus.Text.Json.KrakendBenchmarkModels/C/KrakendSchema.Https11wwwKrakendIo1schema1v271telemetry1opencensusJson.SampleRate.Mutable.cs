...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1opencensusJson
    {
        ...
        public readonly partial struct SampleRate
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SampleRate instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SampleRate"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SampleRate(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new SampleRate(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SampleRate.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="SampleRate"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="SampleRate"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly SampleRate Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<SampleRate>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="SampleRate"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly SampleRate Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SampleRate>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SampleRate instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SampleRate, Mutable>(this);
            }
        }
    }
}
