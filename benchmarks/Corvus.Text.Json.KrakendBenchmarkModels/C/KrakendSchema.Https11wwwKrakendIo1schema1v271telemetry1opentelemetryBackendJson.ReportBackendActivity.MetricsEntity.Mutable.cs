        ...
        public readonly partial struct ReportBackendActivity
        {
            ...
            public readonly partial struct MetricsEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(MetricsEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="MetricsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator MetricsEntity(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryBackendJson.ReportBackendActivity.MetricsEntity.DisableThisStage.Mutable DisableStage
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisableStageUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryBackendJson.ReportBackendActivity.MetricsEntity.DisableThisStage.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetDisableStage(in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryBackendJson.ReportBackendActivity.MetricsEntity.DisableThisStage.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DisableStageUtf8);
                            _documentVersion = _parent.Version;
                            return;
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisableStageUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                        ...
                        else
                        {
                            ...
                            value.AddAsProperty(JsonPropertyNamesEscaped.DisableStage, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    ...
                    /// <summary>
                    /// Remove the <c>disable_stage</c> property, if present.
                    /// </summary>
                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                    public bool RemoveDisableStage()
                    {
                        CheckValidInstance();
                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DisableStageUtf8);
                        _documentVersion = _parent.Version;
                        return result;
                    }
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"MetricsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MetricsEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MetricsEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<MetricsEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryBackendJson.ReportBackendActivity.MetricsEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(MetricsEntity instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryBackendJson.ReportBackendActivity.MetricsEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="MetricsEntity"/>.
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryBackendJson.ReportBackendActivity.MetricsEntity.DisableThisStage.Source disableStage = default)
                    {
                        disableStage.AddAsProperty(JsonPropertyNamesEscaped.DisableStage, ref builder, escapeName: false);
                    }

                    /// <summary>
                    /// Creates an instance of a <see cref="MetricsEntity"/>.
                    /// </summary>
                    public void Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryBackendJson.ReportBackendActivity.MetricsEntity.DisableThisStage.Source disableStage = default)
                    {
                        Create(ref _builder, disableStage);
                    }
                ...
                /// </summary>
                /// <param name="workspace">The JSON workspace.</param>
                /// <param name="disableStage">The value of the property.</param>
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryBackendJson.ReportBackendActivity.MetricsEntity.DisableThisStage.Source disableStage = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(disableStage);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<MetricsEntity, Mutable>(this);
                }
            }
        }
    }
