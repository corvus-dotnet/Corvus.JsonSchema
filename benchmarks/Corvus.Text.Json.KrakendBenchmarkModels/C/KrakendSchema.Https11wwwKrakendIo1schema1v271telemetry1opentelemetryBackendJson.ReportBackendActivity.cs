...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1opentelemetryBackendJson
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryBackendJson.ReportBackendActivity.MetricsEntity Metrics
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MetricsUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryBackendJson.ReportBackendActivity.MetricsEntity value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryBackendJson.ReportBackendActivity.TracesEntity Traces
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TracesUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryBackendJson.ReportBackendActivity.TracesEntity value))
                    {
                        return value;
                    }
