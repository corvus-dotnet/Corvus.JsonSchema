    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1opentelemetryEndpointJson
    {
        ...
        public readonly partial struct ExportersOverride
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="MetricsExporters"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal MetricsExporters(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static MetricsExporters DefaultInstance { get; }
                ...
                /// </returns>
                public static bool operator ==(in MetricsExporters left, in MetricsExporters right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in MetricsExporters left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(MetricsExporters instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MetricsExporters(JsonElement instance)
                {
                    return MetricsExporters.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static MetricsExporters From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static MetricsExporters ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<MetricsExporters>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static MetricsExporters ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<MetricsExporters>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static MetricsExporters ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<MetricsExporters>(json, options);
                }
                ...
                /// </exception>
                public static MetricsExporters ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<MetricsExporters>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out MetricsExporters? result)
                {
                    return JsonElementHelpers.TryParseValue<MetricsExporters>(ref reader, out result);
                }
...
#if NET
                static MetricsExporters IJsonElement<MetricsExporters>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MetricsExporters: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public MetricsExporters Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<MetricsExporters>(_idx);
                    }
