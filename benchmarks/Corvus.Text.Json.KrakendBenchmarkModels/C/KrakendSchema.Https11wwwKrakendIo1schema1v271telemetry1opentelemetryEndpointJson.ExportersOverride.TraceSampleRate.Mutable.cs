        ...
        public readonly partial struct ExportersOverride
        {
            ...
            public readonly partial struct TraceSampleRate
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(TraceSampleRate instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="TraceSampleRate"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TraceSampleRate(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TraceSampleRate.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TraceSampleRate Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TraceSampleRate Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<TraceSampleRate>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(TraceSampleRate instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<TraceSampleRate, Mutable>(this);
                }
            }
        }
    }
