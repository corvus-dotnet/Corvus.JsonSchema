    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1opentelemetryEndpointJson
    {
        ...
        public readonly partial struct ExportersOverride
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="TraceSampleRate"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal TraceSampleRate(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static TraceSampleRate DefaultInstance { get; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator long(TraceSampleRate value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator double(TraceSampleRate value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator Corvus.Numerics.BigNumber(TraceSampleRate value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator System.Numerics.BigInteger(TraceSampleRate value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in TraceSampleRate left, in TraceSampleRate right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in TraceSampleRate left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(TraceSampleRate instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TraceSampleRate(JsonElement instance)
                {
                    return TraceSampleRate.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TraceSampleRate From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TraceSampleRate ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TraceSampleRate>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TraceSampleRate ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TraceSampleRate>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TraceSampleRate ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TraceSampleRate>(json, options);
                }
                ...
                /// </exception>
                public static TraceSampleRate ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<TraceSampleRate>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out TraceSampleRate? result)
                {
                    return JsonElementHelpers.TryParseValue<TraceSampleRate>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TraceSampleRate(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static TraceSampleRate IJsonElement<TraceSampleRate>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TraceSampleRate: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TraceSampleRate"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TraceSampleRate"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public TraceSampleRate Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TraceSampleRate>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TraceSampleRate"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public TraceSampleRate Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<TraceSampleRate>(_idx);
                    }
