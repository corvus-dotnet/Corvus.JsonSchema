    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson
    {
        ...
        public readonly partial struct Exporters
        {
            ...
            public readonly partial struct RequiredHostAndNameArray
                ...
                : IJsonElement<RequiredHostAndNameArray>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                internal RequiredHostAndNameArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static RequiredHostAndNameArray DefaultInstance { get; }
                ...
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.RequiredHostAndNameArray.RequiredHostAndName this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.RequiredHostAndNameArray.RequiredHostAndName>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.RequiredHostAndNameArray.RequiredHostAndName> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.RequiredHostAndNameArray.RequiredHostAndName>(_parent, _idx);
                }
                ...
                /// </returns>
                public static bool operator ==(in RequiredHostAndNameArray left, in RequiredHostAndNameArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in RequiredHostAndNameArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(RequiredHostAndNameArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredHostAndNameArray(JsonElement instance)
                {
                    return RequiredHostAndNameArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredHostAndNameArray From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredHostAndNameArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredHostAndNameArray>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredHostAndNameArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredHostAndNameArray>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredHostAndNameArray ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredHostAndNameArray>(json, options);
                }
                ...
                /// </exception>
                public static RequiredHostAndNameArray ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<RequiredHostAndNameArray>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredHostAndNameArray? result)
                {
                    return JsonElementHelpers.TryParseValue<RequiredHostAndNameArray>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RequiredHostAndNameArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static RequiredHostAndNameArray IJsonElement<RequiredHostAndNameArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredHostAndNameArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RequiredHostAndNameArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RequiredHostAndNameArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public RequiredHostAndNameArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RequiredHostAndNameArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RequiredHostAndNameArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public RequiredHostAndNameArray Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<RequiredHostAndNameArray>(_idx);
                    }
