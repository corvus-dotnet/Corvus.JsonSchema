                ...
                public readonly partial struct RequiredName
                {
                    ...
                    public readonly partial struct Port
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Mutable(Port instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="Port"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator Port(Mutable instance)
                            {
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"Port.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly Port Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<Port>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            public static implicit operator Source(Port instance) => new(JsonElement.From(instance));
                        ...
                        {
                            return workspace.CreateBuilder<Port, Mutable>(this);
                        }
                    }
                }
            }
