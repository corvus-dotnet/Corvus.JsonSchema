            ...
            public readonly partial struct ReportProxyActivity
            {
                ...
                public readonly partial struct TracesStaticAttributesEntityArray
                {
                    ...
                    public readonly partial struct TracesStaticAttributesEntity
                        ...
                        : IJsonElement<TracesStaticAttributesEntity>,
                          IFormattable,
                          ISpanFormattable,
...
#endif
                    {
                        ...
                        internal TracesStaticAttributesEntity(IJsonDocument parent, int idx)
                        {
                            Debug.Assert(idx >= 0);
                            _parent = parent;
                            _idx = idx;
                        ...
                        /// <c>True</c> if the values are equal.
                        /// </returns>
                        public static bool operator ==(in TracesStaticAttributesEntity left, in JsonElement right)
                        {
                            return left.Equals(right);
                        }
                        ...
                        public static implicit operator JsonElement(TracesStaticAttributesEntity instance)
                        {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator TracesStaticAttributesEntity(JsonElement instance)
                        {
                            return TracesStaticAttributesEntity.From(instance);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static TracesStaticAttributesEntity From<T>(in T instance)
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static TracesStaticAttributesEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<TracesStaticAttributesEntity>(utf8Json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static TracesStaticAttributesEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<TracesStaticAttributesEntity>(json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static TracesStaticAttributesEntity ParseValue(string json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<TracesStaticAttributesEntity>(json, options);
                        }
                        ...
                        /// </exception>
                        public static TracesStaticAttributesEntity ParseValue(ref Utf8JsonReader reader)
                        {
                            return JsonElementHelpers.ParseValue<TracesStaticAttributesEntity>(ref reader);
                        }
                        ...
                        ///   A value could not be read from the reader.
                        /// </exception>
                        public static bool TryParseValue(ref Utf8JsonReader reader, out TracesStaticAttributesEntity? result)
                        {
                            return JsonElementHelpers.TryParseValue<TracesStaticAttributesEntity>(ref reader, out result);
                        }
...
#if NET
                        static TracesStaticAttributesEntity IJsonElement<TracesStaticAttributesEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"TracesStaticAttributesEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public TracesStaticAttributesEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public TracesStaticAttributesEntity Freeze()
                        {
                            CheckValidInstance();
                            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                            {
                                return mutable.FreezeElement<TracesStaticAttributesEntity>(_idx);
                            }
