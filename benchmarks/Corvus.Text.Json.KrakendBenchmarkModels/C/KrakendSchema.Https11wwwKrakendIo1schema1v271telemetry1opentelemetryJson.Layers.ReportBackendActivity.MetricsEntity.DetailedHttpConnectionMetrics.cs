            ...
            public readonly partial struct ReportBackendActivity
            {
                ...
                public readonly partial struct MetricsEntity
                {
...
#endif
                    {
                        ...
                        /// <summary>
                        /// Initializes a new instance of the <see cref="DetailedHttpConnectionMetrics"/> struct.
                        /// </summary>
                        /// <param name="value">The value from which to construct the instance.</param>
                        internal DetailedHttpConnectionMetrics(IJsonDocument parent, int idx)
                        {
                            Debug.Assert(idx >= 0);
                            _parent = parent;
                            _idx = idx;
                        ...
                        /// </summary>
                        public static DetailedHttpConnectionMetrics DefaultInstance { get; } = ParsedJsonDocument<DetailedHttpConnectionMetrics>.False;
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator bool(DetailedHttpConnectionMetrics value)
                        {
                        ...
                        /// </returns>
                        public static bool operator ==(in DetailedHttpConnectionMetrics left, in DetailedHttpConnectionMetrics right)
                        {
                        ...
                        /// <c>True</c> if the values are equal.
                        /// </returns>
                        public static bool operator ==(in DetailedHttpConnectionMetrics left, in JsonElement right)
                        {
                            return left.Equals(right);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator JsonElement(DetailedHttpConnectionMetrics instance)
                        {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator DetailedHttpConnectionMetrics(JsonElement instance)
                        {
                            return DetailedHttpConnectionMetrics.From(instance);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static DetailedHttpConnectionMetrics From<T>(in T instance)
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static DetailedHttpConnectionMetrics ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<DetailedHttpConnectionMetrics>(utf8Json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static DetailedHttpConnectionMetrics ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<DetailedHttpConnectionMetrics>(json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static DetailedHttpConnectionMetrics ParseValue(string json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<DetailedHttpConnectionMetrics>(json, options);
                        }
                        ...
                        /// </exception>
                        public static DetailedHttpConnectionMetrics ParseValue(ref Utf8JsonReader reader)
                        {
                            return JsonElementHelpers.ParseValue<DetailedHttpConnectionMetrics>(ref reader);
                        }
                        ...
                        ///   A value could not be read from the reader.
                        /// </exception>
                        public static bool TryParseValue(ref Utf8JsonReader reader, out DetailedHttpConnectionMetrics? result)
                        {
                            return JsonElementHelpers.TryParseValue<DetailedHttpConnectionMetrics>(ref reader, out result);
                        }
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new DetailedHttpConnectionMetrics(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                        static DetailedHttpConnectionMetrics IJsonElement<DetailedHttpConnectionMetrics>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"DetailedHttpConnectionMetrics: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="DetailedHttpConnectionMetrics"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="DetailedHttpConnectionMetrics"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public DetailedHttpConnectionMetrics Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<DetailedHttpConnectionMetrics>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="DetailedHttpConnectionMetrics"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public DetailedHttpConnectionMetrics Freeze()
                        {
                            CheckValidInstance();
                            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                            {
                                return mutable.FreezeElement<DetailedHttpConnectionMetrics>(_idx);
                            }
