        ...
        public readonly partial struct Layers
        {
            ...
            public readonly partial struct ReportBackendActivity
            {
                ...
                public readonly partial struct MetricsEntity
                {
                    ...
                    public readonly partial struct DetailedPayloadRead
#if NET8_0_OR_GREATER
                        : IJsonElement<DetailedPayloadRead>,
                          IFormattable,
                          ISpanFormattable,
...
#endif
                    {
                        ...
                        /// <summary>
                        /// Initializes a new instance of the <see cref="DetailedPayloadRead"/> struct.
                        /// </summary>
                        /// <param name="value">The value from which to construct the instance.</param>
                        internal DetailedPayloadRead(IJsonDocument parent, int idx)
                        {
                            Debug.Assert(idx >= 0);
                            _parent = parent;
                            _idx = idx;
                        ...
                        /// </summary>
                        public static DetailedPayloadRead DefaultInstance { get; } = ParsedJsonDocument<DetailedPayloadRead>.False;
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator bool(DetailedPayloadRead value)
                        {
                        ...
                        /// </returns>
                        public static bool operator ==(in DetailedPayloadRead left, in DetailedPayloadRead right)
                        {
                        ...
                        /// <c>True</c> if the values are equal.
                        /// </returns>
                        public static bool operator ==(in DetailedPayloadRead left, in JsonElement right)
                        {
                            return left.Equals(right);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator JsonElement(DetailedPayloadRead instance)
                        {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator DetailedPayloadRead(JsonElement instance)
                        {
                            return DetailedPayloadRead.From(instance);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static DetailedPayloadRead From<T>(in T instance)
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static DetailedPayloadRead ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<DetailedPayloadRead>(utf8Json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static DetailedPayloadRead ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<DetailedPayloadRead>(json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static DetailedPayloadRead ParseValue(string json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<DetailedPayloadRead>(json, options);
                        }
                        ...
                        /// </exception>
                        public static DetailedPayloadRead ParseValue(ref Utf8JsonReader reader)
                        {
                            return JsonElementHelpers.ParseValue<DetailedPayloadRead>(ref reader);
                        }
                        ...
                        ///   A value could not be read from the reader.
                        /// </exception>
                        public static bool TryParseValue(ref Utf8JsonReader reader, out DetailedPayloadRead? result)
                        {
                            return JsonElementHelpers.TryParseValue<DetailedPayloadRead>(ref reader, out result);
                        }
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new DetailedPayloadRead(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                        static DetailedPayloadRead IJsonElement<DetailedPayloadRead>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"DetailedPayloadRead: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="DetailedPayloadRead"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="DetailedPayloadRead"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public DetailedPayloadRead Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<DetailedPayloadRead>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="DetailedPayloadRead"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public DetailedPayloadRead Freeze()
                        {
                            CheckValidInstance();
                            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                            {
                                return mutable.FreezeElement<DetailedPayloadRead>(_idx);
                            }
