            ...
            public readonly partial struct ReportBackendActivity
            {
                ...
                public readonly partial struct MetricsEntity
                {
                    ...
                    public readonly partial struct RequiredKeyAndValueArray
                        ...
                        : IJsonElement<RequiredKeyAndValueArray>,
                          IFormattable,
                          ISpanFormattable,
...
#endif
                    {
                        ...
                        internal RequiredKeyAndValueArray(IJsonDocument parent, int idx)
                        {
                            Debug.Assert(idx >= 0);
                            _parent = parent;
                            _idx = idx;
                        ...
                        /// </summary>
                        public static RequiredKeyAndValueArray DefaultInstance { get; }
                        ...
                        public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Layers.ReportBackendActivity.MetricsEntity.RequiredKeyAndValueArray.RequiredKeyAndValue this[int index]
                        {
                            get
                            {
                                CheckValidInstance();
                                return _parent.GetArrayIndexElement<Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Layers.ReportBackendActivity.MetricsEntity.RequiredKeyAndValueArray.RequiredKeyAndValue>(_idx, index);
                            }
                        }
                        ...
                        /// </summary>
                        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                        public ArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Layers.ReportBackendActivity.MetricsEntity.RequiredKeyAndValueArray.RequiredKeyAndValue> EnumerateArray()
                        {
                            CheckValidInstance();
                            return EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Layers.ReportBackendActivity.MetricsEntity.RequiredKeyAndValueArray.RequiredKeyAndValue>(_parent, _idx);
                        }
                        ...
                        /// </returns>
                        public static bool operator ==(in RequiredKeyAndValueArray left, in RequiredKeyAndValueArray right)
                        {
                        ...
                        /// <c>True</c> if the values are equal.
                        /// </returns>
                        public static bool operator ==(in RequiredKeyAndValueArray left, in JsonElement right)
                        {
                            return left.Equals(right);
                        }
                        ...
                        public static implicit operator JsonElement(RequiredKeyAndValueArray instance)
                        {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RequiredKeyAndValueArray(JsonElement instance)
                        {
                            return RequiredKeyAndValueArray.From(instance);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static RequiredKeyAndValueArray From<T>(in T instance)
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static RequiredKeyAndValueArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<RequiredKeyAndValueArray>(utf8Json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static RequiredKeyAndValueArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<RequiredKeyAndValueArray>(json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static RequiredKeyAndValueArray ParseValue(string json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<RequiredKeyAndValueArray>(json, options);
                        }
                        ...
                        /// </exception>
                        public static RequiredKeyAndValueArray ParseValue(ref Utf8JsonReader reader)
                        {
                            return JsonElementHelpers.ParseValue<RequiredKeyAndValueArray>(ref reader);
                        }
                        ...
                        ///   A value could not be read from the reader.
                        /// </exception>
                        public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredKeyAndValueArray? result)
                        {
                            return JsonElementHelpers.TryParseValue<RequiredKeyAndValueArray>(ref reader, out result);
                        }
...
#if NET
                        static RequiredKeyAndValueArray IJsonElement<RequiredKeyAndValueArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RequiredKeyAndValueArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public RequiredKeyAndValueArray Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public RequiredKeyAndValueArray Freeze()
                        {
                            CheckValidInstance();
                            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                            {
                                return mutable.FreezeElement<RequiredKeyAndValueArray>(_idx);
                            }
