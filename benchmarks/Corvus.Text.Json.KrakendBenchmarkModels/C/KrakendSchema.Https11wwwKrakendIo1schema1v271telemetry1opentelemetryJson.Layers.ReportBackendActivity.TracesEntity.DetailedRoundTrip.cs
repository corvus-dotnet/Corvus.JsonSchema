        ...
        public readonly partial struct Layers
        {
            ...
            public readonly partial struct ReportBackendActivity
            {
                ...
                public readonly partial struct TracesEntity
                {
                    ...
                    public readonly partial struct DetailedRoundTrip
#if NET8_0_OR_GREATER
                        : IJsonElement<DetailedRoundTrip>,
                          IFormattable,
                          ISpanFormattable,
...
#endif
                    {
                        ...
                        /// <summary>
                        /// Initializes a new instance of the <see cref="DetailedRoundTrip"/> struct.
                        /// </summary>
                        /// <param name="value">The value from which to construct the instance.</param>
                        internal DetailedRoundTrip(IJsonDocument parent, int idx)
                        {
                            Debug.Assert(idx >= 0);
                            _parent = parent;
                            _idx = idx;
                        ...
                        /// </summary>
                        public static DetailedRoundTrip DefaultInstance { get; } = ParsedJsonDocument<DetailedRoundTrip>.False;
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator bool(DetailedRoundTrip value)
                        {
                        ...
                        /// </returns>
                        public static bool operator ==(in DetailedRoundTrip left, in DetailedRoundTrip right)
                        {
                        ...
                        /// <c>True</c> if the values are equal.
                        /// </returns>
                        public static bool operator ==(in DetailedRoundTrip left, in JsonElement right)
                        {
                            return left.Equals(right);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator JsonElement(DetailedRoundTrip instance)
                        {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator DetailedRoundTrip(JsonElement instance)
                        {
                            return DetailedRoundTrip.From(instance);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static DetailedRoundTrip From<T>(in T instance)
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static DetailedRoundTrip ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<DetailedRoundTrip>(utf8Json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static DetailedRoundTrip ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<DetailedRoundTrip>(json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static DetailedRoundTrip ParseValue(string json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<DetailedRoundTrip>(json, options);
                        }
                        ...
                        /// </exception>
                        public static DetailedRoundTrip ParseValue(ref Utf8JsonReader reader)
                        {
                            return JsonElementHelpers.ParseValue<DetailedRoundTrip>(ref reader);
                        }
                        ...
                        ///   A value could not be read from the reader.
                        /// </exception>
                        public static bool TryParseValue(ref Utf8JsonReader reader, out DetailedRoundTrip? result)
                        {
                            return JsonElementHelpers.TryParseValue<DetailedRoundTrip>(ref reader, out result);
                        }
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new DetailedRoundTrip(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                        static DetailedRoundTrip IJsonElement<DetailedRoundTrip>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"DetailedRoundTrip: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="DetailedRoundTrip"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="DetailedRoundTrip"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public DetailedRoundTrip Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<DetailedRoundTrip>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="DetailedRoundTrip"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public DetailedRoundTrip Freeze()
                        {
                            CheckValidInstance();
                            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                            {
                                return mutable.FreezeElement<DetailedRoundTrip>(_idx);
                            }
