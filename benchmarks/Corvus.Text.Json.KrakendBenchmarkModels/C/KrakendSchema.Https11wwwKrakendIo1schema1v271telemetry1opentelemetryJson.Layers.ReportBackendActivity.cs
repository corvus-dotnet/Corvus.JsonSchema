    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson
    {
        ...
        public readonly partial struct Layers
        {
            ...
            public readonly partial struct ReportBackendActivity
                ...
                : IJsonElement<ReportBackendActivity>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="ReportBackendActivity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal ReportBackendActivity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static ReportBackendActivity DefaultInstance { get; }
                ...
                /// </summary>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Layers.ReportBackendActivity.MetricsEntity Metrics
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MetricsUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Layers.ReportBackendActivity.MetricsEntity value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Layers.ReportBackendActivity.TracesEntity Traces
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TracesUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Layers.ReportBackendActivity.TracesEntity value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in ReportBackendActivity left, in ReportBackendActivity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in ReportBackendActivity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(ReportBackendActivity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ReportBackendActivity(JsonElement instance)
                {
                    return ReportBackendActivity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ReportBackendActivity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ReportBackendActivity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ReportBackendActivity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ReportBackendActivity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ReportBackendActivity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ReportBackendActivity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ReportBackendActivity>(json, options);
                }
                ...
                /// </exception>
                public static ReportBackendActivity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<ReportBackendActivity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out ReportBackendActivity? result)
                {
                    return JsonElementHelpers.TryParseValue<ReportBackendActivity>(ref reader, out result);
                }
...
#if NET
                static ReportBackendActivity IJsonElement<ReportBackendActivity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ReportBackendActivity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public ReportBackendActivity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public ReportBackendActivity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<ReportBackendActivity>(_idx);
                    }
                ...
                {
                    /// <summary>
                    /// Gets the JSON property name for <see cref="Metrics"/>.
                    /// </summary>
                    ...
                    /// Gets the JSON property name for <see cref="Metrics"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> MetricsUtf8 => "metrics"u8;
                ...
                {
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="Metrics"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Metrics => "metrics"u8;

                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="Traces"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Traces => "traces"u8;
                }
                ...
                {
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="Metrics"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Metrics => [0x95, 0x00, 0x00, 0x00, 0x22, 0x6D, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x22];

                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="Traces"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Traces => [0x85, 0x00, 0x00, 0x00, 0x22, 0x74, 0x72, 0x61, 0x63, 0x65, 0x73, 0x22];
                }
            }
        }
    }
