    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson
    {
        ...
        public readonly partial struct Layers
        {
            ...
            public readonly partial struct ReportGlobalActivity
            {
                ...
                public readonly partial struct DisableGlobalMetrics
#if NET8_0_OR_GREATER
                    : IJsonElement<DisableGlobalMetrics>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="DisableGlobalMetrics"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal DisableGlobalMetrics(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static DisableGlobalMetrics DefaultInstance { get; } = ParsedJsonDocument<DisableGlobalMetrics>.False;
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator bool(DisableGlobalMetrics value)
                    {
                    ...
                    /// </returns>
                    public static bool operator ==(in DisableGlobalMetrics left, in DisableGlobalMetrics right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in DisableGlobalMetrics left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(DisableGlobalMetrics instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DisableGlobalMetrics(JsonElement instance)
                    {
                        return DisableGlobalMetrics.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static DisableGlobalMetrics From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static DisableGlobalMetrics ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<DisableGlobalMetrics>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static DisableGlobalMetrics ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<DisableGlobalMetrics>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static DisableGlobalMetrics ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<DisableGlobalMetrics>(json, options);
                    }
                    ...
                    /// </exception>
                    public static DisableGlobalMetrics ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<DisableGlobalMetrics>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out DisableGlobalMetrics? result)
                    {
                        return JsonElementHelpers.TryParseValue<DisableGlobalMetrics>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new DisableGlobalMetrics(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static DisableGlobalMetrics IJsonElement<DisableGlobalMetrics>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DisableGlobalMetrics: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="DisableGlobalMetrics"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="DisableGlobalMetrics"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public DisableGlobalMetrics Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<DisableGlobalMetrics>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="DisableGlobalMetrics"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public DisableGlobalMetrics Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<DisableGlobalMetrics>(_idx);
                        }
