        ...
        public readonly partial struct Layers
        {
            ...
            public readonly partial struct ReportProxyActivity
            {
...
#endif
                {
                    ...
                    internal MetricsStaticAttributesEntityArray(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Layers.ReportProxyActivity.MetricsStaticAttributesEntityArray.MetricsStaticAttributesEntity this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Layers.ReportProxyActivity.MetricsStaticAttributesEntityArray.MetricsStaticAttributesEntity>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Layers.ReportProxyActivity.MetricsStaticAttributesEntityArray.MetricsStaticAttributesEntity> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Layers.ReportProxyActivity.MetricsStaticAttributesEntityArray.MetricsStaticAttributesEntity>(_parent, _idx);
                    }
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in MetricsStaticAttributesEntityArray left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(MetricsStaticAttributesEntityArray instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator MetricsStaticAttributesEntityArray(JsonElement instance)
                    {
                        return MetricsStaticAttributesEntityArray.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static MetricsStaticAttributesEntityArray From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static MetricsStaticAttributesEntityArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<MetricsStaticAttributesEntityArray>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static MetricsStaticAttributesEntityArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<MetricsStaticAttributesEntityArray>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static MetricsStaticAttributesEntityArray ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<MetricsStaticAttributesEntityArray>(json, options);
                    }
                    ...
                    /// </exception>
                    public static MetricsStaticAttributesEntityArray ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<MetricsStaticAttributesEntityArray>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out MetricsStaticAttributesEntityArray? result)
                    {
                        return JsonElementHelpers.TryParseValue<MetricsStaticAttributesEntityArray>(ref reader, out result);
                    }
...
#if NET
                    static MetricsStaticAttributesEntityArray IJsonElement<MetricsStaticAttributesEntityArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"MetricsStaticAttributesEntityArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public MetricsStaticAttributesEntityArray Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public MetricsStaticAttributesEntityArray Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<MetricsStaticAttributesEntityArray>(_idx);
                        }
