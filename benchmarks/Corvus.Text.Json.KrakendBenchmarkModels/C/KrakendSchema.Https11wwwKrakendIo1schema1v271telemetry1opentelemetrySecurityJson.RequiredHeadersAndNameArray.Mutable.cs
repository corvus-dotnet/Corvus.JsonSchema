    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson
    {
        ...
        public readonly partial struct RequiredHeadersAndNameArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequiredHeadersAndNameArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequiredHeadersAndNameArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredHeadersAndNameArray(Mutable instance)
                {
                ...
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName.Mutable>(_parent, _idx);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RequiredHeadersAndNameArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredHeadersAndNameArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName oldItem, in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName current = enumerator.Current;
                ...
                /// <summary>
                /// Gets a <see cref="RequiredHeadersAndNameArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RequiredHeadersAndNameArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredHeadersAndNameArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RequiredHeadersAndNameArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RequiredHeadersAndNameArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredHeadersAndNameArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequiredHeadersAndNameArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(RequiredHeadersAndNameArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<RequiredHeadersAndNameArray, Mutable>(this);
            }
        }
    }
}
