        ...
        public readonly partial struct RequiredHeadersAndNameArray
        {
            ...
            public readonly partial struct RequiredHeadersAndName
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RequiredHeadersAndName instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RequiredHeadersAndName"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredHeadersAndName(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Mutable HeadersValue
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HeadersValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetHeadersValue(in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source value)
                    {
                        CheckValidInstance();
                        ...
                        else
                        {
                            ...
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.HeadersValue, ref cvb);
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetHeadersValue<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source<TContext> value)
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredHeadersAndName.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredHeadersAndName Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredHeadersAndName Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RequiredHeadersAndName>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(RequiredHeadersAndName instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source headers,
                        in Corvus.KrakendBenchmark.Current.JsonString.Source name)
                    {
                        headers.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.HeadersValue, ref builder);
                    ...
                    /// Creates an instance of a <see cref="RequiredHeadersAndName"/>.
                    /// </summary>
                    public void Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source headers, in Corvus.KrakendBenchmark.Current.JsonString.Source name)
                    {
                        Create(ref _builder, headers, name);
                    }
                    ...
                    internal static void Create<TContext>(
                        in TContext context,
                        ref ComplexValueBuilder builder,
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source<TContext> headers,
                        in Corvus.KrakendBenchmark.Current.JsonString.Source name)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    ...
                    #endif
                    {
                        Create(context, ref _builder, headers, name);
                    }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source headers, in Corvus.KrakendBenchmark.Current.JsonString.Source name, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(headers, name);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source<TContext> headers, in Corvus.KrakendBenchmark.Current.JsonString.Source name, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    ...
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(context, headers, name);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<RequiredHeadersAndName, Mutable>(this);
                }
            }
        }
    }
