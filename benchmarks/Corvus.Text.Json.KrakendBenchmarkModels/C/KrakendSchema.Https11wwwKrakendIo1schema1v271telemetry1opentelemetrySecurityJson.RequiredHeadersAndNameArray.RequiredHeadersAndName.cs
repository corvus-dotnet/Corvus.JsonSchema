    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson
    {
        ...
        public readonly partial struct RequiredHeadersAndNameArray
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers HeadersValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HeadersValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetrySecurityJson.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers value))
                        {
                            return value;
                        }
