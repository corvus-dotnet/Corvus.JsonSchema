    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271tlsJson
    {
        ...
        public readonly partial struct KeysEntityArray
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.PrivateKey PrivateKeyValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrivateKeyValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.PrivateKey value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.PrivateKey.DefaultInstance;
                    }
                }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.PublicKey PublicKeyValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PublicKeyValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.PublicKey value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271tlsJson.KeysEntityArray.KeysEntity.PublicKey.DefaultInstance;
                    }
                }
                ...
                {
                    /// <summary>
                    /// Gets the JSON property name for <see cref="PrivateKeyValue"/>.
                    /// </summary>
                    public const string PrivateKeyValue = "private_key";

                    /// <summary>
                    /// Gets the JSON property name for <see cref="PublicKeyValue"/>.
                    /// </summary>
                    public const string PublicKeyValue = "public_key";

                    /// <summary>
                    /// Gets the JSON property name for <see cref="PrivateKeyValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> PrivateKeyValueUtf8 => "private_key"u8;

                    /// <summary>
                    /// Gets the JSON property name for <see cref="PublicKeyValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> PublicKeyValueUtf8 => "public_key"u8;
                }
                ...
                {
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="PrivateKeyValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> PrivateKeyValue => "private_key"u8;

                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="PublicKeyValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> PublicKeyValue => "public_key"u8;
                }
                ...
                {
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="PrivateKeyValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> PrivateKeyValue => [0xD5, 0x00, 0x00, 0x00, 0x22, 0x70, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x5F, 0x6B, 0x65, 0x79, 0x22];

                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="PublicKeyValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> PublicKeyValue => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x70, 0x75, 0x62, 0x6C, 0x69, 0x63, 0x5F, 0x6B, 0x65, 0x79, 0x22];
                }
            }
        }
    }
