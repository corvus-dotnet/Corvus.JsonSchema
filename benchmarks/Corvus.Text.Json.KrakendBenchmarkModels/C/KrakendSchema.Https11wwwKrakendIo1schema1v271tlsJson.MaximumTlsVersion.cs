...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271tlsJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="MaximumTlsVersion"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal MaximumTlsVersion(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static MaximumTlsVersion DefaultInstance { get; } = ParsedJsonDocument<MaximumTlsVersion>.StringConstant([.."\"TLS13\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(MaximumTlsVersion value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in MaximumTlsVersion left, in MaximumTlsVersion right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in MaximumTlsVersion left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(MaximumTlsVersion instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MaximumTlsVersion(JsonElement instance)
            {
                return MaximumTlsVersion.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MaximumTlsVersion From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MaximumTlsVersion ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MaximumTlsVersion>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MaximumTlsVersion ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MaximumTlsVersion>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MaximumTlsVersion ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MaximumTlsVersion>(json, options);
            }
            ...
            /// </exception>
            public static MaximumTlsVersion ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<MaximumTlsVersion>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out MaximumTlsVersion? result)
            {
                return JsonElementHelpers.TryParseValue<MaximumTlsVersion>(ref reader, out result);
            }
...
#if NET
            static MaximumTlsVersion IJsonElement<MaximumTlsVersion>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MaximumTlsVersion: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public MaximumTlsVersion Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public MaximumTlsVersion Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<MaximumTlsVersion>(_idx);
                }
