    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271tlsJson
    {
        ...
        public readonly partial struct MinimumTlsVersion
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(MinimumTlsVersion instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MinimumTlsVersion"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MinimumTlsVersion(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MinimumTlsVersion.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MinimumTlsVersion Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MinimumTlsVersion Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MinimumTlsVersion>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MinimumTlsVersion instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MinimumTlsVersion, Mutable>(this);
            }
        }
    }
}
