...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271websocketJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DirectCommunicationNoMultiplexing"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal DirectCommunicationNoMultiplexing(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static DirectCommunicationNoMultiplexing DefaultInstance { get; } = ParsedJsonDocument<DirectCommunicationNoMultiplexing>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(DirectCommunicationNoMultiplexing value)
            {
            ...
            /// </returns>
            public static bool operator ==(in DirectCommunicationNoMultiplexing left, in DirectCommunicationNoMultiplexing right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in DirectCommunicationNoMultiplexing left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(DirectCommunicationNoMultiplexing instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DirectCommunicationNoMultiplexing(JsonElement instance)
            {
                return DirectCommunicationNoMultiplexing.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DirectCommunicationNoMultiplexing From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DirectCommunicationNoMultiplexing ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DirectCommunicationNoMultiplexing>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DirectCommunicationNoMultiplexing ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DirectCommunicationNoMultiplexing>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DirectCommunicationNoMultiplexing ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DirectCommunicationNoMultiplexing>(json, options);
            }
            ...
            /// </exception>
            public static DirectCommunicationNoMultiplexing ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<DirectCommunicationNoMultiplexing>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out DirectCommunicationNoMultiplexing? result)
            {
                return JsonElementHelpers.TryParseValue<DirectCommunicationNoMultiplexing>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DirectCommunicationNoMultiplexing(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static DirectCommunicationNoMultiplexing IJsonElement<DirectCommunicationNoMultiplexing>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DirectCommunicationNoMultiplexing: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DirectCommunicationNoMultiplexing"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DirectCommunicationNoMultiplexing"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public DirectCommunicationNoMultiplexing Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DirectCommunicationNoMultiplexing>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DirectCommunicationNoMultiplexing"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public DirectCommunicationNoMultiplexing Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<DirectCommunicationNoMultiplexing>(_idx);
                }
