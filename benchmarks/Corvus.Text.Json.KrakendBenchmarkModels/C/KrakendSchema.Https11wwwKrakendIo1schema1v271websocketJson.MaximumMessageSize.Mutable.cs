    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271websocketJson
    {
        ...
        public readonly partial struct MaximumMessageSize
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(MaximumMessageSize instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MaximumMessageSize"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MaximumMessageSize(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MaximumMessageSize.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MaximumMessageSize Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MaximumMessageSize Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MaximumMessageSize>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MaximumMessageSize instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MaximumMessageSize, Mutable>(this);
            }
        }
    }
}
