...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271websocketJson
    {
        ...
        public readonly partial struct ReturnErrorDetails
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ReturnErrorDetails instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ReturnErrorDetails"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ReturnErrorDetails(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ReturnErrorDetails(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ReturnErrorDetails.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ReturnErrorDetails"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ReturnErrorDetails"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ReturnErrorDetails Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ReturnErrorDetails>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ReturnErrorDetails"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ReturnErrorDetails Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ReturnErrorDetails>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ReturnErrorDetails instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ReturnErrorDetails, Mutable>(this);
            }
        }
    }
}
