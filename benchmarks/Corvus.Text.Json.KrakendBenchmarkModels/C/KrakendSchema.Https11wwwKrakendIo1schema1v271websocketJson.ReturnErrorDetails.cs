...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271websocketJson
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ReturnErrorDetails"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ReturnErrorDetails(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ReturnErrorDetails DefaultInstance { get; } = ParsedJsonDocument<ReturnErrorDetails>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(ReturnErrorDetails value)
            {
            ...
            /// </returns>
            public static bool operator ==(in ReturnErrorDetails left, in ReturnErrorDetails right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ReturnErrorDetails left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ReturnErrorDetails instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ReturnErrorDetails(JsonElement instance)
            {
                return ReturnErrorDetails.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ReturnErrorDetails From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ReturnErrorDetails ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ReturnErrorDetails>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ReturnErrorDetails ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ReturnErrorDetails>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ReturnErrorDetails ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ReturnErrorDetails>(json, options);
            }
            ...
            /// </exception>
            public static ReturnErrorDetails ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ReturnErrorDetails>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ReturnErrorDetails? result)
            {
                return JsonElementHelpers.TryParseValue<ReturnErrorDetails>(ref reader, out result);
            }
...
#if NET
            static ReturnErrorDetails IJsonElement<ReturnErrorDetails>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ReturnErrorDetails: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ReturnErrorDetails Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ReturnErrorDetails Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ReturnErrorDetails>(_idx);
                }
