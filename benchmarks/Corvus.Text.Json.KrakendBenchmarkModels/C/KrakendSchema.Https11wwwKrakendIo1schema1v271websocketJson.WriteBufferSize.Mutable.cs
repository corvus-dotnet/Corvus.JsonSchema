...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271websocketJson
    {
        ...
        public readonly partial struct WriteBufferSize
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(WriteBufferSize instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="WriteBufferSize"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WriteBufferSize(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new WriteBufferSize(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WriteBufferSize.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="WriteBufferSize"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="WriteBufferSize"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly WriteBufferSize Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<WriteBufferSize>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="WriteBufferSize"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly WriteBufferSize Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<WriteBufferSize>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(WriteBufferSize instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<WriteBufferSize, Mutable>(this);
            }
        }
    }
}
