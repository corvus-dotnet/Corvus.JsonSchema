    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271workflowExtraConfigJson
    {
        ...
        public readonly partial struct Proxy
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="SequentialProxy"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal SequentialProxy(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static SequentialProxy DefaultInstance { get; } = ParsedJsonDocument<SequentialProxy>.True;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(SequentialProxy value)
                {
                ...
                /// </returns>
                public static bool operator ==(in SequentialProxy left, in SequentialProxy right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in SequentialProxy left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(SequentialProxy instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SequentialProxy(JsonElement instance)
                {
                    return SequentialProxy.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SequentialProxy From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SequentialProxy ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SequentialProxy>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SequentialProxy ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SequentialProxy>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SequentialProxy ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SequentialProxy>(json, options);
                }
                ...
                /// </exception>
                public static SequentialProxy ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<SequentialProxy>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out SequentialProxy? result)
                {
                    return JsonElementHelpers.TryParseValue<SequentialProxy>(ref reader, out result);
                }
...
#if NET
                static SequentialProxy IJsonElement<SequentialProxy>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SequentialProxy: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public SequentialProxy Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<SequentialProxy>(_idx);
                    }
