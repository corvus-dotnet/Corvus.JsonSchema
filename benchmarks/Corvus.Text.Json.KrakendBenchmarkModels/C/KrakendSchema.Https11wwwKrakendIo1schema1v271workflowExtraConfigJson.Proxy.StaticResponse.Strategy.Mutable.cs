            ...
            public readonly partial struct StaticResponse
            {
                ...
                public readonly partial struct Strategy
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(Strategy instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="Strategy"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator Strategy(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"Strategy.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly Strategy Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly Strategy Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<Strategy>(_idx);
                        }
                        ...
                        /// <param name="matchComplete">Match 3rd item.</param>
                        /// <param name="matchErrored">Match 4th item.</param>
                        /// <param name="matchIncomplete">Match 5th item.</param>
                        ...
                        public TResult Match<TContext, TResult>(
                            ...
                            Func<TContext, TResult> matchComplete,
                            Func<TContext, TResult> matchErrored,
                            Func<TContext, TResult> matchIncomplete,
...
#endif
                        {
                            ...
                            {
                                return matchComplete(context);
                            }

                            if (this.ValueEquals(Constants.Enum4))
                            {
                                return matchErrored(context);
                            }

                            if (this.ValueEquals(Constants.Enum5))
                            {
                                return matchIncomplete(context);
                            }
                        ...
                        public TResult Match<TResult>(
                            ...
                            Func<TResult> matchComplete,
                            Func<TResult> matchErrored,
                            Func<TResult> matchIncomplete,
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(Strategy instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<Strategy, Mutable>(this);
                    }
                }
            }
        }
