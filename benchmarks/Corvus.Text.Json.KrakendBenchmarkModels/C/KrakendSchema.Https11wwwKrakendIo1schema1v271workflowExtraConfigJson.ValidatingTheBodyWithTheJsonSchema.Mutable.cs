    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271workflowExtraConfigJson
    {
        ...
        public readonly partial struct ValidatingTheBodyWithTheJsonSchema
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ValidatingTheBodyWithTheJsonSchema instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ValidatingTheBodyWithTheJsonSchema"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ValidatingTheBodyWithTheJsonSchema(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ValidatingTheBodyWithTheJsonSchema.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ValidatingTheBodyWithTheJsonSchema Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ValidatingTheBodyWithTheJsonSchema Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ValidatingTheBodyWithTheJsonSchema>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.ValidatingTheBodyWithTheJsonSchema.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(ValidatingTheBodyWithTheJsonSchema instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.ValidatingTheBodyWithTheJsonSchema.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<ValidatingTheBodyWithTheJsonSchema, Mutable>(this);
            }
        }
    }
}
