...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271workflowExtraConfigJson
    {
        ...
        public readonly partial struct ValidatingTheBodyWithTheJsonSchema
#if NET8_0_OR_GREATER
            : IJsonElement<ValidatingTheBodyWithTheJsonSchema>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ValidatingTheBodyWithTheJsonSchema"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ValidatingTheBodyWithTheJsonSchema(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ValidatingTheBodyWithTheJsonSchema DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in ValidatingTheBodyWithTheJsonSchema left, in ValidatingTheBodyWithTheJsonSchema right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ValidatingTheBodyWithTheJsonSchema left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(ValidatingTheBodyWithTheJsonSchema instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ValidatingTheBodyWithTheJsonSchema(JsonElement instance)
            {
                return ValidatingTheBodyWithTheJsonSchema.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ValidatingTheBodyWithTheJsonSchema From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ValidatingTheBodyWithTheJsonSchema ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ValidatingTheBodyWithTheJsonSchema>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ValidatingTheBodyWithTheJsonSchema ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ValidatingTheBodyWithTheJsonSchema>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ValidatingTheBodyWithTheJsonSchema ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ValidatingTheBodyWithTheJsonSchema>(json, options);
            }
            ...
            /// </exception>
            public static ValidatingTheBodyWithTheJsonSchema ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ValidatingTheBodyWithTheJsonSchema>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ValidatingTheBodyWithTheJsonSchema? result)
            {
                return JsonElementHelpers.TryParseValue<ValidatingTheBodyWithTheJsonSchema>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ValidatingTheBodyWithTheJsonSchema(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ValidatingTheBodyWithTheJsonSchema IJsonElement<ValidatingTheBodyWithTheJsonSchema>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ValidatingTheBodyWithTheJsonSchema: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ValidatingTheBodyWithTheJsonSchema"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ValidatingTheBodyWithTheJsonSchema"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ValidatingTheBodyWithTheJsonSchema Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ValidatingTheBodyWithTheJsonSchema>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ValidatingTheBodyWithTheJsonSchema"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ValidatingTheBodyWithTheJsonSchema Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ValidatingTheBodyWithTheJsonSchema>(_idx);
                }
