    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271workflowJson
    {
        ...
        public readonly partial struct ConcurrentCalls
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ConcurrentCalls instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ConcurrentCalls"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ConcurrentCalls(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ConcurrentCalls.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ConcurrentCalls Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ConcurrentCalls Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ConcurrentCalls>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ConcurrentCalls instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ConcurrentCalls, Mutable>(this);
            }
        }
    }
}
