    ...
    public readonly partial struct Influx
    {
        ...
        public readonly partial struct DbName
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DbName, Mutable>(DbName.DefaultInstance);
                ...
                public static explicit operator Mutable(DbName instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DbName"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DbName(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DbName.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DbName Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DbName>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DbName instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DbName, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DbName> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DbName>();
                }
                finally
                {
