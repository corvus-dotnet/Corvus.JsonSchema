...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Influx
    {
        ...
        public readonly partial struct DbName
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DbName"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal DbName(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static DbName DefaultInstance { get; } = ParsedJsonDocument<DbName>.StringConstant([.."\"krakend\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(DbName value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in DbName left, in DbName right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in DbName left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(DbName instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DbName(JsonElement instance)
            {
                return DbName.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DbName From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DbName ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DbName>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DbName ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DbName>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DbName ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DbName>(json, options);
            }
            ...
            /// </exception>
            public static DbName ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<DbName>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out DbName? result)
            {
                return JsonElementHelpers.TryParseValue<DbName>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DbName(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static DbName IJsonElement<DbName>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DbName: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DbName"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DbName"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<DbName>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DbName"/> that lives for the lifetime of its
