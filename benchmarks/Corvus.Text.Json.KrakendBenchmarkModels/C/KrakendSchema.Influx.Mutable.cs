...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Influx
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Influx instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Influx"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Influx(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Influx.PointsInBuffer.Mutable BufferSize
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BufferSizeUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Influx.PointsInBuffer.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Influx.DbName.Mutable Db
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DbUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Influx.DbName.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.JsonString.Mutable Password
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PasswordUtf8, out Corvus.KrakendBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Duration.Mutable Ttl
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TtlUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Duration.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.JsonString.Mutable Username
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UsernameUtf8, out Corvus.KrakendBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Influx(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            /// <summary>
            /// Set the <c>buffer_size</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetBufferSize(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Influx.PointsInBuffer.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.BufferSizeUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BufferSizeUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.BufferSize, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>buffer_size</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveBufferSize()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.BufferSizeUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetDb(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Influx.DbName.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DbUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DbUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Db, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>db</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveDb()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DbUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            public void SetPassword(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PasswordUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PasswordUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Password, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>password</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemovePassword()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PasswordUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetTtl(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Duration.Source value)
            {
                CheckValidInstance();
            ...
            public void SetUsername(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.UsernameUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UsernameUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Username, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>username</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveUsername()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.UsernameUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Influx.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Influx"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Influx"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Influx Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Influx>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Influx"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Influx Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Influx>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Influx.PointsInBuffer.Source _createArg3;
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Influx.DbName.Source _createArg4;
            private readonly Corvus.KrakendBenchmark.Current.JsonString.Source _createArg5;
            private readonly Corvus.KrakendBenchmark.Current.JsonString.Source _createArg6;
            ...
            internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Influx.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Duration.Source arg2, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Influx.PointsInBuffer.Source arg3, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Influx.DbName.Source arg4, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg5, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg6)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            public static implicit operator Source(Influx instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Influx.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Influx"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.KrakendBenchmark.Current.JsonString.Source address,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.Duration.Source ttl,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.Influx.PointsInBuffer.Source bufferSize = default,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.Influx.DbName.Source db = default,
                in Corvus.KrakendBenchmark.Current.JsonString.Source password = default,
                in Corvus.KrakendBenchmark.Current.JsonString.Source username = default)
            {
                ...
                bufferSize.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.BufferSize, ref builder);
                db.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Db, ref builder);
                password.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Password, ref builder);
                username.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Username, ref builder);
            }
            ...
            public void Create(
                ...
                in Corvus.KrakendBenchmark.Current.JsonString.Source username = default)
            {
                Create(ref _builder, address, ttl, bufferSize, db, password, username);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Duration.Source arg2, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Influx.PointsInBuffer.Source arg3, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Influx.DbName.Source arg4, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg5, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg6, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <param name="bufferSize">The value of the <c>"buffer_size"</c> property.</param>
        /// <param name="db">The value of the <c>"db"</c> property.</param>
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source address, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Duration.Source ttl, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Influx.PointsInBuffer.Source bufferSize = default, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Influx.DbName.Source db = default, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source password = default, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source username = default)
        {
            return new Source(address, ttl, bufferSize, db, password, username);
        }
        ...
        /// <param name="bufferSize">The value of the property.</param>
        /// <param name="db">The value of the property.</param>
        /// <param name="password">The value of the property.</param>
        /// <param name="username">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonString.Source address, in Corvus.KrakendBenchmark.Current.KrakendSchema.Duration.Source ttl, in Corvus.KrakendBenchmark.Current.KrakendSchema.Influx.PointsInBuffer.Source bufferSize = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Influx.DbName.Source db = default, in Corvus.KrakendBenchmark.Current.JsonString.Source password = default, in Corvus.KrakendBenchmark.Current.JsonString.Source username = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(address, ttl, bufferSize, db, password, username);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<Influx, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Influx> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Influx>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Influx> Create<TContext>(
        ...
        public static ParsedJsonDocument<Influx> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source address, in Corvus.KrakendBenchmark.Current.KrakendSchema.Duration.Source ttl, in Corvus.KrakendBenchmark.Current.KrakendSchema.Influx.PointsInBuffer.Source bufferSize = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Influx.DbName.Source db = default, in Corvus.KrakendBenchmark.Current.JsonString.Source password = default, in Corvus.KrakendBenchmark.Current.JsonString.Source username = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
