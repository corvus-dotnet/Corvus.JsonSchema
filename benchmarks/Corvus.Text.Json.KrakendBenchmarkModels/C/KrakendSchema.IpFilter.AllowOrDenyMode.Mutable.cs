    ...
    public readonly partial struct IpFilter
    {
        ...
        public readonly partial struct AllowOrDenyMode
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AllowOrDenyMode, Mutable>(AllowOrDenyMode.DefaultInstance);
                ...
                public static explicit operator Mutable(AllowOrDenyMode instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AllowOrDenyMode"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AllowOrDenyMode(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AllowOrDenyMode.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AllowOrDenyMode Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AllowOrDenyMode Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AllowOrDenyMode>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AllowOrDenyMode instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AllowOrDenyMode, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AllowOrDenyMode> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AllowOrDenyMode>();
                }
                finally
                {
