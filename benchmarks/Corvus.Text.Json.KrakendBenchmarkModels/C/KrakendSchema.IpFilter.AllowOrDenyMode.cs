...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct IpFilter
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AllowOrDenyMode"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal AllowOrDenyMode(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AllowOrDenyMode DefaultInstance { get; } = ParsedJsonDocument<AllowOrDenyMode>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(AllowOrDenyMode value)
            {
            ...
            /// </returns>
            public static bool operator ==(in AllowOrDenyMode left, in AllowOrDenyMode right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AllowOrDenyMode left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(AllowOrDenyMode instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AllowOrDenyMode(JsonElement instance)
            {
                return AllowOrDenyMode.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllowOrDenyMode From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllowOrDenyMode ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllowOrDenyMode>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllowOrDenyMode ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllowOrDenyMode>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllowOrDenyMode ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllowOrDenyMode>(json, options);
            }
            ...
            /// </exception>
            public static AllowOrDenyMode ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<AllowOrDenyMode>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AllowOrDenyMode? result)
            {
                return JsonElementHelpers.TryParseValue<AllowOrDenyMode>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new AllowOrDenyMode(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static AllowOrDenyMode IJsonElement<AllowOrDenyMode>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AllowOrDenyMode: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="AllowOrDenyMode"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="AllowOrDenyMode"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public AllowOrDenyMode Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<AllowOrDenyMode>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="AllowOrDenyMode"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public AllowOrDenyMode Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<AllowOrDenyMode>(_idx);
                }
