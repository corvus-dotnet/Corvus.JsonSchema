...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Jmespath
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Jmespath instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Jmespath"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Jmespath(Mutable instance)
            {
            ...
            public void SetExpr(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Jmespath.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Jmespath Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly Jmespath Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Jmespath>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Jmespath.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            public static implicit operator Source(Jmespath instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Jmespath.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Jmespath"/>.
            /// </summary>
        ...
        /// </summary>
        /// <param name="expr">The value of the <c>"expr"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source expr)
        {
            return new Source(expr);
        }
        ...
        {
            return workspace.CreateBuilder<Jmespath, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Jmespath> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Jmespath>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Jmespath> Create<TContext>(
        ...
        public static ParsedJsonDocument<Jmespath> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source expr, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
