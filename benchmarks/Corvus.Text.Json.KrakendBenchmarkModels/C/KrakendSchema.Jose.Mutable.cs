...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Jose
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Jose instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Jose"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Jose(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Jose(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetSharedCacheDuration(scoped in Corvus.KrakendBenchmark.Current.JsonInteger.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Jose.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Jose"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Jose"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Jose Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Jose>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Jose"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Jose Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Jose>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Jose.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.KrakendBenchmark.Current.JsonInteger.Source arg1)
            {
                _createArg1 = arg1;
                _kind = Kind.Create;
            }

            public static implicit operator Source(Jose instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Jose.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Jose"/>.
            /// </summary>
            ...
            internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.JsonInteger.Source arg1, ref ComplexValueBuilder o)
            {
                o.StartObject();
                Create(ref o, arg1);
                o.EndObject();
        ...
        /// </summary>
        /// <param name="sharedCacheDuration">The value of the <c>"shared_cache_duration"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.KrakendBenchmark.Current.JsonInteger.Source sharedCacheDuration)
        {
            return new Source(sharedCacheDuration);
        }
        ...
        {
            return workspace.CreateBuilder<Jose, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Jose> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Jose>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Jose> Create<TContext>(
        ...
        public static ParsedJsonDocument<Jose> Create(in Corvus.KrakendBenchmark.Current.JsonInteger.Source sharedCacheDuration, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
