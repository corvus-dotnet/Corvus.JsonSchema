...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Lambda
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Lambda instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Lambda"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Lambda(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Lambda.MaxRetries.Mutable MaxRetriesValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxRetriesValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Lambda.MaxRetries.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.KrakendBenchmark.Current.KrakendSchema.Lambda.MaxRetries.Mutable.DefaultInstance;
                }
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Lambda(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Lambda.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Lambda"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Lambda"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Lambda Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Lambda>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Lambda"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Lambda Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Lambda>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Lambda.MaxRetries.Source _createArg4;
            ...
            public static implicit operator Source(Lambda instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Lambda.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Lambda"/>.
            /// </summary>
            internal static void Create(
                ...
                in Corvus.KrakendBenchmark.Current.KrakendSchema.Lambda.MaxRetries.Source maxRetries = default,
        ...
        /// <param name="functionName">The value of the <c>"function_name"</c> property.</param>
        /// <param name="functionParamName">The value of the <c>"function_param_name"</c> property.</param>
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonString.Source endpoint = default, in Corvus.KrakendBenchmark.Current.JsonString.Source functionName = default, in Corvus.KrakendBenchmark.Current.JsonString.Source functionParamName = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Lambda.MaxRetries.Source maxRetries = default, in Corvus.KrakendBenchmark.Current.JsonString.Source region = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        {
            return workspace.CreateBuilder<Lambda, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Lambda> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Lambda>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Lambda> Create<TContext>(
        ...
        public static ParsedJsonDocument<Lambda> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source endpoint = default, in Corvus.KrakendBenchmark.Current.JsonString.Source functionName = default, in Corvus.KrakendBenchmark.Current.JsonString.Source functionParamName = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Lambda.MaxRetries.Source maxRetries = default, in Corvus.KrakendBenchmark.Current.JsonString.Source region = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
