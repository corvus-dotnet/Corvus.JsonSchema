...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct ListenIp
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ListenIp, Mutable>(ListenIp.DefaultInstance);
            ...
            public static explicit operator Mutable(ListenIp instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ListenIp"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ListenIp(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ListenIp.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ListenIp Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ListenIp Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ListenIp>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ListenIp instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ListenIp, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ListenIp> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ListenIp>();
            }
            finally
            {
