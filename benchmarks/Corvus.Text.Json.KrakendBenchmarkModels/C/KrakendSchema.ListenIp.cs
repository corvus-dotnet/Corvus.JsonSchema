...
public readonly partial struct KrakendSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListenIp"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ListenIp(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ListenIp DefaultInstance { get; } = ParsedJsonDocument<ListenIp>.StringConstant([.."\"0.0.0.0\""u8]);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(ListenIp value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in ListenIp left, in ListenIp right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ListenIp left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ListenIp instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ListenIp(JsonElement instance)
        {
            return ListenIp.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ListenIp From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ListenIp ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ListenIp>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ListenIp ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ListenIp>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ListenIp ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ListenIp>(json, options);
        }
        ...
        /// </exception>
        public static ListenIp ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ListenIp>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ListenIp? result)
        {
            return JsonElementHelpers.TryParseValue<ListenIp>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ListenIp(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ListenIp IJsonElement<ListenIp>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ListenIp: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ListenIp"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ListenIp"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ListenIp Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ListenIp>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ListenIp"/> that lives for the lifetime of its
