    ...
    public readonly partial struct Logging
    {
        ...
        public readonly partial struct LogFormat
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<LogFormat, Mutable>(LogFormat.DefaultInstance);
                ...
                public static explicit operator Mutable(LogFormat instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="LogFormat"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LogFormat(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LogFormat.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly LogFormat Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly LogFormat Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<LogFormat>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(LogFormat instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<LogFormat, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<LogFormat> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<LogFormat>();
                }
                finally
                {
