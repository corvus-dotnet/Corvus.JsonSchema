...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Logging
    {
...
#endif
        {
            ...
            internal LogLevel(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static LogLevel DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(LogLevel value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in LogLevel left, in LogLevel right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in LogLevel left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(LogLevel instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LogLevel(JsonElement instance)
            {
                return LogLevel.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LogLevel From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LogLevel ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LogLevel>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LogLevel ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LogLevel>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LogLevel ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LogLevel>(json, options);
            }
            ...
            /// </exception>
            public static LogLevel ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<LogLevel>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out LogLevel? result)
            {
                return JsonElementHelpers.TryParseValue<LogLevel>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new LogLevel(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static LogLevel IJsonElement<LogLevel>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LogLevel: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="LogLevel"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="LogLevel"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public LogLevel Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<LogLevel>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="LogLevel"/> that lives for the lifetime of its
            ...
            /// <param name="matchDebug">Match 1st item.</param>
            /// <param name="matchInfo">Match 2nd item.</param>
            /// <param name="matchWarning">Match 3rd item.</param>
            /// <param name="matchError">Match 4th item.</param>
            /// <param name="matchCritical">Match 5th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchDebug,
                Func<TContext, TResult> matchInfo,
                Func<TContext, TResult> matchWarning,
...
#endif
            {
                ...
                {
                    return matchInfo(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchWarning(context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Func<TResult> matchInfo,
                Func<TResult> matchWarning,
