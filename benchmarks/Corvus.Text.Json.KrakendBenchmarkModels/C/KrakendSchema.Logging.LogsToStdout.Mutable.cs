...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Logging
    {
        ...
        public readonly partial struct LogsToStdout
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<LogsToStdout, Mutable>(LogsToStdout.DefaultInstance);
                ...
                public static explicit operator Mutable(LogsToStdout instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="LogsToStdout"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LogsToStdout(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new LogsToStdout(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LogsToStdout.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="LogsToStdout"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="LogsToStdout"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly LogsToStdout Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<LogsToStdout>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="LogsToStdout"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly LogsToStdout Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<LogsToStdout>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(LogsToStdout instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<LogsToStdout, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<LogsToStdout> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<LogsToStdout>();
                }
                finally
                {
