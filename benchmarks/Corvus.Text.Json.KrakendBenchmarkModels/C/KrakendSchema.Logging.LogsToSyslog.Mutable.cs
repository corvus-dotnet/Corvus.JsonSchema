    ...
    public readonly partial struct Logging
    {
        ...
        public readonly partial struct LogsToSyslog
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<LogsToSyslog, Mutable>(LogsToSyslog.DefaultInstance);
            ...
            public static ParsedJsonDocument<LogsToSyslog> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<LogsToSyslog>();
                }
                finally
                {
