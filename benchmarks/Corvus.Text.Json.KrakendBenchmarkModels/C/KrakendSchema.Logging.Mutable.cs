...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Logging
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Logging instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Logging"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Logging(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogFormat.Mutable Format
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FormatUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogFormat.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogLevel.Mutable Level
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LevelUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogLevel.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogsToStdout.Mutable Stdout
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StdoutUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogsToStdout.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogsToSyslog.Mutable Syslog
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SyslogUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogsToSyslog.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.SyslogFacility.Mutable SyslogFacilityValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SyslogFacilityValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.SyslogFacility.Mutable value))
                    {
                        return value;
                    }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Logging.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Logging Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Logging>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogLevel.Source _createArg1;
            private readonly Corvus.KrakendBenchmark.Current.JsonString.Source _createArg2;
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogFormat.Source _createArg3;
            private readonly Corvus.KrakendBenchmark.Current.JsonString.Source _createArg4;
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogsToStdout.Source _createArg5;
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogsToSyslog.Source _createArg6;
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.SyslogFacility.Source _createArg7;
            ...
            public static implicit operator Source(Logging instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Logging"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogLevel.Source level,
                in Corvus.KrakendBenchmark.Current.JsonString.Source customFormat = default,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogFormat.Source format = default,
                in Corvus.KrakendBenchmark.Current.JsonString.Source prefix = default,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogsToStdout.Source stdout = default,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogsToSyslog.Source syslog = default,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.SyslogFacility.Source syslogFacility = default)
            {
        ...
        /// </summary>
        /// <param name="level">The value of the <c>"level"</c> property.</param>
        /// <param name="customFormat">The value of the <c>"custom_format"</c> property.</param>
        /// <param name="format">The value of the <c>"format"</c> property.</param>
        /// <param name="prefix">The value of the <c>"prefix"</c> property.</param>
        /// <param name="stdout">The value of the <c>"stdout"</c> property.</param>
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogLevel.Source level, in Corvus.KrakendBenchmark.Current.JsonString.Source customFormat = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogFormat.Source format = default, in Corvus.KrakendBenchmark.Current.JsonString.Source prefix = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogsToStdout.Source stdout = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogsToSyslog.Source syslog = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.SyslogFacility.Source syslogFacility = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        {
            return workspace.CreateBuilder<Logging, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Logging> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Logging>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Logging> Create<TContext>(
        ...
        public static ParsedJsonDocument<Logging> Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogLevel.Source level, in Corvus.KrakendBenchmark.Current.JsonString.Source customFormat = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogFormat.Source format = default, in Corvus.KrakendBenchmark.Current.JsonString.Source prefix = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogsToStdout.Source stdout = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogsToSyslog.Source syslog = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.SyslogFacility.Source syslogFacility = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
