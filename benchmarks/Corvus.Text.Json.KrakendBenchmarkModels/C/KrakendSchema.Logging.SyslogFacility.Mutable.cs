    ...
    public readonly partial struct Logging
    {
        ...
        public readonly partial struct SyslogFacility
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SyslogFacility, Mutable>(SyslogFacility.DefaultInstance);
            ...
            public ref struct Source
            {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (SyslogFacility)value;
            ...
            public static ParsedJsonDocument<SyslogFacility> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SyslogFacility>();
                }
                finally
                {
