...
public readonly partial struct KrakendSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Logging"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Logging(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Logging DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.JsonString CustomFormat
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CustomFormatUtf8, out Corvus.KrakendBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogFormat Format
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FormatUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogFormat value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogFormat.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogLevel Level
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LevelUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogLevel value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogsToStdout Stdout
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StdoutUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogsToStdout value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogsToStdout.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogsToSyslog Syslog
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SyslogUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogsToSyslog value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.LogsToSyslog.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.SyslogFacility SyslogFacilityValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SyslogFacilityValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.SyslogFacility value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Logging.SyslogFacility.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in Logging left, in Logging right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Logging left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Logging instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Logging(JsonElement instance)
        {
            return Logging.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Logging From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Logging ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Logging>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Logging ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Logging>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Logging ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Logging>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static Logging ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Logging>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Logging? result)
        {
            return JsonElementHelpers.TryParseValue<Logging>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Logging(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Logging IJsonElement<Logging>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Logging: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Logging"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Logging"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<Logging>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Logging"/> that lives for the lifetime of its
        ...
        public static class JsonPropertyNames
        {
            ...
            /// <summary>
            /// Gets the JSON property name for <see cref="SyslogFacilityValue"/>.
            /// </summary>
            public const string SyslogFacilityValue = "syslog_facility";
            ...
            /// Gets the JSON property name for <see cref="SyslogFacilityValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> SyslogFacilityValueUtf8 => "syslog_facility"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="CustomFormat"/>.
            /// </summary>
            public static ReadOnlySpan<byte> CustomFormat => "custom_format"u8;
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Level"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Level => "level"u8;
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Stdout"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Stdout => "stdout"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Syslog"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Syslog => "syslog"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="SyslogFacilityValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> SyslogFacilityValue => "syslog_facility"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="CustomFormat"/>.
            /// </summary>
            public static ReadOnlySpan<byte> CustomFormat => [0xF5, 0x00, 0x00, 0x00, 0x22, 0x63, 0x75, 0x73, 0x74, 0x6F, 0x6D, 0x5F, 0x66, 0x6F, 0x72, 0x6D, 0x61, 0x74, 0x22];
            ...
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Level"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Level => [0x75, 0x00, 0x00, 0x00, 0x22, 0x6C, 0x65, 0x76, 0x65, 0x6C, 0x22];
            ...
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Stdout"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Stdout => [0x85, 0x00, 0x00, 0x00, 0x22, 0x73, 0x74, 0x64, 0x6F, 0x75, 0x74, 0x22];

            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Syslog"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Syslog => [0x85, 0x00, 0x00, 0x00, 0x22, 0x73, 0x79, 0x73, 0x6C, 0x6F, 0x67, 0x22];

            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="SyslogFacilityValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> SyslogFacilityValue => [0x15, 0x01, 0x00, 0x00, 0x22, 0x73, 0x79, 0x73, 0x6C, 0x6F, 0x67, 0x5F, 0x66, 0x61, 0x63, 0x69, 0x6C, 0x69, 0x74, 0x79, 0x22];
        }
    }
}
