    ...
    public readonly partial struct Logstash
    {
            ...
            : IJsonElement<Enabled>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1telemetry~1logstash.json/properties/enabled"u8, buffer, out written);
