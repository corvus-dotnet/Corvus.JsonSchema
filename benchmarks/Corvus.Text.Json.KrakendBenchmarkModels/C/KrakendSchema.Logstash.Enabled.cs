...
public readonly partial struct KrakendSchema
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct Logstash
    {
        /// <summary>
        /// Enabled
        /// </summary>
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="Enabled"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal Enabled(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Enabled DefaultInstance { get; } = ParsedJsonDocument<Enabled>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(Enabled value)
            {
            ...
            /// </returns>
            public static bool operator ==(in Enabled left, in Enabled right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Enabled left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(Enabled instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Enabled(JsonElement instance)
            {
                return Enabled.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Enabled From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Enabled ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Enabled>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Enabled ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Enabled>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Enabled ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Enabled>(json, options);
            }
            ...
            /// </exception>
            public static Enabled ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Enabled>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Enabled? result)
            {
                return JsonElementHelpers.TryParseValue<Enabled>(ref reader, out result);
            }
...
#if NET
            static Enabled IJsonElement<Enabled>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Enabled: ValueKind = {ValueKind} : \"{ToString()}\"";
