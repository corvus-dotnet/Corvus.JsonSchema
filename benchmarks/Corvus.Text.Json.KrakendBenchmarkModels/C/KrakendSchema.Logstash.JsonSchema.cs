...
public readonly partial struct KrakendSchema
{
        ...
        : IJsonElement<Logstash>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchEnabledValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.KrakendBenchmark.Current.KrakendSchema.Logstash.Enabled.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.KrakendBenchmark.Current.KrakendSchema.Logstash.Enabled.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
