...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Logstash
    {
...
#endif
        {
            ...
            public void SetEnabledValue(in Corvus.KrakendBenchmark.Current.KrakendSchema.Logstash.Enabled.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(in Corvus.KrakendBenchmark.Current.KrakendSchema.Logstash.Enabled.Source arg1)
            {
                _createArg1 = arg1;
                _kind = Kind.Create;
            }
        ...
        public ref struct Builder
        {
            ...
            internal static void BuildCreateValue(in Corvus.KrakendBenchmark.Current.KrakendSchema.Logstash.Enabled.Source arg1, ref ComplexValueBuilder o)
            {
                o.StartObject();
                Create(ref o, arg1);
                o.EndObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in Corvus.KrakendBenchmark.Current.KrakendSchema.Logstash.Enabled.Source enabled)
        {
