...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Logstash
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Logstash instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Logstash"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Logstash(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Logstash.Enabled.Mutable EnabledValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnabledValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Logstash.Enabled.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Logstash(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetEnabledValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Logstash.Enabled.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Logstash.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Logstash"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Logstash"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Logstash Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Logstash>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Logstash"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Logstash Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Logstash>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Logstash.Enabled.Source _createArg1;
            ...
            internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Logstash.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Logstash.Enabled.Source arg1)
            {
                _createArg1 = arg1;
                _kind = Kind.Create;
            }

            public static implicit operator Source(Logstash instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Logstash.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Logstash"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.KrakendBenchmark.Current.KrakendSchema.Logstash.Enabled.Source enabled)
            {
            ...
            /// Creates an instance of a <see cref="Logstash"/>.
            /// </summary>
            public void Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Logstash.Enabled.Source enabled)
            {
            ...
            internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Logstash.Enabled.Source arg1, ref ComplexValueBuilder o)
            {
                o.StartObject();
                Create(ref o, arg1);
                o.EndObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Logstash.Enabled.Source enabled)
        {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.Logstash.Enabled.Source enabled, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        {
            return workspace.CreateBuilder<Logstash, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Logstash> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Logstash>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Logstash> Create<TContext>(
        ...
        public static ParsedJsonDocument<Logstash> Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Logstash.Enabled.Source enabled, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
