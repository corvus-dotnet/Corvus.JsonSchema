    ...
    public readonly partial struct Lua
    {
        ...
        public readonly partial struct LiveReload
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<LiveReload, Mutable>(LiveReload.DefaultInstance);
            ...
            public static ParsedJsonDocument<LiveReload> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<LiveReload>();
                }
                finally
                {
