    ...
    public readonly partial struct Lua
    {
        ...
        public readonly partial struct OpenExternalLibs
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<OpenExternalLibs, Mutable>(OpenExternalLibs.DefaultInstance);
            ...
            public static ParsedJsonDocument<OpenExternalLibs> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OpenExternalLibs>();
                }
                finally
                {
