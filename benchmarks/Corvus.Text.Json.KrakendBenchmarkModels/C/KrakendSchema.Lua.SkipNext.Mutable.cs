    ...
    public readonly partial struct Lua
    {
        ...
        public readonly partial struct SkipNext
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SkipNext, Mutable>(SkipNext.DefaultInstance);
                ...
                public static explicit operator Mutable(SkipNext instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SkipNext"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SkipNext(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SkipNext.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SkipNext Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SkipNext Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SkipNext>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SkipNext instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SkipNext, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SkipNext> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SkipNext>();
                }
                finally
                {
