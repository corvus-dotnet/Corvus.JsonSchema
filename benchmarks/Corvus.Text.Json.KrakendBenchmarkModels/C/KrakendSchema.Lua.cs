...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Lua
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Lua"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Lua(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Lua DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Lua.OpenExternalLibs AllowOpenLibs
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AllowOpenLibsUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Lua.OpenExternalLibs value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Lua.OpenExternalLibs.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Lua.LiveReload Live
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LiveUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Lua.LiveReload value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Lua.LiveReload.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.JsonString Post
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PostUtf8, out Corvus.KrakendBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.JsonString Pre
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PreUtf8, out Corvus.KrakendBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Lua.SkipNext SkipNextValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SkipNextValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Lua.SkipNext value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Lua.SkipNext.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in Lua left, in Lua right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Lua left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Lua instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Lua(JsonElement instance)
        {
            return Lua.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Lua From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Lua ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Lua>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Lua ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Lua>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Lua ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Lua>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static Lua ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Lua>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Lua? result)
        {
            return JsonElementHelpers.TryParseValue<Lua>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Lua(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Lua IJsonElement<Lua>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Lua: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Lua"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Lua"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<Lua>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Lua"/> that lives for the lifetime of its
        ...
        public Lua Freeze()
        {
            ...
            {
                return mutable.FreezeElement<Lua>(_idx);
            }
        ...
        public static class JsonPropertyNames
        {
            ...
            /// <summary>
            /// Gets the JSON property name for <see cref="SkipNextValue"/>.
            /// </summary>
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="AllowOpenLibs"/>.
            /// </summary>
            public static ReadOnlySpan<byte> AllowOpenLibs => "allow_open_libs"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Live"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Live => "live"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Md5"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Md5 => "md5"u8;
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="SkipNextValue"/>.
            /// </summary>
