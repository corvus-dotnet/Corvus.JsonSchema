    ...
    public readonly partial struct Martian
    {
        ...
        public readonly partial struct AppendAHeader
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.AppendAHeader.Scope.Mutable ScopeValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopeValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.AppendAHeader.Scope.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetScopeValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.AppendAHeader.Scope.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetScopeValue<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.AppendAHeader.Scope.Source<TContext> value)
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.AppendAHeader.Scope.Source _createArg2;
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.AppendAHeader.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.AppendAHeader.Scope.Source arg2, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg3)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _createArg3 = arg3;
                ...
                #endif
            {
                ...
                private readonly Corvus.KrakendBenchmark.Current.JsonString.Source _createArg1;
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.AppendAHeader.Scope.Source<TContext> _createArg2;
                private readonly Corvus.KrakendBenchmark.Current.JsonString.Source _createArg3;
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.AppendAHeader.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.AppendAHeader.Scope.Source<TContext> arg2, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg3)
                {
                    _context = context;
                    _createArg1 = arg1;
                    _createArg2 = arg2;
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.AppendAHeader.Scope.Source scope,
                ...
                internal static void Create<TContext>(
                    ...
                    ref ComplexValueBuilder builder,
                    in Corvus.KrakendBenchmark.Current.JsonString.Source name,
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.AppendAHeader.Scope.Source<TContext> scope,
                    in Corvus.KrakendBenchmark.Current.JsonString.Source value)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                ...
                internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.AppendAHeader.Scope.Source arg2, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg3, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                ...
                /// <param name="arg3">The value of the property.</param>
                /// <param name="o">The complex value builder into which to write the object.</param>
                internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.AppendAHeader.Scope.Source<TContext> arg2, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg3, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source name, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.AppendAHeader.Scope.Source scope, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source value)
            {
            ...
            /// <param name="value">The value of the <c>"value"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source name, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.AppendAHeader.Scope.Source<TContext> scope, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source value)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonString.Source name, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.AppendAHeader.Scope.Source scope, in Corvus.KrakendBenchmark.Current.JsonString.Source value, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.JsonString.Source name, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.AppendAHeader.Scope.Source<TContext> scope, in Corvus.KrakendBenchmark.Current.JsonString.Source value, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            public static ParsedJsonDocument<AppendAHeader> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AppendAHeader>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<AppendAHeader> Create<TContext>(
            ...
            public static ParsedJsonDocument<AppendAHeader> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source name, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.AppendAHeader.Scope.Source scope, in Corvus.KrakendBenchmark.Current.JsonString.Source value, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<AppendAHeader> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.JsonString.Source name, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.AppendAHeader.Scope.Source<TContext> scope, in Corvus.KrakendBenchmark.Current.JsonString.Source value, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
