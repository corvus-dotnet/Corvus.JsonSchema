    ...
    public readonly partial struct Martian
    {
        ...
        public readonly partial struct BlacklistHeaders
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.JsonStringArray.Mutable Names
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NamesUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.JsonStringArray.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.Scope.Mutable ScopeValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopeValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.Scope.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetNames(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.JsonStringArray.Source value)
                {
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Names, ref cvb);
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetNames<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.JsonStringArray.Source<TContext> value)
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetScopeValue<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.Scope.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.JsonStringArray.Source _createArg1;
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.Scope.Source _createArg2;
                ...
                #endif
            {
                ...
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.JsonStringArray.Source<TContext> _createArg1;
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.Scope.Source<TContext> _createArg2;
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.JsonStringArray.Source names,
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.Scope.Source scope)
                {
                    names.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Names, ref builder);
                ...
                /// Creates an instance of a <see cref="BlacklistHeaders"/>.
                /// </summary>
                public void Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.JsonStringArray.Source names, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.Scope.Source scope)
                {
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.JsonStringArray.Source<TContext> names,
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.Scope.Source<TContext> scope)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
            ...
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.JsonStringArray.Source<TContext> names, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.Scope.Source<TContext> scope)
                ...
                #endif
            {
                return new Source<TContext>(context, names, scope);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.JsonStringArray.Source names, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.Scope.Source scope, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.JsonStringArray.Source<TContext> names, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.Scope.Source<TContext> scope, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            public static ParsedJsonDocument<BlacklistHeaders> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<BlacklistHeaders>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<BlacklistHeaders> Create<TContext>(
            ...
            public static ParsedJsonDocument<BlacklistHeaders> Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.JsonStringArray.Source names, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.Scope.Source scope, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<BlacklistHeaders> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.JsonStringArray.Source<TContext> names, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.Scope.Source<TContext> scope, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
