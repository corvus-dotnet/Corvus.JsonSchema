...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Martian
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="BlacklistHeaders"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal BlacklistHeaders(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static BlacklistHeaders DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.JsonStringArray Names
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NamesUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.JsonStringArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.Scope ScopeValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopeValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.BlacklistHeaders.Scope value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in BlacklistHeaders left, in BlacklistHeaders right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in BlacklistHeaders left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(BlacklistHeaders instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BlacklistHeaders(JsonElement instance)
            {
                return BlacklistHeaders.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BlacklistHeaders From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BlacklistHeaders ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BlacklistHeaders>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BlacklistHeaders ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BlacklistHeaders>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BlacklistHeaders ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BlacklistHeaders>(json, options);
            }
            ...
            /// </exception>
            public static BlacklistHeaders ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<BlacklistHeaders>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out BlacklistHeaders? result)
            {
                return JsonElementHelpers.TryParseValue<BlacklistHeaders>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new BlacklistHeaders(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static BlacklistHeaders IJsonElement<BlacklistHeaders>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BlacklistHeaders: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="BlacklistHeaders"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="BlacklistHeaders"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public BlacklistHeaders Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<BlacklistHeaders>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="BlacklistHeaders"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public BlacklistHeaders Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<BlacklistHeaders>(_idx);
                }
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Names"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Names => "names"u8;
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="Names"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Names => [0x75, 0x00, 0x00, 0x00, 0x22, 0x6E, 0x61, 0x6D, 0x65, 0x73, 0x22];
