        ...
        public readonly partial struct CookieModifier
        {
            ...
            public readonly partial struct SecureEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SecureEntity, Mutable>(SecureEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(SecureEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="SecureEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator SecureEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"SecureEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SecureEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SecureEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<SecureEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(SecureEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<SecureEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<SecureEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<SecureEntity>();
                    }
                    finally
                    {
