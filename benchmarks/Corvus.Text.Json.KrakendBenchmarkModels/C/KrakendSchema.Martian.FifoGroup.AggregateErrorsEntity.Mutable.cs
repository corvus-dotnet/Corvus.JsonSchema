        ...
        public readonly partial struct FifoGroup
        {
            ...
            public readonly partial struct AggregateErrorsEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AggregateErrorsEntity, Mutable>(AggregateErrorsEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(AggregateErrorsEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="AggregateErrorsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AggregateErrorsEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AggregateErrorsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AggregateErrorsEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AggregateErrorsEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<AggregateErrorsEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(AggregateErrorsEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<AggregateErrorsEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<AggregateErrorsEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<AggregateErrorsEntity>();
                    }
                    finally
                    {
