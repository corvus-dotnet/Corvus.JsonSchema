        ...
        public readonly partial struct FifoGroup
        {
            ...
            public readonly partial struct MartianArray
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(MartianArray instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="MartianArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator MartianArray(Mutable instance)
                    {
                    ...
                    public Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Mutable this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Mutable>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Mutable> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Mutable>(_parent, _idx);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new MartianArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"MartianArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void SetItem(int itemIndex, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void InsertItem(int itemIndex, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void AddItem(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source value)
                    {
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Remove(in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian item)
                    {
                        CheckValidInstance();
                        if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.KrakendBenchmark.Current.KrakendSchema.Martian>(this, in item))
                        {
                            return false;
                        }
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void RemoveWhere(JsonPredicate<Corvus.KrakendBenchmark.Current.KrakendSchema.Martian> predicate)
                    {
                        CheckValidInstance();
                        JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.KrakendBenchmark.Current.KrakendSchema.Martian>(this, predicate);
                        _documentVersion = _parent.Version;
                    }
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Replace(in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian oldItem, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source newItem)
                    {
                        CheckValidInstance();
                        ...
                        var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Martian>(_parent, _idx);

                        while (enumerator.MoveNext())
                        {
                            Corvus.KrakendBenchmark.Current.KrakendSchema.Martian current = enumerator.Current;
                    ...
                    /// <summary>
                    /// Gets a <see cref="MartianArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="MartianArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MartianArray Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<MartianArray>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="MartianArray"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MartianArray Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<MartianArray>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.FifoGroup.MartianArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(MartianArray instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.FifoGroup.MartianArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// </summary>
                    public void AddItem(in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source value)
                    {
                    ...
                    /// Add an item to the array.
                    /// </summary>
                    public void AddItem<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source<TContext> value)
#if NET9_0_OR_GREATER
                        where TContext : allows ref struct
#endif
                    {
                ...
                {
                    return workspace.CreateBuilder<MartianArray, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<MartianArray> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<MartianArray>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<MartianArray> Create<TContext>(
