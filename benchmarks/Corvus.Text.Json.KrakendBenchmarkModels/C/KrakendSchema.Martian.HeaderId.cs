...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Martian
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="HeaderId"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal HeaderId(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static HeaderId DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.HeaderId.Scope ScopeValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopeValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.HeaderId.Scope value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in HeaderId left, in HeaderId right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in HeaderId left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(HeaderId instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator HeaderId(JsonElement instance)
            {
                return HeaderId.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HeaderId From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HeaderId ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HeaderId>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HeaderId ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HeaderId>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HeaderId ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HeaderId>(json, options);
            }
            ...
            /// </exception>
            public static HeaderId ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<HeaderId>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out HeaderId? result)
            {
                return JsonElementHelpers.TryParseValue<HeaderId>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new HeaderId(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static HeaderId IJsonElement<HeaderId>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"HeaderId: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="HeaderId"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="HeaderId"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public HeaderId Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<HeaderId>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="HeaderId"/> that lives for the lifetime of its
