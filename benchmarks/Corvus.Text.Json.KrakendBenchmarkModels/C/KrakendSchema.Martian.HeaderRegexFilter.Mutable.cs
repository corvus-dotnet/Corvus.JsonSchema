...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Martian
    {
        ...
        public readonly partial struct HeaderRegexFilter
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(HeaderRegexFilter instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="HeaderRegexFilter"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator HeaderRegexFilter(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.JsonString.Mutable Header
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HeaderUtf8, out Corvus.KrakendBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.JsonString.Mutable Regex
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RegexUtf8, out Corvus.KrakendBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.HeaderRegexFilter.Scope.Mutable ScopeValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopeValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.HeaderRegexFilter.Scope.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new HeaderRegexFilter(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetHeader(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetScopeValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.HeaderRegexFilter.Scope.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetScopeValue<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.HeaderRegexFilter.Scope.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"HeaderRegexFilter.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="HeaderRegexFilter"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="HeaderRegexFilter"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly HeaderRegexFilter Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<HeaderRegexFilter>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="HeaderRegexFilter"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly HeaderRegexFilter Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<HeaderRegexFilter>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.HeaderRegexFilter.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(HeaderRegexFilter instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.HeaderRegexFilter.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="HeaderRegexFilter"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.KrakendBenchmark.Current.JsonString.Source header,
                    ...
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.HeaderRegexFilter.Scope.Source scope)
                {
                ...
                public void Create(
                    ...
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.HeaderRegexFilter.Scope.Source scope)
                {
                    Create(ref _builder, header, modifier, regex, scope);
                }
                ...
                internal static void Create<TContext>(
                    ...
                    in Corvus.KrakendBenchmark.Current.JsonString.Source regex,
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.HeaderRegexFilter.Scope.Source<TContext> scope)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                #endif
                {
                    Create(context, ref _builder, header, modifier, regex, scope);
                }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonString.Source header, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source modifier, in Corvus.KrakendBenchmark.Current.JsonString.Source regex, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.HeaderRegexFilter.Scope.Source scope, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(header, modifier, regex, scope);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.JsonString.Source header, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source<TContext> modifier, in Corvus.KrakendBenchmark.Current.JsonString.Source regex, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.HeaderRegexFilter.Scope.Source<TContext> scope, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, header, modifier, regex, scope);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<HeaderRegexFilter, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<HeaderRegexFilter> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<HeaderRegexFilter>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<HeaderRegexFilter> Create<TContext>(
            ...
            public static ParsedJsonDocument<HeaderRegexFilter> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source header, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source modifier, in Corvus.KrakendBenchmark.Current.JsonString.Source regex, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.HeaderRegexFilter.Scope.Source scope, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<HeaderRegexFilter> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.JsonString.Source header, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source<TContext> modifier, in Corvus.KrakendBenchmark.Current.JsonString.Source regex, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.HeaderRegexFilter.Scope.Source<TContext> scope, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
