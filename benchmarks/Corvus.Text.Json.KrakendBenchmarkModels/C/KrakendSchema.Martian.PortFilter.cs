...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Martian
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="PortFilter"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal PortFilter(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static PortFilter DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.PortFilter.Scope ScopeValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopeValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.PortFilter.Scope value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in PortFilter left, in PortFilter right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in PortFilter left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(PortFilter instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PortFilter(JsonElement instance)
            {
                return PortFilter.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PortFilter From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PortFilter ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PortFilter>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PortFilter ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PortFilter>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PortFilter ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PortFilter>(json, options);
            }
            ...
            /// </exception>
            public static PortFilter ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<PortFilter>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out PortFilter? result)
            {
                return JsonElementHelpers.TryParseValue<PortFilter>(ref reader, out result);
            }
...
#if NET
            static PortFilter IJsonElement<PortFilter>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PortFilter: ValueKind = {ValueKind} : \"{ToString()}\"";
