    ...
    public readonly partial struct Martian
    {
            ...
            : IJsonElement<PortModifier>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchDefaultForScheme(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                ...
                private static void MatchScopeValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
