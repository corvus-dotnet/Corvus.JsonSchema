    ...
    public readonly partial struct Martian
    {
        ...
        public readonly partial struct PortModifier
        {
            ...
            public readonly partial struct RequiredDefaultForSchemeAndScope
                : IJsonElement<RequiredDefaultForSchemeAndScope>
            {
                public static partial class JsonSchema
                {
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDefaultForSchemePresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("defaultForScheme"u8, buffer, out written);
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDefaultForSchemeNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("defaultForScheme"u8, buffer, out written);

                    private const int RequiredOffsetForDefaultForScheme = 0;
                    private const uint RequiredBitForDefaultForScheme = 0b00000000000000000000000000000001;
                    ...
                    private const uint RequiredBitMask0 =
                        RequiredBitForDefaultForScheme | RequiredBitForScope;

                    private static void MatchDefaultForScheme(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        requiredBitBuffer[RequiredOffsetForDefaultForScheme] |= RequiredBitForDefaultForScheme;
                    }
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1modifier~1martian.json/properties/port.Modifier/oneOf/1"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1modifier~1martian.json/properties/port.Modifier/oneOf/1";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1modifier~1martian.json/properties/port.Modifier/oneOf/1"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.StartObject)
                        {
                            ...
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDefaultForSchemePresent, "defaultForScheme"u8, "required"u8);
                            ...
                            {
                                if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForDefaultForScheme] & RequiredBitForDefaultForScheme) == 0)
                                {
                                    context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyDefaultForSchemeNotPresent, "defaultForScheme"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDefaultForSchemePresent, "defaultForScheme"u8, "required"u8);
