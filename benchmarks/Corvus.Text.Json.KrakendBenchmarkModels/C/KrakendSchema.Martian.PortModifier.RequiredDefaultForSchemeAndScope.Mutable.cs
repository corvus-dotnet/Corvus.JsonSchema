    ...
    public readonly partial struct Martian
    {
        ...
        public readonly partial struct PortModifier
        {
            ...
            public readonly partial struct RequiredDefaultForSchemeAndScope
            {
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(in Corvus.Text.Json.JsonElement.Source defaultForScheme, in Corvus.Text.Json.JsonElement.Source scope)
                {
                ...
                /// <param name="scope">The value of the <c>"scope"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> defaultForScheme, in Corvus.Text.Json.JsonElement.Source<TContext> scope)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
