        ...
        public readonly partial struct PortModifier
        {
            ...
            public readonly partial struct RequiredDefaultForSchemeAndScope
            {
...
#endif
                {
                    ...
                    public void SetDefaultForScheme(scoped in Corvus.Text.Json.JsonElement.Source value)
                    {
                        CheckValidInstance();
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.PortModifier.RequiredDefaultForSchemeAndScope.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.PortModifier.RequiredDefaultForSchemeAndScope.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                /// </summary>
                /// <param name="defaultForScheme">The value of the <c>"defaultForScheme"</c> property.</param>
                /// <param name="scope">The value of the <c>"scope"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.Text.Json.JsonElement.Source defaultForScheme, scoped in Corvus.Text.Json.JsonElement.Source scope)
                {
                    return new Source(defaultForScheme, scope);
                }
                ...
                /// <param name="scope">The value of the <c>"scope"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> defaultForScheme, scoped in Corvus.Text.Json.JsonElement.Source<TContext> scope)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    return new Source<TContext>(context, defaultForScheme, scope);
                }
                ...
                public static ParsedJsonDocument<RequiredDefaultForSchemeAndScope> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RequiredDefaultForSchemeAndScope>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredDefaultForSchemeAndScope> Create<TContext>(
                ...
                public static ParsedJsonDocument<RequiredDefaultForSchemeAndScope> Create(in Corvus.Text.Json.JsonElement.Source defaultForScheme, in Corvus.Text.Json.JsonElement.Source scope, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredDefaultForSchemeAndScope> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> defaultForScheme, in Corvus.Text.Json.JsonElement.Source<TContext> scope, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
