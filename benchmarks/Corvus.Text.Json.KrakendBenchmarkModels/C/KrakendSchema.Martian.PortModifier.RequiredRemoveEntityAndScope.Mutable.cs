...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Martian
    {
        ...
        public readonly partial struct PortModifier
        {
            ...
            public readonly partial struct RequiredRemoveEntityAndScope
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RequiredRemoveEntityAndScope instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RequiredRemoveEntityAndScope"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredRemoveEntityAndScope(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Text.Json.JsonElement.Mutable RemoveValue
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RemoveValueUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Text.Json.JsonElement.Mutable Scope
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopeUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                            {
                                return value;
                            }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RequiredRemoveEntityAndScope(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    public void SetRemoveValue(scoped in Corvus.Text.Json.JsonElement.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("remove");
                        }
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetRemoveValue<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetScope(scoped in Corvus.Text.Json.JsonElement.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetScope<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
#if NET9_0_OR_GREATER
                        where TContext : allows ref struct
#endif
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredRemoveEntityAndScope.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RequiredRemoveEntityAndScope"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RequiredRemoveEntityAndScope"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredRemoveEntityAndScope Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RequiredRemoveEntityAndScope>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RequiredRemoveEntityAndScope"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredRemoveEntityAndScope Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RequiredRemoveEntityAndScope>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.PortModifier.RequiredRemoveEntityAndScope.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public static implicit operator Source(RequiredRemoveEntityAndScope instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.PortModifier.RequiredRemoveEntityAndScope.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="RequiredRemoveEntityAndScope"/>.
                    /// </summary>
                    internal static void Create(
                        ref ComplexValueBuilder builder,
                        in Corvus.Text.Json.JsonElement.Source remove,
                        in Corvus.Text.Json.JsonElement.Source scope)
                    {
                    ...
                    /// Creates an instance of a <see cref="RequiredRemoveEntityAndScope"/>.
                    /// </summary>
                    public void Create(in Corvus.Text.Json.JsonElement.Source remove, in Corvus.Text.Json.JsonElement.Source scope)
                    {
                        Create(ref _builder, remove, scope);
                    }
                    ...
                    internal static void Create<TContext>(
                        in TContext context,
                        ref ComplexValueBuilder builder,
                        in Corvus.Text.Json.JsonElement.Source<TContext> remove,
                        in Corvus.Text.Json.JsonElement.Source<TContext> scope)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    {
                    ...
                    #endif
                    {
                        Create(context, ref _builder, remove, scope);
                    }
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.Text.Json.JsonElement.Source remove, scoped in Corvus.Text.Json.JsonElement.Source scope)
                {
                    return new Source(remove, scope);
                }
                ...
                /// <param name="scope">The value of the <c>"scope"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> remove, scoped in Corvus.Text.Json.JsonElement.Source<TContext> scope)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    return new Source<TContext>(context, remove, scope);
                }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source remove, in Corvus.Text.Json.JsonElement.Source scope, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(remove, scope);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> remove, in Corvus.Text.Json.JsonElement.Source<TContext> scope, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    ...
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(context, remove, scope);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<RequiredRemoveEntityAndScope, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<RequiredRemoveEntityAndScope> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RequiredRemoveEntityAndScope>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredRemoveEntityAndScope> Create<TContext>(
                ...
                public static ParsedJsonDocument<RequiredRemoveEntityAndScope> Create(in Corvus.Text.Json.JsonElement.Source remove, in Corvus.Text.Json.JsonElement.Source scope, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredRemoveEntityAndScope> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> remove, in Corvus.Text.Json.JsonElement.Source<TContext> scope, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
