    ...
    public readonly partial struct Martian
    {
        ...
        public readonly partial struct PriorityGroup
        {
...
#endif
            {
                ...
                public void SetModifiers(in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.PriorityGroup.RequiredModifierAndPriorityArray.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetScopeValue(in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.PriorityGroup.Scope.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.PriorityGroup.RequiredModifierAndPriorityArray.Source arg1, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.PriorityGroup.Scope.Source arg2)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _kind = Kind.Create;
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.PriorityGroup.RequiredModifierAndPriorityArray.Source<TContext> arg1, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.PriorityGroup.Scope.Source<TContext> arg2)
                {
                    _context = context;
                    _createArg1 = arg1;
                    _createArg2 = arg2;
            ...
            public ref struct Builder
            {
                ...
                internal static void BuildCreateValue(in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.PriorityGroup.RequiredModifierAndPriorityArray.Source arg1, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.PriorityGroup.Scope.Source arg2, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                ...
                /// <param name="arg2">The value of the property.</param>
                /// <param name="o">The complex value builder into which to write the object.</param>
                internal static void BuildCreateValue<TContext>(scoped in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.PriorityGroup.RequiredModifierAndPriorityArray.Source<TContext> arg1, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.PriorityGroup.Scope.Source<TContext> arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.PriorityGroup.RequiredModifierAndPriorityArray.Source modifiers, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.PriorityGroup.Scope.Source scope)
            {
            ...
            /// <param name="scope">The value of the <c>"scope"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.PriorityGroup.RequiredModifierAndPriorityArray.Source<TContext> modifiers, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.PriorityGroup.Scope.Source<TContext> scope)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
