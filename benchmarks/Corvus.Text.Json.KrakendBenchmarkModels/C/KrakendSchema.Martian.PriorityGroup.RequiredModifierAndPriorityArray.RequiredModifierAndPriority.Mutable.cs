            ...
            public readonly partial struct RequiredModifierAndPriorityArray
            {
                ...
                public readonly partial struct RequiredModifierAndPriority
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RequiredModifierAndPriority instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RequiredModifierAndPriority"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RequiredModifierAndPriority(Mutable instance)
                        {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.KrakendBenchmark.Current.JsonInteger.Mutable Priority
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PriorityUtf8, out Corvus.KrakendBenchmark.Current.JsonInteger.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        public void SetPriority(scoped in Corvus.KrakendBenchmark.Current.JsonInteger.Source value)
                        {
                            ...
                            if (value.IsUndefined)
                            {
                                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("priority");
                            }
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RequiredModifierAndPriority.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredModifierAndPriority Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredModifierAndPriority Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RequiredModifierAndPriority>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source _createArg1;
                        ...
                        public static implicit operator Source(RequiredModifierAndPriority instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source<TContext> _createArg1;
                        private readonly Corvus.KrakendBenchmark.Current.JsonInteger.Source _createArg2;
                    ...
                    public ref struct Builder
                    {
                        ...
                        internal static void Create(
                            ...
                            in Corvus.KrakendBenchmark.Current.JsonInteger.Source priority)
                        {
                        ...
                        /// Creates an instance of a <see cref="RequiredModifierAndPriority"/>.
                        /// </summary>
                        public void Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source modifier, in Corvus.KrakendBenchmark.Current.JsonInteger.Source priority)
                        {
                            Create(ref _builder, modifier, priority);
                        }
                        ...
                        #endif
                        {
                            Create(context, ref _builder, modifier, priority);
                        }
                    ...
                    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source<TContext> modifier, scoped in Corvus.KrakendBenchmark.Current.JsonInteger.Source priority)
                        ...
                        #endif
                    {
                        return new Source<TContext>(context, modifier, priority);
                    }
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source modifier, in Corvus.KrakendBenchmark.Current.JsonInteger.Source priority, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(modifier, priority);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source<TContext> modifier, in Corvus.KrakendBenchmark.Current.JsonInteger.Source priority, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                        ...
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(context, modifier, priority);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    {
                        return workspace.CreateBuilder<RequiredModifierAndPriority, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<RequiredModifierAndPriority> Create(
                        scoped in Source value, int initialCapacity = 30)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<RequiredModifierAndPriority>();
                        }
                        finally
                        {
                    ...
                    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<RequiredModifierAndPriority> Create<TContext>(
                    ...
                    public static ParsedJsonDocument<RequiredModifierAndPriority> Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source modifier, in Corvus.KrakendBenchmark.Current.JsonInteger.Source priority, int initialCapacity = 30)
                    {
                        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                        try
                        {
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<RequiredModifierAndPriority> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source<TContext> modifier, in Corvus.KrakendBenchmark.Current.JsonInteger.Source priority, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
