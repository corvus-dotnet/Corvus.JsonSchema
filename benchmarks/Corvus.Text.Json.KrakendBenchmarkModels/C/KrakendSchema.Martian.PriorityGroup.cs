...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Martian
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.PriorityGroup.RequiredModifierAndPriorityArray Modifiers
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ModifiersUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.PriorityGroup.RequiredModifierAndPriorityArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.PriorityGroup.Scope ScopeValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopeValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.PriorityGroup.Scope value))
                    {
                        return value;
                    }
