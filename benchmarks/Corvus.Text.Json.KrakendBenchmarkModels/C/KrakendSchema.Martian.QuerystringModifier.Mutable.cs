    ...
    public readonly partial struct Martian
    {
        ...
        public readonly partial struct QuerystringModifier
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(QuerystringModifier instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="QuerystringModifier"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator QuerystringModifier(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.QuerystringModifier.Scope.Mutable ScopeValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopeValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.QuerystringModifier.Scope.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetScopeValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.QuerystringModifier.Scope.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetScopeValue<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.QuerystringModifier.Scope.Source<TContext> value)
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"QuerystringModifier.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly QuerystringModifier Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly QuerystringModifier Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<QuerystringModifier>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.QuerystringModifier.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                public static implicit operator Source(QuerystringModifier instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.QuerystringModifier.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="QuerystringModifier"/>.
                /// </summary>
                    ...
                    in Corvus.KrakendBenchmark.Current.JsonString.Source value)
                {
                    ...
                    builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.ScopeValue, Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.QuerystringModifier.Scope.ConstInstance);
                ...
                /// Creates an instance of a <see cref="QuerystringModifier"/>.
                /// </summary>
                public void Create(in Corvus.KrakendBenchmark.Current.JsonString.Source name, in Corvus.KrakendBenchmark.Current.JsonString.Source value)
                {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source name, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source value)
            {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonString.Source name, in Corvus.KrakendBenchmark.Current.JsonString.Source value, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            {
                return workspace.CreateBuilder<QuerystringModifier, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<QuerystringModifier> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<QuerystringModifier>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<QuerystringModifier> Create<TContext>(
            ...
            public static ParsedJsonDocument<QuerystringModifier> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source name, in Corvus.KrakendBenchmark.Current.JsonString.Source value, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
