    ...
    public readonly partial struct Martian
    {
        ...
        public readonly partial struct QuerystringModifier
        {
...
#endif
            {
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetScopeValue(in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.QuerystringModifier.Scope.Source value)
                {
                    CheckValidInstance();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.KrakendBenchmark.Current.JsonString.Source name, in Corvus.KrakendBenchmark.Current.JsonString.Source value)
            {
