...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Martian
    {
        ...
        public readonly partial struct QuerystringModifier
#if NET8_0_OR_GREATER
            : IJsonElement<QuerystringModifier>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="QuerystringModifier"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal QuerystringModifier(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static QuerystringModifier DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.QuerystringModifier.Scope ScopeValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopeValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.QuerystringModifier.Scope value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in QuerystringModifier left, in QuerystringModifier right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in QuerystringModifier left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(QuerystringModifier instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator QuerystringModifier(JsonElement instance)
            {
                return QuerystringModifier.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static QuerystringModifier From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static QuerystringModifier ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<QuerystringModifier>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static QuerystringModifier ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<QuerystringModifier>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static QuerystringModifier ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<QuerystringModifier>(json, options);
            }
            ...
            /// </exception>
            public static QuerystringModifier ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<QuerystringModifier>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out QuerystringModifier? result)
            {
                return JsonElementHelpers.TryParseValue<QuerystringModifier>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new QuerystringModifier(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static QuerystringModifier IJsonElement<QuerystringModifier>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"QuerystringModifier: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="QuerystringModifier"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="QuerystringModifier"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public QuerystringModifier Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<QuerystringModifier>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="QuerystringModifier"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public QuerystringModifier Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<QuerystringModifier>(_idx);
                }
