...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Martian
    {
        ...
        public readonly partial struct StashModifier
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(StashModifier instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="StashModifier"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator StashModifier(Mutable instance)
                {
                ...
                /// <summary>
                /// Gets the <c>headerName</c> property.
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.JsonString.Mutable HeaderName
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HeaderNameUtf8, out Corvus.KrakendBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.StashModifier.Scope.Mutable ScopeValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopeValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.StashModifier.Scope.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new StashModifier(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                /// <summary>
                /// Set the <c>headerName</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetHeaderName(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("headerName");
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HeaderNameUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.HeaderName, ref cvb);
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetScopeValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.StashModifier.Scope.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetScopeValue<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.StashModifier.Scope.Source<TContext> value)
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"StashModifier.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="StashModifier"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="StashModifier"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly StashModifier Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<StashModifier>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="StashModifier"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly StashModifier Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<StashModifier>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.StashModifier.Scope.Source _createArg2;
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.StashModifier.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.StashModifier.Scope.Source arg2)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _kind = Kind.Create;
                ...
                public static implicit operator Source(StashModifier instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                private readonly Corvus.KrakendBenchmark.Current.JsonString.Source _createArg1;
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.StashModifier.Scope.Source<TContext> _createArg2;
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.StashModifier.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.StashModifier.Scope.Source<TContext> arg2)
                {
                    _context = context;
                    _createArg1 = arg1;
                    _createArg2 = arg2;
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="StashModifier"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.KrakendBenchmark.Current.JsonString.Source headerName,
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.StashModifier.Scope.Source scope)
                {
                    headerName.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.HeaderName, ref builder);
                ...
                /// Creates an instance of a <see cref="StashModifier"/>.
                /// </summary>
                public void Create(in Corvus.KrakendBenchmark.Current.JsonString.Source headerName, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.StashModifier.Scope.Source scope)
                {
                    Create(ref _builder, headerName, scope);
                }
                ...
                internal static void Create<TContext>(
                    ...
                    ref ComplexValueBuilder builder,
                    in Corvus.KrakendBenchmark.Current.JsonString.Source headerName,
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.StashModifier.Scope.Source<TContext> scope)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                #endif
                {
                    Create(context, ref _builder, headerName, scope);
                }
                ...
                internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.StashModifier.Scope.Source arg2, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                ...
                /// <param name="arg2">The value of the property.</param>
                /// <param name="o">The complex value builder into which to write the object.</param>
                internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.StashModifier.Scope.Source<TContext> arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            /// </summary>
            /// <param name="headerName">The value of the <c>"headerName"</c> property.</param>
            /// <param name="scope">The value of the <c>"scope"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source headerName, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.StashModifier.Scope.Source scope)
            {
                return new Source(headerName, scope);
            }
            ...
            /// <param name="scope">The value of the <c>"scope"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source headerName, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.StashModifier.Scope.Source<TContext> scope)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Source<TContext>(context, headerName, scope);
            }
            ...
            /// </summary>
            /// <param name="workspace">The JSON workspace.</param>
            /// <param name="headerName">The value of the property.</param>
            /// <param name="scope">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonString.Source headerName, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.StashModifier.Scope.Source scope, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(headerName, scope);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.JsonString.Source headerName, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.StashModifier.Scope.Source<TContext> scope, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, headerName, scope);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<StashModifier, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<StashModifier> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<StashModifier>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<StashModifier> Create<TContext>(
            ...
            public static ParsedJsonDocument<StashModifier> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source headerName, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.StashModifier.Scope.Source scope, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<StashModifier> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.JsonString.Source headerName, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.StashModifier.Scope.Source<TContext> scope, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
