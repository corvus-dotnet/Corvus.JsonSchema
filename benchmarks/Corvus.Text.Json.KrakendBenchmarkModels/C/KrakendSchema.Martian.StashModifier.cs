...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Martian
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="StashModifier"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal StashModifier(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static StashModifier DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.JsonString HeaderName
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HeaderNameUtf8, out Corvus.KrakendBenchmark.Current.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.StashModifier.Scope ScopeValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopeValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.StashModifier.Scope value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in StashModifier left, in StashModifier right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in StashModifier left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(StashModifier instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator StashModifier(JsonElement instance)
            {
                return StashModifier.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StashModifier From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StashModifier ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<StashModifier>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StashModifier ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<StashModifier>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StashModifier ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<StashModifier>(json, options);
            }
            ...
            /// </exception>
            public static StashModifier ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<StashModifier>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out StashModifier? result)
            {
                return JsonElementHelpers.TryParseValue<StashModifier>(ref reader, out result);
            }
...
#if NET
            static StashModifier IJsonElement<StashModifier>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"StashModifier: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="HeaderName"/>.
                /// </summary>
                ...
                /// Gets the JSON property name for <see cref="HeaderName"/>.
                /// </summary>
                public static ReadOnlySpan<byte> HeaderNameUtf8 => "headerName"u8;
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="HeaderName"/>.
                /// </summary>
                public static ReadOnlySpan<byte> HeaderName => "headerName"u8;
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="HeaderName"/>.
                /// </summary>
                public static ReadOnlySpan<byte> HeaderName => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x4E, 0x61, 0x6D, 0x65, 0x22];
