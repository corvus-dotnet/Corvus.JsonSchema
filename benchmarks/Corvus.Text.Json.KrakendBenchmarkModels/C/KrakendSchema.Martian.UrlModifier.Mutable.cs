    ...
    public readonly partial struct Martian
    {
        ...
        public readonly partial struct UrlModifier
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.UrlModifier.Scope.Mutable ScopeValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopeValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.UrlModifier.Scope.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetScopeValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.UrlModifier.Scope.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetScopeValue<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.UrlModifier.Scope.Source<TContext> value)
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.UrlModifier.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg2, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg3, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg4)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _createArg3 = arg3;
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.UrlModifier.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                {
                    builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.ScopeValue, Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.UrlModifier.Scope.ConstInstance);
                ...
                internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg2, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg3, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg4, ref ComplexValueBuilder o)
                {
                    o.StartObject();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source host = default, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source path = default, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source query = default, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source scheme = default)
            {
                return new Source(host, path, query, scheme);
            }
            ...
            public static ParsedJsonDocument<UrlModifier> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<UrlModifier>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<UrlModifier> Create<TContext>(
            ...
            public static ParsedJsonDocument<UrlModifier> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source host = default, in Corvus.KrakendBenchmark.Current.JsonString.Source path = default, in Corvus.KrakendBenchmark.Current.JsonString.Source query = default, in Corvus.KrakendBenchmark.Current.JsonString.Source scheme = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
