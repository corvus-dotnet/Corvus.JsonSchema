...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Martian
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="UrlModifier"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal UrlModifier(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static UrlModifier DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.UrlModifier.Scope ScopeValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopeValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.UrlModifier.Scope value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in UrlModifier left, in UrlModifier right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in UrlModifier left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(UrlModifier instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator UrlModifier(JsonElement instance)
            {
                return UrlModifier.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UrlModifier From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UrlModifier ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<UrlModifier>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UrlModifier ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<UrlModifier>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UrlModifier ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<UrlModifier>(json, options);
            }
            ...
            /// </exception>
            public static UrlModifier ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<UrlModifier>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out UrlModifier? result)
            {
                return JsonElementHelpers.TryParseValue<UrlModifier>(ref reader, out result);
            }
...
#if NET
            static UrlModifier IJsonElement<UrlModifier>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"UrlModifier: ValueKind = {ValueKind} : \"{ToString()}\"";
