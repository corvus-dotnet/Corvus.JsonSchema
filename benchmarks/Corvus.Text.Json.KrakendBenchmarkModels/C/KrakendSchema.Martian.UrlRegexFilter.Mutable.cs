    ...
    public readonly partial struct Martian
    {
        ...
        public readonly partial struct UrlRegexFilter
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.UrlRegexFilter.Scope.Mutable ScopeValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopeValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.UrlRegexFilter.Scope.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetScopeValue<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.UrlRegexFilter.Scope.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.UrlRegexFilter.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.UrlRegexFilter.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                    ...
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source elseValue = default)
                {
                    ...
                    builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.ScopeValue, Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.UrlRegexFilter.Scope.ConstInstance);
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source modifier, in Corvus.KrakendBenchmark.Current.JsonString.Source regex, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source elseValue = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source<TContext> modifier, in Corvus.KrakendBenchmark.Current.JsonString.Source regex, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source<TContext> elseValue = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            public static ParsedJsonDocument<UrlRegexFilter> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<UrlRegexFilter>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<UrlRegexFilter> Create<TContext>(
            ...
            public static ParsedJsonDocument<UrlRegexFilter> Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source modifier, in Corvus.KrakendBenchmark.Current.JsonString.Source regex, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source elseValue = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<UrlRegexFilter> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source<TContext> modifier, in Corvus.KrakendBenchmark.Current.JsonString.Source regex, in Corvus.KrakendBenchmark.Current.KrakendSchema.Martian.Source<TContext> elseValue = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
