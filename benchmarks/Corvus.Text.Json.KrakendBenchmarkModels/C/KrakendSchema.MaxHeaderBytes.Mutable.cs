...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct MaxHeaderBytes
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MaxHeaderBytes, Mutable>(MaxHeaderBytes.DefaultInstance);
        ...
        public static ParsedJsonDocument<MaxHeaderBytes> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MaxHeaderBytes>();
            }
            finally
            {
