...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct MaxIdleConnections
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MaxIdleConnections, Mutable>(MaxIdleConnections.DefaultInstance);
            ...
            public static explicit operator Mutable(MaxIdleConnections instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MaxIdleConnections"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MaxIdleConnections(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MaxIdleConnections.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MaxIdleConnections Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MaxIdleConnections Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MaxIdleConnections>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MaxIdleConnections instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MaxIdleConnections, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MaxIdleConnections> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MaxIdleConnections>();
            }
            finally
            {
