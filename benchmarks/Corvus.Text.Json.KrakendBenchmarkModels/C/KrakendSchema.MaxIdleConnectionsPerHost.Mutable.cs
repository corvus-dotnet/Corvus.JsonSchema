...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct MaxIdleConnectionsPerHost
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MaxIdleConnectionsPerHost, Mutable>(MaxIdleConnectionsPerHost.DefaultInstance);
            ...
            public static explicit operator Mutable(MaxIdleConnectionsPerHost instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MaxIdleConnectionsPerHost"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MaxIdleConnectionsPerHost(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MaxIdleConnectionsPerHost.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MaxIdleConnectionsPerHost Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MaxIdleConnectionsPerHost Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MaxIdleConnectionsPerHost>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MaxIdleConnectionsPerHost instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MaxIdleConnectionsPerHost, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MaxIdleConnectionsPerHost> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MaxIdleConnectionsPerHost>();
            }
            finally
            {
