...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Metrics
    {
        ...
        public readonly partial struct BackendDisabled
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<BackendDisabled, Mutable>(BackendDisabled.DefaultInstance);
                ...
                public static explicit operator Mutable(BackendDisabled instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="BackendDisabled"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator BackendDisabled(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new BackendDisabled(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"BackendDisabled.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="BackendDisabled"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="BackendDisabled"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly BackendDisabled Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<BackendDisabled>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="BackendDisabled"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly BackendDisabled Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<BackendDisabled>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(BackendDisabled instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<BackendDisabled, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<BackendDisabled> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<BackendDisabled>();
                }
                finally
                {
