    ...
    public readonly partial struct Metrics
    {
        ...
        public readonly partial struct EndpointDisabled
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EndpointDisabled, Mutable>(EndpointDisabled.DefaultInstance);
            ...
            public static ParsedJsonDocument<EndpointDisabled> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EndpointDisabled>();
                }
                finally
                {
