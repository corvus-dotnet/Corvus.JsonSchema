    ...
    public readonly partial struct Metrics
    {
        ...
        public readonly partial struct ListenAddress
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ListenAddress, Mutable>(ListenAddress.DefaultInstance);
            ...
            public static ParsedJsonDocument<ListenAddress> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ListenAddress>();
                }
                finally
                {
