    ...
    public readonly partial struct Metrics
    {
        ...
        public readonly partial struct ProxyDisabled
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ProxyDisabled, Mutable>(ProxyDisabled.DefaultInstance);
            ...
            public static ParsedJsonDocument<ProxyDisabled> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ProxyDisabled>();
                }
                finally
                {
