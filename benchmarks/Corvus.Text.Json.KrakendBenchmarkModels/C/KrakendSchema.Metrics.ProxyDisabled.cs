...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Metrics
    {
        ...
        public readonly partial struct ProxyDisabled
#if NET8_0_OR_GREATER
            : IJsonElement<ProxyDisabled>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ProxyDisabled"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ProxyDisabled(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ProxyDisabled DefaultInstance { get; } = ParsedJsonDocument<ProxyDisabled>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(ProxyDisabled value)
            {
            ...
            /// </returns>
            public static bool operator ==(in ProxyDisabled left, in ProxyDisabled right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ProxyDisabled left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ProxyDisabled instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ProxyDisabled(JsonElement instance)
            {
                return ProxyDisabled.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ProxyDisabled From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ProxyDisabled ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ProxyDisabled>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ProxyDisabled ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ProxyDisabled>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ProxyDisabled ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ProxyDisabled>(json, options);
            }
            ...
            /// </exception>
            public static ProxyDisabled ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ProxyDisabled>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ProxyDisabled? result)
            {
                return JsonElementHelpers.TryParseValue<ProxyDisabled>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ProxyDisabled(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ProxyDisabled IJsonElement<ProxyDisabled>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ProxyDisabled: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ProxyDisabled"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ProxyDisabled"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ProxyDisabled Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ProxyDisabled>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ProxyDisabled"/> that lives for the lifetime of its
