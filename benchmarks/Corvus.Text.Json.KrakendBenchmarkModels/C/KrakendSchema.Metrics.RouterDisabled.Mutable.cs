    ...
    public readonly partial struct Metrics
    {
        ...
        public readonly partial struct RouterDisabled
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<RouterDisabled, Mutable>(RouterDisabled.DefaultInstance);
                ...
                public static explicit operator Mutable(RouterDisabled instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RouterDisabled"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RouterDisabled(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RouterDisabled.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RouterDisabled Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RouterDisabled Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RouterDisabled>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RouterDisabled instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RouterDisabled, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RouterDisabled> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RouterDisabled>();
                }
                finally
                {
