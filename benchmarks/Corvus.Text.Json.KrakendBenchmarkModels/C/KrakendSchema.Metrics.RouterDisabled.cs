...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Metrics
    {
        ...
        public readonly partial struct RouterDisabled
#if NET8_0_OR_GREATER
            : IJsonElement<RouterDisabled>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RouterDisabled"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RouterDisabled(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RouterDisabled DefaultInstance { get; } = ParsedJsonDocument<RouterDisabled>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(RouterDisabled value)
            {
            ...
            /// </returns>
            public static bool operator ==(in RouterDisabled left, in RouterDisabled right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RouterDisabled left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RouterDisabled instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RouterDisabled(JsonElement instance)
            {
                return RouterDisabled.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RouterDisabled From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RouterDisabled ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RouterDisabled>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RouterDisabled ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RouterDisabled>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RouterDisabled ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RouterDisabled>(json, options);
            }
            ...
            /// </exception>
            public static RouterDisabled ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RouterDisabled>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RouterDisabled? result)
            {
                return JsonElementHelpers.TryParseValue<RouterDisabled>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RouterDisabled(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RouterDisabled IJsonElement<RouterDisabled>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RouterDisabled: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RouterDisabled"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RouterDisabled"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RouterDisabled Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RouterDisabled>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RouterDisabled"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RouterDisabled Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RouterDisabled>(_idx);
                }
