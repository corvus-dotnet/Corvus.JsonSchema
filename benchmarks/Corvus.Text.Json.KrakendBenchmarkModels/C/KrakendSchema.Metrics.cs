...
public readonly partial struct KrakendSchema
{
...
#endif
    {
        ...
        internal Metrics(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Metrics DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Metrics.BackendDisabled BackendDisabledValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BackendDisabledValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Metrics.BackendDisabled value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Metrics.BackendDisabled.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Metrics.EndpointDisabled EndpointDisabledValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EndpointDisabledValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Metrics.EndpointDisabled value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Metrics.EndpointDisabled.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Metrics.ListenAddress ListenAddressValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ListenAddressValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Metrics.ListenAddress value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Metrics.ListenAddress.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Metrics.ProxyDisabled ProxyDisabledValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProxyDisabledValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Metrics.ProxyDisabled value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Metrics.ProxyDisabled.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Metrics.RouterDisabled RouterDisabledValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RouterDisabledValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Metrics.RouterDisabled value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Metrics.RouterDisabled.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in Metrics left, in Metrics right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Metrics left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Metrics instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Metrics(JsonElement instance)
        {
            return Metrics.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Metrics From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Metrics ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Metrics>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Metrics ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Metrics>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Metrics ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Metrics>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static Metrics ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Metrics>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Metrics? result)
        {
            return JsonElementHelpers.TryParseValue<Metrics>(ref reader, out result);
        }
...
#if NET
        static Metrics IJsonElement<Metrics>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Metrics: ValueKind = {ValueKind} : \"{ToString()}\"";
