    ...
    public readonly partial struct Moesif
    {
        ...
        public readonly partial struct BatchSize
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<BatchSize, Mutable>(BatchSize.DefaultInstance);
            ...
            public static ParsedJsonDocument<BatchSize> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<BatchSize>();
                }
                finally
                {
