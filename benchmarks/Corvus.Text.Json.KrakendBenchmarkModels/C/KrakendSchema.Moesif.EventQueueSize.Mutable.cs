    ...
    public readonly partial struct Moesif
    {
        ...
        public readonly partial struct EventQueueSize
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EventQueueSize, Mutable>(EventQueueSize.DefaultInstance);
            ...
            public static ParsedJsonDocument<EventQueueSize> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EventQueueSize>();
                }
                finally
                {
