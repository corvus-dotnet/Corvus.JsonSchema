    ...
    public readonly partial struct Moesif
    {
        ...
        public readonly partial struct IdentifyCompany
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.JsonString.Mutable JwtClaim
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.JwtClaimUtf8, out Corvus.KrakendBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.JsonString.Mutable QueryString
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.QueryStringUtf8, out Corvus.KrakendBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetJwtClaim(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source value)
                {
                    CheckValidInstance();
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.JwtClaim, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetQueryString(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source value)
                {
                    CheckValidInstance();
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.QueryString, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Moesif.IdentifyCompany.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg2, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg3)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _createArg3 = arg3;
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Moesif.IdentifyCompany.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.KrakendBenchmark.Current.JsonString.Source header = default,
                    in Corvus.KrakendBenchmark.Current.JsonString.Source jwtClaim = default,
                    in Corvus.KrakendBenchmark.Current.JsonString.Source queryString = default)
                {
                    header.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Header, ref builder);
                    jwtClaim.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.JwtClaim, ref builder);
                    queryString.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.QueryString, ref builder);
                }
                ...
                internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg2, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg3, ref ComplexValueBuilder o)
                {
                    o.StartObject();
            ...
            /// <param name="jwtClaim">The value of the <c>"jwt_claim"</c> property.</param>
            /// <param name="queryString">The value of the <c>"query_string"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source header = default, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source jwtClaim = default, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source queryString = default)
            {
                return new Source(header, jwtClaim, queryString);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonString.Source header = default, in Corvus.KrakendBenchmark.Current.JsonString.Source jwtClaim = default, in Corvus.KrakendBenchmark.Current.JsonString.Source queryString = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            public static ParsedJsonDocument<IdentifyCompany> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<IdentifyCompany>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<IdentifyCompany> Create<TContext>(
            ...
            public static ParsedJsonDocument<IdentifyCompany> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source header = default, in Corvus.KrakendBenchmark.Current.JsonString.Source jwtClaim = default, in Corvus.KrakendBenchmark.Current.JsonString.Source queryString = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
