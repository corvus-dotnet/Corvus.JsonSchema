...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Moesif
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.JsonString JwtClaim
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.JwtClaimUtf8, out Corvus.KrakendBenchmark.Current.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.JsonString QueryString
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.QueryStringUtf8, out Corvus.KrakendBenchmark.Current.JsonString value))
                    {
                        return value;
                    }
