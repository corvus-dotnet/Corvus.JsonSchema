    ...
    public readonly partial struct Moesif
    {
        ...
        public readonly partial struct SendTheBody
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SendTheBody, Mutable>(SendTheBody.DefaultInstance);
                ...
                public static explicit operator Mutable(SendTheBody instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SendTheBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SendTheBody(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SendTheBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SendTheBody Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SendTheBody Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SendTheBody>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SendTheBody instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SendTheBody, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SendTheBody> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SendTheBody>();
                }
                finally
                {
