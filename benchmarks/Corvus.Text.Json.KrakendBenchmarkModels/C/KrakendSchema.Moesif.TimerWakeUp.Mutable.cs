    ...
    public readonly partial struct Moesif
    {
        ...
        public readonly partial struct TimerWakeUp
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TimerWakeUp, Mutable>(TimerWakeUp.DefaultInstance);
                ...
                public static explicit operator Mutable(TimerWakeUp instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TimerWakeUp"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TimerWakeUp(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TimerWakeUp.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TimerWakeUp Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TimerWakeUp Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TimerWakeUp>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TimerWakeUp instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TimerWakeUp, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TimerWakeUp> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TimerWakeUp>();
                }
                finally
                {
