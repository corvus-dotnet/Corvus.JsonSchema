    ...
    public readonly partial struct Moesif
    {
        ...
        public readonly partial struct UserIdJwtClaim
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<UserIdJwtClaim, Mutable>(UserIdJwtClaim.DefaultInstance);
            ...
            public static ParsedJsonDocument<UserIdJwtClaim> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<UserIdJwtClaim>();
                }
                finally
                {
