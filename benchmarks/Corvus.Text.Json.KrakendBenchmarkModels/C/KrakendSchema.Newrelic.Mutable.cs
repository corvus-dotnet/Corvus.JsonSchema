...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Newrelic
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Newrelic instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Newrelic"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Newrelic(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Newrelic.EnableDebug.Mutable DebugValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DebugValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Newrelic.EnableDebug.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.KrakendBenchmark.Current.KrakendSchema.Newrelic.EnableDebug.Mutable.DefaultInstance;
                }
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Newrelic.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Newrelic Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly Newrelic Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Newrelic>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Newrelic.EnableDebug.Source _createArg2;
            ...
            public static implicit operator Source(Newrelic instance) => new(JsonElement.From(instance));
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Newrelic"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.KrakendBenchmark.Current.JsonString.Source license,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.Newrelic.EnableDebug.Source debug = default,
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source license, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Newrelic.EnableDebug.Source debug = default, scoped in Corvus.KrakendBenchmark.Current.JsonArray.Source<TContext> headersToPass = default)
            ...
            #endif
        {
            return new Source<TContext>(context, license, debug, headersToPass);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonString.Source license, in Corvus.KrakendBenchmark.Current.KrakendSchema.Newrelic.EnableDebug.Source debug = default, in Corvus.KrakendBenchmark.Current.JsonArray.Source headersToPass = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.JsonString.Source license, in Corvus.KrakendBenchmark.Current.KrakendSchema.Newrelic.EnableDebug.Source debug = default, in Corvus.KrakendBenchmark.Current.JsonArray.Source<TContext> headersToPass = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        {
            return workspace.CreateBuilder<Newrelic, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Newrelic> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Newrelic>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Newrelic> Create<TContext>(
        ...
        public static ParsedJsonDocument<Newrelic> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source license, in Corvus.KrakendBenchmark.Current.KrakendSchema.Newrelic.EnableDebug.Source debug = default, in Corvus.KrakendBenchmark.Current.JsonArray.Source headersToPass = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Newrelic> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.JsonString.Source license, in Corvus.KrakendBenchmark.Current.KrakendSchema.Newrelic.EnableDebug.Source debug = default, in Corvus.KrakendBenchmark.Current.JsonArray.Source<TContext> headersToPass = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
