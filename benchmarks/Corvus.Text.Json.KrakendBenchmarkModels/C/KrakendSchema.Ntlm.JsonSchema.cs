...
public readonly partial struct KrakendSchema
{
        ...
        : IJsonElement<Ntlm>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyPasswordPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("password"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyPasswordNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("password"u8, buffer, out written);

            private const int RequiredOffsetForPassword = 0;
            private const uint RequiredBitForPassword = 0b00000000000000000000000000000001;

            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyUserPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("user"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyUserNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("user"u8, buffer, out written);

            private const int RequiredOffsetForUser = 0;
            private const uint RequiredBitForUser = 0b00000000000000000000000000000010;

            private const uint RequiredBitMask0 =
                RequiredBitForPassword | RequiredBitForUser;
            ...
            private static void MatchPassword(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
            {
                ...
                requiredBitBuffer[RequiredOffsetForPassword] |= RequiredBitForPassword;
            }

            private static void MatchUser(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                ...
                requiredBitBuffer[RequiredOffsetForUser] |= RequiredBitForUser;
            }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1auth~1ntlm.json"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1auth~1ntlm.json";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1auth~1ntlm.json"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyPasswordPresent, "password"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyUserPresent, "user"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForPassword] & RequiredBitForPassword) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyPasswordNotPresent, "password"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyPasswordPresent, "password"u8, "required"u8);
                        ...
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForUser] & RequiredBitForUser) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyUserNotPresent, "user"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyUserPresent, "user"u8, "required"u8);
