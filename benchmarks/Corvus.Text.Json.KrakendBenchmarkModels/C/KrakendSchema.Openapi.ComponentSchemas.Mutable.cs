    ...
    public readonly partial struct Openapi
    {
        ...
        public readonly partial struct ComponentSchemas
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ComponentSchemas instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ComponentSchemas"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ComponentSchemas(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ComponentSchemas(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ComponentSchemas.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ComponentSchemas"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ComponentSchemas"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ComponentSchemas Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ComponentSchemas>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ComponentSchemas"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ComponentSchemas Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ComponentSchemas>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.ComponentSchemas.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(ComponentSchemas instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.ComponentSchemas.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<ComponentSchemas, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ComponentSchemas> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ComponentSchemas>();
                }
                finally
                {
