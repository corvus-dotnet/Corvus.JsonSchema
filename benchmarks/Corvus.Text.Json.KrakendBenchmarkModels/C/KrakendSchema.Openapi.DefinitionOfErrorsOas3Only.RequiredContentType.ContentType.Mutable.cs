            ...
            public readonly partial struct RequiredContentType
            {
                ...
                public readonly partial struct ContentType
                {
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.DefinitionOfErrorsOas3Only.RequiredContentType.ContentType.ObjectBuilder.Build value) {_objectBuilder = value; _kind = Kind.ObjectBuilder; }

                        internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.DefinitionOfErrorsOas3Only.RequiredContentType.ContentType.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.DefinitionOfErrorsOas3Only.RequiredContentType.ContentType.ObjectBuilder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.ObjectBuilder; }

                        internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.DefinitionOfErrorsOas3Only.RequiredContentType.ContentType.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }
