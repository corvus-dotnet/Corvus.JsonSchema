...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Openapi
    {
...
#endif
        {
            ...
            public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.DefinitionOfErrorsOas3Only.RequiredContentType value)
            {
                CheckValidInstance();
            ...
            /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.DefinitionOfErrorsOas3Only.RequiredContentType value)
            {
                CheckValidInstance();
                return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
            }
            ...
            /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(string propertyName, out Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.DefinitionOfErrorsOas3Only.RequiredContentType value)
            {
                CheckValidInstance();
                return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
            }
            ...
            /// <see cref="Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.DefinitionOfErrorsOas3Only.RequiredContentType"/>.
            /// </summary>
            ...
            public static bool MatchesPatternRequiredContentType(ReadOnlySpan<byte> propertyName)
            {
            ...
            /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
            public static bool TryAsPatternRequiredContentType(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.DefinitionOfErrorsOas3Only.RequiredContentType result)
            {
                if (MatchesPatternRequiredContentType(propertyName))
                {
                    result = Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.DefinitionOfErrorsOas3Only.RequiredContentType.From(value);
                    return true;
                }
            ...
            {
                /// <summary>
                /// Visits a property matching 'default|^[0-9]+$'.
                /// </summary>
                bool VisitPatternRequiredContentType(ReadOnlySpan<byte> name, in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.DefinitionOfErrorsOas3Only.RequiredContentType value, ref TState state);
                ...
                where TVisitor : IPatternPropertyVisitor<TState>
            {
                ...
                foreach (var property in EnumerateObject())
                {
                    ...
                    {
                        matched = true;
                        Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.DefinitionOfErrorsOas3Only.RequiredContentType typedValue = Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.DefinitionOfErrorsOas3Only.RequiredContentType.From(property.Value);
                        if (!visitor.VisitPatternRequiredContentType(propertyName, in typedValue, ref state))
                        {
                            return false;
                        }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public ObjectEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.DefinitionOfErrorsOas3Only.RequiredContentType> EnumerateObject()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateObjectEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.DefinitionOfErrorsOas3Only.RequiredContentType>(_parent, _idx);
            }
