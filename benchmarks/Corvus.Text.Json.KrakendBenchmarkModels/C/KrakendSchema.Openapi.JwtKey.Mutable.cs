    ...
    public readonly partial struct Openapi
    {
        ...
        public readonly partial struct JwtKey
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<JwtKey, Mutable>(JwtKey.DefaultInstance);
            ...
            public static ParsedJsonDocument<JwtKey> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<JwtKey>();
                }
                finally
                {
