...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Openapi
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="JwtKey"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal JwtKey(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static JwtKey DefaultInstance { get; } = ParsedJsonDocument<JwtKey>.StringConstant([.."\"KrakenD-JWT\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(JwtKey value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in JwtKey left, in JwtKey right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in JwtKey left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(JwtKey instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JwtKey(JsonElement instance)
            {
                return JwtKey.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static JwtKey From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static JwtKey ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<JwtKey>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static JwtKey ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<JwtKey>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static JwtKey ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<JwtKey>(json, options);
            }
            ...
            /// </exception>
            public static JwtKey ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<JwtKey>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out JwtKey? result)
            {
                return JsonElementHelpers.TryParseValue<JwtKey>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new JwtKey(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static JwtKey IJsonElement<JwtKey>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"JwtKey: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="JwtKey"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="JwtKey"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<JwtKey>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="JwtKey"/> that lives for the lifetime of its
