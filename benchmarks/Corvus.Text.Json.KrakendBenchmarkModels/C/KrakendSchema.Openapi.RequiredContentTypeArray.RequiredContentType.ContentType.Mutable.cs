            ...
            public readonly partial struct RequiredContentType
            {
                ...
                public readonly partial struct ContentType
                {
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ContentType.ObjectBuilder.Build value) {_objectBuilder = value; _kind = Kind.ObjectBuilder; }

                        internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ContentType.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ContentType.ObjectBuilder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.ObjectBuilder; }

                        internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ContentType.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }
                    ...
                    public static ParsedJsonDocument<ContentType> CreateArray(
                    ...
                    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                    /// <returns>An empty <see cref="ParsedJsonDocument{T}"/>. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<ContentType> CreateObject(
                        int initialCapacity = 30, int initialValueBufferSize = 8192)
                    {
                        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
                        try
