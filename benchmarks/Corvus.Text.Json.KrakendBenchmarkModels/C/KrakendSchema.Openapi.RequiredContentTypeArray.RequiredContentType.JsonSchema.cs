                ...
                public static partial class JsonSchema
                {
                    ...
                    private static void MatchExample(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        ...
                        JsonSchemaContext childContext2 =
                            Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ContentType.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                        ...
                        Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ContentType.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                    ...
                    private static void MatchExampleSchema(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        ...
                        JsonSchemaContext childContext3 =
                            Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ExampleSchemaEntity.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                        ...
                        Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ExampleSchemaEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
