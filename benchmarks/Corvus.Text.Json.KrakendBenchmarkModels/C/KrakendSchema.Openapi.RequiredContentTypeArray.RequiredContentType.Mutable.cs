        ...
        public readonly partial struct RequiredContentTypeArray
        {
            ...
            public readonly partial struct RequiredContentType
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RequiredContentType instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RequiredContentType"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredContentType(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.JsonString.Mutable ContentTypeValue
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContentTypeValueUtf8, out Corvus.KrakendBenchmark.Current.JsonString.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ContentType.Mutable Example
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExampleUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ContentType.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ExampleSchemaEntity.Mutable ExampleSchema
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExampleSchemaUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ExampleSchemaEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.JsonString.Mutable Ref
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RefUtf8, out Corvus.KrakendBenchmark.Current.JsonString.Mutable value))
                            {
                                return value;
                            }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RequiredContentType(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    public void SetContentTypeValue(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source value)
                    {
                        ...
                        {
                            CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("content_type");
                        }
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetExample(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ContentType.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetExample<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ContentType.Source<TContext> value)
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetExampleSchema(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ExampleSchemaEntity.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ExampleSchemaUtf8);
                            _documentVersion = _parent.Version;
                            return;
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExampleSchemaUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                            // We are going to replace just the value
                            value.AddAsItem(ref cvb);
                            _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                        ...
                        {
                            // We are going to insert the new value
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ExampleSchema, ref cvb);
                            int endIndex = _idx + _parent.GetDbSize(_idx, false);
                            _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                        }
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetExampleSchema<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ExampleSchemaEntity.Source<TContext> value)
#if NET9_0_OR_GREATER
                        where TContext : allows ref struct
#endif
                    {
                    ...
                    /// <summary>
                    /// Remove the <c>example_schema</c> property, if present.
                    /// </summary>
                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                    public bool RemoveExampleSchema()
                    {
                        CheckValidInstance();
                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ExampleSchemaUtf8);
                        _documentVersion = _parent.Version;
                        return result;
                    }
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredContentType.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RequiredContentType"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RequiredContentType"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredContentType Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RequiredContentType>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RequiredContentType"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredContentType Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RequiredContentType>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ContentType.Source _createArg3;
                    private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ExampleSchemaEntity.Source _createArg4;
                    private readonly Corvus.KrakendBenchmark.Current.JsonString.Source _createArg5;
                    ...
                    internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg2, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ContentType.Source arg3, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ExampleSchemaEntity.Source arg4, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg5)
                    {
                        _createArg1 = arg1;
                        _createArg2 = arg2;
                        _createArg3 = arg3;
                    ...
                    public static implicit operator Source(RequiredContentType instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    private readonly Corvus.KrakendBenchmark.Current.JsonString.Source _createArg1;
                    private readonly Corvus.KrakendBenchmark.Current.JsonString.Source _createArg2;
                    private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ContentType.Source<TContext> _createArg3;
                    private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ExampleSchemaEntity.Source<TContext> _createArg4;
                    private readonly Corvus.KrakendBenchmark.Current.JsonString.Source _createArg5;
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg2, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ContentType.Source<TContext> arg3, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ExampleSchemaEntity.Source<TContext> arg4, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg5)
                    {
                        _context = context;
                        _createArg1 = arg1;
                        _createArg2 = arg2;
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ContentType.Source example = default,
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ExampleSchemaEntity.Source exampleSchema = default,
                        in Corvus.KrakendBenchmark.Current.JsonString.Source refValue = default)
                    {
                        ...
                        exampleSchema.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ExampleSchema, ref builder);
                    ...
                    public void Create(
                        ...
                        in Corvus.KrakendBenchmark.Current.JsonString.Source refValue = default)
                    {
                        Create(ref _builder, contentType, description, example, exampleSchema, refValue);
                    }
                    ...
                    internal static void Create<TContext>(
                        ...
                        in Corvus.KrakendBenchmark.Current.JsonString.Source contentType,
                        in Corvus.KrakendBenchmark.Current.JsonString.Source description = default,
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ContentType.Source<TContext> example = default,
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ExampleSchemaEntity.Source<TContext> exampleSchema = default,
                        in Corvus.KrakendBenchmark.Current.JsonString.Source refValue = default)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    ...
                    #endif
                    {
                        Create(context, ref _builder, contentType, description, example, exampleSchema, refValue);
                    }
                    ...
                    internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg2, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ContentType.Source arg3, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ExampleSchemaEntity.Source arg4, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg5, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                    ...
                    /// <param name="arg5">The value of the property.</param>
                    /// <param name="o">The complex value builder into which to write the object.</param>
                    internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg2, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ContentType.Source<TContext> arg3, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ExampleSchemaEntity.Source<TContext> arg4, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg5, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                        where TContext : allows ref struct
#endif
                    {
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source contentType, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source description = default, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ContentType.Source example = default, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ExampleSchemaEntity.Source exampleSchema = default, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source refValue = default)
                {
                ...
                /// <param name="refValue">The value of the <c>"ref"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source contentType, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source description = default, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ContentType.Source<TContext> example = default, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ExampleSchemaEntity.Source<TContext> exampleSchema = default, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source refValue = default)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    return new Source<TContext>(context, contentType, description, example, exampleSchema, refValue);
                }
                ...
                /// <param name="exampleSchema">The value of the property.</param>
                /// <param name="refValue">The value of the property.</param>
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonString.Source contentType, in Corvus.KrakendBenchmark.Current.JsonString.Source description = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ContentType.Source example = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ExampleSchemaEntity.Source exampleSchema = default, in Corvus.KrakendBenchmark.Current.JsonString.Source refValue = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(contentType, description, example, exampleSchema, refValue);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.JsonString.Source contentType, in Corvus.KrakendBenchmark.Current.JsonString.Source description = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ContentType.Source<TContext> example = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ExampleSchemaEntity.Source<TContext> exampleSchema = default, in Corvus.KrakendBenchmark.Current.JsonString.Source refValue = default, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    ...
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(context, contentType, description, example, exampleSchema, refValue);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<RequiredContentType, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<RequiredContentType> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RequiredContentType>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredContentType> Create<TContext>(
                ...
                public static ParsedJsonDocument<RequiredContentType> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source contentType, in Corvus.KrakendBenchmark.Current.JsonString.Source description = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ContentType.Source example = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ExampleSchemaEntity.Source exampleSchema = default, in Corvus.KrakendBenchmark.Current.JsonString.Source refValue = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredContentType> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.JsonString.Source contentType, in Corvus.KrakendBenchmark.Current.JsonString.Source description = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ContentType.Source<TContext> example = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.RequiredContentTypeArray.RequiredContentType.ExampleSchemaEntity.Source<TContext> exampleSchema = default, in Corvus.KrakendBenchmark.Current.JsonString.Source refValue = default, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
