    ...
    public readonly partial struct Openapi
    {
        ...
        public readonly partial struct SupportedSchemes
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SupportedSchemes, Mutable>(SupportedSchemes.DefaultInstance);
                ...
                public static explicit operator Mutable(SupportedSchemes instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SupportedSchemes"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SupportedSchemes(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SupportedSchemes.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public readonly SupportedSchemes Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SupportedSchemes Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SupportedSchemes>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.SupportedSchemes.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(SupportedSchemes instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.SupportedSchemes.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<SupportedSchemes, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SupportedSchemes> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SupportedSchemes>();
                }
                finally
                {
