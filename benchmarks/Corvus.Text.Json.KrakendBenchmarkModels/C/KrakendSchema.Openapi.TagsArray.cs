...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Openapi
    {
...
#endif
        {
            ...
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.TagsArray.Tags this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.TagsArray.Tags>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.TagsArray.Tags> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Openapi.TagsArray.Tags>(_parent, _idx);
            }
