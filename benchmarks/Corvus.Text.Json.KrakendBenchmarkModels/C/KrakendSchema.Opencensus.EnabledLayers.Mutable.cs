    ...
    public readonly partial struct Opencensus
    {
        ...
        public readonly partial struct EnabledLayers
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.EnabledLayers.ReportBackend.Mutable Backend
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BackendUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.EnabledLayers.ReportBackend.Mutable value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.EnabledLayers.ReportBackend.Mutable.DefaultInstance;
                    }
                }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.EnabledLayers.ReportPipe.Mutable Pipe
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PipeUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.EnabledLayers.ReportPipe.Mutable value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.EnabledLayers.ReportPipe.Mutable.DefaultInstance;
                    }
                }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.EnabledLayers.ReportRouter.Mutable Router
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RouterUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.EnabledLayers.ReportRouter.Mutable value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.EnabledLayers.ReportRouter.Mutable.DefaultInstance;
                    }
                }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.EnabledLayers.ReportBackend.Source _createArg1;
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.EnabledLayers.ReportPipe.Source _createArg2;
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.EnabledLayers.ReportRouter.Source _createArg3;
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.EnabledLayers.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.EnabledLayers.ReportBackend.Source backend = default,
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.EnabledLayers.ReportPipe.Source pipe = default,
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.EnabledLayers.ReportRouter.Source router = default)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.EnabledLayers.ReportBackend.Source backend = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.EnabledLayers.ReportPipe.Source pipe = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.EnabledLayers.ReportRouter.Source router = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            public static ParsedJsonDocument<EnabledLayers> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EnabledLayers>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<EnabledLayers> Create<TContext>(
            ...
            public static ParsedJsonDocument<EnabledLayers> Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.EnabledLayers.ReportBackend.Source backend = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.EnabledLayers.ReportPipe.Source pipe = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.EnabledLayers.ReportRouter.Source router = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
