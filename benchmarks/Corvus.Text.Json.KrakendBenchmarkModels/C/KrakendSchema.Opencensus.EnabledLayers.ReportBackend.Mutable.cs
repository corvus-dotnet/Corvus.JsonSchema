...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Opencensus
    {
        ...
        public readonly partial struct EnabledLayers
        {
            ...
            public readonly partial struct ReportBackend
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ReportBackend, Mutable>(ReportBackend.DefaultInstance);
                    ...
                    public static explicit operator Mutable(ReportBackend instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ReportBackend"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ReportBackend(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new ReportBackend(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ReportBackend.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="ReportBackend"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="ReportBackend"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ReportBackend Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<ReportBackend>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="ReportBackend"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ReportBackend Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ReportBackend>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ReportBackend instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ReportBackend, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ReportBackend> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ReportBackend>();
                    }
                    finally
                    {
