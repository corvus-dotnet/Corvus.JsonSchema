...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Opencensus
    {
        ...
        public readonly partial struct EnabledLayers
        {
            ...
            public readonly partial struct ReportPipe
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ReportPipe, Mutable>(ReportPipe.DefaultInstance);
                    ...
                    public static explicit operator Mutable(ReportPipe instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ReportPipe"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ReportPipe(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new ReportPipe(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ReportPipe.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="ReportPipe"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="ReportPipe"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ReportPipe Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<ReportPipe>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="ReportPipe"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ReportPipe Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ReportPipe>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ReportPipe instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ReportPipe, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ReportPipe> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ReportPipe>();
                    }
                    finally
                    {
