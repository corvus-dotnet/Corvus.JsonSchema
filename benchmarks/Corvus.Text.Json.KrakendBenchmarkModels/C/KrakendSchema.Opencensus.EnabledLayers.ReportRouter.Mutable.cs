        ...
        public readonly partial struct EnabledLayers
        {
            ...
            public readonly partial struct ReportRouter
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ReportRouter, Mutable>(ReportRouter.DefaultInstance);
                ...
                public static ParsedJsonDocument<ReportRouter> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ReportRouter>();
                    }
                    finally
                    {
