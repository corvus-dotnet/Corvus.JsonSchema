        ...
        public readonly partial struct Exporters
        {
            ...
            public readonly partial struct AwsXRay
            {
                ...
                public readonly partial struct RequiredAccessKeyIdAndRegionAndSecretAccessKeyAndVersion
                    : IJsonElement<RequiredAccessKeyIdAndRegionAndSecretAccessKeyAndVersion>
                {
                    public static partial class JsonSchema
                    {
                        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAccessKeyIdPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("access_key_id"u8, buffer, out written);
                        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAccessKeyIdNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("access_key_id"u8, buffer, out written);

                        private const int RequiredOffsetForAccessKeyId = 0;
                        private const uint RequiredBitForAccessKeyId = 0b00000000000000000000000000000001;
                        ...
                        private const uint RequiredBitForRegion = 0b00000000000000000000000000000010;

                        private static readonly JsonSchemaMessageProvider<int> RequiredPropertySecretAccessKeyPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("secret_access_key"u8, buffer, out written);
                        private static readonly JsonSchemaMessageProvider<int> RequiredPropertySecretAccessKeyNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("secret_access_key"u8, buffer, out written);

                        private const int RequiredOffsetForSecretAccessKey = 0;
                        private const uint RequiredBitForSecretAccessKey = 0b00000000000000000000000000000100;
                        ...
                        private const uint RequiredBitForVersion = 0b00000000000000000000000000001000;
                        ...
                        private static PropertySchemaMatchers<Corvus.KrakendBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                        {
                            return new PropertySchemaMatchers<Corvus.KrakendBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                                (static () => JsonPropertyNames.AccessKeyIdUtf8, MatchAccessKeyId),
                                (static () => JsonPropertyNames.RegionUtf8, MatchRegion),
                                (static () => JsonPropertyNames.SecretAccessKeyUtf8, MatchSecretAccessKey),
                        ...
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1telemetry~1opencensus.json/properties/exporters/properties/xray/oneOf/0"u8, buffer, out written);

                        /// <summary>
                        /// Gets the schema location from which this type was generated.
                        /// </summary>
                        public const string SchemaLocation = "/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1telemetry~1opencensus.json/properties/exporters/properties/xray/oneOf/0";

                        /// <summary>
                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                        /// </summary>
                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1telemetry~1opencensus.json/properties/exporters/properties/xray/oneOf/0"u8;
                            ...
                            ref JsonSchemaContext context)
                        {
                            ...
                            if (tokenType == JsonTokenType.StartObject)
                            {
                                ...
                                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                                {
                                    ...
                                    {
                                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAccessKeyIdPresent, "access_key_id"u8, "required"u8);
                                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyRegionPresent, "region"u8, "required"u8);
                                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertySecretAccessKeyPresent, "secret_access_key"u8, "required"u8);
                                        context.EvaluatedKeywordForProperty(true, 3, RequiredPropertyVersionPresent, "version"u8, "required"u8);
                                    }
                                }
                                ...
                                {
                                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForAccessKeyId] & RequiredBitForAccessKeyId) == 0)
                                    {
                                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyAccessKeyIdNotPresent, "access_key_id"u8, "required"u8);
                                    }
                                    else
                                    {
                                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAccessKeyIdPresent, "access_key_id"u8, "required"u8);
                                    ...
                                    {
                                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyRegionNotPresent, "region"u8, "required"u8);
                                    }
                                    else
                                    {
                                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyRegionPresent, "region"u8, "required"u8);
                                    ...
                                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForSecretAccessKey] & RequiredBitForSecretAccessKey) == 0)
                                    {
                                        context.EvaluatedKeywordForProperty(false, 2, RequiredPropertySecretAccessKeyNotPresent, "secret_access_key"u8, "required"u8);
                                    }
                                    else
                                    {
                                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertySecretAccessKeyPresent, "secret_access_key"u8, "required"u8);
                                    ...
                                    {
                                        context.EvaluatedKeywordForProperty(false, 3, RequiredPropertyVersionNotPresent, "version"u8, "required"u8);
                                    }
                                    else
                                    {
                                        context.EvaluatedKeywordForProperty(true, 3, RequiredPropertyVersionPresent, "version"u8, "required"u8);
