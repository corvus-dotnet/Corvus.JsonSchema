            ...
            public readonly partial struct AwsXRay
            {
                ...
                public readonly partial struct RequiredRegionAndUseEnvAndVersion
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RequiredRegionAndUseEnvAndVersion instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RequiredRegionAndUseEnvAndVersion"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RequiredRegionAndUseEnvAndVersion(Mutable instance)
                        {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.Text.Json.JsonElement.Mutable Region
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RegionUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.Text.Json.JsonElement.Mutable UseEnv
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UseEnvUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.Text.Json.JsonElement.Mutable Version
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new RequiredRegionAndUseEnvAndVersion(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetRegion<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
                        ...
                        public void SetUseEnv(scoped in Corvus.Text.Json.JsonElement.Source value)
                        {
                            ...
                            if (value.IsUndefined)
                            {
                                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("use_env");
                            }

                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UseEnvUtf8, out IJsonDocument? elementParent, out int elementIdx))
                            {
                                // We are going to replace just the value
                                value.AddAsItem(ref cvb);
                                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetUseEnv<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
#if NET9_0_OR_GREATER
                            where TContext : allows ref struct
#endif
                        {
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetVersion<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
#if NET9_0_OR_GREATER
                            where TContext : allows ref struct
#endif
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RequiredRegionAndUseEnvAndVersion.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="RequiredRegionAndUseEnvAndVersion"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="RequiredRegionAndUseEnvAndVersion"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredRegionAndUseEnvAndVersion Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<RequiredRegionAndUseEnvAndVersion>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="RequiredRegionAndUseEnvAndVersion"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredRegionAndUseEnvAndVersion Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RequiredRegionAndUseEnvAndVersion>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(RequiredRegionAndUseEnvAndVersion instance) => new(JsonElement.From(instance));
                    ...
                    public ref struct Builder
                    {
                        ...
                        internal static void Create(
                            ...
                            in Corvus.Text.Json.JsonElement.Source region,
                        ...
                        public void Create(
                            ...
                            in Corvus.Text.Json.JsonElement.Source version)
                        {
                            Create(ref _builder, region, useEnv, version);
                        }
                        ...
                        internal static void Create<TContext>(
                            in TContext context,
                            ref ComplexValueBuilder builder,
                            in Corvus.Text.Json.JsonElement.Source<TContext> region,
                            in Corvus.Text.Json.JsonElement.Source<TContext> useEnv,
                            in Corvus.Text.Json.JsonElement.Source<TContext> version)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                        {
                        ...
                        #endif
                        {
                            Create(context, ref _builder, region, useEnv, version);
                        }
                    ...
                    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> region, scoped in Corvus.Text.Json.JsonElement.Source<TContext> useEnv, scoped in Corvus.Text.Json.JsonElement.Source<TContext> version)
                        ...
                        #endif
                    {
                        return new Source<TContext>(context, region, useEnv, version);
                    }
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source region, in Corvus.Text.Json.JsonElement.Source useEnv, in Corvus.Text.Json.JsonElement.Source version, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(region, useEnv, version);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> region, in Corvus.Text.Json.JsonElement.Source<TContext> useEnv, in Corvus.Text.Json.JsonElement.Source<TContext> version, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                        ...
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(context, region, useEnv, version);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    {
                        return workspace.CreateBuilder<RequiredRegionAndUseEnvAndVersion, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<RequiredRegionAndUseEnvAndVersion> Create(
                        scoped in Source value, int initialCapacity = 30)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<RequiredRegionAndUseEnvAndVersion>();
                        }
                        finally
                        {
                    ...
                    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<RequiredRegionAndUseEnvAndVersion> Create<TContext>(
                    ...
                    public static ParsedJsonDocument<RequiredRegionAndUseEnvAndVersion> Create(in Corvus.Text.Json.JsonElement.Source region, in Corvus.Text.Json.JsonElement.Source useEnv, in Corvus.Text.Json.JsonElement.Source version, int initialCapacity = 30)
                    {
                        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                        try
                        {
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<RequiredRegionAndUseEnvAndVersion> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> region, in Corvus.Text.Json.JsonElement.Source<TContext> useEnv, in Corvus.Text.Json.JsonElement.Source<TContext> version, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
