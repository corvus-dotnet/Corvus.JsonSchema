            ...
            public readonly partial struct AwsXRay
            {
                ...
                public readonly partial struct UseEnv
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<UseEnv, Mutable>(UseEnv.DefaultInstance);
                        ...
                        public static explicit operator Mutable(UseEnv instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="UseEnv"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator UseEnv(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"UseEnv.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly UseEnv Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<UseEnv>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(UseEnv instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<UseEnv, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<UseEnv> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<UseEnv>();
                        }
                        finally
                        {
