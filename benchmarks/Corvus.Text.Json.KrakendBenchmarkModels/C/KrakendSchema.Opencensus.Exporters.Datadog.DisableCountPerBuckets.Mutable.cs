            ...
            public readonly partial struct Datadog
            {
                ...
                public readonly partial struct DisableCountPerBuckets
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableCountPerBuckets, Mutable>(DisableCountPerBuckets.DefaultInstance);
                    ...
                    public static ParsedJsonDocument<DisableCountPerBuckets> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<DisableCountPerBuckets>();
                        }
                        finally
                        {
