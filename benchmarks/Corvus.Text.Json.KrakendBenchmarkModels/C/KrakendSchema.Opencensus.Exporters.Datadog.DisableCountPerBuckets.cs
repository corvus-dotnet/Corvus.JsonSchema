    ...
    public readonly partial struct Opencensus
    {
        ...
        public readonly partial struct Exporters
        {
            ...
            public readonly partial struct Datadog
            {
                ...
                public readonly partial struct DisableCountPerBuckets
#if NET8_0_OR_GREATER
                    : IJsonElement<DisableCountPerBuckets>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="DisableCountPerBuckets"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal DisableCountPerBuckets(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static DisableCountPerBuckets DefaultInstance { get; } = ParsedJsonDocument<DisableCountPerBuckets>.False;
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator bool(DisableCountPerBuckets value)
                    {
                    ...
                    /// </returns>
                    public static bool operator ==(in DisableCountPerBuckets left, in DisableCountPerBuckets right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in DisableCountPerBuckets left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(DisableCountPerBuckets instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DisableCountPerBuckets(JsonElement instance)
                    {
                        return DisableCountPerBuckets.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static DisableCountPerBuckets From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static DisableCountPerBuckets ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<DisableCountPerBuckets>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static DisableCountPerBuckets ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<DisableCountPerBuckets>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static DisableCountPerBuckets ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<DisableCountPerBuckets>(json, options);
                    }
                    ...
                    /// </exception>
                    public static DisableCountPerBuckets ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<DisableCountPerBuckets>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out DisableCountPerBuckets? result)
                    {
                        return JsonElementHelpers.TryParseValue<DisableCountPerBuckets>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new DisableCountPerBuckets(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static DisableCountPerBuckets IJsonElement<DisableCountPerBuckets>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DisableCountPerBuckets: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="DisableCountPerBuckets"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="DisableCountPerBuckets"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public DisableCountPerBuckets Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<DisableCountPerBuckets>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="DisableCountPerBuckets"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public DisableCountPerBuckets Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<DisableCountPerBuckets>(_idx);
                        }
