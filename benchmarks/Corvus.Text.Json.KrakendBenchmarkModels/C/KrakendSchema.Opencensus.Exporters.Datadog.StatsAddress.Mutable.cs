            ...
            public readonly partial struct Datadog
            {
                ...
                public readonly partial struct StatsAddress
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<StatsAddress, Mutable>(StatsAddress.DefaultInstance);
                    ...
                    public static ParsedJsonDocument<StatsAddress> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<StatsAddress>();
                        }
                        finally
                        {
