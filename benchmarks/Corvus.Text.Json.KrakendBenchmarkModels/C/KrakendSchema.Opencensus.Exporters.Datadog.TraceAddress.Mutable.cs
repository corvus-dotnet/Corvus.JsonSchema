            ...
            public readonly partial struct Datadog
            {
                ...
                public readonly partial struct TraceAddress
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TraceAddress, Mutable>(TraceAddress.DefaultInstance);
                        ...
                        public static explicit operator Mutable(TraceAddress instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="TraceAddress"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator TraceAddress(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"TraceAddress.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly TraceAddress Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly TraceAddress Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<TraceAddress>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(TraceAddress instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<TraceAddress, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<TraceAddress> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<TraceAddress>();
                        }
                        finally
                        {
