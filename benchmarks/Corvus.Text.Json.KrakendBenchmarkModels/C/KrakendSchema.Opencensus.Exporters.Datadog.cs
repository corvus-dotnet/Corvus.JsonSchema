    ...
    public readonly partial struct Opencensus
    {
        ...
        public readonly partial struct Exporters
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="Datadog"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal Datadog(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static Datadog DefaultInstance { get; }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Datadog.DisableCountPerBuckets DisableCountPerBucketsValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisableCountPerBucketsValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Datadog.DisableCountPerBuckets value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Datadog.DisableCountPerBuckets.DefaultInstance;
                    }
                }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.JsonString Service
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ServiceUtf8, out Corvus.KrakendBenchmark.Current.JsonString value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Datadog.StatsAddress StatsAddressValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatsAddressValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Datadog.StatsAddress value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Datadog.StatsAddress.DefaultInstance;
                    }
                }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Datadog.TraceAddress TraceAddressValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TraceAddressValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Datadog.TraceAddress value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Datadog.TraceAddress.DefaultInstance;
                    }
                }
                ...
                /// </returns>
                public static bool operator ==(in Datadog left, in Datadog right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in Datadog left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(Datadog instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Datadog(JsonElement instance)
                {
                    return Datadog.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Datadog From<T>(in T instance)
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Datadog ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<Datadog>(utf8Json, options);
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Datadog ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<Datadog>(json, options);
                    #pragma warning restore CS0618
                }
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Datadog ParseValue(string json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<Datadog>(json, options);
                    #pragma warning restore CS0618
                ...
                /// </exception>
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                public static Datadog ParseValue(ref Utf8JsonReader reader)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<Datadog>(ref reader);
                    #pragma warning restore CS0618
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out Datadog? result)
                {
                    return JsonElementHelpers.TryParseValue<Datadog>(ref reader, out result);
                }
...
#if NET
                static Datadog IJsonElement<Datadog>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Datadog: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                {
                    /// <summary>
                    /// Gets the JSON property name for <see cref="DisableCountPerBucketsValue"/>.
                    /// </summary>
                    ...
                    /// <summary>
                    /// Gets the JSON property name for <see cref="StatsAddressValue"/>.
                    /// </summary>
                    ...
                    /// </summary>
                    public const string TraceAddressValue = "trace_address";
                    ...
                    /// Gets the JSON property name for <see cref="TraceAddressValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> TraceAddressValueUtf8 => "trace_address"u8;
                }
                ...
                {
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="DisableCountPerBucketsValue"/>.
                    /// </summary>
                    ...
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="StatsAddressValue"/>.
                    /// </summary>
