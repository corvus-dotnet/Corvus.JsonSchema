    ...
    public readonly partial struct Opencensus
    {
        ...
        public readonly partial struct Exporters
        {
            ...
            public readonly partial struct Jaeger
            {
                ...
                public readonly partial struct RequiredAgentEndpointAndServiceName
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RequiredAgentEndpointAndServiceName instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RequiredAgentEndpointAndServiceName"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RequiredAgentEndpointAndServiceName(Mutable instance)
                        {
                        ...
                        /// <summary>
                        /// Gets the <c>agent_endpoint</c> property.
                        /// </summary>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.Text.Json.JsonElement.Mutable AgentEndpoint
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AgentEndpointUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.Text.Json.JsonElement.Mutable ServiceName
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ServiceNameUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new RequiredAgentEndpointAndServiceName(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        public void SetAgentEndpoint(scoped in Corvus.Text.Json.JsonElement.Source value)
                        {
                            CheckValidInstance();

                            if (value.IsUndefined)
                            {
                                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("agent_endpoint");
                            }
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetAgentEndpoint<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetServiceName(scoped in Corvus.Text.Json.JsonElement.Source value)
                        {
                            CheckValidInstance();
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetServiceName<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
#if NET9_0_OR_GREATER
                            where TContext : allows ref struct
#endif
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RequiredAgentEndpointAndServiceName.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="RequiredAgentEndpointAndServiceName"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="RequiredAgentEndpointAndServiceName"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredAgentEndpointAndServiceName Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<RequiredAgentEndpointAndServiceName>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="RequiredAgentEndpointAndServiceName"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredAgentEndpointAndServiceName Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RequiredAgentEndpointAndServiceName>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Jaeger.RequiredAgentEndpointAndServiceName.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        public static implicit operator Source(RequiredAgentEndpointAndServiceName instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Jaeger.RequiredAgentEndpointAndServiceName.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        /// <summary>
                        /// Creates an instance of a <see cref="RequiredAgentEndpointAndServiceName"/>.
                        /// </summary>
                        internal static void Create(
                            ref ComplexValueBuilder builder,
                            in Corvus.Text.Json.JsonElement.Source agentEndpoint,
                            in Corvus.Text.Json.JsonElement.Source serviceName)
                        {
                        ...
                        /// Creates an instance of a <see cref="RequiredAgentEndpointAndServiceName"/>.
                        /// </summary>
                        public void Create(in Corvus.Text.Json.JsonElement.Source agentEndpoint, in Corvus.Text.Json.JsonElement.Source serviceName)
                        {
                            Create(ref _builder, agentEndpoint, serviceName);
                        }
                        ...
                        internal static void Create<TContext>(
                            in TContext context,
                            ref ComplexValueBuilder builder,
                            in Corvus.Text.Json.JsonElement.Source<TContext> agentEndpoint,
                            in Corvus.Text.Json.JsonElement.Source<TContext> serviceName)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                        {
                        ...
                        #endif
                        {
                            Create(context, ref _builder, agentEndpoint, serviceName);
                        }
                    ...
                    /// </summary>
                    /// <param name="agentEndpoint">The value of the <c>"agent_endpoint"</c> property.</param>
                    /// <param name="serviceName">The value of the <c>"service_name"</c> property.</param>
                    /// <returns>The source from which to build the value.</returns>
                    public static Source Build(scoped in Corvus.Text.Json.JsonElement.Source agentEndpoint, scoped in Corvus.Text.Json.JsonElement.Source serviceName)
                    {
                        return new Source(agentEndpoint, serviceName);
                    }
                    ...
                    /// <param name="serviceName">The value of the <c>"service_name"</c> property.</param>
                    /// <returns>The source from which to build the value.</returns>
                    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> agentEndpoint, scoped in Corvus.Text.Json.JsonElement.Source<TContext> serviceName)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                        return new Source<TContext>(context, agentEndpoint, serviceName);
                    }
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source agentEndpoint, in Corvus.Text.Json.JsonElement.Source serviceName, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(agentEndpoint, serviceName);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> agentEndpoint, in Corvus.Text.Json.JsonElement.Source<TContext> serviceName, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                        ...
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(context, agentEndpoint, serviceName);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    {
                        return workspace.CreateBuilder<RequiredAgentEndpointAndServiceName, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<RequiredAgentEndpointAndServiceName> Create(
                        scoped in Source value, int initialCapacity = 30)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<RequiredAgentEndpointAndServiceName>();
                        }
                        finally
                        {
                    ...
                    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<RequiredAgentEndpointAndServiceName> Create<TContext>(
                    ...
                    public static ParsedJsonDocument<RequiredAgentEndpointAndServiceName> Create(in Corvus.Text.Json.JsonElement.Source agentEndpoint, in Corvus.Text.Json.JsonElement.Source serviceName, int initialCapacity = 30)
                    {
                        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                        try
                        {
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<RequiredAgentEndpointAndServiceName> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> agentEndpoint, in Corvus.Text.Json.JsonElement.Source<TContext> serviceName, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
