        ...
        public readonly partial struct Exporters
        {
            ...
            public readonly partial struct Jaeger
            {
...
#endif
                {
                    ...
                    internal RequiredAgentEndpointAndServiceName(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Text.Json.JsonElement AgentEndpoint
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AgentEndpointUtf8, out Corvus.Text.Json.JsonElement value))
                            {
                                return value;
                            }
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in RequiredAgentEndpointAndServiceName left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(RequiredAgentEndpointAndServiceName instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredAgentEndpointAndServiceName(JsonElement instance)
                    {
                        return RequiredAgentEndpointAndServiceName.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredAgentEndpointAndServiceName From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredAgentEndpointAndServiceName ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredAgentEndpointAndServiceName>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredAgentEndpointAndServiceName ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredAgentEndpointAndServiceName>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredAgentEndpointAndServiceName ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredAgentEndpointAndServiceName>(json, options);
                    }
                    ...
                    /// </exception>
                    public static RequiredAgentEndpointAndServiceName ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<RequiredAgentEndpointAndServiceName>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredAgentEndpointAndServiceName? result)
                    {
                        return JsonElementHelpers.TryParseValue<RequiredAgentEndpointAndServiceName>(ref reader, out result);
                    }
...
#if NET
                    static RequiredAgentEndpointAndServiceName IJsonElement<RequiredAgentEndpointAndServiceName>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredAgentEndpointAndServiceName: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public RequiredAgentEndpointAndServiceName Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public RequiredAgentEndpointAndServiceName Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<RequiredAgentEndpointAndServiceName>(_idx);
                        }
