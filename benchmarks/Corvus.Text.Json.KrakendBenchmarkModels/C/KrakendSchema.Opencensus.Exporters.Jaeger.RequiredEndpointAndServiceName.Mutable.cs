            ...
            public readonly partial struct Jaeger
            {
                ...
                public readonly partial struct RequiredEndpointAndServiceName
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RequiredEndpointAndServiceName instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RequiredEndpointAndServiceName"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RequiredEndpointAndServiceName(Mutable instance)
                        {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.Text.Json.JsonElement.Mutable Endpoint
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EndpointUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        public void SetEndpoint(scoped in Corvus.Text.Json.JsonElement.Source value)
                        {
                            CheckValidInstance();
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetEndpoint<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RequiredEndpointAndServiceName.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredEndpointAndServiceName Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredEndpointAndServiceName Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RequiredEndpointAndServiceName>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Jaeger.RequiredEndpointAndServiceName.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        public static implicit operator Source(RequiredEndpointAndServiceName instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Jaeger.RequiredEndpointAndServiceName.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        internal static void Create(
                            ...
                            in Corvus.Text.Json.JsonElement.Source endpoint,
                        ...
                        /// Creates an instance of a <see cref="RequiredEndpointAndServiceName"/>.
                        /// </summary>
                        public void Create(in Corvus.Text.Json.JsonElement.Source endpoint, in Corvus.Text.Json.JsonElement.Source serviceName)
                        {
                            Create(ref _builder, endpoint, serviceName);
                        }
                        ...
                        internal static void Create<TContext>(
                            in TContext context,
                            ref ComplexValueBuilder builder,
                            in Corvus.Text.Json.JsonElement.Source<TContext> endpoint,
                        ...
                        #endif
                        {
                            Create(context, ref _builder, endpoint, serviceName);
                        }
                    ...
                    /// <returns>The source from which to build the value.</returns>
                    public static Source Build(scoped in Corvus.Text.Json.JsonElement.Source endpoint, scoped in Corvus.Text.Json.JsonElement.Source serviceName)
                    {
                        return new Source(endpoint, serviceName);
                    }
                    ...
                    /// <param name="serviceName">The value of the <c>"service_name"</c> property.</param>
                    /// <returns>The source from which to build the value.</returns>
                    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> endpoint, scoped in Corvus.Text.Json.JsonElement.Source<TContext> serviceName)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                        return new Source<TContext>(context, endpoint, serviceName);
                    }
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source endpoint, in Corvus.Text.Json.JsonElement.Source serviceName, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(endpoint, serviceName);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> endpoint, in Corvus.Text.Json.JsonElement.Source<TContext> serviceName, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                        ...
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(context, endpoint, serviceName);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    {
                        return workspace.CreateBuilder<RequiredEndpointAndServiceName, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<RequiredEndpointAndServiceName> Create(
                        scoped in Source value, int initialCapacity = 30)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<RequiredEndpointAndServiceName>();
                        }
                        finally
                        {
                    ...
                    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<RequiredEndpointAndServiceName> Create<TContext>(
                    ...
                    public static ParsedJsonDocument<RequiredEndpointAndServiceName> Create(in Corvus.Text.Json.JsonElement.Source endpoint, in Corvus.Text.Json.JsonElement.Source serviceName, int initialCapacity = 30)
                    {
                        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                        try
                        {
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<RequiredEndpointAndServiceName> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> endpoint, in Corvus.Text.Json.JsonElement.Source<TContext> serviceName, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
