            ...
            public readonly partial struct Jaeger
            {
                ...
                public readonly partial struct RequiredEndpointAndServiceName
                {
...
#endif
                    {
                        ...
                        public void SetEndpoint(in Corvus.Text.Json.JsonElement.Source value)
                        {
                            CheckValidInstance();
                    ...
                    /// <returns>The source from which to build the value.</returns>
                    public static Source Build(in Corvus.Text.Json.JsonElement.Source endpoint, in Corvus.Text.Json.JsonElement.Source serviceName)
                    {
                    ...
                    /// <param name="serviceName">The value of the <c>"service_name"</c> property.</param>
                    /// <returns>The source from which to build the value.</returns>
                    public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> endpoint, in Corvus.Text.Json.JsonElement.Source<TContext> serviceName)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
