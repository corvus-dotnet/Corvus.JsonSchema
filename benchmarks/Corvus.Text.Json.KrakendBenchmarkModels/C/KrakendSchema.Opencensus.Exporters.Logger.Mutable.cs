        ...
        public readonly partial struct Exporters
        {
            ...
            public readonly partial struct Logger
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(Logger instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="Logger"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Logger(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Spans.Mutable SpansValue
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SpansValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Spans.Mutable value))
                            {
                                return value;
                            }

                            return Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Spans.Mutable.DefaultInstance;
                        }
                    }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Stats.Mutable StatsValue
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatsValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Stats.Mutable value))
                            {
                                return value;
                            }

                            return Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Stats.Mutable.DefaultInstance;
                        }
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new Logger(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    /// <summary>
                    /// Set the <c>spans</c> property.
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetSpansValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Spans.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SpansValueUtf8);
                            _documentVersion = _parent.Version;
                            return;
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SpansValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                        ...
                        else
                        {
                            ...
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.SpansValue, ref cvb);
                    ...
                    /// <summary>
                    /// Remove the <c>spans</c> property, if present.
                    /// </summary>
                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                    public bool RemoveSpansValue()
                    {
                        CheckValidInstance();
                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SpansValueUtf8);
                        _documentVersion = _parent.Version;
                        return result;
                    }

                    /// <summary>
                    /// Set the <c>stats</c> property.
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetStatsValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Stats.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.StatsValueUtf8);
                            _documentVersion = _parent.Version;
                            return;
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatsValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                            // We are going to replace just the value
                            value.AddAsItem(ref cvb);
                            _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                        ...
                        {
                            // We are going to insert the new value
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.StatsValue, ref cvb);
                            int endIndex = _idx + _parent.GetDbSize(_idx, false);
                            _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                        }
                    ...
                    /// <summary>
                    /// Remove the <c>stats</c> property, if present.
                    /// </summary>
                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                    public bool RemoveStatsValue()
                    {
                        CheckValidInstance();
                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.StatsValueUtf8);
                        _documentVersion = _parent.Version;
                        return result;
                    }
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"Logger.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="Logger"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="Logger"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly Logger Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<Logger>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="Logger"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly Logger Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<Logger>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Spans.Source _createArg1;
                    private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Stats.Source _createArg2;
                    ...
                    internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Spans.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Stats.Source arg2)
                    {
                        _createArg1 = arg1;
                        _createArg2 = arg2;
                        _kind = Kind.Create;
                    ...
                    public static implicit operator Source(Logger instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="Logger"/>.
                    /// </summary>
                    internal static void Create(
                        ref ComplexValueBuilder builder,
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Spans.Source spans = default,
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Stats.Source stats = default)
                    {
                        spans.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.SpansValue, ref builder);
                        stats.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.StatsValue, ref builder);
                    }

                    /// <summary>
                    /// Creates an instance of a <see cref="Logger"/>.
                    /// </summary>
                    public void Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Spans.Source spans = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Stats.Source stats = default)
                    {
                        Create(ref _builder, spans, stats);
                    }
                    ...
                    internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Spans.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Stats.Source arg2, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                ...
                /// </summary>
                /// <param name="spans">The value of the <c>"spans"</c> property.</param>
                /// <param name="stats">The value of the <c>"stats"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Spans.Source spans = default, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Stats.Source stats = default)
                {
                    return new Source(spans, stats);
                }
                ...
                /// </summary>
                /// <param name="workspace">The JSON workspace.</param>
                /// <param name="spans">The value of the property.</param>
                /// <param name="stats">The value of the property.</param>
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Spans.Source spans = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Stats.Source stats = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(spans, stats);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<Logger, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<Logger> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<Logger>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<Logger> Create<TContext>(
                ...
                public static ParsedJsonDocument<Logger> Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Spans.Source spans = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Stats.Source stats = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
