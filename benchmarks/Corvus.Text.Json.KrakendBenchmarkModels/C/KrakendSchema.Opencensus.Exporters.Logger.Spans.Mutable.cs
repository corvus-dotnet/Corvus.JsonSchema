    ...
    public readonly partial struct Opencensus
    {
        ...
        public readonly partial struct Exporters
        {
            ...
            public readonly partial struct Logger
            {
                ...
                public readonly partial struct Spans
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<Spans, Mutable>(Spans.DefaultInstance);
                        ...
                        public static explicit operator Mutable(Spans instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="Spans"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator Spans(Mutable instance)
                        {
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new Spans(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"Spans.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="Spans"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="Spans"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly Spans Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<Spans>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="Spans"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly Spans Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<Spans>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(Spans instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<Spans, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<Spans> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<Spans>();
                        }
                        finally
                        {
