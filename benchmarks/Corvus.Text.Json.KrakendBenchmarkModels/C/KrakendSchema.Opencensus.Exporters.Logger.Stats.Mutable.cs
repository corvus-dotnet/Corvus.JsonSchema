            ...
            public readonly partial struct Logger
            {
                ...
                public readonly partial struct Stats
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<Stats, Mutable>(Stats.DefaultInstance);
                        ...
                        public static explicit operator Mutable(Stats instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="Stats"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator Stats(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"Stats.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly Stats Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<Stats>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(Stats instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<Stats, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<Stats> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<Stats>();
                        }
                        finally
                        {
