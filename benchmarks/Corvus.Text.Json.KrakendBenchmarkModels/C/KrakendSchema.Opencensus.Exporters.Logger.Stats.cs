    ...
    public readonly partial struct Opencensus
    {
        ...
        public readonly partial struct Exporters
        {
            ...
            public readonly partial struct Logger
            {
                ...
                public readonly partial struct Stats
...
#endif
                {
                    ...
                    internal Stats(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static Stats DefaultInstance { get; } = ParsedJsonDocument<Stats>.False;
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator bool(Stats value)
                    {
                    ...
                    /// </returns>
                    public static bool operator ==(in Stats left, in Stats right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in Stats left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(Stats instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Stats(JsonElement instance)
                    {
                        return Stats.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static Stats From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static Stats ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<Stats>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static Stats ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<Stats>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static Stats ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<Stats>(json, options);
                    }
                    ...
                    /// </exception>
                    public static Stats ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<Stats>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out Stats? result)
                    {
                        return JsonElementHelpers.TryParseValue<Stats>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new Stats(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static Stats IJsonElement<Stats>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"Stats: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="Stats"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="Stats"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<Stats>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="Stats"/> that lives for the lifetime of its
                    ...
                    public Stats Freeze()
                    {
                        ...
                        {
                            return mutable.FreezeElement<Stats>(_idx);
                        }
