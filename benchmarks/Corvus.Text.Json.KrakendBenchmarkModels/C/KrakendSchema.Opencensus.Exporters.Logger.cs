    ...
    public readonly partial struct Opencensus
    {
        ...
        public readonly partial struct Exporters
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="Logger"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal Logger(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static Logger DefaultInstance { get; }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Spans SpansValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SpansValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Spans value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Spans.DefaultInstance;
                    }
                }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Stats StatsValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatsValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Stats value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Logger.Stats.DefaultInstance;
                    }
                }
                ...
                /// </returns>
                public static bool operator ==(in Logger left, in Logger right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in Logger left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(Logger instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Logger(JsonElement instance)
                {
                    return Logger.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Logger From<T>(in T instance)
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Logger ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<Logger>(utf8Json, options);
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Logger ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<Logger>(json, options);
                    #pragma warning restore CS0618
                }
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Logger ParseValue(string json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<Logger>(json, options);
                    #pragma warning restore CS0618
                ...
                /// </exception>
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                public static Logger ParseValue(ref Utf8JsonReader reader)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<Logger>(ref reader);
                    #pragma warning restore CS0618
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out Logger? result)
                {
                    return JsonElementHelpers.TryParseValue<Logger>(ref reader, out result);
                }
...
#if NET
                static Logger IJsonElement<Logger>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Logger: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                public Logger Freeze()
                {
                    ...
                    {
                        return mutable.FreezeElement<Logger>(_idx);
                    }
                ...
                {
                    /// <summary>
                    /// Gets the JSON property name for <see cref="SpansValue"/>.
                    /// </summary>
                    public const string SpansValue = "spans";

                    /// <summary>
                    /// Gets the JSON property name for <see cref="StatsValue"/>.
                    /// </summary>
                    public const string StatsValue = "stats";

                    /// <summary>
                    /// Gets the JSON property name for <see cref="SpansValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> SpansValueUtf8 => "spans"u8;

                    /// <summary>
                    /// Gets the JSON property name for <see cref="StatsValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> StatsValueUtf8 => "stats"u8;
                }
                ...
                {
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="SpansValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> SpansValue => "spans"u8;

                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="StatsValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> StatsValue => "stats"u8;
                }
                ...
                {
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="SpansValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> SpansValue => [0x75, 0x00, 0x00, 0x00, 0x22, 0x73, 0x70, 0x61, 0x6E, 0x73, 0x22];

                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="StatsValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> StatsValue => [0x75, 0x00, 0x00, 0x00, 0x22, 0x73, 0x74, 0x61, 0x74, 0x73, 0x22];
                }
            }
        }
    }
