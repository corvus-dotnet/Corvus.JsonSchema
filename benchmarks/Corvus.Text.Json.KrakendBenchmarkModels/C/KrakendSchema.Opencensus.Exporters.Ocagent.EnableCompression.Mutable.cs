            ...
            public readonly partial struct Ocagent
            {
                ...
                public readonly partial struct EnableCompression
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnableCompression, Mutable>(EnableCompression.DefaultInstance);
                        ...
                        public static explicit operator Mutable(EnableCompression instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="EnableCompression"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator EnableCompression(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"EnableCompression.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly EnableCompression Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly EnableCompression Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<EnableCompression>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(EnableCompression instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<EnableCompression, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<EnableCompression> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<EnableCompression>();
                        }
                        finally
                        {
