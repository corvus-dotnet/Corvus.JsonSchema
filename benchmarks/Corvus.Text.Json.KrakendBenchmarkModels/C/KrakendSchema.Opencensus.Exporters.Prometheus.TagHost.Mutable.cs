            ...
            public readonly partial struct Prometheus
            {
                ...
                public readonly partial struct TagHost
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TagHost, Mutable>(TagHost.DefaultInstance);
                        ...
                        public static explicit operator Mutable(TagHost instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="TagHost"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator TagHost(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"TagHost.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly TagHost Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<TagHost>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(TagHost instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<TagHost, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<TagHost> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<TagHost>();
                        }
                        finally
                        {
