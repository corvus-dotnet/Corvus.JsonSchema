            ...
            public readonly partial struct Prometheus
            {
                ...
                public readonly partial struct TagMethod
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TagMethod, Mutable>(TagMethod.DefaultInstance);
                        ...
                        public static explicit operator Mutable(TagMethod instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="TagMethod"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator TagMethod(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"TagMethod.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly TagMethod Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly TagMethod Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<TagMethod>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(TagMethod instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<TagMethod, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<TagMethod> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<TagMethod>();
                        }
                        finally
                        {
