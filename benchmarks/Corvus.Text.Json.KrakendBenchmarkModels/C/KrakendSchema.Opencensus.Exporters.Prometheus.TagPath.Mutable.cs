            ...
            public readonly partial struct Prometheus
            {
                ...
                public readonly partial struct TagPath
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TagPath, Mutable>(TagPath.DefaultInstance);
                        ...
                        public static explicit operator Mutable(TagPath instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="TagPath"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator TagPath(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"TagPath.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly TagPath Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<TagPath>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(TagPath instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<TagPath, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<TagPath> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<TagPath>();
                        }
                        finally
                        {
