    ...
    public readonly partial struct Opencensus
    {
        ...
        public readonly partial struct Exporters
        {
            ...
            public readonly partial struct Prometheus
            {
                ...
                public readonly partial struct TagStatusCode
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TagStatusCode, Mutable>(TagStatusCode.DefaultInstance);
                        ...
                        public static explicit operator Mutable(TagStatusCode instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="TagStatusCode"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator TagStatusCode(Mutable instance)
                        {
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new TagStatusCode(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"TagStatusCode.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="TagStatusCode"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="TagStatusCode"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly TagStatusCode Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<TagStatusCode>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="TagStatusCode"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly TagStatusCode Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<TagStatusCode>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(TagStatusCode instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<TagStatusCode, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<TagStatusCode> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<TagStatusCode>();
                        }
                        finally
                        {
