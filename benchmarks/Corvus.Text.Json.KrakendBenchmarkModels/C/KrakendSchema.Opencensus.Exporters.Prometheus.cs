    ...
    public readonly partial struct Opencensus
    {
        ...
        public readonly partial struct Exporters
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="Prometheus"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal Prometheus(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static Prometheus DefaultInstance { get; }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.JsonString Namespace
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NamespaceUtf8, out Corvus.KrakendBenchmark.Current.JsonString value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Prometheus.TagHost TagHostValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagHostValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Prometheus.TagHost value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Prometheus.TagHost.DefaultInstance;
                    }
                }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Prometheus.TagMethod TagMethodValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagMethodValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Prometheus.TagMethod value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Prometheus.TagMethod.DefaultInstance;
                    }
                }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Prometheus.TagPath TagPathValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagPathValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Prometheus.TagPath value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Prometheus.TagPath.DefaultInstance;
                    }
                }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Prometheus.TagStatusCode TagStatuscode
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagStatuscodeUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Prometheus.TagStatusCode value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Prometheus.TagStatusCode.DefaultInstance;
                    }
                }
                ...
                /// </returns>
                public static bool operator ==(in Prometheus left, in Prometheus right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in Prometheus left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(Prometheus instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Prometheus(JsonElement instance)
                {
                    return Prometheus.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Prometheus From<T>(in T instance)
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Prometheus ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<Prometheus>(utf8Json, options);
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Prometheus ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<Prometheus>(json, options);
                    #pragma warning restore CS0618
                }
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Prometheus ParseValue(string json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<Prometheus>(json, options);
                    #pragma warning restore CS0618
                ...
                /// </exception>
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                public static Prometheus ParseValue(ref Utf8JsonReader reader)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<Prometheus>(ref reader);
                    #pragma warning restore CS0618
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out Prometheus? result)
                {
                    return JsonElementHelpers.TryParseValue<Prometheus>(ref reader, out result);
                }
...
#if NET
                static Prometheus IJsonElement<Prometheus>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Prometheus: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                public static class JsonPropertyNames
                {
                    ...
                    /// <summary>
                    /// Gets the JSON property name for <see cref="TagHostValue"/>.
                    /// </summary>
                    public const string TagHostValue = "tag_host";

                    /// <summary>
                    /// Gets the JSON property name for <see cref="TagMethodValue"/>.
                    /// </summary>
                    public const string TagMethodValue = "tag_method";

                    /// <summary>
                    /// Gets the JSON property name for <see cref="TagPathValue"/>.
                    /// </summary>
                    public const string TagPathValue = "tag_path";
                    ...
                    /// Gets the JSON property name for <see cref="TagHostValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> TagHostValueUtf8 => "tag_host"u8;

                    /// <summary>
                    /// Gets the JSON property name for <see cref="TagMethodValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> TagMethodValueUtf8 => "tag_method"u8;

                    /// <summary>
                    /// Gets the JSON property name for <see cref="TagPathValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> TagPathValueUtf8 => "tag_path"u8;
                ...
                private static class JsonPropertyNamesEscaped
                {
                    ...
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="TagHostValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> TagHostValue => "tag_host"u8;

                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="TagMethodValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> TagMethodValue => "tag_method"u8;

                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="TagPathValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> TagPathValue => "tag_path"u8;

                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="TagStatuscode"/>.
                    /// </summary>
