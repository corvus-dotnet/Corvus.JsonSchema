        ...
        public readonly partial struct Exporters
        {
                ...
                : IJsonElement<Stackdriver>
            {
                public static partial class JsonSchema
                {
                    ...
                    private static void MatchMetricPrefix(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                    ...
                    private static void MatchProjectIdValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                        JsonSchemaContext childContext2 =
                            Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Stackdriver.ProjectId.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                        ...
                        Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Stackdriver.ProjectId.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
