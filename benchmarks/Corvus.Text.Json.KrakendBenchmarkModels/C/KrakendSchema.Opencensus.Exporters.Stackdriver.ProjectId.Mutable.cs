            ...
            public readonly partial struct Stackdriver
            {
                ...
                public readonly partial struct ProjectId
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ProjectId, Mutable>(ProjectId.DefaultInstance);
                    ...
                    public static ParsedJsonDocument<ProjectId> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<ProjectId>();
                        }
                        finally
                        {
