        ...
        public readonly partial struct Exporters
        {
            ...
            public readonly partial struct Zipkin
            {
...
#endif
                {
                    ...
                    public void SetCollectorUrl(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source value)
                    {
                        CheckValidInstance();
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Zipkin.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters.Zipkin.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                /// </summary>
                /// <param name="collectorUrl">The value of the <c>"collector_url"</c> property.</param>
                /// <param name="serviceName">The value of the <c>"service_name"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source collectorUrl, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source serviceName)
                {
                    return new Source(collectorUrl, serviceName);
                }
                ...
                public static ParsedJsonDocument<Zipkin> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<Zipkin>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<Zipkin> Create<TContext>(
                ...
                public static ParsedJsonDocument<Zipkin> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source collectorUrl, in Corvus.KrakendBenchmark.Current.JsonString.Source serviceName, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
