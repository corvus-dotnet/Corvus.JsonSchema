    ...
    public readonly partial struct Opencensus
    {
        ...
        public readonly partial struct ReportingPeriod
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ReportingPeriod, Mutable>(ReportingPeriod.DefaultInstance);
                ...
                public static explicit operator Mutable(ReportingPeriod instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ReportingPeriod"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ReportingPeriod(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ReportingPeriod.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ReportingPeriod Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ReportingPeriod Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ReportingPeriod>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ReportingPeriod instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ReportingPeriod, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ReportingPeriod> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ReportingPeriod>();
                }
                finally
                {
