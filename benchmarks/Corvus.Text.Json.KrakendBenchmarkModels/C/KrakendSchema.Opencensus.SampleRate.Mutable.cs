    ...
    public readonly partial struct Opencensus
    {
        ...
        public readonly partial struct SampleRate
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SampleRate, Mutable>(SampleRate.DefaultInstance);
            ...
            public static ParsedJsonDocument<SampleRate> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SampleRate>();
                }
                finally
                {
