...
public readonly partial struct KrakendSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Opencensus"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Opencensus(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Opencensus DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.EnabledLayers EnabledLayersValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnabledLayersValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.EnabledLayers value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters ExportersValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExportersValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.Exporters value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.ReportingPeriod ReportingPeriodValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReportingPeriodValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.ReportingPeriod value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.ReportingPeriod.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.SampleRate SampleRateValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SampleRateValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.SampleRate value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Opencensus.SampleRate.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in Opencensus left, in Opencensus right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Opencensus left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Opencensus instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Opencensus(JsonElement instance)
        {
            return Opencensus.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Opencensus From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Opencensus ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Opencensus>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Opencensus ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Opencensus>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Opencensus ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Opencensus>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static Opencensus ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Opencensus>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Opencensus? result)
        {
            return JsonElementHelpers.TryParseValue<Opencensus>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Opencensus(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Opencensus IJsonElement<Opencensus>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Opencensus: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Opencensus"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Opencensus"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Opencensus Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<Opencensus>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Opencensus"/> that lives for the lifetime of its
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="EnabledLayersValue"/>.
            /// </summary>
            public const string EnabledLayersValue = "enabled_layers";
            ...
            /// <summary>
            /// Gets the JSON property name for <see cref="ReportingPeriodValue"/>.
            /// </summary>
            public const string ReportingPeriodValue = "reporting_period";

            /// <summary>
            /// Gets the JSON property name for <see cref="SampleRateValue"/>.
            /// </summary>
            public const string SampleRateValue = "sample_rate";

            /// <summary>
            /// Gets the JSON property name for <see cref="EnabledLayersValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> EnabledLayersValueUtf8 => "enabled_layers"u8;
            ...
            /// Gets the JSON property name for <see cref="ReportingPeriodValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> ReportingPeriodValueUtf8 => "reporting_period"u8;

            /// <summary>
            /// Gets the JSON property name for <see cref="SampleRateValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> SampleRateValueUtf8 => "sample_rate"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="EnabledLayersValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> EnabledLayersValue => "enabled_layers"u8;
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="ReportingPeriodValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> ReportingPeriodValue => "reporting_period"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="SampleRateValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> SampleRateValue => "sample_rate"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="EnabledLayersValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> EnabledLayersValue => [0x05, 0x01, 0x00, 0x00, 0x22, 0x65, 0x6E, 0x61, 0x62, 0x6C, 0x65, 0x64, 0x5F, 0x6C, 0x61, 0x79, 0x65, 0x72, 0x73, 0x22];
            ...
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="ReportingPeriodValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> ReportingPeriodValue => [0x25, 0x01, 0x00, 0x00, 0x22, 0x72, 0x65, 0x70, 0x6F, 0x72, 0x74, 0x69, 0x6E, 0x67, 0x5F, 0x70, 0x65, 0x72, 0x69, 0x6F, 0x64, 0x22];

            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="SampleRateValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> SampleRateValue => [0xD5, 0x00, 0x00, 0x00, 0x22, 0x73, 0x61, 0x6D, 0x70, 0x6C, 0x65, 0x5F, 0x72, 0x61, 0x74, 0x65, 0x22];
        }
    }
}
