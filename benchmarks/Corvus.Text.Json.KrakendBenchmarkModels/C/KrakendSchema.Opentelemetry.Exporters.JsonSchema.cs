    ...
    public readonly partial struct Opentelemetry
    {
            ...
            : IJsonElement<Exporters>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchOtlp(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                ...
                private static void MatchPrometheus(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
